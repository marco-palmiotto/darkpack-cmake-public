...
\end{align}
In this case, $\srad$ remains the same as in expression \eqref{expr:sradlcdm}, and
its $T$ derivative as in expression \eqref{expr:dsraddT}; however,
...
{\bf Why is the temperature derivative always the same?}
