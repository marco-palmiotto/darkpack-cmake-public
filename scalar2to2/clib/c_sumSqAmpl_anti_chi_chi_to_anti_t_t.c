...
#include <math.h>
#include "stdbool.h"
#include "c_sumSqAmpl_anti_chi_chi_to_anti_t_t.h"
#include "ccommon.h"

#include "cparams.h"

ccomplex_return_t c_sumSqAmpl_anti_chi_chi_to_anti_t_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*g_u*m_t*e_em*IT_0008*IT_0010;
