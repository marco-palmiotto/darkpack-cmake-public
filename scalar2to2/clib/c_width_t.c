        ...
        )
{
    ...
    const ccomplex_t IT_0093 = pow(m_phi, 2);
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = IT_0008 + IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*g_u*m_t*e_em*IT_0026*IT_0037;
    const ccomplex_t IT_0097 = (-0.5)*IT_0096;
    const ccomplex_t IT_0098 = cpow(IT_0097, 2);
    const ccomplex_t IT_0099 = pow(m_phi, 4);
    const ccomplex_t IT_0100 = cabs(-IT_0093 + 0.25*IT_0001*IT_0099);
    const ccomplex_t IT_0101 = cpow(IT_0100, 0.5);
    const ccomplex_t IT_0102 = ( ((m_t
) >= (m_t + m_phi
)) ? ((-0.25)*IT_0000
      *IT_0001*(IT_0008 + IT_0095)*IT_0098*IT_0101
) : (0
));
