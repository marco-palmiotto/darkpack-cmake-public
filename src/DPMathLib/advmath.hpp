...
real_t integrate_gauss_comparative(real_t xmin, real_t xmax, std::function<real_t(real_t)> f, real_t maxdiscrepancy=-1.0e-3, real_t *discr = nullptr);

real_t integrate_trap(real_t xmin, real_t xmax, std::function<real_t(real_t)> f, real_t maxdiscrepancy=-1.0e-3, real_t *discr = nullptr);
