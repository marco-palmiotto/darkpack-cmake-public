...
// #define K_to_eV     8.617330637338339e-05 /* conversion factor T(10**9 K) * K_to_GeV = T(GeV) or T(K) * K_to_eV =
// T(eV) */ #define m_e    		510.9989461e-6 /* electron mass in GeV */ #define M_u         1.660538921e-24 /* unit
// atomic mass M_u in g */ #define g_to_GeV    5.60958884538932e+23 /* conversion factor M(g) * g_to_GeV = M(GeV) */
...
// #define G           6.708609142443796e-39 /* Gn*pow(m_to_GeV,3.)*pow(g_to_GeV,-1.)*pow(s_to_GeV,-2.) Newton constant
// in GeV^-2 */ #define Mplanck     1.2209102930946623e+19 /* in GeV, more precise definition than before */ #define
// DMpn        0.0012934 /* mass difference between neutron and proton in GeV */ #define zeta        1.6103162253325862
