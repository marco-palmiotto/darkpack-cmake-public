...
namespace pdg2016Value //!< Default values from PDG 2016 and their lha block code convention
{
    ...
    /**< Conversion factor: \f$T(10^9 \mathrm{K}) \cdot K\_to\_GeV = T(\mathrm{GeV})\f$ or \f$T(\mathrm{K}) \cdot K\_to\_eV = T(\mathrm{eV})\f$.
     */
...
namespace pdgValue
{
    ...
    constexpr const real_t K_to_eV = k_B;
    /**< Conversion factor: 
     * \f$T(10^9 \mathrm{K}) \cdot K\_to\_GeV = T(\mathrm{GeV})\f$ or \f$T(\mathrm{K}) \cdot K\_to\_eV = T(\mathrm{eV})\f$
     */
...
public:
    ...
    {
        /**< Returns the integer value in the corr::Part_t enumeration
    ...
    {
        /**< Returns the mass of the lightest BSM particle.
    ...
    {
        /**< Returns the electric charge of the lightest BSM particle.
    ...
    {
        /**< Returns the spin-helicity degrees of freedom of the lightest BSM particle.
    ...
    /**< Compares this object with another darkpackparam_t object.
    ...
    /**< Prints the object's data to the specified output stream.
...
public:
    ...
    /**< Reads Standard Model parameters from a file.
    ...
    /**< Constructor that reads parameters from an LHA file.
    ...
    /**< Assigns values to the masses_vector array.
     *   Uses corr::getMassFirst to populate the array.
     */

    void setLightestBSMparticle();
    /**< Determines the lightest BSM particle and assigns relevant data.
     *   Updates the corresponding data member in this instance.
     */

    void refresh();
    /**< Updates the object state after an input change.
     */

    unsigned int change_values(const Param_t &other);
    /**< Modifies the object's content based on another instance.
