...
namespace mssm2to2
{
  std::string getSname(const Process2to2& proc)
  {
    ...
    const std::string listSisoSusy[SIZEPHYSICALBSM] = {"o1", "o2", "o3", "o4", "c1", "c2", "t1", "t2", "b1", "b2",
                                                       "dr", "dl", "ur", "ul", "cr", "cl", "sr", "sl", "er", "el",
                                                       "mr", "ml", "l1", "l2", "ne", "nm", "nl", "go"};

    const std::string listSisoSM[SIZEPHYSICALSM] = {"h", "hh", "hc", "h3", "w", "z", "g", "a",  "d",  "u",
    ...
    const std::string listMartySM[SIZEPHYSICALSM] = {"h", "H0", "Hp",  "A0",   "W",     "Z",     "G",
                                                     "A", "d",  "u",   "s",    "c",     "b",     "t",
                                                     "e", "mu", "tau", "nu_e", "nu_mu", "nu_tau"};
