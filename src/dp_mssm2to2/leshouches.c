...
/* initializes the "param" structure by initializing the parameters with either 0 or a value from the PDG */
{
	...
	/* Other */
	param->mu_W_mass_W=param->mu_b_mass_b=param->mu_spec_lambda_h_mass_b=0.;
	param->bsgamma_rand=0.;
	param->BRBXsmumu_lowq2_rand=param->BRBXsmumu_highq2_rand=param->BRBXsmumu_full_rand=0.;
	param->BRBXsee_lowq2_rand=param->BRBXsee_highq2_rand=param->BRBXsee_full_rand=0.;
	param->BRBXstautau_lowq2_rand=param->BRBXstautau_highq2_rand=param->BRBXstautau_full_rand=0.;
	
	sprintf(param->nuisance_values,"chi2_input/nuisance.in");
	sprintf(param->nuisance_corr,"chi2_input/nuisance_corr.in");
	sprintf(param->exp_values_mom,"chi2_input/exp_values_mom.in");
	sprintf(param->exp_corr_mom,"chi2_input/exp_corr_mom.in");
	sprintf(param->exp_values,"chi2_input/exp_values.in");
	sprintf(param->exp_corr,"chi2_input/exp_corr.in");
		
	/* NP contributions to Wilson coefficients */
    for(ie=1;ie<=30;ie++) param->deltaC[ie]=param->deltaCp[ie]=0.;
	for(ie=1;ie<=6;ie++) param->deltaCQ[ie]=param->deltaCQp[ie]=0.;
