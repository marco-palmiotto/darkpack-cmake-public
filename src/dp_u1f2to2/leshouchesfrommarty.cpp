...
namespace u1f2to2::readmodule
{
  ...
  void ReadBSMparams(Param_t& param, const std::string namefile)
  {
    ...
    param.theta_12_L = get_value(data, "U1LEPTONIC", 1);
    param.theta_12_R = get_value(data, "U1LEPTONIC", 2);
    param.theta_13_L = get_value(data, "U1LEPTONIC", 3);
    param.theta_13_R = get_value(data, "U1LEPTONIC", 4);
    param.theta_23_L = get_value(data, "U1LEPTONIC", 5);
    param.theta_23_R = get_value(data, "U1LEPTONIC", 6);
...
} // End of namespace u1f2to2::readmodule
