...
inline const std::array<bool,TOTAL_PARTICLES+1> isboson={false, 
        true,
        true,
        true,
        true,
...
inline const std::string mass_codes={EMPTYCHAR, 
        EMPTYCHAR+G,
        EMPTYCHAR+V_3,
        EMPTYCHAR+phi,
        EMPTYCHAR+W,
...
inline const std::array<double,TOTAL_PARTICLES+1> part_charge={ 0,
        0,
        0,
        0,
        1,
...
inline const std::array<int,TOTAL_PARTICLES+1> part_tot_dof={ 0,
        16,
        3,
        1,
        6,
...
inline const std::array<int,TOTAL_PARTICLES+1> part_hel_dof={ 0,
        16,
        3,
        1,
        3,
...
inline const std::array<bool,TOTAL_PARTICLES+1> part_isSelfConj={ false,
        true,
        true,
        true,
        false,
...
inline double getMassFirst(const int p, const param_t &input)
{
    switch (p)
    {
        case(G) : 
            return 0.0;
        case(V_3) : 
            return static_cast<double>(input.m_V_3);
        case(phi) : 
