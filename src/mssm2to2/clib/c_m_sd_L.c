        ...
        )
{
    ...
    const ccomplex_t IT_0001 = pow(V_ud, 2);
    ...
    const ccomplex_t IT_0012 = V_cd*conj(V_cd)*IT_0000 + IT_0000*IT_0001 +
       V_td*conj(V_td)*IT_0002 + IT_0003*IT_0005 + -IT_0003*IT_0005*IT_0008 + (
