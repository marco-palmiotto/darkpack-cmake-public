...
ccomplex_return_t c_partWidth_A0_to_Z_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = 0.5*IT_0013 + 0.5*IT_0015 + (-0.5)*IT_0016;
    const ccomplex_t IT_0018 = cpow(IT_0017, 2);
    const ccomplex_t IT_0019 = IT_0014*IT_0018;
    const ccomplex_t IT_0020 = cpow(IT_0013 + IT_0015 + -IT_0016, 2);
    const ccomplex_t IT_0021 = cabs(-IT_0015 + 0.25*IT_0001*IT_0020);
    const ccomplex_t IT_0022 = cpow(IT_0021, 0.5);
    const ccomplex_t IT_0023 = ( ((m_A0
) >= (m_Z + m_H0
)) ? ((-0.125)
      *IT_0000*IT_0001*IT_0012*(IT_0013 + -IT_0019)*IT_0022
) : (0
));
