...
ccomplex_return_t c_partWidth_H0_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*e_em*m_tau*IT_0002*IT_0004
      *IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0016 = ( ((m_H0
) >= (2*m_tau
)) ? (0.5*IT_0000
      *IT_0001*IT_0010*(IT_0011 + -IT_0013)*IT_0015
) : (0
));
