...
ccomplex_return_t c_partWidth_Hp_to_d_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*e_em
      *IT_0002*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0009 = 0.5*IT_0008;
    const ccomplex_t IT_0010 = cpow(IT_0003, -1);
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_d*V_td*e_em
      *IT_0002*IT_0004*IT_0007*IT_0010;
    const ccomplex_t IT_0012 = 0.5*IT_0011;
    const ccomplex_t IT_0013 = m_d*m_t;
