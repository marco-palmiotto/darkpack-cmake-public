...
ccomplex_return_t c_partWidth_Hp_to_s_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*e_em
      *IT_0002*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0009 = 0.5*IT_0008;
    const ccomplex_t IT_0010 = cpow(IT_0003, -1);
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_s*V_ts*e_em
