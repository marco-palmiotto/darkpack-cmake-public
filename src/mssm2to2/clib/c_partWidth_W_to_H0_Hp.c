...
ccomplex_return_t c_partWidth_W_to_H0_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = 0.5*IT_0011 + 0.5*IT_0012 + (-0.5)*IT_0013;
    const ccomplex_t IT_0015 = cpow(IT_0014, 2);
    const ccomplex_t IT_0016 = IT_0001*IT_0015;
    const ccomplex_t IT_0017 = cpow(IT_0011 + IT_0012 + -IT_0013, 2);
    const ccomplex_t IT_0018 = cabs(-IT_0011 + 0.25*IT_0001*IT_0017);
    const ccomplex_t IT_0019 = cpow(IT_0018, 0.5);
    const ccomplex_t IT_0020 = ( ((m_W
) >= (m_H0 + m_Hp
)) ? 
      (0.0416666666666667*IT_0000*IT_0001*IT_0010*(IT_0011 + -IT_0016)*IT_0019
)
       : (0
));
