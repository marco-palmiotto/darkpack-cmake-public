...
ccomplex_return_t c_sumSqAmpl_C_1_C_1_to_Hp_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = IT_0011*IT_0023;
    const ccomplex_t IT_0029 = N_B3*V_u1*e_em;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = 1.4142135623731*IT_0030;
    const ccomplex_t IT_0032 = N_W3*V_u1*e_em;
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0076 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0077 = IT_0024*IT_0076;
    const ccomplex_t IT_0078 = 2*IT_0077;
    const ccomplex_t IT_0079 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0080 = IT_0028*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0092 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0096 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0102*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0109 = IT_0071*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*IT_0109;
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0112 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0113 = IT_0006*IT_0112;
    const ccomplex_t IT_0114 = (-2)*IT_0113;
    const ccomplex_t IT_0115 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0116 = IT_0012*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0141 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0142 = IT_0138*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*IT_0142;
    const ccomplex_t IT_0144 = IT_0041 + -IT_0044 + IT_0074 + IT_0104 + 
      -IT_0107 + -IT_0110 + IT_0140 + -IT_0143;
    const ccomplex_t IT_0145 = cpow(IT_0124, 2);
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_N_2*IT_0145;
    const ccomplex_t IT_0147 = IT_0111*IT_0146;
    const ccomplex_t IT_0148 = m_C_1*IT_0104;
    const ccomplex_t IT_0149 = m_C_1*IT_0107;
    const ccomplex_t IT_0150 = m_C_1*IT_0140;
    const ccomplex_t IT_0151 = m_C_1*IT_0143;
    const ccomplex_t IT_0152 = m_C_1*IT_0044;
    const ccomplex_t IT_0153 = IT_0141*IT_0146;
    const ccomplex_t IT_0154 = cpow(IT_0022, 2);
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*m_N_3*IT_0154;
    const ccomplex_t IT_0156 = IT_0042*IT_0155;
    const ccomplex_t IT_0157 = cpow(IT_0057, 2);
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*m_N_4*IT_0157;
    const ccomplex_t IT_0159 = IT_0072*IT_0158;
    const ccomplex_t IT_0160 = IT_0108*IT_0158;
    const ccomplex_t IT_0161 = m_C_1*IT_0041;
    const ccomplex_t IT_0162 = m_C_1*IT_0074;
    const ccomplex_t IT_0163 = cpow(IT_0101, 2);
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*m_N_1*IT_0163;
    const ccomplex_t IT_0165 = IT_0075*IT_0164;
    const ccomplex_t IT_0166 = IT_0105*IT_0164;
    const ccomplex_t IT_0167 = IT_0002*IT_0155;
    const ccomplex_t IT_0168 = m_C_1*IT_0110;
    const ccomplex_t IT_0169 = IT_0147 + -IT_0148 + -IT_0149 + -IT_0150 + 
      -IT_0151 + -IT_0152 + IT_0153 + IT_0156 + IT_0159 + IT_0160 + -IT_0161 + 
      -IT_0162 + IT_0165 + IT_0166 + IT_0167 + -IT_0168;
    const ccomplex_t IT_0170 = s_24*m_C_1;
    const ccomplex_t IT_0171 = cpow(IT_0088, 2);
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_N_1*IT_0171;
    const ccomplex_t IT_0173 = IT_0075*IT_0172;
    const ccomplex_t IT_0174 = IT_0105*IT_0172;
    const ccomplex_t IT_0175 = cpow(IT_0137, 2);
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*m_N_2*IT_0175;
    const ccomplex_t IT_0177 = IT_0111*IT_0176;
    const ccomplex_t IT_0178 = IT_0141*IT_0176;
    const ccomplex_t IT_0179 = cpow(IT_0070, 2);
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*m_N_4*IT_0179;
    const ccomplex_t IT_0181 = IT_0072*IT_0180;
    const ccomplex_t IT_0182 = IT_0108*IT_0180;
    const ccomplex_t IT_0183 = cpow(IT_0038, 2);
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*m_N_3*IT_0183;
    const ccomplex_t IT_0185 = IT_0002*IT_0184;
    const ccomplex_t IT_0186 = IT_0042*IT_0184;
    const ccomplex_t IT_0187 = -IT_0148 + -IT_0149 + -IT_0150 + -IT_0151 + 
      -IT_0152 + -IT_0161 + -IT_0162 + -IT_0168 + IT_0173 + IT_0174 + IT_0177 +
       IT_0178 + IT_0181 + IT_0182 + IT_0185 + IT_0186;
    const ccomplex_t IT_0188 = s_14*m_C_1;
    const ccomplex_t IT_0189 = IT_0000*IT_0001;
    const ccomplex_t IT_0190 = s_12*IT_0000;
    ...
    const ccomplex_t IT_0197 = (-2)*IT_0144*(conj(IT_0169)*IT_0170 + -conj
      ...
      *IT_0187*(IT_0001*conj(IT_0169) + conj(IT_0144)*IT_0170 + -conj(IT_0144)
      *IT_0188 + (-0.5)*conj(IT_0187)*IT_0194) + (-2)*IT_0169*(conj(IT_0144)
      *IT_0170 + -conj(IT_0144)*IT_0188 + (-0.5)*conj(IT_0169)*IT_0194 + (-0.5)
      *IT_0001*IT_0195) + 2*IT_0144*(conj(IT_0169)*IT_0188 + 0.5*IT_0170*IT_0195
