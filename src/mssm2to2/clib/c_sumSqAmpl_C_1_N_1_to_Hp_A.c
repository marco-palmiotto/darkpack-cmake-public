...
ccomplex_return_t c_sumSqAmpl_C_1_N_1_to_Hp_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0059 = s_14*m_C_1*m_N_1;
    const ccomplex_t IT_0060 = s_24*m_C_1*m_N_1;
    ...
    const ccomplex_t IT_0067 = m_C_1*m_N_1;
    const ccomplex_t IT_0068 = 2*s_12;
    const ccomplex_t IT_0069 = IT_0003*IT_0056;
    const ccomplex_t IT_0070 = -IT_0069;
    const ccomplex_t IT_0071 = IT_0003*IT_0032;
    ...
    const ccomplex_t IT_0082 = (-2)*conj(IT_0054)*(IT_0035*IT_0058 + -IT_0034
      ...
      *IT_0027*IT_0066 + 0.5*IT_0071*IT_0078 + 0.5*IT_0062*IT_0079 + 0.5*IT_0034
      *IT_0081) + (-2)*conj(IT_0058)*(IT_0035*IT_0054 + -IT_0027*IT_0059 + (-0.5
      )*IT_0029*IT_0058*IT_0076 + (-0.5)*IT_0070*IT_0077 + (-0.5)*IT_0057
      *IT_0081) + 2*conj(IT_0057)*(IT_0027*IT_0060 + (-2)*IT_0054*IT_0066 + 0.5
      *IT_0070*IT_0078 + 0.5*IT_0057*IT_0079 + 0.5*IT_0058*IT_0081) + (-2)*conj
      (IT_0034)*(IT_0027*IT_0035 + -IT_0054*IT_0059 + (-0.5)*IT_0029*IT_0034
      *IT_0076 + (-0.5)*IT_0071*IT_0077 + (-0.5)*IT_0062*IT_0081);
