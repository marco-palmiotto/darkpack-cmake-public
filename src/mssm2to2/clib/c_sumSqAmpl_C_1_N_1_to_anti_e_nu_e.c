        ...
        )
{
    ...
    const ccomplex_t IT_0003 = pow(m_N_1, 2);
    ...
    const ccomplex_t IT_0012 = N_u1*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0055 = conj(N_d1)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0056 = IT_0035*IT_0055;
    const ccomplex_t IT_0057 = (-2)*IT_0056;
    const ccomplex_t IT_0058 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0059 = IT_0038*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0087 = N_B1*e_em;
    const ccomplex_t IT_0088 = IT_0016*IT_0087;
    const ccomplex_t IT_0089 = 1.4142135623731*IT_0088;
    const ccomplex_t IT_0090 = N_W1*e_em;
    const ccomplex_t IT_0091 = IT_0007*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*(IT_0089 + IT_0092);
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = IT_0086*IT_0094;
    const ccomplex_t IT_0096 = pow(m_e, 2);
    const ccomplex_t IT_0097 = cpow((-2)*s_23 + IT_0003 + IT_0096 + -m_se_L*
    ...
    const ccomplex_t IT_0100 = cpow((-2)*s_23 + IT_0003 + IT_0096 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0101 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0005*IT_0007*IT_0032;
    const ccomplex_t IT_0102 = 0.5*IT_0101;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
    ...
    const ccomplex_t IT_0109 = m_e*s_14*m_N_1;
    ...
    const ccomplex_t IT_0114 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0115 = IT_0007*IT_0114;
    const ccomplex_t IT_0116 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0016;
    const ccomplex_t IT_0128 = -IT_0127;
    const ccomplex_t IT_0129 = IT_0104*IT_0128;
    const ccomplex_t IT_0130 = IT_0100*IT_0129;
    ...
    const ccomplex_t IT_0154 = (-2)*IT_0125;
    const ccomplex_t IT_0155 = conj(IT_0153)*IT_0154;
    const ccomplex_t IT_0156 = IT_0104*IT_0148;
    const ccomplex_t IT_0157 = IT_0150*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*IT_0157;
    const ccomplex_t IT_0159 = IT_0000 + IT_0135;
    const ccomplex_t IT_0160 = (-2)*conj(IT_0158)*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0005*IT_0007*IT_0032;
    const ccomplex_t IT_0162 = (-0.5)*IT_0161;
    const ccomplex_t IT_0163 = IT_0086*IT_0162;
    const ccomplex_t IT_0164 = IT_0097*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*IT_0164;
    const ccomplex_t IT_0166 = (-2)*IT_0137*conj(IT_0165);
    ...
    const ccomplex_t IT_0170 = IT_0111 + IT_0126 + IT_0138 + IT_0155 + IT_0160
       + IT_0166 + IT_0169;
    const ccomplex_t IT_0171 = s_34*m_C_1*m_N_1;
    const ccomplex_t IT_0172 = 2*IT_0171;
    const ccomplex_t IT_0173 = IT_0132 + IT_0133 + IT_0136;
    const ccomplex_t IT_0174 = conj(IT_0131) + conj(IT_0165);
    const ccomplex_t IT_0175 = 2*IT_0158;
    const ccomplex_t IT_0176 = IT_0131 + IT_0165;
    const ccomplex_t IT_0177 = 2*conj(IT_0158);
    ...
    const ccomplex_t IT_0192 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0193 = IT_0007*IT_0192;
    const ccomplex_t IT_0194 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0206 = conj(IT_0108)*IT_0124 + IT_0108*conj(IT_0124) +
      ...
      *IT_0174*IT_0187 + 0.25*IT_0176*IT_0190 + 0.25*IT_0177*IT_0191 + 0.25*conj
      (IT_0153)*IT_0202 + 0.25*IT_0153*IT_0203 + 0.25*conj(IT_0201)*IT_0204 +
       0.25*IT_0201*IT_0205;
    const ccomplex_t IT_0207 = 4*IT_0158;
    const ccomplex_t IT_0208 = (-2)*IT_0158*IT_0159;
    const ccomplex_t IT_0209 = (-2)*IT_0137*IT_0165;
    const ccomplex_t IT_0210 = 4*IT_0131;
    const ccomplex_t IT_0211 = 4*IT_0165;
    const ccomplex_t IT_0212 = 4*conj(IT_0131);
    const ccomplex_t IT_0213 = 0.5*IT_0108;
    const ccomplex_t IT_0214 = 0.5*IT_0054*conj(IT_0124) + 0.5*IT_0051*
      (IT_0124 + 0.5*IT_0153) + 0.25*conj(IT_0153)*IT_0191 + (conj(IT_0131) +
       0.5*conj(IT_0158) + conj(IT_0165))*IT_0201 + 0.125*IT_0167*IT_0202 +
       0.125*IT_0181*IT_0203 + conj(IT_0201)*(IT_0176 + 0.125*IT_0207) + 0.125
      *conj(IT_0108)*(IT_0175 + IT_0210 + IT_0211) + (conj(IT_0165) + 0.25
      *IT_0177 + 0.25*IT_0212)*IT_0213;
    const ccomplex_t IT_0215 = 0.5*conj(IT_0108);
    const ccomplex_t IT_0216 = IT_0153*(conj(IT_0131) + 2*conj(IT_0158) + conj
      (IT_0165)) + 0.5*IT_0184*IT_0201 + 0.5*IT_0180*conj(IT_0201) + conj
      (IT_0153)*(IT_0176 + 0.5*IT_0207) + 4*conj(IT_0124)*(IT_0158 + 0.125
      *IT_0210 + 0.125*IT_0211) + 4*IT_0124*((-0.5)*conj(IT_0071) + (-0.5)*conj
      (IT_0085) + conj(IT_0158) + 0.5*conj(IT_0165) + 0.125*IT_0212) + IT_0190
      *IT_0213 + IT_0187*IT_0215;
    const ccomplex_t IT_0217 = 4*IT_0000*IT_0051*IT_0054 + (IT_0071 + IT_0085)
      *IT_0170 + (conj(IT_0108)*IT_0153 + IT_0108*conj(IT_0153))*IT_0172 +
       IT_0173*(IT_0174*IT_0175 + IT_0176*IT_0177) + 4*IT_0171*IT_0206 + IT_0132
      *(16*IT_0124*conj(IT_0124) + conj(IT_0153)*IT_0204 + 4*IT_0153*(conj
      (IT_0153) + 0.25*IT_0205) + conj(IT_0158)*IT_0207) + (-2)*IT_0167*((-0.5)
      *IT_0108*IT_0110 + IT_0131*IT_0137 + (-0.5)*IT_0153*IT_0154 + (-0.5)
      *IT_0208 + (-0.5)*IT_0209) + 8*IT_0109*IT_0214 + 8*IT_0133*(IT_0201*(conj
      (IT_0108) + 2*conj(IT_0201)) + 1./8*IT_0174*IT_0210 + 1./8*conj(IT_0165)
      *IT_0211 + 1./8*IT_0165*IT_0212 + IT_0108*(conj(IT_0201) + IT_0215)) + 2
      *IT_0125*IT_0216;
