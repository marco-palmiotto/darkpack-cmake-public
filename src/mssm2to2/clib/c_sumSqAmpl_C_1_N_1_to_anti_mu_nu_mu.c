        ...
        )
{
    ...
    const ccomplex_t IT_0074 = IT_0038*IT_0055;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = IT_0035*IT_0058;
    ...
    const ccomplex_t IT_0096 = pow(m_mu, 2);
    const ccomplex_t IT_0097 = cpow((-2)*s_23 + IT_0003 + IT_0096 + -m_smu_L*
    ...
    const ccomplex_t IT_0100 = cpow((-2)*s_23 + IT_0003 + IT_0096 + -m_smu_R*
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0005*IT_0007*IT_0032;
    ...
    const ccomplex_t IT_0109 = m_mu*s_14*m_N_1;
    ...
    const ccomplex_t IT_0125 = m_mu*s_24*m_C_1;
    const ccomplex_t IT_0126 = (-4)*conj(IT_0124)*IT_0125;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0005*IT_0007*IT_0032;
    const ccomplex_t IT_0128 = (-0.5)*IT_0127;
    const ccomplex_t IT_0129 = IT_0086*IT_0128;
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0016;
    const ccomplex_t IT_0140 = -IT_0139;
    const ccomplex_t IT_0141 = IT_0104*IT_0140;
    ...
    const ccomplex_t IT_0156 = cpow((-2)*s_13 + IT_0002 + IT_0096 + reg_prop +
    ...
    const ccomplex_t IT_0162 = IT_0104*IT_0154;
