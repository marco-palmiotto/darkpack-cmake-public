...
ccomplex_return_t c_sumSqAmpl_C_1_N_1_to_anti_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0009*IT_0015*IT_0017;
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
    ...
    const ccomplex_t IT_0072 = m_mu*s_24*m_C_1;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009;
    const ccomplex_t IT_0074 = 0.5*IT_0073;
    const ccomplex_t IT_0075 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0076 = IT_0009*IT_0075;
    const ccomplex_t IT_0077 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0086 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0087 = IT_0053*IT_0086;
    const ccomplex_t IT_0088 = 2*IT_0087;
    const ccomplex_t IT_0089 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0090 = IT_0050*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0102 = IT_0025*IT_0086;
    const ccomplex_t IT_0103 = 2*IT_0102;
    const ccomplex_t IT_0104 = IT_0029*IT_0089;
    const ccomplex_t IT_0105 = 1.4142135623731*IT_0104;
    const ccomplex_t IT_0106 = IT_0025*IT_0092;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0009;
    ...
    const ccomplex_t IT_0125 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_smu_R*
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0009;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_smu_L*
    ...
    const ccomplex_t IT_0136 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0137 = IT_0009*IT_0136;
    const ccomplex_t IT_0138 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0165 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0009*IT_0015*IT_0017;
    const ccomplex_t IT_0166 = 0.5*IT_0165;
    const ccomplex_t IT_0167 = IT_0019*IT_0166;
    const ccomplex_t IT_0168 = IT_0125*IT_0167;
    ...
    const ccomplex_t IT_0172 = m_mu*s_14*m_N_1;
    const ccomplex_t IT_0173 = 2*IT_0172;
    const ccomplex_t IT_0174 = s_34*m_C_1*m_N_1;
    ...
    const ccomplex_t IT_0185 = 0.25*conj(IT_0170);
    const ccomplex_t IT_0186 = 0.25*conj(IT_0135);
    const ccomplex_t IT_0187 = 4*IT_0172*((conj(IT_0022) + conj(IT_0065))
      *IT_0085 + (IT_0022 + IT_0065)*conj(IT_0085) + conj(IT_0115)*IT_0145 +
       IT_0115*conj(IT_0145) + 0.25*IT_0135*IT_0178 + 0.25*IT_0170*IT_0180 +
       IT_0153*IT_0185 + IT_0171*IT_0186);
    const ccomplex_t IT_0188 = (-4)*IT_0174;
    const ccomplex_t IT_0189 = 0.25*conj(IT_0121);
    const ccomplex_t IT_0190 = (-2)*IT_0022*conj(IT_0065)*IT_0071 + (-4)
      *IT_0072*IT_0147 + 4*IT_0067*(IT_0022*conj(IT_0022) + 2*IT_0145*(conj
      (IT_0121) + 2*conj(IT_0145)) + IT_0121*IT_0150) + conj(IT_0135)*IT_0152
      *IT_0153 + IT_0068*(16*IT_0085*conj(IT_0085) + conj(IT_0170)*IT_0171) +
       IT_0121*(conj(IT_0115)*IT_0173 + conj(IT_0170)*IT_0175 + conj(IT_0065)
      *IT_0179) + IT_0170*(conj(IT_0065)*IT_0173 + conj(IT_0121)*IT_0175 + conj
      (IT_0135)*IT_0176 + conj(IT_0170)*IT_0177 + IT_0068*IT_0178 + conj(IT_0115
      )*IT_0179) + IT_0135*(conj(IT_0170)*IT_0176 + conj(IT_0135)*IT_0177 +
       IT_0152*IT_0180 + conj(IT_0115)*IT_0181 + conj(IT_0065)*IT_0183) + 4
      *IT_0174*(conj(IT_0085)*IT_0121 + IT_0085*IT_0150 + conj(IT_0145)*IT_0170 
      + 2*IT_0145*(conj(IT_0085) + 0.5*conj(IT_0170)) + 0.25*IT_0115*IT_0180 +
       IT_0153*IT_0184) + IT_0187 + 4*IT_0115*(IT_0066*conj(IT_0115) + IT_0179
      *IT_0185 + IT_0181*IT_0186 + 0.25*conj(IT_0065)*IT_0188 + IT_0173*IT_0189)
       + 4*IT_0065*(conj(IT_0065)*IT_0066 + (-0.5)*conj(IT_0022)*IT_0071 +
       IT_0173*IT_0185 + IT_0183*IT_0186 + IT_0184*IT_0188 + IT_0179*IT_0189);
