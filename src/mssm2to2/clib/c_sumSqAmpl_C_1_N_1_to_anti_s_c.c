...
ccomplex_return_t c_sumSqAmpl_C_1_N_1_to_anti_s_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0058 = N_B1*e_em;
    const ccomplex_t IT_0059 = IT_0015*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = N_W1*e_em;
    ...
    const ccomplex_t IT_0073 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0074 = IT_0006*IT_0073;
    const ccomplex_t IT_0075 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0001 + IT_0067 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0094 = conj(N_B1)*e_em;
    const ccomplex_t IT_0095 = IT_0015*IT_0094;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
    ...
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0004*IT_0006*IT_0044;
    const ccomplex_t IT_0129 = (-0.5)*IT_0128;
    const ccomplex_t IT_0130 = IT_0127*IT_0129;
    const ccomplex_t IT_0131 = IT_0093*IT_0130;
    ...
    const ccomplex_t IT_0136 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0137 = IT_0016*IT_0136;
    const ccomplex_t IT_0138 = 1.4142135623731*IT_0137;
    const ccomplex_t IT_0139 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0143 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0154 = IT_0035*IT_0136;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = IT_0032*IT_0139;
    ...
    const ccomplex_t IT_0166 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0167 = IT_0006*IT_0166;
    const ccomplex_t IT_0168 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0179 = m_s*s_14*m_N_1;
    ...
    const ccomplex_t IT_0200 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0015;
    const ccomplex_t IT_0201 = (-0.333333333333333)*IT_0200;
    const ccomplex_t IT_0202 = IT_0103*IT_0201;
    const ccomplex_t IT_0203 = IT_0115*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*IT_0203;
    const ccomplex_t IT_0205 = IT_0088*IT_0108;
    const ccomplex_t IT_0206 = IT_0068*IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*IT_0206;
    const ccomplex_t IT_0208 = IT_0204 + IT_0207;
    const ccomplex_t IT_0209 = IT_0101*IT_0127;
    const ccomplex_t IT_0210 = IT_0093*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1)*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0004*IT_0006*IT_0044;
    ...
    const ccomplex_t IT_0219 = m_c*s_13*m_N_1;
    const ccomplex_t IT_0220 = IT_0103*IT_0129;
    ...
    const ccomplex_t IT_0227 = m_c*m_s*s_12;
    const ccomplex_t IT_0228 = (-6)*conj(IT_0070);
    const ccomplex_t IT_0229 = s_34*m_C_1*m_N_1;
    const ccomplex_t IT_0230 = 24*IT_0085;
    ...
    const ccomplex_t IT_0235 = IT_0054 + IT_0232;
    const ccomplex_t IT_0236 = m_c*m_s*m_C_1*m_N_1;
    const ccomplex_t IT_0237 = 6*IT_0070;
    const ccomplex_t IT_0238 = 24*IT_0175;
    const ccomplex_t IT_0239 = (-6)*IT_0106;
    const ccomplex_t IT_0240 = IT_0092*IT_0178 + conj(IT_0133)*IT_0180 +
       IT_0133*IT_0181 + IT_0071*(IT_0106 + IT_0192) + IT_0119*IT_0208 + IT_0177
      *conj(IT_0208) + IT_0218*IT_0223 + conj(IT_0092)*IT_0230 + IT_0050*IT_0234
       + (conj(IT_0106) + conj(IT_0192))*IT_0237 + conj(IT_0223)*IT_0238 + conj
      (IT_0050)*IT_0239;
    ...
    const ccomplex_t IT_0249 = (-6)*IT_0227;
    const ccomplex_t IT_0250 = (-6)*IT_0229;
    const ccomplex_t IT_0251 = IT_0179*IT_0230 + IT_0235*IT_0239 + IT_0192
    ...
    const ccomplex_t IT_0258 = (-12)*IT_0227;
    const ccomplex_t IT_0259 = (-12)*IT_0229;
    const ccomplex_t IT_0260 = (-6)*IT_0226;
    const ccomplex_t IT_0261 = (-6)*IT_0236;
    const ccomplex_t IT_0262 = (-6)*IT_0219;
    const ccomplex_t IT_0263 = IT_0233*IT_0239 + IT_0208*IT_0241 + IT_0092
    ...
    const ccomplex_t IT_0264 = 6*IT_0227;
    const ccomplex_t IT_0265 = 6*IT_0229;
    const ccomplex_t IT_0266 = 12*IT_0053;
    const ccomplex_t IT_0267 = 12*IT_0219;
    const ccomplex_t IT_0268 = IT_0180*IT_0226 + IT_0219*IT_0237 + IT_0053
      *IT_0238 + IT_0208*IT_0242 + IT_0165*IT_0252 + IT_0199*IT_0253 + IT_0229
      *IT_0254 + IT_0223*IT_0256 + IT_0192*IT_0260 + IT_0050*IT_0262 + IT_0092
      *IT_0264 + IT_0118*IT_0265 + IT_0217*IT_0266 + IT_0133*IT_0267;
    const ccomplex_t IT_0269 = 6*IT_0106;
    const ccomplex_t IT_0270 = IT_0177*IT_0179 + IT_0227*IT_0245 + IT_0092
      *IT_0246 + IT_0208*IT_0247 + IT_0192*IT_0252 + IT_0134*IT_0253 + IT_0118
      *IT_0256 + IT_0165*IT_0260 + IT_0199*IT_0262 + IT_0217*IT_0264 + IT_0223
      *IT_0265 + IT_0072*IT_0269;
    const ccomplex_t IT_0271 = IT_0072*IT_0177 + IT_0052*IT_0230 + IT_0229
      *IT_0245 + IT_0118*IT_0246 + IT_0208*IT_0248 + IT_0134*IT_0252 + IT_0192
      *IT_0253 + IT_0092*IT_0256 + IT_0199*IT_0260 + IT_0165*IT_0262 + IT_0223
      *IT_0264 + IT_0217*IT_0265 + IT_0179*IT_0269;
    const ccomplex_t IT_0272 = 12*IT_0226;
    const ccomplex_t IT_0273 = IT_0180*IT_0219 + IT_0226*IT_0237 + IT_0208
      *IT_0244 + IT_0199*IT_0252 + IT_0165*IT_0253 + IT_0227*IT_0254 + IT_0217
      *IT_0256 + IT_0050*IT_0260 + IT_0192*IT_0262 + IT_0118*IT_0264 + IT_0092
      *IT_0265 + IT_0223*IT_0266 + IT_0133*IT_0272;
    ...
    const ccomplex_t IT_0276 = IT_0179*IT_0245 + IT_0208*IT_0250 + IT_0223
      ...
      *IT_0258 + IT_0192*IT_0259 + IT_0118*IT_0260 + IT_0092*IT_0262 + IT_0133
      *IT_0264 + IT_0229*IT_0269 + IT_0227*IT_0274 + IT_0226*IT_0275;
    const ccomplex_t IT_0277 = IT_0072*IT_0245 + IT_0208*IT_0249 + IT_0217
      ...
      *IT_0258 + IT_0050*IT_0259 + IT_0092*IT_0260 + IT_0118*IT_0262 + IT_0133
      *IT_0265 + IT_0227*IT_0269 + IT_0229*IT_0274 + IT_0219*IT_0275;
    ...
    const ccomplex_t IT_0283 = IT_0219*IT_0238 + IT_0192*IT_0261 + IT_0199
      *IT_0264 + IT_0165*IT_0265 + IT_0133*IT_0266 + IT_0217*IT_0267 + IT_0223
      *IT_0272 + IT_0235*IT_0274 + IT_0278 + IT_0050*IT_0279 + IT_0280 + IT_0281
       + IT_0282;
    const ccomplex_t IT_0284 = IT_0055*IT_0237 + IT_0050*IT_0255 + IT_0192
    ...
    const ccomplex_t IT_0285 = IT_0050*IT_0055*IT_0071 + IT_0072*(24*conj
      ...
      *IT_0226 + IT_0227*(IT_0107*IT_0165 + IT_0092*IT_0176 + IT_0135*IT_0223 +
       IT_0199*IT_0228) + IT_0229*(IT_0118*IT_0176 + IT_0175*IT_0178 + IT_0107
      *IT_0199 + IT_0135*IT_0217 + IT_0165*IT_0228 + conj(IT_0175)*IT_0230) +
       IT_0192*IT_0233*IT_0234 + (IT_0133*IT_0228 + IT_0208*IT_0234)*IT_0235 +
       IT_0236*IT_0240 + conj(IT_0208)*IT_0251 + conj(IT_0192)*IT_0263 + conj
      (IT_0217)*IT_0268 + conj(IT_0092)*IT_0270 + conj(IT_0118)*IT_0271 + conj
