...
ccomplex_return_t c_sumSqAmpl_C_1_N_1_to_u_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = IT_0001*IT_0005;
    ...
    const ccomplex_t IT_0035 = IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_13 + IT_0026 + IT_0068 + -m_sd_L*
    ...
    const ccomplex_t IT_0074 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0075 = IT_0005*IT_0074;
    const ccomplex_t IT_0076 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0087 = cpow(IT_0001, -1);
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0000*IT_0005*IT_0087;
    ...
    const ccomplex_t IT_0094 = cpow((-2)*s_23 + IT_0027 + IT_0068 + -m_su_L*
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0000*IT_0005*IT_0087;
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0000*IT_0005*IT_0087;
    const ccomplex_t IT_0110 = 0.5*IT_0109;
    const ccomplex_t IT_0111 = IT_0104*IT_0110;
    const ccomplex_t IT_0112 = cpow((-2)*s_13 + IT_0026 + IT_0068 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0113 = IT_0111*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0116 = IT_0066*IT_0115;
    ...
    const ccomplex_t IT_0124 = cpow((-2)*s_23 + IT_0027 + IT_0068 + -m_su_R*
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0005;
    const ccomplex_t IT_0128 = -IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
    ...
    const ccomplex_t IT_0137 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0138 = IT_0038*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0144 = conj(N_d1)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0145 = IT_0035*IT_0144;
    ...
    const ccomplex_t IT_0153 = IT_0008*IT_0144;
    const ccomplex_t IT_0154 = (-2)*IT_0153;
    const ccomplex_t IT_0155 = IT_0014*IT_0137;
    const ccomplex_t IT_0156 = 1.4142135623731*IT_0155;
    const ccomplex_t IT_0157 = IT_0008*IT_0140;
    ...
    const ccomplex_t IT_0167 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0168 = IT_0005*IT_0167;
    const ccomplex_t IT_0169 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0180 = m_d*s_13*m_N_1;
    ...
    const ccomplex_t IT_0183 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0000*IT_0002*IT_0005*IT_0087;
    ...
    const ccomplex_t IT_0201 = IT_0089*IT_0115;
    const ccomplex_t IT_0202 = IT_0069*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0013;
    const ccomplex_t IT_0205 = (-0.333333333333333)*IT_0204;
    const ccomplex_t IT_0206 = IT_0104*IT_0205;
    ...
    const ccomplex_t IT_0210 = IT_0102*IT_0128;
    const ccomplex_t IT_0211 = IT_0094*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*IT_0211;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0220 = m_u*s_14*m_N_1;
    const ccomplex_t IT_0221 = IT_0104*IT_0130;
    const ccomplex_t IT_0222 = IT_0094*IT_0221;
    ...
    const ccomplex_t IT_0227 = m_d*s_23*m_C_1;
    const ccomplex_t IT_0228 = s_34*m_C_1*m_N_1;
    ...
    const ccomplex_t IT_0235 = m_d*m_u*m_C_1*m_N_1;
    const ccomplex_t IT_0236 = 6*IT_0071;
    const ccomplex_t IT_0237 = 24*IT_0176;
    const ccomplex_t IT_0238 = (-6)*IT_0107;
    const ccomplex_t IT_0239 = IT_0093*IT_0179 + conj(IT_0134)*IT_0181 +
      ...
      *conj(IT_0209) + IT_0219*IT_0224 + conj(IT_0093)*IT_0229 + IT_0050*IT_0234
       + (conj(IT_0107) + conj(IT_0193))*IT_0236 + conj(IT_0224)*IT_0237 + conj
      (IT_0050)*IT_0238;
    const ccomplex_t IT_0240 = IT_0055 + IT_0232;
    const ccomplex_t IT_0241 = 6*IT_0056;
    const ccomplex_t IT_0242 = 6*IT_0227;
    const ccomplex_t IT_0243 = 6*IT_0235;
    const ccomplex_t IT_0244 = 6*IT_0220;
    ...
    const ccomplex_t IT_0251 = IT_0180*IT_0229 + IT_0238*IT_0240 + IT_0193
      *IT_0241 + IT_0218*IT_0242 + IT_0135*IT_0243 + IT_0224*IT_0244 + IT_0227
    ...
    const ccomplex_t IT_0262 = (-6)*IT_0220;
    const ccomplex_t IT_0263 = IT_0233*IT_0238 + IT_0209*IT_0241 + IT_0093
      *IT_0252 + IT_0119*IT_0253 + IT_0180*IT_0254 + IT_0193*IT_0255 + IT_0050
      *IT_0256 + IT_0227*IT_0257 + IT_0166*IT_0258 + IT_0200*IT_0259 + IT_0218
    ...
    const ccomplex_t IT_0270 = IT_0181*IT_0227 + IT_0220*IT_0236 + IT_0053
      *IT_0237 + IT_0209*IT_0242 + IT_0166*IT_0252 + IT_0200*IT_0253 + IT_0228
      *IT_0254 + IT_0224*IT_0256 + IT_0193*IT_0260 + IT_0050*IT_0262 + IT_0093
      *IT_0265 + IT_0119*IT_0266 + IT_0218*IT_0268 + IT_0134*IT_0269;
    const ccomplex_t IT_0271 = IT_0178*IT_0180 + IT_0231*IT_0245 + IT_0093
    ...
    const ccomplex_t IT_0272 = 12*IT_0227;
    const ccomplex_t IT_0273 = IT_0181*IT_0220 + IT_0227*IT_0236 + IT_0209
      ...
      *IT_0266 + IT_0224*IT_0268 + IT_0134*IT_0272;
    ...
    const ccomplex_t IT_0276 = IT_0180*IT_0245 + IT_0209*IT_0250 + IT_0224
      ...
      *IT_0264 + IT_0134*IT_0265 + IT_0231*IT_0274 + IT_0227*IT_0275;
    const ccomplex_t IT_0277 = IT_0073*IT_0245 + IT_0209*IT_0249 + IT_0218
      ...
      *IT_0264 + IT_0134*IT_0266 + IT_0228*IT_0274 + IT_0220*IT_0275;
    ...
    const ccomplex_t IT_0283 = IT_0220*IT_0237 + IT_0193*IT_0261 + IT_0200
      *IT_0265 + IT_0166*IT_0266 + IT_0134*IT_0268 + IT_0218*IT_0269 + IT_0224
      *IT_0272 + IT_0240*IT_0274 + IT_0278 + IT_0050*IT_0279 + IT_0280 + IT_0281
       + IT_0282;
    const ccomplex_t IT_0284 = IT_0056*IT_0236 + IT_0050*IT_0255 + IT_0193
      *IT_0256 + IT_0220*IT_0257 + IT_0200*IT_0258 + IT_0166*IT_0259 + IT_0224
    ...
    const ccomplex_t IT_0285 = IT_0050*IT_0056*IT_0072 + IT_0073*(24*conj
      ...
      *IT_0176*conj(IT_0176) + conj(IT_0107)*IT_0181 + IT_0218*IT_0219) +
       IT_0220*(IT_0120*IT_0176 + conj(IT_0176)*IT_0178 + IT_0072*IT_0218 +
       IT_0134*IT_0219 + IT_0182*IT_0224 + IT_0166*IT_0225 + IT_0050*IT_0226) + 
      (24*conj(IT_0107)*IT_0176 + 24*IT_0107*conj(IT_0176) + IT_0177*IT_0209 +
       IT_0182*IT_0218 + IT_0072*IT_0224 + IT_0200*IT_0225 + IT_0193*IT_0226)
      ...
      *IT_0166 + IT_0093*IT_0177 + IT_0136*IT_0224 + IT_0200*IT_0230)*IT_0231 +
       IT_0193*IT_0233*IT_0234 + IT_0235*IT_0239 + (IT_0134*IT_0230 + IT_0209
      *IT_0234)*IT_0240 + conj(IT_0209)*IT_0251 + conj(IT_0193)*IT_0263 + conj
      (IT_0119)*IT_0267 + conj(IT_0218)*IT_0270 + conj(IT_0093)*IT_0271 + conj
      (IT_0224)*IT_0273 + conj(IT_0200)*IT_0276 + conj(IT_0166)*IT_0277 + conj
