...
ccomplex_return_t c_sumSqAmpl_C_1_N_2_to_Hp_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_B2*V_u1*e_em;
    ...
    const ccomplex_t IT_0018 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0028 = 2*IT_0003;
    const ccomplex_t IT_0029 = pow(m_C_1, 2);
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + -IT_0001 + -IT_0029 + m_Hp*
    ...
    const ccomplex_t IT_0038 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = (-2)*IT_0039;
    const ccomplex_t IT_0041 = IT_0006*IT_0036;
    const ccomplex_t IT_0042 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0075 = IT_0029*(conj(IT_0034)*IT_0058 + IT_0034*conj
      ...
      *IT_0069 + IT_0058*conj(IT_0069) + conj(IT_0034)*IT_0071 + IT_0034*conj
      (IT_0071))*IT_0072 + 0.5*(conj(IT_0054)*IT_0069 + IT_0054*conj(IT_0069) +
    ...
    const ccomplex_t IT_0079 = IT_0001*IT_0076;
    const ccomplex_t IT_0080 = pow(s_12, 2);
    const ccomplex_t IT_0081 = (-2)*IT_0080;
    const ccomplex_t IT_0082 = 0.5*IT_0054;
    const ccomplex_t IT_0083 = 0.5*IT_0071;
    const ccomplex_t IT_0084 = (-2)*conj(IT_0057)*(IT_0035*IT_0058 + -IT_0034
      *IT_0059 + (-4)*IT_0057*IT_0061 + -IT_0060*IT_0062 + 2*IT_0054*IT_0066) + 
      ...
      (IT_0071)*(IT_0058*IT_0077 + IT_0054*IT_0078) + conj(IT_0069)*(IT_0034
      *IT_0077 + IT_0062*IT_0078) + 2*conj(IT_0062)*(IT_0057*IT_0060 + (-2)
      *IT_0027*IT_0066 + 0.5*IT_0069*IT_0078 + 0.5*IT_0062*IT_0079 + 0.5*IT_0034
      *IT_0081) + (-2)*conj(IT_0034)*(IT_0027*IT_0035 + -IT_0057*IT_0059 + (-0.5
      )*IT_0029*IT_0034*IT_0076 + (-0.5)*IT_0069*IT_0077 + (-0.5)*IT_0062
      *IT_0081) + (-2)*conj(IT_0058)*(IT_0035*IT_0057 + -IT_0027*IT_0059 + (-0.5
      )*IT_0029*IT_0058*IT_0076 + -IT_0081*IT_0082 + -IT_0077*IT_0083) + 2*conj
      (IT_0054)*(IT_0027*IT_0060 + (-2)*IT_0057*IT_0066 + 0.5*IT_0058*IT_0081 +
       IT_0079*IT_0082 + IT_0078*IT_0083);
