        ...
        )
{
    ...
    const ccomplex_t IT_0009 = conj(N_B2)*e_em;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0000*IT_0004;
    ...
    const ccomplex_t IT_0072 = m_e*s_24*m_C_1;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004;
    const ccomplex_t IT_0074 = 0.5*IT_0073;
    const ccomplex_t IT_0075 = N_W2*e_em*conj(U_Wm1);
    const ccomplex_t IT_0076 = IT_0004*IT_0075;
    const ccomplex_t IT_0077 = N_d2*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0008;
    const ccomplex_t IT_0117 = -IT_0116;
    const ccomplex_t IT_0118 = IT_0006*IT_0117;
    const ccomplex_t IT_0119 = cpow((-2)*s_23 + IT_0018 + IT_0042 + -m_se_R*
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0004;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0124 = (-0.5)*IT_0123;
    const ccomplex_t IT_0125 = IT_0122*IT_0124;
    const ccomplex_t IT_0126 = cpow((-2)*s_23 + IT_0018 + IT_0042 + -m_se_L*
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0004;
    ...
    const ccomplex_t IT_0136 = conj(N_W2)*e_em*V_Wp1;
    const ccomplex_t IT_0137 = IT_0004*IT_0136;
    const ccomplex_t IT_0138 = conj(N_u2)*V_u1*e_em;
    ...
    const ccomplex_t IT_0146 = conj(IT_0022) + 0.5*conj(IT_0129);
    const ccomplex_t IT_0147 = conj(IT_0085)*IT_0115 + IT_0085*conj(IT_0115) +
       -(IT_0022 + 0.5*IT_0129)*conj(IT_0135) + (-2)*(IT_0022 + (-0.5)*IT_0065 +
       0.5*IT_0129)*conj(IT_0145) + -IT_0135*IT_0146 + IT_0145*(conj(IT_0065) + 
      (-2)*IT_0146);
    const ccomplex_t IT_0148 = 8*conj(IT_0145);
    const ccomplex_t IT_0149 = 0.25*IT_0148;
    const ccomplex_t IT_0150 = conj(IT_0135) + IT_0149;
    const ccomplex_t IT_0151 = -IT_0066;
    const ccomplex_t IT_0152 = IT_0067 + IT_0068 + IT_0151;
    const ccomplex_t IT_0153 = 2*IT_0022;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0168 = IT_0126*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*IT_0168;
    const ccomplex_t IT_0170 = -IT_0158 + -IT_0169;
    const ccomplex_t IT_0171 = 8*IT_0085;
    const ccomplex_t IT_0172 = m_e*s_14*m_N_2;
    const ccomplex_t IT_0173 = 2*IT_0172;
    const ccomplex_t IT_0174 = s_34*m_C_1*m_N_2;
    const ccomplex_t IT_0175 = 2*IT_0174;
    const ccomplex_t IT_0176 = 4*IT_0172;
    const ccomplex_t IT_0177 = 4*IT_0068;
    const ccomplex_t IT_0178 = 8*conj(IT_0085);
    const ccomplex_t IT_0179 = (-2)*IT_0072;
    const ccomplex_t IT_0180 = 2*conj(IT_0022);
    const ccomplex_t IT_0181 = (-2)*IT_0174;
    const ccomplex_t IT_0182 = IT_0070 + IT_0151;
    const ccomplex_t IT_0183 = (-2)*IT_0182;
    const ccomplex_t IT_0184 = 0.25*conj(IT_0115);
    const ccomplex_t IT_0185 = (-4)*IT_0174;
    const ccomplex_t IT_0186 = 0.25*conj(IT_0129);
    const ccomplex_t IT_0187 = 0.25*conj(IT_0135);
    const ccomplex_t IT_0188 = 0.25*conj(IT_0170);
    const ccomplex_t IT_0189 = 4*IT_0172*((conj(IT_0022) + conj(IT_0065))
      *IT_0085 + (IT_0022 + IT_0065)*conj(IT_0085) + conj(IT_0115)*IT_0145 +
       IT_0115*conj(IT_0145) + 0.25*IT_0129*IT_0178 + 0.25*IT_0170*IT_0180 +
       IT_0171*IT_0186 + IT_0153*IT_0188);
    const ccomplex_t IT_0190 = (-2)*IT_0022*conj(IT_0065)*IT_0071 + (-4)
      *IT_0072*IT_0147 + 4*IT_0067*(IT_0022*conj(IT_0022) + 2*IT_0145*(conj
      (IT_0135) + 2*conj(IT_0145)) + IT_0135*IT_0150) + conj(IT_0129)*IT_0152
      *IT_0153 + IT_0068*(16*IT_0085*conj(IT_0085) + conj(IT_0170)*IT_0171) +
       IT_0135*(conj(IT_0115)*IT_0173 + conj(IT_0170)*IT_0175 + conj(IT_0065)
      *IT_0179) + IT_0170*(conj(IT_0065)*IT_0173 + conj(IT_0135)*IT_0175 + conj
      (IT_0129)*IT_0176 + conj(IT_0170)*IT_0177 + IT_0068*IT_0178 + conj(IT_0115
      )*IT_0179) + IT_0129*(conj(IT_0170)*IT_0176 + conj(IT_0129)*IT_0177 +
       IT_0152*IT_0180 + conj(IT_0115)*IT_0181 + conj(IT_0065)*IT_0183) + 4
      *IT_0174*(conj(IT_0085)*IT_0135 + IT_0085*IT_0150 + conj(IT_0145)*IT_0170 
      + 2*IT_0145*(conj(IT_0085) + 0.5*conj(IT_0170)) + 0.25*IT_0115*IT_0180 +
       IT_0153*IT_0184) + 4*IT_0065*(conj(IT_0065)*IT_0066 + (-0.5)*conj(IT_0022
      )*IT_0071 + IT_0184*IT_0185 + IT_0183*IT_0186 + IT_0179*IT_0187 + IT_0173
      *IT_0188) + 4*IT_0115*(IT_0066*conj(IT_0115) + 0.25*conj(IT_0065)*IT_0185 
      + IT_0181*IT_0186 + IT_0173*IT_0187 + IT_0179*IT_0188) + IT_0189;
