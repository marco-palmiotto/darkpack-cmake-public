...
ccomplex_return_t c_sumSqAmpl_C_1_N_2_to_anti_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
    ...
    const ccomplex_t IT_0086 = m_mu*s_24*m_C_1;
    ...
    const ccomplex_t IT_0101 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0005*IT_0007*IT_0033;
    const ccomplex_t IT_0103 = (-0.5)*IT_0102;
    const ccomplex_t IT_0104 = IT_0101*IT_0103;
    const ccomplex_t IT_0105 = pow(m_mu, 2);
    const ccomplex_t IT_0106 = cpow((-2)*s_23 + IT_0003 + IT_0105 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0107 = IT_0104*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = s_13*s_24;
    const ccomplex_t IT_0110 = s_14*s_23;
    const ccomplex_t IT_0111 = -IT_0110;
    const ccomplex_t IT_0112 = IT_0109 + IT_0111;
    const ccomplex_t IT_0113 = -IT_0000;
    const ccomplex_t IT_0114 = IT_0112 + IT_0113;
    const ccomplex_t IT_0115 = (-2)*IT_0108*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0005*IT_0007*IT_0033;
    ...
    const ccomplex_t IT_0127 = cpow((-2)*s_13 + IT_0002 + IT_0105 + reg_prop +
    ...
    const ccomplex_t IT_0130 = IT_0000 + IT_0112;
    const ccomplex_t IT_0131 = (-2)*IT_0129*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0019;
    const ccomplex_t IT_0133 = -IT_0132;
    const ccomplex_t IT_0134 = IT_0117*IT_0133;
    const ccomplex_t IT_0135 = cpow((-2)*s_23 + IT_0003 + IT_0105 + -m_smu_R*
    ...
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0005*IT_0007*IT_0033;
    const ccomplex_t IT_0151 = 0.5*IT_0150;
    const ccomplex_t IT_0152 = IT_0117*IT_0151;
    ...
    const ccomplex_t IT_0163 = IT_0101*IT_0162;
    ...
    const ccomplex_t IT_0167 = m_mu*s_14*m_N_2;
    const ccomplex_t IT_0168 = 2*IT_0167;
    const ccomplex_t IT_0169 = IT_0166*IT_0168;
    const ccomplex_t IT_0170 = IT_0085 + IT_0100 + IT_0115 + IT_0131 + IT_0138
       + IT_0146 + IT_0149 + IT_0169;
    const ccomplex_t IT_0171 = 2*IT_0084;
    const ccomplex_t IT_0172 = IT_0109 + IT_0110 + IT_0113;
    const ccomplex_t IT_0173 = conj(IT_0108) + conj(IT_0137);
    const ccomplex_t IT_0174 = 2*IT_0129;
    const ccomplex_t IT_0175 = IT_0108 + IT_0137;
    const ccomplex_t IT_0176 = 2*conj(IT_0129);
    const ccomplex_t IT_0177 = 4*IT_0129;
    ...
    const ccomplex_t IT_0206 = (-2)*conj(IT_0108)*IT_0114;
    const ccomplex_t IT_0207 = conj(IT_0144)*IT_0145;
    const ccomplex_t IT_0208 = (-2)*conj(IT_0129)*IT_0130;
    const ccomplex_t IT_0209 = (-2)*IT_0114*conj(IT_0137);
    const ccomplex_t IT_0210 = 4*IT_0108;
    const ccomplex_t IT_0211 = 4*IT_0137;
    const ccomplex_t IT_0212 = 4*conj(IT_0108);
    const ccomplex_t IT_0213 = 0.5*IT_0166;
    const ccomplex_t IT_0214 = 0.5*IT_0052*(IT_0099 + 0.5*IT_0144) + 0.5
      *IT_0051*(conj(IT_0099) + 0.5*conj(IT_0144)) + (conj(IT_0108) + 0.5*conj
      (IT_0129) + conj(IT_0137))*IT_0198 + (IT_0175 + 0.125*IT_0177)*conj
    ...
    const ccomplex_t IT_0216 = (conj(IT_0108) + 2*conj(IT_0129) + conj(IT_0137
      ))*IT_0144 + conj(IT_0144)*(IT_0175 + 0.5*IT_0177) + 0.5*IT_0182*IT_0198 +
       (-2)*conj(IT_0198)*(IT_0030 + (-0.25)*IT_0202) + 4*conj(IT_0099)*(IT_0129
       + 0.125*IT_0210 + 0.125*IT_0211) + 4*IT_0099*(conj(IT_0129) + 0.5*conj
    ...
    const ccomplex_t IT_0217 = 4*IT_0000*IT_0051*IT_0052 + (conj(IT_0069) +
      ...
      *IT_0171 + IT_0172*(IT_0173*IT_0174 + IT_0175*IT_0176) + IT_0109*(16
      *IT_0099*conj(IT_0099) + conj(IT_0129)*IT_0177 + conj(IT_0144)*IT_0178 + 4
      *IT_0144*(conj(IT_0144) + 0.25*IT_0179)) + 4*IT_0084*IT_0203 + IT_0147*
      (IT_0204 + IT_0205 + IT_0206 + IT_0207 + IT_0208 + IT_0209) + 8*IT_0167
      *IT_0214 + 8*IT_0110*(IT_0198*(conj(IT_0166) + 2*conj(IT_0198)) + 1./8
