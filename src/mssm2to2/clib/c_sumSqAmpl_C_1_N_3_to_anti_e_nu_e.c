        ...
        )
{
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0008;
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0169 = m_e*s_14*m_N_3;
