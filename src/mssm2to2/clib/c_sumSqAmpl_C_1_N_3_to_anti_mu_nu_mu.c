        ...
        )
{
    ...
    const ccomplex_t IT_0026 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = (-2)*IT_0027;
    const ccomplex_t IT_0029 = IT_0001*IT_0008;
    const ccomplex_t IT_0030 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0056 = IT_0026*IT_0049;
