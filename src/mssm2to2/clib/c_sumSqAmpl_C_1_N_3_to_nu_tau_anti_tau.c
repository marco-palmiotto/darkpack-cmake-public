...
ccomplex_return_t c_sumSqAmpl_C_1_N_3_to_nu_tau_anti_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0005 = IT_0001*IT_0004;
    const ccomplex_t IT_0006 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0018 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0019 = IT_0001*IT_0018;
    const ccomplex_t IT_0020 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0028 = s_34*m_C_1*m_N_3;
    ...
    const ccomplex_t IT_0040 = N_u3*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0080 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0081 = IT_0039*IT_0080;
    const ccomplex_t IT_0082 = (-2)*IT_0081;
    const ccomplex_t IT_0083 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0084 = IT_0045*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_W3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0096 = IT_0064*IT_0086;
    ...
    const ccomplex_t IT_0101 = IT_0064*IT_0080;
    ...
    const ccomplex_t IT_0110 = conj(N_B3)*e_em*conj(U_stau_11);
    ...
    const ccomplex_t IT_0114 = conj(N_d3)*e_em*m_tau*IT_0033*conj(U_stau_01);
    ...
    const ccomplex_t IT_0129 = conj(N_B3)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0130 = IT_0044*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = conj(N_d3)*e_em*m_tau*IT_0033*conj(U_stau_00);
    ...
    const ccomplex_t IT_0198 = s_13*m_N_3*m_tau;
