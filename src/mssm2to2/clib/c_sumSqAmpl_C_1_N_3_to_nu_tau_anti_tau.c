        ...
        )
{
    ...
    const ccomplex_t IT_0037 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0038 = IT_0002*IT_0037;
    const ccomplex_t IT_0039 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0108 = IT_0076*IT_0098;
    ...
    const ccomplex_t IT_0113 = IT_0076*IT_0092;
    ...
    const ccomplex_t IT_0122 = conj(N_B3)*e_em*conj(U_stau_11);
    ...
    const ccomplex_t IT_0126 = conj(N_d3)*e_em*m_tau*IT_0047*conj(U_stau_01);
    ...
    const ccomplex_t IT_0141 = conj(N_B3)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0142 = IT_0020*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = conj(N_d3)*e_em*m_tau*IT_0047*conj(U_stau_00);
