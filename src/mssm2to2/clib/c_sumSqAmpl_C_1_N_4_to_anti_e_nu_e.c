        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_u4*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0018 = N_B4*V_u1*e_em;
    const ccomplex_t IT_0019 = IT_0017*IT_0018;
    const ccomplex_t IT_0020 = 1.4142135623731*IT_0019;
    const ccomplex_t IT_0021 = N_W4*V_u1*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0056 = IT_0011*IT_0055;
    const ccomplex_t IT_0057 = (-2)*IT_0056;
    const ccomplex_t IT_0058 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0059 = IT_0017*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0072 = IT_0035*IT_0055;
    ...
    const ccomplex_t IT_0076 = IT_0035*IT_0061;
    ...
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
    ...
    const ccomplex_t IT_0109 = m_e*s_14*m_N_4;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0016;
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0005*IT_0007*IT_0032;
    ...
    const ccomplex_t IT_0192 = N_W4*e_em*conj(U_Wm1);
    const ccomplex_t IT_0193 = IT_0007*IT_0192;
    const ccomplex_t IT_0194 = N_d4*conj(U_d1)*e_em;
