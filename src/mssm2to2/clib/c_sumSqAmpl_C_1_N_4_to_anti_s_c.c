...
ccomplex_return_t c_sumSqAmpl_C_1_N_4_to_anti_s_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
    ...
    const ccomplex_t IT_0152 = IT_0032*IT_0136;
    ...
    const ccomplex_t IT_0156 = IT_0032*IT_0142;
    ...
    const ccomplex_t IT_0179 = m_s*s_14*m_N_4;
    ...
    const ccomplex_t IT_0203 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0015;
    ...
    const ccomplex_t IT_0219 = m_c*s_13*m_N_4;
    ...
    const ccomplex_t IT_0227 = s_34*m_C_1*m_N_4;
    ...
    const ccomplex_t IT_0235 = m_c*m_s*m_C_1*m_N_4;
