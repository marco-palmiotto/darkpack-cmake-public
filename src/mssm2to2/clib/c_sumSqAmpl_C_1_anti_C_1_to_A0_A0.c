...
ccomplex_return_t c_sumSqAmpl_C_1_anti_C_1_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0019 + IT_0020 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0018*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0019 + (0 + _Complex_I*1)
      *m_C_1*Gamma_c1 + reg_prop, -1);
    const ccomplex_t IT_0028 = conj(V_u1)*conj(U_Wm1);
    const ccomplex_t IT_0029 = IT_0000*IT_0028;
    const ccomplex_t IT_0030 = conj(U_d1)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0019 + (0 + _Complex_I*1)
      *m_C_1*Gamma_c1 + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0042*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = IT_0023 + -IT_0026 + IT_0044 + -IT_0047;
    const ccomplex_t IT_0049 = cpow(IT_0034, 2);
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*m_C_1*IT_0049;
    const ccomplex_t IT_0051 = IT_0045*IT_0050;
    const ccomplex_t IT_0052 = IT_0027*IT_0050;
    const ccomplex_t IT_0053 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0054 = IT_0000*IT_0053;
    const ccomplex_t IT_0055 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0062 = IT_0024*IT_0060*IT_0061;
    const ccomplex_t IT_0063 = IT_0021*IT_0060*IT_0061;
    const ccomplex_t IT_0064 = m_C_1*IT_0023;
    const ccomplex_t IT_0065 = m_C_1*IT_0047;
    const ccomplex_t IT_0066 = m_C_1*IT_0044;
    ...
    const ccomplex_t IT_0080 = cpow(IT_0003, 3);
    const ccomplex_t IT_0081 = cpow(IT_0003, 2);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_W*e_em*IT_0079*(IT_0068
      *IT_0080 + -IT_0000*(IT_0000*(IT_0003*IT_0068 + IT_0000*IT_0070) + 
      -IT_0070*IT_0081));
    ...
    const ccomplex_t IT_0087 = cpow((-2)*s_12 + (-2)*IT_0020 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0088 = IT_0030*IT_0068;
    const ccomplex_t IT_0089 = IT_0028*IT_0070;
    const ccomplex_t IT_0090 = IT_0007*(IT_0088 + IT_0089);
    ...
    const ccomplex_t IT_0094 = -IT_0000;
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_W*e_em*IT_0079*(IT_0070
      *IT_0080 + IT_0094*(IT_0068*IT_0081 + (IT_0000*IT_0068 + -IT_0003*IT_0070)
      *IT_0094));
    ...
    const ccomplex_t IT_0111 = IT_0051 + IT_0052 + IT_0062 + IT_0063 + IT_0064
       + IT_0065 + IT_0066 + IT_0086 + IT_0099 + IT_0110;
    const ccomplex_t IT_0112 = s_14*m_C_1;
    const ccomplex_t IT_0113 = cpow(IT_0041, 2);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*m_C_1*IT_0113;
    const ccomplex_t IT_0115 = IT_0045*IT_0114;
    const ccomplex_t IT_0116 = IT_0027*IT_0114;
    const ccomplex_t IT_0117 = IT_0035*IT_0068;
    const ccomplex_t IT_0118 = IT_0037*IT_0070;
    ...
    const ccomplex_t IT_0135 = IT_0017*IT_0106;
    const ccomplex_t IT_0136 = IT_0024*IT_0061*IT_0135;
    const ccomplex_t IT_0137 = IT_0021*IT_0061*IT_0135;
    const ccomplex_t IT_0138 = IT_0021*IT_0107;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*IT_0138;
    const ccomplex_t IT_0140 = m_C_1*IT_0139;
    const ccomplex_t IT_0141 = m_C_1*IT_0026;
    const ccomplex_t IT_0142 = IT_0065 + IT_0066 + IT_0115 + IT_0116 + IT_0125
       + IT_0134 + IT_0136 + IT_0137 + IT_0140 + IT_0141;
    const ccomplex_t IT_0143 = s_24*m_C_1;
    const ccomplex_t IT_0144 = IT_0044 + -IT_0047 + -IT_0109 + IT_0139;
    const ccomplex_t IT_0145 = IT_0019*IT_0020;
    ...
    const ccomplex_t IT_0150 = 2*s_12;
    const ccomplex_t IT_0151 = (-2)*conj(IT_0142);
    const ccomplex_t IT_0152 = (-2)*IT_0144;
    const ccomplex_t IT_0153 = (-2)*IT_0048*(conj(IT_0111)*IT_0112 + -conj
      (IT_0142)*IT_0143 + conj(IT_0144)*IT_0145 + conj(IT_0048)*IT_0149) + (-2)
      *IT_0142*(IT_0020*conj(IT_0111) + -conj(IT_0048)*IT_0143 + IT_0112*conj
      (IT_0144) + (-0.5)*conj(IT_0142)*IT_0150) + (-2)*IT_0111*(conj(IT_0048)
      *IT_0112 + -IT_0143*conj(IT_0144) + (-0.5)*conj(IT_0111)*IT_0150 + (-0.5)
      *IT_0020*IT_0151) + 2*IT_0144*(conj(IT_0111)*IT_0143 + 0.5*IT_0112*IT_0151
      ) + (conj(IT_0048)*IT_0145 + conj(IT_0144)*IT_0149)*IT_0152;
