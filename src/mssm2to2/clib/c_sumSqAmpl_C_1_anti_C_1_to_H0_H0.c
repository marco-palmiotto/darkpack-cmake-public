        ...
        )
{
    ...
    const ccomplex_t IT_0014 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0027 = conj(U_d1)*conj(V_Wp1);
    const ccomplex_t IT_0028 = IT_0000*IT_0027;
    const ccomplex_t IT_0029 = conj(V_u1)*conj(U_Wm1);
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0021 + IT_0022 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0047 = IT_0020*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0021 + (0 + _Complex_I*1)
      *m_C_1*Gamma_c1 + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0043*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = IT_0025 + IT_0045 + -IT_0048 + -IT_0051;
    const ccomplex_t IT_0053 = cpow(IT_0034, 2);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*m_C_1*IT_0053;
    ...
    const ccomplex_t IT_0067 = IT_0046*IT_0065*IT_0066;
    const ccomplex_t IT_0068 = IT_0023*IT_0065*IT_0066;
    const ccomplex_t IT_0069 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + (-2)*IT_0022 + -reg_prop, -1);
    const ccomplex_t IT_0070 = IT_0000*IT_0029;
    const ccomplex_t IT_0071 = IT_0003*IT_0027;
    ...
    const ccomplex_t IT_0089 = U_d2*V_Wp1;
    const ccomplex_t IT_0090 = IT_0000*IT_0089;
    const ccomplex_t IT_0091 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0097 = IT_0064*IT_0096;
    ...
    const ccomplex_t IT_0101 = cpow((-2)*s_12 + (-2)*IT_0022 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0102 = cpow(IT_0000, 2);
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*m_W*e_em*IT_0079*(IT_0081
      *IT_0082 + -IT_0000*(IT_0000*IT_0003*IT_0082 + IT_0080*(IT_0083 + -IT_0102
      )));
    ...
    const ccomplex_t IT_0108 = m_C_1*IT_0051;
    const ccomplex_t IT_0109 = m_C_1*IT_0045;
    const ccomplex_t IT_0110 = m_C_1*IT_0025;
    const ccomplex_t IT_0111 = IT_0055 + IT_0056 + IT_0067 + IT_0068 + IT_0088
       + IT_0100 + IT_0107 + IT_0108 + IT_0109 + IT_0110;
    const ccomplex_t IT_0112 = s_14*m_C_1;
    const ccomplex_t IT_0113 = cpow(IT_0042, 2);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*m_C_1*IT_0113;
    const ccomplex_t IT_0115 = IT_0049*IT_0114;
    const ccomplex_t IT_0116 = IT_0026*IT_0114;
    const ccomplex_t IT_0117 = IT_0042*IT_0104;
    const ccomplex_t IT_0118 = IT_0101*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*IT_0118;
    const ccomplex_t IT_0120 = IT_0019*IT_0096;
    const ccomplex_t IT_0121 = IT_0046*IT_0066*IT_0120;
    const ccomplex_t IT_0122 = IT_0023*IT_0066*IT_0120;
    const ccomplex_t IT_0123 = IT_0000*IT_0037;
    const ccomplex_t IT_0124 = IT_0003*IT_0035;
    ...
    const ccomplex_t IT_0132 = IT_0023*IT_0097;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*IT_0132;
    const ccomplex_t IT_0134 = m_C_1*IT_0133;
    const ccomplex_t IT_0135 = m_C_1*IT_0048;
    const ccomplex_t IT_0136 = IT_0108 + IT_0109 + IT_0115 + IT_0116 + IT_0119
       + IT_0121 + IT_0122 + IT_0131 + IT_0134 + IT_0135;
    const ccomplex_t IT_0137 = s_24*m_C_1;
    const ccomplex_t IT_0138 = IT_0045 + -IT_0051 + -IT_0099 + IT_0133;
    const ccomplex_t IT_0139 = IT_0021*IT_0022;
    ...
    const ccomplex_t IT_0146 = (-2)*IT_0138;
    const ccomplex_t IT_0147 = (-2)*IT_0052*(conj(IT_0111)*IT_0112 + -conj
      (IT_0136)*IT_0137 + conj(IT_0138)*IT_0139 + conj(IT_0052)*IT_0143) + (-2)
      *IT_0136*(IT_0022*conj(IT_0111) + -conj(IT_0052)*IT_0137 + IT_0112*conj
      (IT_0138) + (-0.5)*conj(IT_0136)*IT_0144) + (-2)*IT_0111*(conj(IT_0052)
      *IT_0112 + -IT_0137*conj(IT_0138) + (-0.5)*conj(IT_0111)*IT_0144 + (-0.5)
      *IT_0022*IT_0145) + 2*IT_0138*(conj(IT_0111)*IT_0137 + 0.5*IT_0112*IT_0145
      ) + (conj(IT_0052)*IT_0139 + conj(IT_0138)*IT_0143)*IT_0146;
