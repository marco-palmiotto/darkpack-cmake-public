        ...
        )
{
    ...
    const ccomplex_t IT_0015 = m_c*e_em*IT_0010*IT_0014;
    ...
    const ccomplex_t IT_0027 = m_c*e_em*IT_0003*IT_0010*IT_0014*IT_0026;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*m_c*e_em*IT_0010*IT_0014
      *IT_0026*IT_0059;
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*m_c*e_em*IT_0010*IT_0014
      *IT_0026*IT_0057;
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0010*IT_0014*IT_0026;
    const ccomplex_t IT_0119 = 0.5*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u1
      *e_em*IT_0010*IT_0014*IT_0026;
    const ccomplex_t IT_0127 = 0.5*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *conj(V_u1)*e_em*IT_0010*IT_0014*IT_0026;
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*conj
    ...
    const ccomplex_t IT_0152 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_cd*e_em*IT_0010*IT_0014*IT_0151;
    ...
    const ccomplex_t IT_0160 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0010*IT_0014*IT_0151;
    ...
    const ccomplex_t IT_0168 = V_cb*e_em*U_Wm1*conj(U_sb_00);
    const ccomplex_t IT_0169 = IT_0010*IT_0168;
    const ccomplex_t IT_0170 = IT_0010*IT_0151;
    const ccomplex_t IT_0171 = m_b*U_d1*V_cb*e_em*IT_0014*conj(U_sb_10);
    ...
    const ccomplex_t IT_0175 = V_cb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0176 = IT_0010*IT_0175;
    const ccomplex_t IT_0177 = m_b*conj(U_d1)*V_cb*e_em*IT_0014*U_sb_10;
    ...
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm1)*IT_0010;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*conj(V_cd)*e_em*U_Wm1*IT_0010;
    ...
    const ccomplex_t IT_0189 = V_cb*e_em*U_Wm1*conj(U_sb_01);
    const ccomplex_t IT_0190 = IT_0010*IT_0189;
    const ccomplex_t IT_0191 = m_b*U_d1*V_cb*e_em*IT_0014*conj(U_sb_11);
    ...
    const ccomplex_t IT_0195 = V_cb*e_em*conj(U_Wm1)*U_sb_01;
    const ccomplex_t IT_0196 = IT_0010*IT_0195;
    const ccomplex_t IT_0197 = m_b*conj(U_d1)*V_cb*e_em*IT_0014*U_sb_11;
    ...
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0010;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*conj(V_cs)*e_em*U_Wm1*IT_0010;
    ...
    const ccomplex_t IT_0314 = m_c*s_23*m_C_1;
    ...
    const ccomplex_t IT_0326 = m_c*s_14*m_C_1;
    ...
    const ccomplex_t IT_0343 = m_c*s_24*m_C_1;
    const ccomplex_t IT_0344 = m_c*s_13*m_C_1;
