...
ccomplex_return_t c_sumSqAmpl_C_1_anti_C_1_to_anti_nu_e_nu_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0005*IT_0024*IT_0026;
    const ccomplex_t IT_0028 = (-0.5)*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_e*U_d1*e_em
      *IT_0005*IT_0024*IT_0026;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = IT_0028*IT_0030;
    const ccomplex_t IT_0032 = cpow(s_23 + (-0.5)*IT_0018 + 0.5*m_se_R*(m_se_R
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*e_em*U_Wm1*IT_0005;
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = cpow(s_23 + (-0.5)*IT_0018 + 0.5*m_se_L*(m_se_L
