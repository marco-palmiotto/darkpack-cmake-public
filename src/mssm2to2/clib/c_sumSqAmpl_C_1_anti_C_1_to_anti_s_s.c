        ...
        )
{
    ...
    const ccomplex_t IT_0104 = m_s*m_C_1;
    ...
    const ccomplex_t IT_0156 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0000*IT_0005*IT_0155;
    const ccomplex_t IT_0157 = 0.5*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0005;
    const ccomplex_t IT_0165 = -IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp1)
      *IT_0005;
    ...
    const ccomplex_t IT_0171 = cpow((-2)*s_13 + IT_0016 + IT_0052 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*V_us*e_em*V_Wp1*IT_0005;
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*V_us*e_em*conj(V_Wp1)*IT_0005;
    ...
    const ccomplex_t IT_0179 = conj(V_ts)*e_em*conj(V_Wp1)*U_st_01;
    const ccomplex_t IT_0180 = IT_0005*IT_0179;
    const ccomplex_t IT_0181 = IT_0005*IT_0155;
    const ccomplex_t IT_0182 = m_t*conj(V_ts)*conj(V_u1)*e_em*IT_0000*U_st_11;
    ...
    const ccomplex_t IT_0187 = m_t*V_ts*V_u1*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0192 = V_ts*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0212 = conj(V_ts)*e_em*conj(V_Wp1)*U_st_00;
    const ccomplex_t IT_0213 = IT_0005*IT_0212;
    const ccomplex_t IT_0214 = m_t*conj(V_ts)*conj(V_u1)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0219 = m_t*V_ts*V_u1*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0224 = V_ts*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0237 = m_s*s_23*m_C_1;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
    ...
    const ccomplex_t IT_0243 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
    ...
    const ccomplex_t IT_0248 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
    ...
    const ccomplex_t IT_0255 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*V_us
    ...
    const ccomplex_t IT_0263 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0268 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_us*e_em*IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0269 = (-0.5)*IT_0268;
    const ccomplex_t IT_0270 = IT_0256*IT_0269;
    const ccomplex_t IT_0271 = IT_0171*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*IT_0271;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
    ...
    const ccomplex_t IT_0280 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
    ...
    const ccomplex_t IT_0289 = m_s*s_14*m_C_1;
    const ccomplex_t IT_0290 = IT_0166*IT_0264;
    const ccomplex_t IT_0291 = IT_0168*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = IT_0218*IT_0281;
    const ccomplex_t IT_0294 = IT_0211*IT_0293;
    ...
    const ccomplex_t IT_0298 = IT_0174*IT_0269;
    const ccomplex_t IT_0299 = IT_0171*IT_0298;
    ...
    const ccomplex_t IT_0337 = (-12)*conj(IT_0296);
    const ccomplex_t IT_0338 = (-12)*IT_0253;
    const ccomplex_t IT_0339 = (-12)*conj(IT_0253);
    const ccomplex_t IT_0340 = conj(IT_0201)*IT_0288 + IT_0254*conj(IT_0296) +
      ...
      *IT_0332 + IT_0296*IT_0333 + conj(IT_0142)*(48*IT_0125 + 24*IT_0278 +
       IT_0334) + conj(IT_0125)*IT_0335 + IT_0125*IT_0336 + IT_0259*IT_0337 +
       conj(IT_0304)*(12*IT_0259 + IT_0338) + IT_0304*IT_0339;
    ...
    const ccomplex_t IT_0346 = conj(IT_0201)*IT_0202 + conj(IT_0253)*IT_0254 +
      ...
      (48*conj(IT_0142) + 24*conj(IT_0201) + IT_0336) + IT_0304*IT_0337 + conj
      (IT_0259)*IT_0338 + IT_0259*(12*conj(IT_0259) + IT_0339) + conj(IT_0233)
    ...
    const ccomplex_t IT_0357 = (-6)*conj(IT_0081);
    const ccomplex_t IT_0358 = (-6)*IT_0100;
    const ccomplex_t IT_0359 = (-6)*conj(IT_0100);
    const ccomplex_t IT_0360 = conj(IT_0100)*IT_0259 + IT_0100*conj(IT_0259) +
       4*conj(IT_0081)*(IT_0100 + 1./4*IT_0304) + 4*IT_0081*(conj(IT_0100) + -1.
      /4*conj(IT_0296) + 1./4*conj(IT_0304)) + 0.166666666666667*IT_0296*IT_0357
       + 0.166666666666667*conj(IT_0253)*IT_0358 + 0.166666666666667*IT_0253
      *IT_0359;
    const ccomplex_t IT_0361 = 2*IT_0147;
    const ccomplex_t IT_0362 = (-3)*IT_0081;
    const ccomplex_t IT_0363 = (-3)*conj(IT_0081);
    const ccomplex_t IT_0364 = (-3)*IT_0100;
    const ccomplex_t IT_0365 = (-3)*conj(IT_0100);
    const ccomplex_t IT_0366 = (-2)*IT_0147;
    const ccomplex_t IT_0367 = (-2)*IT_0107;
    const ccomplex_t IT_0368 = 2*IT_0107;
    const ccomplex_t IT_0369 = 24*IT_0154;
    const ccomplex_t IT_0370 = 48*IT_0316;
    const ccomplex_t IT_0371 = 24*IT_0262;
    const ccomplex_t IT_0372 = 48*IT_0341;
    const ccomplex_t IT_0373 = IT_0369 + IT_0370 + IT_0371 + IT_0372;
    const ccomplex_t IT_0374 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0375 = (-0.333333333333333)*IT_0374;
    const ccomplex_t IT_0376 = IT_0374*IT_0375;
    const ccomplex_t IT_0377 = cpow(s_12 + IT_0016 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0382 = m_s*s_13*m_C_1;
    const ccomplex_t IT_0383 = (-24)*IT_0304;
    const ccomplex_t IT_0384 = (-24)*conj(IT_0304);
    const ccomplex_t IT_0385 = 12*conj(IT_0233);
    const ccomplex_t IT_0386 = 24*conj(IT_0142);
    const ccomplex_t IT_0387 = IT_0235*conj(IT_0253) + conj(IT_0201)*IT_0254 +
       IT_0288*conj(IT_0296) + IT_0296*IT_0323 + conj(IT_0304)*IT_0326 + IT_0304
      *IT_0329 + IT_0201*IT_0333 + conj(IT_0233)*IT_0338 + IT_0233*IT_0339 +
       conj(IT_0259)*((-24)*IT_0142 + IT_0342 + IT_0343) + conj(IT_0125)*IT_0383
       + IT_0125*IT_0384 + IT_0259*((-24)*conj(IT_0142) + IT_0345 + IT_0385) +
       IT_0253*IT_0386;
    const ccomplex_t IT_0388 = m_s*s_24*m_C_1;
    const ccomplex_t IT_0389 = 12*conj(IT_0201);
    const ccomplex_t IT_0390 = (-12)*conj(IT_0233);
    const ccomplex_t IT_0391 = IT_0386 + IT_0389 + IT_0390;
    const ccomplex_t IT_0392 = 24*conj(IT_0253);
    const ccomplex_t IT_0393 = 24*conj(IT_0125)*IT_0253 + IT_0254*conj(IT_0278
      ) + IT_0236*conj(IT_0296) + conj(IT_0259)*((-24)*IT_0125 + IT_0324 +
       IT_0325) + IT_0259*((-24)*conj(IT_0125) + IT_0327 + IT_0328) + IT_0278
      *IT_0333 + conj(IT_0285)*IT_0338 + IT_0285*IT_0339 + conj(IT_0304)*IT_0344
       + conj(IT_0142)*IT_0383 + IT_0142*IT_0384 + IT_0304*(IT_0345 + IT_0385) +
       IT_0296*IT_0391 + IT_0125*IT_0392;
    const ccomplex_t IT_0394 = -conj(IT_0285);
    const ccomplex_t IT_0395 = -conj(IT_0032)*IT_0201 + (-2)*IT_0032*(conj
      (IT_0142) + 1./2*conj(IT_0201)) + conj(IT_0051)*(IT_0278 + -IT_0285) + (
      ...
      *conj(IT_0125)*IT_0352 + (-0.166666666666667)*IT_0125*IT_0353 + IT_0051*
      (conj(IT_0278) + IT_0394);
    const ccomplex_t IT_0396 = 12*IT_0154;
    const ccomplex_t IT_0397 = 24*IT_0316;
    const ccomplex_t IT_0398 = 24*IT_0341;
    const ccomplex_t IT_0399 = 12*IT_0262;
    const ccomplex_t IT_0400 = IT_0396 + IT_0397 + IT_0398 + IT_0399;
    const ccomplex_t IT_0401 = 48*IT_0314;
    const ccomplex_t IT_0402 = IT_0369 + IT_0370 + IT_0371 + IT_0401;
    ...
    const ccomplex_t IT_0411 = (-12)*IT_0154;
    const ccomplex_t IT_0412 = (-24)*IT_0316;
    const ccomplex_t IT_0413 = (-24)*IT_0341;
    const ccomplex_t IT_0414 = (-12)*IT_0262;
    const ccomplex_t IT_0415 = IT_0411 + IT_0412 + IT_0413 + IT_0414;
    const ccomplex_t IT_0416 = -(conj(IT_0125) + conj(IT_0142))*IT_0373 + (96
      *IT_0154 + 96*IT_0262 + 96*IT_0314 + 192*IT_0316 + 96*IT_0341)*IT_0380 + 
      (IT_0201 + -conj(IT_0201) + IT_0278 + -conj(IT_0278))*IT_0400 + -(conj
      (IT_0151) + conj(IT_0313))*IT_0402 + -(IT_0127 + IT_0144 + IT_0362 +
       IT_0364)*IT_0407 + -((-24)*IT_0253 + 24*IT_0259 + (-24)*conj(IT_0259) + (
      -24)*IT_0296 + 24*conj(IT_0296) + 24*IT_0304 + IT_0384 + IT_0392)*IT_0410 
      + (IT_0233 + -conj(IT_0233) + IT_0285 + IT_0394)*IT_0415;
    const ccomplex_t IT_0417 = s_12*s_34;
    const ccomplex_t IT_0418 = -IT_0417;
    const ccomplex_t IT_0419 = -IT_0341;
    const ccomplex_t IT_0420 = IT_0262 + IT_0314 + IT_0418 + IT_0419;
    const ccomplex_t IT_0421 = 0.166666666666667*IT_0259;
    const ccomplex_t IT_0422 = -IT_0314;
    const ccomplex_t IT_0423 = IT_0262 + IT_0341 + IT_0417 + IT_0422;
    const ccomplex_t IT_0424 = 6*(conj(IT_0032)*IT_0253 + IT_0032*conj(IT_0253
      ) + conj(IT_0051)*IT_0304 + IT_0051*conj(IT_0304) + 0.166666666666667*conj
      (IT_0259)*IT_0348 + 0.166666666666667*conj(IT_0296)*IT_0354 +
       0.166666666666667*IT_0296*IT_0355 + IT_0349*IT_0421)*IT_0423;
    const ccomplex_t IT_0425 = (-12)*conj(IT_0259);
    const ccomplex_t IT_0426 = IT_0333 + IT_0425;
    const ccomplex_t IT_0427 = 12*conj(IT_0296);
    const ccomplex_t IT_0428 = (-12)*conj(IT_0304);
    const ccomplex_t IT_0429 = IT_0427 + IT_0428;
    const ccomplex_t IT_0430 = 12*conj(IT_0051);
    const ccomplex_t IT_0431 = (-12)*conj(IT_0032);
    const ccomplex_t IT_0432 = IT_0381*IT_0402;
    const ccomplex_t IT_0433 = IT_0151*(IT_0108*IT_0127 + IT_0144*IT_0148 + 48
      *conj(IT_0151)*IT_0314 + IT_0262*IT_0323 + IT_0154*IT_0391 + IT_0237
      *IT_0426 + IT_0289*IT_0429 + IT_0308*IT_0430 + IT_0153*IT_0431 + IT_0432);
    const ccomplex_t IT_0434 = (24*IT_0032*conj(IT_0032) + 24*IT_0051*conj
      ...
      *IT_0354 + 0.166666666666667*IT_0201*IT_0355) + 6*IT_0356*IT_0360 +
       IT_0361*(conj(IT_0201)*IT_0362 + IT_0201*IT_0363 + conj(IT_0278)*IT_0364 
      + IT_0278*IT_0365) + (conj(IT_0233)*IT_0362 + IT_0233*IT_0363 + conj
      (IT_0285)*IT_0364 + IT_0285*IT_0365)*IT_0366 + (conj(IT_0278)*IT_0362 +
       IT_0278*IT_0363 + conj(IT_0201)*IT_0364 + IT_0201*IT_0365)*IT_0367 + 
      (conj(IT_0285)*IT_0362 + IT_0285*IT_0363 + conj(IT_0233)*IT_0364 + IT_0233
      *IT_0365)*IT_0368 + (IT_0125 + IT_0142)*IT_0373*IT_0381 + IT_0382*IT_0387 
      + IT_0388*IT_0393 + (-6)*IT_0308*IT_0395 + -IT_0380*IT_0416 + 6*IT_0420*
      (conj(IT_0081)*IT_0253 + IT_0081*(conj(IT_0253) + -conj(IT_0259)) + conj
      (IT_0100)*IT_0296 + IT_0100*conj(IT_0296) + 0.166666666666667*conj(IT_0304
      )*IT_0358 + 0.166666666666667*IT_0304*IT_0359 + IT_0357*IT_0421) + IT_0424
       + IT_0313*(IT_0108*IT_0144 + IT_0127*IT_0148 + IT_0154*IT_0323 + IT_0262
      *IT_0391 + IT_0289*IT_0426 + IT_0237*IT_0429 + IT_0153*IT_0430 + IT_0308
      *IT_0431 + IT_0432) + IT_0433;
