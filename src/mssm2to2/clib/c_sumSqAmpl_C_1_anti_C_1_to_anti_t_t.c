        ...
        )
{
    ...
    const ccomplex_t IT_0027 = m_t*e_em*IT_0009*IT_0013;
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u1
      *e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0119 = 0.5*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u1
      *e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0135 = 0.5*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_ts)
      *conj(V_u1)*e_em*IT_0009*IT_0013*IT_0014;
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0009;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*conj(V_td)*e_em*U_Wm1*IT_0009;
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm1)*IT_0009;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*conj(V_ts)*e_em*U_Wm1*IT_0009;
    ...
    const ccomplex_t IT_0178 = V_tb*e_em*U_Wm1*conj(U_sb_00);
    const ccomplex_t IT_0179 = IT_0009*IT_0178;
    const ccomplex_t IT_0180 = IT_0009*IT_0151;
    const ccomplex_t IT_0181 = m_b*U_d1*V_tb*e_em*IT_0013*conj(U_sb_10);
    ...
    const ccomplex_t IT_0185 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0186 = IT_0009*IT_0185;
    const ccomplex_t IT_0187 = m_b*conj(U_d1)*V_tb*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0194 = V_tb*e_em*U_Wm1*conj(U_sb_01);
    const ccomplex_t IT_0195 = IT_0009*IT_0194;
    const ccomplex_t IT_0196 = m_b*U_d1*V_tb*e_em*IT_0013*conj(U_sb_11);
    ...
    const ccomplex_t IT_0200 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    const ccomplex_t IT_0201 = IT_0009*IT_0200;
    const ccomplex_t IT_0202 = m_b*conj(U_d1)*V_tb*e_em*IT_0013*U_sb_11;
    ...
    const ccomplex_t IT_0342 = m_t*s_24*m_C_1;
    const ccomplex_t IT_0343 = m_t*s_13*m_C_1;
