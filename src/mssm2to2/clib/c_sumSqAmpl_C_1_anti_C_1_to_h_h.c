...
ccomplex_return_t c_sumSqAmpl_C_1_anti_C_1_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = V_u1*U_Wm1;
    ...
    const ccomplex_t IT_0030 = conj(U_d1)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0070 = m_C_1*IT_0024;
    const ccomplex_t IT_0071 = V_u1*U_Wm2;
    const ccomplex_t IT_0072 = IT_0003*IT_0071;
    const ccomplex_t IT_0073 = U_d2*V_Wp1;
    const ccomplex_t IT_0074 = IT_0006*IT_0073;
    const ccomplex_t IT_0075 = IT_0009*(IT_0072 + -IT_0074);
    ...
    const ccomplex_t IT_0083 = m_C_1*IT_0048;
    ...
    const ccomplex_t IT_0090 = cpow(IT_0006, 3);
    const ccomplex_t IT_0091 = sin(beta);
    const ccomplex_t IT_0092 = cpow(IT_0006, 2);
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*m_W*e_em*IT_0088*(IT_0089
      *IT_0090 + -IT_0003*(IT_0003*(IT_0006*IT_0089 + IT_0003*IT_0091) + 
      -IT_0091*IT_0092));
    const ccomplex_t IT_0094 = 1.5*IT_0093;
    const ccomplex_t IT_0095 = IT_0013*IT_0094;
    const ccomplex_t IT_0096 = IT_0084*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_12 + (-2)*IT_0045 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0099 = IT_0003*IT_0005;
    const ccomplex_t IT_0100 = IT_0002*IT_0006;
    const ccomplex_t IT_0101 = IT_0009*(IT_0099 + IT_0100);
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*m_W*e_em*IT_0088*(IT_0090
      *IT_0091 + (-5)*IT_0003*(IT_0003*IT_0006*IT_0091 + 1*IT_0089*(IT_0092 + 
      -1./5*IT_0105)));
    ...
    const ccomplex_t IT_0111 = IT_0063 + IT_0066 + IT_0067 + IT_0068 + IT_0069
       + IT_0070 + IT_0082 + IT_0083 + IT_0097 + IT_0110;
    ...
    const ccomplex_t IT_0117 = IT_0043*IT_0078;
    ...
    const ccomplex_t IT_0127 = IT_0098*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*IT_0127;
    const ccomplex_t IT_0129 = IT_0021*IT_0094;
    const ccomplex_t IT_0130 = IT_0084*IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*IT_0130;
    const ccomplex_t IT_0132 = IT_0046*IT_0079;
    ...
    const ccomplex_t IT_0136 = IT_0069 + IT_0070 + IT_0115 + IT_0116 + IT_0118
       + IT_0119 + IT_0128 + IT_0131 + IT_0134 + IT_0135;
    const ccomplex_t IT_0137 = s_24*m_C_1;
    const ccomplex_t IT_0138 = -IT_0024 + IT_0027 + -IT_0081 + IT_0133;
