...
ccomplex_return_t c_sumSqAmpl_C_1_anti_C_2_to_Hp_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = pow(m_C_2, 2);
    const ccomplex_t IT_0014 = cpow((-2)*s_12 + -IT_0012 + -IT_0013 + m_A0*
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0006
      *IT_0018 + -IT_0003*IT_0019);
    const ccomplex_t IT_0021 = IT_0007*IT_0018;
    const ccomplex_t IT_0022 = IT_0004*IT_0019;
    const ccomplex_t IT_0023 = IT_0001*(IT_0021 + IT_0022);
    const ccomplex_t IT_0024 = 1.4142135623731*e_em*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = 0.5*IT_0025;
    const ccomplex_t IT_0027 = cpow((-2)*s_12 + -IT_0012 + -IT_0013 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = IT_0020*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0003
      *IT_0018 + IT_0006*IT_0019);
    const ccomplex_t IT_0032 = -IT_0031;
    const ccomplex_t IT_0033 = IT_0004*IT_0018;
    const ccomplex_t IT_0034 = IT_0007*IT_0019;
    const ccomplex_t IT_0035 = IT_0001*(IT_0033 + -IT_0034);
    ...
    const ccomplex_t IT_0075 = pow(m_Hp, 2);
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0012 + IT_0075 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0074*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = conj(V_u2)*conj(U_Wm1);
    const ccomplex_t IT_0080 = IT_0018*IT_0079;
    const ccomplex_t IT_0081 = conj(U_d1)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_13 + IT_0012 + IT_0075 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0091 = N_W1*e_em*conj(V_Wp2);
    const ccomplex_t IT_0092 = IT_0001*IT_0091;
    const ccomplex_t IT_0093 = N_u1*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0114 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0115 = IT_0050*IT_0114;
    const ccomplex_t IT_0116 = 1.4142135623731*IT_0115;
    const ccomplex_t IT_0117 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0121 = conj(N_d3)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0127 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0128 = IT_0001*IT_0127;
    const ccomplex_t IT_0129 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0135 = cpow((-2)*s_13 + IT_0012 + IT_0075 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0136 = IT_0134*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*IT_0136;
    const ccomplex_t IT_0138 = cpow((-2)*s_13 + IT_0012 + IT_0075 + -m_N_4*
    ...
    const ccomplex_t IT_0152 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0153 = IT_0001*IT_0152;
    const ccomplex_t IT_0154 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0162 = IT_0018*IT_0081;
    const ccomplex_t IT_0163 = IT_0019*IT_0079;
    const ccomplex_t IT_0164 = IT_0001*(IT_0162 + IT_0163);
    ...
    const ccomplex_t IT_0168 = IT_0027*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*IT_0168;
    const ccomplex_t IT_0170 = IT_0020*IT_0169;
    const ccomplex_t IT_0171 = IT_0003*IT_0079;
    const ccomplex_t IT_0172 = IT_0006*IT_0081;
    const ccomplex_t IT_0173 = IT_0001*(IT_0171 + IT_0172);
    ...
    const ccomplex_t IT_0179 = (-2)*IT_0078 + -IT_0089 + (-2)*IT_0113 + (-2)
      *IT_0137 + (-2)*IT_0161 + -IT_0170 + -IT_0178;
    const ccomplex_t IT_0180 = m_C_1*m_C_2;
    const ccomplex_t IT_0181 = s_14*s_24*IT_0044;
    const ccomplex_t IT_0182 = -IT_0181;
    const ccomplex_t IT_0183 = s_12 + IT_0182;
    const ccomplex_t IT_0184 = IT_0180*IT_0183;
    const ccomplex_t IT_0185 = -IT_0089 + -IT_0170 + -IT_0178;
    const ccomplex_t IT_0186 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0187 = IT_0001*IT_0186;
    const ccomplex_t IT_0188 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0193 = IT_0001*IT_0003;
    const ccomplex_t IT_0194 = N_u4*e_em*V_Wp1;
    const ccomplex_t IT_0195 = IT_0193*IT_0194;
    const ccomplex_t IT_0196 = 2*IT_0195;
    const ccomplex_t IT_0197 = IT_0003*IT_0055;
    const ccomplex_t IT_0198 = N_B4*V_u1*e_em;
    const ccomplex_t IT_0199 = IT_0197*IT_0198;
    const ccomplex_t IT_0200 = 1.4142135623731*IT_0199;
    const ccomplex_t IT_0201 = N_W4*V_u1*e_em;
    ...
    const ccomplex_t IT_0208 = IT_0192*IT_0207;
    const ccomplex_t IT_0209 = IT_0138*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*IT_0209;
    const ccomplex_t IT_0211 = conj(N_W1)*e_em*U_Wm2;
    const ccomplex_t IT_0212 = IT_0001*IT_0211;
    const ccomplex_t IT_0213 = conj(N_d1)*U_d2*e_em;
    ...
    const ccomplex_t IT_0218 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0219 = IT_0193*IT_0218;
    const ccomplex_t IT_0220 = 2*IT_0219;
    const ccomplex_t IT_0221 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0222 = IT_0197*IT_0221;
    const ccomplex_t IT_0223 = 1.4142135623731*IT_0222;
    const ccomplex_t IT_0224 = N_W1*V_u1*e_em;
    const ccomplex_t IT_0225 = IT_0193*IT_0224;
    ...
    const ccomplex_t IT_0232 = IT_0090*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = conj(N_W2)*e_em*U_Wm2;
    const ccomplex_t IT_0235 = IT_0001*IT_0234;
    const ccomplex_t IT_0236 = conj(N_d2)*U_d2*e_em;
    ...
    const ccomplex_t IT_0241 = N_B2*V_u1*e_em;
    const ccomplex_t IT_0242 = IT_0197*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = N_W2*V_u1*e_em;
    const ccomplex_t IT_0245 = IT_0193*IT_0244;
    const ccomplex_t IT_0246 = 1.4142135623731*IT_0245;
    const ccomplex_t IT_0247 = IT_0243 + IT_0246;
    const ccomplex_t IT_0248 = N_u2*e_em*V_Wp1;
    const ccomplex_t IT_0249 = IT_0193*IT_0248;
    ...
    const ccomplex_t IT_0255 = IT_0076*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0258 = IT_0001*IT_0257;
    const ccomplex_t IT_0259 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0264 = N_u3*e_em*V_Wp1;
    const ccomplex_t IT_0265 = IT_0193*IT_0264;
    const ccomplex_t IT_0266 = 2*IT_0265;
    const ccomplex_t IT_0267 = N_B3*V_u1*e_em;
    const ccomplex_t IT_0268 = IT_0197*IT_0267;
    const ccomplex_t IT_0269 = 1.4142135623731*IT_0268;
    const ccomplex_t IT_0270 = N_W3*V_u1*e_em;
    ...
    const ccomplex_t IT_0277 = IT_0263*IT_0276;
    const ccomplex_t IT_0278 = IT_0135*IT_0277;
    const ccomplex_t IT_0279 = (0 + _Complex_I*1)*IT_0278;
    const ccomplex_t IT_0280 = -IT_0017 + -IT_0030 + -IT_0042 + 2*IT_0210 + 2
      *IT_0233 + 2*IT_0256 + 2*IT_0279;
    const ccomplex_t IT_0281 = IT_0048*IT_0180;
    const ccomplex_t IT_0282 = (-2)*IT_0043;
    const ccomplex_t IT_0283 = s_12*IT_0183;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0285 = IT_0097*IT_0230;
    const ccomplex_t IT_0286 = IT_0090*IT_0284*IT_0285;
    const ccomplex_t IT_0287 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0288 = IT_0073*IT_0253;
    const ccomplex_t IT_0289 = IT_0076*IT_0287*IT_0288;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0291 = IT_0133*IT_0276;
    const ccomplex_t IT_0292 = IT_0135*IT_0290*IT_0291;
    const ccomplex_t IT_0293 = m_C_2*IT_0210;
    const ccomplex_t IT_0294 = m_C_2*IT_0233;
    const ccomplex_t IT_0295 = m_C_2*IT_0256;
    const ccomplex_t IT_0296 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0297 = IT_0158*IT_0207;
    const ccomplex_t IT_0298 = IT_0138*IT_0296*IT_0297;
    const ccomplex_t IT_0299 = m_C_2*IT_0279;
    const ccomplex_t IT_0300 = -IT_0286 + -IT_0289 + -IT_0292 + IT_0293 +
       IT_0294 + IT_0295 + -IT_0298 + IT_0299;
    const ccomplex_t IT_0301 = m_C_2*IT_0048;
    const ccomplex_t IT_0302 = IT_0126*IT_0263;
    const ccomplex_t IT_0303 = IT_0135*IT_0290*IT_0302;
    const ccomplex_t IT_0304 = IT_0151*IT_0192;
    const ccomplex_t IT_0305 = IT_0138*IT_0296*IT_0304;
    const ccomplex_t IT_0306 = IT_0066*IT_0240;
    const ccomplex_t IT_0307 = IT_0076*IT_0287*IT_0306;
    const ccomplex_t IT_0308 = m_C_2*IT_0078;
    const ccomplex_t IT_0309 = m_C_2*IT_0137;
    const ccomplex_t IT_0310 = IT_0110*IT_0217;
    const ccomplex_t IT_0311 = IT_0090*IT_0284*IT_0310;
    const ccomplex_t IT_0312 = m_C_2*IT_0113;
    const ccomplex_t IT_0313 = m_C_2*IT_0161;
    const ccomplex_t IT_0314 = IT_0303 + IT_0305 + IT_0307 + -IT_0308 + 
      -IT_0309 + IT_0311 + -IT_0312 + -IT_0313;
    const ccomplex_t IT_0315 = m_C_1*IT_0183;
    const ccomplex_t IT_0316 = -IT_0210 + -IT_0233 + -IT_0256 + -IT_0279;
    const ccomplex_t IT_0317 = s_12*s_14;
    const ccomplex_t IT_0318 = s_24*IT_0012;
    const ccomplex_t IT_0319 = -IT_0318;
    const ccomplex_t IT_0320 = IT_0317 + IT_0319;
    const ccomplex_t IT_0321 = (-2)*conj(IT_0043);
    const ccomplex_t IT_0322 = pow(s_24, 2);
    const ccomplex_t IT_0323 = IT_0044*IT_0322;
    const ccomplex_t IT_0324 = -IT_0013;
    const ccomplex_t IT_0325 = IT_0323 + IT_0324;
    const ccomplex_t IT_0326 = s_12*IT_0325;
    const ccomplex_t IT_0327 = IT_0180*IT_0325;
    const ccomplex_t IT_0328 = m_C_2*IT_0183;
    const ccomplex_t IT_0329 = m_C_1*IT_0325;
    const ccomplex_t IT_0330 = IT_0078 + IT_0113 + IT_0137 + IT_0161;
    const ccomplex_t IT_0331 = s_12*s_24;
    const ccomplex_t IT_0332 = s_14*IT_0013;
    const ccomplex_t IT_0333 = -IT_0332;
    const ccomplex_t IT_0334 = IT_0331 + IT_0333;
    const ccomplex_t IT_0335 = (-2)*IT_0185;
    const ccomplex_t IT_0336 = (-2)*conj(IT_0185);
    const ccomplex_t IT_0337 = -IT_0179;
    const ccomplex_t IT_0338 = pow(m_W, 2);
    const ccomplex_t IT_0339 = s_14*IT_0338;
    const ccomplex_t IT_0340 = IT_0044*IT_0339;
    ...
    const ccomplex_t IT_0346 = IT_0044*IT_0345;
    ...
    const ccomplex_t IT_0351 = s_12*IT_0338;
    const ccomplex_t IT_0352 = s_14*s_24;
    const ccomplex_t IT_0353 = (-2)*IT_0352;
    const ccomplex_t IT_0354 = IT_0351 + IT_0353;
    const ccomplex_t IT_0355 = IT_0044*IT_0354;
    const ccomplex_t IT_0356 = (-0.5)*IT_0355;
    const ccomplex_t IT_0357 = 0.166666666666667*IT_0315;
    const ccomplex_t IT_0358 = 0.333333333333333*IT_0179;
    const ccomplex_t IT_0359 = IT_0180*IT_0300 + 0.333333333333333*IT_0280
      *IT_0329 + 0.166666666666667*IT_0301*IT_0335 + (-0.333333333333333)
      *IT_0330*IT_0344 + 0.333333333333333*IT_0316*IT_0350 + 0.666666666666667
      *IT_0314*(s_12 + IT_0356) + IT_0282*IT_0357 + IT_0328*IT_0358;
    const ccomplex_t IT_0360 = 0.166666666666667*IT_0282*IT_0301 + IT_0180
      *IT_0314 + 0.333333333333333*IT_0280*IT_0328 + (-0.333333333333333)
      *IT_0316*IT_0344 + 0.333333333333333*IT_0330*IT_0350 + 0.666666666666667
      *IT_0300*(s_12 + IT_0356) + IT_0335*IT_0357 + IT_0329*IT_0358;
    const ccomplex_t IT_0361 = IT_0180*IT_0338;
    const ccomplex_t IT_0362 = (-3)*IT_0361;
    const ccomplex_t IT_0363 = pow(m_W, 4);
    const ccomplex_t IT_0364 = s_12*IT_0363;
    const ccomplex_t IT_0365 = IT_0044*IT_0364;
    const ccomplex_t IT_0366 = (-0.5)*IT_0365;
    const ccomplex_t IT_0367 = IT_0351 + IT_0353 + IT_0366;
    const ccomplex_t IT_0368 = (-0.5)*IT_0320;
    const ccomplex_t IT_0369 = 2*conj(IT_0043)*(IT_0043*IT_0049 + IT_0179
      *IT_0184) + 2*conj(IT_0185)*(IT_0049*IT_0185 + IT_0184*IT_0280 + 0.5
      *IT_0281*IT_0282) + (IT_0185*IT_0281 + IT_0280*IT_0283 + IT_0300*IT_0301 +
       IT_0314*IT_0315 + IT_0316*IT_0320)*IT_0321 + 2*conj(IT_0179)*(IT_0043
      *IT_0184 + IT_0179*IT_0326 + -IT_0280*IT_0327 + IT_0314*IT_0328 + IT_0300
      *IT_0329 + IT_0330*IT_0334 + 0.5*IT_0283*IT_0335) + (IT_0179*IT_0283 +
       IT_0301*IT_0314 + IT_0300*IT_0315 + IT_0320*IT_0330)*IT_0336 + 2*conj
      (IT_0280)*(IT_0184*IT_0185 + 0.5*IT_0282*IT_0283 + IT_0280*IT_0326 +
       IT_0300*IT_0328 + IT_0314*IT_0329 + IT_0316*IT_0334 + IT_0327*IT_0337) +
       6*conj(IT_0314)*IT_0359 + 6*conj(IT_0300)*IT_0360 + 2*conj(IT_0316)*
      (IT_0280*IT_0334 + -IT_0300*IT_0344 + IT_0314*IT_0350 + -IT_0330*IT_0362 +
       (-2)*IT_0316*IT_0367 + -IT_0282*IT_0368) + (-2)*conj(IT_0330)*(IT_0334
      *IT_0337 + IT_0314*IT_0344 + -IT_0300*IT_0350 + IT_0316*IT_0362 + 2
      *IT_0330*IT_0367 + IT_0335*IT_0368);
