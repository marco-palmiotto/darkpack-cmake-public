...
ccomplex_return_t c_sumSqAmpl_C_1_anti_C_2_to_anti_nu_e_nu_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0006;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*e_em*U_Wm2*IT_0006;
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = cpow(s_23 + (-0.5)*IT_0020 + 0.5*m_se_L*(m_se_L
       + (0 + _Complex_I*-1)*Gamma_el) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*IT_0039;
    const ccomplex_t IT_0041 = (-0.5)*IT_0034 + (-0.5)*IT_0040;
