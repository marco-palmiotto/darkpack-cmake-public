        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*V_cb*e_em*V_Wp1*IT_0004;
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0004*(m_W*IT_0007*IT_0008*conj(U_sb_01) + (-0.5)*IT_0009*(IT_0007
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0004*IT_0009*IT_0011*IT_0018*V_ub_mod;
    const ccomplex_t IT_0020 = 0.5*IT_0019;
    const ccomplex_t IT_0021 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0004*IT_0009*IT_0021*(mu_h*conj(U_sb_01) + m_b*IT_0011*IT_0012*conj
      (U_sb_11))*V_ub_mod;
    const ccomplex_t IT_0023 = 0.5*IT_0022;
    const ccomplex_t IT_0024 = IT_0020*IT_0023;
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_R*
    ...
    const ccomplex_t IT_0030 = IT_0004*IT_0007;
    const ccomplex_t IT_0031 = N_u1*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0037 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0047 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0048 = IT_0035*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = IT_0004*IT_0012;
    const ccomplex_t IT_0051 = m_b*conj(N_d1)*e_em*IT_0009*conj(U_sb_01);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*(IT_0049 + 1.5*IT_0053);
    ...
    const ccomplex_t IT_0059 = m_b*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0000 + IT_0028 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0062 = N_B2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0063 = IT_0035*IT_0062;
    const ccomplex_t IT_0064 = 1.4142135623731*IT_0063;
    const ccomplex_t IT_0065 = N_W2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0066 = IT_0004*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = m_b*N_d2*e_em*IT_0009*conj(U_sb_11);
    const ccomplex_t IT_0069 = IT_0050*IT_0068;
    ...
    const ccomplex_t IT_0080 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0087 = IT_0060*IT_0061*IT_0086;
    const ccomplex_t IT_0088 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0089 = IT_0035*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = m_b*conj(N_d2)*e_em*IT_0009*conj(U_sb_01);
    ...
    const ccomplex_t IT_0113 = IT_0029*IT_0100*IT_0112;
    ...
    const ccomplex_t IT_0157 = N_B4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0158 = IT_0035*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = N_W4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0161 = IT_0004*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = m_b*N_d4*e_em*IT_0009*conj(U_sb_11);
    const ccomplex_t IT_0164 = IT_0050*IT_0163;
    ...
    const ccomplex_t IT_0169 = IT_0142*IT_0143*IT_0168;
    const ccomplex_t IT_0170 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0004*IT_0018
      *V_ub_mod;
    const ccomplex_t IT_0172 = -IT_0171;
    const ccomplex_t IT_0173 = pow(m_u, 2);
    const ccomplex_t IT_0174 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004
      *IT_0021*(m_W*IT_0007*IT_0008*conj(U_sb_01) + (-0.5)*IT_0009*(IT_0007
      *IT_0011*IT_0173*conj(U_sb_01) + m_b*(m_b*IT_0008*IT_0012*conj(U_sb_01) +
    ...
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u1
      *e_em*IT_0004*IT_0009*IT_0011;
    const ccomplex_t IT_0180 = 0.5*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0004*IT_0009*(mu_h*conj(U_sb_01) + m_b*IT_0011*IT_0012*conj(U_sb_11));
    const ccomplex_t IT_0182 = 0.5*IT_0181;
    const ccomplex_t IT_0183 = IT_0180*IT_0182;
    const ccomplex_t IT_0184 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0187 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0188 = m_t*conj(U_sb_01)*(m_t*IT_0007*IT_0011*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0008*IT_0012*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0011*IT_0012*U_st_10));
    const ccomplex_t IT_0189 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0008*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0004*((-0.5)*IT_0009
      *IT_0188 + m_W*IT_0007*IT_0008*conj(U_sb_01)*U_st_00) + A_t*IT_0007*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0190 = IT_0004*IT_0011;
    const ccomplex_t IT_0191 = m_t*V_tb*V_u1*e_em*IT_0009*conj(U_st_10);
    ...
    const ccomplex_t IT_0196 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0202 = IT_0189*IT_0201;
    const ccomplex_t IT_0203 = IT_0187*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*IT_0203;
    const ccomplex_t IT_0205 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0206 = m_t*conj(U_sb_01)*(m_t*IT_0007*IT_0011*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0008*IT_0012*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0011*IT_0012*U_st_11));
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0008*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0004*((-0.5)*IT_0009
      *IT_0206 + m_W*IT_0007*IT_0008*conj(U_sb_01)*U_st_01) + A_t*IT_0007*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0208 = m_t*V_tb*V_u1*e_em*IT_0009*conj(U_st_11);
    ...
    const ccomplex_t IT_0213 = V_tb*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0222 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0223 = IT_0035*IT_0222;
    const ccomplex_t IT_0224 = 1.4142135623731*IT_0223;
    const ccomplex_t IT_0225 = m_b*conj(N_d3)*e_em*IT_0009*conj(U_sb_01);
    ...
    const ccomplex_t IT_0230 = IT_0127*IT_0229;
    ...
    const ccomplex_t IT_0234 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0235 = IT_0035*IT_0234;
    const ccomplex_t IT_0236 = 1.4142135623731*IT_0235;
    const ccomplex_t IT_0237 = m_b*conj(N_d4)*e_em*IT_0009*conj(U_sb_01);
    ...
    const ccomplex_t IT_0242 = IT_0156*IT_0241;
    ...
    const ccomplex_t IT_0246 = IT_0017 + IT_0027 + -IT_0059 + IT_0087 + 
      -IT_0099 + IT_0113 + IT_0141 + IT_0169 + IT_0178 + IT_0186 + -IT_0204 + 
      -IT_0221 + -IT_0233 + -IT_0245;
    const ccomplex_t IT_0247 = IT_0004*IT_0008;
    const ccomplex_t IT_0248 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0249 = IT_0247*IT_0248;
    const ccomplex_t IT_0250 = (-2)*IT_0249;
    const ccomplex_t IT_0251 = IT_0008*IT_0035;
    const ccomplex_t IT_0252 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0253 = IT_0251*IT_0252;
    const ccomplex_t IT_0254 = 1.4142135623731*IT_0253;
    const ccomplex_t IT_0255 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0262 = IT_0241*IT_0261;
    const ccomplex_t IT_0263 = IT_0142*IT_0143*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0004*IT_0009*IT_0012*conj(U_st_00);
    const ccomplex_t IT_0265 = (-0.5)*IT_0264;
    const ccomplex_t IT_0266 = IT_0189*IT_0265;
    const ccomplex_t IT_0267 = IT_0187*IT_0266;
    const ccomplex_t IT_0268 = (0 + _Complex_I*1)*IT_0267;
    const ccomplex_t IT_0269 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0270 = IT_0251*IT_0269;
    const ccomplex_t IT_0271 = 1.4142135623731*IT_0270;
    const ccomplex_t IT_0272 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0276 = conj(N_d1)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0277 = IT_0247*IT_0276;
    ...
    const ccomplex_t IT_0282 = IT_0111*IT_0281;
    const ccomplex_t IT_0283 = IT_0029*IT_0282;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = m_b*IT_0284;
    const ccomplex_t IT_0286 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0287 = IT_0247*IT_0286;
    const ccomplex_t IT_0288 = (-2)*IT_0287;
    const ccomplex_t IT_0289 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0290 = IT_0251*IT_0289;
    const ccomplex_t IT_0291 = 1.4142135623731*IT_0290;
    const ccomplex_t IT_0292 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0299 = IT_0095*IT_0298;
    const ccomplex_t IT_0300 = IT_0060*IT_0061*IT_0299;
    const ccomplex_t IT_0301 = IT_0167*IT_0261;
    ...
    const ccomplex_t IT_0305 = IT_0055*IT_0281;
    const ccomplex_t IT_0306 = IT_0029*IT_0100*IT_0305;
    const ccomplex_t IT_0307 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_cb*e_em*IT_0004*IT_0009*IT_0012;
    ...
    const ccomplex_t IT_0312 = IT_0072*IT_0298;
    const ccomplex_t IT_0313 = IT_0061*IT_0312;
    const ccomplex_t IT_0314 = (0 + _Complex_I*1)*IT_0313;
    const ccomplex_t IT_0315 = m_b*IT_0314;
    const ccomplex_t IT_0316 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0317 = IT_0247*IT_0316;
    const ccomplex_t IT_0318 = 1.4142135623731*IT_0317;
    const ccomplex_t IT_0319 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0320 = IT_0251*IT_0319;
    const ccomplex_t IT_0321 = 1.4142135623731*IT_0320;
    const ccomplex_t IT_0322 = IT_0318 + IT_0321;
    const ccomplex_t IT_0323 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0324 = IT_0247*IT_0323;
    ...
    const ccomplex_t IT_0330 = IT_0114*IT_0140*IT_0329;
    const ccomplex_t IT_0331 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *e_em*IT_0004*IT_0009*IT_0012*IT_0018*V_ub_mod;
    const ccomplex_t IT_0332 = (-0.5)*IT_0331;
    const ccomplex_t IT_0333 = IT_0175*IT_0332;
    const ccomplex_t IT_0334 = IT_0170*IT_0333;
    const ccomplex_t IT_0335 = (0 + _Complex_I*1)*IT_0334;
    const ccomplex_t IT_0336 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0004*IT_0009*IT_0012*conj(U_st_01);
    const ccomplex_t IT_0337 = (-0.5)*IT_0336;
    const ccomplex_t IT_0338 = IT_0207*IT_0337;
    const ccomplex_t IT_0339 = IT_0205*IT_0338;
    const ccomplex_t IT_0340 = (0 + _Complex_I*1)*IT_0339;
    const ccomplex_t IT_0341 = IT_0138*IT_0328;
    const ccomplex_t IT_0342 = IT_0140*IT_0341;
    const ccomplex_t IT_0343 = (0 + _Complex_I*1)*IT_0342;
    const ccomplex_t IT_0344 = m_b*IT_0343;
    const ccomplex_t IT_0345 = IT_0263 + -IT_0268 + -IT_0285 + IT_0300 + 
      -IT_0304 + IT_0306 + -IT_0311 + -IT_0315 + IT_0330 + -IT_0335 + -IT_0340 +
       -IT_0344;
    const ccomplex_t IT_0346 = m_b*m_C_1;
    const ccomplex_t IT_0347 = -IT_0284 + -IT_0303 + -IT_0314 + -IT_0343;
    const ccomplex_t IT_0348 = s_23*m_C_1;
    const ccomplex_t IT_0349 = -IT_0058 + -IT_0098 + -IT_0232 + -IT_0244;
    const ccomplex_t IT_0350 = m_b*s_12;
    const ccomplex_t IT_0351 = 6*s_13;
    const ccomplex_t IT_0352 = (-6)*IT_0345;
    const ccomplex_t IT_0353 = m_b*m_C_1*IT_0028;
    const ccomplex_t IT_0354 = s_13*IT_0028;
