...
ccomplex_return_t c_sumSqAmpl_C_1_anti_sc_L_to_anti_c_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_cb*e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0010 = (-0.5)*IT_0009;
    const ccomplex_t IT_0011 = sin(beta);
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0004*IT_0006*IT_0008*IT_0011;
    ...
    const ccomplex_t IT_0047 = IT_0011*IT_0038;
    ...
    const ccomplex_t IT_0051 = IT_0008*IT_0011;
    ...
    const ccomplex_t IT_0102 = IT_0047*IT_0101;
    ...
    const ccomplex_t IT_0112 = cpow((-2)*s_23 + IT_0002 + IT_0035 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0113 = IT_0111*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*IT_0113;
    const ccomplex_t IT_0115 = N_B3*e_em;
    const ccomplex_t IT_0116 = IT_0038*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = N_W3*e_em;
    ...
    const ccomplex_t IT_0123 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0124 = IT_0051*IT_0123;
    const ccomplex_t IT_0125 = 1.4142135623731*IT_0124;
    const ccomplex_t IT_0126 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0130 = conj(N_d3)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0137 = cpow((-2)*s_23 + IT_0002 + IT_0035 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0138 = IT_0136*IT_0137;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*IT_0138;
    const ccomplex_t IT_0140 = -IT_0016 + -IT_0025 + -IT_0034 + -IT_0064 + 
      -IT_0089 + -IT_0114 + -IT_0139;
    const ccomplex_t IT_0141 = m_c*m_C_1*IT_0002;
    const ccomplex_t IT_0142 = cpow(IT_0011, -1);
    const ccomplex_t IT_0143 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0004*IT_0008*IT_0142;
    const ccomplex_t IT_0144 = (-0.5)*IT_0143;
    const ccomplex_t IT_0145 = IT_0005*IT_0008;
    const ccomplex_t IT_0146 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0147 = IT_0145*IT_0146;
    const ccomplex_t IT_0148 = 2*IT_0147;
    const ccomplex_t IT_0149 = IT_0005*IT_0038;
    const ccomplex_t IT_0150 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0151 = IT_0149*IT_0150;
    const ccomplex_t IT_0152 = 1.4142135623731*IT_0151;
    const ccomplex_t IT_0153 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0163 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0004*IT_0008*IT_0142;
    ...
    const ccomplex_t IT_0168 = N_W2*V_u1*e_em;
    ...
    const ccomplex_t IT_0172 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0181 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0004*IT_0008*IT_0142;
    const ccomplex_t IT_0182 = (-0.5)*IT_0181;
    const ccomplex_t IT_0183 = N_u3*e_em*V_Wp1;
    const ccomplex_t IT_0184 = IT_0145*IT_0183;
    const ccomplex_t IT_0185 = 2*IT_0184;
    const ccomplex_t IT_0186 = N_B3*V_u1*e_em;
    const ccomplex_t IT_0187 = IT_0149*IT_0186;
    const ccomplex_t IT_0188 = 1.4142135623731*IT_0187;
    const ccomplex_t IT_0189 = N_W3*V_u1*e_em;
    ...
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0004*IT_0008*IT_0142;
    const ccomplex_t IT_0200 = (-0.5)*IT_0199;
    const ccomplex_t IT_0201 = N_u4*e_em*V_Wp1;
    const ccomplex_t IT_0202 = IT_0145*IT_0201;
    const ccomplex_t IT_0203 = 2*IT_0202;
    const ccomplex_t IT_0204 = N_B4*V_u1*e_em;
    const ccomplex_t IT_0205 = IT_0149*IT_0204;
    const ccomplex_t IT_0206 = 1.4142135623731*IT_0205;
    const ccomplex_t IT_0207 = N_W4*V_u1*e_em;
    const ccomplex_t IT_0208 = IT_0145*IT_0207;
    ...
    const ccomplex_t IT_0215 = IT_0112*IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1)*IT_0215;
    const ccomplex_t IT_0217 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0004*IT_0005*IT_0008*IT_0142;
    const ccomplex_t IT_0218 = 0.5*IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1)*V_cb*e_em*V_Wp1*IT_0008;
    const ccomplex_t IT_0220 = -IT_0219;
    const ccomplex_t IT_0221 = IT_0218*IT_0220;
    const ccomplex_t IT_0222 = IT_0003*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*IT_0004*IT_0005*IT_0008*IT_0142;
    const ccomplex_t IT_0225 = 0.5*IT_0224;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*V_cd*e_em*V_Wp1*IT_0008;
    ...
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0004*IT_0005*IT_0008*IT_0142;
    const ccomplex_t IT_0232 = 0.5*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0008;
    ...
    const ccomplex_t IT_0238 = -IT_0162 + -IT_0180 + -IT_0198 + -IT_0216 +
       IT_0223 + IT_0230 + IT_0237;
    const ccomplex_t IT_0239 = s_13*IT_0002;
    const ccomplex_t IT_0240 = (-6)*IT_0239;
    const ccomplex_t IT_0241 = s_12*s_23;
    const ccomplex_t IT_0242 = 12*IT_0241;
    const ccomplex_t IT_0243 = IT_0240 + IT_0242;
    const ccomplex_t IT_0244 = 0.166666666666667*conj(IT_0140);
    const ccomplex_t IT_0245 = s_23*m_C_1;
    const ccomplex_t IT_0246 = (-6)*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0248 = IT_0072*IT_0177;
    const ccomplex_t IT_0249 = IT_0087*IT_0247*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0251 = IT_0122*IT_0195;
    const ccomplex_t IT_0252 = IT_0137*IT_0250*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0254 = IT_0097*IT_0213;
    const ccomplex_t IT_0255 = IT_0112*IT_0253*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0257 = IT_0013*IT_0220;
    const ccomplex_t IT_0258 = IT_0003*IT_0256*IT_0257;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0260 = IT_0022*IT_0227;
    const ccomplex_t IT_0261 = IT_0018*IT_0259*IT_0260;
    const ccomplex_t IT_0262 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0263 = IT_0031*IT_0234;
    const ccomplex_t IT_0264 = IT_0027*IT_0262*IT_0263;
    const ccomplex_t IT_0265 = m_c*IT_0162;
    const ccomplex_t IT_0266 = m_c*IT_0180;
    const ccomplex_t IT_0267 = m_c*IT_0198;
    const ccomplex_t IT_0268 = m_c*IT_0216;
    const ccomplex_t IT_0269 = m_C_1*IT_0016;
    const ccomplex_t IT_0270 = m_C_1*IT_0025;
    const ccomplex_t IT_0271 = m_C_1*IT_0034;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0273 = IT_0046*IT_0159;
    const ccomplex_t IT_0274 = IT_0036*IT_0272*IT_0273;
    const ccomplex_t IT_0275 = IT_0249 + IT_0252 + IT_0255 + -IT_0258 + 
      -IT_0261 + -IT_0264 + -IT_0265 + -IT_0266 + -IT_0267 + -IT_0268 + IT_0269 
      + IT_0270 + IT_0271 + IT_0274;
    const ccomplex_t IT_0276 = 0.166666666666667*conj(IT_0275);
    const ccomplex_t IT_0277 = m_c*s_12;
    const ccomplex_t IT_0278 = (-6)*IT_0277;
    const ccomplex_t IT_0279 = IT_0010*IT_0218;
    const ccomplex_t IT_0280 = IT_0003*IT_0256*IT_0279;
    const ccomplex_t IT_0281 = IT_0020*IT_0225;
    const ccomplex_t IT_0282 = IT_0018*IT_0259*IT_0281;
    const ccomplex_t IT_0283 = IT_0029*IT_0232;
    const ccomplex_t IT_0284 = IT_0027*IT_0262*IT_0283;
    const ccomplex_t IT_0285 = IT_0061*IT_0144;
    const ccomplex_t IT_0286 = IT_0036*IT_0272*IT_0285;
    const ccomplex_t IT_0287 = IT_0085*IT_0164;
    const ccomplex_t IT_0288 = IT_0087*IT_0247*IT_0287;
    const ccomplex_t IT_0289 = IT_0135*IT_0182;
    const ccomplex_t IT_0290 = IT_0137*IT_0250*IT_0289;
    const ccomplex_t IT_0291 = IT_0110*IT_0200;
    const ccomplex_t IT_0292 = IT_0112*IT_0253*IT_0291;
    const ccomplex_t IT_0293 = m_c*IT_0064;
    const ccomplex_t IT_0294 = m_c*IT_0089;
    const ccomplex_t IT_0295 = m_c*IT_0114;
    const ccomplex_t IT_0296 = m_c*IT_0139;
    const ccomplex_t IT_0297 = m_C_1*IT_0223;
    const ccomplex_t IT_0298 = m_C_1*IT_0230;
    const ccomplex_t IT_0299 = m_C_1*IT_0237;
    const ccomplex_t IT_0300 = IT_0280 + IT_0282 + IT_0284 + IT_0286 + IT_0288
       + IT_0290 + IT_0292 + -IT_0293 + -IT_0294 + -IT_0295 + -IT_0296 + 
      -IT_0297 + -IT_0298 + -IT_0299;
    const ccomplex_t IT_0301 = 0.166666666666667*conj(IT_0300);
    const ccomplex_t IT_0302 = 0.166666666666667*conj(IT_0238);
    const ccomplex_t IT_0303 = m_c*m_C_1;
    const ccomplex_t IT_0304 = 6*IT_0303;
    const ccomplex_t IT_0305 = 6*IT_0140*(IT_0141*conj(IT_0238) + IT_0243
      *IT_0244 + IT_0246*IT_0276 + IT_0278*IT_0301) + 6*IT_0238*(conj(IT_0140)
      *IT_0141 + IT_0276*IT_0278 + IT_0246*IT_0301 + IT_0243*IT_0302) + 6
      *IT_0300*(IT_0244*IT_0278 + s_13*conj(IT_0300) + IT_0246*IT_0302 + IT_0276
      *IT_0304) + 6*IT_0275*(IT_0244*IT_0246 + s_13*conj(IT_0275) + IT_0278
      *IT_0302 + IT_0301*IT_0304);
