        ...
        )
{
    ...
    const ccomplex_t IT_0061 = pow(m_C_1, 2);
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0002 + IT_0060 + -IT_0061 
      + -reg_prop, -1);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*V_cb*e_em*V_Wp1*IT_0008;
    const ccomplex_t IT_0064 = -IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0008;
    ...
    const ccomplex_t IT_0071 = pow(m_s, 2);
    const ccomplex_t IT_0072 = cpow((-2)*s_12 + -IT_0002 + -IT_0061 + IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0008;
    const ccomplex_t IT_0074 = -IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0008;
    const ccomplex_t IT_0076 = 0.5*IT_0075;
    const ccomplex_t IT_0077 = IT_0074*IT_0076;
    const ccomplex_t IT_0078 = IT_0072*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = m_c*IT_0079;
    const ccomplex_t IT_0081 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0082 = IT_0008*IT_0081;
    const ccomplex_t IT_0083 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0125 = pow(m_d, 2);
    const ccomplex_t IT_0126 = cpow((-2)*s_12 + -IT_0002 + -IT_0061 + IT_0125 
      + -reg_prop, -1);
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*V_cd*e_em*V_Wp1*IT_0008;
    const ccomplex_t IT_0128 = -IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*conj(V_cd)
      *e_em*IT_0008;
    ...
    const ccomplex_t IT_0144 = 12*s_13;
    const ccomplex_t IT_0145 = IT_0143 + IT_0144;
    const ccomplex_t IT_0146 = 2*IT_0069 + 2*IT_0079 + 2*IT_0133;
    const ccomplex_t IT_0147 = s_14*s_34*IT_0136;
    ...
    const ccomplex_t IT_0152 = conj(IT_0146)*IT_0151;
    const ccomplex_t IT_0153 = cos(theta_W);
    ...
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*(IT_0157 + 3*IT_0160);
    const ccomplex_t IT_0162 = 0.166666666666667*IT_0161;
    const ccomplex_t IT_0163 = IT_0098*IT_0162;
    const ccomplex_t IT_0164 = IT_0033*IT_0044*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0166 = cos(beta);
    const ccomplex_t IT_0167 = cpow(IT_0166, -1);
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_cb*e_em*IT_0004*IT_0008*IT_0167;
    const ccomplex_t IT_0169 = (-0.5)*IT_0168;
    const ccomplex_t IT_0170 = IT_0066*IT_0169;
    const ccomplex_t IT_0171 = IT_0062*IT_0165*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_cd*e_em*IT_0004*IT_0008*IT_0167;
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = IT_0130*IT_0174;
    const ccomplex_t IT_0176 = IT_0126*IT_0172*IT_0175;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0178 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0004*IT_0008*IT_0167;
    const ccomplex_t IT_0179 = (-0.5)*IT_0178;
    const ccomplex_t IT_0180 = IT_0076*IT_0179;
    const ccomplex_t IT_0181 = IT_0072*IT_0177*IT_0180;
    const ccomplex_t IT_0182 = IT_0042*IT_0162;
    ...
    const ccomplex_t IT_0195 = IT_0000*IT_0003*IT_0194;
    const ccomplex_t IT_0196 = N_B4*e_em;
    const ccomplex_t IT_0197 = IT_0154*IT_0196;
    const ccomplex_t IT_0198 = 1.4142135623731*IT_0197;
    const ccomplex_t IT_0199 = N_W4*e_em;
    const ccomplex_t IT_0200 = IT_0008*IT_0199;
    const ccomplex_t IT_0201 = 1.4142135623731*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*(IT_0198 + 3*IT_0201);
    const ccomplex_t IT_0203 = 0.166666666666667*IT_0202;
    const ccomplex_t IT_0204 = IT_0120*IT_0203;
    const ccomplex_t IT_0205 = IT_0046*IT_0047*IT_0204;
    const ccomplex_t IT_0206 = IT_0017*IT_0193;
    ...
    const ccomplex_t IT_0210 = IT_0054*IT_0203;
    ...
    const ccomplex_t IT_0214 = N_B1*e_em;
    const ccomplex_t IT_0215 = IT_0154*IT_0214;
    const ccomplex_t IT_0216 = 1.4142135623731*IT_0215;
    const ccomplex_t IT_0217 = N_W1*e_em;
    const ccomplex_t IT_0218 = IT_0008*IT_0217;
    const ccomplex_t IT_0219 = 1.4142135623731*IT_0218;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*(IT_0216 + 3*IT_0219);
    const ccomplex_t IT_0221 = 0.166666666666667*IT_0220;
    const ccomplex_t IT_0222 = IT_0087*IT_0221;
    const ccomplex_t IT_0223 = IT_0020*IT_0031*IT_0222;
    const ccomplex_t IT_0224 = IT_0029*IT_0221;
    ...
    const ccomplex_t IT_0228 = IT_0164 + IT_0171 + IT_0176 + IT_0181 + 
      -IT_0185 + IT_0195 + IT_0205 + -IT_0209 + -IT_0213 + IT_0223 + -IT_0227;
    const ccomplex_t IT_0229 = m_c*m_C_1;
    const ccomplex_t IT_0230 = (-18)*IT_0229;
    const ccomplex_t IT_0231 = (-2)*IT_0184 + (-2)*IT_0208 + (-2)*IT_0212 + (
      -2)*IT_0226;
    const ccomplex_t IT_0232 = pow(s_14, 2);
    const ccomplex_t IT_0233 = IT_0136*IT_0232;
    const ccomplex_t IT_0234 = -IT_0061;
    const ccomplex_t IT_0235 = IT_0233 + IT_0234;
    const ccomplex_t IT_0236 = m_c*IT_0235;
    const ccomplex_t IT_0237 = (-6)*IT_0236;
    const ccomplex_t IT_0238 = conj(IT_0231)*IT_0237;
    const ccomplex_t IT_0239 = IT_0069 + IT_0079 + IT_0133;
    const ccomplex_t IT_0240 = s_14*IT_0137;
    const ccomplex_t IT_0241 = IT_0136*IT_0240;
    const ccomplex_t IT_0242 = (-0.25)*IT_0241;
    const ccomplex_t IT_0243 = s_14 + IT_0242;
    const ccomplex_t IT_0244 = m_c*IT_0243;
    const ccomplex_t IT_0245 = (-4)*IT_0244;
    const ccomplex_t IT_0246 = (-6)*IT_0245;
    const ccomplex_t IT_0247 = conj(IT_0239)*IT_0246;
    const ccomplex_t IT_0248 = -IT_0090 + -IT_0101 + -IT_0112 + -IT_0123;
    const ccomplex_t IT_0249 = s_34*IT_0137;
    const ccomplex_t IT_0250 = IT_0136*IT_0249;
    const ccomplex_t IT_0251 = (-0.25)*IT_0250;
    const ccomplex_t IT_0252 = s_34 + IT_0251;
    const ccomplex_t IT_0253 = m_C_1*IT_0252;
    const ccomplex_t IT_0254 = (-4)*IT_0253;
    const ccomplex_t IT_0255 = (-6)*IT_0254;
    const ccomplex_t IT_0256 = conj(IT_0248)*IT_0255;
    const ccomplex_t IT_0257 = IT_0184 + IT_0208 + IT_0212 + IT_0226;
    const ccomplex_t IT_0258 = 0.5*IT_0241;
    ...
    const ccomplex_t IT_0263 = conj(IT_0257)*IT_0262;
    const ccomplex_t IT_0264 = 2*IT_0090 + 2*IT_0101 + 2*IT_0112 + 2*IT_0123;
    const ccomplex_t IT_0265 = m_C_1*IT_0149;
    const ccomplex_t IT_0266 = 6*IT_0265;
    const ccomplex_t IT_0267 = conj(IT_0264)*IT_0266;
    const ccomplex_t IT_0268 = (conj(IT_0059) + conj(IT_0135))*IT_0145 +
       IT_0152 + conj(IT_0228)*IT_0230 + IT_0238 + IT_0247 + IT_0256 + IT_0263 +
       IT_0267;
    const ccomplex_t IT_0269 = pow(m_W, 4);
    const ccomplex_t IT_0270 = s_13*IT_0269;
    const ccomplex_t IT_0271 = IT_0136*IT_0270;
    const ccomplex_t IT_0272 = 6*IT_0271;
    const ccomplex_t IT_0273 = 24*IT_0139;
    const ccomplex_t IT_0274 = (-12)*IT_0138;
    const ccomplex_t IT_0275 = IT_0272 + IT_0273 + IT_0274;
    const ccomplex_t IT_0276 = (-24)*IT_0139;
    const ccomplex_t IT_0277 = IT_0272 + IT_0276;
    const ccomplex_t IT_0278 = s_13*s_14;
    const ccomplex_t IT_0279 = s_34*IT_0061;
    const ccomplex_t IT_0280 = -IT_0279;
    const ccomplex_t IT_0281 = IT_0278 + IT_0280;
    const ccomplex_t IT_0282 = 6*IT_0281;
    const ccomplex_t IT_0283 = s_14*IT_0001;
    ...
    const ccomplex_t IT_0288 = IT_0137*IT_0229;
    const ccomplex_t IT_0289 = (-3)*IT_0288;
    const ccomplex_t IT_0290 = 6*IT_0289;
    const ccomplex_t IT_0291 = conj(IT_0059) + conj(IT_0135);
    const ccomplex_t IT_0292 = 3*IT_0288;
    const ccomplex_t IT_0293 = 6*IT_0292;
    const ccomplex_t IT_0294 = pow(s_34, 2);
    const ccomplex_t IT_0295 = IT_0136*IT_0294;
    ...
    const ccomplex_t IT_0300 = 0.5*IT_0250;
    ...
    const ccomplex_t IT_0305 = s_13*IT_0235;
    const ccomplex_t IT_0306 = IT_0229*IT_0235;
    const ccomplex_t IT_0307 = 6*IT_0306;
    const ccomplex_t IT_0308 = IT_0149*IT_0229;
    const ccomplex_t IT_0309 = (-6)*IT_0308;
    const ccomplex_t IT_0310 = 0.166666666666667*conj(IT_0146);
    const ccomplex_t IT_0311 = 0.166666666666667*conj(IT_0228);
    const ccomplex_t IT_0312 = 0.166666666666667*IT_0291;
    const ccomplex_t IT_0313 = s_13*IT_0149;
    const ccomplex_t IT_0314 = (-6)*IT_0313;
    const ccomplex_t IT_0315 = (-6)*IT_0286;
    const ccomplex_t IT_0316 = (-0.166666666666667)*conj(IT_0228);
    const ccomplex_t IT_0317 = (-0.166666666666667)*IT_0291;
    const ccomplex_t IT_0318 = (-0.166666666666667)*conj(IT_0257);
    const ccomplex_t IT_0319 = (-0.166666666666667)*conj(IT_0239);
    const ccomplex_t IT_0320 = s_13*IT_0297;
    const ccomplex_t IT_0321 = (IT_0059 + IT_0135)*IT_0268 + IT_0257*(conj
      (IT_0228)*IT_0255 + conj(IT_0257)*IT_0275 + conj(IT_0239)*IT_0277 + conj
      (IT_0231)*IT_0282 + conj(IT_0146)*IT_0287 + conj(IT_0248)*IT_0290 +
       IT_0262*IT_0291) + IT_0248*(conj(IT_0228)*IT_0262 + conj(IT_0248)*IT_0275
       + conj(IT_0264)*IT_0282 + conj(IT_0257)*IT_0290 + IT_0255*IT_0291 + conj
      (IT_0239)*IT_0293) + IT_0228*(IT_0145*conj(IT_0228) + IT_0255*conj(IT_0257
      ) + conj(IT_0248)*IT_0262 + IT_0237*conj(IT_0264) + conj(IT_0231)*IT_0266 
      + IT_0230*IT_0291 + conj(IT_0146)*IT_0299 + conj(IT_0239)*IT_0304) + 6
      *IT_0264*(0.166666666666667*conj(IT_0248)*IT_0282 + conj(IT_0264)*IT_0305 
      + 0.166666666666667*conj(IT_0231)*IT_0307 + IT_0309*IT_0310 + IT_0237
      *IT_0311 + IT_0266*IT_0312) + (-6)*IT_0231*(conj(IT_0239)*IT_0281 + (
      -0.166666666666667)*conj(IT_0257)*IT_0282 + -conj(IT_0231)*IT_0305 + (
      -0.166666666666667)*conj(IT_0264)*IT_0307 + -IT_0266*IT_0311 + -IT_0237
      *IT_0312 + -IT_0310*IT_0314) + (-6)*IT_0239*(conj(IT_0231)*IT_0281 + (
      -0.166666666666667)*conj(IT_0248)*IT_0293 + (-0.166666666666667)*conj
      (IT_0146)*IT_0315 + IT_0304*IT_0316 + IT_0246*IT_0317 + IT_0277*IT_0318 +
       IT_0275*IT_0319) + (-6)*IT_0146*((-0.166666666666667)*conj(IT_0264)
      *IT_0309 + (-0.166666666666667)*conj(IT_0231)*IT_0314 + IT_0299*IT_0316 +
       IT_0151*IT_0317 + IT_0287*IT_0318 + IT_0315*IT_0319 + conj(IT_0146)
      *IT_0320);
