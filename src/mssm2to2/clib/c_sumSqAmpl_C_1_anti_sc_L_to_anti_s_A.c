...
ccomplex_return_t c_sumSqAmpl_C_1_anti_sc_L_to_anti_s_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_13 + IT_0001 + IT_0002 + -m_sc_L*
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0006*IT_0031*IT_0033;
    ...
    const ccomplex_t IT_0046 = m_s*m_C_1;
    ...
    const ccomplex_t IT_0061 = m_s*s_14*m_C_1;
    ...
    const ccomplex_t IT_0081 = m_s*s_34*m_C_1;
