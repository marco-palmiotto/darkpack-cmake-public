...
ccomplex_return_t c_sumSqAmpl_C_1_anti_sc_L_to_anti_s_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0001;
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0001*IT_0034*IT_0035;
    ...
    const ccomplex_t IT_0064 = m_s*m_C_1*IT_0063;
    const ccomplex_t IT_0065 = m_s*e_em*IT_0001*IT_0007*IT_0034*IT_0035;
    ...
    const ccomplex_t IT_0080 = m_s*m_C_1;
    const ccomplex_t IT_0081 = m_c*e_em*mu_h*IT_0001*IT_0034;
    const ccomplex_t IT_0082 = (-0.5)*IT_0081;
    const ccomplex_t IT_0083 = cpow(IT_0007, -1);
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0001*IT_0034*IT_0083;
    const ccomplex_t IT_0085 = 0.5*IT_0084;
    const ccomplex_t IT_0086 = IT_0082*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0014 + IT_0068 + -m_sc_R*
    ...
    const ccomplex_t IT_0113 = m_s*s_14;
