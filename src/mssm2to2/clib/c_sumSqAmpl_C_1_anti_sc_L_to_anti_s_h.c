...
ccomplex_return_t c_sumSqAmpl_C_1_anti_sc_L_to_anti_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0004
      *IT_0036*IT_0071*IT_0073 + (-0.5)*m_W*(IT_0007*IT_0037 + IT_0004*IT_0072)*
      (IT_0001 + -1./3*IT_0000*IT_0075));
    const ccomplex_t IT_0077 = -IT_0076;
    const ccomplex_t IT_0078 = IT_0040*IT_0077;
    const ccomplex_t IT_0079 = pow(m_C_1, 2);
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0015 + IT_0079 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*m_s*e_em*IT_0001*IT_0007
      *IT_0036*IT_0038;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = IT_0040*IT_0084;
    const ccomplex_t IT_0086 = cpow((-2)*s_12 + IT_0015 + -IT_0016 + -IT_0079 
      + -reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = m_s*IT_0088;
    const ccomplex_t IT_0090 = IT_0013*IT_0053;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0092 = IT_0017*IT_0090*IT_0091;
    const ccomplex_t IT_0093 = IT_0070 + -IT_0082 + 2*IT_0089 + IT_0092;
    const ccomplex_t IT_0094 = m_s*m_C_1;
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0001
      *IT_0007*IT_0036*IT_0073;
    const ccomplex_t IT_0096 = (-0.5)*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0001*IT_0036*IT_0073;
    const ccomplex_t IT_0098 = 0.5*IT_0097;
    const ccomplex_t IT_0099 = IT_0096*IT_0098;
    const ccomplex_t IT_0100 = cpow((-2)*s_13 + IT_0015 + IT_0079 + -m_sc_R*
    ...
    const ccomplex_t IT_0103 = IT_0021*IT_0077;
    const ccomplex_t IT_0104 = IT_0080*IT_0103;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*IT_0104;
    const ccomplex_t IT_0106 = IT_0021*IT_0048;
    const ccomplex_t IT_0107 = IT_0031*IT_0069*IT_0106;
    const ccomplex_t IT_0108 = IT_0003*IT_0061;
    const ccomplex_t IT_0109 = IT_0017*IT_0091*IT_0108;
    const ccomplex_t IT_0110 = IT_0021*IT_0084;
    ...
    const ccomplex_t IT_0140 = (-6)*conj(IT_0112);
