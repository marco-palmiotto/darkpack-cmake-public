...
ccomplex_return_t c_sumSqAmpl_C_1_anti_sc_R_to_anti_c_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0071 = IT_0016*IT_0070;
    const ccomplex_t IT_0072 = (-2)*IT_0071;
    const ccomplex_t IT_0073 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0074 = IT_0012*IT_0073;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
    ...
    const ccomplex_t IT_0088 = m_c*m_C_1*IT_0001;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0011;
    ...
    const ccomplex_t IT_0096 = IT_0011*IT_0091;
    ...
    const ccomplex_t IT_0164 = pow(m_d, 2);
    const ccomplex_t IT_0165 = pow(m_C_1, 2);
    const ccomplex_t IT_0166 = cpow((-2)*s_12 + -IT_0001 + IT_0164 + -IT_0165 
      + -reg_prop, -1);
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*IT_0003*IT_0005*IT_0007*IT_0091;
    const ccomplex_t IT_0168 = 0.5*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u1
    ...
    const ccomplex_t IT_0174 = pow(m_s, 2);
    const ccomplex_t IT_0175 = cpow((-2)*s_12 + -IT_0001 + -IT_0165 + IT_0174 
      + -reg_prop, -1);
    const ccomplex_t IT_0176 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0003*IT_0005*IT_0007*IT_0091;
    const ccomplex_t IT_0177 = 0.5*IT_0176;
    const ccomplex_t IT_0178 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0183 = pow(m_b, 2);
    const ccomplex_t IT_0184 = cpow((-2)*s_12 + -IT_0001 + -IT_0165 + IT_0183 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0187 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u1
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0192 = -IT_0109 + -IT_0127 + -IT_0145 + -IT_0163 +
       IT_0173 + IT_0182 + IT_0191;
    const ccomplex_t IT_0193 = s_23*m_C_1;
    const ccomplex_t IT_0194 = (-6)*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0196 = IT_0009*IT_0106;
    const ccomplex_t IT_0197 = IT_0002*IT_0195*IT_0196;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0199 = IT_0031*IT_0124;
    const ccomplex_t IT_0200 = IT_0046*IT_0198*IT_0199;
    const ccomplex_t IT_0201 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0202 = IT_0050*IT_0142;
    const ccomplex_t IT_0203 = IT_0065*IT_0201*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0205 = IT_0069*IT_0160;
    const ccomplex_t IT_0206 = IT_0084*IT_0204*IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0208 = cpow(IT_0091, -1);
    const ccomplex_t IT_0209 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0003*IT_0004*IT_0007*IT_0208;
    const ccomplex_t IT_0210 = 0.5*IT_0209;
    const ccomplex_t IT_0211 = IT_0188*IT_0210;
    const ccomplex_t IT_0212 = IT_0184*IT_0207*IT_0211;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*IT_0003*IT_0004*IT_0007*IT_0208;
    const ccomplex_t IT_0215 = 0.5*IT_0214;
    const ccomplex_t IT_0216 = IT_0170*IT_0215;
    const ccomplex_t IT_0217 = IT_0166*IT_0213*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0003*IT_0004*IT_0007*IT_0208;
    const ccomplex_t IT_0220 = 0.5*IT_0219;
    const ccomplex_t IT_0221 = IT_0179*IT_0220;
    const ccomplex_t IT_0222 = IT_0175*IT_0218*IT_0221;
    const ccomplex_t IT_0223 = m_c*IT_0109;
    const ccomplex_t IT_0224 = m_c*IT_0127;
    const ccomplex_t IT_0225 = m_c*IT_0145;
    const ccomplex_t IT_0226 = m_c*IT_0163;
    const ccomplex_t IT_0227 = IT_0197 + IT_0200 + IT_0203 + IT_0206 + 
      -IT_0212 + -IT_0217 + -IT_0222 + -IT_0223 + -IT_0224 + -IT_0225 + -IT_0226;
    const ccomplex_t IT_0228 = 0.166666666666667*conj(IT_0227);
    const ccomplex_t IT_0229 = m_c*s_12;
    const ccomplex_t IT_0230 = (-6)*IT_0229;
    const ccomplex_t IT_0231 = IT_0026*IT_0090;
    const ccomplex_t IT_0232 = IT_0002*IT_0195*IT_0231;
    const ccomplex_t IT_0233 = IT_0044*IT_0111;
    const ccomplex_t IT_0234 = IT_0046*IT_0198*IT_0233;
    const ccomplex_t IT_0235 = IT_0063*IT_0129;
    const ccomplex_t IT_0236 = IT_0065*IT_0201*IT_0235;
    const ccomplex_t IT_0237 = IT_0082*IT_0147;
    const ccomplex_t IT_0238 = IT_0084*IT_0204*IT_0237;
    const ccomplex_t IT_0239 = m_c*IT_0029;
    const ccomplex_t IT_0240 = m_c*IT_0048;
    const ccomplex_t IT_0241 = m_c*IT_0067;
    const ccomplex_t IT_0242 = m_C_1*IT_0173;
    const ccomplex_t IT_0243 = m_C_1*IT_0182;
    const ccomplex_t IT_0244 = m_c*IT_0086;
    const ccomplex_t IT_0245 = m_C_1*IT_0191;
    const ccomplex_t IT_0246 = IT_0232 + IT_0234 + IT_0236 + IT_0238 + 
      -IT_0239 + -IT_0240 + -IT_0241 + -IT_0242 + -IT_0243 + -IT_0244 + -IT_0245;
    const ccomplex_t IT_0247 = 0.166666666666667*conj(IT_0246);
    const ccomplex_t IT_0248 = s_13*IT_0001;
    ...
    const ccomplex_t IT_0253 = 0.166666666666667*conj(IT_0087);
    const ccomplex_t IT_0254 = 0.166666666666667*conj(IT_0192);
    const ccomplex_t IT_0255 = m_c*m_C_1;
    const ccomplex_t IT_0256 = 6*IT_0255;
    const ccomplex_t IT_0257 = 6*IT_0087*(IT_0088*conj(IT_0192) + IT_0194
      *IT_0228 + IT_0230*IT_0247 + IT_0252*IT_0253) + 6*IT_0192*(conj(IT_0087)
      *IT_0088 + IT_0228*IT_0230 + IT_0194*IT_0247 + IT_0252*IT_0254) + 6
      *IT_0246*(s_13*conj(IT_0246) + IT_0230*IT_0253 + IT_0194*IT_0254 + IT_0228
      *IT_0256) + 6*IT_0227*(s_13*conj(IT_0227) + IT_0194*IT_0253 + IT_0230
      *IT_0254 + IT_0247*IT_0256);
