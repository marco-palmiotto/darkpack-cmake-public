...
ccomplex_return_t c_sumSqAmpl_C_1_anti_sc_R_to_anti_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = m_s*s_14;
    ...
    const ccomplex_t IT_0050 = m_s*m_C_1*IT_0049;
    const ccomplex_t IT_0051 = -IT_0034 + -IT_0046;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0003*IT_0005*IT_0009;
    const ccomplex_t IT_0053 = (-0.5)*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0005;
    const ccomplex_t IT_0055 = -IT_0054;
    const ccomplex_t IT_0056 = IT_0053*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_sc_L*
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*(IT_0001
      *IT_0003 + IT_0008*IT_0022)*IT_0061 + (-1.5)*IT_0000*IT_0005*IT_0009
      *IT_0022*IT_0062);
    const ccomplex_t IT_0064 = 0.666666666666667*IT_0063;
    const ccomplex_t IT_0065 = IT_0011*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_sc_R*
    ...
    const ccomplex_t IT_0069 = m_s*IT_0018;
    const ccomplex_t IT_0070 = V_u1*U_Wm1;
    const ccomplex_t IT_0071 = IT_0022*IT_0070;
    const ccomplex_t IT_0072 = U_d1*V_Wp1;
    ...
    const ccomplex_t IT_0080 = IT_0044*IT_0078*IT_0079;
    ...
    const ccomplex_t IT_0092 = IT_0059 + IT_0068 + (-2)*IT_0069 + -IT_0080 + 
      -IT_0091;
    const ccomplex_t IT_0093 = s_34*m_C_1;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
    ...
    const ccomplex_t IT_0107 = m_s*m_C_1;
