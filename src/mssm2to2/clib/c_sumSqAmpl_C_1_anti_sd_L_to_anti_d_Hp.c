...
ccomplex_return_t c_sumSqAmpl_C_1_anti_sd_L_to_anti_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0008;
    const ccomplex_t IT_0012 = -IT_0011;
    const ccomplex_t IT_0013 = IT_0010*IT_0012;
    const ccomplex_t IT_0014 = pow(m_C_1, 2);
    const ccomplex_t IT_0015 = cpow((-2)*s_13 + IT_0001 + IT_0014 + -m_su_L*
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*conj(V_cd)
      *e_em*IT_0008*(IT_0000*IT_0001*IT_0003*IT_0004 + (-2)*IT_0002*(m_W*IT_0004
       + (-0.5)*IT_0000*IT_0006*IT_0018));
    const ccomplex_t IT_0020 = 0.5*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*V_cd*e_em*V_Wp1*IT_0008;
    const ccomplex_t IT_0022 = -IT_0021;
    const ccomplex_t IT_0023 = IT_0020*IT_0022;
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0001 + IT_0014 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*mu_h*IT_0000*IT_0008;
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u1
      *e_em*IT_0000*IT_0006*IT_0008;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = IT_0028*IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0001 + IT_0014 + -m_sc_R*
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0000*IT_0008;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0000*IT_0006*IT_0008;
    const ccomplex_t IT_0038 = 0.5*IT_0037;
    const ccomplex_t IT_0039 = IT_0036*IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0001 + IT_0014 + -m_su_R*
    ...
    const ccomplex_t IT_0054 = IT_0002*IT_0008;
    const ccomplex_t IT_0055 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = 2*IT_0056;
    const ccomplex_t IT_0058 = IT_0002*IT_0045;
    const ccomplex_t IT_0059 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0001 + IT_0070 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0043*IT_0069*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0001 + IT_0070 + -m_N_2*
    ...
    const ccomplex_t IT_0114 = IT_0054*IT_0113;
    ...
    const ccomplex_t IT_0121 = cpow((-2)*s_23 + IT_0001 + IT_0070 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0122 = IT_0098*IT_0120*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0124 = N_B4*e_em;
    const ccomplex_t IT_0125 = IT_0045*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = N_W4*e_em;
    ...
    const ccomplex_t IT_0136 = IT_0058*IT_0135;
    ...
    const ccomplex_t IT_0146 = cpow((-2)*s_23 + IT_0001 + IT_0070 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0147 = IT_0123*IT_0145*IT_0146;
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0000*IT_0003*IT_0008;
    const ccomplex_t IT_0155 = (-0.5)*IT_0154;
    const ccomplex_t IT_0156 = IT_0095*IT_0155;
    const ccomplex_t IT_0157 = IT_0074*IT_0156;
    ...
    const ccomplex_t IT_0162 = IT_0119*IT_0161;
    const ccomplex_t IT_0163 = IT_0121*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*IT_0163;
    const ccomplex_t IT_0165 = m_d*IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0000*IT_0003*IT_0008;
    ...
    const ccomplex_t IT_0171 = m_d*IT_0170;
    ...
    const ccomplex_t IT_0175 = IT_0006*IT_0008;
    const ccomplex_t IT_0176 = m_t*V_td*V_u1*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0181 = V_td*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0188 = IT_0172*IT_0187;
    const ccomplex_t IT_0189 = (0 + _Complex_I*1)*IT_0188;
    const ccomplex_t IT_0190 = cpow((-2)*s_13 + IT_0001 + IT_0014 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0191 = A_t*IT_0002*U_st_10 + (-1.4142135623731)*e_em
    ...
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*conj(V_td)*IT_0191;
    const ccomplex_t IT_0193 = m_t*V_td*V_u1*e_em*IT_0000*conj(U_st_10);
    const ccomplex_t IT_0194 = IT_0175*IT_0193;
    ...
    const ccomplex_t IT_0198 = V_td*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0207 = IT_0017 + IT_0026 + IT_0034 + IT_0042 + IT_0072
       + IT_0097 + IT_0122 + IT_0147 + -IT_0153 + -IT_0159 + -IT_0165 + -IT_0171
       + -IT_0189 + -IT_0206;
    const ccomplex_t IT_0208 = m_d*m_C_1;
    const ccomplex_t IT_0209 = 6*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
    ...
    const ccomplex_t IT_0215 = IT_0004*IT_0045;
    const ccomplex_t IT_0216 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0217 = IT_0215*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0230 = IT_0149*IT_0229;
    const ccomplex_t IT_0231 = IT_0043*IT_0071*IT_0230;
    const ccomplex_t IT_0232 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0233 = IT_0219*IT_0232;
    const ccomplex_t IT_0234 = (-2)*IT_0233;
    const ccomplex_t IT_0235 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0236 = IT_0215*IT_0235;
    const ccomplex_t IT_0237 = 1.4142135623731*IT_0236;
    const ccomplex_t IT_0238 = conj(N_W2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0239 = IT_0219*IT_0238;
    ...
    const ccomplex_t IT_0246 = IT_0073*IT_0074*IT_0245;
    const ccomplex_t IT_0247 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0248 = IT_0219*IT_0247;
    const ccomplex_t IT_0249 = 1.4142135623731*IT_0248;
    const ccomplex_t IT_0250 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0251 = IT_0215*IT_0250;
    const ccomplex_t IT_0252 = 1.4142135623731*IT_0251;
    const ccomplex_t IT_0253 = IT_0249 + IT_0252;
    const ccomplex_t IT_0254 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0255 = IT_0219*IT_0254;
    ...
    const ccomplex_t IT_0260 = IT_0161*IT_0259;
    const ccomplex_t IT_0261 = IT_0098*IT_0121*IT_0260;
    const ccomplex_t IT_0262 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0263 = IT_0219*IT_0262;
    const ccomplex_t IT_0264 = (-2)*IT_0263;
    const ccomplex_t IT_0265 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0266 = IT_0215*IT_0265;
    const ccomplex_t IT_0267 = 1.4142135623731*IT_0266;
    const ccomplex_t IT_0268 = conj(N_W4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0269 = IT_0219*IT_0268;
    ...
    const ccomplex_t IT_0275 = IT_0167*IT_0274;
    const ccomplex_t IT_0276 = IT_0123*IT_0146*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_td*e_em*IT_0000*IT_0003*IT_0008*conj(U_st_00);
    const ccomplex_t IT_0278 = (-0.5)*IT_0277;
    const ccomplex_t IT_0279 = IT_0192*IT_0278;
    const ccomplex_t IT_0280 = IT_0190*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_td*e_em*IT_0000*IT_0003*IT_0008*conj(U_st_01);
    const ccomplex_t IT_0283 = (-0.5)*IT_0282;
    const ccomplex_t IT_0284 = IT_0174*IT_0283;
    const ccomplex_t IT_0285 = IT_0172*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*IT_0285;
    const ccomplex_t IT_0287 = IT_0053*IT_0229;
    const ccomplex_t IT_0288 = IT_0071*IT_0287;
    const ccomplex_t IT_0289 = (0 + _Complex_I*1)*IT_0288;
    const ccomplex_t IT_0290 = m_d*IT_0289;
    const ccomplex_t IT_0291 = IT_0082*IT_0244;
    ...
    const ccomplex_t IT_0295 = IT_0106*IT_0259;
    const ccomplex_t IT_0296 = IT_0121*IT_0295;
    const ccomplex_t IT_0297 = (0 + _Complex_I*1)*IT_0296;
    const ccomplex_t IT_0298 = m_d*IT_0297;
    const ccomplex_t IT_0299 = IT_0131*IT_0274;
    const ccomplex_t IT_0300 = IT_0146*IT_0299;
    const ccomplex_t IT_0301 = (0 + _Complex_I*1)*IT_0300;
    const ccomplex_t IT_0302 = m_d*IT_0301;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
    ...
    const ccomplex_t IT_0308 = -IT_0214 + IT_0231 + IT_0246 + IT_0261 +
       IT_0276 + -IT_0281 + -IT_0286 + -IT_0290 + -IT_0294 + -IT_0298 + -IT_0302
       + -IT_0307;
    const ccomplex_t IT_0309 = 0.166666666666667*conj(IT_0308);
    const ccomplex_t IT_0310 = s_23*m_C_1;
    const ccomplex_t IT_0311 = (-6)*IT_0310;
    const ccomplex_t IT_0312 = -IT_0289 + -IT_0293 + -IT_0297 + -IT_0301;
    const ccomplex_t IT_0313 = 0.166666666666667*conj(IT_0312);
    const ccomplex_t IT_0314 = m_d*s_12;
    const ccomplex_t IT_0315 = (-6)*IT_0314;
    const ccomplex_t IT_0316 = -IT_0152 + -IT_0158 + -IT_0164 + -IT_0170;
    const ccomplex_t IT_0317 = 0.166666666666667*conj(IT_0316);
    const ccomplex_t IT_0318 = 0.166666666666667*conj(IT_0207);
    const ccomplex_t IT_0319 = m_d*m_C_1*IT_0070;
    const ccomplex_t IT_0320 = s_13*IT_0070;
    const ccomplex_t IT_0321 = (-6)*IT_0320;
    const ccomplex_t IT_0322 = s_12*s_23;
    const ccomplex_t IT_0323 = 12*IT_0322;
    const ccomplex_t IT_0324 = IT_0321 + IT_0323;
    const ccomplex_t IT_0325 = 6*IT_0207*(s_13*conj(IT_0207) + IT_0209*IT_0309
       + IT_0311*IT_0313 + IT_0315*IT_0317) + 6*IT_0308*(s_13*conj(IT_0308) +
       IT_0313*IT_0315 + IT_0311*IT_0317 + IT_0209*IT_0318) + 6*IT_0312*(IT_0309
      *IT_0315 + IT_0311*IT_0318 + conj(IT_0316)*IT_0319 + IT_0313*IT_0324) + 6
      *IT_0316*(IT_0309*IT_0311 + IT_0315*IT_0318 + conj(IT_0312)*IT_0319 +
       IT_0317*IT_0324);
