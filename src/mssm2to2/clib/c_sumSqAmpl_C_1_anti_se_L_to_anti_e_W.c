        ...
        )
{
    ...
    const ccomplex_t IT_0169 = m_e*m_C_1;
    ...
    const ccomplex_t IT_0187 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0199 = m_e*IT_0198;
    ...
    const ccomplex_t IT_0233 = m_e*IT_0173;
