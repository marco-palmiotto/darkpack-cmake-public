...
ccomplex_return_t c_sumSqAmpl_C_1_anti_smu_L_to_anti_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0110 = m_mu*m_C_1*IT_0001;
    const ccomplex_t IT_0111 = pow(m_W, -1);
    const ccomplex_t IT_0112 = cos(beta);
    const ccomplex_t IT_0113 = cpow(IT_0112, -1);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0009*IT_0111*IT_0113;
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0009*IT_0111*IT_0113;
    ...
    const ccomplex_t IT_0152 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0009*IT_0111*IT_0113;
    ...
    const ccomplex_t IT_0170 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0009*IT_0111*IT_0113;
    ...
    const ccomplex_t IT_0212 = m_mu*IT_0133;
    const ccomplex_t IT_0213 = m_mu*IT_0151;
    const ccomplex_t IT_0214 = m_mu*IT_0169;
    const ccomplex_t IT_0215 = m_mu*IT_0187;
    ...
    const ccomplex_t IT_0218 = m_mu*s_12;
    const ccomplex_t IT_0219 = (-2)*IT_0218;
    const ccomplex_t IT_0220 = IT_0030*IT_0115;
    const ccomplex_t IT_0221 = IT_0002*IT_0200*IT_0220;
    const ccomplex_t IT_0222 = IT_0079*IT_0153;
    const ccomplex_t IT_0223 = IT_0081*IT_0206*IT_0222;
    const ccomplex_t IT_0224 = IT_0104*IT_0171;
    const ccomplex_t IT_0225 = IT_0106*IT_0209*IT_0224;
    const ccomplex_t IT_0226 = m_mu*IT_0033;
    const ccomplex_t IT_0227 = m_mu*IT_0058;
    const ccomplex_t IT_0228 = m_mu*IT_0083;
    const ccomplex_t IT_0229 = m_mu*IT_0108;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0009*IT_0111*IT_0113;
    const ccomplex_t IT_0231 = (-0.5)*IT_0230;
    const ccomplex_t IT_0232 = IT_0192*IT_0231;
    const ccomplex_t IT_0233 = IT_0197*IT_0232;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1)*IT_0233;
    const ccomplex_t IT_0235 = IT_0054*IT_0135;
    const ccomplex_t IT_0236 = IT_0056*IT_0203*IT_0235;
    const ccomplex_t IT_0237 = IT_0221 + IT_0223 + IT_0225 + -IT_0226 + 
      -IT_0227 + -IT_0228 + -IT_0229 + -IT_0234 + IT_0236;
    ...
    const ccomplex_t IT_0246 = m_mu*m_C_1;
