...
ccomplex_return_t c_sumSqAmpl_C_1_anti_smu_R_to_anti_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0089 = m_mu*m_C_1*IT_0001;
    ...
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0003*IT_0007;
    ...
    const ccomplex_t IT_0188 = m_mu*IT_0109;
    const ccomplex_t IT_0189 = m_mu*IT_0127;
    const ccomplex_t IT_0190 = m_mu*IT_0145;
    const ccomplex_t IT_0191 = m_mu*IT_0163;
    ...
    const ccomplex_t IT_0194 = m_mu*s_12;
    const ccomplex_t IT_0195 = (-2)*IT_0194;
    const ccomplex_t IT_0196 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
    ...
    const ccomplex_t IT_0209 = m_mu*IT_0030;
    const ccomplex_t IT_0210 = m_mu*IT_0049;
    const ccomplex_t IT_0211 = m_mu*IT_0068;
    const ccomplex_t IT_0212 = m_mu*IT_0087;
    ...
    const ccomplex_t IT_0222 = m_mu*m_C_1;
