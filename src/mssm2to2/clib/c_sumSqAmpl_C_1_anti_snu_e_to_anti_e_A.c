...
ccomplex_return_t c_sumSqAmpl_C_1_anti_snu_e_to_anti_e_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = m_e*s_14*m_C_1;
    ...
    const ccomplex_t IT_0028 = m_e*s_34*m_C_1;
    ...
    const ccomplex_t IT_0044 = m_e*m_C_1;
    ...
    const ccomplex_t IT_0061 = 0.5*conj(IT_0027);
    const ccomplex_t IT_0062 = (-2)*IT_0033;
    const ccomplex_t IT_0063 = 0.5*conj(IT_0054);
    const ccomplex_t IT_0064 = (-2)*IT_0042;
    const ccomplex_t IT_0065 = 0.5*conj(IT_0048);
    const ccomplex_t IT_0066 = conj(IT_0032)*IT_0047 + conj(IT_0034)*IT_0051 +
       2*IT_0018*(conj(IT_0016) + 0.5*IT_0052) + 2*IT_0045*IT_0060 + 2*IT_0050
      *IT_0061 + 2*IT_0062*IT_0063 + 2*IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (-2)*IT_0039;
    const ccomplex_t IT_0068 = (-2)*IT_0036;
    const ccomplex_t IT_0069 = conj(IT_0034)*IT_0045 + 2*IT_0028*(conj(IT_0010
      ...
      *IT_0047*IT_0061 + 2*IT_0063*IT_0067 + 2*IT_0065*IT_0068;
    ...
    const ccomplex_t IT_0073 = 8*(IT_0010 + IT_0016)*(conj(IT_0010) + conj
      ...
      *IT_0055) + IT_0035*(conj(IT_0027)*IT_0045 + conj(IT_0034)*IT_0047 +
      ...
      (IT_0035)*IT_0057 + conj(IT_0032)*IT_0058 + conj(IT_0048)*IT_0059) +
       IT_0027*IT_0066 + IT_0032*IT_0069 + IT_0054*(conj(IT_0034)*IT_0055 + conj
      (IT_0035)*IT_0056 + conj(IT_0027)*IT_0062 + conj(IT_0032)*IT_0067 +
       IT_0072) + IT_0048*(conj(IT_0034)*IT_0049 + conj(IT_0035)*IT_0059 + conj
