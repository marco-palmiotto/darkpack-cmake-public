        ...
        )
{
    ...
    const ccomplex_t IT_0033 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_1*
    ...
    const ccomplex_t IT_0045 = V_u1*conj(V_u2)*e_em;
    const ccomplex_t IT_0046 = IT_0007*IT_0045;
    const ccomplex_t IT_0047 = IT_0010*IT_0045;
    const ccomplex_t IT_0048 = e_em*V_Wp1*conj(V_Wp2);
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0009;
    ...
    const ccomplex_t IT_0057 = (-2)*IT_0043 + (-2)*IT_0056;
    ...
    const ccomplex_t IT_0071 = IT_0043 + IT_0056;
    ...
    const ccomplex_t IT_0112 = 2*IT_0022;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0114 = IT_0053*IT_0105;
    const ccomplex_t IT_0115 = IT_0044*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = m_C_1*IT_0056;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0118 = IT_0015*IT_0093;
    const ccomplex_t IT_0119 = IT_0033*IT_0117*IT_0118;
    const ccomplex_t IT_0120 = m_C_1*IT_0043;
    ...
    const ccomplex_t IT_0135 = IT_0027*IT_0040;
    const ccomplex_t IT_0136 = IT_0033*IT_0117*IT_0135;
    const ccomplex_t IT_0137 = IT_0051*IT_0098;
    const ccomplex_t IT_0138 = IT_0044*IT_0113*IT_0137;
    const ccomplex_t IT_0139 = m_C_1*IT_0096;
    const ccomplex_t IT_0140 = m_C_1*IT_0108;
    const ccomplex_t IT_0141 = IT_0136 + IT_0138 + IT_0139 + IT_0140;
    ...
    const ccomplex_t IT_0215 = 0.5*IT_0148;
    ...
    const ccomplex_t IT_0223 = IT_0109*IT_0134 + IT_0071*IT_0153 + IT_0110
      *IT_0174 + IT_0080*IT_0194 + IT_0201 + IT_0081*IT_0207 + IT_0126*IT_0212 +
       IT_0213 + IT_0146*IT_0214 + IT_0219 + IT_0032*IT_0220 + IT_0221 + IT_0057
      *IT_0222;
    ...
    const ccomplex_t IT_0230 = conj(IT_0141)*IT_0214;
    ...
    const ccomplex_t IT_0239 = IT_0018*IT_0073 + 0.125*IT_0057*IT_0111 + 0.125
      *IT_0109*IT_0112 + 0.125*IT_0134*IT_0146 + 0.125*IT_0127*IT_0153 + 0.125
    ...
    const ccomplex_t IT_0244 = IT_0018*IT_0022 + 0.5*IT_0109*IT_0154 + 0.5
      *IT_0032*IT_0155 + 0.5*IT_0162 + 0.5*IT_0165 + 0.5*IT_0127*IT_0220 +
       IT_0111*IT_0240 + IT_0238*IT_0241 + 0.5*IT_0146*IT_0243;
    const ccomplex_t IT_0245 = IT_0057*IT_0174;
    const ccomplex_t IT_0246 = IT_0157*IT_0185;
    const ccomplex_t IT_0247 = IT_0080*IT_0187;
    const ccomplex_t IT_0248 = IT_0110*IT_0222;
    const ccomplex_t IT_0249 = IT_0081*IT_0180;
    const ccomplex_t IT_0250 = IT_0160*IT_0194;
    const ccomplex_t IT_0251 = IT_0163*IT_0207;
    const ccomplex_t IT_0252 = IT_0146*IT_0212;
    const ccomplex_t IT_0253 = IT_0071*IT_0134;
    const ccomplex_t IT_0254 = IT_0109*IT_0153;
    const ccomplex_t IT_0255 = IT_0032*IT_0243;
    const ccomplex_t IT_0256 = 2*conj(IT_0018)*(IT_0022*IT_0032 + IT_0057
      *IT_0061 + (-2)*IT_0018*IT_0070 + 4*IT_0071*IT_0073) + (IT_0061*IT_0080 +
       IT_0081*IT_0085)*IT_0086 + conj(IT_0109)*(IT_0110*IT_0111 + IT_0071
      *IT_0112 + IT_0127*IT_0134 + IT_0146*IT_0153 + IT_0032*IT_0154 + IT_0109
      *IT_0155 + IT_0156*IT_0157 + IT_0162 + IT_0165) + IT_0032*(IT_0166 +
       IT_0167 + IT_0168) + IT_0109*(IT_0086*IT_0156 + IT_0166 + IT_0167 +
       IT_0168) + IT_0146*(IT_0175 + IT_0181 + IT_0186 + IT_0188) + conj(IT_0160
      )*(IT_0160*IT_0190 + IT_0080*IT_0192 + IT_0146*IT_0194 + IT_0110*IT_0195 +
      ...
      (conj(IT_0121) + conj(IT_0126))*IT_0223 + conj(IT_0110)*(IT_0110*IT_0190 +
       IT_0057*IT_0192 + IT_0160*IT_0195 + IT_0080*IT_0198 + IT_0146*IT_0222 +
       IT_0163*IT_0224 + IT_0081*IT_0225) + IT_0127*(IT_0226 + IT_0227 + IT_0228
       + IT_0229 + IT_0230 + IT_0231 + IT_0232 + IT_0233) + conj(IT_0163)*
      (IT_0160*IT_0197 + IT_0080*IT_0200 + IT_0146*IT_0207 + IT_0110*IT_0224 +
      ...
      *IT_0244 + conj(IT_0141)*(IT_0245 + IT_0246 + IT_0247 + IT_0248 + IT_0249 
      + IT_0250 + IT_0251 + IT_0252 + IT_0253 + IT_0254 + IT_0255) + conj
      (IT_0145)*(IT_0127*IT_0214 + IT_0245 + IT_0246 + IT_0247 + IT_0248 +
       IT_0249 + IT_0250 + IT_0251 + IT_0252 + IT_0253 + IT_0254 + IT_0255);
