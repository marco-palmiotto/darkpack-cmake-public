...
ccomplex_return_t c_sumSqAmpl_C_1_anti_snu_mu_to_anti_mu_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0001*IT_0034*IT_0035;
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0001*IT_0034*IT_0035;
    ...
    const ccomplex_t IT_0064 = m_mu*m_C_1*IT_0063;
    const ccomplex_t IT_0065 = e_em*m_mu*IT_0001*IT_0007*IT_0034*IT_0035;
    ...
    const ccomplex_t IT_0080 = m_mu*m_C_1;
    ...
    const ccomplex_t IT_0104 = m_mu*s_14;
