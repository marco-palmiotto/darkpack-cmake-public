...
ccomplex_return_t c_sumSqAmpl_C_1_anti_snu_mu_to_anti_mu_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0001*IT_0036*IT_0038;
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0001*IT_0036*IT_0038;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*m_W*e_em*IT_0073*(IT_0005
      *IT_0037 + -IT_0008*IT_0074);
    ...
    const ccomplex_t IT_0081 = IT_0029*IT_0053;
    const ccomplex_t IT_0082 = IT_0031*IT_0080*IT_0081;
    const ccomplex_t IT_0083 = cpow((-2)*s_12 + IT_0015 + -IT_0016 + -IT_0068 
      + -reg_prop, -1);
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*e_em*m_mu*IT_0001*IT_0005
      *IT_0036*IT_0038;
    ...
    const ccomplex_t IT_0091 = IT_0013*IT_0040;
    const ccomplex_t IT_0092 = IT_0017*IT_0090*IT_0091;
    const ccomplex_t IT_0093 = -IT_0079 + IT_0082 + 2*IT_0089 + IT_0092;
    const ccomplex_t IT_0094 = m_mu*m_C_1;
    const ccomplex_t IT_0095 = IT_0003*IT_0048;
    const ccomplex_t IT_0096 = IT_0017*IT_0090*IT_0095;
    const ccomplex_t IT_0097 = IT_0003*IT_0076;
    const ccomplex_t IT_0098 = IT_0069*IT_0097;
    const ccomplex_t IT_0099 = (0 + _Complex_I*1)*IT_0098;
    const ccomplex_t IT_0100 = IT_0021*IT_0061;
    const ccomplex_t IT_0101 = IT_0031*IT_0080*IT_0100;
    const ccomplex_t IT_0102 = IT_0003*IT_0085;
    const ccomplex_t IT_0103 = IT_0083*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*IT_0103;
    const ccomplex_t IT_0105 = m_mu*IT_0104;
    const ccomplex_t IT_0106 = -IT_0096 + IT_0099 + -IT_0101 + (-2)*IT_0105;
    const ccomplex_t IT_0107 = pow(m_H0, 2);
    const ccomplex_t IT_0108 = m_mu*m_C_1*IT_0107;
    const ccomplex_t IT_0109 = conj(IT_0065) + conj(IT_0104);
    const ccomplex_t IT_0110 = -IT_0019 + -IT_0033;
    const ccomplex_t IT_0111 = -IT_0088;
    const ccomplex_t IT_0112 = IT_0110 + IT_0111;
    const ccomplex_t IT_0113 = IT_0065 + IT_0104;
    ...
    const ccomplex_t IT_0123 = (-2)*IT_0094;
    const ccomplex_t IT_0124 = s_13*IT_0107;
    const ccomplex_t IT_0125 = s_14*s_34;
    const ccomplex_t IT_0126 = (-2)*IT_0125;
    const ccomplex_t IT_0127 = IT_0124 + IT_0126;
    const ccomplex_t IT_0128 = (-2)*IT_0127;
    const ccomplex_t IT_0129 = IT_0093*IT_0116;
    const ccomplex_t IT_0130 = IT_0110*IT_0128;
    const ccomplex_t IT_0131 = (-2)*IT_0104;
    const ccomplex_t IT_0132 = (-2)*conj(IT_0104);
    const ccomplex_t IT_0133 = 2*s_13*(IT_0035*conj(IT_0035) + IT_0067*conj
      ...
      *IT_0093*IT_0119 + IT_0110*IT_0121 + (conj(IT_0067)*IT_0093 + IT_0067*conj
      (IT_0093) + IT_0035*conj(IT_0106))*IT_0122 + IT_0067*conj(IT_0106)*IT_0123
       + 2*IT_0106*(conj(IT_0093)*IT_0094 + s_13*conj(IT_0106) + 0.5*conj
      (IT_0065)*IT_0116 + 0.5*IT_0114*IT_0119 + 0.5*conj(IT_0035)*IT_0122 + 0.5
      *conj(IT_0067)*IT_0123) + IT_0111*(IT_0121 + IT_0114*IT_0128) + IT_0114*
      (IT_0129 + IT_0130) + IT_0109*IT_0127*IT_0131 + 2*IT_0118*(IT_0067*IT_0109
       + conj(IT_0035)*IT_0112 + conj(IT_0067)*IT_0113 + IT_0035*IT_0114 + 0.5
      *conj(IT_0093)*IT_0131 + 0.5*IT_0093*IT_0132) + 2*IT_0115*(IT_0035*IT_0109
       + conj(IT_0067)*IT_0112 + conj(IT_0035)*IT_0113 + IT_0067*IT_0114 + 0.5
      *conj(IT_0106)*IT_0131 + 0.5*IT_0106*IT_0132) + IT_0065*(conj(IT_0106)
      *IT_0116 + conj(IT_0093)*IT_0119 + conj(IT_0065)*IT_0128 + IT_0127*IT_0132);
