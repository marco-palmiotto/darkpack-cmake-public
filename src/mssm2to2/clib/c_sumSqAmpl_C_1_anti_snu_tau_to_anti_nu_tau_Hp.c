...
ccomplex_return_t c_sumSqAmpl_C_1_anti_snu_tau_to_anti_nu_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
    ...
    const ccomplex_t IT_0028 = IT_0007*IT_0019;
    ...
    const ccomplex_t IT_0032 = IT_0007*IT_0009;
    ...
    const ccomplex_t IT_0068 = cpow(s_23 + (-0.5)*IT_0002 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0093 = cpow(s_23 + (-0.5)*IT_0002 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0118 = cpow(s_23 + (-0.5)*IT_0002 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0121 = 0.5*IT_0016 + 0.5*IT_0045 + 0.5*IT_0070 + 0.5
      *IT_0095 + 0.5*IT_0120;
    const ccomplex_t IT_0122 = s_12*s_23;
    const ccomplex_t IT_0123 = s_13*IT_0002;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0009;
    const ccomplex_t IT_0125 = -IT_0124;
    const ccomplex_t IT_0126 = IT_0011*IT_0125;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0128 = IT_0003*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = IT_0005*IT_0009;
    const ccomplex_t IT_0130 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0131 = IT_0129*IT_0130;
    const ccomplex_t IT_0132 = 2*IT_0131;
    const ccomplex_t IT_0133 = IT_0005*IT_0019;
    ...
    const ccomplex_t IT_0196 = 0.5*IT_0128 + (-0.5)*IT_0146 + (-0.5)*IT_0162 +
       (-0.5)*IT_0178 + (-0.5)*IT_0194 + (-0.5)*IT_0195;
