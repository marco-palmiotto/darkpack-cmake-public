...
ccomplex_return_t c_sumSqAmpl_C_1_anti_snu_tau_to_anti_nu_tau_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_tau*IT_0005*IT_0008*IT_0010;
    const ccomplex_t IT_0012 = (-0.5)*IT_0011;
    const ccomplex_t IT_0013 = IT_0007*IT_0012;
    const ccomplex_t IT_0014 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0015 = IT_0003*IT_0013*IT_0014;
    ...
    const ccomplex_t IT_0035 = cpow(s_23 + (-0.5)*IT_0002 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0054 = cpow(s_23 + (-0.5)*IT_0002 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0073 = cpow(s_23 + (-0.5)*IT_0002 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0092 = cpow(s_23 + (-0.5)*IT_0002 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0093 = IT_0090*IT_0091*IT_0092;
    const ccomplex_t IT_0094 = (-0.5)*IT_0015 + (-0.5)*IT_0036 + (-0.5)
      *IT_0055 + (-0.5)*IT_0074 + (-0.5)*IT_0093;
    ...
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0005;
    ...
    const ccomplex_t IT_0153 = 0.5*conj(IT_0152);
    const ccomplex_t IT_0154 = IT_0146*IT_0153;
    const ccomplex_t IT_0155 = -IT_0104 + -IT_0114 + -IT_0124 + -IT_0134;
    const ccomplex_t IT_0156 = s_14*s_34*IT_0138;
    ...
    const ccomplex_t IT_0161 = conj(IT_0155)*IT_0160;
    const ccomplex_t IT_0162 = 0.5*IT_0161;
    const ccomplex_t IT_0163 = pow(s_34, 2);
    const ccomplex_t IT_0164 = m_C_1*IT_0138*IT_0163;
    const ccomplex_t IT_0165 = (-2)*IT_0164;
    const ccomplex_t IT_0166 = -IT_0151;
    const ccomplex_t IT_0167 = 0.5*conj(IT_0166);
    const ccomplex_t IT_0168 = IT_0165*IT_0167;
    const ccomplex_t IT_0169 = s_13*IT_0139;
    ...
    const ccomplex_t IT_0177 = conj(IT_0094) + conj(IT_0137);
    const ccomplex_t IT_0178 = 0.5*IT_0177;
    const ccomplex_t IT_0179 = (-0.25)*IT_0141;
    const ccomplex_t IT_0180 = s_34 + IT_0179;
    const ccomplex_t IT_0181 = m_C_1*IT_0180;
    const ccomplex_t IT_0182 = (-4)*IT_0181;
    const ccomplex_t IT_0183 = 0.5*IT_0104 + 0.5*IT_0114 + 0.5*IT_0124 + 0.5
      *IT_0134;
    const ccomplex_t IT_0184 = IT_0182*conj(IT_0183);
    const ccomplex_t IT_0185 = IT_0154 + IT_0162 + IT_0168 + IT_0176*IT_0178 +
       IT_0184;
    const ccomplex_t IT_0186 = s_13*IT_0138*IT_0163;
    const ccomplex_t IT_0187 = s_13*s_34;
    const ccomplex_t IT_0188 = conj(IT_0152) + conj(IT_0183);
    const ccomplex_t IT_0189 = s_13*IT_0158;
    const ccomplex_t IT_0190 = 2*IT_0189;
    const ccomplex_t IT_0191 = pow(s_14, 2);
    const ccomplex_t IT_0192 = IT_0138*IT_0191;
    const ccomplex_t IT_0193 = -IT_0000;
    const ccomplex_t IT_0194 = IT_0192 + IT_0193;
    const ccomplex_t IT_0195 = s_13*IT_0194;
    const ccomplex_t IT_0196 = s_13*s_14;
    const ccomplex_t IT_0197 = s_34*IT_0000;
    ...
    const ccomplex_t IT_0203 = IT_0169 + IT_0171 + (-0.5)*IT_0202;
    const ccomplex_t IT_0204 = (-4)*IT_0203;
    const ccomplex_t IT_0205 = (-0.25)*IT_0202;
    const ccomplex_t IT_0206 = IT_0170 + IT_0205;
    const ccomplex_t IT_0207 = 8*IT_0206;
    const ccomplex_t IT_0208 = conj(IT_0155)*IT_0199;
    const ccomplex_t IT_0209 = 2*(IT_0094 + IT_0137)*IT_0185 + 2*IT_0166*
      (IT_0165*IT_0178 + conj(IT_0166)*IT_0186 + IT_0187*IT_0188 + 0.5*conj
      (IT_0155)*IT_0190) + 2*IT_0155*(IT_0160*IT_0178 + IT_0167*IT_0190 + conj
      (IT_0155)*IT_0195 + IT_0188*IT_0199) + 2*IT_0183*(IT_0177*IT_0182 + conj
      (IT_0166)*IT_0187 + 0.5*conj(IT_0183)*IT_0204 + IT_0153*IT_0207 + IT_0208)
       + 2*IT_0152*(IT_0146*IT_0178 + conj(IT_0166)*IT_0187 + IT_0153*IT_0204 +
       0.5*conj(IT_0183)*IT_0207 + IT_0208);
