...
ccomplex_return_t c_sumSqAmpl_C_1_anti_snu_tau_to_anti_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = IT_0005*(IT_0021 + IT_0024);
    ...
    const ccomplex_t IT_0053 = conj(U_d1)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0057 = IT_0005*(IT_0054 + IT_0056);
    ...
    const ccomplex_t IT_0066 = conj(U_d1)*conj(V_Wp2);
    const ccomplex_t IT_0067 = IT_0003*IT_0066;
    const ccomplex_t IT_0068 = conj(V_u2)*conj(U_Wm1);
    ...
    const ccomplex_t IT_0083 = IT_0007*IT_0019;
    const ccomplex_t IT_0084 = IT_0014*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*IT_0084;
    const ccomplex_t IT_0086 = 0.5*IT_0085;
    const ccomplex_t IT_0087 = pow(m_H0, 2);
    ...
    const ccomplex_t IT_0091 = IT_0019*IT_0060;
    ...
    const ccomplex_t IT_0095 = IT_0034*IT_0073;
    const ccomplex_t IT_0096 = IT_0044*IT_0094*IT_0095;
    const ccomplex_t IT_0097 = cpow(s_13 + (-0.5)*IT_0011 + (-0.5)*IT_0012 + (
      -0.5)*reg_prop + 0.5*m_snu_tau*(m_snu_tau + (0 + _Complex_I*-1)
      *Gamma_nutaul), -1);
    const ccomplex_t IT_0098 = cos(theta_W);
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*m_W*e_em*IT_0101*(IT_0001
      *IT_0003 + -IT_0022*IT_0102);
    ...
    const ccomplex_t IT_0108 = m_tau*IT_0085;
    const ccomplex_t IT_0109 = (-0.5)*IT_0093 + (-0.5)*IT_0096 + 0.5*IT_0107 +
       -IT_0108;
    const ccomplex_t IT_0110 = (-2)*IT_0050;
    const ccomplex_t IT_0111 = conj(IT_0109)*IT_0110;
    const ccomplex_t IT_0112 = IT_0009*IT_0028;
    const ccomplex_t IT_0113 = IT_0030*IT_0092*IT_0112;
    const ccomplex_t IT_0114 = IT_0042*IT_0065;
    const ccomplex_t IT_0115 = IT_0044*IT_0094*IT_0114;
    const ccomplex_t IT_0116 = m_tau*IT_0016;
    const ccomplex_t IT_0117 = IT_0009*IT_0104;
    const ccomplex_t IT_0118 = IT_0097*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*IT_0118;
    const ccomplex_t IT_0120 = 0.5*IT_0113 + 0.5*IT_0115 + IT_0116 + (-0.5)
      *IT_0119;
    const ccomplex_t IT_0121 = (-2)*IT_0080;
    const ccomplex_t IT_0122 = conj(IT_0120)*IT_0121;
    const ccomplex_t IT_0123 = 0.5*IT_0063 + 0.5*IT_0076;
