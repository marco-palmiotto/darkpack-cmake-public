...
ccomplex_return_t c_sumSqAmpl_C_1_anti_ss_R_to_anti_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0033 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0034 = IT_0017*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0040 = conj(N_d3)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_3*
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0089 = m_s*m_C_1*IT_0001;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0011;
    const ccomplex_t IT_0091 = (-0.333333333333333)*IT_0090;
    const ccomplex_t IT_0092 = IT_0004*IT_0011;
    const ccomplex_t IT_0093 = N_B2*V_u1*e_em;
    const ccomplex_t IT_0094 = IT_0092*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = IT_0004*IT_0007;
    const ccomplex_t IT_0097 = N_W2*V_u1*e_em;
    ...
    const ccomplex_t IT_0101 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0159 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0011;
    ...
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0003*IT_0007;
    const ccomplex_t IT_0168 = 0.5*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0007;
    const ccomplex_t IT_0170 = -IT_0169;
    const ccomplex_t IT_0171 = IT_0168*IT_0170;
    const ccomplex_t IT_0172 = pow(m_C_1, 2);
    const ccomplex_t IT_0173 = cpow((-2)*s_13 + IT_0000 + IT_0172 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0174 = IT_0171*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*IT_0174;
    const ccomplex_t IT_0176 = cpow(IT_0012, -1);
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0003*IT_0005*IT_0007*IT_0176;
    const ccomplex_t IT_0178 = 0.5*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0003*IT_0007*IT_0176;
    const ccomplex_t IT_0180 = 0.5*IT_0179;
    const ccomplex_t IT_0181 = IT_0178*IT_0180;
    const ccomplex_t IT_0182 = cpow((-2)*s_13 + IT_0000 + IT_0172 + -m_sc_R*
    ...
    const ccomplex_t IT_0185 = (0 + _Complex_I*1.4142135623731)*m_s*m_u*V_us
      *e_em*IT_0003*IT_0005*IT_0007*IT_0176;
    const ccomplex_t IT_0186 = 0.5*IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_us
      *e_em*IT_0003*IT_0007*IT_0176;
    const ccomplex_t IT_0188 = 0.5*IT_0187;
    const ccomplex_t IT_0189 = IT_0186*IT_0188;
    const ccomplex_t IT_0190 = cpow((-2)*s_13 + IT_0000 + IT_0172 + -m_su_R*
    ...
    const ccomplex_t IT_0194 = IT_0009*IT_0158;
    const ccomplex_t IT_0195 = IT_0002*IT_0193*IT_0194;
    const ccomplex_t IT_0196 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0197 = IT_0071*IT_0106;
    const ccomplex_t IT_0198 = IT_0069*IT_0196*IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0200 = IT_0032*IT_0124;
    const ccomplex_t IT_0201 = IT_0047*IT_0199*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0203 = IT_0051*IT_0142;
    const ccomplex_t IT_0204 = IT_0066*IT_0202*IT_0203;
    const ccomplex_t IT_0205 = m_s*IT_0163;
    const ccomplex_t IT_0206 = m_s*IT_0109;
    const ccomplex_t IT_0207 = m_s*IT_0127;
    const ccomplex_t IT_0208 = m_s*IT_0145;
    const ccomplex_t IT_0209 = cpow((-2)*s_13 + IT_0000 + IT_0172 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0210 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *mu_h*IT_0003*IT_0007;
    const ccomplex_t IT_0211 = 0.5*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*V_us*e_em*V_Wp1*IT_0007;
    ...
    const ccomplex_t IT_0217 = cpow((-2)*s_13 + IT_0000 + IT_0172 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0012
      *U_st_00 + 0.707106781186548*m_s*e_em*IT_0003*IT_0007*(mu_h*U_st_00 + m_t
      *IT_0005*IT_0176*U_st_10));
    const ccomplex_t IT_0219 = IT_0007*IT_0176;
    const ccomplex_t IT_0220 = m_t*V_ts*V_u1*e_em*IT_0003*conj(U_st_10);
    ...
    const ccomplex_t IT_0225 = V_ts*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0234 = cpow((-2)*s_13 + IT_0000 + IT_0172 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0012
      *U_st_01 + 0.707106781186548*m_s*e_em*IT_0003*IT_0007*(mu_h*U_st_01 + m_t
      *IT_0005*IT_0176*U_st_11));
    const ccomplex_t IT_0236 = m_t*V_ts*V_u1*e_em*IT_0003*conj(U_st_11);
    ...
    const ccomplex_t IT_0241 = V_ts*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0247 = IT_0235*IT_0246;
    const ccomplex_t IT_0248 = IT_0234*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0175 + IT_0184 + IT_0192 + IT_0195 + IT_0198
       + IT_0201 + IT_0204 + -IT_0205 + -IT_0206 + -IT_0207 + -IT_0208 + IT_0216
       + -IT_0233 + -IT_0249;
    const ccomplex_t IT_0251 = 0.166666666666667*conj(IT_0250);
    const ccomplex_t IT_0252 = m_s*s_12;
    const ccomplex_t IT_0253 = (-6)*IT_0252;
    const ccomplex_t IT_0254 = IT_0027*IT_0160;
    const ccomplex_t IT_0255 = IT_0002*IT_0193*IT_0254;
    const ccomplex_t IT_0256 = IT_0045*IT_0111;
    const ccomplex_t IT_0257 = IT_0047*IT_0199*IT_0256;
    const ccomplex_t IT_0258 = IT_0064*IT_0129;
    const ccomplex_t IT_0259 = IT_0066*IT_0202*IT_0258;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_ts*e_em*IT_0003*IT_0005*IT_0007*conj(U_st_00);
    const ccomplex_t IT_0261 = (-0.5)*IT_0260;
    const ccomplex_t IT_0262 = IT_0218*IT_0261;
    const ccomplex_t IT_0263 = IT_0217*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_ts*e_em*IT_0003*IT_0005*IT_0007*conj(U_st_01);
    const ccomplex_t IT_0266 = (-0.5)*IT_0265;
    const ccomplex_t IT_0267 = IT_0235*IT_0266;
    const ccomplex_t IT_0268 = IT_0234*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = m_s*IT_0030;
    const ccomplex_t IT_0271 = m_s*IT_0068;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_us*e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0273 = (-0.5)*IT_0272;
    const ccomplex_t IT_0274 = IT_0211*IT_0273;
    const ccomplex_t IT_0275 = IT_0209*IT_0274;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1)*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0278 = (-0.5)*IT_0277;
    const ccomplex_t IT_0279 = IT_0168*IT_0278;
    const ccomplex_t IT_0280 = IT_0173*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = IT_0084*IT_0091;
    const ccomplex_t IT_0283 = IT_0069*IT_0196*IT_0282;
    const ccomplex_t IT_0284 = m_s*IT_0087;
    const ccomplex_t IT_0285 = m_s*IT_0049;
    const ccomplex_t IT_0286 = IT_0255 + IT_0257 + IT_0259 + -IT_0264 + 
      -IT_0269 + -IT_0270 + -IT_0271 + -IT_0276 + -IT_0281 + IT_0283 + -IT_0284 
      + -IT_0285;
    const ccomplex_t IT_0287 = 0.166666666666667*conj(IT_0286);
    const ccomplex_t IT_0288 = s_13*IT_0001;
    const ccomplex_t IT_0289 = (-6)*IT_0288;
    const ccomplex_t IT_0290 = s_12*s_23;
    const ccomplex_t IT_0291 = 12*IT_0290;
    const ccomplex_t IT_0292 = IT_0289 + IT_0291;
    const ccomplex_t IT_0293 = 0.166666666666667*conj(IT_0088);
    const ccomplex_t IT_0294 = 0.166666666666667*conj(IT_0164);
    const ccomplex_t IT_0295 = m_s*m_C_1;
    const ccomplex_t IT_0296 = 6*IT_0295;
    const ccomplex_t IT_0297 = 6*IT_0088*(IT_0089*conj(IT_0164) + IT_0166
      *IT_0251 + IT_0253*IT_0287 + IT_0292*IT_0293) + 6*IT_0164*(conj(IT_0088)
      *IT_0089 + IT_0251*IT_0253 + IT_0166*IT_0287 + IT_0292*IT_0294) + 6
      *IT_0286*(s_13*conj(IT_0286) + IT_0253*IT_0293 + IT_0166*IT_0294 + IT_0251
      *IT_0296) + 6*IT_0250*(s_13*conj(IT_0250) + IT_0166*IT_0293 + IT_0253
      *IT_0294 + IT_0287*IT_0296);
