        ...
        )
{
    ...
    const ccomplex_t IT_0057 = m_t*V_tb*V_u2*e_em*IT_0011*conj(U_st_10);
    ...
    const ccomplex_t IT_0063 = V_tb*e_em*V_Wp2*conj(U_st_00);
    ...
    const ccomplex_t IT_0071 = m_t*V_tb*V_u1*e_em*IT_0011*conj(U_st_10);
    ...
    const ccomplex_t IT_0077 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0103 = m_t*e_em*mu_h*IT_0011*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0104 = IT_0007*IT_0103;
    const ccomplex_t IT_0105 = m_t*e_em*mu_h*IT_0011*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0106 = IT_0007*IT_0105;
    const ccomplex_t IT_0107 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0108 = IT_0000*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0117 = cpow((-2)*s_13 + IT_0016 + IT_0040 + -m_st_1*
    ...
    const ccomplex_t IT_0123 = cpow((-2)*s_13 + IT_0016 + IT_0040 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0124 = m_t*e_em*mu_h*IT_0011*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0125 = IT_0007*IT_0124;
    const ccomplex_t IT_0126 = m_t*e_em*mu_h*IT_0011*conj(U_st_00)*U_st_11;
    const ccomplex_t IT_0127 = IT_0007*IT_0126;
    const ccomplex_t IT_0128 = A_t*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0129 = IT_0000*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = A_t*conj(U_st_00)*U_st_11;
    ...
    const ccomplex_t IT_0134 = 0.5*IT_0125 + (-0.5)*IT_0127 + 0.5*IT_0130 + (
      -0.5)*IT_0133;
    const ccomplex_t IT_0135 = m_t*V_tb*V_u1*e_em*IT_0011*conj(U_st_11);
    ...
    const ccomplex_t IT_0140 = V_tb*e_em*V_Wp1*conj(U_st_01);
