...
ccomplex_return_t c_sumSqAmpl_C_1_anti_st_2_to_anti_b_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = V_tb*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0015 = m_t*V_tb*V_u1*e_em*IT_0014*conj(U_st_11);
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_st_2*
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0001*IT_0014*IT_0036*conj(U_st_01);
