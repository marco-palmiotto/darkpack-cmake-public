...
ccomplex_return_t c_sumSqAmpl_C_1_anti_st_2_to_anti_b_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0003*IT_0005*IT_0007*conj(U_st_01);
    const ccomplex_t IT_0009 = (-0.5)*IT_0008;
    const ccomplex_t IT_0010 = pow(m_b, 2);
    const ccomplex_t IT_0011 = pow(m_C_1, 2);
    const ccomplex_t IT_0012 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_st_2*
    ...
    const ccomplex_t IT_0034 = m_t*V_tb*V_u1*e_em*IT_0003*conj(U_st_11);
