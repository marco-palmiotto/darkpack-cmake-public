...
ccomplex_return_t c_sumSqAmpl_C_1_anti_st_2_to_anti_b_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*e_em*((-0.75)*(IT_0008
      *IT_0011 + -1./3*IT_0007*IT_0012)*U_st_01*conj(U_st_01) + IT_0007*IT_0012
      *U_st_11*conj(U_st_11));
    const ccomplex_t IT_0054 = 1.33333333333333*IT_0053;
    const ccomplex_t IT_0055 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_st_2*
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*e_em*((-0.75)*(IT_0008
      *IT_0011 + -1./3*IT_0007*IT_0012)*U_st_00*conj(U_st_01) + IT_0007*IT_0012
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_st_1*
    ...
    const ccomplex_t IT_0094 = m_t*V_tb*V_u1*e_em*IT_0004*conj(U_st_11);
    ...
    const ccomplex_t IT_0099 = V_tb*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0115 = m_t*V_tb*V_u2*e_em*IT_0004*conj(U_st_11);
    ...
    const ccomplex_t IT_0120 = V_tb*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0224 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0229 = m_t*V_tb*V_u1*e_em*IT_0004*conj(U_st_10);
