...
ccomplex_return_t c_sumSqAmpl_C_1_anti_st_2_to_anti_b_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0033 = m_t*V_tb*V_u2*e_em*IT_0005*conj(U_st_11);
    ...
    const ccomplex_t IT_0067 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
    ...
    const ccomplex_t IT_0072 = V_u1*U_Wm1;
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0003*IT_0005*IT_0066*conj(U_st_01);
    ...
    const ccomplex_t IT_0110 = cpow((-2)*s_13 + IT_0027 + IT_0109 + -m_st_2*
    ...
    const ccomplex_t IT_0118 = 2*U_st_01*(((-0.5)*m_W*IT_0114*(IT_0003 + -1./3
      *IT_0002*IT_0116) + IT_0001*IT_0003*IT_0005*IT_0018*IT_0117)*conj(U_st_01)
       + 1./2*IT_0001*IT_0003*IT_0021*IT_0111*conj(U_st_11)) + U_st_11*(IT_0001
      *IT_0003*IT_0021*IT_0111*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0114*IT_0116 + (-1.5)*IT_0001*IT_0003*IT_0005*IT_0018*IT_0117)*conj
      (U_st_11));
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*(e_em*IT_0118 +
       1.4142135623731*A_t*IT_0018*(conj(U_st_01)*U_st_11 + U_st_01*conj(U_st_11
      )));
    ...
    const ccomplex_t IT_0124 = cpow((-2)*s_13 + IT_0027 + IT_0109 + -m_st_1*
    ...
    const ccomplex_t IT_0127 = 2*U_st_00*(((-0.5)*m_W*IT_0114*(IT_0003 + -1./3
      *IT_0002*IT_0116) + IT_0001*IT_0003*IT_0005*IT_0018*IT_0117)*conj(U_st_01)
       + 1./2*IT_0001*IT_0003*IT_0021*IT_0111*conj(U_st_11)) + U_st_10*(IT_0001
      *IT_0003*IT_0021*IT_0111*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0114*IT_0116 + (-1.5)*IT_0001*IT_0003*IT_0005*IT_0018*IT_0117)*conj
      (U_st_11));
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*(e_em*IT_0127 +
       1.4142135623731*A_t*IT_0018*(conj(U_st_01)*U_st_10 + U_st_00*conj(U_st_11
      )));
    ...
    const ccomplex_t IT_0146 = -IT_0123 + -IT_0132 + IT_0135 + IT_0138 + 2
      *IT_0145;
    ...
    const ccomplex_t IT_0152 = m_t*V_tb*V_u1*e_em*IT_0005*conj(U_st_10);
    ...
    const ccomplex_t IT_0157 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0166 = IT_0016*IT_0079;
    const ccomplex_t IT_0167 = IT_0029*IT_0137*IT_0166;
    const ccomplex_t IT_0168 = IT_0043*IT_0064;
    const ccomplex_t IT_0169 = IT_0052*IT_0134*IT_0168;
    const ccomplex_t IT_0170 = IT_0140*IT_0142;
    ...
    const ccomplex_t IT_0190 = -IT_0144;
