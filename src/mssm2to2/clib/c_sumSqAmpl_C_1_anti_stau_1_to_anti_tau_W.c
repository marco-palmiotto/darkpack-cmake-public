...
ccomplex_return_t c_sumSqAmpl_C_1_anti_stau_1_to_anti_tau_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = conj(N_B1)*e_em*conj(U_stau_10);
    ...
    const ccomplex_t IT_0021 = conj(N_d1)*e_em*m_tau*IT_0020*conj(U_stau_00);
    ...
    const ccomplex_t IT_0037 = conj(N_B2)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0038 = IT_0013*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = conj(N_d2)*e_em*m_tau*IT_0020*conj(U_stau_00);
    ...
    const ccomplex_t IT_0056 = conj(N_B3)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0057 = IT_0013*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = conj(N_d3)*e_em*m_tau*IT_0020*conj(U_stau_00);
    ...
    const ccomplex_t IT_0075 = conj(N_B4)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0076 = IT_0013*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = conj(N_d4)*e_em*m_tau*IT_0020*conj(U_stau_00);
