...
ccomplex_return_t c_sumSqAmpl_C_1_anti_stau_2_to_anti_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = conj(N_B1)*e_em*conj(U_stau_11);
    ...
    const ccomplex_t IT_0029 = conj(N_d1)*e_em*m_tau*IT_0028*conj(U_stau_01);
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = 1.4142135623731*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*(IT_0025 + 0.5*IT_0031);
    ...
    const ccomplex_t IT_0037 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
       0.5*m_N_2*(m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0038 = conj(N_B2)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0039 = IT_0011*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = conj(N_d2)*e_em*m_tau*IT_0028*conj(U_stau_01);
    ...
    const ccomplex_t IT_0053 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0076 = conj(N_B3)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0077 = IT_0011*IT_0076;
    const ccomplex_t IT_0078 = 1.4142135623731*IT_0077;
    const ccomplex_t IT_0079 = conj(N_d3)*e_em*m_tau*IT_0028*conj(U_stau_01);
    ...
    const ccomplex_t IT_0087 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0101 = conj(N_B4)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0102 = IT_0011*IT_0101;
    const ccomplex_t IT_0103 = 1.4142135623731*IT_0102;
    const ccomplex_t IT_0104 = conj(N_d4)*e_em*m_tau*IT_0028*conj(U_stau_01);
    ...
    const ccomplex_t IT_0112 = 0.5*IT_0036 + 0.5*IT_0061 + 0.5*IT_0086 + 0.5
      *IT_0111;
    const ccomplex_t IT_0113 = m_C_1*m_tau*IT_0001;
    const ccomplex_t IT_0114 = sin(beta);
    const ccomplex_t IT_0115 = IT_0011*IT_0114;
    const ccomplex_t IT_0116 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0117 = IT_0115*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = IT_0005*IT_0114;
    const ccomplex_t IT_0120 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0124 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0151 = IT_0119*IT_0150;
    ...
    const ccomplex_t IT_0157 = N_B4*e_em*conj(U_stau_01);
    const ccomplex_t IT_0158 = IT_0011*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = N_W4*e_em*conj(U_stau_01);
    const ccomplex_t IT_0161 = IT_0005*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = N_d4*e_em*m_tau*IT_0028*conj(U_stau_11);
    const ccomplex_t IT_0164 = IT_0027*IT_0163;
    ...
    const ccomplex_t IT_0198 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0199 = IT_0119*IT_0198;
    const ccomplex_t IT_0200 = 1.4142135623731*IT_0199;
    const ccomplex_t IT_0201 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0202 = IT_0115*IT_0201;
    const ccomplex_t IT_0203 = 1.4142135623731*IT_0202;
    const ccomplex_t IT_0204 = IT_0200 + IT_0203;
    const ccomplex_t IT_0205 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0206 = IT_0119*IT_0205;
    ...
    const ccomplex_t IT_0211 = N_B3*e_em*conj(U_stau_01);
    const ccomplex_t IT_0212 = IT_0011*IT_0211;
    const ccomplex_t IT_0213 = 1.4142135623731*IT_0212;
    const ccomplex_t IT_0214 = N_W3*e_em*conj(U_stau_01);
    const ccomplex_t IT_0215 = IT_0005*IT_0214;
    const ccomplex_t IT_0216 = 1.4142135623731*IT_0215;
    const ccomplex_t IT_0217 = N_d3*e_em*m_tau*IT_0028*conj(U_stau_11);
    ...
    const ccomplex_t IT_0225 = 0.5*IT_0143 + 0.5*IT_0170 + 0.5*IT_0197 + 0.5
      *IT_0224;
    const ccomplex_t IT_0226 = s_12*s_23;
    const ccomplex_t IT_0227 = s_13*IT_0001;
    const ccomplex_t IT_0228 = (-0.5)*IT_0227;
    const ccomplex_t IT_0229 = IT_0226 + IT_0228;
    const ccomplex_t IT_0230 = 4*IT_0229;
    const ccomplex_t IT_0231 = 0.5*conj(IT_0112);
    const ccomplex_t IT_0232 = s_12*m_tau;
    const ccomplex_t IT_0233 = (-2)*IT_0232;
    const ccomplex_t IT_0234 = m_tau*IT_0036;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0236 = IT_0022*IT_0140;
    const ccomplex_t IT_0237 = IT_0002*IT_0235*IT_0236;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0239 = IT_0058*IT_0194;
    const ccomplex_t IT_0240 = IT_0037*IT_0238*IT_0239;
    const ccomplex_t IT_0241 = pow(m_C_1, 2);
    const ccomplex_t IT_0242 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0241 + (
      -0.5)*reg_prop + 0.5*m_snu_tau*(m_snu_tau + (0 + _Complex_I*-1)
      *Gamma_nutaul), -1);
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*(A_tau*IT_0114*conj
      (U_stau_11) + (-1.4142135623731)*e_em*IT_0005*(m_W*IT_0003*IT_0114*conj
      (U_stau_01) + (-0.5)*m_tau*IT_0028*(m_tau*IT_0026*IT_0114*conj(U_stau_01) 
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0005;
    ...
    const ccomplex_t IT_0250 = IT_0075*IT_0221;
    const ccomplex_t IT_0251 = IT_0062*IT_0249*IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0253 = IT_0100*IT_0167;
    const ccomplex_t IT_0254 = IT_0087*IT_0252*IT_0253;
    const ccomplex_t IT_0255 = m_tau*IT_0061;
    const ccomplex_t IT_0256 = m_tau*IT_0086;
    const ccomplex_t IT_0257 = m_tau*IT_0111;
    const ccomplex_t IT_0258 = 0.5*IT_0234 + (-0.5)*IT_0237 + (-0.5)*IT_0240 +
       (-0.5)*IT_0248 + (-0.5)*IT_0251 + (-0.5)*IT_0254 + 0.5*IT_0255 + 0.5
      *IT_0256 + 0.5*IT_0257;
    const ccomplex_t IT_0259 = 0.5*conj(IT_0258);
    const ccomplex_t IT_0260 = s_23*m_C_1;
    const ccomplex_t IT_0261 = (-2)*IT_0260;
    const ccomplex_t IT_0262 = m_tau*IT_0170;
    const ccomplex_t IT_0263 = IT_0045*IT_0183;
    const ccomplex_t IT_0264 = IT_0037*IT_0238*IT_0263;
    const ccomplex_t IT_0265 = IT_0033*IT_0129;
    const ccomplex_t IT_0266 = IT_0002*IT_0235*IT_0265;
    const ccomplex_t IT_0267 = IT_0083*IT_0210;
    const ccomplex_t IT_0268 = IT_0062*IT_0249*IT_0267;
    const ccomplex_t IT_0269 = IT_0108*IT_0156;
    const ccomplex_t IT_0270 = IT_0087*IT_0252*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_tau*IT_0005*IT_0026*IT_0028;
    const ccomplex_t IT_0272 = (-0.5)*IT_0271;
    const ccomplex_t IT_0273 = IT_0243*IT_0272;
    const ccomplex_t IT_0274 = IT_0242*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*IT_0274;
    const ccomplex_t IT_0276 = m_tau*IT_0143;
    const ccomplex_t IT_0277 = m_tau*IT_0197;
    const ccomplex_t IT_0278 = m_tau*IT_0224;
    const ccomplex_t IT_0279 = 0.5*IT_0262 + (-0.5)*IT_0264 + (-0.5)*IT_0266 +
       (-0.5)*IT_0268 + (-0.5)*IT_0270 + 0.5*IT_0275 + 0.5*IT_0276 + 0.5*IT_0277
       + 0.5*IT_0278;
    const ccomplex_t IT_0280 = 0.5*conj(IT_0279);
    const ccomplex_t IT_0281 = 0.5*conj(IT_0225);
    const ccomplex_t IT_0282 = m_C_1*m_tau;
    const ccomplex_t IT_0283 = 2*IT_0282;
    const ccomplex_t IT_0284 = 2*IT_0112*(IT_0113*conj(IT_0225) + IT_0230
      *IT_0231 + IT_0233*IT_0259 + IT_0261*IT_0280) + 2*IT_0225*(conj(IT_0112)
      *IT_0113 + IT_0259*IT_0261 + IT_0233*IT_0280 + IT_0230*IT_0281) + 2
      *IT_0279*(IT_0231*IT_0261 + s_13*conj(IT_0279) + IT_0233*IT_0281 + IT_0259
      *IT_0283) + 2*IT_0258*(IT_0231*IT_0233 + s_13*conj(IT_0258) + IT_0261
      *IT_0281 + IT_0280*IT_0283);
