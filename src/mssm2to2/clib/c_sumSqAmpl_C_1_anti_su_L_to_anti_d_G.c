...
ccomplex_return_t c_sumSqAmpl_C_1_anti_su_L_to_anti_d_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0006*IT_0025*IT_0027;
    ...
    const ccomplex_t IT_0041 = m_d*m_C_1;
    ...
    const ccomplex_t IT_0048 = m_d*s_14*m_C_1;
    const ccomplex_t IT_0049 = m_d*s_34*m_C_1;
