...
ccomplex_return_t c_sumSqAmpl_C_1_anti_su_L_to_anti_d_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0010;
    const ccomplex_t IT_0016 = -IT_0015;
    const ccomplex_t IT_0017 = IT_0014*IT_0016;
    const ccomplex_t IT_0018 = IT_0002*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp2*IT_0010;
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_C_2*
    ...
    const ccomplex_t IT_0041 = U_d2*V_Wp1;
    const ccomplex_t IT_0042 = IT_0004*IT_0041;
    const ccomplex_t IT_0043 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0056 = V_u1*U_Wm1;
    ...
    const ccomplex_t IT_0068 = IT_0029*IT_0040;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0070 = IT_0031*IT_0068*IT_0069;
    const ccomplex_t IT_0071 = pow(m_u, 2);
    const ccomplex_t IT_0072 = sin(beta);
    const ccomplex_t IT_0073 = cpow(IT_0072, -1);
    const ccomplex_t IT_0074 = cos(theta_W);
    const ccomplex_t IT_0075 = cpow(IT_0074, -2);
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*e_em*(IT_0007*IT_0010
      *IT_0036*IT_0071*IT_0073 + 0.5*m_W*(IT_0004*IT_0037 + -IT_0007*IT_0072)*
      (IT_0010 + -1./3*IT_0009*IT_0075));
    const ccomplex_t IT_0077 = -IT_0076;
    const ccomplex_t IT_0078 = IT_0053*IT_0077;
    const ccomplex_t IT_0079 = pow(m_C_1, 2);
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0000 + IT_0079 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0084 = IT_0014*IT_0053;
    const ccomplex_t IT_0085 = IT_0002*IT_0083*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_d*e_em*IT_0004*IT_0010
      *IT_0036*IT_0038;
    const ccomplex_t IT_0087 = (-0.5)*IT_0086;
    const ccomplex_t IT_0088 = IT_0053*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0079 
      + -reg_prop, -1);
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*IT_0090;
    const ccomplex_t IT_0092 = m_d*IT_0091;
    const ccomplex_t IT_0093 = IT_0070 + -IT_0082 + IT_0085 + 2*IT_0092;
    const ccomplex_t IT_0094 = m_d*m_C_1;
    const ccomplex_t IT_0095 = IT_0021*IT_0048;
    const ccomplex_t IT_0096 = IT_0031*IT_0069*IT_0095;
    const ccomplex_t IT_0097 = IT_0016*IT_0077;
    const ccomplex_t IT_0098 = IT_0080*IT_0097;
    const ccomplex_t IT_0099 = (0 + _Complex_I*1)*IT_0098;
    const ccomplex_t IT_0100 = IT_0016*IT_0087;
    ...
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0004
      *IT_0010*IT_0036*IT_0073;
    const ccomplex_t IT_0105 = 0.5*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0010*IT_0036*IT_0073;
    const ccomplex_t IT_0107 = 0.5*IT_0106;
    const ccomplex_t IT_0108 = IT_0105*IT_0107;
    const ccomplex_t IT_0109 = cpow((-2)*s_13 + IT_0000 + IT_0079 + -m_su_R*
    ...
    const ccomplex_t IT_0112 = IT_0016*IT_0061;
    const ccomplex_t IT_0113 = IT_0002*IT_0083*IT_0112;
    const ccomplex_t IT_0114 = -IT_0096 + IT_0099 + (-2)*IT_0103 + IT_0111 + 
      -IT_0113;
    ...
    const ccomplex_t IT_0138 = IT_0118*IT_0136;
    const ccomplex_t IT_0139 = (-6)*IT_0102;
    const ccomplex_t IT_0140 = (-6)*conj(IT_0102);
    const ccomplex_t IT_0141 = 6*s_13*(IT_0035*conj(IT_0035) + IT_0067*conj
      ...
      *IT_0093*IT_0127 + IT_0118*IT_0129 + (conj(IT_0067)*IT_0093 + IT_0067*conj
      ...
      *conj(IT_0067)*IT_0131) + IT_0119*(IT_0129 + IT_0122*IT_0136) + IT_0122*
