...
ccomplex_return_t c_sumSqAmpl_C_1_anti_su_L_to_anti_d_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0005;
    ...
    const ccomplex_t IT_0019 = m_d*m_C_1;
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0005*IT_0023*IT_0025;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_2*
    ...
    const ccomplex_t IT_0049 = IT_0012*IT_0047;
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = (-2)*IT_0046 + (-2)*IT_0057;
    ...
    const ccomplex_t IT_0073 = IT_0046 + IT_0057;
    ...
    const ccomplex_t IT_0078 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
    ...
    const ccomplex_t IT_0089 = U_d1*conj(U_d1)*e_em;
    const ccomplex_t IT_0090 = IT_0010*IT_0089;
    const ccomplex_t IT_0091 = IT_0012*IT_0089;
    const ccomplex_t IT_0092 = e_em*U_Wm1*conj(U_Wm1);
    ...
    const ccomplex_t IT_0110 = IT_0044*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*IT_0110;
    const ccomplex_t IT_0112 = m_C_1*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0114 = IT_0027*IT_0053;
    const ccomplex_t IT_0115 = IT_0055*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0117 = IT_0042*IT_0101;
    const ccomplex_t IT_0118 = IT_0044*IT_0116*IT_0117;
    const ccomplex_t IT_0119 = IT_0099 + IT_0112 + IT_0115 + IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0121 = IT_0007*IT_0029;
    const ccomplex_t IT_0122 = IT_0003*IT_0120*IT_0121;
    const ccomplex_t IT_0123 = m_d*IT_0018;
    ...
    const ccomplex_t IT_0130 = m_d*IT_0129;
    const ccomplex_t IT_0131 = (-4)*IT_0130;
    const ccomplex_t IT_0132 = IT_0088*IT_0131;
    const ccomplex_t IT_0133 = (-2)*IT_0098 + (-2)*IT_0111;
    ...
    const ccomplex_t IT_0144 = IT_0098 + IT_0111;
    const ccomplex_t IT_0145 = 3*IT_0021;
    const ccomplex_t IT_0146 = conj(IT_0133)*IT_0134;
    const ccomplex_t IT_0147 = IT_0035*IT_0108;
    const ccomplex_t IT_0148 = IT_0044*IT_0116*IT_0147;
    const ccomplex_t IT_0149 = m_C_1*IT_0046;
    const ccomplex_t IT_0150 = IT_0007*IT_0095;
    const ccomplex_t IT_0151 = IT_0055*IT_0113*IT_0150;
    const ccomplex_t IT_0152 = m_C_1*IT_0057;
    const ccomplex_t IT_0153 = IT_0148 + IT_0149 + IT_0151 + IT_0152;
    const ccomplex_t IT_0154 = IT_0015*IT_0027;
    const ccomplex_t IT_0155 = IT_0003*IT_0120*IT_0154;
    const ccomplex_t IT_0156 = m_d*IT_0032;
    const ccomplex_t IT_0157 = IT_0155 + -IT_0156;
    const ccomplex_t IT_0158 = conj(IT_0153) + conj(IT_0157);
    const ccomplex_t IT_0159 = 0.5*IT_0127;
    ...
    const ccomplex_t IT_0164 = s_34*IT_0020;
    const ccomplex_t IT_0165 = IT_0063*IT_0164;
    const ccomplex_t IT_0166 = (-0.25)*IT_0165;
    ...
    const ccomplex_t IT_0171 = 6*IT_0022;
    ...
    const ccomplex_t IT_0175 = (-6)*IT_0145;
    const ccomplex_t IT_0176 = pow(s_14, 2);
    const ccomplex_t IT_0177 = IT_0063*IT_0176;
    const ccomplex_t IT_0178 = -IT_0001;
    const ccomplex_t IT_0179 = IT_0177 + IT_0178;
    const ccomplex_t IT_0180 = s_13*IT_0179;
    const ccomplex_t IT_0181 = 6*IT_0180;
    const ccomplex_t IT_0182 = IT_0019*IT_0179;
    const ccomplex_t IT_0183 = 6*IT_0182;
    const ccomplex_t IT_0184 = s_14*s_34*IT_0063;
    const ccomplex_t IT_0185 = -IT_0184;
    const ccomplex_t IT_0186 = s_13 + IT_0185;
    const ccomplex_t IT_0187 = m_C_1*IT_0186;
    const ccomplex_t IT_0188 = 6*IT_0187;
    const ccomplex_t IT_0189 = (-6)*IT_0180;
    const ccomplex_t IT_0190 = s_13*IT_0186;
    const ccomplex_t IT_0191 = (-6)*IT_0190;
    const ccomplex_t IT_0192 = (-6)*IT_0182;
    const ccomplex_t IT_0193 = IT_0019*IT_0186;
    const ccomplex_t IT_0194 = (-6)*IT_0193;
    const ccomplex_t IT_0195 = m_d*IT_0179;
    const ccomplex_t IT_0196 = (-6)*IT_0195;
    const ccomplex_t IT_0197 = IT_0082*(conj(IT_0073)*IT_0139 + IT_0062
      *IT_0172 + conj(IT_0082)*IT_0181 + conj(IT_0138)*IT_0183 + IT_0158*IT_0188
       + conj(IT_0058)*IT_0189 + conj(IT_0083)*IT_0191 + conj(IT_0133)*IT_0192 +
       conj(IT_0141)*IT_0194 + IT_0125*IT_0196);
    const ccomplex_t IT_0198 = 6*IT_0190;
    const ccomplex_t IT_0199 = 6*IT_0193;
    const ccomplex_t IT_0200 = (-6)*IT_0187;
    const ccomplex_t IT_0201 = 6*conj(IT_0018);
    const ccomplex_t IT_0202 = 6*IT_0195;
    const ccomplex_t IT_0203 = IT_0058*(conj(IT_0073)*IT_0134 + conj(IT_0058)
      *IT_0181 + conj(IT_0133)*IT_0183 + conj(IT_0082)*IT_0189 + conj(IT_0138)
      *IT_0192 + conj(IT_0083)*IT_0198 + conj(IT_0141)*IT_0199 + IT_0158*IT_0200
       + IT_0062*IT_0201 + IT_0125*IT_0202);
    const ccomplex_t IT_0204 = pow(s_34, 2);
    const ccomplex_t IT_0205 = IT_0063*IT_0204;
    ...
    const ccomplex_t IT_0210 = s_13*IT_0207;
    const ccomplex_t IT_0211 = (-6)*IT_0210;
    const ccomplex_t IT_0212 = IT_0019*IT_0207;
    const ccomplex_t IT_0213 = (-6)*IT_0212;
    const ccomplex_t IT_0214 = m_d*IT_0186;
    const ccomplex_t IT_0215 = 6*IT_0214;
    const ccomplex_t IT_0216 = IT_0083*(conj(IT_0073)*IT_0142 + IT_0087
      *IT_0172 + conj(IT_0082)*IT_0191 + conj(IT_0138)*IT_0194 + conj(IT_0058)
      *IT_0198 + conj(IT_0133)*IT_0199 + IT_0158*IT_0209 + conj(IT_0083)*IT_0211
       + conj(IT_0141)*IT_0213 + IT_0125*IT_0215);
    const ccomplex_t IT_0217 = (-6)*IT_0131;
    const ccomplex_t IT_0218 = 0.5*IT_0165;
    ...
    const ccomplex_t IT_0223 = IT_0133*IT_0202;
    const ccomplex_t IT_0224 = IT_0141*IT_0215;
    const ccomplex_t IT_0225 = IT_0088*IT_0221;
    const ccomplex_t IT_0226 = IT_0138*IT_0196;
    ...
    const ccomplex_t IT_0233 = IT_0153*IT_0232;
    const ccomplex_t IT_0234 = conj(IT_0133)*IT_0202;
    const ccomplex_t IT_0235 = conj(IT_0141)*IT_0215;
    const ccomplex_t IT_0236 = conj(IT_0082)*IT_0188;
    const ccomplex_t IT_0237 = conj(IT_0083)*IT_0209;
    const ccomplex_t IT_0238 = (-18)*IT_0019;
    const ccomplex_t IT_0239 = conj(IT_0119)*IT_0238;
    const ccomplex_t IT_0240 = IT_0172*IT_0221;
    const ccomplex_t IT_0241 = conj(IT_0138)*IT_0196;
    const ccomplex_t IT_0242 = conj(IT_0058)*IT_0200;
    const ccomplex_t IT_0243 = conj(IT_0124)*IT_0238;
    const ccomplex_t IT_0244 = conj(IT_0073)*IT_0170;
    const ccomplex_t IT_0245 = conj(IT_0144)*IT_0163;
    const ccomplex_t IT_0246 = conj(IT_0033)*IT_0217;
    const ccomplex_t IT_0247 = conj(IT_0058)*IT_0202;
    const ccomplex_t IT_0248 = conj(IT_0083)*IT_0215;
    const ccomplex_t IT_0249 = IT_0131*IT_0172;
    const ccomplex_t IT_0250 = conj(IT_0082)*IT_0196;
    const ccomplex_t IT_0251 = conj(IT_0133)*IT_0200;
    const ccomplex_t IT_0252 = conj(IT_0138)*IT_0188;
    const ccomplex_t IT_0253 = conj(IT_0141)*IT_0209;
    const ccomplex_t IT_0254 = IT_0158*IT_0238;
    const ccomplex_t IT_0255 = conj(IT_0073)*IT_0163;
    const ccomplex_t IT_0256 = conj(IT_0144)*IT_0170;
    const ccomplex_t IT_0257 = conj(IT_0033)*IT_0222;
    const ccomplex_t IT_0258 = 6*IT_0018*(IT_0022*conj(IT_0033) + conj(IT_0058
      ...
      *IT_0088 + IT_0125*IT_0132 + conj(IT_0033)*(IT_0135 + IT_0140 + IT_0143) +
      ...
      (conj(IT_0033)*IT_0075 + IT_0072*conj(IT_0144) + IT_0146 + IT_0158*IT_0163
       + IT_0125*IT_0170 + conj(IT_0073)*IT_0171 + IT_0145*IT_0172 + IT_0173 +
       IT_0174) + IT_0073*(IT_0072*conj(IT_0073) + conj(IT_0018)*IT_0075 + conj
      (IT_0058)*IT_0134 + conj(IT_0082)*IT_0139 + conj(IT_0083)*IT_0142 +
       IT_0125*IT_0163 + IT_0158*IT_0170 + conj(IT_0144)*IT_0171 + conj(IT_0033)
      *IT_0175) + IT_0138*(conj(IT_0138)*IT_0181 + conj(IT_0082)*IT_0183 +
       IT_0125*IT_0188 + conj(IT_0133)*IT_0189 + conj(IT_0141)*IT_0191 + conj
      (IT_0058)*IT_0192 + conj(IT_0083)*IT_0194) + IT_0197 + IT_0133*(conj
      (IT_0133)*IT_0181 + conj(IT_0058)*IT_0183 + conj(IT_0138)*IT_0189 + conj
      (IT_0082)*IT_0192 + conj(IT_0141)*IT_0198 + conj(IT_0083)*IT_0199 +
       IT_0125*IT_0200) + IT_0203 + IT_0141*(conj(IT_0138)*IT_0191 + conj
      (IT_0082)*IT_0194 + conj(IT_0133)*IT_0198 + conj(IT_0058)*IT_0199 +
       IT_0125*IT_0209 + conj(IT_0141)*IT_0211 + conj(IT_0083)*IT_0213) +
       IT_0216 + IT_0033*(conj(IT_0033)*IT_0072 + IT_0075*conj(IT_0144) +
       IT_0146 + IT_0173 + IT_0174 + conj(IT_0073)*IT_0175 + IT_0022*IT_0201 +
       IT_0158*IT_0217 + IT_0125*IT_0222) + IT_0158*(IT_0223 + IT_0224 + IT_0225
       + IT_0226 + IT_0233) + IT_0153*(IT_0234 + IT_0235 + IT_0236 + IT_0237 +
       IT_0239 + IT_0240 + IT_0241 + IT_0242 + IT_0243 + IT_0244 + IT_0245 +
       IT_0246) + IT_0157*(IT_0158*IT_0232 + IT_0234 + IT_0235 + IT_0236 +
