...
ccomplex_return_t c_sumSqAmpl_C_1_sG_to_u_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = m_d*m_u*m_sG*m_C_1;
    const ccomplex_t IT_0001 = pow(m_W, -1);
    const ccomplex_t IT_0002 = cos(beta);
    const ccomplex_t IT_0003 = cpow(IT_0002, -1);
    const ccomplex_t IT_0004 = sin(theta_W);
    const ccomplex_t IT_0005 = cpow(IT_0004, -1);
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
    ...
    const ccomplex_t IT_0033 = cpow((-2)*s_13 + IT_0010 + IT_0020 + -m_sd_R*
    ...
    const ccomplex_t IT_0042 = s_13*s_24;
    const ccomplex_t IT_0043 = s_14*s_23;
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0005;
    ...
    const ccomplex_t IT_0054 = m_d*m_sG*s_13;
    const ccomplex_t IT_0055 = m_u*s_24*m_C_1;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0005;
    ...
    const ccomplex_t IT_0064 = m_u*m_sG*s_14;
    const ccomplex_t IT_0065 = m_d*s_23*m_C_1;
