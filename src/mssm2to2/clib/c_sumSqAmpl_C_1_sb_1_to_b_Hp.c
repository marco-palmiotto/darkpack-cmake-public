...
ccomplex_return_t c_sumSqAmpl_C_1_sb_1_to_b_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0002 
      + -reg_prop, -1);
    const ccomplex_t IT_0004 = (0 + _Complex_I*1)*m_c;
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0005*IT_0007*IT_0008*IT_0010;
    const ccomplex_t IT_0012 = 0.5*IT_0011;
    const ccomplex_t IT_0013 = cpow(IT_0008, -1);
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u1
      *e_em*IT_0005*IT_0010*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0002 + IT_0019 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0006*IT_0010;
    const ccomplex_t IT_0022 = N_u1*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0038 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0039 = IT_0026*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = IT_0007*IT_0010;
    const ccomplex_t IT_0042 = m_b*N_d1*e_em*IT_0005*U_sb_00;
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*(IT_0040 + 1.5*IT_0044);
    const ccomplex_t IT_0046 = (-0.333333333333333)*IT_0045;
    const ccomplex_t IT_0047 = IT_0037*IT_0046;
    const ccomplex_t IT_0048 = IT_0018*IT_0020*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0050 = cpow((-2)*s_23 + IT_0002 + IT_0019 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0051 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0052 = IT_0026*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = m_b*N_d2*e_em*IT_0005*U_sb_00;
    ...
    const ccomplex_t IT_0066 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0073 = IT_0049*IT_0050*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0075 = cpow((-2)*s_23 + IT_0002 + IT_0019 + -m_N_3*
    ...
    const ccomplex_t IT_0092 = m_b*N_d3*e_em*IT_0005*U_sb_00;
    ...
    const ccomplex_t IT_0098 = IT_0074*IT_0075*IT_0097;
    const ccomplex_t IT_0099 = pow(m_u, 2);
    const ccomplex_t IT_0100 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + IT_0099 
      + -reg_prop, -1);
    const ccomplex_t IT_0101 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0102 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*m_b*e_em
      *IT_0005*IT_0007*IT_0008*IT_0010*IT_0102*V_ub_mod;
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0005*IT_0010*IT_0013*IT_0105*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0107 = 0.5*IT_0106;
    const ccomplex_t IT_0108 = IT_0104*IT_0107;
    const ccomplex_t IT_0109 = IT_0100*IT_0101*IT_0108;
    const ccomplex_t IT_0110 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0116 = m_b*conj(N_d2)*e_em*IT_0005*U_sb_10;
    ...
    const ccomplex_t IT_0142 = m_b*N_d4*e_em*IT_0005*U_sb_00;
    const ccomplex_t IT_0143 = IT_0041*IT_0142;
    ...
    const ccomplex_t IT_0148 = cpow((-2)*s_23 + IT_0002 + IT_0019 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0149 = IT_0125*IT_0147*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0151 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + 
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0005*IT_0010*IT_0013*U_sb_00;
    const ccomplex_t IT_0155 = 0.5*IT_0154;
    const ccomplex_t IT_0156 = IT_0153*IT_0155;
    const ccomplex_t IT_0157 = IT_0150*IT_0151*IT_0156;
    const ccomplex_t IT_0158 = V_cb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0159 = IT_0010*IT_0158;
    const ccomplex_t IT_0160 = m_b*conj(U_d1)*V_cb*e_em*IT_0005*U_sb_10;
    ...
    const ccomplex_t IT_0167 = m_C_1*IT_0166;
    const ccomplex_t IT_0168 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0169 = IT_0010*IT_0168;
    const ccomplex_t IT_0170 = m_b*conj(U_d1)*V_tb*e_em*IT_0005*U_sb_10;
    ...
    const ccomplex_t IT_0178 = IT_0010*IT_0105;
    const ccomplex_t IT_0179 = e_em*conj(U_Wm1)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0180 = IT_0178*IT_0179;
    const ccomplex_t IT_0181 = IT_0007*IT_0010*IT_0105;
    const ccomplex_t IT_0182 = m_b*conj(U_d1)*e_em*IT_0005*U_sb_10*V_ub_mod;
    ...
    const ccomplex_t IT_0186 = IT_0104*IT_0185;
    const ccomplex_t IT_0187 = IT_0100*IT_0186;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*IT_0187;
    const ccomplex_t IT_0189 = m_C_1*IT_0188;
    const ccomplex_t IT_0190 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0196 = m_b*conj(N_d1)*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0197 = IT_0041*IT_0196;
    ...
    const ccomplex_t IT_0231 = IT_0138*IT_0230;
    const ccomplex_t IT_0232 = IT_0148*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = m_b*IT_0233;
    const ccomplex_t IT_0235 = -IT_0017 + -IT_0048 + -IT_0073 + -IT_0098 + 
      -IT_0109 + IT_0124 + -IT_0149 + -IT_0157 + IT_0167 + IT_0177 + IT_0189 +
       IT_0204 + IT_0219 + IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0005*IT_0006*IT_0010*IT_0013*IT_0102*V_ub_mod;
    const ccomplex_t IT_0237 = 0.5*IT_0236;
    const ccomplex_t IT_0238 = IT_0185*IT_0237;
    const ccomplex_t IT_0239 = IT_0100*IT_0101*IT_0238;
    const ccomplex_t IT_0240 = IT_0107*IT_0237;
    const ccomplex_t IT_0241 = IT_0100*IT_0240;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = m_C_1*IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0005*IT_0006*IT_0010*IT_0013;
    const ccomplex_t IT_0245 = 0.5*IT_0244;
    const ccomplex_t IT_0246 = IT_0163*IT_0245;
    const ccomplex_t IT_0247 = IT_0003*IT_0004*IT_0246;
    const ccomplex_t IT_0248 = IT_0008*IT_0026;
    const ccomplex_t IT_0249 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0250 = IT_0248*IT_0249;
    const ccomplex_t IT_0251 = 1.4142135623731*IT_0250;
    const ccomplex_t IT_0252 = IT_0008*IT_0010;
    const ccomplex_t IT_0253 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0257 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0263 = IT_0200*IT_0262;
    const ccomplex_t IT_0264 = IT_0018*IT_0020*IT_0263;
    const ccomplex_t IT_0265 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0266 = IT_0252*IT_0265;
    const ccomplex_t IT_0267 = (-2)*IT_0266;
    const ccomplex_t IT_0268 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0269 = IT_0248*IT_0268;
    const ccomplex_t IT_0270 = 1.4142135623731*IT_0269;
    const ccomplex_t IT_0271 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0278 = IT_0230*IT_0277;
    const ccomplex_t IT_0279 = IT_0125*IT_0148*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0005*IT_0006*IT_0010*IT_0013;
    const ccomplex_t IT_0281 = 0.5*IT_0280;
    const ccomplex_t IT_0282 = IT_0173*IT_0281;
    const ccomplex_t IT_0283 = IT_0150*IT_0151*IT_0282;
    const ccomplex_t IT_0284 = IT_0046*IT_0262;
    ...
    const ccomplex_t IT_0292 = IT_0248*IT_0291;
    ...
    const ccomplex_t IT_0296 = IT_0252*IT_0295;
    ...
    const ccomplex_t IT_0318 = IT_0120*IT_0317;
    const ccomplex_t IT_0319 = IT_0049*IT_0050*IT_0318;
    const ccomplex_t IT_0320 = IT_0215*IT_0300;
    const ccomplex_t IT_0321 = IT_0074*IT_0075*IT_0320;
    const ccomplex_t IT_0322 = IT_0058*IT_0317;
    ...
    const ccomplex_t IT_0326 = IT_0146*IT_0277;
    const ccomplex_t IT_0327 = IT_0148*IT_0326;
    const ccomplex_t IT_0328 = (0 + _Complex_I*1)*IT_0327;
    const ccomplex_t IT_0329 = m_b*IT_0328;
    const ccomplex_t IT_0330 = IT_0015*IT_0245;
    const ccomplex_t IT_0331 = IT_0003*IT_0330;
    const ccomplex_t IT_0332 = (0 + _Complex_I*1)*IT_0331;
    const ccomplex_t IT_0333 = m_C_1*IT_0332;
    const ccomplex_t IT_0334 = IT_0155*IT_0281;
    const ccomplex_t IT_0335 = IT_0151*IT_0334;
    const ccomplex_t IT_0336 = (0 + _Complex_I*1)*IT_0335;
    const ccomplex_t IT_0337 = m_C_1*IT_0336;
    const ccomplex_t IT_0338 = IT_0239 + -IT_0243 + IT_0247 + -IT_0264 + 
      -IT_0279 + IT_0283 + IT_0287 + IT_0304 + -IT_0319 + -IT_0321 + IT_0325 +
    ...
    const ccomplex_t IT_0342 = -IT_0123 + -IT_0203 + -IT_0218 + -IT_0233 + 
      -IT_0242 + -IT_0332 + -IT_0336;
    const ccomplex_t IT_0343 = m_b*s_12;
    const ccomplex_t IT_0344 = IT_0166 + IT_0176 + IT_0188 + -IT_0286 + 
      -IT_0303 + -IT_0324 + -IT_0328;
    const ccomplex_t IT_0345 = s_23*m_C_1;
    const ccomplex_t IT_0346 = 6*conj(IT_0235);
    const ccomplex_t IT_0347 = 6*conj(IT_0338);
    const ccomplex_t IT_0348 = m_b*m_C_1*IT_0002;
    const ccomplex_t IT_0349 = s_13*IT_0002;
