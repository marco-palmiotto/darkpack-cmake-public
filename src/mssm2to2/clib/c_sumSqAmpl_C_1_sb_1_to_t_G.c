...
ccomplex_return_t c_sumSqAmpl_C_1_sb_1_to_t_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = pow(m_sb_1, 2);
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0009 + IT_0015 + -m_sb_1*
    ...
    const ccomplex_t IT_0021 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    ...
    const ccomplex_t IT_0026 = m_b*conj(U_d1)*V_tb*e_em*IT_0001*U_sb_10;
