        ...
        )
{
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u1
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0018 = 0.5*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_12 + -IT_0001 + -IT_0024 + 
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0005
      *IT_0007*IT_0028;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = IT_0027*IT_0030;
    const ccomplex_t IT_0032 = IT_0025*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = m_t*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0036 = cpow(V_tb, 2);
    const ccomplex_t IT_0037 = m_b*mu_h*IT_0003;
    const ccomplex_t IT_0038 = cos(beta);
    const ccomplex_t IT_0039 = cpow(IT_0038, -1);
    const ccomplex_t IT_0040 = -IT_0004*IT_0028;
    const ccomplex_t IT_0041 = IT_0010*IT_0038;
    const ccomplex_t IT_0042 = IT_0040 + IT_0041;
    const ccomplex_t IT_0043 = cos(theta_W);
    const ccomplex_t IT_0044 = cpow(IT_0043, -2);
    const ccomplex_t IT_0045 = pow(m_b, 2);
    const ccomplex_t IT_0046 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0042*(IT_0007 + 1.
      /3*IT_0006*IT_0044) + IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)*conj
      (U_sb_00) + -1./2*IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_10)) + U_sb_10
      *(IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0006*IT_0042*IT_0044 + (-3)*IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)
      *conj(U_sb_10));
    const ccomplex_t IT_0047 = (0 + _Complex_I*-1)*(e_em*IT_0046 + (
      -1.4142135623731)*A_b*IT_0010*IT_0036*(conj(U_sb_00)*U_sb_10 + U_sb_00
      *conj(U_sb_10)));
    const ccomplex_t IT_0048 = (-0.5)*IT_0047;
    const ccomplex_t IT_0049 = IT_0027*IT_0048;
    const ccomplex_t IT_0050 = IT_0035*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_01;
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0042*(IT_0007 + 1.
      /3*IT_0006*IT_0044) + IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)*conj
      (U_sb_01) + -1./2*IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_11)) + U_sb_10
      *(IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0006*IT_0042*IT_0044 + (-3)*IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)
      *conj(U_sb_11));
    const ccomplex_t IT_0056 = (0 + _Complex_I*-1)*(e_em*IT_0055 + (
      -1.4142135623731)*A_b*IT_0010*IT_0036*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0063 = U_d1*V_Wp1;
    const ccomplex_t IT_0064 = IT_0010*IT_0063;
    const ccomplex_t IT_0065 = V_u1*U_Wm1;
    ...
    const ccomplex_t IT_0072 = IT_0061*IT_0062*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_C_2*
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_00;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = IT_0082*IT_0084;
    const ccomplex_t IT_0086 = IT_0073*IT_0074*IT_0085;
    ...
    const ccomplex_t IT_0108 = IT_0074*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*IT_0108;
    const ccomplex_t IT_0110 = m_C_1*IT_0109;
    const ccomplex_t IT_0111 = IT_0015 + IT_0023 + (-2)*IT_0034 + IT_0051 +
       IT_0060 + -IT_0072 + -IT_0086 + -IT_0098 + -IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0007;
    ...
    const ccomplex_t IT_0118 = IT_0007*IT_0039;
    const ccomplex_t IT_0119 = m_b*conj(U_d2)*V_tb*e_em*IT_0003*U_sb_10;
    ...
    const ccomplex_t IT_0124 = IT_0073*IT_0074*IT_0123;
    const ccomplex_t IT_0125 = IT_0082*IT_0122;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_ts*e_em*IT_0003*IT_0007*IT_0039;
    const ccomplex_t IT_0131 = (-0.5)*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
    ...
    const ccomplex_t IT_0137 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0138 = IT_0007*IT_0137;
    const ccomplex_t IT_0139 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_10;
    ...
    const ccomplex_t IT_0143 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0042*(IT_0007 + 1.
      /3*IT_0006*IT_0044) + IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)*conj
      (U_sb_00) + -1./2*IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_10)) + U_sb_10
      *(IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0006*IT_0042*IT_0044 + (-3)*IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)
    ...
    const ccomplex_t IT_0147 = IT_0035*IT_0146;
    ...
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_td*e_em*IT_0003*IT_0007*IT_0039;
    ...
    const ccomplex_t IT_0167 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0042*(IT_0007 + 1.
      /3*IT_0006*IT_0044) + IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)*conj
      (U_sb_01) + -1./2*IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_11)) + U_sb_10
      *(IT_0007*IT_0028*IT_0037*IT_0039*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0006*IT_0042*IT_0044 + (-3)*IT_0003*IT_0007*IT_0010*IT_0039*IT_0045)
    ...
    const ccomplex_t IT_0173 = IT_0094*IT_0142;
    const ccomplex_t IT_0174 = IT_0061*IT_0062*IT_0173;
    const ccomplex_t IT_0175 = IT_0030*IT_0142;
    ...
    const ccomplex_t IT_0179 = IT_0070*IT_0142;
    const ccomplex_t IT_0180 = IT_0062*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1)*IT_0180;
    const ccomplex_t IT_0182 = m_C_1*IT_0181;
    const ccomplex_t IT_0183 = -IT_0115 + IT_0124 + IT_0128 + -IT_0136 + 
      -IT_0148 + -IT_0156 + -IT_0160 + -IT_0172 + IT_0174 + 2*IT_0178 + IT_0182;
    const ccomplex_t IT_0184 = 6*s_13;
    const ccomplex_t IT_0185 = m_t*m_C_1;
    const ccomplex_t IT_0186 = 6*IT_0111;
    const ccomplex_t IT_0187 = -IT_0033 + -IT_0127 + -IT_0181;
    const ccomplex_t IT_0188 = m_t*s_14;
    const ccomplex_t IT_0189 = IT_0097 + IT_0109 + IT_0177;
