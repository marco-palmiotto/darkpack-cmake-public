...
ccomplex_return_t c_sumSqAmpl_C_1_sb_1_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u1
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_01;
    const ccomplex_t IT_0018 = 0.5*IT_0017;
    const ccomplex_t IT_0019 = cpow(V_tb, 2);
    const ccomplex_t IT_0020 = m_b*mu_h*IT_0003;
    ...
    const ccomplex_t IT_0025 = IT_0010*IT_0021;
    ...
    const ccomplex_t IT_0030 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
      /3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_01) + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_10
      *(IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0006*IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)
      *conj(U_sb_11));
    const ccomplex_t IT_0031 = (0 + _Complex_I*-1)*(e_em*IT_0030 + (
      -1.4142135623731)*A_b*IT_0010*IT_0019*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_00;
    const ccomplex_t IT_0038 = 0.5*IT_0037;
    const ccomplex_t IT_0039 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
      /3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_00) + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_10)) + U_sb_10
      *(IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0006*IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)
      *conj(U_sb_10));
    const ccomplex_t IT_0040 = (0 + _Complex_I*-1)*(e_em*IT_0039 + (
      -1.4142135623731)*A_b*IT_0010*IT_0019*(conj(U_sb_00)*U_sb_10 + U_sb_00
      *conj(U_sb_10)));
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0000 + IT_0046 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0048 = U_d2*V_Wp1;
    const ccomplex_t IT_0049 = IT_0010*IT_0048;
    const ccomplex_t IT_0050 = V_u1*U_Wm2;
    const ccomplex_t IT_0051 = IT_0023*IT_0050;
    const ccomplex_t IT_0052 = IT_0007*(IT_0049 + IT_0051);
    const ccomplex_t IT_0053 = 1.4142135623731*e_em*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_00;
    const ccomplex_t IT_0057 = 0.5*IT_0056;
    const ccomplex_t IT_0058 = IT_0055*IT_0057;
    const ccomplex_t IT_0059 = IT_0045*IT_0047*IT_0058;
    const ccomplex_t IT_0060 = cpow((-2)*s_12 + -IT_0001 + -IT_0046 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0005
      *IT_0007*IT_0023;
    const ccomplex_t IT_0062 = (-0.5)*IT_0061;
    const ccomplex_t IT_0063 = IT_0038*IT_0062;
    const ccomplex_t IT_0064 = IT_0060*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = m_t*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0000 + IT_0046 + -m_C_1*
    ...
    const ccomplex_t IT_0072 = IT_0007*(IT_0069 + IT_0071);
    ...
    const ccomplex_t IT_0079 = m_C_1*IT_0078;
    const ccomplex_t IT_0080 = conj(U_d1)*conj(V_Wp2);
    const ccomplex_t IT_0081 = IT_0010*IT_0080;
    const ccomplex_t IT_0082 = conj(V_u2)*conj(U_Wm1);
    const ccomplex_t IT_0083 = IT_0023*IT_0082;
    const ccomplex_t IT_0084 = IT_0007*(IT_0081 + IT_0083);
    ...
    const ccomplex_t IT_0092 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0093 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u1
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0094 = 0.5*IT_0093;
    const ccomplex_t IT_0095 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_td)*IT_0010*U_sb_10;
    ...
    const ccomplex_t IT_0101 = U_d1*V_Wp1;
    const ccomplex_t IT_0102 = IT_0010*IT_0101;
    const ccomplex_t IT_0103 = V_u1*U_Wm1;
    const ccomplex_t IT_0104 = IT_0023*IT_0103;
    const ccomplex_t IT_0105 = IT_0007*(IT_0102 + IT_0104);
    const ccomplex_t IT_0106 = 1.4142135623731*e_em*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = 0.5*IT_0107;
    const ccomplex_t IT_0109 = IT_0038*IT_0108;
    const ccomplex_t IT_0110 = IT_0067*IT_0100*IT_0109;
    const ccomplex_t IT_0111 = IT_0015 + IT_0035 + IT_0044 + -IT_0059 + (-2)
      *IT_0066 + -IT_0079 + -IT_0091 + IT_0099 + -IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm1)*IT_0007;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_ts*e_em*IT_0003*IT_0007*IT_0022;
    const ccomplex_t IT_0117 = (-0.5)*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_ts)*IT_0010*U_sb_00;
    const ccomplex_t IT_0119 = (-0.5)*IT_0118;
    const ccomplex_t IT_0120 = IT_0117*IT_0119;
    const ccomplex_t IT_0121 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0122 = IT_0120*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*IT_0122;
    const ccomplex_t IT_0124 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0125 = IT_0007*IT_0124;
    const ccomplex_t IT_0126 = IT_0007*IT_0022;
    const ccomplex_t IT_0127 = m_b*conj(U_d2)*V_tb*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0128 = IT_0126*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = (0 + _Complex_I*1)*(IT_0125 + (-0.5)*IT_0129);
    ...
    const ccomplex_t IT_0135 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0136 = IT_0007*IT_0135;
    const ccomplex_t IT_0137 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_10;
    ...
    const ccomplex_t IT_0141 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
      /3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_00) + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_10)) + U_sb_10
      *(IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0006*IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)
    ...
    const ccomplex_t IT_0147 = IT_0087*IT_0130;
    const ccomplex_t IT_0148 = IT_0045*IT_0047*IT_0147;
    const ccomplex_t IT_0149 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_td*e_em*IT_0003*IT_0007*IT_0022;
    const ccomplex_t IT_0151 = (-0.5)*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_td)*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0007;
    ...
    const ccomplex_t IT_0161 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    const ccomplex_t IT_0162 = IT_0007*IT_0161;
    const ccomplex_t IT_0163 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0167 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
      /3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_01) + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_10
      *(IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0006*IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)
    ...
    const ccomplex_t IT_0173 = IT_0062*IT_0140;
    const ccomplex_t IT_0174 = IT_0060*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*IT_0174;
    const ccomplex_t IT_0176 = m_t*IT_0175;
    const ccomplex_t IT_0177 = IT_0108*IT_0140;
    ...
    const ccomplex_t IT_0181 = IT_0075*IT_0140;
    const ccomplex_t IT_0182 = IT_0067*IT_0100*IT_0181;
    const ccomplex_t IT_0183 = -IT_0115 + -IT_0123 + IT_0134 + -IT_0146 +
       IT_0148 + -IT_0156 + -IT_0160 + -IT_0172 + 2*IT_0176 + IT_0180 + IT_0182;
    const ccomplex_t IT_0184 = 6*s_13;
    const ccomplex_t IT_0185 = m_t*m_C_1;
    const ccomplex_t IT_0186 = 6*IT_0111;
    const ccomplex_t IT_0187 = -IT_0065 + -IT_0133 + -IT_0179;
    const ccomplex_t IT_0188 = m_t*s_14;
    const ccomplex_t IT_0189 = IT_0078 + IT_0090 + IT_0175;
    const ccomplex_t IT_0190 = s_34*m_C_1;
    const ccomplex_t IT_0191 = 6*conj(IT_0111);
    const ccomplex_t IT_0192 = 6*conj(IT_0183);
    const ccomplex_t IT_0193 = pow(m_H0, 2);
