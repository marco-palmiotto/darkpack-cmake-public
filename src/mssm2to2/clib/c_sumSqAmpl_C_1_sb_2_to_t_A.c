...
ccomplex_return_t c_sumSqAmpl_C_1_sb_2_to_t_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0005*IT_0007*IT_0009*U_sb_01;
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_12 + -IT_0002 + -IT_0016 + 
    ...
    const ccomplex_t IT_0023 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    ...
    const ccomplex_t IT_0028 = m_b*conj(U_d1)*V_tb*e_em*IT_0005*U_sb_11;
    ...
    const ccomplex_t IT_0038 = IT_0000*(IT_0022*((-24)*conj(IT_0015) + 24*conj
      (IT_0022)) + IT_0015*(24*conj(IT_0015) + (-24)*conj(IT_0022)) + IT_0037*((
      -24)*conj(IT_0034) + 24*conj(IT_0037)) + IT_0034*(24*conj(IT_0034) + (-24)
      *conj(IT_0037)));
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0001 + IT_0016 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0011*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = IT_0018*IT_0041;
    const ccomplex_t IT_0043 = 2*IT_0014 + IT_0042;
    const ccomplex_t IT_0044 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0059 = (-2)*IT_0021 + -IT_0042;
    const ccomplex_t IT_0060 = s_14*IT_0001;
    ...
    const ccomplex_t IT_0082 = conj(IT_0015) + conj(IT_0022);
    const ccomplex_t IT_0083 = IT_0015 + IT_0022;
    ...
    const ccomplex_t IT_0089 = IT_0038 + IT_0043*(conj(IT_0022)*IT_0048 + conj
      (IT_0051)*IT_0053) + IT_0057*(conj(IT_0034)*IT_0048 + IT_0053*conj(IT_0058
      )) + 6*IT_0059*(conj(IT_0015)*IT_0063 + 0.166666666666667*conj(IT_0051)
      *IT_0064) + 6*(conj(IT_0037)*IT_0063 + 0.166666666666667*conj(IT_0058)
      *IT_0064)*IT_0065 + 6*conj(IT_0059)*(IT_0015*IT_0063 + 0.166666666666667
      ...
      *IT_0066 + 0.166666666666667*IT_0057*IT_0068) + conj(IT_0043)*(IT_0022
      ...
      *IT_0069) + IT_0070*IT_0074 + IT_0044*(conj(IT_0015)*IT_0075 + IT_0015
      ...
      *IT_0080 + IT_0076*IT_0081 + IT_0077*IT_0082 + IT_0078*IT_0083) + IT_0060*
      (conj(IT_0022)*IT_0084 + IT_0022*IT_0085 + conj(IT_0034)*IT_0086 + IT_0034
