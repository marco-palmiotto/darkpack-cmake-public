...
ccomplex_return_t c_sumSqAmpl_C_1_sb_2_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
      /3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_01) + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_11
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*-1)*(e_em*IT_0030 + (
      -1.4142135623731)*A_b*IT_0010*IT_0019*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_00;
    const ccomplex_t IT_0046 = 0.5*IT_0045;
    const ccomplex_t IT_0047 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0026*
      (IT_0007 + 1./3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029
      )*U_sb_01 + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*U_sb_11) + conj(U_sb_10)
      *(IT_0007*IT_0020*IT_0022*IT_0023*U_sb_01 + 0.666666666666667*(m_W*IT_0006
      *IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*U_sb_11);
    const ccomplex_t IT_0048 = (0 + _Complex_I*-1)*(e_em*IT_0047 + (
      -1.4142135623731)*A_b*IT_0010*IT_0019*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    ...
    const ccomplex_t IT_0054 = pow(m_sb_2, 2);
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0000 + IT_0054 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0056 = U_d1*V_Wp1;
    const ccomplex_t IT_0057 = IT_0010*IT_0056;
    const ccomplex_t IT_0058 = V_u1*U_Wm1;
    ...
    const ccomplex_t IT_0065 = IT_0053*IT_0055*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0000 + IT_0054 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0068 = U_d2*V_Wp1;
    const ccomplex_t IT_0069 = IT_0010*IT_0068;
    const ccomplex_t IT_0070 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_01;
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = IT_0075*IT_0077;
    const ccomplex_t IT_0079 = IT_0066*IT_0067*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_12 + -IT_0001 + -IT_0054 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0005
      *IT_0007*IT_0023;
    ...
    const ccomplex_t IT_0087 = conj(U_d1)*conj(V_Wp1);
    const ccomplex_t IT_0088 = IT_0010*IT_0087;
    const ccomplex_t IT_0089 = conj(V_u1)*conj(U_Wm1);
    ...
    const ccomplex_t IT_0111 = IT_0015 + IT_0035 + IT_0043 + IT_0052 + 
      -IT_0065 + -IT_0079 + (-2)*IT_0086 + -IT_0098 + -IT_0110;
    ...
    const ccomplex_t IT_0117 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0118 = IT_0116*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*IT_0118;
    const ccomplex_t IT_0120 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0121 = IT_0007*IT_0120;
    const ccomplex_t IT_0122 = IT_0007*IT_0022;
    const ccomplex_t IT_0123 = m_b*conj(U_d2)*V_tb*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0128 = IT_0066*IT_0067*IT_0127;
    const ccomplex_t IT_0129 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    ...
    const ccomplex_t IT_0135 = IT_0082*IT_0134;
    const ccomplex_t IT_0136 = IT_0080*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*IT_0136;
    const ccomplex_t IT_0138 = m_t*IT_0137;
    const ccomplex_t IT_0139 = IT_0063*IT_0134;
    const ccomplex_t IT_0140 = IT_0055*IT_0139;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*IT_0140;
    const ccomplex_t IT_0142 = m_C_1*IT_0141;
    const ccomplex_t IT_0143 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
      /3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_01) + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_11
      *(IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0006*IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)
    ...
    const ccomplex_t IT_0149 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
    ...
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm1)*IT_0007;
    ...
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0007;
    ...
    const ccomplex_t IT_0165 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0166 = IT_0007*IT_0165;
    const ccomplex_t IT_0167 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_10;
    ...
    const ccomplex_t IT_0171 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0026*
      (IT_0007 + 1./3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029
      )*U_sb_01 + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*U_sb_11) + conj(U_sb_10)
      *(IT_0007*IT_0020*IT_0022*IT_0023*U_sb_01 + 0.666666666666667*(m_W*IT_0006
      *IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*U_sb_11);
    ...
    const ccomplex_t IT_0177 = IT_0094*IT_0134;
    const ccomplex_t IT_0178 = IT_0053*IT_0055*IT_0177;
    const ccomplex_t IT_0179 = IT_0075*IT_0126;
    ...
    const ccomplex_t IT_0183 = -IT_0119 + IT_0128 + 2*IT_0138 + IT_0142 + 
      -IT_0148 + -IT_0156 + -IT_0160 + -IT_0164 + -IT_0176 + IT_0178 + IT_0182;
    const ccomplex_t IT_0184 = 6*s_13;
    const ccomplex_t IT_0185 = m_t*m_C_1;
    const ccomplex_t IT_0186 = 6*IT_0111;
    const ccomplex_t IT_0187 = -IT_0085 + -IT_0141 + -IT_0181;
    const ccomplex_t IT_0188 = m_t*s_14;
    const ccomplex_t IT_0189 = IT_0097 + IT_0109 + IT_0137;
