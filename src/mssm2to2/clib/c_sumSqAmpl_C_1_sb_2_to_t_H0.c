        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0026*
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0000 + IT_0037 + -m_C_1*
    ...
    const ccomplex_t IT_0043 = IT_0007*(IT_0040 + IT_0042);
    ...
    const ccomplex_t IT_0050 = IT_0036*IT_0038*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0000 + IT_0037 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0053 = U_d2*V_Wp1;
    const ccomplex_t IT_0054 = IT_0010*IT_0053;
    const ccomplex_t IT_0055 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0084 = conj(U_d1)*conj(V_Wp2);
    const ccomplex_t IT_0085 = IT_0010*IT_0084;
    const ccomplex_t IT_0086 = conj(V_u2)*conj(U_Wm1);
    ...
    const ccomplex_t IT_0097 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
    ...
    const ccomplex_t IT_0103 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u1
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0111 = IT_0015 + IT_0035 + -IT_0050 + -IT_0064 + (-2)
      *IT_0071 + -IT_0083 + -IT_0095 + IT_0102 + IT_0110;
    ...
    const ccomplex_t IT_0135 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0026*
      (IT_0007 + 1./3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029
      )*U_sb_01 + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*U_sb_11) + conj(U_sb_10)
      *(IT_0007*IT_0020*IT_0022*IT_0023*U_sb_01 + 0.666666666666667*(m_W*IT_0006
      *IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*U_sb_11);
    ...
    const ccomplex_t IT_0141 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    const ccomplex_t IT_0142 = IT_0007*IT_0141;
    const ccomplex_t IT_0143 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0151 = IT_0046*IT_0146;
    ...
    const ccomplex_t IT_0155 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0026*(IT_0007 + 1.
      /3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_01) + -1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_11
      *(IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0006*IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)
      *conj(U_sb_11));
    const ccomplex_t IT_0156 = (0 + _Complex_I*-1)*(e_em*IT_0155 + (
      -1.4142135623731)*A_b*IT_0010*IT_0019*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    const ccomplex_t IT_0157 = (-0.5)*IT_0156;
    const ccomplex_t IT_0158 = IT_0146*IT_0157;
    const ccomplex_t IT_0159 = IT_0096*IT_0158;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0162 = IT_0107*IT_0161;
    const ccomplex_t IT_0163 = IT_0103*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0007;
    ...
    const ccomplex_t IT_0169 = IT_0079*IT_0146;
    const ccomplex_t IT_0170 = IT_0036*IT_0038*IT_0169;
    const ccomplex_t IT_0171 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0172 = IT_0007*IT_0171;
    const ccomplex_t IT_0173 = m_b*conj(U_d2)*V_tb*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0179 = IT_0060*IT_0176;
    const ccomplex_t IT_0180 = IT_0052*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1)*IT_0180;
    const ccomplex_t IT_0182 = m_C_1*IT_0181;
    const ccomplex_t IT_0183 = -IT_0119 + -IT_0127 + -IT_0140 + 2*IT_0150 +
       IT_0154 + -IT_0160 + -IT_0164 + -IT_0168 + IT_0170 + IT_0178 + IT_0182;
    const ccomplex_t IT_0184 = 6*s_13;
    const ccomplex_t IT_0185 = m_t*m_C_1;
    const ccomplex_t IT_0186 = 6*IT_0111;
    const ccomplex_t IT_0187 = -IT_0070 + -IT_0153 + -IT_0181;
    const ccomplex_t IT_0188 = m_t*s_14;
    const ccomplex_t IT_0189 = IT_0082 + IT_0094 + IT_0149;
