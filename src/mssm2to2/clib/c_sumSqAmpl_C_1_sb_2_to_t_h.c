        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u1
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_1*
    ...
    const ccomplex_t IT_0024 = IT_0010*IT_0021;
    ...
    const ccomplex_t IT_0030 = 2*conj(U_sb_00)*(((-0.5)*m_W*IT_0026*(IT_0007 +
       1./3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*U_sb_01 
      + 1./2*IT_0007*IT_0020*IT_0022*IT_0023*U_sb_11) + conj(U_sb_10)*(IT_0007
      *IT_0020*IT_0022*IT_0023*U_sb_01 + (-0.666666666666667)*(m_W*IT_0006
      *IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*U_sb_11);
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*(e_em*IT_0030 +
       1.4142135623731*A_b*IT_0010*IT_0019*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = IT_0018*IT_0032;
    const ccomplex_t IT_0034 = IT_0016*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*IT_0034;
    const ccomplex_t IT_0036 = pow(m_sb_2, 2);
    const ccomplex_t IT_0037 = cpow((-2)*s_23 + IT_0000 + IT_0036 + -m_C_2*
    ...
    const ccomplex_t IT_0042 = IT_0007*(IT_0039 + -IT_0041);
    ...
    const ccomplex_t IT_0051 = m_C_1*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u1
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_ts)*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0000 + IT_0036 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0062 = V_u1*U_Wm1;
    const ccomplex_t IT_0063 = IT_0023*IT_0062;
    const ccomplex_t IT_0064 = U_d1*V_Wp1;
    const ccomplex_t IT_0065 = IT_0010*IT_0064;
    const ccomplex_t IT_0066 = IT_0007*(IT_0063 + -IT_0065);
    ...
    const ccomplex_t IT_0073 = IT_0060*IT_0061*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0075 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0084 = IT_0037*IT_0074*IT_0083;
    const ccomplex_t IT_0085 = cpow((-2)*s_12 + -IT_0001 + -IT_0036 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0005
      *IT_0007*IT_0023;
    ...
    const ccomplex_t IT_0091 = m_t*IT_0090;
    const ccomplex_t IT_0092 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0093 = 2*U_sb_01*(((-0.5)*m_W*IT_0026*(IT_0007 + 1./3
      *IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj(U_sb_01)
       + 1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_11*(IT_0007
      *IT_0020*IT_0022*IT_0023*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0006
      *IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
      (U_sb_11));
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*(e_em*IT_0093 +
       1.4142135623731*A_b*IT_0010*IT_0019*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0099 = conj(V_u1)*conj(U_Wm1);
    const ccomplex_t IT_0100 = IT_0023*IT_0099;
    const ccomplex_t IT_0101 = conj(U_d1)*conj(V_Wp1);
    const ccomplex_t IT_0102 = IT_0010*IT_0101;
    const ccomplex_t IT_0103 = IT_0007*(IT_0100 + -IT_0102);
    ...
    const ccomplex_t IT_0111 = IT_0015 + IT_0035 + -IT_0051 + IT_0059 + 
      -IT_0073 + -IT_0084 + (-2)*IT_0091 + IT_0098 + -IT_0110;
    ...
    const ccomplex_t IT_0120 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
    ...
    const ccomplex_t IT_0128 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    const ccomplex_t IT_0129 = IT_0007*IT_0128;
    const ccomplex_t IT_0130 = IT_0007*IT_0022;
    const ccomplex_t IT_0131 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0136 = IT_0060*IT_0061*IT_0135;
    const ccomplex_t IT_0137 = IT_0069*IT_0134;
    const ccomplex_t IT_0138 = IT_0061*IT_0137;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*IT_0138;
    const ccomplex_t IT_0140 = m_C_1*IT_0139;
    const ccomplex_t IT_0141 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0142 = IT_0007*IT_0141;
    const ccomplex_t IT_0143 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_10;
    ...
    const ccomplex_t IT_0147 = 2*conj(U_sb_00)*(((-0.5)*m_W*IT_0026*(IT_0007 +
       1./3*IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*U_sb_01 
      + 1./2*IT_0007*IT_0020*IT_0022*IT_0023*U_sb_11) + conj(U_sb_10)*(IT_0007
      *IT_0020*IT_0022*IT_0023*U_sb_01 + (-0.666666666666667)*(m_W*IT_0006
      *IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*U_sb_11);
    ...
    const ccomplex_t IT_0153 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0154 = IT_0007*IT_0153;
    const ccomplex_t IT_0155 = m_b*conj(U_d2)*V_tb*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0160 = IT_0037*IT_0074*IT_0159;
    const ccomplex_t IT_0161 = 2*U_sb_01*(((-0.5)*m_W*IT_0026*(IT_0007 + 1./3
      *IT_0006*IT_0028) + IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj(U_sb_01)
       + 1./2*IT_0007*IT_0020*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_11*(IT_0007
      *IT_0020*IT_0022*IT_0023*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0006
      *IT_0026*IT_0028 + (-3)*IT_0003*IT_0007*IT_0010*IT_0022*IT_0029)*conj
    ...
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0007;
    ...
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0172 = IT_0056*IT_0171;
    const ccomplex_t IT_0173 = IT_0052*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*IT_0173;
    const ccomplex_t IT_0175 = IT_0087*IT_0134;
    ...
    const ccomplex_t IT_0179 = IT_0082*IT_0158;
    ...
    const ccomplex_t IT_0183 = -IT_0119 + -IT_0127 + IT_0136 + IT_0140 + 
      -IT_0152 + IT_0160 + -IT_0166 + -IT_0170 + -IT_0174 + 2*IT_0178 + IT_0182;
    const ccomplex_t IT_0184 = 6*s_13;
    const ccomplex_t IT_0185 = m_t*m_C_1;
    const ccomplex_t IT_0186 = 6*IT_0111;
    const ccomplex_t IT_0187 = -IT_0090 + -IT_0139 + -IT_0181;
    const ccomplex_t IT_0188 = m_t*s_14;
    const ccomplex_t IT_0189 = IT_0050 + IT_0109 + IT_0177;
