...
ccomplex_return_t c_sumSqAmpl_C_1_sd_L_to_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*IT_0005*IT_0007*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_td)
      *e_em*IT_0005*IT_0007*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0005*IT_0007*IT_0009*IT_0010;
    const ccomplex_t IT_0027 = 0.5*IT_0026;
    const ccomplex_t IT_0028 = IT_0025*IT_0027;
    const ccomplex_t IT_0029 = IT_0024*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*IT_0029;
    const ccomplex_t IT_0031 = pow(m_d, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0002 + IT_0031 + -m_N_1*
    ...
    const ccomplex_t IT_0038 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = IT_0005*IT_0010;
    const ccomplex_t IT_0042 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0046 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0005*IT_0007*IT_0009;
    const ccomplex_t IT_0056 = (-0.5)*IT_0055;
    const ccomplex_t IT_0057 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0058 = IT_0041*IT_0057;
    const ccomplex_t IT_0059 = (-2)*IT_0058;
    const ccomplex_t IT_0060 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0061 = IT_0037*IT_0060;
    const ccomplex_t IT_0062 = 1.4142135623731*IT_0061;
    const ccomplex_t IT_0063 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0002 + IT_0031 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0005*IT_0007*IT_0009;
    const ccomplex_t IT_0075 = (-0.5)*IT_0074;
    const ccomplex_t IT_0076 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0077 = IT_0041*IT_0076;
    const ccomplex_t IT_0078 = 1.4142135623731*IT_0077;
    const ccomplex_t IT_0079 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0083 = conj(N_d3)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_23 + IT_0002 + IT_0031 + -m_N_3*
    ...
    const ccomplex_t IT_0109 = cpow((-2)*s_23 + IT_0002 + IT_0031 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0110 = IT_0108*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*IT_0110;
    const ccomplex_t IT_0112 = IT_0015 + IT_0022 + IT_0030 + -IT_0054 + 
      -IT_0073 + -IT_0092 + -IT_0111;
    const ccomplex_t IT_0113 = m_d*m_C_1*IT_0002;
    ...
    const ccomplex_t IT_0122 = IT_0005*IT_0008;
    const ccomplex_t IT_0123 = N_u3*e_em*V_Wp1;
    const ccomplex_t IT_0124 = IT_0122*IT_0123;
    const ccomplex_t IT_0125 = 2*IT_0124;
    const ccomplex_t IT_0126 = IT_0008*IT_0036;
    const ccomplex_t IT_0127 = N_B3*V_u1*e_em;
    const ccomplex_t IT_0128 = IT_0126*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = N_W3*V_u1*e_em;
    ...
    const ccomplex_t IT_0137 = IT_0121*IT_0136;
    const ccomplex_t IT_0138 = IT_0090*IT_0137;
    ...
    const ccomplex_t IT_0152 = IT_0126*IT_0151;
    ...
    const ccomplex_t IT_0162 = IT_0109*IT_0161;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*IT_0162;
    const ccomplex_t IT_0164 = cpow(IT_0010, -1);
    const ccomplex_t IT_0165 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
      *e_em*IT_0005*IT_0007*IT_0008*IT_0164;
    const ccomplex_t IT_0166 = 0.5*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u1
      *e_em*IT_0005*IT_0007*IT_0164;
    ...
    const ccomplex_t IT_0172 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*IT_0005*IT_0007*IT_0008*IT_0164;
    const ccomplex_t IT_0173 = 0.5*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u1
      *e_em*IT_0005*IT_0007*IT_0164;
    ...
    const ccomplex_t IT_0203 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0005*IT_0007*IT_0008*IT_0164;
    const ccomplex_t IT_0204 = 0.5*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0005*IT_0007*IT_0164;
    ...
    const ccomplex_t IT_0210 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0211 = IT_0122*IT_0210;
    const ccomplex_t IT_0212 = 2*IT_0211;
    const ccomplex_t IT_0213 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0214 = IT_0126*IT_0213;
    const ccomplex_t IT_0215 = 1.4142135623731*IT_0214;
    const ccomplex_t IT_0216 = N_W1*V_u1*e_em;
    const ccomplex_t IT_0217 = IT_0122*IT_0216;
    ...
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*(IT_0225 + (-3)*IT_0228);
    ...
    const ccomplex_t IT_0234 = -IT_0139 + -IT_0163 + -IT_0171 + -IT_0178 + 
      -IT_0202 + -IT_0209 + -IT_0233;
    const ccomplex_t IT_0235 = s_13*IT_0002;
    const ccomplex_t IT_0236 = (-6)*IT_0235;
    const ccomplex_t IT_0237 = s_12*s_23;
    const ccomplex_t IT_0238 = 12*IT_0237;
    const ccomplex_t IT_0239 = IT_0236 + IT_0238;
    const ccomplex_t IT_0240 = 0.166666666666667*conj(IT_0112);
    const ccomplex_t IT_0241 = s_23*m_C_1;
    const ccomplex_t IT_0242 = 6*IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0244 = IT_0034*IT_0222;
    const ccomplex_t IT_0245 = IT_0032*IT_0243*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0247 = IT_0056*IT_0199;
    const ccomplex_t IT_0248 = IT_0071*IT_0246*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0250 = IT_0075*IT_0136;
    const ccomplex_t IT_0251 = IT_0090*IT_0249*IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0253 = IT_0094*IT_0160;
    const ccomplex_t IT_0254 = IT_0109*IT_0252*IT_0253;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0256 = IT_0012*IT_0175;
    const ccomplex_t IT_0257 = IT_0003*IT_0255*IT_0256;
    const ccomplex_t IT_0258 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0259 = IT_0019*IT_0168;
    const ccomplex_t IT_0260 = IT_0016*IT_0258*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0262 = IT_0027*IT_0206;
    const ccomplex_t IT_0263 = IT_0024*IT_0261*IT_0262;
    const ccomplex_t IT_0264 = m_d*IT_0139;
    const ccomplex_t IT_0265 = m_d*IT_0163;
    const ccomplex_t IT_0266 = m_C_1*IT_0015;
    const ccomplex_t IT_0267 = m_C_1*IT_0022;
    const ccomplex_t IT_0268 = m_C_1*IT_0030;
    const ccomplex_t IT_0269 = m_d*IT_0233;
    const ccomplex_t IT_0270 = m_d*IT_0202;
    const ccomplex_t IT_0271 = -IT_0245 + -IT_0248 + -IT_0251 + -IT_0254 + 
      -IT_0257 + -IT_0260 + -IT_0263 + IT_0264 + IT_0265 + IT_0266 + IT_0267 +
       IT_0268 + IT_0269 + IT_0270;
    const ccomplex_t IT_0272 = 0.166666666666667*conj(IT_0271);
    const ccomplex_t IT_0273 = m_d*s_12;
    const ccomplex_t IT_0274 = 6*IT_0273;
    const ccomplex_t IT_0275 = IT_0006*IT_0173;
    const ccomplex_t IT_0276 = IT_0003*IT_0255*IT_0275;
    const ccomplex_t IT_0277 = IT_0025*IT_0204;
    const ccomplex_t IT_0278 = IT_0024*IT_0261*IT_0277;
    const ccomplex_t IT_0279 = IT_0051*IT_0230;
    const ccomplex_t IT_0280 = IT_0032*IT_0243*IT_0279;
    const ccomplex_t IT_0281 = IT_0069*IT_0186;
    const ccomplex_t IT_0282 = IT_0071*IT_0246*IT_0281;
    const ccomplex_t IT_0283 = IT_0088*IT_0121;
    const ccomplex_t IT_0284 = IT_0090*IT_0249*IT_0283;
    const ccomplex_t IT_0285 = IT_0107*IT_0147;
    const ccomplex_t IT_0286 = IT_0109*IT_0252*IT_0285;
    const ccomplex_t IT_0287 = IT_0017*IT_0166;
    const ccomplex_t IT_0288 = IT_0016*IT_0258*IT_0287;
    const ccomplex_t IT_0289 = m_d*IT_0054;
    const ccomplex_t IT_0290 = m_d*IT_0073;
    const ccomplex_t IT_0291 = m_d*IT_0092;
    const ccomplex_t IT_0292 = m_d*IT_0111;
    const ccomplex_t IT_0293 = m_C_1*IT_0171;
    const ccomplex_t IT_0294 = m_C_1*IT_0178;
    const ccomplex_t IT_0295 = m_C_1*IT_0209;
    const ccomplex_t IT_0296 = IT_0276 + IT_0278 + -IT_0280 + -IT_0282 + 
      -IT_0284 + -IT_0286 + IT_0288 + IT_0289 + IT_0290 + IT_0291 + IT_0292 + 
      -IT_0293 + -IT_0294 + -IT_0295;
    const ccomplex_t IT_0297 = 0.166666666666667*conj(IT_0296);
    const ccomplex_t IT_0298 = 0.166666666666667*conj(IT_0234);
    const ccomplex_t IT_0299 = m_d*m_C_1;
    const ccomplex_t IT_0300 = 6*IT_0299;
    const ccomplex_t IT_0301 = 6*IT_0112*(IT_0113*conj(IT_0234) + IT_0239
      *IT_0240 + IT_0242*IT_0272 + IT_0274*IT_0297) + 6*IT_0234*(conj(IT_0112)
      *IT_0113 + IT_0272*IT_0274 + IT_0242*IT_0297 + IT_0239*IT_0298) + 6
      *IT_0296*(IT_0240*IT_0274 + s_13*conj(IT_0296) + IT_0242*IT_0298 + IT_0272
      *IT_0300) + 6*IT_0271*(IT_0240*IT_0242 + s_13*conj(IT_0271) + IT_0274
      *IT_0298 + IT_0297*IT_0300);
