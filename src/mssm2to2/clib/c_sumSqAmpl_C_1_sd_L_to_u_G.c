...
ccomplex_return_t c_sumSqAmpl_C_1_sd_L_to_u_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0002;
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_sd_L*
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
    ...
    const ccomplex_t IT_0037 = m_u*m_C_1;
    ...
    const ccomplex_t IT_0046 = m_u*s_14*m_C_1;
    const ccomplex_t IT_0047 = m_u*s_34*m_C_1;
