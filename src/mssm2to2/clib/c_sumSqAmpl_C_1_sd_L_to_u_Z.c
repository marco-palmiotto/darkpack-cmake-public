...
ccomplex_return_t c_sumSqAmpl_C_1_sd_L_to_u_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0001;
    ...
    const ccomplex_t IT_0055 = s_34*IT_0025;
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0001*IT_0061*IT_0063;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = IT_0010*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0068 = IT_0015*IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0070 = V_u1*conj(V_u1)*e_em;
    const ccomplex_t IT_0071 = IT_0005*IT_0070;
    const ccomplex_t IT_0072 = IT_0007*IT_0070;
    const ccomplex_t IT_0073 = e_em*V_Wp1*conj(V_Wp1);
    ...
    const ccomplex_t IT_0078 = IT_0049*IT_0069*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0080 = V_u1*conj(V_u2)*e_em;
    const ccomplex_t IT_0081 = IT_0005*IT_0080;
    const ccomplex_t IT_0082 = IT_0007*IT_0080;
    const ccomplex_t IT_0083 = e_em*V_Wp1*conj(V_Wp2);
    ...
    const ccomplex_t IT_0088 = IT_0038*IT_0079*IT_0087;
    const ccomplex_t IT_0089 = m_C_1*IT_0051;
    const ccomplex_t IT_0090 = m_C_1*IT_0040;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*e_em*IT_0000*IT_0004;
    ...
    const ccomplex_t IT_0097 = -IT_0068 + -IT_0078 + -IT_0088 + -IT_0089 + 
      -IT_0090 + IT_0096;
    const ccomplex_t IT_0098 = s_14*IT_0025;
    ...
    const ccomplex_t IT_0104 = IT_0002*IT_0092;
    const ccomplex_t IT_0105 = IT_0015*IT_0067*IT_0104;
    const ccomplex_t IT_0106 = IT_0047*IT_0065;
    const ccomplex_t IT_0107 = IT_0049*IT_0069*IT_0106;
    const ccomplex_t IT_0108 = m_u*IT_0017;
    const ccomplex_t IT_0109 = IT_0065*IT_0076;
    ...
    const ccomplex_t IT_0116 = IT_0038*IT_0079*IT_0115;
    const ccomplex_t IT_0117 = IT_0086*IT_0114;
    ...
    const ccomplex_t IT_0121 = IT_0105 + -IT_0107 + -IT_0108 + -IT_0112 + 
      -IT_0116 + -IT_0120;
    const ccomplex_t IT_0122 = m_u*m_C_1;
    const ccomplex_t IT_0123 = IT_0025*IT_0122;
    const ccomplex_t IT_0124 = (-3)*IT_0123;
    const ccomplex_t IT_0125 = -IT_0095;
    const ccomplex_t IT_0126 = 3*IT_0123;
    const ccomplex_t IT_0127 = -IT_0111 + -IT_0119;
    ...
    const ccomplex_t IT_0131 = cpow((-2)*s_13 + IT_0012 + IT_0013 + -m_sd_L*
    ...
    const ccomplex_t IT_0147 = 6*IT_0124;
    const ccomplex_t IT_0148 = 6*IT_0126;
    const ccomplex_t IT_0149 = 0.5*IT_0099;
    ...
    const ccomplex_t IT_0154 = (-0.25)*IT_0056;
    ...
    const ccomplex_t IT_0160 = IT_0065*IT_0131;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = IT_0130*IT_0161;
    const ccomplex_t IT_0163 = 2*IT_0111 + 2*IT_0119 + IT_0162;
    const ccomplex_t IT_0164 = (-2)*IT_0095 + -IT_0162;
    const ccomplex_t IT_0165 = (-6)*conj(IT_0017);
    const ccomplex_t IT_0166 = 6*IT_0060;
    const ccomplex_t IT_0167 = 6*IT_0103;
    ...
    const ccomplex_t IT_0176 = m_u*IT_0173;
    const ccomplex_t IT_0177 = 6*IT_0176;
    const ccomplex_t IT_0178 = IT_0122*IT_0173;
    ...
    const ccomplex_t IT_0185 = IT_0122*IT_0182;
    ...
    const ccomplex_t IT_0195 = (-18)*IT_0122;
    const ccomplex_t IT_0196 = m_u*IT_0182;
    ...
    const ccomplex_t IT_0204 = conj(IT_0097)*(IT_0127*IT_0153 + IT_0052
      *IT_0158 + IT_0060*IT_0159 + IT_0125*IT_0167 + IT_0163*IT_0177 + IT_0135
      *IT_0188 + IT_0097*IT_0194 + IT_0121*IT_0195 + IT_0164*IT_0197 + IT_0141
      *IT_0203);
    const ccomplex_t IT_0205 = conj(IT_0121)*(IT_0052*IT_0153 + IT_0127
      *IT_0158 + IT_0103*IT_0159 + IT_0125*IT_0166 + IT_0135*IT_0177 + IT_0163
      *IT_0188 + IT_0121*IT_0194 + IT_0097*IT_0195 + IT_0141*IT_0197 + IT_0164
      *IT_0203);
    const ccomplex_t IT_0206 = s_13*IT_0201;
    const ccomplex_t IT_0207 = (-6)*IT_0206;
    const ccomplex_t IT_0208 = IT_0122*IT_0201;
    ...
    const ccomplex_t IT_0211 = IT_0017*IT_0139 + (-0.166666666666667)*IT_0135
      *IT_0175 + (-0.166666666666667)*IT_0121*IT_0177 + (-0.166666666666667)
      *IT_0163*IT_0179 + (-0.166666666666667)*IT_0141*IT_0184 + (
      -0.166666666666667)*IT_0164*IT_0186 + (-0.166666666666667)*IT_0097*IT_0188
       + IT_0140*IT_0210;
    const ccomplex_t IT_0212 = IT_0017*IT_0145 + (-0.166666666666667)*IT_0135
      ...
      *IT_0121*IT_0197 + (-0.166666666666667)*IT_0097*IT_0203 + (
    ...
    const ccomplex_t IT_0213 = conj(IT_0017)*(IT_0017*IT_0028 + IT_0052
      *IT_0054) + (IT_0060*IT_0097 + IT_0103*IT_0121 + IT_0124*IT_0125 + IT_0126
      *IT_0127)*IT_0128 + conj(IT_0052)*(IT_0028*IT_0052 + IT_0017*IT_0054 +
       IT_0135*IT_0140 + IT_0141*IT_0146 + IT_0127*IT_0147 + IT_0125*IT_0148 +
       IT_0121*IT_0153 + IT_0097*IT_0158) + conj(IT_0127)*(IT_0054*IT_0125 +
       IT_0028*IT_0127 + IT_0052*IT_0147 + IT_0097*IT_0153 + IT_0121*IT_0158 +
       IT_0126*IT_0159 + IT_0140*IT_0163 + IT_0146*IT_0164) + (IT_0135*IT_0139 +
       IT_0141*IT_0145)*IT_0165 + conj(IT_0125)*(IT_0028*IT_0125 + IT_0054
      *IT_0127 + IT_0052*IT_0148 + IT_0124*IT_0159 + IT_0121*IT_0166 + IT_0097
      *IT_0167 + IT_0163*IT_0168 + IT_0164*IT_0169) + conj(IT_0163)*(IT_0127
      *IT_0140 + IT_0125*IT_0168 + IT_0163*IT_0175 + IT_0097*IT_0177 + IT_0135
      *IT_0179 + IT_0164*IT_0184 + IT_0141*IT_0186 + IT_0121*IT_0188) + IT_0204 
      + IT_0205 + conj(IT_0164)*(IT_0127*IT_0146 + IT_0125*IT_0169 + IT_0163
      *IT_0184 + IT_0135*IT_0186 + IT_0097*IT_0197 + IT_0121*IT_0203 + IT_0164
