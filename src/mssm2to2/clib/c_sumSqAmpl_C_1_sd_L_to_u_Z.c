        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*3)*e_em*(IT_0001*IT_0003 + 1./3
      *IT_0000*IT_0004);
    const ccomplex_t IT_0019 = 0.333333333333333*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0012 + IT_0013 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0002*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*IT_0021;
    const ccomplex_t IT_0023 = IT_0019*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0001;
    const ccomplex_t IT_0025 = conj(U_d1)*U_d2*e_em;
    const ccomplex_t IT_0026 = IT_0005*IT_0025;
    const ccomplex_t IT_0027 = IT_0007*IT_0025;
    const ccomplex_t IT_0028 = e_em*conj(U_Wm1)*U_Wm2;
    ...
    const ccomplex_t IT_0033 = cpow((-2)*s_23 + IT_0012 + IT_0014 + -m_C_2*
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0012 + IT_0014 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = -IT_0023 + 2*IT_0035 + 2*IT_0046;
    ...
    const ccomplex_t IT_0052 = 2*IT_0017 + IT_0023;
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0001*IT_0078*IT_0080;
    ...
    const ccomplex_t IT_0100 = m_u*m_C_1;
    ...
    const ccomplex_t IT_0124 = IT_0024*IT_0077;
    const ccomplex_t IT_0125 = IT_0033*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0127 = IT_0002*IT_0095;
    const ccomplex_t IT_0128 = IT_0044*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = m_C_1*IT_0035;
    const ccomplex_t IT_0130 = m_C_1*IT_0046;
    const ccomplex_t IT_0131 = m_u*IT_0112;
    ...
    const ccomplex_t IT_0139 = IT_0042*IT_0088;
    const ccomplex_t IT_0140 = IT_0044*IT_0126*IT_0139;
    const ccomplex_t IT_0141 = m_u*IT_0017;
    const ccomplex_t IT_0142 = IT_0002*IT_0109;
    const ccomplex_t IT_0143 = IT_0015*IT_0121*IT_0142;
    const ccomplex_t IT_0144 = IT_0031*IT_0082;
    const ccomplex_t IT_0145 = IT_0033*IT_0123*IT_0144;
    const ccomplex_t IT_0146 = m_C_1*IT_0085;
    const ccomplex_t IT_0147 = m_C_1*IT_0098;
    ...
    const ccomplex_t IT_0167 = IT_0020*IT_0088;
    ...
    const ccomplex_t IT_0180 = m_u*IT_0177;
    ...
    const ccomplex_t IT_0201 = m_u*IT_0187;
    ...
    const ccomplex_t IT_0210 = s_13*IT_0206;
    const ccomplex_t IT_0211 = (-6)*IT_0210;
    const ccomplex_t IT_0212 = IT_0100*IT_0206;
    const ccomplex_t IT_0213 = (-6)*IT_0212;
    const ccomplex_t IT_0214 = IT_0132*(IT_0151*IT_0158 + conj(IT_0068)
    ...
    const ccomplex_t IT_0221 = (-6)*IT_0017*(conj(IT_0047)*IT_0051 + conj
      ...
      *IT_0193) + IT_0209 + IT_0172*(IT_0150*IT_0151 + conj(IT_0113)*IT_0173 +
       conj(IT_0170)*IT_0189 + conj(IT_0047)*IT_0191 + conj(IT_0132)*IT_0202 +
       conj(IT_0148)*IT_0208 + conj(IT_0172)*IT_0211 + conj(IT_0052)*IT_0213) +
       IT_0052*(conj(IT_0068)*IT_0150 + IT_0056*IT_0184 + conj(IT_0047)*IT_0189 
      + conj(IT_0170)*IT_0191 + conj(IT_0148)*IT_0202 + conj(IT_0132)*IT_0208 +
       conj(IT_0052)*IT_0211 + conj(IT_0172)*IT_0213) + IT_0214 + IT_0086*
      (IT_0070*conj(IT_0113) + IT_0215 + IT_0216 + IT_0217 + IT_0218 + IT_0219 +
       IT_0220) + IT_0099*(IT_0070*conj(IT_0113) + IT_0067*IT_0151 + IT_0215 +
       IT_0216 + IT_0217 + IT_0218 + IT_0219 + IT_0220);
