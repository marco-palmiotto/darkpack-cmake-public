...
ccomplex_return_t c_sumSqAmpl_C_1_sd_R_to_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = pow(m_d, 2);
    const ccomplex_t IT_0026 = pow(m_sd_R, 2);
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0088 = m_d*m_C_1*IT_0026;
    const ccomplex_t IT_0089 = pow(m_c, 2);
    const ccomplex_t IT_0090 = pow(m_C_1, 2);
    const ccomplex_t IT_0091 = cpow((-2)*s_12 + -IT_0026 + IT_0089 + -IT_0090 
      + -reg_prop, -1);
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_cd*e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0093 = (-0.5)*IT_0092;
    const ccomplex_t IT_0094 = sin(beta);
    const ccomplex_t IT_0095 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*IT_0000*IT_0002*IT_0004*IT_0094;
    ...
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_td*e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0101 = (-0.5)*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_td)
      *e_em*IT_0000*IT_0002*IT_0004*IT_0094;
    const ccomplex_t IT_0103 = 0.5*IT_0102;
    const ccomplex_t IT_0104 = IT_0101*IT_0103;
    const ccomplex_t IT_0105 = cpow((-2)*s_12 + -IT_0026 + -IT_0090 + 
    ...
    const ccomplex_t IT_0109 = cpow((-2)*s_12 + -IT_0026 + -IT_0090 + IT_0108 
      + -reg_prop, -1);
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0111 = (-0.5)*IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0000*IT_0002*IT_0004*IT_0094;
    ...
    const ccomplex_t IT_0119 = IT_0012*IT_0094;
    ...
    const ccomplex_t IT_0123 = IT_0004*IT_0094;
    ...
    const ccomplex_t IT_0189 = IT_0084*IT_0188;
    ...
    const ccomplex_t IT_0192 = m_d*s_12;
    const ccomplex_t IT_0193 = 6*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0195 = IT_0023*IT_0118;
    const ccomplex_t IT_0196 = IT_0027*IT_0194*IT_0195;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0198 = IT_0045*IT_0156;
    const ccomplex_t IT_0199 = IT_0030*IT_0197*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0201 = IT_0063*IT_0138;
    const ccomplex_t IT_0202 = IT_0065*IT_0200*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0204 = IT_0082*IT_0174;
    const ccomplex_t IT_0205 = IT_0084*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = m_d*IT_0029;
    const ccomplex_t IT_0207 = m_d*IT_0048;
    const ccomplex_t IT_0208 = m_d*IT_0067;
    const ccomplex_t IT_0209 = m_d*IT_0086;
    const ccomplex_t IT_0210 = m_C_1*IT_0099;
    const ccomplex_t IT_0211 = m_C_1*IT_0107;
    const ccomplex_t IT_0212 = m_C_1*IT_0116;
    ...
    const ccomplex_t IT_0218 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*IT_0000*IT_0001*IT_0004*IT_0217;
    ...
    const ccomplex_t IT_0223 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0000*IT_0001*IT_0004*IT_0217;
    ...
    const ccomplex_t IT_0228 = IT_0006*IT_0133;
    const ccomplex_t IT_0229 = IT_0027*IT_0194*IT_0228;
    const ccomplex_t IT_0230 = IT_0032*IT_0169;
    const ccomplex_t IT_0231 = IT_0030*IT_0197*IT_0230;
    const ccomplex_t IT_0232 = IT_0050*IT_0151;
    const ccomplex_t IT_0233 = IT_0065*IT_0200*IT_0232;
    const ccomplex_t IT_0234 = IT_0069*IT_0187;
    const ccomplex_t IT_0235 = IT_0084*IT_0203*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
      *e_em*IT_0000*IT_0001*IT_0004*IT_0217;
    ...
    const ccomplex_t IT_0241 = m_d*IT_0136;
    const ccomplex_t IT_0242 = m_d*IT_0154;
    const ccomplex_t IT_0243 = m_d*IT_0172;
    const ccomplex_t IT_0244 = m_d*IT_0190;
    ...
    const ccomplex_t IT_0247 = s_13*IT_0026;
    ...
    const ccomplex_t IT_0254 = m_d*m_C_1;
