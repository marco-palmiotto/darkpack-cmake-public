...
ccomplex_return_t c_sumSqAmpl_C_1_sd_R_to_u_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0000;
    ...
    const ccomplex_t IT_0009 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_ss_L*
    ...
    const ccomplex_t IT_0016 = e_em*conj(U_Wm1)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = cos(beta);
    const ccomplex_t IT_0019 = cpow(IT_0018, -1);
    const ccomplex_t IT_0020 = IT_0004*IT_0014*IT_0019;
    const ccomplex_t IT_0021 = pow(m_W, -1);
    const ccomplex_t IT_0022 = m_b*conj(U_d1)*e_em*IT_0021*U_sb_10*V_ub_mod;
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = 1.4142135623731*A_b*V_tb*V_td*IT_0000*conj
      (U_sb_01);
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = e_em*conj(U_Wm1)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0033 = IT_0015*IT_0032;
    const ccomplex_t IT_0034 = m_b*conj(U_d1)*e_em*IT_0021*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0004*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0048 = IT_0004*(IT_0045 + IT_0047);
    ...
    const ccomplex_t IT_0053 = pow(m_sd_R, 2);
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0007 + IT_0053 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0051*IT_0052*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0004*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0007 + IT_0053 + -m_C_2*
    ...
    const ccomplex_t IT_0080 = V_u1*U_Wm2;
    const ccomplex_t IT_0081 = IT_0018*IT_0080;
    const ccomplex_t IT_0082 = U_d2*V_Wp1;
    const ccomplex_t IT_0083 = IT_0000*IT_0082;
    const ccomplex_t IT_0084 = IT_0004*(IT_0081 + IT_0083);
    ...
    const ccomplex_t IT_0090 = m_C_1*IT_0089;
    const ccomplex_t IT_0091 = m_d*e_em*mu_h*IT_0021;
    const ccomplex_t IT_0092 = IT_0004*IT_0091;
    const ccomplex_t IT_0093 = A_b*V_td*conj(V_td);
    const ccomplex_t IT_0094 = IT_0000*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = (-0.5)*IT_0092 + (-0.5)*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0004;
    const ccomplex_t IT_0098 = IT_0096*IT_0097;
    const ccomplex_t IT_0099 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0100 = IT_0098*IT_0099;
    const ccomplex_t IT_0101 = (0 + _Complex_I*1)*IT_0100;
    const ccomplex_t IT_0102 = -IT_0011 + -IT_0029 + -IT_0041 + IT_0055 +
       IT_0068 + IT_0079 + IT_0090 + -IT_0101;
    const ccomplex_t IT_0103 = s_34*m_C_1;
    const ccomplex_t IT_0104 = 6*IT_0103;
    const ccomplex_t IT_0105 = -IT_0078 + -IT_0089;
    const ccomplex_t IT_0106 = 0.166666666666667*IT_0105;
    const ccomplex_t IT_0107 = m_u*s_14;
    const ccomplex_t IT_0108 = 6*IT_0107;
    const ccomplex_t IT_0109 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0053 
      + -reg_prop, -1);
    const ccomplex_t IT_0110 = cpow(IT_0000, -1);
    const ccomplex_t IT_0111 = m_u*e_em*IT_0004*IT_0018*IT_0021*IT_0110;
    ...
    const ccomplex_t IT_0118 = m_u*m_C_1;
    const ccomplex_t IT_0119 = 6*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_us
      *e_em*IT_0004*IT_0021*IT_0110;
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0004*IT_0014*IT_0021*IT_0110*U_sb_01*V_ub_mod;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0004*IT_0021*IT_0110;
    const ccomplex_t IT_0131 = 0.5*IT_0130;
    const ccomplex_t IT_0132 = IT_0096*IT_0131;
    const ccomplex_t IT_0133 = IT_0099*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0004*IT_0014*IT_0021*IT_0110*U_sb_00*V_ub_mod;
    ...
    const ccomplex_t IT_0140 = IT_0124 + IT_0129 + IT_0134 + IT_0139;
    const ccomplex_t IT_0141 = 0.166666666666667*IT_0140;
    const ccomplex_t IT_0142 = 0.166666666666667*IT_0102;
    const ccomplex_t IT_0143 = pow(m_A0, 2);
    const ccomplex_t IT_0144 = m_u*m_C_1*IT_0143;
    const ccomplex_t IT_0145 = s_13*IT_0143;
    const ccomplex_t IT_0146 = s_14*s_34;
    const ccomplex_t IT_0147 = (-2)*IT_0146;
    const ccomplex_t IT_0148 = IT_0145 + IT_0147;
    const ccomplex_t IT_0149 = (-6)*IT_0148;
    const ccomplex_t IT_0150 = 6*conj(IT_0102)*(s_13*IT_0102 + IT_0104*IT_0106
       + IT_0108*IT_0117 + IT_0119*IT_0141) + 6*conj(IT_0140)*(IT_0106*IT_0108 +
       IT_0104*IT_0117 + s_13*IT_0140 + IT_0119*IT_0142) + 6*conj(IT_0105)*
      (IT_0108*IT_0141 + IT_0104*IT_0142 + IT_0116*IT_0144 + IT_0106*IT_0149) +
       6*conj(IT_0116)*(IT_0104*IT_0141 + IT_0108*IT_0142 + IT_0105*IT_0144 +
       IT_0117*IT_0149);
