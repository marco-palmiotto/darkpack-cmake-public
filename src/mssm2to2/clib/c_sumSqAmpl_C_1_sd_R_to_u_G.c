...
ccomplex_return_t c_sumSqAmpl_C_1_sd_R_to_u_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_sd_R*
    ...
    const ccomplex_t IT_0034 = IT_0014*(32*conj(IT_0014)*IT_0015 + (-8)
      *IT_0016*conj(IT_0022) + conj(IT_0023)*IT_0027) + IT_0029*(s_14*conj
      (IT_0023)*IT_0030 + conj(IT_0022)*IT_0031) + IT_0023*(conj(IT_0014)
      *IT_0027 + (IT_0010*conj(IT_0023) + s_14*conj(IT_0029))*IT_0030 + conj
      (IT_0022)*IT_0033) + (-8)*IT_0022*(conj(IT_0014)*IT_0016 + s_13*IT_0009
      *conj(IT_0022) + (-0.125)*conj(IT_0029)*IT_0031 + (-0.125)*conj(IT_0023)
      *IT_0033);
