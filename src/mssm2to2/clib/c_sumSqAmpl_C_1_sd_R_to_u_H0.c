...
ccomplex_return_t c_sumSqAmpl_C_1_sd_R_to_u_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = m_u*m_C_1*IT_0019;
    const ccomplex_t IT_0025 = cos(alpha);
    const ccomplex_t IT_0026 = U_d1*V_Wp1;
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = V_u1*U_Wm1;
    ...
    const ccomplex_t IT_0040 = U_d2*V_Wp1;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*-1)*(m_d*e_em*mu_h*IT_0004
      *IT_0006*IT_0008*IT_0013 + (-1.4142135623731)*A_b*V_td*conj(V_td)*IT_0025);
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0004*IT_0008*IT_0012;
    const ccomplex_t IT_0057 = 0.5*IT_0056;
    const ccomplex_t IT_0058 = IT_0055*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0004*IT_0008*IT_0012*IT_0065*U_sb_00*V_ub_mod;
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0004*IT_0008*IT_0012*IT_0065*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0074 = 0.5*IT_0073;
    const ccomplex_t IT_0075 = IT_0072*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0025;
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0085 = IT_0083*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = IT_0061 + IT_0070 + IT_0078 + IT_0086;
    const ccomplex_t IT_0088 = m_u*s_14;
    const ccomplex_t IT_0089 = cos(theta_W);
    const ccomplex_t IT_0090 = cpow(IT_0089, -2);
    const ccomplex_t IT_0091 = pow(m_d, 2);
    const ccomplex_t IT_0092 = (0 + _Complex_I*-1)*e_em*(m_W*IT_0007*(IT_0011
      *IT_0013 + -IT_0005*IT_0025)*IT_0090 + 3*IT_0004*IT_0006*IT_0008*IT_0025
      *IT_0091);
    const ccomplex_t IT_0093 = 0.333333333333333*IT_0092;
    const ccomplex_t IT_0094 = IT_0010*IT_0093;
    const ccomplex_t IT_0095 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = IT_0008*IT_0065;
    const ccomplex_t IT_0099 = e_em*conj(U_Wm1)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0100 = IT_0098*IT_0099;
    const ccomplex_t IT_0101 = IT_0006*IT_0008*IT_0065;
    const ccomplex_t IT_0102 = m_b*conj(U_d1)*e_em*IT_0004*U_sb_10*V_ub_mod;
    ...
    const ccomplex_t IT_0109 = e_em*conj(U_Wm1)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0110 = IT_0098*IT_0109;
    const ccomplex_t IT_0111 = m_b*conj(U_d1)*e_em*IT_0004*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0116 = IT_0076*IT_0115;
    ...
    const ccomplex_t IT_0122 = IT_0008*(IT_0119 + IT_0121);
    ...
    const ccomplex_t IT_0128 = IT_0035*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = conj(U_d1)*conj(V_Wp2);
    const ccomplex_t IT_0130 = IT_0025*IT_0129;
    const ccomplex_t IT_0131 = conj(V_u2)*conj(U_Wm1);
    ...
    const ccomplex_t IT_0139 = IT_0049*IT_0137*IT_0138;
    const ccomplex_t IT_0140 = m_u*IT_0018;
    const ccomplex_t IT_0141 = m_C_1*IT_0037;
    const ccomplex_t IT_0142 = m_C_1*IT_0051;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0008;
    const ccomplex_t IT_0144 = IT_0055*IT_0143;
    const ccomplex_t IT_0145 = IT_0059*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm1)*IT_0008;
    ...
    const ccomplex_t IT_0151 = -IT_0097 + -IT_0108 + -IT_0117 + IT_0128 +
       IT_0139 + 2*IT_0140 + IT_0141 + IT_0142 + -IT_0146 + -IT_0150;
    const ccomplex_t IT_0152 = 6*IT_0018;
    const ccomplex_t IT_0153 = 6*conj(IT_0018);
    const ccomplex_t IT_0154 = 6*IT_0088;
    const ccomplex_t IT_0155 = 6*IT_0053;
    const ccomplex_t IT_0156 = m_u*m_C_1;
    const ccomplex_t IT_0157 = 6*IT_0156;
    const ccomplex_t IT_0158 = 0.166666666666667*conj(IT_0052);
    const ccomplex_t IT_0159 = (-6)*IT_0018*conj(IT_0018)*IT_0023 + (IT_0024
      *conj(IT_0052) + IT_0053*conj(IT_0087) + IT_0088*conj(IT_0151))*IT_0152 + 
      (-6)*IT_0052*(IT_0023*conj(IT_0052) + (-0.166666666666667)*IT_0024*IT_0153
       + (-0.166666666666667)*conj(IT_0087)*IT_0154 + (-0.166666666666667)*conj
      (IT_0151)*IT_0155) + 6*IT_0087*(s_13*conj(IT_0087) + 0.166666666666667
      *IT_0053*IT_0153 + 0.166666666666667*conj(IT_0151)*IT_0157 + IT_0154
      *IT_0158) + 6*IT_0151*(s_13*conj(IT_0151) + 0.166666666666667*IT_0088
      *IT_0153 + 0.166666666666667*conj(IT_0087)*IT_0157 + IT_0155*IT_0158);
