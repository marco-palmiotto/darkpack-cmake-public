...
ccomplex_return_t c_sumSqAmpl_C_1_se_L_to_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0029 + IT_0030 + -m_N_2*
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_23 + IT_0029 + IT_0030 + -m_N_3*
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_23 + IT_0029 + IT_0030 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0107 = IT_0105*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = -IT_0033 + -IT_0058 + -IT_0083 + -IT_0108;
    const ccomplex_t IT_0110 = m_e*m_C_1*IT_0030;
    const ccomplex_t IT_0111 = pow(m_W, -1);
    const ccomplex_t IT_0112 = cpow(IT_0012, -1);
    const ccomplex_t IT_0113 = sin(beta);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0006*IT_0111*IT_0112*IT_0113;
    const ccomplex_t IT_0115 = 0.5*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0006;
    const ccomplex_t IT_0117 = IT_0115*IT_0116;
    const ccomplex_t IT_0118 = pow(m_C_1, 2);
    const ccomplex_t IT_0119 = cpow(s_12 + 0.5*IT_0030 + 0.5*IT_0118 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0120 = IT_0117*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0006*IT_0111*IT_0112;
    const ccomplex_t IT_0123 = (-0.5)*IT_0122;
    const ccomplex_t IT_0124 = IT_0001*IT_0113;
    const ccomplex_t IT_0125 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0126 = IT_0124*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = IT_0006*IT_0113;
    ...
    const ccomplex_t IT_0142 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0006*IT_0111*IT_0112;
    const ccomplex_t IT_0143 = (-0.5)*IT_0142;
    const ccomplex_t IT_0144 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0145 = IT_0128*IT_0144;
    const ccomplex_t IT_0146 = (-2)*IT_0145;
    const ccomplex_t IT_0147 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0148 = IT_0124*IT_0147;
    const ccomplex_t IT_0149 = 1.4142135623731*IT_0148;
    const ccomplex_t IT_0150 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0160 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0006*IT_0111*IT_0112;
    const ccomplex_t IT_0161 = (-0.5)*IT_0160;
    const ccomplex_t IT_0162 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0163 = IT_0128*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0166 = IT_0124*IT_0165;
    const ccomplex_t IT_0167 = 1.4142135623731*IT_0166;
    const ccomplex_t IT_0168 = IT_0164 + IT_0167;
    const ccomplex_t IT_0169 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0170 = IT_0128*IT_0169;
    ...
    const ccomplex_t IT_0180 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0181 = IT_0128*IT_0180;
    const ccomplex_t IT_0182 = (-2)*IT_0181;
    const ccomplex_t IT_0183 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0184 = IT_0124*IT_0183;
    const ccomplex_t IT_0185 = 1.4142135623731*IT_0184;
    const ccomplex_t IT_0186 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0194 = IT_0106*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*IT_0194;
    const ccomplex_t IT_0196 = (-0.5)*IT_0121 + -IT_0141 + -IT_0159 + -IT_0177
       + -IT_0195;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0198 = IT_0027*IT_0123;
    const ccomplex_t IT_0199 = IT_0031*IT_0197*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0201 = IT_0055*IT_0143;
    const ccomplex_t IT_0202 = IT_0034*IT_0200*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0204 = IT_0079*IT_0161;
    const ccomplex_t IT_0205 = IT_0081*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0207 = IT_0104*IT_0179;
    const ccomplex_t IT_0208 = IT_0106*IT_0206*IT_0207;
    const ccomplex_t IT_0209 = m_e*IT_0033;
    const ccomplex_t IT_0210 = m_e*IT_0058;
    const ccomplex_t IT_0211 = m_e*IT_0083;
    const ccomplex_t IT_0212 = m_e*IT_0108;
    const ccomplex_t IT_0213 = m_C_1*IT_0121;
    const ccomplex_t IT_0214 = -IT_0199 + -IT_0202 + -IT_0205 + -IT_0208 +
       IT_0209 + IT_0210 + IT_0211 + IT_0212 + (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = m_e*s_12;
    const ccomplex_t IT_0216 = 2*IT_0215;
    const ccomplex_t IT_0217 = s_23*m_C_1;
    const ccomplex_t IT_0218 = 2*IT_0217;
    const ccomplex_t IT_0219 = IT_0011*IT_0138;
    const ccomplex_t IT_0220 = IT_0031*IT_0197*IT_0219;
    const ccomplex_t IT_0221 = IT_0042*IT_0156;
    const ccomplex_t IT_0222 = IT_0034*IT_0200*IT_0221;
    const ccomplex_t IT_0223 = IT_0066*IT_0174;
    const ccomplex_t IT_0224 = IT_0081*IT_0203*IT_0223;
    const ccomplex_t IT_0225 = m_e*IT_0141;
    const ccomplex_t IT_0226 = m_e*IT_0159;
    const ccomplex_t IT_0227 = m_e*IT_0177;
    const ccomplex_t IT_0228 = m_e*IT_0195;
    const ccomplex_t IT_0229 = IT_0091*IT_0192;
    const ccomplex_t IT_0230 = IT_0106*IT_0206*IT_0229;
    const ccomplex_t IT_0231 = -IT_0220 + -IT_0222 + -IT_0224 + IT_0225 +
       IT_0226 + IT_0227 + IT_0228 + -IT_0230;
    const ccomplex_t IT_0232 = 0.5*conj(IT_0231);
    const ccomplex_t IT_0233 = s_12*s_23;
    const ccomplex_t IT_0234 = s_13*IT_0030;
    const ccomplex_t IT_0235 = (-0.5)*IT_0234;
    const ccomplex_t IT_0236 = IT_0233 + IT_0235;
    const ccomplex_t IT_0237 = 4*IT_0236;
    const ccomplex_t IT_0238 = 0.5*conj(IT_0109);
    const ccomplex_t IT_0239 = m_e*m_C_1;
    const ccomplex_t IT_0240 = 2*IT_0239;
    const ccomplex_t IT_0241 = 0.5*conj(IT_0196);
    const ccomplex_t IT_0242 = 2*IT_0109*(IT_0110*conj(IT_0196) + 0.5*conj
      (IT_0214)*IT_0216 + IT_0218*IT_0232 + IT_0237*IT_0238) + 2*IT_0231*(s_13
      *conj(IT_0231) + IT_0218*IT_0238 + 0.5*conj(IT_0214)*IT_0240 + IT_0216
      *IT_0241) + 2*IT_0214*(s_13*conj(IT_0214) + IT_0216*IT_0238 + IT_0232
      *IT_0240 + IT_0218*IT_0241) + 2*IT_0196*(conj(IT_0109)*IT_0110 + 0.5*conj
      (IT_0214)*IT_0218 + IT_0216*IT_0232 + IT_0237*IT_0241);
