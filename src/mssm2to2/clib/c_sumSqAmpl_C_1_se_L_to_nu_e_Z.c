        ...
        )
{
    ...
    const ccomplex_t IT_0006 = V_u1*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0017 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0018 = IT_0014*IT_0015*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0001;
    const ccomplex_t IT_0020 = V_u1*conj(V_u1)*e_em;
    const ccomplex_t IT_0021 = IT_0005*IT_0020;
    const ccomplex_t IT_0022 = IT_0008*IT_0020;
    const ccomplex_t IT_0023 = e_em*V_Wp1*conj(V_Wp1);
    ...
    const ccomplex_t IT_0029 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0030 = IT_0027*IT_0028*IT_0029;
    const ccomplex_t IT_0031 = U_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0042 = conj(U_d1)*U_d2*e_em;
    const ccomplex_t IT_0043 = IT_0005*IT_0042;
    const ccomplex_t IT_0044 = IT_0008*IT_0042;
    const ccomplex_t IT_0045 = e_em*conj(U_Wm1)*U_Wm2;
    ...
    const ccomplex_t IT_0088 = 0.5*IT_0040 + 0.5*IT_0051;
    const ccomplex_t IT_0089 = (-0.25)*IT_0082;
    ...
    const ccomplex_t IT_0102 = pow(m_Z, 4);
    ...
    const ccomplex_t IT_0107 = (-8)*IT_0106;
    const ccomplex_t IT_0108 = IT_0056 + IT_0058 + (-0.5)*IT_0104;
    const ccomplex_t IT_0109 = (-4)*IT_0108;
    const ccomplex_t IT_0110 = s_13*s_14;
    const ccomplex_t IT_0111 = s_34*IT_0066;
    const ccomplex_t IT_0112 = -IT_0111;
    const ccomplex_t IT_0113 = IT_0110 + IT_0112;
    const ccomplex_t IT_0114 = conj(IT_0094)*IT_0113;
    const ccomplex_t IT_0115 = pow(s_14, 2);
    const ccomplex_t IT_0116 = IT_0054*IT_0115;
    const ccomplex_t IT_0117 = -IT_0066;
    const ccomplex_t IT_0118 = IT_0116 + IT_0117;
    const ccomplex_t IT_0119 = s_13*IT_0118;
    const ccomplex_t IT_0120 = s_13*IT_0097;
    const ccomplex_t IT_0121 = (-2)*IT_0120;
    const ccomplex_t IT_0122 = 0.5*conj(IT_0076);
    const ccomplex_t IT_0123 = 0.5*conj(IT_0053);
    const ccomplex_t IT_0124 = (-2)*IT_0100;
    const ccomplex_t IT_0125 = 0.5*conj(IT_0080);
    const ccomplex_t IT_0126 = 0.5*conj(IT_0088);
    const ccomplex_t IT_0127 = s_13*IT_0054*IT_0077;
    const ccomplex_t IT_0128 = 4*IT_0053*(conj(IT_0053)*(s_13 + (-0.5)*IT_0060
      ) + 0.25*conj(IT_0076)*IT_0079 + 0.25*conj(IT_0080)*IT_0087 + 0.25*conj
      (IT_0088)*IT_0093 + 0.25*conj(IT_0094)*IT_0099) + IT_0080*(conj(IT_0053)
      *IT_0087 + conj(IT_0076)*IT_0101 + conj(IT_0088)*IT_0107 + conj(IT_0080)
      *IT_0109 + (-2)*IT_0114) + (-2)*IT_0094*((conj(IT_0080) + -conj(IT_0088))
      *IT_0113 + -conj(IT_0094)*IT_0119 + -IT_0121*IT_0122 + -IT_0099*IT_0123) +
       2*IT_0088*(IT_0114 + IT_0093*IT_0123 + IT_0122*IT_0124 + IT_0107*IT_0125 
      + IT_0109*IT_0126) + 2*IT_0076*(0.5*conj(IT_0094)*IT_0121 + IT_0079
      *IT_0123 + IT_0101*IT_0125 + IT_0124*IT_0126 + conj(IT_0076)*IT_0127);
