...
ccomplex_return_t c_sumSqAmpl_C_1_se_R_to_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0088 = m_e*m_C_1*IT_0026;
    const ccomplex_t IT_0089 = sin(beta);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0000*IT_0002*IT_0004*IT_0089;
    const ccomplex_t IT_0091 = 0.5*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0186 = m_e*IT_0029;
    const ccomplex_t IT_0187 = m_e*IT_0048;
    const ccomplex_t IT_0188 = m_e*IT_0067;
    const ccomplex_t IT_0189 = m_e*IT_0086;
    ...
    const ccomplex_t IT_0192 = m_e*s_12;
    ...
    const ccomplex_t IT_0202 = m_e*IT_0118;
    const ccomplex_t IT_0203 = m_e*IT_0136;
    const ccomplex_t IT_0204 = m_e*IT_0154;
    const ccomplex_t IT_0205 = m_e*IT_0172;
    ...
    const ccomplex_t IT_0216 = m_e*m_C_1;
