        ...
        )
{
    ...
    const ccomplex_t IT_0021 = conj(N_W2)*e_em*V_Wp1;
    const ccomplex_t IT_0022 = IT_0005*IT_0021;
    const ccomplex_t IT_0023 = conj(N_u2)*V_u1*e_em;
    ...
    const ccomplex_t IT_0034 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0035 = IT_0005*IT_0034;
    const ccomplex_t IT_0036 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0065 = m_e*IT_0064;
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0005*IT_0068*IT_0070;
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = IT_0027*IT_0077;
    const ccomplex_t IT_0079 = IT_0029*IT_0075*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0005*IT_0068*IT_0070;
    const ccomplex_t IT_0082 = 0.5*IT_0081;
    const ccomplex_t IT_0083 = IT_0040*IT_0082;
    const ccomplex_t IT_0084 = IT_0042*IT_0080*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0005*IT_0068*IT_0070;
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = IT_0053*IT_0087;
    const ccomplex_t IT_0089 = IT_0055*IT_0085*IT_0088;
    ...
    const ccomplex_t IT_0141 = IT_0003*IT_0096;
    const ccomplex_t IT_0142 = IT_0016*IT_0067*IT_0141;
    const ccomplex_t IT_0143 = IT_0020*IT_0107;
    const ccomplex_t IT_0144 = IT_0029*IT_0075*IT_0143;
    const ccomplex_t IT_0145 = IT_0033*IT_0118;
    const ccomplex_t IT_0146 = IT_0042*IT_0080*IT_0145;
    const ccomplex_t IT_0147 = IT_0046*IT_0129;
    const ccomplex_t IT_0148 = IT_0055*IT_0085*IT_0147;
    const ccomplex_t IT_0149 = m_C_1*IT_0018;
    const ccomplex_t IT_0150 = m_C_1*IT_0031;
    const ccomplex_t IT_0151 = m_C_1*IT_0044;
    const ccomplex_t IT_0152 = m_C_1*IT_0057;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005;
    const ccomplex_t IT_0154 = 0.5*IT_0153;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0005*IT_0068*IT_0070;
    const ccomplex_t IT_0156 = (-0.5)*IT_0155;
    const ccomplex_t IT_0157 = IT_0154*IT_0156;
    const ccomplex_t IT_0158 = pow(m_C_1, 2);
    const ccomplex_t IT_0159 = cpow(s_12 + 0.5*IT_0015 + 0.5*IT_0158 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0160 = IT_0157*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = m_e*IT_0161;
    const ccomplex_t IT_0163 = IT_0142 + IT_0144 + IT_0146 + IT_0148 + 
      -IT_0149 + -IT_0150 + -IT_0151 + -IT_0152 + 0.5*IT_0162;
    const ccomplex_t IT_0164 = m_e*m_C_1;
    const ccomplex_t IT_0165 = IT_0060*IT_0164;
    const ccomplex_t IT_0166 = 3*IT_0165;
    const ccomplex_t IT_0167 = (-0.5)*IT_0161;
    const ccomplex_t IT_0168 = (-3)*IT_0165;
    const ccomplex_t IT_0169 = IT_0099 + IT_0110 + IT_0121 + IT_0132;
    const ccomplex_t IT_0170 = 2*IT_0018 + 2*IT_0031 + 2*IT_0044 + 2*IT_0057;
    const ccomplex_t IT_0171 = s_13*s_14;
    const ccomplex_t IT_0172 = s_34*IT_0158;
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = IT_0171 + IT_0173;
    const ccomplex_t IT_0175 = s_13*IT_0060;
    const ccomplex_t IT_0176 = pow(m_W, 4);
    const ccomplex_t IT_0177 = s_13*IT_0176;
    const ccomplex_t IT_0178 = IT_0059*IT_0177;
    ...
    const ccomplex_t IT_0184 = -IT_0161;
    const ccomplex_t IT_0185 = pow(s_34, 2);
    const ccomplex_t IT_0186 = IT_0059*IT_0185;
    const ccomplex_t IT_0187 = -IT_0186;
    const ccomplex_t IT_0188 = IT_0014 + IT_0187;
    const ccomplex_t IT_0189 = s_13*IT_0188;
    const ccomplex_t IT_0190 = s_14*IT_0014;
    ...
    const ccomplex_t IT_0195 = s_14*s_34*IT_0059;
    ...
    const ccomplex_t IT_0200 = m_C_1*IT_0188;
    const ccomplex_t IT_0201 = (-2)*IT_0200;
    const ccomplex_t IT_0202 = (-2)*IT_0099 + (-2)*IT_0110 + (-2)*IT_0121 + (
      -2)*IT_0132;
    const ccomplex_t IT_0203 = s_13*IT_0197;
    const ccomplex_t IT_0204 = (-2)*IT_0203;
    const ccomplex_t IT_0205 = m_e*IT_0197;
    const ccomplex_t IT_0206 = (-2)*IT_0205;
    const ccomplex_t IT_0207 = -IT_0169;
    const ccomplex_t IT_0208 = (-2)*conj(IT_0184)*(IT_0184*IT_0189 + (-0.5)
      *IT_0167*IT_0194 + (-0.5)*IT_0170*IT_0199 + (-0.5)*IT_0134*IT_0201 + (-0.5
      )*IT_0202*IT_0204 + (-0.5)*IT_0163*IT_0206 + IT_0193*IT_0207);
    const ccomplex_t IT_0209 = pow(s_14, 2);
    const ccomplex_t IT_0210 = IT_0059*IT_0209;
    const ccomplex_t IT_0211 = -IT_0158;
    const ccomplex_t IT_0212 = IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = IT_0164*IT_0212;
    const ccomplex_t IT_0214 = s_13*IT_0212;
    const ccomplex_t IT_0215 = m_C_1*IT_0197;
    const ccomplex_t IT_0216 = (-2)*IT_0215;
    const ccomplex_t IT_0217 = 0.5*IT_0134;
    const ccomplex_t IT_0218 = 0.5*IT_0184;
    const ccomplex_t IT_0219 = m_e*IT_0212;
    const ccomplex_t IT_0220 = 2*IT_0219;
    const ccomplex_t IT_0221 = 0.5*IT_0163;
    const ccomplex_t IT_0222 = (-0.25)*IT_0062;
    const ccomplex_t IT_0223 = s_14 + IT_0222;
    const ccomplex_t IT_0224 = m_e*IT_0223;
    const ccomplex_t IT_0225 = (-4)*IT_0224;
    const ccomplex_t IT_0226 = (-6)*IT_0164;
    const ccomplex_t IT_0227 = 0.5*IT_0202;
    const ccomplex_t IT_0228 = IT_0175 + IT_0181;
    const ccomplex_t IT_0229 = IT_0059*IT_0228;
    const ccomplex_t IT_0230 = (-0.5)*IT_0229;
    const ccomplex_t IT_0231 = s_13 + IT_0230;
    const ccomplex_t IT_0232 = 4*IT_0231;
    const ccomplex_t IT_0233 = 0.5*IT_0136;
    const ccomplex_t IT_0234 = s_34 + IT_0233;
    const ccomplex_t IT_0235 = m_C_1*IT_0234;
    const ccomplex_t IT_0236 = 2*IT_0235;
    const ccomplex_t IT_0237 = 0.5*IT_0167;
    const ccomplex_t IT_0238 = (-0.25)*IT_0178;
    const ccomplex_t IT_0239 = IT_0180 + IT_0238;
    const ccomplex_t IT_0240 = (-8)*IT_0239;
    const ccomplex_t IT_0241 = 0.5*IT_0169;
    const ccomplex_t IT_0242 = 2*conj(IT_0058)*(IT_0066*IT_0134 + IT_0140
      *IT_0163 + IT_0166*IT_0167 + IT_0168*IT_0169 + IT_0170*IT_0174 + 0.5
      *IT_0058*IT_0183) + IT_0208 + 2*conj(IT_0170)*(IT_0058*IT_0174 + IT_0202
      *IT_0213 + IT_0170*IT_0214 + IT_0199*IT_0218 + IT_0217*IT_0220 + IT_0216
      *IT_0221) + (-2)*conj(IT_0202)*(IT_0174*(IT_0167 + IT_0207) + -IT_0170
      *IT_0213 + -IT_0202*IT_0214 + -IT_0216*IT_0217 + -IT_0204*IT_0218 + 
      -IT_0220*IT_0221) + 2*conj(IT_0163)*(IT_0058*IT_0140 + IT_0066*IT_0169 +
       0.5*IT_0170*IT_0216 + IT_0206*IT_0218 + IT_0167*IT_0225 + IT_0217*IT_0226
       + IT_0220*IT_0227 + IT_0221*IT_0232) + 2*conj(IT_0134)*(IT_0058*IT_0066 +
       IT_0140*IT_0169 + IT_0201*IT_0218 + 0.5*IT_0170*IT_0220 + IT_0221*IT_0226
       + IT_0216*IT_0227 + IT_0217*IT_0232 + IT_0167*IT_0236) + 2*conj(IT_0169)*
      (IT_0134*IT_0140 + IT_0066*IT_0163 + IT_0058*IT_0168 + IT_0184*IT_0193 +
       IT_0174*IT_0202 + IT_0237*IT_0240 + IT_0183*IT_0241) + 2*conj(IT_0167)*
      (IT_0058*IT_0166 + -IT_0174*IT_0202 + IT_0194*IT_0218 + IT_0163*IT_0225 +
       IT_0134*IT_0236 + IT_0183*IT_0237 + IT_0240*IT_0241);
