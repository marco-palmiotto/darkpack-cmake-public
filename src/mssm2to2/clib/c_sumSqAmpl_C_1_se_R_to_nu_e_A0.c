...
ccomplex_return_t c_sumSqAmpl_C_1_se_R_to_nu_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = IT_0004*(IT_0008 + IT_0011);
    ...
    const ccomplex_t IT_0024 = U_d2*V_Wp1;
    const ccomplex_t IT_0025 = IT_0009*IT_0024;
    const ccomplex_t IT_0026 = IT_0004*(IT_0023 + IT_0025);
    const ccomplex_t IT_0027 = 1.4142135623731*e_em*IT_0026;
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = IT_0021*IT_0028;
    const ccomplex_t IT_0030 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0036 = s_14*s_34;
    const ccomplex_t IT_0037 = m_e*e_em*mu_h*IT_0000*IT_0004;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0004;
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = pow(m_C_1, 2);
    const ccomplex_t IT_0042 = cpow(s_13 + (-0.5)*IT_0041 + 0.5*m_se_L*(m_se_L
    ...
    const ccomplex_t IT_0049 = IT_0004*(IT_0046 + IT_0048);
    ...
    const ccomplex_t IT_0054 = IT_0017*IT_0052*IT_0053;
    ...
    const ccomplex_t IT_0059 = IT_0004*(IT_0056 + IT_0058);
    ...
    const ccomplex_t IT_0064 = IT_0030*IT_0062*IT_0063;
    const ccomplex_t IT_0065 = m_C_1*IT_0019;
    const ccomplex_t IT_0066 = m_C_1*IT_0032;
    const ccomplex_t IT_0067 = 0.5*IT_0044 + (-0.5)*IT_0054 + (-0.5)*IT_0064 +
       (-0.5)*IT_0065 + (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = s_34*m_C_1;
    const ccomplex_t IT_0069 = 2*IT_0068;
    return create_ccomplex_return(2*IT_0067*(s_13*conj(IT_0067) + 0.5*conj
      (IT_0033)*IT_0069) + (-2)*IT_0033*(conj(IT_0033)*(IT_0035 + (-2)*IT_0036) 
      + (-0.5)*conj(IT_0067)*IT_0069));
}
