...
ccomplex_return_t c_sumSqAmpl_C_1_smu_L_to_mu_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*(IT_0106 + IT_0109);
    ...
    const ccomplex_t IT_0114 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0115 = IT_0004*IT_0114;
    const ccomplex_t IT_0116 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0125 = N_W2*e_em*conj(U_Wm1);
    const ccomplex_t IT_0126 = IT_0004*IT_0125;
    const ccomplex_t IT_0127 = N_d2*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0143 = IT_0100*IT_0142;
    const ccomplex_t IT_0144 = IT_0043*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*IT_0144;
    const ccomplex_t IT_0146 = m_C_1*IT_0145;
    const ccomplex_t IT_0147 = N_W4*e_em*conj(U_Wm1);
    const ccomplex_t IT_0148 = IT_0004*IT_0147;
    const ccomplex_t IT_0149 = N_d4*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0158 = -IT_0080 + -IT_0091 + -IT_0102 + -IT_0113 +
       IT_0124 + IT_0135 + IT_0146 + IT_0157;
    const ccomplex_t IT_0159 = s_34*IT_0061;
    const ccomplex_t IT_0160 = IT_0060*IT_0159;
    const ccomplex_t IT_0161 = (-0.25)*IT_0160;
    const ccomplex_t IT_0162 = s_34 + IT_0161;
    const ccomplex_t IT_0163 = m_C_1*IT_0162;
    const ccomplex_t IT_0164 = (-4)*IT_0163;
    const ccomplex_t IT_0165 = IT_0006*IT_0120;
    const ccomplex_t IT_0166 = IT_0017*IT_0068*IT_0165;
    const ccomplex_t IT_0167 = IT_0021*IT_0131;
    const ccomplex_t IT_0168 = IT_0030*IT_0081*IT_0167;
    const ccomplex_t IT_0169 = IT_0034*IT_0142;
    const ccomplex_t IT_0170 = IT_0043*IT_0092*IT_0169;
    const ccomplex_t IT_0171 = IT_0047*IT_0153;
    const ccomplex_t IT_0172 = IT_0056*IT_0103*IT_0171;
    const ccomplex_t IT_0173 = m_C_1*IT_0019;
    const ccomplex_t IT_0174 = m_C_1*IT_0032;
    const ccomplex_t IT_0175 = m_C_1*IT_0045;
    const ccomplex_t IT_0176 = m_C_1*IT_0058;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004;
    const ccomplex_t IT_0178 = 0.5*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0004;
    const ccomplex_t IT_0180 = IT_0178*IT_0179;
    const ccomplex_t IT_0181 = pow(m_C_1, 2);
    const ccomplex_t IT_0182 = cpow(s_12 + 0.5*IT_0016 + 0.5*IT_0181 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0183 = IT_0180*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*IT_0183;
    const ccomplex_t IT_0185 = m_mu*IT_0184;
    const ccomplex_t IT_0186 = IT_0166 + IT_0168 + IT_0170 + IT_0172 + 
      -IT_0173 + -IT_0174 + -IT_0175 + -IT_0176 + 0.5*IT_0185;
    const ccomplex_t IT_0187 = m_mu*m_C_1;
    const ccomplex_t IT_0188 = IT_0061*IT_0187;
    const ccomplex_t IT_0189 = 3*IT_0188;
    const ccomplex_t IT_0190 = (-0.5)*IT_0184;
    const ccomplex_t IT_0191 = (-3)*IT_0188;
    const ccomplex_t IT_0192 = IT_0123 + IT_0134 + IT_0145 + IT_0156;
    const ccomplex_t IT_0193 = 2*IT_0019 + 2*IT_0032 + 2*IT_0045 + 2*IT_0058;
    const ccomplex_t IT_0194 = s_13*s_14;
    const ccomplex_t IT_0195 = s_34*IT_0181;
    const ccomplex_t IT_0196 = -IT_0195;
    const ccomplex_t IT_0197 = IT_0194 + IT_0196;
    const ccomplex_t IT_0198 = s_13*IT_0061;
    const ccomplex_t IT_0199 = pow(m_W, 4);
    const ccomplex_t IT_0200 = s_13*IT_0199;
    const ccomplex_t IT_0201 = IT_0060*IT_0200;
    const ccomplex_t IT_0202 = (-0.5)*IT_0201;
    const ccomplex_t IT_0203 = s_14*s_34;
    const ccomplex_t IT_0204 = (-2)*IT_0203;
    const ccomplex_t IT_0205 = IT_0198 + IT_0202 + IT_0204;
    const ccomplex_t IT_0206 = (-4)*IT_0205;
    const ccomplex_t IT_0207 = -IT_0184;
    const ccomplex_t IT_0208 = pow(s_34, 2);
    const ccomplex_t IT_0209 = IT_0060*IT_0208;
    const ccomplex_t IT_0210 = -IT_0209;
    const ccomplex_t IT_0211 = IT_0015 + IT_0210;
    const ccomplex_t IT_0212 = s_13*IT_0211;
    const ccomplex_t IT_0213 = s_14*IT_0015;
    const ccomplex_t IT_0214 = s_13*s_34;
    const ccomplex_t IT_0215 = -IT_0214;
    const ccomplex_t IT_0216 = IT_0213 + IT_0215;
    const ccomplex_t IT_0217 = (-2)*IT_0216;
    const ccomplex_t IT_0218 = s_14*s_34*IT_0060;
    ...
    const ccomplex_t IT_0223 = m_C_1*IT_0211;
    const ccomplex_t IT_0224 = (-2)*IT_0223;
    const ccomplex_t IT_0225 = (-2)*IT_0123 + (-2)*IT_0134 + (-2)*IT_0145 + (
      -2)*IT_0156;
    const ccomplex_t IT_0226 = s_13*IT_0220;
    const ccomplex_t IT_0227 = (-2)*IT_0226;
    const ccomplex_t IT_0228 = m_mu*IT_0220;
    const ccomplex_t IT_0229 = (-2)*IT_0228;
    const ccomplex_t IT_0230 = -IT_0192;
    const ccomplex_t IT_0231 = (-2)*conj(IT_0207)*(IT_0207*IT_0212 + (-0.5)
      *IT_0190*IT_0217 + (-0.5)*IT_0193*IT_0222 + (-0.5)*IT_0158*IT_0224 + (-0.5
      )*IT_0225*IT_0227 + (-0.5)*IT_0186*IT_0229 + IT_0216*IT_0230);
    const ccomplex_t IT_0232 = pow(s_14, 2);
    const ccomplex_t IT_0233 = IT_0060*IT_0232;
    const ccomplex_t IT_0234 = -IT_0181;
    const ccomplex_t IT_0235 = IT_0233 + IT_0234;
    const ccomplex_t IT_0236 = IT_0187*IT_0235;
    const ccomplex_t IT_0237 = s_13*IT_0235;
    const ccomplex_t IT_0238 = m_C_1*IT_0220;
    const ccomplex_t IT_0239 = (-2)*IT_0238;
    const ccomplex_t IT_0240 = 0.5*IT_0158;
    const ccomplex_t IT_0241 = 0.5*IT_0207;
    const ccomplex_t IT_0242 = m_mu*IT_0235;
    const ccomplex_t IT_0243 = 2*IT_0242;
    const ccomplex_t IT_0244 = 0.5*IT_0186;
    const ccomplex_t IT_0245 = (-0.25)*IT_0063;
    const ccomplex_t IT_0246 = s_14 + IT_0245;
    const ccomplex_t IT_0247 = m_mu*IT_0246;
    const ccomplex_t IT_0248 = (-4)*IT_0247;
    const ccomplex_t IT_0249 = (-6)*IT_0187;
    const ccomplex_t IT_0250 = 0.5*IT_0225;
    const ccomplex_t IT_0251 = IT_0198 + IT_0204;
    ...
    const ccomplex_t IT_0256 = 0.5*IT_0160;
    const ccomplex_t IT_0257 = s_34 + IT_0256;
    const ccomplex_t IT_0258 = m_C_1*IT_0257;
    const ccomplex_t IT_0259 = 2*IT_0258;
    const ccomplex_t IT_0260 = 0.5*IT_0190;
    const ccomplex_t IT_0261 = (-0.25)*IT_0201;
    const ccomplex_t IT_0262 = IT_0203 + IT_0261;
    const ccomplex_t IT_0263 = (-8)*IT_0262;
    const ccomplex_t IT_0264 = 0.5*IT_0192;
    const ccomplex_t IT_0265 = 2*conj(IT_0059)*(IT_0067*IT_0158 + IT_0164
      *IT_0186 + IT_0189*IT_0190 + IT_0191*IT_0192 + IT_0193*IT_0197 + 0.5
      *IT_0059*IT_0206) + IT_0231 + 2*conj(IT_0193)*(IT_0059*IT_0197 + IT_0225
      *IT_0236 + IT_0193*IT_0237 + IT_0222*IT_0241 + IT_0240*IT_0243 + IT_0239
      *IT_0244) + (-2)*conj(IT_0225)*(IT_0197*(IT_0190 + IT_0230) + -IT_0193
      *IT_0236 + -IT_0225*IT_0237 + -IT_0239*IT_0240 + -IT_0227*IT_0241 + 
      -IT_0243*IT_0244) + 2*conj(IT_0186)*(IT_0059*IT_0164 + IT_0067*IT_0192 +
       0.5*IT_0193*IT_0239 + IT_0229*IT_0241 + IT_0190*IT_0248 + IT_0240*IT_0249
       + IT_0243*IT_0250 + IT_0244*IT_0255) + 2*conj(IT_0158)*(IT_0059*IT_0067 +
       IT_0164*IT_0192 + IT_0224*IT_0241 + 0.5*IT_0193*IT_0243 + IT_0244*IT_0249
       + IT_0239*IT_0250 + IT_0240*IT_0255 + IT_0190*IT_0259) + 2*conj(IT_0192)*
      (IT_0158*IT_0164 + IT_0067*IT_0186 + IT_0059*IT_0191 + IT_0207*IT_0216 +
       IT_0197*IT_0225 + IT_0260*IT_0263 + IT_0206*IT_0264) + 2*conj(IT_0190)*
      (IT_0059*IT_0189 + -IT_0197*IT_0225 + IT_0217*IT_0241 + IT_0186*IT_0248 +
       IT_0158*IT_0259 + IT_0206*IT_0260 + IT_0263*IT_0264);
    return create_ccomplex_return(IT_0265);
}
