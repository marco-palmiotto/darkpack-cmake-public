...
ccomplex_return_t c_sumSqAmpl_C_1_smu_L_to_nu_mu_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = e_em*m_mu*mu_h*IT_0001*IT_0033;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = cpow(IT_0003, -1);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0001*IT_0033*IT_0036;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = IT_0035*IT_0038;
    const ccomplex_t IT_0040 = pow(m_C_1, 2);
    const ccomplex_t IT_0041 = cpow(s_13 + (-0.5)*IT_0040 + 0.5*m_smu_R*
