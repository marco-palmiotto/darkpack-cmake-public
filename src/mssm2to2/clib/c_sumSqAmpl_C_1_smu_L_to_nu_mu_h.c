...
ccomplex_return_t c_sumSqAmpl_C_1_smu_L_to_nu_mu_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0066 = IT_0015*IT_0064*IT_0065;
    const ccomplex_t IT_0067 = conj(V_u2)*conj(U_Wm1);
    const ccomplex_t IT_0068 = IT_0003*IT_0067;
    const ccomplex_t IT_0069 = conj(U_d1)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0077 = IT_0028*IT_0075*IT_0076;
    const ccomplex_t IT_0078 = m_C_1*IT_0017;
    const ccomplex_t IT_0079 = m_C_1*IT_0030;
    const ccomplex_t IT_0080 = 0.5*IT_0046 + 0.5*IT_0055 + (-0.5)*IT_0066 + (
      -0.5)*IT_0077 + (-0.5)*IT_0078 + (-0.5)*IT_0079;
    const ccomplex_t IT_0081 = s_34*m_C_1;
    const ccomplex_t IT_0082 = 2*IT_0081;
    return create_ccomplex_return(2*IT_0080*(s_13*conj(IT_0080) + 0.5*conj
      (IT_0031)*IT_0082) + (-2)*IT_0031*(conj(IT_0031)*(IT_0033 + (-2)*IT_0034) 
      + (-0.5)*conj(IT_0080)*IT_0082));
}
