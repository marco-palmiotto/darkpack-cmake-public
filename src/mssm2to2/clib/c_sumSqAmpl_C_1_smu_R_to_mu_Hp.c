...
ccomplex_return_t c_sumSqAmpl_C_1_smu_R_to_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_u1*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = N_B2*V_u1*e_em;
    const ccomplex_t IT_0034 = IT_0013*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = N_W2*V_u1*e_em;
    ...
    const ccomplex_t IT_0040 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = N_u3*e_em*V_Wp1;
    const ccomplex_t IT_0052 = IT_0007*IT_0051;
    const ccomplex_t IT_0053 = 2*IT_0052;
    const ccomplex_t IT_0054 = N_B3*V_u1*e_em;
    const ccomplex_t IT_0055 = IT_0013*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = N_W3*V_u1*e_em;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = N_u4*e_em*V_Wp1;
    const ccomplex_t IT_0071 = IT_0007*IT_0070;
    const ccomplex_t IT_0072 = 2*IT_0071;
    const ccomplex_t IT_0073 = N_B4*V_u1*e_em;
    const ccomplex_t IT_0074 = IT_0013*IT_0073;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = N_W4*V_u1*e_em;
    ...
    const ccomplex_t IT_0088 = m_mu*m_C_1*IT_0026;
    const ccomplex_t IT_0089 = sin(beta);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0000*IT_0002*IT_0004*IT_0089;
    const ccomplex_t IT_0091 = 0.5*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0093 = (-0.5)*IT_0092;
    const ccomplex_t IT_0094 = IT_0091*IT_0093;
    const ccomplex_t IT_0095 = pow(m_C_1, 2);
    const ccomplex_t IT_0096 = cpow(s_12 + 0.5*IT_0026 + 0.5*IT_0095 + 0.5
      *reg_prop, -1);
    ...
    const ccomplex_t IT_0101 = IT_0012*IT_0089;
    const ccomplex_t IT_0102 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0103 = IT_0101*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = IT_0004*IT_0089;
    const ccomplex_t IT_0106 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0110 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0139 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0140 = IT_0105*IT_0139;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0146 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0147 = IT_0105*IT_0146;
    ...
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0012;
    const ccomplex_t IT_0156 = -IT_0155;
    const ccomplex_t IT_0157 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0158 = IT_0105*IT_0157;
    const ccomplex_t IT_0159 = (-2)*IT_0158;
    const ccomplex_t IT_0160 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0161 = IT_0101*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = conj(N_W4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0164 = IT_0105*IT_0163;
    ...
    const ccomplex_t IT_0171 = IT_0084*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*IT_0171;
    const ccomplex_t IT_0173 = (-0.5)*IT_0098 + -IT_0118 + -IT_0136 + -IT_0154
       + -IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0175 = IT_0023*IT_0100;
    const ccomplex_t IT_0176 = IT_0027*IT_0174*IT_0175;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0178 = IT_0045*IT_0120;
    const ccomplex_t IT_0179 = IT_0030*IT_0177*IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0181 = IT_0063*IT_0138;
    const ccomplex_t IT_0182 = IT_0065*IT_0180*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0184 = IT_0082*IT_0156;
    const ccomplex_t IT_0185 = IT_0084*IT_0183*IT_0184;
    const ccomplex_t IT_0186 = m_mu*IT_0029;
    const ccomplex_t IT_0187 = m_mu*IT_0048;
    const ccomplex_t IT_0188 = m_mu*IT_0067;
    const ccomplex_t IT_0189 = m_mu*IT_0086;
    const ccomplex_t IT_0190 = m_C_1*IT_0098;
    const ccomplex_t IT_0191 = -IT_0176 + -IT_0179 + -IT_0182 + -IT_0185 +
       IT_0186 + IT_0187 + IT_0188 + IT_0189 + (-0.5)*IT_0190;
    const ccomplex_t IT_0192 = m_mu*s_12;
    const ccomplex_t IT_0193 = 2*IT_0192;
    const ccomplex_t IT_0194 = s_23*m_C_1;
    const ccomplex_t IT_0195 = 2*IT_0194;
    const ccomplex_t IT_0196 = IT_0006*IT_0115;
    const ccomplex_t IT_0197 = IT_0027*IT_0174*IT_0196;
    const ccomplex_t IT_0198 = IT_0032*IT_0133;
    const ccomplex_t IT_0199 = IT_0030*IT_0177*IT_0198;
    const ccomplex_t IT_0200 = IT_0050*IT_0151;
    const ccomplex_t IT_0201 = IT_0065*IT_0180*IT_0200;
    const ccomplex_t IT_0202 = m_mu*IT_0118;
    const ccomplex_t IT_0203 = m_mu*IT_0136;
    const ccomplex_t IT_0204 = m_mu*IT_0154;
    const ccomplex_t IT_0205 = m_mu*IT_0172;
    const ccomplex_t IT_0206 = IT_0069*IT_0169;
    const ccomplex_t IT_0207 = IT_0084*IT_0183*IT_0206;
    const ccomplex_t IT_0208 = -IT_0197 + -IT_0199 + -IT_0201 + IT_0202 +
       IT_0203 + IT_0204 + IT_0205 + -IT_0207;
    const ccomplex_t IT_0209 = 0.5*conj(IT_0208);
    const ccomplex_t IT_0210 = s_12*s_23;
    const ccomplex_t IT_0211 = s_13*IT_0026;
    const ccomplex_t IT_0212 = (-0.5)*IT_0211;
    const ccomplex_t IT_0213 = IT_0210 + IT_0212;
    const ccomplex_t IT_0214 = 4*IT_0213;
    const ccomplex_t IT_0215 = 0.5*conj(IT_0087);
    const ccomplex_t IT_0216 = m_mu*m_C_1;
    const ccomplex_t IT_0217 = 2*IT_0216;
    const ccomplex_t IT_0218 = 0.5*conj(IT_0173);
    const ccomplex_t IT_0219 = 2*IT_0087*(IT_0088*conj(IT_0173) + 0.5*conj
      (IT_0191)*IT_0193 + IT_0195*IT_0209 + IT_0214*IT_0215) + 2*IT_0208*(s_13
      *conj(IT_0208) + IT_0195*IT_0215 + 0.5*conj(IT_0191)*IT_0217 + IT_0193
      *IT_0218) + 2*IT_0191*(s_13*conj(IT_0191) + IT_0193*IT_0215 + IT_0209
      *IT_0217 + IT_0195*IT_0218) + 2*IT_0173*(conj(IT_0087)*IT_0088 + 0.5*conj
      (IT_0191)*IT_0195 + IT_0193*IT_0209 + IT_0214*IT_0218);
