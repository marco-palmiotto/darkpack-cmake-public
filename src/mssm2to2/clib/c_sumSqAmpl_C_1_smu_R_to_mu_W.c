...
ccomplex_return_t c_sumSqAmpl_C_1_smu_R_to_mu_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0133 = m_mu*m_C_1;
    ...
    const ccomplex_t IT_0160 = m_mu*IT_0078;
    ...
    const ccomplex_t IT_0205 = m_mu*IT_0204;
    ...
    const ccomplex_t IT_0229 = m_mu*IT_0228;
    const ccomplex_t IT_0230 = (-4)*IT_0229;
    const ccomplex_t IT_0231 = 2*IT_0230;
    const ccomplex_t IT_0232 = m_mu*IT_0218;
