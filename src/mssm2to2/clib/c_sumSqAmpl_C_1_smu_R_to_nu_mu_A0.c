...
ccomplex_return_t c_sumSqAmpl_C_1_smu_R_to_nu_mu_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = e_em*m_mu*mu_h*IT_0000*IT_0004;
    ...
    const ccomplex_t IT_0042 = cpow(s_13 + (-0.5)*IT_0041 + 0.5*m_smu_L*
