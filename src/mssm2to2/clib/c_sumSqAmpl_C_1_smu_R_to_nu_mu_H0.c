...
ccomplex_return_t c_sumSqAmpl_C_1_smu_R_to_nu_mu_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = pow(m_smu_R, 2);
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0023 = (-0.5)*IT_0022;
    const ccomplex_t IT_0024 = U_d2*V_Wp1;
    const ccomplex_t IT_0025 = IT_0007*IT_0024;
    const ccomplex_t IT_0026 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0000
    ...
    const ccomplex_t IT_0045 = cpow(s_13 + (-0.5)*IT_0044 + 0.5*m_smu_L*
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*e_em*(m_W*IT_0003*IT_0049*
      (IT_0001*IT_0007 + -IT_0010*IT_0050) + -IT_0000*IT_0002*IT_0004*IT_0007
      *IT_0051);
    const ccomplex_t IT_0053 = IT_0006*IT_0052;
    const ccomplex_t IT_0054 = cpow(s_13 + (-0.5)*IT_0044 + 0.5*m_smu_R*
    ...
    const ccomplex_t IT_0061 = IT_0004*(IT_0058 + IT_0060);
    ...
    const ccomplex_t IT_0067 = IT_0019*IT_0065*IT_0066;
    ...
    const ccomplex_t IT_0072 = IT_0004*(IT_0069 + IT_0071);
    ...
    const ccomplex_t IT_0078 = IT_0033*IT_0076*IT_0077;
    const ccomplex_t IT_0079 = m_C_1*IT_0021;
    const ccomplex_t IT_0080 = m_C_1*IT_0035;
    const ccomplex_t IT_0081 = 0.5*IT_0047 + 0.5*IT_0056 + (-0.5)*IT_0067 + (
    ...
    return create_ccomplex_return(2*IT_0081*(s_13*conj(IT_0081) + 0.5*conj
      (IT_0036)*IT_0083) + (-2)*IT_0036*(conj(IT_0036)*(IT_0038 + (-2)*IT_0039) 
