...
ccomplex_return_t c_sumSqAmpl_C_1_snu_e_to_nu_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0120 = cpow(s_13 + (-0.5)*IT_0119 + 0.5*m_se_L*(m_se_L
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0006*IT_0111;
    const ccomplex_t IT_0124 = 0.5*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0006*IT_0111*IT_0113;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = IT_0124*IT_0126;
    const ccomplex_t IT_0128 = cpow(s_13 + (-0.5)*IT_0119 + 0.5*m_se_R*(m_se_R
