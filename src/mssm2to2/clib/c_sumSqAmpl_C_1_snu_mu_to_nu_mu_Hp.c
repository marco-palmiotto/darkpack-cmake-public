...
ccomplex_return_t c_sumSqAmpl_C_1_snu_mu_to_nu_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0112 = pow(m_mu, 2);
    const ccomplex_t IT_0113 = cpow(IT_0012, -1);
    const ccomplex_t IT_0114 = sin(beta);
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0006*
      (m_W*IT_0012 + (-0.5)*IT_0111*IT_0112*IT_0113)*IT_0114;
    const ccomplex_t IT_0116 = -IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0006;
    const ccomplex_t IT_0118 = IT_0116*IT_0117;
    const ccomplex_t IT_0119 = pow(m_C_1, 2);
    const ccomplex_t IT_0120 = cpow(s_13 + (-0.5)*IT_0119 + 0.5*m_smu_L*
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0006*IT_0111;
    const ccomplex_t IT_0124 = 0.5*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0006*IT_0111*IT_0113;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = IT_0124*IT_0126;
    const ccomplex_t IT_0128 = cpow(s_13 + (-0.5)*IT_0119 + 0.5*m_smu_R*
    ...
    const ccomplex_t IT_0132 = IT_0001*IT_0114;
    const ccomplex_t IT_0133 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0134 = IT_0132*IT_0133;
    const ccomplex_t IT_0135 = 1.4142135623731*IT_0134;
    const ccomplex_t IT_0136 = IT_0006*IT_0114;
    const ccomplex_t IT_0137 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0141 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0148 = IT_0030*IT_0131*IT_0147;
    const ccomplex_t IT_0149 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0150 = IT_0136*IT_0149;
    const ccomplex_t IT_0151 = (-2)*IT_0150;
    const ccomplex_t IT_0152 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0153 = IT_0132*IT_0152;
    const ccomplex_t IT_0154 = 1.4142135623731*IT_0153;
    const ccomplex_t IT_0155 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0164 = IT_0033*IT_0162*IT_0163;
    const ccomplex_t IT_0165 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0166 = IT_0136*IT_0165;
    const ccomplex_t IT_0167 = 1.4142135623731*IT_0166;
    const ccomplex_t IT_0168 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0172 = conj(N_d3)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0178 = IT_0065*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0180 = IT_0080*IT_0178*IT_0179;
    const ccomplex_t IT_0181 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0182 = IT_0136*IT_0181;
    const ccomplex_t IT_0183 = (-2)*IT_0182;
    const ccomplex_t IT_0184 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0185 = IT_0132*IT_0184;
    const ccomplex_t IT_0186 = 1.4142135623731*IT_0185;
    const ccomplex_t IT_0187 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0196 = IT_0105*IT_0194*IT_0195;
    const ccomplex_t IT_0197 = 0.5*IT_0122 + 0.5*IT_0130 + 0.5*IT_0148 + 0.5
      *IT_0164 + 0.5*IT_0180 + 0.5*IT_0196;
    const ccomplex_t IT_0198 = s_23*m_C_1;
    const ccomplex_t IT_0199 = 2*IT_0198;
    return create_ccomplex_return(2*IT_0197*(s_13*conj(IT_0197) + 0.5*conj
      (IT_0108)*IT_0199) + 4*IT_0108*(conj(IT_0108)*(IT_0109 + (-0.5)*IT_0110) +
       0.25*conj(IT_0197)*IT_0199));
}
