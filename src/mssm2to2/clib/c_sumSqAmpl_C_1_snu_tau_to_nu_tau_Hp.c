...
ccomplex_return_t c_sumSqAmpl_C_1_snu_tau_to_nu_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0033 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0049 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0080 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0105 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = 0.5*IT_0032 + 0.5*IT_0057 + 0.5*IT_0082 + 0.5
      *IT_0107;
    const ccomplex_t IT_0109 = s_12*s_23;
    const ccomplex_t IT_0110 = s_13*IT_0029;
    const ccomplex_t IT_0111 = sin(beta);
    const ccomplex_t IT_0112 = IT_0006*IT_0111;
    const ccomplex_t IT_0113 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0114 = IT_0112*IT_0113;
    const ccomplex_t IT_0115 = (-2)*IT_0114;
    const ccomplex_t IT_0116 = IT_0001*IT_0111;
    const ccomplex_t IT_0117 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0118 = IT_0116*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0129 = IT_0105*IT_0127*IT_0128;
    const ccomplex_t IT_0130 = pow(m_W, -1);
    const ccomplex_t IT_0131 = cpow(IT_0012, -1);
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*(A_tau*IT_0111*conj
      (U_stau_10) + (-1.4142135623731)*e_em*IT_0006*(m_W*IT_0012*IT_0111*conj
      (U_stau_00) + (-0.5)*m_tau*IT_0130*(m_tau*IT_0111*IT_0131*conj(U_stau_00) 
      + mu_h*conj(U_stau_10))));
    const ccomplex_t IT_0133 = e_em*conj(U_Wm1)*U_stau_00;
    const ccomplex_t IT_0134 = IT_0006*IT_0133;
    const ccomplex_t IT_0135 = IT_0006*IT_0131;
    const ccomplex_t IT_0136 = conj(U_d1)*e_em*m_tau*IT_0130*U_stau_10;
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*(A_tau*IT_0111*conj
      (U_stau_11) + (-1.4142135623731)*e_em*IT_0006*(m_W*IT_0012*IT_0111*conj
      (U_stau_01) + (-0.5)*m_tau*IT_0130*(m_tau*IT_0111*IT_0131*conj(U_stau_01) 
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0146 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0147 = IT_0006*IT_0146;
    const ccomplex_t IT_0148 = conj(U_d1)*e_em*m_tau*IT_0130*U_stau_11;
    ...
    const ccomplex_t IT_0152 = IT_0145*IT_0151;
    const ccomplex_t IT_0153 = cpow(s_13 + (-0.5)*IT_0141 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0157 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0158 = IT_0116*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0164 = conj(N_d1)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0165 = IT_0112*IT_0164;
    ...
    const ccomplex_t IT_0171 = IT_0030*IT_0156*IT_0170;
    const ccomplex_t IT_0172 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0173 = IT_0112*IT_0172;
    const ccomplex_t IT_0174 = (-2)*IT_0173;
    const ccomplex_t IT_0175 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0176 = IT_0116*IT_0175;
    const ccomplex_t IT_0177 = 1.4142135623731*IT_0176;
    const ccomplex_t IT_0178 = conj(N_W2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0179 = IT_0112*IT_0178;
    ...
    const ccomplex_t IT_0185 = IT_0041*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0187 = IT_0033*IT_0185*IT_0186;
    const ccomplex_t IT_0188 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0189 = IT_0112*IT_0188;
    const ccomplex_t IT_0190 = 1.4142135623731*IT_0189;
    const ccomplex_t IT_0191 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0192 = IT_0116*IT_0191;
    const ccomplex_t IT_0193 = 1.4142135623731*IT_0192;
    const ccomplex_t IT_0194 = IT_0190 + IT_0193;
    const ccomplex_t IT_0195 = conj(N_d3)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0203 = IT_0080*IT_0201*IT_0202;
    const ccomplex_t IT_0204 = 0.5*IT_0129 + 0.5*IT_0144 + 0.5*IT_0155 + 0.5
      *IT_0171 + 0.5*IT_0187 + 0.5*IT_0203;
    const ccomplex_t IT_0205 = s_23*m_C_1;
    const ccomplex_t IT_0206 = 2*IT_0205;
    return create_ccomplex_return(2*IT_0204*(s_13*conj(IT_0204) + 0.5*conj
      (IT_0108)*IT_0206) + 4*IT_0108*(conj(IT_0108)*(IT_0109 + (-0.5)*IT_0110) +
       0.25*conj(IT_0204)*IT_0206));
}
