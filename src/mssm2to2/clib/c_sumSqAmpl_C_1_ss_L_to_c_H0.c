...
ccomplex_return_t c_sumSqAmpl_C_1_ss_L_to_c_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0008;
    const ccomplex_t IT_0019 = cos(alpha);
    const ccomplex_t IT_0020 = U_d1*V_Wp1;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = V_u1*U_Wm1;
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0008;
    const ccomplex_t IT_0033 = U_d2*V_Wp1;
    const ccomplex_t IT_0034 = IT_0019*IT_0033;
    const ccomplex_t IT_0035 = V_u1*U_Wm2;
    const ccomplex_t IT_0036 = IT_0011*IT_0035;
    const ccomplex_t IT_0037 = IT_0008*(IT_0034 + IT_0036);
    ...
    const ccomplex_t IT_0046 = m_c*m_C_1*IT_0045;
    const ccomplex_t IT_0047 = IT_0013*IT_0018;
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = conj(U_d1)*conj(V_Wp2);
    const ccomplex_t IT_0064 = IT_0019*IT_0063;
    const ccomplex_t IT_0065 = conj(V_u2)*conj(U_Wm1);
    ...
    const ccomplex_t IT_0081 = m_c*s_14;
    const ccomplex_t IT_0082 = 6*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0084 = IT_0040*IT_0062;
    const ccomplex_t IT_0085 = IT_0031*IT_0083*IT_0084;
    const ccomplex_t IT_0086 = m_c*IT_0016;
    const ccomplex_t IT_0087 = pow(m_s, 2);
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*e_em*(IT_0004*IT_0008
      *IT_0019*IT_0087*IT_0089 + 0.5*m_W*(IT_0005*IT_0011 + -IT_0019*IT_0088)*
      (IT_0008 + 1./3*IT_0007*IT_0091));
    const ccomplex_t IT_0093 = -IT_0092;
    const ccomplex_t IT_0094 = IT_0010*IT_0093;
    const ccomplex_t IT_0095 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0099 = IT_0010*IT_0027;
    const ccomplex_t IT_0100 = IT_0017*IT_0098*IT_0099;
    ...
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0019*conj(U_sb_10);
    const ccomplex_t IT_0105 = (-0.5)*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u1
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0019*conj(U_sb_11);
    const ccomplex_t IT_0113 = (-0.5)*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u1
    ...
    const ccomplex_t IT_0119 = -IT_0085 + (-2)*IT_0086 + IT_0097 + -IT_0100 + 
      -IT_0101 + -IT_0102 + IT_0110 + IT_0118;
    const ccomplex_t IT_0120 = 0.166666666666667*conj(IT_0119);
    const ccomplex_t IT_0121 = s_34*m_C_1;
    const ccomplex_t IT_0122 = 6*IT_0121;
    const ccomplex_t IT_0123 = IT_0008*IT_0089;
    const ccomplex_t IT_0124 = m_b*conj(U_d1)*V_cb*e_em*IT_0004*U_sb_10;
    ...
    const ccomplex_t IT_0131 = IT_0105*IT_0130;
    const ccomplex_t IT_0132 = IT_0103*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*IT_0132;
    const ccomplex_t IT_0134 = m_c*IT_0049;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0019;
    const ccomplex_t IT_0136 = (-0.5)*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_cd*e_em*IT_0004*IT_0008*IT_0089;
    const ccomplex_t IT_0138 = (-0.5)*IT_0137;
    const ccomplex_t IT_0139 = IT_0136*IT_0138;
    const ccomplex_t IT_0140 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0141 = IT_0139*IT_0140;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0019 + -m_s*e_em*mu_h*IT_0004*IT_0008*IT_0011*IT_0089);
    const ccomplex_t IT_0144 = (-0.5)*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0004*IT_0008*IT_0089;
    const ccomplex_t IT_0146 = (-0.5)*IT_0145;
    const ccomplex_t IT_0147 = IT_0144*IT_0146;
    const ccomplex_t IT_0148 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0149 = IT_0147*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*IT_0149;
    const ccomplex_t IT_0151 = IT_0018*IT_0093;
    const ccomplex_t IT_0152 = IT_0095*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*IT_0152;
    const ccomplex_t IT_0154 = IT_0032*IT_0070;
    const ccomplex_t IT_0155 = IT_0031*IT_0083*IT_0154;
    const ccomplex_t IT_0156 = m_C_1*IT_0030;
    const ccomplex_t IT_0157 = V_cb*e_em*conj(U_Wm1)*U_sb_01;
    const ccomplex_t IT_0158 = IT_0008*IT_0157;
    const ccomplex_t IT_0159 = m_b*conj(U_d1)*V_cb*e_em*IT_0004*U_sb_11;
    ...
    const ccomplex_t IT_0163 = IT_0113*IT_0162;
    const ccomplex_t IT_0164 = IT_0111*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*IT_0164;
    const ccomplex_t IT_0166 = IT_0018*IT_0057;
    const ccomplex_t IT_0167 = IT_0017*IT_0098*IT_0166;
    const ccomplex_t IT_0168 = m_C_1*IT_0043;
    const ccomplex_t IT_0169 = -IT_0133 + 2*IT_0134 + -IT_0142 + -IT_0150 + 
      -IT_0153 + IT_0155 + IT_0156 + -IT_0165 + IT_0167 + IT_0168;
    const ccomplex_t IT_0170 = 0.166666666666667*conj(IT_0169);
    const ccomplex_t IT_0171 = m_c*m_C_1;
    const ccomplex_t IT_0172 = 6*IT_0171;
    const ccomplex_t IT_0173 = 0.166666666666667*conj(IT_0074);
    const ccomplex_t IT_0174 = 6*IT_0044*(IT_0046*conj(IT_0074) + IT_0079
      *IT_0080 + IT_0082*IT_0120 + IT_0122*IT_0170) + 6*IT_0074*(conj(IT_0044)
      *IT_0046 + IT_0120*IT_0122 + IT_0082*IT_0170 + IT_0079*IT_0173) + 6
      *IT_0169*(IT_0080*IT_0122 + s_13*conj(IT_0169) + IT_0120*IT_0172 + IT_0082
      *IT_0173) + 6*IT_0119*(IT_0080*IT_0082 + s_13*conj(IT_0119) + IT_0170
      *IT_0172 + IT_0122*IT_0173);
