...
ccomplex_return_t c_sumSqAmpl_C_1_ss_L_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_u1*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0013 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0014 = IT_0012*IT_0013;
    const ccomplex_t IT_0015 = 1.4142135623731*IT_0014;
    const ccomplex_t IT_0016 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0035 = conj(N_B2)*e_em;
    const ccomplex_t IT_0036 = IT_0011*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_12 + -IT_0001 + IT_0109 + -IT_0110 
      + -reg_prop, -1);
    const ccomplex_t IT_0112 = pow(m_W, -1);
    const ccomplex_t IT_0113 = sin(beta);
    const ccomplex_t IT_0114 = cpow(IT_0113, -1);
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0003*IT_0005*IT_0112*IT_0114;
    const ccomplex_t IT_0116 = 0.5*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0005*IT_0112*IT_0114;
    ...
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u1
      *e_em*IT_0005*IT_0112*IT_0114;
    const ccomplex_t IT_0125 = 0.5*IT_0124;
    const ccomplex_t IT_0126 = IT_0123*IT_0125;
    const ccomplex_t IT_0127 = cpow((-2)*s_12 + -IT_0001 + -IT_0110 + 
    ...
    const ccomplex_t IT_0130 = pow(m_u, 2);
    const ccomplex_t IT_0131 = cpow((-2)*s_12 + -IT_0001 + -IT_0110 + IT_0130 
      + -reg_prop, -1);
    const ccomplex_t IT_0132 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0003*IT_0005*IT_0112*IT_0114;
    const ccomplex_t IT_0133 = 0.5*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_us
      *e_em*IT_0005*IT_0112*IT_0114;
    ...
    const ccomplex_t IT_0139 = -IT_0033 + -IT_0058 + -IT_0083 + -IT_0108 + 
      -IT_0121 + -IT_0129 + -IT_0138;
    const ccomplex_t IT_0140 = m_s*m_C_1*IT_0001;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0142 = cpow(IT_0003, -1);
    const ccomplex_t IT_0143 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0005*IT_0112*IT_0113*IT_0142;
    const ccomplex_t IT_0144 = 0.5*IT_0143;
    const ccomplex_t IT_0145 = IT_0141*IT_0144;
    const ccomplex_t IT_0146 = IT_0111*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_ts)
      *e_em*IT_0005*IT_0112*IT_0113*IT_0142;
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *IT_0005*IT_0112*IT_0113*IT_0142;
    ...
    const ccomplex_t IT_0160 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0005*IT_0112*IT_0142;
    const ccomplex_t IT_0161 = (-0.5)*IT_0160;
    const ccomplex_t IT_0162 = IT_0011*IT_0113;
    const ccomplex_t IT_0163 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0164 = IT_0162*IT_0163;
    const ccomplex_t IT_0165 = 1.4142135623731*IT_0164;
    const ccomplex_t IT_0166 = IT_0005*IT_0113;
    const ccomplex_t IT_0167 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0171 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0005*IT_0112*IT_0142;
    const ccomplex_t IT_0181 = (-0.5)*IT_0180;
    const ccomplex_t IT_0182 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0183 = IT_0166*IT_0182;
    const ccomplex_t IT_0184 = (-2)*IT_0183;
    const ccomplex_t IT_0185 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0186 = IT_0162*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0195 = IT_0181*IT_0194;
    const ccomplex_t IT_0196 = IT_0034*IT_0195;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*IT_0196;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0005*IT_0112*IT_0142;
    ...
    const ccomplex_t IT_0203 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0204 = IT_0162*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = IT_0202 + IT_0205;
    const ccomplex_t IT_0207 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0208 = IT_0166*IT_0207;
    ...
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0005*IT_0112*IT_0142;
    const ccomplex_t IT_0217 = (-0.5)*IT_0216;
    const ccomplex_t IT_0218 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0219 = IT_0166*IT_0218;
    const ccomplex_t IT_0220 = (-2)*IT_0219;
    const ccomplex_t IT_0221 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0222 = IT_0162*IT_0221;
    const ccomplex_t IT_0223 = 1.4142135623731*IT_0222;
    const ccomplex_t IT_0224 = conj(N_W4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0225 = IT_0166*IT_0224;
    ...
    const ccomplex_t IT_0234 = IT_0147 + IT_0153 + IT_0159 + -IT_0179 + 
      -IT_0197 + -IT_0215 + -IT_0233;
    const ccomplex_t IT_0235 = m_s*s_12;
    const ccomplex_t IT_0236 = 6*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0238 = IT_0022*IT_0161;
    const ccomplex_t IT_0239 = IT_0002*IT_0237*IT_0238;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0241 = IT_0055*IT_0181;
    const ccomplex_t IT_0242 = IT_0034*IT_0240*IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0244 = IT_0079*IT_0199;
    const ccomplex_t IT_0245 = IT_0081*IT_0243*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0247 = IT_0104*IT_0217;
    const ccomplex_t IT_0248 = IT_0106*IT_0246*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0250 = IT_0118*IT_0144;
    const ccomplex_t IT_0251 = IT_0111*IT_0249*IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0253 = IT_0125*IT_0150;
    const ccomplex_t IT_0254 = IT_0127*IT_0252*IT_0253;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0256 = IT_0135*IT_0156;
    const ccomplex_t IT_0257 = IT_0131*IT_0255*IT_0256;
    const ccomplex_t IT_0258 = m_s*IT_0033;
    const ccomplex_t IT_0259 = m_s*IT_0058;
    const ccomplex_t IT_0260 = m_s*IT_0083;
    const ccomplex_t IT_0261 = m_s*IT_0108;
    const ccomplex_t IT_0262 = m_C_1*IT_0147;
    const ccomplex_t IT_0263 = m_C_1*IT_0153;
    const ccomplex_t IT_0264 = m_C_1*IT_0159;
    const ccomplex_t IT_0265 = -IT_0239 + -IT_0242 + -IT_0245 + -IT_0248 + 
      -IT_0251 + -IT_0254 + -IT_0257 + IT_0258 + IT_0259 + IT_0260 + IT_0261 +
       IT_0262 + IT_0263 + IT_0264;
    const ccomplex_t IT_0266 = 0.166666666666667*conj(IT_0265);
    const ccomplex_t IT_0267 = s_23*m_C_1;
    const ccomplex_t IT_0268 = 6*IT_0267;
    const ccomplex_t IT_0269 = IT_0116*IT_0141;
    const ccomplex_t IT_0270 = IT_0111*IT_0249*IT_0269;
    const ccomplex_t IT_0271 = IT_0133*IT_0154;
    const ccomplex_t IT_0272 = IT_0131*IT_0255*IT_0271;
    const ccomplex_t IT_0273 = IT_0030*IT_0176;
    const ccomplex_t IT_0274 = IT_0002*IT_0237*IT_0273;
    const ccomplex_t IT_0275 = IT_0042*IT_0194;
    const ccomplex_t IT_0276 = IT_0034*IT_0240*IT_0275;
    const ccomplex_t IT_0277 = IT_0066*IT_0212;
    const ccomplex_t IT_0278 = IT_0081*IT_0243*IT_0277;
    const ccomplex_t IT_0279 = IT_0091*IT_0230;
    const ccomplex_t IT_0280 = IT_0106*IT_0246*IT_0279;
    const ccomplex_t IT_0281 = IT_0123*IT_0148;
    const ccomplex_t IT_0282 = IT_0127*IT_0252*IT_0281;
    const ccomplex_t IT_0283 = m_s*IT_0179;
    const ccomplex_t IT_0284 = m_s*IT_0197;
    const ccomplex_t IT_0285 = m_s*IT_0215;
    const ccomplex_t IT_0286 = m_s*IT_0233;
    const ccomplex_t IT_0287 = m_C_1*IT_0121;
    const ccomplex_t IT_0288 = m_C_1*IT_0129;
    const ccomplex_t IT_0289 = m_C_1*IT_0138;
    const ccomplex_t IT_0290 = IT_0270 + IT_0272 + -IT_0274 + -IT_0276 + 
      -IT_0278 + -IT_0280 + IT_0282 + IT_0283 + IT_0284 + IT_0285 + IT_0286 + 
      -IT_0287 + -IT_0288 + -IT_0289;
    const ccomplex_t IT_0291 = 0.166666666666667*conj(IT_0290);
    const ccomplex_t IT_0292 = s_13*IT_0001;
    ...
    const ccomplex_t IT_0297 = 0.166666666666667*conj(IT_0139);
    const ccomplex_t IT_0298 = 0.166666666666667*conj(IT_0234);
    const ccomplex_t IT_0299 = m_s*m_C_1;
    const ccomplex_t IT_0300 = 6*IT_0299;
    const ccomplex_t IT_0301 = 6*IT_0139*(IT_0140*conj(IT_0234) + IT_0236
      *IT_0266 + IT_0268*IT_0291 + IT_0296*IT_0297) + 6*IT_0234*(conj(IT_0139)
      *IT_0140 + IT_0266*IT_0268 + IT_0236*IT_0291 + IT_0296*IT_0298) + 6
      *IT_0290*(s_13*conj(IT_0290) + IT_0268*IT_0297 + IT_0236*IT_0298 + IT_0266
      *IT_0300) + 6*IT_0265*(s_13*conj(IT_0265) + IT_0236*IT_0297 + IT_0268
      *IT_0298 + IT_0291*IT_0300);
