...
ccomplex_return_t c_sumSqAmpl_C_1_ss_R_to_c_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_13 + IT_0019 + IT_0054 + -m_ss_R*
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0110 = IT_0055*IT_0108*IT_0109;
    const ccomplex_t IT_0111 = m_c*IT_0057;
    ...
    const ccomplex_t IT_0117 = m_c*IT_0116;
    ...
    const ccomplex_t IT_0131 = m_c*m_C_1;
    ...
    const ccomplex_t IT_0154 = m_c*IT_0135;
