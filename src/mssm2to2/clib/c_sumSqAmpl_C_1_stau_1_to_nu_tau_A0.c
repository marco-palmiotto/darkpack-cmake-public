...
ccomplex_return_t c_sumSqAmpl_C_1_stau_1_to_nu_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = conj(U_d1)*e_em*m_tau*IT_0015*U_stau_10;
    ...
    const ccomplex_t IT_0032 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0033 = IT_0007*IT_0032;
    const ccomplex_t IT_0034 = conj(U_d2)*e_em*m_tau*IT_0015*U_stau_10;
    ...
    const ccomplex_t IT_0046 = e_em*mu_h*m_tau*IT_0015*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0047 = IT_0007*IT_0046;
    const ccomplex_t IT_0048 = e_em*mu_h*m_tau*IT_0015*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0049 = IT_0007*IT_0048;
    const ccomplex_t IT_0050 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0051 = IT_0003*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0064 = conj(U_d1)*e_em*m_tau*IT_0015*U_stau_11;
    ...
    const ccomplex_t IT_0068 = e_em*mu_h*m_tau*IT_0015*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0069 = IT_0007*IT_0068;
    const ccomplex_t IT_0070 = e_em*mu_h*m_tau*IT_0015*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0071 = IT_0007*IT_0070;
    const ccomplex_t IT_0072 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0073 = IT_0003*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = A_tau*U_stau_00*conj(U_stau_11);
