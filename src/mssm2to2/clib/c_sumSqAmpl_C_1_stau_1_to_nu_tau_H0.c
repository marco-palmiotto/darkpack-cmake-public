...
ccomplex_return_t c_sumSqAmpl_C_1_stau_1_to_nu_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = e_em*conj(U_Wm1)*U_stau_00;
    ...
    const ccomplex_t IT_0018 = conj(U_d1)*e_em*m_tau*IT_0017*U_stau_10;
    ...
    const ccomplex_t IT_0035 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0036 = IT_0007*IT_0035;
    const ccomplex_t IT_0037 = conj(U_d2)*e_em*m_tau*IT_0017*U_stau_10;
    ...
    const ccomplex_t IT_0049 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0050 = IT_0007*IT_0049;
    const ccomplex_t IT_0051 = conj(U_d1)*e_em*m_tau*IT_0017*U_stau_11;
    ...
    const ccomplex_t IT_0063 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0059*(IT_0007 + 
      -IT_0006*IT_0061) + IT_0000*IT_0007*IT_0015*IT_0017*IT_0062)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0007*IT_0015*IT_0055*conj(U_stau_11)) +
       U_stau_10*(IT_0003*IT_0007*IT_0015*IT_0055*conj(U_stau_01) + 2*(m_W
    ...
    const ccomplex_t IT_0095 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0059*(IT_0007 + 
      -IT_0006*IT_0061) + IT_0000*IT_0007*IT_0015*IT_0017*IT_0062)*conj
      (U_stau_00) + -1./2*IT_0003*IT_0007*IT_0015*IT_0055*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0007*IT_0015*IT_0055*conj(U_stau_00) + 2*(m_W
      *IT_0006*IT_0059*IT_0061 + -IT_0000*IT_0007*IT_0015*IT_0017*IT_0062)*conj
      (U_stau_10));
