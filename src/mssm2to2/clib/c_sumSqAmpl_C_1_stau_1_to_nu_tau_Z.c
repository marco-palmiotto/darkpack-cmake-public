...
ccomplex_return_t c_sumSqAmpl_C_1_stau_1_to_nu_tau_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = e_em*conj(U_Wm1)*U_stau_00;
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = cos(beta);
    const ccomplex_t IT_0005 = cpow(IT_0004, -1);
    const ccomplex_t IT_0006 = IT_0001*IT_0005;
    const ccomplex_t IT_0007 = pow(m_W, -1);
    const ccomplex_t IT_0008 = conj(U_d1)*e_em*m_tau*IT_0007*U_stau_10;
    ...
    const ccomplex_t IT_0029 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0030 = IT_0001*IT_0029;
    const ccomplex_t IT_0031 = conj(U_d1)*e_em*m_tau*IT_0007*U_stau_11;
    ...
    const ccomplex_t IT_0050 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0051 = IT_0001*IT_0050;
    const ccomplex_t IT_0052 = conj(U_d2)*e_em*m_tau*IT_0007*U_stau_10;
