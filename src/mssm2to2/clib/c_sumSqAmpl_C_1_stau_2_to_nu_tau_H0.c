...
ccomplex_return_t c_sumSqAmpl_C_1_stau_2_to_nu_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = U_d1*V_Wp1;
    ...
    const ccomplex_t IT_0029 = V_u1*U_Wm2;
    ...
    const ccomplex_t IT_0058 = IT_0000*IT_0014;
    ...
    const ccomplex_t IT_0063 = (-2)*conj(U_stau_00)*(((-0.5)*m_W*IT_0059*
      (IT_0007 + -IT_0006*IT_0061) + IT_0000*IT_0007*IT_0015*IT_0017*IT_0062)
      *U_stau_01 + -1./2*IT_0003*IT_0007*IT_0015*IT_0055*U_stau_11) + conj
      (U_stau_10)*(IT_0003*IT_0007*IT_0015*IT_0055*U_stau_01 + 2*(m_W*IT_0006
      *IT_0059*IT_0061 + -IT_0000*IT_0007*IT_0015*IT_0017*IT_0062)*U_stau_11);
    ...
    const ccomplex_t IT_0071 = conj(U_d1)*conj(V_Wp1);
    const ccomplex_t IT_0072 = IT_0000*IT_0071;
    const ccomplex_t IT_0073 = conj(V_u1)*conj(U_Wm1);
    ...
    const ccomplex_t IT_0082 = conj(U_d1)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0095 = (-2)*U_stau_01*(((-0.5)*m_W*IT_0059*(IT_0007 + 
      -IT_0006*IT_0061) + IT_0000*IT_0007*IT_0015*IT_0017*IT_0062)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0007*IT_0015*IT_0055*conj(U_stau_11)) +
       U_stau_11*(IT_0003*IT_0007*IT_0015*IT_0055*conj(U_stau_01) + 2*(m_W
      *IT_0006*IT_0059*IT_0061 + -IT_0000*IT_0007*IT_0015*IT_0017*IT_0062)*conj
      (U_stau_11));
