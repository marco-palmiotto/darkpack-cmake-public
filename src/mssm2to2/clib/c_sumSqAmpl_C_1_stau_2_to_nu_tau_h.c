...
ccomplex_return_t c_sumSqAmpl_C_1_stau_2_to_nu_tau_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = e_em*conj(U_Wm1)*U_stau_01;
    ...
    const ccomplex_t IT_0018 = conj(U_d1)*e_em*m_tau*IT_0017*U_stau_11;
    ...
    const ccomplex_t IT_0024 = cpow(s_23 + (-0.5)*IT_0023 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0022*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = V_u1*U_Wm2;
    const ccomplex_t IT_0028 = IT_0000*IT_0027;
    const ccomplex_t IT_0029 = U_d2*V_Wp1;
    ...
    const ccomplex_t IT_0037 = conj(U_d2)*e_em*m_tau*IT_0017*U_stau_11;
    ...
    const ccomplex_t IT_0042 = cpow(s_23 + (-0.5)*IT_0023 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0048 = s_14*s_34;
    const ccomplex_t IT_0049 = e_em*conj(U_Wm1)*U_stau_00;
    const ccomplex_t IT_0050 = IT_0007*IT_0049;
    const ccomplex_t IT_0051 = conj(U_d1)*e_em*m_tau*IT_0017*U_stau_10;
    ...
    const ccomplex_t IT_0055 = mu_h*m_tau*IT_0017;
    const ccomplex_t IT_0056 = IT_0003*IT_0014;
    ...
    const ccomplex_t IT_0063 = 2*conj(U_stau_00)*(((-0.5)*m_W*IT_0059*(IT_0007
       + -IT_0006*IT_0061) + IT_0003*IT_0007*IT_0015*IT_0017*IT_0062)*U_stau_01 
      + 1./2*IT_0000*IT_0007*IT_0015*IT_0055*U_stau_11) + conj(U_stau_10)*
      (IT_0000*IT_0007*IT_0015*IT_0055*U_stau_01 + (-2)*(m_W*IT_0006*IT_0059
      *IT_0061 + -IT_0003*IT_0007*IT_0015*IT_0017*IT_0062)*U_stau_11);
    ...
    const ccomplex_t IT_0067 = pow(m_C_1, 2);
    const ccomplex_t IT_0068 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*reg_prop +
       0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1), -1);
    const ccomplex_t IT_0069 = IT_0066*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = conj(V_u1)*conj(U_Wm1);
    const ccomplex_t IT_0072 = IT_0000*IT_0071;
    const ccomplex_t IT_0073 = conj(U_d1)*conj(V_Wp1);
    const ccomplex_t IT_0074 = IT_0003*IT_0073;
    const ccomplex_t IT_0075 = IT_0007*(IT_0072 + -IT_0074);
    ...
    const ccomplex_t IT_0081 = IT_0024*IT_0079*IT_0080;
    ...
    const ccomplex_t IT_0092 = IT_0042*IT_0090*IT_0091;
    const ccomplex_t IT_0093 = m_C_1*IT_0026;
    const ccomplex_t IT_0094 = m_C_1*IT_0044;
    const ccomplex_t IT_0095 = 2*U_stau_01*(((-0.5)*m_W*IT_0059*(IT_0007 + 
      -IT_0006*IT_0061) + IT_0003*IT_0007*IT_0015*IT_0017*IT_0062)*conj
      (U_stau_01) + 1./2*IT_0000*IT_0007*IT_0015*IT_0055*conj(U_stau_11)) +
       U_stau_11*(IT_0000*IT_0007*IT_0015*IT_0055*conj(U_stau_01) + (-2)*(m_W
      *IT_0006*IT_0059*IT_0061 + -IT_0003*IT_0007*IT_0015*IT_0017*IT_0062)*conj
      (U_stau_11));
    ...
    const ccomplex_t IT_0099 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0102 = 0.5*IT_0070 + (-0.5)*IT_0081 + (-0.5)*IT_0092 +
       (-0.5)*IT_0093 + (-0.5)*IT_0094 + 0.5*IT_0101;
    const ccomplex_t IT_0103 = s_34*m_C_1;
    const ccomplex_t IT_0104 = 2*IT_0103;
    return create_ccomplex_return(2*IT_0102*(s_13*conj(IT_0102) + 0.5*conj
      (IT_0045)*IT_0104) + (-2)*IT_0045*(conj(IT_0045)*(IT_0047 + (-2)*IT_0048) 
      + (-0.5)*conj(IT_0102)*IT_0104));
}
