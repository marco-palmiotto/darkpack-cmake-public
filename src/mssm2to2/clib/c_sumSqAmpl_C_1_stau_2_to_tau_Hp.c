...
ccomplex_return_t c_sumSqAmpl_C_1_stau_2_to_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0054 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0055 = IT_0011*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0058 = IT_0005*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = conj(N_d2)*e_em*m_tau*IT_0031*U_stau_11;
    ...
    const ccomplex_t IT_0116 = conj(N_d4)*e_em*m_tau*IT_0031*U_stau_11;
    const ccomplex_t IT_0117 = IT_0030*IT_0116;
    ...
    const ccomplex_t IT_0122 = IT_0096*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*IT_0122;
    const ccomplex_t IT_0124 = 0.5*IT_0039 + 0.5*IT_0067 + 0.5*IT_0095 + 0.5
      *IT_0123;
    const ccomplex_t IT_0125 = m_C_1*m_tau*IT_0001;
    ...
    const ccomplex_t IT_0131 = IT_0005*IT_0126;
    const ccomplex_t IT_0132 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0136 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0142 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0143 = IT_0011*IT_0142;
    const ccomplex_t IT_0144 = 1.4142135623731*IT_0143;
    const ccomplex_t IT_0145 = N_d1*e_em*m_tau*IT_0031*U_stau_01;
    ...
    const ccomplex_t IT_0153 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0154 = IT_0131*IT_0153;
    const ccomplex_t IT_0155 = (-2)*IT_0154;
    const ccomplex_t IT_0156 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0157 = IT_0127*IT_0156;
    const ccomplex_t IT_0158 = 1.4142135623731*IT_0157;
    const ccomplex_t IT_0159 = conj(N_W2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0160 = IT_0131*IT_0159;
    ...
    const ccomplex_t IT_0166 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0167 = IT_0011*IT_0166;
    const ccomplex_t IT_0168 = 1.4142135623731*IT_0167;
    const ccomplex_t IT_0169 = N_d2*e_em*m_tau*IT_0031*U_stau_01;
    ...
    const ccomplex_t IT_0177 = conj(N_W3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0178 = IT_0131*IT_0177;
    const ccomplex_t IT_0179 = 1.4142135623731*IT_0178;
    const ccomplex_t IT_0180 = conj(N_B3)*conj(U_d1)*e_em;
    const ccomplex_t IT_0181 = IT_0127*IT_0180;
    const ccomplex_t IT_0182 = 1.4142135623731*IT_0181;
    const ccomplex_t IT_0183 = IT_0179 + IT_0182;
    const ccomplex_t IT_0184 = conj(N_d3)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0185 = IT_0131*IT_0184;
    ...
    const ccomplex_t IT_0190 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0191 = IT_0011*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = N_d3*e_em*m_tau*IT_0031*U_stau_01;
    ...
    const ccomplex_t IT_0199 = IT_0068*IT_0198;
    ...
    const ccomplex_t IT_0214 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0215 = IT_0011*IT_0214;
    const ccomplex_t IT_0216 = 1.4142135623731*IT_0215;
    const ccomplex_t IT_0217 = N_d4*e_em*m_tau*IT_0031*U_stau_01;
    const ccomplex_t IT_0218 = IT_0030*IT_0217;
    ...
    const ccomplex_t IT_0223 = IT_0096*IT_0222;
    const ccomplex_t IT_0224 = (0 + _Complex_I*1)*IT_0223;
    const ccomplex_t IT_0225 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0005*IT_0029*IT_0031*IT_0126;
    const ccomplex_t IT_0226 = 0.5*IT_0225;
    const ccomplex_t IT_0227 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0228 = IT_0005*IT_0227;
    const ccomplex_t IT_0229 = conj(U_d1)*e_em*m_tau*IT_0031*U_stau_11;
    ...
    const ccomplex_t IT_0233 = IT_0226*IT_0232;
    const ccomplex_t IT_0234 = pow(m_C_1, 2);
    const ccomplex_t IT_0235 = cpow(s_12 + 0.5*IT_0001 + 0.5*IT_0234 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0236 = IT_0233*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = 0.5*IT_0152 + 0.5*IT_0176 + 0.5*IT_0200 + 0.5
      *IT_0224 + (-0.5)*IT_0237;
    const ccomplex_t IT_0239 = m_tau*IT_0039;
    const ccomplex_t IT_0240 = m_tau*IT_0095;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0242 = IT_0022*IT_0149;
    const ccomplex_t IT_0243 = IT_0002*IT_0241*IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0245 = IT_0053*IT_0173;
    const ccomplex_t IT_0246 = IT_0040*IT_0244*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0248 = IT_0081*IT_0197;
    const ccomplex_t IT_0249 = IT_0068*IT_0247*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0251 = IT_0109*IT_0221;
    const ccomplex_t IT_0252 = IT_0096*IT_0250*IT_0251;
    const ccomplex_t IT_0253 = m_tau*IT_0067;
    const ccomplex_t IT_0254 = m_tau*IT_0123;
    const ccomplex_t IT_0255 = m_C_1*IT_0237;
    const ccomplex_t IT_0256 = (-0.5)*IT_0239 + (-0.5)*IT_0240 + 0.5*IT_0243 +
       0.5*IT_0246 + 0.5*IT_0249 + 0.5*IT_0252 + (-0.5)*IT_0253 + (-0.5)*IT_0254
       + (-0.5)*IT_0255;
    const ccomplex_t IT_0257 = s_12*m_tau;
    const ccomplex_t IT_0258 = 2*IT_0257;
    const ccomplex_t IT_0259 = s_23*m_C_1;
    const ccomplex_t IT_0260 = 2*IT_0259;
    const ccomplex_t IT_0261 = IT_0036*IT_0141;
    const ccomplex_t IT_0262 = IT_0002*IT_0241*IT_0261;
    const ccomplex_t IT_0263 = IT_0064*IT_0165;
    const ccomplex_t IT_0264 = IT_0040*IT_0244*IT_0263;
    const ccomplex_t IT_0265 = IT_0092*IT_0189;
    const ccomplex_t IT_0266 = IT_0068*IT_0247*IT_0265;
    const ccomplex_t IT_0267 = IT_0120*IT_0213;
    const ccomplex_t IT_0268 = IT_0096*IT_0250*IT_0267;
    const ccomplex_t IT_0269 = m_tau*IT_0152;
    const ccomplex_t IT_0270 = m_tau*IT_0176;
    const ccomplex_t IT_0271 = m_tau*IT_0200;
    const ccomplex_t IT_0272 = m_tau*IT_0224;
    const ccomplex_t IT_0273 = 0.5*IT_0262 + 0.5*IT_0264 + 0.5*IT_0266 + 0.5
      *IT_0268 + (-0.5)*IT_0269 + (-0.5)*IT_0270 + (-0.5)*IT_0271 + (-0.5)
      *IT_0272;
    ...
    const ccomplex_t IT_0280 = 0.5*conj(IT_0124);
    const ccomplex_t IT_0281 = m_C_1*m_tau;
    const ccomplex_t IT_0282 = 2*IT_0281;
    const ccomplex_t IT_0283 = 0.5*conj(IT_0238);
    const ccomplex_t IT_0284 = 2*IT_0124*(IT_0125*conj(IT_0238) + 0.5*conj
      (IT_0256)*IT_0258 + IT_0260*IT_0274 + IT_0279*IT_0280) + 2*IT_0273*(s_13
      *conj(IT_0273) + IT_0260*IT_0280 + 0.5*conj(IT_0256)*IT_0282 + IT_0258
      *IT_0283) + 2*IT_0256*(s_13*conj(IT_0256) + IT_0258*IT_0280 + IT_0274
      *IT_0282 + IT_0260*IT_0283) + 2*IT_0238*(conj(IT_0124)*IT_0125 + 0.5*conj
      (IT_0256)*IT_0260 + IT_0258*IT_0274 + IT_0279*IT_0283);
