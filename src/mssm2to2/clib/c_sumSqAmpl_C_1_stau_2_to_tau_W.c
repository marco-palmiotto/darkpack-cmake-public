...
ccomplex_return_t c_sumSqAmpl_C_1_stau_2_to_tau_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = N_d4*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0030 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0031 = IT_0004*IT_0030;
    const ccomplex_t IT_0032 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0037 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0038 = IT_0013*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = N_d1*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0056 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0057 = IT_0013*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = N_d2*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0078 = N_d3*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0161 = IT_0002*IT_0148*IT_0160;
    ...
    const ccomplex_t IT_0203 = IT_0044*IT_0168;
    const ccomplex_t IT_0204 = IT_0029*IT_0095*IT_0203;
    ...
    const ccomplex_t IT_0209 = IT_0025*IT_0190;
    const ccomplex_t IT_0210 = IT_0002*IT_0148*IT_0209;
    const ccomplex_t IT_0211 = m_C_1*IT_0047;
    const ccomplex_t IT_0212 = m_C_1*IT_0066;
    const ccomplex_t IT_0213 = m_C_1*IT_0028;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004;
    const ccomplex_t IT_0215 = 0.5*IT_0214;
    const ccomplex_t IT_0216 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0217 = IT_0004*IT_0216;
    const ccomplex_t IT_0218 = conj(U_d1)*e_em*m_tau*IT_0020*U_stau_11;
    ...
    const ccomplex_t IT_0233 = -IT_0028 + -IT_0047 + -IT_0066 + -IT_0085;
    const ccomplex_t IT_0234 = s_13*s_14;
    const ccomplex_t IT_0235 = s_34*IT_0223;
    const ccomplex_t IT_0236 = -IT_0235;
    const ccomplex_t IT_0237 = IT_0234 + IT_0236;
    const ccomplex_t IT_0238 = (-3)*IT_0230;
    const ccomplex_t IT_0239 = (-0.5)*IT_0146;
    const ccomplex_t IT_0240 = (-0.5)*IT_0171 + (-0.5)*IT_0182 + (-0.5)*IT_0193;
    const ccomplex_t IT_0241 = conj(IT_0239) + conj(IT_0240);
    const ccomplex_t IT_0242 = s_13*IT_0088;
    const ccomplex_t IT_0243 = pow(m_W, 4);
    const ccomplex_t IT_0244 = s_13*IT_0243;
    const ccomplex_t IT_0245 = IT_0087*IT_0244;
    ...
    const ccomplex_t IT_0251 = IT_0239*IT_0250;
    const ccomplex_t IT_0252 = -IT_0226;
    const ccomplex_t IT_0253 = s_14*s_34*IT_0087;
    ...
    const ccomplex_t IT_0258 = IT_0087*IT_0257;
    const ccomplex_t IT_0259 = -IT_0000;
    const ccomplex_t IT_0260 = IT_0258 + IT_0259;
    const ccomplex_t IT_0261 = s_13*IT_0260;
    const ccomplex_t IT_0262 = m_C_1*IT_0260;
    const ccomplex_t IT_0263 = s_13*s_34;
    const ccomplex_t IT_0264 = s_14*IT_0000;
    const ccomplex_t IT_0265 = -IT_0264;
    const ccomplex_t IT_0266 = IT_0263 + IT_0265;
    const ccomplex_t IT_0267 = (-2)*IT_0266;
    const ccomplex_t IT_0268 = IT_0146 + IT_0171 + IT_0182 + IT_0193;
    const ccomplex_t IT_0269 = s_13*IT_0255;
    const ccomplex_t IT_0270 = (-2)*IT_0269;
    const ccomplex_t IT_0271 = m_tau*IT_0255;
    const ccomplex_t IT_0272 = (-2)*IT_0271;
    const ccomplex_t IT_0273 = -conj(IT_0232);
    const ccomplex_t IT_0274 = (-2)*IT_0252*(conj(IT_0233)*IT_0256 + -conj
      (IT_0252)*IT_0261 + -conj(IT_0195)*IT_0262 + (-0.5)*IT_0241*IT_0267 + (
      -0.5)*conj(IT_0268)*IT_0270 + (-0.5)*conj(IT_0228)*IT_0272 + IT_0266
      *IT_0273);
    const ccomplex_t IT_0275 = pow(s_14, 2);
    const ccomplex_t IT_0276 = IT_0087*IT_0275;
    const ccomplex_t IT_0277 = -IT_0223;
    const ccomplex_t IT_0278 = IT_0276 + IT_0277;
    const ccomplex_t IT_0279 = m_tau*IT_0278;
    const ccomplex_t IT_0280 = IT_0242 + IT_0248;
    const ccomplex_t IT_0281 = IT_0087*IT_0280;
    const ccomplex_t IT_0282 = (-0.25)*IT_0090;
    const ccomplex_t IT_0283 = s_14 + IT_0282;
    const ccomplex_t IT_0284 = m_tau*IT_0283;
    const ccomplex_t IT_0285 = (-4)*IT_0284;
    const ccomplex_t IT_0286 = m_C_1*IT_0255;
    const ccomplex_t IT_0287 = (-2)*IT_0286;
    const ccomplex_t IT_0288 = 0.5*conj(IT_0252);
    const ccomplex_t IT_0289 = (-6)*IT_0229;
    const ccomplex_t IT_0290 = 0.5*conj(IT_0195);
    const ccomplex_t IT_0291 = conj(IT_0086)*IT_0201 + IT_0094*conj(IT_0239) +
       IT_0094*conj(IT_0240) + conj(IT_0268)*IT_0279 + 2*conj(IT_0228)*(s_13 + (
      -0.5)*IT_0281) + conj(IT_0232)*IT_0285 + 0.5*conj(IT_0233)*IT_0287 +
       IT_0272*IT_0288 + IT_0289*IT_0290;
    const ccomplex_t IT_0292 = s_13*IT_0278;
    const ccomplex_t IT_0293 = IT_0229*IT_0278;
    const ccomplex_t IT_0294 = 2*IT_0293;
    const ccomplex_t IT_0295 = 0.5*IT_0197;
    const ccomplex_t IT_0296 = s_34 + IT_0295;
    const ccomplex_t IT_0297 = m_C_1*IT_0296;
    const ccomplex_t IT_0298 = 2*IT_0297;
    const ccomplex_t IT_0299 = 0.5*conj(IT_0268);
    const ccomplex_t IT_0300 = 0.5*conj(IT_0228);
    const ccomplex_t IT_0301 = conj(IT_0086)*IT_0094 + IT_0201*conj(IT_0239) +
       IT_0201*conj(IT_0240) + conj(IT_0252)*IT_0262 + conj(IT_0233)*IT_0279 + 2
      *conj(IT_0195)*(s_13 + (-0.5)*IT_0281) + conj(IT_0232)*IT_0298 + IT_0287
      *IT_0299 + IT_0289*IT_0300;
    const ccomplex_t IT_0302 = 0.5*conj(IT_0232);
    const ccomplex_t IT_0303 = (-0.25)*IT_0245;
    const ccomplex_t IT_0304 = IT_0247 + IT_0303;
    const ccomplex_t IT_0305 = (-8)*IT_0304;
    const ccomplex_t IT_0306 = 0.5*IT_0241;
    const ccomplex_t IT_0307 = conj(IT_0252)*IT_0267;
    const ccomplex_t IT_0308 = 0.5*IT_0307;
    const ccomplex_t IT_0309 = IT_0237*conj(IT_0268);
    const ccomplex_t IT_0310 = 2*IT_0086*(IT_0094*conj(IT_0195) + IT_0201*conj
      (IT_0228) + IT_0231*conj(IT_0232) + conj(IT_0233)*IT_0237 + IT_0238
      *IT_0241 + 0.5*conj(IT_0086)*IT_0250) + IT_0241*IT_0251 + IT_0274 + 2
      *IT_0228*IT_0291 + 2*IT_0268*(IT_0237*(conj(IT_0239) + conj(IT_0240) +
       IT_0273) + conj(IT_0228)*IT_0279 + IT_0270*IT_0288 + IT_0287*IT_0290 +
       conj(IT_0268)*IT_0292 + 0.5*conj(IT_0233)*IT_0294) + 2*IT_0233*(conj
      (IT_0086)*IT_0237 + -conj(IT_0252)*IT_0256 + conj(IT_0195)*IT_0279 + conj
      (IT_0233)*IT_0292 + IT_0294*IT_0299 + IT_0287*IT_0300) + 2*IT_0195*IT_0301
       + 2*IT_0232*(conj(IT_0086)*IT_0231 + conj(IT_0252)*IT_0266 + -IT_0237
      *conj(IT_0268) + conj(IT_0228)*IT_0285 + conj(IT_0195)*IT_0298 + IT_0250
      *IT_0302 + IT_0305*IT_0306) + 2*IT_0239*(conj(IT_0195)*IT_0201 + IT_0094
      *conj(IT_0228) + conj(IT_0086)*IT_0238 + IT_0302*IT_0305 + IT_0308 +
       IT_0309) + 2*IT_0240*(conj(IT_0195)*IT_0201 + IT_0094*conj(IT_0228) +
       conj(IT_0086)*IT_0238 + IT_0302*IT_0305 + IT_0250*IT_0306 + IT_0308 +
       IT_0309);
