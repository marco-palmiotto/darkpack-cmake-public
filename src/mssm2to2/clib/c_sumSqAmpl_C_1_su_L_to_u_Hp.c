...
ccomplex_return_t c_sumSqAmpl_C_1_su_L_to_u_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0051 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0052 = IT_0016*IT_0051;
    const ccomplex_t IT_0053 = (-2)*IT_0052;
    const ccomplex_t IT_0054 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0055 = IT_0012*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W4)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_3*
    ...
    const ccomplex_t IT_0088 = m_u*m_C_1*IT_0001;
    const ccomplex_t IT_0089 = conj(N_B2)*e_em;
    const ccomplex_t IT_0090 = IT_0011*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0099 = N_B2*V_u1*e_em;
    const ccomplex_t IT_0100 = IT_0098*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = IT_0007*IT_0097;
    const ccomplex_t IT_0103 = N_W2*V_u1*e_em;
    ...
    const ccomplex_t IT_0107 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0116 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0117 = IT_0102*IT_0116;
    const ccomplex_t IT_0118 = 2*IT_0117;
    const ccomplex_t IT_0119 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0120 = IT_0098*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0188 = -IT_0115 + -IT_0139 + -IT_0163 + -IT_0187;
    const ccomplex_t IT_0189 = s_13*IT_0001;
    const ccomplex_t IT_0190 = (-6)*IT_0189;
    const ccomplex_t IT_0191 = s_12*s_23;
    const ccomplex_t IT_0192 = 12*IT_0191;
    const ccomplex_t IT_0193 = IT_0190 + IT_0192;
    const ccomplex_t IT_0194 = 0.166666666666667*conj(IT_0087);
    const ccomplex_t IT_0195 = s_23*m_C_1;
    const ccomplex_t IT_0196 = 6*IT_0195;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0198 = IT_0031*IT_0112;
    const ccomplex_t IT_0199 = IT_0046*IT_0197*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0201 = IT_0069*IT_0184;
    const ccomplex_t IT_0202 = IT_0084*IT_0200*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0204 = IT_0050*IT_0160;
    const ccomplex_t IT_0205 = IT_0065*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = pow(m_C_1, 2);
    const ccomplex_t IT_0207 = cpow((-2)*s_13 + IT_0000 + IT_0206 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0208 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0209 = cpow(IT_0097, -1);
    const ccomplex_t IT_0210 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007
      *IT_0208*(m_W*IT_0004*IT_0097*conj(U_sb_01) + (-0.5)*IT_0003*(IT_0000
      *IT_0005*IT_0097*conj(U_sb_01) + m_b*(m_b*IT_0004*IT_0209*conj(U_sb_01) +
       mu_h*conj(U_sb_11))))*V_ub_mod;
    const ccomplex_t IT_0211 = -IT_0210;
    const ccomplex_t IT_0212 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0003*IT_0005*IT_0007*IT_0212*U_sb_01*V_ub_mod;
    ...
    const ccomplex_t IT_0218 = m_u*IT_0115;
    const ccomplex_t IT_0219 = cpow((-2)*s_13 + IT_0000 + IT_0206 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0220 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007
      *IT_0208*(m_W*IT_0004*IT_0097*conj(U_sb_00) + (-0.5)*IT_0003*(IT_0000
      *IT_0005*IT_0097*conj(U_sb_00) + m_b*(m_b*IT_0004*IT_0209*conj(U_sb_00) +
       mu_h*conj(U_sb_10))))*V_ub_mod;
    const ccomplex_t IT_0221 = -IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*e_em
      *IT_0003*IT_0005*IT_0007*IT_0212*U_sb_00*V_ub_mod;
    ...
    const ccomplex_t IT_0227 = pow(m_s, 2);
    const ccomplex_t IT_0228 = (0 + _Complex_I*(-2.82842712474619))*V_us*e_em
      *IT_0007*((m_W*IT_0004 + (-0.5)*IT_0000*IT_0003*IT_0005)*IT_0097 + -1./2
      *IT_0003*IT_0004*IT_0209*IT_0227);
    const ccomplex_t IT_0229 = 0.5*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_us
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0231 = 0.5*IT_0230;
    const ccomplex_t IT_0232 = IT_0229*IT_0231;
    const ccomplex_t IT_0233 = cpow((-2)*s_13 + IT_0000 + IT_0206 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0234 = IT_0232*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0237 = IT_0009*IT_0128;
    const ccomplex_t IT_0238 = IT_0002*IT_0236*IT_0237;
    const ccomplex_t IT_0239 = m_u*IT_0139;
    const ccomplex_t IT_0240 = m_u*IT_0187;
    const ccomplex_t IT_0241 = m_u*IT_0163;
    const ccomplex_t IT_0242 = pow(m_d, 2);
    const ccomplex_t IT_0243 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0007*((m_W*IT_0004 + (-0.5)*IT_0000*IT_0003*IT_0005)*IT_0097 + -1./2
      *IT_0003*IT_0004*IT_0209*IT_0242);
    const ccomplex_t IT_0244 = 0.5*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0246 = 0.5*IT_0245;
    const ccomplex_t IT_0247 = IT_0244*IT_0246;
    const ccomplex_t IT_0248 = cpow((-2)*s_13 + IT_0000 + IT_0206 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0249 = IT_0247*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*IT_0249;
    const ccomplex_t IT_0251 = -IT_0199 + -IT_0202 + -IT_0205 + IT_0217 +
       IT_0218 + IT_0226 + IT_0235 + -IT_0238 + IT_0239 + IT_0240 + IT_0241 +
       IT_0250;
    const ccomplex_t IT_0252 = 0.166666666666667*conj(IT_0251);
    const ccomplex_t IT_0253 = m_u*s_12;
    const ccomplex_t IT_0254 = 6*IT_0253;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0003*IT_0007;
    const ccomplex_t IT_0256 = 0.5*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0003*IT_0007*IT_0209;
    const ccomplex_t IT_0258 = (-0.5)*IT_0257;
    const ccomplex_t IT_0259 = IT_0256*IT_0258;
    const ccomplex_t IT_0260 = cpow((-2)*s_13 + IT_0000 + IT_0206 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0261 = IT_0259*IT_0260;
    const ccomplex_t IT_0262 = (0 + _Complex_I*1)*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *mu_h*IT_0003*IT_0007;
    const ccomplex_t IT_0264 = 0.5*IT_0263;
    const ccomplex_t IT_0265 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_us*e_em*IT_0003*IT_0007*IT_0209;
    const ccomplex_t IT_0266 = (-0.5)*IT_0265;
    const ccomplex_t IT_0267 = IT_0264*IT_0266;
    const ccomplex_t IT_0268 = cpow((-2)*s_13 + IT_0000 + IT_0206 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0269 = IT_0267*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*IT_0269;
    const ccomplex_t IT_0271 = IT_0063*IT_0147;
    const ccomplex_t IT_0272 = IT_0065*IT_0203*IT_0271;
    const ccomplex_t IT_0273 = IT_0007*IT_0212;
    const ccomplex_t IT_0274 = e_em*conj(U_Wm1)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0275 = IT_0273*IT_0274;
    const ccomplex_t IT_0276 = IT_0007*IT_0209*IT_0212;
    const ccomplex_t IT_0277 = m_b*conj(U_d1)*e_em*IT_0003*U_sb_10*V_ub_mod;
    const ccomplex_t IT_0278 = IT_0276*IT_0277;
    const ccomplex_t IT_0279 = 1.4142135623731*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*(IT_0275 + (-0.5)*IT_0279);
    const ccomplex_t IT_0281 = IT_0221*IT_0280;
    const ccomplex_t IT_0282 = IT_0219*IT_0281;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1)*IT_0282;
    const ccomplex_t IT_0284 = m_u*IT_0029;
    const ccomplex_t IT_0285 = m_u*IT_0067;
    const ccomplex_t IT_0286 = IT_0026*IT_0136;
    const ccomplex_t IT_0287 = IT_0002*IT_0236*IT_0286;
    const ccomplex_t IT_0288 = IT_0044*IT_0096;
    const ccomplex_t IT_0289 = IT_0046*IT_0197*IT_0288;
    const ccomplex_t IT_0290 = IT_0082*IT_0171;
    const ccomplex_t IT_0291 = IT_0084*IT_0200*IT_0290;
    const ccomplex_t IT_0292 = m_u*IT_0048;
    const ccomplex_t IT_0293 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0294 = IT_0244*IT_0293;
    const ccomplex_t IT_0295 = IT_0248*IT_0294;
    const ccomplex_t IT_0296 = (0 + _Complex_I*1)*IT_0295;
    const ccomplex_t IT_0297 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0298 = IT_0229*IT_0297;
    const ccomplex_t IT_0299 = IT_0233*IT_0298;
    const ccomplex_t IT_0300 = (0 + _Complex_I*1)*IT_0299;
    const ccomplex_t IT_0301 = e_em*conj(U_Wm1)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0302 = IT_0273*IT_0301;
    const ccomplex_t IT_0303 = m_b*conj(U_d1)*e_em*IT_0003*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0307 = IT_0211*IT_0306;
    const ccomplex_t IT_0308 = IT_0207*IT_0307;
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*IT_0308;
    const ccomplex_t IT_0310 = m_u*IT_0086;
    const ccomplex_t IT_0311 = -IT_0262 + -IT_0270 + -IT_0272 + -IT_0283 +
       IT_0284 + IT_0285 + -IT_0287 + -IT_0289 + -IT_0291 + IT_0292 + -IT_0296 +
       -IT_0300 + -IT_0309 + IT_0310;
    const ccomplex_t IT_0312 = 0.166666666666667*conj(IT_0311);
    const ccomplex_t IT_0313 = 0.166666666666667*conj(IT_0188);
    const ccomplex_t IT_0314 = m_u*m_C_1;
    const ccomplex_t IT_0315 = 6*IT_0314;
    const ccomplex_t IT_0316 = 6*IT_0087*(IT_0088*conj(IT_0188) + IT_0193
      *IT_0194 + IT_0196*IT_0252 + IT_0254*IT_0312) + 6*IT_0188*(conj(IT_0087)
      *IT_0088 + IT_0252*IT_0254 + IT_0196*IT_0312 + IT_0193*IT_0313) + 6
      *IT_0311*(IT_0194*IT_0254 + s_13*conj(IT_0311) + IT_0196*IT_0313 + IT_0252
      *IT_0315) + 6*IT_0251*(IT_0194*IT_0196 + s_13*conj(IT_0251) + IT_0254
      *IT_0313 + IT_0312*IT_0315);
