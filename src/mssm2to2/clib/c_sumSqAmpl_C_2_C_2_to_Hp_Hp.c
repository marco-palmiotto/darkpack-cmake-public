        ...
        )
{
    ...
    const ccomplex_t IT_0004 = conj(N_W1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0010 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0037 + IT_0038 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0036*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0037 + IT_0038 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0046 = conj(N_d2)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0037 + IT_0038 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0072*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = cpow((-2)*s_23 + IT_0037 + IT_0038 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0079 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0080 = IT_0003*IT_0079;
    const ccomplex_t IT_0081 = (-2)*IT_0080;
    const ccomplex_t IT_0082 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0083 = IT_0009*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0138 = cpow((-2)*s_23 + IT_0037 + IT_0038 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0139 = IT_0137*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*IT_0139;
    const ccomplex_t IT_0141 = cpow((-2)*s_13 + IT_0037 + IT_0038 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0142 = IT_0137*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*IT_0142;
    const ccomplex_t IT_0144 = -IT_0041 + IT_0044 + -IT_0074 + IT_0077 + 
      -IT_0107 + IT_0110 + -IT_0140 + IT_0143;
    const ccomplex_t IT_0145 = cpow(IT_0058, 2);
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_N_2*IT_0145;
    const ccomplex_t IT_0147 = IT_0075*IT_0146;
    const ccomplex_t IT_0148 = cpow(IT_0091, 2);
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*m_N_4*IT_0148;
    const ccomplex_t IT_0150 = IT_0078*IT_0149;
    const ccomplex_t IT_0151 = cpow(IT_0019, 2);
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*m_N_1*IT_0151;
    const ccomplex_t IT_0153 = IT_0039*IT_0152;
    const ccomplex_t IT_0154 = IT_0042*IT_0152;
    const ccomplex_t IT_0155 = IT_0045*IT_0146;
    const ccomplex_t IT_0156 = cpow(IT_0123, 2);
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_3*IT_0156;
    const ccomplex_t IT_0158 = IT_0138*IT_0157;
    const ccomplex_t IT_0159 = IT_0141*IT_0157;
    const ccomplex_t IT_0160 = IT_0108*IT_0149;
    const ccomplex_t IT_0161 = m_C_2*IT_0044;
    const ccomplex_t IT_0162 = m_C_2*IT_0140;
    const ccomplex_t IT_0163 = m_C_2*IT_0074;
    const ccomplex_t IT_0164 = m_C_2*IT_0077;
    const ccomplex_t IT_0165 = m_C_2*IT_0107;
    const ccomplex_t IT_0166 = m_C_2*IT_0110;
    const ccomplex_t IT_0167 = m_C_2*IT_0041;
    const ccomplex_t IT_0168 = m_C_2*IT_0143;
    const ccomplex_t IT_0169 = IT_0147 + IT_0150 + IT_0153 + IT_0154 + IT_0155
       + IT_0158 + IT_0159 + IT_0160 + -IT_0161 + -IT_0162 + -IT_0163 + -IT_0164
    ...
    const ccomplex_t IT_0174 = IT_0042*IT_0172;
    const ccomplex_t IT_0175 = cpow(IT_0136, 2);
    ...
    const ccomplex_t IT_0179 = cpow(IT_0104, 2);
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*m_N_4*IT_0179;
    const ccomplex_t IT_0181 = IT_0108*IT_0180;
    const ccomplex_t IT_0182 = cpow(IT_0071, 2);
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*m_N_2*IT_0182;
    const ccomplex_t IT_0184 = IT_0045*IT_0183;
    const ccomplex_t IT_0185 = IT_0075*IT_0183;
    const ccomplex_t IT_0186 = IT_0078*IT_0180;
    const ccomplex_t IT_0187 = -IT_0161 + -IT_0162 + -IT_0163 + -IT_0164 + 
      -IT_0165 + -IT_0166 + -IT_0167 + -IT_0168 + IT_0173 + IT_0174 + IT_0177 +
       IT_0178 + IT_0181 + IT_0184 + IT_0185 + IT_0186;
