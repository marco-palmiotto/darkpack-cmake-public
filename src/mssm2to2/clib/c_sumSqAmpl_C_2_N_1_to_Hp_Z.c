        ...
        )
{
    ...
    const ccomplex_t IT_0004 = N_u1*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0010 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0011 = IT_0009*IT_0010;
    const ccomplex_t IT_0012 = 1.4142135623731*IT_0011;
    const ccomplex_t IT_0013 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0035 = N_u1*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0094 = IT_0023*IT_0092;
    ...
    const ccomplex_t IT_0099 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0100 = IT_0078*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0103 = IT_0074*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = IT_0101 + IT_0104;
    const ccomplex_t IT_0106 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0115 = IT_0061*IT_0111;
    ...
    const ccomplex_t IT_0125 = s_14*s_24;
    const ccomplex_t IT_0126 = pow(m_Z, 4);
    const ccomplex_t IT_0127 = s_12*IT_0126;
    const ccomplex_t IT_0128 = IT_0119*IT_0127;
    const ccomplex_t IT_0129 = (-0.25)*IT_0128;
    const ccomplex_t IT_0130 = IT_0125 + IT_0129;
    const ccomplex_t IT_0131 = -IT_0034 + -IT_0058;
    const ccomplex_t IT_0132 = N_u1*conj(N_u1)*e_em;
    const ccomplex_t IT_0133 = IT_0020*IT_0132;
    const ccomplex_t IT_0134 = IT_0023*IT_0132;
    const ccomplex_t IT_0135 = N_d1*conj(N_d1)*e_em;
    const ccomplex_t IT_0136 = IT_0020*IT_0135;
    const ccomplex_t IT_0137 = IT_0023*IT_0135;
    const ccomplex_t IT_0138 = (0 + _Complex_I*1)*(IT_0133 + IT_0134 + 
      -IT_0136 + -IT_0137);
    const ccomplex_t IT_0139 = 0.5*IT_0138;
    const ccomplex_t IT_0140 = cpow((-2)*s_13 + IT_0030 + IT_0060 + -m_N_1*
    ...
    const ccomplex_t IT_0168 = cpow((-2)*s_13 + IT_0030 + IT_0060 + -m_N_2*
    ...
    const ccomplex_t IT_0193 = cpow((-2)*s_13 + IT_0030 + IT_0060 + -m_N_3*
    ...
    const ccomplex_t IT_0222 = 0.5*IT_0146 + IT_0171 + IT_0196 + IT_0221;
    const ccomplex_t IT_0223 = -IT_0222;
    const ccomplex_t IT_0224 = IT_0144 + IT_0223;
    const ccomplex_t IT_0225 = -conj(IT_0222);
    const ccomplex_t IT_0226 = conj(IT_0144) + IT_0225;
    const ccomplex_t IT_0227 = -IT_0091 + -IT_0114;
    const ccomplex_t IT_0228 = IT_0111*IT_0140;
    ...
    const ccomplex_t IT_0232 = conj(N_d1)*N_d4*e_em;
    const ccomplex_t IT_0233 = IT_0020*IT_0232;
    const ccomplex_t IT_0234 = IT_0023*IT_0232;
    const ccomplex_t IT_0235 = conj(N_u1)*N_u4*e_em;
    ...
    const ccomplex_t IT_0302 = IT_0168*IT_0301;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1)*IT_0302;
    const ccomplex_t IT_0304 = IT_0288*IT_0303;
    const ccomplex_t IT_0305 = -IT_0255 + -IT_0279 + (-0.5)*IT_0280 + -IT_0304;
    const ccomplex_t IT_0306 = -IT_0305;
    const ccomplex_t IT_0307 = IT_0231 + IT_0306;
    const ccomplex_t IT_0308 = -conj(IT_0305);
    const ccomplex_t IT_0309 = conj(IT_0231) + IT_0308;
    const ccomplex_t IT_0310 = pow(m_Z, 2);
    const ccomplex_t IT_0311 = s_12*IT_0310;
    const ccomplex_t IT_0312 = (-0.5)*IT_0128;
    const ccomplex_t IT_0313 = (-2)*IT_0125;
    const ccomplex_t IT_0314 = IT_0311 + IT_0312 + IT_0313;
    const ccomplex_t IT_0315 = m_C_2*m_N_1;
    const ccomplex_t IT_0316 = pow(s_24, 2);
    const ccomplex_t IT_0317 = IT_0119*IT_0316;
    const ccomplex_t IT_0318 = -IT_0031;
    const ccomplex_t IT_0319 = IT_0317 + IT_0318;
    const ccomplex_t IT_0320 = IT_0315*IT_0319;
    const ccomplex_t IT_0321 = -IT_0117 + IT_0230;
    const ccomplex_t IT_0322 = -IT_0146 + (-2)*IT_0171 + (-2)*IT_0196 + (-2)
      *IT_0221;
    const ccomplex_t IT_0323 = IT_0064 + -IT_0143;
    const ccomplex_t IT_0324 = (-2)*IT_0323;
    const ccomplex_t IT_0325 = 0.5*IT_0324;
    const ccomplex_t IT_0326 = IT_0322 + IT_0325;
    const ccomplex_t IT_0327 = (-2)*conj(IT_0323);
    const ccomplex_t IT_0328 = 0.5*IT_0327;
    const ccomplex_t IT_0329 = conj(IT_0322) + IT_0328;
    const ccomplex_t IT_0330 = 2*IT_0255 + 2*IT_0279 + IT_0280 + 2*IT_0304;
    const ccomplex_t IT_0331 = (-2)*IT_0322;
    const ccomplex_t IT_0332 = 0.5*IT_0331;
    const ccomplex_t IT_0333 = IT_0323 + IT_0332;
    const ccomplex_t IT_0334 = (-2)*conj(IT_0322);
    const ccomplex_t IT_0335 = 0.5*IT_0334;
    const ccomplex_t IT_0336 = conj(IT_0323) + IT_0335;
    const ccomplex_t IT_0337 = s_24*IT_0310;
    const ccomplex_t IT_0338 = IT_0119*IT_0337;
    const ccomplex_t IT_0339 = (-0.25)*IT_0338;
    const ccomplex_t IT_0340 = s_24 + IT_0339;
    const ccomplex_t IT_0341 = m_C_2*IT_0340;
    const ccomplex_t IT_0342 = (-4)*IT_0341;
    const ccomplex_t IT_0343 = m_N_3*IT_0179;
    const ccomplex_t IT_0344 = m_N_1*IT_0263;
    const ccomplex_t IT_0345 = -IT_0344;
    const ccomplex_t IT_0346 = IT_0343 + IT_0345;
    const ccomplex_t IT_0347 = IT_0278*IT_0346;
    const ccomplex_t IT_0348 = m_N_4*IT_0204;
    const ccomplex_t IT_0349 = m_N_1*IT_0239;
    const ccomplex_t IT_0350 = -IT_0349;
    const ccomplex_t IT_0351 = IT_0348 + IT_0350;
    const ccomplex_t IT_0352 = IT_0254*IT_0351;
    const ccomplex_t IT_0353 = m_N_1*IT_0139;
    const ccomplex_t IT_0354 = m_N_1*IT_0145;
    const ccomplex_t IT_0355 = -IT_0354;
    const ccomplex_t IT_0356 = IT_0353 + IT_0355;
    const ccomplex_t IT_0357 = IT_0229*IT_0356;
    const ccomplex_t IT_0358 = m_N_2*IT_0154;
    const ccomplex_t IT_0359 = m_N_1*IT_0288;
    const ccomplex_t IT_0360 = -IT_0359;
    const ccomplex_t IT_0361 = IT_0358 + IT_0360;
    const ccomplex_t IT_0362 = IT_0303*IT_0361;
    const ccomplex_t IT_0363 = IT_0347 + IT_0352 + (-0.5)*IT_0357 + IT_0362;
    const ccomplex_t IT_0364 = IT_0019*IT_0072;
    const ccomplex_t IT_0365 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0366 = IT_0032*IT_0364*IT_0365;
    const ccomplex_t IT_0367 = IT_0047*IT_0098;
    const ccomplex_t IT_0368 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0369 = IT_0056*IT_0367*IT_0368;
    const ccomplex_t IT_0370 = m_C_2*IT_0034;
    const ccomplex_t IT_0371 = m_C_2*IT_0058;
    const ccomplex_t IT_0372 = (-0.5)*IT_0357 + -IT_0366 + -IT_0369 + -IT_0370
       + -IT_0371;
    const ccomplex_t IT_0373 = IT_0363 + IT_0372;
    const ccomplex_t IT_0374 = conj(IT_0363) + conj(IT_0372);
    const ccomplex_t IT_0375 = m_N_2*IT_0288;
    const ccomplex_t IT_0376 = m_N_1*IT_0154;
    const ccomplex_t IT_0377 = -IT_0376;
    const ccomplex_t IT_0378 = IT_0375 + IT_0377;
    const ccomplex_t IT_0379 = IT_0170*IT_0378;
    const ccomplex_t IT_0380 = IT_0142*IT_0356;
    const ccomplex_t IT_0381 = m_N_3*IT_0263;
    const ccomplex_t IT_0382 = m_N_1*IT_0179;
    const ccomplex_t IT_0383 = -IT_0382;
    const ccomplex_t IT_0384 = IT_0381 + IT_0383;
    const ccomplex_t IT_0385 = IT_0195*IT_0384;
    const ccomplex_t IT_0386 = m_N_4*IT_0239;
    const ccomplex_t IT_0387 = m_N_1*IT_0204;
    const ccomplex_t IT_0388 = -IT_0387;
    const ccomplex_t IT_0389 = IT_0386 + IT_0388;
    const ccomplex_t IT_0390 = IT_0220*IT_0389;
    const ccomplex_t IT_0391 = -IT_0379 + (-0.5)*IT_0380 + -IT_0385 + -IT_0390;
    const ccomplex_t IT_0392 = IT_0028*IT_0088;
    const ccomplex_t IT_0393 = IT_0032*IT_0365*IT_0392;
    const ccomplex_t IT_0394 = m_C_2*IT_0091;
    const ccomplex_t IT_0395 = IT_0054*IT_0111;
    const ccomplex_t IT_0396 = IT_0056*IT_0368*IT_0395;
    const ccomplex_t IT_0397 = m_C_2*IT_0114;
    const ccomplex_t IT_0398 = (-0.5)*IT_0380 + -IT_0393 + -IT_0394 + -IT_0396
       + -IT_0397;
    const ccomplex_t IT_0399 = IT_0391 + IT_0398;
    const ccomplex_t IT_0400 = conj(IT_0391) + conj(IT_0398);
    const ccomplex_t IT_0401 = 0.5*IT_0338;
    const ccomplex_t IT_0402 = s_24 + IT_0401;
    const ccomplex_t IT_0403 = m_C_2*IT_0402;
    const ccomplex_t IT_0404 = 2*IT_0403;
    const ccomplex_t IT_0405 = (-2)*IT_0363;
    const ccomplex_t IT_0406 = (-2)*IT_0372;
    const ccomplex_t IT_0407 = IT_0405 + IT_0406;
    const ccomplex_t IT_0408 = (-2)*conj(IT_0363);
    const ccomplex_t IT_0409 = (-2)*conj(IT_0372);
    const ccomplex_t IT_0410 = IT_0408 + IT_0409;
    const ccomplex_t IT_0411 = (-2)*IT_0391;
    const ccomplex_t IT_0412 = (-2)*IT_0398;
    const ccomplex_t IT_0413 = IT_0411 + IT_0412;
    const ccomplex_t IT_0414 = (-2)*conj(IT_0391);
    const ccomplex_t IT_0415 = (-2)*conj(IT_0398);
    const ccomplex_t IT_0416 = IT_0414 + IT_0415;
    const ccomplex_t IT_0417 = 2*IT_0404*(conj(IT_0144)*IT_0373 + IT_0144
      *IT_0374 + conj(IT_0231)*IT_0399 + IT_0231*IT_0400 + 0.5*conj(IT_0222)
      *IT_0407 + 0.5*IT_0222*IT_0410 + 0.5*conj(IT_0305)*IT_0413 + 0.5*IT_0305
      *IT_0416);
    const ccomplex_t IT_0418 = s_14*IT_0310;
    ...
    const ccomplex_t IT_0424 = IT_0311 + IT_0313;
    const ccomplex_t IT_0425 = IT_0119*IT_0424;
    const ccomplex_t IT_0426 = (-0.5)*IT_0425;
    const ccomplex_t IT_0427 = s_12 + IT_0426;
    const ccomplex_t IT_0428 = 4*IT_0391;
    const ccomplex_t IT_0429 = 6*conj(IT_0363);
    const ccomplex_t IT_0430 = IT_0123*IT_0315;
    const ccomplex_t IT_0431 = (-2)*IT_0065;
    const ccomplex_t IT_0432 = (-2)*conj(IT_0065);
    const ccomplex_t IT_0433 = s_14*s_24*IT_0119;
    const ccomplex_t IT_0434 = -IT_0433;
    const ccomplex_t IT_0435 = s_12 + IT_0434;
    const ccomplex_t IT_0436 = m_C_2*IT_0435;
    const ccomplex_t IT_0437 = (-2)*IT_0118;
    const ccomplex_t IT_0438 = (-2)*conj(IT_0118);
    const ccomplex_t IT_0439 = s_12*s_24;
    const ccomplex_t IT_0440 = s_14*IT_0031;
    const ccomplex_t IT_0441 = -IT_0440;
    const ccomplex_t IT_0442 = IT_0439 + IT_0441;
    const ccomplex_t IT_0443 = (-2)*IT_0330;
    const ccomplex_t IT_0444 = 0.5*IT_0443;
    const ccomplex_t IT_0445 = IT_0321 + IT_0444;
    const ccomplex_t IT_0446 = (-2)*conj(IT_0330);
    const ccomplex_t IT_0447 = 0.5*IT_0446;
    const ccomplex_t IT_0448 = conj(IT_0321) + IT_0447;
    const ccomplex_t IT_0449 = IT_0131 + IT_0222;
    const ccomplex_t IT_0450 = conj(IT_0131) + conj(IT_0222);
    const ccomplex_t IT_0451 = conj(IT_0227) + conj(IT_0305);
    const ccomplex_t IT_0452 = (-2)*IT_0321;
    const ccomplex_t IT_0453 = IT_0227 + IT_0305;
    const ccomplex_t IT_0454 = (-2)*conj(IT_0321);
    const ccomplex_t IT_0455 = 2*IT_0442*(conj(IT_0144)*IT_0333 + IT_0144
      *IT_0336 + conj(IT_0231)*IT_0445 + IT_0231*IT_0448 + IT_0329*IT_0449 +
       IT_0326*IT_0450 + IT_0451*(IT_0330 + 0.5*IT_0452) + IT_0453*(conj(IT_0330
      ) + 0.5*IT_0454));
    const ccomplex_t IT_0456 = m_N_1*IT_0123;
    const ccomplex_t IT_0457 = IT_0310*IT_0315;
    const ccomplex_t IT_0458 = (-3)*IT_0457;
    const ccomplex_t IT_0459 = (-2)*conj(IT_0144);
    const ccomplex_t IT_0460 = 0.5*IT_0459;
    const ccomplex_t IT_0461 = conj(IT_0222) + IT_0460;
    const ccomplex_t IT_0462 = (-2)*IT_0131;
    const ccomplex_t IT_0463 = (-2)*conj(IT_0131);
    const ccomplex_t IT_0464 = (-0.25)*IT_0419;
    const ccomplex_t IT_0465 = s_14 + IT_0464;
    const ccomplex_t IT_0466 = m_N_1*IT_0465;
    const ccomplex_t IT_0467 = (-4)*IT_0466;
    const ccomplex_t IT_0468 = 0.5*conj(IT_0144);
    const ccomplex_t IT_0469 = 0.5*IT_0231;
    const ccomplex_t IT_0470 = 0.5*conj(IT_0231);
    const ccomplex_t IT_0471 = s_12*s_14;
    const ccomplex_t IT_0472 = s_24*IT_0060;
    const ccomplex_t IT_0473 = -IT_0472;
    const ccomplex_t IT_0474 = IT_0471 + IT_0473;
    const ccomplex_t IT_0475 = 3*IT_0457;
    const ccomplex_t IT_0476 = IT_0315*IT_0435;
    const ccomplex_t IT_0477 = 0.5*IT_0330;
    const ccomplex_t IT_0478 = 0.5*conj(IT_0330);
    const ccomplex_t IT_0479 = s_12*IT_0435;
    const ccomplex_t IT_0480 = 0.5*conj(IT_0323);
    const ccomplex_t IT_0481 = 0.5*conj(IT_0321);
    const ccomplex_t IT_0482 = s_12*IT_0319;
    const ccomplex_t IT_0483 = m_N_1*IT_0435;
    const ccomplex_t IT_0484 = 0.5*IT_0399;
    const ccomplex_t IT_0485 = 2*IT_0483*(conj(IT_0321)*IT_0373 + IT_0321
      *IT_0374 + conj(IT_0323)*IT_0399 + IT_0333*IT_0400 + 0.5*conj(IT_0372)
      *IT_0443 + 0.5*IT_0372*IT_0446 + IT_0408*IT_0477 + IT_0405*IT_0478 +
       IT_0334*IT_0484);
    const ccomplex_t IT_0486 = m_C_2*IT_0319;
    const ccomplex_t IT_0487 = 2*(IT_0065*conj(IT_0065) + IT_0118*conj(IT_0118
      ))*IT_0124 + (-8)*IT_0130*(conj(IT_0131)*IT_0224 + IT_0131*IT_0226 + conj
      (IT_0227)*IT_0307 + IT_0227*IT_0309) + (-4)*(IT_0131*conj(IT_0131) +
       IT_0224*IT_0226 + IT_0227*conj(IT_0227) + IT_0307*IT_0309)*IT_0314 + 2
      *IT_0320*(conj(IT_0321)*IT_0326 + IT_0321*IT_0329 + conj(IT_0330)*IT_0333 
      + IT_0330*IT_0336) + 2*IT_0342*(conj(IT_0131)*IT_0373 + IT_0131*IT_0374 +
       conj(IT_0227)*IT_0399 + IT_0227*IT_0400) + IT_0417 + (conj(IT_0227)
      *IT_0407 + IT_0227*IT_0410 + conj(IT_0131)*IT_0413 + IT_0131*IT_0416)
      *IT_0423 + 4*IT_0427*(IT_0373*IT_0374 + IT_0400*(IT_0398 + 0.25*IT_0428)) 
      + 6*IT_0315*(IT_0373*IT_0400 + IT_0399*(conj(IT_0372) + 0.166666666666667
      *IT_0429)) + IT_0430*(conj(IT_0118)*IT_0431 + IT_0118*IT_0432) + IT_0436*
      (IT_0374*IT_0431 + IT_0373*IT_0432 + IT_0400*IT_0437 + IT_0399*IT_0438) +
       IT_0455 + (conj(IT_0118)*IT_0405 + IT_0118*IT_0408 + IT_0400*IT_0431 +
       IT_0399*IT_0432 + conj(IT_0372)*IT_0437 + IT_0372*IT_0438)*IT_0456 + 2
      *IT_0458*(IT_0226*IT_0305 + -IT_0224*IT_0309 + IT_0231*IT_0461 + 0.5*conj
      (IT_0227)*IT_0462 + 0.5*IT_0227*IT_0463) + 2*IT_0467*(conj(IT_0305)
      *IT_0373 + IT_0305*IT_0374 + conj(IT_0222)*IT_0399 + IT_0222*IT_0400 + 0.5
      *IT_0144*IT_0416 + IT_0413*IT_0468 + IT_0410*IT_0469 + IT_0407*IT_0470) +
       2*(0.5*IT_0144*IT_0432 + conj(IT_0065)*IT_0449 + IT_0065*IT_0450 +
       IT_0118*IT_0451 + conj(IT_0118)*IT_0453 + IT_0431*IT_0468 + IT_0438
      *IT_0469 + IT_0437*IT_0470)*IT_0474 + (-2)*(IT_0224*conj(IT_0227) + -conj
      (IT_0131)*IT_0305 + -IT_0131*conj(IT_0305) + -IT_0227*IT_0461 + -IT_0463
      *IT_0469 + -IT_0462*IT_0470)*IT_0475 + 2*IT_0476*(conj(IT_0065)*IT_0321 +
       IT_0065*conj(IT_0321) + conj(IT_0118)*IT_0333 + IT_0118*IT_0336 + IT_0432
      *IT_0477 + IT_0431*IT_0478) + 2*IT_0479*(conj(IT_0065)*IT_0322 + IT_0065
      *conj(IT_0322) + conj(IT_0118)*IT_0330 + IT_0118*conj(IT_0330) + 0.5
      *IT_0323*IT_0432 + 0.5*IT_0321*IT_0438 + IT_0431*IT_0480 + IT_0437*IT_0481
      ) + 2*(IT_0322*conj(IT_0322) + IT_0330*conj(IT_0330) + IT_0323*IT_0336 +
       IT_0321*IT_0448 + IT_0331*IT_0480 + IT_0443*IT_0481)*IT_0482 + IT_0485 +
       2*(IT_0336*IT_0373 + IT_0333*IT_0374 + conj(IT_0321)*IT_0399 + IT_0400
      *IT_0445 + IT_0446*IT_0484)*IT_0486;
