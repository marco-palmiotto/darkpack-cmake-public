...
ccomplex_return_t c_sumSqAmpl_C_2_N_1_to_anti_e_nu_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + -IT_0007 + -IT_0029 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0031 = sin(beta);
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0015*IT_0021*IT_0023*IT_0031;
    const ccomplex_t IT_0033 = 0.5*IT_0032;
    const ccomplex_t IT_0034 = IT_0015*IT_0031;
    const ccomplex_t IT_0035 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = IT_0010*IT_0031;
    ...
    const ccomplex_t IT_0062 = IT_0035*IT_0056;
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_12 + -IT_0007 + -IT_0029 + IT_0069 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_23 + IT_0006 + IT_0029 + -m_se_R*
    ...
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0015*IT_0021*IT_0023;
    const ccomplex_t IT_0089 = (-0.5)*IT_0088;
    const ccomplex_t IT_0090 = IT_0087*IT_0089;
    const ccomplex_t IT_0091 = cpow((-2)*s_23 + IT_0006 + IT_0029 + -m_se_L*
    ...
    const ccomplex_t IT_0099 = conj(IT_0052) + conj(IT_0073);
    const ccomplex_t IT_0100 = 4*IT_0052;
    const ccomplex_t IT_0101 = 4*conj(IT_0052);
    const ccomplex_t IT_0102 = 4*IT_0073;
    const ccomplex_t IT_0103 = N_u1*e_em*V_Wp2;
    const ccomplex_t IT_0104 = IT_0034*IT_0103;
    const ccomplex_t IT_0105 = 2*IT_0104;
    const ccomplex_t IT_0106 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0107 = IT_0038*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0116 = IT_0055*IT_0115;
    const ccomplex_t IT_0117 = IT_0070*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*IT_0117;
    const ccomplex_t IT_0119 = IT_0056*IT_0103;
    const ccomplex_t IT_0120 = 2*IT_0119;
    const ccomplex_t IT_0121 = IT_0059*IT_0106;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = IT_0056*IT_0109;
    ...
    const ccomplex_t IT_0132 = conj(IT_0118) + conj(IT_0131);
    const ccomplex_t IT_0133 = 4*IT_0118;
    const ccomplex_t IT_0134 = 4*conj(IT_0118);
    const ccomplex_t IT_0135 = 4*IT_0131;
    const ccomplex_t IT_0136 = m_e*s_14*m_N_1;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0015;
    ...
    const ccomplex_t IT_0144 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0015;
    ...
    const ccomplex_t IT_0154 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0007 + -IT_0029 + -reg_prop, -1);
    const ccomplex_t IT_0155 = IT_0153*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*IT_0155;
    const ccomplex_t IT_0157 = IT_0118 + IT_0131;
    const ccomplex_t IT_0158 = 2*conj(IT_0142);
    const ccomplex_t IT_0159 = N_B1*e_em;
    const ccomplex_t IT_0160 = IT_0010*IT_0159;
    const ccomplex_t IT_0161 = 1.4142135623731*IT_0160;
    const ccomplex_t IT_0162 = N_W1*e_em;
    const ccomplex_t IT_0163 = IT_0015*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*(IT_0161 + IT_0164);
    const ccomplex_t IT_0166 = (-0.5)*IT_0165;
    const ccomplex_t IT_0167 = IT_0087*IT_0166;
    const ccomplex_t IT_0168 = IT_0091*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0015*IT_0021*IT_0023;
    const ccomplex_t IT_0171 = 0.5*IT_0170;
    const ccomplex_t IT_0172 = IT_0025*IT_0171;
    ...
    const ccomplex_t IT_0177 = IT_0052 + IT_0073;
    const ccomplex_t IT_0178 = 2*conj(IT_0175);
    ...
    const ccomplex_t IT_0189 = 4*IT_0175;
    const ccomplex_t IT_0190 = 4*conj(IT_0175);
    const ccomplex_t IT_0191 = 4*IT_0028;
    const ccomplex_t IT_0192 = conj(IT_0118)*IT_0143 + IT_0134*IT_0156 + 4
      *conj(IT_0131)*(0.25*IT_0143 + IT_0156) + (IT_0133 + IT_0135)*conj(IT_0156
      ) + IT_0157*IT_0158 + (conj(IT_0028) + IT_0099)*IT_0176 + (IT_0028 +
       IT_0177)*IT_0178 + 4*(conj(IT_0028) + conj(IT_0073) + 2*conj(IT_0086) + 2
      *conj(IT_0093) + 0.25*IT_0101)*IT_0188 + IT_0094*IT_0189 + IT_0095*IT_0190
       + 8*conj(IT_0188)*(IT_0095 + 0.125*IT_0100 + 0.125*IT_0102 + 0.125
      *IT_0191);
    const ccomplex_t IT_0193 = 4*IT_0086;
    const ccomplex_t IT_0194 = 4*conj(IT_0086);
    const ccomplex_t IT_0195 = 4*IT_0093;
    const ccomplex_t IT_0196 = 2*conj(IT_0156);
    const ccomplex_t IT_0197 = conj(IT_0142) + IT_0196;
    const ccomplex_t IT_0198 = 2*IT_0156;
    const ccomplex_t IT_0199 = m_e*s_24*m_C_2;
    const ccomplex_t IT_0200 = (-2)*conj(IT_0142);
    const ccomplex_t IT_0201 = (-2)*IT_0175;
    const ccomplex_t IT_0202 = (-2)*conj(IT_0175);
    const ccomplex_t IT_0203 = (-4)*IT_0052;
    const ccomplex_t IT_0204 = (-4)*IT_0073;
    const ccomplex_t IT_0205 = (-4)*conj(IT_0052);
    const ccomplex_t IT_0206 = (-4)*conj(IT_0073);
    const ccomplex_t IT_0207 = 0.25*IT_0095;
    const ccomplex_t IT_0208 = 0.25*IT_0094;
    const ccomplex_t IT_0209 = (conj(IT_0028) + (-0.5)*IT_0099)*IT_0142 +
       IT_0028*conj(IT_0142) + 0.25*IT_0177*IT_0200 + -IT_0132*(IT_0188 + (-0.25
      )*IT_0201) + -IT_0157*(conj(IT_0188) + (-0.25)*IT_0202) + IT_0196*(IT_0028
       + 0.125*IT_0193 + 0.125*IT_0195 + 0.125*IT_0203 + 0.125*IT_0204) +
       IT_0198*(conj(IT_0028) + 0.5*conj(IT_0093) + 0.125*IT_0194 + 0.125
      *IT_0205 + 0.125*IT_0206) + IT_0158*IT_0207 + IT_0143*IT_0208;
    const ccomplex_t IT_0210 = s_34*m_C_2*m_N_1;
    const ccomplex_t IT_0211 = (-2)*conj(IT_0118);
    const ccomplex_t IT_0212 = (-2)*conj(IT_0131);
    const ccomplex_t IT_0213 = (-2)*IT_0118;
    const ccomplex_t IT_0214 = (-2)*IT_0131;
    const ccomplex_t IT_0215 = 0.25*IT_0158*IT_0175 + 0.25*IT_0143*conj
      (IT_0175) + 0.25*conj(IT_0156)*IT_0189 + 0.25*IT_0156*IT_0190 + IT_0188
      *IT_0197 + conj(IT_0188)*(IT_0142 + IT_0198) + 0.25*IT_0132*(IT_0097 +
       IT_0203 + IT_0204) + 0.25*IT_0157*(IT_0098 + IT_0205 + IT_0206) + IT_0207
      *(IT_0211 + IT_0212) + IT_0208*(IT_0213 + IT_0214);
    const ccomplex_t IT_0216 = IT_0005*(conj(IT_0028)*IT_0075 + IT_0028
      *IT_0078) + IT_0080*(IT_0075*IT_0094 + IT_0078*IT_0095) + IT_0096*(IT_0094
      *IT_0097 + IT_0095*IT_0098) + IT_0000*(IT_0099*IT_0100 + IT_0073*IT_0101 +
       conj(IT_0073)*IT_0102 + IT_0132*IT_0133 + IT_0131*IT_0134 + conj(IT_0131)
      *IT_0135) + IT_0136*IT_0192 + 8*IT_0002*((IT_0175 + 2*IT_0188)*conj
      (IT_0188) + conj(IT_0175)*(IT_0188 + 0.125*IT_0189) + 0.125*IT_0094
      *IT_0193 + 0.125*IT_0093*IT_0194 + 0.125*conj(IT_0093)*IT_0195) + IT_0001*
      (conj(IT_0028)*IT_0191 + 4*IT_0197*(IT_0142 + IT_0198)) + 4*IT_0199
      *IT_0209 + 4*IT_0210*IT_0215;
