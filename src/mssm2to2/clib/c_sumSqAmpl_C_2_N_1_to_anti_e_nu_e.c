        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0000*IT_0002;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0002;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0030;
    const ccomplex_t IT_0074 = (-0.5)*IT_0073;
    const ccomplex_t IT_0075 = IT_0072*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_23 + IT_0026 + IT_0051 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = cpow((-2)*s_23 + IT_0026 + IT_0051 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0011;
    ...
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0102 = IT_0076*IT_0101;
    ...
    const ccomplex_t IT_0138 = IT_0006*IT_0122;
    const ccomplex_t IT_0139 = 2*IT_0138;
    const ccomplex_t IT_0140 = IT_0012*IT_0125;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = IT_0006*IT_0128;
    ...
    const ccomplex_t IT_0172 = m_e*s_14*m_N_1;
    const ccomplex_t IT_0173 = 2*IT_0159;
    const ccomplex_t IT_0174 = 2*conj(IT_0159);
    const ccomplex_t IT_0175 = 2*IT_0104;
    const ccomplex_t IT_0176 = 2*conj(IT_0104);
    const ccomplex_t IT_0177 = 4*conj(IT_0104);
    const ccomplex_t IT_0178 = (0.5*conj(IT_0050) + 0.5*conj(IT_0065) + conj
      (IT_0085))*IT_0117 + 0.125*conj(IT_0085)*IT_0118 + 0.125*IT_0152*conj
      (IT_0169) + conj(IT_0117)*(IT_0085 + 0.125*IT_0153 + 0.125*IT_0171) + 0.5
      *conj(IT_0151)*(IT_0169 + 0.25*IT_0173) + 0.125*IT_0151*IT_0174 + 0.125*
      (conj(IT_0050) + conj(IT_0065))*IT_0175 + 0.125*(IT_0050 + IT_0065)
      *IT_0176 + 0.125*IT_0085*IT_0177;
    const ccomplex_t IT_0179 = s_34*m_C_2*m_N_1;
    const ccomplex_t IT_0180 = (-4)*conj(IT_0151);
    const ccomplex_t IT_0181 = 4*conj(IT_0159);
    const ccomplex_t IT_0182 = (-0.5)*IT_0117;
    const ccomplex_t IT_0183 = 2*(conj(IT_0050) + -1./2*conj(IT_0065) + 1./2
      *conj(IT_0085))*IT_0151 + -(IT_0065 + -IT_0085)*conj(IT_0151) + (-4)
      *IT_0120*conj(IT_0169) + (-0.5)*conj(IT_0117)*IT_0170 + (-0.5)*conj
      (IT_0104)*IT_0173 + (-0.5)*IT_0104*IT_0174 + (-4)*IT_0169*(conj(IT_0117) +
       0.125*IT_0177) + (-0.5)*IT_0050*IT_0180 + IT_0181*IT_0182;
    const ccomplex_t IT_0184 = m_e*s_24*m_C_2;
    const ccomplex_t IT_0185 = (conj(IT_0104) + 2*conj(IT_0117))*IT_0151 +
       IT_0104*conj(IT_0151) + conj(IT_0050)*IT_0159 + IT_0050*conj(IT_0159) + 2
      *(conj(IT_0050) + (-2)*conj(IT_0065) + -conj(IT_0085))*IT_0169 + 2*
      (IT_0050 + (-2)*IT_0065 + (-0.25)*IT_0121)*conj(IT_0169) + (-0.5)*conj
      (IT_0065)*IT_0170 + (-0.5)*conj(IT_0085)*IT_0173 + (-0.5)*IT_0085*IT_0174 
      + (-0.5)*IT_0065*IT_0181 + IT_0180*IT_0182;
    const ccomplex_t IT_0186 = 2*(conj(IT_0065)*IT_0085 + IT_0065*conj(IT_0085
      ))*(IT_0067 + IT_0068 + IT_0086) + (-2)*IT_0050*(conj(IT_0065)*IT_0071 +
       conj(IT_0085)*IT_0087) + 8*IT_0068*((IT_0104 + 2*IT_0117)*conj(IT_0117) +
       conj(IT_0104)*IT_0120 + 0.125*conj(IT_0085)*IT_0121) + IT_0066*conj
      (IT_0151)*IT_0152 + (-2)*conj(IT_0050)*(IT_0065*IT_0071 + IT_0085*IT_0087 
      ...
      + 8*IT_0172*IT_0178 + (-2)*IT_0179*IT_0183 + (-2)*IT_0184*IT_0185;
