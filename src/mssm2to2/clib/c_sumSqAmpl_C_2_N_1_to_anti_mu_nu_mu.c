...
ccomplex_return_t c_sumSqAmpl_C_2_N_1_to_anti_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0013 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0014 = IT_0012*IT_0013;
    const ccomplex_t IT_0015 = 1.4142135623731*IT_0014;
    const ccomplex_t IT_0016 = conj(N_W1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0026 = pow(m_N_1, 2);
    const ccomplex_t IT_0027 = cpow((-2)*s_12 + IT_0024 + -IT_0025 + -IT_0026 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0000*IT_0002*IT_0030*IT_0031;
    const ccomplex_t IT_0033 = 0.5*IT_0032;
    const ccomplex_t IT_0034 = IT_0002*IT_0031;
    const ccomplex_t IT_0035 = IT_0016*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = IT_0011*IT_0031;
    const ccomplex_t IT_0038 = IT_0013*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = IT_0036 + IT_0039;
    const ccomplex_t IT_0041 = IT_0007*IT_0034;
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_12 + -IT_0025 + -IT_0026 + m_Hp*
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0025 + IT_0051 + reg_prop +
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0030;
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0026 + IT_0051 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0011;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0002;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0030;
    const ccomplex_t IT_0080 = (-0.5)*IT_0079;
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_23 + IT_0026 + IT_0051 + -m_smu_L*
    ...
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0000*IT_0002*IT_0030;
    const ccomplex_t IT_0100 = 0.5*IT_0099;
    const ccomplex_t IT_0101 = IT_0062*IT_0100;
    const ccomplex_t IT_0102 = IT_0072*IT_0101;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*IT_0102;
    const ccomplex_t IT_0104 = -IT_0098 + -IT_0103;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002;
    ...
    const ccomplex_t IT_0119 = 0.125*IT_0118;
    const ccomplex_t IT_0120 = IT_0117 + IT_0119;
    const ccomplex_t IT_0121 = 4*IT_0085;
    const ccomplex_t IT_0122 = 4*IT_0050;
    ...
    const ccomplex_t IT_0149 = IT_0004*IT_0148;
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0002;
    ...
    const ccomplex_t IT_0160 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0161 = IT_0002*IT_0160;
    const ccomplex_t IT_0162 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0167 = IT_0106*IT_0166;
    ...
    const ccomplex_t IT_0173 = 2*conj(IT_0104);
    const ccomplex_t IT_0174 = 2*IT_0159;
    const ccomplex_t IT_0175 = 2*conj(IT_0159);
    const ccomplex_t IT_0176 = 4*conj(IT_0104);
    const ccomplex_t IT_0177 = (conj(IT_0050) + conj(IT_0065))*IT_0104 + 4*
      (0.5*conj(IT_0050) + 0.5*conj(IT_0065) + conj(IT_0085))*IT_0117 + 0.5*conj
      (IT_0085)*IT_0118 + 0.5*IT_0153*conj(IT_0169) + 4*conj(IT_0117)*(IT_0085 +
       0.125*IT_0122 + 0.125*IT_0171) + 0.5*(IT_0050 + IT_0065)*IT_0173 + 2*conj
      (IT_0152)*(IT_0169 + 0.25*IT_0174) + 0.5*IT_0152*IT_0175 + 0.5*IT_0085
      *IT_0176;
    const ccomplex_t IT_0178 = s_34*m_C_2*m_N_1;
    const ccomplex_t IT_0179 = (-4)*IT_0152;
    const ccomplex_t IT_0180 = (-4)*conj(IT_0152);
    const ccomplex_t IT_0181 = 4*conj(IT_0159);
    const ccomplex_t IT_0182 = (-0.5)*IT_0117;
    const ccomplex_t IT_0183 = (-0.5)*conj(IT_0117);
    const ccomplex_t IT_0184 = -(conj(IT_0065) + -conj(IT_0085))*IT_0152 + -
      (IT_0065 + -IT_0085)*conj(IT_0152) + (-4)*IT_0120*conj(IT_0169) + (-0.5)
      *conj(IT_0104)*IT_0174 + (-0.5)*IT_0104*IT_0175 + (-4)*IT_0169*(conj
      (IT_0117) + 0.125*IT_0176) + (-0.5)*conj(IT_0050)*IT_0179 + (-0.5)*IT_0050
      *IT_0180 + IT_0181*IT_0182 + IT_0170*IT_0183;
    const ccomplex_t IT_0185 = m_mu*s_24*m_C_2;
    const ccomplex_t IT_0186 = conj(IT_0104)*IT_0152 + IT_0104*conj(IT_0152) +
       conj(IT_0050)*IT_0159 + IT_0050*conj(IT_0159) + 2*(conj(IT_0050) + (-2)
      *conj(IT_0065) + -conj(IT_0085))*IT_0169 + 2*(IT_0050 + (-2)*IT_0065 + (
      -0.25)*IT_0121)*conj(IT_0169) + (-0.5)*conj(IT_0065)*IT_0170 + (-0.5)*conj
      (IT_0085)*IT_0174 + (-0.5)*IT_0085*IT_0175 + (-0.5)*IT_0065*IT_0181 +
       IT_0180*IT_0182 + IT_0179*IT_0183;
    const ccomplex_t IT_0187 = 2*(conj(IT_0065)*IT_0085 + IT_0065*conj(IT_0085
      ))*(IT_0067 + IT_0068 + IT_0086) + (-2)*IT_0050*(conj(IT_0065)*IT_0071 +
       conj(IT_0085)*IT_0087) + 8*IT_0068*((IT_0104 + 2*IT_0117)*conj(IT_0117) +
       conj(IT_0104)*IT_0120 + 0.125*conj(IT_0085)*IT_0121) + (-2)*conj(IT_0050)
      *(IT_0065*IT_0071 + IT_0085*IT_0087 + (-0.5)*IT_0066*IT_0122) + IT_0066
      *conj(IT_0152)*IT_0153 + 8*IT_0067*((IT_0159 + 2*IT_0169)*conj(IT_0169) +
       conj(IT_0159)*(IT_0169 + 0.125*IT_0170) + 0.125*conj(IT_0065)*IT_0171) +
       2*IT_0172*IT_0177 + (-2)*IT_0178*IT_0184 + (-2)*IT_0185*IT_0186;
