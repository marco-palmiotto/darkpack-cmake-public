...
ccomplex_return_t c_sumSqAmpl_C_2_N_1_to_nu_tau_anti_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = conj(N_B1)*e_em*conj(U_stau_11);
    ...
    const ccomplex_t IT_0012 = conj(N_d1)*e_em*m_tau*IT_0011*conj(U_stau_01);
    const ccomplex_t IT_0013 = IT_0010*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*(IT_0005 + 0.5*IT_0014);
    const ccomplex_t IT_0016 = -IT_0015;
    const ccomplex_t IT_0017 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0018 = IT_0009*IT_0017;
    const ccomplex_t IT_0019 = conj(U_d2)*e_em*m_tau*IT_0011*U_stau_11;
    ...
    const ccomplex_t IT_0036 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0037 = IT_0009*IT_0036;
    const ccomplex_t IT_0038 = conj(U_d2)*e_em*m_tau*IT_0011*U_stau_10;
    ...
    const ccomplex_t IT_0077 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0024 + -IT_0076 + -reg_prop, -1);
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009;
    const ccomplex_t IT_0079 = 0.5*IT_0078;
    const ccomplex_t IT_0080 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0081 = IT_0009*IT_0080;
    const ccomplex_t IT_0082 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_12 + -IT_0024 + -IT_0076 + IT_0094 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0103 = IT_0002*IT_0098;
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0007*IT_0009*IT_0011*IT_0098;
    const ccomplex_t IT_0118 = 0.5*IT_0117;
    const ccomplex_t IT_0119 = IT_0006*IT_0009;
    const ccomplex_t IT_0120 = IT_0100*IT_0119;
    const ccomplex_t IT_0121 = 2*IT_0120;
    const ccomplex_t IT_0122 = IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_12 + -IT_0024 + -IT_0076 + m_Hp*
    ...
    const ccomplex_t IT_0152 = IT_0099*IT_0142;
    ...
    const ccomplex_t IT_0157 = IT_0099*IT_0136;
    ...
    const ccomplex_t IT_0183 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0184 = IT_0009*IT_0183;
    const ccomplex_t IT_0185 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0194 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_tau*IT_0007*IT_0009*IT_0011;
    ...
    const ccomplex_t IT_0204 = s_13*m_N_1*m_tau;
    ...
    const ccomplex_t IT_0212 = conj(IT_0135)*IT_0192 + 0.5*IT_0135*(conj
      ...
      (conj(IT_0199) + 0.5*IT_0206) + 0.25*IT_0046*IT_0207 + 0.5*IT_0090*IT_0208
       ...
       IT_0211);
    const ccomplex_t IT_0213 = s_34*m_C_2*m_N_1;
