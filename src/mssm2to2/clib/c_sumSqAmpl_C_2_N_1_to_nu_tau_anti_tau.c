        ...
        )
{
    ...
    const ccomplex_t IT_0017 = conj(N_B1)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = 1.4142135623731*IT_0018;
    const ccomplex_t IT_0020 = conj(N_d1)*e_em*m_tau*IT_0010*conj(U_stau_01);
    ...
    const ccomplex_t IT_0035 = conj(N_B1)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0036 = IT_0016*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = conj(N_d1)*e_em*m_tau*IT_0010*conj(U_stau_00);
    ...
    const ccomplex_t IT_0053 = N_d1*e_em*m_tau*IT_0010*conj(U_stau_11);
    ...
    const ccomplex_t IT_0067 = N_d1*e_em*m_tau*IT_0010*conj(U_stau_10);
    ...
    const ccomplex_t IT_0086 = pow(m_N_1, 2);
