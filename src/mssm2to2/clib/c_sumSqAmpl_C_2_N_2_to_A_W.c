        ...
        )
{
    ...
    const ccomplex_t IT_0032 = m_N_2*IT_0031;
    ...
    const ccomplex_t IT_0043 = N_u2*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0063 = m_N_2*IT_0000;
    ...
    const ccomplex_t IT_0071 = IT_0025*IT_0033;
    const ccomplex_t IT_0072 = -IT_0071;
    const ccomplex_t IT_0073 = IT_0025*IT_0063;
    ...
    const ccomplex_t IT_0095 = IT_0015*IT_0036;
    ...
    const ccomplex_t IT_0107 = m_C_2*IT_0031;
    const ccomplex_t IT_0108 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_C_2
      *Gamma_c2 + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0109 = IT_0000*IT_0010;
    ...
    const ccomplex_t IT_0113 = 2*IT_0096;
    const ccomplex_t IT_0114 = (-2)*IT_0074;
    const ccomplex_t IT_0115 = IT_0113 + IT_0114;
    const ccomplex_t IT_0116 = 2*conj(IT_0096);
    const ccomplex_t IT_0117 = (-2)*conj(IT_0074);
    const ccomplex_t IT_0118 = IT_0116 + IT_0117;
    const ccomplex_t IT_0119 = IT_0000*IT_0023;
    const ccomplex_t IT_0120 = IT_0108*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*IT_0120;
    const ccomplex_t IT_0122 = -IT_0071 + IT_0121;
    const ccomplex_t IT_0123 = 2*IT_0065;
    const ccomplex_t IT_0124 = (-2)*IT_0037;
    const ccomplex_t IT_0125 = IT_0123 + IT_0124;
    const ccomplex_t IT_0126 = 2*conj(IT_0065);
    const ccomplex_t IT_0127 = (-2)*conj(IT_0037);
    const ccomplex_t IT_0128 = IT_0126 + IT_0127;
    const ccomplex_t IT_0129 = pow(s_14, 2);
    const ccomplex_t IT_0130 = IT_0028*IT_0129;
    const ccomplex_t IT_0131 = -IT_0011;
    ...
    const ccomplex_t IT_0152 = s_12*IT_0132;
    const ccomplex_t IT_0153 = s_12*IT_0105;
    const ccomplex_t IT_0154 = IT_0000*IT_0025;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = 4*IT_0155*conj(IT_0155);
    const ccomplex_t IT_0157 = IT_0000*IT_0015;
    ...
    const ccomplex_t IT_0177 = (-0.5)*IT_0121;
    const ccomplex_t IT_0178 = 4*IT_0170;
    const ccomplex_t IT_0179 = 4*IT_0026;
    const ccomplex_t IT_0180 = 4*conj(IT_0026);
    const ccomplex_t IT_0181 = (-0.5)*IT_0111;
    const ccomplex_t IT_0182 = 0.25*IT_0175*IT_0177 + 0.25*IT_0174*conj
      (IT_0177) + IT_0016*(conj(IT_0170) + conj(IT_0177)) + conj(IT_0016)*
      (IT_0177 + 0.25*IT_0178) + 0.25*conj(IT_0173)*(12*IT_0170 + IT_0179) +
       0.25*IT_0173*(12*conj(IT_0170) + IT_0180) + 0.25*(IT_0172 + IT_0180)
      *IT_0181 + 0.25*(IT_0171 + IT_0179)*conj(IT_0181);
    const ccomplex_t IT_0183 = m_C_2*m_N_2;
    const ccomplex_t IT_0184 = IT_0132*IT_0183;
    ...
    const ccomplex_t IT_0194 = conj(IT_0096)*IT_0141 + IT_0096*IT_0144 + conj
      (IT_0074)*IT_0148 + IT_0074*IT_0151 + (conj(IT_0072)*IT_0112 + IT_0072
      *conj(IT_0112) + conj(IT_0035)*IT_0122 + IT_0035*conj(IT_0122))*IT_0189 + 
      (conj(IT_0112)*IT_0170 + IT_0112*conj(IT_0170) + conj(IT_0122)*IT_0173 +
       IT_0122*conj(IT_0173))*IT_0190 + (conj(IT_0035)*IT_0170 + IT_0035*conj
      (IT_0170) + conj(IT_0072)*IT_0173 + IT_0072*conj(IT_0173))*IT_0191 + (conj
      (IT_0112)*IT_0122 + IT_0112*conj(IT_0122))*IT_0192 + (conj(IT_0035)
    ...
    const ccomplex_t IT_0207 = (conj(IT_0035)*IT_0112 + IT_0035*conj(IT_0112) 
      + conj(IT_0072)*IT_0122 + IT_0072*conj(IT_0122))*IT_0202 + (conj(IT_0122)
      *IT_0170 + IT_0122*conj(IT_0170) + conj(IT_0112)*IT_0173 + IT_0112*conj
      (IT_0173))*IT_0203 + (conj(IT_0072)*IT_0170 + IT_0072*conj(IT_0170) + conj
      (IT_0035)*IT_0173 + IT_0035*conj(IT_0173))*IT_0204 + (IT_0112*conj(IT_0112
      ) + IT_0122*conj(IT_0122))*IT_0205 + (IT_0035*conj(IT_0035) + IT_0072*conj
      (IT_0072))*IT_0206;
    ...
    const ccomplex_t IT_0224 = s_23*IT_0028*IT_0129;
    ...
    const ccomplex_t IT_0243 = (-4)*IT_0158*conj(IT_0181);
    const ccomplex_t IT_0244 = (-4)*conj(IT_0158)*IT_0181;
    const ccomplex_t IT_0245 = IT_0011*IT_0031;
    const ccomplex_t IT_0246 = 2*IT_0122;
    ...
    const ccomplex_t IT_0252 = (-2)*IT_0122;
    const ccomplex_t IT_0253 = IT_0012*IT_0132;
    const ccomplex_t IT_0254 = (-2)*IT_0072;
    const ccomplex_t IT_0255 = 2*conj(IT_0122);
    const ccomplex_t IT_0256 = 2*conj(IT_0072);
    const ccomplex_t IT_0257 = (-2)*conj(IT_0122);
    ...
    const ccomplex_t IT_0262 = 2*IT_0112;
    const ccomplex_t IT_0263 = 2*IT_0035;
    const ccomplex_t IT_0264 = (-8)*IT_0158;
    const ccomplex_t IT_0265 = (-2)*IT_0112;
    const ccomplex_t IT_0266 = (-2)*IT_0035;
    const ccomplex_t IT_0267 = 0.125*IT_0032*IT_0067 + 0.125*IT_0098*IT_0106 +
       0.125*IT_0107*IT_0115 + 0.125*IT_0125*IT_0133 + 0.125*IT_0184*IT_0246 +
       0.125*IT_0188*IT_0248 + 0.125*(IT_0252 + IT_0254)*IT_0259 + IT_0155*
      (IT_0184 + IT_0188 + (-2)*IT_0259) + 0.125*IT_0170*((-10)*IT_0260 + (-10)
      *IT_0261) + 0.125*IT_0245*IT_0262 + 0.125*IT_0247*IT_0263 + 0.125*IT_0249
      *IT_0264 + 0.125*IT_0251*IT_0265 + 0.125*IT_0253*IT_0266;
    const ccomplex_t IT_0268 = 2*conj(IT_0112);
    const ccomplex_t IT_0269 = 2*conj(IT_0035);
    const ccomplex_t IT_0270 = (-2)*conj(IT_0112);
    const ccomplex_t IT_0271 = (-2)*conj(IT_0035);
    const ccomplex_t IT_0272 = IT_0032*IT_0070 + IT_0101*IT_0106 + IT_0107
      *IT_0118 + IT_0128*IT_0133 + IT_0184*IT_0255 + IT_0188*IT_0256 + ((-16)
    ...
    const ccomplex_t IT_0284 = conj(IT_0026)*IT_0273;
    const ccomplex_t IT_0285 = IT_0026*IT_0274;
    const ccomplex_t IT_0286 = conj(IT_0016)*IT_0158;
    const ccomplex_t IT_0287 = (-2)*IT_0286;
    const ccomplex_t IT_0288 = IT_0016*conj(IT_0158);
    ...
    const ccomplex_t IT_0292 = IT_0011*IT_0214;
    const ccomplex_t IT_0293 = IT_0012*IT_0210;
    const ccomplex_t IT_0294 = m_C_2*IT_0214;
    const ccomplex_t IT_0295 = -IT_0136;
    const ccomplex_t IT_0296 = m_N_2*IT_0210;
    const ccomplex_t IT_0297 = -IT_0065;
    const ccomplex_t IT_0298 = (-0.25)*IT_0292;
    const ccomplex_t IT_0299 = (-0.25)*IT_0293;
    const ccomplex_t IT_0300 = -conj(IT_0065);
    const ccomplex_t IT_0301 = s_23*IT_0011*IT_0039;
    const ccomplex_t IT_0302 = s_24*s_34*IT_0011;
    const ccomplex_t IT_0303 = (-2)*IT_0302;
    const ccomplex_t IT_0304 = IT_0301 + IT_0303;
    const ccomplex_t IT_0305 = IT_0028*IT_0304;
    const ccomplex_t IT_0306 = (-0.5)*IT_0305;
    const ccomplex_t IT_0307 = IT_0225 + IT_0306;
    const ccomplex_t IT_0308 = s_12*s_23*IT_0039;
    const ccomplex_t IT_0309 = s_13*IT_0102;
    const ccomplex_t IT_0310 = IT_0308 + IT_0309;
    const ccomplex_t IT_0311 = s_14*s_23*s_24;
    const ccomplex_t IT_0312 = s_12*s_24*s_34;
    const ccomplex_t IT_0313 = s_13*IT_0012*IT_0039;
    const ccomplex_t IT_0314 = -IT_0311 + -IT_0312 + (-0.5)*IT_0313;
    const ccomplex_t IT_0315 = IT_0310 + IT_0314;
    const ccomplex_t IT_0316 = IT_0028*IT_0315;
    const ccomplex_t IT_0317 = s_12*s_23;
    const ccomplex_t IT_0318 = (-2)*IT_0317;
    const ccomplex_t IT_0319 = IT_0235 + IT_0316 + IT_0318;
    const ccomplex_t IT_0320 = s_13*s_23*IT_0039;
    const ccomplex_t IT_0321 = s_12*IT_0161;
    const ccomplex_t IT_0322 = IT_0320 + IT_0321;
    const ccomplex_t IT_0323 = s_14*s_23*s_34;
    const ccomplex_t IT_0324 = s_13*s_24*s_34;
    const ccomplex_t IT_0325 = -IT_0323 + -IT_0324;
    const ccomplex_t IT_0326 = IT_0322 + IT_0325;
    const ccomplex_t IT_0327 = IT_0028*IT_0326;
    const ccomplex_t IT_0328 = (-0.5)*IT_0327;
    const ccomplex_t IT_0329 = IT_0027 + IT_0328;
    const ccomplex_t IT_0330 = s_23*IT_0039;
    const ccomplex_t IT_0331 = s_24*s_34;
    ...
    const ccomplex_t IT_0350 = IT_0028*IT_0340;
    const ccomplex_t IT_0351 = (-0.25)*IT_0350;
    const ccomplex_t IT_0352 = s_13 + IT_0351;
    const ccomplex_t IT_0353 = IT_0183*IT_0352;
    const ccomplex_t IT_0354 = (-4)*IT_0353;
    const ccomplex_t IT_0355 = (-0.25)*IT_0354;
    const ccomplex_t IT_0356 = IT_0028*IT_0330;
    const ccomplex_t IT_0357 = (-0.25)*IT_0356;
    const ccomplex_t IT_0358 = s_23 + IT_0357;
    const ccomplex_t IT_0359 = IT_0183*IT_0358;
    const ccomplex_t IT_0360 = (-4)*IT_0359;
    const ccomplex_t IT_0361 = (-0.25)*IT_0360;
    const ccomplex_t IT_0362 = s_34*IT_0028;
    const ccomplex_t IT_0363 = s_14*s_23;
    const ccomplex_t IT_0364 = s_13*s_24;
    const ccomplex_t IT_0365 = s_12*s_34;
    const ccomplex_t IT_0366 = -IT_0364 + -IT_0365;
    const ccomplex_t IT_0367 = IT_0363 + IT_0366;
    const ccomplex_t IT_0368 = IT_0362*IT_0367;
    const ccomplex_t IT_0369 = (-0.25)*IT_0368;
    const ccomplex_t IT_0370 = (-2)*IT_0324;
    const ccomplex_t IT_0371 = IT_0320 + IT_0370;
    const ccomplex_t IT_0372 = IT_0028*IT_0371;
    const ccomplex_t IT_0373 = (-8)*IT_0372;
    const ccomplex_t IT_0374 = 16*IT_0027;
    const ccomplex_t IT_0375 = IT_0373 + IT_0374;
    const ccomplex_t IT_0376 = conj(IT_0122)*IT_0307 + -conj(IT_0072)*IT_0319 
      + 2*conj(IT_0026)*IT_0329 + IT_0128*IT_0339 + IT_0101*IT_0349 + IT_0268
      *IT_0355 + IT_0269*IT_0361 + IT_0218*IT_0369 + (-0.25)*conj(IT_0177)
      *IT_0375;
    const ccomplex_t IT_0377 = conj(IT_0112)*IT_0307 + -conj(IT_0035)*IT_0319 
      + 2*conj(IT_0016)*IT_0329 + IT_0118*IT_0339 + IT_0070*IT_0349 + IT_0255
      *IT_0355 + IT_0256*IT_0361 + IT_0222*IT_0369 + (-0.25)*conj(IT_0181)
      *IT_0375;
    const ccomplex_t IT_0378 = (-2)*IT_0026;
    const ccomplex_t IT_0379 = IT_0276 + IT_0378;
    const ccomplex_t IT_0380 = (-2)*conj(IT_0026);
    const ccomplex_t IT_0381 = IT_0278 + IT_0380;
    const ccomplex_t IT_0382 = (-10)*IT_0158*conj(IT_0170);
    const ccomplex_t IT_0383 = (-10)*IT_0155*conj(IT_0173);
    const ccomplex_t IT_0384 = (-10)*conj(IT_0155)*IT_0173;
    const ccomplex_t IT_0385 = (-8)*conj(IT_0155)*IT_0181;
    const ccomplex_t IT_0386 = conj(IT_0177)*IT_0264;
    const ccomplex_t IT_0387 = (-8)*conj(IT_0158)*IT_0177;
    const ccomplex_t IT_0388 = conj(IT_0158)*IT_0378;
    const ccomplex_t IT_0389 = IT_0158*IT_0380;
    const ccomplex_t IT_0390 = conj(IT_0181)*IT_0250;
    const ccomplex_t IT_0391 = conj(IT_0173)*IT_0252 + IT_0173*IT_0257 + conj
      (IT_0016)*(IT_0252 + IT_0273) + IT_0016*(IT_0257 + IT_0274) + conj(IT_0112
      )*IT_0379 + IT_0112*IT_0381 + IT_0382 + IT_0383 + IT_0384 + IT_0385 +
       IT_0386 + IT_0387 + IT_0388 + IT_0389 + IT_0390;
    const ccomplex_t IT_0392 = conj(IT_0173)*IT_0254 + IT_0173*IT_0258 + conj
      (IT_0016)*(IT_0254 + IT_0273) + IT_0016*(IT_0258 + IT_0274) + conj(IT_0035
      )*IT_0379 + IT_0035*IT_0381 + IT_0382 + IT_0383 + IT_0384 + IT_0385 +
       IT_0386 + IT_0387 + IT_0388 + IT_0389 + IT_0390;
    const ccomplex_t IT_0393 = (12*IT_0016*conj(IT_0016) + 12*IT_0026*conj
      ...
      *conj(IT_0072) + conj(IT_0035)*IT_0098 + IT_0035*IT_0101)*IT_0106 +
       IT_0107*(conj(IT_0112)*IT_0115 + IT_0112*IT_0118 + conj(IT_0122)*IT_0125 
      + IT_0122*IT_0128) + (IT_0118*IT_0122 + IT_0115*conj(IT_0122) + conj
      (IT_0112)*IT_0125 + IT_0112*IT_0128)*IT_0133 + 6*IT_0134*(conj(IT_0026)
      *IT_0136 + IT_0026*IT_0138 + 0.166666666666667*conj(IT_0016)*IT_0141 +
      ...
      (IT_0074) + IT_0096*conj(IT_0096))*IT_0160 + IT_0168*(conj(IT_0026)
      *IT_0171 + IT_0026*IT_0172 + conj(IT_0016)*IT_0174 + IT_0016*IT_0175) + 4
      *IT_0176*IT_0182 + IT_0184*(conj(IT_0112)*IT_0185 + IT_0112*IT_0186 +
      ...
      *IT_0098 + IT_0067*IT_0106 + IT_0107*IT_0125 + IT_0115*IT_0133 + IT_0245
      *IT_0246 + IT_0247*IT_0248 + IT_0249*IT_0250 + IT_0251*IT_0252 + IT_0253
      *IT_0254) + IT_0155*(IT_0032*IT_0101 + IT_0070*IT_0106 + IT_0107*IT_0128 +
       IT_0118*IT_0133 + IT_0245*IT_0255 + IT_0247*IT_0256 + IT_0251*IT_0257 +
       IT_0253*IT_0258) + 8*conj(IT_0158)*IT_0267 + IT_0158*IT_0272 + IT_0259*(
      (conj(IT_0035) + conj(IT_0112))*IT_0273 + (IT_0035 + IT_0112)*IT_0274) +
       IT_0275*(conj(IT_0026)*IT_0252 + IT_0026*IT_0257 + conj(IT_0016)*IT_0265 
      + IT_0016*IT_0270 + IT_0277 + IT_0279 + IT_0281 + IT_0283 + IT_0284 +
       IT_0285 + IT_0287 + IT_0289) + (conj(IT_0026)*IT_0254 + IT_0026*IT_0258 +
       conj(IT_0016)*IT_0266 + IT_0016*IT_0271 + IT_0277 + IT_0279 + IT_0281 +
       IT_0283 + IT_0284 + IT_0285 + IT_0287 + IT_0289)*IT_0291 + 4*conj(IT_0173
      )*(IT_0162*IT_0173 + 0.25*IT_0168*IT_0174 + 0.25*IT_0262*IT_0292 + 0.25
      *IT_0263*IT_0293 + IT_0294*IT_0295 + IT_0296*(IT_0037 + IT_0297)) + conj
      (IT_0170)*(IT_0168*IT_0171 + IT_0162*IT_0178 + (-4)*IT_0295*IT_0296 + (-4)
      *IT_0294*(IT_0037 + IT_0297) + (-4)*IT_0246*IT_0298 + (-4)*IT_0248*IT_0299
      ) + 4*IT_0170*(IT_0138*IT_0296 + -IT_0255*IT_0298 + -IT_0256*IT_0299 + 
      -IT_0294*(conj(IT_0037) + IT_0300)) + (-4)*IT_0173*(IT_0138*IT_0294 +
       IT_0268*IT_0298 + IT_0269*IT_0299 + -IT_0296*(conj(IT_0037) + IT_0300)) +
       (-4)*conj(IT_0177)*(IT_0122*IT_0307 + -IT_0072*IT_0319 + 2*IT_0026
      *IT_0329 + IT_0125*IT_0339 + IT_0098*IT_0349 + IT_0262*IT_0355 + IT_0263
      *IT_0361 + IT_0216*IT_0369) + (-4)*conj(IT_0181)*(IT_0112*IT_0307 + 
      -IT_0035*IT_0319 + 2*IT_0016*IT_0329 + IT_0115*IT_0339 + IT_0067*IT_0349 +
       IT_0246*IT_0355 + IT_0248*IT_0361 + IT_0220*IT_0369) + (-4)*IT_0177
      *IT_0376 + (-4)*IT_0181*IT_0377 + IT_0260*IT_0391 + IT_0261*IT_0392;
