...
ccomplex_return_t c_sumSqAmpl_C_2_N_2_to_anti_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_d2)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0013 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0014 = IT_0012*IT_0013;
    const ccomplex_t IT_0015 = 1.4142135623731*IT_0014;
    const ccomplex_t IT_0016 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0040 = IT_0016*IT_0034;
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0011;
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0030;
    ...
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
    ...
    const ccomplex_t IT_0160 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0161 = IT_0002*IT_0160;
    const ccomplex_t IT_0162 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0172 = m_mu*s_14*m_N_2;
    ...
    const ccomplex_t IT_0177 = (conj(IT_0050) + conj(IT_0065))*IT_0104 + 4*
      ...
      *IT_0176;
    const ccomplex_t IT_0178 = s_34*m_C_2*m_N_2;
