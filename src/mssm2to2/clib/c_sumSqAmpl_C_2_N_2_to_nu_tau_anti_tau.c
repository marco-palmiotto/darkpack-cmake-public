        ...
        )
{
    ...
    const ccomplex_t IT_0017 = conj(N_B2)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = 1.4142135623731*IT_0018;
    const ccomplex_t IT_0020 = conj(N_d2)*e_em*m_tau*IT_0010*conj(U_stau_01);
    ...
    const ccomplex_t IT_0035 = conj(N_B2)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0036 = IT_0016*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = conj(N_d2)*e_em*m_tau*IT_0010*conj(U_stau_00);
    ...
    const ccomplex_t IT_0086 = pow(m_N_2, 2);
    ...
    const ccomplex_t IT_0204 = s_13*m_N_2*m_tau;
    ...
    const ccomplex_t IT_0212 = conj(IT_0135)*IT_0192 + 0.5*IT_0135*(conj
      ...
      (conj(IT_0199) + 0.5*IT_0206) + 0.25*IT_0046*IT_0207 + 0.5*IT_0090*IT_0208
       ...
       IT_0211);
    const ccomplex_t IT_0213 = s_34*m_C_2*m_N_2;
