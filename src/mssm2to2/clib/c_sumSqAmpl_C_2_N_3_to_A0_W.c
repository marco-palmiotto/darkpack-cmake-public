        ...
        )
{
    ...
    const ccomplex_t IT_0057 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0058 = IT_0011*IT_0057;
    const ccomplex_t IT_0059 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0034 + IT_0035 + -m_N_2*
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_23 + IT_0034 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_12 + -IT_0035 + -IT_0103 + m_Hp*
    ...
    const ccomplex_t IT_0112 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0113 = IT_0012*IT_0112;
    const ccomplex_t IT_0114 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0115 = IT_0015*IT_0114;
    const ccomplex_t IT_0116 = N_B3*N_u4*e_em;
    ...
    const ccomplex_t IT_0122 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0034 + IT_0035 + -m_N_4*
    ...
    const ccomplex_t IT_0136 = (-2)*IT_0039 + (-2)*IT_0067 + (-2)*IT_0087 +
       IT_0107 + (-2)*IT_0135;
    ...
    const ccomplex_t IT_0150 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0151 = IT_0011*IT_0150;
    const ccomplex_t IT_0152 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0158 = cpow((-2)*s_13 + IT_0034 + IT_0103 + -m_C_1*
    ...
    const ccomplex_t IT_0197 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0198 = IT_0003*IT_0197;
    const ccomplex_t IT_0199 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0200 = IT_0007*IT_0199;
    const ccomplex_t IT_0201 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0202 = IT_0012*IT_0201;
    const ccomplex_t IT_0203 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0216 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0217 = IT_0003*IT_0216;
    const ccomplex_t IT_0218 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0219 = IT_0007*IT_0218;
    const ccomplex_t IT_0220 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0221 = IT_0012*IT_0220;
    const ccomplex_t IT_0222 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0223 = IT_0015*IT_0222;
    const ccomplex_t IT_0224 = IT_0217 + -IT_0219 + -IT_0221 + IT_0223;
    const ccomplex_t IT_0225 = IT_0084*IT_0175;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = IT_0224*IT_0226;
    const ccomplex_t IT_0228 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0229 = IT_0003*IT_0228;
    const ccomplex_t IT_0230 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0231 = IT_0007*IT_0230;
    const ccomplex_t IT_0232 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0233 = IT_0012*IT_0232;
    const ccomplex_t IT_0234 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0235 = IT_0015*IT_0234;
    const ccomplex_t IT_0236 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0237 = IT_0003*IT_0236;
    const ccomplex_t IT_0238 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0239 = IT_0007*IT_0238;
    const ccomplex_t IT_0240 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0241 = IT_0012*IT_0240;
    const ccomplex_t IT_0242 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0245 = N_W2*e_em*conj(U_Wm2);
    const ccomplex_t IT_0246 = IT_0011*IT_0245;
    const ccomplex_t IT_0247 = N_d2*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0252 = IT_0064*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = IT_0244*IT_0253;
    const ccomplex_t IT_0255 = 2*IT_0215 + IT_0227 + 2*IT_0254;
    const ccomplex_t IT_0256 = m_C_2*m_N_3;
    const ccomplex_t IT_0257 = IT_0141*IT_0256;
    const ccomplex_t IT_0258 = IT_0182*IT_0256;
    const ccomplex_t IT_0259 = (-2)*conj(IT_0107);
    const ccomplex_t IT_0260 = 0.5*IT_0259;
    const ccomplex_t IT_0261 = conj(IT_0179) + IT_0260;
    const ccomplex_t IT_0262 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0263 = IT_0000*IT_0262;
    const ccomplex_t IT_0264 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0265 = IT_0006*IT_0264;
    const ccomplex_t IT_0266 = IT_0011*(IT_0263 + IT_0265);
    const ccomplex_t IT_0267 = 1.4142135623731*e_em*IT_0266;
    const ccomplex_t IT_0268 = (-0.5)*IT_0267;
    const ccomplex_t IT_0269 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0270 = IT_0011*IT_0269;
    const ccomplex_t IT_0271 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0302 = IT_0104*IT_0301;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1)*IT_0302;
    const ccomplex_t IT_0304 = IT_0089*IT_0303;
    const ccomplex_t IT_0305 = (-2)*IT_0278 + (-2)*IT_0288 + -IT_0304;
    const ccomplex_t IT_0306 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0307 = IT_0003*IT_0306;
    const ccomplex_t IT_0308 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0309 = IT_0007*IT_0308;
    const ccomplex_t IT_0310 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0311 = IT_0012*IT_0310;
    const ccomplex_t IT_0312 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0313 = IT_0015*IT_0312;
    const ccomplex_t IT_0314 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0320 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0350 = m_N_2*IT_0056;
    const ccomplex_t IT_0351 = IT_0253*IT_0350;
    const ccomplex_t IT_0352 = m_N_3*IT_0076;
    const ccomplex_t IT_0353 = IT_0226*IT_0352;
    const ccomplex_t IT_0354 = IT_0344 + IT_0347 + -IT_0349 + -IT_0351 + (-0.5
      )*IT_0353;
    const ccomplex_t IT_0355 = m_C_2*IT_0076;
    const ccomplex_t IT_0356 = IT_0086*IT_0355;
    const ccomplex_t IT_0357 = m_C_2*IT_0026;
    const ccomplex_t IT_0358 = IT_0038*IT_0357;
    const ccomplex_t IT_0359 = m_C_2*IT_0056;
    const ccomplex_t IT_0360 = IT_0066*IT_0359;
    const ccomplex_t IT_0361 = m_N_3*IT_0278;
    const ccomplex_t IT_0362 = m_N_3*IT_0288;
    const ccomplex_t IT_0363 = m_N_4*IT_0124;
    const ccomplex_t IT_0364 = IT_0331*IT_0363;
    const ccomplex_t IT_0365 = m_C_2*IT_0124;
    const ccomplex_t IT_0366 = IT_0134*IT_0365;
    const ccomplex_t IT_0367 = (-0.5)*IT_0353 + IT_0356 + IT_0358 + IT_0360 + 
      -IT_0361 + -IT_0362 + -IT_0364 + IT_0366;
    const ccomplex_t IT_0368 = IT_0354 + IT_0367;
    const ccomplex_t IT_0369 = m_C_2*IT_0187;
    const ccomplex_t IT_0370 = m_C_2*IT_0244;
    const ccomplex_t IT_0371 = IT_0253*IT_0370;
    const ccomplex_t IT_0372 = m_N_3*IT_0160;
    const ccomplex_t IT_0373 = m_C_2*IT_0205;
    const ccomplex_t IT_0374 = IT_0214*IT_0373;
    const ccomplex_t IT_0375 = m_C_2*IT_0224;
    const ccomplex_t IT_0376 = IT_0226*IT_0375;
    const ccomplex_t IT_0377 = m_N_3*IT_0178;
    const ccomplex_t IT_0378 = IT_0371 + -IT_0372 + IT_0374 + 0.5*IT_0376 + 
      -IT_0377;
    const ccomplex_t IT_0379 = IT_0083*IT_0168;
    const ccomplex_t IT_0380 = IT_0161*IT_0343*IT_0379;
    const ccomplex_t IT_0381 = IT_0149*IT_0275;
    const ccomplex_t IT_0382 = IT_0158*IT_0346*IT_0381;
    const ccomplex_t IT_0383 = m_N_3*IT_0224;
    const ccomplex_t IT_0384 = IT_0086*IT_0383;
    const ccomplex_t IT_0385 = m_N_4*IT_0322;
    const ccomplex_t IT_0386 = IT_0134*IT_0385;
    const ccomplex_t IT_0387 = m_N_1*IT_0205;
    const ccomplex_t IT_0388 = IT_0038*IT_0387;
    const ccomplex_t IT_0389 = m_N_2*IT_0244;
    const ccomplex_t IT_0390 = IT_0066*IT_0389;
    const ccomplex_t IT_0391 = m_C_2*IT_0322;
    const ccomplex_t IT_0392 = IT_0331*IT_0391;
    const ccomplex_t IT_0393 = 0.5*IT_0376 + IT_0380 + IT_0382 + -IT_0384 + 
    ...
    const ccomplex_t IT_0404 = IT_0039 + IT_0067 + IT_0087 + IT_0135;
    const ccomplex_t IT_0405 = -IT_0215 + (-0.5)*IT_0227 + -IT_0254;
    const ccomplex_t IT_0406 = 0.5*IT_0227 + IT_0332;
    ...
    const ccomplex_t IT_0417 = (-2)*IT_0378;
    const ccomplex_t IT_0418 = (-2)*IT_0393;
    const ccomplex_t IT_0419 = IT_0417 + IT_0418;
    const ccomplex_t IT_0420 = (-2)*conj(IT_0378);
    const ccomplex_t IT_0421 = (-2)*conj(IT_0393);
    const ccomplex_t IT_0422 = IT_0420 + IT_0421;
    const ccomplex_t IT_0423 = 6*conj(IT_0354);
    const ccomplex_t IT_0424 = m_N_3*IT_0141;
    const ccomplex_t IT_0425 = (-2)*IT_0179;
    const ccomplex_t IT_0426 = 0.5*IT_0425;
    const ccomplex_t IT_0427 = IT_0107 + IT_0426;
    const ccomplex_t IT_0428 = IT_0396 + IT_0402;
    const ccomplex_t IT_0429 = IT_0137*IT_0428;
    const ccomplex_t IT_0430 = (-0.5)*IT_0429;
    const ccomplex_t IT_0431 = s_12 + IT_0430;
    const ccomplex_t IT_0432 = m_C_2*IT_0182;
    const ccomplex_t IT_0433 = (-2)*IT_0136;
    const ccomplex_t IT_0434 = s_14*IT_0395;
    const ccomplex_t IT_0435 = IT_0137*IT_0434;
    const ccomplex_t IT_0436 = 0.5*IT_0435;
    const ccomplex_t IT_0437 = s_14 + IT_0436;
    const ccomplex_t IT_0438 = m_N_3*IT_0437;
    const ccomplex_t IT_0439 = 2*IT_0438;
    const ccomplex_t IT_0440 = 2*conj(IT_0367)*(IT_0305*IT_0341 + 3*IT_0256
      *IT_0394 + IT_0404*IT_0416 + IT_0336*IT_0424 + IT_0369*IT_0427 + 2*IT_0368
      *IT_0431 + 0.5*IT_0432*IT_0433 + IT_0405*IT_0439);
    const ccomplex_t IT_0441 = IT_0278 + IT_0288;
    const ccomplex_t IT_0442 = 0.5*IT_0412;
    const ccomplex_t IT_0443 = s_24 + IT_0442;
    const ccomplex_t IT_0444 = m_C_2*IT_0443;
    const ccomplex_t IT_0445 = 2*IT_0444;
    const ccomplex_t IT_0446 = -IT_0160 + -IT_0178;
    const ccomplex_t IT_0447 = (-0.25)*IT_0435;
    const ccomplex_t IT_0448 = s_14 + IT_0447;
    const ccomplex_t IT_0449 = m_N_3*IT_0448;
    const ccomplex_t IT_0450 = (-4)*IT_0449;
    const ccomplex_t IT_0451 = 4*IT_0378;
    const ccomplex_t IT_0452 = 3*IT_0256*IT_0368 + IT_0305*IT_0369 + IT_0406
      *IT_0416 + IT_0341*IT_0427 + IT_0336*IT_0432 + 0.5*IT_0424*IT_0433 +
       IT_0441*IT_0445 + IT_0446*IT_0450 + 2*IT_0431*(IT_0393 + 0.25*IT_0451);
    const ccomplex_t IT_0453 = (-2)*conj(IT_0136);
    const ccomplex_t IT_0454 = s_12*s_14;
    const ccomplex_t IT_0455 = s_24*IT_0103;
    const ccomplex_t IT_0456 = -IT_0455;
    const ccomplex_t IT_0457 = IT_0454 + IT_0456;
    const ccomplex_t IT_0458 = (-2)*IT_0255;
    const ccomplex_t IT_0459 = 0.5*IT_0458;
    const ccomplex_t IT_0460 = IT_0333 + IT_0459;
    const ccomplex_t IT_0461 = IT_0404 + IT_0446;
    const ccomplex_t IT_0462 = conj(IT_0404) + conj(IT_0446);
    const ccomplex_t IT_0463 = IT_0405 + IT_0441;
    const ccomplex_t IT_0464 = (-2)*conj(IT_0333);
    const ccomplex_t IT_0465 = (-2)*conj(IT_0255);
    const ccomplex_t IT_0466 = (-2)*IT_0354;
    const ccomplex_t IT_0467 = (-2)*conj(IT_0354);
    const ccomplex_t IT_0468 = IT_0256*IT_0395;
    const ccomplex_t IT_0469 = (-3)*IT_0468;
    const ccomplex_t IT_0470 = (-0.25)*IT_0399;
    const ccomplex_t IT_0471 = IT_0401 + IT_0470;
    const ccomplex_t IT_0472 = (-2)*IT_0367;
    const ccomplex_t IT_0473 = IT_0466 + IT_0472;
    const ccomplex_t IT_0474 = 3*IT_0468;
    const ccomplex_t IT_0475 = (-2)*IT_0404;
    const ccomplex_t IT_0476 = (-2)*conj(IT_0367);
    const ccomplex_t IT_0477 = IT_0467 + IT_0476;
    const ccomplex_t IT_0478 = (-2)*conj(IT_0404);
    const ccomplex_t IT_0479 = s_12*s_24;
    const ccomplex_t IT_0480 = s_14*IT_0035;
    const ccomplex_t IT_0481 = -IT_0480;
    const ccomplex_t IT_0482 = IT_0479 + IT_0481;
    const ccomplex_t IT_0483 = (-2)*IT_0446;
    const ccomplex_t IT_0484 = 0.5*IT_0406;
    const ccomplex_t IT_0485 = 0.5*conj(IT_0406);
    const ccomplex_t IT_0486 = 0.5*IT_0183;
    const ccomplex_t IT_0487 = IT_0394*IT_0432;
    const ccomplex_t IT_0488 = (-2)*conj(IT_0179);
    const ccomplex_t IT_0489 = IT_0258*IT_0333;
    ...
    const ccomplex_t IT_0492 = 2*IT_0136*(conj(IT_0136)*IT_0142 + conj(IT_0179
      ...
      *IT_0255*(conj(IT_0136)*IT_0257 + IT_0258*IT_0261) + 2*conj(IT_0305)*
      (IT_0136*IT_0258 + IT_0188*IT_0305 + IT_0183*IT_0336 + IT_0337*IT_0340 +
       IT_0341*IT_0368 + IT_0369*IT_0394) + (-4)*IT_0403*(IT_0404*conj(IT_0404) 
      + IT_0408*IT_0410) + 2*IT_0416*(conj(IT_0354)*IT_0404 + IT_0368*conj
      (IT_0404) + IT_0394*conj(IT_0406) + 0.5*conj(IT_0405)*IT_0419 + 0.5
      *IT_0405*IT_0422) + IT_0256*IT_0394*IT_0423 + 2*conj(IT_0354)*(IT_0305
      *IT_0341 + IT_0255*IT_0424 + IT_0369*IT_0427 + 2*IT_0368*IT_0431 + 0.5
      *IT_0432*IT_0433) + IT_0440 + 2*(conj(IT_0378) + conj(IT_0393))*IT_0452 + 
      (IT_0107*IT_0183 + IT_0257*IT_0333 + IT_0394*IT_0424 + IT_0368*IT_0432)
      *IT_0453 + 2*IT_0457*(IT_0336*(conj(IT_0405) + conj(IT_0441)) + conj
      (IT_0406)*IT_0460 + conj(IT_0136)*IT_0461 + IT_0136*IT_0462 + IT_0463*
      (conj(IT_0255) + 0.5*IT_0464) + IT_0406*(conj(IT_0333) + 0.5*IT_0465)) + 2
      *conj(IT_0333)*(IT_0258*IT_0427 + 0.5*IT_0257*IT_0433 + IT_0142*IT_0460 +
       0.5*IT_0424*IT_0466) + IT_0333*(IT_0142*IT_0465 + IT_0424*IT_0467) + (-4)
      *conj(IT_0441)*(IT_0403*IT_0441 + -1./2*IT_0394*IT_0445 + -1./2*IT_0446
      *IT_0469 + (-2)*IT_0408*IT_0471 + (-0.25)*IT_0450*IT_0473 + (-0.25)
      *IT_0474*IT_0475) + 8*IT_0441*(IT_0410*IT_0471 + 0.125*IT_0450*IT_0477 +
       0.125*IT_0474*IT_0478) + 2*(IT_0305*(conj(IT_0405) + IT_0409 + conj
      (IT_0441)) + (conj(IT_0179) + 0.5*IT_0259)*IT_0461 + IT_0340*IT_0462 +
       conj(IT_0305)*(IT_0407 + IT_0463))*IT_0482 + (-4)*(conj(IT_0404)*IT_0471 
      + (-0.25)*IT_0410*IT_0474 + 0.125*IT_0445*IT_0477)*IT_0483 + 2*conj
      (IT_0446)*(IT_0394*IT_0450 + IT_0441*IT_0469 + 4*IT_0404*IT_0471 + 0.5
      *IT_0445*IT_0473 + -IT_0408*IT_0474 + IT_0403*IT_0483) + 2*IT_0439*(conj
      (IT_0354)*IT_0405 + IT_0368*conj(IT_0405) + 0.5*conj(IT_0404)*IT_0419 +
       0.5*IT_0404*IT_0422 + IT_0477*IT_0484 + IT_0473*IT_0485) + 2*IT_0469*
      (conj(IT_0404)*IT_0405 + IT_0404*conj(IT_0405) + IT_0478*IT_0484 + IT_0475
      *IT_0485) + 2*IT_0305*(conj(IT_0136)*IT_0258 + IT_0261*IT_0337 + IT_0464
      *IT_0486) + IT_0464*(IT_0367*IT_0424 + IT_0487) + 2*conj(IT_0255)*(IT_0142
      *IT_0255 + IT_0136*IT_0257 + IT_0183*IT_0305 + IT_0258*IT_0340 + IT_0368
      *IT_0424 + IT_0487) + IT_0488*(IT_0107*IT_0188 + IT_0489 + IT_0490 +
       IT_0491) + 2*conj(IT_0107)*(IT_0188*IT_0427 + IT_0433*IT_0486 + IT_0489 +
       IT_0490 + IT_0491);
