        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002 +
       IT_0001*IT_0003)*IT_0005;
    const ccomplex_t IT_0031 = -IT_0030;
    const ccomplex_t IT_0032 = IT_0001*IT_0005;
    const ccomplex_t IT_0033 = IT_0008*IT_0032;
    const ccomplex_t IT_0034 = 2*IT_0033;
    const ccomplex_t IT_0035 = IT_0001*IT_0012;
    const ccomplex_t IT_0036 = IT_0014*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = IT_0017*IT_0032;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = IT_0037 + IT_0039;
    const ccomplex_t IT_0041 = IT_0034 + IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = pow(m_W, 2);
    const ccomplex_t IT_0045 = cpow((-2)*s_12 + -IT_0024 + -IT_0025 + IT_0044 
      + -reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0043*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = IT_0031*IT_0047;
    const ccomplex_t IT_0049 = IT_0000*IT_0012;
    const ccomplex_t IT_0050 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = IT_0003*IT_0012;
    const ccomplex_t IT_0053 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = IT_0000*IT_0005;
    const ccomplex_t IT_0056 = N_W3*N_d3*e_em;
    const ccomplex_t IT_0057 = IT_0055*IT_0056;
    const ccomplex_t IT_0058 = IT_0003*IT_0005;
    const ccomplex_t IT_0059 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*(IT_0051 + -IT_0054 + 
      -IT_0057 + IT_0060);
    const ccomplex_t IT_0062 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0063 = IT_0005*IT_0062;
    const ccomplex_t IT_0064 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0095 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0096 = IT_0005*IT_0095;
    const ccomplex_t IT_0097 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_23 + IT_0025 + IT_0069 + -m_N_1*
    ...
    const ccomplex_t IT_0117 = N_W3*N_d2*e_em;
    ...
    const ccomplex_t IT_0127 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0128 = IT_0005*IT_0127;
    const ccomplex_t IT_0129 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0134 = cpow((-2)*s_23 + IT_0025 + IT_0069 + -m_N_2*
    ...
    const ccomplex_t IT_0143 = IT_0049*IT_0142;
    const ccomplex_t IT_0144 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0145 = IT_0058*IT_0144;
    const ccomplex_t IT_0146 = IT_0139 + IT_0141 + IT_0143 + IT_0145;
    const ccomplex_t IT_0147 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0148 = IT_0052*IT_0147;
    const ccomplex_t IT_0149 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0150 = IT_0055*IT_0149;
    const ccomplex_t IT_0151 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0152 = IT_0052*IT_0151;
    const ccomplex_t IT_0153 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0159 = conj(N_W4)*e_em*V_Wp2;
    const ccomplex_t IT_0160 = IT_0005*IT_0159;
    const ccomplex_t IT_0161 = conj(N_u4)*V_u2*e_em;
    ...
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0025 + IT_0069 + -m_N_4*
    ...
    const ccomplex_t IT_0170 = IT_0029 + IT_0048 + (-2)*IT_0073 + (-2)*IT_0105
       + (-2)*IT_0137 + (-2)*IT_0169;
    ...
    const ccomplex_t IT_0177 = cpow((-2)*s_13 + IT_0069 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0182 = IT_0005*(IT_0179 + IT_0181);
    ...
    const ccomplex_t IT_0186 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0187 = IT_0005*IT_0186;
    const ccomplex_t IT_0188 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0196 = cpow((-2)*s_13 + IT_0024 + IT_0069 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0197 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0198 = IT_0005*IT_0197;
    const ccomplex_t IT_0199 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0204 = U_d1*V_Wp2;
    const ccomplex_t IT_0205 = IT_0000*IT_0204;
    const ccomplex_t IT_0206 = V_u2*U_Wm1;
    const ccomplex_t IT_0207 = IT_0003*IT_0206;
    const ccomplex_t IT_0208 = IT_0005*(IT_0205 + IT_0207);
    ...
    const ccomplex_t IT_0253 = IT_0134*IT_0252;
    ...
    const ccomplex_t IT_0259 = IT_0052*IT_0258;
    const ccomplex_t IT_0260 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0261 = IT_0055*IT_0260;
    const ccomplex_t IT_0262 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0263 = IT_0058*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*(IT_0257 + -IT_0259 + 
      -IT_0261 + IT_0263);
    const ccomplex_t IT_0265 = IT_0070*IT_0192;
    ...
    const ccomplex_t IT_0271 = IT_0058*IT_0270;
    const ccomplex_t IT_0272 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0273 = IT_0049*IT_0272;
    ...
    const ccomplex_t IT_0278 = IT_0052*IT_0277;
    const ccomplex_t IT_0279 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0280 = IT_0055*IT_0279;
    const ccomplex_t IT_0281 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0282 = IT_0052*IT_0281;
    const ccomplex_t IT_0283 = conj(N_W3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0284 = IT_0055*IT_0283;
    ...
    const ccomplex_t IT_0296 = IT_0102*IT_0295;
    ...
    const ccomplex_t IT_0303 = IT_0029 + IT_0048;
    const ccomplex_t IT_0304 = (-2)*conj(IT_0303);
    const ccomplex_t IT_0305 = 0.5*IT_0304;
    const ccomplex_t IT_0306 = conj(IT_0215) + IT_0305;
    const ccomplex_t IT_0307 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0308 = IT_0000*IT_0307;
    const ccomplex_t IT_0309 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0310 = IT_0003*IT_0309;
    const ccomplex_t IT_0311 = IT_0005*(IT_0308 + IT_0310);
    const ccomplex_t IT_0312 = 1.4142135623731*e_em*IT_0311;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = 0.5*IT_0313;
    const ccomplex_t IT_0315 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0316 = IT_0005*IT_0315;
    const ccomplex_t IT_0317 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0323 = IT_0196*IT_0322;
    const ccomplex_t IT_0324 = (0 + _Complex_I*1)*IT_0323;
    const ccomplex_t IT_0325 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0326 = IT_0032*IT_0325;
    const ccomplex_t IT_0327 = (-2)*IT_0326;
    const ccomplex_t IT_0328 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0329 = IT_0035*IT_0328;
    const ccomplex_t IT_0330 = 1.4142135623731*IT_0329;
    const ccomplex_t IT_0331 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0338 = IT_0026*IT_0337;
    const ccomplex_t IT_0339 = (0 + _Complex_I*1)*IT_0338;
    const ccomplex_t IT_0340 = IT_0006*IT_0339;
    const ccomplex_t IT_0341 = conj(U_d2)*conj(V_Wp2);
    const ccomplex_t IT_0342 = IT_0000*IT_0341;
    const ccomplex_t IT_0343 = conj(V_u2)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0394 = IT_0166*IT_0393;
    const ccomplex_t IT_0395 = (0 + _Complex_I*1)*IT_0394;
    const ccomplex_t IT_0396 = IT_0386*IT_0395;
    const ccomplex_t IT_0397 = -IT_0340 + -IT_0364 + (-2)*IT_0396;
    ...
    const ccomplex_t IT_0406 = IT_0192*IT_0348;
    const ccomplex_t IT_0407 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0408 = IT_0177*IT_0406*IT_0407;
    const ccomplex_t IT_0409 = (0 + _Complex_I*1)*m_W*e_em*(IT_0000*IT_0002 +
       IT_0001*IT_0003)*IT_0005;
    const ccomplex_t IT_0410 = IT_0192*IT_0409;
    ...
    const ccomplex_t IT_0415 = IT_0254*IT_0414;
    const ccomplex_t IT_0416 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0417 = IT_0203*IT_0314;
    const ccomplex_t IT_0418 = IT_0196*IT_0416*IT_0417;
    const ccomplex_t IT_0419 = m_N_1*IT_0094;
    const ccomplex_t IT_0420 = IT_0297*IT_0419;
    const ccomplex_t IT_0421 = m_N_3*IT_0061;
    const ccomplex_t IT_0422 = IT_0266*IT_0421;
    const ccomplex_t IT_0423 = IT_0408 + -IT_0413 + -IT_0415 + IT_0418 + 
      -IT_0420 + -IT_0422;
    const ccomplex_t IT_0424 = m_C_2*IT_0061;
    const ccomplex_t IT_0425 = IT_0072*IT_0424;
    const ccomplex_t IT_0426 = m_C_2*IT_0158;
    const ccomplex_t IT_0427 = IT_0168*IT_0426;
    const ccomplex_t IT_0428 = m_C_2*IT_0094;
    const ccomplex_t IT_0429 = IT_0104*IT_0428;
    const ccomplex_t IT_0430 = m_C_2*IT_0126;
    const ccomplex_t IT_0431 = IT_0136*IT_0430;
    const ccomplex_t IT_0432 = m_N_3*IT_0324;
    const ccomplex_t IT_0433 = m_N_3*IT_0351;
    const ccomplex_t IT_0434 = m_N_4*IT_0158;
    const ccomplex_t IT_0435 = IT_0395*IT_0434;
    ...
    const ccomplex_t IT_0439 = m_C_2*IT_0245;
    const ccomplex_t IT_0440 = IT_0254*IT_0439;
    const ccomplex_t IT_0441 = m_C_2*IT_0288;
    const ccomplex_t IT_0442 = IT_0297*IT_0441;
    const ccomplex_t IT_0443 = m_N_3*IT_0214;
    const ccomplex_t IT_0444 = m_C_2*IT_0264;
    const ccomplex_t IT_0445 = IT_0266*IT_0444;
    const ccomplex_t IT_0446 = m_N_3*IT_0195;
    const ccomplex_t IT_0447 = IT_0440 + IT_0442 + -IT_0443 + IT_0445 + 
      -IT_0446;
    const ccomplex_t IT_0448 = IT_0211*IT_0321;
    const ccomplex_t IT_0449 = IT_0196*IT_0416*IT_0448;
    const ccomplex_t IT_0450 = IT_0068*IT_0185;
    const ccomplex_t IT_0451 = IT_0177*IT_0407*IT_0450;
    const ccomplex_t IT_0452 = IT_0068*IT_0409;
    const ccomplex_t IT_0453 = IT_0411*IT_0452;
    const ccomplex_t IT_0454 = (0 + _Complex_I*1)*IT_0453;
    const ccomplex_t IT_0455 = m_N_1*IT_0288;
    const ccomplex_t IT_0456 = IT_0104*IT_0455;
    const ccomplex_t IT_0457 = m_N_2*IT_0245;
    const ccomplex_t IT_0458 = IT_0136*IT_0457;
    const ccomplex_t IT_0459 = m_N_3*IT_0264;
    const ccomplex_t IT_0460 = IT_0072*IT_0459;
    const ccomplex_t IT_0461 = m_C_2*IT_0386;
    const ccomplex_t IT_0462 = IT_0395*IT_0461;
    const ccomplex_t IT_0463 = m_N_4*IT_0386;
    const ccomplex_t IT_0464 = IT_0168*IT_0463;
    const ccomplex_t IT_0465 = IT_0449 + IT_0451 + -IT_0454 + -IT_0456 + 
      -IT_0458 + -IT_0460 + IT_0462 + -IT_0464;
    const ccomplex_t IT_0466 = IT_0447 + IT_0465;
    const ccomplex_t IT_0467 = s_12*IT_0044;
    ...
    const ccomplex_t IT_0475 = IT_0073 + IT_0105 + IT_0137 + IT_0169;
    ...
    const ccomplex_t IT_0481 = s_24*IT_0044;
    ...
    const ccomplex_t IT_0494 = IT_0324 + IT_0351;
    const ccomplex_t IT_0495 = 0.5*IT_0482;
    const ccomplex_t IT_0496 = s_24 + IT_0495;
    const ccomplex_t IT_0497 = m_C_2*IT_0496;
    const ccomplex_t IT_0498 = 2*IT_0497;
    const ccomplex_t IT_0499 = -IT_0195 + -IT_0214;
    const ccomplex_t IT_0500 = s_14*IT_0044;
    const ccomplex_t IT_0501 = IT_0171*IT_0500;
    const ccomplex_t IT_0502 = (-0.25)*IT_0501;
    const ccomplex_t IT_0503 = s_14 + IT_0502;
    const ccomplex_t IT_0504 = m_N_3*IT_0503;
    const ccomplex_t IT_0505 = (-4)*IT_0504;
    const ccomplex_t IT_0506 = m_C_2*IT_0218;
    const ccomplex_t IT_0507 = (-2)*IT_0215;
    const ccomplex_t IT_0508 = 0.5*IT_0507;
    const ccomplex_t IT_0509 = IT_0303 + IT_0508;
    const ccomplex_t IT_0510 = IT_0467 + IT_0473;
    const ccomplex_t IT_0511 = IT_0171*IT_0510;
    const ccomplex_t IT_0512 = (-0.5)*IT_0511;
    const ccomplex_t IT_0513 = s_12 + IT_0512;
    const ccomplex_t IT_0514 = 4*IT_0447;
    const ccomplex_t IT_0515 = m_N_3*IT_0175;
    const ccomplex_t IT_0516 = (-2)*IT_0170;
    const ccomplex_t IT_0517 = 3*IT_0300*IT_0437 + IT_0365*IT_0438 + IT_0396
      *IT_0486 + IT_0494*IT_0498 + IT_0499*IT_0505 + IT_0400*IT_0506 + IT_0405
      *IT_0509 + 2*IT_0513*(IT_0465 + 0.25*IT_0514) + 0.5*IT_0515*IT_0516;
    const ccomplex_t IT_0518 = 0.5*IT_0501;
    const ccomplex_t IT_0519 = s_14 + IT_0518;
    const ccomplex_t IT_0520 = m_N_3*IT_0519;
    const ccomplex_t IT_0521 = 2*IT_0520;
    const ccomplex_t IT_0522 = 2*conj(IT_0436)*(IT_0365*IT_0405 + 3*IT_0300
      *IT_0466 + IT_0475*IT_0486 + IT_0438*IT_0509 + 2*IT_0437*IT_0513 + IT_0400
      *IT_0515 + 0.5*IT_0506*IT_0516 + IT_0476*IT_0521);
    ...
    const ccomplex_t IT_0531 = IT_0475 + IT_0499;
    const ccomplex_t IT_0532 = conj(IT_0475) + conj(IT_0499);
    const ccomplex_t IT_0533 = (-2)*conj(IT_0299);
    const ccomplex_t IT_0534 = IT_0476 + IT_0494;
    ...
    const ccomplex_t IT_0542 = IT_0044*IT_0300;
    ...
    const ccomplex_t IT_0556 = (-0.5)*IT_0498;
    const ccomplex_t IT_0557 = IT_0466*IT_0506;
    ...
    const ccomplex_t IT_0562 = 2*IT_0170*(conj(IT_0170)*IT_0176 + conj(IT_0215
      ...
      *IT_0492) + IT_0300*IT_0466*IT_0493 + 2*conj(IT_0423)*(IT_0365*IT_0405 +
       IT_0438*IT_0509 + 2*IT_0437*IT_0513 + IT_0299*IT_0515 + 0.5*IT_0506
      *IT_0516) + 2*(conj(IT_0447) + conj(IT_0465))*IT_0517 + IT_0522 + (IT_0219
      *IT_0303 + IT_0301*IT_0397 + IT_0437*IT_0506 + IT_0466*IT_0515)*IT_0523 +
       2*IT_0527*(IT_0400*(conj(IT_0476) + conj(IT_0494)) + conj(IT_0396)
      *IT_0530 + conj(IT_0170)*IT_0531 + IT_0170*IT_0532 + IT_0396*(conj(IT_0397
      ) + 0.5*IT_0533) + IT_0534*(conj(IT_0299) + 0.5*IT_0535)) + 2*(conj
      (IT_0365)*(IT_0478 + IT_0494) + IT_0365*(IT_0480 + conj(IT_0494)) + (conj
      (IT_0215) + 0.5*IT_0304)*IT_0531 + IT_0404*IT_0532)*IT_0539 + 2*conj
      (IT_0397)*(IT_0302*IT_0509 + 0.5*IT_0301*IT_0516 + IT_0176*IT_0530 + 0.5
      *IT_0515*IT_0540) + IT_0397*(IT_0176*IT_0533 + IT_0515*IT_0541) + (-4)
      *conj(IT_0494)*(IT_0474*IT_0494 + -1./2*IT_0466*IT_0498 + -1./2*IT_0499
      *IT_0543 + (-2)*IT_0478*IT_0545 + (-0.25)*IT_0505*IT_0547 + (-0.25)
      *IT_0548*IT_0549) + 8*IT_0494*(IT_0480*IT_0545 + 0.125*IT_0505*IT_0551 +
       0.125*IT_0548*IT_0552) + 2*IT_0521*(conj(IT_0423)*IT_0476 + IT_0437*conj
      ...
      *conj(IT_0476) + IT_0552*IT_0553 + IT_0549*IT_0554) + 2*IT_0365*(conj
      (IT_0170)*IT_0302 + IT_0306*IT_0401 + IT_0535*IT_0555) + (-4)*conj(IT_0499
      )*(IT_0474*IT_0499 + -1./2*IT_0466*IT_0505 + -1./2*IT_0494*IT_0543 + (-2)
      *IT_0475*IT_0545 + 1./2*IT_0478*IT_0548 + 1./2*IT_0547*IT_0556) + 8
      *IT_0499*(conj(IT_0475)*IT_0545 + (-0.25)*IT_0480*IT_0548 + (-0.25)
      *IT_0551*IT_0556) + IT_0535*(IT_0436*IT_0515 + IT_0557) + 2*conj(IT_0299)*
      (IT_0176*IT_0299 + IT_0170*IT_0301 + IT_0219*IT_0365 + IT_0302*IT_0404 +
       IT_0437*IT_0515 + IT_0557) + IT_0558*(IT_0224*IT_0303 + IT_0559 + IT_0560
       + IT_0561) + 2*conj(IT_0303)*(IT_0224*IT_0509 + IT_0516*IT_0555 + IT_0559
       + IT_0560 + IT_0561);
