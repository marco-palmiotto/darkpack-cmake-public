...
ccomplex_return_t c_sumSqAmpl_C_2_N_3_to_Hp_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0059 = s_14*m_C_2*m_N_3;
    const ccomplex_t IT_0060 = s_24*m_C_2*m_N_3;
    ...
    const ccomplex_t IT_0067 = m_C_2*m_N_3;
