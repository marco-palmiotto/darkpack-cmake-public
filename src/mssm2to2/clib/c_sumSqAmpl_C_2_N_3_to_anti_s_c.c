        ...
        )
{
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0009;
    ...
    const ccomplex_t IT_0145 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0146 = IT_0014*IT_0145;
    const ccomplex_t IT_0147 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0170 = IT_0076*IT_0169;
    const ccomplex_t IT_0171 = IT_0161*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*IT_0171;
    const ccomplex_t IT_0173 = 0.166666666666667*IT_0123 + IT_0172;
    const ccomplex_t IT_0174 = 0.166666666666667*IT_0124;
    const ccomplex_t IT_0175 = conj(IT_0172) + IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0014*IT_0020*IT_0074;
    const ccomplex_t IT_0177 = 0.5*IT_0176;
    const ccomplex_t IT_0178 = IT_0076*IT_0177;
    const ccomplex_t IT_0179 = IT_0073*IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*IT_0179;
    const ccomplex_t IT_0181 = IT_0019*IT_0082;
    ...
    const ccomplex_t IT_0185 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0009;
    const ccomplex_t IT_0186 = 0.666666666666667*IT_0185;
    const ccomplex_t IT_0187 = IT_0024*IT_0186;
    const ccomplex_t IT_0188 = cpow((-2)*s_13 + IT_0005 + IT_0029 + -m_sc_R*
    ...
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0014;
    const ccomplex_t IT_0192 = -IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
    ...
    const ccomplex_t IT_0203 = IT_0076*IT_0194;
    const ccomplex_t IT_0204 = IT_0161*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*IT_0204;
    const ccomplex_t IT_0206 = -IT_0205;
    const ccomplex_t IT_0207 = 6*IT_0132;
    const ccomplex_t IT_0208 = 6*conj(IT_0132);
    const ccomplex_t IT_0209 = IT_0169*IT_0192;
    const ccomplex_t IT_0210 = IT_0161*IT_0209;
    ...
    const ccomplex_t IT_0215 = IT_0188*IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1)*IT_0215;
    const ccomplex_t IT_0217 = -IT_0211 + -IT_0216;
    const ccomplex_t IT_0218 = 6*IT_0140;
    const ccomplex_t IT_0219 = 6*conj(IT_0140);
    const ccomplex_t IT_0220 = 12*IT_0160;
    const ccomplex_t IT_0221 = 12*conj(IT_0160);
    const ccomplex_t IT_0222 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0223 = IT_0014*IT_0222;
    const ccomplex_t IT_0224 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0233 = 12*conj(IT_0070);
    const ccomplex_t IT_0234 = 12*conj(IT_0198);
    const ccomplex_t IT_0235 = 12*IT_0184;
    const ccomplex_t IT_0236 = 12*conj(IT_0184);
    const ccomplex_t IT_0237 = 12*conj(IT_0140)*IT_0156 + IT_0141*conj(IT_0156
      ) + 6*conj(IT_0160)*IT_0173 + 6*IT_0160*IT_0175 + conj(IT_0184)*IT_0200 +
       IT_0184*IT_0202 + conj(IT_0206)*IT_0207 + IT_0206*IT_0208 + conj(IT_0217)
      *IT_0218 + IT_0217*IT_0219 + conj(IT_0088)*IT_0220 + IT_0088*IT_0221 +
       conj(IT_0231)*(24*IT_0027 + IT_0125 + IT_0232) + IT_0231*(24*conj(IT_0027
      ) + IT_0233 + IT_0234) + conj(IT_0027)*IT_0235 + IT_0027*IT_0236;
    const ccomplex_t IT_0238 = 24*IT_0231;
    const ccomplex_t IT_0239 = IT_0235 + IT_0238;
    const ccomplex_t IT_0240 = 12*IT_0088;
    const ccomplex_t IT_0241 = 12*IT_0027;
    const ccomplex_t IT_0242 = m_s*s_14*m_N_3;
    const ccomplex_t IT_0243 = 6*IT_0206;
    const ccomplex_t IT_0244 = 6*conj(IT_0206);
    const ccomplex_t IT_0245 = 6*IT_0184;
    const ccomplex_t IT_0246 = 6*conj(IT_0184);
    const ccomplex_t IT_0247 = 12*conj(IT_0132);
    const ccomplex_t IT_0248 = 12*IT_0172;
    const ccomplex_t IT_0249 = IT_0133*conj(IT_0156) + conj(IT_0160)*IT_0200 +
       IT_0160*IT_0202 + IT_0208*IT_0217 + IT_0207*conj(IT_0217) + conj(IT_0027)
      *IT_0220 + IT_0027*IT_0221 + (24*conj(IT_0088) + 12*conj(IT_0122) + 12
      *conj(IT_0172))*IT_0231 + conj(IT_0088)*IT_0235 + IT_0088*IT_0236 + conj
      (IT_0140)*IT_0243 + IT_0140*IT_0244 + (conj(IT_0122) + conj(IT_0172))
      *IT_0245 + (IT_0122 + IT_0172)*IT_0246 + IT_0156*IT_0247 + conj(IT_0231)*
      (24*IT_0088 + IT_0142 + IT_0248);
    const ccomplex_t IT_0250 = 12*IT_0217;
    const ccomplex_t IT_0251 = 24*IT_0156;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = 12*IT_0206;
    const ccomplex_t IT_0254 = m_c*m_s*s_12;
    const ccomplex_t IT_0255 = 6*IT_0217;
    const ccomplex_t IT_0256 = 6*conj(IT_0217);
    const ccomplex_t IT_0257 = 12*conj(IT_0206);
    const ccomplex_t IT_0258 = (-12)*IT_0070;
    const ccomplex_t IT_0259 = (-12)*conj(IT_0070);
    const ccomplex_t IT_0260 = (-12)*IT_0140;
    const ccomplex_t IT_0261 = (-12)*conj(IT_0140);
    const ccomplex_t IT_0262 = (-6)*IT_0132;
    const ccomplex_t IT_0263 = (-6)*conj(IT_0132);
    const ccomplex_t IT_0264 = (-6)*IT_0140;
    const ccomplex_t IT_0265 = (-6)*conj(IT_0140);
    const ccomplex_t IT_0266 = conj(IT_0198)*IT_0207 + IT_0198*IT_0208 + conj
      (IT_0172)*IT_0218 + IT_0172*IT_0219 + conj(IT_0156)*IT_0220 + IT_0156
      *IT_0221 + conj(IT_0184)*IT_0243 + IT_0184*IT_0244 + conj(IT_0231)*IT_0253
       + conj(IT_0160)*IT_0255 + IT_0160*IT_0256 + IT_0231*IT_0257 + conj
      (IT_0132)*IT_0258 + IT_0132*IT_0259 + conj(IT_0122)*IT_0260 + IT_0122
      *IT_0261 + conj(IT_0027)*IT_0262 + IT_0027*IT_0263 + conj(IT_0088)*IT_0264
       + IT_0088*IT_0265;
    const ccomplex_t IT_0267 = s_34*m_C_2*m_N_3;
    const ccomplex_t IT_0268 = 12*conj(IT_0217);
    const ccomplex_t IT_0269 = (-12)*IT_0132;
    const ccomplex_t IT_0270 = (-12)*conj(IT_0132);
    const ccomplex_t IT_0271 = conj(IT_0172)*IT_0207 + IT_0172*IT_0208 + conj
      (IT_0156)*IT_0235 + IT_0156*IT_0236 + conj(IT_0160)*IT_0243 + IT_0160
      *IT_0244 + conj(IT_0217)*IT_0245 + IT_0217*IT_0246 + conj(IT_0231)*IT_0252
       + conj(IT_0140)*(IT_0199 + IT_0258) + IT_0140*(IT_0201 + IT_0259) + conj
      (IT_0088)*IT_0262 + IT_0088*IT_0263 + conj(IT_0027)*IT_0264 + IT_0027
      *IT_0265 + IT_0231*(24*conj(IT_0156) + IT_0268) + conj(IT_0122)*IT_0269 +
       IT_0122*IT_0270;
    const ccomplex_t IT_0272 = m_s*s_24*m_C_2;
    const ccomplex_t IT_0273 = (-6)*IT_0070;
    const ccomplex_t IT_0274 = IT_0232 + IT_0273;
    const ccomplex_t IT_0275 = (-6)*conj(IT_0070);
    const ccomplex_t IT_0276 = IT_0234 + IT_0275;
    const ccomplex_t IT_0277 = 12*conj(IT_0088);
    const ccomplex_t IT_0278 = (-6)*IT_0122;
    const ccomplex_t IT_0279 = (-6)*conj(IT_0122);
    const ccomplex_t IT_0280 = conj(IT_0156)*((-12)*IT_0122 + 24*IT_0172 +
       IT_0240) + conj(IT_0027)*IT_0243 + IT_0027*IT_0244 + conj(IT_0172)
      *IT_0250 + conj(IT_0088)*IT_0255 + IT_0088*IT_0256 + conj(IT_0184)*IT_0262
       + IT_0184*IT_0263 + conj(IT_0160)*IT_0264 + IT_0160*IT_0265 + IT_0172
      *IT_0268 + conj(IT_0231)*IT_0269 + IT_0231*IT_0270 + conj(IT_0206)*IT_0274
       + IT_0206*IT_0276 + IT_0156*((-12)*conj(IT_0122) + 24*conj(IT_0172) +
       IT_0277) + conj(IT_0217)*IT_0278 + IT_0217*IT_0279;
    const ccomplex_t IT_0281 = -IT_0001;
    const ccomplex_t IT_0282 = IT_0000 + IT_0281;
    const ccomplex_t IT_0283 = IT_0002 + IT_0282;
    const ccomplex_t IT_0284 = m_c*m_s*m_C_2*m_N_3;
    const ccomplex_t IT_0285 = (-6)*IT_0198;
    const ccomplex_t IT_0286 = (-6)*conj(IT_0198);
    const ccomplex_t IT_0287 = IT_0133*conj(IT_0140) + conj(IT_0088)*IT_0200 +
       IT_0088*IT_0202 + 24*conj(IT_0156)*IT_0206 + 24*IT_0156*conj(IT_0206) +
       IT_0160*(24*conj(IT_0231) + IT_0236) + conj(IT_0160)*IT_0239 + 6*conj
      (IT_0027)*(IT_0173 + 0.166666666666667*IT_0240) + IT_0140*IT_0247 + conj
      (IT_0217)*IT_0253 + IT_0217*IT_0257 + conj(IT_0172)*IT_0274 + IT_0172
      *IT_0276 + 6*IT_0027*(IT_0175 + 0.166666666666667*IT_0277) + conj(IT_0122)
      *(IT_0125 + IT_0285) + IT_0122*(IT_0233 + IT_0286);
    const ccomplex_t IT_0288 = m_c*s_13*m_N_3;
    const ccomplex_t IT_0289 = (-0.166666666666667)*IT_0027;
    const ccomplex_t IT_0290 = (-0.166666666666667)*conj(IT_0027);
    const ccomplex_t IT_0291 = conj(IT_0140)*IT_0184 + IT_0140*conj(IT_0184) +
       conj(IT_0122)*IT_0206 + IT_0122*conj(IT_0206) + (-0.166666666666667)*conj
      (IT_0088)*IT_0243 + (-0.166666666666667)*IT_0088*IT_0244 + (
      -0.166666666666667)*conj(IT_0172)*IT_0253 + (-0.166666666666667)*IT_0172
      *IT_0257 + (-4)*conj(IT_0156)*(IT_0198 + 0.0416666666666667*IT_0241 +
       0.0416666666666667*IT_0258) + (-4)*IT_0156*(0.5*conj(IT_0027) + conj
      (IT_0198) + 0.0416666666666667*IT_0259) + (-0.166666666666667)*conj
      (IT_0231)*IT_0260 + (-0.166666666666667)*IT_0231*IT_0261 + (
      -0.166666666666667)*conj(IT_0160)*IT_0262 + (-0.166666666666667)*IT_0160
      *IT_0263 + (-0.166666666666667)*conj(IT_0217)*IT_0274 + (
      -0.166666666666667)*IT_0217*IT_0276 + IT_0256*IT_0289 + IT_0255*IT_0290;
    const ccomplex_t IT_0292 = IT_0003 + IT_0282;
    const ccomplex_t IT_0293 = IT_0004*(conj(IT_0027)*IT_0071 + IT_0027
      *IT_0072 + conj(IT_0088)*IT_0123 + IT_0088*IT_0124) + IT_0000*(conj
      ...
      (IT_0122)*IT_0142) + IT_0143*IT_0237 + IT_0001*(conj(IT_0160)*IT_0220 + 
      (24*IT_0184 + 48*IT_0231)*conj(IT_0231) + conj(IT_0184)*IT_0239 + conj
      (IT_0088)*IT_0240 + conj(IT_0027)*IT_0241) + IT_0242*IT_0249 + IT_0002*
      (conj(IT_0156)*(48*IT_0156 + 24*IT_0217) + conj(IT_0198)*IT_0232 + conj
      (IT_0172)*IT_0248 + conj(IT_0217)*IT_0252 + conj(IT_0206)*IT_0253) +
       IT_0254*IT_0266 + IT_0267*IT_0271 + IT_0272*IT_0280 + (conj(IT_0198)
      *IT_0273 + IT_0198*IT_0275 + conj(IT_0172)*IT_0278 + IT_0172*IT_0279)
      *IT_0283 + IT_0284*IT_0287 + (-6)*IT_0288*IT_0291 + (-6)*(conj(IT_0088)
      *IT_0172 + IT_0088*conj(IT_0172) + IT_0286*IT_0289 + IT_0285*IT_0290)
      *IT_0292;
