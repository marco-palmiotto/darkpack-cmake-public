        ...
        )
{
    ...
    const ccomplex_t IT_0078 = conj(N_d4)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0134 = s_13*m_N_4;
    ...
    const ccomplex_t IT_0176 = m_C_2*m_N_4*IT_0028*IT_0161;
    const ccomplex_t IT_0177 = (-0.5)*IT_0125;
    const ccomplex_t IT_0178 = 4*IT_0170;
    const ccomplex_t IT_0179 = 4*IT_0016;
    const ccomplex_t IT_0180 = 4*conj(IT_0016);
    const ccomplex_t IT_0181 = (-0.5)*IT_0115;
    const ccomplex_t IT_0182 = 4*conj(IT_0170)*(IT_0026 + 3*IT_0173) + IT_0175
      *IT_0177 + 4*(IT_0026 + 0.25*IT_0174)*conj(IT_0177) + 4*conj(IT_0026)*
      (IT_0177 + 0.25*IT_0178) + conj(IT_0173)*(12*IT_0170 + IT_0179) + IT_0173
      *IT_0180 + (IT_0172 + IT_0180)*IT_0181 + (IT_0171 + IT_0179)*conj(IT_0181);
    const ccomplex_t IT_0183 = m_C_2*m_N_4;
    ...
    const ccomplex_t IT_0245 = IT_0012*IT_0031;
    const ccomplex_t IT_0246 = 2*IT_0072;
    const ccomplex_t IT_0247 = IT_0011*IT_0031;
    const ccomplex_t IT_0248 = 2*IT_0126;
    const ccomplex_t IT_0249 = s_12*IT_0031;
    const ccomplex_t IT_0250 = (-8)*IT_0155;
    const ccomplex_t IT_0251 = IT_0012*IT_0110;
    const ccomplex_t IT_0252 = (-2)*IT_0072;
    const ccomplex_t IT_0253 = IT_0011*IT_0105;
    const ccomplex_t IT_0254 = (-2)*IT_0126;
    const ccomplex_t IT_0255 = 2*conj(IT_0072);
    const ccomplex_t IT_0256 = 2*conj(IT_0126);
    const ccomplex_t IT_0257 = (-2)*conj(IT_0072);
    const ccomplex_t IT_0258 = (-2)*conj(IT_0126);
    ...
    const ccomplex_t IT_0267 = 0.125*IT_0032*IT_0067 + 0.125*IT_0098*IT_0106 +
       0.125*IT_0111*IT_0119 + 0.125*IT_0129*IT_0133 + 0.125*IT_0188*IT_0246 +
       0.125*IT_0184*IT_0248 + 0.125*(IT_0252 + IT_0254)*IT_0259 + IT_0155*
      (IT_0184 + IT_0188 + (-2)*IT_0259) + (-1.25)*IT_0170*(IT_0260 + IT_0261) +
       0.125*IT_0247*IT_0262 + 0.125*IT_0245*IT_0263 + 0.125*IT_0249*IT_0264 +
       0.125*IT_0253*IT_0265 + 0.125*IT_0251*IT_0266;
    ...
    const ccomplex_t IT_0272 = IT_0032*IT_0070 + IT_0101*IT_0106 + IT_0111
      *IT_0122 + IT_0132*IT_0133 + IT_0188*IT_0255 + IT_0184*IT_0256 + ((-16)
      *conj(IT_0155) + IT_0257 + IT_0258)*IT_0259 + IT_0247*IT_0268 + IT_0245
      *IT_0269 + IT_0253*IT_0270 + IT_0251*IT_0271;
    ...
    const ccomplex_t IT_0292 = m_N_4*IT_0210;
    ...
    const ccomplex_t IT_0374 = conj(IT_0126)*IT_0305 + -conj(IT_0072)*IT_0317 
      ...
      *IT_0373;
    const ccomplex_t IT_0375 = IT_0116*IT_0305 + -IT_0035*IT_0317 + 2*IT_0026
      *IT_0327 + IT_0129*IT_0337 + IT_0067*IT_0347 + IT_0248*IT_0353 + IT_0246
      *IT_0359 + IT_0220*IT_0367 + (-0.25)*IT_0181*IT_0373;
    ...
    const ccomplex_t IT_0383 = (-8)*conj(IT_0155)*IT_0181;
    ...
    const ccomplex_t IT_0387 = IT_0026 + IT_0173;
    const ccomplex_t IT_0388 = conj(IT_0026)*IT_0273;
    const ccomplex_t IT_0389 = IT_0026*IT_0274;
    const ccomplex_t IT_0390 = conj(IT_0158)*IT_0376;
    const ccomplex_t IT_0391 = IT_0158*IT_0378;
    const ccomplex_t IT_0392 = conj(IT_0181)*IT_0250;
    const ccomplex_t IT_0393 = (12*IT_0016*conj(IT_0016) + 12*IT_0026*conj
      ...
      *IT_0254) + IT_0155*(IT_0032*IT_0101 + IT_0070*IT_0106 + IT_0111*IT_0132 +
      ...
      (conj(IT_0035) + conj(IT_0116))*IT_0273 + (IT_0035 + IT_0116)*IT_0274) +
       IT_0275*(conj(IT_0016)*IT_0254 + IT_0016*IT_0258 + conj(IT_0026)*IT_0265 
      + IT_0026*IT_0270 + IT_0277 + IT_0279 + IT_0281 + IT_0283 + IT_0284 +
       IT_0285 + IT_0287 + IT_0289) + (conj(IT_0016)*IT_0252 + IT_0016*IT_0257 +
      ...
      *conj(IT_0170)*((-0.25)*IT_0168*IT_0171 + (-0.25)*IT_0162*IT_0178 + 
      (IT_0037 + -IT_0065)*IT_0295 + IT_0292*IT_0296 + IT_0248*IT_0297 + IT_0246
      *IT_0298) + 4*IT_0170*(IT_0138*IT_0292 + -(conj(IT_0037) + -conj(IT_0065))
      *IT_0295 + -IT_0256*IT_0297 + -IT_0255*IT_0298) + 4*IT_0173*((conj(IT_0037
      ...
      -IT_0269*IT_0298) + (-4)*conj(IT_0177)*(IT_0126*IT_0305 + -IT_0072*IT_0317
       ...
       + IT_0263*IT_0359 + IT_0216*IT_0367) + (-4)*IT_0181*(conj(IT_0116)
      *IT_0305 + -conj(IT_0035)*IT_0317 + 2*conj(IT_0026)*IT_0327 + IT_0132
      *IT_0337 + IT_0070*IT_0347 + IT_0256*IT_0353 + IT_0255*IT_0359 + IT_0222
      *IT_0367) + (-4)*IT_0177*IT_0374 + (-4)*conj(IT_0181)*IT_0375 + IT_0261*
      (conj(IT_0035)*IT_0377 + IT_0035*IT_0379 + IT_0380 + IT_0381 + IT_0382 +
       IT_0383 + IT_0384 + IT_0385 + IT_0252*IT_0386 + IT_0257*IT_0387 + IT_0388
       + IT_0389 + IT_0390 + IT_0391 + IT_0392) + IT_0260*(conj(IT_0116)*IT_0377
       + IT_0116*IT_0379 + IT_0380 + IT_0381 + IT_0382 + IT_0383 + IT_0384 +
       IT_0385 + IT_0254*IT_0386 + IT_0258*IT_0387 + IT_0388 + IT_0389 + IT_0390
       + IT_0391 + IT_0392);
