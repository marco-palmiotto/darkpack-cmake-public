...
ccomplex_return_t c_sumSqAmpl_C_2_N_4_to_Hp_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = 2*IT_0006;
    const ccomplex_t IT_0008 = cos(theta_W);
    const ccomplex_t IT_0009 = cpow(IT_0008, -1);
    const ccomplex_t IT_0010 = IT_0001*IT_0009;
    const ccomplex_t IT_0011 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0012 = IT_0010*IT_0011;
    const ccomplex_t IT_0013 = 1.4142135623731*IT_0012;
    const ccomplex_t IT_0014 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0059 = s_14*m_C_2*m_N_4;
    const ccomplex_t IT_0060 = s_24*m_C_2*m_N_4;
    ...
    const ccomplex_t IT_0067 = m_C_2*m_N_4;
    ...
    const ccomplex_t IT_0082 = (-2)*conj(IT_0054)*(IT_0035*IT_0058 + -IT_0034
      ...
      *IT_0077 + IT_0062*IT_0078) + (-2)*conj(IT_0058)*(IT_0035*IT_0054 + 
      -IT_0027*IT_0059 + (-0.5)*IT_0029*IT_0058*IT_0076 + (-0.5)*IT_0071*IT_0077
       + (-0.5)*IT_0057*IT_0080) + (-2)*conj(IT_0034)*(IT_0027*IT_0035 + 
      -IT_0054*IT_0059 + (-0.5)*IT_0029*IT_0034*IT_0076 + (-0.5)*IT_0069*IT_0077
       + (-0.5)*IT_0062*IT_0080) + 2*conj(IT_0057)*(IT_0027*IT_0060 + (-2)
      *IT_0054*IT_0066 + 0.5*IT_0071*IT_0078 + 0.5*IT_0058*IT_0080 + 0.5*IT_0057
      *IT_0081) + 2*conj(IT_0062)*(IT_0054*IT_0060 + (-2)*IT_0027*IT_0066 + 0.5
      *IT_0069*IT_0078 + 0.5*IT_0034*IT_0080 + 0.5*IT_0062*IT_0081);
