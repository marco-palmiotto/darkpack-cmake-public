        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_u4*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0041 = IT_0012*IT_0036;
    ...
    const ccomplex_t IT_0070 = IT_0003*IT_0056;
