...
ccomplex_return_t c_sumSqAmpl_C_2_N_4_to_anti_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = conj(N_d4)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0015 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0016 = IT_0014*IT_0015;
    const ccomplex_t IT_0017 = 1.4142135623731*IT_0016;
    const ccomplex_t IT_0018 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0053 = conj(N_B4)*e_em;
    const ccomplex_t IT_0054 = IT_0013*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0088 = 4*IT_0050;
    ...
    const ccomplex_t IT_0105 = IT_0008*IT_0089;
    const ccomplex_t IT_0106 = 2*IT_0105;
    const ccomplex_t IT_0107 = IT_0014*IT_0092;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = IT_0008*IT_0095;
    ...
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
    ...
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005;
    const ccomplex_t IT_0138 = 0.5*IT_0137;
    const ccomplex_t IT_0139 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0140 = IT_0005*IT_0139;
    const ccomplex_t IT_0141 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0147 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0150 = 4*IT_0136;
    const ccomplex_t IT_0151 = 0.125*IT_0150;
    const ccomplex_t IT_0152 = IT_0149 + IT_0151;
    const ccomplex_t IT_0153 = 4*IT_0085;
    ...
    const ccomplex_t IT_0172 = m_mu*s_14*m_N_4;
    const ccomplex_t IT_0173 = 2*IT_0159;
    const ccomplex_t IT_0174 = 2*conj(IT_0159);
    const ccomplex_t IT_0175 = 2*IT_0136;
    const ccomplex_t IT_0176 = 2*conj(IT_0136);
    const ccomplex_t IT_0177 = 4*conj(IT_0136);
    const ccomplex_t IT_0178 = (conj(IT_0050) + conj(IT_0065) + 2*conj(IT_0085
      ))*IT_0149 + 0.25*conj(IT_0085)*IT_0150 + 0.25*IT_0119*conj(IT_0169) + 2
      *conj(IT_0149)*(IT_0085 + 0.125*IT_0088 + 0.125*IT_0171) + conj(IT_0118)*
      (IT_0169 + 0.25*IT_0173) + 0.25*IT_0118*IT_0174 + 0.25*(conj(IT_0050) +
       conj(IT_0065))*IT_0175 + 0.25*(IT_0050 + IT_0065)*IT_0176 + 0.25*IT_0085
      *IT_0177;
    const ccomplex_t IT_0179 = s_34*m_C_2*m_N_4;
    const ccomplex_t IT_0180 = (-4)*IT_0118;
    const ccomplex_t IT_0181 = (-4)*conj(IT_0118);
    const ccomplex_t IT_0182 = 4*conj(IT_0159);
    const ccomplex_t IT_0183 = (-0.5)*IT_0149;
    const ccomplex_t IT_0184 = (-0.5)*conj(IT_0149);
    const ccomplex_t IT_0185 = -(conj(IT_0065) + -conj(IT_0085))*IT_0118 + -
      (IT_0065 + -IT_0085)*conj(IT_0118) + (-4)*IT_0152*conj(IT_0169) + (-0.5)
      *conj(IT_0136)*IT_0173 + (-0.5)*IT_0136*IT_0174 + (-4)*IT_0169*(conj
      (IT_0149) + 0.125*IT_0177) + (-0.5)*conj(IT_0050)*IT_0180 + (-0.5)*IT_0050
      *IT_0181 + IT_0182*IT_0183 + IT_0170*IT_0184;
    const ccomplex_t IT_0186 = m_mu*s_24*m_C_2;
    const ccomplex_t IT_0187 = conj(IT_0118)*IT_0136 + IT_0118*conj(IT_0136) +
       conj(IT_0050)*IT_0159 + IT_0050*conj(IT_0159) + 2*(conj(IT_0050) + (-2)
      *conj(IT_0065) + -conj(IT_0085))*IT_0169 + 2*(IT_0050 + (-2)*IT_0065 + (
      -0.25)*IT_0153)*conj(IT_0169) + (-0.5)*conj(IT_0065)*IT_0170 + (-0.5)*conj
      (IT_0085)*IT_0173 + (-0.5)*IT_0085*IT_0174 + (-0.5)*IT_0065*IT_0182 +
       IT_0181*IT_0183 + IT_0180*IT_0184;
    const ccomplex_t IT_0188 = 2*(conj(IT_0065)*IT_0085 + IT_0065*conj(IT_0085
      ))*(IT_0067 + IT_0068 + IT_0086) + (-2)*IT_0050*(conj(IT_0065)*IT_0071 +
       conj(IT_0085)*IT_0087) + (-2)*conj(IT_0050)*(IT_0065*IT_0071 + IT_0085
      *IT_0087 + (-0.5)*IT_0066*IT_0088) + IT_0066*conj(IT_0118)*IT_0119 + 8
      *IT_0068*((IT_0136 + 2*IT_0149)*conj(IT_0149) + conj(IT_0136)*IT_0152 +
       0.125*conj(IT_0085)*IT_0153) + 8*IT_0067*((IT_0159 + 2*IT_0169)*conj
      (IT_0169) + conj(IT_0159)*(IT_0169 + 0.125*IT_0170) + 0.125*conj(IT_0065)
      *IT_0171) + 4*IT_0172*IT_0178 + (-2)*IT_0179*IT_0185 + (-2)*IT_0186*IT_0187;
