        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0015*IT_0021*IT_0023;
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_12 + -IT_0007 + -IT_0048 + IT_0054 
      + -reg_prop, -1);
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0015*IT_0021;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0015;
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_23 + IT_0006 + IT_0048 + -m_smu_L*
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0006 + IT_0048 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0010;
    ...
    const ccomplex_t IT_0094 = conj(IT_0087) + conj(IT_0093);
    const ccomplex_t IT_0095 = IT_0087 + IT_0093;
    ...
    const ccomplex_t IT_0158 = m_mu*s_14*m_N_4;
    ...
    const ccomplex_t IT_0171 = IT_0085*IT_0170;
    ...
    const ccomplex_t IT_0194 = 4*IT_0117*(conj(IT_0153) + 0.25*IT_0156) + conj
      ...
      *IT_0182 + IT_0095*IT_0183 + 4*(conj(IT_0028) + conj(IT_0073) + 2*conj
      (IT_0087) + 2*conj(IT_0093) + 0.25*IT_0123)*IT_0193 + 8*(IT_0095 + 0.125
      *IT_0120 + 0.125*IT_0122 + 0.125*IT_0124)*conj(IT_0193);
    const ccomplex_t IT_0195 = 4*IT_0087;
    const ccomplex_t IT_0196 = 4*conj(IT_0087);
    const ccomplex_t IT_0197 = 4*IT_0093;
    const ccomplex_t IT_0198 = m_mu*s_24*m_C_2;
