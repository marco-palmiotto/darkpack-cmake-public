        ...
        )
{
    ...
    const ccomplex_t IT_0008 = IT_0000*IT_0005;
    const ccomplex_t IT_0009 = N_u4*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0015 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0016 = IT_0014*IT_0015;
    const ccomplex_t IT_0017 = 1.4142135623731*IT_0016;
    const ccomplex_t IT_0018 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0031 = IT_0001*IT_0013;
    const ccomplex_t IT_0032 = N_B4*N_u1*e_em;
    ...
    const ccomplex_t IT_0037 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0038 = IT_0031*IT_0037;
    const ccomplex_t IT_0039 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0040 = IT_0034*IT_0039;
    const ccomplex_t IT_0041 = IT_0033 + IT_0036 + IT_0038 + IT_0040;
    const ccomplex_t IT_0042 = IT_0001*IT_0005;
    const ccomplex_t IT_0043 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = IT_0003*IT_0005;
    const ccomplex_t IT_0046 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0047 = IT_0045*IT_0046;
    const ccomplex_t IT_0048 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0049 = IT_0042*IT_0048;
    const ccomplex_t IT_0050 = N_W1*N_d4*e_em;
    const ccomplex_t IT_0051 = IT_0045*IT_0050;
    const ccomplex_t IT_0052 = -IT_0044 + -IT_0047 + -IT_0049 + -IT_0051;
    const ccomplex_t IT_0053 = IT_0041 + IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0057 = IT_0005*IT_0056;
    const ccomplex_t IT_0058 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0026 + IT_0063 + -m_N_1*
    ...
    const ccomplex_t IT_0074 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0075 = IT_0034*IT_0074;
    const ccomplex_t IT_0076 = IT_0069 + IT_0071 + IT_0073 + IT_0075;
    const ccomplex_t IT_0077 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0078 = IT_0042*IT_0077;
    const ccomplex_t IT_0079 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0080 = IT_0045*IT_0079;
    const ccomplex_t IT_0081 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0082 = IT_0042*IT_0081;
    const ccomplex_t IT_0083 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0089 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0090 = IT_0005*IT_0089;
    const ccomplex_t IT_0091 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_23 + IT_0026 + IT_0063 + -m_N_2*
    ...
    const ccomplex_t IT_0121 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0122 = IT_0005*IT_0121;
    const ccomplex_t IT_0123 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0128 = cpow((-2)*s_23 + IT_0026 + IT_0063 + -m_N_3*
    ...
    const ccomplex_t IT_0132 = N_B4*N_u4*e_em;
    const ccomplex_t IT_0133 = IT_0031*IT_0132;
    const ccomplex_t IT_0134 = N_B4*N_d4*e_em;
    const ccomplex_t IT_0135 = IT_0034*IT_0134;
    const ccomplex_t IT_0136 = N_W4*N_u4*e_em;
    const ccomplex_t IT_0137 = IT_0042*IT_0136;
    const ccomplex_t IT_0138 = N_W4*N_d4*e_em;
    const ccomplex_t IT_0139 = IT_0045*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*(IT_0133 + IT_0135 + 
      -IT_0137 + -IT_0139);
    const ccomplex_t IT_0141 = -IT_0140;
    const ccomplex_t IT_0142 = conj(N_W4)*e_em*V_Wp2;
    const ccomplex_t IT_0143 = IT_0005*IT_0142;
    const ccomplex_t IT_0144 = conj(N_u4)*V_u2*e_em;
    ...
    const ccomplex_t IT_0149 = cpow((-2)*s_23 + IT_0063 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0168 = cpow((-2)*s_12 + -IT_0025 + -IT_0026 + IT_0167 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0184 = IT_0005*(IT_0181 + -IT_0183);
    ...
    const ccomplex_t IT_0189 = IT_0005*IT_0188;
    ...
    const ccomplex_t IT_0205 = -IT_0026;
    ...
    const ccomplex_t IT_0209 = IT_0031*IT_0208;
    ...
    const ccomplex_t IT_0213 = IT_0031*IT_0212;
    ...
    const ccomplex_t IT_0220 = IT_0045*IT_0219;
    ...
    const ccomplex_t IT_0236 = IT_0064*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = IT_0228*IT_0237;
    const ccomplex_t IT_0239 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0240 = IT_0031*IT_0239;
    const ccomplex_t IT_0241 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0242 = IT_0034*IT_0241;
    const ccomplex_t IT_0243 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0244 = IT_0031*IT_0243;
    const ccomplex_t IT_0245 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0246 = IT_0034*IT_0245;
    const ccomplex_t IT_0247 = IT_0240 + IT_0242 + IT_0244 + IT_0246;
    const ccomplex_t IT_0248 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0249 = IT_0042*IT_0248;
    const ccomplex_t IT_0250 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0251 = IT_0045*IT_0250;
    const ccomplex_t IT_0252 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0253 = IT_0042*IT_0252;
    ...
    const ccomplex_t IT_0260 = N_W2*e_em*conj(U_Wm2);
    const ccomplex_t IT_0261 = IT_0005*IT_0260;
    const ccomplex_t IT_0262 = N_d2*conj(U_d2)*e_em;
    const ccomplex_t IT_0263 = IT_0005*IT_0262;
    const ccomplex_t IT_0264 = 1.4142135623731*IT_0263;
    const ccomplex_t IT_0265 = (0 + _Complex_I*1)*(IT_0261 + 0.5*IT_0264);
    const ccomplex_t IT_0266 = -IT_0265;
    const ccomplex_t IT_0267 = IT_0096*IT_0266;
    const ccomplex_t IT_0268 = (0 + _Complex_I*1)*IT_0267;
    const ccomplex_t IT_0269 = IT_0259*IT_0268;
    const ccomplex_t IT_0270 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0271 = IT_0031*IT_0270;
    const ccomplex_t IT_0272 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0273 = IT_0034*IT_0272;
    const ccomplex_t IT_0274 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0275 = IT_0031*IT_0274;
    const ccomplex_t IT_0276 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0277 = IT_0034*IT_0276;
    ...
    const ccomplex_t IT_0286 = IT_0045*IT_0285;
    ...
    const ccomplex_t IT_0291 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0292 = IT_0005*IT_0291;
    const ccomplex_t IT_0293 = N_d3*conj(U_d2)*e_em;
    const ccomplex_t IT_0294 = IT_0005*IT_0293;
    ...
    const ccomplex_t IT_0298 = IT_0128*IT_0297;
    const ccomplex_t IT_0299 = (0 + _Complex_I*1)*IT_0298;
    const ccomplex_t IT_0300 = IT_0290*IT_0299;
    const ccomplex_t IT_0301 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0302 = IT_0031*IT_0301;
    const ccomplex_t IT_0303 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0304 = IT_0034*IT_0303;
    const ccomplex_t IT_0305 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0306 = IT_0042*IT_0305;
    const ccomplex_t IT_0307 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0308 = IT_0045*IT_0307;
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*(IT_0302 + IT_0304 + 
      -IT_0306 + -IT_0308);
    const ccomplex_t IT_0310 = -IT_0309;
    const ccomplex_t IT_0311 = IT_0149*IT_0194;
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*IT_0311;
    const ccomplex_t IT_0313 = IT_0310*IT_0312;
    const ccomplex_t IT_0314 = 2*IT_0238 + 2*IT_0269 + 2*IT_0300 + IT_0313;
    ...
    const ccomplex_t IT_0322 = IT_0005*(IT_0319 + -IT_0321);
    ...
    const ccomplex_t IT_0327 = IT_0005*IT_0326;
    ...
    const ccomplex_t IT_0334 = cpow((-2)*s_13 + IT_0025 + IT_0063 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0335 = IT_0333*IT_0334;
    const ccomplex_t IT_0336 = (0 + _Complex_I*1)*IT_0335;
    const ccomplex_t IT_0337 = IT_0030 + IT_0171 + (-2)*IT_0336;
    const ccomplex_t IT_0338 = (-2)*IT_0337;
    const ccomplex_t IT_0339 = 0.5*IT_0338;
    const ccomplex_t IT_0340 = IT_0198 + IT_0339;
    const ccomplex_t IT_0341 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0342 = IT_0001*IT_0341;
    const ccomplex_t IT_0343 = conj(U_d2)*conj(V_Wp2);
    const ccomplex_t IT_0344 = IT_0003*IT_0343;
    const ccomplex_t IT_0345 = IT_0005*(IT_0342 + -IT_0344);
    ...
    const ccomplex_t IT_0349 = IT_0148*IT_0348;
    const ccomplex_t IT_0350 = IT_0179*IT_0349;
    const ccomplex_t IT_0351 = (0 + _Complex_I*1)*IT_0350;
    const ccomplex_t IT_0352 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0353 = IT_0155*IT_0352;
    const ccomplex_t IT_0354 = (-2)*IT_0353;
    const ccomplex_t IT_0355 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0356 = IT_0158*IT_0355;
    const ccomplex_t IT_0357 = 1.4142135623731*IT_0356;
    const ccomplex_t IT_0358 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0359 = IT_0155*IT_0358;
    ...
    const ccomplex_t IT_0368 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0369 = IT_0001*IT_0368;
    const ccomplex_t IT_0370 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0371 = IT_0003*IT_0370;
    const ccomplex_t IT_0372 = IT_0005*(IT_0369 + -IT_0371);
    const ccomplex_t IT_0373 = 1.4142135623731*e_em*IT_0372;
    ...
    const ccomplex_t IT_0377 = IT_0005*IT_0376;
    const ccomplex_t IT_0378 = conj(N_u4)*V_u1*e_em;
    const ccomplex_t IT_0379 = IT_0005*IT_0378;
    ...
    const ccomplex_t IT_0396 = IT_0168*IT_0395;
    const ccomplex_t IT_0397 = (0 + _Complex_I*1)*IT_0396;
    const ccomplex_t IT_0398 = IT_0154*IT_0397;
    const ccomplex_t IT_0399 = (-2)*IT_0351 + -IT_0367 + (-2)*IT_0385 + 
      -IT_0398;
    const ccomplex_t IT_0400 = -IT_0313 + -IT_0367 + -IT_0398;
    const ccomplex_t IT_0401 = (-2)*conj(IT_0400);
    const ccomplex_t IT_0402 = 0.5*IT_0401;
    const ccomplex_t IT_0403 = conj(IT_0314) + IT_0402;
    const ccomplex_t IT_0404 = IT_0206*IT_0315;
    const ccomplex_t IT_0405 = (-2)*conj(IT_0337);
    const ccomplex_t IT_0406 = 0.5*IT_0405;
    const ccomplex_t IT_0407 = conj(IT_0198) + IT_0406;
    const ccomplex_t IT_0408 = m_N_4*IT_0201;
    const ccomplex_t IT_0409 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0002 + 
      -IT_0000*IT_0003)*IT_0005;
    ...
    const ccomplex_t IT_0414 = IT_0332*IT_0375;
    const ccomplex_t IT_0415 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0416 = IT_0334*IT_0414*IT_0415;
    const ccomplex_t IT_0417 = IT_0194*IT_0348;
    const ccomplex_t IT_0418 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0419 = IT_0179*IT_0417*IT_0418;
    const ccomplex_t IT_0420 = m_N_1*IT_0055;
    const ccomplex_t IT_0421 = IT_0237*IT_0420;
    const ccomplex_t IT_0422 = m_N_2*IT_0088;
    const ccomplex_t IT_0423 = IT_0268*IT_0422;
    const ccomplex_t IT_0424 = m_N_3*IT_0120;
    const ccomplex_t IT_0425 = IT_0299*IT_0424;
    const ccomplex_t IT_0426 = m_N_4*IT_0141;
    const ccomplex_t IT_0427 = IT_0312*IT_0426;
    const ccomplex_t IT_0428 = -IT_0413 + IT_0416 + IT_0419 + -IT_0421 + 
      -IT_0423 + -IT_0425 + (-0.5)*IT_0427;
    const ccomplex_t IT_0429 = m_N_4*IT_0385;
    const ccomplex_t IT_0430 = m_C_2*IT_0120;
    const ccomplex_t IT_0431 = IT_0130*IT_0430;
    const ccomplex_t IT_0432 = m_C_2*IT_0055;
    const ccomplex_t IT_0433 = IT_0066*IT_0432;
    const ccomplex_t IT_0434 = m_C_2*IT_0088;
    const ccomplex_t IT_0435 = IT_0098*IT_0434;
    const ccomplex_t IT_0436 = m_C_2*IT_0141;
    const ccomplex_t IT_0437 = IT_0151*IT_0436;
    const ccomplex_t IT_0438 = m_N_4*IT_0351;
    const ccomplex_t IT_0439 = (-0.5)*IT_0427 + -IT_0429 + IT_0431 + IT_0433 +
       IT_0435 + IT_0437 + -IT_0438;
    const ccomplex_t IT_0440 = conj(IT_0428) + conj(IT_0439);
    const ccomplex_t IT_0441 = m_C_2*IT_0206;
    const ccomplex_t IT_0442 = m_C_2*IT_0310;
    const ccomplex_t IT_0443 = IT_0312*IT_0442;
    const ccomplex_t IT_0444 = m_C_2*IT_0259;
    const ccomplex_t IT_0445 = IT_0268*IT_0444;
    const ccomplex_t IT_0446 = m_C_2*IT_0228;
    const ccomplex_t IT_0447 = IT_0237*IT_0446;
    const ccomplex_t IT_0448 = m_C_2*IT_0290;
    const ccomplex_t IT_0449 = IT_0299*IT_0448;
    const ccomplex_t IT_0450 = m_N_4*IT_0197;
    const ccomplex_t IT_0451 = 0.5*IT_0443 + IT_0445 + IT_0447 + IT_0449 + 
      -IT_0450;
    const ccomplex_t IT_0452 = m_N_4*IT_0310;
    const ccomplex_t IT_0453 = IT_0151*IT_0452;
    const ccomplex_t IT_0454 = IT_0148*IT_0409;
    const ccomplex_t IT_0455 = IT_0411*IT_0454;
    const ccomplex_t IT_0456 = (0 + _Complex_I*1)*IT_0455;
    const ccomplex_t IT_0457 = IT_0325*IT_0382;
    const ccomplex_t IT_0458 = IT_0334*IT_0415*IT_0457;
    const ccomplex_t IT_0459 = IT_0148*IT_0187;
    const ccomplex_t IT_0460 = IT_0179*IT_0418*IT_0459;
    const ccomplex_t IT_0461 = m_N_1*IT_0228;
    const ccomplex_t IT_0462 = IT_0066*IT_0461;
    const ccomplex_t IT_0463 = m_N_2*IT_0259;
    const ccomplex_t IT_0464 = IT_0098*IT_0463;
    const ccomplex_t IT_0465 = m_N_3*IT_0290;
    const ccomplex_t IT_0466 = IT_0130*IT_0465;
    const ccomplex_t IT_0467 = m_N_4*IT_0336;
    const ccomplex_t IT_0468 = 0.5*IT_0443 + -IT_0453 + -IT_0456 + IT_0458 +
       IT_0460 + -IT_0462 + -IT_0464 + -IT_0466 + -IT_0467;
    const ccomplex_t IT_0469 = conj(IT_0451) + conj(IT_0468);
    const ccomplex_t IT_0470 = s_24*IT_0167;
    ...
    const ccomplex_t IT_0476 = IT_0351 + IT_0385;
    const ccomplex_t IT_0477 = IT_0451 + IT_0468;
    const ccomplex_t IT_0478 = conj(IT_0351) + conj(IT_0385);
    ...
    const ccomplex_t IT_0490 = IT_0067 + IT_0099 + IT_0131 + IT_0152;
    const ccomplex_t IT_0491 = 0.5*IT_0313;
    const ccomplex_t IT_0492 = -IT_0238 + -IT_0269 + -IT_0300 + (-0.5)*IT_0313;
    ...
    const ccomplex_t IT_0499 = s_12*IT_0167;
    ...
    const ccomplex_t IT_0540 = IT_0340*(conj(IT_0479) + conj(IT_0490)) + conj
      (IT_0399)*(IT_0351 + IT_0385 + -IT_0522) + IT_0399*(conj(IT_0351) + conj
      (IT_0385) + -IT_0524) + (conj(IT_0198) + 0.5*IT_0405)*IT_0535 + -IT_0512
    ...
    const ccomplex_t IT_0546 = s_14*IT_0167;
    ...
    const ccomplex_t IT_0553 = IT_0167*IT_0315;
    const ccomplex_t IT_0554 = (-3)*IT_0553;
    const ccomplex_t IT_0555 = (-2)*conj(IT_0490);
    const ccomplex_t IT_0556 = (-2)*IT_0490;
    const ccomplex_t IT_0557 = 0.5*IT_0527;
    const ccomplex_t IT_0558 = (-2)*conj(IT_0314);
    const ccomplex_t IT_0559 = 0.5*IT_0558;
    const ccomplex_t IT_0560 = conj(IT_0400) + IT_0559;
    const ccomplex_t IT_0561 = 3*IT_0553;
    const ccomplex_t IT_0562 = 0.5*IT_0476;
    const ccomplex_t IT_0563 = 0.5*IT_0478;
    const ccomplex_t IT_0564 = (-0.25)*IT_0547;
    const ccomplex_t IT_0565 = s_14 + IT_0564;
    const ccomplex_t IT_0566 = m_N_4*IT_0565;
    const ccomplex_t IT_0567 = (-4)*IT_0566;
    const ccomplex_t IT_0568 = 0.5*IT_0336;
    const ccomplex_t IT_0569 = 0.5*conj(IT_0336);
    const ccomplex_t IT_0570 = s_12*s_14;
    const ccomplex_t IT_0571 = s_24*IT_0025;
    const ccomplex_t IT_0572 = -IT_0571;
    const ccomplex_t IT_0573 = IT_0570 + IT_0572;
    const ccomplex_t IT_0574 = IT_0172*(conj(IT_0479) + conj(IT_0490)) +
       IT_0403*(IT_0351 + IT_0385 + IT_0492) + (conj(IT_0351) + conj(IT_0385) +
       conj(IT_0492))*(IT_0314 + 0.5*IT_0529) + conj(IT_0491)*(IT_0400 + 0.5
      *IT_0530) + conj(IT_0172)*IT_0535 + IT_0491*IT_0560 + IT_0544*IT_0568 +
       IT_0528*IT_0569;
    const ccomplex_t IT_0575 = 0.166666666666667*IT_0526*IT_0544;
    const ccomplex_t IT_0576 = IT_0408*IT_0545;
    const ccomplex_t IT_0577 = 0.333333333333333*conj(IT_0492)*IT_0551;
    const ccomplex_t IT_0578 = 0.333333333333333*IT_0489*conj(IT_0490);
    const ccomplex_t IT_0579 = 0.333333333333333*IT_0441*IT_0538;
    const ccomplex_t IT_0580 = 0.666666666666667*IT_0440*IT_0505;
    const ccomplex_t IT_0581 = IT_0469*IT_0526;
    const ccomplex_t IT_0582 = IT_0317*conj(IT_0400);
    const ccomplex_t IT_0583 = IT_0408*IT_0469;
    const ccomplex_t IT_0584 = IT_0440*IT_0441;
    const ccomplex_t IT_0585 = 2*IT_0172*(conj(IT_0172)*IT_0178 + conj(IT_0198
      )*IT_0202) + 2*IT_0198*(conj(IT_0172)*IT_0202 + conj(IT_0198)*IT_0207) + 2
      *conj(IT_0314)*(IT_0172*IT_0316 + IT_0317*IT_0340) + 2*IT_0399*(conj
      (IT_0172)*IT_0317 + IT_0207*conj(IT_0399) + IT_0202*IT_0403 + IT_0404
      ...
      *IT_0515 + IT_0522*IT_0524 + IT_0478*(IT_0351 + (-0.25)*IT_0525)) + 
      (IT_0202*conj(IT_0337) + IT_0316*conj(IT_0400) + IT_0440*IT_0526 + IT_0469
      *IT_0527)*IT_0528 + 2*conj(IT_0399)*(IT_0172*IT_0317 + IT_0340*IT_0404 +
       0.5*IT_0202*IT_0529) + conj(IT_0400)*(IT_0480*IT_0527 + IT_0178*IT_0530) 
      + 2*IT_0534*IT_0540 + 2*IT_0468*(IT_0489*conj(IT_0491) + 2*IT_0469*IT_0505
       + IT_0403*IT_0526 + IT_0408*IT_0538 + 3*IT_0315*IT_0543 + 0.5*IT_0527
      ...
      *IT_0552) + 2*IT_0554*(conj(IT_0490)*IT_0492 + IT_0490*conj(IT_0492) +
      ...
      ) + 2*IT_0451*(conj(IT_0399)*IT_0441 + IT_0489*conj(IT_0491) + IT_0403
      *IT_0526 + IT_0408*IT_0538 + 3*IT_0315*IT_0543 + IT_0544*IT_0557) + 2
      *IT_0400*(IT_0317*IT_0538 + 0.5*IT_0316*IT_0544 + IT_0483*IT_0557 +
       IT_0178*IT_0560) + 2*IT_0561*(IT_0515*IT_0522 + IT_0513*IT_0524 + IT_0555
      *IT_0562 + IT_0556*IT_0563) + 2*IT_0567*(IT_0469*IT_0479 + IT_0477*conj
      (IT_0479) + IT_0485*IT_0562 + IT_0482*IT_0563 + IT_0498*IT_0568 + IT_0495
      *IT_0569) + 2*IT_0573*IT_0574 + 6*IT_0428*(IT_0315*IT_0469 + 1./3*conj
      (IT_0314)*IT_0527 + IT_0575 + IT_0576 + IT_0577 + IT_0578 + IT_0579 +
       IT_0580) + 6*IT_0439*(IT_0315*IT_0469 + 1./3*IT_0403*IT_0527 + IT_0575 +
       IT_0576 + IT_0577 + IT_0578 + IT_0579 + IT_0580) + IT_0529*(conj(IT_0439)
      *IT_0527 + IT_0581) + 2*IT_0314*(IT_0178*conj(IT_0314) + conj(IT_0172)
      *IT_0316 + IT_0202*conj(IT_0399) + IT_0317*IT_0407 + IT_0440*IT_0527 +
       IT_0581) + IT_0539*(IT_0207*conj(IT_0337) + IT_0582 + IT_0583 + IT_0584) 
      + 2*IT_0337*(IT_0207*IT_0538 + 0.5*IT_0202*IT_0544 + IT_0582 + IT_0583 +
       IT_0584);
    return create_ccomplex_return(IT_0585);
}
