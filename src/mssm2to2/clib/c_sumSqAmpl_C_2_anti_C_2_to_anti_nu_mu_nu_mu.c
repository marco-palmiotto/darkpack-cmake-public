...
ccomplex_return_t c_sumSqAmpl_C_2_anti_C_2_to_anti_nu_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_smu_L*
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0006*IT_0029*IT_0031;
    const ccomplex_t IT_0033 = (-0.5)*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0006*IT_0029*IT_0031;
    const ccomplex_t IT_0035 = (-0.5)*IT_0034;
    const ccomplex_t IT_0036 = IT_0033*IT_0035;
    const ccomplex_t IT_0037 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_smu_R*
