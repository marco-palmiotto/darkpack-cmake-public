...
ccomplex_return_t c_sumSqAmpl_C_2_anti_C_2_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0037 = IT_0002*IT_0036;
    const ccomplex_t IT_0038 = conj(U_d2)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_12 + (-2)*IT_0000 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0006*IT_0057;
    const ccomplex_t IT_0072 = IT_0003*IT_0059;
    ...
    const ccomplex_t IT_0101 = IT_0066*IT_0100;
    const ccomplex_t IT_0102 = IT_0056*IT_0101;
    ...
    const ccomplex_t IT_0118 = cpow(IT_0002, -1);
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0009*IT_0013*IT_0118;
    const ccomplex_t IT_0120 = (-0.5)*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0009*IT_0013*IT_0118;
    const ccomplex_t IT_0122 = (-0.5)*IT_0121;
    const ccomplex_t IT_0123 = IT_0120*IT_0122;
    const ccomplex_t IT_0124 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0125 = IT_0123*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*IT_0125;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*V_us
      *e_em*IT_0009*IT_0013*IT_0118;
    const ccomplex_t IT_0128 = (-0.5)*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_us*e_em*IT_0009*IT_0013*IT_0118;
    const ccomplex_t IT_0130 = (-0.5)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0133 = IT_0131*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0009;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm2*IT_0009;
    const ccomplex_t IT_0137 = IT_0135*IT_0136;
    const ccomplex_t IT_0138 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0139 = IT_0137*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*IT_0139;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm2)*IT_0009;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*V_us*e_em*U_Wm2*IT_0009;
    const ccomplex_t IT_0143 = IT_0141*IT_0142;
    const ccomplex_t IT_0144 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_ss_L*
    ...
    const ccomplex_t IT_0149 = e_em*U_Wm2*conj(U_sb_00)*V_ub_mod;
    const ccomplex_t IT_0150 = IT_0148*IT_0149;
    const ccomplex_t IT_0151 = IT_0009*IT_0118*IT_0147;
    const ccomplex_t IT_0152 = m_b*U_d2*e_em*IT_0013*conj(U_sb_10)*V_ub_mod;
    ...
    const ccomplex_t IT_0158 = e_em*conj(U_Wm2)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0159 = IT_0157*IT_0158;
    const ccomplex_t IT_0160 = IT_0009*IT_0118*IT_0156;
    const ccomplex_t IT_0161 = m_b*conj(U_d2)*e_em*IT_0013*U_sb_10*V_ub_mod;
    const ccomplex_t IT_0162 = IT_0160*IT_0161;
    const ccomplex_t IT_0163 = 1.4142135623731*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*(IT_0159 + (-0.5)*IT_0163);
    const ccomplex_t IT_0165 = IT_0155*IT_0164;
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0167 = IT_0165*IT_0166;
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*IT_0167;
    const ccomplex_t IT_0169 = e_em*U_Wm2*conj(U_sb_01)*V_ub_mod;
    const ccomplex_t IT_0170 = IT_0148*IT_0169;
    const ccomplex_t IT_0171 = m_b*U_d2*e_em*IT_0013*conj(U_sb_11)*V_ub_mod;
    ...
    const ccomplex_t IT_0175 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0176 = IT_0157*IT_0175;
    const ccomplex_t IT_0177 = m_b*conj(U_d2)*e_em*IT_0013*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0182 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0183 = IT_0181*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*IT_0183;
    const ccomplex_t IT_0185 = IT_0126 + IT_0134 + IT_0140 + IT_0146 + IT_0168
       + IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_us
      *e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0187 = 0.5*IT_0186;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_us*e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0189 = 0.5*IT_0188;
    const ccomplex_t IT_0190 = IT_0187*IT_0189;
    const ccomplex_t IT_0191 = IT_0144*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0194 = 0.5*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
    ...
    const ccomplex_t IT_0200 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0009*IT_0013*IT_0014*IT_0156*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0201 = 0.5*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *e_em*IT_0009*IT_0013*IT_0014*IT_0147*conj(U_sb_00)*V_ub_mod;
    const ccomplex_t IT_0203 = 0.5*IT_0202;
    const ccomplex_t IT_0204 = IT_0201*IT_0203;
    const ccomplex_t IT_0205 = IT_0166*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0009*IT_0013*IT_0014*IT_0156*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0208 = 0.5*IT_0207;
    const ccomplex_t IT_0209 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *e_em*IT_0009*IT_0013*IT_0014*IT_0147*conj(U_sb_01)*V_ub_mod;
    const ccomplex_t IT_0210 = 0.5*IT_0209;
    const ccomplex_t IT_0211 = IT_0208*IT_0210;
    const ccomplex_t IT_0212 = IT_0182*IT_0211;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*IT_0212;
    const ccomplex_t IT_0214 = IT_0192 + IT_0199 + IT_0206 + IT_0213;
    ...
    const ccomplex_t IT_0242 = U_d2*conj(U_d2)*e_em;
    const ccomplex_t IT_0243 = IT_0224*IT_0242;
    const ccomplex_t IT_0244 = IT_0227*IT_0242;
    const ccomplex_t IT_0245 = e_em*U_Wm2*conj(U_Wm2);
    ...
    const ccomplex_t IT_0266 = m_u*m_C_2;
    ...
    const ccomplex_t IT_0277 = IT_0136*IT_0194;
    const ccomplex_t IT_0278 = IT_0138*IT_0277;
    const ccomplex_t IT_0279 = (0 + _Complex_I*1)*IT_0278;
    const ccomplex_t IT_0280 = IT_0142*IT_0187;
    const ccomplex_t IT_0281 = IT_0144*IT_0280;
    const ccomplex_t IT_0282 = (0 + _Complex_I*1)*IT_0281;
    const ccomplex_t IT_0283 = IT_0174*IT_0208;
    const ccomplex_t IT_0284 = IT_0182*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*IT_0284;
    const ccomplex_t IT_0286 = IT_0155*IT_0201;
    const ccomplex_t IT_0287 = IT_0166*IT_0286;
    const ccomplex_t IT_0288 = (0 + _Complex_I*1)*IT_0287;
    const ccomplex_t IT_0289 = -IT_0279 + -IT_0282 + -IT_0285 + -IT_0288;
    const ccomplex_t IT_0290 = IT_0135*IT_0196;
    const ccomplex_t IT_0291 = IT_0138*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = IT_0141*IT_0189;
    const ccomplex_t IT_0294 = IT_0144*IT_0293;
    const ccomplex_t IT_0295 = (0 + _Complex_I*1)*IT_0294;
    const ccomplex_t IT_0296 = IT_0164*IT_0203;
    const ccomplex_t IT_0297 = IT_0166*IT_0296;
    const ccomplex_t IT_0298 = (0 + _Complex_I*1)*IT_0297;
    const ccomplex_t IT_0299 = IT_0180*IT_0210;
    const ccomplex_t IT_0300 = IT_0182*IT_0299;
    const ccomplex_t IT_0301 = (0 + _Complex_I*1)*IT_0300;
    const ccomplex_t IT_0302 = -IT_0292 + -IT_0295 + -IT_0298 + -IT_0301;
    const ccomplex_t IT_0303 = 12*conj(IT_0289);
    const ccomplex_t IT_0304 = 12*conj(IT_0302);
    const ccomplex_t IT_0305 = IT_0112*(96*IT_0113 + 96*IT_0114 + 96*IT_0115 +
       192*IT_0116 + 96*IT_0117) + (IT_0185 + -conj(IT_0185) + IT_0214 + -conj
      ...
      -12)*IT_0289 + (-12)*IT_0302 + IT_0303 + IT_0304);
    const ccomplex_t IT_0306 = -s_24;
    const ccomplex_t IT_0307 = s_23 + IT_0306;
    const ccomplex_t IT_0308 = IT_0266*IT_0307;
    const ccomplex_t IT_0309 = 2*IT_0308;
    const ccomplex_t IT_0310 = 3*IT_0104;
    ...
    const ccomplex_t IT_0315 = 3*IT_0082;
    const ccomplex_t IT_0316 = s_23 + s_24;
    const ccomplex_t IT_0317 = IT_0266*IT_0316;
    const ccomplex_t IT_0318 = 6*IT_0054;
    const ccomplex_t IT_0319 = 12*IT_0185;
    const ccomplex_t IT_0320 = m_u*s_14*m_C_2;
    const ccomplex_t IT_0321 = 12*IT_0289;
    const ccomplex_t IT_0322 = 12*IT_0214;
    const ccomplex_t IT_0323 = s_13 + s_14;
    const ccomplex_t IT_0324 = IT_0266*IT_0323;
    const ccomplex_t IT_0325 = (-6)*IT_0032;
    const ccomplex_t IT_0326 = 6*conj(IT_0054);
    const ccomplex_t IT_0327 = 12*conj(IT_0185);
    const ccomplex_t IT_0328 = (-6)*conj(IT_0032);
    const ccomplex_t IT_0329 = 0.166666666666667*IT_0114;
    const ccomplex_t IT_0330 = 0.166666666666667*IT_0317;
    const ccomplex_t IT_0331 = m_u*s_23*m_C_2;
    const ccomplex_t IT_0332 = 0.166666666666667*IT_0331;
    const ccomplex_t IT_0333 = 0.166666666666667*IT_0309;
    const ccomplex_t IT_0334 = 0.166666666666667*IT_0314;
    const ccomplex_t IT_0335 = s_12*s_34;
    const ccomplex_t IT_0336 = -IT_0335;
    const ccomplex_t IT_0337 = -IT_0114;
    const ccomplex_t IT_0338 = IT_0113 + IT_0115 + IT_0336 + IT_0337;
    const ccomplex_t IT_0339 = 12*IT_0302;
    const ccomplex_t IT_0340 = 0.166666666666667*IT_0055;
    const ccomplex_t IT_0341 = 0.166666666666667*IT_0320;
    const ccomplex_t IT_0342 = 0.166666666666667*IT_0116;
    const ccomplex_t IT_0343 = -IT_0115;
    const ccomplex_t IT_0344 = IT_0113 + IT_0114 + IT_0335 + IT_0343;
    const ccomplex_t IT_0345 = 0.166666666666667*IT_0344;
    const ccomplex_t IT_0346 = 12*conj(IT_0214);
    const ccomplex_t IT_0347 = 4*IT_0308;
    const ccomplex_t IT_0348 = m_u*s_13*m_C_2;
    const ccomplex_t IT_0349 = m_u*s_24*m_C_2;
    const ccomplex_t IT_0350 = 12*IT_0032;
    const ccomplex_t IT_0351 = (-4)*IT_0313;
    const ccomplex_t IT_0352 = IT_0315*IT_0351;
    const ccomplex_t IT_0353 = 48*IT_0237;
    const ccomplex_t IT_0354 = 24*IT_0214;
    const ccomplex_t IT_0355 = IT_0353 + IT_0354;
    const ccomplex_t IT_0356 = 12*IT_0054;
    const ccomplex_t IT_0357 = (-12)*IT_0032;
    const ccomplex_t IT_0358 = 24*IT_0289;
    const ccomplex_t IT_0359 = 24*IT_0302;
    const ccomplex_t IT_0360 = IT_0315*IT_0347;
    const ccomplex_t IT_0361 = 12*conj(IT_0054);
    const ccomplex_t IT_0362 = (-12)*conj(IT_0032);
    const ccomplex_t IT_0363 = 24*conj(IT_0185);
    const ccomplex_t IT_0364 = 24*conj(IT_0260);
    const ccomplex_t IT_0365 = 24*conj(IT_0289);
    const ccomplex_t IT_0366 = 24*conj(IT_0302);
    const ccomplex_t IT_0367 = 24*conj(IT_0214);
    const ccomplex_t IT_0368 = 24*conj(IT_0263);
    const ccomplex_t IT_0369 = IT_0273*IT_0351;
    const ccomplex_t IT_0370 = IT_0272*IT_0347;
    const ccomplex_t IT_0371 = -IT_0112;
    const ccomplex_t IT_0372 = IT_0256*IT_0371;
    const ccomplex_t IT_0373 = IT_0272*IT_0351;
    const ccomplex_t IT_0374 = IT_0273*IT_0347;
    const ccomplex_t IT_0375 = IT_0324*IT_0361 + IT_0317*IT_0362 + IT_0114*(48
      *conj(IT_0251) + IT_0363) + IT_0117*IT_0364 + IT_0331*IT_0365 + IT_0320
      *IT_0366 + IT_0116*(48*conj(IT_0237) + IT_0367) + IT_0113*IT_0368 +
       IT_0372 + IT_0373 + IT_0374;
    const ccomplex_t IT_0376 = 24*conj(IT_0237);
    const ccomplex_t IT_0377 = IT_0346 + IT_0376;
    const ccomplex_t IT_0378 = 24*conj(IT_0251);
    const ccomplex_t IT_0379 = IT_0327 + IT_0378;
    const ccomplex_t IT_0380 = 12*conj(IT_0032);
    const ccomplex_t IT_0381 = (-12)*conj(IT_0054);
    const ccomplex_t IT_0382 = 48*conj(IT_0263);
    const ccomplex_t IT_0383 = IT_0265*IT_0371;
    const ccomplex_t IT_0384 = IT_0260*(48*IT_0115*conj(IT_0260) + IT_0303
      *IT_0348 + IT_0304*IT_0349 + IT_0369 + IT_0370 + IT_0113*IT_0377 + IT_0117
      *IT_0379 + IT_0324*IT_0380 + IT_0317*IT_0381 + IT_0116*IT_0382 + IT_0383);
    const ccomplex_t IT_0385 = IT_0263*(48*IT_0116*conj(IT_0260) + IT_0304
      *IT_0348 + IT_0303*IT_0349 + IT_0373 + IT_0374 + IT_0117*IT_0377 + IT_0113
      *IT_0379 + IT_0317*IT_0380 + IT_0324*IT_0381 + IT_0115*IT_0382 + IT_0383);
    const ccomplex_t IT_0386 = IT_0054*(24*IT_0035*conj(IT_0054) + (-24)*conj
      ...
      (IT_0104)*IT_0105) + -IT_0112*IT_0305 + conj(IT_0214)*(IT_0309*IT_0310 +
       IT_0314*IT_0315 + IT_0317*IT_0318 + IT_0116*IT_0319 + IT_0320*IT_0321 +
       IT_0114*IT_0322 + IT_0324*IT_0325) + IT_0214*(IT_0272*IT_0309 + IT_0273
      *IT_0314 + IT_0303*IT_0320 + IT_0317*IT_0326 + IT_0116*IT_0327 + IT_0324
      *IT_0328) + 6*IT_0185*(conj(IT_0054)*IT_0324 + IT_0328*IT_0330 + IT_0303
      *IT_0332 + IT_0273*IT_0333 + IT_0272*IT_0334) + 6*conj(IT_0185)*(IT_0054
      *IT_0324 + IT_0319*IT_0329 + IT_0325*IT_0330 + IT_0321*IT_0332 + IT_0315
      *IT_0333 + IT_0310*IT_0334) + 6*conj(IT_0302)*(IT_0082*IT_0105 + IT_0322
      *IT_0332 + -IT_0104*IT_0338 + IT_0329*IT_0339 + IT_0325*IT_0340 + IT_0319
      *IT_0341 + IT_0321*IT_0342 + IT_0318*IT_0345) + 6*conj(IT_0289)*(IT_0054
      *IT_0055 + IT_0104*IT_0105 + IT_0321*IT_0329 + -IT_0082*IT_0338 + IT_0325
      *IT_0345) + 6*IT_0289*(conj(IT_0054)*IT_0055 + conj(IT_0104)*IT_0105 + 
      -conj(IT_0082)*IT_0338 + IT_0328*IT_0345) + 6*IT_0302*(conj(IT_0082)
      *IT_0105 + -conj(IT_0104)*IT_0338 + IT_0328*IT_0340 + IT_0327*IT_0341 +
       IT_0303*IT_0342 + IT_0326*IT_0345 + IT_0332*IT_0346) + conj(IT_0260)*((
      -12)*IT_0054*IT_0317 + IT_0117*IT_0319 + IT_0113*IT_0322 + IT_0310*IT_0347
       + IT_0321*IT_0348 + IT_0339*IT_0349 + IT_0324*IT_0350 + IT_0352) + conj
      (IT_0237)*(24*IT_0116*IT_0185 + IT_0310*IT_0347 + IT_0352 + IT_0114
      *IT_0355 + IT_0317*IT_0356 + IT_0324*IT_0357 + IT_0320*IT_0358 + IT_0331
      *IT_0359) + conj(IT_0263)*(IT_0113*IT_0319 + IT_0117*IT_0322 + (-12)
      *IT_0054*IT_0324 + IT_0339*IT_0348 + IT_0321*IT_0349 + IT_0317*IT_0350 +
       IT_0310*IT_0351 + IT_0360) + conj(IT_0251)*(24*IT_0114*IT_0185 + IT_0310
      *IT_0351 + IT_0116*IT_0355 + IT_0324*IT_0356 + IT_0317*IT_0357 + IT_0331
      *IT_0358 + IT_0320*IT_0359 + IT_0360) + IT_0237*(IT_0317*IT_0361 + IT_0324
      *IT_0362 + IT_0116*IT_0363 + IT_0113*IT_0364 + IT_0320*IT_0365 + IT_0331
      *IT_0366 + IT_0114*IT_0367 + IT_0117*IT_0368 + IT_0369 + IT_0370 + IT_0372
      ) + IT_0251*IT_0375 + IT_0384 + IT_0385;
