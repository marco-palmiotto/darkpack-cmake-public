        ...
        )
{
    ...
    const ccomplex_t IT_0036 = U_d2*V_Wp2;
    const ccomplex_t IT_0037 = IT_0002*IT_0036;
    const ccomplex_t IT_0038 = V_u2*U_Wm2;
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_us
      *e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0119 = 0.5*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_us*e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0121 = 0.5*IT_0120;
    const ccomplex_t IT_0122 = IT_0119*IT_0121;
    const ccomplex_t IT_0123 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0124 = IT_0122*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0127 = 0.5*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_ud*e_em*IT_0009*IT_0013*IT_0014;
    const ccomplex_t IT_0129 = 0.5*IT_0128;
    const ccomplex_t IT_0130 = IT_0127*IT_0129;
    const ccomplex_t IT_0131 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0132 = IT_0130*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*IT_0132;
    const ccomplex_t IT_0134 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0135 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0009*IT_0013*IT_0014*IT_0135*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *e_em*IT_0009*IT_0013*IT_0014*IT_0138*conj(U_sb_00)*V_ub_mod;
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0009*IT_0013*IT_0014*IT_0135*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0146 = 0.5*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *e_em*IT_0009*IT_0013*IT_0014*IT_0138*conj(U_sb_01)*V_ub_mod;
    ...
    const ccomplex_t IT_0152 = IT_0125 + IT_0133 + IT_0143 + IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0009;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm2*IT_0009;
    ...
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm2)*IT_0009;
    const ccomplex_t IT_0159 = (0 + _Complex_I*1)*V_us*e_em*U_Wm2*IT_0009;
    ...
    const ccomplex_t IT_0163 = IT_0009*IT_0138;
    const ccomplex_t IT_0164 = e_em*U_Wm2*conj(U_sb_00)*V_ub_mod;
    const ccomplex_t IT_0165 = IT_0163*IT_0164;
    const ccomplex_t IT_0166 = cpow(IT_0002, -1);
    const ccomplex_t IT_0167 = IT_0009*IT_0138*IT_0166;
    const ccomplex_t IT_0168 = m_b*U_d2*e_em*IT_0013*conj(U_sb_10)*V_ub_mod;
    const ccomplex_t IT_0169 = IT_0167*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*(IT_0165 + (-0.5)*IT_0170);
    const ccomplex_t IT_0172 = IT_0009*IT_0135;
    const ccomplex_t IT_0173 = e_em*conj(U_Wm2)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0174 = IT_0172*IT_0173;
    const ccomplex_t IT_0175 = IT_0009*IT_0135*IT_0166;
    const ccomplex_t IT_0176 = m_b*conj(U_d2)*e_em*IT_0013*U_sb_10*V_ub_mod;
    ...
    const ccomplex_t IT_0183 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0184 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0009*IT_0013*IT_0166;
    const ccomplex_t IT_0185 = (-0.5)*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0009*IT_0013*IT_0166;
    ...
    const ccomplex_t IT_0191 = cpow((-2)*s_23 + IT_0000 + IT_0033 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0192 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_us*e_em*IT_0009*IT_0013*IT_0166;
    const ccomplex_t IT_0193 = (-0.5)*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*V_us
      *e_em*IT_0009*IT_0013*IT_0166;
    ...
    const ccomplex_t IT_0199 = e_em*U_Wm2*conj(U_sb_01)*V_ub_mod;
    const ccomplex_t IT_0200 = IT_0163*IT_0199;
    const ccomplex_t IT_0201 = m_b*U_d2*e_em*IT_0013*conj(U_sb_11)*V_ub_mod;
    const ccomplex_t IT_0202 = IT_0167*IT_0201;
    const ccomplex_t IT_0203 = 1.4142135623731*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*(IT_0200 + (-0.5)*IT_0203);
    const ccomplex_t IT_0205 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0206 = IT_0172*IT_0205;
    const ccomplex_t IT_0207 = m_b*conj(U_d2)*e_em*IT_0013*U_sb_11*V_ub_mod;
    const ccomplex_t IT_0208 = IT_0175*IT_0207;
    ...
    const ccomplex_t IT_0214 = IT_0157 + IT_0162 + IT_0182 + IT_0190 + IT_0198
       + IT_0213;
    ...
    const ccomplex_t IT_0220 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
      *Gamma_Z) + (-2)*IT_0000 + -reg_prop, -1);
    const ccomplex_t IT_0221 = cos(theta_W);
    const ccomplex_t IT_0222 = cpow(IT_0221, -1);
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*e_em*IT_0008*IT_0222;
    const ccomplex_t IT_0224 = (-0.666666666666667)*IT_0223;
    const ccomplex_t IT_0225 = IT_0008*IT_0222;
    const ccomplex_t IT_0226 = V_u2*conj(V_u2)*e_em;
    const ccomplex_t IT_0227 = IT_0225*IT_0226;
    const ccomplex_t IT_0228 = IT_0009*IT_0221;
    const ccomplex_t IT_0229 = IT_0226*IT_0228;
    const ccomplex_t IT_0230 = e_em*V_Wp2*conj(V_Wp2);
    const ccomplex_t IT_0231 = IT_0228*IT_0230;
    const ccomplex_t IT_0232 = (0 + _Complex_I*1)*(IT_0227 + -IT_0229 + (-2)
      *IT_0231);
    const ccomplex_t IT_0233 = (-0.5)*IT_0232;
    const ccomplex_t IT_0234 = IT_0224*IT_0233;
    const ccomplex_t IT_0235 = IT_0220*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*IT_0235;
    const ccomplex_t IT_0237 = -IT_0236;
    const ccomplex_t IT_0238 = e_em*IT_0225;
    const ccomplex_t IT_0239 = e_em*IT_0228;
    ...
    const ccomplex_t IT_0244 = IT_0228*IT_0242;
    const ccomplex_t IT_0245 = e_em*U_Wm2*conj(U_Wm2);
    const ccomplex_t IT_0246 = IT_0228*IT_0245;
    ...
    const ccomplex_t IT_0250 = IT_0220*IT_0249;
    ...
    const ccomplex_t IT_0257 = IT_0233*IT_0241;
    const ccomplex_t IT_0258 = IT_0220*IT_0257;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*IT_0258;
    const ccomplex_t IT_0260 = -IT_0259;
    const ccomplex_t IT_0261 = IT_0224*IT_0248;
    const ccomplex_t IT_0262 = IT_0220*IT_0261;
    ...
    const ccomplex_t IT_0277 = IT_0127*IT_0154;
    const ccomplex_t IT_0278 = IT_0131*IT_0277;
    const ccomplex_t IT_0279 = (0 + _Complex_I*1)*IT_0278;
    const ccomplex_t IT_0280 = IT_0119*IT_0159;
    const ccomplex_t IT_0281 = IT_0123*IT_0280;
    const ccomplex_t IT_0282 = (0 + _Complex_I*1)*IT_0281;
    const ccomplex_t IT_0283 = IT_0137*IT_0171;
    const ccomplex_t IT_0284 = IT_0134*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*IT_0284;
    const ccomplex_t IT_0286 = IT_0146*IT_0204;
    ...
    const ccomplex_t IT_0317 = m_u*s_23*m_C_2;
    ...
    const ccomplex_t IT_0347 = m_u*s_24*m_C_2;
    ...
    const ccomplex_t IT_0363 = 24*conj(IT_0260);
    const ccomplex_t IT_0364 = 24*conj(IT_0214);
    const ccomplex_t IT_0365 = 24*conj(IT_0263);
    const ccomplex_t IT_0366 = IT_0273*IT_0351;
    const ccomplex_t IT_0367 = IT_0272*IT_0346;
    const ccomplex_t IT_0368 = -IT_0112;
    const ccomplex_t IT_0369 = IT_0256*IT_0368;
    const ccomplex_t IT_0370 = IT_0330*IT_0358 + IT_0328*IT_0359 + IT_0317
      *IT_0360 + IT_0320*IT_0361 + IT_0116*(48*conj(IT_0237) + IT_0362) +
       IT_0117*IT_0363 + IT_0114*(48*conj(IT_0251) + IT_0364) + IT_0113*IT_0365 
      + IT_0366 + IT_0367 + IT_0369;
    const ccomplex_t IT_0371 = IT_0272*IT_0351;
    const ccomplex_t IT_0372 = IT_0273*IT_0346;
    ...
    const ccomplex_t IT_0380 = IT_0265*IT_0368;
    const ccomplex_t IT_0381 = IT_0263*(48*IT_0116*conj(IT_0260) + IT_0290
      *IT_0347 + IT_0304*IT_0348 + IT_0366 + IT_0367 + IT_0117*IT_0374 + IT_0113
    ...
    const ccomplex_t IT_0382 = IT_0260*(48*IT_0115*conj(IT_0260) + IT_0304
      *IT_0347 + IT_0290*IT_0348 + IT_0371 + IT_0372 + IT_0113*IT_0374 + IT_0117
    ...
    const ccomplex_t IT_0383 = IT_0054*(24*IT_0035*conj(IT_0054) + (-24)*conj
      ...
      *IT_0303*IT_0317 + 24*IT_0289*IT_0320 + IT_0338*IT_0351 + IT_0114*IT_0354 
      + IT_0328*IT_0355 + IT_0330*IT_0356 + IT_0357) + IT_0251*IT_0370 + IT_0237
      *(IT_0328*IT_0358 + IT_0330*IT_0359 + IT_0320*IT_0360 + IT_0317*IT_0361 +
       IT_0114*IT_0362 + IT_0113*IT_0363 + IT_0116*IT_0364 + IT_0117*IT_0365 +
       IT_0369 + IT_0371 + IT_0372) + IT_0381 + IT_0382;
