        ...
        )
{
    ...
    const ccomplex_t IT_0031 = m_c*IT_0030;
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0000*IT_0001*IT_0004*IT_0035;
    const ccomplex_t IT_0037 = 0.5*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_cb*e_em*IT_0000*IT_0004*IT_0035;
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_12 + -IT_0027 + -IT_0033 + IT_0044 
      + -reg_prop, -1);
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*IT_0000*IT_0001*IT_0004*IT_0035;
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_cd*e_em*IT_0000*IT_0004*IT_0035;
    ...
    const ccomplex_t IT_0054 = pow(m_s, 2);
    const ccomplex_t IT_0055 = cpow((-2)*s_12 + -IT_0027 + -IT_0033 + IT_0054 
      + -reg_prop, -1);
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0000*IT_0001*IT_0004*IT_0035;
    const ccomplex_t IT_0057 = 0.5*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
    ...
    const ccomplex_t IT_0063 = m_C_2*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_N_3*
    ...
    const ccomplex_t IT_0088 = IT_0064*IT_0065*IT_0087;
    ...
    const ccomplex_t IT_0113 = IT_0089*IT_0090*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*V_cb*e_em*V_Wp2*IT_0004;
    const ccomplex_t IT_0116 = -IT_0115;
    const ccomplex_t IT_0117 = IT_0037*IT_0116;
    const ccomplex_t IT_0118 = IT_0034*IT_0114*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*V_cd*e_em*V_Wp2*IT_0004;
    const ccomplex_t IT_0121 = -IT_0120;
    const ccomplex_t IT_0122 = IT_0047*IT_0121;
    const ccomplex_t IT_0123 = IT_0045*IT_0119*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0004;
    const ccomplex_t IT_0126 = -IT_0125;
    const ccomplex_t IT_0127 = IT_0057*IT_0126;
    const ccomplex_t IT_0128 = IT_0055*IT_0124*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0136 = N_B1*e_em;
    const ccomplex_t IT_0137 = IT_0013*IT_0136;
    const ccomplex_t IT_0138 = 1.4142135623731*IT_0137;
    const ccomplex_t IT_0139 = N_W1*e_em;
    ...
    const ccomplex_t IT_0145 = IT_0028*IT_0135*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0147 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0148 = N_B2*e_em;
    const ccomplex_t IT_0149 = IT_0013*IT_0148;
    const ccomplex_t IT_0150 = 1.4142135623731*IT_0149;
    const ccomplex_t IT_0151 = N_W2*e_em;
    ...
    const ccomplex_t IT_0170 = IT_0146*IT_0147*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0183 = -IT_0031 + IT_0043 + IT_0053 + IT_0063 +
       IT_0088 + IT_0113 + -IT_0118 + -IT_0123 + -IT_0128 + -IT_0134 + IT_0145 +
       IT_0170 + -IT_0176 + -IT_0182;
    const ccomplex_t IT_0184 = IT_0001*IT_0004;
    const ccomplex_t IT_0185 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0186 = IT_0184*IT_0185;
    const ccomplex_t IT_0187 = (-2)*IT_0186;
    const ccomplex_t IT_0188 = IT_0001*IT_0013;
    const ccomplex_t IT_0189 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0190 = IT_0188*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0216 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0222 = IT_0006*IT_0221;
    const ccomplex_t IT_0223 = IT_0028*IT_0135*IT_0222;
    const ccomplex_t IT_0224 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0000*IT_0002*IT_0004*IT_0007;
    const ccomplex_t IT_0225 = 0.5*IT_0224;
    const ccomplex_t IT_0226 = IT_0039*IT_0225;
    const ccomplex_t IT_0227 = IT_0034*IT_0114*IT_0226;
    const ccomplex_t IT_0228 = IT_0143*IT_0221;
    const ccomplex_t IT_0229 = IT_0028*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = m_c*IT_0230;
    const ccomplex_t IT_0232 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0233 = IT_0184*IT_0232;
    const ccomplex_t IT_0234 = (-2)*IT_0233;
    const ccomplex_t IT_0235 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0236 = IT_0188*IT_0235;
    const ccomplex_t IT_0237 = 1.4142135623731*IT_0236;
    const ccomplex_t IT_0238 = conj(N_W3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0239 = IT_0184*IT_0238;
    ...
    const ccomplex_t IT_0245 = IT_0073*IT_0244;
    const ccomplex_t IT_0246 = IT_0065*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = m_c*IT_0247;
    const ccomplex_t IT_0249 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0250 = IT_0184*IT_0249;
    const ccomplex_t IT_0251 = (-2)*IT_0250;
    const ccomplex_t IT_0252 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0253 = IT_0188*IT_0252;
    const ccomplex_t IT_0254 = 1.4142135623731*IT_0253;
    const ccomplex_t IT_0255 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0262 = IT_0098*IT_0261;
    ...
    const ccomplex_t IT_0266 = IT_0116*IT_0225;
    ...
    const ccomplex_t IT_0270 = IT_0130*IT_0244;
    const ccomplex_t IT_0271 = IT_0064*IT_0065*IT_0270;
    const ccomplex_t IT_0272 = IT_0178*IT_0261;
    const ccomplex_t IT_0273 = IT_0089*IT_0090*IT_0272;
    const ccomplex_t IT_0274 = IT_0155*IT_0198;
    ...
    const ccomplex_t IT_0278 = IT_0121*IT_0202;
    const ccomplex_t IT_0279 = IT_0045*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*IT_0279;
    const ccomplex_t IT_0281 = m_C_2*IT_0280;
    const ccomplex_t IT_0282 = IT_0126*IT_0206;
    const ccomplex_t IT_0283 = IT_0055*IT_0282;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = m_C_2*IT_0284;
    const ccomplex_t IT_0286 = IT_0200 + IT_0204 + IT_0208 + IT_0223 + IT_0227
       + -IT_0231 + -IT_0248 + -IT_0265 + -IT_0269 + IT_0271 + IT_0273 + 
      -IT_0277 + -IT_0281 + -IT_0285;
    const ccomplex_t IT_0287 = m_c*m_C_2;
    const ccomplex_t IT_0288 = -IT_0042 + -IT_0052 + -IT_0062 + -IT_0230 + 
      -IT_0247 + -IT_0264 + -IT_0276;
    const ccomplex_t IT_0289 = s_23*m_C_2;
    const ccomplex_t IT_0290 = -IT_0030 + -IT_0133 + -IT_0175 + -IT_0181 +
       IT_0268 + IT_0280 + IT_0284;
    const ccomplex_t IT_0291 = m_c*s_12;
    const ccomplex_t IT_0292 = 6*s_13;
    const ccomplex_t IT_0293 = (-6)*IT_0286;
    const ccomplex_t IT_0294 = m_c*m_C_2*IT_0027;
    const ccomplex_t IT_0295 = s_13*IT_0027;
