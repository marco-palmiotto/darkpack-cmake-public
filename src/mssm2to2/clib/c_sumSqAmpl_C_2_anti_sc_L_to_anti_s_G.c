...
ccomplex_return_t c_sumSqAmpl_C_2_anti_sc_L_to_anti_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0006;
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0006*IT_0018*IT_0020;
    ...
    const ccomplex_t IT_0039 = m_s*s_14*m_C_2;
    ...
    const ccomplex_t IT_0049 = m_s*m_C_2;
    ...
    const ccomplex_t IT_0054 = m_s*s_34*m_C_2;
