        ...
        )
{
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0040 
      + -reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_s*e_em*IT_0005*IT_0012
      *IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0012;
    ...
    const ccomplex_t IT_0082 = pow(m_c, 2);
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_13 + IT_0002 + IT_0040 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0091 = IT_0089*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = m_s*IT_0048;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0005
      *IT_0012*IT_0017*IT_0084;
    const ccomplex_t IT_0095 = 0.5*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0012*IT_0017*IT_0084;
    const ccomplex_t IT_0097 = 0.5*IT_0096;
    const ccomplex_t IT_0098 = IT_0095*IT_0097;
    const ccomplex_t IT_0099 = cpow((-2)*s_13 + IT_0002 + IT_0040 + -m_sc_R*
    ...
    const ccomplex_t IT_0118 = m_s*IT_0052;
