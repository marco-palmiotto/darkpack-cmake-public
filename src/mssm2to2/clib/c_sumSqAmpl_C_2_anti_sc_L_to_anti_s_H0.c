...
ccomplex_return_t c_sumSqAmpl_C_2_anti_sc_L_to_anti_s_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = V_u2*U_Wm1;
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = IT_0009*(IT_0014 + IT_0017);
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0040 
      + -reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_s*e_em*IT_0005*IT_0007
      *IT_0009*IT_0012;
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0009;
    ...
    const ccomplex_t IT_0054 = IT_0009*(IT_0051 + IT_0053);
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0009;
    ...
    const ccomplex_t IT_0067 = IT_0009*(IT_0064 + IT_0066);
    ...
    const ccomplex_t IT_0075 = IT_0027*IT_0043;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0005
      *IT_0009*IT_0012*IT_0083;
    const ccomplex_t IT_0085 = 0.5*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0005*IT_0009*IT_0083;
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = IT_0085*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_13 + IT_0002 + IT_0040 + -m_sc_R*
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*e_em*(IT_0005*IT_0009
      *IT_0015*IT_0083*IT_0092 + 0.5*m_W*(IT_0006*IT_0012 + -IT_0015*IT_0082)*
      (IT_0009 + -1./3*IT_0008*IT_0094));
    const ccomplex_t IT_0096 = -IT_0095;
    const ccomplex_t IT_0097 = IT_0045*IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0002 + IT_0040 + -m_sc_L*
    ...
    const ccomplex_t IT_0102 = IT_0035*IT_0045;
    const ccomplex_t IT_0103 = IT_0025*IT_0101*IT_0102;
    const ccomplex_t IT_0104 = m_s*IT_0048;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0106 = IT_0021*IT_0062;
    const ccomplex_t IT_0107 = IT_0004*IT_0105*IT_0106;
    const ccomplex_t IT_0108 = IT_0091 + IT_0100 + -IT_0103 + (-2)*IT_0104 + 
      -IT_0107;
    const ccomplex_t IT_0109 = m_C_2*IT_0039;
    const ccomplex_t IT_0110 = -IT_0109;
    const ccomplex_t IT_0111 = IT_0011*IT_0070;
    const ccomplex_t IT_0112 = IT_0004*IT_0105*IT_0111;
    const ccomplex_t IT_0113 = IT_0027*IT_0057;
    const ccomplex_t IT_0114 = IT_0025*IT_0101*IT_0113;
    const ccomplex_t IT_0115 = m_s*IT_0077;
    const ccomplex_t IT_0116 = IT_0027*IT_0096;
    const ccomplex_t IT_0117 = IT_0098*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*IT_0117;
    const ccomplex_t IT_0119 = IT_0112 + IT_0114 + 2*IT_0115 + -IT_0118;
    const ccomplex_t IT_0120 = IT_0060 + IT_0073;
    const ccomplex_t IT_0121 = m_C_2*IT_0120;
    const ccomplex_t IT_0122 = 6*s_13;
    const ccomplex_t IT_0123 = (-6)*s_13;
    const ccomplex_t IT_0124 = m_s*m_C_2;
    ...
    const ccomplex_t IT_0136 = m_s*s_14;
    ...
    const ccomplex_t IT_0142 = (-6)*IT_0074;
    const ccomplex_t IT_0143 = 6*IT_0001*(IT_0049*IT_0079 + IT_0080*IT_0081) +
      ...
      *IT_0135) + 6*(IT_0049*IT_0127 + IT_0080*IT_0130 + IT_0079*(conj(IT_0110) 
      ...
      (IT_0049*(IT_0048 + (-0.166666666666667)*IT_0141) + IT_0081*(IT_0078 + (
