        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0015;
    ...
    const ccomplex_t IT_0029 = m_s*IT_0028;
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0015*IT_0038*IT_0040;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0015*IT_0038*IT_0040;
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0015;
    ...
    const ccomplex_t IT_0122 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sc_L*
    ...
    const ccomplex_t IT_0164 = m_s*IT_0146;
