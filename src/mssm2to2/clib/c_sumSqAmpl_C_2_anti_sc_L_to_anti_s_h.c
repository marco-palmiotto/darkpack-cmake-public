...
ccomplex_return_t c_sumSqAmpl_C_2_anti_sc_L_to_anti_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0012*IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0040 
      + -reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_s*e_em*IT_0008*IT_0012
      *IT_0017*IT_0019;
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0012;
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp1*IT_0012;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0008
      *IT_0012*IT_0017*IT_0083;
    const ccomplex_t IT_0085 = (-0.5)*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0012*IT_0017*IT_0083;
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*e_em*(IT_0005*IT_0012
      *IT_0017*IT_0083*IT_0092 + (-0.5)*m_W*(IT_0008*IT_0018 + IT_0005*IT_0082)*
      (IT_0012 + -1./3*IT_0011*IT_0094));
    ...
    const ccomplex_t IT_0102 = IT_0016*IT_0051;
    const ccomplex_t IT_0103 = IT_0004*IT_0101*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0105 = IT_0033*IT_0045;
    const ccomplex_t IT_0106 = IT_0025*IT_0104*IT_0105;
    const ccomplex_t IT_0107 = m_s*IT_0048;
    const ccomplex_t IT_0108 = IT_0091 + IT_0100 + -IT_0103 + -IT_0106 + (-2)
      *IT_0107;
    const ccomplex_t IT_0109 = m_C_2*IT_0039;
    const ccomplex_t IT_0110 = -IT_0109;
    const ccomplex_t IT_0111 = IT_0035*IT_0096;
    const ccomplex_t IT_0112 = IT_0098*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*IT_0112;
    const ccomplex_t IT_0114 = IT_0021*IT_0059;
    const ccomplex_t IT_0115 = IT_0004*IT_0101*IT_0114;
    const ccomplex_t IT_0116 = IT_0035*IT_0070;
    const ccomplex_t IT_0117 = IT_0025*IT_0104*IT_0116;
    const ccomplex_t IT_0118 = m_s*IT_0077;
    const ccomplex_t IT_0119 = -IT_0113 + IT_0115 + IT_0117 + 2*IT_0118;
    const ccomplex_t IT_0120 = IT_0062 + IT_0073;
