...
ccomplex_return_t c_sumSqAmpl_C_2_anti_sc_R_to_anti_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_sc_R*
    ...
    const ccomplex_t IT_0021 = s_14*IT_0009;
    ...
    const ccomplex_t IT_0029 = -IT_0018*(IT_0015 + -IT_0028);
    ...
    const ccomplex_t IT_0035 = (-8)*conj(IT_0014)*(IT_0020*IT_0021 + (-4)
      *IT_0014*IT_0022 + (-0.125)*IT_0023*IT_0027) + conj(IT_0030)*(s_14*IT_0023
      *IT_0031 + IT_0020*IT_0032) + conj(IT_0023)*(IT_0014*IT_0027 + (IT_0010
      *IT_0023 + s_14*IT_0030)*IT_0031 + IT_0020*IT_0034) + (-8)*conj(IT_0020)*
      (s_13*IT_0009*IT_0020 + IT_0014*IT_0021 + (-0.125)*IT_0030*IT_0032 + (
      -0.125)*IT_0023*IT_0034);
