...
ccomplex_return_t c_sumSqAmpl_C_2_anti_sc_R_to_anti_s_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_s*e_em*IT_0000*IT_0004
      *IT_0007*IT_0039;
    ...
    const ccomplex_t IT_0048 = m_s*m_C_2*IT_0047;
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0002*IT_0004*IT_0007;
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0004;
    const ccomplex_t IT_0056 = -IT_0055;
    const ccomplex_t IT_0057 = IT_0054*IT_0056;
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0018 + IT_0043 + -m_sc_L*
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0018 + IT_0043 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = m_s*IT_0046;
    ...
    const ccomplex_t IT_0093 = IT_0060 + IT_0069 + (-2)*IT_0070 + -IT_0081 + 
      -IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0000*IT_0004*IT_0039;
    ...
    const ccomplex_t IT_0104 = m_s*s_14;
