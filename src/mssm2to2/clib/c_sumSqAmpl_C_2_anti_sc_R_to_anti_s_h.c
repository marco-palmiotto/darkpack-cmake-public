...
ccomplex_return_t c_sumSqAmpl_C_2_anti_sc_R_to_anti_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0009 = IT_0007*IT_0008;
    const ccomplex_t IT_0010 = sin(alpha);
    const ccomplex_t IT_0011 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_C_1*
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_C_2*
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0018 + IT_0045 + -m_sc_L*
    ...
    const ccomplex_t IT_0080 = IT_0020*IT_0078*IT_0079;
    const ccomplex_t IT_0081 = V_u2*U_Wm2;
    const ccomplex_t IT_0082 = IT_0007*IT_0081;
    const ccomplex_t IT_0083 = U_d2*V_Wp2;
    const ccomplex_t IT_0084 = IT_0010*IT_0083;
    const ccomplex_t IT_0085 = IT_0004*(IT_0082 + -IT_0084);
    ...
    const ccomplex_t IT_0091 = IT_0034*IT_0089*IT_0090;
    const ccomplex_t IT_0092 = m_s*IT_0048;
    const ccomplex_t IT_0093 = IT_0060 + IT_0069 + -IT_0080 + -IT_0091 + (-2)
      *IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0000*IT_0004*IT_0041;
    ...
    const ccomplex_t IT_0113 = m_s*m_C_2;
    const ccomplex_t IT_0114 = s_34*m_C_2;
    const ccomplex_t IT_0115 = 6*conj(IT_0037)*(IT_0039*IT_0048 + -IT_0037
      *IT_0052) + 6*conj(IT_0048)*(IT_0037*IT_0039 + -IT_0048*IT_0052) + 
      ...
      *IT_0104*(conj(IT_0048)*IT_0107 + IT_0048*IT_0110 + 0.166666666666667*conj
      (IT_0037)*IT_0111 + 0.166666666666667*IT_0037*IT_0112) + 6*(conj(IT_0093)
      *IT_0099 + IT_0093*conj(IT_0099) + 0.166666666666667*conj(IT_0101)*IT_0111
       + 0.166666666666667*IT_0101*IT_0112)*IT_0113 + 6*(conj(IT_0037)*IT_0107 +
       IT_0037*IT_0110 + 0.166666666666667*conj(IT_0048)*IT_0111 +
       0.166666666666667*IT_0048*IT_0112)*IT_0114;
