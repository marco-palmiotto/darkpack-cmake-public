        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp2*IT_0002;
    ...
    const ccomplex_t IT_0010 = cpow((-2)*s_13 + IT_0008 + IT_0009 + -m_su_L*
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*conj
      (V_cd)*e_em*IT_0000*IT_0002*IT_0014*IT_0016;
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*mu_h*IT_0000*IT_0002;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*V_cd*e_em*V_Wp2*IT_0002;
    const ccomplex_t IT_0036 = -IT_0035;
    const ccomplex_t IT_0037 = IT_0034*IT_0036;
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0008 + IT_0009 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0042 = pow(m_sd_R, 2);
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0008 + IT_0042 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0000*IT_0002*IT_0014;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = IT_0002*IT_0013;
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_23 + IT_0008 + IT_0042 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0000*IT_0002*IT_0014;
    ...
    const ccomplex_t IT_0110 = cpow((-2)*s_23 + IT_0008 + IT_0042 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0000*IT_0002*IT_0014;
    const ccomplex_t IT_0112 = 0.5*IT_0111;
    const ccomplex_t IT_0113 = N_u4*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0015
    ...
    const ccomplex_t IT_0131 = m_t*V_td*V_u2*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0136 = V_td*e_em*V_Wp2*conj(U_st_00);
    ...
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0015
      *U_st_01 + 0.707106781186548*m_d*e_em*IT_0000*IT_0002*(mu_h*U_st_01 + m_t
      *IT_0014*IT_0016*U_st_11));
    const ccomplex_t IT_0147 = m_t*V_td*V_u2*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0152 = V_td*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0163 = IT_0106*IT_0162;
    ...
    const ccomplex_t IT_0169 = IT_0081*IT_0168;
    ...
    const ccomplex_t IT_0179 = IT_0012 + IT_0024 + IT_0032 + IT_0040 + IT_0064
       + IT_0083 + -IT_0089 + IT_0108 + IT_0127 + -IT_0144 + -IT_0160 + -IT_0166
       + -IT_0172 + -IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_td*e_em*IT_0000*IT_0002*IT_0014*conj(U_st_01);
    ...
    const ccomplex_t IT_0185 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_cd*e_em*IT_0000*IT_0002*IT_0014;
    const ccomplex_t IT_0186 = (-0.5)*IT_0185;
    const ccomplex_t IT_0187 = IT_0034*IT_0186;
    const ccomplex_t IT_0188 = IT_0038*IT_0187;
    const ccomplex_t IT_0189 = (0 + _Complex_I*1)*IT_0188;
    const ccomplex_t IT_0190 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0000*IT_0002*IT_0014;
    ...
    const ccomplex_t IT_0195 = IT_0002*IT_0015;
    const ccomplex_t IT_0196 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0197 = IT_0195*IT_0196;
    const ccomplex_t IT_0198 = (-2)*IT_0197;
    const ccomplex_t IT_0199 = IT_0015*IT_0051;
    const ccomplex_t IT_0200 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0201 = IT_0199*IT_0200;
    const ccomplex_t IT_0202 = 1.4142135623731*IT_0201;
    const ccomplex_t IT_0203 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0225 = IT_0168*IT_0224;
    const ccomplex_t IT_0226 = IT_0065*IT_0066*IT_0225;
    const ccomplex_t IT_0227 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0228 = IT_0195*IT_0227;
    const ccomplex_t IT_0229 = (-2)*IT_0228;
    const ccomplex_t IT_0230 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0231 = IT_0199*IT_0230;
    const ccomplex_t IT_0232 = 1.4142135623731*IT_0231;
    const ccomplex_t IT_0233 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0234 = IT_0195*IT_0233;
    ...
    const ccomplex_t IT_0254 = conj(N_d1)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0255 = IT_0195*IT_0254;
    ...
    const ccomplex_t IT_0260 = IT_0045*IT_0259;
    ...
    const ccomplex_t IT_0264 = IT_0093*IT_0209;
    ...
    const ccomplex_t IT_0268 = IT_0068*IT_0224;
    const ccomplex_t IT_0269 = IT_0066*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*IT_0269;
    const ccomplex_t IT_0271 = m_d*IT_0270;
    const ccomplex_t IT_0272 = IT_0112*IT_0239;
    const ccomplex_t IT_0273 = IT_0110*IT_0272;
    const ccomplex_t IT_0274 = (0 + _Complex_I*1)*IT_0273;
    const ccomplex_t IT_0275 = m_d*IT_0274;
    const ccomplex_t IT_0276 = IT_0085*IT_0259;
    const ccomplex_t IT_0277 = IT_0041*IT_0043*IT_0276;
    const ccomplex_t IT_0278 = -IT_0184 + -IT_0189 + -IT_0194 + IT_0211 +
       IT_0226 + IT_0241 + -IT_0246 + -IT_0263 + -IT_0267 + -IT_0271 + -IT_0275 
      + IT_0277;
    const ccomplex_t IT_0279 = m_d*m_C_2;
    const ccomplex_t IT_0280 = -IT_0262 + -IT_0266 + -IT_0270 + -IT_0274;
    const ccomplex_t IT_0281 = s_23*m_C_2;
    const ccomplex_t IT_0282 = -IT_0088 + -IT_0165 + -IT_0171 + -IT_0177;
    const ccomplex_t IT_0283 = m_d*s_12;
    const ccomplex_t IT_0284 = 6*s_13;
    const ccomplex_t IT_0285 = (-6)*IT_0278;
    const ccomplex_t IT_0286 = m_d*m_C_2*IT_0042;
    const ccomplex_t IT_0287 = s_13*IT_0042;
