...
ccomplex_return_t c_sumSqAmpl_C_2_anti_se_L_to_anti_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = pow(m_se_L, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0030 + IT_0031 + -m_N_1*
    ...
    const ccomplex_t IT_0060 = cpow(IT_0013, -1);
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0007*IT_0059*IT_0060;
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0030 + IT_0031 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0007*IT_0059*IT_0060;
    ...
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007*
      (m_W*IT_0013 + (-0.5)*IT_0030*IT_0059*IT_0060)*IT_0087;
    const ccomplex_t IT_0089 = -IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0007;
    const ccomplex_t IT_0091 = -IT_0090;
    const ccomplex_t IT_0092 = IT_0089*IT_0091;
    const ccomplex_t IT_0093 = pow(m_C_2, 2);
    const ccomplex_t IT_0094 = cpow((-2)*s_13 + IT_0030 + IT_0093 + reg_prop +
    ...
    const ccomplex_t IT_0145 = IT_0033 + IT_0058 + -IT_0066 + -IT_0086 +
       IT_0096 + IT_0121 + IT_0132 + -IT_0138 + -IT_0144;
    const ccomplex_t IT_0146 = IT_0007*IT_0087;
    const ccomplex_t IT_0147 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0148 = IT_0146*IT_0147;
    const ccomplex_t IT_0149 = (-2)*IT_0148;
    const ccomplex_t IT_0150 = IT_0002*IT_0087;
    const ccomplex_t IT_0151 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0152 = IT_0150*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0161 = IT_0134*IT_0160;
    const ccomplex_t IT_0162 = IT_0097*IT_0098*IT_0161;
    const ccomplex_t IT_0163 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0164 = IT_0146*IT_0163;
    const ccomplex_t IT_0165 = (-2)*IT_0164;
    const ccomplex_t IT_0166 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0167 = IT_0150*IT_0166;
    const ccomplex_t IT_0168 = 1.4142135623731*IT_0167;
    const ccomplex_t IT_0169 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0177 = IT_0067*IT_0122*IT_0176;
    const ccomplex_t IT_0178 = IT_0130*IT_0175;
    ...
    const ccomplex_t IT_0182 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
      *e_em*IT_0007*IT_0059*IT_0060;
    ...
    const ccomplex_t IT_0187 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0188 = IT_0146*IT_0187;
    const ccomplex_t IT_0189 = (-2)*IT_0188;
    const ccomplex_t IT_0190 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0191 = IT_0150*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0201 = IT_0034*IT_0057*IT_0200;
    const ccomplex_t IT_0202 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0203 = IT_0146*IT_0202;
    const ccomplex_t IT_0204 = 1.4142135623731*IT_0203;
    const ccomplex_t IT_0205 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0206 = IT_0150*IT_0205;
    ...
    const ccomplex_t IT_0215 = IT_0062*IT_0214;
    const ccomplex_t IT_0216 = IT_0000*IT_0032*IT_0215;
    const ccomplex_t IT_0217 = IT_0012*IT_0214;
    const ccomplex_t IT_0218 = IT_0032*IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1)*IT_0218;
    const ccomplex_t IT_0220 = m_e*IT_0219;
    const ccomplex_t IT_0221 = IT_0106*IT_0160;
    const ccomplex_t IT_0222 = IT_0098*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = m_e*IT_0223;
    const ccomplex_t IT_0225 = IT_0042*IT_0199;
    ...
    const ccomplex_t IT_0229 = IT_0162 + IT_0177 + -IT_0181 + -IT_0186 +
       IT_0201 + IT_0216 + -IT_0220 + -IT_0224 + -IT_0228;
    const ccomplex_t IT_0230 = m_e*m_C_2;
    const ccomplex_t IT_0231 = -IT_0180 + -IT_0219 + -IT_0223 + -IT_0227;
    const ccomplex_t IT_0232 = s_23*m_C_2;
    const ccomplex_t IT_0233 = -IT_0065 + -IT_0085 + -IT_0137 + -IT_0143;
    const ccomplex_t IT_0234 = m_e*s_12;
    const ccomplex_t IT_0235 = 2*s_13;
    const ccomplex_t IT_0236 = (-2)*IT_0229;
    const ccomplex_t IT_0237 = m_e*m_C_2*IT_0031;
