        ...
        )
{
    ...
    const ccomplex_t IT_0027 = pow(m_se_R, 2);
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0013;
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0001*IT_0005;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0117 = 0.5*IT_0116;
    const ccomplex_t IT_0118 = IT_0083*IT_0117;
    const ccomplex_t IT_0119 = IT_0068*IT_0115*IT_0118;
    const ccomplex_t IT_0120 = IT_0029 + IT_0048 + IT_0067 + -IT_0087 + 
      -IT_0093 + -IT_0099 + -IT_0105 + IT_0114 + IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
    ...
    const ccomplex_t IT_0142 = IT_0070*IT_0141;
    const ccomplex_t IT_0143 = IT_0068*IT_0115*IT_0142;
    ...
    const ccomplex_t IT_0192 = m_e*IT_0191;
    ...
    const ccomplex_t IT_0213 = m_e*m_C_2*IT_0027;
