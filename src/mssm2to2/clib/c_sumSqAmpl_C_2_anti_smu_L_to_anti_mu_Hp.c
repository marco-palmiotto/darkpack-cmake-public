...
ccomplex_return_t c_sumSqAmpl_C_2_anti_smu_L_to_anti_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0030 + IT_0031 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0034*IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0060 = cpow((-2)*s_23 + IT_0030 + IT_0031 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0061 = N_B4*e_em;
    const ccomplex_t IT_0062 = IT_0002*IT_0061;
    const ccomplex_t IT_0063 = 1.4142135623731*IT_0062;
    const ccomplex_t IT_0064 = N_W4*e_em;
    ...
    const ccomplex_t IT_0083 = IT_0059*IT_0060*IT_0082;
    const ccomplex_t IT_0084 = pow(m_W, -1);
    const ccomplex_t IT_0085 = cpow(IT_0013, -1);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0007*IT_0084*IT_0085;
    const ccomplex_t IT_0087 = (-0.5)*IT_0086;
    const ccomplex_t IT_0088 = N_u1*e_em*V_Wp2;
    const ccomplex_t IT_0089 = IT_0014*IT_0088;
    const ccomplex_t IT_0090 = 2*IT_0089;
    const ccomplex_t IT_0091 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0092 = IT_0018*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_23 + IT_0030 + IT_0031 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0103 = IT_0101*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*IT_0103;
    const ccomplex_t IT_0105 = m_mu*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0007*IT_0084*IT_0085;
    ...
    const ccomplex_t IT_0111 = m_mu*IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0007*IT_0084*IT_0085;
    ...
    const ccomplex_t IT_0117 = m_mu*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0007*IT_0084*IT_0085;
    const ccomplex_t IT_0119 = (-0.5)*IT_0118;
    const ccomplex_t IT_0120 = IT_0081*IT_0119;
    const ccomplex_t IT_0121 = IT_0060*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*IT_0121;
    const ccomplex_t IT_0123 = m_mu*IT_0122;
    const ccomplex_t IT_0124 = pow(m_C_2, 2);
    const ccomplex_t IT_0125 = cpow((-2)*s_13 + IT_0030 + IT_0124 + reg_prop +
       -m_snu_mu*(m_snu_mu + (0 + _Complex_I*-1)*Gamma_numl), -1);
    const ccomplex_t IT_0126 = sin(beta);
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007*
      (m_W*IT_0013 + (-0.5)*IT_0030*IT_0084*IT_0085)*IT_0126;
    const ccomplex_t IT_0128 = -IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0007;
    ...
    const ccomplex_t IT_0144 = IT_0102*IT_0134*IT_0143;
    const ccomplex_t IT_0145 = IT_0033 + IT_0058 + IT_0083 + -IT_0105 + 
      -IT_0111 + -IT_0117 + -IT_0123 + IT_0133 + IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0007*IT_0084*IT_0085;
    ...
    const ccomplex_t IT_0151 = IT_0007*IT_0126;
    const ccomplex_t IT_0152 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0153 = IT_0151*IT_0152;
    const ccomplex_t IT_0154 = 1.4142135623731*IT_0153;
    const ccomplex_t IT_0155 = IT_0002*IT_0126;
    ...
    const ccomplex_t IT_0167 = IT_0102*IT_0134*IT_0166;
    const ccomplex_t IT_0168 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0169 = IT_0151*IT_0168;
    const ccomplex_t IT_0170 = (-2)*IT_0169;
    const ccomplex_t IT_0171 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0172 = IT_0155*IT_0171;
    const ccomplex_t IT_0173 = 1.4142135623731*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0182 = IT_0000*IT_0032*IT_0181;
    const ccomplex_t IT_0183 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0184 = IT_0151*IT_0183;
    const ccomplex_t IT_0185 = (-2)*IT_0184;
    const ccomplex_t IT_0186 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0187 = IT_0155*IT_0186;
    const ccomplex_t IT_0188 = 1.4142135623731*IT_0187;
    const ccomplex_t IT_0189 = conj(N_W3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0190 = IT_0151*IT_0189;
    ...
    const ccomplex_t IT_0196 = IT_0113*IT_0195;
    const ccomplex_t IT_0197 = IT_0034*IT_0057*IT_0196;
    const ccomplex_t IT_0198 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0199 = IT_0151*IT_0198;
    const ccomplex_t IT_0200 = (-2)*IT_0199;
    const ccomplex_t IT_0201 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0202 = IT_0155*IT_0201;
    const ccomplex_t IT_0203 = 1.4142135623731*IT_0202;
    const ccomplex_t IT_0204 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0205 = IT_0151*IT_0204;
    ...
    const ccomplex_t IT_0212 = IT_0059*IT_0060*IT_0211;
    const ccomplex_t IT_0213 = IT_0042*IT_0195;
    ...
    const ccomplex_t IT_0217 = IT_0142*IT_0165;
    const ccomplex_t IT_0218 = IT_0102*IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1)*IT_0218;
    const ccomplex_t IT_0220 = m_mu*IT_0219;
    const ccomplex_t IT_0221 = IT_0012*IT_0180;
    const ccomplex_t IT_0222 = IT_0032*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = m_mu*IT_0223;
    const ccomplex_t IT_0225 = IT_0068*IT_0210;
    const ccomplex_t IT_0226 = IT_0060*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*IT_0226;
    const ccomplex_t IT_0228 = m_mu*IT_0227;
    const ccomplex_t IT_0229 = -IT_0150 + IT_0167 + IT_0182 + IT_0197 +
       IT_0212 + -IT_0216 + -IT_0220 + -IT_0224 + -IT_0228;
    const ccomplex_t IT_0230 = m_mu*m_C_2;
    const ccomplex_t IT_0231 = -IT_0215 + -IT_0219 + -IT_0223 + -IT_0227;
    const ccomplex_t IT_0232 = s_23*m_C_2;
    const ccomplex_t IT_0233 = -IT_0104 + -IT_0110 + -IT_0116 + -IT_0122;
    const ccomplex_t IT_0234 = m_mu*s_12;
    const ccomplex_t IT_0235 = 2*s_13;
    const ccomplex_t IT_0236 = (-2)*IT_0229;
    const ccomplex_t IT_0237 = m_mu*m_C_2*IT_0031;
    const ccomplex_t IT_0238 = s_12*s_23;
    const ccomplex_t IT_0239 = s_13*IT_0031;
    const ccomplex_t IT_0240 = (-0.5)*IT_0239;
    const ccomplex_t IT_0241 = IT_0238 + IT_0240;
    const ccomplex_t IT_0242 = (-2)*conj(IT_0229);
    const ccomplex_t IT_0243 = 0.5*IT_0232;
    const ccomplex_t IT_0244 = (-2)*conj(IT_0145);
    const ccomplex_t IT_0245 = 0.5*IT_0234;
    const ccomplex_t IT_0246 = 2*IT_0145*(conj(IT_0229)*IT_0230 + -conj
      (IT_0231)*IT_0232 + -conj(IT_0233)*IT_0234 + 0.5*conj(IT_0145)*IT_0235) +
       2*IT_0229*(conj(IT_0145)*IT_0230 + 0.5*conj(IT_0229)*IT_0235) + (IT_0232
      *conj(IT_0233) + conj(IT_0231)*IT_0234)*IT_0236 + 2*IT_0231*(conj(IT_0233)
      *IT_0237 + 2*conj(IT_0231)*IT_0241 + IT_0243*IT_0244 + IT_0242*IT_0245) +
       2*IT_0233*(conj(IT_0231)*IT_0237 + 2*conj(IT_0233)*IT_0241 + IT_0242
