        ...
        )
{
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0001*IT_0003*IT_0005;
