...
ccomplex_return_t c_sumSqAmpl_C_2_anti_smu_L_to_anti_mu_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0020*IT_0030*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_1*
    ...
    const ccomplex_t IT_0119 = m_mu*m_C_2;
    ...
    const ccomplex_t IT_0212 = IT_0076*IT_0173;
    const ccomplex_t IT_0213 = IT_0033*IT_0034*IT_0212;
    const ccomplex_t IT_0214 = IT_0086*IT_0151;
    const ccomplex_t IT_0215 = IT_0046*IT_0047*IT_0214;
    const ccomplex_t IT_0216 = IT_0096*IT_0184;
    const ccomplex_t IT_0217 = IT_0020*IT_0031*IT_0216;
    const ccomplex_t IT_0218 = IT_0066*IT_0162;
    const ccomplex_t IT_0219 = IT_0000*IT_0018*IT_0218;
    ...
    const ccomplex_t IT_0237 = m_mu*IT_0124;
    ...
    const ccomplex_t IT_0256 = m_mu*IT_0255;
    ...
    const ccomplex_t IT_0264 = IT_0109 + IT_0111 + IT_0263;
    const ccomplex_t IT_0265 = 2*IT_0198;
    const ccomplex_t IT_0266 = (-0.5)*IT_0197;
    const ccomplex_t IT_0267 = 0.333333333333333*IT_0100;
    const ccomplex_t IT_0268 = (-0.333333333333333)*IT_0251;
    const ccomplex_t IT_0269 = (-0.166666666666667)*IT_0228;
    const ccomplex_t IT_0270 = 4*IT_0211;
    const ccomplex_t IT_0271 = (-2)*conj(IT_0059)*(IT_0100*IT_0108 + (-2)
      ...
      *IT_0247 + (-0.5)*IT_0244*IT_0248 + (-0.5)*IT_0249*IT_0250) + IT_0251*
      ...
      (IT_0108*IT_0221 + 0.5*IT_0203*IT_0239 + (IT_0117 + 0.5*IT_0232)*IT_0257 +
       -IT_0100*IT_0259 + (-2)*IT_0251*IT_0264 + -IT_0246*IT_0266) + (-2)*conj
      (IT_0100)*(IT_0108*IT_0118 + (-0.5)*IT_0203*IT_0231 + IT_0221*IT_0257 +
       IT_0251*IT_0259 + 2*IT_0100*IT_0264 + IT_0265*IT_0266) + 4*conj(IT_0117)*
      (IT_0115*IT_0118 + (-1.5)*IT_0119*IT_0221 + 0.25*IT_0208*IT_0222 + (-1.5)
      *IT_0108*IT_0267 + (-1.5)*IT_0257*IT_0268 + (-1.5)*IT_0265*IT_0269) + (-6)
      *IT_0230*(IT_0118*IT_0119 + (-0.166666666666667)*IT_0208*IT_0265 + IT_0257
      *IT_0267 + IT_0108*IT_0268 + IT_0222*IT_0269 + (-0.666666666666667)
      *IT_0115*(IT_0220 + 0.25*IT_0270));
