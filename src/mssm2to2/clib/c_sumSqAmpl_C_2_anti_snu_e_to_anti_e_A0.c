...
ccomplex_return_t c_sumSqAmpl_C_2_anti_snu_e_to_anti_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0037 
      + -reg_prop, -1);
    const ccomplex_t IT_0039 = m_e*e_em*IT_0008*IT_0012*IT_0016*IT_0017;
    ...
    const ccomplex_t IT_0094 = m_e*m_C_2;
