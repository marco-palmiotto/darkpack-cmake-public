        ...
        )
{
    ...
    const ccomplex_t IT_0052 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0053 = IT_0005*IT_0052;
    const ccomplex_t IT_0054 = conj(V_u1)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*m_W*e_em*IT_0088*(IT_0005
      *IT_0018 + -IT_0008*IT_0089);
    ...
    const ccomplex_t IT_0106 = m_e*IT_0048;
    const ccomplex_t IT_0107 = IT_0016*IT_0051;
    const ccomplex_t IT_0108 = IT_0004*IT_0095*IT_0107;
    const ccomplex_t IT_0109 = IT_0033*IT_0045;
    const ccomplex_t IT_0110 = IT_0025*IT_0098*IT_0109;
    const ccomplex_t IT_0111 = IT_0105 + (-2)*IT_0106 + -IT_0108 + -IT_0110;
