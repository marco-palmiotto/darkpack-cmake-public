        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_23 + IT_0002 + IT_0003 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0026 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0012*IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0075 = IT_0021*IT_0043;
    ...
    const ccomplex_t IT_0083 = IT_0016*IT_0045;
    const ccomplex_t IT_0084 = IT_0004*IT_0082*IT_0083;
    const ccomplex_t IT_0085 = cpow((-2)*s_13 + IT_0002 + IT_0040 + reg_prop +
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*m_W*e_em*IT_0089*(IT_0008
      *IT_0018 + IT_0005*IT_0090);
    ...
    const ccomplex_t IT_0097 = IT_0033*IT_0051;
    const ccomplex_t IT_0098 = IT_0025*IT_0096*IT_0097;
    const ccomplex_t IT_0099 = m_e*IT_0048;
    const ccomplex_t IT_0100 = -IT_0084 + IT_0095 + -IT_0098 + (-2)*IT_0099;
    const ccomplex_t IT_0101 = m_C_2*IT_0039;
    const ccomplex_t IT_0102 = -IT_0101;
    const ccomplex_t IT_0103 = IT_0021*IT_0092;
    ...
    const ccomplex_t IT_0107 = IT_0004*IT_0082*IT_0106;
    const ccomplex_t IT_0108 = m_e*IT_0077;
    const ccomplex_t IT_0109 = IT_0035*IT_0059;
    const ccomplex_t IT_0110 = IT_0025*IT_0096*IT_0109;
    const ccomplex_t IT_0111 = -IT_0105 + IT_0107 + 2*IT_0108 + IT_0110;
