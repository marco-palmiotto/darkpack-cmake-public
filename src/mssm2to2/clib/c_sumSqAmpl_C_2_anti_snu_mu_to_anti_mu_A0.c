...
ccomplex_return_t c_sumSqAmpl_C_2_anti_snu_mu_to_anti_mu_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0012*IT_0016*IT_0017;
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0012*IT_0016*IT_0017;
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0037 
      + -reg_prop, -1);
    const ccomplex_t IT_0039 = e_em*m_mu*IT_0008*IT_0012*IT_0016*IT_0017;
    const ccomplex_t IT_0040 = (-0.5)*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0012;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0012;
    ...
    const ccomplex_t IT_0077 = IT_0015*IT_0058;
    const ccomplex_t IT_0078 = IT_0004*IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0080 = IT_0030*IT_0042;
    const ccomplex_t IT_0081 = IT_0023*IT_0079*IT_0080;
    const ccomplex_t IT_0082 = -IT_0078 + -IT_0081;
    const ccomplex_t IT_0083 = m_C_2*IT_0036;
    const ccomplex_t IT_0084 = -IT_0083;
    const ccomplex_t IT_0085 = IT_0019*IT_0065;
    const ccomplex_t IT_0086 = IT_0004*IT_0076*IT_0085;
    const ccomplex_t IT_0087 = IT_0032*IT_0053;
    const ccomplex_t IT_0088 = IT_0023*IT_0079*IT_0087;
    const ccomplex_t IT_0089 = IT_0086 + IT_0088;
    const ccomplex_t IT_0090 = IT_0056 + IT_0068;
    const ccomplex_t IT_0091 = m_C_2*IT_0090;
    const ccomplex_t IT_0092 = 2*s_13;
    const ccomplex_t IT_0093 = (-2)*s_13;
    const ccomplex_t IT_0094 = m_mu*m_C_2;
    const ccomplex_t IT_0095 = (-2)*IT_0082;
    const ccomplex_t IT_0096 = 0.5*IT_0095;
    const ccomplex_t IT_0097 = IT_0091 + IT_0096;
    const ccomplex_t IT_0098 = (-2)*conj(IT_0082);
    const ccomplex_t IT_0099 = 0.5*IT_0098;
    const ccomplex_t IT_0100 = conj(IT_0091) + IT_0099;
    const ccomplex_t IT_0101 = (-2)*IT_0089;
    const ccomplex_t IT_0102 = (-2)*conj(IT_0089);
    ...
    const ccomplex_t IT_0107 = s_13*IT_0000;
    const ccomplex_t IT_0108 = s_14*s_34;
    const ccomplex_t IT_0109 = (-2)*IT_0108;
    const ccomplex_t IT_0110 = IT_0107 + IT_0109;
    const ccomplex_t IT_0111 = (-2)*IT_0036;
    const ccomplex_t IT_0112 = (-2)*IT_0069;
    const ccomplex_t IT_0113 = 2*IT_0001*(IT_0046*IT_0073 + IT_0074*IT_0075) +
       (IT_0082*conj(IT_0082) + IT_0084*conj(IT_0084) + IT_0089*conj(IT_0089) +
       IT_0091*conj(IT_0091))*IT_0092 + (conj(IT_0084)*IT_0089 + IT_0084*conj
      (IT_0089) + conj(IT_0082)*IT_0091 + IT_0082*conj(IT_0091))*IT_0093 + 2
      *IT_0094*(conj(IT_0082)*IT_0089 + IT_0082*conj(IT_0089) + conj(IT_0084)
      *IT_0097 + IT_0084*IT_0100 + 0.5*conj(IT_0091)*IT_0101 + 0.5*IT_0091
      *IT_0102) + 2*IT_0103*(IT_0075*IT_0097 + IT_0073*IT_0100 + IT_0074*(conj
      (IT_0084) + 0.5*IT_0102) + IT_0046*IT_0105) + 2*(IT_0046*IT_0097 + IT_0074
      *IT_0100 + IT_0073*(conj(IT_0084) + 0.5*IT_0102) + IT_0075*IT_0105)
      *IT_0106 + (-2)*IT_0110*(IT_0046*(IT_0045 + (-0.5)*IT_0111) + IT_0075*
      (IT_0072 + (-0.5)*IT_0112));
