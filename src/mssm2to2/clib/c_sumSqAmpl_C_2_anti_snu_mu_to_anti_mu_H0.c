        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0012*IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0012*IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0040 
      + -reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*m_mu*IT_0005*IT_0012
      *IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0050 = conj(U_d2)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0002 + IT_0040 + reg_prop +
    ...
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*m_W*e_em*IT_0086*(IT_0005
      *IT_0018 + -IT_0008*IT_0087);
    ...
    const ccomplex_t IT_0094 = IT_0016*IT_0062;
    const ccomplex_t IT_0095 = IT_0004*IT_0093*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0097 = IT_0033*IT_0045;
    const ccomplex_t IT_0098 = IT_0025*IT_0096*IT_0097;
    const ccomplex_t IT_0099 = m_mu*IT_0048;
    const ccomplex_t IT_0100 = IT_0092 + -IT_0095 + -IT_0098 + (-2)*IT_0099;
    const ccomplex_t IT_0101 = m_C_2*IT_0039;
    const ccomplex_t IT_0102 = -IT_0101;
    const ccomplex_t IT_0103 = IT_0035*IT_0089;
    const ccomplex_t IT_0104 = IT_0082*IT_0103;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*IT_0104;
    const ccomplex_t IT_0106 = IT_0021*IT_0070;
    const ccomplex_t IT_0107 = IT_0004*IT_0093*IT_0106;
    const ccomplex_t IT_0108 = IT_0035*IT_0057;
    const ccomplex_t IT_0109 = IT_0025*IT_0096*IT_0108;
    const ccomplex_t IT_0110 = m_mu*IT_0077;
    const ccomplex_t IT_0111 = -IT_0105 + IT_0107 + IT_0109 + 2*IT_0110;
    const ccomplex_t IT_0112 = IT_0060 + IT_0073;
    const ccomplex_t IT_0113 = m_C_2*IT_0112;
    const ccomplex_t IT_0114 = 2*s_13;
    const ccomplex_t IT_0115 = (-2)*s_13;
    const ccomplex_t IT_0116 = m_mu*m_C_2;
    const ccomplex_t IT_0117 = (-2)*IT_0100;
    const ccomplex_t IT_0118 = 0.5*IT_0117;
    const ccomplex_t IT_0119 = IT_0113 + IT_0118;
    const ccomplex_t IT_0120 = (-2)*conj(IT_0100);
    ...
    const ccomplex_t IT_0125 = s_34*m_C_2;
    const ccomplex_t IT_0126 = 0.5*IT_0123;
    const ccomplex_t IT_0127 = IT_0102 + IT_0126;
    const ccomplex_t IT_0128 = m_mu*s_14;
    const ccomplex_t IT_0129 = s_13*IT_0000;
    const ccomplex_t IT_0130 = s_14*s_34;
    const ccomplex_t IT_0131 = (-2)*IT_0130;
    const ccomplex_t IT_0132 = IT_0129 + IT_0131;
    const ccomplex_t IT_0133 = (-2)*IT_0039;
    const ccomplex_t IT_0134 = (-2)*IT_0074;
    const ccomplex_t IT_0135 = 2*IT_0001*(IT_0049*IT_0079 + IT_0080*IT_0081) +
       (IT_0100*conj(IT_0100) + IT_0102*conj(IT_0102) + IT_0111*conj(IT_0111) +
       IT_0113*conj(IT_0113))*IT_0114 + (conj(IT_0102)*IT_0111 + IT_0102*conj
      (IT_0111) + conj(IT_0100)*IT_0113 + IT_0100*conj(IT_0113))*IT_0115 + 2
      *IT_0116*(conj(IT_0100)*IT_0111 + IT_0100*conj(IT_0111) + conj(IT_0102)
      *IT_0119 + IT_0102*IT_0122 + 0.5*conj(IT_0113)*IT_0123 + 0.5*IT_0113
      *IT_0124) + 2*IT_0125*(IT_0081*IT_0119 + IT_0079*IT_0122 + IT_0080*(conj
      (IT_0102) + 0.5*IT_0124) + IT_0049*IT_0127) + 2*(IT_0049*IT_0119 + IT_0080
      *IT_0122 + IT_0079*(conj(IT_0102) + 0.5*IT_0124) + IT_0081*IT_0127)
      *IT_0128 + (-2)*IT_0132*(IT_0049*(IT_0048 + (-0.5)*IT_0133) + IT_0081*
      (IT_0078 + (-0.5)*IT_0134));
