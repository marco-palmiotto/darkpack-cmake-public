...
ccomplex_return_t c_sumSqAmpl_C_2_anti_snu_mu_to_anti_mu_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0040 
      + -reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*m_mu*IT_0008*IT_0012
      *IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0085 = IT_0021*IT_0059;
    const ccomplex_t IT_0086 = IT_0004*IT_0084*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0088 = IT_0035*IT_0070;
    const ccomplex_t IT_0089 = IT_0025*IT_0087*IT_0088;
    const ccomplex_t IT_0090 = m_mu*IT_0077;
    const ccomplex_t IT_0091 = cpow((-2)*s_13 + IT_0002 + IT_0040 + reg_prop +
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*m_W*e_em*IT_0095*(IT_0008
      *IT_0018 + IT_0005*IT_0096);
    ...
    const ccomplex_t IT_0102 = IT_0086 + IT_0089 + 2*IT_0090 + -IT_0101;
    const ccomplex_t IT_0103 = IT_0016*IT_0051;
    const ccomplex_t IT_0104 = IT_0004*IT_0084*IT_0103;
    const ccomplex_t IT_0105 = IT_0033*IT_0045;
    const ccomplex_t IT_0106 = IT_0025*IT_0087*IT_0105;
    const ccomplex_t IT_0107 = m_mu*IT_0048;
    const ccomplex_t IT_0108 = IT_0045*IT_0098;
    ...
    const ccomplex_t IT_0135 = m_mu*s_14;
