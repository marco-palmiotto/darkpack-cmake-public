...
ccomplex_return_t c_sumSqAmpl_C_2_anti_snu_mu_to_anti_nu_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0108 = pow(m_mu, 2);
    const ccomplex_t IT_0109 = pow(m_C_2, 2);
    const ccomplex_t IT_0110 = cpow((-2)*s_12 + -IT_0030 + IT_0108 + -IT_0109 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0006;
    const ccomplex_t IT_0117 = -IT_0116;
    const ccomplex_t IT_0118 = IT_0115*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0120 = IT_0110*IT_0118*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0006*IT_0111*IT_0112;
    ...
    const ccomplex_t IT_0127 = (-0.5)*IT_0032 + (-0.5)*IT_0057 + (-0.5)
      *IT_0082 + (-0.5)*IT_0107 + -IT_0120 + IT_0126;
    ...
    const ccomplex_t IT_0176 = IT_0084*IT_0175;
    ...
    const ccomplex_t IT_0194 = -IT_0125 + 0.5*IT_0145 + 0.5*IT_0161 + 0.5
      *IT_0177 + 0.5*IT_0193;
