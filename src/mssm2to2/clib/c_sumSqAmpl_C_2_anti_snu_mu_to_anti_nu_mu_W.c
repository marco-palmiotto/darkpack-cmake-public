        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0013 = IT_0006*IT_0012;
    const ccomplex_t IT_0014 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0032 = N_W2*e_em*conj(U_Wm2);
    const ccomplex_t IT_0033 = IT_0006*IT_0032;
    const ccomplex_t IT_0034 = N_d2*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0051 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0052 = IT_0006*IT_0051;
    const ccomplex_t IT_0053 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0060 = cpow(s_23 + (-0.5)*IT_0021 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0070 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0071 = IT_0006*IT_0070;
    const ccomplex_t IT_0072 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0079 = cpow(s_23 + (-0.5)*IT_0021 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0080 = IT_0077*IT_0078*IT_0079;
    const ccomplex_t IT_0081 = pow(m_mu, 2);
    const ccomplex_t IT_0082 = pow(m_C_2, 2);
    const ccomplex_t IT_0083 = cpow((-2)*s_12 + -IT_0021 + IT_0081 + -IT_0082 
      + -reg_prop, -1);
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0006;
    const ccomplex_t IT_0086 = 0.5*IT_0085;
    const ccomplex_t IT_0087 = pow(m_W, -1);
    const ccomplex_t IT_0088 = cos(beta);
    const ccomplex_t IT_0089 = cpow(IT_0088, -1);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0006*IT_0087*IT_0089;
    const ccomplex_t IT_0091 = (-0.5)*IT_0090;
    const ccomplex_t IT_0092 = IT_0086*IT_0091;
    const ccomplex_t IT_0093 = IT_0083*IT_0084*IT_0092;
    const ccomplex_t IT_0094 = (-0.5)*IT_0023 + (-0.5)*IT_0042 + (-0.5)
      *IT_0061 + (-0.5)*IT_0080 + IT_0093;
    ...
    const ccomplex_t IT_0115 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0116 = IT_0006*IT_0115;
    const ccomplex_t IT_0117 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0132 = IT_0069*IT_0131;
    ...
    const ccomplex_t IT_0143 = IT_0086*IT_0142;
    ...
    const ccomplex_t IT_0196 = IT_0156 + IT_0158 + (-0.5)*IT_0195;
    const ccomplex_t IT_0197 = (-0.25)*IT_0195;
    const ccomplex_t IT_0198 = IT_0157 + IT_0197;
    const ccomplex_t IT_0199 = conj(IT_0146)*IT_0181;
    const ccomplex_t IT_0200 = conj(IT_0152)*IT_0192;
    const ccomplex_t IT_0201 = (-2)*(IT_0094 + IT_0137)*IT_0178 + 2*IT_0146*
      (conj(IT_0146)*IT_0179 + conj(IT_0152)*IT_0180 + IT_0181*IT_0182 + IT_0140
      *IT_0183) + 2*IT_0152*(conj(IT_0146)*IT_0180 + IT_0151*IT_0183 + conj
      (IT_0152)*IT_0188 + IT_0182*IT_0192) + (-4)*IT_0165*((-0.5)*IT_0163
      *IT_0171 + conj(IT_0165)*IT_0196 + (-2)*conj(IT_0145)*IT_0198 + (-0.5)
      *IT_0199 + (-0.5)*IT_0200) + (-4)*IT_0145*((-0.5)*IT_0176*IT_0183 + conj
      (IT_0145)*IT_0196 + (-2)*conj(IT_0165)*IT_0198 + (-0.5)*IT_0199 + (-0.5)
      *IT_0200);
