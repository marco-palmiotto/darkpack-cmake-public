...
ccomplex_return_t c_sumSqAmpl_C_2_anti_snu_tau_to_anti_nu_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = cpow(s_23 + (-0.5)*IT_0030 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0058 = N_B4*e_em;
    const ccomplex_t IT_0059 = IT_0001*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = N_W4*e_em;
    ...
    const ccomplex_t IT_0081 = cpow(s_23 + (-0.5)*IT_0030 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0107 = IT_0083*IT_0084*IT_0106;
    const ccomplex_t IT_0108 = pow(m_C_2, 2);
    const ccomplex_t IT_0109 = pow(m_tau, 2);
    const ccomplex_t IT_0110 = cpow(s_12 + 0.5*IT_0030 + 0.5*IT_0108 + (-0.5)
      *IT_0109 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_tau*IT_0006*IT_0111*IT_0112;
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0006;
    const ccomplex_t IT_0123 = -IT_0122;
    const ccomplex_t IT_0124 = IT_0115*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0126 = IT_0110*IT_0124*IT_0125;
    const ccomplex_t IT_0127 = (-0.5)*IT_0032 + (-0.5)*IT_0057 + (-0.5)
      *IT_0082 + (-0.5)*IT_0107 + (-0.5)*IT_0121 + 0.5*IT_0126;
    const ccomplex_t IT_0128 = IT_0006*IT_0113;
    const ccomplex_t IT_0129 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0130 = IT_0128*IT_0129;
    const ccomplex_t IT_0131 = (-2)*IT_0130;
    const ccomplex_t IT_0132 = IT_0001*IT_0113;
    const ccomplex_t IT_0133 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0134 = IT_0132*IT_0133;
    const ccomplex_t IT_0135 = 1.4142135623731*IT_0134;
    const ccomplex_t IT_0136 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0160 = IT_0081*IT_0159;
    ...
    const ccomplex_t IT_0191 = IT_0092*IT_0190;
    const ccomplex_t IT_0192 = IT_0084*IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1)*IT_0192;
    const ccomplex_t IT_0194 = 0.5*IT_0120 + 0.5*IT_0145 + 0.5*IT_0161 + 0.5
      *IT_0177 + 0.5*IT_0193;
