        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0012;
    const ccomplex_t IT_0018 = -IT_0017;
    const ccomplex_t IT_0019 = IT_0016*IT_0018;
    const ccomplex_t IT_0020 = IT_0001*IT_0004*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0022 = cpow(s_23 + (-0.5)*IT_0002 + (-0.5)*IT_0003 +
       0.5*m_C_2*(m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0023 = U_d2*V_Wp2;
    const ccomplex_t IT_0024 = IT_0005*IT_0023;
    const ccomplex_t IT_0025 = V_u2*U_Wm2;
    const ccomplex_t IT_0026 = IT_0008*IT_0025;
    const ccomplex_t IT_0027 = IT_0012*(IT_0024 + IT_0026);
    const ccomplex_t IT_0028 = 1.4142135623731*e_em*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0012;
    const ccomplex_t IT_0032 = -IT_0031;
    const ccomplex_t IT_0033 = IT_0030*IT_0032;
    const ccomplex_t IT_0034 = IT_0021*IT_0022*IT_0033;
    const ccomplex_t IT_0035 = pow(m_C_2, 2);
    const ccomplex_t IT_0036 = cpow(s_13 + (-0.5)*IT_0002 + (-0.5)*IT_0035 + (
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*m_W*e_em*IT_0040*(IT_0005
      *IT_0041 + -IT_0008*IT_0042);
    ...
    const ccomplex_t IT_0048 = cpow(s_12 + (-0.5)*IT_0002 + 0.5*IT_0003 + 0.5
      *IT_0035 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0049 = pow(m_W, -1);
    const ccomplex_t IT_0050 = cpow(IT_0041, -1);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*e_em*m_tau*IT_0005*IT_0012
      *IT_0049*IT_0050;
    ...
    const ccomplex_t IT_0057 = 0.5*IT_0020 + 0.5*IT_0034 + (-0.5)*IT_0047 +
       IT_0056;
    const ccomplex_t IT_0058 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0073 = IT_0012*(IT_0070 + IT_0072);
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_tau*IT_0012*IT_0049*IT_0050;
    const ccomplex_t IT_0084 = (-0.5)*IT_0083;
    const ccomplex_t IT_0085 = IT_0065*IT_0084;
    const ccomplex_t IT_0086 = IT_0001*IT_0004*IT_0085;
    ...
    const ccomplex_t IT_0092 = IT_0052*IT_0088;
    const ccomplex_t IT_0093 = IT_0048*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*IT_0093;
    const ccomplex_t IT_0095 = m_tau*IT_0094;
    const ccomplex_t IT_0096 = IT_0076*IT_0088;
    const ccomplex_t IT_0097 = IT_0021*IT_0022*IT_0096;
    const ccomplex_t IT_0098 = (-0.5)*IT_0086 + 0.5*IT_0091 + -IT_0095 + (-0.5
      )*IT_0097;
    const ccomplex_t IT_0099 = IT_0030*IT_0088;
    const ccomplex_t IT_0100 = IT_0022*IT_0099;
    const ccomplex_t IT_0101 = (0 + _Complex_I*1)*IT_0100;
    const ccomplex_t IT_0102 = IT_0016*IT_0084;
    ...
    const ccomplex_t IT_0108 = 2*IT_0082;
    const ccomplex_t IT_0109 = (-2)*IT_0057;
    const ccomplex_t IT_0110 = IT_0108 + IT_0109;
    const ccomplex_t IT_0111 = 2*conj(IT_0082);
    const ccomplex_t IT_0112 = (-2)*conj(IT_0057);
    const ccomplex_t IT_0113 = IT_0111 + IT_0112;
    const ccomplex_t IT_0114 = s_34*m_C_2;
    const ccomplex_t IT_0115 = 0.5*IT_0094;
    const ccomplex_t IT_0116 = 0.5*IT_0068 + 0.5*IT_0079;
    ...
    const ccomplex_t IT_0120 = (-0.5)*IT_0101 + (-0.5)*IT_0104;
    ...
    const ccomplex_t IT_0133 = 2*IT_0115;
    const ccomplex_t IT_0134 = 2*conj(IT_0115);
    ...
    const ccomplex_t IT_0142 = 2*IT_0000*((conj(IT_0057) + -conj(IT_0082))
      *IT_0098 + (IT_0057 + -IT_0082)*conj(IT_0098) + 0.5*conj(IT_0107)*IT_0110 
      + 0.5*IT_0107*IT_0113) + IT_0114*(IT_0110*IT_0117 + IT_0113*IT_0118 +
       IT_0121*IT_0124 + IT_0125*IT_0128) + (IT_0110*IT_0121 + IT_0117*IT_0124 +
       IT_0113*IT_0125 + IT_0118*IT_0128)*IT_0129 + (IT_0057*conj(IT_0057) +
       IT_0082*conj(IT_0082) + IT_0098*conj(IT_0098) + IT_0107*conj(IT_0107))
      *IT_0130 + 2*IT_0132*(IT_0121*(IT_0116 + 0.5*IT_0133) + IT_0125*(conj
      (IT_0116) + 0.5*IT_0134)) + (conj(IT_0057)*IT_0082 + IT_0057*conj(IT_0082)
       + conj(IT_0098)*IT_0107 + IT_0098*conj(IT_0107))*IT_0135 + (-2)*IT_0139*
      (IT_0121*(IT_0120 + (-0.5)*IT_0140) + IT_0117*(IT_0116 + (-0.5)*IT_0141));
