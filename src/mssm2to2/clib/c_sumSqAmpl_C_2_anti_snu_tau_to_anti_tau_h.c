        ...
        )
{
    ...
    const ccomplex_t IT_0004 = cpow(s_12 + 0.5*IT_0001 + (-0.5)*IT_0002 + 0.5
      *IT_0003 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*e_em*m_tau*IT_0005*IT_0007
      *IT_0008*IT_0010;
    const ccomplex_t IT_0012 = 0.5*IT_0011;
    const ccomplex_t IT_0013 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_tau*IT_0005*IT_0007*IT_0010;
    ...
    const ccomplex_t IT_0019 = cpow(s_13 + (-0.5)*IT_0001 + (-0.5)*IT_0002 + (
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*m_W*e_em*IT_0023*(IT_0006
      *IT_0008 + IT_0024*IT_0025);
    ...
    const ccomplex_t IT_0032 = cpow(s_23 + (-0.5)*IT_0002 + (-0.5)*IT_0003 +
       0.5*m_C_1*(m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0033 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0034 = IT_0024*IT_0033;
    const ccomplex_t IT_0035 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_tau*IT_0005*IT_0007*IT_0010;
    const ccomplex_t IT_0042 = (-0.5)*IT_0041;
    const ccomplex_t IT_0043 = IT_0040*IT_0042;
    const ccomplex_t IT_0044 = IT_0031*IT_0032*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0046 = cpow(s_23 + (-0.5)*IT_0002 + (-0.5)*IT_0003 +
    ...
    const ccomplex_t IT_0051 = IT_0010*(IT_0048 + -IT_0050);
    const ccomplex_t IT_0052 = 1.4142135623731*e_em*IT_0051;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = IT_0014*IT_0054;
    const ccomplex_t IT_0056 = IT_0045*IT_0046*IT_0055;
    const ccomplex_t IT_0057 = -IT_0018 + 0.5*IT_0030 + (-0.5)*IT_0044 + (-0.5
      )*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0010;
    ...
    const ccomplex_t IT_0084 = IT_0045*IT_0046*IT_0083;
    const ccomplex_t IT_0085 = IT_0012*IT_0059;
    ...
    const ccomplex_t IT_0089 = (-0.5)*IT_0062 + 0.5*IT_0074 + 0.5*IT_0084 +
       IT_0088;
    const ccomplex_t IT_0090 = IT_0040*IT_0064;
    const ccomplex_t IT_0091 = IT_0032*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = IT_0054*IT_0059;
    ...
    const ccomplex_t IT_0108 = 2*IT_0098;
    const ccomplex_t IT_0109 = (-2)*IT_0089;
    const ccomplex_t IT_0110 = IT_0108 + IT_0109;
    const ccomplex_t IT_0111 = 2*conj(IT_0098);
    const ccomplex_t IT_0112 = (-2)*conj(IT_0089);
    const ccomplex_t IT_0113 = IT_0111 + IT_0112;
    const ccomplex_t IT_0114 = s_34*m_C_2;
    ...
    const ccomplex_t IT_0118 = 2*IT_0107;
    const ccomplex_t IT_0119 = (-2)*IT_0057;
    const ccomplex_t IT_0120 = IT_0118 + IT_0119;
    const ccomplex_t IT_0121 = IT_0115 + IT_0116;
    const ccomplex_t IT_0122 = 2*conj(IT_0107);
    const ccomplex_t IT_0123 = (-2)*conj(IT_0057);
    const ccomplex_t IT_0124 = IT_0122 + IT_0123;
    const ccomplex_t IT_0125 = 0.5*IT_0017;
    const ccomplex_t IT_0126 = 0.5*IT_0092 + 0.5*IT_0095;
    const ccomplex_t IT_0127 = conj(IT_0125) + conj(IT_0126);
    const ccomplex_t IT_0128 = IT_0125 + IT_0126;
    const ccomplex_t IT_0129 = s_14*m_tau;
    const ccomplex_t IT_0130 = 2*s_13;
    const ccomplex_t IT_0131 = pow(m_h, 2);
    const ccomplex_t IT_0132 = m_C_2*m_tau*IT_0131;
    const ccomplex_t IT_0133 = 2*IT_0125;
    const ccomplex_t IT_0134 = 2*conj(IT_0125);
    ...
    const ccomplex_t IT_0140 = (-2)*IT_0125;
    const ccomplex_t IT_0141 = (-2)*IT_0115;
    const ccomplex_t IT_0142 = 2*IT_0000*(conj(IT_0057)*(IT_0089 + -IT_0098) +
       IT_0057*(conj(IT_0089) + -conj(IT_0098)) + 0.5*conj(IT_0107)*IT_0110 +
       0.5*IT_0107*IT_0113) + IT_0114*(IT_0117*IT_0120 + IT_0121*IT_0124 +
       IT_0110*IT_0127 + IT_0113*IT_0128) + (IT_0110*IT_0117 + IT_0113*IT_0121 +
       IT_0120*IT_0127 + IT_0124*IT_0128)*IT_0129 + (IT_0057*conj(IT_0057) +
       IT_0089*conj(IT_0089) + IT_0098*conj(IT_0098) + IT_0107*conj(IT_0107))
      *IT_0130 + 2*IT_0132*(IT_0117*(IT_0126 + 0.5*IT_0133) + IT_0121*(conj
      (IT_0126) + 0.5*IT_0134)) + (conj(IT_0089)*IT_0098 + IT_0089*conj(IT_0098)
       + conj(IT_0057)*IT_0107 + IT_0057*conj(IT_0107))*IT_0135 + (-2)*IT_0139*
      (IT_0127*(IT_0126 + (-0.5)*IT_0140) + IT_0117*(IT_0116 + (-0.5)*IT_0141));
