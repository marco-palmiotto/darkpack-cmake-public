        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *mu_h*IT_0000*IT_0002;
    const ccomplex_t IT_0004 = 0.5*IT_0003;
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*V_us*e_em*V_Wp2*IT_0002;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0008 + IT_0034 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0014;
    const ccomplex_t IT_0037 = 0.5*IT_0036;
    const ccomplex_t IT_0038 = IT_0002*IT_0013;
    const ccomplex_t IT_0039 = N_u4*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0056 = IT_0033*IT_0035*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0008 + IT_0009 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0015
      *U_st_00 + 0.707106781186548*m_s*e_em*IT_0000*IT_0002*(mu_h*U_st_00 + m_t
      *IT_0014*IT_0016*U_st_10));
    const ccomplex_t IT_0059 = IT_0002*IT_0016;
    const ccomplex_t IT_0060 = m_t*V_ts*V_u2*e_em*IT_0000*conj(U_st_10);
    const ccomplex_t IT_0061 = IT_0059*IT_0060;
    const ccomplex_t IT_0062 = 1.4142135623731*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = (-0.5)*IT_0063;
    const ccomplex_t IT_0065 = V_ts*e_em*V_Wp2*conj(U_st_00);
    const ccomplex_t IT_0066 = IT_0002*IT_0065;
    ...
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0008 + IT_0009 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0015
      *U_st_01 + 0.707106781186548*m_s*e_em*IT_0000*IT_0002*(mu_h*U_st_01 + m_t
      *IT_0014*IT_0016*U_st_11));
    const ccomplex_t IT_0076 = m_t*V_ts*V_u2*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0081 = V_ts*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0122 = IT_0104*IT_0105*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0014;
    ...
    const ccomplex_t IT_0140 = cpow((-2)*s_23 + IT_0008 + IT_0034 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0141 = IT_0123*IT_0139*IT_0140;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0043;
    const ccomplex_t IT_0143 = (-0.333333333333333)*IT_0142;
    const ccomplex_t IT_0144 = IT_0120*IT_0143;
    ...
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0155 = cpow((-2)*s_23 + IT_0008 + IT_0034 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0156 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0000*IT_0002*IT_0014;
    const ccomplex_t IT_0157 = 0.5*IT_0156;
    const ccomplex_t IT_0158 = N_u2*e_em*V_Wp2;
    const ccomplex_t IT_0159 = IT_0038*IT_0158;
    const ccomplex_t IT_0160 = 2*IT_0159;
    const ccomplex_t IT_0161 = N_B2*V_u2*e_em;
    const ccomplex_t IT_0162 = IT_0044*IT_0161;
    const ccomplex_t IT_0163 = 1.4142135623731*IT_0162;
    const ccomplex_t IT_0164 = N_W2*V_u2*e_em;
    ...
    const ccomplex_t IT_0172 = IT_0154*IT_0155*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0179 = IT_0012 + IT_0024 + IT_0032 + IT_0056 + 
      -IT_0073 + -IT_0089 + -IT_0095 + IT_0103 + IT_0122 + IT_0141 + -IT_0147 + 
      -IT_0153 + IT_0172 + -IT_0178;
    const ccomplex_t IT_0180 = IT_0002*IT_0015;
    const ccomplex_t IT_0181 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0182 = IT_0180*IT_0181;
    const ccomplex_t IT_0183 = (-2)*IT_0182;
    const ccomplex_t IT_0184 = IT_0015*IT_0043;
    const ccomplex_t IT_0185 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0186 = IT_0184*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0199 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0200 = IT_0180*IT_0199;
    const ccomplex_t IT_0201 = (-2)*IT_0200;
    const ccomplex_t IT_0202 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0203 = IT_0184*IT_0202;
    const ccomplex_t IT_0204 = 1.4142135623731*IT_0203;
    const ccomplex_t IT_0205 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0206 = IT_0180*IT_0205;
    ...
    const ccomplex_t IT_0216 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0217 = IT_0180*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0220 = IT_0184*IT_0219;
    const ccomplex_t IT_0221 = 1.4142135623731*IT_0220;
    const ccomplex_t IT_0222 = IT_0218 + IT_0221;
    const ccomplex_t IT_0223 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0229 = IT_0143*IT_0228;
    const ccomplex_t IT_0230 = IT_0104*IT_0105*IT_0229;
    const ccomplex_t IT_0231 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0232 = IT_0180*IT_0231;
    const ccomplex_t IT_0233 = (-2)*IT_0232;
    const ccomplex_t IT_0234 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0235 = IT_0184*IT_0234;
    const ccomplex_t IT_0236 = 1.4142135623731*IT_0235;
    const ccomplex_t IT_0237 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0245 = IT_0154*IT_0155*IT_0244;
    const ccomplex_t IT_0246 = IT_0149*IT_0194;
    const ccomplex_t IT_0247 = IT_0123*IT_0140*IT_0246;
    const ccomplex_t IT_0248 = IT_0091*IT_0211;
    const ccomplex_t IT_0249 = IT_0033*IT_0035*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
    ...
    const ccomplex_t IT_0253 = IT_0074*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = IT_0107*IT_0228;
    const ccomplex_t IT_0256 = IT_0105*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = m_s*IT_0257;
    const ccomplex_t IT_0259 = IT_0157*IT_0243;
    const ccomplex_t IT_0260 = IT_0155*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*IT_0260;
    const ccomplex_t IT_0262 = m_s*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
    ...
    const ccomplex_t IT_0268 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_us*e_em*IT_0000*IT_0002*IT_0014;
    const ccomplex_t IT_0269 = (-0.5)*IT_0268;
    const ccomplex_t IT_0270 = IT_0004*IT_0269;
    ...
    const ccomplex_t IT_0278 = -IT_0198 + -IT_0215 + IT_0230 + IT_0245 +
       IT_0247 + IT_0249 + -IT_0254 + -IT_0258 + -IT_0262 + -IT_0267 + -IT_0272 
      + -IT_0277;
    const ccomplex_t IT_0279 = m_s*m_C_2;
    const ccomplex_t IT_0280 = -IT_0197 + -IT_0214 + -IT_0257 + -IT_0261;
    const ccomplex_t IT_0281 = s_23*m_C_2;
    const ccomplex_t IT_0282 = -IT_0094 + -IT_0146 + -IT_0152 + -IT_0177;
    const ccomplex_t IT_0283 = m_s*s_12;
    const ccomplex_t IT_0284 = 6*s_13;
    const ccomplex_t IT_0285 = (-6)*IT_0278;
    const ccomplex_t IT_0286 = m_s*m_C_2*IT_0034;
    const ccomplex_t IT_0287 = s_13*IT_0034;
