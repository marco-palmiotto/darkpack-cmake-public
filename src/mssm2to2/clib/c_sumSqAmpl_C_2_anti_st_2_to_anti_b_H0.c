        ...
        )
{
    ...
    const ccomplex_t IT_0002 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = sin(alpha);
    const ccomplex_t IT_0005 = conj(V_u1)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0036 = m_t*V_tb*V_u2*e_em*IT_0021*conj(U_st_11);
    ...
    const ccomplex_t IT_0042 = V_tb*e_em*V_Wp2*conj(U_st_01);
    const ccomplex_t IT_0043 = IT_0008*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = -IT_0044;
    const ccomplex_t IT_0046 = m_C_2*IT_0045;
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_C_2*
    ...
    const ccomplex_t IT_0071 = (-2)*U_st_01*((0.5*m_W*IT_0067*(IT_0008 + -1./3
      *IT_0007*IT_0069) + IT_0004*IT_0008*IT_0019*IT_0021*IT_0070)*conj(U_st_01)
       + -1./2*IT_0001*IT_0008*IT_0019*IT_0064*conj(U_st_11)) + U_st_11*(IT_0001
    ...
    const ccomplex_t IT_0074 = -IT_0045;
    ...
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0013 + IT_0062 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0080 = (-2)*U_st_00*((0.5*m_W*IT_0067*(IT_0008 + -1./3
      *IT_0007*IT_0069) + IT_0004*IT_0008*IT_0019*IT_0021*IT_0070)*conj(U_st_01)
       + -1./2*IT_0001*IT_0008*IT_0019*IT_0064*conj(U_st_11)) + U_st_10*(IT_0001
      *IT_0008*IT_0019*IT_0064*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0007
      *IT_0067*IT_0069 + 1.5*IT_0004*IT_0008*IT_0019*IT_0021*IT_0070)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0083 = m_t*V_tb*V_u2*e_em*IT_0021*conj(U_st_10);
    ...
    const ccomplex_t IT_0098 = U_d1*V_Wp2;
    const ccomplex_t IT_0099 = IT_0001*IT_0098;
    const ccomplex_t IT_0100 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0119 = IT_0075*IT_0118;
    const ccomplex_t IT_0120 = IT_0057*IT_0110*IT_0119;
    const ccomplex_t IT_0121 = cpow(IT_0065, -1);
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*m_b*e_em*IT_0001*IT_0008
      *IT_0021*IT_0121;
    const ccomplex_t IT_0123 = (-0.5)*IT_0122;
    const ccomplex_t IT_0124 = cpow((-2)*s_12 + IT_0013 + -IT_0014 + -IT_0062 
      + -reg_prop, -1);
    const ccomplex_t IT_0125 = IT_0123*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*IT_0125;
    const ccomplex_t IT_0127 = m_b*IT_0040;
    const ccomplex_t IT_0128 = m_b*IT_0045;
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = IT_0127 + IT_0129;
    const ccomplex_t IT_0131 = IT_0126*IT_0130;
    const ccomplex_t IT_0132 = -IT_0078 + -IT_0096 + IT_0109 + IT_0120 + 2
      *IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0008*IT_0021*IT_0121*conj(U_st_01);
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0008*IT_0021*IT_0121*conj(U_st_00);
    ...
    const ccomplex_t IT_0144 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0008*IT_0021*IT_0121*conj(U_st_01);
    const ccomplex_t IT_0145 = (-0.5)*IT_0144;
    const ccomplex_t IT_0146 = IT_0012*IT_0145;
    const ccomplex_t IT_0147 = IT_0015*IT_0097*IT_0146;
    const ccomplex_t IT_0148 = IT_0073*IT_0134;
    const ccomplex_t IT_0149 = IT_0063*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*IT_0149;
    const ccomplex_t IT_0151 = IT_0056*IT_0134;
    const ccomplex_t IT_0152 = IT_0057*IT_0110*IT_0151;
    const ccomplex_t IT_0153 = 2*IT_0138 + -IT_0143 + IT_0147 + -IT_0150 +
       IT_0152;
    const ccomplex_t IT_0154 = IT_0118*IT_0134;
    const ccomplex_t IT_0155 = IT_0057*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*IT_0155;
    const ccomplex_t IT_0157 = IT_0105*IT_0145;
    ...
    const ccomplex_t IT_0170 = IT_0017*IT_0107;
    const ccomplex_t IT_0171 = IT_0059*IT_0075;
    const ccomplex_t IT_0172 = IT_0170 + IT_0171;
    const ccomplex_t IT_0173 = -IT_0137;
    const ccomplex_t IT_0174 = conj(IT_0172) + conj(IT_0173);
    const ccomplex_t IT_0175 = IT_0172 + IT_0173;
    const ccomplex_t IT_0176 = (IT_0040 + -IT_0045)*IT_0126;
