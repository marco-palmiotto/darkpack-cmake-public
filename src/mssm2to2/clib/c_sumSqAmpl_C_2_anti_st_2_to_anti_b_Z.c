        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0014*IT_0016*IT_0018*conj(U_st_01);
    ...
    const ccomplex_t IT_0024 = conj(V_u1)*V_u2*e_em;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = IT_0018*IT_0021;
    const ccomplex_t IT_0027 = IT_0024*IT_0026;
    const ccomplex_t IT_0028 = e_em*conj(V_Wp1)*V_Wp2;
    ...
    const ccomplex_t IT_0036 = IT_0026*IT_0034;
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0014*IT_0016*IT_0018*conj(U_st_01);
    ...
    const ccomplex_t IT_0060 = IT_0026*IT_0058;
    ...
    const ccomplex_t IT_0069 = IT_0033 + IT_0044 + IT_0057 + IT_0068;
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*e_em*IT_0017*IT_0022;
    ...
    const ccomplex_t IT_0078 = m_t*V_tb*V_u2*e_em*IT_0014*conj(U_st_11);
    ...
    const ccomplex_t IT_0091 = e_em*IT_0023;
    const ccomplex_t IT_0092 = e_em*IT_0026;
    ...
    const ccomplex_t IT_0097 = m_b*IT_0086;
    const ccomplex_t IT_0098 = m_b*IT_0082;
    ...
    const ccomplex_t IT_0105 = m_t*V_tb*V_u1*e_em*IT_0014*conj(U_st_11);
    ...
    const ccomplex_t IT_0110 = V_tb*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0117 = IT_0010*IT_0013*IT_0116;
    const ccomplex_t IT_0118 = IT_0064*IT_0088;
    const ccomplex_t IT_0119 = IT_0045*IT_0046*IT_0118;
    const ccomplex_t IT_0120 = IT_0046*IT_0055;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*IT_0120;
    const ccomplex_t IT_0122 = m_C_2*IT_0086;
    const ccomplex_t IT_0123 = m_C_2*IT_0082;
    const ccomplex_t IT_0124 = -IT_0123;
    const ccomplex_t IT_0125 = IT_0122 + IT_0124;
    const ccomplex_t IT_0126 = IT_0121*IT_0125;
    const ccomplex_t IT_0127 = IT_0013*IT_0031;
    ...
    const ccomplex_t IT_0135 = IT_0048*IT_0094;
    const ccomplex_t IT_0136 = IT_0071*IT_0072*IT_0135;
    const ccomplex_t IT_0137 = IT_0048*IT_0074;
    const ccomplex_t IT_0138 = IT_0071*IT_0137;
    ...
    const ccomplex_t IT_0188 = IT_0048*IT_0155;
    const ccomplex_t IT_0189 = (0 + _Complex_I*1)*IT_0188;
    const ccomplex_t IT_0190 = IT_0158*IT_0189;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0014*IT_0016*IT_0018*conj(U_st_00);
    const ccomplex_t IT_0192 = (-0.5)*IT_0191;
    const ccomplex_t IT_0193 = IT_0164*IT_0192;
    ...
    const ccomplex_t IT_0207 = IT_0088*IT_0096;
    const ccomplex_t IT_0208 = IT_0163 + IT_0181 + (-2)*IT_0207;
    const ccomplex_t IT_0209 = (-2)*IT_0139 + -IT_0190 + -IT_0195;
    ...
    const ccomplex_t IT_0217 = s_34*IT_0070;
    const ccomplex_t IT_0218 = -IT_0217;
    const ccomplex_t IT_0219 = IT_0216 + IT_0218;
    const ccomplex_t IT_0220 = -(IT_0082 + -IT_0086)*IT_0096;
    const ccomplex_t IT_0221 = -IT_0220;
    const ccomplex_t IT_0222 = -IT_0221;
    const ccomplex_t IT_0223 = -IT_0151 + -IT_0152;
    const ccomplex_t IT_0224 = IT_0043 + IT_0067;
    const ccomplex_t IT_0225 = -IT_0139;
    const ccomplex_t IT_0226 = m_b*IT_0148;
    const ccomplex_t IT_0227 = m_b*IT_0205;
    const ccomplex_t IT_0228 = 6*IT_0208;
    const ccomplex_t IT_0229 = 6*conj(IT_0208);
    const ccomplex_t IT_0230 = 6*IT_0209;
    const ccomplex_t IT_0231 = 6*conj(IT_0209);
    const ccomplex_t IT_0232 = pow(s_34, 2);
    ...
    const ccomplex_t IT_0238 = 6*conj(IT_0069);
    const ccomplex_t IT_0239 = (-18)*conj(IT_0069);
    const ccomplex_t IT_0240 = s_13*IT_0148;
    const ccomplex_t IT_0241 = 6*IT_0196;
    const ccomplex_t IT_0242 = (-6)*IT_0150;
    const ccomplex_t IT_0243 = IT_0241 + IT_0242;
    const ccomplex_t IT_0244 = (-6)*conj(IT_0150);
    const ccomplex_t IT_0245 = IT_0144*IT_0205;
    const ccomplex_t IT_0246 = (-6)*IT_0208;
    const ccomplex_t IT_0247 = (-6)*conj(IT_0208);
    const ccomplex_t IT_0248 = IT_0144*IT_0235;
    const ccomplex_t IT_0249 = s_14*IT_0001;
    const ccomplex_t IT_0250 = IT_0000*IT_0249;
    const ccomplex_t IT_0251 = 0.5*IT_0250;
    const ccomplex_t IT_0252 = s_14 + IT_0251;
    const ccomplex_t IT_0253 = m_b*IT_0252;
    const ccomplex_t IT_0254 = 2*IT_0253;
    const ccomplex_t IT_0255 = 6*conj(IT_0102);
    const ccomplex_t IT_0256 = IT_0238 + IT_0255;
    const ccomplex_t IT_0257 = s_34*IT_0001;
    const ccomplex_t IT_0258 = IT_0000*IT_0257;
    const ccomplex_t IT_0259 = (-0.25)*IT_0258;
    const ccomplex_t IT_0260 = s_34 + IT_0259;
    const ccomplex_t IT_0261 = m_C_2*IT_0260;
    const ccomplex_t IT_0262 = (-4)*IT_0261;
    const ccomplex_t IT_0263 = 6*conj(IT_0134);
    const ccomplex_t IT_0264 = 6*conj(IT_0141);
    const ccomplex_t IT_0265 = IT_0263 + IT_0264;
    const ccomplex_t IT_0266 = s_14*IT_0011;
    const ccomplex_t IT_0267 = s_13*s_34;
    const ccomplex_t IT_0268 = -IT_0267;
    const ccomplex_t IT_0269 = IT_0266 + IT_0268;
    const ccomplex_t IT_0270 = (-0.25)*IT_0250;
    const ccomplex_t IT_0271 = s_14 + IT_0270;
    const ccomplex_t IT_0272 = m_b*IT_0271;
    const ccomplex_t IT_0273 = (-4)*IT_0272;
    const ccomplex_t IT_0274 = (-6)*conj(IT_0069);
    const ccomplex_t IT_0275 = (-6)*conj(IT_0102);
    const ccomplex_t IT_0276 = IT_0274 + IT_0275;
    const ccomplex_t IT_0277 = 0.5*IT_0258;
    const ccomplex_t IT_0278 = s_34 + IT_0277;
    const ccomplex_t IT_0279 = m_C_2*IT_0278;
    const ccomplex_t IT_0280 = 2*IT_0279;
    const ccomplex_t IT_0281 = (-6)*conj(IT_0134);
    const ccomplex_t IT_0282 = (-6)*conj(IT_0141);
    const ccomplex_t IT_0283 = IT_0281 + IT_0282;
    const ccomplex_t IT_0284 = s_13*IT_0235;
    const ccomplex_t IT_0285 = (-6)*IT_0209;
    const ccomplex_t IT_0286 = m_C_2*IT_0205;
    const ccomplex_t IT_0287 = (-6)*IT_0069;
    const ccomplex_t IT_0288 = IT_0001*IT_0144;
    const ccomplex_t IT_0289 = (-3)*IT_0288;
    const ccomplex_t IT_0290 = 3*IT_0288;
    const ccomplex_t IT_0291 = 24*IT_0003;
    const ccomplex_t IT_0292 = pow(m_Z, 4);
    const ccomplex_t IT_0293 = s_13*IT_0292;
    const ccomplex_t IT_0294 = IT_0000*IT_0293;
    const ccomplex_t IT_0295 = (-6)*IT_0294;
    const ccomplex_t IT_0296 = IT_0291 + IT_0295;
    const ccomplex_t IT_0297 = 6*IT_0294;
    const ccomplex_t IT_0298 = (-12)*IT_0002;
    const ccomplex_t IT_0299 = IT_0291 + IT_0297 + IT_0298;
    const ccomplex_t IT_0300 = 0.166666666666667*IT_0223;
    const ccomplex_t IT_0301 = 6*IT_0102;
    const ccomplex_t IT_0302 = IT_0237 + IT_0301;
    const ccomplex_t IT_0303 = 0.166666666666667*IT_0254;
    const ccomplex_t IT_0304 = 6*IT_0134;
    const ccomplex_t IT_0305 = 6*IT_0141;
    const ccomplex_t IT_0306 = IT_0304 + IT_0305;
    const ccomplex_t IT_0307 = 0.166666666666667*IT_0262;
    const ccomplex_t IT_0308 = 0.166666666666667*IT_0269;
    const ccomplex_t IT_0309 = (-6)*IT_0102;
    const ccomplex_t IT_0310 = IT_0287 + IT_0309;
    const ccomplex_t IT_0311 = 0.166666666666667*IT_0273;
    const ccomplex_t IT_0312 = (-6)*IT_0134;
    const ccomplex_t IT_0313 = (-6)*IT_0141;
    ...
    const ccomplex_t IT_0317 = 0.166666666666667*IT_0225;
    const ccomplex_t IT_0318 = IT_0285*IT_0308;
    const ccomplex_t IT_0319 = (-6)*conj(IT_0209);
    const ccomplex_t IT_0320 = IT_0269*IT_0319;
    const ccomplex_t IT_0321 = IT_0009*(IT_0103*IT_0104 + IT_0142*IT_0143) +
      ...
      + IT_0196*IT_0202) + IT_0206*(IT_0187*IT_0208 + IT_0184*conj(IT_0208) +
       conj(IT_0209)*IT_0212 + IT_0209*IT_0215) + IT_0219*(IT_0187*(IT_0222 +
       IT_0223) + IT_0184*(conj(IT_0222) + conj(IT_0223)) + IT_0215*(IT_0224 +
       IT_0225) + IT_0212*(conj(IT_0224) + conj(IT_0225))) + (IT_0104*IT_0184 +
       IT_0103*IT_0187 + IT_0143*IT_0212 + IT_0142*IT_0215)*IT_0226 + IT_0227*
      (IT_0104*IT_0228 + IT_0103*IT_0229 + IT_0143*IT_0230 + IT_0142*IT_0231) +
       IT_0236*(IT_0143*IT_0228 + IT_0142*IT_0229 + conj(IT_0102)*IT_0230 +
       IT_0102*IT_0231 + conj(IT_0209)*IT_0237 + IT_0209*IT_0238) + IT_0144*
      (IT_0103*((-18)*conj(IT_0134) + (-18)*conj(IT_0141)) + IT_0142*((-18)*conj
      (IT_0102) + IT_0239)) + IT_0240*(conj(IT_0153)*IT_0154 + conj(IT_0182)
      *IT_0199 + IT_0182*IT_0201 + conj(IT_0150)*IT_0210 + conj(IT_0196)*IT_0243
       + IT_0196*IT_0244) + IT_0245*(IT_0187*IT_0209 + IT_0184*conj(IT_0209) +
       conj(IT_0150)*IT_0228 + IT_0150*IT_0229 + conj(IT_0196)*IT_0246 + IT_0196
      *IT_0247) + (conj(IT_0209)*IT_0246 + IT_0209*IT_0247)*IT_0248 + IT_0223*
      (IT_0254*IT_0256 + IT_0262*IT_0265 + IT_0247*IT_0269) + IT_0222*(IT_0247
      *IT_0269 + IT_0273*IT_0276 + IT_0280*IT_0283) + IT_0284*(conj(IT_0208)
      *IT_0246 + conj(IT_0209)*IT_0285) + IT_0286*(IT_0143*IT_0199 + IT_0142
      *IT_0202 + 6*conj(IT_0196)*(IT_0102 + 0.166666666666667*IT_0237) + IT_0196
      *IT_0238 + conj(IT_0102)*IT_0243 + IT_0102*IT_0244 + IT_0150*IT_0274 +
       conj(IT_0150)*IT_0287) + 6*conj(IT_0223)*(IT_0224*IT_0289 + -IT_0225
      *IT_0290 + 0.166666666666667*IT_0222*IT_0296 + IT_0299*IT_0300 + IT_0302
      *IT_0303 + IT_0306*IT_0307 + IT_0246*IT_0308) + 6*conj(IT_0222)*(IT_0225
      *IT_0289 + -IT_0224*IT_0290 + 0.166666666666667*IT_0222*IT_0299 + IT_0296
      *IT_0300 + IT_0246*IT_0308 + IT_0310*IT_0311 + IT_0314*IT_0315) + 6*conj
      (IT_0224)*(IT_0223*IT_0289 + -IT_0222*IT_0290 + IT_0303*IT_0306 + IT_0302
      *IT_0307 + IT_0299*IT_0316 + IT_0296*IT_0317 + IT_0318) + 6*conj(IT_0225)*
      (IT_0222*IT_0289 + -IT_0223*IT_0290 + IT_0311*IT_0314 + IT_0310*IT_0315 +
       IT_0296*IT_0316 + IT_0299*IT_0317 + IT_0318) + IT_0224*(IT_0256*IT_0262 +
       IT_0254*IT_0265 + IT_0320) + IT_0225*(IT_0276*IT_0280 + IT_0273*IT_0283 +
       IT_0320);
