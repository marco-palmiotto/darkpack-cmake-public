        ...
        )
{
    ...
    const ccomplex_t IT_0036 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0037 = IT_0001*IT_0036;
    const ccomplex_t IT_0038 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0065 = IT_0001*IT_0024;
    const ccomplex_t IT_0066 = IT_0064 + IT_0065;
    const ccomplex_t IT_0067 = cos(theta_W);
    const ccomplex_t IT_0068 = cpow(IT_0067, -2);
    const ccomplex_t IT_0069 = pow(m_t, 2);
    const ccomplex_t IT_0070 = 2*U_st_01*(((-0.5)*m_W*IT_0066*(IT_0008 + -1./3
      *IT_0007*IT_0068) + IT_0001*IT_0008*IT_0025*IT_0027*IT_0069)*conj(U_st_01)
       + 1./2*IT_0004*IT_0008*IT_0025*IT_0062*conj(U_st_11)) + U_st_11*(IT_0004
      *IT_0008*IT_0025*IT_0062*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0007
      *IT_0066*IT_0068 + (-1.5)*IT_0001*IT_0008*IT_0025*IT_0027*IT_0069)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0076 = pow(m_C_2, 2);
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0013 + IT_0076 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0075*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = 2*U_st_00*(((-0.5)*m_W*IT_0066*(IT_0008 + -1./3
      *IT_0007*IT_0068) + IT_0001*IT_0008*IT_0025*IT_0027*IT_0069)*conj(U_st_01)
       + 1./2*IT_0004*IT_0008*IT_0025*IT_0062*conj(U_st_11)) + U_st_10*(IT_0004
      *IT_0008*IT_0025*IT_0062*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0007
      *IT_0066*IT_0068 + (-1.5)*IT_0001*IT_0008*IT_0025*IT_0027*IT_0069)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0083 = m_t*V_tb*V_u2*e_em*IT_0027*conj(U_st_10);
    ...
    const ccomplex_t IT_0088 = V_tb*e_em*V_Wp2*conj(U_st_00);
    ...
    const ccomplex_t IT_0108 = IT_0015*IT_0098*IT_0107;
    const ccomplex_t IT_0109 = cpow(IT_0063, -1);
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*m_b*e_em*IT_0004*IT_0008
      *IT_0027*IT_0109;
    const ccomplex_t IT_0111 = 0.5*IT_0110;
    const ccomplex_t IT_0112 = cpow((-2)*s_12 + IT_0013 + -IT_0014 + -IT_0076 
      + -reg_prop, -1);
    const ccomplex_t IT_0113 = IT_0111*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*IT_0113;
    const ccomplex_t IT_0115 = m_b*IT_0032;
    const ccomplex_t IT_0116 = m_b*IT_0021;
    ...
    const ccomplex_t IT_0121 = V_u2*U_Wm1;
    const ccomplex_t IT_0122 = IT_0001*IT_0121;
    const ccomplex_t IT_0123 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0129 = -IT_0056;
    const ccomplex_t IT_0130 = IT_0051 + IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = IT_0044*IT_0120*IT_0131;
    const ccomplex_t IT_0133 = -IT_0079 + -IT_0097 + IT_0108 + 2*IT_0119 +
       IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0008*IT_0027*IT_0109*conj(U_st_00);
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0008*IT_0027*IT_0109*conj(U_st_01);
    const ccomplex_t IT_0140 = (-0.5)*IT_0139;
    const ccomplex_t IT_0141 = IT_0012*IT_0140;
    const ccomplex_t IT_0142 = IT_0015*IT_0098*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0008*IT_0027*IT_0109*conj(U_st_01);
    const ccomplex_t IT_0144 = (-0.5)*IT_0143;
    const ccomplex_t IT_0145 = IT_0043*IT_0144;
    const ccomplex_t IT_0146 = IT_0044*IT_0120*IT_0145;
    const ccomplex_t IT_0147 = IT_0111*IT_0140;
    ...
    const ccomplex_t IT_0151 = IT_0072*IT_0140;
    const ccomplex_t IT_0152 = IT_0077*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*IT_0152;
    const ccomplex_t IT_0154 = -IT_0138 + IT_0142 + IT_0146 + 2*IT_0150 + 
      -IT_0153;
    const ccomplex_t IT_0155 = IT_0128*IT_0144;
    const ccomplex_t IT_0156 = IT_0044*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*IT_0156;
    const ccomplex_t IT_0158 = IT_0106*IT_0140;
    ...
    const ccomplex_t IT_0171 = (IT_0021 + -IT_0032)*IT_0114;
    const ccomplex_t IT_0172 = -IT_0171;
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = conj(IT_0161) + conj(IT_0173);
    const ccomplex_t IT_0175 = IT_0161 + IT_0173;
    const ccomplex_t IT_0176 = IT_0046*IT_0130;
    const ccomplex_t IT_0177 = IT_0017*IT_0074;
    const ccomplex_t IT_0178 = IT_0176 + IT_0177;
    const ccomplex_t IT_0179 = -IT_0149;
    const ccomplex_t IT_0180 = conj(IT_0178) + conj(IT_0179);
    const ccomplex_t IT_0181 = 6*IT_0163;
    const ccomplex_t IT_0182 = (-6)*IT_0154;
    const ccomplex_t IT_0183 = IT_0181 + IT_0182;
    const ccomplex_t IT_0184 = IT_0178 + IT_0179;
    const ccomplex_t IT_0185 = 6*conj(IT_0163);
    const ccomplex_t IT_0186 = (-6)*conj(IT_0154);
    const ccomplex_t IT_0187 = IT_0185 + IT_0186;
    const ccomplex_t IT_0188 = s_34*m_C_2;
    const ccomplex_t IT_0189 = 6*s_13;
    const ccomplex_t IT_0190 = pow(m_h, 2);
    const ccomplex_t IT_0191 = m_b*m_C_2*IT_0190;
    const ccomplex_t IT_0192 = 6*IT_0161;
    const ccomplex_t IT_0193 = 6*conj(IT_0161);
    const ccomplex_t IT_0194 = (-6)*s_13;
    const ccomplex_t IT_0195 = s_13*IT_0190;
    const ccomplex_t IT_0196 = s_14*s_34;
    const ccomplex_t IT_0197 = (-2)*IT_0196;
    const ccomplex_t IT_0198 = IT_0195 + IT_0197;
    const ccomplex_t IT_0199 = (-6)*IT_0178;
    const ccomplex_t IT_0200 = (-6)*IT_0161;
    const ccomplex_t IT_0201 = (-6)*IT_0000*((conj(IT_0061) + -conj(IT_0133))
      *IT_0154 + (IT_0061 + -IT_0133)*conj(IT_0154) + (-0.166666666666667)*conj
      (IT_0163)*IT_0166 + (-0.166666666666667)*IT_0163*IT_0169) + IT_0170*
      (IT_0166*IT_0174 + IT_0169*IT_0175 + IT_0180*IT_0183 + IT_0184*IT_0187) + 
      (IT_0166*IT_0180 + IT_0174*IT_0183 + IT_0169*IT_0184 + IT_0175*IT_0187)
      *IT_0188 + (IT_0061*conj(IT_0061) + IT_0133*conj(IT_0133) + IT_0154*conj
      (IT_0154) + IT_0163*conj(IT_0163))*IT_0189 + 6*IT_0191*(IT_0180*(IT_0173 +
       0.166666666666667*IT_0192) + IT_0184*(conj(IT_0173) + 0.166666666666667
      *IT_0193)) + (conj(IT_0061)*IT_0133 + IT_0061*conj(IT_0133) + conj(IT_0154
      )*IT_0163 + IT_0154*conj(IT_0163))*IT_0194 + (-6)*IT_0198*(IT_0180*
      (IT_0179 + (-0.166666666666667)*IT_0199) + IT_0174*(IT_0173 + (
