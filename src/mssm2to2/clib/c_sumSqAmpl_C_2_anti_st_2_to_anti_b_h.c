...
ccomplex_return_t c_sumSqAmpl_C_2_anti_st_2_to_anti_b_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = m_C_2*IT_0031;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = m_t*V_tb*V_u2*e_em*IT_0021*conj(U_st_11);
    ...
    const ccomplex_t IT_0053 = V_tb*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0013 + IT_0062 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0064 = m_t*mu_h*IT_0021;
    const ccomplex_t IT_0065 = cos(beta);
    const ccomplex_t IT_0066 = IT_0004*IT_0065;
    const ccomplex_t IT_0067 = IT_0001*IT_0018;
    const ccomplex_t IT_0068 = IT_0066 + IT_0067;
    const ccomplex_t IT_0069 = cos(theta_W);
    const ccomplex_t IT_0070 = cpow(IT_0069, -2);
    const ccomplex_t IT_0071 = pow(m_t, 2);
    const ccomplex_t IT_0072 = 2*U_st_01*(((-0.5)*m_W*IT_0068*(IT_0008 + -1./3
      *IT_0007*IT_0070) + IT_0001*IT_0008*IT_0019*IT_0021*IT_0071)*conj(U_st_01)
       + 1./2*IT_0004*IT_0008*IT_0019*IT_0064*conj(U_st_11)) + U_st_11*(IT_0004
      *IT_0008*IT_0019*IT_0064*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0007
      *IT_0068*IT_0070 + (-1.5)*IT_0001*IT_0008*IT_0019*IT_0021*IT_0071)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0075 = -IT_0056;
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0013 + IT_0062 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0081 = 2*U_st_00*(((-0.5)*m_W*IT_0068*(IT_0008 + -1./3
      *IT_0007*IT_0070) + IT_0001*IT_0008*IT_0019*IT_0021*IT_0071)*conj(U_st_01)
       + 1./2*IT_0004*IT_0008*IT_0019*IT_0064*conj(U_st_11)) + U_st_10*(IT_0004
      *IT_0008*IT_0019*IT_0064*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0007
      *IT_0068*IT_0070 + (-1.5)*IT_0001*IT_0008*IT_0019*IT_0021*IT_0071)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0084 = m_t*V_tb*V_u2*e_em*IT_0021*conj(U_st_10);
    ...
    const ccomplex_t IT_0089 = V_tb*e_em*V_Wp2*conj(U_st_00);
    ...
    const ccomplex_t IT_0096 = IT_0080*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0099 = V_u2*U_Wm1;
    const ccomplex_t IT_0100 = IT_0001*IT_0099;
    const ccomplex_t IT_0101 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0107 = -IT_0031;
    const ccomplex_t IT_0108 = IT_0026 + IT_0107;
    const ccomplex_t IT_0109 = IT_0106*IT_0108;
    const ccomplex_t IT_0110 = IT_0015*IT_0098*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0112 = V_u2*U_Wm2;
    const ccomplex_t IT_0113 = IT_0001*IT_0112;
    const ccomplex_t IT_0114 = U_d2*V_Wp2;
    const ccomplex_t IT_0115 = IT_0004*IT_0114;
    const ccomplex_t IT_0116 = IT_0008*(IT_0113 + -IT_0115);
    const ccomplex_t IT_0117 = 1.4142135623731*e_em*IT_0116;
    const ccomplex_t IT_0118 = 0.5*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*IT_0118;
    const ccomplex_t IT_0120 = IT_0076*IT_0119;
    const ccomplex_t IT_0121 = IT_0044*IT_0111*IT_0120;
    const ccomplex_t IT_0122 = cpow(IT_0065, -1);
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_b*e_em*IT_0004*IT_0008
      *IT_0021*IT_0122;
    const ccomplex_t IT_0124 = 0.5*IT_0123;
    const ccomplex_t IT_0125 = cpow((-2)*s_12 + IT_0013 + -IT_0014 + -IT_0062 
      + -reg_prop, -1);
    const ccomplex_t IT_0126 = IT_0124*IT_0125;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*IT_0126;
    const ccomplex_t IT_0128 = m_b*IT_0056;
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = m_b*IT_0051;
    const ccomplex_t IT_0131 = IT_0129 + IT_0130;
    const ccomplex_t IT_0132 = IT_0127*IT_0131;
    const ccomplex_t IT_0133 = -IT_0079 + -IT_0097 + IT_0110 + IT_0121 + 2
      *IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0008*IT_0021*IT_0122*conj(U_st_01);
    const ccomplex_t IT_0135 = (-0.5)*IT_0134;
    const ccomplex_t IT_0136 = IT_0012*IT_0135;
    const ccomplex_t IT_0137 = IT_0015*IT_0098*IT_0136;
    ...
    const ccomplex_t IT_0141 = IT_0044*IT_0111*IT_0140;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0008*IT_0021*IT_0122*conj(U_st_00);
    const ccomplex_t IT_0143 = (-0.5)*IT_0142;
    const ccomplex_t IT_0144 = IT_0083*IT_0143;
    const ccomplex_t IT_0145 = IT_0080*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*IT_0145;
    const ccomplex_t IT_0147 = IT_0124*IT_0139;
    ...
    const ccomplex_t IT_0151 = IT_0074*IT_0139;
    const ccomplex_t IT_0152 = IT_0063*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*IT_0152;
    const ccomplex_t IT_0154 = IT_0137 + IT_0141 + -IT_0146 + 2*IT_0150 + 
      -IT_0153;
    const ccomplex_t IT_0155 = IT_0106*IT_0135;
    const ccomplex_t IT_0156 = IT_0015*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*IT_0156;
    const ccomplex_t IT_0158 = IT_0119*IT_0139;
    ...
    const ccomplex_t IT_0164 = 6*IT_0061;
    const ccomplex_t IT_0165 = (-6)*IT_0133;
    const ccomplex_t IT_0166 = IT_0164 + IT_0165;
    const ccomplex_t IT_0167 = 6*conj(IT_0061);
    const ccomplex_t IT_0168 = (-6)*conj(IT_0133);
    const ccomplex_t IT_0169 = IT_0167 + IT_0168;
    const ccomplex_t IT_0170 = m_b*s_14;
    const ccomplex_t IT_0171 = IT_0017*IT_0108;
    const ccomplex_t IT_0172 = IT_0046*IT_0076;
    const ccomplex_t IT_0173 = IT_0171 + IT_0172;
    const ccomplex_t IT_0174 = -IT_0149;
    const ccomplex_t IT_0175 = conj(IT_0173) + conj(IT_0174);
    const ccomplex_t IT_0176 = 6*IT_0163;
    const ccomplex_t IT_0177 = (-6)*IT_0154;
    const ccomplex_t IT_0178 = IT_0176 + IT_0177;
    const ccomplex_t IT_0179 = IT_0173 + IT_0174;
    const ccomplex_t IT_0180 = 6*conj(IT_0163);
    const ccomplex_t IT_0181 = (-6)*conj(IT_0154);
    const ccomplex_t IT_0182 = IT_0180 + IT_0181;
    const ccomplex_t IT_0183 = (IT_0051 + -IT_0056)*IT_0127;
    ...
    const ccomplex_t IT_0199 = (-6)*IT_0173;
    const ccomplex_t IT_0200 = (-6)*IT_0000*((conj(IT_0061) + -conj(IT_0133))
      *IT_0154 + (IT_0061 + -IT_0133)*conj(IT_0154) + (-0.166666666666667)*conj
      ...
      *IT_0187 + (IT_0061*conj(IT_0061) + IT_0133*conj(IT_0133) + IT_0154*conj
      ...
      *IT_0192)) + (conj(IT_0061)*IT_0133 + IT_0061*conj(IT_0133) + conj(IT_0154
      )*IT_0163 + IT_0154*conj(IT_0163))*IT_0193 + (-6)*IT_0197*(IT_0185*
      (IT_0184 + (-0.166666666666667)*IT_0198) + IT_0175*(IT_0174 + (
