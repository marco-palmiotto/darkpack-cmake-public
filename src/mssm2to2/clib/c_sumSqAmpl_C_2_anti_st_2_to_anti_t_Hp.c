        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
    ...
    const ccomplex_t IT_0015 = m_t*V_tb*V_u2*e_em*IT_0005*conj(U_st_11);
    const ccomplex_t IT_0016 = IT_0014*IT_0015;
    const ccomplex_t IT_0017 = 1.4142135623731*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*IT_0017;
    const ccomplex_t IT_0019 = (-0.5)*IT_0018;
    const ccomplex_t IT_0020 = V_tb*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0027 = IT_0003*IT_0004*IT_0026;
    const ccomplex_t IT_0028 = pow(m_d, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + IT_0028 
      + -reg_prop, -1);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_td)
      *e_em*IT_0005*IT_0007*IT_0008*IT_0010;
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = m_t*V_td*V_u2*e_em*IT_0005*conj(U_st_11);
    const ccomplex_t IT_0034 = IT_0014*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*IT_0035;
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = V_td*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0045 = IT_0029*IT_0030*IT_0044;
    const ccomplex_t IT_0046 = pow(m_s, 2);
    const ccomplex_t IT_0047 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + IT_0046 
      + -reg_prop, -1);
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_ts)
      *e_em*IT_0005*IT_0007*IT_0008*IT_0010;
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = m_t*V_ts*V_u2*e_em*IT_0005*conj(U_st_11);
    const ccomplex_t IT_0052 = IT_0014*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = V_ts*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0063 = IT_0047*IT_0048*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0065 = IT_0006*IT_0010;
    const ccomplex_t IT_0066 = N_u1*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0094 = pow(m_t, 2);
    const ccomplex_t IT_0095 = cpow((-2)*s_23 + IT_0002 + IT_0094 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0064*IT_0093*IT_0095;
    ...
    const ccomplex_t IT_0139 = N_B3*e_em*conj(U_st_01);
    const ccomplex_t IT_0140 = IT_0070*IT_0139;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = N_W3*e_em*conj(U_st_01);
    const ccomplex_t IT_0143 = IT_0010*IT_0142;
    const ccomplex_t IT_0144 = 1.4142135623731*IT_0143;
    const ccomplex_t IT_0145 = m_t*N_u3*e_em*IT_0005*conj(U_st_11);
    ...
    const ccomplex_t IT_0151 = cpow((-2)*s_23 + IT_0002 + IT_0094 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0152 = IT_0125*IT_0150*IT_0151;
    const ccomplex_t IT_0153 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0154 = IT_0070*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = m_t*conj(N_u1)*e_em*IT_0005*conj(U_st_01);
    ...
    const ccomplex_t IT_0161 = IT_0081*IT_0160;
    const ccomplex_t IT_0162 = IT_0095*IT_0161;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*IT_0162;
    const ccomplex_t IT_0164 = m_t*IT_0163;
    const ccomplex_t IT_0165 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0166 = IT_0070*IT_0165;
    const ccomplex_t IT_0167 = 1.4142135623731*IT_0166;
    const ccomplex_t IT_0168 = m_t*conj(N_u2)*e_em*IT_0005*conj(U_st_01);
    ...
    const ccomplex_t IT_0189 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_td*e_em*IT_0005*IT_0007*IT_0010*conj(U_st_01);
    ...
    const ccomplex_t IT_0195 = cpow((-2)*s_23 + IT_0002 + IT_0094 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0196 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0197 = IT_0065*IT_0196;
    const ccomplex_t IT_0198 = 2*IT_0197;
    const ccomplex_t IT_0199 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0200 = IT_0071*IT_0199;
    const ccomplex_t IT_0201 = 1.4142135623731*IT_0200;
    const ccomplex_t IT_0202 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0209 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0210 = IT_0070*IT_0209;
    const ccomplex_t IT_0211 = 1.4142135623731*IT_0210;
    const ccomplex_t IT_0212 = m_t*conj(N_u4)*e_em*IT_0005*conj(U_st_01);
    const ccomplex_t IT_0213 = IT_0014*IT_0212;
    const ccomplex_t IT_0214 = 1.4142135623731*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*(IT_0211 + (-0.75)*IT_0214);
    ...
    const ccomplex_t IT_0221 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0005*IT_0007*IT_0010*conj(U_st_01);
    ...
    const ccomplex_t IT_0227 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_ts*e_em*IT_0005*IT_0007*IT_0010*conj(U_st_01);
    const ccomplex_t IT_0228 = (-0.5)*IT_0227;
    const ccomplex_t IT_0229 = IT_0050*IT_0228;
    const ccomplex_t IT_0230 = IT_0047*IT_0229;
    ...
    const ccomplex_t IT_0234 = N_B4*e_em*conj(U_st_01);
    const ccomplex_t IT_0235 = IT_0070*IT_0234;
    const ccomplex_t IT_0236 = 1.4142135623731*IT_0235;
    const ccomplex_t IT_0237 = N_W4*e_em*conj(U_st_01);
    const ccomplex_t IT_0238 = IT_0010*IT_0237;
    const ccomplex_t IT_0239 = 1.4142135623731*IT_0238;
    const ccomplex_t IT_0240 = m_t*N_u4*e_em*IT_0005*conj(U_st_11);
    const ccomplex_t IT_0241 = IT_0014*IT_0240;
    const ccomplex_t IT_0242 = 1.4142135623731*IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*(IT_0236 + 3*IT_0239 + 3
      *IT_0242);
    const ccomplex_t IT_0244 = 0.166666666666667*IT_0243;
    const ccomplex_t IT_0245 = IT_0208*IT_0244;
    const ccomplex_t IT_0246 = IT_0195*IT_0233*IT_0245;
    const ccomplex_t IT_0247 = IT_0027 + IT_0045 + IT_0063 + IT_0096 + IT_0124
       + IT_0152 + -IT_0164 + -IT_0176 + -IT_0188 + IT_0194 + -IT_0220 + IT_0226
       + IT_0232 + IT_0246;
    const ccomplex_t IT_0248 = IT_0008*IT_0010;
    const ccomplex_t IT_0249 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0250 = IT_0248*IT_0249;
    const ccomplex_t IT_0251 = 1.4142135623731*IT_0250;
    const ccomplex_t IT_0252 = IT_0008*IT_0070;
    const ccomplex_t IT_0253 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0257 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0263 = IT_0160*IT_0262;
    const ccomplex_t IT_0264 = IT_0064*IT_0095*IT_0263;
    const ccomplex_t IT_0265 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0266 = IT_0248*IT_0265;
    const ccomplex_t IT_0267 = (-2)*IT_0266;
    const ccomplex_t IT_0268 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0269 = IT_0252*IT_0268;
    const ccomplex_t IT_0270 = 1.4142135623731*IT_0269;
    const ccomplex_t IT_0271 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0293 = IT_0184*IT_0292;
    const ccomplex_t IT_0294 = IT_0125*IT_0151*IT_0293;
    const ccomplex_t IT_0295 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0296 = IT_0248*IT_0295;
    const ccomplex_t IT_0297 = (-2)*IT_0296;
    const ccomplex_t IT_0298 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0299 = IT_0252*IT_0298;
    const ccomplex_t IT_0300 = 1.4142135623731*IT_0299;
    const ccomplex_t IT_0301 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0308 = IT_0216*IT_0307;
    const ccomplex_t IT_0309 = IT_0195*IT_0233*IT_0308;
    const ccomplex_t IT_0310 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0005*IT_0006*IT_0010*IT_0013;
    const ccomplex_t IT_0311 = 0.5*IT_0310;
    const ccomplex_t IT_0312 = IT_0222*IT_0311;
    const ccomplex_t IT_0313 = IT_0003*IT_0004*IT_0312;
    const ccomplex_t IT_0314 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
      *e_em*IT_0005*IT_0006*IT_0010*IT_0013;
    const ccomplex_t IT_0315 = 0.5*IT_0314;
    const ccomplex_t IT_0316 = IT_0190*IT_0315;
    const ccomplex_t IT_0317 = IT_0029*IT_0030*IT_0316;
    const ccomplex_t IT_0318 = IT_0092*IT_0262;
    const ccomplex_t IT_0319 = IT_0095*IT_0318;
    const ccomplex_t IT_0320 = (0 + _Complex_I*1)*IT_0319;
    const ccomplex_t IT_0321 = m_t*IT_0320;
    const ccomplex_t IT_0322 = IT_0121*IT_0277;
    const ccomplex_t IT_0323 = IT_0123*IT_0322;
    const ccomplex_t IT_0324 = (0 + _Complex_I*1)*IT_0323;
    const ccomplex_t IT_0325 = m_t*IT_0324;
    const ccomplex_t IT_0326 = IT_0149*IT_0292;
    const ccomplex_t IT_0327 = IT_0151*IT_0326;
    ...
    const ccomplex_t IT_0332 = IT_0228*IT_0331;
    const ccomplex_t IT_0333 = IT_0047*IT_0048*IT_0332;
    const ccomplex_t IT_0334 = IT_0244*IT_0307;
    const ccomplex_t IT_0335 = IT_0195*IT_0334;
    const ccomplex_t IT_0336 = (0 + _Complex_I*1)*IT_0335;
    const ccomplex_t IT_0337 = m_t*IT_0336;
    const ccomplex_t IT_0338 = IT_0003*IT_0311;
    const ccomplex_t IT_0339 = (0 + _Complex_I*1)*IT_0338;
    const ccomplex_t IT_0340 = m_C_2*IT_0019;
    const ccomplex_t IT_0341 = m_C_2*IT_0023;
    const ccomplex_t IT_0342 = -IT_0341;
    const ccomplex_t IT_0343 = IT_0340 + IT_0342;
    const ccomplex_t IT_0344 = IT_0339*IT_0343;
    const ccomplex_t IT_0345 = m_C_2*IT_0037;
    const ccomplex_t IT_0346 = m_C_2*IT_0041;
    const ccomplex_t IT_0347 = -IT_0346;
    const ccomplex_t IT_0348 = IT_0345 + IT_0347;
    const ccomplex_t IT_0349 = IT_0029*IT_0315;
    const ccomplex_t IT_0350 = (0 + _Complex_I*1)*IT_0349;
    const ccomplex_t IT_0351 = IT_0348*IT_0350;
    const ccomplex_t IT_0352 = m_C_2*IT_0055;
    const ccomplex_t IT_0353 = m_C_2*IT_0059;
    const ccomplex_t IT_0354 = -IT_0353;
    const ccomplex_t IT_0355 = IT_0352 + IT_0354;
    const ccomplex_t IT_0356 = IT_0047*IT_0331;
    const ccomplex_t IT_0357 = (0 + _Complex_I*1)*IT_0356;
    const ccomplex_t IT_0358 = IT_0355*IT_0357;
    const ccomplex_t IT_0359 = IT_0264 + IT_0279 + IT_0294 + IT_0309 + IT_0313
       + IT_0317 + -IT_0321 + -IT_0325 + -IT_0329 + IT_0333 + -IT_0337 + IT_0344
       + IT_0351 + IT_0358;
    const ccomplex_t IT_0360 = m_t*m_C_2;
    const ccomplex_t IT_0361 = -IT_0193 + -IT_0225 + -IT_0231 + -IT_0320 + 
      -IT_0324 + -IT_0328 + -IT_0336;
    const ccomplex_t IT_0362 = s_23*m_C_2;
    const ccomplex_t IT_0363 = IT_0043*IT_0350;
    const ccomplex_t IT_0364 = IT_0025*IT_0339;
    const ccomplex_t IT_0365 = IT_0061*IT_0357;
    const ccomplex_t IT_0366 = -IT_0163 + -IT_0175 + -IT_0187 + -IT_0219 + 
    ...
    const ccomplex_t IT_0370 = m_t*m_C_2*IT_0002;
    const ccomplex_t IT_0371 = s_13*IT_0002;
