        ...
        )
{
    ...
    const ccomplex_t IT_0019 = conj(N_B4)*e_em*conj(U_stau_10);
    ...
    const ccomplex_t IT_0026 = conj(N_d4)*e_em*m_tau*IT_0025*conj(U_stau_00);
    ...
    const ccomplex_t IT_0048 = conj(N_d2)*e_em*m_tau*IT_0025*conj(U_stau_00);
    ...
    const ccomplex_t IT_0067 = conj(N_d3)*e_em*m_tau*IT_0025*conj(U_stau_00);
    ...
    const ccomplex_t IT_0083 = conj(N_B1)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0084 = IT_0018*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_d1)*e_em*m_tau*IT_0025*conj(U_stau_00);
    ...
    const ccomplex_t IT_0186 = N_d4*e_em*m_tau*IT_0025*conj(U_stau_10);
