        ...
        )
{
    ...
    const ccomplex_t IT_0021 = N_B3*e_em*conj(U_stau_01);
    const ccomplex_t IT_0022 = IT_0009*IT_0021;
    const ccomplex_t IT_0023 = 1.4142135623731*IT_0022;
    const ccomplex_t IT_0024 = N_W3*e_em*conj(U_stau_01);
    ...
    const ccomplex_t IT_0030 = N_d3*e_em*m_tau*IT_0029*conj(U_stau_11);
    ...
    const ccomplex_t IT_0037 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*(A_tau*IT_0042*conj
      (U_stau_11) + (-1.4142135623731)*e_em*IT_0003*(m_W*IT_0001*IT_0042*conj
      (U_stau_01) + (-0.5)*m_tau*IT_0029*(m_tau*IT_0027*IT_0042*conj(U_stau_01) 
      + mu_h*conj(U_stau_11))));
    ...
    const ccomplex_t IT_0085 = N_d2*e_em*m_tau*IT_0029*conj(U_stau_11);
    ...
    const ccomplex_t IT_0133 = conj(N_B1)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0134 = IT_0009*IT_0133;
    const ccomplex_t IT_0135 = 1.4142135623731*IT_0134;
    const ccomplex_t IT_0136 = conj(N_d1)*e_em*m_tau*IT_0029*conj(U_stau_01);
    ...
    const ccomplex_t IT_0145 = conj(N_B2)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0146 = IT_0009*IT_0145;
    const ccomplex_t IT_0147 = 1.4142135623731*IT_0146;
    const ccomplex_t IT_0148 = conj(N_d2)*e_em*m_tau*IT_0029*conj(U_stau_01);
    ...
    const ccomplex_t IT_0160 = conj(N_d3)*e_em*m_tau*IT_0029*conj(U_stau_01);
    ...
    const ccomplex_t IT_0172 = conj(N_d4)*e_em*m_tau*IT_0029*conj(U_stau_01);
