...
ccomplex_return_t c_sumSqAmpl_C_2_anti_stau_2_to_anti_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = conj(N_B2)*e_em*conj(U_stau_11);
    ...
    const ccomplex_t IT_0014 = conj(N_d2)*e_em*m_tau*IT_0013*conj(U_stau_01);
    ...
    const ccomplex_t IT_0019 = IT_0008*IT_0011;
    const ccomplex_t IT_0020 = N_u2*e_em*V_Wp2;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = 2*IT_0021;
    const ccomplex_t IT_0023 = IT_0004*IT_0008;
    const ccomplex_t IT_0024 = N_B2*V_u2*e_em;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*IT_0025;
    const ccomplex_t IT_0027 = N_W2*V_u2*e_em;
    ...
    const ccomplex_t IT_0037 = m_tau*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0039 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
       0.5*m_N_4*(m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0040 = N_B4*e_em*conj(U_stau_01);
    const ccomplex_t IT_0041 = IT_0004*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = N_W4*e_em*conj(U_stau_01);
    const ccomplex_t IT_0044 = IT_0011*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = N_d4*e_em*m_tau*IT_0013*conj(U_stau_11);
    ...
    const ccomplex_t IT_0086 = N_d1*e_em*m_tau*IT_0013*conj(U_stau_11);
    ...
    const ccomplex_t IT_0134 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
       0.5*m_N_3*(m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0135 = IT_0108*IT_0133*IT_0134;
    const ccomplex_t IT_0136 = pow(m_C_2, 2);
    const ccomplex_t IT_0137 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0136 + (
      -0.5)*reg_prop + 0.5*m_snu_tau*(m_snu_tau + (0 + _Complex_I*-1)
      *Gamma_nutaul), -1);
    const ccomplex_t IT_0138 = sin(beta);
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*(A_tau*IT_0138*conj
      (U_stau_11) + (-1.4142135623731)*e_em*IT_0011*(m_W*IT_0008*IT_0138*conj
      (U_stau_01) + (-0.5)*m_tau*IT_0013*(m_tau*IT_0009*IT_0138*conj(U_stau_01) 
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0011;
    ...
    const ccomplex_t IT_0145 = conj(N_B1)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0146 = IT_0004*IT_0145;
    const ccomplex_t IT_0147 = 1.4142135623731*IT_0146;
    const ccomplex_t IT_0148 = conj(N_d1)*e_em*m_tau*IT_0013*conj(U_stau_01);
    ...
    const ccomplex_t IT_0169 = conj(N_B4)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0170 = IT_0004*IT_0169;
    const ccomplex_t IT_0171 = 1.4142135623731*IT_0170;
    const ccomplex_t IT_0172 = conj(N_d4)*e_em*m_tau*IT_0013*conj(U_stau_01);
    ...
    const ccomplex_t IT_0181 = 0.5*IT_0037 + (-0.5)*IT_0065 + (-0.5)*IT_0093 +
       (-0.5)*IT_0107 + (-0.5)*IT_0135 + (-0.5)*IT_0144 + 0.5*IT_0156 + 0.5
      *IT_0168 + 0.5*IT_0180;
    const ccomplex_t IT_0182 = IT_0011*IT_0138;
    ...
    const ccomplex_t IT_0186 = IT_0004*IT_0138;
    ...
    const ccomplex_t IT_0198 = IT_0002*IT_0094*IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_tau*IT_0009*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0204 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0205 = IT_0182*IT_0204;
    const ccomplex_t IT_0206 = 1.4142135623731*IT_0205;
    const ccomplex_t IT_0207 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0211 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0218 = IT_0066*IT_0092*IT_0217;
    const ccomplex_t IT_0219 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0220 = IT_0182*IT_0219;
    const ccomplex_t IT_0221 = (-2)*IT_0220;
    const ccomplex_t IT_0222 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0223 = IT_0186*IT_0222;
    const ccomplex_t IT_0224 = 1.4142135623731*IT_0223;
    const ccomplex_t IT_0225 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0226 = IT_0182*IT_0225;
    ...
    const ccomplex_t IT_0233 = IT_0038*IT_0039*IT_0232;
    const ccomplex_t IT_0234 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0235 = IT_0182*IT_0234;
    const ccomplex_t IT_0236 = (-2)*IT_0235;
    const ccomplex_t IT_0237 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0238 = IT_0186*IT_0237;
    const ccomplex_t IT_0239 = 1.4142135623731*IT_0238;
    const ccomplex_t IT_0240 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0248 = IT_0134*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = m_tau*IT_0249;
    const ccomplex_t IT_0251 = IT_0164*IT_0246;
    const ccomplex_t IT_0252 = IT_0108*IT_0134*IT_0251;
    const ccomplex_t IT_0253 = IT_0090*IT_0216;
    const ccomplex_t IT_0254 = IT_0092*IT_0253;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*IT_0254;
    const ccomplex_t IT_0256 = m_tau*IT_0255;
    const ccomplex_t IT_0257 = IT_0105*IT_0196;
    ...
    const ccomplex_t IT_0261 = IT_0050*IT_0231;
    ...
    const ccomplex_t IT_0265 = (-0.5)*IT_0198 + 0.5*IT_0203 + (-0.5)*IT_0218 +
       (-0.5)*IT_0233 + 0.5*IT_0250 + (-0.5)*IT_0252 + 0.5*IT_0256 + 0.5*IT_0260
       + 0.5*IT_0264;
    const ccomplex_t IT_0266 = m_C_2*m_tau;
    const ccomplex_t IT_0267 = 0.5*IT_0249 + 0.5*IT_0255 + 0.5*IT_0259 + 0.5
      *IT_0263;
    const ccomplex_t IT_0268 = s_23*m_C_2;
    const ccomplex_t IT_0269 = 0.5*IT_0036 + 0.5*IT_0155 + 0.5*IT_0167 + 0.5
      *IT_0179;
    const ccomplex_t IT_0270 = s_12*m_tau;
    const ccomplex_t IT_0271 = 2*s_13;
    const ccomplex_t IT_0272 = (-2)*IT_0265;
    const ccomplex_t IT_0273 = m_C_2*m_tau*IT_0001;
    const ccomplex_t IT_0274 = s_12*s_23;
    const ccomplex_t IT_0275 = s_13*IT_0001;
