        ...
        )
{
    ...
    const ccomplex_t IT_0022 = conj(N_B1)*e_em*conj(U_stau_11);
    ...
    const ccomplex_t IT_0048 = conj(N_d2)*e_em*m_tau*IT_0028*conj(U_stau_01);
    ...
    const ccomplex_t IT_0067 = conj(N_d3)*e_em*m_tau*IT_0028*conj(U_stau_01);
    ...
    const ccomplex_t IT_0082 = conj(N_B4)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0083 = IT_0021*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = conj(N_d4)*e_em*m_tau*IT_0028*conj(U_stau_01);
    ...
    const ccomplex_t IT_0186 = N_d4*e_em*m_tau*IT_0028*conj(U_stau_11);
