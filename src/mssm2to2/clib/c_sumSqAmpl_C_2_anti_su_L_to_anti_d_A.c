        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp2*IT_0004;
    ...
    const ccomplex_t IT_0014 = cpow((-2)*s_13 + IT_0000 + IT_0008 + -m_su_L*
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0004*IT_0026*IT_0028;
