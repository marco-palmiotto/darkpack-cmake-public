        ...
        )
{
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0012;
    ...
    const ccomplex_t IT_0085 = m_u*e_em*mu_h*IT_0012*IT_0016;
    const ccomplex_t IT_0086 = (-0.5)*IT_0085;
    const ccomplex_t IT_0087 = cpow(IT_0008, -1);
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0012*IT_0016*IT_0087;
    const ccomplex_t IT_0089 = 0.5*IT_0088;
    const ccomplex_t IT_0090 = IT_0086*IT_0089;
    const ccomplex_t IT_0091 = cpow((-2)*s_13 + IT_0002 + IT_0037 + -m_su_R*
    ...
    const ccomplex_t IT_0122 = m_d*s_14;
