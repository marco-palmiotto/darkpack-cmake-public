        ...
        )
{
    ...
    const ccomplex_t IT_0022 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0027 = IT_0011*(IT_0023 + IT_0026);
    ...
    const ccomplex_t IT_0037 = conj(U_d2)*conj(V_Wp2);
    const ccomplex_t IT_0038 = IT_0009*IT_0037;
    const ccomplex_t IT_0039 = conj(V_u2)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*e_em*(IT_0006*IT_0011
      *IT_0024*IT_0090*IT_0092 + 0.5*m_W*(IT_0007*IT_0009 + -IT_0024*IT_0091)*
