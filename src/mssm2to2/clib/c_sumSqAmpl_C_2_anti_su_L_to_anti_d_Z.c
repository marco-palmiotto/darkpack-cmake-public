        ...
        )
{
    ...
    const ccomplex_t IT_0027 = e_em*U_Wm2*conj(U_Wm2);
    ...
    const ccomplex_t IT_0036 = V_u2*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0044 = IT_0012*IT_0035*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0010 + IT_0011 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0013*IT_0015*IT_0017;
    ...
    const ccomplex_t IT_0069 = IT_0034 + IT_0044 + IT_0057 + IT_0068;
    const ccomplex_t IT_0070 = pow(m_C_2, 2);
    const ccomplex_t IT_0071 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0070 
      + -reg_prop, -1);
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp2*IT_0017;
    const ccomplex_t IT_0073 = -IT_0072;
    const ccomplex_t IT_0074 = e_em*IT_0022;
    const ccomplex_t IT_0075 = e_em*IT_0025;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*e_em*IT_0016*IT_0021;
    const ccomplex_t IT_0084 = 0.333333333333333*IT_0083;
    const ccomplex_t IT_0085 = IT_0073*IT_0084;
    const ccomplex_t IT_0086 = IT_0071*IT_0082*IT_0085;
    ...
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0017;
    const ccomplex_t IT_0091 = -IT_0090;
    const ccomplex_t IT_0092 = IT_0064*IT_0091;
    const ccomplex_t IT_0093 = IT_0045*IT_0046*IT_0092;
    const ccomplex_t IT_0094 = IT_0030*IT_0073;
    const ccomplex_t IT_0095 = IT_0012*IT_0035*IT_0094;
    const ccomplex_t IT_0096 = IT_0042*IT_0073;
    ...
    const ccomplex_t IT_0105 = IT_0019*IT_0084;
    const ccomplex_t IT_0106 = IT_0071*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = m_d*IT_0107;
    const ccomplex_t IT_0109 = IT_0019*IT_0077;
    const ccomplex_t IT_0110 = IT_0071*IT_0082*IT_0109;
    ...
    const ccomplex_t IT_0120 = (0 + _Complex_I*-3)*e_em*(IT_0017*IT_0020 + -1.
      /3*IT_0016*IT_0021);
    const ccomplex_t IT_0121 = 0.333333333333333*IT_0120;
    const ccomplex_t IT_0122 = cpow((-2)*s_13 + IT_0010 + IT_0070 + -m_su_L*
    ...
    const ccomplex_t IT_0126 = IT_0073*IT_0122;
    ...
    const ccomplex_t IT_0137 = (-2)*IT_0033 + (-2)*IT_0067;
    ...
    const ccomplex_t IT_0148 = 2*IT_0080 + IT_0128;
    const ccomplex_t IT_0149 = (-2)*IT_0107 + -IT_0125;
    const ccomplex_t IT_0150 = 6*IT_0137;
    const ccomplex_t IT_0151 = (-6)*IT_0125;
    const ccomplex_t IT_0152 = IT_0150 + IT_0151;
    const ccomplex_t IT_0153 = 6*conj(IT_0137);
    const ccomplex_t IT_0154 = (-6)*conj(IT_0125);
    ...
    const ccomplex_t IT_0160 = IT_0098 + IT_0102;
    const ccomplex_t IT_0161 = IT_0033 + IT_0067;
    const ccomplex_t IT_0162 = -IT_0107;
    const ccomplex_t IT_0163 = m_d*IT_0118;
    const ccomplex_t IT_0164 = m_d*IT_0146;
    const ccomplex_t IT_0165 = 6*IT_0148;
    const ccomplex_t IT_0166 = 6*conj(IT_0148);
    const ccomplex_t IT_0167 = 6*IT_0149;
    const ccomplex_t IT_0168 = 6*conj(IT_0149);
    ...
    const ccomplex_t IT_0174 = 6*IT_0069;
    const ccomplex_t IT_0175 = 6*conj(IT_0069);
    ...
    const ccomplex_t IT_0183 = (-6)*IT_0148;
    const ccomplex_t IT_0184 = (-6)*conj(IT_0148);
    ...
    const ccomplex_t IT_0192 = 6*conj(IT_0087);
    ...
    const ccomplex_t IT_0211 = (-6)*conj(IT_0069);
    ...
    const ccomplex_t IT_0222 = (-6)*IT_0149;
    const ccomplex_t IT_0223 = m_C_2*IT_0146;
    const ccomplex_t IT_0224 = (-6)*IT_0069;
    ...
    const ccomplex_t IT_0235 = 0.166666666666667*IT_0160;
    const ccomplex_t IT_0236 = (-6)*IT_0230;
    const ccomplex_t IT_0237 = IT_0232 + IT_0236;
    const ccomplex_t IT_0238 = 0.166666666666667*IT_0080;
    const ccomplex_t IT_0239 = 6*IT_0087;
    const ccomplex_t IT_0240 = IT_0174 + IT_0239;
    const ccomplex_t IT_0241 = 0.166666666666667*IT_0191;
    const ccomplex_t IT_0242 = 6*IT_0104;
    const ccomplex_t IT_0243 = 6*IT_0111;
    const ccomplex_t IT_0244 = IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = 0.166666666666667*IT_0199;
    const ccomplex_t IT_0246 = 0.166666666666667*IT_0206;
    const ccomplex_t IT_0247 = (-6)*IT_0087;
    const ccomplex_t IT_0248 = IT_0224 + IT_0247;
    const ccomplex_t IT_0249 = 0.166666666666667*IT_0210;
    const ccomplex_t IT_0250 = (-6)*IT_0104;
    const ccomplex_t IT_0251 = (-6)*IT_0111;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = 0.166666666666667*IT_0217;
    const ccomplex_t IT_0254 = 0.166666666666667*IT_0161;
    const ccomplex_t IT_0255 = 0.166666666666667*IT_0162;
    const ccomplex_t IT_0256 = IT_0222*IT_0246;
    const ccomplex_t IT_0257 = (-6)*conj(IT_0149);
    const ccomplex_t IT_0258 = IT_0206*IT_0257;
    const ccomplex_t IT_0259 = IT_0009*(IT_0088*IT_0089 + IT_0112*IT_0113) +
      ...
      + IT_0137*IT_0143) + IT_0147*(IT_0143*IT_0148 + IT_0140*conj(IT_0148) +
       conj(IT_0149)*IT_0152 + IT_0149*IT_0155) + IT_0159*(IT_0143*(IT_0080 +
       IT_0160) + IT_0140*(conj(IT_0080) + conj(IT_0160)) + IT_0155*(IT_0161 +
       IT_0162) + IT_0152*(conj(IT_0161) + conj(IT_0162))) + (IT_0089*IT_0140 +
       IT_0088*IT_0143 + IT_0113*IT_0152 + IT_0112*IT_0155)*IT_0163 + IT_0164*
      (IT_0089*IT_0165 + IT_0088*IT_0166 + IT_0113*IT_0167 + IT_0112*IT_0168) +
       IT_0173*(IT_0113*IT_0165 + IT_0112*IT_0166 + conj(IT_0087)*IT_0167 +
       IT_0087*IT_0168 + conj(IT_0149)*IT_0174 + IT_0149*IT_0175) + IT_0114*
      (IT_0088*((-18)*conj(IT_0104) + (-18)*conj(IT_0111)) + IT_0112*((-18)*conj
      (IT_0087) + IT_0176)) + IT_0177*(conj(IT_0129)*IT_0133 + IT_0129*IT_0135 +
       conj(IT_0131)*IT_0138 + conj(IT_0137)*IT_0150 + conj(IT_0125)*IT_0180 +
       IT_0125*IT_0181) + IT_0182*(IT_0143*IT_0149 + IT_0140*conj(IT_0149) +
       conj(IT_0137)*IT_0165 + IT_0137*IT_0166 + conj(IT_0125)*IT_0183 + IT_0125
      *IT_0184) + (conj(IT_0149)*IT_0183 + IT_0149*IT_0184)*IT_0185 + IT_0160*
      (IT_0191*IT_0193 + IT_0199*IT_0202 + IT_0184*IT_0206) + IT_0080*(IT_0184
      *IT_0206 + IT_0210*IT_0213 + IT_0217*IT_0220) + IT_0221*(conj(IT_0148)
      *IT_0183 + conj(IT_0149)*IT_0222) + IT_0223*(IT_0113*IT_0133 + IT_0112
      *IT_0136 + 6*conj(IT_0125)*(IT_0087 + 0.166666666666667*IT_0174) + IT_0125
      *IT_0175 + conj(IT_0087)*IT_0180 + IT_0087*IT_0181 + IT_0137*IT_0211 +
       conj(IT_0137)*IT_0224) + 6*conj(IT_0160)*(IT_0161*IT_0226 + -IT_0162
      *IT_0227 + IT_0234*IT_0235 + IT_0237*IT_0238 + IT_0240*IT_0241 + IT_0244
      *IT_0245 + IT_0183*IT_0246) + 6*conj(IT_0080)*(IT_0162*IT_0226 + -IT_0161
      *IT_0227 + IT_0235*IT_0237 + IT_0234*IT_0238 + IT_0183*IT_0246 + IT_0248
      *IT_0249 + IT_0252*IT_0253) + 6*conj(IT_0162)*(IT_0080*IT_0226 + -IT_0160
      *IT_0227 + IT_0249*IT_0252 + IT_0248*IT_0253 + IT_0237*IT_0254 + IT_0234
      *IT_0255 + IT_0256) + 6*conj(IT_0161)*(IT_0160*IT_0226 + -IT_0080*IT_0227 
      + IT_0241*IT_0244 + IT_0240*IT_0245 + IT_0234*IT_0254 + IT_0237*IT_0255 +
       IT_0256) + IT_0161*(IT_0193*IT_0199 + IT_0191*IT_0202 + IT_0258) +
       IT_0162*(IT_0213*IT_0217 + IT_0210*IT_0220 + IT_0258);
