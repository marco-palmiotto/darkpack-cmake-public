        ...
        )
{
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + IT_0002 + -IT_0003 + -IT_0040 
      + -reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_d*e_em*IT_0008*IT_0012
      *IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0056 = conj(V_u1)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*e_em*(IT_0005*IT_0012
      *IT_0017*IT_0082*IT_0084 + (-0.5)*m_W*(IT_0008*IT_0018 + IT_0005*IT_0083)*
    ...
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0008
