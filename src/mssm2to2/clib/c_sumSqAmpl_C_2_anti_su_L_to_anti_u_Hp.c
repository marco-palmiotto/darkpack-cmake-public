        ...
        )
{
    ...
    const ccomplex_t IT_0006 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0007 = cos(beta);
    const ccomplex_t IT_0008 = cpow(IT_0007, -1);
    const ccomplex_t IT_0009 = sin(beta);
    const ccomplex_t IT_0010 = sin(theta_W);
    const ccomplex_t IT_0011 = cpow(IT_0010, -1);
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_b*e_em
      *IT_0005*IT_0006*IT_0008*IT_0009*IT_0011*V_ub_mod;
    const ccomplex_t IT_0013 = 0.5*IT_0012;
    const ccomplex_t IT_0014 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*e_em*V_Wp2*IT_0011*IT_0014
      *V_ub_mod;
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + IT_0019 
      + -reg_prop, -1);
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp2*IT_0011;
    const ccomplex_t IT_0023 = -IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0005*IT_0008*IT_0009*IT_0011;
    const ccomplex_t IT_0025 = 0.5*IT_0024;
    const ccomplex_t IT_0026 = IT_0023*IT_0025;
    const ccomplex_t IT_0027 = IT_0020*IT_0021*IT_0026;
    const ccomplex_t IT_0028 = pow(m_s, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + IT_0028 
      + -reg_prop, -1);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*V_us*e_em*V_Wp2*IT_0011;
    const ccomplex_t IT_0032 = -IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *IT_0005*IT_0008*IT_0009*IT_0011;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = IT_0032*IT_0034;
    const ccomplex_t IT_0036 = IT_0029*IT_0030*IT_0035;
    const ccomplex_t IT_0037 = cpow(IT_0009, -1);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0005*IT_0011*IT_0037;
    const ccomplex_t IT_0039 = (-0.5)*IT_0038;
    const ccomplex_t IT_0040 = IT_0007*IT_0011;
    const ccomplex_t IT_0041 = N_u1*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0058 = pow(m_u, 2);
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0002 + IT_0058 + -m_N_1*
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *e_em*IT_0005*IT_0008*IT_0011*IT_0014*V_ub_mod;
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0005*IT_0008*IT_0011;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_us*e_em*IT_0005*IT_0008*IT_0011;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0082 = N_B1*e_em;
    const ccomplex_t IT_0083 = IT_0045*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = N_W1*e_em;
    ...
    const ccomplex_t IT_0101 = N_u3*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0115 = cpow((-2)*s_23 + IT_0002 + IT_0058 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0116 = IT_0092*IT_0114*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0118 = cpow((-2)*s_23 + IT_0002 + IT_0058 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0119 = N_B4*e_em;
    const ccomplex_t IT_0120 = IT_0045*IT_0119;
    ...
    const ccomplex_t IT_0158 = cpow((-2)*s_23 + IT_0002 + IT_0058 + -m_N_2*
    ...
    const ccomplex_t IT_0165 = IT_0115*IT_0164;
    ...
    const ccomplex_t IT_0170 = IT_0045*IT_0169;
    ...
    const ccomplex_t IT_0178 = IT_0158*IT_0168*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0005*IT_0011*IT_0037;
    ...
    const ccomplex_t IT_0185 = -IT_0018 + -IT_0027 + -IT_0036 + -IT_0062 +
       IT_0068 + IT_0074 + IT_0080 + IT_0091 + IT_0116 + IT_0141 + -IT_0161 + 
      -IT_0167 + IT_0178 + -IT_0184;
    const ccomplex_t IT_0186 = IT_0009*IT_0011;
    const ccomplex_t IT_0187 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0188 = IT_0186*IT_0187;
    const ccomplex_t IT_0189 = 1.4142135623731*IT_0188;
    const ccomplex_t IT_0190 = IT_0009*IT_0045;
    const ccomplex_t IT_0191 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0195 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0202 = IT_0059*IT_0081*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0005*IT_0006*IT_0007*IT_0011*IT_0037*V_ub_mod;
    const ccomplex_t IT_0204 = 0.5*IT_0203;
    const ccomplex_t IT_0205 = IT_0064*IT_0204;
    const ccomplex_t IT_0206 = IT_0003*IT_0004*IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0005*IT_0007*IT_0011*IT_0037;
    const ccomplex_t IT_0208 = 0.5*IT_0207;
    const ccomplex_t IT_0209 = IT_0070*IT_0208;
    const ccomplex_t IT_0210 = IT_0020*IT_0021*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0005*IT_0007*IT_0011*IT_0037;
    const ccomplex_t IT_0212 = 0.5*IT_0211;
    const ccomplex_t IT_0213 = IT_0076*IT_0212;
    const ccomplex_t IT_0214 = IT_0029*IT_0030*IT_0213;
    const ccomplex_t IT_0215 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0216 = IT_0186*IT_0215;
    const ccomplex_t IT_0217 = (-2)*IT_0216;
    const ccomplex_t IT_0218 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0219 = IT_0190*IT_0218;
    const ccomplex_t IT_0220 = 1.4142135623731*IT_0219;
    const ccomplex_t IT_0221 = conj(N_W2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0222 = IT_0186*IT_0221;
    ...
    const ccomplex_t IT_0228 = IT_0176*IT_0227;
    const ccomplex_t IT_0229 = IT_0158*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = m_u*IT_0230;
    const ccomplex_t IT_0232 = IT_0016*IT_0204;
    ...
    const ccomplex_t IT_0236 = IT_0143*IT_0227;
    const ccomplex_t IT_0237 = IT_0158*IT_0168*IT_0236;
    const ccomplex_t IT_0238 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0239 = IT_0186*IT_0238;
    const ccomplex_t IT_0240 = (-2)*IT_0239;
    const ccomplex_t IT_0241 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0242 = IT_0190*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = conj(N_W3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0245 = IT_0186*IT_0244;
    ...
    const ccomplex_t IT_0251 = IT_0163*IT_0250;
    const ccomplex_t IT_0252 = IT_0092*IT_0115*IT_0251;
    const ccomplex_t IT_0253 = IT_0100*IT_0250;
    const ccomplex_t IT_0254 = IT_0115*IT_0253;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*IT_0254;
    const ccomplex_t IT_0256 = m_u*IT_0255;
    ...
    const ccomplex_t IT_0270 = IT_0180*IT_0269;
    const ccomplex_t IT_0271 = IT_0117*IT_0118*IT_0270;
    const ccomplex_t IT_0272 = IT_0089*IT_0200;
    const ccomplex_t IT_0273 = IT_0059*IT_0272;
    const ccomplex_t IT_0274 = (0 + _Complex_I*1)*IT_0273;
    const ccomplex_t IT_0275 = m_u*IT_0274;
    const ccomplex_t IT_0276 = IT_0126*IT_0269;
    const ccomplex_t IT_0277 = IT_0118*IT_0276;
    const ccomplex_t IT_0278 = (0 + _Complex_I*1)*IT_0277;
    const ccomplex_t IT_0279 = m_u*IT_0278;
    const ccomplex_t IT_0280 = IT_0023*IT_0208;
    ...
    const ccomplex_t IT_0284 = IT_0032*IT_0212;
    const ccomplex_t IT_0285 = IT_0029*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*IT_0285;
    const ccomplex_t IT_0287 = m_C_2*IT_0286;
    const ccomplex_t IT_0288 = IT_0202 + IT_0206 + IT_0210 + IT_0214 + 
      -IT_0231 + -IT_0235 + IT_0237 + IT_0252 + -IT_0256 + IT_0271 + -IT_0275 + 
      -IT_0279 + -IT_0283 + -IT_0287;
    const ccomplex_t IT_0289 = m_u*m_C_2;
    const ccomplex_t IT_0290 = -IT_0067 + -IT_0073 + -IT_0079 + -IT_0230 + 
      -IT_0255 + -IT_0274 + -IT_0278;
    const ccomplex_t IT_0291 = s_23*m_C_2;
    const ccomplex_t IT_0292 = -IT_0061 + -IT_0160 + -IT_0166 + -IT_0183 +
       IT_0234 + IT_0282 + IT_0286;
    const ccomplex_t IT_0293 = m_u*s_12;
    const ccomplex_t IT_0294 = 6*s_13;
    const ccomplex_t IT_0295 = (-6)*IT_0288;
    const ccomplex_t IT_0296 = m_u*m_C_2*IT_0002;
    const ccomplex_t IT_0297 = s_13*IT_0002;
