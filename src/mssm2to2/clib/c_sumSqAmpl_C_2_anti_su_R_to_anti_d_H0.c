...
ccomplex_return_t c_sumSqAmpl_C_2_anti_su_R_to_anti_d_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = conj(V_u1)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*-1)*e_em*(m_W*IT_0003*(IT_0001
      *IT_0010 + -IT_0007*IT_0038)*IT_0062 + (-1.5)*IT_0000*IT_0002*IT_0004
      *IT_0010*IT_0063);
    ...
    const ccomplex_t IT_0071 = U_d2*V_Wp2;
    const ccomplex_t IT_0072 = IT_0007*IT_0071;
    const ccomplex_t IT_0073 = V_u2*U_Wm2;
    ...
    const ccomplex_t IT_0082 = U_d1*V_Wp2;
    const ccomplex_t IT_0083 = IT_0007*IT_0082;
    const ccomplex_t IT_0084 = V_u2*U_Wm1;
