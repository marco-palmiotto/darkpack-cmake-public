        ...
        )
{
    ...
    const ccomplex_t IT_0003 = cpow((-2)*s_13 + IT_0001 + IT_0002 + -m_sb_2*
    ...
    const ccomplex_t IT_0011 = m_b*conj(U_d2)*V_tb*e_em*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_13 + IT_0001 + IT_0002 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_00);
    const ccomplex_t IT_0023 = m_b*conj(U_d2)*V_tb*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0024 = IT_0009*IT_0023;
    const ccomplex_t IT_0025 = 1.4142135623731*IT_0024;
    const ccomplex_t IT_0026 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    ...
    const ccomplex_t IT_0125 = m_sG*s_34*m_C_2;
    ...
    const ccomplex_t IT_0133 = 8*IT_0071;
    const ccomplex_t IT_0134 = 8*conj(IT_0071);
    const ccomplex_t IT_0135 = IT_0053*IT_0084;
    const ccomplex_t IT_0136 = IT_0055*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*IT_0136;
    const ccomplex_t IT_0138 = IT_0045*IT_0099;
    ...
    const ccomplex_t IT_0142 = 8*IT_0141;
    const ccomplex_t IT_0143 = 8*conj(IT_0141);
    const ccomplex_t IT_0144 = 16*IT_0071;
    const ccomplex_t IT_0145 = m_t*s_24*m_C_2;
    const ccomplex_t IT_0146 = 16*conj(IT_0071);
    const ccomplex_t IT_0147 = m_b*m_t*m_sG*m_C_2;
    const ccomplex_t IT_0148 = 16*IT_0103;
    const ccomplex_t IT_0149 = IT_0123 + IT_0148;
    const ccomplex_t IT_0150 = 16*conj(IT_0103);
    const ccomplex_t IT_0151 = IT_0124 + IT_0150;
    const ccomplex_t IT_0152 = 16*IT_0141;
    const ccomplex_t IT_0153 = 16*conj(IT_0141);
    const ccomplex_t IT_0154 = m_b*s_23*m_C_2;
    const ccomplex_t IT_0155 = 16*IT_0132;
    const ccomplex_t IT_0156 = m_t*m_sG*s_14;
    const ccomplex_t IT_0157 = 0.125*IT_0141;
    const ccomplex_t IT_0158 = 0.125*conj(IT_0141);
    const ccomplex_t IT_0159 = m_b*m_t*s_12;
    const ccomplex_t IT_0160 = IT_0000*(16*conj(IT_0033)*IT_0042 + IT_0033*(16
      *conj(IT_0042) + 8*conj(IT_0058)) + conj(IT_0071)*IT_0113 + IT_0071
      *IT_0116 + IT_0058*IT_0117) + 8*IT_0122*(conj(IT_0042)*IT_0058 + IT_0042
      *conj(IT_0058) + 0.125*conj(IT_0103)*IT_0123 + 0.125*IT_0103*IT_0124) +
       IT_0125*(conj(IT_0132)*IT_0133 + IT_0132*IT_0134 + conj(IT_0033)*IT_0142 
      + IT_0033*IT_0143) + IT_0118*(16*IT_0033*conj(IT_0033) + 16*IT_0042*conj
      (IT_0042) + conj(IT_0111)*IT_0112 + conj(IT_0071)*IT_0144) + IT_0145*(conj
      (IT_0033)*IT_0113 + IT_0033*IT_0116 + conj(IT_0058)*IT_0133 + IT_0058
      *IT_0134 + conj(IT_0042)*IT_0144 + IT_0042*IT_0146) + IT_0147*(conj
      (IT_0042)*IT_0113 + IT_0042*IT_0116 + conj(IT_0033)*IT_0144 + IT_0033
      *IT_0146 + conj(IT_0058)*IT_0149 + IT_0058*IT_0151 + conj(IT_0132)*IT_0152
       + IT_0132*IT_0153) + (conj(IT_0042)*IT_0142 + IT_0042*IT_0143 + conj
      (IT_0132)*IT_0149 + IT_0132*IT_0151 + conj(IT_0058)*IT_0152 + IT_0058
      *IT_0153)*IT_0154 + IT_0119*(16*IT_0058*conj(IT_0058) + conj(IT_0103)
      *IT_0148 + conj(IT_0141)*IT_0152 + conj(IT_0132)*IT_0155) + 8*IT_0156*
      (conj(IT_0042)*IT_0132 + (IT_0042 + 2*IT_0058)*conj(IT_0132) + 0.125*conj
      (IT_0058)*IT_0155 + IT_0151*IT_0157 + IT_0149*IT_0158) + 8*(0.125*IT_0117
      *IT_0132 + IT_0033*conj(IT_0132) + IT_0134*IT_0157 + IT_0133*IT_0158)
      *IT_0159;
