...
ccomplex_return_t c_sumSqAmpl_C_2_sb_1_to_b_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_u1*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0013 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0014 = IT_0012*IT_0013;
    const ccomplex_t IT_0015 = 1.4142135623731*IT_0014;
    const ccomplex_t IT_0016 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
    ...
    const ccomplex_t IT_0055 = m_b*conj(N_d2)*e_em*IT_0025*U_sb_10;
    const ccomplex_t IT_0056 = IT_0024*IT_0055;
    const ccomplex_t IT_0057 = 1.4142135623731*IT_0056;
    const ccomplex_t IT_0058 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0059 = IT_0011*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = conj(N_W2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0071 = N_u3*e_em*V_Wp2;
    const ccomplex_t IT_0072 = IT_0006*IT_0071;
    const ccomplex_t IT_0073 = 2*IT_0072;
    const ccomplex_t IT_0074 = N_B3*V_u2*e_em;
    const ccomplex_t IT_0075 = IT_0012*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*IT_0075;
    const ccomplex_t IT_0077 = N_W3*V_u2*e_em;
    ...
    const ccomplex_t IT_0084 = m_b*conj(N_d3)*e_em*IT_0025*U_sb_10;
    const ccomplex_t IT_0085 = IT_0024*IT_0084;
    const ccomplex_t IT_0086 = 1.4142135623731*IT_0085;
    const ccomplex_t IT_0087 = conj(N_B3)*e_em*U_sb_00;
    const ccomplex_t IT_0088 = IT_0011*IT_0087;
    const ccomplex_t IT_0089 = 1.4142135623731*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0091 = IT_0005*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*(IT_0086 + 0.333333333333333
      *IT_0089 + -IT_0092);
    ...
    const ccomplex_t IT_0099 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0100 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0101 = IT_0006*IT_0100;
    const ccomplex_t IT_0102 = 2*IT_0101;
    const ccomplex_t IT_0103 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0104 = IT_0012*IT_0103;
    const ccomplex_t IT_0105 = 1.4142135623731*IT_0104;
    const ccomplex_t IT_0106 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0113 = m_b*conj(N_d4)*e_em*IT_0025*U_sb_10;
    const ccomplex_t IT_0114 = IT_0024*IT_0113;
    ...
    const ccomplex_t IT_0119 = conj(N_W4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0128 = pow(m_c, 2);
    const ccomplex_t IT_0129 = pow(m_C_2, 2);
    const ccomplex_t IT_0130 = cpow((-2)*s_12 + -IT_0001 + IT_0128 + -IT_0129 
      + -reg_prop, -1);
    const ccomplex_t IT_0131 = sin(beta);
    const ccomplex_t IT_0132 = cpow(IT_0131, -1);
    const ccomplex_t IT_0133 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0003*IT_0005*IT_0025*IT_0132;
    const ccomplex_t IT_0134 = 0.5*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0005*IT_0025*IT_0132*U_sb_00;
    ...
    const ccomplex_t IT_0140 = cpow((-2)*s_12 + -IT_0001 + -IT_0129 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0003*IT_0005*IT_0025*IT_0132;
    ...
    const ccomplex_t IT_0148 = pow(m_u, 2);
    const ccomplex_t IT_0149 = cpow((-2)*s_12 + -IT_0001 + -IT_0129 + IT_0148 
      + -reg_prop, -1);
    const ccomplex_t IT_0150 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0151 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0003*IT_0005*IT_0025*IT_0132*IT_0150*V_ub_mod;
    const ccomplex_t IT_0152 = 0.5*IT_0151;
    const ccomplex_t IT_0153 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0005*IT_0025*IT_0132*IT_0153*U_sb_00*V_ub_mod;
    ...
    const ccomplex_t IT_0159 = -IT_0040 + -IT_0069 + -IT_0098 + -IT_0127 + 
      -IT_0139 + -IT_0147 + -IT_0158;
    const ccomplex_t IT_0160 = m_b*m_C_2*IT_0001;
    const ccomplex_t IT_0161 = IT_0005*IT_0131;
    ...
    const ccomplex_t IT_0165 = IT_0011*IT_0131;
    ...
    const ccomplex_t IT_0169 = IT_0164 + IT_0168;
    ...
    const ccomplex_t IT_0176 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0177 = IT_0011*IT_0176;
    const ccomplex_t IT_0178 = 1.4142135623731*IT_0177;
    const ccomplex_t IT_0179 = m_b*N_d1*e_em*IT_0025*U_sb_00;
    const ccomplex_t IT_0180 = IT_0024*IT_0179;
    ...
    const ccomplex_t IT_0187 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0188 = IT_0161*IT_0187;
    const ccomplex_t IT_0189 = (-2)*IT_0188;
    const ccomplex_t IT_0190 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0191 = IT_0165*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0194 = IT_0161*IT_0193;
    ...
    const ccomplex_t IT_0203 = m_b*N_d4*e_em*IT_0025*U_sb_00;
    ...
    const ccomplex_t IT_0211 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0212 = IT_0161*IT_0211;
    const ccomplex_t IT_0213 = (-2)*IT_0212;
    const ccomplex_t IT_0214 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0215 = IT_0165*IT_0214;
    const ccomplex_t IT_0216 = 1.4142135623731*IT_0215;
    const ccomplex_t IT_0217 = conj(N_W2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0218 = IT_0161*IT_0217;
    ...
    const ccomplex_t IT_0224 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0225 = IT_0011*IT_0224;
    const ccomplex_t IT_0226 = 1.4142135623731*IT_0225;
    const ccomplex_t IT_0227 = m_b*N_d2*e_em*IT_0025*U_sb_00;
    ...
    const ccomplex_t IT_0248 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0249 = IT_0011*IT_0248;
    const ccomplex_t IT_0250 = 1.4142135623731*IT_0249;
    const ccomplex_t IT_0251 = m_b*N_d3*e_em*IT_0025*U_sb_00;
    const ccomplex_t IT_0252 = IT_0024*IT_0251;
    const ccomplex_t IT_0253 = 1.4142135623731*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*(IT_0250 + 1.5*IT_0253);
    const ccomplex_t IT_0255 = (-0.333333333333333)*IT_0254;
    const ccomplex_t IT_0256 = IT_0247*IT_0255;
    const ccomplex_t IT_0257 = IT_0070*IT_0256;
    const ccomplex_t IT_0258 = (0 + _Complex_I*1)*IT_0257;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0005*IT_0023*IT_0025*IT_0131;
    const ccomplex_t IT_0260 = 0.5*IT_0259;
    const ccomplex_t IT_0261 = m_b*conj(U_d2)*V_cb*e_em*IT_0025*U_sb_10;
    const ccomplex_t IT_0262 = IT_0024*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = V_cb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0265 = IT_0005*IT_0264;
    const ccomplex_t IT_0266 = (0 + _Complex_I*1)*(IT_0263 + (-2)*IT_0265);
    const ccomplex_t IT_0267 = (-0.5)*IT_0266;
    const ccomplex_t IT_0268 = IT_0260*IT_0267;
    const ccomplex_t IT_0269 = IT_0130*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0005*IT_0023*IT_0025*IT_0131;
    const ccomplex_t IT_0272 = 0.5*IT_0271;
    const ccomplex_t IT_0273 = m_b*conj(U_d2)*V_tb*e_em*IT_0025*U_sb_10;
    const ccomplex_t IT_0274 = IT_0024*IT_0273;
    const ccomplex_t IT_0275 = 1.4142135623731*IT_0274;
    const ccomplex_t IT_0276 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0277 = IT_0005*IT_0276;
    const ccomplex_t IT_0278 = (0 + _Complex_I*1)*(IT_0275 + (-2)*IT_0277);
    const ccomplex_t IT_0279 = (-0.5)*IT_0278;
    const ccomplex_t IT_0280 = IT_0272*IT_0279;
    const ccomplex_t IT_0281 = IT_0140*IT_0280;
    const ccomplex_t IT_0282 = (0 + _Complex_I*1)*IT_0281;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1.4142135623731)*m_b*e_em
      *IT_0005*IT_0023*IT_0025*IT_0131*IT_0150*V_ub_mod;
    const ccomplex_t IT_0284 = 0.5*IT_0283;
    const ccomplex_t IT_0285 = IT_0005*IT_0153;
    const ccomplex_t IT_0286 = e_em*conj(U_Wm2)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0287 = IT_0285*IT_0286;
    const ccomplex_t IT_0288 = IT_0005*IT_0023*IT_0153;
    const ccomplex_t IT_0289 = m_b*conj(U_d2)*e_em*IT_0025*U_sb_10*V_ub_mod;
    const ccomplex_t IT_0290 = IT_0288*IT_0289;
    const ccomplex_t IT_0291 = 1.4142135623731*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*(IT_0287 + (-0.5)*IT_0291);
    const ccomplex_t IT_0293 = IT_0284*IT_0292;
    const ccomplex_t IT_0294 = IT_0149*IT_0293;
    const ccomplex_t IT_0295 = (0 + _Complex_I*1)*IT_0294;
    const ccomplex_t IT_0296 = -IT_0186 + -IT_0210 + -IT_0234 + -IT_0258 +
       IT_0270 + IT_0282 + IT_0295;
    const ccomplex_t IT_0297 = m_b*s_12;
    const ccomplex_t IT_0298 = 6*IT_0297;
    const ccomplex_t IT_0299 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0300 = IT_0112*IT_0207;
    const ccomplex_t IT_0301 = IT_0099*IT_0299*IT_0300;
    const ccomplex_t IT_0302 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0303 = IT_0136*IT_0260;
    const ccomplex_t IT_0304 = IT_0130*IT_0302*IT_0303;
    const ccomplex_t IT_0305 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0306 = IT_0022*IT_0183;
    const ccomplex_t IT_0307 = IT_0002*IT_0305*IT_0306;
    const ccomplex_t IT_0308 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0309 = IT_0054*IT_0231;
    const ccomplex_t IT_0310 = IT_0041*IT_0308*IT_0309;
    const ccomplex_t IT_0311 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0312 = IT_0083*IT_0255;
    const ccomplex_t IT_0313 = IT_0070*IT_0311*IT_0312;
    const ccomplex_t IT_0314 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0315 = IT_0144*IT_0272;
    const ccomplex_t IT_0316 = IT_0140*IT_0314*IT_0315;
    const ccomplex_t IT_0317 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0318 = IT_0155*IT_0284;
    const ccomplex_t IT_0319 = IT_0149*IT_0317*IT_0318;
    const ccomplex_t IT_0320 = m_b*IT_0040;
    const ccomplex_t IT_0321 = m_b*IT_0069;
    const ccomplex_t IT_0322 = m_b*IT_0098;
    const ccomplex_t IT_0323 = m_b*IT_0127;
    const ccomplex_t IT_0324 = (0 + _Complex_I*1)*((-0.5)*IT_0263 + IT_0265);
    const ccomplex_t IT_0325 = IT_0260*IT_0324;
    const ccomplex_t IT_0326 = IT_0130*IT_0325;
    const ccomplex_t IT_0327 = (0 + _Complex_I*1)*IT_0326;
    const ccomplex_t IT_0328 = m_C_2*IT_0327;
    const ccomplex_t IT_0329 = m_C_2*IT_0282;
    const ccomplex_t IT_0330 = m_C_2*IT_0295;
    const ccomplex_t IT_0331 = -IT_0301 + -IT_0304 + -IT_0307 + -IT_0310 + 
      -IT_0313 + -IT_0316 + -IT_0319 + IT_0320 + IT_0321 + IT_0322 + IT_0323 +
       IT_0328 + IT_0329 + IT_0330;
    const ccomplex_t IT_0332 = 0.166666666666667*conj(IT_0331);
    const ccomplex_t IT_0333 = s_23*m_C_2;
    const ccomplex_t IT_0334 = 6*IT_0333;
    const ccomplex_t IT_0335 = m_b*IT_0258;
    const ccomplex_t IT_0336 = IT_0134*IT_0324;
    const ccomplex_t IT_0337 = IT_0130*IT_0302*IT_0336;
    const ccomplex_t IT_0338 = IT_0152*IT_0292;
    const ccomplex_t IT_0339 = IT_0149*IT_0317*IT_0338;
    const ccomplex_t IT_0340 = IT_0142*IT_0279;
    const ccomplex_t IT_0341 = IT_0140*IT_0314*IT_0340;
    const ccomplex_t IT_0342 = IT_0037*IT_0175;
    const ccomplex_t IT_0343 = IT_0002*IT_0305*IT_0342;
    const ccomplex_t IT_0344 = IT_0066*IT_0223;
    const ccomplex_t IT_0345 = IT_0041*IT_0308*IT_0344;
    const ccomplex_t IT_0346 = IT_0095*IT_0247;
    const ccomplex_t IT_0347 = IT_0070*IT_0311*IT_0346;
    const ccomplex_t IT_0348 = IT_0124*IT_0199;
    const ccomplex_t IT_0349 = IT_0099*IT_0299*IT_0348;
    const ccomplex_t IT_0350 = m_b*IT_0186;
    const ccomplex_t IT_0351 = m_b*IT_0234;
    const ccomplex_t IT_0352 = m_b*IT_0210;
    const ccomplex_t IT_0353 = m_C_2*IT_0139;
    const ccomplex_t IT_0354 = m_C_2*IT_0147;
    const ccomplex_t IT_0355 = m_C_2*IT_0158;
    const ccomplex_t IT_0356 = IT_0335 + IT_0337 + IT_0339 + IT_0341 + 
      -IT_0343 + -IT_0345 + -IT_0347 + -IT_0349 + IT_0350 + IT_0351 + IT_0352 + 
      -IT_0353 + -IT_0354 + -IT_0355;
    const ccomplex_t IT_0357 = 0.166666666666667*conj(IT_0356);
    const ccomplex_t IT_0358 = s_13*IT_0001;
    const ccomplex_t IT_0359 = (-6)*IT_0358;
    const ccomplex_t IT_0360 = s_12*s_23;
    const ccomplex_t IT_0361 = 12*IT_0360;
    const ccomplex_t IT_0362 = IT_0359 + IT_0361;
    const ccomplex_t IT_0363 = 0.166666666666667*conj(IT_0159);
    const ccomplex_t IT_0364 = 0.166666666666667*conj(IT_0296);
    const ccomplex_t IT_0365 = m_b*m_C_2;
    const ccomplex_t IT_0366 = 6*IT_0365;
    const ccomplex_t IT_0367 = 6*IT_0159*(IT_0160*conj(IT_0296) + IT_0298
      *IT_0332 + IT_0334*IT_0357 + IT_0362*IT_0363) + 6*IT_0296*(conj(IT_0159)
      *IT_0160 + IT_0332*IT_0334 + IT_0298*IT_0357 + IT_0362*IT_0364) + 6
      *IT_0356*(s_13*conj(IT_0356) + IT_0334*IT_0363 + IT_0298*IT_0364 + IT_0332
      *IT_0366) + 6*IT_0331*(s_13*conj(IT_0331) + IT_0298*IT_0363 + IT_0334
      *IT_0364 + IT_0357*IT_0366);
