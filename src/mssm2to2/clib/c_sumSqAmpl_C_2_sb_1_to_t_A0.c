...
ccomplex_return_t c_sumSqAmpl_C_2_sb_1_to_t_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = V_u2*U_Wm2;
    const ccomplex_t IT_0005 = IT_0003*IT_0004;
    const ccomplex_t IT_0006 = sin(beta);
    const ccomplex_t IT_0007 = U_d2*V_Wp2;
    ...
    const ccomplex_t IT_0031 = IT_0010*(IT_0028 + IT_0030);
    const ccomplex_t IT_0032 = 1.4142135623731*e_em*IT_0031;
    const ccomplex_t IT_0033 = 0.5*IT_0032;
    const ccomplex_t IT_0034 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0035 = IT_0010*IT_0034;
    const ccomplex_t IT_0036 = m_b*conj(U_d1)*V_tb*e_em*IT_0016*U_sb_10;
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = pow(m_C_2, 2);
    const ccomplex_t IT_0045 = cpow((-2)*s_12 + -IT_0001 + -IT_0044 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0046 = cpow(IT_0006, -1);
    const ccomplex_t IT_0047 = m_t*e_em*IT_0003*IT_0010*IT_0016*IT_0046;
    const ccomplex_t IT_0048 = (-0.5)*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0010*IT_0016*IT_0046*U_sb_00;
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = IT_0048*IT_0050;
    const ccomplex_t IT_0052 = IT_0045*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = -IT_0026 + -IT_0043 + -IT_0053;
    const ccomplex_t IT_0055 = pow(m_A0, 2);
    const ccomplex_t IT_0056 = m_t*m_C_2*IT_0055;
    const ccomplex_t IT_0057 = IT_0023*IT_0048;
    const ccomplex_t IT_0058 = IT_0045*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0061 = IT_0003*IT_0060;
    const ccomplex_t IT_0062 = conj(U_d2)*conj(V_Wp2);
    const ccomplex_t IT_0063 = IT_0006*IT_0062;
    const ccomplex_t IT_0064 = IT_0010*(IT_0061 + IT_0063);
    ...
    const ccomplex_t IT_0070 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0071 = IT_0003*IT_0070;
    const ccomplex_t IT_0072 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0010*IT_0016*IT_0046*U_sb_00;
    ...
    const ccomplex_t IT_0082 = -IT_0059 + IT_0069 + IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u2
      *e_em*IT_0010*IT_0016*IT_0046;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0006
      *U_sb_10;
    const ccomplex_t IT_0086 = (-0.5)*IT_0085;
    const ccomplex_t IT_0087 = IT_0084*IT_0086;
    const ccomplex_t IT_0088 = cpow((-2)*s_13 + IT_0000 + IT_0044 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = m_b*e_em*mu_h*IT_0016*conj(U_sb_00)*U_sb_10;
    const ccomplex_t IT_0092 = IT_0010*IT_0091;
    const ccomplex_t IT_0093 = m_b*e_em*mu_h*IT_0016*U_sb_00*conj(U_sb_10);
    const ccomplex_t IT_0094 = IT_0010*IT_0093;
    const ccomplex_t IT_0095 = cpow(V_tb, 2);
    const ccomplex_t IT_0096 = A_b*IT_0095*conj(U_sb_00)*U_sb_10;
    const ccomplex_t IT_0097 = IT_0006*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = A_b*IT_0095*U_sb_00*conj(U_sb_10);
    const ccomplex_t IT_0100 = IT_0006*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = (-0.5)*IT_0092 + 0.5*IT_0094 + (-0.5)*IT_0098 +
       0.5*IT_0101;
    const ccomplex_t IT_0103 = IT_0050*IT_0102;
    const ccomplex_t IT_0104 = cpow((-2)*s_13 + IT_0000 + IT_0044 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0105 = IT_0103*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u2
      *e_em*IT_0010*IT_0016*IT_0046;
    const ccomplex_t IT_0108 = 0.5*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0006
      *U_sb_10;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = IT_0108*IT_0110;
    const ccomplex_t IT_0112 = cpow((-2)*s_13 + IT_0000 + IT_0044 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0113 = IT_0111*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0010*IT_0016*IT_0046*U_sb_01;
    const ccomplex_t IT_0116 = 0.5*IT_0115;
    const ccomplex_t IT_0117 = m_b*e_em*mu_h*IT_0016*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0118 = IT_0010*IT_0117;
    const ccomplex_t IT_0119 = m_b*e_em*mu_h*IT_0016*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0120 = IT_0010*IT_0119;
    const ccomplex_t IT_0121 = A_b*IT_0095*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0122 = IT_0006*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = A_b*IT_0095*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0129 = cpow((-2)*s_13 + IT_0000 + IT_0044 + -m_sb_2*
    ...
    const ccomplex_t IT_0133 = IT_0033*IT_0078;
    const ccomplex_t IT_0134 = IT_0041*IT_0132*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0136 = IT_0013*IT_0050;
    const ccomplex_t IT_0137 = IT_0002*IT_0135*IT_0136;
    const ccomplex_t IT_0138 = m_C_2*IT_0081;
    const ccomplex_t IT_0139 = m_C_2*IT_0069;
    ...
    const ccomplex_t IT_0145 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0006
      *U_sb_00;
    ...
    const ccomplex_t IT_0150 = cpow((-2)*s_13 + IT_0000 + IT_0044 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0151 = IT_0149*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0006
      *U_sb_00;
    ...
    const ccomplex_t IT_0158 = cpow((-2)*s_13 + IT_0000 + IT_0044 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0159 = IT_0157*IT_0158;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm2)*IT_0010;
    const ccomplex_t IT_0162 = IT_0110*IT_0161;
    const ccomplex_t IT_0163 = IT_0112*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*IT_0163;
    const ccomplex_t IT_0165 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0166 = IT_0010*IT_0165;
    const ccomplex_t IT_0167 = m_b*conj(U_d2)*V_tb*e_em*IT_0016*U_sb_11;
    ...
    const ccomplex_t IT_0174 = IT_0039*IT_0076;
    const ccomplex_t IT_0175 = IT_0041*IT_0132*IT_0174;
    const ccomplex_t IT_0176 = IT_0023*IT_0066;
    const ccomplex_t IT_0177 = IT_0002*IT_0135*IT_0176;
    const ccomplex_t IT_0178 = m_C_2*IT_0026;
    const ccomplex_t IT_0179 = m_C_2*IT_0043;
    const ccomplex_t IT_0180 = IT_0023*IT_0102;
    const ccomplex_t IT_0181 = IT_0104*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm2)*IT_0010;
    const ccomplex_t IT_0184 = IT_0086*IT_0183;
    const ccomplex_t IT_0185 = IT_0088*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*IT_0185;
    const ccomplex_t IT_0187 = -IT_0152 + -IT_0160 + -IT_0164 + -IT_0173 +
       IT_0175 + IT_0177 + IT_0178 + IT_0179 + -IT_0182 + -IT_0186;
    const ccomplex_t IT_0188 = 0.166666666666667*conj(IT_0187);
    const ccomplex_t IT_0189 = s_13*IT_0055;
    ...
    const ccomplex_t IT_0194 = 0.166666666666667*conj(IT_0054);
    const ccomplex_t IT_0195 = m_t*m_C_2;
    const ccomplex_t IT_0196 = 6*IT_0195;
    const ccomplex_t IT_0197 = 0.166666666666667*conj(IT_0082);
    const ccomplex_t IT_0198 = 6*IT_0054*(IT_0056*conj(IT_0082) +
       0.166666666666667*conj(IT_0140)*IT_0142 + IT_0144*IT_0188 + IT_0193
      *IT_0194) + 6*IT_0187*(s_13*conj(IT_0187) + IT_0144*IT_0194 +
       0.166666666666667*conj(IT_0140)*IT_0196 + IT_0142*IT_0197) + 6*IT_0140*
      (s_13*conj(IT_0140) + IT_0142*IT_0194 + IT_0188*IT_0196 + IT_0144*IT_0197)
       + 6*IT_0082*(conj(IT_0054)*IT_0056 + 0.166666666666667*conj(IT_0140)
      *IT_0144 + IT_0142*IT_0188 + IT_0193*IT_0197);
