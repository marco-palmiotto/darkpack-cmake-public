        ...
        )
{
    ...
    const ccomplex_t IT_0047 = m_b*conj(U_d1)*V_tb*e_em*IT_0016*U_sb_10;
    ...
    const ccomplex_t IT_0093 = IT_0057*IT_0089*IT_0092;
    const ccomplex_t IT_0094 = m_t*IT_0026;
    const ccomplex_t IT_0095 = V_u2*conj(V_u2)*e_em;
    const ccomplex_t IT_0096 = IT_0006*IT_0095;
    const ccomplex_t IT_0097 = IT_0009*IT_0095;
    const ccomplex_t IT_0098 = e_em*V_Wp2*conj(V_Wp2);
    ...
    const ccomplex_t IT_0106 = conj(V_u1)*V_u2*e_em;
    const ccomplex_t IT_0107 = IT_0006*IT_0106;
    const ccomplex_t IT_0108 = IT_0009*IT_0106;
    const ccomplex_t IT_0109 = e_em*conj(V_Wp1)*V_Wp2;
    ...
    const ccomplex_t IT_0117 = IT_0081 + -IT_0088 + -IT_0093 + -IT_0094 + 
      -IT_0105 + -IT_0116;
    const ccomplex_t IT_0118 = s_34*IT_0034;
    ...
    const ccomplex_t IT_0124 = m_C_2*IT_0056;
    const ccomplex_t IT_0125 = m_C_2*IT_0067;
    const ccomplex_t IT_0126 = IT_0012*IT_0091;
    const ccomplex_t IT_0127 = IT_0002*IT_0077*IT_0126;
    const ccomplex_t IT_0128 = IT_0023*IT_0101;
    const ccomplex_t IT_0129 = IT_0057*IT_0089*IT_0128;
    const ccomplex_t IT_0130 = IT_0053*IT_0112;
    const ccomplex_t IT_0131 = IT_0039*IT_0082*IT_0130;
    const ccomplex_t IT_0132 = IT_0079*IT_0091;
    const ccomplex_t IT_0133 = IT_0002*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*IT_0133;
    const ccomplex_t IT_0135 = m_t*IT_0134;
    const ccomplex_t IT_0136 = -IT_0124 + -IT_0125 + -IT_0127 + -IT_0129 + 
      -IT_0131 + IT_0135;
    const ccomplex_t IT_0137 = m_t*m_C_2;
    const ccomplex_t IT_0138 = IT_0034*IT_0137;
    const ccomplex_t IT_0139 = (-3)*IT_0138;
    const ccomplex_t IT_0140 = -IT_0134;
    const ccomplex_t IT_0141 = 3*IT_0138;
    const ccomplex_t IT_0142 = -IT_0104 + -IT_0115;
    const ccomplex_t IT_0143 = 6*conj(IT_0026);
    const ccomplex_t IT_0144 = 6*IT_0026;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0004
    ...
    const ccomplex_t IT_0147 = cpow((-2)*s_13 + IT_0000 + IT_0038 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0148 = IT_0091*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*IT_0148;
    const ccomplex_t IT_0150 = IT_0146*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0004
    ...
    const ccomplex_t IT_0153 = cpow((-2)*s_13 + IT_0000 + IT_0038 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0008*IT_0016*IT_0084*U_sb_01;
    ...
    const ccomplex_t IT_0159 = 2*IT_0104 + 2*IT_0115 + IT_0150 + IT_0158;
    const ccomplex_t IT_0160 = s_13*s_14;
    const ccomplex_t IT_0161 = s_34*IT_0000;
    const ccomplex_t IT_0162 = -IT_0161;
    const ccomplex_t IT_0163 = IT_0160 + IT_0162;
    const ccomplex_t IT_0164 = 6*IT_0163;
    const ccomplex_t IT_0165 = (-2)*IT_0134 + -IT_0150 + -IT_0158;
    const ccomplex_t IT_0166 = s_14*IT_0038;
    ...
    const ccomplex_t IT_0171 = 6*IT_0139;
    const ccomplex_t IT_0172 = 0.5*IT_0072;
    const ccomplex_t IT_0173 = s_14 + IT_0172;
    const ccomplex_t IT_0174 = m_t*IT_0173;
    const ccomplex_t IT_0175 = 2*IT_0174;
    const ccomplex_t IT_0176 = 6*IT_0175;
    const ccomplex_t IT_0177 = (-0.25)*IT_0119;
    ...
    const ccomplex_t IT_0182 = IT_0023*IT_0147;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*IT_0182;
    const ccomplex_t IT_0184 = IT_0146*IT_0183;
    const ccomplex_t IT_0185 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0186 = IT_0008*IT_0185;
    const ccomplex_t IT_0187 = m_b*conj(U_d2)*V_tb*e_em*IT_0016*U_sb_11;
    ...
    const ccomplex_t IT_0194 = 2*IT_0056 + 2*IT_0067 + -IT_0184 + -IT_0193;
    const ccomplex_t IT_0195 = 2*IT_0026 + IT_0184 + IT_0193;
    const ccomplex_t IT_0196 = 6*IT_0141;
    const ccomplex_t IT_0197 = (-6)*conj(IT_0026);
    const ccomplex_t IT_0198 = 6*IT_0123;
    const ccomplex_t IT_0199 = 6*IT_0076;
    const ccomplex_t IT_0200 = (-6)*IT_0163;
    const ccomplex_t IT_0201 = (-6)*IT_0169;
    const ccomplex_t IT_0202 = pow(s_14, 2);
    const ccomplex_t IT_0203 = IT_0027*IT_0202;
    const ccomplex_t IT_0204 = -IT_0000;
    const ccomplex_t IT_0205 = IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = s_13*IT_0205;
    const ccomplex_t IT_0207 = 6*IT_0206;
    const ccomplex_t IT_0208 = m_t*IT_0205;
    const ccomplex_t IT_0209 = 6*IT_0208;
    const ccomplex_t IT_0210 = IT_0137*IT_0205;
    const ccomplex_t IT_0211 = 6*IT_0210;
    const ccomplex_t IT_0212 = s_14*s_34*IT_0027;
    ...
    const ccomplex_t IT_0217 = IT_0137*IT_0214;
    const ccomplex_t IT_0218 = (-6)*IT_0217;
    const ccomplex_t IT_0219 = m_C_2*IT_0214;
    ...
    const ccomplex_t IT_0239 = (-18)*IT_0137;
    const ccomplex_t IT_0240 = conj(IT_0117)*(IT_0076*IT_0144 + IT_0068
      *IT_0176 + IT_0142*IT_0181 + IT_0140*IT_0198 + IT_0194*IT_0209 + IT_0159
      *IT_0220 + IT_0195*IT_0228 + IT_0165*IT_0232 + IT_0117*IT_0238 + IT_0136
      *IT_0239);
    const ccomplex_t IT_0241 = conj(IT_0136)*(IT_0123*IT_0144 + IT_0142
      *IT_0176 + IT_0068*IT_0181 + IT_0140*IT_0199 + IT_0159*IT_0209 + IT_0194
      *IT_0220 + IT_0165*IT_0228 + IT_0195*IT_0232 + IT_0136*IT_0238 + IT_0117
      *IT_0239);
    const ccomplex_t IT_0242 = (-0.166666666666667)*IT_0068;
    const ccomplex_t IT_0243 = IT_0026*IT_0163 + (-0.166666666666667)*IT_0194
      *IT_0207 + (-0.166666666666667)*IT_0117*IT_0209 + (-0.166666666666667)
      *IT_0159*IT_0211 + (-0.166666666666667)*IT_0195*IT_0216 + (
      -0.166666666666667)*IT_0165*IT_0218 + (-0.166666666666667)*IT_0136*IT_0220
       + IT_0164*IT_0242;
    const ccomplex_t IT_0244 = IT_0026*IT_0169 + (-0.166666666666667)*IT_0194
      *IT_0216 + (-0.166666666666667)*IT_0159*IT_0218 + (-0.166666666666667)
      *IT_0195*IT_0226 + (-0.166666666666667)*IT_0117*IT_0228 + (
      -0.166666666666667)*IT_0165*IT_0230 + (-0.166666666666667)*IT_0136*IT_0232
       + IT_0170*IT_0242;
    const ccomplex_t IT_0245 = conj(IT_0026)*(IT_0026*IT_0037 + IT_0068
      *IT_0070) + (IT_0076*IT_0117 + IT_0123*IT_0136 + IT_0139*IT_0140 + IT_0141
      *IT_0142)*IT_0143 + conj(IT_0142)*(IT_0070*IT_0140 + IT_0037*IT_0142 +
       IT_0141*IT_0144 + IT_0159*IT_0164 + IT_0165*IT_0170 + IT_0068*IT_0171 +
       IT_0136*IT_0176 + IT_0117*IT_0181) + conj(IT_0068)*(IT_0037*IT_0068 +
       IT_0026*IT_0070 + IT_0142*IT_0171 + IT_0117*IT_0176 + IT_0136*IT_0181 +
       IT_0164*IT_0194 + IT_0170*IT_0195 + IT_0140*IT_0196) + (IT_0163*IT_0194 +
       IT_0169*IT_0195)*IT_0197 + conj(IT_0140)*(IT_0037*IT_0140 + IT_0070
      *IT_0142 + IT_0139*IT_0144 + IT_0068*IT_0196 + IT_0117*IT_0198 + IT_0136
      *IT_0199 + IT_0159*IT_0200 + IT_0165*IT_0201) + conj(IT_0159)*(IT_0142
      *IT_0164 + IT_0140*IT_0200 + IT_0159*IT_0207 + IT_0136*IT_0209 + IT_0194
      *IT_0211 + IT_0165*IT_0216 + IT_0195*IT_0218 + IT_0117*IT_0220) + conj
      (IT_0165)*(IT_0142*IT_0170 + IT_0140*IT_0201 + IT_0159*IT_0216 + IT_0194
      *IT_0218 + IT_0165*IT_0226 + IT_0136*IT_0228 + IT_0195*IT_0230 + IT_0117
      *IT_0232) + IT_0240 + IT_0241 + (-6)*conj(IT_0194)*IT_0243 + (-6)*conj
      (IT_0195)*IT_0244;
