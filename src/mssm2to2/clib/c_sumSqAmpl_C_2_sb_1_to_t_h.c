...
ccomplex_return_t c_sumSqAmpl_C_2_sb_1_to_t_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0010
      *IT_0018*IT_0032;
    const ccomplex_t IT_0034 = (-0.5)*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
    ...
    const ccomplex_t IT_0041 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0049 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0050 = IT_0010*IT_0049;
    const ccomplex_t IT_0051 = m_b*conj(U_d1)*V_tb*e_em*IT_0018*U_sb_10;
    ...
    const ccomplex_t IT_0058 = -IT_0028 + -IT_0039 + -IT_0057;
    const ccomplex_t IT_0059 = pow(m_h, 2);
    const ccomplex_t IT_0060 = m_t*m_C_2*IT_0059;
    const ccomplex_t IT_0061 = conj(V_u2)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0072 = IT_0025*IT_0034;
    const ccomplex_t IT_0073 = IT_0030*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = conj(V_u1)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0079 = IT_0010*(IT_0076 + -IT_0078);
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0010*IT_0018*IT_0032*U_sb_00;
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_13 + IT_0000 + IT_0029 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u2
    ...
    const ccomplex_t IT_0098 = IT_0014*IT_0036;
    const ccomplex_t IT_0099 = IT_0002*IT_0097*IT_0098;
    const ccomplex_t IT_0100 = cpow((-2)*s_13 + IT_0000 + IT_0029 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0101 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u2
      *e_em*IT_0010*IT_0018*IT_0032;
    ...
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0000 + IT_0029 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0109 = cpow(V_tb, 2);
    const ccomplex_t IT_0110 = m_b*mu_h*IT_0018;
    const ccomplex_t IT_0111 = IT_0006*IT_0015;
    const ccomplex_t IT_0112 = IT_0003*IT_0031;
    const ccomplex_t IT_0113 = IT_0111 + IT_0112;
    const ccomplex_t IT_0114 = cos(theta_W);
    const ccomplex_t IT_0115 = cpow(IT_0114, -2);
    const ccomplex_t IT_0116 = pow(m_b, 2);
    const ccomplex_t IT_0117 = 2*U_sb_00*(((-0.5)*m_W*IT_0113*(IT_0010 + 1./3
      *IT_0009*IT_0115) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj(U_sb_00)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0110*conj(U_sb_10)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0110*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0113*IT_0115 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj
      (U_sb_10));
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*(e_em*IT_0117 +
       1.4142135623731*A_b*IT_0006*IT_0109*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    ...
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0010*IT_0018*IT_0032*U_sb_01;
    const ccomplex_t IT_0125 = 0.5*IT_0124;
    const ccomplex_t IT_0126 = 2*U_sb_00*(((-0.5)*m_W*IT_0113*(IT_0010 + 1./3
      *IT_0009*IT_0115) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0110*conj(U_sb_11)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0110*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0113*IT_0115 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj
      (U_sb_11));
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*(e_em*IT_0126 +
       1.4142135623731*A_b*IT_0006*IT_0109*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0133 = IT_0048*IT_0084;
    const ccomplex_t IT_0134 = IT_0040*IT_0132*IT_0133;
    const ccomplex_t IT_0135 = m_t*IT_0039;
    const ccomplex_t IT_0136 = m_C_2*IT_0087;
    const ccomplex_t IT_0137 = m_C_2*IT_0071;
    const ccomplex_t IT_0138 = IT_0096 + -IT_0099 + IT_0107 + IT_0122 +
    ...
    const ccomplex_t IT_0143 = IT_0054*IT_0082;
    const ccomplex_t IT_0144 = IT_0040*IT_0132*IT_0143;
    const ccomplex_t IT_0145 = 2*U_sb_00*(((-0.5)*m_W*IT_0113*(IT_0010 + 1./3
      *IT_0009*IT_0115) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj(U_sb_00)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0110*conj(U_sb_10)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0110*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0113*IT_0115 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj
    ...
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm2)*IT_0010;
    const ccomplex_t IT_0152 = IT_0093*IT_0151;
    const ccomplex_t IT_0153 = IT_0089*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*IT_0153;
    const ccomplex_t IT_0155 = cpow((-2)*s_13 + IT_0000 + IT_0029 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0156 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_ts*e_em*IT_0010*IT_0016*IT_0018;
    const ccomplex_t IT_0157 = (-0.5)*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
    ...
    const ccomplex_t IT_0163 = cpow((-2)*s_13 + IT_0000 + IT_0029 + -m_sd_R*
    ...
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm2)*IT_0010;
    ...
    const ccomplex_t IT_0177 = m_b*conj(U_d2)*V_tb*e_em*IT_0018*U_sb_11;
    ...
    const ccomplex_t IT_0181 = 2*U_sb_00*(((-0.5)*m_W*IT_0113*(IT_0010 + 1./3
      *IT_0009*IT_0115) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0110*conj(U_sb_11)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0110*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0113*IT_0115 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0116)*conj
    ...
    const ccomplex_t IT_0185 = IT_0123*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*IT_0185;
    const ccomplex_t IT_0187 = IT_0025*IT_0068;
    const ccomplex_t IT_0188 = IT_0002*IT_0097*IT_0187;
    const ccomplex_t IT_0189 = m_t*IT_0074;
    const ccomplex_t IT_0190 = m_C_2*IT_0057;
    const ccomplex_t IT_0191 = m_C_2*IT_0028;
    const ccomplex_t IT_0192 = IT_0144 + -IT_0150 + -IT_0154 + -IT_0162 + 
      -IT_0170 + -IT_0174 + -IT_0186 + IT_0188 + 2*IT_0189 + IT_0190 + IT_0191;
