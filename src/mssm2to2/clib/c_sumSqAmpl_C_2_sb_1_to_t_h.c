        ...
        )
{
    ...
    const ccomplex_t IT_0032 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0010
      *IT_0018*IT_0050;
    ...
    const ccomplex_t IT_0061 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0062 = IT_0003*IT_0061;
    const ccomplex_t IT_0063 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0074 = IT_0025*IT_0052;
    ...
    const ccomplex_t IT_0088 = IT_0073 + IT_0076 + IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_13 + IT_0000 + IT_0047 + -m_sd_L*
    ...
    const ccomplex_t IT_0097 = cpow((-2)*s_13 + IT_0000 + IT_0047 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u2
      *e_em*IT_0010*IT_0018*IT_0050;
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0000 + IT_0047 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0106 = cpow(V_tb, 2);
    const ccomplex_t IT_0107 = m_b*mu_h*IT_0018;
    const ccomplex_t IT_0108 = IT_0006*IT_0015;
    const ccomplex_t IT_0109 = IT_0003*IT_0049;
    ...
    const ccomplex_t IT_0114 = 2*U_sb_00*(((-0.5)*m_W*IT_0110*(IT_0010 + 1./3
      *IT_0009*IT_0112) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj(U_sb_00)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0107*conj(U_sb_10)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0107*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0110*IT_0112 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj
      (U_sb_10));
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*(e_em*IT_0114 +
       1.4142135623731*A_b*IT_0006*IT_0106*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    ...
    const ccomplex_t IT_0120 = cpow((-2)*s_13 + IT_0000 + IT_0047 + -m_sb_2*
    ...
    const ccomplex_t IT_0123 = 2*U_sb_00*(((-0.5)*m_W*IT_0110*(IT_0010 + 1./3
      *IT_0009*IT_0112) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0107*conj(U_sb_11)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0107*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0110*IT_0112 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj
      (U_sb_11));
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*(e_em*IT_0123 +
       1.4142135623731*A_b*IT_0006*IT_0106*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0130 = IT_0037*IT_0070;
    const ccomplex_t IT_0131 = IT_0029*IT_0129*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0133 = IT_0014*IT_0054;
    const ccomplex_t IT_0134 = IT_0002*IT_0132*IT_0133;
    const ccomplex_t IT_0135 = m_t*IT_0057;
    const ccomplex_t IT_0136 = m_C_2*IT_0073;
    const ccomplex_t IT_0137 = m_C_2*IT_0087;
    const ccomplex_t IT_0138 = IT_0096 + IT_0104 + IT_0119 + IT_0128 + 
    ...
    const ccomplex_t IT_0143 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0144 = IT_0010*IT_0143;
    const ccomplex_t IT_0145 = m_b*conj(U_d2)*V_tb*e_em*IT_0018*U_sb_11;
    ...
    const ccomplex_t IT_0149 = 2*U_sb_00*(((-0.5)*m_W*IT_0110*(IT_0010 + 1./3
      *IT_0009*IT_0112) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0107*conj(U_sb_11)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0107*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0110*IT_0112 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj
    ...
    const ccomplex_t IT_0155 = IT_0025*IT_0084;
    const ccomplex_t IT_0156 = IT_0002*IT_0132*IT_0155;
    const ccomplex_t IT_0157 = m_C_2*IT_0028;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm2)*IT_0010;
    const ccomplex_t IT_0159 = IT_0101*IT_0158;
    const ccomplex_t IT_0160 = IT_0097*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = 2*U_sb_00*(((-0.5)*m_W*IT_0110*(IT_0010 + 1./3
      *IT_0009*IT_0112) + IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj(U_sb_00)
       + 1./2*IT_0003*IT_0010*IT_0016*IT_0107*conj(U_sb_10)) + U_sb_10*(IT_0003
      *IT_0010*IT_0016*IT_0107*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0009
      *IT_0110*IT_0112 + (-3)*IT_0006*IT_0010*IT_0016*IT_0018*IT_0113)*conj
    ...
    const ccomplex_t IT_0182 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_td)*IT_0006*U_sb_00;
    const ccomplex_t IT_0183 = 0.5*IT_0182;
    const ccomplex_t IT_0184 = IT_0181*IT_0183;
    const ccomplex_t IT_0185 = cpow((-2)*s_13 + IT_0000 + IT_0047 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0186 = IT_0184*IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1)*IT_0186;
    const ccomplex_t IT_0188 = IT_0043*IT_0068;
    const ccomplex_t IT_0189 = IT_0029*IT_0129*IT_0188;
    const ccomplex_t IT_0190 = m_t*IT_0076;
    const ccomplex_t IT_0191 = m_C_2*IT_0046;
    const ccomplex_t IT_0192 = -IT_0154 + IT_0156 + IT_0157 + -IT_0161 + 
      -IT_0167 + -IT_0171 + -IT_0179 + -IT_0187 + IT_0189 + 2*IT_0190 + IT_0191;
