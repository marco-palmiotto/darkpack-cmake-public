        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0004*IT_0005*IT_0007*IT_0009;
    const ccomplex_t IT_0011 = 0.5*IT_0010;
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0004*IT_0007*IT_0009*U_sb_01;
    const ccomplex_t IT_0013 = 0.5*IT_0012;
    const ccomplex_t IT_0014 = IT_0011*IT_0013;
    const ccomplex_t IT_0015 = IT_0003*IT_0014;
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*IT_0015;
    const ccomplex_t IT_0017 = cpow((-2)*s_12 + -IT_0001 + -IT_0002 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0004*IT_0005*IT_0007*IT_0009;
    const ccomplex_t IT_0019 = 0.5*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0004*IT_0007*IT_0009*U_sb_01;
    const ccomplex_t IT_0021 = 0.5*IT_0020;
    const ccomplex_t IT_0022 = IT_0019*IT_0021;
    const ccomplex_t IT_0023 = IT_0017*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*IT_0023;
    const ccomplex_t IT_0025 = pow(m_b, 2);
    const ccomplex_t IT_0026 = cpow((-2)*s_23 + IT_0002 + IT_0025 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0027 = IT_0005*IT_0009;
    const ccomplex_t IT_0028 = N_u1*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0034 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0050 = cpow(IT_0005, -1);
    const ccomplex_t IT_0051 = IT_0009*IT_0050;
    const ccomplex_t IT_0052 = m_b*conj(N_d1)*e_em*IT_0004*U_sb_11;
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*(IT_0046 + (-3)*IT_0049 + 3
      *IT_0054);
    ...
    const ccomplex_t IT_0060 = cpow((-2)*s_23 + IT_0002 + IT_0025 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0061 = N_u2*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0074 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0080 = m_b*conj(N_d2)*e_em*IT_0004*U_sb_11;
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0002 + IT_0025 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0089 = N_u3*e_em*V_Wp2;
    const ccomplex_t IT_0090 = IT_0027*IT_0089;
    const ccomplex_t IT_0091 = 2*IT_0090;
    const ccomplex_t IT_0092 = N_B3*V_u2*e_em;
    const ccomplex_t IT_0093 = IT_0033*IT_0092;
    const ccomplex_t IT_0094 = 1.4142135623731*IT_0093;
    const ccomplex_t IT_0095 = N_W3*V_u2*e_em;
    const ccomplex_t IT_0096 = IT_0027*IT_0095;
    ...
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0004*IT_0007*IT_0009*IT_0149*U_sb_01*V_ub_mod;
    ...
    const ccomplex_t IT_0155 = -IT_0016 + -IT_0024 + -IT_0059 + -IT_0087 + 
      -IT_0115 + -IT_0143 + -IT_0154;
    const ccomplex_t IT_0156 = m_b*m_C_2*IT_0002;
    const ccomplex_t IT_0157 = V_cb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0158 = IT_0009*IT_0157;
    const ccomplex_t IT_0159 = m_b*conj(U_d2)*V_cb*e_em*IT_0004*U_sb_11;
    ...
    const ccomplex_t IT_0163 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0004*IT_0006*IT_0009*IT_0050;
    ...
    const ccomplex_t IT_0168 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0169 = IT_0009*IT_0168;
    const ccomplex_t IT_0170 = m_b*conj(U_d2)*V_tb*e_em*IT_0004*U_sb_11;
    ...
    const ccomplex_t IT_0174 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0004*IT_0006*IT_0009*IT_0050;
    ...
    const ccomplex_t IT_0179 = IT_0009*IT_0149;
    const ccomplex_t IT_0180 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0181 = IT_0179*IT_0180;
    const ccomplex_t IT_0182 = IT_0009*IT_0050*IT_0149;
    const ccomplex_t IT_0183 = m_b*conj(U_d2)*e_em*IT_0004*U_sb_11*V_ub_mod;
    const ccomplex_t IT_0184 = IT_0182*IT_0183;
    const ccomplex_t IT_0185 = 1.4142135623731*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*(IT_0181 + (-0.5)*IT_0185);
    const ccomplex_t IT_0187 = (0 + _Complex_I*1.4142135623731)*m_b*e_em
      *IT_0004*IT_0006*IT_0009*IT_0050*IT_0146*V_ub_mod;
    ...
    const ccomplex_t IT_0192 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0193 = IT_0032*IT_0192;
    const ccomplex_t IT_0194 = 1.4142135623731*IT_0193;
    const ccomplex_t IT_0195 = m_b*N_d1*e_em*IT_0004*U_sb_01;
    ...
    const ccomplex_t IT_0200 = IT_0006*IT_0009;
    ...
    const ccomplex_t IT_0204 = IT_0006*IT_0032;
    const ccomplex_t IT_0205 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0209 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0219 = IT_0200*IT_0218;
    ...
    const ccomplex_t IT_0225 = IT_0200*IT_0224;
    ...
    const ccomplex_t IT_0234 = m_b*N_d4*e_em*IT_0004*U_sb_01;
    ...
    const ccomplex_t IT_0246 = IT_0204*IT_0245;
    ...
    const ccomplex_t IT_0258 = m_b*N_d2*e_em*IT_0004*U_sb_01;
    ...
    const ccomplex_t IT_0280 = IT_0032*IT_0279;
    const ccomplex_t IT_0281 = 1.4142135623731*IT_0280;
    const ccomplex_t IT_0282 = m_b*N_d3*e_em*IT_0004*U_sb_01;
    const ccomplex_t IT_0283 = IT_0051*IT_0282;
    ...
    const ccomplex_t IT_0288 = IT_0088*IT_0287;
    const ccomplex_t IT_0289 = (0 + _Complex_I*1)*IT_0288;
    const ccomplex_t IT_0290 = IT_0167 + IT_0178 + IT_0191 + -IT_0217 + 
    ...
    const ccomplex_t IT_0294 = IT_0151*IT_0188;
    const ccomplex_t IT_0295 = IT_0145*IT_0293*IT_0294;
    const ccomplex_t IT_0296 = m_b*IT_0115;
    const ccomplex_t IT_0297 = m_C_2*IT_0167;
    const ccomplex_t IT_0298 = m_C_2*IT_0178;
    const ccomplex_t IT_0299 = m_C_2*IT_0191;
    const ccomplex_t IT_0300 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0301 = IT_0043*IT_0199;
    const ccomplex_t IT_0302 = IT_0026*IT_0300*IT_0301;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0304 = IT_0101*IT_0286;
    const ccomplex_t IT_0305 = IT_0088*IT_0303*IT_0304;
    const ccomplex_t IT_0306 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0307 = IT_0021*IT_0175;
    const ccomplex_t IT_0308 = IT_0017*IT_0306*IT_0307;
    const ccomplex_t IT_0309 = m_b*IT_0059;
    const ccomplex_t IT_0310 = m_b*IT_0087;
    const ccomplex_t IT_0311 = m_b*IT_0143;
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0313 = IT_0073*IT_0262;
    const ccomplex_t IT_0314 = IT_0060*IT_0312*IT_0313;
    const ccomplex_t IT_0315 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0316 = IT_0129*IT_0238;
    const ccomplex_t IT_0317 = IT_0116*IT_0315*IT_0316;
    const ccomplex_t IT_0318 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0319 = IT_0013*IT_0164;
    const ccomplex_t IT_0320 = IT_0003*IT_0318*IT_0319;
    const ccomplex_t IT_0321 = -IT_0295 + IT_0296 + IT_0297 + IT_0298 +
       IT_0299 + -IT_0302 + -IT_0305 + -IT_0308 + IT_0309 + IT_0310 + IT_0311 + 
    ...
    const ccomplex_t IT_0325 = IT_0011*IT_0162;
    const ccomplex_t IT_0326 = IT_0003*IT_0318*IT_0325;
    const ccomplex_t IT_0327 = IT_0148*IT_0186;
    const ccomplex_t IT_0328 = IT_0145*IT_0293*IT_0327;
    const ccomplex_t IT_0329 = IT_0112*IT_0278;
    const ccomplex_t IT_0330 = IT_0088*IT_0303*IT_0329;
    const ccomplex_t IT_0331 = m_b*IT_0241;
    const ccomplex_t IT_0332 = IT_0056*IT_0214;
    const ccomplex_t IT_0333 = IT_0026*IT_0300*IT_0332;
    const ccomplex_t IT_0334 = IT_0140*IT_0230;
    const ccomplex_t IT_0335 = IT_0116*IT_0315*IT_0334;
    const ccomplex_t IT_0336 = IT_0019*IT_0173;
    const ccomplex_t IT_0337 = IT_0017*IT_0306*IT_0336;
    const ccomplex_t IT_0338 = m_b*IT_0217;
    const ccomplex_t IT_0339 = IT_0084*IT_0254;
    const ccomplex_t IT_0340 = IT_0060*IT_0312*IT_0339;
    const ccomplex_t IT_0341 = m_b*IT_0289;
    const ccomplex_t IT_0342 = m_C_2*IT_0154;
    const ccomplex_t IT_0343 = m_b*IT_0265;
    const ccomplex_t IT_0344 = m_C_2*IT_0016;
    const ccomplex_t IT_0345 = m_C_2*IT_0024;
    const ccomplex_t IT_0346 = IT_0326 + IT_0328 + -IT_0330 + IT_0331 + 
      -IT_0333 + -IT_0335 + IT_0337 + IT_0338 + -IT_0340 + IT_0341 + -IT_0342 +
       IT_0343 + -IT_0344 + -IT_0345;
    const ccomplex_t IT_0347 = 0.166666666666667*conj(IT_0346);
    const ccomplex_t IT_0348 = s_13*IT_0002;
