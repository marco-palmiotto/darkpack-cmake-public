        ...
        )
{
    ...
    const ccomplex_t IT_0002 = conj(N_W4)*e_em*V_Wp2;
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = conj(N_u4)*V_u2*e_em;
    ...
    const ccomplex_t IT_0011 = N_B4*e_em*U_sb_11;
    ...
    const ccomplex_t IT_0018 = m_b*N_d4*e_em*IT_0017*U_sb_01;
    ...
    const ccomplex_t IT_0026 = cpow((-2)*s_23 + IT_0024 + IT_0025 + -m_N_4*
    ...
    const ccomplex_t IT_0037 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0038 = IT_0010*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = m_b*N_d1*e_em*IT_0017*U_sb_01;
    ...
    const ccomplex_t IT_0056 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0057 = IT_0010*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = m_b*N_d2*e_em*IT_0017*U_sb_01;
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0024 + IT_0025 + -m_N_3*
    ...
    const ccomplex_t IT_0075 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0076 = IT_0010*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_b*N_d3*e_em*IT_0017*U_sb_01;
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0096 = conj(N_B4)*e_em*U_sb_01;
    const ccomplex_t IT_0097 = IT_0010*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = conj(N_W4)*e_em*U_sb_01;
    const ccomplex_t IT_0100 = IT_0001*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = m_b*conj(N_d4)*e_em*IT_0017*U_sb_11;
    ...
    const ccomplex_t IT_0108 = IT_0026*IT_0095*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0110 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0116 = m_b*conj(N_d2)*e_em*IT_0017*U_sb_11;
    ...
    const ccomplex_t IT_0133 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0134 = IT_0001*IT_0133;
    const ccomplex_t IT_0135 = 1.4142135623731*IT_0134;
    const ccomplex_t IT_0136 = m_b*conj(N_d3)*e_em*IT_0017*U_sb_11;
    ...
    const ccomplex_t IT_0146 = pow(m_C_2, 2);
    const ccomplex_t IT_0147 = cpow((-2)*s_12 + -IT_0025 + IT_0145 + -IT_0146 
      + -reg_prop, -1);
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0149 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001
      *IT_0149*V_ub_mod;
    const ccomplex_t IT_0151 = 0.5*IT_0150;
    const ccomplex_t IT_0152 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0153 = sin(beta);
    const ccomplex_t IT_0154 = cpow(IT_0153, -1);
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0001*IT_0017*IT_0152*IT_0154*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0156 = 0.5*IT_0155;
    const ccomplex_t IT_0157 = IT_0151*IT_0156;
    const ccomplex_t IT_0158 = IT_0147*IT_0148*IT_0157;
    const ccomplex_t IT_0159 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0160 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0161 = IT_0010*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = conj(N_W1)*e_em*U_sb_01;
    const ccomplex_t IT_0164 = IT_0001*IT_0163;
    const ccomplex_t IT_0165 = 1.4142135623731*IT_0164;
    const ccomplex_t IT_0166 = m_b*conj(N_d1)*e_em*IT_0017*U_sb_11;
    ...
    const ccomplex_t IT_0172 = IT_0029*IT_0159*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0174 = IT_0074*IT_0140;
    const ccomplex_t IT_0175 = IT_0067*IT_0173*IT_0174;
    const ccomplex_t IT_0176 = pow(m_c, 2);
    const ccomplex_t IT_0177 = cpow((-2)*s_12 + -IT_0025 + -IT_0146 + IT_0176 
      + -reg_prop, -1);
    const ccomplex_t IT_0178 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0001;
    const ccomplex_t IT_0180 = 0.5*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0001*IT_0017*IT_0154*U_sb_01;
    ...
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0186 = cpow((-2)*s_12 + -IT_0025 + -IT_0146 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0187 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001;
    const ccomplex_t IT_0188 = 0.5*IT_0187;
    const ccomplex_t IT_0189 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0001*IT_0017*IT_0154*U_sb_01;
    const ccomplex_t IT_0190 = 0.5*IT_0189;
    const ccomplex_t IT_0191 = IT_0188*IT_0190;
    const ccomplex_t IT_0192 = IT_0185*IT_0186*IT_0191;
    const ccomplex_t IT_0193 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0194 = IT_0001*IT_0193;
    const ccomplex_t IT_0195 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0200 = IT_0170*IT_0199;
    ...
    const ccomplex_t IT_0211 = IT_0120*IT_0210;
    ...
    const ccomplex_t IT_0215 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0216 = IT_0001*IT_0215;
    const ccomplex_t IT_0217 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0222 = IT_0106*IT_0221;
    ...
    const ccomplex_t IT_0226 = -IT_0108 + -IT_0122 + IT_0144 + -IT_0158 + 
      -IT_0172 + -IT_0175 + -IT_0184 + -IT_0192 + IT_0203 + IT_0214 + IT_0225;
    const ccomplex_t IT_0227 = s_34*IT_0088;
    ...
    const ccomplex_t IT_0233 = m_C_2*IT_0085;
    const ccomplex_t IT_0234 = m_C_2*IT_0028;
    const ccomplex_t IT_0235 = IT_0063*IT_0210;
    const ccomplex_t IT_0236 = IT_0048*IT_0109*IT_0235;
    const ccomplex_t IT_0237 = IT_0082*IT_0129;
    const ccomplex_t IT_0238 = IT_0067*IT_0173*IT_0237;
    const ccomplex_t IT_0239 = IT_0044*IT_0199;
    const ccomplex_t IT_0240 = IT_0029*IT_0159*IT_0239;
    const ccomplex_t IT_0241 = IT_0022*IT_0221;
    const ccomplex_t IT_0242 = IT_0026*IT_0095*IT_0241;
    const ccomplex_t IT_0243 = m_C_2*IT_0047;
    const ccomplex_t IT_0244 = m_C_2*IT_0066;
    const ccomplex_t IT_0245 = m_b*conj(U_d2)*V_cb*e_em*IT_0017*U_sb_11;
    const ccomplex_t IT_0246 = IT_0016*IT_0245;
    const ccomplex_t IT_0247 = 1.4142135623731*IT_0246;
    const ccomplex_t IT_0248 = V_cb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0249 = IT_0001*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*(IT_0247 + (-2)*IT_0249);
    const ccomplex_t IT_0251 = (-0.5)*IT_0250;
    const ccomplex_t IT_0252 = IT_0180*IT_0251;
    const ccomplex_t IT_0253 = IT_0177*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = m_b*IT_0254;
    const ccomplex_t IT_0256 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0257 = IT_0001*IT_0256;
    const ccomplex_t IT_0258 = m_b*conj(U_d2)*V_tb*e_em*IT_0017*U_sb_11;
    ...
    const ccomplex_t IT_0262 = IT_0188*IT_0261;
    const ccomplex_t IT_0263 = IT_0186*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = m_b*IT_0264;
    const ccomplex_t IT_0266 = IT_0001*IT_0152;
    const ccomplex_t IT_0267 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0268 = IT_0266*IT_0267;
    const ccomplex_t IT_0269 = IT_0001*IT_0015*IT_0152;
    const ccomplex_t IT_0270 = m_b*conj(U_d2)*e_em*IT_0017*U_sb_11*V_ub_mod;
    const ccomplex_t IT_0271 = IT_0269*IT_0270;
    const ccomplex_t IT_0272 = 1.4142135623731*IT_0271;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*(IT_0268 + (-0.5)*IT_0272);
    const ccomplex_t IT_0274 = IT_0151*IT_0273;
    const ccomplex_t IT_0275 = IT_0147*IT_0274;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1)*IT_0275;
    const ccomplex_t IT_0277 = m_b*IT_0276;
    const ccomplex_t IT_0278 = -IT_0233 + -IT_0234 + IT_0236 + IT_0238 +
       IT_0240 + IT_0242 + -IT_0243 + -IT_0244 + -IT_0255 + -IT_0265 + -IT_0277;
    const ccomplex_t IT_0279 = m_b*m_C_2;
    const ccomplex_t IT_0280 = IT_0088*IT_0279;
    const ccomplex_t IT_0281 = 3*IT_0280;
    const ccomplex_t IT_0282 = IT_0254 + IT_0264 + IT_0276;
    const ccomplex_t IT_0283 = (-3)*IT_0280;
    const ccomplex_t IT_0284 = IT_0143 + IT_0202 + IT_0213 + IT_0224;
    const ccomplex_t IT_0285 = 2*IT_0028 + 2*IT_0047 + 2*IT_0066 + 2*IT_0085;
    const ccomplex_t IT_0286 = s_13*s_14;
    const ccomplex_t IT_0287 = s_34*IT_0146;
    const ccomplex_t IT_0288 = -IT_0287;
    const ccomplex_t IT_0289 = IT_0286 + IT_0288;
    const ccomplex_t IT_0290 = pow(m_W, 4);
    const ccomplex_t IT_0291 = s_13*IT_0290;
    const ccomplex_t IT_0292 = IT_0087*IT_0291;
    const ccomplex_t IT_0293 = s_14*s_34;
    const ccomplex_t IT_0294 = 24*IT_0293;
    const ccomplex_t IT_0295 = s_13*IT_0088;
    const ccomplex_t IT_0296 = (-12)*IT_0295;
    const ccomplex_t IT_0297 = 6*IT_0292 + IT_0294 + IT_0296;
    const ccomplex_t IT_0298 = 2*IT_0254 + 2*IT_0264 + 2*IT_0276;
    const ccomplex_t IT_0299 = pow(s_34, 2);
    const ccomplex_t IT_0300 = IT_0087*IT_0299;
    const ccomplex_t IT_0301 = -IT_0300;
    const ccomplex_t IT_0302 = IT_0024 + IT_0301;
    const ccomplex_t IT_0303 = s_13*IT_0302;
    const ccomplex_t IT_0304 = s_14*IT_0024;
    ...
    const ccomplex_t IT_0309 = s_14*s_34*IT_0087;
    const ccomplex_t IT_0310 = -IT_0309;
    const ccomplex_t IT_0311 = s_13 + IT_0310;
    const ccomplex_t IT_0312 = IT_0279*IT_0311;
    const ccomplex_t IT_0313 = (-6)*IT_0312;
    const ccomplex_t IT_0314 = m_C_2*IT_0302;
    const ccomplex_t IT_0315 = (-6)*IT_0314;
    const ccomplex_t IT_0316 = (-2)*IT_0143 + (-2)*IT_0202 + (-2)*IT_0213 + (
      -2)*IT_0224;
    const ccomplex_t IT_0317 = s_13*IT_0311;
    const ccomplex_t IT_0318 = (-6)*IT_0317;
    const ccomplex_t IT_0319 = m_b*IT_0311;
    const ccomplex_t IT_0320 = (-6)*IT_0319;
    const ccomplex_t IT_0321 = -IT_0284;
    const ccomplex_t IT_0322 = (-6)*conj(IT_0298)*(IT_0298*IT_0303 + (
      -0.166666666666667)*IT_0282*IT_0308 + (-0.166666666666667)*IT_0285*IT_0313
       + (-0.166666666666667)*IT_0226*IT_0315 + (-0.166666666666667)*IT_0316
      *IT_0318 + (-0.166666666666667)*IT_0278*IT_0320 + IT_0307*IT_0321);
    const ccomplex_t IT_0323 = (-0.25)*IT_0090;
    const ccomplex_t IT_0324 = s_14 + IT_0323;
    const ccomplex_t IT_0325 = m_b*IT_0324;
    const ccomplex_t IT_0326 = (-4)*IT_0325;
    const ccomplex_t IT_0327 = m_C_2*IT_0311;
    const ccomplex_t IT_0328 = (-6)*IT_0327;
    const ccomplex_t IT_0329 = (-18)*IT_0279;
    const ccomplex_t IT_0330 = 0.166666666666667*IT_0226;
    const ccomplex_t IT_0331 = pow(s_14, 2);
    const ccomplex_t IT_0332 = IT_0087*IT_0331;
    const ccomplex_t IT_0333 = -IT_0146;
    const ccomplex_t IT_0334 = IT_0332 + IT_0333;
    const ccomplex_t IT_0335 = m_b*IT_0334;
    const ccomplex_t IT_0336 = 6*IT_0335;
    const ccomplex_t IT_0337 = 0.166666666666667*IT_0316;
    const ccomplex_t IT_0338 = 0.166666666666667*IT_0298;
    const ccomplex_t IT_0339 = (-2)*IT_0293;
    const ccomplex_t IT_0340 = IT_0295 + IT_0339;
    const ccomplex_t IT_0341 = IT_0087*IT_0340;
    const ccomplex_t IT_0342 = 12*s_13;
    const ccomplex_t IT_0343 = (-6)*IT_0341 + IT_0342;
    const ccomplex_t IT_0344 = 0.166666666666667*IT_0278;
    const ccomplex_t IT_0345 = IT_0279*IT_0334;
    const ccomplex_t IT_0346 = s_13*IT_0334;
    const ccomplex_t IT_0347 = 0.5*IT_0228;
    const ccomplex_t IT_0348 = s_34 + IT_0347;
    const ccomplex_t IT_0349 = m_C_2*IT_0348;
    const ccomplex_t IT_0350 = 2*IT_0349;
    const ccomplex_t IT_0351 = (-24)*IT_0293;
    const ccomplex_t IT_0352 = 6*IT_0292 + IT_0351;
    const ccomplex_t IT_0353 = 0.166666666666667*IT_0282;
    const ccomplex_t IT_0354 = 0.166666666666667*IT_0284;
    const ccomplex_t IT_0355 = 6*conj(IT_0086)*(IT_0094*IT_0226 + IT_0232
      *IT_0278 + IT_0281*IT_0282 + IT_0283*IT_0284 + IT_0285*IT_0289 +
       0.166666666666667*IT_0086*IT_0297) + IT_0322 + 6*conj(IT_0278)*(IT_0086
      *IT_0232 + IT_0094*IT_0284 + IT_0282*IT_0326 + 0.166666666666667*IT_0285
      *IT_0328 + IT_0329*IT_0330 + IT_0336*IT_0337 + IT_0320*IT_0338 + IT_0343
      *IT_0344) + 6*conj(IT_0285)*(IT_0086*IT_0289 + IT_0330*IT_0336 + IT_0313
      *IT_0338 + IT_0328*IT_0344 + IT_0316*IT_0345 + IT_0285*IT_0346) + (-6)
      *conj(IT_0316)*(IT_0289*(IT_0282 + IT_0321) + -IT_0328*IT_0330 + -IT_0318
      *IT_0338 + -IT_0336*IT_0344 + -IT_0285*IT_0345 + -IT_0316*IT_0346) + 6
      *conj(IT_0226)*(IT_0086*IT_0094 + IT_0232*IT_0284 + 0.166666666666667
      *IT_0285*IT_0336 + IT_0328*IT_0337 + IT_0315*IT_0338 + IT_0330*IT_0343 +
       IT_0329*IT_0344 + IT_0282*IT_0350) + 6*conj(IT_0284)*(IT_0226*IT_0232 +
       IT_0094*IT_0278 + IT_0086*IT_0283 + IT_0298*IT_0307 + IT_0289*IT_0316 +
       IT_0352*IT_0353 + IT_0297*IT_0354) + 6*conj(IT_0282)*(IT_0086*IT_0281 + 
      -IT_0289*IT_0316 + IT_0278*IT_0326 + IT_0308*IT_0338 + IT_0226*IT_0350 +
       IT_0297*IT_0353 + IT_0352*IT_0354);
