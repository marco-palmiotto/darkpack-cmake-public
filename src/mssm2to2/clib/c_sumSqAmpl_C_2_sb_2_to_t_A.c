        ...
        )
{
    ...
    const ccomplex_t IT_0019 = 0.666666666666667*IT_0000;
    const ccomplex_t IT_0020 = IT_0012*IT_0019;
    const ccomplex_t IT_0021 = pow(m_C_2, 2);
    const ccomplex_t IT_0022 = cpow((-2)*s_12 + -IT_0015 + -IT_0021 + 
    ...
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0014 + IT_0021 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0027 = IT_0012*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = IT_0019*IT_0028;
    const ccomplex_t IT_0030 = (-2)*IT_0018 + -IT_0029;
    const ccomplex_t IT_0031 = s_34*IT_0021;
    ...
    const ccomplex_t IT_0036 = 0.333333333333333*IT_0000;
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0002*IT_0008*IT_0041*U_sb_01;
    ...
    const ccomplex_t IT_0051 = IT_0000*IT_0043;
    ...
    const ccomplex_t IT_0066 = (-6)*conj(IT_0018);
    const ccomplex_t IT_0067 = IT_0065 + IT_0066;
    const ccomplex_t IT_0068 = IT_0021*IT_0038;
    const ccomplex_t IT_0069 = 2*IT_0024 + IT_0029;
    ...
    const ccomplex_t IT_0074 = (-6)*IT_0021*IT_0048;
    ...
    const ccomplex_t IT_0078 = s_14*IT_0014;
    ...
    const ccomplex_t IT_0086 = (-6)*IT_0014;
    ...
    const ccomplex_t IT_0094 = 0.166666666666667*conj(IT_0055)*IT_0070 +
       0.166666666666667*conj(IT_0030)*IT_0073 + conj(IT_0018)*IT_0081 +
      ...
      *IT_0091 + IT_0065*IT_0093;
    const ccomplex_t IT_0095 = (IT_0024*((-24)*conj(IT_0018) + 24*conj(IT_0024
      )) + IT_0018*(24*conj(IT_0018) + (-24)*conj(IT_0024)))*IT_0025 + conj
      (IT_0030)*(IT_0024*IT_0035 + IT_0037*IT_0039 + IT_0047*IT_0049 + IT_0031
      ...
      *IT_0064 + IT_0060*IT_0067 + conj(IT_0055)*IT_0068 + conj(IT_0069)*IT_0070
       + conj(IT_0071)*IT_0073 + conj(IT_0030)*IT_0074) + IT_0030*(conj(IT_0024)
      *IT_0035 + conj(IT_0037)*IT_0039 + conj(IT_0047)*IT_0049 + IT_0031*IT_0066
      ...
      *IT_0089 + IT_0090 + IT_0092) + 6*conj(IT_0069)*(IT_0018*IT_0081 +
