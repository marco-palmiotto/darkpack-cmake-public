        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
    ...
    const ccomplex_t IT_0030 = IT_0000*IT_0003*IT_0029;
    const ccomplex_t IT_0031 = cpow(IT_0011, -1);
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0008*(m_W*IT_0005*IT_0011*conj(U_sb_01) + (-0.5)*IT_0004*(IT_0001
      *IT_0006*IT_0011*conj(U_sb_01) + m_b*(m_b*IT_0005*IT_0031*conj(U_sb_01) +
       mu_h*conj(U_sb_11))));
    const ccomplex_t IT_0033 = -IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0004*IT_0006*IT_0008*U_sb_01;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = IT_0033*IT_0035;
    const ccomplex_t IT_0037 = pow(m_C_2, 2);
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0001 + IT_0037 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0039 = IT_0036*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*IT_0039;
    const ccomplex_t IT_0041 = pow(m_s, 2);
    const ccomplex_t IT_0042 = (0 + _Complex_I*(-2.82842712474619))*conj(V_cs)
      *e_em*IT_0008*((m_W*IT_0005 + (-0.5)*IT_0001*IT_0004*IT_0006)*IT_0011 + 
      -1./2*IT_0004*IT_0005*IT_0031*IT_0041);
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = IT_0043*IT_0045;
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0001 + IT_0037 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*IT_0048;
    const ccomplex_t IT_0050 = pow(m_d, 2);
    const ccomplex_t IT_0051 = (0 + _Complex_I*(-2.82842712474619))*conj(V_cd)
      *e_em*IT_0008*((m_W*IT_0005 + (-0.5)*IT_0001*IT_0004*IT_0006)*IT_0011 + 
      -1./2*IT_0004*IT_0005*IT_0031*IT_0050);
    const ccomplex_t IT_0052 = 0.5*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = IT_0052*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_13 + IT_0001 + IT_0037 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0057 = IT_0055*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0061 = (-0.5)*IT_0060;
    const ccomplex_t IT_0062 = N_u1*e_em*V_Wp2;
    const ccomplex_t IT_0063 = IT_0012*IT_0062;
    const ccomplex_t IT_0064 = 2*IT_0063;
    const ccomplex_t IT_0065 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0066 = IT_0018*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0004*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0114 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0115 = IT_0097*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = cpow((-2)*s_13 + IT_0001 + IT_0037 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0008*(m_W*IT_0005*IT_0011*conj(U_sb_00) + (-0.5)*IT_0004*(IT_0001
      *IT_0006*IT_0011*conj(U_sb_00) + m_b*(m_b*IT_0005*IT_0031*conj(U_sb_00) +
       mu_h*conj(U_sb_10))));
    const ccomplex_t IT_0118 = -IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0004*IT_0006*IT_0008*U_sb_00;
    ...
    const ccomplex_t IT_0132 = IT_0074*IT_0131;
    ...
    const ccomplex_t IT_0156 = IT_0112*IT_0155;
    ...
    const ccomplex_t IT_0172 = -IT_0030 + IT_0040 + IT_0049 + IT_0058 + 
      -IT_0077 + -IT_0096 + -IT_0115 + IT_0123 + IT_0135 + IT_0147 + IT_0159 +
       IT_0171;
    const ccomplex_t IT_0173 = IT_0005*IT_0008;
    const ccomplex_t IT_0174 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0175 = IT_0173*IT_0174;
    const ccomplex_t IT_0176 = (-2)*IT_0175;
    const ccomplex_t IT_0177 = IT_0005*IT_0017;
    ...
    const ccomplex_t IT_0189 = IT_0114*IT_0188;
    const ccomplex_t IT_0190 = (0 + _Complex_I*1)*IT_0189;
    const ccomplex_t IT_0191 = m_c*IT_0190;
    const ccomplex_t IT_0192 = cpow((-2)*s_13 + IT_0001 + IT_0037 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0193 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0004*IT_0008;
    const ccomplex_t IT_0194 = 0.5*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0004*IT_0008*IT_0031;
    ...
    const ccomplex_t IT_0200 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0201 = IT_0173*IT_0200;
    const ccomplex_t IT_0202 = (-2)*IT_0201;
    const ccomplex_t IT_0203 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0204 = IT_0177*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = conj(N_W2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0207 = IT_0173*IT_0206;
    const ccomplex_t IT_0208 = 1.4142135623731*IT_0207;
    const ccomplex_t IT_0209 = IT_0205 + IT_0208;
    const ccomplex_t IT_0210 = IT_0202 + IT_0209;
    ...
    const ccomplex_t IT_0214 = IT_0078*IT_0079*IT_0213;
    const ccomplex_t IT_0215 = IT_0155*IT_0187;
    const ccomplex_t IT_0216 = IT_0097*IT_0114*IT_0215;
    const ccomplex_t IT_0217 = IT_0008*IT_0031;
    const ccomplex_t IT_0218 = m_b*conj(U_d2)*V_cb*e_em*IT_0004*U_sb_10;
    const ccomplex_t IT_0219 = IT_0217*IT_0218;
    const ccomplex_t IT_0220 = 1.4142135623731*IT_0219;
    const ccomplex_t IT_0221 = V_cb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0222 = IT_0008*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*(IT_0220 + (-2)*IT_0222);
    const ccomplex_t IT_0224 = (-0.5)*IT_0223;
    const ccomplex_t IT_0225 = IT_0118*IT_0224;
    const ccomplex_t IT_0226 = IT_0116*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*IT_0226;
    const ccomplex_t IT_0228 = m_b*conj(U_d2)*V_cb*e_em*IT_0004*U_sb_11;
    const ccomplex_t IT_0229 = IT_0217*IT_0228;
    const ccomplex_t IT_0230 = 1.4142135623731*IT_0229;
    const ccomplex_t IT_0231 = V_cb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0232 = IT_0008*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*(IT_0230 + (-2)*IT_0232);
    const ccomplex_t IT_0234 = (-0.5)*IT_0233;
    const ccomplex_t IT_0235 = IT_0033*IT_0234;
    const ccomplex_t IT_0236 = IT_0038*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = IT_0081*IT_0212;
    const ccomplex_t IT_0239 = IT_0079*IT_0238;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*IT_0239;
    const ccomplex_t IT_0241 = m_c*IT_0240;
    const ccomplex_t IT_0242 = cpow((-2)*s_13 + IT_0001 + IT_0037 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0243 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*mu_h*IT_0004*IT_0008;
    const ccomplex_t IT_0244 = 0.5*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_cd*e_em*IT_0004*IT_0008*IT_0031;
    ...
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0008;
    const ccomplex_t IT_0251 = IT_0043*IT_0250;
    const ccomplex_t IT_0252 = IT_0047*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0008;
    const ccomplex_t IT_0255 = IT_0052*IT_0254;
    const ccomplex_t IT_0256 = IT_0056*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0259 = IT_0173*IT_0258;
    const ccomplex_t IT_0260 = 1.4142135623731*IT_0259;
    const ccomplex_t IT_0261 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0262 = IT_0177*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = IT_0260 + IT_0263;
    const ccomplex_t IT_0265 = conj(N_d1)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0266 = IT_0173*IT_0265;
    ...
    const ccomplex_t IT_0271 = IT_0131*IT_0270;
    const ccomplex_t IT_0272 = IT_0059*IT_0076*IT_0271;
    const ccomplex_t IT_0273 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0274 = IT_0173*IT_0273;
    const ccomplex_t IT_0275 = (-2)*IT_0274;
    const ccomplex_t IT_0276 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0277 = IT_0177*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0286 = IT_0167*IT_0285;
    const ccomplex_t IT_0287 = IT_0000*IT_0003*IT_0286;
    const ccomplex_t IT_0288 = IT_0061*IT_0270;
    const ccomplex_t IT_0289 = IT_0076*IT_0288;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*IT_0289;
    const ccomplex_t IT_0291 = m_c*IT_0290;
    const ccomplex_t IT_0292 = IT_0010*IT_0285;
    ...
    const ccomplex_t IT_0296 = IT_0191 + -IT_0199 + -IT_0214 + -IT_0216 + 
      -IT_0227 + -IT_0237 + IT_0241 + -IT_0249 + -IT_0253 + -IT_0257 + -IT_0272 
    ...
    const ccomplex_t IT_0300 = -IT_0134 + -IT_0146 + -IT_0158 + -IT_0170;
    const ccomplex_t IT_0301 = m_c*s_12;
    const ccomplex_t IT_0302 = -IT_0190 + -IT_0240 + -IT_0290 + -IT_0294;
    const ccomplex_t IT_0303 = s_23*m_C_2;
    const ccomplex_t IT_0304 = 6*conj(IT_0172);
    const ccomplex_t IT_0305 = 6*conj(IT_0296);
    const ccomplex_t IT_0306 = m_c*m_C_2*IT_0002;
    const ccomplex_t IT_0307 = s_13*IT_0002;
