        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*mu_h*IT_0000*IT_0002;
    const ccomplex_t IT_0004 = 0.5*IT_0003;
    const ccomplex_t IT_0005 = sin(beta);
    const ccomplex_t IT_0006 = cpow(IT_0005, -1);
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
    ...
    const ccomplex_t IT_0037 = pow(m_sc_R, 2);
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0010 + IT_0037 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0039 = IT_0015*IT_0036*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0010 + IT_0037 + -m_N_2*
    ...
    const ccomplex_t IT_0058 = IT_0040*IT_0041*IT_0057;
    ...
    const ccomplex_t IT_0076 = cpow((-2)*s_23 + IT_0010 + IT_0037 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0059*IT_0075*IT_0076;
    const ccomplex_t IT_0078 = cpow(IT_0020, -1);
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0000*IT_0002*(mu_h*conj(U_sb_01) + m_b*IT_0006*IT_0078*conj(U_sb_11));
    const ccomplex_t IT_0080 = 0.5*IT_0079;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0000*IT_0002*IT_0006*U_sb_01;
    const ccomplex_t IT_0082 = 0.5*IT_0081;
    const ccomplex_t IT_0083 = IT_0080*IT_0082;
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0085 = IT_0083*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0093 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0099 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0000*IT_0002*(mu_h*conj(U_sb_00) + m_b*IT_0006*IT_0078*conj(U_sb_10));
    const ccomplex_t IT_0101 = 0.5*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0000*IT_0002*IT_0006*U_sb_00;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*mu_h*IT_0000*IT_0002;
    const ccomplex_t IT_0108 = 0.5*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0000*IT_0002*IT_0006;
    const ccomplex_t IT_0110 = 0.5*IT_0109;
    const ccomplex_t IT_0111 = IT_0108*IT_0110;
    const ccomplex_t IT_0112 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sd_L*
    ...
    const ccomplex_t IT_0120 = m_c*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0122 = cpow((-2)*s_23 + IT_0010 + IT_0037 + -m_N_4*
    ...
    const ccomplex_t IT_0139 = IT_0121*IT_0122*IT_0138;
    ...
    const ccomplex_t IT_0143 = IT_0122*IT_0142;
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*IT_0143;
    const ccomplex_t IT_0145 = m_c*IT_0144;
    const ccomplex_t IT_0146 = IT_0014 + -IT_0039 + -IT_0058 + -IT_0077 +
       IT_0086 + IT_0092 + IT_0098 + IT_0106 + IT_0114 + IT_0120 + -IT_0139 +
       IT_0145;
    const ccomplex_t IT_0147 = IT_0002*IT_0005;
    const ccomplex_t IT_0148 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0149 = IT_0147*IT_0148;
    const ccomplex_t IT_0150 = 1.4142135623731*IT_0149;
    const ccomplex_t IT_0151 = IT_0005*IT_0017;
    const ccomplex_t IT_0152 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0156 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0165 = m_c*IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0002;
    ...
    const ccomplex_t IT_0170 = IT_0088*IT_0161;
    const ccomplex_t IT_0171 = IT_0015*IT_0038*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0002;
    const ccomplex_t IT_0173 = IT_0108*IT_0172;
    const ccomplex_t IT_0174 = IT_0112*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*IT_0174;
    const ccomplex_t IT_0176 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*conj
      (V_cd)*e_em*IT_0000*IT_0002*IT_0006*IT_0078;
    const ccomplex_t IT_0178 = 0.5*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_cd*e_em*IT_0000*IT_0002*IT_0078;
    ...
    const ccomplex_t IT_0184 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0185 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0000*IT_0002*IT_0006*IT_0078;
    const ccomplex_t IT_0186 = 0.5*IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0000*IT_0002*IT_0078;
    ...
    const ccomplex_t IT_0192 = IT_0002*IT_0078;
    const ccomplex_t IT_0193 = m_b*conj(U_d2)*V_cb*e_em*IT_0000*U_sb_10;
    ...
    const ccomplex_t IT_0203 = m_b*conj(U_d2)*V_cb*e_em*IT_0000*U_sb_11;
    const ccomplex_t IT_0204 = IT_0192*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = V_cb*e_em*conj(U_Wm2)*U_sb_01;
    ...
    const ccomplex_t IT_0210 = IT_0080*IT_0209;
    const ccomplex_t IT_0211 = IT_0084*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*IT_0211;
    const ccomplex_t IT_0213 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0214 = IT_0147*IT_0213;
    const ccomplex_t IT_0215 = (-2)*IT_0214;
    const ccomplex_t IT_0216 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0217 = IT_0151*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = conj(N_W2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0220 = IT_0147*IT_0219;
    ...
    const ccomplex_t IT_0226 = IT_0094*IT_0225;
    const ccomplex_t IT_0227 = IT_0040*IT_0041*IT_0226;
    const ccomplex_t IT_0228 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0229 = IT_0147*IT_0228;
    const ccomplex_t IT_0230 = (-2)*IT_0229;
    const ccomplex_t IT_0231 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0232 = IT_0151*IT_0231;
    const ccomplex_t IT_0233 = 1.4142135623731*IT_0232;
    const ccomplex_t IT_0234 = conj(N_W3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0235 = IT_0147*IT_0234;
    ...
    const ccomplex_t IT_0241 = IT_0116*IT_0240;
    const ccomplex_t IT_0242 = IT_0059*IT_0076*IT_0241;
    const ccomplex_t IT_0243 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0244 = IT_0147*IT_0243;
    const ccomplex_t IT_0245 = (-2)*IT_0244;
    const ccomplex_t IT_0246 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0247 = IT_0151*IT_0246;
    const ccomplex_t IT_0248 = 1.4142135623731*IT_0247;
    const ccomplex_t IT_0249 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0256 = IT_0141*IT_0255;
    const ccomplex_t IT_0257 = IT_0121*IT_0122*IT_0256;
    const ccomplex_t IT_0258 = IT_0043*IT_0225;
    ...
    const ccomplex_t IT_0262 = IT_0061*IT_0240;
    const ccomplex_t IT_0263 = IT_0076*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = m_c*IT_0264;
    const ccomplex_t IT_0266 = IT_0124*IT_0255;
    const ccomplex_t IT_0267 = IT_0122*IT_0266;
    const ccomplex_t IT_0268 = (0 + _Complex_I*1)*IT_0267;
    const ccomplex_t IT_0269 = m_c*IT_0268;
    const ccomplex_t IT_0270 = IT_0165 + -IT_0169 + -IT_0171 + -IT_0175 + 
      -IT_0183 + -IT_0191 + -IT_0202 + -IT_0212 + -IT_0227 + -IT_0242 + -IT_0257
    ...
    const ccomplex_t IT_0274 = -IT_0091 + -IT_0097 + -IT_0119 + -IT_0144;
    const ccomplex_t IT_0275 = m_c*s_12;
    const ccomplex_t IT_0276 = -IT_0164 + -IT_0260 + -IT_0264 + -IT_0268;
    const ccomplex_t IT_0277 = s_23*m_C_2;
    const ccomplex_t IT_0278 = 6*conj(IT_0146);
    const ccomplex_t IT_0279 = 6*conj(IT_0270);
    const ccomplex_t IT_0280 = m_c*m_C_2*IT_0037;
    const ccomplex_t IT_0281 = s_13*IT_0037;
