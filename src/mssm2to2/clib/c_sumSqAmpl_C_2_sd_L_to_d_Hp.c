        ...
        )
{
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*(IT_0051 + (-3)*IT_0054);
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0027 + -IT_0061 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm2)*IT_0005;
    const ccomplex_t IT_0064 = sin(beta);
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_td)
      *e_em*IT_0001*IT_0003*IT_0005*IT_0064;
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0110 = cpow((-2)*s_12 + -IT_0027 + -IT_0061 + IT_0109 
      + -reg_prop, -1);
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0112 = cpow(IT_0064, -1);
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0001*IT_0005*IT_0112;
    ...
    const ccomplex_t IT_0118 = IT_0110*IT_0111*IT_0117;
    const ccomplex_t IT_0119 = pow(m_u, 2);
    const ccomplex_t IT_0120 = cpow((-2)*s_12 + -IT_0027 + -IT_0061 + IT_0119 
      + -reg_prop, -1);
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0001*IT_0005*IT_0112;
    const ccomplex_t IT_0123 = 0.5*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0001*IT_0003*IT_0005*IT_0064;
    const ccomplex_t IT_0125 = 0.5*IT_0124;
    const ccomplex_t IT_0126 = IT_0123*IT_0125;
    const ccomplex_t IT_0127 = IT_0120*IT_0121*IT_0126;
    ...
    const ccomplex_t IT_0149 = IT_0072*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*IT_0149;
    const ccomplex_t IT_0151 = m_d*IT_0150;
    ...
    const ccomplex_t IT_0160 = IT_0106*IT_0159;
    const ccomplex_t IT_0161 = IT_0091*IT_0160;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*IT_0161;
    const ccomplex_t IT_0163 = m_d*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0175 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u2
      *e_em*IT_0001*IT_0005*IT_0112;
    const ccomplex_t IT_0176 = 0.5*IT_0175;
    const ccomplex_t IT_0177 = IT_0066*IT_0176;
    const ccomplex_t IT_0178 = IT_0062*IT_0174*IT_0177;
    const ccomplex_t IT_0179 = -IT_0029 + -IT_0048 + IT_0060 + IT_0070 + 
      -IT_0089 + -IT_0108 + -IT_0118 + -IT_0127 + IT_0139 + IT_0151 + IT_0163 +
       IT_0168 + IT_0173 + -IT_0178;
    const ccomplex_t IT_0180 = IT_0005*IT_0064;
    const ccomplex_t IT_0181 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0182 = IT_0180*IT_0181;
    const ccomplex_t IT_0183 = (-2)*IT_0182;
    const ccomplex_t IT_0184 = IT_0013*IT_0064;
    ...
    const ccomplex_t IT_0195 = IT_0147*IT_0194;
    const ccomplex_t IT_0196 = IT_0071*IT_0072*IT_0195;
    const ccomplex_t IT_0197 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0198 = IT_0180*IT_0197;
    const ccomplex_t IT_0199 = (-2)*IT_0198;
    const ccomplex_t IT_0200 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0201 = IT_0184*IT_0200;
    const ccomplex_t IT_0202 = 1.4142135623731*IT_0201;
    const ccomplex_t IT_0203 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0211 = IT_0030*IT_0047*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
      *e_em*IT_0001*IT_0002*IT_0005*IT_0112;
    const ccomplex_t IT_0213 = 0.5*IT_0212;
    const ccomplex_t IT_0214 = IT_0063*IT_0213;
    const ccomplex_t IT_0215 = IT_0062*IT_0174*IT_0214;
    const ccomplex_t IT_0216 = IT_0032*IT_0209;
    const ccomplex_t IT_0217 = IT_0047*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*IT_0217;
    const ccomplex_t IT_0219 = m_d*IT_0218;
    const ccomplex_t IT_0220 = IT_0176*IT_0213;
    ...
    const ccomplex_t IT_0224 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0001*IT_0002*IT_0005*IT_0112;
    ...
    const ccomplex_t IT_0233 = IT_0110*IT_0111*IT_0232;
    const ccomplex_t IT_0234 = IT_0169*IT_0225;
    const ccomplex_t IT_0235 = IT_0120*IT_0121*IT_0234;
    const ccomplex_t IT_0236 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0237 = IT_0180*IT_0236;
    const ccomplex_t IT_0238 = 1.4142135623731*IT_0237;
    const ccomplex_t IT_0239 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0240 = IT_0184*IT_0239;
    const ccomplex_t IT_0241 = 1.4142135623731*IT_0240;
    const ccomplex_t IT_0242 = IT_0238 + IT_0241;
    const ccomplex_t IT_0243 = conj(N_d1)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0244 = IT_0180*IT_0243;
    ...
    const ccomplex_t IT_0249 = IT_0135*IT_0248;
    const ccomplex_t IT_0250 = IT_0000*IT_0028*IT_0249;
    const ccomplex_t IT_0251 = IT_0007*IT_0248;
    const ccomplex_t IT_0252 = IT_0028*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = m_d*IT_0253;
    const ccomplex_t IT_0255 = IT_0074*IT_0194;
    const ccomplex_t IT_0256 = IT_0072*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = m_d*IT_0257;
    const ccomplex_t IT_0259 = IT_0114*IT_0231;
    ...
    const ccomplex_t IT_0263 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0264 = IT_0180*IT_0263;
    const ccomplex_t IT_0265 = (-2)*IT_0264;
    const ccomplex_t IT_0266 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0267 = IT_0184*IT_0266;
    const ccomplex_t IT_0268 = 1.4142135623731*IT_0267;
    const ccomplex_t IT_0269 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0278 = IT_0093*IT_0275;
    const ccomplex_t IT_0279 = IT_0091*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*IT_0279;
    const ccomplex_t IT_0281 = m_d*IT_0280;
    const ccomplex_t IT_0282 = -IT_0196 + -IT_0211 + IT_0215 + IT_0219 + 
      -IT_0223 + -IT_0229 + IT_0233 + IT_0235 + -IT_0250 + IT_0254 + IT_0258 + 
    ...
    const ccomplex_t IT_0286 = -IT_0059 + -IT_0138 + -IT_0150 + -IT_0162 + 
      -IT_0222 + -IT_0228 + -IT_0261;
    const ccomplex_t IT_0287 = m_d*s_12;
    const ccomplex_t IT_0288 = IT_0069 + IT_0167 + IT_0172 + -IT_0218 + 
      -IT_0253 + -IT_0257 + -IT_0280;
