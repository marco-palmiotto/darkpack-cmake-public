...
ccomplex_return_t c_sumSqAmpl_C_2_sd_L_to_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
    ...
    const ccomplex_t IT_0033 = N_u2*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0067 = IT_0049*IT_0065*IT_0066;
    const ccomplex_t IT_0068 = pow(m_c, 2);
    const ccomplex_t IT_0069 = pow(m_C_2, 2);
    const ccomplex_t IT_0070 = cpow((-2)*s_12 + -IT_0027 + IT_0068 + -IT_0069 
      + -reg_prop, -1);
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0072 = sin(beta);
    const ccomplex_t IT_0073 = cpow(IT_0072, -1);
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0001*IT_0005*IT_0073;
    const ccomplex_t IT_0075 = 0.5*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*IT_0001*IT_0003*IT_0005*IT_0072;
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = IT_0075*IT_0077;
    const ccomplex_t IT_0079 = IT_0070*IT_0071*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0081 = cpow((-2)*s_12 + -IT_0027 + -IT_0069 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u2
      *e_em*IT_0001*IT_0005*IT_0073;
    const ccomplex_t IT_0083 = 0.5*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_td)
      *e_em*IT_0001*IT_0003*IT_0005*IT_0072;
    const ccomplex_t IT_0085 = 0.5*IT_0084;
    const ccomplex_t IT_0086 = IT_0083*IT_0085;
    const ccomplex_t IT_0087 = IT_0080*IT_0081*IT_0086;
    const ccomplex_t IT_0088 = pow(m_u, 2);
    const ccomplex_t IT_0089 = cpow((-2)*s_12 + -IT_0027 + -IT_0069 + IT_0088 
      + -reg_prop, -1);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0001*IT_0005*IT_0073;
    const ccomplex_t IT_0092 = 0.5*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0001*IT_0003*IT_0005*IT_0072;
    const ccomplex_t IT_0094 = 0.5*IT_0093;
    const ccomplex_t IT_0095 = IT_0092*IT_0094;
    const ccomplex_t IT_0096 = IT_0089*IT_0090*IT_0095;
    const ccomplex_t IT_0097 = conj(N_B1)*e_em;
    const ccomplex_t IT_0098 = IT_0013*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0117 = IT_0045*IT_0116;
    ...
    const ccomplex_t IT_0129 = IT_0064*IT_0128;
    const ccomplex_t IT_0130 = IT_0066*IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*IT_0130;
    const ccomplex_t IT_0132 = m_d*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0138 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0149 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0151 = (-0.5)*IT_0150;
    const ccomplex_t IT_0152 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0153 = IT_0008*IT_0152;
    const ccomplex_t IT_0154 = 2*IT_0153;
    const ccomplex_t IT_0155 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0156 = IT_0014*IT_0155;
    const ccomplex_t IT_0157 = 1.4142135623731*IT_0156;
    const ccomplex_t IT_0158 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0166 = IT_0148*IT_0149*IT_0165;
    ...
    const ccomplex_t IT_0179 = -IT_0029 + -IT_0048 + -IT_0067 + -IT_0079 + 
      -IT_0087 + -IT_0096 + IT_0108 + IT_0120 + IT_0132 + IT_0137 + IT_0142 +
       IT_0147 + -IT_0166 + IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0001*IT_0002*IT_0005*IT_0073;
    const ccomplex_t IT_0181 = 0.5*IT_0180;
    const ccomplex_t IT_0182 = IT_0143*IT_0181;
    const ccomplex_t IT_0183 = IT_0089*IT_0090*IT_0182;
    const ccomplex_t IT_0184 = IT_0005*IT_0072;
    const ccomplex_t IT_0185 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0186 = IT_0184*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = IT_0013*IT_0072;
    ...
    const ccomplex_t IT_0199 = IT_0104*IT_0198;
    const ccomplex_t IT_0200 = IT_0000*IT_0028*IT_0199;
    ...
    const ccomplex_t IT_0216 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0217 = IT_0184*IT_0216;
    const ccomplex_t IT_0218 = (-2)*IT_0217;
    const ccomplex_t IT_0219 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0220 = IT_0188*IT_0219;
    const ccomplex_t IT_0221 = 1.4142135623731*IT_0220;
    const ccomplex_t IT_0222 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0229 = IT_0128*IT_0228;
    const ccomplex_t IT_0230 = IT_0049*IT_0066*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
      *e_em*IT_0001*IT_0002*IT_0005*IT_0073;
    const ccomplex_t IT_0232 = 0.5*IT_0231;
    const ccomplex_t IT_0233 = IT_0138*IT_0232;
    const ccomplex_t IT_0234 = IT_0080*IT_0081*IT_0233;
    const ccomplex_t IT_0235 = IT_0007*IT_0198;
    const ccomplex_t IT_0236 = IT_0028*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = m_d*IT_0237;
    const ccomplex_t IT_0239 = IT_0032*IT_0213;
    const ccomplex_t IT_0240 = IT_0047*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*IT_0240;
    const ccomplex_t IT_0242 = m_d*IT_0241;
    const ccomplex_t IT_0243 = IT_0051*IT_0228;
    ...
    const ccomplex_t IT_0260 = IT_0151*IT_0259;
    const ccomplex_t IT_0261 = IT_0149*IT_0260;
    const ccomplex_t IT_0262 = (0 + _Complex_I*1)*IT_0261;
    const ccomplex_t IT_0263 = m_d*IT_0262;
    const ccomplex_t IT_0264 = IT_0174*IT_0259;
    const ccomplex_t IT_0265 = IT_0148*IT_0149*IT_0264;
    const ccomplex_t IT_0266 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*IT_0001*IT_0002*IT_0005*IT_0073;
    const ccomplex_t IT_0267 = 0.5*IT_0266;
    const ccomplex_t IT_0268 = IT_0133*IT_0267;
    const ccomplex_t IT_0269 = IT_0070*IT_0071*IT_0268;
    const ccomplex_t IT_0270 = IT_0075*IT_0267;
    const ccomplex_t IT_0271 = IT_0070*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*IT_0271;
    const ccomplex_t IT_0273 = m_C_2*IT_0272;
    const ccomplex_t IT_0274 = IT_0083*IT_0232;
    const ccomplex_t IT_0275 = IT_0081*IT_0274;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1)*IT_0275;
    const ccomplex_t IT_0277 = m_C_2*IT_0276;
    const ccomplex_t IT_0278 = IT_0092*IT_0181;
    const ccomplex_t IT_0279 = IT_0089*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*IT_0279;
    const ccomplex_t IT_0281 = m_C_2*IT_0280;
    const ccomplex_t IT_0282 = IT_0183 + -IT_0200 + -IT_0215 + -IT_0230 +
       IT_0234 + IT_0238 + IT_0242 + IT_0246 + IT_0263 + -IT_0265 + IT_0269 + 
      -IT_0273 + -IT_0277 + -IT_0281;
    const ccomplex_t IT_0283 = 6*s_13;
    const ccomplex_t IT_0284 = m_d*m_C_2;
    const ccomplex_t IT_0285 = 6*IT_0179;
    const ccomplex_t IT_0286 = -IT_0107 + -IT_0119 + -IT_0131 + -IT_0177 + 
      -IT_0272 + -IT_0276 + -IT_0280;
    const ccomplex_t IT_0287 = m_d*s_12;
    const ccomplex_t IT_0288 = IT_0136 + IT_0141 + IT_0146 + -IT_0237 + 
      -IT_0241 + -IT_0245 + -IT_0262;
    const ccomplex_t IT_0289 = s_23*m_C_2;
    const ccomplex_t IT_0290 = 6*conj(IT_0179);
    const ccomplex_t IT_0291 = 6*conj(IT_0282);
    const ccomplex_t IT_0292 = m_d*m_C_2*IT_0027;
