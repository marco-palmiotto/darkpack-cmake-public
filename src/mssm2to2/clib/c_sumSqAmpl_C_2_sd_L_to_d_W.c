        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0009 = (-0.5)*IT_0008;
    const ccomplex_t IT_0010 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0011 = IT_0007*IT_0010;
    const ccomplex_t IT_0012 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0021 = (-0.5)*IT_0020;
    const ccomplex_t IT_0022 = conj(N_W4)*e_em*V_Wp2;
    const ccomplex_t IT_0023 = IT_0007*IT_0022;
    const ccomplex_t IT_0024 = conj(N_u4)*V_u2*e_em;
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
    ...
    const ccomplex_t IT_0077 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0078 = IT_0007*IT_0077;
    const ccomplex_t IT_0079 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0113 = N_W2*e_em*conj(U_Wm2);
    const ccomplex_t IT_0114 = IT_0007*IT_0113;
    const ccomplex_t IT_0115 = N_d2*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0149 = cpow((-2)*s_12 + -IT_0001 + -IT_0063 + IT_0148 
      + -reg_prop, -1);
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0007;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0007;
    ...
    const ccomplex_t IT_0156 = cpow((-2)*s_12 + -IT_0001 + -IT_0063 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm2)*IT_0007;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
      *e_em*IT_0007;
    const ccomplex_t IT_0159 = 0.5*IT_0158;
    const ccomplex_t IT_0160 = IT_0157*IT_0159;
    const ccomplex_t IT_0161 = IT_0156*IT_0160;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*IT_0161;
    const ccomplex_t IT_0163 = IT_0155 + IT_0162;
    const ccomplex_t IT_0164 = pow(m_c, 2);
    const ccomplex_t IT_0165 = cpow((-2)*s_12 + -IT_0001 + -IT_0063 + IT_0164 
      + -reg_prop, -1);
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0007;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*conj(V_cd)
      *e_em*IT_0007;
    ...
    const ccomplex_t IT_0173 = (-3)*IT_0146;
    const ccomplex_t IT_0174 = IT_0086 + IT_0122 + IT_0140;
    const ccomplex_t IT_0175 = IT_0104 + IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0177 = IT_0028*IT_0130;
    const ccomplex_t IT_0178 = IT_0030*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0180 = sin(beta);
    const ccomplex_t IT_0181 = cpow(IT_0180, -1);
    const ccomplex_t IT_0182 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0003*IT_0007*IT_0181;
    const ccomplex_t IT_0183 = 0.5*IT_0182;
    const ccomplex_t IT_0184 = IT_0168*IT_0183;
    const ccomplex_t IT_0185 = IT_0165*IT_0179*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u2
      *e_em*IT_0003*IT_0007*IT_0181;
    const ccomplex_t IT_0188 = 0.5*IT_0187;
    const ccomplex_t IT_0189 = IT_0159*IT_0188;
    const ccomplex_t IT_0190 = IT_0156*IT_0186*IT_0189;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0192 = IT_0041*IT_0076;
    const ccomplex_t IT_0193 = IT_0043*IT_0191*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0003*IT_0007*IT_0181;
    const ccomplex_t IT_0196 = 0.5*IT_0195;
    const ccomplex_t IT_0197 = IT_0152*IT_0196;
    const ccomplex_t IT_0198 = IT_0149*IT_0194*IT_0197;
    const ccomplex_t IT_0199 = m_C_2*IT_0086;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0201 = IT_0055*IT_0112;
    const ccomplex_t IT_0202 = IT_0046*IT_0200*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0204 = IT_0016*IT_0094;
    const ccomplex_t IT_0205 = IT_0002*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = m_C_2*IT_0122;
    const ccomplex_t IT_0207 = m_C_2*IT_0104;
    const ccomplex_t IT_0208 = m_C_2*IT_0140;
    const ccomplex_t IT_0209 = -IT_0178 + -IT_0185 + -IT_0190 + -IT_0193 + 
      -IT_0198 + IT_0199 + -IT_0202 + -IT_0205 + IT_0206 + IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = m_d*IT_0065;
    const ccomplex_t IT_0211 = s_14*IT_0145;
    const ccomplex_t IT_0212 = IT_0060*IT_0211;
    const ccomplex_t IT_0213 = 0.5*IT_0212;
    const ccomplex_t IT_0214 = s_14 + IT_0213;
    const ccomplex_t IT_0215 = m_d*IT_0214;
    const ccomplex_t IT_0216 = 2*IT_0215;
    const ccomplex_t IT_0217 = s_34*IT_0145;
    ...
    const ccomplex_t IT_0223 = (-0.25)*IT_0218;
    const ccomplex_t IT_0224 = s_34 + IT_0223;
    const ccomplex_t IT_0225 = m_C_2*IT_0224;
    const ccomplex_t IT_0226 = (-4)*IT_0225;
    const ccomplex_t IT_0227 = pow(m_W, 4);
    const ccomplex_t IT_0228 = s_13*IT_0227;
    const ccomplex_t IT_0229 = IT_0060*IT_0228;
    const ccomplex_t IT_0230 = s_14*s_34;
    const ccomplex_t IT_0231 = 24*IT_0230;
    const ccomplex_t IT_0232 = s_13*IT_0145;
    const ccomplex_t IT_0233 = (-12)*IT_0232;
    const ccomplex_t IT_0234 = 6*IT_0229 + IT_0231 + IT_0233;
    const ccomplex_t IT_0235 = conj(IT_0163) + conj(IT_0171);
    const ccomplex_t IT_0236 = conj(IT_0104) + conj(IT_0174);
    const ccomplex_t IT_0237 = (-24)*IT_0230;
    const ccomplex_t IT_0238 = 6*IT_0229 + IT_0237;
    const ccomplex_t IT_0239 = 12*s_13;
    const ccomplex_t IT_0240 = (-2)*IT_0230;
    ...
    const ccomplex_t IT_0245 = s_14*s_34*IT_0060;
    const ccomplex_t IT_0246 = -IT_0245;
    const ccomplex_t IT_0247 = s_13 + IT_0246;
    const ccomplex_t IT_0248 = m_C_2*IT_0247;
    const ccomplex_t IT_0249 = (-6)*conj(IT_0209);
    const ccomplex_t IT_0250 = 2*IT_0155 + 2*IT_0162 + 2*IT_0171;
    const ccomplex_t IT_0251 = IT_0142*IT_0247;
    const ccomplex_t IT_0252 = (-6)*conj(IT_0059);
    const ccomplex_t IT_0253 = s_13*IT_0247;
    const ccomplex_t IT_0254 = (-6)*conj(IT_0141);
    const ccomplex_t IT_0255 = pow(s_34, 2);
    const ccomplex_t IT_0256 = IT_0060*IT_0255;
    const ccomplex_t IT_0257 = -IT_0256;
    const ccomplex_t IT_0258 = IT_0000 + IT_0257;
    const ccomplex_t IT_0259 = m_C_2*IT_0258;
    const ccomplex_t IT_0260 = (-6)*IT_0141;
    const ccomplex_t IT_0261 = (-6)*IT_0209;
    const ccomplex_t IT_0262 = s_13*IT_0258;
    const ccomplex_t IT_0263 = (-6)*IT_0250;
    const ccomplex_t IT_0264 = 6*IT_0141;
    const ccomplex_t IT_0265 = 6*conj(IT_0141);
    const ccomplex_t IT_0266 = IT_0034*IT_0083;
    const ccomplex_t IT_0267 = IT_0043*IT_0191*IT_0266;
    const ccomplex_t IT_0268 = IT_0021*IT_0137;
    const ccomplex_t IT_0269 = IT_0030*IT_0176*IT_0268;
    const ccomplex_t IT_0270 = m_C_2*IT_0019;
    const ccomplex_t IT_0271 = m_d*IT_0171;
    const ccomplex_t IT_0272 = IT_0048*IT_0119;
    const ccomplex_t IT_0273 = IT_0046*IT_0200*IT_0272;
    const ccomplex_t IT_0274 = IT_0009*IT_0101;
    const ccomplex_t IT_0275 = IT_0002*IT_0203*IT_0274;
    const ccomplex_t IT_0276 = m_C_2*IT_0045;
    const ccomplex_t IT_0277 = m_C_2*IT_0058;
    const ccomplex_t IT_0278 = m_C_2*IT_0032;
    const ccomplex_t IT_0279 = m_d*IT_0162;
    const ccomplex_t IT_0280 = m_d*IT_0155;
    const ccomplex_t IT_0281 = IT_0267 + IT_0269 + -IT_0270 + -IT_0271 +
       IT_0273 + IT_0275 + -IT_0276 + -IT_0277 + -IT_0278 + -IT_0279 + -IT_0280;
    const ccomplex_t IT_0282 = (-0.25)*IT_0212;
    const ccomplex_t IT_0283 = s_14 + IT_0282;
    const ccomplex_t IT_0284 = m_d*IT_0283;
    const ccomplex_t IT_0285 = (-4)*IT_0284;
    const ccomplex_t IT_0286 = m_d*IT_0247;
    const ccomplex_t IT_0287 = (-6)*conj(IT_0250);
    const ccomplex_t IT_0288 = IT_0281*((-18)*IT_0142*conj(IT_0209) + 6*conj
      (IT_0144)*IT_0226 + 6*IT_0216*IT_0236 + IT_0248*IT_0252 + IT_0210*IT_0265 
      + IT_0244*conj(IT_0281) + 6*IT_0235*IT_0285 + IT_0286*IT_0287);
    const ccomplex_t IT_0289 = 6*IT_0144;
    ...
    const ccomplex_t IT_0294 = 0.166666666666667*IT_0235;
    ...
    const ccomplex_t IT_0299 = 6*conj(IT_0059)*(IT_0059*IT_0066 + IT_0141
      *IT_0143) + 6*conj(IT_0144)*(IT_0147*IT_0172 + IT_0173*IT_0175) + 6*conj
      (IT_0209)*(IT_0059*IT_0210 + IT_0144*IT_0216 + IT_0172*IT_0222 + IT_0175
      *IT_0226) + IT_0234*(IT_0144*conj(IT_0144) + IT_0172*IT_0235 + (IT_0104 +
       IT_0174)*IT_0236) + (IT_0175*IT_0235 + IT_0172*IT_0236)*IT_0238 + 6
      *IT_0209*(conj(IT_0059)*IT_0210 + conj(IT_0144)*IT_0216 + IT_0222*IT_0235 
      + IT_0226*IT_0236 + 0.166666666666667*conj(IT_0209)*IT_0244) + IT_0141
      *IT_0248*IT_0249 + IT_0250*(IT_0251*IT_0252 + IT_0253*IT_0254 + IT_0249
      *IT_0259) + (-6)*conj(IT_0250)*(IT_0059*IT_0251 + (-0.166666666666667)
      *IT_0253*IT_0260 + (-0.166666666666667)*IT_0259*IT_0261 + (
      -0.166666666666667)*IT_0262*IT_0263) + (IT_0059*IT_0143 +
       0.166666666666667*IT_0248*IT_0261 + 0.166666666666667*IT_0066*IT_0264)
      *IT_0265 + IT_0288 + (IT_0147*IT_0235 + IT_0173*IT_0236)*IT_0289 + conj
      (IT_0281)*((-18)*IT_0142*IT_0209 + 6*IT_0175*IT_0216 + (-6)*IT_0059
      *IT_0248 + IT_0210*IT_0264 + 6*IT_0172*IT_0285 + IT_0263*IT_0286 + IT_0226
      *IT_0289) + 6*IT_0293*(conj(IT_0059)*IT_0144 + IT_0059*conj(IT_0144) +
       conj(IT_0141)*IT_0175 + 0.166666666666667*IT_0172*IT_0254 +
       0.166666666666667*IT_0236*IT_0264 + IT_0260*IT_0294) + 6*(IT_0236*IT_0250
       + IT_0175*conj(IT_0250) + 0.166666666666667*IT_0172*IT_0287 + IT_0263
      *IT_0294)*IT_0298;
