        ...
        )
{
    ...
    const ccomplex_t IT_0074 = IT_0015 + IT_0023 + -IT_0038 + -IT_0051 + 
      -IT_0062 + -IT_0073;
    const ccomplex_t IT_0075 = m_d*e_em*mu_h*IT_0003;
    const ccomplex_t IT_0076 = IT_0007*IT_0075;
    const ccomplex_t IT_0077 = A_b*V_td*conj(V_td);
    ...
    const ccomplex_t IT_0097 = e_em*conj(U_Wm2)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0098 = IT_0096*IT_0097;
    const ccomplex_t IT_0099 = IT_0004*IT_0007*IT_0081;
    const ccomplex_t IT_0100 = m_b*conj(U_d2)*e_em*IT_0003*U_sb_10*V_ub_mod;
    ...
    const ccomplex_t IT_0107 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0108 = IT_0096*IT_0107;
    const ccomplex_t IT_0109 = m_b*conj(U_d2)*e_em*IT_0003*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0117 = IT_0058*IT_0116;
    const ccomplex_t IT_0118 = IT_0024*IT_0037*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0007;
    const ccomplex_t IT_0120 = IT_0069*IT_0119;
    const ccomplex_t IT_0121 = IT_0039*IT_0050*IT_0120;
    const ccomplex_t IT_0122 = IT_0034*IT_0116;
    ...
    const ccomplex_t IT_0126 = IT_0048*IT_0119;
    const ccomplex_t IT_0127 = IT_0050*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*IT_0127;
    const ccomplex_t IT_0129 = m_C_2*IT_0128;
    const ccomplex_t IT_0130 = -IT_0087 + -IT_0095 + -IT_0106 + -IT_0115 +
       IT_0118 + IT_0121 + IT_0125 + IT_0129;
    ...
    const ccomplex_t IT_0140 = -IT_0124 + -IT_0128 + -IT_0139;
    const ccomplex_t IT_0141 = m_u*s_14;
    const ccomplex_t IT_0142 = IT_0119*IT_0136;
