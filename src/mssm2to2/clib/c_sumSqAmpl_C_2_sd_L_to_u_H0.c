        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0020 = IT_0016*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0004*conj(U_sb_10);
    const ccomplex_t IT_0023 = (-0.5)*IT_0022;
    const ccomplex_t IT_0024 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0000*IT_0006*IT_0013*IT_0024*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0026 = 0.5*IT_0025;
    const ccomplex_t IT_0027 = IT_0023*IT_0026;
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0029 = IT_0027*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0004*conj(U_sb_11);
    const ccomplex_t IT_0032 = (-0.5)*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0000*IT_0006*IT_0013*IT_0024*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = IT_0032*IT_0034;
    const ccomplex_t IT_0036 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0000*IT_0006*IT_0013;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = U_d1*V_Wp2;
    const ccomplex_t IT_0043 = IT_0004*IT_0042;
    const ccomplex_t IT_0044 = V_u2*U_Wm1;
    const ccomplex_t IT_0045 = IT_0008*IT_0044;
    const ccomplex_t IT_0046 = IT_0006*(IT_0043 + IT_0045);
    ...
    const ccomplex_t IT_0051 = pow(m_sd_L, 2);
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0017 + IT_0051 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0039*IT_0050*IT_0052;
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0017 + IT_0051 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0065 = IT_0054*IT_0063*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_12 + IT_0017 + -IT_0018 + -IT_0051 
      + -reg_prop, -1);
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0006
      *IT_0008*IT_0013;
    ...
    const ccomplex_t IT_0073 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0077 = IT_0006*(IT_0074 + IT_0076);
    ...
    const ccomplex_t IT_0085 = conj(U_d2)*conj(V_Wp2);
    const ccomplex_t IT_0086 = IT_0004*IT_0085;
    const ccomplex_t IT_0087 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0088 = IT_0008*IT_0087;
    const ccomplex_t IT_0089 = IT_0006*(IT_0086 + IT_0088);
    ...
    const ccomplex_t IT_0097 = IT_0021 + IT_0030 + IT_0038 + -IT_0053 + 
      -IT_0065 + (-2)*IT_0072 + -IT_0084 + -IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0004 + -m_d*e_em*mu_h*IT_0000*IT_0003*IT_0006*IT_0008);
    const ccomplex_t IT_0099 = (-0.5)*IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0101 = (-0.5)*IT_0100;
    const ccomplex_t IT_0102 = IT_0099*IT_0101;
    const ccomplex_t IT_0103 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0104 = IT_0102*IT_0103;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0004;
    const ccomplex_t IT_0107 = (-0.5)*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_us*e_em*IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0109 = (-0.5)*IT_0108;
    const ccomplex_t IT_0110 = IT_0107*IT_0109;
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0112 = IT_0110*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*IT_0112;
    const ccomplex_t IT_0114 = IT_0006*IT_0024;
    const ccomplex_t IT_0115 = e_em*conj(U_Wm2)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0116 = IT_0114*IT_0115;
    const ccomplex_t IT_0117 = IT_0003*IT_0006*IT_0024;
    const ccomplex_t IT_0118 = m_b*conj(U_d2)*e_em*IT_0000*U_sb_10*V_ub_mod;
    const ccomplex_t IT_0119 = IT_0117*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*(IT_0116 + (-0.5)*IT_0120);
    ...
    const ccomplex_t IT_0125 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0126 = IT_0114*IT_0125;
    const ccomplex_t IT_0127 = m_b*conj(U_d2)*e_em*IT_0000*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0006;
    const ccomplex_t IT_0135 = IT_0080*IT_0134;
    const ccomplex_t IT_0136 = IT_0039*IT_0052*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0006;
    const ccomplex_t IT_0138 = IT_0092*IT_0137;
    const ccomplex_t IT_0139 = IT_0054*IT_0064*IT_0138;
    const ccomplex_t IT_0140 = IT_0068*IT_0137;
    ...
    const ccomplex_t IT_0144 = IT_0049*IT_0134;
    ...
    const ccomplex_t IT_0148 = IT_0062*IT_0137;
    const ccomplex_t IT_0149 = IT_0064*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*IT_0149;
    const ccomplex_t IT_0151 = m_C_2*IT_0150;
    const ccomplex_t IT_0152 = IT_0012*IT_0137;
    const ccomplex_t IT_0153 = IT_0019*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*IT_0153;
    const ccomplex_t IT_0155 = -IT_0105 + -IT_0113 + -IT_0124 + -IT_0133 +
       IT_0136 + IT_0139 + 2*IT_0143 + IT_0147 + IT_0151 + -IT_0154;
    const ccomplex_t IT_0156 = 6*s_13;
    const ccomplex_t IT_0157 = m_u*m_C_2;
    const ccomplex_t IT_0158 = 6*IT_0097;
    const ccomplex_t IT_0159 = -IT_0071 + -IT_0146 + -IT_0150;
    const ccomplex_t IT_0160 = m_u*s_14;
    const ccomplex_t IT_0161 = IT_0083 + IT_0095 + IT_0142;
