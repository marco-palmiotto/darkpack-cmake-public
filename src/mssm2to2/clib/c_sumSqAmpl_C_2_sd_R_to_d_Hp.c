        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0013 = IT_0011*IT_0012;
    const ccomplex_t IT_0014 = 2*IT_0013;
    const ccomplex_t IT_0015 = IT_0005*IT_0008;
    const ccomplex_t IT_0016 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = 1.4142135623731*IT_0017;
    const ccomplex_t IT_0019 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0027 = IT_0000*IT_0003*IT_0026;
    ...
    const ccomplex_t IT_0035 = m_d*IT_0034;
    const ccomplex_t IT_0036 = pow(m_c, 2);
    const ccomplex_t IT_0037 = pow(m_C_2, 2);
    const ccomplex_t IT_0038 = cpow((-2)*s_12 + -IT_0002 + IT_0036 + -IT_0037 
      + -reg_prop, -1);
    const ccomplex_t IT_0039 = sin(beta);
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*IT_0010*IT_0028*IT_0029*IT_0039;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_cd*e_em*IT_0010*IT_0028*IT_0029;
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0086 = IT_0068*IT_0084*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0105 = IT_0087*IT_0088*IT_0104;
    ...
    const ccomplex_t IT_0109 = IT_0062*IT_0108;
    const ccomplex_t IT_0110 = IT_0064*IT_0106*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0010*IT_0028*IT_0029;
    ...
    const ccomplex_t IT_0120 = IT_0088*IT_0119;
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_td*e_em*IT_0010*IT_0028*IT_0029;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = IT_0124*IT_0126;
    const ccomplex_t IT_0128 = cpow((-2)*s_12 + -IT_0002 + -IT_0037 + 
    ...
    const ccomplex_t IT_0142 = -IT_0027 + IT_0035 + IT_0047 + IT_0067 + 
      -IT_0086 + -IT_0105 + -IT_0110 + IT_0116 + IT_0122 + IT_0131 + IT_0141;
    const ccomplex_t IT_0143 = IT_0010*IT_0039;
    const ccomplex_t IT_0144 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0145 = IT_0143*IT_0144;
    const ccomplex_t IT_0146 = (-2)*IT_0145;
    const ccomplex_t IT_0147 = IT_0005*IT_0039;
    ...
    const ccomplex_t IT_0158 = IT_0118*IT_0157;
    const ccomplex_t IT_0159 = IT_0087*IT_0088*IT_0158;
    const ccomplex_t IT_0160 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0161 = IT_0143*IT_0160;
    const ccomplex_t IT_0162 = (-2)*IT_0161;
    const ccomplex_t IT_0163 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0164 = IT_0147*IT_0163;
    const ccomplex_t IT_0165 = 1.4142135623731*IT_0164;
    const ccomplex_t IT_0166 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0173 = IT_0049*IT_0172;
    const ccomplex_t IT_0174 = IT_0064*IT_0106*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0176 = cpow(IT_0039, -1);
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0008*IT_0010*IT_0028*IT_0176;
    const ccomplex_t IT_0178 = 0.5*IT_0177;
    const ccomplex_t IT_0179 = IT_0137*IT_0178;
    const ccomplex_t IT_0180 = IT_0133*IT_0175*IT_0179;
    const ccomplex_t IT_0181 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0182 = IT_0143*IT_0181;
    const ccomplex_t IT_0183 = 1.4142135623731*IT_0182;
    const ccomplex_t IT_0184 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0188 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0195 = IT_0085*IT_0194;
    const ccomplex_t IT_0196 = (0 + _Complex_I*1)*IT_0195;
    const ccomplex_t IT_0197 = m_d*IT_0196;
    const ccomplex_t IT_0198 = IT_0112*IT_0193;
    const ccomplex_t IT_0199 = IT_0068*IT_0085*IT_0198;
    const ccomplex_t IT_0200 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0201 = IT_0143*IT_0200;
    const ccomplex_t IT_0202 = (-2)*IT_0201;
    const ccomplex_t IT_0203 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0204 = IT_0147*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0207 = IT_0143*IT_0206;
    ...
    const ccomplex_t IT_0214 = IT_0000*IT_0003*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*IT_0008*IT_0010*IT_0028*IT_0176;
    const ccomplex_t IT_0217 = 0.5*IT_0216;
    const ccomplex_t IT_0218 = IT_0043*IT_0217;
    const ccomplex_t IT_0219 = IT_0038*IT_0215*IT_0218;
    ...
    const ccomplex_t IT_0224 = IT_0128*IT_0220*IT_0223;
    const ccomplex_t IT_0225 = IT_0090*IT_0157;
    ...
    const ccomplex_t IT_0229 = IT_0108*IT_0172;
    ...
    const ccomplex_t IT_0233 = IT_0007*IT_0212;
    ...
    const ccomplex_t IT_0237 = -IT_0159 + -IT_0174 + IT_0180 + IT_0197 + 
      -IT_0199 + -IT_0214 + IT_0219 + IT_0224 + IT_0228 + IT_0232 + IT_0236;
    const ccomplex_t IT_0238 = 6*s_13;
    const ccomplex_t IT_0239 = m_d*m_C_2;
    const ccomplex_t IT_0240 = 6*IT_0142;
    const ccomplex_t IT_0241 = -IT_0034 + -IT_0066 + -IT_0115 + -IT_0121;
    const ccomplex_t IT_0242 = m_d*s_12;
    const ccomplex_t IT_0243 = IT_0046 + IT_0130 + IT_0140 + -IT_0196 + 
    ...
    const ccomplex_t IT_0247 = m_d*m_C_2*IT_0002;
    const ccomplex_t IT_0248 = s_13*IT_0002;
