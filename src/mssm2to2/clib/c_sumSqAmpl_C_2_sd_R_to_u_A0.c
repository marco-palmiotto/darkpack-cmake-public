        ...
        )
{
    ...
    const ccomplex_t IT_0076 = pow(m_sd_R, 2);
    const ccomplex_t IT_0077 = cpow((-2)*s_23 + IT_0014 + IT_0076 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0078 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0079 = IT_0056*IT_0078;
    const ccomplex_t IT_0080 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0081 = IT_0005*IT_0080;
    const ccomplex_t IT_0082 = IT_0001*(IT_0079 + IT_0081);
    const ccomplex_t IT_0083 = 1.4142135623731*e_em*IT_0082;
    const ccomplex_t IT_0084 = (-0.5)*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0001*IT_0002*IT_0057;
    const ccomplex_t IT_0086 = (-0.5)*IT_0085;
    const ccomplex_t IT_0087 = IT_0084*IT_0086;
    const ccomplex_t IT_0088 = IT_0075*IT_0077*IT_0087;
    const ccomplex_t IT_0089 = V_u2*U_Wm1;
    const ccomplex_t IT_0090 = IT_0056*IT_0089;
    const ccomplex_t IT_0091 = U_d1*V_Wp2;
    const ccomplex_t IT_0092 = IT_0005*IT_0091;
    const ccomplex_t IT_0093 = IT_0001*(IT_0090 + IT_0092);
    ...
    const ccomplex_t IT_0101 = cpow((-2)*s_23 + IT_0014 + IT_0076 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0102 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0103 = IT_0056*IT_0102;
    const ccomplex_t IT_0104 = conj(U_d2)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0001*IT_0002*IT_0057;
