        ...
        )
{
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm2)*IT_0007;
    ...
    const ccomplex_t IT_0051 = pow(m_d, 2);
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*e_em*(m_W*IT_0006*(IT_0000
      *IT_0033 + -IT_0004*IT_0035)*IT_0050 + (-3)*IT_0000*IT_0003*IT_0007
      *IT_0034*IT_0051);
    const ccomplex_t IT_0053 = 0.333333333333333*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0003*IT_0007*IT_0034;
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = IT_0053*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = IT_0007*IT_0018;
    const ccomplex_t IT_0061 = e_em*conj(U_Wm2)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = IT_0007*IT_0018*IT_0034;
    const ccomplex_t IT_0064 = m_b*conj(U_d2)*e_em*IT_0003*U_sb_10*V_ub_mod;
    const ccomplex_t IT_0065 = IT_0063*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*(IT_0062 + (-0.5)*IT_0066);
    const ccomplex_t IT_0068 = IT_0017*IT_0067;
    const ccomplex_t IT_0069 = IT_0022*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0072 = IT_0060*IT_0071;
    const ccomplex_t IT_0073 = m_b*conj(U_d2)*e_em*IT_0003*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0081 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0003*IT_0007*IT_0034;
    const ccomplex_t IT_0090 = (-0.5)*IT_0089;
    const ccomplex_t IT_0091 = IT_0088*IT_0090;
    const ccomplex_t IT_0092 = pow(m_sd_R, 2);
    const ccomplex_t IT_0093 = cpow((-2)*s_23 + IT_0011 + IT_0092 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0094 = IT_0080*IT_0091*IT_0093;
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0096 = conj(U_d2)*conj(V_Wp2);
    const ccomplex_t IT_0097 = IT_0000*IT_0096;
    const ccomplex_t IT_0098 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0099 = IT_0035*IT_0098;
    const ccomplex_t IT_0100 = IT_0007*(IT_0097 + IT_0099);
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_23 + IT_0011 + IT_0092 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0095*IT_0104*IT_0105;
    const ccomplex_t IT_0107 = cpow((-2)*s_12 + IT_0011 + -IT_0012 + -IT_0092 
      + -reg_prop, -1);
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*m_u*e_em*IT_0003*IT_0005
      *IT_0007*IT_0035;
    ...
    const ccomplex_t IT_0114 = U_d1*V_Wp2;
    const ccomplex_t IT_0115 = IT_0000*IT_0114;
    const ccomplex_t IT_0116 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0123 = IT_0093*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*IT_0123;
    const ccomplex_t IT_0125 = m_C_2*IT_0124;
    const ccomplex_t IT_0126 = U_d2*V_Wp2;
    const ccomplex_t IT_0127 = IT_0000*IT_0126;
    const ccomplex_t IT_0128 = V_u2*U_Wm2;
    const ccomplex_t IT_0129 = IT_0035*IT_0128;
    const ccomplex_t IT_0130 = IT_0007*(IT_0127 + IT_0129);
    ...
    const ccomplex_t IT_0138 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0007;
    ...
    const ccomplex_t IT_0142 = -IT_0048 + -IT_0059 + -IT_0070 + -IT_0079 +
       IT_0094 + IT_0106 + 2*IT_0113 + IT_0125 + IT_0137 + -IT_0141;
    const ccomplex_t IT_0143 = 6*s_13;
    const ccomplex_t IT_0144 = m_u*m_C_2;
    const ccomplex_t IT_0145 = 6*IT_0044;
    const ccomplex_t IT_0146 = -IT_0124 + -IT_0136;
    ...
    const ccomplex_t IT_0159 = (IT_0044*conj(IT_0044) + IT_0142*conj(IT_0142))
      ...
      *IT_0147 + IT_0112*IT_0148)*IT_0149 + (IT_0112*IT_0147 + IT_0146*IT_0148)
      *IT_0150 + 6*conj(IT_0112)*(IT_0146*IT_0152 + -IT_0112*IT_0156 +
       0.166666666666667*IT_0147*IT_0157 + IT_0145*IT_0158) + 6*conj(IT_0146)*
      (0.166666666666667*IT_0145*IT_0147 + IT_0112*IT_0152 + -IT_0146*IT_0156 +
       IT_0157*IT_0158);
