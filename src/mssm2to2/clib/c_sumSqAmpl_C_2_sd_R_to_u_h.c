...
ccomplex_return_t c_sumSqAmpl_C_2_sd_R_to_u_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0074 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0075 = IT_0035*IT_0074;
    const ccomplex_t IT_0076 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0077 = IT_0000*IT_0076;
    const ccomplex_t IT_0078 = IT_0007*(IT_0075 + -IT_0077);
    const ccomplex_t IT_0079 = 1.4142135623731*e_em*IT_0078;
    const ccomplex_t IT_0080 = 0.5*IT_0079;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0003*IT_0007*IT_0034;
    const ccomplex_t IT_0083 = (-0.5)*IT_0082;
    const ccomplex_t IT_0084 = IT_0081*IT_0083;
    const ccomplex_t IT_0085 = pow(m_sd_R, 2);
    const ccomplex_t IT_0086 = cpow((-2)*s_23 + IT_0011 + IT_0085 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0073*IT_0084*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0089 = conj(V_u2)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0100 = cpow((-2)*s_23 + IT_0011 + IT_0085 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0101 = IT_0088*IT_0099*IT_0100;
    const ccomplex_t IT_0102 = cpow((-2)*s_12 + IT_0011 + -IT_0012 + -IT_0085 
      + -reg_prop, -1);
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*m_u*e_em*IT_0003*IT_0005
      *IT_0007*IT_0035;
    ...
    const ccomplex_t IT_0109 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0110 = cos(theta_W);
    const ccomplex_t IT_0111 = cpow(IT_0110, -2);
    const ccomplex_t IT_0112 = pow(m_d, 2);
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*e_em*(m_W*IT_0006*(IT_0000
      *IT_0033 + IT_0004*IT_0035)*IT_0111 + (-3)*IT_0000*IT_0003*IT_0007*IT_0034
      *IT_0112);
    ...
    const ccomplex_t IT_0118 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0130 = V_u2*U_Wm2;
    const ccomplex_t IT_0131 = IT_0035*IT_0130;
    const ccomplex_t IT_0132 = U_d2*V_Wp2;
    ...
    const ccomplex_t IT_0138 = IT_0098*IT_0137;
    ...
    const ccomplex_t IT_0142 = -IT_0048 + -IT_0052 + -IT_0063 + -IT_0072 +
       IT_0087 + IT_0101 + 2*IT_0108 + -IT_0117 + IT_0129 + IT_0141;
    ...
    const ccomplex_t IT_0159 = (IT_0044*conj(IT_0044) + IT_0142*conj(IT_0142))
      ...
      *IT_0147 + IT_0107*IT_0148)*IT_0149 + (IT_0107*IT_0147 + IT_0146*IT_0148)
      *IT_0150 + 6*conj(IT_0107)*(IT_0146*IT_0152 + -IT_0107*IT_0156 +
       0.166666666666667*IT_0147*IT_0157 + IT_0145*IT_0158) + 6*conj(IT_0146)*
      (0.166666666666667*IT_0145*IT_0147 + IT_0107*IT_0152 + -IT_0146*IT_0156 +
       IT_0157*IT_0158);
