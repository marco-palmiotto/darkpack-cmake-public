        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
    ...
    const ccomplex_t IT_0079 = IT_0030*IT_0067*IT_0078;
    ...
    const ccomplex_t IT_0090 = IT_0002*IT_0080*IT_0089;
    ...
    const ccomplex_t IT_0101 = IT_0043*IT_0091*IT_0100;
    ...
    const ccomplex_t IT_0110 = N_W2*e_em*conj(U_Wm2);
    const ccomplex_t IT_0111 = IT_0007*IT_0110;
    const ccomplex_t IT_0112 = N_d2*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0121 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0122 = IT_0007*IT_0121;
    const ccomplex_t IT_0123 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0132 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0133 = IT_0007*IT_0132;
    const ccomplex_t IT_0134 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0140 = IT_0043*IT_0139;
    ...
    const ccomplex_t IT_0144 = IT_0055*IT_0109;
    ...
    const ccomplex_t IT_0205 = (-0.25)*IT_0194;
    ...
    const ccomplex_t IT_0213 = m_C_2*IT_0172;
    const ccomplex_t IT_0214 = (-2)*IT_0157;
    const ccomplex_t IT_0215 = (-2)*conj(IT_0157);
    const ccomplex_t IT_0216 = (-2)*conj(IT_0059);
    const ccomplex_t IT_0217 = s_13*IT_0172;
    const ccomplex_t IT_0218 = (-2)*conj(IT_0159);
    const ccomplex_t IT_0219 = pow(s_34, 2);
    const ccomplex_t IT_0220 = IT_0060*IT_0219;
    const ccomplex_t IT_0221 = -IT_0220;
    const ccomplex_t IT_0222 = IT_0000 + IT_0221;
    const ccomplex_t IT_0223 = m_C_2*IT_0222;
    const ccomplex_t IT_0224 = (-2)*IT_0169;
    const ccomplex_t IT_0225 = s_13*IT_0222;
    const ccomplex_t IT_0226 = 0.5*IT_0200;
    const ccomplex_t IT_0227 = s_34 + IT_0226;
    const ccomplex_t IT_0228 = m_C_2*IT_0227;
    const ccomplex_t IT_0229 = 2*IT_0228;
    const ccomplex_t IT_0230 = (-2)*conj(IT_0169);
    const ccomplex_t IT_0231 = IT_0191 + IT_0197;
    const ccomplex_t IT_0232 = IT_0060*IT_0231;
    const ccomplex_t IT_0233 = (-0.5)*IT_0232;
    const ccomplex_t IT_0234 = IT_0048*IT_0116;
    const ccomplex_t IT_0235 = IT_0046*IT_0143*IT_0234;
    const ccomplex_t IT_0236 = IT_0021*IT_0127;
    const ccomplex_t IT_0237 = IT_0030*IT_0067*IT_0236;
    const ccomplex_t IT_0238 = IT_0034*IT_0138;
    const ccomplex_t IT_0239 = IT_0043*IT_0091*IT_0238;
    const ccomplex_t IT_0240 = m_C_2*IT_0032;
    const ccomplex_t IT_0241 = m_C_2*IT_0045;
    const ccomplex_t IT_0242 = m_C_2*IT_0019;
    const ccomplex_t IT_0243 = m_C_2*IT_0058;
    const ccomplex_t IT_0244 = m_e*IT_0168;
    const ccomplex_t IT_0245 = IT_0009*IT_0152;
    const ccomplex_t IT_0246 = IT_0002*IT_0080*IT_0245;
    const ccomplex_t IT_0247 = IT_0235 + IT_0237 + IT_0239 + -IT_0240 + 
      -IT_0241 + -IT_0242 + -IT_0243 + 0.5*IT_0244 + IT_0246;
    const ccomplex_t IT_0248 = (-0.25)*IT_0186;
    const ccomplex_t IT_0249 = s_14 + IT_0248;
    const ccomplex_t IT_0250 = m_e*IT_0249;
    const ccomplex_t IT_0251 = (-4)*IT_0250;
    const ccomplex_t IT_0252 = m_e*IT_0172;
    const ccomplex_t IT_0253 = (-0.166666666666667)*IT_0252;
    const ccomplex_t IT_0254 = (-6)*conj(IT_0247)*(IT_0157*IT_0160 + (
      -0.333333333333333)*IT_0183*IT_0190 + (-0.333333333333333)*IT_0174*IT_0204
       + (-0.166666666666667)*IT_0158*IT_0211 + 0.333333333333333*IT_0059
      *IT_0213 + (-0.333333333333333)*IT_0179*IT_0251 + IT_0224*IT_0253);
    const ccomplex_t IT_0255 = (-0.333333333333333)*IT_0158*conj(IT_0159) +
       conj(IT_0157)*IT_0160 + (-0.333333333333333)*conj(IT_0183)*IT_0190 + (
      -0.333333333333333)*conj(IT_0174)*IT_0204 + (-0.166666666666667)*IT_0213
      *IT_0216 + (-0.666666666666667)*(s_13 + IT_0233)*conj(IT_0247) + (
      -0.333333333333333)*conj(IT_0179)*IT_0251 + IT_0230*IT_0253;
    const ccomplex_t IT_0256 = 2*IT_0059*(conj(IT_0059)*IT_0066 + conj(IT_0157
      )*IT_0158 + conj(IT_0159)*IT_0161 + -conj(IT_0169)*IT_0173 + conj(IT_0174)
      *IT_0178) + 2*IT_0174*(conj(IT_0059)*IT_0178 + conj(IT_0179)*IT_0182 +
       conj(IT_0183)*IT_0184 + conj(IT_0157)*IT_0190 + (-2)*conj(IT_0174)
      *IT_0198) + 2*IT_0183*(conj(IT_0159)*IT_0178 + conj(IT_0174)*IT_0184 + (-2
      )*conj(IT_0183)*IT_0198 + conj(IT_0157)*IT_0204 + (-4)*conj(IT_0179)
      *IT_0206 + conj(IT_0169)*IT_0210) + IT_0178*(conj(IT_0183)*IT_0211 + conj
      (IT_0179)*IT_0212) + conj(IT_0159)*(IT_0066*IT_0211 + IT_0213*IT_0214) + 2
      *IT_0159*(conj(IT_0059)*IT_0161 + 0.5*IT_0213*IT_0215) + 2*IT_0169*(conj
      (IT_0183)*IT_0210 + 0.5*IT_0173*IT_0216 + 0.5*IT_0217*IT_0218 + 0.5
      *IT_0215*IT_0223) + conj(IT_0179)*IT_0210*IT_0224 + conj(IT_0169)*(IT_0212
      *IT_0217 + IT_0214*IT_0223 + IT_0224*IT_0225) + 2*IT_0179*(conj(IT_0174)
      *IT_0182 + (-2)*conj(IT_0179)*IT_0198 + (-4)*conj(IT_0183)*IT_0206 + 0.5
      *IT_0178*IT_0218 + conj(IT_0157)*IT_0229 + 0.5*IT_0210*IT_0230) + 2
      *IT_0157*(conj(IT_0059)*IT_0158 + conj(IT_0174)*IT_0190 + conj(IT_0183)
      *IT_0204 + conj(IT_0179)*IT_0229 + 2*conj(IT_0157)*(s_13 + IT_0233)) +
       IT_0254 + (-6)*IT_0247*IT_0255;
