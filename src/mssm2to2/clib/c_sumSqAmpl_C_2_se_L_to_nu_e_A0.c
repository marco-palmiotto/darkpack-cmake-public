...
ccomplex_return_t c_sumSqAmpl_C_2_se_L_to_nu_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*m_C_1;
    ...
    const ccomplex_t IT_0016 = IT_0012*IT_0013*IT_0015;
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0001;
    const ccomplex_t IT_0018 = conj(V_u2)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0027 = cpow(s_23 + (-0.5)*IT_0014 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0028 = IT_0025*IT_0026*IT_0027;
    const ccomplex_t IT_0029 = V_u2*U_Wm1;
    const ccomplex_t IT_0030 = IT_0003*IT_0029;
    const ccomplex_t IT_0031 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0044 = IT_0001*(IT_0041 + IT_0043);
    ...
    const ccomplex_t IT_0052 = cpow(s_13 + (-0.5)*IT_0051 + 0.5*m_se_R*(m_se_R
       + (0 + _Complex_I*-1)*Gamma_er) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0053 = pow(m_W, -1);
    const ccomplex_t IT_0054 = m_e*e_em*mu_h*IT_0001*IT_0053;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = cpow(IT_0003, -1);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
      *e_em*IT_0001*IT_0053*IT_0056;
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = IT_0055*IT_0058;
    const ccomplex_t IT_0060 = IT_0052*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = (-0.5)*IT_0016 + (-0.5)*IT_0028 + (-0.5)
      *IT_0039 + (-0.5)*IT_0050 + 0.5*IT_0061;
    const ccomplex_t IT_0063 = 0.5*IT_0038 + 0.5*IT_0049;
