...
ccomplex_return_t c_sumSqAmpl_C_2_se_L_to_nu_e_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0017 = IT_0003*IT_0016;
    const ccomplex_t IT_0018 = sin(alpha);
    const ccomplex_t IT_0019 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0020 = IT_0018*IT_0019;
    const ccomplex_t IT_0021 = IT_0005*(IT_0017 + -IT_0020);
    ...
    const ccomplex_t IT_0055 = V_u2*U_Wm2;
    ...
    const ccomplex_t IT_0067 = pow(m_e, 2);
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0005*IT_0018*IT_0067 + (-0.5)*m_W*(IT_0001*IT_0018 + IT_0003*IT_0068)*
      (IT_0005 + -IT_0004*IT_0070));
    const ccomplex_t IT_0072 = IT_0030*IT_0071;
    const ccomplex_t IT_0073 = cpow(s_13 + (-0.5)*IT_0011 + 0.5*m_se_L*(m_se_L
    ...
    const ccomplex_t IT_0076 = 0.5*IT_0014 + (-0.5)*IT_0029 + (-0.5)*IT_0042 +
       (-0.5)*IT_0054 + (-0.5)*IT_0066 + 0.5*IT_0075;
    const ccomplex_t IT_0077 = 0.5*IT_0053 + 0.5*IT_0065;
    const ccomplex_t IT_0078 = s_34*m_C_2;
    const ccomplex_t IT_0079 = pow(m_h, 2);
    const ccomplex_t IT_0080 = s_13*IT_0079;
    const ccomplex_t IT_0081 = s_14*s_34;
    return create_ccomplex_return(2*IT_0076*(s_13*conj(IT_0076) + conj(IT_0077
      )*IT_0078) + 2*IT_0077*(conj(IT_0076)*IT_0078 + -conj(IT_0077)*(IT_0080 + 
      (-2)*IT_0081)));
}
