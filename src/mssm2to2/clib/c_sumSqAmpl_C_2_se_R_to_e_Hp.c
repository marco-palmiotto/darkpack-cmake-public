...
ccomplex_return_t c_sumSqAmpl_C_2_se_R_to_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0009 = N_u3*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0024 = pow(m_e, 2);
    const ccomplex_t IT_0025 = pow(m_se_R, 2);
    ...
    const ccomplex_t IT_0029 = cpow(IT_0005, -1);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0007*IT_0028*IT_0029;
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = N_u1*e_em*V_Wp2;
    const ccomplex_t IT_0033 = IT_0008*IT_0032;
    const ccomplex_t IT_0034 = 2*IT_0033;
    const ccomplex_t IT_0035 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0036 = IT_0012*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0024 + IT_0025 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0047 = IT_0045*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*IT_0047;
    const ccomplex_t IT_0049 = m_e*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*m_N_1;
    ...
    const ccomplex_t IT_0054 = IT_0046*IT_0050*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0007*IT_0028*IT_0029;
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0024 + IT_0025 + -m_N_2*
    ...
    const ccomplex_t IT_0079 = IT_0061*IT_0062*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0081 = cpow((-2)*s_23 + IT_0024 + IT_0025 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0002;
    const ccomplex_t IT_0083 = -IT_0082;
    const ccomplex_t IT_0084 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0085 = IT_0008*IT_0084;
    const ccomplex_t IT_0086 = 2*IT_0085;
    const ccomplex_t IT_0087 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0088 = IT_0012*IT_0087;
    const ccomplex_t IT_0089 = 1.4142135623731*IT_0088;
    const ccomplex_t IT_0090 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0098 = IT_0080*IT_0081*IT_0097;
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0007*IT_0028*IT_0029;
    ...
    const ccomplex_t IT_0108 = IT_0081*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*IT_0108;
    const ccomplex_t IT_0110 = m_e*IT_0109;
    const ccomplex_t IT_0111 = pow(m_C_2, 2);
    const ccomplex_t IT_0112 = cpow(s_12 + 0.5*IT_0025 + 0.5*IT_0111 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0113 = sin(beta);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0007*IT_0028*IT_0029*IT_0113;
    const ccomplex_t IT_0115 = 0.5*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
      *e_em*IT_0007*IT_0028*IT_0029;
    ...
    const ccomplex_t IT_0122 = -IT_0027 + IT_0049 + -IT_0054 + IT_0060 + 
      -IT_0079 + -IT_0098 + IT_0104 + IT_0110 + (-0.5)*IT_0121;
    const ccomplex_t IT_0123 = IT_0007*IT_0113;
    const ccomplex_t IT_0124 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0125 = IT_0123*IT_0124;
    const ccomplex_t IT_0126 = (-2)*IT_0125;
    const ccomplex_t IT_0127 = IT_0002*IT_0113;
    const ccomplex_t IT_0128 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0129 = IT_0127*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0139 = IT_0061*IT_0062*IT_0138;
    const ccomplex_t IT_0140 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0141 = IT_0123*IT_0140;
    const ccomplex_t IT_0142 = (-2)*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0144 = IT_0127*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0153 = IT_0106*IT_0152;
    const ccomplex_t IT_0154 = IT_0080*IT_0081*IT_0153;
    const ccomplex_t IT_0155 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0156 = IT_0123*IT_0155;
    const ccomplex_t IT_0157 = (-2)*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0159 = IT_0127*IT_0158;
    ...
    const ccomplex_t IT_0169 = IT_0000*IT_0026*IT_0168;
    const ccomplex_t IT_0170 = IT_0064*IT_0137;
    ...
    const ccomplex_t IT_0174 = IT_0083*IT_0152;
    const ccomplex_t IT_0175 = IT_0081*IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*IT_0175;
    const ccomplex_t IT_0177 = m_e*IT_0176;
    const ccomplex_t IT_0178 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0179 = IT_0123*IT_0178;
    ...
    const ccomplex_t IT_0186 = IT_0123*IT_0185;
    ...
    const ccomplex_t IT_0191 = IT_0031*IT_0190;
    const ccomplex_t IT_0192 = IT_0046*IT_0050*IT_0191;
    const ccomplex_t IT_0193 = IT_0052*IT_0190;
    const ccomplex_t IT_0194 = IT_0046*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*IT_0194;
    const ccomplex_t IT_0196 = m_e*IT_0195;
    const ccomplex_t IT_0197 = IT_0004*IT_0167;
    const ccomplex_t IT_0198 = IT_0026*IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*IT_0198;
    const ccomplex_t IT_0200 = m_e*IT_0199;
    const ccomplex_t IT_0201 = -IT_0139 + -IT_0154 + -IT_0169 + IT_0173 +
       IT_0177 + -IT_0192 + IT_0196 + IT_0200;
    const ccomplex_t IT_0202 = 2*s_13;
    const ccomplex_t IT_0203 = m_e*m_C_2;
    const ccomplex_t IT_0204 = 2*IT_0122;
    const ccomplex_t IT_0205 = -IT_0048 + -IT_0059 + -IT_0103 + -IT_0109;
    const ccomplex_t IT_0206 = m_e*s_12;
    const ccomplex_t IT_0207 = (-0.5)*IT_0120 + -IT_0172 + -IT_0176 + -IT_0195
       + -IT_0199;
    const ccomplex_t IT_0208 = s_23*m_C_2;
    const ccomplex_t IT_0209 = 2*conj(IT_0122);
    const ccomplex_t IT_0210 = 2*conj(IT_0201);
    const ccomplex_t IT_0211 = m_e*m_C_2*IT_0025;
    const ccomplex_t IT_0212 = s_12*s_23;
    const ccomplex_t IT_0213 = s_13*IT_0025;
    const ccomplex_t IT_0214 = (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = IT_0212 + IT_0214;
    const ccomplex_t IT_0216 = 2*IT_0201;
    const ccomplex_t IT_0217 = 0.5*IT_0208;
    const ccomplex_t IT_0218 = (IT_0122*conj(IT_0122) + IT_0201*conj(IT_0201))
      *IT_0202 + conj(IT_0201)*IT_0203*IT_0204 + (IT_0201*IT_0203 + IT_0205
      *IT_0206 + IT_0207*IT_0208)*IT_0209 + (IT_0206*IT_0207 + IT_0205*IT_0208)
      *IT_0210 + 2*conj(IT_0207)*(IT_0205*IT_0211 + 2*IT_0207*IT_0215 + 0.5
      *IT_0206*IT_0216 + IT_0204*IT_0217) + 2*conj(IT_0205)*(0.5*IT_0204*IT_0206
       + IT_0207*IT_0211 + 2*IT_0205*IT_0215 + IT_0216*IT_0217);
