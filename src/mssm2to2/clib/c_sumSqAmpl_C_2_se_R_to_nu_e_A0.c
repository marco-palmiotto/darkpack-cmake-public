        ...
        )
{
    ...
    const ccomplex_t IT_0031 = m_e*e_em*mu_h*IT_0008*IT_0012;
    ...
    const ccomplex_t IT_0036 = cpow(s_13 + (-0.5)*IT_0035 + 0.5*m_se_L*(m_se_L
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0008*IT_0012*IT_0013;
