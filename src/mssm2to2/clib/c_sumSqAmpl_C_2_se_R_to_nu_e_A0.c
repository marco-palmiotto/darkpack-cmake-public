...
ccomplex_return_t c_sumSqAmpl_C_2_se_R_to_nu_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = IT_0000*IT_0002*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0021 = conj(V_u2)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
      *e_em*IT_0010*IT_0014*IT_0015;
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = cpow(s_23 + (-0.5)*IT_0001 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0020*IT_0030*IT_0031;
    const ccomplex_t IT_0033 = V_u2*U_Wm2;
    const ccomplex_t IT_0034 = IT_0003*IT_0033;
    const ccomplex_t IT_0035 = U_d2*V_Wp2;
    ...
    const ccomplex_t IT_0044 = m_e*e_em*mu_h*IT_0010*IT_0014;
    const ccomplex_t IT_0045 = (-0.5)*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0010;
    const ccomplex_t IT_0047 = IT_0045*IT_0046;
    const ccomplex_t IT_0048 = pow(m_C_2, 2);
    const ccomplex_t IT_0049 = cpow(s_13 + (-0.5)*IT_0048 + 0.5*m_se_L*(m_se_L
    ...
    const ccomplex_t IT_0056 = IT_0010*(IT_0053 + IT_0055);
    ...
    const ccomplex_t IT_0063 = (-0.5)*IT_0019 + (-0.5)*IT_0032 + (-0.5)
      *IT_0043 + 0.5*IT_0051 + (-0.5)*IT_0062;
    const ccomplex_t IT_0064 = 0.5*IT_0042 + 0.5*IT_0061;
