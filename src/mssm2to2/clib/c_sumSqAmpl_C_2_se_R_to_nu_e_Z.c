        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
      *e_em*IT_0005*IT_0007*IT_0008;
    const ccomplex_t IT_0010 = (-0.5)*IT_0009;
    const ccomplex_t IT_0011 = pow(m_C_2, 2);
    const ccomplex_t IT_0012 = cpow(s_13 + (-0.5)*IT_0011 + 0.5*m_se_R*(m_se_R
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0005*IT_0007*IT_0008;
    ...
    const ccomplex_t IT_0081 = m_C_2*IT_0031;
    const ccomplex_t IT_0082 = m_C_2*IT_0042;
    ...
    const ccomplex_t IT_0120 = 0.5*IT_0031 + 0.5*IT_0042;
