        ...
        )
{
    ...
    const ccomplex_t IT_0026 = IT_0008*(IT_0023 + -IT_0025);
    ...
    const ccomplex_t IT_0035 = cpow(s_13 + (-0.5)*IT_0034 + 0.5*m_se_R*(m_se_R
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*(m_W*IT_0007*IT_0037*
      (IT_0004*IT_0014 + IT_0001*IT_0038) + -IT_0004*IT_0008*IT_0013*IT_0015
      *IT_0039);
    ...
    const ccomplex_t IT_0046 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_C_1*(m_C_1 +
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0008*IT_0013*IT_0015;
    const ccomplex_t IT_0056 = (-0.5)*IT_0055;
    const ccomplex_t IT_0057 = IT_0054*IT_0056;
    const ccomplex_t IT_0058 = IT_0045*IT_0046*IT_0057;
    const ccomplex_t IT_0059 = V_u2*U_Wm1;
    const ccomplex_t IT_0060 = IT_0001*IT_0059;
    const ccomplex_t IT_0061 = U_d1*V_Wp2;
    const ccomplex_t IT_0062 = IT_0004*IT_0061;
    const ccomplex_t IT_0063 = IT_0008*(IT_0060 + -IT_0062);
    ...
    const ccomplex_t IT_0075 = cpow(s_13 + (-0.5)*IT_0034 + 0.5*m_se_L*(m_se_L
       + (0 + _Complex_I*-1)*Gamma_el) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = (-0.5)*IT_0021 + (-0.5)*IT_0033 + 0.5*IT_0044 +
       (-0.5)*IT_0058 + (-0.5)*IT_0070 + 0.5*IT_0077;
    const ccomplex_t IT_0079 = 0.5*IT_0032 + 0.5*IT_0069;
