...
ccomplex_return_t c_sumSqAmpl_C_2_smu_L_to_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_N_2*
    ...
    const ccomplex_t IT_0127 = IT_0062*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*IT_0127;
    const ccomplex_t IT_0129 = m_mu*IT_0128;
    const ccomplex_t IT_0130 = sin(beta);
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0001*IT_0003*IT_0005*IT_0130;
    const ccomplex_t IT_0132 = 0.5*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0005;
    const ccomplex_t IT_0134 = IT_0132*IT_0133;
    const ccomplex_t IT_0135 = pow(m_C_2, 2);
    const ccomplex_t IT_0136 = cpow(s_12 + 0.5*IT_0027 + 0.5*IT_0135 + 0.5
      *reg_prop, -1);
    ...
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0142 = (-0.5)*IT_0141;
    const ccomplex_t IT_0143 = IT_0101*IT_0142;
    const ccomplex_t IT_0144 = IT_0080*IT_0140*IT_0143;
    const ccomplex_t IT_0145 = -IT_0029 + -IT_0048 + IT_0060 + -IT_0079 +
       IT_0105 + IT_0117 + IT_0129 + (-0.5)*IT_0139 + -IT_0144;
    const ccomplex_t IT_0146 = IT_0005*IT_0130;
    ...
    const ccomplex_t IT_0150 = IT_0013*IT_0130;
    ...
    const ccomplex_t IT_0162 = IT_0000*IT_0028*IT_0161;
    ...
    const ccomplex_t IT_0176 = IT_0088*IT_0175;
    const ccomplex_t IT_0177 = IT_0080*IT_0140*IT_0176;
    ...
    const ccomplex_t IT_0192 = IT_0030*IT_0047*IT_0191;
    ...
    const ccomplex_t IT_0206 = IT_0125*IT_0205;
    const ccomplex_t IT_0207 = IT_0061*IT_0062*IT_0206;
    const ccomplex_t IT_0208 = IT_0142*IT_0175;
    const ccomplex_t IT_0209 = IT_0080*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*IT_0209;
    const ccomplex_t IT_0211 = m_mu*IT_0210;
    const ccomplex_t IT_0212 = IT_0032*IT_0190;
    ...
    const ccomplex_t IT_0216 = IT_0007*IT_0160;
    ...
    const ccomplex_t IT_0226 = m_mu*m_C_2;
    const ccomplex_t IT_0227 = 2*IT_0145;
    const ccomplex_t IT_0228 = -IT_0059 + -IT_0104 + -IT_0116 + -IT_0128;
    const ccomplex_t IT_0229 = m_mu*s_12;
    const ccomplex_t IT_0230 = (-0.5)*IT_0138 + -IT_0210 + -IT_0214 + -IT_0218
       + -IT_0222;
    const ccomplex_t IT_0231 = s_23*m_C_2;
    const ccomplex_t IT_0232 = 2*conj(IT_0145);
    const ccomplex_t IT_0233 = 2*conj(IT_0224);
    const ccomplex_t IT_0234 = m_mu*m_C_2*IT_0027;
