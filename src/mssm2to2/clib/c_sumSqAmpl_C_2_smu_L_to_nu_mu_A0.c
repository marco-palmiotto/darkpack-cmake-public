        ...
        )
{
    ...
    const ccomplex_t IT_0052 = cpow(s_13 + (-0.5)*IT_0051 + 0.5*m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0053 = pow(m_W, -1);
    const ccomplex_t IT_0054 = e_em*m_mu*mu_h*IT_0001*IT_0053;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = cpow(IT_0003, -1);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0001*IT_0053*IT_0056;
