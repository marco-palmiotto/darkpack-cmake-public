...
ccomplex_return_t c_sumSqAmpl_C_2_smu_R_to_nu_mu_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = cpow(s_13 + (-0.5)*IT_0000 + 0.5*m_smu_R*
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*IT_0003*(IT_0004
      *IT_0005 + -IT_0006*IT_0007)*IT_0008 + -IT_0005*IT_0009*IT_0010*IT_0011
      *IT_0012);
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0009*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0033 = IT_0019*IT_0021*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0035 = cpow(s_23 + (-0.5)*IT_0020 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0040 = IT_0012*(IT_0037 + IT_0039);
    const ccomplex_t IT_0041 = 1.4142135623731*e_em*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = IT_0015*IT_0043;
    const ccomplex_t IT_0045 = IT_0034*IT_0035*IT_0044;
    const ccomplex_t IT_0046 = U_d1*V_Wp2;
    const ccomplex_t IT_0047 = IT_0005*IT_0046;
    const ccomplex_t IT_0048 = V_u2*U_Wm1;
    const ccomplex_t IT_0049 = IT_0007*IT_0048;
    const ccomplex_t IT_0050 = IT_0012*(IT_0047 + IT_0049);
    ...
    const ccomplex_t IT_0077 = 0.5*IT_0018 + (-0.5)*IT_0033 + (-0.5)*IT_0045 +
       (-0.5)*IT_0057 + 0.5*IT_0064 + (-0.5)*IT_0076;
    const ccomplex_t IT_0078 = 0.5*IT_0056 + 0.5*IT_0075;
