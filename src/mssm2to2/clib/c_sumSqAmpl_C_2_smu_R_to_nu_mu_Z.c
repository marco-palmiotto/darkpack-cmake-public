...
ccomplex_return_t c_sumSqAmpl_C_2_smu_R_to_nu_mu_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0005*IT_0007*IT_0008;
    ...
    const ccomplex_t IT_0017 = U_d1*conj(U_d2)*e_em;
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = IT_0000*IT_0008;
    const ccomplex_t IT_0020 = IT_0017*IT_0019;
    const ccomplex_t IT_0021 = e_em*U_Wm1*conj(U_Wm2);
    const ccomplex_t IT_0022 = IT_0019*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*(IT_0018 + -IT_0020 + (-2)
      *IT_0022);
    const ccomplex_t IT_0024 = 0.5*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0005*IT_0007*IT_0008;
    const ccomplex_t IT_0026 = (-0.5)*IT_0025;
    const ccomplex_t IT_0027 = IT_0024*IT_0026;
    const ccomplex_t IT_0028 = pow(m_smu_R, 2);
    const ccomplex_t IT_0029 = cpow(s_23 + (-0.5)*IT_0028 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*IT_0030;
    const ccomplex_t IT_0032 = cpow(s_23 + (-0.5)*IT_0028 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0035 = IT_0019*IT_0033;
    const ccomplex_t IT_0036 = e_em*U_Wm2*conj(U_Wm2);
    ...
    const ccomplex_t IT_0043 = 0.5*IT_0015 + -IT_0031 + -IT_0042;
    const ccomplex_t IT_0044 = pow(m_Z, -2);
    const ccomplex_t IT_0045 = pow(s_14, 2);
    const ccomplex_t IT_0046 = IT_0044*IT_0045;
    const ccomplex_t IT_0047 = -IT_0011;
    const ccomplex_t IT_0048 = IT_0046 + IT_0047;
    const ccomplex_t IT_0049 = s_13*IT_0048;
    const ccomplex_t IT_0050 = cpow(s_12 + 0.5*IT_0011 + 0.5*IT_0028 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0051 = e_em*IT_0016;
    const ccomplex_t IT_0052 = e_em*IT_0019;
    ...
    const ccomplex_t IT_0058 = (-0.5)*IT_0015 + -IT_0057;
    ...
    const ccomplex_t IT_0062 = V_u2*conj(V_u2)*e_em;
    const ccomplex_t IT_0063 = IT_0016*IT_0062;
    const ccomplex_t IT_0064 = IT_0019*IT_0062;
    const ccomplex_t IT_0065 = e_em*V_Wp2*conj(V_Wp2);
    ...
    const ccomplex_t IT_0070 = IT_0032*IT_0061*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0072 = conj(V_u1)*V_u2*e_em;
    const ccomplex_t IT_0073 = IT_0016*IT_0072;
    const ccomplex_t IT_0074 = IT_0019*IT_0072;
    const ccomplex_t IT_0075 = e_em*conj(V_Wp1)*V_Wp2;
    ...
    const ccomplex_t IT_0080 = IT_0029*IT_0071*IT_0079;
    const ccomplex_t IT_0081 = m_C_2*IT_0042;
    const ccomplex_t IT_0082 = m_C_2*IT_0031;
    ...
    const ccomplex_t IT_0102 = s_34*IT_0011;
    ...
    const ccomplex_t IT_0117 = IT_0107 + IT_0109 + IT_0116;
    const ccomplex_t IT_0118 = 2*conj(IT_0083);
    const ccomplex_t IT_0119 = (-0.25)*IT_0115;
    const ccomplex_t IT_0120 = IT_0108 + IT_0119;
    const ccomplex_t IT_0121 = 0.5*IT_0031 + 0.5*IT_0042;
    const ccomplex_t IT_0122 = 2*conj(IT_0121);
    const ccomplex_t IT_0123 = (-0.25)*IT_0090;
    ...
    const ccomplex_t IT_0128 = 2*IT_0043*conj(IT_0043)*IT_0049 + (conj(IT_0058
      ...
      *IT_0086*IT_0112 + conj(IT_0085)*IT_0117 + (-0.25)*IT_0094*IT_0118 +
       IT_0120*IT_0122) + (-2)*conj(IT_0121)*(IT_0058*IT_0086 + -IT_0043*IT_0104
       + IT_0095*IT_0127) + (-2)*IT_0121*(conj(IT_0058)*IT_0086 + -conj(IT_0043)
      *IT_0104 + 4*conj(IT_0085)*IT_0120 + IT_0117*IT_0122 + IT_0118*IT_0127);
