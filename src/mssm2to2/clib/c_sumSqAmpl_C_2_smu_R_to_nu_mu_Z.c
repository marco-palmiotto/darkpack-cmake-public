        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0006*IT_0013*IT_0015;
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0006*IT_0013*IT_0015;
    ...
    const ccomplex_t IT_0039 = cpow(s_13 + (-0.5)*IT_0038 + 0.5*m_smu_R*
