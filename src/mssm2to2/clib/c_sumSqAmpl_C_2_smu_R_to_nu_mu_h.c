...
ccomplex_return_t c_sumSqAmpl_C_2_smu_R_to_nu_mu_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0009*IT_0014*IT_0016;
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0002
      *IT_0009*IT_0014*IT_0016;
    const ccomplex_t IT_0024 = 0.5*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0009;
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = pow(m_C_2, 2);
    const ccomplex_t IT_0028 = cpow(s_13 + (-0.5)*IT_0027 + 0.5*m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0029 = IT_0026*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*IT_0029;
    const ccomplex_t IT_0031 = cpow(s_13 + (-0.5)*IT_0027 + 0.5*m_smu_R*
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*e_em*(m_W*IT_0008*IT_0033*
      (IT_0005*IT_0015 + IT_0002*IT_0034) + -IT_0005*IT_0009*IT_0014*IT_0016
      *IT_0035);
    ...
    const ccomplex_t IT_0042 = cpow(s_23 + (-0.5)*IT_0000 + 0.5*m_C_1*(m_C_1 +
    ...
    const ccomplex_t IT_0047 = IT_0009*(IT_0044 + -IT_0046);
    ...
    const ccomplex_t IT_0054 = IT_0041*IT_0042*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0056 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0057 = IT_0002*IT_0056;
    const ccomplex_t IT_0058 = conj(U_d2)*conj(V_Wp2);
    const ccomplex_t IT_0059 = IT_0005*IT_0058;
    const ccomplex_t IT_0060 = IT_0009*(IT_0057 + -IT_0059);
    const ccomplex_t IT_0061 = 1.4142135623731*e_em*IT_0060;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = IT_0018*IT_0063;
    const ccomplex_t IT_0065 = IT_0001*IT_0055*IT_0064;
    const ccomplex_t IT_0066 = V_u2*U_Wm1;
    const ccomplex_t IT_0067 = IT_0002*IT_0066;
    const ccomplex_t IT_0068 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0078 = (-0.5)*IT_0022 + 0.5*IT_0030 + 0.5*IT_0040 + (
      -0.5)*IT_0054 + (-0.5)*IT_0065 + (-0.5)*IT_0077;
    const ccomplex_t IT_0079 = 0.5*IT_0021 + 0.5*IT_0076;
