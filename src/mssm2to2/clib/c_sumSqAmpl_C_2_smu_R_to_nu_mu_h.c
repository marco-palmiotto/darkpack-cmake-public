        ...
        )
{
    ...
    const ccomplex_t IT_0068 = cpow(s_13 + (-0.5)*IT_0067 + 0.5*m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0069 = IT_0066*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0001
    ...
    const ccomplex_t IT_0075 = cpow(s_13 + (-0.5)*IT_0067 + 0.5*m_smu_L*
