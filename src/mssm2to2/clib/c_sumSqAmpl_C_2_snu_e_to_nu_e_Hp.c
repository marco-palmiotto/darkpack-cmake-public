...
ccomplex_return_t c_sumSqAmpl_C_2_snu_e_to_nu_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = cpow(s_13 + (-0.5)*IT_0011 + 0.5*m_se_L*(m_se_L
    ...
    const ccomplex_t IT_0026 = IT_0004*IT_0006;
    const ccomplex_t IT_0027 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = 1.4142135623731*IT_0028;
    const ccomplex_t IT_0030 = IT_0004*IT_0017;
    const ccomplex_t IT_0031 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0035 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0042 = pow(m_snu_mu, 2);
    const ccomplex_t IT_0043 = cpow(s_23 + (-0.5)*IT_0042 + 0.5*m_N_1*(m_N_1 +
       (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0015*IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0056 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0057 = IT_0030*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0068 = cpow(s_23 + (-0.5)*IT_0042 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0081 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0082 = IT_0030*IT_0081;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0118 = cpow(s_23 + (-0.5)*IT_0042 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0119 = IT_0116*IT_0117*IT_0118;
    const ccomplex_t IT_0120 = cpow(s_13 + (-0.5)*IT_0011 + 0.5*m_se_R*(m_se_R
       + (0 + _Complex_I*-1)*Gamma_er) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0001*IT_0006;
    const ccomplex_t IT_0122 = 0.5*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
    ...
    const ccomplex_t IT_0128 = 0.5*IT_0014 + 0.5*IT_0044 + 0.5*IT_0069 + 0.5
      *IT_0094 + 0.5*IT_0119 + 0.5*IT_0127;
    ...
    const ccomplex_t IT_0133 = IT_0000*IT_0017;
    ...
    const ccomplex_t IT_0193 = IT_0118*IT_0192;
    ...
    const ccomplex_t IT_0198 = s_13*IT_0042;
