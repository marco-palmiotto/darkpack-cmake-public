...
ccomplex_return_t c_sumSqAmpl_C_2_ss_L_to_c_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0003;
    ...
    const ccomplex_t IT_0038 = m_c*s_14*m_C_2;
    ...
    const ccomplex_t IT_0048 = m_c*m_C_2;
    ...
    const ccomplex_t IT_0053 = m_c*s_34*m_C_2;
