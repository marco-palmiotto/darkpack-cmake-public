...
ccomplex_return_t c_sumSqAmpl_C_2_ss_L_to_c_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0007 = 0.5*IT_0006;
    const ccomplex_t IT_0008 = cos(alpha);
    const ccomplex_t IT_0009 = V_u2*U_Wm2;
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_12 + IT_0019 + -IT_0020 + -IT_0023 
      + -reg_prop, -1);
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*m_c*e_em*IT_0001*IT_0003
      *IT_0005*IT_0008;
    const ccomplex_t IT_0026 = (-0.5)*IT_0025;
    const ccomplex_t IT_0027 = IT_0007*IT_0026;
    const ccomplex_t IT_0028 = IT_0024*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = m_c*IT_0029;
    const ccomplex_t IT_0031 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0032 = IT_0008*IT_0031;
    const ccomplex_t IT_0033 = conj(U_d2)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0005
      *IT_0011*IT_0051*IT_0053 + (-0.5)*m_W*(IT_0002*IT_0008 + IT_0011*IT_0052)*
      (IT_0005 + 1./3*IT_0004*IT_0055));
    const ccomplex_t IT_0057 = IT_0007*IT_0056;
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0019 + IT_0023 + -m_ss_L*
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0001*IT_0003*IT_0005*U_sb_01;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = IT_0062*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0019 + IT_0023 + -m_sb_2*
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0071 = 0.5*IT_0070;
    const ccomplex_t IT_0072 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_23 + IT_0019 + IT_0020 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0069*IT_0080*IT_0081;
    const ccomplex_t IT_0083 = conj(V_u1)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0087 = IT_0005*(IT_0084 + -IT_0086);
    ...
    const ccomplex_t IT_0095 = -IT_0022 + (-2)*IT_0030 + -IT_0042 + IT_0050 +
       IT_0060 + IT_0068 + -IT_0082 + -IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0011;
    const ccomplex_t IT_0097 = 0.5*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_cd*e_em*IT_0001*IT_0005*IT_0053;
    const ccomplex_t IT_0099 = (-0.5)*IT_0098;
    const ccomplex_t IT_0100 = IT_0097*IT_0099;
    const ccomplex_t IT_0101 = cpow((-2)*s_13 + IT_0019 + IT_0023 + -m_sd_R*
    ...
    const ccomplex_t IT_0121 = IT_0066*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0005;
    const ccomplex_t IT_0124 = IT_0038*IT_0123;
    const ccomplex_t IT_0125 = IT_0000*IT_0021*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0127 = IT_0079*IT_0126;
    const ccomplex_t IT_0128 = IT_0081*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*IT_0128;
    const ccomplex_t IT_0130 = m_C_2*IT_0129;
    const ccomplex_t IT_0131 = IT_0017*IT_0123;
    ...
    const ccomplex_t IT_0135 = IT_0026*IT_0123;
    ...
    const ccomplex_t IT_0139 = IT_0056*IT_0123;
    const ccomplex_t IT_0140 = IT_0058*IT_0139;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*IT_0140;
    const ccomplex_t IT_0142 = m_b*conj(U_d2)*V_cb*e_em*IT_0001*U_sb_10;
    const ccomplex_t IT_0143 = IT_0112*IT_0142;
    const ccomplex_t IT_0144 = 1.4142135623731*IT_0143;
    const ccomplex_t IT_0145 = V_cb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0146 = IT_0005*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*(IT_0144 + (-2)*IT_0146);
    ...
    const ccomplex_t IT_0152 = IT_0090*IT_0126;
    const ccomplex_t IT_0153 = IT_0069*IT_0081*IT_0152;
    const ccomplex_t IT_0154 = -IT_0103 + -IT_0111 + -IT_0122 + IT_0125 +
       IT_0130 + IT_0134 + 2*IT_0138 + -IT_0141 + -IT_0151 + IT_0153;
    const ccomplex_t IT_0155 = 6*s_13;
    const ccomplex_t IT_0156 = m_c*m_C_2;
    const ccomplex_t IT_0157 = 6*IT_0095;
    const ccomplex_t IT_0158 = -IT_0029 + -IT_0129 + -IT_0133;
    const ccomplex_t IT_0159 = m_c*s_14;
    const ccomplex_t IT_0160 = IT_0041 + IT_0093 + IT_0137;
    const ccomplex_t IT_0161 = s_34*m_C_2;
    const ccomplex_t IT_0162 = 6*conj(IT_0095);
    const ccomplex_t IT_0163 = 6*conj(IT_0154);
    const ccomplex_t IT_0164 = pow(m_h, 2);
    const ccomplex_t IT_0165 = m_c*m_C_2*IT_0164;
    ...
    const ccomplex_t IT_0172 = (IT_0095*conj(IT_0095) + IT_0154*conj(IT_0154))
