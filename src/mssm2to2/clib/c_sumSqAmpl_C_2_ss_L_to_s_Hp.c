...
ccomplex_return_t c_sumSqAmpl_C_2_ss_L_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0049 = pow(m_c, 2);
    const ccomplex_t IT_0050 = pow(m_C_2, 2);
    const ccomplex_t IT_0051 = cpow((-2)*s_12 + -IT_0027 + IT_0049 + -IT_0050 
      + -reg_prop, -1);
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0053 = sin(beta);
    const ccomplex_t IT_0054 = cpow(IT_0053, -1);
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0001*IT_0005*IT_0054;
    const ccomplex_t IT_0056 = 0.5*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0001*IT_0003*IT_0005*IT_0053;
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = IT_0056*IT_0058;
    const ccomplex_t IT_0060 = IT_0051*IT_0052*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0027 + -IT_0050 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u2
      *e_em*IT_0001*IT_0005*IT_0054;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_ts)
      *e_em*IT_0001*IT_0003*IT_0005*IT_0053;
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = IT_0064*IT_0066;
    const ccomplex_t IT_0068 = IT_0061*IT_0062*IT_0067;
    ...
    const ccomplex_t IT_0120 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0122 = (-0.5)*IT_0121;
    const ccomplex_t IT_0123 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0124 = IT_0008*IT_0123;
    const ccomplex_t IT_0125 = 2*IT_0124;
    const ccomplex_t IT_0126 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0127 = IT_0014*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0138 = pow(m_u, 2);
    const ccomplex_t IT_0139 = cpow((-2)*s_12 + -IT_0027 + -IT_0050 + IT_0138 
      + -reg_prop, -1);
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm2)*IT_0005;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *IT_0001*IT_0003*IT_0005*IT_0053;
    ...
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_us
      *e_em*IT_0001*IT_0005*IT_0054;
    const ccomplex_t IT_0149 = 0.5*IT_0148;
    const ccomplex_t IT_0150 = IT_0142*IT_0149;
    const ccomplex_t IT_0151 = IT_0139*IT_0147*IT_0150;
    ...
    const ccomplex_t IT_0156 = IT_0005*IT_0155;
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0005;
    const ccomplex_t IT_0165 = IT_0058*IT_0164;
    ...
    const ccomplex_t IT_0170 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0171 = (-0.5)*IT_0170;
    const ccomplex_t IT_0172 = IT_0101*IT_0171;
    const ccomplex_t IT_0173 = IT_0103*IT_0169*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0179 = -IT_0029 + -IT_0048 + -IT_0060 + -IT_0068 +
       IT_0080 + IT_0106 + IT_0118 + -IT_0137 + IT_0146 + -IT_0151 + IT_0163 +
       IT_0168 + -IT_0173 + IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0001*IT_0002*IT_0005*IT_0054;
    const ccomplex_t IT_0181 = 0.5*IT_0180;
    const ccomplex_t IT_0182 = IT_0140*IT_0181;
    const ccomplex_t IT_0183 = IT_0139*IT_0147*IT_0182;
    const ccomplex_t IT_0184 = IT_0005*IT_0053;
    ...
    const ccomplex_t IT_0188 = IT_0013*IT_0053;
    ...
    const ccomplex_t IT_0200 = IT_0103*IT_0169*IT_0199;
    ...
    const ccomplex_t IT_0205 = IT_0188*IT_0204;
    ...
    const ccomplex_t IT_0214 = IT_0114*IT_0213;
    const ccomplex_t IT_0215 = IT_0030*IT_0047*IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_ts)
      *e_em*IT_0001*IT_0002*IT_0005*IT_0054;
    const ccomplex_t IT_0217 = 0.5*IT_0216;
    const ccomplex_t IT_0218 = IT_0174*IT_0217;
    const ccomplex_t IT_0219 = IT_0061*IT_0062*IT_0218;
    const ccomplex_t IT_0220 = IT_0171*IT_0198;
    const ccomplex_t IT_0221 = IT_0103*IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1)*IT_0221;
    const ccomplex_t IT_0223 = m_s*IT_0222;
    const ccomplex_t IT_0224 = IT_0032*IT_0213;
    const ccomplex_t IT_0225 = IT_0047*IT_0224;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = m_s*IT_0226;
    const ccomplex_t IT_0228 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0001*IT_0002*IT_0005*IT_0054;
    ...
    const ccomplex_t IT_0234 = IT_0064*IT_0217;
    ...
    const ccomplex_t IT_0238 = IT_0149*IT_0181;
    const ccomplex_t IT_0239 = IT_0139*IT_0238;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*IT_0239;
    const ccomplex_t IT_0241 = m_C_2*IT_0240;
    const ccomplex_t IT_0242 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0243 = IT_0184*IT_0242;
    const ccomplex_t IT_0244 = (-2)*IT_0243;
    const ccomplex_t IT_0245 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0246 = IT_0188*IT_0245;
    const ccomplex_t IT_0247 = 1.4142135623731*IT_0246;
    const ccomplex_t IT_0248 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0255 = IT_0159*IT_0254;
    const ccomplex_t IT_0256 = IT_0119*IT_0120*IT_0255;
    const ccomplex_t IT_0257 = IT_0122*IT_0254;
    ...
    const ccomplex_t IT_0261 = IT_0164*IT_0229;
    const ccomplex_t IT_0262 = IT_0051*IT_0052*IT_0261;
    const ccomplex_t IT_0263 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0264 = IT_0184*IT_0263;
    const ccomplex_t IT_0265 = 1.4142135623731*IT_0264;
    const ccomplex_t IT_0266 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0267 = IT_0188*IT_0266;
    const ccomplex_t IT_0268 = 1.4142135623731*IT_0267;
    const ccomplex_t IT_0269 = IT_0265 + IT_0268;
    const ccomplex_t IT_0270 = conj(N_d1)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0271 = IT_0184*IT_0270;
    ...
    const ccomplex_t IT_0276 = IT_0076*IT_0275;
    const ccomplex_t IT_0277 = IT_0000*IT_0028*IT_0276;
    const ccomplex_t IT_0278 = IT_0007*IT_0275;
    const ccomplex_t IT_0279 = IT_0028*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*IT_0279;
    const ccomplex_t IT_0281 = m_s*IT_0280;
    const ccomplex_t IT_0282 = IT_0183 + -IT_0200 + -IT_0215 + IT_0219 +
       IT_0223 + IT_0227 + -IT_0233 + -IT_0237 + -IT_0241 + -IT_0256 + IT_0260 +
       IT_0262 + -IT_0277 + IT_0281;
    const ccomplex_t IT_0283 = 6*s_13;
    const ccomplex_t IT_0284 = m_s*m_C_2;
    const ccomplex_t IT_0285 = 6*IT_0179;
    const ccomplex_t IT_0286 = -IT_0079 + -IT_0105 + -IT_0117 + -IT_0162 + 
      -IT_0232 + -IT_0236 + -IT_0240;
    const ccomplex_t IT_0287 = m_s*s_12;
    const ccomplex_t IT_0288 = IT_0145 + IT_0167 + IT_0177 + -IT_0222 + 
      -IT_0226 + -IT_0259 + -IT_0280;
    const ccomplex_t IT_0289 = s_23*m_C_2;
    const ccomplex_t IT_0290 = 6*conj(IT_0179);
    const ccomplex_t IT_0291 = 6*conj(IT_0282);
    const ccomplex_t IT_0292 = m_s*m_C_2*IT_0027;
    const ccomplex_t IT_0293 = s_13*IT_0027;
    const ccomplex_t IT_0294 = (-6)*IT_0293;
    const ccomplex_t IT_0295 = s_12*s_23;
    const ccomplex_t IT_0296 = 12*IT_0295;
    const ccomplex_t IT_0297 = IT_0294 + IT_0296;
    const ccomplex_t IT_0298 = 6*IT_0282;
    const ccomplex_t IT_0299 = 0.166666666666667*IT_0287;
    const ccomplex_t IT_0300 = 0.166666666666667*IT_0289;
    const ccomplex_t IT_0301 = (IT_0179*conj(IT_0179) + IT_0282*conj(IT_0282))
      *IT_0283 + conj(IT_0282)*IT_0284*IT_0285 + (IT_0282*IT_0284 + IT_0286
      *IT_0287 + IT_0288*IT_0289)*IT_0290 + (IT_0287*IT_0288 + IT_0286*IT_0289)
      *IT_0291 + 6*conj(IT_0288)*(IT_0286*IT_0292 + 0.166666666666667*IT_0288
      *IT_0297 + IT_0298*IT_0299 + IT_0285*IT_0300) + 6*conj(IT_0286)*(IT_0288
      *IT_0292 + 0.166666666666667*IT_0286*IT_0297 + IT_0285*IT_0299 + IT_0298
      *IT_0300);
