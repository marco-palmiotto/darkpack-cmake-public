        ...
        )
{
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sb_1*
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0036 = 1.4142135623731*A_b*V_tb*V_ts*IT_0000*conj
      (U_sb_01);
    ...
    const ccomplex_t IT_0055 = m_b*conj(U_d2)*V_cb*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = 1.4142135623731*IT_0056;
    const ccomplex_t IT_0058 = V_cb*e_em*conj(U_Wm2)*U_sb_00;
    ...
    const ccomplex_t IT_0065 = m_b*conj(U_d2)*V_cb*e_em*IT_0003*U_sb_11;
    const ccomplex_t IT_0066 = IT_0054*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = V_cb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0069 = IT_0006*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*(IT_0067 + (-2)*IT_0069);
    ...
    const ccomplex_t IT_0079 = IT_0000*IT_0078;
    const ccomplex_t IT_0080 = IT_0006*(IT_0077 + IT_0079);
    ...
    const ccomplex_t IT_0086 = pow(m_ss_R, 2);
    const ccomplex_t IT_0087 = cpow((-2)*s_23 + IT_0010 + IT_0086 + -m_C_1*
    ...
    const ccomplex_t IT_0093 = IT_0000*IT_0092;
    const ccomplex_t IT_0094 = IT_0006*(IT_0091 + IT_0093);
    const ccomplex_t IT_0095 = 1.4142135623731*e_em*IT_0094;
    const ccomplex_t IT_0096 = (-0.5)*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0003*IT_0006*IT_0053;
    const ccomplex_t IT_0098 = (-0.5)*IT_0097;
    const ccomplex_t IT_0099 = IT_0096*IT_0098;
    const ccomplex_t IT_0100 = cpow((-2)*s_23 + IT_0010 + IT_0086 + -m_C_2*
    ...
    const ccomplex_t IT_0124 = -IT_0047 + -IT_0051 + -IT_0064 + -IT_0074 +
    ...
    const ccomplex_t IT_0130 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0086 
      + -reg_prop, -1);
