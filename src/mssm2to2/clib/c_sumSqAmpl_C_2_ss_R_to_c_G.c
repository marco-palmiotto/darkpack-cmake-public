...
ccomplex_return_t c_sumSqAmpl_C_2_ss_R_to_c_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_R*
    ...
    const ccomplex_t IT_0022 = s_14*s_34;
    const ccomplex_t IT_0023 = -IT_0019;
    const ccomplex_t IT_0024 = s_34*IT_0001;
    const ccomplex_t IT_0025 = s_13*s_14;
    const ccomplex_t IT_0026 = (-16)*IT_0025;
    const ccomplex_t IT_0027 = 8*IT_0024 + IT_0026;
    const ccomplex_t IT_0028 = -IT_0004;
    const ccomplex_t IT_0029 = IT_0018*IT_0028;
    const ccomplex_t IT_0030 = (-8)*s_13;
    const ccomplex_t IT_0031 = s_34*IT_0030;
    const ccomplex_t IT_0032 = pow(s_13, 2);
    const ccomplex_t IT_0033 = (-8)*IT_0032;
    const ccomplex_t IT_0034 = (-8)*conj(IT_0014)*(IT_0020*IT_0021 + (-4)
      *IT_0014*IT_0022 + (-0.125)*IT_0023*IT_0027) + conj(IT_0029)*(s_14*IT_0023
      *IT_0030 + IT_0020*IT_0031) + conj(IT_0023)*(IT_0014*IT_0027 + (IT_0001
      *IT_0023 + s_14*IT_0029)*IT_0030 + IT_0020*IT_0033) + (-8)*conj(IT_0020)*
      (s_13*IT_0000*IT_0020 + IT_0014*IT_0021 + (-0.125)*IT_0029*IT_0031 + (
      -0.125)*IT_0023*IT_0033);
    return create_ccomplex_return(IT_0034);
}
