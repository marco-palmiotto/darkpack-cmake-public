        ...
        )
{
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*(m_W*IT_0006*(IT_0000
      *IT_0016 + -IT_0004*IT_0018)*IT_0045 + (-3)*IT_0000*IT_0003*IT_0007
      *IT_0017*IT_0046);
    ...
    const ccomplex_t IT_0065 = IT_0000*IT_0064;
    ...
    const ccomplex_t IT_0077 = conj(U_d2)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0100 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0130 = U_d1*V_Wp2;
