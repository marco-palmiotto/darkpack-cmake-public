...
ccomplex_return_t c_sumSqAmpl_C_2_ss_R_to_c_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0045 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*e_em*(m_W*IT_0006*(IT_0010
      *IT_0016 + -IT_0004*IT_0018)*IT_0082 + (-3)*IT_0003*IT_0007*IT_0010
      *IT_0017*IT_0083);
    ...
    const ccomplex_t IT_0108 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0120 = U_d2*V_Wp2;
    const ccomplex_t IT_0121 = IT_0010*IT_0120;
    const ccomplex_t IT_0122 = V_u2*U_Wm2;
