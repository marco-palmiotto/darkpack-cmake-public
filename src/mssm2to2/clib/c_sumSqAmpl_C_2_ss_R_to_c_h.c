        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sd_L*
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0000 + m_s*e_em*mu_h*IT_0003*IT_0007*IT_0017*IT_0018);
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0000*conj(U_sb_00);
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0003*IT_0005*IT_0007*U_sb_01;
    const ccomplex_t IT_0038 = 0.5*IT_0037;
    const ccomplex_t IT_0039 = IT_0036*IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sb_2*
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*(m_W*IT_0006*(IT_0000
      *IT_0016 + IT_0004*IT_0018)*IT_0045 + (-3)*IT_0000*IT_0003*IT_0007*IT_0017
      *IT_0046);
    const ccomplex_t IT_0048 = (-0.333333333333333)*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0003*IT_0007*IT_0017;
    const ccomplex_t IT_0050 = (-0.5)*IT_0049;
    const ccomplex_t IT_0051 = IT_0048*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = pow(m_ss_R, 2);
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + IT_0011 + -IT_0012 + -IT_0055 
      + -reg_prop, -1);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*m_c*e_em*IT_0003*IT_0005
      *IT_0007*IT_0018;
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0011 + IT_0055 + -m_C_2*
    ...
    const ccomplex_t IT_0068 = IT_0007*(IT_0065 + -IT_0067);
    ...
    const ccomplex_t IT_0086 = IT_0063*IT_0076*IT_0085;
    const ccomplex_t IT_0087 = IT_0007*IT_0017;
    const ccomplex_t IT_0088 = m_b*conj(U_d2)*V_cb*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = V_cb*e_em*conj(U_Wm2)*U_sb_00;
    ...
    const ccomplex_t IT_0099 = cpow((-2)*s_23 + IT_0011 + IT_0055 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0100 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0101 = IT_0018*IT_0100;
    const ccomplex_t IT_0102 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0111 = IT_0098*IT_0099*IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0007;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0007;
    ...
    const ccomplex_t IT_0120 = m_b*conj(U_d2)*V_cb*e_em*IT_0003*U_sb_11;
    const ccomplex_t IT_0121 = IT_0087*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = V_cb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0124 = IT_0007*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*(IT_0122 + (-2)*IT_0124);
    ...
    const ccomplex_t IT_0130 = V_u2*U_Wm1;
    const ccomplex_t IT_0131 = IT_0018*IT_0130;
    const ccomplex_t IT_0132 = U_d1*V_Wp2;
    const ccomplex_t IT_0133 = IT_0000*IT_0132;
    ...
    const ccomplex_t IT_0142 = -IT_0054 + 2*IT_0062 + IT_0075 + IT_0086 + 
      -IT_0097 + IT_0111 + -IT_0115 + -IT_0119 + -IT_0129 + IT_0141;
    const ccomplex_t IT_0143 = 6*s_13;
    const ccomplex_t IT_0144 = m_c*m_C_2;
    const ccomplex_t IT_0145 = 6*IT_0043;
    const ccomplex_t IT_0146 = -IT_0074 + -IT_0140;
    ...
    const ccomplex_t IT_0159 = (IT_0043*conj(IT_0043) + IT_0142*conj(IT_0142))
      ...
      *IT_0147 + IT_0061*IT_0148)*IT_0149 + (IT_0061*IT_0147 + IT_0146*IT_0148)
      *IT_0150 + 6*conj(IT_0061)*(IT_0146*IT_0152 + -IT_0061*IT_0156 +
       0.166666666666667*IT_0147*IT_0157 + IT_0145*IT_0158) + 6*conj(IT_0146)*
      (0.166666666666667*IT_0145*IT_0147 + IT_0061*IT_0152 + -IT_0146*IT_0156 +
       IT_0157*IT_0158);
