...
ccomplex_return_t c_sumSqAmpl_C_2_st_1_to_t_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0052 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0053 = IT_0009*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*IT_0053;
    const ccomplex_t IT_0055 = m_t*N_u2*e_em*IT_0027*U_st_00;
    ...
    const ccomplex_t IT_0077 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0078 = IT_0009*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = m_t*N_u3*e_em*IT_0027*U_st_00;
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0034 + IT_0035 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0090 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0091 = IT_0009*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = m_t*N_u4*e_em*IT_0027*U_st_00;
    ...
    const ccomplex_t IT_0112 = IT_0088*IT_0089*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u2
      *e_em*IT_0003*IT_0025*IT_0027;
    const ccomplex_t IT_0114 = 0.5*IT_0113;
    const ccomplex_t IT_0115 = pow(m_s, 2);
    const ccomplex_t IT_0116 = cpow(IT_0001, -1);
    const ccomplex_t IT_0117 = A_t*IT_0001*U_st_10 + (-1.4142135623731)*e_em
      *IT_0003*(m_W*IT_0001*IT_0024*U_st_00 + (-0.5)*IT_0027*(IT_0024*IT_0115
      *IT_0116*U_st_00 + m_t*(m_t*IT_0001*IT_0025*U_st_00 + mu_h*U_st_10)));
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*conj(V_ts)*IT_0117;
    const ccomplex_t IT_0119 = IT_0114*IT_0118;
    const ccomplex_t IT_0120 = pow(m_C_2, 2);
    const ccomplex_t IT_0121 = cpow((-2)*s_13 + IT_0034 + IT_0120 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0122 = IT_0119*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u2
      *e_em*IT_0003*IT_0025*IT_0027;
    const ccomplex_t IT_0125 = 0.5*IT_0124;
    const ccomplex_t IT_0126 = pow(m_d, 2);
    const ccomplex_t IT_0127 = A_t*IT_0001*U_st_10 + (-1.4142135623731)*e_em
      *IT_0003*(m_W*IT_0001*IT_0024*U_st_00 + (-0.5)*IT_0027*(IT_0024*IT_0116
      *IT_0126*U_st_00 + m_t*(m_t*IT_0001*IT_0025*U_st_00 + mu_h*U_st_10)));
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*conj(V_td)*IT_0127;
    const ccomplex_t IT_0129 = IT_0125*IT_0128;
    const ccomplex_t IT_0130 = cpow((-2)*s_13 + IT_0034 + IT_0120 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0131 = IT_0129*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*IT_0131;
    const ccomplex_t IT_0133 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0025*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0024*IT_0116*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0025*IT_0116*U_st_10));
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0024*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0027
      *IT_0133 + m_W*IT_0001*IT_0024*conj(U_sb_00)*U_st_00) + A_t*IT_0001*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0003*IT_0025*IT_0027*U_sb_00;
    const ccomplex_t IT_0136 = 0.5*IT_0135;
    const ccomplex_t IT_0137 = IT_0134*IT_0136;
    const ccomplex_t IT_0138 = cpow((-2)*s_13 + IT_0034 + IT_0120 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0139 = IT_0137*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*IT_0139;
    const ccomplex_t IT_0141 = m_t*conj(U_sb_01)*(m_t*IT_0001*IT_0025*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0024*IT_0116*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0025*IT_0116*U_st_10));
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0024*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0027
      *IT_0141 + m_W*IT_0001*IT_0024*conj(U_sb_01)*U_st_00) + A_t*IT_0001*conj
      (U_sb_01)*U_st_10);
    ...
    const ccomplex_t IT_0163 = m_t*IT_0162;
    const ccomplex_t IT_0164 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0165 = IT_0009*IT_0164;
    const ccomplex_t IT_0166 = 1.4142135623731*IT_0165;
    const ccomplex_t IT_0167 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0168 = IT_0003*IT_0167;
    const ccomplex_t IT_0169 = 1.4142135623731*IT_0168;
    const ccomplex_t IT_0170 = m_t*conj(N_u2)*e_em*IT_0027*U_st_10;
    ...
    const ccomplex_t IT_0176 = IT_0061*IT_0175;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*IT_0176;
    const ccomplex_t IT_0178 = m_t*IT_0177;
    const ccomplex_t IT_0179 = conj(N_B3)*e_em*U_st_00;
    const ccomplex_t IT_0180 = IT_0009*IT_0179;
    const ccomplex_t IT_0181 = 1.4142135623731*IT_0180;
    const ccomplex_t IT_0182 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0183 = IT_0003*IT_0182;
    const ccomplex_t IT_0184 = 1.4142135623731*IT_0183;
    const ccomplex_t IT_0185 = m_t*conj(N_u3)*e_em*IT_0027*U_st_10;
    ...
    const ccomplex_t IT_0190 = IT_0076*IT_0189;
    const ccomplex_t IT_0191 = IT_0086*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*IT_0191;
    const ccomplex_t IT_0193 = m_t*IT_0192;
    const ccomplex_t IT_0194 = conj(N_B4)*e_em*U_st_00;
    const ccomplex_t IT_0195 = IT_0009*IT_0194;
    const ccomplex_t IT_0196 = 1.4142135623731*IT_0195;
    const ccomplex_t IT_0197 = conj(N_W4)*e_em*U_st_00;
    const ccomplex_t IT_0198 = IT_0003*IT_0197;
    const ccomplex_t IT_0199 = 1.4142135623731*IT_0198;
    const ccomplex_t IT_0200 = m_t*conj(N_u4)*e_em*IT_0027*U_st_10;
    ...
    const ccomplex_t IT_0206 = IT_0089*IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*IT_0206;
    const ccomplex_t IT_0208 = m_t*IT_0207;
    const ccomplex_t IT_0209 = -IT_0037 + -IT_0062 + -IT_0087 + -IT_0112 +
       IT_0123 + IT_0132 + IT_0140 + IT_0148 + IT_0163 + IT_0178 + IT_0193 +
       IT_0208;
    ...
    const ccomplex_t IT_0225 = IT_0159*IT_0224;
    ...
    const ccomplex_t IT_0240 = IT_0174*IT_0239;
    ...
    const ccomplex_t IT_0255 = IT_0189*IT_0254;
    ...
    const ccomplex_t IT_0271 = IT_0088*IT_0089*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0024
      *U_st_00 + 0.707106781186548*m_s*e_em*IT_0003*IT_0027*(mu_h*U_st_00 + m_t
      *IT_0025*IT_0116*U_st_10));
    const ccomplex_t IT_0273 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_ts*e_em*IT_0003*IT_0027*IT_0116;
    const ccomplex_t IT_0274 = (-0.5)*IT_0273;
    const ccomplex_t IT_0275 = IT_0272*IT_0274;
    const ccomplex_t IT_0276 = cpow((-2)*s_13 + IT_0034 + IT_0120 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0277 = IT_0275*IT_0276;
    const ccomplex_t IT_0278 = (0 + _Complex_I*1)*IT_0277;
    const ccomplex_t IT_0279 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0024
      *U_st_00 + 0.707106781186548*m_d*e_em*IT_0003*IT_0027*(mu_h*U_st_00 + m_t
      *IT_0025*IT_0116*U_st_10));
    const ccomplex_t IT_0280 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_td*e_em*IT_0003*IT_0027*IT_0116;
    const ccomplex_t IT_0281 = (-0.5)*IT_0280;
    const ccomplex_t IT_0282 = IT_0279*IT_0281;
    const ccomplex_t IT_0283 = cpow((-2)*s_13 + IT_0034 + IT_0120 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0284 = IT_0282*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm2)*IT_0003;
    const ccomplex_t IT_0287 = IT_0118*IT_0286;
    const ccomplex_t IT_0288 = IT_0121*IT_0287;
    const ccomplex_t IT_0289 = (0 + _Complex_I*1)*IT_0288;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm2)*IT_0003;
    const ccomplex_t IT_0291 = IT_0128*IT_0290;
    const ccomplex_t IT_0292 = IT_0130*IT_0291;
    const ccomplex_t IT_0293 = (0 + _Complex_I*1)*IT_0292;
    const ccomplex_t IT_0294 = IT_0003*IT_0116;
    const ccomplex_t IT_0295 = m_b*conj(U_d2)*V_tb*e_em*IT_0027*U_sb_10;
    const ccomplex_t IT_0296 = IT_0294*IT_0295;
    const ccomplex_t IT_0297 = 1.4142135623731*IT_0296;
    const ccomplex_t IT_0298 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0299 = IT_0003*IT_0298;
    const ccomplex_t IT_0300 = (0 + _Complex_I*1)*(IT_0297 + (-2)*IT_0299);
    const ccomplex_t IT_0301 = (-0.5)*IT_0300;
    const ccomplex_t IT_0302 = IT_0134*IT_0301;
    const ccomplex_t IT_0303 = IT_0138*IT_0302;
    const ccomplex_t IT_0304 = (0 + _Complex_I*1)*IT_0303;
    const ccomplex_t IT_0305 = m_b*conj(U_d2)*V_tb*e_em*IT_0027*U_sb_11;
    const ccomplex_t IT_0306 = IT_0294*IT_0305;
    const ccomplex_t IT_0307 = 1.4142135623731*IT_0306;
    const ccomplex_t IT_0308 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0309 = IT_0003*IT_0308;
    const ccomplex_t IT_0310 = (0 + _Complex_I*1)*(IT_0307 + (-2)*IT_0309);
    const ccomplex_t IT_0311 = (-0.5)*IT_0310;
    const ccomplex_t IT_0312 = IT_0142*IT_0311;
    const ccomplex_t IT_0313 = IT_0146*IT_0312;
    const ccomplex_t IT_0314 = (0 + _Complex_I*1)*IT_0313;
    const ccomplex_t IT_0315 = IT_0032*IT_0224;
    const ccomplex_t IT_0316 = IT_0036*IT_0315;
    const ccomplex_t IT_0317 = (0 + _Complex_I*1)*IT_0316;
    const ccomplex_t IT_0318 = m_t*IT_0317;
    const ccomplex_t IT_0319 = IT_0084*IT_0254;
    const ccomplex_t IT_0320 = IT_0086*IT_0319;
    const ccomplex_t IT_0321 = (0 + _Complex_I*1)*IT_0320;
    const ccomplex_t IT_0322 = m_t*IT_0321;
    const ccomplex_t IT_0323 = IT_0097*IT_0269;
    const ccomplex_t IT_0324 = IT_0089*IT_0323;
    const ccomplex_t IT_0325 = (0 + _Complex_I*1)*IT_0324;
    const ccomplex_t IT_0326 = m_t*IT_0325;
    const ccomplex_t IT_0327 = IT_0059*IT_0239;
    const ccomplex_t IT_0328 = IT_0061*IT_0327;
    ...
    const ccomplex_t IT_0331 = -IT_0226 + -IT_0241 + -IT_0256 + -IT_0271 + 
      -IT_0278 + -IT_0285 + -IT_0289 + -IT_0293 + -IT_0304 + -IT_0314 + IT_0318 
    ...
    const ccomplex_t IT_0335 = -IT_0162 + -IT_0177 + -IT_0192 + -IT_0207;
    const ccomplex_t IT_0336 = m_t*s_12;
    const ccomplex_t IT_0337 = -IT_0317 + -IT_0321 + -IT_0325 + -IT_0329;
