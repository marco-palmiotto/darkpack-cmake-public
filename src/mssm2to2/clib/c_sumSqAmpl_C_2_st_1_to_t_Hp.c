        ...
        )
{
    ...
    const ccomplex_t IT_0092 = A_t*IT_0001*U_st_10 + (-1.4142135623731)*e_em
      *IT_0003*(m_W*IT_0001*IT_0024*U_st_00 + (-0.5)*IT_0027*(IT_0024*IT_0090
      *IT_0091*U_st_00 + m_t*(m_t*IT_0001*IT_0025*U_st_00 + mu_h*U_st_10)));
    ...
    const ccomplex_t IT_0102 = A_t*IT_0001*U_st_10 + (-1.4142135623731)*e_em
      *IT_0003*(m_W*IT_0001*IT_0024*U_st_00 + (-0.5)*IT_0027*(IT_0024*IT_0091
      *IT_0101*U_st_00 + m_t*(m_t*IT_0001*IT_0025*U_st_00 + mu_h*U_st_10)));
    ...
    const ccomplex_t IT_0108 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0025*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0024*IT_0091*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0025*IT_0091*U_st_10));
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0024*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0027
      *IT_0108 + m_W*IT_0001*IT_0024*conj(U_sb_00)*U_st_00) + A_t*IT_0001*conj
      (U_sb_00)*U_st_10);
    ...
    const ccomplex_t IT_0116 = m_t*conj(U_sb_01)*(m_t*IT_0001*IT_0025*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0024*IT_0091*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0025*IT_0091*U_st_10));
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0024*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0027
      *IT_0116 + m_W*IT_0001*IT_0024*conj(U_sb_01)*U_st_00) + A_t*IT_0001*conj
      (U_sb_01)*U_st_10);
    ...
    const ccomplex_t IT_0199 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0200 = IT_0009*IT_0199;
    const ccomplex_t IT_0201 = 1.4142135623731*IT_0200;
    const ccomplex_t IT_0202 = m_t*N_u4*e_em*IT_0027*U_st_00;
    ...
    const ccomplex_t IT_0284 = cpow((-2)*s_13 + IT_0034 + IT_0095 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0024
      *U_st_00 + 0.707106781186548*m_s*e_em*IT_0003*IT_0027*(mu_h*U_st_00 + m_t
      *IT_0025*IT_0091*U_st_10));
    const ccomplex_t IT_0286 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
    ...
    const ccomplex_t IT_0291 = cpow((-2)*s_13 + IT_0034 + IT_0095 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0024
      *U_st_00 + 0.707106781186548*m_d*e_em*IT_0003*IT_0027*(mu_h*U_st_00 + m_t
      *IT_0025*IT_0091*U_st_10));
    const ccomplex_t IT_0293 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
