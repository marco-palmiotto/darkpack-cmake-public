...
ccomplex_return_t c_sumSqAmpl_C_2_st_1_to_t_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = N_B3*e_em*U_st_10;
    ...
    const ccomplex_t IT_0018 = m_t*N_u3*e_em*IT_0017*U_st_00;
    ...
    const ccomplex_t IT_0036 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0037 = IT_0010*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = m_t*N_u4*e_em*IT_0017*U_st_00;
    ...
    const ccomplex_t IT_0089 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0090 = IT_0010*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = m_t*N_u1*e_em*IT_0017*U_st_00;
    ...
    const ccomplex_t IT_0111 = m_t*N_u2*e_em*IT_0017*U_st_00;
    ...
    const ccomplex_t IT_0130 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0131 = IT_0001*IT_0130;
    const ccomplex_t IT_0132 = 1.4142135623731*IT_0131;
    const ccomplex_t IT_0133 = m_t*conj(N_u1)*e_em*IT_0017*U_st_10;
    ...
    const ccomplex_t IT_0194 = m_t*conj(N_u2)*e_em*IT_0017*U_st_10;
