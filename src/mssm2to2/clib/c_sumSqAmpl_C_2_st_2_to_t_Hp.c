        ...
        )
{
    ...
    const ccomplex_t IT_0090 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0091 = IT_0009*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = m_t*N_u4*e_em*IT_0027*U_st_01;
    ...
    const ccomplex_t IT_0117 = A_t*IT_0001*U_st_11 + (-1.4142135623731)*e_em
      *IT_0003*(m_W*IT_0001*IT_0024*U_st_01 + (-0.5)*IT_0027*(IT_0024*IT_0115
      *IT_0116*U_st_01 + m_t*(m_t*IT_0001*IT_0025*U_st_01 + mu_h*U_st_11)));
    ...
    const ccomplex_t IT_0127 = A_t*IT_0001*U_st_11 + (-1.4142135623731)*e_em
      *IT_0003*(m_W*IT_0001*IT_0024*U_st_01 + (-0.5)*IT_0027*(IT_0024*IT_0116
      *IT_0126*U_st_01 + m_t*(m_t*IT_0001*IT_0025*U_st_01 + mu_h*U_st_11)));
    ...
    const ccomplex_t IT_0133 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0025*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0024*IT_0116*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0025*IT_0116*U_st_11));
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0024*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0027
      *IT_0133 + m_W*IT_0001*IT_0024*conj(U_sb_00)*U_st_01) + A_t*IT_0001*conj
      (U_sb_00)*U_st_11);
    ...
    const ccomplex_t IT_0141 = m_t*conj(U_sb_01)*(m_t*IT_0001*IT_0025*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0024*IT_0116*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0025*IT_0116*U_st_11));
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0024*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0027
      *IT_0141 + m_W*IT_0001*IT_0024*conj(U_sb_01)*U_st_01) + A_t*IT_0001*conj
      (U_sb_01)*U_st_11);
    ...
    const ccomplex_t IT_0185 = m_t*conj(N_u3)*e_em*IT_0027*U_st_11;
