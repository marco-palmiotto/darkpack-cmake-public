...
ccomplex_return_t c_sumSqAmpl_C_2_stau_1_to_nu_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = conj(U_d2)*conj(V_Wp1);
    const ccomplex_t IT_0002 = IT_0000*IT_0001;
    const ccomplex_t IT_0003 = sin(alpha);
    const ccomplex_t IT_0004 = conj(V_u1)*conj(U_Wm2);
    ...
    const ccomplex_t IT_0025 = cpow(s_23 + (-0.5)*IT_0024 + 0.5*m_C_1*(m_C_1 +
    ...
    const ccomplex_t IT_0043 = cpow(s_23 + (-0.5)*IT_0024 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0041*IT_0042*IT_0043;
    const ccomplex_t IT_0045 = U_d1*V_Wp2;
    const ccomplex_t IT_0046 = IT_0000*IT_0045;
    const ccomplex_t IT_0047 = V_u2*U_Wm1;
    ...
    const ccomplex_t IT_0056 = m_C_2*IT_0055;
    const ccomplex_t IT_0057 = U_d2*V_Wp2;
    const ccomplex_t IT_0058 = IT_0000*IT_0057;
    const ccomplex_t IT_0059 = V_u2*U_Wm2;
    ...
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0069 + (-0.5)*reg_prop +
       0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1), -1);
    const ccomplex_t IT_0071 = mu_h*m_tau*IT_0017;
    const ccomplex_t IT_0072 = sin(beta);
    const ccomplex_t IT_0073 = -IT_0003*IT_0072;
    const ccomplex_t IT_0074 = IT_0000*IT_0014;
    ...
    const ccomplex_t IT_0079 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0075*(IT_0007 + 
      -IT_0006*IT_0077) + IT_0000*IT_0007*IT_0015*IT_0017*IT_0078)*conj
      (U_stau_00) + -1./2*IT_0003*IT_0007*IT_0015*IT_0071*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0007*IT_0015*IT_0071*conj(U_stau_00) + 2*(m_W
      *IT_0006*IT_0075*IT_0077 + -IT_0000*IT_0007*IT_0015*IT_0017*IT_0078)*conj
      (U_stau_10));
    ...
    const ccomplex_t IT_0085 = cpow(s_13 + (-0.5)*IT_0069 + (-0.5)*reg_prop +
       0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2), -1);
    const ccomplex_t IT_0086 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0087 = IT_0007*IT_0086;
    const ccomplex_t IT_0088 = conj(U_d2)*e_em*m_tau*IT_0017*U_stau_11;
    ...
    const ccomplex_t IT_0092 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0075*(IT_0007 + 
      -IT_0006*IT_0077) + IT_0000*IT_0007*IT_0015*IT_0017*IT_0078)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0007*IT_0015*IT_0071*conj(U_stau_11)) +
       U_stau_10*(IT_0003*IT_0007*IT_0015*IT_0071*conj(U_stau_01) + 2*(m_W
      *IT_0006*IT_0075*IT_0077 + -IT_0000*IT_0007*IT_0015*IT_0017*IT_0078)*conj
      (U_stau_11));
    ...
    const ccomplex_t IT_0098 = (-0.5)*IT_0026 + (-0.5)*IT_0044 + (-0.5)
      *IT_0056 + (-0.5)*IT_0068 + 0.5*IT_0084 + 0.5*IT_0097;
    const ccomplex_t IT_0099 = 0.5*IT_0055 + 0.5*IT_0067;
