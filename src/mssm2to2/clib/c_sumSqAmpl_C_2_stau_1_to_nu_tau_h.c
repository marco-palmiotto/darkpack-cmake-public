        ...
        )
{
    ...
    const ccomplex_t IT_0015 = IT_0004*IT_0012;
    ...
    const ccomplex_t IT_0022 = 2*U_stau_00*(((-0.5)*m_W*IT_0018*(IT_0001 + 
      -IT_0000*IT_0020) + IT_0001*IT_0005*IT_0007*IT_0012*IT_0021)*conj
      (U_stau_01) + 1./2*IT_0001*IT_0005*IT_0013*IT_0014*conj(U_stau_11)) +
       U_stau_10*(IT_0001*IT_0005*IT_0013*IT_0014*conj(U_stau_01) + (-2)*(m_W
    ...
    const ccomplex_t IT_0030 = conj(V_u1)*conj(U_Wm2);
    const ccomplex_t IT_0031 = IT_0014*IT_0030;
    const ccomplex_t IT_0032 = conj(U_d2)*conj(V_Wp1);
    ...
    const ccomplex_t IT_0049 = conj(V_u2)*conj(U_Wm2);
    const ccomplex_t IT_0050 = IT_0014*IT_0049;
    const ccomplex_t IT_0051 = conj(U_d2)*conj(V_Wp2);
    ...
    const ccomplex_t IT_0057 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = conj(U_d2)*e_em*m_tau*IT_0007*U_stau_10;
    ...
    const ccomplex_t IT_0067 = V_u2*U_Wm1;
    const ccomplex_t IT_0068 = IT_0014*IT_0067;
    const ccomplex_t IT_0069 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0092 = 2*U_stau_00*(((-0.5)*m_W*IT_0018*(IT_0001 + 
      -IT_0000*IT_0020) + IT_0001*IT_0005*IT_0007*IT_0012*IT_0021)*conj
      (U_stau_00) + 1./2*IT_0001*IT_0005*IT_0013*IT_0014*conj(U_stau_10)) +
       U_stau_10*(IT_0001*IT_0005*IT_0013*IT_0014*conj(U_stau_00) + (-2)*(m_W
      *IT_0000*IT_0018*IT_0020 + -IT_0001*IT_0005*IT_0007*IT_0012*IT_0021)*conj
      (U_stau_10));
