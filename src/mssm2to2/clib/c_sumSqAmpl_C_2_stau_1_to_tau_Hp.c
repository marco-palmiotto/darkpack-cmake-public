...
ccomplex_return_t c_sumSqAmpl_C_2_stau_1_to_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = N_B1*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0051 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0052 = IT_0009*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = N_d3*e_em*m_tau*IT_0026*U_stau_00;
    ...
    const ccomplex_t IT_0079 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0080 = IT_0009*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_d4*e_em*m_tau*IT_0026*U_stau_00;
    ...
    const ccomplex_t IT_0101 = IT_0077*IT_0078*IT_0100;
    const ccomplex_t IT_0102 = cpow(s_23 + (-0.5)*IT_0033 + (-0.5)*IT_0034 +
       0.5*m_N_2*(m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0103 = N_u2*e_em*V_Wp2;
    const ccomplex_t IT_0104 = IT_0004*IT_0103;
    const ccomplex_t IT_0105 = 2*IT_0104;
    const ccomplex_t IT_0106 = N_B2*V_u2*e_em;
    const ccomplex_t IT_0107 = IT_0010*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = N_W2*V_u2*e_em;
    ...
    const ccomplex_t IT_0128 = IT_0102*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*IT_0128;
    const ccomplex_t IT_0130 = m_tau*IT_0129;
    const ccomplex_t IT_0131 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0132 = IT_0009*IT_0131;
    const ccomplex_t IT_0133 = 1.4142135623731*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0135 = IT_0003*IT_0134;
    const ccomplex_t IT_0136 = 1.4142135623731*IT_0135;
    const ccomplex_t IT_0137 = conj(N_d3)*e_em*m_tau*IT_0026*U_stau_10;
    ...
    const ccomplex_t IT_0152 = conj(N_d4)*e_em*m_tau*IT_0026*U_stau_10;
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0003*IT_0024*IT_0026*IT_0161;
    const ccomplex_t IT_0163 = 0.5*IT_0162;
    const ccomplex_t IT_0164 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0165 = IT_0003*IT_0164;
    const ccomplex_t IT_0166 = conj(U_d2)*e_em*m_tau*IT_0026*U_stau_10;
    ...
    const ccomplex_t IT_0171 = pow(m_C_2, 2);
    const ccomplex_t IT_0172 = cpow(s_12 + 0.5*IT_0034 + 0.5*IT_0171 + 0.5
      *reg_prop, -1);
    ...
    const ccomplex_t IT_0177 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0178 = IT_0009*IT_0177;
    const ccomplex_t IT_0179 = 1.4142135623731*IT_0178;
    const ccomplex_t IT_0180 = N_d2*e_em*m_tau*IT_0026*U_stau_00;
    ...
    const ccomplex_t IT_0186 = IT_0102*IT_0176*IT_0185;
    const ccomplex_t IT_0187 = 0.5*IT_0036 + 0.5*IT_0061 + (-0.5)*IT_0076 +
       0.5*IT_0101 + (-0.5)*IT_0130 + (-0.5)*IT_0145 + (-0.5)*IT_0160 + (-0.5)
      *IT_0175 + 0.5*IT_0186;
    const ccomplex_t IT_0188 = IT_0003*IT_0161;
    const ccomplex_t IT_0189 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0190 = IT_0188*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = IT_0009*IT_0161;
    const ccomplex_t IT_0193 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0194 = IT_0192*IT_0193;
    const ccomplex_t IT_0195 = 1.4142135623731*IT_0194;
    const ccomplex_t IT_0196 = IT_0191 + IT_0195;
    const ccomplex_t IT_0197 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0204 = IT_0000*IT_0035*IT_0203;
    const ccomplex_t IT_0205 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0206 = IT_0188*IT_0205;
    const ccomplex_t IT_0207 = (-2)*IT_0206;
    const ccomplex_t IT_0208 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0209 = IT_0192*IT_0208;
    const ccomplex_t IT_0210 = 1.4142135623731*IT_0209;
    const ccomplex_t IT_0211 = conj(N_W2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0212 = IT_0188*IT_0211;
    ...
    const ccomplex_t IT_0218 = IT_0126*IT_0217;
    const ccomplex_t IT_0219 = IT_0102*IT_0176*IT_0218;
    const ccomplex_t IT_0220 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0221 = IT_0188*IT_0220;
    const ccomplex_t IT_0222 = (-2)*IT_0221;
    const ccomplex_t IT_0223 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0224 = IT_0192*IT_0223;
    const ccomplex_t IT_0225 = 1.4142135623731*IT_0224;
    const ccomplex_t IT_0226 = conj(N_W3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0227 = IT_0188*IT_0226;
    ...
    const ccomplex_t IT_0233 = IT_0141*IT_0232;
    const ccomplex_t IT_0234 = IT_0037*IT_0060*IT_0233;
    const ccomplex_t IT_0235 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0236 = IT_0188*IT_0235;
    const ccomplex_t IT_0237 = (-2)*IT_0236;
    const ccomplex_t IT_0238 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0239 = IT_0192*IT_0238;
    const ccomplex_t IT_0240 = 1.4142135623731*IT_0239;
    const ccomplex_t IT_0241 = conj(N_W4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0242 = IT_0188*IT_0241;
    ...
    const ccomplex_t IT_0248 = IT_0156*IT_0247;
    const ccomplex_t IT_0249 = IT_0077*IT_0078*IT_0248;
    const ccomplex_t IT_0250 = IT_0184*IT_0217;
    const ccomplex_t IT_0251 = IT_0102*IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*IT_0251;
    const ccomplex_t IT_0253 = m_tau*IT_0252;
    const ccomplex_t IT_0254 = IT_0058*IT_0232;
    ...
    const ccomplex_t IT_0258 = IT_0031*IT_0202;
    const ccomplex_t IT_0259 = IT_0035*IT_0258;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1)*IT_0259;
    const ccomplex_t IT_0261 = m_tau*IT_0260;
    const ccomplex_t IT_0262 = IT_0086*IT_0247;
    ...
    const ccomplex_t IT_0266 = 0.5*IT_0204 + 0.5*IT_0219 + 0.5*IT_0234 + 0.5
      *IT_0249 + (-0.5)*IT_0253 + (-0.5)*IT_0257 + (-0.5)*IT_0261 + (-0.5)
      *IT_0265;
    const ccomplex_t IT_0267 = 2*s_13;
    const ccomplex_t IT_0268 = m_C_2*m_tau;
    const ccomplex_t IT_0269 = 2*IT_0187;
    const ccomplex_t IT_0270 = 0.5*IT_0075 + 0.5*IT_0129 + 0.5*IT_0144 + 0.5
      *IT_0159;
    const ccomplex_t IT_0271 = s_12*m_tau;
    const ccomplex_t IT_0272 = (-0.5)*IT_0174 + 0.5*IT_0252 + 0.5*IT_0256 +
       0.5*IT_0260 + 0.5*IT_0264;
    const ccomplex_t IT_0273 = s_23*m_C_2;
    const ccomplex_t IT_0274 = 2*conj(IT_0187);
    const ccomplex_t IT_0275 = 2*conj(IT_0266);
    const ccomplex_t IT_0276 = m_C_2*m_tau*IT_0034;
    const ccomplex_t IT_0277 = s_12*s_23;
    const ccomplex_t IT_0278 = s_13*IT_0034;
    const ccomplex_t IT_0279 = (-0.5)*IT_0278;
    const ccomplex_t IT_0280 = IT_0277 + IT_0279;
    const ccomplex_t IT_0281 = 2*IT_0266;
    const ccomplex_t IT_0282 = 0.5*IT_0273;
    const ccomplex_t IT_0283 = (IT_0187*conj(IT_0187) + IT_0266*conj(IT_0266))
      *IT_0267 + conj(IT_0266)*IT_0268*IT_0269 + (IT_0266*IT_0268 + IT_0270
      *IT_0271 + IT_0272*IT_0273)*IT_0274 + (IT_0271*IT_0272 + IT_0270*IT_0273)
      *IT_0275 + 2*conj(IT_0272)*(IT_0270*IT_0276 + 2*IT_0272*IT_0280 + 0.5
      *IT_0271*IT_0281 + IT_0269*IT_0282) + 2*conj(IT_0270)*(0.5*IT_0269*IT_0271
       + IT_0272*IT_0276 + 2*IT_0270*IT_0280 + IT_0281*IT_0282);
