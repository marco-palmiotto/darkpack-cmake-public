        ...
        )
{
    ...
    const ccomplex_t IT_0021 = N_B3*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0027 = N_d3*e_em*m_tau*IT_0026*U_stau_00;
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0003*IT_0024*IT_0026*IT_0037;
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0041 = IT_0003*IT_0040;
    const ccomplex_t IT_0042 = conj(U_d2)*e_em*m_tau*IT_0026*U_stau_10;
    ...
    const ccomplex_t IT_0048 = cpow(s_12 + 0.5*IT_0034 + 0.5*IT_0047 + 0.5
      *reg_prop, -1);
    ...
    const ccomplex_t IT_0053 = cpow(s_23 + (-0.5)*IT_0033 + (-0.5)*IT_0034 +
    ...
    const ccomplex_t IT_0067 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0068 = IT_0009*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = N_d2*e_em*m_tau*IT_0026*U_stau_00;
    ...
    const ccomplex_t IT_0076 = IT_0052*IT_0053*IT_0075;
    ...
    const ccomplex_t IT_0092 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0093 = IT_0009*IT_0092;
    const ccomplex_t IT_0094 = 1.4142135623731*IT_0093;
    const ccomplex_t IT_0095 = N_d4*e_em*m_tau*IT_0026*U_stau_00;
    ...
    const ccomplex_t IT_0152 = conj(N_d3)*e_em*m_tau*IT_0026*U_stau_10;
    ...
    const ccomplex_t IT_0187 = 0.5*IT_0036 + (-0.5)*IT_0051 + 0.5*IT_0076 +
       0.5*IT_0101 + (-0.5)*IT_0130 + (-0.5)*IT_0145 + (-0.5)*IT_0160 + (-0.5)
      *IT_0175 + 0.5*IT_0186;
    const ccomplex_t IT_0188 = IT_0003*IT_0037;
    ...
    const ccomplex_t IT_0192 = IT_0009*IT_0037;
    const ccomplex_t IT_0193 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0194 = IT_0192*IT_0193;
    const ccomplex_t IT_0195 = 1.4142135623731*IT_0194;
    const ccomplex_t IT_0196 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0204 = IT_0077*IT_0078*IT_0203;
    const ccomplex_t IT_0205 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0206 = IT_0188*IT_0205;
    const ccomplex_t IT_0207 = 1.4142135623731*IT_0206;
    const ccomplex_t IT_0208 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0212 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0234 = IT_0053*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = m_tau*IT_0235;
    const ccomplex_t IT_0237 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0238 = IT_0188*IT_0237;
    const ccomplex_t IT_0239 = (-2)*IT_0238;
    const ccomplex_t IT_0240 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0241 = IT_0192*IT_0240;
    const ccomplex_t IT_0242 = 1.4142135623731*IT_0241;
    const ccomplex_t IT_0243 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0250 = IT_0031*IT_0249;
    ...
    const ccomplex_t IT_0254 = IT_0099*IT_0202;
    const ccomplex_t IT_0255 = IT_0078*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = m_tau*IT_0256;
    const ccomplex_t IT_0258 = IT_0141*IT_0232;
    const ccomplex_t IT_0259 = IT_0052*IT_0053*IT_0258;
    const ccomplex_t IT_0260 = IT_0156*IT_0249;
    const ccomplex_t IT_0261 = IT_0000*IT_0035*IT_0260;
    const ccomplex_t IT_0262 = IT_0184*IT_0217;
    ...
    const ccomplex_t IT_0266 = 0.5*IT_0204 + 0.5*IT_0219 + (-0.5)*IT_0236 + (
      -0.5)*IT_0253 + (-0.5)*IT_0257 + 0.5*IT_0259 + 0.5*IT_0261 + (-0.5)*IT_0265;
    const ccomplex_t IT_0267 = 2*s_13;
    const ccomplex_t IT_0268 = m_C_2*m_tau;
    const ccomplex_t IT_0269 = 2*IT_0187;
    const ccomplex_t IT_0270 = 0.5*IT_0129 + 0.5*IT_0144 + 0.5*IT_0159 + 0.5
      *IT_0174;
    const ccomplex_t IT_0271 = s_12*m_tau;
    const ccomplex_t IT_0272 = (-0.5)*IT_0050 + 0.5*IT_0235 + 0.5*IT_0252 +
       0.5*IT_0256 + 0.5*IT_0264;
