...
ccomplex_return_t c_sumSqAmpl_C_2_stau_2_to_nu_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = e_em*mu_h*m_tau*IT_0007*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = e_em*mu_h*m_tau*IT_0007*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0015 = IT_0001*IT_0014;
    const ccomplex_t IT_0016 = sin(beta);
    const ccomplex_t IT_0017 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = 1.4142135623731*IT_0018;
    const ccomplex_t IT_0020 = A_tau*conj(U_stau_00)*U_stau_11;
    ...
    const ccomplex_t IT_0036 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0037 = IT_0001*IT_0036;
    const ccomplex_t IT_0038 = conj(U_d1)*e_em*m_tau*IT_0007*U_stau_11;
    ...
    const ccomplex_t IT_0054 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0055 = IT_0001*IT_0054;
    const ccomplex_t IT_0056 = conj(U_d2)*e_em*m_tau*IT_0007*U_stau_11;
    ...
    const ccomplex_t IT_0086 = e_em*mu_h*m_tau*IT_0007*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0087 = IT_0001*IT_0086;
    const ccomplex_t IT_0088 = e_em*mu_h*m_tau*IT_0007*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0089 = IT_0001*IT_0088;
    const ccomplex_t IT_0090 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0091 = IT_0016*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = A_tau*U_stau_01*conj(U_stau_11);
