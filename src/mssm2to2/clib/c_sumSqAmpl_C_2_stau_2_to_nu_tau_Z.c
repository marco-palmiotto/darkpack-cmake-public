...
ccomplex_return_t c_sumSqAmpl_C_2_stau_2_to_nu_tau_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = conj(U_d2)*e_em*m_tau*IT_0007*U_stau_10;
    ...
    const ccomplex_t IT_0047 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0048 = IT_0001*IT_0047;
    const ccomplex_t IT_0049 = conj(U_d1)*e_em*m_tau*IT_0007*U_stau_11;
