...
ccomplex_return_t c_sumSqAmpl_C_2_stau_2_to_nu_tau_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0047 = U_d1*V_Wp2;
    ...
    const ccomplex_t IT_0059 = U_d2*V_Wp2;
    ...
    const ccomplex_t IT_0072 = IT_0003*IT_0014;
    ...
    const ccomplex_t IT_0079 = 2*U_stau_01*(((-0.5)*m_W*IT_0075*(IT_0007 + 
      -IT_0006*IT_0077) + IT_0003*IT_0007*IT_0015*IT_0017*IT_0078)*conj
      (U_stau_01) + 1./2*IT_0000*IT_0007*IT_0015*IT_0071*conj(U_stau_11)) +
       U_stau_11*(IT_0000*IT_0007*IT_0015*IT_0071*conj(U_stau_01) + (-2)*(m_W
      *IT_0006*IT_0075*IT_0077 + -IT_0003*IT_0007*IT_0015*IT_0017*IT_0078)*conj
      (U_stau_11));
    ...
    const ccomplex_t IT_0092 = 2*conj(U_stau_00)*(((-0.5)*m_W*IT_0075*(IT_0007
       + -IT_0006*IT_0077) + IT_0003*IT_0007*IT_0015*IT_0017*IT_0078)*U_stau_01 
      + 1./2*IT_0000*IT_0007*IT_0015*IT_0071*U_stau_11) + conj(U_stau_10)*
      (IT_0000*IT_0007*IT_0015*IT_0071*U_stau_01 + (-2)*(m_W*IT_0006*IT_0075
      *IT_0077 + -IT_0003*IT_0007*IT_0015*IT_0017*IT_0078)*U_stau_11);
    ...
    const ccomplex_t IT_0101 = pow(m_h, 2);
