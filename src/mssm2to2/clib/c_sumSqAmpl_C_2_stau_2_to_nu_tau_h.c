        ...
        )
{
    ...
    const ccomplex_t IT_0022 = 2*conj(U_stau_00)*(((-0.5)*m_W*IT_0018*(IT_0001
       + -IT_0000*IT_0020) + IT_0001*IT_0005*IT_0007*IT_0012*IT_0021)*U_stau_01 
      + 1./2*IT_0001*IT_0005*IT_0013*IT_0014*U_stau_11) + conj(U_stau_10)*
      (IT_0001*IT_0005*IT_0013*IT_0014*U_stau_01 + (-2)*(m_W*IT_0000*IT_0018
      *IT_0020 + -IT_0001*IT_0005*IT_0007*IT_0012*IT_0021)*U_stau_11);
