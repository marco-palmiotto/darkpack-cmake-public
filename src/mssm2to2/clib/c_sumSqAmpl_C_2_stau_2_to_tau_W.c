...
ccomplex_return_t c_sumSqAmpl_C_2_stau_2_to_tau_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0021 = N_d3*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0037 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0038 = IT_0013*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = N_d4*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0059 = N_d1*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0067 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0068 = IT_0004*IT_0067;
    const ccomplex_t IT_0069 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0074 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0075 = IT_0013*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*IT_0075;
    const ccomplex_t IT_0077 = N_d2*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0083 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0149 = conj(N_d2)*e_em*m_tau*IT_0020*U_stau_11;
    ...
    const ccomplex_t IT_0155 = IT_0083*IT_0154;
    ...
    const ccomplex_t IT_0182 = IT_0011*IT_0174;
    const ccomplex_t IT_0183 = IT_0002*IT_0181*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0185 = IT_0036*IT_0111;
    const ccomplex_t IT_0186 = IT_0029*IT_0184*IT_0185;
    const ccomplex_t IT_0187 = m_C_2*IT_0177;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0189 = IT_0073*IT_0153;
    const ccomplex_t IT_0190 = IT_0083*IT_0188*IT_0189;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0192 = IT_0055*IT_0132;
    const ccomplex_t IT_0193 = IT_0048*IT_0191*IT_0192;
    const ccomplex_t IT_0194 = m_C_2*IT_0135;
    const ccomplex_t IT_0195 = m_C_2*IT_0156;
    const ccomplex_t IT_0196 = m_C_2*IT_0114;
    const ccomplex_t IT_0197 = 0.5*IT_0183 + 0.5*IT_0186 + (-0.5)*IT_0187 +
       0.5*IT_0190 + 0.5*IT_0193 + (-0.5)*IT_0194 + (-0.5)*IT_0195 + (-0.5)
      *IT_0196;
    ...
    const ccomplex_t IT_0204 = IT_0081*IT_0142;
    const ccomplex_t IT_0205 = IT_0083*IT_0188*IT_0204;
    const ccomplex_t IT_0206 = IT_0025*IT_0163;
    const ccomplex_t IT_0207 = IT_0002*IT_0181*IT_0206;
    const ccomplex_t IT_0208 = IT_0044*IT_0100;
    const ccomplex_t IT_0209 = IT_0029*IT_0184*IT_0208;
    const ccomplex_t IT_0210 = m_C_2*IT_0028;
    const ccomplex_t IT_0211 = m_C_2*IT_0047;
    const ccomplex_t IT_0212 = IT_0063*IT_0121;
    const ccomplex_t IT_0213 = IT_0048*IT_0191*IT_0212;
    const ccomplex_t IT_0214 = m_C_2*IT_0066;
    const ccomplex_t IT_0215 = m_C_2*IT_0085;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004;
    const ccomplex_t IT_0217 = 0.5*IT_0216;
    const ccomplex_t IT_0218 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0219 = IT_0004*IT_0218;
    const ccomplex_t IT_0220 = conj(U_d2)*e_em*m_tau*IT_0020*U_stau_11;
    ...
    const ccomplex_t IT_0225 = cpow(s_12 + 0.5*IT_0001 + 0.5*IT_0090 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0226 = IT_0224*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*IT_0226;
    const ccomplex_t IT_0228 = m_tau*IT_0227;
    const ccomplex_t IT_0229 = (-0.5)*IT_0205 + (-0.5)*IT_0207 + (-0.5)
      *IT_0209 + 0.5*IT_0210 + 0.5*IT_0211 + (-0.5)*IT_0213 + 0.5*IT_0214 + 0.5
      *IT_0215 + 0.5*IT_0228;
    const ccomplex_t IT_0230 = (-0.5)*IT_0114 + (-0.5)*IT_0135 + (-0.5)
      *IT_0156 + (-0.5)*IT_0177;
    const ccomplex_t IT_0231 = (-0.5)*IT_0227;
    const ccomplex_t IT_0232 = pow(m_W, 2);
    const ccomplex_t IT_0233 = IT_0179*IT_0232;
    const ccomplex_t IT_0234 = 3*IT_0233;
    const ccomplex_t IT_0235 = (-3)*IT_0233;
    const ccomplex_t IT_0236 = s_14*IT_0232;
    const ccomplex_t IT_0237 = IT_0087*IT_0236;
    ...
    const ccomplex_t IT_0242 = s_34*IT_0232;
    const ccomplex_t IT_0243 = IT_0087*IT_0242;
    const ccomplex_t IT_0244 = (-0.25)*IT_0243;
    const ccomplex_t IT_0245 = s_34 + IT_0244;
    const ccomplex_t IT_0246 = m_C_2*IT_0245;
    const ccomplex_t IT_0247 = (-4)*IT_0246;
    const ccomplex_t IT_0248 = s_13*IT_0232;
    const ccomplex_t IT_0249 = pow(m_W, 4);
    const ccomplex_t IT_0250 = s_13*IT_0249;
    const ccomplex_t IT_0251 = IT_0087*IT_0250;
    const ccomplex_t IT_0252 = (-0.5)*IT_0251;
    const ccomplex_t IT_0253 = s_14*s_34;
    const ccomplex_t IT_0254 = (-2)*IT_0253;
    const ccomplex_t IT_0255 = IT_0248 + IT_0252 + IT_0254;
    const ccomplex_t IT_0256 = s_13*s_34;
    const ccomplex_t IT_0257 = s_14*IT_0000;
    const ccomplex_t IT_0258 = -IT_0257;
    const ccomplex_t IT_0259 = IT_0256 + IT_0258;
    const ccomplex_t IT_0260 = -IT_0227;
    const ccomplex_t IT_0261 = (-2)*conj(IT_0260);
    const ccomplex_t IT_0262 = s_14*s_34*IT_0087;
    const ccomplex_t IT_0263 = -IT_0262;
    const ccomplex_t IT_0264 = s_13 + IT_0263;
    const ccomplex_t IT_0265 = IT_0179*IT_0264;
    const ccomplex_t IT_0266 = (-2)*conj(IT_0086);
    const ccomplex_t IT_0267 = m_tau*IT_0264;
    const ccomplex_t IT_0268 = m_C_2*IT_0264;
    const ccomplex_t IT_0269 = 0.5*IT_0243;
    const ccomplex_t IT_0270 = s_34 + IT_0269;
    const ccomplex_t IT_0271 = m_C_2*IT_0270;
    const ccomplex_t IT_0272 = 2*IT_0271;
    const ccomplex_t IT_0273 = (-0.25)*IT_0237;
    const ccomplex_t IT_0274 = s_14 + IT_0273;
    const ccomplex_t IT_0275 = m_tau*IT_0274;
    const ccomplex_t IT_0276 = (-4)*IT_0275;
    const ccomplex_t IT_0277 = (-0.25)*IT_0251;
    const ccomplex_t IT_0278 = IT_0253 + IT_0277;
    const ccomplex_t IT_0279 = (-2)*IT_0178;
    const ccomplex_t IT_0280 = s_13*IT_0264;
    const ccomplex_t IT_0281 = (-2)*conj(IT_0178);
    const ccomplex_t IT_0282 = pow(s_34, 2);
    const ccomplex_t IT_0283 = IT_0087*IT_0282;
    const ccomplex_t IT_0284 = -IT_0000;
    const ccomplex_t IT_0285 = IT_0283 + IT_0284;
    const ccomplex_t IT_0286 = m_C_2*IT_0285;
    const ccomplex_t IT_0287 = s_13*IT_0285;
    const ccomplex_t IT_0288 = -IT_0260;
    const ccomplex_t IT_0289 = IT_0248 + IT_0254;
    const ccomplex_t IT_0290 = IT_0087*IT_0289;
    const ccomplex_t IT_0291 = (-0.5)*IT_0290;
    const ccomplex_t IT_0292 = (-0.333333333333333)*IT_0199;
    const ccomplex_t IT_0293 = (-0.333333333333333)*IT_0231;
    const ccomplex_t IT_0294 = (-0.333333333333333)*IT_0230;
    const ccomplex_t IT_0295 = IT_0179*IT_0197 + (-0.333333333333333)*IT_0178
      *IT_0198 + 0.333333333333333*IT_0260*IT_0267 + 0.333333333333333*IT_0086
      *IT_0268 + (-0.666666666666667)*IT_0229*(s_13 + IT_0291) + IT_0247*IT_0292
       + IT_0276*IT_0293 + IT_0241*IT_0294;
    const ccomplex_t IT_0296 = (-0.333333333333333)*IT_0086*IT_0198 + IT_0179
      *IT_0229 + (-0.166666666666667)*IT_0268*IT_0279 + (-0.333333333333333)
      *IT_0260*IT_0286 + (-0.666666666666667)*IT_0197*(s_13 + IT_0291) + IT_0241
      *IT_0292 + IT_0272*IT_0293 + IT_0247*IT_0294;
    const ccomplex_t IT_0297 = 2*conj(IT_0086)*(IT_0086*IT_0093 + IT_0178
      *IT_0180 + IT_0197*IT_0198 + IT_0199*IT_0203) + 2*conj(IT_0178)*(IT_0093
      *IT_0178 + IT_0086*IT_0180 + IT_0198*IT_0229 + IT_0203*IT_0230) + 2*conj
      (IT_0199)*(IT_0086*IT_0203 + IT_0231*IT_0234 + IT_0230*IT_0235 + IT_0197
      *IT_0241 + IT_0229*IT_0247 + (-2)*IT_0199*IT_0255) + IT_0230*IT_0259
      *IT_0261 + IT_0260*IT_0265*IT_0266 + IT_0229*(IT_0261*IT_0267 + IT_0266
      *IT_0268) + 2*conj(IT_0231)*(IT_0199*IT_0234 + (-2)*IT_0231*IT_0255 +
       IT_0259*IT_0260 + IT_0197*IT_0272 + IT_0229*IT_0276 + (-4)*IT_0230
      *IT_0278 + 0.5*IT_0203*IT_0279) + (IT_0203*IT_0231 + IT_0197*IT_0268 +
       IT_0260*IT_0280)*IT_0281 + 2*conj(IT_0230)*(IT_0178*IT_0203 + IT_0199
      *IT_0235 + IT_0229*IT_0241 + IT_0197*IT_0247 + (-2)*IT_0230*IT_0255 + (-4)
      *IT_0231*IT_0278 + IT_0259*IT_0288) + 2*conj(IT_0260)*(IT_0231*IT_0259 + 
      -IT_0086*IT_0265 + 0.5*IT_0279*IT_0280 + IT_0197*IT_0286 + -IT_0287
      *IT_0288) + (-6)*conj(IT_0229)*IT_0295 + (-6)*conj(IT_0197)*IT_0296;
