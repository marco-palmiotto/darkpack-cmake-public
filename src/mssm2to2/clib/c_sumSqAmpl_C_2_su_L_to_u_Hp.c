        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0007 = (-0.5)*IT_0006;
    const ccomplex_t IT_0008 = cos(beta);
    const ccomplex_t IT_0009 = IT_0005*IT_0008;
    const ccomplex_t IT_0010 = N_u1*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0016 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = 1.4142135623731*IT_0017;
    const ccomplex_t IT_0019 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0027 = pow(m_u, 2);
    const ccomplex_t IT_0028 = pow(m_su_L, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_23 + IT_0027 + IT_0028 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0030 = IT_0000*IT_0026*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0027 + IT_0028 + -m_N_4*
    ...
    const ccomplex_t IT_0049 = IT_0031*IT_0032*IT_0048;
    const ccomplex_t IT_0050 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0051 = cpow(IT_0008, -1);
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005
      *IT_0050*(m_W*IT_0002*IT_0008*conj(U_sb_00) + (-0.5)*IT_0001*(IT_0003
      *IT_0008*IT_0027*conj(U_sb_00) + m_b*(m_b*IT_0002*IT_0051*conj(U_sb_00) +
       mu_h*conj(U_sb_10))))*V_ub_mod;
    const ccomplex_t IT_0053 = -IT_0052;
    const ccomplex_t IT_0054 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0001*IT_0003*IT_0005*IT_0054*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0056 = 0.5*IT_0055;
    const ccomplex_t IT_0057 = IT_0053*IT_0056;
    const ccomplex_t IT_0058 = pow(m_C_2, 2);
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0027 + IT_0058 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0057*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005
      *IT_0050*(m_W*IT_0002*IT_0008*conj(U_sb_01) + (-0.5)*IT_0001*(IT_0003
      *IT_0008*IT_0027*conj(U_sb_01) + m_b*(m_b*IT_0002*IT_0051*conj(U_sb_01) +
       mu_h*conj(U_sb_11))))*V_ub_mod;
    const ccomplex_t IT_0063 = -IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*e_em
      *IT_0001*IT_0003*IT_0005*IT_0054*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = IT_0063*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0027 + IT_0058 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = pow(m_d, 2);
    const ccomplex_t IT_0071 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0005*(IT_0008*(m_W*IT_0002 + (-0.5)*IT_0001*IT_0003*IT_0027) + -1./2
      *IT_0001*IT_0002*IT_0051*IT_0070);
    const ccomplex_t IT_0072 = 0.5*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0074 = 0.5*IT_0073;
    const ccomplex_t IT_0075 = IT_0072*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0027 + IT_0058 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = pow(m_s, 2);
    const ccomplex_t IT_0080 = (0 + _Complex_I*(-2.82842712474619))*V_us*e_em
      *IT_0005*(IT_0008*(m_W*IT_0002 + (-0.5)*IT_0001*IT_0003*IT_0027) + -1./2
      *IT_0001*IT_0002*IT_0051*IT_0079);
    const ccomplex_t IT_0081 = 0.5*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_us
      *e_em*IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0083 = 0.5*IT_0082;
    const ccomplex_t IT_0084 = IT_0081*IT_0083;
    const ccomplex_t IT_0085 = cpow((-2)*s_13 + IT_0027 + IT_0058 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0086 = IT_0084*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0027 + IT_0028 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0106 = IT_0088*IT_0089*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0108 = cpow((-2)*s_23 + IT_0027 + IT_0028 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = N_u3*e_em*V_Wp2;
    const ccomplex_t IT_0112 = IT_0009*IT_0111;
    const ccomplex_t IT_0113 = 2*IT_0112;
    const ccomplex_t IT_0114 = N_B3*V_u2*e_em;
    const ccomplex_t IT_0115 = IT_0015*IT_0114;
    const ccomplex_t IT_0116 = 1.4142135623731*IT_0115;
    const ccomplex_t IT_0117 = N_W3*V_u2*e_em;
    ...
    const ccomplex_t IT_0125 = IT_0107*IT_0108*IT_0124;
    const ccomplex_t IT_0126 = conj(N_B1)*e_em;
    const ccomplex_t IT_0127 = IT_0014*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0159 = IT_0032*IT_0158;
    ...
    const ccomplex_t IT_0170 = IT_0104*IT_0169;
    const ccomplex_t IT_0171 = IT_0089*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*IT_0171;
    const ccomplex_t IT_0173 = m_u*IT_0172;
    const ccomplex_t IT_0174 = -IT_0030 + -IT_0049 + IT_0061 + IT_0069 +
       IT_0078 + IT_0087 + -IT_0106 + -IT_0125 + IT_0137 + IT_0149 + IT_0161 +
       IT_0173;
    const ccomplex_t IT_0175 = IT_0002*IT_0005;
    const ccomplex_t IT_0176 = conj(N_d4)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0177 = IT_0175*IT_0176;
    const ccomplex_t IT_0178 = (-2)*IT_0177;
    const ccomplex_t IT_0179 = IT_0002*IT_0014;
    const ccomplex_t IT_0180 = conj(N_B4)*conj(U_d2)*e_em;
    const ccomplex_t IT_0181 = IT_0179*IT_0180;
    const ccomplex_t IT_0182 = 1.4142135623731*IT_0181;
    const ccomplex_t IT_0183 = conj(N_W4)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0190 = IT_0157*IT_0189;
    const ccomplex_t IT_0191 = IT_0031*IT_0032*IT_0190;
    const ccomplex_t IT_0192 = IT_0005*IT_0054;
    const ccomplex_t IT_0193 = e_em*conj(U_Wm2)*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0194 = IT_0192*IT_0193;
    const ccomplex_t IT_0195 = IT_0005*IT_0051*IT_0054;
    const ccomplex_t IT_0196 = m_b*conj(U_d2)*e_em*IT_0001*U_sb_10*V_ub_mod;
    const ccomplex_t IT_0197 = IT_0195*IT_0196;
    const ccomplex_t IT_0198 = 1.4142135623731*IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*(IT_0194 + (-0.5)*IT_0198);
    const ccomplex_t IT_0200 = IT_0053*IT_0199;
    const ccomplex_t IT_0201 = IT_0059*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*IT_0201;
    const ccomplex_t IT_0203 = e_em*conj(U_Wm2)*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0204 = IT_0192*IT_0203;
    const ccomplex_t IT_0205 = m_b*conj(U_d2)*e_em*IT_0001*U_sb_11*V_ub_mod;
    ...
    const ccomplex_t IT_0212 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0213 = IT_0175*IT_0212;
    const ccomplex_t IT_0214 = (-2)*IT_0213;
    const ccomplex_t IT_0215 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0216 = IT_0179*IT_0215;
    const ccomplex_t IT_0217 = 1.4142135623731*IT_0216;
    const ccomplex_t IT_0218 = conj(N_W3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0219 = IT_0175*IT_0218;
    ...
    const ccomplex_t IT_0240 = IT_0091*IT_0239;
    const ccomplex_t IT_0241 = IT_0089*IT_0240;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = m_u*IT_0242;
    const ccomplex_t IT_0244 = cpow((-2)*s_13 + IT_0027 + IT_0058 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0001*IT_0005;
    const ccomplex_t IT_0246 = 0.5*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0001*IT_0005*IT_0051;
    ...
    const ccomplex_t IT_0252 = cpow((-2)*s_13 + IT_0027 + IT_0058 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0253 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *mu_h*IT_0001*IT_0005;
    const ccomplex_t IT_0254 = 0.5*IT_0253;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_us*e_em*IT_0001*IT_0005*IT_0051;
    ...
    const ccomplex_t IT_0260 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0272 = IT_0175*IT_0271;
    ...
    const ccomplex_t IT_0278 = IT_0000*IT_0029*IT_0277;
    const ccomplex_t IT_0279 = IT_0169*IT_0239;
    const ccomplex_t IT_0280 = IT_0088*IT_0089*IT_0279;
    const ccomplex_t IT_0281 = IT_0007*IT_0276;
    const ccomplex_t IT_0282 = IT_0029*IT_0281;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1)*IT_0282;
    const ccomplex_t IT_0284 = m_u*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm2)*IT_0005;
    const ccomplex_t IT_0286 = IT_0081*IT_0285;
    const ccomplex_t IT_0287 = IT_0085*IT_0286;
    const ccomplex_t IT_0288 = (0 + _Complex_I*1)*IT_0287;
    const ccomplex_t IT_0289 = IT_0110*IT_0224;
    const ccomplex_t IT_0290 = IT_0108*IT_0289;
    const ccomplex_t IT_0291 = (0 + _Complex_I*1)*IT_0290;
    const ccomplex_t IT_0292 = m_u*IT_0291;
    const ccomplex_t IT_0293 = IT_0034*IT_0189;
    const ccomplex_t IT_0294 = IT_0032*IT_0293;
    const ccomplex_t IT_0295 = (0 + _Complex_I*1)*IT_0294;
    const ccomplex_t IT_0296 = m_u*IT_0295;
    const ccomplex_t IT_0297 = -IT_0191 + -IT_0202 + -IT_0211 + -IT_0226 +
       IT_0243 + -IT_0251 + -IT_0259 + -IT_0263 + -IT_0278 + -IT_0280 + IT_0284 
      + -IT_0288 + IT_0292 + IT_0296;
    const ccomplex_t IT_0298 = 6*s_13;
    const ccomplex_t IT_0299 = m_u*m_C_2;
    const ccomplex_t IT_0300 = 6*IT_0174;
    const ccomplex_t IT_0301 = -IT_0136 + -IT_0148 + -IT_0160 + -IT_0172;
    const ccomplex_t IT_0302 = m_u*s_12;
    const ccomplex_t IT_0303 = -IT_0242 + -IT_0283 + -IT_0291 + -IT_0295;
    const ccomplex_t IT_0304 = s_23*m_C_2;
    const ccomplex_t IT_0305 = 6*conj(IT_0174);
    const ccomplex_t IT_0306 = 6*conj(IT_0297);
    const ccomplex_t IT_0307 = m_u*m_C_2*IT_0028;
    const ccomplex_t IT_0308 = s_13*IT_0028;
    const ccomplex_t IT_0309 = (-6)*IT_0308;
    const ccomplex_t IT_0310 = s_12*s_23;
    const ccomplex_t IT_0311 = 12*IT_0310;
    const ccomplex_t IT_0312 = IT_0309 + IT_0311;
    const ccomplex_t IT_0313 = 6*IT_0297;
    const ccomplex_t IT_0314 = 0.166666666666667*IT_0302;
    const ccomplex_t IT_0315 = 0.166666666666667*IT_0304;
    const ccomplex_t IT_0316 = (IT_0174*conj(IT_0174) + IT_0297*conj(IT_0297))
      *IT_0298 + conj(IT_0297)*IT_0299*IT_0300 + (IT_0297*IT_0299 + IT_0301
      *IT_0302 + IT_0303*IT_0304)*IT_0305 + (IT_0302*IT_0303 + IT_0301*IT_0304)
      *IT_0306 + 6*conj(IT_0303)*(IT_0301*IT_0307 + 0.166666666666667*IT_0303
      *IT_0312 + IT_0313*IT_0314 + IT_0300*IT_0315) + 6*conj(IT_0301)*(IT_0303
      *IT_0307 + 0.166666666666667*IT_0301*IT_0312 + IT_0300*IT_0314 + IT_0313
      *IT_0315);
