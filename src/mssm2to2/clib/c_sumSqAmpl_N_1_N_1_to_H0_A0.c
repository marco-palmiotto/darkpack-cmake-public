        ...
        )
{
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0000 + IT_0031 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0066 = IT_0004*IT_0065;
    const ccomplex_t IT_0067 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0068 = IT_0008*IT_0067;
    const ccomplex_t IT_0069 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0070 = IT_0013*IT_0069;
    const ccomplex_t IT_0071 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0072 = IT_0016*IT_0071;
    const ccomplex_t IT_0073 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0074 = IT_0004*IT_0073;
    const ccomplex_t IT_0075 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0076 = IT_0008*IT_0075;
    const ccomplex_t IT_0077 = conj(N_W3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0105 = IT_0039*IT_0067;
    const ccomplex_t IT_0106 = IT_0045*IT_0069;
    const ccomplex_t IT_0107 = IT_0039*IT_0075;
    const ccomplex_t IT_0108 = IT_0045*IT_0077;
    const ccomplex_t IT_0109 = IT_0105 + IT_0106 + IT_0107 + IT_0108;
    const ccomplex_t IT_0110 = IT_0041*IT_0065;
    const ccomplex_t IT_0111 = IT_0043*IT_0071;
    const ccomplex_t IT_0112 = IT_0041*IT_0073;
    const ccomplex_t IT_0113 = IT_0043*IT_0079;
    ...
    const ccomplex_t IT_0122 = cpow((-2)*s_23 + IT_0000 + IT_0031 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*IT_0122;
    const ccomplex_t IT_0124 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0125 = IT_0004*IT_0124;
    const ccomplex_t IT_0126 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0127 = IT_0008*IT_0126;
    const ccomplex_t IT_0128 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0129 = IT_0013*IT_0128;
    const ccomplex_t IT_0130 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0131 = IT_0016*IT_0130;
    const ccomplex_t IT_0132 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0133 = IT_0004*IT_0132;
    const ccomplex_t IT_0134 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0135 = IT_0008*IT_0134;
    const ccomplex_t IT_0136 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0142 = IT_0039*IT_0141;
    const ccomplex_t IT_0143 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0144 = IT_0045*IT_0143;
    const ccomplex_t IT_0145 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0146 = IT_0039*IT_0145;
    const ccomplex_t IT_0147 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0148 = IT_0045*IT_0147;
    const ccomplex_t IT_0149 = IT_0142 + IT_0144 + IT_0146 + IT_0148;
    const ccomplex_t IT_0150 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0151 = IT_0041*IT_0150;
    const ccomplex_t IT_0152 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0153 = IT_0043*IT_0152;
    const ccomplex_t IT_0154 = N_B1*N_u4*e_em;
    ...
    const ccomplex_t IT_0164 = IT_0039*IT_0126;
    const ccomplex_t IT_0165 = IT_0045*IT_0128;
    const ccomplex_t IT_0166 = IT_0039*IT_0134;
    const ccomplex_t IT_0167 = IT_0045*IT_0136;
    const ccomplex_t IT_0168 = IT_0164 + IT_0165 + IT_0166 + IT_0167;
    const ccomplex_t IT_0169 = IT_0041*IT_0124;
    const ccomplex_t IT_0170 = IT_0043*IT_0130;
    const ccomplex_t IT_0171 = IT_0041*IT_0132;
    const ccomplex_t IT_0172 = IT_0043*IT_0138;
    ...
    const ccomplex_t IT_0188 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0189 = IT_0008*IT_0188;
    const ccomplex_t IT_0190 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0191 = IT_0013*IT_0190;
    const ccomplex_t IT_0192 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0193 = IT_0016*IT_0192;
    const ccomplex_t IT_0194 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0203 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0204 = IT_0039*IT_0203;
    const ccomplex_t IT_0205 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0206 = IT_0045*IT_0205;
    const ccomplex_t IT_0207 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0208 = IT_0039*IT_0207;
    const ccomplex_t IT_0209 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0210 = IT_0045*IT_0209;
    const ccomplex_t IT_0211 = IT_0204 + IT_0206 + IT_0208 + IT_0210;
    const ccomplex_t IT_0212 = N_B2*N_u1*e_em;
    ...
    const ccomplex_t IT_0218 = N_W1*N_d2*e_em;
    const ccomplex_t IT_0219 = IT_0043*IT_0218;
    ...
    const ccomplex_t IT_0224 = IT_0202*IT_0223;
    const ccomplex_t IT_0225 = m_N_1*IT_0224;
    const ccomplex_t IT_0226 = IT_0039*IT_0188;
    const ccomplex_t IT_0227 = IT_0045*IT_0190;
    const ccomplex_t IT_0228 = IT_0039*IT_0196;
    const ccomplex_t IT_0229 = IT_0045*IT_0198;
    const ccomplex_t IT_0230 = IT_0226 + IT_0227 + IT_0228 + IT_0229;
    const ccomplex_t IT_0231 = IT_0041*IT_0186;
    const ccomplex_t IT_0232 = IT_0043*IT_0192;
    const ccomplex_t IT_0233 = IT_0041*IT_0194;
    const ccomplex_t IT_0234 = IT_0043*IT_0200;
    const ccomplex_t IT_0235 = -IT_0231 + -IT_0232 + -IT_0233 + -IT_0234;
    ...
    const ccomplex_t IT_0239 = IT_0202*IT_0238;
    const ccomplex_t IT_0240 = m_N_2*IT_0239;
    const ccomplex_t IT_0241 = IT_0225 + IT_0240;
    const ccomplex_t IT_0242 = IT_0185*IT_0241;
    const ccomplex_t IT_0243 = cpow((-2)*s_13 + IT_0000 + IT_0031 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*IT_0243;
    const ccomplex_t IT_0245 = IT_0241*IT_0244;
    const ccomplex_t IT_0246 = cpow((-2)*s_23 + IT_0000 + IT_0031 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    ...
    const ccomplex_t IT_0249 = 0.5*IT_0030 + (-0.5)*IT_0062 + -IT_0121 + 
      -IT_0180 + -IT_0183 + -IT_0242 + -IT_0245 + -IT_0248;
    ...
    const ccomplex_t IT_0272 = IT_0004*IT_0052;
    const ccomplex_t IT_0273 = IT_0008*IT_0050;
    const ccomplex_t IT_0274 = IT_0013*IT_0056;
    const ccomplex_t IT_0275 = IT_0016*IT_0054;
    ...
    const ccomplex_t IT_0286 = cpow((-2)*s_23 + IT_0031 + (0 + _Complex_I*1)
      *m_N_1*Gamma_o1 + reg_prop, -1);
    const ccomplex_t IT_0287 = (0 + _Complex_I*1)*IT_0286;
    const ccomplex_t IT_0288 = IT_0058*IT_0276;
    const ccomplex_t IT_0289 = m_N_1*IT_0288;
    const ccomplex_t IT_0290 = IT_0047*IT_0276;
    const ccomplex_t IT_0291 = m_N_1*IT_0290;
    const ccomplex_t IT_0292 = IT_0289 + IT_0291;
    const ccomplex_t IT_0293 = IT_0287*IT_0292;
    const ccomplex_t IT_0294 = IT_0004*IT_0050;
    const ccomplex_t IT_0295 = IT_0008*IT_0052;
    const ccomplex_t IT_0296 = IT_0013*IT_0054;
    const ccomplex_t IT_0297 = IT_0016*IT_0056;
    const ccomplex_t IT_0298 = -IT_0294 + -IT_0295 + IT_0296 + IT_0297;
    const ccomplex_t IT_0299 = IT_0029*IT_0298;
    const ccomplex_t IT_0300 = IT_0033*IT_0292;
    const ccomplex_t IT_0301 = -IT_0271 + -IT_0285 + IT_0293 + (-0.5)*IT_0299 
      + 0.5*IT_0300;
    const ccomplex_t IT_0302 = 2*IT_0301;
    const ccomplex_t IT_0303 = IT_0004*IT_0150;
    const ccomplex_t IT_0304 = IT_0008*IT_0141;
    const ccomplex_t IT_0305 = IT_0013*IT_0143;
    const ccomplex_t IT_0306 = IT_0016*IT_0152;
    const ccomplex_t IT_0307 = IT_0004*IT_0154;
    const ccomplex_t IT_0308 = IT_0008*IT_0145;
    const ccomplex_t IT_0309 = IT_0013*IT_0147;
    const ccomplex_t IT_0310 = IT_0016*IT_0156;
    const ccomplex_t IT_0311 = (-0.5)*IT_0303 + 0.5*IT_0304 + 0.5*IT_0305 + (
      -0.5)*IT_0306 + (-0.5)*IT_0307 + 0.5*IT_0308 + 0.5*IT_0309 + (-0.5)*IT_0310;
    const ccomplex_t IT_0312 = IT_0161*IT_0311;
    const ccomplex_t IT_0313 = m_N_4*IT_0312;
    const ccomplex_t IT_0314 = IT_0176*IT_0311;
    const ccomplex_t IT_0315 = m_N_1*IT_0314;
    const ccomplex_t IT_0316 = IT_0313 + IT_0315;
    const ccomplex_t IT_0317 = IT_0123*IT_0316;
    const ccomplex_t IT_0318 = IT_0182*IT_0316;
    const ccomplex_t IT_0319 = IT_0004*IT_0212;
    const ccomplex_t IT_0320 = IT_0008*IT_0203;
    const ccomplex_t IT_0321 = IT_0013*IT_0205;
    const ccomplex_t IT_0322 = IT_0016*IT_0214;
    const ccomplex_t IT_0323 = IT_0004*IT_0216;
    const ccomplex_t IT_0324 = IT_0008*IT_0207;
    const ccomplex_t IT_0325 = IT_0013*IT_0209;
    const ccomplex_t IT_0326 = IT_0016*IT_0218;
    const ccomplex_t IT_0327 = (-0.5)*IT_0319 + 0.5*IT_0320 + 0.5*IT_0321 + (
      -0.5)*IT_0322 + (-0.5)*IT_0323 + 0.5*IT_0324 + 0.5*IT_0325 + (-0.5)*IT_0326;
    const ccomplex_t IT_0328 = IT_0223*IT_0327;
    const ccomplex_t IT_0329 = m_N_2*IT_0328;
    const ccomplex_t IT_0330 = IT_0238*IT_0327;
    const ccomplex_t IT_0331 = m_N_1*IT_0330;
    const ccomplex_t IT_0332 = IT_0329 + IT_0331;
    const ccomplex_t IT_0333 = IT_0244*IT_0332;
    const ccomplex_t IT_0334 = IT_0185*IT_0332;
    const ccomplex_t IT_0335 = IT_0004*IT_0091;
    const ccomplex_t IT_0336 = IT_0008*IT_0082;
    const ccomplex_t IT_0337 = IT_0013*IT_0084;
    const ccomplex_t IT_0338 = IT_0016*IT_0093;
    const ccomplex_t IT_0339 = IT_0004*IT_0095;
    const ccomplex_t IT_0340 = IT_0008*IT_0086;
    const ccomplex_t IT_0341 = IT_0013*IT_0088;
    const ccomplex_t IT_0342 = IT_0016*IT_0097;
    const ccomplex_t IT_0343 = (-0.5)*IT_0335 + 0.5*IT_0336 + 0.5*IT_0337 + (
      -0.5)*IT_0338 + (-0.5)*IT_0339 + 0.5*IT_0340 + 0.5*IT_0341 + (-0.5)*IT_0342;
    const ccomplex_t IT_0344 = IT_0102*IT_0343;
    const ccomplex_t IT_0345 = m_N_3*IT_0344;
    const ccomplex_t IT_0346 = IT_0117*IT_0343;
    const ccomplex_t IT_0347 = m_N_1*IT_0346;
    const ccomplex_t IT_0348 = IT_0345 + IT_0347;
    const ccomplex_t IT_0349 = IT_0247*IT_0348;
    const ccomplex_t IT_0350 = IT_0064*IT_0348;
    const ccomplex_t IT_0351 = 0.5*IT_0299 + (-0.5)*IT_0300 + -IT_0317 + 
    ...
    const ccomplex_t IT_0358 = IT_0061*IT_0287;
    ...
    const ccomplex_t IT_0369 = IT_0252*IT_0263;
    const ccomplex_t IT_0370 = IT_0251*IT_0369;
    const ccomplex_t IT_0371 = IT_0059*IT_0287;
    const ccomplex_t IT_0372 = IT_0033*IT_0290;
    const ccomplex_t IT_0373 = -IT_0370 + -IT_0371 + 0.5*IT_0372;
    const ccomplex_t IT_0374 = IT_0123*IT_0162;
    const ccomplex_t IT_0375 = IT_0244*IT_0330;
    const ccomplex_t IT_0376 = IT_0182*IT_0314;
    const ccomplex_t IT_0377 = IT_0185*IT_0224;
    const ccomplex_t IT_0378 = IT_0103*IT_0247;
    const ccomplex_t IT_0379 = IT_0064*IT_0346;
    ...
    const ccomplex_t IT_0383 = IT_0252*IT_0266;
    const ccomplex_t IT_0384 = IT_0251*IT_0383;
    const ccomplex_t IT_0385 = IT_0287*IT_0290;
    const ccomplex_t IT_0386 = IT_0033*IT_0059;
    const ccomplex_t IT_0387 = -IT_0384 + -IT_0385 + 0.5*IT_0386;
    const ccomplex_t IT_0388 = IT_0185*IT_0330;
    const ccomplex_t IT_0389 = IT_0224*IT_0244;
    const ccomplex_t IT_0390 = IT_0247*IT_0346;
    const ccomplex_t IT_0391 = IT_0064*IT_0103;
    const ccomplex_t IT_0392 = IT_0123*IT_0314;
    const ccomplex_t IT_0393 = IT_0162*IT_0182;
