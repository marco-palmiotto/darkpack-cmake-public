        ...
        )
{
    ...
    const ccomplex_t IT_0036 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0037 = IT_0024*IT_0036;
    const ccomplex_t IT_0038 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0039 = IT_0027*IT_0038;
    const ccomplex_t IT_0040 = N_W1*N_d1*e_em;
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0052 = IT_0007*IT_0051;
    const ccomplex_t IT_0053 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0059 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0060 = IT_0007*IT_0059;
    const ccomplex_t IT_0061 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0062 = IT_0011*IT_0061;
    const ccomplex_t IT_0063 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0064 = IT_0016*IT_0063;
    const ccomplex_t IT_0065 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0091 = IT_0024*IT_0053;
    const ccomplex_t IT_0092 = IT_0031*IT_0055;
    const ccomplex_t IT_0093 = IT_0024*IT_0061;
    const ccomplex_t IT_0094 = IT_0031*IT_0063;
    const ccomplex_t IT_0095 = IT_0091 + IT_0092 + IT_0093 + IT_0094;
    const ccomplex_t IT_0096 = IT_0027*IT_0051;
    const ccomplex_t IT_0097 = IT_0029*IT_0057;
    const ccomplex_t IT_0098 = IT_0027*IT_0059;
    const ccomplex_t IT_0099 = IT_0029*IT_0065;
    ...
    const ccomplex_t IT_0107 = IT_0050*IT_0106;
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*IT_0108;
    const ccomplex_t IT_0110 = IT_0106*IT_0109;
    const ccomplex_t IT_0111 = IT_0007*IT_0012;
    const ccomplex_t IT_0112 = IT_0008*IT_0011;
    const ccomplex_t IT_0113 = IT_0016*IT_0020;
    const ccomplex_t IT_0114 = IT_0017*IT_0019;
    const ccomplex_t IT_0115 = IT_0111 + IT_0112 + -IT_0113 + -IT_0114;
    const ccomplex_t IT_0116 = cpow(IT_0005, -2);
    const ccomplex_t IT_0117 = IT_0014*IT_0116;
    const ccomplex_t IT_0118 = IT_0015 + IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*m_W*e_em*IT_0004*IT_0010*
      (IT_0004*IT_0023 + -IT_0010*IT_0026)*IT_0118;
    const ccomplex_t IT_0120 = pow(m_Z, 2);
    const ccomplex_t IT_0121 = cpow((-2)*s_12 + (-2)*IT_0000 + IT_0120 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0125 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*IT_0125;
    const ccomplex_t IT_0127 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0128 = IT_0007*IT_0127;
    const ccomplex_t IT_0129 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0130 = IT_0011*IT_0129;
    const ccomplex_t IT_0131 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0132 = IT_0016*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0134 = IT_0019*IT_0133;
    const ccomplex_t IT_0135 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0136 = IT_0007*IT_0135;
    const ccomplex_t IT_0137 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0138 = IT_0011*IT_0137;
    const ccomplex_t IT_0139 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0140 = IT_0016*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0144 = IT_0024*IT_0129;
    const ccomplex_t IT_0145 = IT_0031*IT_0131;
    const ccomplex_t IT_0146 = IT_0024*IT_0137;
    const ccomplex_t IT_0147 = IT_0031*IT_0139;
    const ccomplex_t IT_0148 = IT_0144 + IT_0145 + IT_0146 + IT_0147;
    const ccomplex_t IT_0149 = IT_0027*IT_0127;
    const ccomplex_t IT_0150 = IT_0029*IT_0133;
    const ccomplex_t IT_0151 = IT_0027*IT_0135;
    const ccomplex_t IT_0152 = IT_0029*IT_0141;
    ...
    const ccomplex_t IT_0168 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0169 = IT_0027*IT_0168;
    const ccomplex_t IT_0170 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0171 = IT_0029*IT_0170;
    const ccomplex_t IT_0172 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0173 = IT_0027*IT_0172;
    const ccomplex_t IT_0174 = N_W1*N_d2*e_em;
    const ccomplex_t IT_0175 = IT_0029*IT_0174;
    ...
    const ccomplex_t IT_0184 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*IT_0184;
    const ccomplex_t IT_0186 = IT_0182*IT_0185;
    const ccomplex_t IT_0187 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
    ...
    const ccomplex_t IT_0218 = IT_0029*IT_0217;
    ...
    const ccomplex_t IT_0229 = IT_0024*IT_0191;
    const ccomplex_t IT_0230 = IT_0031*IT_0193;
    const ccomplex_t IT_0231 = IT_0024*IT_0199;
    const ccomplex_t IT_0232 = IT_0031*IT_0201;
    const ccomplex_t IT_0233 = IT_0229 + IT_0230 + IT_0231 + IT_0232;
    const ccomplex_t IT_0234 = IT_0027*IT_0189;
    const ccomplex_t IT_0235 = IT_0029*IT_0195;
    const ccomplex_t IT_0236 = IT_0027*IT_0197;
    const ccomplex_t IT_0237 = IT_0029*IT_0203;
    ...
    const ccomplex_t IT_0246 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = IT_0244*IT_0247;
    const ccomplex_t IT_0249 = (-0.5)*IT_0048 + -IT_0107 + -IT_0110 + 0.5
      *IT_0124 + -IT_0183 + -IT_0186 + -IT_0245 + -IT_0248;
    const ccomplex_t IT_0250 = IT_0007*IT_0038;
    const ccomplex_t IT_0251 = IT_0011*IT_0036;
    const ccomplex_t IT_0252 = IT_0016*IT_0042;
    const ccomplex_t IT_0253 = IT_0019*IT_0040;
    ...
    const ccomplex_t IT_0257 = IT_0033*IT_0254;
    const ccomplex_t IT_0258 = m_N_1*IT_0257;
    const ccomplex_t IT_0259 = IT_0256 + IT_0258;
    const ccomplex_t IT_0260 = IT_0003*IT_0259;
    const ccomplex_t IT_0261 = IT_0007*IT_0036;
    const ccomplex_t IT_0262 = IT_0011*IT_0038;
    const ccomplex_t IT_0263 = IT_0016*IT_0040;
    const ccomplex_t IT_0264 = IT_0019*IT_0042;
    const ccomplex_t IT_0265 = -IT_0261 + -IT_0262 + IT_0263 + IT_0264;
    const ccomplex_t IT_0266 = IT_0123*IT_0265;
    const ccomplex_t IT_0267 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
      *Gamma_Z) + (-2)*IT_0000 + -reg_prop, -1);
    const ccomplex_t IT_0268 = (0 + _Complex_I*1)*IT_0267;
    const ccomplex_t IT_0269 = e_em*IT_0006*IT_0015*(IT_0010*IT_0023 + 
      -IT_0004*IT_0026);
    const ccomplex_t IT_0270 = 0.5*IT_0269;
    const ccomplex_t IT_0271 = IT_0006*IT_0014;
    const ccomplex_t IT_0272 = N_u1*conj(N_u1)*e_em;
    const ccomplex_t IT_0273 = IT_0271*IT_0272;
    const ccomplex_t IT_0274 = IT_0005*IT_0015;
    const ccomplex_t IT_0275 = IT_0272*IT_0274;
    const ccomplex_t IT_0276 = N_d1*conj(N_d1)*e_em;
    const ccomplex_t IT_0277 = IT_0271*IT_0276;
    const ccomplex_t IT_0278 = IT_0274*IT_0276;
    const ccomplex_t IT_0279 = (0 + _Complex_I*1)*(IT_0273 + IT_0275 + 
      -IT_0277 + -IT_0278);
    const ccomplex_t IT_0280 = (-0.5)*IT_0279;
    const ccomplex_t IT_0281 = IT_0270*IT_0280;
    const ccomplex_t IT_0282 = m_N_1*IT_0281;
    const ccomplex_t IT_0283 = 0.5*IT_0279;
    const ccomplex_t IT_0284 = IT_0270*IT_0283;
    const ccomplex_t IT_0285 = m_N_1*IT_0284;
    const ccomplex_t IT_0286 = -IT_0285;
    const ccomplex_t IT_0287 = IT_0282 + IT_0286;
    const ccomplex_t IT_0288 = IT_0268*IT_0287;
    const ccomplex_t IT_0289 = cpow(IT_0010, 3);
    const ccomplex_t IT_0290 = -IT_0004;
    const ccomplex_t IT_0291 = cpow(IT_0010, 2);
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*m_W*e_em*IT_0118*(IT_0026
      *IT_0289 + IT_0290*((IT_0004*IT_0023 + -IT_0010*IT_0026)*IT_0290 + IT_0023
      *IT_0291));
    const ccomplex_t IT_0293 = 0.5*IT_0292;
    const ccomplex_t IT_0294 = cpow((-2)*s_12 + (-2)*IT_0000 + m_A0*(m_A0 + (0
       + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0295 = IT_0293*IT_0294;
    const ccomplex_t IT_0296 = (0 + _Complex_I*1)*IT_0295;
    const ccomplex_t IT_0297 = IT_0254*IT_0296;
    const ccomplex_t IT_0298 = cpow((-2)*s_23 + IT_0001 + (0 + _Complex_I*1)
      *m_N_1*Gamma_o1 + reg_prop, -1);
    const ccomplex_t IT_0299 = (0 + _Complex_I*1)*IT_0298;
    const ccomplex_t IT_0300 = IT_0259*IT_0299;
    const ccomplex_t IT_0301 = 0.5*IT_0260 + (-0.5)*IT_0266 + -IT_0288 + 
      -IT_0297 + IT_0300;
    const ccomplex_t IT_0302 = 2*IT_0301;
    const ccomplex_t IT_0303 = IT_0007*IT_0168;
    const ccomplex_t IT_0304 = IT_0011*IT_0159;
    const ccomplex_t IT_0305 = IT_0016*IT_0161;
    const ccomplex_t IT_0306 = IT_0019*IT_0170;
    const ccomplex_t IT_0307 = IT_0007*IT_0172;
    const ccomplex_t IT_0308 = IT_0011*IT_0163;
    const ccomplex_t IT_0309 = IT_0016*IT_0165;
    const ccomplex_t IT_0310 = IT_0019*IT_0174;
    const ccomplex_t IT_0311 = (-0.5)*IT_0303 + 0.5*IT_0304 + 0.5*IT_0305 + (
      -0.5)*IT_0306 + (-0.5)*IT_0307 + 0.5*IT_0308 + 0.5*IT_0309 + (-0.5)*IT_0310;
    const ccomplex_t IT_0312 = IT_0179*IT_0311;
    const ccomplex_t IT_0313 = m_N_2*IT_0312;
    const ccomplex_t IT_0314 = IT_0156*IT_0311;
    const ccomplex_t IT_0315 = m_N_1*IT_0314;
    const ccomplex_t IT_0316 = IT_0313 + IT_0315;
    const ccomplex_t IT_0317 = IT_0126*IT_0316;
    const ccomplex_t IT_0318 = IT_0185*IT_0316;
    const ccomplex_t IT_0319 = IT_0007*IT_0077;
    const ccomplex_t IT_0320 = IT_0011*IT_0068;
    const ccomplex_t IT_0321 = IT_0016*IT_0070;
    const ccomplex_t IT_0322 = IT_0019*IT_0079;
    const ccomplex_t IT_0323 = IT_0007*IT_0081;
    const ccomplex_t IT_0324 = IT_0011*IT_0072;
    const ccomplex_t IT_0325 = IT_0016*IT_0074;
    const ccomplex_t IT_0326 = IT_0019*IT_0083;
    const ccomplex_t IT_0327 = (-0.5)*IT_0319 + 0.5*IT_0320 + 0.5*IT_0321 + (
      -0.5)*IT_0322 + (-0.5)*IT_0323 + 0.5*IT_0324 + 0.5*IT_0325 + (-0.5)*IT_0326;
    const ccomplex_t IT_0328 = IT_0088*IT_0327;
    const ccomplex_t IT_0329 = m_N_3*IT_0328;
    const ccomplex_t IT_0330 = IT_0103*IT_0327;
    const ccomplex_t IT_0331 = m_N_1*IT_0330;
    const ccomplex_t IT_0332 = IT_0329 + IT_0331;
    const ccomplex_t IT_0333 = IT_0050*IT_0332;
    const ccomplex_t IT_0334 = IT_0109*IT_0332;
    const ccomplex_t IT_0335 = IT_0007*IT_0215;
    const ccomplex_t IT_0336 = IT_0011*IT_0206;
    const ccomplex_t IT_0337 = IT_0016*IT_0208;
    const ccomplex_t IT_0338 = IT_0019*IT_0217;
    const ccomplex_t IT_0339 = IT_0007*IT_0219;
    const ccomplex_t IT_0340 = IT_0011*IT_0210;
    const ccomplex_t IT_0341 = IT_0016*IT_0212;
    const ccomplex_t IT_0342 = IT_0019*IT_0221;
    const ccomplex_t IT_0343 = (-0.5)*IT_0335 + 0.5*IT_0336 + 0.5*IT_0337 + (
      -0.5)*IT_0338 + (-0.5)*IT_0339 + 0.5*IT_0340 + 0.5*IT_0341 + (-0.5)*IT_0342;
    const ccomplex_t IT_0344 = IT_0241*IT_0343;
    const ccomplex_t IT_0345 = m_N_1*IT_0344;
    const ccomplex_t IT_0346 = IT_0226*IT_0343;
    const ccomplex_t IT_0347 = m_N_4*IT_0346;
    const ccomplex_t IT_0348 = IT_0345 + IT_0347;
    const ccomplex_t IT_0349 = IT_0188*IT_0348;
    const ccomplex_t IT_0350 = IT_0247*IT_0348;
    const ccomplex_t IT_0351 = (-0.5)*IT_0260 + 0.5*IT_0266 + -IT_0317 + 
      -IT_0318 + -IT_0333 + -IT_0334 + -IT_0349 + -IT_0350;
    ...
    const ccomplex_t IT_0357 = IT_0022*IT_0296;
    const ccomplex_t IT_0358 = IT_0047*IT_0299;
    const ccomplex_t IT_0359 = 0.5*IT_0048 + (-0.5)*IT_0124 + IT_0288 + 
      -IT_0357 + IT_0358;
    ...
    const ccomplex_t IT_0369 = IT_0045*IT_0299;
    const ccomplex_t IT_0370 = IT_0003*IT_0257;
    const ccomplex_t IT_0371 = IT_0269*IT_0280;
    const ccomplex_t IT_0372 = IT_0268*IT_0371;
    const ccomplex_t IT_0373 = -IT_0369 + 0.5*IT_0370 + -IT_0372;
    const ccomplex_t IT_0374 = IT_0050*IT_0089;
    const ccomplex_t IT_0375 = IT_0109*IT_0330;
    const ccomplex_t IT_0376 = IT_0185*IT_0314;
    const ccomplex_t IT_0377 = IT_0126*IT_0180;
    const ccomplex_t IT_0378 = IT_0188*IT_0227;
    const ccomplex_t IT_0379 = IT_0247*IT_0344;
    ...
    const ccomplex_t IT_0383 = IT_0257*IT_0299;
    const ccomplex_t IT_0384 = IT_0269*IT_0283;
    const ccomplex_t IT_0385 = IT_0268*IT_0384;
    const ccomplex_t IT_0386 = IT_0003*IT_0045;
    const ccomplex_t IT_0387 = -IT_0383 + -IT_0385 + 0.5*IT_0386;
    const ccomplex_t IT_0388 = IT_0050*IT_0330;
    const ccomplex_t IT_0389 = IT_0089*IT_0109;
    const ccomplex_t IT_0390 = IT_0188*IT_0344;
    const ccomplex_t IT_0391 = IT_0227*IT_0247;
    const ccomplex_t IT_0392 = IT_0126*IT_0314;
    const ccomplex_t IT_0393 = IT_0180*IT_0185;
    const ccomplex_t IT_0394 = 0.5*IT_0386 + -IT_0388 + IT_0389 + -IT_0390 +
       IT_0391 + -IT_0392 + IT_0393;
    const ccomplex_t IT_0395 = conj(IT_0387) + conj(IT_0394);
    const ccomplex_t IT_0396 = 2*IT_0249;
    const ccomplex_t IT_0397 = (-2)*IT_0359;
    const ccomplex_t IT_0398 = IT_0387 + IT_0394;
    ...
    const ccomplex_t IT_0410 = (-2)*IT_0373;
    const ccomplex_t IT_0411 = (-2)*conj(IT_0373);
    const ccomplex_t IT_0412 = (-2)*IT_0387;
    const ccomplex_t IT_0413 = (-2)*conj(IT_0387);
    const ccomplex_t IT_0414 = (-2)*IT_0394;
    const ccomplex_t IT_0415 = IT_0000*IT_0001;
    const ccomplex_t IT_0416 = IT_0000*(conj(IT_0249)*IT_0353 + IT_0249
      ...
      *IT_0412 + IT_0394*IT_0413 + conj(IT_0394)*IT_0414) + (conj(IT_0387)
