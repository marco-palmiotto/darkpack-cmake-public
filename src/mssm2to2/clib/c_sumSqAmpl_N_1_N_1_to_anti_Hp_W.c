        ...
        )
{
    ...
    const ccomplex_t IT_0020 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = IT_0013*IT_0018;
    const ccomplex_t IT_0023 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0073 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0074 = IT_0018*IT_0073;
    const ccomplex_t IT_0075 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0098 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0099 = IT_0018*IT_0098;
    const ccomplex_t IT_0100 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_23 + IT_0000 + IT_0081 + -m_C_1*
    ...
    const ccomplex_t IT_0110 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0111 = IT_0035*IT_0110;
    const ccomplex_t IT_0112 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0113 = IT_0037*IT_0112;
    const ccomplex_t IT_0114 = N_W1*N_d1*e_em;
    ...
    const ccomplex_t IT_0121 = IT_0035*IT_0112;
    const ccomplex_t IT_0122 = IT_0037*IT_0110;
    const ccomplex_t IT_0123 = IT_0039*IT_0116;
    const ccomplex_t IT_0124 = IT_0041*IT_0114;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*(IT_0121 + IT_0122 + 
      -IT_0123 + -IT_0124);
    const ccomplex_t IT_0126 = -IT_0125;
    const ccomplex_t IT_0127 = IT_0055*IT_0126;
    const ccomplex_t IT_0128 = IT_0058*IT_0127;
    ...
    const ccomplex_t IT_0165 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0166 = IT_0018*IT_0165;
    const ccomplex_t IT_0167 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0173 = IT_0082*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*IT_0173;
    const ccomplex_t IT_0175 = IT_0010*IT_0112;
    const ccomplex_t IT_0176 = IT_0014*IT_0110;
    const ccomplex_t IT_0177 = IT_0019*IT_0116;
    const ccomplex_t IT_0178 = IT_0022*IT_0114;
    ...
    const ccomplex_t IT_0182 = 0.5*IT_0120 + 0.5*IT_0128 + 2*IT_0151 + 2
      *IT_0174 + 0.5*IT_0181;
    const ccomplex_t IT_0183 = 2*IT_0182;
    const ccomplex_t IT_0184 = (-0.5)*IT_0120 + (-0.5)*IT_0128 + (-0.5)*IT_0181;
    ...
    const ccomplex_t IT_0201 = -IT_0151 + -IT_0174;
    const ccomplex_t IT_0202 = cpow((-2)*s_13 + IT_0000 + IT_0081 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0203 = IT_0172*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*IT_0203;
    const ccomplex_t IT_0205 = cpow((-2)*s_13 + IT_0000 + IT_0081 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0206 = IT_0149*IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*IT_0206;
    const ccomplex_t IT_0208 = IT_0204 + IT_0207;
    const ccomplex_t IT_0209 = conj(IT_0201) + conj(IT_0208);
    const ccomplex_t IT_0210 = IT_0201 + IT_0208;
    const ccomplex_t IT_0211 = IT_0105*IT_0205;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*IT_0211;
    const ccomplex_t IT_0213 = IT_0080*IT_0202;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*IT_0213;
    const ccomplex_t IT_0215 = IT_0212 + IT_0214;
    const ccomplex_t IT_0216 = -IT_0084 + -IT_0108;
    const ccomplex_t IT_0217 = conj(IT_0215) + conj(IT_0216);
    const ccomplex_t IT_0218 = 2*IT_0109;
    const ccomplex_t IT_0219 = (-2)*IT_0190;
    const ccomplex_t IT_0220 = IT_0218 + IT_0219;
    const ccomplex_t IT_0221 = 2*conj(IT_0109);
    const ccomplex_t IT_0222 = (-2)*conj(IT_0190);
    const ccomplex_t IT_0223 = IT_0221 + IT_0222;
    const ccomplex_t IT_0224 = m_N_1*IT_0005;
    const ccomplex_t IT_0225 = IT_0097*IT_0135;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0227 = IT_0106*IT_0225*IT_0226;
    const ccomplex_t IT_0228 = IT_0104*IT_0148;
    const ccomplex_t IT_0229 = IT_0205*IT_0226*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0231 = IT_0079*IT_0164;
    const ccomplex_t IT_0232 = IT_0202*IT_0230*IT_0231;
    const ccomplex_t IT_0233 = IT_0072*IT_0171;
    const ccomplex_t IT_0234 = IT_0082*IT_0230*IT_0233;
    const ccomplex_t IT_0235 = -IT_0227 + -IT_0229 + -IT_0232 + -IT_0234;
    const ccomplex_t IT_0236 = IT_0084 + IT_0108 + IT_0204 + IT_0207;
    const ccomplex_t IT_0237 = m_N_1*IT_0236;
    const ccomplex_t IT_0238 = conj(IT_0235) + conj(IT_0237);
    const ccomplex_t IT_0239 = IT_0235 + IT_0237;
    const ccomplex_t IT_0240 = IT_0151 + IT_0174 + IT_0212 + IT_0214;
    const ccomplex_t IT_0241 = m_N_1*IT_0240;
    const ccomplex_t IT_0242 = -IT_0241;
    const ccomplex_t IT_0243 = IT_0202*IT_0230*IT_0233;
    const ccomplex_t IT_0244 = IT_0106*IT_0226*IT_0228;
    const ccomplex_t IT_0245 = IT_0082*IT_0230*IT_0231;
    const ccomplex_t IT_0246 = IT_0205*IT_0225*IT_0226;
    const ccomplex_t IT_0247 = IT_0243 + IT_0244 + IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = conj(IT_0242) + conj(IT_0247);
    const ccomplex_t IT_0249 = IT_0242 + IT_0247;
    ...
    const ccomplex_t IT_0254 = 0.5*IT_0031 + 0.5*IT_0047 + 0.5*IT_0059 + (-2)
      *IT_0212 + (-2)*IT_0214;
    const ccomplex_t IT_0255 = (-0.5)*IT_0031 + (-0.5)*IT_0047 + (-0.5)*IT_0059;
    const ccomplex_t IT_0256 = 0.5*IT_0120 + 0.5*IT_0128 + 0.5*IT_0181;
    const ccomplex_t IT_0257 = 2*IT_0256;
    const ccomplex_t IT_0258 = (-0.5)*IT_0120 + (-0.5)*IT_0128 + (-0.5)
    ...
    const ccomplex_t IT_0290 = s_12*IT_0286;
    const ccomplex_t IT_0291 = pow(m_W, 4);
    ...
    const ccomplex_t IT_0297 = IT_0290 + IT_0294 + IT_0296;
    const ccomplex_t IT_0298 = (-0.25)*IT_0293;
    const ccomplex_t IT_0299 = IT_0295 + IT_0298;
    const ccomplex_t IT_0300 = s_24*IT_0286;
    const ccomplex_t IT_0301 = IT_0001*IT_0300;
    const ccomplex_t IT_0302 = 0.5*IT_0301;
    const ccomplex_t IT_0303 = s_24 + IT_0302;
    const ccomplex_t IT_0304 = m_N_1*IT_0303;
    const ccomplex_t IT_0305 = 2*IT_0304;
    const ccomplex_t IT_0306 = (-2)*IT_0242;
    const ccomplex_t IT_0307 = (-2)*IT_0247;
    const ccomplex_t IT_0308 = IT_0306 + IT_0307;
    const ccomplex_t IT_0309 = s_14*IT_0286;
    const ccomplex_t IT_0310 = IT_0001*IT_0309;
    const ccomplex_t IT_0311 = (-0.25)*IT_0310;
    const ccomplex_t IT_0312 = s_14 + IT_0311;
    const ccomplex_t IT_0313 = m_N_1*IT_0312;
    const ccomplex_t IT_0314 = (-4)*IT_0313;
    const ccomplex_t IT_0315 = 2*IT_0235;
    const ccomplex_t IT_0316 = (-2)*conj(IT_0208)*(IT_0216*IT_0288 + -IT_0215
      *IT_0289 + 2*IT_0208*IT_0297 + (-4)*IT_0201*IT_0299 + (-0.5)*IT_0305
      *IT_0308 + -IT_0314*(IT_0237 + 0.5*IT_0315));
    const ccomplex_t IT_0317 = s_12*IT_0252;
    const ccomplex_t IT_0318 = 2*IT_0190;
    const ccomplex_t IT_0319 = 0.5*IT_0223*IT_0254 + 0.5*IT_0220*conj(IT_0254)
      ...
      *IT_0193*conj(IT_0256) + 0.5*IT_0189*IT_0258 + 0.5*IT_0186*conj(IT_0258) +
       -conj(IT_0255)*(IT_0109 + (-0.5)*IT_0318);
    const ccomplex_t IT_0320 = IT_0290 + IT_0296;
    const ccomplex_t IT_0321 = IT_0001*IT_0320;
    const ccomplex_t IT_0322 = (-0.5)*IT_0321;
    const ccomplex_t IT_0323 = s_12 + IT_0322;
    const ccomplex_t IT_0324 = 4*IT_0242;
    const ccomplex_t IT_0325 = 6*conj(IT_0235);
    const ccomplex_t IT_0326 = (-0.25)*IT_0301;
    const ccomplex_t IT_0327 = s_24 + IT_0326;
    const ccomplex_t IT_0328 = m_N_1*IT_0327;
    const ccomplex_t IT_0329 = (-4)*IT_0328;
    const ccomplex_t IT_0330 = 2*IT_0242;
    const ccomplex_t IT_0331 = 2*IT_0247;
    const ccomplex_t IT_0332 = IT_0330 + IT_0331;
    const ccomplex_t IT_0333 = 0.5*IT_0310;
    const ccomplex_t IT_0334 = s_14 + IT_0333;
    const ccomplex_t IT_0335 = m_N_1*IT_0334;
    const ccomplex_t IT_0336 = 2*IT_0335;
    const ccomplex_t IT_0337 = (-2)*IT_0235;
    const ccomplex_t IT_0338 = m_N_1*IT_0273;
    const ccomplex_t IT_0339 = -IT_0338;
    const ccomplex_t IT_0340 = 2*conj(IT_0235);
    const ccomplex_t IT_0341 = (-2)*conj(IT_0235);
    const ccomplex_t IT_0342 = 2*conj(IT_0242);
    const ccomplex_t IT_0343 = 2*conj(IT_0247);
    const ccomplex_t IT_0344 = IT_0342 + IT_0343;
    const ccomplex_t IT_0345 = s_12*IT_0005;
    const ccomplex_t IT_0346 = s_12*IT_0273;
    const ccomplex_t IT_0347 = -IT_0346;
    const ccomplex_t IT_0348 = m_N_1*IT_0252;
    const ccomplex_t IT_0349 = conj(IT_0237)*(IT_0218 + IT_0219 + IT_0257 +
       IT_0259) + conj(IT_0235)*IT_0260 + IT_0237*(IT_0221 + IT_0222 + IT_0261 +
       IT_0262) + IT_0235*IT_0263 + IT_0248*(IT_0191 + IT_0192 + IT_0280 +
       IT_0281) + IT_0249*(IT_0194 + IT_0195 + IT_0283 + IT_0284) + conj(IT_0109
      )*IT_0315 + conj(IT_0190)*IT_0337 + IT_0109*IT_0340 + IT_0190*IT_0341;
    const ccomplex_t IT_0350 = (-2)*IT_0201;
    const ccomplex_t IT_0351 = 2*conj(IT_0215);
    const ccomplex_t IT_0352 = (-2)*conj(IT_0201);
    const ccomplex_t IT_0353 = (-2)*conj(IT_0242);
    const ccomplex_t IT_0354 = (-2)*conj(IT_0247);
    const ccomplex_t IT_0355 = IT_0353 + IT_0354;
    const ccomplex_t IT_0356 = 0.5*IT_0340;
    const ccomplex_t IT_0357 = IT_0006*(conj(IT_0109)*IT_0186 + IT_0109
      *IT_0189 + conj(IT_0190)*IT_0193 + IT_0190*IT_0196) + IT_0200*(IT_0186
      *IT_0209 + IT_0189*IT_0210 + IT_0217*IT_0220 + (IT_0215 + IT_0216)*IT_0223
      ) + IT_0224*(IT_0193*IT_0238 + IT_0196*IT_0239 + IT_0220*IT_0248 + IT_0223
      ...
      *IT_0255 + IT_0193*conj(IT_0255) + conj(IT_0190)*IT_0260 + IT_0190*IT_0263
       ...
       IT_0279*(IT_0209*IT_0266 + IT_0210*IT_0269 + IT_0217*IT_0282 + (IT_0215 +
       IT_0216)*IT_0285) + IT_0316 + 2*IT_0317*IT_0319 + 4*IT_0323*(IT_0238
      *IT_0239 + IT_0248*(IT_0247 + 0.25*IT_0324)) + 6*IT_0000*(IT_0239*IT_0248 
      + IT_0249*(conj(IT_0237) + 0.166666666666667*IT_0325)) + 2*conj(IT_0201)*
      (IT_0216*IT_0289 + (-2)*IT_0201*IT_0297 + 4*IT_0208*IT_0299 + 0.5*IT_0329
      *IT_0332 + 0.5*IT_0336*IT_0337) + (-2)*conj(IT_0216)*(IT_0208*IT_0288 + 
      -IT_0201*IT_0289 + 2*IT_0216*IT_0297 + (-4)*IT_0215*IT_0299 + (-0.5)
      *IT_0332*IT_0336 + IT_0329*(IT_0237 + (-0.5)*IT_0337)) + IT_0339*(IT_0248
      *IT_0260 + IT_0249*IT_0263 + conj(IT_0237)*IT_0282 + IT_0237*IT_0285 +
       conj(IT_0254)*IT_0315 + conj(IT_0255)*IT_0337 + IT_0254*IT_0340 + IT_0255
      *IT_0341) + IT_0201*(IT_0336*IT_0341 + IT_0329*IT_0344) + 8*IT_0216*(conj
      (IT_0215)*IT_0299 + (-0.25)*IT_0329*(conj(IT_0237) + (-0.5)*IT_0341) +
       0.125*IT_0336*IT_0344) + (conj(IT_0182)*IT_0183 + conj(IT_0184)*IT_0193 +
       IT_0184*IT_0195 + conj(IT_0109)*IT_0220 + IT_0109*IT_0222 + conj(IT_0190)
      *IT_0318)*IT_0345 + (-2)*((IT_0254 + -IT_0255)*conj(IT_0255) + (-0.5)*conj
      (IT_0256)*IT_0257 + (-0.5)*conj(IT_0258)*IT_0266 + (-0.5)*IT_0258*IT_0268 
      + conj(IT_0254)*(IT_0255 + (-0.5)*IT_0280))*IT_0347 + IT_0348*IT_0349 +
       conj(IT_0237)*IT_0336*IT_0350 + conj(IT_0215)*(IT_0308*IT_0314 + IT_0305
      *IT_0315 + IT_0288*IT_0350) + IT_0237*(IT_0305*IT_0351 + IT_0336*IT_0352) 
      + (-4)*IT_0215*(conj(IT_0215)*IT_0297 + (-0.25)*IT_0288*IT_0352 + (-0.25)
      *IT_0314*IT_0355 + (-0.5)*IT_0305*(conj(IT_0237) + IT_0356)) + IT_0208*
      (IT_0289*IT_0351 + IT_0305*IT_0355 + 2*IT_0314*(conj(IT_0237) + IT_0356));
