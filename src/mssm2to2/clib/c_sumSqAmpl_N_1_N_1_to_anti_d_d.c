        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
    ...
    const ccomplex_t IT_0208 = IT_0043*IT_0207;
    ...
    const ccomplex_t IT_0224 = IT_0047*IT_0207;
    ...
    const ccomplex_t IT_0327 = conj(IT_0096)*IT_0239 + IT_0096*IT_0242 + conj
      ...
      *IT_0282 + conj(IT_0165)*IT_0290 + IT_0165*IT_0293 + IT_0296*IT_0299 + 
      (IT_0154 + IT_0185)*IT_0302 + IT_0303*IT_0306 + IT_0307*IT_0310 + IT_0311
    ...
    const ccomplex_t IT_0330 = 6*IT_0096;
    const ccomplex_t IT_0331 = 6*conj(IT_0096);
    const ccomplex_t IT_0332 = 6*IT_0176;
    const ccomplex_t IT_0333 = 6*conj(IT_0176);
    const ccomplex_t IT_0334 = conj(IT_0042)*IT_0239 + IT_0042*IT_0242 + conj
      (IT_0165)*IT_0279 + IT_0165*IT_0282 + IT_0306*IT_0311 + IT_0303*IT_0314 +
       IT_0310*IT_0315 + IT_0307*IT_0318 + IT_0299*IT_0319 + IT_0296*IT_0322 +
       IT_0302*IT_0323 + (IT_0154 + IT_0185)*IT_0326 + (-6)*conj(IT_0262)*
      (IT_0176 + (-0.166666666666667)*IT_0330) + (-6)*IT_0262*(conj(IT_0176) + (
      -0.166666666666667)*IT_0331) + (-6)*conj(IT_0264)*(IT_0096 + (
      -0.166666666666667)*IT_0332) + (-6)*IT_0264*(conj(IT_0096) + (
      -0.166666666666667)*IT_0333);
    const ccomplex_t IT_0335 = -IT_0196;
    const ccomplex_t IT_0336 = IT_0195 + IT_0197 + IT_0335;
    const ccomplex_t IT_0337 = 6*IT_0206;
    const ccomplex_t IT_0338 = 6*conj(IT_0206);
    const ccomplex_t IT_0339 = m_d*s_13*m_N_1;
    const ccomplex_t IT_0340 = 12*IT_0096;
    const ccomplex_t IT_0341 = 24*IT_0186;
    const ccomplex_t IT_0342 = 24*IT_0156;
    const ccomplex_t IT_0343 = IT_0340 + IT_0341 + IT_0342;
    const ccomplex_t IT_0344 = 12*conj(IT_0096);
    const ccomplex_t IT_0345 = 24*conj(IT_0186);
    const ccomplex_t IT_0346 = 24*conj(IT_0156);
    const ccomplex_t IT_0347 = IT_0344 + IT_0345 + IT_0346;
    const ccomplex_t IT_0348 = 12*IT_0276;
    const ccomplex_t IT_0349 = 24*IT_0206;
    const ccomplex_t IT_0350 = IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = 12*conj(IT_0276);
    const ccomplex_t IT_0352 = 24*conj(IT_0206);
    ...
    const ccomplex_t IT_0362 = IT_0339*(conj(IT_0287)*IT_0330 + IT_0287
      *IT_0331 + conj(IT_0249)*IT_0343 + IT_0249*IT_0347 + IT_0311*IT_0350 +
       IT_0315*IT_0353 + conj(IT_0042)*IT_0356 + IT_0042*IT_0359 + IT_0303
      *IT_0360 + IT_0307*IT_0361);
    const ccomplex_t IT_0363 = m_d*s_14*m_N_1;
    const ccomplex_t IT_0364 = 12*IT_0176;
    const ccomplex_t IT_0365 = 24*IT_0154;
    const ccomplex_t IT_0366 = 24*IT_0185;
    const ccomplex_t IT_0367 = IT_0364 + IT_0365 + IT_0366;
    const ccomplex_t IT_0368 = 12*conj(IT_0176);
    const ccomplex_t IT_0369 = 24*conj(IT_0154);
    const ccomplex_t IT_0370 = 24*conj(IT_0185);
    const ccomplex_t IT_0371 = IT_0368 + IT_0369 + IT_0370;
    const ccomplex_t IT_0372 = 24*IT_0276;
    const ccomplex_t IT_0373 = IT_0355 + IT_0372;
    const ccomplex_t IT_0374 = 24*conj(IT_0276);
    const ccomplex_t IT_0375 = IT_0358 + IT_0374;
    const ccomplex_t IT_0376 = IT_0337 + IT_0348;
    const ccomplex_t IT_0377 = IT_0338 + IT_0351;
    const ccomplex_t IT_0378 = 12*IT_0249;
    const ccomplex_t IT_0379 = 12*conj(IT_0249);
    const ccomplex_t IT_0380 = conj(IT_0249)*IT_0332 + IT_0249*IT_0333 + conj
      (IT_0287)*IT_0367 + IT_0287*IT_0371 + IT_0319*IT_0373 + IT_0323*IT_0375 +
       conj(IT_0165)*IT_0376 + IT_0165*IT_0377 + IT_0296*IT_0378 + (IT_0154 +
       IT_0185)*IT_0379;
    const ccomplex_t IT_0381 = m_d*s_23*m_N_1;
    const ccomplex_t IT_0382 = 24*IT_0190;
    const ccomplex_t IT_0383 = 24*IT_0151;
    ...
    const ccomplex_t IT_0391 = conj(IT_0165)*IT_0249 + IT_0165*conj(IT_0249) +
       0.166666666666667*IT_0296*IT_0373 + 0.166666666666667*(IT_0154 + IT_0185)
      *IT_0375 + 0.166666666666667*conj(IT_0176)*IT_0376 + 0.166666666666667
      *IT_0176*IT_0377 + 0.166666666666667*IT_0319*IT_0378 + 0.166666666666667
      *IT_0323*IT_0379 + 0.166666666666667*conj(IT_0287)*IT_0386 +
       0.166666666666667*IT_0287*IT_0390;
    ...
    const ccomplex_t IT_0397 = conj(IT_0165)*IT_0330 + IT_0165*IT_0331 + conj
      (IT_0042)*IT_0332 + IT_0042*IT_0333 + IT_0319*IT_0340 + IT_0323*IT_0344 +
       conj(IT_0145)*(IT_0364 + IT_0365) + conj(IT_0189)*IT_0367 + IT_0145*
      (IT_0368 + IT_0369) + IT_0189*IT_0371 + IT_0303*IT_0386 + IT_0307*IT_0390 
      + IT_0296*IT_0393 + (IT_0154 + IT_0185)*IT_0394 + conj(IT_0185)*IT_0395 +
       IT_0185*IT_0396;
    ...
    const ccomplex_t IT_0413 = 48*IT_0151;
    const ccomplex_t IT_0414 = 24*IT_0165;
    const ccomplex_t IT_0415 = IT_0413 + IT_0414;
    const ccomplex_t IT_0416 = 48*conj(IT_0154);
    const ccomplex_t IT_0417 = 48*conj(IT_0151);
    const ccomplex_t IT_0418 = 48*IT_0190;
    const ccomplex_t IT_0419 = conj(IT_0276)*IT_0348 + conj(IT_0287)*IT_0360 +
       conj(IT_0176)*IT_0367 + conj(IT_0165)*IT_0386 + conj(IT_0185)*(48*IT_0185
       + IT_0410 + IT_0411) + conj(IT_0154)*IT_0412 + conj(IT_0151)*IT_0415 +
       IT_0185*IT_0416 + IT_0190*IT_0417 + conj(IT_0190)*(IT_0415 + IT_0418);
    ...
    const ccomplex_t IT_0440 = m_d*s_24*m_N_1;
    ...
    const ccomplex_t IT_0447 = IT_0303*IT_0350 + IT_0307*IT_0353 + conj
      (IT_0096)*IT_0356 + IT_0096*IT_0359 + IT_0311*IT_0360 + IT_0315*IT_0361 +
       conj(IT_0249)*IT_0443 + conj(IT_0287)*IT_0444 + IT_0287*IT_0445 + IT_0249
      *(24*conj(IT_0145) + IT_0394 + IT_0446);
    const ccomplex_t IT_0448 = conj(IT_0176)*IT_0330 + IT_0176*IT_0331 +
       IT_0296*IT_0340 + (IT_0154 + IT_0185)*IT_0344 + IT_0303*IT_0367 + IT_0307
      *IT_0371 + IT_0311*IT_0385 + IT_0315*IT_0387 + IT_0319*(IT_0393 + IT_0395 
      + IT_0441) + conj(IT_0165)*IT_0444 + IT_0165*IT_0445 + IT_0323*(IT_0394 +
       IT_0396 + IT_0446);
    ...
    const ccomplex_t IT_0457 = conj(IT_0042)*IT_0343 + IT_0042*IT_0347 + conj
      (IT_0249)*IT_0356 + IT_0249*IT_0359 + conj(IT_0165)*IT_0367 + IT_0165
      *IT_0371 + conj(IT_0287)*IT_0376 + IT_0287*IT_0377 + conj(IT_0176)*IT_0384
       + conj(IT_0190)*(48*IT_0185 + IT_0410 + IT_0411) + conj(IT_0151)*IT_0412 
      + IT_0323*IT_0416 + IT_0185*IT_0417 + conj(IT_0185)*(IT_0413 + IT_0418) +
       conj(IT_0096)*IT_0442 + IT_0315*IT_0450 + IT_0186*IT_0451 + conj(IT_0186)
      *(IT_0452 + IT_0453) + conj(IT_0145)*(IT_0454 + IT_0455) + conj(IT_0189)*
      (IT_0454 + IT_0455 + IT_0456);
    const ccomplex_t IT_0458 = 24*IT_0042;
    const ccomplex_t IT_0459 = IT_0452 + IT_0458;
    const ccomplex_t IT_0460 = conj(IT_0096)*IT_0343 + conj(IT_0206)*IT_0355 +
       conj(IT_0249)*IT_0378 + conj(IT_0042)*IT_0443 + IT_0186*IT_0450 + IT_0189
      *IT_0451 + conj(IT_0156)*(IT_0454 + IT_0455) + conj(IT_0186)*(IT_0454 +
       IT_0455 + IT_0456) + conj(IT_0145)*IT_0459 + conj(IT_0189)*(IT_0453 +
       IT_0459);
    const ccomplex_t IT_0461 = (-0.166666666666667)*IT_0249;
    const ccomplex_t IT_0462 = (-0.166666666666667)*conj(IT_0249);
    const ccomplex_t IT_0463 = IT_0027*IT_0398;
    const ccomplex_t IT_0464 = IT_0282*IT_0287 + IT_0279*conj(IT_0287) + (-6)
      *conj(IT_0264)*(IT_0206 + 4*IT_0235 + (-4)*IT_0237 + (-0.166666666666667)
      *IT_0354) + (-6)*IT_0264*(conj(IT_0206) + 4*conj(IT_0235) + (-4)*conj
      (IT_0237) + (-0.166666666666667)*IT_0357) + 24*conj(IT_0262)*(IT_0235 + 
      -1./4*IT_0276 + 0.0416666666666667*IT_0337 + 0.0416666666666667*IT_0400) +
       24*IT_0262*(conj(IT_0235) + -1./4*conj(IT_0276) + 0.0416666666666667
      *IT_0338 + 0.0416666666666667*IT_0401) + (-6)*IT_0242*IT_0461 + (-6)
      *IT_0239*IT_0462;
    const ccomplex_t IT_0465 = IT_0004*(conj(IT_0042)*IT_0080 + IT_0042
      ...
      *IT_0327 + IT_0329*IT_0334 + 6*IT_0336*(conj(IT_0249)*IT_0287 + IT_0249
      *conj(IT_0287) + 0.166666666666667*conj(IT_0276)*IT_0337 +
       0.166666666666667*IT_0276*IT_0338) + IT_0362 + IT_0363*IT_0380 + 6
      *IT_0381*IT_0391 + IT_0392*IT_0397 + IT_0399*(24*IT_0237*conj(IT_0237) +
       IT_0264*((-24)*conj(IT_0262) + 24*conj(IT_0264)) + IT_0262*(24*conj
      (IT_0262) + (-24)*conj(IT_0264)) + conj(IT_0235)*IT_0400 + IT_0235*(24
      *conj(IT_0235) + IT_0401)) + (IT_0194 + IT_0195 + IT_0198 + IT_0335)*
      (IT_0276*IT_0404 + conj(IT_0287)*IT_0407 + 6*IT_0287*(conj(IT_0114) +
       0.166666666666667*IT_0408) + 6*conj(IT_0276)*(IT_0076 + 0.166666666666667
      *IT_0409)) + IT_0197*IT_0419 + IT_0422*IT_0438 + (24*conj(IT_0076)*IT_0078
       + IT_0076*((-24)*conj(IT_0076) + 24*conj(IT_0078)) + IT_0116*IT_0425 +
       conj(IT_0078)*IT_0436 + IT_0114*((-24)*conj(IT_0114) + IT_0437))*IT_0439 
      + IT_0440*IT_0447 + IT_0194*IT_0448 + IT_0449*IT_0457 + IT_0195*IT_0460 + 
      (IT_0194 + IT_0197 + IT_0270 + IT_0335)*(IT_0206*IT_0434 + (-6)*conj
      (IT_0206)*(IT_0076 + (-0.166666666666667)*IT_0435) + (-6)*IT_0431*IT_0461 
      + (-6)*IT_0428*IT_0462) + IT_0463*IT_0464;
