...
ccomplex_return_t c_sumSqAmpl_N_1_N_1_to_anti_nu_e_nu_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0051 = (-0.5)*IT_0022;
    const ccomplex_t IT_0052 = 8*IT_0048;
    const ccomplex_t IT_0053 = conj(IT_0051)*IT_0052;
    const ccomplex_t IT_0054 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*reg_prop +
       0.5*m_snu_mu*(m_snu_mu + (0 + _Complex_I*-1)*Gamma_nuel), -1);
    ...
    const ccomplex_t IT_0058 = s_14*s_23;
    const ccomplex_t IT_0059 = 8*IT_0058;
    const ccomplex_t IT_0060 = conj(IT_0057)*IT_0059;
    const ccomplex_t IT_0061 = conj(IT_0023) + conj(IT_0026);
    const ccomplex_t IT_0062 = 16*IT_0058;
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = 0.5*IT_0025;
    const ccomplex_t IT_0065 = IT_0052*conj(IT_0064);
    const ccomplex_t IT_0066 = IT_0050 + IT_0053 + IT_0060 + IT_0063 + IT_0065;
    const ccomplex_t IT_0067 = IT_0049*conj(IT_0057);
    const ccomplex_t IT_0068 = conj(IT_0051) + conj(IT_0064);
    const ccomplex_t IT_0069 = s_13*s_24;
    const ccomplex_t IT_0070 = 16*IT_0069;
    const ccomplex_t IT_0071 = IT_0068*IT_0070;
    const ccomplex_t IT_0072 = IT_0052*IT_0061;
    const ccomplex_t IT_0073 = 8*IT_0069;
    const ccomplex_t IT_0074 = conj(IT_0047)*IT_0073;
    const ccomplex_t IT_0075 = IT_0067 + IT_0071 + IT_0072 + IT_0074;
    const ccomplex_t IT_0076 = IT_0049*IT_0057;
    const ccomplex_t IT_0077 = 2*IT_0057*(conj(IT_0047)*IT_0048 + 2*conj
      (IT_0057)*IT_0058 + 0.5*IT_0059*IT_0061) + (IT_0023 + IT_0026)*IT_0066 + 4
      *IT_0047*(0.5*IT_0048*conj(IT_0057) + 0.25*IT_0049*IT_0061 + conj(IT_0047)
      *IT_0069 + 0.25*IT_0068*IT_0073) + (IT_0051 + IT_0064)*IT_0075 + IT_0068
      *IT_0076;
