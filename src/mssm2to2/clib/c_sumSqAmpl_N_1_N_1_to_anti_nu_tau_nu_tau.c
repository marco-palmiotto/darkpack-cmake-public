...
ccomplex_return_t c_sumSqAmpl_N_1_N_1_to_anti_nu_tau_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0054 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*reg_prop +
       0.5*m_snu_tau*(m_snu_tau + (0 + _Complex_I*-1)*Gamma_nutaul), -1);
    ...
    const ccomplex_t IT_0058 = s_13*s_24;
