        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0000 + IT_0029 + -m_ss_R*
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_13 + IT_0000 + IT_0029 + -m_ss_L*
    ...
    const ccomplex_t IT_0102 = m_s*s_14*m_N_1;
    ...
    const ccomplex_t IT_0121 = m_s*s_23*m_N_1;
    ...
    const ccomplex_t IT_0168 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0169 = IT_0124*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*IT_0169;
    const ccomplex_t IT_0171 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0182 = m_s*s_13*m_N_1;
    ...
    const ccomplex_t IT_0195 = m_s*s_24*m_N_1;
    ...
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*m_s*e_em*IT_0007*IT_0033
      *IT_0035*IT_0228;
    ...
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*m_s*e_em*IT_0007*IT_0033
      *IT_0035*IT_0233;
