        ...
        )
{
    ...
    const ccomplex_t IT_0000 = m_u*m_N_1;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*m_u*e_em*IT_0011*IT_0036
      *IT_0051*IT_0053;
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*(IT_0060 + -IT_0061 + 
      -IT_0062 + IT_0063);
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*m_u*e_em*IT_0011*IT_0040
      *IT_0051*IT_0053;
    ...
    const ccomplex_t IT_0084 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0088 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0094 = IT_0037*IT_0086;
    const ccomplex_t IT_0095 = IT_0041*IT_0084;
    const ccomplex_t IT_0096 = IT_0044*IT_0090;
    const ccomplex_t IT_0097 = IT_0047*IT_0088;
    ...
    const ccomplex_t IT_0114 = pow(m_u, 2);
    const ccomplex_t IT_0115 = cpow((-2)*s_13 + IT_0023 + IT_0114 + -m_su_L*
    ...
    const ccomplex_t IT_0135 = cpow((-2)*s_13 + IT_0023 + IT_0114 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0011*IT_0051*IT_0053;
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0011*IT_0051*IT_0053;
    ...
    const ccomplex_t IT_0144 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0006;
    const ccomplex_t IT_0145 = 0.666666666666667*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0006;
    ...
    const ccomplex_t IT_0151 = (-0.5)*IT_0138;
    const ccomplex_t IT_0152 = (-0.5)*IT_0136;
    const ccomplex_t IT_0153 = IT_0151*IT_0152;
    const ccomplex_t IT_0154 = IT_0115*IT_0153;
    ...
    const ccomplex_t IT_0159 = cpow((-2)*s_23 + IT_0023 + IT_0114 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0160 = IT_0148*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = cpow((-2)*s_23 + IT_0023 + IT_0114 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    ...
    const ccomplex_t IT_0172 = IT_0132*IT_0162;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = IT_0140*IT_0159;
    ...
    const ccomplex_t IT_0200 = IT_0131*IT_0151;
    const ccomplex_t IT_0201 = IT_0115*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*IT_0201;
    const ccomplex_t IT_0203 = IT_0139*IT_0147;
    ...
    const ccomplex_t IT_0224 = IT_0035*IT_0208;
    const ccomplex_t IT_0225 = IT_0039*IT_0210;
    const ccomplex_t IT_0226 = IT_0043*IT_0212;
    const ccomplex_t IT_0227 = IT_0046*IT_0214;
    const ccomplex_t IT_0228 = -IT_0224 + IT_0225 + IT_0226 + -IT_0227;
    const ccomplex_t IT_0229 = m_u*e_em*IT_0011*IT_0051*IT_0053*IT_0207;
    ...
    const ccomplex_t IT_0256 = IT_0084*IT_0208;
    ...
    const ccomplex_t IT_0340 = m_u*s_14*m_N_1;
    ...
    const ccomplex_t IT_0362 = m_u*s_23*m_N_1;
    const ccomplex_t IT_0363 = 12*IT_0165;
    const ccomplex_t IT_0364 = 24*IT_0190;
    const ccomplex_t IT_0365 = 24*IT_0034;
    const ccomplex_t IT_0366 = IT_0363 + IT_0364 + IT_0365;
    const ccomplex_t IT_0367 = 12*conj(IT_0165);
    const ccomplex_t IT_0368 = 24*conj(IT_0190);
    const ccomplex_t IT_0369 = 24*conj(IT_0034);
    const ccomplex_t IT_0370 = IT_0367 + IT_0368 + IT_0369;
    const ccomplex_t IT_0371 = conj(IT_0165)*IT_0249 + IT_0165*conj(IT_0249) +
       0.166666666666667*IT_0296*IT_0351 + 0.166666666666667*IT_0300*IT_0354 +
       0.166666666666667*conj(IT_0176)*IT_0356 + 0.166666666666667*IT_0176
      *IT_0358 + 0.166666666666667*IT_0320*IT_0359 + 0.166666666666667*IT_0324
      *IT_0360 + 0.166666666666667*conj(IT_0287)*IT_0366 + 0.166666666666667
      *IT_0287*IT_0370;
    const ccomplex_t IT_0372 = m_u*s_24*m_N_1;
    const ccomplex_t IT_0373 = 12*IT_0143;
    const ccomplex_t IT_0374 = 24*IT_0028;
    const ccomplex_t IT_0375 = 24*IT_0189;
    const ccomplex_t IT_0376 = IT_0373 + IT_0374 + IT_0375;
    const ccomplex_t IT_0377 = 12*conj(IT_0143);
    const ccomplex_t IT_0378 = 24*conj(IT_0028);
    const ccomplex_t IT_0379 = 24*conj(IT_0189);
    const ccomplex_t IT_0380 = IT_0377 + IT_0378 + IT_0379;
    const ccomplex_t IT_0381 = 24*IT_0206;
    const ccomplex_t IT_0382 = IT_0355 + IT_0381;
    const ccomplex_t IT_0383 = 24*conj(IT_0206);
    const ccomplex_t IT_0384 = IT_0357 + IT_0383;
    const ccomplex_t IT_0385 = 6*IT_0276;
    const ccomplex_t IT_0386 = IT_0349 + IT_0385;
    const ccomplex_t IT_0387 = 6*conj(IT_0276);
    const ccomplex_t IT_0388 = IT_0352 + IT_0387;
    const ccomplex_t IT_0389 = 6*IT_0143;
    const ccomplex_t IT_0390 = 6*conj(IT_0143);
    const ccomplex_t IT_0391 = 12*IT_0287;
    const ccomplex_t IT_0392 = 12*conj(IT_0287);
    const ccomplex_t IT_0393 = IT_0372*(conj(IT_0249)*IT_0376 + IT_0249
      *IT_0380 + IT_0304*IT_0382 + IT_0308*IT_0384 + conj(IT_0156)*IT_0386 +
       IT_0156*IT_0388 + conj(IT_0287)*IT_0389 + IT_0287*IT_0390 + IT_0312
      *IT_0391 + IT_0316*IT_0392);
    const ccomplex_t IT_0394 = s_34*IT_0023;
    const ccomplex_t IT_0395 = 12*IT_0156;
    const ccomplex_t IT_0396 = 12*conj(IT_0156);
    const ccomplex_t IT_0397 = conj(IT_0165)*IT_0335 + IT_0165*IT_0336 + conj
      (IT_0143)*IT_0337 + IT_0143*IT_0338 + IT_0312*IT_0341 + IT_0028*(IT_0345 +
       IT_0346) + IT_0189*IT_0348 + IT_0304*IT_0366 + IT_0308*IT_0370 + IT_0296
      *IT_0373 + conj(IT_0185)*IT_0374 + (IT_0081 + IT_0185)*IT_0380 + IT_0320
      *IT_0395 + IT_0324*IT_0396;
    const ccomplex_t IT_0398 = -s_34;
    const ccomplex_t IT_0399 = IT_0114 + IT_0398;
    const ccomplex_t IT_0400 = s_12*IT_0399;
    const ccomplex_t IT_0401 = (-24)*IT_0073;
    const ccomplex_t IT_0402 = IT_0400*(24*conj(IT_0071)*IT_0073 + IT_0071*((
      -24)*conj(IT_0071) + 24*conj(IT_0073)) + IT_0101*((-24)*conj(IT_0101) + 24
      *conj(IT_0103)) + IT_0103*(24*conj(IT_0101) + (-24)*conj(IT_0103)) + conj
      (IT_0073)*IT_0401);
    const ccomplex_t IT_0403 = s_34 + IT_0114;
    const ccomplex_t IT_0404 = s_12*IT_0403;
    const ccomplex_t IT_0405 = (-24)*IT_0237;
    const ccomplex_t IT_0406 = (-24)*conj(IT_0237);
    const ccomplex_t IT_0407 = 6*IT_0071;
    const ccomplex_t IT_0408 = (-6)*IT_0073;
    const ccomplex_t IT_0409 = IT_0407 + IT_0408;
    const ccomplex_t IT_0410 = 6*conj(IT_0071);
    const ccomplex_t IT_0411 = (-6)*conj(IT_0073);
    const ccomplex_t IT_0412 = IT_0410 + IT_0411;
    const ccomplex_t IT_0413 = 6*IT_0101;
    const ccomplex_t IT_0414 = (-6)*IT_0103;
    const ccomplex_t IT_0415 = IT_0413 + IT_0414;
    const ccomplex_t IT_0416 = (-6)*conj(IT_0103);
    const ccomplex_t IT_0417 = 24*conj(IT_0186);
    const ccomplex_t IT_0418 = 24*conj(IT_0083);
    const ccomplex_t IT_0419 = IT_0396 + IT_0417 + IT_0418;
    const ccomplex_t IT_0420 = conj(IT_0176)*IT_0335 + IT_0176*IT_0336 +
       IT_0304*IT_0341 + IT_0308*IT_0348 + IT_0312*IT_0363 + IT_0316*IT_0367 +
       IT_0320*(IT_0373 + IT_0374 + IT_0375) + IT_0324*IT_0380 + conj(IT_0165)
      *IT_0389 + IT_0165*IT_0390 + IT_0296*IT_0395 + IT_0300*IT_0419;
    const ccomplex_t IT_0421 = m_u*s_13*m_N_1;
    const ccomplex_t IT_0422 = 24*IT_0083;
    const ccomplex_t IT_0423 = 24*IT_0186;
    const ccomplex_t IT_0424 = conj(IT_0287)*IT_0335 + IT_0287*IT_0336 +
       IT_0312*IT_0382 + IT_0316*IT_0384 + conj(IT_0143)*IT_0386 + IT_0143
      *IT_0388 + IT_0304*IT_0391 + IT_0308*IT_0392 + IT_0249*IT_0419 + conj
      (IT_0249)*(IT_0395 + IT_0422 + IT_0423);
    const ccomplex_t IT_0425 = 48*IT_0083;
    const ccomplex_t IT_0426 = 24*IT_0156;
    const ccomplex_t IT_0427 = IT_0425 + IT_0426;
    const ccomplex_t IT_0428 = 48*IT_0028;
    const ccomplex_t IT_0429 = 24*IT_0143;
    const ccomplex_t IT_0430 = IT_0428 + IT_0429;
    const ccomplex_t IT_0431 = 48*conj(IT_0028);
    const ccomplex_t IT_0432 = 48*IT_0189;
    const ccomplex_t IT_0433 = 48*conj(IT_0083);
    const ccomplex_t IT_0434 = 24*conj(IT_0156);
    const ccomplex_t IT_0435 = conj(IT_0206)*IT_0349 + conj(IT_0249)*IT_0359 +
       conj(IT_0143)*IT_0376 + conj(IT_0156)*(IT_0395 + IT_0422) + IT_0304
      *IT_0427 + conj(IT_0028)*IT_0430 + IT_0189*IT_0431 + conj(IT_0189)*
      (IT_0430 + IT_0432) + IT_0186*(48*conj(IT_0186) + IT_0433 + IT_0434);
    const ccomplex_t IT_0436 = IT_0023*IT_0114;
    const ccomplex_t IT_0437 = 48*IT_0081;
    const ccomplex_t IT_0438 = 24*IT_0176;
    const ccomplex_t IT_0439 = IT_0437 + IT_0438;
    const ccomplex_t IT_0440 = 48*conj(IT_0034);
    const ccomplex_t IT_0441 = 48*IT_0034;
    const ccomplex_t IT_0442 = 48*IT_0190;
    const ccomplex_t IT_0443 = 48*conj(IT_0081);
    const ccomplex_t IT_0444 = 24*conj(IT_0176);
    const ccomplex_t IT_0445 = conj(IT_0165)*IT_0344 + IT_0165*IT_0348 + conj
      (IT_0287)*IT_0356 + IT_0287*IT_0358 + conj(IT_0249)*IT_0386 + IT_0249
      *IT_0388 + IT_0143*IT_0419 + conj(IT_0143)*(IT_0395 + IT_0422 + IT_0423) +
       conj(IT_0189)*(48*IT_0186 + IT_0425 + IT_0426) + conj(IT_0028)*IT_0427 +
       IT_0186*IT_0431 + conj(IT_0186)*(IT_0428 + IT_0432) + IT_0316*(IT_0433 +
       IT_0434) + conj(IT_0190)*(48*IT_0185 + IT_0437 + IT_0438) + conj(IT_0034)
      *IT_0439 + IT_0185*IT_0440 + conj(IT_0185)*(IT_0441 + IT_0442) + IT_0324*
      (IT_0443 + IT_0444);
    const ccomplex_t IT_0446 = 24*IT_0165;
    const ccomplex_t IT_0447 = IT_0441 + IT_0446;
    const ccomplex_t IT_0448 = conj(IT_0176)*(IT_0341 + IT_0343) + conj
      (IT_0276)*IT_0355 + conj(IT_0165)*IT_0366 + conj(IT_0287)*IT_0391 +
       IT_0296*IT_0439 + IT_0190*IT_0440 + IT_0185*(48*conj(IT_0185) + IT_0443 +
       IT_0444) + conj(IT_0034)*IT_0447 + conj(IT_0190)*(IT_0442 + IT_0447);
    const ccomplex_t IT_0449 = IT_0023*IT_0403;
    const ccomplex_t IT_0450 = (-0.166666666666667)*IT_0249;
    const ccomplex_t IT_0451 = (-0.166666666666667)*conj(IT_0249);
    const ccomplex_t IT_0452 = (-0.166666666666667)*IT_0287;
    const ccomplex_t IT_0453 = (-0.166666666666667)*conj(IT_0287);
    const ccomplex_t IT_0454 = conj(IT_0264)*(IT_0206 + 4*IT_0235 + (-4)
      *IT_0237 + (-0.166666666666667)*IT_0385) + IT_0264*(conj(IT_0206) + 4*conj
      (IT_0235) + (-4)*conj(IT_0237) + (-0.166666666666667)*IT_0387) + (-4)*conj
      (IT_0262)*(IT_0235 + -1./4*IT_0276 + 0.0416666666666667*IT_0331 +
       0.0416666666666667*IT_0405) + (-4)*IT_0262*(conj(IT_0235) + -1./4*conj
      (IT_0276) + 0.0416666666666667*IT_0332 + 0.0416666666666667*IT_0406) +
       IT_0242*IT_0450 + IT_0239*IT_0451 + IT_0282*IT_0452 + IT_0279*IT_0453;
    const ccomplex_t IT_0455 = 6*IT_0073;
    const ccomplex_t IT_0456 = 6*conj(IT_0103);
    const ccomplex_t IT_0457 = (-6)*conj(IT_0101);
    const ccomplex_t IT_0458 = IT_0456 + IT_0457;
    const ccomplex_t IT_0459 = 6*IT_0103;
    const ccomplex_t IT_0460 = (-6)*IT_0101;
    const ccomplex_t IT_0461 = IT_0459 + IT_0460;
    const ccomplex_t IT_0462 = 6*conj(IT_0073);
    const ccomplex_t IT_0463 = (-6)*conj(IT_0071);
    const ccomplex_t IT_0464 = IT_0462 + IT_0463;
    const ccomplex_t IT_0465 = (-0.166666666666667)*IT_0206;
    const ccomplex_t IT_0466 = IT_0023*IT_0399;
    const ccomplex_t IT_0467 = (conj(IT_0071) + -conj(IT_0073))*(IT_0101 + 
      -IT_0103) + IT_0073*conj(IT_0103) + IT_0071*(conj(IT_0101) + -conj(IT_0103
      ) + -1./4*conj(IT_0287)) + 0.25*conj(IT_0101)*(IT_0206 + 0.166666666666667
      *IT_0401) + 0.0416666666666667*conj(IT_0206)*IT_0415 + (-0.25)*IT_0412
      *IT_0450 + (-0.25)*IT_0409*IT_0451 + (-0.25)*IT_0453*IT_0455 +
       0.0416666666666667*IT_0276*IT_0458 + 0.0416666666666667*conj(IT_0276)
      *IT_0461 + (-0.25)*IT_0452*IT_0464 + (-0.25)*IT_0416*IT_0465;
    const ccomplex_t IT_0468 = IT_0004*((conj(IT_0028) + conj(IT_0034))
      ...
      *IT_0332) + IT_0334*IT_0339 + IT_0361 + 6*IT_0362*IT_0371 + IT_0393 +
       IT_0394*IT_0397 + IT_0402 + IT_0404*(24*IT_0237*conj(IT_0237) + IT_0264*(
      (-24)*conj(IT_0262) + 24*conj(IT_0264)) + IT_0262*(24*conj(IT_0262) + (-24
      )*conj(IT_0264)) + conj(IT_0235)*IT_0405 + IT_0235*(24*conj(IT_0235) +
       IT_0406)) + (IT_0194 + IT_0195 + IT_0198 + IT_0329)*(conj(IT_0276)
      *IT_0409 + IT_0276*IT_0412 + conj(IT_0287)*IT_0415 + 6*IT_0287*(conj
      (IT_0101) + 0.166666666666667*IT_0416)) + IT_0194*IT_0420 + IT_0421
      *IT_0424 + IT_0195*IT_0435 + IT_0436*IT_0445 + IT_0197*IT_0448 + (-6)
      *IT_0449*IT_0454 + (-6)*(IT_0194 + IT_0197 + IT_0270 + IT_0329)*(conj
      (IT_0206)*(IT_0071 + (-0.166666666666667)*IT_0455) + IT_0450*IT_0458 +
       IT_0451*IT_0461 + IT_0464*IT_0465) + 24*IT_0466*IT_0467;
