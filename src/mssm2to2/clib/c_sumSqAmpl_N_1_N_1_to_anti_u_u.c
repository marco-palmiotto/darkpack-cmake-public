        ...
        )
{
    ...
    const ccomplex_t IT_0026 = pow(m_u, 2);
    const ccomplex_t IT_0027 = pow(m_N_1, 2);
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0026 + IT_0027 + -m_su_L*
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0026 + IT_0027 + -m_su_R*
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_u*e_em*IT_0011*IT_0031
      *IT_0033*IT_0044;
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*(IT_0065 + -IT_0066 + 
      -IT_0067 + IT_0068);
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*m_u*e_em*IT_0011*IT_0031
      *IT_0033*IT_0048;
    ...
    const ccomplex_t IT_0159 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0160 = IT_0088*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    ...
    const ccomplex_t IT_0217 = m_u*e_em*IT_0011*IT_0031;
    ...
    const ccomplex_t IT_0224 = IT_0043*IT_0208;
    const ccomplex_t IT_0225 = IT_0047*IT_0210;
    const ccomplex_t IT_0226 = IT_0051*IT_0212;
    const ccomplex_t IT_0227 = IT_0054*IT_0214;
    const ccomplex_t IT_0228 = -IT_0224 + IT_0225 + IT_0226 + -IT_0227;
    const ccomplex_t IT_0229 = m_u*e_em*IT_0011*IT_0031*IT_0033*IT_0207;
    ...
    const ccomplex_t IT_0336 = m_u*s_13*m_N_1;
    const ccomplex_t IT_0337 = 12*IT_0096;
    const ccomplex_t IT_0338 = 24*IT_0186;
    const ccomplex_t IT_0339 = 24*IT_0156;
    const ccomplex_t IT_0340 = IT_0337 + IT_0338 + IT_0339;
    const ccomplex_t IT_0341 = 12*conj(IT_0096);
    const ccomplex_t IT_0342 = 24*conj(IT_0186);
    const ccomplex_t IT_0343 = 24*conj(IT_0156);
    const ccomplex_t IT_0344 = IT_0341 + IT_0342 + IT_0343;
    const ccomplex_t IT_0345 = 12*IT_0276;
    const ccomplex_t IT_0346 = 24*IT_0206;
    const ccomplex_t IT_0347 = IT_0345 + IT_0346;
    const ccomplex_t IT_0348 = 12*conj(IT_0276);
    const ccomplex_t IT_0349 = 24*conj(IT_0206);
    const ccomplex_t IT_0350 = IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = 6*IT_0276;
    const ccomplex_t IT_0352 = 12*IT_0206;
    const ccomplex_t IT_0353 = IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = 6*conj(IT_0276);
    const ccomplex_t IT_0355 = 12*conj(IT_0206);
    const ccomplex_t IT_0356 = IT_0354 + IT_0355;
    const ccomplex_t IT_0357 = 12*IT_0287;
    const ccomplex_t IT_0358 = 12*conj(IT_0287);
    const ccomplex_t IT_0359 = IT_0336*(conj(IT_0287)*IT_0331 + IT_0287
      *IT_0332 + conj(IT_0249)*IT_0340 + IT_0249*IT_0344 + IT_0312*IT_0347 +
       IT_0316*IT_0350 + conj(IT_0042)*IT_0353 + IT_0042*IT_0356 + IT_0304
      *IT_0357 + IT_0308*IT_0358);
    const ccomplex_t IT_0360 = m_u*s_14*m_N_1;
    const ccomplex_t IT_0361 = 12*IT_0176;
    const ccomplex_t IT_0362 = 24*IT_0154;
    const ccomplex_t IT_0363 = 24*IT_0185;
    const ccomplex_t IT_0364 = IT_0361 + IT_0362 + IT_0363;
    const ccomplex_t IT_0365 = 12*conj(IT_0176);
    const ccomplex_t IT_0366 = 24*conj(IT_0154);
    const ccomplex_t IT_0367 = 24*conj(IT_0185);
    const ccomplex_t IT_0368 = IT_0365 + IT_0366 + IT_0367;
    const ccomplex_t IT_0369 = 24*IT_0190;
    const ccomplex_t IT_0370 = 24*IT_0151;
    const ccomplex_t IT_0371 = IT_0369 + IT_0370;
    const ccomplex_t IT_0372 = 24*conj(IT_0190);
    const ccomplex_t IT_0373 = 24*conj(IT_0151);
    const ccomplex_t IT_0374 = IT_0372 + IT_0373;
    const ccomplex_t IT_0375 = 6*IT_0206;
    const ccomplex_t IT_0376 = IT_0345 + IT_0375;
    const ccomplex_t IT_0377 = 6*conj(IT_0206);
    const ccomplex_t IT_0378 = IT_0348 + IT_0377;
    const ccomplex_t IT_0379 = 12*IT_0249;
    const ccomplex_t IT_0380 = 12*conj(IT_0249);
    const ccomplex_t IT_0381 = conj(IT_0249)*IT_0333 + IT_0249*IT_0334 +
       IT_0320*IT_0352 + IT_0324*IT_0355 + conj(IT_0287)*IT_0364 + IT_0287
      *IT_0368 + conj(IT_0276)*IT_0371 + IT_0276*IT_0374 + conj(IT_0165)*IT_0376
       + IT_0165*IT_0378 + IT_0296*IT_0379 + IT_0300*IT_0380;
    const ccomplex_t IT_0382 = m_u*s_23*m_N_1;
    const ccomplex_t IT_0383 = 12*IT_0165;
    const ccomplex_t IT_0384 = 12*conj(IT_0165);
    const ccomplex_t IT_0385 = conj(IT_0165)*IT_0249 + IT_0165*conj(IT_0249) +
       4*IT_0296*(IT_0276 + 0.0416666666666667*IT_0352) + 4*IT_0300*(conj
      (IT_0276) + 0.0416666666666667*IT_0355) + 0.166666666666667*conj(IT_0176)
      *IT_0376 + 0.166666666666667*IT_0176*IT_0378 + 0.166666666666667*IT_0320
      *IT_0379 + 0.166666666666667*IT_0324*IT_0380 + 4*conj(IT_0287)*(IT_0324 +
       0.0416666666666667*IT_0383) + 4*IT_0287*(IT_0320 + 0.0416666666666667
      *IT_0384);
    const ccomplex_t IT_0386 = s_34*IT_0027;
    const ccomplex_t IT_0387 = IT_0371 + IT_0383;
    const ccomplex_t IT_0388 = 12*IT_0042;
    const ccomplex_t IT_0389 = 12*conj(IT_0042);
    const ccomplex_t IT_0390 = 24*IT_0145;
    const ccomplex_t IT_0391 = 24*conj(IT_0145);
    const ccomplex_t IT_0392 = conj(IT_0165)*IT_0331 + IT_0165*IT_0332 + conj
      (IT_0042)*IT_0333 + IT_0042*IT_0334 + IT_0320*IT_0337 + IT_0324*IT_0341 +
       conj(IT_0145)*(IT_0361 + IT_0362) + conj(IT_0189)*IT_0364 + IT_0145*
      (IT_0365 + IT_0366) + IT_0189*IT_0368 + IT_0308*(IT_0374 + IT_0384) +
       IT_0304*IT_0387 + IT_0296*IT_0388 + IT_0300*IT_0389 + conj(IT_0185)
      *IT_0390 + IT_0185*IT_0391;
    const ccomplex_t IT_0393 = -s_34;
    const ccomplex_t IT_0394 = IT_0026 + IT_0393;
    const ccomplex_t IT_0395 = s_12*IT_0394;
    const ccomplex_t IT_0396 = (-24)*IT_0078;
    const ccomplex_t IT_0397 = IT_0395*(24*conj(IT_0076)*IT_0078 + IT_0076*((
    ...
    const ccomplex_t IT_0402 = 48*IT_0154;
    const ccomplex_t IT_0403 = 24*IT_0176;
    const ccomplex_t IT_0404 = IT_0402 + IT_0403;
    const ccomplex_t IT_0405 = 48*IT_0151;
    const ccomplex_t IT_0406 = 24*IT_0165;
    const ccomplex_t IT_0407 = IT_0405 + IT_0406;
    const ccomplex_t IT_0408 = 48*conj(IT_0154);
    const ccomplex_t IT_0409 = 48*conj(IT_0151);
    const ccomplex_t IT_0410 = 48*IT_0190;
    const ccomplex_t IT_0411 = conj(IT_0276)*IT_0345 + conj(IT_0287)*IT_0357 +
       conj(IT_0176)*IT_0364 + conj(IT_0165)*IT_0387 + conj(IT_0185)*(48*IT_0185
       + IT_0402 + IT_0403) + conj(IT_0154)*IT_0404 + conj(IT_0151)*IT_0407 +
       IT_0185*IT_0408 + IT_0190*IT_0409 + conj(IT_0190)*(IT_0407 + IT_0410);
    const ccomplex_t IT_0412 = m_u*s_24*m_N_1;
    const ccomplex_t IT_0413 = 24*IT_0189;
    const ccomplex_t IT_0414 = IT_0390 + IT_0413;
    const ccomplex_t IT_0415 = IT_0388 + IT_0414;
    const ccomplex_t IT_0416 = 6*IT_0042;
    const ccomplex_t IT_0417 = 6*conj(IT_0042);
    const ccomplex_t IT_0418 = 24*conj(IT_0189);
    const ccomplex_t IT_0419 = IT_0304*IT_0347 + IT_0308*IT_0350 + conj
      (IT_0096)*IT_0353 + IT_0096*IT_0356 + IT_0312*IT_0357 + IT_0316*IT_0358 +
       conj(IT_0249)*IT_0415 + conj(IT_0287)*IT_0416 + IT_0287*IT_0417 + IT_0249
      *(24*conj(IT_0145) + IT_0389 + IT_0418);
    const ccomplex_t IT_0420 = conj(IT_0176)*IT_0331 + IT_0176*IT_0332 +
       IT_0296*IT_0337 + IT_0300*IT_0341 + IT_0304*IT_0364 + IT_0308*IT_0368 +
       IT_0312*IT_0383 + IT_0316*IT_0384 + IT_0320*(IT_0388 + IT_0390 + IT_0413)
       + conj(IT_0165)*IT_0416 + IT_0165*IT_0417 + IT_0324*(IT_0389 + IT_0391 +
       IT_0418);
    const ccomplex_t IT_0421 = IT_0026*IT_0027;
    const ccomplex_t IT_0422 = 48*IT_0156;
    const ccomplex_t IT_0423 = 24*IT_0096;
    const ccomplex_t IT_0424 = IT_0422 + IT_0423;
    const ccomplex_t IT_0425 = 48*conj(IT_0156);
    const ccomplex_t IT_0426 = 48*conj(IT_0145);
    const ccomplex_t IT_0427 = 48*IT_0145;
    const ccomplex_t IT_0428 = 48*IT_0189;
    const ccomplex_t IT_0429 = 48*IT_0186;
    const ccomplex_t IT_0430 = conj(IT_0042)*IT_0340 + IT_0042*IT_0344 + conj
      (IT_0249)*IT_0353 + IT_0249*IT_0356 + conj(IT_0165)*IT_0364 + IT_0165
      *IT_0368 + conj(IT_0176)*IT_0371 + conj(IT_0287)*IT_0376 + IT_0287*IT_0378
       + conj(IT_0190)*(48*IT_0185 + IT_0402 + IT_0403) + conj(IT_0151)*IT_0404 
      + IT_0324*IT_0408 + IT_0185*IT_0409 + conj(IT_0185)*(IT_0405 + IT_0410) +
       conj(IT_0096)*IT_0414 + conj(IT_0145)*IT_0424 + IT_0316*IT_0425 + IT_0186
      *IT_0426 + conj(IT_0186)*(IT_0427 + IT_0428) + conj(IT_0189)*(IT_0422 +
       IT_0423 + IT_0429);
    const ccomplex_t IT_0431 = 24*IT_0042;
    const ccomplex_t IT_0432 = IT_0427 + IT_0431;
    const ccomplex_t IT_0433 = conj(IT_0096)*IT_0340 + conj(IT_0206)*IT_0352 +
       conj(IT_0249)*IT_0379 + conj(IT_0042)*IT_0415 + conj(IT_0156)*IT_0424 +
       IT_0186*IT_0425 + IT_0189*IT_0426 + conj(IT_0186)*(IT_0422 + IT_0423 +
       IT_0429) + conj(IT_0145)*IT_0432 + conj(IT_0189)*(IT_0428 + IT_0432);
    const ccomplex_t IT_0434 = -IT_0196;
    const ccomplex_t IT_0435 = IT_0195 + IT_0197 + IT_0434;
    const ccomplex_t IT_0436 = 0.166666666666667*conj(IT_0276);
    const ccomplex_t IT_0437 = 6*conj(IT_0076);
    const ccomplex_t IT_0438 = (-6)*conj(IT_0078);
    const ccomplex_t IT_0439 = IT_0437 + IT_0438;
    const ccomplex_t IT_0440 = (-6)*IT_0078;
    const ccomplex_t IT_0441 = (-6)*conj(IT_0116);
    const ccomplex_t IT_0442 = 6*IT_0114;
    const ccomplex_t IT_0443 = (-6)*IT_0116;
    const ccomplex_t IT_0444 = IT_0442 + IT_0443;
    const ccomplex_t IT_0445 = 0.166666666666667*conj(IT_0287);
    const ccomplex_t IT_0446 = IT_0027*IT_0394;
    const ccomplex_t IT_0447 = 6*conj(IT_0078);
    const ccomplex_t IT_0448 = (-6)*conj(IT_0076);
    const ccomplex_t IT_0449 = IT_0447 + IT_0448;
    const ccomplex_t IT_0450 = 6*conj(IT_0116);
    const ccomplex_t IT_0451 = (-6)*conj(IT_0114);
    const ccomplex_t IT_0452 = IT_0450 + IT_0451;
    const ccomplex_t IT_0453 = 6*IT_0116;
    const ccomplex_t IT_0454 = (-6)*IT_0114;
    const ccomplex_t IT_0455 = IT_0453 + IT_0454;
    const ccomplex_t IT_0456 = 6*IT_0078;
    const ccomplex_t IT_0457 = (conj(IT_0076) + -conj(IT_0078))*(IT_0114 + 
      -IT_0116) + IT_0078*conj(IT_0116) + IT_0076*(conj(IT_0114) + -conj(IT_0116
      ) + 1./4*conj(IT_0249) + -1./4*conj(IT_0287)) + 0.25*conj(IT_0114)*
      (IT_0206 + 0.166666666666667*IT_0396) + 0.0416666666666667*IT_0249*IT_0439
       + 0.0416666666666667*conj(IT_0249)*IT_0440 + 0.0416666666666667*IT_0206
      *IT_0441 + 0.0416666666666667*conj(IT_0206)*IT_0444 + 0.0416666666666667
      *IT_0287*IT_0449 + 0.0416666666666667*IT_0276*IT_0452 + 0.25*IT_0436
      *IT_0455 + 0.25*IT_0445*IT_0456;
    const ccomplex_t IT_0458 = (-0.166666666666667)*IT_0249;
    const ccomplex_t IT_0459 = (-0.166666666666667)*conj(IT_0249);
    const ccomplex_t IT_0460 = IT_0027*IT_0398;
    const ccomplex_t IT_0461 = IT_0282*IT_0287 + IT_0279*conj(IT_0287) + (-6)
      *conj(IT_0264)*(IT_0206 + 4*IT_0235 + (-4)*IT_0237 + (-0.166666666666667)
      *IT_0351) + (-6)*IT_0264*(conj(IT_0206) + 4*conj(IT_0235) + (-4)*conj
      (IT_0237) + (-0.166666666666667)*IT_0354) + 24*conj(IT_0262)*(IT_0235 + 
      -1./4*IT_0276 + 0.0416666666666667*IT_0375 + 0.0416666666666667*IT_0400) +
       24*IT_0262*(conj(IT_0235) + -1./4*conj(IT_0276) + 0.0416666666666667
      *IT_0377 + 0.0416666666666667*IT_0401) + (-6)*IT_0242*IT_0458 + (-6)
      *IT_0239*IT_0459;
    const ccomplex_t IT_0462 = IT_0004*(conj(IT_0042)*IT_0080 + IT_0042
      ...
      *IT_0328 + IT_0330*IT_0335 + IT_0359 + IT_0360*IT_0381 + 6*IT_0382*IT_0385
       + IT_0386*IT_0392 + IT_0397 + IT_0399*(24*IT_0237*conj(IT_0237) + IT_0264
      *((-24)*conj(IT_0262) + 24*conj(IT_0264)) + IT_0262*(24*conj(IT_0262) + (
      -24)*conj(IT_0264)) + conj(IT_0235)*IT_0400 + IT_0235*(24*conj(IT_0235) +
       IT_0401)) + IT_0197*IT_0411 + IT_0412*IT_0419 + IT_0194*IT_0420 + IT_0421
      *IT_0430 + IT_0195*IT_0433 + 6*IT_0435*(conj(IT_0249)*IT_0287 + IT_0249
      *conj(IT_0287) + 0.166666666666667*IT_0276*IT_0377 + IT_0375*IT_0436) + 
      (IT_0194 + IT_0195 + IT_0198 + IT_0434)*(IT_0276*IT_0439 + 6*conj(IT_0276)
      *(IT_0076 + 0.166666666666667*IT_0440) + 6*IT_0287*(conj(IT_0114) +
       0.166666666666667*IT_0441) + 6*IT_0444*IT_0445) + 24*IT_0446*IT_0457 + 
      (IT_0194 + IT_0197 + IT_0270 + IT_0434)*(IT_0206*IT_0449 + (-6)*conj
      (IT_0206)*(IT_0076 + (-0.166666666666667)*IT_0456) + (-6)*IT_0452*IT_0458 
      + (-6)*IT_0455*IT_0459) + IT_0460*IT_0461;
