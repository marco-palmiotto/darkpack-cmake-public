        ...
        )
{
    ...
    const ccomplex_t IT_0068 = (-0.5)*IT_0032 + -IT_0045 + IT_0064 + 0.5
      *IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_13 + IT_0000 + IT_0046 + -m_N_4*
    ...
    const ccomplex_t IT_0092 = IT_0005*IT_0080;
    const ccomplex_t IT_0093 = IT_0009*IT_0071;
    const ccomplex_t IT_0094 = IT_0005*IT_0084;
    const ccomplex_t IT_0095 = IT_0009*IT_0075;
    const ccomplex_t IT_0096 = IT_0092 + IT_0093 + IT_0094 + IT_0095;
    const ccomplex_t IT_0097 = IT_0014*IT_0073;
    const ccomplex_t IT_0098 = IT_0017*IT_0082;
    const ccomplex_t IT_0099 = IT_0014*IT_0077;
    const ccomplex_t IT_0100 = IT_0017*IT_0086;
    ...
    const ccomplex_t IT_0107 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0108 = IT_0005*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0110 = IT_0009*IT_0109;
    const ccomplex_t IT_0111 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0112 = IT_0005*IT_0111;
    const ccomplex_t IT_0113 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0114 = IT_0009*IT_0113;
    const ccomplex_t IT_0115 = IT_0108 + IT_0110 + IT_0112 + IT_0114;
    const ccomplex_t IT_0116 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0117 = IT_0014*IT_0116;
    const ccomplex_t IT_0118 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0119 = IT_0017*IT_0118;
    const ccomplex_t IT_0120 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0121 = IT_0014*IT_0120;
    const ccomplex_t IT_0122 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0129 = m_N_1*IT_0128;
    const ccomplex_t IT_0130 = IT_0106 + IT_0129;
    const ccomplex_t IT_0131 = IT_0070*IT_0130;
    const ccomplex_t IT_0132 = IT_0005*IT_0053;
    const ccomplex_t IT_0133 = IT_0009*IT_0051;
    const ccomplex_t IT_0134 = IT_0014*IT_0057;
    const ccomplex_t IT_0135 = IT_0017*IT_0055;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*(IT_0132 + -IT_0133 + 
      -IT_0134 + IT_0135);
    const ccomplex_t IT_0137 = IT_0060*IT_0136;
    const ccomplex_t IT_0138 = m_N_1*IT_0137;
    const ccomplex_t IT_0139 = IT_0038*IT_0136;
    const ccomplex_t IT_0140 = m_N_1*IT_0139;
    const ccomplex_t IT_0141 = IT_0138 + IT_0140;
    const ccomplex_t IT_0142 = IT_0066*IT_0141;
    const ccomplex_t IT_0143 = IT_0031*IT_0136;
    const ccomplex_t IT_0144 = cpow((-2)*s_13 + IT_0000 + IT_0046 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*IT_0144;
    const ccomplex_t IT_0146 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0147 = IT_0005*IT_0146;
    const ccomplex_t IT_0148 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0149 = IT_0017*IT_0148;
    const ccomplex_t IT_0150 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0151 = IT_0005*IT_0150;
    const ccomplex_t IT_0152 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0153 = IT_0017*IT_0152;
    const ccomplex_t IT_0154 = IT_0147 + IT_0149 + IT_0151 + IT_0153;
    const ccomplex_t IT_0155 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0156 = IT_0009*IT_0155;
    const ccomplex_t IT_0157 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0158 = IT_0014*IT_0157;
    const ccomplex_t IT_0159 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0160 = IT_0009*IT_0159;
    ...
    const ccomplex_t IT_0167 = IT_0005*IT_0155;
    const ccomplex_t IT_0168 = IT_0009*IT_0146;
    const ccomplex_t IT_0169 = IT_0005*IT_0159;
    const ccomplex_t IT_0170 = IT_0009*IT_0150;
    const ccomplex_t IT_0171 = IT_0167 + IT_0168 + IT_0169 + IT_0170;
    const ccomplex_t IT_0172 = IT_0014*IT_0148;
    const ccomplex_t IT_0173 = IT_0017*IT_0157;
    const ccomplex_t IT_0174 = IT_0014*IT_0152;
    const ccomplex_t IT_0175 = IT_0017*IT_0161;
    const ccomplex_t IT_0176 = -IT_0172 + -IT_0173 + -IT_0174 + -IT_0175;
    const ccomplex_t IT_0177 = IT_0171 + IT_0176;
    ...
    const ccomplex_t IT_0203 = IT_0166*IT_0202;
    const ccomplex_t IT_0204 = m_N_1*IT_0203;
    const ccomplex_t IT_0205 = IT_0181 + IT_0204;
    const ccomplex_t IT_0206 = IT_0145*IT_0205;
    const ccomplex_t IT_0207 = cpow((-2)*s_23 + IT_0000 + IT_0046 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*IT_0207;
    const ccomplex_t IT_0209 = IT_0205*IT_0208;
    const ccomplex_t IT_0210 = cpow((-2)*s_13 + IT_0000 + IT_0046 + -m_N_3*
    ...
    const ccomplex_t IT_0215 = IT_0017*IT_0214;
    const ccomplex_t IT_0216 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0217 = IT_0005*IT_0216;
    ...
    const ccomplex_t IT_0233 = IT_0005*IT_0221;
    const ccomplex_t IT_0234 = IT_0009*IT_0212;
    const ccomplex_t IT_0235 = IT_0005*IT_0225;
    const ccomplex_t IT_0236 = IT_0009*IT_0216;
    const ccomplex_t IT_0237 = IT_0233 + IT_0234 + IT_0235 + IT_0236;
    const ccomplex_t IT_0238 = IT_0014*IT_0214;
    const ccomplex_t IT_0239 = IT_0017*IT_0223;
    const ccomplex_t IT_0240 = IT_0014*IT_0218;
    const ccomplex_t IT_0241 = IT_0017*IT_0227;
    ...
    const ccomplex_t IT_0246 = IT_0232*IT_0245;
    const ccomplex_t IT_0247 = m_N_3*IT_0246;
    const ccomplex_t IT_0248 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0249 = IT_0005*IT_0248;
    const ccomplex_t IT_0250 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0257 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0258 = IT_0014*IT_0257;
    const ccomplex_t IT_0259 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0260 = IT_0017*IT_0259;
    const ccomplex_t IT_0261 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0262 = IT_0014*IT_0261;
    const ccomplex_t IT_0263 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0270 = m_N_1*IT_0269;
    const ccomplex_t IT_0271 = IT_0247 + IT_0270;
    const ccomplex_t IT_0272 = IT_0211*IT_0271;
    const ccomplex_t IT_0273 = cpow((-2)*s_23 + IT_0000 + IT_0046 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    ...
    const ccomplex_t IT_0278 = IT_0130*IT_0277;
    const ccomplex_t IT_0279 = -IT_0131 + (-0.5)*IT_0142 + 0.5*IT_0143 + 
      -IT_0206 + -IT_0209 + -IT_0272 + -IT_0275 + -IT_0278;
    const ccomplex_t IT_0280 = 2*IT_0279;
    const ccomplex_t IT_0281 = IT_0044*IT_0060;
    const ccomplex_t IT_0282 = IT_0048*IT_0141;
    const ccomplex_t IT_0283 = 0.5*IT_0142 + (-0.5)*IT_0143 + -IT_0281 +
       IT_0282;
    ...
    const ccomplex_t IT_0289 = IT_0005*IT_0184;
    const ccomplex_t IT_0290 = IT_0017*IT_0191;
    const ccomplex_t IT_0291 = IT_0005*IT_0188;
    const ccomplex_t IT_0292 = IT_0017*IT_0195;
    const ccomplex_t IT_0293 = IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = IT_0009*IT_0182;
    const ccomplex_t IT_0295 = IT_0014*IT_0193;
    const ccomplex_t IT_0296 = IT_0009*IT_0186;
    const ccomplex_t IT_0297 = IT_0014*IT_0197;
    ...
    const ccomplex_t IT_0302 = IT_0179*IT_0301;
    const ccomplex_t IT_0303 = m_N_1*IT_0302;
    const ccomplex_t IT_0304 = IT_0202*IT_0301;
    const ccomplex_t IT_0305 = m_N_2*IT_0304;
    const ccomplex_t IT_0306 = IT_0303 + IT_0305;
    const ccomplex_t IT_0307 = IT_0208*IT_0306;
    const ccomplex_t IT_0308 = IT_0005*IT_0250;
    const ccomplex_t IT_0309 = IT_0017*IT_0257;
    const ccomplex_t IT_0310 = IT_0005*IT_0254;
    const ccomplex_t IT_0311 = IT_0017*IT_0261;
    const ccomplex_t IT_0312 = IT_0308 + IT_0309 + IT_0310 + IT_0311;
    const ccomplex_t IT_0313 = IT_0009*IT_0248;
    const ccomplex_t IT_0314 = IT_0014*IT_0259;
    const ccomplex_t IT_0315 = IT_0009*IT_0252;
    const ccomplex_t IT_0316 = IT_0014*IT_0263;
    ...
    const ccomplex_t IT_0323 = IT_0268*IT_0320;
    const ccomplex_t IT_0324 = m_N_3*IT_0323;
    const ccomplex_t IT_0325 = IT_0322 + IT_0324;
    const ccomplex_t IT_0326 = IT_0211*IT_0325;
    const ccomplex_t IT_0327 = IT_0145*IT_0306;
    const ccomplex_t IT_0328 = IT_0274*IT_0325;
    const ccomplex_t IT_0329 = IT_0005*IT_0109;
    const ccomplex_t IT_0330 = IT_0017*IT_0116;
    const ccomplex_t IT_0331 = IT_0005*IT_0113;
    const ccomplex_t IT_0332 = IT_0017*IT_0120;
    const ccomplex_t IT_0333 = IT_0329 + IT_0330 + IT_0331 + IT_0332;
    const ccomplex_t IT_0334 = IT_0009*IT_0107;
    const ccomplex_t IT_0335 = IT_0014*IT_0118;
    const ccomplex_t IT_0336 = IT_0009*IT_0111;
    const ccomplex_t IT_0337 = IT_0014*IT_0122;
    ...
    const ccomplex_t IT_0342 = IT_0104*IT_0341;
    const ccomplex_t IT_0343 = m_N_1*IT_0342;
    const ccomplex_t IT_0344 = IT_0127*IT_0341;
    ...
    const ccomplex_t IT_0349 = 0.5*IT_0032 + (-0.5)*IT_0067 + -IT_0307 + 
      -IT_0326 + -IT_0327 + -IT_0328 + -IT_0347 + -IT_0348;
    ...
    const ccomplex_t IT_0359 = IT_0145*IT_0302;
    const ccomplex_t IT_0360 = IT_0269*IT_0274;
    const ccomplex_t IT_0361 = IT_0070*IT_0342;
    const ccomplex_t IT_0362 = IT_0066*IT_0139;
    const ccomplex_t IT_0363 = IT_0203*IT_0208;
    const ccomplex_t IT_0364 = IT_0211*IT_0321;
    const ccomplex_t IT_0365 = IT_0128*IT_0277;
    const ccomplex_t IT_0366 = IT_0359 + -IT_0360 + IT_0361 + (-0.5)*IT_0362 +
       -IT_0363 + IT_0364 + -IT_0365;
    const ccomplex_t IT_0367 = IT_0048*IT_0061;
    const ccomplex_t IT_0368 = (-0.5)*IT_0362 + IT_0367;
    const ccomplex_t IT_0369 = conj(IT_0366) + conj(IT_0368);
    const ccomplex_t IT_0370 = IT_0366 + IT_0368;
    const ccomplex_t IT_0371 = IT_0061*IT_0066;
    const ccomplex_t IT_0372 = IT_0145*IT_0203;
    const ccomplex_t IT_0373 = IT_0208*IT_0302;
    const ccomplex_t IT_0374 = IT_0211*IT_0269;
    const ccomplex_t IT_0375 = IT_0274*IT_0321;
    const ccomplex_t IT_0376 = IT_0070*IT_0128;
    const ccomplex_t IT_0377 = IT_0277*IT_0342;
    const ccomplex_t IT_0378 = (-0.5)*IT_0371 + IT_0372 + -IT_0373 + IT_0374 +
       -IT_0375 + IT_0376 + -IT_0377;
    const ccomplex_t IT_0379 = IT_0048*IT_0139;
    const ccomplex_t IT_0380 = (-0.5)*IT_0371 + IT_0379;
    ...
    const ccomplex_t IT_0396 = (-2)*IT_0366;
    const ccomplex_t IT_0397 = (-2)*conj(IT_0366);
    const ccomplex_t IT_0398 = (-2)*IT_0378;
    const ccomplex_t IT_0399 = (-2)*conj(IT_0378);
    ...
    const ccomplex_t IT_0402 = IT_0000*(conj(IT_0068)*IT_0285 + IT_0068
      ...
      *IT_0398 + IT_0380*IT_0399 + conj(IT_0380)*IT_0400) + (conj(IT_0378)
