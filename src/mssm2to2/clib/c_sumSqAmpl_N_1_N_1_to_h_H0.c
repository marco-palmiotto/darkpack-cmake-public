        ...
        )
{
    ...
    const ccomplex_t IT_0033 = IT_0005*IT_0007;
    const ccomplex_t IT_0034 = IT_0001*IT_0009;
    const ccomplex_t IT_0035 = IT_0014*IT_0016;
    const ccomplex_t IT_0036 = IT_0011*IT_0017;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*(IT_0033 + IT_0034 + 
      -IT_0035 + -IT_0036);
    const ccomplex_t IT_0038 = -IT_0037;
    const ccomplex_t IT_0039 = cpow(IT_0002, 2);
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_W*e_em*IT_0022*(IT_0024
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0046 + (0 + _Complex_I*1)
      *m_N_1*Gamma_o1 + reg_prop, -1);
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*IT_0047;
    const ccomplex_t IT_0049 = IT_0019*IT_0038;
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0046 + (0 + _Complex_I*1)
      *m_N_1*Gamma_o1 + reg_prop, -1);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*IT_0065;
    const ccomplex_t IT_0067 = IT_0063*IT_0066;
    const ccomplex_t IT_0068 = (-0.5)*IT_0032 + -IT_0045 + IT_0064 + 0.5
      *IT_0067;
    const ccomplex_t IT_0069 = IT_0005*IT_0053;
    const ccomplex_t IT_0070 = IT_0009*IT_0051;
    const ccomplex_t IT_0071 = IT_0014*IT_0057;
    const ccomplex_t IT_0072 = IT_0017*IT_0055;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*(IT_0069 + -IT_0070 + 
      -IT_0071 + IT_0072);
    const ccomplex_t IT_0074 = IT_0031*IT_0073;
    const ccomplex_t IT_0075 = IT_0038*IT_0073;
    const ccomplex_t IT_0076 = m_N_1*IT_0075;
    const ccomplex_t IT_0077 = IT_0060*IT_0073;
    const ccomplex_t IT_0078 = m_N_1*IT_0077;
    const ccomplex_t IT_0079 = IT_0076 + IT_0078;
    const ccomplex_t IT_0080 = IT_0066*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0000 + IT_0046 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0084 = IT_0005*IT_0083;
    const ccomplex_t IT_0085 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0086 = IT_0017*IT_0085;
    const ccomplex_t IT_0087 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0088 = IT_0005*IT_0087;
    const ccomplex_t IT_0089 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0090 = IT_0017*IT_0089;
    const ccomplex_t IT_0091 = IT_0084 + IT_0086 + IT_0088 + IT_0090;
    const ccomplex_t IT_0092 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0093 = IT_0009*IT_0092;
    const ccomplex_t IT_0094 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0095 = IT_0014*IT_0094;
    const ccomplex_t IT_0096 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0097 = IT_0009*IT_0096;
    const ccomplex_t IT_0098 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0104 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0105 = IT_0005*IT_0104;
    const ccomplex_t IT_0106 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0107 = IT_0009*IT_0106;
    const ccomplex_t IT_0108 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0109 = IT_0005*IT_0108;
    const ccomplex_t IT_0110 = conj(N_B2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0115 = conj(N_W1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0125 = IT_0103*IT_0124;
    const ccomplex_t IT_0126 = m_N_1*IT_0125;
    const ccomplex_t IT_0127 = IT_0005*IT_0092;
    const ccomplex_t IT_0128 = IT_0009*IT_0083;
    const ccomplex_t IT_0129 = IT_0005*IT_0096;
    const ccomplex_t IT_0130 = IT_0009*IT_0087;
    const ccomplex_t IT_0131 = IT_0127 + IT_0128 + IT_0129 + IT_0130;
    const ccomplex_t IT_0132 = IT_0014*IT_0085;
    const ccomplex_t IT_0133 = IT_0017*IT_0094;
    const ccomplex_t IT_0134 = IT_0014*IT_0089;
    const ccomplex_t IT_0135 = IT_0017*IT_0098;
    ...
    const ccomplex_t IT_0170 = IT_0005*IT_0158;
    const ccomplex_t IT_0171 = IT_0009*IT_0149;
    const ccomplex_t IT_0172 = IT_0005*IT_0162;
    const ccomplex_t IT_0173 = IT_0009*IT_0153;
    const ccomplex_t IT_0174 = IT_0170 + IT_0171 + IT_0172 + IT_0173;
    const ccomplex_t IT_0175 = IT_0014*IT_0151;
    const ccomplex_t IT_0176 = IT_0017*IT_0160;
    const ccomplex_t IT_0177 = IT_0014*IT_0155;
    const ccomplex_t IT_0178 = IT_0017*IT_0164;
    ...
    const ccomplex_t IT_0185 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0186 = IT_0005*IT_0185;
    const ccomplex_t IT_0187 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0188 = IT_0009*IT_0187;
    const ccomplex_t IT_0189 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0190 = IT_0005*IT_0189;
    const ccomplex_t IT_0191 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0192 = IT_0009*IT_0191;
    const ccomplex_t IT_0193 = IT_0186 + IT_0188 + IT_0190 + IT_0192;
    const ccomplex_t IT_0194 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0195 = IT_0014*IT_0194;
    const ccomplex_t IT_0196 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0197 = IT_0017*IT_0196;
    const ccomplex_t IT_0198 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0199 = IT_0014*IT_0198;
    const ccomplex_t IT_0200 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0209 = IT_0148*IT_0208;
    const ccomplex_t IT_0210 = cpow((-2)*s_23 + IT_0000 + IT_0046 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0211 = (0 + _Complex_I*1)*IT_0210;
    const ccomplex_t IT_0212 = IT_0208*IT_0211;
    const ccomplex_t IT_0213 = cpow((-2)*s_13 + IT_0000 + IT_0046 + -m_N_4*
    ...
    const ccomplex_t IT_0226 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0227 = IT_0017*IT_0226;
    const ccomplex_t IT_0228 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0229 = IT_0014*IT_0228;
    const ccomplex_t IT_0230 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0236 = IT_0005*IT_0217;
    const ccomplex_t IT_0237 = IT_0017*IT_0224;
    const ccomplex_t IT_0238 = IT_0005*IT_0221;
    const ccomplex_t IT_0239 = IT_0017*IT_0228;
    const ccomplex_t IT_0240 = IT_0236 + IT_0237 + IT_0238 + IT_0239;
    const ccomplex_t IT_0241 = IT_0009*IT_0215;
    const ccomplex_t IT_0242 = IT_0014*IT_0226;
    const ccomplex_t IT_0243 = IT_0009*IT_0219;
    const ccomplex_t IT_0244 = IT_0014*IT_0230;
    ...
    const ccomplex_t IT_0251 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0252 = IT_0005*IT_0251;
    const ccomplex_t IT_0253 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0254 = IT_0009*IT_0253;
    const ccomplex_t IT_0255 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0256 = IT_0005*IT_0255;
    const ccomplex_t IT_0257 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0262 = conj(N_W1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0266 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0272 = IT_0248*IT_0271;
    const ccomplex_t IT_0273 = m_N_1*IT_0272;
    const ccomplex_t IT_0274 = IT_0250 + IT_0273;
    const ccomplex_t IT_0275 = IT_0214*IT_0274;
    const ccomplex_t IT_0276 = cpow((-2)*s_23 + IT_0000 + IT_0046 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0277 = (0 + _Complex_I*1)*IT_0276;
    const ccomplex_t IT_0278 = IT_0274*IT_0277;
    const ccomplex_t IT_0279 = 0.5*IT_0074 + (-0.5)*IT_0080 + -IT_0143 + 
      -IT_0146 + -IT_0209 + -IT_0212 + -IT_0275 + -IT_0278;
    const ccomplex_t IT_0280 = 2*IT_0279;
    const ccomplex_t IT_0281 = IT_0044*IT_0060;
    const ccomplex_t IT_0282 = IT_0048*IT_0079;
    const ccomplex_t IT_0283 = (-0.5)*IT_0074 + 0.5*IT_0080 + -IT_0281 +
       IT_0282;
    ...
    const ccomplex_t IT_0289 = IT_0005*IT_0187;
    const ccomplex_t IT_0290 = IT_0017*IT_0194;
    const ccomplex_t IT_0291 = IT_0005*IT_0191;
    const ccomplex_t IT_0292 = IT_0017*IT_0198;
    const ccomplex_t IT_0293 = IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = IT_0009*IT_0185;
    const ccomplex_t IT_0295 = IT_0014*IT_0196;
    const ccomplex_t IT_0296 = IT_0009*IT_0189;
    const ccomplex_t IT_0297 = IT_0014*IT_0200;
    ...
    const ccomplex_t IT_0302 = IT_0182*IT_0301;
    const ccomplex_t IT_0303 = m_N_1*IT_0302;
    const ccomplex_t IT_0304 = IT_0205*IT_0301;
    const ccomplex_t IT_0305 = m_N_3*IT_0304;
    const ccomplex_t IT_0306 = IT_0303 + IT_0305;
    const ccomplex_t IT_0307 = IT_0148*IT_0306;
    const ccomplex_t IT_0308 = IT_0211*IT_0306;
    const ccomplex_t IT_0309 = IT_0005*IT_0106;
    const ccomplex_t IT_0310 = IT_0017*IT_0113;
    const ccomplex_t IT_0311 = IT_0005*IT_0110;
    const ccomplex_t IT_0312 = IT_0017*IT_0117;
    const ccomplex_t IT_0313 = IT_0309 + IT_0310 + IT_0311 + IT_0312;
    const ccomplex_t IT_0314 = IT_0009*IT_0104;
    const ccomplex_t IT_0315 = IT_0014*IT_0115;
    const ccomplex_t IT_0316 = IT_0009*IT_0108;
    const ccomplex_t IT_0317 = IT_0014*IT_0119;
    ...
    const ccomplex_t IT_0322 = IT_0139*IT_0321;
    const ccomplex_t IT_0323 = m_N_1*IT_0322;
    const ccomplex_t IT_0324 = IT_0124*IT_0321;
    const ccomplex_t IT_0325 = m_N_2*IT_0324;
    const ccomplex_t IT_0326 = IT_0323 + IT_0325;
    const ccomplex_t IT_0327 = IT_0082*IT_0326;
    const ccomplex_t IT_0328 = IT_0145*IT_0326;
    const ccomplex_t IT_0329 = IT_0005*IT_0253;
    const ccomplex_t IT_0330 = IT_0017*IT_0260;
    const ccomplex_t IT_0331 = IT_0005*IT_0257;
    const ccomplex_t IT_0332 = IT_0017*IT_0264;
    const ccomplex_t IT_0333 = IT_0329 + IT_0330 + IT_0331 + IT_0332;
    const ccomplex_t IT_0334 = IT_0009*IT_0251;
    const ccomplex_t IT_0335 = IT_0014*IT_0262;
    const ccomplex_t IT_0336 = IT_0009*IT_0255;
    const ccomplex_t IT_0337 = IT_0014*IT_0266;
    ...
    const ccomplex_t IT_0342 = IT_0235*IT_0341;
    const ccomplex_t IT_0343 = m_N_1*IT_0342;
    const ccomplex_t IT_0344 = IT_0271*IT_0341;
    const ccomplex_t IT_0345 = m_N_4*IT_0344;
    const ccomplex_t IT_0346 = IT_0343 + IT_0345;
    const ccomplex_t IT_0347 = IT_0214*IT_0346;
    const ccomplex_t IT_0348 = IT_0277*IT_0346;
    const ccomplex_t IT_0349 = 0.5*IT_0032 + (-0.5)*IT_0067 + -IT_0307 + 
    ...
    const ccomplex_t IT_0359 = IT_0066*IT_0075;
    const ccomplex_t IT_0360 = IT_0082*IT_0322;
    const ccomplex_t IT_0361 = IT_0125*IT_0145;
    const ccomplex_t IT_0362 = IT_0148*IT_0302;
    const ccomplex_t IT_0363 = IT_0206*IT_0211;
    const ccomplex_t IT_0364 = IT_0214*IT_0342;
    const ccomplex_t IT_0365 = IT_0272*IT_0277;
    const ccomplex_t IT_0366 = (-0.5)*IT_0359 + IT_0360 + -IT_0361 + IT_0362 +
       -IT_0363 + IT_0364 + -IT_0365;
    const ccomplex_t IT_0367 = IT_0048*IT_0061;
    const ccomplex_t IT_0368 = (-0.5)*IT_0359 + IT_0367;
    const ccomplex_t IT_0369 = conj(IT_0366) + conj(IT_0368);
    const ccomplex_t IT_0370 = IT_0061*IT_0066;
    const ccomplex_t IT_0371 = IT_0277*IT_0342;
    const ccomplex_t IT_0372 = IT_0082*IT_0125;
    const ccomplex_t IT_0373 = IT_0145*IT_0322;
    const ccomplex_t IT_0374 = IT_0148*IT_0206;
    const ccomplex_t IT_0375 = IT_0211*IT_0302;
    const ccomplex_t IT_0376 = IT_0214*IT_0272;
    const ccomplex_t IT_0377 = (-0.5)*IT_0370 + -IT_0371 + IT_0372 + -IT_0373 
      + IT_0374 + -IT_0375 + IT_0376;
    const ccomplex_t IT_0378 = IT_0048*IT_0075;
    const ccomplex_t IT_0379 = (-0.5)*IT_0370 + IT_0378;
    const ccomplex_t IT_0380 = conj(IT_0377) + conj(IT_0379);
    const ccomplex_t IT_0381 = 2*IT_0068;
    const ccomplex_t IT_0382 = (-2)*IT_0349;
    const ccomplex_t IT_0383 = IT_0377 + IT_0379;
    const ccomplex_t IT_0384 = 2*conj(IT_0068);
    const ccomplex_t IT_0385 = (-2)*conj(IT_0349);
    const ccomplex_t IT_0386 = s_23*m_N_1;
    const ccomplex_t IT_0387 = 2*IT_0349;
    const ccomplex_t IT_0388 = (-2)*IT_0068;
    const ccomplex_t IT_0389 = 2*conj(IT_0349);
    const ccomplex_t IT_0390 = (-2)*conj(IT_0068);
    const ccomplex_t IT_0391 = s_12*IT_0046;
    const ccomplex_t IT_0392 = s_13*s_23;
    const ccomplex_t IT_0393 = (-2)*IT_0392;
    const ccomplex_t IT_0394 = IT_0391 + IT_0393;
    const ccomplex_t IT_0395 = (-2)*IT_0366;
    const ccomplex_t IT_0396 = (-2)*conj(IT_0366);
    const ccomplex_t IT_0397 = (-2)*IT_0377;
    const ccomplex_t IT_0398 = (-2)*conj(IT_0377);
    const ccomplex_t IT_0399 = (-2)*IT_0379;
    const ccomplex_t IT_0400 = IT_0000*IT_0046;
    const ccomplex_t IT_0401 = IT_0000*(conj(IT_0068)*IT_0285 + IT_0068
      *IT_0288 + conj(IT_0349)*IT_0352 + IT_0349*IT_0355) + (IT_0068*conj
      ...
      (IT_0068)*IT_0349 + IT_0068*conj(IT_0349))*IT_0357 + IT_0358*(IT_0355*
      (IT_0366 + IT_0368) + IT_0352*IT_0369 + IT_0380*(IT_0381 + IT_0382) +
       IT_0383*(IT_0384 + IT_0385)) + IT_0386*(IT_0285*IT_0380 + IT_0288*IT_0383
       + IT_0369*(IT_0387 + IT_0388) + (IT_0366 + IT_0368)*(IT_0389 + IT_0390)) 
      + IT_0394*(IT_0369*IT_0395 + (-2)*IT_0368*(conj(IT_0368) + (-0.5)*IT_0396)
       + IT_0380*IT_0397 + IT_0379*IT_0398 + conj(IT_0379)*IT_0399) + (conj
      (IT_0377)*IT_0395 + (-2)*conj(IT_0379)*(IT_0368 + (-0.5)*IT_0395) +
       IT_0383*IT_0396 + IT_0368*IT_0398 + conj(IT_0368)*(IT_0397 + IT_0399))
      *IT_0400;
