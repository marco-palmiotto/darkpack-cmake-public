        ...
        )
{
    ...
    const ccomplex_t IT_0010 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0019 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0026 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0027 = IT_0008*IT_0026;
    const ccomplex_t IT_0028 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0029 = IT_0012*IT_0028;
    const ccomplex_t IT_0030 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0031 = IT_0017*IT_0030;
    const ccomplex_t IT_0032 = N_W1*N_d1*e_em;
    ...
    const ccomplex_t IT_0037 = m_N_1*IT_0036;
    const ccomplex_t IT_0038 = IT_0025 + IT_0037;
    const ccomplex_t IT_0039 = IT_0003*IT_0038;
    const ccomplex_t IT_0040 = cpow(IT_0006, -2);
    const ccomplex_t IT_0041 = IT_0015*IT_0040;
    const ccomplex_t IT_0042 = IT_0016 + IT_0041;
    const ccomplex_t IT_0043 = cos(beta);
    const ccomplex_t IT_0044 = cpow(IT_0011, 3);
    const ccomplex_t IT_0045 = sin(beta);
    const ccomplex_t IT_0046 = cpow(IT_0011, 2);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_W*e_em*IT_0042*(IT_0043
      *IT_0044 + -IT_0005*(IT_0005*(IT_0011*IT_0043 + IT_0005*IT_0045) + 
      -IT_0045*IT_0046));
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0001 + (0 + _Complex_I*1)
      *m_N_1*Gamma_o1 + reg_prop, -1);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = IT_0038*IT_0054;
    const ccomplex_t IT_0056 = IT_0008*IT_0010;
    const ccomplex_t IT_0057 = IT_0004*IT_0012;
    const ccomplex_t IT_0058 = IT_0017*IT_0019;
    const ccomplex_t IT_0059 = IT_0014*IT_0020;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*(IT_0056 + -IT_0057 + 
      -IT_0058 + IT_0059);
    const ccomplex_t IT_0061 = cpow(IT_0005, 2);
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*m_W*e_em*IT_0042*(IT_0044
      *IT_0045 + (-5)*IT_0005*(IT_0005*IT_0011*IT_0045 + 1*IT_0043*(IT_0046 + 
      -1./5*IT_0061)));
    ...
    const ccomplex_t IT_0068 = IT_0039 + (-0.5)*IT_0052 + IT_0055 + (-0.5)
      *IT_0067;
    const ccomplex_t IT_0069 = IT_0035*IT_0051;
    const ccomplex_t IT_0070 = IT_0008*IT_0028;
    const ccomplex_t IT_0071 = IT_0012*IT_0026;
    const ccomplex_t IT_0072 = IT_0017*IT_0032;
    const ccomplex_t IT_0073 = IT_0020*IT_0030;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*(IT_0070 + -IT_0071 + 
      -IT_0072 + IT_0073);
    const ccomplex_t IT_0075 = IT_0066*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0079 = IT_0008*IT_0078;
    const ccomplex_t IT_0080 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0081 = IT_0012*IT_0080;
    const ccomplex_t IT_0082 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0083 = IT_0008*IT_0082;
    const ccomplex_t IT_0084 = N_B1*N_d2*e_em;
    ...
    const ccomplex_t IT_0091 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0092 = IT_0017*IT_0091;
    const ccomplex_t IT_0093 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0107 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0108 = IT_0012*IT_0107;
    const ccomplex_t IT_0109 = IT_0102 + IT_0104 + IT_0106 + IT_0108;
    const ccomplex_t IT_0110 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0111 = IT_0017*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0113 = IT_0020*IT_0112;
    ...
    const ccomplex_t IT_0152 = cpow(IT_0151, 2);
    ...
    const ccomplex_t IT_0163 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0164 = IT_0017*IT_0163;
    const ccomplex_t IT_0165 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0166 = IT_0020*IT_0165;
    const ccomplex_t IT_0167 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0168 = IT_0017*IT_0167;
    const ccomplex_t IT_0169 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0175 = IT_0151*IT_0174;
    const ccomplex_t IT_0176 = m_N_1*IT_0175;
    const ccomplex_t IT_0177 = IT_0153 + IT_0176;
    const ccomplex_t IT_0178 = IT_0130*IT_0177;
    const ccomplex_t IT_0179 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*IT_0179;
    const ccomplex_t IT_0181 = IT_0177*IT_0180;
    const ccomplex_t IT_0182 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*IT_0182;
    const ccomplex_t IT_0184 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0185 = IT_0008*IT_0184;
    const ccomplex_t IT_0186 = N_B4*N_d1*e_em;
    ...
    const ccomplex_t IT_0193 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0194 = IT_0017*IT_0193;
    const ccomplex_t IT_0195 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0196 = IT_0020*IT_0195;
    const ccomplex_t IT_0197 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0198 = IT_0017*IT_0197;
    const ccomplex_t IT_0199 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0213 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0214 = IT_0012*IT_0213;
    const ccomplex_t IT_0215 = IT_0208 + IT_0210 + IT_0212 + IT_0214;
    const ccomplex_t IT_0216 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0217 = IT_0017*IT_0216;
    const ccomplex_t IT_0218 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0219 = IT_0020*IT_0218;
    const ccomplex_t IT_0220 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0221 = IT_0017*IT_0220;
    const ccomplex_t IT_0222 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0231 = IT_0183*IT_0230;
    const ccomplex_t IT_0232 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = IT_0230*IT_0233;
    const ccomplex_t IT_0235 = 0.5*IT_0069 + 0.5*IT_0075 + -IT_0125 + -IT_0128
       + -IT_0178 + -IT_0181 + -IT_0231 + -IT_0234;
    const ccomplex_t IT_0236 = 2*IT_0235;
    const ccomplex_t IT_0237 = cpow(IT_0035, 2);
    const ccomplex_t IT_0238 = m_N_1*IT_0237;
    const ccomplex_t IT_0239 = IT_0037 + IT_0238;
    const ccomplex_t IT_0240 = IT_0054*IT_0239;
    const ccomplex_t IT_0241 = IT_0003*IT_0239;
    const ccomplex_t IT_0242 = (-0.5)*IT_0069 + (-0.5)*IT_0075 + IT_0240 +
       IT_0241;
    const ccomplex_t IT_0243 = (-2)*IT_0242;
    const ccomplex_t IT_0244 = IT_0236 + IT_0243;
    const ccomplex_t IT_0245 = 2*conj(IT_0235);
    const ccomplex_t IT_0246 = (-2)*conj(IT_0242);
    const ccomplex_t IT_0247 = IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = cpow(IT_0174, 2);
    const ccomplex_t IT_0249 = m_N_3*IT_0248;
    const ccomplex_t IT_0250 = IT_0176 + IT_0249;
    const ccomplex_t IT_0251 = IT_0130*IT_0250;
    const ccomplex_t IT_0252 = IT_0180*IT_0250;
    const ccomplex_t IT_0253 = cpow(IT_0227, 2);
    const ccomplex_t IT_0254 = m_N_4*IT_0253;
    const ccomplex_t IT_0255 = IT_0229 + IT_0254;
    const ccomplex_t IT_0256 = IT_0183*IT_0255;
    const ccomplex_t IT_0257 = cpow(IT_0121, 2);
    const ccomplex_t IT_0258 = m_N_2*IT_0257;
    const ccomplex_t IT_0259 = IT_0123 + IT_0258;
    const ccomplex_t IT_0260 = IT_0077*IT_0259;
    const ccomplex_t IT_0261 = IT_0127*IT_0259;
    const ccomplex_t IT_0262 = IT_0233*IT_0255;
    const ccomplex_t IT_0263 = 0.5*IT_0052 + 0.5*IT_0067 + -IT_0251 + -IT_0252
       + -IT_0256 + -IT_0260 + -IT_0261 + -IT_0262;
    const ccomplex_t IT_0264 = 2*IT_0242;
    const ccomplex_t IT_0265 = (-2)*IT_0235;
    const ccomplex_t IT_0266 = IT_0264 + IT_0265;
    const ccomplex_t IT_0267 = 2*conj(IT_0242);
    const ccomplex_t IT_0268 = (-2)*conj(IT_0235);
    ...
    const ccomplex_t IT_0273 = IT_0077*IT_0122;
    const ccomplex_t IT_0274 = IT_0122*IT_0127;
    const ccomplex_t IT_0275 = IT_0130*IT_0175;
    const ccomplex_t IT_0276 = IT_0175*IT_0180;
    const ccomplex_t IT_0277 = IT_0183*IT_0228;
    const ccomplex_t IT_0278 = IT_0228*IT_0233;
    const ccomplex_t IT_0279 = IT_0273 + -IT_0274 + IT_0275 + -IT_0276 +
       IT_0277 + -IT_0278;
    const ccomplex_t IT_0280 = 2*IT_0068;
    const ccomplex_t IT_0281 = (-2)*IT_0263;
    const ccomplex_t IT_0282 = -IT_0003;
    const ccomplex_t IT_0283 = IT_0054 + IT_0282;
    const ccomplex_t IT_0284 = IT_0036*IT_0283;
    const ccomplex_t IT_0285 = 2*conj(IT_0068);
    ...
    const ccomplex_t IT_0288 = s_24*m_N_1;
    const ccomplex_t IT_0289 = 2*IT_0263;
    const ccomplex_t IT_0290 = (-2)*IT_0068;
    const ccomplex_t IT_0291 = 2*conj(IT_0263);
    const ccomplex_t IT_0292 = (-2)*conj(IT_0068);
    const ccomplex_t IT_0293 = IT_0288*(IT_0247*IT_0279 + IT_0244*conj(IT_0279
      ) + conj(IT_0279)*(IT_0289 + IT_0290) + conj(IT_0284)*(IT_0236 + IT_0243 +
       IT_0289 + IT_0290) + IT_0279*(IT_0291 + IT_0292) + IT_0284*(IT_0245 +
       IT_0246 + IT_0291 + IT_0292));
    ...
    const ccomplex_t IT_0298 = (-2)*IT_0279;
    ...
    const ccomplex_t IT_0302 = (-2)*conj(IT_0279)*IT_0284;
    ...
    const ccomplex_t IT_0306 = IT_0000*(conj(IT_0068)*IT_0244 + IT_0068
      *IT_0247 + conj(IT_0263)*IT_0266 + IT_0263*IT_0269) + (IT_0068*conj
      (IT_0068) + IT_0235*conj(IT_0235) + IT_0242*conj(IT_0242) + IT_0263*conj
      (IT_0263))*IT_0270 + (conj(IT_0235)*IT_0242 + IT_0235*conj(IT_0242) + conj
      (IT_0068)*IT_0263 + IT_0068*conj(IT_0263))*IT_0271 + IT_0287 + IT_0293 + 2
      *IT_0297*(conj(IT_0279)*IT_0298 + IT_0299 + 1./2*IT_0301 + 1./2*IT_0302) +
       (-2)*IT_0303*(IT_0284*conj(IT_0284) + (-0.5)*conj(IT_0279)*IT_0298 + 
      -IT_0299 + (-0.5)*IT_0279*IT_0300 + (-0.5)*IT_0301 + (-0.5)*IT_0302 + (
