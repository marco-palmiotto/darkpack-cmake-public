...
ccomplex_return_t c_sumSqAmpl_N_1_N_2_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0131 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_sd_L*
    ...
    const ccomplex_t IT_0140 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
    ...
    const ccomplex_t IT_0145 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0146 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0011*IT_0027*IT_0046;
    const ccomplex_t IT_0147 = 0.5*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0161 = (-0.5)*IT_0146;
    const ccomplex_t IT_0162 = N_B2*e_em;
    const ccomplex_t IT_0163 = IT_0002*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = N_W2*e_em;
    ...
    const ccomplex_t IT_0171 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0172 = IT_0170*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0175 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0002;
    const ccomplex_t IT_0176 = (-0.333333333333333)*IT_0175;
    const ccomplex_t IT_0177 = 0.5*IT_0140;
    const ccomplex_t IT_0178 = IT_0176*IT_0177;
    const ccomplex_t IT_0179 = IT_0174*IT_0178;
    ...
    const ccomplex_t IT_0238 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0002;
    const ccomplex_t IT_0239 = (-0.333333333333333)*IT_0238;
    const ccomplex_t IT_0240 = IT_0237*IT_0239;
    const ccomplex_t IT_0241 = IT_0174*IT_0240;
    ...
    const ccomplex_t IT_0263 = m_d*m_N_1;
    const ccomplex_t IT_0264 = -s_24;
    const ccomplex_t IT_0265 = s_23 + IT_0264;
    const ccomplex_t IT_0266 = IT_0263*IT_0265;
    const ccomplex_t IT_0267 = (-2)*IT_0266;
    const ccomplex_t IT_0268 = IT_0149*IT_0230;
    const ccomplex_t IT_0269 = IT_0145*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*IT_0269;
    const ccomplex_t IT_0271 = IT_0141*IT_0217;
    ...
    const ccomplex_t IT_0284 = m_d*m_N_2;
    const ccomplex_t IT_0285 = -s_14;
    ...
    const ccomplex_t IT_0292 = m_d*s_13*m_N_2;
    ...
    const ccomplex_t IT_0324 = conj(N_d1)*N_d2*e_em;
    const ccomplex_t IT_0325 = IT_0299*IT_0324;
    const ccomplex_t IT_0326 = IT_0302*IT_0324;
    const ccomplex_t IT_0327 = conj(N_u1)*N_u2*e_em;
    ...
    const ccomplex_t IT_0344 = 6*IT_0274;
    const ccomplex_t IT_0345 = 6*conj(IT_0274);
    const ccomplex_t IT_0346 = 12*IT_0274;
    const ccomplex_t IT_0347 = 12*conj(IT_0274);
    const ccomplex_t IT_0348 = IT_0292*(conj(IT_0281)*IT_0295 + IT_0281
    ...
    const ccomplex_t IT_0349 = 24*conj(IT_0274);
    const ccomplex_t IT_0350 = 48*conj(IT_0337);
    const ccomplex_t IT_0351 = IT_0349 + IT_0350;
    const ccomplex_t IT_0352 = 12*IT_0281;
    const ccomplex_t IT_0353 = 12*IT_0236;
    const ccomplex_t IT_0354 = 24*IT_0281;
    const ccomplex_t IT_0355 = 24*conj(IT_0281);
    const ccomplex_t IT_0356 = 24*IT_0274;
    const ccomplex_t IT_0357 = s_13 + s_14;
    const ccomplex_t IT_0358 = IT_0284*IT_0357;
    const ccomplex_t IT_0359 = IT_0169*IT_0250;
    const ccomplex_t IT_0360 = IT_0171*IT_0359;
    const ccomplex_t IT_0361 = (0 + _Complex_I*1)*IT_0360;
    const ccomplex_t IT_0362 = IT_0177*IT_0237;
    const ccomplex_t IT_0363 = IT_0174*IT_0362;
    const ccomplex_t IT_0364 = (0 + _Complex_I*1)*IT_0363;
    const ccomplex_t IT_0365 = IT_0361 + IT_0364;
    const ccomplex_t IT_0366 = IT_0176*IT_0239;
    const ccomplex_t IT_0367 = IT_0174*IT_0366;
    const ccomplex_t IT_0368 = (0 + _Complex_I*1)*IT_0367;
    const ccomplex_t IT_0369 = IT_0161*IT_0251;
    const ccomplex_t IT_0370 = IT_0171*IT_0369;
    const ccomplex_t IT_0371 = (0 + _Complex_I*1)*IT_0370;
    const ccomplex_t IT_0372 = IT_0368 + IT_0371;
    const ccomplex_t IT_0373 = 6*IT_0053;
    const ccomplex_t IT_0374 = 6*conj(IT_0053);
    const ccomplex_t IT_0375 = IT_0308*IT_0335;
    const ccomplex_t IT_0376 = -IT_0375;
    const ccomplex_t IT_0377 = 12*IT_0053;
    const ccomplex_t IT_0378 = 12*conj(IT_0053);
    const ccomplex_t IT_0379 = 12*IT_0082;
    const ccomplex_t IT_0380 = 12*conj(IT_0082);
    const ccomplex_t IT_0381 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0382 = IT_0315*IT_0331;
    const ccomplex_t IT_0383 = -IT_0382;
    const ccomplex_t IT_0384 = (-12)*IT_0082;
    const ccomplex_t IT_0385 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0386 = (-6)*IT_0053;
    const ccomplex_t IT_0387 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0388 = (-12)*IT_0053*conj(IT_0317) + (-6)*conj(IT_0082
      )*((-0.166666666666667)*IT_0344 + IT_0365) + (-6)*IT_0082*((
      -0.166666666666667)*IT_0345 + conj(IT_0365)) + conj(IT_0372)*IT_0373 +
       IT_0372*IT_0374 + conj(IT_0376)*IT_0377 + IT_0376*IT_0378 + conj(IT_0337)
      *IT_0379 + IT_0337*IT_0380 + IT_0317*IT_0381 + conj(IT_0383)*IT_0384 +
       IT_0383*IT_0385 + conj(IT_0281)*IT_0386 + IT_0281*IT_0387;
    const ccomplex_t IT_0389 = IT_0084*IT_0256;
    const ccomplex_t IT_0390 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0181 + (
      -0.0416666666666667)*IT_0290) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0181) + (-0.0416666666666667)*IT_0291) + (-0.166666666666667)*conj
      (IT_0255)*IT_0373 + (-0.166666666666667)*IT_0255*IT_0374 + (
      -0.166666666666667)*conj(IT_0236)*IT_0386 + (-0.166666666666667)*IT_0236
      *IT_0387;
    const ccomplex_t IT_0391 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0392 = 6*IT_0082;
    const ccomplex_t IT_0393 = 6*conj(IT_0082);
    const ccomplex_t IT_0394 = s_23 + s_24;
    const ccomplex_t IT_0395 = IT_0263*IT_0394;
    const ccomplex_t IT_0396 = (-6)*IT_0082;
    const ccomplex_t IT_0397 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0398 = (-12)*IT_0053*conj(IT_0337) + conj(IT_0365)
      *IT_0373 + IT_0365*IT_0374 + conj(IT_0317)*IT_0379 + IT_0317*IT_0380 +
       IT_0337*IT_0381 + IT_0378*IT_0383 + IT_0377*conj(IT_0383) + conj(IT_0376)
      *IT_0384 + IT_0376*IT_0385 + conj(IT_0274)*IT_0386 + IT_0274*IT_0387 +
       conj(IT_0281)*IT_0392 + IT_0281*IT_0393 + conj(IT_0372)*IT_0396 + IT_0372
      *IT_0397;
    const ccomplex_t IT_0399 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0400 = (-2)*IT_0287;
    const ccomplex_t IT_0401 = (-3)*IT_0130;
    const ccomplex_t IT_0402 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0403 = (-3)*IT_0215;
    const ccomplex_t IT_0404 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0405 = 2*IT_0266;
    const ccomplex_t IT_0406 = (-2)*IT_0259;
    const ccomplex_t IT_0407 = 4*IT_0266;
    const ccomplex_t IT_0408 = conj(IT_0337) + conj(IT_0383);
    const ccomplex_t IT_0409 = IT_0337 + IT_0383;
    const ccomplex_t IT_0410 = conj(IT_0317) + conj(IT_0376);
    const ccomplex_t IT_0411 = IT_0317 + IT_0376;
    const ccomplex_t IT_0412 = (-4)*IT_0287;
    const ccomplex_t IT_0413 = m_N_1*m_N_2*IT_0083;
    const ccomplex_t IT_0414 = IT_0290 + IT_0318;
    const ccomplex_t IT_0415 = IT_0291 + IT_0321;
    const ccomplex_t IT_0416 = 24*IT_0372;
    const ccomplex_t IT_0417 = 48*IT_0376;
    const ccomplex_t IT_0418 = IT_0416 + IT_0417;
    const ccomplex_t IT_0419 = 12*IT_0365;
    const ccomplex_t IT_0420 = 12*conj(IT_0365);
    const ccomplex_t IT_0421 = 24*conj(IT_0365);
    const ccomplex_t IT_0422 = 24*conj(IT_0372);
    const ccomplex_t IT_0423 = 48*IT_0383;
    const ccomplex_t IT_0424 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0281)*IT_0346 + IT_0281*IT_0347 + IT_0317*IT_0351 + conj(IT_0337)
      *IT_0354 + IT_0337*IT_0355 + conj(IT_0317)*(48*IT_0337 + IT_0356) + conj
      (IT_0255)*IT_0414 + IT_0255*IT_0415 + conj(IT_0383)*IT_0418 + conj(IT_0372
      )*IT_0419 + IT_0372*IT_0420 + IT_0376*IT_0421 + IT_0383*IT_0422 + conj
      (IT_0376)*(24*IT_0365 + IT_0423);
    const ccomplex_t IT_0425 = 12*IT_0372;
    const ccomplex_t IT_0426 = 0.0416666666666667*IT_0347;
    const ccomplex_t IT_0427 = conj(IT_0337) + IT_0426;
    const ccomplex_t IT_0428 = 0.166666666666667*conj(IT_0365);
    const ccomplex_t IT_0429 = 12*conj(IT_0372);
    const ccomplex_t IT_0430 = 0.166666666666667*IT_0317;
    const ccomplex_t IT_0431 = 0.166666666666667*conj(IT_0317);
    const ccomplex_t IT_0432 = 6*conj(IT_0281);
    const ccomplex_t IT_0433 = 0.166666666666667*IT_0372;
    const ccomplex_t IT_0434 = 12*conj(IT_0281);
    const ccomplex_t IT_0435 = 24*conj(IT_0317);
    const ccomplex_t IT_0436 = IT_0434 + IT_0435;
    const ccomplex_t IT_0437 = 0.166666666666667*IT_0376;
    const ccomplex_t IT_0438 = 24*IT_0317;
    const ccomplex_t IT_0439 = IT_0352 + IT_0438;
    const ccomplex_t IT_0440 = 0.166666666666667*conj(IT_0376);
    const ccomplex_t IT_0441 = 0.166666666666667*IT_0337;
    const ccomplex_t IT_0442 = 0.166666666666667*conj(IT_0337);
    const ccomplex_t IT_0443 = 0.166666666666667*IT_0345*IT_0365 + IT_0281
      *conj(IT_0372) + 4*(IT_0337 + 0.0416666666666667*IT_0346)*conj(IT_0383) +
       4*IT_0383*IT_0427 + IT_0344*IT_0428 + IT_0429*IT_0430 + IT_0425*IT_0431 +
       IT_0432*IT_0433 + IT_0436*IT_0437 + IT_0439*IT_0440 + IT_0420*IT_0441 +
       IT_0419*IT_0442;
    const ccomplex_t IT_0444 = s_34*m_N_1*m_N_2;
    const ccomplex_t IT_0445 = 6*conj(IT_0365);
    const ccomplex_t IT_0446 = 0.166666666666667*conj(IT_0372);
    const ccomplex_t IT_0447 = 0.166666666666667*IT_0383;
    const ccomplex_t IT_0448 = 0.166666666666667*conj(IT_0383);
    const ccomplex_t IT_0449 = conj(IT_0281)*IT_0365 + 4*(IT_0337 +
       0.0416666666666667*IT_0346)*conj(IT_0376) + 4*IT_0376*IT_0427 + IT_0420
      *IT_0430 + IT_0419*IT_0431 + IT_0345*IT_0433 + IT_0429*IT_0441 + IT_0425
      *IT_0442 + 0.166666666666667*IT_0281*IT_0445 + IT_0344*IT_0446 + IT_0436
      *IT_0447 + IT_0439*IT_0448;
    const ccomplex_t IT_0450 = m_d*s_24*m_N_1;
    const ccomplex_t IT_0451 = 0.166666666666667*IT_0236;
    const ccomplex_t IT_0452 = 0.166666666666667*IT_0255;
    const ccomplex_t IT_0453 = conj(IT_0255)*IT_0281 + 0.166666666666667*conj
      (IT_0274)*IT_0295 + 0.166666666666667*IT_0274*IT_0298 + 0.166666666666667
      *conj(IT_0236)*IT_0352 + IT_0343*IT_0430 + IT_0340*IT_0431 + IT_0323
      *IT_0441 + IT_0320*IT_0442 + IT_0434*IT_0451 + IT_0432*IT_0452;
    const ccomplex_t IT_0454 = m_d*s_14*m_N_2;
    const ccomplex_t IT_0455 = 24*conj(IT_0181);
    const ccomplex_t IT_0456 = IT_0297 + IT_0455;
    const ccomplex_t IT_0457 = 24*IT_0181;
    const ccomplex_t IT_0458 = IT_0294 + IT_0457;
    const ccomplex_t IT_0459 = 12*conj(IT_0236);
    const ccomplex_t IT_0460 = 24*conj(IT_0255);
    const ccomplex_t IT_0461 = IT_0459 + IT_0460;
    const ccomplex_t IT_0462 = 24*IT_0255;
    const ccomplex_t IT_0463 = IT_0353 + IT_0462;
    const ccomplex_t IT_0464 = 0.166666666666667*conj(IT_0255);
    const ccomplex_t IT_0465 = 6*IT_0454*(conj(IT_0236)*IT_0365 + IT_0415
      *IT_0433 + IT_0414*IT_0446 + IT_0445*IT_0451 + IT_0420*IT_0452 + IT_0437
      *IT_0456 + IT_0440*IT_0458 + IT_0447*IT_0461 + IT_0448*IT_0463 + IT_0419
      *IT_0464);
    const ccomplex_t IT_0466 = m_d*s_23*m_N_1;
    const ccomplex_t IT_0467 = conj(IT_0236)*IT_0372 + IT_0236*conj(IT_0372) +
       0.166666666666667*IT_0365*IT_0415 + IT_0414*IT_0428 + IT_0429*IT_0452 +
       IT_0447*IT_0456 + IT_0448*IT_0458 + IT_0437*IT_0461 + IT_0440*IT_0463 +
       IT_0425*IT_0464;
    const ccomplex_t IT_0468 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0348 + IT_0156*(conj(IT_0153)*IT_0294 + conj(IT_0274)
      *IT_0346 + IT_0337*IT_0351 + conj(IT_0281)*IT_0352 + conj(IT_0236)*IT_0353
       + conj(IT_0317)*IT_0354 + IT_0317*(48*conj(IT_0317) + IT_0355) + conj
      (IT_0337)*IT_0356) + IT_0358*IT_0388 + (-6)*IT_0389*IT_0390 + IT_0391*
      (conj(IT_0153)*IT_0386 + IT_0153*IT_0387 + conj(IT_0236)*IT_0392 + IT_0236
      *IT_0393) + IT_0395*IT_0398 + (conj(IT_0181)*IT_0373 + IT_0181*IT_0374 +
       conj(IT_0255)*IT_0396 + IT_0255*IT_0397)*IT_0399 + IT_0400*(conj(IT_0372)
      *IT_0401 + IT_0372*IT_0402 + conj(IT_0365)*IT_0403 + IT_0365*IT_0404) + 
      (conj(IT_0365)*IT_0401 + IT_0365*IT_0402 + conj(IT_0372)*IT_0403 + IT_0372
      *IT_0404)*IT_0405 + (conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj
      (IT_0153)*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0401 + IT_0255
      *IT_0402 + conj(IT_0181)*IT_0403 + IT_0181*IT_0404)*IT_0406 + IT_0407*
      (IT_0401*IT_0408 + IT_0402*IT_0409 + IT_0403*IT_0410 + IT_0404*IT_0411) + 
      (IT_0403*IT_0408 + IT_0404*IT_0409 + IT_0401*IT_0410 + IT_0402*IT_0411)
      *IT_0412 + IT_0413*IT_0424 + IT_0155*(conj(IT_0181)*IT_0318 + conj(IT_0255
      )*IT_0338 + conj(IT_0376)*IT_0418 + conj(IT_0365)*IT_0419 + IT_0383
      *IT_0421 + IT_0376*IT_0422 + conj(IT_0383)*(24*IT_0365 + IT_0423) + conj
      (IT_0372)*IT_0425) + 6*IT_0154*IT_0443 + 6*IT_0444*IT_0449 + 6*IT_0450
      *IT_0453 + IT_0465 + 6*IT_0466*IT_0467;
