...
ccomplex_return_t c_sumSqAmpl_N_1_N_2_to_anti_e_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0160 = m_N_1*m_N_2;
    ...
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0002;
    const ccomplex_t IT_0170 = -IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0011*IT_0027*IT_0046;
    const ccomplex_t IT_0178 = (-0.5)*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0185 = m_e*m_N_1;
    ...
    const ccomplex_t IT_0209 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0011*IT_0027*IT_0046;
    const ccomplex_t IT_0210 = 0.5*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0217 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0222 = IT_0180*IT_0197;
    const ccomplex_t IT_0223 = IT_0176*IT_0222;
    const ccomplex_t IT_0224 = (0 + _Complex_I*1)*IT_0223;
    const ccomplex_t IT_0225 = IT_0172*IT_0210;
    const ccomplex_t IT_0226 = IT_0168*IT_0225;
    ...
    const ccomplex_t IT_0236 = (-0.5)*IT_0209;
    const ccomplex_t IT_0237 = N_B2*e_em;
    const ccomplex_t IT_0238 = IT_0002*IT_0237;
    const ccomplex_t IT_0239 = 1.4142135623731*IT_0238;
    const ccomplex_t IT_0240 = N_W2*e_em;
    ...
    const ccomplex_t IT_0249 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0002;
    const ccomplex_t IT_0251 = -IT_0250;
    const ccomplex_t IT_0252 = 0.5*IT_0179;
    const ccomplex_t IT_0253 = IT_0251*IT_0252;
    const ccomplex_t IT_0254 = IT_0249*IT_0253;
    ...
    const ccomplex_t IT_0259 = IT_0178*IT_0205;
    const ccomplex_t IT_0260 = IT_0176*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*IT_0260;
    const ccomplex_t IT_0262 = IT_0170*IT_0212;
    const ccomplex_t IT_0263 = IT_0168*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0261 + IT_0264;
    const ccomplex_t IT_0266 = 0.5*IT_0177;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0002;
    ...
    const ccomplex_t IT_0280 = (-0.5)*IT_0211;
    ...
    const ccomplex_t IT_0288 = m_e*s_13*m_N_2;
    ...
    const ccomplex_t IT_0296 = N_u1*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0320 = conj(N_d1)*N_d2*e_em;
    const ccomplex_t IT_0321 = IT_0295*IT_0320;
    const ccomplex_t IT_0322 = IT_0298*IT_0320;
    const ccomplex_t IT_0323 = conj(N_u1)*N_u2*e_em;
    ...
    const ccomplex_t IT_0344 = 4*IT_0216;
    const ccomplex_t IT_0345 = 4*IT_0265;
    const ccomplex_t IT_0346 = 8*IT_0216;
    const ccomplex_t IT_0347 = 8*conj(IT_0216);
    const ccomplex_t IT_0348 = 8*IT_0184;
    const ccomplex_t IT_0349 = 8*conj(IT_0184);
    const ccomplex_t IT_0350 = IT_0231*(conj(IT_0228)*IT_0290 + conj(IT_0184)
      *IT_0341 + conj(IT_0216)*IT_0344 + conj(IT_0265)*IT_0345 + conj(IT_0313)
      *IT_0346 + IT_0313*(16*conj(IT_0313) + IT_0347) + conj(IT_0332)*IT_0348 +
       IT_0332*(16*conj(IT_0332) + IT_0349));
    const ccomplex_t IT_0351 = IT_0084*IT_0160;
    const ccomplex_t IT_0352 = 2*IT_0053;
    const ccomplex_t IT_0353 = 2*conj(IT_0053);
    const ccomplex_t IT_0354 = (-2)*IT_0053;
    const ccomplex_t IT_0355 = (-2)*conj(IT_0053);
    const ccomplex_t IT_0356 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0256 + (
      -0.125)*IT_0286) + 4*IT_0082*(conj(IT_0053) + 1./4*conj(IT_0256) + (-0.125
      )*IT_0287) + (-0.5)*conj(IT_0284)*IT_0352 + (-0.5)*IT_0284*IT_0353 + (-0.5
      )*conj(IT_0265)*IT_0354 + (-0.5)*IT_0265*IT_0355;
    const ccomplex_t IT_0357 = IT_0229 + IT_0231 + IT_0233 + IT_0257;
    const ccomplex_t IT_0358 = 2*IT_0082;
    const ccomplex_t IT_0359 = 2*conj(IT_0082);
    const ccomplex_t IT_0360 = IT_0229 + IT_0230 + IT_0232 + IT_0233;
    const ccomplex_t IT_0361 = (-2)*IT_0082;
    const ccomplex_t IT_0362 = (-2)*conj(IT_0082);
    const ccomplex_t IT_0363 = (-2)*IT_0220;
    const ccomplex_t IT_0364 = IT_0251*IT_0268;
    const ccomplex_t IT_0365 = IT_0249*IT_0364;
    const ccomplex_t IT_0366 = (0 + _Complex_I*1)*IT_0365;
    const ccomplex_t IT_0367 = IT_0236*IT_0280;
    const ccomplex_t IT_0368 = IT_0246*IT_0367;
    const ccomplex_t IT_0369 = (0 + _Complex_I*1)*IT_0368;
    const ccomplex_t IT_0370 = IT_0366 + IT_0369;
    const ccomplex_t IT_0371 = -IT_0130;
    const ccomplex_t IT_0372 = -conj(IT_0130);
    const ccomplex_t IT_0373 = IT_0244*IT_0279;
    const ccomplex_t IT_0374 = IT_0246*IT_0373;
    const ccomplex_t IT_0375 = (0 + _Complex_I*1)*IT_0374;
    const ccomplex_t IT_0376 = IT_0252*IT_0266;
    const ccomplex_t IT_0377 = IT_0249*IT_0376;
    const ccomplex_t IT_0378 = (0 + _Complex_I*1)*IT_0377;
    const ccomplex_t IT_0379 = IT_0375 + IT_0378;
    const ccomplex_t IT_0380 = -IT_0159;
    const ccomplex_t IT_0381 = -conj(IT_0159);
    const ccomplex_t IT_0382 = 2*IT_0188;
    const ccomplex_t IT_0383 = (-2)*IT_0163;
    const ccomplex_t IT_0384 = 4*IT_0188;
    const ccomplex_t IT_0385 = IT_0311*IT_0327;
    const ccomplex_t IT_0386 = -IT_0385;
    const ccomplex_t IT_0387 = conj(IT_0332) + conj(IT_0386);
    const ccomplex_t IT_0388 = IT_0332 + IT_0386;
    const ccomplex_t IT_0389 = IT_0304*IT_0330;
    const ccomplex_t IT_0390 = -IT_0389;
    const ccomplex_t IT_0391 = conj(IT_0313) + conj(IT_0390);
    const ccomplex_t IT_0392 = IT_0313 + IT_0390;
    const ccomplex_t IT_0393 = (-4)*IT_0220;
    const ccomplex_t IT_0394 = m_N_1*m_N_2*IT_0083;
    const ccomplex_t IT_0395 = IT_0287 + IT_0317;
    const ccomplex_t IT_0396 = 8*IT_0370;
    const ccomplex_t IT_0397 = 16*IT_0390;
    const ccomplex_t IT_0398 = IT_0396 + IT_0397;
    const ccomplex_t IT_0399 = 4*conj(IT_0379);
    const ccomplex_t IT_0400 = 4*IT_0379;
    const ccomplex_t IT_0401 = 0.125*conj(IT_0370);
    const ccomplex_t IT_0402 = 8*conj(IT_0379);
    const ccomplex_t IT_0403 = 0.125*IT_0390;
    const ccomplex_t IT_0404 = 8*conj(IT_0370);
    const ccomplex_t IT_0405 = 0.125*IT_0386;
    const ccomplex_t IT_0406 = IT_0286 + IT_0314;
    const ccomplex_t IT_0407 = 0.125*conj(IT_0284);
    const ccomplex_t IT_0408 = 0.125*conj(IT_0265)*IT_0291 + 0.125*IT_0265
      *IT_0294 + 0.125*conj(IT_0216)*IT_0341 + 0.125*IT_0216*IT_0342 + 0.125
      *conj(IT_0332)*IT_0346 + 0.125*IT_0332*IT_0347 + 2*conj(IT_0313)*(IT_0332 
      + 0.0625*IT_0348) + 2*IT_0313*(conj(IT_0332) + 0.0625*IT_0349) + (IT_0379 
      + 2*IT_0386)*conj(IT_0390) + 0.125*IT_0284*IT_0395 + 0.125*conj(IT_0386)
      *IT_0398 + 0.125*IT_0370*IT_0399 + IT_0400*IT_0401 + IT_0402*IT_0403 +
       IT_0404*IT_0405 + IT_0406*IT_0407;
    const ccomplex_t IT_0409 = 4*IT_0370;
    const ccomplex_t IT_0410 = 0.125*conj(IT_0256)*IT_0314 + (IT_0379 + 2
      *IT_0386)*conj(IT_0386) + 0.125*conj(IT_0390)*IT_0398 + 0.125*conj(IT_0379
      )*IT_0400 + IT_0403*IT_0404 + IT_0402*IT_0405 + IT_0333*IT_0407 + IT_0401
      *IT_0409;
    const ccomplex_t IT_0411 = 0.125*IT_0342;
    const ccomplex_t IT_0412 = conj(IT_0332) + IT_0411;
    const ccomplex_t IT_0413 = 0.5*conj(IT_0379);
    const ccomplex_t IT_0414 = 4*conj(IT_0370);
    const ccomplex_t IT_0415 = 0.5*IT_0313;
    const ccomplex_t IT_0416 = 0.5*conj(IT_0313);
    const ccomplex_t IT_0417 = 2*conj(IT_0216);
    const ccomplex_t IT_0418 = 0.5*IT_0370;
    const ccomplex_t IT_0419 = 4*conj(IT_0216);
    const ccomplex_t IT_0420 = 8*conj(IT_0313);
    const ccomplex_t IT_0421 = IT_0419 + IT_0420;
    const ccomplex_t IT_0422 = 0.5*IT_0390;
    const ccomplex_t IT_0423 = 8*IT_0313;
    const ccomplex_t IT_0424 = IT_0344 + IT_0423;
    const ccomplex_t IT_0425 = 0.5*conj(IT_0390);
    const ccomplex_t IT_0426 = 0.5*IT_0332;
    const ccomplex_t IT_0427 = 0.5*conj(IT_0332);
    const ccomplex_t IT_0428 = IT_0216*conj(IT_0370) + 0.5*IT_0340*IT_0379 + 4
      *(IT_0332 + 0.125*IT_0341)*conj(IT_0386) + 4*IT_0386*IT_0412 + IT_0339
      *IT_0413 + IT_0414*IT_0415 + IT_0409*IT_0416 + IT_0417*IT_0418 + IT_0421
      *IT_0422 + IT_0424*IT_0425 + IT_0399*IT_0426 + IT_0400*IT_0427;
    const ccomplex_t IT_0429 = s_34*m_N_1*m_N_2;
    const ccomplex_t IT_0430 = 2*conj(IT_0379);
    const ccomplex_t IT_0431 = 0.5*conj(IT_0370);
    const ccomplex_t IT_0432 = 0.5*IT_0386;
    const ccomplex_t IT_0433 = 0.5*conj(IT_0386);
    const ccomplex_t IT_0434 = conj(IT_0216)*IT_0379 + 4*(IT_0332 + 0.125
      *IT_0341)*conj(IT_0390) + 4*IT_0390*IT_0412 + IT_0399*IT_0415 + IT_0400
      *IT_0416 + IT_0340*IT_0418 + IT_0414*IT_0426 + IT_0409*IT_0427 + 0.5
      *IT_0216*IT_0430 + IT_0339*IT_0431 + IT_0421*IT_0432 + IT_0424*IT_0433;
    const ccomplex_t IT_0435 = m_e*s_24*m_N_1;
    const ccomplex_t IT_0436 = 0.5*IT_0265;
    const ccomplex_t IT_0437 = 0.5*IT_0284;
    const ccomplex_t IT_0438 = IT_0216*conj(IT_0284) + 0.5*conj(IT_0184)
      *IT_0291 + 0.5*IT_0184*IT_0294 + 0.5*conj(IT_0265)*IT_0344 + IT_0338
      *IT_0415 + IT_0335*IT_0416 + IT_0319*IT_0426 + IT_0316*IT_0427 + IT_0419
      *IT_0436 + IT_0417*IT_0437;
    const ccomplex_t IT_0439 = m_e*s_14*m_N_2;
    const ccomplex_t IT_0440 = 8*conj(IT_0256);
    const ccomplex_t IT_0441 = IT_0293 + IT_0440;
    const ccomplex_t IT_0442 = 8*IT_0256;
    const ccomplex_t IT_0443 = IT_0290 + IT_0442;
    const ccomplex_t IT_0444 = 4*conj(IT_0265);
    const ccomplex_t IT_0445 = 8*conj(IT_0284);
    const ccomplex_t IT_0446 = IT_0444 + IT_0445;
    const ccomplex_t IT_0447 = 8*IT_0284;
    const ccomplex_t IT_0448 = IT_0345 + IT_0447;
    const ccomplex_t IT_0449 = 0.5*conj(IT_0284);
    const ccomplex_t IT_0450 = 2*IT_0439*(conj(IT_0265)*IT_0379 + IT_0395
      *IT_0418 + IT_0406*IT_0431 + IT_0430*IT_0436 + IT_0399*IT_0437 + IT_0422
      *IT_0441 + IT_0425*IT_0443 + IT_0432*IT_0446 + IT_0433*IT_0448 + IT_0400
      *IT_0449);
    const ccomplex_t IT_0451 = m_e*s_23*m_N_1;
    const ccomplex_t IT_0452 = conj(IT_0265)*IT_0370 + IT_0265*conj(IT_0370) +
       0.5*IT_0379*IT_0395 + IT_0406*IT_0413 + IT_0414*IT_0437 + IT_0432*IT_0441
       + IT_0433*IT_0443 + IT_0422*IT_0446 + IT_0425*IT_0448 + IT_0409*IT_0449;
    const ccomplex_t IT_0453 = s_13 + s_14;
    const ccomplex_t IT_0454 = IT_0217*IT_0453;
    const ccomplex_t IT_0455 = 4*IT_0082;
    const ccomplex_t IT_0456 = (-0.25)*IT_0216;
    const ccomplex_t IT_0457 = (-0.25)*conj(IT_0216);
    const ccomplex_t IT_0458 = (-4)*conj(IT_0053);
    const ccomplex_t IT_0459 = (-0.25)*IT_0313;
    const ccomplex_t IT_0460 = (-0.25)*IT_0370;
    const ccomplex_t IT_0461 = (-0.25)*conj(IT_0370);
    const ccomplex_t IT_0462 = 4*conj(IT_0053);
    const ccomplex_t IT_0463 = (-0.25)*IT_0390;
    const ccomplex_t IT_0464 = 4*IT_0053;
    const ccomplex_t IT_0465 = (-0.25)*conj(IT_0390);
    const ccomplex_t IT_0466 = (-4)*conj(IT_0082);
    const ccomplex_t IT_0467 = (-0.25)*IT_0386;
    const ccomplex_t IT_0468 = (-4)*IT_0082;
    const ccomplex_t IT_0469 = (-0.25)*conj(IT_0386);
    const ccomplex_t IT_0470 = 4*conj(IT_0082);
    const ccomplex_t IT_0471 = (-0.25)*IT_0332;
    const ccomplex_t IT_0472 = IT_0053*conj(IT_0313) + 0.5*conj(IT_0082)*((
      -0.5)*IT_0339 + IT_0379) + 0.5*IT_0082*((-0.5)*IT_0340 + conj(IT_0379)) + 
      (-0.25)*conj(IT_0332)*IT_0455 + IT_0355*IT_0456 + IT_0354*IT_0457 +
       IT_0458*IT_0459 + IT_0353*IT_0460 + IT_0352*IT_0461 + IT_0462*IT_0463 +
       IT_0464*IT_0465 + IT_0466*IT_0467 + IT_0468*IT_0469 + IT_0470*IT_0471;
    const ccomplex_t IT_0473 = s_23 + s_24;
    const ccomplex_t IT_0474 = IT_0185*IT_0473;
    const ccomplex_t IT_0475 = IT_0053*conj(IT_0332) + (-0.25)*conj(IT_0184)
      *IT_0354 + (-0.25)*IT_0184*IT_0355 + (-0.25)*IT_0353*IT_0379 + (-0.25)
      *IT_0352*conj(IT_0379) + (-0.25)*conj(IT_0313)*IT_0455 + IT_0359*IT_0456 +
       IT_0358*IT_0457 + IT_0362*IT_0460 + IT_0361*IT_0461 + IT_0463*IT_0466 +
       IT_0462*IT_0467 + IT_0465*IT_0468 + IT_0464*IT_0469 + IT_0459*IT_0470 +
       IT_0458*IT_0471;
    const ccomplex_t IT_0476 = 8*(IT_0053*conj(IT_0053) + IT_0082*conj(IT_0082
      ...
      *IT_0235*IT_0265 + 2*IT_0258*IT_0284) + IT_0159*(IT_0189*conj(IT_0216) +
      ...
      (IT_0284)) + 2*IT_0285*(conj(IT_0265)*IT_0284 + IT_0265*conj(IT_0284) +
       0.5*conj(IT_0256)*IT_0286 + 0.5*IT_0256*IT_0287) + IT_0343 + IT_0350 + (
      -2)*IT_0351*IT_0356 + IT_0357*(conj(IT_0228)*IT_0354 + IT_0228*IT_0355 +
       conj(IT_0265)*IT_0358 + IT_0265*IT_0359) + IT_0360*(conj(IT_0256)*IT_0352
       + IT_0256*IT_0353 + conj(IT_0284)*IT_0361 + IT_0284*IT_0362) + IT_0363*
      (conj(IT_0370)*IT_0371 + IT_0370*IT_0372 + conj(IT_0379)*IT_0380 + IT_0379
      *IT_0381) + (IT_0372*IT_0379 + IT_0371*conj(IT_0379) + conj(IT_0370)
      *IT_0380 + IT_0370*IT_0381)*IT_0382 + (conj(IT_0159)*IT_0228 + IT_0159
      *conj(IT_0228) + conj(IT_0130)*IT_0265 + IT_0130*conj(IT_0265) + conj
      (IT_0284)*IT_0371 + IT_0284*IT_0372 + conj(IT_0256)*IT_0380 + IT_0256
      *IT_0381)*IT_0383 + IT_0384*(IT_0371*IT_0387 + IT_0372*IT_0388 + IT_0380
      *IT_0391 + IT_0381*IT_0392) + (IT_0380*IT_0387 + IT_0381*IT_0388 + IT_0371
      *IT_0391 + IT_0372*IT_0392)*IT_0393 + 8*IT_0394*IT_0408 + 8*IT_0230
      *IT_0410 + 2*IT_0229*IT_0428 + 2*IT_0429*IT_0434 + 2*IT_0435*IT_0438 +
       IT_0450 + 2*IT_0451*IT_0452 + (-4)*IT_0454*IT_0472 + (-4)*IT_0474*IT_0475;
