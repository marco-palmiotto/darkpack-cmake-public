        ...
        )
{
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0391 = m_s*s_23*m_N_1;
