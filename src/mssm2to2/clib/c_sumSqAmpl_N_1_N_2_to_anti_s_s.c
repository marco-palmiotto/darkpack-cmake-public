...
ccomplex_return_t c_sumSqAmpl_N_1_N_2_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0140 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0168 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0169 = (-0.5)*IT_0146;
    const ccomplex_t IT_0170 = N_B2*e_em;
    const ccomplex_t IT_0171 = IT_0002*IT_0170;
    const ccomplex_t IT_0172 = 1.4142135623731*IT_0171;
    const ccomplex_t IT_0173 = N_W2*e_em;
    ...
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0263 = m_s*m_N_1;
    ...
    const ccomplex_t IT_0284 = m_s*m_N_2;
    ...
    const ccomplex_t IT_0292 = m_s*s_13*m_N_2;
    ...
    const ccomplex_t IT_0349 = m_s*s_14*m_N_2;
    ...
    const ccomplex_t IT_0353 = IT_0169*IT_0251;
    ...
    const ccomplex_t IT_0359 = IT_0315*IT_0331;
    ...
    const ccomplex_t IT_0367 = IT_0308*IT_0335;
    ...
    const ccomplex_t IT_0373 = IT_0177*IT_0250;
    const ccomplex_t IT_0374 = IT_0168*IT_0373;
    const ccomplex_t IT_0375 = (0 + _Complex_I*1)*IT_0374;
    const ccomplex_t IT_0376 = IT_0163*IT_0237;
    ...
    const ccomplex_t IT_0385 = s_34*m_N_1*m_N_2;
    const ccomplex_t IT_0386 = 24*conj(IT_0337);
    const ccomplex_t IT_0387 = IT_0347 + IT_0386;
    const ccomplex_t IT_0388 = 12*IT_0281;
    const ccomplex_t IT_0389 = 24*IT_0317;
    const ccomplex_t IT_0390 = IT_0388 + IT_0389;
    const ccomplex_t IT_0391 = 12*conj(IT_0281);
    const ccomplex_t IT_0392 = 24*conj(IT_0317);
    const ccomplex_t IT_0393 = IT_0391 + IT_0392;
    const ccomplex_t IT_0394 = 12*IT_0356;
    const ccomplex_t IT_0395 = 12*conj(IT_0356);
    const ccomplex_t IT_0396 = IT_0345*IT_0356 + IT_0344*conj(IT_0356) + (24
      *IT_0337 + IT_0346)*conj(IT_0368) + conj(IT_0281)*IT_0380 + IT_0281
      *IT_0381 + conj(IT_0317)*IT_0382 + IT_0317*IT_0383 + IT_0368*IT_0387 +
       conj(IT_0360)*IT_0390 + IT_0360*IT_0393 + conj(IT_0337)*IT_0394 + IT_0337
      *IT_0395;
    const ccomplex_t IT_0397 = 24*conj(IT_0274);
    const ccomplex_t IT_0398 = 48*conj(IT_0337);
    const ccomplex_t IT_0399 = IT_0397 + IT_0398;
    const ccomplex_t IT_0400 = 24*conj(IT_0281);
    const ccomplex_t IT_0401 = 24*IT_0274;
    const ccomplex_t IT_0402 = 24*IT_0356;
    const ccomplex_t IT_0403 = 48*IT_0368;
    const ccomplex_t IT_0404 = IT_0402 + IT_0403;
    const ccomplex_t IT_0405 = 24*IT_0379;
    const ccomplex_t IT_0406 = 24*conj(IT_0379);
    const ccomplex_t IT_0407 = 24*conj(IT_0356);
    const ccomplex_t IT_0408 = m_N_1*m_N_2*IT_0083;
    const ccomplex_t IT_0409 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0281)*IT_0346 + conj(IT_0255)*IT_0357 + IT_0255*IT_0358 + conj(IT_0356
      )*IT_0382 + IT_0356*IT_0383 + IT_0281*IT_0387 + IT_0317*IT_0399 + IT_0337
      *IT_0400 + conj(IT_0317)*(48*IT_0337 + IT_0401) + conj(IT_0360)*IT_0404 +
       conj(IT_0368)*(48*IT_0360 + IT_0405) + IT_0368*IT_0406 + IT_0360*IT_0407;
    const ccomplex_t IT_0410 = s_13 + s_14;
    const ccomplex_t IT_0411 = IT_0284*IT_0410;
    const ccomplex_t IT_0412 = 6*IT_0053;
    const ccomplex_t IT_0413 = 6*conj(IT_0053);
    const ccomplex_t IT_0414 = 12*IT_0053;
    const ccomplex_t IT_0415 = 12*conj(IT_0053);
    const ccomplex_t IT_0416 = 12*IT_0082;
    const ccomplex_t IT_0417 = 12*conj(IT_0082);
    const ccomplex_t IT_0418 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0419 = (-12)*IT_0082;
    const ccomplex_t IT_0420 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0421 = (-6)*IT_0053;
    const ccomplex_t IT_0422 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0423 = (-12)*IT_0053*conj(IT_0317) + (-6)*conj(IT_0082
      )*((-0.166666666666667)*IT_0344 + IT_0379) + (-6)*IT_0082*((
      -0.166666666666667)*IT_0345 + conj(IT_0379)) + conj(IT_0356)*IT_0412 +
       IT_0356*IT_0413 + conj(IT_0368)*IT_0414 + IT_0368*IT_0415 + conj(IT_0337)
      *IT_0416 + IT_0337*IT_0417 + IT_0317*IT_0418 + conj(IT_0360)*IT_0419 +
       IT_0360*IT_0420 + conj(IT_0281)*IT_0421 + IT_0281*IT_0422;
    const ccomplex_t IT_0424 = IT_0084*IT_0256;
    const ccomplex_t IT_0425 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0181 + (
      -0.0416666666666667)*IT_0290) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0181) + (-0.0416666666666667)*IT_0291) + (-0.166666666666667)*conj
      (IT_0255)*IT_0412 + (-0.166666666666667)*IT_0255*IT_0413 + (
      -0.166666666666667)*conj(IT_0236)*IT_0421 + (-0.166666666666667)*IT_0236
      *IT_0422;
    const ccomplex_t IT_0426 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0427 = 6*IT_0082;
    const ccomplex_t IT_0428 = 6*conj(IT_0082);
    const ccomplex_t IT_0429 = s_23 + s_24;
    const ccomplex_t IT_0430 = IT_0263*IT_0429;
    const ccomplex_t IT_0431 = (-6)*IT_0082;
    const ccomplex_t IT_0432 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0433 = (-12)*IT_0053*conj(IT_0337) + conj(IT_0379)
      *IT_0412 + IT_0379*IT_0413 + conj(IT_0360)*IT_0414 + IT_0360*IT_0415 +
       conj(IT_0317)*IT_0416 + IT_0317*IT_0417 + IT_0337*IT_0418 + conj(IT_0368)
      *IT_0419 + IT_0368*IT_0420 + conj(IT_0274)*IT_0421 + IT_0274*IT_0422 +
       conj(IT_0281)*IT_0427 + IT_0281*IT_0428 + conj(IT_0356)*IT_0431 + IT_0356
      *IT_0432;
    const ccomplex_t IT_0434 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0435 = (-2)*IT_0287;
    const ccomplex_t IT_0436 = (-3)*IT_0130;
    const ccomplex_t IT_0437 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0438 = (-3)*IT_0215;
    const ccomplex_t IT_0439 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0440 = 2*IT_0266;
    const ccomplex_t IT_0441 = (-2)*IT_0259;
    const ccomplex_t IT_0442 = 4*IT_0266;
    const ccomplex_t IT_0443 = conj(IT_0337) + conj(IT_0360);
    const ccomplex_t IT_0444 = IT_0337 + IT_0360;
    const ccomplex_t IT_0445 = conj(IT_0317) + conj(IT_0368);
    const ccomplex_t IT_0446 = IT_0317 + IT_0368;
    const ccomplex_t IT_0447 = (-4)*IT_0287;
    const ccomplex_t IT_0448 = 6*conj(IT_0281);
    const ccomplex_t IT_0449 = 0.166666666666667*IT_0317;
    const ccomplex_t IT_0450 = 0.166666666666667*conj(IT_0317);
    const ccomplex_t IT_0451 = 0.166666666666667*IT_0379;
    const ccomplex_t IT_0452 = 0.166666666666667*conj(IT_0379);
    const ccomplex_t IT_0453 = 0.166666666666667*IT_0368;
    const ccomplex_t IT_0454 = 0.166666666666667*conj(IT_0368);
    const ccomplex_t IT_0455 = 0.166666666666667*IT_0337;
    const ccomplex_t IT_0456 = 0.166666666666667*conj(IT_0337);
    const ccomplex_t IT_0457 = IT_0281*conj(IT_0356) + 4*(conj(IT_0337) +
       0.0416666666666667*IT_0347)*IT_0360 + 4*(IT_0337 + 0.0416666666666667
      *IT_0346)*conj(IT_0360) + 0.166666666666667*IT_0356*IT_0448 + IT_0395
      *IT_0449 + IT_0394*IT_0450 + IT_0345*IT_0451 + IT_0344*IT_0452 + IT_0393
      *IT_0453 + IT_0390*IT_0454 + IT_0383*IT_0455 + IT_0382*IT_0456;
    const ccomplex_t IT_0458 = m_s*s_24*m_N_1;
    const ccomplex_t IT_0459 = 0.166666666666667*IT_0255;
    const ccomplex_t IT_0460 = conj(IT_0255)*IT_0281 + 0.166666666666667*conj
      (IT_0274)*IT_0295 + 0.166666666666667*IT_0274*IT_0298 + 0.166666666666667
      *conj(IT_0236)*IT_0388 + 0.166666666666667*IT_0236*IT_0391 + IT_0343
      *IT_0449 + IT_0340*IT_0450 + IT_0323*IT_0455 + IT_0320*IT_0456 + IT_0448
      *IT_0459;
    const ccomplex_t IT_0461 = m_s*s_23*m_N_1;
    const ccomplex_t IT_0462 = conj(IT_0236)*IT_0356 + IT_0236*conj(IT_0356) +
       0.166666666666667*conj(IT_0360)*IT_0370 + 0.166666666666667*IT_0360
      *IT_0372 + 0.166666666666667*conj(IT_0255)*IT_0394 + IT_0358*IT_0451 +
       IT_0357*IT_0452 + IT_0366*IT_0453 + IT_0363*IT_0454 + IT_0395*IT_0459;
    const ccomplex_t IT_0463 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0348 + IT_0384 + IT_0385*IT_0396 + IT_0156*(conj(IT_0153)
      *IT_0294 + (24*IT_0281 + 48*IT_0317)*conj(IT_0317) + conj(IT_0274)*IT_0346
       + conj(IT_0236)*IT_0361 + conj(IT_0281)*IT_0388 + IT_0337*IT_0399 +
       IT_0317*IT_0400 + conj(IT_0337)*IT_0401) + IT_0155*(conj(IT_0181)*IT_0318
       + conj(IT_0255)*IT_0338 + conj(IT_0379)*IT_0382 + conj(IT_0356)*IT_0394 +
       conj(IT_0368)*IT_0404 + conj(IT_0360)*IT_0405 + IT_0360*(48*conj(IT_0360)
       + IT_0406) + IT_0368*IT_0407) + IT_0408*IT_0409 + IT_0411*IT_0423 + (-6)
      *IT_0424*IT_0425 + IT_0426*(conj(IT_0153)*IT_0421 + IT_0153*IT_0422 + conj
      (IT_0236)*IT_0427 + IT_0236*IT_0428) + IT_0430*IT_0433 + (conj(IT_0181)
      *IT_0412 + IT_0181*IT_0413 + conj(IT_0255)*IT_0431 + IT_0255*IT_0432)
      *IT_0434 + IT_0435*(conj(IT_0356)*IT_0436 + IT_0356*IT_0437 + conj(IT_0379
      )*IT_0438 + IT_0379*IT_0439) + (conj(IT_0379)*IT_0436 + IT_0379*IT_0437 +
       conj(IT_0356)*IT_0438 + IT_0356*IT_0439)*IT_0440 + (conj(IT_0236)*IT_0261
       + IT_0236*IT_0262 + conj(IT_0153)*IT_0282 + IT_0153*IT_0283 + conj
      (IT_0255)*IT_0436 + IT_0255*IT_0437 + conj(IT_0181)*IT_0438 + IT_0181
      *IT_0439)*IT_0441 + IT_0442*(IT_0436*IT_0443 + IT_0437*IT_0444 + IT_0438
      *IT_0445 + IT_0439*IT_0446) + (IT_0438*IT_0443 + IT_0439*IT_0444 + IT_0436
      *IT_0445 + IT_0437*IT_0446)*IT_0447 + 6*IT_0154*IT_0457 + 6*IT_0458
      *IT_0460 + 6*IT_0461*IT_0462;
