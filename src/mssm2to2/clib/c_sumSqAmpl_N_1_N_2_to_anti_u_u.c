...
ccomplex_return_t c_sumSqAmpl_N_1_N_2_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
    ...
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0263 = m_u*m_N_2;
    ...
    const ccomplex_t IT_0292 = m_u*s_13*m_N_2;
    ...
    const ccomplex_t IT_0349 = m_u*s_14*m_N_2;
    ...
    const ccomplex_t IT_0385 = m_u*s_24*m_N_1;
    ...
    const ccomplex_t IT_0391 = m_u*s_23*m_N_1;
