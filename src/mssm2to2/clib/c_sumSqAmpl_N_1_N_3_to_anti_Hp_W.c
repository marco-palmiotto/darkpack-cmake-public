        ...
        )
{
    ...
    const ccomplex_t IT_0099 = (0 + _Complex_I*-1)*e_em*IT_0009*(IT_0017
      *IT_0071 + -IT_0067*IT_0094);
    const ccomplex_t IT_0100 = IT_0068*IT_0073;
    const ccomplex_t IT_0101 = IT_0081*IT_0083;
    const ccomplex_t IT_0102 = IT_0068*IT_0077;
    const ccomplex_t IT_0103 = IT_0083*IT_0086;
    const ccomplex_t IT_0104 = IT_0100 + IT_0101 + IT_0102 + IT_0103;
    const ccomplex_t IT_0105 = IT_0069*IT_0072;
    const ccomplex_t IT_0106 = IT_0080*IT_0084;
    const ccomplex_t IT_0107 = IT_0072*IT_0075;
    const ccomplex_t IT_0108 = IT_0080*IT_0088;
    ...
    const ccomplex_t IT_0113 = IT_0099*IT_0112;
    const ccomplex_t IT_0114 = cpow((-2)*s_12 + -IT_0004 + -IT_0037 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*IT_0114;
    const ccomplex_t IT_0116 = IT_0113*IT_0115;
    const ccomplex_t IT_0117 = IT_0024*IT_0069;
    const ccomplex_t IT_0118 = IT_0023*IT_0094;
    const ccomplex_t IT_0119 = IT_0073*IT_0118;
    const ccomplex_t IT_0120 = IT_0018*IT_0081;
    const ccomplex_t IT_0121 = IT_0009*IT_0094;
    const ccomplex_t IT_0122 = IT_0084*IT_0121;
    const ccomplex_t IT_0123 = IT_0024*IT_0075;
    const ccomplex_t IT_0124 = IT_0077*IT_0118;
    const ccomplex_t IT_0125 = IT_0018*IT_0086;
    const ccomplex_t IT_0126 = IT_0088*IT_0121;
    const ccomplex_t IT_0127 = 0.5*IT_0117 + (-0.5)*IT_0119 + (-0.5)*IT_0120 +
       0.5*IT_0122 + 0.5*IT_0123 + (-0.5)*IT_0124 + (-0.5)*IT_0125 + 0.5*IT_0126;
    const ccomplex_t IT_0128 = e_em*IT_0009;
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = IT_0127*IT_0129;
    const ccomplex_t IT_0131 = cpow((-2)*s_12 + -IT_0004 + -IT_0037 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*IT_0131;
    const ccomplex_t IT_0133 = IT_0130*IT_0132;
    const ccomplex_t IT_0134 = 2*IT_0040 + 2*IT_0064 + -IT_0098 + -IT_0116 + 
      -IT_0133;
    const ccomplex_t IT_0135 = N_W3*U_d2*e_em;
    const ccomplex_t IT_0136 = IT_0121*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = N_B3*U_d2*e_em;
    const ccomplex_t IT_0139 = IT_0118*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = IT_0137 + IT_0140;
    const ccomplex_t IT_0142 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0148 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0149 = IT_0009*IT_0148;
    const ccomplex_t IT_0150 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0156 = IT_0062*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*IT_0156;
    const ccomplex_t IT_0158 = N_d3*e_em*U_Wm1;
    const ccomplex_t IT_0159 = IT_0121*IT_0158;
    const ccomplex_t IT_0160 = (-2)*IT_0159;
    const ccomplex_t IT_0161 = N_B3*U_d1*e_em;
    const ccomplex_t IT_0162 = IT_0118*IT_0161;
    const ccomplex_t IT_0163 = 1.4142135623731*IT_0162;
    const ccomplex_t IT_0164 = N_W3*U_d1*e_em;
    const ccomplex_t IT_0165 = IT_0121*IT_0164;
    ...
    const ccomplex_t IT_0171 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0172 = IT_0009*IT_0171;
    const ccomplex_t IT_0173 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0179 = IT_0038*IT_0178;
    ...
    const ccomplex_t IT_0215 = IT_0099*IT_0214;
    ...
    const ccomplex_t IT_0238 = N_d1*e_em*U_Wm1;
    const ccomplex_t IT_0239 = IT_0121*IT_0238;
    const ccomplex_t IT_0240 = (-2)*IT_0239;
    const ccomplex_t IT_0241 = N_B1*U_d1*e_em;
    const ccomplex_t IT_0242 = IT_0118*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = N_W1*U_d1*e_em;
    const ccomplex_t IT_0245 = IT_0121*IT_0244;
    ...
    const ccomplex_t IT_0251 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0252 = IT_0009*IT_0251;
    const ccomplex_t IT_0253 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0259 = cpow((-2)*s_13 + IT_0004 + IT_0036 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0294 = m_N_1*IT_0040;
    const ccomplex_t IT_0295 = m_N_1*IT_0064;
    const ccomplex_t IT_0296 = m_N_3*IT_0261;
    const ccomplex_t IT_0297 = m_N_3*IT_0285;
    const ccomplex_t IT_0298 = IT_0294 + IT_0295 + IT_0296 + IT_0297;
    const ccomplex_t IT_0299 = 2*conj(IT_0298);
    const ccomplex_t IT_0300 = IT_0060*IT_0154;
    ...
    const ccomplex_t IT_0311 = IT_0250*IT_0310;
    const ccomplex_t IT_0312 = IT_0259*IT_0303*IT_0311;
    const ccomplex_t IT_0313 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0314 = IT_0009*IT_0313;
    const ccomplex_t IT_0315 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0320 = IT_0274*IT_0319;
    const ccomplex_t IT_0321 = IT_0283*IT_0301*IT_0320;
    const ccomplex_t IT_0322 = IT_0034*IT_0177;
    const ccomplex_t IT_0323 = IT_0038*IT_0303*IT_0322;
    const ccomplex_t IT_0324 = -IT_0302 + -IT_0312 + -IT_0321 + -IT_0323;
    ...
    const ccomplex_t IT_0333 = IT_0016*IT_0170;
    const ccomplex_t IT_0334 = IT_0038*IT_0303*IT_0333;
    const ccomplex_t IT_0335 = IT_0047*IT_0147;
    const ccomplex_t IT_0336 = IT_0062*IT_0301*IT_0335;
    const ccomplex_t IT_0337 = conj(N_u1)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0338 = IT_0018*IT_0337;
    const ccomplex_t IT_0339 = 2*IT_0338;
    const ccomplex_t IT_0340 = conj(N_B1)*conj(V_u1)*e_em;
    const ccomplex_t IT_0341 = IT_0024*IT_0340;
    const ccomplex_t IT_0342 = 1.4142135623731*IT_0341;
    const ccomplex_t IT_0343 = conj(N_W1)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0351 = IT_0259*IT_0303*IT_0350;
    const ccomplex_t IT_0352 = conj(N_u1)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0353 = IT_0018*IT_0352;
    const ccomplex_t IT_0354 = 2*IT_0353;
    const ccomplex_t IT_0355 = conj(N_B1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0356 = IT_0024*IT_0355;
    const ccomplex_t IT_0357 = 1.4142135623731*IT_0356;
    const ccomplex_t IT_0358 = conj(N_W1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0359 = IT_0018*IT_0358;
    ...
    const ccomplex_t IT_0365 = IT_0281*IT_0364;
    const ccomplex_t IT_0366 = IT_0283*IT_0301*IT_0365;
    const ccomplex_t IT_0367 = IT_0334 + IT_0336 + IT_0351 + IT_0366;
    const ccomplex_t IT_0368 = (-2)*conj(IT_0367);
    const ccomplex_t IT_0369 = IT_0310*IT_0349;
    const ccomplex_t IT_0370 = IT_0259*IT_0369;
    const ccomplex_t IT_0371 = (0 + _Complex_I*1)*IT_0370;
    const ccomplex_t IT_0372 = m_N_3*IT_0371;
    const ccomplex_t IT_0373 = IT_0319*IT_0364;
    const ccomplex_t IT_0374 = IT_0283*IT_0373;
    const ccomplex_t IT_0375 = (0 + _Complex_I*1)*IT_0374;
    const ccomplex_t IT_0376 = m_N_3*IT_0375;
    const ccomplex_t IT_0377 = m_N_1*IT_0157;
    const ccomplex_t IT_0378 = m_N_1*IT_0180;
    const ccomplex_t IT_0379 = -IT_0372 + -IT_0376 + -IT_0377 + -IT_0378;
    const ccomplex_t IT_0380 = (-2)*conj(IT_0379);
    const ccomplex_t IT_0381 = IT_0368 + IT_0380;
    const ccomplex_t IT_0382 = IT_0371 + IT_0375;
    ...
    const ccomplex_t IT_0403 = -IT_0098 + -IT_0116 + -IT_0133;
    const ccomplex_t IT_0404 = -IT_0201 + -IT_0216 + -IT_0231 + (-2)*IT_0261 +
       (-2)*IT_0285;
    const ccomplex_t IT_0405 = (-2)*IT_0371 + (-2)*IT_0375;
    const ccomplex_t IT_0406 = 2*IT_0134;
    const ccomplex_t IT_0407 = 2*conj(IT_0134);
    const ccomplex_t IT_0408 = m_N_3*IT_0006;
    const ccomplex_t IT_0409 = conj(IT_0298) + conj(IT_0324);
    const ccomplex_t IT_0410 = 2*IT_0232;
    const ccomplex_t IT_0411 = (-2)*IT_0181;
    const ccomplex_t IT_0412 = IT_0410 + IT_0411;
    const ccomplex_t IT_0413 = IT_0298 + IT_0324;
    const ccomplex_t IT_0414 = 2*conj(IT_0232);
    const ccomplex_t IT_0415 = (-2)*conj(IT_0181);
    const ccomplex_t IT_0416 = IT_0414 + IT_0415;
    const ccomplex_t IT_0417 = 2*IT_0367;
    const ccomplex_t IT_0418 = m_N_1*IT_0401;
    const ccomplex_t IT_0419 = conj(IT_0367) + conj(IT_0379);
    const ccomplex_t IT_0420 = IT_0367 + IT_0379;
    const ccomplex_t IT_0421 = s_12*s_14;
    const ccomplex_t IT_0422 = s_24*IT_0004;
    const ccomplex_t IT_0423 = -IT_0422;
    const ccomplex_t IT_0424 = IT_0421 + IT_0423;
    const ccomplex_t IT_0425 = conj(IT_0286) + conj(IT_0383);
    const ccomplex_t IT_0426 = IT_0286 + IT_0383;
    const ccomplex_t IT_0427 = conj(IT_0382) + conj(IT_0398);
    const ccomplex_t IT_0428 = IT_0382 + IT_0398;
    const ccomplex_t IT_0429 = IT_0000*IT_0401;
    const ccomplex_t IT_0430 = 2*IT_0404;
    const ccomplex_t IT_0431 = 2*conj(IT_0404);
    const ccomplex_t IT_0432 = s_12*s_24;
    const ccomplex_t IT_0433 = s_14*IT_0037;
    const ccomplex_t IT_0434 = -IT_0433;
    const ccomplex_t IT_0435 = IT_0432 + IT_0434;
    const ccomplex_t IT_0436 = 2*IT_0405;
    const ccomplex_t IT_0437 = (-2)*IT_0403;
    const ccomplex_t IT_0438 = IT_0436 + IT_0437;
    const ccomplex_t IT_0439 = 2*conj(IT_0405);
    ...
    const ccomplex_t IT_0457 = IT_0000*IT_0455;
    const ccomplex_t IT_0458 = (-2)*IT_0404;
    const ccomplex_t IT_0459 = (-2)*conj(IT_0404);
    const ccomplex_t IT_0460 = m_N_1*IT_0455;
    const ccomplex_t IT_0461 = m_N_3*IT_0401;
    ...
    const ccomplex_t IT_0478 = IT_0417 + IT_0477;
    ...
    const ccomplex_t IT_0487 = IT_0007*(conj(IT_0134)*IT_0234 + IT_0134
      ...
      *IT_0407) + IT_0408*(IT_0134*IT_0388 + conj(IT_0379)*IT_0406 + IT_0379
      *IT_0407 + IT_0409*IT_0412 + IT_0413*IT_0416 + conj(IT_0134)*IT_0417) +
       IT_0418*(IT_0406*IT_0409 + IT_0407*IT_0413 + IT_0412*IT_0419 + IT_0416
      *IT_0420) + IT_0424*(IT_0234*IT_0425 + IT_0237*IT_0426 + IT_0406*IT_0427 +
       IT_0407*IT_0428) + IT_0429*(IT_0237*IT_0405 + IT_0234*conj(IT_0405) +
       conj(IT_0403)*IT_0412 + IT_0403*IT_0416 + conj(IT_0134)*IT_0430 + IT_0134
      *IT_0431) + IT_0435*(IT_0425*IT_0430 + IT_0426*IT_0431 + IT_0427*IT_0438 +
       IT_0428*IT_0441) + 4*IT_0448*(IT_0419*IT_0420 + IT_0409*(IT_0324 + 0.25
      *IT_0449)) + 6*IT_0000*(IT_0409*IT_0420 + IT_0413*(conj(IT_0379) +
       0.166666666666667*IT_0450)) + (conj(IT_0181)*IT_0234 + IT_0181*IT_0236 +
       conj(IT_0134)*IT_0406 + conj(IT_0232)*IT_0410)*IT_0451 + 2*(IT_0403*conj
      (IT_0403) + 0.5*conj(IT_0404)*IT_0430 + 0.5*conj(IT_0405)*IT_0438 + 0.5
      *IT_0405*IT_0440)*IT_0456 + IT_0457*(conj(IT_0405)*IT_0430 + IT_0405
      *IT_0431 + conj(IT_0403)*IT_0458 + IT_0403*IT_0459) + (IT_0409*IT_0438 +
       IT_0413*IT_0441 + IT_0419*IT_0458 + IT_0420*IT_0459)*IT_0460 + IT_0461*
      (IT_0368*IT_0403 + IT_0388*IT_0405 + conj(IT_0405)*IT_0417 + conj(IT_0379)
      *IT_0438 + IT_0379*IT_0441 + IT_0409*IT_0458 + IT_0413*IT_0459 + conj
      (IT_0403)*IT_0462) + (-2)*conj(IT_0398)*(IT_0286*IT_0464 + -IT_0383
