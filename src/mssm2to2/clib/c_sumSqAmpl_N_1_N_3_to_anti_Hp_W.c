...
ccomplex_return_t c_sumSqAmpl_N_1_N_3_to_anti_Hp_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = conj(N_u3)*e_em*conj(V_Wp1);
    ...
    const ccomplex_t IT_0025 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = 1.4142135623731*IT_0026;
    const ccomplex_t IT_0028 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0036 + IT_0037 + -m_C_2*
    ...
    const ccomplex_t IT_0069 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0070 = IT_0068*IT_0069;
    const ccomplex_t IT_0071 = sin(alpha);
    const ccomplex_t IT_0072 = IT_0023*IT_0071;
    const ccomplex_t IT_0073 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0076 = IT_0068*IT_0075;
    const ccomplex_t IT_0077 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0078 = IT_0072*IT_0077;
    const ccomplex_t IT_0079 = IT_0070 + IT_0074 + IT_0076 + IT_0078;
    const ccomplex_t IT_0080 = IT_0009*IT_0067;
    const ccomplex_t IT_0081 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = IT_0009*IT_0071;
    const ccomplex_t IT_0084 = conj(N_W1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*e_em*IT_0009*(IT_0017
      *IT_0067 + IT_0071*IT_0094);
    const ccomplex_t IT_0096 = -IT_0095;
    const ccomplex_t IT_0097 = IT_0093*IT_0096;
    const ccomplex_t IT_0098 = IT_0066*IT_0097;
    const ccomplex_t IT_0099 = IT_0024*IT_0069;
    const ccomplex_t IT_0100 = IT_0023*IT_0094;
    const ccomplex_t IT_0101 = IT_0073*IT_0100;
    const ccomplex_t IT_0102 = IT_0018*IT_0081;
    const ccomplex_t IT_0103 = IT_0009*IT_0094;
    const ccomplex_t IT_0104 = IT_0084*IT_0103;
    const ccomplex_t IT_0105 = IT_0024*IT_0075;
    const ccomplex_t IT_0106 = IT_0077*IT_0100;
    const ccomplex_t IT_0107 = IT_0018*IT_0086;
    const ccomplex_t IT_0108 = IT_0088*IT_0103;
    const ccomplex_t IT_0109 = 0.5*IT_0099 + (-0.5)*IT_0101 + (-0.5)*IT_0102 +
       0.5*IT_0104 + 0.5*IT_0105 + (-0.5)*IT_0106 + (-0.5)*IT_0107 + 0.5*IT_0108;
    const ccomplex_t IT_0110 = e_em*IT_0009;
    const ccomplex_t IT_0111 = -IT_0110;
    const ccomplex_t IT_0112 = IT_0109*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_12 + -IT_0004 + -IT_0037 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*IT_0113;
    const ccomplex_t IT_0115 = IT_0112*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*-1)*e_em*IT_0009*(IT_0017
      *IT_0071 + -IT_0067*IT_0094);
    const ccomplex_t IT_0117 = IT_0068*IT_0073;
    const ccomplex_t IT_0118 = IT_0081*IT_0083;
    const ccomplex_t IT_0119 = IT_0068*IT_0077;
    const ccomplex_t IT_0120 = IT_0083*IT_0086;
    const ccomplex_t IT_0121 = IT_0117 + IT_0118 + IT_0119 + IT_0120;
    const ccomplex_t IT_0122 = IT_0069*IT_0072;
    const ccomplex_t IT_0123 = IT_0080*IT_0084;
    const ccomplex_t IT_0124 = IT_0072*IT_0075;
    const ccomplex_t IT_0125 = IT_0080*IT_0088;
    ...
    const ccomplex_t IT_0134 = 2*IT_0040 + 2*IT_0064 + -IT_0098 + -IT_0115 + 
      -IT_0133;
    const ccomplex_t IT_0135 = N_d3*e_em*U_Wm1;
    const ccomplex_t IT_0136 = IT_0103*IT_0135;
    const ccomplex_t IT_0137 = (-2)*IT_0136;
    const ccomplex_t IT_0138 = N_B3*U_d1*e_em;
    const ccomplex_t IT_0139 = IT_0100*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = N_W3*U_d1*e_em;
    const ccomplex_t IT_0142 = IT_0103*IT_0141;
    ...
    const ccomplex_t IT_0183 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0184 = IT_0024*IT_0183;
    const ccomplex_t IT_0185 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0186 = IT_0100*IT_0185;
    const ccomplex_t IT_0187 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0188 = IT_0018*IT_0187;
    const ccomplex_t IT_0189 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0190 = IT_0103*IT_0189;
    const ccomplex_t IT_0191 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0192 = IT_0024*IT_0191;
    const ccomplex_t IT_0193 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0194 = IT_0100*IT_0193;
    const ccomplex_t IT_0195 = N_W1*N_u3*e_em;
    const ccomplex_t IT_0196 = IT_0018*IT_0195;
    const ccomplex_t IT_0197 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0202 = IT_0068*IT_0185;
    const ccomplex_t IT_0203 = IT_0083*IT_0187;
    const ccomplex_t IT_0204 = IT_0068*IT_0193;
    const ccomplex_t IT_0205 = IT_0083*IT_0195;
    const ccomplex_t IT_0206 = IT_0202 + IT_0203 + IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = IT_0072*IT_0183;
    const ccomplex_t IT_0208 = IT_0080*IT_0189;
    const ccomplex_t IT_0209 = IT_0072*IT_0191;
    const ccomplex_t IT_0210 = IT_0080*IT_0197;
    ...
    const ccomplex_t IT_0217 = IT_0068*IT_0183;
    const ccomplex_t IT_0218 = IT_0072*IT_0185;
    const ccomplex_t IT_0219 = IT_0068*IT_0191;
    const ccomplex_t IT_0220 = IT_0072*IT_0193;
    const ccomplex_t IT_0221 = IT_0217 + IT_0218 + IT_0219 + IT_0220;
    const ccomplex_t IT_0222 = IT_0080*IT_0187;
    const ccomplex_t IT_0223 = IT_0083*IT_0189;
    const ccomplex_t IT_0224 = IT_0080*IT_0195;
    const ccomplex_t IT_0225 = IT_0083*IT_0197;
    ...
    const ccomplex_t IT_0231 = IT_0066*IT_0230;
    ...
    const ccomplex_t IT_0238 = cpow((-2)*s_13 + IT_0004 + IT_0036 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0239 = N_d1*e_em*U_Wm1;
    const ccomplex_t IT_0240 = IT_0103*IT_0239;
    const ccomplex_t IT_0241 = (-2)*IT_0240;
    const ccomplex_t IT_0242 = N_B1*U_d1*e_em;
    const ccomplex_t IT_0243 = IT_0100*IT_0242;
    const ccomplex_t IT_0244 = 1.4142135623731*IT_0243;
    const ccomplex_t IT_0245 = N_W1*U_d1*e_em;
    const ccomplex_t IT_0246 = IT_0103*IT_0245;
    ...
    const ccomplex_t IT_0252 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0253 = IT_0009*IT_0252;
    const ccomplex_t IT_0254 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0260 = IT_0238*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*IT_0260;
    const ccomplex_t IT_0262 = N_d1*e_em*U_Wm2;
    const ccomplex_t IT_0263 = IT_0103*IT_0262;
    const ccomplex_t IT_0264 = (-2)*IT_0263;
    const ccomplex_t IT_0265 = N_B1*U_d2*e_em;
    const ccomplex_t IT_0266 = IT_0100*IT_0265;
    const ccomplex_t IT_0267 = 1.4142135623731*IT_0266;
    const ccomplex_t IT_0268 = N_W1*U_d2*e_em;
    const ccomplex_t IT_0269 = IT_0103*IT_0268;
    ...
    const ccomplex_t IT_0275 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0276 = IT_0009*IT_0275;
    const ccomplex_t IT_0277 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0283 = cpow((-2)*s_13 + IT_0004 + IT_0036 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0294 = m_N_3*IT_0285;
    const ccomplex_t IT_0295 = m_N_1*IT_0040;
    const ccomplex_t IT_0296 = m_N_1*IT_0064;
    const ccomplex_t IT_0297 = m_N_3*IT_0261;
    const ccomplex_t IT_0298 = IT_0294 + IT_0295 + IT_0296 + IT_0297;
    const ccomplex_t IT_0299 = 2*conj(IT_0298);
    const ccomplex_t IT_0300 = IT_0060*IT_0177;
    const ccomplex_t IT_0301 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0302 = IT_0062*IT_0300*IT_0301;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0304 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0305 = IT_0009*IT_0304;
    const ccomplex_t IT_0306 = conj(N_u3)*V_u1*e_em;
    const ccomplex_t IT_0307 = IT_0009*IT_0306;
    ...
    const ccomplex_t IT_0312 = IT_0238*IT_0303*IT_0311;
    const ccomplex_t IT_0313 = IT_0034*IT_0154;
    const ccomplex_t IT_0314 = IT_0038*IT_0303*IT_0313;
    const ccomplex_t IT_0315 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0316 = IT_0009*IT_0315;
    const ccomplex_t IT_0317 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0322 = IT_0274*IT_0321;
    const ccomplex_t IT_0323 = IT_0283*IT_0301*IT_0322;
    const ccomplex_t IT_0324 = -IT_0302 + -IT_0312 + -IT_0314 + -IT_0323;
    ...
    const ccomplex_t IT_0333 = IT_0047*IT_0170;
    const ccomplex_t IT_0334 = IT_0062*IT_0301*IT_0333;
    const ccomplex_t IT_0335 = conj(N_u1)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0336 = IT_0018*IT_0335;
    const ccomplex_t IT_0337 = 2*IT_0336;
    const ccomplex_t IT_0338 = conj(N_B1)*conj(V_u1)*e_em;
    const ccomplex_t IT_0339 = IT_0024*IT_0338;
    const ccomplex_t IT_0340 = 1.4142135623731*IT_0339;
    const ccomplex_t IT_0341 = conj(N_W1)*conj(V_u1)*e_em;
    const ccomplex_t IT_0342 = IT_0018*IT_0341;
    const ccomplex_t IT_0343 = 1.4142135623731*IT_0342;
    const ccomplex_t IT_0344 = IT_0340 + IT_0343;
    const ccomplex_t IT_0345 = IT_0337 + IT_0344;
    const ccomplex_t IT_0346 = (0 + _Complex_I*1)*IT_0345;
    const ccomplex_t IT_0347 = 0.5*IT_0346;
    const ccomplex_t IT_0348 = IT_0258*IT_0347;
    const ccomplex_t IT_0349 = IT_0238*IT_0303*IT_0348;
    const ccomplex_t IT_0350 = conj(N_u1)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0351 = IT_0018*IT_0350;
    const ccomplex_t IT_0352 = 2*IT_0351;
    const ccomplex_t IT_0353 = conj(N_B1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0354 = IT_0024*IT_0353;
    const ccomplex_t IT_0355 = 1.4142135623731*IT_0354;
    const ccomplex_t IT_0356 = conj(N_W1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0357 = IT_0018*IT_0356;
    ...
    const ccomplex_t IT_0364 = IT_0283*IT_0301*IT_0363;
    const ccomplex_t IT_0365 = IT_0016*IT_0147;
    const ccomplex_t IT_0366 = IT_0038*IT_0303*IT_0365;
    const ccomplex_t IT_0367 = IT_0334 + IT_0349 + IT_0364 + IT_0366;
    const ccomplex_t IT_0368 = (-2)*conj(IT_0367);
    const ccomplex_t IT_0369 = m_N_1*IT_0180;
    const ccomplex_t IT_0370 = IT_0310*IT_0347;
    const ccomplex_t IT_0371 = IT_0238*IT_0370;
    const ccomplex_t IT_0372 = (0 + _Complex_I*1)*IT_0371;
    const ccomplex_t IT_0373 = m_N_3*IT_0372;
    const ccomplex_t IT_0374 = IT_0321*IT_0362;
    const ccomplex_t IT_0375 = IT_0283*IT_0374;
    const ccomplex_t IT_0376 = (0 + _Complex_I*1)*IT_0375;
    const ccomplex_t IT_0377 = m_N_3*IT_0376;
    const ccomplex_t IT_0378 = m_N_1*IT_0157;
    const ccomplex_t IT_0379 = -IT_0369 + -IT_0373 + -IT_0377 + -IT_0378;
    const ccomplex_t IT_0380 = (-2)*conj(IT_0379);
    const ccomplex_t IT_0381 = IT_0368 + IT_0380;
    const ccomplex_t IT_0382 = IT_0372 + IT_0376;
    ...
    const ccomplex_t IT_0398 = -IT_0040 + -IT_0064;
    ...
    const ccomplex_t IT_0403 = -IT_0098 + -IT_0115 + -IT_0133;
    const ccomplex_t IT_0404 = -IT_0201 + -IT_0216 + -IT_0231 + (-2)*IT_0261 +
       (-2)*IT_0285;
    const ccomplex_t IT_0405 = (-2)*IT_0372 + (-2)*IT_0376;
    const ccomplex_t IT_0406 = 2*IT_0134;
    const ccomplex_t IT_0407 = 2*conj(IT_0134);
    const ccomplex_t IT_0408 = s_12*s_14;
    const ccomplex_t IT_0409 = s_24*IT_0004;
    const ccomplex_t IT_0410 = -IT_0409;
    const ccomplex_t IT_0411 = IT_0408 + IT_0410;
    const ccomplex_t IT_0412 = conj(IT_0286) + conj(IT_0383);
    const ccomplex_t IT_0413 = IT_0286 + IT_0383;
    const ccomplex_t IT_0414 = conj(IT_0382) + conj(IT_0398);
    const ccomplex_t IT_0415 = m_N_1*IT_0401;
    const ccomplex_t IT_0416 = conj(IT_0367) + conj(IT_0379);
    const ccomplex_t IT_0417 = 2*IT_0232;
    const ccomplex_t IT_0418 = (-2)*IT_0181;
    const ccomplex_t IT_0419 = IT_0417 + IT_0418;
    const ccomplex_t IT_0420 = IT_0367 + IT_0379;
    const ccomplex_t IT_0421 = 2*conj(IT_0232);
    const ccomplex_t IT_0422 = (-2)*conj(IT_0181);
    const ccomplex_t IT_0423 = IT_0421 + IT_0422;
    const ccomplex_t IT_0424 = conj(IT_0298) + conj(IT_0324);
    const ccomplex_t IT_0425 = IT_0298 + IT_0324;
    const ccomplex_t IT_0426 = IT_0000*IT_0401;
    const ccomplex_t IT_0427 = 2*IT_0404;
    const ccomplex_t IT_0428 = 2*conj(IT_0404);
    const ccomplex_t IT_0429 = s_12*s_24;
    const ccomplex_t IT_0430 = s_14*IT_0037;
    const ccomplex_t IT_0431 = -IT_0430;
    const ccomplex_t IT_0432 = IT_0429 + IT_0431;
    const ccomplex_t IT_0433 = 2*IT_0405;
    const ccomplex_t IT_0434 = (-2)*IT_0403;
    const ccomplex_t IT_0435 = IT_0433 + IT_0434;
    const ccomplex_t IT_0436 = 2*conj(IT_0405);
    const ccomplex_t IT_0437 = (-2)*conj(IT_0403);
    const ccomplex_t IT_0438 = IT_0436 + IT_0437;
    const ccomplex_t IT_0439 = m_N_3*IT_0006;
    const ccomplex_t IT_0440 = 2*IT_0367;
    const ccomplex_t IT_0441 = s_12*IT_0287;
    const ccomplex_t IT_0442 = s_14*s_24;
    const ccomplex_t IT_0443 = (-2)*IT_0442;
    const ccomplex_t IT_0444 = IT_0441 + IT_0443;
    const ccomplex_t IT_0445 = IT_0001*IT_0444;
    const ccomplex_t IT_0446 = (-0.5)*IT_0445;
    const ccomplex_t IT_0447 = s_12 + IT_0446;
    const ccomplex_t IT_0448 = 4*IT_0298;
    const ccomplex_t IT_0449 = 6*conj(IT_0367);
    const ccomplex_t IT_0450 = s_12*IT_0006;
    const ccomplex_t IT_0451 = pow(s_24, 2);
    const ccomplex_t IT_0452 = IT_0001*IT_0451;
    const ccomplex_t IT_0453 = -IT_0037;
    const ccomplex_t IT_0454 = IT_0452 + IT_0453;
    const ccomplex_t IT_0455 = IT_0000*IT_0454;
    const ccomplex_t IT_0456 = (-2)*IT_0404;
    const ccomplex_t IT_0457 = (-2)*conj(IT_0404);
    const ccomplex_t IT_0458 = m_N_1*IT_0454;
    const ccomplex_t IT_0459 = s_12*IT_0454;
    const ccomplex_t IT_0460 = m_N_3*IT_0401;
    const ccomplex_t IT_0461 = (-2)*IT_0367;
    const ccomplex_t IT_0462 = IT_0000*IT_0287;
    const ccomplex_t IT_0463 = 3*IT_0462;
    const ccomplex_t IT_0464 = (-3)*IT_0462;
    const ccomplex_t IT_0465 = pow(m_W, 4);
    const ccomplex_t IT_0466 = s_12*IT_0465;
    const ccomplex_t IT_0467 = IT_0001*IT_0466;
    const ccomplex_t IT_0468 = (-0.5)*IT_0467;
    const ccomplex_t IT_0469 = IT_0441 + IT_0443 + IT_0468;
    const ccomplex_t IT_0470 = (-0.25)*IT_0467;
    const ccomplex_t IT_0471 = IT_0442 + IT_0470;
    const ccomplex_t IT_0472 = (-2)*IT_0298;
    const ccomplex_t IT_0473 = (-2)*IT_0324;
    const ccomplex_t IT_0474 = IT_0472 + IT_0473;
    const ccomplex_t IT_0475 = (-0.5)*IT_0394;
    const ccomplex_t IT_0476 = 2*IT_0379;
    const ccomplex_t IT_0477 = IT_0440 + IT_0476;
    const ccomplex_t IT_0478 = (-0.5)*IT_0387;
    const ccomplex_t IT_0479 = (-2)*IT_0379;
    const ccomplex_t IT_0480 = IT_0461 + IT_0479;
    const ccomplex_t IT_0481 = (-0.5)*IT_0332;
    const ccomplex_t IT_0482 = 2*IT_0298;
    const ccomplex_t IT_0483 = 2*IT_0324;
    const ccomplex_t IT_0484 = IT_0482 + IT_0483;
    const ccomplex_t IT_0485 = (-0.5)*IT_0293;
    const ccomplex_t IT_0486 = IT_0007*(conj(IT_0134)*IT_0234 + IT_0134
      ...
      *IT_0407) + IT_0411*((IT_0382 + IT_0398)*IT_0407 + IT_0234*IT_0412 +
       IT_0237*IT_0413 + IT_0406*IT_0414) + IT_0415*(IT_0416*IT_0419 + IT_0420
      *IT_0423 + IT_0406*IT_0424 + IT_0407*IT_0425) + IT_0426*(IT_0237*IT_0405 +
       IT_0234*conj(IT_0405) + conj(IT_0403)*IT_0419 + IT_0403*IT_0423 + conj
      (IT_0134)*IT_0427 + IT_0134*IT_0428) + IT_0432*(IT_0412*IT_0427 + IT_0413
      *IT_0428 + IT_0414*IT_0435 + (IT_0382 + IT_0398)*IT_0438) + IT_0439*
      (IT_0134*IT_0388 + conj(IT_0379)*IT_0406 + IT_0379*IT_0407 + IT_0419
      *IT_0424 + IT_0423*IT_0425 + conj(IT_0134)*IT_0440) + 4*IT_0447*(IT_0416
      *IT_0420 + IT_0424*(IT_0324 + 0.25*IT_0448)) + 6*IT_0000*(IT_0420*IT_0424 
      + IT_0425*(conj(IT_0379) + 0.166666666666667*IT_0449)) + (conj(IT_0181)
      *IT_0234 + IT_0181*IT_0236 + conj(IT_0134)*IT_0406 + conj(IT_0232)*IT_0417
      )*IT_0450 + IT_0455*(conj(IT_0405)*IT_0427 + IT_0405*IT_0428 + conj
      (IT_0403)*IT_0456 + IT_0403*IT_0457) + (IT_0424*IT_0435 + IT_0425*IT_0438 
      + IT_0416*IT_0456 + IT_0420*IT_0457)*IT_0458 + 2*(IT_0403*conj(IT_0403) +
       0.5*conj(IT_0404)*IT_0427 + 0.5*conj(IT_0405)*IT_0435 + 0.5*IT_0405
      *IT_0437)*IT_0459 + IT_0460*(IT_0368*IT_0403 + IT_0388*IT_0405 + conj
      (IT_0379)*IT_0435 + IT_0379*IT_0438 + conj(IT_0405)*IT_0440 + IT_0424
      *IT_0456 + IT_0425*IT_0457 + conj(IT_0403)*IT_0461) + (-2)*conj(IT_0398)*
      (IT_0286*IT_0463 + -IT_0383*IT_0464 + 2*IT_0398*IT_0469 + (-4)*IT_0382
      *IT_0471 + IT_0475*IT_0477 + IT_0474*IT_0478) + (-2)*conj(IT_0383)*
      (IT_0382*IT_0463 + -IT_0398*IT_0464 + 2*IT_0383*IT_0469 + (-4)*IT_0286
      *IT_0471 + IT_0474*IT_0475 + IT_0477*IT_0478) + (-2)*conj(IT_0382)*
      (IT_0383*IT_0463 + -IT_0286*IT_0464 + 2*IT_0382*IT_0469 + (-4)*IT_0398
      *IT_0471 + IT_0481*IT_0484 + IT_0480*IT_0485) + (-2)*conj(IT_0286)*
      (IT_0398*IT_0463 + -IT_0382*IT_0464 + 2*IT_0286*IT_0469 + (-4)*IT_0383
      *IT_0471 + IT_0480*IT_0481 + IT_0484*IT_0485);
