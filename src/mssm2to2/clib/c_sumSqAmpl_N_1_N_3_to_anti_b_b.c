        ...
        )
{
    ...
    const ccomplex_t IT_0169 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0170 = IT_0002*IT_0169;
    const ccomplex_t IT_0171 = 1.4142135623731*IT_0170;
    const ccomplex_t IT_0172 = m_b*N_d3*e_em*IT_0027*U_sb_01;
    ...
    const ccomplex_t IT_0188 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0189 = m_b*N_d3*e_em*IT_0027*conj(U_sb_10);
    const ccomplex_t IT_0190 = IT_0135*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = N_B3*e_em*conj(U_sb_00);
    const ccomplex_t IT_0193 = IT_0002*IT_0192;
    const ccomplex_t IT_0194 = 1.4142135623731*IT_0193;
    const ccomplex_t IT_0195 = N_W3*e_em*conj(U_sb_00);
    const ccomplex_t IT_0196 = IT_0011*IT_0195;
    const ccomplex_t IT_0197 = 1.4142135623731*IT_0196;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1)*(IT_0191 + 0.333333333333333
      *IT_0194 + -IT_0197);
    ...
    const ccomplex_t IT_0205 = IT_0135*IT_0204;
    ...
    const ccomplex_t IT_0241 = IT_0054*IT_0087;
    const ccomplex_t IT_0242 = IT_0060*IT_0090;
    const ccomplex_t IT_0243 = IT_0062*IT_0087;
    const ccomplex_t IT_0244 = IT_0068*IT_0090;
    const ccomplex_t IT_0245 = IT_0241 + IT_0242 + IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = IT_0056*IT_0095;
    const ccomplex_t IT_0247 = IT_0058*IT_0097;
    const ccomplex_t IT_0248 = IT_0064*IT_0095;
    const ccomplex_t IT_0249 = IT_0066*IT_0097;
    ...
    const ccomplex_t IT_0255 = IT_0056*IT_0087;
    const ccomplex_t IT_0256 = IT_0054*IT_0095;
    const ccomplex_t IT_0257 = IT_0064*IT_0087;
    const ccomplex_t IT_0258 = IT_0062*IT_0095;
    const ccomplex_t IT_0259 = IT_0255 + IT_0256 + IT_0257 + IT_0258;
    const ccomplex_t IT_0260 = IT_0060*IT_0097;
    const ccomplex_t IT_0261 = IT_0058*IT_0090;
    const ccomplex_t IT_0262 = IT_0068*IT_0097;
    const ccomplex_t IT_0263 = IT_0066*IT_0090;
    ...
    const ccomplex_t IT_0270 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0271 = IT_0002*IT_0270;
    const ccomplex_t IT_0272 = 1.4142135623731*IT_0271;
    const ccomplex_t IT_0273 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0274 = IT_0011*IT_0273;
    const ccomplex_t IT_0275 = 1.4142135623731*IT_0274;
    const ccomplex_t IT_0276 = m_b*conj(N_d3)*e_em*IT_0027*U_sb_11;
    const ccomplex_t IT_0277 = IT_0135*IT_0276;
    ...
    const ccomplex_t IT_0284 = m_b*conj(N_d1)*e_em*IT_0027*conj(U_sb_01);
    const ccomplex_t IT_0285 = IT_0135*IT_0284;
    ...
    const ccomplex_t IT_0292 = conj(N_B1)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0293 = IT_0002*IT_0292;
    const ccomplex_t IT_0294 = 1.4142135623731*IT_0293;
    const ccomplex_t IT_0295 = m_b*conj(N_d1)*e_em*IT_0027*conj(U_sb_00);
    ...
    const ccomplex_t IT_0313 = IT_0131*IT_0312;
    ...
    const ccomplex_t IT_0327 = conj(N_W1)*e_em*U_sb_00;
    const ccomplex_t IT_0328 = IT_0011*IT_0327;
    const ccomplex_t IT_0329 = 1.4142135623731*IT_0328;
    const ccomplex_t IT_0330 = conj(N_B1)*e_em*U_sb_00;
    const ccomplex_t IT_0331 = IT_0002*IT_0330;
    const ccomplex_t IT_0332 = 1.4142135623731*IT_0331;
    const ccomplex_t IT_0333 = (0 + _Complex_I*1)*(IT_0326 + -IT_0329 +
       0.333333333333333*IT_0332);
    ...
    const ccomplex_t IT_0350 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0351 = IT_0002*IT_0350;
    const ccomplex_t IT_0352 = 1.4142135623731*IT_0351;
    const ccomplex_t IT_0353 = m_b*conj(N_d3)*e_em*IT_0027*conj(U_sb_01);
    const ccomplex_t IT_0354 = IT_0135*IT_0353;
    ...
    const ccomplex_t IT_0369 = m_b*m_N_3;
    ...
    const ccomplex_t IT_0388 = 3*IT_0269;
    const ccomplex_t IT_0389 = 3*conj(IT_0269);
    ...
    const ccomplex_t IT_0398 = m_b*s_13*m_N_3;
    const ccomplex_t IT_0399 = 6*IT_0235;
    const ccomplex_t IT_0400 = 12*IT_0180;
    const ccomplex_t IT_0401 = IT_0399 + IT_0400;
    const ccomplex_t IT_0402 = 6*conj(IT_0235);
    ...
    const ccomplex_t IT_0455 = m_b*s_14*m_N_3;
    const ccomplex_t IT_0456 = IT_0208*IT_0323;
    const ccomplex_t IT_0457 = IT_0188*IT_0456;
    const ccomplex_t IT_0458 = (0 + _Complex_I*1)*IT_0457;
    const ccomplex_t IT_0459 = IT_0231*IT_0357;
    const ccomplex_t IT_0460 = IT_0212*IT_0459;
    ...
    const ccomplex_t IT_0467 = 24*IT_0235;
    const ccomplex_t IT_0468 = IT_0400 + IT_0467;
    const ccomplex_t IT_0469 = 24*conj(IT_0235);
    ...
    const ccomplex_t IT_0479 = IT_0200*IT_0335;
    const ccomplex_t IT_0480 = IT_0188*IT_0479;
    const ccomplex_t IT_0481 = (0 + _Complex_I*1)*IT_0480;
    const ccomplex_t IT_0482 = IT_0223*IT_0349;
    const ccomplex_t IT_0483 = IT_0212*IT_0482;
    ...
    const ccomplex_t IT_0497 = 24*IT_0423;
    const ccomplex_t IT_0498 = IT_0494 + IT_0497;
    const ccomplex_t IT_0499 = 24*conj(IT_0423);
    const ccomplex_t IT_0500 = IT_0495 + IT_0499;
    const ccomplex_t IT_0501 = 12*IT_0462;
    const ccomplex_t IT_0502 = 12*conj(IT_0462);
    const ccomplex_t IT_0503 = IT_0453*IT_0472 + IT_0452*conj(IT_0472) +
       IT_0451*IT_0485 + IT_0450*conj(IT_0485) + conj(IT_0443)*(24*IT_0472 +
       IT_0488) + IT_0443*(24*conj(IT_0472) + IT_0489) + conj(IT_0462)*IT_0492 +
       IT_0462*IT_0493 + conj(IT_0466)*IT_0498 + IT_0466*IT_0500 + conj(IT_0423)
      *IT_0501 + IT_0423*IT_0502;
    const ccomplex_t IT_0504 = m_b*s_23*m_N_1;
    const ccomplex_t IT_0505 = conj(IT_0315)*IT_0462 + IT_0315*conj(IT_0462) +
      ...
      *IT_0463*conj(IT_0485) + 0.166666666666667*conj(IT_0361)*IT_0501 +
       0.166666666666667*IT_0361*IT_0502;
    const ccomplex_t IT_0506 = s_34*m_N_1*m_N_3;
    const ccomplex_t IT_0507 = IT_0451*IT_0462 + IT_0450*conj(IT_0462) +
       IT_0453*IT_0466 + IT_0452*conj(IT_0466) + conj(IT_0380)*IT_0486 + IT_0380
      *IT_0487 + conj(IT_0423)*IT_0488 + IT_0423*IT_0489 + conj(IT_0472)*IT_0498
       + IT_0472*IT_0500 + conj(IT_0443)*(24*IT_0466 + IT_0501) + IT_0443*(24
      *conj(IT_0466) + IT_0502);
    const ccomplex_t IT_0508 = 24*IT_0380;
    const ccomplex_t IT_0509 = 48*IT_0423;
    const ccomplex_t IT_0510 = IT_0508 + IT_0509;
    const ccomplex_t IT_0511 = 24*conj(IT_0387);
    const ccomplex_t IT_0512 = 24*conj(IT_0380);
    const ccomplex_t IT_0513 = 24*IT_0462;
    const ccomplex_t IT_0514 = 48*IT_0466;
    const ccomplex_t IT_0515 = IT_0513 + IT_0514;
    const ccomplex_t IT_0516 = 24*IT_0485;
    const ccomplex_t IT_0517 = 24*conj(IT_0485);
    const ccomplex_t IT_0518 = 24*conj(IT_0462);
    const ccomplex_t IT_0519 = m_N_1*m_N_3*IT_0083;
    const ccomplex_t IT_0520 = conj(IT_0315)*IT_0401 + IT_0315*IT_0404 + 24
      *IT_0387*conj(IT_0423) + conj(IT_0380)*IT_0452 + IT_0380*IT_0453 + conj
      (IT_0361)*IT_0463 + IT_0361*IT_0464 + conj(IT_0462)*IT_0488 + IT_0462
      *IT_0489 + conj(IT_0443)*IT_0510 + IT_0423*IT_0511 + IT_0443*(48*conj
      (IT_0423) + IT_0512) + conj(IT_0472)*IT_0515 + conj(IT_0466)*(48*IT_0472 +
       IT_0516) + IT_0466*IT_0517 + IT_0472*IT_0518;
    const ccomplex_t IT_0521 = s_13 + s_14;
    const ccomplex_t IT_0522 = IT_0369*IT_0521;
    const ccomplex_t IT_0523 = 6*IT_0053;
    const ccomplex_t IT_0524 = 6*conj(IT_0053);
    const ccomplex_t IT_0525 = 12*IT_0053;
    const ccomplex_t IT_0526 = 12*conj(IT_0053);
    const ccomplex_t IT_0527 = 12*IT_0082;
    const ccomplex_t IT_0528 = 12*conj(IT_0082);
    const ccomplex_t IT_0529 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0530 = (-12)*IT_0082;
    const ccomplex_t IT_0531 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0532 = (-6)*IT_0053;
    const ccomplex_t IT_0533 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0534 = (-12)*IT_0053*conj(IT_0423) + (-6)*conj(IT_0082
      )*((-0.166666666666667)*IT_0450 + IT_0485) + (-6)*IT_0082*((
      -0.166666666666667)*IT_0451 + conj(IT_0485)) + conj(IT_0462)*IT_0523 +
       IT_0462*IT_0524 + conj(IT_0466)*IT_0525 + IT_0466*IT_0526 + conj(IT_0443)
      *IT_0527 + IT_0443*IT_0528 + IT_0423*IT_0529 + conj(IT_0472)*IT_0530 +
       IT_0472*IT_0531 + conj(IT_0380)*IT_0532 + IT_0380*IT_0533;
    const ccomplex_t IT_0535 = IT_0181 + IT_0183 + IT_0185 + IT_0236;
    const ccomplex_t IT_0536 = 6*IT_0082;
    const ccomplex_t IT_0537 = 6*conj(IT_0082);
    const ccomplex_t IT_0538 = IT_0084*IT_0362;
    const ccomplex_t IT_0539 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0235 + (
      -0.0416666666666667)*IT_0396) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0235) + (-0.0416666666666667)*IT_0397) + (-0.166666666666667)*conj
      (IT_0361)*IT_0523 + (-0.166666666666667)*IT_0361*IT_0524 + (
      -0.166666666666667)*conj(IT_0315)*IT_0532 + (-0.166666666666667)*IT_0315
      *IT_0533;
    const ccomplex_t IT_0540 = s_23 + s_24;
    const ccomplex_t IT_0541 = IT_0390*IT_0540;
    const ccomplex_t IT_0542 = (-6)*IT_0082;
    const ccomplex_t IT_0543 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0544 = (-12)*IT_0053*conj(IT_0443) + conj(IT_0485)
      *IT_0523 + IT_0485*IT_0524 + conj(IT_0472)*IT_0525 + IT_0472*IT_0526 +
       conj(IT_0423)*IT_0527 + IT_0423*IT_0528 + IT_0443*IT_0529 + conj(IT_0466)
      *IT_0530 + IT_0466*IT_0531 + conj(IT_0387)*IT_0532 + IT_0387*IT_0533 +
       conj(IT_0380)*IT_0536 + IT_0380*IT_0537 + conj(IT_0462)*IT_0542 + IT_0462
      *IT_0543;
    const ccomplex_t IT_0545 = IT_0181 + IT_0182 + IT_0184 + IT_0185;
    const ccomplex_t IT_0546 = (-2)*IT_0372;
    const ccomplex_t IT_0547 = (-3)*IT_0130;
    const ccomplex_t IT_0548 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0549 = (-3)*IT_0269;
    const ccomplex_t IT_0550 = (-3)*conj(IT_0269);
    const ccomplex_t IT_0551 = 2*IT_0393;
    const ccomplex_t IT_0552 = (-4)*IT_0372;
    const ccomplex_t IT_0553 = conj(IT_0423) + conj(IT_0466);
    const ccomplex_t IT_0554 = IT_0423 + IT_0466;
    const ccomplex_t IT_0555 = conj(IT_0443) + conj(IT_0472);
    const ccomplex_t IT_0556 = (-2)*IT_0365;
    const ccomplex_t IT_0557 = 4*IT_0393;
    const ccomplex_t IT_0558 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0361 + (-0.166666666666667)*IT_0366*IT_0367) + IT_0269*((-24)*IT_0240
      *conj(IT_0269) + (-6)*IT_0187*conj(IT_0315) + 6*IT_0237*conj(IT_0361) +
      ...
      *IT_0395*(conj(IT_0315)*IT_0361 + IT_0315*conj(IT_0361) +
       0.166666666666667*conj(IT_0235)*IT_0396 + 0.166666666666667*IT_0235
      *IT_0397) + IT_0454 + IT_0490 + IT_0496 + IT_0181*IT_0503 + 6*IT_0504
      *IT_0505 + IT_0506*IT_0507 + IT_0183*(conj(IT_0180)*IT_0400 + 24*IT_0387
      *conj(IT_0443) + conj(IT_0387)*IT_0452 + conj(IT_0315)*IT_0473 + conj
      (IT_0380)*IT_0494 + conj(IT_0423)*IT_0510 + IT_0443*(48*conj(IT_0443) +
       IT_0511) + IT_0423*IT_0512) + IT_0182*(conj(IT_0235)*IT_0424 + conj
      (IT_0361)*IT_0444 + conj(IT_0485)*IT_0488 + conj(IT_0462)*IT_0501 + conj
      (IT_0466)*IT_0515 + conj(IT_0472)*IT_0516 + IT_0472*(48*conj(IT_0472) +
       IT_0517) + IT_0466*IT_0518) + IT_0519*IT_0520 + IT_0522*IT_0534 + IT_0535
      *(conj(IT_0180)*IT_0532 + IT_0180*IT_0533 + conj(IT_0315)*IT_0536 +
       IT_0315*IT_0537) + (-6)*IT_0538*IT_0539 + IT_0541*IT_0544 + (conj(IT_0235
      )*IT_0523 + IT_0235*IT_0524 + conj(IT_0361)*IT_0542 + IT_0361*IT_0543)
      *IT_0545 + IT_0546*(conj(IT_0462)*IT_0547 + IT_0462*IT_0548 + conj(IT_0485
      )*IT_0549 + IT_0485*IT_0550) + (conj(IT_0485)*IT_0547 + IT_0485*IT_0548 +
       conj(IT_0462)*IT_0549 + IT_0462*IT_0550)*IT_0551 + IT_0552*((IT_0443 +
       IT_0472)*IT_0550 + IT_0547*IT_0553 + IT_0548*IT_0554 + IT_0549*IT_0555) +
       (conj(IT_0315)*IT_0367 + IT_0315*IT_0368 + conj(IT_0180)*IT_0388 +
       IT_0180*IT_0389 + conj(IT_0361)*IT_0547 + IT_0361*IT_0548 + conj(IT_0235)
      *IT_0549 + IT_0235*IT_0550)*IT_0556 + ((IT_0443 + IT_0472)*IT_0548 +
       IT_0549*IT_0553 + IT_0550*IT_0554 + IT_0547*IT_0555)*IT_0557;
