...
ccomplex_return_t c_sumSqAmpl_N_1_N_3_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0140 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
    ...
    const ccomplex_t IT_0168 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0169 = (-0.5)*IT_0146;
    const ccomplex_t IT_0170 = N_B3*e_em;
    const ccomplex_t IT_0171 = IT_0002*IT_0170;
    const ccomplex_t IT_0172 = 1.4142135623731*IT_0171;
    const ccomplex_t IT_0173 = N_W3*e_em;
    ...
    const ccomplex_t IT_0218 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
    ...
    const ccomplex_t IT_0247 = IT_0168*IT_0246;
    ...
    const ccomplex_t IT_0275 = IT_0149*IT_0217;
    const ccomplex_t IT_0276 = IT_0145*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1)*IT_0276;
    const ccomplex_t IT_0278 = IT_0141*IT_0224;
    const ccomplex_t IT_0279 = IT_0131*IT_0278;
    ...
    const ccomplex_t IT_0284 = m_d*m_N_1;
    ...
    const ccomplex_t IT_0349 = m_d*s_14*m_N_3;
    ...
    const ccomplex_t IT_0353 = IT_0169*IT_0245;
    ...
    const ccomplex_t IT_0373 = IT_0177*IT_0244;
    ...
    const ccomplex_t IT_0385 = m_d*s_24*m_N_1;
    ...
    const ccomplex_t IT_0391 = s_34*m_N_1*m_N_3;
    const ccomplex_t IT_0392 = 24*IT_0337 + IT_0346;
    const ccomplex_t IT_0393 = 24*conj(IT_0337);
    const ccomplex_t IT_0394 = IT_0347 + IT_0393;
    const ccomplex_t IT_0395 = 24*IT_0317;
    const ccomplex_t IT_0396 = IT_0388 + IT_0395;
    const ccomplex_t IT_0397 = 24*conj(IT_0317);
    const ccomplex_t IT_0398 = IT_0389 + IT_0397;
    const ccomplex_t IT_0399 = 12*IT_0356;
    const ccomplex_t IT_0400 = 12*conj(IT_0356);
    const ccomplex_t IT_0401 = IT_0345*IT_0356 + IT_0344*conj(IT_0356) + conj
      (IT_0274)*IT_0380 + IT_0274*IT_0381 + conj(IT_0317)*IT_0382 + IT_0317
      *IT_0383 + conj(IT_0360)*IT_0392 + IT_0360*IT_0394 + conj(IT_0366)*IT_0396
       + IT_0366*IT_0398 + conj(IT_0337)*IT_0399 + IT_0337*IT_0400;
    const ccomplex_t IT_0402 = IT_0345*IT_0379 + IT_0344*conj(IT_0379) + conj
      (IT_0337)*IT_0382 + IT_0337*IT_0383 + conj(IT_0356)*IT_0386 + IT_0356
      *IT_0387 + conj(IT_0366)*IT_0392 + IT_0366*IT_0394 + conj(IT_0360)*IT_0396
       + IT_0360*IT_0398 + conj(IT_0317)*IT_0399 + IT_0317*IT_0400;
    const ccomplex_t IT_0403 = m_d*s_23*m_N_1;
    const ccomplex_t IT_0404 = conj(IT_0236)*IT_0356 + IT_0236*conj(IT_0356) +
      ...
      *IT_0357*conj(IT_0379) + 0.166666666666667*conj(IT_0255)*IT_0399 +
       0.166666666666667*IT_0255*IT_0400;
    const ccomplex_t IT_0405 = 24*IT_0274;
    const ccomplex_t IT_0406 = 48*IT_0317;
    const ccomplex_t IT_0407 = IT_0405 + IT_0406;
    const ccomplex_t IT_0408 = 24*IT_0281;
    const ccomplex_t IT_0409 = 24*conj(IT_0281);
    const ccomplex_t IT_0410 = 24*conj(IT_0274);
    const ccomplex_t IT_0411 = m_N_1*m_N_3*IT_0083;
    const ccomplex_t IT_0412 = 24*conj(IT_0379);
    const ccomplex_t IT_0413 = 48*conj(IT_0366);
    const ccomplex_t IT_0414 = IT_0412 + IT_0413;
    const ccomplex_t IT_0415 = 24*IT_0379;
    const ccomplex_t IT_0416 = 24*IT_0356;
    const ccomplex_t IT_0417 = 24*conj(IT_0356);
    const ccomplex_t IT_0418 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0274)*IT_0346 + IT_0274*IT_0347 + conj(IT_0255)*IT_0357 + IT_0255
      *IT_0358 + conj(IT_0356)*IT_0382 + IT_0356*IT_0383 + conj(IT_0337)*IT_0407
       + conj(IT_0317)*IT_0408 + IT_0317*IT_0409 + IT_0337*(48*conj(IT_0317) +
       IT_0410) + IT_0360*IT_0414 + conj(IT_0360)*(48*IT_0366 + IT_0415) + conj
      (IT_0366)*IT_0416 + IT_0366*IT_0417;
    const ccomplex_t IT_0419 = s_13 + s_14;
    const ccomplex_t IT_0420 = IT_0263*IT_0419;
    const ccomplex_t IT_0421 = 6*IT_0053;
    const ccomplex_t IT_0422 = 6*conj(IT_0053);
    const ccomplex_t IT_0423 = 12*IT_0053;
    ...
    const ccomplex_t IT_0432 = (-12)*IT_0053*conj(IT_0317) + (-6)*conj(IT_0082
      )*((-0.166666666666667)*IT_0344 + IT_0379) + (-6)*IT_0082*((
      -0.166666666666667)*IT_0345 + conj(IT_0379)) + conj(IT_0356)*IT_0421 +
       IT_0356*IT_0422 + conj(IT_0360)*IT_0423 + IT_0360*IT_0424 + conj(IT_0337)
      *IT_0425 + IT_0337*IT_0426 + IT_0317*IT_0427 + conj(IT_0366)*IT_0428 +
       IT_0366*IT_0429 + conj(IT_0274)*IT_0430 + IT_0274*IT_0431;
    const ccomplex_t IT_0433 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0434 = 6*IT_0082;
    const ccomplex_t IT_0435 = 6*conj(IT_0082);
    const ccomplex_t IT_0436 = IT_0084*IT_0256;
    const ccomplex_t IT_0437 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0181 + (
      -0.0416666666666667)*IT_0290) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0181) + (-0.0416666666666667)*IT_0291) + (-0.166666666666667)*conj
      (IT_0255)*IT_0421 + (-0.166666666666667)*IT_0255*IT_0422 + (
      -0.166666666666667)*conj(IT_0236)*IT_0430 + (-0.166666666666667)*IT_0236
      *IT_0431;
    ...
    const ccomplex_t IT_0442 = (-12)*IT_0053*conj(IT_0337) + conj(IT_0379)
      *IT_0421 + IT_0379*IT_0422 + conj(IT_0366)*IT_0423 + IT_0366*IT_0424 +
       conj(IT_0317)*IT_0425 + IT_0317*IT_0426 + IT_0337*IT_0427 + conj(IT_0360)
      *IT_0428 + IT_0360*IT_0429 + conj(IT_0281)*IT_0430 + IT_0281*IT_0431 +
       conj(IT_0274)*IT_0434 + IT_0274*IT_0435 + conj(IT_0356)*IT_0440 + IT_0356
      *IT_0441;
    ...
    const ccomplex_t IT_0450 = 4*IT_0287;
    const ccomplex_t IT_0451 = conj(IT_0337) + conj(IT_0366);
    const ccomplex_t IT_0452 = IT_0337 + IT_0366;
    const ccomplex_t IT_0453 = conj(IT_0317) + conj(IT_0360);
    ...
    const ccomplex_t IT_0456 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0348 + IT_0384 + IT_0390 + IT_0391*IT_0401 + IT_0154
      *IT_0402 + 6*IT_0403*IT_0404 + IT_0156*(conj(IT_0153)*IT_0294 + conj
      (IT_0281)*IT_0346 + conj(IT_0236)*IT_0367 + conj(IT_0274)*IT_0388 + conj
      (IT_0317)*IT_0407 + conj(IT_0337)*IT_0408 + IT_0337*(48*conj(IT_0337) +
       IT_0409) + IT_0317*IT_0410) + IT_0155*(conj(IT_0181)*IT_0318 + conj
      (IT_0255)*IT_0338 + conj(IT_0379)*IT_0382 + conj(IT_0356)*IT_0399 +
       IT_0366*IT_0414 + conj(IT_0366)*IT_0415 + conj(IT_0360)*IT_0416 + IT_0360
      *(48*conj(IT_0360) + IT_0417)) + IT_0411*IT_0418 + IT_0420*IT_0432 +
       IT_0433*(conj(IT_0153)*IT_0430 + IT_0153*IT_0431 + conj(IT_0236)*IT_0434 
      + IT_0236*IT_0435) + (-6)*IT_0436*IT_0437 + IT_0439*IT_0442 + (conj
      (IT_0181)*IT_0421 + IT_0181*IT_0422 + conj(IT_0255)*IT_0440 + IT_0255
      *IT_0441)*IT_0443 + IT_0444*(conj(IT_0356)*IT_0445 + IT_0356*IT_0446 +
       conj(IT_0379)*IT_0447 + IT_0379*IT_0448) + (conj(IT_0379)*IT_0445 +
       IT_0379*IT_0446 + conj(IT_0356)*IT_0447 + IT_0356*IT_0448)*IT_0449 +
       IT_0450*((IT_0317 + IT_0360)*IT_0448 + IT_0445*IT_0451 + IT_0446*IT_0452 
      + IT_0447*IT_0453) + (conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj
      (IT_0153)*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0445 + IT_0255
      *IT_0446 + conj(IT_0181)*IT_0447 + IT_0181*IT_0448)*IT_0454 + ((IT_0317 +
       IT_0360)*IT_0446 + IT_0447*IT_0451 + IT_0448*IT_0452 + IT_0445*IT_0453)
      *IT_0455;
