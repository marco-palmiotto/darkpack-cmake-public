...
ccomplex_return_t c_sumSqAmpl_N_1_N_3_to_anti_e_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0211 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0236 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    ...
    const ccomplex_t IT_0243 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    ...
    const ccomplex_t IT_0344 = m_e*s_14*m_N_3;
    ...
    const ccomplex_t IT_0380 = m_e*s_24*m_N_1;
    ...
    const ccomplex_t IT_0386 = m_e*s_23*m_N_1;
