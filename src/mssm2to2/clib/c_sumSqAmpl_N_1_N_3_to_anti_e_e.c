        ...
        )
{
    ...
    const ccomplex_t IT_0178 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0190 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0011*IT_0027*IT_0028;
    const ccomplex_t IT_0191 = 0.5*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0402 = m_N_1*m_N_3*IT_0083;
    ...
    const ccomplex_t IT_0439 = s_34*m_N_1*m_N_3;
