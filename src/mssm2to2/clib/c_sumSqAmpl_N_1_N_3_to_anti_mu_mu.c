...
ccomplex_return_t c_sumSqAmpl_N_1_N_3_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0132 = IT_0054*IT_0090;
    const ccomplex_t IT_0133 = IT_0064*IT_0087;
    const ccomplex_t IT_0134 = IT_0062*IT_0090;
    const ccomplex_t IT_0135 = IT_0131 + IT_0132 + IT_0133 + IT_0134;
    const ccomplex_t IT_0136 = IT_0060*IT_0095;
    const ccomplex_t IT_0137 = IT_0058*IT_0097;
    const ccomplex_t IT_0138 = IT_0068*IT_0095;
    ...
    const ccomplex_t IT_0146 = IT_0060*IT_0097;
    const ccomplex_t IT_0147 = IT_0062*IT_0087;
    const ccomplex_t IT_0148 = IT_0068*IT_0097;
    const ccomplex_t IT_0149 = IT_0145 + IT_0146 + IT_0147 + IT_0148;
    const ccomplex_t IT_0150 = IT_0056*IT_0090;
    const ccomplex_t IT_0151 = IT_0058*IT_0095;
    const ccomplex_t IT_0152 = IT_0064*IT_0090;
    const ccomplex_t IT_0153 = IT_0066*IT_0095;
    ...
    const ccomplex_t IT_0160 = m_N_1*m_N_3;
    ...
    const ccomplex_t IT_0168 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_smu_R*
    ...
    const ccomplex_t IT_0171 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0176 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0011*IT_0027*IT_0046;
    const ccomplex_t IT_0178 = (-0.5)*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
    ...
    const ccomplex_t IT_0185 = m_mu*m_N_1;
    ...
    const ccomplex_t IT_0209 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0011*IT_0027*IT_0046;
    const ccomplex_t IT_0210 = 0.5*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0236 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0237 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0002;
    const ccomplex_t IT_0238 = -IT_0237;
    const ccomplex_t IT_0239 = 0.5*IT_0179;
    ...
    const ccomplex_t IT_0243 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0244 = (-0.5)*IT_0209;
    const ccomplex_t IT_0245 = N_B3*e_em;
    const ccomplex_t IT_0246 = IT_0002*IT_0245;
    const ccomplex_t IT_0247 = 1.4142135623731*IT_0246;
    const ccomplex_t IT_0248 = N_W3*e_em;
    const ccomplex_t IT_0249 = IT_0011*IT_0248;
    const ccomplex_t IT_0250 = 1.4142135623731*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*(IT_0247 + IT_0250);
    ...
    const ccomplex_t IT_0278 = 0.5*IT_0177;
    const ccomplex_t IT_0279 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0002;
    const ccomplex_t IT_0280 = -IT_0279;
    const ccomplex_t IT_0281 = IT_0278*IT_0280;
    const ccomplex_t IT_0282 = IT_0236*IT_0281;
    ...
    const ccomplex_t IT_0320 = conj(N_d1)*N_d3*e_em;
    const ccomplex_t IT_0321 = IT_0295*IT_0320;
    const ccomplex_t IT_0322 = IT_0298*IT_0320;
    const ccomplex_t IT_0323 = conj(N_u1)*N_u3*e_em;
    ...
    const ccomplex_t IT_0345 = IT_0238*IT_0280;
    const ccomplex_t IT_0346 = IT_0236*IT_0345;
    const ccomplex_t IT_0347 = (0 + _Complex_I*1)*IT_0346;
    const ccomplex_t IT_0348 = IT_0244*IT_0274;
    const ccomplex_t IT_0349 = IT_0243*IT_0348;
    ...
    const ccomplex_t IT_0368 = IT_0252*IT_0273;
    const ccomplex_t IT_0369 = IT_0243*IT_0368;
    const ccomplex_t IT_0370 = (0 + _Complex_I*1)*IT_0369;
    const ccomplex_t IT_0371 = IT_0239*IT_0278;
    const ccomplex_t IT_0372 = IT_0236*IT_0371;
    ...
    const ccomplex_t IT_0380 = m_mu*s_24*m_N_1;
    ...
    const ccomplex_t IT_0386 = m_mu*s_23*m_N_1;
    ...
    const ccomplex_t IT_0390 = 8*IT_0216;
    const ccomplex_t IT_0391 = 16*IT_0313;
    const ccomplex_t IT_0392 = IT_0390 + IT_0391;
    const ccomplex_t IT_0393 = 8*IT_0184;
    const ccomplex_t IT_0394 = 8*conj(IT_0184);
    const ccomplex_t IT_0395 = 8*conj(IT_0216);
    const ccomplex_t IT_0396 = m_N_1*m_N_3*IT_0083;
    const ccomplex_t IT_0397 = 8*conj(IT_0374);
    const ccomplex_t IT_0398 = 16*conj(IT_0361);
    const ccomplex_t IT_0399 = IT_0397 + IT_0398;
    const ccomplex_t IT_0400 = 8*IT_0374;
    const ccomplex_t IT_0401 = 8*IT_0351;
    const ccomplex_t IT_0402 = 8*conj(IT_0351);
    const ccomplex_t IT_0403 = conj(IT_0265)*IT_0291 + IT_0265*IT_0294 + conj
      ...
      *IT_0353 + conj(IT_0351)*IT_0377 + IT_0351*IT_0378 + conj(IT_0332)*IT_0392
       + conj(IT_0313)*IT_0393 + IT_0313*IT_0394 + IT_0332*(16*conj(IT_0313) +
       IT_0395) + IT_0355*IT_0399 + conj(IT_0355)*(16*IT_0361 + IT_0400) + conj
      (IT_0361)*IT_0401 + IT_0361*IT_0402;
    const ccomplex_t IT_0404 = IT_0229 + IT_0231 + IT_0233 + IT_0257;
    const ccomplex_t IT_0405 = 2*IT_0082;
    const ccomplex_t IT_0406 = 2*conj(IT_0082);
    const ccomplex_t IT_0407 = (-2)*IT_0053;
    const ccomplex_t IT_0408 = (-2)*conj(IT_0053);
    const ccomplex_t IT_0409 = IT_0084*IT_0160;
    const ccomplex_t IT_0410 = 2*IT_0053;
    const ccomplex_t IT_0411 = 2*conj(IT_0053);
    const ccomplex_t IT_0412 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0256 + (
      -0.125)*IT_0286) + 4*IT_0082*(conj(IT_0053) + 1./4*conj(IT_0256) + (-0.125
      )*IT_0287) + (-0.5)*conj(IT_0265)*IT_0407 + (-0.5)*IT_0265*IT_0408 + (-0.5
      )*conj(IT_0284)*IT_0410 + (-0.5)*IT_0284*IT_0411;
    const ccomplex_t IT_0413 = IT_0229 + IT_0230 + IT_0232 + IT_0233;
    const ccomplex_t IT_0414 = (-2)*IT_0082;
    const ccomplex_t IT_0415 = (-2)*conj(IT_0082);
    const ccomplex_t IT_0416 = (-2)*IT_0220;
    const ccomplex_t IT_0417 = -IT_0130;
    const ccomplex_t IT_0418 = -conj(IT_0130);
    const ccomplex_t IT_0419 = -IT_0159;
    const ccomplex_t IT_0420 = -conj(IT_0159);
    const ccomplex_t IT_0421 = 2*IT_0188;
    const ccomplex_t IT_0422 = 4*IT_0188;
    const ccomplex_t IT_0423 = conj(IT_0332) + conj(IT_0361);
    const ccomplex_t IT_0424 = IT_0332 + IT_0361;
    const ccomplex_t IT_0425 = conj(IT_0313) + conj(IT_0355);
    const ccomplex_t IT_0426 = (-2)*IT_0163;
    const ccomplex_t IT_0427 = (-4)*IT_0220;
    const ccomplex_t IT_0428 = s_34*m_N_1*m_N_3;
    const ccomplex_t IT_0429 = 0.125*IT_0341;
    const ccomplex_t IT_0430 = IT_0332 + IT_0429;
    const ccomplex_t IT_0431 = 0.125*IT_0342;
    const ccomplex_t IT_0432 = conj(IT_0332) + IT_0431;
    const ccomplex_t IT_0433 = 8*IT_0313;
    const ccomplex_t IT_0434 = IT_0383 + IT_0433;
    const ccomplex_t IT_0435 = 8*conj(IT_0313);
    const ccomplex_t IT_0436 = IT_0384 + IT_0435;
    const ccomplex_t IT_0437 = 0.125*IT_0332;
    const ccomplex_t IT_0438 = 0.125*conj(IT_0332);
    const ccomplex_t IT_0439 = 0.125*IT_0351;
    const ccomplex_t IT_0440 = 0.125*conj(IT_0351);
    const ccomplex_t IT_0441 = 0.125*IT_0313;
    const ccomplex_t IT_0442 = 0.125*conj(IT_0313);
    const ccomplex_t IT_0443 = 0.125*conj(IT_0216)*IT_0375 + 0.125*IT_0216
      *IT_0376 + conj(IT_0355)*IT_0430 + IT_0355*IT_0432 + 0.125*conj(IT_0361)
      *IT_0434 + 0.125*IT_0361*IT_0436 + IT_0388*IT_0437 + IT_0387*IT_0438 +
       IT_0340*IT_0439 + IT_0339*IT_0440 + IT_0378*IT_0441 + IT_0377*IT_0442;
    const ccomplex_t IT_0444 = 0.125*IT_0340*IT_0374 + 0.125*IT_0339*conj
      (IT_0374) + conj(IT_0361)*IT_0430 + IT_0361*IT_0432 + 0.125*conj(IT_0355)
      *IT_0434 + 0.125*IT_0355*IT_0436 + IT_0378*IT_0437 + IT_0377*IT_0438 +
       IT_0382*IT_0439 + IT_0381*IT_0440 + IT_0388*IT_0441 + IT_0387*IT_0442;
    const ccomplex_t IT_0445 = s_23 + s_24;
    const ccomplex_t IT_0446 = IT_0185*IT_0445;
    const ccomplex_t IT_0447 = 4*IT_0082;
    const ccomplex_t IT_0448 = (-4)*conj(IT_0082);
    const ccomplex_t IT_0449 = (-4)*IT_0082;
    const ccomplex_t IT_0450 = (-0.25)*conj(IT_0355);
    const ccomplex_t IT_0451 = 4*conj(IT_0053);
    const ccomplex_t IT_0452 = (-0.25)*IT_0361;
    const ccomplex_t IT_0453 = 4*IT_0053;
    const ccomplex_t IT_0454 = (-0.25)*conj(IT_0361);
    const ccomplex_t IT_0455 = (-4)*conj(IT_0053);
    const ccomplex_t IT_0456 = (-0.25)*IT_0332;
    const ccomplex_t IT_0457 = (-0.25)*IT_0216;
    const ccomplex_t IT_0458 = (-0.25)*conj(IT_0216);
    const ccomplex_t IT_0459 = (-0.25)*IT_0351;
    const ccomplex_t IT_0460 = (-0.25)*conj(IT_0351);
    const ccomplex_t IT_0461 = 4*conj(IT_0082);
    const ccomplex_t IT_0462 = (-0.25)*IT_0313;
    const ccomplex_t IT_0463 = IT_0053*conj(IT_0332) + (-0.25)*conj(IT_0184)
      *IT_0407 + (-0.25)*IT_0184*IT_0408 + (-0.25)*conj(IT_0374)*IT_0410 + (
      -0.25)*IT_0374*IT_0411 + (-0.25)*conj(IT_0313)*IT_0447 + (-0.25)*IT_0355
      *IT_0448 + IT_0449*IT_0450 + IT_0451*IT_0452 + IT_0453*IT_0454 + IT_0455
      *IT_0456 + IT_0406*IT_0457 + IT_0405*IT_0458 + IT_0415*IT_0459 + IT_0414
      *IT_0460 + IT_0461*IT_0462;
    const ccomplex_t IT_0464 = s_13 + s_14;
    const ccomplex_t IT_0465 = IT_0217*IT_0464;
    const ccomplex_t IT_0466 = IT_0053*conj(IT_0313) + 0.5*conj(IT_0082)*((
      -0.5)*IT_0339 + IT_0374) + 0.5*IT_0082*((-0.5)*IT_0340 + conj(IT_0374)) + 
      (-0.25)*conj(IT_0332)*IT_0447 + (-0.25)*IT_0355*IT_0451 + IT_0448*IT_0452 
      + IT_0450*IT_0453 + IT_0449*IT_0454 + IT_0408*IT_0457 + IT_0407*IT_0458 +
       IT_0411*IT_0459 + IT_0410*IT_0460 + IT_0456*IT_0461 + IT_0455*IT_0462;
    const ccomplex_t IT_0467 = 8*(IT_0053*conj(IT_0053) + IT_0082*conj(IT_0082
      ...
      *IT_0235*IT_0265 + 2*IT_0258*IT_0284) + IT_0159*(IT_0189*conj(IT_0216) +
      ...
      (IT_0184)*IT_0341 + conj(IT_0265)*IT_0362 + conj(IT_0216)*IT_0383 + conj
      (IT_0313)*IT_0392 + conj(IT_0332)*IT_0393 + IT_0332*(16*conj(IT_0332) +
       IT_0394) + IT_0313*IT_0395) + IT_0230*(conj(IT_0256)*IT_0314 + conj
      (IT_0284)*IT_0333 + conj(IT_0374)*IT_0377 + conj(IT_0351)*IT_0387 +
       IT_0361*IT_0399 + conj(IT_0361)*IT_0400 + conj(IT_0355)*IT_0401 + IT_0355
      *(16*conj(IT_0355) + IT_0402)) + IT_0396*IT_0403 + IT_0404*(conj(IT_0265)
      *IT_0405 + IT_0265*IT_0406 + conj(IT_0228)*IT_0407 + IT_0228*IT_0408) + (
      -2)*IT_0409*IT_0412 + IT_0413*(conj(IT_0256)*IT_0410 + IT_0256*IT_0411 +
       conj(IT_0284)*IT_0414 + IT_0284*IT_0415) + IT_0416*(conj(IT_0351)*IT_0417
       + IT_0351*IT_0418 + conj(IT_0374)*IT_0419 + IT_0374*IT_0420) + (conj
      (IT_0374)*IT_0417 + IT_0374*IT_0418 + conj(IT_0351)*IT_0419 + IT_0351
      *IT_0420)*IT_0421 + IT_0422*((IT_0313 + IT_0355)*IT_0420 + IT_0417*IT_0423
       + IT_0418*IT_0424 + IT_0419*IT_0425) + (conj(IT_0159)*IT_0228 + IT_0159
      *conj(IT_0228) + conj(IT_0130)*IT_0265 + IT_0130*conj(IT_0265) + conj
      (IT_0284)*IT_0417 + IT_0284*IT_0418 + conj(IT_0256)*IT_0419 + IT_0256
      *IT_0420)*IT_0426 + ((IT_0313 + IT_0355)*IT_0418 + IT_0419*IT_0423 +
       IT_0420*IT_0424 + IT_0417*IT_0425)*IT_0427 + 8*IT_0428*IT_0443 + 8
      *IT_0229*IT_0444 + (-4)*IT_0446*IT_0463 + (-4)*IT_0465*IT_0466;
