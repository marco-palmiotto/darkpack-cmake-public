...
ccomplex_return_t c_sumSqAmpl_N_1_N_3_to_anti_nu_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = conj(N_u1)*N_u3*e_em;
    ...
    const ccomplex_t IT_0048 = N_u1*conj(N_u3)*e_em;
    const ccomplex_t IT_0049 = IT_0026*IT_0048;
    const ccomplex_t IT_0050 = IT_0029*IT_0048;
    const ccomplex_t IT_0051 = N_d1*conj(N_d3)*e_em;
