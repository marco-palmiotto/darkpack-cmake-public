...
ccomplex_return_t c_sumSqAmpl_N_1_N_3_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0349 = m_u*s_14*m_N_3;
