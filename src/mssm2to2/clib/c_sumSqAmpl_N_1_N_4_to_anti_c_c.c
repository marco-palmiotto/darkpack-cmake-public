...
ccomplex_return_t c_sumSqAmpl_N_1_N_4_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
    ...
    const ccomplex_t IT_0284 = m_c*m_N_1;
    ...
    const ccomplex_t IT_0385 = m_c*s_24*m_N_1;
    ...
    const ccomplex_t IT_0391 = m_c*s_23*m_N_1;
    ...
    const ccomplex_t IT_0404 = s_34*m_N_1*m_N_4;
    ...
    const ccomplex_t IT_0418 = m_N_1*m_N_4*IT_0083;
