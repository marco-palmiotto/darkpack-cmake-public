...
ccomplex_return_t c_sumSqAmpl_N_1_N_4_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0140 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
    ...
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0161 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0002;
    const ccomplex_t IT_0163 = (-0.333333333333333)*IT_0162;
    const ccomplex_t IT_0164 = 0.5*IT_0140;
    ...
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0002;
    ...
    const ccomplex_t IT_0221 = IT_0145*IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1)*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0234 = IT_0131*IT_0233;
    ...
    const ccomplex_t IT_0284 = m_d*m_N_4;
    ...
    const ccomplex_t IT_0324 = conj(N_d1)*N_d4*e_em;
    const ccomplex_t IT_0325 = IT_0299*IT_0324;
    const ccomplex_t IT_0326 = IT_0302*IT_0324;
    const ccomplex_t IT_0327 = conj(N_u1)*N_u4*e_em;
    ...
    const ccomplex_t IT_0350 = IT_0163*IT_0251;
    const ccomplex_t IT_0351 = IT_0161*IT_0350;
    ...
    const ccomplex_t IT_0376 = IT_0164*IT_0249;
    const ccomplex_t IT_0377 = IT_0161*IT_0376;
    ...
    const ccomplex_t IT_0385 = s_34*m_N_1*m_N_4;
    ...
    const ccomplex_t IT_0396 = IT_0345*IT_0356 + IT_0344*conj(IT_0356) + (24
      *IT_0337 + IT_0346)*conj(IT_0360) + conj(IT_0281)*IT_0380 + IT_0281
      *IT_0381 + conj(IT_0317)*IT_0382 + IT_0317*IT_0383 + IT_0360*IT_0387 +
       conj(IT_0366)*IT_0390 + IT_0366*IT_0393 + conj(IT_0337)*IT_0394 + IT_0337
      *IT_0395;
    const ccomplex_t IT_0397 = 24*conj(IT_0379);
    const ccomplex_t IT_0398 = 48*conj(IT_0366);
    const ccomplex_t IT_0399 = IT_0397 + IT_0398;
    const ccomplex_t IT_0400 = 24*IT_0379;
    const ccomplex_t IT_0401 = 24*IT_0356;
    const ccomplex_t IT_0402 = 24*conj(IT_0356);
    const ccomplex_t IT_0403 = m_N_1*m_N_4*IT_0083;
    const ccomplex_t IT_0404 = 24*conj(IT_0281);
    const ccomplex_t IT_0405 = 24*IT_0274;
    const ccomplex_t IT_0406 = 24*conj(IT_0274);
    const ccomplex_t IT_0407 = 48*IT_0317;
    const ccomplex_t IT_0408 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0281)*IT_0346 + conj(IT_0255)*IT_0357 + IT_0255*IT_0358 + conj(IT_0356
      )*IT_0382 + IT_0356*IT_0383 + IT_0281*IT_0387 + IT_0360*IT_0399 + conj
      (IT_0360)*(48*IT_0366 + IT_0400) + conj(IT_0366)*IT_0401 + IT_0366*IT_0402
       + IT_0337*(48*conj(IT_0317) + IT_0404) + conj(IT_0317)*IT_0405 + IT_0317
      *IT_0406 + conj(IT_0337)*IT_0407;
    const ccomplex_t IT_0409 = IT_0156*(conj(IT_0153)*IT_0294 + conj(IT_0274)
      *IT_0346 + conj(IT_0236)*IT_0367 + conj(IT_0281)*IT_0388 + IT_0317*IT_0404
       + conj(IT_0337)*IT_0405 + IT_0337*(48*conj(IT_0337) + IT_0406) + conj
      (IT_0317)*(24*IT_0281 + IT_0407));
    ...
    const ccomplex_t IT_0423 = (-12)*IT_0053*conj(IT_0317) + (-6)*conj(IT_0082
      ...
      -0.166666666666667)*IT_0345 + conj(IT_0379)) + conj(IT_0356)*IT_0412 +
       IT_0356*IT_0413 + conj(IT_0360)*IT_0414 + IT_0360*IT_0415 + conj(IT_0337)
      *IT_0416 + IT_0337*IT_0417 + IT_0317*IT_0418 + conj(IT_0366)*IT_0419 +
       IT_0366*IT_0420 + conj(IT_0281)*IT_0421 + IT_0281*IT_0422;
    const ccomplex_t IT_0424 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0425 = 6*IT_0082;
    const ccomplex_t IT_0426 = 6*conj(IT_0082);
    const ccomplex_t IT_0427 = IT_0084*IT_0256;
    const ccomplex_t IT_0428 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0181 + (
    ...
    const ccomplex_t IT_0433 = (-12)*IT_0053*conj(IT_0337) + conj(IT_0379)
      *IT_0412 + IT_0379*IT_0413 + conj(IT_0366)*IT_0414 + IT_0366*IT_0415 +
       conj(IT_0317)*IT_0416 + IT_0317*IT_0417 + IT_0337*IT_0418 + conj(IT_0360)
      *IT_0419 + IT_0360*IT_0420 + conj(IT_0274)*IT_0421 + IT_0274*IT_0422 +
       conj(IT_0281)*IT_0425 + IT_0281*IT_0426 + conj(IT_0356)*IT_0431 + IT_0356
      *IT_0432;
    ...
    const ccomplex_t IT_0443 = conj(IT_0337) + conj(IT_0366);
    const ccomplex_t IT_0444 = IT_0337 + IT_0366;
    const ccomplex_t IT_0445 = conj(IT_0317) + conj(IT_0360);
    const ccomplex_t IT_0446 = IT_0317 + IT_0360;
    const ccomplex_t IT_0447 = (-4)*IT_0287;
    const ccomplex_t IT_0448 = 6*conj(IT_0281);
    const ccomplex_t IT_0449 = 0.166666666666667*conj(IT_0360);
    const ccomplex_t IT_0450 = 0.166666666666667*IT_0379;
    const ccomplex_t IT_0451 = 0.166666666666667*conj(IT_0379);
    const ccomplex_t IT_0452 = 0.166666666666667*IT_0317;
    const ccomplex_t IT_0453 = 0.166666666666667*conj(IT_0317);
    const ccomplex_t IT_0454 = 0.166666666666667*IT_0366;
    const ccomplex_t IT_0455 = 0.166666666666667*conj(IT_0366);
    const ccomplex_t IT_0456 = IT_0281*conj(IT_0356) + 4*conj(IT_0337)*
      (IT_0366 + 0.0416666666666667*IT_0382) + 4*IT_0337*(conj(IT_0366) +
       0.0416666666666667*IT_0383) + 0.166666666666667*IT_0360*IT_0393 +
       0.166666666666667*IT_0356*IT_0448 + IT_0390*IT_0449 + IT_0345*IT_0450 +
       IT_0344*IT_0451 + IT_0395*IT_0452 + IT_0394*IT_0453 + IT_0347*IT_0454 +
       IT_0346*IT_0455;
    const ccomplex_t IT_0457 = m_d*s_24*m_N_1;
    const ccomplex_t IT_0458 = 0.166666666666667*IT_0255;
    const ccomplex_t IT_0459 = conj(IT_0255)*IT_0281 + 0.166666666666667*conj
      (IT_0274)*IT_0295 + 0.166666666666667*IT_0274*IT_0298 + 0.166666666666667
      *IT_0323*IT_0337 + 0.166666666666667*IT_0320*conj(IT_0337) +
       0.166666666666667*conj(IT_0236)*IT_0388 + 0.166666666666667*IT_0236
      *IT_0391 + IT_0343*IT_0452 + IT_0340*IT_0453 + IT_0448*IT_0458;
    const ccomplex_t IT_0460 = m_d*s_23*m_N_1;
    const ccomplex_t IT_0461 = conj(IT_0236)*IT_0356 + IT_0236*conj(IT_0356) +
       0.166666666666667*IT_0360*IT_0372 + 0.166666666666667*conj(IT_0255)
      *IT_0394 + IT_0369*IT_0449 + IT_0358*IT_0450 + IT_0357*IT_0451 + IT_0364
      *IT_0454 + IT_0362*IT_0455 + IT_0395*IT_0458;
    const ccomplex_t IT_0462 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0348 + IT_0384 + IT_0385*IT_0396 + IT_0155*(conj(IT_0181)
      *IT_0318 + conj(IT_0255)*IT_0338 + conj(IT_0379)*IT_0382 + conj(IT_0356)
      *IT_0394 + IT_0366*IT_0399 + conj(IT_0366)*IT_0400 + conj(IT_0360)*IT_0401
       + IT_0360*(48*conj(IT_0360) + IT_0402)) + IT_0403*IT_0408 + IT_0409 +
       IT_0411*IT_0423 + IT_0424*(conj(IT_0153)*IT_0421 + IT_0153*IT_0422 + conj
      (IT_0236)*IT_0425 + IT_0236*IT_0426) + (-6)*IT_0427*IT_0428 + IT_0430
      *IT_0433 + (conj(IT_0181)*IT_0412 + IT_0181*IT_0413 + conj(IT_0255)
      *IT_0431 + IT_0255*IT_0432)*IT_0434 + IT_0435*(conj(IT_0356)*IT_0436 +
       IT_0356*IT_0437 + conj(IT_0379)*IT_0438 + IT_0379*IT_0439) + (conj
      (IT_0379)*IT_0436 + IT_0379*IT_0437 + conj(IT_0356)*IT_0438 + IT_0356
      *IT_0439)*IT_0440 + (conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj
      (IT_0153)*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0436 + IT_0255
      *IT_0437 + conj(IT_0181)*IT_0438 + IT_0181*IT_0439)*IT_0441 + IT_0442*
      (IT_0436*IT_0443 + IT_0437*IT_0444 + IT_0438*IT_0445 + IT_0439*IT_0446) + 
      (IT_0438*IT_0443 + IT_0439*IT_0444 + IT_0436*IT_0445 + IT_0437*IT_0446)
      *IT_0447 + 6*IT_0154*IT_0456 + 6*IT_0457*IT_0459 + 6*IT_0460*IT_0461;
