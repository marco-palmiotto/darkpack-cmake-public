        ...
        )
{
    ...
    const ccomplex_t IT_0160 = m_N_1*m_N_4;
    ...
    const ccomplex_t IT_0402 = m_N_1*m_N_4*IT_0083;
    ...
    const ccomplex_t IT_0454 = s_34*m_N_1*m_N_4;
