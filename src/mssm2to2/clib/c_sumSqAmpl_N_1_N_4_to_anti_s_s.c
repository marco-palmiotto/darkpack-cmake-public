...
ccomplex_return_t c_sumSqAmpl_N_1_N_4_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0140 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
    ...
    const ccomplex_t IT_0161 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0223 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0292 = m_s*s_13*m_N_4;
    ...
    const ccomplex_t IT_0349 = m_s*s_14*m_N_4;
    ...
    const ccomplex_t IT_0408 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      ...
      (IT_0360)*(48*IT_0366 + IT_0400) + conj(IT_0366)*IT_0401 + IT_0366*IT_0402
       + IT_0337*IT_0404 + conj(IT_0317)*(48*IT_0337 + IT_0405) + IT_0317
    ...
    const ccomplex_t IT_0454 = 0.166666666666667*IT_0337;
    const ccomplex_t IT_0455 = 0.166666666666667*conj(IT_0337);
    const ccomplex_t IT_0456 = IT_0281*conj(IT_0356) + 4*(conj(IT_0337) +
       0.0416666666666667*IT_0347)*IT_0366 + 4*(IT_0337 + 0.0416666666666667
      *IT_0346)*conj(IT_0366) + 0.166666666666667*IT_0360*IT_0393 +
       0.166666666666667*IT_0356*IT_0448 + IT_0390*IT_0449 + IT_0345*IT_0450 +
       IT_0344*IT_0451 + IT_0395*IT_0452 + IT_0394*IT_0453 + IT_0383*IT_0454 +
       IT_0382*IT_0455;
    const ccomplex_t IT_0457 = m_s*s_24*m_N_1;
    ...
    const ccomplex_t IT_0459 = conj(IT_0255)*IT_0281 + 0.166666666666667*conj
      ...
      *IT_0452 + IT_0340*IT_0453 + IT_0323*IT_0454 + IT_0320*IT_0455 + IT_0448
      *IT_0458;
    const ccomplex_t IT_0460 = m_s*s_23*m_N_1;
    const ccomplex_t IT_0461 = conj(IT_0236)*IT_0356 + IT_0236*conj(IT_0356) +
      ...
      (IT_0366) + 0.166666666666667*IT_0360*IT_0372 + 0.166666666666667*conj
      (IT_0255)*IT_0394 + IT_0369*IT_0449 + IT_0358*IT_0450 + IT_0357*IT_0451 +
       IT_0395*IT_0458;
