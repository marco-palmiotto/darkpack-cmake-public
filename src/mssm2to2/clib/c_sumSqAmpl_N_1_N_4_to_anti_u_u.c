...
ccomplex_return_t c_sumSqAmpl_N_1_N_4_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0011*IT_0027*IT_0028;
    const ccomplex_t IT_0146 = 0.5*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0187 = IT_0004*IT_0087;
    const ccomplex_t IT_0188 = IT_0008*IT_0090;
    const ccomplex_t IT_0189 = IT_0018*IT_0087;
    const ccomplex_t IT_0190 = IT_0020*IT_0090;
    const ccomplex_t IT_0191 = IT_0187 + IT_0188 + IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = IT_0013*IT_0095;
    const ccomplex_t IT_0193 = IT_0016*IT_0097;
    const ccomplex_t IT_0194 = IT_0022*IT_0095;
    const ccomplex_t IT_0195 = IT_0024*IT_0097;
    ...
    const ccomplex_t IT_0201 = IT_0008*IT_0087;
    const ccomplex_t IT_0202 = IT_0013*IT_0097;
    const ccomplex_t IT_0203 = IT_0020*IT_0087;
    const ccomplex_t IT_0204 = IT_0022*IT_0097;
    const ccomplex_t IT_0205 = IT_0201 + IT_0202 + IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = IT_0004*IT_0090;
    const ccomplex_t IT_0207 = IT_0016*IT_0095;
    const ccomplex_t IT_0208 = IT_0018*IT_0090;
    const ccomplex_t IT_0209 = IT_0024*IT_0095;
    ...
    const ccomplex_t IT_0227 = IT_0142*IT_0226;
    ...
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0011*IT_0027*IT_0028;
    const ccomplex_t IT_0232 = 0.5*IT_0231;
    const ccomplex_t IT_0233 = IT_0230*IT_0232;
    const ccomplex_t IT_0234 = IT_0150*IT_0233;
    ...
    const ccomplex_t IT_0245 = (-0.5)*IT_0231;
    ...
    const ccomplex_t IT_0249 = 0.5*IT_0216;
    ...
    const ccomplex_t IT_0256 = m_N_1*m_N_4;
    ...
    const ccomplex_t IT_0263 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0284 = m_u*m_N_1;
    ...
    const ccomplex_t IT_0292 = m_u*s_13*m_N_4;
    ...
    const ccomplex_t IT_0304 = N_d1*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0318 = 12*conj(IT_0181);
    const ccomplex_t IT_0319 = 24*conj(IT_0153);
    const ccomplex_t IT_0320 = IT_0318 + IT_0319;
    const ccomplex_t IT_0321 = conj(N_d1)*N_d4*e_em;
    const ccomplex_t IT_0322 = IT_0299*IT_0321;
    const ccomplex_t IT_0323 = IT_0302*IT_0321;
    const ccomplex_t IT_0324 = conj(N_u1)*N_u4*e_em;
    const ccomplex_t IT_0325 = IT_0299*IT_0324;
    const ccomplex_t IT_0326 = IT_0302*IT_0324;
    const ccomplex_t IT_0327 = (0 + _Complex_I*1)*(IT_0322 + IT_0323 + 
      -IT_0325 + -IT_0326);
    const ccomplex_t IT_0328 = (-0.5)*IT_0327;
    const ccomplex_t IT_0329 = (0 + _Complex_I*1)*e_em*IT_0002*IT_0010;
    ...
    const ccomplex_t IT_0333 = IT_0328*IT_0332;
    const ccomplex_t IT_0334 = -IT_0333;
    const ccomplex_t IT_0335 = 12*IT_0255;
    const ccomplex_t IT_0336 = 24*IT_0236;
    const ccomplex_t IT_0337 = IT_0335 + IT_0336;
    const ccomplex_t IT_0338 = 12*conj(IT_0255);
    const ccomplex_t IT_0339 = 24*conj(IT_0236);
    const ccomplex_t IT_0340 = IT_0338 + IT_0339;
    const ccomplex_t IT_0341 = 6*IT_0281;
    const ccomplex_t IT_0342 = 6*conj(IT_0281);
    const ccomplex_t IT_0343 = 12*IT_0181;
    const ccomplex_t IT_0344 = 12*IT_0281;
    const ccomplex_t IT_0345 = 12*conj(IT_0281);
    const ccomplex_t IT_0346 = conj(IT_0274)*IT_0295 + IT_0274*IT_0298 +
       IT_0317*IT_0320 + conj(IT_0334)*IT_0337 + IT_0334*IT_0340 + conj(IT_0255)
      *IT_0341 + IT_0255*IT_0342 + conj(IT_0317)*(24*IT_0153 + IT_0343) + conj
      (IT_0236)*IT_0344 + IT_0236*IT_0345;
    const ccomplex_t IT_0347 = m_u*s_14*m_N_4;
    const ccomplex_t IT_0348 = IT_0162*IT_0251;
    const ccomplex_t IT_0349 = IT_0165*IT_0348;
    const ccomplex_t IT_0350 = (0 + _Complex_I*1)*IT_0349;
    const ccomplex_t IT_0351 = IT_0168*IT_0245;
    ...
    const ccomplex_t IT_0355 = IT_0290 + IT_0343;
    const ccomplex_t IT_0356 = IT_0291 + IT_0318;
    const ccomplex_t IT_0357 = IT_0308*IT_0332;
    const ccomplex_t IT_0358 = -IT_0357;
    const ccomplex_t IT_0359 = 24*IT_0181;
    const ccomplex_t IT_0360 = IT_0294 + IT_0359;
    const ccomplex_t IT_0361 = 24*conj(IT_0181);
    const ccomplex_t IT_0362 = IT_0297 + IT_0361;
    const ccomplex_t IT_0363 = IT_0315*IT_0328;
    const ccomplex_t IT_0364 = -IT_0363;
    const ccomplex_t IT_0365 = 12*IT_0236;
    const ccomplex_t IT_0366 = 24*IT_0255;
    const ccomplex_t IT_0367 = IT_0365 + IT_0366;
    const ccomplex_t IT_0368 = 12*conj(IT_0236);
    const ccomplex_t IT_0369 = 24*conj(IT_0255);
    const ccomplex_t IT_0370 = IT_0368 + IT_0369;
    const ccomplex_t IT_0371 = IT_0176*IT_0244;
    const ccomplex_t IT_0372 = IT_0178*IT_0371;
    const ccomplex_t IT_0373 = (0 + _Complex_I*1)*IT_0372;
    const ccomplex_t IT_0374 = IT_0163*IT_0249;
    const ccomplex_t IT_0375 = IT_0165*IT_0374;
    const ccomplex_t IT_0376 = (0 + _Complex_I*1)*IT_0375;
    const ccomplex_t IT_0377 = IT_0373 + IT_0376;
    const ccomplex_t IT_0378 = 6*IT_0377;
    const ccomplex_t IT_0379 = 6*conj(IT_0377);
    const ccomplex_t IT_0380 = 12*IT_0377;
    const ccomplex_t IT_0381 = 12*conj(IT_0377);
    const ccomplex_t IT_0382 = IT_0347*(conj(IT_0354)*IT_0355 + IT_0354
      *IT_0356 + conj(IT_0358)*IT_0360 + IT_0358*IT_0362 + conj(IT_0364)*IT_0367
       + IT_0364*IT_0370 + conj(IT_0236)*IT_0378 + IT_0236*IT_0379 + conj
      (IT_0255)*IT_0380 + IT_0255*IT_0381);
    const ccomplex_t IT_0383 = m_u*s_24*m_N_1;
    const ccomplex_t IT_0384 = 6*IT_0274;
    const ccomplex_t IT_0385 = 6*conj(IT_0274);
    const ccomplex_t IT_0386 = 12*IT_0274;
    const ccomplex_t IT_0387 = 12*conj(IT_0274);
    const ccomplex_t IT_0388 = conj(IT_0281)*IT_0295 + IT_0281*IT_0298 +
       IT_0320*IT_0334 + conj(IT_0317)*IT_0337 + IT_0317*IT_0340 + conj(IT_0334)
      *(24*IT_0153 + IT_0343) + conj(IT_0255)*IT_0384 + IT_0255*IT_0385 + conj
      (IT_0236)*IT_0386 + IT_0236*IT_0387;
    const ccomplex_t IT_0389 = m_u*s_23*m_N_1;
    const ccomplex_t IT_0390 = 12*IT_0354;
    const ccomplex_t IT_0391 = 12*conj(IT_0354);
    const ccomplex_t IT_0392 = conj(IT_0236)*IT_0354 + IT_0236*conj(IT_0354) +
       0.166666666666667*IT_0362*IT_0364 + 0.166666666666667*IT_0360*conj
      (IT_0364) + 0.166666666666667*conj(IT_0358)*IT_0367 + 0.166666666666667
      *IT_0358*IT_0370 + 0.166666666666667*IT_0356*IT_0377 + 0.166666666666667
      *IT_0355*conj(IT_0377) + 0.166666666666667*conj(IT_0255)*IT_0390 +
       0.166666666666667*IT_0255*IT_0391;
    const ccomplex_t IT_0393 = 24*IT_0334;
    const ccomplex_t IT_0394 = IT_0344 + IT_0393;
    const ccomplex_t IT_0395 = 24*conj(IT_0334);
    const ccomplex_t IT_0396 = IT_0345 + IT_0395;
    const ccomplex_t IT_0397 = 24*IT_0317;
    const ccomplex_t IT_0398 = IT_0386 + IT_0397;
    const ccomplex_t IT_0399 = 24*conj(IT_0317);
    const ccomplex_t IT_0400 = IT_0387 + IT_0399;
    const ccomplex_t IT_0401 = IT_0342*IT_0377 + IT_0341*conj(IT_0377) + conj
      (IT_0334)*IT_0380 + IT_0334*IT_0381 + conj(IT_0354)*IT_0384 + IT_0354
      *IT_0385 + conj(IT_0317)*IT_0390 + IT_0317*IT_0391 + conj(IT_0364)*IT_0394
       + IT_0364*IT_0396 + conj(IT_0358)*IT_0398 + IT_0358*IT_0400;
    const ccomplex_t IT_0402 = s_34*m_N_1*m_N_4;
    const ccomplex_t IT_0403 = IT_0342*IT_0354 + IT_0341*conj(IT_0354) + conj
      (IT_0274)*IT_0378 + IT_0274*IT_0379 + conj(IT_0317)*IT_0380 + IT_0317
      *IT_0381 + conj(IT_0334)*IT_0390 + IT_0334*IT_0391 + conj(IT_0358)*IT_0394
       + IT_0358*IT_0396 + conj(IT_0364)*IT_0398 + IT_0364*IT_0400;
    const ccomplex_t IT_0404 = 24*conj(IT_0281);
    const ccomplex_t IT_0405 = 48*conj(IT_0334);
    const ccomplex_t IT_0406 = IT_0404 + IT_0405;
    const ccomplex_t IT_0407 = 24*IT_0281;
    const ccomplex_t IT_0408 = 24*IT_0274;
    const ccomplex_t IT_0409 = 24*conj(IT_0274);
    const ccomplex_t IT_0410 = 24*IT_0354;
    const ccomplex_t IT_0411 = 48*IT_0358;
    const ccomplex_t IT_0412 = IT_0410 + IT_0411;
    const ccomplex_t IT_0413 = 24*IT_0377;
    const ccomplex_t IT_0414 = 24*conj(IT_0377);
    const ccomplex_t IT_0415 = 24*conj(IT_0354);
    const ccomplex_t IT_0416 = m_N_1*m_N_4*IT_0083;
    const ccomplex_t IT_0417 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0274)*IT_0344 + IT_0274*IT_0345 + conj(IT_0255)*IT_0355 + IT_0255
      *IT_0356 + conj(IT_0354)*IT_0380 + IT_0354*IT_0381 + IT_0317*IT_0406 +
       conj(IT_0317)*(48*IT_0334 + IT_0407) + conj(IT_0334)*IT_0408 + IT_0334
      *IT_0409 + conj(IT_0364)*IT_0412 + conj(IT_0358)*(48*IT_0364 + IT_0413) +
       IT_0358*IT_0414 + IT_0364*IT_0415;
    const ccomplex_t IT_0418 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0419 = 6*IT_0053;
    const ccomplex_t IT_0420 = 6*conj(IT_0053);
    const ccomplex_t IT_0421 = (-6)*IT_0082;
    const ccomplex_t IT_0422 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0423 = (-2)*IT_0259;
    const ccomplex_t IT_0424 = (-3)*IT_0130;
    const ccomplex_t IT_0425 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0426 = (-3)*IT_0215;
    const ccomplex_t IT_0427 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0428 = (-2)*IT_0266;
    const ccomplex_t IT_0429 = 2*IT_0287;
    const ccomplex_t IT_0430 = 4*IT_0287;
    const ccomplex_t IT_0431 = conj(IT_0334) + conj(IT_0364);
    const ccomplex_t IT_0432 = IT_0334 + IT_0364;
    const ccomplex_t IT_0433 = conj(IT_0317) + conj(IT_0358);
    const ccomplex_t IT_0434 = IT_0317 + IT_0358;
    const ccomplex_t IT_0435 = (-4)*IT_0266;
    const ccomplex_t IT_0436 = IT_0084*IT_0256;
    const ccomplex_t IT_0437 = 6*IT_0082;
    const ccomplex_t IT_0438 = 6*conj(IT_0082);
    const ccomplex_t IT_0439 = (-0.166666666666667)*IT_0255;
    const ccomplex_t IT_0440 = 4*conj(IT_0053)*(IT_0082 + 1./4*IT_0181 + (
      -0.0416666666666667)*IT_0290) + 4*IT_0053*(conj(IT_0082) + 1./4*conj
      (IT_0181) + (-0.0416666666666667)*IT_0291) + (-0.166666666666667)*conj
      (IT_0236)*IT_0421 + (-0.166666666666667)*IT_0236*IT_0422 + (
      -0.166666666666667)*conj(IT_0255)*IT_0437 + IT_0438*IT_0439;
    const ccomplex_t IT_0441 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0442 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0443 = s_13 + s_14;
    const ccomplex_t IT_0444 = IT_0263*IT_0443;
    const ccomplex_t IT_0445 = 12*IT_0082;
    const ccomplex_t IT_0446 = (-0.166666666666667)*IT_0274;
    const ccomplex_t IT_0447 = (-0.166666666666667)*conj(IT_0274);
    const ccomplex_t IT_0448 = (-0.166666666666667)*IT_0354;
    const ccomplex_t IT_0449 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0450 = (-0.166666666666667)*IT_0317;
    const ccomplex_t IT_0451 = (-12)*IT_0082;
    const ccomplex_t IT_0452 = (-0.166666666666667)*conj(IT_0317);
    const ccomplex_t IT_0453 = 12*conj(IT_0082);
    const ccomplex_t IT_0454 = (-0.166666666666667)*IT_0358;
    const ccomplex_t IT_0455 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0456 = (-0.166666666666667)*IT_0364;
    const ccomplex_t IT_0457 = 12*conj(IT_0053);
    const ccomplex_t IT_0458 = (-0.166666666666667)*IT_0334;
    const ccomplex_t IT_0459 = 12*IT_0053;
    const ccomplex_t IT_0460 = (-0.166666666666667)*conj(IT_0334);
    const ccomplex_t IT_0461 = conj(IT_0053)*((-0.166666666666667)*IT_0341 +
       IT_0377) + IT_0053*((-0.166666666666667)*IT_0342 + 2*conj(IT_0364) + conj
      (IT_0377)) + (-0.166666666666667)*conj(IT_0354)*IT_0437 + (
      -0.166666666666667)*conj(IT_0358)*IT_0445 + IT_0422*IT_0446 + IT_0421
      *IT_0447 + IT_0438*IT_0448 + IT_0449*IT_0450 + IT_0451*IT_0452 + IT_0453
      *IT_0454 + IT_0455*IT_0456 + IT_0457*IT_0458 + IT_0459*IT_0460;
    const ccomplex_t IT_0462 = s_23 + s_24;
    const ccomplex_t IT_0463 = IT_0284*IT_0462;
    const ccomplex_t IT_0464 = IT_0053*(conj(IT_0354) + 2*conj(IT_0358)) + (
      -0.166666666666667)*conj(IT_0281)*IT_0421 + (-0.166666666666667)*IT_0281
      *IT_0422 + (-0.166666666666667)*conj(IT_0377)*IT_0437 + (
      -0.166666666666667)*IT_0377*IT_0438 + (-0.166666666666667)*conj(IT_0364)
      *IT_0445 + IT_0420*IT_0446 + IT_0419*IT_0447 + IT_0442*IT_0448 + IT_0454
      *IT_0455 + IT_0453*IT_0456 + IT_0450*IT_0457 + IT_0449*IT_0458 + IT_0452
      *IT_0459 + IT_0451*IT_0460;
    const ccomplex_t IT_0465 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0292*IT_0346 + IT_0382 + IT_0383*IT_0388 + 6*IT_0389
      *IT_0392 + IT_0154*IT_0401 + IT_0402*IT_0403 + IT_0156*(conj(IT_0153)
      *IT_0294 + conj(IT_0281)*IT_0344 + conj(IT_0236)*IT_0365 + conj(IT_0274)
      *IT_0386 + IT_0334*IT_0406 + conj(IT_0334)*IT_0407 + conj(IT_0317)*IT_0408
       + IT_0317*(48*conj(IT_0317) + IT_0409)) + IT_0155*(conj(IT_0255)*IT_0335 
      + conj(IT_0181)*IT_0343 + conj(IT_0377)*IT_0380 + conj(IT_0354)*IT_0390 +
       conj(IT_0358)*IT_0412 + conj(IT_0364)*IT_0413 + IT_0364*(48*conj(IT_0364)
       + IT_0414) + IT_0358*IT_0415) + IT_0416*IT_0417 + IT_0418*(conj(IT_0236)
      *IT_0419 + IT_0236*IT_0420 + conj(IT_0153)*IT_0421 + IT_0153*IT_0422) +
       IT_0423*(conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj(IT_0153)*IT_0282 
      + IT_0153*IT_0283 + conj(IT_0255)*IT_0424 + IT_0255*IT_0425 + conj(IT_0181
      )*IT_0426 + IT_0181*IT_0427) + (conj(IT_0354)*IT_0424 + IT_0354*IT_0425 +
       conj(IT_0377)*IT_0426 + IT_0377*IT_0427)*IT_0428 + (conj(IT_0377)*IT_0424
       + IT_0377*IT_0425 + conj(IT_0354)*IT_0426 + IT_0354*IT_0427)*IT_0429 +
       IT_0430*(IT_0424*IT_0431 + IT_0425*IT_0432 + IT_0426*IT_0433 + IT_0427
      *IT_0434) + (IT_0426*IT_0431 + IT_0427*IT_0432 + IT_0424*IT_0433 + IT_0425
      *IT_0434)*IT_0435 + (-6)*IT_0436*IT_0440 + (-6)*IT_0441*(IT_0053*conj
      (IT_0255) + (-0.166666666666667)*conj(IT_0181)*IT_0437 + (
      -0.166666666666667)*IT_0181*IT_0438 + IT_0439*IT_0442) + (-6)*IT_0444
      *IT_0461 + (-6)*IT_0463*IT_0464;
