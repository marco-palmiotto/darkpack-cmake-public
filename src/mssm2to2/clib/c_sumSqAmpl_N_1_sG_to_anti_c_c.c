        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
    ...
    const ccomplex_t IT_0042 = m_sG*s_34*m_N_1;
    ...
    const ccomplex_t IT_0094 = m_c*s_23*m_N_1;
