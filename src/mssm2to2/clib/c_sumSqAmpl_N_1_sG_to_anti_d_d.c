...
ccomplex_return_t c_sumSqAmpl_N_1_sG_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
    ...
    const ccomplex_t IT_0089 = m_d*s_24*m_N_1;
    ...
    const ccomplex_t IT_0098 = m_d*s_23*m_N_1;
