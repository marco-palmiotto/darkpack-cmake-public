...
ccomplex_return_t c_sumSqAmpl_N_1_sG_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0044;
    ...
    const ccomplex_t IT_0083 = m_sG*s_34*m_N_1;
    ...
    const ccomplex_t IT_0089 = m_s*s_24*m_N_1;
    ...
    const ccomplex_t IT_0095 = m_sG*m_N_1*IT_0014;
    ...
    const ccomplex_t IT_0098 = m_s*s_23*m_N_1;
