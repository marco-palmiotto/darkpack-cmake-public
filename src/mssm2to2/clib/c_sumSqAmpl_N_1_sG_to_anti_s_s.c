        ...
        )
{
    ...
    const ccomplex_t IT_0003 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_ss_L*
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_13 + IT_0001 + IT_0020 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_ss_R*
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0001 + IT_0020 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0084 = m_s*s_24*m_N_1;
    ...
    const ccomplex_t IT_0089 = m_s*m_sG*s_13;
    ...
    const ccomplex_t IT_0107 = m_s*m_sG*s_14;
