...
ccomplex_return_t c_sumSqAmpl_N_1_sG_to_anti_t_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0048 = conj(N_B1)*e_em*conj(U_st_10);
    const ccomplex_t IT_0049 = IT_0007*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = m_t*conj(N_u1)*e_em*IT_0019*conj(U_st_00);
    ...
    const ccomplex_t IT_0062 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0063 = IT_0007*IT_0062;
    const ccomplex_t IT_0064 = 1.4142135623731*IT_0063;
    const ccomplex_t IT_0065 = m_t*conj(N_u1)*e_em*IT_0019*conj(U_st_01);
    ...
    const ccomplex_t IT_0111 = m_t*N_u1*e_em*IT_0019*U_st_00;
    ...
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_01);
    const ccomplex_t IT_0120 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0121 = IT_0007*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = m_t*N_u1*e_em*IT_0019*U_st_01;
    ...
    const ccomplex_t IT_0134 = m_sG*s_34*m_N_1;
    ...
    const ccomplex_t IT_0179 = m_sG*m_N_1*IT_0026;
    ...
    const ccomplex_t IT_0186 = m_t*s_24*m_N_1;
