        ...
        )
{
    ...
    const ccomplex_t IT_0048 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0049 = IT_0007*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = m_t*conj(N_u1)*e_em*IT_0019*conj(U_st_01);
    ...
    const ccomplex_t IT_0064 = conj(N_B1)*e_em*conj(U_st_10);
    const ccomplex_t IT_0065 = IT_0007*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = m_t*conj(N_u1)*e_em*IT_0019*conj(U_st_00);
