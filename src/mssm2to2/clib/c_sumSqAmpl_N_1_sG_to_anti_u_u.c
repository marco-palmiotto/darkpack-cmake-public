...
ccomplex_return_t c_sumSqAmpl_N_1_sG_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_su_R*
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0006*IT_0008*IT_0010;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = IT_0005*IT_0029;
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    ...
    const ccomplex_t IT_0084 = m_u*m_sG*s_13;
    ...
    const ccomplex_t IT_0089 = m_u*s_24*m_N_1;
    ...
    const ccomplex_t IT_0098 = m_u*s_23*m_N_1;
    ...
    const ccomplex_t IT_0106 = m_u*m_sG*s_14;
