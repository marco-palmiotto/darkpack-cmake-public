        ...
        )
{
    ...
    const ccomplex_t IT_0003 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_su_L*
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_13 + IT_0001 + IT_0020 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_su_R*
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0001 + IT_0020 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
    ...
    const ccomplex_t IT_0084 = m_u*s_24*m_N_1;
