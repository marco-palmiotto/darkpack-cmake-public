...
ccomplex_return_t c_sumSqAmpl_N_1_sb_1_to_b_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_B1*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0016 = m_b*N_d1*e_em*IT_0015*U_sb_00;
