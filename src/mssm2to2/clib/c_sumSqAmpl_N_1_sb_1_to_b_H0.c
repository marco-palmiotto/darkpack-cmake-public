        ...
        )
{
    ...
    const ccomplex_t IT_0045 = m_b*N_d4*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0079 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0080 = IT_0053*IT_0079;
    const ccomplex_t IT_0081 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0082 = IT_0056*IT_0081;
    const ccomplex_t IT_0083 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0084 = IT_0053*IT_0083;
    const ccomplex_t IT_0085 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0086 = IT_0056*IT_0085;
    ...
    const ccomplex_t IT_0090 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0091 = IT_0067*IT_0090;
    const ccomplex_t IT_0092 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0093 = IT_0064*IT_0092;
    const ccomplex_t IT_0094 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0100 = m_N_1*IT_0099;
    const ccomplex_t IT_0101 = IT_0078 + IT_0100;
    const ccomplex_t IT_0102 = IT_0052*IT_0101;
    const ccomplex_t IT_0103 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
    ...
    const ccomplex_t IT_0107 = m_b*N_d1*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0112 = (-2)*U_sb_00*((IT_0000*IT_0009*IT_0011*IT_0013
      *IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))*conj
    ...
    const ccomplex_t IT_0130 = conj(N_B1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0134 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0135 = IT_0056*IT_0134;
    ...
    const ccomplex_t IT_0139 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_1*
    ...
    const ccomplex_t IT_0143 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0144 = IT_0004*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = m_b*N_d2*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0151 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_2*
    ...
    const ccomplex_t IT_0157 = IT_0056*IT_0156;
    ...
    const ccomplex_t IT_0164 = IT_0064*IT_0163;
    const ccomplex_t IT_0165 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0166 = IT_0067*IT_0165;
    ...
    const ccomplex_t IT_0170 = IT_0067*IT_0169;
    ...
    const ccomplex_t IT_0178 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0179 = IT_0056*IT_0178;
    const ccomplex_t IT_0180 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0181 = IT_0053*IT_0180;
    const ccomplex_t IT_0182 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0183 = IT_0056*IT_0182;
    const ccomplex_t IT_0184 = IT_0177 + IT_0179 + IT_0181 + IT_0183;
    const ccomplex_t IT_0185 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0186 = IT_0064*IT_0185;
    const ccomplex_t IT_0187 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0188 = IT_0067*IT_0187;
    const ccomplex_t IT_0189 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0190 = IT_0064*IT_0189;
    const ccomplex_t IT_0191 = N_W1*N_d2*e_em;
    const ccomplex_t IT_0192 = IT_0067*IT_0191;
    ...
    const ccomplex_t IT_0197 = m_N_2*IT_0196;
    const ccomplex_t IT_0198 = IT_0175 + IT_0197;
    const ccomplex_t IT_0199 = IT_0153*IT_0198;
    const ccomplex_t IT_0200 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0201 = IT_0053*IT_0200;
    const ccomplex_t IT_0202 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0203 = IT_0056*IT_0202;
    const ccomplex_t IT_0204 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0205 = IT_0053*IT_0204;
    const ccomplex_t IT_0206 = N_W1*N_u3*e_em;
    const ccomplex_t IT_0207 = IT_0056*IT_0206;
    const ccomplex_t IT_0208 = IT_0201 + IT_0203 + IT_0205 + IT_0207;
    const ccomplex_t IT_0209 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0210 = IT_0064*IT_0209;
    const ccomplex_t IT_0211 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0212 = IT_0067*IT_0211;
    const ccomplex_t IT_0213 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0214 = IT_0064*IT_0213;
    const ccomplex_t IT_0215 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0222 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0223 = IT_0053*IT_0222;
    const ccomplex_t IT_0224 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0225 = IT_0056*IT_0224;
    const ccomplex_t IT_0226 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0227 = IT_0053*IT_0226;
    ...
    const ccomplex_t IT_0231 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0232 = IT_0064*IT_0231;
    const ccomplex_t IT_0233 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0234 = IT_0067*IT_0233;
    const ccomplex_t IT_0235 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0245 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0246 = IT_0004*IT_0245;
    const ccomplex_t IT_0247 = 1.4142135623731*IT_0246;
    const ccomplex_t IT_0248 = m_b*N_d3*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0253 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_3*
    ...
    const ccomplex_t IT_0257 = IT_0033 + (-2)*IT_0041 + IT_0102 + IT_0117 +
       IT_0142 + IT_0199 + IT_0256;
    const ccomplex_t IT_0258 = m_b*conj(N_d1)*e_em*IT_0013*U_sb_10;
    const ccomplex_t IT_0259 = IT_0012*IT_0258;
    const ccomplex_t IT_0260 = 1.4142135623731*IT_0259;
    const ccomplex_t IT_0261 = conj(N_B1)*e_em*U_sb_00;
    const ccomplex_t IT_0262 = IT_0004*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = conj(N_W1)*e_em*U_sb_00;
    const ccomplex_t IT_0265 = IT_0011*IT_0264;
    const ccomplex_t IT_0266 = 1.4142135623731*IT_0265;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*(IT_0260 + 0.333333333333333
      *IT_0263 + -IT_0266);
    const ccomplex_t IT_0268 = 3*IT_0267;
    const ccomplex_t IT_0269 = 0.166666666666667*IT_0268;
    const ccomplex_t IT_0270 = (-2)*U_sb_00*((IT_0000*IT_0009*IT_0011*IT_0013
      *IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))*conj
      (U_sb_00) + -1./2*IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_10)) + U_sb_10
      *(IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_00) + (-2)*(IT_0000*IT_0009
      *IT_0011*IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*conj(U_sb_10
    ...
    const ccomplex_t IT_0287 = (-2)*U_sb_00*((IT_0000*IT_0009*IT_0011*IT_0013
      *IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))*conj
      (U_sb_01) + -1./2*IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_11)) + U_sb_10
      *(IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_01) + (-2)*(IT_0000*IT_0009
      *IT_0011*IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*conj(U_sb_11
    ...
    const ccomplex_t IT_0291 = IT_0103*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = IT_0037*IT_0269;
    ...
    const ccomplex_t IT_0297 = IT_0139*IT_0269;
    const ccomplex_t IT_0298 = (0 + _Complex_I*1)*IT_0297;
    const ccomplex_t IT_0299 = IT_0138*IT_0298;
    const ccomplex_t IT_0300 = m_b*conj(N_d2)*e_em*IT_0013*U_sb_10;
    const ccomplex_t IT_0301 = IT_0012*IT_0300;
    const ccomplex_t IT_0302 = 1.4142135623731*IT_0301;
    const ccomplex_t IT_0303 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0304 = IT_0011*IT_0303;
    const ccomplex_t IT_0305 = 1.4142135623731*IT_0304;
    const ccomplex_t IT_0306 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0307 = IT_0004*IT_0306;
    ...
    const ccomplex_t IT_0312 = IT_0151*IT_0311;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = m_N_1*IT_0196;
    const ccomplex_t IT_0315 = m_N_2*IT_0174;
    const ccomplex_t IT_0316 = IT_0314 + IT_0315;
    const ccomplex_t IT_0317 = IT_0313*IT_0316;
    const ccomplex_t IT_0318 = m_N_1*IT_0220;
    const ccomplex_t IT_0319 = m_N_3*IT_0242;
    const ccomplex_t IT_0320 = IT_0318 + IT_0319;
    const ccomplex_t IT_0321 = m_b*conj(N_d3)*e_em*IT_0013*U_sb_10;
    const ccomplex_t IT_0322 = IT_0012*IT_0321;
    const ccomplex_t IT_0323 = 1.4142135623731*IT_0322;
    const ccomplex_t IT_0324 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0325 = IT_0011*IT_0324;
    const ccomplex_t IT_0326 = 1.4142135623731*IT_0325;
    const ccomplex_t IT_0327 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0333 = IT_0253*IT_0332;
    const ccomplex_t IT_0334 = (0 + _Complex_I*1)*IT_0333;
    const ccomplex_t IT_0335 = IT_0320*IT_0334;
    const ccomplex_t IT_0336 = m_b*conj(N_d4)*e_em*IT_0013*U_sb_10;
    const ccomplex_t IT_0337 = IT_0012*IT_0336;
    const ccomplex_t IT_0338 = 1.4142135623731*IT_0337;
    const ccomplex_t IT_0339 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0340 = IT_0011*IT_0339;
    const ccomplex_t IT_0341 = 1.4142135623731*IT_0340;
    const ccomplex_t IT_0342 = conj(N_B4)*e_em*U_sb_00;
    const ccomplex_t IT_0343 = IT_0004*IT_0342;
    const ccomplex_t IT_0344 = 1.4142135623731*IT_0343;
    const ccomplex_t IT_0345 = (0 + _Complex_I*1)*(IT_0338 + -IT_0341 +
       0.333333333333333*IT_0344);
    const ccomplex_t IT_0346 = 3*IT_0345;
    const ccomplex_t IT_0347 = 0.166666666666667*IT_0346;
    const ccomplex_t IT_0348 = IT_0050*IT_0347;
    const ccomplex_t IT_0349 = (0 + _Complex_I*1)*IT_0348;
    const ccomplex_t IT_0350 = m_N_1*IT_0077;
    const ccomplex_t IT_0351 = m_N_4*IT_0099;
    const ccomplex_t IT_0352 = IT_0350 + IT_0351;
    const ccomplex_t IT_0353 = IT_0349*IT_0352;
    const ccomplex_t IT_0354 = -IT_0275 + -IT_0292 + 2*IT_0296 + -IT_0299 + 
      -IT_0317 + -IT_0335 + -IT_0353;
    const ccomplex_t IT_0355 = 6*s_13;
    const ccomplex_t IT_0356 = m_b*m_N_1;
    const ccomplex_t IT_0357 = 6*IT_0257;
    const ccomplex_t IT_0358 = IT_0220*IT_0334;
    const ccomplex_t IT_0359 = IT_0126*IT_0298;
    const ccomplex_t IT_0360 = IT_0196*IT_0313;
    const ccomplex_t IT_0361 = IT_0077*IT_0349;
    const ccomplex_t IT_0362 = -IT_0040 + IT_0358 + IT_0359 + IT_0360 + IT_0361;
    const ccomplex_t IT_0363 = m_b*s_14;
    const ccomplex_t IT_0364 = IT_0052*IT_0099;
    const ccomplex_t IT_0365 = IT_0136*IT_0141;
    const ccomplex_t IT_0366 = IT_0153*IT_0174;
    const ccomplex_t IT_0367 = IT_0242*IT_0255;
    const ccomplex_t IT_0368 = IT_0295 + -IT_0364 + -IT_0365 + -IT_0366 + 
      -IT_0367;
    const ccomplex_t IT_0369 = s_34*m_N_1;
    const ccomplex_t IT_0370 = 6*conj(IT_0257);
    const ccomplex_t IT_0371 = 6*conj(IT_0354);
    const ccomplex_t IT_0372 = pow(m_H0, 2);
    const ccomplex_t IT_0373 = m_b*m_N_1*IT_0372;
    const ccomplex_t IT_0374 = s_13*IT_0372;
    const ccomplex_t IT_0375 = s_14*s_34;
    const ccomplex_t IT_0376 = (-2)*IT_0375;
    const ccomplex_t IT_0377 = IT_0374 + IT_0376;
    const ccomplex_t IT_0378 = 6*IT_0354;
    const ccomplex_t IT_0379 = 0.166666666666667*IT_0369;
    const ccomplex_t IT_0380 = (IT_0257*conj(IT_0257) + IT_0354*conj(IT_0354))
      *IT_0355 + conj(IT_0354)*IT_0356*IT_0357 + (IT_0354*IT_0356 + IT_0362
      *IT_0363 + IT_0368*IT_0369)*IT_0370 + (IT_0363*IT_0368 + IT_0362*IT_0369)
      *IT_0371 + 6*conj(IT_0368)*(IT_0362*IT_0373 + -IT_0368*IT_0377 +
       0.166666666666667*IT_0363*IT_0378 + IT_0357*IT_0379) + 6*conj(IT_0362)*
      (0.166666666666667*IT_0357*IT_0363 + IT_0368*IT_0373 + -IT_0362*IT_0377 +
       IT_0378*IT_0379);
