        ...
        )
{
    ...
    const ccomplex_t IT_0018 = 2*U_sb_00*((IT_0000*IT_0004*IT_0005*IT_0008
      *IT_0011 + (-0.5)*m_W*IT_0015*(IT_0011 + 1./3*IT_0010*IT_0017))*conj
      (U_sb_00) + 1./2*IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_10)) + U_sb_10*
      (IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_00) + 2*(IT_0000*IT_0004
      *IT_0005*IT_0008*IT_0011 + -1./3*m_W*IT_0010*IT_0015*IT_0017)*conj(U_sb_10
      ));
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*(e_em*IT_0018 +
       1.4142135623731*A_b*IT_0003*IT_0004*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    const ccomplex_t IT_0020 = 0.5*IT_0019;
    const ccomplex_t IT_0021 = cpow(IT_0016, -1);
    const ccomplex_t IT_0022 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0023 = IT_0021*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = IT_0008*IT_0011;
    const ccomplex_t IT_0026 = m_b*N_d1*e_em*IT_0005*U_sb_00;
    ...
    const ccomplex_t IT_0038 = m_b*N_d1*e_em*IT_0005*U_sb_01;
    ...
    const ccomplex_t IT_0043 = 2*U_sb_00*((IT_0000*IT_0004*IT_0005*IT_0008
      *IT_0011 + (-0.5)*m_W*IT_0015*(IT_0011 + 1./3*IT_0010*IT_0017))*conj
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0049 
      + -reg_prop, -1);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_b*e_em*IT_0004*IT_0005
      *IT_0008*IT_0011;
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0000 + IT_0049 + -m_N_1*
    ...
    const ccomplex_t IT_0091 = m_b*N_d2*e_em*IT_0005*U_sb_00;
    ...
    const ccomplex_t IT_0202 = m_b*N_d4*e_em*IT_0005*U_sb_00;
    const ccomplex_t IT_0203 = IT_0025*IT_0202;
    const ccomplex_t IT_0204 = 1.4142135623731*IT_0203;
    const ccomplex_t IT_0205 = N_B4*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0211 = cpow((-2)*s_23 + IT_0000 + IT_0049 + -m_N_4*
    ...
    const ccomplex_t IT_0217 = IT_0064*IT_0216;
    const ccomplex_t IT_0218 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0219 = IT_0061*IT_0218;
    const ccomplex_t IT_0220 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0221 = IT_0064*IT_0220;
    ...
    const ccomplex_t IT_0240 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0241 = IT_0061*IT_0240;
    const ccomplex_t IT_0242 = N_B1*N_d4*e_em;
    ...
    const ccomplex_t IT_0248 = IT_0070*IT_0247;
    const ccomplex_t IT_0249 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0250 = IT_0067*IT_0249;
    const ccomplex_t IT_0251 = N_W1*N_d4*e_em;
    const ccomplex_t IT_0252 = IT_0070*IT_0251;
    ...
    const ccomplex_t IT_0260 = IT_0033 + IT_0048 + (-2)*IT_0056 + IT_0087 +
       IT_0144 + IT_0201 + IT_0259;
    const ccomplex_t IT_0261 = m_b*conj(N_d1)*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0262 = IT_0025*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = conj(N_B1)*e_em*U_sb_00;
    const ccomplex_t IT_0265 = IT_0021*IT_0264;
    const ccomplex_t IT_0266 = 1.4142135623731*IT_0265;
    const ccomplex_t IT_0267 = conj(N_W1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0273 = 2*U_sb_00*((IT_0000*IT_0004*IT_0005*IT_0008
      *IT_0011 + (-0.5)*m_W*IT_0015*(IT_0011 + 1./3*IT_0010*IT_0017))*conj
      (U_sb_00) + 1./2*IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_10)) + U_sb_10*
      (IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_00) + 2*(IT_0000*IT_0004
      *IT_0005*IT_0008*IT_0011 + -1./3*m_W*IT_0010*IT_0015*IT_0017)*conj(U_sb_10
      ));
    const ccomplex_t IT_0274 = (0 + _Complex_I*1)*(e_em*IT_0273 +
       1.4142135623731*A_b*IT_0003*IT_0004*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    ...
    const ccomplex_t IT_0279 = m_b*conj(N_d1)*e_em*IT_0005*U_sb_11;
    const ccomplex_t IT_0280 = IT_0025*IT_0279;
    const ccomplex_t IT_0281 = 1.4142135623731*IT_0280;
    const ccomplex_t IT_0282 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0283 = IT_0021*IT_0282;
    ...
    const ccomplex_t IT_0291 = 2*U_sb_00*((IT_0000*IT_0004*IT_0005*IT_0008
      *IT_0011 + (-0.5)*m_W*IT_0015*(IT_0011 + 1./3*IT_0010*IT_0017))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_11)) + U_sb_10*
      (IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_01) + 2*(IT_0000*IT_0004
      *IT_0005*IT_0008*IT_0011 + -1./3*m_W*IT_0010*IT_0015*IT_0017)*conj(U_sb_11
    ...
    const ccomplex_t IT_0295 = IT_0034*IT_0294;
    const ccomplex_t IT_0296 = (0 + _Complex_I*1)*IT_0295;
    const ccomplex_t IT_0297 = IT_0052*IT_0272;
    ...
    const ccomplex_t IT_0301 = IT_0057*IT_0272;
    const ccomplex_t IT_0302 = (0 + _Complex_I*1)*IT_0301;
    const ccomplex_t IT_0303 = IT_0086*IT_0302;
    const ccomplex_t IT_0304 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0305 = IT_0021*IT_0304;
    const ccomplex_t IT_0306 = 1.4142135623731*IT_0305;
    const ccomplex_t IT_0307 = m_b*conj(N_d2)*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0308 = IT_0025*IT_0307;
    ...
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*(IT_0306 + 3*IT_0309 + (-3)
      *IT_0312);
    const ccomplex_t IT_0314 = 0.333333333333333*IT_0313;
    const ccomplex_t IT_0315 = 3*IT_0314;
    const ccomplex_t IT_0316 = 0.166666666666667*IT_0315;
    const ccomplex_t IT_0317 = IT_0096*IT_0316;
    const ccomplex_t IT_0318 = (0 + _Complex_I*1)*IT_0317;
    const ccomplex_t IT_0319 = m_N_1*IT_0119;
    const ccomplex_t IT_0320 = m_N_2*IT_0141;
    ...
    const ccomplex_t IT_0326 = m_b*conj(N_d3)*e_em*IT_0005*U_sb_10;
    ...
    const ccomplex_t IT_0330 = IT_0021*IT_0329;
    const ccomplex_t IT_0331 = 1.4142135623731*IT_0330;
    const ccomplex_t IT_0332 = conj(N_W3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0341 = m_N_1*IT_0256;
    const ccomplex_t IT_0342 = m_N_4*IT_0234;
    const ccomplex_t IT_0343 = IT_0341 + IT_0342;
    const ccomplex_t IT_0344 = m_b*conj(N_d4)*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0345 = IT_0025*IT_0344;
    const ccomplex_t IT_0346 = 1.4142135623731*IT_0345;
    const ccomplex_t IT_0347 = conj(N_B4)*e_em*U_sb_00;
    const ccomplex_t IT_0348 = IT_0021*IT_0347;
    const ccomplex_t IT_0349 = 1.4142135623731*IT_0348;
    const ccomplex_t IT_0350 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0351 = IT_0011*IT_0350;
    const ccomplex_t IT_0352 = 1.4142135623731*IT_0351;
    const ccomplex_t IT_0353 = (0 + _Complex_I*1)*(IT_0346 + 0.333333333333333
      *IT_0349 + -IT_0352);
    const ccomplex_t IT_0354 = 3*IT_0353;
    const ccomplex_t IT_0355 = 0.166666666666667*IT_0354;
    const ccomplex_t IT_0356 = IT_0211*IT_0355;
    const ccomplex_t IT_0357 = (0 + _Complex_I*1)*IT_0356;
    const ccomplex_t IT_0358 = IT_0343*IT_0357;
    const ccomplex_t IT_0359 = -IT_0278 + -IT_0296 + 2*IT_0300 + -IT_0303 + 
      -IT_0322 + -IT_0340 + -IT_0358;
    const ccomplex_t IT_0360 = 6*s_13;
    const ccomplex_t IT_0361 = m_b*m_N_1;
    const ccomplex_t IT_0362 = 6*IT_0260;
    const ccomplex_t IT_0363 = IT_0073*IT_0302;
    const ccomplex_t IT_0364 = (0 + _Complex_I*1)*(0.333333333333333*IT_0306 +
       IT_0309 + -IT_0312);
    ...
    const ccomplex_t IT_0369 = IT_0119*IT_0368;
    const ccomplex_t IT_0370 = IT_0165*IT_0339;
    const ccomplex_t IT_0371 = IT_0256*IT_0357;
    const ccomplex_t IT_0372 = -IT_0055 + IT_0363 + IT_0369 + IT_0370 + IT_0371;
    const ccomplex_t IT_0373 = m_b*s_14;
    const ccomplex_t IT_0374 = IT_0098*IT_0141;
    const ccomplex_t IT_0375 = IT_0059*IT_0084;
    const ccomplex_t IT_0376 = (0 + _Complex_I*1)*(IT_0192 + 0.666666666666667
      *IT_0195);
    const ccomplex_t IT_0377 = 1.5*IT_0376;
    ...
    const ccomplex_t IT_0381 = IT_0187*IT_0380;
    const ccomplex_t IT_0382 = IT_0213*IT_0234;
    const ccomplex_t IT_0383 = IT_0299 + -IT_0374 + -IT_0375 + -IT_0381 + 
      -IT_0382;
    const ccomplex_t IT_0384 = s_34*m_N_1;
    const ccomplex_t IT_0385 = 6*conj(IT_0260);
    const ccomplex_t IT_0386 = 6*conj(IT_0359);
    const ccomplex_t IT_0387 = pow(m_h, 2);
    const ccomplex_t IT_0388 = m_b*m_N_1*IT_0387;
    ...
    const ccomplex_t IT_0393 = 6*IT_0359;
    const ccomplex_t IT_0394 = 0.166666666666667*IT_0384;
    const ccomplex_t IT_0395 = (IT_0260*conj(IT_0260) + IT_0359*conj(IT_0359))
      *IT_0360 + conj(IT_0359)*IT_0361*IT_0362 + (IT_0359*IT_0361 + IT_0372
      *IT_0373 + IT_0383*IT_0384)*IT_0385 + (IT_0373*IT_0383 + IT_0372*IT_0384)
      *IT_0386 + 6*conj(IT_0383)*(IT_0372*IT_0388 + -IT_0383*IT_0392 +
       0.166666666666667*IT_0373*IT_0393 + IT_0362*IT_0394) + 6*conj(IT_0372)*
      (0.166666666666667*IT_0362*IT_0373 + IT_0383*IT_0388 + -IT_0372*IT_0392 +
       IT_0393*IT_0394);
