        ...
        )
{
    ...
    const ccomplex_t IT_0015 = N_B1*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0020 = m_b*N_d1*e_em*IT_0005*U_sb_00;
    ...
    const ccomplex_t IT_0080 = m_b*conj(N_d1)*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0081 = IT_0019*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0119 = m_t*U_sb_00*(m_t*IT_0006*IT_0008*conj(U_st_01) 
      + mu_h*conj(U_st_11)) + m_b*(m_b*IT_0007*IT_0018*U_sb_00*conj(U_st_01) +
       U_sb_10*(mu_h*conj(U_st_01) + m_t*IT_0008*IT_0018*conj(U_st_11)));
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*U_sb_10
      *conj(U_st_01) + (-1.4142135623731)*e_em*IT_0010*((-0.5)*IT_0005*IT_0119 +
       m_W*IT_0006*IT_0007*U_sb_00*conj(U_st_01)) + A_t*IT_0006*U_sb_00*conj
      (U_st_11));
    const ccomplex_t IT_0121 = IT_0118*IT_0120;
    const ccomplex_t IT_0122 = cpow((-2)*s_13 + IT_0001 + IT_0027 + -m_st_2*
    ...
    const ccomplex_t IT_0129 = IT_0028*IT_0125*IT_0128;
    ...
    const ccomplex_t IT_0133 = IT_0068*IT_0132;
    const ccomplex_t IT_0134 = IT_0055*IT_0130*IT_0133;
    const ccomplex_t IT_0135 = -IT_0026 + -IT_0054 + -IT_0079 + IT_0095 +
       IT_0110 + IT_0124 + IT_0129 + IT_0134;
    ...
    const ccomplex_t IT_0152 = IT_0028*IT_0125*IT_0151;
    ...
    const ccomplex_t IT_0167 = IT_0055*IT_0130*IT_0166;
    ...
    const ccomplex_t IT_0192 = m_t*conj(N_u1)*e_em*IT_0005*U_st_11;
    ...
    const ccomplex_t IT_0198 = IT_0122*IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*IT_0198;
    const ccomplex_t IT_0200 = IT_0132*IT_0165;
    ...
    const ccomplex_t IT_0204 = IT_0024*IT_0169;
    ...
    const ccomplex_t IT_0208 = IT_0127*IT_0150;
    ...
    const ccomplex_t IT_0212 = IT_0152 + IT_0167 + IT_0171 + -IT_0185 + 
    ...
    const ccomplex_t IT_0216 = IT_0053 + IT_0078 + -IT_0206;
    const ccomplex_t IT_0217 = m_t*s_12;
    const ccomplex_t IT_0218 = IT_0094 + IT_0202 + IT_0210;
