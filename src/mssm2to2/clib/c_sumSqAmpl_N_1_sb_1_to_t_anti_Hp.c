...
ccomplex_return_t c_sumSqAmpl_N_1_sb_1_to_t_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = m_t*U_sb_00*(m_t*IT_0006*IT_0016*conj(U_st_01) 
      + mu_h*conj(U_st_11)) + m_b*(m_b*IT_0005*IT_0017*U_sb_00*conj(U_st_01) +
       U_sb_10*(mu_h*conj(U_st_01) + m_t*IT_0006*IT_0017*conj(U_st_11)));
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*U_sb_10
      *conj(U_st_01) + (-1.4142135623731)*e_em*IT_0008*((-0.5)*IT_0010*IT_0018 +
       m_W*IT_0005*IT_0016*U_sb_00*conj(U_st_01)) + A_t*IT_0016*U_sb_00*conj
      (U_st_11));
    const ccomplex_t IT_0020 = IT_0015*IT_0019;
    const ccomplex_t IT_0021 = pow(m_t, 2);
    const ccomplex_t IT_0022 = pow(m_N_1, 2);
    const ccomplex_t IT_0023 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_st_2*
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_12 + -IT_0022 + IT_0026 + -IT_0027 
      + -reg_prop, -1);
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0006*IT_0008*IT_0010*IT_0016;
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0033 = IT_0001*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = IT_0008*IT_0017;
    const ccomplex_t IT_0036 = m_b*N_d1*e_em*IT_0010*U_sb_00;
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*(IT_0034 + 1.5*IT_0038);
    const ccomplex_t IT_0040 = (-0.333333333333333)*IT_0039;
    const ccomplex_t IT_0041 = IT_0031*IT_0040;
    const ccomplex_t IT_0042 = IT_0028*IT_0029*IT_0041;
    const ccomplex_t IT_0043 = IT_0005*IT_0008;
    const ccomplex_t IT_0044 = N_d1*e_em*U_Wm2;
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (-2)*IT_0045;
    const ccomplex_t IT_0047 = IT_0001*IT_0005;
    const ccomplex_t IT_0048 = N_B1*U_d2*e_em;
    const ccomplex_t IT_0049 = IT_0047*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = N_W1*U_d2*e_em;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0021 + IT_0027 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0060*IT_0061*IT_0062;
    const ccomplex_t IT_0064 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = m_t*N_u1*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0072 = m_t*U_sb_00*(m_t*IT_0006*IT_0016*conj(U_st_00) 
      + mu_h*conj(U_st_10)) + m_b*(m_b*IT_0005*IT_0017*U_sb_00*conj(U_st_00) +
       U_sb_10*(mu_h*conj(U_st_00) + m_t*IT_0006*IT_0017*conj(U_st_10)));
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*U_sb_10
      *conj(U_st_00) + (-1.4142135623731)*e_em*IT_0008*((-0.5)*IT_0010*IT_0072 +
       m_W*IT_0005*IT_0016*U_sb_00*conj(U_st_00)) + A_t*IT_0016*U_sb_00*conj
      (U_st_10));
    const ccomplex_t IT_0074 = IT_0071*IT_0073;
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = cpow((-2)*s_23 + IT_0021 + IT_0027 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0079 = m_b*conj(U_d1)*V_tb*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0080 = IT_0035*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0083 = IT_0008*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*(IT_0081 + (-2)*IT_0083);
    const ccomplex_t IT_0085 = (-0.5)*IT_0084;
    const ccomplex_t IT_0086 = N_d1*e_em*U_Wm1;
    const ccomplex_t IT_0087 = IT_0043*IT_0086;
    const ccomplex_t IT_0088 = (-2)*IT_0087;
    const ccomplex_t IT_0089 = N_B1*U_d1*e_em;
    const ccomplex_t IT_0090 = IT_0047*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = N_W1*U_d1*e_em;
    ...
    const ccomplex_t IT_0103 = m_b*conj(U_d2)*V_tb*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0104 = IT_0035*IT_0103;
    ...
    const ccomplex_t IT_0133 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0006*IT_0008*IT_0010*U_sb_00;
    const ccomplex_t IT_0134 = 0.5*IT_0133;
    const ccomplex_t IT_0135 = IT_0098*IT_0134;
    const ccomplex_t IT_0136 = IT_0078*IT_0132*IT_0135;
    const ccomplex_t IT_0137 = IT_0025 + -IT_0042 + IT_0063 + IT_0077 + 
      -IT_0102 + -IT_0113 + IT_0131 + IT_0136;
    const ccomplex_t IT_0138 = 6*s_13;
    const ccomplex_t IT_0139 = IT_0008*IT_0016;
    const ccomplex_t IT_0140 = conj(N_u1)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0141 = IT_0139*IT_0140;
    const ccomplex_t IT_0142 = 2*IT_0141;
    const ccomplex_t IT_0143 = IT_0001*IT_0016;
    const ccomplex_t IT_0144 = conj(N_B1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0145 = IT_0143*IT_0144;
    const ccomplex_t IT_0146 = 1.4142135623731*IT_0145;
    const ccomplex_t IT_0147 = conj(N_W1)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0170 = IT_0134*IT_0169;
    const ccomplex_t IT_0171 = IT_0078*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*IT_0171;
    const ccomplex_t IT_0173 = IT_0130 + IT_0156 + IT_0172;
    const ccomplex_t IT_0174 = m_t*s_12;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0005*IT_0008*IT_0010*IT_0017;
    const ccomplex_t IT_0176 = 0.5*IT_0175;
    const ccomplex_t IT_0177 = IT_0040*IT_0176;
    const ccomplex_t IT_0178 = IT_0028*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*IT_0178;
    const ccomplex_t IT_0180 = IT_0101 + IT_0112 + -IT_0179;
    const ccomplex_t IT_0181 = s_23*m_N_1;
    const ccomplex_t IT_0182 = IT_0085*IT_0169;
    const ccomplex_t IT_0183 = IT_0078*IT_0132*IT_0182;
    const ccomplex_t IT_0184 = IT_0109*IT_0153;
    const ccomplex_t IT_0185 = IT_0061*IT_0062*IT_0184;
    const ccomplex_t IT_0186 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0187 = IT_0001*IT_0186;
    const ccomplex_t IT_0188 = 1.4142135623731*IT_0187;
    const ccomplex_t IT_0189 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0190 = IT_0008*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = m_t*conj(N_u1)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0214 = IT_0127*IT_0176;
    const ccomplex_t IT_0215 = IT_0028*IT_0029*IT_0214;
    const ccomplex_t IT_0216 = m_t*IT_0172;
    const ccomplex_t IT_0217 = m_N_1*IT_0179;
    const ccomplex_t IT_0218 = m_t*IT_0156;
    const ccomplex_t IT_0219 = IT_0183 + IT_0185 + -IT_0199 + -IT_0213 +
       IT_0215 + -IT_0216 + -IT_0217 + -IT_0218;
    const ccomplex_t IT_0220 = 6*conj(IT_0219);
    const ccomplex_t IT_0221 = m_t*m_N_1;
    const ccomplex_t IT_0222 = 6*IT_0137;
    const ccomplex_t IT_0223 = 6*conj(IT_0137);
    const ccomplex_t IT_0224 = m_t*m_N_1*IT_0027;
    const ccomplex_t IT_0225 = s_13*IT_0027;
    ...
    const ccomplex_t IT_0230 = 0.166666666666667*IT_0174;
    const ccomplex_t IT_0231 = 6*IT_0219;
    const ccomplex_t IT_0232 = 0.166666666666667*IT_0181;
    const ccomplex_t IT_0233 = IT_0137*conj(IT_0137)*IT_0138 + (IT_0173
      *IT_0174 + IT_0180*IT_0181)*IT_0220 + conj(IT_0219)*(IT_0138*IT_0219 +
       IT_0221*IT_0222) + (IT_0174*IT_0180 + IT_0173*IT_0181 + IT_0219*IT_0221)
      *IT_0223 + 6*conj(IT_0173)*(IT_0180*IT_0224 + 0.166666666666667*IT_0173
      *IT_0229 + IT_0230*IT_0231 + IT_0222*IT_0232) + 6*conj(IT_0180)*(IT_0173
      *IT_0224 + 0.166666666666667*IT_0180*IT_0229 + IT_0222*IT_0230 + IT_0231
      *IT_0232);
