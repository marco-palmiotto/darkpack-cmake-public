...
ccomplex_return_t c_sumSqAmpl_N_1_sb_2_to_b_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_B1*e_em*U_sb_11;
    ...
    const ccomplex_t IT_0017 = m_b*N_d1*e_em*IT_0016*U_sb_01;
    ...
    const ccomplex_t IT_0031 = m_b*conj(N_d1)*e_em*IT_0016*U_sb_11;
    ...
    const ccomplex_t IT_0057 = m_b*s_14*m_N_1;
    ...
    const ccomplex_t IT_0069 = m_b*m_N_1;
    ...
    const ccomplex_t IT_0074 = m_b*s_34*m_N_1;
