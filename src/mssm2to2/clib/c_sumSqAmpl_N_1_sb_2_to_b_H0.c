...
ccomplex_return_t c_sumSqAmpl_N_1_sb_2_to_b_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*-1)*(e_em*IT_0028 + (
      -1.4142135623731)*A_b*IT_0019*IT_0020*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = IT_0018*IT_0030;
    const ccomplex_t IT_0032 = IT_0002*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0035 = IT_0004*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = m_b*N_d4*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0046 = IT_0004*IT_0020;
    const ccomplex_t IT_0047 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = IT_0011*IT_0022;
    ...
    const ccomplex_t IT_0054 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0055 = IT_0049*IT_0054;
    const ccomplex_t IT_0056 = IT_0048 + IT_0051 + IT_0053 + IT_0055;
    const ccomplex_t IT_0057 = IT_0004*IT_0022;
    const ccomplex_t IT_0058 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = IT_0011*IT_0020;
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0097 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0098 = IT_0004*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = m_b*N_d1*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0105 = (-2)*U_sb_01*((IT_0000*IT_0009*IT_0011*IT_0013
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*-1)*(e_em*IT_0105 + (
      -1.4142135623731)*A_b*IT_0019*IT_0020*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0042 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0117 = m_b*IT_0116;
    ...
    const ccomplex_t IT_0125 = IT_0049*IT_0124;
    ...
    const ccomplex_t IT_0139 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_N_1*
    ...
    const ccomplex_t IT_0165 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0166 = IT_0046*IT_0165;
    const ccomplex_t IT_0167 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0168 = IT_0049*IT_0167;
    const ccomplex_t IT_0169 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0170 = IT_0046*IT_0169;
    const ccomplex_t IT_0171 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0172 = IT_0049*IT_0171;
    const ccomplex_t IT_0173 = IT_0166 + IT_0168 + IT_0170 + IT_0172;
    const ccomplex_t IT_0174 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0175 = IT_0057*IT_0174;
    const ccomplex_t IT_0176 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0177 = IT_0060*IT_0176;
    const ccomplex_t IT_0178 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0188 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0189 = IT_0004*IT_0188;
    const ccomplex_t IT_0190 = 1.4142135623731*IT_0189;
    const ccomplex_t IT_0191 = m_b*N_d2*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0196 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_N_2*
    ...
    const ccomplex_t IT_0245 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0246 = IT_0004*IT_0245;
    const ccomplex_t IT_0247 = 1.4142135623731*IT_0246;
    const ccomplex_t IT_0248 = m_b*N_d3*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0253 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_N_3*
    ...
    const ccomplex_t IT_0257 = IT_0033 + IT_0095 + IT_0110 + (-2)*IT_0117 +
       IT_0142 + IT_0199 + IT_0256;
    const ccomplex_t IT_0258 = m_b*conj(N_d4)*e_em*IT_0013*U_sb_11;
    ...
    const ccomplex_t IT_0272 = m_N_1*IT_0070;
    const ccomplex_t IT_0273 = m_N_4*IT_0092;
    ...
    const ccomplex_t IT_0287 = (-2)*U_sb_01*((IT_0000*IT_0009*IT_0011*IT_0013
      *IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))*conj
      (U_sb_01) + -1./2*IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_11)) + U_sb_11
      *(IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_01) + (-2)*(IT_0000*IT_0009
      *IT_0011*IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*conj(U_sb_11
    ...
    const ccomplex_t IT_0291 = IT_0096*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = m_b*conj(N_d1)*e_em*IT_0013*U_sb_10;
    const ccomplex_t IT_0294 = IT_0012*IT_0293;
    const ccomplex_t IT_0295 = 1.4142135623731*IT_0294;
    const ccomplex_t IT_0296 = conj(N_W1)*e_em*U_sb_00;
    const ccomplex_t IT_0297 = IT_0011*IT_0296;
    const ccomplex_t IT_0298 = 1.4142135623731*IT_0297;
    const ccomplex_t IT_0299 = conj(N_B1)*e_em*U_sb_00;
    const ccomplex_t IT_0300 = IT_0004*IT_0299;
    const ccomplex_t IT_0301 = 1.4142135623731*IT_0300;
    const ccomplex_t IT_0302 = (0 + _Complex_I*1)*(IT_0295 + -IT_0298 +
       0.333333333333333*IT_0301);
    const ccomplex_t IT_0303 = 3*IT_0302;
    const ccomplex_t IT_0304 = 0.166666666666667*IT_0303;
    const ccomplex_t IT_0305 = (-2)*conj(U_sb_00)*((IT_0000*IT_0009*IT_0011
      *IT_0013*IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))
      *U_sb_01 + -1./2*IT_0009*IT_0011*IT_0021*IT_0022*U_sb_11) + conj(U_sb_10)*
      (IT_0009*IT_0011*IT_0021*IT_0022*U_sb_01 + (-2)*(IT_0000*IT_0009*IT_0011
      *IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*U_sb_11);
    const ccomplex_t IT_0306 = (0 + _Complex_I*-1)*(e_em*IT_0305 + (
      -1.4142135623731)*A_b*IT_0019*IT_0020*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    ...
    const ccomplex_t IT_0311 = IT_0113*IT_0286;
    const ccomplex_t IT_0312 = IT_0111*IT_0311;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = m_b*IT_0313;
    const ccomplex_t IT_0315 = IT_0139*IT_0286;
    const ccomplex_t IT_0316 = (0 + _Complex_I*1)*IT_0315;
    const ccomplex_t IT_0317 = IT_0138*IT_0316;
    const ccomplex_t IT_0318 = m_N_1*IT_0163;
    const ccomplex_t IT_0319 = m_N_2*IT_0185;
    const ccomplex_t IT_0320 = IT_0318 + IT_0319;
    const ccomplex_t IT_0321 = m_b*conj(N_d2)*e_em*IT_0013*U_sb_11;
    ...
    const ccomplex_t IT_0336 = m_N_1*IT_0220;
    const ccomplex_t IT_0337 = m_N_3*IT_0242;
    ...
    const ccomplex_t IT_0345 = m_b*conj(N_d3)*e_em*IT_0013*U_sb_11;
    const ccomplex_t IT_0346 = IT_0012*IT_0345;
    ...
    const ccomplex_t IT_0353 = -IT_0275 + -IT_0292 + -IT_0310 + 2*IT_0314 + 
      -IT_0317 + -IT_0335 + -IT_0352;
    const ccomplex_t IT_0354 = 6*s_13;
    const ccomplex_t IT_0355 = m_b*m_N_1;
    const ccomplex_t IT_0356 = 6*IT_0257;
    const ccomplex_t IT_0357 = IT_0163*IT_0334;
    const ccomplex_t IT_0358 = IT_0126*IT_0316;
    const ccomplex_t IT_0359 = IT_0070*IT_0271;
    const ccomplex_t IT_0360 = IT_0220*IT_0351;
    const ccomplex_t IT_0361 = -IT_0116 + IT_0357 + IT_0358 + IT_0359 + IT_0360;
    const ccomplex_t IT_0362 = m_b*s_14;
    const ccomplex_t IT_0363 = IT_0185*IT_0198;
    const ccomplex_t IT_0364 = IT_0045*IT_0092;
    const ccomplex_t IT_0365 = IT_0136*IT_0141;
    const ccomplex_t IT_0366 = IT_0242*IT_0255;
    const ccomplex_t IT_0367 = IT_0313 + -IT_0363 + -IT_0364 + -IT_0365 + 
      -IT_0366;
    const ccomplex_t IT_0368 = s_34*m_N_1;
    const ccomplex_t IT_0369 = 6*conj(IT_0257);
    const ccomplex_t IT_0370 = 6*conj(IT_0353);
    const ccomplex_t IT_0371 = pow(m_H0, 2);
    const ccomplex_t IT_0372 = m_b*m_N_1*IT_0371;
