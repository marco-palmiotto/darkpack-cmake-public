        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*(IT_0005 + -IT_0009 + 
      -IT_0014 + IT_0017);
    const ccomplex_t IT_0019 = m_N_1*IT_0018;
    const ccomplex_t IT_0020 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0021 = IT_0004*IT_0020;
    const ccomplex_t IT_0022 = conj(N_B1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0038 = m_b*N_d1*e_em*IT_0037*U_sb_01;
    ...
    const ccomplex_t IT_0044 = pow(m_sb_2, 2);
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0043 + IT_0044 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0042*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = IT_0030*IT_0047;
    const ccomplex_t IT_0049 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0050 = IT_0003*IT_0049;
    const ccomplex_t IT_0051 = 1.4142135623731*IT_0050;
    const ccomplex_t IT_0052 = m_b*N_d2*e_em*IT_0037*U_sb_01;
    ...
    const ccomplex_t IT_0082 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0083 = IT_0004*IT_0082;
    const ccomplex_t IT_0084 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0085 = IT_0016*IT_0084;
    const ccomplex_t IT_0086 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0087 = IT_0004*IT_0086;
    const ccomplex_t IT_0088 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0095 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0106 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0107 = IT_0003*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = m_b*N_d3*e_em*IT_0037*U_sb_01;
    ...
    const ccomplex_t IT_0114 = cpow((-2)*s_23 + IT_0043 + IT_0044 + -m_N_3*
    ...
    const ccomplex_t IT_0164 = cpow((-2)*s_13 + IT_0043 + IT_0163 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0165 = cpow(V_tb, 2);
    const ccomplex_t IT_0166 = m_b*mu_h*IT_0037;
    const ccomplex_t IT_0167 = sin(beta);
    const ccomplex_t IT_0168 = -IT_0007*IT_0167;
    const ccomplex_t IT_0169 = IT_0001*IT_0034;
    const ccomplex_t IT_0170 = IT_0168 + IT_0169;
    const ccomplex_t IT_0171 = cpow(IT_0002, -2);
    const ccomplex_t IT_0172 = (-2)*U_sb_01*((IT_0001*IT_0012*IT_0035*IT_0037
      *IT_0043 + (-0.5)*m_W*IT_0170*(IT_0012 + 1./3*IT_0011*IT_0171))*conj
      (U_sb_01) + -1./2*IT_0007*IT_0012*IT_0035*IT_0166*conj(U_sb_11)) + U_sb_11
      *(IT_0007*IT_0012*IT_0035*IT_0166*conj(U_sb_01) + (-2)*(IT_0001*IT_0012
      *IT_0035*IT_0037*IT_0043 + -1./3*m_W*IT_0011*IT_0170*IT_0171)*conj(U_sb_11
      ));
    const ccomplex_t IT_0173 = (0 + _Complex_I*-1)*(e_em*IT_0172 + (
      -1.4142135623731)*A_b*IT_0001*IT_0165*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = IT_0042*IT_0174;
    const ccomplex_t IT_0176 = IT_0164*IT_0175;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*IT_0176;
    const ccomplex_t IT_0178 = cpow((-2)*s_13 + IT_0043 + IT_0163 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0179 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0180 = IT_0003*IT_0179;
    const ccomplex_t IT_0181 = 1.4142135623731*IT_0180;
    const ccomplex_t IT_0182 = m_b*N_d1*e_em*IT_0037*U_sb_00;
    const ccomplex_t IT_0183 = IT_0036*IT_0182;
    ...
    const ccomplex_t IT_0187 = (-2)*conj(U_sb_00)*((IT_0001*IT_0012*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0170*(IT_0012 + 1./3*IT_0011*IT_0171))
      *U_sb_01 + -1./2*IT_0007*IT_0012*IT_0035*IT_0166*U_sb_11) + conj(U_sb_10)*
      (IT_0007*IT_0012*IT_0035*IT_0166*U_sb_01 + (-2)*(IT_0001*IT_0012*IT_0035
      *IT_0037*IT_0043 + -1./3*m_W*IT_0011*IT_0170*IT_0171)*U_sb_11);
    const ccomplex_t IT_0188 = (0 + _Complex_I*-1)*(e_em*IT_0187 + (
      -1.4142135623731)*A_b*IT_0001*IT_0165*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0189 = (-0.5)*IT_0188;
    const ccomplex_t IT_0190 = IT_0186*IT_0189;
    const ccomplex_t IT_0191 = IT_0178*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*IT_0191;
    const ccomplex_t IT_0193 = cpow((-2)*s_12 + IT_0043 + -IT_0044 + -IT_0163 
      + -reg_prop, -1);
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*m_b*e_em*IT_0001*IT_0012
      *IT_0035*IT_0037;
    ...
    const ccomplex_t IT_0199 = m_b*IT_0198;
    ...
    const ccomplex_t IT_0212 = IT_0013*IT_0211;
    const ccomplex_t IT_0213 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0214 = IT_0008*IT_0213;
    ...
    const ccomplex_t IT_0238 = IT_0013*IT_0237;
    ...
    const ccomplex_t IT_0245 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0246 = IT_0003*IT_0245;
    const ccomplex_t IT_0247 = 1.4142135623731*IT_0246;
    const ccomplex_t IT_0248 = m_b*N_d4*e_em*IT_0037*U_sb_01;
    const ccomplex_t IT_0249 = IT_0036*IT_0248;
    ...
    const ccomplex_t IT_0253 = cpow((-2)*s_23 + IT_0043 + IT_0044 + -m_N_4*
    ...
    const ccomplex_t IT_0257 = IT_0048 + IT_0105 + IT_0162 + IT_0177 + IT_0192
       + (-2)*IT_0199 + IT_0256;
    const ccomplex_t IT_0258 = m_b*conj(N_d1)*e_em*IT_0037*U_sb_11;
    const ccomplex_t IT_0259 = IT_0036*IT_0258;
    const ccomplex_t IT_0260 = 1.4142135623731*IT_0259;
    const ccomplex_t IT_0261 = conj(N_W1)*e_em*U_sb_01;
    const ccomplex_t IT_0262 = IT_0012*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = conj(N_B1)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0270 = IT_0195*IT_0269;
    const ccomplex_t IT_0271 = IT_0193*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*IT_0271;
    const ccomplex_t IT_0273 = m_b*IT_0272;
    const ccomplex_t IT_0274 = (-2)*U_sb_01*((IT_0001*IT_0012*IT_0035*IT_0037
      *IT_0043 + (-0.5)*m_W*IT_0170*(IT_0012 + 1./3*IT_0011*IT_0171))*conj
      (U_sb_01) + -1./2*IT_0007*IT_0012*IT_0035*IT_0166*conj(U_sb_11)) + U_sb_11
      *(IT_0007*IT_0012*IT_0035*IT_0166*conj(U_sb_01) + (-2)*(IT_0001*IT_0012
      *IT_0035*IT_0037*IT_0043 + -1./3*m_W*IT_0011*IT_0170*IT_0171)*conj(U_sb_11
    ...
    const ccomplex_t IT_0297 = (-2)*conj(U_sb_00)*((IT_0001*IT_0012*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0170*(IT_0012 + 1./3*IT_0011*IT_0171))
      *U_sb_01 + -1./2*IT_0007*IT_0012*IT_0035*IT_0166*U_sb_11) + conj(U_sb_10)*
      (IT_0007*IT_0012*IT_0035*IT_0166*U_sb_01 + (-2)*(IT_0001*IT_0012*IT_0035
      *IT_0037*IT_0043 + -1./3*m_W*IT_0011*IT_0170*IT_0171)*U_sb_11);
    const ccomplex_t IT_0298 = (0 + _Complex_I*-1)*(e_em*IT_0297 + (
      -1.4142135623731)*A_b*IT_0001*IT_0165*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0299 = (-0.5)*IT_0298;
    const ccomplex_t IT_0300 = IT_0296*IT_0299;
    const ccomplex_t IT_0301 = IT_0178*IT_0300;
    const ccomplex_t IT_0302 = (0 + _Complex_I*1)*IT_0301;
    const ccomplex_t IT_0303 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0304 = IT_0012*IT_0303;
    const ccomplex_t IT_0305 = 1.4142135623731*IT_0304;
    const ccomplex_t IT_0306 = m_b*conj(N_d2)*e_em*IT_0037*U_sb_11;
    const ccomplex_t IT_0307 = IT_0036*IT_0306;
    const ccomplex_t IT_0308 = 1.4142135623731*IT_0307;
    const ccomplex_t IT_0309 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0333 = IT_0114*IT_0332;
    const ccomplex_t IT_0334 = (0 + _Complex_I*1)*IT_0333;
    const ccomplex_t IT_0335 = m_N_1*IT_0137;
    const ccomplex_t IT_0336 = m_N_3*IT_0159;
    const ccomplex_t IT_0337 = IT_0335 + IT_0336;
    const ccomplex_t IT_0338 = IT_0334*IT_0337;
    const ccomplex_t IT_0339 = conj(N_B4)*e_em*U_sb_01;
    const ccomplex_t IT_0340 = IT_0003*IT_0339;
    const ccomplex_t IT_0341 = 1.4142135623731*IT_0340;
    const ccomplex_t IT_0342 = conj(N_W4)*e_em*U_sb_01;
    const ccomplex_t IT_0343 = IT_0012*IT_0342;
    const ccomplex_t IT_0344 = 1.4142135623731*IT_0343;
    const ccomplex_t IT_0345 = m_b*conj(N_d4)*e_em*IT_0037*U_sb_11;
    const ccomplex_t IT_0346 = IT_0036*IT_0345;
    ...
    const ccomplex_t IT_0352 = m_N_1*IT_0242;
    const ccomplex_t IT_0353 = m_N_4*IT_0220;
    const ccomplex_t IT_0354 = IT_0352 + IT_0353;
    const ccomplex_t IT_0355 = IT_0351*IT_0354;
    const ccomplex_t IT_0356 = 2*IT_0273 + -IT_0279 + -IT_0282 + -IT_0302 + 
      -IT_0320 + -IT_0338 + -IT_0355;
    const ccomplex_t IT_0357 = 6*s_13;
    const ccomplex_t IT_0358 = m_b*m_N_1;
    const ccomplex_t IT_0359 = 6*IT_0257;
    const ccomplex_t IT_0360 = IT_0137*IT_0334;
    const ccomplex_t IT_0361 = IT_0018*IT_0281;
    const ccomplex_t IT_0362 = IT_0242*IT_0351;
    const ccomplex_t IT_0363 = IT_0080*IT_0316;
    const ccomplex_t IT_0364 = -IT_0198 + IT_0360 + IT_0361 + IT_0362 + IT_0363;
    const ccomplex_t IT_0365 = m_b*s_14;
    const ccomplex_t IT_0366 = IT_0059*IT_0102;
    const ccomplex_t IT_0367 = IT_0116*IT_0159;
    const ccomplex_t IT_0368 = IT_0028*IT_0047;
    const ccomplex_t IT_0369 = IT_0220*IT_0255;
    const ccomplex_t IT_0370 = IT_0272 + -IT_0366 + -IT_0367 + -IT_0368 + 
      -IT_0369;
    const ccomplex_t IT_0371 = s_34*m_N_1;
    const ccomplex_t IT_0372 = 6*conj(IT_0257);
    const ccomplex_t IT_0373 = 6*conj(IT_0356);
    const ccomplex_t IT_0374 = pow(m_H0, 2);
    ...
    const ccomplex_t IT_0382 = (IT_0257*conj(IT_0257) + IT_0356*conj(IT_0356))
