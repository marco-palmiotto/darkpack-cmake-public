        ...
        )
{
    ...
    const ccomplex_t IT_0005 = N_B1*e_em*U_sb_11;
    ...
    const ccomplex_t IT_0014 = m_b*N_d1*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0028 = 2*U_sb_01*((IT_0000*IT_0009*IT_0011*IT_0013
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0035 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0036 = IT_0004*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = m_b*N_d1*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0043 = 2*conj(U_sb_00)*((IT_0000*IT_0009*IT_0011
    ...
    const ccomplex_t IT_0088 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0089 = IT_0058*IT_0088;
    const ccomplex_t IT_0090 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0091 = IT_0061*IT_0090;
    const ccomplex_t IT_0092 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0093 = IT_0058*IT_0092;
    const ccomplex_t IT_0094 = conj(N_B2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0100 = IT_0067*IT_0099;
    ...
    const ccomplex_t IT_0113 = IT_0061*IT_0112;
    ...
    const ccomplex_t IT_0133 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0134 = IT_0004*IT_0133;
    const ccomplex_t IT_0135 = 1.4142135623731*IT_0134;
    const ccomplex_t IT_0136 = m_b*N_d2*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0141 = cpow((-2)*s_23 + IT_0000 + IT_0049 + -m_N_2*
    ...
    const ccomplex_t IT_0157 = IT_0067*IT_0156;
    ...
    const ccomplex_t IT_0170 = IT_0061*IT_0169;
    const ccomplex_t IT_0171 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0172 = IT_0058*IT_0171;
    ...
    const ccomplex_t IT_0202 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0203 = IT_0004*IT_0202;
    const ccomplex_t IT_0204 = 1.4142135623731*IT_0203;
    const ccomplex_t IT_0205 = m_b*N_d4*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0213 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0214 = IT_0058*IT_0213;
    const ccomplex_t IT_0215 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0216 = IT_0061*IT_0215;
    const ccomplex_t IT_0217 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0218 = IT_0058*IT_0217;
    const ccomplex_t IT_0219 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0220 = IT_0061*IT_0219;
    const ccomplex_t IT_0221 = IT_0214 + IT_0216 + IT_0218 + IT_0220;
    const ccomplex_t IT_0222 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0223 = IT_0064*IT_0222;
    const ccomplex_t IT_0224 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0225 = IT_0067*IT_0224;
    const ccomplex_t IT_0226 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0227 = IT_0064*IT_0226;
    const ccomplex_t IT_0228 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0271 = 2*U_sb_01*((IT_0000*IT_0009*IT_0011*IT_0013
      *IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))*conj
      (U_sb_01) + 1./2*IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_11)) + U_sb_11*
      (IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_01) + 2*(IT_0000*IT_0009
      *IT_0011*IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*conj(U_sb_11
    ...
    const ccomplex_t IT_0277 = 2*conj(U_sb_00)*((IT_0000*IT_0009*IT_0011
      *IT_0013*IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))
      *U_sb_01 + 1./2*IT_0009*IT_0011*IT_0021*IT_0022*U_sb_11) + conj(U_sb_10)*
      (IT_0009*IT_0011*IT_0021*IT_0022*U_sb_01 + 2*(IT_0000*IT_0009*IT_0011
      *IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*U_sb_11);
    ...
    const ccomplex_t IT_0280 = m_b*conj(N_d1)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0293 = IT_0034*IT_0292;
    const ccomplex_t IT_0294 = (0 + _Complex_I*1)*IT_0293;
    const ccomplex_t IT_0295 = IT_0052*IT_0270;
    ...
    const ccomplex_t IT_0351 = m_N_1*IT_0255;
    const ccomplex_t IT_0352 = m_N_4*IT_0233;
    const ccomplex_t IT_0353 = IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = IT_0350*IT_0353;
    const ccomplex_t IT_0355 = -IT_0276 + -IT_0294 + 2*IT_0298 + -IT_0301 + 
      -IT_0319 + -IT_0336 + -IT_0354;
    const ccomplex_t IT_0356 = 6*s_13;
    const ccomplex_t IT_0357 = m_b*m_N_1;
    const ccomplex_t IT_0358 = 6*IT_0259;
    const ccomplex_t IT_0359 = IT_0070*IT_0300;
    const ccomplex_t IT_0360 = IT_0130*IT_0315;
    const ccomplex_t IT_0361 = IT_0165*IT_0332;
    const ccomplex_t IT_0362 = IT_0255*IT_0350;
    const ccomplex_t IT_0363 = -IT_0055 + IT_0359 + IT_0360 + IT_0361 + IT_0362;
    const ccomplex_t IT_0364 = m_b*s_14;
    const ccomplex_t IT_0365 = IT_0187*IT_0200;
    const ccomplex_t IT_0366 = IT_0212*IT_0233;
    const ccomplex_t IT_0367 = IT_0081*IT_0086;
    const ccomplex_t IT_0368 = IT_0108*IT_0143;
    const ccomplex_t IT_0369 = IT_0297 + -IT_0365 + -IT_0366 + -IT_0367 + 
      -IT_0368;
    const ccomplex_t IT_0370 = s_34*m_N_1;
    const ccomplex_t IT_0371 = 6*conj(IT_0259);
    const ccomplex_t IT_0372 = 6*conj(IT_0355);
    const ccomplex_t IT_0373 = pow(m_h, 2);
    const ccomplex_t IT_0374 = m_b*m_N_1*IT_0373;
