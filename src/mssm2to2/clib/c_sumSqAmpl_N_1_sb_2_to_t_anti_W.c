        ...
        )
{
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001;
    const ccomplex_t IT_0099 = 0.5*IT_0098;
    const ccomplex_t IT_0100 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0101 = IT_0005*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = m_b*N_d1*e_em*IT_0012*U_sb_01;
    ...
    const ccomplex_t IT_0153 = s_13*IT_0125;
    const ccomplex_t IT_0154 = (-12)*IT_0153;
    const ccomplex_t IT_0155 = 6*IT_0150 + IT_0152 + IT_0154;
    const ccomplex_t IT_0156 = (-3)*IT_0126;
    const ccomplex_t IT_0157 = conj(N_W1)*e_em*U_Wm1;
    const ccomplex_t IT_0158 = IT_0001*IT_0157;
    const ccomplex_t IT_0159 = conj(N_d1)*U_d1*e_em;
    ...
    const ccomplex_t IT_0180 = m_t*conj(N_u1)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0199 = IT_0034*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*IT_0199;
    const ccomplex_t IT_0201 = IT_0025*IT_0200;
    const ccomplex_t IT_0202 = (-2)*IT_0119 + -IT_0187 + -IT_0201;
    const ccomplex_t IT_0203 = 2*IT_0166;
    ...
    const ccomplex_t IT_0207 = (-6)*conj(IT_0203);
    const ccomplex_t IT_0208 = 0.166666666666667*IT_0207;
    const ccomplex_t IT_0209 = conj(IT_0202) + IT_0208;
    const ccomplex_t IT_0210 = conj(IT_0141) + conj(IT_0167);
    const ccomplex_t IT_0211 = (-6)*IT_0202;
    const ccomplex_t IT_0212 = 0.166666666666667*IT_0211;
    const ccomplex_t IT_0213 = IT_0203 + IT_0212;
    const ccomplex_t IT_0214 = (-6)*conj(IT_0202);
    const ccomplex_t IT_0215 = 0.166666666666667*IT_0214;
    const ccomplex_t IT_0216 = conj(IT_0203) + IT_0215;
    const ccomplex_t IT_0217 = s_14*s_34*IT_0066;
    const ccomplex_t IT_0218 = -IT_0217;
    const ccomplex_t IT_0219 = s_13 + IT_0218;
    const ccomplex_t IT_0220 = m_t*IT_0219;
    const ccomplex_t IT_0221 = -IT_0023 + -IT_0037;
    const ccomplex_t IT_0222 = (-6)*conj(IT_0221);
    const ccomplex_t IT_0223 = s_34*IT_0125;
    const ccomplex_t IT_0224 = IT_0066*IT_0223;
    ...
    const ccomplex_t IT_0229 = (-6)*conj(IT_0121);
    const ccomplex_t IT_0230 = 2*IT_0141 + IT_0187 + IT_0201;
    const ccomplex_t IT_0231 = s_13*IT_0219;
    const ccomplex_t IT_0232 = IT_0124*IT_0219;
    const ccomplex_t IT_0233 = m_N_1*IT_0219;
    const ccomplex_t IT_0234 = IT_0070*IT_0124;
    const ccomplex_t IT_0235 = (-6)*IT_0065;
    const ccomplex_t IT_0236 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0237 = pow(s_34, 2);
    const ccomplex_t IT_0238 = IT_0066*IT_0237;
    const ccomplex_t IT_0239 = -IT_0238;
    const ccomplex_t IT_0240 = IT_0018 + IT_0239;
    const ccomplex_t IT_0241 = IT_0124*IT_0240;
    const ccomplex_t IT_0242 = m_N_1*IT_0240;
    const ccomplex_t IT_0243 = s_14*IT_0018;
    const ccomplex_t IT_0244 = s_13*s_34;
    const ccomplex_t IT_0245 = -IT_0244;
    const ccomplex_t IT_0246 = IT_0243 + IT_0245;
    const ccomplex_t IT_0247 = (-6)*IT_0230;
    const ccomplex_t IT_0248 = (-6)*conj(IT_0230);
    const ccomplex_t IT_0249 = (-6)*IT_0150;
    const ccomplex_t IT_0250 = (-24)*IT_0151;
    const ccomplex_t IT_0251 = 12*IT_0153;
    const ccomplex_t IT_0252 = IT_0249 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = IT_0152 + IT_0249;
    const ccomplex_t IT_0254 = (-6)*IT_0121;
    const ccomplex_t IT_0255 = IT_0123*IT_0156;
    const ccomplex_t IT_0256 = m_N_1*IT_0051;
    const ccomplex_t IT_0257 = m_N_1*IT_0064;
    const ccomplex_t IT_0258 = m_t*IT_0141;
    const ccomplex_t IT_0259 = -IT_0256 + -IT_0257 + -IT_0258;
    const ccomplex_t IT_0260 = IT_0048*IT_0163;
    const ccomplex_t IT_0261 = IT_0039*IT_0072*IT_0260;
    const ccomplex_t IT_0262 = IT_0061*IT_0116;
    const ccomplex_t IT_0263 = IT_0052*IT_0085*IT_0262;
    const ccomplex_t IT_0264 = IT_0261 + IT_0263;
    const ccomplex_t IT_0265 = m_N_1*IT_0166;
    const ccomplex_t IT_0266 = (-2)*IT_0151;
    const ccomplex_t IT_0267 = IT_0153 + IT_0266;
    const ccomplex_t IT_0268 = IT_0066*IT_0267;
    const ccomplex_t IT_0269 = (-6)*IT_0268;
    const ccomplex_t IT_0270 = 12*s_13;
    const ccomplex_t IT_0271 = IT_0269 + IT_0270;
    const ccomplex_t IT_0272 = IT_0259 + IT_0264;
    const ccomplex_t IT_0273 = (-6)*IT_0221;
    const ccomplex_t IT_0274 = 6*IT_0123;
    const ccomplex_t IT_0275 = (-0.25)*IT_0143;
    const ccomplex_t IT_0276 = s_14 + IT_0275;
    const ccomplex_t IT_0277 = m_t*IT_0276;
    const ccomplex_t IT_0278 = (-4)*IT_0277;
    const ccomplex_t IT_0279 = 6*IT_0141;
    const ccomplex_t IT_0280 = (-6)*IT_0169;
    const ccomplex_t IT_0281 = 6*IT_0122*IT_0206 + IT_0233*IT_0235 + IT_0220
      *IT_0247 + IT_0124*((-18)*IT_0121 + (-18)*IT_0265) + IT_0271*IT_0272 +
       IT_0242*IT_0273 + IT_0228*IT_0274 + IT_0278*IT_0279 + IT_0147*IT_0280;
    const ccomplex_t IT_0282 = 0.5*IT_0224;
    const ccomplex_t IT_0283 = s_34 + IT_0282;
    const ccomplex_t IT_0284 = m_N_1*IT_0283;
    const ccomplex_t IT_0285 = 2*IT_0284;
    const ccomplex_t IT_0286 = 6*IT_0065*IT_0122 + 6*IT_0213*IT_0233 + IT_0242
      *IT_0247 + IT_0124*((-18)*IT_0259 + (-18)*IT_0264) + (IT_0121 + IT_0265)
      *IT_0271 + IT_0220*IT_0273 + IT_0147*IT_0274 + IT_0228*IT_0280 + IT_0279
      *IT_0285;
    const ccomplex_t IT_0287 = 0.166666666666667*IT_0232;
    const ccomplex_t IT_0288 = 0.166666666666667*IT_0233;
    const ccomplex_t IT_0289 = 6*IT_0150 + IT_0250;
    const ccomplex_t IT_0290 = 0.166666666666667*IT_0119;
    const ccomplex_t IT_0291 = 0.166666666666667*IT_0141;
    const ccomplex_t IT_0292 = s_13*IT_0240;
    const ccomplex_t IT_0293 = 0.166666666666667*IT_0292;
    const ccomplex_t IT_0294 = 0.166666666666667*IT_0220;
    const ccomplex_t IT_0295 = (-18)*conj(IT_0121);
    const ccomplex_t IT_0296 = conj(IT_0119) + -conj(IT_0167);
    const ccomplex_t IT_0297 = 0.166666666666667*IT_0242;
    const ccomplex_t IT_0298 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0121
      *IT_0122) + 6*conj(IT_0123)*(IT_0127*IT_0141 + IT_0121*IT_0147 +
       0.166666666666667*IT_0123*IT_0155 + -IT_0156*IT_0169) + IT_0071*IT_0203
      *IT_0214 + 6*IT_0173*(conj(IT_0065)*IT_0123 + IT_0065*conj(IT_0123) + conj
      (IT_0119)*IT_0206 + IT_0119*IT_0209 + IT_0210*IT_0213 + (IT_0141 + IT_0167
      )*IT_0216) + IT_0121*IT_0220*IT_0222 + IT_0167*IT_0228*IT_0229 + 6*conj
      (IT_0203)*(IT_0071*IT_0213 + IT_0230*IT_0231 + IT_0221*IT_0232 + IT_0121
      *IT_0233 + 0.166666666666667*IT_0234*IT_0235) + (IT_0221*IT_0231 + IT_0203
      *IT_0234)*IT_0236 + IT_0230*(IT_0214*IT_0231 + IT_0232*IT_0236 + IT_0222
      *IT_0241 + IT_0229*IT_0242) + 6*IT_0246*(conj(IT_0123)*IT_0221 + IT_0123
      *conj(IT_0221) + conj(IT_0119)*IT_0230 + IT_0119*conj(IT_0230) +
       0.166666666666667*IT_0210*IT_0247 + 0.166666666666667*(IT_0141 + IT_0167)
      *IT_0248) + conj(IT_0167)*(IT_0155*IT_0167 + IT_0119*IT_0252 + IT_0141
      *IT_0253 + IT_0228*IT_0254 + (-6)*IT_0255) + (conj(IT_0259) + conj(IT_0264
      ))*IT_0281 + conj(IT_0265)*IT_0286 + 6*IT_0202*(IT_0071*conj(IT_0202) +
       conj(IT_0065)*IT_0234 + IT_0222*IT_0287 + IT_0229*IT_0288) + 6*conj
      (IT_0202)*(IT_0065*IT_0234 + IT_0273*IT_0287 + IT_0254*IT_0288) + 6*conj
      (IT_0141)*(IT_0123*IT_0127 + 0.166666666666667*IT_0167*IT_0253 + IT_0121
      *IT_0285 + IT_0289*IT_0290 + IT_0155*IT_0291) + 6*conj(IT_0119)*(IT_0121
      *IT_0228 + 0.166666666666667*IT_0167*IT_0252 + IT_0255 + IT_0155*IT_0290 +
       IT_0289*IT_0291) + 6*conj(IT_0221)*(IT_0203*IT_0232 + 0.166666666666667
      *IT_0231*IT_0235 + IT_0273*IT_0293) + 6*conj(IT_0121)*(IT_0065*IT_0122 +
       IT_0123*IT_0147 + IT_0119*IT_0228 + IT_0203*IT_0233 + 0.166666666666667
      *IT_0121*IT_0271 + IT_0141*IT_0285 + IT_0273*IT_0294) + 6*IT_0272*(IT_0122
      *IT_0209 + conj(IT_0123)*IT_0228 + conj(IT_0141)*IT_0278 + IT_0236*IT_0288
       + IT_0248*IT_0294 + 0.166666666666667*IT_0124*IT_0295 + IT_0147*IT_0296 +
       IT_0222*IT_0297) + 6*IT_0265*(conj(IT_0065)*IT_0122 + conj(IT_0123)
      *IT_0147 + IT_0216*IT_0233 + 0.166666666666667*conj(IT_0121)*IT_0271 +
       conj(IT_0141)*IT_0285 + IT_0222*IT_0294 + IT_0228*IT_0296 + IT_0248
      *IT_0297) + 6*conj(IT_0230)*(IT_0213*IT_0231 + 0.166666666666667*IT_0241
      *IT_0273 + IT_0235*IT_0287 + IT_0247*IT_0293 + IT_0254*IT_0297);
