...
ccomplex_return_t c_sumSqAmpl_N_1_sc_L_to_c_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (-1.33333333333333)*IT_0004;
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
    ...
    const ccomplex_t IT_0040 = (-0.666666666666667)*IT_0004;
    ...
    const ccomplex_t IT_0046 = m_c*s_14*m_N_1;
    ...
    const ccomplex_t IT_0058 = m_c*m_N_1;
    ...
    const ccomplex_t IT_0063 = m_c*s_34*m_N_1;
