        ...
        )
{
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0000*IT_0002*IT_0042;
    const ccomplex_t IT_0044 = (-0.5)*IT_0043;
    const ccomplex_t IT_0045 = pow(m_sc_L, 2);
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_1*
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_2*
    ...
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
    ...
    const ccomplex_t IT_0195 = m_N_1*IT_0066;
    const ccomplex_t IT_0196 = m_N_2*IT_0084;
    ...
    const ccomplex_t IT_0210 = m_N_1*IT_0109;
    ...
    const ccomplex_t IT_0234 = m_N_1*IT_0152;
