...
ccomplex_return_t c_sumSqAmpl_N_1_sc_L_to_c_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
    ...
    const ccomplex_t IT_0045 = m_c*s_14*m_N_1;
    ...
    const ccomplex_t IT_0057 = m_c*m_N_1;
    ...
    const ccomplex_t IT_0062 = m_c*s_34*m_N_1;
