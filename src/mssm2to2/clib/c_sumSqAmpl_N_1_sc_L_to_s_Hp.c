        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp2)
      *IT_0014;
    ...
    const ccomplex_t IT_0067 = IT_0011*IT_0031;
    const ccomplex_t IT_0068 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = IT_0011*IT_0014;
    const ccomplex_t IT_0072 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0088 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0089 = IT_0071*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0095 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0126 = cpow((-2)*s_13 + IT_0007 + IT_0023 + -m_ss_R*
    ...
    const ccomplex_t IT_0135 = IT_0042*IT_0102;
    const ccomplex_t IT_0136 = IT_0024*IT_0134*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0138 = IT_0018*IT_0116;
    const ccomplex_t IT_0139 = IT_0008*IT_0137*IT_0138;
    const ccomplex_t IT_0140 = cpow((-2)*s_13 + IT_0007 + IT_0023 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0141 = (0 + _Complex_I*(-2.82842712474619))*conj(V_cs)
      *e_em*IT_0014*(IT_0010*(m_W*IT_0011 + (-0.5)*IT_0006*IT_0009*IT_0012) + 
      -1./2*IT_0009*IT_0011*IT_0023*IT_0082);
    const ccomplex_t IT_0142 = 0.5*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0149 = IT_0060*IT_0084;
    const ccomplex_t IT_0150 = IT_0046*IT_0148*IT_0149;
    const ccomplex_t IT_0151 = m_N_1*IT_0119;
    const ccomplex_t IT_0152 = IT_0133 + -IT_0136 + -IT_0139 + IT_0147 + 
      -IT_0150 + IT_0151;
    const ccomplex_t IT_0153 = IT_0045 + IT_0063;
    const ccomplex_t IT_0154 = m_s*IT_0153;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = IT_0025*IT_0100;
    const ccomplex_t IT_0157 = IT_0024*IT_0134*IT_0156;
    const ccomplex_t IT_0158 = IT_0047*IT_0081;
    const ccomplex_t IT_0159 = IT_0046*IT_0148*IT_0158;
    const ccomplex_t IT_0160 = m_N_1*IT_0021;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
    ...
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*(IT_0109 + (-3)*IT_0112);
    const ccomplex_t IT_0167 = 0.166666666666667*IT_0166;
    const ccomplex_t IT_0168 = IT_0142*IT_0167;
    const ccomplex_t IT_0169 = IT_0140*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*IT_0169;
    const ccomplex_t IT_0171 = IT_0016*IT_0114;
    const ccomplex_t IT_0172 = IT_0008*IT_0137*IT_0171;
    const ccomplex_t IT_0173 = -IT_0157 + -IT_0159 + -IT_0160 + -IT_0165 + 
      -IT_0170 + IT_0172;
