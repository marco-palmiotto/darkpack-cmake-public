...
ccomplex_return_t c_sumSqAmpl_N_1_sc_L_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0009*IT_0010*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp2)
      *IT_0014;
    const ccomplex_t IT_0024 = IT_0010*IT_0014;
    const ccomplex_t IT_0025 = N_u1*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0042 = pow(m_s, 2);
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0041*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp1)
      *IT_0014;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0009*IT_0014*IT_0067;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0011*IT_0014;
    const ccomplex_t IT_0071 = conj(N_W1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0075 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = IT_0073 + IT_0077;
    const ccomplex_t IT_0079 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0091 = IT_0074*IT_0090;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0009*IT_0011*IT_0014*IT_0067;
    ...
    const ccomplex_t IT_0122 = m_s*m_N_1;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0124 = IT_0040*IT_0069;
    const ccomplex_t IT_0125 = IT_0043*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = cpow((-2)*s_13 + IT_0007 + IT_0042 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0009*IT_0014;
    ...
    const ccomplex_t IT_0134 = cpow((-2)*s_13 + IT_0007 + IT_0042 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0135 = (0 + _Complex_I*(-2.82842712474619))*conj(V_cs)
      *e_em*IT_0014*(IT_0010*(m_W*IT_0011 + (-0.5)*IT_0006*IT_0009*IT_0012) + 
      -1./2*IT_0009*IT_0011*IT_0042*IT_0067);
    const ccomplex_t IT_0136 = 0.5*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0143 = IT_0060*IT_0089;
    const ccomplex_t IT_0144 = IT_0046*IT_0142*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0146 = IT_0018*IT_0108;
    const ccomplex_t IT_0147 = IT_0008*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = m_N_1*IT_0119;
    const ccomplex_t IT_0149 = -IT_0125 + IT_0133 + IT_0141 + -IT_0144 + 
      -IT_0147 + IT_0148;
    const ccomplex_t IT_0150 = IT_0045 + IT_0063;
    const ccomplex_t IT_0151 = m_s*IT_0150;
    const ccomplex_t IT_0152 = -IT_0151;
    const ccomplex_t IT_0153 = IT_0023*IT_0084;
    const ccomplex_t IT_0154 = IT_0043*IT_0123*IT_0153;
    const ccomplex_t IT_0155 = m_s*IT_0087;
    const ccomplex_t IT_0156 = m_s*IT_0105;
    const ccomplex_t IT_0157 = IT_0154 + -IT_0155 + -IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*(IT_0111 + (-3)*IT_0114);
    ...
    const ccomplex_t IT_0163 = IT_0047*IT_0102;
    const ccomplex_t IT_0164 = IT_0046*IT_0142*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0009*IT_0014*IT_0067;
    const ccomplex_t IT_0166 = 0.5*IT_0165;
    const ccomplex_t IT_0167 = IT_0128*IT_0166;
    const ccomplex_t IT_0168 = IT_0126*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*IT_0168;
    const ccomplex_t IT_0170 = IT_0016*IT_0116;
    const ccomplex_t IT_0171 = IT_0008*IT_0145*IT_0170;
    const ccomplex_t IT_0172 = m_N_1*IT_0021;
    const ccomplex_t IT_0173 = -IT_0162 + -IT_0164 + -IT_0169 + IT_0171 + 
      -IT_0172;
    const ccomplex_t IT_0174 = 6*IT_0149;
    const ccomplex_t IT_0175 = (-6)*IT_0152;
    const ccomplex_t IT_0176 = IT_0174 + IT_0175;
    const ccomplex_t IT_0177 = 6*conj(IT_0149);
    const ccomplex_t IT_0178 = (-6)*conj(IT_0152);
    const ccomplex_t IT_0179 = IT_0177 + IT_0178;
    const ccomplex_t IT_0180 = s_23*m_N_1;
    ...
    const ccomplex_t IT_0189 = m_s*m_N_1*IT_0000;
    ...
    const ccomplex_t IT_0193 = IT_0005*(IT_0065*IT_0066 + IT_0120*IT_0121) + (
      -6)*IT_0122*((conj(IT_0149) + -conj(IT_0152))*IT_0157 + (IT_0149 + 
      ...
      *IT_0179 + IT_0121*IT_0183 + IT_0120*IT_0186)*IT_0187 + (IT_0149*conj
      (IT_0149) + IT_0152*conj(IT_0152) + IT_0157*conj(IT_0157) + IT_0173*conj
      (IT_0173))*IT_0188 + 6*IT_0189*(IT_0121*(IT_0064 + 0.166666666666667
      *IT_0190) + IT_0120*(conj(IT_0064) + 0.166666666666667*IT_0191)) + (conj
      (IT_0149)*IT_0152 + IT_0149*conj(IT_0152) + conj(IT_0157)*IT_0173 +
