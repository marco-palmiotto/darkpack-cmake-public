...
ccomplex_return_t c_sumSqAmpl_N_1_sc_L_to_s_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0063 = m_s*m_N_1;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp1)
      *IT_0007;
    const ccomplex_t IT_0082 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0083 = IT_0007*IT_0082;
    const ccomplex_t IT_0084 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0133 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0003*IT_0007*IT_0132;
    ...
    const ccomplex_t IT_0151 = IT_0022*IT_0077;
    const ccomplex_t IT_0152 = IT_0020*IT_0127*IT_0151;
    const ccomplex_t IT_0153 = IT_0009*IT_0088;
    const ccomplex_t IT_0154 = IT_0002*IT_0124*IT_0153;
