        ...
        )
{
    ...
    const ccomplex_t IT_0034 = pow(m_sc_R, 2);
    ...
    const ccomplex_t IT_0078 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_N_2*
    ...
    const ccomplex_t IT_0087 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0088 = IT_0003*IT_0087;
    const ccomplex_t IT_0089 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0090 = IT_0007*IT_0089;
    const ccomplex_t IT_0091 = N_W3*N_u1*e_em;
    ...
    const ccomplex_t IT_0097 = N_B1*N_d3*e_em;
    ...
    const ccomplex_t IT_0105 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0111 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0112 = IT_0015*IT_0111;
    const ccomplex_t IT_0113 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0114 = IT_0003*IT_0113;
    const ccomplex_t IT_0115 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0116 = IT_0007*IT_0115;
    const ccomplex_t IT_0117 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0118 = IT_0012*IT_0117;
    const ccomplex_t IT_0119 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0127 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_N_4*
    ...
    const ccomplex_t IT_0132 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0133 = IT_0007*IT_0132;
    const ccomplex_t IT_0134 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0135 = IT_0012*IT_0134;
    const ccomplex_t IT_0136 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0137 = IT_0015*IT_0136;
    const ccomplex_t IT_0138 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0139 = IT_0003*IT_0138;
    const ccomplex_t IT_0140 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0141 = IT_0007*IT_0140;
    const ccomplex_t IT_0142 = N_W1*N_u4*e_em;
    ...
    const ccomplex_t IT_0152 = conj(N_W1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0158 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0159 = IT_0007*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0169 = cpow((-2)*s_13 + IT_0033 + IT_0168 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0170 = pow(m_W, -1);
    const ccomplex_t IT_0171 = m_c*e_em*mu_h*IT_0011*IT_0170;
    const ccomplex_t IT_0172 = (-0.5)*IT_0171;
    const ccomplex_t IT_0173 = cpow(IT_0006, -1);
    const ccomplex_t IT_0174 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0011*IT_0170*IT_0173;
    ...
    const ccomplex_t IT_0179 = IT_0038 + IT_0081 + IT_0124 + IT_0167 + IT_0178;
    ...
    const ccomplex_t IT_0191 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0011*IT_0170*IT_0173;
    const ccomplex_t IT_0192 = 0.5*IT_0191;
    const ccomplex_t IT_0193 = IT_0127*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*IT_0193;
    const ccomplex_t IT_0195 = m_N_1*IT_0146;
    const ccomplex_t IT_0196 = m_N_4*IT_0164;
    ...
    const ccomplex_t IT_0201 = IT_0035*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*IT_0201;
    const ccomplex_t IT_0203 = IT_0030*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0011*IT_0170*IT_0173;
    ...
    const ccomplex_t IT_0208 = m_N_1*IT_0055;
    const ccomplex_t IT_0209 = m_N_2*IT_0073;
    ...
    const ccomplex_t IT_0214 = IT_0084*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*IT_0214;
    const ccomplex_t IT_0216 = m_N_1*IT_0103;
    const ccomplex_t IT_0217 = m_N_3*IT_0121;
    ...
    const ccomplex_t IT_0224 = IT_0146*IT_0194;
    const ccomplex_t IT_0225 = cpow((-2)*s_12 + IT_0033 + -IT_0034 + -IT_0168 
      + -reg_prop, -1);
    const ccomplex_t IT_0226 = m_c*e_em*IT_0000*IT_0011*IT_0170*IT_0173;
    ...
    const ccomplex_t IT_0231 = IT_0103*IT_0215;
    const ccomplex_t IT_0232 = IT_0018*IT_0202;
    const ccomplex_t IT_0233 = IT_0055*IT_0207;
    const ccomplex_t IT_0234 = IT_0224 + -IT_0230 + IT_0231 + IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = m_c*s_14;
    const ccomplex_t IT_0236 = IT_0200*IT_0227;
    const ccomplex_t IT_0237 = IT_0225*IT_0236;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*IT_0237;
    const ccomplex_t IT_0239 = IT_0129*IT_0164;
    const ccomplex_t IT_0240 = IT_0028*IT_0037;
    const ccomplex_t IT_0241 = IT_0073*IT_0080;
    const ccomplex_t IT_0242 = IT_0086*IT_0121;
