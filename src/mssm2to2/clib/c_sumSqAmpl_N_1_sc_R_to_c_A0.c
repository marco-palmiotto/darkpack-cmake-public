...
ccomplex_return_t c_sumSqAmpl_N_1_sc_R_to_c_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
    ...
    const ccomplex_t IT_0098 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0099 = IT_0024*IT_0098;
    const ccomplex_t IT_0100 = N_B3*N_d1*e_em;
    ...
    const ccomplex_t IT_0106 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0107 = IT_0024*IT_0106;
    const ccomplex_t IT_0108 = N_B1*N_d3*e_em;
    ...
    const ccomplex_t IT_0118 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0119 = IT_0027*IT_0118;
    const ccomplex_t IT_0120 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0121 = IT_0030*IT_0120;
    const ccomplex_t IT_0122 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0123 = IT_0033*IT_0122;
    const ccomplex_t IT_0124 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0125 = IT_0024*IT_0124;
    const ccomplex_t IT_0126 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0127 = IT_0027*IT_0126;
    const ccomplex_t IT_0128 = conj(N_W3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0204 = m_N_1*IT_0066;
    const ccomplex_t IT_0205 = m_N_2*IT_0084;
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0212 = m_N_1*IT_0114;
    ...
    const ccomplex_t IT_0222 = m_c*m_N_1;
    ...
    const ccomplex_t IT_0248 = m_c*m_N_1*IT_0247;
