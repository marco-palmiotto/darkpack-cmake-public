...
ccomplex_return_t c_sumSqAmpl_N_1_sc_R_to_c_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
    ...
    const ccomplex_t IT_0039 = m_c*s_14*m_N_1;
    ...
    const ccomplex_t IT_0051 = m_c*m_N_1;
    ...
    const ccomplex_t IT_0056 = m_c*s_34*m_N_1;
