        ...
        )
{
    ...
    const ccomplex_t IT_0011 = N_B2*N_d1*e_em;
    ...
    const ccomplex_t IT_0017 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0020 = IT_0010*IT_0019;
    const ccomplex_t IT_0021 = N_W1*N_u2*e_em;
    ...
    const ccomplex_t IT_0039 = conj(N_B1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0043 = conj(N_B2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0048 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0054 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0009
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0004 + IT_0071 + -m_sc_L*
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*e_em*(1.5*IT_0004*IT_0013
      *IT_0015*IT_0063*IT_0065 + -m_W*IT_0014*IT_0075*(IT_0013*IT_0064 + 
      -IT_0009*IT_0076));
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0004 + IT_0071 + -m_sc_R*
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_c*e_em*IT_0013*IT_0015
      *IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0158 = conj(N_B1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_4*
    ...
    const ccomplex_t IT_0219 = IT_0062 + IT_0074 + IT_0084 + (-2)*IT_0091 +
    ...
    const ccomplex_t IT_0237 = IT_0078*IT_0221;
    const ccomplex_t IT_0238 = IT_0082*IT_0237;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*IT_0238;
    const ccomplex_t IT_0240 = m_N_1*IT_0037;
    const ccomplex_t IT_0241 = m_N_2*IT_0059;
    const ccomplex_t IT_0242 = IT_0240 + IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0015*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0248 = IT_0143*IT_0221;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0166*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0015*IT_0063*IT_0065;
    const ccomplex_t IT_0252 = 0.5*IT_0251;
    const ccomplex_t IT_0253 = IT_0094*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = m_N_1*IT_0117;
    const ccomplex_t IT_0256 = m_N_3*IT_0139;
    ...
    const ccomplex_t IT_0263 = m_N_1*IT_0193;
    ...
    const ccomplex_t IT_0271 = IT_0154*IT_0249;
    const ccomplex_t IT_0272 = IT_0037*IT_0246;
    const ccomplex_t IT_0273 = IT_0117*IT_0254;
    ...
    const ccomplex_t IT_0277 = IT_0096*IT_0139;
    const ccomplex_t IT_0278 = IT_0172*IT_0215;
    const ccomplex_t IT_0279 = IT_0145*IT_0164;
