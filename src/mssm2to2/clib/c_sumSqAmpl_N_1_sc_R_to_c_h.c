        ...
        )
{
    ...
    const ccomplex_t IT_0011 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0012 = IT_0010*IT_0011;
    const ccomplex_t IT_0013 = sin(alpha);
    const ccomplex_t IT_0014 = IT_0001*IT_0013;
    const ccomplex_t IT_0015 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0016 = IT_0014*IT_0015;
    const ccomplex_t IT_0017 = N_B1*N_u2*e_em;
    ...
    const ccomplex_t IT_0030 = N_W1*N_u2*e_em;
    ...
    const ccomplex_t IT_0043 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0044 = IT_0010*IT_0043;
    const ccomplex_t IT_0045 = conj(N_B2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0013
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0004*IT_0009
      *IT_0023*IT_0063*IT_0065 + m_W*IT_0022*IT_0075*(IT_0009*IT_0064 + IT_0013
      *IT_0076));
    ...
    const ccomplex_t IT_0162 = IT_0024*IT_0161;
    ...
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
    ...
    const ccomplex_t IT_0250 = IT_0143*IT_0223;
    ...
    const ccomplex_t IT_0255 = IT_0094*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = m_N_1*IT_0117;
    const ccomplex_t IT_0258 = m_N_3*IT_0139;
    ...
    const ccomplex_t IT_0273 = IT_0155*IT_0251;
    const ccomplex_t IT_0274 = IT_0037*IT_0248;
    const ccomplex_t IT_0275 = IT_0117*IT_0256;
    ...
    const ccomplex_t IT_0279 = IT_0096*IT_0139;
