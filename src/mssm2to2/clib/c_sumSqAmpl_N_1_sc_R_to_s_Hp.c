        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0005*IT_0007*IT_0008*IT_0010;
    const ccomplex_t IT_0012 = 0.5*IT_0011;
    const ccomplex_t IT_0013 = cpow(IT_0008, -1);
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *conj(V_u1)*e_em*IT_0005*IT_0010*IT_0013;
    ...
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0003 + IT_0029 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*mu_h*IT_0005*IT_0010;
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0003 + IT_0029 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0005*IT_0007*IT_0010*IT_0013;
    ...
    const ccomplex_t IT_0118 = IT_0030*IT_0101*IT_0117;
    ...
    const ccomplex_t IT_0136 = IT_0015*IT_0020;
    const ccomplex_t IT_0137 = IT_0004*IT_0135*IT_0136;
    const ccomplex_t IT_0138 = m_N_1*IT_0027;
    const ccomplex_t IT_0139 = -IT_0092 + -IT_0100 + -IT_0118 + -IT_0134 +
       IT_0137 + -IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0150 = IT_0004*IT_0135*IT_0149;
