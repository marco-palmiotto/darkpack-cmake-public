...
ccomplex_return_t c_sumSqAmpl_N_1_sc_R_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_s*m_N_1*IT_0000;
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
    ...
    const ccomplex_t IT_0078 = m_s*m_N_1;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0003 + IT_0047 + -m_ss_R*
    ...
    const ccomplex_t IT_0089 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = IT_0006*IT_0022;
    ...
    const ccomplex_t IT_0104 = IT_0067*IT_0087*IT_0103;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0106 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0107 = IT_0092*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0113 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0120 = IT_0048*IT_0105*IT_0119;
    const ccomplex_t IT_0121 = m_N_1*IT_0027;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
    ...
    const ccomplex_t IT_0133 = cpow((-2)*s_13 + IT_0003 + IT_0047 + -m_ss_L*
    ...
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0005*IT_0009*IT_0013;
    const ccomplex_t IT_0148 = (-0.5)*IT_0147;
    const ccomplex_t IT_0149 = IT_0123*IT_0148;
    const ccomplex_t IT_0150 = IT_0133*IT_0149;
