...
ccomplex_return_t c_sumSqAmpl_N_1_sc_R_to_s_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0045 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0046 = IT_0007*IT_0045;
    const ccomplex_t IT_0047 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0053 = IT_0002*IT_0044*IT_0052;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0007;
    ...
    const ccomplex_t IT_0144 = m_s*m_N_1;
    ...
    const ccomplex_t IT_0155 = IT_0134*IT_0150;
    const ccomplex_t IT_0156 = 6*IT_0033*(conj(IT_0066)*IT_0071 + -conj
      ...
      *IT_0135 + IT_0143*IT_0152 + IT_0153 + IT_0154 + IT_0155) + 6*IT_0066*
      (conj(IT_0033)*IT_0071 + -conj(IT_0088)*IT_0101 + 0.166666666666667
      *IT_0143*IT_0152 + 0.166666666666667*IT_0153 + 0.166666666666667*IT_0154 +
