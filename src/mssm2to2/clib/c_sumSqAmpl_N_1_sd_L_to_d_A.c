...
ccomplex_return_t c_sumSqAmpl_N_1_sd_L_to_d_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
    ...
    const ccomplex_t IT_0046 = m_d*s_14*m_N_1;
    ...
    const ccomplex_t IT_0058 = m_d*m_N_1;
    ...
    const ccomplex_t IT_0063 = m_d*s_34*m_N_1;
