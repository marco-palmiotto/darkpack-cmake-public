...
ccomplex_return_t c_sumSqAmpl_N_1_sd_L_to_d_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
    ...
    const ccomplex_t IT_0045 = m_d*s_14*m_N_1;
    ...
    const ccomplex_t IT_0057 = m_d*m_N_1;
    ...
    const ccomplex_t IT_0062 = m_d*s_34*m_N_1;
