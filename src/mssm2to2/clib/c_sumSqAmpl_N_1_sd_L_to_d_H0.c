        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0012*IT_0031*IT_0033;
    const ccomplex_t IT_0035 = (-0.5)*IT_0034;
    const ccomplex_t IT_0036 = pow(m_d, 2);
    const ccomplex_t IT_0037 = pow(m_sd_L, 2);
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0012*IT_0031*IT_0033;
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0036 + IT_0037 + -m_N_4*
    ...
    const ccomplex_t IT_0069 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0070 = IT_0004*IT_0069;
    const ccomplex_t IT_0071 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0072 = IT_0016*IT_0071;
    const ccomplex_t IT_0073 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0074 = IT_0004*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0076 = IT_0016*IT_0075;
    const ccomplex_t IT_0077 = IT_0070 + IT_0072 + IT_0074 + IT_0076;
    const ccomplex_t IT_0078 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0079 = IT_0008*IT_0078;
    const ccomplex_t IT_0080 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0081 = IT_0013*IT_0080;
    const ccomplex_t IT_0082 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0083 = IT_0008*IT_0082;
    const ccomplex_t IT_0084 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0093 = pow(m_N_1, 2);
    const ccomplex_t IT_0094 = cpow((-2)*s_13 + IT_0036 + IT_0093 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0001 + -m_d*e_em*mu_h*IT_0007*IT_0012*IT_0031*IT_0033);
    ...
    const ccomplex_t IT_0103 = cpow(IT_0002, -2);
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0012
      *IT_0031*IT_0033*IT_0036 + (-0.5)*m_W*(IT_0001*IT_0032 + -IT_0007*IT_0102)
      *(IT_0012 + 1./3*IT_0011*IT_0103));
    const ccomplex_t IT_0105 = -IT_0104;
    const ccomplex_t IT_0106 = IT_0035*IT_0105;
    const ccomplex_t IT_0107 = cpow((-2)*s_13 + IT_0036 + IT_0093 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0108 = IT_0106*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*m_d*e_em*IT_0001*IT_0012
      *IT_0031*IT_0033;
    const ccomplex_t IT_0111 = (-0.5)*IT_0110;
    const ccomplex_t IT_0112 = IT_0035*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_12 + IT_0036 + -IT_0037 + -IT_0093 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0139 = conj(N_B1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0150 = conj(N_W1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0012*IT_0031*IT_0033;
    const ccomplex_t IT_0163 = (-0.5)*IT_0162;
    const ccomplex_t IT_0164 = cpow((-2)*s_23 + IT_0036 + IT_0037 + -m_N_2*
    ...
    const ccomplex_t IT_0184 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0185 = IT_0013*IT_0184;
    const ccomplex_t IT_0186 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0187 = IT_0008*IT_0186;
    const ccomplex_t IT_0188 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0204 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0205 = IT_0008*IT_0204;
    const ccomplex_t IT_0206 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0207 = IT_0013*IT_0206;
    const ccomplex_t IT_0208 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0209 = IT_0008*IT_0208;
    const ccomplex_t IT_0210 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0219 = IT_0041 + IT_0092 + IT_0101 + IT_0109 + (-2)
    ...
    const ccomplex_t IT_0228 = IT_0105*IT_0227;
    const ccomplex_t IT_0229 = IT_0107*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = IT_0111*IT_0227;
    const ccomplex_t IT_0232 = IT_0113*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = m_d*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0012*IT_0031*IT_0033;
    const ccomplex_t IT_0236 = 0.5*IT_0235;
    const ccomplex_t IT_0237 = IT_0096*IT_0236;
    const ccomplex_t IT_0238 = IT_0094*IT_0237;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*IT_0238;
    const ccomplex_t IT_0240 = IT_0038*IT_0227;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*IT_0240;
    const ccomplex_t IT_0242 = IT_0030*IT_0241;
    const ccomplex_t IT_0243 = m_N_1*IT_0137;
    const ccomplex_t IT_0244 = m_N_2*IT_0159;
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = conj(N_B2)*e_em;
    const ccomplex_t IT_0247 = IT_0003*IT_0246;
    const ccomplex_t IT_0248 = 1.4142135623731*IT_0247;
    const ccomplex_t IT_0249 = conj(N_W2)*e_em;
    const ccomplex_t IT_0250 = IT_0012*IT_0249;
    const ccomplex_t IT_0251 = 1.4142135623731*IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*(IT_0248 + (-3)*IT_0251);
    const ccomplex_t IT_0253 = 0.166666666666667*IT_0252;
    const ccomplex_t IT_0254 = IT_0164*IT_0253;
    ...
    const ccomplex_t IT_0265 = IT_0170*IT_0264;
    const ccomplex_t IT_0266 = (0 + _Complex_I*1)*IT_0265;
    const ccomplex_t IT_0267 = m_N_1*IT_0193;
    const ccomplex_t IT_0268 = m_N_3*IT_0215;
    const ccomplex_t IT_0269 = IT_0267 + IT_0268;
    const ccomplex_t IT_0270 = IT_0266*IT_0269;
    const ccomplex_t IT_0271 = m_N_1*IT_0067;
    const ccomplex_t IT_0272 = m_N_4*IT_0089;
    const ccomplex_t IT_0273 = IT_0271 + IT_0272;
    const ccomplex_t IT_0274 = conj(N_B4)*e_em;
    const ccomplex_t IT_0275 = IT_0003*IT_0274;
    ...
    const ccomplex_t IT_0285 = -IT_0230 + 2*IT_0234 + -IT_0239 + -IT_0242 + 
    ...
    const ccomplex_t IT_0289 = IT_0193*IT_0266;
    const ccomplex_t IT_0290 = IT_0018*IT_0241;
    const ccomplex_t IT_0291 = IT_0137*IT_0255;
    const ccomplex_t IT_0292 = IT_0067*IT_0283;
    const ccomplex_t IT_0293 = -IT_0115 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_d*s_14;
    const ccomplex_t IT_0295 = IT_0028*IT_0040;
    const ccomplex_t IT_0296 = IT_0159*IT_0166;
    const ccomplex_t IT_0297 = IT_0172*IT_0215;
    const ccomplex_t IT_0298 = IT_0046*IT_0089;
    const ccomplex_t IT_0299 = IT_0233 + -IT_0295 + -IT_0296 + -IT_0297 + 
      -IT_0298;
