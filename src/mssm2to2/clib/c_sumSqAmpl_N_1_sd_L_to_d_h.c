...
ccomplex_return_t c_sumSqAmpl_N_1_sd_L_to_d_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0003 + m_d*e_em*mu_h*IT_0004*IT_0006*IT_0007*IT_0009);
    ...
    const ccomplex_t IT_0020 = cpow(IT_0012, -2);
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0003
      *IT_0004*IT_0006*IT_0009 + (-0.5)*m_W*(IT_0003*IT_0005 + IT_0007*IT_0019)*
      (IT_0009 + 1./3*IT_0008*IT_0020));
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0004*IT_0006*IT_0009;
    const ccomplex_t IT_0023 = (-0.5)*IT_0022;
    const ccomplex_t IT_0024 = IT_0021*IT_0023;
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*IT_0026;
    const ccomplex_t IT_0028 = pow(m_sd_L, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0028 
      + -reg_prop, -1);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_d*e_em*IT_0003*IT_0004
      *IT_0006*IT_0009;
    ...
    const ccomplex_t IT_0036 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0037 = IT_0007*IT_0013;
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0040 = IT_0003*IT_0013;
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0043 = IT_0007*IT_0009;
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = N_W1*N_d1*e_em;
    const ccomplex_t IT_0046 = IT_0003*IT_0009;
    ...
    const ccomplex_t IT_0051 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0052 = IT_0037*IT_0051;
    const ccomplex_t IT_0053 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0057 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0000 + IT_0028 + -m_N_1*
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0000 + IT_0028 + -m_N_2*
    ...
    const ccomplex_t IT_0074 = conj(N_B1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0103 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0104 = IT_0043*IT_0103;
    const ccomplex_t IT_0105 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0106 = IT_0046*IT_0105;
    const ccomplex_t IT_0107 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0108 = IT_0043*IT_0107;
    const ccomplex_t IT_0109 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0004*IT_0006*IT_0009;
    const ccomplex_t IT_0119 = (-0.5)*IT_0118;
    const ccomplex_t IT_0120 = cpow((-2)*s_23 + IT_0000 + IT_0028 + -m_N_3*
    ...
    const ccomplex_t IT_0135 = IT_0046*IT_0134;
    ...
    const ccomplex_t IT_0148 = IT_0040*IT_0147;
    ...
    const ccomplex_t IT_0152 = IT_0040*IT_0151;
    ...
    const ccomplex_t IT_0171 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0178 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0179 = IT_0043*IT_0178;
    const ccomplex_t IT_0180 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0181 = IT_0046*IT_0180;
    const ccomplex_t IT_0182 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0183 = IT_0043*IT_0182;
    const ccomplex_t IT_0184 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0191 = N_B4*N_u1*e_em;
    ...
    const ccomplex_t IT_0200 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0201 = IT_0043*IT_0200;
    const ccomplex_t IT_0202 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0203 = IT_0046*IT_0202;
    const ccomplex_t IT_0204 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0205 = IT_0043*IT_0204;
    const ccomplex_t IT_0206 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0212 = m_N_4*IT_0211;
    const ccomplex_t IT_0213 = IT_0190 + IT_0212;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0004*IT_0006*IT_0009;
    const ccomplex_t IT_0215 = (-0.5)*IT_0214;
    const ccomplex_t IT_0216 = cpow((-2)*s_23 + IT_0000 + IT_0028 + -m_N_4*
    ...
    const ccomplex_t IT_0220 = IT_0018 + IT_0027 + (-2)*IT_0035 + IT_0066 +
    ...
    const ccomplex_t IT_0232 = IT_0031*IT_0228;
    ...
    const ccomplex_t IT_0236 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0004*IT_0006*IT_0009;
    ...
    const ccomplex_t IT_0241 = IT_0063*IT_0228;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = IT_0062*IT_0242;
    const ccomplex_t IT_0244 = m_N_1*IT_0114;
    const ccomplex_t IT_0245 = m_N_2*IT_0092;
    ...
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*(IT_0249 + (-3)*IT_0252);
    const ccomplex_t IT_0254 = 0.166666666666667*IT_0253;
    const ccomplex_t IT_0255 = IT_0069*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0246*IT_0256;
    const ccomplex_t IT_0258 = m_N_3*IT_0165;
    const ccomplex_t IT_0259 = m_N_1*IT_0143;
    ...
    const ccomplex_t IT_0269 = IT_0120*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*IT_0269;
    const ccomplex_t IT_0271 = IT_0260*IT_0270;
    const ccomplex_t IT_0272 = m_N_4*IT_0189;
    const ccomplex_t IT_0273 = m_N_1*IT_0211;
    ...
    const ccomplex_t IT_0286 = -IT_0231 + 2*IT_0235 + -IT_0240 + -IT_0243 + 
      -IT_0257 + -IT_0271 + -IT_0285;
    const ccomplex_t IT_0287 = 6*s_13;
    const ccomplex_t IT_0288 = m_d*m_N_1;
    const ccomplex_t IT_0289 = 6*IT_0220;
    const ccomplex_t IT_0290 = IT_0049*IT_0242;
    const ccomplex_t IT_0291 = IT_0114*IT_0256;
    const ccomplex_t IT_0292 = IT_0143*IT_0270;
    const ccomplex_t IT_0293 = IT_0211*IT_0284;
    const ccomplex_t IT_0294 = -IT_0034 + IT_0290 + IT_0291 + IT_0292 + IT_0293;
    const ccomplex_t IT_0295 = m_d*s_14;
    const ccomplex_t IT_0296 = IT_0060*IT_0065;
    const ccomplex_t IT_0297 = IT_0071*IT_0092;
    const ccomplex_t IT_0298 = IT_0122*IT_0165;
    const ccomplex_t IT_0299 = IT_0189*IT_0218;
    ...
    const ccomplex_t IT_0305 = m_d*m_N_1*IT_0304;
