...
ccomplex_return_t c_sumSqAmpl_N_1_sd_L_to_u_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0004;
    const ccomplex_t IT_0006 = sin(beta);
    const ccomplex_t IT_0007 = IT_0004*IT_0006;
    const ccomplex_t IT_0008 = N_d1*e_em*U_Wm1;
    ...
    const ccomplex_t IT_0027 = m_u*IT_0026;
    const ccomplex_t IT_0028 = pow(m_N_1, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_13 + IT_0000 + IT_0028 + -m_su_L*
    ...
    const ccomplex_t IT_0034 = cpow(IT_0006, -1);
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0004*(IT_0006*IT_0030*IT_0031*IT_0033 + (-2)*IT_0032*(m_W*IT_0006 + (
      -0.5)*IT_0000*IT_0030*IT_0034));
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0004*IT_0030*IT_0034;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = IT_0036*IT_0038;
    const ccomplex_t IT_0040 = IT_0029*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0000 + IT_0028 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0004*IT_0030;
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + -IT_0001 + -IT_0028 + IT_0031 
      + -reg_prop, -1);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0004*IT_0030*IT_0032*IT_0034;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0004*IT_0030*IT_0033;
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = IT_0053*IT_0055;
    const ccomplex_t IT_0057 = IT_0050*IT_0051*IT_0056;
    const ccomplex_t IT_0058 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0004;
    const ccomplex_t IT_0060 = N_d1*e_em*U_Wm2;
    const ccomplex_t IT_0061 = IT_0007*IT_0060;
    const ccomplex_t IT_0062 = (-2)*IT_0061;
    const ccomplex_t IT_0063 = N_B1*U_d2*e_em;
    const ccomplex_t IT_0064 = IT_0013*IT_0063;
    const ccomplex_t IT_0065 = 1.4142135623731*IT_0064;
    const ccomplex_t IT_0066 = N_W1*U_d2*e_em;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0004*IT_0030*IT_0034;
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0004*IT_0030*IT_0034;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = IT_0072*IT_0084;
    const ccomplex_t IT_0086 = IT_0058*IT_0082*IT_0085;
    const ccomplex_t IT_0087 = conj(N_B1)*e_em;
    const ccomplex_t IT_0088 = IT_0012*IT_0087;
    const ccomplex_t IT_0089 = 1.4142135623731*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0099 = -IT_0027 + IT_0041 + IT_0049 + -IT_0057 + 
      -IT_0076 + IT_0081 + IT_0086 + IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0004*IT_0006*IT_0030*IT_0033;
    const ccomplex_t IT_0101 = 0.5*IT_0100;
    const ccomplex_t IT_0102 = IT_0094*IT_0101;
    const ccomplex_t IT_0103 = IT_0050*IT_0051*IT_0102;
    const ccomplex_t IT_0104 = IT_0055*IT_0101;
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*(IT_0089 + 3*IT_0092);
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0004*IT_0030*IT_0034;
    ...
    const ccomplex_t IT_0118 = IT_0004*IT_0032;
    const ccomplex_t IT_0119 = conj(N_u1)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0120 = IT_0118*IT_0119;
    const ccomplex_t IT_0121 = 2*IT_0120;
    const ccomplex_t IT_0122 = IT_0012*IT_0032;
    const ccomplex_t IT_0123 = conj(N_B1)*conj(V_u1)*e_em;
    const ccomplex_t IT_0124 = IT_0122*IT_0123;
    const ccomplex_t IT_0125 = 1.4142135623731*IT_0124;
    const ccomplex_t IT_0126 = conj(N_W1)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0134 = IT_0002*IT_0077*IT_0133;
    const ccomplex_t IT_0135 = conj(N_u1)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0136 = IT_0118*IT_0135;
    const ccomplex_t IT_0137 = 2*IT_0136;
    const ccomplex_t IT_0138 = conj(N_B1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0139 = IT_0122*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W1)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0149 = IT_0058*IT_0082*IT_0148;
    const ccomplex_t IT_0150 = IT_0079*IT_0132;
    ...
    const ccomplex_t IT_0154 = IT_0084*IT_0147;
    ...
    const ccomplex_t IT_0158 = IT_0103 + -IT_0107 + -IT_0112 + -IT_0117 +
       IT_0134 + IT_0149 + -IT_0153 + -IT_0157;
    const ccomplex_t IT_0159 = 6*s_13;
    const ccomplex_t IT_0160 = m_u*m_N_1;
    const ccomplex_t IT_0161 = 6*IT_0099;
    const ccomplex_t IT_0162 = IT_0026 + IT_0075 + -IT_0106;
    const ccomplex_t IT_0163 = m_u*s_12;
    const ccomplex_t IT_0164 = IT_0097 + IT_0152 + IT_0156;
    const ccomplex_t IT_0165 = s_23*m_N_1;
    const ccomplex_t IT_0166 = 6*conj(IT_0099);
    const ccomplex_t IT_0167 = 6*conj(IT_0158);
    const ccomplex_t IT_0168 = m_u*m_N_1*IT_0001;
    const ccomplex_t IT_0169 = s_13*IT_0001;
