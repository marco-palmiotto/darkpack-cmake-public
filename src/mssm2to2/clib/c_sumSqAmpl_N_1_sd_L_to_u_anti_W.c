        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0023 = (-0.5)*IT_0022;
    const ccomplex_t IT_0024 = pow(m_N_1, 2);
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0015 + IT_0024 + -m_su_L*
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0004;
    ...
    const ccomplex_t IT_0131 = m_u*IT_0077;
    ...
    const ccomplex_t IT_0162 = m_u*IT_0161;
    ...
    const ccomplex_t IT_0202 = m_u*IT_0047;
