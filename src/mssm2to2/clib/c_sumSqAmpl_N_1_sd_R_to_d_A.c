...
ccomplex_return_t c_sumSqAmpl_N_1_sd_R_to_d_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = m_d*s_14*m_N_1;
    ...
    const ccomplex_t IT_0052 = m_d*m_N_1;
    ...
    const ccomplex_t IT_0057 = m_d*s_34*m_N_1;
