        ...
        )
{
    ...
    const ccomplex_t IT_0002 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0021;
    const ccomplex_t IT_0023 = (-0.333333333333333)*IT_0022;
    const ccomplex_t IT_0024 = pow(m_sd_R, 2);
    const ccomplex_t IT_0025 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0023*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*IT_0026;
    const ccomplex_t IT_0028 = IT_0013*IT_0021;
    const ccomplex_t IT_0029 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = IT_0008*IT_0021;
    const ccomplex_t IT_0032 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0033 = IT_0031*IT_0032;
    const ccomplex_t IT_0034 = IT_0004*IT_0013;
    const ccomplex_t IT_0035 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = IT_0004*IT_0008;
    const ccomplex_t IT_0038 = N_W4*N_d1*e_em;
    ...
    const ccomplex_t IT_0044 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0045 = IT_0034*IT_0044;
    const ccomplex_t IT_0046 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0050 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0051 = IT_0028*IT_0050;
    const ccomplex_t IT_0052 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0053 = IT_0031*IT_0052;
    const ccomplex_t IT_0054 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0055 = IT_0034*IT_0054;
    const ccomplex_t IT_0056 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0057 = IT_0037*IT_0056;
    const ccomplex_t IT_0058 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0059 = IT_0028*IT_0058;
    const ccomplex_t IT_0060 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0061 = IT_0031*IT_0060;
    const ccomplex_t IT_0062 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0063 = IT_0034*IT_0062;
    const ccomplex_t IT_0064 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0082 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0086 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_N_1*
    ...
    const ccomplex_t IT_0099 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_N_2*
    ...
    const ccomplex_t IT_0124 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0125 = IT_0034*IT_0124;
    const ccomplex_t IT_0126 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0127 = IT_0037*IT_0126;
    const ccomplex_t IT_0128 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0129 = IT_0028*IT_0128;
    const ccomplex_t IT_0130 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0131 = IT_0031*IT_0130;
    const ccomplex_t IT_0132 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0133 = IT_0034*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0140 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0021;
    const ccomplex_t IT_0141 = (-0.333333333333333)*IT_0140;
    const ccomplex_t IT_0142 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_N_3*
    ...
    const ccomplex_t IT_0149 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0150 = IT_0034*IT_0149;
    const ccomplex_t IT_0151 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0152 = IT_0037*IT_0151;
    const ccomplex_t IT_0153 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0154 = IT_0028*IT_0153;
    const ccomplex_t IT_0155 = N_B1*N_d3*e_em;
    ...
    const ccomplex_t IT_0163 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0169 = conj(N_W1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0177 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0195 = m_N_1*IT_0161;
    const ccomplex_t IT_0196 = m_N_3*IT_0179;
    const ccomplex_t IT_0197 = IT_0195 + IT_0196;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0004*IT_0005*IT_0014;
    const ccomplex_t IT_0199 = 0.5*IT_0198;
    const ccomplex_t IT_0200 = IT_0142*IT_0199;
    ...
    const ccomplex_t IT_0207 = IT_0090*IT_0206;
    const ccomplex_t IT_0208 = m_N_1*IT_0118;
    const ccomplex_t IT_0209 = m_N_2*IT_0136;
    const ccomplex_t IT_0210 = IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0004*IT_0005*IT_0014;
    ...
    const ccomplex_t IT_0216 = m_N_1*IT_0048;
    const ccomplex_t IT_0217 = m_N_4*IT_0066;
    ...
    const ccomplex_t IT_0224 = -IT_0194 + -IT_0202 + -IT_0207 + -IT_0215 + 
      -IT_0223;
    const ccomplex_t IT_0225 = 6*s_13;
    const ccomplex_t IT_0226 = m_d*m_N_1;
    const ccomplex_t IT_0227 = 6*IT_0183;
    const ccomplex_t IT_0228 = m_d*e_em*IT_0004*IT_0005*IT_0008*IT_0014;
    const ccomplex_t IT_0229 = (-0.5)*IT_0228;
    const ccomplex_t IT_0230 = IT_0092*IT_0229;
    const ccomplex_t IT_0231 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0024 
      + -reg_prop, -1);
    const ccomplex_t IT_0232 = IT_0230*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = IT_0048*IT_0222;
    const ccomplex_t IT_0235 = IT_0078*IT_0206;
    const ccomplex_t IT_0236 = IT_0118*IT_0214;
    const ccomplex_t IT_0237 = IT_0161*IT_0201;
    const ccomplex_t IT_0238 = -IT_0233 + IT_0234 + IT_0235 + IT_0236 + IT_0237;
    const ccomplex_t IT_0239 = m_d*s_14;
    const ccomplex_t IT_0240 = IT_0144*IT_0179;
    const ccomplex_t IT_0241 = IT_0027*IT_0066;
    const ccomplex_t IT_0242 = IT_0204*IT_0229;
    ...
    const ccomplex_t IT_0246 = IT_0101*IT_0136;
    const ccomplex_t IT_0247 = -IT_0240 + -IT_0241 + -IT_0244 + -IT_0245 + 
      -IT_0246;
    const ccomplex_t IT_0248 = s_34*m_N_1;
