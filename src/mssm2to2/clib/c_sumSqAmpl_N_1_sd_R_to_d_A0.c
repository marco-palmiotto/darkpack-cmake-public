...
ccomplex_return_t c_sumSqAmpl_N_1_sd_R_to_d_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0021;
    ...
    const ccomplex_t IT_0186 = cpow((-2)*s_12 + IT_0015 + -IT_0016 + -IT_0024 
      + -reg_prop, -1);
    const ccomplex_t IT_0187 = m_d*e_em*IT_0001*IT_0002*IT_0005*IT_0011;
    const ccomplex_t IT_0188 = (-0.5)*IT_0187;
    const ccomplex_t IT_0189 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0194 = IT_0088*IT_0095;
    const ccomplex_t IT_0195 = IT_0131*IT_0138;
    const ccomplex_t IT_0196 = IT_0027*IT_0050;
    const ccomplex_t IT_0197 = -IT_0185 + -IT_0193 + -IT_0194 + -IT_0195 + 
      -IT_0196;
    const ccomplex_t IT_0198 = m_d*s_14;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0200 = 0.5*IT_0199;
    const ccomplex_t IT_0201 = IT_0136*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*IT_0201;
    const ccomplex_t IT_0203 = IT_0113*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0205 = 0.5*IT_0204;
    const ccomplex_t IT_0206 = IT_0142*IT_0205;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*IT_0206;
    const ccomplex_t IT_0208 = IT_0161*IT_0207;
    const ccomplex_t IT_0209 = IT_0023*IT_0188;
    const ccomplex_t IT_0210 = IT_0186*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1)*IT_0210;
    const ccomplex_t IT_0212 = IT_0025*IT_0190;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*IT_0212;
    const ccomplex_t IT_0214 = IT_0040*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0216 = 0.5*IT_0215;
    const ccomplex_t IT_0217 = IT_0093*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*IT_0217;
    const ccomplex_t IT_0219 = IT_0070*IT_0218;
    const ccomplex_t IT_0220 = IT_0203 + IT_0208 + -IT_0211 + IT_0214 + IT_0219;
    const ccomplex_t IT_0221 = s_34*m_N_1;
    ...
    const ccomplex_t IT_0233 = m_N_1*IT_0070;
    const ccomplex_t IT_0234 = m_N_2*IT_0088;
    const ccomplex_t IT_0235 = IT_0233 + IT_0234;
    const ccomplex_t IT_0236 = IT_0218*IT_0235;
    const ccomplex_t IT_0237 = m_N_1*IT_0113;
    const ccomplex_t IT_0238 = m_N_3*IT_0131;
    const ccomplex_t IT_0239 = IT_0237 + IT_0238;
    const ccomplex_t IT_0240 = IT_0202*IT_0239;
    const ccomplex_t IT_0241 = m_N_1*IT_0161;
    const ccomplex_t IT_0242 = m_N_4*IT_0179;
    const ccomplex_t IT_0243 = IT_0241 + IT_0242;
    const ccomplex_t IT_0244 = IT_0207*IT_0243;
    const ccomplex_t IT_0245 = IT_0052*IT_0213;
    const ccomplex_t IT_0246 = -IT_0232 + -IT_0236 + -IT_0240 + -IT_0244 + 
      -IT_0245;
    const ccomplex_t IT_0247 = 6*conj(IT_0246);
    const ccomplex_t IT_0248 = m_d*m_N_1;
    const ccomplex_t IT_0249 = 6*IT_0183;
    const ccomplex_t IT_0250 = 6*conj(IT_0183);
    const ccomplex_t IT_0251 = pow(m_A0, 2);
    const ccomplex_t IT_0252 = m_d*m_N_1*IT_0251;
    ...
    const ccomplex_t IT_0257 = 6*IT_0246;
    const ccomplex_t IT_0258 = 0.166666666666667*IT_0221;
    const ccomplex_t IT_0259 = IT_0183*conj(IT_0183)*IT_0184 + (IT_0197
      *IT_0198 + IT_0220*IT_0221)*IT_0247 + conj(IT_0246)*(IT_0184*IT_0246 +
       IT_0248*IT_0249) + (IT_0198*IT_0220 + IT_0197*IT_0221 + IT_0246*IT_0248)
      *IT_0250 + 6*conj(IT_0197)*(IT_0220*IT_0252 + -IT_0197*IT_0256 +
       0.166666666666667*IT_0198*IT_0257 + IT_0249*IT_0258) + 6*conj(IT_0220)*
      (0.166666666666667*IT_0198*IT_0249 + IT_0197*IT_0252 + -IT_0220*IT_0256 +
       IT_0257*IT_0258);
