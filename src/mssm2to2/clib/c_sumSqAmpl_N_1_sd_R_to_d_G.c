...
ccomplex_return_t c_sumSqAmpl_N_1_sd_R_to_d_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_R*
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
    ...
    const ccomplex_t IT_0039 = m_d*s_14*m_N_1;
    ...
    const ccomplex_t IT_0051 = m_d*m_N_1;
    ...
    const ccomplex_t IT_0056 = m_d*s_34*m_N_1;
