...
ccomplex_return_t c_sumSqAmpl_N_1_sd_R_to_d_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B1*N_u3*e_em;
    ...
    const ccomplex_t IT_0030 = N_W1*N_u3*e_em;
    ...
    const ccomplex_t IT_0039 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0040 = IT_0010*IT_0039;
    const ccomplex_t IT_0041 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0068 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0069 = IT_0010*IT_0068;
    const ccomplex_t IT_0070 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0071 = IT_0014*IT_0070;
    const ccomplex_t IT_0072 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0073 = IT_0010*IT_0072;
    const ccomplex_t IT_0074 = N_B1*N_d4*e_em;
    ...
    const ccomplex_t IT_0081 = N_W1*N_u4*e_em;
    ...
    const ccomplex_t IT_0090 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0091 = IT_0010*IT_0090;
    const ccomplex_t IT_0092 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0093 = IT_0014*IT_0092;
    const ccomplex_t IT_0094 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0095 = IT_0010*IT_0094;
    const ccomplex_t IT_0096 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0156 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0160 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_2*
    ...
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
    ...
    const ccomplex_t IT_0253 = m_N_1*IT_0195;
    const ccomplex_t IT_0254 = m_N_2*IT_0217;
    const ccomplex_t IT_0255 = IT_0253 + IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0023*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0265 = m_N_1*IT_0088;
    ...
    const ccomplex_t IT_0271 = m_d*m_N_1;
    ...
    const ccomplex_t IT_0288 = m_d*m_N_1*IT_0287;
