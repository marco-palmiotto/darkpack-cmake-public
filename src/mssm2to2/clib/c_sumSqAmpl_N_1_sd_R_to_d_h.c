        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*(IT_0005
      *IT_0006 + IT_0007*IT_0008)*IT_0009 + (-3)*IT_0000*IT_0008*IT_0010*IT_0011
      *IT_0012);
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0021 
      + -reg_prop, -1);
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_d*e_em*IT_0008*IT_0010
      *IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0008 + m_d*e_em*mu_h*IT_0005*IT_0010*IT_0011*IT_0012);
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
    ...
    const ccomplex_t IT_0222 = 6*s_13;
    ...
    const ccomplex_t IT_0237 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0010*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0010*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0268 = m_d*IT_0227;
    ...
    const ccomplex_t IT_0283 = 6*conj(IT_0282);
    const ccomplex_t IT_0284 = m_d*m_N_1;
    const ccomplex_t IT_0285 = 6*IT_0221;
    const ccomplex_t IT_0286 = 6*conj(IT_0221);
    ...
    const ccomplex_t IT_0293 = 6*IT_0282;
    const ccomplex_t IT_0294 = 0.166666666666667*IT_0253;
    const ccomplex_t IT_0295 = IT_0221*conj(IT_0221)*IT_0222 + (IT_0232
      ...
      *IT_0286 + 6*conj(IT_0232)*(IT_0252*IT_0288 + -IT_0232*IT_0292 +
       0.166666666666667*IT_0233*IT_0293 + IT_0285*IT_0294) + 6*conj(IT_0252)*
      (0.166666666666667*IT_0233*IT_0285 + IT_0232*IT_0288 + -IT_0252*IT_0292 +
       IT_0293*IT_0294);
