...
ccomplex_return_t c_sumSqAmpl_N_1_sd_R_to_u_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
    ...
    const ccomplex_t IT_0144 = m_u*m_N_1;
