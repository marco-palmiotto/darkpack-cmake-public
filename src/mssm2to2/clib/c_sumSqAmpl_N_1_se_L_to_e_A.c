...
ccomplex_return_t c_sumSqAmpl_N_1_se_L_to_e_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = 2*IT_0004;
    ...
    const ccomplex_t IT_0040 = IT_0004*IT_0019;
    const ccomplex_t IT_0041 = -IT_0040;
    const ccomplex_t IT_0042 = IT_0004*IT_0036;
    const ccomplex_t IT_0043 = (-2)*s_13;
    const ccomplex_t IT_0044 = s_34*IT_0043;
    const ccomplex_t IT_0045 = m_e*s_14*m_N_1;
    ...
    const ccomplex_t IT_0056 = m_e*m_N_1;
    ...
    const ccomplex_t IT_0061 = m_e*s_34*m_N_1;
