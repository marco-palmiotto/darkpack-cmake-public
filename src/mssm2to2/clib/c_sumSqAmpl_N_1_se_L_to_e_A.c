        ...
        )
{
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_se_L*
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0047 = m_e*s_14*m_N_1;
