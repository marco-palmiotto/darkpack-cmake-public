...
ccomplex_return_t c_sumSqAmpl_N_1_se_L_to_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = pow(m_N_1, 2);
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0000*IT_0002*IT_0016;
    const ccomplex_t IT_0018 = (-0.5)*IT_0017;
    const ccomplex_t IT_0019 = pow(m_se_L, 2);
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0010 + IT_0019 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0018*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*IT_0021;
    const ccomplex_t IT_0023 = IT_0006*IT_0015;
    const ccomplex_t IT_0024 = N_B1*N_u1*e_em;
    ...
    const ccomplex_t IT_0038 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0039 = IT_0023*IT_0038;
    const ccomplex_t IT_0040 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0041 = IT_0027*IT_0040;
    const ccomplex_t IT_0042 = conj(N_W1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0000*IT_0002*IT_0016;
    ...
    const ccomplex_t IT_0111 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0112 = IT_0023*IT_0111;
    const ccomplex_t IT_0113 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0114 = IT_0027*IT_0113;
    const ccomplex_t IT_0115 = conj(N_W1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0121 = conj(N_B3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0147 = N_W4*N_d1*e_em;
    ...
    const ccomplex_t IT_0159 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0160 = IT_0023*IT_0159;
    const ccomplex_t IT_0161 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0162 = IT_0027*IT_0161;
    const ccomplex_t IT_0163 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0164 = IT_0030*IT_0163;
    const ccomplex_t IT_0165 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0166 = IT_0033*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0168 = IT_0023*IT_0167;
    const ccomplex_t IT_0169 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0170 = IT_0027*IT_0169;
    const ccomplex_t IT_0171 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0172 = IT_0030*IT_0171;
    const ccomplex_t IT_0173 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0241 = s_34*m_N_1;
