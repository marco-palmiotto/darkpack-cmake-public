        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = sin(beta);
    const ccomplex_t IT_0020 = IT_0009*IT_0019;
    const ccomplex_t IT_0021 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0022 = IT_0020*IT_0021;
    const ccomplex_t IT_0023 = IT_0005*IT_0015;
    const ccomplex_t IT_0024 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = IT_0005*IT_0019;
    const ccomplex_t IT_0027 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0030 = IT_0016*IT_0029;
    const ccomplex_t IT_0031 = N_B1*N_d2*e_em;
    ...
    const ccomplex_t IT_0037 = (-0.5)*IT_0018 + 0.5*IT_0022 + 0.5*IT_0025 + (
      -0.5)*IT_0028 + (-0.5)*IT_0030 + 0.5*IT_0032 + 0.5*IT_0034 + (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = m_N_2*IT_0037;
    const ccomplex_t IT_0039 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0043 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0044 = IT_0023*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0046 = IT_0026*IT_0045;
    const ccomplex_t IT_0047 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0048 = IT_0016*IT_0047;
    const ccomplex_t IT_0049 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0050 = IT_0020*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0052 = IT_0023*IT_0051;
    const ccomplex_t IT_0053 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0058 = cpow(IT_0015, -1);
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0003*IT_0005*IT_0058;
    const ccomplex_t IT_0060 = (-0.5)*IT_0059;
    const ccomplex_t IT_0061 = pow(m_se_L, 2);
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0000 + IT_0061 + -m_N_2*
    ...
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0000 + IT_0061 + -m_N_4*
    ...
    const ccomplex_t IT_0075 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0076 = IT_0023*IT_0075;
    const ccomplex_t IT_0077 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0078 = IT_0026*IT_0077;
    const ccomplex_t IT_0079 = N_B1*N_u4*e_em;
    ...
    const ccomplex_t IT_0085 = N_W1*N_d4*e_em;
    const ccomplex_t IT_0086 = IT_0026*IT_0085;
    const ccomplex_t IT_0087 = (-0.5)*IT_0072 + 0.5*IT_0074 + 0.5*IT_0076 + (
      -0.5)*IT_0078 + (-0.5)*IT_0080 + 0.5*IT_0082 + 0.5*IT_0084 + (-0.5)*IT_0086;
    const ccomplex_t IT_0088 = m_N_4*IT_0087;
    const ccomplex_t IT_0089 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0090 = IT_0016*IT_0089;
    const ccomplex_t IT_0091 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0092 = IT_0020*IT_0091;
    const ccomplex_t IT_0093 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0094 = IT_0023*IT_0093;
    const ccomplex_t IT_0095 = conj(N_W1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0109 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0110 = IT_0016*IT_0109;
    const ccomplex_t IT_0111 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0112 = IT_0020*IT_0111;
    const ccomplex_t IT_0113 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0114 = IT_0023*IT_0113;
    const ccomplex_t IT_0115 = N_W1*N_d1*e_em;
    ...
    const ccomplex_t IT_0119 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0120 = IT_0016*IT_0119;
    const ccomplex_t IT_0121 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0122 = IT_0020*IT_0121;
    const ccomplex_t IT_0123 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0124 = IT_0023*IT_0123;
    const ccomplex_t IT_0125 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0000 + IT_0061 + -m_N_1*
    ...
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0000 + IT_0061 + -m_N_3*
    ...
    const ccomplex_t IT_0179 = IT_0014 + IT_0065 + IT_0108 + IT_0135 + IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0003*IT_0005*IT_0058;
    ...
    const ccomplex_t IT_0195 = m_N_1*IT_0087;
    const ccomplex_t IT_0196 = m_N_4*IT_0105;
    ...
    const ccomplex_t IT_0210 = m_N_1*IT_0037;
    const ccomplex_t IT_0211 = m_N_2*IT_0055;
    ...
    const ccomplex_t IT_0224 = m_N_1*IT_0152;
    const ccomplex_t IT_0225 = m_N_3*IT_0170;
    ...
    const ccomplex_t IT_0240 = m_e*m_N_1;
    const ccomplex_t IT_0241 = 2*IT_0179;
    const ccomplex_t IT_0242 = m_e*e_em*IT_0003*IT_0005*IT_0019*IT_0058;
    const ccomplex_t IT_0243 = (-0.5)*IT_0242;
    const ccomplex_t IT_0244 = IT_0131*IT_0243;
    const ccomplex_t IT_0245 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0061 
      + -reg_prop, -1);
    const ccomplex_t IT_0246 = IT_0244*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = IT_0087*IT_0194;
    const ccomplex_t IT_0249 = IT_0117*IT_0208;
    const ccomplex_t IT_0250 = IT_0037*IT_0222;
    const ccomplex_t IT_0251 = IT_0152*IT_0236;
    const ccomplex_t IT_0252 = -IT_0247 + IT_0248 + IT_0249 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_e*s_14;
    const ccomplex_t IT_0254 = IT_0070*IT_0105;
    ...
    const ccomplex_t IT_0258 = IT_0055*IT_0064;
