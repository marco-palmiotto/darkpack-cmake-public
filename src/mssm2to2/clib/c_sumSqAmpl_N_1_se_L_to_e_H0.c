...
ccomplex_return_t c_sumSqAmpl_N_1_se_L_to_e_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0012*IT_0031*IT_0033;
    const ccomplex_t IT_0035 = (-0.5)*IT_0034;
    const ccomplex_t IT_0036 = pow(m_e, 2);
    const ccomplex_t IT_0037 = pow(m_se_L, 2);
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0012*IT_0031*IT_0033;
    ...
    const ccomplex_t IT_0094 = cpow((-2)*s_13 + IT_0036 + IT_0093 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0007
      *IT_0012*IT_0031*IT_0033;
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0012*IT_0031*IT_0033;
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0012*IT_0031*IT_0033;
    ...
    const ccomplex_t IT_0235 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*(IT_0248 + IT_0251);
    ...
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*(IT_0276 + IT_0279);
    ...
    const ccomplex_t IT_0287 = m_e*m_N_1;
    ...
    const ccomplex_t IT_0294 = m_e*s_14;
    ...
    const ccomplex_t IT_0304 = m_e*m_N_1*IT_0303;
