        ...
        )
{
    ...
    const ccomplex_t IT_0102 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0103 = IT_0015*IT_0102;
    const ccomplex_t IT_0104 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0105 = IT_0027*IT_0104;
    const ccomplex_t IT_0106 = conj(N_W1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0107 = IT_0030*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0232 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0267 = m_N_1*IT_0040;
    ...
    const ccomplex_t IT_0281 = m_N_1*IT_0193;
