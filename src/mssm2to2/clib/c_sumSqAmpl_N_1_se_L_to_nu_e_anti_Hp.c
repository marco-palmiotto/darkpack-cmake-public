...
ccomplex_return_t c_sumSqAmpl_N_1_se_L_to_nu_e_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = conj(N_u1)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = 2*IT_0006;
    const ccomplex_t IT_0008 = cos(theta_W);
    const ccomplex_t IT_0009 = cpow(IT_0008, -1);
    const ccomplex_t IT_0010 = IT_0003*IT_0009;
    const ccomplex_t IT_0011 = conj(N_B1)*conj(V_u1)*e_em;
    const ccomplex_t IT_0012 = IT_0010*IT_0011;
    const ccomplex_t IT_0013 = 1.4142135623731*IT_0012;
    const ccomplex_t IT_0014 = conj(N_W1)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0001;
    const ccomplex_t IT_0027 = conj(N_u1)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0028 = IT_0004*IT_0027;
    const ccomplex_t IT_0029 = 2*IT_0028;
    const ccomplex_t IT_0030 = conj(N_B1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0031 = IT_0010*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W1)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0044 = pow(m_e, 2);
    const ccomplex_t IT_0045 = pow(m_N_1, 2);
    const ccomplex_t IT_0046 = cpow((-2)*s_12 + -IT_0023 + IT_0044 + -IT_0045 
      + -reg_prop, -1);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_e;
    const ccomplex_t IT_0048 = pow(m_W, -1);
    const ccomplex_t IT_0049 = cpow(IT_0003, -1);
    const ccomplex_t IT_0050 = sin(beta);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0001*IT_0048*IT_0049*IT_0050;
    ...
    const ccomplex_t IT_0062 = IT_0046*IT_0047*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001*
      (m_W*IT_0003 + (-0.5)*IT_0044*IT_0048*IT_0049)*IT_0050;
    ...
    const ccomplex_t IT_0068 = cpow(s_13 + (-0.5)*IT_0045 + (-0.5)*reg_prop +
       0.5*m_snu_mu*(m_snu_mu + (0 + _Complex_I*-1)*Gamma_nuel), -1);
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0001*IT_0048*IT_0049;
    ...
    const ccomplex_t IT_0077 = (-0.5)*IT_0025 + (-0.5)*IT_0043 + IT_0062 + 0.5
      *IT_0070 + -IT_0076;
    const ccomplex_t IT_0078 = IT_0001*IT_0050;
    const ccomplex_t IT_0079 = N_d1*e_em*U_Wm1;
    const ccomplex_t IT_0080 = IT_0078*IT_0079;
    const ccomplex_t IT_0081 = (-2)*IT_0080;
    const ccomplex_t IT_0082 = IT_0009*IT_0050;
    const ccomplex_t IT_0083 = N_B1*U_d1*e_em;
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = N_W1*U_d1*e_em;
    ...
    const ccomplex_t IT_0112 = -IT_0075 + (-0.5)*IT_0095 + (-0.5)*IT_0111;
