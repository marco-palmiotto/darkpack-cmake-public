...
ccomplex_return_t c_sumSqAmpl_N_1_se_R_to_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0185 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0217 = s_34*m_N_1;
