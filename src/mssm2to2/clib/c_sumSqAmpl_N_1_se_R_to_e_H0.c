        ...
        )
{
    ...
    const ccomplex_t IT_0068 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0069 = IT_0010*IT_0068;
    const ccomplex_t IT_0070 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0071 = IT_0016*IT_0070;
    const ccomplex_t IT_0072 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0073 = IT_0010*IT_0072;
    const ccomplex_t IT_0074 = N_W1*N_u4*e_em;
    ...
    const ccomplex_t IT_0083 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0015*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0142 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0143 = IT_0010*IT_0142;
    const ccomplex_t IT_0144 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0145 = IT_0024*IT_0144;
    const ccomplex_t IT_0146 = N_W1*N_d1*e_em;
    const ccomplex_t IT_0147 = IT_0027*IT_0146;
    const ccomplex_t IT_0148 = N_W1*N_u1*e_em;
    ...
    const ccomplex_t IT_0154 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0155 = IT_0024*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0157 = IT_0027*IT_0156;
    const ccomplex_t IT_0158 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0159 = IT_0016*IT_0158;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*(IT_0153 + -IT_0155 + 
      -IT_0157 + IT_0159);
    const ccomplex_t IT_0161 = m_N_1*IT_0160;
    const ccomplex_t IT_0162 = IT_0151 + IT_0161;
    const ccomplex_t IT_0163 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0219 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0230 = m_N_1*IT_0037;
    ...
    const ccomplex_t IT_0262 = m_N_1*IT_0088;
