        ...
        )
{
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_13 + IT_0016 + IT_0054 + -m_se_R*
    ...
    const ccomplex_t IT_0101 = IT_0067*IT_0084;
    ...
    const ccomplex_t IT_0105 = conj(N_d1)*N_d2*e_em;
    const ccomplex_t IT_0106 = IT_0003*IT_0105;
    const ccomplex_t IT_0107 = IT_0007*IT_0105;
    const ccomplex_t IT_0108 = conj(N_u1)*N_u2*e_em;
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0006*IT_0080*IT_0082;
    ...
    const ccomplex_t IT_0131 = -IT_0087 + (-2)*IT_0100 + IT_0103 + -IT_0104 + 
      (-2)*IT_0117 + (-2)*IT_0130;
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*(IT_0143 + -IT_0144);
    ...
    const ccomplex_t IT_0148 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0054 
      + -reg_prop, -1);
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*m_e;
    ...
    const ccomplex_t IT_0153 = -IT_0151;
    const ccomplex_t IT_0154 = IT_0140 + IT_0153;
    const ccomplex_t IT_0155 = IT_0102*IT_0154;
    const ccomplex_t IT_0156 = m_N_2*IT_0013;
    const ccomplex_t IT_0157 = m_N_1*IT_0112;
    ...
    const ccomplex_t IT_0162 = m_N_1*IT_0095;
    ...
    const ccomplex_t IT_0171 = IT_0050*IT_0053;
    ...
    const ccomplex_t IT_0175 = -IT_0150 + (-0.5)*IT_0152 + 0.5*IT_0155 + 
      -IT_0160 + -IT_0165 + -IT_0170 + IT_0174;
    const ccomplex_t IT_0176 = IT_0142 + IT_0175;
    const ccomplex_t IT_0177 = IT_0100 + (-0.5)*IT_0103 + 0.5*IT_0104 +
       IT_0117 + IT_0130;
    ...
    const ccomplex_t IT_0182 = IT_0084*IT_0146;
    const ccomplex_t IT_0183 = IT_0148*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*IT_0183;
    const ccomplex_t IT_0185 = -IT_0058 + (-2)*IT_0173;
    const ccomplex_t IT_0186 = s_14*IT_0016;
    ...
    const ccomplex_t IT_0201 = s_34*IT_0178;
    ...
    const ccomplex_t IT_0207 = IT_0069*IT_0151;
    const ccomplex_t IT_0208 = (-0.5)*IT_0207;
    const ccomplex_t IT_0209 = IT_0050*IT_0084;
    const ccomplex_t IT_0210 = IT_0148*IT_0149*IT_0209;
    const ccomplex_t IT_0211 = IT_0069*IT_0140;
    const ccomplex_t IT_0212 = IT_0069*IT_0154;
    const ccomplex_t IT_0213 = m_N_4*IT_0125;
    const ccomplex_t IT_0214 = m_N_1*IT_0043;
    const ccomplex_t IT_0215 = -IT_0214;
    const ccomplex_t IT_0216 = IT_0213 + IT_0215;
    const ccomplex_t IT_0217 = IT_0048*IT_0216;
    const ccomplex_t IT_0218 = m_e*IT_0184;
    const ccomplex_t IT_0219 = m_N_2*IT_0112;
    const ccomplex_t IT_0220 = m_N_1*IT_0013;
    ...
    const ccomplex_t IT_0225 = m_N_1*IT_0029;
    const ccomplex_t IT_0226 = -IT_0225;
    const ccomplex_t IT_0227 = IT_0224 + IT_0226;
    const ccomplex_t IT_0228 = IT_0034*IT_0227;
    const ccomplex_t IT_0229 = IT_0210 + 0.5*IT_0211 + 0.5*IT_0212 + IT_0217 +
       -IT_0218 + IT_0223 + IT_0228;
    const ccomplex_t IT_0230 = IT_0208 + IT_0229;
    const ccomplex_t IT_0231 = s_14*IT_0178;
    ...
    const ccomplex_t IT_0237 = IT_0087 + 2*IT_0184;
    ...
    const ccomplex_t IT_0253 = m_e*IT_0241;
    const ccomplex_t IT_0254 = (-2)*conj(IT_0185);
    const ccomplex_t IT_0255 = (-2)*conj(IT_0237);
    const ccomplex_t IT_0256 = (-2)*conj(IT_0175);
    const ccomplex_t IT_0257 = (-0.25)*IT_0232;
    const ccomplex_t IT_0258 = s_14 + IT_0257;
    const ccomplex_t IT_0259 = m_e*IT_0258;
    const ccomplex_t IT_0260 = (-4)*IT_0259;
    const ccomplex_t IT_0261 = 0.5*IT_0202;
    const ccomplex_t IT_0262 = s_34 + IT_0261;
    const ccomplex_t IT_0263 = m_N_1*IT_0262;
    const ccomplex_t IT_0264 = 2*IT_0263;
    const ccomplex_t IT_0265 = (-2)*IT_0185;
    const ccomplex_t IT_0266 = IT_0190 + IT_0196;
    const ccomplex_t IT_0267 = IT_0074*IT_0266;
    const ccomplex_t IT_0268 = (-0.5)*IT_0267;
    const ccomplex_t IT_0269 = s_13 + IT_0268;
    const ccomplex_t IT_0270 = 4*IT_0175;
    ...
    const ccomplex_t IT_0275 = s_13*IT_0250;
    ...
    const ccomplex_t IT_0281 = (-0.666666666666667)*IT_0269;
    const ccomplex_t IT_0282 = (-0.333333333333333)*IT_0134;
    const ccomplex_t IT_0283 = (-0.333333333333333)*IT_0177;
    const ccomplex_t IT_0284 = (-0.333333333333333)*IT_0184;
    const ccomplex_t IT_0285 = (-0.166666666666667)*IT_0244;
    const ccomplex_t IT_0286 = (-0.166666666666667)*IT_0253;
    const ccomplex_t IT_0287 = IT_0073*IT_0139 + (-3)*IT_0132*IT_0230 +
       IT_0198*IT_0260 + 0.5*IT_0252*IT_0278 + (-3)*(IT_0142 + IT_0271)*IT_0281 
      + (-3)*IT_0236*IT_0282 + (-3)*IT_0206*IT_0283 + (-3)*IT_0264*IT_0284 + (-3
      )*IT_0277*IT_0285 + (-3)*IT_0265*IT_0286;
    const ccomplex_t IT_0288 = 4*IT_0229;
    const ccomplex_t IT_0289 = IT_0131*IT_0139 + (-3)*IT_0132*IT_0176 +
       IT_0198*IT_0264 + 0.5*IT_0252*IT_0265 + (-3)*IT_0206*IT_0282 + (-3)
      *IT_0236*IT_0283 + (-3)*IT_0260*IT_0284 + (-3)*IT_0274*IT_0285 + (-3)
      *IT_0278*IT_0286 + (-3)*IT_0281*(IT_0208 + 0.25*IT_0288);
    const ccomplex_t IT_0290 = 2*conj(IT_0073)*(IT_0073*IT_0079 + IT_0131
      ...
      *IT_0138 + IT_0177*IT_0180 + IT_0181*IT_0184 + IT_0185*IT_0189 + (-2)
      *IT_0134*IT_0197 + (-4)*IT_0198*IT_0200 + IT_0206*IT_0230 + IT_0176
      *IT_0236) + 2*conj(IT_0177)*(IT_0131*IT_0138 + IT_0134*IT_0180 + (-2)
      *IT_0177*IT_0197 + IT_0181*IT_0198 + (-4)*IT_0184*IT_0200 + IT_0176
      ...
      *IT_0245 + (IT_0138*IT_0184 + IT_0237*IT_0242 + IT_0142*IT_0244)*IT_0246 +
       (IT_0189*IT_0198 + IT_0131*IT_0243 + IT_0237*IT_0251 + IT_0230*IT_0252 +
       IT_0176*IT_0253)*IT_0254 + (IT_0184*IT_0189 + IT_0142*IT_0252 + IT_0230
      *IT_0253)*IT_0255 + (IT_0131*IT_0244 + IT_0237*IT_0252)*IT_0256 + 2*conj
      (IT_0175)*(IT_0073*IT_0139 + IT_0177*IT_0206 + IT_0134*IT_0236 + IT_0198
      *IT_0260 + IT_0184*IT_0264 + 0.5*IT_0253*IT_0265 + 2*IT_0269*(IT_0142 +
       IT_0271)) + 2*conj(IT_0131)*(IT_0079*IT_0131 + IT_0073*IT_0133 + IT_0138
      *IT_0177 + IT_0139*IT_0230 + 0.5*IT_0244*IT_0272 + IT_0265*IT_0273) + 2
      *conj(IT_0185)*(IT_0134*IT_0189 + 0.5*IT_0242*IT_0274 + IT_0265*IT_0276) +
       2*conj(IT_0237)*(IT_0177*IT_0189 + 0.5*IT_0251*IT_0265 + 0.5*IT_0252
      *IT_0272 + IT_0273*IT_0274 + 0.5*IT_0242*IT_0277 + IT_0276*IT_0278) + 2
      *conj(IT_0198)*(IT_0177*IT_0181 + IT_0180*IT_0184 + (-2)*IT_0197*IT_0198 +
       (-4)*IT_0134*IT_0200 + IT_0176*IT_0260 + IT_0230*IT_0264 + IT_0274
      *IT_0279 + IT_0265*IT_0280) + 2*conj(IT_0184)*(IT_0134*IT_0181 + (-2)
      *IT_0184*IT_0197 + IT_0180*IT_0198 + (-4)*IT_0177*IT_0200 + IT_0230
      *IT_0260 + IT_0176*IT_0264 + IT_0277*IT_0279 + IT_0278*IT_0280) + 2*conj
      (IT_0142)*IT_0287 + 2*(conj(IT_0208) + conj(IT_0229))*IT_0289;
