        ...
        )
{
    ...
    const ccomplex_t IT_0092 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0093 = IT_0010*IT_0092;
    const ccomplex_t IT_0094 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0095 = IT_0014*IT_0094;
    const ccomplex_t IT_0096 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0097 = IT_0024*IT_0096;
    const ccomplex_t IT_0098 = N_W1*N_d1*e_em;
    ...
    const ccomplex_t IT_0103 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0104 = IT_0010*IT_0103;
    const ccomplex_t IT_0105 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0106 = IT_0014*IT_0105;
    const ccomplex_t IT_0107 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0108 = IT_0024*IT_0107;
    const ccomplex_t IT_0109 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0115 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0248 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0023*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0257 = m_N_1*IT_0037;
    ...
    const ccomplex_t IT_0271 = m_e*m_N_1;
