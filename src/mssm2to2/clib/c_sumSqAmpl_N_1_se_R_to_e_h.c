...
ccomplex_return_t c_sumSqAmpl_N_1_se_R_to_e_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*(IT_0005
      *IT_0006 + IT_0007*IT_0008)*IT_0009 + -IT_0000*IT_0008*IT_0010*IT_0011
      *IT_0012);
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0021 
      + -reg_prop, -1);
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_e*e_em*IT_0008*IT_0010
      *IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0000 + IT_0021 + -m_N_2*
    ...
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0000 + IT_0021 + -m_N_3*
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0000 + IT_0021 + -m_N_4*
    ...
    const ccomplex_t IT_0185 = IT_0047*IT_0184;
    const ccomplex_t IT_0186 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0187 = IT_0050*IT_0186;
    ...
    const ccomplex_t IT_0209 = IT_0050*IT_0208;
    ...
    const ccomplex_t IT_0221 = IT_0020 + (-2)*IT_0028 + IT_0036 + IT_0067 +
       IT_0118 + IT_0169 + IT_0220;
    const ccomplex_t IT_0222 = 2*s_13;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0228 = IT_0039*IT_0064;
    const ccomplex_t IT_0229 = IT_0072*IT_0115;
    const ccomplex_t IT_0230 = IT_0161*IT_0168;
    const ccomplex_t IT_0231 = IT_0174*IT_0217;
    const ccomplex_t IT_0232 = IT_0227 + -IT_0228 + -IT_0229 + -IT_0230 + 
      -IT_0231;
    const ccomplex_t IT_0233 = m_e*s_14;
    const ccomplex_t IT_0234 = IT_0037*IT_0224;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = IT_0053*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0010*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0246 = IT_0139*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0010*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0251 = IT_0195*IT_0250;
    const ccomplex_t IT_0252 = -IT_0027 + IT_0236 + IT_0241 + IT_0246 + IT_0251;
    const ccomplex_t IT_0253 = s_34*m_N_1;
    const ccomplex_t IT_0254 = conj(N_B1)*e_em;
    const ccomplex_t IT_0255 = IT_0015*IT_0254;
    const ccomplex_t IT_0256 = 1.4142135623731*IT_0255;
    const ccomplex_t IT_0257 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0262 = IT_0031*IT_0261;
    const ccomplex_t IT_0263 = IT_0029*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0014*IT_0224;
    const ccomplex_t IT_0266 = IT_0002*IT_0265;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*IT_0266;
    const ccomplex_t IT_0268 = m_e*IT_0227;
    const ccomplex_t IT_0269 = IT_0066*IT_0235;
    const ccomplex_t IT_0270 = m_N_1*IT_0093;
    const ccomplex_t IT_0271 = m_N_2*IT_0115;
    const ccomplex_t IT_0272 = IT_0270 + IT_0271;
    const ccomplex_t IT_0273 = IT_0240*IT_0272;
    const ccomplex_t IT_0274 = m_N_1*IT_0139;
    const ccomplex_t IT_0275 = m_N_3*IT_0161;
    const ccomplex_t IT_0276 = IT_0274 + IT_0275;
    const ccomplex_t IT_0277 = IT_0245*IT_0276;
    const ccomplex_t IT_0278 = m_N_4*IT_0217;
    const ccomplex_t IT_0279 = m_N_1*IT_0195;
    const ccomplex_t IT_0280 = IT_0278 + IT_0279;
    const ccomplex_t IT_0281 = IT_0250*IT_0280;
    const ccomplex_t IT_0282 = -IT_0264 + -IT_0267 + 2*IT_0268 + -IT_0269 + 
      -IT_0273 + -IT_0277 + -IT_0281;
    const ccomplex_t IT_0283 = 2*conj(IT_0282);
    const ccomplex_t IT_0284 = m_e*m_N_1;
    const ccomplex_t IT_0285 = 2*IT_0221;
    const ccomplex_t IT_0286 = 2*conj(IT_0221);
    const ccomplex_t IT_0287 = pow(m_h, 2);
    const ccomplex_t IT_0288 = m_e*m_N_1*IT_0287;
    ...
    const ccomplex_t IT_0293 = 2*IT_0282;
    const ccomplex_t IT_0294 = 0.5*IT_0253;
    const ccomplex_t IT_0295 = IT_0221*conj(IT_0221)*IT_0222 + (IT_0232
      *IT_0233 + IT_0252*IT_0253)*IT_0283 + conj(IT_0282)*(IT_0222*IT_0282 +
       IT_0284*IT_0285) + (IT_0233*IT_0252 + IT_0232*IT_0253 + IT_0282*IT_0284)
      *IT_0286 + 2*conj(IT_0232)*(IT_0252*IT_0288 + -IT_0232*IT_0292 + 0.5
      *IT_0233*IT_0293 + IT_0285*IT_0294) + 2*conj(IT_0252)*(0.5*IT_0233*IT_0285
       + IT_0232*IT_0288 + -IT_0252*IT_0292 + IT_0293*IT_0294);
