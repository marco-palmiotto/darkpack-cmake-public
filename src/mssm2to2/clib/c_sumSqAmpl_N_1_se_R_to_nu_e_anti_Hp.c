...
ccomplex_return_t c_sumSqAmpl_N_1_se_R_to_nu_e_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_e;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0003*IT_0007;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0003*IT_0005*IT_0007;
