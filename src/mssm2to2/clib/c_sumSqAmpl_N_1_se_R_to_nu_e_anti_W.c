...
ccomplex_return_t c_sumSqAmpl_N_1_se_R_to_nu_e_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0002*IT_0004*IT_0006;
