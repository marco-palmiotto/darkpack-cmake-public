        ...
        )
{
    ...
    const ccomplex_t IT_0037 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0047 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0048 = IT_0018*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0050 = IT_0021*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0007 + IT_0057 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0059 = e_em*m_mu*mu_h*IT_0000*IT_0004;
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0182 = IT_0060*IT_0181;
    ...
    const ccomplex_t IT_0210 = m_N_1*IT_0035;
    const ccomplex_t IT_0211 = m_N_3*IT_0053;
    ...
    const ccomplex_t IT_0245 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0057 
      + -reg_prop, -1);
    const ccomplex_t IT_0246 = IT_0244*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = IT_0109*IT_0208;
    const ccomplex_t IT_0249 = IT_0152*IT_0236;
    const ccomplex_t IT_0250 = IT_0074*IT_0194;
    const ccomplex_t IT_0251 = IT_0035*IT_0222;
    ...
    const ccomplex_t IT_0256 = IT_0170*IT_0177;
    const ccomplex_t IT_0257 = IT_0192*IT_0243;
