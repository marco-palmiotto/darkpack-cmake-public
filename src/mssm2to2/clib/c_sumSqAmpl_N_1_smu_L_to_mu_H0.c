...
ccomplex_return_t c_sumSqAmpl_N_1_smu_L_to_mu_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0087 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0088 = IT_0027*IT_0087;
    const ccomplex_t IT_0089 = N_W1*N_d1*e_em;
    const ccomplex_t IT_0090 = IT_0030*IT_0089;
    const ccomplex_t IT_0091 = N_W1*N_u1*e_em;
    ...
    const ccomplex_t IT_0095 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0137 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0138 = IT_0015*IT_0137;
    const ccomplex_t IT_0139 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0140 = IT_0019*IT_0139;
    const ccomplex_t IT_0141 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0142 = IT_0015*IT_0141;
    const ccomplex_t IT_0143 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0148 = conj(N_W1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0182 = IT_0027*IT_0181;
    ...
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0214 = (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0244 = m_N_1*IT_0135;
    const ccomplex_t IT_0245 = m_N_4*IT_0157;
    const ccomplex_t IT_0246 = IT_0244 + IT_0245;
    const ccomplex_t IT_0247 = IT_0243*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
    ...
    const ccomplex_t IT_0277 = m_N_1*IT_0040;
    const ccomplex_t IT_0278 = m_N_3*IT_0062;
    const ccomplex_t IT_0279 = IT_0277 + IT_0278;
    const ccomplex_t IT_0280 = IT_0276*IT_0279;
    const ccomplex_t IT_0281 = IT_0162*IT_0227;
    const ccomplex_t IT_0282 = IT_0164*IT_0281;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1)*IT_0282;
    const ccomplex_t IT_0284 = m_mu*IT_0283;
    const ccomplex_t IT_0285 = -IT_0230 + -IT_0233 + -IT_0247 + -IT_0252 + 
      -IT_0266 + -IT_0280 + 2*IT_0284;
    const ccomplex_t IT_0286 = 2*s_13;
    const ccomplex_t IT_0287 = m_mu*m_N_1;
    const ccomplex_t IT_0288 = 2*IT_0219;
    const ccomplex_t IT_0289 = IT_0040*IT_0276;
    const ccomplex_t IT_0290 = IT_0093*IT_0232;
    const ccomplex_t IT_0291 = IT_0188*IT_0262;
    const ccomplex_t IT_0292 = IT_0135*IT_0243;
    const ccomplex_t IT_0293 = -IT_0166 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_mu*s_14;
    const ccomplex_t IT_0295 = IT_0011*IT_0062;
    const ccomplex_t IT_0296 = IT_0114*IT_0157;
    const ccomplex_t IT_0297 = IT_0103*IT_0108;
    ...
    const ccomplex_t IT_0304 = m_mu*m_N_1*IT_0303;
