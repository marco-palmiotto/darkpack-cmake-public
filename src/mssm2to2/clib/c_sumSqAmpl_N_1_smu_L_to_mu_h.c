        ...
        )
{
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0004*IT_0018;
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0018 + (-0.5)*m_W*(IT_0001*IT_0018 + IT_0012*IT_0162)*
      (IT_0004 + -IT_0003*IT_0163));
    const ccomplex_t IT_0165 = IT_0099*IT_0164;
    const ccomplex_t IT_0166 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_smu_L*
    ...
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0246 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
