...
ccomplex_return_t c_sumSqAmpl_N_1_smu_L_to_nu_mu_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0012;
    const ccomplex_t IT_0014 = conj(N_W1)*e_em*U_Wm2;
    const ccomplex_t IT_0015 = IT_0012*IT_0014;
    const ccomplex_t IT_0016 = conj(N_d1)*U_d2*e_em;
    ...
    const ccomplex_t IT_0026 = N_W1*e_em*conj(V_Wp2);
    const ccomplex_t IT_0027 = IT_0012*IT_0026;
    const ccomplex_t IT_0028 = N_u1*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0035 = IT_0010*IT_0033*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0037 = cpow(s_23 + (-0.5)*IT_0009 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0012;
    const ccomplex_t IT_0039 = N_W1*e_em*conj(V_Wp1);
    const ccomplex_t IT_0040 = IT_0012*IT_0039;
    const ccomplex_t IT_0041 = N_u1*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0047 = IT_0036*IT_0037*IT_0046;
    const ccomplex_t IT_0048 = conj(N_W1)*e_em*U_Wm1;
    const ccomplex_t IT_0049 = IT_0012*IT_0048;
    const ccomplex_t IT_0050 = conj(N_d1)*U_d1*e_em;
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_12 + -IT_0009 + IT_0059 + -IT_0060 
      + -reg_prop, -1);
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0012;
    ...
    const ccomplex_t IT_0093 = (-0.5)*IT_0057;
    const ccomplex_t IT_0094 = 0.5*IT_0023;
    ...
    const ccomplex_t IT_0102 = -IT_0063;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*(IT_0084 + -IT_0087);
    const ccomplex_t IT_0104 = (-0.5)*IT_0103;
    const ccomplex_t IT_0105 = cpow(s_13 + (-0.5)*IT_0060 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0112 = IT_0057 + 0.5*IT_0108;
    ...
    const ccomplex_t IT_0118 = m_N_1*IT_0100;
    ...
    const ccomplex_t IT_0153 = (-0.25)*IT_0077;
    const ccomplex_t IT_0154 = IT_0003 + IT_0153;
    const ccomplex_t IT_0155 = 0.5*IT_0120;
    const ccomplex_t IT_0156 = s_34 + IT_0155;
    const ccomplex_t IT_0157 = m_N_1*IT_0156;
    const ccomplex_t IT_0158 = 2*IT_0157;
    const ccomplex_t IT_0159 = (-0.125)*IT_0158;
    const ccomplex_t IT_0160 = 4*IT_0008*IT_0073*IT_0074 + (-4)*IT_0079*
      ...
      *IT_0124*(IT_0074*IT_0094 + IT_0073*conj(IT_0094) + (-0.5)*conj(IT_0093)
      *IT_0127 + (-0.5)*IT_0093*IT_0130) + conj(IT_0109)*IT_0132*IT_0133 +
       IT_0134*(IT_0074*IT_0133 + IT_0073*IT_0135) + (-2)*IT_0136*(conj(IT_0093)
      *IT_0109 + IT_0093*conj(IT_0109) + IT_0135*IT_0138 + IT_0133*IT_0140) + (
      -2)*IT_0144*(IT_0117*IT_0138 + IT_0114*IT_0140 + -IT_0093*(conj(IT_0112) +
       0.5*IT_0145) + conj(IT_0093)*(IT_0110 + IT_0147)) + (conj(IT_0110)
      *IT_0111 + IT_0112*IT_0145 + (-2)*conj(IT_0112)*(IT_0110 + IT_0147))
      *IT_0152 + (-8)*conj(IT_0092)*(IT_0095*IT_0154 + IT_0127*IT_0159) + (-8)
      *IT_0092*(IT_0097*IT_0154 + IT_0130*IT_0159);
    return create_ccomplex_return(IT_0160);
}
