        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_W1)*e_em*U_Wm2;
    const ccomplex_t IT_0013 = IT_0010*IT_0012;
    const ccomplex_t IT_0014 = conj(N_d1)*U_d2*e_em;
    ...
    const ccomplex_t IT_0051 = N_W1*e_em*conj(V_Wp2);
    const ccomplex_t IT_0052 = IT_0010*IT_0051;
    const ccomplex_t IT_0053 = N_u1*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0061 = conj(N_W1)*e_em*U_Wm1;
    const ccomplex_t IT_0062 = IT_0010*IT_0061;
    const ccomplex_t IT_0063 = conj(N_d1)*U_d1*e_em;
