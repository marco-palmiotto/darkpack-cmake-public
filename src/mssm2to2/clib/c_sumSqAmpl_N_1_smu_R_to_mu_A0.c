        ...
        )
{
    ...
    const ccomplex_t IT_0035 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0036 = IT_0010*IT_0035;
    const ccomplex_t IT_0037 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0038 = IT_0014*IT_0037;
    const ccomplex_t IT_0039 = conj(N_W1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0047 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0048 = IT_0019*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
    ...
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0018*IT_0055*IT_0058;
    ...
    const ccomplex_t IT_0204 = m_N_1*IT_0152;
    ...
    const ccomplex_t IT_0212 = m_N_1*IT_0033;
