        ...
        )
{
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_N_1*
    ...
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0033 + IT_0039 + -m_smu_L*
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0007
      *IT_0012*IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_13 + IT_0033 + IT_0039 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0052 = cpow(IT_0002, -2);
    const ccomplex_t IT_0053 = sin(beta);
    const ccomplex_t IT_0054 = (0 + _Complex_I*-1)*e_em*(IT_0001*IT_0012
      *IT_0033*IT_0041*IT_0043 + -m_W*IT_0011*IT_0052*(IT_0001*IT_0042 + 
      -IT_0007*IT_0053));
    ...
    const ccomplex_t IT_0060 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_N_2*
    ...
    const ccomplex_t IT_0087 = conj(N_W1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0091 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0092 = IT_0016*IT_0091;
    const ccomplex_t IT_0093 = IT_0086 + IT_0088 + IT_0090 + IT_0092;
    const ccomplex_t IT_0094 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0095 = IT_0008*IT_0094;
    const ccomplex_t IT_0096 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0097 = IT_0013*IT_0096;
    const ccomplex_t IT_0098 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0099 = IT_0008*IT_0098;
    const ccomplex_t IT_0100 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0124 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0131 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0132 = IT_0004*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0134 = IT_0016*IT_0133;
    const ccomplex_t IT_0135 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0136 = IT_0004*IT_0135;
    const ccomplex_t IT_0137 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0138 = IT_0016*IT_0137;
    const ccomplex_t IT_0139 = IT_0132 + IT_0134 + IT_0136 + IT_0138;
    const ccomplex_t IT_0140 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0144 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0003;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_N_3*
    ...
    const ccomplex_t IT_0191 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0202 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0211 = cpow((-2)*s_12 + IT_0033 + -IT_0034 + -IT_0039 
      + -reg_prop, -1);
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*e_em*m_mu*IT_0001*IT_0012
      *IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0218 = IT_0038 + IT_0050 + IT_0057 + IT_0108 + IT_0159
       + IT_0210 + (-2)*IT_0217;
    ...
    const ccomplex_t IT_0230 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0012*IT_0041*IT_0043;
    const ccomplex_t IT_0231 = 0.5*IT_0230;
    const ccomplex_t IT_0232 = IT_0054*IT_0231;
    const ccomplex_t IT_0233 = IT_0051*IT_0232;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1)*IT_0233;
    const ccomplex_t IT_0235 = IT_0213*IT_0231;
    const ccomplex_t IT_0236 = IT_0211*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = m_mu*IT_0237;
    const ccomplex_t IT_0239 = m_N_1*IT_0185;
    const ccomplex_t IT_0240 = m_N_4*IT_0207;
    ...
    const ccomplex_t IT_0244 = IT_0162*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1)*IT_0244;
    const ccomplex_t IT_0246 = IT_0241*IT_0245;
    const ccomplex_t IT_0247 = IT_0035*IT_0231;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = IT_0030*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0012*IT_0041*IT_0043;
    const ccomplex_t IT_0251 = 0.5*IT_0250;
    const ccomplex_t IT_0252 = IT_0060*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = m_N_2*IT_0105;
    const ccomplex_t IT_0255 = m_N_1*IT_0083;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = IT_0253*IT_0256;
    const ccomplex_t IT_0258 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0012*IT_0041*IT_0043;
    const ccomplex_t IT_0259 = 0.5*IT_0258;
    const ccomplex_t IT_0260 = IT_0156*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*IT_0260;
    const ccomplex_t IT_0262 = m_N_1*IT_0129;
    const ccomplex_t IT_0263 = m_N_3*IT_0151;
    ...
    const ccomplex_t IT_0270 = IT_0083*IT_0253;
    const ccomplex_t IT_0271 = IT_0018*IT_0248;
    const ccomplex_t IT_0272 = IT_0129*IT_0261;
    const ccomplex_t IT_0273 = IT_0185*IT_0245;
    const ccomplex_t IT_0274 = -IT_0216 + IT_0270 + IT_0271 + IT_0272 + IT_0273;
    const ccomplex_t IT_0275 = m_mu*s_14;
    const ccomplex_t IT_0276 = IT_0164*IT_0207;
    const ccomplex_t IT_0277 = IT_0028*IT_0037;
    const ccomplex_t IT_0278 = IT_0062*IT_0105;
    const ccomplex_t IT_0279 = IT_0151*IT_0158;
