...
ccomplex_return_t c_sumSqAmpl_N_1_smu_R_to_mu_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = N_B3*N_d1*e_em;
    ...
    const ccomplex_t IT_0017 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0020 = IT_0010*IT_0019;
    const ccomplex_t IT_0021 = N_W1*N_u3*e_em;
    ...
    const ccomplex_t IT_0025 = N_B3*N_u1*e_em;
    ...
    const ccomplex_t IT_0032 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0039 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0043 = conj(N_B3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0048 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0015*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0085 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0086 = IT_0010*IT_0085;
    const ccomplex_t IT_0087 = conj(N_B1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0091 = conj(N_W1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0001;
    const ccomplex_t IT_0097 = -IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0001;
    const ccomplex_t IT_0103 = -IT_0102;
    const ccomplex_t IT_0104 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_4*
    ...
    const ccomplex_t IT_0116 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0117 = IT_0024*IT_0116;
    const ccomplex_t IT_0118 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0119 = IT_0027*IT_0118;
    const ccomplex_t IT_0120 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0121 = IT_0024*IT_0120;
    const ccomplex_t IT_0122 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0129 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0140 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0141 = IT_0027*IT_0140;
    const ccomplex_t IT_0142 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0143 = IT_0024*IT_0142;
    const ccomplex_t IT_0144 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*e_em*m_mu*IT_0009*IT_0015
      *IT_0063*IT_0065;
    const ccomplex_t IT_0154 = (-0.5)*IT_0153;
    const ccomplex_t IT_0155 = IT_0097*IT_0154;
    const ccomplex_t IT_0156 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0157 = IT_0155*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*IT_0157;
    const ccomplex_t IT_0159 = m_mu*IT_0158;
    const ccomplex_t IT_0160 = cpow(IT_0000, -2);
    const ccomplex_t IT_0161 = sin(beta);
    const ccomplex_t IT_0162 = (0 + _Complex_I*-1)*e_em*(IT_0004*IT_0009
      *IT_0015*IT_0063*IT_0065 + -m_W*IT_0014*IT_0160*(IT_0009*IT_0064 + 
      -IT_0013*IT_0161));
    const ccomplex_t IT_0163 = IT_0097*IT_0162;
    const ccomplex_t IT_0164 = cpow((-2)*s_13 + IT_0004 + IT_0071 + -m_smu_R*
    ...
    const ccomplex_t IT_0169 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_2*
    ...
    const ccomplex_t IT_0218 = IT_0062 + IT_0074 + IT_0101 + IT_0152 + (-2)
      *IT_0159 + IT_0166 + IT_0217;
    const ccomplex_t IT_0219 = m_N_1*IT_0127;
    const ccomplex_t IT_0220 = m_N_4*IT_0149;
    const ccomplex_t IT_0221 = IT_0219 + IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0015*IT_0063*IT_0065;
    const ccomplex_t IT_0223 = 0.5*IT_0222;
    const ccomplex_t IT_0224 = IT_0104*IT_0223;
    const ccomplex_t IT_0225 = (0 + _Complex_I*1)*IT_0224;
    const ccomplex_t IT_0226 = IT_0221*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0015*IT_0063*IT_0065;
    const ccomplex_t IT_0228 = 0.5*IT_0227;
    const ccomplex_t IT_0229 = IT_0098*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = IT_0095*IT_0230;
    const ccomplex_t IT_0232 = conj(N_B1)*e_em;
    const ccomplex_t IT_0233 = IT_0001*IT_0232;
    const ccomplex_t IT_0234 = 1.4142135623731*IT_0233;
    const ccomplex_t IT_0235 = conj(N_W1)*e_em;
    const ccomplex_t IT_0236 = IT_0015*IT_0235;
    const ccomplex_t IT_0237 = 1.4142135623731*IT_0236;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*(IT_0234 + IT_0237);
    const ccomplex_t IT_0239 = (-0.5)*IT_0238;
    const ccomplex_t IT_0240 = IT_0067*IT_0239;
    const ccomplex_t IT_0241 = IT_0072*IT_0240;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = IT_0162*IT_0228;
    const ccomplex_t IT_0244 = IT_0164*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1)*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0015*IT_0063*IT_0065;
    const ccomplex_t IT_0247 = 0.5*IT_0246;
    const ccomplex_t IT_0248 = IT_0169*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = m_N_1*IT_0192;
    const ccomplex_t IT_0251 = m_N_2*IT_0214;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = IT_0249*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0015*IT_0063*IT_0065;
    const ccomplex_t IT_0255 = 0.5*IT_0254;
    const ccomplex_t IT_0256 = IT_0006*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = m_N_1*IT_0037;
    const ccomplex_t IT_0259 = m_N_3*IT_0059;
    const ccomplex_t IT_0260 = IT_0258 + IT_0259;
    const ccomplex_t IT_0261 = IT_0257*IT_0260;
    const ccomplex_t IT_0262 = IT_0154*IT_0228;
    const ccomplex_t IT_0263 = IT_0156*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = m_mu*IT_0264;
    const ccomplex_t IT_0266 = -IT_0226 + -IT_0231 + -IT_0242 + -IT_0245 + 
      -IT_0253 + -IT_0261 + 2*IT_0265;
    const ccomplex_t IT_0267 = 2*s_13;
    const ccomplex_t IT_0268 = m_mu*m_N_1;
    const ccomplex_t IT_0269 = 2*IT_0218;
    const ccomplex_t IT_0270 = IT_0083*IT_0230;
    const ccomplex_t IT_0271 = IT_0037*IT_0257;
    const ccomplex_t IT_0272 = IT_0127*IT_0225;
    const ccomplex_t IT_0273 = IT_0192*IT_0249;
    const ccomplex_t IT_0274 = -IT_0158 + IT_0270 + IT_0271 + IT_0272 + IT_0273;
    const ccomplex_t IT_0275 = m_mu*s_14;
    const ccomplex_t IT_0276 = IT_0171*IT_0214;
    const ccomplex_t IT_0277 = IT_0106*IT_0149;
    const ccomplex_t IT_0278 = IT_0093*IT_0100;
    const ccomplex_t IT_0279 = IT_0008*IT_0059;
    const ccomplex_t IT_0280 = IT_0264 + -IT_0276 + -IT_0277 + -IT_0278 + 
      -IT_0279;
    ...
    const ccomplex_t IT_0285 = m_mu*m_N_1*IT_0284;
