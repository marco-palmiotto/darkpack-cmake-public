...
ccomplex_return_t c_sumSqAmpl_N_1_smu_R_to_nu_mu_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = IT_0004*IT_0007;
    ...
    const ccomplex_t IT_0046 = cpow(s_13 + (-0.5)*IT_0030 + (-0.5)*reg_prop +
       0.5*m_snu_mu*(m_snu_mu + (0 + _Complex_I*-1)*Gamma_numl), -1);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0003*IT_0007;
    ...
    const ccomplex_t IT_0061 = cpow(s_23 + (-0.5)*IT_0001 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0062 = conj(N_u1)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0063 = IT_0010*IT_0062;
    const ccomplex_t IT_0064 = 2*IT_0063;
    const ccomplex_t IT_0065 = conj(N_B1)*conj(V_u1)*e_em;
    const ccomplex_t IT_0066 = IT_0016*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = conj(N_W1)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = IT_0074*IT_0076;
    const ccomplex_t IT_0078 = IT_0060*IT_0061*IT_0077;
    const ccomplex_t IT_0079 = (-0.5)*IT_0028 + IT_0039 + -IT_0045 + 0.5
      *IT_0059 + (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = IT_0007*IT_0032;
    const ccomplex_t IT_0081 = N_d1*e_em*U_Wm1;
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (-2)*IT_0082;
    const ccomplex_t IT_0084 = IT_0015*IT_0032;
    const ccomplex_t IT_0085 = N_B1*U_d1*e_em;
    const ccomplex_t IT_0086 = IT_0084*IT_0085;
    const ccomplex_t IT_0087 = 1.4142135623731*IT_0086;
    const ccomplex_t IT_0088 = N_W1*U_d1*e_em;
    ...
    const ccomplex_t IT_0114 = -IT_0044 + (-0.5)*IT_0097 + (-0.5)*IT_0113;
    const ccomplex_t IT_0115 = s_23*m_N_1;
    const ccomplex_t IT_0116 = s_12*s_23;
    const ccomplex_t IT_0117 = s_13*IT_0001;
