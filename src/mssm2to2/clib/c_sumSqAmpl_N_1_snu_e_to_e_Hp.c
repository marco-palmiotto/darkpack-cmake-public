        ...
        )
{
    ...
    const ccomplex_t IT_0119 = cpow((-2)*s_13 + IT_0002 + IT_0047 + -m_se_L*
    ...
    const ccomplex_t IT_0127 = cpow((-2)*s_13 + IT_0002 + IT_0047 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0005*IT_0049;
    ...
    const ccomplex_t IT_0146 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0005*IT_0049*IT_0050;
