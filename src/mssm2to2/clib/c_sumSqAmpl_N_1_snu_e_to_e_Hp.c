...
ccomplex_return_t c_sumSqAmpl_N_1_snu_e_to_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_e*m_N_1*IT_0000;
    ...
    const ccomplex_t IT_0086 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0087 = IT_0072*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0093 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0111 = m_e*m_N_1;
    ...
    const ccomplex_t IT_0116 = IT_0022*IT_0100;
    const ccomplex_t IT_0117 = IT_0025*IT_0115*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0119 = IT_0041*IT_0067;
    const ccomplex_t IT_0120 = IT_0043*IT_0118*IT_0119;
    const ccomplex_t IT_0121 = cpow((-2)*s_13 + IT_0024 + IT_0061 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0011;
    const ccomplex_t IT_0123 = -IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0003*IT_0047;
    ...
    const ccomplex_t IT_0129 = m_N_1*IT_0064;
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0003*
      (m_W*IT_0005 + (-0.5)*IT_0024*IT_0047*IT_0048)*IT_0049;
    const ccomplex_t IT_0131 = -IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0003*IT_0047*IT_0048;
    const ccomplex_t IT_0133 = (-0.5)*IT_0132;
    const ccomplex_t IT_0134 = IT_0131*IT_0133;
    const ccomplex_t IT_0135 = cpow((-2)*s_13 + IT_0024 + IT_0061 + -m_se_L*
    ...
    const ccomplex_t IT_0138 = -IT_0117 + -IT_0120 + IT_0128 + (-0.5)*IT_0129 
      + IT_0137;
    ...
    const ccomplex_t IT_0147 = IT_0004*IT_0098;
    const ccomplex_t IT_0148 = IT_0025*IT_0115*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0003*IT_0047*IT_0048;
    const ccomplex_t IT_0150 = 0.5*IT_0149;
    const ccomplex_t IT_0151 = IT_0125*IT_0150;
    ...
    const ccomplex_t IT_0155 = IT_0043*IT_0118*IT_0154;
    const ccomplex_t IT_0156 = -IT_0146 + -IT_0148 + -IT_0153 + -IT_0155;
