        ...
        )
{
    ...
    const ccomplex_t IT_0131 = m_N_1*IT_0103;
    ...
    const ccomplex_t IT_0140 = m_N_1*IT_0019;
    const ccomplex_t IT_0141 = m_N_1*IT_0032;
    ...
    const ccomplex_t IT_0173 = m_N_1*IT_0171;
