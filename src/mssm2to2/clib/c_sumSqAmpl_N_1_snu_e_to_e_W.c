...
ccomplex_return_t c_sumSqAmpl_N_1_snu_e_to_e_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_e*U_d2*e_em
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0000 + IT_0024 + -m_se_L*
    ...
    const ccomplex_t IT_0063 = m_e*m_N_1;
    ...
    const ccomplex_t IT_0070 = cpow(s_12 + 0.5*IT_0001 + 0.5*IT_0024 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0071 = 0.5*IT_0020;
    ...
    const ccomplex_t IT_0124 = m_N_1*IT_0103;
    const ccomplex_t IT_0125 = -IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0127 = IT_0038*IT_0081;
    const ccomplex_t IT_0128 = IT_0029*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0130 = IT_0016*IT_0092;
    const ccomplex_t IT_0131 = IT_0002*IT_0129*IT_0130;
    ...
    const ccomplex_t IT_0140 = m_e*IT_0076;
    const ccomplex_t IT_0141 = m_N_1*IT_0041;
    const ccomplex_t IT_0142 = m_N_1*IT_0019;
    const ccomplex_t IT_0143 = 0.5*IT_0140 + IT_0141 + IT_0142;
    const ccomplex_t IT_0144 = IT_0009*IT_0099;
    const ccomplex_t IT_0145 = IT_0002*IT_0129*IT_0144;
    const ccomplex_t IT_0146 = IT_0031*IT_0088;
    const ccomplex_t IT_0147 = IT_0029*IT_0126*IT_0146;
    const ccomplex_t IT_0148 = -IT_0145 + -IT_0147;
    const ccomplex_t IT_0149 = IT_0143 + IT_0148;
    const ccomplex_t IT_0150 = (-6)*conj(IT_0132);
    ...
    const ccomplex_t IT_0164 = m_e*IT_0154;
    const ccomplex_t IT_0165 = (-2)*IT_0105;
    const ccomplex_t IT_0166 = IT_0061 + -IT_0076;
    const ccomplex_t IT_0167 = pow(s_34, 2);
    ...
    const ccomplex_t IT_0188 = (-2)*IT_0166;
    const ccomplex_t IT_0189 = IT_0077 + IT_0103;
    const ccomplex_t IT_0190 = (-2)*conj(IT_0166);
    const ccomplex_t IT_0191 = (-2)*IT_0132;
    const ccomplex_t IT_0192 = (-2)*conj(IT_0103)*(IT_0065*IT_0104 + 2*IT_0103
      *IT_0117 + IT_0123*IT_0149 + (-4)*IT_0077*IT_0180 + -IT_0069*IT_0183 + (
      -0.5)*IT_0109*IT_0188 + IT_0139*(IT_0125 + (-0.5)*IT_0191));
    const ccomplex_t IT_0193 = (-2)*conj(IT_0132);
    const ccomplex_t IT_0194 = 0.5*IT_0172;
    const ccomplex_t IT_0195 = (-2)*IT_0042;
    const ccomplex_t IT_0196 = s_13*IT_0170;
    ...
    const ccomplex_t IT_0208 = IT_0166*IT_0175;
    ...
    const ccomplex_t IT_0210 = 2*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      ...
      *IT_0080 + -IT_0103*IT_0104 + IT_0105*IT_0109 + (-2)*IT_0065*IT_0117 +
      ...
      (IT_0132)*(IT_0065*IT_0123 + IT_0151*IT_0155 + IT_0077*IT_0159 + 2*IT_0133
      *IT_0163 + 0.5*IT_0164*IT_0165) + (IT_0133*IT_0164 + IT_0166*IT_0171 +
       IT_0062*IT_0172 + IT_0149*IT_0173)*IT_0174 + (IT_0064*IT_0151 + IT_0149
      *IT_0155 + IT_0166*IT_0172 + IT_0105*IT_0175)*IT_0176 + 2*IT_0177*(IT_0042
      *conj(IT_0132) + conj(IT_0042)*IT_0133 + IT_0149*(conj(IT_0062) + 0.5
      *IT_0178)) + 2*conj(IT_0077)*(IT_0065*IT_0080 + (-2)*IT_0077*IT_0117 +
       ...
       0.5*IT_0109*IT_0188) + (IT_0149*IT_0164 + IT_0125*IT_0173 + IT_0109
      *IT_0189)*IT_0190 + IT_0192 + (IT_0103*IT_0139 + IT_0062*IT_0155 + IT_0166
      *IT_0173)*IT_0193 + 2*conj(IT_0062)*(IT_0048*IT_0062 + IT_0042*IT_0064 +
       ...
       + IT_0151*IT_0172 + 0.5*IT_0175*IT_0195 + IT_0165*IT_0197) + 2*conj
      (IT_0166)*(0.5*IT_0165*IT_0171 + IT_0175*IT_0183 + 0.5*IT_0173*IT_0191 +
       IT_0194*IT_0195 + IT_0188*IT_0197) + (-6)*(conj(IT_0143) + conj(IT_0148))
      *IT_0205 + 2*conj(IT_0125)*IT_0206 + IT_0207*(IT_0048*IT_0151 + IT_0125
      *IT_0155 + IT_0208 + IT_0209) + 2*conj(IT_0151)*(IT_0133*IT_0155 + IT_0105
      *IT_0172 + IT_0048*IT_0183 + 0.5*IT_0064*IT_0195 + IT_0208 + IT_0209);
