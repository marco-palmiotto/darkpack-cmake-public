        ...
        )
{
    ...
    const ccomplex_t IT_0006 = conj(N_B1)*e_em;
    ...
    const ccomplex_t IT_0034 = 0.5*IT_0027;
    ...
    const ccomplex_t IT_0041 = IT_0022*IT_0039;
    ...
    const ccomplex_t IT_0052 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0072 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0081 = IT_0022*IT_0079;
    ...
    const ccomplex_t IT_0092 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0096 = 0.5*IT_0018 + (-0.5)*IT_0033 + 0.5*IT_0035 +
    ...
    const ccomplex_t IT_0100 = -IT_0014;
    const ccomplex_t IT_0101 = IT_0099 + IT_0100;
    const ccomplex_t IT_0102 = s_13*IT_0101;
    const ccomplex_t IT_0103 = m_N_1*IT_0034;
    const ccomplex_t IT_0104 = IT_0032*IT_0103;
    const ccomplex_t IT_0105 = (-0.25)*IT_0104;
    const ccomplex_t IT_0106 = m_N_1*IT_0028;
    const ccomplex_t IT_0107 = IT_0032*IT_0106;
    const ccomplex_t IT_0108 = -IT_0106;
    ...
    const ccomplex_t IT_0120 = m_N_1*IT_0043;
    ...
    const ccomplex_t IT_0129 = IT_0022*IT_0127;
    ...
    const ccomplex_t IT_0133 = m_N_1*IT_0063;
    ...
    const ccomplex_t IT_0142 = IT_0022*IT_0140;
    ...
    const ccomplex_t IT_0146 = m_N_1*IT_0083;
    const ccomplex_t IT_0147 = -IT_0146;
    const ccomplex_t IT_0148 = IT_0145 + IT_0147;
    const ccomplex_t IT_0149 = IT_0094*IT_0148;
    const ccomplex_t IT_0150 = 0.25*IT_0107 + (-0.25)*IT_0110 + 0.5*IT_0123 +
       0.5*IT_0136 + 0.5*IT_0149;
    const ccomplex_t IT_0151 = pow(s_34, 2);
    const ccomplex_t IT_0152 = m_N_1*IT_0097*IT_0151;
    const ccomplex_t IT_0153 = e_em*IT_0019;
    const ccomplex_t IT_0154 = e_em*IT_0022;
    ...
    const ccomplex_t IT_0158 = cpow(s_12 + 0.5*IT_0014 + 0.5*IT_0029 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0159 = IT_0157*IT_0158;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*IT_0159;
    const ccomplex_t IT_0161 = (-0.5)*IT_0018 + -IT_0160;
    ...
    const ccomplex_t IT_0195 = s_34*IT_0014;
    ...
    const ccomplex_t IT_0208 = 0.25*IT_0033 + (-0.25)*IT_0035 + (-0.5)*IT_0055
