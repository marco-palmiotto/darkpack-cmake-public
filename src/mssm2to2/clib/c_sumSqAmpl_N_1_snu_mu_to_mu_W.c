...
ccomplex_return_t c_sumSqAmpl_N_1_snu_mu_to_mu_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0000 + IT_0024 + -m_smu_L*
    ...
    const ccomplex_t IT_0063 = m_mu*m_N_1;
    ...
    const ccomplex_t IT_0140 = m_mu*IT_0076;
