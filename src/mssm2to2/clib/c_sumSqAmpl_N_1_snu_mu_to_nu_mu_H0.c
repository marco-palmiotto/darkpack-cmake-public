        ...
        )
{
    ...
    const ccomplex_t IT_0108 = N_B4*N_u1*e_em;
    ...
    const ccomplex_t IT_0121 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0130 = conj(N_B1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0134 = conj(N_B4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0166 = cpow(s_23 + (-0.5)*IT_0063 + 0.5*m_N_1*(m_N_1 +
