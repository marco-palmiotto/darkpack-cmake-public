...
ccomplex_return_t c_sumSqAmpl_N_1_snu_tau_to_nu_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0113 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0114 = IT_0024*IT_0113;
    const ccomplex_t IT_0115 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0116 = IT_0027*IT_0115;
    const ccomplex_t IT_0117 = N_B1*N_u4*e_em;
    ...
    const ccomplex_t IT_0123 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0127 = conj(N_B1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0139 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0140 = IT_0024*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W4)*conj(N_d1)*e_em;
