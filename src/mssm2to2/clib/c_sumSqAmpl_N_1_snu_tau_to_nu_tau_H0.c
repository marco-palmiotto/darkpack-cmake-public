        ...
        )
{
    ...
    const ccomplex_t IT_0052 = cpow(s_23 + (-0.5)*IT_0051 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0087 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0135 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0136 = IT_0027*IT_0135;
    const ccomplex_t IT_0137 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0138 = IT_0036*IT_0137;
    const ccomplex_t IT_0139 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0140 = IT_0027*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0142 = IT_0036*IT_0141;
    const ccomplex_t IT_0143 = IT_0136 + IT_0138 + IT_0140 + IT_0142;
    const ccomplex_t IT_0144 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0145 = IT_0030*IT_0144;
    const ccomplex_t IT_0146 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0147 = IT_0033*IT_0146;
    const ccomplex_t IT_0148 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0149 = IT_0030*IT_0148;
    const ccomplex_t IT_0150 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0223 = cpow(s_23 + (-0.5)*IT_0051 + 0.5*m_N_2*(m_N_2 +
