        ...
        )
{
    ...
    const ccomplex_t IT_0041 = conj(N_B1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0045 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0046 = IT_0033*IT_0045;
    const ccomplex_t IT_0047 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0054 = cpow(s_23 + (-0.5)*IT_0053 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0066 = cpow(s_23 + (-0.5)*IT_0053 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0135 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0136 = IT_0033*IT_0135;
    const ccomplex_t IT_0137 = N_W3*N_d1*e_em;
    ...
    const ccomplex_t IT_0164 = IT_0036*IT_0163;
    ...
    const ccomplex_t IT_0232 = IT_0039*IT_0056;
