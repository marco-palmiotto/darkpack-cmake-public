        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0005;
    ...
    const ccomplex_t IT_0043 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0002 +
    ...
    const ccomplex_t IT_0053 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = IT_0013*IT_0051;
    const ccomplex_t IT_0057 = conj(N_B1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0061 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0072 = conj(N_B1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0089 = pow(m_N_1, 2);
    const ccomplex_t IT_0090 = cpow(s_12 + 0.5*IT_0000 + 0.5*IT_0089 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0005*IT_0047*IT_0048*IT_0051;
    const ccomplex_t IT_0092 = 0.5*IT_0091;
    const ccomplex_t IT_0093 = conj(N_B1)*e_em;
    const ccomplex_t IT_0094 = IT_0013*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0107 = m_N_1*m_tau;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0109 = IT_0024*IT_0071;
    const ccomplex_t IT_0110 = IT_0003*IT_0108*IT_0109;
    const ccomplex_t IT_0111 = m_tau*IT_0027;
    const ccomplex_t IT_0112 = m_tau*IT_0045;
    const ccomplex_t IT_0113 = (-0.5)*IT_0110 + 0.5*IT_0111 + 0.5*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*(A_tau*IT_0051*conj
      ...
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0115 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0116 = IT_0013*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = IT_0005*IT_0048;
    const ccomplex_t IT_0119 = N_d1*e_em*m_tau*IT_0047*U_stau_01;
    ...
    const ccomplex_t IT_0125 = cpow(s_13 + (-0.5)*IT_0002 + (-0.5)*IT_0089 + (
    ...
    const ccomplex_t IT_0128 = cpow(s_13 + (-0.5)*IT_0002 + (-0.5)*IT_0089 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*(A_tau*IT_0051*conj
    ...
    const ccomplex_t IT_0133 = N_d1*e_em*m_tau*IT_0047*U_stau_00;
    ...
    const ccomplex_t IT_0142 = IT_0041*IT_0050;
    const ccomplex_t IT_0143 = IT_0043*IT_0141*IT_0142;
    const ccomplex_t IT_0144 = m_N_1*IT_0103;
    const ccomplex_t IT_0145 = (-0.5)*IT_0127 + (-0.5)*IT_0140 + 0.5*IT_0143 +
       (-0.5)*IT_0144;
    const ccomplex_t IT_0146 = m_tau*IT_0087;
    const ccomplex_t IT_0147 = IT_0028*IT_0066;
    const ccomplex_t IT_0148 = IT_0043*IT_0141*IT_0147;
    const ccomplex_t IT_0149 = m_tau*IT_0069;
    const ccomplex_t IT_0150 = 0.5*IT_0146 + (-0.5)*IT_0148 + 0.5*IT_0149;
    const ccomplex_t IT_0151 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0152 = IT_0013*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0155 = IT_0005*IT_0154;
    const ccomplex_t IT_0156 = 1.4142135623731*IT_0155;
    const ccomplex_t IT_0157 = conj(N_d1)*e_em*m_tau*IT_0047*U_stau_10;
    ...
    const ccomplex_t IT_0165 = IT_0006*IT_0084;
    const ccomplex_t IT_0166 = IT_0003*IT_0108*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0168 = IT_0013*IT_0167;
    const ccomplex_t IT_0169 = 1.4142135623731*IT_0168;
    const ccomplex_t IT_0170 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0171 = IT_0005*IT_0170;
    const ccomplex_t IT_0172 = 1.4142135623731*IT_0171;
    const ccomplex_t IT_0173 = conj(N_d1)*e_em*m_tau*IT_0047*U_stau_11;
    ...
    const ccomplex_t IT_0179 = IT_0125*IT_0178;
    ...
    const ccomplex_t IT_0188 = s_23*m_N_1;
