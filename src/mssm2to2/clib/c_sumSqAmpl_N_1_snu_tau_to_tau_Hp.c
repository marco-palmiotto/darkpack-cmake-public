...
ccomplex_return_t c_sumSqAmpl_N_1_snu_tau_to_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_N_1*m_tau*IT_0000;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0003;
    const ccomplex_t IT_0029 = N_u1*e_em*V_Wp2;
    const ccomplex_t IT_0030 = IT_0006*IT_0029;
    const ccomplex_t IT_0031 = 2*IT_0030;
    const ccomplex_t IT_0032 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0033 = IT_0012*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0056 = IT_0003*IT_0051;
    ...
    const ccomplex_t IT_0070 = conj(N_W1)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0100 = pow(m_N_1, 2);
    ...
    const ccomplex_t IT_0111 = m_N_1*m_tau;
    const ccomplex_t IT_0112 = IT_0027 + IT_0045;
    const ccomplex_t IT_0113 = m_tau*IT_0112;
    const ccomplex_t IT_0114 = 0.5*IT_0113;
    const ccomplex_t IT_0115 = m_N_1*IT_0103;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0117 = IT_0022*IT_0050;
    const ccomplex_t IT_0118 = IT_0025*IT_0116*IT_0117;
    const ccomplex_t IT_0119 = cpow(s_13 + (-0.5)*IT_0024 + (-0.5)*IT_0100 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*(A_tau*IT_0051*conj
      ...
      + mu_h*conj(U_stau_10))));
    const ccomplex_t IT_0121 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0122 = IT_0011*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = IT_0003*IT_0048;
    const ccomplex_t IT_0125 = N_d1*e_em*m_tau*IT_0047*U_stau_00;
    ...
    const ccomplex_t IT_0134 = IT_0041*IT_0084;
    const ccomplex_t IT_0135 = IT_0043*IT_0133*IT_0134;
    const ccomplex_t IT_0136 = cpow(s_13 + (-0.5)*IT_0024 + (-0.5)*IT_0100 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*(A_tau*IT_0051*conj
    ...
    const ccomplex_t IT_0141 = N_d1*e_em*m_tau*IT_0047*U_stau_01;
    ...
    const ccomplex_t IT_0149 = (-0.5)*IT_0115 + 0.5*IT_0118 + (-0.5)*IT_0132 +
       0.5*IT_0135 + (-0.5)*IT_0148;
    const ccomplex_t IT_0150 = IT_0069 + IT_0087;
    const ccomplex_t IT_0151 = m_tau*IT_0150;
    const ccomplex_t IT_0152 = 0.5*IT_0151;
    const ccomplex_t IT_0153 = IT_0004*IT_0066;
    const ccomplex_t IT_0154 = IT_0025*IT_0116*IT_0153;
    const ccomplex_t IT_0155 = IT_0028*IT_0082;
    const ccomplex_t IT_0156 = IT_0043*IT_0133*IT_0155;
    const ccomplex_t IT_0157 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0158 = IT_0011*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0161 = IT_0003*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = conj(N_d1)*e_em*m_tau*IT_0047*U_stau_10;
    ...
    const ccomplex_t IT_0171 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0172 = IT_0011*IT_0171;
    const ccomplex_t IT_0173 = 1.4142135623731*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0175 = IT_0003*IT_0174;
    const ccomplex_t IT_0176 = 1.4142135623731*IT_0175;
    const ccomplex_t IT_0177 = conj(N_d1)*e_em*m_tau*IT_0047*U_stau_11;
    const ccomplex_t IT_0178 = IT_0124*IT_0177;
    ...
    const ccomplex_t IT_0192 = s_23*m_N_1;
