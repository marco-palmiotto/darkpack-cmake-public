...
ccomplex_return_t c_sumSqAmpl_N_1_snu_tau_to_tau_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = N_B1*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0013 = N_d1*e_em*m_tau*IT_0012*U_stau_01;
    ...
    const ccomplex_t IT_0041 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0042 = IT_0001*IT_0041;
    const ccomplex_t IT_0043 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0056 = N_d1*e_em*m_tau*IT_0012*U_stau_00;
    ...
    const ccomplex_t IT_0080 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0081 = IT_0005*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0084 = IT_0001*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_d1)*e_em*m_tau*IT_0012*U_stau_10;
    ...
    const ccomplex_t IT_0093 = IT_0052*IT_0092;
    const ccomplex_t IT_0094 = 0.5*IT_0079 + 0.5*IT_0093;
    const ccomplex_t IT_0095 = m_N_1*m_tau;
    ...
    const ccomplex_t IT_0139 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0140 = IT_0001*IT_0139;
    const ccomplex_t IT_0141 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0150 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0151 = IT_0001*IT_0150;
    const ccomplex_t IT_0152 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0169 = IT_0148 + IT_0159;
    const ccomplex_t IT_0170 = m_N_1*IT_0169;
    const ccomplex_t IT_0171 = 0.5*IT_0170;
    const ccomplex_t IT_0172 = IT_0034*IT_0149;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0174 = IT_0025*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = IT_0047*IT_0138;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0177 = IT_0038*IT_0175*IT_0176;
    const ccomplex_t IT_0178 = (-0.5)*IT_0174 + (-0.5)*IT_0177;
    ...
    const ccomplex_t IT_0189 = IT_0027*IT_0156;
    const ccomplex_t IT_0190 = IT_0025*IT_0173*IT_0189;
    const ccomplex_t IT_0191 = IT_0040*IT_0145;
    const ccomplex_t IT_0192 = IT_0038*IT_0176*IT_0191;
    const ccomplex_t IT_0193 = 0.5*IT_0190 + 0.5*IT_0192;
    const ccomplex_t IT_0194 = m_N_1*IT_0037;
    const ccomplex_t IT_0195 = m_N_1*IT_0050;
    const ccomplex_t IT_0196 = m_tau*IT_0120;
    ...
    const ccomplex_t IT_0222 = m_N_1*IT_0219;
    ...
    const ccomplex_t IT_0229 = 4*IT_0193;
    const ccomplex_t IT_0230 = 0.25*IT_0229;
    const ccomplex_t IT_0231 = IT_0197 + IT_0230;
    const ccomplex_t IT_0232 = m_N_1*IT_0214;
    const ccomplex_t IT_0233 = (-2)*conj(IT_0065);
    const ccomplex_t IT_0234 = s_13*IT_0100;
    const ccomplex_t IT_0235 = (-2)*IT_0169;
    const ccomplex_t IT_0236 = (-2)*conj(IT_0169);
    const ccomplex_t IT_0237 = (-2)*IT_0211;
    const ccomplex_t IT_0238 = 2*conj(IT_0102)*(IT_0065*IT_0106 + IT_0121
      *IT_0124 + (-2)*IT_0102*IT_0137 + -IT_0160*IT_0199 + IT_0198*IT_0203 +
       IT_0179*IT_0207 + 0.5*IT_0129*IT_0237);
    const ccomplex_t IT_0239 = m_tau*IT_0214;
    const ccomplex_t IT_0240 = (-2)*conj(IT_0211);
    const ccomplex_t IT_0241 = (-2)*conj(IT_0193);
    const ccomplex_t IT_0242 = m_tau*IT_0100;
    const ccomplex_t IT_0243 = IT_0121 + IT_0160;
    const ccomplex_t IT_0244 = 0.5*IT_0215;
    const ccomplex_t IT_0245 = 0.333333333333333*IT_0160;
    const ccomplex_t IT_0246 = (-0.333333333333333)*IT_0102;
    const ccomplex_t IT_0247 = (-0.333333333333333)*IT_0121;
    const ccomplex_t IT_0248 = (-3)*IT_0095*IT_0198 + IT_0125*IT_0222 + 2
      *IT_0179*IT_0228 + IT_0182*IT_0232 + 0.5*IT_0237*IT_0239 + IT_0065*IT_0242
       + (-3)*IT_0203*IT_0245 + (-3)*IT_0207*IT_0246 + (-3)*IT_0168*IT_0247;
    const ccomplex_t IT_0249 = (-6)*conj(IT_0193);
    const ccomplex_t IT_0250 = IT_0095*IT_0179;
    const ccomplex_t IT_0251 = IT_0211*IT_0222 + 2*IT_0228*IT_0231 + 0.5
      *IT_0224*IT_0232 + -IT_0125*IT_0239 + (IT_0094 + 0.5*IT_0235)*IT_0242 + (
      -3)*IT_0207*IT_0245 + (-3)*IT_0203*IT_0246 + (-3)*IT_0188*IT_0247 + (-3)
      *IT_0250;
    const ccomplex_t IT_0252 = (-2)*conj(IT_0094);
    const ccomplex_t IT_0253 = IT_0179*IT_0232;
    const ccomplex_t IT_0254 = IT_0106*IT_0243;
    const ccomplex_t IT_0255 = 2*conj(IT_0065)*(IT_0094*IT_0101 + IT_0102
      ...
      *IT_0160 + 4*IT_0121*IT_0162 + IT_0106*IT_0182 + -IT_0102*IT_0199 + 
      -IT_0179*IT_0203 + -IT_0207*IT_0210) + 2*conj(IT_0211)*(IT_0169*IT_0215 +
       IT_0211*IT_0220 + IT_0125*IT_0221 + IT_0198*IT_0222 + 0.5*IT_0223*IT_0224
      ) + 2*conj(IT_0193)*(IT_0121*IT_0188 + IT_0102*IT_0203 + IT_0211*IT_0222 +
       2*IT_0228*IT_0231 + 0.5*IT_0224*IT_0232) + (IT_0101*IT_0169 + IT_0125
      *IT_0215 + IT_0211*IT_0223 + IT_0198*IT_0232)*IT_0233 + 2*IT_0234*(IT_0065
      *conj(IT_0065) + 0.5*conj(IT_0094)*IT_0235 + IT_0094*(conj(IT_0094) + 0.5
      *IT_0236)) + IT_0238 + (IT_0102*IT_0129 + IT_0094*IT_0215 + IT_0179
      *IT_0239)*IT_0240 + (IT_0160*IT_0207 + IT_0125*IT_0239)*IT_0241 + 2*(conj
      (IT_0065)*IT_0179 + IT_0094*conj(IT_0193) + conj(IT_0094)*IT_0198 + 0.5
      *IT_0197*IT_0236 + 0.5*IT_0169*IT_0241)*IT_0242 + 2*conj(IT_0125)*(IT_0125
      *IT_0220 + IT_0211*IT_0221 + IT_0179*IT_0222 + IT_0182*IT_0223 + -IT_0210
      *IT_0239 + IT_0129*IT_0243 + IT_0224*IT_0244) + 2*conj(IT_0094)*(IT_0065
      *IT_0101 + IT_0237*IT_0244) + 2*(conj(IT_0171) + conj(IT_0178))*IT_0248 +
       IT_0249*IT_0250 + 2*conj(IT_0197)*IT_0251 + IT_0252*(IT_0125*IT_0223 +
       IT_0253 + IT_0254) + 2*conj(IT_0169)*(IT_0211*IT_0215 + IT_0125*IT_0223 +
       0.5*IT_0101*IT_0224 + IT_0169*IT_0234 + 0.5*IT_0208*IT_0242 + IT_0253 +
       IT_0254);
