        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
      *m_tau*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0024 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*IT_0025;
    const ccomplex_t IT_0027 = IT_0005*IT_0007;
    const ccomplex_t IT_0028 = N_d1*e_em*m_tau*IT_0003*U_stau_01;
    ...
    const ccomplex_t IT_0034 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0033 + (
    ...
    const ccomplex_t IT_0038 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0041 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0042 = IT_0007*IT_0041;
    const ccomplex_t IT_0043 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007
      *conj(U_stau_00);
    ...
    const ccomplex_t IT_0056 = N_d1*e_em*m_tau*IT_0003*U_stau_00;
    ...
    const ccomplex_t IT_0072 = conj(N_d1)*e_em*m_tau*IT_0003*U_stau_11;
    ...
    const ccomplex_t IT_0086 = conj(N_d1)*e_em*m_tau*IT_0003*U_stau_10;
    ...
    const ccomplex_t IT_0099 = -IT_0033;
    const ccomplex_t IT_0100 = IT_0098 + IT_0099;
    const ccomplex_t IT_0101 = IT_0095*IT_0100;
    const ccomplex_t IT_0102 = (-0.5)*IT_0019 + (-0.5)*IT_0050;
    const ccomplex_t IT_0103 = s_13*s_14;
    const ccomplex_t IT_0104 = s_34*IT_0033;
    const ccomplex_t IT_0105 = -IT_0104;
    const ccomplex_t IT_0106 = IT_0103 + IT_0105;
    const ccomplex_t IT_0107 = cpow(s_12 + 0.5*IT_0001 + 0.5*IT_0033 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007;
    ...
    const ccomplex_t IT_0127 = s_14*IT_0000;
    ...
    const ccomplex_t IT_0138 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0007;
    const ccomplex_t IT_0139 = conj(N_W1)*e_em*V_Wp1;
    const ccomplex_t IT_0140 = IT_0007*IT_0139;
    const ccomplex_t IT_0141 = conj(N_u1)*V_u1*e_em;
    ...
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0007;
    const ccomplex_t IT_0150 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0151 = IT_0007*IT_0150;
    const ccomplex_t IT_0152 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0174 = IT_0009*IT_0156;
    const ccomplex_t IT_0175 = IT_0002*IT_0173*IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0177 = IT_0040*IT_0145;
    const ccomplex_t IT_0178 = IT_0038*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = 0.5*IT_0175 + 0.5*IT_0178;
    const ccomplex_t IT_0180 = m_N_1*IT_0019;
    const ccomplex_t IT_0181 = m_N_1*IT_0050;
    ...
    const ccomplex_t IT_0191 = m_N_1*IT_0163;
    const ccomplex_t IT_0192 = 0.5*IT_0191;
    const ccomplex_t IT_0193 = IT_0047*IT_0138;
    const ccomplex_t IT_0194 = IT_0038*IT_0176*IT_0193;
    const ccomplex_t IT_0195 = IT_0016*IT_0149;
    const ccomplex_t IT_0196 = IT_0002*IT_0173*IT_0195;
    ...
    const ccomplex_t IT_0211 = 0.5*IT_0037 + 0.5*IT_0064;
    ...
    const ccomplex_t IT_0218 = -IT_0000;
    ...
    const ccomplex_t IT_0229 = m_N_1*IT_0214;
