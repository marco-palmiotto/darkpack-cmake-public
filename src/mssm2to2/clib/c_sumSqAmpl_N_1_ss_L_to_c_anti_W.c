        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0007;
    const ccomplex_t IT_0071 = conj(N_W1)*e_em*U_Wm1;
    const ccomplex_t IT_0072 = IT_0007*IT_0071;
    const ccomplex_t IT_0073 = conj(N_d1)*U_d1*e_em;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0007;
    const ccomplex_t IT_0082 = conj(N_W1)*e_em*U_Wm2;
    const ccomplex_t IT_0083 = IT_0007*IT_0082;
    const ccomplex_t IT_0084 = conj(N_d1)*U_d2*e_em;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0147 = m_c*IT_0104;
    ...
    const ccomplex_t IT_0187 = (-6)*conj(IT_0137);
    ...
    const ccomplex_t IT_0200 = IT_0092 + IT_0104;
    ...
    const ccomplex_t IT_0210 = IT_0063*((-18)*IT_0137 + (-18)*IT_0139) +
       IT_0156*IT_0177 + IT_0179*IT_0185 + IT_0178*IT_0197 + IT_0166*IT_0205 +
       IT_0146*IT_0206 + IT_0204*(IT_0062 + 0.166666666666667*IT_0207) + IT_0196
      *IT_0208 + IT_0123*IT_0209;
    const ccomplex_t IT_0211 = IT_0063*((-18)*IT_0150 + (-18)*IT_0155) +
       IT_0140*IT_0177 + IT_0178*IT_0179 + 6*IT_0166*IT_0192 + IT_0185*IT_0197 +
    ...
    const ccomplex_t IT_0216 = IT_0069*IT_0200;
    const ccomplex_t IT_0217 = 6*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      ...
      *IT_0186 + (IT_0092*IT_0146 + IT_0062*IT_0166 + IT_0164*IT_0185)*IT_0187 +
       6*conj(IT_0104)*(IT_0065*IT_0096 + 0.166666666666667*IT_0104*IT_0117 +
       IT_0140*IT_0171 + 0.166666666666667*IT_0092*IT_0189 + IT_0069*IT_0192 +
       IT_0156*IT_0196 + 0.166666666666667*IT_0109*IT_0197) + IT_0199 + (IT_0156
      *IT_0178 + IT_0139*IT_0185 + IT_0109*IT_0200)*IT_0201 + (IT_0042*conj
      ...
      *IT_0210 + conj(IT_0139)*IT_0211 + 6*conj(IT_0062)*(IT_0048*IT_0062 +
       IT_0042*IT_0064 + 0.166666666666667*IT_0166*IT_0198 + IT_0179*IT_0212) +
      ...
      *IT_0179*IT_0184 + IT_0162*IT_0192 + 0.166666666666667*IT_0185*IT_0198 +
       IT_0205*IT_0212 + IT_0197*IT_0214) + IT_0215*(IT_0048*IT_0163 + IT_0162
      *IT_0164 + IT_0139*IT_0166 + IT_0216) + 6*conj(IT_0163)*(IT_0162*IT_0164 +
       IT_0105*IT_0165 + IT_0140*IT_0166 + IT_0048*IT_0192 + 0.166666666666667
