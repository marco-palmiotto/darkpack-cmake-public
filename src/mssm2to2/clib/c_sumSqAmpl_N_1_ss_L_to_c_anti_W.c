...
ccomplex_return_t c_sumSqAmpl_N_1_ss_L_to_c_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_W1*e_em*conj(V_Wp2);
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = N_u1*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0004;
    const ccomplex_t IT_0021 = -IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0023 = (-0.5)*IT_0022;
    const ccomplex_t IT_0024 = pow(m_N_1, 2);
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0015 + IT_0024 + -m_sc_L*
    ...
    const ccomplex_t IT_0031 = N_W1*e_em*conj(V_Wp1);
    const ccomplex_t IT_0032 = IT_0004*IT_0031;
    const ccomplex_t IT_0033 = N_u1*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0063 = m_c*m_N_1;
    ...
    const ccomplex_t IT_0082 = conj(N_W1)*e_em*U_Wm1;
    const ccomplex_t IT_0083 = IT_0004*IT_0082;
    const ccomplex_t IT_0084 = conj(N_d1)*U_d1*e_em;
    ...
    const ccomplex_t IT_0090 = IT_0039*IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0004;
    const ccomplex_t IT_0093 = conj(N_W1)*e_em*U_Wm2;
    const ccomplex_t IT_0094 = IT_0004*IT_0093;
    const ccomplex_t IT_0095 = conj(N_d1)*U_d2*e_em;
    ...
    const ccomplex_t IT_0124 = IT_0006*IT_0099;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0126 = IT_0017*IT_0124*IT_0125;
    const ccomplex_t IT_0127 = IT_0030*IT_0088;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0129 = IT_0039*IT_0127*IT_0128;
    const ccomplex_t IT_0130 = IT_0126 + IT_0129;
    const ccomplex_t IT_0131 = m_c*IT_0077;
    const ccomplex_t IT_0132 = m_N_1*IT_0019;
    const ccomplex_t IT_0133 = m_N_1*IT_0041;
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0000*IT_0004*IT_0144;
    const ccomplex_t IT_0146 = (-0.5)*IT_0145;
    const ccomplex_t IT_0147 = IT_0074*IT_0146;
    const ccomplex_t IT_0148 = IT_0071*IT_0142*IT_0147;
    const ccomplex_t IT_0149 = IT_0013*IT_0092;
    const ccomplex_t IT_0150 = IT_0017*IT_0125*IT_0149;
    const ccomplex_t IT_0151 = IT_0037*IT_0081;
    const ccomplex_t IT_0152 = IT_0039*IT_0128*IT_0151;
    const ccomplex_t IT_0153 = -IT_0148 + -IT_0150 + -IT_0152;
    const ccomplex_t IT_0154 = IT_0091 + IT_0102;
    ...
    const ccomplex_t IT_0159 = IT_0114 + IT_0158;
    const ccomplex_t IT_0160 = (-0.25)*IT_0137;
    const ccomplex_t IT_0161 = s_14 + IT_0160;
    const ccomplex_t IT_0162 = m_c*IT_0161;
    const ccomplex_t IT_0163 = (-4)*IT_0162;
    const ccomplex_t IT_0164 = 2*IT_0091 + 2*IT_0102;
    ...
    const ccomplex_t IT_0172 = IT_0061 + 2*IT_0077;
    const ccomplex_t IT_0173 = (-6)*IT_0172;
    const ccomplex_t IT_0174 = pow(s_34, 2);
    const ccomplex_t IT_0175 = IT_0043*IT_0174;
    const ccomplex_t IT_0176 = -IT_0175;
    const ccomplex_t IT_0177 = IT_0015 + IT_0176;
    const ccomplex_t IT_0178 = m_N_1*IT_0177;
    const ccomplex_t IT_0179 = s_14*s_34*IT_0043;
    const ccomplex_t IT_0180 = -IT_0179;
    const ccomplex_t IT_0181 = s_13 + IT_0180;
    const ccomplex_t IT_0182 = m_c*IT_0181;
    const ccomplex_t IT_0183 = IT_0077 + IT_0103;
    const ccomplex_t IT_0184 = (-6)*conj(IT_0172);
    const ccomplex_t IT_0185 = s_13*IT_0181;
    const ccomplex_t IT_0186 = IT_0063*IT_0181;
    const ccomplex_t IT_0187 = m_N_1*IT_0181;
    const ccomplex_t IT_0188 = (-6)*conj(IT_0042);
    const ccomplex_t IT_0189 = (-2)*IT_0113;
    const ccomplex_t IT_0190 = IT_0115 + IT_0189;
    const ccomplex_t IT_0191 = IT_0043*IT_0190;
    const ccomplex_t IT_0192 = (-6)*IT_0191;
    const ccomplex_t IT_0193 = 12*s_13;
    const ccomplex_t IT_0194 = IT_0192 + IT_0193;
    const ccomplex_t IT_0195 = (-6)*IT_0105;
    const ccomplex_t IT_0196 = IT_0063*IT_0177;
    const ccomplex_t IT_0197 = (-6)*conj(IT_0105);
    ...
    const ccomplex_t IT_0199 = (-6)*conj(IT_0103)*(IT_0065*IT_0104 + (
      ...
      -0.166666666666667)*IT_0077*IT_0159 + -IT_0069*IT_0167 + (
      -0.166666666666667)*IT_0109*IT_0173 + IT_0123*(IT_0155 + (
      -0.166666666666667)*IT_0198));
    const ccomplex_t IT_0200 = (-6)*conj(IT_0153);
    const ccomplex_t IT_0201 = (-6)*conj(IT_0164);
    ...
    const ccomplex_t IT_0207 = (-6)*IT_0164;
    const ccomplex_t IT_0208 = (-6)*IT_0103;
    const ccomplex_t IT_0209 = IT_0063*((-18)*IT_0153 + (-18)*IT_0155) +
       IT_0173*IT_0182 + IT_0135*IT_0194 + IT_0178*IT_0195 + IT_0187*IT_0204 +
       IT_0123*IT_0205 + IT_0163*IT_0206 + IT_0203*(IT_0062 + 0.166666666666667
      *IT_0207) + IT_0141*IT_0208;
    const ccomplex_t IT_0210 = IT_0063*((-18)*IT_0130 + (-18)*IT_0134) +
       IT_0173*IT_0178 + 6*IT_0167*IT_0187 + IT_0156*IT_0194 + IT_0182*IT_0195 +
       6*IT_0042*IT_0202 + IT_0141*IT_0205 + IT_0171*IT_0206 + IT_0123*IT_0208;
    const ccomplex_t IT_0211 = 0.166666666666667*IT_0186;
    const ccomplex_t IT_0212 = s_13*IT_0177;
    const ccomplex_t IT_0213 = 0.166666666666667*IT_0212;
    const ccomplex_t IT_0214 = (-6)*conj(IT_0062);
    const ccomplex_t IT_0215 = IT_0172*IT_0185;
    const ccomplex_t IT_0216 = 6*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      ...
      *IT_0117 + IT_0123*IT_0135 + IT_0141*IT_0156) + IT_0063*IT_0135*IT_0157 +
       6*conj(IT_0077)*(IT_0065*IT_0080 + 0.166666666666667*IT_0077*IT_0117 +
       0.166666666666667*IT_0103*IT_0159 + IT_0135*IT_0163 + IT_0069*IT_0167 +
       IT_0156*IT_0171 + 0.166666666666667*IT_0109*IT_0173) + (IT_0155*IT_0178 +
       IT_0135*IT_0182 + IT_0109*IT_0183)*IT_0184 + (IT_0064*IT_0164 + IT_0105
      *IT_0185 + IT_0172*IT_0186 + IT_0135*IT_0187)*IT_0188 + 6*conj(IT_0153)*
      (IT_0065*IT_0141 + IT_0077*IT_0171 + IT_0164*IT_0187 + 0.166666666666667
      *IT_0156*IT_0194 + 0.166666666666667*IT_0182*IT_0195) + (IT_0135*IT_0178 +
       IT_0156*IT_0182 + IT_0062*IT_0186 + IT_0172*IT_0196)*IT_0197 + IT_0199 + 
      (IT_0103*IT_0123 + IT_0172*IT_0178 + IT_0062*IT_0187)*IT_0200 + (IT_0042
      *conj(IT_0153) + conj(IT_0042)*IT_0156 + IT_0135*(conj(IT_0062) +
       0.166666666666667*IT_0201))*IT_0203 + (conj(IT_0130) + conj(IT_0134))
      *IT_0209 + conj(IT_0155)*IT_0210 + 6*conj(IT_0062)*(IT_0048*IT_0062 +
       IT_0042*IT_0064 + 0.166666666666667*IT_0187*IT_0198 + IT_0195*IT_0211) +
       6*conj(IT_0172)*(IT_0167*IT_0185 + 0.166666666666667*IT_0195*IT_0196 +
       0.166666666666667*IT_0178*IT_0198 + IT_0204*IT_0211 + IT_0173*IT_0213) +
       6*conj(IT_0105)*(IT_0065*IT_0109 + IT_0164*IT_0186 + 0.166666666666667
      *IT_0185*IT_0204 + IT_0195*IT_0213) + IT_0214*(IT_0048*IT_0164 + IT_0069
      *IT_0183 + IT_0155*IT_0187 + IT_0215) + 6*conj(IT_0164)*(IT_0048*IT_0167 +
       IT_0069*IT_0183 + IT_0105*IT_0186 + IT_0156*IT_0187 + 0.166666666666667
      *IT_0064*IT_0204 + IT_0215);
