...
ccomplex_return_t c_sumSqAmpl_N_1_ss_L_to_s_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_L*
    ...
    const ccomplex_t IT_0035 = IT_0005*IT_0031;
    ...
    const ccomplex_t IT_0054 = IT_0001*IT_0044;
    const ccomplex_t IT_0055 = pow(s_13, 2);
    const ccomplex_t IT_0056 = (-6)*IT_0055;
    const ccomplex_t IT_0057 = -IT_0034;
    const ccomplex_t IT_0058 = m_s*m_N_1;
    ...
    const ccomplex_t IT_0063 = m_s*s_34*m_N_1;
    ...
    const ccomplex_t IT_0072 = s_13*(IT_0021*conj(IT_0021) + IT_0038*conj
      ...
      (IT_0037*IT_0046 + (-0.166666666666667)*IT_0047*IT_0052 + (
      ...
      *IT_0057 + (-6)*(IT_0046*IT_0047 + (-0.166666666666667)*IT_0037*IT_0052 + 
      ...
      *IT_0062 + IT_0047*(IT_0064*IT_0065 + IT_0063*IT_0066) + IT_0037*(IT_0063
      *IT_0064 + IT_0065*IT_0066) + (-6)*conj(IT_0047)*((-0.166666666666667)
      *IT_0020*IT_0052 + IT_0046*IT_0057 + (-4)*IT_0047*IT_0067 + IT_0069
      *IT_0070 + IT_0068*IT_0071) + (-6)*conj(IT_0037)*(IT_0020*IT_0046 + (
      -0.166666666666667)*IT_0052*IT_0057 + (-4)*IT_0037*IT_0067 + IT_0068
