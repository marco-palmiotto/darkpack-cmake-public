...
ccomplex_return_t c_sumSqAmpl_N_1_ss_L_to_s_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = pow(m_N_1, 2);
    ...
    const ccomplex_t IT_0046 = conj(N_W1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0062 = N_B1*N_u2*e_em;
    ...
    const ccomplex_t IT_0068 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0076 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0077 = IT_0034*IT_0076;
    const ccomplex_t IT_0078 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0079 = IT_0037*IT_0078;
    const ccomplex_t IT_0080 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0081 = IT_0028*IT_0080;
    const ccomplex_t IT_0082 = conj(N_B2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0001*IT_0002*IT_0021;
    const ccomplex_t IT_0092 = (-0.5)*IT_0091;
    const ccomplex_t IT_0093 = cpow((-2)*s_23 + IT_0015 + IT_0024 + -m_N_2*
    ...
    const ccomplex_t IT_0105 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0106 = IT_0028*IT_0105;
    const ccomplex_t IT_0107 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0108 = IT_0031*IT_0107;
    const ccomplex_t IT_0109 = N_W1*N_u3*e_em;
    const ccomplex_t IT_0110 = IT_0034*IT_0109;
    const ccomplex_t IT_0111 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0117 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0129 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0001*IT_0002*IT_0021;
    const ccomplex_t IT_0135 = (-0.5)*IT_0134;
    const ccomplex_t IT_0136 = cpow((-2)*s_23 + IT_0015 + IT_0024 + -m_N_3*
    ...
    const ccomplex_t IT_0142 = cpow((-2)*s_23 + IT_0015 + IT_0024 + -m_N_4*
    ...
    const ccomplex_t IT_0153 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0154 = IT_0028*IT_0153;
    const ccomplex_t IT_0155 = N_B1*N_d4*e_em;
    ...
    const ccomplex_t IT_0163 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0164 = IT_0028*IT_0163;
    const ccomplex_t IT_0165 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0166 = IT_0031*IT_0165;
    const ccomplex_t IT_0167 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0168 = IT_0034*IT_0167;
    const ccomplex_t IT_0169 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0170 = IT_0037*IT_0169;
    const ccomplex_t IT_0171 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0172 = IT_0028*IT_0171;
    const ccomplex_t IT_0173 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0185 = IT_0144*IT_0179;
    const ccomplex_t IT_0186 = cpow((-2)*s_12 + IT_0015 + -IT_0016 + -IT_0024 
      + -reg_prop, -1);
    const ccomplex_t IT_0187 = m_s*e_em*IT_0001*IT_0002*IT_0005*IT_0021;
    ...
    const ccomplex_t IT_0200 = IT_0088*IT_0095;
    const ccomplex_t IT_0201 = IT_0131*IT_0138;
    const ccomplex_t IT_0202 = IT_0027*IT_0050;
    const ccomplex_t IT_0203 = -IT_0185 + -IT_0199 + -IT_0200 + -IT_0201 + 
      -IT_0202;
    const ccomplex_t IT_0204 = m_s*s_14;
    ...
    const ccomplex_t IT_0213 = IT_0136*IT_0212;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*IT_0213;
    const ccomplex_t IT_0215 = IT_0113*IT_0214;
    ...
    const ccomplex_t IT_0226 = IT_0161*IT_0225;
    const ccomplex_t IT_0227 = IT_0023*IT_0188;
    const ccomplex_t IT_0228 = IT_0186*IT_0227;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = IT_0025*IT_0196;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1)*IT_0230;
    const ccomplex_t IT_0232 = IT_0040*IT_0231;
    ...
    const ccomplex_t IT_0241 = IT_0093*IT_0240;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = IT_0070*IT_0242;
    const ccomplex_t IT_0244 = IT_0215 + IT_0226 + -IT_0229 + IT_0232 + IT_0243;
    const ccomplex_t IT_0245 = s_34*m_N_1;
    ...
    const ccomplex_t IT_0249 = IT_0017*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*IT_0249;
    const ccomplex_t IT_0251 = m_N_1*IT_0070;
    const ccomplex_t IT_0252 = m_N_2*IT_0088;
    const ccomplex_t IT_0253 = IT_0251 + IT_0252;
    const ccomplex_t IT_0254 = IT_0242*IT_0253;
    const ccomplex_t IT_0255 = m_N_1*IT_0113;
    const ccomplex_t IT_0256 = m_N_3*IT_0131;
    const ccomplex_t IT_0257 = IT_0255 + IT_0256;
    const ccomplex_t IT_0258 = IT_0214*IT_0257;
    const ccomplex_t IT_0259 = m_N_1*IT_0161;
    const ccomplex_t IT_0260 = m_N_4*IT_0179;
    const ccomplex_t IT_0261 = IT_0259 + IT_0260;
    const ccomplex_t IT_0262 = IT_0225*IT_0261;
    const ccomplex_t IT_0263 = IT_0052*IT_0231;
    const ccomplex_t IT_0264 = -IT_0250 + -IT_0254 + -IT_0258 + -IT_0262 + 
      -IT_0263;
    const ccomplex_t IT_0265 = 6*conj(IT_0264);
    const ccomplex_t IT_0266 = m_s*m_N_1;
    const ccomplex_t IT_0267 = 6*IT_0183;
    const ccomplex_t IT_0268 = 6*conj(IT_0183);
    const ccomplex_t IT_0269 = pow(m_A0, 2);
    const ccomplex_t IT_0270 = m_s*m_N_1*IT_0269;
    ...
    const ccomplex_t IT_0275 = 6*IT_0264;
    const ccomplex_t IT_0276 = 0.166666666666667*IT_0245;
    const ccomplex_t IT_0277 = IT_0183*conj(IT_0183)*IT_0184 + (IT_0203
      *IT_0204 + IT_0244*IT_0245)*IT_0265 + conj(IT_0264)*(IT_0184*IT_0264 +
       IT_0266*IT_0267) + (IT_0204*IT_0244 + IT_0203*IT_0245 + IT_0264*IT_0266)
      *IT_0268 + 6*conj(IT_0203)*(IT_0244*IT_0270 + -IT_0203*IT_0274 +
       0.166666666666667*IT_0204*IT_0275 + IT_0267*IT_0276) + 6*conj(IT_0244)*
      (0.166666666666667*IT_0204*IT_0267 + IT_0203*IT_0270 + -IT_0244*IT_0274 +
       IT_0275*IT_0276);
