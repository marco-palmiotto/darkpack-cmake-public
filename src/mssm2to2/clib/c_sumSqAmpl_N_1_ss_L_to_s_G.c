...
ccomplex_return_t c_sumSqAmpl_N_1_ss_L_to_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_ss_L*
    ...
    const ccomplex_t IT_0034 = IT_0004*IT_0030;
    ...
    const ccomplex_t IT_0042 = IT_0032*IT_0039;
    const ccomplex_t IT_0043 = (-8)*s_13;
    const ccomplex_t IT_0044 = s_34*IT_0043;
    const ccomplex_t IT_0045 = m_s*s_14*m_N_1;
    const ccomplex_t IT_0046 = -IT_0014;
    const ccomplex_t IT_0047 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0056 = -IT_0033;
    const ccomplex_t IT_0057 = m_s*m_N_1;
    ...
    const ccomplex_t IT_0062 = m_s*s_34*m_N_1;
    ...
    const ccomplex_t IT_0071 = s_13*(IT_0020*conj(IT_0020) + IT_0037*conj
      ...
      (IT_0036*IT_0045 + (-0.125)*IT_0046*IT_0051 + (-0.125)*IT_0041*IT_0052 + (
      -0.125)*IT_0019*IT_0053 + (-0.125)*IT_0020*IT_0055) + IT_0019*(conj
      (IT_0041)*IT_0052 + conj(IT_0020)*IT_0055) + (conj(IT_0042)*IT_0052 + conj
      (IT_0037)*IT_0055)*IT_0056 + (-8)*(IT_0045*IT_0046 + (-0.125)*IT_0036
      *IT_0051 + (-0.125)*IT_0042*IT_0052 + (-0.125)*IT_0037*IT_0055 + (-0.125)
      *IT_0053*IT_0056)*conj(IT_0056) + IT_0057*IT_0061 + IT_0046*(IT_0063
      *IT_0064 + IT_0062*IT_0065) + IT_0036*(IT_0062*IT_0063 + IT_0064*IT_0065) 
      + (-8)*conj(IT_0046)*((-0.125)*IT_0019*IT_0051 + IT_0045*IT_0056 + (-4)
      *IT_0046*IT_0066 + IT_0068*IT_0069 + IT_0067*IT_0070) + (-8)*conj(IT_0036)
      *(IT_0019*IT_0045 + (-0.125)*IT_0051*IT_0056 + (-4)*IT_0036*IT_0066 +
