        ...
        )
{
    ...
    const ccomplex_t IT_0025 = N_u1*conj(N_u3)*e_em;
    const ccomplex_t IT_0026 = IT_0003*IT_0025;
    const ccomplex_t IT_0027 = IT_0007*IT_0025;
    const ccomplex_t IT_0028 = N_d1*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0019 + IT_0020 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = IT_0046*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0002 + 3
      *IT_0000*IT_0006);
    const ccomplex_t IT_0054 = 0.333333333333333*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0006*IT_0014*IT_0016;
    const ccomplex_t IT_0056 = (-0.5)*IT_0055;
    const ccomplex_t IT_0057 = pow(m_N_1, 2);
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0019 + IT_0057 + -m_ss_L*
    ...
    const ccomplex_t IT_0076 = 2*IT_0024 + 2*IT_0038 + 2*IT_0052 + IT_0061 +
       IT_0073 + -IT_0075;
    ...
    const ccomplex_t IT_0113 = IT_0070*IT_0090;
    ...
    const ccomplex_t IT_0155 = -IT_0093 + (-2)*IT_0112 + IT_0115 + -IT_0116 + 
      (-2)*IT_0135 + (-2)*IT_0154;
    const ccomplex_t IT_0156 = m_s*m_N_1;
    const ccomplex_t IT_0157 = IT_0081*IT_0156;
    const ccomplex_t IT_0158 = -IT_0024 + -IT_0038 + -IT_0052 + (-0.5)*IT_0073
       + 0.5*IT_0075;
    const ccomplex_t IT_0159 = s_13*s_14;
    const ccomplex_t IT_0160 = s_34*IT_0057;
    const ccomplex_t IT_0161 = -IT_0160;
    const ccomplex_t IT_0162 = IT_0159 + IT_0161;
    const ccomplex_t IT_0163 = m_s*IT_0081;
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_12 + IT_0019 + -IT_0020 + -IT_0057 
      + -reg_prop, -1);
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0174 = IT_0171*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = m_N_1*IT_0069;
    const ccomplex_t IT_0176 = IT_0114*IT_0175;
    const ccomplex_t IT_0177 = -IT_0164;
    const ccomplex_t IT_0178 = IT_0175 + IT_0177;
    const ccomplex_t IT_0179 = IT_0114*IT_0178;
    const ccomplex_t IT_0180 = m_N_2*IT_0013;
    const ccomplex_t IT_0181 = m_N_1*IT_0124;
    const ccomplex_t IT_0182 = -IT_0181;
    const ccomplex_t IT_0183 = IT_0180 + IT_0182;
    const ccomplex_t IT_0184 = IT_0134*IT_0183;
    const ccomplex_t IT_0185 = m_N_3*IT_0032;
    ...
    const ccomplex_t IT_0190 = m_N_4*IT_0046;
    ...
    const ccomplex_t IT_0197 = IT_0056*IT_0196;
    ...
    const ccomplex_t IT_0201 = -IT_0174 + (-0.5)*IT_0176 + (-0.5)*IT_0179 + 
      -IT_0184 + -IT_0189 + -IT_0194 + IT_0200;
    const ccomplex_t IT_0202 = IT_0166 + IT_0201;
    const ccomplex_t IT_0203 = IT_0090*IT_0196;
    const ccomplex_t IT_0204 = IT_0172*IT_0173*IT_0203;
    const ccomplex_t IT_0205 = IT_0072*IT_0164;
    const ccomplex_t IT_0206 = IT_0072*IT_0178;
    const ccomplex_t IT_0207 = m_N_4*IT_0143;
    const ccomplex_t IT_0208 = m_N_1*IT_0046;
    const ccomplex_t IT_0209 = -IT_0208;
    const ccomplex_t IT_0210 = IT_0207 + IT_0209;
    const ccomplex_t IT_0211 = IT_0051*IT_0210;
    const ccomplex_t IT_0212 = IT_0090*IT_0170;
    ...
    const ccomplex_t IT_0236 = IT_0093 + 2*IT_0214;
    ...
    const ccomplex_t IT_0251 = m_s*IT_0250;
    const ccomplex_t IT_0252 = 2*IT_0251;
    const ccomplex_t IT_0253 = IT_0112 + (-0.5)*IT_0115 + 0.5*IT_0116 +
       IT_0135 + IT_0154;
    ...
    const ccomplex_t IT_0272 = m_s*IT_0234;
    ...
    const ccomplex_t IT_0289 = 6*IT_0238;
    const ccomplex_t IT_0290 = 6*IT_0158;
    const ccomplex_t IT_0291 = 6*IT_0253;
    const ccomplex_t IT_0292 = 6*IT_0214;
    const ccomplex_t IT_0293 = 6*IT_0155*IT_0163 + IT_0156*((-18)*IT_0166 + (
      -18)*IT_0201) + IT_0229*IT_0271 + IT_0273*IT_0283 + IT_0239*IT_0287 +
       IT_0272*IT_0288 + IT_0263*IT_0289 + IT_0259*IT_0290 + IT_0252*IT_0291 +
       IT_0248*IT_0292;
    const ccomplex_t IT_0294 = (-6)*IT_0155;
    const ccomplex_t IT_0295 = 6*IT_0076*IT_0163 + IT_0156*((-18)*IT_0226 + (
      -18)*IT_0228) + IT_0202*IT_0271 + IT_0272*IT_0273 + IT_0283*IT_0288 +
       IT_0248*IT_0289 + IT_0252*IT_0290 + IT_0259*IT_0291 + IT_0263*IT_0292 +
       IT_0239*IT_0294;
    const ccomplex_t IT_0296 = IT_0156*IT_0242;
    const ccomplex_t IT_0297 = (-3)*IT_0296;
    const ccomplex_t IT_0298 = 3*IT_0296;
    const ccomplex_t IT_0299 = pow(m_Z, 4);
    const ccomplex_t IT_0300 = s_13*IT_0299;
    const ccomplex_t IT_0301 = IT_0077*IT_0300;
    const ccomplex_t IT_0302 = (-24)*IT_0265;
    const ccomplex_t IT_0303 = 6*IT_0301 + IT_0302;
    const ccomplex_t IT_0304 = 0.166666666666667*IT_0238;
    const ccomplex_t IT_0305 = 24*IT_0265;
    const ccomplex_t IT_0306 = (-12)*IT_0264;
    const ccomplex_t IT_0307 = 6*IT_0301 + IT_0305 + IT_0306;
    const ccomplex_t IT_0308 = 0.166666666666667*IT_0158;
    const ccomplex_t IT_0309 = 0.166666666666667*IT_0253;
    const ccomplex_t IT_0310 = 0.166666666666667*IT_0214;
    const ccomplex_t IT_0311 = (-6)*IT_0201;
    const ccomplex_t IT_0312 = 0.166666666666667*IT_0237;
    const ccomplex_t IT_0313 = 0.166666666666667*IT_0235;
    const ccomplex_t IT_0314 = s_13*IT_0277;
    const ccomplex_t IT_0315 = 0.166666666666667*IT_0314;
    const ccomplex_t IT_0316 = 0.166666666666667*IT_0162;
    const ccomplex_t IT_0317 = 0.166666666666667*IT_0282;
    const ccomplex_t IT_0318 = 6*conj(IT_0076)*(IT_0076*IT_0082 + IT_0155
      ...
      *IT_0240 + (IT_0162*IT_0214 + IT_0235*IT_0236 + IT_0166*IT_0239)*IT_0241 +
       6*conj(IT_0201)*(IT_0076*IT_0163 + IT_0238*IT_0248 + IT_0158*IT_0252 +
       IT_0253*IT_0259 + IT_0214*IT_0263 + 0.166666666666667*IT_0202*IT_0271 +
      ...
      *IT_0272 + IT_0214*IT_0282 + IT_0166*IT_0283)*IT_0285 + (IT_0155*IT_0239 +
       IT_0236*IT_0283)*IT_0286 + (conj(IT_0226) + conj(IT_0228))*IT_0293 + conj
      (IT_0166)*IT_0295 + 6*conj(IT_0158)*(IT_0076*IT_0162 + IT_0202*IT_0252 +
       IT_0229*IT_0259 + IT_0231*IT_0282 + IT_0253*IT_0297 + IT_0214*IT_0298 +
       IT_0303*IT_0304 + IT_0307*IT_0308) + 6*conj(IT_0253)*(IT_0155*IT_0162 +
       IT_0229*IT_0252 + IT_0202*IT_0259 + IT_0236*IT_0282 + IT_0158*IT_0297 +
       IT_0238*IT_0298 + IT_0307*IT_0309 + IT_0303*IT_0310) + 6*conj(IT_0155)*
      (IT_0082*IT_0155 + IT_0076*IT_0157 + IT_0163*IT_0229 + IT_0162*IT_0253 +
       0.166666666666667*IT_0239*IT_0311 + IT_0273*IT_0312) + 6*conj(IT_0231)*
      (IT_0158*IT_0282 + IT_0287*IT_0313 + IT_0273*IT_0315) + 6*conj(IT_0236)*
      (0.166666666666667*IT_0273*IT_0278 + IT_0253*IT_0282 + 0.166666666666667
      *IT_0283*IT_0311 + IT_0287*IT_0312 + IT_0294*IT_0313 + IT_0288*IT_0315) +
       6*conj(IT_0238)*(IT_0202*IT_0248 + IT_0229*IT_0263 + IT_0214*IT_0297 +
       IT_0253*IT_0298 + IT_0304*IT_0307 + IT_0303*IT_0308 + IT_0287*IT_0316 +
       IT_0273*IT_0317) + 6*conj(IT_0214)*(IT_0229*IT_0248 + IT_0202*IT_0263 +
       IT_0238*IT_0297 + IT_0158*IT_0298 + IT_0303*IT_0309 + IT_0307*IT_0310 +
       IT_0294*IT_0316 + IT_0288*IT_0317);
    return create_ccomplex_return(IT_0318);
}
