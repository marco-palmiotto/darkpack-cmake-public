        ...
        )
{
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0012*IT_0033*IT_0035;
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = pow(m_s, 2);
    const ccomplex_t IT_0039 = pow(m_ss_L, 2);
    ...
    const ccomplex_t IT_0075 = conj(N_W1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0079 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0012*IT_0033*IT_0035;
    const ccomplex_t IT_0090 = (-0.5)*IT_0089;
    const ccomplex_t IT_0091 = cpow((-2)*s_23 + IT_0038 + IT_0039 + -m_N_4*
    ...
    const ccomplex_t IT_0095 = pow(m_N_1, 2);
    const ccomplex_t IT_0096 = cpow((-2)*s_12 + IT_0038 + -IT_0039 + -IT_0095 
      + -reg_prop, -1);
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*m_s*e_em*IT_0007*IT_0012
      *IT_0033*IT_0035;
    ...
    const ccomplex_t IT_0102 = m_s*IT_0101;
    const ccomplex_t IT_0103 = cpow((-2)*s_13 + IT_0038 + IT_0095 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0007 + m_s*e_em*mu_h*IT_0001*IT_0012*IT_0033*IT_0035);
    const ccomplex_t IT_0105 = 0.5*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0003;
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0038 + IT_0095 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0112 = sin(beta);
    const ccomplex_t IT_0113 = cpow(IT_0002, -2);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*e_em*(IT_0007*IT_0012
      *IT_0033*IT_0035*IT_0038 + (-0.5)*m_W*(IT_0007*IT_0034 + IT_0001*IT_0112)*
      (IT_0012 + 1./3*IT_0011*IT_0113));
    ...
    const ccomplex_t IT_0127 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0128 = IT_0013*IT_0127;
    const ccomplex_t IT_0129 = N_W2*N_d1*e_em;
    ...
    const ccomplex_t IT_0144 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0145 = IT_0004*IT_0144;
    const ccomplex_t IT_0146 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0147 = IT_0008*IT_0146;
    const ccomplex_t IT_0148 = IT_0141 + IT_0143 + IT_0145 + IT_0147;
    const ccomplex_t IT_0149 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0150 = IT_0013*IT_0149;
    const ccomplex_t IT_0151 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0152 = IT_0016*IT_0151;
    const ccomplex_t IT_0153 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0154 = IT_0013*IT_0153;
    const ccomplex_t IT_0155 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0163 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0012*IT_0033*IT_0035;
    const ccomplex_t IT_0164 = (-0.5)*IT_0163;
    const ccomplex_t IT_0165 = cpow((-2)*s_23 + IT_0038 + IT_0039 + -m_N_2*
    ...
    const ccomplex_t IT_0191 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0192 = IT_0004*IT_0191;
    const ccomplex_t IT_0193 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0194 = IT_0008*IT_0193;
    const ccomplex_t IT_0195 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0196 = IT_0004*IT_0195;
    const ccomplex_t IT_0197 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0198 = IT_0008*IT_0197;
    const ccomplex_t IT_0199 = IT_0192 + IT_0194 + IT_0196 + IT_0198;
    const ccomplex_t IT_0200 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0201 = IT_0013*IT_0200;
    const ccomplex_t IT_0202 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0203 = IT_0016*IT_0202;
    const ccomplex_t IT_0204 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0205 = IT_0013*IT_0204;
    const ccomplex_t IT_0206 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0214 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0012*IT_0033*IT_0035;
    const ccomplex_t IT_0215 = (-0.5)*IT_0214;
    const ccomplex_t IT_0216 = cpow((-2)*s_23 + IT_0038 + IT_0039 + -m_N_3*
    ...
    const ccomplex_t IT_0220 = IT_0043 + IT_0094 + (-2)*IT_0102 + IT_0110 +
    ...
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*(IT_0223 + (-3)*IT_0226);
    const ccomplex_t IT_0228 = 0.166666666666667*IT_0227;
    const ccomplex_t IT_0229 = IT_0114*IT_0228;
    const ccomplex_t IT_0230 = IT_0111*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1)*IT_0230;
    const ccomplex_t IT_0232 = m_N_1*IT_0189;
    const ccomplex_t IT_0233 = m_N_3*IT_0211;
    const ccomplex_t IT_0234 = IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = conj(N_B3)*e_em;
    const ccomplex_t IT_0236 = IT_0003*IT_0235;
    const ccomplex_t IT_0237 = 1.4142135623731*IT_0236;
    const ccomplex_t IT_0238 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0246 = IT_0098*IT_0228;
    const ccomplex_t IT_0247 = IT_0096*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = m_s*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0012*IT_0033*IT_0035;
    const ccomplex_t IT_0251 = 0.5*IT_0250;
    const ccomplex_t IT_0252 = IT_0105*IT_0251;
    const ccomplex_t IT_0253 = IT_0103*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = IT_0040*IT_0228;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0032*IT_0256;
    const ccomplex_t IT_0258 = m_N_1*IT_0138;
    const ccomplex_t IT_0259 = m_N_2*IT_0160;
    ...
    const ccomplex_t IT_0272 = m_N_4*IT_0086;
    const ccomplex_t IT_0273 = m_N_1*IT_0064;
    ...
    const ccomplex_t IT_0286 = -IT_0231 + -IT_0245 + 2*IT_0249 + -IT_0254 + 
    ...
    const ccomplex_t IT_0290 = IT_0064*IT_0284;
    const ccomplex_t IT_0291 = IT_0030*IT_0256;
    const ccomplex_t IT_0292 = IT_0138*IT_0270;
    const ccomplex_t IT_0293 = IT_0189*IT_0244;
    const ccomplex_t IT_0294 = -IT_0101 + IT_0290 + IT_0291 + IT_0292 + IT_0293;
    const ccomplex_t IT_0295 = m_s*s_14;
    const ccomplex_t IT_0296 = IT_0211*IT_0218;
    const ccomplex_t IT_0297 = IT_0019*IT_0042;
    const ccomplex_t IT_0298 = IT_0086*IT_0093;
    const ccomplex_t IT_0299 = IT_0160*IT_0167;
    const ccomplex_t IT_0300 = IT_0248 + -IT_0296 + -IT_0297 + -IT_0298 + 
      -IT_0299;
