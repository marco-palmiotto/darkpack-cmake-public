...
ccomplex_return_t c_sumSqAmpl_N_1_ss_R_to_c_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_12 + -IT_0001 + IT_0044 + -IT_0045 
      + -reg_prop, -1);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_s;
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0004;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = IT_0051*IT_0053;
    const ccomplex_t IT_0055 = IT_0046*IT_0047*IT_0054;
    const ccomplex_t IT_0056 = N_W1*e_em*conj(V_Wp2);
    const ccomplex_t IT_0057 = IT_0004*IT_0056;
    const ccomplex_t IT_0058 = N_u1*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0065 = IT_0030*IT_0063*IT_0064;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
    ...
    const ccomplex_t IT_0090 = -IT_0019 + -IT_0032;
    const ccomplex_t IT_0091 = s_13*s_14;
    const ccomplex_t IT_0092 = s_34*IT_0045;
    const ccomplex_t IT_0093 = -IT_0092;
    const ccomplex_t IT_0094 = IT_0091 + IT_0093;
    const ccomplex_t IT_0095 = 6*conj(IT_0033);
    const ccomplex_t IT_0096 = pow(m_W, 2);
    const ccomplex_t IT_0097 = s_14*IT_0096;
    const ccomplex_t IT_0098 = IT_0067*IT_0097;
    const ccomplex_t IT_0099 = (-0.25)*IT_0098;
    const ccomplex_t IT_0100 = s_14 + IT_0099;
    const ccomplex_t IT_0101 = m_c*IT_0100;
    const ccomplex_t IT_0102 = (-4)*IT_0101;
    const ccomplex_t IT_0103 = pow(m_W, 4);
    const ccomplex_t IT_0104 = s_13*IT_0103;
    const ccomplex_t IT_0105 = IT_0067*IT_0104;
    const ccomplex_t IT_0106 = 6*IT_0105;
    const ccomplex_t IT_0107 = s_14*s_34;
    const ccomplex_t IT_0108 = 24*IT_0107;
    const ccomplex_t IT_0109 = s_13*IT_0096;
    const ccomplex_t IT_0110 = (-12)*IT_0109;
    const ccomplex_t IT_0111 = IT_0106 + IT_0108 + IT_0110;
    const ccomplex_t IT_0112 = (-6)*IT_0105;
    const ccomplex_t IT_0113 = IT_0108 + IT_0112;
    const ccomplex_t IT_0114 = s_34*IT_0096;
    ...
    const ccomplex_t IT_0120 = IT_0066 + IT_0087;
    const ccomplex_t IT_0121 = s_14*IT_0000;
    const ccomplex_t IT_0122 = s_13*s_34;
    const ccomplex_t IT_0123 = -IT_0122;
    const ccomplex_t IT_0124 = IT_0121 + IT_0123;
    const ccomplex_t IT_0125 = (-6)*IT_0088;
    ...
    const ccomplex_t IT_0131 = m_c*IT_0070;
    const ccomplex_t IT_0132 = (-6)*conj(IT_0088);
    const ccomplex_t IT_0133 = s_13*IT_0129;
    const ccomplex_t IT_0134 = (-6)*IT_0066;
    const ccomplex_t IT_0135 = 0.5*IT_0098;
    const ccomplex_t IT_0136 = s_14 + IT_0135;
    const ccomplex_t IT_0137 = m_c*IT_0136;
    const ccomplex_t IT_0138 = 2*IT_0137;
    const ccomplex_t IT_0139 = (-0.25)*IT_0115;
    const ccomplex_t IT_0140 = s_34 + IT_0139;
    const ccomplex_t IT_0141 = m_N_1*IT_0140;
    const ccomplex_t IT_0142 = (-4)*IT_0141;
    const ccomplex_t IT_0143 = (-6)*conj(IT_0066);
    const ccomplex_t IT_0144 = m_c*m_N_1;
    const ccomplex_t IT_0145 = (-2)*IT_0107;
    const ccomplex_t IT_0146 = IT_0109 + IT_0145;
    ...
    const ccomplex_t IT_0152 = (-18)*IT_0078*IT_0144;
    const ccomplex_t IT_0153 = IT_0119*IT_0151;
    const ccomplex_t IT_0154 = IT_0120*IT_0150;
    const ccomplex_t IT_0155 = 6*conj(IT_0033)*(IT_0066*IT_0071 + -IT_0078
      *IT_0083 + 0.166666666666667*IT_0084*IT_0085) + (IT_0071*IT_0087 + IT_0088
      *IT_0089 + (IT_0076 + IT_0090)*IT_0094)*IT_0095 + 6*conj(IT_0076)*
      (0.166666666666667*IT_0085*IT_0094 + IT_0078*IT_0102 + 0.166666666666667
      *IT_0076*IT_0111 + 0.166666666666667*IT_0090*IT_0113 + IT_0119*IT_0120 +
       0.166666666666667*IT_0124*IT_0125) + ((IT_0076 + IT_0090)*IT_0124 +
       IT_0087*IT_0130 + IT_0078*IT_0131)*IT_0132 + conj(IT_0088)*(IT_0085
      *IT_0089 + IT_0125*IT_0133 + IT_0130*IT_0134) + (-6)*conj(IT_0090)*((
      -0.166666666666667)*IT_0085*IT_0094 + (-0.166666666666667)*IT_0090*IT_0111
       + (-0.166666666666667)*IT_0076*IT_0113 + (-0.166666666666667)*IT_0124
      *IT_0125 + IT_0078*IT_0138 + (IT_0087 + (-0.166666666666667)*IT_0134)
      *IT_0142) + (IT_0088*IT_0130 + IT_0090*IT_0142)*IT_0143 + (-6)*conj
      (IT_0078)*(IT_0033*IT_0083 + -1./6*IT_0125*IT_0131 + IT_0090*IT_0138 + -1.
      /6*((-18)*IT_0066 + (-18)*IT_0087)*IT_0144 + -1./6*IT_0078*IT_0150 + -1./6
      *IT_0102*IT_0151) + 6*conj(IT_0066)*(IT_0033*IT_0071 + 0.166666666666667
      *IT_0152 + 0.166666666666667*IT_0153 + 0.166666666666667*IT_0154) + (-6)
      *conj(IT_0087)*((-0.166666666666667)*IT_0071*IT_0085 + (-0.166666666666667
      )*IT_0125*IT_0130 + IT_0090*IT_0142 + (-0.166666666666667)*IT_0152 + (
