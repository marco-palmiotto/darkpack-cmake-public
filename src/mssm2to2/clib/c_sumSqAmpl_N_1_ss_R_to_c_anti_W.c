        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
    ...
    const ccomplex_t IT_0021 = conj(N_W1)*e_em*U_Wm1;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(N_d1)*U_d1*e_em;
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + -IT_0001 + IT_0054 + -IT_0055 
      + -reg_prop, -1);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0004;
    ...
    const ccomplex_t IT_0142 = m_c*IT_0070;
