        ...
        )
{
    ...
    const ccomplex_t IT_0006 = m_s*e_em*mu_h*IT_0005;
    const ccomplex_t IT_0007 = IT_0004*IT_0006;
    const ccomplex_t IT_0008 = sin(beta);
    const ccomplex_t IT_0009 = A_b*V_ts*conj(V_ts);
    ...
    const ccomplex_t IT_0028 = IT_0004*IT_0013;
    const ccomplex_t IT_0029 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0043 = m_N_2*IT_0042;
    ...
    const ccomplex_t IT_0065 = pow(m_ss_R, 2);
    ...
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0021;
    ...
    const ccomplex_t IT_0199 = m_N_1*IT_0042;
    const ccomplex_t IT_0200 = m_N_2*IT_0060;
    const ccomplex_t IT_0201 = IT_0199 + IT_0200;
    const ccomplex_t IT_0202 = IT_0198*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0004*IT_0005*IT_0014;
    const ccomplex_t IT_0204 = 0.5*IT_0203;
    const ccomplex_t IT_0205 = IT_0179*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*IT_0205;
    const ccomplex_t IT_0207 = m_N_1*IT_0156;
    const ccomplex_t IT_0208 = m_N_3*IT_0174;
    const ccomplex_t IT_0209 = IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = IT_0206*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0004*IT_0005*IT_0014;
    ...
    const ccomplex_t IT_0215 = m_N_1*IT_0091;
    const ccomplex_t IT_0216 = m_N_4*IT_0109;
    const ccomplex_t IT_0217 = IT_0215 + IT_0216;
    const ccomplex_t IT_0218 = IT_0214*IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0004*IT_0005*IT_0014;
    ...
    const ccomplex_t IT_0223 = IT_0133*IT_0222;
    const ccomplex_t IT_0224 = -IT_0194 + -IT_0202 + -IT_0210 + -IT_0218 + 
      -IT_0223;
    const ccomplex_t IT_0225 = 6*s_13;
    const ccomplex_t IT_0226 = m_s*m_N_1;
    const ccomplex_t IT_0227 = 6*IT_0183;
    const ccomplex_t IT_0228 = m_s*e_em*IT_0004*IT_0005*IT_0008*IT_0014;
    const ccomplex_t IT_0229 = (-0.5)*IT_0228;
    const ccomplex_t IT_0230 = IT_0135*IT_0229;
    const ccomplex_t IT_0231 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0065 
      + -reg_prop, -1);
    const ccomplex_t IT_0232 = IT_0230*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = IT_0121*IT_0222;
    const ccomplex_t IT_0235 = IT_0042*IT_0198;
    const ccomplex_t IT_0236 = IT_0156*IT_0206;
    const ccomplex_t IT_0237 = IT_0091*IT_0214;
    const ccomplex_t IT_0238 = -IT_0233 + IT_0234 + IT_0235 + IT_0236 + IT_0237;
    const ccomplex_t IT_0239 = m_s*s_14;
    const ccomplex_t IT_0240 = IT_0074*IT_0109;
    const ccomplex_t IT_0241 = IT_0220*IT_0229;
    const ccomplex_t IT_0242 = IT_0231*IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*IT_0242;
    const ccomplex_t IT_0244 = IT_0131*IT_0138;
    const ccomplex_t IT_0245 = IT_0174*IT_0181;
    const ccomplex_t IT_0246 = IT_0060*IT_0068;
