...
ccomplex_return_t c_sumSqAmpl_N_1_ss_R_to_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
    ...
    const ccomplex_t IT_0041 = m_s*s_14*m_N_1;
    ...
    const ccomplex_t IT_0051 = m_s*m_N_1;
    ...
    const ccomplex_t IT_0056 = m_s*s_34*m_N_1;
