        ...
        )
{
    ...
    const ccomplex_t IT_0164 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_2*
    ...
    const ccomplex_t IT_0220 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
    ...
    const ccomplex_t IT_0231 = m_N_1*IT_0037;
    ...
    const ccomplex_t IT_0251 = m_N_1*IT_0193;
    const ccomplex_t IT_0252 = m_N_2*IT_0215;
    const ccomplex_t IT_0253 = IT_0251 + IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0015*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0263 = m_N_1*IT_0088;
