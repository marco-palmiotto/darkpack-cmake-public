...
ccomplex_return_t c_sumSqAmpl_N_1_ss_R_to_s_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0068*IT_0070;
    ...
    const ccomplex_t IT_0144 = pow(m_N_1, 2);
    ...
    const ccomplex_t IT_0163 = m_s*IT_0162;
    const ccomplex_t IT_0164 = m_N_1*IT_0013;
    const ccomplex_t IT_0165 = m_N_1*IT_0065;
    const ccomplex_t IT_0166 = -IT_0165;
    const ccomplex_t IT_0167 = IT_0164 + IT_0166;
    const ccomplex_t IT_0168 = IT_0074*IT_0167;
    const ccomplex_t IT_0169 = m_N_2*IT_0043;
    const ccomplex_t IT_0170 = m_N_1*IT_0083;
    const ccomplex_t IT_0171 = -IT_0170;
    const ccomplex_t IT_0172 = IT_0169 + IT_0171;
    const ccomplex_t IT_0173 = IT_0087*IT_0172;
    const ccomplex_t IT_0174 = -IT_0147 + -IT_0152 + -IT_0157 + IT_0163 + (
      -0.5)*IT_0168 + -IT_0173;
    const ccomplex_t IT_0175 = IT_0074*(IT_0164 + -IT_0165);
    ...
    const ccomplex_t IT_0179 = IT_0072*IT_0159;
    const ccomplex_t IT_0180 = IT_0145*IT_0146*IT_0179;
    const ccomplex_t IT_0181 = IT_0020*IT_0167;
    const ccomplex_t IT_0182 = m_N_2*IT_0083;
    const ccomplex_t IT_0183 = m_N_1*IT_0043;
    const ccomplex_t IT_0184 = -IT_0183;
    const ccomplex_t IT_0185 = IT_0182 + IT_0184;
    const ccomplex_t IT_0186 = IT_0048*IT_0185;
    const ccomplex_t IT_0187 = m_N_3*IT_0109;
    const ccomplex_t IT_0188 = m_N_1*IT_0057;
    const ccomplex_t IT_0189 = -IT_0188;
    const ccomplex_t IT_0190 = IT_0187 + IT_0189;
    const ccomplex_t IT_0191 = IT_0062*IT_0190;
    const ccomplex_t IT_0192 = IT_0072*IT_0142;
    const ccomplex_t IT_0193 = IT_0145*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*IT_0193;
    const ccomplex_t IT_0195 = m_s*IT_0194;
    const ccomplex_t IT_0196 = m_N_4*IT_0096;
    ...
    const ccomplex_t IT_0201 = IT_0180 + (-0.5)*IT_0181 + IT_0186 + IT_0191 + 
      -IT_0195 + IT_0200;
    const ccomplex_t IT_0202 = IT_0020*(IT_0164 + -IT_0165);
    ...
    const ccomplex_t IT_0206 = m_s*m_N_1;
    const ccomplex_t IT_0207 = pow(s_14, 2);
    const ccomplex_t IT_0208 = IT_0118*IT_0207;
    const ccomplex_t IT_0209 = -IT_0144;
    const ccomplex_t IT_0210 = IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = IT_0206*IT_0210;
    const ccomplex_t IT_0212 = -IT_0116;
    const ccomplex_t IT_0213 = 6*IT_0066;
    const ccomplex_t IT_0214 = (-0.666666666666667)*IT_0158;
    const ccomplex_t IT_0215 = cpow((-2)*s_13 + IT_0016 + IT_0144 + -m_ss_R*
    ...
    const ccomplex_t IT_0219 = IT_0021 + 2*IT_0035 + 2*IT_0049 + 2*IT_0063 +
       IT_0218;
    const ccomplex_t IT_0220 = (-6)*IT_0219;
    const ccomplex_t IT_0221 = IT_0213 + IT_0220;
    const ccomplex_t IT_0222 = 6*conj(IT_0066);
    const ccomplex_t IT_0223 = (-6)*conj(IT_0219);
    const ccomplex_t IT_0224 = IT_0222 + IT_0223;
    const ccomplex_t IT_0225 = IT_0072*IT_0215;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = IT_0214*IT_0226;
    const ccomplex_t IT_0228 = -IT_0075 + (-2)*IT_0088 + (-2)*IT_0101 + (-2)
      *IT_0114 + -IT_0227;
    const ccomplex_t IT_0229 = 6*IT_0219;
    const ccomplex_t IT_0230 = (-6)*IT_0066;
    const ccomplex_t IT_0231 = IT_0229 + IT_0230;
    const ccomplex_t IT_0232 = 6*conj(IT_0219);
    const ccomplex_t IT_0233 = (-6)*conj(IT_0066);
    const ccomplex_t IT_0234 = IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = m_s*IT_0210;
    const ccomplex_t IT_0236 = 6*IT_0228;
    const ccomplex_t IT_0237 = (-6)*IT_0212;
    const ccomplex_t IT_0238 = IT_0236 + IT_0237;
    const ccomplex_t IT_0239 = 6*conj(IT_0228);
    const ccomplex_t IT_0240 = (-6)*conj(IT_0212);
    ...
    const ccomplex_t IT_0246 = (-2)*IT_0162 + -IT_0218;
    const ccomplex_t IT_0247 = 2*IT_0194 + IT_0227;
    const ccomplex_t IT_0248 = 6*IT_0212;
    const ccomplex_t IT_0249 = (-6)*IT_0228;
    const ccomplex_t IT_0250 = IT_0248 + IT_0249;
    const ccomplex_t IT_0251 = 6*conj(IT_0212);
    const ccomplex_t IT_0252 = (-6)*conj(IT_0228);
    ...
    const ccomplex_t IT_0258 = -IT_0162;
    const ccomplex_t IT_0259 = conj(IT_0067) + conj(IT_0258);
    const ccomplex_t IT_0260 = IT_0067 + IT_0258;
    const ccomplex_t IT_0261 = conj(IT_0117) + conj(IT_0194);
    const ccomplex_t IT_0262 = IT_0117 + IT_0194;
    const ccomplex_t IT_0263 = s_34*IT_0125;
    ...
    const ccomplex_t IT_0293 = s_14*IT_0125;
    ...
    const ccomplex_t IT_0299 = IT_0125*IT_0206;
    const ccomplex_t IT_0300 = 3*IT_0299;
    const ccomplex_t IT_0301 = 6*IT_0258;
    const ccomplex_t IT_0302 = 6*conj(IT_0258);
    const ccomplex_t IT_0303 = (-18)*conj(IT_0174);
    const ccomplex_t IT_0304 = s_13*IT_0210;
    ...
    const ccomplex_t IT_0311 = (-6)*IT_0247;
    const ccomplex_t IT_0312 = IT_0206*IT_0308;
    const ccomplex_t IT_0313 = (-6)*conj(IT_0246);
    const ccomplex_t IT_0314 = IT_0206*IT_0244;
    const ccomplex_t IT_0315 = 6*IT_0246;
    const ccomplex_t IT_0316 = 6*conj(IT_0246);
    const ccomplex_t IT_0317 = m_s*IT_0244;
    ...
    const ccomplex_t IT_0323 = conj(IT_0115)*IT_0247 + IT_0115*conj(IT_0247) +
       0.166666666666667*IT_0259*IT_0310 + 0.166666666666667*IT_0261*IT_0311 +
       0.166666666666667*IT_0260*IT_0313 + 0.166666666666667*conj(IT_0064)
      *IT_0315 + 0.166666666666667*IT_0064*IT_0316 + 0.166666666666667*IT_0262
      *IT_0318;
    const ccomplex_t IT_0324 = m_N_1*IT_0308;
    const ccomplex_t IT_0325 = m_N_1*IT_0244;
    ...
    const ccomplex_t IT_0333 = (-0.166666666666667)*conj(IT_0194);
    ...
    const ccomplex_t IT_0338 = m_s*IT_0337;
    ...
    const ccomplex_t IT_0346 = (conj(IT_0064)*IT_0067 + IT_0064*conj(IT_0067) 
      ...
      *(conj(IT_0212)*IT_0221 + IT_0212*IT_0224 + conj(IT_0228)*IT_0231 +
       IT_0228*IT_0234) + IT_0235*(IT_0178*IT_0231 + IT_0177*IT_0234 + IT_0205
      *IT_0238 + IT_0204*IT_0241) + IT_0245*(IT_0224*IT_0246 + IT_0221*conj
      (IT_0246) + conj(IT_0247)*IT_0250 + IT_0247*IT_0253) + IT_0257*(conj
      (IT_0064)*IT_0231 + IT_0064*IT_0234 + conj(IT_0115)*IT_0238 + IT_0115
      *IT_0241 + IT_0221*IT_0259 + IT_0224*IT_0260 + IT_0250*IT_0261 + IT_0253
      *IT_0262) + IT_0268*(conj(IT_0115)*IT_0271 + IT_0115*IT_0274 + conj
      (IT_0064)*IT_0277 + IT_0064*IT_0280 + conj(IT_0117)*IT_0283 + IT_0117
      *IT_0286 + conj(IT_0067)*IT_0289 + IT_0067*IT_0292) + (conj(IT_0064)
      *IT_0271 + IT_0064*IT_0274 + conj(IT_0115)*IT_0277 + IT_0115*IT_0280 +
       conj(IT_0067)*IT_0283 + IT_0067*IT_0286 + conj(IT_0117)*IT_0289 + IT_0117
      *IT_0292)*IT_0298 + IT_0300*(conj(IT_0115)*IT_0301 + IT_0115*IT_0302) +
       IT_0206*(IT_0177*((-18)*conj(IT_0201) + (-18)*conj(IT_0203)) + IT_0204*((
      -18)*conj(IT_0176) + IT_0303)) + (conj(IT_0066)*IT_0221 + IT_0066*IT_0223 
      + conj(IT_0219)*IT_0229 + conj(IT_0228)*IT_0236 + conj(IT_0212)*IT_0250 +
       IT_0212*IT_0252)*IT_0304 + conj(IT_0246)*IT_0309*IT_0310 + conj(IT_0247)*
      (IT_0309*IT_0311 + IT_0310*IT_0312) + IT_0247*IT_0312*IT_0313 + IT_0314*
      (IT_0224*IT_0247 + IT_0221*conj(IT_0247) + conj(IT_0228)*IT_0310 + IT_0228
      *IT_0313 + conj(IT_0212)*IT_0315 + IT_0212*IT_0316) + IT_0317*(IT_0178
      *IT_0310 + IT_0205*IT_0311 + IT_0177*IT_0313 + IT_0204*IT_0318) + 6
      *IT_0322*IT_0323 + (conj(IT_0247)*IT_0281 + IT_0247*IT_0284 + IT_0205
      *IT_0310 + conj(IT_0176)*IT_0311 + IT_0204*IT_0313 + IT_0176*IT_0318)
      *IT_0324 + (IT_0205*IT_0221 + IT_0204*IT_0224 + conj(IT_0176)*IT_0250 +
       IT_0176*IT_0253 + conj(IT_0212)*IT_0269 + IT_0212*IT_0272 + conj(IT_0228)
      *IT_0281 + IT_0228*IT_0284)*IT_0325 + (-6)*IT_0326*((conj(IT_0064) + -conj
      (IT_0067))*IT_0117 + (IT_0064 + -IT_0067)*conj(IT_0117) + (
      -0.166666666666667)*IT_0194*IT_0302 + conj(IT_0115)*IT_0329 + IT_0115
      *IT_0332 + IT_0301*IT_0333) + (-6)*conj(IT_0194)*(IT_0300*IT_0329 + -1./6
      *IT_0117*IT_0334 + -1./6*IT_0115*IT_0335 + IT_0277*IT_0340 + IT_0271
      *IT_0345) + (-6)*IT_0194*(IT_0300*IT_0332 + IT_0132*IT_0333 + -1./6*conj
      (IT_0117)*IT_0334 + -1./6*conj(IT_0115)*IT_0335 + IT_0280*IT_0340 +
       IT_0274*IT_0345) + (-6)*conj(IT_0258)*((-0.166666666666667)*IT_0132
      *IT_0258 + IT_0117*IT_0300 + (-0.166666666666667)*IT_0067*IT_0334 + (
      -0.166666666666667)*IT_0064*IT_0335 + IT_0271*IT_0340 + IT_0277*IT_0345) +
       (-6)*IT_0258*(conj(IT_0117)*IT_0300 + (-0.166666666666667)*conj(IT_0067)
      *IT_0334 + (-0.166666666666667)*conj(IT_0064)*IT_0335 + IT_0274*IT_0340 +
       IT_0280*IT_0345);
