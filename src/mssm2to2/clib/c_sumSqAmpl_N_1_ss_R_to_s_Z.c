        ...
        )
{
    ...
    const ccomplex_t IT_0025 = N_d1*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0036 = 0.5*IT_0028;
    const ccomplex_t IT_0037 = IT_0034*IT_0036;
    const ccomplex_t IT_0038 = N_u1*conj(N_u2)*e_em;
    const ccomplex_t IT_0039 = IT_0003*IT_0038;
    const ccomplex_t IT_0040 = IT_0007*IT_0038;
    const ccomplex_t IT_0041 = N_d1*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_2*
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0158 = m_N_1*IT_0029;
    const ccomplex_t IT_0159 = IT_0115*IT_0158;
    const ccomplex_t IT_0160 = m_N_1*IT_0036;
    const ccomplex_t IT_0161 = -IT_0160;
    const ccomplex_t IT_0162 = IT_0158 + IT_0161;
    const ccomplex_t IT_0163 = IT_0115*IT_0162;
    const ccomplex_t IT_0164 = m_N_4*IT_0059;
    const ccomplex_t IT_0165 = m_N_1*IT_0103;
    const ccomplex_t IT_0166 = -IT_0165;
    const ccomplex_t IT_0167 = IT_0164 + IT_0166;
    const ccomplex_t IT_0168 = IT_0107*IT_0167;
    const ccomplex_t IT_0169 = 0.333333333333333*IT_0066;
    ...
    const ccomplex_t IT_0174 = -IT_0144 + -IT_0149 + -IT_0157 + (-0.5)*IT_0159
       + (-0.5)*IT_0163 + -IT_0168 + IT_0173;
    const ccomplex_t IT_0175 = IT_0115*IT_0160;
    const ccomplex_t IT_0176 = 0.5*IT_0175;
    const ccomplex_t IT_0177 = IT_0174 + IT_0176;
    const ccomplex_t IT_0178 = m_N_3*IT_0087;
    const ccomplex_t IT_0179 = m_N_1*IT_0013;
    const ccomplex_t IT_0180 = -IT_0179;
    const ccomplex_t IT_0181 = IT_0178 + IT_0180;
    const ccomplex_t IT_0182 = IT_0020*IT_0181;
    const ccomplex_t IT_0183 = IT_0110*IT_0169;
    const ccomplex_t IT_0184 = IT_0150*IT_0151*IT_0183;
    const ccomplex_t IT_0185 = IT_0110*IT_0155;
    const ccomplex_t IT_0186 = IT_0150*IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1)*IT_0186;
    const ccomplex_t IT_0188 = m_s*IT_0187;
    const ccomplex_t IT_0189 = IT_0034*IT_0160;
    const ccomplex_t IT_0190 = IT_0034*IT_0162;
    const ccomplex_t IT_0191 = m_N_2*IT_0125;
    const ccomplex_t IT_0192 = m_N_1*IT_0045;
    const ccomplex_t IT_0193 = -IT_0192;
    const ccomplex_t IT_0194 = IT_0191 + IT_0193;
    const ccomplex_t IT_0195 = IT_0050*IT_0194;
    const ccomplex_t IT_0196 = m_N_4*IT_0103;
    const ccomplex_t IT_0197 = m_N_1*IT_0059;
    ...
    const ccomplex_t IT_0211 = s_14*IT_0016;
    const ccomplex_t IT_0212 = s_13*s_34;
    const ccomplex_t IT_0213 = -IT_0212;
    const ccomplex_t IT_0214 = IT_0211 + IT_0213;
    const ccomplex_t IT_0215 = s_14*s_34*IT_0074;
    const ccomplex_t IT_0216 = -IT_0215;
    const ccomplex_t IT_0217 = s_13 + IT_0216;
    const ccomplex_t IT_0218 = m_s*IT_0217;
    const ccomplex_t IT_0219 = IT_0113 + 2*IT_0187;
    const ccomplex_t IT_0220 = (-6)*conj(IT_0219);
    const ccomplex_t IT_0221 = -IT_0072 + (-2)*IT_0172;
    const ccomplex_t IT_0222 = s_13*IT_0217;
    const ccomplex_t IT_0223 = IT_0132*IT_0217;
    const ccomplex_t IT_0224 = -IT_0172;
    const ccomplex_t IT_0225 = m_N_1*IT_0217;
    const ccomplex_t IT_0226 = (-6)*conj(IT_0073);
    const ccomplex_t IT_0227 = (-6)*conj(IT_0131);
    const ccomplex_t IT_0228 = pow(m_Z, 2);
    ...
    const ccomplex_t IT_0236 = s_14 + IT_0235;
    const ccomplex_t IT_0237 = m_s*IT_0236;
    const ccomplex_t IT_0238 = 2*IT_0237;
    const ccomplex_t IT_0239 = IT_0095 + IT_0108 + (-0.5)*IT_0116 + 0.5
      *IT_0117 + IT_0130;
    const ccomplex_t IT_0240 = s_34*IT_0228;
    ...
    const ccomplex_t IT_0246 = 0.5*IT_0241;
    const ccomplex_t IT_0247 = s_34 + IT_0246;
    const ccomplex_t IT_0248 = m_N_1*IT_0247;
    const ccomplex_t IT_0249 = 2*IT_0248;
    const ccomplex_t IT_0250 = s_13*IT_0228;
    const ccomplex_t IT_0251 = s_14*s_34;
    const ccomplex_t IT_0252 = (-2)*IT_0251;
    const ccomplex_t IT_0253 = IT_0250 + IT_0252;
    const ccomplex_t IT_0254 = IT_0074*IT_0253;
    const ccomplex_t IT_0255 = (-6)*IT_0254;
    const ccomplex_t IT_0256 = 12*s_13;
    const ccomplex_t IT_0257 = IT_0255 + IT_0256;
    const ccomplex_t IT_0258 = (-6)*IT_0221;
    const ccomplex_t IT_0259 = IT_0132*IT_0209;
    const ccomplex_t IT_0260 = (-6)*conj(IT_0221);
    const ccomplex_t IT_0261 = (-6)*conj(IT_0174);
    const ccomplex_t IT_0262 = (-6)*IT_0219;
    const ccomplex_t IT_0263 = (-6)*IT_0073;
    const ccomplex_t IT_0264 = 6*IT_0224;
    const ccomplex_t IT_0265 = 6*IT_0134;
    const ccomplex_t IT_0266 = 6*IT_0239;
    const ccomplex_t IT_0267 = 6*IT_0187;
    const ccomplex_t IT_0268 = 6*IT_0131*IT_0139 + IT_0132*((-18)*IT_0174 + (
      -18)*IT_0176) + IT_0204*IT_0257 + IT_0210*IT_0258 + IT_0218*IT_0262 +
       IT_0225*IT_0263 + IT_0249*IT_0264 + IT_0245*IT_0265 + IT_0238*IT_0266 +
       IT_0234*IT_0267;
    const ccomplex_t IT_0269 = (-6)*IT_0131;
    const ccomplex_t IT_0270 = 6*IT_0073*IT_0139 + IT_0132*((-18)*IT_0201 + (
      -18)*IT_0203) + IT_0177*IT_0257 + IT_0218*IT_0258 + IT_0210*IT_0262 +
       IT_0234*IT_0264 + IT_0238*IT_0265 + IT_0245*IT_0266 + IT_0249*IT_0267 +
       IT_0225*IT_0269;
    const ccomplex_t IT_0271 = IT_0132*IT_0228;
    ...
    const ccomplex_t IT_0277 = (-24)*IT_0251;
    const ccomplex_t IT_0278 = 6*IT_0276 + IT_0277;
    const ccomplex_t IT_0279 = 0.166666666666667*IT_0224;
    const ccomplex_t IT_0280 = 24*IT_0251;
    const ccomplex_t IT_0281 = (-12)*IT_0250;
    const ccomplex_t IT_0282 = 6*IT_0276 + IT_0280 + IT_0281;
    const ccomplex_t IT_0283 = 0.166666666666667*IT_0134;
    const ccomplex_t IT_0284 = (-6)*IT_0174;
    const ccomplex_t IT_0285 = 0.166666666666667*IT_0223;
    const ccomplex_t IT_0286 = 0.166666666666667*IT_0239;
    const ccomplex_t IT_0287 = 0.166666666666667*IT_0187;
    const ccomplex_t IT_0288 = 0.166666666666667*IT_0222;
    const ccomplex_t IT_0289 = s_13*IT_0209;
    const ccomplex_t IT_0290 = 0.166666666666667*IT_0289;
    const ccomplex_t IT_0291 = 0.166666666666667*IT_0138;
    const ccomplex_t IT_0292 = 0.166666666666667*IT_0214;
    const ccomplex_t IT_0293 = 6*conj(IT_0073)*(IT_0073*IT_0079 + IT_0131
      *IT_0133 + IT_0134*IT_0138 + IT_0139*IT_0177) + IT_0132*IT_0204*IT_0205 + 
      (IT_0176*IT_0210 + IT_0187*IT_0214 + IT_0204*IT_0218)*IT_0220 + (IT_0221
      *IT_0222 + IT_0219*IT_0223 + IT_0138*IT_0224 + IT_0204*IT_0225)*IT_0226 + 
      (IT_0138*IT_0187 + IT_0219*IT_0222 + IT_0176*IT_0225)*IT_0227 + 6*conj
      (IT_0174)*(IT_0073*IT_0139 + IT_0224*IT_0234 + IT_0134*IT_0238 + IT_0239
      *IT_0245 + IT_0187*IT_0249 + 0.166666666666667*IT_0177*IT_0257 +
       0.166666666666667*IT_0218*IT_0258) + (IT_0204*IT_0210 + IT_0177*IT_0218 +
       IT_0131*IT_0223 + IT_0214*IT_0224 + IT_0219*IT_0259)*IT_0260 + (IT_0210
      *IT_0219 + IT_0131*IT_0225)*IT_0261 + (conj(IT_0201) + conj(IT_0203))
      *IT_0268 + conj(IT_0176)*IT_0270 + 6*conj(IT_0134)*(IT_0073*IT_0138 +
       IT_0214*IT_0221 + IT_0177*IT_0238 + IT_0204*IT_0245 + IT_0239*IT_0272 +
       IT_0187*IT_0273 + IT_0278*IT_0279 + IT_0282*IT_0283) + 6*conj(IT_0131)*
      (IT_0079*IT_0131 + IT_0073*IT_0133 + IT_0139*IT_0204 + IT_0138*IT_0239 +
       0.166666666666667*IT_0225*IT_0284 + IT_0258*IT_0285) + 6*conj(IT_0239)*
      (IT_0131*IT_0138 + IT_0214*IT_0219 + IT_0204*IT_0238 + IT_0177*IT_0245 +
       IT_0134*IT_0272 + IT_0224*IT_0273 + IT_0282*IT_0286 + IT_0278*IT_0287) +
       6*conj(IT_0221)*(IT_0134*IT_0214 + IT_0263*IT_0288 + IT_0258*IT_0290) + 6
      *conj(IT_0219)*(IT_0214*IT_0239 + 0.166666666666667*IT_0258*IT_0259 +
       0.166666666666667*IT_0210*IT_0284 + IT_0263*IT_0285 + IT_0269*IT_0288 +
       IT_0262*IT_0290) + 6*conj(IT_0224)*(IT_0177*IT_0234 + IT_0204*IT_0249 +
       IT_0187*IT_0272 + IT_0239*IT_0273 + IT_0279*IT_0282 + IT_0278*IT_0283 +
       IT_0263*IT_0291 + IT_0258*IT_0292) + 6*conj(IT_0187)*(IT_0204*IT_0234 +
       IT_0177*IT_0249 + IT_0224*IT_0272 + IT_0134*IT_0273 + IT_0278*IT_0286 +
       IT_0282*IT_0287 + IT_0269*IT_0291 + IT_0262*IT_0292);
