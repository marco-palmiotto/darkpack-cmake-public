...
ccomplex_return_t c_sumSqAmpl_N_1_ss_R_to_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = pow(m_s, 2);
    const ccomplex_t IT_0036 = pow(m_ss_R, 2);
    ...
    const ccomplex_t IT_0041 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0042 = IT_0004*IT_0041;
    const ccomplex_t IT_0043 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0044 = IT_0008*IT_0043;
    const ccomplex_t IT_0045 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0046 = IT_0004*IT_0045;
    const ccomplex_t IT_0047 = N_B1*N_d4*e_em;
    ...
    const ccomplex_t IT_0056 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0065 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0069 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = IT_0085*IT_0090;
    const ccomplex_t IT_0092 = pow(m_N_1, 2);
    const ccomplex_t IT_0093 = cpow((-2)*s_12 + IT_0035 + -IT_0036 + -IT_0092 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0035 + IT_0092 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0112 = cpow(IT_0002, -2);
    const ccomplex_t IT_0113 = sin(beta);
    const ccomplex_t IT_0114 = (0 + _Complex_I*-3)*e_em*(IT_0007*IT_0012
      *IT_0035*IT_0094*IT_0096 + -1./3*m_W*IT_0011*IT_0112*(IT_0007*IT_0095 +
       IT_0001*IT_0113));
    ...
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_2*
    ...
    const ccomplex_t IT_0215 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0003;
    const ccomplex_t IT_0216 = (-0.333333333333333)*IT_0215;
    const ccomplex_t IT_0217 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_3*
    ...
    const ccomplex_t IT_0221 = IT_0040 + IT_0091 + (-2)*IT_0102 + IT_0110 +
       IT_0118 + IT_0169 + IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0012*IT_0094*IT_0096;
    ...
    const ccomplex_t IT_0227 = m_N_1*IT_0190;
    const ccomplex_t IT_0228 = m_N_3*IT_0212;
    const ccomplex_t IT_0229 = IT_0227 + IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0012*IT_0094*IT_0096;
    ...
    const ccomplex_t IT_0235 = IT_0098*IT_0223;
    const ccomplex_t IT_0236 = IT_0093*IT_0235;
    ...
    const ccomplex_t IT_0247 = IT_0105*IT_0246;
    const ccomplex_t IT_0248 = IT_0103*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0037*IT_0223;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = IT_0032*IT_0251;
    const ccomplex_t IT_0253 = m_N_1*IT_0139;
    const ccomplex_t IT_0254 = m_N_2*IT_0161;
    ...
    const ccomplex_t IT_0261 = m_N_4*IT_0083;
    const ccomplex_t IT_0262 = m_N_1*IT_0061;
    const ccomplex_t IT_0263 = IT_0261 + IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0012*IT_0094*IT_0096;
    const ccomplex_t IT_0265 = 0.5*IT_0264;
    const ccomplex_t IT_0266 = IT_0088*IT_0265;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*IT_0266;
    const ccomplex_t IT_0268 = IT_0263*IT_0267;
    const ccomplex_t IT_0269 = -IT_0226 + -IT_0234 + 2*IT_0238 + -IT_0249 + 
      -IT_0252 + -IT_0260 + -IT_0268;
    const ccomplex_t IT_0270 = 6*s_13;
    const ccomplex_t IT_0271 = m_s*m_N_1;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0061*IT_0267;
    const ccomplex_t IT_0274 = IT_0030*IT_0251;
    const ccomplex_t IT_0275 = IT_0139*IT_0259;
    const ccomplex_t IT_0276 = IT_0190*IT_0233;
    const ccomplex_t IT_0277 = -IT_0101 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_s*s_14;
    const ccomplex_t IT_0279 = IT_0212*IT_0219;
    const ccomplex_t IT_0280 = IT_0019*IT_0039;
    ...
    const ccomplex_t IT_0288 = m_s*m_N_1*IT_0287;
