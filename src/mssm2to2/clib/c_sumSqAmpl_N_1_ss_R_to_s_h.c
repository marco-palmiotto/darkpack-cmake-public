        ...
        )
{
    ...
    const ccomplex_t IT_0100 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*m_s*e_em*IT_0013*IT_0023
      *IT_0063*IT_0065;
    const ccomplex_t IT_0156 = 0.5*IT_0155;
    const ccomplex_t IT_0157 = IT_0099*IT_0156;
    const ccomplex_t IT_0158 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0071 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0162 = cpow(IT_0000, -2);
    const ccomplex_t IT_0163 = sin(beta);
    const ccomplex_t IT_0164 = (0 + _Complex_I*-3)*e_em*(IT_0004*IT_0013
      *IT_0023*IT_0063*IT_0065 + -1./3*m_W*IT_0022*IT_0162*(IT_0013*IT_0064 +
       IT_0009*IT_0163));
    const ccomplex_t IT_0165 = (-0.333333333333333)*IT_0164;
    const ccomplex_t IT_0166 = IT_0099*IT_0165;
    const ccomplex_t IT_0167 = cpow((-2)*s_13 + IT_0004 + IT_0071 + -m_ss_R*
    ...
    const ccomplex_t IT_0221 = IT_0062 + IT_0074 + IT_0103 + IT_0154 + (-2)
      *IT_0161 + IT_0169 + IT_0220;
    const ccomplex_t IT_0222 = m_N_1*IT_0129;
    const ccomplex_t IT_0223 = m_N_4*IT_0151;
    const ccomplex_t IT_0224 = IT_0222 + IT_0223;
    const ccomplex_t IT_0225 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0230 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0023*IT_0063*IT_0065;
    const ccomplex_t IT_0231 = 0.5*IT_0230;
    const ccomplex_t IT_0232 = IT_0100*IT_0231;
    ...
    const ccomplex_t IT_0239 = IT_0023*IT_0238;
    ...
    const ccomplex_t IT_0243 = IT_0067*IT_0242;
    const ccomplex_t IT_0244 = IT_0072*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1)*IT_0244;
    const ccomplex_t IT_0246 = IT_0165*IT_0231;
    const ccomplex_t IT_0247 = IT_0167*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0023*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0257 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0023*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0265 = IT_0156*IT_0231;
    ...
    const ccomplex_t IT_0269 = -IT_0229 + -IT_0234 + -IT_0245 + -IT_0248 + 
    ...
    const ccomplex_t IT_0273 = IT_0084*IT_0233;
    const ccomplex_t IT_0274 = IT_0037*IT_0260;
    const ccomplex_t IT_0275 = IT_0129*IT_0228;
    const ccomplex_t IT_0276 = IT_0195*IT_0252;
    const ccomplex_t IT_0277 = -IT_0160 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_s*s_14;
    const ccomplex_t IT_0279 = IT_0174*IT_0217;
    const ccomplex_t IT_0280 = IT_0108*IT_0151;
    const ccomplex_t IT_0281 = IT_0095*IT_0102;
