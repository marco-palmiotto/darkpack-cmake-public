        ...
        )
{
    ...
    const ccomplex_t IT_0116 = V_tb*e_em*conj(V_Wp1)*U_st_00;
    ...
    const ccomplex_t IT_0121 = m_t*V_tb*conj(V_u1)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0136 = V_tb*e_em*conj(V_Wp2)*U_st_00;
    const ccomplex_t IT_0137 = IT_0001*IT_0136;
    const ccomplex_t IT_0138 = m_t*V_tb*conj(V_u2)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0194 = m_t*N_u1*e_em*IT_0012*U_st_00;
