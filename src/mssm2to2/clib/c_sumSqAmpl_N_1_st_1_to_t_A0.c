...
ccomplex_return_t c_sumSqAmpl_N_1_st_1_to_t_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = m_t*N_u1*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0030 = pow(m_N_1, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0029 + IT_0030 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0028*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0035 = IT_0016*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = m_t*N_u1*e_em*IT_0002*U_st_01;
    ...
    const ccomplex_t IT_0042 = m_t*e_em*mu_h*IT_0002*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0043 = IT_0001*IT_0042;
    const ccomplex_t IT_0044 = m_t*e_em*mu_h*IT_0002*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0066 = cpow((-2)*s_23 + IT_0029 + IT_0065 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0067 = IT_0064*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*IT_0067;
    const ccomplex_t IT_0069 = IT_0007*IT_0016;
    const ccomplex_t IT_0070 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = IT_0016*IT_0020;
    const ccomplex_t IT_0073 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = IT_0001*IT_0007;
    const ccomplex_t IT_0076 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = IT_0001*IT_0020;
    ...
    const ccomplex_t IT_0089 = (-0.5)*IT_0071 + 0.5*IT_0074 + 0.5*IT_0077 + (
      -0.5)*IT_0080 + (-0.5)*IT_0082 + 0.5*IT_0084 + 0.5*IT_0086 + (-0.5)*IT_0088;
    const ccomplex_t IT_0090 = m_N_4*IT_0089;
    const ccomplex_t IT_0091 = conj(N_B1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0097 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0098 = IT_0078*IT_0097;
    const ccomplex_t IT_0099 = conj(N_B4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0105 = conj(N_W4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0106 = IT_0078*IT_0105;
    ...
    const ccomplex_t IT_0109 = IT_0090 + IT_0108;
    const ccomplex_t IT_0110 = IT_0068*IT_0109;
    const ccomplex_t IT_0111 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0112 = IT_0069*IT_0111;
    const ccomplex_t IT_0113 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0114 = IT_0072*IT_0113;
    const ccomplex_t IT_0115 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0116 = IT_0075*IT_0115;
    const ccomplex_t IT_0117 = N_W1*N_d1*e_em;
    ...
    const ccomplex_t IT_0121 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0122 = IT_0069*IT_0121;
    const ccomplex_t IT_0123 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0124 = IT_0072*IT_0123;
    const ccomplex_t IT_0125 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0126 = IT_0075*IT_0125;
    const ccomplex_t IT_0127 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0029 + IT_0065 + -m_N_1*
    ...
    const ccomplex_t IT_0139 = m_t*N_u2*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0144 = cpow((-2)*s_23 + IT_0029 + IT_0065 + -m_N_2*
    ...
    const ccomplex_t IT_0148 = IT_0069*IT_0147;
    const ccomplex_t IT_0149 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0150 = IT_0072*IT_0149;
    const ccomplex_t IT_0151 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0152 = IT_0075*IT_0151;
    const ccomplex_t IT_0153 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0154 = IT_0078*IT_0153;
    const ccomplex_t IT_0155 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0156 = IT_0069*IT_0155;
    const ccomplex_t IT_0157 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0158 = IT_0072*IT_0157;
    const ccomplex_t IT_0159 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0160 = IT_0075*IT_0159;
    const ccomplex_t IT_0161 = N_W1*N_d2*e_em;
    const ccomplex_t IT_0162 = IT_0078*IT_0161;
    ...
    const ccomplex_t IT_0166 = IT_0069*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0168 = IT_0072*IT_0167;
    const ccomplex_t IT_0169 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0170 = IT_0075*IT_0169;
    ...
    const ccomplex_t IT_0174 = IT_0069*IT_0173;
    const ccomplex_t IT_0175 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0176 = IT_0072*IT_0175;
    const ccomplex_t IT_0177 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0178 = IT_0075*IT_0177;
    const ccomplex_t IT_0179 = conj(N_W2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0180 = IT_0078*IT_0179;
    ...
    const ccomplex_t IT_0185 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0186 = IT_0016*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = m_t*N_u3*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0193 = cpow((-2)*s_23 + IT_0029 + IT_0065 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0194 = IT_0192*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*IT_0194;
    const ccomplex_t IT_0196 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0197 = IT_0069*IT_0196;
    const ccomplex_t IT_0198 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0199 = IT_0072*IT_0198;
    const ccomplex_t IT_0200 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0201 = IT_0075*IT_0200;
    const ccomplex_t IT_0202 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0203 = IT_0078*IT_0202;
    const ccomplex_t IT_0204 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0205 = IT_0069*IT_0204;
    const ccomplex_t IT_0206 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0207 = IT_0072*IT_0206;
    const ccomplex_t IT_0208 = N_W1*N_u3*e_em;
    const ccomplex_t IT_0209 = IT_0075*IT_0208;
    const ccomplex_t IT_0210 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0225 = IT_0072*IT_0224;
    ...
    const ccomplex_t IT_0248 = m_N_1*IT_0089;
    const ccomplex_t IT_0249 = m_N_4*IT_0107;
    const ccomplex_t IT_0250 = IT_0248 + IT_0249;
    const ccomplex_t IT_0251 = IT_0247*IT_0250;
    const ccomplex_t IT_0252 = conj(N_B1)*e_em*U_st_01;
    const ccomplex_t IT_0253 = IT_0016*IT_0252;
    const ccomplex_t IT_0254 = 1.4142135623731*IT_0253;
    const ccomplex_t IT_0255 = conj(N_W1)*e_em*U_st_01;
    const ccomplex_t IT_0256 = IT_0001*IT_0255;
    const ccomplex_t IT_0257 = 1.4142135623731*IT_0256;
    const ccomplex_t IT_0258 = m_t*conj(N_u1)*e_em*IT_0002*U_st_11;
    const ccomplex_t IT_0259 = IT_0022*IT_0258;
    const ccomplex_t IT_0260 = 1.4142135623731*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*(IT_0254 + 3*IT_0257 + 3
      *IT_0260);
    const ccomplex_t IT_0262 = 0.166666666666667*IT_0261;
    const ccomplex_t IT_0263 = IT_0052*IT_0262;
    const ccomplex_t IT_0264 = IT_0054*IT_0263;
    const ccomplex_t IT_0265 = (0 + _Complex_I*1)*IT_0264;
    const ccomplex_t IT_0266 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0267 = IT_0016*IT_0266;
    const ccomplex_t IT_0268 = 1.4142135623731*IT_0267;
    const ccomplex_t IT_0269 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0270 = IT_0001*IT_0269;
    const ccomplex_t IT_0271 = 1.4142135623731*IT_0270;
    const ccomplex_t IT_0272 = m_t*conj(N_u2)*e_em*IT_0002*U_st_10;
    const ccomplex_t IT_0273 = IT_0022*IT_0272;
    const ccomplex_t IT_0274 = 1.4142135623731*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*(IT_0268 + 3*IT_0271 + 3
      *IT_0274);
    ...
    const ccomplex_t IT_0294 = IT_0193*IT_0293;
    const ccomplex_t IT_0295 = (0 + _Complex_I*1)*IT_0294;
    const ccomplex_t IT_0296 = m_N_1*IT_0212;
    const ccomplex_t IT_0297 = m_N_3*IT_0230;
    const ccomplex_t IT_0298 = IT_0296 + IT_0297;
    const ccomplex_t IT_0299 = IT_0295*IT_0298;
    const ccomplex_t IT_0300 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0301 = IT_0016*IT_0300;
    const ccomplex_t IT_0302 = 1.4142135623731*IT_0301;
    const ccomplex_t IT_0303 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0304 = IT_0001*IT_0303;
    const ccomplex_t IT_0305 = 1.4142135623731*IT_0304;
    const ccomplex_t IT_0306 = m_t*conj(N_u1)*e_em*IT_0002*U_st_10;
    const ccomplex_t IT_0307 = IT_0022*IT_0306;
    const ccomplex_t IT_0308 = 1.4142135623731*IT_0307;
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*(IT_0302 + 3*IT_0305 + 3
      *IT_0308);
    const ccomplex_t IT_0310 = 0.166666666666667*IT_0309;
    const ccomplex_t IT_0311 = IT_0014*IT_0310;
    const ccomplex_t IT_0312 = IT_0031*IT_0311;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = IT_0132*IT_0310;
    const ccomplex_t IT_0315 = (0 + _Complex_I*1)*IT_0314;
    const ccomplex_t IT_0316 = IT_0131*IT_0315;
    const ccomplex_t IT_0317 = -IT_0251 + -IT_0265 + -IT_0282 + -IT_0299 + 
      -IT_0313 + -IT_0316;
    const ccomplex_t IT_0318 = 6*s_13;
    const ccomplex_t IT_0319 = m_t*m_N_1;
    const ccomplex_t IT_0320 = 6*IT_0234;
    const ccomplex_t IT_0321 = m_t*e_em*IT_0001*IT_0002*IT_0007*IT_0021;
    const ccomplex_t IT_0322 = (-0.5)*IT_0321;
    const ccomplex_t IT_0323 = IT_0027*IT_0322;
    const ccomplex_t IT_0324 = cpow((-2)*s_12 + -IT_0030 + -IT_0065 + 
    ...
    const ccomplex_t IT_0327 = IT_0163*IT_0278;
    const ccomplex_t IT_0328 = IT_0212*IT_0295;
    const ccomplex_t IT_0329 = IT_0089*IT_0247;
    const ccomplex_t IT_0330 = IT_0119*IT_0315;
    const ccomplex_t IT_0331 = -IT_0326 + IT_0327 + IT_0328 + IT_0329 + IT_0330;
    const ccomplex_t IT_0332 = m_t*s_14;
    const ccomplex_t IT_0333 = IT_0146*IT_0181;
    const ccomplex_t IT_0334 = IT_0195*IT_0230;
    const ccomplex_t IT_0335 = IT_0068*IT_0107;
    const ccomplex_t IT_0336 = IT_0310*IT_0322;
    const ccomplex_t IT_0337 = IT_0324*IT_0336;
    const ccomplex_t IT_0338 = (0 + _Complex_I*1)*IT_0337;
    const ccomplex_t IT_0339 = IT_0129*IT_0134;
    const ccomplex_t IT_0340 = -IT_0333 + -IT_0334 + -IT_0335 + -IT_0338 + 
      -IT_0339;
    ...
    const ccomplex_t IT_0345 = m_t*m_N_1*IT_0344;
