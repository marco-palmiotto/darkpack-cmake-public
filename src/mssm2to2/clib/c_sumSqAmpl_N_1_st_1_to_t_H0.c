...
ccomplex_return_t c_sumSqAmpl_N_1_st_1_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = N_B1*N_d1*e_em;
    ...
    const ccomplex_t IT_0033 = N_W1*N_d1*e_em;
    const ccomplex_t IT_0034 = IT_0008*IT_0027;
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0037 = IT_0008*IT_0016;
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*(IT_0029 + -IT_0032 + 
      -IT_0035 + IT_0038);
    const ccomplex_t IT_0040 = m_N_1*IT_0039;
    const ccomplex_t IT_0041 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0042 = IT_0028*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0044 = IT_0031*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0046 = IT_0034*IT_0045;
    const ccomplex_t IT_0047 = conj(N_W1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_1*
    ...
    const ccomplex_t IT_0062 = (-2)*U_st_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0052 + 0.5*m_W*IT_0060*(IT_0008 + -1./3*IT_0007*IT_0061))*conj(U_st_00
      ) + -1./2*IT_0006*IT_0008*IT_0027*IT_0057*conj(U_st_10)) + U_st_10*
      (IT_0006*IT_0008*IT_0027*IT_0057*conj(U_st_00) + (-1.33333333333333)*(1.5
    ...
    const ccomplex_t IT_0072 = m_t*N_u1*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0077 = (-2)*U_st_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0052 + 0.5*m_W*IT_0060*(IT_0008 + -1./3*IT_0007*IT_0061))*conj(U_st_01
      ) + -1./2*IT_0006*IT_0008*IT_0027*IT_0057*conj(U_st_11)) + U_st_10*
      (IT_0006*IT_0008*IT_0027*IT_0057*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0006*IT_0008*IT_0010*IT_0016*IT_0052 + m_W*IT_0007*IT_0060*IT_0061)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0129 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0130 = IT_0001*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = m_t*N_u2*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0137 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_2*
    ...
    const ccomplex_t IT_0156 = N_B1*N_d3*e_em;
    ...
    const ccomplex_t IT_0161 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0162 = IT_0031*IT_0161;
    const ccomplex_t IT_0163 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0164 = IT_0034*IT_0163;
    const ccomplex_t IT_0165 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0166 = IT_0031*IT_0165;
    const ccomplex_t IT_0167 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0174 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0175 = IT_0028*IT_0174;
    const ccomplex_t IT_0176 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0177 = IT_0037*IT_0176;
    const ccomplex_t IT_0178 = conj(N_B3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0183 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0184 = IT_0031*IT_0183;
    const ccomplex_t IT_0185 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0186 = IT_0034*IT_0185;
    const ccomplex_t IT_0187 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0188 = IT_0031*IT_0187;
    const ccomplex_t IT_0189 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0218 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0219 = IT_0031*IT_0218;
    const ccomplex_t IT_0220 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0221 = IT_0034*IT_0220;
    const ccomplex_t IT_0222 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0223 = IT_0031*IT_0222;
    const ccomplex_t IT_0224 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0231 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0235 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0240 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0241 = IT_0031*IT_0240;
    const ccomplex_t IT_0242 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0243 = IT_0034*IT_0242;
    const ccomplex_t IT_0244 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0245 = IT_0031*IT_0244;
    const ccomplex_t IT_0246 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0323 = s_34*m_N_1;
