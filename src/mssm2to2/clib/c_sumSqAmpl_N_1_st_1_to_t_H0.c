        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (-2)*U_st_00*((0.5*m_W*IT_0021*(IT_0008 + -1./3
      *IT_0007*IT_0022) + IT_0006*IT_0008*IT_0010*IT_0016*IT_0023)*conj(U_st_00)
    ...
    const ccomplex_t IT_0028 = pow(m_N_1, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_13 + IT_0023 + IT_0028 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*IT_0030;
    const ccomplex_t IT_0032 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0033 = IT_0001*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = m_t*N_u1*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0040 = (-2)*U_st_00*((0.5*m_W*IT_0021*(IT_0008 + -1./3
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0023 + IT_0028 + -m_st_2*
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_1*
    ...
    const ccomplex_t IT_0084 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0085 = IT_0001*IT_0084;
    const ccomplex_t IT_0086 = 1.4142135623731*IT_0085;
    const ccomplex_t IT_0087 = m_t*N_u2*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0092 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0093 = IT_0091*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*IT_0093;
    const ccomplex_t IT_0095 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0096 = IT_0056*IT_0095;
    const ccomplex_t IT_0097 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0098 = IT_0065*IT_0097;
    const ccomplex_t IT_0099 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0100 = IT_0056*IT_0099;
    const ccomplex_t IT_0101 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0132 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0147 = N_W1*N_u3*e_em;
    const ccomplex_t IT_0148 = IT_0065*IT_0147;
    ...
    const ccomplex_t IT_0154 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0155 = IT_0059*IT_0154;
    const ccomplex_t IT_0156 = N_W1*N_d3*e_em;
    const ccomplex_t IT_0157 = IT_0062*IT_0156;
    ...
    const ccomplex_t IT_0163 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0164 = IT_0056*IT_0163;
    const ccomplex_t IT_0165 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0166 = IT_0065*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0168 = IT_0056*IT_0167;
    const ccomplex_t IT_0169 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0170 = IT_0065*IT_0169;
    const ccomplex_t IT_0171 = IT_0164 + IT_0166 + IT_0168 + IT_0170;
    const ccomplex_t IT_0172 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0173 = IT_0059*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0175 = IT_0062*IT_0174;
    const ccomplex_t IT_0176 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0177 = IT_0059*IT_0176;
    const ccomplex_t IT_0178 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0185 = IT_0162 + IT_0184;
    const ccomplex_t IT_0186 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0187 = IT_0001*IT_0186;
    const ccomplex_t IT_0188 = 1.4142135623731*IT_0187;
    const ccomplex_t IT_0189 = m_t*N_u3*e_em*IT_0010*U_st_00;
    const ccomplex_t IT_0190 = IT_0009*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*(IT_0188 + (-0.75)*IT_0191);
    const ccomplex_t IT_0193 = 0.666666666666667*IT_0192;
    const ccomplex_t IT_0194 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_3*
    ...
    const ccomplex_t IT_0206 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_4*
    ...
    const ccomplex_t IT_0212 = IT_0065*IT_0211;
    const ccomplex_t IT_0213 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0214 = IT_0056*IT_0213;
    ...
    const ccomplex_t IT_0225 = IT_0062*IT_0224;
    ...
    const ccomplex_t IT_0232 = IT_0056*IT_0231;
    const ccomplex_t IT_0233 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0234 = IT_0065*IT_0233;
    const ccomplex_t IT_0235 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0236 = IT_0056*IT_0235;
    const ccomplex_t IT_0237 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0238 = IT_0065*IT_0237;
    ...
    const ccomplex_t IT_0267 = IT_0042*IT_0266;
    const ccomplex_t IT_0268 = IT_0044*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0271 = IT_0001*IT_0270;
    const ccomplex_t IT_0272 = 1.4142135623731*IT_0271;
    const ccomplex_t IT_0273 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0274 = IT_0008*IT_0273;
    const ccomplex_t IT_0275 = 1.4142135623731*IT_0274;
    const ccomplex_t IT_0276 = m_t*conj(N_u1)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0304 = m_N_1*IT_0229;
    const ccomplex_t IT_0305 = m_N_4*IT_0251;
    const ccomplex_t IT_0306 = IT_0304 + IT_0305;
    const ccomplex_t IT_0307 = IT_0303*IT_0306;
    const ccomplex_t IT_0308 = m_N_1*IT_0137;
    const ccomplex_t IT_0309 = m_N_2*IT_0115;
    ...
    const ccomplex_t IT_0317 = m_t*conj(N_u2)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0322 = IT_0092*IT_0321;
    const ccomplex_t IT_0323 = (0 + _Complex_I*1)*IT_0322;
    const ccomplex_t IT_0324 = IT_0310*IT_0323;
    const ccomplex_t IT_0325 = m_N_1*IT_0161;
    const ccomplex_t IT_0326 = m_N_3*IT_0183;
    ...
    const ccomplex_t IT_0339 = IT_0194*IT_0338;
    const ccomplex_t IT_0340 = (0 + _Complex_I*1)*IT_0339;
    const ccomplex_t IT_0341 = IT_0327*IT_0340;
    const ccomplex_t IT_0342 = -IT_0269 + 2*IT_0284 + -IT_0287 + -IT_0290 + 
      -IT_0307 + -IT_0324 + -IT_0341;
    const ccomplex_t IT_0343 = 6*s_13;
    const ccomplex_t IT_0344 = m_t*m_N_1;
    const ccomplex_t IT_0345 = 6*IT_0255;
    const ccomplex_t IT_0346 = IT_0067*IT_0286;
    const ccomplex_t IT_0347 = IT_0137*IT_0323;
    const ccomplex_t IT_0348 = IT_0161*IT_0340;
    const ccomplex_t IT_0349 = IT_0229*IT_0303;
    const ccomplex_t IT_0350 = -IT_0053 + IT_0346 + IT_0347 + IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = m_t*s_14;
    const ccomplex_t IT_0352 = IT_0077*IT_0082;
    const ccomplex_t IT_0353 = IT_0094*IT_0115;
    const ccomplex_t IT_0354 = IT_0183*IT_0196;
    const ccomplex_t IT_0355 = IT_0208*IT_0251;
    const ccomplex_t IT_0356 = IT_0283 + -IT_0352 + -IT_0353 + -IT_0354 + 
      -IT_0355;
    const ccomplex_t IT_0357 = s_34*m_N_1;
