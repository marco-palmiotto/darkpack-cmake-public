...
ccomplex_return_t c_sumSqAmpl_N_1_st_2_to_b_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = m_b*conj(N_d1)*e_em*IT_0006*U_sb_10;
    ...
    const ccomplex_t IT_0022 = conj(N_W1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0004*IT_0006*IT_0007*IT_0011;
    const ccomplex_t IT_0033 = 0.5*IT_0032;
    const ccomplex_t IT_0034 = conj(N_B1)*e_em*U_st_01;
    const ccomplex_t IT_0035 = IT_0018*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_W1)*e_em*U_st_01;
    const ccomplex_t IT_0038 = IT_0011*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = IT_0007*IT_0011;
    const ccomplex_t IT_0041 = m_t*conj(N_u1)*e_em*IT_0006*U_st_11;
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*(IT_0036 + 3*IT_0039 + 3
      *IT_0043);
    const ccomplex_t IT_0045 = 0.166666666666667*IT_0044;
    const ccomplex_t IT_0046 = IT_0033*IT_0045;
    const ccomplex_t IT_0047 = pow(m_st_2, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_12 + -IT_0002 + -IT_0047 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0049 = IT_0031*IT_0046*IT_0048;
    const ccomplex_t IT_0050 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0051 = IT_0018*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = m_t*N_u1*e_em*IT_0006*U_st_01;
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_13 + IT_0001 + IT_0002 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0063 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0007*U_st_01 
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      ...
      *IT_0063 + m_W*IT_0004*IT_0005*conj(U_sb_01)*U_st_01) + A_t*IT_0004*conj
      (U_sb_01)*U_st_11);
    ...
    const ccomplex_t IT_0071 = m_b*conj(N_d1)*e_em*IT_0006*U_sb_11;
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0001 + IT_0047 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0081 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    const ccomplex_t IT_0082 = IT_0011*IT_0081;
    const ccomplex_t IT_0083 = m_t*V_tb*conj(V_u1)*e_em*IT_0006*U_st_11;
    ...
    const ccomplex_t IT_0088 = IT_0005*IT_0018;
    const ccomplex_t IT_0089 = conj(N_B1)*conj(U_d1)*e_em;
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = IT_0005*IT_0011;
    const ccomplex_t IT_0093 = conj(N_W1)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0097 = conj(N_d1)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0104 = IT_0079*IT_0080*IT_0103;
    const ccomplex_t IT_0105 = -IT_0030 + IT_0049 + -IT_0061 + -IT_0078 +
       IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
    ...
    const ccomplex_t IT_0111 = m_b*IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0001 + IT_0047 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0114 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    const ccomplex_t IT_0115 = IT_0011*IT_0114;
    const ccomplex_t IT_0116 = m_t*V_tb*conj(V_u2)*e_em*IT_0006*U_st_11;
    ...
    const ccomplex_t IT_0121 = conj(N_W1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0122 = IT_0092*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = conj(N_B1)*conj(U_d2)*e_em;
    const ccomplex_t IT_0125 = IT_0088*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = IT_0123 + IT_0126;
    const ccomplex_t IT_0128 = conj(N_d1)*e_em*conj(U_Wm2);
    ...
    const ccomplex_t IT_0135 = IT_0112*IT_0113*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0006*IT_0008*IT_0011*U_st_01;
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = IT_0133*IT_0137;
    const ccomplex_t IT_0139 = IT_0113*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*IT_0139;
    const ccomplex_t IT_0141 = m_b*IT_0140;
    const ccomplex_t IT_0142 = -IT_0111 + -IT_0135 + -IT_0141;
    const ccomplex_t IT_0143 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0144 = IT_0018*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = m_b*N_d1*e_em*IT_0006*U_sb_01;
    ...
    const ccomplex_t IT_0154 = IT_0004*IT_0011;
    const ccomplex_t IT_0155 = N_u1*e_em*V_Wp1;
    const ccomplex_t IT_0156 = IT_0154*IT_0155;
    const ccomplex_t IT_0157 = 2*IT_0156;
    const ccomplex_t IT_0158 = IT_0004*IT_0018;
    const ccomplex_t IT_0159 = N_B1*V_u1*e_em;
    const ccomplex_t IT_0160 = IT_0158*IT_0159;
    const ccomplex_t IT_0161 = 1.4142135623731*IT_0160;
    const ccomplex_t IT_0162 = N_W1*V_u1*e_em;
    ...
    const ccomplex_t IT_0170 = IT_0079*IT_0080*IT_0169;
    const ccomplex_t IT_0171 = N_u1*e_em*V_Wp2;
    const ccomplex_t IT_0172 = IT_0154*IT_0171;
    const ccomplex_t IT_0173 = 2*IT_0172;
    const ccomplex_t IT_0174 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0175 = IT_0158*IT_0174;
    const ccomplex_t IT_0176 = 1.4142135623731*IT_0175;
    const ccomplex_t IT_0177 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0184 = IT_0137*IT_0183;
    const ccomplex_t IT_0185 = IT_0112*IT_0113*IT_0184;
    const ccomplex_t IT_0186 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0187 = IT_0018*IT_0186;
    const ccomplex_t IT_0188 = 1.4142135623731*IT_0187;
    const ccomplex_t IT_0189 = m_b*N_d1*e_em*IT_0006*U_sb_00;
    ...
    const ccomplex_t IT_0199 = IT_0057*IT_0198;
    const ccomplex_t IT_0200 = IT_0031*IT_0048*IT_0199;
    const ccomplex_t IT_0201 = IT_0045*IT_0198;
    const ccomplex_t IT_0202 = IT_0048*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*IT_0202;
    const ccomplex_t IT_0204 = m_N_1*IT_0203;
    const ccomplex_t IT_0205 = IT_0153 + -IT_0170 + -IT_0185 + IT_0196 + 
      -IT_0200 + IT_0204;
    const ccomplex_t IT_0206 = IT_0120*IT_0183;
    const ccomplex_t IT_0207 = IT_0113*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*IT_0207;
    const ccomplex_t IT_0209 = IT_0087*IT_0168;
    ...
    const ccomplex_t IT_0216 = IT_0105 + -IT_0142;
    const ccomplex_t IT_0217 = m_b*m_N_1*IT_0047;
    const ccomplex_t IT_0218 = -IT_0060;
    const ccomplex_t IT_0219 = conj(IT_0212) + conj(IT_0218);
    const ccomplex_t IT_0220 = -IT_0110 + -IT_0140;
    const ccomplex_t IT_0221 = IT_0203 + IT_0220;
    const ccomplex_t IT_0222 = IT_0212 + IT_0218;
    const ccomplex_t IT_0223 = conj(IT_0203) + conj(IT_0220);
    const ccomplex_t IT_0224 = s_13*IT_0047;
    ...
    const ccomplex_t IT_0229 = 6*s_13;
    const ccomplex_t IT_0230 = (-6)*s_13;
    const ccomplex_t IT_0231 = s_23*m_N_1;
    const ccomplex_t IT_0232 = (-6)*IT_0142;
    const ccomplex_t IT_0233 = IT_0105 + 0.166666666666667*IT_0232;
    const ccomplex_t IT_0234 = -conj(IT_0213);
    const ccomplex_t IT_0235 = conj(IT_0205) + IT_0234;
    const ccomplex_t IT_0236 = (-6)*conj(IT_0142);
    const ccomplex_t IT_0237 = m_b*s_12;
    const ccomplex_t IT_0238 = 6*IT_0000*((conj(IT_0105) + -conj(IT_0142))
      *IT_0215 + (conj(IT_0205) + -conj(IT_0213))*IT_0216) + 6*IT_0217*(IT_0219
      *IT_0221 + IT_0222*IT_0223) + (IT_0219*IT_0222 + IT_0221*IT_0223)*IT_0228 
      + (IT_0105*conj(IT_0105) + IT_0142*conj(IT_0142) + IT_0205*conj(IT_0205) +
       IT_0213*conj(IT_0213))*IT_0229 + (conj(IT_0105)*IT_0142 + IT_0105*conj
      (IT_0142) + conj(IT_0205)*IT_0213 + IT_0205*conj(IT_0213))*IT_0230 + 6
      *IT_0231*(IT_0215*IT_0223 + IT_0219*IT_0233 + IT_0221*IT_0235 + IT_0222*
      (conj(IT_0105) + 0.166666666666667*IT_0236)) + 6*(IT_0215*IT_0219 +
       IT_0223*IT_0233 + IT_0222*IT_0235 + IT_0221*(conj(IT_0105) +
       0.166666666666667*IT_0236))*IT_0237;
