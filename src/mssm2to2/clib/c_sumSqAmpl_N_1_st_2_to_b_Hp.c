        ...
        )
{
    ...
    const ccomplex_t IT_0016 = m_t*N_u1*e_em*IT_0002*U_st_01;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
      *e_em*IT_0002*IT_0007*IT_0080*U_st_01;
    ...
    const ccomplex_t IT_0146 = IT_0048*IT_0097;
    const ccomplex_t IT_0147 = IT_0051*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = cpow((-2)*s_13 + IT_0022 + IT_0050 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0149 = m_t*conj(U_sb_00)*(m_t*IT_0003*IT_0005*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0004*IT_0080*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0005*IT_0080*U_st_11));
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0004*conj
      ...
      *IT_0149 + m_W*IT_0003*IT_0004*conj(U_sb_00)*U_st_01) + A_t*IT_0003*conj
      (U_sb_00)*U_st_11);
    const ccomplex_t IT_0151 = IT_0007*IT_0080;
    const ccomplex_t IT_0152 = m_b*conj(N_d1)*e_em*IT_0002*U_sb_10;
    const ccomplex_t IT_0153 = IT_0151*IT_0152;
    const ccomplex_t IT_0154 = 1.4142135623731*IT_0153;
    const ccomplex_t IT_0155 = conj(N_W1)*e_em*U_sb_00;
    const ccomplex_t IT_0156 = IT_0007*IT_0155;
    const ccomplex_t IT_0157 = 1.4142135623731*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0172 = m_t*conj(U_sb_01)*(m_t*IT_0003*IT_0005*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0004*IT_0080*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0005*IT_0080*U_st_11));
    ...
    const ccomplex_t IT_0189 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0190 = IT_0009*IT_0130;
    const ccomplex_t IT_0191 = IT_0023*IT_0189*IT_0190;
    const ccomplex_t IT_0192 = m_N_1*IT_0025;
    const ccomplex_t IT_0193 = IT_0147 + -IT_0170 + -IT_0188 + IT_0191 + 
      -IT_0192;
    const ccomplex_t IT_0194 = m_b*IT_0100;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0196 = IT_0073*IT_0115;
    const ccomplex_t IT_0197 = IT_0075*IT_0195*IT_0196;
    const ccomplex_t IT_0198 = m_b*IT_0118;
    const ccomplex_t IT_0199 = -IT_0194 + -IT_0197 + -IT_0198;
    const ccomplex_t IT_0200 = IT_0066*IT_0102;
    const ccomplex_t IT_0201 = IT_0075*IT_0195*IT_0200;
    ...
    const ccomplex_t IT_0206 = IT_0151*IT_0205;
    ...
    const ccomplex_t IT_0227 = IT_0148*IT_0226;
    ...
    const ccomplex_t IT_0235 = 6*s_13;
    const ccomplex_t IT_0236 = (-6)*s_13;
    const ccomplex_t IT_0237 = s_23*m_N_1;
    const ccomplex_t IT_0238 = (-6)*IT_0199;
    const ccomplex_t IT_0239 = IT_0193 + 0.166666666666667*IT_0238;
    const ccomplex_t IT_0240 = (-6)*conj(IT_0199);
    const ccomplex_t IT_0241 = m_b*s_12;
    const ccomplex_t IT_0242 = 6*IT_0001*(IT_0079*IT_0136 + IT_0137*IT_0138) +
       (IT_0079*IT_0137 + IT_0136*IT_0138)*IT_0143 + 6*IT_0144*((conj(IT_0193) +
       -conj(IT_0199))*IT_0232 + (IT_0193 + -IT_0199)*IT_0234) + (IT_0193*conj
      (IT_0193) + IT_0199*conj(IT_0199) + IT_0229*conj(IT_0229) + IT_0230*conj
      (IT_0230))*IT_0235 + (conj(IT_0193)*IT_0199 + IT_0193*conj(IT_0199) + conj
      (IT_0229)*IT_0230 + IT_0229*conj(IT_0230))*IT_0236 + 6*IT_0237*(IT_0138
      *IT_0232 + IT_0136*IT_0234 + IT_0079*IT_0239 + IT_0137*(conj(IT_0193) +
       0.166666666666667*IT_0240)) + 6*(IT_0079*IT_0232 + IT_0137*IT_0234 +
       IT_0138*IT_0239 + IT_0136*(conj(IT_0193) + 0.166666666666667*IT_0240))
      *IT_0241;
