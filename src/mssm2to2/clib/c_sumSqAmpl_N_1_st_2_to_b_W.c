        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0004*IT_0012*IT_0014*U_st_01;
    ...
    const ccomplex_t IT_0121 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    ...
    const ccomplex_t IT_0126 = m_t*V_tb*conj(V_u2)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0141 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    const ccomplex_t IT_0142 = IT_0004*IT_0141;
    const ccomplex_t IT_0143 = m_t*V_tb*conj(V_u1)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0193 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0194 = IT_0036*IT_0193;
    const ccomplex_t IT_0195 = 1.4142135623731*IT_0194;
    const ccomplex_t IT_0196 = m_t*N_u1*e_em*IT_0012*U_st_01;
