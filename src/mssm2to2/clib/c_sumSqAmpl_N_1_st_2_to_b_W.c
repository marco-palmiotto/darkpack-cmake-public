...
ccomplex_return_t c_sumSqAmpl_N_1_st_2_to_b_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = N_B1*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0013 = m_b*N_d1*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_23 + IT_0018 + IT_0024 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0026 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0027 = IT_0001*IT_0026;
    const ccomplex_t IT_0028 = N_d1*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0018 + IT_0024 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0039 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0040 = IT_0001*IT_0039;
    const ccomplex_t IT_0041 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0018 + IT_0019 + -m_sb_2*
    ...
    const ccomplex_t IT_0072 = m_b*conj(N_d1)*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0073 = IT_0011*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = conj(N_B1)*e_em*U_sb_00;
    const ccomplex_t IT_0076 = IT_0005*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = conj(N_W1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0102 = m_b*m_N_1;
    const ccomplex_t IT_0103 = IT_0070*IT_0102;
    const ccomplex_t IT_0104 = IT_0037 + IT_0050;
    ...
    const ccomplex_t IT_0116 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    ...
    const ccomplex_t IT_0121 = m_t*V_tb*conj(V_u1)*e_em*IT_0012*U_st_11;
    const ccomplex_t IT_0122 = IT_0120*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*(IT_0117 + (-0.5)*IT_0123);
    ...
    const ccomplex_t IT_0129 = conj(N_W1)*e_em*V_Wp2;
    const ccomplex_t IT_0130 = IT_0001*IT_0129;
    const ccomplex_t IT_0131 = conj(N_u1)*V_u2*e_em;
    ...
    const ccomplex_t IT_0136 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    const ccomplex_t IT_0137 = IT_0001*IT_0136;
    const ccomplex_t IT_0138 = m_t*V_tb*conj(V_u2)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0148 = IT_0102*IT_0147;
    const ccomplex_t IT_0149 = (-3)*IT_0148;
    const ccomplex_t IT_0150 = 3*IT_0148;
    const ccomplex_t IT_0151 = cpow((-2)*s_12 + -IT_0019 + -IT_0024 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0152 = conj(N_B1)*e_em*U_st_01;
    const ccomplex_t IT_0153 = IT_0005*IT_0152;
    const ccomplex_t IT_0154 = 1.4142135623731*IT_0153;
    const ccomplex_t IT_0155 = conj(N_W1)*e_em*U_st_01;
    const ccomplex_t IT_0156 = IT_0001*IT_0155;
    const ccomplex_t IT_0157 = 1.4142135623731*IT_0156;
    const ccomplex_t IT_0158 = m_t*conj(N_u1)*e_em*IT_0012*U_st_11;
    const ccomplex_t IT_0159 = IT_0120*IT_0158;
    ...
    const ccomplex_t IT_0166 = IT_0151*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*IT_0166;
    const ccomplex_t IT_0168 = -IT_0023 + -IT_0064;
    ...
    const ccomplex_t IT_0194 = m_t*N_u1*e_em*IT_0012*U_st_01;
    ...
    const ccomplex_t IT_0200 = IT_0151*IT_0190*IT_0199;
    const ccomplex_t IT_0201 = IT_0032*IT_0142;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0203 = IT_0025*IT_0201*IT_0202;
    const ccomplex_t IT_0204 = -IT_0189 + -IT_0200 + -IT_0203;
    const ccomplex_t IT_0205 = IT_0128 + IT_0145;
    const ccomplex_t IT_0206 = m_N_1*IT_0205;
    const ccomplex_t IT_0207 = IT_0204 + IT_0206;
    const ccomplex_t IT_0208 = s_34*IT_0147;
    const ccomplex_t IT_0209 = IT_0066*IT_0208;
    const ccomplex_t IT_0210 = (-0.25)*IT_0209;
    const ccomplex_t IT_0211 = s_34 + IT_0210;
    const ccomplex_t IT_0212 = m_N_1*IT_0211;
    const ccomplex_t IT_0213 = (-4)*IT_0212;
    const ccomplex_t IT_0214 = m_N_1*IT_0050;
    const ccomplex_t IT_0215 = m_N_1*IT_0037;
    const ccomplex_t IT_0216 = m_b*IT_0167;
    const ccomplex_t IT_0217 = IT_0214 + IT_0215 + -IT_0216;
    const ccomplex_t IT_0218 = IT_0047*IT_0115;
    const ccomplex_t IT_0219 = IT_0038*IT_0188*IT_0218;
    const ccomplex_t IT_0220 = IT_0034*IT_0135;
    const ccomplex_t IT_0221 = IT_0025*IT_0202*IT_0220;
    const ccomplex_t IT_0222 = -IT_0219 + -IT_0221;
    const ccomplex_t IT_0223 = IT_0217 + IT_0222;
    const ccomplex_t IT_0224 = 6*conj(IT_0104)*(IT_0065*IT_0108 + -IT_0146
      *IT_0149 + IT_0150*IT_0167 + IT_0168*IT_0172 + 0.166666666666667*IT_0104
      *IT_0180 + IT_0186*IT_0207 + IT_0213*IT_0223);
    const ccomplex_t IT_0225 = (-18)*conj(IT_0204);
    const ccomplex_t IT_0226 = s_14*s_34*IT_0066;
    const ccomplex_t IT_0227 = -IT_0226;
    const ccomplex_t IT_0228 = s_13 + IT_0227;
    const ccomplex_t IT_0229 = s_13*IT_0228;
    const ccomplex_t IT_0230 = 2*IT_0128 + 2*IT_0145;
    const ccomplex_t IT_0231 = IT_0086 + IT_0100 + 2*IT_0167;
    const ccomplex_t IT_0232 = IT_0102*IT_0228;
    const ccomplex_t IT_0233 = m_N_1*IT_0228;
    const ccomplex_t IT_0234 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0235 = 0.5*IT_0209;
    const ccomplex_t IT_0236 = s_34 + IT_0235;
    const ccomplex_t IT_0237 = m_N_1*IT_0236;
    const ccomplex_t IT_0238 = 2*IT_0237;
    const ccomplex_t IT_0239 = (-2)*IT_0176;
    const ccomplex_t IT_0240 = IT_0178 + IT_0239;
    const ccomplex_t IT_0241 = IT_0066*IT_0240;
    const ccomplex_t IT_0242 = (-6)*IT_0241;
    const ccomplex_t IT_0243 = 12*s_13;
    const ccomplex_t IT_0244 = IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = m_b*IT_0228;
    const ccomplex_t IT_0246 = (-6)*IT_0168;
    ...
    const ccomplex_t IT_0251 = IT_0102*IT_0250;
    const ccomplex_t IT_0252 = m_N_1*IT_0250;
    const ccomplex_t IT_0253 = (-6)*conj(IT_0168);
    const ccomplex_t IT_0254 = (-6)*IT_0175;
    const ccomplex_t IT_0255 = IT_0177 + IT_0254;
    const ccomplex_t IT_0256 = (-6)*IT_0101;
    const ccomplex_t IT_0257 = 0.166666666666667*IT_0256;
    const ccomplex_t IT_0258 = IT_0230 + IT_0257;
    const ccomplex_t IT_0259 = (-0.25)*IT_0182;
    const ccomplex_t IT_0260 = s_14 + IT_0259;
    const ccomplex_t IT_0261 = m_b*IT_0260;
    const ccomplex_t IT_0262 = (-4)*IT_0261;
    const ccomplex_t IT_0263 = (-6)*IT_0231;
    const ccomplex_t IT_0264 = IT_0146 + IT_0167;
    const ccomplex_t IT_0265 = (-6)*conj(IT_0231);
    const ccomplex_t IT_0266 = (-6)*IT_0204;
    const ccomplex_t IT_0267 = (-6)*conj(IT_0146)*(IT_0104*IT_0149 + (
      -0.166666666666667)*IT_0146*IT_0180 + IT_0186*IT_0223 + (
      -0.166666666666667)*IT_0167*IT_0255 + -IT_0108*IT_0258 + (
      -0.166666666666667)*IT_0172*IT_0263 + IT_0213*(IT_0206 + (
      -0.166666666666667)*IT_0266));
    const ccomplex_t IT_0268 = (-6)*conj(IT_0204);
    const ccomplex_t IT_0269 = (-6)*conj(IT_0230);
    const ccomplex_t IT_0270 = m_b*IT_0070;
    const ccomplex_t IT_0271 = 6*IT_0270;
    const ccomplex_t IT_0272 = (-6)*IT_0065;
    const ccomplex_t IT_0273 = 6*IT_0104;
    const ccomplex_t IT_0274 = (-6)*IT_0230;
    const ccomplex_t IT_0275 = 6*IT_0167;
    const ccomplex_t IT_0276 = (-6)*IT_0146;
    const ccomplex_t IT_0277 = IT_0102*((-18)*IT_0204 + (-18)*IT_0206) +
       IT_0223*IT_0244 + IT_0246*IT_0252 + IT_0245*IT_0263 + IT_0233*IT_0272 +
       IT_0213*IT_0273 + IT_0271*(IT_0101 + 0.166666666666667*IT_0274) + IT_0262
      *IT_0275 + IT_0186*IT_0276;
    const ccomplex_t IT_0278 = IT_0102*((-18)*IT_0217 + (-18)*IT_0222) +
       IT_0207*IT_0244 + IT_0245*IT_0246 + 6*IT_0233*IT_0258 + IT_0252*IT_0263 +
       6*IT_0065*IT_0270 + IT_0186*IT_0273 + IT_0238*IT_0275 + IT_0213*IT_0276;
    const ccomplex_t IT_0279 = 0.166666666666667*IT_0232;
    const ccomplex_t IT_0280 = s_13*IT_0250;
    const ccomplex_t IT_0281 = 0.166666666666667*IT_0280;
    const ccomplex_t IT_0282 = (-6)*conj(IT_0101);
    const ccomplex_t IT_0283 = IT_0108*IT_0264;
    const ccomplex_t IT_0284 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0101
      *IT_0103 + IT_0104*IT_0108) + IT_0224 + IT_0102*IT_0223*IT_0225 + (IT_0168
      *IT_0229 + IT_0103*IT_0230 + IT_0231*IT_0232 + IT_0223*IT_0233)*IT_0234 +
       6*conj(IT_0204)*(IT_0104*IT_0186 + IT_0230*IT_0233 + IT_0167*IT_0238 +
       0.166666666666667*IT_0207*IT_0244 + 0.166666666666667*IT_0245*IT_0246) + 
      (IT_0101*IT_0232 + IT_0207*IT_0245 + IT_0231*IT_0251 + IT_0223*IT_0252)
      *IT_0253 + 6*conj(IT_0167)*(IT_0104*IT_0150 + 0.166666666666667*IT_0167
      *IT_0180 + IT_0207*IT_0238 + 0.166666666666667*IT_0146*IT_0255 + IT_0108
      *IT_0258 + IT_0223*IT_0262 + 0.166666666666667*IT_0172*IT_0263) + (IT_0223
      *IT_0245 + IT_0206*IT_0252 + IT_0172*IT_0264)*IT_0265 + IT_0267 + (IT_0146
      *IT_0213 + IT_0101*IT_0233 + IT_0231*IT_0252)*IT_0268 + (IT_0065*conj
      (IT_0204) + conj(IT_0065)*IT_0207 + IT_0223*(conj(IT_0101) +
       0.166666666666667*IT_0269))*IT_0271 + (conj(IT_0217) + conj(IT_0222))
      *IT_0277 + conj(IT_0206)*IT_0278 + 6*conj(IT_0101)*(IT_0071*IT_0101 +
       IT_0065*IT_0103 + 0.166666666666667*IT_0233*IT_0266 + IT_0246*IT_0279) +
       6*conj(IT_0168)*(IT_0104*IT_0172 + IT_0230*IT_0232 + 0.166666666666667
      *IT_0229*IT_0272 + IT_0246*IT_0281) + 6*conj(IT_0231)*(0.166666666666667
      *IT_0246*IT_0251 + IT_0229*IT_0258 + 0.166666666666667*IT_0252*IT_0266 +
       IT_0272*IT_0279 + IT_0263*IT_0281) + IT_0282*(IT_0071*IT_0230 + IT_0229
      *IT_0231 + IT_0206*IT_0233 + IT_0283) + 6*conj(IT_0230)*(IT_0229*IT_0231 +
       IT_0168*IT_0232 + IT_0207*IT_0233 + IT_0071*IT_0258 + 0.166666666666667
      *IT_0103*IT_0272 + IT_0283);
