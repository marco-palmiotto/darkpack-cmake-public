...
ccomplex_return_t c_sumSqAmpl_N_1_st_2_to_t_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = N_B1*e_em*U_st_11;
    ...
    const ccomplex_t IT_0037 = m_t*conj(N_u1)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0056 = m_t*s_14*m_N_1;
    ...
    const ccomplex_t IT_0068 = m_t*m_N_1;
    ...
    const ccomplex_t IT_0073 = m_t*s_34*m_N_1;
