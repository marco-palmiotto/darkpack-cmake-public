        ...
        )
{
    ...
    const ccomplex_t IT_0020 = e_em*conj(U_Wm2)*U_stau_00;
    ...
    const ccomplex_t IT_0025 = conj(U_d2)*e_em*m_tau*IT_0024*U_stau_10;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*(A_tau*IT_0034*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0002*(m_W*IT_0000*IT_0034*U_stau_00 + (-0.5)
      *m_tau*IT_0024*(m_tau*IT_0022*IT_0034*U_stau_00 + mu_h*U_stau_10)));
    ...
    const ccomplex_t IT_0064 = conj(U_d1)*e_em*m_tau*IT_0024*U_stau_10;
