        ...
        )
{
    ...
    const ccomplex_t IT_0009 = e_em*conj(U_Wm2)*U_stau_00;
    ...
    const ccomplex_t IT_0015 = conj(U_d2)*e_em*m_tau*IT_0014*U_stau_10;
    ...
    const ccomplex_t IT_0024 = conj(N_W1)*e_em*U_Wm1;
    const ccomplex_t IT_0025 = IT_0001*IT_0024;
    const ccomplex_t IT_0026 = conj(N_d1)*U_d1*e_em;
    ...
    const ccomplex_t IT_0031 = e_em*conj(U_Wm1)*U_stau_00;
    const ccomplex_t IT_0032 = IT_0001*IT_0031;
    const ccomplex_t IT_0033 = conj(U_d1)*e_em*m_tau*IT_0014*U_stau_10;
    ...
    const ccomplex_t IT_0044 = N_W1*e_em*conj(V_Wp1);
    const ccomplex_t IT_0045 = IT_0001*IT_0044;
    const ccomplex_t IT_0046 = N_u1*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0061 = N_d1*e_em*m_tau*IT_0014*U_stau_00;
    ...
    const ccomplex_t IT_0067 = pow(m_N_1, 2);
    ...
    const ccomplex_t IT_0072 = N_W1*e_em*conj(V_Wp2);
    const ccomplex_t IT_0073 = IT_0001*IT_0072;
    const ccomplex_t IT_0074 = N_u1*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0083 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0084 = IT_0057*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0087 = IT_0001*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = conj(N_d1)*e_em*m_tau*IT_0014*U_stau_10;
    ...
    const ccomplex_t IT_0107 = m_N_1*IT_0098*IT_0106;
    ...
    const ccomplex_t IT_0118 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0173 = (-2)*(conj(IT_0043) + conj(IT_0082))*IT_0140 +
       IT_0144*(conj(IT_0122)*IT_0149 + IT_0122*IT_0152) + IT_0156*((conj
      (IT_0097) + conj(IT_0134))*IT_0149 + IT_0152*IT_0157) + ((conj(IT_0043) +
       conj(IT_0082))*IT_0149 + IT_0132*IT_0152)*IT_0158 + (-2)*((-0.5)*conj
      ...
      *IT_0132 + IT_0157*IT_0171)*IT_0172;
