        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_B1*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0017 = N_d1*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0039 = conj(N_d1)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0051 = IT_0004*IT_0048;
