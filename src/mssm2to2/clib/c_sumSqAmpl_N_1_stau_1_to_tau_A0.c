        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B1*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0023 = N_d1*e_em*m_tau*IT_0002*U_stau_01;
    ...
    const ccomplex_t IT_0034 = IT_0016*IT_0020;
    const ccomplex_t IT_0035 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = IT_0007*IT_0016;
    const ccomplex_t IT_0038 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = IT_0001*IT_0020;
    const ccomplex_t IT_0041 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = IT_0001*IT_0007;
    ...
    const ccomplex_t IT_0062 = N_d1*e_em*m_tau*IT_0002*U_stau_00;
    ...
    const ccomplex_t IT_0072 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0073 = IT_0016*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = N_d3*e_em*m_tau*IT_0002*U_stau_00;
    ...
    const ccomplex_t IT_0085 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0086 = IT_0037*IT_0085;
    const ccomplex_t IT_0087 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0088 = IT_0040*IT_0087;
    const ccomplex_t IT_0089 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0090 = IT_0043*IT_0089;
    const ccomplex_t IT_0091 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0092 = IT_0034*IT_0091;
    const ccomplex_t IT_0093 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0094 = IT_0037*IT_0093;
    const ccomplex_t IT_0095 = N_W1*N_u3*e_em;
    ...
    const ccomplex_t IT_0121 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0122 = IT_0016*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = N_d4*e_em*m_tau*IT_0002*U_stau_00;
    ...
    const ccomplex_t IT_0132 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0133 = IT_0034*IT_0132;
    const ccomplex_t IT_0134 = N_B4*N_d1*e_em;
    ...
    const ccomplex_t IT_0140 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0141 = IT_0034*IT_0140;
    const ccomplex_t IT_0142 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0143 = IT_0037*IT_0142;
    const ccomplex_t IT_0144 = N_W1*N_u4*e_em;
    ...
    const ccomplex_t IT_0149 = m_N_4*IT_0148;
    const ccomplex_t IT_0150 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0151 = IT_0034*IT_0150;
    const ccomplex_t IT_0152 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0158 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0159 = IT_0034*IT_0158;
    const ccomplex_t IT_0160 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0161 = IT_0037*IT_0160;
    const ccomplex_t IT_0162 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0163 = IT_0040*IT_0162;
    const ccomplex_t IT_0164 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0170 = cpow(s_13 + (-0.5)*IT_0029 + (-0.5)*IT_0030 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0171 = e_em*mu_h*m_tau*IT_0002*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0172 = IT_0001*IT_0171;
    const ccomplex_t IT_0173 = e_em*mu_h*m_tau*IT_0002*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0174 = IT_0001*IT_0173;
    const ccomplex_t IT_0175 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0176 = IT_0007*IT_0175;
    const ccomplex_t IT_0177 = 1.4142135623731*IT_0176;
    const ccomplex_t IT_0178 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0188 = N_d2*e_em*m_tau*IT_0002*U_stau_00;
    ...
    const ccomplex_t IT_0193 = cpow(s_23 + (-0.5)*IT_0030 + (-0.5)*IT_0067 +
    ...
    const ccomplex_t IT_0196 = N_B2*N_u1*e_em;
    ...
    const ccomplex_t IT_0202 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0203 = IT_0043*IT_0202;
    const ccomplex_t IT_0204 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0205 = IT_0034*IT_0204;
    const ccomplex_t IT_0206 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0207 = IT_0037*IT_0206;
    const ccomplex_t IT_0208 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0209 = IT_0040*IT_0208;
    const ccomplex_t IT_0210 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0219 = IT_0040*IT_0218;
    const ccomplex_t IT_0220 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0221 = IT_0043*IT_0220;
    ...
    const ccomplex_t IT_0234 = (-0.5)*IT_0033 + (-0.5)*IT_0071 + (-0.5)
      *IT_0120 + (-0.5)*IT_0169 + (-0.5)*IT_0184 + (-0.5)*IT_0233;
    const ccomplex_t IT_0235 = m_N_1*IT_0212;
    const ccomplex_t IT_0236 = m_N_2*IT_0230;
    const ccomplex_t IT_0237 = IT_0235 + IT_0236;
    const ccomplex_t IT_0238 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0239 = IT_0016*IT_0238;
    const ccomplex_t IT_0240 = 1.4142135623731*IT_0239;
    const ccomplex_t IT_0241 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0242 = IT_0001*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = conj(N_d2)*e_em*m_tau*IT_0002*U_stau_10;
    ...
    const ccomplex_t IT_0251 = IT_0237*IT_0250;
    const ccomplex_t IT_0252 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0253 = IT_0016*IT_0252;
    const ccomplex_t IT_0254 = 1.4142135623731*IT_0253;
    const ccomplex_t IT_0255 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0256 = IT_0001*IT_0255;
    const ccomplex_t IT_0257 = 1.4142135623731*IT_0256;
    const ccomplex_t IT_0258 = conj(N_d1)*e_em*m_tau*IT_0002*U_stau_10;
    ...
    const ccomplex_t IT_0308 = IT_0129*IT_0307;
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*IT_0308;
    const ccomplex_t IT_0310 = m_N_1*IT_0148;
    const ccomplex_t IT_0311 = m_N_4*IT_0166;
    const ccomplex_t IT_0312 = IT_0310 + IT_0311;
    const ccomplex_t IT_0313 = IT_0309*IT_0312;
    const ccomplex_t IT_0314 = IT_0068*IT_0262;
    const ccomplex_t IT_0315 = (0 + _Complex_I*1)*IT_0314;
    const ccomplex_t IT_0316 = IT_0058*IT_0315;
    const ccomplex_t IT_0317 = 0.5*IT_0251 + 0.5*IT_0265 + 0.5*IT_0279 + 0.5
      *IT_0296 + 0.5*IT_0313 + 0.5*IT_0316;
    const ccomplex_t IT_0318 = 2*s_13;
    const ccomplex_t IT_0319 = m_N_1*m_tau;
    const ccomplex_t IT_0320 = 2*IT_0234;
    const ccomplex_t IT_0321 = IT_0148*IT_0309;
    const ccomplex_t IT_0322 = cpow(s_12 + 0.5*IT_0029 + (-0.5)*IT_0030 + 0.5
      *IT_0067 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0323 = e_em*m_tau*IT_0001*IT_0002*IT_0007*IT_0021;
    ...
    const ccomplex_t IT_0328 = IT_0099*IT_0295;
    const ccomplex_t IT_0329 = IT_0046*IT_0315;
    const ccomplex_t IT_0330 = IT_0212*IT_0250;
    const ccomplex_t IT_0331 = (-0.5)*IT_0321 + 0.5*IT_0327 + (-0.5)*IT_0328 +
       (-0.5)*IT_0329 + (-0.5)*IT_0330;
    const ccomplex_t IT_0332 = s_14*m_tau;
    const ccomplex_t IT_0333 = IT_0082*IT_0117;
    const ccomplex_t IT_0334 = IT_0131*IT_0166;
    const ccomplex_t IT_0335 = IT_0262*IT_0324;
    const ccomplex_t IT_0336 = IT_0322*IT_0335;
    const ccomplex_t IT_0337 = (0 + _Complex_I*1)*IT_0336;
    const ccomplex_t IT_0338 = IT_0056*IT_0070;
    const ccomplex_t IT_0339 = IT_0195*IT_0230;
    const ccomplex_t IT_0340 = 0.5*IT_0333 + 0.5*IT_0334 + 0.5*IT_0337 + 0.5
      *IT_0338 + 0.5*IT_0339;
