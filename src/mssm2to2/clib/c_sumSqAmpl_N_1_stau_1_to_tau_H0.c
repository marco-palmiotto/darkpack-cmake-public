        ...
        )
{
    ...
    const ccomplex_t IT_0078 = N_d1*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0095 = cpow(s_13 + (-0.5)*IT_0016 + (-0.5)*IT_0073 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0096 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0097 = IT_0001*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = N_d1*e_em*m_tau*IT_0010*U_stau_01;
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*(IT_0111 + -IT_0113 + 
      -IT_0115 + IT_0117);
    const ccomplex_t IT_0119 = m_N_1*IT_0118;
    const ccomplex_t IT_0120 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0124 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0180 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0181 = IT_0001*IT_0180;
    const ccomplex_t IT_0182 = 1.4142135623731*IT_0181;
    const ccomplex_t IT_0183 = N_d2*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0195 = N_d4*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0252 = IT_0082*IT_0251;
    ...
    const ccomplex_t IT_0263 = conj(N_d1)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0268 = IT_0131*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0130*IT_0269;
    const ccomplex_t IT_0271 = m_N_1*IT_0155;
    const ccomplex_t IT_0272 = m_N_2*IT_0177;
    ...
    const ccomplex_t IT_0280 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0292 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))*conj
      (U_stau_00) + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_10)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_00) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)
    ...
    const ccomplex_t IT_0326 = IT_0018*IT_0325;
    const ccomplex_t IT_0327 = (0 + _Complex_I*1)*IT_0326;
    const ccomplex_t IT_0328 = m_N_1*IT_0047;
    const ccomplex_t IT_0329 = m_N_3*IT_0069;
    ...
    const ccomplex_t IT_0353 = IT_0223*IT_0344;
    const ccomplex_t IT_0354 = IT_0118*IT_0269;
    const ccomplex_t IT_0355 = IT_0155*IT_0286;
    const ccomplex_t IT_0356 = IT_0047*IT_0327;
    const ccomplex_t IT_0357 = 0.5*IT_0254 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0202*IT_0245;
    const ccomplex_t IT_0360 = IT_0177*IT_0190;
    const ccomplex_t IT_0361 = IT_0020*IT_0069;
    const ccomplex_t IT_0362 = IT_0128*IT_0133;
