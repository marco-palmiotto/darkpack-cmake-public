        ...
        )
{
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
    ...
    const ccomplex_t IT_0037 = N_d1*e_em*m_tau*IT_0020*U_stau_00;
    ...
    const ccomplex_t IT_0043 = cpow(s_13 + (-0.5)*IT_0026 + (-0.5)*IT_0042 + (
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
    ...
    const ccomplex_t IT_0052 = N_d1*e_em*m_tau*IT_0020*U_stau_01;
    ...
    const ccomplex_t IT_0057 = cpow(s_13 + (-0.5)*IT_0026 + (-0.5)*IT_0042 + (
    ...
    const ccomplex_t IT_0061 = N_u1*conj(N_u1)*e_em;
    const ccomplex_t IT_0062 = IT_0003*IT_0061;
    const ccomplex_t IT_0063 = IT_0007*IT_0061;
    const ccomplex_t IT_0064 = N_d1*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0069 = cpow(s_23 + (-0.5)*IT_0026 + (-0.5)*IT_0027 +
    ...
    const ccomplex_t IT_0073 = 0.5*IT_0067;
    ...
    const ccomplex_t IT_0083 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0084 = IT_0001*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = N_d2*e_em*m_tau*IT_0020*U_stau_00;
    ...
    const ccomplex_t IT_0091 = cpow(s_23 + (-0.5)*IT_0026 + (-0.5)*IT_0027 +
    ...
    const ccomplex_t IT_0103 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0104 = IT_0001*IT_0103;
    const ccomplex_t IT_0105 = 1.4142135623731*IT_0104;
    const ccomplex_t IT_0106 = N_d4*e_em*m_tau*IT_0020*U_stau_00;
    ...
    const ccomplex_t IT_0115 = -IT_0031 + (-0.5)*IT_0046 + (-0.5)*IT_0060 + (
      -0.5)*IT_0072 + 0.5*IT_0074 + -IT_0094 + -IT_0114;
    ...
    const ccomplex_t IT_0122 = conj(N_d1)*N_d4*e_em;
    const ccomplex_t IT_0123 = IT_0003*IT_0122;
    const ccomplex_t IT_0124 = IT_0007*IT_0122;
    const ccomplex_t IT_0125 = conj(N_u1)*N_u4*e_em;
    ...
    const ccomplex_t IT_0158 = conj(N_d1)*N_d2*e_em;
    const ccomplex_t IT_0159 = IT_0003*IT_0158;
    const ccomplex_t IT_0160 = IT_0007*IT_0158;
    const ccomplex_t IT_0161 = conj(N_u1)*N_u2*e_em;
    ...
    const ccomplex_t IT_0172 = conj(N_d2)*e_em*m_tau*IT_0020*U_stau_10;
    ...
    const ccomplex_t IT_0203 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0204 = IT_0001*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0207 = IT_0006*IT_0206;
    const ccomplex_t IT_0208 = 1.4142135623731*IT_0207;
    const ccomplex_t IT_0209 = conj(N_d3)*e_em*m_tau*IT_0020*U_stau_10;
    const ccomplex_t IT_0210 = IT_0019*IT_0209;
    ...
    const ccomplex_t IT_0216 = IT_0202*IT_0215;
    const ccomplex_t IT_0217 = IT_0043*IT_0190;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*IT_0217;
    const ccomplex_t IT_0219 = IT_0033*IT_0218;
    const ccomplex_t IT_0220 = IT_0143 + 0.5*IT_0157 + IT_0179 + (-0.5)
      *IT_0193 + 0.5*IT_0194 + IT_0216 + 0.5*IT_0219;
    const ccomplex_t IT_0221 = m_N_1*m_tau;
    const ccomplex_t IT_0222 = IT_0120*IT_0221;
    const ccomplex_t IT_0223 = 0.5*IT_0031 + 0.25*IT_0072 + (-0.25)*IT_0074 +
       0.5*IT_0094 + 0.5*IT_0114;
    ...
    const ccomplex_t IT_0229 = m_N_1*IT_0073;
    const ccomplex_t IT_0230 = IT_0192*IT_0229;
    const ccomplex_t IT_0231 = (-0.25)*IT_0230;
    const ccomplex_t IT_0232 = e_em*IT_0003;
    const ccomplex_t IT_0233 = e_em*IT_0007;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1)*(IT_0232 + -IT_0233);
    const ccomplex_t IT_0235 = 0.5*IT_0234;
    const ccomplex_t IT_0236 = IT_0041*IT_0235;
    ...
    const ccomplex_t IT_0240 = m_N_3*IT_0013;
    const ccomplex_t IT_0241 = m_N_1*IT_0202;
    const ccomplex_t IT_0242 = -IT_0241;
    const ccomplex_t IT_0243 = IT_0240 + IT_0242;
    const ccomplex_t IT_0244 = IT_0215*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0002;
    const ccomplex_t IT_0246 = IT_0041*IT_0245;
    const ccomplex_t IT_0247 = IT_0237*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = m_tau*IT_0248;
    const ccomplex_t IT_0250 = m_N_1*IT_0068;
    const ccomplex_t IT_0251 = IT_0192*IT_0250;
    const ccomplex_t IT_0252 = -IT_0229;
    const ccomplex_t IT_0253 = IT_0250 + IT_0252;
    const ccomplex_t IT_0254 = IT_0192*IT_0253;
    const ccomplex_t IT_0255 = m_N_2*IT_0082;
    const ccomplex_t IT_0256 = m_N_1*IT_0165;
    const ccomplex_t IT_0257 = -IT_0256;
    const ccomplex_t IT_0258 = IT_0255 + IT_0257;
    const ccomplex_t IT_0259 = IT_0178*IT_0258;
    const ccomplex_t IT_0260 = m_N_4*IT_0102;
    const ccomplex_t IT_0261 = m_N_1*IT_0129;
    const ccomplex_t IT_0262 = -IT_0261;
    const ccomplex_t IT_0263 = IT_0260 + IT_0262;
    const ccomplex_t IT_0264 = IT_0142*IT_0263;
    const ccomplex_t IT_0265 = 0.5*IT_0239 + 0.5*IT_0244 + (-0.5)*IT_0249 +
       0.25*IT_0251 + 0.25*IT_0254 + 0.5*IT_0259 + 0.5*IT_0264;
    ...
    const ccomplex_t IT_0276 = 0.5*IT_0046 + 0.5*IT_0060 + IT_0248;
    ...
    const ccomplex_t IT_0281 = IT_0190*IT_0235;
    const ccomplex_t IT_0282 = IT_0237*IT_0281;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1)*IT_0282;
    const ccomplex_t IT_0284 = (-0.5)*IT_0157 + (-0.5)*IT_0219 + -IT_0283;
    const ccomplex_t IT_0285 = IT_0221*IT_0279;
    const ccomplex_t IT_0286 = 0.5*IT_0248;
    const ccomplex_t IT_0287 = m_N_1*IT_0279;
    const ccomplex_t IT_0288 = IT_0071*IT_0250;
    const ccomplex_t IT_0289 = 0.25*IT_0288;
    const ccomplex_t IT_0290 = IT_0190*IT_0245;
    const ccomplex_t IT_0291 = IT_0237*IT_0238*IT_0290;
    const ccomplex_t IT_0292 = m_N_4*IT_0129;
    const ccomplex_t IT_0293 = m_N_1*IT_0102;
    const ccomplex_t IT_0294 = -IT_0293;
    const ccomplex_t IT_0295 = IT_0292 + IT_0294;
    const ccomplex_t IT_0296 = IT_0113*IT_0295;
    const ccomplex_t IT_0297 = m_N_2*IT_0165;
    const ccomplex_t IT_0298 = m_N_1*IT_0082;
    const ccomplex_t IT_0299 = -IT_0298;
    const ccomplex_t IT_0300 = IT_0297 + IT_0299;
    const ccomplex_t IT_0301 = IT_0093*IT_0300;
    const ccomplex_t IT_0302 = m_N_3*IT_0202;
    const ccomplex_t IT_0303 = m_N_1*IT_0013;
    const ccomplex_t IT_0304 = -IT_0303;
    const ccomplex_t IT_0305 = IT_0302 + IT_0304;
    const ccomplex_t IT_0306 = IT_0030*IT_0305;
    const ccomplex_t IT_0307 = m_tau*IT_0283;
    const ccomplex_t IT_0308 = IT_0071*IT_0229;
    const ccomplex_t IT_0309 = IT_0071*IT_0253;
    const ccomplex_t IT_0310 = (-0.5)*IT_0291 + (-0.5)*IT_0296 + (-0.5)
      *IT_0301 + (-0.5)*IT_0306 + 0.5*IT_0307 + (-0.25)*IT_0308 + 0.25*IT_0309;
    ...
    const ccomplex_t IT_0329 = (-0.5)*IT_0143 + (-0.5)*IT_0179 + 0.25*IT_0193 
      + (-0.25)*IT_0194 + (-0.5)*IT_0216;
    const ccomplex_t IT_0330 = s_34*IT_0267;
    const ccomplex_t IT_0331 = IT_0116*IT_0330;
    const ccomplex_t IT_0332 = (-0.25)*IT_0331;
    const ccomplex_t IT_0333 = s_34 + IT_0332;
    ...
    const ccomplex_t IT_0355 = conj(IT_0115)*IT_0228 + conj(IT_0284)*IT_0323 +
       conj(IT_0329)*IT_0335 + conj(IT_0325)*IT_0339 + conj(IT_0223)*IT_0345 +
    ...
    const ccomplex_t IT_0375 = (-0.333333333333333)*conj(IT_0223);
    const ccomplex_t IT_0376 = (-0.333333333333333)*conj(IT_0286);
    const ccomplex_t IT_0377 = (-0.333333333333333)*conj(IT_0329);
    ...
    const ccomplex_t IT_0382 = (-2)*IT_0289*(conj(IT_0284)*IT_0327 + 3*IT_0373
       + 3*IT_0374 + 3*IT_0335*IT_0375 + 3*IT_0339*IT_0376 + 3*IT_0378 + 3
    ...
    const ccomplex_t IT_0384 = conj(IT_0115)*IT_0228 + 2*IT_0266*IT_0274 +
       conj(IT_0284)*IT_0323 + (-3)*IT_0221*IT_0352 + (-3)*IT_0345*IT_0375 + (-3
      )*IT_0349*IT_0376 + (-3)*IT_0335*IT_0377 + (-3)*IT_0339*IT_0379 + (-3)
    ...
    const ccomplex_t IT_0385 = 2*IT_0115*(conj(IT_0115)*IT_0121 + conj(IT_0220
      ...
      *conj(IT_0325))*IT_0326 + (conj(IT_0220)*IT_0285 + conj(IT_0223)*IT_0322 +
       ...
       IT_0322*conj(IT_0329))*IT_0356 + 2*IT_0284*(conj(IT_0284)*IT_0317 + conj
      ...
      *conj(IT_0329) + IT_0354*IT_0357) + 2*IT_0286*(conj(IT_0276)*IT_0322 +
       IT_0311*IT_0339 + IT_0266*IT_0349 + conj(IT_0325)*IT_0359 + conj(IT_0329)
      *IT_0360 + (-2)*conj(IT_0286)*IT_0365 + (-4)*conj(IT_0223)*IT_0367 +
       IT_0324*IT_0368) + 2*IT_0325*(conj(IT_0284)*IT_0322 + IT_0266*IT_0339 +
       IT_0311*IT_0349 + conj(IT_0286)*IT_0359 + conj(IT_0223)*IT_0360 + (-2)
      *conj(IT_0325)*IT_0365 + (-4)*conj(IT_0329)*IT_0367 + IT_0353*IT_0368) + 2
      *IT_0223*(conj(IT_0115)*IT_0227 + IT_0311*IT_0335 + IT_0266*IT_0345 + conj
      (IT_0329)*IT_0359 + conj(IT_0325)*IT_0360 + (-2)*conj(IT_0223)*IT_0365 + (
      -4)*conj(IT_0286)*IT_0367 + IT_0354*IT_0369) + 2*IT_0329*(conj(IT_0220)
      *IT_0227 + IT_0266*IT_0335 + IT_0311*IT_0345 + conj(IT_0223)*IT_0359 +
       conj(IT_0286)*IT_0360 + (-2)*conj(IT_0329)*IT_0365 + (-4)*conj(IT_0325)
      *IT_0367 + IT_0369*IT_0370) + IT_0382 + (-6)*IT_0310*(IT_0373 + IT_0374 +
       IT_0335*IT_0375 + IT_0339*IT_0376 + IT_0378 + IT_0380 + IT_0324*IT_0381 +
