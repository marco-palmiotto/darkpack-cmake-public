        ...
        )
{
    ...
    const ccomplex_t IT_0074 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0075 = IT_0008*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*IT_0075;
    const ccomplex_t IT_0077 = N_d1*e_em*m_tau*IT_0024*U_stau_01;
    ...
    const ccomplex_t IT_0094 = conj(N_d1)*e_em*m_tau*IT_0024*U_stau_11;
