...
ccomplex_return_t c_sumSqAmpl_N_1_stau_2_to_nu_tau_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = conj(N_u1)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0010 = conj(N_B1)*conj(V_u2)*e_em;
    const ccomplex_t IT_0011 = IT_0009*IT_0010;
    const ccomplex_t IT_0012 = 1.4142135623731*IT_0011;
    const ccomplex_t IT_0013 = conj(N_W1)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*(A_tau*IT_0034*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0002*(m_W*IT_0000*IT_0034*U_stau_01 + (-0.5)
      *m_tau*IT_0024*(m_tau*IT_0022*IT_0034*U_stau_01 + mu_h*U_stau_11)));
    ...
    const ccomplex_t IT_0062 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0063 = IT_0002*IT_0062;
    const ccomplex_t IT_0064 = conj(U_d1)*e_em*m_tau*IT_0024*U_stau_11;
    ...
    const ccomplex_t IT_0070 = cpow(s_23 + (-0.5)*IT_0031 + 0.5*m_C_1*(m_C_1 +
    ...
    const ccomplex_t IT_0073 = cpow(s_12 + 0.5*IT_0031 + 0.5*IT_0045 + (-0.5)
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0002*IT_0022*IT_0024*IT_0034;
    const ccomplex_t IT_0076 = 0.5*IT_0075;
    const ccomplex_t IT_0077 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0078 = IT_0008*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0081 = IT_0002*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = conj(N_d1)*e_em*m_tau*IT_0024*U_stau_11;
    ...
    const ccomplex_t IT_0093 = N_d1*e_em*m_tau*IT_0024*U_stau_01;
    ...
    const ccomplex_t IT_0102 = (-0.5)*IT_0033 + 0.5*IT_0048 + (-0.5)*IT_0071 +
       (-0.5)*IT_0089 + 0.5*IT_0101;
    const ccomplex_t IT_0103 = IT_0002*IT_0034;
    const ccomplex_t IT_0104 = N_d1*e_em*U_Wm1;
    const ccomplex_t IT_0105 = IT_0103*IT_0104;
    const ccomplex_t IT_0106 = (-2)*IT_0105;
    const ccomplex_t IT_0107 = IT_0008*IT_0034;
