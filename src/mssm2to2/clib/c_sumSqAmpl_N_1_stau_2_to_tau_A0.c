        ...
        )
{
    ...
    const ccomplex_t IT_0019 = e_em*mu_h*m_tau*IT_0013*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0020 = IT_0011*IT_0019;
    const ccomplex_t IT_0021 = e_em*mu_h*m_tau*IT_0013*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0022 = IT_0011*IT_0021;
    const ccomplex_t IT_0023 = sin(beta);
    const ccomplex_t IT_0024 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*IT_0025;
    const ccomplex_t IT_0027 = A_tau*conj(U_stau_00)*U_stau_11;
    const ccomplex_t IT_0028 = IT_0023*IT_0027;
    const ccomplex_t IT_0029 = 1.4142135623731*IT_0028;
    const ccomplex_t IT_0030 = 0.5*IT_0020 + (-0.5)*IT_0022 + 0.5*IT_0026 + (
      -0.5)*IT_0029;
    ...
    const ccomplex_t IT_0043 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0042 +
    ...
    const ccomplex_t IT_0049 = IT_0004*IT_0023;
    ...
    const ccomplex_t IT_0055 = IT_0011*IT_0023;
    ...
    const ccomplex_t IT_0091 = N_d3*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0096 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0042 +
    ...
    const ccomplex_t IT_0140 = N_d4*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0145 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0042 +
    ...
    const ccomplex_t IT_0186 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0187 = IT_0046*IT_0186;
    const ccomplex_t IT_0188 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0189 = IT_0049*IT_0188;
    const ccomplex_t IT_0190 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0191 = IT_0052*IT_0190;
    const ccomplex_t IT_0192 = N_W1*N_d1*e_em;
    const ccomplex_t IT_0193 = IT_0055*IT_0192;
    const ccomplex_t IT_0194 = -IT_0187 + IT_0189 + IT_0191 + -IT_0193;
    const ccomplex_t IT_0195 = m_N_1*IT_0194;
    const ccomplex_t IT_0196 = conj(N_B1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0197 = IT_0046*IT_0196;
    const ccomplex_t IT_0198 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0199 = IT_0049*IT_0198;
    const ccomplex_t IT_0200 = conj(N_W1)*conj(N_u1)*e_em;
    const ccomplex_t IT_0201 = IT_0052*IT_0200;
    const ccomplex_t IT_0202 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0207 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0208 = IT_0004*IT_0207;
    const ccomplex_t IT_0209 = 1.4142135623731*IT_0208;
    const ccomplex_t IT_0210 = N_d1*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0215 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0042 +
    ...
    const ccomplex_t IT_0219 = e_em*mu_h*m_tau*IT_0013*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0220 = IT_0011*IT_0219;
    const ccomplex_t IT_0221 = e_em*mu_h*m_tau*IT_0013*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0222 = IT_0011*IT_0221;
    const ccomplex_t IT_0223 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0224 = IT_0023*IT_0223;
    const ccomplex_t IT_0225 = 1.4142135623731*IT_0224;
    const ccomplex_t IT_0226 = A_tau*U_stau_01*conj(U_stau_11);
    const ccomplex_t IT_0227 = IT_0023*IT_0226;
    const ccomplex_t IT_0228 = 1.4142135623731*IT_0227;
    const ccomplex_t IT_0229 = (-0.5)*IT_0220 + 0.5*IT_0222 + (-0.5)*IT_0225 +
       0.5*IT_0228;
    const ccomplex_t IT_0230 = IT_0214*IT_0229;
    const ccomplex_t IT_0231 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 + (
    ...
    const ccomplex_t IT_0234 = (-0.5)*IT_0033 + (-0.5)*IT_0087 + (-0.5)
      *IT_0136 + (-0.5)*IT_0185 + (-0.5)*IT_0218 + (-0.5)*IT_0233;
    ...
    const ccomplex_t IT_0241 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0246 = IT_0030*IT_0245;
    ...
    const ccomplex_t IT_0255 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0274 = IT_0043*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*IT_0274;
    const ccomplex_t IT_0276 = m_N_1*IT_0066;
    const ccomplex_t IT_0277 = m_N_2*IT_0084;
    ...
    const ccomplex_t IT_0286 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0293 = m_N_1*IT_0115;
    const ccomplex_t IT_0294 = m_N_3*IT_0133;
    ...
    const ccomplex_t IT_0303 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0308 = IT_0145*IT_0307;
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*IT_0308;
    const ccomplex_t IT_0310 = m_N_1*IT_0164;
    const ccomplex_t IT_0311 = m_N_4*IT_0182;
    const ccomplex_t IT_0312 = IT_0310 + IT_0311;
    const ccomplex_t IT_0313 = IT_0309*IT_0312;
    const ccomplex_t IT_0314 = IT_0229*IT_0259;
    const ccomplex_t IT_0315 = IT_0231*IT_0314;
    ...
    const ccomplex_t IT_0321 = IT_0066*IT_0275;
    const ccomplex_t IT_0322 = IT_0164*IT_0309;
    const ccomplex_t IT_0323 = e_em*m_tau*IT_0009*IT_0011*IT_0013*IT_0023;
    const ccomplex_t IT_0324 = (-0.5)*IT_0323;
    const ccomplex_t IT_0325 = IT_0214*IT_0324;
    const ccomplex_t IT_0326 = cpow(s_12 + 0.5*IT_0000 + (-0.5)*IT_0001 + 0.5
      *IT_0042 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0327 = IT_0325*IT_0326;
    const ccomplex_t IT_0328 = (0 + _Complex_I*1)*IT_0327;
    const ccomplex_t IT_0329 = IT_0115*IT_0292;
    const ccomplex_t IT_0330 = IT_0194*IT_0261;
    const ccomplex_t IT_0331 = (-0.5)*IT_0321 + (-0.5)*IT_0322 + 0.5*IT_0328 +
       (-0.5)*IT_0329 + (-0.5)*IT_0330;
    const ccomplex_t IT_0332 = s_14*m_tau;
    const ccomplex_t IT_0333 = IT_0204*IT_0217;
    const ccomplex_t IT_0334 = IT_0045*IT_0084;
    const ccomplex_t IT_0335 = IT_0098*IT_0133;
    const ccomplex_t IT_0336 = IT_0147*IT_0182;
    const ccomplex_t IT_0337 = IT_0259*IT_0324;
    const ccomplex_t IT_0338 = IT_0326*IT_0337;
