        ...
        )
{
    ...
    const ccomplex_t IT_0034 = IT_0004*IT_0019;
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = N_B1*N_u1*e_em;
    const ccomplex_t IT_0037 = IT_0004*IT_0021;
    ...
    const ccomplex_t IT_0043 = IT_0011*IT_0021;
    ...
    const ccomplex_t IT_0053 = conj(N_W1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0059 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0058 +
    ...
    const ccomplex_t IT_0063 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0064 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0065 = IT_0004*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0072 = (-2)*conj(U_stau_00)*((IT_0001*IT_0009*IT_0011
    ...
    const ccomplex_t IT_0086 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0058 +
    ...
    const ccomplex_t IT_0135 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0136 = IT_0004*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = N_d3*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0143 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0058 +
    ...
    const ccomplex_t IT_0146 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0147 = IT_0034*IT_0146;
    const ccomplex_t IT_0148 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0149 = IT_0043*IT_0148;
    const ccomplex_t IT_0150 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0151 = IT_0034*IT_0150;
    const ccomplex_t IT_0152 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0153 = IT_0043*IT_0152;
    const ccomplex_t IT_0154 = IT_0147 + IT_0149 + IT_0151 + IT_0153;
    const ccomplex_t IT_0155 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0159 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0200 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0058 +
    ...
    const ccomplex_t IT_0228 = IT_0043*IT_0227;
    ...
    const ccomplex_t IT_0256 = (-0.5)*IT_0032 + (-0.5)*IT_0062 + (-0.5)
    ...
    const ccomplex_t IT_0268 = IT_0059*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0057*IT_0269;
    const ccomplex_t IT_0271 = (-2)*U_stau_01*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj
      (U_stau_01) + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_11)) +
       U_stau_11*(IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)
    ...
    const ccomplex_t IT_0288 = (-2)*conj(U_stau_00)*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))
      *U_stau_01 + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*U_stau_11) + conj
      (U_stau_10)*(IT_0009*IT_0011*IT_0020*IT_0021*U_stau_01 + (-2)*(IT_0001
      *IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)*U_stau_11);
    ...
    const ccomplex_t IT_0292 = IT_0063*IT_0291;
    const ccomplex_t IT_0293 = (0 + _Complex_I*1)*IT_0292;
    const ccomplex_t IT_0294 = m_N_2*IT_0131;
    const ccomplex_t IT_0295 = m_N_1*IT_0109;
    const ccomplex_t IT_0296 = IT_0294 + IT_0295;
    const ccomplex_t IT_0297 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0298 = IT_0004*IT_0297;
    const ccomplex_t IT_0299 = 1.4142135623731*IT_0298;
    const ccomplex_t IT_0300 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0301 = IT_0011*IT_0300;
    const ccomplex_t IT_0302 = 1.4142135623731*IT_0301;
    const ccomplex_t IT_0303 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0324 = m_N_3*IT_0166;
    const ccomplex_t IT_0325 = m_N_1*IT_0188;
    ...
    const ccomplex_t IT_0334 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0341 = m_N_1*IT_0223;
    ...
    const ccomplex_t IT_0349 = 0.5*IT_0270 + 0.5*IT_0276 + 0.5*IT_0293 + 0.5
    ...
    const ccomplex_t IT_0353 = IT_0223*IT_0340;
    const ccomplex_t IT_0354 = IT_0045*IT_0269;
    const ccomplex_t IT_0355 = IT_0109*IT_0309;
    const ccomplex_t IT_0356 = IT_0188*IT_0323;
    const ccomplex_t IT_0357 = 0.5*IT_0254 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0055*IT_0061;
    const ccomplex_t IT_0360 = IT_0088*IT_0131;
    const ccomplex_t IT_0361 = IT_0145*IT_0166;
