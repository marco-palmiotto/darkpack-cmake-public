        ...
        )
{
    ...
    const ccomplex_t IT_0034 = IT_0004*IT_0021;
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0037 = IT_0004*IT_0019;
    ...
    const ccomplex_t IT_0043 = IT_0011*IT_0019;
    ...
    const ccomplex_t IT_0060 = pow(m_stau_2, 2);
    const ccomplex_t IT_0061 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0060 +
    ...
    const ccomplex_t IT_0065 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0066 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0067 = IT_0004*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0074 = 2*conj(U_stau_00)*((IT_0001*IT_0009*IT_0011
    ...
    const ccomplex_t IT_0088 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0060 +
    ...
    const ccomplex_t IT_0140 = N_d3*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0145 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0060 +
    ...
    const ccomplex_t IT_0150 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0154 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0155 = IT_0037*IT_0154;
    const ccomplex_t IT_0156 = IT_0149 + IT_0151 + IT_0153 + IT_0155;
    const ccomplex_t IT_0157 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0158 = IT_0040*IT_0157;
    const ccomplex_t IT_0159 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0160 = IT_0043*IT_0159;
    const ccomplex_t IT_0161 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0162 = IT_0040*IT_0161;
    const ccomplex_t IT_0163 = conj(N_W3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0164 = IT_0043*IT_0163;
    ...
    const ccomplex_t IT_0202 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0060 +
    ...
    const ccomplex_t IT_0239 = IT_0043*IT_0238;
    ...
    const ccomplex_t IT_0258 = (-0.5)*IT_0032 + (-0.5)*IT_0064 + (-0.5)
    ...
    const ccomplex_t IT_0270 = IT_0061*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1)*IT_0270;
    const ccomplex_t IT_0272 = IT_0059*IT_0271;
    const ccomplex_t IT_0273 = 2*U_stau_01*((IT_0001*IT_0009*IT_0011*IT_0013
      *IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj(U_stau_01
      ) + 1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_11)) + U_stau_11*
      (IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_01) + 2*(IT_0001*IT_0009
      *IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0279 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0280 = IT_0004*IT_0279;
    const ccomplex_t IT_0281 = 1.4142135623731*IT_0280;
    const ccomplex_t IT_0282 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0283 = IT_0011*IT_0282;
    const ccomplex_t IT_0284 = 1.4142135623731*IT_0283;
    const ccomplex_t IT_0285 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0290 = 2*conj(U_stau_00)*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))
      *U_stau_01 + 1./2*IT_0009*IT_0011*IT_0020*IT_0021*U_stau_11) + conj
      (U_stau_10)*(IT_0009*IT_0011*IT_0020*IT_0021*U_stau_01 + 2*(IT_0001
      *IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)*U_stau_11);
    ...
    const ccomplex_t IT_0296 = m_N_2*IT_0133;
    const ccomplex_t IT_0297 = m_N_1*IT_0111;
    const ccomplex_t IT_0298 = IT_0296 + IT_0297;
    const ccomplex_t IT_0299 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0300 = IT_0004*IT_0299;
    const ccomplex_t IT_0301 = 1.4142135623731*IT_0300;
    const ccomplex_t IT_0302 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0303 = IT_0011*IT_0302;
    const ccomplex_t IT_0304 = 1.4142135623731*IT_0303;
    const ccomplex_t IT_0305 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_11;
    const ccomplex_t IT_0306 = IT_0012*IT_0305;
    ...
    const ccomplex_t IT_0326 = m_N_3*IT_0168;
    const ccomplex_t IT_0327 = m_N_1*IT_0190;
    ...
    const ccomplex_t IT_0336 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0343 = m_N_1*IT_0225;
    ...
    const ccomplex_t IT_0351 = 0.5*IT_0272 + 0.5*IT_0278 + 0.5*IT_0295 + 0.5
    ...
    const ccomplex_t IT_0355 = IT_0225*IT_0342;
    const ccomplex_t IT_0356 = IT_0046*IT_0271;
    const ccomplex_t IT_0357 = IT_0111*IT_0311;
    const ccomplex_t IT_0358 = IT_0190*IT_0325;
    const ccomplex_t IT_0359 = 0.5*IT_0256 + (-0.5)*IT_0355 + (-0.5)*IT_0356 +
       (-0.5)*IT_0357 + (-0.5)*IT_0358;
    const ccomplex_t IT_0360 = s_14*m_tau;
    const ccomplex_t IT_0361 = IT_0057*IT_0063;
    const ccomplex_t IT_0362 = IT_0090*IT_0133;
    const ccomplex_t IT_0363 = IT_0147*IT_0168;
