        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0007;
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0007;
    const ccomplex_t IT_0033 = N_u1*e_em*V_Wp2;
    const ccomplex_t IT_0034 = IT_0010*IT_0033;
    const ccomplex_t IT_0035 = 2*IT_0034;
    const ccomplex_t IT_0036 = N_B1*V_u2*e_em;
    const ccomplex_t IT_0037 = IT_0016*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = N_W1*V_u2*e_em;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0007*IT_0009*IT_0054*IT_0056;
    ...
    const ccomplex_t IT_0067 = cpow(IT_0009, -1);
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
      *e_em*IT_0007*IT_0054*IT_0067;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0015*IT_0055;
    ...
    const ccomplex_t IT_0074 = IT_0007*IT_0055;
    ...
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0007*IT_0054*IT_0055*IT_0067;
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0007*(IT_0009*(m_W*IT_0055 + (-0.5)*IT_0051*IT_0054*IT_0056) + -1./2
      *IT_0028*IT_0054*IT_0055*IT_0067);
    const ccomplex_t IT_0127 = 0.5*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0007*IT_0054*IT_0067;
    const ccomplex_t IT_0129 = (-0.5)*IT_0128;
    const ccomplex_t IT_0130 = IT_0127*IT_0129;
    const ccomplex_t IT_0131 = cpow((-2)*s_13 + IT_0028 + IT_0052 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0132 = IT_0130*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0135 = IT_0060*IT_0116;
    const ccomplex_t IT_0136 = IT_0053*IT_0134*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0007*IT_0054;
    const ccomplex_t IT_0138 = 0.5*IT_0137;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0015;
    const ccomplex_t IT_0140 = (-0.333333333333333)*IT_0139;
    const ccomplex_t IT_0141 = IT_0138*IT_0140;
    const ccomplex_t IT_0142 = cpow((-2)*s_13 + IT_0028 + IT_0052 + -m_sd_R*
    ...
    const ccomplex_t IT_0146 = IT_0045*IT_0089;
    const ccomplex_t IT_0147 = IT_0047*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0149 = IT_0026*IT_0069;
    const ccomplex_t IT_0150 = IT_0029*IT_0148*IT_0149;
    const ccomplex_t IT_0151 = m_N_1*IT_0119;
    const ccomplex_t IT_0152 = IT_0133 + -IT_0136 + IT_0144 + -IT_0147 + 
      -IT_0150 + IT_0151;
    const ccomplex_t IT_0153 = IT_0032*IT_0102;
    const ccomplex_t IT_0154 = IT_0047*IT_0145*IT_0153;
    const ccomplex_t IT_0155 = m_d*IT_0105;
    const ccomplex_t IT_0156 = m_d*IT_0087;
    const ccomplex_t IT_0157 = IT_0154 + -IT_0155 + -IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0007*IT_0054*IT_0067;
    ...
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*(IT_0109 + (-3)*IT_0112);
    ...
    const ccomplex_t IT_0168 = IT_0008*IT_0084;
    const ccomplex_t IT_0169 = IT_0029*IT_0148*IT_0168;
    const ccomplex_t IT_0170 = IT_0058*IT_0114;
    const ccomplex_t IT_0171 = IT_0053*IT_0134*IT_0170;
    const ccomplex_t IT_0172 = m_N_1*IT_0063;
    const ccomplex_t IT_0173 = -IT_0162 + -IT_0167 + -IT_0169 + IT_0171 + 
      -IT_0172;
    ...
    const ccomplex_t IT_0193 = IT_0005*(IT_0065*IT_0066 + IT_0120*IT_0121) + 6
      *IT_0122*((conj(IT_0125) + -conj(IT_0152))*IT_0157 + (IT_0125 + -IT_0152)
      ...
      *IT_0179 + IT_0121*IT_0183 + IT_0120*IT_0186)*IT_0187 + (IT_0125*conj
      (IT_0125) + IT_0152*conj(IT_0152) + IT_0157*conj(IT_0157) + IT_0173*conj
      (IT_0173))*IT_0188 + 6*IT_0189*(IT_0121*(IT_0050 + 0.166666666666667
      *IT_0190) + IT_0120*(conj(IT_0050) + 0.166666666666667*IT_0191)) + (conj
      (IT_0125)*IT_0152 + IT_0125*conj(IT_0152) + conj(IT_0157)*IT_0173 +
