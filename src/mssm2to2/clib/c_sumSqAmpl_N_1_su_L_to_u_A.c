...
ccomplex_return_t c_sumSqAmpl_N_1_su_L_to_u_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
    ...
    const ccomplex_t IT_0035 = IT_0012*IT_0031;
    ...
    const ccomplex_t IT_0040 = (-0.666666666666667)*IT_0011;
    ...
    const ccomplex_t IT_0046 = m_u*s_14*m_N_1;
    ...
    const ccomplex_t IT_0058 = m_u*m_N_1;
    ...
    const ccomplex_t IT_0063 = m_u*s_34*m_N_1;
