...
ccomplex_return_t c_sumSqAmpl_N_1_su_L_to_u_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
    ...
    const ccomplex_t IT_0240 = m_u*m_N_1;
    ...
    const ccomplex_t IT_0266 = m_u*m_N_1*IT_0265;
