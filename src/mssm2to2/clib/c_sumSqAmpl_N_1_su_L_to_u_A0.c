        ...
        )
{
    ...
    const ccomplex_t IT_0006 = m_u*e_em*mu_h*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0000 + IT_0019 + -m_N_4*
    ...
    const ccomplex_t IT_0046 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0047 = IT_0024*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0049 = IT_0027*IT_0048;
    const ccomplex_t IT_0050 = conj(N_W1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0000 + IT_0019 + -m_N_1*
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0000 + IT_0019 + -m_N_2*
    ...
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0000 + IT_0019 + -m_N_3*
    ...
    const ccomplex_t IT_0196 = conj(N_B3)*e_em;
    const ccomplex_t IT_0197 = IT_0009*IT_0196;
    const ccomplex_t IT_0198 = 1.4142135623731*IT_0197;
    const ccomplex_t IT_0199 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0204 = IT_0175*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*IT_0204;
    const ccomplex_t IT_0206 = m_N_1*IT_0152;
    const ccomplex_t IT_0207 = m_N_3*IT_0170;
    ...
    const ccomplex_t IT_0220 = m_N_1*IT_0044;
    const ccomplex_t IT_0221 = m_N_4*IT_0062;
    const ccomplex_t IT_0222 = IT_0220 + IT_0221;
    const ccomplex_t IT_0223 = IT_0219*IT_0222;
    const ccomplex_t IT_0224 = m_N_1*IT_0109;
    ...
    const ccomplex_t IT_0242 = IT_0074*IT_0194;
    const ccomplex_t IT_0243 = IT_0152*IT_0205;
    const ccomplex_t IT_0244 = IT_0044*IT_0219;
    const ccomplex_t IT_0245 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0019 
      + -reg_prop, -1);
    const ccomplex_t IT_0246 = m_u*e_em*IT_0003*IT_0005*IT_0016*IT_0023;
    const ccomplex_t IT_0247 = (-0.5)*IT_0246;
    const ccomplex_t IT_0248 = IT_0088*IT_0247;
    ...
    const ccomplex_t IT_0252 = IT_0242 + IT_0243 + IT_0244 + -IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_u*s_14;
    const ccomplex_t IT_0254 = IT_0192*IT_0247;
    const ccomplex_t IT_0255 = IT_0245*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0022*IT_0062;
