...
ccomplex_return_t c_sumSqAmpl_N_1_su_L_to_u_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_R*
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0003
    ...
    const ccomplex_t IT_0018 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0019 = sin(alpha);
    const ccomplex_t IT_0020 = cos(beta);
    const ccomplex_t IT_0021 = cpow(IT_0011, -2);
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0003
      *IT_0006*IT_0008*IT_0019 + (-0.5)*m_W*(IT_0005*IT_0019 + -IT_0004*IT_0020)
      *(IT_0008 + -1./3*IT_0007*IT_0021));
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0029 
      + -reg_prop, -1);
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_u*e_em*IT_0003*IT_0006
      *IT_0008*IT_0019;
    ...
    const ccomplex_t IT_0037 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0038 = IT_0025*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0041 = IT_0004*IT_0012;
    ...
    const ccomplex_t IT_0047 = IT_0004*IT_0008;
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0050 = IT_0008*IT_0019;
    ...
    const ccomplex_t IT_0054 = conj(N_B1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0058 = conj(N_W1)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_N_4*
    ...
    const ccomplex_t IT_0164 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_N_2*
    ...
    const ccomplex_t IT_0169 = IT_0041*IT_0168;
    const ccomplex_t IT_0170 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0171 = IT_0050*IT_0170;
    const ccomplex_t IT_0172 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0173 = IT_0041*IT_0172;
    const ccomplex_t IT_0174 = N_W1*N_u3*e_em;
    const ccomplex_t IT_0175 = IT_0050*IT_0174;
    const ccomplex_t IT_0176 = IT_0169 + IT_0171 + IT_0173 + IT_0175;
    const ccomplex_t IT_0177 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0178 = IT_0044*IT_0177;
    const ccomplex_t IT_0179 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0180 = IT_0047*IT_0179;
    const ccomplex_t IT_0181 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0182 = IT_0044*IT_0181;
    const ccomplex_t IT_0183 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0190 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0191 = IT_0041*IT_0190;
    const ccomplex_t IT_0192 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0193 = IT_0050*IT_0192;
    const ccomplex_t IT_0194 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0195 = IT_0041*IT_0194;
    const ccomplex_t IT_0196 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0197 = IT_0050*IT_0196;
    const ccomplex_t IT_0198 = IT_0191 + IT_0193 + IT_0195 + IT_0197;
    const ccomplex_t IT_0199 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0200 = IT_0044*IT_0199;
    ...
    const ccomplex_t IT_0205 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0214 = (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_N_3*
    ...
    const ccomplex_t IT_0232 = m_N_1*IT_0188;
    const ccomplex_t IT_0233 = m_N_3*IT_0210;
    ...
    const ccomplex_t IT_0268 = IT_0164*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0259*IT_0269;
    const ccomplex_t IT_0271 = m_N_1*IT_0091;
    const ccomplex_t IT_0272 = m_N_4*IT_0113;
    ...
    const ccomplex_t IT_0282 = IT_0068*IT_0281;
    ...
    const ccomplex_t IT_0287 = m_u*m_N_1;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0137*IT_0269;
    const ccomplex_t IT_0290 = IT_0188*IT_0244;
    const ccomplex_t IT_0291 = IT_0091*IT_0283;
    const ccomplex_t IT_0292 = IT_0052*IT_0255;
    const ccomplex_t IT_0293 = -IT_0035 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_u*s_14;
    const ccomplex_t IT_0295 = IT_0210*IT_0217;
    const ccomplex_t IT_0296 = IT_0039*IT_0062;
    const ccomplex_t IT_0297 = IT_0070*IT_0113;
    const ccomplex_t IT_0298 = IT_0159*IT_0166;
    ...
    const ccomplex_t IT_0304 = m_u*m_N_1*IT_0303;
