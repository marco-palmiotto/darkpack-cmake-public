...
ccomplex_return_t c_sumSqAmpl_N_1_su_L_to_u_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = pow(m_su_L, 2);
    ...
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
    ...
    const ccomplex_t IT_0073 = N_B1*N_d1*e_em;
    const ccomplex_t IT_0074 = IT_0019*IT_0073;
    const ccomplex_t IT_0075 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0076 = IT_0027*IT_0075;
    const ccomplex_t IT_0077 = N_W1*N_d1*e_em;
    ...
    const ccomplex_t IT_0082 = conj(N_B1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0095 
      + -reg_prop, -1);
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0002
      *IT_0004*IT_0012;
    ...
    const ccomplex_t IT_0103 = cpow((-2)*s_13 + IT_0007 + IT_0095 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0007 + IT_0095 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0112 = cos(beta);
    const ccomplex_t IT_0113 = cpow(IT_0013, -2);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0012 + (-0.5)*m_W*(IT_0001*IT_0012 + IT_0018*IT_0112)*
      (IT_0004 + -1./3*IT_0003*IT_0113));
    ...
    const ccomplex_t IT_0132 = N_W1*N_u2*e_em;
    ...
    const ccomplex_t IT_0141 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0142 = IT_0015*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0144 = IT_0019*IT_0143;
    const ccomplex_t IT_0145 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0146 = IT_0015*IT_0145;
    const ccomplex_t IT_0147 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0148 = IT_0019*IT_0147;
    const ccomplex_t IT_0149 = IT_0142 + IT_0144 + IT_0146 + IT_0148;
    const ccomplex_t IT_0150 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0151 = IT_0027*IT_0150;
    const ccomplex_t IT_0152 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0153 = IT_0030*IT_0152;
    const ccomplex_t IT_0154 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0155 = IT_0027*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0165 = (-0.5)*IT_0164;
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
    ...
    const ccomplex_t IT_0197 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0198 = IT_0015*IT_0197;
    const ccomplex_t IT_0199 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0206 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0207 = IT_0027*IT_0206;
    const ccomplex_t IT_0208 = conj(N_W1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0221 = IT_0065 + IT_0094 + (-2)*IT_0102 + IT_0110 +
    ...
    const ccomplex_t IT_0230 = IT_0115*IT_0229;
    const ccomplex_t IT_0231 = IT_0111*IT_0230;
    const ccomplex_t IT_0232 = (0 + _Complex_I*1)*IT_0231;
    const ccomplex_t IT_0233 = IT_0098*IT_0229;
    ...
    const ccomplex_t IT_0237 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0238 = 0.5*IT_0237;
    const ccomplex_t IT_0239 = IT_0105*IT_0238;
    const ccomplex_t IT_0240 = IT_0103*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*IT_0240;
    const ccomplex_t IT_0242 = IT_0068*IT_0229;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*IT_0242;
    const ccomplex_t IT_0244 = IT_0093*IT_0243;
    const ccomplex_t IT_0245 = m_N_1*IT_0139;
    const ccomplex_t IT_0246 = m_N_2*IT_0161;
    ...
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*(IT_0250 + 3*IT_0253);
    const ccomplex_t IT_0255 = 0.166666666666667*IT_0254;
    const ccomplex_t IT_0256 = IT_0166*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0247*IT_0257;
    ...
    const ccomplex_t IT_0269 = m_N_3*IT_0217;
    const ccomplex_t IT_0270 = m_N_1*IT_0195;
    ...
    const ccomplex_t IT_0283 = m_N_1*IT_0040;
    const ccomplex_t IT_0284 = m_N_4*IT_0062;
    const ccomplex_t IT_0285 = IT_0283 + IT_0284;
    const ccomplex_t IT_0286 = IT_0282*IT_0285;
    const ccomplex_t IT_0287 = -IT_0232 + 2*IT_0236 + -IT_0241 + -IT_0244 + 
      -IT_0258 + -IT_0272 + -IT_0286;
    const ccomplex_t IT_0288 = 6*s_13;
    const ccomplex_t IT_0289 = m_u*m_N_1;
    const ccomplex_t IT_0290 = 6*IT_0221;
    const ccomplex_t IT_0291 = IT_0195*IT_0268;
    const ccomplex_t IT_0292 = IT_0080*IT_0243;
    const ccomplex_t IT_0293 = IT_0139*IT_0257;
    const ccomplex_t IT_0294 = IT_0040*IT_0282;
    const ccomplex_t IT_0295 = -IT_0101 + IT_0291 + IT_0292 + IT_0293 + IT_0294;
    const ccomplex_t IT_0296 = m_u*s_14;
    const ccomplex_t IT_0297 = IT_0070*IT_0091;
    const ccomplex_t IT_0298 = IT_0011*IT_0062;
    const ccomplex_t IT_0299 = IT_0161*IT_0168;
    const ccomplex_t IT_0300 = IT_0174*IT_0217;
    const ccomplex_t IT_0301 = IT_0235 + -IT_0297 + -IT_0298 + -IT_0299 + 
      -IT_0300;
    ...
    const ccomplex_t IT_0306 = m_u*m_N_1*IT_0305;
