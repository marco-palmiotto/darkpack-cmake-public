        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B1*N_u1*e_em;
    ...
    const ccomplex_t IT_0018 = N_B1*N_d1*e_em;
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0051 = N_B2*N_d1*e_em;
    ...
    const ccomplex_t IT_0104 = cpow(IT_0014, -2);
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0013 + (-0.5)*m_W*(IT_0001*IT_0013 + IT_0019*IT_0103)*
      (IT_0004 + -1./3*IT_0003*IT_0104));
    const ccomplex_t IT_0106 = -IT_0105;
    const ccomplex_t IT_0107 = IT_0006*IT_0106;
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0007 + IT_0095 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0109 = IT_0107*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0138 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0139 = IT_0016*IT_0138;
    const ccomplex_t IT_0140 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0147 = conj(N_W1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
      *IT_0002*IT_0004*IT_0019;
    ...
    const ccomplex_t IT_0167 = cpow((-2)*s_13 + IT_0007 + IT_0095 + -m_su_R*
    ...
    const ccomplex_t IT_0221 = IT_0043 + IT_0094 + (-2)*IT_0102 + IT_0110 +
       IT_0161 + IT_0169 + IT_0220;
    ...
    const ccomplex_t IT_0230 = IT_0046*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1)*IT_0230;
    const ccomplex_t IT_0232 = m_N_1*IT_0069;
    const ccomplex_t IT_0233 = m_N_2*IT_0091;
    ...
    const ccomplex_t IT_0267 = IT_0113*IT_0266;
    const ccomplex_t IT_0268 = (0 + _Complex_I*1)*IT_0267;
    const ccomplex_t IT_0269 = m_N_1*IT_0136;
    const ccomplex_t IT_0270 = m_N_3*IT_0158;
    ...
    const ccomplex_t IT_0287 = -IT_0235 + 2*IT_0247 + -IT_0250 + -IT_0253 + 
    ...
    const ccomplex_t IT_0291 = IT_0136*IT_0268;
    const ccomplex_t IT_0292 = IT_0195*IT_0282;
    const ccomplex_t IT_0293 = IT_0029*IT_0252;
    const ccomplex_t IT_0294 = IT_0069*IT_0231;
    const ccomplex_t IT_0295 = -IT_0101 + IT_0291 + IT_0292 + IT_0293 + IT_0294;
    const ccomplex_t IT_0296 = m_u*s_14;
    const ccomplex_t IT_0297 = IT_0048*IT_0091;
    const ccomplex_t IT_0298 = IT_0115*IT_0158;
    const ccomplex_t IT_0299 = IT_0174*IT_0217;
    const ccomplex_t IT_0300 = IT_0011*IT_0040;
    const ccomplex_t IT_0301 = IT_0246 + -IT_0297 + -IT_0298 + -IT_0299 + 
      -IT_0300;
