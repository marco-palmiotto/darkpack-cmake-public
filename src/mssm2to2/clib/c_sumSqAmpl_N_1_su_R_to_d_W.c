...
ccomplex_return_t c_sumSqAmpl_N_1_su_R_to_d_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
    ...
    const ccomplex_t IT_0053 = IT_0030*IT_0044*IT_0052;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0007;
    ...
    const ccomplex_t IT_0089 = 2*IT_0076;
    const ccomplex_t IT_0090 = s_13*IT_0070;
    const ccomplex_t IT_0091 = s_13*s_14;
    const ccomplex_t IT_0092 = s_34*IT_0055;
    const ccomplex_t IT_0093 = -IT_0092;
    const ccomplex_t IT_0094 = IT_0091 + IT_0093;
    const ccomplex_t IT_0095 = IT_0076 + IT_0086;
    ...
    const ccomplex_t IT_0102 = m_d*IT_0101;
    ...
    const ccomplex_t IT_0121 = IT_0066 + IT_0088;
    const ccomplex_t IT_0122 = s_14*IT_0000;
    const ccomplex_t IT_0123 = s_13*s_34;
    const ccomplex_t IT_0124 = -IT_0123;
    const ccomplex_t IT_0125 = IT_0122 + IT_0124;
    const ccomplex_t IT_0126 = (-6)*IT_0089;
    ...
    const ccomplex_t IT_0132 = m_d*IT_0070;
    const ccomplex_t IT_0133 = (-6)*conj(IT_0089);
    ...
    const ccomplex_t IT_0145 = m_d*m_N_1;
    ...
    const ccomplex_t IT_0153 = (-6)*IT_0086;
    ...
    const ccomplex_t IT_0157 = 6*conj(IT_0033)*(IT_0066*IT_0071 + -IT_0078
      *IT_0083 + 0.166666666666667*IT_0084*IT_0085) + (IT_0071*IT_0088 + IT_0089
      *IT_0090 + IT_0094*IT_0095)*IT_0096 + 6*conj(IT_0076)*(0.166666666666667
      *IT_0085*IT_0094 + IT_0078*IT_0103 + 0.166666666666667*IT_0076*IT_0112 +
       0.166666666666667*IT_0086*IT_0114 + IT_0120*IT_0121 + 0.166666666666667
      *IT_0125*IT_0126) + (IT_0095*IT_0125 + IT_0088*IT_0131 + IT_0078*IT_0132)
      *IT_0133 + conj(IT_0089)*(IT_0085*IT_0090 + IT_0126*IT_0134 + IT_0131
      *IT_0135) + (-6)*conj(IT_0086)*((-0.166666666666667)*IT_0085*IT_0094 + (
      -0.166666666666667)*IT_0086*IT_0112 + (-0.166666666666667)*IT_0076*IT_0114
       + (-0.166666666666667)*IT_0125*IT_0126 + IT_0078*IT_0139 + (IT_0088 + (
      -0.166666666666667)*IT_0135)*IT_0143) + (IT_0089*IT_0131 + IT_0086*IT_0143
      )*IT_0144 + (-6)*conj(IT_0078)*(IT_0033*IT_0083 + -1./6*IT_0126*IT_0132 + 
      -1./6*((-18)*IT_0066 + (-18)*IT_0088)*IT_0145 + -1./6*IT_0078*IT_0151 + 
      -1./6*IT_0103*IT_0152 + -1./6*IT_0139*IT_0153) + conj(IT_0088)*(IT_0071
