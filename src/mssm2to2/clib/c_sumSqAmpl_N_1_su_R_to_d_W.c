        ...
        )
{
    ...
    const ccomplex_t IT_0069 = N_W1*e_em*conj(U_Wm1);
    const ccomplex_t IT_0070 = IT_0004*IT_0069;
    const ccomplex_t IT_0071 = N_d1*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0081;
    ...
    const ccomplex_t IT_0086 = N_W1*e_em*conj(U_Wm2);
    const ccomplex_t IT_0087 = IT_0004*IT_0086;
    const ccomplex_t IT_0088 = N_d1*conj(U_d2)*e_em;
