...
ccomplex_return_t c_sumSqAmpl_N_1_su_R_to_u_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0005;
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
    ...
    const ccomplex_t IT_0029 = IT_0009*IT_0025;
    ...
    const ccomplex_t IT_0040 = m_u*s_14*m_N_1;
    ...
    const ccomplex_t IT_0052 = m_u*m_N_1;
    ...
    const ccomplex_t IT_0057 = m_u*s_34*m_N_1;
