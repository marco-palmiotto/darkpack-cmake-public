...
ccomplex_return_t c_sumSqAmpl_N_1_su_R_to_u_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0222 = m_u*m_N_1;
    ...
    const ccomplex_t IT_0248 = m_u*m_N_1*IT_0247;
