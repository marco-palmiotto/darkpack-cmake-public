        ...
        )
{
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0009
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0004 + IT_0071 + -m_su_L*
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0004 + IT_0071 + -m_su_R*
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_u*e_em*IT_0013*IT_0015
      *IT_0063*IT_0065;
