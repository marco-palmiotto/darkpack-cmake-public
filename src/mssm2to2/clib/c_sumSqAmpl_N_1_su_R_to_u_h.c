...
ccomplex_return_t c_sumSqAmpl_N_1_su_R_to_u_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0003
      *IT_0005*IT_0008*IT_0019 + m_W*IT_0007*IT_0018*(IT_0004*IT_0019 + IT_0006
      *IT_0020));
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + IT_0000 + -IT_0001 + -IT_0029 
      + -reg_prop, -1);
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_u*e_em*IT_0003*IT_0005
      *IT_0008*IT_0019;
    ...
    const ccomplex_t IT_0044 = IT_0006*IT_0023;
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = N_W1*N_u1*e_em;
    const ccomplex_t IT_0047 = IT_0008*IT_0019;
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = N_W1*N_d1*e_em;
    const ccomplex_t IT_0050 = IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0057 = conj(N_B1)*conj(N_d1)*e_em;
    const ccomplex_t IT_0058 = IT_0044*IT_0057;
    const ccomplex_t IT_0059 = conj(N_W1)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0086 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0087 = IT_0047*IT_0086;
    const ccomplex_t IT_0088 = conj(N_W2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0089 = IT_0050*IT_0088;
    ...
    const ccomplex_t IT_0142 = IT_0041*IT_0141;
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0023;
    const ccomplex_t IT_0165 = 0.666666666666667*IT_0164;
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_N_3*
    ...
    const ccomplex_t IT_0193 = IT_0041*IT_0192;
    const ccomplex_t IT_0194 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0195 = IT_0044*IT_0194;
    const ccomplex_t IT_0196 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0197 = IT_0041*IT_0196;
    const ccomplex_t IT_0198 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0199 = IT_0044*IT_0198;
    const ccomplex_t IT_0200 = IT_0193 + IT_0195 + IT_0197 + IT_0199;
    const ccomplex_t IT_0201 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0202 = IT_0047*IT_0201;
    const ccomplex_t IT_0203 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0204 = IT_0050*IT_0203;
    const ccomplex_t IT_0205 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0206 = IT_0047*IT_0205;
    const ccomplex_t IT_0207 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0217 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_N_4*
    ...
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0237 = m_N_1*IT_0190;
    const ccomplex_t IT_0238 = m_N_4*IT_0212;
    const ccomplex_t IT_0239 = IT_0237 + IT_0238;
    const ccomplex_t IT_0240 = IT_0236*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0003*IT_0005*IT_0008;
    ...
    const ccomplex_t IT_0246 = m_u*IT_0245;
    const ccomplex_t IT_0247 = IT_0022*IT_0242;
    const ccomplex_t IT_0248 = IT_0016*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0037*IT_0242;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = IT_0066*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0003*IT_0005*IT_0008;
    ...
    const ccomplex_t IT_0257 = m_N_1*IT_0115;
    const ccomplex_t IT_0258 = m_N_2*IT_0093;
    ...
    const ccomplex_t IT_0265 = m_N_3*IT_0161;
    const ccomplex_t IT_0266 = m_N_1*IT_0139;
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = IT_0264*IT_0267;
    const ccomplex_t IT_0269 = -IT_0232 + -IT_0240 + 2*IT_0246 + -IT_0249 + 
      -IT_0252 + -IT_0260 + -IT_0268;
    const ccomplex_t IT_0270 = 6*s_13;
    const ccomplex_t IT_0271 = m_u*m_N_1;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0053*IT_0251;
    const ccomplex_t IT_0274 = IT_0190*IT_0236;
    const ccomplex_t IT_0275 = IT_0115*IT_0256;
    const ccomplex_t IT_0276 = IT_0139*IT_0264;
    ...
    const ccomplex_t IT_0280 = IT_0072*IT_0093;
    const ccomplex_t IT_0281 = IT_0161*IT_0168;
    const ccomplex_t IT_0282 = IT_0212*IT_0219;
    const ccomplex_t IT_0283 = IT_0245 + -IT_0279 + -IT_0280 + -IT_0281 + 
      -IT_0282;
    ...
    const ccomplex_t IT_0288 = m_u*m_N_1*IT_0287;
