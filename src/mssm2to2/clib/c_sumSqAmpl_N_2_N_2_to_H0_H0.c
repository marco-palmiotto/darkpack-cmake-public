        ...
        )
{
    ...
    const ccomplex_t IT_0021 = m_N_2*IT_0020;
    const ccomplex_t IT_0022 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0023 = IT_0004*IT_0022;
    const ccomplex_t IT_0024 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0025 = IT_0008*IT_0024;
    const ccomplex_t IT_0026 = N_W2*N_d2*e_em;
    const ccomplex_t IT_0027 = IT_0013*IT_0026;
    const ccomplex_t IT_0028 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0029 = IT_0016*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*(IT_0023 + -IT_0025 + 
      -IT_0027 + IT_0029);
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0034 + (0 + _Complex_I*1)
      *m_N_2*Gamma_o2 + reg_prop, -1);
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = IT_0033*IT_0039;
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0044 = IT_0004*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0046 = IT_0016*IT_0045;
    const ccomplex_t IT_0047 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0048 = IT_0004*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0050 = IT_0016*IT_0049;
    const ccomplex_t IT_0051 = IT_0044 + IT_0046 + IT_0048 + IT_0050;
    const ccomplex_t IT_0052 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0053 = IT_0008*IT_0052;
    const ccomplex_t IT_0054 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0055 = IT_0013*IT_0054;
    const ccomplex_t IT_0056 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0057 = IT_0008*IT_0056;
    const ccomplex_t IT_0058 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = IT_0089*IT_0092;
    const ccomplex_t IT_0094 = cpow(IT_0002, -2);
    const ccomplex_t IT_0095 = IT_0011*IT_0094;
    const ccomplex_t IT_0096 = IT_0012 + IT_0095;
    const ccomplex_t IT_0097 = sin(beta);
    const ccomplex_t IT_0098 = cpow(IT_0007, 3);
    const ccomplex_t IT_0099 = cos(beta);
    const ccomplex_t IT_0100 = cpow(IT_0001, 2);
    const ccomplex_t IT_0101 = cpow(IT_0007, 2);
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*m_W*e_em*IT_0096*(IT_0097
      *IT_0098 + -IT_0001*(IT_0001*IT_0007*IT_0097 + -IT_0099*(IT_0100 + 
      -IT_0101)));
    const ccomplex_t IT_0103 = (-1.5)*IT_0102;
    const ccomplex_t IT_0104 = cpow((-2)*s_12 + (-2)*IT_0000 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0108 = IT_0004*IT_0009;
    const ccomplex_t IT_0109 = IT_0005*IT_0008;
    const ccomplex_t IT_0110 = IT_0013*IT_0017;
    const ccomplex_t IT_0111 = IT_0014*IT_0016;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*(IT_0108 + IT_0109 + 
      -IT_0110 + -IT_0111);
    const ccomplex_t IT_0113 = -IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*m_W*e_em*IT_0096*(IT_0098
      *IT_0099 + 5*IT_0001*((-0.2)*IT_0001*(IT_0001*IT_0097 + 5*IT_0007*IT_0099)
       + IT_0097*IT_0101));
    ...
    const ccomplex_t IT_0120 = IT_0037 + 0.5*IT_0040 + IT_0090 + IT_0093 + (
      -0.5)*IT_0107 + -IT_0119;
    const ccomplex_t IT_0121 = cpow(IT_0030, 2);
    const ccomplex_t IT_0122 = m_N_2*IT_0121;
    const ccomplex_t IT_0123 = IT_0032 + IT_0122;
    const ccomplex_t IT_0124 = IT_0039*IT_0123;
    const ccomplex_t IT_0125 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*IT_0125;
    const ccomplex_t IT_0127 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0128 = IT_0004*IT_0127;
    const ccomplex_t IT_0129 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0130 = IT_0016*IT_0129;
    const ccomplex_t IT_0131 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0132 = IT_0004*IT_0131;
    const ccomplex_t IT_0133 = N_W2*N_u3*e_em;
    ...
    const ccomplex_t IT_0140 = N_B2*N_u3*e_em;
    ...
    const ccomplex_t IT_0148 = cpow(IT_0147, 2);
    ...
    const ccomplex_t IT_0152 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0156 = conj(N_W3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0161 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0165 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0173 = IT_0149 + IT_0172;
    const ccomplex_t IT_0174 = IT_0126*IT_0173;
    const ccomplex_t IT_0175 = IT_0030*IT_0106;
    const ccomplex_t IT_0176 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*IT_0176;
    const ccomplex_t IT_0178 = IT_0173*IT_0177;
    const ccomplex_t IT_0179 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_4*
    ...
    const ccomplex_t IT_0185 = N_B2*N_d4*e_em;
    ...
    const ccomplex_t IT_0190 = N_B4*N_u2*e_em;
    const ccomplex_t IT_0191 = IT_0008*IT_0190;
    const ccomplex_t IT_0192 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0193 = IT_0013*IT_0192;
    const ccomplex_t IT_0194 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0195 = IT_0008*IT_0194;
    const ccomplex_t IT_0196 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0202 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0203 = IT_0004*IT_0202;
    const ccomplex_t IT_0204 = conj(N_W2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0211 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0212 = IT_0008*IT_0211;
    const ccomplex_t IT_0213 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0214 = IT_0013*IT_0213;
    const ccomplex_t IT_0215 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0216 = IT_0008*IT_0215;
    const ccomplex_t IT_0217 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0225 = cpow(IT_0201, 2);
    const ccomplex_t IT_0226 = m_N_4*IT_0225;
    const ccomplex_t IT_0227 = IT_0224 + IT_0226;
    const ccomplex_t IT_0228 = IT_0180*IT_0227;
    const ccomplex_t IT_0229 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = IT_0227*IT_0230;
    const ccomplex_t IT_0232 = (-0.5)*IT_0124 + -IT_0174 + 0.5*IT_0175 + 
      -IT_0178 + -IT_0228 + -IT_0231;
    const ccomplex_t IT_0233 = 2*IT_0232;
    const ccomplex_t IT_0234 = IT_0036*IT_0123;
    const ccomplex_t IT_0235 = cpow(IT_0086, 2);
    const ccomplex_t IT_0236 = m_N_1*IT_0235;
    const ccomplex_t IT_0237 = IT_0088 + IT_0236;
    const ccomplex_t IT_0238 = IT_0092*IT_0237;
    const ccomplex_t IT_0239 = IT_0004*IT_0024;
    const ccomplex_t IT_0240 = IT_0008*IT_0022;
    const ccomplex_t IT_0241 = IT_0013*IT_0028;
    const ccomplex_t IT_0242 = IT_0016*IT_0026;
    ...
    const ccomplex_t IT_0246 = IT_0042*IT_0237;
    const ccomplex_t IT_0247 = 0.5*IT_0124 + (-0.5)*IT_0175 + IT_0234 +
       IT_0238 + -IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = (-2)*IT_0247;
    const ccomplex_t IT_0249 = IT_0233 + IT_0248;
    const ccomplex_t IT_0250 = 2*conj(IT_0232);
    const ccomplex_t IT_0251 = (-2)*conj(IT_0247);
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = cpow(IT_0170, 2);
    const ccomplex_t IT_0254 = m_N_3*IT_0253;
    const ccomplex_t IT_0255 = IT_0172 + IT_0254;
    const ccomplex_t IT_0256 = IT_0177*IT_0255;
    const ccomplex_t IT_0257 = IT_0126*IT_0255;
    const ccomplex_t IT_0258 = cpow(IT_0222, 2);
    const ccomplex_t IT_0259 = m_N_4*IT_0258;
    const ccomplex_t IT_0260 = IT_0224 + IT_0259;
    const ccomplex_t IT_0261 = IT_0180*IT_0260;
    const ccomplex_t IT_0262 = IT_0230*IT_0260;
    const ccomplex_t IT_0263 = (-0.5)*IT_0040 + 0.5*IT_0107 + -IT_0256 + 
    ...
    const ccomplex_t IT_0273 = IT_0031*IT_0039;
    const ccomplex_t IT_0274 = IT_0031*IT_0036;
    const ccomplex_t IT_0275 = IT_0042*IT_0087;
    const ccomplex_t IT_0276 = IT_0087*IT_0092;
    const ccomplex_t IT_0277 = (-0.5)*IT_0273 + IT_0274 + IT_0275 + -IT_0276;
    const ccomplex_t IT_0278 = IT_0171*IT_0177;
    const ccomplex_t IT_0279 = IT_0126*IT_0171;
    const ccomplex_t IT_0280 = IT_0180*IT_0223;
    const ccomplex_t IT_0281 = IT_0223*IT_0230;
    const ccomplex_t IT_0282 = (-0.5)*IT_0273 + IT_0278 + -IT_0279 + IT_0280 +
       -IT_0281;
    const ccomplex_t IT_0283 = conj(IT_0277) + conj(IT_0282);
    const ccomplex_t IT_0284 = 2*IT_0120;
    const ccomplex_t IT_0285 = (-2)*IT_0263;
    const ccomplex_t IT_0286 = IT_0277 + IT_0282;
    const ccomplex_t IT_0287 = 2*conj(IT_0120);
    const ccomplex_t IT_0288 = (-2)*conj(IT_0263);
    const ccomplex_t IT_0289 = s_24*m_N_2;
    const ccomplex_t IT_0290 = 2*IT_0263;
    const ccomplex_t IT_0291 = (-2)*IT_0120;
    const ccomplex_t IT_0292 = 2*conj(IT_0263);
    const ccomplex_t IT_0293 = (-2)*conj(IT_0120);
    const ccomplex_t IT_0294 = s_12*IT_0034;
    const ccomplex_t IT_0295 = s_14*s_24;
    const ccomplex_t IT_0296 = (-2)*IT_0295;
    const ccomplex_t IT_0297 = IT_0294 + IT_0296;
    const ccomplex_t IT_0298 = (-2)*IT_0282;
    const ccomplex_t IT_0299 = (-2)*conj(IT_0282);
    const ccomplex_t IT_0300 = (-2)*IT_0277;
    const ccomplex_t IT_0301 = IT_0000*IT_0034;
    const ccomplex_t IT_0302 = IT_0000*(conj(IT_0120)*IT_0249 + IT_0120
      *IT_0252 + conj(IT_0263)*IT_0266 + IT_0263*IT_0269) + (IT_0120*conj
      (IT_0120) + IT_0232*conj(IT_0232) + IT_0247*conj(IT_0247) + IT_0263*conj
      (IT_0263))*IT_0270 + (conj(IT_0232)*IT_0247 + IT_0232*conj(IT_0247) + conj
      (IT_0120)*IT_0263 + IT_0120*conj(IT_0263))*IT_0271 + IT_0272*(IT_0269*
      (IT_0277 + IT_0282) + IT_0266*IT_0283 + IT_0283*(IT_0284 + IT_0285) +
       IT_0286*(IT_0287 + IT_0288)) + IT_0289*(IT_0249*IT_0283 + IT_0252*IT_0286
       + IT_0283*(IT_0290 + IT_0291) + (IT_0277 + IT_0282)*(IT_0292 + IT_0293)) 
      + 2*IT_0297*(IT_0283*IT_0298 + 1./2*IT_0277*IT_0299 + -IT_0277*(conj
      (IT_0277) + (-0.5)*IT_0299) + 1./2*conj(IT_0277)*IT_0300) + (IT_0283
      *IT_0298 + IT_0286*IT_0299 + (-2)*IT_0277*(conj(IT_0277) + (-0.5)*IT_0299)
       + conj(IT_0277)*(IT_0298 + IT_0300))*IT_0301;
