...
ccomplex_return_t c_sumSqAmpl_N_2_N_2_to_anti_Hp_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = conj(N_u2)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = 2*IT_0027;
    const ccomplex_t IT_0029 = IT_0012*IT_0024;
    const ccomplex_t IT_0030 = conj(N_B2)*conj(V_u2)*e_em;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W2)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_u2)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0056 = IT_0025*IT_0055;
    const ccomplex_t IT_0057 = 2*IT_0056;
    const ccomplex_t IT_0058 = conj(N_B2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0059 = IT_0029*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = conj(N_W2)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0107 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0108 = N_B2*V_u1*e_em;
    const ccomplex_t IT_0109 = IT_0029*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = N_W2*V_u1*e_em;
    ...
    const ccomplex_t IT_0115 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0122 = IT_0069*IT_0107*IT_0121;
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*-1)*e_em*(IT_0006*IT_0011 + 
      -IT_0005*IT_0012);
    const ccomplex_t IT_0126 = 0.5*IT_0125;
    const ccomplex_t IT_0127 = IT_0005*IT_0012;
    const ccomplex_t IT_0128 = N_u2*conj(N_u2)*e_em;
    const ccomplex_t IT_0129 = IT_0127*IT_0128;
    const ccomplex_t IT_0130 = IT_0006*IT_0011;
    ...
    const ccomplex_t IT_0152 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0153 = IT_0151*IT_0152;
    const ccomplex_t IT_0154 = sin(alpha);
    const ccomplex_t IT_0155 = IT_0012*IT_0154;
    const ccomplex_t IT_0156 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0157 = IT_0155*IT_0156;
    const ccomplex_t IT_0158 = IT_0006*IT_0150;
    const ccomplex_t IT_0159 = N_W2*N_d2*e_em;
    const ccomplex_t IT_0160 = IT_0158*IT_0159;
    const ccomplex_t IT_0161 = IT_0006*IT_0154;
    const ccomplex_t IT_0162 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0163 = IT_0161*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*(IT_0153 + -IT_0157 + 
      -IT_0160 + IT_0163);
    const ccomplex_t IT_0165 = -IT_0006;
    const ccomplex_t IT_0166 = cpow(IT_0011, -2);
    const ccomplex_t IT_0167 = IT_0005*IT_0166;
    const ccomplex_t IT_0168 = IT_0165 + IT_0167;
    const ccomplex_t IT_0169 = cpow(IT_0004, 3);
    const ccomplex_t IT_0170 = -IT_0024;
    const ccomplex_t IT_0171 = 3*IT_0006 + IT_0167;
    const ccomplex_t IT_0172 = cpow(IT_0004, 2);
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*m_W*e_em*(IT_0154*IT_0168
      *IT_0169 + IT_0170*(IT_0170*(IT_0024*IT_0150*IT_0168 + -IT_0004*IT_0154
      *IT_0171) + IT_0150*IT_0171*IT_0172));
    ...
    const ccomplex_t IT_0179 = IT_0067*IT_0120;
    ...
    const ccomplex_t IT_0183 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0184 = N_u2*e_em*V_Wp2;
    const ccomplex_t IT_0185 = IT_0025*IT_0184;
    const ccomplex_t IT_0186 = 2*IT_0185;
    const ccomplex_t IT_0187 = N_B2*V_u2*e_em;
    const ccomplex_t IT_0188 = IT_0029*IT_0187;
    const ccomplex_t IT_0189 = 1.4142135623731*IT_0188;
    const ccomplex_t IT_0190 = N_W2*V_u2*e_em;
    ...
    const ccomplex_t IT_0198 = IT_0183*IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*IT_0198;
    const ccomplex_t IT_0200 = m_N_2*IT_0199;
    const ccomplex_t IT_0201 = IT_0084*IT_0196;
    const ccomplex_t IT_0202 = IT_0001*IT_0183*IT_0201;
    const ccomplex_t IT_0203 = IT_0151*IT_0156;
    const ccomplex_t IT_0204 = IT_0152*IT_0155;
    const ccomplex_t IT_0205 = IT_0158*IT_0162;
    const ccomplex_t IT_0206 = IT_0159*IT_0161;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*(IT_0203 + IT_0204 + 
      -IT_0205 + -IT_0206);
    const ccomplex_t IT_0208 = -IT_0207;
    const ccomplex_t IT_0209 = -IT_0006 + IT_0167;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*m_W*e_em*(IT_0150*IT_0169
      *IT_0209 + IT_0024*(IT_0154*IT_0171*IT_0172 + -IT_0024*(IT_0004*IT_0150
      *IT_0171 + IT_0024*IT_0154*IT_0209)));
    const ccomplex_t IT_0211 = 0.5*IT_0210;
    const ccomplex_t IT_0212 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0216 = -IT_0122 + IT_0149 + -IT_0178 + IT_0182 +
       IT_0200 + -IT_0202 + -IT_0215;
    const ccomplex_t IT_0217 = 2*IT_0216;
    const ccomplex_t IT_0218 = IT_0069*IT_0070*IT_0121;
    const ccomplex_t IT_0219 = IT_0001*IT_0003*IT_0201;
    const ccomplex_t IT_0220 = IT_0070*IT_0179;
    const ccomplex_t IT_0221 = (0 + _Complex_I*1)*IT_0220;
    const ccomplex_t IT_0222 = m_N_2*IT_0221;
    const ccomplex_t IT_0223 = IT_0003*IT_0197;
    ...
    const ccomplex_t IT_0232 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0233 = IT_0151*IT_0232;
    const ccomplex_t IT_0234 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0235 = IT_0155*IT_0234;
    const ccomplex_t IT_0236 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0237 = IT_0158*IT_0236;
    const ccomplex_t IT_0238 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0239 = IT_0161*IT_0238;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*(IT_0233 + IT_0235 + 
      -IT_0237 + -IT_0239);
    const ccomplex_t IT_0241 = -IT_0240;
    const ccomplex_t IT_0242 = IT_0214*IT_0241;
    const ccomplex_t IT_0243 = IT_0001*IT_0040*IT_0183;
    const ccomplex_t IT_0244 = IT_0085*IT_0183;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1)*IT_0244;
    const ccomplex_t IT_0246 = m_N_2*IT_0245;
    const ccomplex_t IT_0247 = IT_0068*IT_0069*IT_0107;
    const ccomplex_t IT_0248 = IT_0151*IT_0234;
    const ccomplex_t IT_0249 = IT_0155*IT_0232;
    const ccomplex_t IT_0250 = IT_0158*IT_0238;
    const ccomplex_t IT_0251 = IT_0161*IT_0236;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*(IT_0248 + -IT_0249 + 
      -IT_0250 + IT_0251);
    const ccomplex_t IT_0253 = IT_0177*IT_0252;
    const ccomplex_t IT_0254 = IT_0102*IT_0107;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*IT_0254;
    const ccomplex_t IT_0256 = m_N_2*IT_0255;
    const ccomplex_t IT_0257 = -IT_0149 + -IT_0242 + -IT_0243 + IT_0246 + 
      -IT_0247 + -IT_0253 + IT_0256;
    ...
    const ccomplex_t IT_0266 = s_23*m_N_2;
    const ccomplex_t IT_0267 = IT_0124*IT_0140;
    const ccomplex_t IT_0268 = -IT_0245 + -IT_0255 + IT_0267;
    const ccomplex_t IT_0269 = IT_0221 + IT_0224;
    const ccomplex_t IT_0270 = conj(IT_0268) + conj(IT_0269);
    const ccomplex_t IT_0271 = IT_0124*IT_0145;
    const ccomplex_t IT_0272 = -IT_0181 + -IT_0199 + IT_0271;
    const ccomplex_t IT_0273 = IT_0087 + IT_0104;
    const ccomplex_t IT_0274 = conj(IT_0272) + conj(IT_0273);
    const ccomplex_t IT_0275 = 2*IT_0106;
    const ccomplex_t IT_0276 = (-2)*IT_0257;
    const ccomplex_t IT_0277 = IT_0272 + IT_0273;
    const ccomplex_t IT_0278 = 2*conj(IT_0106);
    const ccomplex_t IT_0279 = (-2)*conj(IT_0257);
    const ccomplex_t IT_0280 = s_13*m_N_2;
    const ccomplex_t IT_0281 = 2*IT_0257;
    const ccomplex_t IT_0282 = (-2)*IT_0106;
    const ccomplex_t IT_0283 = 2*conj(IT_0257);
    const ccomplex_t IT_0284 = (-2)*conj(IT_0106);
    const ccomplex_t IT_0285 = s_12*IT_0002;
    const ccomplex_t IT_0286 = s_13*s_23;
    const ccomplex_t IT_0287 = (-2)*IT_0286;
    const ccomplex_t IT_0288 = IT_0285 + IT_0287;
    const ccomplex_t IT_0289 = (-2)*IT_0268;
    const ccomplex_t IT_0290 = (-2)*conj(IT_0268);
    const ccomplex_t IT_0291 = (-2)*IT_0272;
    const ccomplex_t IT_0292 = (-2)*conj(IT_0272);
    const ccomplex_t IT_0293 = (-2)*IT_0273;
    const ccomplex_t IT_0294 = IT_0000*IT_0002;
    const ccomplex_t IT_0295 = IT_0000*(conj(IT_0106)*IT_0228 + IT_0106
      *IT_0231 + conj(IT_0257)*IT_0260 + IT_0257*IT_0263) + (IT_0106*conj
      ...
      (IT_0106)*IT_0257 + IT_0106*conj(IT_0257))*IT_0265 + IT_0266*(IT_0263*
      (IT_0268 + IT_0269) + IT_0260*IT_0270 + IT_0274*(IT_0275 + IT_0276) +
       IT_0277*(IT_0278 + IT_0279)) + IT_0280*(IT_0228*IT_0274 + IT_0231*IT_0277
       + IT_0270*(IT_0281 + IT_0282) + (IT_0268 + IT_0269)*(IT_0283 + IT_0284)) 
      + IT_0288*(IT_0270*IT_0289 + (-2)*IT_0269*(conj(IT_0269) + (-0.5)*IT_0290)
       + IT_0274*IT_0291 + IT_0273*IT_0292 + conj(IT_0273)*IT_0293) + (conj
      (IT_0272)*IT_0289 + (-2)*conj(IT_0273)*(IT_0269 + (-0.5)*IT_0289) +
       IT_0277*IT_0290 + IT_0269*IT_0292 + conj(IT_0269)*(IT_0291 + IT_0293))
      *IT_0294;
