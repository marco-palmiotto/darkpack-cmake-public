...
ccomplex_return_t c_sumSqAmpl_N_2_N_2_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = m_c*m_N_2;
    ...
    const ccomplex_t IT_0026 = pow(m_c, 2);
    const ccomplex_t IT_0027 = pow(m_N_2, 2);
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0026 + IT_0027 + -m_sc_L*
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0026 + IT_0027 + -m_sc_R*
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*m_c*e_em*IT_0011*IT_0031
      *IT_0033*IT_0043;
    ...
    const ccomplex_t IT_0099 = conj(N_B2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0103 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0180 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0181 = IT_0088*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*IT_0181;
    const ccomplex_t IT_0183 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0187 = IT_0025*IT_0183;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*IT_0187;
    const ccomplex_t IT_0189 = IT_0038*IT_0180;
    ...
    const ccomplex_t IT_0208 = IT_0006*IT_0207;
    const ccomplex_t IT_0209 = IT_0049*IT_0208;
    const ccomplex_t IT_0210 = IT_0006*IT_0032;
    const ccomplex_t IT_0211 = IT_0045*IT_0210;
    const ccomplex_t IT_0212 = IT_0011*IT_0207;
    const ccomplex_t IT_0213 = IT_0055*IT_0212;
    const ccomplex_t IT_0214 = IT_0011*IT_0032;
    const ccomplex_t IT_0215 = IT_0052*IT_0214;
    const ccomplex_t IT_0216 = -IT_0209 + IT_0211 + IT_0213 + -IT_0215;
    const ccomplex_t IT_0217 = m_c*e_em*IT_0011*IT_0031*IT_0033*IT_0207;
    ...
    const ccomplex_t IT_0223 = IT_0045*IT_0208;
    const ccomplex_t IT_0224 = IT_0049*IT_0210;
    const ccomplex_t IT_0225 = IT_0052*IT_0212;
    const ccomplex_t IT_0226 = IT_0055*IT_0214;
    const ccomplex_t IT_0227 = -IT_0223 + -IT_0224 + IT_0225 + IT_0226;
    const ccomplex_t IT_0228 = m_c*e_em*IT_0011*IT_0031;
    ...
    const ccomplex_t IT_0250 = IT_0099*IT_0208;
    const ccomplex_t IT_0251 = IT_0097*IT_0210;
    const ccomplex_t IT_0252 = IT_0103*IT_0212;
    const ccomplex_t IT_0253 = IT_0101*IT_0214;
    const ccomplex_t IT_0254 = IT_0250 + -IT_0251 + -IT_0252 + IT_0253;
    const ccomplex_t IT_0255 = IT_0221*IT_0254;
    const ccomplex_t IT_0256 = IT_0097*IT_0208;
    const ccomplex_t IT_0257 = IT_0099*IT_0210;
    const ccomplex_t IT_0258 = IT_0101*IT_0212;
    const ccomplex_t IT_0259 = IT_0103*IT_0214;
    ...
    const ccomplex_t IT_0272 = IT_0180*IT_0200;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*IT_0272;
    const ccomplex_t IT_0274 = IT_0183*IT_0203;
    ...
    const ccomplex_t IT_0283 = IT_0183*IT_0243;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = IT_0180*IT_0246;
    ...
    const ccomplex_t IT_0300 = 12*conj(IT_0237);
    const ccomplex_t IT_0301 = (-12)*conj(IT_0235);
    const ccomplex_t IT_0302 = IT_0300 + IT_0301;
    const ccomplex_t IT_0303 = conj(IT_0151) + conj(IT_0172);
    const ccomplex_t IT_0304 = 12*IT_0235;
    const ccomplex_t IT_0305 = (-12)*IT_0237;
    const ccomplex_t IT_0306 = IT_0304 + IT_0305;
    const ccomplex_t IT_0307 = IT_0151 + IT_0172;
    const ccomplex_t IT_0308 = 12*conj(IT_0235);
    const ccomplex_t IT_0309 = (-12)*conj(IT_0237);
    const ccomplex_t IT_0310 = IT_0308 + IT_0309;
    const ccomplex_t IT_0311 = conj(IT_0156) + conj(IT_0161);
    const ccomplex_t IT_0312 = 12*IT_0262;
    const ccomplex_t IT_0313 = (-12)*IT_0264;
    const ccomplex_t IT_0314 = IT_0312 + IT_0313;
    const ccomplex_t IT_0315 = IT_0156 + IT_0161;
    const ccomplex_t IT_0316 = 12*conj(IT_0262);
    const ccomplex_t IT_0317 = (-12)*conj(IT_0264);
    const ccomplex_t IT_0318 = IT_0316 + IT_0317;
    const ccomplex_t IT_0319 = conj(IT_0158) + conj(IT_0162);
    const ccomplex_t IT_0320 = 12*IT_0264;
    const ccomplex_t IT_0321 = (-12)*IT_0262;
    const ccomplex_t IT_0322 = IT_0320 + IT_0321;
    const ccomplex_t IT_0323 = IT_0158 + IT_0162;
    const ccomplex_t IT_0324 = 12*conj(IT_0264);
    const ccomplex_t IT_0325 = (-12)*conj(IT_0262);
    const ccomplex_t IT_0326 = IT_0324 + IT_0325;
    const ccomplex_t IT_0327 = conj(IT_0096)*IT_0239 + IT_0096*IT_0242 + conj
      (IT_0042)*IT_0266 + IT_0042*IT_0269 + conj(IT_0191)*IT_0279 + IT_0191
      *IT_0282 + conj(IT_0186)*IT_0290 + IT_0186*IT_0293 + IT_0296*IT_0299 + 
      (IT_0145 + IT_0171)*IT_0302 + IT_0303*IT_0306 + IT_0307*IT_0310 + IT_0311
      *IT_0314 + IT_0315*IT_0318 + IT_0319*IT_0322 + IT_0323*IT_0326;
    const ccomplex_t IT_0328 = -IT_0196;
    const ccomplex_t IT_0329 = IT_0195 + IT_0197 + IT_0328;
    const ccomplex_t IT_0330 = 6*IT_0206;
    const ccomplex_t IT_0331 = 6*conj(IT_0206);
    const ccomplex_t IT_0332 = s_13 + s_14;
    const ccomplex_t IT_0333 = IT_0000*IT_0332;
    const ccomplex_t IT_0334 = 6*IT_0096;
    const ccomplex_t IT_0335 = 6*conj(IT_0096);
    const ccomplex_t IT_0336 = 6*IT_0191;
    const ccomplex_t IT_0337 = 6*conj(IT_0191);
    const ccomplex_t IT_0338 = conj(IT_0042)*IT_0239 + IT_0042*IT_0242 + conj
      (IT_0186)*IT_0279 + IT_0186*IT_0282 + IT_0306*IT_0311 + IT_0303*IT_0314 +
       IT_0310*IT_0315 + IT_0307*IT_0318 + IT_0299*IT_0319 + IT_0296*IT_0322 +
       IT_0302*IT_0323 + (IT_0145 + IT_0171)*IT_0326 + (-6)*conj(IT_0262)*
      (IT_0191 + (-0.166666666666667)*IT_0334) + (-6)*IT_0262*(conj(IT_0191) + (
      -0.166666666666667)*IT_0335) + (-6)*conj(IT_0264)*(IT_0096 + (
      -0.166666666666667)*IT_0336) + (-6)*IT_0264*(conj(IT_0096) + (
      -0.166666666666667)*IT_0337);
    const ccomplex_t IT_0339 = m_c*s_13*m_N_2;
    const ccomplex_t IT_0340 = 12*IT_0096;
    const ccomplex_t IT_0341 = 24*IT_0151;
    const ccomplex_t IT_0342 = 24*IT_0172;
    const ccomplex_t IT_0343 = IT_0340 + IT_0341 + IT_0342;
    const ccomplex_t IT_0344 = 12*conj(IT_0096);
    const ccomplex_t IT_0345 = 24*conj(IT_0151);
    const ccomplex_t IT_0346 = 24*conj(IT_0172);
    const ccomplex_t IT_0347 = IT_0344 + IT_0345 + IT_0346;
    const ccomplex_t IT_0348 = 24*IT_0156;
    const ccomplex_t IT_0349 = 24*IT_0161;
    const ccomplex_t IT_0350 = IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = 24*conj(IT_0156);
    const ccomplex_t IT_0352 = 24*conj(IT_0161);
    const ccomplex_t IT_0353 = IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = 6*IT_0276;
    const ccomplex_t IT_0355 = 12*IT_0206;
    const ccomplex_t IT_0356 = IT_0354 + IT_0355;
    const ccomplex_t IT_0357 = 6*conj(IT_0276);
    const ccomplex_t IT_0358 = 12*conj(IT_0206);
    const ccomplex_t IT_0359 = IT_0357 + IT_0358;
    const ccomplex_t IT_0360 = 12*IT_0287;
    const ccomplex_t IT_0361 = 12*conj(IT_0287);
    const ccomplex_t IT_0362 = 12*IT_0276;
    const ccomplex_t IT_0363 = 12*conj(IT_0276);
    const ccomplex_t IT_0364 = conj(IT_0287)*IT_0334 + IT_0287*IT_0335 + conj
      (IT_0249)*IT_0343 + IT_0249*IT_0347 + conj(IT_0206)*IT_0350 + IT_0206
      *IT_0353 + conj(IT_0042)*IT_0356 + IT_0042*IT_0359 + IT_0303*IT_0360 +
       IT_0307*IT_0361 + IT_0311*IT_0362 + IT_0315*IT_0363;
    const ccomplex_t IT_0365 = m_c*s_23*m_N_2;
    const ccomplex_t IT_0366 = 24*IT_0162;
    const ccomplex_t IT_0367 = 24*IT_0158;
    const ccomplex_t IT_0368 = IT_0366 + IT_0367;
    const ccomplex_t IT_0369 = 12*IT_0186;
    const ccomplex_t IT_0370 = IT_0368 + IT_0369;
    const ccomplex_t IT_0371 = 24*conj(IT_0162);
    const ccomplex_t IT_0372 = 24*conj(IT_0158);
    const ccomplex_t IT_0373 = IT_0371 + IT_0372;
    const ccomplex_t IT_0374 = 12*conj(IT_0186);
    const ccomplex_t IT_0375 = IT_0373 + IT_0374;
    const ccomplex_t IT_0376 = IT_0330 + IT_0362;
    const ccomplex_t IT_0377 = IT_0331 + IT_0363;
    const ccomplex_t IT_0378 = 12*IT_0249;
    const ccomplex_t IT_0379 = 12*conj(IT_0249);
    const ccomplex_t IT_0380 = conj(IT_0186)*IT_0249 + IT_0186*conj(IT_0249) +
       0.166666666666667*IT_0296*(24*IT_0276 + IT_0355) + 0.166666666666667*
      (IT_0145 + IT_0171)*(24*conj(IT_0276) + IT_0358) + 0.166666666666667*conj
      (IT_0287)*IT_0370 + 0.166666666666667*IT_0287*IT_0375 + 0.166666666666667
      *conj(IT_0191)*IT_0376 + 0.166666666666667*IT_0191*IT_0377 +
       0.166666666666667*IT_0319*IT_0378 + 0.166666666666667*IT_0323*IT_0379;
    const ccomplex_t IT_0381 = s_34*IT_0027;
    const ccomplex_t IT_0382 = 12*IT_0191;
    const ccomplex_t IT_0383 = 24*IT_0145;
    const ccomplex_t IT_0384 = IT_0382 + IT_0383;
    const ccomplex_t IT_0385 = 12*IT_0042;
    const ccomplex_t IT_0386 = IT_0348 + IT_0349 + IT_0385;
    const ccomplex_t IT_0387 = 12*conj(IT_0042);
    const ccomplex_t IT_0388 = IT_0351 + IT_0352 + IT_0387;
    const ccomplex_t IT_0389 = 12*conj(IT_0191);
    const ccomplex_t IT_0390 = 24*conj(IT_0145);
    const ccomplex_t IT_0391 = IT_0389 + IT_0390;
    const ccomplex_t IT_0392 = conj(IT_0186)*IT_0334 + IT_0186*IT_0335 + conj
      (IT_0042)*IT_0336 + IT_0042*IT_0337 + IT_0319*IT_0340 + IT_0323*IT_0344 +
       IT_0303*IT_0370 + IT_0307*IT_0375 + IT_0311*IT_0384 + conj(IT_0145)
      *IT_0385 + conj(IT_0171)*IT_0386 + IT_0145*IT_0387 + IT_0171*IT_0388 +
       IT_0315*IT_0391;
    const ccomplex_t IT_0393 = m_c*s_24*m_N_2;
    const ccomplex_t IT_0394 = IT_0350 + IT_0385;
    const ccomplex_t IT_0395 = 6*IT_0042;
    const ccomplex_t IT_0396 = 6*conj(IT_0042);
    const ccomplex_t IT_0397 = conj(IT_0096)*IT_0356 + IT_0096*IT_0359 +
       IT_0311*IT_0360 + IT_0315*IT_0361 + IT_0303*(24*IT_0206 + IT_0362) +
       IT_0307*(24*conj(IT_0206) + IT_0363) + IT_0249*(IT_0353 + IT_0387) + conj
      (IT_0249)*IT_0394 + conj(IT_0287)*IT_0395 + IT_0287*IT_0396;
    const ccomplex_t IT_0398 = conj(IT_0191)*IT_0334 + IT_0191*IT_0335 + conj
      (IT_0145)*IT_0340 + conj(IT_0171)*IT_0343 + IT_0145*IT_0344 + IT_0171
      *IT_0347 + IT_0311*IT_0369 + IT_0315*IT_0374 + IT_0303*IT_0384 + IT_0319
      *IT_0386 + IT_0323*IT_0388 + IT_0307*IT_0391 + conj(IT_0186)*IT_0395 +
       IT_0186*IT_0396;
    const ccomplex_t IT_0399 = m_c*s_14*m_N_2;
    const ccomplex_t IT_0400 = conj(IT_0249)*IT_0336 + IT_0249*IT_0337 +
       IT_0319*IT_0355 + IT_0323*IT_0358 + conj(IT_0276)*IT_0368 + IT_0276
      *IT_0373 + conj(IT_0186)*IT_0376 + IT_0186*IT_0377 + IT_0296*IT_0378 + 
      (IT_0145 + IT_0171)*IT_0379 + conj(IT_0287)*(24*IT_0171 + IT_0382 +
       IT_0383) + IT_0287*(24*conj(IT_0171) + IT_0389 + IT_0390);
    const ccomplex_t IT_0401 = 48*IT_0156;
    const ccomplex_t IT_0402 = 24*IT_0042;
    const ccomplex_t IT_0403 = IT_0401 + IT_0402;
    const ccomplex_t IT_0404 = 48*IT_0161;
    const ccomplex_t IT_0405 = IT_0403 + IT_0404;
    const ccomplex_t IT_0406 = IT_0340 + IT_0341;
    const ccomplex_t IT_0407 = 48*IT_0151;
    const ccomplex_t IT_0408 = 48*conj(IT_0151);
    const ccomplex_t IT_0409 = 48*conj(IT_0156);
    const ccomplex_t IT_0410 = conj(IT_0206)*IT_0355 + conj(IT_0249)*IT_0378 +
       conj(IT_0042)*IT_0394 + conj(IT_0156)*IT_0403 + conj(IT_0161)*IT_0405 +
       conj(IT_0096)*IT_0406 + IT_0303*(24*IT_0096 + IT_0407) + IT_0172*(24*conj
      (IT_0096) + 48*conj(IT_0172) + IT_0408) + IT_0161*IT_0409;
    const ccomplex_t IT_0411 = 48*IT_0158;
    const ccomplex_t IT_0412 = 24*IT_0186;
    const ccomplex_t IT_0413 = IT_0411 + IT_0412;
    const ccomplex_t IT_0414 = 48*IT_0162;
    const ccomplex_t IT_0415 = IT_0413 + IT_0414;
    const ccomplex_t IT_0416 = 48*IT_0145;
    const ccomplex_t IT_0417 = 48*conj(IT_0145);
    const ccomplex_t IT_0418 = 48*conj(IT_0158);
    const ccomplex_t IT_0419 = conj(IT_0287)*IT_0360 + conj(IT_0276)*IT_0362 +
       conj(IT_0186)*IT_0370 + conj(IT_0191)*IT_0384 + conj(IT_0158)*IT_0413 +
       conj(IT_0162)*IT_0415 + IT_0296*(24*IT_0191 + IT_0416) + IT_0171*(48*conj
      (IT_0171) + 24*conj(IT_0191) + IT_0417) + IT_0162*IT_0418;
    ...
    const ccomplex_t IT_0424 = IT_0422*(24*conj(IT_0076)*IT_0078 + IT_0076*((
      ...
      *conj(IT_0116)) + IT_0116*(24*conj(IT_0114) + (-24)*conj(IT_0116)) + conj
      (IT_0078)*IT_0423);
    const ccomplex_t IT_0425 = s_34 + IT_0026;
    const ccomplex_t IT_0426 = s_12*IT_0425;
    const ccomplex_t IT_0427 = (-24)*IT_0237;
    const ccomplex_t IT_0428 = (-24)*conj(IT_0237);
    ...
    const ccomplex_t IT_0437 = IT_0026*IT_0027;
    const ccomplex_t IT_0438 = IT_0042*(IT_0344 + IT_0345) + conj(IT_0096)
      *IT_0350 + IT_0096*IT_0353 + conj(IT_0249)*IT_0356 + IT_0249*IT_0359 +
       conj(IT_0191)*IT_0368 + IT_0191*IT_0373 + conj(IT_0287)*IT_0376 + IT_0287
      *IT_0377 + conj(IT_0186)*IT_0384 + IT_0186*(IT_0389 + IT_0390) + conj
      (IT_0172)*IT_0405 + conj(IT_0042)*IT_0406 + IT_0311*IT_0407 + IT_0315
      *IT_0408 + IT_0172*(24*conj(IT_0042) + 48*conj(IT_0161) + IT_0409) + conj
      (IT_0171)*IT_0415 + IT_0319*IT_0416 + IT_0323*IT_0417 + IT_0171*(48*conj
      (IT_0162) + 24*conj(IT_0186) + IT_0418);
    const ccomplex_t IT_0439 = 6*IT_0078;
    const ccomplex_t IT_0440 = 6*conj(IT_0078);
    const ccomplex_t IT_0441 = (-6)*conj(IT_0076);
    const ccomplex_t IT_0442 = IT_0440 + IT_0441;
    const ccomplex_t IT_0443 = (-0.166666666666667)*IT_0206;
    const ccomplex_t IT_0444 = 6*conj(IT_0116);
    const ccomplex_t IT_0445 = (-6)*conj(IT_0114);
    const ccomplex_t IT_0446 = IT_0444 + IT_0445;
    const ccomplex_t IT_0447 = (-0.166666666666667)*IT_0249;
    const ccomplex_t IT_0448 = 6*IT_0116;
    const ccomplex_t IT_0449 = (-6)*IT_0114;
    const ccomplex_t IT_0450 = IT_0448 + IT_0449;
    const ccomplex_t IT_0451 = (-0.166666666666667)*conj(IT_0249);
    const ccomplex_t IT_0452 = IT_0027*IT_0425;
    const ccomplex_t IT_0453 = (-0.166666666666667)*conj(IT_0287);
    const ccomplex_t IT_0454 = IT_0282*IT_0287 + (-6)*conj(IT_0264)*(IT_0206 +
       4*IT_0235 + (-4)*IT_0237 + (-0.166666666666667)*IT_0354) + (-6)*IT_0264*
      (conj(IT_0206) + 4*conj(IT_0235) + (-4)*conj(IT_0237) + (
      -0.166666666666667)*IT_0357) + 24*conj(IT_0262)*(IT_0235 + -1./4*IT_0276 +
       0.0416666666666667*IT_0330 + 0.0416666666666667*IT_0427) + 24*IT_0262*
      (conj(IT_0235) + -1./4*conj(IT_0276) + 0.0416666666666667*IT_0331 +
       0.0416666666666667*IT_0428) + (-6)*IT_0242*IT_0447 + (-6)*IT_0239*IT_0451
       + (-6)*IT_0279*IT_0453;
    const ccomplex_t IT_0455 = IT_0027*IT_0421;
    const ccomplex_t IT_0456 = (conj(IT_0076) + -conj(IT_0078))*(IT_0114 + 
      -IT_0116) + IT_0078*conj(IT_0116) + IT_0076*(conj(IT_0114) + -conj(IT_0116
      ) + 1./4*conj(IT_0249) + -1./4*conj(IT_0287)) + 0.25*conj(IT_0114)*
      (IT_0206 + 0.166666666666667*IT_0423) + 0.0416666666666667*conj(IT_0206)
      *IT_0434 + 0.0416666666666667*IT_0287*IT_0442 + (-0.25)*IT_0436*IT_0443 +
       0.0416666666666667*IT_0276*IT_0446 + (-0.25)*IT_0431*IT_0447 +
       0.0416666666666667*conj(IT_0276)*IT_0450 + (-0.25)*IT_0435*IT_0451 + (
      -0.25)*IT_0439*IT_0453;
    const ccomplex_t IT_0457 = IT_0004*(conj(IT_0042)*IT_0080 + IT_0042
      ...
      *IT_0293) + IT_0295*IT_0327 + 6*IT_0329*(conj(IT_0249)*IT_0287 + IT_0249
      *conj(IT_0287) + 0.166666666666667*conj(IT_0276)*IT_0330 +
       0.166666666666667*IT_0276*IT_0331) + IT_0333*IT_0338 + IT_0339*IT_0364 +
       6*IT_0365*IT_0380 + IT_0381*IT_0392 + IT_0393*IT_0397 + IT_0194*IT_0398 +
       IT_0399*IT_0400 + IT_0195*IT_0410 + IT_0197*IT_0419 + IT_0424 + IT_0426*
      (24*IT_0237*conj(IT_0237) + IT_0264*((-24)*conj(IT_0262) + 24*conj(IT_0264
      )) + IT_0262*(24*conj(IT_0262) + (-24)*conj(IT_0264)) + conj(IT_0235)
      *IT_0427 + IT_0235*(24*conj(IT_0235) + IT_0428)) + (IT_0194 + IT_0195 +
       IT_0198 + IT_0328)*(IT_0276*IT_0431 + conj(IT_0287)*IT_0434 + 6*conj
      (IT_0276)*(IT_0076 + 0.166666666666667*IT_0435) + 6*IT_0287*(conj(IT_0114)
       + 0.166666666666667*IT_0436)) + IT_0437*IT_0438 + (-6)*(IT_0194 + IT_0197
       + IT_0270 + IT_0328)*(conj(IT_0206)*(IT_0076 + (-0.166666666666667)
      *IT_0439) + IT_0442*IT_0443 + IT_0446*IT_0447 + IT_0450*IT_0451) + IT_0452
      *IT_0454 + 24*IT_0455*IT_0456;
