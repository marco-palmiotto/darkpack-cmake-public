        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0095 = conj(N_B2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0099 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0323 = m_e*s_13*m_N_2;
    ...
    const ccomplex_t IT_0345 = m_e*s_23*m_N_2;
    ...
    const ccomplex_t IT_0373 = m_e*s_14*m_N_2;
    ...
    const ccomplex_t IT_0432 = IT_0077*conj(IT_0113) + IT_0081*(IT_0112 +
      ...
      *IT_0431;
    const ccomplex_t IT_0433 = m_e*s_24*m_N_2;
