        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0006;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0017*IT_0019*IT_0021;
    const ccomplex_t IT_0023 = (-0.5)*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0033 = conj(N_B2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0043 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0097 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0098 = IT_0032*IT_0097;
    const ccomplex_t IT_0099 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0100 = IT_0036*IT_0099;
    const ccomplex_t IT_0101 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0102 = IT_0039*IT_0101;
    const ccomplex_t IT_0103 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0108 = IT_0032*IT_0099;
    const ccomplex_t IT_0109 = IT_0036*IT_0097;
    const ccomplex_t IT_0110 = IT_0039*IT_0103;
    const ccomplex_t IT_0111 = IT_0042*IT_0101;
    ...
    const ccomplex_t IT_0250 = IT_0037*IT_0207;
    const ccomplex_t IT_0251 = IT_0033*IT_0210;
    const ccomplex_t IT_0252 = IT_0043*IT_0212;
    const ccomplex_t IT_0253 = IT_0040*IT_0214;
    const ccomplex_t IT_0254 = IT_0250 + IT_0251 + -IT_0252 + -IT_0253;
    const ccomplex_t IT_0255 = IT_0222*IT_0254;
    const ccomplex_t IT_0256 = IT_0033*IT_0207;
    const ccomplex_t IT_0257 = IT_0037*IT_0210;
    const ccomplex_t IT_0258 = IT_0040*IT_0212;
    const ccomplex_t IT_0259 = IT_0043*IT_0214;
    ...
    const ccomplex_t IT_0340 = m_s*s_24*m_N_2;
    ...
    const ccomplex_t IT_0390 = m_s*s_13*m_N_2;
    ...
    const ccomplex_t IT_0413 = m_s*s_14*m_N_2;
    ...
    const ccomplex_t IT_0430 = conj(IT_0096)*IT_0335 + IT_0096*IT_0336 +
       ...
       IT_0428);
    const ccomplex_t IT_0431 = m_s*s_23*m_N_2;
