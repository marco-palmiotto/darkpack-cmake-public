        ...
        )
{
    ...
    const ccomplex_t IT_0010 = conj(N_W2)*e_em*V_Wp1;
    const ccomplex_t IT_0011 = IT_0009*IT_0010;
    const ccomplex_t IT_0012 = conj(N_u2)*V_u1*e_em;
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0036 + IT_0037 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0042 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0043 = IT_0018*IT_0042;
    const ccomplex_t IT_0044 = 2*IT_0043;
    const ccomplex_t IT_0045 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0046 = IT_0024*IT_0045;
    const ccomplex_t IT_0047 = 1.4142135623731*IT_0046;
    const ccomplex_t IT_0048 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0056 = IT_0009*IT_0055;
    const ccomplex_t IT_0057 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0067 = sin(alpha);
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*e_em*IT_0009*(IT_0065
      *IT_0066 + -IT_0017*IT_0067);
    const ccomplex_t IT_0069 = IT_0023*IT_0065;
    const ccomplex_t IT_0070 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = IT_0009*IT_0067;
    const ccomplex_t IT_0073 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0080 = IT_0023*IT_0067;
    const ccomplex_t IT_0081 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = IT_0009*IT_0065;
    const ccomplex_t IT_0084 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0094 = IT_0068*IT_0093;
    const ccomplex_t IT_0095 = cpow((-2)*s_12 + -IT_0004 + -IT_0037 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*IT_0095;
    const ccomplex_t IT_0097 = IT_0094*IT_0096;
    const ccomplex_t IT_0098 = IT_0069*IT_0081;
    const ccomplex_t IT_0099 = IT_0070*IT_0080;
    const ccomplex_t IT_0100 = IT_0069*IT_0086;
    const ccomplex_t IT_0101 = IT_0075*IT_0080;
    const ccomplex_t IT_0102 = IT_0098 + IT_0099 + IT_0100 + IT_0101;
    const ccomplex_t IT_0103 = IT_0073*IT_0083;
    const ccomplex_t IT_0104 = IT_0072*IT_0084;
    const ccomplex_t IT_0105 = IT_0077*IT_0083;
    const ccomplex_t IT_0106 = IT_0072*IT_0088;
    ...
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*e_em*IT_0009*(IT_0017
      *IT_0065 + IT_0066*IT_0067);
    ...
    const ccomplex_t IT_0117 = IT_0024*IT_0081;
    const ccomplex_t IT_0118 = IT_0023*IT_0066;
    const ccomplex_t IT_0119 = IT_0070*IT_0118;
    const ccomplex_t IT_0120 = IT_0018*IT_0073;
    const ccomplex_t IT_0121 = IT_0009*IT_0066;
    const ccomplex_t IT_0122 = IT_0084*IT_0121;
    const ccomplex_t IT_0123 = IT_0024*IT_0086;
    const ccomplex_t IT_0124 = IT_0075*IT_0118;
    const ccomplex_t IT_0125 = IT_0018*IT_0077;
    ...
    const ccomplex_t IT_0134 = 2*IT_0040 + 2*IT_0064 + -IT_0097 + -IT_0116 + 
      -IT_0133;
    ...
    const ccomplex_t IT_0142 = IT_0121*IT_0141;
    ...
    const ccomplex_t IT_0148 = N_W2*e_em*conj(U_Wm1);
    const ccomplex_t IT_0149 = IT_0009*IT_0148;
    const ccomplex_t IT_0150 = N_d2*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0172 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0184 = IT_0069*IT_0183;
    const ccomplex_t IT_0185 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0186 = IT_0080*IT_0185;
    ...
    const ccomplex_t IT_0192 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0193 = IT_0083*IT_0192;
    const ccomplex_t IT_0194 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0195 = IT_0072*IT_0194;
    const ccomplex_t IT_0196 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0197 = IT_0083*IT_0196;
    const ccomplex_t IT_0198 = N_W2*N_d3*e_em;
    const ccomplex_t IT_0199 = IT_0072*IT_0198;
    ...
    const ccomplex_t IT_0204 = IT_0112*IT_0203;
    const ccomplex_t IT_0205 = IT_0115*IT_0204;
    const ccomplex_t IT_0206 = IT_0024*IT_0183;
    const ccomplex_t IT_0207 = IT_0118*IT_0185;
    const ccomplex_t IT_0208 = IT_0018*IT_0192;
    const ccomplex_t IT_0209 = IT_0121*IT_0194;
    const ccomplex_t IT_0210 = IT_0024*IT_0187;
    const ccomplex_t IT_0211 = IT_0118*IT_0189;
    const ccomplex_t IT_0212 = IT_0018*IT_0196;
    const ccomplex_t IT_0213 = IT_0121*IT_0198;
    const ccomplex_t IT_0214 = (-0.5)*IT_0206 + 0.5*IT_0207 + 0.5*IT_0208 + (
      -0.5)*IT_0209 + (-0.5)*IT_0210 + 0.5*IT_0211 + 0.5*IT_0212 + (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = IT_0129*IT_0214;
    const ccomplex_t IT_0216 = IT_0132*IT_0215;
    const ccomplex_t IT_0217 = IT_0069*IT_0185;
    const ccomplex_t IT_0218 = IT_0072*IT_0192;
    const ccomplex_t IT_0219 = IT_0069*IT_0189;
    const ccomplex_t IT_0220 = IT_0072*IT_0196;
    const ccomplex_t IT_0221 = IT_0217 + IT_0218 + IT_0219 + IT_0220;
    const ccomplex_t IT_0222 = IT_0080*IT_0183;
    const ccomplex_t IT_0223 = IT_0083*IT_0194;
    const ccomplex_t IT_0224 = IT_0080*IT_0187;
    const ccomplex_t IT_0225 = IT_0083*IT_0198;
    ...
    const ccomplex_t IT_0230 = IT_0068*IT_0229;
    const ccomplex_t IT_0231 = IT_0096*IT_0230;
    const ccomplex_t IT_0232 = -IT_0205 + -IT_0216 + -IT_0231;
    ...
    const ccomplex_t IT_0251 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0252 = IT_0009*IT_0251;
    const ccomplex_t IT_0253 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0283 = cpow((-2)*s_13 + IT_0004 + IT_0036 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0294 = m_N_3*IT_0261;
    const ccomplex_t IT_0295 = m_N_2*IT_0040;
    const ccomplex_t IT_0296 = m_N_2*IT_0064;
    ...
    const ccomplex_t IT_0310 = IT_0054*IT_0164;
    const ccomplex_t IT_0311 = IT_0041*IT_0300*IT_0310;
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0313 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0314 = IT_0009*IT_0313;
    const ccomplex_t IT_0315 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0321 = IT_0283*IT_0312*IT_0320;
    const ccomplex_t IT_0322 = IT_0034*IT_0154;
    const ccomplex_t IT_0323 = IT_0038*IT_0312*IT_0322;
    const ccomplex_t IT_0324 = -IT_0309 + -IT_0311 + -IT_0321 + -IT_0323;
    ...
    const ccomplex_t IT_0333 = IT_0016*IT_0147;
    const ccomplex_t IT_0334 = IT_0038*IT_0312*IT_0333;
    const ccomplex_t IT_0335 = IT_0061*IT_0177;
    const ccomplex_t IT_0336 = IT_0041*IT_0300*IT_0335;
    const ccomplex_t IT_0337 = conj(N_u2)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0338 = IT_0018*IT_0337;
    const ccomplex_t IT_0339 = 2*IT_0338;
    const ccomplex_t IT_0340 = conj(N_B2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0341 = IT_0024*IT_0340;
    const ccomplex_t IT_0342 = 1.4142135623731*IT_0341;
    const ccomplex_t IT_0343 = conj(N_W2)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0350 = IT_0281*IT_0349;
    const ccomplex_t IT_0351 = IT_0283*IT_0312*IT_0350;
    const ccomplex_t IT_0352 = conj(N_u2)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0353 = IT_0018*IT_0352;
    const ccomplex_t IT_0354 = 2*IT_0353;
    const ccomplex_t IT_0355 = conj(N_B2)*conj(V_u2)*e_em;
    const ccomplex_t IT_0356 = IT_0024*IT_0355;
    const ccomplex_t IT_0357 = 1.4142135623731*IT_0356;
    const ccomplex_t IT_0358 = conj(N_W2)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0365 = IT_0257*IT_0364;
    const ccomplex_t IT_0366 = IT_0259*IT_0300*IT_0365;
    const ccomplex_t IT_0367 = IT_0334 + IT_0336 + IT_0351 + IT_0366;
    const ccomplex_t IT_0368 = (-2)*conj(IT_0367);
    const ccomplex_t IT_0369 = m_N_2*IT_0180;
    const ccomplex_t IT_0370 = m_N_2*IT_0157;
    const ccomplex_t IT_0371 = IT_0319*IT_0349;
    const ccomplex_t IT_0372 = IT_0283*IT_0371;
    const ccomplex_t IT_0373 = (0 + _Complex_I*1)*IT_0372;
    const ccomplex_t IT_0374 = m_N_3*IT_0373;
    const ccomplex_t IT_0375 = IT_0307*IT_0364;
    ...
    const ccomplex_t IT_0403 = -IT_0097 + -IT_0116 + -IT_0133;
    const ccomplex_t IT_0404 = -IT_0205 + -IT_0216 + -IT_0231 + (-2)*IT_0261 +
       (-2)*IT_0285;
    ...
    const ccomplex_t IT_0418 = m_N_2*IT_0401;
    ...
    const ccomplex_t IT_0459 = m_N_2*IT_0455;
    const ccomplex_t IT_0460 = m_N_3*IT_0401;
    const ccomplex_t IT_0461 = (-2)*IT_0367;
    const ccomplex_t IT_0462 = s_12*IT_0455;
    ...
    const ccomplex_t IT_0481 = IT_0461 + IT_0480;
    ...
    const ccomplex_t IT_0487 = IT_0007*(conj(IT_0134)*IT_0234 + IT_0134
      ...
      *IT_0449)) + 6*IT_0000*(IT_0409*IT_0420 + IT_0413*(conj(IT_0379) +
      ...
      (IT_0405)*IT_0430 + IT_0405*IT_0431 + conj(IT_0403)*IT_0457 + IT_0403
      *IT_0458) + (IT_0409*IT_0438 + IT_0413*IT_0441 + IT_0419*IT_0457 + IT_0420
      *IT_0458)*IT_0459 + IT_0460*(IT_0368*IT_0403 + IT_0388*IT_0405 + conj
      (IT_0405)*IT_0417 + conj(IT_0379)*IT_0438 + IT_0379*IT_0441 + IT_0409
      *IT_0457 + IT_0413*IT_0458 + conj(IT_0403)*IT_0461) + 2*(IT_0403*conj
      (IT_0403) + 0.5*conj(IT_0404)*IT_0430 + 0.5*conj(IT_0405)*IT_0438 + 0.5
      *IT_0405*IT_0440)*IT_0462 + (-2)*conj(IT_0398)*(IT_0286*IT_0464 + -IT_0383
