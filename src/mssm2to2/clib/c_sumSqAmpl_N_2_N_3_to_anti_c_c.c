        ...
        )
{
    ...
    const ccomplex_t IT_0350 = m_c*s_14*m_N_3;
    const ccomplex_t IT_0351 = IT_0162*IT_0239;
    const ccomplex_t IT_0352 = IT_0165*IT_0351;
    const ccomplex_t IT_0353 = (0 + _Complex_I*1)*IT_0352;
    const ccomplex_t IT_0354 = IT_0168*IT_0251;
    ...
    const ccomplex_t IT_0386 = m_c*s_24*m_N_2;
    ...
    const ccomplex_t IT_0392 = m_c*s_23*m_N_2;
    ...
    const ccomplex_t IT_0400 = IT_0348*IT_0367 + IT_0347*conj(IT_0367) +
       IT_0346*IT_0380 + IT_0345*conj(IT_0380) + conj(IT_0338)*(24*IT_0367 +
       IT_0383) + IT_0338*(24*conj(IT_0367) + IT_0384) + conj(IT_0357)*IT_0387 +
    ...
    const ccomplex_t IT_0402 = IT_0346*IT_0357 + IT_0345*conj(IT_0357) + (24
      *conj(IT_0338) + IT_0348)*IT_0361 + (24*IT_0338 + IT_0347)*conj(IT_0361) +
       conj(IT_0274)*IT_0381 + IT_0274*IT_0382 + conj(IT_0318)*IT_0383 + IT_0318
      *IT_0384 + conj(IT_0338)*IT_0393 + IT_0338*IT_0394 + conj(IT_0367)*IT_0397
       + IT_0367*IT_0399;
    ...
    const ccomplex_t IT_0416 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      ...
      *IT_0408 + conj(IT_0367)*IT_0411 + conj(IT_0361)*(48*IT_0367 + IT_0412) +
       IT_0361*IT_0413 + IT_0367*IT_0414;
