...
ccomplex_return_t c_sumSqAmpl_N_2_N_3_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
    ...
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0263 = m_d*m_N_3;
    ...
    const ccomplex_t IT_0292 = m_d*s_13*m_N_3;
    ...
    const ccomplex_t IT_0299 = IT_0001*IT_0011;
    const ccomplex_t IT_0300 = conj(N_d2)*N_d3*e_em;
    const ccomplex_t IT_0301 = IT_0299*IT_0300;
    const ccomplex_t IT_0302 = IT_0002*IT_0010;
    const ccomplex_t IT_0303 = conj(N_u2)*N_u3*e_em;
    const ccomplex_t IT_0304 = IT_0302*IT_0303;
    const ccomplex_t IT_0305 = IT_0299*IT_0303;
    const ccomplex_t IT_0306 = IT_0300*IT_0302;
    const ccomplex_t IT_0307 = (0 + _Complex_I*1)*(IT_0301 + -IT_0304 + 
      -IT_0305 + IT_0306);
    ...
    const ccomplex_t IT_0322 = N_d2*conj(N_d3)*e_em;
    const ccomplex_t IT_0323 = IT_0302*IT_0322;
    const ccomplex_t IT_0324 = IT_0299*IT_0322;
    const ccomplex_t IT_0325 = N_u2*conj(N_u3)*e_em;
    const ccomplex_t IT_0326 = IT_0302*IT_0325;
    const ccomplex_t IT_0327 = IT_0299*IT_0325;
    ...
    const ccomplex_t IT_0332 = e_em*IT_0299;
    const ccomplex_t IT_0333 = (0 + _Complex_I*1)*(IT_0331 + 3*IT_0332);
    const ccomplex_t IT_0334 = (-0.166666666666667)*IT_0333;
    const ccomplex_t IT_0335 = IT_0311*IT_0334;
    const ccomplex_t IT_0336 = (0 + _Complex_I*1)*IT_0335;
    const ccomplex_t IT_0337 = IT_0330*IT_0336;
    const ccomplex_t IT_0338 = -IT_0337;
    const ccomplex_t IT_0339 = 12*IT_0181;
    const ccomplex_t IT_0340 = 24*IT_0153;
    const ccomplex_t IT_0341 = IT_0339 + IT_0340;
    const ccomplex_t IT_0342 = 12*conj(IT_0181);
    const ccomplex_t IT_0343 = 24*conj(IT_0153);
    ...
    const ccomplex_t IT_0349 = IT_0292*(conj(IT_0274)*IT_0295 + IT_0274
      *IT_0298 + conj(IT_0315)*IT_0318 + IT_0315*IT_0321 + conj(IT_0338)*IT_0341
    ...
    const ccomplex_t IT_0358 = IT_0290 + IT_0339;
    const ccomplex_t IT_0359 = IT_0291 + IT_0342;
    const ccomplex_t IT_0360 = IT_0308*IT_0336;
    const ccomplex_t IT_0361 = -IT_0360;
    const ccomplex_t IT_0362 = 12*IT_0236;
    const ccomplex_t IT_0363 = 24*IT_0255;
    const ccomplex_t IT_0364 = IT_0362 + IT_0363;
    const ccomplex_t IT_0365 = 12*conj(IT_0236);
    const ccomplex_t IT_0366 = 24*conj(IT_0255);
    const ccomplex_t IT_0367 = IT_0365 + IT_0366;
    const ccomplex_t IT_0368 = IT_0313*IT_0330;
    const ccomplex_t IT_0369 = -IT_0368;
    const ccomplex_t IT_0370 = 24*IT_0181;
    const ccomplex_t IT_0371 = IT_0294 + IT_0370;
    const ccomplex_t IT_0372 = 24*conj(IT_0181);
    const ccomplex_t IT_0373 = IT_0297 + IT_0372;
    ...
    const ccomplex_t IT_0385 = IT_0350*(conj(IT_0357)*IT_0358 + IT_0357
      *IT_0359 + conj(IT_0361)*IT_0364 + IT_0361*IT_0367 + conj(IT_0369)*IT_0371
       + IT_0369*IT_0373 + conj(IT_0236)*IT_0381 + IT_0236*IT_0382 + conj
      (IT_0255)*IT_0383 + IT_0255*IT_0384);
    const ccomplex_t IT_0386 = m_d*s_24*m_N_2;
    ...
    const ccomplex_t IT_0391 = IT_0386*(conj(IT_0281)*IT_0295 + IT_0281
      *IT_0298 + IT_0321*IT_0338 + IT_0318*conj(IT_0338) + conj(IT_0315)*IT_0341
       + IT_0315*IT_0344 + conj(IT_0255)*IT_0387 + IT_0255*IT_0388 + conj
      (IT_0236)*IT_0389 + IT_0236*IT_0390);
    const ccomplex_t IT_0392 = m_d*s_23*m_N_2;
    ...
    const ccomplex_t IT_0395 = conj(IT_0236)*IT_0357 + IT_0236*conj(IT_0357) +
       0.166666666666667*IT_0367*IT_0369 + 0.166666666666667*IT_0364*conj
      (IT_0369) + 0.166666666666667*conj(IT_0361)*IT_0371 + 0.166666666666667
    ...
    const ccomplex_t IT_0396 = 24*IT_0315 + IT_0347;
    const ccomplex_t IT_0397 = 24*conj(IT_0315);
    const ccomplex_t IT_0398 = IT_0348 + IT_0397;
    const ccomplex_t IT_0399 = 24*IT_0338;
    const ccomplex_t IT_0400 = IT_0389 + IT_0399;
    const ccomplex_t IT_0401 = 24*conj(IT_0338);
    const ccomplex_t IT_0402 = IT_0390 + IT_0401;
    const ccomplex_t IT_0403 = IT_0346*IT_0380 + IT_0345*conj(IT_0380) + conj
      (IT_0315)*IT_0383 + IT_0315*IT_0384 + conj(IT_0357)*IT_0387 + IT_0357
      *IT_0388 + conj(IT_0338)*IT_0393 + IT_0338*IT_0394 + conj(IT_0361)*IT_0396
       + IT_0361*IT_0398 + conj(IT_0369)*IT_0400 + IT_0369*IT_0402;
    const ccomplex_t IT_0404 = s_34*m_N_2*m_N_3;
    const ccomplex_t IT_0405 = IT_0346*IT_0357 + IT_0345*conj(IT_0357) + conj
      (IT_0274)*IT_0381 + IT_0274*IT_0382 + conj(IT_0338)*IT_0383 + IT_0338
      *IT_0384 + conj(IT_0315)*IT_0393 + IT_0315*IT_0394 + conj(IT_0369)*IT_0396
       + IT_0369*IT_0398 + conj(IT_0361)*IT_0400 + IT_0361*IT_0402;
    const ccomplex_t IT_0406 = 24*IT_0357;
    const ccomplex_t IT_0407 = 48*IT_0369;
    const ccomplex_t IT_0408 = IT_0406 + IT_0407;
    const ccomplex_t IT_0409 = 24*IT_0380;
    const ccomplex_t IT_0410 = 24*conj(IT_0380);
    const ccomplex_t IT_0411 = 24*conj(IT_0357);
    const ccomplex_t IT_0412 = s_13 + s_14;
    const ccomplex_t IT_0413 = IT_0263*IT_0412;
    const ccomplex_t IT_0414 = 6*IT_0053;
    const ccomplex_t IT_0415 = 6*conj(IT_0053);
    const ccomplex_t IT_0416 = 12*IT_0053;
    const ccomplex_t IT_0417 = 12*conj(IT_0053);
    const ccomplex_t IT_0418 = 12*IT_0082;
    const ccomplex_t IT_0419 = 12*conj(IT_0082);
    const ccomplex_t IT_0420 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0421 = (-12)*IT_0082;
    const ccomplex_t IT_0422 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0423 = (-6)*IT_0053;
    const ccomplex_t IT_0424 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0425 = (-12)*IT_0053*conj(IT_0338) + (-6)*conj(IT_0082
      )*((-0.166666666666667)*IT_0345 + IT_0380) + (-6)*IT_0082*((
      -0.166666666666667)*IT_0346 + conj(IT_0380)) + conj(IT_0357)*IT_0414 +
       IT_0357*IT_0415 + conj(IT_0369)*IT_0416 + IT_0369*IT_0417 + conj(IT_0315)
      *IT_0418 + IT_0315*IT_0419 + IT_0338*IT_0420 + conj(IT_0361)*IT_0421 +
       IT_0361*IT_0422 + conj(IT_0274)*IT_0423 + IT_0274*IT_0424;
    const ccomplex_t IT_0426 = IT_0084*IT_0256;
    const ccomplex_t IT_0427 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0181 + (
      -0.0416666666666667)*IT_0290) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0181) + (-0.0416666666666667)*IT_0291) + (-0.166666666666667)*conj
      (IT_0255)*IT_0414 + (-0.166666666666667)*IT_0255*IT_0415 + (
      -0.166666666666667)*conj(IT_0236)*IT_0423 + (-0.166666666666667)*IT_0236
      *IT_0424;
    const ccomplex_t IT_0428 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0429 = 6*IT_0082;
    const ccomplex_t IT_0430 = 6*conj(IT_0082);
    const ccomplex_t IT_0431 = s_23 + s_24;
    const ccomplex_t IT_0432 = IT_0284*IT_0431;
    const ccomplex_t IT_0433 = (-6)*IT_0082;
    const ccomplex_t IT_0434 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0435 = (-12)*IT_0053*conj(IT_0315) + conj(IT_0380)
      *IT_0414 + IT_0380*IT_0415 + conj(IT_0361)*IT_0416 + IT_0361*IT_0417 +
       conj(IT_0338)*IT_0418 + IT_0338*IT_0419 + IT_0315*IT_0420 + conj(IT_0369)
      *IT_0421 + IT_0369*IT_0422 + conj(IT_0281)*IT_0423 + IT_0281*IT_0424 +
       conj(IT_0274)*IT_0429 + IT_0274*IT_0430 + conj(IT_0357)*IT_0433 + IT_0357
      *IT_0434;
    const ccomplex_t IT_0436 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0437 = (-2)*IT_0266;
    const ccomplex_t IT_0438 = (-3)*IT_0130;
    const ccomplex_t IT_0439 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0440 = (-3)*IT_0215;
    const ccomplex_t IT_0441 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0442 = 2*IT_0287;
    const ccomplex_t IT_0443 = (-2)*IT_0259;
    const ccomplex_t IT_0444 = (-4)*IT_0266;
    const ccomplex_t IT_0445 = conj(IT_0338) + conj(IT_0369);
    const ccomplex_t IT_0446 = IT_0338 + IT_0369;
    const ccomplex_t IT_0447 = conj(IT_0315) + conj(IT_0361);
    const ccomplex_t IT_0448 = IT_0315 + IT_0361;
    const ccomplex_t IT_0449 = 4*IT_0287;
    const ccomplex_t IT_0450 = m_N_2*m_N_3*IT_0083;
    const ccomplex_t IT_0451 = 24*IT_0274;
    const ccomplex_t IT_0452 = 48*IT_0338;
    const ccomplex_t IT_0453 = IT_0451 + IT_0452;
    const ccomplex_t IT_0454 = 24*conj(IT_0281);
    const ccomplex_t IT_0455 = 24*conj(IT_0274);
    const ccomplex_t IT_0456 = 48*IT_0315;
    const ccomplex_t IT_0457 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0274)*IT_0347 + IT_0274*IT_0348 + conj(IT_0255)*IT_0358 + IT_0255
      *IT_0359 + conj(IT_0357)*IT_0383 + IT_0357*IT_0384 + conj(IT_0361)*IT_0408
       + conj(IT_0369)*IT_0409 + IT_0369*IT_0410 + IT_0361*(48*conj(IT_0369) +
       IT_0411) + conj(IT_0315)*IT_0453 + IT_0338*IT_0454 + IT_0315*IT_0455 +
       conj(IT_0338)*(24*IT_0281 + IT_0456);
    const ccomplex_t IT_0458 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0403 + IT_0404*IT_0405 + IT_0155*(conj(IT_0255)*IT_0316 + conj(IT_0181
      )*IT_0339 + conj(IT_0380)*IT_0383 + conj(IT_0357)*IT_0393 + conj(IT_0369)
      *IT_0408 + conj(IT_0361)*IT_0409 + IT_0361*(48*conj(IT_0361) + IT_0410) +
       IT_0369*IT_0411) + IT_0413*IT_0425 + (-6)*IT_0426*IT_0427 + IT_0428*(conj
      (IT_0153)*IT_0423 + IT_0153*IT_0424 + conj(IT_0236)*IT_0429 + IT_0236
      *IT_0430) + IT_0432*IT_0435 + (conj(IT_0181)*IT_0414 + IT_0181*IT_0415 +
       conj(IT_0255)*IT_0433 + IT_0255*IT_0434)*IT_0436 + IT_0437*(conj(IT_0357)
      *IT_0438 + IT_0357*IT_0439 + conj(IT_0380)*IT_0440 + IT_0380*IT_0441) + 
      (conj(IT_0380)*IT_0438 + IT_0380*IT_0439 + conj(IT_0357)*IT_0440 + IT_0357
      *IT_0441)*IT_0442 + (conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj
      (IT_0153)*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0438 + IT_0255
      *IT_0439 + conj(IT_0181)*IT_0440 + IT_0181*IT_0441)*IT_0443 + IT_0444*
      (IT_0438*IT_0445 + IT_0439*IT_0446 + IT_0440*IT_0447 + IT_0441*IT_0448) + 
      (IT_0440*IT_0445 + IT_0441*IT_0446 + IT_0438*IT_0447 + IT_0439*IT_0448)
      *IT_0449 + IT_0156*(conj(IT_0153)*IT_0294 + conj(IT_0281)*IT_0347 + conj
      (IT_0236)*IT_0362 + conj(IT_0274)*IT_0389 + conj(IT_0338)*IT_0453 +
       IT_0315*IT_0454 + IT_0338*IT_0455 + conj(IT_0315)*(24*IT_0281 + IT_0456))
       + IT_0450*IT_0457;
