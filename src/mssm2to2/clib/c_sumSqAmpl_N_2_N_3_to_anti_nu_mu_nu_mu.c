...
ccomplex_return_t c_sumSqAmpl_N_2_N_3_to_anti_nu_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B3*e_em;
    ...
    const ccomplex_t IT_0021 = pow(m_N_3, 2);
    ...
    const ccomplex_t IT_0026 = IT_0000*IT_0006;
    const ccomplex_t IT_0027 = conj(N_d2)*N_d3*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = IT_0001*IT_0005;
    const ccomplex_t IT_0030 = conj(N_u2)*N_u3*e_em;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = IT_0026*IT_0030;
    const ccomplex_t IT_0033 = IT_0027*IT_0029;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*(IT_0028 + -IT_0031 + 
      -IT_0032 + IT_0033);
    const ccomplex_t IT_0035 = (-0.5)*IT_0034;
    const ccomplex_t IT_0036 = e_em*IT_0029;
    ...
    const ccomplex_t IT_0046 = s_14*s_23;
    ...
    const ccomplex_t IT_0051 = N_u2*conj(N_u3)*e_em;
    const ccomplex_t IT_0052 = IT_0029*IT_0051;
    const ccomplex_t IT_0053 = IT_0026*IT_0051;
    ...
    const ccomplex_t IT_0076 = cpow(s_13 + (-0.5)*IT_0040 + (-0.5)*reg_prop +
       0.5*m_snu_mu*(m_snu_mu + (0 + _Complex_I*-1)*Gamma_numl), -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = 0.5*IT_0078;
    const ccomplex_t IT_0080 = 2*IT_0058 + IT_0079;
    const ccomplex_t IT_0081 = 4*IT_0079;
    const ccomplex_t IT_0082 = 0.125*IT_0081;
    const ccomplex_t IT_0083 = IT_0058 + IT_0082;
    const ccomplex_t IT_0084 = s_34*m_N_2*m_N_3;
    const ccomplex_t IT_0085 = 4*(IT_0025 + 2*IT_0045)*(conj(IT_0025) + 2*conj
      (IT_0045))*IT_0046 + 8*IT_0047*(conj(IT_0058)*IT_0080 + conj(IT_0079)
      *IT_0083) + 4*((IT_0025 + 2*IT_0045)*(conj(IT_0058) + 1./2*conj(IT_0079)) 
      + 1./2*conj(IT_0025)*IT_0080 + 2*conj(IT_0045)*IT_0083)*IT_0084;
