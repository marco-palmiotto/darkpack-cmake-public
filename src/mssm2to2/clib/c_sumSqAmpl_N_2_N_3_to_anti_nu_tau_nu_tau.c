...
ccomplex_return_t c_sumSqAmpl_N_2_N_3_to_anti_nu_tau_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = N_d2*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0049 = conj(N_d2)*N_d3*e_em;
    const ccomplex_t IT_0050 = IT_0029*IT_0049;
    const ccomplex_t IT_0051 = conj(N_u2)*N_u3*e_em;
    const ccomplex_t IT_0052 = IT_0026*IT_0051;
    const ccomplex_t IT_0053 = IT_0029*IT_0051;
    const ccomplex_t IT_0054 = IT_0026*IT_0049;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*(IT_0050 + -IT_0052 + 
      -IT_0053 + IT_0054);
    ...
    const ccomplex_t IT_0076 = cpow(s_23 + (-0.5)*IT_0041 + (-0.5)*reg_prop +
       0.5*m_snu_tau*(m_snu_tau + (0 + _Complex_I*-1)*Gamma_nutaul), -1);
    ...
    const ccomplex_t IT_0085 = 4*(IT_0025 + 2*IT_0046)*(conj(IT_0025) + 2*conj
      (IT_0046))*IT_0047 + 8*IT_0048*(conj(IT_0058)*IT_0080 + conj(IT_0079)
      *IT_0083) + 4*((IT_0025 + 2*IT_0046)*(conj(IT_0058) + 1./2*conj(IT_0079)) 
      + 1./2*conj(IT_0025)*IT_0080 + 2*conj(IT_0046)*IT_0083)*IT_0084;
