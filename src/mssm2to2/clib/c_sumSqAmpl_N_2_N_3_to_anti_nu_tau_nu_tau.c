        ...
        )
{
    ...
    const ccomplex_t IT_0027 = N_u2*conj(N_u3)*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = IT_0000*IT_0006;
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = N_d2*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0048 = conj(N_d2)*N_d3*e_em;
    ...
    const ccomplex_t IT_0083 = s_34*m_N_2*m_N_3;
