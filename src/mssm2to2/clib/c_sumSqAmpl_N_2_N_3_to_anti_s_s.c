        ...
        )
{
    ...
    const ccomplex_t IT_0146 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0398 = s_34*m_N_2*m_N_3;
    const ccomplex_t IT_0399 = IT_0345*IT_0356 + IT_0344*conj(IT_0356) + (24
      ...
      *IT_0383 + conj(IT_0366)*IT_0392 + IT_0366*IT_0394 + conj(IT_0337)*IT_0395
       + IT_0337*IT_0396;
    const ccomplex_t IT_0400 = m_s*s_23*m_N_2;
    ...
    const ccomplex_t IT_0414 = m_N_2*m_N_3*IT_0083;
