...
ccomplex_return_t c_sumSqAmpl_N_2_N_3_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
    ...
    const ccomplex_t IT_0161 = (-0.5)*IT_0145;
    const ccomplex_t IT_0162 = N_B3*e_em;
    const ccomplex_t IT_0163 = IT_0002*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = N_W3*e_em;
    ...
    const ccomplex_t IT_0171 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0172 = IT_0170*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0175 = 0.5*IT_0139;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0247 = IT_0171*IT_0246;
    ...
    const ccomplex_t IT_0253 = IT_0174*IT_0252;
    ...
    const ccomplex_t IT_0351 = IT_0177*IT_0251;
    const ccomplex_t IT_0352 = IT_0174*IT_0351;
    const ccomplex_t IT_0353 = (0 + _Complex_I*1)*IT_0352;
    const ccomplex_t IT_0354 = IT_0161*IT_0245;
    const ccomplex_t IT_0355 = IT_0171*IT_0354;
    ...
    const ccomplex_t IT_0360 = IT_0313*IT_0330;
    ...
    const ccomplex_t IT_0366 = IT_0308*IT_0336;
    ...
    const ccomplex_t IT_0374 = IT_0169*IT_0244;
    const ccomplex_t IT_0375 = IT_0171*IT_0374;
    const ccomplex_t IT_0376 = (0 + _Complex_I*1)*IT_0375;
    const ccomplex_t IT_0377 = IT_0175*IT_0249;
    const ccomplex_t IT_0378 = IT_0174*IT_0377;
    ...
    const ccomplex_t IT_0386 = m_s*s_24*m_N_2;
    ...
    const ccomplex_t IT_0392 = m_s*s_23*m_N_2;
    ...
    const ccomplex_t IT_0396 = s_34*m_N_2*m_N_3;
    const ccomplex_t IT_0397 = 24*IT_0315;
    const ccomplex_t IT_0398 = IT_0347 + IT_0397;
    const ccomplex_t IT_0399 = 24*conj(IT_0315);
    const ccomplex_t IT_0400 = IT_0348 + IT_0399;
    const ccomplex_t IT_0401 = 24*IT_0338;
    const ccomplex_t IT_0402 = IT_0389 + IT_0401;
    const ccomplex_t IT_0403 = 24*conj(IT_0338);
    const ccomplex_t IT_0404 = IT_0390 + IT_0403;
    const ccomplex_t IT_0405 = IT_0346*IT_0357 + IT_0345*conj(IT_0357) + conj
      ...
      *IT_0384 + conj(IT_0315)*IT_0393 + IT_0315*IT_0394 + conj(IT_0361)*IT_0398
       + IT_0361*IT_0400 + conj(IT_0367)*IT_0402 + IT_0367*IT_0404;
    const ccomplex_t IT_0406 = IT_0346*IT_0380 + IT_0345*conj(IT_0380) + conj
      (IT_0315)*IT_0383 + IT_0315*IT_0384 + conj(IT_0357)*IT_0387 + IT_0357
      *IT_0388 + conj(IT_0338)*IT_0393 + IT_0338*IT_0394 + conj(IT_0367)*IT_0398
       + IT_0367*IT_0400 + conj(IT_0361)*IT_0402 + IT_0361*IT_0404;
    const ccomplex_t IT_0407 = 24*IT_0274;
    const ccomplex_t IT_0408 = 48*IT_0338;
    const ccomplex_t IT_0409 = IT_0407 + IT_0408;
    const ccomplex_t IT_0410 = 24*IT_0281;
    const ccomplex_t IT_0411 = 24*conj(IT_0281);
    const ccomplex_t IT_0412 = 24*conj(IT_0274);
    const ccomplex_t IT_0413 = m_N_2*m_N_3*IT_0083;
    const ccomplex_t IT_0414 = 24*conj(IT_0380);
    const ccomplex_t IT_0415 = 48*conj(IT_0367);
    const ccomplex_t IT_0416 = IT_0414 + IT_0415;
    const ccomplex_t IT_0417 = 24*IT_0380;
    const ccomplex_t IT_0418 = 24*IT_0357;
    const ccomplex_t IT_0419 = 24*conj(IT_0357);
    const ccomplex_t IT_0420 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0274)*IT_0347 + IT_0274*IT_0348 + conj(IT_0255)*IT_0358 + IT_0255
      *IT_0359 + conj(IT_0357)*IT_0383 + IT_0357*IT_0384 + conj(IT_0315)*IT_0409
       + conj(IT_0338)*IT_0410 + IT_0338*IT_0411 + IT_0315*(48*conj(IT_0338) +
       IT_0412) + IT_0361*IT_0416 + conj(IT_0361)*(48*IT_0367 + IT_0417) + conj
      (IT_0367)*IT_0418 + IT_0367*IT_0419;
    const ccomplex_t IT_0421 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0422 = 6*IT_0082;
    const ccomplex_t IT_0423 = 6*conj(IT_0082);
    const ccomplex_t IT_0424 = (-6)*IT_0053;
    const ccomplex_t IT_0425 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0426 = s_13 + s_14;
    const ccomplex_t IT_0427 = IT_0263*IT_0426;
    const ccomplex_t IT_0428 = 6*IT_0053;
    const ccomplex_t IT_0429 = 6*conj(IT_0053);
    const ccomplex_t IT_0430 = 12*conj(IT_0053);
    const ccomplex_t IT_0431 = 12*IT_0082;
    const ccomplex_t IT_0432 = 12*conj(IT_0082);
    const ccomplex_t IT_0433 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0434 = (-12)*IT_0082;
    const ccomplex_t IT_0435 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0436 = -IT_0053*(conj(IT_0338) + -conj(IT_0361)) + (
      -0.5)*conj(IT_0082)*((-0.166666666666667)*IT_0345 + IT_0380) + (-0.5)
      *IT_0082*((-0.166666666666667)*IT_0346 + conj(IT_0380)) +
       0.0833333333333333*conj(IT_0274)*IT_0424 + 0.0833333333333333*IT_0274
      *IT_0425 + 0.0833333333333333*conj(IT_0357)*IT_0428 + 0.0833333333333333
      *IT_0357*IT_0429 + 0.0833333333333333*IT_0361*IT_0430 + 0.0833333333333333
      *conj(IT_0315)*IT_0431 + 0.0833333333333333*IT_0315*IT_0432 +
       0.0833333333333333*IT_0338*IT_0433 + 0.0833333333333333*conj(IT_0367)
      *IT_0434 + 0.0833333333333333*IT_0367*IT_0435;
    ...
    const ccomplex_t IT_0438 = (conj(IT_0082)*((-24)*IT_0053 + (-6)*IT_0181 +
       ...
       conj(IT_0236)*IT_0424 + IT_0236*IT_0425 + conj(IT_0255)*IT_0428 + IT_0255
      *IT_0429)*IT_0437;
    const ccomplex_t IT_0439 = s_23 + s_24;
    const ccomplex_t IT_0440 = IT_0284*IT_0439;
    const ccomplex_t IT_0441 = (-6)*IT_0082;
    const ccomplex_t IT_0442 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0443 = IT_0053*((-12)*conj(IT_0315) + 12*conj(IT_0367)
      ) + conj(IT_0274)*IT_0422 + IT_0274*IT_0423 + conj(IT_0281)*IT_0424 +
       IT_0281*IT_0425 + conj(IT_0380)*IT_0428 + IT_0380*IT_0429 + IT_0367
      *IT_0430 + conj(IT_0338)*IT_0431 + IT_0338*IT_0432 + IT_0315*IT_0433 +
       conj(IT_0361)*IT_0434 + IT_0361*IT_0435 + conj(IT_0357)*IT_0441 + IT_0357
      *IT_0442;
    const ccomplex_t IT_0444 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0445 = (-2)*IT_0266;
    const ccomplex_t IT_0446 = (-3)*IT_0130;
    const ccomplex_t IT_0447 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0448 = (-3)*IT_0215;
    const ccomplex_t IT_0449 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0450 = 2*IT_0287;
    const ccomplex_t IT_0451 = (-2)*IT_0259;
    const ccomplex_t IT_0452 = 4*IT_0287;
    const ccomplex_t IT_0453 = conj(IT_0315) + conj(IT_0367);
    const ccomplex_t IT_0454 = IT_0315 + IT_0367;
    const ccomplex_t IT_0455 = IT_0338 + IT_0361;
    ...
    const ccomplex_t IT_0457 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0349 + IT_0385 + IT_0391 + 6*IT_0392*IT_0395 + IT_0396
      *IT_0405 + IT_0154*IT_0406 + IT_0156*(conj(IT_0153)*IT_0294 + conj(IT_0281
      )*IT_0347 + conj(IT_0236)*IT_0368 + conj(IT_0274)*IT_0389 + conj(IT_0338)
      *IT_0409 + conj(IT_0315)*IT_0410 + IT_0315*(48*conj(IT_0315) + IT_0411) +
       IT_0338*IT_0412) + IT_0155*(conj(IT_0255)*IT_0316 + conj(IT_0181)*IT_0339
       + conj(IT_0380)*IT_0383 + conj(IT_0357)*IT_0393 + IT_0367*IT_0416 + conj
      (IT_0367)*IT_0417 + conj(IT_0361)*IT_0418 + IT_0361*(48*conj(IT_0361) +
       IT_0419)) + IT_0413*IT_0420 + IT_0421*(conj(IT_0236)*IT_0422 + IT_0236
      *IT_0423 + conj(IT_0153)*IT_0424 + IT_0153*IT_0425) + 12*IT_0427*IT_0436 +
       IT_0438 + IT_0440*IT_0443 + (conj(IT_0181)*IT_0428 + IT_0181*IT_0429 +
       conj(IT_0255)*IT_0441 + IT_0255*IT_0442)*IT_0444 + IT_0445*(conj(IT_0357)
      *IT_0446 + IT_0357*IT_0447 + conj(IT_0380)*IT_0448 + IT_0380*IT_0449) + 
      (conj(IT_0380)*IT_0446 + IT_0380*IT_0447 + conj(IT_0357)*IT_0448 + IT_0357
      *IT_0449)*IT_0450 + (conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj
      (IT_0153)*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0446 + IT_0255
      *IT_0447 + conj(IT_0181)*IT_0448 + IT_0181*IT_0449)*IT_0451 + IT_0452*(
      (conj(IT_0338) + conj(IT_0361))*IT_0448 + IT_0446*IT_0453 + IT_0447
      *IT_0454 + IT_0449*IT_0455) + ((conj(IT_0338) + conj(IT_0361))*IT_0446 +
       IT_0448*IT_0453 + IT_0449*IT_0454 + IT_0447*IT_0455)*IT_0456;
