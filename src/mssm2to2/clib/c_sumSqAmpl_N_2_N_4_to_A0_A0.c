...
ccomplex_return_t c_sumSqAmpl_N_2_N_4_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = sin(alpha);
    const ccomplex_t IT_0008 = sin(theta_W);
    const ccomplex_t IT_0009 = cpow(IT_0008, -1);
    const ccomplex_t IT_0010 = IT_0007*IT_0009;
    const ccomplex_t IT_0011 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0012 = IT_0010*IT_0011;
    const ccomplex_t IT_0013 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0014 = IT_0004*IT_0013;
    const ccomplex_t IT_0015 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0019 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0020 = IT_0018*IT_0019;
    const ccomplex_t IT_0021 = IT_0001*IT_0009;
    const ccomplex_t IT_0022 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0023 = IT_0021*IT_0022;
    const ccomplex_t IT_0024 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0025 = IT_0018*IT_0024;
    const ccomplex_t IT_0026 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_23 + IT_0048 + (0 + _Complex_I*1)
      *m_N_4*Gamma_o4 + reg_prop, -1);
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0099 = IT_0051*IT_0098;
    const ccomplex_t IT_0100 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0101 = IT_0054*IT_0100;
    const ccomplex_t IT_0102 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0103 = IT_0057*IT_0102;
    const ccomplex_t IT_0104 = conj(N_W4)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0109 = IT_0072*IT_0106;
    const ccomplex_t IT_0110 = m_N_4*IT_0109;
    const ccomplex_t IT_0111 = IT_0108 + IT_0110;
    const ccomplex_t IT_0112 = IT_0097*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0043 + IT_0048 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*IT_0113;
    const ccomplex_t IT_0115 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0116 = IT_0051*IT_0115;
    const ccomplex_t IT_0117 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0118 = IT_0054*IT_0117;
    const ccomplex_t IT_0119 = N_W2*N_u2*e_em;
    ...
    const ccomplex_t IT_0124 = IT_0072*IT_0123;
    const ccomplex_t IT_0125 = m_N_2*IT_0124;
    const ccomplex_t IT_0126 = IT_0074 + IT_0125;
    const ccomplex_t IT_0127 = IT_0114*IT_0126;
    const ccomplex_t IT_0128 = cpow((-2)*s_13 + IT_0042 + IT_0048 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*IT_0128;
    const ccomplex_t IT_0130 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0131 = IT_0051*IT_0130;
    const ccomplex_t IT_0132 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0133 = IT_0054*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0135 = IT_0057*IT_0134;
    const ccomplex_t IT_0136 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0137 = IT_0060*IT_0136;
    const ccomplex_t IT_0138 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0139 = IT_0051*IT_0138;
    const ccomplex_t IT_0140 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0141 = IT_0054*IT_0140;
    const ccomplex_t IT_0142 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0143 = IT_0057*IT_0142;
    const ccomplex_t IT_0144 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0148 = IT_0051*IT_0147;
    ...
    const ccomplex_t IT_0152 = IT_0057*IT_0151;
    ...
    const ccomplex_t IT_0177 = IT_0054*IT_0176;
    const ccomplex_t IT_0178 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0179 = IT_0057*IT_0178;
    const ccomplex_t IT_0180 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0183 = IT_0146*IT_0182;
    const ccomplex_t IT_0184 = m_N_4*IT_0183;
    const ccomplex_t IT_0185 = IT_0165 + IT_0184;
    const ccomplex_t IT_0186 = IT_0129*IT_0185;
    const ccomplex_t IT_0187 = IT_0004*IT_0019;
    const ccomplex_t IT_0188 = IT_0005*IT_0018;
    const ccomplex_t IT_0189 = IT_0004*IT_0024;
    const ccomplex_t IT_0190 = IT_0013*IT_0018;
    const ccomplex_t IT_0191 = IT_0187 + IT_0188 + IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = IT_0011*IT_0021;
    const ccomplex_t IT_0193 = IT_0010*IT_0022;
    const ccomplex_t IT_0194 = IT_0015*IT_0021;
    const ccomplex_t IT_0195 = IT_0010*IT_0026;
    ...
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*m_W*e_em*IT_0034*(IT_0001
    ...
    const ccomplex_t IT_0206 = cpow((-2)*s_23 + IT_0043 + IT_0048 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*IT_0206;
    const ccomplex_t IT_0208 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0209 = IT_0051*IT_0208;
    const ccomplex_t IT_0210 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0211 = IT_0054*IT_0210;
    const ccomplex_t IT_0212 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0213 = IT_0057*IT_0212;
    const ccomplex_t IT_0214 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0215 = IT_0060*IT_0214;
    const ccomplex_t IT_0216 = N_B1*N_u2*e_em;
    ...
    const ccomplex_t IT_0221 = IT_0057*IT_0220;
    const ccomplex_t IT_0222 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0225 = IT_0163*IT_0224;
    const ccomplex_t IT_0226 = m_N_2*IT_0225;
    const ccomplex_t IT_0227 = IT_0165 + IT_0226;
    const ccomplex_t IT_0228 = IT_0207*IT_0227;
    const ccomplex_t IT_0229 = cpow((-2)*s_23 + IT_0043 + IT_0048 + -m_N_3*
    ...
    const ccomplex_t IT_0233 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0234 = IT_0054*IT_0233;
    const ccomplex_t IT_0235 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0236 = IT_0057*IT_0235;
    const ccomplex_t IT_0237 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0238 = IT_0060*IT_0237;
    const ccomplex_t IT_0239 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0240 = IT_0051*IT_0239;
    const ccomplex_t IT_0241 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0242 = IT_0054*IT_0241;
    const ccomplex_t IT_0243 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0244 = IT_0057*IT_0243;
    const ccomplex_t IT_0245 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0248 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0249 = IT_0051*IT_0248;
    const ccomplex_t IT_0250 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0251 = IT_0054*IT_0250;
    const ccomplex_t IT_0252 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0253 = IT_0057*IT_0252;
    const ccomplex_t IT_0254 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0255 = IT_0060*IT_0254;
    const ccomplex_t IT_0256 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0257 = IT_0051*IT_0256;
    const ccomplex_t IT_0258 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0259 = IT_0054*IT_0258;
    const ccomplex_t IT_0260 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0261 = IT_0057*IT_0260;
    const ccomplex_t IT_0262 = conj(N_W4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0263 = IT_0060*IT_0262;
    ...
    const ccomplex_t IT_0267 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0268 = IT_0051*IT_0267;
    const ccomplex_t IT_0269 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0270 = IT_0054*IT_0269;
    const ccomplex_t IT_0271 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0272 = IT_0057*IT_0271;
    const ccomplex_t IT_0273 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0274 = IT_0060*IT_0273;
    const ccomplex_t IT_0275 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0276 = IT_0051*IT_0275;
    const ccomplex_t IT_0277 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0278 = IT_0054*IT_0277;
    const ccomplex_t IT_0279 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0280 = IT_0057*IT_0279;
    const ccomplex_t IT_0281 = N_W2*N_d3*e_em;
    const ccomplex_t IT_0282 = IT_0060*IT_0281;
    const ccomplex_t IT_0283 = (-0.5)*IT_0268 + 0.5*IT_0270 + 0.5*IT_0272 + (
      -0.5)*IT_0274 + (-0.5)*IT_0276 + 0.5*IT_0278 + 0.5*IT_0280 + (-0.5)*IT_0282;
    const ccomplex_t IT_0284 = IT_0264*IT_0283;
    const ccomplex_t IT_0285 = m_N_2*IT_0284;
    const ccomplex_t IT_0286 = IT_0266 + IT_0285;
    const ccomplex_t IT_0287 = IT_0230*IT_0286;
    const ccomplex_t IT_0288 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0289 = IT_0051*IT_0288;
    const ccomplex_t IT_0290 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0291 = IT_0054*IT_0290;
    const ccomplex_t IT_0292 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0293 = IT_0057*IT_0292;
    const ccomplex_t IT_0294 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0295 = IT_0060*IT_0294;
    const ccomplex_t IT_0296 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0297 = IT_0051*IT_0296;
    const ccomplex_t IT_0298 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0299 = IT_0054*IT_0298;
    const ccomplex_t IT_0300 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0301 = IT_0057*IT_0300;
    const ccomplex_t IT_0302 = N_W3*N_d4*e_em;
    const ccomplex_t IT_0303 = IT_0060*IT_0302;
    const ccomplex_t IT_0304 = (-0.5)*IT_0289 + 0.5*IT_0291 + 0.5*IT_0293 + (
      -0.5)*IT_0295 + (-0.5)*IT_0297 + 0.5*IT_0299 + 0.5*IT_0301 + (-0.5)*IT_0303;
    const ccomplex_t IT_0305 = IT_0247*IT_0304;
    const ccomplex_t IT_0306 = m_N_4*IT_0305;
    const ccomplex_t IT_0307 = IT_0266 + IT_0306;
    const ccomplex_t IT_0308 = cpow((-2)*s_13 + IT_0042 + IT_0048 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    ...
    const ccomplex_t IT_0326 = -IT_0047 + IT_0095 + 0.5*IT_0112 + IT_0127 +
       IT_0186 + -IT_0205 + IT_0228 + IT_0287 + IT_0310 + IT_0325;
    const ccomplex_t IT_0327 = IT_0091*IT_0321;
    const ccomplex_t IT_0328 = m_N_4*IT_0327;
    const ccomplex_t IT_0329 = m_N_2*IT_0322;
    const ccomplex_t IT_0330 = IT_0097*(IT_0328 + IT_0329);
    ...
    const ccomplex_t IT_0347 = IT_0091*IT_0123;
    const ccomplex_t IT_0348 = m_N_2*IT_0347;
    const ccomplex_t IT_0349 = m_N_4*IT_0124;
    ...
    const ccomplex_t IT_0365 = IT_0204*IT_0364;
    const ccomplex_t IT_0366 = m_N_2*IT_0092;
    const ccomplex_t IT_0367 = IT_0348 + IT_0366;
    const ccomplex_t IT_0368 = IT_0114*IT_0367;
    const ccomplex_t IT_0369 = m_N_4*IT_0225;
    const ccomplex_t IT_0370 = IT_0182*IT_0224;
    const ccomplex_t IT_0371 = m_N_1*IT_0370;
    const ccomplex_t IT_0372 = IT_0369 + IT_0371;
    const ccomplex_t IT_0373 = IT_0129*IT_0372;
    const ccomplex_t IT_0374 = m_N_2*IT_0183;
    const ccomplex_t IT_0375 = IT_0371 + IT_0374;
    const ccomplex_t IT_0376 = IT_0207*IT_0375;
    const ccomplex_t IT_0377 = m_N_2*IT_0305;
    const ccomplex_t IT_0378 = IT_0283*IT_0304;
    const ccomplex_t IT_0379 = m_N_3*IT_0378;
    const ccomplex_t IT_0380 = IT_0377 + IT_0379;
    const ccomplex_t IT_0381 = IT_0230*IT_0380;
    const ccomplex_t IT_0382 = m_N_4*IT_0284;
    const ccomplex_t IT_0383 = IT_0379 + IT_0382;
    const ccomplex_t IT_0384 = IT_0309*IT_0383;
    const ccomplex_t IT_0385 = IT_0328 + IT_0329;
    const ccomplex_t IT_0386 = IT_0097*IT_0385;
    const ccomplex_t IT_0387 = m_N_4*IT_0107;
    ...
    const ccomplex_t IT_0396 = IT_0097*(IT_0108 + IT_0110);
    ...
    const ccomplex_t IT_0407 = IT_0097*IT_0107;
    const ccomplex_t IT_0408 = 0.5*IT_0407;
    const ccomplex_t IT_0409 = IT_0114*IT_0124;
    const ccomplex_t IT_0410 = IT_0129*IT_0225;
    const ccomplex_t IT_0411 = IT_0207*IT_0225;
    const ccomplex_t IT_0412 = IT_0230*IT_0284;
    const ccomplex_t IT_0413 = IT_0284*IT_0309;
    const ccomplex_t IT_0414 = IT_0107*IT_0312;
    const ccomplex_t IT_0415 = IT_0050*IT_0124;
    ...
    const ccomplex_t IT_0419 = IT_0097*IT_0322;
    const ccomplex_t IT_0420 = 0.5*IT_0419;
    const ccomplex_t IT_0421 = IT_0050*IT_0092;
    const ccomplex_t IT_0422 = IT_0092*IT_0114;
    const ccomplex_t IT_0423 = IT_0183*IT_0207;
    const ccomplex_t IT_0424 = IT_0230*IT_0305;
    const ccomplex_t IT_0425 = IT_0312*IT_0322;
    const ccomplex_t IT_0426 = IT_0129*IT_0183;
    const ccomplex_t IT_0427 = IT_0305*IT_0309;
    ...
    const ccomplex_t IT_0435 = s_24*m_N_2;
    ...
    const ccomplex_t IT_0450 = m_N_2*m_N_4*IT_0048;
