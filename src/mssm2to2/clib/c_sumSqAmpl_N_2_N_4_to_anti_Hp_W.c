...
ccomplex_return_t c_sumSqAmpl_N_2_N_4_to_anti_Hp_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0023 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0024 = IT_0017*IT_0023;
    const ccomplex_t IT_0025 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0026 = IT_0020*IT_0025;
    const ccomplex_t IT_0027 = IT_0019 + IT_0022 + IT_0024 + IT_0026;
    const ccomplex_t IT_0028 = IT_0011*IT_0016;
    const ccomplex_t IT_0029 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = IT_0008*IT_0013;
    const ccomplex_t IT_0032 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0033 = IT_0031*IT_0032;
    const ccomplex_t IT_0034 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_12 + -IT_0004 + -IT_0043 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = IT_0042*IT_0045;
    const ccomplex_t IT_0047 = pow(m_Hp, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0043 + IT_0047 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0010*IT_0016;
    const ccomplex_t IT_0050 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = IT_0010*IT_0013;
    const ccomplex_t IT_0054 = conj(N_W4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0055 = IT_0053*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = IT_0052 + IT_0056;
    const ccomplex_t IT_0058 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0064 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0065 = IT_0013*IT_0064;
    const ccomplex_t IT_0066 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_23 + IT_0043 + IT_0047 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_12 + -IT_0004 + -IT_0043 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0099 = (0 + _Complex_I*1)*IT_0098;
    const ccomplex_t IT_0100 = IT_0029*IT_0049;
    const ccomplex_t IT_0101 = IT_0009*IT_0016;
    const ccomplex_t IT_0102 = IT_0018*IT_0101;
    const ccomplex_t IT_0103 = IT_0021*IT_0053;
    const ccomplex_t IT_0104 = IT_0009*IT_0013;
    const ccomplex_t IT_0105 = IT_0032*IT_0104;
    const ccomplex_t IT_0106 = IT_0034*IT_0049;
    const ccomplex_t IT_0107 = IT_0023*IT_0101;
    const ccomplex_t IT_0108 = IT_0025*IT_0053;
    const ccomplex_t IT_0109 = IT_0036*IT_0104;
    const ccomplex_t IT_0110 = 0.5*IT_0100 + (-0.5)*IT_0102 + (-0.5)*IT_0103 +
       0.5*IT_0105 + 0.5*IT_0106 + (-0.5)*IT_0107 + (-0.5)*IT_0108 + 0.5*IT_0109;
    const ccomplex_t IT_0111 = e_em*IT_0013;
    ...
    const ccomplex_t IT_0115 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0004 + -IT_0043 + -reg_prop, -1);
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*IT_0115;
    const ccomplex_t IT_0117 = IT_0017*IT_0029;
    const ccomplex_t IT_0118 = IT_0018*IT_0028;
    const ccomplex_t IT_0119 = IT_0017*IT_0034;
    const ccomplex_t IT_0120 = IT_0023*IT_0028;
    const ccomplex_t IT_0121 = IT_0117 + IT_0118 + IT_0119 + IT_0120;
    const ccomplex_t IT_0122 = IT_0021*IT_0031;
    const ccomplex_t IT_0123 = IT_0020*IT_0032;
    const ccomplex_t IT_0124 = IT_0025*IT_0031;
    const ccomplex_t IT_0125 = IT_0020*IT_0036;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1)*e_em*(IT_0008*IT_0010 +
    ...
    const ccomplex_t IT_0134 = -IT_0046 + 2*IT_0073 + 2*IT_0097 + -IT_0114 + 
      -IT_0133;
    const ccomplex_t IT_0135 = N_W2*e_em*conj(U_Wm1);
    const ccomplex_t IT_0136 = IT_0013*IT_0135;
    const ccomplex_t IT_0137 = N_d2*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0142 = N_d4*e_em*U_Wm1;
    const ccomplex_t IT_0143 = IT_0104*IT_0142;
    const ccomplex_t IT_0144 = (-2)*IT_0143;
    const ccomplex_t IT_0145 = N_B4*U_d1*e_em;
    const ccomplex_t IT_0146 = IT_0101*IT_0145;
    const ccomplex_t IT_0147 = 1.4142135623731*IT_0146;
    const ccomplex_t IT_0148 = N_W4*U_d1*e_em;
    ...
    const ccomplex_t IT_0165 = N_d4*e_em*U_Wm2;
    const ccomplex_t IT_0166 = IT_0104*IT_0165;
    const ccomplex_t IT_0167 = (-2)*IT_0166;
    const ccomplex_t IT_0168 = N_B4*U_d2*e_em;
    const ccomplex_t IT_0169 = IT_0101*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = N_W4*U_d2*e_em;
    const ccomplex_t IT_0172 = IT_0104*IT_0171;
    ...
    const ccomplex_t IT_0179 = IT_0048*IT_0178;
    ...
    const ccomplex_t IT_0184 = IT_0049*IT_0183;
    const ccomplex_t IT_0185 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0186 = IT_0101*IT_0185;
    const ccomplex_t IT_0187 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0188 = IT_0053*IT_0187;
    const ccomplex_t IT_0189 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0190 = IT_0104*IT_0189;
    const ccomplex_t IT_0191 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0192 = IT_0049*IT_0191;
    const ccomplex_t IT_0193 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0194 = IT_0101*IT_0193;
    const ccomplex_t IT_0195 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0196 = IT_0053*IT_0195;
    const ccomplex_t IT_0197 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0200 = IT_0112*IT_0199;
    const ccomplex_t IT_0201 = IT_0099*IT_0200;
    const ccomplex_t IT_0202 = IT_0017*IT_0183;
    const ccomplex_t IT_0203 = IT_0028*IT_0185;
    const ccomplex_t IT_0204 = IT_0017*IT_0191;
    const ccomplex_t IT_0205 = IT_0028*IT_0193;
    const ccomplex_t IT_0206 = IT_0202 + IT_0203 + IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = IT_0031*IT_0187;
    const ccomplex_t IT_0208 = IT_0020*IT_0189;
    const ccomplex_t IT_0209 = IT_0031*IT_0195;
    const ccomplex_t IT_0210 = IT_0020*IT_0197;
    ...
    const ccomplex_t IT_0217 = IT_0017*IT_0185;
    const ccomplex_t IT_0218 = IT_0020*IT_0187;
    const ccomplex_t IT_0219 = IT_0017*IT_0193;
    const ccomplex_t IT_0220 = IT_0020*IT_0195;
    const ccomplex_t IT_0221 = IT_0217 + IT_0218 + IT_0219 + IT_0220;
    const ccomplex_t IT_0222 = IT_0028*IT_0183;
    const ccomplex_t IT_0223 = IT_0031*IT_0189;
    const ccomplex_t IT_0224 = IT_0028*IT_0191;
    const ccomplex_t IT_0225 = IT_0031*IT_0197;
    ...
    const ccomplex_t IT_0230 = IT_0014*IT_0229;
    const ccomplex_t IT_0231 = IT_0045*IT_0230;
    ...
    const ccomplex_t IT_0254 = IT_0013*IT_0253;
    ...
    const ccomplex_t IT_0259 = cpow((-2)*s_13 + IT_0004 + IT_0047 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0263 = IT_0104*IT_0262;
    ...
    const ccomplex_t IT_0269 = IT_0104*IT_0268;
    ...
    const ccomplex_t IT_0275 = N_W4*e_em*conj(U_Wm1);
    const ccomplex_t IT_0276 = IT_0013*IT_0275;
    const ccomplex_t IT_0277 = N_d4*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0283 = cpow((-2)*s_13 + IT_0004 + IT_0047 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0294 = m_N_2*IT_0097;
    const ccomplex_t IT_0295 = m_N_2*IT_0073;
    ...
    const ccomplex_t IT_0301 = IT_0063*IT_0164;
    const ccomplex_t IT_0302 = IT_0048*IT_0300*IT_0301;
    const ccomplex_t IT_0303 = IT_0093*IT_0141;
    const ccomplex_t IT_0304 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0305 = IT_0095*IT_0303*IT_0304;
    const ccomplex_t IT_0306 = conj(N_W4)*e_em*V_Wp1;
    const ccomplex_t IT_0307 = IT_0013*IT_0306;
    const ccomplex_t IT_0308 = conj(N_u4)*V_u1*e_em;
    ...
    const ccomplex_t IT_0313 = IT_0274*IT_0312;
    const ccomplex_t IT_0314 = IT_0283*IT_0304*IT_0313;
    ...
    const ccomplex_t IT_0318 = IT_0013*IT_0317;
    ...
    const ccomplex_t IT_0322 = IT_0250*IT_0321;
    const ccomplex_t IT_0323 = IT_0259*IT_0300*IT_0322;
    const ccomplex_t IT_0324 = -IT_0302 + -IT_0305 + -IT_0314 + -IT_0323;
    ...
    const ccomplex_t IT_0333 = conj(N_u2)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0334 = IT_0053*IT_0333;
    const ccomplex_t IT_0335 = 2*IT_0334;
    const ccomplex_t IT_0336 = conj(N_B2)*conj(V_u2)*e_em;
    const ccomplex_t IT_0337 = IT_0049*IT_0336;
    const ccomplex_t IT_0338 = 1.4142135623731*IT_0337;
    const ccomplex_t IT_0339 = conj(N_W2)*conj(V_u2)*e_em;
    const ccomplex_t IT_0340 = IT_0053*IT_0339;
    ...
    const ccomplex_t IT_0346 = IT_0257*IT_0345;
    const ccomplex_t IT_0347 = IT_0259*IT_0300*IT_0346;
    const ccomplex_t IT_0348 = IT_0080*IT_0154;
    const ccomplex_t IT_0349 = IT_0095*IT_0304*IT_0348;
    const ccomplex_t IT_0350 = IT_0070*IT_0177;
    const ccomplex_t IT_0351 = IT_0048*IT_0300*IT_0350;
    const ccomplex_t IT_0352 = conj(N_u2)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0353 = IT_0053*IT_0352;
    const ccomplex_t IT_0354 = 2*IT_0353;
    const ccomplex_t IT_0355 = conj(N_B2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0356 = IT_0049*IT_0355;
    const ccomplex_t IT_0357 = 1.4142135623731*IT_0356;
    const ccomplex_t IT_0358 = conj(N_W2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0359 = IT_0053*IT_0358;
    ...
    const ccomplex_t IT_0366 = IT_0283*IT_0304*IT_0365;
    const ccomplex_t IT_0367 = IT_0347 + IT_0349 + IT_0351 + IT_0366;
    const ccomplex_t IT_0368 = (-2)*conj(IT_0367);
    const ccomplex_t IT_0369 = IT_0312*IT_0364;
    const ccomplex_t IT_0370 = IT_0283*IT_0369;
    const ccomplex_t IT_0371 = (0 + _Complex_I*1)*IT_0370;
    const ccomplex_t IT_0372 = m_N_4*IT_0371;
    const ccomplex_t IT_0373 = IT_0321*IT_0345;
    const ccomplex_t IT_0374 = IT_0259*IT_0373;
    const ccomplex_t IT_0375 = (0 + _Complex_I*1)*IT_0374;
    const ccomplex_t IT_0376 = m_N_4*IT_0375;
    const ccomplex_t IT_0377 = m_N_2*IT_0157;
    const ccomplex_t IT_0378 = m_N_2*IT_0180;
    ...
    const ccomplex_t IT_0398 = -IT_0073 + -IT_0097;
    ...
    const ccomplex_t IT_0403 = -IT_0046 + -IT_0114 + -IT_0133;
    ...
    const ccomplex_t IT_0408 = m_N_2*IT_0401;
    ...
    const ccomplex_t IT_0431 = s_14*IT_0043;
    ...
    const ccomplex_t IT_0456 = s_12*IT_0006;
    const ccomplex_t IT_0457 = IT_0000*IT_0454;
    const ccomplex_t IT_0458 = (-2)*IT_0404;
    const ccomplex_t IT_0459 = (-2)*conj(IT_0404);
    const ccomplex_t IT_0460 = m_N_2*IT_0454;
    ...
    const ccomplex_t IT_0487 = IT_0007*(conj(IT_0134)*IT_0234 + IT_0134
      ...
      *IT_0428 + IT_0134*IT_0429) + IT_0433*(IT_0423*IT_0428 + IT_0424*IT_0429 +
      ...
      (IT_0379)*IT_0406 + IT_0379*IT_0407 + IT_0412*IT_0417 + IT_0416*IT_0418 +
       ...
       0.166666666666667*IT_0450)) + 2*(IT_0403*conj(IT_0403) + 0.5*conj(IT_0404
      )*IT_0428 + 0.5*conj(IT_0405)*IT_0436 + 0.5*IT_0405*IT_0438)*IT_0455 + 
      (conj(IT_0181)*IT_0234 + IT_0181*IT_0236 + conj(IT_0134)*IT_0406 + conj
      (IT_0232)*IT_0410)*IT_0456 + IT_0457*(conj(IT_0405)*IT_0428 + IT_0405
      *IT_0429 + conj(IT_0403)*IT_0458 + IT_0403*IT_0459) + (IT_0417*IT_0436 +
       IT_0418*IT_0439 + IT_0409*IT_0458 + IT_0413*IT_0459)*IT_0460 + IT_0461*
      (IT_0368*IT_0403 + IT_0388*IT_0405 + conj(IT_0379)*IT_0436 + IT_0379
      *IT_0439 + conj(IT_0405)*IT_0441 + IT_0417*IT_0458 + IT_0418*IT_0459 +
