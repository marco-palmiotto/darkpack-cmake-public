        ...
        )
{
    ...
    const ccomplex_t IT_0200 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0201 = IT_0002*IT_0200;
    const ccomplex_t IT_0202 = 1.4142135623731*IT_0201;
    const ccomplex_t IT_0203 = m_b*N_d2*e_em*IT_0027*U_sb_00;
    ...
    const ccomplex_t IT_0211 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0212 = N_B4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0213 = IT_0002*IT_0212;
    const ccomplex_t IT_0214 = 1.4142135623731*IT_0213;
    const ccomplex_t IT_0215 = N_W4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0216 = IT_0011*IT_0215;
    const ccomplex_t IT_0217 = 1.4142135623731*IT_0216;
    const ccomplex_t IT_0218 = m_b*N_d4*e_em*IT_0027*conj(U_sb_11);
    const ccomplex_t IT_0219 = IT_0135*IT_0218;
    const ccomplex_t IT_0220 = 1.4142135623731*IT_0219;
    const ccomplex_t IT_0221 = (0 + _Complex_I*1)*(IT_0214 + (-3)*IT_0217 + 3
      *IT_0220);
    const ccomplex_t IT_0222 = 0.166666666666667*IT_0221;
    const ccomplex_t IT_0223 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0224 = IT_0002*IT_0223;
    const ccomplex_t IT_0225 = 1.4142135623731*IT_0224;
    const ccomplex_t IT_0226 = m_b*N_d2*e_em*IT_0027*U_sb_01;
    const ccomplex_t IT_0227 = IT_0135*IT_0226;
    ...
    const ccomplex_t IT_0240 = IT_0056*IT_0087;
    const ccomplex_t IT_0241 = IT_0058*IT_0090;
    const ccomplex_t IT_0242 = IT_0064*IT_0087;
    const ccomplex_t IT_0243 = IT_0066*IT_0090;
    const ccomplex_t IT_0244 = IT_0240 + IT_0241 + IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = IT_0054*IT_0095;
    const ccomplex_t IT_0246 = IT_0060*IT_0097;
    const ccomplex_t IT_0247 = IT_0062*IT_0095;
    const ccomplex_t IT_0248 = IT_0068*IT_0097;
    ...
    const ccomplex_t IT_0269 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0270 = IT_0002*IT_0269;
    const ccomplex_t IT_0271 = 1.4142135623731*IT_0270;
    const ccomplex_t IT_0272 = m_b*conj(N_d2)*e_em*IT_0027*conj(U_sb_00);
    const ccomplex_t IT_0273 = IT_0135*IT_0272;
    const ccomplex_t IT_0274 = 1.4142135623731*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*(IT_0271 + 1.5*IT_0274);
    const ccomplex_t IT_0276 = (-0.333333333333333)*IT_0275;
    const ccomplex_t IT_0277 = m_b*conj(N_d4)*e_em*IT_0027*U_sb_10;
    const ccomplex_t IT_0278 = IT_0135*IT_0277;
    const ccomplex_t IT_0279 = 1.4142135623731*IT_0278;
    const ccomplex_t IT_0280 = conj(N_B4)*e_em*U_sb_00;
    const ccomplex_t IT_0281 = IT_0002*IT_0280;
    const ccomplex_t IT_0282 = 1.4142135623731*IT_0281;
    const ccomplex_t IT_0283 = conj(N_W4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0292 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0293 = IT_0002*IT_0292;
    const ccomplex_t IT_0294 = 1.4142135623731*IT_0293;
    const ccomplex_t IT_0295 = m_b*conj(N_d2)*e_em*IT_0027*conj(U_sb_01);
    const ccomplex_t IT_0296 = IT_0135*IT_0295;
    ...
    const ccomplex_t IT_0316 = m_b*conj(N_d2)*e_em*IT_0027*U_sb_10;
    const ccomplex_t IT_0317 = IT_0135*IT_0316;
    const ccomplex_t IT_0318 = 1.4142135623731*IT_0317;
    const ccomplex_t IT_0319 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0320 = IT_0002*IT_0319;
    const ccomplex_t IT_0321 = 1.4142135623731*IT_0320;
    const ccomplex_t IT_0322 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0323 = IT_0011*IT_0322;
    const ccomplex_t IT_0324 = 1.4142135623731*IT_0323;
    const ccomplex_t IT_0325 = (0 + _Complex_I*1)*(IT_0318 + 0.333333333333333
      *IT_0321 + -IT_0324);
    const ccomplex_t IT_0326 = 3*IT_0325;
    const ccomplex_t IT_0327 = 0.166666666666667*IT_0326;
    const ccomplex_t IT_0328 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0329 = IT_0002*IT_0328;
    const ccomplex_t IT_0330 = 1.4142135623731*IT_0329;
    const ccomplex_t IT_0331 = m_b*conj(N_d4)*e_em*IT_0027*conj(U_sb_00);
    const ccomplex_t IT_0332 = IT_0135*IT_0331;
    const ccomplex_t IT_0333 = 1.4142135623731*IT_0332;
    const ccomplex_t IT_0334 = (0 + _Complex_I*1)*(IT_0330 + 1.5*IT_0333);
    const ccomplex_t IT_0335 = (-0.333333333333333)*IT_0334;
    ...
    const ccomplex_t IT_0339 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0340 = IT_0002*IT_0339;
    const ccomplex_t IT_0341 = 1.4142135623731*IT_0340;
    const ccomplex_t IT_0342 = m_b*conj(N_d4)*e_em*IT_0027*conj(U_sb_01);
    const ccomplex_t IT_0343 = IT_0135*IT_0342;
    const ccomplex_t IT_0344 = 1.4142135623731*IT_0343;
    const ccomplex_t IT_0345 = (0 + _Complex_I*1)*(IT_0341 + 1.5*IT_0344);
    const ccomplex_t IT_0346 = (-0.333333333333333)*IT_0345;
    const ccomplex_t IT_0347 = m_b*conj(N_d2)*e_em*IT_0027*U_sb_11;
    const ccomplex_t IT_0348 = IT_0135*IT_0347;
    const ccomplex_t IT_0349 = 1.4142135623731*IT_0348;
    const ccomplex_t IT_0350 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0351 = IT_0011*IT_0350;
    const ccomplex_t IT_0352 = 1.4142135623731*IT_0351;
    const ccomplex_t IT_0353 = conj(N_B2)*e_em*U_sb_01;
    const ccomplex_t IT_0354 = IT_0002*IT_0353;
    const ccomplex_t IT_0355 = 1.4142135623731*IT_0354;
    const ccomplex_t IT_0356 = (0 + _Complex_I*1)*(IT_0349 + -IT_0352 +
       0.333333333333333*IT_0355);
    const ccomplex_t IT_0357 = 3*IT_0356;
    const ccomplex_t IT_0358 = 0.166666666666667*IT_0357;
    const ccomplex_t IT_0359 = IT_0346*IT_0358;
    const ccomplex_t IT_0360 = IT_0211*IT_0359;
    const ccomplex_t IT_0361 = (0 + _Complex_I*1)*IT_0360;
    const ccomplex_t IT_0362 = -IT_0338 + -IT_0361;
    const ccomplex_t IT_0363 = m_N_2*m_N_4;
    ...
    const ccomplex_t IT_0370 = m_b*m_N_4;
    ...
    const ccomplex_t IT_0375 = IT_0153*IT_0288;
    ...
    const ccomplex_t IT_0382 = IT_0140*IT_0276;
    const ccomplex_t IT_0383 = IT_0131*IT_0382;
    const ccomplex_t IT_0384 = (0 + _Complex_I*1)*IT_0383;
    const ccomplex_t IT_0385 = IT_0165*IT_0299;
    const ccomplex_t IT_0386 = IT_0157*IT_0385;
    const ccomplex_t IT_0387 = (0 + _Complex_I*1)*IT_0386;
    const ccomplex_t IT_0388 = -IT_0384 + -IT_0387;
    const ccomplex_t IT_0389 = 3*IT_0268;
    const ccomplex_t IT_0390 = 3*conj(IT_0268);
    ...
    const ccomplex_t IT_0425 = 12*IT_0234;
    const ccomplex_t IT_0426 = 24*IT_0180;
    const ccomplex_t IT_0427 = IT_0425 + IT_0426;
    const ccomplex_t IT_0428 = 12*conj(IT_0234);
    ...
    const ccomplex_t IT_0456 = m_b*s_14*m_N_4;
    const ccomplex_t IT_0457 = IT_0207*IT_0335;
    const ccomplex_t IT_0458 = IT_0188*IT_0457;
    const ccomplex_t IT_0459 = (0 + _Complex_I*1)*IT_0458;
    const ccomplex_t IT_0460 = IT_0230*IT_0346;
    const ccomplex_t IT_0461 = IT_0211*IT_0460;
    ...
    const ccomplex_t IT_0468 = 24*IT_0234;
    const ccomplex_t IT_0469 = IT_0401 + IT_0468;
    const ccomplex_t IT_0470 = 24*conj(IT_0234);
    ...
    const ccomplex_t IT_0480 = IT_0199*IT_0327;
    const ccomplex_t IT_0481 = IT_0188*IT_0480;
    const ccomplex_t IT_0482 = (0 + _Complex_I*1)*IT_0481;
    const ccomplex_t IT_0483 = IT_0222*IT_0358;
    const ccomplex_t IT_0484 = IT_0211*IT_0483;
    ...
    const ccomplex_t IT_0498 = 24*IT_0444;
    const ccomplex_t IT_0499 = IT_0453 + IT_0498;
    const ccomplex_t IT_0500 = 24*conj(IT_0444);
    const ccomplex_t IT_0501 = IT_0454 + IT_0500;
    const ccomplex_t IT_0502 = 24*IT_0424;
    const ccomplex_t IT_0503 = IT_0495 + IT_0502;
    const ccomplex_t IT_0504 = 24*conj(IT_0424);
    const ccomplex_t IT_0505 = IT_0496 + IT_0504;
    const ccomplex_t IT_0506 = 12*IT_0463;
    const ccomplex_t IT_0507 = 12*conj(IT_0463);
    const ccomplex_t IT_0508 = IT_0452*IT_0486 + IT_0451*conj(IT_0486) + conj
      (IT_0444)*IT_0489 + IT_0444*IT_0490 + conj(IT_0463)*IT_0493 + IT_0463
      *IT_0494 + conj(IT_0473)*IT_0499 + IT_0473*IT_0501 + conj(IT_0467)*IT_0503
       + IT_0467*IT_0505 + conj(IT_0424)*IT_0506 + IT_0424*IT_0507;
    const ccomplex_t IT_0509 = s_34*m_N_2*m_N_4;
    const ccomplex_t IT_0510 = IT_0452*IT_0463 + IT_0451*conj(IT_0463) + conj
      (IT_0381)*IT_0487 + IT_0381*IT_0488 + conj(IT_0424)*IT_0489 + IT_0424
      *IT_0490 + conj(IT_0467)*IT_0499 + IT_0467*IT_0501 + conj(IT_0473)*IT_0503
       + IT_0473*IT_0505 + conj(IT_0444)*IT_0506 + IT_0444*IT_0507;
    const ccomplex_t IT_0511 = m_b*s_23*m_N_2;
    const ccomplex_t IT_0512 = conj(IT_0315)*IT_0463 + IT_0315*conj(IT_0463) +
      ...
      *IT_0464*conj(IT_0486) + 0.166666666666667*conj(IT_0362)*IT_0506 +
       0.166666666666667*IT_0362*IT_0507;
    const ccomplex_t IT_0513 = 24*IT_0463;
    const ccomplex_t IT_0514 = 48*IT_0467;
    const ccomplex_t IT_0515 = IT_0513 + IT_0514;
    const ccomplex_t IT_0516 = 24*IT_0486;
    const ccomplex_t IT_0517 = 24*conj(IT_0486);
    const ccomplex_t IT_0518 = 24*conj(IT_0463);
    const ccomplex_t IT_0519 = s_13 + s_14;
    const ccomplex_t IT_0520 = IT_0370*IT_0519;
    ...
    const ccomplex_t IT_0532 = (-12)*IT_0053*conj(IT_0424) + (-6)*conj(IT_0082
      )*((-0.166666666666667)*IT_0451 + IT_0486) + (-6)*IT_0082*((
      -0.166666666666667)*IT_0452 + conj(IT_0486)) + conj(IT_0463)*IT_0521 +
       IT_0463*IT_0522 + conj(IT_0467)*IT_0523 + IT_0467*IT_0524 + conj(IT_0444)
      *IT_0525 + IT_0444*IT_0526 + IT_0424*IT_0527 + conj(IT_0473)*IT_0528 +
       IT_0473*IT_0529 + conj(IT_0381)*IT_0530 + IT_0381*IT_0531;
    const ccomplex_t IT_0533 = IT_0181 + IT_0183 + IT_0185 + IT_0235;
    const ccomplex_t IT_0534 = 6*IT_0082;
    const ccomplex_t IT_0535 = 6*conj(IT_0082);
    const ccomplex_t IT_0536 = IT_0084*IT_0363;
    const ccomplex_t IT_0537 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0234 + (
      -0.0416666666666667)*IT_0397) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0234) + (-0.0416666666666667)*IT_0398) + (-0.166666666666667)*conj
      (IT_0362)*IT_0521 + (-0.166666666666667)*IT_0362*IT_0522 + (
      -0.166666666666667)*conj(IT_0315)*IT_0530 + (-0.166666666666667)*IT_0315
      *IT_0531;
    const ccomplex_t IT_0538 = s_23 + s_24;
    const ccomplex_t IT_0539 = IT_0391*IT_0538;
    const ccomplex_t IT_0540 = (-6)*IT_0082;
    const ccomplex_t IT_0541 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0542 = (-12)*IT_0053*conj(IT_0444) + conj(IT_0486)
      *IT_0521 + IT_0486*IT_0522 + conj(IT_0473)*IT_0523 + IT_0473*IT_0524 +
       conj(IT_0424)*IT_0525 + IT_0424*IT_0526 + IT_0444*IT_0527 + conj(IT_0467)
      *IT_0528 + IT_0467*IT_0529 + conj(IT_0388)*IT_0530 + IT_0388*IT_0531 +
       conj(IT_0381)*IT_0534 + IT_0381*IT_0535 + conj(IT_0463)*IT_0540 + IT_0463
      *IT_0541;
    const ccomplex_t IT_0543 = IT_0181 + IT_0182 + IT_0184 + IT_0185;
    const ccomplex_t IT_0544 = (-2)*IT_0373;
    const ccomplex_t IT_0545 = (-3)*IT_0130;
    const ccomplex_t IT_0546 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0547 = (-3)*IT_0268;
    const ccomplex_t IT_0548 = (-3)*conj(IT_0268);
    const ccomplex_t IT_0549 = 2*IT_0394;
    const ccomplex_t IT_0550 = (-2)*IT_0366;
    const ccomplex_t IT_0551 = 4*IT_0394;
    const ccomplex_t IT_0552 = conj(IT_0444) + conj(IT_0473);
    const ccomplex_t IT_0553 = IT_0444 + IT_0473;
    const ccomplex_t IT_0554 = conj(IT_0424) + conj(IT_0467);
    const ccomplex_t IT_0555 = IT_0424 + IT_0467;
    const ccomplex_t IT_0556 = (-4)*IT_0373;
    const ccomplex_t IT_0557 = m_N_2*m_N_4*IT_0083;
    const ccomplex_t IT_0558 = 24*conj(IT_0388);
    const ccomplex_t IT_0559 = 24*IT_0381;
    const ccomplex_t IT_0560 = 24*conj(IT_0381);
    const ccomplex_t IT_0561 = 48*IT_0444;
    const ccomplex_t IT_0562 = conj(IT_0315)*IT_0402 + IT_0315*IT_0405 + conj
      (IT_0381)*IT_0453 + IT_0381*IT_0454 + conj(IT_0362)*IT_0464 + IT_0362
      *IT_0465 + conj(IT_0463)*IT_0489 + IT_0463*IT_0490 + conj(IT_0473)*IT_0515
       + conj(IT_0467)*(48*IT_0473 + IT_0516) + IT_0467*IT_0517 + IT_0473
      *IT_0518 + IT_0424*(48*conj(IT_0444) + IT_0558) + conj(IT_0444)*IT_0559 +
       IT_0444*IT_0560 + conj(IT_0424)*(24*IT_0388 + IT_0561);
    const ccomplex_t IT_0563 = IT_0183*(conj(IT_0180)*IT_0401 + conj(IT_0388)
      *IT_0453 + conj(IT_0315)*IT_0474 + conj(IT_0381)*IT_0495 + IT_0444*IT_0558
       + conj(IT_0424)*IT_0559 + IT_0424*(48*conj(IT_0424) + IT_0560) + conj
      (IT_0444)*(24*IT_0388 + IT_0561));
    const ccomplex_t IT_0564 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0362 + (-0.166666666666667)*IT_0367*IT_0368) + IT_0268*((-24)*IT_0239
      *conj(IT_0268) + (-6)*IT_0187*conj(IT_0315) + 6*IT_0236*conj(IT_0362) +
      ...
      *IT_0396*(conj(IT_0315)*IT_0362 + IT_0315*conj(IT_0362) +
       0.166666666666667*conj(IT_0234)*IT_0397 + 0.166666666666667*IT_0234
      *IT_0398) + IT_0455 + IT_0491 + IT_0497 + IT_0181*IT_0508 + IT_0509
      *IT_0510 + 6*IT_0511*IT_0512 + IT_0182*(conj(IT_0234)*IT_0425 + conj
      (IT_0362)*IT_0445 + conj(IT_0486)*IT_0489 + conj(IT_0463)*IT_0506 + conj
      (IT_0467)*IT_0515 + conj(IT_0473)*IT_0516 + IT_0473*(48*conj(IT_0473) +
       IT_0517) + IT_0467*IT_0518) + IT_0520*IT_0532 + IT_0533*(conj(IT_0180)
      *IT_0530 + IT_0180*IT_0531 + conj(IT_0315)*IT_0534 + IT_0315*IT_0535) + (
      -6)*IT_0536*IT_0537 + IT_0539*IT_0542 + (conj(IT_0234)*IT_0521 + IT_0234
      *IT_0522 + conj(IT_0362)*IT_0540 + IT_0362*IT_0541)*IT_0543 + IT_0544*
      (conj(IT_0463)*IT_0545 + IT_0463*IT_0546 + conj(IT_0486)*IT_0547 + IT_0486
      *IT_0548) + (conj(IT_0486)*IT_0545 + IT_0486*IT_0546 + conj(IT_0463)
      *IT_0547 + IT_0463*IT_0548)*IT_0549 + (conj(IT_0315)*IT_0368 + IT_0315
      *IT_0369 + conj(IT_0180)*IT_0389 + IT_0180*IT_0390 + conj(IT_0362)*IT_0545
       + IT_0362*IT_0546 + conj(IT_0234)*IT_0547 + IT_0234*IT_0548)*IT_0550 +
       IT_0551*(IT_0545*IT_0552 + IT_0546*IT_0553 + IT_0547*IT_0554 + IT_0548
      *IT_0555) + (IT_0547*IT_0552 + IT_0548*IT_0553 + IT_0545*IT_0554 + IT_0546
      *IT_0555)*IT_0556 + IT_0557*IT_0562 + IT_0563;
