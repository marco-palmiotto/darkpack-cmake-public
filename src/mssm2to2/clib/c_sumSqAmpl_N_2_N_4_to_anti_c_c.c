        ...
        )
{
    ...
    const ccomplex_t IT_0304 = N_d2*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0327 = conj(N_u2)*N_u4*e_em;
    ...
    const ccomplex_t IT_0404 = s_34*m_N_2*m_N_4;
    ...
    const ccomplex_t IT_0418 = m_N_2*m_N_4*IT_0083;
