...
ccomplex_return_t c_sumSqAmpl_N_2_N_4_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = m_c*e_em*IT_0000*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0046 = m_c*e_em*IT_0011*IT_0027;
    ...
    const ccomplex_t IT_0083 = pow(m_c, 2);
    ...
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*m_c*e_em*IT_0011*IT_0027
      *IT_0028*IT_0089;
    ...
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*m_c*e_em*IT_0011*IT_0027
      *IT_0028*IT_0086;
    ...
    const ccomplex_t IT_0150 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_sc_R*
    ...
    const ccomplex_t IT_0165 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0178 = cpow((-2)*s_23 + IT_0032 + IT_0083 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0188 = IT_0058*IT_0090;
    const ccomplex_t IT_0189 = IT_0064*IT_0087;
    const ccomplex_t IT_0190 = IT_0066*IT_0090;
    const ccomplex_t IT_0191 = IT_0187 + IT_0188 + IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = IT_0054*IT_0095;
    const ccomplex_t IT_0193 = IT_0060*IT_0097;
    const ccomplex_t IT_0194 = IT_0062*IT_0095;
    ...
    const ccomplex_t IT_0202 = IT_0056*IT_0095;
    const ccomplex_t IT_0203 = IT_0062*IT_0087;
    const ccomplex_t IT_0204 = IT_0064*IT_0095;
    const ccomplex_t IT_0205 = IT_0201 + IT_0202 + IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = IT_0058*IT_0097;
    const ccomplex_t IT_0207 = IT_0060*IT_0090;
    const ccomplex_t IT_0208 = IT_0066*IT_0097;
    const ccomplex_t IT_0209 = IT_0068*IT_0090;
    ...
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
    ...
    const ccomplex_t IT_0229 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0002;
    const ccomplex_t IT_0230 = 0.666666666666667*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0256 = m_N_2*m_N_4;
    ...
    const ccomplex_t IT_0263 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0284 = m_c*m_N_2;
    ...
    const ccomplex_t IT_0292 = m_c*s_13*m_N_4;
    ...
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*e_em*IT_0002*IT_0010;
    const ccomplex_t IT_0313 = (-0.666666666666667)*IT_0312;
    ...
    const ccomplex_t IT_0317 = IT_0311*IT_0316;
    const ccomplex_t IT_0318 = -IT_0317;
    const ccomplex_t IT_0319 = 12*IT_0255;
    const ccomplex_t IT_0320 = 24*IT_0236;
    const ccomplex_t IT_0321 = IT_0319 + IT_0320;
    const ccomplex_t IT_0322 = 12*conj(IT_0255);
    const ccomplex_t IT_0323 = 24*conj(IT_0236);
    const ccomplex_t IT_0324 = IT_0322 + IT_0323;
    const ccomplex_t IT_0325 = N_d2*conj(N_d4)*e_em;
    const ccomplex_t IT_0326 = IT_0299*IT_0325;
    const ccomplex_t IT_0327 = IT_0302*IT_0325;
    const ccomplex_t IT_0328 = N_u2*conj(N_u4)*e_em;
    const ccomplex_t IT_0329 = IT_0302*IT_0328;
    const ccomplex_t IT_0330 = IT_0299*IT_0328;
    ...
    const ccomplex_t IT_0334 = e_em*IT_0299;
    const ccomplex_t IT_0335 = e_em*IT_0302;
    const ccomplex_t IT_0336 = (0 + _Complex_I*1)*(IT_0334 + (-3)*IT_0335);
    const ccomplex_t IT_0337 = (-0.166666666666667)*IT_0336;
    const ccomplex_t IT_0338 = IT_0314*IT_0337;
    const ccomplex_t IT_0339 = (0 + _Complex_I*1)*IT_0338;
    const ccomplex_t IT_0340 = IT_0333*IT_0339;
    const ccomplex_t IT_0341 = -IT_0340;
    const ccomplex_t IT_0342 = 12*IT_0181;
    const ccomplex_t IT_0343 = 24*IT_0153;
    const ccomplex_t IT_0344 = IT_0342 + IT_0343;
    const ccomplex_t IT_0345 = 12*conj(IT_0181);
    const ccomplex_t IT_0346 = 24*conj(IT_0153);
    const ccomplex_t IT_0347 = IT_0345 + IT_0346;
    const ccomplex_t IT_0348 = 6*IT_0281;
    const ccomplex_t IT_0349 = 6*conj(IT_0281);
    const ccomplex_t IT_0350 = 12*IT_0281;
    const ccomplex_t IT_0351 = 12*conj(IT_0281);
    const ccomplex_t IT_0352 = IT_0292*(conj(IT_0274)*IT_0295 + IT_0274
      *IT_0298 + conj(IT_0318)*IT_0321 + IT_0318*IT_0324 + conj(IT_0341)*IT_0344
       + IT_0341*IT_0347 + conj(IT_0255)*IT_0348 + IT_0255*IT_0349 + conj
      (IT_0236)*IT_0350 + IT_0236*IT_0351);
    const ccomplex_t IT_0353 = m_c*s_14*m_N_4;
    ...
    const ccomplex_t IT_0357 = IT_0162*IT_0251;
    const ccomplex_t IT_0358 = IT_0165*IT_0357;
    const ccomplex_t IT_0359 = (0 + _Complex_I*1)*IT_0358;
    const ccomplex_t IT_0360 = IT_0356 + IT_0359;
    const ccomplex_t IT_0361 = IT_0290 + IT_0342;
    const ccomplex_t IT_0362 = IT_0291 + IT_0345;
    const ccomplex_t IT_0363 = IT_0311*IT_0339;
    ...
    const ccomplex_t IT_0371 = IT_0316*IT_0333;
    const ccomplex_t IT_0372 = -IT_0371;
    const ccomplex_t IT_0373 = 24*IT_0181;
    const ccomplex_t IT_0374 = IT_0294 + IT_0373;
    const ccomplex_t IT_0375 = 24*conj(IT_0181);
    const ccomplex_t IT_0376 = IT_0297 + IT_0375;
    const ccomplex_t IT_0377 = IT_0176*IT_0244;
    const ccomplex_t IT_0378 = IT_0178*IT_0377;
    const ccomplex_t IT_0379 = (0 + _Complex_I*1)*IT_0378;
    const ccomplex_t IT_0380 = IT_0163*IT_0249;
    const ccomplex_t IT_0381 = IT_0165*IT_0380;
    ...
    const ccomplex_t IT_0385 = 6*conj(IT_0383);
    const ccomplex_t IT_0386 = 12*IT_0383;
    const ccomplex_t IT_0387 = 12*conj(IT_0383);
    const ccomplex_t IT_0388 = IT_0353*(conj(IT_0360)*IT_0361 + IT_0360
      *IT_0362 + conj(IT_0364)*IT_0367 + IT_0364*IT_0370 + conj(IT_0372)*IT_0374
       + IT_0372*IT_0376 + conj(IT_0236)*IT_0384 + IT_0236*IT_0385 + conj
      (IT_0255)*IT_0386 + IT_0255*IT_0387);
    const ccomplex_t IT_0389 = m_c*s_24*m_N_2;
    const ccomplex_t IT_0390 = 6*IT_0274;
    const ccomplex_t IT_0391 = 6*conj(IT_0274);
    const ccomplex_t IT_0392 = 12*IT_0274;
    const ccomplex_t IT_0393 = 12*conj(IT_0274);
    const ccomplex_t IT_0394 = IT_0389*(conj(IT_0281)*IT_0295 + IT_0281
      *IT_0298 + IT_0324*IT_0341 + IT_0321*conj(IT_0341) + conj(IT_0318)*IT_0344
       + IT_0318*IT_0347 + conj(IT_0255)*IT_0390 + IT_0255*IT_0391 + conj
      (IT_0236)*IT_0392 + IT_0236*IT_0393);
    const ccomplex_t IT_0395 = m_c*s_23*m_N_2;
    const ccomplex_t IT_0396 = 12*IT_0360;
    const ccomplex_t IT_0397 = 12*conj(IT_0360);
    const ccomplex_t IT_0398 = conj(IT_0236)*IT_0360 + IT_0236*conj(IT_0360) +
       0.166666666666667*IT_0370*IT_0372 + 0.166666666666667*IT_0367*conj
      (IT_0372) + 0.166666666666667*conj(IT_0364)*IT_0374 + 0.166666666666667
      *IT_0364*IT_0376 + 0.166666666666667*IT_0362*IT_0383 + 0.166666666666667
      *IT_0361*conj(IT_0383) + 0.166666666666667*conj(IT_0255)*IT_0396 +
       0.166666666666667*IT_0255*IT_0397;
    const ccomplex_t IT_0399 = 24*IT_0318;
    const ccomplex_t IT_0400 = IT_0350 + IT_0399;
    const ccomplex_t IT_0401 = 24*conj(IT_0318);
    const ccomplex_t IT_0402 = IT_0351 + IT_0401;
    const ccomplex_t IT_0403 = 24*IT_0341;
    const ccomplex_t IT_0404 = IT_0392 + IT_0403;
    const ccomplex_t IT_0405 = 24*conj(IT_0341);
    const ccomplex_t IT_0406 = IT_0393 + IT_0405;
    const ccomplex_t IT_0407 = IT_0349*IT_0383 + IT_0348*conj(IT_0383) + conj
      (IT_0318)*IT_0386 + IT_0318*IT_0387 + conj(IT_0360)*IT_0390 + IT_0360
      *IT_0391 + conj(IT_0341)*IT_0396 + IT_0341*IT_0397 + conj(IT_0364)*IT_0400
       + IT_0364*IT_0402 + conj(IT_0372)*IT_0404 + IT_0372*IT_0406;
    const ccomplex_t IT_0408 = s_34*m_N_2*m_N_4;
    const ccomplex_t IT_0409 = IT_0349*IT_0360 + IT_0348*conj(IT_0360) + conj
      (IT_0274)*IT_0384 + IT_0274*IT_0385 + conj(IT_0341)*IT_0386 + IT_0341
      *IT_0387 + conj(IT_0318)*IT_0396 + IT_0318*IT_0397 + conj(IT_0372)*IT_0400
       + IT_0372*IT_0402 + conj(IT_0364)*IT_0404 + IT_0364*IT_0406;
    const ccomplex_t IT_0410 = 24*conj(IT_0281);
    const ccomplex_t IT_0411 = 48*conj(IT_0318);
    const ccomplex_t IT_0412 = IT_0410 + IT_0411;
    const ccomplex_t IT_0413 = 24*IT_0281;
    const ccomplex_t IT_0414 = 24*IT_0274;
    const ccomplex_t IT_0415 = 24*conj(IT_0274);
    const ccomplex_t IT_0416 = 24*IT_0360;
    const ccomplex_t IT_0417 = 48*IT_0372;
    const ccomplex_t IT_0418 = IT_0416 + IT_0417;
    const ccomplex_t IT_0419 = 24*IT_0383;
    const ccomplex_t IT_0420 = 24*conj(IT_0383);
    const ccomplex_t IT_0421 = 24*conj(IT_0360);
    const ccomplex_t IT_0422 = m_N_2*m_N_4*IT_0083;
    const ccomplex_t IT_0423 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0274)*IT_0350 + IT_0274*IT_0351 + conj(IT_0255)*IT_0361 + IT_0255
      *IT_0362 + conj(IT_0360)*IT_0386 + IT_0360*IT_0387 + IT_0341*IT_0412 +
       conj(IT_0341)*(48*IT_0318 + IT_0413) + conj(IT_0318)*IT_0414 + IT_0318
      *IT_0415 + conj(IT_0364)*IT_0418 + conj(IT_0372)*(48*IT_0364 + IT_0419) +
       IT_0372*IT_0420 + IT_0364*IT_0421;
    const ccomplex_t IT_0424 = s_13 + s_14;
    const ccomplex_t IT_0425 = IT_0263*IT_0424;
    ...
    const ccomplex_t IT_0431 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0432 = (-12)*IT_0082;
    const ccomplex_t IT_0433 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0434 = (-6)*IT_0053;
    const ccomplex_t IT_0435 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0436 = IT_0053*(conj(IT_0341) + -conj(IT_0372)) + 0.5
      *conj(IT_0082)*((-0.166666666666667)*IT_0348 + IT_0383) + 0.5*IT_0082*((
      -0.166666666666667)*IT_0349 + conj(IT_0383)) + (-0.0833333333333333)*conj
      (IT_0360)*IT_0426 + (-0.0833333333333333)*IT_0360*IT_0427 + (
      -0.0833333333333333)*IT_0372*IT_0428 + (-0.0833333333333333)*conj(IT_0318)
      *IT_0429 + (-0.0833333333333333)*IT_0318*IT_0430 + (-0.0833333333333333)
      *IT_0341*IT_0431 + (-0.0833333333333333)*conj(IT_0364)*IT_0432 + (
      -0.0833333333333333)*IT_0364*IT_0433 + (-0.0833333333333333)*conj(IT_0274)
      *IT_0434 + (-0.0833333333333333)*IT_0274*IT_0435;
    const ccomplex_t IT_0437 = IT_0084*IT_0256;
    const ccomplex_t IT_0438 = (conj(IT_0082)*((-24)*IT_0053 + (-6)*IT_0181 +
       IT_0290) + IT_0082*((-24)*conj(IT_0053) + (-6)*conj(IT_0181) + IT_0291) +
       conj(IT_0255)*IT_0426 + IT_0255*IT_0427 + conj(IT_0236)*IT_0434 + IT_0236
      *IT_0435)*IT_0437;
    const ccomplex_t IT_0439 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0440 = 6*IT_0082;
    const ccomplex_t IT_0441 = 6*conj(IT_0082);
    const ccomplex_t IT_0442 = s_23 + s_24;
    const ccomplex_t IT_0443 = IT_0284*IT_0442;
    const ccomplex_t IT_0444 = (-6)*IT_0082;
    const ccomplex_t IT_0445 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0446 = IT_0053*((-12)*conj(IT_0318) + 12*conj(IT_0364)
      ) + conj(IT_0383)*IT_0426 + IT_0383*IT_0427 + IT_0364*IT_0428 + conj
      (IT_0341)*IT_0429 + IT_0341*IT_0430 + IT_0318*IT_0431 + conj(IT_0372)
      *IT_0432 + IT_0372*IT_0433 + conj(IT_0281)*IT_0434 + IT_0281*IT_0435 +
       conj(IT_0274)*IT_0440 + IT_0274*IT_0441 + conj(IT_0360)*IT_0444 + IT_0360
      *IT_0445;
    const ccomplex_t IT_0447 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0448 = (-2)*IT_0266;
    const ccomplex_t IT_0449 = (-3)*IT_0130;
    const ccomplex_t IT_0450 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0451 = (-3)*IT_0215;
    const ccomplex_t IT_0452 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0453 = 2*IT_0287;
    const ccomplex_t IT_0454 = (-2)*IT_0259;
    const ccomplex_t IT_0455 = 4*IT_0287;
    const ccomplex_t IT_0456 = conj(IT_0318) + conj(IT_0364);
    const ccomplex_t IT_0457 = IT_0318 + IT_0364;
    const ccomplex_t IT_0458 = IT_0341 + IT_0372;
    const ccomplex_t IT_0459 = (-4)*IT_0266;
    const ccomplex_t IT_0460 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0352 + IT_0388 + IT_0394 + 6*IT_0395*IT_0398 + IT_0154
      *IT_0407 + IT_0408*IT_0409 + IT_0156*(conj(IT_0153)*IT_0294 + conj(IT_0281
      )*IT_0350 + conj(IT_0236)*IT_0365 + conj(IT_0274)*IT_0392 + IT_0318
      *IT_0412 + conj(IT_0318)*IT_0413 + conj(IT_0341)*IT_0414 + IT_0341*(48
      *conj(IT_0341) + IT_0415)) + IT_0155*(conj(IT_0255)*IT_0319 + conj(IT_0181
      )*IT_0342 + conj(IT_0383)*IT_0386 + conj(IT_0360)*IT_0396 + conj(IT_0372)
      *IT_0418 + conj(IT_0364)*IT_0419 + IT_0364*(48*conj(IT_0364) + IT_0420) +
       IT_0372*IT_0421) + IT_0422*IT_0423 + (-12)*IT_0425*IT_0436 + IT_0438 +
       IT_0439*(conj(IT_0153)*IT_0434 + IT_0153*IT_0435 + conj(IT_0236)*IT_0440 
      + IT_0236*IT_0441) + IT_0443*IT_0446 + (conj(IT_0181)*IT_0426 + IT_0181
      *IT_0427 + conj(IT_0255)*IT_0444 + IT_0255*IT_0445)*IT_0447 + IT_0448*
      (conj(IT_0360)*IT_0449 + IT_0360*IT_0450 + conj(IT_0383)*IT_0451 + IT_0383
      *IT_0452) + (conj(IT_0383)*IT_0449 + IT_0383*IT_0450 + conj(IT_0360)
      *IT_0451 + IT_0360*IT_0452)*IT_0453 + (conj(IT_0236)*IT_0261 + IT_0236
      *IT_0262 + conj(IT_0153)*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0449
       + IT_0255*IT_0450 + conj(IT_0181)*IT_0451 + IT_0181*IT_0452)*IT_0454 +
       IT_0455*((conj(IT_0341) + conj(IT_0372))*IT_0451 + IT_0449*IT_0456 +
       IT_0450*IT_0457 + IT_0452*IT_0458) + ((conj(IT_0341) + conj(IT_0372))
      *IT_0449 + IT_0451*IT_0456 + IT_0452*IT_0457 + IT_0450*IT_0458)*IT_0459;
