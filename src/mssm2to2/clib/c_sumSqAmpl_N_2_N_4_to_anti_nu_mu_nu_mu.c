...
ccomplex_return_t c_sumSqAmpl_N_2_N_4_to_anti_nu_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = N_u2*conj(N_u4)*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = IT_0000*IT_0006;
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = N_d2*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0051 = conj(N_u2)*N_u4*e_em;
    ...
    const ccomplex_t IT_0083 = s_34*m_N_2*m_N_4;
