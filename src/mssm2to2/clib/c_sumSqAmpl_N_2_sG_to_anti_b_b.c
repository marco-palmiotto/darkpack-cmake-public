        ...
        )
{
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0005 + IT_0006 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_11);
    const ccomplex_t IT_0043 = m_b*conj(N_d2)*e_em*IT_0014*U_sb_11;
    const ccomplex_t IT_0044 = IT_0013*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0047 = IT_0012*IT_0046;
    const ccomplex_t IT_0048 = 1.4142135623731*IT_0047;
    const ccomplex_t IT_0049 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0060 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0061 = IT_0022*IT_0060;
    const ccomplex_t IT_0062 = 1.4142135623731*IT_0061;
    const ccomplex_t IT_0063 = m_b*conj(N_d2)*e_em*IT_0014*conj(U_sb_01);
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_01;
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = pow(m_N_2, 2);
    const ccomplex_t IT_0071 = cpow((-2)*s_13 + IT_0005 + IT_0070 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0069*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0005 + IT_0070 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_00;
    const ccomplex_t IT_0076 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0077 = IT_0022*IT_0076;
    const ccomplex_t IT_0078 = 1.4142135623731*IT_0077;
    const ccomplex_t IT_0079 = m_b*conj(N_d2)*e_em*IT_0014*conj(U_sb_00);
    ...
    const ccomplex_t IT_0086 = 1.5*IT_0085;
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_10;
    const ccomplex_t IT_0093 = m_b*N_d2*e_em*IT_0014*conj(U_sb_10);
    const ccomplex_t IT_0094 = IT_0013*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = N_W2*e_em*conj(U_sb_00);
    const ccomplex_t IT_0097 = IT_0012*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = N_B2*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0110 = m_b*N_d2*e_em*IT_0014*conj(U_sb_11);
    ...
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_00);
    const ccomplex_t IT_0139 = m_b*N_d2*e_em*IT_0014*U_sb_00;
    const ccomplex_t IT_0140 = IT_0013*IT_0139;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = N_B2*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0161 = -IT_0137 + -IT_0160;
    const ccomplex_t IT_0162 = 8*IT_0161;
    const ccomplex_t IT_0163 = 8*conj(IT_0161);
    const ccomplex_t IT_0164 = s_12*IT_0005;
    const ccomplex_t IT_0165 = IT_0075*IT_0105;
    const ccomplex_t IT_0166 = IT_0074*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*IT_0166;
    const ccomplex_t IT_0168 = IT_0068*IT_0121;
    const ccomplex_t IT_0169 = IT_0071*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*IT_0169;
    const ccomplex_t IT_0171 = -IT_0167 + -IT_0170;
    const ccomplex_t IT_0172 = IT_0042*IT_0134;
    const ccomplex_t IT_0173 = IT_0041*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*IT_0173;
    const ccomplex_t IT_0175 = IT_0008*IT_0157;
    ...
    const ccomplex_t IT_0179 = 8*IT_0178;
    const ccomplex_t IT_0180 = 8*conj(IT_0178);
    const ccomplex_t IT_0181 = IT_0067*IT_0109;
    const ccomplex_t IT_0182 = IT_0071*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*IT_0182;
    const ccomplex_t IT_0184 = IT_0087*IT_0092;
    ...
    const ccomplex_t IT_0195 = 8*IT_0194;
    const ccomplex_t IT_0196 = 8*conj(IT_0194);
    const ccomplex_t IT_0197 = m_sG*s_34*m_N_2;
    const ccomplex_t IT_0198 = 8*IT_0171;
    const ccomplex_t IT_0199 = 8*conj(IT_0171);
    const ccomplex_t IT_0200 = m_b*s_23*m_N_2;
    const ccomplex_t IT_0201 = 8*IT_0125;
    const ccomplex_t IT_0202 = 16*IT_0161;
    const ccomplex_t IT_0203 = IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = 8*conj(IT_0125);
    const ccomplex_t IT_0205 = 16*conj(IT_0161);
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = 16*IT_0178;
    const ccomplex_t IT_0208 = 16*conj(IT_0178);
    const ccomplex_t IT_0209 = 16*IT_0194;
    const ccomplex_t IT_0210 = m_b*m_sG*s_14;
    const ccomplex_t IT_0211 = m_sG*m_N_2*IT_0005;
    const ccomplex_t IT_0212 = 16*IT_0125;
    const ccomplex_t IT_0213 = IT_0162 + IT_0212;
    const ccomplex_t IT_0214 = 16*conj(IT_0125);
    const ccomplex_t IT_0215 = IT_0163 + IT_0214;
    const ccomplex_t IT_0216 = 16*IT_0171;
    const ccomplex_t IT_0217 = 16*conj(IT_0171);
    const ccomplex_t IT_0218 = m_b*s_24*m_N_2;
    const ccomplex_t IT_0219 = 16*IT_0187;
    const ccomplex_t IT_0220 = m_b*m_sG*s_13;
    const ccomplex_t IT_0221 = 8*IT_0004*(conj(IT_0059)*IT_0091 + IT_0059*conj
      (IT_0091) + 0.125*conj(IT_0125)*IT_0162 + 0.125*IT_0125*IT_0163) + IT_0164
      *(conj(IT_0171)*IT_0179 + IT_0171*IT_0180 + conj(IT_0187)*IT_0195 +
       IT_0187*IT_0196) + IT_0197*(IT_0180*IT_0187 + IT_0179*conj(IT_0187) +
       conj(IT_0194)*IT_0198 + IT_0194*IT_0199) + IT_0200*(conj(IT_0091)*IT_0179
       + IT_0091*IT_0180 + conj(IT_0194)*IT_0203 + IT_0194*IT_0206 + conj
      (IT_0059)*IT_0207 + IT_0059*IT_0208) + IT_0000*(16*IT_0059*conj(IT_0059) +
       conj(IT_0161)*IT_0202 + conj(IT_0178)*IT_0207 + conj(IT_0194)*IT_0209) + 
      (16*IT_0059*conj(IT_0194) + conj(IT_0091)*IT_0195 + IT_0091*IT_0196 + conj
      (IT_0178)*IT_0203 + IT_0178*IT_0206 + conj(IT_0059)*IT_0209)*IT_0210 +
       IT_0211*(conj(IT_0059)*IT_0203 + IT_0059*IT_0206 + conj(IT_0194)*IT_0207 
      + IT_0194*IT_0208 + conj(IT_0091)*IT_0213 + IT_0091*IT_0215 + conj(IT_0187
      )*IT_0216 + IT_0187*IT_0217) + (conj(IT_0059)*IT_0198 + IT_0059*IT_0199 +
       conj(IT_0187)*IT_0213 + IT_0187*IT_0215 + conj(IT_0091)*IT_0216 + IT_0091
      *IT_0217)*IT_0218 + IT_0001*(16*IT_0091*conj(IT_0091) + conj(IT_0125)
      *IT_0212 + conj(IT_0171)*IT_0216 + conj(IT_0187)*IT_0219) + 8*(conj
      (IT_0059)*IT_0187 + (IT_0059 + 2*IT_0091)*conj(IT_0187) + 0.125*conj
      (IT_0171)*IT_0213 + 0.125*IT_0171*IT_0215 + 0.125*conj(IT_0091)*IT_0219)
      *IT_0220;
