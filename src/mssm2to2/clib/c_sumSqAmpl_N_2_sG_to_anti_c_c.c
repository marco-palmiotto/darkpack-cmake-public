        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sc_L*
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0015 + IT_0029 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sc_R*
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_13 + IT_0015 + IT_0029 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
    ...
    const ccomplex_t IT_0084 = m_c*s_24*m_N_2;
