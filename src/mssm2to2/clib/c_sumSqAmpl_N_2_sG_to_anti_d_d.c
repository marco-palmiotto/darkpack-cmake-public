...
ccomplex_return_t c_sumSqAmpl_N_2_sG_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_sd_R*
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0006*IT_0008*IT_0010;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = IT_0005*IT_0029;
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0084 = m_d*m_sG*s_13;
    ...
    const ccomplex_t IT_0089 = m_d*s_24*m_N_2;
    ...
    const ccomplex_t IT_0098 = m_d*s_23*m_N_2;
    ...
    const ccomplex_t IT_0106 = m_d*m_sG*s_14;
