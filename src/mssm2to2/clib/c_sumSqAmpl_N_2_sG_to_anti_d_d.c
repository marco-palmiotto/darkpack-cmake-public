        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0015 + IT_0029 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sd_R*
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_13 + IT_0015 + IT_0029 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
    ...
    const ccomplex_t IT_0084 = m_d*s_24*m_N_2;
