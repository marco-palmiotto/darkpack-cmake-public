        ...
        )
{
    ...
    const ccomplex_t IT_0023 = m_t*conj(N_u2)*e_em*IT_0022*U_st_10;
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0005 + IT_0048 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0050 = conj(N_B2)*e_em*conj(U_st_10);
    const ccomplex_t IT_0051 = IT_0010*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = m_t*conj(N_u2)*e_em*IT_0022*conj(U_st_00);
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_00;
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = IT_0049*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = cpow((-2)*s_13 + IT_0005 + IT_0048 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_01;
    const ccomplex_t IT_0064 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0065 = IT_0010*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = m_t*conj(N_u2)*e_em*IT_0022*conj(U_st_01);
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_11;
    ...
    const ccomplex_t IT_0107 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0108 = IT_0010*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = m_t*N_u2*e_em*IT_0022*U_st_01;
    ...
    const ccomplex_t IT_0122 = m_t*N_u2*e_em*IT_0022*U_st_00;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_00);
    ...
    const ccomplex_t IT_0134 = s_12*IT_0005;
    const ccomplex_t IT_0135 = IT_0063*IT_0101;
    const ccomplex_t IT_0136 = IT_0062*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*IT_0136;
    const ccomplex_t IT_0138 = IT_0058*IT_0086;
    ...
    const ccomplex_t IT_0167 = m_sG*s_34*m_N_2;
    const ccomplex_t IT_0168 = 8*IT_0141;
    const ccomplex_t IT_0169 = 8*conj(IT_0141);
    ...
    const ccomplex_t IT_0179 = 16*IT_0164;
    const ccomplex_t IT_0180 = m_t*m_sG*s_14;
    const ccomplex_t IT_0181 = m_sG*m_N_2*IT_0005;
    const ccomplex_t IT_0182 = 16*IT_0106;
    const ccomplex_t IT_0183 = IT_0132 + IT_0182;
    const ccomplex_t IT_0184 = 16*conj(IT_0106);
    const ccomplex_t IT_0185 = IT_0133 + IT_0184;
    const ccomplex_t IT_0186 = 16*IT_0141;
    const ccomplex_t IT_0187 = 16*conj(IT_0141);
    const ccomplex_t IT_0188 = m_t*s_24*m_N_2;
    const ccomplex_t IT_0189 = 16*IT_0157;
    const ccomplex_t IT_0190 = m_t*m_sG*s_13;
    const ccomplex_t IT_0191 = 8*IT_0004*(conj(IT_0047)*IT_0075 + IT_0047*conj
      ...
      *(conj(IT_0141)*IT_0149 + IT_0141*IT_0150 + conj(IT_0157)*IT_0165 +
       IT_0157*IT_0166) + IT_0167*(IT_0150*IT_0157 + IT_0149*conj(IT_0157) +
       conj(IT_0164)*IT_0168 + IT_0164*IT_0169) + IT_0170*(conj(IT_0075)*IT_0149
       + IT_0075*IT_0150 + conj(IT_0164)*IT_0173 + IT_0164*IT_0176 + conj
      (IT_0047)*IT_0177 + IT_0047*IT_0178) + IT_0000*(16*IT_0047*conj(IT_0047) +
       conj(IT_0131)*IT_0172 + conj(IT_0148)*IT_0177 + conj(IT_0164)*IT_0179) + 
      (16*IT_0047*conj(IT_0164) + conj(IT_0075)*IT_0165 + IT_0075*IT_0166 + conj
      (IT_0148)*IT_0173 + IT_0148*IT_0176 + conj(IT_0047)*IT_0179)*IT_0180 +
       IT_0181*(conj(IT_0047)*IT_0173 + IT_0047*IT_0176 + conj(IT_0164)*IT_0177 
      + IT_0164*IT_0178 + conj(IT_0075)*IT_0183 + IT_0075*IT_0185 + conj(IT_0157
      )*IT_0186 + IT_0157*IT_0187) + (conj(IT_0047)*IT_0168 + IT_0047*IT_0169 +
       conj(IT_0157)*IT_0183 + IT_0157*IT_0185 + conj(IT_0075)*IT_0186 + IT_0075
      *IT_0187)*IT_0188 + IT_0001*(16*IT_0075*conj(IT_0075) + conj(IT_0106)
      *IT_0182 + conj(IT_0141)*IT_0186 + conj(IT_0157)*IT_0189) + 8*(conj
      (IT_0047)*IT_0157 + (IT_0047 + 2*IT_0075)*conj(IT_0157) + 0.125*conj
      (IT_0141)*IT_0183 + 0.125*IT_0141*IT_0185 + 0.125*conj(IT_0075)*IT_0189)
      *IT_0190;
