        ...
        )
{
    ...
    const ccomplex_t IT_0032 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0033 = IT_0012*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0035 = IT_0015*IT_0034;
    const ccomplex_t IT_0036 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0037 = IT_0003*IT_0036;
    const ccomplex_t IT_0038 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0039 = IT_0007*IT_0038;
    const ccomplex_t IT_0040 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0041 = IT_0012*IT_0040;
    const ccomplex_t IT_0042 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0047 = N_B4*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0053 = m_b*N_d4*e_em*IT_0052*U_sb_00;
    ...
    const ccomplex_t IT_0059 = pow(m_sb_1, 2);
    const ccomplex_t IT_0060 = cpow((-2)*s_23 + IT_0058 + IT_0059 + -m_N_4*
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_13 + IT_0058 + IT_0064 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0066 = m_b*e_em*mu_h*IT_0052*conj(U_sb_00)*U_sb_10;
    const ccomplex_t IT_0067 = IT_0011*IT_0066;
    const ccomplex_t IT_0068 = m_b*e_em*mu_h*IT_0052*U_sb_00*conj(U_sb_10);
    ...
    const ccomplex_t IT_0077 = (-0.5)*IT_0067 + 0.5*IT_0069 + (-0.5)*IT_0073 +
       0.5*IT_0076;
    const ccomplex_t IT_0078 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0079 = IT_0002*IT_0078;
    const ccomplex_t IT_0080 = 1.4142135623731*IT_0079;
    const ccomplex_t IT_0081 = m_b*N_d2*e_em*IT_0052*U_sb_00;
    ...
    const ccomplex_t IT_0089 = m_b*e_em*mu_h*IT_0052*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0090 = IT_0011*IT_0089;
    const ccomplex_t IT_0091 = m_b*e_em*mu_h*IT_0052*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0092 = IT_0011*IT_0091;
    const ccomplex_t IT_0093 = A_b*IT_0070*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0094 = IT_0006*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = A_b*IT_0070*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0103 = m_b*N_d2*e_em*IT_0052*U_sb_01;
    ...
    const ccomplex_t IT_0109 = cpow((-2)*s_13 + IT_0058 + IT_0064 + -m_sb_2*
    ...
    const ccomplex_t IT_0128 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0133 = cpow((-2)*s_23 + IT_0058 + IT_0059 + -m_N_2*
    ...
    const ccomplex_t IT_0174 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0175 = IT_0002*IT_0174;
    const ccomplex_t IT_0176 = 1.4142135623731*IT_0175;
    const ccomplex_t IT_0177 = m_b*N_d1*e_em*IT_0052*U_sb_00;
    const ccomplex_t IT_0178 = IT_0051*IT_0177;
    ...
    const ccomplex_t IT_0189 = m_b*N_d3*e_em*IT_0052*U_sb_00;
    ...
    const ccomplex_t IT_0194 = cpow((-2)*s_23 + IT_0058 + IT_0059 + -m_N_3*
    ...
    const ccomplex_t IT_0235 = IT_0063 + IT_0088 + IT_0111 + IT_0136 + IT_0185
       + IT_0234;
    const ccomplex_t IT_0236 = m_b*conj(N_d4)*e_em*IT_0052*U_sb_10;
    ...
    const ccomplex_t IT_0250 = m_N_2*IT_0026;
    const ccomplex_t IT_0251 = m_N_4*IT_0044;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = IT_0249*IT_0252;
    const ccomplex_t IT_0254 = m_N_2*IT_0153;
    const ccomplex_t IT_0255 = m_N_1*IT_0171;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = m_b*conj(N_d1)*e_em*IT_0052*U_sb_10;
    ...
    const ccomplex_t IT_0285 = IT_0065*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*IT_0285;
    const ccomplex_t IT_0287 = m_b*conj(N_d2)*e_em*IT_0052*U_sb_11;
    const ccomplex_t IT_0288 = IT_0051*IT_0287;
    ...
    const ccomplex_t IT_0293 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0300 = IT_0109*IT_0299;
    const ccomplex_t IT_0301 = (0 + _Complex_I*1)*IT_0300;
    const ccomplex_t IT_0302 = IT_0133*IT_0283;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1)*IT_0302;
    const ccomplex_t IT_0304 = IT_0132*IT_0303;
    const ccomplex_t IT_0305 = m_N_2*IT_0213;
    const ccomplex_t IT_0306 = m_N_3*IT_0231;
    const ccomplex_t IT_0307 = IT_0305 + IT_0306;
    const ccomplex_t IT_0308 = m_b*conj(N_d3)*e_em*IT_0052*U_sb_10;
    const ccomplex_t IT_0309 = IT_0051*IT_0308;
    const ccomplex_t IT_0310 = 1.4142135623731*IT_0309;
    const ccomplex_t IT_0311 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0312 = IT_0011*IT_0311;
    const ccomplex_t IT_0313 = 1.4142135623731*IT_0312;
    const ccomplex_t IT_0314 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0317 = (0 + _Complex_I*1)*(IT_0310 + -IT_0313 +
       0.333333333333333*IT_0316);
    const ccomplex_t IT_0318 = 3*IT_0317;
    const ccomplex_t IT_0319 = 0.166666666666667*IT_0318;
    const ccomplex_t IT_0320 = IT_0194*IT_0319;
    const ccomplex_t IT_0321 = (0 + _Complex_I*1)*IT_0320;
    const ccomplex_t IT_0322 = IT_0307*IT_0321;
    const ccomplex_t IT_0323 = -IT_0253 + -IT_0271 + -IT_0286 + -IT_0301 + 
      -IT_0304 + -IT_0322;
    const ccomplex_t IT_0324 = 6*s_13;
    const ccomplex_t IT_0325 = m_b*m_N_2;
    const ccomplex_t IT_0326 = 6*IT_0235;
    const ccomplex_t IT_0327 = IT_0026*IT_0249;
    const ccomplex_t IT_0328 = cpow((-2)*s_12 + IT_0058 + -IT_0059 + -IT_0064 
      + -reg_prop, -1);
    const ccomplex_t IT_0329 = m_b*e_em*IT_0006*IT_0011*IT_0050*IT_0052;
    const ccomplex_t IT_0330 = (-0.5)*IT_0329;
    const ccomplex_t IT_0331 = IT_0085*IT_0330;
    const ccomplex_t IT_0332 = IT_0328*IT_0331;
    const ccomplex_t IT_0333 = (0 + _Complex_I*1)*IT_0332;
    const ccomplex_t IT_0334 = IT_0153*IT_0270;
    const ccomplex_t IT_0335 = IT_0120*IT_0303;
    const ccomplex_t IT_0336 = IT_0213*IT_0321;
    const ccomplex_t IT_0337 = IT_0327 + -IT_0333 + IT_0334 + IT_0335 + IT_0336;
    const ccomplex_t IT_0338 = m_b*s_14;
    const ccomplex_t IT_0339 = IT_0044*IT_0062;
    const ccomplex_t IT_0340 = IT_0283*IT_0330;
    ...
    const ccomplex_t IT_0344 = IT_0171*IT_0184;
    const ccomplex_t IT_0345 = IT_0196*IT_0231;
    const ccomplex_t IT_0346 = -IT_0339 + -IT_0342 + -IT_0343 + -IT_0344 + 
      -IT_0345;
    const ccomplex_t IT_0347 = s_34*m_N_2;
    const ccomplex_t IT_0348 = 6*conj(IT_0235);
    const ccomplex_t IT_0349 = 6*conj(IT_0323);
    const ccomplex_t IT_0350 = pow(m_A0, 2);
    const ccomplex_t IT_0351 = m_b*m_N_2*IT_0350;
