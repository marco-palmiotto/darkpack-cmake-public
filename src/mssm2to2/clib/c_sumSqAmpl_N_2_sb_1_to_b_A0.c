...
ccomplex_return_t c_sumSqAmpl_N_2_sb_1_to_b_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = m_b*N_d2*e_em*IT_0033*U_sb_00;
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*(IT_0036 + 0.666666666666667
      *IT_0039);
    const ccomplex_t IT_0041 = 1.5*IT_0040;
    const ccomplex_t IT_0042 = (-0.333333333333333)*IT_0041;
    const ccomplex_t IT_0043 = pow(m_b, 2);
    const ccomplex_t IT_0044 = pow(m_sb_1, 2);
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0043 + IT_0044 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0042*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = IT_0030*IT_0047;
    const ccomplex_t IT_0049 = m_b*e_em*mu_h*IT_0033*conj(U_sb_00)*U_sb_10;
    const ccomplex_t IT_0050 = IT_0011*IT_0049;
    const ccomplex_t IT_0051 = m_b*e_em*mu_h*IT_0033*U_sb_00*conj(U_sb_10);
    const ccomplex_t IT_0052 = IT_0011*IT_0051;
    const ccomplex_t IT_0053 = cpow(V_tb, 2);
    const ccomplex_t IT_0054 = A_b*IT_0053*conj(U_sb_00)*U_sb_10;
    const ccomplex_t IT_0055 = IT_0006*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = A_b*IT_0053*U_sb_00*conj(U_sb_10);
    const ccomplex_t IT_0058 = IT_0006*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = (-0.5)*IT_0050 + 0.5*IT_0052 + (-0.5)*IT_0056 +
       0.5*IT_0059;
    const ccomplex_t IT_0061 = IT_0042*IT_0060;
    const ccomplex_t IT_0062 = pow(m_N_2, 2);
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0043 + IT_0062 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0061*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0043 + IT_0062 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0067 = m_b*e_em*mu_h*IT_0033*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0068 = IT_0011*IT_0067;
    const ccomplex_t IT_0069 = m_b*e_em*mu_h*IT_0033*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0070 = IT_0011*IT_0069;
    const ccomplex_t IT_0071 = A_b*IT_0053*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0072 = IT_0006*IT_0071;
    const ccomplex_t IT_0073 = 1.4142135623731*IT_0072;
    const ccomplex_t IT_0074 = A_b*IT_0053*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0077 = (-0.5)*IT_0068 + 0.5*IT_0070 + (-0.5)*IT_0073 +
       0.5*IT_0076;
    const ccomplex_t IT_0078 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0079 = IT_0002*IT_0078;
    const ccomplex_t IT_0080 = 1.4142135623731*IT_0079;
    const ccomplex_t IT_0081 = m_b*N_d2*e_em*IT_0033*U_sb_01;
    ...
    const ccomplex_t IT_0089 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0090 = IT_0003*IT_0089;
    const ccomplex_t IT_0091 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0092 = IT_0007*IT_0091;
    const ccomplex_t IT_0093 = N_W2*N_u1*e_em;
    ...
    const ccomplex_t IT_0101 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0102 = IT_0012*IT_0101;
    const ccomplex_t IT_0103 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0107 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0108 = IT_0003*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0110 = IT_0007*IT_0109;
    const ccomplex_t IT_0111 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0112 = IT_0012*IT_0111;
    const ccomplex_t IT_0113 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0114 = IT_0015*IT_0113;
    const ccomplex_t IT_0115 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0116 = IT_0003*IT_0115;
    const ccomplex_t IT_0117 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0118 = IT_0007*IT_0117;
    const ccomplex_t IT_0119 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0126 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0127 = IT_0002*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = m_b*N_d1*e_em*IT_0033*U_sb_00;
    ...
    const ccomplex_t IT_0134 = cpow((-2)*s_23 + IT_0043 + IT_0044 + -m_N_1*
    ...
    const ccomplex_t IT_0156 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0157 = IT_0015*IT_0156;
    const ccomplex_t IT_0158 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0159 = IT_0003*IT_0158;
    const ccomplex_t IT_0160 = N_B2*N_d3*e_em;
    ...
    const ccomplex_t IT_0172 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0173 = IT_0012*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0175 = IT_0015*IT_0174;
    const ccomplex_t IT_0176 = conj(N_B3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0182 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0196 = cpow((-2)*s_23 + IT_0043 + IT_0044 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0197 = IT_0195*IT_0196;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1)*IT_0197;
    const ccomplex_t IT_0199 = N_B4*N_u2*e_em;
    const ccomplex_t IT_0200 = IT_0003*IT_0199;
    const ccomplex_t IT_0201 = N_B4*N_d2*e_em;
    ...
    const ccomplex_t IT_0207 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0208 = IT_0003*IT_0207;
    const ccomplex_t IT_0209 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0210 = IT_0007*IT_0209;
    const ccomplex_t IT_0211 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0212 = IT_0012*IT_0211;
    const ccomplex_t IT_0213 = N_W2*N_d4*e_em;
    const ccomplex_t IT_0214 = IT_0015*IT_0213;
    const ccomplex_t IT_0215 = (-0.5)*IT_0200 + 0.5*IT_0202 + 0.5*IT_0204 + (
      -0.5)*IT_0206 + (-0.5)*IT_0208 + 0.5*IT_0210 + 0.5*IT_0212 + (-0.5)*IT_0214;
    const ccomplex_t IT_0216 = m_N_4*IT_0215;
    const ccomplex_t IT_0217 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0218 = IT_0003*IT_0217;
    const ccomplex_t IT_0219 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0220 = IT_0007*IT_0219;
    const ccomplex_t IT_0221 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0222 = IT_0012*IT_0221;
    const ccomplex_t IT_0223 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0224 = IT_0015*IT_0223;
    const ccomplex_t IT_0225 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0232 = IT_0015*IT_0231;
    ...
    const ccomplex_t IT_0235 = IT_0216 + IT_0234;
    const ccomplex_t IT_0236 = IT_0198*IT_0235;
    const ccomplex_t IT_0237 = IT_0048 + IT_0065 + IT_0088 + IT_0137 + IT_0187
       + IT_0236;
    const ccomplex_t IT_0238 = m_b*conj(N_d2)*e_em*IT_0033*U_sb_10;
    const ccomplex_t IT_0239 = IT_0032*IT_0238;
    const ccomplex_t IT_0240 = 1.4142135623731*IT_0239;
    const ccomplex_t IT_0241 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0242 = IT_0002*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0245 = IT_0011*IT_0244;
    const ccomplex_t IT_0246 = 1.4142135623731*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*(IT_0240 + 0.333333333333333
      *IT_0243 + -IT_0246);
    ...
    const ccomplex_t IT_0255 = IT_0030*IT_0254;
    const ccomplex_t IT_0256 = IT_0060*IT_0252;
    const ccomplex_t IT_0257 = IT_0063*IT_0256;
    const ccomplex_t IT_0258 = (0 + _Complex_I*1)*IT_0257;
    const ccomplex_t IT_0259 = m_b*conj(N_d1)*e_em*IT_0033*U_sb_10;
    const ccomplex_t IT_0260 = IT_0032*IT_0259;
    const ccomplex_t IT_0261 = 1.4142135623731*IT_0260;
    const ccomplex_t IT_0262 = conj(N_W1)*e_em*U_sb_00;
    const ccomplex_t IT_0263 = IT_0011*IT_0262;
    const ccomplex_t IT_0264 = 1.4142135623731*IT_0263;
    const ccomplex_t IT_0265 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0293 = IT_0077*IT_0292;
    const ccomplex_t IT_0294 = IT_0066*IT_0293;
    const ccomplex_t IT_0295 = (0 + _Complex_I*1)*IT_0294;
    const ccomplex_t IT_0296 = m_b*conj(N_d3)*e_em*IT_0033*U_sb_10;
    const ccomplex_t IT_0297 = IT_0032*IT_0296;
    const ccomplex_t IT_0298 = 1.4142135623731*IT_0297;
    const ccomplex_t IT_0299 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0300 = IT_0011*IT_0299;
    const ccomplex_t IT_0301 = 1.4142135623731*IT_0300;
    const ccomplex_t IT_0302 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0308 = IT_0147*IT_0307;
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*IT_0308;
    const ccomplex_t IT_0310 = m_N_2*IT_0166;
    const ccomplex_t IT_0311 = m_N_3*IT_0184;
    const ccomplex_t IT_0312 = IT_0310 + IT_0311;
    const ccomplex_t IT_0313 = IT_0309*IT_0312;
    const ccomplex_t IT_0314 = m_N_2*IT_0215;
    const ccomplex_t IT_0315 = m_N_4*IT_0233;
    const ccomplex_t IT_0316 = IT_0314 + IT_0315;
    const ccomplex_t IT_0317 = m_b*conj(N_d4)*e_em*IT_0033*U_sb_10;
    const ccomplex_t IT_0318 = IT_0032*IT_0317;
    const ccomplex_t IT_0319 = 1.4142135623731*IT_0318;
    const ccomplex_t IT_0320 = conj(N_B4)*e_em*U_sb_00;
    const ccomplex_t IT_0321 = IT_0002*IT_0320;
    const ccomplex_t IT_0322 = 1.4142135623731*IT_0321;
    const ccomplex_t IT_0323 = conj(N_W4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0329 = IT_0196*IT_0328;
    const ccomplex_t IT_0330 = (0 + _Complex_I*1)*IT_0329;
    const ccomplex_t IT_0331 = IT_0316*IT_0330;
    const ccomplex_t IT_0332 = -IT_0255 + -IT_0258 + -IT_0280 + -IT_0295 + 
      -IT_0313 + -IT_0331;
    const ccomplex_t IT_0333 = 6*s_13;
    const ccomplex_t IT_0334 = m_b*m_N_2;
    const ccomplex_t IT_0335 = 6*IT_0237;
    const ccomplex_t IT_0336 = IT_0166*IT_0309;
    const ccomplex_t IT_0337 = IT_0215*IT_0330;
    const ccomplex_t IT_0338 = cpow((-2)*s_12 + IT_0043 + -IT_0044 + -IT_0062 
      + -reg_prop, -1);
    const ccomplex_t IT_0339 = m_b*e_em*IT_0006*IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0340 = (-0.5)*IT_0339;
    const ccomplex_t IT_0341 = IT_0042*IT_0340;
    const ccomplex_t IT_0342 = IT_0338*IT_0341;
    const ccomplex_t IT_0343 = (0 + _Complex_I*1)*IT_0342;
    const ccomplex_t IT_0344 = IT_0018*IT_0254;
    const ccomplex_t IT_0345 = IT_0105*IT_0276;
    const ccomplex_t IT_0346 = IT_0336 + IT_0337 + -IT_0343 + IT_0344 + IT_0345;
    const ccomplex_t IT_0347 = m_b*s_14;
    const ccomplex_t IT_0348 = IT_0198*IT_0233;
    const ccomplex_t IT_0349 = IT_0252*IT_0340;
    const ccomplex_t IT_0350 = IT_0338*IT_0349;
    const ccomplex_t IT_0351 = (0 + _Complex_I*1)*IT_0350;
    const ccomplex_t IT_0352 = IT_0149*IT_0184;
    const ccomplex_t IT_0353 = IT_0028*IT_0047;
    const ccomplex_t IT_0354 = IT_0123*IT_0136;
    const ccomplex_t IT_0355 = -IT_0348 + -IT_0351 + -IT_0352 + -IT_0353 + 
      -IT_0354;
    const ccomplex_t IT_0356 = s_34*m_N_2;
    const ccomplex_t IT_0357 = 6*conj(IT_0237);
    const ccomplex_t IT_0358 = 6*conj(IT_0332);
    const ccomplex_t IT_0359 = pow(m_A0, 2);
    const ccomplex_t IT_0360 = m_b*m_N_2*IT_0359;
    const ccomplex_t IT_0361 = s_13*IT_0359;
    const ccomplex_t IT_0362 = s_14*s_34;
    const ccomplex_t IT_0363 = (-2)*IT_0362;
    const ccomplex_t IT_0364 = IT_0361 + IT_0363;
    const ccomplex_t IT_0365 = 6*IT_0332;
    const ccomplex_t IT_0366 = 0.166666666666667*IT_0356;
    const ccomplex_t IT_0367 = (IT_0237*conj(IT_0237) + IT_0332*conj(IT_0332))
      *IT_0333 + conj(IT_0332)*IT_0334*IT_0335 + (IT_0332*IT_0334 + IT_0346
      *IT_0347 + IT_0355*IT_0356)*IT_0357 + (IT_0347*IT_0355 + IT_0346*IT_0356)
      *IT_0358 + 6*conj(IT_0355)*(IT_0346*IT_0360 + -IT_0355*IT_0364 +
       0.166666666666667*IT_0347*IT_0365 + IT_0335*IT_0366) + 6*conj(IT_0346)*
      (0.166666666666667*IT_0335*IT_0347 + IT_0355*IT_0360 + -IT_0346*IT_0364 +
       IT_0365*IT_0366);
