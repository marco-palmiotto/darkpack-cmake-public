        ...
        )
{
    ...
    const ccomplex_t IT_0009 = N_B2*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0017 = m_b*N_d2*e_em*IT_0016*U_sb_00;
    ...
    const ccomplex_t IT_0027 = conj(N_d1)*N_d2*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = IT_0004*IT_0014;
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = conj(N_u1)*N_u2*e_em;
    ...
    const ccomplex_t IT_0039 = m_b*N_d1*e_em*IT_0016*U_sb_00;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0084 = (-0.5)*IT_0054;
    const ccomplex_t IT_0085 = m_b*conj(N_d2)*e_em*IT_0016*U_sb_10;
    const ccomplex_t IT_0086 = IT_0015*IT_0085;
    const ccomplex_t IT_0087 = 1.4142135623731*IT_0086;
    const ccomplex_t IT_0088 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0089 = IT_0014*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0099 = IT_0084*IT_0098;
    const ccomplex_t IT_0100 = IT_0083 + 0.5*IT_0099;
    const ccomplex_t IT_0101 = e_em*IT_0026;
    const ccomplex_t IT_0102 = e_em*IT_0029;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*(IT_0101 + 3*IT_0102);
    ...
    const ccomplex_t IT_0109 = pow(m_Z, 4);
    ...
    const ccomplex_t IT_0158 = IT_0029*IT_0156;
    const ccomplex_t IT_0159 = conj(N_u2)*N_u3*e_em;
    const ccomplex_t IT_0160 = IT_0026*IT_0159;
    const ccomplex_t IT_0161 = IT_0029*IT_0159;
    ...
    const ccomplex_t IT_0166 = IT_0155 + IT_0165;
    const ccomplex_t IT_0167 = IT_0146*IT_0166;
    const ccomplex_t IT_0168 = m_b*IT_0024;
    const ccomplex_t IT_0169 = m_b*conj(N_d4)*e_em*IT_0016*U_sb_10;
    const ccomplex_t IT_0170 = IT_0015*IT_0169;
    const ccomplex_t IT_0171 = 1.4142135623731*IT_0170;
    const ccomplex_t IT_0172 = conj(N_B4)*e_em*U_sb_00;
    const ccomplex_t IT_0173 = IT_0005*IT_0172;
    const ccomplex_t IT_0174 = 1.4142135623731*IT_0173;
    const ccomplex_t IT_0175 = conj(N_W4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0181 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0182 = IT_0180*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*IT_0182;
    const ccomplex_t IT_0184 = N_u2*conj(N_u4)*e_em;
    const ccomplex_t IT_0185 = IT_0026*IT_0184;
    const ccomplex_t IT_0186 = IT_0029*IT_0184;
    const ccomplex_t IT_0187 = N_d2*conj(N_d4)*e_em;
    const ccomplex_t IT_0188 = IT_0026*IT_0187;
    const ccomplex_t IT_0189 = IT_0029*IT_0187;
    ...
    const ccomplex_t IT_0193 = conj(N_d2)*N_d4*e_em;
    const ccomplex_t IT_0194 = IT_0026*IT_0193;
    const ccomplex_t IT_0195 = IT_0029*IT_0193;
    const ccomplex_t IT_0196 = conj(N_u2)*N_u4*e_em;
    const ccomplex_t IT_0197 = IT_0026*IT_0196;
    const ccomplex_t IT_0198 = IT_0029*IT_0196;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*(IT_0194 + IT_0195 + 
      -IT_0197 + -IT_0198);
    const ccomplex_t IT_0200 = (-0.5)*IT_0199;
    const ccomplex_t IT_0201 = m_N_2*IT_0200;
    const ccomplex_t IT_0202 = -IT_0201;
    const ccomplex_t IT_0203 = IT_0192 + IT_0202;
    const ccomplex_t IT_0204 = IT_0183*IT_0203;
    const ccomplex_t IT_0205 = (-0.5)*IT_0128 + -IT_0131 + -IT_0167 + IT_0168 
      + -IT_0204;
    const ccomplex_t IT_0206 = m_N_1*IT_0035;
    const ccomplex_t IT_0207 = m_N_2*IT_0068;
    const ccomplex_t IT_0208 = -IT_0207;
    const ccomplex_t IT_0209 = IT_0206 + IT_0208;
    const ccomplex_t IT_0210 = IT_0082*IT_0209;
    const ccomplex_t IT_0211 = (-0.5)*IT_0128 + IT_0210;
    const ccomplex_t IT_0212 = IT_0205 + IT_0211;
    const ccomplex_t IT_0213 = conj(IT_0205) + conj(IT_0211);
    const ccomplex_t IT_0214 = IT_0008*IT_0096;
    const ccomplex_t IT_0215 = IT_0003*IT_0129*IT_0214;
    const ccomplex_t IT_0216 = m_b*IT_0107;
    const ccomplex_t IT_0217 = IT_0058*IT_0127;
    const ccomplex_t IT_0218 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0219 = IT_0005*IT_0218;
    const ccomplex_t IT_0220 = 1.4142135623731*IT_0219;
    const ccomplex_t IT_0221 = m_b*N_d3*e_em*IT_0016*U_sb_00;
    ...
    const ccomplex_t IT_0245 = IT_0181*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*IT_0245;
    const ccomplex_t IT_0247 = IT_0236*IT_0246;
    const ccomplex_t IT_0248 = IT_0215 + -IT_0216 + (-0.5)*IT_0217 + IT_0232 +
       IT_0247;
    const ccomplex_t IT_0249 = m_N_1*IT_0068;
    const ccomplex_t IT_0250 = m_N_2*IT_0035;
    const ccomplex_t IT_0251 = -IT_0250;
    const ccomplex_t IT_0252 = IT_0249 + IT_0251;
    const ccomplex_t IT_0253 = IT_0046*IT_0252;
    const ccomplex_t IT_0254 = (-0.5)*IT_0217 + -IT_0253;
    const ccomplex_t IT_0255 = IT_0248 + IT_0254;
    const ccomplex_t IT_0256 = conj(IT_0248) + conj(IT_0254);
    const ccomplex_t IT_0257 = (-24)*IT_0113;
    const ccomplex_t IT_0258 = 6*IT_0111;
    const ccomplex_t IT_0259 = IT_0257 + IT_0258;
    const ccomplex_t IT_0260 = IT_0055*IT_0098;
    const ccomplex_t IT_0261 = IT_0183*IT_0200;
    const ccomplex_t IT_0262 = IT_0146*IT_0163;
    const ccomplex_t IT_0263 = 0.5*IT_0260 + IT_0261 + IT_0262;
    const ccomplex_t IT_0264 = IT_0154*IT_0227;
    const ccomplex_t IT_0265 = IT_0191*IT_0246;
    const ccomplex_t IT_0266 = -IT_0264 + -IT_0265;
    const ccomplex_t IT_0267 = IT_0058*IT_0084;
    const ccomplex_t IT_0268 = (-0.5)*IT_0267;
    const ccomplex_t IT_0269 = IT_0266 + IT_0268;
    const ccomplex_t IT_0270 = conj(IT_0266) + conj(IT_0268);
    const ccomplex_t IT_0271 = (-12)*IT_0117;
    const ccomplex_t IT_0272 = IT_0114 + IT_0258 + IT_0271;
    const ccomplex_t IT_0273 = 12*IT_0117;
    const ccomplex_t IT_0274 = IT_0112 + IT_0257 + IT_0273;
    const ccomplex_t IT_0275 = m_b*m_N_2;
    const ccomplex_t IT_0276 = pow(s_14, 2);
    const ccomplex_t IT_0277 = IT_0108*IT_0276;
    const ccomplex_t IT_0278 = -IT_0001;
    const ccomplex_t IT_0279 = IT_0277 + IT_0278;
    const ccomplex_t IT_0280 = IT_0275*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0005
    ...
    const ccomplex_t IT_0283 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0284 = IT_0096*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*IT_0284;
    const ccomplex_t IT_0286 = IT_0282*IT_0285;
    const ccomplex_t IT_0287 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0005
    ...
    const ccomplex_t IT_0289 = m_b*conj(N_d2)*e_em*IT_0016*U_sb_11;
    const ccomplex_t IT_0290 = IT_0015*IT_0289;
    const ccomplex_t IT_0291 = 1.4142135623731*IT_0290;
    const ccomplex_t IT_0292 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0293 = IT_0014*IT_0292;
    const ccomplex_t IT_0294 = 1.4142135623731*IT_0293;
    const ccomplex_t IT_0295 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0301 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
    ...
    const ccomplex_t IT_0305 = -IT_0260 + (-2)*IT_0261 + (-2)*IT_0262 + 
      -IT_0286 + -IT_0304;
    const ccomplex_t IT_0306 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0307 = IT_0005*IT_0306;
    const ccomplex_t IT_0308 = 1.4142135623731*IT_0307;
    const ccomplex_t IT_0309 = m_b*N_d2*e_em*IT_0016*U_sb_01;
    const ccomplex_t IT_0310 = IT_0015*IT_0309;
    ...
    const ccomplex_t IT_0314 = IT_0301*IT_0313;
    const ccomplex_t IT_0315 = (0 + _Complex_I*1)*IT_0314;
    const ccomplex_t IT_0316 = IT_0288*IT_0315;
    const ccomplex_t IT_0317 = IT_0021*IT_0283;
    const ccomplex_t IT_0318 = (0 + _Complex_I*1)*IT_0317;
    const ccomplex_t IT_0319 = IT_0282*IT_0318;
    const ccomplex_t IT_0320 = 2*IT_0264 + 2*IT_0265 + IT_0267 + IT_0316 +
       IT_0319;
    const ccomplex_t IT_0321 = 6*IT_0320;
    const ccomplex_t IT_0322 = 2*IT_0047 + IT_0059;
    const ccomplex_t IT_0323 = (-6)*IT_0322;
    const ccomplex_t IT_0324 = IT_0321 + IT_0323;
    const ccomplex_t IT_0325 = 6*conj(IT_0320);
    const ccomplex_t IT_0326 = (-6)*conj(IT_0322);
    const ccomplex_t IT_0327 = IT_0325 + IT_0326;
    const ccomplex_t IT_0328 = (-2)*IT_0083 + -IT_0099;
    const ccomplex_t IT_0329 = 6*IT_0322;
    const ccomplex_t IT_0330 = (-6)*IT_0320;
    const ccomplex_t IT_0331 = IT_0329 + IT_0330;
    const ccomplex_t IT_0332 = 6*conj(IT_0322);
    const ccomplex_t IT_0333 = (-6)*conj(IT_0320);
    const ccomplex_t IT_0334 = IT_0332 + IT_0333;
    const ccomplex_t IT_0335 = m_b*IT_0279;
    const ccomplex_t IT_0336 = 6*IT_0305;
    const ccomplex_t IT_0337 = (-6)*IT_0328;
    const ccomplex_t IT_0338 = IT_0336 + IT_0337;
    const ccomplex_t IT_0339 = 6*conj(IT_0305);
    const ccomplex_t IT_0340 = (-6)*conj(IT_0328);
    const ccomplex_t IT_0341 = IT_0339 + IT_0340;
    const ccomplex_t IT_0342 = s_14*s_34*IT_0108;
    const ccomplex_t IT_0343 = -IT_0342;
    const ccomplex_t IT_0344 = s_13 + IT_0343;
    const ccomplex_t IT_0345 = s_13*IT_0344;
    const ccomplex_t IT_0346 = (-2)*IT_0024 + -IT_0316 + -IT_0319;
    const ccomplex_t IT_0347 = 2*IT_0107 + IT_0286 + IT_0304;
    const ccomplex_t IT_0348 = 6*IT_0328;
    const ccomplex_t IT_0349 = (-6)*IT_0305;
    const ccomplex_t IT_0350 = IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = 6*conj(IT_0328);
    const ccomplex_t IT_0352 = (-6)*conj(IT_0305);
    ...
    const ccomplex_t IT_0358 = conj(IT_0025) + conj(IT_0060);
    const ccomplex_t IT_0359 = IT_0025 + IT_0060;
    const ccomplex_t IT_0360 = conj(IT_0100) + conj(IT_0107);
    const ccomplex_t IT_0361 = IT_0100 + IT_0107;
    const ccomplex_t IT_0362 = s_34*IT_0116;
    const ccomplex_t IT_0363 = IT_0108*IT_0362;
    const ccomplex_t IT_0364 = 0.5*IT_0363;
    const ccomplex_t IT_0365 = s_34 + IT_0364;
    const ccomplex_t IT_0366 = m_N_2*IT_0365;
    const ccomplex_t IT_0367 = 2*IT_0366;
    const ccomplex_t IT_0368 = 6*IT_0205;
    const ccomplex_t IT_0369 = 6*IT_0211;
    const ccomplex_t IT_0370 = IT_0368 + IT_0369;
    const ccomplex_t IT_0371 = 6*conj(IT_0205);
    const ccomplex_t IT_0372 = 6*conj(IT_0211);
    const ccomplex_t IT_0373 = IT_0371 + IT_0372;
    const ccomplex_t IT_0374 = 6*IT_0248;
    const ccomplex_t IT_0375 = 6*IT_0254;
    const ccomplex_t IT_0376 = IT_0374 + IT_0375;
    const ccomplex_t IT_0377 = 6*conj(IT_0248);
    const ccomplex_t IT_0378 = 6*conj(IT_0254);
    const ccomplex_t IT_0379 = IT_0377 + IT_0378;
    const ccomplex_t IT_0380 = s_14*IT_0116;
    const ccomplex_t IT_0381 = IT_0108*IT_0380;
    ...
    const ccomplex_t IT_0390 = (-6)*IT_0205;
    const ccomplex_t IT_0391 = (-6)*IT_0211;
    const ccomplex_t IT_0392 = IT_0390 + IT_0391;
    const ccomplex_t IT_0393 = (-6)*conj(IT_0205);
    const ccomplex_t IT_0394 = (-6)*conj(IT_0211);
    const ccomplex_t IT_0395 = IT_0393 + IT_0394;
    const ccomplex_t IT_0396 = (-6)*IT_0248;
    const ccomplex_t IT_0397 = (-6)*IT_0254;
    const ccomplex_t IT_0398 = IT_0396 + IT_0397;
    const ccomplex_t IT_0399 = (-6)*conj(IT_0248);
    ...
    const ccomplex_t IT_0406 = IT_0116*IT_0275;
    const ccomplex_t IT_0407 = 3*IT_0406;
    const ccomplex_t IT_0408 = 6*IT_0268;
    const ccomplex_t IT_0409 = (-0.166666666666667)*IT_0408;
    const ccomplex_t IT_0410 = 6*IT_0266;
    const ccomplex_t IT_0411 = (-0.166666666666667)*IT_0410;
    const ccomplex_t IT_0412 = IT_0060 + IT_0409 + IT_0411;
    const ccomplex_t IT_0413 = 6*conj(IT_0268);
    const ccomplex_t IT_0414 = (-0.166666666666667)*IT_0413;
    const ccomplex_t IT_0415 = 6*conj(IT_0266);
    const ccomplex_t IT_0416 = (-0.166666666666667)*IT_0415;
    const ccomplex_t IT_0417 = conj(IT_0060) + IT_0414 + IT_0416;
    const ccomplex_t IT_0418 = 6*IT_0025;
    const ccomplex_t IT_0419 = 6*conj(IT_0025);
    const ccomplex_t IT_0420 = (-3)*IT_0406;
    const ccomplex_t IT_0421 = 6*(conj(IT_0100)*(IT_0060 + -IT_0269) + IT_0100
      *(conj(IT_0060) + -IT_0270) + -conj(IT_0263)*IT_0412 + -IT_0263*IT_0417 +
       0.166666666666667*conj(IT_0107)*IT_0418 + 0.166666666666667*IT_0107
      *IT_0419)*IT_0420;
    const ccomplex_t IT_0422 = (-18)*conj(IT_0205);
    const ccomplex_t IT_0423 = s_13*IT_0279;
    const ccomplex_t IT_0424 = IT_0275*IT_0344;
    ...
    const ccomplex_t IT_0430 = IT_0108*IT_0429;
    const ccomplex_t IT_0431 = -IT_0430;
    const ccomplex_t IT_0432 = IT_0000 + IT_0431;
    const ccomplex_t IT_0433 = IT_0275*IT_0432;
    ...
    const ccomplex_t IT_0442 = conj(IT_0263)*IT_0347 + IT_0263*conj(IT_0347) +
       0.166666666666667*IT_0270*IT_0425 + 0.166666666666667*IT_0269*IT_0426 +
    ...
    const ccomplex_t IT_0443 = m_N_2*IT_0344;
    const ccomplex_t IT_0444 = m_N_2*IT_0432;
    const ccomplex_t IT_0445 = (conj(IT_0025)*IT_0060 + IT_0025*conj(IT_0060) 
      + conj(IT_0100)*IT_0107 + IT_0100*conj(IT_0107))*IT_0115 + IT_0123*
      (IT_0212*IT_0213 + IT_0255*IT_0256) + IT_0259*(conj(IT_0107)*IT_0263 +
       IT_0107*conj(IT_0263) + conj(IT_0025)*IT_0269 + IT_0025*IT_0270) + 
      (IT_0025*conj(IT_0025) + IT_0060*conj(IT_0060) + IT_0100*conj(IT_0100) +
       IT_0107*conj(IT_0107) + IT_0263*conj(IT_0263) + (IT_0266 + IT_0268)
      *IT_0270)*IT_0272 + (conj(IT_0100)*IT_0263 + IT_0100*conj(IT_0263) + conj
      (IT_0060)*IT_0269 + IT_0060*IT_0270)*IT_0274 + IT_0280*(conj(IT_0305)
      *IT_0324 + IT_0305*IT_0327 + conj(IT_0328)*IT_0331 + IT_0328*IT_0334) +
       IT_0335*(IT_0213*IT_0324 + IT_0212*IT_0327 + IT_0256*IT_0338 + IT_0255
      *IT_0341) + IT_0345*(IT_0334*IT_0346 + IT_0331*conj(IT_0346) + conj
      (IT_0347)*IT_0350 + IT_0347*IT_0353) + IT_0357*(IT_0270*IT_0324 + IT_0269
      *IT_0327 + conj(IT_0263)*IT_0338 + IT_0263*IT_0341 + IT_0331*IT_0358 +
       IT_0334*IT_0359 + IT_0350*IT_0360 + IT_0353*IT_0361) + IT_0367*(conj
      (IT_0107)*IT_0370 + IT_0107*IT_0373 + conj(IT_0025)*IT_0376 + IT_0025
      *IT_0379) + (conj(IT_0025)*IT_0370 + IT_0025*IT_0373 + conj(IT_0107)
      *IT_0376 + IT_0107*IT_0379)*IT_0385 + IT_0389*(conj(IT_0263)*IT_0370 +
       IT_0263*IT_0373 + IT_0270*IT_0376 + IT_0269*IT_0379 + conj(IT_0100)
      *IT_0392 + IT_0100*IT_0395 + conj(IT_0060)*IT_0398 + IT_0060*IT_0401) + 
      (IT_0270*IT_0370 + IT_0269*IT_0373 + conj(IT_0263)*IT_0376 + IT_0263
      *IT_0379 + conj(IT_0060)*IT_0392 + IT_0060*IT_0395 + conj(IT_0100)*IT_0398
       + IT_0100*IT_0401)*IT_0405 + (-6)*IT_0407*(conj(IT_0025)*IT_0100 +
       IT_0025*conj(IT_0100) + conj(IT_0107)*IT_0412 + IT_0107*IT_0417 + (
      -0.166666666666667)*conj(IT_0263)*IT_0418 + (-0.166666666666667)*IT_0263
      *IT_0419) + IT_0421 + IT_0275*(IT_0212*((-18)*conj(IT_0248) + (-18)*conj
      (IT_0254)) + IT_0255*((-18)*conj(IT_0211) + IT_0422)) + (conj(IT_0320)
      *IT_0321 + conj(IT_0322)*IT_0331 + IT_0322*IT_0333 + conj(IT_0305)*IT_0336
      ...
      *IT_0347 + IT_0331*conj(IT_0347) + conj(IT_0328)*IT_0425 + IT_0328*IT_0426
       + conj(IT_0305)*IT_0427 + IT_0305*IT_0428) + (conj(IT_0347)*IT_0427 +
       IT_0347*IT_0428)*IT_0433 + IT_0434*(conj(IT_0346)*IT_0427 + conj(IT_0347)
      *IT_0435) + IT_0436*(IT_0213*IT_0427 + IT_0212*IT_0428 + IT_0256*IT_0435 +
       IT_0255*IT_0437) + 6*IT_0441*IT_0442 + (IT_0256*IT_0331 + IT_0255*IT_0334
       + conj(IT_0211)*IT_0350 + IT_0211*IT_0353 + conj(IT_0328)*IT_0368 +
       IT_0328*IT_0371 + conj(IT_0305)*IT_0390 + IT_0305*IT_0393)*IT_0443 + 
      (conj(IT_0347)*IT_0390 + IT_0347*IT_0393 + IT_0256*IT_0427 + IT_0255
      *IT_0428 + conj(IT_0211)*IT_0435 + IT_0211*IT_0437)*IT_0444;
