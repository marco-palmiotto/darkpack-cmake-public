        ...
        )
{
    ...
    const ccomplex_t IT_0073 = N_B4*N_u2*e_em;
    const ccomplex_t IT_0074 = IT_0022*IT_0073;
    const ccomplex_t IT_0075 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0076 = IT_0026*IT_0075;
    const ccomplex_t IT_0077 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0078 = IT_0022*IT_0077;
    const ccomplex_t IT_0079 = N_B2*N_d4*e_em;
    ...
    const ccomplex_t IT_0097 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0101 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0106 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0110 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0121 = m_b*N_d4*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0126 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_4*
    ...
    const ccomplex_t IT_0131 = cpow((-2)*s_13 + IT_0016 + IT_0130 + -m_sb_1*
    ...
    const ccomplex_t IT_0135 = m_b*N_d2*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0141 = m_b*mu_h*IT_0010;
    const ccomplex_t IT_0142 = IT_0005*IT_0025;
    const ccomplex_t IT_0143 = sin(beta);
    const ccomplex_t IT_0144 = IT_0021*IT_0143;
    const ccomplex_t IT_0145 = IT_0142 + IT_0144;
    const ccomplex_t IT_0146 = cpow(IT_0000, -2);
    const ccomplex_t IT_0147 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0145*(IT_0008 + 1./3*IT_0007*IT_0146))*conj
      (U_sb_00) + 1./2*IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_10)) + U_sb_10*
      (IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_00) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0145*IT_0146)*conj(U_sb_10
      ));
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*(e_em*IT_0147 +
       1.4142135623731*A_b*IT_0025*IT_0140*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    ...
    const ccomplex_t IT_0153 = cpow((-2)*s_13 + IT_0016 + IT_0130 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0154 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0145*(IT_0008 + 1./3*IT_0007*IT_0146))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_11)) + U_sb_10*
      (IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0145*IT_0146)*conj(U_sb_11
      ));
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*(e_em*IT_0154 +
       1.4142135623731*A_b*IT_0025*IT_0140*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0160 = m_b*N_d2*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0168 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0130 
      + -reg_prop, -1);
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_b*e_em*IT_0006*IT_0008
      *IT_0010*IT_0025;
    ...
    const ccomplex_t IT_0175 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0176 = IT_0022*IT_0175;
    const ccomplex_t IT_0177 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0178 = IT_0026*IT_0177;
    const ccomplex_t IT_0179 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0180 = IT_0034*IT_0179;
    const ccomplex_t IT_0181 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0186 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0187 = IT_0022*IT_0186;
    const ccomplex_t IT_0188 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0189 = IT_0026*IT_0188;
    const ccomplex_t IT_0190 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0191 = IT_0034*IT_0190;
    const ccomplex_t IT_0192 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0198 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_2*
    ...
    const ccomplex_t IT_0229 = IT_0022*IT_0228;
    ...
    const ccomplex_t IT_0234 = IT_0034*IT_0233;
    const ccomplex_t IT_0235 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0236 = IT_0037*IT_0235;
    ...
    const ccomplex_t IT_0240 = IT_0037*IT_0239;
    ...
    const ccomplex_t IT_0245 = m_N_2*IT_0244;
    const ccomplex_t IT_0246 = IT_0223 + IT_0245;
    const ccomplex_t IT_0247 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0248 = IT_0001*IT_0247;
    const ccomplex_t IT_0249 = 1.4142135623731*IT_0248;
    const ccomplex_t IT_0250 = m_b*N_d1*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0255 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_1*
    ...
    const ccomplex_t IT_0259 = IT_0072 + IT_0129 + IT_0152 + IT_0167 + (-2)
      *IT_0174 + IT_0201 + IT_0258;
    const ccomplex_t IT_0260 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0261 = IT_0009*IT_0260;
    const ccomplex_t IT_0262 = 1.4142135623731*IT_0261;
    const ccomplex_t IT_0263 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0264 = IT_0008*IT_0263;
    const ccomplex_t IT_0265 = 1.4142135623731*IT_0264;
    const ccomplex_t IT_0266 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0288 = IT_0018*IT_0287;
    const ccomplex_t IT_0289 = (0 + _Complex_I*1)*IT_0288;
    const ccomplex_t IT_0290 = m_N_2*IT_0047;
    const ccomplex_t IT_0291 = m_N_3*IT_0069;
    const ccomplex_t IT_0292 = IT_0290 + IT_0291;
    const ccomplex_t IT_0293 = IT_0289*IT_0292;
    const ccomplex_t IT_0294 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0145*(IT_0008 + 1./3*IT_0007*IT_0146))*conj
      (U_sb_00) + 1./2*IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_10)) + U_sb_10*
      (IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_00) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0145*IT_0146)*conj(U_sb_10
    ...
    const ccomplex_t IT_0297 = IT_0271*IT_0296;
    const ccomplex_t IT_0298 = IT_0131*IT_0297;
    const ccomplex_t IT_0299 = (0 + _Complex_I*1)*IT_0298;
    const ccomplex_t IT_0300 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0306 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0312 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0145*(IT_0008 + 1./3*IT_0007*IT_0146))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_11)) + U_sb_10*
      (IT_0006*IT_0008*IT_0021*IT_0141*conj(U_sb_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0145*IT_0146)*conj(U_sb_11
      ));
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*(e_em*IT_0312 +
       1.4142135623731*A_b*IT_0025*IT_0140*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    const ccomplex_t IT_0314 = 0.5*IT_0313;
    const ccomplex_t IT_0315 = IT_0311*IT_0314;
    const ccomplex_t IT_0316 = IT_0153*IT_0315;
    const ccomplex_t IT_0317 = (0 + _Complex_I*1)*IT_0316;
    const ccomplex_t IT_0318 = IT_0198*IT_0271;
    const ccomplex_t IT_0319 = (0 + _Complex_I*1)*IT_0318;
    const ccomplex_t IT_0320 = IT_0197*IT_0319;
    const ccomplex_t IT_0321 = m_b*conj(N_d1)*e_em*IT_0010*U_sb_10;
    ...
    const ccomplex_t IT_0333 = IT_0255*IT_0332;
    const ccomplex_t IT_0334 = (0 + _Complex_I*1)*IT_0333;
    const ccomplex_t IT_0335 = m_N_2*IT_0222;
    const ccomplex_t IT_0336 = m_N_1*IT_0244;
    ...
    const ccomplex_t IT_0353 = m_N_2*IT_0093;
    const ccomplex_t IT_0354 = m_N_4*IT_0115;
    const ccomplex_t IT_0355 = IT_0353 + IT_0354;
    const ccomplex_t IT_0356 = IT_0352*IT_0355;
    const ccomplex_t IT_0357 = 2*IT_0275 + -IT_0293 + -IT_0299 + -IT_0317 + 
      -IT_0320 + -IT_0338 + -IT_0356;
    const ccomplex_t IT_0358 = 6*s_13;
    const ccomplex_t IT_0359 = m_b*m_N_2;
    const ccomplex_t IT_0360 = 6*IT_0259;
    const ccomplex_t IT_0361 = IT_0222*IT_0334;
    const ccomplex_t IT_0362 = IT_0047*IT_0289;
    const ccomplex_t IT_0363 = IT_0093*IT_0352;
    const ccomplex_t IT_0364 = IT_0184*IT_0319;
    const ccomplex_t IT_0365 = -IT_0173 + IT_0361 + IT_0362 + IT_0363 + IT_0364;
    const ccomplex_t IT_0366 = m_b*s_14;
    const ccomplex_t IT_0367 = IT_0020*IT_0069;
    const ccomplex_t IT_0368 = IT_0244*IT_0257;
    const ccomplex_t IT_0369 = IT_0195*IT_0200;
    const ccomplex_t IT_0370 = IT_0115*IT_0128;
    const ccomplex_t IT_0371 = IT_0274 + -IT_0367 + -IT_0368 + -IT_0369 + 
      -IT_0370;
    const ccomplex_t IT_0372 = s_34*m_N_2;
    const ccomplex_t IT_0373 = 6*conj(IT_0259);
    const ccomplex_t IT_0374 = 6*conj(IT_0357);
    const ccomplex_t IT_0375 = pow(m_h, 2);
    const ccomplex_t IT_0376 = m_b*m_N_2*IT_0375;
