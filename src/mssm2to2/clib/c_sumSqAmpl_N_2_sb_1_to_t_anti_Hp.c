        ...
        )
{
    ...
    const ccomplex_t IT_0015 = N_B2*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0020 = m_b*N_d2*e_em*IT_0005*U_sb_00;
    ...
    const ccomplex_t IT_0044 = m_b*conj(U_d1)*V_tb*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0045 = IT_0019*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0002 + IT_0027 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0056 = N_d2*e_em*U_Wm2;
    const ccomplex_t IT_0057 = IT_0029*IT_0056;
    const ccomplex_t IT_0058 = (-2)*IT_0057;
    const ccomplex_t IT_0059 = N_B2*U_d2*e_em;
    const ccomplex_t IT_0060 = IT_0033*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = N_W2*U_d2*e_em;
    ...
    const ccomplex_t IT_0069 = m_b*conj(U_d2)*V_tb*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0070 = IT_0019*IT_0069;
    const ccomplex_t IT_0071 = 1.4142135623731*IT_0070;
    const ccomplex_t IT_0072 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0073 = IT_0010*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*(IT_0071 + (-2)*IT_0073);
    ...
    const ccomplex_t IT_0080 = m_b*conj(N_d2)*e_em*IT_0005*U_sb_10;
    const ccomplex_t IT_0081 = IT_0019*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0084 = IT_0010*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0005*IT_0008*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0100 = IT_0055*IT_0098*IT_0099;
    const ccomplex_t IT_0101 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0102 = IT_0014*IT_0101;
    const ccomplex_t IT_0103 = 1.4142135623731*IT_0102;
    const ccomplex_t IT_0104 = IT_0008*IT_0010;
    const ccomplex_t IT_0105 = m_t*N_u2*e_em*IT_0005*U_st_00;
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = 1.4142135623731*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*(IT_0103 + (-0.75)*IT_0107);
    const ccomplex_t IT_0109 = 0.666666666666667*IT_0108;
    const ccomplex_t IT_0110 = m_t*U_sb_00*(m_t*IT_0006*IT_0008*conj(U_st_00) 
      + mu_h*conj(U_st_10)) + m_b*(m_b*IT_0007*IT_0018*U_sb_00*conj(U_st_00) +
       U_sb_10*(mu_h*conj(U_st_00) + m_t*IT_0008*IT_0018*conj(U_st_10)));
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*U_sb_10
      *conj(U_st_00) + (-1.4142135623731)*e_em*IT_0010*((-0.5)*IT_0005*IT_0110 +
       m_W*IT_0006*IT_0007*U_sb_00*conj(U_st_00)) + A_t*IT_0006*U_sb_00*conj
      (U_st_10));
    const ccomplex_t IT_0112 = IT_0109*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_13 + IT_0001 + IT_0027 + -m_st_1*
    ...
    const ccomplex_t IT_0119 = m_t*N_u2*e_em*IT_0005*U_st_01;
    ...
    const ccomplex_t IT_0124 = m_t*U_sb_00*(m_t*IT_0006*IT_0008*conj(U_st_01) 
      + mu_h*conj(U_st_11)) + m_b*(m_b*IT_0007*IT_0018*U_sb_00*conj(U_st_01) +
       U_sb_10*(mu_h*conj(U_st_01) + m_t*IT_0008*IT_0018*conj(U_st_11)));
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*U_sb_10
      *conj(U_st_01) + (-1.4142135623731)*e_em*IT_0010*((-0.5)*IT_0005*IT_0124 +
       m_W*IT_0006*IT_0007*U_sb_00*conj(U_st_01)) + A_t*IT_0006*U_sb_00*conj
      (U_st_11));
    const ccomplex_t IT_0126 = IT_0123*IT_0125;
    const ccomplex_t IT_0127 = cpow((-2)*s_13 + IT_0001 + IT_0027 + -m_st_2*
    ...
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0005*IT_0008*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0135 = -IT_0026 + -IT_0054 + -IT_0079 + IT_0095 +
       IT_0100 + IT_0115 + IT_0129 + IT_0134;
    ...
    const ccomplex_t IT_0152 = IT_0028*IT_0130*IT_0151;
    ...
    const ccomplex_t IT_0167 = IT_0055*IT_0099*IT_0166;
    ...
    const ccomplex_t IT_0172 = IT_0132*IT_0150;
    const ccomplex_t IT_0173 = IT_0028*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*IT_0173;
    const ccomplex_t IT_0175 = m_t*IT_0174;
    const ccomplex_t IT_0176 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0177 = IT_0014*IT_0176;
    const ccomplex_t IT_0178 = 1.4142135623731*IT_0177;
    const ccomplex_t IT_0179 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0180 = IT_0010*IT_0179;
    const ccomplex_t IT_0181 = 1.4142135623731*IT_0180;
    const ccomplex_t IT_0182 = m_t*conj(N_u2)*e_em*IT_0005*U_st_10;
    const ccomplex_t IT_0183 = IT_0104*IT_0182;
    ...
    const ccomplex_t IT_0190 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0191 = IT_0014*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = conj(N_W2)*e_em*U_st_01;
    const ccomplex_t IT_0194 = IT_0010*IT_0193;
    const ccomplex_t IT_0195 = 1.4142135623731*IT_0194;
    const ccomplex_t IT_0196 = m_t*conj(N_u2)*e_em*IT_0005*U_st_11;
    const ccomplex_t IT_0197 = IT_0104*IT_0196;
    ...
    const ccomplex_t IT_0208 = IT_0024*IT_0169;
