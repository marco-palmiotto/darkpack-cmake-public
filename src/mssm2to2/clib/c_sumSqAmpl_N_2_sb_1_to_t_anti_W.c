        ...
        )
{
    ...
    const ccomplex_t IT_0039 = N_W2*e_em*conj(V_Wp2);
    const ccomplex_t IT_0040 = IT_0001*IT_0039;
    const ccomplex_t IT_0041 = N_u2*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0056 = m_t*N_u2*e_em*IT_0012*U_st_01;
    ...
    const ccomplex_t IT_0072 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0073 = IT_0005*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_t*conj(N_u2)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0086 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0087 = IT_0005*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W2)*e_em*U_st_01;
    const ccomplex_t IT_0090 = IT_0001*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = m_t*conj(N_u2)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0195 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0196 = IT_0005*IT_0195;
    const ccomplex_t IT_0197 = 1.4142135623731*IT_0196;
    const ccomplex_t IT_0198 = m_b*N_d2*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0219 = IT_0034*IT_0114;
    const ccomplex_t IT_0220 = IT_0025*IT_0188*IT_0219;
    const ccomplex_t IT_0221 = IT_0047*IT_0134;
    const ccomplex_t IT_0222 = IT_0038*IT_0191*IT_0221;
    ...
    const ccomplex_t IT_0284 = IT_0230*IT_0232;
    const ccomplex_t IT_0285 = IT_0107*IT_0265;
    const ccomplex_t IT_0286 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0100
      ...
      *IT_0247*IT_0252 + IT_0230*IT_0259 + 0.166666666666667*IT_0253*IT_0267 +
       IT_0273*IT_0280 + IT_0264*IT_0282) + IT_0283*(IT_0071*IT_0231 + IT_0207
      *IT_0234 + IT_0284 + IT_0285) + 6*conj(IT_0231)*(IT_0169*IT_0233 + IT_0208
      *IT_0234 + IT_0071*IT_0259 + 0.166666666666667*IT_0102*IT_0273 + IT_0284 +
       IT_0285);
