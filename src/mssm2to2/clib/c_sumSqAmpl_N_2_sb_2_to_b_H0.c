        ...
        )
{
    ...
    const ccomplex_t IT_0035 = N_B4*N_u2*e_em;
    ...
    const ccomplex_t IT_0042 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0051 = conj(N_W2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0016 + IT_0073 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0075 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_b*N_d2*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0083 = cpow(V_tb, 2);
    const ccomplex_t IT_0084 = m_b*mu_h*IT_0010;
    const ccomplex_t IT_0085 = sin(beta);
    const ccomplex_t IT_0086 = -IT_0025*IT_0085;
    const ccomplex_t IT_0087 = IT_0005*IT_0021;
    const ccomplex_t IT_0088 = IT_0086 + IT_0087;
    const ccomplex_t IT_0089 = cpow(IT_0000, -2);
    const ccomplex_t IT_0090 = (-2)*conj(U_sb_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))
      *U_sb_01 + -1./2*IT_0006*IT_0008*IT_0025*IT_0084*U_sb_11) + conj(U_sb_10)*
      (IT_0006*IT_0008*IT_0025*IT_0084*U_sb_01 + (-2)*(IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*U_sb_11);
    const ccomplex_t IT_0091 = (0 + _Complex_I*-1)*(e_em*IT_0090 + (
      -1.4142135623731)*A_b*IT_0021*IT_0083*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0073 
      + -reg_prop, -1);
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*m_b*e_em*IT_0006*IT_0008
      *IT_0010*IT_0021;
    const ccomplex_t IT_0098 = (-0.5)*IT_0097;
    const ccomplex_t IT_0099 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0100 = IT_0001*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = m_b*N_d2*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0016 + IT_0073 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0112 = (-2)*U_sb_01*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0021 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0084*conj(U_sb_11)) + U_sb_11
      *(IT_0006*IT_0008*IT_0025*IT_0084*conj(U_sb_01) + (-2)*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*conj(U_sb_11
      ));
    const ccomplex_t IT_0113 = (0 + _Complex_I*-1)*(e_em*IT_0112 + (
      -1.4142135623731)*A_b*IT_0021*IT_0083*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0120 = N_B2*N_u2*e_em;
    ...
    const ccomplex_t IT_0128 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0129 = IT_0022*IT_0128;
    const ccomplex_t IT_0130 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0131 = IT_0034*IT_0130;
    const ccomplex_t IT_0132 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0133 = IT_0037*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0135 = IT_0026*IT_0134;
    ...
    const ccomplex_t IT_0139 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0140 = IT_0106*IT_0139;
    ...
    const ccomplex_t IT_0157 = IT_0034*IT_0156;
    ...
    const ccomplex_t IT_0164 = m_N_1*IT_0163;
    ...
    const ccomplex_t IT_0179 = IT_0034*IT_0178;
    ...
    const ccomplex_t IT_0188 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0189 = IT_0001*IT_0188;
    const ccomplex_t IT_0190 = 1.4142135623731*IT_0189;
    const ccomplex_t IT_0191 = m_b*N_d1*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0196 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_1*
    ...
    const ccomplex_t IT_0200 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0201 = IT_0001*IT_0200;
    const ccomplex_t IT_0202 = 1.4142135623731*IT_0201;
    const ccomplex_t IT_0203 = m_b*N_d3*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0208 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0209 = IT_0207*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*IT_0209;
    const ccomplex_t IT_0211 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0212 = IT_0022*IT_0211;
    const ccomplex_t IT_0213 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0214 = IT_0026*IT_0213;
    const ccomplex_t IT_0215 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0216 = IT_0022*IT_0215;
    const ccomplex_t IT_0217 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0218 = IT_0026*IT_0217;
    const ccomplex_t IT_0219 = IT_0212 + IT_0214 + IT_0216 + IT_0218;
    const ccomplex_t IT_0220 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0221 = IT_0034*IT_0220;
    const ccomplex_t IT_0222 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0223 = IT_0037*IT_0222;
    const ccomplex_t IT_0224 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0225 = IT_0034*IT_0224;
    const ccomplex_t IT_0226 = N_W2*N_d3*e_em;
    const ccomplex_t IT_0227 = IT_0037*IT_0226;
    ...
    const ccomplex_t IT_0237 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0238 = IT_0022*IT_0237;
    const ccomplex_t IT_0239 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0240 = IT_0026*IT_0239;
    ...
    const ccomplex_t IT_0245 = IT_0037*IT_0244;
    const ccomplex_t IT_0246 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0247 = IT_0034*IT_0246;
    const ccomplex_t IT_0248 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0257 = IT_0072 + IT_0095 + (-2)*IT_0110 + IT_0117 +
       IT_0142 + IT_0199 + IT_0256;
    const ccomplex_t IT_0258 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_11;
    const ccomplex_t IT_0259 = IT_0009*IT_0258;
    const ccomplex_t IT_0260 = 1.4142135623731*IT_0259;
    const ccomplex_t IT_0261 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0262 = IT_0008*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0270 = (-2)*U_sb_01*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0021 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0084*conj(U_sb_11)) + U_sb_11
      *(IT_0006*IT_0008*IT_0025*IT_0084*conj(U_sb_01) + (-2)*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*conj(U_sb_11
    ...
    const ccomplex_t IT_0274 = IT_0111*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*IT_0274;
    const ccomplex_t IT_0276 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0277 = IT_0009*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_W2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0288 = (-2)*conj(U_sb_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))
      *U_sb_01 + -1./2*IT_0006*IT_0008*IT_0025*IT_0084*U_sb_11) + conj(U_sb_10)*
      (IT_0006*IT_0008*IT_0025*IT_0084*U_sb_01 + (-2)*(IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*U_sb_11);
    ...
    const ccomplex_t IT_0292 = IT_0074*IT_0291;
    const ccomplex_t IT_0293 = (0 + _Complex_I*1)*IT_0292;
    const ccomplex_t IT_0294 = IT_0139*IT_0269;
    const ccomplex_t IT_0295 = (0 + _Complex_I*1)*IT_0294;
    const ccomplex_t IT_0296 = IT_0138*IT_0295;
    const ccomplex_t IT_0297 = IT_0098*IT_0269;
    const ccomplex_t IT_0298 = IT_0096*IT_0297;
    const ccomplex_t IT_0299 = (0 + _Complex_I*1)*IT_0298;
    const ccomplex_t IT_0300 = m_b*IT_0299;
    const ccomplex_t IT_0301 = m_N_2*IT_0163;
    const ccomplex_t IT_0302 = m_N_1*IT_0185;
    ...
    const ccomplex_t IT_0310 = m_b*conj(N_d1)*e_em*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0318 = m_N_2*IT_0231;
    const ccomplex_t IT_0319 = m_N_3*IT_0253;
    const ccomplex_t IT_0320 = IT_0318 + IT_0319;
    const ccomplex_t IT_0321 = conj(N_B3)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0327 = m_b*conj(N_d3)*e_em*IT_0010*U_sb_11;
    const ccomplex_t IT_0328 = IT_0009*IT_0327;
    const ccomplex_t IT_0329 = 1.4142135623731*IT_0328;
    const ccomplex_t IT_0330 = (0 + _Complex_I*1)*(IT_0323 + (-3)*IT_0326 + 3
      *IT_0329);
    ...
    const ccomplex_t IT_0334 = IT_0320*IT_0333;
    const ccomplex_t IT_0335 = m_b*conj(N_d4)*e_em*IT_0010*U_sb_11;
    const ccomplex_t IT_0336 = IT_0009*IT_0335;
    const ccomplex_t IT_0337 = 1.4142135623731*IT_0336;
    const ccomplex_t IT_0338 = conj(N_W4)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0347 = IT_0018*IT_0346;
    const ccomplex_t IT_0348 = (0 + _Complex_I*1)*IT_0347;
    const ccomplex_t IT_0349 = m_N_2*IT_0047;
    const ccomplex_t IT_0350 = m_N_4*IT_0069;
    const ccomplex_t IT_0351 = IT_0349 + IT_0350;
    const ccomplex_t IT_0352 = IT_0348*IT_0351;
    const ccomplex_t IT_0353 = -IT_0275 + -IT_0293 + -IT_0296 + 2*IT_0300 + 
      -IT_0317 + -IT_0334 + -IT_0352;
    const ccomplex_t IT_0354 = 6*s_13;
    const ccomplex_t IT_0355 = m_b*m_N_2;
    const ccomplex_t IT_0356 = 6*IT_0257;
    const ccomplex_t IT_0357 = IT_0126*IT_0295;
    const ccomplex_t IT_0358 = IT_0047*IT_0348;
    const ccomplex_t IT_0359 = IT_0163*IT_0316;
    const ccomplex_t IT_0360 = IT_0231*IT_0333;
    const ccomplex_t IT_0361 = -IT_0109 + IT_0357 + IT_0358 + IT_0359 + IT_0360;
    const ccomplex_t IT_0362 = m_b*s_14;
    const ccomplex_t IT_0363 = IT_0210*IT_0253;
    const ccomplex_t IT_0364 = IT_0020*IT_0069;
    const ccomplex_t IT_0365 = IT_0185*IT_0198;
    const ccomplex_t IT_0366 = IT_0136*IT_0141;
    const ccomplex_t IT_0367 = IT_0299 + -IT_0363 + -IT_0364 + -IT_0365 + 
      -IT_0366;
    const ccomplex_t IT_0368 = s_34*m_N_2;
    const ccomplex_t IT_0369 = 6*conj(IT_0257);
    const ccomplex_t IT_0370 = 6*conj(IT_0353);
    const ccomplex_t IT_0371 = pow(m_H0, 2);
    const ccomplex_t IT_0372 = m_b*m_N_2*IT_0371;
