        ...
        )
{
    ...
    const ccomplex_t IT_0040 = N_W2*N_u4*e_em;
    ...
    const ccomplex_t IT_0049 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0050 = IT_0022*IT_0049;
    const ccomplex_t IT_0051 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0052 = IT_0026*IT_0051;
    const ccomplex_t IT_0053 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0054 = IT_0022*IT_0053;
    const ccomplex_t IT_0055 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0016 + IT_0073 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0075 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_b*N_d2*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0085 = IT_0005*IT_0025;
    ...
    const ccomplex_t IT_0090 = 2*U_sb_01*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_11)) + U_sb_11*
      (IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*conj(U_sb_11
      ));
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*(e_em*IT_0090 +
       1.4142135623731*A_b*IT_0025*IT_0083*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0016 + IT_0073 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0097 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0098 = IT_0001*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = m_b*N_d2*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0105 = 2*conj(U_sb_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))
      *U_sb_01 + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*U_sb_11) + conj(U_sb_10)*
      (IT_0006*IT_0008*IT_0021*IT_0084*U_sb_01 + 2*(IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*U_sb_11);
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*(e_em*IT_0105 +
       1.4142135623731*A_b*IT_0025*IT_0083*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    ...
    const ccomplex_t IT_0114 = IT_0082*IT_0113;
    ...
    const ccomplex_t IT_0120 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0121 = IT_0026*IT_0120;
    const ccomplex_t IT_0122 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0123 = IT_0034*IT_0122;
    const ccomplex_t IT_0124 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0129 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0130 = IT_0022*IT_0129;
    const ccomplex_t IT_0131 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0132 = IT_0026*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0134 = IT_0034*IT_0133;
    const ccomplex_t IT_0135 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0141 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0142 = IT_0082*IT_0141;
    ...
    const ccomplex_t IT_0147 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0148 = IT_0026*IT_0147;
    const ccomplex_t IT_0149 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0150 = IT_0022*IT_0149;
    const ccomplex_t IT_0151 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0152 = IT_0026*IT_0151;
    const ccomplex_t IT_0153 = IT_0146 + IT_0148 + IT_0150 + IT_0152;
    const ccomplex_t IT_0154 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0155 = IT_0034*IT_0154;
    const ccomplex_t IT_0156 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0157 = IT_0037*IT_0156;
    const ccomplex_t IT_0158 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0159 = IT_0034*IT_0158;
    const ccomplex_t IT_0160 = N_W1*N_d2*e_em;
    const ccomplex_t IT_0161 = IT_0037*IT_0160;
    ...
    const ccomplex_t IT_0167 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0168 = IT_0022*IT_0167;
    const ccomplex_t IT_0169 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0170 = IT_0026*IT_0169;
    const ccomplex_t IT_0171 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0172 = IT_0022*IT_0171;
    const ccomplex_t IT_0173 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0174 = IT_0026*IT_0173;
    const ccomplex_t IT_0175 = IT_0168 + IT_0170 + IT_0172 + IT_0174;
    const ccomplex_t IT_0176 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0177 = IT_0034*IT_0176;
    const ccomplex_t IT_0178 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0179 = IT_0037*IT_0178;
    const ccomplex_t IT_0180 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0181 = IT_0034*IT_0180;
    const ccomplex_t IT_0182 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0188 = m_N_2*IT_0187;
    const ccomplex_t IT_0189 = IT_0166 + IT_0188;
    const ccomplex_t IT_0190 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0191 = IT_0001*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = m_b*N_d1*e_em*IT_0010*U_sb_01;
    const ccomplex_t IT_0194 = IT_0009*IT_0193;
    ...
    const ccomplex_t IT_0198 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_1*
    ...
    const ccomplex_t IT_0205 = m_b*N_d3*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0210 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_3*
    ...
    const ccomplex_t IT_0217 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0218 = IT_0022*IT_0217;
    const ccomplex_t IT_0219 = N_B2*N_d3*e_em;
    ...
    const ccomplex_t IT_0226 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0227 = IT_0034*IT_0226;
    const ccomplex_t IT_0228 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0235 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0236 = IT_0022*IT_0235;
    const ccomplex_t IT_0237 = conj(N_B2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0244 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0245 = IT_0034*IT_0244;
    const ccomplex_t IT_0246 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0247 = IT_0037*IT_0246;
    const ccomplex_t IT_0248 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0249 = IT_0034*IT_0248;
    const ccomplex_t IT_0250 = conj(N_W3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0251 = IT_0037*IT_0250;
    ...
    const ccomplex_t IT_0259 = IT_0072 + IT_0095 + IT_0110 + (-2)*IT_0117 +
    ...
    const ccomplex_t IT_0275 = m_N_4*IT_0069;
    const ccomplex_t IT_0276 = IT_0274 + IT_0275;
    const ccomplex_t IT_0277 = IT_0273*IT_0276;
    const ccomplex_t IT_0278 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0284 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0307 = IT_0198*IT_0306;
    const ccomplex_t IT_0308 = (0 + _Complex_I*1)*IT_0307;
    const ccomplex_t IT_0309 = IT_0295*IT_0308;
    const ccomplex_t IT_0310 = 2*U_sb_01*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_11)) + U_sb_11*
      (IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*conj(U_sb_11
    ...
    const ccomplex_t IT_0316 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0317 = IT_0009*IT_0316;
    ...
    const ccomplex_t IT_0322 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0328 = 2*conj(U_sb_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))
      *U_sb_01 + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*U_sb_11) + conj(U_sb_10)*
      (IT_0006*IT_0008*IT_0021*IT_0084*U_sb_01 + 2*(IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*U_sb_11);
    ...
    const ccomplex_t IT_0334 = IT_0113*IT_0289;
    ...
    const ccomplex_t IT_0338 = m_N_2*IT_0233;
    const ccomplex_t IT_0339 = m_N_3*IT_0255;
    const ccomplex_t IT_0340 = IT_0338 + IT_0339;
    const ccomplex_t IT_0341 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0342 = IT_0001*IT_0341;
    const ccomplex_t IT_0343 = 1.4142135623731*IT_0342;
    const ccomplex_t IT_0344 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0345 = IT_0008*IT_0344;
    const ccomplex_t IT_0346 = 1.4142135623731*IT_0345;
    const ccomplex_t IT_0347 = m_b*conj(N_d3)*e_em*IT_0010*U_sb_11;
    const ccomplex_t IT_0348 = IT_0009*IT_0347;
    ...
    const ccomplex_t IT_0352 = IT_0210*IT_0351;
    const ccomplex_t IT_0353 = (0 + _Complex_I*1)*IT_0352;
    const ccomplex_t IT_0354 = IT_0340*IT_0353;
    const ccomplex_t IT_0355 = -IT_0277 + -IT_0292 + -IT_0309 + -IT_0315 + 
      -IT_0333 + 2*IT_0337 + -IT_0354;
    const ccomplex_t IT_0356 = 6*s_13;
    const ccomplex_t IT_0357 = m_b*m_N_2;
    const ccomplex_t IT_0358 = 6*IT_0259;
    const ccomplex_t IT_0359 = IT_0047*IT_0273;
    const ccomplex_t IT_0360 = IT_0233*IT_0353;
    const ccomplex_t IT_0361 = IT_0127*IT_0291;
    const ccomplex_t IT_0362 = IT_0165*IT_0308;
    const ccomplex_t IT_0363 = -IT_0116 + IT_0359 + IT_0360 + IT_0361 + IT_0362;
    const ccomplex_t IT_0364 = m_b*s_14;
    const ccomplex_t IT_0365 = IT_0212*IT_0255;
    const ccomplex_t IT_0366 = IT_0020*IT_0069;
    const ccomplex_t IT_0367 = IT_0138*IT_0143;
    const ccomplex_t IT_0368 = IT_0187*IT_0200;
    const ccomplex_t IT_0369 = IT_0336 + -IT_0365 + -IT_0366 + -IT_0367 + 
      -IT_0368;
