...
ccomplex_return_t c_sumSqAmpl_N_2_sb_2_to_t_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = N_W2*e_em*conj(V_Wp2);
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = N_u2*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0053 = N_W2*e_em*conj(V_Wp1);
    const ccomplex_t IT_0054 = IT_0001*IT_0053;
    const ccomplex_t IT_0055 = N_u2*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0072 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0073 = IT_0005*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W2)*e_em*U_st_01;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_t*conj(N_u2)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0092 = m_t*conj(N_u2)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0101 = m_t*m_N_2;
    ...
    const ccomplex_t IT_0108 = m_t*IT_0070;
    ...
    const ccomplex_t IT_0113 = m_b*conj(U_d1)*V_tb*e_em*IT_0012*U_sb_11;
    const ccomplex_t IT_0114 = IT_0112*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    ...
    const ccomplex_t IT_0121 = IT_0052*IT_0109*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0123 = m_b*conj(U_d2)*V_tb*e_em*IT_0012*U_sb_11;
    ...
    const ccomplex_t IT_0131 = IT_0039*IT_0122*IT_0130;
    const ccomplex_t IT_0132 = pow(m_b, 2);
    const ccomplex_t IT_0133 = cpow((-2)*s_12 + -IT_0019 + -IT_0038 + IT_0132 
      + -reg_prop, -1);
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001;
    const ccomplex_t IT_0136 = 0.5*IT_0135;
    const ccomplex_t IT_0137 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0138 = IT_0005*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = m_b*N_d2*e_em*IT_0012*U_sb_01;
    ...
    const ccomplex_t IT_0146 = IT_0133*IT_0134*IT_0145;
    const ccomplex_t IT_0147 = -IT_0121 + -IT_0131 + -IT_0146;
    const ccomplex_t IT_0148 = conj(N_W2)*e_em*U_Wm2;
    const ccomplex_t IT_0149 = IT_0001*IT_0148;
    const ccomplex_t IT_0150 = conj(N_d2)*U_d2*e_em;
    ...
    const ccomplex_t IT_0158 = conj(N_W2)*e_em*U_Wm1;
    const ccomplex_t IT_0159 = IT_0001*IT_0158;
    const ccomplex_t IT_0160 = conj(N_d2)*U_d1*e_em;
    ...
    const ccomplex_t IT_0165 = IT_0119*IT_0164;
    ...
    const ccomplex_t IT_0185 = IT_0133*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*IT_0185;
    const ccomplex_t IT_0187 = pow(m_W, 2);
    const ccomplex_t IT_0188 = IT_0101*IT_0187;
    const ccomplex_t IT_0189 = 3*IT_0188;
    const ccomplex_t IT_0190 = -IT_0157 + -IT_0167;
    const ccomplex_t IT_0191 = (-3)*IT_0188;
    const ccomplex_t IT_0192 = -IT_0023 + -IT_0037;
    const ccomplex_t IT_0193 = s_14*IT_0018;
    const ccomplex_t IT_0194 = s_13*s_34;
    const ccomplex_t IT_0195 = -IT_0194;
    const ccomplex_t IT_0196 = IT_0193 + IT_0195;
    const ccomplex_t IT_0197 = pow(m_W, 4);
    ...
    const ccomplex_t IT_0202 = s_13*IT_0187;
    const ccomplex_t IT_0203 = (-12)*IT_0202;
    const ccomplex_t IT_0204 = 6*IT_0199 + IT_0201 + IT_0203;
    const ccomplex_t IT_0205 = s_14*IT_0187;
    const ccomplex_t IT_0206 = IT_0066*IT_0205;
    ...
    const ccomplex_t IT_0211 = s_34*IT_0187;
    ...
    const ccomplex_t IT_0217 = m_N_2*IT_0064;
    const ccomplex_t IT_0218 = m_N_2*IT_0051;
    const ccomplex_t IT_0219 = m_t*IT_0186;
    const ccomplex_t IT_0220 = -IT_0217 + -IT_0218 + -IT_0219;
    const ccomplex_t IT_0221 = IT_0048*IT_0154;
    const ccomplex_t IT_0222 = IT_0039*IT_0122*IT_0221;
    const ccomplex_t IT_0223 = IT_0061*IT_0164;
    const ccomplex_t IT_0224 = IT_0052*IT_0109*IT_0223;
    ...
    const ccomplex_t IT_0231 = 2*IT_0157 + 2*IT_0167;
    const ccomplex_t IT_0232 = IT_0085 + IT_0099 + 2*IT_0186;
    const ccomplex_t IT_0233 = IT_0101*IT_0229;
    const ccomplex_t IT_0234 = m_N_2*IT_0229;
    const ccomplex_t IT_0235 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0236 = (-18)*conj(IT_0147);
    const ccomplex_t IT_0237 = (-6)*conj(IT_0231);
    const ccomplex_t IT_0238 = 0.5*IT_0212;
    const ccomplex_t IT_0239 = s_34 + IT_0238;
    const ccomplex_t IT_0240 = m_N_2*IT_0239;
    const ccomplex_t IT_0241 = 2*IT_0240;
    const ccomplex_t IT_0242 = (-2)*IT_0200;
    const ccomplex_t IT_0243 = IT_0202 + IT_0242;
    const ccomplex_t IT_0244 = IT_0066*IT_0243;
    const ccomplex_t IT_0245 = (-6)*IT_0244;
    const ccomplex_t IT_0246 = 12*s_13;
    const ccomplex_t IT_0247 = IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = m_t*IT_0229;
    ...
    const ccomplex_t IT_0254 = IT_0101*IT_0253;
    const ccomplex_t IT_0255 = m_N_2*IT_0253;
    const ccomplex_t IT_0256 = (-6)*conj(IT_0192);
    const ccomplex_t IT_0257 = (-6)*IT_0199;
    const ccomplex_t IT_0258 = IT_0201 + IT_0257;
    const ccomplex_t IT_0259 = (-6)*IT_0100;
    const ccomplex_t IT_0260 = 0.166666666666667*IT_0259;
    const ccomplex_t IT_0261 = IT_0231 + IT_0260;
    const ccomplex_t IT_0262 = (-0.25)*IT_0206;
    const ccomplex_t IT_0263 = s_14 + IT_0262;
    const ccomplex_t IT_0264 = m_t*IT_0263;
    const ccomplex_t IT_0265 = (-4)*IT_0264;
    const ccomplex_t IT_0266 = (-6)*IT_0232;
    const ccomplex_t IT_0267 = IT_0186 + IT_0190;
    const ccomplex_t IT_0268 = (-6)*conj(IT_0232);
    const ccomplex_t IT_0269 = (-6)*IT_0147;
    const ccomplex_t IT_0270 = (-6)*conj(IT_0190)*(IT_0103*IT_0191 + (
      -0.166666666666667)*IT_0190*IT_0204 + IT_0210*IT_0226 + (
      -0.166666666666667)*IT_0186*IT_0258 + -IT_0107*IT_0261 + (
      -0.166666666666667)*IT_0196*IT_0266 + IT_0216*(IT_0169 + (
      -0.166666666666667)*IT_0269));
    const ccomplex_t IT_0271 = (-6)*conj(IT_0147);
    const ccomplex_t IT_0272 = (-6)*IT_0065;
    const ccomplex_t IT_0273 = (-6)*IT_0231;
    const ccomplex_t IT_0274 = 6*IT_0103;
    const ccomplex_t IT_0275 = 6*IT_0186;
    const ccomplex_t IT_0276 = (-6)*IT_0190;
    const ccomplex_t IT_0277 = IT_0101*((-18)*IT_0147 + (-18)*IT_0169) +
       IT_0226*IT_0247 + IT_0249*IT_0255 + IT_0248*IT_0266 + IT_0234*IT_0272 + 6
      *IT_0108*(IT_0100 + 0.166666666666667*IT_0273) + IT_0216*IT_0274 + IT_0265
      *IT_0275 + IT_0210*IT_0276;
    const ccomplex_t IT_0278 = 6*IT_0065*IT_0108 + IT_0101*((-18)*IT_0220 + (
      -18)*IT_0225) + IT_0170*IT_0247 + IT_0248*IT_0249 + 6*IT_0234*IT_0261 +
       IT_0255*IT_0266 + IT_0210*IT_0274 + IT_0241*IT_0275 + IT_0216*IT_0276;
    const ccomplex_t IT_0279 = 0.166666666666667*IT_0233;
    const ccomplex_t IT_0280 = s_13*IT_0253;
    const ccomplex_t IT_0281 = 0.166666666666667*IT_0280;
    const ccomplex_t IT_0282 = (-6)*conj(IT_0100);
    const ccomplex_t IT_0283 = IT_0107*IT_0267;
    const ccomplex_t IT_0284 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0100
      *IT_0102 + IT_0103*IT_0107 + IT_0108*IT_0170) + 6*conj(IT_0103)*(IT_0065
      *IT_0107 + IT_0186*IT_0189 + -IT_0190*IT_0191 + IT_0192*IT_0196 +
       0.166666666666667*IT_0103*IT_0204 + IT_0170*IT_0210 + IT_0216*IT_0226) + 
      (IT_0192*IT_0230 + IT_0102*IT_0231 + IT_0232*IT_0233 + IT_0226*IT_0234)
      *IT_0235 + IT_0226*(IT_0101*IT_0236 + IT_0108*IT_0237) + 6*conj(IT_0147)*
      (IT_0065*IT_0108 + IT_0103*IT_0210 + IT_0231*IT_0234 + IT_0186*IT_0241 +
       0.166666666666667*IT_0170*IT_0247 + 0.166666666666667*IT_0248*IT_0249) + 
      (IT_0100*IT_0233 + IT_0170*IT_0248 + IT_0232*IT_0254 + IT_0226*IT_0255)
      *IT_0256 + 6*conj(IT_0186)*(IT_0103*IT_0189 + 0.166666666666667*IT_0186
      *IT_0204 + IT_0170*IT_0241 + 0.166666666666667*IT_0190*IT_0258 + IT_0107
      *IT_0261 + IT_0226*IT_0265 + 0.166666666666667*IT_0196*IT_0266) + (IT_0226
      *IT_0248 + IT_0169*IT_0255 + IT_0196*IT_0267)*IT_0268 + IT_0270 + (IT_0190
      *IT_0216 + IT_0100*IT_0234 + IT_0232*IT_0255)*IT_0271 + (conj(IT_0220) +
       conj(IT_0225))*IT_0277 + conj(IT_0169)*IT_0278 + 6*conj(IT_0100)*(IT_0071
      *IT_0100 + IT_0065*IT_0102 + IT_0108*IT_0226 + 0.166666666666667*IT_0234
      *IT_0269 + IT_0249*IT_0279) + 6*conj(IT_0192)*(IT_0103*IT_0196 + IT_0231
      *IT_0233 + 0.166666666666667*IT_0230*IT_0272 + IT_0249*IT_0281) + 6*conj
      (IT_0232)*(0.166666666666667*IT_0249*IT_0254 + IT_0230*IT_0261 +
       0.166666666666667*IT_0255*IT_0269 + IT_0272*IT_0279 + IT_0266*IT_0281) +
       IT_0282*(IT_0071*IT_0231 + IT_0230*IT_0232 + IT_0169*IT_0234 + IT_0283) +
       6*conj(IT_0231)*(IT_0230*IT_0232 + IT_0192*IT_0233 + IT_0170*IT_0234 +
       IT_0071*IT_0261 + 0.166666666666667*IT_0102*IT_0272 + IT_0283);
