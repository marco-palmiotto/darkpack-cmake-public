...
ccomplex_return_t c_sumSqAmpl_N_2_sc_L_to_c_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (-1.33333333333333)*IT_0016;
    const ccomplex_t IT_0022 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
    ...
    const ccomplex_t IT_0040 = (-0.666666666666667)*IT_0016;
    ...
    const ccomplex_t IT_0048 = m_c*s_14*m_N_2;
    ...
    const ccomplex_t IT_0058 = m_c*m_N_2;
    ...
    const ccomplex_t IT_0063 = m_c*s_34*m_N_2;
