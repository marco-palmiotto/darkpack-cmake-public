        ...
        )
{
    ...
    const ccomplex_t IT_0030 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0031 = IT_0015*IT_0030;
    const ccomplex_t IT_0032 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0033 = IT_0019*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0035 = IT_0022*IT_0034;
    const ccomplex_t IT_0036 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0037 = IT_0025*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*(IT_0031 + -IT_0033 + 
      -IT_0035 + IT_0037);
    const ccomplex_t IT_0039 = m_N_2*IT_0038;
    const ccomplex_t IT_0040 = IT_0029 + IT_0039;
    const ccomplex_t IT_0041 = IT_0011*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
    ...
    const ccomplex_t IT_0069 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0070 = IT_0015*IT_0069;
    const ccomplex_t IT_0071 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0072 = IT_0025*IT_0071;
    const ccomplex_t IT_0073 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0074 = IT_0015*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0082 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0109 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0110 = IT_0022*IT_0109;
    const ccomplex_t IT_0111 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0112 = IT_0019*IT_0111;
    const ccomplex_t IT_0113 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0120 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0121 = IT_0015*IT_0120;
    const ccomplex_t IT_0122 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0123 = IT_0025*IT_0122;
    const ccomplex_t IT_0124 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0125 = IT_0015*IT_0124;
    const ccomplex_t IT_0126 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0127 = IT_0025*IT_0126;
    const ccomplex_t IT_0128 = IT_0121 + IT_0123 + IT_0125 + IT_0127;
    const ccomplex_t IT_0129 = conj(N_B2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0133 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0145 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0144 
      + -reg_prop, -1);
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_c*e_em*IT_0000*IT_0002
      *IT_0004*IT_0018;
    ...
    const ccomplex_t IT_0152 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0153 = (-0.5)*IT_0152;
    const ccomplex_t IT_0154 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
    ...
    const ccomplex_t IT_0181 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0185 = conj(N_W3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0190 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0194 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0002*IT_0004*IT_0012;
    const ccomplex_t IT_0204 = 0.5*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0014;
    const ccomplex_t IT_0206 = 0.666666666666667*IT_0205;
    const ccomplex_t IT_0207 = IT_0204*IT_0206;
    const ccomplex_t IT_0208 = cpow((-2)*s_13 + IT_0007 + IT_0144 + -m_sc_R*
    ...
    const ccomplex_t IT_0211 = cos(beta);
    const ccomplex_t IT_0212 = cpow(IT_0013, -2);
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0018 + (-0.5)*m_W*(IT_0001*IT_0018 + -IT_0012*IT_0211)
      *(IT_0004 + -1./3*IT_0003*IT_0212));
    const ccomplex_t IT_0214 = -IT_0213;
    const ccomplex_t IT_0215 = IT_0006*IT_0214;
    const ccomplex_t IT_0216 = cpow((-2)*s_13 + IT_0007 + IT_0144 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0217 = IT_0215*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*IT_0217;
    const ccomplex_t IT_0219 = IT_0041 + IT_0092 + IT_0143 + (-2)*IT_0151 +
       IT_0202 + IT_0210 + IT_0218;
    ...
    const ccomplex_t IT_0273 = m_N_2*IT_0118;
    const ccomplex_t IT_0274 = m_N_4*IT_0140;
    const ccomplex_t IT_0275 = IT_0273 + IT_0274;
    const ccomplex_t IT_0276 = IT_0272*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0278 = 0.5*IT_0277;
    const ccomplex_t IT_0279 = IT_0204*IT_0278;
    const ccomplex_t IT_0280 = IT_0208*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = IT_0214*IT_0227;
    const ccomplex_t IT_0283 = IT_0216*IT_0282;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = 2*IT_0231 + -IT_0245 + -IT_0259 + -IT_0262 + 
      -IT_0276 + -IT_0281 + -IT_0284;
    const ccomplex_t IT_0286 = 6*s_13;
    const ccomplex_t IT_0287 = m_c*m_N_2;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0067*IT_0241;
    const ccomplex_t IT_0290 = IT_0177*IT_0255;
    const ccomplex_t IT_0291 = IT_0118*IT_0272;
    const ccomplex_t IT_0292 = IT_0028*IT_0261;
    const ccomplex_t IT_0293 = -IT_0150 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_c*s_14;
    const ccomplex_t IT_0295 = IT_0011*IT_0038;
    const ccomplex_t IT_0296 = IT_0046*IT_0089;
    const ccomplex_t IT_0297 = IT_0156*IT_0199;
    const ccomplex_t IT_0298 = IT_0097*IT_0140;
