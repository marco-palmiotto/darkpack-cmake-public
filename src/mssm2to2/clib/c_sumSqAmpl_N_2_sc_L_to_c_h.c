...
ccomplex_return_t c_sumSqAmpl_N_2_sc_L_to_c_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1)*m_c*e_em*IT_0004*IT_0006
      *IT_0008*IT_0011;
    const ccomplex_t IT_0013 = (-0.5)*IT_0012;
    const ccomplex_t IT_0014 = IT_0010*IT_0013;
    const ccomplex_t IT_0015 = IT_0003*IT_0014;
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*IT_0015;
    const ccomplex_t IT_0017 = m_c*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0019 = (-0.5)*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_3*
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0004*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0094 = N_W2*N_u4*e_em;
    ...
    const ccomplex_t IT_0103 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0104 = IT_0025*IT_0103;
    const ccomplex_t IT_0105 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0106 = IT_0029*IT_0105;
    const ccomplex_t IT_0107 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0108 = IT_0025*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0116 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0117 = IT_0037*IT_0116;
    const ccomplex_t IT_0118 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0004
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0136 = cpow(IT_0023, -2);
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0004
      *IT_0006*IT_0008*IT_0011 + (-0.5)*m_W*(IT_0005*IT_0011 + IT_0028*IT_0135)*
      (IT_0008 + -1./3*IT_0007*IT_0136));
    const ccomplex_t IT_0138 = -IT_0137;
    const ccomplex_t IT_0139 = IT_0010*IT_0138;
    const ccomplex_t IT_0140 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
    ...
    const ccomplex_t IT_0146 = IT_0029*IT_0145;
    ...
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0199 = IT_0029*IT_0198;
    const ccomplex_t IT_0200 = IT_0193 + IT_0195 + IT_0197 + IT_0199;
    const ccomplex_t IT_0201 = conj(N_W1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0205 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0217 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0221 = (-2)*IT_0017 + IT_0075 + IT_0126 + IT_0134 +
    ...
    const ccomplex_t IT_0252 = m_N_2*IT_0050;
    const ccomplex_t IT_0253 = m_N_3*IT_0072;
    const ccomplex_t IT_0254 = IT_0252 + IT_0253;
    const ccomplex_t IT_0255 = IT_0251*IT_0254;
    const ccomplex_t IT_0256 = IT_0166*IT_0229;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0165*IT_0257;
    const ccomplex_t IT_0259 = conj(N_B1)*e_em;
    const ccomplex_t IT_0260 = IT_0024*IT_0259;
    const ccomplex_t IT_0261 = 1.4142135623731*IT_0260;
    const ccomplex_t IT_0262 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0267 = IT_0217*IT_0266;
    const ccomplex_t IT_0268 = (0 + _Complex_I*1)*IT_0267;
    const ccomplex_t IT_0269 = m_N_2*IT_0190;
    const ccomplex_t IT_0270 = m_N_1*IT_0212;
    const ccomplex_t IT_0271 = IT_0269 + IT_0270;
    const ccomplex_t IT_0272 = IT_0268*IT_0271;
    const ccomplex_t IT_0273 = m_N_2*IT_0101;
    const ccomplex_t IT_0274 = m_N_4*IT_0123;
    const ccomplex_t IT_0275 = IT_0273 + IT_0274;
    const ccomplex_t IT_0276 = conj(N_B4)*e_em;
    const ccomplex_t IT_0277 = IT_0024*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0287 = 2*IT_0233 + -IT_0236 + -IT_0241 + -IT_0255 + 
      -IT_0258 + -IT_0272 + -IT_0286;
    const ccomplex_t IT_0288 = 6*s_13;
    const ccomplex_t IT_0289 = m_c*m_N_2;
    const ccomplex_t IT_0290 = 6*IT_0221;
    const ccomplex_t IT_0291 = IT_0050*IT_0251;
    const ccomplex_t IT_0292 = IT_0152*IT_0257;
    const ccomplex_t IT_0293 = IT_0190*IT_0268;
    const ccomplex_t IT_0294 = IT_0101*IT_0285;
    ...
    const ccomplex_t IT_0298 = IT_0163*IT_0168;
    const ccomplex_t IT_0299 = IT_0212*IT_0219;
    const ccomplex_t IT_0300 = IT_0022*IT_0072;
    ...
    const ccomplex_t IT_0306 = m_c*m_N_2*IT_0305;
