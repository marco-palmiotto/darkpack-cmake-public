...
ccomplex_return_t c_sumSqAmpl_N_2_sc_R_to_c_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
    ...
    const ccomplex_t IT_0016 = (-1.33333333333333)*IT_0011;
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0034 = (-0.666666666666667)*IT_0011;
    ...
    const ccomplex_t IT_0042 = m_c*s_14*m_N_2;
    ...
    const ccomplex_t IT_0052 = m_c*m_N_2;
    ...
    const ccomplex_t IT_0057 = m_c*s_34*m_N_2;
