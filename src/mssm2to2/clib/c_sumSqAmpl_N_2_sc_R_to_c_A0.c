        ...
        )
{
    ...
    const ccomplex_t IT_0191 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
    ...
    const ccomplex_t IT_0201 = IT_0089*IT_0200;
    ...
    const ccomplex_t IT_0208 = m_N_2*IT_0109;
    const ccomplex_t IT_0209 = m_N_3*IT_0127;
    const ccomplex_t IT_0210 = IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = IT_0207*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0216 = m_N_2*IT_0157;
    const ccomplex_t IT_0217 = m_N_4*IT_0175;
    ...
    const ccomplex_t IT_0224 = IT_0036*IT_0194;
    const ccomplex_t IT_0225 = IT_0109*IT_0207;
    ...
    const ccomplex_t IT_0232 = IT_0157*IT_0215;
    const ccomplex_t IT_0233 = IT_0066*IT_0202;
    ...
    const ccomplex_t IT_0237 = IT_0192*IT_0228;
    ...
    const ccomplex_t IT_0242 = IT_0127*IT_0134;
