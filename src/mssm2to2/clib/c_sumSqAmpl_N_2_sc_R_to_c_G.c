...
ccomplex_return_t c_sumSqAmpl_N_2_sc_R_to_c_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = -IT_0027;
    const ccomplex_t IT_0041 = m_c*s_14*m_N_2;
    ...
    const ccomplex_t IT_0048 = IT_0001*IT_0037;
    const ccomplex_t IT_0049 = pow(s_13, 2);
    const ccomplex_t IT_0050 = (-8)*IT_0049;
    const ccomplex_t IT_0051 = m_c*m_N_2;
    ...
    const ccomplex_t IT_0055 = (conj(IT_0020)*IT_0031 + IT_0020*conj(IT_0031))
      *IT_0032 + IT_0037*(conj(IT_0020)*IT_0030 + IT_0020*conj(IT_0030) + conj
      (IT_0031)*IT_0039 + IT_0031*conj(IT_0039)) + (conj(IT_0030)*IT_0034 +
       IT_0030*conj(IT_0034) + conj(IT_0036)*IT_0039 + IT_0036*conj(IT_0039))
      *IT_0052 + (conj(IT_0031)*IT_0034 + IT_0031*conj(IT_0034) + conj(IT_0020)
      *IT_0036 + IT_0020*conj(IT_0036))*IT_0053 + (conj(IT_0030)*IT_0039 +
       IT_0030*conj(IT_0039))*IT_0054;
    const ccomplex_t IT_0056 = m_c*s_34*m_N_2;
    ...
    const ccomplex_t IT_0065 = s_13*(IT_0020*conj(IT_0020) + IT_0031*conj
      ...
      (IT_0040*IT_0041 + (-0.125)*IT_0014*IT_0046 + (-0.125)*IT_0034*IT_0047 + (
      -0.125)*IT_0039*IT_0048 + (-0.125)*IT_0020*IT_0050) + IT_0039*(conj
      (IT_0034)*IT_0047 + conj(IT_0020)*IT_0050) + (-8)*conj(IT_0030)*(IT_0014
      *IT_0041 + (-0.125)*IT_0040*IT_0046 + (-0.125)*IT_0036*IT_0047 + (-0.125)
      *IT_0030*IT_0048 + (-0.125)*IT_0031*IT_0050) + IT_0030*(conj(IT_0036)
      *IT_0047 + conj(IT_0031)*IT_0050) + IT_0051*IT_0055 + IT_0014*(IT_0057
      *IT_0058 + IT_0056*IT_0059) + IT_0040*(IT_0056*IT_0057 + IT_0058*IT_0059) 
      + (-8)*conj(IT_0014)*(IT_0030*IT_0041 + (-0.125)*IT_0039*IT_0046 + (-4)
      *IT_0014*IT_0060 + IT_0062*IT_0063 + IT_0061*IT_0064) + (-8)*conj(IT_0040)
      *(IT_0039*IT_0041 + (-0.125)*IT_0030*IT_0046 + (-4)*IT_0040*IT_0060 +
