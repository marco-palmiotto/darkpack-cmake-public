...
ccomplex_return_t c_sumSqAmpl_N_2_sc_R_to_c_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sc_R*
    ...
    const ccomplex_t IT_0220 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
    ...
    const ccomplex_t IT_0229 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0259 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0269 = m_c*m_N_2;
    ...
    const ccomplex_t IT_0286 = m_c*m_N_2*IT_0285;
