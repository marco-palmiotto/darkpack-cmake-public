        ...
        )
{
    ...
    const ccomplex_t IT_0027 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0028 = IT_0010*IT_0027;
    const ccomplex_t IT_0029 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0030 = IT_0014*IT_0029;
    const ccomplex_t IT_0031 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0032 = IT_0019*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0034 = IT_0022*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*(IT_0028 + -IT_0030 + 
      -IT_0032 + IT_0034);
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0045 = IT_0010*IT_0044;
    const ccomplex_t IT_0046 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0047 = IT_0022*IT_0046;
    const ccomplex_t IT_0048 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0049 = IT_0010*IT_0048;
    const ccomplex_t IT_0050 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0051 = IT_0022*IT_0050;
    const ccomplex_t IT_0052 = IT_0045 + IT_0047 + IT_0049 + IT_0051;
    const ccomplex_t IT_0053 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0054 = IT_0014*IT_0053;
    const ccomplex_t IT_0055 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0056 = IT_0019*IT_0055;
    const ccomplex_t IT_0057 = N_B1*N_u2*e_em;
    ...
    const ccomplex_t IT_0066 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0067 = IT_0010*IT_0066;
    const ccomplex_t IT_0068 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0069 = IT_0022*IT_0068;
    const ccomplex_t IT_0070 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0071 = IT_0010*IT_0070;
    const ccomplex_t IT_0072 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0073 = IT_0022*IT_0072;
    const ccomplex_t IT_0074 = IT_0067 + IT_0069 + IT_0071 + IT_0073;
    const ccomplex_t IT_0075 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0079 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0092 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_4*
    ...
    const ccomplex_t IT_0098 = IT_0022*IT_0097;
    ...
    const ccomplex_t IT_0104 = N_B4*N_u2*e_em;
    ...
    const ccomplex_t IT_0110 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0128 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0129 = IT_0019*IT_0128;
    const ccomplex_t IT_0130 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0131 = IT_0014*IT_0130;
    const ccomplex_t IT_0132 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0141 = pow(m_N_2, 2);
    const ccomplex_t IT_0142 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0141 
      + -reg_prop, -1);
    const ccomplex_t IT_0143 = pow(m_W, -1);
    const ccomplex_t IT_0144 = sin(beta);
    const ccomplex_t IT_0145 = cpow(IT_0144, -1);
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_c*e_em*IT_0013*IT_0018
      *IT_0143*IT_0145;
    const ccomplex_t IT_0147 = (-0.5)*IT_0146;
    const ccomplex_t IT_0148 = IT_0003*IT_0147;
    const ccomplex_t IT_0149 = IT_0142*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*IT_0149;
    const ccomplex_t IT_0151 = m_c*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0001;
    const ccomplex_t IT_0153 = 0.666666666666667*IT_0152;
    const ccomplex_t IT_0154 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_3*
    ...
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0009
      *IT_0018*IT_0143*IT_0145;
    const ccomplex_t IT_0204 = 0.5*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0018*IT_0143*IT_0145;
    const ccomplex_t IT_0206 = (-0.5)*IT_0205;
    const ccomplex_t IT_0207 = IT_0204*IT_0206;
    const ccomplex_t IT_0208 = cpow((-2)*s_13 + IT_0004 + IT_0141 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0209 = IT_0207*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*IT_0209;
    const ccomplex_t IT_0211 = cpow(IT_0000, -2);
    const ccomplex_t IT_0212 = cos(beta);
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*e_em*(1.5*IT_0004*IT_0013
      *IT_0018*IT_0143*IT_0145 + -m_W*IT_0017*IT_0211*(IT_0013*IT_0144 + 
      -IT_0009*IT_0212));
    const ccomplex_t IT_0214 = (-0.666666666666667)*IT_0213;
    const ccomplex_t IT_0215 = IT_0003*IT_0214;
    const ccomplex_t IT_0216 = cpow((-2)*s_13 + IT_0004 + IT_0141 + -m_sc_R*
    ...
    const ccomplex_t IT_0226 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0018*IT_0143*IT_0145;
    const ccomplex_t IT_0227 = 0.5*IT_0226;
    const ccomplex_t IT_0228 = IT_0041*IT_0227;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = m_N_2*IT_0064;
    const ccomplex_t IT_0231 = m_N_1*IT_0086;
    const ccomplex_t IT_0232 = IT_0230 + IT_0231;
    const ccomplex_t IT_0233 = IT_0229*IT_0232;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0018*IT_0143*IT_0145;
    ...
    const ccomplex_t IT_0238 = m_N_2*IT_0177;
    const ccomplex_t IT_0239 = m_N_3*IT_0199;
    const ccomplex_t IT_0240 = IT_0238 + IT_0239;
    const ccomplex_t IT_0241 = IT_0237*IT_0240;
    const ccomplex_t IT_0242 = IT_0006*IT_0221;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*IT_0242;
    const ccomplex_t IT_0244 = IT_0037*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0018*IT_0143*IT_0145;
    const ccomplex_t IT_0246 = 0.5*IT_0245;
    const ccomplex_t IT_0247 = IT_0092*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = m_N_2*IT_0115;
    const ccomplex_t IT_0250 = m_N_4*IT_0137;
    ...
    const ccomplex_t IT_0262 = IT_0208*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1)*IT_0262;
    const ccomplex_t IT_0264 = IT_0214*IT_0221;
    ...
    const ccomplex_t IT_0271 = IT_0064*IT_0229;
    const ccomplex_t IT_0272 = IT_0177*IT_0237;
    const ccomplex_t IT_0273 = IT_0115*IT_0248;
    const ccomplex_t IT_0274 = IT_0025*IT_0243;
    const ccomplex_t IT_0275 = -IT_0150 + IT_0271 + IT_0272 + IT_0273 + IT_0274;
    const ccomplex_t IT_0276 = m_c*s_14;
    const ccomplex_t IT_0277 = IT_0008*IT_0035;
    const ccomplex_t IT_0278 = IT_0043*IT_0086;
    const ccomplex_t IT_0279 = IT_0156*IT_0199;
