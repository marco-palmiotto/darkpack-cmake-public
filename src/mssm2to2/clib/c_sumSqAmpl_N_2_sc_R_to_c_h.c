...
ccomplex_return_t c_sumSqAmpl_N_2_sc_R_to_c_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0005;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0008
      *IT_0011*IT_0013*IT_0028;
    const ccomplex_t IT_0128 = (-0.5)*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0008*IT_0011*IT_0013;
    const ccomplex_t IT_0130 = (-0.5)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0133 = IT_0131*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*IT_0133;
    const ccomplex_t IT_0135 = cpow(IT_0004, -2);
    const ccomplex_t IT_0136 = cos(beta);
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0008
      *IT_0009*IT_0011*IT_0013 + m_W*IT_0012*IT_0135*(IT_0009*IT_0010 + IT_0028
      *IT_0136));
    const ccomplex_t IT_0138 = 0.666666666666667*IT_0137;
    const ccomplex_t IT_0139 = IT_0007*IT_0138;
    const ccomplex_t IT_0140 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
    ...
    const ccomplex_t IT_0228 = IT_0138*IT_0223;
    const ccomplex_t IT_0229 = IT_0140*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = conj(N_B2)*e_em;
    const ccomplex_t IT_0232 = IT_0005*IT_0231;
    const ccomplex_t IT_0233 = 1.4142135623731*IT_0232;
    const ccomplex_t IT_0234 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0242 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0246 = m_N_2*IT_0050;
    const ccomplex_t IT_0247 = m_N_3*IT_0072;
    ...
    const ccomplex_t IT_0253 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0257 = m_N_2*IT_0190;
    const ccomplex_t IT_0258 = m_N_1*IT_0212;
    const ccomplex_t IT_0259 = IT_0257 + IT_0258;
    const ccomplex_t IT_0260 = IT_0256*IT_0259;
    const ccomplex_t IT_0261 = m_N_2*IT_0101;
    const ccomplex_t IT_0262 = m_N_4*IT_0123;
    const ccomplex_t IT_0263 = IT_0261 + IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0008*IT_0011*IT_0013;
    const ccomplex_t IT_0265 = 0.5*IT_0264;
    const ccomplex_t IT_0266 = IT_0078*IT_0265;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*IT_0266;
    const ccomplex_t IT_0268 = IT_0263*IT_0267;
    const ccomplex_t IT_0269 = 2*IT_0227 + -IT_0230 + -IT_0241 + -IT_0249 + 
      -IT_0252 + -IT_0260 + -IT_0268;
    const ccomplex_t IT_0270 = 6*s_13;
    const ccomplex_t IT_0271 = m_c*m_N_2;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0050*IT_0245;
    const ccomplex_t IT_0274 = IT_0152*IT_0251;
    const ccomplex_t IT_0275 = IT_0190*IT_0256;
    const ccomplex_t IT_0276 = IT_0101*IT_0267;
    ...
    const ccomplex_t IT_0282 = IT_0024*IT_0072;
    ...
    const ccomplex_t IT_0288 = m_c*m_N_2*IT_0287;
