        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0002
      *IT_0005*IT_0011*IT_0018 + m_W*IT_0004*IT_0017*(IT_0001*IT_0018 + IT_0003
      *IT_0019));
    ...
    const ccomplex_t IT_0043 = IT_0003*IT_0022;
    const ccomplex_t IT_0044 = N_B2*N_d2*e_em;
    ...
    const ccomplex_t IT_0049 = IT_0003*IT_0005;
    const ccomplex_t IT_0050 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0056 = IT_0040*IT_0055;
    const ccomplex_t IT_0057 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0058 = IT_0043*IT_0057;
    const ccomplex_t IT_0059 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0065 = m_N_2*IT_0064;
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0011 + IT_0029 + -m_N_1*
    ...
    const ccomplex_t IT_0121 = cpow((-2)*s_23 + IT_0011 + IT_0029 + -m_N_3*
    ...
    const ccomplex_t IT_0177 = IT_0043*IT_0176;
    ...
    const ccomplex_t IT_0195 = IT_0043*IT_0194;
    ...
    const ccomplex_t IT_0199 = IT_0043*IT_0198;
    ...
    const ccomplex_t IT_0217 = cpow((-2)*s_23 + IT_0011 + IT_0029 + -m_N_4*
    ...
    const ccomplex_t IT_0221 = IT_0015 + IT_0028 + (-2)*IT_0036 + IT_0067 +
    ...
    const ccomplex_t IT_0228 = m_N_2*IT_0093;
    const ccomplex_t IT_0229 = m_N_1*IT_0115;
    const ccomplex_t IT_0230 = IT_0228 + IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0248 = 0.5*IT_0247;
    const ccomplex_t IT_0249 = IT_0121*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*IT_0249;
    const ccomplex_t IT_0251 = m_N_3*IT_0166;
    const ccomplex_t IT_0252 = m_N_2*IT_0144;
    const ccomplex_t IT_0253 = IT_0251 + IT_0252;
    const ccomplex_t IT_0254 = IT_0250*IT_0253;
    const ccomplex_t IT_0255 = IT_0021*IT_0223;
    const ccomplex_t IT_0256 = IT_0026*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0037*IT_0223;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*IT_0258;
    const ccomplex_t IT_0260 = IT_0066*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0265 = m_N_2*IT_0190;
    const ccomplex_t IT_0266 = m_N_4*IT_0212;
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = IT_0264*IT_0267;
    const ccomplex_t IT_0269 = 2*IT_0227 + -IT_0235 + -IT_0246 + -IT_0254 + 
    ...
    const ccomplex_t IT_0273 = IT_0093*IT_0234;
    const ccomplex_t IT_0274 = IT_0053*IT_0259;
    const ccomplex_t IT_0275 = IT_0144*IT_0250;
    const ccomplex_t IT_0276 = IT_0190*IT_0264;
    const ccomplex_t IT_0277 = -IT_0035 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_c*s_14;
    const ccomplex_t IT_0279 = IT_0039*IT_0064;
    const ccomplex_t IT_0280 = IT_0072*IT_0115;
    const ccomplex_t IT_0281 = IT_0123*IT_0166;
    const ccomplex_t IT_0282 = IT_0212*IT_0219;
