...
ccomplex_return_t c_sumSqAmpl_N_2_sc_R_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_s*m_N_2*IT_0000;
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
    ...
    const ccomplex_t IT_0078 = m_s*m_N_2;
    ...
    const ccomplex_t IT_0124 = cpow((-2)*s_13 + IT_0003 + IT_0029 + -m_ss_L*
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0005*IT_0009*IT_0013;
    const ccomplex_t IT_0130 = 0.5*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0003 + IT_0029 + -m_ss_R*
