        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_C_1*
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_12 + -IT_0016 + IT_0034 + -IT_0035 
      + -reg_prop, -1);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_c;
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0004;
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = IT_0041*IT_0043;
    const ccomplex_t IT_0045 = IT_0036*IT_0037*IT_0044;
    const ccomplex_t IT_0046 = N_W2*e_em*conj(U_Wm1);
    const ccomplex_t IT_0047 = IT_0004*IT_0046;
    const ccomplex_t IT_0048 = N_d2*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0055 = IT_0030*IT_0053*IT_0054;
    const ccomplex_t IT_0056 = N_W2*e_em*conj(U_Wm2);
    const ccomplex_t IT_0057 = IT_0004*IT_0056;
    const ccomplex_t IT_0058 = N_d2*conj(U_d2)*e_em;
