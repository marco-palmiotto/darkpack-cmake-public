...
ccomplex_return_t c_sumSqAmpl_N_2_sd_L_to_d_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = 0.666666666666667*IT_0016;
    const ccomplex_t IT_0022 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0023 = IT_0015*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*IT_0023;
    const ccomplex_t IT_0025 = IT_0021*IT_0024;
    const ccomplex_t IT_0026 = 2*IT_0020 + IT_0025;
    ...
    const ccomplex_t IT_0039 = (-6)*IT_0000;
    const ccomplex_t IT_0040 = 0.333333333333333*IT_0016;
    const ccomplex_t IT_0041 = IT_0024*IT_0040;
    const ccomplex_t IT_0042 = IT_0036*IT_0040;
    const ccomplex_t IT_0043 = -IT_0042;
    const ccomplex_t IT_0044 = (-6)*s_13;
    const ccomplex_t IT_0045 = s_34*IT_0044;
    const ccomplex_t IT_0046 = -IT_0025;
    const ccomplex_t IT_0047 = -IT_0034;
    const ccomplex_t IT_0048 = m_d*s_14*m_N_2;
    ...
    const ccomplex_t IT_0055 = IT_0001*IT_0044;
    const ccomplex_t IT_0056 = pow(s_13, 2);
    const ccomplex_t IT_0057 = (-6)*IT_0056;
    const ccomplex_t IT_0058 = m_d*m_N_2;
    const ccomplex_t IT_0059 = (-6)*s_14;
    const ccomplex_t IT_0060 = (-6)*s_34;
    const ccomplex_t IT_0061 = (-6)*IT_0001;
    const ccomplex_t IT_0062 = (conj(IT_0026)*IT_0038 + IT_0026*conj(IT_0038))
      *IT_0039 + IT_0044*(conj(IT_0026)*IT_0037 + IT_0026*conj(IT_0037) + conj
      (IT_0038)*IT_0046 + IT_0038*conj(IT_0046)) + (conj(IT_0037)*IT_0041 +
       IT_0037*conj(IT_0041) + conj(IT_0043)*IT_0046 + IT_0043*conj(IT_0046))
      *IT_0059 + (conj(IT_0038)*IT_0041 + IT_0038*conj(IT_0041) + conj(IT_0026)
      *IT_0043 + IT_0026*conj(IT_0043))*IT_0060 + (conj(IT_0037)*IT_0046 +
       IT_0037*conj(IT_0046))*IT_0061;
    const ccomplex_t IT_0063 = m_d*s_34*m_N_2;
    const ccomplex_t IT_0064 = (-6)*conj(IT_0026);
    const ccomplex_t IT_0065 = s_14*IT_0000;
    ...
    const ccomplex_t IT_0072 = s_13*(IT_0026*conj(IT_0026) + IT_0038*conj
      ...
      (IT_0047*IT_0048 + (-0.166666666666667)*IT_0020*IT_0053 + (
      ...
      + conj(IT_0026)*IT_0057) + (-6)*conj(IT_0037)*(IT_0020*IT_0048 + (
      -0.166666666666667)*IT_0047*IT_0053 + (-0.166666666666667)*IT_0043*IT_0054
       + (-0.166666666666667)*IT_0037*IT_0055 + (-0.166666666666667)*IT_0038
      *IT_0057) + IT_0037*(conj(IT_0043)*IT_0054 + conj(IT_0038)*IT_0057) +
       IT_0058*IT_0062 + IT_0020*(IT_0064*IT_0065 + IT_0063*IT_0066) + IT_0047*
      (IT_0063*IT_0064 + IT_0065*IT_0066) + (-6)*conj(IT_0020)*(IT_0037*IT_0048 
      + (-0.166666666666667)*IT_0046*IT_0053 + (-4)*IT_0020*IT_0067 + IT_0069
      *IT_0070 + IT_0068*IT_0071) + (-6)*conj(IT_0047)*(IT_0046*IT_0048 + (
      -0.166666666666667)*IT_0037*IT_0053 + (-4)*IT_0047*IT_0067 + IT_0068
