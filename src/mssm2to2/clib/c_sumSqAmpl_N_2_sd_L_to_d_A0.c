        ...
        )
{
    ...
    const ccomplex_t IT_0097 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0098 = IT_0028*IT_0097;
    const ccomplex_t IT_0099 = N_B3*N_d2*e_em;
    ...
    const ccomplex_t IT_0105 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0106 = IT_0028*IT_0105;
    const ccomplex_t IT_0107 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0108 = IT_0031*IT_0107;
    const ccomplex_t IT_0109 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0110 = IT_0034*IT_0109;
    const ccomplex_t IT_0111 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0115 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0116 = IT_0028*IT_0115;
    const ccomplex_t IT_0117 = conj(N_B2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0123 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0124 = IT_0028*IT_0123;
    const ccomplex_t IT_0125 = conj(N_B3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0245 = s_34*m_N_2;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
    ...
    const ccomplex_t IT_0266 = m_d*m_N_2;
