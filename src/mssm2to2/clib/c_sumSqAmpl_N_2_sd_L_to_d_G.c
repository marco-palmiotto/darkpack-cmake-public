...
ccomplex_return_t c_sumSqAmpl_N_2_sd_L_to_d_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sd_L*
    ...
    const ccomplex_t IT_0047 = m_d*s_14*m_N_2;
    ...
    const ccomplex_t IT_0057 = m_d*m_N_2;
    ...
    const ccomplex_t IT_0062 = m_d*s_34*m_N_2;
