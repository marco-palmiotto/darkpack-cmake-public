...
ccomplex_return_t c_sumSqAmpl_N_2_sd_L_to_d_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0001*IT_0003*IT_0006;
    const ccomplex_t IT_0024 = (-0.5)*IT_0023;
    const ccomplex_t IT_0025 = IT_0022*IT_0024;
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = IT_0000*IT_0010;
    const ccomplex_t IT_0030 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = IT_0004*IT_0006;
    const ccomplex_t IT_0033 = N_W2*N_u1*e_em;
    ...
    const ccomplex_t IT_0040 = IT_0004*IT_0010;
    const ccomplex_t IT_0041 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = IT_0000*IT_0006;
    const ccomplex_t IT_0044 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0047 = IT_0040*IT_0046;
    const ccomplex_t IT_0048 = N_W1*N_d2*e_em;
    const ccomplex_t IT_0049 = IT_0043*IT_0048;
    const ccomplex_t IT_0050 = -IT_0042 + -IT_0045 + -IT_0047 + -IT_0049;
    const ccomplex_t IT_0051 = IT_0039 + IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = m_N_1*IT_0053;
    const ccomplex_t IT_0055 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0056 = IT_0029*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0058 = IT_0032*IT_0057;
    const ccomplex_t IT_0059 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0060 = IT_0029*IT_0059;
    const ccomplex_t IT_0061 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0062 = IT_0032*IT_0061;
    const ccomplex_t IT_0063 = IT_0056 + IT_0058 + IT_0060 + IT_0062;
    const ccomplex_t IT_0064 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0065 = IT_0040*IT_0064;
    const ccomplex_t IT_0066 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0067 = IT_0043*IT_0066;
    const ccomplex_t IT_0068 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0069 = IT_0040*IT_0068;
    const ccomplex_t IT_0070 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0102 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0103 = IT_0029*IT_0102;
    const ccomplex_t IT_0104 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0105 = IT_0040*IT_0104;
    const ccomplex_t IT_0106 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0107 = IT_0043*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0014 + IT_0080 + -m_N_2*
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0001*IT_0003*IT_0006;
    const ccomplex_t IT_0118 = (-0.5)*IT_0117;
    const ccomplex_t IT_0119 = cpow((-2)*s_23 + IT_0014 + IT_0080 + -m_N_3*
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0001*IT_0003*IT_0006;
    const ccomplex_t IT_0169 = (-0.5)*IT_0168;
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0014 + IT_0080 + -m_N_4*
    ...
    const ccomplex_t IT_0178 = IT_0029*IT_0177;
    ...
    const ccomplex_t IT_0185 = IT_0043*IT_0184;
    ...
    const ccomplex_t IT_0207 = IT_0043*IT_0206;
    ...
    const ccomplex_t IT_0219 = IT_0018 + IT_0028 + IT_0084 + (-2)*IT_0091 +
    ...
    const ccomplex_t IT_0228 = IT_0086*IT_0227;
    const ccomplex_t IT_0229 = IT_0088*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = m_d*IT_0230;
    const ccomplex_t IT_0232 = IT_0022*IT_0227;
    const ccomplex_t IT_0233 = IT_0026*IT_0232;
    ...
    const ccomplex_t IT_0239 = IT_0006*IT_0238;
    ...
    const ccomplex_t IT_0263 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
    ...
    const ccomplex_t IT_0268 = IT_0113*IT_0227;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0112*IT_0269;
    const ccomplex_t IT_0271 = conj(N_B3)*e_em;
    const ccomplex_t IT_0272 = IT_0010*IT_0271;
    const ccomplex_t IT_0273 = 1.4142135623731*IT_0272;
    const ccomplex_t IT_0274 = conj(N_W3)*e_em;
    const ccomplex_t IT_0275 = IT_0006*IT_0274;
    ...
    const ccomplex_t IT_0281 = m_N_2*IT_0142;
    const ccomplex_t IT_0282 = m_N_3*IT_0164;
    const ccomplex_t IT_0283 = IT_0281 + IT_0282;
    const ccomplex_t IT_0284 = IT_0280*IT_0283;
    const ccomplex_t IT_0285 = 2*IT_0231 + -IT_0234 + -IT_0248 + -IT_0262 + 
      -IT_0267 + -IT_0270 + -IT_0284;
    const ccomplex_t IT_0286 = 6*s_13;
    const ccomplex_t IT_0287 = m_d*m_N_2;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0142*IT_0280;
    const ccomplex_t IT_0290 = IT_0193*IT_0261;
    const ccomplex_t IT_0291 = IT_0100*IT_0269;
    const ccomplex_t IT_0292 = IT_0053*IT_0244;
    const ccomplex_t IT_0293 = -IT_0090 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_d*s_14;
    const ccomplex_t IT_0295 = IT_0172*IT_0215;
    const ccomplex_t IT_0296 = IT_0110*IT_0115;
    const ccomplex_t IT_0297 = IT_0075*IT_0083;
    const ccomplex_t IT_0298 = IT_0121*IT_0164;
    ...
    const ccomplex_t IT_0304 = m_d*m_N_2*IT_0303;
