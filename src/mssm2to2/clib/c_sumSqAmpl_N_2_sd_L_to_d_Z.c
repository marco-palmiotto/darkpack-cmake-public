        ...
        )
{
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0003*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0003*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0156 = m_d*m_N_2;
    ...
    const ccomplex_t IT_0163 = m_d*IT_0081;
    ...
    const ccomplex_t IT_0205 = m_d*IT_0204;
    ...
    const ccomplex_t IT_0245 = m_d*IT_0244;
    ...
    const ccomplex_t IT_0270 = m_d*IT_0232;
