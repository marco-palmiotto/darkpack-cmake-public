        ...
        )
{
    ...
    const ccomplex_t IT_0016 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = sin(alpha);
    const ccomplex_t IT_0019 = IT_0014*IT_0018;
    const ccomplex_t IT_0020 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0023 = IT_0015*IT_0022;
    const ccomplex_t IT_0024 = N_B2*N_d3*e_em;
    ...
    const ccomplex_t IT_0046 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0047 = IT_0015*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0084 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0085 = IT_0027*IT_0084;
    const ccomplex_t IT_0086 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0093 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0094 = IT_0015*IT_0093;
    const ccomplex_t IT_0095 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0096 = IT_0019*IT_0095;
    const ccomplex_t IT_0097 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0098 = IT_0015*IT_0097;
    const ccomplex_t IT_0099 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0100 = IT_0019*IT_0099;
    const ccomplex_t IT_0101 = IT_0094 + IT_0096 + IT_0098 + IT_0100;
    const ccomplex_t IT_0102 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0103 = IT_0027*IT_0102;
    const ccomplex_t IT_0104 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0105 = IT_0030*IT_0104;
    const ccomplex_t IT_0106 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0107 = IT_0027*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*(m_d*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0018 + (-0.5)*m_W*(IT_0001*IT_0018 + IT_0012*IT_0126)*
      (IT_0004 + 1./3*IT_0003*IT_0127));
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0130 = (-0.5)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0007 + IT_0122 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0133 = IT_0131*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*m_d*e_em*IT_0000*IT_0002
      *IT_0004*IT_0018;
    const ccomplex_t IT_0136 = 0.5*IT_0135;
    const ccomplex_t IT_0137 = IT_0130*IT_0136;
    const ccomplex_t IT_0138 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0122 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0153 = conj(N_B2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0157 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0170 = (-0.5)*IT_0169;
    const ccomplex_t IT_0171 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
    ...
    const ccomplex_t IT_0220 = IT_0065 + IT_0116 + IT_0125 + IT_0134 + (-2)
      *IT_0141 + IT_0168 + IT_0219;
    ...
    const ccomplex_t IT_0243 = m_N_3*IT_0062;
    const ccomplex_t IT_0244 = m_N_2*IT_0040;
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = IT_0242*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0248 = 0.5*IT_0247;
    const ccomplex_t IT_0249 = IT_0118*IT_0248;
    const ccomplex_t IT_0250 = IT_0123*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = IT_0128*IT_0228;
    const ccomplex_t IT_0253 = IT_0132*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = IT_0165*IT_0228;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0164*IT_0256;
    const ccomplex_t IT_0258 = m_N_2*IT_0194;
    const ccomplex_t IT_0259 = m_N_1*IT_0216;
    const ccomplex_t IT_0260 = IT_0258 + IT_0259;
    const ccomplex_t IT_0261 = conj(N_B1)*e_em;
    const ccomplex_t IT_0262 = IT_0014*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0280 = IT_0068*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = m_N_2*IT_0091;
    const ccomplex_t IT_0283 = m_N_4*IT_0113;
    const ccomplex_t IT_0284 = IT_0282 + IT_0283;
    const ccomplex_t IT_0285 = IT_0281*IT_0284;
    const ccomplex_t IT_0286 = 2*IT_0232 + -IT_0246 + -IT_0251 + -IT_0254 + 
    ...
    const ccomplex_t IT_0290 = IT_0151*IT_0256;
    const ccomplex_t IT_0291 = IT_0040*IT_0242;
    const ccomplex_t IT_0292 = IT_0091*IT_0281;
    const ccomplex_t IT_0293 = IT_0194*IT_0270;
    const ccomplex_t IT_0294 = -IT_0140 + IT_0290 + IT_0291 + IT_0292 + IT_0293;
    const ccomplex_t IT_0295 = m_d*s_14;
    const ccomplex_t IT_0296 = IT_0162*IT_0167;
    const ccomplex_t IT_0297 = IT_0173*IT_0216;
    const ccomplex_t IT_0298 = IT_0011*IT_0062;
    const ccomplex_t IT_0299 = IT_0070*IT_0113;
