...
ccomplex_return_t c_sumSqAmpl_N_2_sd_L_to_u_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0029 = IT_0024*IT_0025*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = N_d2*e_em*U_Wm1;
    const ccomplex_t IT_0033 = IT_0007*IT_0032;
    const ccomplex_t IT_0034 = (-2)*IT_0033;
    const ccomplex_t IT_0035 = N_B2*U_d1*e_em;
    const ccomplex_t IT_0036 = IT_0013*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = N_W2*U_d1*e_em;
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_C_1*
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0000*IT_0002*IT_0004*IT_0049;
    const ccomplex_t IT_0051 = 0.5*IT_0050;
    const ccomplex_t IT_0052 = cpow(IT_0049, -1);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0000*IT_0004*IT_0052;
    const ccomplex_t IT_0054 = (-0.5)*IT_0053;
    const ccomplex_t IT_0055 = IT_0051*IT_0054;
    const ccomplex_t IT_0056 = pow(m_d, 2);
    const ccomplex_t IT_0057 = pow(m_N_2, 2);
    const ccomplex_t IT_0058 = cpow((-2)*s_12 + -IT_0027 + IT_0056 + -IT_0057 
      + -reg_prop, -1);
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0060 = IT_0055*IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0004;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0004*((m_W*IT_0001 + (-0.5)*IT_0000*IT_0002*IT_0026)*IT_0049 + -1./2
      *IT_0000*IT_0001*IT_0052*IT_0056);
    const ccomplex_t IT_0079 = 0.5*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0081 = (-0.5)*IT_0080;
    const ccomplex_t IT_0082 = IT_0079*IT_0081;
    const ccomplex_t IT_0083 = cpow((-2)*s_13 + IT_0026 + IT_0057 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0000*IT_0004;
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0012;
    const ccomplex_t IT_0089 = 0.666666666666667*IT_0088;
    const ccomplex_t IT_0090 = IT_0087*IT_0089;
    const ccomplex_t IT_0091 = cpow((-2)*s_13 + IT_0026 + IT_0057 + -m_su_R*
    ...
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0004;
    const ccomplex_t IT_0095 = IT_0044*IT_0094;
    const ccomplex_t IT_0096 = IT_0047*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = m_u*IT_0097;
    const ccomplex_t IT_0099 = IT_0029 + IT_0048 + -IT_0060 + -IT_0065 +
       IT_0077 + IT_0085 + IT_0093 + -IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0000*IT_0001*IT_0004*IT_0052;
    ...
    const ccomplex_t IT_0106 = IT_0073*IT_0101;
    const ccomplex_t IT_0107 = IT_0058*IT_0059*IT_0106;
    const ccomplex_t IT_0108 = IT_0004*IT_0049;
    const ccomplex_t IT_0109 = conj(N_u2)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0110 = IT_0108*IT_0109;
    const ccomplex_t IT_0111 = 2*IT_0110;
    const ccomplex_t IT_0112 = IT_0012*IT_0049;
    const ccomplex_t IT_0113 = conj(N_B2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0114 = IT_0112*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = conj(N_W2)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0123 = IT_0094*IT_0122;
    const ccomplex_t IT_0124 = IT_0046*IT_0047*IT_0123;
    const ccomplex_t IT_0125 = conj(N_u2)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0126 = IT_0108*IT_0125;
    const ccomplex_t IT_0127 = 2*IT_0126;
    const ccomplex_t IT_0128 = conj(N_B2)*conj(V_u2)*e_em;
    const ccomplex_t IT_0129 = IT_0112*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = conj(N_W2)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0139 = IT_0025*IT_0028*IT_0138;
    const ccomplex_t IT_0140 = IT_0006*IT_0137;
    ...
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*(IT_0068 + 3*IT_0071);
    ...
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0150 = 0.5*IT_0149;
    const ccomplex_t IT_0151 = IT_0087*IT_0150;
    const ccomplex_t IT_0152 = IT_0091*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*IT_0152;
    const ccomplex_t IT_0154 = IT_0031*IT_0122;
    ...
    const ccomplex_t IT_0158 = -IT_0105 + IT_0107 + IT_0124 + IT_0139 + 
      -IT_0143 + -IT_0148 + -IT_0153 + -IT_0157;
    const ccomplex_t IT_0159 = 6*s_13;
    const ccomplex_t IT_0160 = m_u*m_N_2;
    const ccomplex_t IT_0161 = 6*IT_0099;
    const ccomplex_t IT_0162 = IT_0064 + IT_0097 + -IT_0104;
    const ccomplex_t IT_0163 = m_u*s_12;
    const ccomplex_t IT_0164 = IT_0076 + IT_0142 + IT_0156;
    const ccomplex_t IT_0165 = s_23*m_N_2;
    const ccomplex_t IT_0166 = 6*conj(IT_0099);
    const ccomplex_t IT_0167 = 6*conj(IT_0158);
    const ccomplex_t IT_0168 = m_u*m_N_2*IT_0027;
    const ccomplex_t IT_0169 = s_13*IT_0027;
