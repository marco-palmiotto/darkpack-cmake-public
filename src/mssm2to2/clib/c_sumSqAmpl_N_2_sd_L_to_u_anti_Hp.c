        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0000*IT_0002*IT_0015*IT_0017;
    const ccomplex_t IT_0019 = 0.5*IT_0018;
    const ccomplex_t IT_0020 = cpow(IT_0015, -1);
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0000*IT_0002*IT_0020;
    const ccomplex_t IT_0022 = (-0.5)*IT_0021;
    const ccomplex_t IT_0023 = IT_0019*IT_0022;
    const ccomplex_t IT_0024 = pow(m_d, 2);
    const ccomplex_t IT_0025 = pow(m_sd_L, 2);
    const ccomplex_t IT_0026 = cpow((-2)*s_12 + -IT_0011 + IT_0024 + -IT_0025 
      + -reg_prop, -1);
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0028 = IT_0023*IT_0026*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0002;
    const ccomplex_t IT_0030 = IT_0002*IT_0016;
    const ccomplex_t IT_0031 = N_d2*e_em*U_Wm1;
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0010 + IT_0025 + -m_C_1*
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0010 + IT_0025 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0065*IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0002;
    ...
    const ccomplex_t IT_0074 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0002*(IT_0015*(m_W*IT_0016 + (-0.5)*IT_0000*IT_0010*IT_0017) + -1./2
      *IT_0000*IT_0016*IT_0020*IT_0024);
    const ccomplex_t IT_0075 = 0.5*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0000*IT_0002*IT_0017;
    const ccomplex_t IT_0077 = (-0.5)*IT_0076;
    const ccomplex_t IT_0078 = IT_0075*IT_0077;
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0080 = IT_0078*IT_0079;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0000*IT_0002*IT_0017;
    ...
    const ccomplex_t IT_0086 = IT_0046*IT_0084*IT_0085;
    const ccomplex_t IT_0087 = conj(N_B2)*e_em;
    const ccomplex_t IT_0088 = IT_0006*IT_0087;
    const ccomplex_t IT_0089 = 1.4142135623731*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W2)*e_em;
    const ccomplex_t IT_0091 = IT_0002*IT_0090;
    ...
    const ccomplex_t IT_0099 = IT_0014 + -IT_0028 + -IT_0049 + IT_0068 + 
      -IT_0073 + IT_0081 + IT_0086 + IT_0098;
    const ccomplex_t IT_0100 = IT_0002*IT_0015;
    const ccomplex_t IT_0101 = conj(N_u2)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0102 = IT_0100*IT_0101;
    const ccomplex_t IT_0103 = 2*IT_0102;
    const ccomplex_t IT_0104 = IT_0006*IT_0015;
    const ccomplex_t IT_0105 = conj(N_B2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = 1.4142135623731*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W2)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0000*IT_0002*IT_0016*IT_0020;
    ...
    const ccomplex_t IT_0142 = IT_0029*IT_0114;
    const ccomplex_t IT_0143 = IT_0046*IT_0085*IT_0142;
    const ccomplex_t IT_0144 = IT_0094*IT_0137;
    const ccomplex_t IT_0145 = IT_0026*IT_0027*IT_0144;
    const ccomplex_t IT_0146 = IT_0069*IT_0131;
    const ccomplex_t IT_0147 = IT_0066*IT_0067*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*(IT_0089 + 3*IT_0092);
    const ccomplex_t IT_0149 = 0.166666666666667*IT_0148;
    const ccomplex_t IT_0150 = IT_0075*IT_0149;
    const ccomplex_t IT_0151 = IT_0079*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0017;
    ...
    const ccomplex_t IT_0158 = -IT_0118 + -IT_0135 + -IT_0141 + IT_0143 +
       IT_0145 + IT_0147 + -IT_0152 + -IT_0157;
    const ccomplex_t IT_0159 = 6*s_13;
    const ccomplex_t IT_0160 = m_u*m_N_2;
    const ccomplex_t IT_0161 = 6*IT_0099;
    const ccomplex_t IT_0162 = IT_0048 + IT_0072 + -IT_0140;
    const ccomplex_t IT_0163 = m_u*s_12;
    const ccomplex_t IT_0164 = IT_0097 + IT_0117 + IT_0134;
    const ccomplex_t IT_0165 = s_23*m_N_2;
    const ccomplex_t IT_0166 = 6*conj(IT_0099);
    const ccomplex_t IT_0167 = 6*conj(IT_0158);
    const ccomplex_t IT_0168 = m_u*m_N_2*IT_0025;
    const ccomplex_t IT_0169 = s_13*IT_0025;
