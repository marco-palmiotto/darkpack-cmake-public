...
ccomplex_return_t c_sumSqAmpl_N_2_sd_R_to_d_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
    ...
    const ccomplex_t IT_0023 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0024 = IT_0022*IT_0023;
    const ccomplex_t IT_0025 = IT_0005*IT_0021;
    const ccomplex_t IT_0026 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = IT_0001*IT_0010;
    const ccomplex_t IT_0029 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = IT_0001*IT_0005;
    const ccomplex_t IT_0032 = N_W2*N_d2*e_em;
    const ccomplex_t IT_0033 = IT_0031*IT_0032;
    const ccomplex_t IT_0034 = -IT_0024 + IT_0027 + IT_0030 + -IT_0033;
    const ccomplex_t IT_0035 = m_N_2*IT_0034;
    const ccomplex_t IT_0036 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0037 = IT_0022*IT_0036;
    const ccomplex_t IT_0038 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0039 = IT_0025*IT_0038;
    const ccomplex_t IT_0040 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0041 = IT_0028*IT_0040;
    const ccomplex_t IT_0042 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0049 = pow(m_sd_R, 2);
    const ccomplex_t IT_0050 = cpow((-2)*s_23 + IT_0015 + IT_0049 + -m_N_2*
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0021;
    const ccomplex_t IT_0092 = (-0.333333333333333)*IT_0091;
    const ccomplex_t IT_0093 = cpow((-2)*s_23 + IT_0015 + IT_0049 + -m_N_1*
    ...
    const ccomplex_t IT_0099 = cpow((-2)*s_23 + IT_0015 + IT_0049 + -m_N_3*
    ...
    const ccomplex_t IT_0120 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0126 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0127 = IT_0031*IT_0126;
    const ccomplex_t IT_0128 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0129 = IT_0022*IT_0128;
    const ccomplex_t IT_0130 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0131 = IT_0025*IT_0130;
    const ccomplex_t IT_0132 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0133 = IT_0028*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0139 = IT_0101*IT_0138;
    const ccomplex_t IT_0140 = N_B4*N_u2*e_em;
    ...
    const ccomplex_t IT_0150 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0151 = IT_0025*IT_0150;
    const ccomplex_t IT_0152 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0153 = IT_0028*IT_0152;
    const ccomplex_t IT_0154 = N_W2*N_d4*e_em;
    const ccomplex_t IT_0155 = IT_0031*IT_0154;
    ...
    const ccomplex_t IT_0162 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0163 = IT_0028*IT_0162;
    const ccomplex_t IT_0164 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0172 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0177 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0021;
    const ccomplex_t IT_0178 = (-0.333333333333333)*IT_0177;
    const ccomplex_t IT_0179 = cpow((-2)*s_23 + IT_0015 + IT_0049 + -m_N_4*
    ...
    const ccomplex_t IT_0195 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
    ...
    const ccomplex_t IT_0200 = m_N_2*IT_0070;
    const ccomplex_t IT_0201 = m_N_1*IT_0088;
    const ccomplex_t IT_0202 = IT_0200 + IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0204 = 0.5*IT_0203;
    const ccomplex_t IT_0205 = IT_0093*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*IT_0205;
    const ccomplex_t IT_0207 = IT_0202*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0212 = m_N_2*IT_0118;
    const ccomplex_t IT_0213 = m_N_3*IT_0136;
    const ccomplex_t IT_0214 = IT_0212 + IT_0213;
    const ccomplex_t IT_0215 = IT_0211*IT_0214;
    const ccomplex_t IT_0216 = m_N_2*IT_0156;
    const ccomplex_t IT_0217 = m_N_4*IT_0174;
    const ccomplex_t IT_0218 = IT_0216 + IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0226 = m_d*m_N_2;
    const ccomplex_t IT_0227 = 6*IT_0183;
    const ccomplex_t IT_0228 = IT_0118*IT_0211;
    const ccomplex_t IT_0229 = IT_0156*IT_0222;
    const ccomplex_t IT_0230 = m_d*e_em*IT_0001*IT_0002*IT_0005*IT_0011;
    const ccomplex_t IT_0231 = (-0.5)*IT_0230;
    const ccomplex_t IT_0232 = IT_0048*IT_0231;
    const ccomplex_t IT_0233 = cpow((-2)*s_12 + IT_0015 + -IT_0016 + -IT_0049 
      + -reg_prop, -1);
    const ccomplex_t IT_0234 = IT_0232*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = IT_0034*IT_0198;
    const ccomplex_t IT_0237 = IT_0070*IT_0206;
    const ccomplex_t IT_0238 = IT_0228 + IT_0229 + -IT_0235 + IT_0236 + IT_0237;
    const ccomplex_t IT_0239 = m_d*s_14;
    const ccomplex_t IT_0240 = IT_0196*IT_0231;
    const ccomplex_t IT_0241 = IT_0233*IT_0240;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = IT_0101*IT_0136;
    const ccomplex_t IT_0244 = IT_0044*IT_0052;
    const ccomplex_t IT_0245 = IT_0088*IT_0095;
    const ccomplex_t IT_0246 = IT_0174*IT_0181;
    const ccomplex_t IT_0247 = -IT_0242 + -IT_0243 + -IT_0244 + -IT_0245 + 
      -IT_0246;
    ...
    const ccomplex_t IT_0252 = m_d*m_N_2*IT_0251;
