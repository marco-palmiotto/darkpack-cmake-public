        ...
        )
{
    ...
    const ccomplex_t IT_0215 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0221 = s_34*m_N_2;
    ...
    const ccomplex_t IT_0248 = m_d*m_N_2;
