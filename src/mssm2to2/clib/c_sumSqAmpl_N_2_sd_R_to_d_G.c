...
ccomplex_return_t c_sumSqAmpl_N_2_sd_R_to_d_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
    ...
    const ccomplex_t IT_0041 = m_d*s_14*m_N_2;
    ...
    const ccomplex_t IT_0051 = m_d*m_N_2;
    ...
    const ccomplex_t IT_0056 = m_d*s_34*m_N_2;
