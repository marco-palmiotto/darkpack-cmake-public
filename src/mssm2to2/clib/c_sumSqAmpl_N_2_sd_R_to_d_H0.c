        ...
        )
{
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0009 + -m_d*e_em*mu_h*IT_0013*IT_0015*IT_0114*IT_0116);
    ...
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*m_d*e_em*IT_0009*IT_0015
      *IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0226 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0015*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0254 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0015*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0259 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0015*IT_0114*IT_0116;
