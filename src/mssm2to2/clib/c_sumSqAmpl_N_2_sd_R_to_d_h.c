...
ccomplex_return_t c_sumSqAmpl_N_2_sd_R_to_d_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*m_d*e_em*IT_0000*IT_0001
      *IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_12 + IT_0012 + -IT_0013 + -IT_0024 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*-3)*e_em*(IT_0000*IT_0001
      *IT_0003*IT_0006*IT_0012 + -1./3*m_W*IT_0005*IT_0029*(IT_0000*IT_0002 +
       IT_0004*IT_0030));
    const ccomplex_t IT_0032 = (-0.333333333333333)*IT_0031;
    const ccomplex_t IT_0033 = IT_0022*IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0012 + IT_0013 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*IT_0035;
    const ccomplex_t IT_0037 = IT_0004*IT_0020;
    const ccomplex_t IT_0038 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = IT_0000*IT_0020;
    const ccomplex_t IT_0041 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0044 = IT_0037*IT_0043;
    const ccomplex_t IT_0045 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0046 = IT_0040*IT_0045;
    const ccomplex_t IT_0047 = IT_0039 + IT_0042 + IT_0044 + IT_0046;
    const ccomplex_t IT_0048 = IT_0004*IT_0006;
    const ccomplex_t IT_0049 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = IT_0000*IT_0006;
    const ccomplex_t IT_0052 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0055 = IT_0048*IT_0054;
    const ccomplex_t IT_0056 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0067 = conj(N_B3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0072 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0073 = IT_0048*IT_0072;
    const ccomplex_t IT_0074 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0075 = IT_0051*IT_0074;
    const ccomplex_t IT_0076 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0077 = IT_0048*IT_0076;
    const ccomplex_t IT_0078 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0105 = conj(N_B2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0109 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0115 = cpow((-2)*s_23 + IT_0012 + IT_0024 + -m_N_2*
    ...
    const ccomplex_t IT_0121 = cpow((-2)*s_23 + IT_0012 + IT_0024 + -m_N_1*
    ...
    const ccomplex_t IT_0146 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0147 = IT_0037*IT_0146;
    const ccomplex_t IT_0148 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0149 = IT_0040*IT_0148;
    const ccomplex_t IT_0150 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0151 = IT_0037*IT_0150;
    const ccomplex_t IT_0152 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0153 = IT_0040*IT_0152;
    const ccomplex_t IT_0154 = IT_0147 + IT_0149 + IT_0151 + IT_0153;
    const ccomplex_t IT_0155 = conj(N_W1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0159 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0012 + IT_0024 + -m_N_4*
    ...
    const ccomplex_t IT_0221 = IT_0016 + (-2)*IT_0028 + IT_0036 + IT_0091 +
       IT_0118 + IT_0169 + IT_0220;
    const ccomplex_t IT_0222 = conj(N_B2)*e_em;
    const ccomplex_t IT_0223 = IT_0020*IT_0222;
    const ccomplex_t IT_0224 = 1.4142135623731*IT_0223;
    const ccomplex_t IT_0225 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0001*IT_0003*IT_0006;
    const ccomplex_t IT_0234 = 0.5*IT_0233;
    const ccomplex_t IT_0235 = IT_0018*IT_0234;
    ...
    const ccomplex_t IT_0239 = m_N_2*IT_0061;
    const ccomplex_t IT_0240 = m_N_3*IT_0083;
    const ccomplex_t IT_0241 = IT_0239 + IT_0240;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0001*IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0247 = IT_0115*IT_0234;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = IT_0114*IT_0248;
    const ccomplex_t IT_0250 = m_N_2*IT_0195;
    const ccomplex_t IT_0251 = m_N_4*IT_0217;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0001*IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0258 = IT_0032*IT_0234;
    const ccomplex_t IT_0259 = IT_0034*IT_0258;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1)*IT_0259;
    const ccomplex_t IT_0261 = m_N_2*IT_0144;
    const ccomplex_t IT_0262 = m_N_1*IT_0166;
    const ccomplex_t IT_0263 = IT_0261 + IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0001*IT_0003*IT_0006;
    const ccomplex_t IT_0265 = 0.5*IT_0264;
    const ccomplex_t IT_0266 = IT_0121*IT_0265;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*IT_0266;
    const ccomplex_t IT_0268 = IT_0263*IT_0267;
    const ccomplex_t IT_0269 = -IT_0232 + 2*IT_0238 + -IT_0246 + -IT_0249 + 
      -IT_0257 + -IT_0260 + -IT_0268;
    const ccomplex_t IT_0270 = 6*s_13;
    const ccomplex_t IT_0271 = m_d*m_N_2;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0195*IT_0256;
    const ccomplex_t IT_0274 = IT_0061*IT_0245;
    const ccomplex_t IT_0275 = IT_0101*IT_0248;
    const ccomplex_t IT_0276 = IT_0144*IT_0267;
    const ccomplex_t IT_0277 = -IT_0027 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_d*s_14;
    const ccomplex_t IT_0279 = IT_0112*IT_0117;
    const ccomplex_t IT_0280 = IT_0174*IT_0217;
    const ccomplex_t IT_0281 = IT_0083*IT_0090;
    const ccomplex_t IT_0282 = IT_0123*IT_0166;
    const ccomplex_t IT_0283 = IT_0237 + -IT_0279 + -IT_0280 + -IT_0281 + 
      -IT_0282;
    const ccomplex_t IT_0284 = s_34*m_N_2;
    const ccomplex_t IT_0285 = 6*conj(IT_0221);
    const ccomplex_t IT_0286 = 6*conj(IT_0269);
    const ccomplex_t IT_0287 = pow(m_h, 2);
    const ccomplex_t IT_0288 = m_d*m_N_2*IT_0287;
