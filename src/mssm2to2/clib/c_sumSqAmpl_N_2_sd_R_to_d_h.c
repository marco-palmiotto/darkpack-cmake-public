        ...
        )
{
    ...
    const ccomplex_t IT_0005 = pow(m_sd_R, 2);
    ...
    const ccomplex_t IT_0011 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0012 = IT_0010*IT_0011;
    const ccomplex_t IT_0013 = sin(alpha);
    const ccomplex_t IT_0014 = IT_0001*IT_0013;
    const ccomplex_t IT_0015 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0016 = IT_0014*IT_0015;
    const ccomplex_t IT_0017 = N_B2*N_u3*e_em;
    ...
    const ccomplex_t IT_0025 = N_W3*N_u2*e_em;
    ...
    const ccomplex_t IT_0030 = N_W2*N_u3*e_em;
    ...
    const ccomplex_t IT_0039 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0040 = IT_0010*IT_0039;
    const ccomplex_t IT_0041 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0042 = IT_0014*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0044 = IT_0010*IT_0043;
    const ccomplex_t IT_0045 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0046 = IT_0014*IT_0045;
    const ccomplex_t IT_0047 = IT_0040 + IT_0042 + IT_0044 + IT_0046;
    const ccomplex_t IT_0048 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0052 = conj(N_W3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0090 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0091 = IT_0010*IT_0090;
    const ccomplex_t IT_0092 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0093 = IT_0014*IT_0092;
    const ccomplex_t IT_0094 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0095 = IT_0010*IT_0094;
    const ccomplex_t IT_0096 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0013 + m_d*e_em*mu_h*IT_0009*IT_0023*IT_0114*IT_0116);
    const ccomplex_t IT_0118 = 0.5*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0023*IT_0114*IT_0116;
    const ccomplex_t IT_0120 = (-0.5)*IT_0119;
    const ccomplex_t IT_0121 = IT_0118*IT_0120;
    const ccomplex_t IT_0122 = pow(m_N_2, 2);
    const ccomplex_t IT_0123 = cpow((-2)*s_13 + IT_0004 + IT_0122 + -m_sd_L*
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*-3)*e_em*(IT_0004*IT_0013
      *IT_0023*IT_0114*IT_0116 + -1./3*m_W*IT_0022*IT_0126*(IT_0013*IT_0115 +
       IT_0009*IT_0127));
    ...
    const ccomplex_t IT_0133 = cpow((-2)*s_13 + IT_0004 + IT_0122 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0134 = IT_0132*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*m_d*e_em*IT_0013*IT_0023
      *IT_0114*IT_0116;
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = IT_0131*IT_0137;
    const ccomplex_t IT_0139 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0122 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0150 = IT_0027*IT_0149;
    ...
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_2*
    ...
    const ccomplex_t IT_0170 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0001;
    const ccomplex_t IT_0171 = (-0.333333333333333)*IT_0170;
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0197 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0198 = IT_0010*IT_0197;
    const ccomplex_t IT_0199 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0200 = IT_0014*IT_0199;
    const ccomplex_t IT_0201 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0202 = IT_0010*IT_0201;
    const ccomplex_t IT_0203 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0204 = IT_0014*IT_0203;
    const ccomplex_t IT_0205 = IT_0198 + IT_0200 + IT_0202 + IT_0204;
    const ccomplex_t IT_0206 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0207 = IT_0024*IT_0206;
    const ccomplex_t IT_0208 = conj(N_W1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0213 = IT_0027*IT_0212;
    ...
    const ccomplex_t IT_0221 = IT_0062 + IT_0113 + IT_0125 + IT_0135 + (-2)
      *IT_0142 + IT_0169 + IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0023*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0228 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0023*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0232 = m_N_3*IT_0059;
    const ccomplex_t IT_0233 = m_N_2*IT_0037;
    ...
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*(IT_0238 + (-3)*IT_0241);
    const ccomplex_t IT_0243 = 0.166666666666667*IT_0242;
    const ccomplex_t IT_0244 = IT_0118*IT_0243;
    const ccomplex_t IT_0245 = IT_0123*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*IT_0245;
    const ccomplex_t IT_0247 = IT_0129*IT_0223;
    const ccomplex_t IT_0248 = IT_0133*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0166*IT_0223;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = IT_0165*IT_0251;
    const ccomplex_t IT_0253 = m_N_2*IT_0195;
    const ccomplex_t IT_0254 = m_N_1*IT_0217;
    const ccomplex_t IT_0255 = IT_0253 + IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0023*IT_0114*IT_0116;
    const ccomplex_t IT_0257 = 0.5*IT_0256;
    const ccomplex_t IT_0258 = IT_0172*IT_0257;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*IT_0258;
    const ccomplex_t IT_0260 = IT_0255*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0023*IT_0114*IT_0116;
    ...
    const ccomplex_t IT_0265 = m_N_2*IT_0088;
    const ccomplex_t IT_0266 = m_N_4*IT_0110;
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = IT_0264*IT_0267;
    const ccomplex_t IT_0269 = 2*IT_0227 + -IT_0235 + -IT_0246 + -IT_0249 + 
    ...
    const ccomplex_t IT_0273 = IT_0152*IT_0251;
    const ccomplex_t IT_0274 = IT_0037*IT_0231;
    const ccomplex_t IT_0275 = IT_0088*IT_0264;
    const ccomplex_t IT_0276 = IT_0195*IT_0259;
    const ccomplex_t IT_0277 = -IT_0141 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_d*s_14;
    const ccomplex_t IT_0279 = IT_0163*IT_0168;
    const ccomplex_t IT_0280 = IT_0174*IT_0217;
    const ccomplex_t IT_0281 = IT_0008*IT_0059;
    const ccomplex_t IT_0282 = IT_0067*IT_0110;
