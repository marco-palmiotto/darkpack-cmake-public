...
ccomplex_return_t c_sumSqAmpl_N_2_se_L_to_e_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1)*(IT_0008 + IT_0013);
    ...
    const ccomplex_t IT_0021 = 2*IT_0016;
    const ccomplex_t IT_0022 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_se_L*
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0040 = IT_0016*IT_0024;
    const ccomplex_t IT_0041 = IT_0016*IT_0036;
    const ccomplex_t IT_0042 = -IT_0041;
    const ccomplex_t IT_0043 = (-2)*s_13;
    const ccomplex_t IT_0044 = s_34*IT_0043;
    const ccomplex_t IT_0045 = -IT_0025;
    const ccomplex_t IT_0046 = -IT_0034;
    const ccomplex_t IT_0047 = m_e*s_14*m_N_2;
    ...
    const ccomplex_t IT_0053 = IT_0001*IT_0043;
    const ccomplex_t IT_0054 = pow(s_13, 2);
    const ccomplex_t IT_0055 = (-2)*IT_0054;
    const ccomplex_t IT_0056 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0060 = (conj(IT_0026)*IT_0038 + IT_0026*conj(IT_0038))
      *IT_0039 + IT_0043*(conj(IT_0026)*IT_0037 + IT_0026*conj(IT_0037) + conj
      (IT_0038)*IT_0045 + IT_0038*conj(IT_0045)) + (conj(IT_0037)*IT_0040 +
       IT_0037*conj(IT_0040) + conj(IT_0042)*IT_0045 + IT_0042*conj(IT_0045))
      *IT_0057 + (conj(IT_0038)*IT_0040 + IT_0038*conj(IT_0040) + conj(IT_0026)
      *IT_0042 + IT_0026*conj(IT_0042))*IT_0058 + (conj(IT_0037)*IT_0045 +
       IT_0037*conj(IT_0045))*IT_0059;
    const ccomplex_t IT_0061 = m_e*s_34*m_N_2;
    ...
    const ccomplex_t IT_0070 = s_13*(IT_0026*conj(IT_0026) + IT_0038*conj
      ...
      (IT_0046*IT_0047 + 2*IT_0020*IT_0051 + (-0.5)*IT_0040*IT_0052 + (-0.5)
      *IT_0045*IT_0053 + (-0.5)*IT_0026*IT_0055) + IT_0045*(conj(IT_0040)
      *IT_0052 + conj(IT_0026)*IT_0055) + (-2)*conj(IT_0037)*(IT_0020*IT_0047 +
       2*IT_0046*IT_0051 + (-0.5)*IT_0042*IT_0052 + (-0.5)*IT_0037*IT_0053 + (
      -0.5)*IT_0038*IT_0055) + IT_0037*(conj(IT_0042)*IT_0052 + conj(IT_0038)
      *IT_0055) + IT_0056*IT_0060 + IT_0020*(IT_0062*IT_0063 + IT_0061*IT_0064) 
      + IT_0046*(IT_0061*IT_0062 + IT_0063*IT_0064) + (-2)*conj(IT_0020)*
      (IT_0037*IT_0047 + 2*IT_0045*IT_0051 + (-4)*IT_0020*IT_0065 + IT_0067
      *IT_0068 + IT_0066*IT_0069) + (-2)*conj(IT_0046)*(IT_0045*IT_0047 + 2
      *IT_0037*IT_0051 + (-4)*IT_0046*IT_0065 + IT_0066*IT_0067 + IT_0068
      *IT_0069);
