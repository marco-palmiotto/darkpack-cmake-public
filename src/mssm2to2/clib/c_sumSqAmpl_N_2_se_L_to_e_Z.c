        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0011 + IT_0027 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = IT_0041*IT_0046;
    const ccomplex_t IT_0048 = N_u2*conj(N_u3)*e_em;
    const ccomplex_t IT_0049 = IT_0017*IT_0048;
    const ccomplex_t IT_0050 = IT_0020*IT_0048;
    const ccomplex_t IT_0051 = N_d2*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0057 = (-0.5)*IT_0056;
    const ccomplex_t IT_0058 = cpow((-2)*s_23 + IT_0011 + IT_0027 + -m_N_3*
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0003*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*(IT_0131 + IT_0134);
    ...
    const ccomplex_t IT_0156 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0177 = m_N_2*IT_0026;
    const ccomplex_t IT_0178 = IT_0152*IT_0177;
    const ccomplex_t IT_0179 = m_N_2*IT_0090;
    const ccomplex_t IT_0180 = IT_0100*IT_0179;
    const ccomplex_t IT_0181 = m_N_4*IT_0069;
    const ccomplex_t IT_0182 = m_N_2*IT_0128;
    const ccomplex_t IT_0183 = -IT_0182;
    const ccomplex_t IT_0184 = IT_0181 + IT_0183;
    const ccomplex_t IT_0185 = IT_0138*IT_0184;
    const ccomplex_t IT_0186 = m_N_2*IT_0032;
    const ccomplex_t IT_0187 = -IT_0177;
    const ccomplex_t IT_0188 = IT_0186 + IT_0187;
    const ccomplex_t IT_0189 = IT_0152*IT_0188;
    const ccomplex_t IT_0190 = m_N_3*IT_0055;
    const ccomplex_t IT_0191 = m_N_2*IT_0109;
    const ccomplex_t IT_0192 = -IT_0191;
    const ccomplex_t IT_0193 = IT_0190 + IT_0192;
    const ccomplex_t IT_0194 = IT_0119*IT_0193;
    const ccomplex_t IT_0195 = -IT_0171 + IT_0176 + (-0.5)*IT_0178 + -IT_0180 
      + -IT_0185 + 0.5*IT_0189 + -IT_0194;
    const ccomplex_t IT_0196 = IT_0152*IT_0186;
    const ccomplex_t IT_0197 = m_N_1*IT_0041;
    const ccomplex_t IT_0198 = IT_0100*IT_0197;
    const ccomplex_t IT_0199 = 0.5*IT_0196 + IT_0198;
    const ccomplex_t IT_0200 = IT_0195 + IT_0199;
    const ccomplex_t IT_0201 = -IT_0101 + IT_0120 + IT_0139 + (-0.5)*IT_0153 +
       0.5*IT_0154;
    const ccomplex_t IT_0202 = -IT_0175;
    const ccomplex_t IT_0203 = pow(m_Z, 2);
    const ccomplex_t IT_0204 = IT_0156*IT_0203;
    const ccomplex_t IT_0205 = 3*IT_0204;
    const ccomplex_t IT_0206 = (-3)*IT_0204;
    const ccomplex_t IT_0207 = IT_0147*IT_0167;
    const ccomplex_t IT_0208 = IT_0169*IT_0207;
    const ccomplex_t IT_0209 = (0 + _Complex_I*1)*IT_0208;
    const ccomplex_t IT_0210 = IT_0150 + 2*IT_0209;
    const ccomplex_t IT_0211 = s_14*IT_0011;
    const ccomplex_t IT_0212 = s_13*s_34;
    const ccomplex_t IT_0213 = -IT_0212;
    const ccomplex_t IT_0214 = IT_0211 + IT_0213;
    const ccomplex_t IT_0215 = s_13*IT_0203;
    const ccomplex_t IT_0216 = pow(m_Z, 4);
    const ccomplex_t IT_0217 = s_13*IT_0216;
    const ccomplex_t IT_0218 = IT_0077*IT_0217;
    const ccomplex_t IT_0219 = (-0.5)*IT_0218;
    const ccomplex_t IT_0220 = s_14*s_34;
    const ccomplex_t IT_0221 = (-2)*IT_0220;
    const ccomplex_t IT_0222 = IT_0215 + IT_0219 + IT_0221;
    const ccomplex_t IT_0223 = (-0.25)*IT_0218;
    const ccomplex_t IT_0224 = IT_0220 + IT_0223;
    const ccomplex_t IT_0225 = s_34*IT_0203;
    const ccomplex_t IT_0226 = IT_0077*IT_0225;
    ...
    const ccomplex_t IT_0231 = s_14*IT_0203;
    const ccomplex_t IT_0232 = IT_0077*IT_0231;
    ...
    const ccomplex_t IT_0237 = m_e*IT_0209;
    const ccomplex_t IT_0238 = IT_0147*IT_0172;
    const ccomplex_t IT_0239 = IT_0169*IT_0170*IT_0238;
    const ccomplex_t IT_0240 = m_N_4*IT_0128;
    const ccomplex_t IT_0241 = m_N_2*IT_0069;
    const ccomplex_t IT_0242 = -IT_0241;
    const ccomplex_t IT_0243 = IT_0240 + IT_0242;
    const ccomplex_t IT_0244 = IT_0074*IT_0243;
    const ccomplex_t IT_0245 = IT_0030*IT_0186;
    const ccomplex_t IT_0246 = IT_0030*IT_0188;
    const ccomplex_t IT_0247 = m_N_2*IT_0041;
    const ccomplex_t IT_0248 = IT_0046*IT_0247;
    const ccomplex_t IT_0249 = m_N_3*IT_0109;
    const ccomplex_t IT_0250 = m_N_2*IT_0055;
    const ccomplex_t IT_0251 = -IT_0250;
    const ccomplex_t IT_0252 = IT_0249 + IT_0251;
    const ccomplex_t IT_0253 = IT_0060*IT_0252;
    const ccomplex_t IT_0254 = -IT_0237 + IT_0239 + IT_0244 + 0.5*IT_0245 +
       0.5*IT_0246 + IT_0248 + IT_0253;
    const ccomplex_t IT_0255 = m_N_1*IT_0090;
    const ccomplex_t IT_0256 = IT_0046*IT_0255;
    const ccomplex_t IT_0257 = IT_0030*IT_0177;
    const ccomplex_t IT_0258 = -IT_0256 + (-0.5)*IT_0257;
    const ccomplex_t IT_0259 = IT_0254 + IT_0258;
    const ccomplex_t IT_0260 = -IT_0016 + (-2)*IT_0175;
    const ccomplex_t IT_0261 = (-6)*conj(IT_0195);
    const ccomplex_t IT_0262 = (-0.25)*IT_0232;
    const ccomplex_t IT_0263 = s_14 + IT_0262;
    const ccomplex_t IT_0264 = m_e*IT_0263;
    const ccomplex_t IT_0265 = (-4)*IT_0264;
    const ccomplex_t IT_0266 = 0.5*IT_0226;
    const ccomplex_t IT_0267 = s_34 + IT_0266;
    const ccomplex_t IT_0268 = m_N_2*IT_0267;
    const ccomplex_t IT_0269 = 2*IT_0268;
    const ccomplex_t IT_0270 = IT_0215 + IT_0221;
    const ccomplex_t IT_0271 = IT_0077*IT_0270;
    const ccomplex_t IT_0272 = (-0.5)*IT_0271;
    const ccomplex_t IT_0273 = s_13 + IT_0272;
    const ccomplex_t IT_0274 = s_14*s_34*IT_0077;
    const ccomplex_t IT_0275 = -IT_0274;
    const ccomplex_t IT_0276 = s_13 + IT_0275;
    const ccomplex_t IT_0277 = m_e*IT_0276;
    const ccomplex_t IT_0278 = (-2)*IT_0260;
    const ccomplex_t IT_0279 = IT_0156*IT_0276;
    ...
    const ccomplex_t IT_0285 = m_N_2*IT_0283;
    const ccomplex_t IT_0286 = (-2)*conj(IT_0260);
    const ccomplex_t IT_0287 = s_13*IT_0276;
    const ccomplex_t IT_0288 = m_N_2*IT_0276;
    const ccomplex_t IT_0289 = (-2)*conj(IT_0076);
    const ccomplex_t IT_0290 = (-2)*conj(IT_0155);
    const ccomplex_t IT_0291 = (-2)*conj(IT_0210);
    const ccomplex_t IT_0292 = (-2)*conj(IT_0195);
    const ccomplex_t IT_0293 = (-2)*IT_0195;
    const ccomplex_t IT_0294 = 0.5*IT_0279;
    const ccomplex_t IT_0295 = (-2)*IT_0076;
    const ccomplex_t IT_0296 = s_13*IT_0283;
    const ccomplex_t IT_0297 = 0.5*IT_0296;
    const ccomplex_t IT_0298 = (-2)*IT_0155;
    const ccomplex_t IT_0299 = (-2)*IT_0210;
    const ccomplex_t IT_0300 = 0.5*IT_0162;
    const ccomplex_t IT_0301 = 0.5*IT_0214;
    const ccomplex_t IT_0302 = 4*IT_0254;
    const ccomplex_t IT_0303 = (-0.333333333333333)*IT_0202;
    const ccomplex_t IT_0304 = (-0.333333333333333)*IT_0158;
    const ccomplex_t IT_0305 = (-0.333333333333333)*IT_0201;
    const ccomplex_t IT_0306 = (-0.333333333333333)*IT_0209;
    const ccomplex_t IT_0307 = (-0.166666666666667)*IT_0277;
    const ccomplex_t IT_0308 = (-0.166666666666667)*IT_0285;
    const ccomplex_t IT_0309 = IT_0155*IT_0163 + (-3)*IT_0156*IT_0200 + 0.5
      *IT_0288*IT_0295 + 2*IT_0273*(IT_0258 + 0.25*IT_0302) + (-3)*IT_0269
      *IT_0303 + (-3)*IT_0230*IT_0304 + (-3)*IT_0236*IT_0305 + (-3)*IT_0265
      *IT_0306 + (-3)*IT_0299*IT_0307 + (-3)*IT_0278*IT_0308;
    const ccomplex_t IT_0310 = IT_0076*IT_0163 + (-3)*IT_0156*IT_0259 + 2
      *IT_0200*IT_0273 + 0.5*IT_0288*IT_0298 + (-3)*IT_0265*IT_0303 + (-3)
      *IT_0236*IT_0304 + (-3)*IT_0230*IT_0305 + (-3)*IT_0269*IT_0306 + (-3)
      *IT_0278*IT_0307 + (-3)*IT_0299*IT_0308;
    const ccomplex_t IT_0311 = 2*conj(IT_0076)*(IT_0076*IT_0082 + IT_0155
      *IT_0157 + IT_0158*IT_0162 + IT_0163*IT_0200) + 2*conj(IT_0201)*(IT_0155
      *IT_0162 + IT_0202*IT_0205 + IT_0158*IT_0206 + IT_0210*IT_0214 + (-2)
      *IT_0201*IT_0222 + (-4)*IT_0209*IT_0224 + IT_0200*IT_0230 + IT_0236
      *IT_0259) + 2*conj(IT_0158)*(IT_0076*IT_0162 + IT_0201*IT_0206 + IT_0205
      *IT_0209 + (-2)*IT_0158*IT_0222 + (-4)*IT_0202*IT_0224 + IT_0200*IT_0236 +
       IT_0230*IT_0259 + IT_0214*IT_0260) + IT_0156*IT_0259*IT_0261 + 2*conj
      (IT_0195)*(IT_0076*IT_0163 + IT_0201*IT_0230 + IT_0158*IT_0236 + IT_0202
      *IT_0265 + IT_0209*IT_0269 + 2*IT_0200*IT_0273 + 0.5*IT_0277*IT_0278) + 
      (IT_0202*IT_0214 + IT_0200*IT_0277 + IT_0155*IT_0279 + IT_0210*IT_0284 +
       IT_0259*IT_0285)*IT_0286 + (IT_0162*IT_0202 + IT_0210*IT_0279 + IT_0260
      *IT_0287 + IT_0259*IT_0288)*IT_0289 + (IT_0162*IT_0209 + IT_0210*IT_0287 +
       IT_0199*IT_0288)*IT_0290 + (IT_0209*IT_0214 + IT_0259*IT_0277 + IT_0199
      *IT_0285)*IT_0291 + (IT_0210*IT_0285 + IT_0155*IT_0288)*IT_0292 + 2*conj
      (IT_0155)*(IT_0082*IT_0155 + IT_0076*IT_0157 + IT_0162*IT_0201 + IT_0163
      *IT_0259 + 0.5*IT_0288*IT_0293 + IT_0278*IT_0294) + 2*conj(IT_0260)*
      (IT_0158*IT_0214 + 0.5*IT_0287*IT_0295 + IT_0278*IT_0297) + 2*conj(IT_0210
      )*(IT_0201*IT_0214 + 0.5*IT_0278*IT_0284 + 0.5*IT_0285*IT_0293 + IT_0294
      *IT_0295 + 0.5*IT_0287*IT_0298 + IT_0297*IT_0299) + 2*conj(IT_0202)*
      (IT_0201*IT_0205 + IT_0206*IT_0209 + (-2)*IT_0202*IT_0222 + (-4)*IT_0158
      *IT_0224 + IT_0200*IT_0265 + IT_0259*IT_0269 + IT_0295*IT_0300 + IT_0278
      *IT_0301) + 2*conj(IT_0209)*(IT_0158*IT_0205 + IT_0202*IT_0206 + (-2)
      *IT_0209*IT_0222 + (-4)*IT_0201*IT_0224 + IT_0259*IT_0265 + IT_0200
      *IT_0269 + IT_0298*IT_0300 + IT_0299*IT_0301) + 2*(conj(IT_0254) + conj
      (IT_0258))*IT_0309 + 2*conj(IT_0199)*IT_0310;
