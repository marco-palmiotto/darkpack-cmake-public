...
ccomplex_return_t c_sumSqAmpl_N_2_se_L_to_e_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0123 = cpow((-2)*s_13 + IT_0007 + IT_0122 + -m_se_R*
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0018 + (-0.5)*m_W*(IT_0001*IT_0018 + IT_0012*IT_0126)*
      (IT_0004 + -IT_0003*IT_0127));
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0130 = (-0.5)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0007 + IT_0122 + -m_se_L*
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*m_e*e_em*IT_0000*IT_0002
      *IT_0004*IT_0018;
    ...
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
    ...
    const ccomplex_t IT_0288 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0305 = m_e*m_N_2*IT_0304;
