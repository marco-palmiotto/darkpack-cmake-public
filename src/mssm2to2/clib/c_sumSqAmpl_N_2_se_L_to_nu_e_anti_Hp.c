        ...
        )
{
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0001*IT_0003*IT_0004*IT_0006;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*m_e;
