...
ccomplex_return_t c_sumSqAmpl_N_2_se_L_to_nu_e_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0026 = conj(N_u2)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = 2*IT_0027;
    const ccomplex_t IT_0029 = IT_0000*IT_0010;
    const ccomplex_t IT_0030 = conj(N_B2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W2)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0042 = pow(m_se_L, 2);
    ...
    const ccomplex_t IT_0046 = cpow(s_23 + (-0.5)*IT_0042 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0006;
    const ccomplex_t IT_0048 = conj(N_u2)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0049 = IT_0025*IT_0048;
    const ccomplex_t IT_0050 = 2*IT_0049;
    const ccomplex_t IT_0051 = conj(N_B2)*conj(V_u2)*e_em;
    const ccomplex_t IT_0052 = IT_0029*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = conj(N_W2)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0062 = IT_0045*IT_0046*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_12 + IT_0002 + -IT_0020 + -IT_0042 
      + -reg_prop, -1);
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0001*IT_0003*IT_0004*IT_0006;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(IT_0013 + IT_0016);
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = IT_0065*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_e;
    const ccomplex_t IT_0070 = IT_0063*IT_0068*IT_0069;
    ...
    const ccomplex_t IT_0083 = N_B2*U_d1*e_em;
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = N_W2*U_d1*e_em;
    ...
    const ccomplex_t IT_0113 = s_23*m_N_2;
