        ...
        )
{
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0001*IT_0042*IT_0044;
    const ccomplex_t IT_0046 = (-0.5)*IT_0045;
    const ccomplex_t IT_0047 = IT_0041*IT_0046;
    const ccomplex_t IT_0048 = pow(m_e, 2);
    const ccomplex_t IT_0049 = pow(m_N_2, 2);
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + -IT_0011 + IT_0048 + -IT_0049 
      + -reg_prop, -1);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_e;
    ...
    const ccomplex_t IT_0062 = IT_0024*IT_0053*IT_0061;
    const ccomplex_t IT_0063 = 0.5*IT_0039 + -IT_0052 + 0.5*IT_0062;
    ...
    const ccomplex_t IT_0080 = -IT_0040;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*(IT_0071 + -IT_0074);
    const ccomplex_t IT_0082 = (-0.5)*IT_0081;
    const ccomplex_t IT_0083 = cpow(s_13 + (-0.5)*IT_0049 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0127 = s_34*IT_0049;
    ...
    const ccomplex_t IT_0133 = -IT_0049;
