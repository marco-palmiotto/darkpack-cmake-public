...
ccomplex_return_t c_sumSqAmpl_N_2_se_R_to_e_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_se_R*
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0023;
    ...
    const ccomplex_t IT_0034 = IT_0011*IT_0019;
    const ccomplex_t IT_0035 = IT_0011*IT_0030;
    const ccomplex_t IT_0036 = -IT_0035;
    const ccomplex_t IT_0037 = (-2)*s_13;
    const ccomplex_t IT_0038 = s_34*IT_0037;
    const ccomplex_t IT_0039 = -IT_0020;
    const ccomplex_t IT_0040 = -IT_0028;
    const ccomplex_t IT_0041 = m_e*s_14*m_N_2;
    const ccomplex_t IT_0042 = s_13*s_14;
    const ccomplex_t IT_0043 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0050 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0054 = (conj(IT_0021)*IT_0032 + IT_0021*conj(IT_0032))
      *IT_0033 + IT_0037*(conj(IT_0021)*IT_0031 + IT_0021*conj(IT_0031) + conj
      (IT_0032)*IT_0039 + IT_0032*conj(IT_0039)) + (conj(IT_0031)*IT_0034 +
       IT_0031*conj(IT_0034) + conj(IT_0036)*IT_0039 + IT_0036*conj(IT_0039))
      *IT_0051 + (conj(IT_0032)*IT_0034 + IT_0032*conj(IT_0034) + conj(IT_0021)
      *IT_0036 + IT_0021*conj(IT_0036))*IT_0052 + (conj(IT_0031)*IT_0039 +
       IT_0031*conj(IT_0039))*IT_0053;
    const ccomplex_t IT_0055 = m_e*s_34*m_N_2;
    ...
    const ccomplex_t IT_0064 = s_13*(IT_0021*conj(IT_0021) + IT_0032*conj
      ...
      (IT_0040*IT_0041 + 2*IT_0015*IT_0045 + (-0.5)*IT_0034*IT_0046 + (-0.5)
      *IT_0039*IT_0047 + (-0.5)*IT_0021*IT_0049) + IT_0039*(conj(IT_0034)
      *IT_0046 + conj(IT_0021)*IT_0049) + (-2)*conj(IT_0031)*(IT_0015*IT_0041 +
       2*IT_0040*IT_0045 + (-0.5)*IT_0036*IT_0046 + (-0.5)*IT_0031*IT_0047 + (
      -0.5)*IT_0032*IT_0049) + IT_0031*(conj(IT_0036)*IT_0046 + conj(IT_0032)
      *IT_0049) + IT_0050*IT_0054 + IT_0015*(IT_0056*IT_0057 + IT_0055*IT_0058) 
      + IT_0040*(IT_0055*IT_0056 + IT_0057*IT_0058) + (-2)*conj(IT_0015)*
      (IT_0031*IT_0041 + 2*IT_0039*IT_0045 + (-4)*IT_0015*IT_0059 + IT_0061
      *IT_0062 + IT_0060*IT_0063) + (-2)*conj(IT_0040)*(IT_0039*IT_0041 + 2
      *IT_0031*IT_0045 + (-4)*IT_0040*IT_0059 + IT_0060*IT_0061 + IT_0062
      *IT_0063);
