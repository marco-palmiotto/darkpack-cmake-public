...
ccomplex_return_t c_sumSqAmpl_N_2_se_R_to_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0016;
    ...
    const ccomplex_t IT_0182 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0019 
      + -reg_prop, -1);
    const ccomplex_t IT_0183 = m_e*e_em*IT_0000*IT_0002*IT_0006*IT_0026;
    const ccomplex_t IT_0184 = (-0.5)*IT_0183;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
    ...
    const ccomplex_t IT_0190 = IT_0084*IT_0091;
    const ccomplex_t IT_0191 = IT_0127*IT_0134;
    const ccomplex_t IT_0192 = IT_0022*IT_0046;
    const ccomplex_t IT_0193 = -IT_0181 + -IT_0189 + -IT_0190 + -IT_0191 + 
      -IT_0192;
    const ccomplex_t IT_0194 = m_e*s_14;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0199 = IT_0109*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0215 = IT_0066*IT_0214;
    const ccomplex_t IT_0216 = IT_0199 + IT_0204 + -IT_0207 + IT_0210 + IT_0215;
    const ccomplex_t IT_0217 = s_34*m_N_2;
    ...
    const ccomplex_t IT_0229 = m_N_2*IT_0066;
    const ccomplex_t IT_0230 = m_N_1*IT_0084;
    const ccomplex_t IT_0231 = IT_0229 + IT_0230;
    const ccomplex_t IT_0232 = IT_0214*IT_0231;
    const ccomplex_t IT_0233 = m_N_2*IT_0109;
    const ccomplex_t IT_0234 = m_N_3*IT_0127;
    const ccomplex_t IT_0235 = IT_0233 + IT_0234;
    const ccomplex_t IT_0236 = IT_0198*IT_0235;
    const ccomplex_t IT_0237 = m_N_2*IT_0157;
    const ccomplex_t IT_0238 = m_N_4*IT_0175;
    const ccomplex_t IT_0239 = IT_0237 + IT_0238;
    const ccomplex_t IT_0240 = IT_0203*IT_0239;
    const ccomplex_t IT_0241 = IT_0048*IT_0209;
    const ccomplex_t IT_0242 = -IT_0228 + -IT_0232 + -IT_0236 + -IT_0240 + 
      -IT_0241;
    const ccomplex_t IT_0243 = 2*conj(IT_0242);
    const ccomplex_t IT_0244 = m_e*m_N_2;
    const ccomplex_t IT_0245 = 2*IT_0179;
    const ccomplex_t IT_0246 = 2*conj(IT_0179);
    const ccomplex_t IT_0247 = pow(m_A0, 2);
    const ccomplex_t IT_0248 = m_e*m_N_2*IT_0247;
