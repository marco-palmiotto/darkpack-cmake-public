        ...
        )
{
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0016*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0016*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0016*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0132 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0148 = IT_0003*IT_0006;
    const ccomplex_t IT_0149 = IT_0145*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*IT_0149;
    const ccomplex_t IT_0151 = m_e*IT_0150;
    const ccomplex_t IT_0152 = m_N_2*IT_0023;
    const ccomplex_t IT_0153 = IT_0128*IT_0152;
    const ccomplex_t IT_0154 = m_N_2*IT_0087;
    const ccomplex_t IT_0155 = IT_0094*IT_0154;
    const ccomplex_t IT_0156 = m_N_4*IT_0066;
    const ccomplex_t IT_0157 = m_N_2*IT_0116;
    const ccomplex_t IT_0158 = -IT_0157;
    const ccomplex_t IT_0159 = IT_0156 + IT_0158;
    const ccomplex_t IT_0160 = IT_0120*IT_0159;
    const ccomplex_t IT_0161 = m_N_2*IT_0029;
    const ccomplex_t IT_0162 = -IT_0152;
    const ccomplex_t IT_0163 = IT_0161 + IT_0162;
    const ccomplex_t IT_0164 = IT_0128*IT_0163;
    const ccomplex_t IT_0165 = m_N_3*IT_0052;
    const ccomplex_t IT_0166 = m_N_2*IT_0103;
    const ccomplex_t IT_0167 = -IT_0166;
    const ccomplex_t IT_0168 = IT_0165 + IT_0167;
    const ccomplex_t IT_0169 = IT_0107*IT_0168;
    const ccomplex_t IT_0170 = -IT_0147 + IT_0151 + (-0.5)*IT_0153 + -IT_0155 
      + -IT_0160 + 0.5*IT_0164 + -IT_0169;
    const ccomplex_t IT_0171 = IT_0128*IT_0161;
    const ccomplex_t IT_0172 = m_N_1*IT_0038;
    const ccomplex_t IT_0173 = IT_0094*IT_0172;
    const ccomplex_t IT_0174 = 0.5*IT_0171 + IT_0173;
    const ccomplex_t IT_0175 = IT_0170 + IT_0174;
    const ccomplex_t IT_0176 = -IT_0095 + IT_0108 + IT_0121 + (-0.5)*IT_0129 +
       0.5*IT_0130;
    const ccomplex_t IT_0177 = -IT_0150;
    const ccomplex_t IT_0178 = pow(m_Z, 2);
    const ccomplex_t IT_0179 = IT_0132*IT_0178;
    const ccomplex_t IT_0180 = 3*IT_0179;
    const ccomplex_t IT_0181 = (-3)*IT_0179;
    const ccomplex_t IT_0182 = IT_0123*IT_0143;
    const ccomplex_t IT_0183 = IT_0145*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*IT_0183;
    const ccomplex_t IT_0185 = IT_0126 + 2*IT_0184;
    ...
    const ccomplex_t IT_0190 = s_13*IT_0178;
    ...
    const ccomplex_t IT_0198 = (-0.25)*IT_0193;
    const ccomplex_t IT_0199 = IT_0195 + IT_0198;
    const ccomplex_t IT_0200 = s_34*IT_0178;
    const ccomplex_t IT_0201 = IT_0074*IT_0200;
    const ccomplex_t IT_0202 = (-0.25)*IT_0201;
    const ccomplex_t IT_0203 = s_34 + IT_0202;
    const ccomplex_t IT_0204 = m_N_2*IT_0203;
    const ccomplex_t IT_0205 = (-4)*IT_0204;
    const ccomplex_t IT_0206 = s_14*IT_0178;
    const ccomplex_t IT_0207 = IT_0074*IT_0206;
    const ccomplex_t IT_0208 = 0.5*IT_0207;
    const ccomplex_t IT_0209 = s_14 + IT_0208;
    const ccomplex_t IT_0210 = m_e*IT_0209;
    const ccomplex_t IT_0211 = 2*IT_0210;
    const ccomplex_t IT_0212 = m_e*IT_0184;
    const ccomplex_t IT_0213 = IT_0003*IT_0123;
    const ccomplex_t IT_0214 = IT_0145*IT_0146*IT_0213;
    const ccomplex_t IT_0215 = m_N_4*IT_0116;
    const ccomplex_t IT_0216 = m_N_2*IT_0066;
    const ccomplex_t IT_0217 = -IT_0216;
    const ccomplex_t IT_0218 = IT_0215 + IT_0217;
    const ccomplex_t IT_0219 = IT_0071*IT_0218;
    const ccomplex_t IT_0220 = IT_0027*IT_0161;
    const ccomplex_t IT_0221 = IT_0027*IT_0163;
    const ccomplex_t IT_0222 = m_N_2*IT_0038;
    const ccomplex_t IT_0223 = IT_0043*IT_0222;
    const ccomplex_t IT_0224 = m_N_3*IT_0103;
    const ccomplex_t IT_0225 = m_N_2*IT_0052;
    const ccomplex_t IT_0226 = -IT_0225;
    const ccomplex_t IT_0227 = IT_0224 + IT_0226;
    const ccomplex_t IT_0228 = IT_0057*IT_0227;
    const ccomplex_t IT_0229 = -IT_0212 + IT_0214 + IT_0219 + 0.5*IT_0220 +
       0.5*IT_0221 + IT_0223 + IT_0228;
    const ccomplex_t IT_0230 = m_N_1*IT_0087;
    const ccomplex_t IT_0231 = IT_0043*IT_0230;
    const ccomplex_t IT_0232 = IT_0027*IT_0152;
    const ccomplex_t IT_0233 = -IT_0231 + (-0.5)*IT_0232;
    const ccomplex_t IT_0234 = IT_0229 + IT_0233;
    const ccomplex_t IT_0235 = -IT_0012 + (-2)*IT_0150;
    const ccomplex_t IT_0236 = (-6)*conj(IT_0170);
    const ccomplex_t IT_0237 = (-0.25)*IT_0207;
    const ccomplex_t IT_0238 = s_14 + IT_0237;
    const ccomplex_t IT_0239 = m_e*IT_0238;
    const ccomplex_t IT_0240 = (-4)*IT_0239;
    const ccomplex_t IT_0241 = 0.5*IT_0201;
    const ccomplex_t IT_0242 = s_34 + IT_0241;
    const ccomplex_t IT_0243 = m_N_2*IT_0242;
    const ccomplex_t IT_0244 = 2*IT_0243;
    const ccomplex_t IT_0245 = IT_0190 + IT_0196;
    const ccomplex_t IT_0246 = IT_0074*IT_0245;
    const ccomplex_t IT_0247 = (-0.5)*IT_0246;
    const ccomplex_t IT_0248 = s_13 + IT_0247;
    const ccomplex_t IT_0249 = s_14*s_34*IT_0074;
    const ccomplex_t IT_0250 = -IT_0249;
    const ccomplex_t IT_0251 = s_13 + IT_0250;
    const ccomplex_t IT_0252 = m_e*IT_0251;
    const ccomplex_t IT_0253 = (-2)*IT_0235;
    const ccomplex_t IT_0254 = IT_0132*IT_0251;
    const ccomplex_t IT_0255 = pow(s_34, 2);
    const ccomplex_t IT_0256 = IT_0074*IT_0255;
    const ccomplex_t IT_0257 = -IT_0256;
    const ccomplex_t IT_0258 = IT_0007 + IT_0257;
    const ccomplex_t IT_0259 = IT_0132*IT_0258;
    const ccomplex_t IT_0260 = m_N_2*IT_0258;
    const ccomplex_t IT_0261 = (-2)*conj(IT_0235);
    const ccomplex_t IT_0262 = s_13*IT_0251;
    const ccomplex_t IT_0263 = m_N_2*IT_0251;
    const ccomplex_t IT_0264 = (-2)*conj(IT_0073);
    const ccomplex_t IT_0265 = (-2)*conj(IT_0131);
    const ccomplex_t IT_0266 = (-2)*conj(IT_0185);
    const ccomplex_t IT_0267 = (-2)*conj(IT_0170);
    const ccomplex_t IT_0268 = (-2)*IT_0170;
    const ccomplex_t IT_0269 = 0.5*IT_0254;
    const ccomplex_t IT_0270 = (-2)*IT_0073;
    const ccomplex_t IT_0271 = s_13*IT_0258;
    const ccomplex_t IT_0272 = 0.5*IT_0271;
    const ccomplex_t IT_0273 = (-2)*IT_0131;
    const ccomplex_t IT_0274 = (-2)*IT_0185;
    const ccomplex_t IT_0275 = 0.5*IT_0138;
    const ccomplex_t IT_0276 = 0.5*IT_0189;
    const ccomplex_t IT_0277 = 4*IT_0229;
    const ccomplex_t IT_0278 = (-0.333333333333333)*IT_0177;
    const ccomplex_t IT_0279 = (-0.333333333333333)*IT_0134;
    const ccomplex_t IT_0280 = (-0.333333333333333)*IT_0176;
    const ccomplex_t IT_0281 = (-0.333333333333333)*IT_0184;
    const ccomplex_t IT_0282 = (-0.166666666666667)*IT_0252;
    const ccomplex_t IT_0283 = (-0.166666666666667)*IT_0260;
    const ccomplex_t IT_0284 = IT_0131*IT_0139 + (-3)*IT_0132*IT_0175 + 0.5
      *IT_0263*IT_0270 + 2*IT_0248*(IT_0233 + 0.25*IT_0277) + (-3)*IT_0244
      *IT_0278 + (-3)*IT_0205*IT_0279 + (-3)*IT_0211*IT_0280 + (-3)*IT_0240
      *IT_0281 + (-3)*IT_0274*IT_0282 + (-3)*IT_0253*IT_0283;
    const ccomplex_t IT_0285 = IT_0073*IT_0139 + (-3)*IT_0132*IT_0234 + 2
      *IT_0175*IT_0248 + 0.5*IT_0263*IT_0273 + (-3)*IT_0240*IT_0278 + (-3)
      *IT_0211*IT_0279 + (-3)*IT_0205*IT_0280 + (-3)*IT_0244*IT_0281 + (-3)
      *IT_0253*IT_0282 + (-3)*IT_0274*IT_0283;
    const ccomplex_t IT_0286 = 2*conj(IT_0073)*(IT_0073*IT_0079 + IT_0131
      *IT_0133 + IT_0134*IT_0138 + IT_0139*IT_0175) + 2*conj(IT_0176)*(IT_0131
      *IT_0138 + IT_0177*IT_0180 + IT_0134*IT_0181 + IT_0185*IT_0189 + (-2)
      *IT_0176*IT_0197 + (-4)*IT_0184*IT_0199 + IT_0175*IT_0205 + IT_0211
      *IT_0234) + 2*conj(IT_0134)*(IT_0073*IT_0138 + IT_0176*IT_0181 + IT_0180
      *IT_0184 + (-2)*IT_0134*IT_0197 + (-4)*IT_0177*IT_0199 + IT_0175*IT_0211 +
       IT_0205*IT_0234 + IT_0189*IT_0235) + IT_0132*IT_0234*IT_0236 + 2*conj
      (IT_0170)*(IT_0073*IT_0139 + IT_0176*IT_0205 + IT_0134*IT_0211 + IT_0177
      *IT_0240 + IT_0184*IT_0244 + 2*IT_0175*IT_0248 + 0.5*IT_0252*IT_0253) + 
      (IT_0177*IT_0189 + IT_0175*IT_0252 + IT_0131*IT_0254 + IT_0185*IT_0259 +
       IT_0234*IT_0260)*IT_0261 + (IT_0138*IT_0177 + IT_0185*IT_0254 + IT_0235
      *IT_0262 + IT_0234*IT_0263)*IT_0264 + (IT_0138*IT_0184 + IT_0185*IT_0262 +
       IT_0174*IT_0263)*IT_0265 + (IT_0184*IT_0189 + IT_0234*IT_0252 + IT_0174
      *IT_0260)*IT_0266 + (IT_0185*IT_0260 + IT_0131*IT_0263)*IT_0267 + 2*conj
      (IT_0131)*(IT_0079*IT_0131 + IT_0073*IT_0133 + IT_0138*IT_0176 + IT_0139
      *IT_0234 + 0.5*IT_0263*IT_0268 + IT_0253*IT_0269) + 2*conj(IT_0235)*
      (IT_0134*IT_0189 + 0.5*IT_0262*IT_0270 + IT_0253*IT_0272) + 2*conj(IT_0185
      )*(IT_0176*IT_0189 + 0.5*IT_0253*IT_0259 + 0.5*IT_0260*IT_0268 + IT_0269
      *IT_0270 + 0.5*IT_0262*IT_0273 + IT_0272*IT_0274) + 2*conj(IT_0177)*
      (IT_0176*IT_0180 + IT_0181*IT_0184 + (-2)*IT_0177*IT_0197 + (-4)*IT_0134
      *IT_0199 + IT_0175*IT_0240 + IT_0234*IT_0244 + IT_0270*IT_0275 + IT_0253
      *IT_0276) + 2*conj(IT_0184)*(IT_0134*IT_0180 + IT_0177*IT_0181 + (-2)
      *IT_0184*IT_0197 + (-4)*IT_0176*IT_0199 + IT_0234*IT_0240 + IT_0175
      *IT_0244 + IT_0273*IT_0275 + IT_0274*IT_0276) + 2*(conj(IT_0229) + conj
      (IT_0233))*IT_0284 + 2*conj(IT_0174)*IT_0285;
