...
ccomplex_return_t c_sumSqAmpl_N_2_se_R_to_e_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*-1)*e_em*(IT_0000*IT_0002
      *IT_0005*IT_0011*IT_0016 + -m_W*IT_0004*IT_0029*(IT_0001*IT_0016 + IT_0003
      *IT_0030));
    const ccomplex_t IT_0032 = -IT_0031;
    const ccomplex_t IT_0033 = IT_0022*IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*IT_0035;
    const ccomplex_t IT_0037 = IT_0003*IT_0020;
    ...
    const ccomplex_t IT_0048 = IT_0003*IT_0005;
    const ccomplex_t IT_0049 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = IT_0005*IT_0016;
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0011 + IT_0024 + -m_N_3*
    ...
    const ccomplex_t IT_0115 = cpow((-2)*s_23 + IT_0011 + IT_0024 + -m_N_2*
    ...
    const ccomplex_t IT_0121 = cpow((-2)*s_23 + IT_0011 + IT_0024 + -m_N_1*
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0011 + IT_0024 + -m_N_4*
    ...
    const ccomplex_t IT_0221 = IT_0015 + (-2)*IT_0028 + IT_0036 + IT_0091 +
    ...
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
    ...
    const ccomplex_t IT_0242 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0253 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0264 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0271 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0288 = m_e*m_N_2*IT_0287;
