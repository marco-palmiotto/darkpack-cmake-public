...
ccomplex_return_t c_sumSqAmpl_N_2_se_R_to_nu_e_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = conj(N_u2)*e_em*conj(V_Wp1);
    ...
    const ccomplex_t IT_0014 = conj(N_B2)*conj(V_u1)*e_em;
    const ccomplex_t IT_0015 = IT_0013*IT_0014;
    const ccomplex_t IT_0016 = 1.4142135623731*IT_0015;
    const ccomplex_t IT_0017 = conj(N_W2)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
