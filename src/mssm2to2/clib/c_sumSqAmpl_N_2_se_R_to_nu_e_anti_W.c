        ...
        )
{
    ...
    const ccomplex_t IT_0019 = conj(N_W2)*e_em*U_Wm2;
    const ccomplex_t IT_0020 = IT_0001*IT_0019;
    const ccomplex_t IT_0021 = conj(N_d2)*U_d2*e_em;
    ...
    const ccomplex_t IT_0036 = N_W2*e_em*conj(V_Wp2);
    const ccomplex_t IT_0037 = IT_0001*IT_0036;
    const ccomplex_t IT_0038 = N_u2*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0044 = IT_0029*IT_0035*IT_0043;
