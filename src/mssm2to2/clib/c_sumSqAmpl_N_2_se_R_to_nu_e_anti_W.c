...
ccomplex_return_t c_sumSqAmpl_N_2_se_R_to_nu_e_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = conj(N_W2)*e_em*U_Wm1;
    const ccomplex_t IT_0021 = IT_0004*IT_0020;
    const ccomplex_t IT_0022 = conj(N_d2)*U_d1*e_em;
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0056 = IT_0019*IT_0047*IT_0055;
    ...
    const ccomplex_t IT_0066 = IT_0016*IT_0057*IT_0065;
