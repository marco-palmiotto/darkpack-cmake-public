...
ccomplex_return_t c_sumSqAmpl_N_2_smu_L_to_mu_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = 2*IT_0007;
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_smu_L*
    ...
    const ccomplex_t IT_0039 = (-2)*IT_0010;
    const ccomplex_t IT_0040 = IT_0007*IT_0019;
    ...
    const ccomplex_t IT_0045 = m_mu*s_14*m_N_2;
    ...
    const ccomplex_t IT_0061 = m_mu*s_34*m_N_2;
    const ccomplex_t IT_0062 = (-2)*conj(IT_0021);
    const ccomplex_t IT_0063 = s_14*IT_0010;
