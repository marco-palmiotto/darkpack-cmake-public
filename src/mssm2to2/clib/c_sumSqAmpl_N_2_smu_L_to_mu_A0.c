...
ccomplex_return_t c_sumSqAmpl_N_2_smu_L_to_mu_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0033 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0037 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0038 = IT_0014*IT_0037;
    const ccomplex_t IT_0039 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0040 = IT_0018*IT_0039;
    const ccomplex_t IT_0041 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0042 = IT_0021*IT_0041;
    const ccomplex_t IT_0043 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0044 = IT_0024*IT_0043;
    const ccomplex_t IT_0045 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0046 = IT_0014*IT_0045;
    const ccomplex_t IT_0047 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0048 = IT_0018*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0050 = IT_0021*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0088 = (-0.5)*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0138 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
    ...
    const ccomplex_t IT_0190 = m_N_2*IT_0157;
    const ccomplex_t IT_0191 = m_N_1*IT_0175;
    const ccomplex_t IT_0192 = IT_0190 + IT_0191;
    const ccomplex_t IT_0193 = IT_0189*IT_0192;
    const ccomplex_t IT_0194 = m_N_2*IT_0109;
    const ccomplex_t IT_0195 = m_N_3*IT_0127;
    const ccomplex_t IT_0196 = IT_0194 + IT_0195;
    const ccomplex_t IT_0197 = conj(N_B3)*e_em;
    const ccomplex_t IT_0198 = IT_0013*IT_0197;
    const ccomplex_t IT_0199 = 1.4142135623731*IT_0198;
    const ccomplex_t IT_0200 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0223 = IT_0086*IT_0222;
    const ccomplex_t IT_0224 = m_N_2*IT_0035;
    ...
    const ccomplex_t IT_0238 = -IT_0193 + -IT_0207 + -IT_0212 + -IT_0223 + 
      -IT_0237;
    const ccomplex_t IT_0239 = 2*s_13;
    const ccomplex_t IT_0240 = m_mu*m_N_2;
    ...
    const ccomplex_t IT_0248 = IT_0157*IT_0189;
    const ccomplex_t IT_0249 = IT_0035*IT_0236;
    const ccomplex_t IT_0250 = IT_0074*IT_0222;
    const ccomplex_t IT_0251 = IT_0109*IT_0206;
    const ccomplex_t IT_0252 = -IT_0247 + IT_0248 + IT_0249 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_mu*s_14;
    const ccomplex_t IT_0254 = IT_0011*IT_0053;
    const ccomplex_t IT_0255 = IT_0220*IT_0243;
    ...
    const ccomplex_t IT_0259 = IT_0140*IT_0175;
    ...
    const ccomplex_t IT_0266 = m_mu*m_N_2*IT_0265;
