        ...
        )
{
    ...
    const ccomplex_t IT_0020 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0023 = IT_0015*IT_0022;
    const ccomplex_t IT_0024 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0031 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0034 = IT_0027*IT_0033;
    const ccomplex_t IT_0035 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0004*IT_0012;
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0069 = (-0.5)*IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = pow(m_N_2, 2);
    const ccomplex_t IT_0072 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0070*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = m_mu*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0077 = sin(beta);
    const ccomplex_t IT_0078 = cpow(IT_0013, -2);
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0012 + (-0.5)*m_W*(IT_0001*IT_0012 + -IT_0018*IT_0077)
      *(IT_0004 + -IT_0003*IT_0078));
    ...
    const ccomplex_t IT_0094 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0095 = IT_0015*IT_0094;
    const ccomplex_t IT_0096 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0097 = IT_0027*IT_0096;
    const ccomplex_t IT_0098 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0099 = IT_0030*IT_0098;
    const ccomplex_t IT_0100 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0000
    ...
    const ccomplex_t IT_0165 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_smu_R*
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0169 = (-0.5)*IT_0168;
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
    ...
    const ccomplex_t IT_0182 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0183 = IT_0027*IT_0182;
    const ccomplex_t IT_0184 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0185 = IT_0030*IT_0184;
    const ccomplex_t IT_0186 = N_B2*N_u3*e_em;
    ...
    const ccomplex_t IT_0195 = conj(N_B2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0199 = conj(N_B3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0204 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0205 = IT_0027*IT_0204;
    const ccomplex_t IT_0206 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0207 = IT_0030*IT_0206;
    const ccomplex_t IT_0208 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0209 = IT_0027*IT_0208;
    const ccomplex_t IT_0210 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0219 = IT_0065 + (-2)*IT_0075 + IT_0083 + IT_0108 +
       IT_0159 + IT_0167 + IT_0218;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
    ...
    const ccomplex_t IT_0233 = IT_0080*IT_0232;
    const ccomplex_t IT_0234 = IT_0076*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = IT_0105*IT_0232;
    ...
    const ccomplex_t IT_0253 = m_N_2*IT_0062;
    const ccomplex_t IT_0254 = m_N_1*IT_0040;
    const ccomplex_t IT_0255 = IT_0253 + IT_0254;
    const ccomplex_t IT_0256 = conj(N_B1)*e_em;
    const ccomplex_t IT_0257 = IT_0014*IT_0256;
    const ccomplex_t IT_0258 = 1.4142135623731*IT_0257;
    const ccomplex_t IT_0259 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0275 = IT_0111*IT_0274;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1)*IT_0275;
    const ccomplex_t IT_0277 = m_N_2*IT_0134;
    const ccomplex_t IT_0278 = m_N_4*IT_0156;
    const ccomplex_t IT_0279 = IT_0277 + IT_0278;
    const ccomplex_t IT_0280 = IT_0276*IT_0279;
    const ccomplex_t IT_0281 = IT_0067*IT_0232;
    ...
    const ccomplex_t IT_0285 = -IT_0224 + -IT_0235 + -IT_0238 + -IT_0252 + 
    ...
    const ccomplex_t IT_0289 = IT_0134*IT_0276;
    const ccomplex_t IT_0290 = IT_0193*IT_0248;
    const ccomplex_t IT_0291 = IT_0062*IT_0265;
    const ccomplex_t IT_0292 = IT_0092*IT_0237;
    const ccomplex_t IT_0293 = -IT_0074 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_mu*s_14;
    const ccomplex_t IT_0295 = IT_0113*IT_0156;
    const ccomplex_t IT_0296 = IT_0102*IT_0107;
    const ccomplex_t IT_0297 = IT_0011*IT_0040;
