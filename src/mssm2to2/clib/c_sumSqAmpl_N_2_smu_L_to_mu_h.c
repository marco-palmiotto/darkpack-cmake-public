        ...
        )
{
    ...
    const ccomplex_t IT_0039 = IT_0009*IT_0018;
    ...
    const ccomplex_t IT_0045 = IT_0005*IT_0018;
    ...
    const ccomplex_t IT_0051 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0052 = IT_0036*IT_0051;
    const ccomplex_t IT_0053 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0054 = IT_0039*IT_0053;
    const ccomplex_t IT_0055 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0056 = IT_0042*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0013 + IT_0024 + -m_N_2*
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0013 + IT_0024 + -m_N_1*
    ...
    const ccomplex_t IT_0096 = conj(N_B1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0100 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0101 = IT_0039*IT_0100;
    const ccomplex_t IT_0102 = IT_0095 + IT_0097 + IT_0099 + IT_0101;
    const ccomplex_t IT_0103 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0104 = IT_0042*IT_0103;
    const ccomplex_t IT_0105 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0106 = IT_0045*IT_0105;
    const ccomplex_t IT_0107 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0108 = IT_0042*IT_0107;
    const ccomplex_t IT_0109 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0119 = (-0.5)*IT_0118;
    const ccomplex_t IT_0120 = cpow((-2)*s_23 + IT_0013 + IT_0024 + -m_N_4*
    ...
    const ccomplex_t IT_0144 = m_N_4*IT_0143;
    ...
    const ccomplex_t IT_0157 = IT_0045*IT_0156;
    ...
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0170 = (-0.5)*IT_0169;
    const ccomplex_t IT_0171 = cpow((-2)*s_23 + IT_0013 + IT_0024 + -m_N_3*
    ...
    const ccomplex_t IT_0187 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0188 = IT_0042*IT_0187;
    const ccomplex_t IT_0189 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0196 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0197 = IT_0036*IT_0196;
    const ccomplex_t IT_0198 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0199 = IT_0039*IT_0198;
    const ccomplex_t IT_0200 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0201 = IT_0036*IT_0200;
    const ccomplex_t IT_0202 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0203 = IT_0039*IT_0202;
    const ccomplex_t IT_0204 = IT_0197 + IT_0199 + IT_0201 + IT_0203;
    const ccomplex_t IT_0205 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0206 = IT_0042*IT_0205;
    const ccomplex_t IT_0207 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0208 = IT_0045*IT_0207;
    const ccomplex_t IT_0209 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0210 = IT_0042*IT_0209;
    const ccomplex_t IT_0211 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0220 = IT_0017 + (-2)*IT_0028 + IT_0035 + IT_0066 +
       IT_0117 + IT_0168 + IT_0219;
    const ccomplex_t IT_0221 = conj(N_B2)*e_em;
    const ccomplex_t IT_0222 = IT_0009*IT_0221;
    const ccomplex_t IT_0223 = 1.4142135623731*IT_0222;
    const ccomplex_t IT_0224 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0230 = IT_0033*IT_0229;
    ...
    const ccomplex_t IT_0240 = IT_0069*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*IT_0240;
    const ccomplex_t IT_0242 = m_N_2*IT_0092;
    const ccomplex_t IT_0243 = m_N_1*IT_0114;
    const ccomplex_t IT_0244 = IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = IT_0241*IT_0244;
    const ccomplex_t IT_0246 = IT_0020*IT_0228;
    ...
    const ccomplex_t IT_0255 = IT_0063*IT_0228;
    ...
    const ccomplex_t IT_0280 = IT_0120*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = m_N_2*IT_0143;
    const ccomplex_t IT_0283 = m_N_4*IT_0165;
    ...
    const ccomplex_t IT_0288 = m_mu*m_N_2;
    const ccomplex_t IT_0289 = 2*IT_0220;
    const ccomplex_t IT_0290 = IT_0143*IT_0281;
    const ccomplex_t IT_0291 = IT_0194*IT_0267;
    const ccomplex_t IT_0292 = IT_0092*IT_0241;
    const ccomplex_t IT_0293 = IT_0049*IT_0256;
    const ccomplex_t IT_0294 = -IT_0027 + IT_0290 + IT_0291 + IT_0292 + IT_0293;
    const ccomplex_t IT_0295 = m_mu*s_14;
    const ccomplex_t IT_0296 = IT_0071*IT_0114;
    const ccomplex_t IT_0297 = IT_0122*IT_0165;
    const ccomplex_t IT_0298 = IT_0173*IT_0216;
    const ccomplex_t IT_0299 = IT_0060*IT_0065;
    ...
    const ccomplex_t IT_0305 = m_mu*m_N_2*IT_0304;
