        ...
        )
{
    ...
    const ccomplex_t IT_0052 = IT_0024*IT_0043*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0054 = N_W2*e_em*conj(V_Wp1);
    const ccomplex_t IT_0055 = IT_0001*IT_0054;
    const ccomplex_t IT_0056 = N_u2*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0062 = IT_0012*IT_0053*IT_0061;
    ...
    const ccomplex_t IT_0127 = s_34*IT_0039;
