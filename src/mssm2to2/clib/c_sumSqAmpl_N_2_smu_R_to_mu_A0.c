        ...
        )
{
    ...
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_3*
    ...
    const ccomplex_t IT_0180 = m_N_2*IT_0109;
    ...
    const ccomplex_t IT_0204 = m_N_2*IT_0152;
    const ccomplex_t IT_0205 = m_N_3*IT_0170;
    ...
    const ccomplex_t IT_0236 = IT_0170*IT_0177;
    ...
    const ccomplex_t IT_0240 = IT_0008*IT_0051;
