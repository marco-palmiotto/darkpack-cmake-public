        ...
        )
{
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_23 + IT_0011 + IT_0020 + -m_N_3*
    ...
    const ccomplex_t IT_0036 = IT_0003*IT_0017;
    ...
    const ccomplex_t IT_0077 = cpow((-2)*s_23 + IT_0011 + IT_0020 + -m_N_4*
    ...
    const ccomplex_t IT_0126 = cpow(IT_0016, -2);
    const ccomplex_t IT_0127 = sin(beta);
    const ccomplex_t IT_0128 = (0 + _Complex_I*-1)*e_em*(IT_0000*IT_0002
      *IT_0005*IT_0011*IT_0024 + -m_W*IT_0004*IT_0126*(IT_0001*IT_0024 + 
      -IT_0003*IT_0127));
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_smu_R*
    ...
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*(IT_0136 + -IT_0138 + 
      -IT_0140 + IT_0142);
    const ccomplex_t IT_0144 = m_N_2*IT_0143;
    const ccomplex_t IT_0145 = conj(N_B2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0149 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0150 = IT_0039*IT_0149;
    ...
    const ccomplex_t IT_0156 = cpow((-2)*s_23 + IT_0011 + IT_0020 + -m_N_2*
    ...
    const ccomplex_t IT_0182 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0183 = IT_0025*IT_0182;
    const ccomplex_t IT_0184 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0185 = IT_0028*IT_0184;
    const ccomplex_t IT_0186 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0187 = IT_0025*IT_0186;
    const ccomplex_t IT_0188 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0189 = IT_0028*IT_0188;
    const ccomplex_t IT_0190 = IT_0183 + IT_0185 + IT_0187 + IT_0189;
    const ccomplex_t IT_0191 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0195 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0203 = m_N_2*IT_0202;
    const ccomplex_t IT_0204 = IT_0181 + IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0017;
    const ccomplex_t IT_0206 = -IT_0205;
    const ccomplex_t IT_0207 = cpow((-2)*s_23 + IT_0011 + IT_0020 + -m_N_1*
    ...
    const ccomplex_t IT_0211 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0005*IT_0024;
    const ccomplex_t IT_0212 = (-0.5)*IT_0211;
    const ccomplex_t IT_0213 = IT_0130*IT_0212;
    const ccomplex_t IT_0214 = cpow((-2)*s_12 + IT_0011 + -IT_0012 + -IT_0020 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0218 = IT_0015 + IT_0074 + IT_0125 + IT_0134 + IT_0159
       + IT_0210 + (-2)*IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
    ...
    const ccomplex_t IT_0223 = m_N_2*IT_0180;
    const ccomplex_t IT_0224 = m_N_1*IT_0202;
    const ccomplex_t IT_0225 = IT_0223 + IT_0224;
    const ccomplex_t IT_0226 = IT_0222*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0231 = m_N_2*IT_0049;
    const ccomplex_t IT_0232 = m_N_3*IT_0071;
    const ccomplex_t IT_0233 = IT_0231 + IT_0232;
    const ccomplex_t IT_0234 = IT_0230*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0236 = 0.5*IT_0235;
    const ccomplex_t IT_0237 = IT_0212*IT_0236;
    const ccomplex_t IT_0238 = IT_0214*IT_0237;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*IT_0238;
    const ccomplex_t IT_0240 = m_mu*IT_0239;
    ...
    const ccomplex_t IT_0249 = IT_0007*IT_0248;
    const ccomplex_t IT_0250 = IT_0013*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0256 = m_N_2*IT_0100;
    const ccomplex_t IT_0257 = m_N_4*IT_0122;
    const ccomplex_t IT_0258 = IT_0256 + IT_0257;
    const ccomplex_t IT_0259 = IT_0255*IT_0258;
    const ccomplex_t IT_0260 = IT_0128*IT_0236;
    const ccomplex_t IT_0261 = IT_0132*IT_0260;
    const ccomplex_t IT_0262 = (0 + _Complex_I*1)*IT_0261;
    const ccomplex_t IT_0263 = IT_0156*IT_0236;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0155*IT_0264;
    const ccomplex_t IT_0266 = -IT_0226 + -IT_0234 + 2*IT_0240 + -IT_0251 + 
      -IT_0259 + -IT_0262 + -IT_0265;
    const ccomplex_t IT_0267 = 2*s_13;
    const ccomplex_t IT_0268 = m_mu*m_N_2;
    const ccomplex_t IT_0269 = 2*IT_0218;
    const ccomplex_t IT_0270 = IT_0049*IT_0230;
    const ccomplex_t IT_0271 = IT_0100*IT_0255;
    const ccomplex_t IT_0272 = IT_0143*IT_0264;
    const ccomplex_t IT_0273 = IT_0180*IT_0222;
    const ccomplex_t IT_0274 = -IT_0216 + IT_0270 + IT_0271 + IT_0272 + IT_0273;
    const ccomplex_t IT_0275 = m_mu*s_14;
    const ccomplex_t IT_0276 = IT_0023*IT_0071;
    const ccomplex_t IT_0277 = IT_0079*IT_0122;
    const ccomplex_t IT_0278 = IT_0153*IT_0158;
    const ccomplex_t IT_0279 = IT_0202*IT_0209;
    const ccomplex_t IT_0280 = IT_0239 + -IT_0276 + -IT_0277 + -IT_0278 + 
      -IT_0279;
