...
ccomplex_return_t c_sumSqAmpl_N_2_smu_R_to_mu_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = pow(m_smu_R, 2);
    const ccomplex_t IT_0037 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_2*
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_3*
    ...
    const ccomplex_t IT_0068 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0069 = IT_0007*IT_0068;
    const ccomplex_t IT_0070 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0071 = IT_0003*IT_0070;
    const ccomplex_t IT_0072 = N_B2*N_d3*e_em;
    ...
    const ccomplex_t IT_0088 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0089 = IT_0003*IT_0088;
    const ccomplex_t IT_0090 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0091 = IT_0007*IT_0090;
    const ccomplex_t IT_0092 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0093 = IT_0003*IT_0092;
    const ccomplex_t IT_0094 = conj(N_B3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0134 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0135 = IT_0003*IT_0134;
    const ccomplex_t IT_0136 = conj(N_B1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0157 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0002;
    const ccomplex_t IT_0158 = -IT_0157;
    const ccomplex_t IT_0159 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_1*
    ...
    const ccomplex_t IT_0191 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0192 = IT_0007*IT_0191;
    const ccomplex_t IT_0193 = IT_0186 + IT_0188 + IT_0190 + IT_0192;
    const ccomplex_t IT_0194 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0195 = IT_0012*IT_0194;
    const ccomplex_t IT_0196 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0197 = IT_0015*IT_0196;
    const ccomplex_t IT_0198 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0199 = IT_0012*IT_0198;
    const ccomplex_t IT_0200 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0206 = m_N_2*IT_0205;
    const ccomplex_t IT_0207 = IT_0184 + IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0002;
    const ccomplex_t IT_0209 = -IT_0208;
    const ccomplex_t IT_0210 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_4*
    ...
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*e_em*m_mu*IT_0006*IT_0011
      *IT_0041*IT_0043;
    const ccomplex_t IT_0215 = 0.5*IT_0214;
    const ccomplex_t IT_0216 = IT_0034*IT_0215;
    const ccomplex_t IT_0217 = cpow((-2)*s_12 + IT_0035 + -IT_0036 + -IT_0049 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0221 = IT_0040 + IT_0052 + IT_0060 + IT_0111 + IT_0162
       + IT_0213 + (-2)*IT_0220;
    ...
    const ccomplex_t IT_0231 = IT_0050*IT_0230;
    const ccomplex_t IT_0232 = (0 + _Complex_I*1)*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0011*IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0237 = m_N_2*IT_0086;
    const ccomplex_t IT_0238 = m_N_3*IT_0108;
    const ccomplex_t IT_0239 = IT_0237 + IT_0238;
    const ccomplex_t IT_0240 = IT_0236*IT_0239;
    const ccomplex_t IT_0241 = m_N_2*IT_0132;
    const ccomplex_t IT_0242 = m_N_1*IT_0154;
    const ccomplex_t IT_0243 = IT_0241 + IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0011*IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0249 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0011*IT_0041*IT_0043;
    const ccomplex_t IT_0250 = 0.5*IT_0249;
    const ccomplex_t IT_0251 = IT_0056*IT_0250;
    const ccomplex_t IT_0252 = IT_0058*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = m_N_2*IT_0183;
    const ccomplex_t IT_0255 = m_N_4*IT_0205;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0011*IT_0041*IT_0043;
    const ccomplex_t IT_0258 = 0.5*IT_0257;
    const ccomplex_t IT_0259 = IT_0210*IT_0258;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1)*IT_0259;
    const ccomplex_t IT_0261 = IT_0256*IT_0260;
    const ccomplex_t IT_0262 = IT_0215*IT_0250;
    ...
    const ccomplex_t IT_0266 = IT_0037*IT_0250;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*IT_0266;
    const ccomplex_t IT_0268 = IT_0032*IT_0267;
    const ccomplex_t IT_0269 = (-0.5)*IT_0268;
    const ccomplex_t IT_0270 = -IT_0232 + -IT_0240 + -IT_0248 + -IT_0253 + 
      -IT_0261 + 2*IT_0265 + 2*IT_0269;
    const ccomplex_t IT_0271 = 2*s_13;
    const ccomplex_t IT_0272 = m_mu*m_N_2;
    const ccomplex_t IT_0273 = 2*IT_0221;
    const ccomplex_t IT_0274 = IT_0086*IT_0236;
    const ccomplex_t IT_0275 = IT_0132*IT_0247;
    const ccomplex_t IT_0276 = IT_0183*IT_0260;
    const ccomplex_t IT_0277 = IT_0019*IT_0267;
    const ccomplex_t IT_0278 = 0.5*IT_0277;
    const ccomplex_t IT_0279 = -IT_0219 + IT_0274 + IT_0275 + IT_0276 + 2
      *IT_0278;
    const ccomplex_t IT_0280 = m_mu*s_14;
    const ccomplex_t IT_0281 = IT_0154*IT_0161;
    const ccomplex_t IT_0282 = IT_0205*IT_0212;
    const ccomplex_t IT_0283 = IT_0065*IT_0108;
    const ccomplex_t IT_0284 = IT_0030*IT_0039;
    const ccomplex_t IT_0285 = IT_0264 + -IT_0281 + -IT_0282 + -IT_0283 + 
      -IT_0284;
    const ccomplex_t IT_0286 = s_34*m_N_2;
    const ccomplex_t IT_0287 = 2*conj(IT_0221);
    const ccomplex_t IT_0288 = 2*conj(IT_0270);
    const ccomplex_t IT_0289 = pow(m_h, 2);
    const ccomplex_t IT_0290 = m_mu*m_N_2*IT_0289;
    const ccomplex_t IT_0291 = s_13*IT_0289;
    const ccomplex_t IT_0292 = s_14*s_34;
    const ccomplex_t IT_0293 = (-2)*IT_0292;
    const ccomplex_t IT_0294 = IT_0291 + IT_0293;
    const ccomplex_t IT_0295 = 2*IT_0270;
    const ccomplex_t IT_0296 = 0.5*IT_0286;
    const ccomplex_t IT_0297 = (IT_0221*conj(IT_0221) + IT_0270*conj(IT_0270))
      *IT_0271 + conj(IT_0270)*IT_0272*IT_0273 + (IT_0270*IT_0272 + IT_0279
      *IT_0280 + IT_0285*IT_0286)*IT_0287 + (IT_0280*IT_0285 + IT_0279*IT_0286)
      *IT_0288 + 2*conj(IT_0285)*(IT_0279*IT_0290 + -IT_0285*IT_0294 + 0.5
      *IT_0280*IT_0295 + IT_0273*IT_0296) + 2*conj(IT_0279)*(0.5*IT_0273*IT_0280
       + IT_0285*IT_0290 + -IT_0279*IT_0294 + IT_0295*IT_0296);
