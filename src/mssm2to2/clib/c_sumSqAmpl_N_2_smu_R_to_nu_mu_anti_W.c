...
ccomplex_return_t c_sumSqAmpl_N_2_smu_R_to_nu_mu_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_W2)*e_em*U_Wm1;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = conj(N_d2)*U_d1*e_em;
    ...
    const ccomplex_t IT_0021 = conj(N_W2)*e_em*U_Wm2;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(N_d2)*U_d2*e_em;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = cos(theta_W);
    const ccomplex_t IT_0038 = cpow(IT_0037, -1);
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0038;
    const ccomplex_t IT_0040 = -IT_0039;
    const ccomplex_t IT_0041 = IT_0036*IT_0040;
    const ccomplex_t IT_0042 = pow(m_mu, 2);
    const ccomplex_t IT_0043 = pow(m_N_2, 2);
    const ccomplex_t IT_0044 = cpow((-2)*s_12 + -IT_0015 + IT_0042 + -IT_0043 
      + -reg_prop, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0046 = IT_0041*IT_0044*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0048 = N_W2*e_em*conj(V_Wp1);
    const ccomplex_t IT_0049 = IT_0004*IT_0048;
    const ccomplex_t IT_0050 = N_u2*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0056 = IT_0016*IT_0047*IT_0055;
    ...
    const ccomplex_t IT_0066 = IT_0029*IT_0057*IT_0065;
    const ccomplex_t IT_0067 = -IT_0046 + 0.5*IT_0056 + 0.5*IT_0066;
    ...
    const ccomplex_t IT_0076 = m_N_2*IT_0074*IT_0075;
    ...
    const ccomplex_t IT_0108 = -IT_0043;
    ...
    const ccomplex_t IT_0114 = s_34*IT_0043;
    ...
    const ccomplex_t IT_0125 = IT_0078 + IT_0080 + IT_0124;
    ...
    const ccomplex_t IT_0129 = 2*(IT_0034 + IT_0067)*IT_0105 + (conj(IT_0089)
      ...
      *IT_0118 + 2*IT_0073*(0.5*IT_0090*IT_0111 + IT_0076*IT_0112 + conj(IT_0073
      )*IT_0119 + IT_0117*IT_0120) + 2*IT_0072*(IT_0097*IT_0112 + conj(IT_0073)
      *IT_0120 + (-2)*conj(IT_0072)*IT_0125 + 4*conj(IT_0099)*IT_0127 + IT_0128)
       + (-2)*IT_0099*(IT_0103*IT_0112 + -conj(IT_0073)*IT_0120 + 2*conj(IT_0099
      )*IT_0125 + (-4)*conj(IT_0072)*IT_0127 + -IT_0128);
