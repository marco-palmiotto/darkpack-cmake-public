        ...
        )
{
    ...
    const ccomplex_t IT_0116 = IT_0024*IT_0087;
    const ccomplex_t IT_0117 = IT_0003*IT_0115*IT_0116;
    ...
    const ccomplex_t IT_0126 = cpow((-2)*s_13 + IT_0002 + IT_0061 + -m_se_R*
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005*
      (m_W*IT_0007 + (-0.5)*IT_0002*IT_0047*IT_0048)*IT_0049;
    const ccomplex_t IT_0130 = -IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0005*IT_0047*IT_0048;
    const ccomplex_t IT_0132 = (-0.5)*IT_0131;
    const ccomplex_t IT_0133 = IT_0130*IT_0132;
    const ccomplex_t IT_0134 = cpow((-2)*s_13 + IT_0002 + IT_0061 + -m_se_L*
    ...
    const ccomplex_t IT_0137 = m_N_2*IT_0064;
    ...
    const ccomplex_t IT_0142 = IT_0006*IT_0100;
    const ccomplex_t IT_0143 = IT_0003*IT_0115*IT_0142;
    const ccomplex_t IT_0144 = IT_0028*IT_0082;
    const ccomplex_t IT_0145 = IT_0043*IT_0118*IT_0144;
