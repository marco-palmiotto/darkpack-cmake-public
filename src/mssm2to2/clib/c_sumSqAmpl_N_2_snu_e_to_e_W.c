...
ccomplex_return_t c_sumSqAmpl_N_2_snu_e_to_e_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = N_W2*e_em*conj(U_Wm1);
    const ccomplex_t IT_0011 = IT_0007*IT_0010;
    const ccomplex_t IT_0012 = N_d2*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*m_e*U_d2*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007;
    const ccomplex_t IT_0034 = -IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0036 = (-0.5)*IT_0035;
    const ccomplex_t IT_0037 = pow(m_N_2, 2);
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0000 + IT_0037 + -m_se_L*
    ...
    const ccomplex_t IT_0063 = m_e*m_N_2;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0007;
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0007;
    const ccomplex_t IT_0093 = conj(N_W2)*e_em*V_Wp2;
    const ccomplex_t IT_0094 = IT_0007*IT_0093;
    const ccomplex_t IT_0095 = conj(N_u2)*V_u2*e_em;
    ...
    const ccomplex_t IT_0131 = m_N_2*IT_0103;
    ...
    const ccomplex_t IT_0140 = m_N_2*IT_0019;
    const ccomplex_t IT_0141 = m_N_2*IT_0032;
    const ccomplex_t IT_0142 = m_e*IT_0076;
    const ccomplex_t IT_0143 = IT_0140 + IT_0141 + 0.5*IT_0142;
    const ccomplex_t IT_0144 = IT_0009*IT_0088;
    const ccomplex_t IT_0145 = IT_0002*IT_0125*IT_0144;
    const ccomplex_t IT_0146 = IT_0022*IT_0099;
    ...
    const ccomplex_t IT_0158 = m_N_2*IT_0153;
    ...
    const ccomplex_t IT_0177 = m_N_2*IT_0175;
