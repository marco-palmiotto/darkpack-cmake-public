        ...
        )
{
    ...
    const ccomplex_t IT_0057 = N_u1*conj(N_u2)*e_em;
    const ccomplex_t IT_0058 = IT_0025*IT_0057;
    const ccomplex_t IT_0059 = IT_0028*IT_0057;
    const ccomplex_t IT_0060 = N_d1*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0075 = IT_0024*IT_0072;
    ...
    const ccomplex_t IT_0141 = 0.25*IT_0074 + 0.25*IT_0075 + 0.5*IT_0107 + 0.5
      *IT_0140;
    ...
    const ccomplex_t IT_0168 = IT_0024*IT_0071;
