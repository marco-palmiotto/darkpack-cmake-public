...
ccomplex_return_t c_sumSqAmpl_N_2_snu_mu_to_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_mu*m_N_2*IT_0000;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_C_2*
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
    ...
    const ccomplex_t IT_0068 = IT_0005*IT_0049;
    const ccomplex_t IT_0069 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0070 = IT_0068*IT_0069;
    const ccomplex_t IT_0071 = (-2)*IT_0070;
    const ccomplex_t IT_0072 = IT_0009*IT_0049;
    ...
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0005*IT_0047*IT_0048;
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0089 = IT_0068*IT_0088;
    const ccomplex_t IT_0090 = (-2)*IT_0089;
    const ccomplex_t IT_0091 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0092 = IT_0072*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0111 = m_mu*m_N_2;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005*
    ...
    const ccomplex_t IT_0117 = cpow((-2)*s_13 + IT_0002 + IT_0061 + -m_smu_L*
    ...
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0005*IT_0047;
    const ccomplex_t IT_0121 = 0.5*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0009;
    const ccomplex_t IT_0123 = -IT_0122;
    const ccomplex_t IT_0124 = IT_0121*IT_0123;
    const ccomplex_t IT_0125 = cpow((-2)*s_13 + IT_0002 + IT_0061 + -m_smu_R*
    ...
    const ccomplex_t IT_0129 = IT_0041*IT_0087;
    const ccomplex_t IT_0130 = IT_0043*IT_0128*IT_0129;
    const ccomplex_t IT_0131 = m_N_2*IT_0064;
    const ccomplex_t IT_0132 = IT_0119 + IT_0127 + -IT_0130 + (-0.5)*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0134 = IT_0024*IT_0067;
    const ccomplex_t IT_0135 = IT_0003*IT_0133*IT_0134;
    const ccomplex_t IT_0136 = m_mu*IT_0027;
    const ccomplex_t IT_0137 = m_mu*IT_0045;
    const ccomplex_t IT_0138 = IT_0135 + -IT_0136 + -IT_0137;
    const ccomplex_t IT_0139 = IT_0006*IT_0082;
    const ccomplex_t IT_0140 = IT_0003*IT_0133*IT_0139;
    const ccomplex_t IT_0141 = m_mu*IT_0085;
    const ccomplex_t IT_0142 = m_mu*IT_0103;
    const ccomplex_t IT_0143 = IT_0140 + -IT_0141 + -IT_0142;
    const ccomplex_t IT_0144 = IT_0028*IT_0100;
    const ccomplex_t IT_0145 = IT_0043*IT_0128*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*(IT_0054 + IT_0057);
    ...
    const ccomplex_t IT_0151 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0005*IT_0047*IT_0048;
    ...
    const ccomplex_t IT_0156 = -IT_0145 + -IT_0150 + -IT_0155;
    const ccomplex_t IT_0157 = 2*IT_0132;
    const ccomplex_t IT_0158 = (-2)*IT_0138;
    const ccomplex_t IT_0159 = IT_0157 + IT_0158;
    const ccomplex_t IT_0160 = 2*conj(IT_0132);
    ...
    const ccomplex_t IT_0173 = 2*IT_0001*(conj(IT_0046)*IT_0105 + IT_0046
      ...
      *IT_0111*((conj(IT_0132) + -conj(IT_0138))*IT_0143 + (IT_0132 + -IT_0138)
      ...
      *IT_0166 + IT_0105*IT_0169)*IT_0170 + (IT_0132*conj(IT_0132) + IT_0138
      *conj(IT_0138) + IT_0143*conj(IT_0143) + IT_0156*conj(IT_0156))*IT_0171 + 
      (conj(IT_0132)*IT_0138 + IT_0132*conj(IT_0138) + conj(IT_0143)*IT_0156 +
       IT_0143*conj(IT_0156))*IT_0172;
