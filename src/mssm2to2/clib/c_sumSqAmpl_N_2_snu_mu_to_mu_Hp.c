        ...
        )
{
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
    ...
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0005*IT_0047*IT_0048;
    ...
    const ccomplex_t IT_0116 = m_mu*IT_0115;
    ...
    const ccomplex_t IT_0129 = cpow((-2)*s_13 + IT_0002 + IT_0061 + -m_smu_L*
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0002 + IT_0061 + -m_smu_R*
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0005*IT_0047;
