        ...
        )
{
    ...
    const ccomplex_t IT_0031 = N_B2*N_d2*e_em;
    ...
    const ccomplex_t IT_0036 = IT_0006*IT_0016;
    const ccomplex_t IT_0037 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0069 = N_W3*N_u2*e_em;
    ...
    const ccomplex_t IT_0098 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0102 = conj(N_B3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0121 = cpow(s_23 + (-0.5)*IT_0026 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0138 = IT_0033*IT_0137;
    ...
    const ccomplex_t IT_0149 = IT_0039*IT_0148;
    ...
    const ccomplex_t IT_0210 = IT_0039*IT_0209;
