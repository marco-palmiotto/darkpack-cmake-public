        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0017 = N_u2*conj(N_u2)*e_em;
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = IT_0000*IT_0006;
    const ccomplex_t IT_0020 = IT_0017*IT_0019;
    const ccomplex_t IT_0021 = N_d2*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0028 = m_N_2*IT_0027;
    ...
    const ccomplex_t IT_0040 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_1*(m_N_1 +
       (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = conj(N_d1)*N_d2*e_em;
    const ccomplex_t IT_0044 = IT_0016*IT_0043;
    const ccomplex_t IT_0045 = IT_0019*IT_0043;
    const ccomplex_t IT_0046 = conj(N_u1)*N_u2*e_em;
    const ccomplex_t IT_0047 = IT_0016*IT_0046;
    const ccomplex_t IT_0048 = IT_0019*IT_0046;
    ...
    const ccomplex_t IT_0064 = (-0.25)*IT_0031 + (-0.5)*IT_0063;
    const ccomplex_t IT_0065 = N_u2*conj(N_u3)*e_em;
    const ccomplex_t IT_0066 = IT_0016*IT_0065;
    const ccomplex_t IT_0067 = IT_0019*IT_0065;
    const ccomplex_t IT_0068 = N_d2*conj(N_d3)*e_em;
    const ccomplex_t IT_0069 = IT_0016*IT_0068;
    const ccomplex_t IT_0070 = IT_0019*IT_0068;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*(IT_0066 + IT_0067 + 
      -IT_0069 + -IT_0070);
    const ccomplex_t IT_0072 = (-0.5)*IT_0071;
    const ccomplex_t IT_0073 = m_N_3*IT_0072;
    const ccomplex_t IT_0074 = conj(N_d2)*N_d3*e_em;
    const ccomplex_t IT_0075 = IT_0016*IT_0074;
    const ccomplex_t IT_0076 = IT_0019*IT_0074;
    const ccomplex_t IT_0077 = conj(N_u2)*N_u3*e_em;
    const ccomplex_t IT_0078 = IT_0016*IT_0077;
    const ccomplex_t IT_0079 = IT_0019*IT_0077;
    ...
    const ccomplex_t IT_0093 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0099 = IT_0019*IT_0097;
    const ccomplex_t IT_0100 = N_d2*conj(N_d4)*e_em;
    const ccomplex_t IT_0101 = IT_0016*IT_0100;
    const ccomplex_t IT_0102 = IT_0019*IT_0100;
    ...
    const ccomplex_t IT_0125 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0129 = (-0.25)*IT_0031 + 0.5*IT_0096 + 0.5*IT_0128;
    ...
    const ccomplex_t IT_0139 = conj(IT_0064) + conj(IT_0129);
    ...
    const ccomplex_t IT_0144 = IT_0132 + IT_0134 + IT_0143;
    const ccomplex_t IT_0145 = IT_0015*IT_0027;
    const ccomplex_t IT_0146 = IT_0042*IT_0059;
    const ccomplex_t IT_0147 = (-0.25)*IT_0145 + (-0.5)*IT_0146;
    const ccomplex_t IT_0148 = IT_0081*IT_0095;
    const ccomplex_t IT_0149 = IT_0015*IT_0025;
    const ccomplex_t IT_0150 = IT_0113*IT_0127;
    const ccomplex_t IT_0151 = (-0.5)*IT_0148 + (-0.25)*IT_0149 + (-0.5)
      *IT_0150;
    ...
    const ccomplex_t IT_0160 = pow(m_N_2, 2);
    const ccomplex_t IT_0161 = cpow(s_12 + 0.5*IT_0012 + 0.5*IT_0160 + 0.5
      *reg_prop, -1);
    ...
    const ccomplex_t IT_0165 = (-0.25)*IT_0142;
    const ccomplex_t IT_0166 = IT_0133 + IT_0165;
    const ccomplex_t IT_0167 = s_34*IT_0131;
    const ccomplex_t IT_0168 = IT_0130*IT_0167;
    ...
    const ccomplex_t IT_0173 = 2*conj(IT_0064);
    const ccomplex_t IT_0174 = 2*conj(IT_0129);
    const ccomplex_t IT_0175 = IT_0173 + IT_0174;
    const ccomplex_t IT_0176 = s_14*s_34*IT_0130;
    ...
    const ccomplex_t IT_0187 = 0.5*IT_0145 + IT_0146;
    const ccomplex_t IT_0188 = 2*IT_0187;
    const ccomplex_t IT_0189 = IT_0148 + 0.5*IT_0149 + IT_0150 + 0.5*IT_0185;
    ...
    const ccomplex_t IT_0195 = m_N_2*IT_0178;
    const ccomplex_t IT_0196 = pow(s_34, 2);
    const ccomplex_t IT_0197 = s_13*IT_0130*IT_0196;
    const ccomplex_t IT_0198 = 2*IT_0186;
    const ccomplex_t IT_0199 = m_N_2*IT_0130*IT_0196;
    const ccomplex_t IT_0200 = 2*conj(IT_0186);
    const ccomplex_t IT_0201 = s_13*s_34;
    const ccomplex_t IT_0202 = conj(IT_0147) + conj(IT_0164);
    const ccomplex_t IT_0203 = IT_0147 + IT_0164;
    ...
    const ccomplex_t IT_0208 = 2*IT_0129;
    const ccomplex_t IT_0209 = pow(s_14, 2);
    const ccomplex_t IT_0210 = IT_0130*IT_0209;
    ...
    const ccomplex_t IT_0222 = 4*(IT_0064 + IT_0129)*IT_0138*IT_0139 + (-4)
      *IT_0144*IT_0152*IT_0154 + 8*IT_0164*(IT_0154*IT_0166 + 0.125*IT_0172
      *IT_0175) + IT_0179*(conj(IT_0186)*IT_0191 + IT_0186*IT_0194) + (IT_0139
      *IT_0191 + (IT_0064 + IT_0129)*IT_0194)*IT_0195 + conj(IT_0186)*IT_0197
      *IT_0198 + IT_0199*(IT_0139*IT_0198 + (IT_0064 + IT_0129)*IT_0200) + (-2)
      *IT_0201*(conj(IT_0151)*IT_0186 + IT_0151*conj(IT_0186) + (-0.5)*IT_0198
      *IT_0202 + (-0.5)*IT_0200*IT_0203) + (-2)*IT_0207*(IT_0139*IT_0147 +
       IT_0129*conj(IT_0147) + IT_0064*IT_0154 + (-0.5)*IT_0151*IT_0175 + (-0.5)
      *conj(IT_0151)*IT_0208) + (-4)*conj(IT_0164)*(IT_0144*IT_0164 + (-2)
      *IT_0152*IT_0166 + (-0.5)*IT_0172*(IT_0064 + 0.5*IT_0208)) + (-2)*IT_0213*
      ((-0.5)*conj(IT_0187)*IT_0188 + conj(IT_0189)*IT_0216 + (-0.5)*IT_0189
      *IT_0217) + (IT_0191*IT_0202 + IT_0194*IT_0203 + 2*IT_0153*IT_0216 + 2
      *IT_0151*(conj(IT_0189) + 0.5*IT_0217))*IT_0221;
