        ...
        )
{
    ...
    const ccomplex_t IT_0030 = IT_0001*IT_0015;
    const ccomplex_t IT_0031 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = IT_0001*IT_0018;
    const ccomplex_t IT_0034 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = IT_0006*IT_0015;
    const ccomplex_t IT_0037 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = IT_0006*IT_0018;
    const ccomplex_t IT_0040 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0045 = conj(N_B2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0049 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0069 = N_B3*N_u2*e_em;
    ...
    const ccomplex_t IT_0078 = N_W3*N_u2*e_em;
    ...
    const ccomplex_t IT_0123 = cpow(s_23 + (-0.5)*IT_0026 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0138 = IT_0039*IT_0137;
    ...
    const ccomplex_t IT_0162 = IT_0036*IT_0161;
    ...
    const ccomplex_t IT_0210 = IT_0030*IT_0209;
    const ccomplex_t IT_0211 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0212 = IT_0033*IT_0211;
    ...
    const ccomplex_t IT_0217 = IT_0039*IT_0216;
    const ccomplex_t IT_0218 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0219 = IT_0036*IT_0218;
