...
ccomplex_return_t c_sumSqAmpl_N_2_snu_tau_to_nu_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0022 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0023 = IT_0021*IT_0022;
    const ccomplex_t IT_0024 = IT_0006*IT_0016;
    const ccomplex_t IT_0025 = N_W2*N_u1*e_em;
    ...
    const ccomplex_t IT_0032 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0033 = IT_0021*IT_0032;
    const ccomplex_t IT_0034 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0035 = IT_0024*IT_0034;
    const ccomplex_t IT_0036 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0040 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0048 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0049 = IT_0017*IT_0048;
    const ccomplex_t IT_0050 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0051 = IT_0021*IT_0050;
    const ccomplex_t IT_0052 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0105 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0112 = IT_0021*IT_0111;
    const ccomplex_t IT_0113 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0114 = IT_0024*IT_0113;
    const ccomplex_t IT_0115 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0116 = IT_0027*IT_0115;
    const ccomplex_t IT_0117 = N_B2*N_u4*e_em;
    ...
    const ccomplex_t IT_0125 = (-0.5)*IT_0110 + 0.5*IT_0112 + 0.5*IT_0114 + (
      -0.5)*IT_0116 + (-0.5)*IT_0118 + 0.5*IT_0120 + 0.5*IT_0122 + (-0.5)*IT_0124;
    const ccomplex_t IT_0126 = m_N_2*IT_0125;
    const ccomplex_t IT_0127 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0128 = IT_0017*IT_0127;
    const ccomplex_t IT_0129 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0130 = IT_0021*IT_0129;
    const ccomplex_t IT_0131 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0132 = IT_0024*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0141 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0145 = IT_0126 + IT_0144;
    ...
    const ccomplex_t IT_0154 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0168 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0169 = IT_0017*IT_0168;
    const ccomplex_t IT_0170 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0171 = IT_0021*IT_0170;
    const ccomplex_t IT_0172 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0173 = IT_0024*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0187 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0191 = 0.5*IT_0059 + 0.5*IT_0108 + 0.5*IT_0157 + 0.5
      *IT_0190;
    const ccomplex_t IT_0192 = IT_0166*IT_0189;
    const ccomplex_t IT_0193 = IT_0015*IT_0038;
    const ccomplex_t IT_0194 = IT_0076*IT_0107;
    const ccomplex_t IT_0195 = IT_0125*IT_0156;
    const ccomplex_t IT_0196 = (-0.5)*IT_0192 + (-0.5)*IT_0193 + (-0.5)
      *IT_0194 + (-0.5)*IT_0195;
    const ccomplex_t IT_0197 = s_34*m_N_2;
