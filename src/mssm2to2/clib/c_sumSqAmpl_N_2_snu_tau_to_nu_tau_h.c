        ...
        )
{
    ...
    const ccomplex_t IT_0041 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0042 = IT_0026*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0044 = IT_0029*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0046 = IT_0032*IT_0045;
    const ccomplex_t IT_0047 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0066 = cpow(s_23 + (-0.5)*IT_0053 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0078 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0079 = IT_0032*IT_0078;
    const ccomplex_t IT_0080 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0081 = IT_0035*IT_0080;
    const ccomplex_t IT_0082 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0083 = IT_0032*IT_0082;
    const ccomplex_t IT_0084 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0123 = cpow(s_23 + (-0.5)*IT_0053 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0180 = cpow(s_23 + (-0.5)*IT_0053 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0192 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0193 = IT_0032*IT_0192;
    const ccomplex_t IT_0194 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0195 = IT_0035*IT_0194;
    const ccomplex_t IT_0196 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0197 = IT_0032*IT_0196;
    const ccomplex_t IT_0198 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0215 = IT_0032*IT_0214;
    const ccomplex_t IT_0216 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0217 = IT_0035*IT_0216;
    ...
    const ccomplex_t IT_0229 = 0.5*IT_0025 + 0.5*IT_0057 + 0.5*IT_0114 + 0.5
      *IT_0171 + 0.5*IT_0228;
    const ccomplex_t IT_0230 = IT_0039*IT_0056;
    const ccomplex_t IT_0231 = IT_0068*IT_0089;
    const ccomplex_t IT_0232 = IT_0182*IT_0203;
    const ccomplex_t IT_0233 = IT_0125*IT_0146;
    const ccomplex_t IT_0234 = (-0.5)*IT_0230 + (-0.5)*IT_0231 + (-0.5)
      *IT_0232 + (-0.5)*IT_0233;
    const ccomplex_t IT_0235 = s_34*m_N_2;
