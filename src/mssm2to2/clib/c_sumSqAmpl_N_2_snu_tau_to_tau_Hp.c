...
ccomplex_return_t c_sumSqAmpl_N_2_snu_tau_to_tau_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_N_2*m_tau*IT_0000;
    const ccomplex_t IT_0002 = pow(m_tau, 2);
    const ccomplex_t IT_0003 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0002 +
       0.5*m_C_2*(m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0004 = sin(theta_W);
    const ccomplex_t IT_0005 = cpow(IT_0004, -1);
    const ccomplex_t IT_0006 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0005;
    ...
    const ccomplex_t IT_0028 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0002 +
       0.5*m_C_1*(m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0005;
    const ccomplex_t IT_0030 = N_B2*V_u1*e_em;
    const ccomplex_t IT_0031 = IT_0014*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = N_W2*V_u1*e_em;
    ...
    const ccomplex_t IT_0037 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0049 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (-2)*IT_0050;
    const ccomplex_t IT_0052 = IT_0013*IT_0047;
    const ccomplex_t IT_0053 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em
      *m_tau*IT_0005*IT_0063*IT_0064;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
      *m_tau*IT_0005*IT_0063*IT_0064;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0005*IT_0047*IT_0063*IT_0064;
    ...
    const ccomplex_t IT_0100 = pow(m_N_2, 2);
    ...
    const ccomplex_t IT_0111 = m_N_2*m_tau;
    const ccomplex_t IT_0112 = IT_0027 + IT_0045;
    const ccomplex_t IT_0113 = m_tau*IT_0112;
    const ccomplex_t IT_0114 = 0.5*IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*(A_tau*IT_0047*conj
      (U_stau_11) + (-1.4142135623731)*e_em*IT_0005*(m_W*IT_0007*IT_0047*conj
      (U_stau_01) + (-0.5)*m_tau*IT_0063*(m_tau*IT_0047*IT_0064*conj(U_stau_01) 
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0116 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0117 = IT_0013*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = IT_0005*IT_0064;
    const ccomplex_t IT_0120 = N_d2*e_em*m_tau*IT_0063*U_stau_01;
    ...
    const ccomplex_t IT_0126 = cpow(s_13 + (-0.5)*IT_0002 + (-0.5)*IT_0100 + (
    ...
    const ccomplex_t IT_0130 = IT_0024*IT_0084;
    const ccomplex_t IT_0131 = IT_0003*IT_0129*IT_0130;
    const ccomplex_t IT_0132 = cpow(s_13 + (-0.5)*IT_0002 + (-0.5)*IT_0100 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*(A_tau*IT_0047*conj
      (U_stau_10) + (-1.4142135623731)*e_em*IT_0005*(m_W*IT_0007*IT_0047*conj
      (U_stau_00) + (-0.5)*m_tau*IT_0063*(m_tau*IT_0047*IT_0064*conj(U_stau_00) 
      + mu_h*conj(U_stau_10))));
    const ccomplex_t IT_0134 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0135 = IT_0013*IT_0134;
    const ccomplex_t IT_0136 = 1.4142135623731*IT_0135;
    const ccomplex_t IT_0137 = N_d2*e_em*m_tau*IT_0063*U_stau_00;
    ...
    const ccomplex_t IT_0146 = IT_0042*IT_0066;
    const ccomplex_t IT_0147 = IT_0028*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = m_N_2*IT_0103;
    const ccomplex_t IT_0149 = (-0.5)*IT_0128 + 0.5*IT_0131 + (-0.5)*IT_0144 +
       0.5*IT_0147 + (-0.5)*IT_0148;
    const ccomplex_t IT_0150 = IT_0069 + IT_0087;
    const ccomplex_t IT_0151 = m_tau*IT_0150;
    const ccomplex_t IT_0152 = 0.5*IT_0151;
    const ccomplex_t IT_0153 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0154 = IT_0013*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0157 = IT_0005*IT_0156;
    const ccomplex_t IT_0158 = 1.4142135623731*IT_0157;
    const ccomplex_t IT_0159 = conj(N_d2)*e_em*m_tau*IT_0063*U_stau_11;
    ...
    const ccomplex_t IT_0164 = IT_0115*IT_0163;
    const ccomplex_t IT_0165 = IT_0126*IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*IT_0165;
    const ccomplex_t IT_0167 = IT_0029*IT_0062;
    const ccomplex_t IT_0168 = IT_0028*IT_0145*IT_0167;
    const ccomplex_t IT_0169 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0170 = IT_0013*IT_0169;
    const ccomplex_t IT_0171 = 1.4142135623731*IT_0170;
    const ccomplex_t IT_0172 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0173 = IT_0005*IT_0172;
    const ccomplex_t IT_0174 = 1.4142135623731*IT_0173;
    const ccomplex_t IT_0175 = conj(N_d2)*e_em*m_tau*IT_0063*U_stau_10;
    const ccomplex_t IT_0176 = IT_0119*IT_0175;
    ...
    const ccomplex_t IT_0180 = IT_0133*IT_0179;
    const ccomplex_t IT_0181 = IT_0132*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*IT_0181;
    const ccomplex_t IT_0183 = IT_0006*IT_0082;
    const ccomplex_t IT_0184 = IT_0003*IT_0129*IT_0183;
    const ccomplex_t IT_0185 = 0.5*IT_0166 + 0.5*IT_0168 + 0.5*IT_0182 + 0.5
      *IT_0184;
    const ccomplex_t IT_0186 = 2*IT_0149;
    const ccomplex_t IT_0187 = (-2)*IT_0114;
    const ccomplex_t IT_0188 = IT_0186 + IT_0187;
    const ccomplex_t IT_0189 = 2*conj(IT_0149);
    const ccomplex_t IT_0190 = (-2)*conj(IT_0114);
    const ccomplex_t IT_0191 = IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = s_23*m_N_2;
    const ccomplex_t IT_0193 = 2*IT_0185;
    const ccomplex_t IT_0194 = (-2)*IT_0152;
    const ccomplex_t IT_0195 = IT_0193 + IT_0194;
    const ccomplex_t IT_0196 = 2*conj(IT_0185);
    const ccomplex_t IT_0197 = (-2)*conj(IT_0152);
    const ccomplex_t IT_0198 = IT_0196 + IT_0197;
    const ccomplex_t IT_0199 = s_12*m_tau;
    const ccomplex_t IT_0200 = 2*s_13;
    const ccomplex_t IT_0201 = (-2)*s_13;
    const ccomplex_t IT_0202 = 2*IT_0001*(conj(IT_0046)*IT_0105 + IT_0046
      *IT_0106) + 4*(IT_0046*conj(IT_0046) + IT_0105*IT_0106)*IT_0110 + 2
      *IT_0111*((conj(IT_0114) + -conj(IT_0149))*IT_0152 + (IT_0114 + -IT_0149)
      *conj(IT_0152) + 0.5*conj(IT_0185)*IT_0188 + 0.5*IT_0185*IT_0191) +
       IT_0192*(IT_0106*IT_0188 + IT_0105*IT_0191 + conj(IT_0046)*IT_0195 +
       IT_0046*IT_0198) + (conj(IT_0046)*IT_0188 + IT_0046*IT_0191 + IT_0106
      *IT_0195 + IT_0105*IT_0198)*IT_0199 + (IT_0114*conj(IT_0114) + IT_0149
      *conj(IT_0149) + IT_0152*conj(IT_0152) + IT_0185*conj(IT_0185))*IT_0200 + 
      (conj(IT_0114)*IT_0149 + IT_0114*conj(IT_0149) + conj(IT_0152)*IT_0185 +
       IT_0152*conj(IT_0185))*IT_0201;
