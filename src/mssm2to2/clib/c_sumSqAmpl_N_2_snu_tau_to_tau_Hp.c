        ...
        )
{
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
      *m_tau*IT_0005*IT_0047*IT_0048;
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = sin(beta);
    const ccomplex_t IT_0052 = IT_0005*IT_0051;
    const ccomplex_t IT_0053 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = (-2)*IT_0054;
    const ccomplex_t IT_0056 = IT_0013*IT_0051;
    const ccomplex_t IT_0057 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em
      *m_tau*IT_0005*IT_0047*IT_0048;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0005*IT_0047*IT_0048*IT_0051;
    ...
    const ccomplex_t IT_0116 = IT_0042*IT_0071;
    const ccomplex_t IT_0117 = IT_0028*IT_0115*IT_0116;
    const ccomplex_t IT_0118 = cpow(s_13 + (-0.5)*IT_0002 + (-0.5)*IT_0100 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*(A_tau*IT_0051*conj
      (U_stau_11) + (-1.4142135623731)*e_em*IT_0005*(m_W*IT_0007*IT_0051*conj
      (U_stau_01) + (-0.5)*m_tau*IT_0047*(m_tau*IT_0048*IT_0051*conj(U_stau_01) 
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0120 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0121 = IT_0013*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = IT_0005*IT_0048;
    const ccomplex_t IT_0124 = N_d2*e_em*m_tau*IT_0047*U_stau_01;
    ...
    const ccomplex_t IT_0133 = IT_0024*IT_0050;
    const ccomplex_t IT_0134 = IT_0003*IT_0132*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*(A_tau*IT_0051*conj
      (U_stau_10) + (-1.4142135623731)*e_em*IT_0005*(m_W*IT_0007*IT_0051*conj
    ...
    const ccomplex_t IT_0139 = N_d2*e_em*m_tau*IT_0047*U_stau_00;
    ...
    const ccomplex_t IT_0145 = cpow(s_13 + (-0.5)*IT_0002 + (-0.5)*IT_0100 + (
    ...
    const ccomplex_t IT_0149 = 0.5*IT_0117 + (-0.5)*IT_0131 + 0.5*IT_0134 + (
    ...
    const ccomplex_t IT_0153 = IT_0029*IT_0084;
    const ccomplex_t IT_0154 = IT_0028*IT_0115*IT_0153;
    const ccomplex_t IT_0155 = IT_0006*IT_0066;
    const ccomplex_t IT_0156 = IT_0003*IT_0132*IT_0155;
    const ccomplex_t IT_0157 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0158 = IT_0013*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0161 = IT_0005*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = conj(N_d2)*e_em*m_tau*IT_0047*U_stau_11;
    ...
    const ccomplex_t IT_0185 = 0.5*IT_0154 + 0.5*IT_0156 + 0.5*IT_0170 + 0.5
      *IT_0184;
