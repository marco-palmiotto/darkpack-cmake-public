...
ccomplex_return_t c_sumSqAmpl_N_2_ss_L_to_c_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_12 + -IT_0027 + IT_0030 + -IT_0031 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_C_1*
    ...
    const ccomplex_t IT_0070 = IT_0032*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = m_N_2*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
    ...
    const ccomplex_t IT_0078 = cpow((-2)*s_13 + IT_0026 + IT_0031 + -m_sc_R*
    ...
    const ccomplex_t IT_0085 = m_c*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*(-2.82842712474619))*V_cs*e_em
      *IT_0004*((m_W*IT_0001 + (-0.5)*IT_0000*IT_0002*IT_0026)*IT_0034 + -1./2
      *IT_0000*IT_0001*IT_0030*IT_0035);
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_13 + IT_0026 + IT_0031 + -m_sc_L*
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0096 = 0.5*IT_0095;
    const ccomplex_t IT_0097 = IT_0055*IT_0096;
    const ccomplex_t IT_0098 = IT_0057*IT_0094*IT_0097;
    const ccomplex_t IT_0099 = IT_0029 + -IT_0041 + -IT_0060 + IT_0072 +
       IT_0080 + -IT_0085 + IT_0093 + IT_0098;
    const ccomplex_t IT_0100 = IT_0004*IT_0034;
    ...
    const ccomplex_t IT_0104 = IT_0012*IT_0034;
    ...
    const ccomplex_t IT_0116 = IT_0057*IT_0094*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*(IT_0063 + 3*IT_0066);
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0141 = IT_0025*IT_0028*IT_0140;
    ...
    const ccomplex_t IT_0144 = IT_0068*IT_0143;
    const ccomplex_t IT_0145 = IT_0032*IT_0033*IT_0144;
    ...
    const ccomplex_t IT_0150 = IT_0037*IT_0143;
    ...
    const ccomplex_t IT_0154 = IT_0096*IT_0114;
