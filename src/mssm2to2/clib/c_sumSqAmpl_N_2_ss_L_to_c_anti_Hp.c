        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0026 = N_B2*U_d1*e_em;
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = 1.4142135623731*IT_0027;
    const ccomplex_t IT_0029 = N_W2*U_d1*e_em;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
    ...
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0005*IT_0009*IT_0013;
    ...
    const ccomplex_t IT_0168 = m_c*m_N_2*IT_0002;
