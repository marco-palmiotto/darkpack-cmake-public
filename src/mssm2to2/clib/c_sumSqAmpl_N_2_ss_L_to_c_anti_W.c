        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_W2*e_em*conj(V_Wp2);
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = N_u2*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0021 = N_W2*e_em*conj(V_Wp1);
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = N_u2*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0004;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0004;
    ...
    const ccomplex_t IT_0132 = IT_0027*IT_0070;
    const ccomplex_t IT_0133 = IT_0020*IT_0131*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0135 = IT_0013*IT_0081;
    const ccomplex_t IT_0136 = IT_0017*IT_0134*IT_0135;
    ...
    const ccomplex_t IT_0148 = m_c*IT_0104;
    const ccomplex_t IT_0149 = m_N_2*IT_0032;
    const ccomplex_t IT_0150 = -IT_0147 + -IT_0148 + -IT_0149;
    const ccomplex_t IT_0151 = IT_0006*IT_0088;
    const ccomplex_t IT_0152 = IT_0017*IT_0134*IT_0151;
    const ccomplex_t IT_0153 = IT_0029*IT_0077;
    const ccomplex_t IT_0154 = IT_0020*IT_0131*IT_0153;
    ...
    const ccomplex_t IT_0196 = (-6)*IT_0105;
    const ccomplex_t IT_0197 = IT_0063*IT_0178;
    const ccomplex_t IT_0198 = (-6)*conj(IT_0105);
    ...
    const ccomplex_t IT_0200 = (-6)*conj(IT_0092)*(IT_0065*IT_0095 + (
      ...
      -0.166666666666667)*IT_0104*IT_0160 + -IT_0069*IT_0164 + (
      -0.166666666666667)*IT_0109*IT_0174 + IT_0146*(IT_0139 + (
      -0.166666666666667)*IT_0199));
    const ccomplex_t IT_0201 = (-6)*conj(IT_0137);
    const ccomplex_t IT_0202 = (-6)*conj(IT_0161);
    ...
    const ccomplex_t IT_0207 = (-6)*IT_0161;
    ...
    const ccomplex_t IT_0210 = IT_0063*((-18)*IT_0137 + (-18)*IT_0139) +
       IT_0174*IT_0183 + IT_0156*IT_0195 + IT_0179*IT_0196 + IT_0188*IT_0205 +
       IT_0146*IT_0206 + IT_0204*(IT_0062 + 0.166666666666667*IT_0207) + IT_0172
      *IT_0208 + IT_0123*IT_0209;
    const ccomplex_t IT_0211 = IT_0063*((-18)*IT_0150 + (-18)*IT_0155) +
       IT_0174*IT_0179 + 6*IT_0164*IT_0188 + IT_0140*IT_0195 + IT_0183*IT_0196 +
       6*IT_0042*IT_0203 + IT_0123*IT_0206 + IT_0168*IT_0208 + IT_0146*IT_0209;
    const ccomplex_t IT_0212 = 0.166666666666667*IT_0187;
    const ccomplex_t IT_0213 = s_13*IT_0178;
    const ccomplex_t IT_0214 = 0.166666666666667*IT_0213;
    const ccomplex_t IT_0215 = (-6)*conj(IT_0062);
    const ccomplex_t IT_0216 = IT_0173*IT_0186;
    const ccomplex_t IT_0217 = 6*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      *IT_0064 + IT_0065*IT_0069) + IT_0157 + IT_0063*IT_0156*IT_0158 + 6*conj
      (IT_0104)*(IT_0065*IT_0096 + 0.166666666666667*IT_0104*IT_0117 +
       0.166666666666667*IT_0092*IT_0160 + IT_0069*IT_0164 + IT_0140*IT_0168 +
       IT_0156*IT_0172 + 0.166666666666667*IT_0109*IT_0174) + (IT_0139*IT_0179 +
       IT_0156*IT_0183 + IT_0109*IT_0184)*IT_0185 + (IT_0064*IT_0161 + IT_0105
      *IT_0186 + IT_0173*IT_0187 + IT_0156*IT_0188)*IT_0189 + 6*conj(IT_0137)*
      (IT_0065*IT_0123 + IT_0104*IT_0168 + IT_0161*IT_0188 + 0.166666666666667
      *IT_0140*IT_0195 + 0.166666666666667*IT_0183*IT_0196) + (IT_0156*IT_0179 +
       IT_0140*IT_0183 + IT_0062*IT_0187 + IT_0173*IT_0197)*IT_0198 + IT_0200 + 
      (IT_0092*IT_0146 + IT_0173*IT_0179 + IT_0062*IT_0188)*IT_0201 + (IT_0042
      ...
      *IT_0210 + conj(IT_0139)*IT_0211 + 6*conj(IT_0062)*(IT_0048*IT_0062 +
       IT_0042*IT_0064 + 0.166666666666667*IT_0188*IT_0199 + IT_0196*IT_0212) +
       6*conj(IT_0173)*(IT_0164*IT_0186 + 0.166666666666667*IT_0196*IT_0197 +
       0.166666666666667*IT_0179*IT_0199 + IT_0205*IT_0212 + IT_0174*IT_0214) +
       6*conj(IT_0105)*(IT_0065*IT_0109 + IT_0161*IT_0187 + 0.166666666666667
      *IT_0186*IT_0205 + IT_0196*IT_0214) + IT_0215*(IT_0048*IT_0161 + IT_0069
      *IT_0184 + IT_0139*IT_0188 + IT_0216) + 6*conj(IT_0161)*(IT_0048*IT_0164 +
       IT_0069*IT_0184 + IT_0105*IT_0187 + IT_0140*IT_0188 + 0.166666666666667
