...
ccomplex_return_t c_sumSqAmpl_N_2_ss_L_to_s_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0048 = m_s*s_14*m_N_2;
    ...
    const ccomplex_t IT_0058 = m_s*m_N_2;
    ...
    const ccomplex_t IT_0063 = m_s*s_34*m_N_2;
