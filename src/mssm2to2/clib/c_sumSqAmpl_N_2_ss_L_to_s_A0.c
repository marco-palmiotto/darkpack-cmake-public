        ...
        )
{
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0011*IT_0031*IT_0032;
    const ccomplex_t IT_0034 = (-0.5)*IT_0033;
    const ccomplex_t IT_0035 = pow(m_s, 2);
    const ccomplex_t IT_0036 = pow(m_ss_L, 2);
    ...
    const ccomplex_t IT_0043 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0044 = IT_0007*IT_0043;
    const ccomplex_t IT_0045 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0046 = IT_0012*IT_0045;
    const ccomplex_t IT_0047 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0048 = IT_0015*IT_0047;
    const ccomplex_t IT_0049 = N_B1*N_u2*e_em;
    ...
    const ccomplex_t IT_0055 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0061 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0062 = IT_0007*IT_0061;
    const ccomplex_t IT_0063 = conj(N_W1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0069 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0070 = IT_0007*IT_0069;
    const ccomplex_t IT_0071 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0072 = IT_0012*IT_0071;
    const ccomplex_t IT_0073 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0011*IT_0031*IT_0032;
    const ccomplex_t IT_0079 = (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_1*
    ...
    const ccomplex_t IT_0084 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0085 = IT_0003*IT_0084;
    const ccomplex_t IT_0086 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0087 = IT_0007*IT_0086;
    const ccomplex_t IT_0088 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0089 = IT_0012*IT_0088;
    const ccomplex_t IT_0090 = N_W3*N_d2*e_em;
    ...
    const ccomplex_t IT_0100 = (-0.5)*IT_0085 + 0.5*IT_0087 + 0.5*IT_0089 + (
      -0.5)*IT_0091 + (-0.5)*IT_0093 + 0.5*IT_0095 + 0.5*IT_0097 + (-0.5)*IT_0099;
    ...
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0011*IT_0031*IT_0032;
    const ccomplex_t IT_0122 = (-0.5)*IT_0121;
    const ccomplex_t IT_0123 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_3*
    ...
    const ccomplex_t IT_0127 = m_s*e_em*mu_h*IT_0031;
    const ccomplex_t IT_0128 = IT_0011*IT_0127;
    const ccomplex_t IT_0129 = A_b*V_ts*conj(V_ts);
    const ccomplex_t IT_0130 = IT_0006*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = 0.5*IT_0128 + 0.5*IT_0131;
    ...
    const ccomplex_t IT_0137 = cpow((-2)*s_13 + IT_0035 + IT_0136 + -m_ss_R*
    ...
    const ccomplex_t IT_0142 = cpow((-2)*s_23 + IT_0035 + IT_0036 + -m_N_4*
    ...
    const ccomplex_t IT_0183 = IT_0040 + IT_0083 + IT_0126 + IT_0139 + IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0011*IT_0031*IT_0032;
    const ccomplex_t IT_0185 = 0.5*IT_0184;
    const ccomplex_t IT_0186 = IT_0132*IT_0185;
    const ccomplex_t IT_0187 = IT_0137*IT_0186;
    ...
    const ccomplex_t IT_0208 = IT_0080*IT_0207;
    const ccomplex_t IT_0209 = (0 + _Complex_I*1)*IT_0208;
    const ccomplex_t IT_0210 = m_N_2*IT_0057;
    const ccomplex_t IT_0211 = m_N_1*IT_0075;
    ...
    const ccomplex_t IT_0222 = IT_0123*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = m_N_2*IT_0100;
    const ccomplex_t IT_0225 = m_N_3*IT_0118;
    const ccomplex_t IT_0226 = IT_0224 + IT_0225;
    const ccomplex_t IT_0227 = IT_0223*IT_0226;
    const ccomplex_t IT_0228 = m_N_2*IT_0161;
    const ccomplex_t IT_0229 = m_N_4*IT_0179;
    ...
    const ccomplex_t IT_0239 = IT_0142*IT_0238;
    ...
    const ccomplex_t IT_0244 = m_s*m_N_2;
    const ccomplex_t IT_0245 = 6*IT_0183;
    const ccomplex_t IT_0246 = IT_0057*IT_0209;
    const ccomplex_t IT_0247 = IT_0100*IT_0223;
    const ccomplex_t IT_0248 = m_s*e_em*IT_0006*IT_0011*IT_0031*IT_0032;
    const ccomplex_t IT_0249 = (-0.5)*IT_0248;
    const ccomplex_t IT_0250 = IT_0034*IT_0249;
    const ccomplex_t IT_0251 = cpow((-2)*s_12 + IT_0035 + -IT_0036 + -IT_0136 
      + -reg_prop, -1);
    const ccomplex_t IT_0252 = IT_0250*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = IT_0018*IT_0198;
    const ccomplex_t IT_0255 = IT_0161*IT_0240;
    const ccomplex_t IT_0256 = IT_0246 + IT_0247 + -IT_0253 + IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = m_s*s_14;
    const ccomplex_t IT_0258 = IT_0028*IT_0039;
    const ccomplex_t IT_0259 = IT_0118*IT_0125;
    const ccomplex_t IT_0260 = IT_0144*IT_0179;
    const ccomplex_t IT_0261 = IT_0196*IT_0249;
    const ccomplex_t IT_0262 = IT_0251*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1)*IT_0262;
    const ccomplex_t IT_0264 = IT_0075*IT_0082;
    const ccomplex_t IT_0265 = -IT_0258 + -IT_0259 + -IT_0260 + -IT_0263 + 
      -IT_0264;
