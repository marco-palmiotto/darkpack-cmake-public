...
ccomplex_return_t c_sumSqAmpl_N_2_ss_L_to_s_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0246 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
