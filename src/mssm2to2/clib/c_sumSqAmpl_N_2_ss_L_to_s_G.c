...
ccomplex_return_t c_sumSqAmpl_N_2_ss_L_to_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_ss_L*
    ...
    const ccomplex_t IT_0045 = m_s*s_14*m_N_2;
    ...
    const ccomplex_t IT_0057 = m_s*m_N_2;
    ...
    const ccomplex_t IT_0062 = m_s*s_34*m_N_2;
