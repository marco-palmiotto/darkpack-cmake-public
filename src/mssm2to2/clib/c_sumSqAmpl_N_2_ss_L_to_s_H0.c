        ...
        )
{
    ...
    const ccomplex_t IT_0099 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0100 = IT_0019*IT_0099;
    const ccomplex_t IT_0101 = IT_0094 + IT_0096 + IT_0098 + IT_0100;
    const ccomplex_t IT_0102 = conj(N_B2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0106 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0123 = cpow((-2)*s_13 + IT_0007 + IT_0122 + -m_ss_R*
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0131 = (-0.5)*IT_0130;
    const ccomplex_t IT_0132 = IT_0129*IT_0131;
    const ccomplex_t IT_0133 = cpow((-2)*s_13 + IT_0007 + IT_0122 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0134 = IT_0132*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*m_s*e_em*IT_0000*IT_0002
      *IT_0004*IT_0012;
    ...
    const ccomplex_t IT_0243 = m_N_2*IT_0040;
    ...
    const ccomplex_t IT_0257 = m_N_2*IT_0193;
    const ccomplex_t IT_0258 = m_N_1*IT_0215;
    ...
    const ccomplex_t IT_0281 = m_N_2*IT_0091;
