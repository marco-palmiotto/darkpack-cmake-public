...
ccomplex_return_t c_sumSqAmpl_N_2_ss_L_to_s_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0017 = IT_0013*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*IT_0017;
    const ccomplex_t IT_0019 = sin(beta);
    const ccomplex_t IT_0020 = cpow(IT_0009, -2);
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0001
      *IT_0003*IT_0006*IT_0014 + (-0.5)*m_W*(IT_0000*IT_0002 + -IT_0004*IT_0019)
      *(IT_0006 + 1./3*IT_0005*IT_0020));
    ...
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*m_s*e_em*IT_0000*IT_0001
      *IT_0003*IT_0006;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = IT_0024*IT_0030;
    const ccomplex_t IT_0032 = pow(m_ss_L, 2);
    const ccomplex_t IT_0033 = cpow((-2)*s_12 + IT_0014 + -IT_0015 + -IT_0032 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0038 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0048 = IT_0004*IT_0010;
    const ccomplex_t IT_0049 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = IT_0000*IT_0006;
    const ccomplex_t IT_0052 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0055 = IT_0048*IT_0054;
    const ccomplex_t IT_0056 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0072 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0078 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0101 = N_B4*N_u2*e_em;
    ...
    const ccomplex_t IT_0114 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0115 = IT_0037*IT_0114;
    const ccomplex_t IT_0116 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0117 = IT_0040*IT_0116;
    const ccomplex_t IT_0118 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0119 = IT_0037*IT_0118;
    ...
    const ccomplex_t IT_0123 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0124 = IT_0048*IT_0123;
    const ccomplex_t IT_0125 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0126 = IT_0051*IT_0125;
    const ccomplex_t IT_0127 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0001*IT_0003*IT_0006;
    const ccomplex_t IT_0138 = (-0.5)*IT_0137;
    const ccomplex_t IT_0139 = cpow((-2)*s_23 + IT_0014 + IT_0032 + -m_N_4*
    ...
    const ccomplex_t IT_0143 = cpow((-2)*s_23 + IT_0014 + IT_0032 + -m_N_2*
    ...
    const ccomplex_t IT_0156 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0157 = IT_0037*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0159 = IT_0048*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0161 = IT_0051*IT_0160;
    const ccomplex_t IT_0162 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0192 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0196 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0197 = IT_0040*IT_0196;
    const ccomplex_t IT_0198 = IT_0191 + IT_0193 + IT_0195 + IT_0197;
    const ccomplex_t IT_0199 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0200 = IT_0048*IT_0199;
    const ccomplex_t IT_0201 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0202 = IT_0051*IT_0201;
    const ccomplex_t IT_0203 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0204 = IT_0048*IT_0203;
    const ccomplex_t IT_0205 = conj(N_W3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0206 = IT_0051*IT_0205;
    ...
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0001*IT_0003*IT_0006;
    const ccomplex_t IT_0214 = (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = cpow((-2)*s_23 + IT_0014 + IT_0032 + -m_N_3*
    ...
    const ccomplex_t IT_0219 = IT_0018 + IT_0028 + (-2)*IT_0036 + IT_0091 +
       IT_0142 + IT_0167 + IT_0218;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
    ...
    const ccomplex_t IT_0233 = IT_0030*IT_0232;
    const ccomplex_t IT_0234 = IT_0033*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = m_s*IT_0235;
    const ccomplex_t IT_0237 = IT_0022*IT_0232;
    const ccomplex_t IT_0238 = IT_0026*IT_0237;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*IT_0238;
    const ccomplex_t IT_0240 = m_N_2*IT_0061;
    const ccomplex_t IT_0241 = m_N_1*IT_0083;
    ...
    const ccomplex_t IT_0247 = IT_0006*IT_0246;
    ...
    const ccomplex_t IT_0254 = m_N_2*IT_0188;
    const ccomplex_t IT_0255 = m_N_3*IT_0210;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = conj(N_B3)*e_em;
    const ccomplex_t IT_0258 = IT_0010*IT_0257;
    const ccomplex_t IT_0259 = 1.4142135623731*IT_0258;
    const ccomplex_t IT_0260 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0265 = IT_0215*IT_0264;
    const ccomplex_t IT_0266 = (0 + _Complex_I*1)*IT_0265;
    const ccomplex_t IT_0267 = IT_0256*IT_0266;
    const ccomplex_t IT_0268 = IT_0143*IT_0232;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0166*IT_0269;
    const ccomplex_t IT_0271 = m_N_2*IT_0112;
    const ccomplex_t IT_0272 = m_N_4*IT_0134;
    const ccomplex_t IT_0273 = IT_0271 + IT_0272;
    const ccomplex_t IT_0274 = conj(N_B4)*e_em;
    const ccomplex_t IT_0275 = IT_0010*IT_0274;
    const ccomplex_t IT_0276 = 1.4142135623731*IT_0275;
    const ccomplex_t IT_0277 = conj(N_W4)*e_em;
    const ccomplex_t IT_0278 = IT_0006*IT_0277;
    const ccomplex_t IT_0279 = 1.4142135623731*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*(IT_0276 + (-3)*IT_0279);
    ...
    const ccomplex_t IT_0284 = IT_0273*IT_0283;
    const ccomplex_t IT_0285 = -IT_0224 + 2*IT_0236 + -IT_0239 + -IT_0253 + 
      -IT_0267 + -IT_0270 + -IT_0284;
    const ccomplex_t IT_0286 = 6*s_13;
    const ccomplex_t IT_0287 = m_s*m_N_2;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0061*IT_0252;
    const ccomplex_t IT_0290 = IT_0188*IT_0266;
    const ccomplex_t IT_0291 = IT_0112*IT_0283;
    const ccomplex_t IT_0292 = IT_0154*IT_0269;
    const ccomplex_t IT_0293 = -IT_0035 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_s*s_14;
    const ccomplex_t IT_0295 = IT_0145*IT_0164;
    const ccomplex_t IT_0296 = IT_0083*IT_0090;
    const ccomplex_t IT_0297 = IT_0210*IT_0217;
    const ccomplex_t IT_0298 = IT_0134*IT_0141;
    const ccomplex_t IT_0299 = IT_0235 + -IT_0295 + -IT_0296 + -IT_0297 + 
      -IT_0298;
    ...
    const ccomplex_t IT_0304 = m_s*m_N_2*IT_0303;
