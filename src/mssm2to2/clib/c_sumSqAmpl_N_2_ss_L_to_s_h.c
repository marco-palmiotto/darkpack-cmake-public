        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0018 + (-0.5)*m_W*(IT_0001*IT_0018 + IT_0012*IT_0044)*
      (IT_0004 + 1./3*IT_0003*IT_0045));
    const ccomplex_t IT_0047 = IT_0006*IT_0046;
    const ccomplex_t IT_0048 = pow(m_N_2, 2);
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0007 + IT_0048 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0047*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0053 = (-0.5)*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0053*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*IT_0055;
    const ccomplex_t IT_0057 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0058 = IT_0015*IT_0057;
    const ccomplex_t IT_0059 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0060 = IT_0019*IT_0059;
    const ccomplex_t IT_0061 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0062 = IT_0015*IT_0061;
    const ccomplex_t IT_0063 = N_B1*N_d2*e_em;
    ...
    const ccomplex_t IT_0070 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0071 = IT_0022*IT_0070;
    const ccomplex_t IT_0072 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0079 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0080 = IT_0015*IT_0079;
    const ccomplex_t IT_0081 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0082 = IT_0019*IT_0081;
    const ccomplex_t IT_0083 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0084 = IT_0015*IT_0083;
    const ccomplex_t IT_0085 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0086 = IT_0019*IT_0085;
    const ccomplex_t IT_0087 = IT_0080 + IT_0082 + IT_0084 + IT_0086;
    const ccomplex_t IT_0088 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0089 = IT_0022*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0091 = IT_0025*IT_0090;
    const ccomplex_t IT_0092 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0093 = IT_0022*IT_0092;
    const ccomplex_t IT_0094 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0104 = (-0.5)*IT_0103;
    const ccomplex_t IT_0105 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0132 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0139 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0140 = IT_0022*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0183 = m_N_3*IT_0182;
    const ccomplex_t IT_0184 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0185 = IT_0015*IT_0184;
    const ccomplex_t IT_0186 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0187 = IT_0019*IT_0186;
    const ccomplex_t IT_0188 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0189 = IT_0015*IT_0188;
    const ccomplex_t IT_0190 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0191 = IT_0019*IT_0190;
    const ccomplex_t IT_0192 = IT_0185 + IT_0187 + IT_0189 + IT_0191;
    const ccomplex_t IT_0193 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0194 = IT_0022*IT_0193;
    const ccomplex_t IT_0195 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0196 = IT_0025*IT_0195;
    const ccomplex_t IT_0197 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0198 = IT_0022*IT_0197;
    const ccomplex_t IT_0199 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0208 = (-0.5)*IT_0207;
    const ccomplex_t IT_0209 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
    ...
    const ccomplex_t IT_0216 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0048 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0220 = IT_0043 + IT_0051 + IT_0102 + IT_0153 + IT_0161
       + IT_0212 + (-2)*IT_0219;
    const ccomplex_t IT_0221 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0222 = 0.5*IT_0221;
    const ccomplex_t IT_0223 = IT_0155*IT_0222;
    const ccomplex_t IT_0224 = IT_0159*IT_0223;
    ...
    const ccomplex_t IT_0251 = m_N_1*IT_0099;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = IT_0249*IT_0252;
    const ccomplex_t IT_0254 = m_N_2*IT_0182;
    const ccomplex_t IT_0255 = m_N_3*IT_0204;
    ...
    const ccomplex_t IT_0265 = IT_0209*IT_0264;
    const ccomplex_t IT_0266 = (0 + _Complex_I*1)*IT_0265;
    const ccomplex_t IT_0267 = IT_0256*IT_0266;
    const ccomplex_t IT_0268 = m_N_2*IT_0128;
    const ccomplex_t IT_0269 = m_N_4*IT_0150;
    ...
    const ccomplex_t IT_0286 = -IT_0225 + -IT_0236 + -IT_0239 + -IT_0253 + 
    ...
    const ccomplex_t IT_0290 = IT_0029*IT_0238;
    const ccomplex_t IT_0291 = IT_0182*IT_0266;
    const ccomplex_t IT_0292 = IT_0077*IT_0249;
    const ccomplex_t IT_0293 = IT_0128*IT_0280;
    ...
    const ccomplex_t IT_0297 = IT_0056*IT_0099;
    const ccomplex_t IT_0298 = IT_0107*IT_0150;
