        ...
        )
{
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
    ...
    const ccomplex_t IT_0068 = m_N_2*IT_0067;
    ...
    const ccomplex_t IT_0084 = -IT_0018 + -IT_0042 + -IT_0062 + IT_0068 +
       IT_0076 + IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *IT_0009*IT_0011*IT_0014*IT_0034;
    const ccomplex_t IT_0109 = 0.5*IT_0108;
    const ccomplex_t IT_0110 = IT_0064*IT_0109;
    const ccomplex_t IT_0111 = IT_0003*IT_0004*IT_0110;
    const ccomplex_t IT_0112 = IT_0008*IT_0109;
    ...
    const ccomplex_t IT_0116 = conj(N_u2)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0117 = IT_0091*IT_0116;
    const ccomplex_t IT_0118 = 2*IT_0117;
    const ccomplex_t IT_0119 = conj(N_B2)*conj(V_u2)*e_em;
    const ccomplex_t IT_0120 = IT_0095*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = conj(N_W2)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0131 = IT_0059*IT_0129*IT_0130;
    ...
    const ccomplex_t IT_0141 = IT_0074*IT_0140;
    ...
    const ccomplex_t IT_0147 = IT_0041 + IT_0061 + -IT_0114;
    ...
    const ccomplex_t IT_0152 = m_c*m_N_2*IT_0002;
