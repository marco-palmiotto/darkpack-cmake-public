        ...
        )
{
    ...
    const ccomplex_t IT_0005 = conj(N_W2)*e_em*U_Wm1;
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = conj(N_d2)*U_d1*e_em;
    ...
    const ccomplex_t IT_0022 = conj(N_W2)*e_em*U_Wm2;
    const ccomplex_t IT_0023 = IT_0004*IT_0022;
    const ccomplex_t IT_0024 = conj(N_d2)*U_d2*e_em;
    ...
    const ccomplex_t IT_0035 = N_W2*e_em*conj(V_Wp1);
    const ccomplex_t IT_0036 = IT_0004*IT_0035;
    const ccomplex_t IT_0037 = N_u2*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0044 = N_W2*e_em*conj(V_Wp2);
    const ccomplex_t IT_0045 = IT_0004*IT_0044;
    const ccomplex_t IT_0046 = N_u2*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0055 = pow(m_s, 2);
    const ccomplex_t IT_0056 = pow(m_N_2, 2);
    const ccomplex_t IT_0057 = cpow((-2)*s_12 + -IT_0001 + IT_0055 + -IT_0056 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0004;
    const ccomplex_t IT_0063 = 0.5*IT_0062;
    const ccomplex_t IT_0064 = IT_0061*IT_0063;
    const ccomplex_t IT_0065 = IT_0054*IT_0057*IT_0064;
    ...
    const ccomplex_t IT_0081 = -IT_0056;
    ...
    const ccomplex_t IT_0090 = s_34*IT_0056;
    ...
    const ccomplex_t IT_0144 = m_c*m_N_2;
