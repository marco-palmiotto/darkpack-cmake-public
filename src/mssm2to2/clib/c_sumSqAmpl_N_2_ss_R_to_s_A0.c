        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0189 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
    ...
    const ccomplex_t IT_0215 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0248 = m_s*m_N_2;
