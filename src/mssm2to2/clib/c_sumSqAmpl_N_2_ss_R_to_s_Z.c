        ...
        )
{
    ...
    const ccomplex_t IT_0004 = N_u2*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0009 = N_d2*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0022 = N_u2*conj(N_u2)*e_em;
    const ccomplex_t IT_0023 = IT_0003*IT_0022;
    const ccomplex_t IT_0024 = IT_0007*IT_0022;
    const ccomplex_t IT_0025 = N_d2*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0001;
    const ccomplex_t IT_0031 = (-0.333333333333333)*IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_2*
    ...
    const ccomplex_t IT_0050 = -IT_0021 + (-0.5)*IT_0035 + -IT_0049;
    const ccomplex_t IT_0051 = 0.5*IT_0028;
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0006*IT_0076*IT_0078;
    ...
    const ccomplex_t IT_0089 = conj(N_d2)*N_d4*e_em;
    const ccomplex_t IT_0090 = IT_0003*IT_0089;
    const ccomplex_t IT_0091 = IT_0007*IT_0089;
    const ccomplex_t IT_0092 = conj(N_u2)*N_u4*e_em;
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0076*IT_0078;
    ...
    const ccomplex_t IT_0102 = IT_0083 + 0.5*IT_0088 + IT_0101;
    ...
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0006*IT_0076*IT_0078;
    ...
    const ccomplex_t IT_0116 = IT_0029*IT_0087;
    const ccomplex_t IT_0117 = IT_0115 + 0.5*IT_0116;
    ...
    const ccomplex_t IT_0145 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0144 
      + -reg_prop, -1);
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0147 = IT_0143*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = m_N_2*IT_0029;
    const ccomplex_t IT_0149 = m_N_2*IT_0051;
    ...
    const ccomplex_t IT_0154 = m_N_2*IT_0075;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = IT_0153 + IT_0155;
    const ccomplex_t IT_0157 = IT_0082*IT_0156;
    const ccomplex_t IT_0158 = m_N_4*IT_0043;
    const ccomplex_t IT_0159 = m_N_2*IT_0096;
    ...
    const ccomplex_t IT_0165 = IT_0031*IT_0164;
    const ccomplex_t IT_0166 = IT_0145*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*IT_0166;
    const ccomplex_t IT_0168 = m_s*IT_0167;
    const ccomplex_t IT_0169 = -IT_0147 + (-0.5)*IT_0152 + -IT_0157 + -IT_0162
       + IT_0168;
    const ccomplex_t IT_0170 = m_N_1*IT_0060;
    const ccomplex_t IT_0171 = m_N_2*IT_0110;
    const ccomplex_t IT_0172 = -IT_0171;
    const ccomplex_t IT_0173 = IT_0170 + IT_0172;
    const ccomplex_t IT_0174 = IT_0114*IT_0173;
    const ccomplex_t IT_0175 = (-0.5)*IT_0152 + IT_0174;
    const ccomplex_t IT_0176 = IT_0169 + IT_0175;
    const ccomplex_t IT_0177 = conj(IT_0169) + conj(IT_0175);
    const ccomplex_t IT_0178 = IT_0085*IT_0164;
    const ccomplex_t IT_0179 = IT_0145*IT_0146*IT_0178;
    const ccomplex_t IT_0180 = IT_0034*IT_0151;
    const ccomplex_t IT_0181 = IT_0085*IT_0142;
    ...
    const ccomplex_t IT_0185 = m_N_3*IT_0075;
    const ccomplex_t IT_0186 = m_N_2*IT_0013;
    const ccomplex_t IT_0187 = -IT_0186;
    const ccomplex_t IT_0188 = IT_0185 + IT_0187;
    const ccomplex_t IT_0189 = IT_0020*IT_0188;
    const ccomplex_t IT_0190 = m_N_4*IT_0096;
    ...
    const ccomplex_t IT_0195 = IT_0179 + (-0.5)*IT_0180 + -IT_0184 + IT_0189 +
       IT_0194;
    const ccomplex_t IT_0196 = m_N_1*IT_0110;
    const ccomplex_t IT_0197 = m_N_2*IT_0060;
    const ccomplex_t IT_0198 = -IT_0197;
    const ccomplex_t IT_0199 = IT_0196 + IT_0198;
    const ccomplex_t IT_0200 = IT_0065*IT_0199;
    const ccomplex_t IT_0201 = (-0.5)*IT_0180 + -IT_0200;
    const ccomplex_t IT_0202 = IT_0195 + IT_0201;
    const ccomplex_t IT_0203 = conj(IT_0195) + conj(IT_0201);
    const ccomplex_t IT_0204 = m_s*m_N_2;
    const ccomplex_t IT_0205 = IT_0125*IT_0204;
    const ccomplex_t IT_0206 = (-3)*IT_0205;
    const ccomplex_t IT_0207 = 6*IT_0050;
    const ccomplex_t IT_0208 = IT_0067 + (-0.166666666666667)*IT_0207;
    const ccomplex_t IT_0209 = 6*conj(IT_0050);
    const ccomplex_t IT_0210 = conj(IT_0067) + (-0.166666666666667)*IT_0209;
    const ccomplex_t IT_0211 = pow(s_14, 2);
    const ccomplex_t IT_0212 = IT_0118*IT_0211;
    const ccomplex_t IT_0213 = -IT_0144;
    const ccomplex_t IT_0214 = IT_0212 + IT_0213;
    const ccomplex_t IT_0215 = IT_0204*IT_0214;
    const ccomplex_t IT_0216 = (-0.666666666666667)*IT_0163;
    const ccomplex_t IT_0217 = cpow((-2)*s_13 + IT_0016 + IT_0144 + -m_ss_R*
    ...
    const ccomplex_t IT_0221 = (-2)*IT_0083 + -IT_0088 + (-2)*IT_0101 + 
      -IT_0220;
    const ccomplex_t IT_0222 = IT_0031*IT_0217;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = IT_0216*IT_0223;
    const ccomplex_t IT_0225 = 2*IT_0021 + IT_0035 + 2*IT_0049 + IT_0224;
    const ccomplex_t IT_0226 = 6*IT_0225;
    const ccomplex_t IT_0227 = IT_0052 + 2*IT_0066;
    ...
    const ccomplex_t IT_0233 = (-2)*IT_0115 + -IT_0116;
    ...
    const ccomplex_t IT_0240 = m_s*IT_0214;
    ...
    const ccomplex_t IT_0247 = s_14*s_34*IT_0118;
    const ccomplex_t IT_0248 = -IT_0247;
    const ccomplex_t IT_0249 = s_13 + IT_0248;
    const ccomplex_t IT_0250 = s_13*IT_0249;
    const ccomplex_t IT_0251 = (-2)*IT_0167 + -IT_0224;
    const ccomplex_t IT_0252 = 2*IT_0183 + IT_0220;
    ...
    const ccomplex_t IT_0260 = s_34*IT_0144;
    const ccomplex_t IT_0261 = -IT_0260;
    const ccomplex_t IT_0262 = IT_0259 + IT_0261;
    const ccomplex_t IT_0263 = -IT_0167;
    const ccomplex_t IT_0264 = conj(IT_0067) + conj(IT_0263);
    const ccomplex_t IT_0265 = conj(IT_0117) + conj(IT_0183);
    const ccomplex_t IT_0266 = IT_0117 + IT_0183;
    const ccomplex_t IT_0267 = IT_0122 + IT_0130;
    const ccomplex_t IT_0268 = IT_0124 + IT_0129;
    const ccomplex_t IT_0269 = 3*IT_0205;
    const ccomplex_t IT_0270 = s_34*IT_0125;
    const ccomplex_t IT_0271 = IT_0118*IT_0270;
    ...
    const ccomplex_t IT_0276 = 6*IT_0169;
    const ccomplex_t IT_0277 = 6*IT_0175;
    const ccomplex_t IT_0278 = IT_0276 + IT_0277;
    const ccomplex_t IT_0279 = s_14*IT_0125;
    const ccomplex_t IT_0280 = IT_0118*IT_0279;
    const ccomplex_t IT_0281 = (-0.25)*IT_0280;
    const ccomplex_t IT_0282 = s_14 + IT_0281;
    const ccomplex_t IT_0283 = m_s*IT_0282;
    const ccomplex_t IT_0284 = (-4)*IT_0283;
    const ccomplex_t IT_0285 = 6*IT_0195;
    const ccomplex_t IT_0286 = 6*IT_0201;
    const ccomplex_t IT_0287 = IT_0285 + IT_0286;
    const ccomplex_t IT_0288 = (-0.25)*IT_0271;
    const ccomplex_t IT_0289 = s_34 + IT_0288;
    const ccomplex_t IT_0290 = m_N_2*IT_0289;
    const ccomplex_t IT_0291 = (-4)*IT_0290;
    const ccomplex_t IT_0292 = 6*conj(IT_0169);
    const ccomplex_t IT_0293 = 6*conj(IT_0175);
    const ccomplex_t IT_0294 = IT_0292 + IT_0293;
    const ccomplex_t IT_0295 = 6*conj(IT_0195);
    const ccomplex_t IT_0296 = 6*conj(IT_0201);
    const ccomplex_t IT_0297 = IT_0295 + IT_0296;
    const ccomplex_t IT_0298 = (-6)*IT_0169;
    const ccomplex_t IT_0299 = (-6)*IT_0175;
    const ccomplex_t IT_0300 = IT_0298 + IT_0299;
    const ccomplex_t IT_0301 = (-6)*conj(IT_0169);
    const ccomplex_t IT_0302 = (-6)*conj(IT_0175);
    const ccomplex_t IT_0303 = IT_0301 + IT_0302;
    const ccomplex_t IT_0304 = (-6)*IT_0195;
    const ccomplex_t IT_0305 = (-6)*IT_0201;
    const ccomplex_t IT_0306 = IT_0304 + IT_0305;
    const ccomplex_t IT_0307 = (-6)*conj(IT_0195);
    const ccomplex_t IT_0308 = (-6)*conj(IT_0201);
    const ccomplex_t IT_0309 = IT_0307 + IT_0308;
    const ccomplex_t IT_0310 = 0.5*IT_0280;
    const ccomplex_t IT_0311 = s_14 + IT_0310;
    const ccomplex_t IT_0312 = m_s*IT_0311;
    const ccomplex_t IT_0313 = 2*IT_0312;
    const ccomplex_t IT_0314 = 6*conj(IT_0263);
    const ccomplex_t IT_0315 = (-18)*conj(IT_0169);
    const ccomplex_t IT_0316 = s_13*IT_0214;
    const ccomplex_t IT_0317 = IT_0204*IT_0249;
    const ccomplex_t IT_0318 = 6*IT_0251;
    const ccomplex_t IT_0319 = 6*conj(IT_0251);
    ...
    const ccomplex_t IT_0326 = IT_0204*IT_0325;
    const ccomplex_t IT_0327 = s_13*IT_0325;
    const ccomplex_t IT_0328 = (-6)*IT_0252;
    const ccomplex_t IT_0329 = m_s*IT_0249;
    const ccomplex_t IT_0330 = (-6)*conj(IT_0252);
    const ccomplex_t IT_0331 = m_N_2*IT_0249;
    const ccomplex_t IT_0332 = m_N_2*IT_0325;
    const ccomplex_t IT_0333 = 0.166666666666667*conj(IT_0050);
    const ccomplex_t IT_0334 = 6*IT_0263*(conj(IT_0183)*IT_0206 +
       0.166666666666667*IT_0132*conj(IT_0263) + 0.166666666666667*conj(IT_0067)
      *IT_0267 + (conj(IT_0102) + -conj(IT_0117))*IT_0269 + 0.166666666666667
      *IT_0284*IT_0294 + 0.166666666666667*IT_0275*IT_0297 + IT_0268*IT_0333);
    const ccomplex_t IT_0335 = s_14*IT_0016;
    const ccomplex_t IT_0336 = s_13*s_34;
    const ccomplex_t IT_0337 = -IT_0336;
    const ccomplex_t IT_0338 = IT_0335 + IT_0337;
    const ccomplex_t IT_0339 = conj(IT_0102)*IT_0252 + IT_0102*conj(IT_0252) +
       0.166666666666667*IT_0050*IT_0319 + 0.166666666666667*IT_0264*IT_0320 +
       0.166666666666667*(IT_0067 + IT_0263)*IT_0321 + 0.166666666666667*IT_0265
      *IT_0328 + 0.166666666666667*IT_0266*IT_0330 + IT_0318*IT_0333;
    const ccomplex_t IT_0340 = (conj(IT_0050)*IT_0067 + IT_0050*conj(IT_0067) 
      + conj(IT_0102)*IT_0117 + IT_0102*conj(IT_0117))*IT_0128 + (IT_0050*conj
      (IT_0050) + IT_0067*conj(IT_0067) + IT_0102*conj(IT_0102) + IT_0117*conj
      (IT_0117))*IT_0132 + IT_0138*(IT_0176*IT_0177 + IT_0202*IT_0203) + (-6)
      *IT_0206*((conj(IT_0050) + -conj(IT_0067))*IT_0117 + (IT_0050 + -IT_0067)
      *conj(IT_0117) + conj(IT_0102)*IT_0208 + IT_0102*IT_0210) + IT_0215*(conj
      (IT_0221)*IT_0229 + IT_0221*IT_0232 + conj(IT_0233)*IT_0236 + IT_0233
      *IT_0239) + IT_0240*(IT_0177*IT_0229 + IT_0176*IT_0232 + IT_0203*IT_0243 +
       IT_0202*IT_0246) + IT_0250*(IT_0239*IT_0251 + IT_0236*conj(IT_0251) +
       conj(IT_0252)*IT_0255 + IT_0252*IT_0258) + IT_0262*(conj(IT_0050)*IT_0229
       + IT_0050*IT_0232 + conj(IT_0102)*IT_0243 + IT_0102*IT_0246 + IT_0239*
      (IT_0067 + IT_0263) + IT_0236*IT_0264 + IT_0255*IT_0265 + IT_0258*IT_0266)
       + (-6)*conj(IT_0263)*((-0.166666666666667)*IT_0067*IT_0267 + (
      -0.166666666666667)*IT_0050*IT_0268 + IT_0117*IT_0269 + (
      -0.166666666666667)*IT_0278*IT_0284 + (-0.166666666666667)*IT_0275*IT_0287
      ) + conj(IT_0183)*(IT_0117*IT_0267 + IT_0102*IT_0268 + (-6)*IT_0208
      *IT_0269 + IT_0275*IT_0278 + IT_0284*IT_0287) + IT_0291*(conj(IT_0102)
      *IT_0278 + conj(IT_0050)*IT_0287 + IT_0102*IT_0294 + IT_0050*IT_0297 +
       conj(IT_0117)*IT_0300 + IT_0117*IT_0303 + conj(IT_0067)*IT_0306 + IT_0067
      *IT_0309) + (conj(IT_0050)*IT_0278 + conj(IT_0102)*IT_0287 + IT_0050
      *IT_0294 + IT_0102*IT_0297 + conj(IT_0067)*IT_0300 + IT_0067*IT_0303 +
       conj(IT_0117)*IT_0306 + IT_0117*IT_0309)*IT_0313 + IT_0102*IT_0269
      *IT_0314 + IT_0183*(IT_0132*conj(IT_0183) + conj(IT_0117)*IT_0267 + conj
      (IT_0102)*IT_0268 + (-6)*IT_0210*IT_0269 + IT_0275*IT_0294 + IT_0284
      *IT_0297 + IT_0206*IT_0314) + IT_0204*(IT_0176*((-18)*conj(IT_0195) + (-18
      )*conj(IT_0201)) + IT_0202*((-18)*conj(IT_0175) + IT_0315)) + (conj
      (IT_0225)*IT_0226 + conj(IT_0227)*IT_0236 + IT_0227*IT_0238 + conj(IT_0221
      )*IT_0241 + conj(IT_0233)*IT_0255 + IT_0233*IT_0257)*IT_0316 + IT_0317*
      (IT_0239*IT_0252 + IT_0236*conj(IT_0252) + conj(IT_0233)*IT_0318 + IT_0233
      *IT_0319 + conj(IT_0221)*IT_0320 + IT_0221*IT_0321) + (conj(IT_0252)
      *IT_0320 + IT_0252*IT_0321)*IT_0326 + IT_0327*(conj(IT_0251)*IT_0320 +
       conj(IT_0252)*IT_0328) + IT_0329*(IT_0177*IT_0320 + IT_0176*IT_0321 +
       IT_0203*IT_0328 + IT_0202*IT_0330) + (IT_0203*IT_0236 + IT_0202*IT_0239 +
       conj(IT_0175)*IT_0255 + IT_0175*IT_0258 + conj(IT_0233)*IT_0276 + IT_0233
      *IT_0292 + conj(IT_0221)*IT_0298 + IT_0221*IT_0301)*IT_0331 + (conj
      (IT_0252)*IT_0298 + IT_0252*IT_0301 + IT_0203*IT_0320 + IT_0202*IT_0321 +
       conj(IT_0175)*IT_0328 + IT_0175*IT_0330)*IT_0332 + IT_0334 + 6*IT_0338
      *IT_0339;
