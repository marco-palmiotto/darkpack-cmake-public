...
ccomplex_return_t c_sumSqAmpl_N_2_ss_R_to_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = N_W2*N_u2*e_em;
    ...
    const ccomplex_t IT_0028 = conj(N_B2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0032 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*e_em*(m_W*IT_0017*IT_0041*
      (IT_0009*IT_0042 + IT_0013*IT_0043) + (-3)*IT_0004*IT_0013*IT_0018*IT_0044
      *IT_0045);
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0004 + IT_0049 + -m_ss_R*
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = N_B2*N_u1*e_em;
    ...
    const ccomplex_t IT_0067 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0068 = IT_0019*IT_0067;
    const ccomplex_t IT_0069 = N_W2*N_d1*e_em;
    ...
    const ccomplex_t IT_0080 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0084 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0089 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0090 = IT_0019*IT_0089;
    const ccomplex_t IT_0091 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0092 = IT_0022*IT_0091;
    const ccomplex_t IT_0093 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0094 = IT_0019*IT_0093;
    const ccomplex_t IT_0095 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0135 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0144 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0152 = m_N_2*IT_0151;
    const ccomplex_t IT_0153 = IT_0130 + IT_0152;
    const ccomplex_t IT_0154 = IT_0108*IT_0153;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0013 + m_s*e_em*mu_h*IT_0009*IT_0018*IT_0044*IT_0045);
    const ccomplex_t IT_0156 = 0.5*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0018*IT_0044*IT_0045;
    const ccomplex_t IT_0158 = (-0.5)*IT_0157;
    const ccomplex_t IT_0159 = IT_0156*IT_0158;
    const ccomplex_t IT_0160 = cpow((-2)*s_13 + IT_0004 + IT_0049 + -m_ss_L*
    ...
    const ccomplex_t IT_0185 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0186 = IT_0010*IT_0185;
    const ccomplex_t IT_0187 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0188 = IT_0014*IT_0187;
    const ccomplex_t IT_0189 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0190 = IT_0010*IT_0189;
    const ccomplex_t IT_0191 = conj(N_B3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0196 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0200 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0208 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0001;
    const ccomplex_t IT_0209 = (-0.333333333333333)*IT_0208;
    const ccomplex_t IT_0210 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_3*
    ...
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*m_s*e_em*IT_0013*IT_0018
      *IT_0044*IT_0045;
    const ccomplex_t IT_0215 = 0.5*IT_0214;
    const ccomplex_t IT_0216 = IT_0003*IT_0215;
    const ccomplex_t IT_0217 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0049 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0221 = IT_0040 + IT_0052 + IT_0103 + IT_0154 + IT_0162
       + IT_0213 + (-2)*IT_0220;
    ...
    const ccomplex_t IT_0231 = IT_0160*IT_0230;
    const ccomplex_t IT_0232 = (0 + _Complex_I*1)*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0018*IT_0044*IT_0045;
    const ccomplex_t IT_0234 = 0.5*IT_0233;
    const ccomplex_t IT_0235 = IT_0047*IT_0234;
    const ccomplex_t IT_0236 = IT_0050*IT_0235;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = IT_0006*IT_0234;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*IT_0238;
    const ccomplex_t IT_0240 = IT_0039*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0018*IT_0044*IT_0045;
    const ccomplex_t IT_0242 = 0.5*IT_0241;
    const ccomplex_t IT_0243 = IT_0055*IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*IT_0243;
    const ccomplex_t IT_0245 = m_N_2*IT_0078;
    const ccomplex_t IT_0246 = m_N_1*IT_0100;
    const ccomplex_t IT_0247 = IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = IT_0244*IT_0247;
    const ccomplex_t IT_0249 = m_N_2*IT_0183;
    const ccomplex_t IT_0250 = m_N_3*IT_0205;
    const ccomplex_t IT_0251 = IT_0249 + IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0018*IT_0044*IT_0045;
    ...
    const ccomplex_t IT_0257 = m_N_2*IT_0129;
    const ccomplex_t IT_0258 = m_N_4*IT_0151;
    const ccomplex_t IT_0259 = IT_0257 + IT_0258;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0018*IT_0044*IT_0045;
    ...
    const ccomplex_t IT_0265 = IT_0215*IT_0234;
    ...
    const ccomplex_t IT_0269 = -IT_0232 + -IT_0237 + -IT_0240 + -IT_0248 + 
      -IT_0256 + -IT_0264 + 2*IT_0268;
    const ccomplex_t IT_0270 = 6*s_13;
    const ccomplex_t IT_0271 = m_s*m_N_2;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0026*IT_0239;
    const ccomplex_t IT_0274 = IT_0183*IT_0255;
    const ccomplex_t IT_0275 = IT_0078*IT_0244;
    const ccomplex_t IT_0276 = IT_0129*IT_0263;
    const ccomplex_t IT_0277 = -IT_0219 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_s*s_14;
    const ccomplex_t IT_0279 = IT_0008*IT_0037;
    const ccomplex_t IT_0280 = IT_0057*IT_0100;
    const ccomplex_t IT_0281 = IT_0108*IT_0151;
    ...
    const ccomplex_t IT_0288 = m_s*m_N_2*IT_0287;
