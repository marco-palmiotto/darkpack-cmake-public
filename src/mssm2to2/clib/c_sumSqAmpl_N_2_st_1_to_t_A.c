...
ccomplex_return_t c_sumSqAmpl_N_2_st_1_to_t_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0000 + IT_0025 + -m_st_1*
    ...
    const ccomplex_t IT_0037 = m_t*conj(N_u2)*e_em*IT_0013*U_st_10;
