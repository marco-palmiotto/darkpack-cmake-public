        ...
        )
{
    ...
    const ccomplex_t IT_0082 = pow(m_st_1, 2);
    ...
    const ccomplex_t IT_0124 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0125 = IT_0016*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = m_t*N_u1*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0176 = m_t*N_u3*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0185 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0186 = IT_0016*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = m_t*N_u4*e_em*IT_0002*U_st_00;
