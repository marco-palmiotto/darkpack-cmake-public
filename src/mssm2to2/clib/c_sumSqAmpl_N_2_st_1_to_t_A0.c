...
ccomplex_return_t c_sumSqAmpl_N_2_st_1_to_t_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B2*e_em*U_st_10;
    ...
    const ccomplex_t IT_0023 = m_t*N_u2*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0034 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0035 = IT_0016*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = m_t*N_u2*e_em*IT_0002*U_st_01;
    ...
    const ccomplex_t IT_0085 = N_W2*N_u4*e_em;
    ...
    const ccomplex_t IT_0095 = conj(N_W2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0103 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0104 = IT_0075*IT_0103;
    const ccomplex_t IT_0105 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0029 + IT_0065 + -m_N_2*
    ...
    const ccomplex_t IT_0279 = m_N_2*IT_0163;
