...
ccomplex_return_t c_sumSqAmpl_N_2_st_1_to_t_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = N_B2*e_em*U_st_10;
    ...
    const ccomplex_t IT_0012 = m_t*N_u2*e_em*IT_0011*U_st_00;
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0018 + IT_0024 + -m_st_1*
