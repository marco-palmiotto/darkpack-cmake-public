...
ccomplex_return_t c_sumSqAmpl_N_2_st_1_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*m_t*e_em*IT_0006*IT_0008
      *IT_0010*IT_0016;
    const ccomplex_t IT_0018 = (-0.5)*IT_0017;
    const ccomplex_t IT_0019 = IT_0015*IT_0018;
    const ccomplex_t IT_0020 = pow(m_N_2, 2);
    ...
    const ccomplex_t IT_0025 = m_t*IT_0024;
    ...
    const ccomplex_t IT_0030 = IT_0001*IT_0016;
    const ccomplex_t IT_0031 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = IT_0008*IT_0026;
    const ccomplex_t IT_0034 = N_W2*N_d2*e_em;
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = IT_0008*IT_0016;
    const ccomplex_t IT_0037 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*(IT_0029 + -IT_0032 + 
      -IT_0035 + IT_0038);
    const ccomplex_t IT_0040 = m_N_2*IT_0039;
    const ccomplex_t IT_0041 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0042 = IT_0027*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0044 = IT_0030*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0046 = IT_0033*IT_0045;
    const ccomplex_t IT_0047 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0048 = IT_0036*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*(IT_0042 + -IT_0044 + 
      -IT_0046 + IT_0048);
    const ccomplex_t IT_0050 = m_N_2*IT_0049;
    const ccomplex_t IT_0051 = IT_0040 + IT_0050;
    const ccomplex_t IT_0052 = pow(m_t, 2);
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0054 = IT_0015*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = IT_0051*IT_0055;
    const ccomplex_t IT_0057 = m_t*mu_h*IT_0010;
    const ccomplex_t IT_0058 = cos(beta);
    const ccomplex_t IT_0059 = IT_0026*IT_0058;
    const ccomplex_t IT_0060 = -IT_0005*IT_0016 + IT_0059;
    const ccomplex_t IT_0061 = cpow(IT_0000, -2);
    const ccomplex_t IT_0062 = (-2)*U_st_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0052 + 0.5*m_W*IT_0060*(IT_0008 + -1./3*IT_0007*IT_0061))*conj(U_st_00
      ) + -1./2*IT_0006*IT_0008*IT_0026*IT_0057*conj(U_st_10)) + U_st_10*
      (IT_0006*IT_0008*IT_0026*IT_0057*conj(U_st_00) + (-1.33333333333333)*(1.5
      *IT_0006*IT_0008*IT_0010*IT_0016*IT_0052 + m_W*IT_0007*IT_0060*IT_0061)
      *conj(U_st_10));
    const ccomplex_t IT_0063 = (0 + _Complex_I*-1)*(e_em*IT_0062 + (
      -1.4142135623731)*A_t*IT_0016*(conj(U_st_00)*U_st_10 + U_st_00*conj
      (U_st_10)));
    const ccomplex_t IT_0064 = (-0.5)*IT_0063;
    const ccomplex_t IT_0065 = IT_0015*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0020 + IT_0052 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0067 = IT_0065*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*IT_0067;
    const ccomplex_t IT_0069 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0070 = IT_0001*IT_0069;
    const ccomplex_t IT_0071 = 1.4142135623731*IT_0070;
    const ccomplex_t IT_0072 = m_t*N_u2*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0077 = (-2)*U_st_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0052 + 0.5*m_W*IT_0060*(IT_0008 + -1./3*IT_0007*IT_0061))*conj(U_st_01
      ) + -1./2*IT_0006*IT_0008*IT_0026*IT_0057*conj(U_st_11)) + U_st_10*
      (IT_0006*IT_0008*IT_0026*IT_0057*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0006*IT_0008*IT_0010*IT_0016*IT_0052 + m_W*IT_0007*IT_0060*IT_0061)
      *conj(U_st_11));
    const ccomplex_t IT_0078 = (0 + _Complex_I*-1)*(e_em*IT_0077 + (
      -1.4142135623731)*A_t*IT_0016*(conj(U_st_01)*U_st_10 + U_st_00*conj
      (U_st_11)));
    const ccomplex_t IT_0079 = (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = IT_0076*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0020 + IT_0052 + -m_st_2*
    ...
    const ccomplex_t IT_0115 = conj(N_B1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0121 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0129 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0130 = IT_0001*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = m_t*N_u1*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0137 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_1*
    ...
    const ccomplex_t IT_0141 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0142 = IT_0001*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = m_t*N_u3*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0149 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0150 = IT_0148*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*IT_0150;
    const ccomplex_t IT_0152 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0153 = IT_0027*IT_0152;
    const ccomplex_t IT_0154 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0155 = IT_0036*IT_0154;
    const ccomplex_t IT_0156 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0157 = IT_0027*IT_0156;
    const ccomplex_t IT_0158 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0159 = IT_0036*IT_0158;
    const ccomplex_t IT_0160 = IT_0153 + IT_0155 + IT_0157 + IT_0159;
    const ccomplex_t IT_0161 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0162 = IT_0030*IT_0161;
    const ccomplex_t IT_0163 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0164 = IT_0033*IT_0163;
    const ccomplex_t IT_0165 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0166 = IT_0030*IT_0165;
    ...
    const ccomplex_t IT_0174 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0175 = IT_0027*IT_0174;
    const ccomplex_t IT_0176 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0177 = IT_0036*IT_0176;
    const ccomplex_t IT_0178 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0179 = IT_0027*IT_0178;
    const ccomplex_t IT_0180 = conj(N_W3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0185 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0186 = IT_0033*IT_0185;
    const ccomplex_t IT_0187 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0188 = IT_0030*IT_0187;
    const ccomplex_t IT_0189 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0198 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0199 = IT_0001*IT_0198;
    const ccomplex_t IT_0200 = 1.4142135623731*IT_0199;
    const ccomplex_t IT_0201 = m_t*N_u4*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0206 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_4*
    ...
    const ccomplex_t IT_0216 = IT_0036*IT_0215;
    ...
    const ccomplex_t IT_0231 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0235 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0236 = IT_0027*IT_0235;
    const ccomplex_t IT_0237 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0238 = IT_0036*IT_0237;
    const ccomplex_t IT_0239 = IT_0232 + IT_0234 + IT_0236 + IT_0238;
    const ccomplex_t IT_0240 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0241 = IT_0030*IT_0240;
    const ccomplex_t IT_0242 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0243 = IT_0033*IT_0242;
    const ccomplex_t IT_0244 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0245 = IT_0030*IT_0244;
    const ccomplex_t IT_0246 = conj(N_W4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0247 = IT_0033*IT_0246;
    ...
    const ccomplex_t IT_0255 = (-2)*IT_0025 + IT_0056 + IT_0068 + IT_0083 +
       IT_0140 + IT_0197 + IT_0254;
    const ccomplex_t IT_0256 = 6*s_13;
    const ccomplex_t IT_0257 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0258 = IT_0001*IT_0257;
    const ccomplex_t IT_0259 = 1.4142135623731*IT_0258;
    const ccomplex_t IT_0260 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0261 = IT_0008*IT_0260;
    const ccomplex_t IT_0262 = 1.4142135623731*IT_0261;
    const ccomplex_t IT_0263 = m_t*conj(N_u2)*e_em*IT_0010*U_st_10;
    const ccomplex_t IT_0264 = IT_0009*IT_0263;
    const ccomplex_t IT_0265 = 1.4142135623731*IT_0264;
    const ccomplex_t IT_0266 = (0 + _Complex_I*1)*(IT_0259 + 3*IT_0262 + 3
      *IT_0265);
    const ccomplex_t IT_0267 = 0.166666666666667*IT_0266;
    const ccomplex_t IT_0268 = IT_0018*IT_0267;
    const ccomplex_t IT_0269 = IT_0022*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*IT_0269;
    const ccomplex_t IT_0271 = IT_0151*IT_0194;
    const ccomplex_t IT_0272 = IT_0049*IT_0055;
    const ccomplex_t IT_0273 = IT_0208*IT_0251;
    const ccomplex_t IT_0274 = IT_0126*IT_0139;
    const ccomplex_t IT_0275 = IT_0270 + -IT_0271 + -IT_0272 + -IT_0273 + 
      -IT_0274;
    const ccomplex_t IT_0276 = m_t*s_14;
    const ccomplex_t IT_0277 = IT_0053*IT_0267;
    const ccomplex_t IT_0278 = (0 + _Complex_I*1)*IT_0277;
    const ccomplex_t IT_0279 = IT_0039*IT_0278;
    const ccomplex_t IT_0280 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0281 = IT_0001*IT_0280;
    const ccomplex_t IT_0282 = 1.4142135623731*IT_0281;
    const ccomplex_t IT_0283 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0284 = IT_0008*IT_0283;
    const ccomplex_t IT_0285 = 1.4142135623731*IT_0284;
    const ccomplex_t IT_0286 = m_t*conj(N_u1)*e_em*IT_0010*U_st_10;
    const ccomplex_t IT_0287 = IT_0009*IT_0286;
    const ccomplex_t IT_0288 = 1.4142135623731*IT_0287;
    const ccomplex_t IT_0289 = (0 + _Complex_I*1)*(IT_0282 + 3*IT_0285 + 3
      *IT_0288);
    const ccomplex_t IT_0290 = 0.166666666666667*IT_0289;
    const ccomplex_t IT_0291 = IT_0137*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = IT_0104*IT_0292;
    const ccomplex_t IT_0294 = conj(N_B4)*e_em*U_st_00;
    const ccomplex_t IT_0295 = IT_0001*IT_0294;
    const ccomplex_t IT_0296 = 1.4142135623731*IT_0295;
    const ccomplex_t IT_0297 = conj(N_W4)*e_em*U_st_00;
    const ccomplex_t IT_0298 = IT_0008*IT_0297;
    const ccomplex_t IT_0299 = 1.4142135623731*IT_0298;
    const ccomplex_t IT_0300 = m_t*conj(N_u4)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0305 = IT_0206*IT_0304;
    const ccomplex_t IT_0306 = (0 + _Complex_I*1)*IT_0305;
    const ccomplex_t IT_0307 = IT_0229*IT_0306;
    const ccomplex_t IT_0308 = conj(N_B3)*e_em*U_st_00;
    const ccomplex_t IT_0309 = IT_0001*IT_0308;
    const ccomplex_t IT_0310 = 1.4142135623731*IT_0309;
    const ccomplex_t IT_0311 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0312 = IT_0008*IT_0311;
    const ccomplex_t IT_0313 = 1.4142135623731*IT_0312;
    const ccomplex_t IT_0314 = m_t*conj(N_u3)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0322 = -IT_0024 + IT_0279 + IT_0293 + IT_0307 + IT_0321;
    const ccomplex_t IT_0323 = s_34*m_N_2;
    const ccomplex_t IT_0324 = IT_0064*IT_0267;
    const ccomplex_t IT_0325 = IT_0066*IT_0324;
    const ccomplex_t IT_0326 = (0 + _Complex_I*1)*IT_0325;
    const ccomplex_t IT_0327 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0328 = IT_0001*IT_0327;
    const ccomplex_t IT_0329 = 1.4142135623731*IT_0328;
    const ccomplex_t IT_0330 = conj(N_W2)*e_em*U_st_01;
    const ccomplex_t IT_0331 = IT_0008*IT_0330;
    const ccomplex_t IT_0332 = 1.4142135623731*IT_0331;
    const ccomplex_t IT_0333 = m_t*conj(N_u2)*e_em*IT_0010*U_st_11;
    ...
    const ccomplex_t IT_0338 = IT_0079*IT_0337;
    const ccomplex_t IT_0339 = IT_0081*IT_0338;
    const ccomplex_t IT_0340 = (0 + _Complex_I*1)*IT_0339;
    const ccomplex_t IT_0341 = m_t*IT_0270;
    const ccomplex_t IT_0342 = IT_0051*IT_0278;
    const ccomplex_t IT_0343 = m_N_2*IT_0104;
    const ccomplex_t IT_0344 = m_N_1*IT_0126;
    const ccomplex_t IT_0345 = IT_0343 + IT_0344;
    const ccomplex_t IT_0346 = IT_0292*IT_0345;
    const ccomplex_t IT_0347 = m_N_2*IT_0172;
    const ccomplex_t IT_0348 = m_N_3*IT_0194;
    const ccomplex_t IT_0349 = IT_0347 + IT_0348;
    const ccomplex_t IT_0350 = IT_0320*IT_0349;
    const ccomplex_t IT_0351 = m_N_2*IT_0229;
    const ccomplex_t IT_0352 = m_N_4*IT_0251;
    const ccomplex_t IT_0353 = IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = IT_0306*IT_0353;
    const ccomplex_t IT_0355 = -IT_0326 + -IT_0340 + 2*IT_0341 + -IT_0342 + 
      -IT_0346 + -IT_0350 + -IT_0354;
    const ccomplex_t IT_0356 = 6*conj(IT_0355);
    const ccomplex_t IT_0357 = m_t*m_N_2;
    const ccomplex_t IT_0358 = 6*IT_0255;
    const ccomplex_t IT_0359 = 6*conj(IT_0255);
    const ccomplex_t IT_0360 = pow(m_H0, 2);
    const ccomplex_t IT_0361 = m_t*m_N_2*IT_0360;
    ...
    const ccomplex_t IT_0366 = 6*IT_0355;
    const ccomplex_t IT_0367 = 0.166666666666667*IT_0323;
    const ccomplex_t IT_0368 = IT_0255*conj(IT_0255)*IT_0256 + (IT_0275
      *IT_0276 + IT_0322*IT_0323)*IT_0356 + conj(IT_0355)*(IT_0256*IT_0355 +
       IT_0357*IT_0358) + (IT_0276*IT_0322 + IT_0275*IT_0323 + IT_0355*IT_0357)
      *IT_0359 + 6*conj(IT_0275)*(IT_0322*IT_0361 + -IT_0275*IT_0365 +
       0.166666666666667*IT_0276*IT_0366 + IT_0358*IT_0367) + 6*conj(IT_0322)*
      (0.166666666666667*IT_0276*IT_0358 + IT_0275*IT_0361 + -IT_0322*IT_0365 +
       IT_0366*IT_0367);
