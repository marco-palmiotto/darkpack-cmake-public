        ...
        )
{
    ...
    const ccomplex_t IT_0117 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    ...
    const ccomplex_t IT_0122 = m_t*V_tb*conj(V_u1)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0132 = m_t*V_tb*conj(V_u2)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0195 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0196 = IT_0005*IT_0195;
    const ccomplex_t IT_0197 = 1.4142135623731*IT_0196;
    const ccomplex_t IT_0198 = m_t*N_u2*e_em*IT_0012*U_st_01;
