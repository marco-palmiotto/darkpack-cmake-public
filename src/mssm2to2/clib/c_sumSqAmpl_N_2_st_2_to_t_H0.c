        ...
        )
{
    ...
    const ccomplex_t IT_0094 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0095 = IT_0001*IT_0094;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = m_t*N_u4*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0106 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0107 = IT_0001*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = m_t*N_u2*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0119 = (-2)*conj(U_st_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + 0.5*m_W*IT_0117*(IT_0008 + -1./3*IT_0007*IT_0118))
      *U_st_01 + -1./2*IT_0006*IT_0008*IT_0021*IT_0114*U_st_11) + conj(U_st_10)*
      (IT_0006*IT_0008*IT_0021*IT_0114*U_st_01 + (-1.33333333333333)*(1.5
      *IT_0006*IT_0008*IT_0010*IT_0016*IT_0025 + m_W*IT_0007*IT_0117*IT_0118)
      *U_st_11);
    const ccomplex_t IT_0120 = (0 + _Complex_I*-1)*(e_em*IT_0119 + (
      -1.4142135623731)*A_t*IT_0025*(U_st_01*conj(U_st_10) + conj(U_st_00)
      *U_st_11));
    const ccomplex_t IT_0121 = (-0.5)*IT_0120;
    const ccomplex_t IT_0122 = IT_0113*IT_0121;
    const ccomplex_t IT_0123 = pow(m_N_2, 2);
    const ccomplex_t IT_0124 = cpow((-2)*s_13 + IT_0016 + IT_0123 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0125 = IT_0122*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*IT_0125;
    const ccomplex_t IT_0127 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0128 = IT_0001*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_t*N_u1*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0191 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0192 = IT_0001*IT_0191;
    const ccomplex_t IT_0193 = 1.4142135623731*IT_0192;
    const ccomplex_t IT_0194 = m_t*N_u3*e_em*IT_0010*U_st_01;
