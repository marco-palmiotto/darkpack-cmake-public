...
ccomplex_return_t c_sumSqAmpl_N_2_st_2_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0062 = (-2)*U_st_01*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0052 + 0.5*m_W*IT_0060*(IT_0008 + -1./3*IT_0007*IT_0061))*conj(U_st_01
      ) + -1./2*IT_0006*IT_0008*IT_0026*IT_0057*conj(U_st_11)) + U_st_11*
    ...
    const ccomplex_t IT_0077 = (-2)*conj(U_st_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0052 + 0.5*m_W*IT_0060*(IT_0008 + -1./3*IT_0007*IT_0061))
      *U_st_01 + -1./2*IT_0006*IT_0008*IT_0026*IT_0057*U_st_11) + conj(U_st_10)*
      (IT_0006*IT_0008*IT_0026*IT_0057*U_st_01 + (-1.33333333333333)*(1.5
      *IT_0006*IT_0008*IT_0010*IT_0016*IT_0052 + m_W*IT_0007*IT_0060*IT_0061)
      *U_st_11);
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0020 + IT_0052 + -m_st_1*
    ...
    const ccomplex_t IT_0129 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0130 = IT_0001*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = m_t*N_u1*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0141 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0142 = IT_0001*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = m_t*N_u3*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0198 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0199 = IT_0001*IT_0198;
    const ccomplex_t IT_0200 = 1.4142135623731*IT_0199;
    const ccomplex_t IT_0201 = m_t*N_u4*e_em*IT_0010*U_st_01;
