        ...
        )
{
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*(A_tau*IT_0042*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0002*(m_W*IT_0000*IT_0042*U_stau_00 + (-0.5)
      *m_tau*IT_0024*(m_tau*IT_0022*IT_0042*U_stau_00 + mu_h*U_stau_10)));
    ...
    const ccomplex_t IT_0056 = N_d2*e_em*m_tau*IT_0024*U_stau_00;
    ...
    const ccomplex_t IT_0072 = conj(N_d2)*e_em*m_tau*IT_0024*U_stau_10;
    ...
    const ccomplex_t IT_0081 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0082 = IT_0002*IT_0081;
    const ccomplex_t IT_0083 = conj(U_d2)*e_em*m_tau*IT_0024*U_stau_10;
