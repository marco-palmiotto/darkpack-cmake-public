...
ccomplex_return_t c_sumSqAmpl_N_2_stau_1_to_nu_tau_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0077 = N_d2*e_em*m_tau*IT_0024*U_stau_00;
    ...
    const ccomplex_t IT_0094 = conj(N_d2)*e_em*m_tau*IT_0024*U_stau_10;
