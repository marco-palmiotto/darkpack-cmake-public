        ...
        )
{
    ...
    const ccomplex_t IT_0002 = conj(N_W2)*e_em*U_Wm2;
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = conj(N_d2)*U_d2*e_em;
    ...
    const ccomplex_t IT_0024 = conj(N_W2)*e_em*U_Wm1;
    const ccomplex_t IT_0025 = IT_0001*IT_0024;
    const ccomplex_t IT_0026 = conj(N_d2)*U_d1*e_em;
    ...
    const ccomplex_t IT_0044 = N_W2*e_em*conj(V_Wp1);
    const ccomplex_t IT_0045 = IT_0001*IT_0044;
    const ccomplex_t IT_0046 = N_u2*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0075 = N_d2*e_em*m_tau*IT_0014*U_stau_00;
    ...
    const ccomplex_t IT_0086 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0087 = IT_0071*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0090 = IT_0001*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = conj(N_d2)*e_em*m_tau*IT_0014*U_stau_10;
    ...
    const ccomplex_t IT_0097 = IT_0069*IT_0096;
    ...
    const ccomplex_t IT_0110 = cpow(s_13 + (-0.5)*IT_0064 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0127 = (-0.5)*IT_0099;
    ...
    const ccomplex_t IT_0148 = 0.5*IT_0113;
    ...
    const ccomplex_t IT_0154 = m_N_2*IT_0144;
    const ccomplex_t IT_0155 = s_13*s_14;
    const ccomplex_t IT_0156 = s_34*IT_0064;
    const ccomplex_t IT_0157 = -IT_0156;
    const ccomplex_t IT_0158 = IT_0155 + IT_0157;
    const ccomplex_t IT_0159 = IT_0127 + IT_0135;
    ...
    const ccomplex_t IT_0174 = (-2)*(conj(IT_0043) + conj(IT_0082))*IT_0141 +
       IT_0145*(conj(IT_0114)*IT_0150 + IT_0114*IT_0153) + ((conj(IT_0043) +
       conj(IT_0082))*IT_0150 + IT_0125*IT_0153)*IT_0154 + IT_0158*((conj
      (IT_0127) + conj(IT_0135))*IT_0150 + IT_0153*IT_0159) + (-2)*((-0.5)*conj
      ...
      *IT_0125 + IT_0159*IT_0172)*IT_0173;
