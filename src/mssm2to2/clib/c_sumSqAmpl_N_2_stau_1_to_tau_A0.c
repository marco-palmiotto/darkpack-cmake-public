        ...
        )
{
    ...
    const ccomplex_t IT_0031 = N_B2*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0037 = N_d2*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0100 = N_d3*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0146 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0147 = IT_0011*IT_0146;
    const ccomplex_t IT_0148 = e_em*mu_h*m_tau*IT_0036*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0149 = IT_0011*IT_0148;
    const ccomplex_t IT_0150 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0151 = IT_0006*IT_0150;
    const ccomplex_t IT_0152 = 1.4142135623731*IT_0151;
    const ccomplex_t IT_0153 = A_tau*U_stau_00*conj(U_stau_10);
    const ccomplex_t IT_0154 = IT_0006*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = (-0.5)*IT_0147 + 0.5*IT_0149 + (-0.5)*IT_0152 +
       0.5*IT_0155;
    const ccomplex_t IT_0157 = IT_0041*IT_0156;
    const ccomplex_t IT_0158 = pow(m_N_2, 2);
    const ccomplex_t IT_0159 = cpow(s_13 + (-0.5)*IT_0042 + (-0.5)*IT_0158 + (
    ...
    const ccomplex_t IT_0162 = cpow(s_13 + (-0.5)*IT_0042 + (-0.5)*IT_0158 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0163 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0164 = IT_0011*IT_0163;
    const ccomplex_t IT_0165 = e_em*mu_h*m_tau*IT_0036*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0166 = IT_0011*IT_0165;
    const ccomplex_t IT_0167 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0168 = IT_0006*IT_0167;
    const ccomplex_t IT_0169 = 1.4142135623731*IT_0168;
    const ccomplex_t IT_0170 = A_tau*U_stau_00*conj(U_stau_11);
    const ccomplex_t IT_0171 = IT_0006*IT_0170;
    const ccomplex_t IT_0172 = 1.4142135623731*IT_0171;
    const ccomplex_t IT_0173 = (-0.5)*IT_0164 + 0.5*IT_0166 + (-0.5)*IT_0169 +
       0.5*IT_0172;
    const ccomplex_t IT_0174 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0175 = IT_0002*IT_0174;
    const ccomplex_t IT_0176 = 1.4142135623731*IT_0175;
    const ccomplex_t IT_0177 = N_d2*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0188 = N_d4*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0247 = conj(N_d2)*e_em*m_tau*IT_0036*U_stau_10;
    ...
    const ccomplex_t IT_0255 = IT_0028*IT_0046;
    const ccomplex_t IT_0256 = IT_0058*IT_0093;
    ...
    const ccomplex_t IT_0265 = conj(N_d4)*e_em*m_tau*IT_0036*U_stau_10;
    ...
    const ccomplex_t IT_0272 = IT_0212*IT_0271;
    const ccomplex_t IT_0273 = IT_0041*IT_0240;
    const ccomplex_t IT_0274 = IT_0238*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*IT_0274;
    const ccomplex_t IT_0276 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0277 = IT_0002*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0280 = IT_0011*IT_0279;
    const ccomplex_t IT_0281 = 1.4142135623731*IT_0280;
    const ccomplex_t IT_0282 = conj(N_d1)*e_em*m_tau*IT_0036*U_stau_10;
    ...
    const ccomplex_t IT_0287 = IT_0056*IT_0286;
    const ccomplex_t IT_0288 = (0 + _Complex_I*1)*IT_0287;
    const ccomplex_t IT_0289 = IT_0075*IT_0288;
    const ccomplex_t IT_0290 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0291 = IT_0002*IT_0290;
    const ccomplex_t IT_0292 = 1.4142135623731*IT_0291;
    const ccomplex_t IT_0293 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0294 = IT_0011*IT_0293;
    const ccomplex_t IT_0295 = 1.4142135623731*IT_0294;
    const ccomplex_t IT_0296 = conj(N_d3)*e_em*m_tau*IT_0036*U_stau_10;
    ...
    const ccomplex_t IT_0304 = IT_0044*IT_0251;
    const ccomplex_t IT_0305 = (0 + _Complex_I*1)*IT_0304;
    const ccomplex_t IT_0306 = IT_0018*IT_0305;
    const ccomplex_t IT_0307 = (-0.5)*IT_0272 + 0.5*IT_0275 + (-0.5)*IT_0289 +
       (-0.5)*IT_0303 + (-0.5)*IT_0306;
    const ccomplex_t IT_0308 = s_34*m_N_2;
    const ccomplex_t IT_0309 = IT_0156*IT_0251;
    const ccomplex_t IT_0310 = IT_0159*IT_0309;
    const ccomplex_t IT_0311 = (0 + _Complex_I*1)*IT_0310;
    const ccomplex_t IT_0312 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0313 = IT_0002*IT_0312;
    const ccomplex_t IT_0314 = 1.4142135623731*IT_0313;
    const ccomplex_t IT_0315 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0316 = IT_0011*IT_0315;
    const ccomplex_t IT_0317 = 1.4142135623731*IT_0316;
    const ccomplex_t IT_0318 = conj(N_d2)*e_em*m_tau*IT_0036*U_stau_11;
