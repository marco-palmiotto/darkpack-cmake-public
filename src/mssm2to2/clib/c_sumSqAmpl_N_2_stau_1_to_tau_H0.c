        ...
        )
{
    ...
    const ccomplex_t IT_0081 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0089 = conj(N_B1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0093 = conj(N_B2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0098 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0099 = IT_0051*IT_0098;
    const ccomplex_t IT_0100 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0101 = IT_0054*IT_0100;
    const ccomplex_t IT_0102 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0103 = IT_0051*IT_0102;
    const ccomplex_t IT_0104 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0157 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0158 = IT_0048*IT_0157;
    const ccomplex_t IT_0159 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0160 = IT_0057*IT_0159;
    const ccomplex_t IT_0161 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0162 = IT_0048*IT_0161;
    const ccomplex_t IT_0163 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0164 = IT_0057*IT_0163;
    const ccomplex_t IT_0165 = IT_0158 + IT_0160 + IT_0162 + IT_0164;
    const ccomplex_t IT_0166 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0170 = conj(N_B3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0183 = N_d3*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0192 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0193 = IT_0004*IT_0192;
    const ccomplex_t IT_0194 = 1.4142135623731*IT_0193;
    const ccomplex_t IT_0195 = N_d4*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0218 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0227 = conj(N_W2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0231 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0236 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0240 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0257 = m_N_2*IT_0155;
    const ccomplex_t IT_0258 = m_N_3*IT_0177;
    const ccomplex_t IT_0259 = IT_0257 + IT_0258;
    const ccomplex_t IT_0260 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0261 = IT_0004*IT_0260;
    const ccomplex_t IT_0262 = 1.4142135623731*IT_0261;
    const ccomplex_t IT_0263 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0264 = IT_0011*IT_0263;
    const ccomplex_t IT_0265 = 1.4142135623731*IT_0264;
    const ccomplex_t IT_0266 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0280 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_10;
    const ccomplex_t IT_0281 = IT_0012*IT_0280;
    ...
    const ccomplex_t IT_0287 = IT_0072*IT_0286;
    const ccomplex_t IT_0288 = (-2)*U_stau_00*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj
      (U_stau_00) + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_10)) +
       U_stau_10*(IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_00) + (-2)*
      (IT_0001*IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)
    ...
    const ccomplex_t IT_0291 = IT_0284*IT_0290;
    ...
    const ccomplex_t IT_0295 = IT_0004*IT_0294;
    ...
    const ccomplex_t IT_0300 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0305 = (-2)*U_stau_00*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj
      (U_stau_01) + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_11)) +
       U_stau_10*(IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)
    ...
    const ccomplex_t IT_0324 = m_N_2*IT_0131;
    const ccomplex_t IT_0325 = m_N_1*IT_0109;
    const ccomplex_t IT_0326 = IT_0324 + IT_0325;
    const ccomplex_t IT_0327 = IT_0323*IT_0326;
    const ccomplex_t IT_0328 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0329 = IT_0004*IT_0328;
    const ccomplex_t IT_0330 = 1.4142135623731*IT_0329;
    const ccomplex_t IT_0331 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0332 = IT_0011*IT_0331;
    const ccomplex_t IT_0333 = 1.4142135623731*IT_0332;
    const ccomplex_t IT_0334 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_10;
    const ccomplex_t IT_0335 = IT_0012*IT_0334;
    ...
    const ccomplex_t IT_0341 = m_N_4*IT_0245;
    const ccomplex_t IT_0342 = m_N_2*IT_0223;
    const ccomplex_t IT_0343 = IT_0341 + IT_0342;
    const ccomplex_t IT_0344 = IT_0340*IT_0343;
    const ccomplex_t IT_0345 = IT_0251*IT_0284;
    ...
    const ccomplex_t IT_0349 = 0.5*IT_0273 + 0.5*IT_0287 + 0.5*IT_0293 + 0.5
      *IT_0310 + 0.5*IT_0327 + 0.5*IT_0344 + -IT_0348;
    const ccomplex_t IT_0350 = 2*s_13;
    const ccomplex_t IT_0351 = m_N_2*m_tau;
    const ccomplex_t IT_0352 = 2*IT_0256;
    const ccomplex_t IT_0353 = IT_0131*IT_0323;
    const ccomplex_t IT_0354 = IT_0223*IT_0340;
    const ccomplex_t IT_0355 = IT_0060*IT_0286;
    const ccomplex_t IT_0356 = IT_0155*IT_0272;
    const ccomplex_t IT_0357 = 0.5*IT_0254 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0088*IT_0109;
    const ccomplex_t IT_0360 = IT_0177*IT_0190;
    const ccomplex_t IT_0361 = IT_0202*IT_0245;
    const ccomplex_t IT_0362 = IT_0070*IT_0076;
    const ccomplex_t IT_0363 = (-0.5)*IT_0347 + 0.5*IT_0359 + 0.5*IT_0360 +
       0.5*IT_0361 + 0.5*IT_0362;
    const ccomplex_t IT_0364 = s_34*m_N_2;
