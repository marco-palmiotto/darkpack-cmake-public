...
ccomplex_return_t c_sumSqAmpl_N_2_stau_1_to_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = N_B2*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0014 = N_d2*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0027 = (-2)*U_stau_00*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj
      (U_stau_00) + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_10)) +
       U_stau_10*(IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_00) + (-2)*
      (IT_0001*IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)
      *conj(U_stau_10));
    const ccomplex_t IT_0028 = (0 + _Complex_I*-1)*(e_em*IT_0027 + (
      -1.4142135623731)*A_tau*IT_0019*(conj(U_stau_00)*U_stau_10 + U_stau_00
      *conj(U_stau_10)));
    ...
    const ccomplex_t IT_0037 = N_d2*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0042 = (-2)*U_stau_00*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj
      (U_stau_01) + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_11)) +
       U_stau_10*(IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)
      *conj(U_stau_11));
    const ccomplex_t IT_0043 = (0 + _Complex_I*-1)*(e_em*IT_0042 + (
      -1.4142135623731)*A_tau*IT_0019*(conj(U_stau_01)*U_stau_10 + U_stau_00
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0062 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0063 = IT_0048*IT_0062;
    const ccomplex_t IT_0064 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0065 = IT_0051*IT_0064;
    const ccomplex_t IT_0066 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0067 = IT_0054*IT_0066;
    const ccomplex_t IT_0068 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0073 = pow(m_stau_1, 2);
    ...
    const ccomplex_t IT_0078 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0079 = IT_0004*IT_0078;
    const ccomplex_t IT_0080 = 1.4142135623731*IT_0079;
    const ccomplex_t IT_0081 = N_d4*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0089 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0090 = IT_0048*IT_0089;
    const ccomplex_t IT_0091 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0092 = IT_0057*IT_0091;
    const ccomplex_t IT_0093 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0094 = IT_0048*IT_0093;
    const ccomplex_t IT_0095 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0096 = IT_0057*IT_0095;
    const ccomplex_t IT_0097 = IT_0090 + IT_0092 + IT_0094 + IT_0096;
    const ccomplex_t IT_0098 = N_B4*N_u2*e_em;
    ...
    const ccomplex_t IT_0111 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0112 = IT_0048*IT_0111;
    const ccomplex_t IT_0113 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0114 = IT_0057*IT_0113;
    const ccomplex_t IT_0115 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0125 = IT_0051*IT_0124;
    ...
    const ccomplex_t IT_0135 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0136 = IT_0048*IT_0135;
    const ccomplex_t IT_0137 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0138 = IT_0057*IT_0137;
    const ccomplex_t IT_0139 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0140 = IT_0048*IT_0139;
    const ccomplex_t IT_0141 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0142 = IT_0057*IT_0141;
    const ccomplex_t IT_0143 = IT_0136 + IT_0138 + IT_0140 + IT_0142;
    const ccomplex_t IT_0144 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0145 = IT_0051*IT_0144;
    const ccomplex_t IT_0146 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0147 = IT_0054*IT_0146;
    const ccomplex_t IT_0148 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0149 = IT_0051*IT_0148;
    const ccomplex_t IT_0150 = N_W1*N_d2*e_em;
    const ccomplex_t IT_0151 = IT_0054*IT_0150;
    ...
    const ccomplex_t IT_0163 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0168 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0169 = IT_0054*IT_0168;
    const ccomplex_t IT_0170 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0171 = IT_0051*IT_0170;
    const ccomplex_t IT_0172 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0180 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0181 = IT_0004*IT_0180;
    const ccomplex_t IT_0182 = 1.4142135623731*IT_0181;
    const ccomplex_t IT_0183 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0192 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0193 = IT_0004*IT_0192;
    const ccomplex_t IT_0194 = 1.4142135623731*IT_0193;
    const ccomplex_t IT_0195 = N_d3*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0203 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0204 = IT_0048*IT_0203;
    const ccomplex_t IT_0205 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0206 = IT_0057*IT_0205;
    const ccomplex_t IT_0207 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0208 = IT_0048*IT_0207;
    ...
    const ccomplex_t IT_0226 = IT_0048*IT_0225;
    const ccomplex_t IT_0227 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0228 = IT_0057*IT_0227;
    ...
    const ccomplex_t IT_0246 = m_N_2*IT_0245;
    ...
    const ccomplex_t IT_0257 = 2*s_13;
    const ccomplex_t IT_0258 = IT_0177*IT_0190;
    const ccomplex_t IT_0259 = IT_0070*IT_0076;
    const ccomplex_t IT_0260 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0261 = IT_0004*IT_0260;
    const ccomplex_t IT_0262 = 1.4142135623731*IT_0261;
    const ccomplex_t IT_0263 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0264 = IT_0011*IT_0263;
    const ccomplex_t IT_0265 = 1.4142135623731*IT_0264;
    const ccomplex_t IT_0266 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0274 = IT_0202*IT_0245;
    const ccomplex_t IT_0275 = IT_0088*IT_0131;
    const ccomplex_t IT_0276 = 0.5*IT_0258 + 0.5*IT_0259 + (-0.5)*IT_0273 +
       0.5*IT_0274 + 0.5*IT_0275;
    const ccomplex_t IT_0277 = s_14*m_tau;
    const ccomplex_t IT_0278 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0279 = IT_0004*IT_0278;
    const ccomplex_t IT_0280 = 1.4142135623731*IT_0279;
    const ccomplex_t IT_0281 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0282 = IT_0011*IT_0281;
    const ccomplex_t IT_0283 = 1.4142135623731*IT_0282;
    const ccomplex_t IT_0284 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0289 = IT_0086*IT_0288;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*IT_0289;
    const ccomplex_t IT_0291 = IT_0109*IT_0290;
    const ccomplex_t IT_0292 = IT_0074*IT_0270;
    const ccomplex_t IT_0293 = (0 + _Complex_I*1)*IT_0292;
    const ccomplex_t IT_0294 = IT_0060*IT_0293;
    const ccomplex_t IT_0295 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0296 = IT_0004*IT_0295;
    const ccomplex_t IT_0297 = 1.4142135623731*IT_0296;
    const ccomplex_t IT_0298 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0299 = IT_0011*IT_0298;
    const ccomplex_t IT_0300 = 1.4142135623731*IT_0299;
    const ccomplex_t IT_0301 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_10;
    const ccomplex_t IT_0302 = IT_0012*IT_0301;
    const ccomplex_t IT_0303 = 1.4142135623731*IT_0302;
    const ccomplex_t IT_0304 = (0 + _Complex_I*1)*(IT_0297 + IT_0300 + 
      -IT_0303);
    const ccomplex_t IT_0305 = (-0.5)*IT_0304;
    const ccomplex_t IT_0306 = IT_0188*IT_0305;
    const ccomplex_t IT_0307 = (0 + _Complex_I*1)*IT_0306;
    const ccomplex_t IT_0308 = IT_0155*IT_0307;
    const ccomplex_t IT_0309 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0310 = IT_0004*IT_0309;
    const ccomplex_t IT_0311 = 1.4142135623731*IT_0310;
    const ccomplex_t IT_0312 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0313 = IT_0011*IT_0312;
    const ccomplex_t IT_0314 = 1.4142135623731*IT_0313;
    const ccomplex_t IT_0315 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0322 = IT_0223*IT_0321;
    const ccomplex_t IT_0323 = 0.5*IT_0254 + (-0.5)*IT_0291 + (-0.5)*IT_0294 +
       (-0.5)*IT_0308 + (-0.5)*IT_0322;
    const ccomplex_t IT_0324 = s_34*m_N_2;
    const ccomplex_t IT_0325 = m_N_2*IT_0223;
    const ccomplex_t IT_0326 = m_N_3*IT_0245;
    const ccomplex_t IT_0327 = IT_0325 + IT_0326;
    const ccomplex_t IT_0328 = IT_0321*IT_0327;
    const ccomplex_t IT_0329 = (-2)*U_stau_00*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj
      (U_stau_00) + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_10)) +
       U_stau_10*(IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_00) + (-2)*
      (IT_0001*IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)
      *conj(U_stau_10));
    const ccomplex_t IT_0330 = (0 + _Complex_I*-1)*(e_em*IT_0329 + (
      -1.4142135623731)*A_tau*IT_0019*(conj(U_stau_00)*U_stau_10 + U_stau_00
      *conj(U_stau_10)));
    const ccomplex_t IT_0331 = (-0.5)*IT_0330;
    const ccomplex_t IT_0332 = IT_0270*IT_0331;
    const ccomplex_t IT_0333 = IT_0002*IT_0332;
    const ccomplex_t IT_0334 = (0 + _Complex_I*1)*IT_0333;
    const ccomplex_t IT_0335 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0336 = IT_0004*IT_0335;
    const ccomplex_t IT_0337 = 1.4142135623731*IT_0336;
    const ccomplex_t IT_0338 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0339 = IT_0011*IT_0338;
    const ccomplex_t IT_0340 = 1.4142135623731*IT_0339;
    const ccomplex_t IT_0341 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0346 = (-2)*U_stau_00*((IT_0001*IT_0009*IT_0011
      *IT_0013*IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj
      (U_stau_01) + -1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_11)) +
       U_stau_10*(IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0009*IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)
    ...
    const ccomplex_t IT_0350 = IT_0033*IT_0349;
    const ccomplex_t IT_0351 = (0 + _Complex_I*1)*IT_0350;
    const ccomplex_t IT_0352 = IT_0072*IT_0293;
    const ccomplex_t IT_0353 = m_N_2*IT_0155;
    const ccomplex_t IT_0354 = m_N_1*IT_0177;
    const ccomplex_t IT_0355 = IT_0353 + IT_0354;
    const ccomplex_t IT_0356 = IT_0307*IT_0355;
    const ccomplex_t IT_0357 = m_N_2*IT_0109;
    const ccomplex_t IT_0358 = m_N_4*IT_0131;
    const ccomplex_t IT_0359 = IT_0357 + IT_0358;
    const ccomplex_t IT_0360 = IT_0290*IT_0359;
    const ccomplex_t IT_0361 = m_tau*IT_0273;
    const ccomplex_t IT_0362 = 0.5*IT_0328 + 0.5*IT_0334 + 0.5*IT_0351 + 0.5
      *IT_0352 + 0.5*IT_0356 + 0.5*IT_0360 + -IT_0361;
    const ccomplex_t IT_0363 = 2*conj(IT_0362);
    const ccomplex_t IT_0364 = m_N_2*m_tau;
    const ccomplex_t IT_0365 = 2*IT_0256;
    const ccomplex_t IT_0366 = 2*conj(IT_0256);
    const ccomplex_t IT_0367 = pow(m_H0, 2);
    const ccomplex_t IT_0368 = m_N_2*m_tau*IT_0367;
    ...
    const ccomplex_t IT_0374 = 0.5*IT_0324;
    const ccomplex_t IT_0375 = IT_0256*conj(IT_0256)*IT_0257 + (IT_0276
      *IT_0277 + IT_0323*IT_0324)*IT_0363 + conj(IT_0362)*(IT_0257*IT_0362 +
       IT_0364*IT_0365) + (IT_0277*IT_0323 + IT_0276*IT_0324 + IT_0362*IT_0364)
      *IT_0366 + 2*conj(IT_0276)*(IT_0323*IT_0368 + -IT_0276*IT_0372 + 0.5
      *IT_0277*IT_0373 + IT_0365*IT_0374) + 2*conj(IT_0323)*(0.5*IT_0277*IT_0365
       + IT_0276*IT_0368 + -IT_0323*IT_0372 + IT_0373*IT_0374);
