        ...
        )
{
    ...
    const ccomplex_t IT_0027 = 2*U_stau_00*((IT_0001*IT_0009*IT_0011*IT_0013
      *IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj(U_stau_00
      ) + 1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_10)) + U_stau_10*
      (IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_00) + 2*(IT_0001*IT_0009
      *IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)*conj(U_stau_10));
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*(e_em*IT_0027 +
       1.4142135623731*A_tau*IT_0019*(conj(U_stau_00)*U_stau_10 + U_stau_00*conj
      (U_stau_10)));
    ...
    const ccomplex_t IT_0042 = 2*U_stau_00*((IT_0001*IT_0009*IT_0011*IT_0013
      *IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj(U_stau_01
      ) + 1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_11)) + U_stau_10*
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*(e_em*IT_0042 +
       1.4142135623731*A_tau*IT_0019*(conj(U_stau_01)*U_stau_10 + U_stau_00*conj
      (U_stau_11)));
    ...
    const ccomplex_t IT_0048 = IT_0004*IT_0021;
    const ccomplex_t IT_0049 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = IT_0004*IT_0019;
    const ccomplex_t IT_0052 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = IT_0011*IT_0021;
    const ccomplex_t IT_0055 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = IT_0011*IT_0019;
    const ccomplex_t IT_0058 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0063 = conj(N_B2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0067 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0075 = pow(m_stau_1, 2);
    ...
    const ccomplex_t IT_0080 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0081 = IT_0004*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0097 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0098 = IT_0051*IT_0097;
    const ccomplex_t IT_0099 = IT_0092 + IT_0094 + IT_0096 + IT_0098;
    const ccomplex_t IT_0100 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0101 = IT_0054*IT_0100;
    const ccomplex_t IT_0102 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0103 = IT_0057*IT_0102;
    const ccomplex_t IT_0104 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0105 = IT_0054*IT_0104;
    const ccomplex_t IT_0106 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0113 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0114 = IT_0048*IT_0113;
    const ccomplex_t IT_0115 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0116 = IT_0051*IT_0115;
    const ccomplex_t IT_0117 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0118 = IT_0048*IT_0117;
    const ccomplex_t IT_0119 = N_B1*N_d2*e_em;
    ...
    const ccomplex_t IT_0124 = N_W2*N_d1*e_em;
    ...
    const ccomplex_t IT_0137 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0138 = IT_0048*IT_0137;
    const ccomplex_t IT_0139 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0140 = IT_0051*IT_0139;
    const ccomplex_t IT_0141 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0142 = IT_0048*IT_0141;
    const ccomplex_t IT_0143 = N_B2*N_d3*e_em;
    ...
    const ccomplex_t IT_0159 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0160 = IT_0048*IT_0159;
    const ccomplex_t IT_0161 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0162 = IT_0051*IT_0161;
    const ccomplex_t IT_0163 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0164 = IT_0048*IT_0163;
    const ccomplex_t IT_0165 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0166 = IT_0051*IT_0165;
    const ccomplex_t IT_0167 = IT_0160 + IT_0162 + IT_0164 + IT_0166;
    const ccomplex_t IT_0168 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0169 = IT_0054*IT_0168;
    const ccomplex_t IT_0170 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0171 = IT_0057*IT_0170;
    const ccomplex_t IT_0172 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0173 = IT_0054*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0182 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0183 = IT_0004*IT_0182;
    const ccomplex_t IT_0184 = 1.4142135623731*IT_0183;
    const ccomplex_t IT_0185 = N_d3*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0194 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0195 = IT_0004*IT_0194;
    const ccomplex_t IT_0196 = 1.4142135623731*IT_0195;
    const ccomplex_t IT_0197 = N_d4*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0227 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0228 = IT_0048*IT_0227;
    const ccomplex_t IT_0229 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0230 = IT_0051*IT_0229;
    const ccomplex_t IT_0231 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0232 = IT_0048*IT_0231;
    const ccomplex_t IT_0233 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0234 = IT_0051*IT_0233;
    const ccomplex_t IT_0235 = IT_0228 + IT_0230 + IT_0232 + IT_0234;
    const ccomplex_t IT_0236 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0237 = IT_0054*IT_0236;
    const ccomplex_t IT_0238 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0239 = IT_0057*IT_0238;
    const ccomplex_t IT_0240 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0241 = IT_0054*IT_0240;
    const ccomplex_t IT_0242 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0259 = m_N_2*IT_0157;
    const ccomplex_t IT_0260 = m_N_3*IT_0179;
    const ccomplex_t IT_0261 = IT_0259 + IT_0260;
    const ccomplex_t IT_0262 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0263 = IT_0004*IT_0262;
    const ccomplex_t IT_0264 = 1.4142135623731*IT_0263;
    const ccomplex_t IT_0265 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0266 = IT_0011*IT_0265;
    const ccomplex_t IT_0267 = 1.4142135623731*IT_0266;
    const ccomplex_t IT_0268 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_10;
    const ccomplex_t IT_0269 = IT_0012*IT_0268;
    ...
    const ccomplex_t IT_0273 = IT_0190*IT_0272;
    ...
    const ccomplex_t IT_0282 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0287 = IT_0076*IT_0286;
    const ccomplex_t IT_0288 = (0 + _Complex_I*1)*IT_0287;
    const ccomplex_t IT_0289 = IT_0074*IT_0288;
    const ccomplex_t IT_0290 = 2*U_stau_00*((IT_0001*IT_0009*IT_0011*IT_0013
      *IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj(U_stau_00
      ) + 1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_10)) + U_stau_10*
      (IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_00) + 2*(IT_0001*IT_0009
      *IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0296 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0297 = IT_0004*IT_0296;
    const ccomplex_t IT_0298 = 1.4142135623731*IT_0297;
    const ccomplex_t IT_0299 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0300 = IT_0011*IT_0299;
    const ccomplex_t IT_0301 = 1.4142135623731*IT_0300;
    const ccomplex_t IT_0302 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0307 = 2*U_stau_00*((IT_0001*IT_0009*IT_0011*IT_0013
      *IT_0019 + (-0.5)*m_W*IT_0025*(IT_0011 + -IT_0010*IT_0026))*conj(U_stau_01
      ) + 1./2*IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_11)) + U_stau_10*
      (IT_0009*IT_0011*IT_0020*IT_0021*conj(U_stau_01) + 2*(IT_0001*IT_0009
      *IT_0011*IT_0013*IT_0019 + -m_W*IT_0010*IT_0025*IT_0026)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0311 = IT_0033*IT_0310;
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*IT_0311;
    const ccomplex_t IT_0313 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0314 = IT_0004*IT_0313;
    const ccomplex_t IT_0315 = 1.4142135623731*IT_0314;
    const ccomplex_t IT_0316 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0317 = IT_0011*IT_0316;
    const ccomplex_t IT_0318 = 1.4142135623731*IT_0317;
    const ccomplex_t IT_0319 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_10;
    const ccomplex_t IT_0320 = IT_0012*IT_0319;
    ...
    const ccomplex_t IT_0343 = m_N_4*IT_0247;
    const ccomplex_t IT_0344 = m_N_2*IT_0225;
    const ccomplex_t IT_0345 = IT_0343 + IT_0344;
    const ccomplex_t IT_0346 = IT_0342*IT_0345;
    const ccomplex_t IT_0347 = IT_0253*IT_0286;
    ...
    const ccomplex_t IT_0351 = 0.5*IT_0275 + 0.5*IT_0289 + 0.5*IT_0295 + 0.5
    ...
    const ccomplex_t IT_0355 = IT_0133*IT_0325;
    const ccomplex_t IT_0356 = IT_0225*IT_0342;
    const ccomplex_t IT_0357 = IT_0061*IT_0288;
    const ccomplex_t IT_0358 = IT_0157*IT_0274;
    const ccomplex_t IT_0359 = 0.5*IT_0256 + (-0.5)*IT_0355 + (-0.5)*IT_0356 +
       (-0.5)*IT_0357 + (-0.5)*IT_0358;
    const ccomplex_t IT_0360 = s_14*m_tau;
    const ccomplex_t IT_0361 = IT_0090*IT_0111;
    const ccomplex_t IT_0362 = IT_0179*IT_0192;
    const ccomplex_t IT_0363 = IT_0204*IT_0247;
    const ccomplex_t IT_0364 = IT_0072*IT_0078;
