        ...
        )
{
    ...
    const ccomplex_t IT_0018 = e_em*conj(U_Wm2)*U_stau_01;
    ...
    const ccomplex_t IT_0024 = conj(U_d2)*e_em*m_tau*IT_0023*U_stau_11;
    ...
    const ccomplex_t IT_0042 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0043 = IT_0010*IT_0042;
    const ccomplex_t IT_0044 = conj(U_d1)*e_em*m_tau*IT_0023*U_stau_11;
    ...
    const ccomplex_t IT_0052 = pow(m_N_2, 2);
    const ccomplex_t IT_0053 = pow(m_tau, 2);
    const ccomplex_t IT_0054 = cpow(s_12 + 0.5*IT_0029 + 0.5*IT_0052 + (-0.5)
      *IT_0053 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*m_tau;
    ...
    const ccomplex_t IT_0060 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0061 = IT_0059*IT_0060;
    const ccomplex_t IT_0062 = 1.4142135623731*IT_0061;
    const ccomplex_t IT_0063 = N_d2*e_em*m_tau*IT_0023*U_stau_01;
    ...
    const ccomplex_t IT_0069 = IT_0054*IT_0055*IT_0068;
    const ccomplex_t IT_0070 = conj(N_W2)*e_em*U_Wm1;
    const ccomplex_t IT_0071 = IT_0010*IT_0070;
    const ccomplex_t IT_0072 = conj(N_d2)*U_d1*e_em;
    ...
    const ccomplex_t IT_0081 = N_W2*e_em*conj(V_Wp2);
    const ccomplex_t IT_0082 = IT_0010*IT_0081;
    const ccomplex_t IT_0083 = N_u2*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0091 = 0.5*IT_0051 + 0.5*IT_0069 + (-0.5)*IT_0080 +
       0.5*IT_0090;
    const ccomplex_t IT_0092 = IT_0034 + IT_0091;
    const ccomplex_t IT_0093 = conj(IT_0034) + conj(IT_0091);
    const ccomplex_t IT_0094 = s_34*IT_0001;
    const ccomplex_t IT_0095 = IT_0000*IT_0094;
    const ccomplex_t IT_0096 = (-0.25)*IT_0095;
    const ccomplex_t IT_0097 = s_34 + IT_0096;
    const ccomplex_t IT_0098 = m_N_2*IT_0097;
    const ccomplex_t IT_0099 = (-4)*IT_0098;
    const ccomplex_t IT_0100 = 0.5*IT_0032;
    const ccomplex_t IT_0101 = (-0.5)*IT_0079;
    const ccomplex_t IT_0102 = 2*IT_0034;
    const ccomplex_t IT_0103 = 2*IT_0091;
    const ccomplex_t IT_0104 = IT_0102 + IT_0103;
    const ccomplex_t IT_0105 = 2*conj(IT_0034);
    const ccomplex_t IT_0106 = 2*conj(IT_0091);
    const ccomplex_t IT_0107 = IT_0105 + IT_0106;
    const ccomplex_t IT_0108 = s_14*s_34*IT_0000;
    ...
    const ccomplex_t IT_0122 = cpow(s_13 + (-0.5)*IT_0052 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0140 = (-0.5)*IT_0125 + -IT_0139;
    const ccomplex_t IT_0141 = -IT_0032;
    const ccomplex_t IT_0142 = 2*IT_0141;
    const ccomplex_t IT_0143 = IT_0079 + 0.5*IT_0125;
    const ccomplex_t IT_0144 = (-2)*IT_0143;
    const ccomplex_t IT_0145 = IT_0142 + IT_0144;
    const ccomplex_t IT_0146 = 2*conj(IT_0141);
    const ccomplex_t IT_0147 = (-2)*conj(IT_0143);
    const ccomplex_t IT_0148 = IT_0146 + IT_0147;
    const ccomplex_t IT_0149 = m_N_2*IT_0110;
    const ccomplex_t IT_0150 = pow(s_34, 2);
    const ccomplex_t IT_0151 = s_13*IT_0000*IT_0150;
    const ccomplex_t IT_0152 = 2*IT_0140;
    const ccomplex_t IT_0153 = m_N_2*IT_0000*IT_0150;
    const ccomplex_t IT_0154 = 2*conj(IT_0140);
    const ccomplex_t IT_0155 = s_13*s_34;
    const ccomplex_t IT_0156 = (-0.5)*IT_0139;
    const ccomplex_t IT_0157 = conj(IT_0100) + conj(IT_0156);
    const ccomplex_t IT_0158 = IT_0100 + IT_0156;
    const ccomplex_t IT_0159 = pow(s_14, 2);
    const ccomplex_t IT_0160 = IT_0000*IT_0159;
    const ccomplex_t IT_0161 = -IT_0052;
    const ccomplex_t IT_0162 = IT_0160 + IT_0161;
    const ccomplex_t IT_0163 = s_13*IT_0162;
    const ccomplex_t IT_0164 = (-2)*conj(IT_0141);
    const ccomplex_t IT_0165 = 0.5*IT_0164;
    const ccomplex_t IT_0166 = conj(IT_0143) + IT_0165;
    const ccomplex_t IT_0167 = (-2)*IT_0141;
    const ccomplex_t IT_0168 = s_13*s_14;
    const ccomplex_t IT_0169 = s_34*IT_0052;
    ...
    const ccomplex_t IT_0176 = IT_0002 + IT_0004 + IT_0175;
    const ccomplex_t IT_0177 = -conj(IT_0101);
    const ccomplex_t IT_0178 = (-0.25)*IT_0174;
    const ccomplex_t IT_0179 = IT_0003 + IT_0178;
    const ccomplex_t IT_0180 = 0.5*IT_0095;
    const ccomplex_t IT_0181 = s_34 + IT_0180;
    const ccomplex_t IT_0182 = m_N_2*IT_0181;
    const ccomplex_t IT_0183 = 2*IT_0182;
    const ccomplex_t IT_0184 = 0.125*IT_0183;
    const ccomplex_t IT_0185 = 4*IT_0008*IT_0092*IT_0093 + (-2)*IT_0099*
      (IT_0093*IT_0100 + IT_0092*conj(IT_0100) + (-0.5)*conj(IT_0101)*IT_0104 + 
      (-0.5)*IT_0101*IT_0107) + IT_0111*(conj(IT_0140)*IT_0145 + IT_0140*IT_0148
      ) + (IT_0093*IT_0145 + IT_0092*IT_0148)*IT_0149 + conj(IT_0140)*IT_0151
      *IT_0152 + IT_0153*(IT_0093*IT_0152 + IT_0092*IT_0154) + (-2)*IT_0155*
      (conj(IT_0101)*IT_0140 + IT_0101*conj(IT_0140) + (-0.5)*IT_0152*IT_0157 + 
      (-0.5)*IT_0154*IT_0158) + 2*IT_0163*(0.5*conj(IT_0141)*IT_0142 + IT_0143
      *IT_0166 + 0.5*conj(IT_0143)*IT_0167) + 2*(0.5*IT_0145*IT_0157 + 0.5
      *IT_0148*IT_0158 + IT_0101*IT_0166 + conj(IT_0101)*(IT_0143 + 0.5*IT_0167)
      )*IT_0171 + (-4)*IT_0176*(IT_0156*conj(IT_0156) + (IT_0100 + -IT_0101)*
      (conj(IT_0100) + IT_0177)) + 8*conj(IT_0156)*((IT_0100 + -IT_0101)*IT_0179
       + IT_0104*IT_0184) + 8*IT_0156*((conj(IT_0100) + IT_0177)*IT_0179 +
       IT_0107*IT_0184);
