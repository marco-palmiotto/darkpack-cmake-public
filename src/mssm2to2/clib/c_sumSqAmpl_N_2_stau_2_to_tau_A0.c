...
ccomplex_return_t c_sumSqAmpl_N_2_stau_2_to_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = N_B2*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0037 = N_d2*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0048 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0049 = IT_0002*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = N_d1*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0059 = N_B2*N_u1*e_em;
    const ccomplex_t IT_0060 = IT_0003*IT_0059;
    const ccomplex_t IT_0061 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0062 = IT_0007*IT_0061;
    const ccomplex_t IT_0063 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0064 = IT_0012*IT_0063;
    const ccomplex_t IT_0065 = N_W2*N_d1*e_em;
    const ccomplex_t IT_0066 = IT_0015*IT_0065;
    const ccomplex_t IT_0067 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0068 = IT_0003*IT_0067;
    const ccomplex_t IT_0069 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0070 = IT_0007*IT_0069;
    const ccomplex_t IT_0071 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0072 = IT_0012*IT_0071;
    const ccomplex_t IT_0073 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0081 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0082 = IT_0012*IT_0081;
    const ccomplex_t IT_0083 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0084 = IT_0015*IT_0083;
    const ccomplex_t IT_0085 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0086 = IT_0003*IT_0085;
    const ccomplex_t IT_0087 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0088 = IT_0007*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0090 = IT_0012*IT_0089;
    const ccomplex_t IT_0091 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0097 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0098 = IT_0002*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = N_d3*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0108 = N_B3*N_u2*e_em;
    ...
    const ccomplex_t IT_0122 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0125 = m_N_3*IT_0124;
    ...
    const ccomplex_t IT_0162 = cpow(s_13 + (-0.5)*IT_0042 + (-0.5)*IT_0146 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0163 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0164 = IT_0002*IT_0163;
    const ccomplex_t IT_0165 = 1.4142135623731*IT_0164;
    const ccomplex_t IT_0166 = N_d2*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0171 = e_em*mu_h*m_tau*IT_0036*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0172 = IT_0011*IT_0171;
    const ccomplex_t IT_0173 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0174 = IT_0011*IT_0173;
    const ccomplex_t IT_0175 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0176 = IT_0006*IT_0175;
    const ccomplex_t IT_0177 = 1.4142135623731*IT_0176;
    const ccomplex_t IT_0178 = A_tau*conj(U_stau_00)*U_stau_11;
    ...
    const ccomplex_t IT_0183 = IT_0162*IT_0182;
    ...
    const ccomplex_t IT_0261 = IT_0162*IT_0260;
    const ccomplex_t IT_0262 = (0 + _Complex_I*1)*IT_0261;
    const ccomplex_t IT_0263 = IT_0044*IT_0245;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0030*IT_0264;
    const ccomplex_t IT_0266 = m_N_2*IT_0075;
    const ccomplex_t IT_0267 = m_N_1*IT_0093;
    const ccomplex_t IT_0268 = IT_0266 + IT_0267;
    const ccomplex_t IT_0269 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0270 = IT_0002*IT_0269;
    const ccomplex_t IT_0271 = 1.4142135623731*IT_0270;
    const ccomplex_t IT_0272 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0273 = IT_0011*IT_0272;
    const ccomplex_t IT_0274 = 1.4142135623731*IT_0273;
    const ccomplex_t IT_0275 = conj(N_d1)*e_em*m_tau*IT_0036*U_stau_11;
    ...
    const ccomplex_t IT_0280 = IT_0056*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = IT_0268*IT_0281;
    const ccomplex_t IT_0283 = m_N_2*IT_0124;
    const ccomplex_t IT_0284 = m_N_3*IT_0142;
    const ccomplex_t IT_0285 = IT_0283 + IT_0284;
    const ccomplex_t IT_0286 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0287 = IT_0002*IT_0286;
    const ccomplex_t IT_0288 = 1.4142135623731*IT_0287;
    const ccomplex_t IT_0289 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0290 = IT_0011*IT_0289;
    const ccomplex_t IT_0291 = 1.4142135623731*IT_0290;
    const ccomplex_t IT_0292 = conj(N_d3)*e_em*m_tau*IT_0036*U_stau_11;
    const ccomplex_t IT_0293 = IT_0035*IT_0292;
    ...
    const ccomplex_t IT_0311 = IT_0193*IT_0310;
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*IT_0311;
    const ccomplex_t IT_0313 = m_N_2*IT_0212;
    const ccomplex_t IT_0314 = m_N_4*IT_0230;
    const ccomplex_t IT_0315 = IT_0313 + IT_0314;
    const ccomplex_t IT_0316 = IT_0312*IT_0315;
    const ccomplex_t IT_0317 = 0.5*IT_0248 + 0.5*IT_0262 + 0.5*IT_0265 + 0.5
      *IT_0282 + 0.5*IT_0299 + 0.5*IT_0316;
    const ccomplex_t IT_0318 = 2*s_13;
    const ccomplex_t IT_0319 = m_N_2*m_tau;
    const ccomplex_t IT_0320 = 2*IT_0234;
    const ccomplex_t IT_0321 = cpow(s_12 + (-0.5)*IT_0042 + 0.5*IT_0043 + 0.5
      *IT_0146 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0322 = e_em*m_tau*IT_0006*IT_0011*IT_0034*IT_0036;
    const ccomplex_t IT_0323 = (-0.5)*IT_0322;
    const ccomplex_t IT_0324 = IT_0041*IT_0323;
    const ccomplex_t IT_0325 = IT_0321*IT_0324;
    const ccomplex_t IT_0326 = (0 + _Complex_I*1)*IT_0325;
    const ccomplex_t IT_0327 = IT_0075*IT_0281;
    const ccomplex_t IT_0328 = IT_0124*IT_0298;
    const ccomplex_t IT_0329 = IT_0018*IT_0264;
    const ccomplex_t IT_0330 = IT_0212*IT_0312;
    const ccomplex_t IT_0331 = 0.5*IT_0326 + (-0.5)*IT_0327 + (-0.5)*IT_0328 +
       (-0.5)*IT_0329 + (-0.5)*IT_0330;
    const ccomplex_t IT_0332 = s_14*m_tau;
    const ccomplex_t IT_0333 = IT_0245*IT_0323;
    const ccomplex_t IT_0334 = IT_0321*IT_0333;
    const ccomplex_t IT_0335 = (0 + _Complex_I*1)*IT_0334;
    const ccomplex_t IT_0336 = IT_0058*IT_0093;
    const ccomplex_t IT_0337 = IT_0028*IT_0046;
    const ccomplex_t IT_0338 = IT_0107*IT_0142;
    const ccomplex_t IT_0339 = IT_0195*IT_0230;
    const ccomplex_t IT_0340 = 0.5*IT_0335 + 0.5*IT_0336 + 0.5*IT_0337 + 0.5
      *IT_0338 + 0.5*IT_0339;
