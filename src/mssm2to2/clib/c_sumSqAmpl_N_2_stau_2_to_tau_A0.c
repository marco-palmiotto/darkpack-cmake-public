        ...
        )
{
    ...
    const ccomplex_t IT_0044 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0045 = IT_0021*IT_0044;
    const ccomplex_t IT_0046 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0047 = IT_0025*IT_0046;
    const ccomplex_t IT_0048 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0049 = IT_0028*IT_0048;
    const ccomplex_t IT_0050 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0051 = IT_0031*IT_0050;
    const ccomplex_t IT_0052 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0064 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_d3*e_em*m_tau*IT_0010*U_stau_01;
    ...
    const ccomplex_t IT_0081 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0082 = IT_0031*IT_0081;
    const ccomplex_t IT_0083 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0084 = IT_0021*IT_0083;
    const ccomplex_t IT_0085 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0086 = IT_0025*IT_0085;
    const ccomplex_t IT_0087 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0088 = IT_0028*IT_0087;
    const ccomplex_t IT_0089 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0093 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0103 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0104 = IT_0025*IT_0103;
    const ccomplex_t IT_0105 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0106 = IT_0028*IT_0105;
    const ccomplex_t IT_0107 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0113 = pow(m_N_2, 2);
    const ccomplex_t IT_0114 = cpow(s_13 + (-0.5)*IT_0016 + (-0.5)*IT_0113 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0115 = e_em*mu_h*m_tau*IT_0010*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0116 = IT_0008*IT_0115;
    const ccomplex_t IT_0117 = e_em*mu_h*m_tau*IT_0010*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0118 = IT_0008*IT_0117;
    const ccomplex_t IT_0119 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0120 = IT_0024*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = A_tau*conj(U_stau_00)*U_stau_11;
    ...
    const ccomplex_t IT_0129 = N_d2*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0137 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0138 = IT_0021*IT_0137;
    const ccomplex_t IT_0139 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0140 = IT_0025*IT_0139;
    const ccomplex_t IT_0141 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0142 = IT_0028*IT_0141;
    const ccomplex_t IT_0143 = N_W2*N_d2*e_em;
    ...
    const ccomplex_t IT_0166 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0170 = e_em*mu_h*m_tau*IT_0010*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0171 = IT_0008*IT_0170;
    const ccomplex_t IT_0172 = e_em*mu_h*m_tau*IT_0010*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0173 = IT_0008*IT_0172;
    const ccomplex_t IT_0174 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0175 = IT_0024*IT_0174;
    const ccomplex_t IT_0176 = 1.4142135623731*IT_0175;
    const ccomplex_t IT_0177 = A_tau*U_stau_01*conj(U_stau_11);
    ...
    const ccomplex_t IT_0182 = cpow(s_13 + (-0.5)*IT_0016 + (-0.5)*IT_0113 + (
    ...
    const ccomplex_t IT_0188 = N_d4*e_em*m_tau*IT_0010*U_stau_01;
    ...
    const ccomplex_t IT_0193 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0203 = IT_0031*IT_0202;
    ...
    const ccomplex_t IT_0227 = IT_0028*IT_0226;
    ...
    const ccomplex_t IT_0234 = (-0.5)*IT_0063 + (-0.5)*IT_0112 + (-0.5)
      *IT_0136 + (-0.5)*IT_0169 + (-0.5)*IT_0184 + (-0.5)*IT_0233;
    ...
    const ccomplex_t IT_0241 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_11;
    ...
    const ccomplex_t IT_0246 = IT_0166*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = IT_0157*IT_0247;
    ...
    const ccomplex_t IT_0255 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0260 = IT_0125*IT_0259;
    const ccomplex_t IT_0261 = IT_0114*IT_0260;
    const ccomplex_t IT_0262 = (0 + _Complex_I*1)*IT_0261;
    const ccomplex_t IT_0263 = m_N_2*IT_0042;
    const ccomplex_t IT_0264 = m_N_1*IT_0060;
    ...
    const ccomplex_t IT_0272 = conj(N_d1)*e_em*m_tau*IT_0010*U_stau_11;
    ...
    const ccomplex_t IT_0291 = IT_0072*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = m_N_2*IT_0091;
    const ccomplex_t IT_0294 = m_N_3*IT_0109;
    ...
    const ccomplex_t IT_0303 = conj(N_d4)*e_em*m_tau*IT_0010*U_stau_11;
    ...
    const ccomplex_t IT_0310 = m_N_2*IT_0212;
    const ccomplex_t IT_0311 = m_N_4*IT_0230;
    const ccomplex_t IT_0312 = IT_0310 + IT_0311;
    const ccomplex_t IT_0313 = IT_0309*IT_0312;
    const ccomplex_t IT_0314 = IT_0180*IT_0245;
    const ccomplex_t IT_0315 = IT_0182*IT_0314;
    ...
    const ccomplex_t IT_0321 = IT_0091*IT_0292;
    const ccomplex_t IT_0322 = IT_0212*IT_0309;
    const ccomplex_t IT_0323 = IT_0145*IT_0247;
    const ccomplex_t IT_0324 = e_em*m_tau*IT_0006*IT_0008*IT_0010*IT_0024;
    const ccomplex_t IT_0325 = (-0.5)*IT_0324;
    const ccomplex_t IT_0326 = IT_0165*IT_0325;
    const ccomplex_t IT_0327 = cpow(s_12 + (-0.5)*IT_0016 + 0.5*IT_0017 + 0.5
      *IT_0113 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0328 = IT_0326*IT_0327;
    const ccomplex_t IT_0329 = (0 + _Complex_I*1)*IT_0328;
    const ccomplex_t IT_0330 = IT_0042*IT_0278;
    const ccomplex_t IT_0331 = (-0.5)*IT_0321 + (-0.5)*IT_0322 + (-0.5)
      *IT_0323 + 0.5*IT_0329 + (-0.5)*IT_0330;
    const ccomplex_t IT_0332 = s_14*m_tau;
    const ccomplex_t IT_0333 = IT_0020*IT_0060;
    const ccomplex_t IT_0334 = IT_0074*IT_0109;
    const ccomplex_t IT_0335 = IT_0195*IT_0230;
    const ccomplex_t IT_0336 = IT_0155*IT_0168;
    const ccomplex_t IT_0337 = IT_0245*IT_0325;
