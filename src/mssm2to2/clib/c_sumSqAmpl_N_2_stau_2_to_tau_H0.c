        ...
        )
{
    ...
    const ccomplex_t IT_0104 = (-2)*conj(U_stau_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))
      *U_stau_01 + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0008*IT_0025*IT_0083*U_stau_01 + (-2)*(IT_0006
      *IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)*U_stau_11);
    ...
    const ccomplex_t IT_0110 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0111 = IT_0022*IT_0110;
    const ccomplex_t IT_0112 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0113 = IT_0034*IT_0112;
    const ccomplex_t IT_0114 = N_W2*N_d2*e_em;
    const ccomplex_t IT_0115 = IT_0037*IT_0114;
    const ccomplex_t IT_0116 = N_W2*N_u2*e_em;
    ...
    const ccomplex_t IT_0120 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0121 = IT_0022*IT_0120;
    const ccomplex_t IT_0122 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0123 = IT_0034*IT_0122;
    const ccomplex_t IT_0124 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0125 = IT_0037*IT_0124;
    const ccomplex_t IT_0126 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0135 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0136 = IT_0001*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = N_d1*e_em*m_tau*IT_0010*U_stau_01;
    ...
    const ccomplex_t IT_0143 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0192 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0193 = IT_0022*IT_0192;
    const ccomplex_t IT_0194 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0195 = IT_0026*IT_0194;
    const ccomplex_t IT_0196 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0197 = IT_0022*IT_0196;
    const ccomplex_t IT_0198 = N_W2*N_u4*e_em;
    ...
    const ccomplex_t IT_0214 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0215 = IT_0022*IT_0214;
    const ccomplex_t IT_0216 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0217 = IT_0026*IT_0216;
    const ccomplex_t IT_0218 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0219 = IT_0022*IT_0218;
    const ccomplex_t IT_0220 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0225 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0229 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0237 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0238 = IT_0001*IT_0237;
    const ccomplex_t IT_0239 = 1.4142135623731*IT_0238;
    const ccomplex_t IT_0240 = N_d4*e_em*m_tau*IT_0010*U_stau_01;
    ...
    const ccomplex_t IT_0263 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_11;
    ...
    const ccomplex_t IT_0271 = m_N_3*IT_0069;
    const ccomplex_t IT_0272 = m_N_2*IT_0047;
    ...
    const ccomplex_t IT_0280 = conj(N_d3)*e_em*m_tau*IT_0010*U_stau_11;
    ...
    const ccomplex_t IT_0285 = IT_0018*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*IT_0285;
    const ccomplex_t IT_0287 = IT_0273*IT_0286;
    const ccomplex_t IT_0288 = (-2)*U_stau_01*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_01) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)
    ...
    const ccomplex_t IT_0300 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0305 = (-2)*conj(U_stau_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))
      *U_stau_01 + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0008*IT_0025*IT_0083*U_stau_01 + (-2)*(IT_0006
      *IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)*U_stau_11);
    ...
    const ccomplex_t IT_0324 = m_N_2*IT_0188;
    const ccomplex_t IT_0325 = m_N_1*IT_0166;
    ...
    const ccomplex_t IT_0339 = IT_0245*IT_0338;
    const ccomplex_t IT_0340 = (0 + _Complex_I*1)*IT_0339;
    const ccomplex_t IT_0341 = m_N_2*IT_0212;
    ...
    const ccomplex_t IT_0353 = IT_0118*IT_0269;
    const ccomplex_t IT_0354 = IT_0188*IT_0323;
    const ccomplex_t IT_0355 = IT_0047*IT_0286;
    const ccomplex_t IT_0356 = IT_0212*IT_0340;
    const ccomplex_t IT_0357 = 0.5*IT_0254 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0128*IT_0133;
