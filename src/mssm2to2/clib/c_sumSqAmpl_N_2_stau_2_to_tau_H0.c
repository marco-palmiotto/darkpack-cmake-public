...
ccomplex_return_t c_sumSqAmpl_N_2_stau_2_to_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0074 = cpow(s_12 + (-0.5)*IT_0067 + 0.5*IT_0068 + 0.5
      *IT_0073 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0008
      *IT_0059*IT_0061;
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0078 = IT_0002*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = N_d2*e_em*m_tau*IT_0061*U_stau_01;
    ...
    const ccomplex_t IT_0089 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*IT_0073 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0090 = mu_h*m_tau*IT_0061;
    const ccomplex_t IT_0091 = sin(beta);
    const ccomplex_t IT_0092 = -IT_0006*IT_0091;
    const ccomplex_t IT_0093 = IT_0000*IT_0058;
    const ccomplex_t IT_0094 = IT_0092 + IT_0093;
    const ccomplex_t IT_0095 = cpow(IT_0001, -2);
    const ccomplex_t IT_0096 = (-2)*U_stau_01*((IT_0000*IT_0008*IT_0059
      *IT_0061*IT_0067 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0008*IT_0059*IT_0090*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0008*IT_0059*IT_0090*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0008*IT_0059*IT_0061*IT_0067 + -m_W*IT_0007*IT_0094*IT_0095)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0102 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*IT_0073 + (
    ...
    const ccomplex_t IT_0106 = N_d2*e_em*m_tau*IT_0061*U_stau_00;
    ...
    const ccomplex_t IT_0111 = (-2)*conj(U_stau_00)*((IT_0000*IT_0008*IT_0059
      *IT_0061*IT_0067 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))
      *U_stau_01 + -1./2*IT_0006*IT_0008*IT_0059*IT_0090*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0008*IT_0059*IT_0090*U_stau_01 + (-2)*(IT_0000
      *IT_0008*IT_0059*IT_0061*IT_0067 + -m_W*IT_0007*IT_0094*IT_0095)*U_stau_11);
    ...
    const ccomplex_t IT_0127 = conj(N_B2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0131 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0157 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0164 = conj(N_B1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0165 = IT_0003*IT_0164;
    const ccomplex_t IT_0166 = conj(N_W1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0167 = IT_0009*IT_0166;
    const ccomplex_t IT_0168 = conj(N_B2)*conj(N_d1)*e_em;
    const ccomplex_t IT_0169 = IT_0003*IT_0168;
    const ccomplex_t IT_0170 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0171 = IT_0009*IT_0170;
    const ccomplex_t IT_0172 = IT_0165 + IT_0167 + IT_0169 + IT_0171;
    const ccomplex_t IT_0173 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0174 = IT_0017*IT_0173;
    const ccomplex_t IT_0175 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0176 = IT_0020*IT_0175;
    const ccomplex_t IT_0177 = conj(N_B2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0187 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0188 = IT_0002*IT_0187;
    const ccomplex_t IT_0189 = 1.4142135623731*IT_0188;
    const ccomplex_t IT_0190 = N_d1*e_em*m_tau*IT_0061*U_stau_01;
    ...
    const ccomplex_t IT_0195 = cpow(s_23 + (-0.5)*IT_0067 + (-0.5)*IT_0068 +
    ...
    const ccomplex_t IT_0242 = m_N_2*IT_0241;
    const ccomplex_t IT_0243 = IT_0220 + IT_0242;
    const ccomplex_t IT_0244 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0245 = IT_0002*IT_0244;
    const ccomplex_t IT_0246 = 1.4142135623731*IT_0245;
    const ccomplex_t IT_0247 = N_d4*e_em*m_tau*IT_0061*U_stau_01;
    ...
    const ccomplex_t IT_0252 = cpow(s_23 + (-0.5)*IT_0067 + (-0.5)*IT_0068 +
    ...
    const ccomplex_t IT_0268 = IT_0138*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0137*IT_0269;
    const ccomplex_t IT_0271 = m_N_2*IT_0162;
    const ccomplex_t IT_0272 = m_N_1*IT_0184;
    const ccomplex_t IT_0273 = IT_0271 + IT_0272;
    const ccomplex_t IT_0274 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0275 = IT_0002*IT_0274;
    const ccomplex_t IT_0276 = 1.4142135623731*IT_0275;
    const ccomplex_t IT_0277 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0278 = IT_0008*IT_0277;
    const ccomplex_t IT_0279 = 1.4142135623731*IT_0278;
    const ccomplex_t IT_0280 = conj(N_d1)*e_em*m_tau*IT_0061*U_stau_11;
    const ccomplex_t IT_0281 = IT_0060*IT_0280;
    ...
    const ccomplex_t IT_0288 = IT_0076*IT_0267;
    const ccomplex_t IT_0289 = IT_0074*IT_0288;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*IT_0289;
    const ccomplex_t IT_0291 = m_tau*IT_0290;
    const ccomplex_t IT_0292 = (-2)*U_stau_01*((IT_0000*IT_0008*IT_0059
      *IT_0061*IT_0067 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0008*IT_0059*IT_0090*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0008*IT_0059*IT_0090*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0008*IT_0059*IT_0061*IT_0067 + -m_W*IT_0007*IT_0094*IT_0095)
    ...
    const ccomplex_t IT_0295 = IT_0267*IT_0294;
    const ccomplex_t IT_0296 = IT_0089*IT_0295;
    const ccomplex_t IT_0297 = (0 + _Complex_I*1)*IT_0296;
    const ccomplex_t IT_0298 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0299 = IT_0002*IT_0298;
    ...
    const ccomplex_t IT_0304 = conj(N_d2)*e_em*m_tau*IT_0061*U_stau_10;
    const ccomplex_t IT_0305 = IT_0060*IT_0304;
    ...
    const ccomplex_t IT_0309 = (-2)*conj(U_stau_00)*((IT_0000*IT_0008*IT_0059
      *IT_0061*IT_0067 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))
      *U_stau_01 + -1./2*IT_0006*IT_0008*IT_0059*IT_0090*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0008*IT_0059*IT_0090*U_stau_01 + (-2)*(IT_0000
      *IT_0008*IT_0059*IT_0061*IT_0067 + -m_W*IT_0007*IT_0094*IT_0095)*U_stau_11);
    const ccomplex_t IT_0310 = (0 + _Complex_I*-1)*(e_em*IT_0309 + (
      -1.4142135623731)*A_tau*IT_0000*(U_stau_01*conj(U_stau_10) + conj
      (U_stau_00)*U_stau_11));
    ...
    const ccomplex_t IT_0315 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0316 = IT_0002*IT_0315;
    const ccomplex_t IT_0317 = 1.4142135623731*IT_0316;
    const ccomplex_t IT_0318 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0319 = IT_0008*IT_0318;
    const ccomplex_t IT_0320 = 1.4142135623731*IT_0319;
    const ccomplex_t IT_0321 = conj(N_d3)*e_em*m_tau*IT_0061*U_stau_11;
    const ccomplex_t IT_0322 = IT_0060*IT_0321;
    const ccomplex_t IT_0323 = 1.4142135623731*IT_0322;
    const ccomplex_t IT_0324 = (0 + _Complex_I*1)*(IT_0317 + IT_0320 + 
      -IT_0323);
    const ccomplex_t IT_0325 = (-0.5)*IT_0324;
    const ccomplex_t IT_0326 = IT_0069*IT_0325;
    const ccomplex_t IT_0327 = (0 + _Complex_I*1)*IT_0326;
    const ccomplex_t IT_0328 = m_N_2*IT_0030;
    const ccomplex_t IT_0329 = m_N_3*IT_0052;
    ...
    const ccomplex_t IT_0338 = conj(N_d4)*e_em*m_tau*IT_0061*U_stau_11;
    const ccomplex_t IT_0339 = IT_0060*IT_0338;
    ...
    const ccomplex_t IT_0346 = m_N_2*IT_0219;
    const ccomplex_t IT_0347 = IT_0345 + IT_0346;
    const ccomplex_t IT_0348 = IT_0344*IT_0347;
    const ccomplex_t IT_0349 = 0.5*IT_0270 + 0.5*IT_0287 + -IT_0291 + 0.5
    ...
    const ccomplex_t IT_0353 = IT_0125*IT_0269;
    const ccomplex_t IT_0354 = IT_0162*IT_0286;
    const ccomplex_t IT_0355 = IT_0030*IT_0327;
    const ccomplex_t IT_0356 = IT_0219*IT_0344;
    const ccomplex_t IT_0357 = 0.5*IT_0087 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0135*IT_0140;
    const ccomplex_t IT_0360 = IT_0184*IT_0197;
    const ccomplex_t IT_0361 = IT_0052*IT_0071;
    const ccomplex_t IT_0362 = IT_0241*IT_0254;
    const ccomplex_t IT_0363 = (-0.5)*IT_0290 + 0.5*IT_0359 + 0.5*IT_0360 +
