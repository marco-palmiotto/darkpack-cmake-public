...
ccomplex_return_t c_sumSqAmpl_N_2_su_L_to_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0014;
    const ccomplex_t IT_0024 = IT_0010*IT_0014;
    const ccomplex_t IT_0025 = N_u2*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0051 = N_W2*V_u1*e_em;
    ...
    const ccomplex_t IT_0055 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0122 = m_d*m_N_2;
    ...
    const ccomplex_t IT_0127 = IT_0018*IT_0116;
    const ccomplex_t IT_0128 = IT_0008*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = m_N_2*IT_0119;
    const ccomplex_t IT_0130 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0131 = IT_0040*IT_0069;
    const ccomplex_t IT_0132 = IT_0043*IT_0130*IT_0131;
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0029;
    ...
    const ccomplex_t IT_0143 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
    ...
    const ccomplex_t IT_0150 = IT_0060*IT_0089;
    const ccomplex_t IT_0151 = IT_0046*IT_0149*IT_0150;
    const ccomplex_t IT_0152 = -IT_0128 + IT_0129 + -IT_0132 + IT_0140 +
       IT_0148 + -IT_0151;
    const ccomplex_t IT_0153 = IT_0087 + IT_0105;
    const ccomplex_t IT_0154 = m_d*IT_0153;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = IT_0023*IT_0084;
    const ccomplex_t IT_0157 = IT_0043*IT_0130*IT_0156;
    const ccomplex_t IT_0158 = IT_0047*IT_0102;
    ...
    const ccomplex_t IT_0165 = m_N_2*IT_0021;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0009*IT_0014*IT_0067;
    const ccomplex_t IT_0167 = 0.5*IT_0166;
    const ccomplex_t IT_0168 = IT_0134*IT_0167;
    ...
    const ccomplex_t IT_0172 = IT_0008*IT_0126*IT_0171;
    const ccomplex_t IT_0173 = -IT_0157 + -IT_0159 + -IT_0164 + -IT_0165 + 
      -IT_0170 + IT_0172;
    ...
    const ccomplex_t IT_0189 = m_d*m_N_2*IT_0000;
