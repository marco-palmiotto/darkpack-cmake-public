        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0014;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0014;
    ...
    const ccomplex_t IT_0068 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = (-2)*IT_0069;
    const ccomplex_t IT_0071 = IT_0011*IT_0027;
    ...
    const ccomplex_t IT_0101 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
      *e_em*IT_0009*IT_0014*IT_0082;
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
    ...
    const ccomplex_t IT_0131 = cpow((-2)*s_13 + IT_0007 + IT_0023 + -m_sd_R*
    ...
    const ccomplex_t IT_0151 = m_N_2*IT_0119;
    ...
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0009*IT_0014*IT_0082;
    const ccomplex_t IT_0162 = 0.5*IT_0161;
    const ccomplex_t IT_0163 = IT_0127*IT_0162;
    const ccomplex_t IT_0164 = IT_0131*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*IT_0164;
    const ccomplex_t IT_0166 = IT_0047*IT_0081;
    const ccomplex_t IT_0167 = IT_0046*IT_0148*IT_0166;
    const ccomplex_t IT_0168 = IT_0025*IT_0100;
    const ccomplex_t IT_0169 = IT_0024*IT_0134*IT_0168;
    const ccomplex_t IT_0170 = IT_0016*IT_0114;
    const ccomplex_t IT_0171 = IT_0008*IT_0137*IT_0170;
    const ccomplex_t IT_0172 = m_N_2*IT_0021;
    const ccomplex_t IT_0173 = -IT_0160 + -IT_0165 + -IT_0167 + -IT_0169 +
       IT_0171 + -IT_0172;
