...
ccomplex_return_t c_sumSqAmpl_N_2_su_L_to_u_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = (-0.5)*IT_0026 + 0.5*IT_0029 + 0.5*IT_0032 + (
      -0.5)*IT_0035 + (-0.5)*IT_0037 + 0.5*IT_0039 + 0.5*IT_0041 + (-0.5)*IT_0043;
    const ccomplex_t IT_0045 = m_N_4*IT_0044;
    const ccomplex_t IT_0046 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0047 = IT_0024*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0052 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0053 = IT_0033*IT_0052;
    const ccomplex_t IT_0054 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0055 = IT_0024*IT_0054;
    const ccomplex_t IT_0056 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0057 = IT_0027*IT_0056;
    const ccomplex_t IT_0058 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0059 = IT_0030*IT_0058;
    const ccomplex_t IT_0060 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0063 = m_N_2*IT_0062;
    const ccomplex_t IT_0064 = IT_0045 + IT_0063;
    const ccomplex_t IT_0065 = IT_0022*IT_0064;
    const ccomplex_t IT_0066 = N_B2*N_u2*e_em;
    const ccomplex_t IT_0067 = IT_0024*IT_0066;
    const ccomplex_t IT_0068 = N_B2*N_d2*e_em;
    const ccomplex_t IT_0069 = IT_0027*IT_0068;
    const ccomplex_t IT_0070 = N_W2*N_u2*e_em;
    const ccomplex_t IT_0071 = IT_0030*IT_0070;
    const ccomplex_t IT_0072 = N_W2*N_d2*e_em;
    const ccomplex_t IT_0073 = IT_0033*IT_0072;
    const ccomplex_t IT_0074 = -IT_0067 + IT_0069 + IT_0071 + -IT_0073;
    const ccomplex_t IT_0075 = m_N_2*IT_0074;
    const ccomplex_t IT_0076 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0077 = IT_0024*IT_0076;
    const ccomplex_t IT_0078 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0079 = IT_0027*IT_0078;
    const ccomplex_t IT_0080 = conj(N_W2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0081 = IT_0030*IT_0080;
    const ccomplex_t IT_0082 = conj(N_W2)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0000*IT_0002*IT_0016;
    const ccomplex_t IT_0088 = (-0.5)*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0010 + IT_0019 + -m_N_2*
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_23 + IT_0010 + IT_0019 + -m_N_1*
    ...
    const ccomplex_t IT_0106 = N_B1*N_u2*e_em;
    const ccomplex_t IT_0107 = IT_0024*IT_0106;
    const ccomplex_t IT_0108 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0109 = IT_0027*IT_0108;
    const ccomplex_t IT_0110 = N_W1*N_u2*e_em;
    const ccomplex_t IT_0111 = IT_0030*IT_0110;
    const ccomplex_t IT_0112 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0128 = conj(N_W2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0129 = IT_0030*IT_0128;
    const ccomplex_t IT_0130 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0000*IT_0002*IT_0016;
    ...
    const ccomplex_t IT_0141 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0142 = IT_0024*IT_0141;
    const ccomplex_t IT_0143 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0144 = IT_0027*IT_0143;
    const ccomplex_t IT_0145 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0146 = IT_0030*IT_0145;
    const ccomplex_t IT_0147 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0148 = IT_0033*IT_0147;
    const ccomplex_t IT_0149 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0150 = IT_0024*IT_0149;
    const ccomplex_t IT_0151 = N_B2*N_d3*e_em;
    ...
    const ccomplex_t IT_0163 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0164 = IT_0030*IT_0163;
    const ccomplex_t IT_0165 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0166 = IT_0033*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0168 = IT_0024*IT_0167;
    const ccomplex_t IT_0169 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0170 = IT_0027*IT_0169;
    const ccomplex_t IT_0171 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0172 = IT_0030*IT_0171;
    const ccomplex_t IT_0173 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0179 = IT_0014 + IT_0065 + IT_0092 + IT_0135 + IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
    ...
    const ccomplex_t IT_0237 = IT_0086*IT_0236;
    const ccomplex_t IT_0238 = -IT_0184 + -IT_0198 + -IT_0212 + -IT_0226 + 
      -IT_0237;
    const ccomplex_t IT_0239 = 6*s_13;
    const ccomplex_t IT_0240 = m_u*m_N_2;
    const ccomplex_t IT_0241 = 6*IT_0179;
    const ccomplex_t IT_0242 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0019 
      + -reg_prop, -1);
    const ccomplex_t IT_0243 = m_u*e_em*IT_0000*IT_0002*IT_0016*IT_0023;
    ...
    const ccomplex_t IT_0248 = IT_0074*IT_0236;
    const ccomplex_t IT_0249 = IT_0157*IT_0211;
    const ccomplex_t IT_0250 = IT_0114*IT_0194;
    const ccomplex_t IT_0251 = IT_0044*IT_0225;
    const ccomplex_t IT_0252 = -IT_0247 + IT_0248 + IT_0249 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_u*s_14;
    const ccomplex_t IT_0254 = IT_0234*IT_0244;
    const ccomplex_t IT_0255 = IT_0242*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0084*IT_0091;
    const ccomplex_t IT_0258 = IT_0022*IT_0062;
    const ccomplex_t IT_0259 = IT_0097*IT_0132;
    const ccomplex_t IT_0260 = IT_0140*IT_0175;
    const ccomplex_t IT_0261 = -IT_0256 + -IT_0257 + -IT_0258 + -IT_0259 + 
      -IT_0260;
    const ccomplex_t IT_0262 = s_34*m_N_2;
    const ccomplex_t IT_0263 = 6*conj(IT_0179);
    const ccomplex_t IT_0264 = 6*conj(IT_0238);
    const ccomplex_t IT_0265 = pow(m_A0, 2);
    const ccomplex_t IT_0266 = m_u*m_N_2*IT_0265;
