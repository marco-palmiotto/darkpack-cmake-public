...
ccomplex_return_t c_sumSqAmpl_N_2_su_L_to_u_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_su_L*
    ...
    const ccomplex_t IT_0045 = m_u*s_14*m_N_2;
    ...
    const ccomplex_t IT_0057 = m_u*m_N_2;
    ...
    const ccomplex_t IT_0062 = m_u*s_34*m_N_2;
