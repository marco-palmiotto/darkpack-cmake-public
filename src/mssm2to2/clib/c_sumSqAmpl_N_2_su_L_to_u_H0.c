        ...
        )
{
    ...
    const ccomplex_t IT_0236 = m_u*IT_0235;
    const ccomplex_t IT_0237 = conj(N_B1)*e_em;
    const ccomplex_t IT_0238 = IT_0009*IT_0237;
    ...
    const ccomplex_t IT_0245 = IT_0068*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*IT_0245;
    const ccomplex_t IT_0247 = m_N_2*IT_0091;
    const ccomplex_t IT_0248 = m_N_1*IT_0113;
    const ccomplex_t IT_0249 = IT_0247 + IT_0248;
    const ccomplex_t IT_0250 = IT_0246*IT_0249;
    const ccomplex_t IT_0251 = IT_0037*IT_0232;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*IT_0251;
    const ccomplex_t IT_0253 = IT_0064*IT_0252;
    const ccomplex_t IT_0254 = conj(N_B3)*e_em;
    const ccomplex_t IT_0255 = IT_0009*IT_0254;
    const ccomplex_t IT_0256 = 1.4142135623731*IT_0255;
    const ccomplex_t IT_0257 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0262 = IT_0119*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1)*IT_0262;
    const ccomplex_t IT_0264 = m_N_2*IT_0142;
    const ccomplex_t IT_0265 = m_N_3*IT_0164;
    ...
    const ccomplex_t IT_0276 = IT_0170*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1)*IT_0276;
    const ccomplex_t IT_0278 = m_N_2*IT_0193;
    const ccomplex_t IT_0279 = m_N_4*IT_0215;
    const ccomplex_t IT_0280 = IT_0278 + IT_0279;
    const ccomplex_t IT_0281 = IT_0277*IT_0280;
    const ccomplex_t IT_0282 = IT_0022*IT_0232;
    const ccomplex_t IT_0283 = IT_0026*IT_0282;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = -IT_0224 + 2*IT_0236 + -IT_0250 + -IT_0253 + 
    ...
    const ccomplex_t IT_0289 = IT_0193*IT_0277;
    const ccomplex_t IT_0290 = IT_0091*IT_0246;
    const ccomplex_t IT_0291 = IT_0142*IT_0263;
    const ccomplex_t IT_0292 = IT_0052*IT_0252;
