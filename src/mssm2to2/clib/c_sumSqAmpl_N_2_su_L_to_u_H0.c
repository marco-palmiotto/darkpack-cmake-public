...
ccomplex_return_t c_sumSqAmpl_N_2_su_L_to_u_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
    ...
    const ccomplex_t IT_0037 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_2*
    ...
    const ccomplex_t IT_0044 = N_B2*N_u2*e_em;
    ...
    const ccomplex_t IT_0050 = N_W2*N_u2*e_em;
    ...
    const ccomplex_t IT_0054 = conj(N_B2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0055 = IT_0040*IT_0054;
    const ccomplex_t IT_0056 = conj(N_B2)*conj(N_u2)*e_em;
    const ccomplex_t IT_0057 = IT_0043*IT_0056;
    const ccomplex_t IT_0058 = conj(N_W2)*conj(N_d2)*e_em;
    const ccomplex_t IT_0059 = IT_0046*IT_0058;
    const ccomplex_t IT_0060 = conj(N_W2)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0071 = N_B2*N_d1*e_em;
    const ccomplex_t IT_0072 = IT_0040*IT_0071;
    const ccomplex_t IT_0073 = N_W2*N_u1*e_em;
    const ccomplex_t IT_0074 = IT_0049*IT_0073;
    const ccomplex_t IT_0075 = N_B1*N_d2*e_em;
    const ccomplex_t IT_0076 = IT_0040*IT_0075;
    const ccomplex_t IT_0077 = N_W1*N_u2*e_em;
    ...
    const ccomplex_t IT_0086 = N_W1*N_d2*e_em;
    ...
    const ccomplex_t IT_0099 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0104 = conj(N_W1)*conj(N_d2)*e_em;
    const ccomplex_t IT_0105 = IT_0046*IT_0104;
    const ccomplex_t IT_0106 = conj(N_B2)*conj(N_u1)*e_em;
    const ccomplex_t IT_0107 = IT_0043*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W2)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0144 = conj(N_B2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0148 = conj(N_B3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0153 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0154 = IT_0043*IT_0153;
    const ccomplex_t IT_0155 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0156 = IT_0046*IT_0155;
    const ccomplex_t IT_0157 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0158 = IT_0043*IT_0157;
    const ccomplex_t IT_0159 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0165 = m_N_2*IT_0164;
    ...
    const ccomplex_t IT_0190 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0191 = IT_0040*IT_0190;
    const ccomplex_t IT_0192 = conj(N_W2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0199 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0200 = IT_0043*IT_0199;
    const ccomplex_t IT_0201 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0202 = IT_0046*IT_0201;
    const ccomplex_t IT_0203 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0204 = IT_0043*IT_0203;
    const ccomplex_t IT_0205 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0232 = m_N_2*IT_0091;
    const ccomplex_t IT_0233 = m_N_1*IT_0113;
    ...
    const ccomplex_t IT_0243 = IT_0068*IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*IT_0243;
    const ccomplex_t IT_0245 = IT_0234*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
    ...
    const ccomplex_t IT_0279 = IT_0215*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*IT_0279;
    const ccomplex_t IT_0281 = m_N_2*IT_0188;
    const ccomplex_t IT_0282 = m_N_4*IT_0210;
    const ccomplex_t IT_0283 = IT_0281 + IT_0282;
    const ccomplex_t IT_0284 = IT_0280*IT_0283;
    const ccomplex_t IT_0285 = 2*IT_0231 + -IT_0245 + -IT_0250 + -IT_0264 + 
      -IT_0267 + -IT_0270 + -IT_0284;
    const ccomplex_t IT_0286 = 6*s_13;
    const ccomplex_t IT_0287 = m_u*m_N_2;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0091*IT_0244;
    const ccomplex_t IT_0290 = IT_0052*IT_0269;
    const ccomplex_t IT_0291 = IT_0142*IT_0260;
    const ccomplex_t IT_0292 = IT_0188*IT_0280;
    ...
    const ccomplex_t IT_0297 = IT_0121*IT_0164;
    const ccomplex_t IT_0298 = IT_0210*IT_0217;
    ...
    const ccomplex_t IT_0304 = m_u*m_N_2*IT_0303;
