...
ccomplex_return_t c_sumSqAmpl_N_2_su_L_to_u_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = conj(N_B1)*conj(N_u2)*e_em;
    const ccomplex_t IT_0033 = IT_0003*IT_0032;
    const ccomplex_t IT_0034 = conj(N_B1)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0041 = conj(N_W1)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0045 = conj(N_W2)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0016*IT_0055*IT_0057;
    const ccomplex_t IT_0059 = (-0.5)*IT_0058;
    const ccomplex_t IT_0060 = pow(m_u, 2);
    const ccomplex_t IT_0061 = pow(m_su_L, 2);
    ...
    const ccomplex_t IT_0066 = pow(m_N_2, 2);
    const ccomplex_t IT_0067 = cpow((-2)*s_12 + IT_0060 + -IT_0061 + -IT_0066 
      + -reg_prop, -1);
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0016*IT_0055*IT_0057;
    const ccomplex_t IT_0069 = (-0.5)*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0016
      *IT_0055*IT_0057;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0006
      *IT_0016*IT_0055*IT_0057;
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0060 + IT_0066 + -m_su_R*
    ...
    const ccomplex_t IT_0085 = cpow(IT_0001, -2);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0016
      *IT_0055*IT_0057*IT_0060 + (-0.5)*m_W*(IT_0000*IT_0056 + IT_0006*IT_0084)*
      (IT_0016 + -1./3*IT_0015*IT_0085));
    const ccomplex_t IT_0087 = -IT_0086;
    const ccomplex_t IT_0088 = IT_0069*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_13 + IT_0060 + IT_0066 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*IT_0090;
    const ccomplex_t IT_0092 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0093 = IT_0003*IT_0092;
    const ccomplex_t IT_0094 = N_B3*N_d2*e_em;
    ...
    const ccomplex_t IT_0101 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0102 = IT_0017*IT_0101;
    const ccomplex_t IT_0103 = N_W3*N_d2*e_em;
    ...
    const ccomplex_t IT_0113 = m_N_3*IT_0112;
    ...
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0016*IT_0055*IT_0057;
    const ccomplex_t IT_0138 = (-0.5)*IT_0137;
    const ccomplex_t IT_0139 = cpow((-2)*s_23 + IT_0060 + IT_0061 + -m_N_3*
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*(IT_0155 + IT_0157 + 
      -IT_0159 + -IT_0161);
    const ccomplex_t IT_0163 = -IT_0162;
    const ccomplex_t IT_0164 = m_N_2*IT_0163;
    const ccomplex_t IT_0165 = IT_0153 + IT_0164;
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0060 + IT_0061 + -m_N_2*
    ...
    const ccomplex_t IT_0197 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0198 = IT_0003*IT_0197;
    const ccomplex_t IT_0199 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0200 = IT_0007*IT_0199;
    const ccomplex_t IT_0201 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0202 = IT_0003*IT_0201;
    const ccomplex_t IT_0203 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0204 = IT_0007*IT_0203;
    const ccomplex_t IT_0205 = IT_0198 + IT_0200 + IT_0202 + IT_0204;
    const ccomplex_t IT_0206 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0207 = IT_0017*IT_0206;
    const ccomplex_t IT_0208 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0218 = m_N_2*IT_0217;
    const ccomplex_t IT_0219 = IT_0196 + IT_0218;
    const ccomplex_t IT_0220 = IT_0174*IT_0219;
    const ccomplex_t IT_0221 = IT_0065 + (-2)*IT_0075 + IT_0083 + IT_0091 +
       IT_0142 + IT_0169 + IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0016*IT_0055*IT_0057;
    const ccomplex_t IT_0223 = 0.5*IT_0222;
    const ccomplex_t IT_0224 = IT_0077*IT_0223;
    const ccomplex_t IT_0225 = IT_0081*IT_0224;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = m_N_2*IT_0030;
    const ccomplex_t IT_0228 = m_N_1*IT_0052;
    const ccomplex_t IT_0229 = IT_0227 + IT_0228;
    const ccomplex_t IT_0230 = conj(N_B1)*e_em;
    const ccomplex_t IT_0231 = IT_0002*IT_0230;
    const ccomplex_t IT_0232 = 1.4142135623731*IT_0231;
    const ccomplex_t IT_0233 = conj(N_W1)*e_em;
    const ccomplex_t IT_0234 = IT_0016*IT_0233;
    const ccomplex_t IT_0235 = 1.4142135623731*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*(IT_0232 + 3*IT_0235);
    ...
    const ccomplex_t IT_0250 = IT_0089*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = m_N_2*IT_0112;
    const ccomplex_t IT_0253 = m_N_3*IT_0134;
    const ccomplex_t IT_0254 = IT_0252 + IT_0253;
    const ccomplex_t IT_0255 = conj(N_B3)*e_em;
    const ccomplex_t IT_0256 = IT_0002*IT_0255;
    const ccomplex_t IT_0257 = 1.4142135623731*IT_0256;
    const ccomplex_t IT_0258 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0263 = IT_0139*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0254*IT_0264;
    const ccomplex_t IT_0266 = IT_0166*IT_0248;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*IT_0266;
    const ccomplex_t IT_0268 = IT_0165*IT_0267;
    const ccomplex_t IT_0269 = conj(N_B4)*e_em;
    const ccomplex_t IT_0270 = IT_0002*IT_0269;
    const ccomplex_t IT_0271 = 1.4142135623731*IT_0270;
    const ccomplex_t IT_0272 = conj(N_W4)*e_em;
    const ccomplex_t IT_0273 = IT_0016*IT_0272;
    const ccomplex_t IT_0274 = 1.4142135623731*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*(IT_0271 + 3*IT_0274);
    const ccomplex_t IT_0276 = 0.166666666666667*IT_0275;
    const ccomplex_t IT_0277 = IT_0172*IT_0276;
    const ccomplex_t IT_0278 = (0 + _Complex_I*1)*IT_0277;
    const ccomplex_t IT_0279 = m_N_2*IT_0195;
    const ccomplex_t IT_0280 = m_N_4*IT_0217;
    const ccomplex_t IT_0281 = IT_0279 + IT_0280;
    const ccomplex_t IT_0282 = IT_0278*IT_0281;
    const ccomplex_t IT_0283 = IT_0071*IT_0248;
    const ccomplex_t IT_0284 = IT_0067*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*IT_0284;
    const ccomplex_t IT_0286 = m_u*IT_0285;
    const ccomplex_t IT_0287 = -IT_0226 + -IT_0240 + -IT_0251 + -IT_0265 + 
      -IT_0268 + -IT_0282 + 2*IT_0286;
    const ccomplex_t IT_0288 = 6*s_13;
    const ccomplex_t IT_0289 = m_u*m_N_2;
    const ccomplex_t IT_0290 = 6*IT_0221;
    const ccomplex_t IT_0291 = IT_0112*IT_0264;
    const ccomplex_t IT_0292 = IT_0152*IT_0267;
    const ccomplex_t IT_0293 = IT_0030*IT_0239;
    const ccomplex_t IT_0294 = IT_0195*IT_0278;
    const ccomplex_t IT_0295 = -IT_0074 + IT_0291 + IT_0292 + IT_0293 + IT_0294;
    const ccomplex_t IT_0296 = m_u*s_14;
    const ccomplex_t IT_0297 = IT_0163*IT_0168;
    const ccomplex_t IT_0298 = IT_0052*IT_0064;
    const ccomplex_t IT_0299 = IT_0134*IT_0141;
    const ccomplex_t IT_0300 = IT_0174*IT_0217;
    const ccomplex_t IT_0301 = IT_0285 + -IT_0297 + -IT_0298 + -IT_0299 + 
      -IT_0300;
    const ccomplex_t IT_0302 = s_34*m_N_2;
    const ccomplex_t IT_0303 = 6*conj(IT_0221);
    const ccomplex_t IT_0304 = 6*conj(IT_0287);
    const ccomplex_t IT_0305 = pow(m_h, 2);
    const ccomplex_t IT_0306 = m_u*m_N_2*IT_0305;
