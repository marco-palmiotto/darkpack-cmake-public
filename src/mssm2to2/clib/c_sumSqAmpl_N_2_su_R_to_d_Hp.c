        ...
        )
{
    ...
    const ccomplex_t IT_0037 = IT_0009*IT_0012;
    const ccomplex_t IT_0038 = N_W2*V_u1*e_em;
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = IT_0036 + IT_0040;
    const ccomplex_t IT_0042 = N_u2*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0096 = IT_0067*IT_0094*IT_0095;
    const ccomplex_t IT_0097 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0098 = IT_0079*IT_0097;
    const ccomplex_t IT_0099 = (-2)*IT_0098;
    const ccomplex_t IT_0100 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0101 = IT_0083*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0112 = IT_0030*IT_0110*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
    ...
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
