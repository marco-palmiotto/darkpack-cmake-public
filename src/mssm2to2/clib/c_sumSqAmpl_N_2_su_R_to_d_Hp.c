...
ccomplex_return_t c_sumSqAmpl_N_2_su_R_to_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_d*m_N_2*IT_0000;
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
    ...
    const ccomplex_t IT_0031 = IT_0012*IT_0022;
    const ccomplex_t IT_0032 = N_B2*V_u1*e_em;
    const ccomplex_t IT_0033 = IT_0031*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = IT_0009*IT_0012;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0000 + IT_0029 + -m_C_2*
    ...
    const ccomplex_t IT_0078 = m_d*m_N_2;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0080 = IT_0011*IT_0020;
    const ccomplex_t IT_0081 = IT_0004*IT_0079*IT_0080;
    const ccomplex_t IT_0082 = IT_0006*IT_0009;
    const ccomplex_t IT_0083 = conj(N_d2)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = (-2)*IT_0084;
    const ccomplex_t IT_0086 = IT_0006*IT_0022;
    const ccomplex_t IT_0087 = conj(N_B2)*conj(U_d2)*e_em;
    const ccomplex_t IT_0088 = IT_0086*IT_0087;
    const ccomplex_t IT_0089 = 1.4142135623731*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W2)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0099 = IT_0067*IT_0097*IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0003 + IT_0029 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0109 = conj(N_d2)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0110 = IT_0082*IT_0109;
    const ccomplex_t IT_0111 = (-2)*IT_0110;
    const ccomplex_t IT_0112 = conj(N_B2)*conj(U_d1)*e_em;
    const ccomplex_t IT_0113 = IT_0086*IT_0112;
    const ccomplex_t IT_0114 = 1.4142135623731*IT_0113;
    const ccomplex_t IT_0115 = conj(N_W2)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0123 = IT_0030*IT_0108*IT_0122;
    const ccomplex_t IT_0124 = m_N_2*IT_0027;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
    ...
    const ccomplex_t IT_0136 = cpow((-2)*s_13 + IT_0003 + IT_0029 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0137 = IT_0135*IT_0136;
    const ccomplex_t IT_0138 = (0 + _Complex_I*1)*IT_0137;
    const ccomplex_t IT_0139 = IT_0081 + -IT_0099 + -IT_0107 + -IT_0123 + 
      -IT_0124 + -IT_0138;
    const ccomplex_t IT_0140 = IT_0015*IT_0024;
    const ccomplex_t IT_0141 = IT_0004*IT_0079*IT_0140;
    const ccomplex_t IT_0142 = m_N_2*IT_0018;
    ...
    const ccomplex_t IT_0148 = (-0.333333333333333)*IT_0023;
    const ccomplex_t IT_0149 = IT_0101*IT_0148;
    const ccomplex_t IT_0150 = IT_0105*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*IT_0150;
    const ccomplex_t IT_0152 = -IT_0141 + IT_0142 + IT_0147 + IT_0151;
    ...
    const ccomplex_t IT_0166 = s_23*m_N_2;
