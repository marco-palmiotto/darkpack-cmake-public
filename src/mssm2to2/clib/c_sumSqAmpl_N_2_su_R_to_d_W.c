        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_W2)*e_em*V_Wp1;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = conj(N_u2)*V_u1*e_em;
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_ud*e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0045 = pow(m_u, 2);
    const ccomplex_t IT_0046 = pow(m_N_2, 2);
    const ccomplex_t IT_0047 = cpow((-2)*s_12 + -IT_0016 + IT_0045 + -IT_0046 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0055 = IT_0044*IT_0047*IT_0054;
    ...
    const ccomplex_t IT_0081 = -IT_0046;
    ...
    const ccomplex_t IT_0091 = s_34*IT_0046;
