...
ccomplex_return_t c_sumSqAmpl_N_2_su_R_to_u_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_su_R*
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
    ...
    const ccomplex_t IT_0039 = m_u*s_14*m_N_2;
    ...
    const ccomplex_t IT_0051 = m_u*m_N_2;
    ...
    const ccomplex_t IT_0056 = m_u*s_34*m_N_2;
