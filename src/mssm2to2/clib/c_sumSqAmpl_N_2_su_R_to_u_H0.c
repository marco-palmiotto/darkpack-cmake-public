        ...
        )
{
    ...
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0011 + IT_0029 + -m_N_4*
    ...
    const ccomplex_t IT_0239 = IT_0068*IT_0238;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*IT_0239;
    const ccomplex_t IT_0241 = m_N_2*IT_0091;
    const ccomplex_t IT_0242 = m_N_1*IT_0113;
    const ccomplex_t IT_0243 = IT_0241 + IT_0242;
    const ccomplex_t IT_0244 = IT_0240*IT_0243;
    const ccomplex_t IT_0245 = IT_0037*IT_0232;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*IT_0245;
    const ccomplex_t IT_0247 = IT_0064*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0252 = m_N_2*IT_0142;
    const ccomplex_t IT_0253 = m_N_3*IT_0164;
    const ccomplex_t IT_0254 = IT_0252 + IT_0253;
    const ccomplex_t IT_0255 = IT_0251*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0000*IT_0003*IT_0005;
    const ccomplex_t IT_0257 = 0.5*IT_0256;
    const ccomplex_t IT_0258 = IT_0170*IT_0257;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*IT_0258;
    const ccomplex_t IT_0260 = m_N_2*IT_0193;
    const ccomplex_t IT_0261 = m_N_4*IT_0215;
    const ccomplex_t IT_0262 = IT_0260 + IT_0261;
    const ccomplex_t IT_0263 = IT_0259*IT_0262;
    const ccomplex_t IT_0264 = IT_0021*IT_0232;
    const ccomplex_t IT_0265 = IT_0026*IT_0264;
    const ccomplex_t IT_0266 = (0 + _Complex_I*1)*IT_0265;
    const ccomplex_t IT_0267 = -IT_0230 + 2*IT_0236 + -IT_0244 + -IT_0247 + 
    ...
    const ccomplex_t IT_0271 = IT_0193*IT_0259;
    const ccomplex_t IT_0272 = IT_0091*IT_0240;
    const ccomplex_t IT_0273 = IT_0142*IT_0251;
    const ccomplex_t IT_0274 = IT_0052*IT_0246;
    ...
    const ccomplex_t IT_0280 = IT_0172*IT_0215;
