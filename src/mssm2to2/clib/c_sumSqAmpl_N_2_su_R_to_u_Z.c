        ...
        )
{
    ...
    const ccomplex_t IT_0009 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_su_R*
    ...
    const ccomplex_t IT_0014 = conj(N_d1)*N_d2*e_em;
    ...
    const ccomplex_t IT_0019 = conj(N_u1)*N_u2*e_em;
    ...
    const ccomplex_t IT_0026 = pow(m_su_R, 2);
    ...
    const ccomplex_t IT_0031 = N_u2*conj(N_u4)*e_em;
    const ccomplex_t IT_0032 = IT_0013*IT_0031;
    const ccomplex_t IT_0033 = IT_0017*IT_0031;
    const ccomplex_t IT_0034 = N_d2*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0045 = N_u2*conj(N_u2)*e_em;
    const ccomplex_t IT_0046 = IT_0013*IT_0045;
    const ccomplex_t IT_0047 = IT_0017*IT_0045;
    const ccomplex_t IT_0048 = N_d2*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0057 = 0.5*IT_0051;
    ...
    const ccomplex_t IT_0067 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0001;
    const ccomplex_t IT_0068 = 0.666666666666667*IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0007 + IT_0026 + -m_N_3*
    ...
    const ccomplex_t IT_0073 = IT_0012 + (-2)*IT_0030 + 2*IT_0044 + IT_0056 + 
      -IT_0058 + 2*IT_0072;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0016*IT_0080*IT_0082;
    ...
    const ccomplex_t IT_0104 = IT_0017*IT_0102;
    ...
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0016*IT_0080*IT_0082;
    ...
    const ccomplex_t IT_0115 = conj(N_d2)*N_d4*e_em;
    const ccomplex_t IT_0116 = IT_0013*IT_0115;
    const ccomplex_t IT_0117 = IT_0017*IT_0115;
    const ccomplex_t IT_0118 = conj(N_u2)*N_u4*e_em;
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0016*IT_0080*IT_0082;
    ...
    const ccomplex_t IT_0128 = IT_0009*IT_0084;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*IT_0128;
    const ccomplex_t IT_0130 = IT_0004*IT_0129;
    const ccomplex_t IT_0131 = IT_0087 + -IT_0088 + 2*IT_0101 + (-2)*IT_0114 +
       (-2)*IT_0127 + -IT_0130;
    const ccomplex_t IT_0132 = m_u*m_N_2;
    const ccomplex_t IT_0133 = IT_0078*IT_0132;
    const ccomplex_t IT_0134 = IT_0030 + -IT_0044 + (-0.5)*IT_0056 + 0.5
      *IT_0058 + -IT_0072;
    ...
    const ccomplex_t IT_0148 = m_N_2*IT_0096;
    const ccomplex_t IT_0149 = IT_0100*IT_0148;
    const ccomplex_t IT_0150 = m_N_4*IT_0038;
    const ccomplex_t IT_0151 = m_N_2*IT_0122;
    const ccomplex_t IT_0152 = -IT_0151;
    const ccomplex_t IT_0153 = IT_0150 + IT_0152;
    const ccomplex_t IT_0154 = IT_0126*IT_0153;
    const ccomplex_t IT_0155 = (-0.666666666666667)*IT_0003;
    ...
    const ccomplex_t IT_0160 = m_N_2*IT_0052;
    const ccomplex_t IT_0161 = IT_0086*IT_0160;
    const ccomplex_t IT_0162 = m_N_2*IT_0057;
    const ccomplex_t IT_0163 = -IT_0162;
    const ccomplex_t IT_0164 = IT_0160 + IT_0163;
    const ccomplex_t IT_0165 = IT_0086*IT_0164;
    const ccomplex_t IT_0166 = m_N_3*IT_0066;
    const ccomplex_t IT_0167 = m_N_2*IT_0109;
    ...
    const ccomplex_t IT_0172 = IT_0086*IT_0162;
    const ccomplex_t IT_0173 = m_N_1*IT_0023;
    const ccomplex_t IT_0174 = IT_0100*IT_0173;
    const ccomplex_t IT_0175 = 0.5*IT_0172 + IT_0174;
    const ccomplex_t IT_0176 = IT_0171 + IT_0175;
    const ccomplex_t IT_0177 = IT_0084*IT_0155;
    const ccomplex_t IT_0178 = IT_0145*IT_0146*IT_0177;
    const ccomplex_t IT_0179 = IT_0084*IT_0143;
    ...
    const ccomplex_t IT_0183 = IT_0055*IT_0162;
    const ccomplex_t IT_0184 = IT_0055*IT_0164;
    const ccomplex_t IT_0185 = m_N_4*IT_0122;
    const ccomplex_t IT_0186 = m_N_2*IT_0038;
    const ccomplex_t IT_0187 = -IT_0186;
    const ccomplex_t IT_0188 = IT_0185 + IT_0187;
    const ccomplex_t IT_0189 = IT_0043*IT_0188;
    const ccomplex_t IT_0190 = m_N_2*IT_0023;
    const ccomplex_t IT_0191 = IT_0029*IT_0190;
    const ccomplex_t IT_0192 = m_N_3*IT_0109;
    ...
    const ccomplex_t IT_0197 = IT_0178 + -IT_0182 + 0.5*IT_0183 + (-0.5)
      *IT_0184 + IT_0189 + IT_0191 + IT_0196;
    const ccomplex_t IT_0198 = IT_0055*IT_0160;
    const ccomplex_t IT_0199 = m_N_1*IT_0096;
    ...
    const ccomplex_t IT_0248 = s_14*IT_0007;
    const ccomplex_t IT_0249 = s_13*s_34;
    const ccomplex_t IT_0250 = -IT_0249;
    const ccomplex_t IT_0251 = IT_0248 + IT_0250;
    const ccomplex_t IT_0252 = m_N_2*IT_0246;
    const ccomplex_t IT_0253 = (-6)*conj(IT_0239);
    const ccomplex_t IT_0254 = s_13*IT_0237;
    const ccomplex_t IT_0255 = m_N_2*IT_0237;
    const ccomplex_t IT_0256 = (-6)*conj(IT_0073);
    const ccomplex_t IT_0257 = (-6)*conj(IT_0131);
    const ccomplex_t IT_0258 = (-6)*conj(IT_0242);
    const ccomplex_t IT_0259 = (-6)*conj(IT_0171);
    const ccomplex_t IT_0260 = (-6)*IT_0073;
    const ccomplex_t IT_0261 = (-6)*IT_0242;
    const ccomplex_t IT_0262 = 6*IT_0204;
    const ccomplex_t IT_0263 = 6*IT_0134;
    const ccomplex_t IT_0264 = 6*IT_0216;
    const ccomplex_t IT_0265 = 6*IT_0181;
    const ccomplex_t IT_0266 = 6*IT_0131*IT_0139 + IT_0132*((-18)*IT_0171 + (
      -18)*IT_0175) + IT_0202*IT_0234 + IT_0240*IT_0252 + IT_0255*IT_0260 +
       IT_0238*IT_0261 + IT_0226*IT_0262 + IT_0222*IT_0263 + IT_0215*IT_0264 +
       IT_0211*IT_0265;
    const ccomplex_t IT_0267 = (-6)*IT_0131;
    const ccomplex_t IT_0268 = 6*IT_0073*IT_0139 + IT_0132*((-18)*IT_0197 + (
      -18)*IT_0201) + IT_0176*IT_0234 + IT_0238*IT_0240 + IT_0252*IT_0261 +
       IT_0211*IT_0262 + IT_0215*IT_0263 + IT_0222*IT_0264 + IT_0226*IT_0265 +
       IT_0255*IT_0267;
    const ccomplex_t IT_0269 = IT_0132*IT_0205;
    ...
    const ccomplex_t IT_0275 = (-24)*IT_0228;
    const ccomplex_t IT_0276 = 6*IT_0274 + IT_0275;
    const ccomplex_t IT_0277 = 0.166666666666667*IT_0204;
    const ccomplex_t IT_0278 = 24*IT_0228;
    const ccomplex_t IT_0279 = (-12)*IT_0227;
    const ccomplex_t IT_0280 = 6*IT_0274 + IT_0278 + IT_0279;
    const ccomplex_t IT_0281 = 0.166666666666667*IT_0134;
    const ccomplex_t IT_0282 = 0.166666666666667*IT_0216;
    const ccomplex_t IT_0283 = 0.166666666666667*IT_0181;
    const ccomplex_t IT_0284 = (-6)*IT_0171;
    const ccomplex_t IT_0285 = 0.166666666666667*IT_0241;
    const ccomplex_t IT_0286 = 0.166666666666667*IT_0254;
    const ccomplex_t IT_0287 = s_13*IT_0246;
    const ccomplex_t IT_0288 = 0.166666666666667*IT_0287;
    const ccomplex_t IT_0289 = 0.166666666666667*IT_0138;
    const ccomplex_t IT_0290 = 0.166666666666667*IT_0251;
    const ccomplex_t IT_0291 = 6*conj(IT_0073)*(IT_0073*IT_0079 + IT_0131
      *IT_0133 + IT_0134*IT_0138 + IT_0139*IT_0176) + IT_0132*IT_0202*IT_0203 +
       6*conj(IT_0171)*(IT_0073*IT_0139 + IT_0204*IT_0211 + IT_0134*IT_0215 +
       IT_0216*IT_0222 + IT_0181*IT_0226 + 0.166666666666667*IT_0176*IT_0234 +
       0.166666666666667*IT_0238*IT_0240) + (IT_0176*IT_0238 + IT_0131*IT_0241 +
       IT_0242*IT_0247 + IT_0204*IT_0251 + IT_0202*IT_0252)*IT_0253 + (IT_0138
      *IT_0204 + IT_0241*IT_0242 + IT_0239*IT_0254 + IT_0202*IT_0255)*IT_0256 + 
      (IT_0138*IT_0181 + IT_0242*IT_0254 + IT_0175*IT_0255)*IT_0257 + (IT_0202
      *IT_0238 + IT_0181*IT_0251 + IT_0175*IT_0252)*IT_0258 + (IT_0242*IT_0252 +
       IT_0131*IT_0255)*IT_0259 + (conj(IT_0197) + conj(IT_0201))*IT_0266 + conj
      (IT_0175)*IT_0268 + 6*conj(IT_0134)*(IT_0073*IT_0138 + IT_0176*IT_0215 +
       IT_0202*IT_0222 + IT_0239*IT_0251 + IT_0216*IT_0270 + IT_0181*IT_0271 +
       IT_0276*IT_0277 + IT_0280*IT_0281) + 6*conj(IT_0216)*(IT_0131*IT_0138 +
       IT_0202*IT_0215 + IT_0176*IT_0222 + IT_0242*IT_0251 + IT_0134*IT_0270 +
       IT_0204*IT_0271 + IT_0280*IT_0282 + IT_0276*IT_0283) + 6*conj(IT_0131)*
      (IT_0079*IT_0131 + IT_0073*IT_0133 + IT_0139*IT_0202 + IT_0138*IT_0216 +
       0.166666666666667*IT_0255*IT_0284 + IT_0240*IT_0285) + 6*conj(IT_0239)*
      (IT_0134*IT_0251 + IT_0260*IT_0286 + IT_0240*IT_0288) + 6*conj(IT_0242)*
      (0.166666666666667*IT_0240*IT_0247 + IT_0216*IT_0251 + 0.166666666666667
      *IT_0252*IT_0284 + IT_0260*IT_0285 + IT_0267*IT_0286 + IT_0261*IT_0288) +
       6*conj(IT_0204)*(IT_0176*IT_0211 + IT_0202*IT_0226 + IT_0181*IT_0270 +
       IT_0216*IT_0271 + IT_0277*IT_0280 + IT_0276*IT_0281 + IT_0260*IT_0289 +
       IT_0240*IT_0290) + 6*conj(IT_0181)*(IT_0202*IT_0211 + IT_0176*IT_0226 +
       IT_0204*IT_0270 + IT_0134*IT_0271 + IT_0276*IT_0282 + IT_0280*IT_0283 +
