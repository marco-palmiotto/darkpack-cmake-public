        ...
        )
{
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_4*
    ...
    const ccomplex_t IT_0041 = conj(N_B3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0047 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0050 = IT_0037*IT_0049;
    const ccomplex_t IT_0051 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0052 = IT_0040*IT_0051;
    const ccomplex_t IT_0053 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0054 = IT_0043*IT_0053;
    const ccomplex_t IT_0055 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0066 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0067 = IT_0046*IT_0066;
    const ccomplex_t IT_0068 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0069 = IT_0037*IT_0068;
    const ccomplex_t IT_0070 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0071 = IT_0040*IT_0070;
    const ccomplex_t IT_0072 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0078 = m_N_3*IT_0077;
    const ccomplex_t IT_0079 = IT_0059 + IT_0078;
    const ccomplex_t IT_0080 = IT_0036*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    ...
    const ccomplex_t IT_0086 = IT_0009*IT_0037;
    const ccomplex_t IT_0087 = IT_0005*IT_0040;
    const ccomplex_t IT_0088 = IT_0017*IT_0043;
    const ccomplex_t IT_0089 = IT_0014*IT_0046;
    const ccomplex_t IT_0090 = IT_0086 + -IT_0087 + -IT_0088 + IT_0089;
    const ccomplex_t IT_0091 = cpow(IT_0090, 2);
    const ccomplex_t IT_0092 = m_N_3*IT_0091;
    const ccomplex_t IT_0093 = N_B3*N_u3*e_em;
    ...
    const ccomplex_t IT_0106 = 0.5*IT_0033 + -IT_0080 + -IT_0083 + (-0.5)
      *IT_0105;
    const ccomplex_t IT_0107 = cpow((-2)*s_13 + IT_0034 + (0 + _Complex_I*1)
      *m_N_3*Gamma_o3 + reg_prop, -1);
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = cpow(IT_0101, 2);
    const ccomplex_t IT_0110 = m_N_3*IT_0109;
    const ccomplex_t IT_0111 = IT_0103 + IT_0110;
    const ccomplex_t IT_0112 = IT_0108*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_1*
    ...
    const ccomplex_t IT_0120 = IT_0043*IT_0119;
    const ccomplex_t IT_0121 = N_W3*N_d1*e_em;
    ...
    const ccomplex_t IT_0129 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0134 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0135 = IT_0037*IT_0134;
    const ccomplex_t IT_0136 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0137 = IT_0040*IT_0136;
    const ccomplex_t IT_0138 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0139 = IT_0043*IT_0138;
    const ccomplex_t IT_0140 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0141 = IT_0046*IT_0140;
    const ccomplex_t IT_0142 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0143 = IT_0037*IT_0142;
    const ccomplex_t IT_0144 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0145 = IT_0040*IT_0144;
    const ccomplex_t IT_0146 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0147 = IT_0043*IT_0146;
    const ccomplex_t IT_0148 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0153 = IT_0133 + IT_0152;
    const ccomplex_t IT_0154 = IT_0114*IT_0153;
    const ccomplex_t IT_0155 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*IT_0155;
    const ccomplex_t IT_0157 = IT_0153*IT_0156;
    const ccomplex_t IT_0158 = IT_0004*IT_0093;
    const ccomplex_t IT_0159 = IT_0008*IT_0095;
    const ccomplex_t IT_0160 = IT_0013*IT_0097;
    const ccomplex_t IT_0161 = IT_0016*IT_0099;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*(IT_0158 + IT_0159 + 
      -IT_0160 + -IT_0161);
    const ccomplex_t IT_0163 = -IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*m_W*e_em*IT_0022*(IT_0001
    ...
    const ccomplex_t IT_0170 = IT_0004*IT_0095;
    const ccomplex_t IT_0171 = IT_0008*IT_0093;
    const ccomplex_t IT_0172 = IT_0013*IT_0099;
    const ccomplex_t IT_0173 = IT_0016*IT_0097;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*(IT_0170 + -IT_0171 + 
      -IT_0172 + IT_0173);
    const ccomplex_t IT_0175 = IT_0032*IT_0174;
    const ccomplex_t IT_0176 = IT_0085*IT_0111;
    ...
    const ccomplex_t IT_0222 = IT_0112 + IT_0154 + IT_0157 + -IT_0169 + (-0.5)
      *IT_0175 + 0.5*IT_0176 + IT_0218 + IT_0221;
    const ccomplex_t IT_0223 = 2*IT_0222;
    const ccomplex_t IT_0224 = cpow(IT_0076, 2);
    const ccomplex_t IT_0225 = m_N_4*IT_0224;
    const ccomplex_t IT_0226 = IT_0078 + IT_0225;
    const ccomplex_t IT_0227 = IT_0036*IT_0226;
    const ccomplex_t IT_0228 = IT_0082*IT_0226;
    const ccomplex_t IT_0229 = 0.5*IT_0175 + (-0.5)*IT_0176 + -IT_0227 + 
      -IT_0228;
    ...
    const ccomplex_t IT_0235 = IT_0104*IT_0108;
    const ccomplex_t IT_0236 = cpow(IT_0150, 2);
    const ccomplex_t IT_0237 = m_N_1*IT_0236;
    const ccomplex_t IT_0238 = IT_0152 + IT_0237;
    const ccomplex_t IT_0239 = IT_0114*IT_0238;
    const ccomplex_t IT_0240 = IT_0156*IT_0238;
    ...
    const ccomplex_t IT_0252 = IT_0220*IT_0243;
    const ccomplex_t IT_0253 = (-0.5)*IT_0033 + 0.5*IT_0105 + IT_0235 +
       IT_0239 + IT_0240 + IT_0244 + -IT_0251 + IT_0252;
    ...
    const ccomplex_t IT_0263 = IT_0102*IT_0108;
    const ccomplex_t IT_0264 = IT_0114*IT_0151;
    const ccomplex_t IT_0265 = IT_0085*IT_0102;
    const ccomplex_t IT_0266 = IT_0151*IT_0156;
    const ccomplex_t IT_0267 = IT_0178*IT_0215;
    const ccomplex_t IT_0268 = IT_0215*IT_0220;
    ...
    const ccomplex_t IT_0272 = IT_0077*IT_0082;
