...
ccomplex_return_t c_sumSqAmpl_N_3_N_3_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0048 = N_B3*N_u3*e_em;
    ...
    const ccomplex_t IT_0054 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*IT_0061;
    const ccomplex_t IT_0063 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0064 = IT_0037*IT_0063;
    const ccomplex_t IT_0065 = conj(N_B3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0069 = conj(N_W3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0073 = conj(N_B4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0077 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0088 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0089 = IT_0043*IT_0088;
    const ccomplex_t IT_0090 = N_B3*N_u4*e_em;
    ...
    const ccomplex_t IT_0096 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0103 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*IT_0103;
    const ccomplex_t IT_0105 = IT_0101*IT_0104;
    const ccomplex_t IT_0106 = 0.5*IT_0033 + (-0.5)*IT_0060 + -IT_0102 + 
      -IT_0105;
    const ccomplex_t IT_0107 = cpow((-2)*s_23 + IT_0034 + (0 + _Complex_I*1)
      *m_N_3*Gamma_o3 + reg_prop, -1);
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = cpow(IT_0056, 2);
    ...
    const ccomplex_t IT_0114 = IT_0004*IT_0050;
    const ccomplex_t IT_0115 = IT_0008*IT_0048;
    const ccomplex_t IT_0116 = IT_0013*IT_0054;
    const ccomplex_t IT_0117 = IT_0016*IT_0052;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*(IT_0114 + -IT_0115 + 
      -IT_0116 + IT_0117);
    const ccomplex_t IT_0119 = IT_0032*IT_0118;
    const ccomplex_t IT_0120 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*IT_0120;
    const ccomplex_t IT_0122 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0123 = IT_0037*IT_0122;
    const ccomplex_t IT_0124 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0125 = IT_0039*IT_0124;
    const ccomplex_t IT_0126 = N_W3*N_u1*e_em;
    ...
    const ccomplex_t IT_0135 = IT_0041*IT_0134;
    ...
    const ccomplex_t IT_0144 = IT_0039*IT_0143;
    const ccomplex_t IT_0145 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0146 = IT_0041*IT_0145;
    const ccomplex_t IT_0147 = conj(N_W1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0153 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0154 = IT_0041*IT_0153;
    const ccomplex_t IT_0155 = conj(N_W3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0156 = IT_0043*IT_0155;
    const ccomplex_t IT_0157 = 0.5*IT_0142 + (-0.5)*IT_0144 + (-0.5)*IT_0146 +
       0.5*IT_0148 + 0.5*IT_0150 + (-0.5)*IT_0152 + (-0.5)*IT_0154 + 0.5*IT_0156;
    const ccomplex_t IT_0158 = IT_0138*IT_0157;
    const ccomplex_t IT_0159 = m_N_3*IT_0158;
    const ccomplex_t IT_0160 = IT_0140 + IT_0159;
    const ccomplex_t IT_0161 = IT_0121*IT_0160;
    const ccomplex_t IT_0162 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*IT_0162;
    const ccomplex_t IT_0164 = IT_0160*IT_0163;
    const ccomplex_t IT_0165 = IT_0004*IT_0048;
    const ccomplex_t IT_0166 = IT_0008*IT_0050;
    const ccomplex_t IT_0167 = IT_0013*IT_0052;
    const ccomplex_t IT_0168 = IT_0016*IT_0054;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*(IT_0165 + IT_0166 + 
      -IT_0167 + -IT_0168);
    const ccomplex_t IT_0170 = -IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*m_W*e_em*IT_0022*(IT_0001
      *IT_0024 + -IT_0025*(IT_0025*(IT_0001*IT_0023 + IT_0007*IT_0025) + 
      -IT_0007*IT_0027));
    const ccomplex_t IT_0172 = 0.5*IT_0171;
    const ccomplex_t IT_0173 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0177 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_2*
    ...
    const ccomplex_t IT_0186 = IT_0043*IT_0185;
    ...
    const ccomplex_t IT_0194 = IT_0043*IT_0193;
    ...
    const ccomplex_t IT_0198 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0204 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0205 = IT_0043*IT_0204;
    const ccomplex_t IT_0206 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0207 = IT_0037*IT_0206;
    const ccomplex_t IT_0208 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0209 = IT_0039*IT_0208;
    const ccomplex_t IT_0210 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0211 = IT_0041*IT_0210;
    const ccomplex_t IT_0212 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0219 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*IT_0219;
    const ccomplex_t IT_0221 = IT_0217*IT_0220;
    const ccomplex_t IT_0222 = IT_0112 + 0.5*IT_0113 + (-0.5)*IT_0119 +
       IT_0161 + IT_0164 + -IT_0176 + IT_0218 + IT_0221;
    ...
    const ccomplex_t IT_0229 = (-0.5)*IT_0113 + 0.5*IT_0119 + -IT_0227 + 
      -IT_0228;
    const ccomplex_t IT_0230 = (-2)*IT_0229;
    const ccomplex_t IT_0231 = IT_0223 + IT_0230;
    const ccomplex_t IT_0232 = 2*conj(IT_0222);
    const ccomplex_t IT_0233 = (-2)*conj(IT_0229);
    const ccomplex_t IT_0234 = IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = IT_0059*IT_0108;
    const ccomplex_t IT_0236 = IT_0004*IT_0009;
    const ccomplex_t IT_0237 = IT_0005*IT_0008;
    const ccomplex_t IT_0238 = IT_0013*IT_0017;
    const ccomplex_t IT_0239 = IT_0014*IT_0016;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*(IT_0236 + IT_0237 + 
      -IT_0238 + -IT_0239);
    const ccomplex_t IT_0241 = -IT_0240;
    const ccomplex_t IT_0242 = IT_0175*IT_0241;
    const ccomplex_t IT_0243 = cpow(IT_0157, 2);
    const ccomplex_t IT_0244 = m_N_1*IT_0243;
    const ccomplex_t IT_0245 = IT_0159 + IT_0244;
    const ccomplex_t IT_0246 = IT_0121*IT_0245;
    const ccomplex_t IT_0247 = IT_0163*IT_0245;
    const ccomplex_t IT_0248 = cpow(IT_0214, 2);
    const ccomplex_t IT_0249 = m_N_2*IT_0248;
    const ccomplex_t IT_0250 = IT_0216 + IT_0249;
    const ccomplex_t IT_0251 = IT_0178*IT_0250;
    const ccomplex_t IT_0252 = IT_0220*IT_0250;
    const ccomplex_t IT_0253 = (-0.5)*IT_0033 + 0.5*IT_0060 + IT_0235 + 
      -IT_0242 + IT_0246 + IT_0247 + IT_0251 + IT_0252;
    ...
    const ccomplex_t IT_0262 = s_24*m_N_3;
    const ccomplex_t IT_0263 = IT_0057*IT_0108;
    const ccomplex_t IT_0264 = IT_0215*IT_0220;
    const ccomplex_t IT_0265 = IT_0036*IT_0057;
    const ccomplex_t IT_0266 = IT_0158*IT_0163;
    const ccomplex_t IT_0267 = IT_0178*IT_0215;
    const ccomplex_t IT_0268 = IT_0121*IT_0158;
    const ccomplex_t IT_0269 = IT_0263 + IT_0264 + (-0.5)*IT_0265 + -IT_0266 +
       -IT_0267 + IT_0268;
    const ccomplex_t IT_0270 = 2*IT_0106;
    const ccomplex_t IT_0271 = (-2)*IT_0253;
    const ccomplex_t IT_0272 = IT_0062*IT_0099;
    const ccomplex_t IT_0273 = IT_0099*IT_0104;
    const ccomplex_t IT_0274 = (-0.5)*IT_0265 + -IT_0272 + IT_0273;
    const ccomplex_t IT_0275 = 2*conj(IT_0106);
    const ccomplex_t IT_0276 = (-2)*conj(IT_0253);
    const ccomplex_t IT_0277 = IT_0262*(IT_0259*IT_0269 + IT_0256*conj(IT_0269
      ) + conj(IT_0269)*(IT_0270 + IT_0271) + (IT_0254 + IT_0255 + IT_0270 +
       IT_0271)*conj(IT_0274) + IT_0269*(IT_0275 + IT_0276) + IT_0274*(IT_0257 +
       IT_0258 + IT_0275 + IT_0276));
    const ccomplex_t IT_0278 = s_14*m_N_3;
    const ccomplex_t IT_0279 = 2*IT_0253;
    const ccomplex_t IT_0280 = (-2)*IT_0106;
    const ccomplex_t IT_0281 = 2*conj(IT_0253);
    const ccomplex_t IT_0282 = (-2)*conj(IT_0106);
    const ccomplex_t IT_0283 = IT_0278*(IT_0234*IT_0269 + IT_0231*conj(IT_0269
      ) + conj(IT_0269)*(IT_0279 + IT_0280) + conj(IT_0274)*(IT_0223 + IT_0230 +
       IT_0279 + IT_0280) + IT_0269*(IT_0281 + IT_0282) + IT_0274*(IT_0232 +
       IT_0233 + IT_0281 + IT_0282));
    const ccomplex_t IT_0284 = IT_0000*IT_0034;
    const ccomplex_t IT_0285 = (-4)*IT_0274*conj(IT_0274);
    const ccomplex_t IT_0286 = (-2)*IT_0269;
    const ccomplex_t IT_0287 = conj(IT_0274)*IT_0286;
    const ccomplex_t IT_0288 = (-2)*conj(IT_0269);
    const ccomplex_t IT_0289 = IT_0274*IT_0288;
    const ccomplex_t IT_0290 = (-2)*conj(IT_0269)*IT_0274;
    ...
    const ccomplex_t IT_0295 = IT_0000*(conj(IT_0106)*IT_0231 + IT_0106
      *IT_0234 + conj(IT_0253)*IT_0256 + IT_0253*IT_0259) + (IT_0106*conj
      (IT_0106) + IT_0222*conj(IT_0222) + IT_0229*conj(IT_0229) + IT_0253*conj
      (IT_0253))*IT_0260 + (conj(IT_0222)*IT_0229 + IT_0222*conj(IT_0229) + conj
      (IT_0106)*IT_0253 + IT_0106*conj(IT_0253))*IT_0261 + IT_0277 + IT_0283 +
       IT_0284*(IT_0285 + conj(IT_0269)*IT_0286 + 2*IT_0287 + IT_0269*IT_0288 +
       IT_0289 + IT_0290) + (IT_0285 + 2*conj(IT_0269)*IT_0286 + 2*IT_0287 +
