...
ccomplex_return_t c_sumSqAmpl_N_3_N_3_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0018 = conj(N_W3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0022 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0027 = conj(N_B3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0037 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0038 = IT_0007*IT_0037;
    const ccomplex_t IT_0039 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0040 = IT_0013*IT_0039;
    const ccomplex_t IT_0041 = N_B2*N_d3*e_em;
    ...
    const ccomplex_t IT_0046 = N_B3*N_u2*e_em;
    ...
    const ccomplex_t IT_0064 = conj(N_B3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0068 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_W*e_em*IT_0074*(IT_0075
      *IT_0076 + 5*IT_0004*((-1)*IT_0004*(IT_0010*IT_0075 + 1./5*IT_0004*IT_0077
      ) + IT_0077*IT_0078));
    ...
    const ccomplex_t IT_0085 = IT_0007*IT_0064;
    const ccomplex_t IT_0086 = IT_0021*IT_0062;
    const ccomplex_t IT_0087 = IT_0024*IT_0068;
    const ccomplex_t IT_0088 = IT_0013*IT_0066;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*(IT_0085 + -IT_0086 + 
      -IT_0087 + IT_0088);
    const ccomplex_t IT_0090 = cpow(IT_0004, 2);
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*m_W*e_em*IT_0074*(IT_0076
      *IT_0077 + -IT_0004*(IT_0004*IT_0010*IT_0077 + IT_0075*(IT_0078 + -IT_0090
      )));
    const ccomplex_t IT_0092 = (-1.5)*IT_0091;
    const ccomplex_t IT_0093 = cpow((-2)*s_12 + (-2)*IT_0000 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0097 = cpow((-2)*s_23 + IT_0001 + (0 + _Complex_I*1)
      *m_N_3*Gamma_o3 + reg_prop, -1);
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*IT_0097;
    const ccomplex_t IT_0099 = cpow(IT_0089, 2);
    const ccomplex_t IT_0100 = m_N_3*IT_0099;
    const ccomplex_t IT_0101 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0102 = IT_0007*IT_0101;
    const ccomplex_t IT_0103 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0104 = IT_0021*IT_0103;
    const ccomplex_t IT_0105 = N_W3*N_d3*e_em;
    const ccomplex_t IT_0106 = IT_0024*IT_0105;
    const ccomplex_t IT_0107 = N_W3*N_u3*e_em;
    ...
    const ccomplex_t IT_0114 = cpow((-2)*s_13 + IT_0001 + (0 + _Complex_I*1)
      *m_N_3*Gamma_o3 + reg_prop, -1);
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*IT_0114;
    const ccomplex_t IT_0116 = IT_0112*IT_0115;
    const ccomplex_t IT_0117 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_1*
    ...
    const ccomplex_t IT_0125 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0126 = IT_0013*IT_0125;
    const ccomplex_t IT_0127 = IT_0120 + IT_0122 + IT_0124 + IT_0126;
    const ccomplex_t IT_0128 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0132 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0166 = IT_0118*IT_0165;
    const ccomplex_t IT_0167 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*IT_0167;
    const ccomplex_t IT_0169 = IT_0165*IT_0168;
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*IT_0170;
    const ccomplex_t IT_0172 = IT_0060*IT_0171;
    const ccomplex_t IT_0173 = IT_0061 + -IT_0084 + (-0.5)*IT_0096 + IT_0113 +
       0.5*IT_0116 + IT_0166 + IT_0169 + IT_0172;
    const ccomplex_t IT_0174 = IT_0095*IT_0109;
    const ccomplex_t IT_0175 = cpow(IT_0109, 2);
    const ccomplex_t IT_0176 = m_N_3*IT_0175;
    const ccomplex_t IT_0177 = IT_0111 + IT_0176;
    const ccomplex_t IT_0178 = IT_0115*IT_0177;
    const ccomplex_t IT_0179 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
    ...
    const ccomplex_t IT_0204 = conj(N_B3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0208 = conj(N_B4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0229 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = IT_0227*IT_0230;
    const ccomplex_t IT_0232 = 0.5*IT_0174 + (-0.5)*IT_0178 + -IT_0228 + 
      -IT_0231;
    const ccomplex_t IT_0233 = 2*IT_0232;
    const ccomplex_t IT_0234 = IT_0007*IT_0103;
    const ccomplex_t IT_0235 = IT_0021*IT_0101;
    const ccomplex_t IT_0236 = IT_0024*IT_0107;
    const ccomplex_t IT_0237 = IT_0013*IT_0105;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*(IT_0234 + IT_0235 + 
      -IT_0236 + -IT_0237);
    const ccomplex_t IT_0239 = -IT_0238;
    const ccomplex_t IT_0240 = IT_0083*IT_0239;
    const ccomplex_t IT_0241 = IT_0098*IT_0177;
    const ccomplex_t IT_0242 = cpow(IT_0057, 2);
    const ccomplex_t IT_0243 = m_N_2*IT_0242;
    const ccomplex_t IT_0244 = IT_0059 + IT_0243;
    const ccomplex_t IT_0245 = IT_0171*IT_0244;
    const ccomplex_t IT_0246 = IT_0003*IT_0244;
    const ccomplex_t IT_0247 = cpow(IT_0162, 2);
    const ccomplex_t IT_0248 = m_N_1*IT_0247;
    const ccomplex_t IT_0249 = IT_0164 + IT_0248;
    const ccomplex_t IT_0250 = IT_0118*IT_0249;
    const ccomplex_t IT_0251 = IT_0168*IT_0249;
    const ccomplex_t IT_0252 = (-0.5)*IT_0174 + 0.5*IT_0178 + -IT_0240 +
       IT_0241 + IT_0245 + IT_0246 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = (-2)*IT_0252;
    const ccomplex_t IT_0254 = IT_0233 + IT_0253;
    const ccomplex_t IT_0255 = 2*conj(IT_0232);
    ...
    const ccomplex_t IT_0263 = 0.5*IT_0096 + (-0.5)*IT_0116 + -IT_0261 + 
      -IT_0262;
    ...
    const ccomplex_t IT_0273 = IT_0058*IT_0171;
    const ccomplex_t IT_0274 = IT_0003*IT_0058;
    const ccomplex_t IT_0275 = IT_0163*IT_0168;
    const ccomplex_t IT_0276 = IT_0098*IT_0110;
    const ccomplex_t IT_0277 = IT_0110*IT_0115;
    const ccomplex_t IT_0278 = IT_0118*IT_0163;
    const ccomplex_t IT_0279 = IT_0273 + -IT_0274 + -IT_0275 + IT_0276 + (-0.5
      )*IT_0277 + IT_0278;
    const ccomplex_t IT_0280 = 2*IT_0173;
    const ccomplex_t IT_0281 = (-2)*IT_0263;
    const ccomplex_t IT_0282 = IT_0180*IT_0225;
    const ccomplex_t IT_0283 = IT_0225*IT_0230;
    const ccomplex_t IT_0284 = (-0.5)*IT_0277 + IT_0282 + -IT_0283;
    const ccomplex_t IT_0285 = 2*conj(IT_0173);
    ...
    const ccomplex_t IT_0288 = s_24*m_N_3;
    const ccomplex_t IT_0289 = 2*IT_0263;
    const ccomplex_t IT_0290 = (-2)*IT_0173;
    const ccomplex_t IT_0291 = 2*conj(IT_0263);
    const ccomplex_t IT_0292 = (-2)*conj(IT_0173);
    const ccomplex_t IT_0293 = IT_0288*(IT_0257*IT_0279 + IT_0254*conj(IT_0279
      ) + conj(IT_0279)*(IT_0289 + IT_0290) + conj(IT_0284)*(IT_0233 + IT_0253 +
       IT_0289 + IT_0290) + IT_0279*(IT_0291 + IT_0292) + IT_0284*(IT_0255 +
       IT_0256 + IT_0291 + IT_0292));
    ...
    const ccomplex_t IT_0300 = (-2)*IT_0279;
    const ccomplex_t IT_0301 = conj(IT_0279)*IT_0298;
    ...
    const ccomplex_t IT_0307 = IT_0000*(conj(IT_0173)*IT_0254 + IT_0173
      *IT_0257 + conj(IT_0263)*IT_0266 + IT_0263*IT_0269) + (IT_0173*conj
      (IT_0173) + IT_0232*conj(IT_0232) + IT_0252*conj(IT_0252) + IT_0263*conj
      (IT_0263))*IT_0270 + (conj(IT_0232)*IT_0252 + IT_0232*conj(IT_0252) + conj
      (IT_0173)*IT_0263 + IT_0173*conj(IT_0263))*IT_0271 + IT_0287 + IT_0293 + 2
      *IT_0299 + (-2)*IT_0297*(IT_0279*conj(IT_0279) + (-0.5)*conj(IT_0279)
      *IT_0300 + 2*IT_0302 + 2*IT_0305) + (-2)*(IT_0279*conj(IT_0279) + (-0.5)
      *conj(IT_0284)*IT_0298 + (-0.5)*conj(IT_0279)*IT_0300 + 2*IT_0302 + (-0.5)
