        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_W*e_em*IT_0023*(IT_0024
      *IT_0025 + 5*IT_0001*((-1)*IT_0001*(IT_0007*IT_0024 + 1./5*IT_0001*IT_0026
      ) + IT_0026*IT_0027));
    ...
    const ccomplex_t IT_0037 = IT_0004*IT_0009;
    const ccomplex_t IT_0038 = IT_0005*IT_0008;
    const ccomplex_t IT_0039 = IT_0013*IT_0017;
    const ccomplex_t IT_0040 = IT_0014*IT_0016;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*(IT_0037 + -IT_0038 + 
      -IT_0039 + IT_0040);
    ...
    const ccomplex_t IT_0046 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0047 = IT_0008*IT_0046;
    const ccomplex_t IT_0048 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0054 = m_N_3*IT_0053;
    ...
    const ccomplex_t IT_0105 = IT_0081 + IT_0104;
    const ccomplex_t IT_0106 = IT_0058*IT_0105;
    const ccomplex_t IT_0107 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = IT_0105*IT_0108;
    const ccomplex_t IT_0110 = cpow(IT_0001, 2);
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*m_W*e_em*IT_0023*(IT_0025
      *IT_0026 + -IT_0001*(IT_0001*IT_0007*IT_0026 + IT_0024*(IT_0027 + -IT_0110
      )));
    const ccomplex_t IT_0112 = (-1.5)*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_12 + (-2)*IT_0000 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0117 = cpow((-2)*s_23 + IT_0034 + (0 + _Complex_I*1)
      *m_N_3*Gamma_o3 + reg_prop, -1);
    ...
    const ccomplex_t IT_0122 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0123 = IT_0004*IT_0122;
    const ccomplex_t IT_0124 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0133 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0134 = IT_0013*IT_0133;
    const ccomplex_t IT_0135 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0136 = IT_0008*IT_0135;
    const ccomplex_t IT_0137 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0145 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0146 = IT_0004*IT_0145;
    const ccomplex_t IT_0147 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0148 = IT_0016*IT_0147;
    const ccomplex_t IT_0149 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0150 = IT_0004*IT_0149;
    const ccomplex_t IT_0151 = N_W2*N_u3*e_em;
    ...
    const ccomplex_t IT_0160 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0170 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*IT_0170;
    const ccomplex_t IT_0172 = IT_0168*IT_0171;
    const ccomplex_t IT_0173 = -IT_0033 + 0.5*IT_0056 + IT_0106 + IT_0109 + (
      -0.5)*IT_0116 + IT_0119 + IT_0169 + IT_0172;
    const ccomplex_t IT_0174 = IT_0052*IT_0115;
    const ccomplex_t IT_0175 = cpow(IT_0052, 2);
    ...
    const ccomplex_t IT_0220 = IT_0013*IT_0219;
    ...
    const ccomplex_t IT_0234 = IT_0004*IT_0046;
    const ccomplex_t IT_0235 = IT_0008*IT_0044;
    const ccomplex_t IT_0236 = IT_0013*IT_0050;
    const ccomplex_t IT_0237 = IT_0016*IT_0048;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*(IT_0234 + IT_0235 + 
      -IT_0236 + -IT_0237);
    const ccomplex_t IT_0239 = -IT_0238;
    const ccomplex_t IT_0240 = IT_0032*IT_0239;
    const ccomplex_t IT_0241 = IT_0118*IT_0177;
    const ccomplex_t IT_0242 = cpow(IT_0102, 2);
    const ccomplex_t IT_0243 = m_N_1*IT_0242;
    const ccomplex_t IT_0244 = IT_0104 + IT_0243;
    const ccomplex_t IT_0245 = IT_0108*IT_0244;
    const ccomplex_t IT_0246 = IT_0058*IT_0244;
    const ccomplex_t IT_0247 = cpow(IT_0165, 2);
    const ccomplex_t IT_0248 = m_N_2*IT_0247;
    const ccomplex_t IT_0249 = IT_0167 + IT_0248;
    const ccomplex_t IT_0250 = IT_0121*IT_0249;
    const ccomplex_t IT_0251 = IT_0171*IT_0249;
    ...
    const ccomplex_t IT_0263 = (-0.5)*IT_0056 + 0.5*IT_0116 + -IT_0261 + 
      -IT_0262;
    ...
    const ccomplex_t IT_0273 = IT_0036*IT_0053;
    const ccomplex_t IT_0274 = IT_0180*IT_0225;
    const ccomplex_t IT_0275 = IT_0225*IT_0230;
    const ccomplex_t IT_0276 = (-0.5)*IT_0273 + IT_0274 + -IT_0275;
    const ccomplex_t IT_0277 = IT_0103*IT_0108;
    const ccomplex_t IT_0278 = IT_0121*IT_0166;
    const ccomplex_t IT_0279 = IT_0058*IT_0103;
    const ccomplex_t IT_0280 = IT_0166*IT_0171;
    const ccomplex_t IT_0281 = IT_0053*IT_0118;
    ...
    const ccomplex_t IT_0302 = IT_0000*(conj(IT_0173)*IT_0254 + IT_0173
      *IT_0257 + conj(IT_0263)*IT_0266 + IT_0263*IT_0269) + (IT_0173*conj
      ...
      (IT_0173)*IT_0263 + IT_0173*conj(IT_0263))*IT_0271 + IT_0272*(IT_0266
