        ...
        )
{
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + (-2)*IT_0000 + -reg_prop, -1);
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*IT_0048;
    const ccomplex_t IT_0050 = IT_0011*IT_0035;
    const ccomplex_t IT_0051 = IT_0015*IT_0037;
    const ccomplex_t IT_0052 = IT_0020*IT_0039;
    const ccomplex_t IT_0053 = IT_0023*IT_0041;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*(IT_0050 + IT_0051 + 
      -IT_0052 + -IT_0053);
    const ccomplex_t IT_0055 = -IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*e_em*IT_0018*(IT_0007
    ...
    const ccomplex_t IT_0089 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0090 = IT_0018*IT_0089;
    const ccomplex_t IT_0091 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0128 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0157 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0158 = IT_0018*IT_0157;
    const ccomplex_t IT_0159 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0180 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0181 = IT_0018*IT_0180;
    const ccomplex_t IT_0182 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0197 = m_N_3*IT_0005;
    const ccomplex_t IT_0198 = IT_0095*IT_0179;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0200 = IT_0111*IT_0198*IT_0199;
    const ccomplex_t IT_0201 = IT_0120*IT_0156;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0203 = IT_0135*IT_0201*IT_0202;
    const ccomplex_t IT_0204 = IT_0108*IT_0186;
    const ccomplex_t IT_0205 = cpow((-2)*s_13 + IT_0000 + IT_0110 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0206 = IT_0199*IT_0204*IT_0205;
    const ccomplex_t IT_0207 = IT_0133*IT_0163;
    const ccomplex_t IT_0208 = cpow((-2)*s_13 + IT_0000 + IT_0110 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0209 = IT_0202*IT_0207*IT_0208;
    const ccomplex_t IT_0210 = -IT_0200 + -IT_0203 + -IT_0206 + -IT_0209;
    const ccomplex_t IT_0211 = IT_0109*IT_0205;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*IT_0211;
    const ccomplex_t IT_0213 = IT_0134*IT_0208;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*IT_0213;
    const ccomplex_t IT_0215 = IT_0166 + IT_0189 + IT_0212 + IT_0214;
    ...
    const ccomplex_t IT_0219 = IT_0164*IT_0208;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*IT_0219;
    const ccomplex_t IT_0221 = IT_0187*IT_0205;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1)*IT_0221;
    const ccomplex_t IT_0223 = IT_0113 + IT_0137 + IT_0220 + IT_0222;
    const ccomplex_t IT_0224 = m_N_3*IT_0223;
    const ccomplex_t IT_0225 = -IT_0224;
    const ccomplex_t IT_0226 = IT_0201*IT_0202*IT_0208;
    const ccomplex_t IT_0227 = IT_0198*IT_0199*IT_0205;
    const ccomplex_t IT_0228 = IT_0111*IT_0199*IT_0204;
    const ccomplex_t IT_0229 = IT_0135*IT_0202*IT_0207;
    const ccomplex_t IT_0230 = IT_0226 + IT_0227 + IT_0228 + IT_0229;
    const ccomplex_t IT_0231 = conj(IT_0225) + conj(IT_0230);
    const ccomplex_t IT_0232 = 2*IT_0190;
    const ccomplex_t IT_0233 = (-2)*IT_0060;
    ...
    const ccomplex_t IT_0243 = -IT_0113 + -IT_0137;
    ...
    const ccomplex_t IT_0248 = -IT_0166 + -IT_0189;
    ...
    const ccomplex_t IT_0255 = (-0.5)*IT_0031 + (-0.5)*IT_0047 + (-0.5)*IT_0059;
    const ccomplex_t IT_0256 = 0.5*IT_0031 + 0.5*IT_0047 + 0.5*IT_0059 + (-2)
      *IT_0220 + (-2)*IT_0222;
    const ccomplex_t IT_0257 = 0.5*IT_0071 + 0.5*IT_0078 + 0.5*IT_0086;
    const ccomplex_t IT_0258 = 2*IT_0257;
    const ccomplex_t IT_0259 = (-0.5)*IT_0071 + (-0.5)*IT_0078 + (-0.5)
      *IT_0086 + (-2)*IT_0212 + (-2)*IT_0214;
    ...
    const ccomplex_t IT_0282 = (-2)*IT_0255;
    const ccomplex_t IT_0283 = IT_0281 + IT_0282;
    const ccomplex_t IT_0284 = 2*conj(IT_0256);
    const ccomplex_t IT_0285 = (-2)*conj(IT_0255);
    ...
    const ccomplex_t IT_0294 = (-2)*IT_0225;
    const ccomplex_t IT_0295 = (-2)*IT_0230;
    const ccomplex_t IT_0296 = IT_0294 + IT_0295;
    const ccomplex_t IT_0297 = (-2)*conj(IT_0225);
    const ccomplex_t IT_0298 = (-2)*conj(IT_0230);
    const ccomplex_t IT_0299 = IT_0297 + IT_0298;
    const ccomplex_t IT_0300 = 2*conj(IT_0210);
    const ccomplex_t IT_0301 = s_12*IT_0253;
    const ccomplex_t IT_0302 = 2*IT_0060;
    const ccomplex_t IT_0303 = (conj(IT_0060) + -conj(IT_0190))*IT_0255 + 0.5
      *IT_0238*IT_0256 + 0.5*IT_0234*conj(IT_0256) + 0.5*IT_0143*IT_0257 + 0.5
      *IT_0140*conj(IT_0257) + 0.5*IT_0196*IT_0259 + 0.5*IT_0193*conj(IT_0259) +
       -conj(IT_0255)*(IT_0190 + (-0.5)*IT_0302);
    const ccomplex_t IT_0304 = IT_0000*IT_0287;
    const ccomplex_t IT_0305 = 3*IT_0304;
    const ccomplex_t IT_0306 = s_12*IT_0287;
    const ccomplex_t IT_0307 = pow(m_W, 4);
    const ccomplex_t IT_0308 = s_12*IT_0307;
    const ccomplex_t IT_0309 = IT_0001*IT_0308;
    const ccomplex_t IT_0310 = (-0.5)*IT_0309;
    const ccomplex_t IT_0311 = s_14*s_24;
    const ccomplex_t IT_0312 = (-2)*IT_0311;
    const ccomplex_t IT_0313 = IT_0306 + IT_0310 + IT_0312;
    const ccomplex_t IT_0314 = (-0.25)*IT_0309;
    const ccomplex_t IT_0315 = IT_0311 + IT_0314;
    const ccomplex_t IT_0316 = s_24*IT_0287;
    ...
    const ccomplex_t IT_0322 = 2*IT_0210;
    const ccomplex_t IT_0323 = (-3)*IT_0304;
    const ccomplex_t IT_0324 = 2*IT_0247;
    const ccomplex_t IT_0325 = (-2)*conj(IT_0244)*(IT_0248*IT_0305 + 2*IT_0244
      *IT_0313 + (-4)*IT_0243*IT_0315 + (-0.5)*IT_0296*IT_0321 + -IT_0293*
      (IT_0216 + 0.5*IT_0322) + (-0.5)*IT_0323*IT_0324);
    const ccomplex_t IT_0326 = 2*conj(IT_0247);
    const ccomplex_t IT_0327 = IT_0306 + IT_0312;
    const ccomplex_t IT_0328 = IT_0001*IT_0327;
    const ccomplex_t IT_0329 = (-0.5)*IT_0328;
    const ccomplex_t IT_0330 = s_12 + IT_0329;
    const ccomplex_t IT_0331 = 4*IT_0225;
    const ccomplex_t IT_0332 = 6*conj(IT_0210);
    const ccomplex_t IT_0333 = (-0.25)*IT_0317;
    const ccomplex_t IT_0334 = s_24 + IT_0333;
    const ccomplex_t IT_0335 = m_N_3*IT_0334;
    const ccomplex_t IT_0336 = (-4)*IT_0335;
    const ccomplex_t IT_0337 = 2*IT_0225;
    const ccomplex_t IT_0338 = 2*IT_0230;
    const ccomplex_t IT_0339 = IT_0337 + IT_0338;
    const ccomplex_t IT_0340 = 0.5*IT_0289;
    const ccomplex_t IT_0341 = s_14 + IT_0340;
    const ccomplex_t IT_0342 = m_N_3*IT_0341;
    const ccomplex_t IT_0343 = 2*IT_0342;
    const ccomplex_t IT_0344 = (-2)*IT_0210;
    const ccomplex_t IT_0345 = m_N_3*IT_0274;
    const ccomplex_t IT_0346 = -IT_0345;
    const ccomplex_t IT_0347 = (-2)*conj(IT_0210);
    const ccomplex_t IT_0348 = 2*conj(IT_0225);
    const ccomplex_t IT_0349 = 2*conj(IT_0230);
    const ccomplex_t IT_0350 = IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = s_12*IT_0005;
    const ccomplex_t IT_0352 = s_12*IT_0274;
    const ccomplex_t IT_0353 = -IT_0352;
    const ccomplex_t IT_0354 = m_N_3*IT_0253;
    const ccomplex_t IT_0355 = conj(IT_0216)*(IT_0232 + IT_0233 + IT_0258 +
       IT_0260) + conj(IT_0210)*IT_0261 + IT_0216*(IT_0236 + IT_0237 + IT_0262 +
       IT_0263) + IT_0210*IT_0264 + IT_0231*(IT_0088 + IT_0139 + IT_0281 +
       IT_0282) + IT_0235*(IT_0141 + IT_0142 + IT_0284 + IT_0285) + IT_0190
      *IT_0300 + conj(IT_0190)*IT_0322 + conj(IT_0060)*IT_0344 + IT_0060*IT_0347;
    const ccomplex_t IT_0356 = (-2)*IT_0243;
    const ccomplex_t IT_0357 = (-2)*conj(IT_0243);
    const ccomplex_t IT_0358 = (-4)*IT_0247;
    const ccomplex_t IT_0359 = IT_0006*(conj(IT_0060)*IT_0140 + IT_0060
      *IT_0143 + conj(IT_0190)*IT_0193 + IT_0190*IT_0196) + IT_0197*(IT_0140
      *IT_0217 + IT_0143*IT_0218 + IT_0231*IT_0234 + IT_0235*IT_0238) + IT_0242*
      (IT_0193*IT_0245 + IT_0196*IT_0246 + IT_0234*IT_0249 + IT_0238*IT_0250) +
       IT_0254*(IT_0143*IT_0255 + IT_0140*conj(IT_0255) + IT_0196*IT_0256 +
       IT_0193*conj(IT_0256) + conj(IT_0060)*IT_0261 + IT_0060*IT_0264 + conj
      (IT_0190)*IT_0267 + IT_0190*IT_0270) + (conj(IT_0255)*IT_0261 + IT_0255
      *IT_0264 + conj(IT_0256)*IT_0267 + IT_0256*IT_0270)*IT_0276 + IT_0280*
      (IT_0245*IT_0267 + IT_0246*IT_0270 + IT_0249*IT_0283 + IT_0250*IT_0286) +
       IT_0293*(conj(IT_0247)*IT_0296 + IT_0247*IT_0299 + 2*IT_0244*(conj
      (IT_0216) + 0.5*IT_0300)) + 2*IT_0301*IT_0303 + IT_0325 + IT_0244*IT_0323
      *IT_0326 + IT_0321*(IT_0244*IT_0299 + IT_0247*IT_0300 + conj(IT_0247)
      *IT_0322 + conj(IT_0216)*IT_0324 + IT_0216*IT_0326) + 4*IT_0330*(IT_0217
      *IT_0218 + IT_0231*(IT_0230 + 0.25*IT_0331)) + 6*IT_0000*(IT_0218*IT_0231 
      + IT_0235*(conj(IT_0216) + 0.166666666666667*IT_0332)) + (-4)*conj(IT_0243
      )*(IT_0243*IT_0313 + (-2)*IT_0244*IT_0315 + -1./2*IT_0248*IT_0323 + (-0.25
      )*IT_0336*IT_0339 + (-0.25)*IT_0343*IT_0344) + IT_0346*(IT_0231*IT_0261 +
       IT_0235*IT_0264 + conj(IT_0216)*IT_0283 + IT_0216*IT_0286 + IT_0256
      *IT_0300 + conj(IT_0256)*IT_0322 + conj(IT_0255)*IT_0344 + IT_0255*IT_0347
      ) + IT_0243*(IT_0343*IT_0347 + IT_0336*IT_0350) + 8*IT_0248*(conj(IT_0247)
      *IT_0315 + (-0.25)*IT_0336*(conj(IT_0216) + (-0.5)*IT_0347) + 0.125
      *IT_0343*IT_0350) + (conj(IT_0087)*IT_0140 + IT_0087*IT_0142 + conj
      (IT_0138)*IT_0191 + conj(IT_0190)*IT_0234 + IT_0190*IT_0237 + conj(IT_0060
      )*IT_0302)*IT_0351 + 2*(conj(IT_0255)*(IT_0255 + -IT_0256) + 0.5*conj
      (IT_0257)*IT_0258 + 0.5*conj(IT_0259)*IT_0267 + 0.5*IT_0259*IT_0269 + 
      -conj(IT_0256)*(IT_0255 + (-0.5)*IT_0281))*IT_0353 + IT_0354*IT_0355 + 
      (conj(IT_0247)*IT_0305 + conj(IT_0216)*IT_0343)*IT_0356 + IT_0216*IT_0343
      *IT_0357 + (conj(IT_0247)*IT_0313 + (-0.25)*IT_0305*IT_0357)*IT_0358 + (-2
      )*conj(IT_0248)*(IT_0244*IT_0305 + 2*IT_0248*IT_0313 + -IT_0243*IT_0323 + 
      (-0.5)*IT_0339*IT_0343 + IT_0336*(IT_0216 + (-0.5)*IT_0344) + IT_0315
      *IT_0358);
