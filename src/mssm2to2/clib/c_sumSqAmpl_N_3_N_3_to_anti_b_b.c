        ...
        )
{
    ...
    const ccomplex_t IT_0014 = m_b*conj(N_d3)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0019 = conj(N_B3)*e_em*U_sb_00;
    const ccomplex_t IT_0020 = IT_0018*IT_0019;
    const ccomplex_t IT_0021 = 1.4142135623731*IT_0020;
    const ccomplex_t IT_0022 = conj(N_W3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0005 + IT_0006 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0044 = N_B3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0045 = IT_0018*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = N_W3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0048 = IT_0011*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = m_b*N_d3*e_em*IT_0013*conj(U_sb_11);
    ...
    const ccomplex_t IT_0061 = m_b*conj(N_d3)*e_em*IT_0013*U_sb_11;
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*m_b*e_em*IT_0009*IT_0011
      *IT_0013*IT_0074;
    ...
    const ccomplex_t IT_0111 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0112 = IT_0018*IT_0111;
    const ccomplex_t IT_0113 = 1.4142135623731*IT_0112;
    const ccomplex_t IT_0114 = m_b*conj(N_d3)*e_em*IT_0013*conj(U_sb_00);
    ...
    const ccomplex_t IT_0122 = m_b*N_d3*e_em*IT_0013*U_sb_00;
    const ccomplex_t IT_0123 = IT_0012*IT_0122;
    ...
    const ccomplex_t IT_0130 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0131 = IT_0018*IT_0130;
    const ccomplex_t IT_0132 = 1.4142135623731*IT_0131;
    const ccomplex_t IT_0133 = m_b*conj(N_d3)*e_em*IT_0013*conj(U_sb_01);
    ...
    const ccomplex_t IT_0138 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0139 = IT_0018*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = m_b*N_d3*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0152 = conj(N_B3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0156 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0180 = IT_0010*IT_0018;
    const ccomplex_t IT_0181 = N_u3*conj(N_u3)*e_em;
    const ccomplex_t IT_0182 = IT_0180*IT_0181;
    const ccomplex_t IT_0183 = IT_0011*IT_0017;
    const ccomplex_t IT_0184 = IT_0181*IT_0183;
    const ccomplex_t IT_0185 = N_d3*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*e_em*IT_0010*IT_0018;
    ...
    const ccomplex_t IT_0205 = conj(IT_0198) + conj(IT_0204);
    const ccomplex_t IT_0206 = IT_0198 + IT_0204;
    const ccomplex_t IT_0207 = (-0.5)*IT_0188;
    const ccomplex_t IT_0208 = IT_0196*IT_0207;
    const ccomplex_t IT_0209 = (-0.5)*IT_0208;
    const ccomplex_t IT_0210 = IT_0202*IT_0207;
    const ccomplex_t IT_0211 = (-0.5)*IT_0210;
    const ccomplex_t IT_0212 = conj(IT_0209) + conj(IT_0211);
    const ccomplex_t IT_0213 = IT_0209 + IT_0211;
    const ccomplex_t IT_0214 = (-4)*IT_0177;
    const ccomplex_t IT_0215 = 4*IT_0177;
    const ccomplex_t IT_0216 = 0.5*IT_0197;
    const ccomplex_t IT_0217 = 0.5*IT_0203;
    const ccomplex_t IT_0218 = 3*IT_0105;
    const ccomplex_t IT_0219 = (-3)*IT_0103;
    const ccomplex_t IT_0220 = IT_0218 + IT_0219;
    const ccomplex_t IT_0221 = 3*conj(IT_0105);
    const ccomplex_t IT_0222 = (-3)*conj(IT_0103);
    const ccomplex_t IT_0223 = IT_0221 + IT_0222;
    const ccomplex_t IT_0224 = 0.5*IT_0208;
    const ccomplex_t IT_0225 = 0.5*IT_0210;
    const ccomplex_t IT_0226 = 3*IT_0169;
    const ccomplex_t IT_0227 = (-3)*IT_0167;
    const ccomplex_t IT_0228 = IT_0226 + IT_0227;
    const ccomplex_t IT_0229 = 3*conj(IT_0169);
    const ccomplex_t IT_0230 = (-3)*conj(IT_0167);
    const ccomplex_t IT_0231 = IT_0229 + IT_0230;
    const ccomplex_t IT_0232 = (-4)*IT_0003;
    const ccomplex_t IT_0233 = (-2)*IT_0003;
    const ccomplex_t IT_0234 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0235 = IT_0127*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*IT_0235;
    const ccomplex_t IT_0237 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0238 = IT_0146*IT_0237;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*IT_0238;
    const ccomplex_t IT_0240 = -IT_0236 + -IT_0239;
    const ccomplex_t IT_0241 = IT_0040*IT_0234;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = IT_0066*IT_0237;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*IT_0243;
    const ccomplex_t IT_0245 = -IT_0242 + -IT_0244;
    const ccomplex_t IT_0246 = 2*IT_0177;
    ...
    const ccomplex_t IT_0260 = IT_0008*IT_0018;
    ...
    const ccomplex_t IT_0265 = IT_0008*IT_0011;
    const ccomplex_t IT_0266 = IT_0082*IT_0265;
    const ccomplex_t IT_0267 = IT_0011*IT_0262;
    const ccomplex_t IT_0268 = IT_0079*IT_0267;
    const ccomplex_t IT_0269 = -IT_0261 + IT_0264 + IT_0266 + -IT_0268;
    const ccomplex_t IT_0270 = m_b*e_em*IT_0009*IT_0011*IT_0013*IT_0262;
    ...
    const ccomplex_t IT_0281 = m_b*e_em*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0296 = IT_0027*IT_0118;
    const ccomplex_t IT_0297 = IT_0007*IT_0296;
    const ccomplex_t IT_0298 = (0 + _Complex_I*1)*IT_0297;
    const ccomplex_t IT_0299 = IT_0065*IT_0137;
    const ccomplex_t IT_0300 = IT_0043*IT_0299;
    ...
    const ccomplex_t IT_0325 = IT_0234*IT_0253;
    const ccomplex_t IT_0326 = (0 + _Complex_I*1)*IT_0325;
    const ccomplex_t IT_0327 = IT_0237*IT_0256;
    ...
    const ccomplex_t IT_0336 = IT_0234*IT_0296;
    const ccomplex_t IT_0337 = (0 + _Complex_I*1)*IT_0336;
    const ccomplex_t IT_0338 = IT_0237*IT_0299;
    ...
    const ccomplex_t IT_0381 = conj(IT_0149)*IT_0292 + IT_0149*IT_0295 + conj
      (IT_0069)*IT_0319 + IT_0069*IT_0322 + conj(IT_0245)*IT_0332 + IT_0245
      *IT_0335 + conj(IT_0240)*IT_0343 + IT_0240*IT_0346 + IT_0349*IT_0352 +
    ...
    const ccomplex_t IT_0386 = s_23 + s_24;
    const ccomplex_t IT_0387 = IT_0000*IT_0386;
    const ccomplex_t IT_0388 = 6*IT_0149;
    const ccomplex_t IT_0389 = 6*conj(IT_0149);
    const ccomplex_t IT_0390 = 6*IT_0245;
    const ccomplex_t IT_0391 = 6*conj(IT_0245);
    const ccomplex_t IT_0392 = conj(IT_0069)*IT_0292 + IT_0069*IT_0295 + conj
      (IT_0240)*IT_0332 + IT_0240*IT_0335 + IT_0360*IT_0365 + IT_0357*IT_0368 +
       IT_0364*IT_0369 + IT_0361*IT_0372 + IT_0352*IT_0373 + IT_0349*IT_0376 +
       IT_0356*IT_0377 + IT_0353*IT_0380 + (-6)*conj(IT_0315)*(IT_0245 + (
      -0.166666666666667)*IT_0388) + (-6)*IT_0315*(conj(IT_0245) + (
    ...
    const ccomplex_t IT_0393 = m_b*s_23*m_N_3;
    const ccomplex_t IT_0394 = 12*IT_0149;
    const ccomplex_t IT_0395 = 24*IT_0211;
    const ccomplex_t IT_0396 = 24*IT_0217;
    const ccomplex_t IT_0397 = IT_0394 + IT_0395 + IT_0396;
    const ccomplex_t IT_0398 = 12*conj(IT_0149);
    const ccomplex_t IT_0399 = 24*conj(IT_0211);
    const ccomplex_t IT_0400 = 24*conj(IT_0217);
    const ccomplex_t IT_0401 = IT_0398 + IT_0399 + IT_0400;
    const ccomplex_t IT_0402 = 12*IT_0329;
    const ccomplex_t IT_0403 = 24*IT_0259;
    const ccomplex_t IT_0404 = IT_0402 + IT_0403;
    const ccomplex_t IT_0405 = 12*conj(IT_0329);
    const ccomplex_t IT_0406 = 24*conj(IT_0259);
    const ccomplex_t IT_0407 = IT_0405 + IT_0406;
    const ccomplex_t IT_0408 = 6*IT_0329;
    const ccomplex_t IT_0409 = 12*IT_0259;
    const ccomplex_t IT_0410 = IT_0408 + IT_0409;
    const ccomplex_t IT_0411 = 6*conj(IT_0329);
    const ccomplex_t IT_0412 = 12*conj(IT_0259);
    const ccomplex_t IT_0413 = IT_0411 + IT_0412;
    const ccomplex_t IT_0414 = 12*IT_0340;
    const ccomplex_t IT_0415 = 12*conj(IT_0340);
    const ccomplex_t IT_0416 = IT_0393*(conj(IT_0340)*IT_0388 + IT_0340
      *IT_0389 + conj(IT_0302)*IT_0397 + IT_0302*IT_0401 + IT_0365*IT_0404 +
       IT_0369*IT_0407 + conj(IT_0069)*IT_0410 + IT_0069*IT_0413 + IT_0357
      *IT_0414 + IT_0361*IT_0415);
    const ccomplex_t IT_0417 = 12*IT_0240;
    const ccomplex_t IT_0418 = 24*IT_0204;
    const ccomplex_t IT_0419 = 24*IT_0225;
    const ccomplex_t IT_0420 = IT_0417 + IT_0418 + IT_0419;
    const ccomplex_t IT_0421 = 12*conj(IT_0240);
    const ccomplex_t IT_0422 = 24*conj(IT_0204);
    const ccomplex_t IT_0423 = 24*conj(IT_0225);
    const ccomplex_t IT_0424 = IT_0421 + IT_0422 + IT_0423;
    const ccomplex_t IT_0425 = 12*IT_0245;
    const ccomplex_t IT_0426 = 24*IT_0209;
    const ccomplex_t IT_0427 = IT_0425 + IT_0426;
    const ccomplex_t IT_0428 = 12*conj(IT_0245);
    const ccomplex_t IT_0429 = 24*conj(IT_0209);
    const ccomplex_t IT_0430 = IT_0428 + IT_0429;
    const ccomplex_t IT_0431 = 12*IT_0069;
    const ccomplex_t IT_0432 = 24*IT_0198;
    const ccomplex_t IT_0433 = IT_0431 + IT_0432;
    const ccomplex_t IT_0434 = 12*conj(IT_0069);
    const ccomplex_t IT_0435 = 24*conj(IT_0198);
    const ccomplex_t IT_0436 = IT_0434 + IT_0435;
    const ccomplex_t IT_0437 = 6*IT_0069;
    const ccomplex_t IT_0438 = 6*conj(IT_0069);
    const ccomplex_t IT_0439 = conj(IT_0245)*IT_0388 + IT_0245*IT_0389 + conj
      (IT_0209)*IT_0394 + conj(IT_0216)*IT_0397 + IT_0209*IT_0398 + IT_0216
      *IT_0401 + conj(IT_0198)*IT_0417 + conj(IT_0224)*IT_0420 + IT_0198*IT_0421
       + IT_0224*IT_0424 + IT_0357*IT_0427 + IT_0361*IT_0430 + IT_0373*IT_0433 +
       IT_0377*IT_0436 + conj(IT_0240)*IT_0437 + IT_0240*IT_0438;
    const ccomplex_t IT_0440 = m_b*s_14*m_N_3;
    const ccomplex_t IT_0441 = IT_0357*IT_0404 + IT_0361*IT_0407 + conj
      (IT_0149)*IT_0410 + IT_0149*IT_0413 + IT_0365*IT_0414 + IT_0369*IT_0415 +
       conj(IT_0302)*(24*IT_0224 + IT_0431 + IT_0432) + IT_0302*(24*conj(IT_0198
      ) + 24*conj(IT_0224) + IT_0434) + conj(IT_0340)*IT_0437 + IT_0340*IT_0438;
    const ccomplex_t IT_0442 = -s_34;
    const ccomplex_t IT_0443 = IT_0005 + IT_0442;
    const ccomplex_t IT_0444 = s_12*IT_0443;
    const ccomplex_t IT_0445 = (-24)*conj(IT_0169);
    const ccomplex_t IT_0446 = 24*conj(IT_0167);
    const ccomplex_t IT_0447 = IT_0445 + IT_0446;
    const ccomplex_t IT_0448 = (-24)*IT_0105;
    const ccomplex_t IT_0449 = s_34 + IT_0005;
    const ccomplex_t IT_0450 = s_12*IT_0449;
    const ccomplex_t IT_0451 = (-24)*IT_0290;
    const ccomplex_t IT_0452 = (-24)*conj(IT_0290);
    const ccomplex_t IT_0453 = 6*conj(IT_0103);
    const ccomplex_t IT_0454 = (-6)*conj(IT_0105);
    const ccomplex_t IT_0455 = IT_0453 + IT_0454;
    const ccomplex_t IT_0456 = 6*IT_0167;
    const ccomplex_t IT_0457 = (-6)*IT_0169;
    const ccomplex_t IT_0458 = IT_0456 + IT_0457;
    const ccomplex_t IT_0459 = (-6)*IT_0105;
    const ccomplex_t IT_0460 = (-6)*conj(IT_0169);
    const ccomplex_t IT_0461 = s_34*IT_0006;
    const ccomplex_t IT_0462 = 24*IT_0216;
    const ccomplex_t IT_0463 = 24*conj(IT_0216);
    const ccomplex_t IT_0464 = conj(IT_0240)*IT_0388 + IT_0240*IT_0389 + conj
      (IT_0069)*IT_0390 + IT_0069*IT_0391 + IT_0373*IT_0397 + IT_0377*IT_0401 +
       IT_0357*IT_0417 + IT_0361*IT_0421 + conj(IT_0198)*IT_0427 + IT_0198
      *IT_0430 + conj(IT_0209)*IT_0431 + conj(IT_0216)*IT_0433 + IT_0209*IT_0434
       + IT_0216*IT_0436 + conj(IT_0224)*(IT_0425 + IT_0426 + IT_0462) + IT_0224
      *(IT_0428 + IT_0429 + IT_0463);
    const ccomplex_t IT_0465 = m_b*s_24*m_N_3;
    const ccomplex_t IT_0466 = 24*IT_0329;
    const ccomplex_t IT_0467 = IT_0409 + IT_0466;
    const ccomplex_t IT_0468 = 24*conj(IT_0329);
    const ccomplex_t IT_0469 = IT_0412 + IT_0468;
    const ccomplex_t IT_0470 = IT_0384 + IT_0402;
    const ccomplex_t IT_0471 = IT_0385 + IT_0405;
    const ccomplex_t IT_0472 = 12*IT_0302;
    const ccomplex_t IT_0473 = 12*conj(IT_0302);
    const ccomplex_t IT_0474 = conj(IT_0302)*IT_0390 + IT_0302*IT_0391 + conj
      (IT_0340)*(IT_0425 + IT_0426 + IT_0462) + IT_0340*(IT_0428 + IT_0429 +
       IT_0463) + IT_0373*IT_0467 + IT_0377*IT_0469 + conj(IT_0240)*IT_0470 +
       IT_0240*IT_0471 + IT_0349*IT_0472 + IT_0353*IT_0473;
    const ccomplex_t IT_0475 = 48*conj(IT_0211);
    const ccomplex_t IT_0476 = 24*conj(IT_0149);
    const ccomplex_t IT_0477 = 48*conj(IT_0217);
    const ccomplex_t IT_0478 = IT_0475 + IT_0476 + IT_0477;
    const ccomplex_t IT_0479 = 48*IT_0211;
    const ccomplex_t IT_0480 = 24*IT_0149;
    const ccomplex_t IT_0481 = IT_0479 + IT_0480;
    const ccomplex_t IT_0482 = 48*IT_0198;
    const ccomplex_t IT_0483 = 48*conj(IT_0198);
    const ccomplex_t IT_0484 = conj(IT_0149)*(IT_0394 + IT_0395) + conj
      (IT_0259)*IT_0409 + conj(IT_0069)*(IT_0431 + IT_0432) + conj(IT_0302)
      *IT_0472 + IT_0217*IT_0478 + IT_0357*IT_0481 + IT_0365*(24*IT_0069 +
       IT_0482) + IT_0224*(24*conj(IT_0069) + 48*conj(IT_0224) + IT_0483);
    const ccomplex_t IT_0485 = m_b*s_13*m_N_3;
    const ccomplex_t IT_0486 = 6*conj(IT_0302);
    const ccomplex_t IT_0487 = conj(IT_0240)*IT_0302 + 0.166666666666667*conj
      (IT_0340)*IT_0420 + 0.166666666666667*IT_0340*IT_0424 + 0.166666666666667
      *IT_0349*IT_0467 + 0.166666666666667*IT_0353*IT_0469 + 0.166666666666667
      *conj(IT_0245)*IT_0470 + 0.166666666666667*IT_0245*IT_0471 +
       0.166666666666667*IT_0373*IT_0472 + 0.166666666666667*IT_0377*IT_0473 +
       0.166666666666667*IT_0240*IT_0486;
    const ccomplex_t IT_0488 = IT_0006*IT_0443;
    const ccomplex_t IT_0489 = 6*conj(IT_0105);
    const ccomplex_t IT_0490 = (-6)*conj(IT_0103);
    const ccomplex_t IT_0491 = IT_0489 + IT_0490;
    const ccomplex_t IT_0492 = 6*IT_0169;
    const ccomplex_t IT_0493 = (-6)*IT_0167;
    const ccomplex_t IT_0494 = IT_0492 + IT_0493;
    const ccomplex_t IT_0495 = 6*conj(IT_0169);
    const ccomplex_t IT_0496 = (-6)*conj(IT_0167);
    const ccomplex_t IT_0497 = IT_0495 + IT_0496;
    const ccomplex_t IT_0498 = 6*IT_0105;
    const ccomplex_t IT_0499 = conj(IT_0105)*((-24)*IT_0167 + 24*IT_0169) +
       conj(IT_0103)*(24*IT_0167 + (-24)*IT_0169) + 24*IT_0105*conj(IT_0169) + 6
      *conj(IT_0167)*(IT_0259 + 0.166666666666667*IT_0448) + IT_0302*IT_0455 +
       conj(IT_0259)*IT_0458 + conj(IT_0302)*IT_0459 + IT_0259*IT_0460 + (-6)
      *IT_0103*(conj(IT_0340) + (-0.166666666666667)*IT_0447 + (
      -0.166666666666667)*IT_0486) + IT_0340*IT_0491 + conj(IT_0329)*IT_0494 +
       IT_0329*IT_0497 + conj(IT_0340)*IT_0498;
    const ccomplex_t IT_0500 = IT_0005*IT_0006;
    const ccomplex_t IT_0501 = 48*IT_0209;
    const ccomplex_t IT_0502 = 24*IT_0245;
    const ccomplex_t IT_0503 = IT_0501 + IT_0502;
    const ccomplex_t IT_0504 = 48*conj(IT_0204);
    const ccomplex_t IT_0505 = 48*IT_0225;
    const ccomplex_t IT_0506 = 48*IT_0204;
    const ccomplex_t IT_0507 = 24*IT_0240;
    const ccomplex_t IT_0508 = 48*conj(IT_0209);
    const ccomplex_t IT_0509 = 24*conj(IT_0245);
    const ccomplex_t IT_0510 = conj(IT_0069)*IT_0397 + IT_0069*IT_0401 + conj
      (IT_0302)*IT_0410 + IT_0302*IT_0413 + IT_0240*(IT_0428 + IT_0429) + conj
      (IT_0240)*(IT_0425 + IT_0426 + IT_0462) + conj(IT_0340)*IT_0470 + IT_0340
      *IT_0471 + IT_0198*(IT_0475 + IT_0476) + IT_0224*IT_0478 + conj(IT_0224)*
      (48*IT_0217 + IT_0479 + IT_0480) + conj(IT_0198)*IT_0481 + conj(IT_0217)
      *IT_0482 + IT_0217*IT_0483 + conj(IT_0225)*(48*IT_0216 + IT_0501 + IT_0502
      ) + conj(IT_0204)*IT_0503 + IT_0216*IT_0504 + conj(IT_0216)*(IT_0505 +
       IT_0506 + IT_0507) + IT_0377*(IT_0508 + IT_0509);
    const ccomplex_t IT_0511 = conj(IT_0329)*IT_0402 + conj(IT_0340)*IT_0414 +
       conj(IT_0240)*IT_0420 + conj(IT_0245)*(IT_0425 + IT_0426) + IT_0349
      *IT_0503 + IT_0225*IT_0504 + conj(IT_0204)*(IT_0506 + IT_0507) + conj
      (IT_0225)*(IT_0505 + IT_0506 + IT_0507) + IT_0216*(48*conj(IT_0216) +
       IT_0508 + IT_0509);
    const ccomplex_t IT_0512 = (-0.166666666666667)*IT_0302;
    const ccomplex_t IT_0513 = (-0.166666666666667)*conj(IT_0302);
    const ccomplex_t IT_0514 = IT_0006*IT_0449;
    const ccomplex_t IT_0515 = IT_0335*IT_0340 + IT_0332*conj(IT_0340) + (-6)
      *conj(IT_0317)*(IT_0259 + 4*IT_0288 + (-4)*IT_0290 + (-0.166666666666667)
      *IT_0408) + (-6)*IT_0317*(conj(IT_0259) + 4*conj(IT_0288) + (-4)*conj
      (IT_0290) + (-0.166666666666667)*IT_0411) + 24*conj(IT_0315)*(IT_0288 + 
      -1./4*IT_0329 + 0.0416666666666667*IT_0384 + 0.0416666666666667*IT_0451) +
       24*IT_0315*(conj(IT_0288) + -1./4*conj(IT_0329) + 0.0416666666666667
      *IT_0385 + 0.0416666666666667*IT_0452) + (-6)*IT_0295*IT_0512 + (-6)
      *IT_0292*IT_0513;
    const ccomplex_t IT_0516 = IT_0004*(conj(IT_0069)*IT_0107 + IT_0069
      *IT_0110 + conj(IT_0149)*IT_0171 + IT_0149*IT_0174) + (IT_0110*IT_0149 +
      ...
      + IT_0179*(IT_0107*IT_0205 + IT_0110*IT_0206 + IT_0171*IT_0212 + IT_0174
      *IT_0213) + (IT_0171*IT_0205 + IT_0174*IT_0206 + IT_0107*IT_0212 + IT_0110
      *IT_0213)*IT_0214 + IT_0215*((conj(IT_0216) + conj(IT_0217))*IT_0220 + 
      (IT_0216 + IT_0217)*IT_0223 + (conj(IT_0224) + conj(IT_0225))*IT_0228 + 
      (IT_0224 + IT_0225)*IT_0231) + (IT_0223*(IT_0224 + IT_0225) + IT_0220*
      (conj(IT_0224) + conj(IT_0225)) + (conj(IT_0216) + conj(IT_0217))*IT_0228 
      + (IT_0216 + IT_0217)*IT_0231)*IT_0232 + IT_0233*(IT_0223*IT_0240 +
       IT_0220*conj(IT_0240) + IT_0231*IT_0245 + IT_0228*conj(IT_0245)) + 
      (IT_0231*IT_0240 + IT_0228*conj(IT_0240) + IT_0223*IT_0245 + IT_0220*conj
      ...
      *IT_0385) + IT_0387*IT_0392 + IT_0416 + IT_0247*IT_0439 + IT_0440*IT_0441 
      + IT_0444*(24*conj(IT_0103)*IT_0105 + IT_0103*((-24)*conj(IT_0103) + 24
      *conj(IT_0105)) + IT_0167*((-24)*conj(IT_0167) + 24*conj(IT_0169)) +
       IT_0169*IT_0447 + conj(IT_0105)*IT_0448) + IT_0450*(24*IT_0290*conj
      (IT_0290) + IT_0317*((-24)*conj(IT_0315) + 24*conj(IT_0317)) + IT_0315*(24
      *conj(IT_0315) + (-24)*conj(IT_0317)) + conj(IT_0288)*IT_0451 + IT_0288*
      (24*conj(IT_0288) + IT_0452)) + (IT_0247 + IT_0248 + IT_0251 + IT_0382)*
      (IT_0329*IT_0455 + conj(IT_0340)*IT_0458 + 6*conj(IT_0329)*(IT_0103 +
       0.166666666666667*IT_0459) + 6*IT_0340*(conj(IT_0167) + 0.166666666666667
      *IT_0460)) + IT_0461*IT_0464 + IT_0465*IT_0474 + IT_0248*IT_0484 + 6
      *IT_0485*IT_0487 + IT_0488*IT_0499 + IT_0500*IT_0510 + IT_0250*IT_0511 + 
      (IT_0247 + IT_0250 + IT_0323 + IT_0382)*(IT_0259*IT_0491 + (-6)*conj
      (IT_0259)*(IT_0103 + (-0.166666666666667)*IT_0498) + (-6)*IT_0497*IT_0512 
      + (-6)*IT_0494*IT_0513) + IT_0514*IT_0515;
