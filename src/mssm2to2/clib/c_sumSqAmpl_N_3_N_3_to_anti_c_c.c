...
ccomplex_return_t c_sumSqAmpl_N_3_N_3_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = m_c*m_N_3;
    ...
    const ccomplex_t IT_0037 = N_B3*N_d3*e_em;
    ...
    const ccomplex_t IT_0044 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_c*e_em*IT_0011*IT_0039
      *IT_0050*IT_0052;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*m_c*e_em*IT_0011*IT_0035
      *IT_0050*IT_0052;
    ...
    const ccomplex_t IT_0086 = conj(N_B3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0090 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0114 = pow(m_c, 2);
    const ccomplex_t IT_0115 = cpow((-2)*s_13 + IT_0023 + IT_0114 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0116 = conj(N_B3)*e_em;
    const ccomplex_t IT_0117 = IT_0006*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0133 = IT_0115*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1)*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0140 = cpow((-2)*s_13 + IT_0023 + IT_0114 + -m_sc_R*
    ...
    const ccomplex_t IT_0144 = (-0.5)*IT_0135;
    const ccomplex_t IT_0145 = (-0.5)*IT_0137;
    const ccomplex_t IT_0146 = IT_0144*IT_0145;
    const ccomplex_t IT_0147 = IT_0115*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0006;
    const ccomplex_t IT_0150 = 0.666666666666667*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0006;
    ...
    const ccomplex_t IT_0159 = cpow((-2)*s_23 + IT_0023 + IT_0114 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0160 = IT_0146*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = cpow((-2)*s_23 + IT_0023 + IT_0114 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0172 = IT_0139*IT_0162;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = IT_0132*IT_0159;
    ...
    const ccomplex_t IT_0194 = s_12*IT_0114;
    ...
    const ccomplex_t IT_0200 = IT_0138*IT_0152;
    const ccomplex_t IT_0201 = IT_0140*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*IT_0201;
    const ccomplex_t IT_0203 = IT_0131*IT_0145;
    const ccomplex_t IT_0204 = IT_0115*IT_0203;
    ...
    const ccomplex_t IT_0210 = IT_0006*IT_0051;
    const ccomplex_t IT_0211 = IT_0041*IT_0210;
    const ccomplex_t IT_0212 = IT_0011*IT_0207;
    const ccomplex_t IT_0213 = IT_0044*IT_0212;
    const ccomplex_t IT_0214 = IT_0011*IT_0051;
    const ccomplex_t IT_0215 = IT_0047*IT_0214;
    const ccomplex_t IT_0216 = -IT_0209 + -IT_0211 + IT_0213 + IT_0215;
    const ccomplex_t IT_0217 = m_c*e_em*IT_0011*IT_0050;
    const ccomplex_t IT_0218 = (-0.5)*IT_0217;
    const ccomplex_t IT_0219 = pow(m_Z, 2);
    const ccomplex_t IT_0220 = cpow((-2)*s_12 + (-2)*IT_0023 + IT_0219 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0224 = IT_0041*IT_0208;
    const ccomplex_t IT_0225 = IT_0037*IT_0210;
    const ccomplex_t IT_0226 = IT_0047*IT_0212;
    const ccomplex_t IT_0227 = IT_0044*IT_0214;
    const ccomplex_t IT_0228 = -IT_0224 + IT_0225 + IT_0226 + -IT_0227;
    const ccomplex_t IT_0229 = m_c*e_em*IT_0011*IT_0050*IT_0052*IT_0207;
    const ccomplex_t IT_0230 = (-0.5)*IT_0229;
    const ccomplex_t IT_0231 = cpow((-2)*s_12 + (-2)*IT_0023 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0243 = IT_0123*IT_0144;
    const ccomplex_t IT_0244 = IT_0115*IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1)*IT_0244;
    const ccomplex_t IT_0246 = IT_0136*IT_0150;
    const ccomplex_t IT_0247 = IT_0140*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = IT_0245 + IT_0248;
    const ccomplex_t IT_0250 = IT_0084*IT_0208;
    const ccomplex_t IT_0251 = IT_0086*IT_0210;
    const ccomplex_t IT_0252 = IT_0088*IT_0212;
    const ccomplex_t IT_0253 = IT_0090*IT_0214;
    const ccomplex_t IT_0254 = IT_0250 + IT_0251 + -IT_0252 + -IT_0253;
    const ccomplex_t IT_0255 = IT_0222*IT_0254;
    const ccomplex_t IT_0256 = IT_0086*IT_0208;
    const ccomplex_t IT_0257 = IT_0084*IT_0210;
    const ccomplex_t IT_0258 = IT_0090*IT_0212;
    const ccomplex_t IT_0259 = IT_0088*IT_0214;
    ...
    const ccomplex_t IT_0283 = IT_0159*IT_0243;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = IT_0162*IT_0246;
    ...
    const ccomplex_t IT_0340 = m_c*s_14*m_N_3;
    const ccomplex_t IT_0341 = 24*IT_0185;
    const ccomplex_t IT_0342 = 24*IT_0081;
    const ccomplex_t IT_0343 = IT_0341 + IT_0342;
    const ccomplex_t IT_0344 = 12*IT_0176;
    ...
    const ccomplex_t IT_0349 = 12*conj(IT_0176);
    const ccomplex_t IT_0350 = IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = 24*IT_0190;
    const ccomplex_t IT_0352 = 24*IT_0034;
    const ccomplex_t IT_0353 = IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = 24*conj(IT_0190);
    const ccomplex_t IT_0355 = 24*conj(IT_0034);
    const ccomplex_t IT_0356 = IT_0354 + IT_0355;
    const ccomplex_t IT_0357 = 12*IT_0276;
    const ccomplex_t IT_0358 = IT_0331 + IT_0357;
    const ccomplex_t IT_0359 = 12*conj(IT_0276);
    const ccomplex_t IT_0360 = IT_0332 + IT_0359;
    const ccomplex_t IT_0361 = 12*IT_0206;
    const ccomplex_t IT_0362 = 12*conj(IT_0206);
    const ccomplex_t IT_0363 = 12*IT_0249;
    const ccomplex_t IT_0364 = 12*conj(IT_0249);
    const ccomplex_t IT_0365 = conj(IT_0249)*IT_0337 + IT_0249*IT_0338 + conj
      (IT_0287)*IT_0345 + IT_0287*IT_0350 + conj(IT_0276)*IT_0353 + IT_0276
      *IT_0356 + conj(IT_0165)*IT_0358 + IT_0165*IT_0360 + IT_0320*IT_0361 +
       IT_0324*IT_0362 + IT_0296*IT_0363 + IT_0300*IT_0364;
    const ccomplex_t IT_0366 = m_c*s_24*m_N_3;
    const ccomplex_t IT_0367 = 12*IT_0143;
    const ccomplex_t IT_0368 = 24*IT_0028;
    const ccomplex_t IT_0369 = 24*IT_0189;
    const ccomplex_t IT_0370 = IT_0367 + IT_0368 + IT_0369;
    const ccomplex_t IT_0371 = 12*conj(IT_0143);
    const ccomplex_t IT_0372 = 24*conj(IT_0028);
    const ccomplex_t IT_0373 = 24*conj(IT_0189);
    const ccomplex_t IT_0374 = IT_0371 + IT_0372 + IT_0373;
    const ccomplex_t IT_0375 = 24*IT_0206;
    const ccomplex_t IT_0376 = IT_0357 + IT_0375;
    const ccomplex_t IT_0377 = 24*conj(IT_0206);
    const ccomplex_t IT_0378 = IT_0359 + IT_0377;
    const ccomplex_t IT_0379 = 6*IT_0276;
    const ccomplex_t IT_0380 = IT_0361 + IT_0379;
    const ccomplex_t IT_0381 = 6*conj(IT_0276);
    const ccomplex_t IT_0382 = IT_0362 + IT_0381;
    const ccomplex_t IT_0383 = 6*IT_0143;
    const ccomplex_t IT_0384 = 6*conj(IT_0143);
    const ccomplex_t IT_0385 = 12*IT_0287;
    const ccomplex_t IT_0386 = 12*conj(IT_0287);
    const ccomplex_t IT_0387 = IT_0366*(conj(IT_0249)*IT_0370 + IT_0249
      *IT_0374 + IT_0304*IT_0376 + IT_0308*IT_0378 + conj(IT_0156)*IT_0380 +
       IT_0156*IT_0382 + conj(IT_0287)*IT_0383 + IT_0287*IT_0384 + IT_0312
      *IT_0385 + IT_0316*IT_0386);
    const ccomplex_t IT_0388 = s_34*IT_0023;
    const ccomplex_t IT_0389 = 12*IT_0165;
    const ccomplex_t IT_0390 = IT_0353 + IT_0389;
    const ccomplex_t IT_0391 = 12*conj(IT_0165);
    const ccomplex_t IT_0392 = IT_0356 + IT_0391;
    const ccomplex_t IT_0393 = IT_0346 + IT_0347 + IT_0349;
    const ccomplex_t IT_0394 = 12*IT_0156;
    const ccomplex_t IT_0395 = 12*conj(IT_0156);
    const ccomplex_t IT_0396 = conj(IT_0165)*IT_0335 + IT_0165*IT_0336 + conj
      (IT_0143)*IT_0337 + IT_0143*IT_0338 + IT_0312*IT_0344 + IT_0028*(IT_0346 +
       IT_0349) + IT_0296*IT_0367 + conj(IT_0185)*IT_0368 + (IT_0081 + IT_0185)
      *IT_0374 + IT_0304*IT_0390 + IT_0308*IT_0392 + IT_0189*IT_0393 + IT_0320
      *IT_0394 + IT_0324*IT_0395;
    const ccomplex_t IT_0397 = -s_34;
    const ccomplex_t IT_0398 = IT_0114 + IT_0397;
    const ccomplex_t IT_0399 = s_12*IT_0398;
    const ccomplex_t IT_0400 = (-24)*conj(IT_0103);
    const ccomplex_t IT_0401 = 24*conj(IT_0101);
    const ccomplex_t IT_0402 = IT_0400 + IT_0401;
    const ccomplex_t IT_0403 = (-24)*IT_0073;
    const ccomplex_t IT_0404 = s_34 + IT_0114;
    const ccomplex_t IT_0405 = s_12*IT_0404;
    const ccomplex_t IT_0406 = (-24)*IT_0237;
    const ccomplex_t IT_0407 = (-24)*conj(IT_0237);
    const ccomplex_t IT_0408 = 6*conj(IT_0071);
    const ccomplex_t IT_0409 = (-6)*conj(IT_0073);
    const ccomplex_t IT_0410 = IT_0408 + IT_0409;
    const ccomplex_t IT_0411 = 6*IT_0101;
    const ccomplex_t IT_0412 = (-6)*IT_0103;
    const ccomplex_t IT_0413 = IT_0411 + IT_0412;
    const ccomplex_t IT_0414 = (-6)*IT_0073;
    const ccomplex_t IT_0415 = (-6)*conj(IT_0103);
    const ccomplex_t IT_0416 = 24*conj(IT_0186);
    const ccomplex_t IT_0417 = 24*conj(IT_0083);
    const ccomplex_t IT_0418 = IT_0395 + IT_0416 + IT_0417;
    const ccomplex_t IT_0419 = conj(IT_0176)*IT_0335 + IT_0176*IT_0336 +
       IT_0304*IT_0344 + IT_0320*(IT_0367 + IT_0368 + IT_0369) + IT_0324*IT_0374
       + conj(IT_0165)*IT_0383 + IT_0165*IT_0384 + IT_0312*IT_0389 + IT_0316
      *IT_0391 + IT_0308*IT_0393 + IT_0296*IT_0394 + IT_0300*IT_0418;
    const ccomplex_t IT_0420 = m_c*s_23*m_N_3;
    const ccomplex_t IT_0421 = 6*conj(IT_0249);
    const ccomplex_t IT_0422 = conj(IT_0165)*IT_0249 + 0.166666666666667*conj
      (IT_0276)*IT_0343 + 0.166666666666667*IT_0276*IT_0348 + 0.166666666666667
      *conj(IT_0176)*IT_0358 + 0.166666666666667*IT_0176*IT_0360 +
       0.166666666666667*IT_0296*IT_0361 + 0.166666666666667*IT_0300*IT_0362 +
       0.166666666666667*IT_0320*IT_0363 + 0.166666666666667*IT_0324*IT_0364 +
       0.166666666666667*conj(IT_0287)*IT_0390 + 0.166666666666667*IT_0287
      *IT_0392 + 0.166666666666667*IT_0165*IT_0421;
    const ccomplex_t IT_0423 = IT_0023*IT_0398;
    const ccomplex_t IT_0424 = 6*conj(IT_0073);
    const ccomplex_t IT_0425 = (-6)*conj(IT_0071);
    const ccomplex_t IT_0426 = IT_0424 + IT_0425;
    const ccomplex_t IT_0427 = 6*IT_0103;
    const ccomplex_t IT_0428 = (-6)*IT_0101;
    const ccomplex_t IT_0429 = IT_0427 + IT_0428;
    const ccomplex_t IT_0430 = 6*conj(IT_0103);
    const ccomplex_t IT_0431 = (-6)*conj(IT_0101);
    const ccomplex_t IT_0432 = IT_0430 + IT_0431;
    const ccomplex_t IT_0433 = 6*IT_0073;
    const ccomplex_t IT_0434 = conj(IT_0073)*((-24)*IT_0101 + 24*IT_0103) +
       conj(IT_0071)*(24*IT_0101 + (-24)*IT_0103) + 24*IT_0073*conj(IT_0103) + 6
      *conj(IT_0101)*(IT_0206 + 0.166666666666667*IT_0403) + IT_0249*IT_0410 +
       conj(IT_0206)*IT_0413 + conj(IT_0249)*IT_0414 + IT_0206*IT_0415 + (-6)
      *IT_0071*(conj(IT_0287) + (-0.166666666666667)*IT_0402 + (
      -0.166666666666667)*IT_0421) + IT_0287*IT_0426 + conj(IT_0276)*IT_0429 +
       IT_0276*IT_0432 + conj(IT_0287)*IT_0433;
    const ccomplex_t IT_0435 = m_c*s_13*m_N_3;
    const ccomplex_t IT_0436 = 24*IT_0083;
    const ccomplex_t IT_0437 = 24*IT_0186;
    const ccomplex_t IT_0438 = conj(IT_0287)*IT_0335 + IT_0287*IT_0336 +
       IT_0312*IT_0376 + IT_0316*IT_0378 + conj(IT_0143)*IT_0380 + IT_0143
      *IT_0382 + IT_0304*IT_0385 + IT_0308*IT_0386 + IT_0249*IT_0418 + conj
      (IT_0249)*(IT_0394 + IT_0436 + IT_0437);
    const ccomplex_t IT_0439 = 48*IT_0083;
    const ccomplex_t IT_0440 = 24*IT_0156;
    const ccomplex_t IT_0441 = IT_0439 + IT_0440;
    const ccomplex_t IT_0442 = 48*IT_0028;
    const ccomplex_t IT_0443 = 24*IT_0143;
    const ccomplex_t IT_0444 = IT_0442 + IT_0443;
    const ccomplex_t IT_0445 = 48*conj(IT_0028);
    const ccomplex_t IT_0446 = 48*IT_0189;
    const ccomplex_t IT_0447 = 48*conj(IT_0083);
    const ccomplex_t IT_0448 = 24*conj(IT_0156);
    const ccomplex_t IT_0449 = conj(IT_0206)*IT_0361 + conj(IT_0249)*IT_0363 +
       conj(IT_0143)*IT_0370 + conj(IT_0156)*(IT_0394 + IT_0436) + IT_0304
      *IT_0441 + conj(IT_0028)*IT_0444 + IT_0189*IT_0445 + conj(IT_0189)*
      (IT_0444 + IT_0446) + IT_0186*(48*conj(IT_0186) + IT_0447 + IT_0448);
    const ccomplex_t IT_0450 = IT_0023*IT_0114;
    const ccomplex_t IT_0451 = 48*IT_0081;
    const ccomplex_t IT_0452 = 24*IT_0176;
    const ccomplex_t IT_0453 = IT_0451 + IT_0452;
    const ccomplex_t IT_0454 = 48*conj(IT_0034);
    const ccomplex_t IT_0455 = 48*IT_0034;
    const ccomplex_t IT_0456 = 48*IT_0190;
    const ccomplex_t IT_0457 = 48*conj(IT_0081);
    const ccomplex_t IT_0458 = 24*conj(IT_0176);
    const ccomplex_t IT_0459 = conj(IT_0165)*IT_0345 + IT_0165*IT_0350 + conj
      (IT_0287)*IT_0358 + IT_0287*IT_0360 + conj(IT_0249)*IT_0380 + IT_0249
      *IT_0382 + IT_0143*IT_0418 + conj(IT_0143)*(IT_0394 + IT_0436 + IT_0437) +
       conj(IT_0189)*(48*IT_0186 + IT_0439 + IT_0440) + conj(IT_0028)*IT_0441 +
       IT_0186*IT_0445 + conj(IT_0186)*(IT_0442 + IT_0446) + IT_0316*(IT_0447 +
       IT_0448) + conj(IT_0190)*(48*IT_0185 + IT_0451 + IT_0452) + conj(IT_0034)
      *IT_0453 + IT_0185*IT_0454 + conj(IT_0185)*(IT_0455 + IT_0456) + IT_0324*
      (IT_0457 + IT_0458);
    const ccomplex_t IT_0460 = 24*IT_0165;
    const ccomplex_t IT_0461 = IT_0455 + IT_0460;
    const ccomplex_t IT_0462 = conj(IT_0176)*(IT_0342 + IT_0344) + conj
      (IT_0276)*IT_0357 + conj(IT_0287)*IT_0385 + conj(IT_0165)*IT_0390 +
       IT_0296*IT_0453 + IT_0190*IT_0454 + IT_0185*(48*conj(IT_0185) + IT_0457 +
       IT_0458) + conj(IT_0034)*IT_0461 + conj(IT_0190)*(IT_0456 + IT_0461);
    const ccomplex_t IT_0463 = (-0.166666666666667)*IT_0249;
    const ccomplex_t IT_0464 = (-0.166666666666667)*conj(IT_0249);
    const ccomplex_t IT_0465 = IT_0023*IT_0404;
    const ccomplex_t IT_0466 = IT_0282*IT_0287 + IT_0279*conj(IT_0287) + (-6)
      *conj(IT_0264)*(IT_0206 + 4*IT_0235 + (-4)*IT_0237 + (-0.166666666666667)
      *IT_0379) + (-6)*IT_0264*(conj(IT_0206) + 4*conj(IT_0235) + (-4)*conj
      (IT_0237) + (-0.166666666666667)*IT_0381) + 24*conj(IT_0262)*(IT_0235 + 
      -1./4*IT_0276 + 0.0416666666666667*IT_0331 + 0.0416666666666667*IT_0406) +
       24*IT_0262*(conj(IT_0235) + -1./4*conj(IT_0276) + 0.0416666666666667
      *IT_0332 + 0.0416666666666667*IT_0407) + (-6)*IT_0242*IT_0463 + (-6)
      *IT_0239*IT_0464;
    const ccomplex_t IT_0467 = IT_0004*((conj(IT_0028) + conj(IT_0034))
      ...
      *IT_0332) + IT_0334*IT_0339 + IT_0340*IT_0365 + IT_0387 + IT_0388*IT_0396 
      + IT_0399*(24*conj(IT_0071)*IT_0073 + IT_0071*((-24)*conj(IT_0071) + 24
      *conj(IT_0073)) + IT_0101*((-24)*conj(IT_0101) + 24*conj(IT_0103)) +
       IT_0103*IT_0402 + conj(IT_0073)*IT_0403) + IT_0405*(24*IT_0237*conj
      (IT_0237) + IT_0264*((-24)*conj(IT_0262) + 24*conj(IT_0264)) + IT_0262*(24
      *conj(IT_0262) + (-24)*conj(IT_0264)) + conj(IT_0235)*IT_0406 + IT_0235*
      (24*conj(IT_0235) + IT_0407)) + (IT_0194 + IT_0195 + IT_0198 + IT_0329)*
      (IT_0276*IT_0410 + conj(IT_0287)*IT_0413 + 6*conj(IT_0276)*(IT_0071 +
       0.166666666666667*IT_0414) + 6*IT_0287*(conj(IT_0101) + 0.166666666666667
      *IT_0415)) + IT_0194*IT_0419 + 6*IT_0420*IT_0422 + IT_0423*IT_0434 +
       IT_0435*IT_0438 + IT_0195*IT_0449 + IT_0450*IT_0459 + IT_0197*IT_0462 + 
      (IT_0194 + IT_0197 + IT_0270 + IT_0329)*(IT_0206*IT_0426 + (-6)*conj
      (IT_0206)*(IT_0071 + (-0.166666666666667)*IT_0433) + (-6)*IT_0432*IT_0463 
      + (-6)*IT_0429*IT_0464) + IT_0465*IT_0466;
