        ...
        )
{
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_se_L*
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0037 = 0.5*IT_0036;
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_se_R*
    ...
    const ccomplex_t IT_0154 = cpow((-2)*s_13 + IT_0026 + IT_0027 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0155 = IT_0086*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*IT_0155;
    const ccomplex_t IT_0157 = cpow((-2)*s_13 + IT_0026 + IT_0027 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    ...
    const ccomplex_t IT_0323 = m_e*s_13*m_N_3;
    ...
    const ccomplex_t IT_0402 = m_e*s_24*m_N_3;
    ...
    const ccomplex_t IT_0417 = m_e*s_23*m_N_3;
    ...
    const ccomplex_t IT_0423 = m_e*s_14*m_N_3;
