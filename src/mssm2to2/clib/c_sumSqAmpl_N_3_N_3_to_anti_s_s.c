        ...
        )
{
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0032 = pow(m_W, -1);
    const ccomplex_t IT_0033 = cos(beta);
    const ccomplex_t IT_0034 = cpow(IT_0033, -1);
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0014*IT_0032*IT_0034;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*(IT_0065 + -IT_0066 + 
      -IT_0067 + IT_0068);
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*m_s*e_em*IT_0014*IT_0032
      *IT_0034*IT_0043;
    ...
    const ccomplex_t IT_0159 = cpow((-2)*s_23 + IT_0005 + IT_0006 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0160 = IT_0088*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = cpow((-2)*s_23 + IT_0005 + IT_0006 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0172 = IT_0028*IT_0162;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = IT_0039*IT_0159;
    ...
    const ccomplex_t IT_0194 = s_12*IT_0005;
    ...
    const ccomplex_t IT_0207 = IT_0009*IT_0033;
    ...
    const ccomplex_t IT_0229 = m_s*e_em*IT_0014*IT_0032*IT_0034*IT_0209;
    const ccomplex_t IT_0230 = (-0.5)*IT_0229;
    const ccomplex_t IT_0231 = cpow((-2)*s_12 + (-2)*IT_0006 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0250 = IT_0045*IT_0207;
    const ccomplex_t IT_0251 = IT_0049*IT_0210;
    const ccomplex_t IT_0252 = IT_0052*IT_0212;
    const ccomplex_t IT_0253 = IT_0055*IT_0214;
    const ccomplex_t IT_0254 = IT_0250 + -IT_0251 + -IT_0252 + IT_0253;
    const ccomplex_t IT_0255 = IT_0233*IT_0254;
    const ccomplex_t IT_0256 = IT_0049*IT_0207;
    const ccomplex_t IT_0257 = IT_0045*IT_0210;
    const ccomplex_t IT_0258 = IT_0055*IT_0212;
    const ccomplex_t IT_0259 = IT_0052*IT_0214;
    ...
    const ccomplex_t IT_0304 = conj(IT_0154) + conj(IT_0185);
    const ccomplex_t IT_0305 = 12*IT_0237;
    const ccomplex_t IT_0306 = (-12)*IT_0235;
    const ccomplex_t IT_0307 = IT_0305 + IT_0306;
    const ccomplex_t IT_0308 = IT_0154 + IT_0185;
    const ccomplex_t IT_0309 = 12*conj(IT_0237);
    const ccomplex_t IT_0310 = (-12)*conj(IT_0235);
    ...
    const ccomplex_t IT_0330 = 6*conj(IT_0078);
    const ccomplex_t IT_0331 = (-6)*conj(IT_0076);
    const ccomplex_t IT_0332 = IT_0330 + IT_0331;
    const ccomplex_t IT_0333 = 6*IT_0116;
    const ccomplex_t IT_0334 = (-6)*IT_0114;
    const ccomplex_t IT_0335 = IT_0333 + IT_0334;
    const ccomplex_t IT_0336 = 6*conj(IT_0116);
    const ccomplex_t IT_0337 = (-6)*conj(IT_0114);
    const ccomplex_t IT_0338 = IT_0336 + IT_0337;
    const ccomplex_t IT_0339 = 6*IT_0078;
    const ccomplex_t IT_0340 = IT_0195 + IT_0197 + IT_0329;
    const ccomplex_t IT_0341 = 6*IT_0206;
    const ccomplex_t IT_0342 = 6*conj(IT_0206);
    const ccomplex_t IT_0343 = s_13 + s_14;
    const ccomplex_t IT_0344 = IT_0000*IT_0343;
    const ccomplex_t IT_0345 = 6*IT_0096;
    const ccomplex_t IT_0346 = 6*conj(IT_0096);
    const ccomplex_t IT_0347 = 6*IT_0176;
    const ccomplex_t IT_0348 = 6*conj(IT_0176);
    const ccomplex_t IT_0349 = conj(IT_0042)*IT_0239 + IT_0042*IT_0242 + conj
      (IT_0165)*IT_0279 + IT_0165*IT_0282 + IT_0299*IT_0312 + IT_0296*IT_0315 +
       IT_0303*IT_0316 + IT_0300*IT_0319 + IT_0307*IT_0320 + IT_0304*IT_0323 +
       IT_0311*IT_0324 + IT_0308*IT_0327 + (-6)*conj(IT_0262)*(IT_0176 + (
      -0.166666666666667)*IT_0345) + (-6)*IT_0262*(conj(IT_0176) + (
      -0.166666666666667)*IT_0346) + (-6)*conj(IT_0264)*(IT_0096 + (
      -0.166666666666667)*IT_0347) + (-6)*IT_0264*(conj(IT_0096) + (
      -0.166666666666667)*IT_0348);
    const ccomplex_t IT_0350 = m_s*s_14*m_N_3;
    const ccomplex_t IT_0351 = 12*IT_0176;
    const ccomplex_t IT_0352 = 24*IT_0185;
    const ccomplex_t IT_0353 = 24*IT_0154;
    const ccomplex_t IT_0354 = IT_0351 + IT_0352 + IT_0353;
    const ccomplex_t IT_0355 = 12*conj(IT_0176);
    const ccomplex_t IT_0356 = 24*conj(IT_0154);
    const ccomplex_t IT_0357 = 24*conj(IT_0185);
    const ccomplex_t IT_0358 = IT_0355 + IT_0356 + IT_0357;
    const ccomplex_t IT_0359 = 24*IT_0190;
    const ccomplex_t IT_0360 = 24*IT_0151;
    const ccomplex_t IT_0361 = IT_0359 + IT_0360;
    const ccomplex_t IT_0362 = 24*conj(IT_0190);
    const ccomplex_t IT_0363 = 24*conj(IT_0151);
    const ccomplex_t IT_0364 = IT_0362 + IT_0363;
    const ccomplex_t IT_0365 = 12*IT_0276;
    const ccomplex_t IT_0366 = IT_0341 + IT_0365;
    const ccomplex_t IT_0367 = 12*conj(IT_0276);
    const ccomplex_t IT_0368 = IT_0342 + IT_0367;
    const ccomplex_t IT_0369 = 12*IT_0206;
    const ccomplex_t IT_0370 = 12*conj(IT_0206);
    const ccomplex_t IT_0371 = 12*IT_0249;
    const ccomplex_t IT_0372 = 12*conj(IT_0249);
    const ccomplex_t IT_0373 = conj(IT_0249)*IT_0347 + IT_0249*IT_0348 + conj
      (IT_0287)*IT_0354 + IT_0287*IT_0358 + conj(IT_0276)*IT_0361 + IT_0276
      *IT_0364 + conj(IT_0165)*IT_0366 + IT_0165*IT_0368 + IT_0320*IT_0369 +
       IT_0324*IT_0370 + IT_0304*IT_0371 + IT_0308*IT_0372;
    const ccomplex_t IT_0374 = m_s*s_23*m_N_3;
    const ccomplex_t IT_0375 = 12*IT_0165;
    const ccomplex_t IT_0376 = IT_0361 + IT_0375;
    const ccomplex_t IT_0377 = 12*conj(IT_0165);
    const ccomplex_t IT_0378 = IT_0364 + IT_0377;
    const ccomplex_t IT_0379 = conj(IT_0165)*IT_0249 + IT_0165*conj(IT_0249) +
       0.166666666666667*conj(IT_0176)*IT_0366 + 0.166666666666667*IT_0176
      *IT_0368 + 0.166666666666667*IT_0304*(24*IT_0276 + IT_0369) +
       0.166666666666667*IT_0308*(24*conj(IT_0276) + IT_0370) +
       0.166666666666667*IT_0320*IT_0371 + 0.166666666666667*IT_0324*IT_0372 +
       0.166666666666667*conj(IT_0287)*IT_0376 + 0.166666666666667*IT_0287
      *IT_0378;
    const ccomplex_t IT_0380 = m_s*s_13*m_N_3;
    const ccomplex_t IT_0381 = 24*IT_0186;
    const ccomplex_t IT_0382 = 24*IT_0156;
    const ccomplex_t IT_0383 = IT_0381 + IT_0382;
    const ccomplex_t IT_0384 = 12*IT_0096;
    const ccomplex_t IT_0385 = IT_0383 + IT_0384;
    const ccomplex_t IT_0386 = 24*conj(IT_0186);
    const ccomplex_t IT_0387 = 24*conj(IT_0156);
    const ccomplex_t IT_0388 = IT_0386 + IT_0387;
    const ccomplex_t IT_0389 = 12*conj(IT_0096);
    const ccomplex_t IT_0390 = IT_0388 + IT_0389;
    const ccomplex_t IT_0391 = 24*IT_0145;
    const ccomplex_t IT_0392 = 24*IT_0189;
    const ccomplex_t IT_0393 = IT_0391 + IT_0392;
    const ccomplex_t IT_0394 = 24*conj(IT_0145);
    const ccomplex_t IT_0395 = 24*conj(IT_0189);
    const ccomplex_t IT_0396 = IT_0394 + IT_0395;
    const ccomplex_t IT_0397 = 6*IT_0276;
    const ccomplex_t IT_0398 = IT_0369 + IT_0397;
    const ccomplex_t IT_0399 = 6*conj(IT_0276);
    const ccomplex_t IT_0400 = IT_0370 + IT_0399;
    const ccomplex_t IT_0401 = 12*IT_0287;
    const ccomplex_t IT_0402 = 12*conj(IT_0287);
    const ccomplex_t IT_0403 = conj(IT_0287)*IT_0345 + IT_0287*IT_0346 +
       IT_0312*IT_0365 + IT_0316*IT_0367 + conj(IT_0249)*IT_0385 + IT_0249
      *IT_0390 + conj(IT_0206)*IT_0393 + IT_0206*IT_0396 + conj(IT_0042)*IT_0398
       + IT_0042*IT_0400 + IT_0296*IT_0401 + IT_0300*IT_0402;
    const ccomplex_t IT_0404 = m_s*s_24*m_N_3;
    const ccomplex_t IT_0405 = 12*IT_0042;
    const ccomplex_t IT_0406 = IT_0393 + IT_0405;
    const ccomplex_t IT_0407 = 12*conj(IT_0042);
    const ccomplex_t IT_0408 = IT_0396 + IT_0407;
    const ccomplex_t IT_0409 = 6*IT_0042;
    const ccomplex_t IT_0410 = 6*conj(IT_0042);
    const ccomplex_t IT_0411 = IT_0296*IT_0365 + IT_0300*IT_0367 + conj
      (IT_0206)*IT_0383 + IT_0206*IT_0388 + conj(IT_0096)*IT_0398 + IT_0096
      *IT_0400 + IT_0312*IT_0401 + IT_0316*IT_0402 + conj(IT_0249)*IT_0406 +
       IT_0249*IT_0408 + conj(IT_0287)*IT_0409 + IT_0287*IT_0410;
    const ccomplex_t IT_0412 = s_34*IT_0006;
    const ccomplex_t IT_0413 = IT_0394 + IT_0395 + IT_0407;
    const ccomplex_t IT_0414 = conj(IT_0165)*IT_0345 + IT_0165*IT_0346 + conj
      (IT_0042)*IT_0347 + IT_0042*IT_0348 + IT_0312*IT_0351 + IT_0145*(IT_0355 +
       IT_0356) + IT_0189*IT_0358 + IT_0296*IT_0376 + IT_0300*IT_0378 + IT_0320
      *IT_0384 + IT_0324*IT_0389 + conj(IT_0185)*IT_0391 + IT_0304*IT_0405 +
       IT_0154*IT_0408 + IT_0185*IT_0413;
    const ccomplex_t IT_0415 = 6*IT_0114;
    const ccomplex_t IT_0416 = (-6)*IT_0116;
    const ccomplex_t IT_0417 = IT_0415 + IT_0416;
    const ccomplex_t IT_0418 = 6*conj(IT_0114);
    const ccomplex_t IT_0419 = (-6)*conj(IT_0116);
    const ccomplex_t IT_0420 = IT_0418 + IT_0419;
    const ccomplex_t IT_0421 = (-6)*IT_0078;
    const ccomplex_t IT_0422 = (-6)*conj(IT_0078);
    const ccomplex_t IT_0423 = -s_34;
    const ccomplex_t IT_0424 = IT_0005 + IT_0423;
    const ccomplex_t IT_0425 = s_12*IT_0424;
    const ccomplex_t IT_0426 = (-24)*IT_0114;
    const ccomplex_t IT_0427 = 24*IT_0116;
    const ccomplex_t IT_0428 = IT_0426 + IT_0427;
    const ccomplex_t IT_0429 = (-24)*IT_0116;
    const ccomplex_t IT_0430 = 24*IT_0114;
    const ccomplex_t IT_0431 = 48*IT_0154;
    const ccomplex_t IT_0432 = 24*IT_0176;
    const ccomplex_t IT_0433 = IT_0431 + IT_0432;
    const ccomplex_t IT_0434 = 48*IT_0151;
    const ccomplex_t IT_0435 = 24*IT_0165;
    const ccomplex_t IT_0436 = IT_0434 + IT_0435;
    const ccomplex_t IT_0437 = 48*conj(IT_0154);
    const ccomplex_t IT_0438 = 48*conj(IT_0151);
    const ccomplex_t IT_0439 = 48*IT_0190;
    const ccomplex_t IT_0440 = conj(IT_0176)*IT_0354 + conj(IT_0276)*IT_0365 +
       conj(IT_0165)*IT_0376 + conj(IT_0287)*IT_0401 + conj(IT_0185)*(48*IT_0185
       + IT_0431 + IT_0432) + conj(IT_0154)*IT_0433 + conj(IT_0151)*IT_0436 +
       IT_0185*IT_0437 + IT_0190*IT_0438 + conj(IT_0190)*(IT_0436 + IT_0439);
    const ccomplex_t IT_0441 = conj(IT_0176)*IT_0345 + IT_0176*IT_0346 +
       IT_0296*IT_0351 + IT_0300*IT_0358 + IT_0312*IT_0375 + IT_0316*IT_0377 +
       IT_0304*IT_0384 + IT_0308*IT_0390 + IT_0320*(IT_0391 + IT_0392 + IT_0405)
       + conj(IT_0165)*IT_0409 + IT_0165*IT_0410 + IT_0324*IT_0413;
    const ccomplex_t IT_0442 = s_34 + IT_0005;
    const ccomplex_t IT_0443 = s_12*IT_0442;
    const ccomplex_t IT_0444 = (-24)*IT_0237;
    const ccomplex_t IT_0445 = (-24)*conj(IT_0237);
    const ccomplex_t IT_0446 = 24*conj(IT_0235);
    const ccomplex_t IT_0447 = 24*IT_0237;
    const ccomplex_t IT_0448 = IT_0005*IT_0006;
    const ccomplex_t IT_0449 = 48*IT_0156;
    const ccomplex_t IT_0450 = 24*IT_0096;
    const ccomplex_t IT_0451 = IT_0449 + IT_0450;
    const ccomplex_t IT_0452 = 48*conj(IT_0156);
    const ccomplex_t IT_0453 = 48*conj(IT_0145);
    const ccomplex_t IT_0454 = 48*IT_0145;
    const ccomplex_t IT_0455 = 48*IT_0189;
    const ccomplex_t IT_0456 = 48*IT_0186;
    const ccomplex_t IT_0457 = conj(IT_0165)*IT_0354 + IT_0165*IT_0358 + conj
      (IT_0176)*IT_0361 + conj(IT_0287)*IT_0366 + IT_0287*IT_0368 + conj(IT_0042
      )*IT_0385 + IT_0042*IT_0390 + conj(IT_0096)*IT_0393 + conj(IT_0249)
      *IT_0398 + IT_0249*IT_0400 + conj(IT_0190)*(48*IT_0185 + IT_0431 + IT_0432
      ) + conj(IT_0151)*IT_0433 + IT_0324*IT_0437 + IT_0185*IT_0438 + conj
      (IT_0185)*(IT_0434 + IT_0439) + conj(IT_0145)*IT_0451 + IT_0316*IT_0452 +
       IT_0186*IT_0453 + conj(IT_0186)*(IT_0454 + IT_0455) + conj(IT_0189)*
      (IT_0449 + IT_0450 + IT_0456);
    const ccomplex_t IT_0458 = 24*IT_0042;
    const ccomplex_t IT_0459 = IT_0454 + IT_0458;
    const ccomplex_t IT_0460 = conj(IT_0206)*IT_0369 + conj(IT_0249)*IT_0371 +
       conj(IT_0096)*IT_0385 + conj(IT_0042)*IT_0406 + conj(IT_0156)*IT_0451 +
       IT_0186*IT_0452 + IT_0189*IT_0453 + conj(IT_0186)*(IT_0449 + IT_0450 +
       IT_0456) + conj(IT_0145)*IT_0459 + conj(IT_0189)*(IT_0455 + IT_0459);
    const ccomplex_t IT_0461 = IT_0006*IT_0424;
    const ccomplex_t IT_0462 = (-6)*conj(IT_0276);
    const ccomplex_t IT_0463 = IT_0078*((-24)*conj(IT_0114) + 24*conj(IT_0116)
      ) + IT_0276*IT_0332 + conj(IT_0287)*IT_0335 + IT_0287*IT_0338 + conj
      (IT_0276)*IT_0339 + conj(IT_0249)*IT_0417 + IT_0249*IT_0420 + conj(IT_0206
      )*IT_0421 + IT_0206*IT_0422 + conj(IT_0078)*IT_0428 + 6*conj(IT_0076)*
      (IT_0206 + 0.166666666666667*IT_0429 + 0.166666666666667*IT_0430) +
       IT_0076*(24*conj(IT_0114) + (-24)*conj(IT_0116) + 6*conj(IT_0206) +
       IT_0462);
    const ccomplex_t IT_0464 = IT_0006*IT_0442;
    const ccomplex_t IT_0465 = IT_0242*IT_0249 + IT_0239*conj(IT_0249) +
       IT_0282*IT_0287 + IT_0279*conj(IT_0287) + (-6)*IT_0264*(conj(IT_0206) + 4
      *conj(IT_0235) + (-4)*conj(IT_0237) + -1./6*IT_0399) + conj(IT_0262)*(24
      *IT_0235 + (-6)*IT_0276 + IT_0341 + IT_0444) + (-6)*conj(IT_0264)*(IT_0206
       + 4*IT_0235 + -1./6*IT_0397 + -1./6*IT_0447) + IT_0262*(IT_0342 + IT_0445
       + IT_0446 + IT_0462);
    const ccomplex_t IT_0466 = IT_0004*(conj(IT_0042)*IT_0080 + IT_0042
      ...
      *IT_0328 + (IT_0194 + IT_0197 + IT_0270 + IT_0329)*(IT_0249*IT_0332 + conj
      (IT_0206)*IT_0335 + IT_0206*IT_0338 + (-6)*conj(IT_0249)*(IT_0076 + (
      -0.166666666666667)*IT_0339)) + 6*IT_0340*(conj(IT_0249)*IT_0287 + IT_0249
      *conj(IT_0287) + 0.166666666666667*conj(IT_0276)*IT_0341 +
       0.166666666666667*IT_0276*IT_0342) + IT_0344*IT_0349 + IT_0350*IT_0373 +
       6*IT_0374*IT_0379 + IT_0380*IT_0403 + IT_0404*IT_0411 + IT_0412*IT_0414 +
       (IT_0194 + IT_0195 + IT_0198 + IT_0329)*(conj(IT_0276)*IT_0417 + IT_0276
      *IT_0420 + 6*conj(IT_0287)*(IT_0076 + 0.166666666666667*IT_0421) + 6
      *IT_0287*(conj(IT_0076) + 0.166666666666667*IT_0422)) + IT_0425*(IT_0076*(
      (-24)*conj(IT_0076) + 24*conj(IT_0078)) + IT_0078*(24*conj(IT_0076) + (-24
      )*conj(IT_0078)) + conj(IT_0114)*IT_0428 + conj(IT_0116)*(IT_0429 +
       IT_0430)) + IT_0197*IT_0440 + IT_0194*IT_0441 + IT_0443*(IT_0264*((-24)
      *conj(IT_0262) + 24*conj(IT_0264)) + IT_0262*(24*conj(IT_0262) + (-24)
      *conj(IT_0264)) + conj(IT_0235)*IT_0444 + IT_0235*(IT_0445 + IT_0446) +
       conj(IT_0237)*IT_0447) + IT_0448*IT_0457 + IT_0195*IT_0460 + IT_0461
