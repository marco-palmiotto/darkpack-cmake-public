...
ccomplex_return_t c_sumSqAmpl_N_3_N_4_to_anti_Hp_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = cpow((-2)*s_12 + -IT_0004 + -IT_0008 + m_A0*
    ...
    const ccomplex_t IT_0015 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0016 = IT_0014*IT_0015;
    const ccomplex_t IT_0017 = sin(beta);
    const ccomplex_t IT_0018 = IT_0013*IT_0017;
    const ccomplex_t IT_0019 = conj(N_B3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0024 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = IT_0017*IT_0022;
    const ccomplex_t IT_0027 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0030 = IT_0014*IT_0029;
    const ccomplex_t IT_0031 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0032 = IT_0018*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0034 = IT_0023*IT_0033;
    const ccomplex_t IT_0035 = conj(N_W4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0036 = IT_0026*IT_0035;
    const ccomplex_t IT_0037 = 0.5*IT_0016 + (-0.5)*IT_0020 + (-0.5)*IT_0025 +
       0.5*IT_0028 + 0.5*IT_0030 + (-0.5)*IT_0032 + (-0.5)*IT_0034 + 0.5*IT_0036;
    const ccomplex_t IT_0038 = e_em*IT_0022;
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0004 + -IT_0008 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0050 = IT_0029*IT_0045;
    const ccomplex_t IT_0051 = IT_0031*IT_0048;
    const ccomplex_t IT_0052 = IT_0046 + IT_0049 + IT_0050 + IT_0051;
    const ccomplex_t IT_0053 = IT_0022*IT_0044;
    const ccomplex_t IT_0054 = IT_0024*IT_0053;
    const ccomplex_t IT_0055 = IT_0022*IT_0047;
    const ccomplex_t IT_0056 = IT_0027*IT_0055;
    const ccomplex_t IT_0057 = IT_0033*IT_0053;
    const ccomplex_t IT_0058 = IT_0035*IT_0055;
    const ccomplex_t IT_0059 = -IT_0054 + -IT_0056 + -IT_0057 + -IT_0058;
    const ccomplex_t IT_0060 = IT_0052 + IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = (-0.5)*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*e_em*IT_0022*(IT_0011
      *IT_0044 + IT_0017*IT_0047);
    const ccomplex_t IT_0064 = -IT_0063;
    const ccomplex_t IT_0065 = IT_0062*IT_0064;
    const ccomplex_t IT_0066 = IT_0043*IT_0065;
    const ccomplex_t IT_0067 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0068 = IT_0022*IT_0067;
    const ccomplex_t IT_0069 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0088 = pow(m_Hp, 2);
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0008 + IT_0088 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0090 = IT_0087*IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*IT_0090;
    const ccomplex_t IT_0092 = cpow((-2)*s_23 + IT_0008 + IT_0088 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0093 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0094 = IT_0022*IT_0093;
    const ccomplex_t IT_0095 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0100 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0101 = IT_0014*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0107 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0116 = cpow((-2)*s_12 + -IT_0004 + -IT_0008 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*e_em*IT_0022*(IT_0017
      *IT_0044 + -IT_0011*IT_0047);
    const ccomplex_t IT_0119 = IT_0019*IT_0045;
    const ccomplex_t IT_0120 = IT_0024*IT_0055;
    const ccomplex_t IT_0121 = IT_0031*IT_0045;
    const ccomplex_t IT_0122 = IT_0033*IT_0055;
    const ccomplex_t IT_0123 = IT_0119 + IT_0120 + IT_0121 + IT_0122;
    const ccomplex_t IT_0124 = IT_0015*IT_0048;
    const ccomplex_t IT_0125 = IT_0027*IT_0053;
    const ccomplex_t IT_0126 = IT_0029*IT_0048;
    const ccomplex_t IT_0127 = IT_0035*IT_0053;
    ...
    const ccomplex_t IT_0133 = IT_0117*IT_0132;
    const ccomplex_t IT_0134 = -IT_0041 + -IT_0066 + 2*IT_0091 + 2*IT_0115 + 
      -IT_0133;
    const ccomplex_t IT_0135 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0136 = IT_0022*IT_0135;
    const ccomplex_t IT_0137 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0142 = N_d4*e_em*U_Wm2;
    const ccomplex_t IT_0143 = IT_0026*IT_0142;
    const ccomplex_t IT_0144 = (-2)*IT_0143;
    const ccomplex_t IT_0145 = N_B4*U_d2*e_em;
    const ccomplex_t IT_0146 = IT_0018*IT_0145;
    const ccomplex_t IT_0147 = 1.4142135623731*IT_0146;
    const ccomplex_t IT_0148 = N_W4*U_d2*e_em;
    ...
    const ccomplex_t IT_0156 = IT_0092*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*IT_0156;
    const ccomplex_t IT_0158 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0159 = IT_0022*IT_0158;
    const ccomplex_t IT_0160 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0165 = N_d4*e_em*U_Wm1;
    const ccomplex_t IT_0166 = IT_0026*IT_0165;
    const ccomplex_t IT_0167 = (-2)*IT_0166;
    const ccomplex_t IT_0168 = N_B4*U_d1*e_em;
    const ccomplex_t IT_0169 = IT_0018*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = N_W4*U_d1*e_em;
    ...
    const ccomplex_t IT_0179 = IT_0089*IT_0178;
    ...
    const ccomplex_t IT_0183 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0184 = IT_0014*IT_0183;
    const ccomplex_t IT_0185 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0186 = IT_0018*IT_0185;
    const ccomplex_t IT_0187 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0188 = IT_0023*IT_0187;
    const ccomplex_t IT_0189 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0190 = IT_0026*IT_0189;
    const ccomplex_t IT_0191 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0192 = IT_0014*IT_0191;
    const ccomplex_t IT_0193 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0194 = IT_0018*IT_0193;
    const ccomplex_t IT_0195 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0196 = IT_0023*IT_0195;
    const ccomplex_t IT_0197 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0202 = IT_0045*IT_0185;
    const ccomplex_t IT_0203 = IT_0055*IT_0187;
    const ccomplex_t IT_0204 = IT_0045*IT_0193;
    const ccomplex_t IT_0205 = IT_0055*IT_0195;
    const ccomplex_t IT_0206 = IT_0202 + IT_0203 + IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = IT_0048*IT_0183;
    const ccomplex_t IT_0208 = IT_0053*IT_0189;
    const ccomplex_t IT_0209 = IT_0048*IT_0191;
    const ccomplex_t IT_0210 = IT_0053*IT_0197;
    ...
    const ccomplex_t IT_0215 = IT_0118*IT_0214;
    const ccomplex_t IT_0216 = IT_0117*IT_0215;
    const ccomplex_t IT_0217 = IT_0045*IT_0183;
    const ccomplex_t IT_0218 = IT_0048*IT_0185;
    const ccomplex_t IT_0219 = IT_0045*IT_0191;
    const ccomplex_t IT_0220 = IT_0048*IT_0193;
    const ccomplex_t IT_0221 = IT_0217 + IT_0218 + IT_0219 + IT_0220;
    const ccomplex_t IT_0222 = IT_0053*IT_0187;
    const ccomplex_t IT_0223 = IT_0055*IT_0189;
    const ccomplex_t IT_0224 = IT_0053*IT_0195;
    const ccomplex_t IT_0225 = IT_0055*IT_0197;
    ...
    const ccomplex_t IT_0238 = N_d3*e_em*U_Wm1;
    const ccomplex_t IT_0239 = IT_0026*IT_0238;
    const ccomplex_t IT_0240 = (-2)*IT_0239;
    const ccomplex_t IT_0241 = N_B3*U_d1*e_em;
    const ccomplex_t IT_0242 = IT_0018*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = N_W3*U_d1*e_em;
    ...
    const ccomplex_t IT_0251 = N_W4*e_em*conj(U_Wm1);
    const ccomplex_t IT_0252 = IT_0022*IT_0251;
    const ccomplex_t IT_0253 = N_d4*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0269 = N_d3*e_em*U_Wm2;
    const ccomplex_t IT_0270 = IT_0026*IT_0269;
    ...
    const ccomplex_t IT_0275 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0276 = IT_0022*IT_0275;
    const ccomplex_t IT_0277 = N_d4*conj(U_d2)*e_em;
    const ccomplex_t IT_0278 = IT_0022*IT_0277;
    ...
    const ccomplex_t IT_0283 = cpow((-2)*s_13 + IT_0004 + IT_0088 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0294 = m_N_3*IT_0091;
    const ccomplex_t IT_0295 = m_N_3*IT_0115;
    const ccomplex_t IT_0296 = m_N_4*IT_0261;
    const ccomplex_t IT_0297 = m_N_4*IT_0285;
    ...
    const ccomplex_t IT_0301 = IT_0112*IT_0141;
    const ccomplex_t IT_0302 = IT_0092*IT_0300*IT_0301;
    const ccomplex_t IT_0303 = IT_0086*IT_0164;
    const ccomplex_t IT_0304 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0305 = IT_0089*IT_0303*IT_0304;
    ...
    const ccomplex_t IT_0314 = IT_0259*IT_0304*IT_0313;
    const ccomplex_t IT_0315 = conj(N_W4)*e_em*V_Wp2;
    const ccomplex_t IT_0316 = IT_0022*IT_0315;
    ...
    const ccomplex_t IT_0323 = IT_0283*IT_0300*IT_0322;
    ...
    const ccomplex_t IT_0333 = IT_0099*IT_0154;
    const ccomplex_t IT_0334 = IT_0092*IT_0300*IT_0333;
    const ccomplex_t IT_0335 = conj(N_u3)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0336 = IT_0023*IT_0335;
    const ccomplex_t IT_0337 = 2*IT_0336;
    const ccomplex_t IT_0338 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0339 = IT_0014*IT_0338;
    const ccomplex_t IT_0340 = 1.4142135623731*IT_0339;
    const ccomplex_t IT_0341 = conj(N_W3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0342 = IT_0023*IT_0341;
    ...
    const ccomplex_t IT_0348 = IT_0257*IT_0347;
    const ccomplex_t IT_0349 = IT_0259*IT_0304*IT_0348;
    const ccomplex_t IT_0350 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0351 = IT_0023*IT_0350;
    const ccomplex_t IT_0352 = 2*IT_0351;
    const ccomplex_t IT_0353 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0354 = IT_0014*IT_0353;
    const ccomplex_t IT_0355 = 1.4142135623731*IT_0354;
    const ccomplex_t IT_0356 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0364 = IT_0283*IT_0300*IT_0363;
    const ccomplex_t IT_0365 = IT_0073*IT_0177;
    const ccomplex_t IT_0366 = IT_0089*IT_0304*IT_0365;
    const ccomplex_t IT_0367 = IT_0334 + IT_0349 + IT_0364 + IT_0366;
    const ccomplex_t IT_0368 = (-2)*conj(IT_0367);
    const ccomplex_t IT_0369 = m_N_3*IT_0180;
    const ccomplex_t IT_0370 = m_N_3*IT_0157;
    const ccomplex_t IT_0371 = IT_0312*IT_0347;
    ...
    const ccomplex_t IT_0375 = IT_0321*IT_0362;
    ...
    const ccomplex_t IT_0398 = -IT_0091 + -IT_0115;
    ...
    const ccomplex_t IT_0403 = -IT_0041 + -IT_0066 + -IT_0133;
    ...
    const ccomplex_t IT_0408 = m_N_3*IT_0401;
    ...
    const ccomplex_t IT_0431 = s_14*IT_0008;
    ...
    const ccomplex_t IT_0454 = -IT_0008;
    ...
    const ccomplex_t IT_0459 = m_N_3*IT_0455;
