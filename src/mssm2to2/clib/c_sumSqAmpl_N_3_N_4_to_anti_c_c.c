        ...
        )
{
    ...
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
    ...
    const ccomplex_t IT_0136 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_sc_R*
    ...
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0011*IT_0027*IT_0028;
    const ccomplex_t IT_0148 = (-0.5)*IT_0147;
    const ccomplex_t IT_0149 = IT_0146*IT_0148;
    const ccomplex_t IT_0150 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_sc_L*
    ...
    const ccomplex_t IT_0218 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
    ...
    const ccomplex_t IT_0223 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0432 = IT_0053*((-12)*conj(IT_0317) + 12*conj(IT_0360)
      ) + (-6)*conj(IT_0082)*((-0.166666666666667)*IT_0344 + IT_0379) + (-6)
      *IT_0082*((-0.166666666666667)*IT_0345 + conj(IT_0379)) + conj(IT_0356)
      *IT_0422 + IT_0356*IT_0423 + IT_0360*IT_0424 + conj(IT_0337)*IT_0425 +
       IT_0337*IT_0426 + IT_0317*IT_0427 + conj(IT_0366)*IT_0428 + IT_0366
      *IT_0429 + conj(IT_0274)*IT_0430 + IT_0274*IT_0431;
    ...
    const ccomplex_t IT_0442 = IT_0053*((-12)*conj(IT_0337) + 12*conj(IT_0366)
      ) + conj(IT_0379)*IT_0422 + IT_0379*IT_0423 + IT_0366*IT_0424 + conj
      (IT_0317)*IT_0425 + IT_0317*IT_0426 + IT_0337*IT_0427 + conj(IT_0360)
    ...
    const ccomplex_t IT_0454 = conj(IT_0317) + conj(IT_0360);
    const ccomplex_t IT_0455 = IT_0317 + IT_0360;
    const ccomplex_t IT_0456 = (-4)*IT_0266;
    const ccomplex_t IT_0457 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0414 + conj(IT_0366)*IT_0415 + IT_0366*(48*conj(IT_0366) + IT_0416) +
       IT_0360*IT_0417) + IT_0418*IT_0419 + IT_0421*IT_0432 + IT_0433*(conj
      (IT_0153)*IT_0430 + IT_0153*IT_0431 + conj(IT_0236)*IT_0434 + IT_0236
      *IT_0435) + IT_0437 + IT_0439*IT_0442 + (conj(IT_0181)*IT_0422 + IT_0181
      ...
      *IT_0283 + conj(IT_0255)*IT_0445 + IT_0255*IT_0446 + conj(IT_0181)*IT_0447
       + IT_0181*IT_0448) + (conj(IT_0356)*IT_0445 + IT_0356*IT_0446 + conj
      (IT_0379)*IT_0447 + IT_0379*IT_0448)*IT_0449 + (conj(IT_0379)*IT_0445 +
       IT_0379*IT_0446 + conj(IT_0356)*IT_0447 + IT_0356*IT_0448)*IT_0450 +
       IT_0451*(IT_0445*IT_0452 + IT_0446*IT_0453 + IT_0447*IT_0454 + IT_0448
      *IT_0455) + (IT_0447*IT_0452 + IT_0448*IT_0453 + IT_0445*IT_0454 + IT_0446
      *IT_0455)*IT_0456;
