        ...
        )
{
    ...
    const ccomplex_t IT_0029 = m_d*e_em*IT_0006*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0046 = m_d*e_em*IT_0011*IT_0027;
    ...
    const ccomplex_t IT_0150 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_sd_R*
    ...
    const ccomplex_t IT_0188 = IT_0058*IT_0097;
    const ccomplex_t IT_0189 = IT_0064*IT_0087;
    const ccomplex_t IT_0190 = IT_0066*IT_0097;
    const ccomplex_t IT_0191 = IT_0187 + IT_0188 + IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = IT_0054*IT_0090;
    const ccomplex_t IT_0193 = IT_0060*IT_0095;
    const ccomplex_t IT_0194 = IT_0062*IT_0090;
    const ccomplex_t IT_0195 = IT_0068*IT_0095;
    ...
    const ccomplex_t IT_0200 = IT_0128*IT_0199;
    const ccomplex_t IT_0201 = IT_0054*IT_0087;
    const ccomplex_t IT_0202 = IT_0056*IT_0090;
    const ccomplex_t IT_0203 = IT_0062*IT_0087;
    const ccomplex_t IT_0204 = IT_0064*IT_0090;
    const ccomplex_t IT_0205 = IT_0201 + IT_0202 + IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = IT_0058*IT_0095;
    const ccomplex_t IT_0207 = IT_0060*IT_0097;
    const ccomplex_t IT_0208 = IT_0066*IT_0095;
    const ccomplex_t IT_0209 = IT_0068*IT_0097;
    ...
    const ccomplex_t IT_0214 = IT_0109*IT_0213;
    const ccomplex_t IT_0215 = -IT_0200 + -IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
    ...
    const ccomplex_t IT_0229 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0002;
    const ccomplex_t IT_0230 = (-0.333333333333333)*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0292 = m_d*s_13*m_N_4;
    ...
    const ccomplex_t IT_0300 = conj(N_d3)*N_d4*e_em;
    ...
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*e_em*IT_0002*IT_0010;
    const ccomplex_t IT_0310 = 0.333333333333333*IT_0309;
    const ccomplex_t IT_0311 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0316 = 12*IT_0255;
    const ccomplex_t IT_0317 = 24*IT_0236;
    const ccomplex_t IT_0318 = IT_0316 + IT_0317;
    const ccomplex_t IT_0319 = 12*conj(IT_0255);
    const ccomplex_t IT_0320 = 24*conj(IT_0236);
    const ccomplex_t IT_0321 = IT_0319 + IT_0320;
    const ccomplex_t IT_0322 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0323 = IT_0299*IT_0322;
    const ccomplex_t IT_0324 = IT_0302*IT_0322;
    const ccomplex_t IT_0325 = N_d3*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0330 = e_em*IT_0299;
    const ccomplex_t IT_0331 = e_em*IT_0302;
    const ccomplex_t IT_0332 = (0 + _Complex_I*1)*(IT_0330 + 3*IT_0331);
    const ccomplex_t IT_0333 = (-0.166666666666667)*IT_0332;
    const ccomplex_t IT_0334 = IT_0311*IT_0333;
    const ccomplex_t IT_0335 = (0 + _Complex_I*1)*IT_0334;
    const ccomplex_t IT_0336 = IT_0329*IT_0335;
    const ccomplex_t IT_0337 = -IT_0336;
    const ccomplex_t IT_0338 = 12*IT_0181;
    const ccomplex_t IT_0339 = 24*IT_0153;
    const ccomplex_t IT_0340 = IT_0338 + IT_0339;
    const ccomplex_t IT_0341 = 12*conj(IT_0181);
    const ccomplex_t IT_0342 = 24*conj(IT_0153);
    ...
    const ccomplex_t IT_0348 = IT_0292*(conj(IT_0274)*IT_0295 + IT_0274
      *IT_0298 + conj(IT_0315)*IT_0318 + IT_0315*IT_0321 + conj(IT_0337)*IT_0340
       + IT_0337*IT_0343 + conj(IT_0255)*IT_0344 + IT_0255*IT_0345 + conj
      (IT_0236)*IT_0346 + IT_0236*IT_0347);
    const ccomplex_t IT_0349 = m_d*s_14*m_N_4;
    const ccomplex_t IT_0350 = IT_0162*IT_0251;
    const ccomplex_t IT_0351 = IT_0165*IT_0350;
    const ccomplex_t IT_0352 = (0 + _Complex_I*1)*IT_0351;
    const ccomplex_t IT_0353 = IT_0168*IT_0245;
    ...
    const ccomplex_t IT_0357 = IT_0290 + IT_0338;
    const ccomplex_t IT_0358 = IT_0291 + IT_0341;
    const ccomplex_t IT_0359 = IT_0308*IT_0335;
    const ccomplex_t IT_0360 = -IT_0359;
    const ccomplex_t IT_0361 = 12*IT_0236;
    const ccomplex_t IT_0362 = 24*IT_0255;
    const ccomplex_t IT_0363 = IT_0361 + IT_0362;
    const ccomplex_t IT_0364 = 12*conj(IT_0236);
    const ccomplex_t IT_0365 = 24*conj(IT_0255);
    const ccomplex_t IT_0366 = IT_0364 + IT_0365;
    const ccomplex_t IT_0367 = IT_0313*IT_0329;
    const ccomplex_t IT_0368 = -IT_0367;
    const ccomplex_t IT_0369 = 24*IT_0181;
    const ccomplex_t IT_0370 = IT_0294 + IT_0369;
    const ccomplex_t IT_0371 = 24*conj(IT_0181);
    const ccomplex_t IT_0372 = IT_0297 + IT_0371;
    const ccomplex_t IT_0373 = IT_0176*IT_0244;
    const ccomplex_t IT_0374 = IT_0178*IT_0373;
    const ccomplex_t IT_0375 = (0 + _Complex_I*1)*IT_0374;
    const ccomplex_t IT_0376 = IT_0163*IT_0249;
    const ccomplex_t IT_0377 = IT_0165*IT_0376;
    ...
    const ccomplex_t IT_0384 = IT_0349*(conj(IT_0356)*IT_0357 + IT_0356
      *IT_0358 + conj(IT_0360)*IT_0363 + IT_0360*IT_0366 + conj(IT_0368)*IT_0370
       + IT_0368*IT_0372 + conj(IT_0236)*IT_0380 + IT_0236*IT_0381 + conj
      (IT_0255)*IT_0382 + IT_0255*IT_0383);
    const ccomplex_t IT_0385 = m_d*s_24*m_N_3;
    ...
    const ccomplex_t IT_0390 = IT_0385*(conj(IT_0281)*IT_0295 + IT_0281
      *IT_0298 + IT_0321*IT_0337 + IT_0318*conj(IT_0337) + conj(IT_0315)*IT_0340
       + IT_0315*IT_0343 + conj(IT_0255)*IT_0386 + IT_0255*IT_0387 + conj
      (IT_0236)*IT_0388 + IT_0236*IT_0389);
    const ccomplex_t IT_0391 = m_d*s_23*m_N_3;
    const ccomplex_t IT_0392 = 12*IT_0356;
    const ccomplex_t IT_0393 = 12*conj(IT_0356);
    const ccomplex_t IT_0394 = conj(IT_0236)*IT_0356 + IT_0236*conj(IT_0356) +
       0.166666666666667*IT_0366*IT_0368 + 0.166666666666667*IT_0363*conj
      (IT_0368) + 0.166666666666667*conj(IT_0360)*IT_0370 + 0.166666666666667
      *IT_0360*IT_0372 + 0.166666666666667*IT_0358*IT_0379 + 0.166666666666667
      *IT_0357*conj(IT_0379) + 0.166666666666667*conj(IT_0255)*IT_0392 +
       0.166666666666667*IT_0255*IT_0393;
    const ccomplex_t IT_0395 = 24*IT_0315;
    const ccomplex_t IT_0396 = IT_0346 + IT_0395;
    const ccomplex_t IT_0397 = 24*conj(IT_0315);
    const ccomplex_t IT_0398 = IT_0347 + IT_0397;
    const ccomplex_t IT_0399 = 24*IT_0337;
    const ccomplex_t IT_0400 = IT_0388 + IT_0399;
    const ccomplex_t IT_0401 = 24*conj(IT_0337);
    const ccomplex_t IT_0402 = IT_0389 + IT_0401;
    const ccomplex_t IT_0403 = IT_0345*IT_0379 + IT_0344*conj(IT_0379) + conj
      (IT_0315)*IT_0382 + IT_0315*IT_0383 + conj(IT_0356)*IT_0386 + IT_0356
      *IT_0387 + conj(IT_0337)*IT_0392 + IT_0337*IT_0393 + conj(IT_0360)*IT_0396
       + IT_0360*IT_0398 + conj(IT_0368)*IT_0400 + IT_0368*IT_0402;
    const ccomplex_t IT_0404 = s_34*m_N_3*m_N_4;
    const ccomplex_t IT_0405 = IT_0345*IT_0356 + IT_0344*conj(IT_0356) + conj
      (IT_0274)*IT_0380 + IT_0274*IT_0381 + conj(IT_0337)*IT_0382 + IT_0337
      *IT_0383 + conj(IT_0315)*IT_0392 + IT_0315*IT_0393 + conj(IT_0368)*IT_0396
       + IT_0368*IT_0398 + conj(IT_0360)*IT_0400 + IT_0360*IT_0402;
    const ccomplex_t IT_0406 = 24*conj(IT_0281);
    const ccomplex_t IT_0407 = 48*conj(IT_0315);
    const ccomplex_t IT_0408 = IT_0406 + IT_0407;
    const ccomplex_t IT_0409 = 24*IT_0281;
    const ccomplex_t IT_0410 = 24*IT_0274;
    const ccomplex_t IT_0411 = 24*conj(IT_0274);
    const ccomplex_t IT_0412 = 24*IT_0356;
    const ccomplex_t IT_0413 = 48*IT_0368;
    const ccomplex_t IT_0414 = IT_0412 + IT_0413;
    const ccomplex_t IT_0415 = 24*IT_0379;
    const ccomplex_t IT_0416 = 24*conj(IT_0379);
    const ccomplex_t IT_0417 = 24*conj(IT_0356);
    const ccomplex_t IT_0418 = m_N_3*m_N_4*IT_0083;
    const ccomplex_t IT_0419 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0274)*IT_0346 + IT_0274*IT_0347 + conj(IT_0255)*IT_0357 + IT_0255
      *IT_0358 + conj(IT_0356)*IT_0382 + IT_0356*IT_0383 + IT_0337*IT_0408 +
       conj(IT_0337)*(48*IT_0315 + IT_0409) + conj(IT_0315)*IT_0410 + IT_0315
      *IT_0411 + conj(IT_0360)*IT_0414 + conj(IT_0368)*(48*IT_0360 + IT_0415) +
       IT_0368*IT_0416 + IT_0360*IT_0417;
    const ccomplex_t IT_0420 = s_13 + s_14;
    const ccomplex_t IT_0421 = IT_0263*IT_0420;
    const ccomplex_t IT_0422 = 6*IT_0053;
    const ccomplex_t IT_0423 = 6*conj(IT_0053);
    const ccomplex_t IT_0424 = 12*conj(IT_0053);
    const ccomplex_t IT_0425 = 12*IT_0082;
    const ccomplex_t IT_0426 = 12*conj(IT_0082);
    const ccomplex_t IT_0427 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0428 = (-12)*IT_0082;
    const ccomplex_t IT_0429 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0430 = (-6)*IT_0053;
    const ccomplex_t IT_0431 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0432 = IT_0053*(conj(IT_0337) + -conj(IT_0368)) + 0.5
      *conj(IT_0082)*((-0.166666666666667)*IT_0344 + IT_0379) + 0.5*IT_0082*((
      -0.166666666666667)*IT_0345 + conj(IT_0379)) + (-0.0833333333333333)*conj
      (IT_0356)*IT_0422 + (-0.0833333333333333)*IT_0356*IT_0423 + (
      -0.0833333333333333)*IT_0368*IT_0424 + (-0.0833333333333333)*conj(IT_0315)
      *IT_0425 + (-0.0833333333333333)*IT_0315*IT_0426 + (-0.0833333333333333)
      *IT_0337*IT_0427 + (-0.0833333333333333)*conj(IT_0360)*IT_0428 + (
      -0.0833333333333333)*IT_0360*IT_0429 + (-0.0833333333333333)*conj(IT_0274)
      *IT_0430 + (-0.0833333333333333)*IT_0274*IT_0431;
    ...
    const ccomplex_t IT_0434 = (conj(IT_0082)*((-24)*IT_0053 + (-6)*IT_0181 +
       ...
       conj(IT_0255)*IT_0422 + IT_0255*IT_0423 + conj(IT_0236)*IT_0430 + IT_0236
      *IT_0431)*IT_0433;
    const ccomplex_t IT_0435 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0436 = 6*IT_0082;
    const ccomplex_t IT_0437 = 6*conj(IT_0082);
    const ccomplex_t IT_0438 = s_23 + s_24;
    const ccomplex_t IT_0439 = IT_0284*IT_0438;
    const ccomplex_t IT_0440 = (-6)*IT_0082;
    const ccomplex_t IT_0441 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0442 = IT_0053*((-12)*conj(IT_0315) + 12*conj(IT_0360)
      ) + conj(IT_0379)*IT_0422 + IT_0379*IT_0423 + IT_0360*IT_0424 + conj
      (IT_0337)*IT_0425 + IT_0337*IT_0426 + IT_0315*IT_0427 + conj(IT_0368)
      *IT_0428 + IT_0368*IT_0429 + conj(IT_0281)*IT_0430 + IT_0281*IT_0431 +
       conj(IT_0274)*IT_0436 + IT_0274*IT_0437 + conj(IT_0356)*IT_0440 + IT_0356
      *IT_0441;
    const ccomplex_t IT_0443 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0444 = (-2)*IT_0266;
    const ccomplex_t IT_0445 = (-3)*IT_0130;
    const ccomplex_t IT_0446 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0447 = (-3)*IT_0215;
    const ccomplex_t IT_0448 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0449 = 2*IT_0287;
    const ccomplex_t IT_0450 = (-2)*IT_0259;
    const ccomplex_t IT_0451 = 4*IT_0287;
    const ccomplex_t IT_0452 = conj(IT_0315) + conj(IT_0360);
    const ccomplex_t IT_0453 = IT_0315 + IT_0360;
    const ccomplex_t IT_0454 = IT_0337 + IT_0368;
    const ccomplex_t IT_0455 = (-4)*IT_0266;
    const ccomplex_t IT_0456 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0348 + IT_0384 + IT_0390 + 6*IT_0391*IT_0394 + IT_0154
      *IT_0403 + IT_0404*IT_0405 + IT_0156*(conj(IT_0153)*IT_0294 + conj(IT_0281
      )*IT_0346 + conj(IT_0236)*IT_0361 + conj(IT_0274)*IT_0388 + IT_0315
      *IT_0408 + conj(IT_0315)*IT_0409 + conj(IT_0337)*IT_0410 + IT_0337*(48
      *conj(IT_0337) + IT_0411)) + IT_0155*(conj(IT_0255)*IT_0316 + conj(IT_0181
      )*IT_0338 + conj(IT_0379)*IT_0382 + conj(IT_0356)*IT_0392 + conj(IT_0368)
      *IT_0414 + conj(IT_0360)*IT_0415 + IT_0360*(48*conj(IT_0360) + IT_0416) +
       IT_0368*IT_0417) + IT_0418*IT_0419 + (-12)*IT_0421*IT_0432 + IT_0434 +
       IT_0435*(conj(IT_0153)*IT_0430 + IT_0153*IT_0431 + conj(IT_0236)*IT_0436 
      + IT_0236*IT_0437) + IT_0439*IT_0442 + (conj(IT_0181)*IT_0422 + IT_0181
      *IT_0423 + conj(IT_0255)*IT_0440 + IT_0255*IT_0441)*IT_0443 + IT_0444*
      (conj(IT_0356)*IT_0445 + IT_0356*IT_0446 + conj(IT_0379)*IT_0447 + IT_0379
      *IT_0448) + (conj(IT_0379)*IT_0445 + IT_0379*IT_0446 + conj(IT_0356)
      *IT_0447 + IT_0356*IT_0448)*IT_0449 + (conj(IT_0236)*IT_0261 + IT_0236
      *IT_0262 + conj(IT_0153)*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0445
       + IT_0255*IT_0446 + conj(IT_0181)*IT_0447 + IT_0181*IT_0448)*IT_0450 +
       IT_0451*((conj(IT_0337) + conj(IT_0368))*IT_0447 + IT_0445*IT_0452 +
       IT_0446*IT_0453 + IT_0448*IT_0454) + ((conj(IT_0337) + conj(IT_0368))
      *IT_0445 + IT_0447*IT_0452 + IT_0448*IT_0453 + IT_0446*IT_0454)*IT_0455;
