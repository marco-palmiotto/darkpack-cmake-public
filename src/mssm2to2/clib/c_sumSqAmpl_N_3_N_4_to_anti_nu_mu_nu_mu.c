...
ccomplex_return_t c_sumSqAmpl_N_3_N_4_to_anti_nu_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = conj(N_u3)*N_u4*e_em;
    ...
    const ccomplex_t IT_0048 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0049 = IT_0026*IT_0048;
    const ccomplex_t IT_0050 = IT_0029*IT_0048;
    const ccomplex_t IT_0051 = N_d3*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0075 = cpow(s_13 + (-0.5)*IT_0040 + (-0.5)*reg_prop +
       0.5*m_snu_mu*(m_snu_mu + (0 + _Complex_I*-1)*Gamma_numl), -1);
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = 0.5*IT_0077;
    const ccomplex_t IT_0079 = 4*IT_0078;
    const ccomplex_t IT_0080 = s_34*m_N_3*m_N_4;
    const ccomplex_t IT_0081 = 4*(IT_0025 + 2*IT_0045)*(conj(IT_0025) + 2*conj
      (IT_0045))*IT_0046 + 8*IT_0047*(conj(IT_0057)*IT_0078 + 0.125*IT_0057*(16
      *conj(IT_0057) + 8*conj(IT_0078)) + 0.125*conj(IT_0078)*IT_0079) + 4*(conj
      (IT_0025)*(IT_0057 + 0.5*IT_0078) + (IT_0025 + 2*IT_0045)*(conj(IT_0057) +
       0.5*conj(IT_0078)) + 2*conj(IT_0045)*(IT_0057 + 0.125*IT_0079))*IT_0080;
