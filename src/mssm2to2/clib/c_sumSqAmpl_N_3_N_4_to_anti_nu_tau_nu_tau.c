...
ccomplex_return_t c_sumSqAmpl_N_3_N_4_to_anti_nu_tau_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = IT_0000*IT_0006;
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = N_d3*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0040 = pow(m_N_4, 2);
    ...
    const ccomplex_t IT_0048 = conj(N_d3)*N_d4*e_em;
    const ccomplex_t IT_0049 = IT_0026*IT_0048;
    const ccomplex_t IT_0050 = IT_0029*IT_0048;
    const ccomplex_t IT_0051 = conj(N_u3)*N_u4*e_em;
    ...
    const ccomplex_t IT_0083 = s_34*m_N_3*m_N_4;
