...
ccomplex_return_t c_sumSqAmpl_N_3_N_4_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = m_s*e_em*IT_0011*IT_0027;
    ...
    const ccomplex_t IT_0047 = m_s*e_em*IT_0006*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
    ...
    const ccomplex_t IT_0150 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_ss_L*
    ...
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0002;
    const ccomplex_t IT_0162 = (-0.333333333333333)*IT_0161;
    const ccomplex_t IT_0163 = 0.5*IT_0147;
    ...
    const ccomplex_t IT_0168 = (-0.5)*IT_0131;
    ...
    const ccomplex_t IT_0187 = IT_0056*IT_0087;
    const ccomplex_t IT_0188 = IT_0054*IT_0090;
    const ccomplex_t IT_0189 = IT_0064*IT_0087;
    const ccomplex_t IT_0190 = IT_0062*IT_0090;
    const ccomplex_t IT_0191 = IT_0187 + IT_0188 + IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = IT_0060*IT_0095;
    const ccomplex_t IT_0193 = IT_0058*IT_0097;
    const ccomplex_t IT_0194 = IT_0068*IT_0095;
    const ccomplex_t IT_0195 = IT_0066*IT_0097;
    ...
    const ccomplex_t IT_0201 = IT_0054*IT_0087;
    const ccomplex_t IT_0202 = IT_0060*IT_0097;
    const ccomplex_t IT_0203 = IT_0062*IT_0087;
    const ccomplex_t IT_0204 = IT_0068*IT_0097;
    const ccomplex_t IT_0205 = IT_0201 + IT_0202 + IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = IT_0056*IT_0090;
    const ccomplex_t IT_0207 = IT_0058*IT_0095;
    const ccomplex_t IT_0208 = IT_0064*IT_0090;
    const ccomplex_t IT_0209 = IT_0066*IT_0095;
    ...
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0002;
    const ccomplex_t IT_0217 = (-0.333333333333333)*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0223 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0011*IT_0027*IT_0046;
    const ccomplex_t IT_0224 = (-0.5)*IT_0223;
    const ccomplex_t IT_0225 = conj(N_B4)*e_em;
    const ccomplex_t IT_0226 = IT_0002*IT_0225;
    const ccomplex_t IT_0227 = 1.4142135623731*IT_0226;
    const ccomplex_t IT_0228 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0002;
    const ccomplex_t IT_0251 = (-0.333333333333333)*IT_0250;
    ...
    const ccomplex_t IT_0256 = m_N_3*m_N_4;
    ...
    const ccomplex_t IT_0263 = m_s*m_N_4;
    ...
    const ccomplex_t IT_0268 = IT_0146*IT_0232;
    const ccomplex_t IT_0269 = IT_0150*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*IT_0269;
    const ccomplex_t IT_0271 = IT_0132*IT_0219;
    const ccomplex_t IT_0272 = IT_0136*IT_0271;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*IT_0272;
    const ccomplex_t IT_0274 = -IT_0270 + -IT_0273;
    const ccomplex_t IT_0275 = IT_0134*IT_0217;
    const ccomplex_t IT_0276 = IT_0136*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1)*IT_0276;
    const ccomplex_t IT_0278 = IT_0148*IT_0224;
    const ccomplex_t IT_0279 = IT_0150*IT_0278;
    ...
    const ccomplex_t IT_0284 = m_s*m_N_3;
    ...
    const ccomplex_t IT_0292 = m_s*s_14*m_N_4;
    const ccomplex_t IT_0293 = IT_0162*IT_0251;
    const ccomplex_t IT_0294 = IT_0165*IT_0293;
    const ccomplex_t IT_0295 = (0 + _Complex_I*1)*IT_0294;
    const ccomplex_t IT_0296 = IT_0168*IT_0245;
    const ccomplex_t IT_0297 = IT_0178*IT_0296;
    const ccomplex_t IT_0298 = (0 + _Complex_I*1)*IT_0297;
    const ccomplex_t IT_0299 = IT_0295 + IT_0298;
    const ccomplex_t IT_0300 = 12*IT_0181;
    const ccomplex_t IT_0301 = IT_0290 + IT_0300;
    const ccomplex_t IT_0302 = 12*conj(IT_0181);
    const ccomplex_t IT_0303 = IT_0291 + IT_0302;
    const ccomplex_t IT_0304 = IT_0002*IT_0010;
    const ccomplex_t IT_0305 = conj(N_d3)*N_d4*e_em;
    const ccomplex_t IT_0306 = IT_0304*IT_0305;
    const ccomplex_t IT_0307 = IT_0001*IT_0011;
    const ccomplex_t IT_0308 = IT_0305*IT_0307;
    const ccomplex_t IT_0309 = conj(N_u3)*N_u4*e_em;
    const ccomplex_t IT_0310 = IT_0304*IT_0309;
    const ccomplex_t IT_0311 = IT_0307*IT_0309;
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*(IT_0306 + IT_0308 + 
      -IT_0310 + -IT_0311);
    const ccomplex_t IT_0313 = (-0.5)*IT_0312;
    const ccomplex_t IT_0314 = e_em*IT_0304;
    const ccomplex_t IT_0315 = e_em*IT_0307;
    const ccomplex_t IT_0316 = (0 + _Complex_I*1)*(IT_0314 + 3*IT_0315);
    const ccomplex_t IT_0317 = (-0.166666666666667)*IT_0316;
    const ccomplex_t IT_0318 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0321 = IT_0313*IT_0320;
    const ccomplex_t IT_0322 = -IT_0321;
    const ccomplex_t IT_0323 = 12*IT_0236;
    const ccomplex_t IT_0324 = 24*IT_0255;
    const ccomplex_t IT_0325 = IT_0323 + IT_0324;
    const ccomplex_t IT_0326 = 12*conj(IT_0236);
    const ccomplex_t IT_0327 = 24*conj(IT_0255);
    const ccomplex_t IT_0328 = IT_0326 + IT_0327;
    const ccomplex_t IT_0329 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0330 = IT_0304*IT_0329;
    const ccomplex_t IT_0331 = IT_0307*IT_0329;
    const ccomplex_t IT_0332 = N_d3*conj(N_d4)*e_em;
    const ccomplex_t IT_0333 = IT_0304*IT_0332;
    const ccomplex_t IT_0334 = IT_0307*IT_0332;
    const ccomplex_t IT_0335 = (0 + _Complex_I*1)*(IT_0330 + IT_0331 + 
      -IT_0333 + -IT_0334);
    const ccomplex_t IT_0336 = (-0.5)*IT_0335;
    const ccomplex_t IT_0337 = (0 + _Complex_I*1)*e_em*IT_0002*IT_0010;
    const ccomplex_t IT_0338 = 0.333333333333333*IT_0337;
    const ccomplex_t IT_0339 = IT_0318*IT_0338;
    const ccomplex_t IT_0340 = (0 + _Complex_I*1)*IT_0339;
    const ccomplex_t IT_0341 = IT_0336*IT_0340;
    const ccomplex_t IT_0342 = -IT_0341;
    const ccomplex_t IT_0343 = 12*IT_0153;
    const ccomplex_t IT_0344 = 24*IT_0181;
    const ccomplex_t IT_0345 = IT_0343 + IT_0344;
    const ccomplex_t IT_0346 = 12*conj(IT_0153);
    const ccomplex_t IT_0347 = 24*conj(IT_0181);
    const ccomplex_t IT_0348 = IT_0346 + IT_0347;
    const ccomplex_t IT_0349 = IT_0163*IT_0249;
    const ccomplex_t IT_0350 = IT_0165*IT_0349;
    const ccomplex_t IT_0351 = (0 + _Complex_I*1)*IT_0350;
    const ccomplex_t IT_0352 = IT_0176*IT_0244;
    const ccomplex_t IT_0353 = IT_0178*IT_0352;
    const ccomplex_t IT_0354 = (0 + _Complex_I*1)*IT_0353;
    const ccomplex_t IT_0355 = IT_0351 + IT_0354;
    const ccomplex_t IT_0356 = 6*IT_0355;
    const ccomplex_t IT_0357 = 6*conj(IT_0355);
    const ccomplex_t IT_0358 = 12*IT_0355;
    const ccomplex_t IT_0359 = 12*conj(IT_0355);
    const ccomplex_t IT_0360 = IT_0292*(conj(IT_0299)*IT_0301 + IT_0299
      *IT_0303 + conj(IT_0322)*IT_0325 + IT_0322*IT_0328 + conj(IT_0342)*IT_0345
       + IT_0342*IT_0348 + conj(IT_0236)*IT_0356 + IT_0236*IT_0357 + conj
      (IT_0255)*IT_0358 + IT_0255*IT_0359);
    const ccomplex_t IT_0361 = 12*conj(IT_0281);
    const ccomplex_t IT_0362 = IT_0313*IT_0340;
    const ccomplex_t IT_0363 = -IT_0362;
    const ccomplex_t IT_0364 = 24*conj(IT_0363);
    const ccomplex_t IT_0365 = IT_0361 + IT_0364;
    const ccomplex_t IT_0366 = 12*IT_0274;
    const ccomplex_t IT_0367 = IT_0320*IT_0336;
    const ccomplex_t IT_0368 = -IT_0367;
    const ccomplex_t IT_0369 = 24*IT_0368;
    const ccomplex_t IT_0370 = IT_0366 + IT_0369;
    const ccomplex_t IT_0371 = 12*conj(IT_0274);
    const ccomplex_t IT_0372 = 24*conj(IT_0368);
    const ccomplex_t IT_0373 = IT_0371 + IT_0372;
    const ccomplex_t IT_0374 = 6*IT_0281;
    const ccomplex_t IT_0375 = 6*conj(IT_0281);
    const ccomplex_t IT_0376 = 6*IT_0274;
    const ccomplex_t IT_0377 = 6*conj(IT_0274);
    const ccomplex_t IT_0378 = 12*IT_0281;
    const ccomplex_t IT_0379 = 12*IT_0299;
    const ccomplex_t IT_0380 = 12*conj(IT_0299);
    const ccomplex_t IT_0381 = IT_0359*IT_0363 + IT_0358*conj(IT_0363) +
       IT_0322*IT_0365 + conj(IT_0342)*IT_0370 + IT_0342*IT_0373 + conj(IT_0355)
      *IT_0374 + IT_0355*IT_0375 + conj(IT_0299)*IT_0376 + IT_0299*IT_0377 +
       conj(IT_0322)*(24*IT_0363 + IT_0378) + conj(IT_0368)*IT_0379 + IT_0368
      *IT_0380;
    const ccomplex_t IT_0382 = m_s*s_23*m_N_3;
    const ccomplex_t IT_0383 = conj(IT_0236)*IT_0299 + IT_0236*conj(IT_0299) +
       0.166666666666667*IT_0328*IT_0342 + 0.166666666666667*IT_0325*conj
      (IT_0342) + 0.166666666666667*conj(IT_0322)*IT_0345 + 0.166666666666667
      *IT_0322*IT_0348 + 0.166666666666667*IT_0303*IT_0355 + 0.166666666666667
      *IT_0301*conj(IT_0355) + 0.166666666666667*conj(IT_0255)*IT_0379 +
       0.166666666666667*IT_0255*IT_0380;
    const ccomplex_t IT_0384 = s_34*m_N_3*m_N_4;
    const ccomplex_t IT_0385 = conj(IT_0274)*IT_0356 + IT_0274*IT_0357 +
       IT_0342*IT_0361 + IT_0359*IT_0368 + IT_0358*conj(IT_0368) + conj(IT_0322)
      *IT_0370 + IT_0322*IT_0373 + conj(IT_0299)*IT_0374 + IT_0299*IT_0375 +
       conj(IT_0342)*IT_0378 + conj(IT_0363)*(24*IT_0342 + IT_0379) + IT_0363*
      (24*conj(IT_0342) + IT_0380);
    const ccomplex_t IT_0386 = m_s*s_13*m_N_4;
    const ccomplex_t IT_0387 = 6*IT_0181;
    const ccomplex_t IT_0388 = IT_0343 + IT_0387;
    const ccomplex_t IT_0389 = 6*conj(IT_0181);
    const ccomplex_t IT_0390 = IT_0346 + IT_0389;
    const ccomplex_t IT_0391 = 24*IT_0153;
    const ccomplex_t IT_0392 = IT_0300 + IT_0391;
    const ccomplex_t IT_0393 = 24*conj(IT_0153);
    const ccomplex_t IT_0394 = IT_0302 + IT_0393;
    const ccomplex_t IT_0395 = 12*conj(IT_0255);
    const ccomplex_t IT_0396 = 24*conj(IT_0236);
    const ccomplex_t IT_0397 = IT_0395 + IT_0396;
    const ccomplex_t IT_0398 = 12*IT_0255;
    const ccomplex_t IT_0399 = IT_0386*(IT_0236*IT_0365 + conj(IT_0255)
      *IT_0374 + IT_0255*IT_0375 + conj(IT_0236)*IT_0378 + conj(IT_0274)*IT_0388
       + IT_0274*IT_0390 + conj(IT_0368)*IT_0392 + IT_0368*IT_0394 + IT_0363
      *IT_0397 + conj(IT_0363)*IT_0398);
    const ccomplex_t IT_0400 = m_s*s_24*m_N_3;
    const ccomplex_t IT_0401 = conj(IT_0236)*IT_0366 + IT_0236*(24*conj
      (IT_0368) + IT_0371) + conj(IT_0255)*IT_0376 + IT_0255*IT_0377 + conj
      (IT_0281)*IT_0388 + IT_0281*IT_0390 + conj(IT_0363)*IT_0392 + IT_0363
      *IT_0394 + IT_0368*IT_0397 + conj(IT_0368)*IT_0398;
    const ccomplex_t IT_0402 = 24*IT_0274;
    const ccomplex_t IT_0403 = 48*IT_0368;
    const ccomplex_t IT_0404 = IT_0402 + IT_0403;
    const ccomplex_t IT_0405 = 24*IT_0281;
    const ccomplex_t IT_0406 = 24*conj(IT_0281);
    const ccomplex_t IT_0407 = 24*conj(IT_0274);
    const ccomplex_t IT_0408 = 24*IT_0299;
    const ccomplex_t IT_0409 = 48*IT_0342;
    const ccomplex_t IT_0410 = IT_0408 + IT_0409;
    const ccomplex_t IT_0411 = 24*IT_0355;
    const ccomplex_t IT_0412 = 24*conj(IT_0355);
    const ccomplex_t IT_0413 = 24*conj(IT_0299);
    const ccomplex_t IT_0414 = m_N_3*m_N_4*IT_0083;
    const ccomplex_t IT_0415 = conj(IT_0255)*IT_0301 + IT_0255*IT_0303 + conj
      (IT_0299)*IT_0358 + IT_0299*IT_0359 + IT_0274*IT_0361 + conj(IT_0274)
      *IT_0378 + conj(IT_0236)*IT_0388 + IT_0236*IT_0390 + conj(IT_0363)*IT_0404
       + conj(IT_0368)*IT_0405 + IT_0368*IT_0406 + IT_0363*(48*conj(IT_0368) +
       IT_0407) + conj(IT_0322)*IT_0410 + conj(IT_0342)*IT_0411 + IT_0342
      *IT_0412 + IT_0322*(48*conj(IT_0342) + IT_0413);
    const ccomplex_t IT_0416 = IT_0084*IT_0256;
    const ccomplex_t IT_0417 = 6*IT_0053;
    const ccomplex_t IT_0418 = 6*conj(IT_0053);
    const ccomplex_t IT_0419 = (-6)*IT_0053;
    const ccomplex_t IT_0420 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0421 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0181 + (
      -0.0416666666666667)*IT_0290) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0181) + (-0.0416666666666667)*IT_0291) + (-0.166666666666667)*conj
      (IT_0255)*IT_0417 + (-0.166666666666667)*IT_0255*IT_0418 + (
      -0.166666666666667)*conj(IT_0236)*IT_0419 + (-0.166666666666667)*IT_0236
      *IT_0420;
    const ccomplex_t IT_0422 = s_13 + s_14;
    const ccomplex_t IT_0423 = IT_0263*IT_0422;
    const ccomplex_t IT_0424 = 12*IT_0053;
    const ccomplex_t IT_0425 = 12*conj(IT_0053);
    const ccomplex_t IT_0426 = 12*IT_0082;
    const ccomplex_t IT_0427 = 12*conj(IT_0082);
    const ccomplex_t IT_0428 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0429 = (-12)*IT_0082;
    const ccomplex_t IT_0430 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0431 = (-12)*IT_0053*conj(IT_0368) + (-6)*conj(IT_0082
      )*(IT_0355 + (-0.166666666666667)*IT_0374) + (-6)*IT_0082*(conj(IT_0355) +
       (-0.166666666666667)*IT_0375) + conj(IT_0299)*IT_0417 + IT_0299*IT_0418 +
       conj(IT_0274)*IT_0419 + IT_0274*IT_0420 + conj(IT_0342)*IT_0424 + IT_0342
      *IT_0425 + conj(IT_0363)*IT_0426 + IT_0363*IT_0427 + IT_0368*IT_0428 +
       conj(IT_0322)*IT_0429 + IT_0322*IT_0430;
    const ccomplex_t IT_0432 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0433 = 6*IT_0082;
    const ccomplex_t IT_0434 = 6*conj(IT_0082);
    ...
    const ccomplex_t IT_0439 = (-12)*IT_0053*conj(IT_0363) + conj(IT_0355)
      *IT_0417 + IT_0355*IT_0418 + conj(IT_0281)*IT_0419 + IT_0281*IT_0420 +
       conj(IT_0322)*IT_0424 + IT_0322*IT_0425 + conj(IT_0368)*IT_0426 + IT_0368
      *IT_0427 + IT_0363*IT_0428 + conj(IT_0342)*IT_0429 + IT_0342*IT_0430 +
       conj(IT_0274)*IT_0433 + IT_0274*IT_0434 + conj(IT_0299)*IT_0437 + IT_0299
      *IT_0438;
    const ccomplex_t IT_0440 = IT_0154 + IT_0155 + IT_0157 + IT_0158;
    const ccomplex_t IT_0441 = (-4)*IT_0266;
    const ccomplex_t IT_0442 = conj(IT_0342) + conj(IT_0368);
    const ccomplex_t IT_0443 = (-3)*IT_0130;
    const ccomplex_t IT_0444 = IT_0342 + IT_0368;
    const ccomplex_t IT_0445 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0446 = conj(IT_0322) + conj(IT_0363);
    const ccomplex_t IT_0447 = (-3)*IT_0215;
    const ccomplex_t IT_0448 = (-3)*conj(IT_0215);
    const ccomplex_t IT_0449 = (-2)*IT_0266;
    const ccomplex_t IT_0450 = 2*IT_0287;
    const ccomplex_t IT_0451 = (-2)*IT_0259;
    const ccomplex_t IT_0452 = 4*IT_0287;
    const ccomplex_t IT_0453 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0360 + IT_0154*IT_0381 + 6*IT_0382*IT_0383 + IT_0384
      *IT_0385 + IT_0399 + IT_0400*IT_0401 + IT_0156*(conj(IT_0236)*IT_0323 +
       conj(IT_0153)*IT_0343 + conj(IT_0274)*IT_0366 + conj(IT_0281)*IT_0378 +
       conj(IT_0368)*IT_0404 + conj(IT_0363)*IT_0405 + IT_0363*(48*conj(IT_0363)
       + IT_0406) + IT_0368*IT_0407) + IT_0155*(conj(IT_0181)*IT_0300 + conj
      (IT_0355)*IT_0358 + conj(IT_0299)*IT_0379 + conj(IT_0255)*IT_0398 + conj
      (IT_0342)*IT_0410 + conj(IT_0322)*IT_0411 + IT_0322*(48*conj(IT_0322) +
       IT_0412) + IT_0342*IT_0413) + IT_0414*IT_0415 + (-6)*IT_0416*IT_0421 +
       IT_0423*IT_0431 + IT_0432*(conj(IT_0153)*IT_0419 + IT_0153*IT_0420 + conj
      (IT_0236)*IT_0433 + IT_0236*IT_0434) + IT_0436*IT_0439 + (conj(IT_0181)
      *IT_0417 + IT_0181*IT_0418 + conj(IT_0255)*IT_0437 + IT_0255*IT_0438)
      *IT_0440 + IT_0441*(IT_0442*IT_0443 + IT_0444*IT_0445 + IT_0446*IT_0447 + 
      (IT_0322 + IT_0363)*IT_0448) + (conj(IT_0299)*IT_0443 + IT_0299*IT_0445 +
       conj(IT_0355)*IT_0447 + IT_0355*IT_0448)*IT_0449 + (conj(IT_0355)*IT_0443
       + IT_0355*IT_0445 + conj(IT_0299)*IT_0447 + IT_0299*IT_0448)*IT_0450 + 
      (conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj(IT_0153)*IT_0282 + IT_0153
      *IT_0283 + conj(IT_0255)*IT_0443 + IT_0255*IT_0445 + conj(IT_0181)*IT_0447
       + IT_0181*IT_0448)*IT_0451 + ((IT_0322 + IT_0363)*IT_0445 + IT_0443
      *IT_0446 + IT_0442*IT_0447 + IT_0444*IT_0448)*IT_0452;
