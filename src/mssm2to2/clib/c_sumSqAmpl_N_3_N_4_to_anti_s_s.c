        ...
        )
{
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0011*IT_0027*IT_0028;
    ...
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0385 = m_s*s_24*m_N_3;
    ...
    const ccomplex_t IT_0391 = m_s*s_23*m_N_3;
