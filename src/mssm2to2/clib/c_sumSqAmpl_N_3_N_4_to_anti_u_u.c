...
ccomplex_return_t c_sumSqAmpl_N_3_N_4_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = m_u*e_em*IT_0011*IT_0027;
    ...
    const ccomplex_t IT_0047 = m_u*e_em*IT_0000*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
    ...
    const ccomplex_t IT_0136 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_su_R*
    ...
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0011*IT_0027*IT_0046;
    const ccomplex_t IT_0148 = (-0.5)*IT_0147;
    const ccomplex_t IT_0149 = IT_0146*IT_0148;
    const ccomplex_t IT_0150 = cpow((-2)*s_13 + IT_0031 + IT_0083 + -m_su_L*
    ...
    const ccomplex_t IT_0188 = IT_0054*IT_0095;
    const ccomplex_t IT_0189 = IT_0064*IT_0087;
    const ccomplex_t IT_0190 = IT_0062*IT_0095;
    const ccomplex_t IT_0191 = IT_0187 + IT_0188 + IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = IT_0060*IT_0097;
    const ccomplex_t IT_0193 = IT_0058*IT_0090;
    const ccomplex_t IT_0194 = IT_0068*IT_0097;
    const ccomplex_t IT_0195 = IT_0066*IT_0090;
    ...
    const ccomplex_t IT_0202 = IT_0060*IT_0090;
    const ccomplex_t IT_0203 = IT_0062*IT_0087;
    const ccomplex_t IT_0204 = IT_0068*IT_0090;
    const ccomplex_t IT_0205 = IT_0201 + IT_0202 + IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = IT_0056*IT_0095;
    const ccomplex_t IT_0207 = IT_0058*IT_0097;
    const ccomplex_t IT_0208 = IT_0064*IT_0095;
    const ccomplex_t IT_0209 = IT_0066*IT_0097;
    ...
    const ccomplex_t IT_0218 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0223 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0011*IT_0027*IT_0046;
    ...
    const ccomplex_t IT_0238 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0002;
    ...
    const ccomplex_t IT_0251 = (-0.5)*IT_0218;
    ...
    const ccomplex_t IT_0275 = IT_0146*IT_0232;
    const ccomplex_t IT_0276 = IT_0150*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1)*IT_0276;
    const ccomplex_t IT_0278 = IT_0132*IT_0219;
    const ccomplex_t IT_0279 = IT_0136*IT_0278;
    ...
    const ccomplex_t IT_0284 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0292 = m_u*s_24*m_N_3;
    ...
    const ccomplex_t IT_0310 = (-0.666666666666667)*IT_0309;
    ...
    const ccomplex_t IT_0316 = 12*IT_0181;
    const ccomplex_t IT_0317 = 24*IT_0153;
    const ccomplex_t IT_0318 = IT_0316 + IT_0317;
    const ccomplex_t IT_0319 = 12*conj(IT_0181);
    const ccomplex_t IT_0320 = 24*conj(IT_0153);
    ...
    const ccomplex_t IT_0349 = m_u*s_13*m_N_4;
    const ccomplex_t IT_0350 = 6*IT_0274;
    const ccomplex_t IT_0351 = 6*conj(IT_0274);
    const ccomplex_t IT_0352 = 12*IT_0274;
    const ccomplex_t IT_0353 = 12*conj(IT_0274);
    const ccomplex_t IT_0354 = IT_0349*(conj(IT_0281)*IT_0295 + IT_0281
      *IT_0298 + IT_0321*IT_0337 + IT_0318*conj(IT_0337) + conj(IT_0315)*IT_0340
       + IT_0315*IT_0343 + conj(IT_0255)*IT_0350 + IT_0255*IT_0351 + conj
      (IT_0236)*IT_0352 + IT_0236*IT_0353);
    const ccomplex_t IT_0355 = s_34*m_N_3*m_N_4;
    const ccomplex_t IT_0356 = IT_0313*IT_0329;
    const ccomplex_t IT_0357 = -IT_0356;
    const ccomplex_t IT_0358 = 24*conj(IT_0315);
    const ccomplex_t IT_0359 = IT_0353 + IT_0358;
    const ccomplex_t IT_0360 = IT_0308*IT_0335;
    const ccomplex_t IT_0361 = -IT_0360;
    const ccomplex_t IT_0362 = 24*IT_0337;
    const ccomplex_t IT_0363 = IT_0346 + IT_0362;
    const ccomplex_t IT_0364 = 24*conj(IT_0337);
    const ccomplex_t IT_0365 = IT_0347 + IT_0364;
    const ccomplex_t IT_0366 = IT_0162*IT_0239;
    const ccomplex_t IT_0367 = IT_0165*IT_0366;
    const ccomplex_t IT_0368 = (0 + _Complex_I*1)*IT_0367;
    const ccomplex_t IT_0369 = IT_0168*IT_0251;
    const ccomplex_t IT_0370 = IT_0178*IT_0369;
    ...
    const ccomplex_t IT_0382 = 12*IT_0372;
    const ccomplex_t IT_0383 = 12*conj(IT_0372);
    const ccomplex_t IT_0384 = 12*IT_0379;
    const ccomplex_t IT_0385 = 12*conj(IT_0379);
    const ccomplex_t IT_0386 = (24*IT_0315 + IT_0352)*conj(IT_0357) + IT_0357
      *IT_0359 + conj(IT_0361)*IT_0363 + IT_0361*IT_0365 + IT_0351*IT_0372 +
       IT_0350*conj(IT_0372) + conj(IT_0281)*IT_0380 + IT_0281*IT_0381 + conj
      (IT_0315)*IT_0382 + IT_0315*IT_0383 + conj(IT_0337)*IT_0384 + IT_0337
      *IT_0385;
    const ccomplex_t IT_0387 = IT_0359*IT_0361 + (24*IT_0315 + IT_0352)*conj
      (IT_0361) + conj(IT_0357)*IT_0363 + IT_0357*IT_0365 + IT_0345*IT_0372 +
       IT_0344*conj(IT_0372) + IT_0351*IT_0379 + IT_0350*conj(IT_0379) + conj
      (IT_0337)*IT_0382 + IT_0337*IT_0383 + conj(IT_0315)*IT_0384 + IT_0315
      *IT_0385;
    const ccomplex_t IT_0388 = m_u*s_14*m_N_4;
    const ccomplex_t IT_0389 = IT_0290 + IT_0316;
    const ccomplex_t IT_0390 = IT_0291 + IT_0319;
    const ccomplex_t IT_0391 = 24*conj(IT_0181);
    const ccomplex_t IT_0392 = IT_0297 + IT_0391;
    const ccomplex_t IT_0393 = 12*IT_0236;
    const ccomplex_t IT_0394 = 24*IT_0255;
    const ccomplex_t IT_0395 = IT_0393 + IT_0394;
    const ccomplex_t IT_0396 = 12*conj(IT_0236);
    const ccomplex_t IT_0397 = 24*conj(IT_0255);
    const ccomplex_t IT_0398 = IT_0396 + IT_0397;
    const ccomplex_t IT_0399 = (24*IT_0181 + IT_0294)*conj(IT_0357) + conj
      (IT_0236)*IT_0380 + IT_0236*IT_0381 + conj(IT_0255)*IT_0384 + IT_0255
      *IT_0385 + conj(IT_0372)*IT_0389 + IT_0372*IT_0390 + IT_0357*IT_0392 +
       conj(IT_0361)*IT_0395 + IT_0361*IT_0398;
    const ccomplex_t IT_0400 = m_u*s_23*m_N_3;
    const ccomplex_t IT_0401 = 0.166666666666667*(24*IT_0181 + IT_0294)*conj
      (IT_0361) + conj(IT_0236)*IT_0372 + IT_0236*conj(IT_0372) +
       0.166666666666667*conj(IT_0255)*IT_0382 + 0.166666666666667*IT_0255
      *IT_0383 + 0.166666666666667*conj(IT_0379)*IT_0389 + 0.166666666666667
      *IT_0379*IT_0390 + 0.166666666666667*IT_0361*IT_0392 + 0.166666666666667
      *conj(IT_0357)*IT_0395 + 0.166666666666667*IT_0357*IT_0398;
    const ccomplex_t IT_0402 = 24*conj(IT_0274);
    const ccomplex_t IT_0403 = 48*conj(IT_0315);
    ...
    const ccomplex_t IT_0408 = m_N_3*m_N_4*IT_0083;
    const ccomplex_t IT_0409 = 24*IT_0372;
    const ccomplex_t IT_0410 = 48*IT_0357;
    const ccomplex_t IT_0411 = IT_0409 + IT_0410;
    const ccomplex_t IT_0412 = 24*conj(IT_0372);
    const ccomplex_t IT_0413 = 24*IT_0379;
    const ccomplex_t IT_0414 = 24*conj(IT_0379);
    const ccomplex_t IT_0415 = conj(IT_0236)*IT_0295 + IT_0236*IT_0298 + conj
      (IT_0281)*IT_0352 + IT_0281*IT_0353 + conj(IT_0372)*IT_0384 + IT_0372
      *IT_0385 + conj(IT_0255)*IT_0389 + IT_0255*IT_0390 + IT_0337*IT_0404 +
       conj(IT_0315)*IT_0405 + IT_0315*IT_0406 + conj(IT_0337)*(48*IT_0315 +
       IT_0407) + conj(IT_0361)*IT_0411 + IT_0361*IT_0412 + conj(IT_0357)*(48
      *IT_0361 + IT_0413) + IT_0357*IT_0414;
    const ccomplex_t IT_0416 = s_13 + s_14;
    const ccomplex_t IT_0417 = IT_0284*IT_0416;
    const ccomplex_t IT_0418 = 6*IT_0053;
    const ccomplex_t IT_0419 = 6*conj(IT_0053);
    const ccomplex_t IT_0420 = 12*IT_0053;
    const ccomplex_t IT_0421 = 12*conj(IT_0053);
    const ccomplex_t IT_0422 = 12*IT_0082;
    const ccomplex_t IT_0423 = 12*conj(IT_0082);
    const ccomplex_t IT_0424 = (-12)*conj(IT_0053);
    const ccomplex_t IT_0425 = (-12)*IT_0082;
    const ccomplex_t IT_0426 = (-12)*conj(IT_0082);
    const ccomplex_t IT_0427 = (-6)*IT_0053;
    const ccomplex_t IT_0428 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0429 = (-12)*IT_0053*conj(IT_0337) + (-6)*conj(IT_0082
      )*((-0.166666666666667)*IT_0350 + IT_0379) + (-6)*IT_0082*((
      -0.166666666666667)*IT_0351 + conj(IT_0379)) + conj(IT_0372)*IT_0418 +
       IT_0372*IT_0419 + conj(IT_0357)*IT_0420 + IT_0357*IT_0421 + conj(IT_0315)
      *IT_0422 + IT_0315*IT_0423 + IT_0337*IT_0424 + conj(IT_0361)*IT_0425 +
       IT_0361*IT_0426 + conj(IT_0281)*IT_0427 + IT_0281*IT_0428;
    const ccomplex_t IT_0430 = IT_0154 + IT_0156 + IT_0158 + IT_0182;
    const ccomplex_t IT_0431 = 6*IT_0082;
    const ccomplex_t IT_0432 = 6*conj(IT_0082);
    const ccomplex_t IT_0433 = IT_0084*IT_0256;
    const ccomplex_t IT_0434 = 4*conj(IT_0082)*(IT_0053 + 1./4*IT_0181 + (
      -0.0416666666666667)*IT_0290) + 4*IT_0082*(conj(IT_0053) + 1./4*conj
      (IT_0181) + (-0.0416666666666667)*IT_0291) + (-0.166666666666667)*conj
      (IT_0255)*IT_0418 + (-0.166666666666667)*IT_0255*IT_0419 + (
      -0.166666666666667)*conj(IT_0236)*IT_0427 + (-0.166666666666667)*IT_0236
      *IT_0428;
    const ccomplex_t IT_0435 = s_23 + s_24;
    const ccomplex_t IT_0436 = IT_0263*IT_0435;
    const ccomplex_t IT_0437 = (-6)*IT_0082;
    const ccomplex_t IT_0438 = (-6)*conj(IT_0082);
    const ccomplex_t IT_0439 = (-12)*IT_0053*conj(IT_0315) + conj(IT_0379)
      *IT_0418 + IT_0379*IT_0419 + conj(IT_0361)*IT_0420 + IT_0361*IT_0421 +
       conj(IT_0337)*IT_0422 + IT_0337*IT_0423 + IT_0315*IT_0424 + conj(IT_0357)
      *IT_0425 + IT_0357*IT_0426 + conj(IT_0274)*IT_0427 + IT_0274*IT_0428 +
       conj(IT_0281)*IT_0431 + IT_0281*IT_0432 + conj(IT_0372)*IT_0437 + IT_0372
      *IT_0438;
    ...
    const ccomplex_t IT_0448 = 4*IT_0266;
    const ccomplex_t IT_0449 = conj(IT_0315) + conj(IT_0361);
    const ccomplex_t IT_0450 = IT_0315 + IT_0361;
    const ccomplex_t IT_0451 = conj(IT_0337) + conj(IT_0357);
    const ccomplex_t IT_0452 = IT_0337 + IT_0357;
    const ccomplex_t IT_0453 = (-4)*IT_0287;
    const ccomplex_t IT_0454 = (24*IT_0053*conj(IT_0053) + 24*IT_0082*conj
      ...
      *IT_0291) + IT_0348 + IT_0354 + IT_0355*IT_0386 + IT_0154*IT_0387 +
       IT_0388*IT_0399 + 6*IT_0400*IT_0401 + IT_0156*(conj(IT_0153)*IT_0294 +
       conj(IT_0281)*IT_0346 + conj(IT_0274)*IT_0352 + conj(IT_0236)*IT_0393 +
       IT_0315*IT_0404 + conj(IT_0337)*IT_0405 + IT_0337*(48*conj(IT_0337) +
       IT_0406) + conj(IT_0315)*IT_0407) + IT_0155*(conj(IT_0181)*IT_0316 + conj
      (IT_0255)*IT_0338 + conj(IT_0372)*IT_0382 + conj(IT_0379)*IT_0384 + conj
      (IT_0357)*IT_0411 + IT_0357*IT_0412 + conj(IT_0361)*IT_0413 + IT_0361*(48
      *conj(IT_0361) + IT_0414)) + IT_0408*IT_0415 + IT_0417*IT_0429 + IT_0430*
      (conj(IT_0153)*IT_0427 + IT_0153*IT_0428 + conj(IT_0236)*IT_0431 + IT_0236
      *IT_0432) + (-6)*IT_0433*IT_0434 + IT_0436*IT_0439 + (conj(IT_0181)
      *IT_0418 + IT_0181*IT_0419 + conj(IT_0255)*IT_0437 + IT_0255*IT_0438)
      *IT_0440 + IT_0441*(conj(IT_0236)*IT_0261 + IT_0236*IT_0262 + conj(IT_0153
      )*IT_0282 + IT_0153*IT_0283 + conj(IT_0255)*IT_0442 + IT_0255*IT_0443 +
       conj(IT_0181)*IT_0444 + IT_0181*IT_0445) + (conj(IT_0379)*IT_0442 +
       IT_0379*IT_0443 + conj(IT_0372)*IT_0444 + IT_0372*IT_0445)*IT_0446 + 
      (conj(IT_0372)*IT_0442 + IT_0372*IT_0443 + conj(IT_0379)*IT_0444 + IT_0379
      *IT_0445)*IT_0447 + IT_0448*(IT_0442*IT_0449 + IT_0443*IT_0450 + IT_0444
      *IT_0451 + IT_0445*IT_0452) + (IT_0444*IT_0449 + IT_0445*IT_0450 + IT_0442
      *IT_0451 + IT_0443*IT_0452)*IT_0453;
    return create_ccomplex_return(IT_0454);
}
