...
ccomplex_return_t c_sumSqAmpl_N_3_sG_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0044;
    ...
    const ccomplex_t IT_0083 = m_sG*s_34*m_N_3;
    ...
    const ccomplex_t IT_0094 = m_c*s_23*m_N_3;
    const ccomplex_t IT_0095 = m_c*m_sG*s_13;
    const ccomplex_t IT_0096 = 16*IT_0061;
    const ccomplex_t IT_0097 = 16*conj(IT_0061);
    const ccomplex_t IT_0098 = 16*IT_0080;
    const ccomplex_t IT_0099 = 16*conj(IT_0080);
    const ccomplex_t IT_0100 = m_c*s_24*m_N_3;
    const ccomplex_t IT_0101 = 16*IT_0018;
    const ccomplex_t IT_0102 = 16*IT_0049;
    const ccomplex_t IT_0103 = 16*IT_0074;
    const ccomplex_t IT_0104 = m_sG*m_N_3*IT_0014;
    const ccomplex_t IT_0105 = (16*conj(IT_0018) + IT_0027)*IT_0033 + conj
      (IT_0018)*IT_0040 + IT_0018*IT_0041 + conj(IT_0039)*IT_0088 + IT_0039
      *IT_0091 + conj(IT_0080)*IT_0096 + IT_0080*IT_0097 + conj(IT_0033)*
      (IT_0026 + IT_0101) + conj(IT_0074)*IT_0102 + conj(IT_0049)*IT_0103;
    const ccomplex_t IT_0106 = IT_0004*(conj(IT_0018)*IT_0026 + IT_0018
      *IT_0027 + conj(IT_0033)*IT_0040 + IT_0033*IT_0041) + IT_0042*(conj
      (IT_0049)*IT_0062 + IT_0049*IT_0063 + conj(IT_0074)*IT_0081 + IT_0074
      *IT_0082) + (IT_0063*IT_0074 + IT_0062*conj(IT_0074) + conj(IT_0049)
      *IT_0081 + IT_0049*IT_0082)*IT_0083 + 8*IT_0084*(IT_0074*IT_0086 + 0.125
      *conj(IT_0049)*IT_0089 + 0.125*IT_0049*IT_0092 + conj(IT_0074)*(IT_0033 +
       0.125*IT_0093)) + 8*(IT_0049*IT_0086 + 0.125*conj(IT_0074)*IT_0089 +
       0.125*IT_0074*IT_0092 + conj(IT_0049)*(IT_0033 + 0.125*IT_0093))*IT_0094 
      + IT_0095*(IT_0027*IT_0061 + IT_0026*conj(IT_0061) + conj(IT_0039)*IT_0081
       + IT_0039*IT_0082 + conj(IT_0018)*IT_0096 + IT_0018*IT_0097 + conj
      (IT_0033)*IT_0098 + IT_0033*IT_0099) + (conj(IT_0039)*IT_0062 + IT_0039
      *IT_0063 + IT_0027*IT_0080 + IT_0026*conj(IT_0080) + conj(IT_0033)*IT_0096
       + IT_0033*IT_0097 + conj(IT_0018)*IT_0098 + IT_0018*IT_0099)*IT_0100 +
       IT_0001*(16*IT_0033*conj(IT_0033) + conj(IT_0061)*IT_0096 + conj(IT_0080)
      *IT_0098 + conj(IT_0018)*IT_0101) + IT_0000*(conj(IT_0025)*IT_0088 + conj
      (IT_0039)*IT_0093 + conj(IT_0049)*IT_0102 + conj(IT_0074)*IT_0103) +
       IT_0104*IT_0105;
