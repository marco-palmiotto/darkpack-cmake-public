        ...
        )
{
    ...
    const ccomplex_t IT_0007 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_sc_R*
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0005 + IT_0019 + -m_sc_L*
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0005 + IT_0019 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0083 = s_12*IT_0005;
