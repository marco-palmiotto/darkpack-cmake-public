...
ccomplex_return_t c_sumSqAmpl_N_3_sG_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_sd_L*
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0084 = m_d*s_23*m_N_3;
    ...
    const ccomplex_t IT_0094 = m_d*m_sG*s_14;
    const ccomplex_t IT_0095 = m_d*s_24*m_N_3;
    ...
    const ccomplex_t IT_0100 = m_d*m_sG*s_13;
