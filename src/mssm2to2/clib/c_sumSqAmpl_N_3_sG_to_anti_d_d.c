        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_13 + IT_0014 + IT_0022 + -m_sd_L*
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0014 + IT_0022 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (-0.5)*IT_0027;
    const ccomplex_t IT_0034 = IT_0005*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0083 = m_d*s_23*m_N_3;
    ...
    const ccomplex_t IT_0093 = m_d*m_sG*s_14;
    const ccomplex_t IT_0094 = m_d*s_24*m_N_3;
    ...
    const ccomplex_t IT_0099 = m_d*m_sG*s_13;
