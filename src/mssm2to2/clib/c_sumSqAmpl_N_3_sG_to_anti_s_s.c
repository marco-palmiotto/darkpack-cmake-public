...
ccomplex_return_t c_sumSqAmpl_N_3_sG_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_ss_L*
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0008*IT_0010;
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = IT_0005*IT_0029;
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0014 + IT_0021 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0042 = m_sG*s_34*m_N_3;
    ...
    const ccomplex_t IT_0069 = 8*conj(IT_0067);
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0044;
    ...
    const ccomplex_t IT_0084 = m_s*s_23*m_N_3;
    ...
    const ccomplex_t IT_0094 = m_s*m_sG*s_14;
    const ccomplex_t IT_0095 = m_s*s_24*m_N_3;
    const ccomplex_t IT_0096 = 16*IT_0067;
    const ccomplex_t IT_0097 = 16*conj(IT_0067);
    const ccomplex_t IT_0098 = 16*IT_0080;
    const ccomplex_t IT_0099 = 16*conj(IT_0080);
    const ccomplex_t IT_0100 = m_s*m_sG*s_13;
    const ccomplex_t IT_0101 = 16*IT_0074;
    const ccomplex_t IT_0102 = 16*IT_0018;
    const ccomplex_t IT_0103 = 16*IT_0033;
    const ccomplex_t IT_0104 = m_sG*m_N_3*IT_0014;
    const ccomplex_t IT_0105 = IT_0027*IT_0033 + IT_0018*IT_0041 + 16*IT_0055
      *conj(IT_0074) + conj(IT_0039)*IT_0088 + IT_0039*IT_0091 + conj(IT_0080)
      *IT_0096 + IT_0080*IT_0097 + conj(IT_0055)*IT_0101 + conj(IT_0033)*
    ...
    const ccomplex_t IT_0106 = IT_0004*(conj(IT_0018)*IT_0026 + IT_0018
      *IT_0027 + conj(IT_0033)*IT_0040 + IT_0033*IT_0041) + IT_0042*(conj
      (IT_0055)*IT_0068 + IT_0055*IT_0069 + conj(IT_0074)*IT_0081 + IT_0074
      *IT_0082) + (IT_0069*IT_0074 + IT_0068*conj(IT_0074) + conj(IT_0055)
      *IT_0081 + IT_0055*IT_0082)*IT_0083 + 8*IT_0084*(IT_0074*IT_0086 + 0.125
      *conj(IT_0055)*IT_0089 + 0.125*IT_0055*IT_0092 + conj(IT_0074)*(IT_0033 +
       0.125*IT_0093)) + 8*(IT_0055*IT_0086 + 0.125*conj(IT_0074)*IT_0089 +
       0.125*IT_0074*IT_0092 + conj(IT_0055)*(IT_0033 + 0.125*IT_0093))*IT_0094 
      + IT_0095*(conj(IT_0039)*IT_0068 + IT_0039*IT_0069 + IT_0027*IT_0080 +
       IT_0026*conj(IT_0080) + conj(IT_0033)*IT_0096 + IT_0033*IT_0097 + conj
      (IT_0018)*IT_0098 + IT_0018*IT_0099) + (IT_0027*IT_0067 + IT_0026*conj
      (IT_0067) + conj(IT_0039)*IT_0081 + IT_0039*IT_0082 + conj(IT_0018)
      *IT_0096 + IT_0018*IT_0097 + conj(IT_0033)*IT_0098 + IT_0033*IT_0099)
      *IT_0100 + IT_0000*(16*IT_0055*conj(IT_0055) + conj(IT_0025)*IT_0088 +
       conj(IT_0039)*IT_0093 + conj(IT_0074)*IT_0101) + IT_0001*(conj(IT_0067)
