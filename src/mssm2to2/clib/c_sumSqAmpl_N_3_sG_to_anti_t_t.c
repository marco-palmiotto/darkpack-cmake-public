...
ccomplex_return_t c_sumSqAmpl_N_3_sG_to_anti_t_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = m_t*conj(N_u3)*e_em*IT_0019*U_st_10;
    ...
    const ccomplex_t IT_0048 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0049 = IT_0007*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = m_t*conj(N_u3)*e_em*IT_0019*conj(U_st_00);
    ...
    const ccomplex_t IT_0111 = m_t*N_u3*e_em*IT_0019*U_st_00;
    ...
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_01);
    const ccomplex_t IT_0120 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0121 = IT_0007*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = m_t*N_u3*e_em*IT_0019*U_st_01;
    ...
    const ccomplex_t IT_0134 = m_sG*s_34*m_N_3;
    ...
    const ccomplex_t IT_0138 = IT_0069*IT_0102;
    const ccomplex_t IT_0139 = IT_0072*IT_0138;
    ...
    const ccomplex_t IT_0161 = IT_0070*IT_0101;
    ...
    const ccomplex_t IT_0170 = m_t*s_23*m_N_3;
    ...
    const ccomplex_t IT_0179 = m_sG*m_N_3*IT_0026;
    ...
    const ccomplex_t IT_0186 = m_t*s_24*m_N_3;
    const ccomplex_t IT_0187 = 16*IT_0157;
    const ccomplex_t IT_0188 = m_t*m_sG*s_14;
    const ccomplex_t IT_0189 = 16*IT_0141;
    ...
    const ccomplex_t IT_0191 = 8*IT_0004*(conj(IT_0047)*IT_0075 + IT_0047*conj
      ...
      *IT_0168 + IT_0075*IT_0169 + conj(IT_0148)*IT_0173 + IT_0148*IT_0176 +
       conj(IT_0047)*IT_0187)*IT_0188 + IT_0001*(16*IT_0075*conj(IT_0075) + conj
      (IT_0106)*IT_0180 + conj(IT_0164)*IT_0184 + conj(IT_0141)*IT_0189) + 8*
      (conj(IT_0047)*IT_0141 + (IT_0047 + 2*IT_0075)*conj(IT_0141) + 0.125*conj
      (IT_0164)*IT_0181 + 0.125*IT_0164*IT_0183 + 0.125*conj(IT_0075)*IT_0189)
      *IT_0190;
