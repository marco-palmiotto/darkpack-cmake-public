...
ccomplex_return_t c_sumSqAmpl_N_3_sG_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_su_R*
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0005 + IT_0019 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0021 = (-0.5)*IT_0014;
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0005 + IT_0019 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0035 = 0.5*IT_0029;
    ...
    const ccomplex_t IT_0042 = s_12*IT_0005;
    ...
    const ccomplex_t IT_0084 = m_u*m_sG*s_14;
    ...
    const ccomplex_t IT_0094 = m_u*s_23*m_N_3;
    const ccomplex_t IT_0095 = m_u*s_24*m_N_3;
    ...
    const ccomplex_t IT_0100 = m_u*m_sG*s_13;
    const ccomplex_t IT_0101 = 16*IT_0049;
    const ccomplex_t IT_0102 = 16*IT_0018;
    const ccomplex_t IT_0103 = 16*IT_0033;
    const ccomplex_t IT_0104 = m_sG*m_N_3*IT_0005;
    const ccomplex_t IT_0105 = IT_0027*IT_0033 + IT_0018*IT_0041 + 16*conj
      (IT_0049)*IT_0074 + conj(IT_0039)*IT_0088 + IT_0039*IT_0091 + conj(IT_0080
      )*IT_0096 + IT_0080*IT_0097 + conj(IT_0074)*IT_0101 + conj(IT_0033)*
    ...
    const ccomplex_t IT_0106 = IT_0004*(conj(IT_0018)*IT_0026 + IT_0018
      ...
      *conj(IT_0049)*IT_0089 + 0.125*IT_0049*IT_0092 + conj(IT_0074)*(IT_0033 +
      ...
      + IT_0095*(conj(IT_0039)*IT_0062 + IT_0039*IT_0063 + IT_0027*IT_0080 +
       IT_0026*conj(IT_0080) + conj(IT_0033)*IT_0096 + IT_0033*IT_0097 + conj
      (IT_0018)*IT_0098 + IT_0018*IT_0099) + (IT_0027*IT_0061 + IT_0026*conj
      (IT_0061) + conj(IT_0039)*IT_0081 + IT_0039*IT_0082 + conj(IT_0018)
      *IT_0096 + IT_0018*IT_0097 + conj(IT_0033)*IT_0098 + IT_0033*IT_0099)
      *IT_0100 + IT_0000*(16*IT_0074*conj(IT_0074) + conj(IT_0025)*IT_0088 +
       conj(IT_0039)*IT_0093 + conj(IT_0049)*IT_0101) + IT_0001*(conj(IT_0061)
