        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_su_R*
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_13 + IT_0014 + IT_0022 + -m_su_L*
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0014 + IT_0022 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (-0.5)*IT_0027;
    const ccomplex_t IT_0034 = IT_0005*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    ...
    const ccomplex_t IT_0041 = m_sG*s_34*m_N_3;
    ...
    const ccomplex_t IT_0083 = m_u*s_23*m_N_3;
    ...
    const ccomplex_t IT_0093 = m_u*m_sG*s_14;
    const ccomplex_t IT_0094 = m_u*m_sG*s_13;
    ...
    const ccomplex_t IT_0099 = m_u*s_24*m_N_3;
    const ccomplex_t IT_0100 = 16*IT_0073;
    const ccomplex_t IT_0101 = 16*IT_0032;
    const ccomplex_t IT_0102 = m_sG*m_N_3*IT_0014;
    ...
    const ccomplex_t IT_0104 = 8*IT_0004*(IT_0019*conj(IT_0025) + 0.125
      ...
      *IT_0088 + 0.125*IT_0073*IT_0091 + conj(IT_0054)*(IT_0025 + 0.125*IT_0092)
      )*IT_0093 + IT_0094*(IT_0040*IT_0066 + IT_0039*conj(IT_0066) + conj
      (IT_0019)*IT_0080 + IT_0019*IT_0081 + conj(IT_0032)*IT_0095 + IT_0032
      *IT_0096 + conj(IT_0025)*IT_0097 + IT_0025*IT_0098) + (conj(IT_0019)
      *IT_0067 + IT_0019*IT_0068 + IT_0040*IT_0079 + IT_0039*conj(IT_0079) +
       conj(IT_0025)*IT_0095 + IT_0025*IT_0096 + conj(IT_0032)*IT_0097 + IT_0032
      *IT_0098)*IT_0099 + IT_0000*(16*IT_0054*conj(IT_0054) + conj(IT_0038)
      *IT_0087 + conj(IT_0019)*IT_0092 + conj(IT_0073)*IT_0100) + IT_0001*(16
      *IT_0025*conj(IT_0025) + conj(IT_0066)*IT_0095 + conj(IT_0079)*IT_0097 +
       conj(IT_0032)*IT_0101) + IT_0102*IT_0103;
