        ...
        )
{
    ...
    const ccomplex_t IT_0031 = m_b*conj(N_d3)*e_em*IT_0016*U_sb_10;
    ...
    const ccomplex_t IT_0057 = m_b*s_14*m_N_3;
    ...
    const ccomplex_t IT_0069 = m_b*m_N_3;
    ...
    const ccomplex_t IT_0074 = m_b*s_34*m_N_3;
