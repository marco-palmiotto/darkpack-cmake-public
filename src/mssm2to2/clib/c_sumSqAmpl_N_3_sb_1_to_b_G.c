        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_B3*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0016 = m_b*N_d3*e_em*IT_0015*U_sb_00;
    ...
    const ccomplex_t IT_0030 = m_b*conj(N_d3)*e_em*IT_0015*U_sb_10;
    const ccomplex_t IT_0031 = IT_0014*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0056 = m_b*s_14*m_N_3;
    ...
    const ccomplex_t IT_0068 = m_b*m_N_3;
    ...
    const ccomplex_t IT_0073 = m_b*s_34*m_N_3;
