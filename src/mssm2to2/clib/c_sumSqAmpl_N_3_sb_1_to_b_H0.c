        ...
        )
{
    ...
    const ccomplex_t IT_0075 = cpow(V_tb, 2);
    const ccomplex_t IT_0076 = m_b*mu_h*IT_0010;
    const ccomplex_t IT_0077 = sin(beta);
    const ccomplex_t IT_0078 = -IT_0025*IT_0077;
    const ccomplex_t IT_0079 = IT_0005*IT_0021;
    const ccomplex_t IT_0080 = IT_0078 + IT_0079;
    const ccomplex_t IT_0081 = cpow(IT_0000, -2);
    const ccomplex_t IT_0082 = (-2)*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0021 + (-0.5)*m_W*IT_0080*(IT_0008 + 1./3*IT_0007*IT_0081))*conj
      (U_sb_00) + -1./2*IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_10)) + U_sb_10
      *(IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_00) + (-2)*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0080*IT_0081)*conj(U_sb_10
      ));
    const ccomplex_t IT_0083 = (0 + _Complex_I*-1)*(e_em*IT_0082 + (
      -1.4142135623731)*A_b*IT_0021*IT_0075*(conj(U_sb_00)*U_sb_10 + U_sb_00
      *conj(U_sb_10)));
    ...
    const ccomplex_t IT_0088 = m_b*N_d3*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0016 + IT_0073 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0097 = (-2)*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0021 + (-0.5)*m_W*IT_0080*(IT_0008 + 1./3*IT_0007*IT_0081))*conj
      (U_sb_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_11)) + U_sb_10
      *(IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_01) + (-2)*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0080*IT_0081)*conj(U_sb_11
      ));
    const ccomplex_t IT_0098 = (0 + _Complex_I*-1)*(e_em*IT_0097 + (
      -1.4142135623731)*A_b*IT_0021*IT_0075*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0099 = (-0.5)*IT_0098;
    const ccomplex_t IT_0100 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0101 = IT_0001*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = m_b*N_d3*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0073 
      + -reg_prop, -1);
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_b*e_em*IT_0006*IT_0008
      *IT_0010*IT_0021;
    ...
    const ccomplex_t IT_0128 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0129 = IT_0022*IT_0128;
    const ccomplex_t IT_0130 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0131 = IT_0034*IT_0130;
    const ccomplex_t IT_0132 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0133 = IT_0037*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0165 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0166 = IT_0022*IT_0165;
    const ccomplex_t IT_0167 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0168 = IT_0026*IT_0167;
    const ccomplex_t IT_0169 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0170 = IT_0022*IT_0169;
    const ccomplex_t IT_0171 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0172 = IT_0026*IT_0171;
    const ccomplex_t IT_0173 = IT_0166 + IT_0168 + IT_0170 + IT_0172;
    const ccomplex_t IT_0174 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0175 = IT_0034*IT_0174;
    const ccomplex_t IT_0176 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0177 = IT_0037*IT_0176;
    const ccomplex_t IT_0178 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0179 = IT_0034*IT_0178;
    const ccomplex_t IT_0180 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0188 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0189 = IT_0001*IT_0188;
    const ccomplex_t IT_0190 = 1.4142135623731*IT_0189;
    const ccomplex_t IT_0191 = m_b*N_d1*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0203 = m_b*N_d4*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0208 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_4*
    ...
    const ccomplex_t IT_0237 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0238 = IT_0022*IT_0237;
    const ccomplex_t IT_0239 = conj(N_W4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0244 = conj(N_W3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0248 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0257 = IT_0072 + IT_0095 + IT_0110 + (-2)*IT_0117 +
       IT_0142 + IT_0199 + IT_0256;
    const ccomplex_t IT_0258 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0259 = IT_0001*IT_0258;
    const ccomplex_t IT_0260 = 1.4142135623731*IT_0259;
    const ccomplex_t IT_0261 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0262 = IT_0008*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = m_b*conj(N_d3)*e_em*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0269 = (-2)*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0021 + (-0.5)*m_W*IT_0080*(IT_0008 + 1./3*IT_0007*IT_0081))*conj
      (U_sb_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_11)) + U_sb_10
      *(IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_01) + (-2)*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0080*IT_0081)*conj(U_sb_11
      ));
    const ccomplex_t IT_0270 = (0 + _Complex_I*-1)*(e_em*IT_0269 + (
      -1.4142135623731)*A_b*IT_0021*IT_0075*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*(IT_0277 + -IT_0280 +
       0.333333333333333*IT_0283);
    const ccomplex_t IT_0285 = 3*IT_0284;
    const ccomplex_t IT_0286 = 0.166666666666667*IT_0285;
    const ccomplex_t IT_0287 = (-2)*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0021 + (-0.5)*m_W*IT_0080*(IT_0008 + 1./3*IT_0007*IT_0081))*conj
      (U_sb_00) + -1./2*IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_10)) + U_sb_10
      *(IT_0006*IT_0008*IT_0025*IT_0076*conj(U_sb_00) + (-2)*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0021 + -1./3*m_W*IT_0007*IT_0080*IT_0081)*conj(U_sb_10
    ...
    const ccomplex_t IT_0312 = (0 + _Complex_I*1)*(IT_0305 + 0.333333333333333
      *IT_0308 + -IT_0311);
    ...
    const ccomplex_t IT_0317 = IT_0302*IT_0316;
    const ccomplex_t IT_0318 = m_N_3*IT_0047;
    const ccomplex_t IT_0319 = m_N_2*IT_0069;
    const ccomplex_t IT_0320 = IT_0318 + IT_0319;
    const ccomplex_t IT_0321 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0322 = IT_0009*IT_0321;
    const ccomplex_t IT_0323 = 1.4142135623731*IT_0322;
    const ccomplex_t IT_0324 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0328 = IT_0008*IT_0327;
    const ccomplex_t IT_0329 = 1.4142135623731*IT_0328;
    const ccomplex_t IT_0330 = (0 + _Complex_I*1)*(IT_0323 + 0.333333333333333
      *IT_0326 + -IT_0329);
    ...
    const ccomplex_t IT_0336 = m_N_3*IT_0231;
    const ccomplex_t IT_0337 = m_N_4*IT_0253;
    const ccomplex_t IT_0338 = IT_0336 + IT_0337;
    const ccomplex_t IT_0339 = m_b*conj(N_d4)*e_em*IT_0010*U_sb_10;
    ...
    const ccomplex_t IT_0345 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0346 = IT_0008*IT_0345;
    const ccomplex_t IT_0347 = 1.4142135623731*IT_0346;
    const ccomplex_t IT_0348 = (0 + _Complex_I*1)*(IT_0341 + 0.333333333333333
      *IT_0344 + -IT_0347);
    const ccomplex_t IT_0349 = 3*IT_0348;
    const ccomplex_t IT_0350 = 0.166666666666667*IT_0349;
    const ccomplex_t IT_0351 = IT_0208*IT_0350;
    const ccomplex_t IT_0352 = (0 + _Complex_I*1)*IT_0351;
    const ccomplex_t IT_0353 = IT_0338*IT_0352;
    const ccomplex_t IT_0354 = -IT_0274 + -IT_0292 + 2*IT_0296 + -IT_0299 + 
      -IT_0317 + -IT_0335 + -IT_0353;
    const ccomplex_t IT_0355 = 6*s_13;
    const ccomplex_t IT_0356 = m_b*m_N_3;
    const ccomplex_t IT_0357 = 6*IT_0257;
    const ccomplex_t IT_0358 = IT_0163*IT_0316;
    const ccomplex_t IT_0359 = IT_0231*IT_0352;
    const ccomplex_t IT_0360 = IT_0126*IT_0298;
    const ccomplex_t IT_0361 = IT_0047*IT_0334;
    const ccomplex_t IT_0362 = -IT_0116 + IT_0358 + IT_0359 + IT_0360 + IT_0361;
    const ccomplex_t IT_0363 = m_b*s_14;
    const ccomplex_t IT_0364 = IT_0210*IT_0253;
    const ccomplex_t IT_0365 = IT_0185*IT_0198;
    const ccomplex_t IT_0366 = IT_0020*IT_0069;
    const ccomplex_t IT_0367 = IT_0136*IT_0141;
    const ccomplex_t IT_0368 = IT_0295 + -IT_0364 + -IT_0365 + -IT_0366 + 
      -IT_0367;
    const ccomplex_t IT_0369 = s_34*m_N_3;
    const ccomplex_t IT_0370 = 6*conj(IT_0257);
    const ccomplex_t IT_0371 = 6*conj(IT_0354);
    const ccomplex_t IT_0372 = pow(m_H0, 2);
    const ccomplex_t IT_0373 = m_b*m_N_3*IT_0372;
