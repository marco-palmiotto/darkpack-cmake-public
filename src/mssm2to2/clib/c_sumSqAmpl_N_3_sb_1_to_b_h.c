        ...
        )
{
    ...
    const ccomplex_t IT_0002 = N_B4*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0011 = m_b*N_d4*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0078 = m_b*N_d3*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0090 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_00) + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_10)) + U_sb_10*
      (IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_00) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*conj(U_sb_10
      ));
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*(e_em*IT_0090 +
       1.4142135623731*A_b*IT_0025*IT_0083*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    ...
    const ccomplex_t IT_0099 = m_b*N_d3*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0104 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_11)) + U_sb_10*
    ...
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*(e_em*IT_0104 +
       1.4142135623731*A_b*IT_0025*IT_0083*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    const ccomplex_t IT_0106 = 0.5*IT_0105;
    const ccomplex_t IT_0107 = IT_0103*IT_0106;
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0016 + IT_0073 + -m_sb_2*
    ...
    const ccomplex_t IT_0129 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0130 = IT_0022*IT_0129;
    const ccomplex_t IT_0131 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0132 = IT_0026*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0134 = IT_0034*IT_0133;
    const ccomplex_t IT_0135 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0139 = m_N_3*IT_0138;
    const ccomplex_t IT_0140 = IT_0128 + IT_0139;
    const ccomplex_t IT_0141 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_3*
    ...
    const ccomplex_t IT_0190 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0191 = IT_0001*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = m_b*N_d1*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0224 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0225 = IT_0022*IT_0224;
    const ccomplex_t IT_0226 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0227 = IT_0026*IT_0226;
    const ccomplex_t IT_0228 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0229 = IT_0022*IT_0228;
    const ccomplex_t IT_0230 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0231 = IT_0026*IT_0230;
    const ccomplex_t IT_0232 = IT_0225 + IT_0227 + IT_0229 + IT_0231;
    const ccomplex_t IT_0233 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0234 = IT_0034*IT_0233;
    const ccomplex_t IT_0235 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0245 = m_N_3*IT_0244;
    const ccomplex_t IT_0246 = IT_0223 + IT_0245;
    const ccomplex_t IT_0247 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0248 = IT_0001*IT_0247;
    const ccomplex_t IT_0249 = 1.4142135623731*IT_0248;
    const ccomplex_t IT_0250 = m_b*N_d2*e_em*IT_0010*U_sb_00;
    ...
    const ccomplex_t IT_0255 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_2*
    ...
    const ccomplex_t IT_0271 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_11)) + U_sb_10*
      (IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*conj(U_sb_11
      ));
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*(e_em*IT_0271 +
       1.4142135623731*A_b*IT_0025*IT_0083*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    const ccomplex_t IT_0273 = 0.5*IT_0272;
    const ccomplex_t IT_0274 = IT_0270*IT_0273;
    const ccomplex_t IT_0275 = IT_0108*IT_0274;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1)*IT_0275;
    const ccomplex_t IT_0277 = m_b*conj(N_d3)*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0278 = IT_0009*IT_0277;
    const ccomplex_t IT_0279 = 1.4142135623731*IT_0278;
    const ccomplex_t IT_0280 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0281 = IT_0008*IT_0280;
    const ccomplex_t IT_0282 = 1.4142135623731*IT_0281;
    const ccomplex_t IT_0283 = conj(N_B3)*e_em*U_sb_00;
    const ccomplex_t IT_0284 = IT_0001*IT_0283;
    const ccomplex_t IT_0285 = 1.4142135623731*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*(IT_0279 + -IT_0282 +
       0.333333333333333*IT_0285);
    const ccomplex_t IT_0287 = 3*IT_0286;
    const ccomplex_t IT_0288 = 0.166666666666667*IT_0287;
    const ccomplex_t IT_0289 = 2*U_sb_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0088*(IT_0008 + 1./3*IT_0007*IT_0089))*conj
      (U_sb_00) + 1./2*IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_10)) + U_sb_10*
      (IT_0006*IT_0008*IT_0021*IT_0084*conj(U_sb_00) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0088*IT_0089)*conj(U_sb_10
      ));
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*(e_em*IT_0289 +
       1.4142135623731*A_b*IT_0025*IT_0083*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    ...
    const ccomplex_t IT_0335 = IT_0255*IT_0334;
    const ccomplex_t IT_0336 = (0 + _Complex_I*1)*IT_0335;
    const ccomplex_t IT_0337 = IT_0322*IT_0336;
    const ccomplex_t IT_0338 = m_b*conj(N_d4)*e_em*IT_0010*U_sb_10;
    ...
    const ccomplex_t IT_0350 = IT_0018*IT_0349;
    const ccomplex_t IT_0351 = (0 + _Complex_I*1)*IT_0350;
    const ccomplex_t IT_0352 = m_N_3*IT_0047;
    const ccomplex_t IT_0353 = m_N_4*IT_0069;
    const ccomplex_t IT_0354 = IT_0352 + IT_0353;
    const ccomplex_t IT_0355 = IT_0351*IT_0354;
    const ccomplex_t IT_0356 = -IT_0276 + -IT_0294 + 2*IT_0298 + -IT_0301 + 
      -IT_0319 + -IT_0337 + -IT_0355;
    const ccomplex_t IT_0357 = 6*s_13;
    const ccomplex_t IT_0358 = m_b*m_N_3;
    const ccomplex_t IT_0359 = 6*IT_0259;
    const ccomplex_t IT_0360 = IT_0165*IT_0318;
    const ccomplex_t IT_0361 = IT_0047*IT_0351;
    const ccomplex_t IT_0362 = IT_0127*IT_0300;
    const ccomplex_t IT_0363 = IT_0222*IT_0336;
    const ccomplex_t IT_0364 = -IT_0116 + IT_0360 + IT_0361 + IT_0362 + IT_0363;
    const ccomplex_t IT_0365 = m_b*s_14;
    const ccomplex_t IT_0366 = IT_0138*IT_0143;
    const ccomplex_t IT_0367 = IT_0187*IT_0200;
    const ccomplex_t IT_0368 = IT_0020*IT_0069;
    const ccomplex_t IT_0369 = IT_0244*IT_0257;
    const ccomplex_t IT_0370 = IT_0297 + -IT_0366 + -IT_0367 + -IT_0368 + 
      -IT_0369;
    const ccomplex_t IT_0371 = s_34*m_N_3;
    const ccomplex_t IT_0372 = 6*conj(IT_0259);
    const ccomplex_t IT_0373 = 6*conj(IT_0356);
    const ccomplex_t IT_0374 = pow(m_h, 2);
    const ccomplex_t IT_0375 = m_b*m_N_3*IT_0374;
