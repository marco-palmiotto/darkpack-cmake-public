        ...
        )
{
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0039 = N_W3*U_d2*e_em;
    const ccomplex_t IT_0040 = IT_0006*IT_0039;
    const ccomplex_t IT_0041 = 1.4142135623731*IT_0040;
    const ccomplex_t IT_0042 = N_B3*U_d2*e_em;
    ...
    const ccomplex_t IT_0046 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0052 = m_b*conj(U_d2)*V_tb*e_em*IT_0026*U_sb_10;
    const ccomplex_t IT_0053 = IT_0025*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*IT_0053;
    const ccomplex_t IT_0055 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0056 = IT_0005*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*(IT_0054 + (-2)*IT_0056);
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = IT_0051*IT_0058;
    const ccomplex_t IT_0060 = IT_0038*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = m_t*IT_0061;
    const ccomplex_t IT_0063 = pow(m_N_3, 2);
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0000 + IT_0063 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0065 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0066 = IT_0011*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = cpow(IT_0003, -1);
    const ccomplex_t IT_0069 = IT_0005*IT_0068;
    const ccomplex_t IT_0070 = m_t*N_u3*e_em*IT_0026*U_st_00;
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*(IT_0067 + (-0.75)*IT_0072);
    const ccomplex_t IT_0074 = 0.666666666666667*IT_0073;
    const ccomplex_t IT_0075 = m_t*U_sb_00*(m_t*IT_0023*IT_0068*conj(U_st_00) 
      + mu_h*conj(U_st_10)) + m_b*(m_b*IT_0003*IT_0024*U_sb_00*conj(U_st_00) +
       U_sb_10*(mu_h*conj(U_st_00) + m_t*IT_0024*IT_0068*conj(U_st_10)));
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0003*U_sb_10
      *conj(U_st_00) + (-1.4142135623731)*e_em*IT_0005*((-0.5)*IT_0026*IT_0075 +
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0000 + IT_0063 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0081 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0082 = IT_0011*IT_0081;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = m_t*N_u3*e_em*IT_0026*U_st_01;
    ...
    const ccomplex_t IT_0089 = m_t*U_sb_00*(m_t*IT_0023*IT_0068*conj(U_st_01) 
      + mu_h*conj(U_st_11)) + m_b*(m_b*IT_0003*IT_0024*U_sb_00*conj(U_st_01) +
       U_sb_10*(mu_h*conj(U_st_01) + m_t*IT_0024*IT_0068*conj(U_st_11)));
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0003*U_sb_10
      *conj(U_st_01) + (-1.4142135623731)*e_em*IT_0005*((-0.5)*IT_0026*IT_0089 +
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_12 + -IT_0001 + -IT_0063 + IT_0094 
      + -reg_prop, -1);
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0005*IT_0023*IT_0026*IT_0068;
    ...
    const ccomplex_t IT_0102 = m_b*N_d3*e_em*IT_0026*U_sb_00;
    ...
    const ccomplex_t IT_0109 = m_b*conj(N_d3)*e_em*IT_0026*U_sb_10;
    ...
    const ccomplex_t IT_0115 = conj(N_W3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0005*IT_0026*IT_0068*U_sb_00;
    const ccomplex_t IT_0127 = 0.5*IT_0126;
    const ccomplex_t IT_0128 = IT_0022*IT_0127;
    const ccomplex_t IT_0129 = IT_0002*IT_0125*IT_0128;
    ...
    const ccomplex_t IT_0134 = IT_0038*IT_0130*IT_0133;
    const ccomplex_t IT_0135 = -IT_0037 + -IT_0062 + IT_0079 + IT_0093 + 
      -IT_0108 + IT_0124 + IT_0129 + IT_0134;
    const ccomplex_t IT_0136 = IT_0005*IT_0023;
    const ccomplex_t IT_0137 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0138 = IT_0136*IT_0137;
    const ccomplex_t IT_0139 = 2*IT_0138;
    const ccomplex_t IT_0140 = IT_0011*IT_0023;
    const ccomplex_t IT_0141 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0142 = IT_0140*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0152 = IT_0038*IT_0130*IT_0151;
    const ccomplex_t IT_0153 = conj(N_u3)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0154 = IT_0136*IT_0153;
    const ccomplex_t IT_0155 = 2*IT_0154;
    const ccomplex_t IT_0156 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0157 = IT_0140*IT_0156;
    const ccomplex_t IT_0158 = 1.4142135623731*IT_0157;
    const ccomplex_t IT_0159 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0167 = IT_0002*IT_0125*IT_0166;
    const ccomplex_t IT_0168 = conj(N_B3)*e_em*U_st_00;
    const ccomplex_t IT_0169 = IT_0011*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0172 = IT_0005*IT_0171;
    const ccomplex_t IT_0173 = 1.4142135623731*IT_0172;
    const ccomplex_t IT_0174 = m_t*conj(N_u3)*e_em*IT_0026*U_st_10;
    const ccomplex_t IT_0175 = IT_0069*IT_0174;
    ...
    const ccomplex_t IT_0179 = IT_0076*IT_0178;
    const ccomplex_t IT_0180 = IT_0064*IT_0179;
    ...
    const ccomplex_t IT_0188 = m_t*conj(N_u3)*e_em*IT_0026*U_st_11;
    const ccomplex_t IT_0189 = IT_0069*IT_0188;
    ...
    const ccomplex_t IT_0193 = IT_0090*IT_0192;
    ...
    const ccomplex_t IT_0199 = IT_0095*IT_0096*IT_0198;
    const ccomplex_t IT_0200 = IT_0132*IT_0150;
    ...
    const ccomplex_t IT_0204 = IT_0127*IT_0165;
    ...
    const ccomplex_t IT_0208 = IT_0106*IT_0197;
    ...
    const ccomplex_t IT_0214 = m_t*m_N_3;
    const ccomplex_t IT_0215 = 6*IT_0135;
    const ccomplex_t IT_0216 = IT_0036 + IT_0061 + -IT_0210;
    const ccomplex_t IT_0217 = m_t*s_12;
    const ccomplex_t IT_0218 = IT_0123 + IT_0202 + IT_0206;
    const ccomplex_t IT_0219 = s_23*m_N_3;
    const ccomplex_t IT_0220 = 6*conj(IT_0135);
    const ccomplex_t IT_0221 = 6*conj(IT_0212);
    const ccomplex_t IT_0222 = m_t*m_N_3*IT_0001;
    const ccomplex_t IT_0223 = s_13*IT_0001;
