...
ccomplex_return_t c_sumSqAmpl_N_3_sb_1_to_t_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = N_B3*e_em*U_st_10;
    ...
    const ccomplex_t IT_0013 = m_t*N_u3*e_em*IT_0012*U_st_00;
    ...
    const ccomplex_t IT_0029 = m_t*N_u3*e_em*IT_0012*U_st_01;
    ...
    const ccomplex_t IT_0053 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0054 = IT_0001*IT_0053;
    const ccomplex_t IT_0055 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0072 = conj(N_B3)*e_em*U_st_00;
    const ccomplex_t IT_0073 = IT_0005*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_t*conj(N_u3)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0086 = conj(N_B3)*e_em*U_st_01;
    const ccomplex_t IT_0087 = IT_0005*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W3)*e_em*U_st_01;
    const ccomplex_t IT_0090 = IT_0001*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = m_t*conj(N_u3)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0101 = m_t*m_N_3;
    ...
    const ccomplex_t IT_0108 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0109 = IT_0001*IT_0108;
    const ccomplex_t IT_0110 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0118 = m_b*conj(U_d2)*V_tb*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0119 = IT_0117*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    ...
    const ccomplex_t IT_0128 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0129 = IT_0001*IT_0128;
    const ccomplex_t IT_0130 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0135 = m_b*conj(U_d1)*V_tb*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0136 = IT_0117*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    ...
    const ccomplex_t IT_0180 = IT_0153*IT_0179;
    const ccomplex_t IT_0181 = IT_0151*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*IT_0181;
    const ccomplex_t IT_0183 = -IT_0023 + -IT_0037;
    const ccomplex_t IT_0184 = s_14*IT_0018;
    const ccomplex_t IT_0185 = s_13*s_34;
    const ccomplex_t IT_0186 = -IT_0185;
    const ccomplex_t IT_0187 = IT_0184 + IT_0186;
    const ccomplex_t IT_0188 = pow(m_W, 4);
    const ccomplex_t IT_0189 = s_13*IT_0188;
    const ccomplex_t IT_0190 = IT_0066*IT_0189;
    const ccomplex_t IT_0191 = s_14*s_34;
    const ccomplex_t IT_0192 = 24*IT_0191;
    const ccomplex_t IT_0193 = s_13*IT_0146;
    const ccomplex_t IT_0194 = (-12)*IT_0193;
    const ccomplex_t IT_0195 = 6*IT_0190 + IT_0192 + IT_0194;
    const ccomplex_t IT_0196 = s_14*IT_0146;
    ...
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0203 = IT_0046*IT_0141;
    const ccomplex_t IT_0204 = IT_0039*IT_0202*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0206 = IT_0059*IT_0124;
    const ccomplex_t IT_0207 = IT_0052*IT_0205*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0209 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0210 = IT_0005*IT_0209;
    const ccomplex_t IT_0211 = 1.4142135623731*IT_0210;
    const ccomplex_t IT_0212 = m_b*N_d3*e_em*IT_0012*U_sb_00;
    const ccomplex_t IT_0213 = IT_0117*IT_0212;
    const ccomplex_t IT_0214 = 1.4142135623731*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*(IT_0211 + 1.5*IT_0214);
    ...
    const ccomplex_t IT_0220 = IT_0151*IT_0208*IT_0219;
    const ccomplex_t IT_0221 = -IT_0204 + -IT_0207 + -IT_0220;
    const ccomplex_t IT_0222 = IT_0127 + IT_0144;
    const ccomplex_t IT_0223 = m_N_3*IT_0222;
    const ccomplex_t IT_0224 = IT_0221 + IT_0223;
    const ccomplex_t IT_0225 = s_34*IT_0146;
    ...
    const ccomplex_t IT_0231 = m_N_3*IT_0051;
    const ccomplex_t IT_0232 = m_N_3*IT_0064;
    const ccomplex_t IT_0233 = m_t*IT_0182;
    const ccomplex_t IT_0234 = -IT_0231 + -IT_0232 + -IT_0233;
    const ccomplex_t IT_0235 = IT_0048*IT_0134;
    const ccomplex_t IT_0236 = IT_0039*IT_0202*IT_0235;
    const ccomplex_t IT_0237 = IT_0061*IT_0114;
    const ccomplex_t IT_0238 = IT_0052*IT_0205*IT_0237;
    const ccomplex_t IT_0239 = IT_0236 + IT_0238;
    const ccomplex_t IT_0240 = IT_0234 + IT_0239;
    const ccomplex_t IT_0241 = 6*conj(IT_0103)*(IT_0065*IT_0107 + -IT_0145
      *IT_0148 + IT_0149*IT_0182 + IT_0183*IT_0187 + 0.166666666666667*IT_0103
      *IT_0195 + IT_0201*IT_0224 + IT_0230*IT_0240);
    const ccomplex_t IT_0242 = (-18)*conj(IT_0221);
    const ccomplex_t IT_0243 = s_14*s_34*IT_0066;
    const ccomplex_t IT_0244 = -IT_0243;
    const ccomplex_t IT_0245 = s_13 + IT_0244;
    const ccomplex_t IT_0246 = s_13*IT_0245;
    const ccomplex_t IT_0247 = 2*IT_0127 + 2*IT_0144;
    const ccomplex_t IT_0248 = IT_0085 + IT_0099 + 2*IT_0182;
    const ccomplex_t IT_0249 = IT_0101*IT_0245;
    const ccomplex_t IT_0250 = m_N_3*IT_0245;
    const ccomplex_t IT_0251 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0252 = 0.5*IT_0226;
    const ccomplex_t IT_0253 = s_34 + IT_0252;
    const ccomplex_t IT_0254 = m_N_3*IT_0253;
    const ccomplex_t IT_0255 = 2*IT_0254;
    const ccomplex_t IT_0256 = (-2)*IT_0191;
    const ccomplex_t IT_0257 = IT_0193 + IT_0256;
    const ccomplex_t IT_0258 = IT_0066*IT_0257;
    const ccomplex_t IT_0259 = (-6)*IT_0258;
    const ccomplex_t IT_0260 = 12*s_13;
    const ccomplex_t IT_0261 = IT_0259 + IT_0260;
    const ccomplex_t IT_0262 = m_t*IT_0245;
    const ccomplex_t IT_0263 = (-6)*IT_0183;
    const ccomplex_t IT_0264 = pow(s_34, 2);
    ...
    const ccomplex_t IT_0281 = IT_0145 + IT_0182;
    const ccomplex_t IT_0282 = (-6)*conj(IT_0248);
    const ccomplex_t IT_0283 = (-6)*IT_0221;
    const ccomplex_t IT_0284 = (-6)*conj(IT_0145)*(IT_0103*IT_0148 + (
      -0.166666666666667)*IT_0145*IT_0195 + IT_0201*IT_0240 + (
      -0.166666666666667)*IT_0182*IT_0272 + -IT_0107*IT_0275 + (
      -0.166666666666667)*IT_0187*IT_0280 + IT_0230*(IT_0223 + (
      -0.166666666666667)*IT_0283));
    const ccomplex_t IT_0285 = (-6)*conj(IT_0221);
    const ccomplex_t IT_0286 = (-6)*conj(IT_0247);
    const ccomplex_t IT_0287 = m_t*IT_0070;
    const ccomplex_t IT_0288 = 6*IT_0287;
    const ccomplex_t IT_0289 = (-6)*IT_0065;
    const ccomplex_t IT_0290 = 6*IT_0103;
    const ccomplex_t IT_0291 = (-6)*IT_0247;
    const ccomplex_t IT_0292 = 6*IT_0182;
    const ccomplex_t IT_0293 = (-6)*IT_0145;
    const ccomplex_t IT_0294 = IT_0101*((-18)*IT_0221 + (-18)*IT_0223) +
       IT_0240*IT_0261 + IT_0263*IT_0269 + IT_0262*IT_0280 + IT_0250*IT_0289 +
       IT_0230*IT_0290 + IT_0288*(IT_0100 + 0.166666666666667*IT_0291) + IT_0279
      *IT_0292 + IT_0201*IT_0293;
    const ccomplex_t IT_0295 = IT_0101*((-18)*IT_0234 + (-18)*IT_0239) +
       IT_0224*IT_0261 + IT_0262*IT_0263 + 6*IT_0250*IT_0275 + IT_0269*IT_0280 +
       6*IT_0065*IT_0287 + IT_0201*IT_0290 + IT_0255*IT_0292 + IT_0230*IT_0293;
    const ccomplex_t IT_0296 = 0.166666666666667*IT_0249;
    const ccomplex_t IT_0297 = s_13*IT_0267;
    const ccomplex_t IT_0298 = 0.166666666666667*IT_0297;
    const ccomplex_t IT_0299 = (-6)*conj(IT_0100);
    const ccomplex_t IT_0300 = IT_0107*IT_0281;
    const ccomplex_t IT_0301 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0100
      *IT_0102 + IT_0103*IT_0107) + IT_0241 + IT_0101*IT_0240*IT_0242 + (IT_0183
      *IT_0246 + IT_0102*IT_0247 + IT_0248*IT_0249 + IT_0240*IT_0250)*IT_0251 +
       6*conj(IT_0221)*(IT_0103*IT_0201 + IT_0247*IT_0250 + IT_0182*IT_0255 +
       0.166666666666667*IT_0224*IT_0261 + 0.166666666666667*IT_0262*IT_0263) + 
      (IT_0100*IT_0249 + IT_0224*IT_0262 + IT_0248*IT_0268 + IT_0240*IT_0269)
      *IT_0270 + 6*conj(IT_0182)*(IT_0103*IT_0149 + 0.166666666666667*IT_0182
      *IT_0195 + IT_0224*IT_0255 + 0.166666666666667*IT_0145*IT_0272 + IT_0107
      *IT_0275 + IT_0240*IT_0279 + 0.166666666666667*IT_0187*IT_0280) + (IT_0240
      *IT_0262 + IT_0223*IT_0269 + IT_0187*IT_0281)*IT_0282 + IT_0284 + (IT_0145
      *IT_0230 + IT_0100*IT_0250 + IT_0248*IT_0269)*IT_0285 + (IT_0065*conj
      (IT_0221) + conj(IT_0065)*IT_0224 + IT_0240*(conj(IT_0100) +
       0.166666666666667*IT_0286))*IT_0288 + (conj(IT_0234) + conj(IT_0239))
      *IT_0294 + conj(IT_0223)*IT_0295 + 6*conj(IT_0100)*(IT_0071*IT_0100 +
       IT_0065*IT_0102 + 0.166666666666667*IT_0250*IT_0283 + IT_0263*IT_0296) +
       6*conj(IT_0183)*(IT_0103*IT_0187 + IT_0247*IT_0249 + 0.166666666666667
      *IT_0246*IT_0289 + IT_0263*IT_0298) + 6*conj(IT_0248)*(0.166666666666667
      *IT_0263*IT_0268 + IT_0246*IT_0275 + 0.166666666666667*IT_0269*IT_0283 +
       IT_0289*IT_0296 + IT_0280*IT_0298) + IT_0299*(IT_0071*IT_0247 + IT_0246
      *IT_0248 + IT_0223*IT_0250 + IT_0300) + 6*conj(IT_0247)*(IT_0246*IT_0248 +
       IT_0183*IT_0249 + IT_0224*IT_0250 + IT_0071*IT_0275 + 0.166666666666667
      *IT_0102*IT_0289 + IT_0300);
