        ...
        )
{
    ...
    const ccomplex_t IT_0053 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0054 = IT_0005*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = m_t*N_u3*e_em*IT_0012*U_st_01;
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0018 + IT_0019 + -m_st_2*
    ...
    const ccomplex_t IT_0073 = cpow((-2)*s_12 + -IT_0019 + -IT_0024 + IT_0072 
      + -reg_prop, -1);
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*m_b;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001;
    const ccomplex_t IT_0076 = 0.5*IT_0075;
    const ccomplex_t IT_0077 = N_B3*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0083 = m_b*N_d3*e_em*IT_0012*U_sb_00;
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*(IT_0079 + 1.5*IT_0085);
    ...
    const ccomplex_t IT_0091 = m_b*conj(U_d2)*V_tb*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0092 = IT_0082*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0095 = IT_0001*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*(IT_0093 + (-2)*IT_0095);
    const ccomplex_t IT_0097 = (-0.5)*IT_0096;
    const ccomplex_t IT_0098 = IT_0045*IT_0097;
    const ccomplex_t IT_0099 = IT_0038*IT_0090*IT_0098;
    const ccomplex_t IT_0100 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0101 = IT_0001*IT_0100;
    const ccomplex_t IT_0102 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0112 = m_b*conj(U_d1)*V_tb*e_em*IT_0012*U_sb_10;
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*(IT_0114 + (-2)*IT_0116);
    const ccomplex_t IT_0118 = (-0.5)*IT_0117;
    const ccomplex_t IT_0119 = IT_0032*IT_0118;
    const ccomplex_t IT_0120 = IT_0025*IT_0111*IT_0119;
    const ccomplex_t IT_0121 = -IT_0089 + -IT_0099 + IT_0110 + -IT_0120;
    ...
    const ccomplex_t IT_0150 = IT_0052*IT_0149;
    const ccomplex_t IT_0151 = (-2)*IT_0109 + -IT_0136 + -IT_0150;
    ...
    const ccomplex_t IT_0158 = -IT_0023 + -IT_0064;
    ...
    const ccomplex_t IT_0169 = m_N_3*IT_0156;
    const ccomplex_t IT_0170 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0171 = IT_0001*IT_0170;
    const ccomplex_t IT_0172 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0189 = m_b*conj(N_d3)*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0190 = IT_0082*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = conj(N_B3)*e_em*U_sb_00;
    const ccomplex_t IT_0193 = IT_0005*IT_0192;
    const ccomplex_t IT_0194 = 1.4142135623731*IT_0193;
    const ccomplex_t IT_0195 = conj(N_W3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0201 = IT_0076*IT_0200;
    ...
    const ccomplex_t IT_0208 = m_N_3*IT_0165;
    const ccomplex_t IT_0209 = m_t*IT_0203;
    const ccomplex_t IT_0210 = m_N_3*IT_0037;
    const ccomplex_t IT_0211 = m_N_3*IT_0050;
    const ccomplex_t IT_0212 = -IT_0209 + -IT_0210 + -IT_0211;
    const ccomplex_t IT_0213 = IT_0034*IT_0176;
    const ccomplex_t IT_0214 = IT_0025*IT_0111*IT_0213;
    const ccomplex_t IT_0215 = IT_0047*IT_0106;
    const ccomplex_t IT_0216 = IT_0038*IT_0090*IT_0215;
    const ccomplex_t IT_0217 = IT_0214 + IT_0216;
    const ccomplex_t IT_0218 = m_N_3*IT_0179;
    const ccomplex_t IT_0219 = s_13*IT_0181;
    ...
    const ccomplex_t IT_0225 = 12*s_13;
    const ccomplex_t IT_0226 = IT_0224 + IT_0225;
    const ccomplex_t IT_0227 = IT_0212 + IT_0217;
    const ccomplex_t IT_0228 = 2*IT_0179;
    ...
    const ccomplex_t IT_0232 = -IT_0037 + -IT_0050;
    ...
    const ccomplex_t IT_0245 = 6*IT_0109 + (-6)*IT_0180;
    const ccomplex_t IT_0246 = IT_0159*IT_0169 + IT_0167*IT_0207 + IT_0168
      *IT_0208 + IT_0152*((-18)*IT_0121 + (-18)*IT_0218) + IT_0226*IT_0227 + 6
      *IT_0122*IT_0231 + IT_0187*IT_0233 + IT_0239*IT_0240 + IT_0244*IT_0245;
    const ccomplex_t IT_0247 = IT_0152*IT_0181;
    const ccomplex_t IT_0248 = 3*IT_0247;
    const ccomplex_t IT_0249 = pow(m_W, 4);
    const ccomplex_t IT_0250 = s_13*IT_0249;
    const ccomplex_t IT_0251 = IT_0066*IT_0250;
    const ccomplex_t IT_0252 = 24*IT_0220;
    const ccomplex_t IT_0253 = (-12)*IT_0219;
    const ccomplex_t IT_0254 = 6*IT_0251 + IT_0252 + IT_0253;
    const ccomplex_t IT_0255 = (-3)*IT_0247;
    const ccomplex_t IT_0256 = -conj(IT_0109);
    const ccomplex_t IT_0257 = conj(IT_0180) + IT_0256;
    const ccomplex_t IT_0258 = -IT_0257;
    const ccomplex_t IT_0259 = 0.166666666666667*IT_0153;
    const ccomplex_t IT_0260 = (-6)*conj(IT_0151);
    const ccomplex_t IT_0261 = 0.166666666666667*IT_0260;
    const ccomplex_t IT_0262 = conj(IT_0228) + IT_0261;
    const ccomplex_t IT_0263 = (-6)*conj(IT_0158);
    const ccomplex_t IT_0264 = 0.166666666666667*IT_0161;
    const ccomplex_t IT_0265 = (-6)*conj(IT_0121);
    const ccomplex_t IT_0266 = 0.166666666666667*IT_0169;
    const ccomplex_t IT_0267 = s_14*IT_0018;
    const ccomplex_t IT_0268 = s_13*s_34;
    const ccomplex_t IT_0269 = -IT_0268;
    const ccomplex_t IT_0270 = IT_0267 + IT_0269;
    const ccomplex_t IT_0271 = conj(IT_0180) + conj(IT_0203);
    const ccomplex_t IT_0272 = (-6)*conj(IT_0204);
    const ccomplex_t IT_0273 = IT_0180 + IT_0203;
    const ccomplex_t IT_0274 = 0.166666666666667*IT_0273;
    const ccomplex_t IT_0275 = 0.5*IT_0183;
    const ccomplex_t IT_0276 = s_34 + IT_0275;
    const ccomplex_t IT_0277 = m_N_3*IT_0276;
    const ccomplex_t IT_0278 = 2*IT_0277;
    const ccomplex_t IT_0279 = (-6)*IT_0251;
    const ccomplex_t IT_0280 = IT_0252 + IT_0279;
    const ccomplex_t IT_0281 = 0.166666666666667*conj(IT_0180);
    const ccomplex_t IT_0282 = (-24)*IT_0220;
    const ccomplex_t IT_0283 = 6*IT_0251 + IT_0282;
    const ccomplex_t IT_0284 = 0.166666666666667*conj(IT_0109);
    const ccomplex_t IT_0285 = 0.166666666666667*conj(IT_0203);
    const ccomplex_t IT_0286 = conj(IT_0065)*IT_0122;
    const ccomplex_t IT_0287 = 0.166666666666667*IT_0167;
    const ccomplex_t IT_0288 = (-6)*conj(IT_0228);
    const ccomplex_t IT_0289 = 0.166666666666667*IT_0288;
    const ccomplex_t IT_0290 = conj(IT_0151) + IT_0289;
    const ccomplex_t IT_0291 = (-18)*conj(IT_0121);
    const ccomplex_t IT_0292 = 0.166666666666667*IT_0208;
    const ccomplex_t IT_0293 = 0.166666666666667*IT_0205;
    const ccomplex_t IT_0294 = 6*IT_0065*IT_0122 + IT_0167*IT_0168 + IT_0207
      *IT_0208 + IT_0152*((-18)*IT_0212 + (-18)*IT_0217) + (IT_0121 + IT_0218)
      *IT_0226 + IT_0233*IT_0244 + IT_0187*IT_0245 + IT_0240*IT_0278 + 6*IT_0169
      *(IT_0228 + IT_0293);
    const ccomplex_t IT_0295 = s_13*s_14;
    const ccomplex_t IT_0296 = s_34*IT_0019;
    const ccomplex_t IT_0297 = -IT_0296;
    const ccomplex_t IT_0298 = IT_0295 + IT_0297;
    const ccomplex_t IT_0299 = 12*IT_0219;
    const ccomplex_t IT_0300 = IT_0279 + IT_0282 + IT_0299;
    const ccomplex_t IT_0301 = conj(IT_0232)*IT_0255;
    const ccomplex_t IT_0302 = 6*IT_0065*(conj(IT_0065)*IT_0071 + conj(IT_0121
      ...
      *IT_0187)*IT_0188 + conj(IT_0204)*(IT_0159*IT_0161 + IT_0157*IT_0205 +
       ...
       conj(IT_0217))*IT_0246 + IT_0233*(conj(IT_0121)*IT_0244 + conj(IT_0203)
      *IT_0248 + 0.166666666666667*conj(IT_0232)*IT_0254 + IT_0255*IT_0258) + 6
      *conj(IT_0228)*(IT_0158*IT_0161 + 0.166666666666667*IT_0071*IT_0205 +
       IT_0159*IT_0259) + 6*IT_0228*(conj(IT_0158)*IT_0161 + conj(IT_0121)
      *IT_0169 + IT_0157*conj(IT_0204) + IT_0160*IT_0259 + IT_0071*IT_0262) + 6
      *IT_0151*(IT_0071*conj(IT_0151) + conj(IT_0065)*IT_0153 + IT_0263*IT_0264 
      + IT_0265*IT_0266) + 6*IT_0270*(conj(IT_0109)*IT_0204 + IT_0109*conj
      (IT_0204) + conj(IT_0158)*IT_0232 + IT_0158*conj(IT_0232) +
       0.166666666666667*IT_0207*IT_0271 + IT_0272*IT_0274) + IT_0240*(conj
      (IT_0232)*IT_0248 + conj(IT_0121)*IT_0278 + IT_0280*IT_0281 + IT_0283
      *IT_0284 + IT_0254*IT_0285) + 6*IT_0121*(conj(IT_0109)*IT_0187 +
       0.166666666666667*conj(IT_0121)*IT_0226 + IT_0169*conj(IT_0228) + conj
      (IT_0232)*IT_0244 + conj(IT_0203)*IT_0278 + IT_0286 + IT_0263*IT_0287) + 6
      *IT_0227*(IT_0187*conj(IT_0232) + conj(IT_0203)*IT_0239 + IT_0244*IT_0258 
      + IT_0160*IT_0266 + IT_0272*IT_0287 + IT_0122*IT_0290 + 0.166666666666667
      *IT_0152*IT_0291 + IT_0263*IT_0292) + 6*IT_0204*(IT_0157*IT_0262 +
       0.166666666666667*IT_0206*IT_0263 + IT_0160*IT_0264 + IT_0265*IT_0292) +
       6*IT_0218*(0.166666666666667*conj(IT_0121)*IT_0226 + conj(IT_0232)
      *IT_0244 + IT_0187*IT_0258 + IT_0169*IT_0262 + conj(IT_0203)*IT_0278 +
       IT_0286 + IT_0263*IT_0287 + IT_0272*IT_0292) + conj(IT_0218)*IT_0294 + 6*
      (conj(IT_0109)*IT_0231 + conj(IT_0065)*IT_0232 + IT_0065*conj(IT_0232) +
       conj(IT_0228)*IT_0273 + IT_0260*IT_0274 + IT_0109*IT_0290 + IT_0271*
      (IT_0228 + IT_0293))*IT_0298 + 6*IT_0109*(conj(IT_0121)*IT_0187 + IT_0254
      *IT_0284 + IT_0283*IT_0285 + IT_0281*IT_0300 + IT_0301) + IT_0180*(conj
      (IT_0180)*IT_0254 + IT_0187*IT_0265 + conj(IT_0203)*IT_0280 + conj(IT_0109
      )*IT_0300 + (-6)*IT_0301);
