        ...
        )
{
    ...
    const ccomplex_t IT_0037 = m_b*conj(N_d3)*e_em*IT_0016*U_sb_11;
    ...
    const ccomplex_t IT_0045 = IT_0005*IT_0041;
    const ccomplex_t IT_0046 = IT_0003*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = IT_0044 + 2*IT_0047;
    const ccomplex_t IT_0049 = (-6)*IT_0000;
    const ccomplex_t IT_0050 = 0.333333333333333*IT_0004;
    ...
    const ccomplex_t IT_0057 = -IT_0024;
    ...
    const ccomplex_t IT_0071 = (-6)*IT_0001;
    ...
    const ccomplex_t IT_0082 = s_13*(IT_0030*conj(IT_0030) + IT_0048*conj
      ...
      (IT_0048)*IT_0053 + IT_0048*conj(IT_0053))*IT_0055 + (-6)*conj(IT_0029)*
      (IT_0047*IT_0056 + (-0.166666666666667)*IT_0057*IT_0062 + (
      -0.166666666666667)*IT_0052*IT_0063 + (-0.166666666666667)*IT_0029*IT_0064
       + (-0.166666666666667)*IT_0030*IT_0066) + IT_0029*(conj(IT_0052)*IT_0063 
      + conj(IT_0030)*IT_0066) + (conj(IT_0053)*IT_0063 + conj(IT_0048)*IT_0066)
      *IT_0067 + (-6)*(IT_0056*IT_0057 + (-0.166666666666667)*IT_0047*IT_0062 + 
      ...
      *IT_0072 + IT_0057*(IT_0074*IT_0075 + IT_0073*IT_0076) + IT_0047*(IT_0073
      *IT_0074 + IT_0075*IT_0076) + (-6)*conj(IT_0057)*((-0.166666666666667)
      *IT_0029*IT_0062 + IT_0056*IT_0067 + (-4)*IT_0057*IT_0077 + IT_0079
      *IT_0080 + IT_0078*IT_0081) + (-6)*conj(IT_0047)*(IT_0029*IT_0056 + (
      -0.166666666666667)*IT_0062*IT_0067 + (-4)*IT_0047*IT_0077 + IT_0078
