        ...
        )
{
    ...
    const ccomplex_t IT_0036 = m_b*conj(N_d3)*e_em*IT_0015*U_sb_11;
    ...
    const ccomplex_t IT_0072 = m_b*s_34*m_N_3;
    const ccomplex_t IT_0073 = (-8)*conj(IT_0029);
    const ccomplex_t IT_0074 = s_14*IT_0000;
    ...
    const ccomplex_t IT_0081 = s_13*(IT_0029*conj(IT_0029) + IT_0047*conj
      ...
      (IT_0046*IT_0055 + (-0.125)*IT_0056*IT_0061 + (-0.125)*IT_0051*IT_0062 + (
      -0.125)*IT_0028*IT_0063 + (-0.125)*IT_0029*IT_0065) + IT_0028*(conj
      (IT_0051)*IT_0062 + conj(IT_0029)*IT_0065) + (conj(IT_0052)*IT_0062 + conj
      (IT_0047)*IT_0065)*IT_0066 + (-8)*(IT_0055*IT_0056 + (-0.125)*IT_0046
      *IT_0061 + (-0.125)*IT_0052*IT_0062 + (-0.125)*IT_0047*IT_0065 + (-0.125)
      *IT_0063*IT_0066)*conj(IT_0066) + IT_0067*IT_0071 + IT_0056*(IT_0073
      *IT_0074 + IT_0072*IT_0075) + IT_0046*(IT_0072*IT_0073 + IT_0074*IT_0075) 
      + (-8)*conj(IT_0056)*((-0.125)*IT_0028*IT_0061 + IT_0055*IT_0066 + (-4)
      *IT_0056*IT_0076 + IT_0078*IT_0079 + IT_0077*IT_0080) + (-8)*conj(IT_0046)
      *(IT_0028*IT_0055 + (-0.125)*IT_0061*IT_0066 + (-4)*IT_0046*IT_0076 +
