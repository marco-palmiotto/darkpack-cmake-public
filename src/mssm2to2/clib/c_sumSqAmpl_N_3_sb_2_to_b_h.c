        ...
        )
{
    ...
    const ccomplex_t IT_0029 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0030 = IT_0022*IT_0029;
    const ccomplex_t IT_0031 = N_B1*N_d3*e_em;
    ...
    const ccomplex_t IT_0049 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0050 = IT_0022*IT_0049;
    const ccomplex_t IT_0051 = conj(N_B1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0062 = conj(N_W3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0084 = N_B4*N_u3*e_em;
    ...
    const ccomplex_t IT_0093 = N_W4*N_u3*e_em;
    ...
    const ccomplex_t IT_0106 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0107 = IT_0022*IT_0106;
    const ccomplex_t IT_0108 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0109 = IT_0026*IT_0108;
    const ccomplex_t IT_0110 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0111 = IT_0022*IT_0110;
    const ccomplex_t IT_0112 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0113 = IT_0026*IT_0112;
    const ccomplex_t IT_0114 = IT_0107 + IT_0109 + IT_0111 + IT_0113;
    const ccomplex_t IT_0115 = conj(N_W3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0119 = conj(N_W4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0130 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0131 = IT_0022*IT_0130;
    const ccomplex_t IT_0132 = N_B3*N_d2*e_em;
    ...
    const ccomplex_t IT_0139 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0140 = IT_0034*IT_0139;
    const ccomplex_t IT_0141 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0142 = IT_0037*IT_0141;
    const ccomplex_t IT_0143 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0144 = IT_0034*IT_0143;
    const ccomplex_t IT_0145 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0152 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0153 = IT_0022*IT_0152;
    const ccomplex_t IT_0154 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0155 = IT_0026*IT_0154;
    const ccomplex_t IT_0156 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0157 = IT_0022*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0159 = IT_0026*IT_0158;
    const ccomplex_t IT_0160 = IT_0153 + IT_0155 + IT_0157 + IT_0159;
    const ccomplex_t IT_0161 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0162 = IT_0034*IT_0161;
    const ccomplex_t IT_0163 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0164 = IT_0037*IT_0163;
    const ccomplex_t IT_0165 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0166 = IT_0034*IT_0165;
    const ccomplex_t IT_0167 = conj(N_W3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0168 = IT_0037*IT_0167;
    ...
    const ccomplex_t IT_0187 = pow(m_N_3, 2);
    const ccomplex_t IT_0188 = cpow((-2)*s_13 + IT_0016 + IT_0187 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0189 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0190 = IT_0001*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = m_b*N_d3*e_em*IT_0010*U_sb_01;
    ...
    const ccomplex_t IT_0197 = cpow(V_tb, 2);
    const ccomplex_t IT_0198 = m_b*mu_h*IT_0010;
    const ccomplex_t IT_0199 = IT_0005*IT_0025;
    const ccomplex_t IT_0200 = sin(beta);
    const ccomplex_t IT_0201 = IT_0021*IT_0200;
    const ccomplex_t IT_0202 = IT_0199 + IT_0201;
    const ccomplex_t IT_0203 = cpow(IT_0000, -2);
    const ccomplex_t IT_0204 = 2*U_sb_01*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0202*(IT_0008 + 1./3*IT_0007*IT_0203))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0198*conj(U_sb_11)) + U_sb_11*
      (IT_0006*IT_0008*IT_0021*IT_0198*conj(U_sb_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0202*IT_0203)*conj(U_sb_11
      ));
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*(e_em*IT_0204 +
       1.4142135623731*A_b*IT_0025*IT_0197*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0210 = cpow((-2)*s_13 + IT_0016 + IT_0187 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0211 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0212 = IT_0001*IT_0211;
    const ccomplex_t IT_0213 = 1.4142135623731*IT_0212;
    const ccomplex_t IT_0214 = m_b*N_d3*e_em*IT_0010*U_sb_00;
    const ccomplex_t IT_0215 = IT_0009*IT_0214;
    ...
    const ccomplex_t IT_0219 = 2*conj(U_sb_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + (-0.5)*m_W*IT_0202*(IT_0008 + 1./3*IT_0007*IT_0203))
      *U_sb_01 + 1./2*IT_0006*IT_0008*IT_0021*IT_0198*U_sb_11) + conj(U_sb_10)*
      (IT_0006*IT_0008*IT_0021*IT_0198*U_sb_01 + 2*(IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0202*IT_0203)*U_sb_11);
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*(e_em*IT_0219 +
       1.4142135623731*A_b*IT_0025*IT_0197*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    ...
    const ccomplex_t IT_0225 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0187 
      + -reg_prop, -1);
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*m_b*e_em*IT_0006*IT_0008
      *IT_0010*IT_0025;
    const ccomplex_t IT_0227 = 0.5*IT_0226;
    const ccomplex_t IT_0228 = IT_0196*IT_0227;
    const ccomplex_t IT_0229 = IT_0225*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = m_b*IT_0230;
    const ccomplex_t IT_0232 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0233 = IT_0022*IT_0232;
    const ccomplex_t IT_0234 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0235 = IT_0026*IT_0234;
    const ccomplex_t IT_0236 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0237 = IT_0034*IT_0236;
    const ccomplex_t IT_0238 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0243 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0244 = IT_0022*IT_0243;
    const ccomplex_t IT_0245 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0246 = IT_0026*IT_0245;
    const ccomplex_t IT_0247 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0248 = IT_0034*IT_0247;
    const ccomplex_t IT_0249 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0250 = IT_0037*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*(IT_0244 + IT_0246 + 
      -IT_0248 + -IT_0250);
    const ccomplex_t IT_0252 = -IT_0251;
    const ccomplex_t IT_0253 = m_N_3*IT_0252;
    const ccomplex_t IT_0254 = IT_0242 + IT_0253;
    const ccomplex_t IT_0255 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0256 = IT_0196*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0254*IT_0257;
    const ccomplex_t IT_0259 = IT_0072 + IT_0129 + IT_0186 + IT_0209 + IT_0224
       + (-2)*IT_0231 + IT_0258;
    const ccomplex_t IT_0260 = m_b*conj(N_d4)*e_em*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0272 = IT_0081*IT_0271;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*IT_0272;
    const ccomplex_t IT_0274 = m_N_3*IT_0104;
    const ccomplex_t IT_0275 = m_N_4*IT_0126;
    const ccomplex_t IT_0276 = IT_0274 + IT_0275;
    const ccomplex_t IT_0277 = IT_0273*IT_0276;
    const ccomplex_t IT_0278 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0279 = IT_0001*IT_0278;
    const ccomplex_t IT_0280 = 1.4142135623731*IT_0279;
    const ccomplex_t IT_0281 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0282 = IT_0008*IT_0281;
    const ccomplex_t IT_0283 = 1.4142135623731*IT_0282;
    const ccomplex_t IT_0284 = m_b*conj(N_d3)*e_em*IT_0010*U_sb_11;
    const ccomplex_t IT_0285 = IT_0009*IT_0284;
    ...
    const ccomplex_t IT_0292 = 2*U_sb_01*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0202*(IT_0008 + 1./3*IT_0007*IT_0203))*conj
      (U_sb_01) + 1./2*IT_0006*IT_0008*IT_0021*IT_0198*conj(U_sb_11)) + U_sb_11*
      (IT_0006*IT_0008*IT_0021*IT_0198*conj(U_sb_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0202*IT_0203)*conj(U_sb_11
    ...
    const ccomplex_t IT_0295 = IT_0288*IT_0294;
    const ccomplex_t IT_0296 = IT_0188*IT_0295;
    const ccomplex_t IT_0297 = (0 + _Complex_I*1)*IT_0296;
    const ccomplex_t IT_0298 = m_b*conj(N_d3)*e_em*IT_0010*U_sb_10;
    const ccomplex_t IT_0299 = IT_0009*IT_0298;
    const ccomplex_t IT_0300 = 1.4142135623731*IT_0299;
    const ccomplex_t IT_0301 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0302 = IT_0008*IT_0301;
    const ccomplex_t IT_0303 = 1.4142135623731*IT_0302;
    const ccomplex_t IT_0304 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0310 = 2*conj(U_sb_00)*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + (-0.5)*m_W*IT_0202*(IT_0008 + 1./3*IT_0007*IT_0203))
      *U_sb_01 + 1./2*IT_0006*IT_0008*IT_0021*IT_0198*U_sb_11) + conj(U_sb_10)*
      (IT_0006*IT_0008*IT_0021*IT_0198*U_sb_01 + 2*(IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0025 + -1./3*m_W*IT_0007*IT_0202*IT_0203)*U_sb_11);
    ...
    const ccomplex_t IT_0314 = IT_0210*IT_0313;
    const ccomplex_t IT_0315 = (0 + _Complex_I*1)*IT_0314;
    const ccomplex_t IT_0316 = IT_0227*IT_0288;
    const ccomplex_t IT_0317 = IT_0225*IT_0316;
    const ccomplex_t IT_0318 = (0 + _Complex_I*1)*IT_0317;
    const ccomplex_t IT_0319 = m_b*IT_0318;
    const ccomplex_t IT_0320 = m_N_3*IT_0047;
    const ccomplex_t IT_0321 = m_N_1*IT_0069;
    const ccomplex_t IT_0322 = IT_0320 + IT_0321;
    const ccomplex_t IT_0323 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0324 = IT_0001*IT_0323;
    const ccomplex_t IT_0325 = 1.4142135623731*IT_0324;
    const ccomplex_t IT_0326 = conj(N_W1)*e_em*U_sb_01;
    const ccomplex_t IT_0327 = IT_0008*IT_0326;
    const ccomplex_t IT_0328 = 1.4142135623731*IT_0327;
    const ccomplex_t IT_0329 = m_b*conj(N_d1)*e_em*IT_0010*U_sb_11;
    ...
    const ccomplex_t IT_0336 = IT_0322*IT_0335;
    const ccomplex_t IT_0337 = m_N_3*IT_0150;
    const ccomplex_t IT_0338 = m_N_2*IT_0172;
    const ccomplex_t IT_0339 = IT_0337 + IT_0338;
    const ccomplex_t IT_0340 = m_b*conj(N_d2)*e_em*IT_0010*U_sb_11;
    const ccomplex_t IT_0341 = IT_0009*IT_0340;
    const ccomplex_t IT_0342 = 1.4142135623731*IT_0341;
    const ccomplex_t IT_0343 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0344 = IT_0008*IT_0343;
    const ccomplex_t IT_0345 = 1.4142135623731*IT_0344;
    const ccomplex_t IT_0346 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0352 = IT_0183*IT_0351;
    const ccomplex_t IT_0353 = (0 + _Complex_I*1)*IT_0352;
    const ccomplex_t IT_0354 = IT_0339*IT_0353;
    const ccomplex_t IT_0355 = -IT_0277 + -IT_0291 + -IT_0297 + -IT_0315 + 2
      *IT_0319 + -IT_0336 + -IT_0354;
    const ccomplex_t IT_0356 = 6*s_13;
    const ccomplex_t IT_0357 = m_b*m_N_3;
    const ccomplex_t IT_0358 = 6*IT_0259;
    const ccomplex_t IT_0359 = IT_0241*IT_0290;
    const ccomplex_t IT_0360 = IT_0150*IT_0353;
    const ccomplex_t IT_0361 = IT_0104*IT_0273;
    const ccomplex_t IT_0362 = IT_0047*IT_0335;
    const ccomplex_t IT_0363 = -IT_0230 + IT_0359 + IT_0360 + IT_0361 + IT_0362;
    const ccomplex_t IT_0364 = m_b*s_14;
    const ccomplex_t IT_0365 = IT_0172*IT_0185;
    const ccomplex_t IT_0366 = IT_0252*IT_0257;
    const ccomplex_t IT_0367 = IT_0020*IT_0069;
    const ccomplex_t IT_0368 = IT_0083*IT_0126;
    const ccomplex_t IT_0369 = IT_0318 + -IT_0365 + -IT_0366 + -IT_0367 + 
      -IT_0368;
    const ccomplex_t IT_0370 = s_34*m_N_3;
    const ccomplex_t IT_0371 = 6*conj(IT_0259);
    const ccomplex_t IT_0372 = 6*conj(IT_0355);
    const ccomplex_t IT_0373 = pow(m_h, 2);
    const ccomplex_t IT_0374 = m_b*m_N_3*IT_0373;
