        ...
        )
{
    ...
    const ccomplex_t IT_0026 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0027 = IT_0005*IT_0026;
    const ccomplex_t IT_0028 = 1.4142135623731*IT_0027;
    const ccomplex_t IT_0029 = m_t*N_u3*e_em*IT_0012*U_st_00;
    ...
    const ccomplex_t IT_0072 = conj(N_B3)*e_em*U_st_01;
    const ccomplex_t IT_0073 = IT_0005*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W3)*e_em*U_st_01;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_t*conj(N_u3)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0089 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0090 = IT_0001*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = m_t*conj(N_u3)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0109 = cpow((-2)*s_12 + -IT_0019 + -IT_0038 + IT_0108 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0131 = IT_0101*IT_0130;
    const ccomplex_t IT_0132 = 3*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0134 = IT_0001*IT_0133;
    const ccomplex_t IT_0135 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0140 = m_b*conj(U_d1)*V_tb*e_em*IT_0012*U_sb_11;
    const ccomplex_t IT_0141 = IT_0114*IT_0140;
    const ccomplex_t IT_0142 = 1.4142135623731*IT_0141;
    const ccomplex_t IT_0143 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    const ccomplex_t IT_0144 = IT_0001*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*(IT_0142 + (-2)*IT_0144);
    ...
    const ccomplex_t IT_0150 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0151 = IT_0001*IT_0150;
    const ccomplex_t IT_0152 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0157 = m_b*conj(U_d2)*V_tb*e_em*IT_0012*U_sb_11;
    const ccomplex_t IT_0158 = IT_0114*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    const ccomplex_t IT_0161 = IT_0001*IT_0160;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*(IT_0159 + (-2)*IT_0161);
    ...
    const ccomplex_t IT_0167 = -IT_0149 + -IT_0166;
    const ccomplex_t IT_0168 = (-3)*IT_0131;
    const ccomplex_t IT_0169 = -IT_0023 + -IT_0037;
    ...
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*m_b;
    ...
    const ccomplex_t IT_0192 = m_b*N_d3*e_em*IT_0012*U_sb_01;
    const ccomplex_t IT_0193 = IT_0114*IT_0192;
    ...
    const ccomplex_t IT_0203 = IT_0111*IT_0202;
    const ccomplex_t IT_0204 = IT_0109*IT_0188*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0206 = IT_0046*IT_0146;
    const ccomplex_t IT_0207 = IT_0039*IT_0205*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0209 = IT_0059*IT_0163;
    const ccomplex_t IT_0210 = IT_0052*IT_0208*IT_0209;
    const ccomplex_t IT_0211 = -IT_0204 + -IT_0207 + -IT_0210;
    const ccomplex_t IT_0212 = IT_0149 + IT_0166;
    const ccomplex_t IT_0213 = m_N_3*IT_0212;
    const ccomplex_t IT_0214 = IT_0211 + IT_0213;
    const ccomplex_t IT_0215 = s_34*IT_0130;
    const ccomplex_t IT_0216 = IT_0066*IT_0215;
    ...
    const ccomplex_t IT_0221 = m_N_3*IT_0051;
    const ccomplex_t IT_0222 = m_N_3*IT_0064;
    const ccomplex_t IT_0223 = m_t*IT_0129;
    const ccomplex_t IT_0224 = -IT_0221 + -IT_0222 + -IT_0223;
    const ccomplex_t IT_0225 = IT_0048*IT_0139;
    const ccomplex_t IT_0226 = IT_0039*IT_0205*IT_0225;
    const ccomplex_t IT_0227 = IT_0061*IT_0156;
    const ccomplex_t IT_0228 = IT_0052*IT_0208*IT_0227;
    const ccomplex_t IT_0229 = IT_0226 + IT_0228;
    const ccomplex_t IT_0230 = IT_0224 + IT_0229;
    const ccomplex_t IT_0231 = (-18)*conj(IT_0211);
    const ccomplex_t IT_0232 = s_14*s_34*IT_0066;
    const ccomplex_t IT_0233 = -IT_0232;
    const ccomplex_t IT_0234 = s_13 + IT_0233;
    const ccomplex_t IT_0235 = s_13*IT_0234;
    const ccomplex_t IT_0236 = 2*IT_0149 + 2*IT_0166;
    const ccomplex_t IT_0237 = IT_0085 + IT_0099 + 2*IT_0129;
    const ccomplex_t IT_0238 = IT_0101*IT_0234;
    const ccomplex_t IT_0239 = m_N_3*IT_0234;
    const ccomplex_t IT_0240 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0241 = 0.5*IT_0216;
    ...
    const ccomplex_t IT_0246 = IT_0179 + IT_0245;
    ...
    const ccomplex_t IT_0251 = m_t*IT_0234;
    const ccomplex_t IT_0252 = (-6)*IT_0169;
    const ccomplex_t IT_0253 = pow(s_34, 2);
    const ccomplex_t IT_0254 = IT_0066*IT_0253;
    const ccomplex_t IT_0255 = -IT_0254;
    const ccomplex_t IT_0256 = IT_0018 + IT_0255;
    const ccomplex_t IT_0257 = IT_0101*IT_0256;
    const ccomplex_t IT_0258 = m_N_3*IT_0256;
    const ccomplex_t IT_0259 = (-6)*conj(IT_0169);
    const ccomplex_t IT_0260 = (-6)*IT_0176;
    const ccomplex_t IT_0261 = IT_0178 + IT_0260;
    const ccomplex_t IT_0262 = (-6)*IT_0100;
    const ccomplex_t IT_0263 = 0.166666666666667*IT_0262;
    const ccomplex_t IT_0264 = IT_0236 + IT_0263;
    const ccomplex_t IT_0265 = (-0.25)*IT_0183;
    const ccomplex_t IT_0266 = s_14 + IT_0265;
    const ccomplex_t IT_0267 = m_t*IT_0266;
    const ccomplex_t IT_0268 = (-4)*IT_0267;
    const ccomplex_t IT_0269 = (-6)*IT_0237;
    const ccomplex_t IT_0270 = IT_0129 + IT_0167;
    const ccomplex_t IT_0271 = (-6)*conj(IT_0237);
    const ccomplex_t IT_0272 = (-6)*IT_0211;
    const ccomplex_t IT_0273 = (-6)*conj(IT_0167)*(IT_0103*IT_0168 + (
      -0.166666666666667)*IT_0167*IT_0181 + IT_0187*IT_0230 + (
      -0.166666666666667)*IT_0129*IT_0261 + -IT_0107*IT_0264 + (
      -0.166666666666667)*IT_0173*IT_0269 + IT_0220*(IT_0213 + (
      -0.166666666666667)*IT_0272));
    const ccomplex_t IT_0274 = (-6)*conj(IT_0211);
    const ccomplex_t IT_0275 = (-6)*conj(IT_0236);
    const ccomplex_t IT_0276 = m_t*IT_0070;
    const ccomplex_t IT_0277 = 6*IT_0276;
    const ccomplex_t IT_0278 = (-6)*IT_0065;
    const ccomplex_t IT_0279 = 6*IT_0103;
    const ccomplex_t IT_0280 = (-6)*IT_0236;
    const ccomplex_t IT_0281 = 6*IT_0129;
    const ccomplex_t IT_0282 = (-6)*IT_0167;
    const ccomplex_t IT_0283 = IT_0101*((-18)*IT_0211 + (-18)*IT_0213) +
       IT_0230*IT_0250 + IT_0252*IT_0258 + IT_0251*IT_0269 + IT_0239*IT_0278 +
       IT_0220*IT_0279 + IT_0277*(IT_0100 + 0.166666666666667*IT_0280) + IT_0268
      *IT_0281 + IT_0187*IT_0282;
    const ccomplex_t IT_0284 = IT_0101*((-18)*IT_0224 + (-18)*IT_0229) +
       IT_0214*IT_0250 + IT_0251*IT_0252 + 6*IT_0239*IT_0264 + IT_0258*IT_0269 +
       6*IT_0065*IT_0276 + IT_0187*IT_0279 + IT_0244*IT_0281 + IT_0220*IT_0282;
    ...
    const ccomplex_t IT_0288 = (-6)*conj(IT_0100);
    const ccomplex_t IT_0289 = IT_0107*IT_0270;
    const ccomplex_t IT_0290 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0100
      *IT_0102 + IT_0103*IT_0107) + 6*conj(IT_0103)*(IT_0065*IT_0107 + IT_0129
      *IT_0132 + -IT_0167*IT_0168 + IT_0169*IT_0173 + 0.166666666666667*IT_0103
      *IT_0181 + IT_0187*IT_0214 + IT_0220*IT_0230) + IT_0101*IT_0230*IT_0231 + 
      (IT_0169*IT_0235 + IT_0102*IT_0236 + IT_0237*IT_0238 + IT_0230*IT_0239)
      *IT_0240 + 6*conj(IT_0211)*(IT_0103*IT_0187 + IT_0236*IT_0239 + IT_0129
      *IT_0244 + 0.166666666666667*IT_0214*IT_0250 + 0.166666666666667*IT_0251
      *IT_0252) + (IT_0100*IT_0238 + IT_0214*IT_0251 + IT_0237*IT_0257 + IT_0230
      *IT_0258)*IT_0259 + 6*conj(IT_0129)*(IT_0103*IT_0132 + 0.166666666666667
      *IT_0129*IT_0181 + IT_0214*IT_0244 + 0.166666666666667*IT_0167*IT_0261 +
       IT_0107*IT_0264 + IT_0230*IT_0268 + 0.166666666666667*IT_0173*IT_0269) + 
      (IT_0230*IT_0251 + IT_0213*IT_0258 + IT_0173*IT_0270)*IT_0271 + IT_0273 + 
      (IT_0167*IT_0220 + IT_0100*IT_0239 + IT_0237*IT_0258)*IT_0274 + (IT_0065
      *conj(IT_0211) + conj(IT_0065)*IT_0214 + IT_0230*(conj(IT_0100) +
       0.166666666666667*IT_0275))*IT_0277 + (conj(IT_0224) + conj(IT_0229))
      *IT_0283 + conj(IT_0213)*IT_0284 + 6*conj(IT_0100)*(IT_0071*IT_0100 +
       IT_0065*IT_0102 + 0.166666666666667*IT_0239*IT_0272 + IT_0252*IT_0285) +
       6*conj(IT_0169)*(IT_0103*IT_0173 + IT_0236*IT_0238 + 0.166666666666667
      *IT_0235*IT_0278 + IT_0252*IT_0287) + 6*conj(IT_0237)*(0.166666666666667
      *IT_0252*IT_0257 + IT_0235*IT_0264 + 0.166666666666667*IT_0258*IT_0272 +
       IT_0278*IT_0285 + IT_0269*IT_0287) + IT_0288*(IT_0071*IT_0236 + IT_0235
      *IT_0237 + IT_0213*IT_0239 + IT_0289) + 6*conj(IT_0236)*(IT_0235*IT_0237 +
       IT_0169*IT_0238 + IT_0214*IT_0239 + IT_0071*IT_0264 + 0.166666666666667
      *IT_0102*IT_0278 + IT_0289);
