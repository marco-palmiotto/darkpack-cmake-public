...
ccomplex_return_t c_sumSqAmpl_N_3_sc_L_to_c_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0046 = m_c*s_14*m_N_3;
    ...
    const ccomplex_t IT_0058 = m_c*m_N_3;
    ...
    const ccomplex_t IT_0063 = m_c*s_34*m_N_3;
