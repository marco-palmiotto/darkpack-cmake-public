        ...
        )
{
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0002*IT_0042;
    const ccomplex_t IT_0044 = (-0.5)*IT_0043;
    const ccomplex_t IT_0045 = pow(m_sc_L, 2);
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_3*
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0000*IT_0002*IT_0042;
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_4*
    ...
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0207 = IT_0175*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*IT_0207;
    const ccomplex_t IT_0209 = m_N_3*IT_0152;
    const ccomplex_t IT_0210 = m_N_4*IT_0170;
    ...
    const ccomplex_t IT_0221 = IT_0046*IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1)*IT_0221;
    const ccomplex_t IT_0223 = IT_0041*IT_0222;
    const ccomplex_t IT_0224 = m_N_3*IT_0109;
    const ccomplex_t IT_0225 = m_N_2*IT_0127;
    ...
    const ccomplex_t IT_0235 = IT_0132*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*IT_0235;
    const ccomplex_t IT_0237 = IT_0226*IT_0236;
    const ccomplex_t IT_0238 = -IT_0184 + -IT_0198 + -IT_0212 + -IT_0223 + 
      -IT_0237;
    ...
    const ccomplex_t IT_0248 = IT_0066*IT_0194;
    const ccomplex_t IT_0249 = IT_0152*IT_0208;
    const ccomplex_t IT_0250 = IT_0029*IT_0222;
    const ccomplex_t IT_0251 = IT_0109*IT_0236;
    ...
    const ccomplex_t IT_0255 = IT_0084*IT_0091;
    const ccomplex_t IT_0256 = IT_0127*IT_0134;
    const ccomplex_t IT_0257 = IT_0220*IT_0244;
    ...
    const ccomplex_t IT_0261 = -IT_0254 + -IT_0255 + -IT_0256 + -IT_0259 + 
      -IT_0260;
