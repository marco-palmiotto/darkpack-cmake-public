...
ccomplex_return_t c_sumSqAmpl_N_3_sc_L_to_c_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0235 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0287 = m_c*m_N_3;
    ...
    const ccomplex_t IT_0304 = m_c*m_N_3*IT_0303;
