...
ccomplex_return_t c_sumSqAmpl_N_3_sc_R_to_c_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (-1.33333333333333)*IT_0008;
    const ccomplex_t IT_0014 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0034 = (-0.666666666666667)*IT_0008;
    ...
    const ccomplex_t IT_0040 = m_c*s_14*m_N_3;
    ...
    const ccomplex_t IT_0052 = m_c*m_N_3;
    ...
    const ccomplex_t IT_0057 = m_c*s_34*m_N_3;
