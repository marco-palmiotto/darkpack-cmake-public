        ...
        )
{
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
    ...
    const ccomplex_t IT_0092 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_3*
    ...
    const ccomplex_t IT_0105 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0106 = IT_0026*IT_0105;
    const ccomplex_t IT_0107 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0108 = IT_0037*IT_0107;
    const ccomplex_t IT_0109 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0110 = IT_0040*IT_0109;
    const ccomplex_t IT_0111 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0220 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0240 = IT_0092*IT_0221;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*IT_0240;
    const ccomplex_t IT_0242 = IT_0115*IT_0241;
    const ccomplex_t IT_0243 = m_N_3*IT_0142;
    const ccomplex_t IT_0244 = m_N_1*IT_0164;
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0008*IT_0010*IT_0013;
    ...
    const ccomplex_t IT_0251 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0008*IT_0010*IT_0013;
    const ccomplex_t IT_0252 = 0.5*IT_0251;
    const ccomplex_t IT_0253 = IT_0170*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = m_N_3*IT_0193;
    const ccomplex_t IT_0256 = m_N_2*IT_0215;
    ...
    const ccomplex_t IT_0263 = m_N_4*IT_0072;
    const ccomplex_t IT_0264 = m_N_3*IT_0050;
    ...
    const ccomplex_t IT_0271 = IT_0142*IT_0249;
    const ccomplex_t IT_0272 = IT_0050*IT_0262;
    const ccomplex_t IT_0273 = IT_0193*IT_0254;
    const ccomplex_t IT_0274 = IT_0103*IT_0241;
    ...
    const ccomplex_t IT_0279 = IT_0094*IT_0113;
