...
ccomplex_return_t c_sumSqAmpl_N_3_sc_R_to_c_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0005;
    ...
    const ccomplex_t IT_0023 = IT_0005*IT_0009;
    ...
    const ccomplex_t IT_0043 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0066 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0067 = IT_0030*IT_0066;
    const ccomplex_t IT_0068 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0069 = IT_0033*IT_0068;
    const ccomplex_t IT_0070 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0071 = IT_0030*IT_0070;
    const ccomplex_t IT_0072 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0079 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0080 = IT_0023*IT_0079;
    const ccomplex_t IT_0081 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0082 = IT_0027*IT_0081;
    const ccomplex_t IT_0083 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0084 = IT_0023*IT_0083;
    const ccomplex_t IT_0085 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0086 = IT_0027*IT_0085;
    const ccomplex_t IT_0087 = IT_0080 + IT_0082 + IT_0084 + IT_0086;
    const ccomplex_t IT_0088 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0089 = IT_0030*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0091 = IT_0033*IT_0090;
    const ccomplex_t IT_0092 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0093 = IT_0030*IT_0092;
    const ccomplex_t IT_0094 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0008
      *IT_0011*IT_0013*IT_0026;
    ...
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0109 = IT_0107*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*IT_0109;
    const ccomplex_t IT_0111 = cpow(IT_0004, -2);
    const ccomplex_t IT_0112 = cos(beta);
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0008
      *IT_0009*IT_0011*IT_0013 + m_W*IT_0012*IT_0111*(IT_0009*IT_0010 + IT_0026
      *IT_0112));
    const ccomplex_t IT_0114 = 0.666666666666667*IT_0113;
    const ccomplex_t IT_0115 = IT_0007*IT_0114;
    const ccomplex_t IT_0116 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0132 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0133 = IT_0030*IT_0132;
    const ccomplex_t IT_0134 = N_W2*N_d3*e_em;
    const ccomplex_t IT_0135 = IT_0033*IT_0134;
    ...
    const ccomplex_t IT_0150 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0151 = IT_0030*IT_0150;
    const ccomplex_t IT_0152 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0153 = IT_0033*IT_0152;
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0005;
    ...
    const ccomplex_t IT_0182 = IT_0033*IT_0181;
    ...
    const ccomplex_t IT_0195 = IT_0027*IT_0194;
    ...
    const ccomplex_t IT_0202 = IT_0030*IT_0201;
    const ccomplex_t IT_0203 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0204 = IT_0033*IT_0203;
    ...
    const ccomplex_t IT_0208 = IT_0033*IT_0207;
    ...
    const ccomplex_t IT_0215 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0005;
    ...
    const ccomplex_t IT_0221 = (-2)*IT_0019 + IT_0051 + IT_0102 + IT_0110 +
    ...
    const ccomplex_t IT_0230 = IT_0104*IT_0229;
    const ccomplex_t IT_0231 = IT_0108*IT_0230;
    ...
    const ccomplex_t IT_0239 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0243 = m_N_3*IT_0077;
    const ccomplex_t IT_0244 = m_N_4*IT_0099;
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = IT_0242*IT_0245;
    const ccomplex_t IT_0247 = IT_0114*IT_0234;
    const ccomplex_t IT_0248 = IT_0116*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0254 = m_N_3*IT_0139;
    const ccomplex_t IT_0255 = m_N_2*IT_0161;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = IT_0253*IT_0256;
    const ccomplex_t IT_0258 = IT_0020*IT_0234;
    ...
    const ccomplex_t IT_0265 = m_N_3*IT_0190;
    const ccomplex_t IT_0266 = m_N_1*IT_0212;
    ...
    const ccomplex_t IT_0271 = m_c*m_N_3;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0037*IT_0259;
    const ccomplex_t IT_0274 = IT_0190*IT_0264;
    const ccomplex_t IT_0275 = IT_0139*IT_0253;
    const ccomplex_t IT_0276 = IT_0077*IT_0242;
    const ccomplex_t IT_0277 = -IT_0018 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_c*s_14;
    const ccomplex_t IT_0279 = IT_0212*IT_0219;
    const ccomplex_t IT_0280 = IT_0056*IT_0099;
    const ccomplex_t IT_0281 = IT_0161*IT_0168;
    const ccomplex_t IT_0282 = IT_0022*IT_0048;
    ...
    const ccomplex_t IT_0288 = m_c*m_N_3*IT_0287;
