        ...
        )
{
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0003 + IT_0047 + -m_ss_L*
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0003 + IT_0047 + -m_ss_R*
    ...
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
