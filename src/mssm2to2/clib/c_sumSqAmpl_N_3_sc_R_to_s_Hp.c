...
ccomplex_return_t c_sumSqAmpl_N_3_sc_R_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_s*m_N_3*IT_0000;
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0000 + IT_0019 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0009*IT_0012;
    const ccomplex_t IT_0022 = N_u3*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
    ...
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0000 + IT_0019 + -m_C_2*
    ...
    const ccomplex_t IT_0072 = conj(IT_0062) + conj(IT_0070);
    ...
    const ccomplex_t IT_0078 = m_s*m_N_3;
    const ccomplex_t IT_0079 = IT_0006*IT_0009;
    const ccomplex_t IT_0080 = conj(N_d3)*e_em*conj(U_Wm2);
    const ccomplex_t IT_0081 = IT_0079*IT_0080;
    const ccomplex_t IT_0082 = (-2)*IT_0081;
    const ccomplex_t IT_0083 = IT_0006*IT_0026;
    const ccomplex_t IT_0084 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0085 = IT_0083*IT_0084;
    const ccomplex_t IT_0086 = 1.4142135623731*IT_0085;
    const ccomplex_t IT_0087 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0096 = IT_0059*IT_0094*IT_0095;
    ...
    const ccomplex_t IT_0111 = IT_0039*IT_0110;
    const ccomplex_t IT_0112 = IT_0020*IT_0097*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*mu_h*IT_0005*IT_0009;
    const ccomplex_t IT_0114 = 0.5*IT_0113;
    const ccomplex_t IT_0115 = conj(N_B3)*e_em;
    const ccomplex_t IT_0116 = IT_0026*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0136 = IT_0011*IT_0064;
    const ccomplex_t IT_0137 = IT_0004*IT_0135*IT_0136;
    const ccomplex_t IT_0138 = m_N_3*IT_0069;
    const ccomplex_t IT_0139 = -IT_0096 + -IT_0112 + -IT_0126 + -IT_0134 +
       IT_0137 + -IT_0138;
    const ccomplex_t IT_0140 = m_N_3*IT_0018;
    const ccomplex_t IT_0141 = (-0.333333333333333)*IT_0065;
    ...
    const ccomplex_t IT_0145 = IT_0015*IT_0066;
    const ccomplex_t IT_0146 = IT_0004*IT_0135*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0005*IT_0009*IT_0013;
    const ccomplex_t IT_0148 = (-0.5)*IT_0147;
    const ccomplex_t IT_0149 = IT_0114*IT_0148;
    const ccomplex_t IT_0150 = IT_0124*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*IT_0150;
    const ccomplex_t IT_0152 = IT_0140 + IT_0144 + -IT_0146 + IT_0151;
    const ccomplex_t IT_0153 = 6*IT_0152;
    const ccomplex_t IT_0154 = IT_0042 + IT_0061;
