        ...
        )
{
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
    ...
    const ccomplex_t IT_0248 = m_d*e_em*IT_0001*IT_0002*IT_0005*IT_0021;
