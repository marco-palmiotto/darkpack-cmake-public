...
ccomplex_return_t c_sumSqAmpl_N_3_sd_L_to_d_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
    ...
    const ccomplex_t IT_0104 = conj(N_B3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0108 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
    ...
    const ccomplex_t IT_0164 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0219 = IT_0065 + IT_0074 + IT_0084 + (-2)*IT_0091 +
       IT_0116 + IT_0167 + IT_0218;
    const ccomplex_t IT_0220 = 6*s_13;
    ...
    const ccomplex_t IT_0229 = IT_0086*IT_0228;
    const ccomplex_t IT_0230 = IT_0088*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1)*IT_0230;
    const ccomplex_t IT_0232 = IT_0110*IT_0115;
    const ccomplex_t IT_0233 = IT_0011*IT_0062;
    const ccomplex_t IT_0234 = IT_0159*IT_0166;
    const ccomplex_t IT_0235 = IT_0172*IT_0215;
    const ccomplex_t IT_0236 = IT_0231 + -IT_0232 + -IT_0233 + -IT_0234 + 
      -IT_0235;
    const ccomplex_t IT_0237 = m_d*s_14;
    const ccomplex_t IT_0238 = IT_0113*IT_0228;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*IT_0238;
    const ccomplex_t IT_0240 = IT_0100*IT_0239;
    const ccomplex_t IT_0241 = conj(N_B4)*e_em;
    const ccomplex_t IT_0242 = IT_0014*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0271 = IT_0164*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*IT_0271;
    const ccomplex_t IT_0273 = IT_0137*IT_0272;
    const ccomplex_t IT_0274 = -IT_0090 + IT_0240 + IT_0251 + IT_0262 + IT_0273;
    const ccomplex_t IT_0275 = s_34*m_N_3;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0277 = 0.5*IT_0276;
    const ccomplex_t IT_0278 = IT_0067*IT_0277;
    const ccomplex_t IT_0279 = IT_0072*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*IT_0279;
    const ccomplex_t IT_0281 = IT_0078*IT_0228;
    const ccomplex_t IT_0282 = IT_0082*IT_0281;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1)*IT_0282;
    const ccomplex_t IT_0284 = m_d*IT_0231;
    const ccomplex_t IT_0285 = m_N_3*IT_0137;
    const ccomplex_t IT_0286 = m_N_2*IT_0159;
    const ccomplex_t IT_0287 = IT_0285 + IT_0286;
    const ccomplex_t IT_0288 = IT_0272*IT_0287;
    const ccomplex_t IT_0289 = IT_0112*IT_0239;
    const ccomplex_t IT_0290 = m_N_3*IT_0040;
    const ccomplex_t IT_0291 = m_N_1*IT_0062;
    const ccomplex_t IT_0292 = IT_0290 + IT_0291;
    const ccomplex_t IT_0293 = IT_0261*IT_0292;
    const ccomplex_t IT_0294 = m_N_3*IT_0193;
    const ccomplex_t IT_0295 = m_N_4*IT_0215;
    const ccomplex_t IT_0296 = IT_0294 + IT_0295;
    const ccomplex_t IT_0297 = IT_0250*IT_0296;
    const ccomplex_t IT_0298 = -IT_0280 + -IT_0283 + 2*IT_0284 + -IT_0288 + 
      -IT_0289 + -IT_0293 + -IT_0297;
    const ccomplex_t IT_0299 = 6*conj(IT_0298);
    const ccomplex_t IT_0300 = m_d*m_N_3;
    const ccomplex_t IT_0301 = 6*IT_0219;
    const ccomplex_t IT_0302 = 6*conj(IT_0219);
    const ccomplex_t IT_0303 = pow(m_H0, 2);
    const ccomplex_t IT_0304 = m_d*m_N_3*IT_0303;
    ...
    const ccomplex_t IT_0309 = 6*IT_0298;
    const ccomplex_t IT_0310 = 0.166666666666667*IT_0275;
    const ccomplex_t IT_0311 = IT_0219*conj(IT_0219)*IT_0220 + (IT_0236
      *IT_0237 + IT_0274*IT_0275)*IT_0299 + conj(IT_0298)*(IT_0220*IT_0298 +
       IT_0300*IT_0301) + (IT_0237*IT_0274 + IT_0236*IT_0275 + IT_0298*IT_0300)
      *IT_0302 + 6*conj(IT_0236)*(IT_0274*IT_0304 + -IT_0236*IT_0308 +
       0.166666666666667*IT_0237*IT_0309 + IT_0301*IT_0310) + 6*conj(IT_0274)*
      (0.166666666666667*IT_0237*IT_0301 + IT_0236*IT_0304 + -IT_0274*IT_0308 +
       IT_0309*IT_0310);
