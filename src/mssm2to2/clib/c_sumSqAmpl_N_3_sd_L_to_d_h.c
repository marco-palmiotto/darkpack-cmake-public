...
ccomplex_return_t c_sumSqAmpl_N_3_sd_L_to_d_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(m_d*e_em*mu_h*IT_0000
      *IT_0002*IT_0004*IT_0012 + 1.4142135623731*A_b*V_td*conj(V_td)*IT_0018);
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_sd_R*
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0079 = (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = IT_0077*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_d*e_em*IT_0000*IT_0002
      *IT_0004*IT_0018;
    const ccomplex_t IT_0085 = 0.5*IT_0084;
    const ccomplex_t IT_0086 = IT_0079*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0071 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0093 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0094 = IT_0019*IT_0093;
    const ccomplex_t IT_0095 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0096 = IT_0027*IT_0095;
    const ccomplex_t IT_0097 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0102 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0103 = IT_0015*IT_0102;
    const ccomplex_t IT_0104 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0105 = IT_0019*IT_0104;
    const ccomplex_t IT_0106 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0107 = IT_0027*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0114 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0115 = IT_0079*IT_0114;
    ...
    const ccomplex_t IT_0142 = conj(N_B2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0146 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0147 = IT_0019*IT_0146;
    const ccomplex_t IT_0148 = IT_0141 + IT_0143 + IT_0145 + IT_0147;
    const ccomplex_t IT_0149 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0150 = IT_0027*IT_0149;
    const ccomplex_t IT_0151 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0152 = IT_0030*IT_0151;
    const ccomplex_t IT_0153 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0154 = IT_0027*IT_0153;
    const ccomplex_t IT_0155 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0163 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0164 = (-0.5)*IT_0163;
    const ccomplex_t IT_0165 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0171 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0220 = IT_0065 + IT_0074 + IT_0083 + (-2)*IT_0090 +
    ...
    const ccomplex_t IT_0230 = IT_0085*IT_0229;
    const ccomplex_t IT_0231 = IT_0087*IT_0230;
    const ccomplex_t IT_0232 = (0 + _Complex_I*1)*IT_0231;
    const ccomplex_t IT_0233 = IT_0111*IT_0116;
    const ccomplex_t IT_0234 = IT_0011*IT_0062;
    const ccomplex_t IT_0235 = IT_0160*IT_0167;
    const ccomplex_t IT_0236 = IT_0173*IT_0216;
    const ccomplex_t IT_0237 = IT_0232 + -IT_0233 + -IT_0234 + -IT_0235 + 
      -IT_0236;
    const ccomplex_t IT_0238 = m_d*s_14;
    const ccomplex_t IT_0239 = IT_0114*IT_0229;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*IT_0239;
    const ccomplex_t IT_0241 = IT_0100*IT_0240;
    const ccomplex_t IT_0242 = conj(N_B4)*e_em;
    const ccomplex_t IT_0243 = IT_0014*IT_0242;
    const ccomplex_t IT_0244 = 1.4142135623731*IT_0243;
    const ccomplex_t IT_0245 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0250 = IT_0171*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = IT_0194*IT_0251;
    const ccomplex_t IT_0253 = conj(N_B1)*e_em;
    const ccomplex_t IT_0254 = IT_0014*IT_0253;
    const ccomplex_t IT_0255 = 1.4142135623731*IT_0254;
    const ccomplex_t IT_0256 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0263 = IT_0040*IT_0262;
    const ccomplex_t IT_0264 = conj(N_B2)*e_em;
    const ccomplex_t IT_0265 = IT_0014*IT_0264;
    const ccomplex_t IT_0266 = 1.4142135623731*IT_0265;
    const ccomplex_t IT_0267 = conj(N_W2)*e_em;
    const ccomplex_t IT_0268 = IT_0004*IT_0267;
    const ccomplex_t IT_0269 = 1.4142135623731*IT_0268;
    const ccomplex_t IT_0270 = (0 + _Complex_I*1)*(IT_0266 + (-3)*IT_0269);
    const ccomplex_t IT_0271 = 0.166666666666667*IT_0270;
    const ccomplex_t IT_0272 = IT_0165*IT_0271;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*IT_0272;
    const ccomplex_t IT_0274 = IT_0138*IT_0273;
    const ccomplex_t IT_0275 = -IT_0089 + IT_0241 + IT_0252 + IT_0263 + IT_0274;
    const ccomplex_t IT_0276 = s_34*m_N_3;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0278 = 0.5*IT_0277;
    const ccomplex_t IT_0279 = IT_0067*IT_0278;
    const ccomplex_t IT_0280 = IT_0072*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = IT_0077*IT_0229;
    const ccomplex_t IT_0283 = IT_0081*IT_0282;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = m_d*IT_0232;
    const ccomplex_t IT_0286 = m_N_3*IT_0138;
    const ccomplex_t IT_0287 = m_N_2*IT_0160;
    const ccomplex_t IT_0288 = IT_0286 + IT_0287;
    const ccomplex_t IT_0289 = IT_0273*IT_0288;
    const ccomplex_t IT_0290 = IT_0113*IT_0240;
    const ccomplex_t IT_0291 = m_N_3*IT_0040;
    const ccomplex_t IT_0292 = m_N_1*IT_0062;
    const ccomplex_t IT_0293 = IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = IT_0262*IT_0293;
    const ccomplex_t IT_0295 = m_N_3*IT_0194;
    const ccomplex_t IT_0296 = m_N_4*IT_0216;
    const ccomplex_t IT_0297 = IT_0295 + IT_0296;
    const ccomplex_t IT_0298 = IT_0251*IT_0297;
    const ccomplex_t IT_0299 = -IT_0281 + -IT_0284 + 2*IT_0285 + -IT_0289 + 
      -IT_0290 + -IT_0294 + -IT_0298;
    const ccomplex_t IT_0300 = 6*conj(IT_0299);
    const ccomplex_t IT_0301 = m_d*m_N_3;
    const ccomplex_t IT_0302 = 6*IT_0220;
    const ccomplex_t IT_0303 = 6*conj(IT_0220);
    const ccomplex_t IT_0304 = pow(m_h, 2);
    const ccomplex_t IT_0305 = m_d*m_N_3*IT_0304;
