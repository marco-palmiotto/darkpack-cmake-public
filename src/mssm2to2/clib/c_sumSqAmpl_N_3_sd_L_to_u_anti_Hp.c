...
ccomplex_return_t c_sumSqAmpl_N_3_sd_L_to_u_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0014 + IT_0019 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0002*IT_0005;
    const ccomplex_t IT_0022 = N_d3*e_em*U_Wm1;
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0000*IT_0003*IT_0005;
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = IT_0037*IT_0039;
    const ccomplex_t IT_0041 = IT_0018*IT_0020*IT_0040;
    ...
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0014 + IT_0019 + -m_C_2*
    ...
    const ccomplex_t IT_0067 = IT_0026*IT_0066;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
    ...
    const ccomplex_t IT_0083 = cpow((-2)*s_13 + IT_0013 + IT_0019 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0005*(IT_0000*IT_0002*IT_0008*IT_0012 + (-2)*IT_0001*(m_W*IT_0002 + (
      -0.5)*IT_0000*IT_0003*IT_0019));
    const ccomplex_t IT_0092 = 0.5*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0000*IT_0003*IT_0005;
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = IT_0092*IT_0094;
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0013 + IT_0019 + -m_su_L*
    ...
    const ccomplex_t IT_0099 = -IT_0017 + IT_0041 + IT_0060 + -IT_0065 +
       IT_0077 + IT_0085 + -IT_0090 + IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0106 = conj(N_u3)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0107 = IT_0105*IT_0106;
    const ccomplex_t IT_0108 = 2*IT_0107;
    const ccomplex_t IT_0109 = IT_0001*IT_0026;
    const ccomplex_t IT_0110 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0111 = IT_0109*IT_0110;
    const ccomplex_t IT_0112 = 1.4142135623731*IT_0111;
    const ccomplex_t IT_0113 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0121 = IT_0018*IT_0020*IT_0120;
    const ccomplex_t IT_0122 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0123 = IT_0105*IT_0122;
    const ccomplex_t IT_0124 = 2*IT_0123;
    const ccomplex_t IT_0125 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0126 = IT_0109*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0137 = IT_0039*IT_0119;
    ...
    const ccomplex_t IT_0141 = IT_0043*IT_0134;
    ...
    const ccomplex_t IT_0151 = IT_0073*IT_0146;
    const ccomplex_t IT_0152 = IT_0015*IT_0016*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*(IT_0068 + 3*IT_0071);
