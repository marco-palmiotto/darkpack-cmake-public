        ...
        )
{
    ...
    const ccomplex_t IT_0023 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0024 = IT_0004*IT_0023;
    const ccomplex_t IT_0025 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_12 + -IT_0016 + -IT_0037 + IT_0070 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0132 = IT_0013*IT_0092;
    ...
    const ccomplex_t IT_0147 = m_N_3*IT_0019;
    const ccomplex_t IT_0148 = m_u*IT_0077;
    const ccomplex_t IT_0149 = m_N_3*IT_0032;
    const ccomplex_t IT_0150 = -IT_0147 + -IT_0148 + -IT_0149;
    const ccomplex_t IT_0151 = IT_0022*IT_0088;
    const ccomplex_t IT_0152 = IT_0020*IT_0134*IT_0151;
    const ccomplex_t IT_0153 = IT_0006*IT_0099;
    const ccomplex_t IT_0154 = IT_0017*IT_0131*IT_0153;
