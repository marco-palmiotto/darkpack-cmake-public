...
ccomplex_return_t c_sumSqAmpl_N_3_sd_R_to_d_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_R*
    ...
    const ccomplex_t IT_0040 = m_d*s_14*m_N_3;
    ...
    const ccomplex_t IT_0052 = m_d*m_N_3;
    ...
    const ccomplex_t IT_0057 = m_d*s_34*m_N_3;
