        ...
        )
{
    ...
    const ccomplex_t IT_0195 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
    ...
    const ccomplex_t IT_0199 = m_N_3*IT_0070;
    const ccomplex_t IT_0200 = m_N_1*IT_0088;
    const ccomplex_t IT_0201 = IT_0199 + IT_0200;
    const ccomplex_t IT_0202 = IT_0198*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0204 = 0.5*IT_0203;
    const ccomplex_t IT_0205 = IT_0136*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*IT_0205;
    const ccomplex_t IT_0207 = m_N_3*IT_0113;
    const ccomplex_t IT_0208 = m_N_2*IT_0131;
    const ccomplex_t IT_0209 = IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = IT_0206*IT_0209;
    const ccomplex_t IT_0211 = m_N_3*IT_0161;
    const ccomplex_t IT_0212 = m_N_4*IT_0179;
    const ccomplex_t IT_0213 = IT_0211 + IT_0212;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0219 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0224 = -IT_0194 + -IT_0202 + -IT_0210 + -IT_0218 + 
      -IT_0223;
    const ccomplex_t IT_0225 = 6*s_13;
    const ccomplex_t IT_0226 = m_d*m_N_3;
    const ccomplex_t IT_0227 = 6*IT_0183;
    const ccomplex_t IT_0228 = IT_0113*IT_0206;
    const ccomplex_t IT_0229 = IT_0161*IT_0217;
    ...
    const ccomplex_t IT_0233 = cpow((-2)*s_12 + IT_0015 + -IT_0016 + -IT_0024 
      + -reg_prop, -1);
    const ccomplex_t IT_0234 = IT_0232*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = IT_0040*IT_0222;
    const ccomplex_t IT_0237 = IT_0070*IT_0198;
    ...
    const ccomplex_t IT_0241 = IT_0220*IT_0231;
    const ccomplex_t IT_0242 = IT_0233*IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*IT_0242;
    const ccomplex_t IT_0244 = IT_0088*IT_0095;
    const ccomplex_t IT_0245 = IT_0131*IT_0138;
    const ccomplex_t IT_0246 = IT_0027*IT_0050;
    const ccomplex_t IT_0247 = -IT_0240 + -IT_0243 + -IT_0244 + -IT_0245 + 
      -IT_0246;
