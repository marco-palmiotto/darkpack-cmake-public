...
ccomplex_return_t c_sumSqAmpl_N_3_sd_R_to_d_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_sd_R*
    ...
    const ccomplex_t IT_0039 = m_d*s_14*m_N_3;
    ...
    const ccomplex_t IT_0051 = m_d*m_N_3;
    ...
    const ccomplex_t IT_0056 = m_d*s_34*m_N_3;
