...
ccomplex_return_t c_sumSqAmpl_N_3_sd_R_to_d_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0003 + -m_d*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0028);
    ...
    const ccomplex_t IT_0239 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0259 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0269 = m_d*m_N_3;
    ...
    const ccomplex_t IT_0286 = m_d*m_N_3*IT_0285;
