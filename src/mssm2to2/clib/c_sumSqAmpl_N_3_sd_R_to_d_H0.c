        ...
        )
{
    ...
    const ccomplex_t IT_0220 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
    ...
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0011*IT_0039*IT_0041;
    ...
    const ccomplex_t IT_0249 = m_N_3*IT_0193;
    ...
    const ccomplex_t IT_0272 = IT_0142*IT_0229;
    const ccomplex_t IT_0273 = IT_0193*IT_0248;
