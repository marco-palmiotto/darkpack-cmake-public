        ...
        )
{
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0003 + m_d*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0025);
    ...
    const ccomplex_t IT_0143 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0144 = IT_0026*IT_0143;
    const ccomplex_t IT_0145 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0146 = IT_0029*IT_0145;
    const ccomplex_t IT_0147 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0148 = IT_0037*IT_0147;
    const ccomplex_t IT_0149 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0156 = conj(N_B3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0160 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0166 = cpow((-2)*s_23 + IT_0013 + IT_0015 + -m_N_3*
    ...
    const ccomplex_t IT_0238 = m_N_4*IT_0072;
    const ccomplex_t IT_0239 = IT_0237 + IT_0238;
    const ccomplex_t IT_0240 = IT_0236*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0247 = m_N_3*IT_0101;
    const ccomplex_t IT_0248 = m_N_1*IT_0123;
    const ccomplex_t IT_0249 = IT_0247 + IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0255 = IT_0138*IT_0242;
    const ccomplex_t IT_0256 = IT_0140*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0166*IT_0242;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*IT_0258;
    const ccomplex_t IT_0260 = IT_0165*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0266 = m_N_2*IT_0217;
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = IT_0264*IT_0267;
    const ccomplex_t IT_0269 = -IT_0232 + -IT_0240 + 2*IT_0246 + -IT_0254 + 
    ...
    const ccomplex_t IT_0273 = IT_0152*IT_0259;
    const ccomplex_t IT_0274 = IT_0101*IT_0253;
    const ccomplex_t IT_0275 = IT_0050*IT_0236;
    const ccomplex_t IT_0276 = IT_0195*IT_0264;
    ...
    const ccomplex_t IT_0281 = IT_0163*IT_0168;
