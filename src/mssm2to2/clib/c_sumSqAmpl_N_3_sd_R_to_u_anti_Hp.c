        ...
        )
{
    ...
    const ccomplex_t IT_0023 = N_W3*U_d2*e_em;
    const ccomplex_t IT_0024 = IT_0022*IT_0023;
    const ccomplex_t IT_0025 = 1.4142135623731*IT_0024;
    const ccomplex_t IT_0026 = IT_0002*IT_0009;
    const ccomplex_t IT_0027 = N_B3*U_d2*e_em;
    ...
    const ccomplex_t IT_0031 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0015 + IT_0038 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0037*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = m_u*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0000*IT_0003*IT_0005*IT_0019;
    const ccomplex_t IT_0044 = 0.5*IT_0043;
    const ccomplex_t IT_0045 = 0.666666666666667*IT_0010;
    const ccomplex_t IT_0046 = IT_0044*IT_0045;
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0014 + IT_0038 + -m_su_R*
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0014 + IT_0038 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0015 + IT_0038 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0065 = N_d3*e_em*U_Wm1;
    const ccomplex_t IT_0066 = IT_0022*IT_0065;
    const ccomplex_t IT_0067 = (-2)*IT_0066;
    const ccomplex_t IT_0068 = N_B3*U_d1*e_em;
    const ccomplex_t IT_0069 = IT_0026*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = N_W3*U_d1*e_em;
    ...
    const ccomplex_t IT_0084 = -IT_0018 + -IT_0042 + IT_0049 + IT_0055 +
       IT_0063 + -IT_0083;
    const ccomplex_t IT_0085 = IT_0001*IT_0005;
    const ccomplex_t IT_0086 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = 2*IT_0087;
    const ccomplex_t IT_0089 = IT_0001*IT_0009;
    const ccomplex_t IT_0090 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0091 = IT_0089*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0126 = conj(N_u3)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0127 = IT_0085*IT_0126;
    const ccomplex_t IT_0128 = 2*IT_0127;
    const ccomplex_t IT_0129 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0130 = IT_0089*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0140 = IT_0064*IT_0125*IT_0139;
    const ccomplex_t IT_0141 = IT_0051*IT_0104;
    const ccomplex_t IT_0142 = IT_0016*IT_0017*IT_0141;
    const ccomplex_t IT_0143 = IT_0102 + -IT_0108 + -IT_0119 + -IT_0124 +
       IT_0140 + IT_0142;
    const ccomplex_t IT_0144 = 6*s_13;
    const ccomplex_t IT_0145 = m_u*m_N_3;
    const ccomplex_t IT_0146 = 6*IT_0084;
    const ccomplex_t IT_0147 = IT_0041 + IT_0082 + -IT_0107;
    ...
    const ccomplex_t IT_0152 = m_u*m_N_3*IT_0015;
    ...
    const ccomplex_t IT_0161 = (IT_0084*conj(IT_0084) + IT_0143*conj(IT_0143))
      ...
      *IT_0148 + IT_0054*IT_0149)*IT_0150 + (IT_0054*IT_0148 + IT_0147*IT_0149)
      *IT_0151 + 6*conj(IT_0054)*(IT_0147*IT_0152 + 0.166666666666667*IT_0054
      *IT_0157 + IT_0158*IT_0159 + IT_0146*IT_0160) + 6*conj(IT_0147)*(IT_0054
