        ...
        )
{
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_12 + -IT_0001 + -IT_0037 + IT_0041 
      + -reg_prop, -1);
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
    ...
    const ccomplex_t IT_0050 = m_u*IT_0049;
    const ccomplex_t IT_0051 = -IT_0050;
    const ccomplex_t IT_0052 = m_u*IT_0039;
    const ccomplex_t IT_0053 = IT_0019 + IT_0032;
    const ccomplex_t IT_0054 = s_13*s_14;
    const ccomplex_t IT_0055 = s_34*IT_0037;
    const ccomplex_t IT_0056 = -IT_0055;
    const ccomplex_t IT_0057 = IT_0054 + IT_0056;
    const ccomplex_t IT_0058 = 6*IT_0033;
    const ccomplex_t IT_0059 = s_14*s_34*IT_0034;
    ...
    const ccomplex_t IT_0064 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0065 = IT_0004*IT_0064;
    const ccomplex_t IT_0066 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0072 = IT_0002*IT_0063*IT_0071;
    const ccomplex_t IT_0073 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0074 = IT_0004*IT_0073;
    const ccomplex_t IT_0075 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0082 = IT_0020*IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*m_d;
    ...
    const ccomplex_t IT_0089 = IT_0042*IT_0083*IT_0088;
    const ccomplex_t IT_0090 = m_N_3*IT_0019;
    const ccomplex_t IT_0091 = m_N_3*IT_0032;
    const ccomplex_t IT_0092 = -IT_0072 + -IT_0082 + -IT_0089 + IT_0090 +
       IT_0091;
    const ccomplex_t IT_0093 = (-6)*conj(IT_0092);
    const ccomplex_t IT_0094 = 2*IT_0049;
    const ccomplex_t IT_0095 = s_13*IT_0061;
    const ccomplex_t IT_0096 = (-6)*IT_0033;
    const ccomplex_t IT_0097 = s_14*IT_0000;
    const ccomplex_t IT_0098 = s_13*s_34;
    ...
    const ccomplex_t IT_0104 = IT_0000 + IT_0103;
    const ccomplex_t IT_0105 = m_N_3*IT_0104;
    const ccomplex_t IT_0106 = (-6)*conj(IT_0033);
    const ccomplex_t IT_0107 = s_13*IT_0104;
    const ccomplex_t IT_0108 = m_u*IT_0061;
    const ccomplex_t IT_0109 = (-6)*IT_0094;
    const ccomplex_t IT_0110 = m_u*m_N_3;
    ...
    const ccomplex_t IT_0115 = s_34 + IT_0114;
    const ccomplex_t IT_0116 = m_N_3*IT_0115;
    const ccomplex_t IT_0117 = 2*IT_0116;
    const ccomplex_t IT_0118 = s_13*IT_0111;
    ...
    const ccomplex_t IT_0124 = 12*s_13 + IT_0123;
    const ccomplex_t IT_0125 = (-0.25)*IT_0113;
    const ccomplex_t IT_0126 = s_34 + IT_0125;
    const ccomplex_t IT_0127 = m_N_3*IT_0126;
    const ccomplex_t IT_0128 = (-4)*IT_0127;
    const ccomplex_t IT_0129 = 6*conj(IT_0053);
    const ccomplex_t IT_0130 = s_14*IT_0111;
    const ccomplex_t IT_0131 = IT_0034*IT_0130;
    const ccomplex_t IT_0132 = (-0.25)*IT_0131;
    const ccomplex_t IT_0133 = s_14 + IT_0132;
    const ccomplex_t IT_0134 = m_u*IT_0133;
    const ccomplex_t IT_0135 = (-4)*IT_0134;
    const ccomplex_t IT_0136 = 6*conj(IT_0033);
    const ccomplex_t IT_0137 = (-6)*conj(IT_0094);
    const ccomplex_t IT_0138 = 0.5*IT_0131;
    ...
    const ccomplex_t IT_0146 = 24*IT_0119;
    const ccomplex_t IT_0147 = (-12)*IT_0118;
    const ccomplex_t IT_0148 = IT_0145 + IT_0146 + IT_0147;
    const ccomplex_t IT_0149 = 6*conj(IT_0051);
    const ccomplex_t IT_0150 = (-24)*IT_0119;
    const ccomplex_t IT_0151 = IT_0145 + IT_0150;
    const ccomplex_t IT_0152 = 0.166666666666667*conj(IT_0049);
    const ccomplex_t IT_0153 = 0.166666666666667*IT_0057;
    const ccomplex_t IT_0154 = (conj(IT_0033)*IT_0040 + conj(IT_0051)*IT_0052 
      + conj(IT_0053)*IT_0057)*IT_0058 + IT_0033*IT_0062*IT_0093 + (conj(IT_0049
      )*IT_0057 + conj(IT_0094)*IT_0095)*IT_0096 + 6*IT_0094*(conj(IT_0053)
      *IT_0100 + 0.166666666666667*IT_0093*IT_0105 + 0.166666666666667*IT_0095
      *IT_0106) + (conj(IT_0049)*IT_0100 + conj(IT_0094)*IT_0107 + conj(IT_0051)
      *IT_0108)*IT_0109 + (-6)*IT_0092*(conj(IT_0033)*IT_0062 + conj(IT_0094)
      *IT_0105 + 3*conj(IT_0051)*IT_0110 + -conj(IT_0049)*IT_0117 + -1./6*conj
      (IT_0092)*IT_0124 + -1./6*IT_0128*IT_0129) + IT_0051*((-18)*conj(IT_0092)
      *IT_0110 + conj(IT_0051)*IT_0124 + 6*conj(IT_0049)*IT_0135 + IT_0052
      *IT_0136 + IT_0108*IT_0137 + IT_0129*IT_0141) + 6*IT_0049*(conj(IT_0092)
      *IT_0117 + 0.166666666666667*IT_0100*IT_0137 + 0.166666666666667*IT_0135
      *IT_0149 + 0.166666666666667*conj(IT_0053)*IT_0151 + IT_0148*IT_0152 +
       IT_0106*IT_0153) + 6*IT_0053*(conj(IT_0094)*IT_0100 + conj(IT_0092)
      *IT_0128 + 0.166666666666667*conj(IT_0053)*IT_0148 + 0.166666666666667
      *IT_0141*IT_0149 + IT_0151*IT_0152 + IT_0136*IT_0153);
