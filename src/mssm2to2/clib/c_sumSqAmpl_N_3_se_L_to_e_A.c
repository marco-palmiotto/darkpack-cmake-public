...
ccomplex_return_t c_sumSqAmpl_N_3_se_L_to_e_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_se_L*
    ...
    const ccomplex_t IT_0045 = m_e*s_14*m_N_3;
    ...
    const ccomplex_t IT_0056 = m_e*m_N_3;
    ...
    const ccomplex_t IT_0061 = m_e*s_34*m_N_3;
