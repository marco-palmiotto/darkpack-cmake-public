        ...
        )
{
    ...
    const ccomplex_t IT_0042 = cpow(IT_0015, -1);
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0000*IT_0002*IT_0042;
    const ccomplex_t IT_0044 = (-0.5)*IT_0043;
    const ccomplex_t IT_0045 = pow(m_se_L, 2);
    ...
    const ccomplex_t IT_0138 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_4*
    ...
    const ccomplex_t IT_0242 = m_e*e_em*IT_0000*IT_0002*IT_0019*IT_0042;
    const ccomplex_t IT_0243 = (-0.5)*IT_0242;
    const ccomplex_t IT_0244 = IT_0044*IT_0243;
    const ccomplex_t IT_0245 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0045 
      + -reg_prop, -1);
    const ccomplex_t IT_0246 = IT_0244*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = IT_0066*IT_0233;
    const ccomplex_t IT_0249 = IT_0029*IT_0194;
    const ccomplex_t IT_0250 = IT_0109*IT_0205;
    const ccomplex_t IT_0251 = IT_0157*IT_0219;
    const ccomplex_t IT_0252 = -IT_0247 + IT_0248 + IT_0249 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_e*s_14;
    const ccomplex_t IT_0254 = IT_0192*IT_0243;
