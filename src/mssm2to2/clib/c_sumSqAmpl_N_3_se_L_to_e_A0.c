...
ccomplex_return_t c_sumSqAmpl_N_3_se_L_to_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
    ...
    const ccomplex_t IT_0209 = m_N_3*IT_0109;
    const ccomplex_t IT_0210 = m_N_2*IT_0127;
    const ccomplex_t IT_0211 = IT_0209 + IT_0210;
    const ccomplex_t IT_0212 = IT_0208*IT_0211;
    const ccomplex_t IT_0213 = m_N_3*IT_0157;
    const ccomplex_t IT_0214 = m_N_4*IT_0175;
    ...
    const ccomplex_t IT_0222 = (0 + _Complex_I*1)*(IT_0218 + IT_0221);
    const ccomplex_t IT_0223 = (-0.5)*IT_0222;
    const ccomplex_t IT_0224 = IT_0138*IT_0223;
    ...
    const ccomplex_t IT_0240 = m_e*m_N_3;
    const ccomplex_t IT_0241 = 2*IT_0179;
    const ccomplex_t IT_0242 = IT_0109*IT_0208;
    const ccomplex_t IT_0243 = IT_0157*IT_0225;
    const ccomplex_t IT_0244 = m_e*e_em*IT_0000*IT_0002*IT_0016*IT_0026;
    const ccomplex_t IT_0245 = (-0.5)*IT_0244;
    const ccomplex_t IT_0246 = IT_0018*IT_0245;
    const ccomplex_t IT_0247 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0019 
      + -reg_prop, -1);
    const ccomplex_t IT_0248 = IT_0246*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0036*IT_0236;
    const ccomplex_t IT_0251 = IT_0066*IT_0194;
    const ccomplex_t IT_0252 = IT_0242 + IT_0243 + -IT_0249 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_e*s_14;
    const ccomplex_t IT_0254 = IT_0140*IT_0175;
    const ccomplex_t IT_0255 = IT_0234*IT_0245;
    const ccomplex_t IT_0256 = IT_0247*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0084*IT_0091;
    const ccomplex_t IT_0259 = IT_0127*IT_0134;
    const ccomplex_t IT_0260 = IT_0022*IT_0046;
    ...
    const ccomplex_t IT_0266 = m_e*m_N_3*IT_0265;
