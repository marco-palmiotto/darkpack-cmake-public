        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0036 + IT_0047 + -m_se_R*
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0011*IT_0031*IT_0033;
    ...
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*(IT_0265 + IT_0268);
