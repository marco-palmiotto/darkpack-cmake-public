        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_se_R*
    ...
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0003*IT_0005*IT_0011 + (-0.5)*m_W*(IT_0001*IT_0003 + IT_0018*IT_0135)*
      (IT_0005 + -IT_0004*IT_0136));
    const ccomplex_t IT_0138 = IT_0009*IT_0137;
    const ccomplex_t IT_0139 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_se_L*
    ...
    const ccomplex_t IT_0288 = m_e*m_N_3;
