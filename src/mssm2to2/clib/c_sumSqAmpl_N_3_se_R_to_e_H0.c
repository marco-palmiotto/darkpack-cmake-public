...
ccomplex_return_t c_sumSqAmpl_N_3_se_R_to_e_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_23 + IT_0013 + IT_0015 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0023 = IT_0021*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*IT_0023;
    const ccomplex_t IT_0025 = IT_0003*IT_0009;
    const ccomplex_t IT_0026 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = sin(alpha);
    const ccomplex_t IT_0029 = IT_0005*IT_0028;
    const ccomplex_t IT_0030 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0033 = IT_0025*IT_0032;
    const ccomplex_t IT_0034 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0035 = IT_0029*IT_0034;
    const ccomplex_t IT_0036 = IT_0027 + IT_0031 + IT_0033 + IT_0035;
    const ccomplex_t IT_0037 = IT_0009*IT_0028;
    const ccomplex_t IT_0038 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = IT_0003*IT_0005;
    const ccomplex_t IT_0041 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0044 = IT_0037*IT_0043;
    const ccomplex_t IT_0045 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0052 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0053 = IT_0025*IT_0052;
    const ccomplex_t IT_0054 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0055 = IT_0029*IT_0054;
    const ccomplex_t IT_0056 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0057 = IT_0025*IT_0056;
    const ccomplex_t IT_0058 = conj(N_W4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0063 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0064 = IT_0040*IT_0063;
    const ccomplex_t IT_0065 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0081 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0082 = IT_0025*IT_0081;
    const ccomplex_t IT_0083 = N_W3*N_u1*e_em;
    ...
    const ccomplex_t IT_0109 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0110 = IT_0029*IT_0109;
    const ccomplex_t IT_0111 = IT_0104 + IT_0106 + IT_0108 + IT_0110;
    const ccomplex_t IT_0112 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0000
      *IT_0002*IT_0005*IT_0028;
    const ccomplex_t IT_0128 = 0.5*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0130 = (-0.5)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_se_L*
    ...
    const ccomplex_t IT_0137 = (0 + _Complex_I*-1)*e_em*(IT_0000*IT_0002
      *IT_0003*IT_0005*IT_0013 + -m_W*IT_0004*IT_0135*(IT_0001*IT_0003 + 
      -IT_0028*IT_0136));
    const ccomplex_t IT_0138 = IT_0011*IT_0137;
    const ccomplex_t IT_0139 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_se_R*
    ...
    const ccomplex_t IT_0152 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0153 = IT_0025*IT_0152;
    const ccomplex_t IT_0154 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0155 = IT_0037*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0157 = IT_0040*IT_0156;
    const ccomplex_t IT_0158 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0163 = cpow((-2)*s_23 + IT_0013 + IT_0015 + -m_N_3*
    ...
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0009;
    const ccomplex_t IT_0168 = -IT_0167;
    const ccomplex_t IT_0169 = cpow((-2)*s_23 + IT_0013 + IT_0015 + -m_N_2*
    ...
    const ccomplex_t IT_0199 = IT_0025*IT_0198;
    ...
    const ccomplex_t IT_0218 = (-2)*IT_0019 + IT_0075 + IT_0126 + IT_0134 +
       IT_0141 + IT_0166 + IT_0217;
    const ccomplex_t IT_0219 = conj(N_B3)*e_em;
    const ccomplex_t IT_0220 = IT_0009*IT_0219;
    const ccomplex_t IT_0221 = 1.4142135623731*IT_0220;
    const ccomplex_t IT_0222 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0227 = IT_0128*IT_0226;
    const ccomplex_t IT_0228 = IT_0132*IT_0227;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
    ...
    const ccomplex_t IT_0234 = m_N_3*IT_0050;
    const ccomplex_t IT_0235 = m_N_4*IT_0072;
    const ccomplex_t IT_0236 = IT_0234 + IT_0235;
    const ccomplex_t IT_0237 = IT_0233*IT_0236;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0244 = m_N_3*IT_0101;
    const ccomplex_t IT_0245 = m_N_1*IT_0123;
    const ccomplex_t IT_0246 = IT_0244 + IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0252 = IT_0137*IT_0239;
    const ccomplex_t IT_0253 = IT_0139*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = IT_0163*IT_0239;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0162*IT_0256;
    const ccomplex_t IT_0258 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0263 = m_N_2*IT_0214;
    const ccomplex_t IT_0264 = IT_0262 + IT_0263;
    const ccomplex_t IT_0265 = IT_0261*IT_0264;
    const ccomplex_t IT_0266 = -IT_0229 + -IT_0237 + 2*IT_0243 + -IT_0251 + 
      -IT_0254 + -IT_0257 + -IT_0265;
    const ccomplex_t IT_0267 = 2*s_13;
    const ccomplex_t IT_0268 = m_e*m_N_3;
    const ccomplex_t IT_0269 = 2*IT_0218;
    const ccomplex_t IT_0270 = IT_0150*IT_0256;
    const ccomplex_t IT_0271 = IT_0101*IT_0250;
    const ccomplex_t IT_0272 = IT_0050*IT_0233;
    const ccomplex_t IT_0273 = IT_0192*IT_0261;
    const ccomplex_t IT_0274 = -IT_0018 + IT_0270 + IT_0271 + IT_0272 + IT_0273;
    const ccomplex_t IT_0275 = m_e*s_14;
    const ccomplex_t IT_0276 = IT_0024*IT_0072;
    const ccomplex_t IT_0277 = IT_0171*IT_0214;
    const ccomplex_t IT_0278 = IT_0160*IT_0165;
    const ccomplex_t IT_0279 = IT_0080*IT_0123;
    const ccomplex_t IT_0280 = IT_0242 + -IT_0276 + -IT_0277 + -IT_0278 + 
      -IT_0279;
    const ccomplex_t IT_0281 = s_34*m_N_3;
    const ccomplex_t IT_0282 = 2*conj(IT_0218);
    const ccomplex_t IT_0283 = 2*conj(IT_0266);
    const ccomplex_t IT_0284 = pow(m_H0, 2);
    const ccomplex_t IT_0285 = m_e*m_N_3*IT_0284;
