        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0002;
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0006
      *IT_0011*IT_0039*IT_0041;
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0011*IT_0039*IT_0041;
    const ccomplex_t IT_0045 = (-0.5)*IT_0044;
    const ccomplex_t IT_0046 = IT_0043*IT_0045;
    const ccomplex_t IT_0047 = pow(m_N_3, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0033 + IT_0047 + -m_se_L*
    ...
    const ccomplex_t IT_0104 = (0 + _Complex_I*-1)*e_em*(IT_0000*IT_0011
      *IT_0033*IT_0039*IT_0041 + -m_W*IT_0010*IT_0102*(IT_0000*IT_0040 + 
      -IT_0006*IT_0103));
    const ccomplex_t IT_0105 = IT_0032*IT_0104;
    const ccomplex_t IT_0106 = cpow((-2)*s_13 + IT_0033 + IT_0047 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0107 = IT_0105*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*m_e*e_em*IT_0000*IT_0011
      *IT_0039*IT_0041;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = IT_0032*IT_0110;
    const ccomplex_t IT_0112 = cpow((-2)*s_12 + IT_0033 + -IT_0034 + -IT_0047 
      + -reg_prop, -1);
    const ccomplex_t IT_0113 = IT_0111*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*IT_0113;
    const ccomplex_t IT_0115 = m_e*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0002;
    const ccomplex_t IT_0117 = -IT_0116;
    const ccomplex_t IT_0118 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_N_1*
    ...
    const ccomplex_t IT_0149 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0150 = IT_0015*IT_0149;
    const ccomplex_t IT_0151 = IT_0144 + IT_0146 + IT_0148 + IT_0150;
    const ccomplex_t IT_0152 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0153 = IT_0007*IT_0152;
    const ccomplex_t IT_0154 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0155 = IT_0012*IT_0154;
    const ccomplex_t IT_0156 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0157 = IT_0007*IT_0156;
    const ccomplex_t IT_0158 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0169 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_N_4*
    ...
    const ccomplex_t IT_0218 = IT_0038 + IT_0050 + IT_0101 + IT_0108 + (-2)
      *IT_0115 + IT_0166 + IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0011*IT_0039*IT_0041;
    const ccomplex_t IT_0220 = 0.5*IT_0219;
    const ccomplex_t IT_0221 = IT_0110*IT_0220;
    const ccomplex_t IT_0222 = IT_0112*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = m_e*IT_0223;
    const ccomplex_t IT_0225 = IT_0104*IT_0220;
    const ccomplex_t IT_0226 = IT_0106*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*IT_0226;
    const ccomplex_t IT_0228 = IT_0035*IT_0220;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = IT_0030*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0011*IT_0039*IT_0041;
    ...
    const ccomplex_t IT_0235 = m_N_3*IT_0214;
    const ccomplex_t IT_0236 = m_N_4*IT_0192;
    ...
    const ccomplex_t IT_0247 = IT_0043*IT_0246;
    const ccomplex_t IT_0248 = IT_0048*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0011*IT_0039*IT_0041;
    ...
    const ccomplex_t IT_0254 = m_N_3*IT_0141;
    const ccomplex_t IT_0255 = m_N_1*IT_0163;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = IT_0253*IT_0256;
    const ccomplex_t IT_0258 = m_N_3*IT_0076;
    const ccomplex_t IT_0259 = m_N_2*IT_0098;
    const ccomplex_t IT_0260 = IT_0258 + IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0011*IT_0039*IT_0041;
    const ccomplex_t IT_0262 = 0.5*IT_0261;
    const ccomplex_t IT_0263 = IT_0053*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0260*IT_0264;
    const ccomplex_t IT_0266 = 2*IT_0224 + -IT_0227 + -IT_0230 + -IT_0238 + 
    ...
    const ccomplex_t IT_0270 = IT_0018*IT_0229;
    const ccomplex_t IT_0271 = IT_0141*IT_0253;
    const ccomplex_t IT_0272 = IT_0214*IT_0234;
    const ccomplex_t IT_0273 = IT_0076*IT_0264;
    const ccomplex_t IT_0274 = -IT_0114 + IT_0270 + IT_0271 + IT_0272 + IT_0273;
    const ccomplex_t IT_0275 = m_e*s_14;
    const ccomplex_t IT_0276 = IT_0171*IT_0192;
    const ccomplex_t IT_0277 = IT_0120*IT_0163;
    const ccomplex_t IT_0278 = IT_0055*IT_0098;
    const ccomplex_t IT_0279 = IT_0028*IT_0037;
