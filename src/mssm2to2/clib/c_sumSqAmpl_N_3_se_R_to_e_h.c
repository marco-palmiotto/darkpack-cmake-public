...
ccomplex_return_t c_sumSqAmpl_N_3_se_R_to_e_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = N_B4*N_u3*e_em;
    ...
    const ccomplex_t IT_0037 = IT_0005*IT_0025;
    ...
    const ccomplex_t IT_0135 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0136 = cpow(IT_0008, -2);
    const ccomplex_t IT_0137 = sin(beta);
    const ccomplex_t IT_0138 = (0 + _Complex_I*-1)*e_em*(IT_0000*IT_0002
      *IT_0003*IT_0005*IT_0013 + -m_W*IT_0004*IT_0136*(IT_0001*IT_0003 + IT_0025
      *IT_0137));
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0013 + IT_0015 + -m_N_2*
    ...
    const ccomplex_t IT_0230 = IT_0128*IT_0229;
    const ccomplex_t IT_0231 = IT_0132*IT_0230;
    const ccomplex_t IT_0232 = (0 + _Complex_I*1)*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
    ...
    const ccomplex_t IT_0239 = m_N_1*IT_0123;
    const ccomplex_t IT_0240 = m_N_3*IT_0101;
    ...
    const ccomplex_t IT_0247 = IT_0139*IT_0234;
    const ccomplex_t IT_0248 = IT_0135*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0143*IT_0234;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = IT_0168*IT_0251;
    const ccomplex_t IT_0253 = m_N_3*IT_0195;
    const ccomplex_t IT_0254 = m_N_2*IT_0217;
    const ccomplex_t IT_0255 = IT_0253 + IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0265 = m_N_3*IT_0050;
    const ccomplex_t IT_0266 = m_N_4*IT_0072;
    ...
    const ccomplex_t IT_0271 = m_e*m_N_3;
    const ccomplex_t IT_0272 = 2*IT_0221;
    const ccomplex_t IT_0273 = IT_0101*IT_0245;
    const ccomplex_t IT_0274 = IT_0050*IT_0264;
    const ccomplex_t IT_0275 = IT_0155*IT_0251;
    ...
    const ccomplex_t IT_0280 = IT_0024*IT_0072;
    ...
    const ccomplex_t IT_0288 = m_e*m_N_3*IT_0287;
