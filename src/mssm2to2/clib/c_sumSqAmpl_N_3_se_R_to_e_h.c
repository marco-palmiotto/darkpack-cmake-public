        ...
        )
{
    ...
    const ccomplex_t IT_0137 = (0 + _Complex_I*-1)*e_em*(IT_0000*IT_0002
      *IT_0003*IT_0005*IT_0013 + -m_W*IT_0004*IT_0135*(IT_0001*IT_0003 + IT_0020
      *IT_0136));
    const ccomplex_t IT_0138 = -IT_0137;
    const ccomplex_t IT_0139 = IT_0011*IT_0138;
    const ccomplex_t IT_0140 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_se_R*
    ...
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
    ...
    const ccomplex_t IT_0231 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0236 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0005;
