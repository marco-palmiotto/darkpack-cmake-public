        ...
        )
{
    ...
    const ccomplex_t IT_0002 = pow(m_smu_L, 2);
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_smu_L*
