...
ccomplex_return_t c_sumSqAmpl_N_3_smu_L_to_mu_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0045 = m_mu*s_14*m_N_3;
    ...
    const ccomplex_t IT_0056 = m_mu*m_N_3;
    ...
    const ccomplex_t IT_0061 = m_mu*s_34*m_N_3;
