...
ccomplex_return_t c_sumSqAmpl_N_3_smu_L_to_mu_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
    ...
    const ccomplex_t IT_0033 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0037 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0047 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0048 = IT_0018*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0050 = IT_0021*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0063 = IT_0014*IT_0062;
    const ccomplex_t IT_0064 = N_B4*N_d3*e_em;
    ...
    const ccomplex_t IT_0074 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0080 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0086 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0087 = IT_0024*IT_0086;
    const ccomplex_t IT_0088 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0089 = IT_0014*IT_0088;
    const ccomplex_t IT_0090 = conj(N_B4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0097 = m_N_3*IT_0096;
    const ccomplex_t IT_0098 = IT_0079 + IT_0097;
    const ccomplex_t IT_0099 = IT_0061*IT_0098;
    const ccomplex_t IT_0100 = e_em*m_mu*mu_h*IT_0000*IT_0004;
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_13 + IT_0007 + IT_0105 + -m_smu_R*
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
    ...
    const ccomplex_t IT_0179 = IT_0056 + IT_0099 + IT_0108 + IT_0135 + IT_0178;
    const ccomplex_t IT_0180 = 2*s_13;
    const ccomplex_t IT_0181 = IT_0061*IT_0096;
    const ccomplex_t IT_0182 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0105 
      + -reg_prop, -1);
    const ccomplex_t IT_0183 = e_em*m_mu*IT_0000*IT_0002*IT_0004*IT_0017;
    ...
    const ccomplex_t IT_0196 = IT_0127*IT_0134;
    const ccomplex_t IT_0197 = IT_0170*IT_0177;
    const ccomplex_t IT_0198 = IT_0011*IT_0053;
    const ccomplex_t IT_0199 = -IT_0181 + -IT_0195 + -IT_0196 + -IT_0197 + 
      -IT_0198;
    const ccomplex_t IT_0200 = m_mu*s_14;
    const ccomplex_t IT_0201 = IT_0131*IT_0184;
    const ccomplex_t IT_0202 = IT_0182*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*IT_0202;
    const ccomplex_t IT_0204 = IT_0132*IT_0192;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*IT_0204;
    const ccomplex_t IT_0206 = IT_0117*IT_0205;
    const ccomplex_t IT_0207 = conj(N_B1)*e_em;
    const ccomplex_t IT_0208 = IT_0013*IT_0207;
    const ccomplex_t IT_0209 = 1.4142135623731*IT_0208;
    const ccomplex_t IT_0210 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0219 = IT_0013*IT_0218;
    ...
    const ccomplex_t IT_0229 = conj(N_B4)*e_em;
    const ccomplex_t IT_0230 = IT_0013*IT_0229;
    const ccomplex_t IT_0231 = 1.4142135623731*IT_0230;
    const ccomplex_t IT_0232 = conj(N_W4)*e_em;
    const ccomplex_t IT_0233 = IT_0004*IT_0232;
    ...
    const ccomplex_t IT_0239 = IT_0078*IT_0238;
    const ccomplex_t IT_0240 = -IT_0203 + IT_0206 + IT_0217 + IT_0228 + IT_0239;
    const ccomplex_t IT_0241 = s_34*m_N_3;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0243 = 0.5*IT_0242;
    const ccomplex_t IT_0244 = IT_0101*IT_0243;
    const ccomplex_t IT_0245 = IT_0106*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*IT_0245;
    const ccomplex_t IT_0247 = IT_0129*IT_0205;
    const ccomplex_t IT_0248 = m_N_3*IT_0152;
    const ccomplex_t IT_0249 = m_N_1*IT_0170;
    const ccomplex_t IT_0250 = IT_0248 + IT_0249;
    const ccomplex_t IT_0251 = IT_0216*IT_0250;
    const ccomplex_t IT_0252 = m_N_3*IT_0035;
    const ccomplex_t IT_0253 = m_N_2*IT_0053;
    const ccomplex_t IT_0254 = IT_0252 + IT_0253;
    const ccomplex_t IT_0255 = IT_0227*IT_0254;
    const ccomplex_t IT_0256 = m_N_3*IT_0078;
    const ccomplex_t IT_0257 = m_N_4*IT_0096;
