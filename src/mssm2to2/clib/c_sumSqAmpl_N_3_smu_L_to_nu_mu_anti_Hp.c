...
ccomplex_return_t c_sumSqAmpl_N_3_smu_L_to_nu_mu_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0026 = conj(N_u3)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = 2*IT_0027;
    const ccomplex_t IT_0029 = IT_0000*IT_0010;
    const ccomplex_t IT_0030 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0079 = N_W3*U_d2*e_em;
