...
ccomplex_return_t c_sumSqAmpl_N_3_smu_L_to_nu_mu_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0004 = IT_0001*IT_0003;
    const ccomplex_t IT_0005 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*e_em*conj(U_Wm1)*IT_0001;
    const ccomplex_t IT_0016 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0017 = IT_0001*IT_0016;
    const ccomplex_t IT_0018 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0024 = cpow(s_23 + (-0.5)*IT_0011 + 0.5*m_C_1*(m_C_1 +
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0001*IT_0032*IT_0034;
    const ccomplex_t IT_0036 = (-0.5)*IT_0035;
    const ccomplex_t IT_0037 = IT_0031*IT_0036;
    const ccomplex_t IT_0038 = pow(m_mu, 2);
    const ccomplex_t IT_0039 = pow(m_N_3, 2);
    const ccomplex_t IT_0040 = cpow((-2)*s_12 + -IT_0011 + IT_0038 + -IT_0039 
      + -reg_prop, -1);
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0042 = IT_0037*IT_0040*IT_0041;
    const ccomplex_t IT_0043 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0044 = IT_0001*IT_0043;
    const ccomplex_t IT_0045 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0052 = IT_0012*IT_0050*IT_0051;
    const ccomplex_t IT_0053 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0054 = IT_0001*IT_0053;
    const ccomplex_t IT_0055 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0063 = -IT_0042 + 0.5*IT_0052 + 0.5*IT_0062;
    const ccomplex_t IT_0064 = pow(m_W, -2);
    const ccomplex_t IT_0065 = pow(s_34, 2);
    const ccomplex_t IT_0066 = m_N_3*IT_0064*IT_0065;
    ...
    const ccomplex_t IT_0080 = -IT_0030;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*(IT_0071 + -IT_0074);
    const ccomplex_t IT_0082 = (-0.5)*IT_0081;
    const ccomplex_t IT_0083 = cpow(s_13 + (-0.5)*IT_0039 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0126 = s_34*IT_0039;
    const ccomplex_t IT_0127 = -IT_0126;
    const ccomplex_t IT_0128 = IT_0125 + IT_0127;
    const ccomplex_t IT_0129 = IT_0079 + IT_0106;
    const ccomplex_t IT_0130 = m_N_3*IT_0115;
    const ccomplex_t IT_0131 = pow(s_14, 2);
    const ccomplex_t IT_0132 = IT_0064*IT_0131;
    const ccomplex_t IT_0133 = -IT_0039;
    ...
    const ccomplex_t IT_0141 = IT_0090 + IT_0092 + IT_0140;
    const ccomplex_t IT_0142 = (-0.25)*IT_0139;
    const ccomplex_t IT_0143 = IT_0091 + IT_0142;
    const ccomplex_t IT_0144 = s_13*s_34;
    const ccomplex_t IT_0145 = 2*conj(IT_0087);
    const ccomplex_t IT_0146 = (-2)*(conj(IT_0029) + conj(IT_0063))*IT_0112 +
       IT_0116*(conj(IT_0087)*IT_0121 + IT_0087*IT_0124) + IT_0128*((conj
      (IT_0079) + conj(IT_0106))*IT_0121 + IT_0124*IT_0129) + ((conj(IT_0029) +
       conj(IT_0063))*IT_0121 + IT_0097*IT_0124)*IT_0130 + (-2)*(conj(IT_0117)*(
      (-0.5)*IT_0118 + IT_0119) + (IT_0117 + -IT_0119)*conj(IT_0119))*IT_0135 +
       conj(IT_0087)*IT_0088*IT_0136 + (-4)*conj(IT_0106)*(0.5*IT_0097*IT_0110 +
       IT_0106*IT_0141 + (-2)*IT_0079*IT_0143 + (-0.25)*IT_0088*IT_0144) + (-4)
      *conj(IT_0079)*((-0.5)*IT_0097*IT_0104 + IT_0079*IT_0141 + (-2)*IT_0106
      *IT_0143 + (-0.25)*IT_0088*IT_0144) + (IT_0066*IT_0097 + IT_0129*IT_0144)
      *IT_0145;
