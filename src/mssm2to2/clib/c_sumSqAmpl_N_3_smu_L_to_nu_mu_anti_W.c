        ...
        )
{
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_12 + -IT_0020 + IT_0034 + -IT_0035 
      + -reg_prop, -1);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_mu;
    ...
    const ccomplex_t IT_0075 = s_14*s_34*IT_0000;
    ...
    const ccomplex_t IT_0092 = -IT_0026;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*(IT_0083 + -IT_0086);
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = cpow(s_13 + (-0.5)*IT_0035 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0099 = 2*IT_0091 + (-0.5)*IT_0098;
    const ccomplex_t IT_0100 = -IT_0023;
    const ccomplex_t IT_0101 = 2*IT_0100;
    const ccomplex_t IT_0102 = IT_0070 + 0.5*IT_0098;
    const ccomplex_t IT_0103 = (-2)*IT_0102;
    const ccomplex_t IT_0104 = IT_0101 + IT_0103;
    const ccomplex_t IT_0105 = 2*conj(IT_0100);
    const ccomplex_t IT_0106 = (-2)*conj(IT_0102);
    const ccomplex_t IT_0107 = IT_0105 + IT_0106;
    const ccomplex_t IT_0108 = m_N_3*IT_0077;
    const ccomplex_t IT_0109 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0115 = 0.5*IT_0023;
    const ccomplex_t IT_0116 = (-0.5)*IT_0070;
    const ccomplex_t IT_0117 = 2*IT_0025;
    const ccomplex_t IT_0118 = 2*IT_0072;
    const ccomplex_t IT_0119 = IT_0117 + IT_0118;
    const ccomplex_t IT_0120 = 2*conj(IT_0025);
    const ccomplex_t IT_0121 = 2*conj(IT_0072);
    const ccomplex_t IT_0122 = IT_0120 + IT_0121;
    const ccomplex_t IT_0123 = pow(s_34, 2);
    const ccomplex_t IT_0124 = s_13*IT_0000*IT_0123;
    const ccomplex_t IT_0125 = 2*IT_0099;
    const ccomplex_t IT_0126 = m_N_3*IT_0000*IT_0123;
    const ccomplex_t IT_0127 = 2*conj(IT_0099);
    const ccomplex_t IT_0128 = s_13*s_34;
    const ccomplex_t IT_0129 = conj(IT_0091) + conj(IT_0115);
    const ccomplex_t IT_0130 = IT_0091 + IT_0115;
    ...
    const ccomplex_t IT_0135 = IT_0002 + IT_0004 + IT_0134;
    const ccomplex_t IT_0136 = -conj(IT_0116);
    const ccomplex_t IT_0137 = (-0.25)*IT_0133;
    const ccomplex_t IT_0138 = IT_0003 + IT_0137;
    const ccomplex_t IT_0139 = 0.5*IT_0110;
    const ccomplex_t IT_0140 = s_34 + IT_0139;
    const ccomplex_t IT_0141 = m_N_3*IT_0140;
    ...
    const ccomplex_t IT_0146 = -IT_0035;
    const ccomplex_t IT_0147 = IT_0145 + IT_0146;
    const ccomplex_t IT_0148 = s_13*IT_0147;
    const ccomplex_t IT_0149 = (-2)*conj(IT_0100);
    const ccomplex_t IT_0150 = 2*IT_0102;
    const ccomplex_t IT_0151 = (-0.5)*IT_0150;
    const ccomplex_t IT_0152 = s_13*s_14;
    const ccomplex_t IT_0153 = s_34*IT_0035;
    const ccomplex_t IT_0154 = -IT_0153;
    const ccomplex_t IT_0155 = IT_0152 + IT_0154;
    const ccomplex_t IT_0156 = 4*IT_0008*IT_0073*IT_0074 + IT_0078*(conj
      (IT_0099)*IT_0104 + IT_0099*IT_0107) + (IT_0074*IT_0104 + IT_0073*IT_0107)
      *IT_0108 + (-2)*IT_0114*(IT_0074*IT_0115 + IT_0073*conj(IT_0115) + (-0.5)
      *conj(IT_0116)*IT_0119 + (-0.5)*IT_0116*IT_0122) + conj(IT_0099)*IT_0124
      *IT_0125 + IT_0126*(IT_0074*IT_0125 + IT_0073*IT_0127) + (-2)*IT_0128*
      (conj(IT_0099)*IT_0116 + IT_0099*conj(IT_0116) + (-0.5)*IT_0125*IT_0129 + 
      (-0.5)*IT_0127*IT_0130) + (-4)*IT_0135*(IT_0091*conj(IT_0091) + (IT_0115 +
       -IT_0116)*(conj(IT_0115) + IT_0136)) + 8*conj(IT_0091)*((IT_0115 + 
      -IT_0116)*IT_0138 + IT_0119*IT_0143) + 8*IT_0091*((conj(IT_0115) + IT_0136
      )*IT_0138 + IT_0122*IT_0143) + IT_0148*(conj(IT_0100)*IT_0101 + IT_0102
      *IT_0149 + (-2)*conj(IT_0102)*(IT_0100 + IT_0151)) + (IT_0104*IT_0129 +
       IT_0107*IT_0130 + 2*IT_0116*(conj(IT_0102) + 0.5*IT_0149) + 2*IT_0136*
      (IT_0100 + IT_0151))*IT_0155;
