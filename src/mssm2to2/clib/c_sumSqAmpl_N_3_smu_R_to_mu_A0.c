...
ccomplex_return_t c_sumSqAmpl_N_3_smu_R_to_mu_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = N_B3*N_u2*e_em;
    const ccomplex_t IT_0061 = IT_0010*IT_0060;
    const ccomplex_t IT_0062 = N_B3*N_d2*e_em;
    const ccomplex_t IT_0063 = IT_0014*IT_0062;
    const ccomplex_t IT_0064 = N_W3*N_u2*e_em;
    const ccomplex_t IT_0065 = IT_0019*IT_0064;
    const ccomplex_t IT_0066 = N_W3*N_d2*e_em;
    const ccomplex_t IT_0067 = IT_0022*IT_0066;
    const ccomplex_t IT_0068 = N_B2*N_u3*e_em;
    const ccomplex_t IT_0069 = IT_0010*IT_0068;
    const ccomplex_t IT_0070 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0071 = IT_0014*IT_0070;
    const ccomplex_t IT_0072 = N_W2*N_u3*e_em;
    const ccomplex_t IT_0073 = IT_0019*IT_0072;
    const ccomplex_t IT_0074 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0078 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0079 = IT_0010*IT_0078;
    const ccomplex_t IT_0080 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0081 = IT_0014*IT_0080;
    const ccomplex_t IT_0082 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0090 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0091 = IT_0019*IT_0090;
    const ccomplex_t IT_0092 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0001;
    const ccomplex_t IT_0099 = -IT_0098;
    const ccomplex_t IT_0100 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0101 = IT_0099*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*IT_0101;
    const ccomplex_t IT_0103 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0104 = IT_0010*IT_0103;
    const ccomplex_t IT_0105 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0106 = IT_0014*IT_0105;
    const ccomplex_t IT_0107 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0108 = IT_0019*IT_0107;
    const ccomplex_t IT_0109 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0110 = IT_0022*IT_0109;
    const ccomplex_t IT_0111 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0112 = IT_0010*IT_0111;
    const ccomplex_t IT_0113 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0114 = IT_0014*IT_0113;
    const ccomplex_t IT_0115 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0116 = IT_0019*IT_0115;
    const ccomplex_t IT_0117 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0125 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0126 = IT_0019*IT_0125;
    const ccomplex_t IT_0127 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0128 = IT_0022*IT_0127;
    const ccomplex_t IT_0129 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0130 = IT_0010*IT_0129;
    const ccomplex_t IT_0131 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0132 = IT_0014*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0134 = IT_0019*IT_0133;
    const ccomplex_t IT_0135 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0140 = IT_0102*IT_0139;
    const ccomplex_t IT_0141 = pow(m_N_3, 2);
    const ccomplex_t IT_0142 = cpow((-2)*s_13 + IT_0004 + IT_0141 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0143 = pow(m_W, -1);
    const ccomplex_t IT_0144 = e_em*m_mu*mu_h*IT_0018*IT_0143;
    const ccomplex_t IT_0145 = (-0.5)*IT_0144;
    const ccomplex_t IT_0146 = cpow(IT_0009, -1);
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0018*IT_0143*IT_0146;
    ...
    const ccomplex_t IT_0157 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0158 = IT_0010*IT_0157;
    const ccomplex_t IT_0159 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0160 = IT_0014*IT_0159;
    const ccomplex_t IT_0161 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0162 = IT_0019*IT_0161;
    const ccomplex_t IT_0163 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0179 = IT_0054 + IT_0097 + IT_0140 + IT_0151 + IT_0178;
    ...
    const ccomplex_t IT_0188 = IT_0145*IT_0187;
    const ccomplex_t IT_0189 = IT_0142*IT_0188;
    const ccomplex_t IT_0190 = (0 + _Complex_I*1)*IT_0189;
    const ccomplex_t IT_0191 = m_N_3*IT_0033;
    const ccomplex_t IT_0192 = m_N_1*IT_0051;
    const ccomplex_t IT_0193 = IT_0191 + IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0018*IT_0143*IT_0146;
    ...
    const ccomplex_t IT_0199 = m_N_3*IT_0076;
    const ccomplex_t IT_0200 = m_N_2*IT_0094;
    const ccomplex_t IT_0201 = IT_0199 + IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0018*IT_0143*IT_0146;
    ...
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0018*IT_0143*IT_0146;
    ...
    const ccomplex_t IT_0211 = m_N_3*IT_0119;
    const ccomplex_t IT_0212 = m_N_4*IT_0137;
    ...
    const ccomplex_t IT_0219 = IT_0177*IT_0218;
    const ccomplex_t IT_0220 = -IT_0190 + -IT_0198 + -IT_0206 + -IT_0214 + 
      -IT_0219;
    const ccomplex_t IT_0221 = 2*s_13;
    const ccomplex_t IT_0222 = m_mu*m_N_3;
    const ccomplex_t IT_0223 = 2*IT_0179;
    const ccomplex_t IT_0224 = e_em*m_mu*IT_0013*IT_0018*IT_0143*IT_0146;
    const ccomplex_t IT_0225 = (-0.5)*IT_0224;
    const ccomplex_t IT_0226 = IT_0153*IT_0225;
    const ccomplex_t IT_0227 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0141 
      + -reg_prop, -1);
    const ccomplex_t IT_0228 = IT_0226*IT_0227;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = IT_0033*IT_0197;
    const ccomplex_t IT_0231 = IT_0076*IT_0205;
    const ccomplex_t IT_0232 = IT_0119*IT_0210;
    const ccomplex_t IT_0233 = IT_0165*IT_0218;
    const ccomplex_t IT_0234 = -IT_0229 + IT_0230 + IT_0231 + IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = m_mu*s_14;
    const ccomplex_t IT_0236 = IT_0059*IT_0094;
    const ccomplex_t IT_0237 = IT_0102*IT_0137;
    const ccomplex_t IT_0238 = IT_0216*IT_0225;
    const ccomplex_t IT_0239 = IT_0227*IT_0238;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*IT_0239;
    const ccomplex_t IT_0241 = IT_0156*IT_0175;
    const ccomplex_t IT_0242 = IT_0008*IT_0051;
    ...
    const ccomplex_t IT_0248 = m_mu*m_N_3*IT_0247;
