        ...
        )
{
    ...
    const ccomplex_t IT_0035 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0036 = IT_0010*IT_0035;
    const ccomplex_t IT_0037 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0038 = IT_0014*IT_0037;
    const ccomplex_t IT_0039 = conj(N_W3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0045 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0046 = IT_0014*IT_0045;
    const ccomplex_t IT_0047 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0048 = IT_0019*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
    ...
    const ccomplex_t IT_0075 = m_N_3*IT_0074;
    const ccomplex_t IT_0076 = conj(N_B3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0080 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_3*
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_2*
    ...
    const ccomplex_t IT_0180 = m_N_3*IT_0109;
    const ccomplex_t IT_0181 = m_N_1*IT_0127;
    const ccomplex_t IT_0182 = IT_0180 + IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
    ...
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0018*IT_0055*IT_0058;
    ...
    const ccomplex_t IT_0203 = IT_0086*IT_0202;
    const ccomplex_t IT_0204 = m_N_3*IT_0152;
    const ccomplex_t IT_0205 = m_N_2*IT_0170;
    ...
    const ccomplex_t IT_0230 = IT_0109*IT_0186;
    const ccomplex_t IT_0231 = IT_0152*IT_0210;
    const ccomplex_t IT_0232 = IT_0033*IT_0218;
    const ccomplex_t IT_0233 = IT_0074*IT_0202;
    ...
    const ccomplex_t IT_0237 = IT_0170*IT_0177;
    const ccomplex_t IT_0238 = IT_0200*IT_0225;
