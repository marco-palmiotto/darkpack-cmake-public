...
ccomplex_return_t c_sumSqAmpl_N_3_smu_R_to_mu_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0027 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0028 = IT_0010*IT_0027;
    const ccomplex_t IT_0029 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0030 = IT_0014*IT_0029;
    const ccomplex_t IT_0031 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0032 = IT_0019*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0050 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0051 = IT_0022*IT_0050;
    const ccomplex_t IT_0052 = IT_0045 + IT_0047 + IT_0049 + IT_0051;
    const ccomplex_t IT_0053 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0057 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0090 = pow(m_N_3, 2);
    const ccomplex_t IT_0091 = cpow((-2)*s_13 + IT_0004 + IT_0090 + -m_smu_L*
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0013
      *IT_0018*IT_0092*IT_0094;
    const ccomplex_t IT_0096 = 0.5*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0018*IT_0092*IT_0094;
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_13 + IT_0004 + IT_0090 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0103 = cpow(IT_0000, -2);
    const ccomplex_t IT_0104 = sin(beta);
    const ccomplex_t IT_0105 = (0 + _Complex_I*-1)*e_em*(IT_0004*IT_0009
      *IT_0018*IT_0092*IT_0094 + -m_W*IT_0017*IT_0103*(IT_0009*IT_0093 + 
      -IT_0013*IT_0104));
    ...
    const ccomplex_t IT_0135 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0136 = IT_0010*IT_0135;
    const ccomplex_t IT_0137 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0138 = IT_0022*IT_0137;
    const ccomplex_t IT_0139 = IT_0132 + IT_0134 + IT_0136 + IT_0138;
    const ccomplex_t IT_0140 = conj(N_B2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0141 = IT_0014*IT_0140;
    const ccomplex_t IT_0142 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0143 = IT_0019*IT_0142;
    const ccomplex_t IT_0144 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0145 = IT_0014*IT_0144;
    const ccomplex_t IT_0146 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0001;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_2*
    ...
    const ccomplex_t IT_0162 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_4*
    ...
    const ccomplex_t IT_0194 = IT_0022*IT_0193;
    ...
    const ccomplex_t IT_0211 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0090 
      + -reg_prop, -1);
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*e_em*m_mu*IT_0009*IT_0018
      *IT_0092*IT_0094;
    ...
    const ccomplex_t IT_0218 = IT_0038 + IT_0089 + IT_0101 + IT_0108 + IT_0159
       + IT_0210 + (-2)*IT_0217;
    ...
    const ccomplex_t IT_0227 = IT_0096*IT_0226;
    const ccomplex_t IT_0228 = IT_0091*IT_0227;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0018*IT_0092*IT_0094;
    ...
    const ccomplex_t IT_0234 = m_N_3*IT_0086;
    const ccomplex_t IT_0235 = m_N_1*IT_0064;
    const ccomplex_t IT_0236 = IT_0234 + IT_0235;
    const ccomplex_t IT_0237 = IT_0233*IT_0236;
    const ccomplex_t IT_0238 = m_N_3*IT_0129;
    const ccomplex_t IT_0239 = m_N_2*IT_0151;
    const ccomplex_t IT_0240 = IT_0238 + IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0018*IT_0092*IT_0094;
    const ccomplex_t IT_0242 = 0.5*IT_0241;
    const ccomplex_t IT_0243 = IT_0156*IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*IT_0243;
    const ccomplex_t IT_0245 = IT_0240*IT_0244;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0018*IT_0092*IT_0094;
    const ccomplex_t IT_0247 = 0.5*IT_0246;
    const ccomplex_t IT_0248 = IT_0213*IT_0247;
    const ccomplex_t IT_0249 = IT_0211*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*IT_0249;
    const ccomplex_t IT_0251 = m_mu*IT_0250;
    const ccomplex_t IT_0252 = IT_0105*IT_0247;
    const ccomplex_t IT_0253 = IT_0102*IT_0252;
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*IT_0253;
    const ccomplex_t IT_0255 = IT_0006*IT_0247;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0037*IT_0256;
    const ccomplex_t IT_0258 = m_N_3*IT_0185;
    const ccomplex_t IT_0259 = m_N_4*IT_0207;
    ...
    const ccomplex_t IT_0263 = IT_0162*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0260*IT_0264;
    const ccomplex_t IT_0266 = -IT_0229 + -IT_0237 + -IT_0245 + 2*IT_0251 + 
      -IT_0254 + -IT_0257 + -IT_0265;
    const ccomplex_t IT_0267 = 2*s_13;
    const ccomplex_t IT_0268 = m_mu*m_N_3;
    const ccomplex_t IT_0269 = 2*IT_0218;
    const ccomplex_t IT_0270 = IT_0086*IT_0233;
    const ccomplex_t IT_0271 = IT_0129*IT_0244;
    const ccomplex_t IT_0272 = IT_0185*IT_0264;
    const ccomplex_t IT_0273 = IT_0025*IT_0256;
    ...
    const ccomplex_t IT_0277 = IT_0043*IT_0064;
    const ccomplex_t IT_0278 = IT_0151*IT_0158;
    const ccomplex_t IT_0279 = IT_0008*IT_0035;
    const ccomplex_t IT_0280 = IT_0250 + -IT_0276 + -IT_0277 + -IT_0278 + 
      -IT_0279;
    ...
    const ccomplex_t IT_0285 = m_mu*m_N_3*IT_0284;
