...
ccomplex_return_t c_sumSqAmpl_N_3_smu_R_to_nu_mu_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = conj(N_u3)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = 2*IT_0026;
    const ccomplex_t IT_0028 = IT_0006*IT_0023;
    const ccomplex_t IT_0029 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = 1.4142135623731*IT_0030;
    const ccomplex_t IT_0032 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0039 = cpow(IT_0023, -1);
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0039;
    const ccomplex_t IT_0041 = (-0.5)*IT_0040;
    const ccomplex_t IT_0042 = IT_0038*IT_0041;
    const ccomplex_t IT_0043 = IT_0020*IT_0022*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0045 = cpow(s_23 + (-0.5)*IT_0021 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0046 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0047 = IT_0024*IT_0046;
    const ccomplex_t IT_0048 = 2*IT_0047;
    const ccomplex_t IT_0049 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0050 = IT_0028*IT_0049;
    const ccomplex_t IT_0051 = 1.4142135623731*IT_0050;
    const ccomplex_t IT_0052 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0062 = IT_0044*IT_0045*IT_0061;
    const ccomplex_t IT_0063 = pow(m_mu, 2);
    const ccomplex_t IT_0064 = cpow((-2)*s_12 + -IT_0016 + -IT_0021 + IT_0063 
      + -reg_prop, -1);
    const ccomplex_t IT_0065 = sin(beta);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0000*IT_0002*IT_0039*IT_0065;
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0039;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0072 = IT_0064*IT_0070*IT_0071;
    ...
    const ccomplex_t IT_0105 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0114 = -IT_0077 + (-0.5)*IT_0097 + (-0.5)*IT_0113;
    const ccomplex_t IT_0115 = s_23*m_N_3;
    const ccomplex_t IT_0116 = s_12*s_23;
    const ccomplex_t IT_0117 = s_13*IT_0021;
