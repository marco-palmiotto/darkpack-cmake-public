...
ccomplex_return_t c_sumSqAmpl_N_3_smu_R_to_nu_mu_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = cpow(s_23 + (-0.5)*IT_0001 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0003 = sin(theta_W);
    const ccomplex_t IT_0004 = cpow(IT_0003, -1);
    const ccomplex_t IT_0005 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0004*IT_0012*IT_0014;
    const ccomplex_t IT_0016 = (-0.5)*IT_0015;
    const ccomplex_t IT_0017 = IT_0011*IT_0016;
    const ccomplex_t IT_0018 = IT_0000*IT_0002*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0020 = cpow(s_23 + (-0.5)*IT_0001 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0021 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0004*IT_0012*IT_0014;
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = IT_0019*IT_0020*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004;
    const ccomplex_t IT_0033 = 0.5*IT_0032;
    const ccomplex_t IT_0034 = cos(theta_W);
    const ccomplex_t IT_0035 = cpow(IT_0034, -1);
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0035;
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + -IT_0001 + IT_0039 + -IT_0040 
      + -reg_prop, -1);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0043 = IT_0038*IT_0041*IT_0042;
    const ccomplex_t IT_0044 = 0.5*IT_0018 + 0.5*IT_0031 + -IT_0043;
    const ccomplex_t IT_0045 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0046 = IT_0004*IT_0045;
    const ccomplex_t IT_0047 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0056 = IT_0004*IT_0055;
    const ccomplex_t IT_0057 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0004*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0089 = -IT_0054 + -IT_0064;
    ...
    const ccomplex_t IT_0099 = 0.5*IT_0054 + 0.5*IT_0064;
    ...
    const ccomplex_t IT_0129 = 2*(IT_0044 + IT_0067)*IT_0105 + (conj(IT_0089)
