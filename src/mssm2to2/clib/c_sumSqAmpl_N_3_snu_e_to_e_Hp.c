...
ccomplex_return_t c_sumSqAmpl_N_3_snu_e_to_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_e*m_N_3*IT_0000;
    ...
    const ccomplex_t IT_0007 = N_u3*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0013 = N_B3*V_u1*e_em;
    const ccomplex_t IT_0014 = IT_0012*IT_0013;
    const ccomplex_t IT_0015 = 1.4142135623731*IT_0014;
    const ccomplex_t IT_0016 = N_W3*V_u1*e_em;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_C_2*
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0003*IT_0049*IT_0050*IT_0051;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_e*U_d2*e_em
      *IT_0003*IT_0049*IT_0050;
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = IT_0003*IT_0051;
    ...
    const ccomplex_t IT_0072 = IT_0011*IT_0051;
    const ccomplex_t IT_0073 = conj(N_B3)*conj(U_d2)*e_em;
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = conj(N_W3)*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_e*U_d1*e_em
      *IT_0003*IT_0049*IT_0050;
    ...
    const ccomplex_t IT_0111 = m_e*m_N_3;
    const ccomplex_t IT_0112 = IT_0028*IT_0082;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0114 = IT_0043*IT_0112*IT_0113;
    const ccomplex_t IT_0115 = m_e*IT_0085;
    const ccomplex_t IT_0116 = m_e*IT_0103;
    const ccomplex_t IT_0117 = IT_0114 + -IT_0115 + -IT_0116;
    const ccomplex_t IT_0118 = IT_0027 + IT_0045;
    const ccomplex_t IT_0119 = m_e*IT_0118;
    const ccomplex_t IT_0120 = -IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0122 = IT_0022*IT_0087;
    const ccomplex_t IT_0123 = IT_0025*IT_0121*IT_0122;
    const ccomplex_t IT_0124 = IT_0041*IT_0067;
    const ccomplex_t IT_0125 = IT_0043*IT_0113*IT_0124;
    const ccomplex_t IT_0126 = m_N_3*IT_0064;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0003*
      (m_W*IT_0005 + (-0.5)*IT_0024*IT_0049*IT_0050)*IT_0051;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0024 + IT_0047 + -m_se_L*
    ...
    const ccomplex_t IT_0135 = cpow((-2)*s_13 + IT_0024 + IT_0047 + -m_se_R*
    ...
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0003*IT_0049;
    ...
    const ccomplex_t IT_0143 = -IT_0123 + -IT_0125 + (-0.5)*IT_0126 + IT_0134 
      + IT_0142;
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*(IT_0056 + IT_0059);
    const ccomplex_t IT_0145 = (-0.5)*IT_0144;
    const ccomplex_t IT_0146 = IT_0128*IT_0145;
    const ccomplex_t IT_0147 = IT_0132*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0003*IT_0049*IT_0050;
    ...
    const ccomplex_t IT_0154 = IT_0004*IT_0100;
    const ccomplex_t IT_0155 = IT_0025*IT_0121*IT_0154;
    const ccomplex_t IT_0156 = -IT_0148 + -IT_0153 + -IT_0155;
    const ccomplex_t IT_0157 = 2*IT_0143;
    const ccomplex_t IT_0158 = (-2)*IT_0120;
    const ccomplex_t IT_0159 = IT_0157 + IT_0158;
    const ccomplex_t IT_0160 = 2*conj(IT_0143);
    const ccomplex_t IT_0161 = (-2)*conj(IT_0120);
    const ccomplex_t IT_0162 = IT_0160 + IT_0161;
    const ccomplex_t IT_0163 = m_e*s_12;
    const ccomplex_t IT_0164 = 2*IT_0156;
    const ccomplex_t IT_0165 = (-2)*IT_0117;
    const ccomplex_t IT_0166 = IT_0164 + IT_0165;
    const ccomplex_t IT_0167 = 2*conj(IT_0156);
    const ccomplex_t IT_0168 = (-2)*conj(IT_0117);
    const ccomplex_t IT_0169 = IT_0167 + IT_0168;
    const ccomplex_t IT_0170 = s_23*m_N_3;
    ...
    const ccomplex_t IT_0173 = 2*IT_0001*(conj(IT_0046)*IT_0105 + IT_0046
      ...
      *IT_0111*(conj(IT_0117)*(IT_0120 + -IT_0143) + IT_0117*(conj(IT_0120) + 
      -conj(IT_0143)) + 0.5*conj(IT_0156)*IT_0159 + 0.5*IT_0156*IT_0162) +
       IT_0163*(conj(IT_0046)*IT_0159 + IT_0046*IT_0162 + IT_0106*IT_0166 +
       IT_0105*IT_0169) + (IT_0106*IT_0159 + IT_0105*IT_0162 + conj(IT_0046)
      *IT_0166 + IT_0046*IT_0169)*IT_0170 + (IT_0117*conj(IT_0117) + IT_0120
      *conj(IT_0120) + IT_0143*conj(IT_0143) + IT_0156*conj(IT_0156))*IT_0171 + 
      (conj(IT_0120)*IT_0143 + IT_0120*conj(IT_0143) + conj(IT_0117)*IT_0156 +
       IT_0117*conj(IT_0156))*IT_0172;
