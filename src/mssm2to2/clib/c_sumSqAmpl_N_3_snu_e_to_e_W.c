        ...
        )
{
    ...
    const ccomplex_t IT_0005 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0021 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0004*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0140 = m_N_3*IT_0019;
    const ccomplex_t IT_0141 = m_N_3*IT_0032;
    ...
    const ccomplex_t IT_0151 = m_e*IT_0047;
    const ccomplex_t IT_0152 = (-2)*IT_0091 + (-2)*IT_0102;
    const ccomplex_t IT_0153 = (-2)*conj(IT_0152);
    const ccomplex_t IT_0154 = s_14*s_34*IT_0043;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = s_13 + IT_0155;
    const ccomplex_t IT_0157 = s_13*IT_0156;
    const ccomplex_t IT_0158 = IT_0061 + -IT_0076;
    const ccomplex_t IT_0159 = IT_0063*IT_0156;
    const ccomplex_t IT_0160 = m_N_3*IT_0156;
    const ccomplex_t IT_0161 = (-2)*conj(IT_0042);
    ...
    const ccomplex_t IT_0170 = m_e*IT_0156;
    ...
    const ccomplex_t IT_0188 = (-2)*IT_0158;
    const ccomplex_t IT_0189 = IT_0077 + IT_0103;
    const ccomplex_t IT_0190 = (-2)*conj(IT_0158);
    ...
    const ccomplex_t IT_0194 = 0.5*IT_0159;
    ...
    const ccomplex_t IT_0199 = (-2)*IT_0152;
    ...
    const ccomplex_t IT_0205 = IT_0063*IT_0133 + (-0.166666666666667)*IT_0160
      *IT_0195 + (-0.666666666666667)*IT_0169*(IT_0148 + 0.25*IT_0198) + (
      -0.333333333333333)*IT_0151*(IT_0062 + 0.5*IT_0199) + IT_0123*IT_0200 +
       IT_0139*IT_0201 + IT_0187*IT_0202 + IT_0188*IT_0203 + IT_0171*IT_0204;
    const ccomplex_t IT_0206 = (-3)*IT_0063*IT_0149 + IT_0042*IT_0151 + 2
      *IT_0133*IT_0169 + IT_0160*IT_0183 + (-3)*IT_0139*IT_0200 + (-3)*IT_0123
      *IT_0201 + (-3)*IT_0165*IT_0202 + (-3)*IT_0171*IT_0203 + (-3)*IT_0188
      *IT_0204;
    const ccomplex_t IT_0207 = (-2)*conj(IT_0062);
    const ccomplex_t IT_0208 = IT_0157*IT_0158;
    ...
    const ccomplex_t IT_0210 = 2*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      ...
      *IT_0080 + -IT_0103*IT_0104 + IT_0105*IT_0109 + (-2)*IT_0065*IT_0117 +
       IT_0123*IT_0133 + IT_0139*IT_0149) + IT_0063*IT_0149*IT_0150 + 2*IT_0151*
      (IT_0042*conj(IT_0130) + conj(IT_0042)*IT_0133 + IT_0149*(conj(IT_0062) +
       0.5*IT_0153)) + (IT_0064*IT_0152 + IT_0105*IT_0157 + IT_0158*IT_0159 +
       IT_0149*IT_0160)*IT_0161 + 2*conj(IT_0130)*(IT_0065*IT_0123 + IT_0152
      *IT_0160 + IT_0077*IT_0165 + 2*IT_0133*IT_0169 + 0.5*IT_0170*IT_0171) + 
      (IT_0062*IT_0159 + IT_0133*IT_0170 + IT_0158*IT_0176 + IT_0149*IT_0177)
      ...
      *IT_0189)*IT_0190 + IT_0192 + (IT_0103*IT_0139 + IT_0062*IT_0160 + IT_0158
      *IT_0177)*IT_0193 + 2*conj(IT_0062)*(IT_0048*IT_0062 + IT_0042*IT_0064 +
       0.5*IT_0160*IT_0191 + IT_0171*IT_0194) + 2*conj(IT_0105)*(IT_0065*IT_0109
       + IT_0152*IT_0159 + 0.5*IT_0157*IT_0195 + IT_0171*IT_0197) + 2*conj
      (IT_0158)*(0.5*IT_0171*IT_0176 + IT_0157*IT_0183 + 0.5*IT_0177*IT_0191 +
       IT_0194*IT_0195 + IT_0188*IT_0197) + (-6)*(conj(IT_0143) + conj(IT_0148))
      *IT_0205 + 2*conj(IT_0132)*IT_0206 + IT_0207*(IT_0048*IT_0152 + IT_0132
      *IT_0160 + IT_0208 + IT_0209) + 2*conj(IT_0152)*(IT_0105*IT_0159 + IT_0133
      *IT_0160 + IT_0048*IT_0183 + 0.5*IT_0064*IT_0195 + IT_0208 + IT_0209);
