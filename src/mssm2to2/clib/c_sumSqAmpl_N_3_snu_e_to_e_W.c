...
ccomplex_return_t c_sumSqAmpl_N_3_snu_e_to_e_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_se_L*
    ...
    const ccomplex_t IT_0063 = m_e*m_N_3;
    ...
    const ccomplex_t IT_0122 = m_e*IT_0121;
    ...
    const ccomplex_t IT_0142 = m_e*IT_0076;
    ...
    const ccomplex_t IT_0160 = m_e*IT_0047;
    ...
    const ccomplex_t IT_0170 = m_e*IT_0153;
