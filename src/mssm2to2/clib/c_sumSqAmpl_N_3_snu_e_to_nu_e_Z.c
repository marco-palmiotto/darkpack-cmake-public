        ...
        )
{
    ...
    const ccomplex_t IT_0013 = N_u3*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0018 = N_d3*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0045 = cpow(s_23 + (-0.5)*IT_0032 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0050 = IT_0016*IT_0048;
    ...
    const ccomplex_t IT_0062 = IT_0016*IT_0060;
    ...
    const ccomplex_t IT_0077 = cpow(s_23 + (-0.5)*IT_0032 + 0.5*m_N_2*(m_N_2 +
       (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = conj(N_d2)*N_d3*e_em;
    const ccomplex_t IT_0081 = IT_0016*IT_0080;
    const ccomplex_t IT_0082 = conj(N_u2)*N_u3*e_em;
    const ccomplex_t IT_0083 = IT_0012*IT_0082;
    const ccomplex_t IT_0084 = IT_0016*IT_0082;
    const ccomplex_t IT_0085 = IT_0012*IT_0080;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*(IT_0081 + -IT_0083 + 
      -IT_0084 + IT_0085);
    const ccomplex_t IT_0087 = (-0.5)*IT_0086;
    const ccomplex_t IT_0088 = m_N_2*IT_0087;
    const ccomplex_t IT_0089 = N_d2*conj(N_d3)*e_em;
    const ccomplex_t IT_0090 = IT_0012*IT_0089;
    const ccomplex_t IT_0091 = IT_0016*IT_0089;
    const ccomplex_t IT_0092 = N_u2*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0117 = cpow(s_23 + (-0.5)*IT_0032 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0120 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0121 = IT_0012*IT_0120;
    const ccomplex_t IT_0122 = IT_0016*IT_0120;
    const ccomplex_t IT_0123 = N_d3*conj(N_d4)*e_em;
    const ccomplex_t IT_0124 = IT_0012*IT_0123;
    const ccomplex_t IT_0125 = IT_0016*IT_0123;
    ...
    const ccomplex_t IT_0129 = conj(N_d3)*N_d4*e_em;
    const ccomplex_t IT_0130 = IT_0012*IT_0129;
    const ccomplex_t IT_0131 = IT_0016*IT_0129;
    const ccomplex_t IT_0132 = conj(N_u3)*N_u4*e_em;
    const ccomplex_t IT_0133 = IT_0012*IT_0132;
    const ccomplex_t IT_0134 = IT_0016*IT_0132;
    ...
    const ccomplex_t IT_0141 = 0.25*IT_0105 + (-0.25)*IT_0108 + 0.5*IT_0140;
    const ccomplex_t IT_0142 = IT_0102 + IT_0141;
    const ccomplex_t IT_0143 = conj(IT_0102) + conj(IT_0141);
    ...
    const ccomplex_t IT_0149 = cpow(s_12 + 0.5*IT_0032 + 0.5*IT_0148 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0150 = e_em*IT_0012;
    const ccomplex_t IT_0151 = e_em*IT_0016;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*(IT_0150 + IT_0151);
    ...
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*e_em*IT_0010*IT_0015;
    const ccomplex_t IT_0158 = -IT_0157;
    const ccomplex_t IT_0159 = cpow(s_13 + (-0.5)*IT_0148 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0163 = -IT_0156 + (-0.5)*IT_0162;
    const ccomplex_t IT_0164 = IT_0047*IT_0064;
    const ccomplex_t IT_0165 = IT_0079*IT_0097;
    const ccomplex_t IT_0166 = IT_0164 + IT_0165;
    const ccomplex_t IT_0167 = 2*IT_0166;
    const ccomplex_t IT_0168 = IT_0022*IT_0035;
    const ccomplex_t IT_0169 = IT_0035*IT_0103;
    const ccomplex_t IT_0170 = IT_0119*IT_0136;
    const ccomplex_t IT_0171 = 0.5*IT_0162 + 0.5*IT_0168 + (-0.5)*IT_0169 +
       IT_0170;
    const ccomplex_t IT_0172 = (-2)*IT_0171;
    const ccomplex_t IT_0173 = IT_0167 + IT_0172;
    const ccomplex_t IT_0174 = 2*conj(IT_0166);
    const ccomplex_t IT_0175 = (-2)*conj(IT_0171);
    const ccomplex_t IT_0176 = IT_0174 + IT_0175;
    const ccomplex_t IT_0177 = m_N_3*IT_0146;
    const ccomplex_t IT_0178 = s_34*IT_0001;
    const ccomplex_t IT_0179 = IT_0000*IT_0178;
    const ccomplex_t IT_0180 = (-0.25)*IT_0179;
    const ccomplex_t IT_0181 = s_34 + IT_0180;
    const ccomplex_t IT_0182 = m_N_3*IT_0181;
    const ccomplex_t IT_0183 = (-4)*IT_0182;
    const ccomplex_t IT_0184 = (-0.5)*IT_0164 + (-0.5)*IT_0165;
    const ccomplex_t IT_0185 = (-0.25)*IT_0168 + 0.25*IT_0169 + (-0.5)*IT_0170;
    const ccomplex_t IT_0186 = 2*IT_0102;
    const ccomplex_t IT_0187 = 2*IT_0141;
    const ccomplex_t IT_0188 = IT_0186 + IT_0187;
    const ccomplex_t IT_0189 = 2*conj(IT_0102);
    const ccomplex_t IT_0190 = 2*conj(IT_0141);
    const ccomplex_t IT_0191 = IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = pow(s_34, 2);
    const ccomplex_t IT_0193 = s_13*IT_0000*IT_0192;
    const ccomplex_t IT_0194 = 2*IT_0163;
    const ccomplex_t IT_0195 = m_N_3*IT_0000*IT_0192;
    const ccomplex_t IT_0196 = 2*conj(IT_0163);
    const ccomplex_t IT_0197 = s_13*s_34;
    const ccomplex_t IT_0198 = (-0.5)*IT_0156;
    const ccomplex_t IT_0199 = conj(IT_0184) + conj(IT_0198);
    const ccomplex_t IT_0200 = IT_0184 + IT_0198;
    const ccomplex_t IT_0201 = pow(m_Z, 4);
    const ccomplex_t IT_0202 = s_13*IT_0201;
    const ccomplex_t IT_0203 = IT_0000*IT_0202;
    const ccomplex_t IT_0204 = (-0.5)*IT_0203;
    const ccomplex_t IT_0205 = IT_0002 + IT_0004 + IT_0204;
    const ccomplex_t IT_0206 = -conj(IT_0185);
    const ccomplex_t IT_0207 = (-0.25)*IT_0203;
    const ccomplex_t IT_0208 = IT_0003 + IT_0207;
    const ccomplex_t IT_0209 = 0.5*IT_0179;
    ...
    const ccomplex_t IT_0226 = 4*IT_0008*IT_0142*IT_0143 + IT_0147*(conj
      (IT_0163)*IT_0173 + IT_0163*IT_0176) + (IT_0143*IT_0173 + IT_0142*IT_0176)
      *IT_0177 + (-2)*IT_0183*(IT_0143*IT_0184 + IT_0142*conj(IT_0184) + (-0.5)
      *conj(IT_0185)*IT_0188 + (-0.5)*IT_0185*IT_0191) + conj(IT_0163)*IT_0193
      *IT_0194 + IT_0195*(IT_0143*IT_0194 + IT_0142*IT_0196) + (-2)*IT_0197*
      (conj(IT_0163)*IT_0185 + IT_0163*conj(IT_0185) + (-0.5)*IT_0194*IT_0199 + 
      (-0.5)*IT_0196*IT_0200) + (-4)*IT_0205*(IT_0198*conj(IT_0198) + (IT_0184 +
       -IT_0185)*(conj(IT_0184) + IT_0206)) + 8*conj(IT_0198)*((IT_0184 + 
      -IT_0185)*IT_0208 + IT_0188*IT_0213) + 8*IT_0198*((conj(IT_0184) + IT_0206
      )*IT_0208 + IT_0191*IT_0213) + IT_0218*(conj(IT_0166)*IT_0167 + IT_0171
      *IT_0219 + (-2)*conj(IT_0171)*(IT_0166 + IT_0221)) + (IT_0173*IT_0199 +
       IT_0176*IT_0200 + 2*IT_0185*(conj(IT_0171) + 0.5*IT_0219) + 2*IT_0206*
      (IT_0166 + IT_0221))*IT_0225;
