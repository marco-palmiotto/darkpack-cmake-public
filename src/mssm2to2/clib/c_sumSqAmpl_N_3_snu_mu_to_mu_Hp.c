...
ccomplex_return_t c_sumSqAmpl_N_3_snu_mu_to_mu_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_mu*m_N_3*IT_0000;
    ...
    const ccomplex_t IT_0111 = m_mu*m_N_3;
    const ccomplex_t IT_0112 = IT_0004*IT_0100;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0114 = IT_0025*IT_0112*IT_0113;
    const ccomplex_t IT_0115 = m_mu*IT_0085;
    const ccomplex_t IT_0116 = m_mu*IT_0103;
    const ccomplex_t IT_0117 = IT_0114 + -IT_0115 + -IT_0116;
    const ccomplex_t IT_0118 = IT_0022*IT_0087;
    const ccomplex_t IT_0119 = IT_0025*IT_0113*IT_0118;
    const ccomplex_t IT_0120 = m_mu*IT_0027;
    const ccomplex_t IT_0121 = m_mu*IT_0045;
    const ccomplex_t IT_0122 = IT_0119 + -IT_0120 + -IT_0121;
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0003*IT_0049*IT_0050;
    const ccomplex_t IT_0130 = (-0.5)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0024 + IT_0047 + -m_smu_L*
    ...
    const ccomplex_t IT_0135 = cpow((-2)*s_13 + IT_0024 + IT_0047 + -m_smu_R*
    ...
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0003*IT_0049;
    ...
    const ccomplex_t IT_0143 = -IT_0125 + (-0.5)*IT_0126 + IT_0134 + IT_0142;
    ...
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0003*IT_0049*IT_0050;
    ...
    const ccomplex_t IT_0154 = IT_0028*IT_0082;
    ...
    const ccomplex_t IT_0173 = 2*IT_0001*(conj(IT_0046)*IT_0105 + IT_0046
      ...
      *IT_0111*(conj(IT_0117)*(IT_0122 + -IT_0143) + IT_0117*(conj(IT_0122) + 
      ...
      *IT_0166 + IT_0046*IT_0169)*IT_0170 + (IT_0117*conj(IT_0117) + IT_0122
      *conj(IT_0122) + IT_0143*conj(IT_0143) + IT_0156*conj(IT_0156))*IT_0171 + 
      (conj(IT_0122)*IT_0143 + IT_0122*conj(IT_0143) + conj(IT_0117)*IT_0156 +
