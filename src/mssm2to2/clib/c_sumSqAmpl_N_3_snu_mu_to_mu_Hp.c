        ...
        )
{
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_C_2*
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_C_1*
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0003*IT_0063*IT_0064;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0003*IT_0063*IT_0064;
    ...
    const ccomplex_t IT_0126 = cpow((-2)*s_13 + IT_0024 + IT_0100 + -m_smu_L*
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0003*IT_0063;
    const ccomplex_t IT_0130 = 0.5*IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0011;
    const ccomplex_t IT_0132 = -IT_0131;
    const ccomplex_t IT_0133 = IT_0130*IT_0132;
    const ccomplex_t IT_0134 = cpow((-2)*s_13 + IT_0024 + IT_0100 + -m_smu_R*
    ...
    const ccomplex_t IT_0137 = m_N_3*IT_0103;
    const ccomplex_t IT_0138 = -IT_0117 + -IT_0120 + IT_0128 + IT_0136 + (-0.5
      )*IT_0137;
    const ccomplex_t IT_0139 = IT_0027 + IT_0045;
    ...
    const ccomplex_t IT_0142 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0003*IT_0063*IT_0064;
    ...
    const ccomplex_t IT_0147 = IT_0004*IT_0062;
    const ccomplex_t IT_0148 = IT_0025*IT_0118*IT_0147;
    const ccomplex_t IT_0149 = IT_0028*IT_0082;
    const ccomplex_t IT_0150 = IT_0043*IT_0115*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*(IT_0093 + IT_0096);
    ...
    const ccomplex_t IT_0173 = 2*IT_0001*(conj(IT_0046)*IT_0105 + IT_0046
      ...
      *IT_0111*(conj(IT_0114)*(IT_0138 + -IT_0141) + IT_0114*(conj(IT_0138) + 
      ...
      *conj(IT_0138) + IT_0141*conj(IT_0141) + IT_0156*conj(IT_0156))*IT_0171 + 
      (conj(IT_0138)*IT_0141 + IT_0138*conj(IT_0141) + conj(IT_0114)*IT_0156 +
