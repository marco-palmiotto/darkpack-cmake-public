...
ccomplex_return_t c_sumSqAmpl_N_3_snu_mu_to_mu_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
    ...
    const ccomplex_t IT_0011 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_smu_L*
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_23 + IT_0009 + IT_0015 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0001*IT_0004*IT_0006;
    const ccomplex_t IT_0018 = 0.5*IT_0017;
    const ccomplex_t IT_0019 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0020 = IT_0001*IT_0019;
    const ccomplex_t IT_0021 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_23 + IT_0009 + IT_0015 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0001*IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0063 = m_mu*m_N_3;
    ...
    const ccomplex_t IT_0070 = cpow(s_12 + 0.5*IT_0010 + 0.5*IT_0015 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0071 = 0.5*IT_0002;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*(IT_0053 + -IT_0056);
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0001;
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0001;
    ...
    const ccomplex_t IT_0124 = IT_0025*IT_0092;
    ...
    const ccomplex_t IT_0140 = m_N_3*IT_0041;
    const ccomplex_t IT_0141 = m_N_3*IT_0028;
    const ccomplex_t IT_0142 = m_mu*IT_0076;
    const ccomplex_t IT_0143 = IT_0140 + IT_0141 + 0.5*IT_0142;
    const ccomplex_t IT_0144 = IT_0031*IT_0088;
    const ccomplex_t IT_0145 = IT_0029*IT_0127*IT_0144;
    const ccomplex_t IT_0146 = IT_0018*IT_0099;
    const ccomplex_t IT_0147 = IT_0016*IT_0125*IT_0146;
    const ccomplex_t IT_0148 = -IT_0145 + -IT_0147;
    const ccomplex_t IT_0149 = IT_0143 + IT_0148;
    const ccomplex_t IT_0150 = (-6)*conj(IT_0130);
    const ccomplex_t IT_0151 = s_14*s_34*IT_0043;
    const ccomplex_t IT_0152 = -IT_0151;
    const ccomplex_t IT_0153 = s_13 + IT_0152;
    const ccomplex_t IT_0154 = s_13*IT_0153;
    const ccomplex_t IT_0155 = (-2)*IT_0091 + (-2)*IT_0102;
    const ccomplex_t IT_0156 = IT_0061 + -IT_0076;
    const ccomplex_t IT_0157 = IT_0063*IT_0153;
    const ccomplex_t IT_0158 = m_N_3*IT_0153;
    const ccomplex_t IT_0159 = (-2)*conj(IT_0042);
    const ccomplex_t IT_0160 = m_mu*IT_0047;
    const ccomplex_t IT_0161 = (-2)*conj(IT_0155);
    const ccomplex_t IT_0162 = 0.5*IT_0135;
    const ccomplex_t IT_0163 = s_34 + IT_0162;
    const ccomplex_t IT_0164 = m_N_3*IT_0163;
    const ccomplex_t IT_0165 = 2*IT_0164;
    const ccomplex_t IT_0166 = IT_0110 + IT_0116;
    const ccomplex_t IT_0167 = IT_0043*IT_0166;
    const ccomplex_t IT_0168 = (-0.5)*IT_0167;
    const ccomplex_t IT_0169 = s_13 + IT_0168;
    const ccomplex_t IT_0170 = m_mu*IT_0153;
    const ccomplex_t IT_0171 = (-2)*IT_0105;
    const ccomplex_t IT_0172 = pow(s_34, 2);
    ...
    const ccomplex_t IT_0177 = m_N_3*IT_0175;
    ...
    const ccomplex_t IT_0183 = IT_0155 + IT_0182;
    ...
    const ccomplex_t IT_0188 = (-2)*IT_0156;
    const ccomplex_t IT_0189 = IT_0077 + IT_0103;
    const ccomplex_t IT_0190 = (-2)*conj(IT_0156);
    ...
    const ccomplex_t IT_0194 = 0.5*IT_0157;
    const ccomplex_t IT_0195 = (-2)*IT_0042;
    const ccomplex_t IT_0196 = s_13*IT_0175;
    const ccomplex_t IT_0197 = 0.5*IT_0196;
    const ccomplex_t IT_0198 = 4*IT_0143;
    const ccomplex_t IT_0199 = (-2)*IT_0155;
    ...
    const ccomplex_t IT_0203 = (-0.166666666666667)*IT_0170;
    const ccomplex_t IT_0204 = (-0.166666666666667)*IT_0177;
    const ccomplex_t IT_0205 = IT_0063*IT_0133 + (-0.166666666666667)*IT_0158
      *IT_0195 + (-0.666666666666667)*IT_0169*(IT_0148 + 0.25*IT_0198) + (
      -0.333333333333333)*IT_0160*(IT_0062 + 0.5*IT_0199) + IT_0123*IT_0200 +
       IT_0139*IT_0201 + IT_0187*IT_0202 + IT_0188*IT_0203 + IT_0171*IT_0204;
    const ccomplex_t IT_0206 = (-3)*IT_0063*IT_0149 + IT_0042*IT_0160 + 2
      *IT_0133*IT_0169 + IT_0158*IT_0183 + (-3)*IT_0139*IT_0200 + (-3)*IT_0123
      *IT_0201 + (-3)*IT_0165*IT_0202 + (-3)*IT_0171*IT_0203 + (-3)*IT_0188
      *IT_0204;
    const ccomplex_t IT_0207 = (-2)*conj(IT_0062);
    const ccomplex_t IT_0208 = IT_0154*IT_0156;
    const ccomplex_t IT_0209 = IT_0069*IT_0189;
    const ccomplex_t IT_0210 = 2*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      *IT_0064 + IT_0065*IT_0069) + 2*conj(IT_0065)*(IT_0042*IT_0069 + IT_0077
      *IT_0080 + -IT_0103*IT_0104 + IT_0105*IT_0109 + (-2)*IT_0065*IT_0117 +
       IT_0123*IT_0133 + IT_0139*IT_0149) + IT_0063*IT_0149*IT_0150 + (IT_0105
      *IT_0154 + IT_0064*IT_0155 + IT_0156*IT_0157 + IT_0149*IT_0158)*IT_0159 +
       2*IT_0160*(IT_0042*conj(IT_0130) + conj(IT_0042)*IT_0133 + IT_0149*(conj
      (IT_0062) + 0.5*IT_0161)) + 2*conj(IT_0130)*(IT_0065*IT_0123 + IT_0155
      *IT_0158 + IT_0077*IT_0165 + 2*IT_0133*IT_0169 + 0.5*IT_0170*IT_0171) + 
      (IT_0062*IT_0157 + IT_0133*IT_0170 + IT_0156*IT_0176 + IT_0149*IT_0177)
      *IT_0178 + 2*conj(IT_0077)*(IT_0065*IT_0080 + (-2)*IT_0077*IT_0117 +
       IT_0133*IT_0165 + 4*IT_0103*IT_0180 + IT_0069*IT_0183 + IT_0149*IT_0187 +
       0.5*IT_0109*IT_0188) + (IT_0149*IT_0170 + IT_0132*IT_0177 + IT_0109
      *IT_0189)*IT_0190 + IT_0192 + (IT_0103*IT_0139 + IT_0062*IT_0158 + IT_0156
      *IT_0177)*IT_0193 + 2*conj(IT_0062)*(IT_0048*IT_0062 + IT_0042*IT_0064 +
       0.5*IT_0158*IT_0191 + IT_0171*IT_0194) + 2*conj(IT_0105)*(IT_0065*IT_0109
       + IT_0155*IT_0157 + 0.5*IT_0154*IT_0195 + IT_0171*IT_0197) + 2*conj
      (IT_0156)*(0.5*IT_0171*IT_0176 + IT_0154*IT_0183 + 0.5*IT_0177*IT_0191 +
       IT_0194*IT_0195 + IT_0188*IT_0197) + (-6)*(conj(IT_0143) + conj(IT_0148))
      *IT_0205 + 2*conj(IT_0132)*IT_0206 + IT_0207*(IT_0048*IT_0155 + IT_0132
      *IT_0158 + IT_0208 + IT_0209) + 2*conj(IT_0155)*(IT_0105*IT_0157 + IT_0133
      *IT_0158 + IT_0048*IT_0183 + 0.5*IT_0064*IT_0195 + IT_0208 + IT_0209);
