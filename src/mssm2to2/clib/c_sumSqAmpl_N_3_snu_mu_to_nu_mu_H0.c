        ...
        )
{
    ...
    const ccomplex_t IT_0155 = conj(N_B3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0159 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0166 = cpow(s_23 + (-0.5)*IT_0063 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0167 = IT_0082*IT_0166;
