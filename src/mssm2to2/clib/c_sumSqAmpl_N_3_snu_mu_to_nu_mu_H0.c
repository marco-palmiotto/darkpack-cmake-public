        ...
        )
{
    ...
    const ccomplex_t IT_0035 = cpow(s_23 + (-0.5)*IT_0034 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0033*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = IT_0001*IT_0016;
    const ccomplex_t IT_0039 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = IT_0006*IT_0018;
    const ccomplex_t IT_0042 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0045 = IT_0038*IT_0044;
    const ccomplex_t IT_0046 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0047 = IT_0041*IT_0046;
    const ccomplex_t IT_0048 = IT_0040 + IT_0043 + IT_0045 + IT_0047;
    const ccomplex_t IT_0049 = IT_0001*IT_0018;
    const ccomplex_t IT_0050 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = IT_0006*IT_0016;
    ...
    const ccomplex_t IT_0059 = -IT_0051 + -IT_0054 + -IT_0056 + -IT_0058;
    ...
    const ccomplex_t IT_0068 = N_B3*N_d4*e_em;
    ...
    const ccomplex_t IT_0109 = cpow(s_23 + (-0.5)*IT_0034 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0135 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0136 = IT_0038*IT_0135;
    const ccomplex_t IT_0137 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0138 = IT_0041*IT_0137;
    const ccomplex_t IT_0139 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0140 = IT_0038*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0142 = IT_0041*IT_0141;
    const ccomplex_t IT_0143 = IT_0136 + IT_0138 + IT_0140 + IT_0142;
    const ccomplex_t IT_0144 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0148 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0166 = cpow(s_23 + (-0.5)*IT_0034 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0178 = cpow(s_23 + (-0.5)*IT_0034 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0185 = N_B2*N_d3*e_em;
    const ccomplex_t IT_0186 = IT_0038*IT_0185;
    ...
    const ccomplex_t IT_0190 = N_B3*N_u2*e_em;
    ...
    const ccomplex_t IT_0196 = N_W2*N_d3*e_em;
    const ccomplex_t IT_0197 = IT_0052*IT_0196;
    ...
    const ccomplex_t IT_0203 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0204 = IT_0038*IT_0203;
    const ccomplex_t IT_0205 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0206 = IT_0041*IT_0205;
    const ccomplex_t IT_0207 = conj(N_B3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0214 = conj(N_W2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0215 = IT_0052*IT_0214;
    const ccomplex_t IT_0216 = conj(N_B3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0227 = 0.5*IT_0025 + 0.5*IT_0087 + 0.5*IT_0112 + 0.5
      *IT_0169 + 0.5*IT_0226;
    const ccomplex_t IT_0228 = IT_0180*IT_0201;
    const ccomplex_t IT_0229 = IT_0133*IT_0168;
    const ccomplex_t IT_0230 = IT_0037*IT_0084;
    const ccomplex_t IT_0231 = IT_0096*IT_0111;
