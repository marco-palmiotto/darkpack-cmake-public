        ...
        )
{
    ...
    const ccomplex_t IT_0045 = cpow(s_23 + (-0.5)*IT_0021 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0062 = IT_0028*IT_0060;
    ...
    const ccomplex_t IT_0073 = IT_0028*IT_0071;
    const ccomplex_t IT_0074 = IT_0025*IT_0069;
    ...
    const ccomplex_t IT_0086 = cpow(s_23 + (-0.5)*IT_0021 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0128 = conj(N_d3)*N_d4*e_em;
    const ccomplex_t IT_0129 = IT_0025*IT_0128;
    const ccomplex_t IT_0130 = IT_0028*IT_0128;
    const ccomplex_t IT_0131 = conj(N_u3)*N_u4*e_em;
    const ccomplex_t IT_0132 = IT_0025*IT_0131;
    const ccomplex_t IT_0133 = IT_0028*IT_0131;
    ...
    const ccomplex_t IT_0140 = 0.25*IT_0093 + (-0.25)*IT_0096 + 0.5*IT_0107 +
       0.5*IT_0139;
    const ccomplex_t IT_0141 = IT_0090 + IT_0140;
    const ccomplex_t IT_0142 = conj(IT_0090) + conj(IT_0140);
    const ccomplex_t IT_0143 = s_14*s_34*IT_0000;
    ...
    const ccomplex_t IT_0148 = cpow(s_12 + 0.5*IT_0021 + 0.5*IT_0147 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0149 = e_em*IT_0025;
    const ccomplex_t IT_0150 = e_em*IT_0028;
    ...
    const ccomplex_t IT_0158 = cpow(s_13 + (-0.5)*IT_0147 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0162 = -IT_0155 + (-0.5)*IT_0161;
    const ccomplex_t IT_0163 = IT_0047*IT_0064;
    const ccomplex_t IT_0164 = 2*IT_0163;
    const ccomplex_t IT_0165 = IT_0024*IT_0034;
    const ccomplex_t IT_0166 = IT_0088*IT_0105;
    const ccomplex_t IT_0167 = IT_0024*IT_0091;
    const ccomplex_t IT_0168 = IT_0118*IT_0135;
    const ccomplex_t IT_0169 = 0.5*IT_0161 + 0.5*IT_0165 + -IT_0166 + (-0.5)
      *IT_0167 + IT_0168;
    const ccomplex_t IT_0170 = (-2)*IT_0169;
    const ccomplex_t IT_0171 = IT_0164 + IT_0170;
    const ccomplex_t IT_0172 = 2*conj(IT_0163);
    const ccomplex_t IT_0173 = (-2)*conj(IT_0169);
    const ccomplex_t IT_0174 = IT_0172 + IT_0173;
    const ccomplex_t IT_0175 = m_N_3*IT_0145;
    ...
    const ccomplex_t IT_0182 = (-0.5)*IT_0163;
    const ccomplex_t IT_0183 = (-0.25)*IT_0165 + 0.5*IT_0166 + 0.25*IT_0167 + 
      (-0.5)*IT_0168;
    const ccomplex_t IT_0184 = 2*IT_0090;
    const ccomplex_t IT_0185 = 2*IT_0140;
    const ccomplex_t IT_0186 = IT_0184 + IT_0185;
    const ccomplex_t IT_0187 = 2*conj(IT_0090);
    const ccomplex_t IT_0188 = 2*conj(IT_0140);
    const ccomplex_t IT_0189 = IT_0187 + IT_0188;
    const ccomplex_t IT_0190 = pow(s_34, 2);
    const ccomplex_t IT_0191 = s_13*IT_0000*IT_0190;
    const ccomplex_t IT_0192 = 2*IT_0162;
    const ccomplex_t IT_0193 = s_13*s_34;
    const ccomplex_t IT_0194 = (-0.5)*IT_0155;
    const ccomplex_t IT_0195 = conj(IT_0182) + conj(IT_0194);
    const ccomplex_t IT_0196 = IT_0182 + IT_0194;
    const ccomplex_t IT_0197 = 2*conj(IT_0162);
    const ccomplex_t IT_0198 = m_N_3*IT_0000*IT_0190;
    const ccomplex_t IT_0199 = pow(s_14, 2);
    const ccomplex_t IT_0200 = IT_0000*IT_0199;
    const ccomplex_t IT_0201 = -IT_0147;
    const ccomplex_t IT_0202 = IT_0200 + IT_0201;
    const ccomplex_t IT_0203 = s_13*IT_0202;
    const ccomplex_t IT_0204 = 2*IT_0169;
    const ccomplex_t IT_0205 = (-0.5)*IT_0204;
    const ccomplex_t IT_0206 = IT_0163 + IT_0205;
    const ccomplex_t IT_0207 = (-2)*conj(IT_0163);
    const ccomplex_t IT_0208 = s_13*s_14;
    const ccomplex_t IT_0209 = s_34*IT_0147;
    const ccomplex_t IT_0210 = -IT_0209;
    const ccomplex_t IT_0211 = IT_0208 + IT_0210;
    const ccomplex_t IT_0212 = -conj(IT_0183);
    const ccomplex_t IT_0213 = pow(m_Z, 4);
    const ccomplex_t IT_0214 = s_13*IT_0213;
    const ccomplex_t IT_0215 = IT_0000*IT_0214;
    const ccomplex_t IT_0216 = (-0.5)*IT_0215;
    const ccomplex_t IT_0217 = IT_0002 + IT_0004 + IT_0216;
    const ccomplex_t IT_0218 = (-0.25)*IT_0215;
    const ccomplex_t IT_0219 = IT_0003 + IT_0218;
    const ccomplex_t IT_0220 = 0.5*IT_0177;
    const ccomplex_t IT_0221 = s_34 + IT_0220;
    const ccomplex_t IT_0222 = m_N_3*IT_0221;
    const ccomplex_t IT_0223 = 2*IT_0222;
    const ccomplex_t IT_0224 = 0.125*IT_0223;
    const ccomplex_t IT_0225 = 4*IT_0008*IT_0141*IT_0142 + IT_0146*(conj
      (IT_0162)*IT_0171 + IT_0162*IT_0174) + (IT_0142*IT_0171 + IT_0141*IT_0174)
      *IT_0175 + (-2)*IT_0181*(IT_0142*IT_0182 + IT_0141*conj(IT_0182) + (-0.5)
      *conj(IT_0183)*IT_0186 + (-0.5)*IT_0183*IT_0189) + conj(IT_0162)*IT_0191
      *IT_0192 + (-2)*IT_0193*(conj(IT_0162)*IT_0183 + IT_0162*conj(IT_0183) + (
      -0.5)*IT_0192*IT_0195 + (-0.5)*IT_0196*IT_0197) + (IT_0142*IT_0192 +
       IT_0141*IT_0197)*IT_0198 + (-2)*IT_0203*((-0.5)*conj(IT_0163)*IT_0164 +
       conj(IT_0169)*IT_0206 + (-0.5)*IT_0169*IT_0207) + IT_0211*(IT_0171
      *IT_0195 + IT_0174*IT_0196 + 2*IT_0183*(conj(IT_0169) + 0.5*IT_0207) + 2
      *IT_0206*IT_0212) + (-4)*(IT_0194*conj(IT_0194) + (IT_0182 + -IT_0183)*
      (conj(IT_0182) + IT_0212))*IT_0217 + 8*conj(IT_0194)*((IT_0182 + -IT_0183)
      *IT_0219 + IT_0186*IT_0224) + 8*IT_0194*((conj(IT_0182) + IT_0212)*IT_0219
       + IT_0189*IT_0224);
