        ...
        )
{
    ...
    const ccomplex_t IT_0014 = cpow(IT_0002, -1);
    const ccomplex_t IT_0015 = conj(N_B3)*e_em;
    ...
    const ccomplex_t IT_0035 = IT_0006*IT_0011;
    ...
    const ccomplex_t IT_0121 = cpow((-2)*s_13 + IT_0000 + IT_0108 + -m_N_2*
    ...
    const ccomplex_t IT_0178 = cpow((-2)*s_13 + IT_0000 + IT_0108 + -m_N_4*
    ...
    const ccomplex_t IT_0227 = -IT_0025 + -IT_0054 + -IT_0112 + -IT_0169 + 
      -IT_0226;
    const ccomplex_t IT_0228 = IT_0123*IT_0144;
    const ccomplex_t IT_0229 = IT_0180*IT_0201;
    const ccomplex_t IT_0230 = IT_0038*IT_0053;
    const ccomplex_t IT_0231 = IT_0075*IT_0111;
