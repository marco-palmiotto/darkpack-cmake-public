        ...
        )
{
    ...
    const ccomplex_t IT_0109 = IT_0022*IT_0084;
    const ccomplex_t IT_0110 = IT_0025*IT_0108*IT_0109;
    ...
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*(A_tau*IT_0047*conj
      ...
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0115 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0116 = IT_0011*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = IT_0003*IT_0064;
    const ccomplex_t IT_0119 = N_d3*e_em*m_tau*IT_0063*U_stau_01;
    ...
    const ccomplex_t IT_0125 = cpow(s_13 + (-0.5)*IT_0024 + (-0.5)*IT_0089 + (
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*(A_tau*IT_0047*conj
    ...
    const ccomplex_t IT_0132 = N_d3*e_em*m_tau*IT_0063*U_stau_00;
    ...
    const ccomplex_t IT_0138 = cpow(s_13 + (-0.5)*IT_0024 + (-0.5)*IT_0089 + (
    ...
    const ccomplex_t IT_0141 = m_N_3*IT_0103;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0143 = IT_0041*IT_0066;
    const ccomplex_t IT_0144 = IT_0043*IT_0142*IT_0143;
    const ccomplex_t IT_0145 = (-0.5)*IT_0127 + (-0.5)*IT_0140 + (-0.5)
      *IT_0141 + 0.5*IT_0144;
    const ccomplex_t IT_0146 = m_tau*IT_0087;
    const ccomplex_t IT_0147 = IT_0028*IT_0062;
    const ccomplex_t IT_0148 = IT_0043*IT_0142*IT_0147;
    const ccomplex_t IT_0149 = m_tau*IT_0069;
    const ccomplex_t IT_0150 = 0.5*IT_0146 + (-0.5)*IT_0148 + 0.5*IT_0149;
    const ccomplex_t IT_0151 = IT_0004*IT_0082;
    const ccomplex_t IT_0152 = IT_0025*IT_0108*IT_0151;
    const ccomplex_t IT_0153 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0154 = IT_0011*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0157 = IT_0003*IT_0156;
    const ccomplex_t IT_0158 = 1.4142135623731*IT_0157;
    const ccomplex_t IT_0159 = conj(N_d3)*e_em*m_tau*IT_0063*U_stau_10;
    const ccomplex_t IT_0160 = IT_0118*IT_0159;
    ...
    const ccomplex_t IT_0173 = conj(N_d3)*e_em*m_tau*IT_0063*U_stau_11;
    ...
    const ccomplex_t IT_0181 = 0.5*IT_0152 + 0.5*IT_0166 + 0.5*IT_0180;
