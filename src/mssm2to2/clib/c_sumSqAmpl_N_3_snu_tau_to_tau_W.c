...
ccomplex_return_t c_sumSqAmpl_N_3_snu_tau_to_tau_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = N_B3*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0013 = N_d3*e_em*m_tau*IT_0012*U_stau_01;
    ...
    const ccomplex_t IT_0026 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0027 = IT_0005*IT_0026;
    const ccomplex_t IT_0028 = 1.4142135623731*IT_0027;
    const ccomplex_t IT_0029 = N_d3*e_em*m_tau*IT_0012*U_stau_00;
    ...
    const ccomplex_t IT_0034 = cpow(s_13 + (-0.5)*IT_0018 + (-0.5)*IT_0019 + (
    ...
    const ccomplex_t IT_0039 = cpow(s_23 + (-0.5)*IT_0019 + (-0.5)*IT_0038 +
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
    ...
    const ccomplex_t IT_0052 = cpow(s_23 + (-0.5)*IT_0019 + (-0.5)*IT_0038 +
       0.5*m_C_1*(m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0053 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0054 = IT_0001*IT_0053;
    const ccomplex_t IT_0055 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0065 = (-0.5)*IT_0023 + (-0.5)*IT_0037 + IT_0051 +
       IT_0064;
    ...
    const ccomplex_t IT_0072 = conj(N_d3)*e_em*m_tau*IT_0012*U_stau_10;
    ...
    const ccomplex_t IT_0080 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0081 = IT_0005*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0084 = IT_0001*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_d3)*e_em*m_tau*IT_0012*U_stau_11;
    ...
    const ccomplex_t IT_0095 = m_N_3*m_tau;
    ...
    const ccomplex_t IT_0102 = (-0.5)*IT_0051 + (-0.5)*IT_0064;
    ...
    const ccomplex_t IT_0107 = cpow(s_12 + 0.5*IT_0018 + 0.5*IT_0038 + 0.5
      *reg_prop, -1);
    ...
    const ccomplex_t IT_0138 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0001;
    const ccomplex_t IT_0139 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0140 = IT_0001*IT_0139;
    const ccomplex_t IT_0141 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0001;
    const ccomplex_t IT_0150 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0151 = IT_0001*IT_0150;
    const ccomplex_t IT_0152 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0158 = IT_0052*IT_0157;
    ...
    const ccomplex_t IT_0163 = s_34*IT_0122;
    const ccomplex_t IT_0164 = IT_0096*IT_0163;
    const ccomplex_t IT_0165 = 0.5*IT_0164;
    const ccomplex_t IT_0166 = s_34 + IT_0165;
    const ccomplex_t IT_0167 = m_N_3*IT_0166;
    const ccomplex_t IT_0168 = 2*IT_0167;
    const ccomplex_t IT_0169 = IT_0059*IT_0149;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0171 = IT_0052*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = IT_0046*IT_0138;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0174 = IT_0039*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = (-0.5)*IT_0171 + (-0.5)*IT_0174;
    const ccomplex_t IT_0176 = IT_0148 + IT_0159;
    const ccomplex_t IT_0177 = m_N_3*IT_0176;
    const ccomplex_t IT_0178 = 0.5*IT_0177;
    const ccomplex_t IT_0179 = IT_0175 + IT_0178;
    const ccomplex_t IT_0180 = (-2)*IT_0094;
    const ccomplex_t IT_0181 = 0.5*IT_0180;
    const ccomplex_t IT_0182 = IT_0176 + IT_0181;
    const ccomplex_t IT_0183 = s_14*IT_0122;
    const ccomplex_t IT_0184 = IT_0096*IT_0183;
    const ccomplex_t IT_0185 = (-0.25)*IT_0184;
    const ccomplex_t IT_0186 = s_14 + IT_0185;
    const ccomplex_t IT_0187 = m_tau*IT_0186;
    const ccomplex_t IT_0188 = (-4)*IT_0187;
    const ccomplex_t IT_0189 = IT_0061*IT_0156;
    const ccomplex_t IT_0190 = IT_0052*IT_0170*IT_0189;
    const ccomplex_t IT_0191 = IT_0048*IT_0145;
    const ccomplex_t IT_0192 = IT_0039*IT_0173*IT_0191;
    const ccomplex_t IT_0193 = 0.5*IT_0190 + 0.5*IT_0192;
    const ccomplex_t IT_0194 = m_N_3*IT_0051;
    const ccomplex_t IT_0195 = m_tau*IT_0120;
    const ccomplex_t IT_0196 = m_N_3*IT_0064;
    const ccomplex_t IT_0197 = (-0.5)*IT_0194 + 0.5*IT_0195 + (-0.5)*IT_0196;
    const ccomplex_t IT_0198 = IT_0193 + IT_0197;
    const ccomplex_t IT_0199 = (-3)*IT_0123;
    const ccomplex_t IT_0200 = (-0.25)*IT_0164;
    const ccomplex_t IT_0201 = s_34 + IT_0200;
    const ccomplex_t IT_0202 = m_N_3*IT_0201;
    const ccomplex_t IT_0203 = (-4)*IT_0202;
    const ccomplex_t IT_0204 = 0.5*IT_0184;
    const ccomplex_t IT_0205 = s_14 + IT_0204;
    const ccomplex_t IT_0206 = m_tau*IT_0205;
    const ccomplex_t IT_0207 = 2*IT_0206;
    const ccomplex_t IT_0208 = (-2)*IT_0193;
    const ccomplex_t IT_0209 = (-0.5)*IT_0208;
    const ccomplex_t IT_0210 = IT_0197 + IT_0209;
    const ccomplex_t IT_0211 = (-6)*conj(IT_0193);
    const ccomplex_t IT_0212 = 0.5*IT_0023 + 0.5*IT_0037;
    const ccomplex_t IT_0213 = (-2)*IT_0212;
    const ccomplex_t IT_0214 = 2*conj(IT_0102)*(IT_0065*IT_0106 + IT_0121
      *IT_0124 + (-2)*IT_0102*IT_0137 + -IT_0160*IT_0199 + IT_0198*IT_0203 +
       IT_0179*IT_0207 + 0.5*IT_0129*IT_0213);
    const ccomplex_t IT_0215 = s_14*s_34*IT_0096;
    const ccomplex_t IT_0216 = -IT_0215;
    const ccomplex_t IT_0217 = s_13 + IT_0216;
    const ccomplex_t IT_0218 = IT_0095*IT_0217;
    const ccomplex_t IT_0219 = m_tau*IT_0217;
    const ccomplex_t IT_0220 = (-2)*conj(IT_0212);
    const ccomplex_t IT_0221 = pow(s_34, 2);
    const ccomplex_t IT_0222 = IT_0096*IT_0221;
    const ccomplex_t IT_0223 = -IT_0019;
    const ccomplex_t IT_0224 = IT_0222 + IT_0223;
    const ccomplex_t IT_0225 = s_13*IT_0224;
    const ccomplex_t IT_0226 = IT_0095*IT_0224;
    const ccomplex_t IT_0227 = m_N_3*IT_0224;
    const ccomplex_t IT_0228 = s_13*IT_0217;
    const ccomplex_t IT_0229 = (-2)*IT_0065;
    const ccomplex_t IT_0230 = IT_0130 + IT_0136;
    const ccomplex_t IT_0231 = IT_0096*IT_0230;
    const ccomplex_t IT_0232 = (-0.5)*IT_0231;
    const ccomplex_t IT_0233 = s_13 + IT_0232;
    const ccomplex_t IT_0234 = 4*IT_0193;
    const ccomplex_t IT_0235 = 0.25*IT_0234;
    const ccomplex_t IT_0236 = IT_0197 + IT_0235;
    const ccomplex_t IT_0237 = m_N_3*IT_0217;
    const ccomplex_t IT_0238 = (-2)*conj(IT_0065);
    const ccomplex_t IT_0239 = s_13*IT_0100;
    const ccomplex_t IT_0240 = (-2)*IT_0176;
    const ccomplex_t IT_0241 = (-2)*conj(IT_0176);
    const ccomplex_t IT_0242 = (-2)*conj(IT_0193);
    const ccomplex_t IT_0243 = m_tau*IT_0100;
    const ccomplex_t IT_0244 = 0.5*IT_0218;
    const ccomplex_t IT_0245 = IT_0121 + IT_0160;
    const ccomplex_t IT_0246 = 0.333333333333333*IT_0160;
    const ccomplex_t IT_0247 = (-0.666666666666667)*IT_0233;
    const ccomplex_t IT_0248 = (-0.333333333333333)*IT_0102;
    const ccomplex_t IT_0249 = (-0.333333333333333)*IT_0121;
    const ccomplex_t IT_0250 = (-3)*IT_0095*IT_0179 + -IT_0125*IT_0219 +
       IT_0212*IT_0227 + 0.5*IT_0229*IT_0237 + (IT_0094 + 0.5*IT_0240)*IT_0243 +
       (-3)*IT_0207*IT_0246 + (-3)*IT_0236*IT_0247 + (-3)*IT_0203*IT_0248 + (-3)
      *IT_0188*IT_0249;
    const ccomplex_t IT_0251 = 4*IT_0178;
    const ccomplex_t IT_0252 = (-3)*IT_0095*IT_0198 + 0.5*IT_0213*IT_0219 +
       IT_0125*IT_0227 + IT_0182*IT_0237 + IT_0065*IT_0243 + (-3)*IT_0203
      *IT_0246 + (-3)*IT_0207*IT_0248 + (-3)*IT_0168*IT_0249 + (-3)*IT_0247*
      (IT_0175 + 0.25*IT_0251);
    const ccomplex_t IT_0253 = (-2)*conj(IT_0094);
    const ccomplex_t IT_0254 = IT_0179*IT_0237;
    const ccomplex_t IT_0255 = IT_0106*IT_0245;
    const ccomplex_t IT_0256 = 2*conj(IT_0065)*(IT_0094*IT_0101 + IT_0102
      *IT_0106) + 2*conj(IT_0121)*(IT_0102*IT_0124 + IT_0125*IT_0129 + (-2)
      *IT_0121*IT_0137 + 4*IT_0160*IT_0162 + IT_0168*IT_0179 + IT_0106*IT_0182 +
       IT_0188*IT_0198) + 2*conj(IT_0160)*(IT_0125*IT_0129 + (-2)*IT_0137
      *IT_0160 + 4*IT_0121*IT_0162 + IT_0106*IT_0182 + -IT_0102*IT_0199 + 
      -IT_0179*IT_0203 + -IT_0207*IT_0210) + IT_0095*IT_0179*IT_0211 + IT_0214 +
       (IT_0102*IT_0129 + IT_0094*IT_0218 + IT_0179*IT_0219)*IT_0220 + 2*conj
      (IT_0212)*(IT_0176*IT_0218 + IT_0212*IT_0225 + IT_0125*IT_0226 + IT_0198
      *IT_0227 + 0.5*IT_0228*IT_0229) + 2*conj(IT_0193)*(IT_0121*IT_0188 +
       IT_0102*IT_0203 + IT_0212*IT_0227 + 2*IT_0233*IT_0236 + 0.5*IT_0229
      *IT_0237) + (IT_0101*IT_0176 + IT_0125*IT_0218 + IT_0212*IT_0228 + IT_0198
      *IT_0237)*IT_0238 + 2*IT_0239*(IT_0065*conj(IT_0065) + 0.5*conj(IT_0094)
      *IT_0240 + IT_0094*(conj(IT_0094) + 0.5*IT_0241)) + (IT_0160*IT_0207 +
       IT_0125*IT_0219)*IT_0242 + 2*(conj(IT_0065)*IT_0179 + IT_0094*conj
      (IT_0193) + conj(IT_0094)*IT_0198 + 0.5*IT_0197*IT_0241 + 0.5*IT_0176
      *IT_0242)*IT_0243 + 2*conj(IT_0094)*(IT_0065*IT_0101 + IT_0213*IT_0244) + 
      (-2)*conj(IT_0125)*(IT_0210*IT_0219 + -IT_0125*IT_0225 + -IT_0212*IT_0226 
      + -IT_0179*IT_0227 + -IT_0182*IT_0228 + -IT_0229*IT_0244 + -IT_0129
      *IT_0245) + 2*conj(IT_0197)*IT_0250 + 2*(conj(IT_0175) + conj(IT_0178))
      *IT_0252 + IT_0253*(IT_0125*IT_0228 + IT_0254 + IT_0255) + 2*conj(IT_0176)
      *(IT_0212*IT_0218 + IT_0125*IT_0228 + 0.5*IT_0101*IT_0229 + IT_0176
      *IT_0239 + 0.5*IT_0208*IT_0243 + IT_0254 + IT_0255);
