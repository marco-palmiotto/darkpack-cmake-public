        ...
        )
{
    ...
    const ccomplex_t IT_0006 = N_B3*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0013 = N_d3*e_em*m_tau*IT_0012*U_stau_00;
    ...
    const ccomplex_t IT_0026 = N_W3*e_em*conj(U_Wm1);
    const ccomplex_t IT_0027 = IT_0001*IT_0026;
    const ccomplex_t IT_0028 = N_d3*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em
    ...
    const ccomplex_t IT_0039 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0040 = IT_0001*IT_0039;
    const ccomplex_t IT_0041 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
      *m_tau*IT_0001*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0053 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0054 = IT_0005*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = N_d3*e_em*m_tau*IT_0012*U_stau_01;
    ...
    const ccomplex_t IT_0072 = conj(N_d3)*e_em*m_tau*IT_0012*U_stau_11;
    ...
    const ccomplex_t IT_0080 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0081 = IT_0005*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0084 = IT_0001*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_d3)*e_em*m_tau*IT_0012*U_stau_10;
    ...
    const ccomplex_t IT_0139 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0140 = IT_0001*IT_0139;
    const ccomplex_t IT_0141 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0163 = s_14*IT_0122;
    ...
    const ccomplex_t IT_0170 = IT_0034*IT_0145;
    const ccomplex_t IT_0171 = IT_0025*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0173 = IT_0047*IT_0156;
    const ccomplex_t IT_0174 = IT_0038*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = 0.5*IT_0171 + 0.5*IT_0174;
    const ccomplex_t IT_0176 = m_tau*IT_0120;
    const ccomplex_t IT_0177 = m_N_3*IT_0037;
    const ccomplex_t IT_0178 = m_N_3*IT_0050;
    const ccomplex_t IT_0179 = 0.5*IT_0176 + (-0.5)*IT_0177 + (-0.5)*IT_0178;
    const ccomplex_t IT_0180 = IT_0175 + IT_0179;
    const ccomplex_t IT_0181 = IT_0148 + IT_0159;
    const ccomplex_t IT_0182 = (-2)*IT_0094;
    ...
    const ccomplex_t IT_0191 = m_N_3*IT_0181;
    const ccomplex_t IT_0192 = 0.5*IT_0191;
    const ccomplex_t IT_0193 = IT_0032*IT_0138;
    const ccomplex_t IT_0194 = IT_0025*IT_0169*IT_0193;
    const ccomplex_t IT_0195 = IT_0045*IT_0149;
    const ccomplex_t IT_0196 = IT_0038*IT_0172*IT_0195;
    ...
    const ccomplex_t IT_0204 = 0.5*IT_0164;
    const ccomplex_t IT_0205 = s_14 + IT_0204;
    const ccomplex_t IT_0206 = m_tau*IT_0205;
    const ccomplex_t IT_0207 = 2*IT_0206;
    const ccomplex_t IT_0208 = (-2)*IT_0175;
    const ccomplex_t IT_0209 = (-0.5)*IT_0208;
    const ccomplex_t IT_0210 = IT_0179 + IT_0209;
    const ccomplex_t IT_0211 = s_14*s_34*IT_0096;
    const ccomplex_t IT_0212 = -IT_0211;
    const ccomplex_t IT_0213 = s_13 + IT_0212;
    const ccomplex_t IT_0214 = m_tau*IT_0213;
    const ccomplex_t IT_0215 = (-2)*conj(IT_0175);
    const ccomplex_t IT_0216 = m_tau*IT_0100;
    const ccomplex_t IT_0217 = (-2)*conj(IT_0181);
    const ccomplex_t IT_0218 = s_13*IT_0100;
    const ccomplex_t IT_0219 = (-2)*IT_0181;
    const ccomplex_t IT_0220 = 0.5*IT_0023 + 0.5*IT_0064;
    const ccomplex_t IT_0221 = IT_0095*IT_0213;
    const ccomplex_t IT_0222 = pow(s_34, 2);
    const ccomplex_t IT_0223 = IT_0096*IT_0222;
    const ccomplex_t IT_0224 = -IT_0019;
    const ccomplex_t IT_0225 = IT_0223 + IT_0224;
    const ccomplex_t IT_0226 = s_13*IT_0225;
    const ccomplex_t IT_0227 = IT_0095*IT_0225;
    const ccomplex_t IT_0228 = m_N_3*IT_0225;
    const ccomplex_t IT_0229 = s_13*IT_0213;
    const ccomplex_t IT_0230 = (-2)*IT_0065;
    const ccomplex_t IT_0231 = IT_0130 + IT_0136;
    const ccomplex_t IT_0232 = IT_0096*IT_0231;
    const ccomplex_t IT_0233 = (-0.5)*IT_0232;
    const ccomplex_t IT_0234 = s_13 + IT_0233;
    const ccomplex_t IT_0235 = m_N_3*IT_0213;
    const ccomplex_t IT_0236 = (-2)*conj(IT_0065);
    const ccomplex_t IT_0237 = (-2)*IT_0220;
    const ccomplex_t IT_0238 = 2*conj(IT_0102)*(IT_0065*IT_0106 + IT_0121
      *IT_0124 + (-2)*IT_0102*IT_0137 + -IT_0160*IT_0199 + IT_0180*IT_0203 +
       IT_0198*IT_0207 + 0.5*IT_0129*IT_0237);
    const ccomplex_t IT_0239 = (-2)*conj(IT_0220);
    const ccomplex_t IT_0240 = IT_0121 + IT_0160;
    const ccomplex_t IT_0241 = 0.5*IT_0221;
    ...
    const ccomplex_t IT_0245 = (-3)*IT_0095*IT_0180 + IT_0121*IT_0190 +
       IT_0065*IT_0216 + IT_0125*IT_0228 + IT_0184*IT_0235 + 0.5*IT_0214*IT_0237
       + 2*IT_0234*(IT_0197 + 0.25*IT_0242) + (-3)*IT_0203*IT_0243 + (-3)
      *IT_0207*IT_0244;
    const ccomplex_t IT_0246 = (-6)*conj(IT_0175);
    const ccomplex_t IT_0247 = IT_0095*IT_0198;
    const ccomplex_t IT_0248 = IT_0121*IT_0168 + -IT_0125*IT_0214 + IT_0216*
      (IT_0094 + 0.5*IT_0219) + IT_0220*IT_0228 + 2*IT_0180*IT_0234 + 0.5
      *IT_0230*IT_0235 + (-3)*IT_0207*IT_0243 + (-3)*IT_0203*IT_0244 + (-3)
      *IT_0247;
    const ccomplex_t IT_0249 = (-2)*conj(IT_0094);
    const ccomplex_t IT_0250 = IT_0198*IT_0235;
    const ccomplex_t IT_0251 = 2*conj(IT_0065)*(IT_0094*IT_0101 + IT_0102
      *IT_0106) + 2*conj(IT_0121)*(IT_0102*IT_0124 + IT_0125*IT_0129 + (-2)
      *IT_0121*IT_0137 + 4*IT_0160*IT_0162 + IT_0168*IT_0180 + IT_0106*IT_0184 +
       IT_0190*IT_0198) + 2*conj(IT_0160)*(IT_0125*IT_0129 + (-2)*IT_0137
      *IT_0160 + 4*IT_0121*IT_0162 + IT_0106*IT_0184 + -IT_0102*IT_0199 + 
      -IT_0198*IT_0203 + -IT_0207*IT_0210) + (IT_0160*IT_0207 + IT_0125*IT_0214)
      *IT_0215 + 2*IT_0216*(IT_0094*conj(IT_0175) + conj(IT_0094)*IT_0180 + conj
      (IT_0065)*IT_0198 + 0.5*IT_0181*IT_0215 + 0.5*IT_0179*IT_0217) + 2*IT_0218
      *(IT_0065*conj(IT_0065) + IT_0094*(conj(IT_0094) + 0.5*IT_0217) + 0.5*conj
      (IT_0094)*IT_0219) + 2*conj(IT_0220)*(IT_0181*IT_0221 + IT_0220*IT_0226 +
       IT_0125*IT_0227 + IT_0180*IT_0228 + 0.5*IT_0229*IT_0230) + 2*conj(IT_0175
      )*(IT_0121*IT_0168 + IT_0102*IT_0203 + IT_0220*IT_0228 + 2*IT_0180*IT_0234
       + 0.5*IT_0230*IT_0235) + (IT_0101*IT_0181 + IT_0125*IT_0221 + IT_0220
      *IT_0229 + IT_0180*IT_0235)*IT_0236 + IT_0238 + (IT_0102*IT_0129 + IT_0198
      *IT_0214 + IT_0094*IT_0221)*IT_0239 + (-2)*conj(IT_0125)*(IT_0210*IT_0214 
      + -IT_0125*IT_0226 + -IT_0220*IT_0227 + -IT_0198*IT_0228 + -IT_0184
      *IT_0229 + -IT_0129*IT_0240 + -IT_0230*IT_0241) + 2*conj(IT_0094)*(IT_0065
      *IT_0101 + IT_0237*IT_0241) + 2*(conj(IT_0192) + conj(IT_0197))*IT_0245 +
       IT_0246*IT_0247 + 2*conj(IT_0179)*IT_0248 + IT_0249*(IT_0125*IT_0229 +
       IT_0106*IT_0240 + IT_0250) + 2*conj(IT_0181)*(0.5*IT_0208*IT_0216 +
       IT_0181*IT_0218 + IT_0220*IT_0221 + IT_0125*IT_0229 + 0.5*IT_0101*IT_0230
       + IT_0106*IT_0240 + IT_0250);
