        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0030 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0031 = IT_0004*IT_0030;
    const ccomplex_t IT_0032 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0093 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0094 = IT_0004*IT_0093;
    const ccomplex_t IT_0095 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0135 = IT_0013*IT_0092;
    ...
    const ccomplex_t IT_0147 = m_c*IT_0077;
    const ccomplex_t IT_0148 = m_N_3*IT_0019;
    const ccomplex_t IT_0149 = m_N_3*IT_0041;
    const ccomplex_t IT_0150 = -IT_0147 + -IT_0148 + -IT_0149;
    const ccomplex_t IT_0151 = IT_0038*IT_0088;
    const ccomplex_t IT_0152 = IT_0029*IT_0131*IT_0151;
    const ccomplex_t IT_0153 = IT_0006*IT_0099;
    const ccomplex_t IT_0154 = IT_0017*IT_0134*IT_0153;
    ...
    const ccomplex_t IT_0173 = m_c*IT_0161;
    ...
    const ccomplex_t IT_0210 = IT_0063*((-18)*IT_0150 + (-18)*IT_0155) +
       ...
       6*IT_0042*IT_0202 + IT_0123*IT_0205 + IT_0166*IT_0206 + IT_0146*IT_0208;
