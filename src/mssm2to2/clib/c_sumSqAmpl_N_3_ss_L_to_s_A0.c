...
ccomplex_return_t c_sumSqAmpl_N_3_ss_L_to_s_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0184 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0244 = m_s*m_N_3;
    const ccomplex_t IT_0245 = 6*IT_0183;
    const ccomplex_t IT_0246 = m_s*e_em*IT_0001*IT_0002*IT_0005*IT_0046;
    ...
    const ccomplex_t IT_0270 = m_s*m_N_3*IT_0269;
