...
ccomplex_return_t c_sumSqAmpl_N_3_ss_L_to_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = conj(N_B3)*e_em;
    const ccomplex_t IT_0005 = IT_0003*IT_0004;
    const ccomplex_t IT_0006 = 1.4142135623731*IT_0005;
    const ccomplex_t IT_0007 = sin(theta_W);
    const ccomplex_t IT_0008 = cpow(IT_0007, -1);
    const ccomplex_t IT_0009 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
    ...
    const ccomplex_t IT_0047 = m_s*s_14*m_N_3;
    ...
    const ccomplex_t IT_0057 = m_s*m_N_3;
    ...
    const ccomplex_t IT_0062 = m_s*s_34*m_N_3;
