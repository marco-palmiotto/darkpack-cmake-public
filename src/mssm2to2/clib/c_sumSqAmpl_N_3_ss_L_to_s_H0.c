...
ccomplex_return_t c_sumSqAmpl_N_3_ss_L_to_s_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0012 + -m_s*e_em*mu_h*IT_0000*IT_0002*IT_0004*IT_0018);
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0080 = (-0.5)*IT_0079;
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0083 = IT_0081*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*m_s*e_em*IT_0000*IT_0002
      *IT_0004*IT_0012;
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0236 = IT_0231 + -IT_0232 + -IT_0233 + -IT_0234 + 
      -IT_0235;
    const ccomplex_t IT_0237 = m_s*s_14;
    ...
    const ccomplex_t IT_0276 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0284 = m_s*IT_0231;
