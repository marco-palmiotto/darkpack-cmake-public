        ...
        )
{
    ...
    const ccomplex_t IT_0228 = m_s*m_N_3;
    ...
    const ccomplex_t IT_0236 = cpow((-2)*s_13 + IT_0019 + IT_0168 + -m_ss_L*
    ...
    const ccomplex_t IT_0259 = m_s*IT_0232;
    ...
    const ccomplex_t IT_0340 = m_s*IT_0268;
