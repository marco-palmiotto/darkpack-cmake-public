        ...
        )
{
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*m_s*e_em*IT_0000*IT_0002
      *IT_0004*IT_0018;
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*(m_s*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0007 + IT_0048 + -m_ss_R*
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0214 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0004;
