...
ccomplex_return_t c_sumSqAmpl_N_3_ss_L_to_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0006 + m_s*e_em*mu_h*IT_0000*IT_0016*IT_0055*IT_0057);
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0060 + IT_0071 + -m_ss_R*
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0060 + IT_0071 + -m_ss_L*
    ...
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0016*IT_0055*IT_0057;
    ...
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*m_s*e_em*IT_0006*IT_0016
      *IT_0055*IT_0057;
    ...
    const ccomplex_t IT_0232 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0288 = m_s*m_N_3;
    ...
    const ccomplex_t IT_0305 = m_s*m_N_3*IT_0304;
