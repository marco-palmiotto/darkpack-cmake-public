        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*V_cs
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0014 + IT_0019 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0003*IT_0006;
    const ccomplex_t IT_0022 = N_W3*U_d2*e_em;
    const ccomplex_t IT_0023 = IT_0021*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = IT_0003*IT_0010;
    const ccomplex_t IT_0026 = N_B3*U_d2*e_em;
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = 1.4142135623731*IT_0027;
    const ccomplex_t IT_0029 = IT_0024 + IT_0028;
    const ccomplex_t IT_0030 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_23 + IT_0014 + IT_0019 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*IT_0059;
    const ccomplex_t IT_0061 = m_c*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *mu_h*IT_0000*IT_0006;
    const ccomplex_t IT_0063 = 0.5*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0004*IT_0006;
    const ccomplex_t IT_0065 = (-0.5)*IT_0064;
    const ccomplex_t IT_0066 = IT_0063*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0014 + IT_0015 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = pow(m_s, 2);
    const ccomplex_t IT_0071 = cpow((-2)*s_12 + -IT_0015 + -IT_0019 + IT_0070 
      + -reg_prop, -1);
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0073 = (-0.333333333333333)*IT_0011;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
      *IT_0000*IT_0001*IT_0004*IT_0006;
    const ccomplex_t IT_0075 = 0.5*IT_0074;
    const ccomplex_t IT_0076 = IT_0073*IT_0075;
    const ccomplex_t IT_0077 = IT_0071*IT_0072*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0084 = IT_0018 + -IT_0041 + -IT_0061 + IT_0069 + 
      -IT_0077 + IT_0083;
    ...
    const ccomplex_t IT_0118 = IT_0058*IT_0101*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
    ...
    const ccomplex_t IT_0125 = IT_0079*IT_0120;
    const ccomplex_t IT_0126 = IT_0071*IT_0072*IT_0125;
    ...
    const ccomplex_t IT_0131 = IT_0106*IT_0130;
    ...
    const ccomplex_t IT_0142 = IT_0020*IT_0140*IT_0141;
    const ccomplex_t IT_0143 = -IT_0095 + -IT_0100 + IT_0118 + -IT_0124 +
       IT_0126 + IT_0142;
    const ccomplex_t IT_0144 = 6*s_13;
    const ccomplex_t IT_0145 = m_c*m_N_3;
    const ccomplex_t IT_0146 = 6*IT_0084;
    const ccomplex_t IT_0147 = IT_0040 + IT_0060 + -IT_0123;
    ...
    const ccomplex_t IT_0152 = m_c*m_N_3*IT_0019;
    const ccomplex_t IT_0153 = s_13*IT_0019;
