...
ccomplex_return_t c_sumSqAmpl_N_3_ss_R_to_c_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = N_d3*e_em*U_Wm1;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = (-2)*IT_0021;
    const ccomplex_t IT_0023 = IT_0006*IT_0011;
    const ccomplex_t IT_0024 = N_B3*U_d1*e_em;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*IT_0025;
    const ccomplex_t IT_0027 = N_W3*U_d1*e_em;
    ...
    const ccomplex_t IT_0034 = cpow(IT_0010, -1);
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0009*IT_0014*IT_0034;
    const ccomplex_t IT_0036 = (-0.5)*IT_0035;
    const ccomplex_t IT_0037 = IT_0033*IT_0036;
    const ccomplex_t IT_0038 = pow(m_c, 2);
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0002 + IT_0038 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0037*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = m_c*IT_0041;
    const ccomplex_t IT_0043 = N_W3*U_d2*e_em;
    const ccomplex_t IT_0044 = IT_0019*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = N_B3*U_d2*e_em;
    ...
    const ccomplex_t IT_0050 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0009*IT_0014*IT_0034;
    const ccomplex_t IT_0057 = (-0.5)*IT_0056;
    const ccomplex_t IT_0058 = IT_0055*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0002 + IT_0038 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = m_c*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0009*IT_0014*IT_0034;
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *mu_h*IT_0009*IT_0014;
    const ccomplex_t IT_0070 = 0.5*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0009*IT_0012*IT_0014;
    const ccomplex_t IT_0072 = (-0.5)*IT_0071;
    const ccomplex_t IT_0073 = IT_0070*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0001 + IT_0038 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0075 = IT_0073*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*V_cs
      *e_em*IT_0009*IT_0012*IT_0014*IT_0034;
    const ccomplex_t IT_0078 = 0.5*IT_0077;
    const ccomplex_t IT_0079 = 0.666666666666667*IT_0007;
    const ccomplex_t IT_0080 = IT_0078*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0001 + IT_0038 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = -IT_0018 + -IT_0042 + -IT_0062 + IT_0068 +
       IT_0076 + IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
    ...
    const ccomplex_t IT_0091 = IT_0010*IT_0014;
    const ccomplex_t IT_0092 = conj(N_u3)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0093 = IT_0091*IT_0092;
    const ccomplex_t IT_0094 = 2*IT_0093;
    const ccomplex_t IT_0095 = IT_0006*IT_0010;
    const ccomplex_t IT_0096 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0097 = IT_0095*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0107 = IT_0039*IT_0090*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0109 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0110 = IT_0091*IT_0109;
    const ccomplex_t IT_0111 = 2*IT_0110;
    const ccomplex_t IT_0112 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0113 = IT_0095*IT_0112;
    const ccomplex_t IT_0114 = 1.4142135623731*IT_0113;
    const ccomplex_t IT_0115 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0123 = IT_0059*IT_0108*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *IT_0009*IT_0011*IT_0014*IT_0034;
    ...
    const ccomplex_t IT_0141 = IT_0064*IT_0125;
    const ccomplex_t IT_0142 = IT_0003*IT_0004*IT_0141;
    const ccomplex_t IT_0143 = -IT_0089 + IT_0107 + IT_0123 + -IT_0129 + 
      -IT_0140 + IT_0142;
    const ccomplex_t IT_0144 = 6*s_13;
    const ccomplex_t IT_0145 = m_c*m_N_3;
    const ccomplex_t IT_0146 = 6*IT_0084;
    const ccomplex_t IT_0147 = IT_0041 + IT_0061 + -IT_0128;
    ...
    const ccomplex_t IT_0152 = m_c*m_N_3*IT_0002;
    ...
    const ccomplex_t IT_0161 = (IT_0084*conj(IT_0084) + IT_0143*conj(IT_0143))
      ...
      *IT_0148 + IT_0067*IT_0149)*IT_0150 + (IT_0067*IT_0148 + IT_0147*IT_0149)
      *IT_0151 + 6*conj(IT_0067)*(IT_0147*IT_0152 + 0.166666666666667*IT_0067
      *IT_0157 + IT_0158*IT_0159 + IT_0146*IT_0160) + 6*conj(IT_0147)*(IT_0067
