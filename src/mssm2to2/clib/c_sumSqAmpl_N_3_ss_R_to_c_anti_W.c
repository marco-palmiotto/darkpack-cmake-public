...
ccomplex_return_t c_sumSqAmpl_N_3_ss_R_to_c_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0039;
    ...
    const ccomplex_t IT_0047 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0048 = IT_0004*IT_0047;
    const ccomplex_t IT_0049 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0056 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0057 = IT_0004*IT_0056;
    const ccomplex_t IT_0058 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
