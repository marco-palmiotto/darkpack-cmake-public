...
ccomplex_return_t c_sumSqAmpl_N_3_ss_R_to_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_ss_R*
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0047 = IT_0007*IT_0037;
    const ccomplex_t IT_0048 = pow(s_13, 2);
    const ccomplex_t IT_0049 = (-8)*IT_0048;
    const ccomplex_t IT_0050 = -IT_0030;
    const ccomplex_t IT_0051 = m_s*m_N_3;
    const ccomplex_t IT_0052 = (-8)*s_14;
    const ccomplex_t IT_0053 = (-8)*s_34;
    const ccomplex_t IT_0054 = (-8)*IT_0007;
    ...
    const ccomplex_t IT_0056 = m_s*s_34*m_N_3;
    const ccomplex_t IT_0057 = (-8)*conj(IT_0017);
    const ccomplex_t IT_0058 = s_14*IT_0006;
    ...
    const ccomplex_t IT_0065 = s_13*(IT_0017*conj(IT_0017) + IT_0031*conj
      ...
      (IT_0027*IT_0039 + (-0.125)*IT_0040*IT_0045 + (-0.125)*IT_0035*IT_0046 + (
      -0.125)*IT_0016*IT_0047 + (-0.125)*IT_0017*IT_0049) + IT_0016*(conj
      (IT_0035)*IT_0046 + conj(IT_0017)*IT_0049) + (conj(IT_0036)*IT_0046 + conj
      (IT_0031)*IT_0049)*IT_0050 + (-8)*(IT_0039*IT_0040 + (-0.125)*IT_0027
      *IT_0045 + (-0.125)*IT_0036*IT_0046 + (-0.125)*IT_0031*IT_0049 + (-0.125)
      *IT_0047*IT_0050)*conj(IT_0050) + IT_0051*IT_0055 + IT_0040*(IT_0057
      *IT_0058 + IT_0056*IT_0059) + IT_0027*(IT_0056*IT_0057 + IT_0058*IT_0059) 
      + (-8)*conj(IT_0040)*((-0.125)*IT_0016*IT_0045 + IT_0039*IT_0050 + (-4)
      *IT_0040*IT_0060 + IT_0062*IT_0063 + IT_0061*IT_0064) + (-8)*conj(IT_0027)
      *(IT_0016*IT_0039 + (-0.125)*IT_0045*IT_0050 + (-4)*IT_0027*IT_0060 +
