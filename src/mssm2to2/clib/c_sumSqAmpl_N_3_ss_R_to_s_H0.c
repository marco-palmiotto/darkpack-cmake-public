...
ccomplex_return_t c_sumSqAmpl_N_3_ss_R_to_s_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = m_s*IT_0018;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0003 + -m_s*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0028);
    const ccomplex_t IT_0128 = (-0.5)*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0130 = (-0.5)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_ss_L*
    ...
    const ccomplex_t IT_0153 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0154 = IT_0025*IT_0153;
    const ccomplex_t IT_0155 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0156 = IT_0037*IT_0155;
    const ccomplex_t IT_0157 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0158 = IT_0040*IT_0157;
    const ccomplex_t IT_0159 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0164 = cpow((-2)*s_23 + IT_0013 + IT_0015 + -m_N_3*
    ...
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0013 + IT_0015 + -m_N_2*
    ...
    const ccomplex_t IT_0219 = (-2)*IT_0019 + IT_0075 + IT_0126 + IT_0134 +
    ...
    const ccomplex_t IT_0228 = IT_0128*IT_0227;
    const ccomplex_t IT_0229 = IT_0132*IT_0228;
    ...
    const ccomplex_t IT_0235 = m_N_3*IT_0050;
    const ccomplex_t IT_0236 = m_N_4*IT_0072;
    const ccomplex_t IT_0237 = IT_0235 + IT_0236;
    const ccomplex_t IT_0238 = IT_0234*IT_0237;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0244 = m_s*IT_0243;
    const ccomplex_t IT_0245 = m_N_3*IT_0101;
    const ccomplex_t IT_0246 = m_N_1*IT_0123;
    const ccomplex_t IT_0247 = IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0253 = IT_0138*IT_0240;
    const ccomplex_t IT_0254 = IT_0140*IT_0253;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*IT_0254;
    const ccomplex_t IT_0256 = IT_0164*IT_0240;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0163*IT_0257;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0264 = m_N_2*IT_0215;
    const ccomplex_t IT_0265 = IT_0263 + IT_0264;
    const ccomplex_t IT_0266 = IT_0262*IT_0265;
    const ccomplex_t IT_0267 = -IT_0230 + -IT_0238 + 2*IT_0244 + -IT_0252 + 
      -IT_0255 + -IT_0258 + -IT_0266;
    const ccomplex_t IT_0268 = 6*s_13;
    const ccomplex_t IT_0269 = m_s*m_N_3;
    const ccomplex_t IT_0270 = 6*IT_0219;
    const ccomplex_t IT_0271 = IT_0151*IT_0257;
    const ccomplex_t IT_0272 = IT_0101*IT_0251;
    const ccomplex_t IT_0273 = IT_0050*IT_0234;
    const ccomplex_t IT_0274 = IT_0193*IT_0262;
    const ccomplex_t IT_0275 = -IT_0018 + IT_0271 + IT_0272 + IT_0273 + IT_0274;
    const ccomplex_t IT_0276 = m_s*s_14;
    const ccomplex_t IT_0277 = IT_0024*IT_0072;
    const ccomplex_t IT_0278 = IT_0172*IT_0215;
    const ccomplex_t IT_0279 = IT_0161*IT_0166;
    const ccomplex_t IT_0280 = IT_0080*IT_0123;
    const ccomplex_t IT_0281 = IT_0243 + -IT_0277 + -IT_0278 + -IT_0279 + 
      -IT_0280;
    ...
    const ccomplex_t IT_0286 = m_s*m_N_3*IT_0285;
