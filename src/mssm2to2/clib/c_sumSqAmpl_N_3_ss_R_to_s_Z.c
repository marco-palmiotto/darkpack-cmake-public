...
ccomplex_return_t c_sumSqAmpl_N_3_ss_R_to_s_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = -IT_0021 + (-0.5)*IT_0035;
    const ccomplex_t IT_0037 = 0.5*IT_0028;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0068*IT_0070;
    ...
    const ccomplex_t IT_0117 = IT_0029*IT_0074;
    const ccomplex_t IT_0118 = IT_0102 + IT_0116 + 0.5*IT_0117;
    ...
    const ccomplex_t IT_0141 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0140 
      + -reg_prop, -1);
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*m_s;
    ...
    const ccomplex_t IT_0155 = m_N_3*IT_0029;
    const ccomplex_t IT_0156 = m_N_3*IT_0037;
    const ccomplex_t IT_0157 = -IT_0156;
    const ccomplex_t IT_0158 = IT_0155 + IT_0157;
    const ccomplex_t IT_0159 = IT_0074*IT_0158;
    const ccomplex_t IT_0160 = m_N_4*IT_0013;
    const ccomplex_t IT_0161 = m_N_3*IT_0083;
    const ccomplex_t IT_0162 = -IT_0161;
    const ccomplex_t IT_0163 = IT_0160 + IT_0162;
    const ccomplex_t IT_0164 = IT_0087*IT_0163;
    const ccomplex_t IT_0165 = -IT_0148 + IT_0154 + (-0.5)*IT_0159 + -IT_0164;
    const ccomplex_t IT_0166 = m_N_2*IT_0060;
    ...
    const ccomplex_t IT_0171 = m_N_1*IT_0046;
    ...
    const ccomplex_t IT_0176 = (-0.5)*IT_0159 + IT_0170 + IT_0175;
    ...
    const ccomplex_t IT_0185 = IT_0034*IT_0158;
    const ccomplex_t IT_0186 = m_N_3*IT_0013;
    const ccomplex_t IT_0187 = -IT_0186;
    const ccomplex_t IT_0188 = m_N_4*IT_0083;
    ...
    const ccomplex_t IT_0197 = m_N_2*IT_0111;
    const ccomplex_t IT_0198 = m_N_3*IT_0060;
    ...
    const ccomplex_t IT_0205 = m_s*m_N_3;
    const ccomplex_t IT_0206 = IT_0126*IT_0205;
    const ccomplex_t IT_0207 = (-3)*IT_0206;
    const ccomplex_t IT_0208 = 6*IT_0036;
    const ccomplex_t IT_0209 = (-0.166666666666667)*IT_0208;
    const ccomplex_t IT_0210 = IT_0067 + IT_0209;
    const ccomplex_t IT_0211 = 6*conj(IT_0036);
    const ccomplex_t IT_0212 = (-0.166666666666667)*IT_0211;
    const ccomplex_t IT_0213 = conj(IT_0067) + IT_0212;
    const ccomplex_t IT_0214 = pow(s_14, 2);
    const ccomplex_t IT_0215 = IT_0119*IT_0214;
    const ccomplex_t IT_0216 = -IT_0140;
    const ccomplex_t IT_0217 = IT_0215 + IT_0216;
    const ccomplex_t IT_0218 = IT_0205*IT_0217;
    const ccomplex_t IT_0219 = (-0.666666666666667)*IT_0149;
    const ccomplex_t IT_0220 = cpow((-2)*s_13 + IT_0016 + IT_0140 + -m_ss_R*
    ...
    const ccomplex_t IT_0224 = -IT_0075 + (-2)*IT_0088 + -IT_0223;
    const ccomplex_t IT_0225 = IT_0031*IT_0220;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = IT_0219*IT_0226;
    const ccomplex_t IT_0228 = 2*IT_0021 + IT_0035 + IT_0227;
    const ccomplex_t IT_0229 = 6*IT_0228;
    const ccomplex_t IT_0230 = IT_0038 + 2*IT_0052 + 2*IT_0066;
    const ccomplex_t IT_0231 = (-6)*IT_0230;
    const ccomplex_t IT_0232 = IT_0229 + IT_0231;
    const ccomplex_t IT_0233 = 6*conj(IT_0228);
    const ccomplex_t IT_0234 = (-6)*conj(IT_0230);
    const ccomplex_t IT_0235 = IT_0233 + IT_0234;
    const ccomplex_t IT_0236 = (-2)*IT_0102 + (-2)*IT_0116 + -IT_0117;
    const ccomplex_t IT_0237 = 6*IT_0230;
    const ccomplex_t IT_0238 = (-6)*IT_0228;
    const ccomplex_t IT_0239 = IT_0237 + IT_0238;
    const ccomplex_t IT_0240 = 6*conj(IT_0230);
    const ccomplex_t IT_0241 = (-6)*conj(IT_0228);
    const ccomplex_t IT_0242 = IT_0240 + IT_0241;
    const ccomplex_t IT_0243 = m_s*IT_0217;
    const ccomplex_t IT_0244 = 6*IT_0224;
    const ccomplex_t IT_0245 = (-6)*IT_0236;
    const ccomplex_t IT_0246 = IT_0244 + IT_0245;
    const ccomplex_t IT_0247 = 6*conj(IT_0224);
    const ccomplex_t IT_0248 = (-6)*conj(IT_0236);
    const ccomplex_t IT_0249 = IT_0247 + IT_0248;
    const ccomplex_t IT_0250 = s_14*s_34*IT_0119;
    const ccomplex_t IT_0251 = -IT_0250;
    const ccomplex_t IT_0252 = s_13 + IT_0251;
    const ccomplex_t IT_0253 = s_13*IT_0252;
    const ccomplex_t IT_0254 = (-2)*IT_0153 + -IT_0227;
    const ccomplex_t IT_0255 = 2*IT_0183 + IT_0223;
    ...
    const ccomplex_t IT_0260 = (-6)*conj(IT_0224);
    const ccomplex_t IT_0261 = IT_0259 + IT_0260;
    const ccomplex_t IT_0262 = s_13*s_14;
    const ccomplex_t IT_0263 = s_34*IT_0140;
    const ccomplex_t IT_0264 = -IT_0263;
    const ccomplex_t IT_0265 = IT_0262 + IT_0264;
    const ccomplex_t IT_0266 = -IT_0153;
    const ccomplex_t IT_0267 = conj(IT_0067) + conj(IT_0266);
    const ccomplex_t IT_0268 = IT_0067 + IT_0266;
    const ccomplex_t IT_0269 = conj(IT_0118) + conj(IT_0183);
    const ccomplex_t IT_0270 = IT_0118 + IT_0183;
    const ccomplex_t IT_0271 = s_34*IT_0126;
    const ccomplex_t IT_0272 = IT_0119*IT_0271;
    const ccomplex_t IT_0273 = (-0.25)*IT_0272;
    ...
    const ccomplex_t IT_0280 = 6*conj(IT_0165);
    const ccomplex_t IT_0281 = 6*conj(IT_0176);
    const ccomplex_t IT_0282 = IT_0280 + IT_0281;
    const ccomplex_t IT_0283 = 6*IT_0191;
    const ccomplex_t IT_0284 = 6*IT_0202;
    const ccomplex_t IT_0285 = IT_0283 + IT_0284;
    const ccomplex_t IT_0286 = 6*conj(IT_0191);
    const ccomplex_t IT_0287 = 6*conj(IT_0202);
    const ccomplex_t IT_0288 = IT_0286 + IT_0287;
    const ccomplex_t IT_0289 = (-6)*IT_0165;
    const ccomplex_t IT_0290 = (-6)*IT_0176;
    const ccomplex_t IT_0291 = IT_0289 + IT_0290;
    const ccomplex_t IT_0292 = (-6)*conj(IT_0165);
    const ccomplex_t IT_0293 = (-6)*conj(IT_0176);
    const ccomplex_t IT_0294 = IT_0292 + IT_0293;
    const ccomplex_t IT_0295 = (-6)*IT_0191;
    const ccomplex_t IT_0296 = (-6)*IT_0202;
    const ccomplex_t IT_0297 = IT_0295 + IT_0296;
    const ccomplex_t IT_0298 = (-6)*conj(IT_0191);
    const ccomplex_t IT_0299 = (-6)*conj(IT_0202);
    const ccomplex_t IT_0300 = IT_0298 + IT_0299;
    const ccomplex_t IT_0301 = s_14*IT_0126;
    const ccomplex_t IT_0302 = IT_0119*IT_0301;
    ...
    const ccomplex_t IT_0307 = 3*IT_0206;
    const ccomplex_t IT_0308 = 6*IT_0266;
    const ccomplex_t IT_0309 = 6*conj(IT_0266);
    const ccomplex_t IT_0310 = (-18)*conj(IT_0165);
    const ccomplex_t IT_0311 = s_13*IT_0217;
    const ccomplex_t IT_0312 = IT_0205*IT_0252;
    const ccomplex_t IT_0313 = 6*IT_0254;
    const ccomplex_t IT_0314 = 6*conj(IT_0254);
    const ccomplex_t IT_0315 = (-6)*IT_0254;
    const ccomplex_t IT_0316 = (-6)*conj(IT_0254);
    const ccomplex_t IT_0317 = pow(s_34, 2);
    const ccomplex_t IT_0318 = IT_0119*IT_0317;
    const ccomplex_t IT_0319 = -IT_0318;
    const ccomplex_t IT_0320 = IT_0016 + IT_0319;
    const ccomplex_t IT_0321 = IT_0205*IT_0320;
    const ccomplex_t IT_0322 = s_13*IT_0320;
    const ccomplex_t IT_0323 = (-6)*IT_0255;
    const ccomplex_t IT_0324 = m_s*IT_0252;
    const ccomplex_t IT_0325 = (-6)*conj(IT_0255);
    const ccomplex_t IT_0326 = s_14*IT_0016;
    const ccomplex_t IT_0327 = s_13*s_34;
    const ccomplex_t IT_0328 = -IT_0327;
    const ccomplex_t IT_0329 = IT_0326 + IT_0328;
    const ccomplex_t IT_0330 = conj(IT_0089)*IT_0255 + IT_0089*conj(IT_0255) +
       0.166666666666667*conj(IT_0036)*IT_0313 + 0.166666666666667*IT_0036
      *IT_0314 + 0.166666666666667*IT_0267*IT_0315 + 0.166666666666667*IT_0268
      *IT_0316 + 0.166666666666667*IT_0269*IT_0323 + 0.166666666666667*IT_0270
      *IT_0325;
    const ccomplex_t IT_0331 = m_N_3*IT_0252;
    const ccomplex_t IT_0332 = m_N_3*IT_0320;
    const ccomplex_t IT_0333 = IT_0123 + IT_0131;
    const ccomplex_t IT_0334 = IT_0125 + IT_0130;
    const ccomplex_t IT_0335 = (-0.166666666666667)*IT_0207;
    const ccomplex_t IT_0336 = (-0.25)*IT_0302;
    ...
    const ccomplex_t IT_0341 = 0.5*IT_0272;
    ...
    const ccomplex_t IT_0346 = (conj(IT_0036)*IT_0067 + IT_0036*conj(IT_0067) 
      ...
      *IT_0207*((conj(IT_0036) + -conj(IT_0067))*IT_0118 + (IT_0036 + -IT_0067)
      *conj(IT_0118) + conj(IT_0089)*IT_0210 + IT_0089*IT_0213) + IT_0218*(conj
      (IT_0224)*IT_0232 + IT_0224*IT_0235 + conj(IT_0236)*IT_0239 + IT_0236
      *IT_0242) + IT_0243*(IT_0178*IT_0232 + IT_0177*IT_0235 + IT_0204*IT_0246 +
       IT_0203*IT_0249) + IT_0253*(IT_0242*IT_0254 + IT_0239*conj(IT_0254) +
       conj(IT_0255)*IT_0258 + IT_0255*IT_0261) + IT_0265*(conj(IT_0036)*IT_0232
       + IT_0036*IT_0235 + conj(IT_0089)*IT_0246 + IT_0089*IT_0249 + IT_0239
      *IT_0267 + IT_0242*IT_0268 + IT_0258*IT_0269 + IT_0261*IT_0270) + IT_0276*
      (conj(IT_0089)*IT_0279 + IT_0089*IT_0282 + conj(IT_0036)*IT_0285 + IT_0036
      *IT_0288 + conj(IT_0118)*IT_0291 + IT_0118*IT_0294 + conj(IT_0067)*IT_0297
       + IT_0067*IT_0300) + (conj(IT_0036)*IT_0279 + IT_0036*IT_0282 + conj
      (IT_0089)*IT_0285 + IT_0089*IT_0288 + conj(IT_0067)*IT_0291 + IT_0067
      *IT_0294 + conj(IT_0118)*IT_0297 + IT_0118*IT_0300)*IT_0306 + IT_0307*
      (conj(IT_0089)*IT_0308 + IT_0089*IT_0309) + IT_0205*(IT_0177*((-18)*conj
      (IT_0191) + (-18)*conj(IT_0202)) + IT_0203*((-18)*conj(IT_0176) + IT_0310)
      ) + (conj(IT_0228)*IT_0229 + conj(IT_0230)*IT_0239 + IT_0230*IT_0241 +
       conj(IT_0224)*IT_0244 + conj(IT_0236)*IT_0258 + IT_0236*IT_0260)*IT_0311 
      + IT_0312*(IT_0242*IT_0255 + IT_0239*conj(IT_0255) + conj(IT_0236)*IT_0313
       + IT_0236*IT_0314 + conj(IT_0224)*IT_0315 + IT_0224*IT_0316) + (conj
      (IT_0255)*IT_0315 + IT_0255*IT_0316)*IT_0321 + IT_0322*(conj(IT_0254)
      *IT_0315 + conj(IT_0255)*IT_0323) + IT_0324*(IT_0178*IT_0315 + IT_0177
      *IT_0316 + IT_0204*IT_0323 + IT_0203*IT_0325) + 6*IT_0329*IT_0330 + 
      (IT_0204*IT_0239 + IT_0203*IT_0242 + conj(IT_0176)*IT_0258 + IT_0176
      *IT_0261 + conj(IT_0236)*IT_0277 + IT_0236*IT_0280 + conj(IT_0224)*IT_0289
       + IT_0224*IT_0292)*IT_0331 + (conj(IT_0255)*IT_0289 + IT_0255*IT_0292 +
       IT_0204*IT_0315 + IT_0203*IT_0316 + conj(IT_0176)*IT_0323 + IT_0176
      *IT_0325)*IT_0332 + (-6)*conj(IT_0183)*(IT_0210*IT_0307 + -1./6*IT_0118
      *IT_0333 + -1./6*IT_0089*IT_0334 + IT_0308*IT_0335 + IT_0285*IT_0340 +
       IT_0279*IT_0345) + IT_0183*(IT_0133*conj(IT_0183) + (-6)*IT_0213*IT_0307 
      + conj(IT_0118)*IT_0333 + conj(IT_0089)*IT_0334 + (-6)*IT_0309*IT_0335 + (
      -6)*IT_0288*IT_0340 + (-6)*IT_0282*IT_0345) + (-6)*conj(IT_0266)*((
      -0.166666666666667)*IT_0133*IT_0266 + IT_0118*IT_0307 + (
      -0.166666666666667)*IT_0067*IT_0333 + (-0.166666666666667)*IT_0036*IT_0334
       + IT_0279*IT_0340 + IT_0285*IT_0345) + (-6)*IT_0266*(conj(IT_0118)
      *IT_0307 + (-0.166666666666667)*conj(IT_0067)*IT_0333 + (
      -0.166666666666667)*conj(IT_0036)*IT_0334 + IT_0282*IT_0340 + IT_0288
      *IT_0345);
