        ...
        )
{
    ...
    const ccomplex_t IT_0014 = N_u3*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0019 = N_d3*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_23 + IT_0007 + IT_0024 + -m_N_3*
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0007 + IT_0024 + -m_N_2*
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0007 + IT_0024 + -m_N_1*
    ...
    const ccomplex_t IT_0080 = conj(N_d3)*N_d4*e_em;
    const ccomplex_t IT_0081 = IT_0013*IT_0080;
    const ccomplex_t IT_0082 = IT_0017*IT_0080;
    const ccomplex_t IT_0083 = conj(N_u3)*N_u4*e_em;
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0016*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0016*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0118 = N_u2*conj(N_u3)*e_em;
    const ccomplex_t IT_0119 = IT_0013*IT_0118;
    const ccomplex_t IT_0120 = IT_0017*IT_0118;
    const ccomplex_t IT_0121 = N_d2*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0016*IT_0088*IT_0090;
    ...
    const ccomplex_t IT_0131 = (-2)*IT_0095 + -IT_0100 + IT_0103 + -IT_0104 +
       2*IT_0117 + 2*IT_0130;
    const ccomplex_t IT_0132 = m_s*m_N_3;
    ...
    const ccomplex_t IT_0139 = m_s*IT_0078;
    ...
    const ccomplex_t IT_0148 = 0.333333333333333*IT_0003;
    ...
    const ccomplex_t IT_0152 = m_s*IT_0151;
    const ccomplex_t IT_0153 = m_N_3*IT_0023;
    ...
    const ccomplex_t IT_0161 = m_N_3*IT_0125;
    const ccomplex_t IT_0162 = IT_0129*IT_0161;
    const ccomplex_t IT_0163 = m_N_4*IT_0050;
    const ccomplex_t IT_0164 = m_N_3*IT_0087;
    const ccomplex_t IT_0165 = -IT_0164;
    const ccomplex_t IT_0166 = IT_0163 + IT_0165;
    const ccomplex_t IT_0167 = IT_0094*IT_0166;
    ...
    const ccomplex_t IT_0170 = m_N_1*IT_0064;
    const ccomplex_t IT_0171 = IT_0116*IT_0170;
    const ccomplex_t IT_0172 = m_N_2*IT_0036;
    const ccomplex_t IT_0173 = IT_0129*IT_0172;
    ...
    const ccomplex_t IT_0178 = IT_0097*IT_0143;
    const ccomplex_t IT_0179 = IT_0145*IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*IT_0179;
    const ccomplex_t IT_0181 = m_s*IT_0180;
    const ccomplex_t IT_0182 = IT_0027*IT_0155;
    const ccomplex_t IT_0183 = IT_0027*IT_0157;
    const ccomplex_t IT_0184 = m_N_3*IT_0064;
    const ccomplex_t IT_0185 = IT_0069*IT_0184;
    const ccomplex_t IT_0186 = m_N_3*IT_0036;
    const ccomplex_t IT_0187 = IT_0041*IT_0186;
    const ccomplex_t IT_0188 = m_N_4*IT_0087;
    const ccomplex_t IT_0189 = m_N_3*IT_0050;
    const ccomplex_t IT_0190 = -IT_0189;
    const ccomplex_t IT_0191 = IT_0188 + IT_0190;
    const ccomplex_t IT_0192 = IT_0055*IT_0191;
    const ccomplex_t IT_0193 = IT_0177 + -IT_0181 + 0.5*IT_0182 + (-0.5)
      *IT_0183 + IT_0185 + IT_0187 + IT_0192;
    const ccomplex_t IT_0194 = IT_0027*IT_0153;
    const ccomplex_t IT_0195 = m_N_1*IT_0112;
    const ccomplex_t IT_0196 = IT_0069*IT_0195;
    const ccomplex_t IT_0197 = m_N_2*IT_0125;
    const ccomplex_t IT_0198 = IT_0041*IT_0197;
    ...
    const ccomplex_t IT_0207 = IT_0100 + 2*IT_0180;
    ...
    const ccomplex_t IT_0222 = m_s*IT_0221;
    ...
    const ccomplex_t IT_0243 = m_s*IT_0205;
    ...
    const ccomplex_t IT_0260 = 6*IT_0134;
    const ccomplex_t IT_0261 = 6*IT_0224;
    const ccomplex_t IT_0262 = 6*IT_0180;
    const ccomplex_t IT_0263 = 6*IT_0131*IT_0139 + IT_0132*((-18)*IT_0168 + (
      -18)*IT_0174) + 6*IT_0209*IT_0234 + IT_0200*IT_0242 + IT_0244*IT_0254 +
       IT_0210*IT_0258 + IT_0243*IT_0259 + IT_0230*IT_0260 + IT_0223*IT_0261 +
       IT_0219*IT_0262;
    const ccomplex_t IT_0264 = (-6)*IT_0131;
    const ccomplex_t IT_0265 = 6*IT_0073*IT_0139 + IT_0132*((-18)*IT_0193 + (
      -18)*IT_0199) + 6*IT_0209*IT_0219 + IT_0175*IT_0242 + IT_0243*IT_0244 +
       IT_0254*IT_0259 + IT_0223*IT_0260 + IT_0230*IT_0261 + IT_0234*IT_0262 +
       IT_0210*IT_0264;
    const ccomplex_t IT_0266 = IT_0132*IT_0213;
    const ccomplex_t IT_0267 = 3*IT_0266;
    const ccomplex_t IT_0268 = (-3)*IT_0266;
    const ccomplex_t IT_0269 = pow(m_Z, 4);
    const ccomplex_t IT_0270 = s_13*IT_0269;
    const ccomplex_t IT_0271 = IT_0074*IT_0270;
    const ccomplex_t IT_0272 = (-24)*IT_0236;
    const ccomplex_t IT_0273 = 6*IT_0271 + IT_0272;
    const ccomplex_t IT_0274 = 24*IT_0236;
    const ccomplex_t IT_0275 = (-12)*IT_0235;
    const ccomplex_t IT_0276 = 6*IT_0271 + IT_0274 + IT_0275;
    ...
    const ccomplex_t IT_0281 = 0.166666666666667*IT_0180;
    const ccomplex_t IT_0282 = 0.166666666666667*IT_0206;
    const ccomplex_t IT_0283 = s_13*IT_0248;
    const ccomplex_t IT_0284 = 0.166666666666667*IT_0283;
    const ccomplex_t IT_0285 = 0.166666666666667*IT_0138;
    const ccomplex_t IT_0286 = 0.166666666666667*IT_0253;
    const ccomplex_t IT_0287 = 6*conj(IT_0073)*(IT_0073*IT_0079 + IT_0131
      ...
      *IT_0211 + (IT_0138*IT_0180 + IT_0206*IT_0207 + IT_0174*IT_0210)*IT_0212 +
       6*conj(IT_0168)*(IT_0073*IT_0139 + IT_0209*IT_0219 + IT_0134*IT_0223 +
       IT_0224*IT_0230 + IT_0180*IT_0234 + 0.166666666666667*IT_0175*IT_0242 +
      ...
      *IT_0243 + IT_0180*IT_0253 + IT_0174*IT_0254)*IT_0256 + (IT_0131*IT_0210 +
       IT_0207*IT_0254)*IT_0257 + (conj(IT_0193) + conj(IT_0199))*IT_0263 + conj
      (IT_0174)*IT_0265 + 6*conj(IT_0134)*(IT_0073*IT_0138 + IT_0175*IT_0223 +
       IT_0200*IT_0230 + IT_0202*IT_0253 + IT_0180*IT_0267 + IT_0224*IT_0268 +
       0.166666666666667*IT_0209*IT_0273 + IT_0276*IT_0277) + 6*conj(IT_0131)*
      (IT_0079*IT_0131 + IT_0073*IT_0133 + IT_0139*IT_0200 + IT_0138*IT_0224 +
       0.166666666666667*IT_0210*IT_0278 + IT_0244*IT_0279) + 6*conj(IT_0224)*
      (IT_0131*IT_0138 + IT_0200*IT_0223 + IT_0175*IT_0230 + IT_0207*IT_0253 +
       IT_0209*IT_0267 + IT_0134*IT_0268 + IT_0276*IT_0280 + IT_0273*IT_0281) +
       6*conj(IT_0202)*(IT_0134*IT_0253 + IT_0258*IT_0282 + IT_0244*IT_0284) + 6
      *conj(IT_0207)*(0.166666666666667*IT_0244*IT_0249 + IT_0224*IT_0253 +
       0.166666666666667*IT_0254*IT_0278 + IT_0258*IT_0279 + IT_0264*IT_0282 +
       IT_0259*IT_0284) + 6*conj(IT_0209)*(IT_0175*IT_0219 + IT_0200*IT_0234 +
       IT_0224*IT_0267 + IT_0180*IT_0268 + 0.166666666666667*IT_0209*IT_0276 +
       IT_0273*IT_0277 + IT_0258*IT_0285 + IT_0244*IT_0286) + 6*conj(IT_0180)*
      (IT_0200*IT_0219 + IT_0175*IT_0234 + IT_0134*IT_0267 + IT_0209*IT_0268 +
       IT_0273*IT_0280 + IT_0276*IT_0281 + IT_0264*IT_0285 + IT_0259*IT_0286);
