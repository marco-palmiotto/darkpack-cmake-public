        ...
        )
{
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_s*e_em*IT_0013*IT_0018
      *IT_0044*IT_0045;
    ...
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0238 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0018*IT_0044*IT_0045;
