...
ccomplex_return_t c_sumSqAmpl_N_3_ss_R_to_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0004 + IT_0092 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0094 = pow(m_W, -1);
    const ccomplex_t IT_0095 = cos(beta);
    const ccomplex_t IT_0096 = cpow(IT_0095, -1);
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0013 + m_s*e_em*mu_h*IT_0009*IT_0018*IT_0094*IT_0096);
    const ccomplex_t IT_0098 = 0.5*IT_0097;
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_13 + IT_0004 + IT_0092 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0105 = cpow(IT_0000, -2);
    const ccomplex_t IT_0106 = sin(beta);
    const ccomplex_t IT_0107 = (0 + _Complex_I*-3)*e_em*(IT_0004*IT_0013
      *IT_0018*IT_0094*IT_0096 + -1./3*m_W*IT_0017*IT_0105*(IT_0013*IT_0095 +
       IT_0009*IT_0106));
    ...
    const ccomplex_t IT_0214 = cpow((-2)*s_12 + IT_0004 + -IT_0005 + -IT_0092 
      + -reg_prop, -1);
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*m_s*e_em*IT_0013*IT_0018
      *IT_0094*IT_0096;
    ...
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0018*IT_0094*IT_0096;
    const ccomplex_t IT_0234 = 0.5*IT_0233;
    const ccomplex_t IT_0235 = IT_0043*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*IT_0235;
    const ccomplex_t IT_0237 = m_N_3*IT_0088;
    const ccomplex_t IT_0238 = m_N_1*IT_0066;
    ...
    const ccomplex_t IT_0244 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0018*IT_0094*IT_0096;
    ...
    const ccomplex_t IT_0249 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0018*IT_0094*IT_0096;
    ...
    const ccomplex_t IT_0254 = m_s*IT_0253;
    ...
    const ccomplex_t IT_0271 = m_s*m_N_3;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0088*IT_0236;
    ...
    const ccomplex_t IT_0280 = IT_0045*IT_0066;
    ...
    const ccomplex_t IT_0288 = m_s*m_N_3*IT_0287;
