        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0013 = IT_0011*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = IT_0005*IT_0007;
    const ccomplex_t IT_0016 = m_t*N_u3*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0002*IT_0007*IT_0095*U_st_00;
    ...
    const ccomplex_t IT_0126 = m_t*conj(N_u3)*e_em*IT_0002*U_st_10;
    ...
    const ccomplex_t IT_0146 = m_t*conj(U_sb_00)*(m_t*IT_0003*IT_0005*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0004*IT_0095*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0005*IT_0095*U_st_10));
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0004*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0007*((-0.5)*IT_0002
      *IT_0146 + m_W*IT_0003*IT_0004*conj(U_sb_00)*U_st_00) + A_t*IT_0003*conj
      (U_sb_00)*U_st_10);
    ...
    const ccomplex_t IT_0172 = m_t*conj(U_sb_01)*(m_t*IT_0003*IT_0005*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0004*IT_0095*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0005*IT_0095*U_st_10));
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0004*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0007*((-0.5)*IT_0002
      *IT_0172 + m_W*IT_0003*IT_0004*conj(U_sb_01)*U_st_00) + A_t*IT_0003*conj
      (U_sb_01)*U_st_10);
