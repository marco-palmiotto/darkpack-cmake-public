...
ccomplex_return_t c_sumSqAmpl_N_3_st_1_to_b_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = V_tb*e_em*conj(V_Wp2)*U_st_00;
    const ccomplex_t IT_0022 = IT_0003*IT_0021;
    const ccomplex_t IT_0023 = cpow(IT_0001, -1);
    const ccomplex_t IT_0024 = IT_0003*IT_0023;
    const ccomplex_t IT_0025 = pow(m_W, -1);
    const ccomplex_t IT_0026 = m_t*V_tb*conj(V_u2)*e_em*IT_0025*U_st_10;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0031*IT_0032*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0038 = cos(beta);
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0003*IT_0023*IT_0025*IT_0038;
    ...
    const ccomplex_t IT_0044 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0045 = IT_0003*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = m_t*conj(N_u3)*e_em*IT_0025*U_st_10;
    ...
    const ccomplex_t IT_0053 = pow(m_N_3, 2);
    const ccomplex_t IT_0054 = cpow((-2)*s_12 + -IT_0034 + -IT_0053 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0055 = IT_0037*IT_0052*IT_0054;
    const ccomplex_t IT_0056 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0057 = IT_0009*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = m_t*N_u3*e_em*IT_0025*U_st_00;
    ...
    const ccomplex_t IT_0071 = conj(N_B3)*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0075 = conj(N_d3)*e_em*conj(U_Wm1);
    ...
    const ccomplex_t IT_0081 = V_tb*e_em*conj(V_Wp1)*U_st_00;
    const ccomplex_t IT_0082 = IT_0003*IT_0081;
    const ccomplex_t IT_0083 = m_t*V_tb*conj(V_u1)*e_em*IT_0025*U_st_10;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0090 = cpow((-2)*s_23 + IT_0033 + IT_0034 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0091 = IT_0088*IT_0089*IT_0090;
    const ccomplex_t IT_0092 = cpow((-2)*s_13 + IT_0033 + IT_0053 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0093 = cpow(IT_0038, -1);
    const ccomplex_t IT_0094 = m_t*conj(U_sb_00)*(m_t*IT_0023*IT_0038*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0001*IT_0093*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0023*IT_0093*U_st_10));
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0025
      *IT_0094 + m_W*IT_0001*IT_0038*conj(U_sb_00)*U_st_00) + A_t*IT_0038*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0096 = IT_0003*IT_0093;
    const ccomplex_t IT_0097 = m_b*conj(N_d3)*e_em*IT_0025*U_sb_10;
    const ccomplex_t IT_0098 = IT_0096*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0101 = IT_0003*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0130 = cpow((-2)*s_13 + IT_0033 + IT_0053 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0131 = m_t*conj(U_sb_01)*(m_t*IT_0023*IT_0038*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0001*IT_0093*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0023*IT_0093*U_st_10));
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0025
      *IT_0131 + m_W*IT_0001*IT_0038*conj(U_sb_01)*U_st_00) + A_t*IT_0038*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0133 = m_b*conj(N_d3)*e_em*IT_0025*U_sb_11;
    const ccomplex_t IT_0134 = IT_0096*IT_0133;
    const ccomplex_t IT_0135 = 1.4142135623731*IT_0134;
    const ccomplex_t IT_0136 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0137 = IT_0009*IT_0136;
    const ccomplex_t IT_0138 = 1.4142135623731*IT_0137;
    const ccomplex_t IT_0139 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0140 = IT_0003*IT_0139;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*(IT_0135 + 0.333333333333333
      *IT_0138 + -IT_0141);
    ...
    const ccomplex_t IT_0146 = IT_0130*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*IT_0146;
    const ccomplex_t IT_0148 = IT_0036 + IT_0055 + -IT_0067 + IT_0091 + 
      -IT_0129 + -IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0003*IT_0025*IT_0093*U_st_00;
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
      *e_em*IT_0003*IT_0025*IT_0093*U_st_00;
    ...
    const ccomplex_t IT_0178 = IT_0089*IT_0090*IT_0177;
    const ccomplex_t IT_0179 = N_u3*e_em*V_Wp2;
    const ccomplex_t IT_0180 = IT_0162*IT_0179;
    ...
    const ccomplex_t IT_0192 = IT_0150*IT_0191;
    const ccomplex_t IT_0193 = IT_0032*IT_0035*IT_0192;
    ...
    const ccomplex_t IT_0197 = m_b*N_d3*e_em*IT_0025*U_sb_00;
    const ccomplex_t IT_0198 = IT_0096*IT_0197;
    const ccomplex_t IT_0199 = 1.4142135623731*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*(IT_0196 + 1.5*IT_0199);
    ...
    const ccomplex_t IT_0205 = IT_0092*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*IT_0205;
    const ccomplex_t IT_0207 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0208 = IT_0009*IT_0207;
    const ccomplex_t IT_0209 = 1.4142135623731*IT_0208;
    const ccomplex_t IT_0210 = m_b*N_d3*e_em*IT_0025*U_sb_01;
    ...
    const ccomplex_t IT_0222 = IT_0130*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0001*IT_0003*IT_0025*IT_0093;
    const ccomplex_t IT_0225 = 0.5*IT_0224;
    const ccomplex_t IT_0226 = IT_0063*IT_0225;
    const ccomplex_t IT_0227 = IT_0037*IT_0054*IT_0226;
    const ccomplex_t IT_0228 = IT_0051*IT_0225;
    const ccomplex_t IT_0229 = IT_0054*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = m_N_3*IT_0230;
    const ccomplex_t IT_0232 = -IT_0178 + -IT_0193 + IT_0206 + IT_0223 + 
      -IT_0227 + IT_0231;
    const ccomplex_t IT_0233 = IT_0087*IT_0176;
    const ccomplex_t IT_0234 = IT_0090*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1)*IT_0234;
    const ccomplex_t IT_0236 = IT_0030*IT_0191;
    const ccomplex_t IT_0237 = IT_0035*IT_0236;
    ...
    const ccomplex_t IT_0243 = IT_0148 + -IT_0161;
    const ccomplex_t IT_0244 = m_b*m_N_3*IT_0034;
    const ccomplex_t IT_0245 = -IT_0066;
    const ccomplex_t IT_0246 = conj(IT_0239) + conj(IT_0245);
    const ccomplex_t IT_0247 = -IT_0153 + -IT_0158;
    const ccomplex_t IT_0248 = IT_0230 + IT_0247;
    const ccomplex_t IT_0249 = IT_0239 + IT_0245;
    const ccomplex_t IT_0250 = conj(IT_0230) + conj(IT_0247);
    const ccomplex_t IT_0251 = s_13*IT_0034;
    const ccomplex_t IT_0252 = (-6)*IT_0251;
    const ccomplex_t IT_0253 = s_12*s_23;
    const ccomplex_t IT_0254 = 12*IT_0253;
    const ccomplex_t IT_0255 = IT_0252 + IT_0254;
    const ccomplex_t IT_0256 = 6*s_13;
    const ccomplex_t IT_0257 = (-6)*s_13;
    const ccomplex_t IT_0258 = s_23*m_N_3;
    const ccomplex_t IT_0259 = (-6)*IT_0161;
    const ccomplex_t IT_0260 = 0.166666666666667*IT_0259;
    const ccomplex_t IT_0261 = IT_0148 + IT_0260;
    const ccomplex_t IT_0262 = -conj(IT_0240);
    const ccomplex_t IT_0263 = conj(IT_0232) + IT_0262;
    const ccomplex_t IT_0264 = (-6)*conj(IT_0161);
    const ccomplex_t IT_0265 = m_b*s_12;
    const ccomplex_t IT_0266 = 6*IT_0000*((conj(IT_0148) + -conj(IT_0161))
      *IT_0242 + (conj(IT_0232) + -conj(IT_0240))*IT_0243) + 6*IT_0244*(IT_0246
      *IT_0248 + IT_0249*IT_0250) + (IT_0246*IT_0249 + IT_0248*IT_0250)*IT_0255 
      + (IT_0148*conj(IT_0148) + IT_0161*conj(IT_0161) + IT_0232*conj(IT_0232) +
       IT_0240*conj(IT_0240))*IT_0256 + (conj(IT_0148)*IT_0161 + IT_0148*conj
      (IT_0161) + conj(IT_0232)*IT_0240 + IT_0232*conj(IT_0240))*IT_0257 + 6
      *IT_0258*(IT_0242*IT_0250 + IT_0246*IT_0261 + IT_0248*IT_0263 + IT_0249*
      (conj(IT_0148) + 0.166666666666667*IT_0264)) + 6*(IT_0242*IT_0246 +
       IT_0250*IT_0261 + IT_0249*IT_0263 + IT_0248*(conj(IT_0148) +
       0.166666666666667*IT_0264))*IT_0265;
