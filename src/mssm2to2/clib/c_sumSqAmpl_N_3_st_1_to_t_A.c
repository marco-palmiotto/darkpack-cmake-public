...
ccomplex_return_t c_sumSqAmpl_N_3_st_1_to_t_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (-1.33333333333333)*IT_0016;
    const ccomplex_t IT_0025 = pow(m_t, 2);
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0019 + IT_0025 + -m_st_1*
    ...
    const ccomplex_t IT_0037 = m_t*conj(N_u3)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0045 = IT_0017*IT_0041;
    const ccomplex_t IT_0046 = IT_0021*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = IT_0044 + 2*IT_0047;
    const ccomplex_t IT_0049 = (-6)*IT_0025;
    const ccomplex_t IT_0050 = (-0.666666666666667)*IT_0016;
    ...
    const ccomplex_t IT_0056 = m_t*s_14*m_N_3;
    ...
    const ccomplex_t IT_0068 = m_t*m_N_3;
    ...
    const ccomplex_t IT_0073 = m_t*s_34*m_N_3;
