...
ccomplex_return_t c_sumSqAmpl_N_3_st_1_to_t_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B3*e_em*U_st_10;
    ...
    const ccomplex_t IT_0023 = m_t*N_u3*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0034 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0035 = IT_0016*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = m_t*N_u3*e_em*IT_0002*U_st_01;
    ...
    const ccomplex_t IT_0108 = m_N_3*IT_0107;
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0029 + IT_0065 + -m_N_3*
    ...
    const ccomplex_t IT_0153 = N_W3*N_d1*e_em;
    ...
    const ccomplex_t IT_0165 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0166 = IT_0069*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0168 = IT_0072*IT_0167;
    const ccomplex_t IT_0169 = conj(N_W1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0175 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0176 = IT_0072*IT_0175;
    const ccomplex_t IT_0177 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0178 = IT_0075*IT_0177;
    const ccomplex_t IT_0179 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0216 = conj(N_B2)*conj(N_d3)*e_em;
    const ccomplex_t IT_0217 = IT_0072*IT_0216;
    const ccomplex_t IT_0218 = conj(N_W2)*conj(N_u3)*e_em;
    const ccomplex_t IT_0219 = IT_0075*IT_0218;
    const ccomplex_t IT_0220 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0228 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0279 = m_N_3*IT_0163;
    ...
    const ccomplex_t IT_0319 = m_t*m_N_3;
    ...
    const ccomplex_t IT_0345 = m_t*m_N_3*IT_0344;
