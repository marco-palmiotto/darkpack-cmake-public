...
ccomplex_return_t c_sumSqAmpl_N_3_st_1_to_t_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0055 = m_t*s_14*m_N_3;
    ...
    const ccomplex_t IT_0067 = m_t*m_N_3;
    ...
    const ccomplex_t IT_0072 = m_t*s_34*m_N_3;
