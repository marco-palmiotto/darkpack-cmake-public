        ...
        )
{
    ...
    const ccomplex_t IT_0069 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0070 = IT_0055*IT_0069;
    const ccomplex_t IT_0071 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0072 = IT_0058*IT_0071;
    const ccomplex_t IT_0073 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0074 = IT_0061*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_3*
    ...
    const ccomplex_t IT_0087 = m_t*N_u1*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0106 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0107 = IT_0061*IT_0106;
    const ccomplex_t IT_0108 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0109 = IT_0058*IT_0108;
    const ccomplex_t IT_0110 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0126 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0130 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0209 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0210 = IT_0055*IT_0209;
    const ccomplex_t IT_0211 = conj(N_W3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0218 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0231 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0232 = IT_0055*IT_0231;
    const ccomplex_t IT_0233 = N_W4*N_u3*e_em;
    ...
    const ccomplex_t IT_0240 = N_B4*N_u3*e_em;
    ...
    const ccomplex_t IT_0291 = m_N_3*IT_0115;
    ...
    const ccomplex_t IT_0321 = m_N_3*IT_0172;
    const ccomplex_t IT_0322 = m_N_2*IT_0194;
    ...
    const ccomplex_t IT_0336 = IT_0206*IT_0335;
    const ccomplex_t IT_0337 = (0 + _Complex_I*1)*IT_0336;
    const ccomplex_t IT_0338 = m_N_4*IT_0229;
    const ccomplex_t IT_0339 = m_N_3*IT_0251;
    ...
    const ccomplex_t IT_0344 = m_t*m_N_3;
    const ccomplex_t IT_0345 = 6*IT_0255;
    const ccomplex_t IT_0346 = IT_0067*IT_0289;
    const ccomplex_t IT_0347 = IT_0115*IT_0306;
    const ccomplex_t IT_0348 = IT_0172*IT_0320;
    const ccomplex_t IT_0349 = IT_0251*IT_0337;
    const ccomplex_t IT_0350 = -IT_0053 + IT_0346 + IT_0347 + IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = m_t*s_14;
    const ccomplex_t IT_0352 = IT_0151*IT_0194;
    const ccomplex_t IT_0353 = IT_0077*IT_0082;
    const ccomplex_t IT_0354 = IT_0094*IT_0137;
    const ccomplex_t IT_0355 = IT_0208*IT_0229;
    const ccomplex_t IT_0356 = IT_0286 + -IT_0352 + -IT_0353 + -IT_0354 + 
      -IT_0355;
    const ccomplex_t IT_0357 = s_34*m_N_3;
