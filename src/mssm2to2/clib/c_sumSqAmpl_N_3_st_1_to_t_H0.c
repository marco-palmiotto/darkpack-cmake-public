...
ccomplex_return_t c_sumSqAmpl_N_3_st_1_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = pow(m_N_3, 2);
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_3*
    ...
    const ccomplex_t IT_0069 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0070 = IT_0001*IT_0069;
    const ccomplex_t IT_0071 = 1.4142135623731*IT_0070;
    const ccomplex_t IT_0072 = m_t*N_u3*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0084 = N_B3*N_d1*e_em;
    const ccomplex_t IT_0085 = IT_0027*IT_0084;
    const ccomplex_t IT_0086 = N_W3*N_u1*e_em;
    const ccomplex_t IT_0087 = IT_0036*IT_0086;
    const ccomplex_t IT_0088 = N_B1*N_d3*e_em;
    const ccomplex_t IT_0089 = IT_0027*IT_0088;
    const ccomplex_t IT_0090 = N_W1*N_u3*e_em;
    ...
    const ccomplex_t IT_0106 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0107 = IT_0027*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0109 = IT_0036*IT_0108;
    const ccomplex_t IT_0110 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0111 = IT_0027*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0113 = IT_0036*IT_0112;
    const ccomplex_t IT_0114 = IT_0107 + IT_0109 + IT_0111 + IT_0113;
    const ccomplex_t IT_0115 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0116 = IT_0030*IT_0115;
    const ccomplex_t IT_0117 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0118 = IT_0033*IT_0117;
    const ccomplex_t IT_0119 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0120 = IT_0030*IT_0119;
    const ccomplex_t IT_0121 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0141 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0142 = IT_0001*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = m_t*N_u2*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0149 = cpow((-2)*s_23 + IT_0021 + IT_0052 + -m_N_2*
    ...
    const ccomplex_t IT_0323 = s_34*m_N_3;
    ...
    const ccomplex_t IT_0333 = m_t*conj(N_u3)*e_em*IT_0010*U_st_11;
