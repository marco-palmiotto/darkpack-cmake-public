...
ccomplex_return_t c_sumSqAmpl_N_3_st_1_to_t_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = N_B3*e_em*U_st_10;
    ...
    const ccomplex_t IT_0011 = m_t*N_u3*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0029 = pow(m_N_3, 2);
    ...
    const ccomplex_t IT_0097 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0098 = IT_0001*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = m_t*N_u2*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_23 + IT_0024 + IT_0105 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0107 = IT_0104*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = IT_0096*IT_0108;
    const ccomplex_t IT_0110 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0111 = IT_0048*IT_0110;
    const ccomplex_t IT_0112 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0113 = IT_0051*IT_0112;
    const ccomplex_t IT_0114 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0115 = IT_0059*IT_0114;
    const ccomplex_t IT_0116 = N_W3*N_d3*e_em;
    const ccomplex_t IT_0117 = IT_0062*IT_0116;
    ...
    const ccomplex_t IT_0122 = IT_0048*IT_0121;
    const ccomplex_t IT_0123 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0124 = IT_0051*IT_0123;
    const ccomplex_t IT_0125 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0126 = IT_0059*IT_0125;
    ...
    const ccomplex_t IT_0133 = cpow((-2)*s_23 + IT_0024 + IT_0105 + -m_N_3*
    ...
    const ccomplex_t IT_0140 = IT_0051*IT_0139;
    ...
    const ccomplex_t IT_0166 = IT_0051*IT_0165;
    ...
    const ccomplex_t IT_0194 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0195 = IT_0048*IT_0194;
    const ccomplex_t IT_0196 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0197 = IT_0051*IT_0196;
    const ccomplex_t IT_0198 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0199 = IT_0048*IT_0198;
    const ccomplex_t IT_0200 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0201 = IT_0051*IT_0200;
    const ccomplex_t IT_0202 = IT_0195 + IT_0197 + IT_0199 + IT_0201;
    const ccomplex_t IT_0203 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0204 = IT_0059*IT_0203;
    const ccomplex_t IT_0205 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0206 = IT_0062*IT_0205;
    const ccomplex_t IT_0207 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0208 = IT_0059*IT_0207;
    const ccomplex_t IT_0209 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0217 = IT_0048*IT_0216;
    const ccomplex_t IT_0218 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0219 = IT_0051*IT_0218;
    const ccomplex_t IT_0220 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0221 = IT_0048*IT_0220;
    const ccomplex_t IT_0222 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0223 = IT_0051*IT_0222;
    const ccomplex_t IT_0224 = IT_0217 + IT_0219 + IT_0221 + IT_0223;
    const ccomplex_t IT_0225 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0226 = IT_0059*IT_0225;
    const ccomplex_t IT_0227 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0228 = IT_0062*IT_0227;
    const ccomplex_t IT_0229 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0230 = IT_0059*IT_0229;
    const ccomplex_t IT_0231 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0254 = cpow((-2)*s_12 + -IT_0029 + -IT_0105 + 
    ...
    const ccomplex_t IT_0258 = IT_0032 + IT_0047 + IT_0109 + IT_0136 + IT_0193
       + IT_0250 + (-2)*IT_0257;
    const ccomplex_t IT_0259 = conj(N_B3)*e_em*U_st_01;
    const ccomplex_t IT_0260 = IT_0001*IT_0259;
    const ccomplex_t IT_0261 = 1.4142135623731*IT_0260;
    const ccomplex_t IT_0262 = conj(N_W3)*e_em*U_st_01;
    const ccomplex_t IT_0263 = IT_0008*IT_0262;
    const ccomplex_t IT_0264 = 1.4142135623731*IT_0263;
    const ccomplex_t IT_0265 = m_t*conj(N_u3)*e_em*IT_0010*U_st_11;
    ...
    const ccomplex_t IT_0287 = m_N_3*IT_0072;
    const ccomplex_t IT_0288 = m_N_2*IT_0094;
    const ccomplex_t IT_0289 = IT_0287 + IT_0288;
    const ccomplex_t IT_0290 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0291 = IT_0001*IT_0290;
    const ccomplex_t IT_0292 = 1.4142135623731*IT_0291;
    const ccomplex_t IT_0293 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0294 = IT_0008*IT_0293;
    const ccomplex_t IT_0295 = 1.4142135623731*IT_0294;
    const ccomplex_t IT_0296 = m_t*conj(N_u2)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0301 = IT_0106*IT_0300;
    const ccomplex_t IT_0302 = (0 + _Complex_I*1)*IT_0301;
    const ccomplex_t IT_0303 = IT_0289*IT_0302;
    const ccomplex_t IT_0304 = m_N_3*IT_0214;
    const ccomplex_t IT_0305 = m_N_4*IT_0236;
    const ccomplex_t IT_0306 = IT_0304 + IT_0305;
    const ccomplex_t IT_0307 = conj(N_B4)*e_em*U_st_00;
    const ccomplex_t IT_0308 = IT_0001*IT_0307;
    const ccomplex_t IT_0309 = 1.4142135623731*IT_0308;
    const ccomplex_t IT_0310 = conj(N_W4)*e_em*U_st_00;
    const ccomplex_t IT_0311 = IT_0008*IT_0310;
    const ccomplex_t IT_0312 = 1.4142135623731*IT_0311;
    const ccomplex_t IT_0313 = m_t*conj(N_u4)*e_em*IT_0010*U_st_10;
    const ccomplex_t IT_0314 = IT_0009*IT_0313;
    const ccomplex_t IT_0315 = 1.4142135623731*IT_0314;
    const ccomplex_t IT_0316 = (0 + _Complex_I*1)*(IT_0309 + 3*IT_0312 + 3
      *IT_0315);
    const ccomplex_t IT_0317 = 0.166666666666667*IT_0316;
    const ccomplex_t IT_0318 = IT_0247*IT_0317;
    const ccomplex_t IT_0319 = (0 + _Complex_I*1)*IT_0318;
    const ccomplex_t IT_0320 = IT_0306*IT_0319;
    const ccomplex_t IT_0321 = IT_0252*IT_0283;
    const ccomplex_t IT_0322 = IT_0254*IT_0321;
    const ccomplex_t IT_0323 = (0 + _Complex_I*1)*IT_0322;
    const ccomplex_t IT_0324 = m_t*IT_0323;
    const ccomplex_t IT_0325 = IT_0133*IT_0283;
    const ccomplex_t IT_0326 = (0 + _Complex_I*1)*IT_0325;
    const ccomplex_t IT_0327 = IT_0132*IT_0326;
    const ccomplex_t IT_0328 = m_N_3*IT_0157;
    const ccomplex_t IT_0329 = m_N_1*IT_0179;
    const ccomplex_t IT_0330 = IT_0328 + IT_0329;
    const ccomplex_t IT_0331 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0332 = IT_0001*IT_0331;
    const ccomplex_t IT_0333 = 1.4142135623731*IT_0332;
    const ccomplex_t IT_0334 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0335 = IT_0008*IT_0334;
    const ccomplex_t IT_0336 = 1.4142135623731*IT_0335;
    const ccomplex_t IT_0337 = m_t*conj(N_u1)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0342 = IT_0190*IT_0341;
    const ccomplex_t IT_0343 = (0 + _Complex_I*1)*IT_0342;
    const ccomplex_t IT_0344 = IT_0330*IT_0343;
    const ccomplex_t IT_0345 = -IT_0272 + -IT_0286 + -IT_0303 + -IT_0320 + 2
      *IT_0324 + -IT_0327 + -IT_0344;
    const ccomplex_t IT_0346 = 6*s_13;
    const ccomplex_t IT_0347 = m_t*m_N_3;
    const ccomplex_t IT_0348 = 6*IT_0258;
    const ccomplex_t IT_0349 = IT_0072*IT_0302;
    const ccomplex_t IT_0350 = IT_0119*IT_0326;
    const ccomplex_t IT_0351 = IT_0214*IT_0319;
    const ccomplex_t IT_0352 = IT_0157*IT_0343;
    const ccomplex_t IT_0353 = -IT_0256 + IT_0349 + IT_0350 + IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = m_t*s_14;
    const ccomplex_t IT_0355 = IT_0094*IT_0108;
    const ccomplex_t IT_0356 = IT_0236*IT_0249;
    const ccomplex_t IT_0357 = IT_0130*IT_0135;
    const ccomplex_t IT_0358 = IT_0179*IT_0192;
    const ccomplex_t IT_0359 = IT_0323 + -IT_0355 + -IT_0356 + -IT_0357 + 
      -IT_0358;
    const ccomplex_t IT_0360 = s_34*m_N_3;
    const ccomplex_t IT_0361 = 6*conj(IT_0258);
    const ccomplex_t IT_0362 = 6*conj(IT_0345);
    const ccomplex_t IT_0363 = pow(m_h, 2);
    const ccomplex_t IT_0364 = m_t*m_N_3*IT_0363;
