        ...
        )
{
    ...
    const ccomplex_t IT_0032 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0033 = IT_0001*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = m_t*N_u3*e_em*IT_0010*U_st_00;
