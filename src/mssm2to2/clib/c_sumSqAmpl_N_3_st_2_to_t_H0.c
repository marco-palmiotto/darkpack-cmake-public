...
ccomplex_return_t c_sumSqAmpl_N_3_st_2_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0069 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0070 = IT_0001*IT_0069;
    const ccomplex_t IT_0071 = 1.4142135623731*IT_0070;
    const ccomplex_t IT_0072 = m_t*N_u3*e_em*IT_0010*U_st_00;
