        ...
        )
{
    ...
    const ccomplex_t IT_0036 = pow(m_st_2, 2);
    ...
    const ccomplex_t IT_0072 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0073 = IT_0001*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = m_t*N_u2*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0129 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0130 = IT_0001*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = m_t*N_u3*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0137 = 2*conj(U_st_00)*(((-0.5)*m_W*IT_0022*(IT_0008 +
    ...
    const ccomplex_t IT_0141 = cpow((-2)*s_13 + IT_0024 + IT_0029 + -m_st_1*
    ...
    const ccomplex_t IT_0189 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0190 = IT_0001*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = m_t*N_u1*e_em*IT_0010*U_st_01;
