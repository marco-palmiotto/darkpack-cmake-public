...
ccomplex_return_t c_sumSqAmpl_N_3_stau_1_to_nu_tau_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*(A_tau*IT_0057*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0002*(m_W*IT_0000*IT_0057*U_stau_00 + (-0.5)
      *m_tau*IT_0024*(m_tau*IT_0022*IT_0057*U_stau_00 + mu_h*U_stau_10)));
    ...
    const ccomplex_t IT_0074 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0075 = IT_0008*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*IT_0075;
    const ccomplex_t IT_0077 = N_d3*e_em*m_tau*IT_0024*U_stau_00;
