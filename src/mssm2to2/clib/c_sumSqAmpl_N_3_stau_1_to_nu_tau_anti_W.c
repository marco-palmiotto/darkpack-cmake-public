        ...
        )
{
    ...
    const ccomplex_t IT_0009 = e_em*conj(U_Wm1)*U_stau_00;
    ...
    const ccomplex_t IT_0015 = conj(U_d1)*e_em*m_tau*IT_0014*U_stau_10;
    ...
    const ccomplex_t IT_0024 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0025 = IT_0001*IT_0024;
    const ccomplex_t IT_0026 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0033 = conj(U_d2)*e_em*m_tau*IT_0014*U_stau_10;
    ...
    const ccomplex_t IT_0042 = m_N_3*IT_0041;
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0045 = IT_0001*IT_0044;
    const ccomplex_t IT_0046 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0053 = IT_0038*IT_0051*IT_0052;
    const ccomplex_t IT_0054 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0055 = IT_0001*IT_0054;
    const ccomplex_t IT_0056 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0063 = IT_0021*IT_0061*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = cos(theta_W);
    const ccomplex_t IT_0067 = cpow(IT_0066, -1);
    const ccomplex_t IT_0068 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = N_d3*e_em*m_tau*IT_0014*U_stau_00;
    ...
    const ccomplex_t IT_0077 = pow(m_N_3, 2);
    const ccomplex_t IT_0078 = pow(m_tau, 2);
    const ccomplex_t IT_0079 = cpow(s_12 + 0.5*IT_0020 + 0.5*IT_0077 + (-0.5)
      *IT_0078 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0081 = IT_0076*IT_0079*IT_0080;
    ...
    const ccomplex_t IT_0085 = m_N_3*IT_0083*IT_0084;
    ...
    const ccomplex_t IT_0096 = cpow(s_13 + (-0.5)*IT_0077 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0112 = IT_0079*IT_0111;
    ...
    const ccomplex_t IT_0124 = IT_0043 + IT_0082;
    const ccomplex_t IT_0125 = (-2)*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = (-0.5)*IT_0113;
    const ccomplex_t IT_0127 = s_34*IT_0116;
    ...
    const ccomplex_t IT_0135 = (-0.25)*IT_0128;
    ...
    const ccomplex_t IT_0140 = (-0.5)*IT_0085*IT_0115 + IT_0125 + IT_0133 +
       IT_0139;
    const ccomplex_t IT_0141 = s_14*s_34*IT_0083;
    ...
    const ccomplex_t IT_0147 = 0.5*IT_0099;
    ...
    const ccomplex_t IT_0154 = s_34*IT_0077;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = IT_0153 + IT_0155;
    const ccomplex_t IT_0157 = IT_0126 + IT_0134;
    const ccomplex_t IT_0158 = m_N_3*IT_0143;
    const ccomplex_t IT_0159 = pow(s_14, 2);
    const ccomplex_t IT_0160 = IT_0083*IT_0159;
    const ccomplex_t IT_0161 = -IT_0077;
    const ccomplex_t IT_0162 = IT_0160 + IT_0161;
    const ccomplex_t IT_0163 = s_13*IT_0162;
    const ccomplex_t IT_0164 = s_13*IT_0083*IT_0084;
    const ccomplex_t IT_0165 = pow(m_W, 4);
    const ccomplex_t IT_0166 = s_13*IT_0165;
    const ccomplex_t IT_0167 = IT_0083*IT_0166;
    const ccomplex_t IT_0168 = IT_0117 + IT_0119 + (-0.5)*IT_0167;
    const ccomplex_t IT_0169 = (-0.25)*IT_0167;
    const ccomplex_t IT_0170 = IT_0118 + IT_0169;
    const ccomplex_t IT_0171 = s_13*s_34;
    const ccomplex_t IT_0172 = 2*conj(IT_0114);
    const ccomplex_t IT_0173 = (-2)*(conj(IT_0043) + conj(IT_0082))*IT_0140 +
       IT_0144*(conj(IT_0114)*IT_0149 + IT_0114*IT_0152) + IT_0156*((conj
      (IT_0126) + conj(IT_0134))*IT_0149 + IT_0152*IT_0157) + ((conj(IT_0043) +
       conj(IT_0082))*IT_0149 + IT_0124*IT_0152)*IT_0158 + (-2)*(conj(IT_0145)*(
      (-0.5)*IT_0146 + IT_0147) + (IT_0145 + -IT_0147)*conj(IT_0147))*IT_0163 +
       conj(IT_0114)*IT_0115*IT_0164 + (-4)*conj(IT_0134)*(0.5*IT_0124*IT_0138 +
       IT_0134*IT_0168 + (-2)*IT_0126*IT_0170 + (-0.25)*IT_0115*IT_0171) + (-4)
      *conj(IT_0126)*((-0.5)*IT_0124*IT_0132 + IT_0126*IT_0168 + (-2)*IT_0134
      *IT_0170 + (-0.25)*IT_0115*IT_0171) + (IT_0085*IT_0124 + IT_0157*IT_0171)
      *IT_0172;
