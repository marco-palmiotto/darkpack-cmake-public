...
ccomplex_return_t c_sumSqAmpl_N_3_stau_1_to_nu_tau_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0012 = IT_0010*IT_0011;
    const ccomplex_t IT_0013 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0052 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0053 = IT_0010*IT_0052;
    const ccomplex_t IT_0054 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0063 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0064 = IT_0010*IT_0063;
    const ccomplex_t IT_0065 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0072 = IT_0030*IT_0070*IT_0071;
    const ccomplex_t IT_0073 = pow(m_N_3, 2);
    const ccomplex_t IT_0074 = pow(m_tau, 2);
    const ccomplex_t IT_0075 = cpow(s_12 + 0.5*IT_0029 + 0.5*IT_0073 + (-0.5)
      *IT_0074 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0010;
    const ccomplex_t IT_0078 = 0.5*IT_0077;
    const ccomplex_t IT_0079 = cos(theta_W);
    const ccomplex_t IT_0080 = cpow(IT_0079, -1);
    const ccomplex_t IT_0081 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = N_d3*e_em*m_tau*IT_0023*U_stau_00;
    ...
    const ccomplex_t IT_0090 = IT_0075*IT_0076*IT_0089;
    const ccomplex_t IT_0091 = 0.5*IT_0051 + (-0.5)*IT_0062 + 0.5*IT_0072 +
       0.5*IT_0090;
    ...
    const ccomplex_t IT_0101 = (-0.5)*IT_0061;
    ...
    const ccomplex_t IT_0122 = cpow(s_13 + (-0.5)*IT_0073 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0126 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0127 = IT_0080*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0130 = IT_0010*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = conj(N_d3)*e_em*m_tau*IT_0023*U_stau_10;
    ...
    const ccomplex_t IT_0143 = IT_0061 + 0.5*IT_0125;
    ...
    const ccomplex_t IT_0161 = -IT_0073;
    const ccomplex_t IT_0162 = IT_0160 + IT_0161;
    const ccomplex_t IT_0163 = s_13*IT_0162;
    const ccomplex_t IT_0164 = 2*IT_0143;
    const ccomplex_t IT_0165 = (-0.5)*IT_0164;
    const ccomplex_t IT_0166 = IT_0141 + IT_0165;
    const ccomplex_t IT_0167 = (-2)*conj(IT_0141);
    const ccomplex_t IT_0168 = s_13*s_14;
    const ccomplex_t IT_0169 = s_34*IT_0073;
    const ccomplex_t IT_0170 = -IT_0169;
    const ccomplex_t IT_0171 = IT_0168 + IT_0170;
    const ccomplex_t IT_0172 = -conj(IT_0101);
    ...
    const ccomplex_t IT_0177 = IT_0002 + IT_0004 + IT_0176;
    const ccomplex_t IT_0178 = (-0.25)*IT_0175;
    ...
    const ccomplex_t IT_0185 = 4*IT_0008*IT_0092*IT_0093 + (-2)*IT_0099*
      ...
      *IT_0152 + IT_0153*(IT_0093*IT_0152 + IT_0092*IT_0154) + (-2)*IT_0155*
      ...
      (-0.5)*IT_0154*IT_0158) + (-2)*IT_0163*((-0.5)*conj(IT_0141)*IT_0142 +
       conj(IT_0143)*IT_0166 + (-0.5)*IT_0143*IT_0167) + IT_0171*(IT_0145
      *IT_0157 + IT_0148*IT_0158 + 2*IT_0101*(conj(IT_0143) + 0.5*IT_0167) + 2
      *IT_0166*IT_0172) + (-4)*(IT_0156*conj(IT_0156) + (IT_0100 + -IT_0101)*
      (conj(IT_0100) + IT_0172))*IT_0177 + 8*conj(IT_0156)*((IT_0100 + -IT_0101)
      *IT_0179 + IT_0104*IT_0184) + 8*IT_0156*((conj(IT_0100) + IT_0172)*IT_0179
       + IT_0107*IT_0184);
