        ...
        )
{
    ...
    const ccomplex_t IT_0039 = conj(N_d3)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0048 = IT_0017*IT_0043;
    ...
    const ccomplex_t IT_0083 = (conj(IT_0030)*IT_0032 + IT_0030*conj(IT_0032) 
      ...
      *IT_0047*IT_0064 + (-0.5)*IT_0052*IT_0066 + (-0.5)*IT_0019*IT_0053*IT_0067
