...
ccomplex_return_t c_sumSqAmpl_N_3_stau_1_to_tau_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_B3*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0017 = N_d3*e_em*m_tau*IT_0016*U_stau_00;
    const ccomplex_t IT_0018 = IT_0015*IT_0017;
    const ccomplex_t IT_0019 = 1.4142135623731*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*(IT_0010 + 0.5*IT_0019);
    ...
    const ccomplex_t IT_0031 = IT_0004*IT_0028;
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0034 = IT_0007*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0037 = IT_0014*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = conj(N_d3)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0051 = IT_0025*IT_0045;
    ...
    const ccomplex_t IT_0073 = IT_0053*(conj(IT_0052)*IT_0056 + IT_0052*conj
      (IT_0056) + conj(IT_0030)*IT_0067 + IT_0030*conj(IT_0067)) + (conj(IT_0047
      )*IT_0056 + IT_0047*conj(IT_0056) + conj(IT_0032)*IT_0067 + IT_0032*conj
      (IT_0067))*IT_0069 + (conj(IT_0030)*IT_0047 + IT_0030*conj(IT_0047) + conj
      (IT_0032)*IT_0052 + IT_0032*conj(IT_0052))*IT_0070 + (conj(IT_0056)
      *IT_0067 + IT_0056*conj(IT_0067))*IT_0071 + (conj(IT_0030)*IT_0052 +
       IT_0030*conj(IT_0052))*IT_0072;
    ...
    const ccomplex_t IT_0083 = (conj(IT_0030)*IT_0032 + IT_0030*conj(IT_0032) 
      + conj(IT_0047)*IT_0052 + IT_0047*conj(IT_0052))*IT_0054 + (IT_0030*conj
      (IT_0030) + IT_0052*conj(IT_0052))*IT_0055 + (-2)*conj(IT_0056)*((-0.5)
      *IT_0000*IT_0053*IT_0056 + IT_0057*IT_0058 + 2*IT_0059*IT_0063 + (-0.5)
      *IT_0032*IT_0064 + (-0.5)*IT_0030*IT_0066) + IT_0056*(conj(IT_0032)
      *IT_0064 + conj(IT_0030)*IT_0066) + (conj(IT_0047)*IT_0064 + conj(IT_0052)
