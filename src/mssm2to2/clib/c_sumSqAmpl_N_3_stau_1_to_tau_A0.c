        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B3*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0023 = N_d3*e_em*m_tau*IT_0002*U_stau_00;
    ...
    const ccomplex_t IT_0335 = m_N_3*IT_0212;
    ...
    const ccomplex_t IT_0341 = m_N_3*m_tau;
