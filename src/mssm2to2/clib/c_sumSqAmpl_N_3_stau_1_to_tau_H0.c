...
ccomplex_return_t c_sumSqAmpl_N_3_stau_1_to_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = N_B2*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0011 = N_d2*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0074 = cpow(s_12 + (-0.5)*IT_0016 + 0.5*IT_0017 + 0.5
      *IT_0073 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*e_em*m_tau*IT_0006*IT_0008
      *IT_0010*IT_0021;
    ...
    const ccomplex_t IT_0080 = N_d3*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0089 = cpow(s_13 + (-0.5)*IT_0016 + (-0.5)*IT_0073 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0090 = mu_h*m_tau*IT_0010;
    const ccomplex_t IT_0091 = sin(beta);
    const ccomplex_t IT_0092 = -IT_0025*IT_0091;
    const ccomplex_t IT_0093 = IT_0005*IT_0021;
    const ccomplex_t IT_0094 = IT_0092 + IT_0093;
    const ccomplex_t IT_0095 = cpow(IT_0000, -2);
    const ccomplex_t IT_0096 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj
      (U_stau_00) + -1./2*IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_10)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_00) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0094*IT_0095)
      *conj(U_stau_10));
    const ccomplex_t IT_0097 = (0 + _Complex_I*-1)*(e_em*IT_0096 + (
      -1.4142135623731)*A_tau*IT_0021*(conj(U_stau_00)*U_stau_10 + U_stau_00
      *conj(U_stau_10)));
    ...
    const ccomplex_t IT_0102 = cpow(s_13 + (-0.5)*IT_0016 + (-0.5)*IT_0073 + (
    ...
    const ccomplex_t IT_0106 = N_d3*e_em*m_tau*IT_0010*U_stau_01;
    ...
    const ccomplex_t IT_0111 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_11)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_01) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0094*IT_0095)
      *conj(U_stau_11));
    const ccomplex_t IT_0112 = (0 + _Complex_I*-1)*(e_em*IT_0111 + (
      -1.4142135623731)*A_tau*IT_0021*(conj(U_stau_01)*U_stau_10 + U_stau_00
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0127 = conj(N_B3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0131 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0138 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0152 = IT_0034*IT_0151;
    ...
    const ccomplex_t IT_0157 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0164 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0165 = IT_0022*IT_0164;
    const ccomplex_t IT_0166 = conj(N_W1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0175 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0176 = IT_0037*IT_0175;
    const ccomplex_t IT_0177 = conj(N_B3)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0190 = N_d1*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0195 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0199 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0200 = IT_0001*IT_0199;
    const ccomplex_t IT_0201 = 1.4142135623731*IT_0200;
    const ccomplex_t IT_0202 = N_d4*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0207 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0211 = IT_0022*IT_0210;
    ...
    const ccomplex_t IT_0263 = conj(N_d3)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0299 = IT_0018*IT_0298;
    const ccomplex_t IT_0300 = (0 + _Complex_I*1)*IT_0299;
    const ccomplex_t IT_0301 = m_N_3*IT_0047;
    const ccomplex_t IT_0302 = m_N_2*IT_0069;
    const ccomplex_t IT_0303 = IT_0301 + IT_0302;
    const ccomplex_t IT_0304 = IT_0300*IT_0303;
    const ccomplex_t IT_0305 = IT_0076*IT_0267;
    const ccomplex_t IT_0306 = IT_0074*IT_0305;
    const ccomplex_t IT_0307 = (0 + _Complex_I*1)*IT_0306;
    const ccomplex_t IT_0308 = m_tau*IT_0307;
    const ccomplex_t IT_0309 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj
      (U_stau_00) + -1./2*IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_10)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_00) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0094*IT_0095)
    ...
    const ccomplex_t IT_0312 = IT_0267*IT_0311;
    const ccomplex_t IT_0313 = IT_0089*IT_0312;
    ...
    const ccomplex_t IT_0321 = conj(N_d3)*e_em*m_tau*IT_0010*U_stau_11;
    ...
    const ccomplex_t IT_0326 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_11)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0090*conj(U_stau_01) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0094*IT_0095)
    ...
    const ccomplex_t IT_0330 = IT_0102*IT_0329;
    const ccomplex_t IT_0331 = (0 + _Complex_I*1)*IT_0330;
    const ccomplex_t IT_0332 = m_N_3*IT_0230;
    const ccomplex_t IT_0333 = m_N_4*IT_0252;
    const ccomplex_t IT_0334 = IT_0332 + IT_0333;
    const ccomplex_t IT_0335 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0336 = IT_0001*IT_0335;
    const ccomplex_t IT_0337 = 1.4142135623731*IT_0336;
    const ccomplex_t IT_0338 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0339 = IT_0008*IT_0338;
    const ccomplex_t IT_0340 = 1.4142135623731*IT_0339;
    const ccomplex_t IT_0341 = conj(N_d4)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0346 = IT_0207*IT_0345;
    const ccomplex_t IT_0347 = (0 + _Complex_I*1)*IT_0346;
    const ccomplex_t IT_0348 = IT_0334*IT_0347;
    const ccomplex_t IT_0349 = 0.5*IT_0270 + 0.5*IT_0287 + 0.5*IT_0304 + 
      -IT_0308 + 0.5*IT_0314 + 0.5*IT_0331 + 0.5*IT_0348;
    const ccomplex_t IT_0350 = 2*s_13;
    const ccomplex_t IT_0351 = m_N_3*m_tau;
    const ccomplex_t IT_0352 = 2*IT_0256;
    const ccomplex_t IT_0353 = IT_0047*IT_0300;
    const ccomplex_t IT_0354 = IT_0230*IT_0347;
    const ccomplex_t IT_0355 = IT_0125*IT_0269;
    const ccomplex_t IT_0356 = IT_0162*IT_0286;
    const ccomplex_t IT_0357 = 0.5*IT_0087 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0209*IT_0252;
    const ccomplex_t IT_0360 = IT_0184*IT_0197;
    const ccomplex_t IT_0361 = IT_0020*IT_0069;
    const ccomplex_t IT_0362 = IT_0135*IT_0140;
    const ccomplex_t IT_0363 = (-0.5)*IT_0307 + 0.5*IT_0359 + 0.5*IT_0360 +
