        ...
        )
{
    ...
    const ccomplex_t IT_0049 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0050 = IT_0022*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0052 = IT_0026*IT_0051;
    const ccomplex_t IT_0053 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0054 = IT_0022*IT_0053;
    const ccomplex_t IT_0055 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0056 = IT_0026*IT_0055;
    const ccomplex_t IT_0057 = IT_0050 + IT_0052 + IT_0054 + IT_0056;
    const ccomplex_t IT_0058 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0078 = N_d3*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0086 = IT_0005*IT_0021;
    const ccomplex_t IT_0087 = IT_0085 + IT_0086;
    const ccomplex_t IT_0088 = cpow(IT_0000, -2);
    const ccomplex_t IT_0089 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))*conj
      (U_stau_00) + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_10)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_00) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)
      *conj(U_stau_10));
    ...
    const ccomplex_t IT_0104 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_11)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_01) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0120 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0121 = IT_0022*IT_0120;
    const ccomplex_t IT_0122 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0123 = IT_0034*IT_0122;
    const ccomplex_t IT_0124 = conj(N_W3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0125 = IT_0037*IT_0124;
    const ccomplex_t IT_0126 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0127 = IT_0026*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*(IT_0121 + -IT_0123 + 
      -IT_0125 + IT_0127);
    const ccomplex_t IT_0129 = m_N_3*IT_0128;
    const ccomplex_t IT_0130 = IT_0119 + IT_0129;
    const ccomplex_t IT_0131 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0183 = N_d1*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0188 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0206 = IT_0034*IT_0205;
    const ccomplex_t IT_0207 = N_W2*N_d3*e_em;
    ...
    const ccomplex_t IT_0237 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0238 = IT_0001*IT_0237;
    const ccomplex_t IT_0239 = 1.4142135623731*IT_0238;
    const ccomplex_t IT_0240 = N_d2*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0245 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0248 = IT_0236*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*e_em*m_tau*IT_0006*IT_0008
      *IT_0010*IT_0021;
    const ccomplex_t IT_0250 = (-0.5)*IT_0249;
    const ccomplex_t IT_0251 = IT_0082*IT_0250;
    const ccomplex_t IT_0252 = cpow(s_12 + (-0.5)*IT_0016 + 0.5*IT_0017 + 0.5
    ...
    const ccomplex_t IT_0256 = (-0.5)*IT_0072 + (-0.5)*IT_0094 + (-0.5)
      *IT_0109 + (-0.5)*IT_0134 + (-0.5)*IT_0191 + (-0.5)*IT_0248 + IT_0255;
    const ccomplex_t IT_0257 = m_N_3*IT_0212;
    const ccomplex_t IT_0258 = m_N_2*IT_0234;
    ...
    const ccomplex_t IT_0266 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0271 = IT_0245*IT_0270;
    ...
    const ccomplex_t IT_0285 = IT_0250*IT_0284;
    const ccomplex_t IT_0286 = IT_0252*IT_0285;
    const ccomplex_t IT_0287 = (0 + _Complex_I*1)*IT_0286;
    const ccomplex_t IT_0288 = m_tau*IT_0287;
    const ccomplex_t IT_0289 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))*conj
      (U_stau_00) + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_10)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_00) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)
    ...
    const ccomplex_t IT_0306 = (-2)*U_stau_00*((IT_0006*IT_0008*IT_0010
      *IT_0016*IT_0021 + (-0.5)*m_W*IT_0087*(IT_0008 + -IT_0007*IT_0088))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_11)) +
       U_stau_10*(IT_0006*IT_0008*IT_0025*IT_0083*conj(U_stau_01) + (-2)*
      (IT_0006*IT_0008*IT_0010*IT_0016*IT_0021 + -m_W*IT_0007*IT_0087*IT_0088)
    ...
    const ccomplex_t IT_0310 = IT_0095*IT_0309;
    const ccomplex_t IT_0311 = (0 + _Complex_I*1)*IT_0310;
    const ccomplex_t IT_0312 = IT_0131*IT_0284;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = IT_0130*IT_0313;
    const ccomplex_t IT_0315 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0316 = IT_0001*IT_0315;
    const ccomplex_t IT_0317 = 1.4142135623731*IT_0316;
    const ccomplex_t IT_0318 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0319 = IT_0008*IT_0318;
    const ccomplex_t IT_0320 = 1.4142135623731*IT_0319;
    const ccomplex_t IT_0321 = conj(N_d1)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0326 = IT_0188*IT_0325;
    const ccomplex_t IT_0327 = (0 + _Complex_I*1)*IT_0326;
    const ccomplex_t IT_0328 = m_N_3*IT_0155;
    const ccomplex_t IT_0329 = m_N_1*IT_0177;
    ...
    const ccomplex_t IT_0338 = conj(N_d4)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0343 = IT_0018*IT_0342;
    const ccomplex_t IT_0344 = (0 + _Complex_I*1)*IT_0343;
    const ccomplex_t IT_0345 = m_N_3*IT_0047;
    const ccomplex_t IT_0346 = m_N_4*IT_0069;
    const ccomplex_t IT_0347 = IT_0345 + IT_0346;
    const ccomplex_t IT_0348 = IT_0344*IT_0347;
    const ccomplex_t IT_0349 = 0.5*IT_0273 + -IT_0288 + 0.5*IT_0294 + 0.5
    ...
    const ccomplex_t IT_0353 = IT_0118*IT_0313;
    const ccomplex_t IT_0354 = IT_0155*IT_0327;
    const ccomplex_t IT_0355 = IT_0212*IT_0272;
    const ccomplex_t IT_0356 = IT_0047*IT_0344;
    ...
    const ccomplex_t IT_0360 = IT_0128*IT_0133;
    const ccomplex_t IT_0361 = IT_0177*IT_0190;
    const ccomplex_t IT_0362 = IT_0234*IT_0247;
    const ccomplex_t IT_0363 = (-0.5)*IT_0287 + 0.5*IT_0359 + 0.5*IT_0360 +
