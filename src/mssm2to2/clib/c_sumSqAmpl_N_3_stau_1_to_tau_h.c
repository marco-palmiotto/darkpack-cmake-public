...
ccomplex_return_t c_sumSqAmpl_N_3_stau_1_to_tau_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0055 = N_B2*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0062 = N_d2*e_em*m_tau*IT_0061*U_stau_00;
    ...
    const ccomplex_t IT_0068 = pow(m_stau_1, 2);
    ...
    const ccomplex_t IT_0074 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*IT_0073 + (
    ...
    const ccomplex_t IT_0078 = N_d3*e_em*m_tau*IT_0061*U_stau_00;
    ...
    const ccomplex_t IT_0083 = mu_h*m_tau*IT_0061;
    const ccomplex_t IT_0084 = IT_0006*IT_0058;
    const ccomplex_t IT_0085 = sin(beta);
    const ccomplex_t IT_0086 = IT_0000*IT_0085;
    const ccomplex_t IT_0087 = IT_0084 + IT_0086;
    const ccomplex_t IT_0088 = cpow(IT_0001, -2);
    const ccomplex_t IT_0089 = 2*U_stau_00*((IT_0006*IT_0016*IT_0059*IT_0061
      *IT_0067 + (-0.5)*m_W*IT_0087*(IT_0016 + -IT_0015*IT_0088))*conj(U_stau_00
      ) + 1./2*IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_10)) + U_stau_10*
      (IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_00) + 2*(IT_0006*IT_0016
      *IT_0059*IT_0061*IT_0067 + -m_W*IT_0015*IT_0087*IT_0088)*conj(U_stau_10));
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*(e_em*IT_0089 +
       1.4142135623731*A_tau*IT_0006*(conj(U_stau_00)*U_stau_10 + U_stau_00*conj
      (U_stau_10)));
    ...
    const ccomplex_t IT_0095 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*IT_0073 + (
    ...
    const ccomplex_t IT_0099 = N_d3*e_em*m_tau*IT_0061*U_stau_01;
    ...
    const ccomplex_t IT_0104 = 2*U_stau_00*((IT_0006*IT_0016*IT_0059*IT_0061
      *IT_0067 + (-0.5)*m_W*IT_0087*(IT_0016 + -IT_0015*IT_0088))*conj(U_stau_01
      ) + 1./2*IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_11)) + U_stau_10*
      (IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_01) + 2*(IT_0006*IT_0016
      *IT_0059*IT_0061*IT_0067 + -m_W*IT_0015*IT_0087*IT_0088)*conj(U_stau_11));
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*(e_em*IT_0104 +
       1.4142135623731*A_tau*IT_0006*(conj(U_stau_01)*U_stau_10 + U_stau_00*conj
      (U_stau_11)));
    ...
    const ccomplex_t IT_0133 = cpow(s_23 + (-0.5)*IT_0067 + (-0.5)*IT_0068 +
    ...
    const ccomplex_t IT_0185 = N_d1*e_em*m_tau*IT_0061*U_stau_00;
    ...
    const ccomplex_t IT_0190 = cpow(s_23 + (-0.5)*IT_0067 + (-0.5)*IT_0068 +
    ...
    const ccomplex_t IT_0242 = N_d4*e_em*m_tau*IT_0061*U_stau_00;
    ...
    const ccomplex_t IT_0247 = cpow(s_23 + (-0.5)*IT_0067 + (-0.5)*IT_0068 +
    ...
    const ccomplex_t IT_0251 = cpow(s_12 + (-0.5)*IT_0067 + 0.5*IT_0068 + 0.5
      *IT_0073 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*e_em*m_tau*IT_0006*IT_0016
      *IT_0059*IT_0061;
    ...
    const ccomplex_t IT_0270 = IT_0069*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1)*IT_0270;
    const ccomplex_t IT_0272 = m_N_3*IT_0030;
    const ccomplex_t IT_0273 = m_N_2*IT_0052;
    ...
    const ccomplex_t IT_0282 = conj(N_d3)*e_em*m_tau*IT_0061*U_stau_10;
    ...
    const ccomplex_t IT_0287 = IT_0133*IT_0286;
    const ccomplex_t IT_0288 = (0 + _Complex_I*1)*IT_0287;
    const ccomplex_t IT_0289 = IT_0132*IT_0288;
    const ccomplex_t IT_0290 = 2*U_stau_00*((IT_0006*IT_0016*IT_0059*IT_0061
      *IT_0067 + (-0.5)*m_W*IT_0087*(IT_0016 + -IT_0015*IT_0088))*conj(U_stau_00
      ) + 1./2*IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_10)) + U_stau_10*
      (IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_00) + 2*(IT_0006*IT_0016
      *IT_0059*IT_0061*IT_0067 + -m_W*IT_0015*IT_0087*IT_0088)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0307 = 2*U_stau_00*((IT_0006*IT_0016*IT_0059*IT_0061
      *IT_0067 + (-0.5)*m_W*IT_0087*(IT_0016 + -IT_0015*IT_0088))*conj(U_stau_01
      ) + 1./2*IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_11)) + U_stau_10*
      (IT_0000*IT_0016*IT_0059*IT_0083*conj(U_stau_01) + 2*(IT_0006*IT_0016
      *IT_0059*IT_0061*IT_0067 + -m_W*IT_0015*IT_0087*IT_0088)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0313 = m_N_3*IT_0157;
    const ccomplex_t IT_0314 = m_N_1*IT_0179;
    const ccomplex_t IT_0315 = IT_0313 + IT_0314;
    const ccomplex_t IT_0316 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0317 = IT_0002*IT_0316;
    const ccomplex_t IT_0318 = 1.4142135623731*IT_0317;
    const ccomplex_t IT_0319 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0320 = IT_0016*IT_0319;
    const ccomplex_t IT_0321 = 1.4142135623731*IT_0320;
    const ccomplex_t IT_0322 = conj(N_d1)*e_em*m_tau*IT_0061*U_stau_10;
    const ccomplex_t IT_0323 = IT_0060*IT_0322;
    ...
    const ccomplex_t IT_0344 = IT_0247*IT_0343;
    ...
    const ccomplex_t IT_0355 = IT_0030*IT_0271;
    const ccomplex_t IT_0356 = IT_0119*IT_0288;
    const ccomplex_t IT_0357 = IT_0157*IT_0328;
    const ccomplex_t IT_0358 = IT_0214*IT_0345;
