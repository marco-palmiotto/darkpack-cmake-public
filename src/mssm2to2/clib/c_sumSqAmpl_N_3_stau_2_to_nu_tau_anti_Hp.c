...
ccomplex_return_t c_sumSqAmpl_N_3_stau_2_to_nu_tau_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = conj(N_u3)*e_em*conj(V_Wp1);
    ...
    const ccomplex_t IT_0010 = conj(N_B3)*conj(V_u1)*e_em;
    const ccomplex_t IT_0011 = IT_0009*IT_0010;
    const ccomplex_t IT_0012 = 1.4142135623731*IT_0011;
    const ccomplex_t IT_0013 = conj(N_W3)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0034 = conj(N_u3)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0035 = IT_0003*IT_0034;
    const ccomplex_t IT_0036 = 2*IT_0035;
    const ccomplex_t IT_0037 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0038 = IT_0009*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0047 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0048 = IT_0002*IT_0047;
    const ccomplex_t IT_0049 = conj(U_d2)*e_em*m_tau*IT_0024*U_stau_11;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*(A_tau*IT_0057*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0002*(m_W*IT_0000*IT_0057*U_stau_01 + (-0.5)
      *m_tau*IT_0024*(m_tau*IT_0022*IT_0057*U_stau_01 + mu_h*U_stau_11)));
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0002*IT_0022*IT_0024*IT_0057;
    ...
    const ccomplex_t IT_0077 = N_d3*e_em*m_tau*IT_0024*U_stau_01;
    ...
    const ccomplex_t IT_0084 = cpow(s_12 + 0.5*IT_0031 + 0.5*IT_0068 + (-0.5)
      *IT_0083 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0100 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0101 = IT_0084*IT_0099*IT_0100;
    const ccomplex_t IT_0102 = (-0.5)*IT_0033 + (-0.5)*IT_0056 + 0.5*IT_0071 +
       0.5*IT_0087 + (-0.5)*IT_0101;
    const ccomplex_t IT_0103 = IT_0002*IT_0057;
    const ccomplex_t IT_0104 = N_W3*U_d2*e_em;
    const ccomplex_t IT_0105 = IT_0103*IT_0104;
    const ccomplex_t IT_0106 = 1.4142135623731*IT_0105;
    const ccomplex_t IT_0107 = IT_0008*IT_0057;
    const ccomplex_t IT_0108 = N_B3*U_d2*e_em;
    ...
    const ccomplex_t IT_0112 = N_d3*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0135 = IT_0032*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*IT_0135;
    const ccomplex_t IT_0137 = 0.5*IT_0086 + (-0.5)*IT_0120 + (-0.5)*IT_0136;
    const ccomplex_t IT_0138 = s_23*m_N_3;
