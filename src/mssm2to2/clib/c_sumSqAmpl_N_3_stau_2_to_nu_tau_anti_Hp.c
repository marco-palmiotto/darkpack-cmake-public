        ...
        )
{
    ...
    const ccomplex_t IT_0004 = conj(N_u3)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0010 = conj(N_B3)*conj(V_u2)*e_em;
    const ccomplex_t IT_0011 = IT_0009*IT_0010;
    const ccomplex_t IT_0012 = 1.4142135623731*IT_0011;
    const ccomplex_t IT_0013 = conj(N_W3)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0025 = conj(U_d2)*e_em*m_tau*IT_0024*U_stau_11;
    ...
    const ccomplex_t IT_0032 = cpow(s_23 + (-0.5)*IT_0031 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0054 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0055 = IT_0008*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0058 = IT_0002*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = conj(N_d3)*e_em*m_tau*IT_0024*U_stau_11;
    ...
    const ccomplex_t IT_0067 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0068 = IT_0008*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = N_d3*e_em*m_tau*IT_0024*U_stau_01;
    ...
    const ccomplex_t IT_0092 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0093 = IT_0002*IT_0092;
    const ccomplex_t IT_0094 = conj(U_d1)*e_em*m_tau*IT_0024*U_stau_11;
    ...
    const ccomplex_t IT_0118 = IT_0097*IT_0117;
    ...
    const ccomplex_t IT_0137 = 0.5*IT_0077 + (-0.5)*IT_0120 + (-0.5)*IT_0136;
