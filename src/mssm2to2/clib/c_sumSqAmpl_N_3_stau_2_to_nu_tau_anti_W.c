...
ccomplex_return_t c_sumSqAmpl_N_3_stau_2_to_nu_tau_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = conj(N_W3)*e_em*U_Wm2;
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = conj(N_d3)*U_d2*e_em;
    ...
    const ccomplex_t IT_0024 = conj(N_W3)*e_em*U_Wm1;
    const ccomplex_t IT_0025 = IT_0001*IT_0024;
    const ccomplex_t IT_0026 = conj(N_d3)*U_d1*e_em;
    ...
    const ccomplex_t IT_0044 = N_W3*e_em*conj(V_Wp1);
    const ccomplex_t IT_0045 = IT_0001*IT_0044;
    const ccomplex_t IT_0046 = N_u3*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001;
    ...
    const ccomplex_t IT_0061 = N_d3*e_em*m_tau*IT_0014*U_stau_01;
    ...
    const ccomplex_t IT_0067 = pow(m_N_3, 2);
    const ccomplex_t IT_0068 = pow(m_tau, 2);
    const ccomplex_t IT_0069 = cpow(s_12 + 0.5*IT_0020 + 0.5*IT_0067 + (-0.5)
      *IT_0068 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0071 = IT_0066*IT_0069*IT_0070;
    const ccomplex_t IT_0072 = N_W3*e_em*conj(V_Wp2);
    const ccomplex_t IT_0073 = IT_0001*IT_0072;
    const ccomplex_t IT_0074 = N_u3*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0081 = IT_0021*IT_0079*IT_0080;
    const ccomplex_t IT_0082 = 0.5*IT_0053 + 0.5*IT_0071 + 0.5*IT_0081;
    const ccomplex_t IT_0083 = pow(m_W, -2);
    const ccomplex_t IT_0084 = pow(s_34, 2);
    const ccomplex_t IT_0085 = m_N_3*IT_0083*IT_0084;
    const ccomplex_t IT_0086 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0087 = IT_0057*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0090 = IT_0001*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = conj(N_d3)*e_em*m_tau*IT_0014*U_stau_11;
    ...
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001
      *U_stau_01;
    ...
    const ccomplex_t IT_0110 = cpow(s_13 + (-0.5)*IT_0067 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0114 = -IT_0099 + (-0.5)*IT_0113;
    ...
    const ccomplex_t IT_0126 = (-0.5)*IT_0099;
    ...
    const ccomplex_t IT_0147 = 0.5*IT_0113;
    ...
    const ccomplex_t IT_0173 = (-2)*(conj(IT_0043) + conj(IT_0082))*IT_0140 +
       IT_0144*(conj(IT_0114)*IT_0149 + IT_0114*IT_0152) + ((conj(IT_0043) +
       conj(IT_0082))*IT_0149 + IT_0124*IT_0152)*IT_0153 + IT_0157*((conj
      (IT_0126) + conj(IT_0134))*IT_0149 + IT_0152*IT_0158) + (-2)*(conj(IT_0145
      ...
      *IT_0170 + (-0.25)*IT_0115*IT_0171) + (IT_0085*IT_0124 + IT_0158*IT_0171)
      *IT_0172;
