        ...
        )
{
    ...
    const ccomplex_t IT_0072 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = N_d3*e_em*m_tau*IT_0014*U_stau_01;
    ...
    const ccomplex_t IT_0154 = s_34*IT_0064;
