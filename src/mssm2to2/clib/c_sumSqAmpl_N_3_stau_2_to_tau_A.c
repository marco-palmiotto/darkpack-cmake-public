        ...
        )
{
    ...
    const ccomplex_t IT_0015 = N_d3*e_em*m_tau*IT_0014*U_stau_01;
    const ccomplex_t IT_0016 = IT_0013*IT_0015;
    const ccomplex_t IT_0017 = 1.4142135623731*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*(IT_0008 + 0.5*IT_0017);
    ...
    const ccomplex_t IT_0039 = conj(N_d3)*e_em*m_tau*IT_0014*U_stau_11;
    ...
    const ccomplex_t IT_0048 = IT_0021*IT_0043;
