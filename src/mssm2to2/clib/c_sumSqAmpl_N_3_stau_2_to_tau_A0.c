...
ccomplex_return_t c_sumSqAmpl_N_3_stau_2_to_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = N_d3*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0043 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0048 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0049 = IT_0011*IT_0048;
    const ccomplex_t IT_0050 = e_em*mu_h*m_tau*IT_0036*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0051 = IT_0011*IT_0050;
    const ccomplex_t IT_0052 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0053 = IT_0006*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*IT_0053;
    const ccomplex_t IT_0055 = A_tau*U_stau_01*conj(U_stau_11);
    ...
    const ccomplex_t IT_0060 = pow(m_N_3, 2);
    const ccomplex_t IT_0061 = cpow(s_13 + (-0.5)*IT_0042 + (-0.5)*IT_0060 + (
    ...
    const ccomplex_t IT_0067 = N_d1*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0072 = cpow(s_23 + (-0.5)*IT_0042 + (-0.5)*IT_0043 +
    ...
    const ccomplex_t IT_0113 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0114 = IT_0002*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = N_d2*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0121 = cpow(s_23 + (-0.5)*IT_0042 + (-0.5)*IT_0043 +
    ...
    const ccomplex_t IT_0142 = conj(N_B2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0150 = conj(N_B3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0151 = IT_0003*IT_0150;
    const ccomplex_t IT_0152 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0153 = IT_0007*IT_0152;
    const ccomplex_t IT_0154 = conj(N_W3)*conj(N_u2)*e_em;
    const ccomplex_t IT_0155 = IT_0012*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0161 = IT_0123*IT_0160;
    const ccomplex_t IT_0162 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0163 = IT_0002*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = N_d3*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0170 = e_em*mu_h*m_tau*IT_0036*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0171 = IT_0011*IT_0170;
    const ccomplex_t IT_0172 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0173 = IT_0011*IT_0172;
    const ccomplex_t IT_0174 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0175 = IT_0006*IT_0174;
    const ccomplex_t IT_0176 = 1.4142135623731*IT_0175;
    const ccomplex_t IT_0177 = A_tau*conj(U_stau_00)*U_stau_11;
    ...
    const ccomplex_t IT_0182 = cpow(s_13 + (-0.5)*IT_0042 + (-0.5)*IT_0060 + (
    ...
    const ccomplex_t IT_0185 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0186 = IT_0002*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = N_d4*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0234 = (-0.5)*IT_0047 + (-0.5)*IT_0063 + (-0.5)
      *IT_0112 + (-0.5)*IT_0161 + (-0.5)*IT_0184 + (-0.5)*IT_0233;
    ...
    const ccomplex_t IT_0241 = conj(N_d3)*e_em*m_tau*IT_0036*U_stau_11;
    const ccomplex_t IT_0242 = IT_0035*IT_0241;
    ...
    const ccomplex_t IT_0255 = conj(N_d1)*e_em*m_tau*IT_0036*U_stau_11;
    ...
    const ccomplex_t IT_0293 = m_N_3*IT_0140;
    const ccomplex_t IT_0294 = m_N_2*IT_0158;
    const ccomplex_t IT_0295 = IT_0293 + IT_0294;
    const ccomplex_t IT_0296 = IT_0292*IT_0295;
    const ccomplex_t IT_0297 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0298 = IT_0002*IT_0297;
    const ccomplex_t IT_0299 = 1.4142135623731*IT_0298;
    const ccomplex_t IT_0300 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0301 = IT_0011*IT_0300;
    const ccomplex_t IT_0302 = 1.4142135623731*IT_0301;
    const ccomplex_t IT_0303 = conj(N_d4)*e_em*m_tau*IT_0036*U_stau_11;
    const ccomplex_t IT_0304 = IT_0035*IT_0303;
    ...
    const ccomplex_t IT_0308 = IT_0193*IT_0307;
    const ccomplex_t IT_0309 = (0 + _Complex_I*1)*IT_0308;
    const ccomplex_t IT_0310 = m_N_3*IT_0212;
    const ccomplex_t IT_0311 = m_N_4*IT_0230;
    const ccomplex_t IT_0312 = IT_0310 + IT_0311;
    const ccomplex_t IT_0313 = IT_0309*IT_0312;
    const ccomplex_t IT_0314 = IT_0058*IT_0245;
    const ccomplex_t IT_0315 = IT_0061*IT_0314;
    const ccomplex_t IT_0316 = (0 + _Complex_I*1)*IT_0315;
    const ccomplex_t IT_0317 = 0.5*IT_0248 + 0.5*IT_0265 + 0.5*IT_0279 + 0.5
    ...
    const ccomplex_t IT_0321 = IT_0091*IT_0261;
    const ccomplex_t IT_0322 = IT_0140*IT_0292;
    const ccomplex_t IT_0323 = IT_0212*IT_0309;
    const ccomplex_t IT_0324 = IT_0018*IT_0247;
    const ccomplex_t IT_0325 = e_em*m_tau*IT_0006*IT_0011*IT_0034*IT_0036;
    const ccomplex_t IT_0326 = (-0.5)*IT_0325;
    const ccomplex_t IT_0327 = IT_0041*IT_0326;
    const ccomplex_t IT_0328 = cpow(s_12 + (-0.5)*IT_0042 + 0.5*IT_0043 + 0.5
      *IT_0060 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0331 = (-0.5)*IT_0321 + (-0.5)*IT_0322 + (-0.5)
      *IT_0323 + (-0.5)*IT_0324 + 0.5*IT_0330;
    const ccomplex_t IT_0332 = s_14*m_tau;
    const ccomplex_t IT_0333 = IT_0074*IT_0109;
    const ccomplex_t IT_0334 = IT_0123*IT_0158;
    const ccomplex_t IT_0335 = IT_0195*IT_0230;
    const ccomplex_t IT_0336 = IT_0245*IT_0326;
    const ccomplex_t IT_0337 = IT_0328*IT_0336;
    const ccomplex_t IT_0338 = (0 + _Complex_I*1)*IT_0337;
    const ccomplex_t IT_0339 = IT_0028*IT_0046;
