        ...
        )
{
    ...
    const ccomplex_t IT_0047 = N_B2*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0053 = N_d2*e_em*m_tau*IT_0052*U_stau_01;
    ...
    const ccomplex_t IT_0059 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0064 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0065 = IT_0002*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_d4*e_em*m_tau*IT_0052*U_stau_01;
    ...
    const ccomplex_t IT_0095 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0096 = IT_0007*IT_0095;
    const ccomplex_t IT_0097 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0098 = IT_0012*IT_0097;
    const ccomplex_t IT_0099 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0100 = IT_0015*IT_0099;
    const ccomplex_t IT_0101 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0102 = IT_0003*IT_0101;
    const ccomplex_t IT_0103 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0104 = IT_0007*IT_0103;
    const ccomplex_t IT_0105 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0106 = IT_0012*IT_0105;
    const ccomplex_t IT_0107 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0113 = e_em*mu_h*m_tau*IT_0052*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0114 = IT_0011*IT_0113;
    const ccomplex_t IT_0115 = e_em*mu_h*m_tau*IT_0052*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0116 = IT_0011*IT_0115;
    const ccomplex_t IT_0117 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0118 = IT_0006*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = A_tau*conj(U_stau_00)*U_stau_11;
    const ccomplex_t IT_0121 = IT_0006*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = 0.5*IT_0114 + (-0.5)*IT_0116 + 0.5*IT_0119 + (
      -0.5)*IT_0122;
    const ccomplex_t IT_0124 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0125 = IT_0002*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = N_d3*e_em*m_tau*IT_0052*U_stau_00;
    ...
    const ccomplex_t IT_0133 = pow(m_N_3, 2);
    const ccomplex_t IT_0134 = cpow(s_13 + (-0.5)*IT_0058 + (-0.5)*IT_0133 + (
    ...
    const ccomplex_t IT_0137 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0138 = IT_0003*IT_0137;
    const ccomplex_t IT_0139 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0140 = IT_0007*IT_0139;
    const ccomplex_t IT_0141 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0142 = IT_0012*IT_0141;
    const ccomplex_t IT_0143 = N_W3*N_d3*e_em;
    ...
    const ccomplex_t IT_0147 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0148 = IT_0003*IT_0147;
    const ccomplex_t IT_0149 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0150 = IT_0007*IT_0149;
    const ccomplex_t IT_0151 = conj(N_W3)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0158 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0159 = IT_0002*IT_0158;
    const ccomplex_t IT_0160 = 1.4142135623731*IT_0159;
    const ccomplex_t IT_0161 = N_d3*e_em*m_tau*IT_0052*U_stau_01;
    ...
    const ccomplex_t IT_0166 = cpow(s_23 + (-0.5)*IT_0058 + (-0.5)*IT_0059 +
    ...
    const ccomplex_t IT_0170 = cpow(s_13 + (-0.5)*IT_0058 + (-0.5)*IT_0133 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0171 = e_em*mu_h*m_tau*IT_0052*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0172 = IT_0011*IT_0171;
    const ccomplex_t IT_0173 = e_em*mu_h*m_tau*IT_0052*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0174 = IT_0011*IT_0173;
    const ccomplex_t IT_0175 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0176 = IT_0006*IT_0175;
    const ccomplex_t IT_0177 = 1.4142135623731*IT_0176;
    const ccomplex_t IT_0178 = A_tau*U_stau_01*conj(U_stau_11);
    ...
    const ccomplex_t IT_0203 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0204 = IT_0003*IT_0203;
    const ccomplex_t IT_0205 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0206 = IT_0007*IT_0205;
    const ccomplex_t IT_0207 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0208 = IT_0012*IT_0207;
    const ccomplex_t IT_0209 = conj(N_W1)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0215 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0216 = IT_0012*IT_0215;
    const ccomplex_t IT_0217 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0222 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0223 = IT_0002*IT_0222;
    const ccomplex_t IT_0224 = 1.4142135623731*IT_0223;
    const ccomplex_t IT_0225 = N_d1*e_em*m_tau*IT_0052*U_stau_01;
    ...
    const ccomplex_t IT_0246 = IT_0123*IT_0245;
    const ccomplex_t IT_0247 = IT_0134*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1)*IT_0247;
    const ccomplex_t IT_0249 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0250 = IT_0002*IT_0249;
    const ccomplex_t IT_0251 = 1.4142135623731*IT_0250;
    const ccomplex_t IT_0252 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0253 = IT_0011*IT_0252;
    const ccomplex_t IT_0254 = 1.4142135623731*IT_0253;
    const ccomplex_t IT_0255 = conj(N_d3)*e_em*m_tau*IT_0052*U_stau_11;
    ...
    const ccomplex_t IT_0263 = IT_0166*IT_0259;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = IT_0157*IT_0264;
    const ccomplex_t IT_0266 = m_N_3*IT_0201;
    const ccomplex_t IT_0267 = m_N_1*IT_0219;
    ...
    const ccomplex_t IT_0275 = conj(N_d1)*e_em*m_tau*IT_0052*U_stau_11;
    ...
    const ccomplex_t IT_0280 = IT_0230*IT_0279;
    ...
    const ccomplex_t IT_0292 = conj(N_d2)*e_em*m_tau*IT_0052*U_stau_11;
    ...
    const ccomplex_t IT_0300 = m_N_3*IT_0091;
    const ccomplex_t IT_0301 = m_N_4*IT_0109;
    const ccomplex_t IT_0302 = IT_0300 + IT_0301;
    const ccomplex_t IT_0303 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0304 = IT_0002*IT_0303;
    const ccomplex_t IT_0305 = 1.4142135623731*IT_0304;
    const ccomplex_t IT_0306 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0307 = IT_0011*IT_0306;
    const ccomplex_t IT_0308 = 1.4142135623731*IT_0307;
    const ccomplex_t IT_0309 = conj(N_d4)*e_em*m_tau*IT_0052*U_stau_11;
    ...
    const ccomplex_t IT_0314 = IT_0072*IT_0313;
    ...
    const ccomplex_t IT_0321 = IT_0201*IT_0281;
    const ccomplex_t IT_0322 = IT_0091*IT_0315;
    const ccomplex_t IT_0323 = cpow(s_12 + (-0.5)*IT_0058 + 0.5*IT_0059 + 0.5
      *IT_0133 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0324 = e_em*m_tau*IT_0006*IT_0011*IT_0050*IT_0052;
    ...
    const ccomplex_t IT_0329 = IT_0145*IT_0264;
    const ccomplex_t IT_0330 = IT_0026*IT_0298;
    ...
    const ccomplex_t IT_0334 = IT_0155*IT_0168;
    const ccomplex_t IT_0335 = IT_0044*IT_0062;
    const ccomplex_t IT_0336 = IT_0259*IT_0325;
    const ccomplex_t IT_0337 = IT_0323*IT_0336;
