        ...
        )
{
    ...
    const ccomplex_t IT_0031 = N_B3*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0038 = N_d3*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0044 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0071 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0072 = IT_0003*IT_0071;
    const ccomplex_t IT_0073 = conj(N_W1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0094 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0095 = IT_0002*IT_0094;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = N_d1*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0102 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0132 = conj(N_B3)*conj(N_d2)*e_em;
    const ccomplex_t IT_0133 = IT_0003*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0139 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0150 = IT_0127 + IT_0149;
    const ccomplex_t IT_0151 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0152 = IT_0002*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = N_d2*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0159 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0163 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0164 = IT_0002*IT_0163;
    const ccomplex_t IT_0165 = 1.4142135623731*IT_0164;
    const ccomplex_t IT_0166 = N_d4*e_em*m_tau*IT_0037*U_stau_01;
    const ccomplex_t IT_0167 = IT_0036*IT_0166;
    ...
    const ccomplex_t IT_0171 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0174 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0175 = IT_0003*IT_0174;
    const ccomplex_t IT_0176 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0177 = IT_0015*IT_0176;
    const ccomplex_t IT_0178 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0179 = IT_0003*IT_0178;
    const ccomplex_t IT_0180 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0187 = N_B3*N_u4*e_em;
    ...
    const ccomplex_t IT_0196 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0197 = IT_0003*IT_0196;
    const ccomplex_t IT_0198 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0199 = IT_0015*IT_0198;
    const ccomplex_t IT_0200 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0201 = IT_0003*IT_0200;
    const ccomplex_t IT_0202 = conj(N_W4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0220 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0221 = IT_0002*IT_0220;
    const ccomplex_t IT_0222 = 1.4142135623731*IT_0221;
    const ccomplex_t IT_0223 = N_d3*e_em*m_tau*IT_0037*U_stau_00;
    ...
    const ccomplex_t IT_0228 = mu_h*m_tau*IT_0037;
    const ccomplex_t IT_0229 = sin(beta);
    const ccomplex_t IT_0230 = -IT_0006*IT_0229;
    const ccomplex_t IT_0231 = IT_0000*IT_0034;
    const ccomplex_t IT_0232 = IT_0230 + IT_0231;
    const ccomplex_t IT_0233 = cpow(IT_0001, -2);
    const ccomplex_t IT_0234 = (-2)*conj(U_stau_00)*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0232*(IT_0011 + -IT_0010*IT_0233))
      *U_stau_01 + -1./2*IT_0006*IT_0011*IT_0035*IT_0228*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0011*IT_0035*IT_0228*U_stau_01 + (-2)*(IT_0000
      *IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0232*IT_0233)*U_stau_11);
    const ccomplex_t IT_0235 = (0 + _Complex_I*-1)*(e_em*IT_0234 + (
    ...
    const ccomplex_t IT_0238 = pow(m_N_3, 2);
    const ccomplex_t IT_0239 = cpow(s_13 + (-0.5)*IT_0043 + (-0.5)*IT_0238 + (
    ...
    const ccomplex_t IT_0242 = cpow(s_12 + (-0.5)*IT_0043 + 0.5*IT_0044 + 0.5
      *IT_0238 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0011
      *IT_0035*IT_0037;
    const ccomplex_t IT_0244 = (-0.5)*IT_0243;
    const ccomplex_t IT_0245 = IT_0042*IT_0244;
    const ccomplex_t IT_0246 = IT_0242*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = m_tau*IT_0247;
    const ccomplex_t IT_0249 = cpow(s_13 + (-0.5)*IT_0043 + (-0.5)*IT_0238 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0250 = (-2)*U_stau_01*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0232*(IT_0011 + -IT_0010*IT_0233))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0011*IT_0035*IT_0228*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0011*IT_0035*IT_0228*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0232*IT_0233)
      *conj(U_stau_11));
    const ccomplex_t IT_0251 = (0 + _Complex_I*-1)*(e_em*IT_0250 + (
    ...
    const ccomplex_t IT_0256 = (-0.5)*IT_0048 + (-0.5)*IT_0105 + (-0.5)
      *IT_0162 + (-0.5)*IT_0219 + (-0.5)*IT_0241 + IT_0248 + (-0.5)*IT_0255;
    const ccomplex_t IT_0257 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0258 = IT_0002*IT_0257;
    const ccomplex_t IT_0259 = 1.4142135623731*IT_0258;
    const ccomplex_t IT_0260 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0261 = IT_0011*IT_0260;
    const ccomplex_t IT_0262 = 1.4142135623731*IT_0261;
    const ccomplex_t IT_0263 = conj(N_d3)*e_em*m_tau*IT_0037*U_stau_10;
    const ccomplex_t IT_0264 = IT_0036*IT_0263;
    ...
    const ccomplex_t IT_0268 = (-2)*conj(U_stau_00)*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0232*(IT_0011 + -IT_0010*IT_0233))
      *U_stau_01 + -1./2*IT_0006*IT_0011*IT_0035*IT_0228*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0011*IT_0035*IT_0228*U_stau_01 + (-2)*(IT_0000
      *IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0232*IT_0233)*U_stau_11);
    ...
    const ccomplex_t IT_0285 = (-2)*U_stau_01*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0232*(IT_0011 + -IT_0010*IT_0233))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0011*IT_0035*IT_0228*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0011*IT_0035*IT_0228*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0232*IT_0233)
    ...
    const ccomplex_t IT_0289 = IT_0249*IT_0288;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*IT_0289;
    const ccomplex_t IT_0291 = m_N_3*IT_0126;
    const ccomplex_t IT_0292 = m_N_2*IT_0148;
    const ccomplex_t IT_0293 = IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0295 = IT_0002*IT_0294;
    const ccomplex_t IT_0296 = 1.4142135623731*IT_0295;
    const ccomplex_t IT_0297 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0298 = IT_0011*IT_0297;
    const ccomplex_t IT_0299 = 1.4142135623731*IT_0298;
    const ccomplex_t IT_0300 = conj(N_d2)*e_em*m_tau*IT_0037*U_stau_11;
    const ccomplex_t IT_0301 = IT_0036*IT_0300;
    ...
    const ccomplex_t IT_0308 = IT_0244*IT_0284;
    const ccomplex_t IT_0309 = IT_0242*IT_0308;
    const ccomplex_t IT_0310 = (0 + _Complex_I*1)*IT_0309;
    const ccomplex_t IT_0311 = m_tau*IT_0310;
    const ccomplex_t IT_0312 = IT_0045*IT_0284;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = IT_0030*IT_0313;
    const ccomplex_t IT_0315 = m_N_3*IT_0069;
    const ccomplex_t IT_0316 = m_N_1*IT_0091;
    const ccomplex_t IT_0317 = IT_0315 + IT_0316;
    const ccomplex_t IT_0318 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0319 = IT_0002*IT_0318;
    const ccomplex_t IT_0320 = 1.4142135623731*IT_0319;
    const ccomplex_t IT_0321 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0322 = IT_0011*IT_0321;
    const ccomplex_t IT_0323 = 1.4142135623731*IT_0322;
    const ccomplex_t IT_0324 = conj(N_d1)*e_em*m_tau*IT_0037*U_stau_11;
    const ccomplex_t IT_0325 = IT_0036*IT_0324;
    ...
    const ccomplex_t IT_0329 = IT_0102*IT_0328;
    const ccomplex_t IT_0330 = (0 + _Complex_I*1)*IT_0329;
    const ccomplex_t IT_0331 = IT_0317*IT_0330;
    const ccomplex_t IT_0332 = m_N_3*IT_0194;
    const ccomplex_t IT_0333 = m_N_4*IT_0216;
    const ccomplex_t IT_0334 = IT_0332 + IT_0333;
    const ccomplex_t IT_0335 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0336 = IT_0002*IT_0335;
    const ccomplex_t IT_0337 = 1.4142135623731*IT_0336;
    const ccomplex_t IT_0338 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0339 = IT_0011*IT_0338;
    const ccomplex_t IT_0340 = 1.4142135623731*IT_0339;
    const ccomplex_t IT_0341 = conj(N_d4)*e_em*m_tau*IT_0037*U_stau_11;
    const ccomplex_t IT_0342 = IT_0036*IT_0341;
    ...
    const ccomplex_t IT_0346 = IT_0171*IT_0345;
    const ccomplex_t IT_0347 = (0 + _Complex_I*1)*IT_0346;
    const ccomplex_t IT_0348 = IT_0334*IT_0347;
    const ccomplex_t IT_0349 = 0.5*IT_0273 + 0.5*IT_0290 + 0.5*IT_0307 + 
      -IT_0311 + 0.5*IT_0314 + 0.5*IT_0331 + 0.5*IT_0348;
    const ccomplex_t IT_0350 = 2*s_13;
    const ccomplex_t IT_0351 = m_N_3*m_tau;
    const ccomplex_t IT_0352 = 2*IT_0256;
    const ccomplex_t IT_0353 = IT_0069*IT_0330;
    const ccomplex_t IT_0354 = IT_0126*IT_0306;
    const ccomplex_t IT_0355 = IT_0018*IT_0313;
    const ccomplex_t IT_0356 = IT_0194*IT_0347;
    const ccomplex_t IT_0357 = 0.5*IT_0247 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0148*IT_0161;
    const ccomplex_t IT_0360 = IT_0028*IT_0047;
    const ccomplex_t IT_0361 = IT_0173*IT_0216;
    const ccomplex_t IT_0362 = IT_0091*IT_0104;
    const ccomplex_t IT_0363 = (-0.5)*IT_0310 + 0.5*IT_0359 + 0.5*IT_0360 +
