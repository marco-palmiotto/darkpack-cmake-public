        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_u3*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0017 = N_d3*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0022 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0023 = IT_0009*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = conj(N_W3)*e_em*U_stau_01;
    ...
    const ccomplex_t IT_0032 = conj(N_d3)*e_em*m_tau*IT_0031*U_stau_11;
    ...
    const ccomplex_t IT_0038 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0043 = N_d2*conj(N_d3)*e_em;
    const ccomplex_t IT_0044 = IT_0011*IT_0043;
    const ccomplex_t IT_0045 = IT_0015*IT_0043;
    const ccomplex_t IT_0046 = N_u2*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0058 = conj(N_d2)*e_em*m_tau*IT_0031*U_stau_11;
    const ccomplex_t IT_0059 = IT_0030*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*(IT_0054 + IT_0057 + 
      -IT_0060);
    const ccomplex_t IT_0062 = (-0.5)*IT_0061;
    const ccomplex_t IT_0063 = cpow(s_23 + (-0.5)*IT_0037 + (-0.5)*IT_0038 +
    ...
    const ccomplex_t IT_0086 = cpow(s_23 + (-0.5)*IT_0037 + (-0.5)*IT_0038 +
    ...
    const ccomplex_t IT_0090 = 0.5*IT_0042 + IT_0066 + IT_0089;
    const ccomplex_t IT_0091 = 0.5*IT_0020;
    ...
    const ccomplex_t IT_0095 = N_d3*e_em*m_tau*IT_0031*U_stau_01;
    ...
    const ccomplex_t IT_0103 = conj(N_d1)*N_d3*e_em;
    const ccomplex_t IT_0104 = IT_0011*IT_0103;
    const ccomplex_t IT_0105 = IT_0015*IT_0103;
    const ccomplex_t IT_0106 = conj(N_u1)*N_u3*e_em;
    ...
    const ccomplex_t IT_0111 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0112 = IT_0009*IT_0111;
    const ccomplex_t IT_0113 = 1.4142135623731*IT_0112;
    const ccomplex_t IT_0114 = N_d1*e_em*m_tau*IT_0031*U_stau_01;
    ...
    const ccomplex_t IT_0119 = IT_0086*IT_0118;
    ...
    const ccomplex_t IT_0126 = IT_0015*IT_0124;
    const ccomplex_t IT_0127 = IT_0011*IT_0122;
    ...
    const ccomplex_t IT_0133 = N_d2*e_em*m_tau*IT_0031*U_stau_01;
    ...
    const ccomplex_t IT_0141 = (-0.5)*IT_0102 + -IT_0121 + -IT_0140;
    const ccomplex_t IT_0142 = 2*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0009*IT_0010 +
       -IT_0008*IT_0014)*conj(U_stau_00)*U_stau_01 + IT_0009*IT_0010*conj
      (U_stau_10)*U_stau_11);
    const ccomplex_t IT_0144 = (-2)*IT_0143;
    const ccomplex_t IT_0145 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0146 = IT_0009*IT_0145;
    const ccomplex_t IT_0147 = 1.4142135623731*IT_0146;
    const ccomplex_t IT_0148 = N_d3*e_em*m_tau*IT_0031*U_stau_00;
    ...
    const ccomplex_t IT_0153 = cpow(s_13 + (-0.5)*IT_0004 + (-0.5)*IT_0037 + (
    ...
    const ccomplex_t IT_0157 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0158 = IT_0011*IT_0157;
    const ccomplex_t IT_0159 = IT_0015*IT_0157;
    const ccomplex_t IT_0160 = N_d3*conj(N_d4)*e_em;
    const ccomplex_t IT_0161 = IT_0011*IT_0160;
    const ccomplex_t IT_0162 = IT_0015*IT_0160;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*(IT_0158 + IT_0159 + 
      -IT_0161 + -IT_0162);
    const ccomplex_t IT_0164 = (-0.5)*IT_0163;
    const ccomplex_t IT_0165 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0166 = IT_0009*IT_0165;
    const ccomplex_t IT_0167 = 1.4142135623731*IT_0166;
    const ccomplex_t IT_0168 = N_d4*e_em*m_tau*IT_0031*U_stau_01;
    ...
    const ccomplex_t IT_0173 = cpow(s_23 + (-0.5)*IT_0037 + (-0.5)*IT_0038 +
    ...
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0009*IT_0010 +
       -IT_0008*IT_0014)*U_stau_01*conj(U_stau_01) + IT_0009*IT_0010*U_stau_11
      *conj(U_stau_11));
    const ccomplex_t IT_0178 = (-2)*IT_0177;
    const ccomplex_t IT_0179 = cpow(s_13 + (-0.5)*IT_0004 + (-0.5)*IT_0037 + (
    ...
    const ccomplex_t IT_0183 = IT_0021*IT_0101;
    const ccomplex_t IT_0184 = (-0.5)*IT_0156 + -IT_0176 + (-0.5)*IT_0182 + (
      -0.5)*IT_0183;
    const ccomplex_t IT_0185 = (-2)*IT_0184;
    const ccomplex_t IT_0186 = IT_0142 + IT_0185;
    const ccomplex_t IT_0187 = 2*conj(IT_0141);
    const ccomplex_t IT_0188 = (-2)*conj(IT_0184);
    const ccomplex_t IT_0189 = IT_0187 + IT_0188;
    const ccomplex_t IT_0190 = IT_0041*IT_0091;
    const ccomplex_t IT_0191 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0192 = IT_0009*IT_0191;
    const ccomplex_t IT_0193 = 1.4142135623731*IT_0192;
    const ccomplex_t IT_0194 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0195 = IT_0014*IT_0194;
    const ccomplex_t IT_0196 = 1.4142135623731*IT_0195;
    const ccomplex_t IT_0197 = conj(N_d3)*e_em*m_tau*IT_0031*U_stau_10;
    ...
    const ccomplex_t IT_0202 = IT_0153*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*IT_0202;
    const ccomplex_t IT_0204 = IT_0144*IT_0203;
    const ccomplex_t IT_0205 = conj(N_d3)*N_d4*e_em;
    const ccomplex_t IT_0206 = IT_0011*IT_0205;
    const ccomplex_t IT_0207 = IT_0015*IT_0205;
    const ccomplex_t IT_0208 = conj(N_u3)*N_u4*e_em;
    const ccomplex_t IT_0209 = IT_0011*IT_0208;
    const ccomplex_t IT_0210 = IT_0015*IT_0208;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1)*(IT_0206 + IT_0207 + 
      -IT_0209 + -IT_0210);
    const ccomplex_t IT_0212 = (-0.5)*IT_0211;
    const ccomplex_t IT_0213 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0214 = IT_0009*IT_0213;
    const ccomplex_t IT_0215 = 1.4142135623731*IT_0214;
    const ccomplex_t IT_0216 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0217 = IT_0014*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = conj(N_d4)*e_em*m_tau*IT_0031*U_stau_11;
    const ccomplex_t IT_0220 = IT_0030*IT_0219;
    ...
    const ccomplex_t IT_0224 = IT_0173*IT_0223;
    const ccomplex_t IT_0225 = (0 + _Complex_I*1)*IT_0224;
    const ccomplex_t IT_0226 = IT_0212*IT_0225;
    const ccomplex_t IT_0227 = IT_0036*IT_0179;
    const ccomplex_t IT_0228 = (0 + _Complex_I*1)*IT_0227;
    const ccomplex_t IT_0229 = IT_0178*IT_0228;
    const ccomplex_t IT_0230 = 0.5*IT_0190 + 0.5*IT_0204 + IT_0226 + 0.5
      *IT_0229;
    const ccomplex_t IT_0231 = 2*IT_0184;
    const ccomplex_t IT_0232 = (-2)*IT_0141;
    const ccomplex_t IT_0233 = IT_0231 + IT_0232;
    const ccomplex_t IT_0234 = 2*conj(IT_0184);
    const ccomplex_t IT_0235 = (-2)*conj(IT_0141);
    ...
    const ccomplex_t IT_0246 = 0.5*IT_0156 + 0.5*IT_0182 + IT_0245;
    ...
    const ccomplex_t IT_0254 = (-0.5)*IT_0204 + (-0.5)*IT_0229 + -IT_0253;
    ...
    const ccomplex_t IT_0261 = m_N_3*IT_0239;
    const ccomplex_t IT_0262 = m_N_3*IT_0021;
    const ccomplex_t IT_0263 = m_N_3*IT_0091;
    const ccomplex_t IT_0264 = -IT_0263;
    const ccomplex_t IT_0265 = IT_0262 + IT_0264;
    const ccomplex_t IT_0266 = IT_0101*IT_0265;
    const ccomplex_t IT_0267 = m_N_1*IT_0074;
    const ccomplex_t IT_0268 = m_N_3*IT_0110;
    const ccomplex_t IT_0269 = -IT_0268;
    const ccomplex_t IT_0270 = IT_0267 + IT_0269;
    const ccomplex_t IT_0271 = IT_0120*IT_0270;
    const ccomplex_t IT_0272 = m_N_2*IT_0051;
    const ccomplex_t IT_0273 = m_N_3*IT_0129;
    const ccomplex_t IT_0274 = -IT_0273;
    const ccomplex_t IT_0275 = IT_0272 + IT_0274;
    const ccomplex_t IT_0276 = IT_0139*IT_0275;
    const ccomplex_t IT_0277 = 0.25*IT_0266 + 0.5*IT_0271 + 0.5*IT_0276;
    const ccomplex_t IT_0278 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0279 = IT_0036*IT_0242;
    const ccomplex_t IT_0280 = IT_0241*IT_0278*IT_0279;
    const ccomplex_t IT_0281 = m_tau*IT_0253;
    const ccomplex_t IT_0282 = m_N_4*IT_0212;
    const ccomplex_t IT_0283 = m_N_3*IT_0164;
    const ccomplex_t IT_0284 = -IT_0283;
    const ccomplex_t IT_0285 = IT_0282 + IT_0284;
    const ccomplex_t IT_0286 = IT_0175*IT_0285;
    const ccomplex_t IT_0287 = 0.25*IT_0266 + (-0.5)*IT_0280 + 0.5*IT_0281 + (
      -0.5)*IT_0286;
    const ccomplex_t IT_0288 = conj(IT_0277) + conj(IT_0287);
    const ccomplex_t IT_0289 = IT_0277 + IT_0287;
    const ccomplex_t IT_0290 = m_N_3*IT_0051;
    const ccomplex_t IT_0291 = -IT_0290;
    const ccomplex_t IT_0292 = m_N_2*IT_0129;
    const ccomplex_t IT_0293 = IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = IT_0065*IT_0293;
    const ccomplex_t IT_0295 = IT_0041*IT_0265;
    const ccomplex_t IT_0296 = m_N_1*IT_0110;
    const ccomplex_t IT_0297 = m_N_3*IT_0074;
    const ccomplex_t IT_0298 = -IT_0297;
    const ccomplex_t IT_0299 = IT_0296 + IT_0298;
    const ccomplex_t IT_0300 = IT_0088*IT_0299;
    const ccomplex_t IT_0301 = (-0.5)*IT_0294 + 0.25*IT_0295 + (-0.5)*IT_0300;
    const ccomplex_t IT_0302 = IT_0099*IT_0250;
    const ccomplex_t IT_0303 = IT_0241*IT_0278*IT_0302;
    const ccomplex_t IT_0304 = m_N_4*IT_0164;
    const ccomplex_t IT_0305 = m_N_3*IT_0212;
    ...
    const ccomplex_t IT_0310 = 0.25*IT_0295 + 0.5*IT_0303 + 0.5*IT_0308 + (
      -0.5)*IT_0309;
    const ccomplex_t IT_0311 = conj(IT_0301) + conj(IT_0310);
    const ccomplex_t IT_0312 = IT_0301 + IT_0310;
    ...
    const ccomplex_t IT_0317 = 0.25*IT_0102 + 0.5*IT_0121 + 0.5*IT_0140;
    const ccomplex_t IT_0318 = 0.5*IT_0245;
    const ccomplex_t IT_0319 = 0.5*IT_0176 + 0.25*IT_0183;
    const ccomplex_t IT_0320 = (-0.25)*IT_0042 + (-0.5)*IT_0066 + (-0.5)
      *IT_0089;
    ...
    const ccomplex_t IT_0324 = (-0.25)*IT_0190 + (-0.5)*IT_0226;
    const ccomplex_t IT_0325 = 2*IT_0230;
    const ccomplex_t IT_0326 = (-2)*IT_0090;
    const ccomplex_t IT_0327 = IT_0325 + IT_0326;
    const ccomplex_t IT_0328 = 2*conj(IT_0230);
    const ccomplex_t IT_0329 = (-2)*conj(IT_0090);
    ...
    const ccomplex_t IT_0365 = m_N_3*IT_0359;
    ...
    const ccomplex_t IT_0375 = (-6)*conj(IT_0277);
    ...
    const ccomplex_t IT_0387 = (-2)*IT_0277;
    const ccomplex_t IT_0388 = (-2)*conj(IT_0277);
    ...
    const ccomplex_t IT_0417 = m_N_3*IT_0416;
    ...
    const ccomplex_t IT_0426 = (-2)*conj(IT_0301);
    ...
    const ccomplex_t IT_0438 = IT_0007*(conj(IT_0090)*IT_0186 + IT_0090
      *IT_0189 + conj(IT_0230)*IT_0233 + IT_0230*IT_0236) + IT_0240*(IT_0189
      *IT_0246 + IT_0186*conj(IT_0246) + conj(IT_0254)*IT_0257 + IT_0254*IT_0260
      ) + IT_0261*(IT_0186*IT_0288 + IT_0189*IT_0289 + IT_0257*IT_0311 + IT_0260
      *IT_0312) + IT_0316*(IT_0189*(IT_0317 + IT_0318) + IT_0186*(conj(IT_0317) 
      ...
      *IT_0364 + IT_0312*IT_0366) + 4*IT_0373*(IT_0311*IT_0312 + IT_0288*
      ...
      (IT_0287) + (-0.166666666666667)*IT_0375)) + (conj(IT_0141)*IT_0142 + conj
      (IT_0184)*IT_0233 + IT_0184*IT_0235 + conj(IT_0090)*IT_0255 + conj(IT_0230
      )*IT_0327 + IT_0230*IT_0329)*IT_0376 + IT_0377*(IT_0189*IT_0254 + IT_0186
      *conj(IT_0254) + conj(IT_0090)*IT_0361 + IT_0090*IT_0362 + conj(IT_0230)
      ...
      *IT_0347 + conj(IT_0090)*IT_0387 + IT_0090*IT_0388) + (IT_0311*IT_0378 +
