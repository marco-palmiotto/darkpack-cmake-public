        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
      *e_em*IT_0010*IT_0028*IT_0030;
    ...
    const ccomplex_t IT_0056 = pow(m_u, 2);
    const ccomplex_t IT_0057 = pow(m_N_3, 2);
    const ccomplex_t IT_0058 = cpow((-2)*s_12 + -IT_0000 + IT_0056 + -IT_0057 
      + -reg_prop, -1);
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0008*IT_0010*IT_0028*IT_0030;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0010*IT_0028*IT_0029*IT_0074;
    const ccomplex_t IT_0076 = 0.5*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0010;
    const ccomplex_t IT_0084 = IT_0010*IT_0029;
    const ccomplex_t IT_0085 = N_u3*e_em*V_Wp1;
    const ccomplex_t IT_0086 = IT_0084*IT_0085;
    const ccomplex_t IT_0087 = 2*IT_0086;
    const ccomplex_t IT_0088 = IT_0016*IT_0029;
    const ccomplex_t IT_0089 = N_B3*V_u1*e_em;
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = N_W3*V_u1*e_em;
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0010;
    const ccomplex_t IT_0103 = N_u3*e_em*V_Wp2;
    const ccomplex_t IT_0104 = IT_0084*IT_0103;
    const ccomplex_t IT_0105 = 2*IT_0104;
    const ccomplex_t IT_0106 = N_B3*V_u2*e_em;
    const ccomplex_t IT_0107 = IT_0088*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = N_W3*V_u2*e_em;
    ...
    const ccomplex_t IT_0124 = IT_0032*IT_0115;
    const ccomplex_t IT_0125 = IT_0007*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0127 = IT_0060*IT_0078;
    const ccomplex_t IT_0128 = IT_0058*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = m_N_3*IT_0071;
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0010*IT_0028;
    const ccomplex_t IT_0131 = 0.5*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0016;
    const ccomplex_t IT_0133 = (-0.333333333333333)*IT_0132;
    const ccomplex_t IT_0134 = IT_0131*IT_0133;
    const ccomplex_t IT_0135 = cpow((-2)*s_13 + IT_0006 + IT_0057 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0136 = IT_0134*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*IT_0136;
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0010*(IT_0006*IT_0008*IT_0028*IT_0030 + (-2)*IT_0029*(m_W*IT_0008 + (
    ...
    const ccomplex_t IT_0143 = cpow((-2)*s_13 + IT_0006 + IT_0057 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0144 = IT_0142*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*IT_0144;
    const ccomplex_t IT_0146 = -IT_0125 + -IT_0128 + IT_0129 + IT_0137 +
       IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0148 = IT_0051*IT_0098;
    const ccomplex_t IT_0149 = IT_0036*IT_0147*IT_0148;
    const ccomplex_t IT_0150 = m_d*IT_0101;
    const ccomplex_t IT_0151 = m_d*IT_0118;
    const ccomplex_t IT_0152 = IT_0149 + -IT_0150 + -IT_0151;
    const ccomplex_t IT_0153 = IT_0049*IT_0083;
    const ccomplex_t IT_0154 = IT_0036*IT_0147*IT_0153;
    const ccomplex_t IT_0155 = m_d*IT_0035;
    const ccomplex_t IT_0156 = m_d*IT_0054;
    const ccomplex_t IT_0157 = IT_0154 + -IT_0155 + -IT_0156;
    const ccomplex_t IT_0158 = m_N_3*IT_0081;
    const ccomplex_t IT_0159 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0010*IT_0028*IT_0030;
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*(IT_0063 + (-3)*IT_0066);
    ...
    const ccomplex_t IT_0169 = IT_0027*IT_0102;
    const ccomplex_t IT_0170 = IT_0007*IT_0123*IT_0169;
    const ccomplex_t IT_0171 = IT_0068*IT_0076;
    const ccomplex_t IT_0172 = IT_0058*IT_0126*IT_0171;
    ...
    const ccomplex_t IT_0180 = m_d*s_12;
    ...
    const ccomplex_t IT_0187 = s_23*m_N_3;
