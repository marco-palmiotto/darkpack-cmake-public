...
ccomplex_return_t c_sumSqAmpl_N_3_su_L_to_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = N_u3*e_em*V_Wp1;
    ...
    const ccomplex_t IT_0067 = IT_0011*IT_0014;
    ...
    const ccomplex_t IT_0071 = IT_0011*IT_0029;
    ...
    const ccomplex_t IT_0082 = cpow(IT_0010, -1);
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
      *e_em*IT_0009*IT_0014*IT_0082;
    ...
    const ccomplex_t IT_0101 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0009*IT_0014*IT_0082;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0009*IT_0011*IT_0014*IT_0082;
    ...
    const ccomplex_t IT_0122 = m_d*m_N_3;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0124 = IT_0040*IT_0084;
    const ccomplex_t IT_0125 = IT_0043*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = m_d*IT_0045;
    const ccomplex_t IT_0127 = m_d*IT_0063;
    const ccomplex_t IT_0128 = IT_0125 + -IT_0126 + -IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0130 = IT_0018*IT_0108;
    const ccomplex_t IT_0131 = IT_0008*IT_0129*IT_0130;
    const ccomplex_t IT_0132 = m_N_3*IT_0119;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0009*IT_0014;
    const ccomplex_t IT_0134 = 0.5*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0029;
    const ccomplex_t IT_0136 = (-0.333333333333333)*IT_0135;
    const ccomplex_t IT_0137 = IT_0134*IT_0136;
    const ccomplex_t IT_0138 = cpow((-2)*s_13 + IT_0007 + IT_0042 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0139 = IT_0137*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*IT_0139;
    const ccomplex_t IT_0141 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0014*(IT_0010*(m_W*IT_0011 + (-0.5)*IT_0006*IT_0009*IT_0012) + -1./2
      *IT_0009*IT_0011*IT_0042*IT_0082);
    const ccomplex_t IT_0142 = 0.5*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0009*IT_0014*IT_0082;
    const ccomplex_t IT_0144 = (-0.5)*IT_0143;
    const ccomplex_t IT_0145 = IT_0142*IT_0144;
    const ccomplex_t IT_0146 = cpow((-2)*s_13 + IT_0007 + IT_0042 + -m_sd_L*
    ...
    const ccomplex_t IT_0150 = IT_0059*IT_0102;
    const ccomplex_t IT_0151 = IT_0061*IT_0149*IT_0150;
    const ccomplex_t IT_0152 = -IT_0131 + IT_0132 + IT_0140 + IT_0148 + 
      -IT_0151;
    const ccomplex_t IT_0153 = m_d*IT_0087;
    const ccomplex_t IT_0154 = IT_0023*IT_0081;
    const ccomplex_t IT_0155 = IT_0043*IT_0123*IT_0154;
    const ccomplex_t IT_0156 = m_d*IT_0105;
    const ccomplex_t IT_0157 = -IT_0153 + IT_0155 + -IT_0156;
    const ccomplex_t IT_0158 = IT_0016*IT_0116;
    const ccomplex_t IT_0159 = IT_0008*IT_0129*IT_0158;
    ...
    const ccomplex_t IT_0163 = IT_0138*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*IT_0163;
    const ccomplex_t IT_0165 = IT_0046*IT_0100;
    const ccomplex_t IT_0166 = IT_0061*IT_0149*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*(IT_0111 + (-3)*IT_0114);
    const ccomplex_t IT_0168 = 0.166666666666667*IT_0167;
    const ccomplex_t IT_0169 = IT_0142*IT_0168;
    const ccomplex_t IT_0170 = IT_0146*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*IT_0170;
    const ccomplex_t IT_0172 = m_N_3*IT_0021;
    const ccomplex_t IT_0173 = IT_0159 + -IT_0164 + -IT_0166 + -IT_0171 + 
      -IT_0172;
    const ccomplex_t IT_0174 = 6*IT_0152;
    const ccomplex_t IT_0175 = (-6)*IT_0128;
    ...
    const ccomplex_t IT_0189 = m_d*m_N_3*IT_0000;
    ...
    const ccomplex_t IT_0193 = IT_0005*(IT_0065*IT_0066 + IT_0120*IT_0121) + 6
      *IT_0122*((conj(IT_0128) + -conj(IT_0152))*IT_0157 + (IT_0128 + -IT_0152)
      ...
      *IT_0190) + IT_0120*(conj(IT_0064) + 0.166666666666667*IT_0191)) + (conj
      (IT_0128)*IT_0152 + IT_0128*conj(IT_0152) + conj(IT_0157)*IT_0173 +
