        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
    ...
    const ccomplex_t IT_0074 = 0.5*IT_0002;
    ...
    const ccomplex_t IT_0124 = IT_0036*IT_0081;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0126 = IT_0029*IT_0124*IT_0125;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0001*IT_0004*IT_0129;
    const ccomplex_t IT_0131 = (-0.5)*IT_0130;
    const ccomplex_t IT_0132 = IT_0074*IT_0131;
    const ccomplex_t IT_0133 = IT_0071*IT_0127*IT_0132;
    const ccomplex_t IT_0134 = IT_0025*IT_0092;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0136 = IT_0016*IT_0134*IT_0135;
    const ccomplex_t IT_0137 = IT_0126 + -IT_0133 + IT_0136;
    const ccomplex_t IT_0138 = m_N_3*IT_0103;
    ...
    const ccomplex_t IT_0147 = m_N_3*IT_0028;
    const ccomplex_t IT_0148 = m_N_3*IT_0041;
    const ccomplex_t IT_0149 = m_d*IT_0077;
    const ccomplex_t IT_0150 = IT_0147 + IT_0148 + -IT_0149;
    const ccomplex_t IT_0151 = IT_0018*IT_0099;
    const ccomplex_t IT_0152 = IT_0016*IT_0135*IT_0151;
    const ccomplex_t IT_0153 = IT_0038*IT_0088;
    const ccomplex_t IT_0154 = IT_0029*IT_0125*IT_0153;
    ...
    const ccomplex_t IT_0163 = 0.5*IT_0142;
    ...
    const ccomplex_t IT_0185 = (-6)*conj(IT_0042);
    ...
    const ccomplex_t IT_0195 = (-6)*IT_0176;
    ...
    const ccomplex_t IT_0201 = (-6)*conj(IT_0158);
    const ccomplex_t IT_0202 = m_d*IT_0047;
    const ccomplex_t IT_0203 = 6*IT_0202;
    const ccomplex_t IT_0204 = (-6)*IT_0042;
    const ccomplex_t IT_0205 = 6*IT_0065;
    const ccomplex_t IT_0206 = (-6)*IT_0158;
    ...
    const ccomplex_t IT_0209 = IT_0063*((-18)*IT_0137 + (-18)*IT_0139) +
       IT_0156*IT_0172 + IT_0174*IT_0182 + IT_0173*IT_0195 + IT_0162*IT_0204 +
       IT_0146*IT_0205 + IT_0203*(IT_0062 + 0.166666666666667*IT_0206) + IT_0194
      *IT_0207 + IT_0123*IT_0208;
    const ccomplex_t IT_0210 = IT_0063*((-18)*IT_0150 + (-18)*IT_0155) +
       IT_0140*IT_0172 + IT_0173*IT_0174 + 6*IT_0162*IT_0190 + IT_0182*IT_0195 +
       6*IT_0042*IT_0202 + IT_0123*IT_0205 + IT_0166*IT_0207 + IT_0146*IT_0208;
    const ccomplex_t IT_0211 = 0.166666666666667*IT_0175;
    const ccomplex_t IT_0212 = s_13*IT_0180;
    const ccomplex_t IT_0213 = 0.166666666666667*IT_0212;
    const ccomplex_t IT_0214 = (-6)*conj(IT_0062);
    const ccomplex_t IT_0215 = IT_0069*IT_0196;
    const ccomplex_t IT_0216 = 6*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      ...
      *IT_0117 + IT_0123*IT_0140 + IT_0146*IT_0156) + IT_0063*IT_0156*IT_0157 +
       6*conj(IT_0137)*(IT_0065*IT_0123 + IT_0158*IT_0162 + IT_0077*IT_0166 +
       0.166666666666667*IT_0140*IT_0172 + 0.166666666666667*IT_0173*IT_0174) + 
      (IT_0140*IT_0173 + IT_0062*IT_0175 + IT_0176*IT_0181 + IT_0156*IT_0182)
      *IT_0183 + (IT_0064*IT_0158 + IT_0156*IT_0162 + IT_0175*IT_0176 + IT_0105
      *IT_0184)*IT_0185 + 6*conj(IT_0077)*(IT_0065*IT_0080 + 0.166666666666667
      *IT_0077*IT_0117 + IT_0140*IT_0166 + 0.166666666666667*IT_0103*IT_0187 +
       IT_0069*IT_0190 + IT_0156*IT_0194 + 0.166666666666667*IT_0109*IT_0195) + 
      (IT_0156*IT_0173 + IT_0139*IT_0182 + IT_0109*IT_0196)*IT_0197 + IT_0199 + 
      (IT_0103*IT_0146 + IT_0062*IT_0162 + IT_0176*IT_0182)*IT_0200 + (IT_0042
      ...
      *IT_0209 + conj(IT_0139)*IT_0210 + 6*conj(IT_0062)*(IT_0048*IT_0062 +
       IT_0042*IT_0064 + 0.166666666666667*IT_0162*IT_0198 + IT_0174*IT_0211) +
       6*conj(IT_0105)*(IT_0065*IT_0109 + IT_0158*IT_0175 + 0.166666666666667
      *IT_0184*IT_0204 + IT_0174*IT_0213) + 6*conj(IT_0176)*(0.166666666666667
      *IT_0174*IT_0181 + IT_0184*IT_0190 + 0.166666666666667*IT_0182*IT_0198 +
       IT_0204*IT_0211 + IT_0195*IT_0213) + IT_0214*(IT_0048*IT_0158 + IT_0139
      *IT_0162 + IT_0176*IT_0184 + IT_0215) + 6*conj(IT_0158)*(IT_0140*IT_0162 +
       IT_0105*IT_0175 + IT_0176*IT_0184 + IT_0048*IT_0190 + 0.166666666666667
