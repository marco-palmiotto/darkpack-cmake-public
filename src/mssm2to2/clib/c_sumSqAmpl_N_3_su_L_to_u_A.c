...
ccomplex_return_t c_sumSqAmpl_N_3_su_L_to_u_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0046 = m_u*s_14*m_N_3;
    ...
    const ccomplex_t IT_0058 = m_u*m_N_3;
    ...
    const ccomplex_t IT_0063 = m_u*s_34*m_N_3;
