...
ccomplex_return_t c_sumSqAmpl_N_3_su_L_to_u_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0000*IT_0002*IT_0016;
    ...
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0000*IT_0002*IT_0016;
    ...
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
    ...
    const ccomplex_t IT_0240 = m_u*m_N_3;
    ...
    const ccomplex_t IT_0266 = m_u*m_N_3*IT_0265;
