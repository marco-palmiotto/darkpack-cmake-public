        ...
        )
{
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_3*
    ...
    const ccomplex_t IT_0077 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0078 = IT_0043*IT_0077;
    const ccomplex_t IT_0079 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0080 = IT_0040*IT_0079;
    const ccomplex_t IT_0081 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0088 = conj(N_B1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0089 = IT_0037*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0091 = IT_0046*IT_0090;
    const ccomplex_t IT_0092 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0093 = IT_0037*IT_0092;
    const ccomplex_t IT_0094 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0095 = IT_0046*IT_0094;
    const ccomplex_t IT_0096 = IT_0089 + IT_0091 + IT_0093 + IT_0095;
    const ccomplex_t IT_0097 = conj(N_B1)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0103 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0000*IT_0003*IT_0005;
    const ccomplex_t IT_0112 = (-0.5)*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_1*
    ...
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_4*
    ...
    const ccomplex_t IT_0231 = IT_0032*IT_0227;
    const ccomplex_t IT_0232 = IT_0030*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = m_u*IT_0233;
    const ccomplex_t IT_0235 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
    ...
    const ccomplex_t IT_0257 = m_N_3*IT_0137;
    ...
    const ccomplex_t IT_0271 = m_N_3*IT_0215;
    const ccomplex_t IT_0272 = m_N_4*IT_0193;
    ...
    const ccomplex_t IT_0282 = IT_0170*IT_0281;
    ...
    const ccomplex_t IT_0289 = IT_0049*IT_0241;
    const ccomplex_t IT_0290 = IT_0086*IT_0255;
    const ccomplex_t IT_0291 = IT_0137*IT_0269;
    const ccomplex_t IT_0292 = IT_0215*IT_0283;
    const ccomplex_t IT_0293 = -IT_0035 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_u*s_14;
    const ccomplex_t IT_0295 = IT_0172*IT_0193;
    const ccomplex_t IT_0296 = IT_0059*IT_0064;
    const ccomplex_t IT_0297 = IT_0108*IT_0115;
