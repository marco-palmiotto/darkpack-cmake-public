...
ccomplex_return_t c_sumSqAmpl_N_3_su_L_to_u_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_su_R*
    ...
    const ccomplex_t IT_0020 = cpow(IT_0008, -2);
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0003
      *IT_0005*IT_0013*IT_0018 + (-0.5)*m_W*(IT_0002*IT_0018 + -IT_0001*IT_0019)
      *(IT_0005 + -1./3*IT_0004*IT_0020));
    const ccomplex_t IT_0022 = -IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0000*IT_0003*IT_0005;
    const ccomplex_t IT_0024 = (-0.5)*IT_0023;
    const ccomplex_t IT_0025 = IT_0022*IT_0024;
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0013 + IT_0014 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = pow(m_su_L, 2);
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + IT_0013 + -IT_0014 + -IT_0029 
      + -reg_prop, -1);
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0003
      *IT_0005*IT_0018;
    const ccomplex_t IT_0032 = (-0.5)*IT_0031;
    const ccomplex_t IT_0033 = IT_0024*IT_0032;
    const ccomplex_t IT_0034 = IT_0030*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*IT_0034;
    const ccomplex_t IT_0036 = m_u*IT_0035;
    const ccomplex_t IT_0037 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0038 = IT_0024*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = IT_0001*IT_0009;
    const ccomplex_t IT_0041 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = IT_0009*IT_0018;
    const ccomplex_t IT_0044 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = IT_0001*IT_0005;
    const ccomplex_t IT_0047 = N_W3*N_d3*e_em;
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = IT_0005*IT_0018;
    const ccomplex_t IT_0050 = N_W3*N_u3*e_em;
    ...
    const ccomplex_t IT_0054 = conj(N_B3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0058 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*(IT_0055 + -IT_0057 + 
      -IT_0059 + IT_0061);
    ...
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_1*
    ...
    const ccomplex_t IT_0080 = N_B3*N_u1*e_em;
    const ccomplex_t IT_0081 = IT_0043*IT_0080;
    const ccomplex_t IT_0082 = N_W3*N_d1*e_em;
    const ccomplex_t IT_0083 = IT_0046*IT_0082;
    const ccomplex_t IT_0084 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0085 = IT_0043*IT_0084;
    const ccomplex_t IT_0086 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0095 = conj(N_W1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0096 = IT_0049*IT_0095;
    const ccomplex_t IT_0097 = conj(N_B3)*conj(N_d1)*e_em;
    const ccomplex_t IT_0098 = IT_0040*IT_0097;
    const ccomplex_t IT_0099 = conj(N_W3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0100 = IT_0049*IT_0099;
    const ccomplex_t IT_0101 = IT_0094 + IT_0096 + IT_0098 + IT_0100;
    const ccomplex_t IT_0102 = conj(N_B1)*conj(N_u3)*e_em;
    const ccomplex_t IT_0103 = IT_0043*IT_0102;
    const ccomplex_t IT_0104 = conj(N_W1)*conj(N_d3)*e_em;
    const ccomplex_t IT_0105 = IT_0046*IT_0104;
    const ccomplex_t IT_0106 = conj(N_B3)*conj(N_u1)*e_em;
    const ccomplex_t IT_0107 = IT_0043*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W3)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0114 = m_N_3*IT_0113;
    ...
    const ccomplex_t IT_0141 = conj(N_W2)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0145 = conj(N_W3)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0150 = conj(N_W2)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0154 = conj(N_W3)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0164 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_2*
    ...
    const ccomplex_t IT_0168 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0169 = IT_0040*IT_0168;
    const ccomplex_t IT_0170 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0171 = IT_0049*IT_0170;
    const ccomplex_t IT_0172 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0173 = IT_0040*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0175 = IT_0049*IT_0174;
    const ccomplex_t IT_0176 = IT_0169 + IT_0171 + IT_0173 + IT_0175;
    const ccomplex_t IT_0177 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0181 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0000*IT_0003*IT_0005;
    const ccomplex_t IT_0214 = (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = cpow((-2)*s_23 + IT_0013 + IT_0029 + -m_N_4*
    ...
    const ccomplex_t IT_0219 = IT_0017 + IT_0028 + (-2)*IT_0036 + IT_0065 +
       IT_0116 + IT_0167 + IT_0218;
    const ccomplex_t IT_0220 = conj(N_B4)*e_em;
    const ccomplex_t IT_0221 = IT_0009*IT_0220;
    const ccomplex_t IT_0222 = 1.4142135623731*IT_0221;
    const ccomplex_t IT_0223 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0228 = IT_0215*IT_0227;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = m_N_3*IT_0210;
    const ccomplex_t IT_0231 = m_N_4*IT_0188;
    const ccomplex_t IT_0232 = IT_0230 + IT_0231;
    const ccomplex_t IT_0233 = IT_0229*IT_0232;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
    ...
    const ccomplex_t IT_0279 = IT_0164*IT_0278;
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*IT_0279;
    const ccomplex_t IT_0281 = IT_0270*IT_0280;
    const ccomplex_t IT_0282 = IT_0022*IT_0246;
    const ccomplex_t IT_0283 = IT_0026*IT_0282;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*IT_0283;
    const ccomplex_t IT_0285 = -IT_0233 + -IT_0238 + -IT_0249 + 2*IT_0253 + 
      -IT_0267 + -IT_0281 + -IT_0284;
    const ccomplex_t IT_0286 = 6*s_13;
    const ccomplex_t IT_0287 = m_u*m_N_3;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0052*IT_0248;
    const ccomplex_t IT_0290 = IT_0137*IT_0280;
    const ccomplex_t IT_0291 = IT_0210*IT_0229;
    const ccomplex_t IT_0292 = IT_0091*IT_0266;
    const ccomplex_t IT_0293 = -IT_0035 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_u*s_14;
    const ccomplex_t IT_0295 = IT_0039*IT_0062;
    const ccomplex_t IT_0296 = IT_0070*IT_0113;
    const ccomplex_t IT_0297 = IT_0159*IT_0166;
    const ccomplex_t IT_0298 = IT_0188*IT_0217;
    const ccomplex_t IT_0299 = IT_0252 + -IT_0295 + -IT_0296 + -IT_0297 + 
      -IT_0298;
    ...
    const ccomplex_t IT_0304 = m_u*m_N_3*IT_0303;
