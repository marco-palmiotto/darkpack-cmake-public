        ...
        )
{
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0003*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0003*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0155 = (-2)*IT_0101 + -IT_0112 + IT_0115 + -IT_0116 +
       2*IT_0135 + 2*IT_0154;
    const ccomplex_t IT_0156 = m_u*m_N_3;
    ...
    const ccomplex_t IT_0206 = m_u*IT_0205;
    ...
    const ccomplex_t IT_0268 = m_u*IT_0230;
