...
ccomplex_return_t c_sumSqAmpl_N_3_su_L_to_u_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
    ...
    const ccomplex_t IT_0017 = m_u*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0019 = (-0.5)*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0040 = IT_0008*IT_0028;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0004*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0092 = N_W4*N_d3*e_em;
    ...
    const ccomplex_t IT_0107 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0108 = IT_0025*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0114 = conj(N_W3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0118 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0131 = N_B1*N_u3*e_em;
    const ccomplex_t IT_0132 = IT_0025*IT_0131;
    const ccomplex_t IT_0133 = N_B1*N_d3*e_em;
    ...
    const ccomplex_t IT_0140 = N_W1*N_u3*e_em;
    const ccomplex_t IT_0141 = IT_0037*IT_0140;
    const ccomplex_t IT_0142 = N_W1*N_d3*e_em;
    ...
    const ccomplex_t IT_0163 = IT_0037*IT_0162;
    ...
    const ccomplex_t IT_0171 = IT_0148 + IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0173 = (-0.5)*IT_0172;
    const ccomplex_t IT_0174 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0178 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0004
      *IT_0006*IT_0008*IT_0028;
    const ccomplex_t IT_0179 = (-0.5)*IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0024;
    const ccomplex_t IT_0181 = 0.666666666666667*IT_0180;
    const ccomplex_t IT_0182 = IT_0179*IT_0181;
    const ccomplex_t IT_0183 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_R*
    ...
    const ccomplex_t IT_0187 = cpow(IT_0023, -2);
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0004
      *IT_0006*IT_0008*IT_0011 + (-0.5)*m_W*(IT_0005*IT_0011 + IT_0028*IT_0186)*
      (IT_0008 + -1./3*IT_0007*IT_0187));
    const ccomplex_t IT_0189 = -IT_0188;
    const ccomplex_t IT_0190 = IT_0010*IT_0189;
    const ccomplex_t IT_0191 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0192 = IT_0190*IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1)*IT_0192;
    const ccomplex_t IT_0194 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0195 = IT_0010*IT_0194;
    const ccomplex_t IT_0196 = (0 + _Complex_I*1)*IT_0195;
    const ccomplex_t IT_0197 = conj(N_B3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0198 = IT_0025*IT_0197;
    const ccomplex_t IT_0199 = conj(N_B3)*conj(N_d3)*e_em;
    const ccomplex_t IT_0200 = IT_0029*IT_0199;
    const ccomplex_t IT_0201 = conj(N_W3)*conj(N_u3)*e_em;
    const ccomplex_t IT_0202 = IT_0037*IT_0201;
    const ccomplex_t IT_0203 = conj(N_W3)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0207 = m_N_3*IT_0206;
    const ccomplex_t IT_0208 = N_B3*N_u3*e_em;
    const ccomplex_t IT_0209 = IT_0025*IT_0208;
    const ccomplex_t IT_0210 = N_B3*N_d3*e_em;
    const ccomplex_t IT_0211 = IT_0029*IT_0210;
    const ccomplex_t IT_0212 = N_W3*N_u3*e_em;
    const ccomplex_t IT_0213 = IT_0037*IT_0212;
    const ccomplex_t IT_0214 = N_W3*N_d3*e_em;
    const ccomplex_t IT_0215 = IT_0040*IT_0214;
    ...
    const ccomplex_t IT_0221 = (-2)*IT_0017 + IT_0075 + IT_0126 + IT_0177 +
       IT_0185 + IT_0193 + IT_0220;
    ...
    const ccomplex_t IT_0243 = m_N_3*IT_0101;
    const ccomplex_t IT_0244 = m_N_4*IT_0123;
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = IT_0242*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0248 = 0.5*IT_0247;
    const ccomplex_t IT_0249 = IT_0179*IT_0248;
    const ccomplex_t IT_0250 = IT_0183*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*IT_0250;
    const ccomplex_t IT_0252 = IT_0194*IT_0229;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = IT_0219*IT_0253;
    const ccomplex_t IT_0255 = conj(N_B1)*e_em;
    const ccomplex_t IT_0256 = IT_0024*IT_0255;
    const ccomplex_t IT_0257 = 1.4142135623731*IT_0256;
    const ccomplex_t IT_0258 = conj(N_W1)*e_em;
    const ccomplex_t IT_0259 = IT_0008*IT_0258;
    const ccomplex_t IT_0260 = 1.4142135623731*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*(IT_0257 + 3*IT_0260);
    const ccomplex_t IT_0262 = 0.166666666666667*IT_0261;
    const ccomplex_t IT_0263 = IT_0174*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = m_N_3*IT_0147;
    const ccomplex_t IT_0266 = m_N_1*IT_0169;
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = IT_0264*IT_0267;
    const ccomplex_t IT_0269 = IT_0013*IT_0229;
    const ccomplex_t IT_0270 = IT_0003*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1)*IT_0270;
    const ccomplex_t IT_0272 = m_u*IT_0271;
    const ccomplex_t IT_0273 = m_N_3*IT_0050;
    const ccomplex_t IT_0274 = m_N_2*IT_0072;
    const ccomplex_t IT_0275 = IT_0273 + IT_0274;
    const ccomplex_t IT_0276 = conj(N_B2)*e_em;
    const ccomplex_t IT_0277 = IT_0024*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_W2)*e_em;
    const ccomplex_t IT_0280 = IT_0008*IT_0279;
    const ccomplex_t IT_0281 = 1.4142135623731*IT_0280;
    const ccomplex_t IT_0282 = (0 + _Complex_I*1)*(IT_0278 + 3*IT_0281);
    ...
    const ccomplex_t IT_0287 = -IT_0232 + -IT_0246 + -IT_0251 + -IT_0254 + 
      -IT_0268 + 2*IT_0272 + -IT_0286;
    const ccomplex_t IT_0288 = 6*s_13;
    const ccomplex_t IT_0289 = m_u*m_N_3;
    const ccomplex_t IT_0290 = 6*IT_0221;
    const ccomplex_t IT_0291 = IT_0147*IT_0264;
    const ccomplex_t IT_0292 = IT_0050*IT_0285;
    const ccomplex_t IT_0293 = IT_0217*IT_0253;
    const ccomplex_t IT_0294 = IT_0101*IT_0242;
    const ccomplex_t IT_0295 = -IT_0016 + IT_0291 + IT_0292 + IT_0293 + IT_0294;
    const ccomplex_t IT_0296 = m_u*s_14;
    const ccomplex_t IT_0297 = IT_0080*IT_0123;
    const ccomplex_t IT_0298 = IT_0196*IT_0206;
    const ccomplex_t IT_0299 = IT_0022*IT_0072;
    const ccomplex_t IT_0300 = IT_0169*IT_0176;
    const ccomplex_t IT_0301 = IT_0271 + -IT_0297 + -IT_0298 + -IT_0299 + 
      -IT_0300;
    ...
    const ccomplex_t IT_0306 = m_u*m_N_3*IT_0305;
