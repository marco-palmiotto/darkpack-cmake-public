...
ccomplex_return_t c_sumSqAmpl_N_3_su_R_to_d_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_ud*e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0006 = (-0.5)*IT_0005;
    const ccomplex_t IT_0007 = conj(N_W3)*e_em*V_Wp2;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = conj(N_u3)*V_u2*e_em;
    ...
    const ccomplex_t IT_0021 = conj(N_W3)*e_em*V_Wp1;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(N_u3)*V_u1*e_em;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
      *V_ud*e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0043 = IT_0020*IT_0034*IT_0042;
    const ccomplex_t IT_0044 = N_W3*e_em*conj(U_Wm2);
    const ccomplex_t IT_0045 = IT_0004*IT_0044;
    const ccomplex_t IT_0046 = N_d3*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0053 = IT_0017*IT_0051*IT_0052;
    const ccomplex_t IT_0054 = pow(m_u, 2);
    const ccomplex_t IT_0055 = pow(m_N_3, 2);
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + -IT_0016 + IT_0054 + -IT_0055 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0105 = s_14*IT_0015;
    ...
    const ccomplex_t IT_0144 = m_d*m_N_3;
