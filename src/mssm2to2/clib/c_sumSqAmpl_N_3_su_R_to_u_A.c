...
ccomplex_return_t c_sumSqAmpl_N_3_su_R_to_u_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_R*
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
    ...
    const ccomplex_t IT_0040 = m_u*s_14*m_N_3;
    ...
    const ccomplex_t IT_0052 = m_u*m_N_3;
    ...
    const ccomplex_t IT_0057 = m_u*s_34*m_N_3;
