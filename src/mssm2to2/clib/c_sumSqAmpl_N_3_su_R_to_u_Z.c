        ...
        )
{
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_1*
    ...
    const ccomplex_t IT_0089 = IT_0083 + 0.5*IT_0088;
    const ccomplex_t IT_0090 = IT_0013*IT_0087;
    ...
    const ccomplex_t IT_0094 = N_u2*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0118 = 0.5*IT_0090 + IT_0104 + IT_0117;
    ...
    const ccomplex_t IT_0155 = m_N_3*IT_0075;
    const ccomplex_t IT_0156 = -IT_0155;
    const ccomplex_t IT_0157 = IT_0154 + IT_0156;
    const ccomplex_t IT_0158 = IT_0082*IT_0157;
    ...
    const ccomplex_t IT_0166 = m_N_1*IT_0044;
    ...
    const ccomplex_t IT_0171 = m_N_2*IT_0060;
    const ccomplex_t IT_0172 = m_N_3*IT_0099;
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = IT_0171 + IT_0173;
    const ccomplex_t IT_0175 = IT_0103*IT_0174;
    ...
    const ccomplex_t IT_0181 = IT_0141*IT_0142*IT_0180;
    const ccomplex_t IT_0182 = IT_0085*IT_0146;
    const ccomplex_t IT_0183 = IT_0141*IT_0182;
    ...
    const ccomplex_t IT_0191 = (-0.5)*IT_0179 + IT_0181 + -IT_0185 + IT_0190;
    const ccomplex_t IT_0192 = m_N_2*IT_0099;
    const ccomplex_t IT_0193 = m_N_3*IT_0060;
    const ccomplex_t IT_0194 = -IT_0193;
    const ccomplex_t IT_0195 = IT_0192 + IT_0194;
    const ccomplex_t IT_0196 = IT_0065*IT_0195;
    const ccomplex_t IT_0197 = m_N_1*IT_0112;
    ...
    const ccomplex_t IT_0211 = 1.33333333333333*IT_0159;
    const ccomplex_t IT_0212 = cpow((-2)*s_13 + IT_0016 + IT_0140 + -m_su_R*
    ...
    const ccomplex_t IT_0216 = (-2)*IT_0083 + -IT_0088 + -IT_0215;
    ...
    const ccomplex_t IT_0228 = -IT_0090 + (-2)*IT_0104 + (-2)*IT_0117;
    ...
    const ccomplex_t IT_0235 = m_u*IT_0209;
    ...
    const ccomplex_t IT_0247 = 2*IT_0184 + IT_0215;
    ...
    const ccomplex_t IT_0261 = conj(IT_0118) + conj(IT_0184);
    const ccomplex_t IT_0262 = IT_0118 + IT_0184;
    ...
    const ccomplex_t IT_0317 = m_u*IT_0244;
    ...
    const ccomplex_t IT_0333 = (-0.166666666666667)*conj(IT_0184);
    ...
    const ccomplex_t IT_0338 = m_u*IT_0337;
    ...
    const ccomplex_t IT_0346 = (conj(IT_0036)*IT_0067 + IT_0036*conj(IT_0067) 
      ...
      *IT_0272 + conj(IT_0216)*IT_0281 + IT_0216*IT_0284)*IT_0324 + (conj
      ...
      (IT_0036) + -conj(IT_0067))*IT_0118 + (IT_0036 + -IT_0067)*conj(IT_0118) +
       (-0.166666666666667)*IT_0184*IT_0302 + conj(IT_0089)*IT_0329 + IT_0089
      *IT_0332 + IT_0301*IT_0333) + (-6)*conj(IT_0184)*(IT_0300*IT_0329 + -1./6
      *IT_0118*IT_0334 + -1./6*IT_0089*IT_0335 + IT_0277*IT_0340 + IT_0271
      *IT_0345) + (-6)*IT_0184*(IT_0300*IT_0332 + IT_0133*IT_0333 + -1./6*conj
