        ...
        )
{
    ...
    const ccomplex_t IT_0014 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0015 = IT_0013*IT_0014;
    const ccomplex_t IT_0016 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0017 = IT_0007*IT_0016;
    const ccomplex_t IT_0018 = N_W1*N_u4*e_em;
    ...
    const ccomplex_t IT_0022 = N_B4*N_u1*e_em;
    ...
    const ccomplex_t IT_0029 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0035 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0036 = IT_0007*IT_0035;
    const ccomplex_t IT_0037 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0038 = IT_0013*IT_0037;
    const ccomplex_t IT_0039 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0040 = IT_0007*IT_0039;
    const ccomplex_t IT_0041 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0046 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0047 = IT_0024*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0049 = IT_0021*IT_0048;
    const ccomplex_t IT_0050 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = IT_0056*IT_0059;
    const ccomplex_t IT_0061 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0062 = IT_0007*IT_0061;
    const ccomplex_t IT_0063 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0064 = IT_0013*IT_0063;
    const ccomplex_t IT_0065 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0066 = IT_0007*IT_0065;
    const ccomplex_t IT_0067 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0072 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0073 = IT_0024*IT_0072;
    const ccomplex_t IT_0074 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0075 = IT_0021*IT_0074;
    const ccomplex_t IT_0076 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0082 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0083 = IT_0007*IT_0082;
    const ccomplex_t IT_0084 = conj(N_W3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0093 = conj(N_W3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0126 = cpow((-2)*s_23 + IT_0000 + (0 + _Complex_I*1)
      *m_N_4*Gamma_o4 + reg_prop, -1);
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*IT_0126;
    const ccomplex_t IT_0128 = IT_0125*IT_0127;
    const ccomplex_t IT_0129 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
    ...
    const ccomplex_t IT_0158 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0159 = IT_0013*IT_0158;
    const ccomplex_t IT_0160 = IT_0153 + IT_0155 + IT_0157 + IT_0159;
    const ccomplex_t IT_0161 = N_B4*N_u2*e_em;
    const ccomplex_t IT_0162 = IT_0021*IT_0161;
    const ccomplex_t IT_0163 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0164 = IT_0024*IT_0163;
    const ccomplex_t IT_0165 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0166 = IT_0021*IT_0165;
    const ccomplex_t IT_0167 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0175 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*IT_0175;
    const ccomplex_t IT_0177 = IT_0103*IT_0176;
    const ccomplex_t IT_0178 = cpow((-2)*s_13 + IT_0000 + (0 + _Complex_I*1)
      *m_N_4*Gamma_o4 + reg_prop, -1);
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*IT_0178;
    const ccomplex_t IT_0180 = IT_0125*IT_0179;
    const ccomplex_t IT_0181 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*IT_0181;
    const ccomplex_t IT_0183 = IT_0173*IT_0182;
    const ccomplex_t IT_0184 = IT_0057 + -IT_0060 + IT_0106 + IT_0128 + 
      -IT_0174 + -IT_0177 + -IT_0180 + IT_0183;
    const ccomplex_t IT_0185 = cpow(IT_0124, 2);
    const ccomplex_t IT_0186 = m_N_4*IT_0185;
    const ccomplex_t IT_0187 = m_N_4*IT_0125;
    const ccomplex_t IT_0188 = IT_0186 + IT_0187;
    const ccomplex_t IT_0189 = IT_0127*IT_0188;
    const ccomplex_t IT_0190 = IT_0179*IT_0188;
    const ccomplex_t IT_0191 = IT_0007*IT_0118;
    const ccomplex_t IT_0192 = IT_0021*IT_0116;
    const ccomplex_t IT_0193 = IT_0024*IT_0122;
    const ccomplex_t IT_0194 = IT_0013*IT_0120;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*(IT_0191 + IT_0192 + 
      -IT_0193 + -IT_0194);
    const ccomplex_t IT_0196 = -IT_0195;
    const ccomplex_t IT_0197 = cpow(IT_0005, -2);
    const ccomplex_t IT_0198 = IT_0011*IT_0197;
    const ccomplex_t IT_0199 = IT_0012 + IT_0198;
    const ccomplex_t IT_0200 = cos(beta);
    const ccomplex_t IT_0201 = cpow(IT_0010, 3);
    const ccomplex_t IT_0202 = sin(beta);
    const ccomplex_t IT_0203 = cpow(IT_0010, 2);
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*m_W*e_em*IT_0199*(IT_0200
      *IT_0201 + 5*IT_0004*((-1)*IT_0004*(IT_0010*IT_0200 + 1./5*IT_0004*IT_0202
      ) + IT_0202*IT_0203));
    const ccomplex_t IT_0205 = (-0.5)*IT_0204;
    const ccomplex_t IT_0206 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0210 = m_N_4*IT_0056;
    const ccomplex_t IT_0211 = cpow(IT_0055, 2);
    const ccomplex_t IT_0212 = m_N_1*IT_0211;
    const ccomplex_t IT_0213 = IT_0210 + IT_0212;
    const ccomplex_t IT_0214 = IT_0059*IT_0213;
    const ccomplex_t IT_0215 = cpow(IT_0151, 2);
    const ccomplex_t IT_0216 = m_N_2*IT_0215;
    const ccomplex_t IT_0217 = m_N_4*IT_0173;
    const ccomplex_t IT_0218 = IT_0216 + IT_0217;
    const ccomplex_t IT_0219 = IT_0130*IT_0218;
    const ccomplex_t IT_0220 = cpow(IT_0004, 2);
    const ccomplex_t IT_0221 = (0 + _Complex_I*1)*m_W*e_em*IT_0199*(IT_0201
      *IT_0202 + -IT_0004*(IT_0004*IT_0010*IT_0202 + IT_0200*(IT_0203 + -IT_0220
      )));
    const ccomplex_t IT_0222 = (-1.5)*IT_0221;
    const ccomplex_t IT_0223 = cpow((-2)*s_12 + (-2)*IT_0001 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0224 = IT_0222*IT_0223;
    const ccomplex_t IT_0225 = (0 + _Complex_I*1)*IT_0224;
    const ccomplex_t IT_0226 = IT_0124*IT_0225;
    const ccomplex_t IT_0227 = IT_0003*IT_0213;
    const ccomplex_t IT_0228 = IT_0182*IT_0218;
    const ccomplex_t IT_0229 = cpow(IT_0102, 2);
    const ccomplex_t IT_0230 = m_N_3*IT_0229;
    const ccomplex_t IT_0231 = m_N_4*IT_0103;
    const ccomplex_t IT_0232 = IT_0230 + IT_0231;
    const ccomplex_t IT_0233 = IT_0176*IT_0232;
    const ccomplex_t IT_0234 = IT_0105*IT_0232;
    const ccomplex_t IT_0235 = IT_0189 + IT_0190 + -IT_0209 + IT_0214 +
       IT_0219 + -IT_0226 + IT_0227 + IT_0228 + IT_0233 + IT_0234;
    const ccomplex_t IT_0236 = s_24*m_N_4;
    const ccomplex_t IT_0237 = cpow(IT_0034, 2);
    const ccomplex_t IT_0238 = m_N_1*IT_0237;
    const ccomplex_t IT_0239 = IT_0210 + IT_0238;
    const ccomplex_t IT_0240 = IT_0003*IT_0239;
    const ccomplex_t IT_0241 = IT_0059*IT_0239;
    const ccomplex_t IT_0242 = IT_0007*IT_0109;
    const ccomplex_t IT_0243 = IT_0021*IT_0107;
    const ccomplex_t IT_0244 = IT_0024*IT_0113;
    const ccomplex_t IT_0245 = IT_0013*IT_0111;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*(IT_0242 + IT_0243 + 
      -IT_0244 + -IT_0245);
    const ccomplex_t IT_0247 = -IT_0246;
    const ccomplex_t IT_0248 = IT_0208*IT_0247;
    const ccomplex_t IT_0249 = IT_0115*IT_0225;
    const ccomplex_t IT_0250 = cpow(IT_0115, 2);
    const ccomplex_t IT_0251 = m_N_4*IT_0250;
    const ccomplex_t IT_0252 = IT_0187 + IT_0251;
    const ccomplex_t IT_0253 = IT_0127*IT_0252;
    const ccomplex_t IT_0254 = IT_0179*IT_0252;
    const ccomplex_t IT_0255 = cpow(IT_0172, 2);
    const ccomplex_t IT_0256 = m_N_2*IT_0255;
    const ccomplex_t IT_0257 = IT_0217 + IT_0256;
    const ccomplex_t IT_0258 = IT_0182*IT_0257;
    const ccomplex_t IT_0259 = IT_0130*IT_0257;
    const ccomplex_t IT_0260 = cpow(IT_0081, 2);
    const ccomplex_t IT_0261 = m_N_3*IT_0260;
    const ccomplex_t IT_0262 = IT_0231 + IT_0261;
    const ccomplex_t IT_0263 = IT_0176*IT_0262;
    const ccomplex_t IT_0264 = IT_0105*IT_0262;
    const ccomplex_t IT_0265 = IT_0240 + IT_0241 + -IT_0248 + -IT_0249 +
       IT_0253 + IT_0254 + IT_0258 + IT_0259 + IT_0263 + IT_0264;
    const ccomplex_t IT_0266 = s_14*m_N_4;
    const ccomplex_t IT_0267 = IT_0000*IT_0001;
    const ccomplex_t IT_0268 = s_12*IT_0000;
    const ccomplex_t IT_0269 = s_14*s_24;
    const ccomplex_t IT_0270 = (-2)*IT_0269;
    const ccomplex_t IT_0271 = IT_0268 + IT_0270;
    const ccomplex_t IT_0272 = 2*s_12;
    const ccomplex_t IT_0273 = (-2)*conj(IT_0265);
    const ccomplex_t IT_0274 = (-2)*IT_0184;
    const ccomplex_t IT_0275 = (-2)*IT_0184*(conj(IT_0235)*IT_0236 + -conj
      (IT_0265)*IT_0266 + conj(IT_0184)*IT_0267 + conj(IT_0184)*IT_0271) + (-2)
      *IT_0265*(IT_0001*conj(IT_0235) + conj(IT_0184)*IT_0236 + -conj(IT_0184)
      *IT_0266 + (-0.5)*conj(IT_0265)*IT_0272) + (-2)*IT_0235*(conj(IT_0184)
      *IT_0236 + -conj(IT_0184)*IT_0266 + (-0.5)*conj(IT_0235)*IT_0272 + (-0.5)
      *IT_0001*IT_0273) + 2*IT_0184*(conj(IT_0235)*IT_0266 + 0.5*IT_0236*IT_0273
      ) + (conj(IT_0184)*IT_0267 + conj(IT_0184)*IT_0271)*IT_0274;
