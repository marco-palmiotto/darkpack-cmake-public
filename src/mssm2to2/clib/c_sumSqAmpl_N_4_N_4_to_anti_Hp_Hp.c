        ...
        )
{
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_13 + IT_0000 + IT_0035 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0034*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = m_N_4*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0041 = cos(beta);
    const ccomplex_t IT_0042 = IT_0009*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = IT_0003*IT_0041;
    const ccomplex_t IT_0047 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0051 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0058 = IT_0036*IT_0040*IT_0057;
    ...
    const ccomplex_t IT_0072 = conj(N_u4)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0073 = IT_0046*IT_0072;
    const ccomplex_t IT_0074 = 2*IT_0073;
    const ccomplex_t IT_0075 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0076 = IT_0042*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0000 + IT_0035 + -m_C_1*
    ...
    const ccomplex_t IT_0106 = -IT_0039 + IT_0058 + IT_0088 + -IT_0105;
    const ccomplex_t IT_0107 = cos(alpha);
    const ccomplex_t IT_0108 = IT_0009*IT_0107;
    const ccomplex_t IT_0109 = N_B4*N_d4*e_em;
    const ccomplex_t IT_0110 = IT_0108*IT_0109;
    const ccomplex_t IT_0111 = sin(alpha);
    const ccomplex_t IT_0112 = IT_0009*IT_0111;
    const ccomplex_t IT_0113 = N_B4*N_u4*e_em;
    const ccomplex_t IT_0114 = IT_0112*IT_0113;
    const ccomplex_t IT_0115 = IT_0003*IT_0107;
    const ccomplex_t IT_0116 = N_W4*N_d4*e_em;
    const ccomplex_t IT_0117 = IT_0115*IT_0116;
    const ccomplex_t IT_0118 = IT_0003*IT_0111;
    const ccomplex_t IT_0119 = N_W4*N_u4*e_em;
    const ccomplex_t IT_0120 = IT_0118*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*(IT_0110 + -IT_0114 + 
      -IT_0117 + IT_0120);
    const ccomplex_t IT_0122 = -IT_0003;
    const ccomplex_t IT_0123 = cpow(IT_0008, -2);
    const ccomplex_t IT_0124 = IT_0002*IT_0123;
    const ccomplex_t IT_0125 = IT_0122 + IT_0124;
    const ccomplex_t IT_0126 = cpow(IT_0001, 3);
    const ccomplex_t IT_0127 = -IT_0041;
    const ccomplex_t IT_0128 = 3*IT_0003 + IT_0124;
    const ccomplex_t IT_0129 = cpow(IT_0001, 2);
    const ccomplex_t IT_0130 = (0 + _Complex_I*1)*m_W*e_em*(IT_0111*IT_0125
      *IT_0126 + IT_0127*(IT_0127*(IT_0041*IT_0107*IT_0125 + -IT_0001*IT_0111
      *IT_0128) + IT_0107*IT_0128*IT_0129));
    const ccomplex_t IT_0131 = 0.5*IT_0130;
    const ccomplex_t IT_0132 = cpow((-2)*s_12 + (-2)*IT_0000 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0136 = IT_0108*IT_0113;
    const ccomplex_t IT_0137 = IT_0109*IT_0112;
    const ccomplex_t IT_0138 = IT_0115*IT_0119;
    const ccomplex_t IT_0139 = IT_0116*IT_0118;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*(IT_0136 + IT_0137 + 
      -IT_0138 + -IT_0139);
    const ccomplex_t IT_0141 = -IT_0140;
    const ccomplex_t IT_0142 = -IT_0003 + IT_0124;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*m_W*e_em*(IT_0107*IT_0126
      *IT_0142 + IT_0041*(IT_0111*IT_0128*IT_0129 + -IT_0041*(IT_0001*IT_0107
      *IT_0128 + IT_0041*IT_0111*IT_0142)));
    const ccomplex_t IT_0144 = 0.5*IT_0143;
    const ccomplex_t IT_0145 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0162 = IT_0084*IT_0161;
    const ccomplex_t IT_0163 = cpow((-2)*s_23 + IT_0000 + IT_0035 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0167 = cpow((-2)*s_23 + IT_0000 + IT_0035 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0168 = N_u4*e_em*V_Wp2;
    const ccomplex_t IT_0169 = IT_0046*IT_0168;
    const ccomplex_t IT_0170 = 2*IT_0169;
    const ccomplex_t IT_0171 = N_B4*V_u2*e_em;
    const ccomplex_t IT_0172 = IT_0042*IT_0171;
    const ccomplex_t IT_0173 = 1.4142135623731*IT_0172;
    const ccomplex_t IT_0174 = N_W4*V_u2*e_em;
    ...
    const ccomplex_t IT_0182 = IT_0167*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*IT_0182;
    const ccomplex_t IT_0184 = m_N_4*IT_0183;
    const ccomplex_t IT_0185 = IT_0101*IT_0161;
    const ccomplex_t IT_0186 = IT_0086*IT_0163*IT_0185;
    const ccomplex_t IT_0187 = IT_0033*IT_0180;
    const ccomplex_t IT_0188 = IT_0040*IT_0167*IT_0187;
    const ccomplex_t IT_0189 = (0 + _Complex_I*-1)*e_em*(IT_0003*IT_0008 + 
      -IT_0002*IT_0009);
    const ccomplex_t IT_0190 = IT_0002*IT_0009;
    const ccomplex_t IT_0191 = N_u4*conj(N_u4)*e_em;
    const ccomplex_t IT_0192 = IT_0190*IT_0191;
    const ccomplex_t IT_0193 = IT_0003*IT_0008;
    const ccomplex_t IT_0194 = IT_0191*IT_0193;
    const ccomplex_t IT_0195 = N_d4*conj(N_d4)*e_em;
    const ccomplex_t IT_0196 = IT_0190*IT_0195;
    const ccomplex_t IT_0197 = IT_0193*IT_0195;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1)*(IT_0192 + IT_0194 + 
      -IT_0196 + -IT_0197);
    const ccomplex_t IT_0199 = (-0.5)*IT_0198;
    const ccomplex_t IT_0200 = IT_0189*IT_0199;
    const ccomplex_t IT_0201 = m_N_4*IT_0200;
    const ccomplex_t IT_0202 = 0.5*IT_0189;
    const ccomplex_t IT_0203 = 0.5*IT_0198;
    const ccomplex_t IT_0204 = IT_0202*IT_0203;
    const ccomplex_t IT_0205 = m_N_4*IT_0204;
    const ccomplex_t IT_0206 = IT_0201 + IT_0205;
    const ccomplex_t IT_0207 = IT_0199*IT_0202;
    const ccomplex_t IT_0208 = m_N_4*IT_0207;
    const ccomplex_t IT_0209 = IT_0189*IT_0203;
    const ccomplex_t IT_0210 = m_N_4*IT_0209;
    const ccomplex_t IT_0211 = -IT_0208 + -IT_0210;
    const ccomplex_t IT_0212 = IT_0206 + IT_0211;
    const ccomplex_t IT_0213 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
      *Gamma_Z) + (-2)*IT_0000 + -reg_prop, -1);
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*IT_0213;
    const ccomplex_t IT_0215 = IT_0212*IT_0214;
    const ccomplex_t IT_0216 = -IT_0135 + -IT_0148 + IT_0166 + IT_0184 + 
      -IT_0186 + -IT_0188 + IT_0215;
    const ccomplex_t IT_0217 = 2*IT_0216;
    const ccomplex_t IT_0218 = IT_0086*IT_0087*IT_0185;
    const ccomplex_t IT_0219 = IT_0087*IT_0162;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*IT_0219;
    const ccomplex_t IT_0221 = m_N_4*IT_0220;
    const ccomplex_t IT_0222 = IT_0036*IT_0181;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = m_N_4*IT_0223;
    const ccomplex_t IT_0225 = IT_0036*IT_0040*IT_0187;
    const ccomplex_t IT_0226 = IT_0218 + -IT_0221 + -IT_0224 + IT_0225;
    ...
    const ccomplex_t IT_0232 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0233 = IT_0108*IT_0232;
    const ccomplex_t IT_0234 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0235 = IT_0112*IT_0234;
    const ccomplex_t IT_0236 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0237 = IT_0115*IT_0236;
    const ccomplex_t IT_0238 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0239 = IT_0118*IT_0238;
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*(IT_0233 + -IT_0235 + 
      -IT_0237 + IT_0239);
    const ccomplex_t IT_0241 = IT_0134*IT_0240;
    const ccomplex_t IT_0242 = IT_0102*IT_0163;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*IT_0242;
    const ccomplex_t IT_0244 = m_N_4*IT_0243;
    const ccomplex_t IT_0245 = IT_0040*IT_0057*IT_0167;
    const ccomplex_t IT_0246 = IT_0085*IT_0086*IT_0163;
    const ccomplex_t IT_0247 = IT_0108*IT_0234;
    const ccomplex_t IT_0248 = IT_0112*IT_0232;
    const ccomplex_t IT_0249 = IT_0115*IT_0238;
    const ccomplex_t IT_0250 = IT_0118*IT_0236;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1)*(IT_0247 + IT_0248 + 
      -IT_0249 + -IT_0250);
    const ccomplex_t IT_0252 = -IT_0251;
    const ccomplex_t IT_0253 = IT_0147*IT_0252;
    const ccomplex_t IT_0254 = IT_0034*IT_0167;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*IT_0254;
    const ccomplex_t IT_0256 = m_N_4*IT_0255;
    const ccomplex_t IT_0257 = -IT_0215 + -IT_0241 + IT_0244 + -IT_0245 + 
      -IT_0246 + -IT_0253 + IT_0256;
    ...
    const ccomplex_t IT_0266 = s_23*m_N_4;
    const ccomplex_t IT_0267 = IT_0200*IT_0214;
    const ccomplex_t IT_0268 = -IT_0243 + -IT_0255 + IT_0267;
    const ccomplex_t IT_0269 = IT_0220 + IT_0223;
    const ccomplex_t IT_0270 = conj(IT_0268) + conj(IT_0269);
    const ccomplex_t IT_0271 = IT_0268 + IT_0269;
    const ccomplex_t IT_0272 = IT_0209*IT_0214;
    const ccomplex_t IT_0273 = -IT_0165 + -IT_0183 + IT_0272;
    const ccomplex_t IT_0274 = IT_0038 + IT_0104;
    ...
    const ccomplex_t IT_0281 = s_13*m_N_4;
    ...
    const ccomplex_t IT_0286 = s_12*IT_0035;
    const ccomplex_t IT_0287 = s_13*s_23;
    const ccomplex_t IT_0288 = (-2)*IT_0287;
    const ccomplex_t IT_0289 = IT_0286 + IT_0288;
    const ccomplex_t IT_0290 = (-2)*IT_0273;
    const ccomplex_t IT_0291 = (-2)*conj(IT_0273);
    const ccomplex_t IT_0292 = (-2)*IT_0268;
    const ccomplex_t IT_0293 = (-2)*conj(IT_0268);
    const ccomplex_t IT_0294 = (-2)*IT_0274;
    const ccomplex_t IT_0295 = IT_0000*IT_0035;
    const ccomplex_t IT_0296 = IT_0000*(conj(IT_0106)*IT_0228 + IT_0106
      ...
      *IT_0270 + IT_0263*IT_0271 + IT_0275*(IT_0276 + IT_0277) + IT_0278*
      ...
      (IT_0275*IT_0290 + IT_0274*IT_0291 + IT_0270*IT_0292 + (-2)*IT_0269*(conj
      (IT_0269) + (-0.5)*IT_0293) + conj(IT_0274)*IT_0294) + (IT_0269*IT_0291 +
       conj(IT_0273)*IT_0292 + (-2)*conj(IT_0274)*(IT_0269 + (-0.5)*IT_0292) +
       IT_0278*IT_0293 + conj(IT_0269)*(IT_0290 + IT_0294))*IT_0295;
