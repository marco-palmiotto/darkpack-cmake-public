        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
    ...
    const ccomplex_t IT_0336 = m_c*s_13*m_N_4;
    ...
    const ccomplex_t IT_0360 = m_c*s_14*m_N_4;
    ...
    const ccomplex_t IT_0382 = m_c*s_23*m_N_4;
    ...
    const ccomplex_t IT_0405 = 48*IT_0185;
    const ccomplex_t IT_0406 = IT_0404 + IT_0405;
    const ccomplex_t IT_0407 = 48*conj(IT_0154);
    const ccomplex_t IT_0408 = 48*conj(IT_0151);
    const ccomplex_t IT_0409 = 48*IT_0151;
    const ccomplex_t IT_0410 = 24*IT_0165;
    const ccomplex_t IT_0411 = conj(IT_0276)*IT_0345 + conj(IT_0287)*IT_0357 +
       conj(IT_0176)*IT_0364 + conj(IT_0165)*IT_0387 + conj(IT_0154)*IT_0404 +
       conj(IT_0185)*IT_0406 + IT_0185*IT_0407 + IT_0190*IT_0408 + conj(IT_0151)
      *(IT_0409 + IT_0410) + conj(IT_0190)*(48*IT_0190 + IT_0409 + IT_0410);
    const ccomplex_t IT_0412 = m_c*s_24*m_N_4;
    ...
    const ccomplex_t IT_0429 = 24*conj(IT_0176);
    const ccomplex_t IT_0430 = 48*IT_0186;
    const ccomplex_t IT_0431 = conj(IT_0042)*IT_0340 + IT_0042*IT_0344 + conj
      (IT_0249)*IT_0353 + IT_0249*IT_0356 + conj(IT_0165)*IT_0364 + IT_0165
      *IT_0368 + conj(IT_0287)*IT_0376 + IT_0287*IT_0378 + conj(IT_0151)*IT_0404
       + conj(IT_0190)*IT_0406 + IT_0185*IT_0408 + conj(IT_0185)*IT_0409 + conj
      (IT_0096)*IT_0414 + conj(IT_0145)*IT_0424 + IT_0316*IT_0425 + IT_0186
      *IT_0426 + conj(IT_0186)*(IT_0427 + IT_0428) + IT_0151*(IT_0407 + IT_0429)
       + IT_0190*(48*conj(IT_0185) + IT_0407 + IT_0429) + conj(IT_0189)*(IT_0422
       + IT_0423 + IT_0430);
    const ccomplex_t IT_0432 = 24*IT_0042;
    const ccomplex_t IT_0433 = IT_0427 + IT_0432;
    const ccomplex_t IT_0434 = conj(IT_0096)*IT_0340 + conj(IT_0206)*IT_0352 +
       ...
       IT_0430) + conj(IT_0145)*IT_0433 + conj(IT_0189)*(IT_0428 + IT_0433);
    const ccomplex_t IT_0435 = -IT_0196;
    const ccomplex_t IT_0436 = IT_0195 + IT_0197 + IT_0435;
    const ccomplex_t IT_0437 = 0.166666666666667*conj(IT_0276);
    const ccomplex_t IT_0438 = 6*conj(IT_0076);
    const ccomplex_t IT_0439 = (-6)*conj(IT_0078);
    const ccomplex_t IT_0440 = IT_0438 + IT_0439;
    const ccomplex_t IT_0441 = (-6)*IT_0078;
    const ccomplex_t IT_0442 = (-6)*conj(IT_0116);
    ...
    const ccomplex_t IT_0447 = IT_0027*IT_0394;
    const ccomplex_t IT_0448 = 6*conj(IT_0078);
    const ccomplex_t IT_0449 = (-6)*conj(IT_0076);
    const ccomplex_t IT_0450 = IT_0448 + IT_0449;
    const ccomplex_t IT_0451 = 6*conj(IT_0116);
    const ccomplex_t IT_0452 = (-6)*conj(IT_0114);
    const ccomplex_t IT_0453 = IT_0451 + IT_0452;
    const ccomplex_t IT_0454 = 6*IT_0116;
    const ccomplex_t IT_0455 = (-6)*IT_0114;
    ...
    const ccomplex_t IT_0458 = (conj(IT_0076) + -conj(IT_0078))*(IT_0114 + 
      ...
      (IT_0206 + 0.166666666666667*IT_0396) + 0.0416666666666667*IT_0249*IT_0440
       + 0.0416666666666667*conj(IT_0249)*IT_0441 + 0.0416666666666667*IT_0206
      *IT_0442 + 0.0416666666666667*conj(IT_0206)*IT_0445 + 0.0416666666666667
      *IT_0287*IT_0450 + 0.0416666666666667*IT_0276*IT_0453 + 0.25*IT_0437
      *IT_0456 + 0.25*IT_0446*IT_0457;
    const ccomplex_t IT_0459 = (-0.166666666666667)*IT_0249;
    const ccomplex_t IT_0460 = (-0.166666666666667)*conj(IT_0249);
    const ccomplex_t IT_0461 = IT_0027*IT_0398;
    const ccomplex_t IT_0462 = IT_0282*IT_0287 + IT_0279*conj(IT_0287) + (-6)
      ...
      *IT_0377 + 0.0416666666666667*IT_0401) + (-6)*IT_0242*IT_0459 + (-6)
      *IT_0239*IT_0460;
    const ccomplex_t IT_0463 = IT_0004*(conj(IT_0042)*IT_0080 + IT_0042
      ...
      *IT_0431 + IT_0195*IT_0434 + 6*IT_0436*(conj(IT_0249)*IT_0287 + IT_0249
      *conj(IT_0287) + 0.166666666666667*IT_0276*IT_0377 + IT_0375*IT_0437) + 
      (IT_0194 + IT_0195 + IT_0198 + IT_0435)*(IT_0276*IT_0440 + 6*conj(IT_0276)
      *(IT_0076 + 0.166666666666667*IT_0441) + 6*IT_0287*(conj(IT_0114) +
       0.166666666666667*IT_0442) + 6*IT_0445*IT_0446) + 24*IT_0447*IT_0458 + 
      (IT_0194 + IT_0197 + IT_0270 + IT_0435)*(IT_0206*IT_0450 + (-6)*conj
      (IT_0206)*(IT_0076 + (-0.166666666666667)*IT_0457) + (-6)*IT_0453*IT_0459 
      + (-6)*IT_0456*IT_0460) + IT_0461*IT_0462;
