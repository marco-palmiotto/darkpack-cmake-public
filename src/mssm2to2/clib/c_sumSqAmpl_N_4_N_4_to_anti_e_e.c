        ...
        )
{
    ...
    const ccomplex_t IT_0154 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0155 = IT_0086*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*IT_0155;
    const ccomplex_t IT_0157 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    ...
    const ccomplex_t IT_0202 = IT_0055*IT_0201;
    const ccomplex_t IT_0203 = -IT_0195 + -IT_0198 + IT_0200 + IT_0202;
    const ccomplex_t IT_0204 = m_e*e_em*IT_0011*IT_0031;
    ...
    const ccomplex_t IT_0211 = IT_0049*IT_0194;
    const ccomplex_t IT_0212 = IT_0045*IT_0197;
    const ccomplex_t IT_0213 = IT_0055*IT_0199;
    const ccomplex_t IT_0214 = IT_0052*IT_0201;
    const ccomplex_t IT_0215 = -IT_0211 + IT_0212 + IT_0213 + -IT_0214;
    const ccomplex_t IT_0216 = m_e*e_em*IT_0011*IT_0031*IT_0033*IT_0196;
    ...
    const ccomplex_t IT_0237 = IT_0095*IT_0194;
    const ccomplex_t IT_0238 = IT_0097*IT_0197;
    const ccomplex_t IT_0239 = IT_0099*IT_0199;
    const ccomplex_t IT_0240 = IT_0101*IT_0201;
    const ccomplex_t IT_0241 = IT_0237 + IT_0238 + -IT_0239 + -IT_0240;
    const ccomplex_t IT_0242 = IT_0209*IT_0241;
    const ccomplex_t IT_0243 = IT_0097*IT_0194;
    const ccomplex_t IT_0244 = IT_0095*IT_0197;
    const ccomplex_t IT_0245 = IT_0101*IT_0199;
    const ccomplex_t IT_0246 = IT_0099*IT_0201;
    ...
    const ccomplex_t IT_0323 = -IT_0183;
    const ccomplex_t IT_0324 = IT_0182 + IT_0184 + IT_0323;
    const ccomplex_t IT_0325 = 2*IT_0193;
    const ccomplex_t IT_0326 = 2*conj(IT_0193);
    const ccomplex_t IT_0327 = m_e*s_23*m_N_4;
    const ccomplex_t IT_0328 = 4*IT_0160;
    const ccomplex_t IT_0329 = 0.125*IT_0328;
    const ccomplex_t IT_0330 = IT_0311 + IT_0329;
    const ccomplex_t IT_0331 = 4*conj(IT_0160);
    ...
    const ccomplex_t IT_0341 = IT_0325 + IT_0340;
    const ccomplex_t IT_0342 = 4*conj(IT_0263);
    const ccomplex_t IT_0343 = IT_0326 + IT_0342;
    const ccomplex_t IT_0344 = 4*IT_0236;
    const ccomplex_t IT_0345 = 4*conj(IT_0236);
    const ccomplex_t IT_0346 = conj(IT_0160)*IT_0236 + IT_0160*conj(IT_0236) +
       4*conj(IT_0274)*IT_0330 + 4*IT_0274*IT_0333 + 4*IT_0283*IT_0336 + 4
      *IT_0287*IT_0339 + 0.5*conj(IT_0169)*IT_0341 + 0.5*IT_0169*IT_0343 + 0.5
      *IT_0307*IT_0344 + 0.5*IT_0311*IT_0345;
    const ccomplex_t IT_0347 = s_34 + IT_0026;
    const ccomplex_t IT_0348 = s_12*IT_0347;
    const ccomplex_t IT_0349 = (-8)*IT_0224;
    const ccomplex_t IT_0350 = (-8)*conj(IT_0224);
    const ccomplex_t IT_0351 = 2*conj(IT_0076);
    const ccomplex_t IT_0352 = (-2)*conj(IT_0077);
    const ccomplex_t IT_0353 = IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = 2*IT_0112;
    const ccomplex_t IT_0355 = (-2)*IT_0113;
    const ccomplex_t IT_0356 = IT_0354 + IT_0355;
    const ccomplex_t IT_0357 = (-2)*conj(IT_0113);
    const ccomplex_t IT_0358 = (-2)*IT_0077;
    const ccomplex_t IT_0359 = (-4)*IT_0003;
    const ccomplex_t IT_0360 = -s_34;
    const ccomplex_t IT_0361 = IT_0026 + IT_0360;
    const ccomplex_t IT_0362 = s_12*IT_0361;
    const ccomplex_t IT_0363 = (-8)*IT_0077;
    const ccomplex_t IT_0364 = (-4)*IT_0120;
    const ccomplex_t IT_0365 = m_e*s_13*m_N_4;
    const ccomplex_t IT_0366 = 4*conj(IT_0094);
    const ccomplex_t IT_0367 = 0.125*IT_0366;
    const ccomplex_t IT_0368 = IT_0291 + IT_0367;
    const ccomplex_t IT_0369 = 0.125*IT_0340;
    const ccomplex_t IT_0370 = IT_0193 + IT_0369;
    const ccomplex_t IT_0371 = 0.125*IT_0342;
    const ccomplex_t IT_0372 = conj(IT_0193) + IT_0371;
    const ccomplex_t IT_0373 = 2*IT_0263;
    const ccomplex_t IT_0374 = IT_0334 + IT_0373;
    const ccomplex_t IT_0375 = 2*conj(IT_0263);
    const ccomplex_t IT_0376 = IT_0337 + IT_0375;
    const ccomplex_t IT_0377 = 4*IT_0274;
    const ccomplex_t IT_0378 = 4*conj(IT_0274);
    const ccomplex_t IT_0379 = 4*IT_0094;
    const ccomplex_t IT_0380 = 0.125*IT_0379;
    const ccomplex_t IT_0381 = 0.125*conj(IT_0274)*IT_0318 + 0.125*IT_0274
      *IT_0319 + IT_0236*IT_0368 + IT_0299*IT_0370 + IT_0303*IT_0372 + 0.125
      *conj(IT_0042)*IT_0374 + 0.125*IT_0042*IT_0376 + 0.125*IT_0291*IT_0377 +
       0.125*IT_0295*IT_0378 + conj(IT_0236)*(IT_0295 + IT_0380);
    const ccomplex_t IT_0382 = m_e*s_14*m_N_4;
    const ccomplex_t IT_0383 = 4*conj(IT_0169);
    const ccomplex_t IT_0384 = 0.125*IT_0383;
    const ccomplex_t IT_0385 = IT_0283 + IT_0384;
    const ccomplex_t IT_0386 = 4*IT_0169;
    const ccomplex_t IT_0387 = 0.125*IT_0386;
    const ccomplex_t IT_0388 = 8*IT_0311;
    const ccomplex_t IT_0389 = 8*IT_0307;
    const ccomplex_t IT_0390 = 0.125*conj(IT_0236)*IT_0320 + 0.125*IT_0236
      *IT_0321 + 0.125*conj(IT_0160)*IT_0341 + 0.125*IT_0160*IT_0343 + 0.125
      *IT_0283*IT_0344 + 0.125*IT_0287*IT_0345 + IT_0274*IT_0385 + conj(IT_0274)
      *(IT_0287 + IT_0387) + 0.125*IT_0339*IT_0388 + 0.125*IT_0336*IT_0389;
    const ccomplex_t IT_0391 = s_34*IT_0027;
    const ccomplex_t IT_0392 = 8*IT_0149;
    const ccomplex_t IT_0393 = 0.125*IT_0392;
    const ccomplex_t IT_0394 = IT_0178 + IT_0387 + IT_0393;
    const ccomplex_t IT_0395 = 8*conj(IT_0149);
    const ccomplex_t IT_0396 = 0.125*IT_0395;
    const ccomplex_t IT_0397 = conj(IT_0178) + IT_0384 + IT_0396;
    const ccomplex_t IT_0398 = 4*IT_0042;
    const ccomplex_t IT_0399 = 4*conj(IT_0042);
    const ccomplex_t IT_0400 = 8*IT_0141;
    const ccomplex_t IT_0401 = 8*conj(IT_0141);
    const ccomplex_t IT_0402 = 8*IT_0295;
    const ccomplex_t IT_0403 = 8*IT_0291;
    const ccomplex_t IT_0404 = 0.125*conj(IT_0160)*IT_0318 + 0.125*IT_0160
      *IT_0319 + 0.125*conj(IT_0042)*IT_0320 + 0.125*IT_0042*IT_0321 + 0.125
      *IT_0311*IT_0366 + 0.125*IT_0307*IT_0379 + 0.125*conj(IT_0141)*(IT_0386 +
       IT_0392) + conj(IT_0176)*IT_0394 + 0.125*IT_0141*(IT_0383 + IT_0395) +
       IT_0176*IT_0397 + 0.125*IT_0283*IT_0398 + 0.125*IT_0287*IT_0399 + 0.125
      *conj(IT_0178)*IT_0400 + 0.125*IT_0178*IT_0401 + 0.125*IT_0333*IT_0402 +
       0.125*IT_0330*IT_0403;
    const ccomplex_t IT_0405 = IT_0027*IT_0361;
    const ccomplex_t IT_0406 = 2*conj(IT_0113);
    const ccomplex_t IT_0407 = (-2)*conj(IT_0112);
    const ccomplex_t IT_0408 = IT_0406 + IT_0407;
    const ccomplex_t IT_0409 = 2*conj(IT_0077);
    const ccomplex_t IT_0410 = (-2)*conj(IT_0076);
    const ccomplex_t IT_0411 = IT_0409 + IT_0410;
    const ccomplex_t IT_0412 = 0.125*IT_0274;
    const ccomplex_t IT_0413 = 2*IT_0077;
    const ccomplex_t IT_0414 = 0.125*conj(IT_0274);
    const ccomplex_t IT_0415 = 0.125*conj(IT_0193);
    const ccomplex_t IT_0416 = 2*IT_0113;
    const ccomplex_t IT_0417 = (-2)*IT_0112;
    const ccomplex_t IT_0418 = IT_0416 + IT_0417;
    const ccomplex_t IT_0419 = 0.125*conj(IT_0263);
    const ccomplex_t IT_0420 = 0.125*IT_0236;
    const ccomplex_t IT_0421 = 0.125*conj(IT_0236);
    const ccomplex_t IT_0422 = IT_0077*conj(IT_0113) + IT_0081*(IT_0112 +
       IT_0114) + IT_0076*(conj(IT_0112) + IT_0116 + 0.25*conj(IT_0236) + (-0.25
      )*conj(IT_0274)) + 0.125*IT_0193*IT_0357 + 0.25*conj(IT_0112)*(IT_0193 +
       0.5*IT_0363) + 0.125*IT_0263*IT_0408 + IT_0411*IT_0412 + IT_0413*IT_0414 
      + IT_0356*IT_0415 + IT_0418*IT_0419 + IT_0353*IT_0420 + IT_0358*IT_0421;
    const ccomplex_t IT_0423 = m_e*s_24*m_N_4;
    const ccomplex_t IT_0424 = 2*conj(IT_0042);
    const ccomplex_t IT_0425 = 2*IT_0042;
    const ccomplex_t IT_0426 = 0.125*IT_0398;
    const ccomplex_t IT_0427 = 0.125*IT_0399;
    const ccomplex_t IT_0428 = IT_0291*IT_0370 + IT_0295*IT_0372 + 0.125*conj
      (IT_0094)*IT_0374 + 0.125*IT_0094*IT_0376 + 0.125*IT_0299*IT_0377 + 0.125
      *IT_0303*IT_0378 + IT_0412*IT_0424 + IT_0414*IT_0425 + conj(IT_0236)*
      (IT_0303 + IT_0426) + IT_0236*(IT_0299 + IT_0427);
    const ccomplex_t IT_0429 = conj(IT_0169)*IT_0318 + IT_0169*IT_0319 +
       IT_0299*IT_0328 + IT_0303*IT_0331 + IT_0287*IT_0366 + IT_0283*IT_0379 +
       IT_0397*IT_0402 + IT_0394*IT_0403 + IT_0160*IT_0424 + conj(IT_0160)
      *IT_0425 + IT_0389*(IT_0176 + 0.125*IT_0400 + IT_0426) + IT_0388*(conj
      (IT_0176) + 0.125*IT_0401 + IT_0427);
    const ccomplex_t IT_0430 = IT_0026*IT_0027;
    const ccomplex_t IT_0431 = 16*IT_0149;
    const ccomplex_t IT_0432 = 0.125*IT_0431;
    const ccomplex_t IT_0433 = IT_0169 + IT_0432;
    const ccomplex_t IT_0434 = 16*IT_0178;
    const ccomplex_t IT_0435 = 0.125*IT_0434;
    const ccomplex_t IT_0436 = IT_0433 + IT_0435;
    const ccomplex_t IT_0437 = 16*conj(IT_0151);
    const ccomplex_t IT_0438 = 16*IT_0146;
    const ccomplex_t IT_0439 = 16*IT_0141;
    const ccomplex_t IT_0440 = 16*IT_0176;
    const ccomplex_t IT_0441 = 16*conj(IT_0146);
    const ccomplex_t IT_0442 = 0.125*IT_0178;
    const ccomplex_t IT_0443 = 16*conj(IT_0141);
    const ccomplex_t IT_0444 = 0.125*IT_0179;
    const ccomplex_t IT_0445 = 16*conj(IT_0149);
    const ccomplex_t IT_0446 = 0.125*IT_0445;
    const ccomplex_t IT_0447 = 16*IT_0151;
    const ccomplex_t IT_0448 = 0.125*IT_0447;
    const ccomplex_t IT_0449 = 2*IT_0179;
    const ccomplex_t IT_0450 = IT_0042*IT_0368 + conj(IT_0042)*(IT_0295 +
       IT_0380) + IT_0160*IT_0385 + conj(IT_0160)*(IT_0287 + IT_0387) + IT_0343
      *IT_0412 + IT_0341*IT_0414 + IT_0376*IT_0420 + IT_0374*IT_0421 + conj
      (IT_0146)*IT_0433 + conj(IT_0177)*IT_0436 + IT_0303*(conj(IT_0094) + 0.125
      *IT_0437) + 0.125*conj(IT_0178)*IT_0438 + 0.125*conj(IT_0179)*(IT_0439 +
       IT_0440) + IT_0441*IT_0442 + IT_0443*IT_0444 + IT_0146*(conj(IT_0169) +
       IT_0446) + IT_0177*(conj(IT_0169) + 2*conj(IT_0178) + IT_0446) + conj
      (IT_0141)*(IT_0094 + IT_0448) + conj(IT_0176)*(IT_0094 + IT_0448 + IT_0449);
    const ccomplex_t IT_0451 = 0.125*IT_0439;
    const ccomplex_t IT_0452 = IT_0042 + IT_0451;
    const ccomplex_t IT_0453 = conj(IT_0094)*(IT_0295 + IT_0380) + IT_0334
      *IT_0415 + IT_0344*IT_0421 + conj(IT_0042)*(IT_0303 + IT_0426) + 0.125
      *IT_0176*IT_0443 + IT_0437*IT_0444 + conj(IT_0151)*(IT_0094 + IT_0448) +
       conj(IT_0179)*(IT_0094 + IT_0448 + IT_0449) + conj(IT_0141)*IT_0452 +
       conj(IT_0176)*(0.125*IT_0440 + IT_0452);
    const ccomplex_t IT_0454 = 0.125*IT_0438;
    const ccomplex_t IT_0455 = conj(IT_0160)*IT_0330 + conj(IT_0169)*(IT_0287 
      + IT_0387) + IT_0377*IT_0414 + IT_0340*IT_0419 + conj(IT_0149)*IT_0433 +
       conj(IT_0178)*IT_0436 + 0.125*IT_0177*IT_0441 + IT_0442*IT_0445 + conj
      (IT_0146)*(IT_0160 + IT_0454) + conj(IT_0177)*(IT_0160 + 2*IT_0177 +
       IT_0454);
    const ccomplex_t IT_0456 = (-0.5)*IT_0236;
    const ccomplex_t IT_0457 = (-0.5)*conj(IT_0236);
    const ccomplex_t IT_0458 = IT_0027*IT_0347;
    const ccomplex_t IT_0459 = IT_0269*IT_0274 + IT_0266*conj(IT_0274) + 8
      *conj(IT_0249)*(IT_0222 + -1./4*IT_0263 + 0.125*IT_0325 + 0.125*IT_0349) +
       8*IT_0249*(conj(IT_0222) + -1./4*conj(IT_0263) + 0.125*IT_0326 + 0.125
      *IT_0350) + (-2)*conj(IT_0251)*(IT_0193 + 4*IT_0222 + (-4)*IT_0224 + (-0.5
      )*IT_0373) + (-2)*IT_0251*(conj(IT_0193) + 4*conj(IT_0222) + (-4)*conj
      (IT_0224) + (-0.5)*IT_0375) + (-2)*IT_0229*IT_0456 + (-2)*IT_0226*IT_0457;
    const ccomplex_t IT_0460 = IT_0004*(conj(IT_0042)*IT_0079 + IT_0042
      ...
      *IT_0226 + IT_0193*IT_0229 + conj(IT_0236)*IT_0253 + IT_0236*IT_0256) +
      ...
      + IT_0274*IT_0280) + IT_0282*IT_0315 + IT_0317*IT_0322 + 2*IT_0324*(conj
      (IT_0236)*IT_0274 + IT_0236*conj(IT_0274) + 0.5*conj(IT_0263)*IT_0325 +
       0.5*IT_0263*IT_0326) + 2*IT_0327*IT_0346 + 8*IT_0348*(IT_0224*conj
      (IT_0224) + (IT_0249 + -IT_0251)*(conj(IT_0249) + -conj(IT_0251)) + 0.125
      *conj(IT_0222)*IT_0349 + IT_0222*(conj(IT_0222) + 0.125*IT_0350)) + 
      (IT_0181 + IT_0182 + IT_0185 + IT_0323)*(IT_0263*IT_0353 + conj(IT_0274)
      *IT_0356 + 2*IT_0274*(conj(IT_0112) + 0.5*IT_0357) + 2*conj(IT_0263)*
      (IT_0076 + 0.5*IT_0358)) + (IT_0173*(IT_0176 + IT_0177) + IT_0171*(conj
      (IT_0176) + conj(IT_0177)) + IT_0162*(conj(IT_0178) + conj(IT_0179)) + 
      (conj(IT_0113) + IT_0163)*IT_0180)*IT_0359 + 8*IT_0362*(conj(IT_0076)
      *IT_0077 + -IT_0076*IT_0081 + -(IT_0112 + IT_0114)*(conj(IT_0112) +
       IT_0116) + 0.125*conj(IT_0077)*IT_0363) + (IT_0117*(IT_0141 + IT_0146) +
       IT_0115*(conj(IT_0141) + conj(IT_0146)) + IT_0079*(conj(IT_0149) + conj
      (IT_0151)) + (conj(IT_0076) + IT_0080)*IT_0152)*IT_0364 + 8*IT_0365
      *IT_0381 + 8*IT_0382*IT_0390 + 8*IT_0391*IT_0404 + 8*IT_0405*IT_0422 + 8
      *IT_0423*IT_0428 + IT_0181*IT_0429 + 8*IT_0430*IT_0450 + 8*IT_0182*IT_0453
       + 8*IT_0184*IT_0455 + (IT_0181 + IT_0184 + IT_0257 + IT_0323)*(IT_0193
      *IT_0411 + (-2)*conj(IT_0193)*(IT_0076 + (-0.5)*IT_0413) + (-2)*IT_0408
      *IT_0456 + (-2)*IT_0418*IT_0457) + IT_0458*IT_0459;
