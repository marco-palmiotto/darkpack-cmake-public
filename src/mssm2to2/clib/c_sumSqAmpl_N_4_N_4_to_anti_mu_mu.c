        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
    ...
    const ccomplex_t IT_0095 = conj(N_B4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0099 = conj(N_W4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0157 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0158 = IT_0086*IT_0157;
    const ccomplex_t IT_0159 = (0 + _Complex_I*1)*IT_0158;
    const ccomplex_t IT_0160 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    ...
    const ccomplex_t IT_0207 = e_em*m_mu*IT_0011*IT_0031*IT_0033*IT_0199;
    const ccomplex_t IT_0208 = (-0.5)*IT_0207;
    const ccomplex_t IT_0209 = cpow((-2)*s_12 + (-2)*IT_0027 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0213 = IT_0049*IT_0197;
    const ccomplex_t IT_0214 = IT_0045*IT_0200;
    const ccomplex_t IT_0215 = IT_0055*IT_0202;
    const ccomplex_t IT_0216 = IT_0052*IT_0204;
    const ccomplex_t IT_0217 = -IT_0213 + -IT_0214 + IT_0215 + IT_0216;
    const ccomplex_t IT_0218 = e_em*m_mu*IT_0011*IT_0031;
    const ccomplex_t IT_0219 = 0.5*IT_0218;
    const ccomplex_t IT_0220 = pow(m_Z, 2);
    const ccomplex_t IT_0221 = cpow((-2)*s_12 + (-2)*IT_0027 + IT_0220 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0225 = 0.5*IT_0212 + 0.5*IT_0224;
    const ccomplex_t IT_0226 = 2*IT_0225;
    const ccomplex_t IT_0227 = (-0.5)*IT_0212 + (-0.5)*IT_0224;
    ...
    const ccomplex_t IT_0245 = IT_0211*IT_0244;
    ...
    const ccomplex_t IT_0326 = m_mu*s_23*m_N_4;
    const ccomplex_t IT_0327 = 4*conj(IT_0196);
    const ccomplex_t IT_0328 = 0.125*IT_0327;
    const ccomplex_t IT_0329 = conj(IT_0266) + IT_0328;
    const ccomplex_t IT_0330 = 4*IT_0163;
    const ccomplex_t IT_0331 = 0.125*IT_0330;
    const ccomplex_t IT_0332 = IT_0314 + IT_0331;
    const ccomplex_t IT_0333 = 4*conj(IT_0163);
    const ccomplex_t IT_0334 = 0.125*IT_0333;
    const ccomplex_t IT_0335 = IT_0310 + IT_0334;
    const ccomplex_t IT_0336 = 2*IT_0196;
    const ccomplex_t IT_0337 = 4*IT_0266;
    const ccomplex_t IT_0338 = IT_0336 + IT_0337;
    const ccomplex_t IT_0339 = 2*conj(IT_0196);
    const ccomplex_t IT_0340 = 4*conj(IT_0266);
    const ccomplex_t IT_0341 = IT_0339 + IT_0340;
    const ccomplex_t IT_0342 = 4*IT_0196;
    const ccomplex_t IT_0343 = 4*IT_0239;
    const ccomplex_t IT_0344 = 4*conj(IT_0239);
    const ccomplex_t IT_0345 = conj(IT_0163)*IT_0239 + IT_0163*conj(IT_0239) +
       4*IT_0290*IT_0329 + 4*conj(IT_0277)*IT_0332 + 4*IT_0277*IT_0335 + 0.5
      *conj(IT_0172)*IT_0338 + 0.5*IT_0172*IT_0341 + 4*IT_0286*(IT_0266 + 0.125
      *IT_0342) + 0.5*IT_0310*IT_0343 + 0.5*IT_0314*IT_0344;
    const ccomplex_t IT_0346 = s_34 + IT_0026;
    const ccomplex_t IT_0347 = s_12*IT_0346;
    const ccomplex_t IT_0348 = (-8)*IT_0227;
    const ccomplex_t IT_0349 = (-8)*conj(IT_0227);
    const ccomplex_t IT_0350 = -s_34;
    const ccomplex_t IT_0351 = IT_0026 + IT_0350;
    const ccomplex_t IT_0352 = s_12*IT_0351;
    const ccomplex_t IT_0353 = (-8)*IT_0077;
    const ccomplex_t IT_0354 = 16*IT_0154;
    const ccomplex_t IT_0355 = 0.125*IT_0354;
    const ccomplex_t IT_0356 = IT_0094 + IT_0355;
    const ccomplex_t IT_0357 = 4*IT_0094;
    const ccomplex_t IT_0358 = 0.125*IT_0357;
    const ccomplex_t IT_0359 = IT_0298 + IT_0358;
    const ccomplex_t IT_0360 = 16*IT_0144;
    const ccomplex_t IT_0361 = 0.125*IT_0360;
    const ccomplex_t IT_0362 = IT_0042 + IT_0361;
    const ccomplex_t IT_0363 = 8*conj(IT_0144);
    const ccomplex_t IT_0364 = 16*conj(IT_0154);
    const ccomplex_t IT_0365 = 16*conj(IT_0144);
    const ccomplex_t IT_0366 = 2*IT_0180;
    const ccomplex_t IT_0367 = 4*IT_0042;
    const ccomplex_t IT_0368 = 0.125*IT_0367;
    const ccomplex_t IT_0369 = IT_0306 + IT_0368;
    const ccomplex_t IT_0370 = 8*conj(IT_0042);
    const ccomplex_t IT_0371 = 16*IT_0181;
    const ccomplex_t IT_0372 = 8*conj(IT_0181);
    const ccomplex_t IT_0373 = 0.125*conj(IT_0196)*IT_0342 + 0.125*conj
      (IT_0239)*IT_0343 + conj(IT_0154)*IT_0356 + conj(IT_0094)*IT_0359 + 0.125
      *IT_0362*IT_0363 + 0.125*IT_0180*IT_0364 + 0.125*IT_0181*IT_0365 + conj
      (IT_0180)*(IT_0094 + IT_0355 + IT_0366) + 0.125*IT_0369*IT_0370 + 0.125*
      (IT_0362 + 0.125*IT_0371)*IT_0372;
    const ccomplex_t IT_0374 = 16*IT_0152;
    const ccomplex_t IT_0375 = 0.125*IT_0374;
    const ccomplex_t IT_0376 = IT_0172 + IT_0375;
    const ccomplex_t IT_0377 = 4*IT_0172;
    const ccomplex_t IT_0378 = 0.125*IT_0377;
    const ccomplex_t IT_0379 = IT_0290 + IT_0378;
    const ccomplex_t IT_0380 = 4*IT_0277;
    const ccomplex_t IT_0381 = 16*conj(IT_0152);
    const ccomplex_t IT_0382 = 16*conj(IT_0149);
    const ccomplex_t IT_0383 = 8*conj(IT_0163);
    const ccomplex_t IT_0384 = 16*IT_0149;
    const ccomplex_t IT_0385 = 0.125*IT_0384;
    const ccomplex_t IT_0386 = IT_0163 + IT_0385;
    const ccomplex_t IT_0387 = 8*conj(IT_0149);
    const ccomplex_t IT_0388 = 16*IT_0182;
    const ccomplex_t IT_0389 = 8*conj(IT_0182);
    const ccomplex_t IT_0390 = 0.125*conj(IT_0266)*IT_0337 + conj(IT_0179)*
      (IT_0172 + 2*IT_0179 + IT_0375) + conj(IT_0152)*IT_0376 + conj(IT_0172)
      *IT_0379 + 0.125*conj(IT_0277)*IT_0380 + 0.125*IT_0179*IT_0381 + 0.125
      *IT_0182*IT_0382 + 0.125*IT_0332*IT_0383 + 0.125*IT_0386*IT_0387 + 0.125*
      (IT_0386 + 0.125*IT_0388)*IT_0389;
    const ccomplex_t IT_0391 = IT_0026*IT_0027;
    const ccomplex_t IT_0392 = 4*conj(IT_0172);
    const ccomplex_t IT_0393 = 0.125*IT_0392;
    const ccomplex_t IT_0394 = IT_0286 + IT_0393;
    const ccomplex_t IT_0395 = 4*conj(IT_0094);
    const ccomplex_t IT_0396 = 0.125*IT_0395;
    const ccomplex_t IT_0397 = IT_0294 + IT_0396;
    const ccomplex_t IT_0398 = 2*IT_0266;
    const ccomplex_t IT_0399 = IT_0342 + IT_0398;
    const ccomplex_t IT_0400 = 2*conj(IT_0266);
    const ccomplex_t IT_0401 = IT_0327 + IT_0400;
    const ccomplex_t IT_0402 = 8*IT_0306;
    const ccomplex_t IT_0403 = 8*IT_0314;
    const ccomplex_t IT_0404 = 0.125*conj(IT_0277)*IT_0338 + 0.125*IT_0277
      *IT_0341 + 0.125*IT_0356*IT_0363 + 0.125*IT_0180*IT_0365 + 0.125*IT_0359
      *IT_0370 + 0.125*conj(IT_0180)*(IT_0360 + IT_0371) + 0.125*(IT_0094 +
       IT_0355 + IT_0366)*IT_0372 + 0.125*IT_0179*IT_0382 + 0.125*IT_0379
      *IT_0383 + 0.125*IT_0376*IT_0387 + 0.125*conj(IT_0179)*(IT_0384 + IT_0388)
       + 0.125*(IT_0172 + 2*IT_0179 + IT_0375)*IT_0389 + IT_0163*IT_0394 +
       IT_0042*IT_0397 + 0.125*conj(IT_0239)*IT_0399 + 0.125*IT_0239*IT_0401 +
       0.125*(conj(IT_0094) + 0.125*IT_0364)*IT_0402 + 0.125*(conj(IT_0172) +
       0.125*IT_0381)*IT_0403;
    const ccomplex_t IT_0405 = m_mu*s_14*m_N_4;
    const ccomplex_t IT_0406 = 8*IT_0310;
    const ccomplex_t IT_0407 = 0.125*conj(IT_0239)*IT_0323 + 0.125*IT_0239
      *IT_0324 + 0.125*conj(IT_0163)*IT_0338 + 0.125*IT_0163*IT_0341 + 0.125
      *IT_0286*IT_0343 + 0.125*IT_0290*IT_0344 + conj(IT_0277)*IT_0379 + IT_0277
      *IT_0394 + 0.125*IT_0329*IT_0403 + 0.125*(IT_0266 + 0.125*IT_0342)*IT_0406;
    const ccomplex_t IT_0408 = s_34*IT_0027;
    const ccomplex_t IT_0409 = 8*conj(IT_0152);
    const ccomplex_t IT_0410 = 0.125*IT_0409;
    const ccomplex_t IT_0411 = conj(IT_0179) + IT_0393 + IT_0410;
    const ccomplex_t IT_0412 = 4*conj(IT_0042);
    const ccomplex_t IT_0413 = 8*IT_0152;
    const ccomplex_t IT_0414 = 8*IT_0144;
    const ccomplex_t IT_0415 = 0.125*IT_0413;
    const ccomplex_t IT_0416 = IT_0179 + IT_0378 + IT_0415;
    const ccomplex_t IT_0417 = 8*IT_0298;
    const ccomplex_t IT_0418 = 8*IT_0294;
    const ccomplex_t IT_0419 = 0.125*conj(IT_0163)*IT_0321 + 0.125*IT_0163
      *IT_0322 + 0.125*conj(IT_0042)*IT_0323 + 0.125*IT_0042*IT_0324 + 0.125
      *IT_0310*IT_0357 + 0.125*IT_0179*IT_0363 + 0.125*IT_0286*IT_0367 + 0.125
      *IT_0314*IT_0395 + 0.125*IT_0144*(IT_0392 + IT_0409) + IT_0181*IT_0411 +
       0.125*IT_0290*IT_0412 + 0.125*conj(IT_0144)*(IT_0377 + IT_0413) + 0.125
      *conj(IT_0179)*IT_0414 + 0.125*IT_0372*IT_0416 + 0.125*IT_0335*IT_0417 +
       0.125*IT_0332*IT_0418;
    const ccomplex_t IT_0420 = m_mu*s_13*m_N_4;
    const ccomplex_t IT_0421 = 4*conj(IT_0277);
    const ccomplex_t IT_0422 = 0.125*IT_0340;
    const ccomplex_t IT_0423 = conj(IT_0196) + IT_0422;
    const ccomplex_t IT_0424 = 0.125*IT_0337;
    const ccomplex_t IT_0425 = 0.125*conj(IT_0277)*IT_0321 + 0.125*IT_0277
      *IT_0322 + conj(IT_0239)*IT_0359 + 0.125*IT_0294*IT_0380 + IT_0239*IT_0397
       + 0.125*conj(IT_0042)*IT_0399 + 0.125*IT_0042*IT_0401 + 0.125*IT_0298
      *IT_0421 + 0.125*IT_0402*IT_0423 + IT_0302*(IT_0196 + IT_0424);
    const ccomplex_t IT_0426 = m_mu*s_24*m_N_4;
    const ccomplex_t IT_0427 = 2*IT_0042;
    const ccomplex_t IT_0428 = 2*conj(IT_0042);
    const ccomplex_t IT_0429 = 0.125*IT_0412;
    const ccomplex_t IT_0430 = conj(IT_0239)*IT_0369 + 0.125*IT_0302*IT_0380 +
       0.125*conj(IT_0094)*IT_0399 + 0.125*IT_0094*IT_0401 + 0.125*IT_0306
      *IT_0421 + IT_0298*IT_0423 + IT_0294*(IT_0196 + IT_0424) + 0.125*conj
      (IT_0277)*IT_0427 + 0.125*IT_0277*IT_0428 + IT_0239*(IT_0302 + IT_0429);
    const ccomplex_t IT_0431 = conj(IT_0172)*IT_0321 + IT_0172*IT_0322 +
       IT_0302*IT_0330 + IT_0306*IT_0333 + IT_0286*IT_0357 + IT_0290*IT_0395 +
       IT_0406*(IT_0181 + IT_0368 + 0.125*IT_0414) + IT_0411*IT_0417 + IT_0416
      *IT_0418 + conj(IT_0163)*IT_0427 + IT_0163*IT_0428 + IT_0403*(conj(IT_0181
      ) + 0.125*IT_0363 + IT_0429);
    const ccomplex_t IT_0432 = -IT_0186;
    const ccomplex_t IT_0433 = IT_0185 + IT_0187 + IT_0432;
    const ccomplex_t IT_0434 = 0.5*IT_0266;
    const ccomplex_t IT_0435 = (-2)*conj(IT_0113);
    const ccomplex_t IT_0436 = 0.5*IT_0435;
    const ccomplex_t IT_0437 = conj(IT_0112) + IT_0436;
    const ccomplex_t IT_0438 = (-2)*IT_0077;
    const ccomplex_t IT_0439 = 2*conj(IT_0076);
    const ccomplex_t IT_0440 = (-2)*conj(IT_0077);
    ...
    const ccomplex_t IT_0445 = 0.5*conj(IT_0277);
    const ccomplex_t IT_0446 = IT_0027*IT_0351;
    const ccomplex_t IT_0447 = 2*conj(IT_0077);
    const ccomplex_t IT_0448 = (-2)*conj(IT_0076);
    const ccomplex_t IT_0449 = IT_0447 + IT_0448;
    const ccomplex_t IT_0450 = 2*IT_0113;
    const ccomplex_t IT_0451 = (-2)*IT_0112;
    const ccomplex_t IT_0452 = IT_0450 + IT_0451;
    const ccomplex_t IT_0453 = 2*conj(IT_0113);
    const ccomplex_t IT_0454 = (-2)*conj(IT_0112);
    const ccomplex_t IT_0455 = IT_0453 + IT_0454;
    const ccomplex_t IT_0456 = 2*IT_0077;
    const ccomplex_t IT_0457 = IT_0077*conj(IT_0113) + IT_0081*(IT_0112 +
       IT_0114) + IT_0076*(conj(IT_0112) + -conj(IT_0113) + 1./4*conj(IT_0239) +
       -1./4*conj(IT_0277)) + 0.125*conj(IT_0112)*IT_0353 + 0.25*IT_0196*IT_0437
       + 0.125*conj(IT_0239)*IT_0438 + 0.125*IT_0239*IT_0441 + 0.125*conj
      (IT_0196)*IT_0444 + 0.125*IT_0277*IT_0449 + 0.125*conj(IT_0266)*IT_0452 +
       0.25*IT_0434*IT_0455 + 0.25*IT_0445*IT_0456;
    const ccomplex_t IT_0458 = (-0.5)*IT_0239;
    const ccomplex_t IT_0459 = (-0.5)*conj(IT_0239);
    const ccomplex_t IT_0460 = IT_0027*IT_0346;
    const ccomplex_t IT_0461 = IT_0272*IT_0277 + IT_0269*conj(IT_0277) + 8
      *conj(IT_0252)*(IT_0225 + -1./4*IT_0266 + 0.125*IT_0336 + 0.125*IT_0348) +
       8*IT_0252*(conj(IT_0225) + -1./4*conj(IT_0266) + 0.125*IT_0339 + 0.125
      *IT_0349) + (-2)*conj(IT_0254)*(IT_0196 + 4*IT_0225 + (-4)*IT_0227 + (-0.5
      )*IT_0398) + (-2)*IT_0254*(conj(IT_0196) + 4*conj(IT_0225) + (-4)*conj
      (IT_0227) + (-0.5)*IT_0400) + (-2)*IT_0232*IT_0458 + (-2)*IT_0229*IT_0459;
    const ccomplex_t IT_0462 = IT_0004*(conj(IT_0042)*IT_0079 + IT_0042
      ...
      *IT_0318 + IT_0320*IT_0325 + 2*IT_0326*IT_0345 + 8*IT_0347*(IT_0227*conj
      (IT_0227) + (IT_0252 + -IT_0254)*(conj(IT_0252) + -conj(IT_0254)) + 0.125
      *conj(IT_0225)*IT_0348 + IT_0225*(conj(IT_0225) + 0.125*IT_0349)) + 8
      *IT_0352*(conj(IT_0076)*IT_0077 + -IT_0076*IT_0081 + -(IT_0112 + IT_0114)
      *IT_0117 + 0.125*conj(IT_0077)*IT_0353) + 8*IT_0185*IT_0373 + 8*IT_0187
      *IT_0390 + 8*IT_0391*IT_0404 + 8*IT_0405*IT_0407 + 8*IT_0408*IT_0419 + 8
      *IT_0420*IT_0425 + 8*IT_0426*IT_0430 + IT_0184*IT_0431 + 2*IT_0433*(conj
      (IT_0239)*IT_0277 + IT_0239*conj(IT_0277) + 0.5*conj(IT_0266)*IT_0336 +
       IT_0339*IT_0434) + 2*(IT_0184 + IT_0185 + IT_0188 + IT_0432)*(IT_0277
      *IT_0437 + conj(IT_0266)*(IT_0076 + 0.5*IT_0438) + IT_0434*IT_0441 +
       IT_0444*IT_0445) + 8*IT_0446*IT_0457 + (IT_0184 + IT_0187 + IT_0260 +
       IT_0432)*(IT_0196*IT_0449 + (-2)*conj(IT_0196)*(IT_0076 + (-0.5)*IT_0456)
       + (-2)*IT_0455*IT_0458 + (-2)*IT_0452*IT_0459) + IT_0460*IT_0461;
