        ...
        )
{
    ...
    const ccomplex_t IT_0056 = s_34*IT_0022;
    ...
    const ccomplex_t IT_0062 = 4*conj(IT_0060);
    const ccomplex_t IT_0063 = (-0.5)*IT_0047;
    const ccomplex_t IT_0064 = 0.5*IT_0050;
    const ccomplex_t IT_0065 = conj(IT_0063) + conj(IT_0064);
    const ccomplex_t IT_0066 = 8*IT_0048;
    const ccomplex_t IT_0067 = IT_0063 + IT_0064;
    const ccomplex_t IT_0068 = 4*conj(IT_0026);
    const ccomplex_t IT_0069 = 8*conj(IT_0048);
    const ccomplex_t IT_0070 = conj(IT_0026)*IT_0060 + IT_0026*conj(IT_0060) +
       0.5*IT_0052*IT_0061 + 0.5*IT_0054*IT_0062 + 4*IT_0065*(IT_0051 + 0.125
      *IT_0053 + 0.125*IT_0066) + 4*IT_0067*(conj(IT_0051) + 0.125*IT_0068 +
       0.125*IT_0069);
    const ccomplex_t IT_0071 = s_13*s_24;
    const ccomplex_t IT_0072 = 8*conj(IT_0060);
    const ccomplex_t IT_0073 = 8*IT_0060;
    const ccomplex_t IT_0074 = 16*IT_0063;
    const ccomplex_t IT_0075 = 8*IT_0000*((IT_0026 + 2*IT_0048 + 2*IT_0051)
      *IT_0052 + 0.125*conj(IT_0026)*IT_0053 + 0.125*IT_0054*IT_0055) + 2
      *IT_0056*IT_0070 + IT_0071*(conj(IT_0060)*IT_0061 + IT_0067*IT_0072 +
       IT_0065*(16*IT_0064 + IT_0073 + IT_0074));
