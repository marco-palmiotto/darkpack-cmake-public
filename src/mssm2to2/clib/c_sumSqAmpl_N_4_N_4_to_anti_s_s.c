        ...
        )
{
    ...
    const ccomplex_t IT_0159 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0160 = IT_0088*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = cpow((-2)*s_23 + IT_0026 + IT_0027 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0217 = m_s*e_em*IT_0011*IT_0031;
    ...
    const ccomplex_t IT_0224 = IT_0045*IT_0207;
    ...
    const ccomplex_t IT_0229 = m_s*e_em*IT_0011*IT_0031*IT_0033*IT_0209;
    ...
    const ccomplex_t IT_0250 = IT_0099*IT_0207;
    ...
    const ccomplex_t IT_0256 = IT_0097*IT_0207;
    ...
    const ccomplex_t IT_0340 = m_s*s_13*m_N_4;
    ...
    const ccomplex_t IT_0364 = m_s*s_14*m_N_4;
    ...
    const ccomplex_t IT_0382 = m_s*s_23*m_N_4;
    ...
    const ccomplex_t IT_0440 = m_s*s_24*m_N_4;
