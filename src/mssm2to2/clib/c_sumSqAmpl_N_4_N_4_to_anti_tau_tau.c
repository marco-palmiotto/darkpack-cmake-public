        ...
        )
{
    ...
    const ccomplex_t IT_0005 = pow(m_N_4, 2);
    ...
    const ccomplex_t IT_0019 = N_d4*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0024 = conj(N_B4)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0025 = IT_0009*IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*IT_0025;
    const ccomplex_t IT_0027 = conj(N_d4)*e_em*m_tau*IT_0018*conj(U_stau_00);
    ...
    const ccomplex_t IT_0035 = cpow(s_23 + (-0.5)*IT_0005 + (-0.5)*IT_0006 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0036 = conj(N_B4)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0037 = IT_0009*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = conj(N_d4)*e_em*m_tau*IT_0018*conj(U_stau_01);
    ...
    const ccomplex_t IT_0044 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0045 = IT_0009*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = N_d4*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0068 = N_W4*N_d4*e_em;
    ...
    const ccomplex_t IT_0146 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0147 = IT_0057*IT_0146;
    const ccomplex_t IT_0148 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0149 = IT_0061*IT_0148;
    const ccomplex_t IT_0150 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0151 = IT_0064*IT_0150;
    const ccomplex_t IT_0152 = conj(N_W4)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0196 = IT_0009*IT_0015;
    const ccomplex_t IT_0197 = N_u4*conj(N_u4)*e_em;
    const ccomplex_t IT_0198 = IT_0196*IT_0197;
    const ccomplex_t IT_0199 = IT_0008*IT_0016;
    const ccomplex_t IT_0200 = IT_0197*IT_0199;
    const ccomplex_t IT_0201 = N_d4*conj(N_d4)*e_em;
    const ccomplex_t IT_0202 = IT_0196*IT_0201;
    const ccomplex_t IT_0203 = IT_0199*IT_0201;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*(IT_0198 + IT_0200 + 
      -IT_0202 + -IT_0203);
    const ccomplex_t IT_0205 = (-0.5)*IT_0204;
    const ccomplex_t IT_0206 = e_em*IT_0196;
    const ccomplex_t IT_0207 = e_em*IT_0199;
    ...
    const ccomplex_t IT_0247 = IT_0023*IT_0105;
    const ccomplex_t IT_0248 = IT_0174*IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*IT_0248;
    const ccomplex_t IT_0250 = IT_0051*IT_0130;
    ...
    const ccomplex_t IT_0260 = IT_0031*IT_0116;
    ...
    const ccomplex_t IT_0291 = IT_0062*IT_0275;
    const ccomplex_t IT_0292 = IT_0058*IT_0278;
    const ccomplex_t IT_0293 = IT_0068*IT_0280;
    const ccomplex_t IT_0294 = IT_0065*IT_0282;
    ...
    const ccomplex_t IT_0310 = IT_0146*IT_0275;
    const ccomplex_t IT_0311 = IT_0148*IT_0278;
    const ccomplex_t IT_0312 = IT_0150*IT_0280;
    const ccomplex_t IT_0313 = IT_0152*IT_0282;
    const ccomplex_t IT_0314 = IT_0310 + -IT_0311 + -IT_0312 + IT_0313;
    const ccomplex_t IT_0315 = IT_0289*IT_0314;
    const ccomplex_t IT_0316 = IT_0148*IT_0275;
    const ccomplex_t IT_0317 = IT_0146*IT_0278;
    const ccomplex_t IT_0318 = IT_0152*IT_0280;
    const ccomplex_t IT_0319 = IT_0150*IT_0282;
    ...
    const ccomplex_t IT_0343 = conj(IT_0226) + conj(IT_0231);
    const ccomplex_t IT_0344 = 4*IT_0336;
    const ccomplex_t IT_0345 = (-4)*IT_0303;
    const ccomplex_t IT_0346 = IT_0344 + IT_0345;
    const ccomplex_t IT_0347 = IT_0226 + IT_0231;
    const ccomplex_t IT_0348 = 4*conj(IT_0336);
    const ccomplex_t IT_0349 = (-4)*conj(IT_0303);
    ...
    const ccomplex_t IT_0359 = conj(IT_0219) + conj(IT_0235);
    const ccomplex_t IT_0360 = 4*IT_0322;
    const ccomplex_t IT_0361 = (-4)*IT_0329;
    const ccomplex_t IT_0362 = IT_0360 + IT_0361;
    const ccomplex_t IT_0363 = IT_0219 + IT_0235;
    const ccomplex_t IT_0364 = 4*conj(IT_0322);
    const ccomplex_t IT_0365 = (-4)*conj(IT_0329);
    ...
    const ccomplex_t IT_0378 = IT_0309*IT_0322 + IT_0306*conj(IT_0322) + conj
      ...
      (IT_0336) + conj(IT_0329)*IT_0339 + IT_0329*IT_0342 + IT_0354*IT_0359 +
       IT_0351*IT_0362 + IT_0358*IT_0363 + IT_0355*IT_0366 + IT_0346*IT_0367 +
       IT_0343*IT_0370 + IT_0350*IT_0371 + IT_0347*IT_0374;
    const ccomplex_t IT_0379 = IT_0007*IT_0247;
    const ccomplex_t IT_0380 = (0 + _Complex_I*1)*IT_0379;
    const ccomplex_t IT_0381 = IT_0035*IT_0250;
    ...
    const ccomplex_t IT_0395 = s_34*IT_0005;
    const ccomplex_t IT_0396 = 4*IT_0145;
    const ccomplex_t IT_0397 = 0.125*IT_0396;
    const ccomplex_t IT_0398 = IT_0355 + IT_0397;
    const ccomplex_t IT_0399 = 4*conj(IT_0145);
    const ccomplex_t IT_0400 = 0.125*IT_0399;
    const ccomplex_t IT_0401 = IT_0351 + IT_0400;
    const ccomplex_t IT_0402 = 4*IT_0180;
    const ccomplex_t IT_0403 = 0.125*IT_0402;
    const ccomplex_t IT_0404 = IT_0347 + IT_0403;
    const ccomplex_t IT_0405 = 4*conj(IT_0180);
    const ccomplex_t IT_0406 = 0.125*IT_0405;
    const ccomplex_t IT_0407 = IT_0343 + IT_0406;
    const ccomplex_t IT_0408 = 4*IT_0055;
    const ccomplex_t IT_0409 = 4*conj(IT_0055);
    const ccomplex_t IT_0410 = 4*IT_0189;
    const ccomplex_t IT_0411 = 4*conj(IT_0189);
    const ccomplex_t IT_0412 = 0.125*conj(IT_0145)*IT_0330 + 0.125*IT_0145
      *IT_0333 + 0.125*conj(IT_0055)*IT_0337 + 0.125*IT_0055*IT_0340 + IT_0367
      *IT_0398 + IT_0371*IT_0401 + IT_0359*IT_0404 + IT_0363*IT_0407 + 0.125
      *IT_0343*IT_0408 + 0.125*IT_0347*IT_0409 + 0.125*IT_0351*IT_0410 + 0.125
      *IT_0355*IT_0411;
    const ccomplex_t IT_0413 = IT_0005*IT_0006;
    const ccomplex_t IT_0414 = 0.125*IT_0410;
    const ccomplex_t IT_0415 = IT_0371 + IT_0414;
    const ccomplex_t IT_0416 = 0.125*IT_0411;
    const ccomplex_t IT_0417 = IT_0367 + IT_0416;
    const ccomplex_t IT_0418 = 16*IT_0230;
    const ccomplex_t IT_0419 = 0.125*IT_0418;
    const ccomplex_t IT_0420 = IT_0145 + IT_0419;
    const ccomplex_t IT_0421 = 16*IT_0224;
    const ccomplex_t IT_0422 = 0.125*IT_0421;
    const ccomplex_t IT_0423 = IT_0420 + IT_0422;
    const ccomplex_t IT_0424 = 16*IT_0214;
    const ccomplex_t IT_0425 = 0.125*IT_0424;
    const ccomplex_t IT_0426 = IT_0189 + IT_0425;
    const ccomplex_t IT_0427 = 16*IT_0234;
    const ccomplex_t IT_0428 = 0.125*IT_0427;
    const ccomplex_t IT_0429 = IT_0426 + IT_0428;
    const ccomplex_t IT_0430 = 4*IT_0383;
    const ccomplex_t IT_0431 = IT_0391 + IT_0430;
    const ccomplex_t IT_0432 = 4*conj(IT_0383);
    const ccomplex_t IT_0433 = IT_0392 + IT_0432;
    const ccomplex_t IT_0434 = 2*IT_0383;
    const ccomplex_t IT_0435 = 4*IT_0253;
    const ccomplex_t IT_0436 = IT_0434 + IT_0435;
    const ccomplex_t IT_0437 = 2*conj(IT_0383);
    const ccomplex_t IT_0438 = 4*conj(IT_0253);
    const ccomplex_t IT_0439 = IT_0437 + IT_0438;
    const ccomplex_t IT_0440 = 16*conj(IT_0230);
    const ccomplex_t IT_0441 = 16*conj(IT_0224);
    const ccomplex_t IT_0442 = 16*conj(IT_0214);
    const ccomplex_t IT_0443 = 16*conj(IT_0234);
    const ccomplex_t IT_0444 = conj(IT_0055)*IT_0398 + IT_0055*IT_0401 + conj
      (IT_0180)*IT_0415 + IT_0180*IT_0417 + IT_0359*IT_0423 + IT_0343*IT_0429 +
       0.125*conj(IT_0388)*IT_0431 + 0.125*IT_0388*IT_0433 + 0.125*conj(IT_0266)
      *IT_0436 + 0.125*IT_0266*IT_0439 + IT_0363*(conj(IT_0145) + 0.125*IT_0440 
      + 0.125*IT_0441) + IT_0347*(conj(IT_0189) + 0.125*IT_0442 + 0.125*IT_0443);
    const ccomplex_t IT_0445 = 0.125*IT_0408;
    const ccomplex_t IT_0446 = IT_0363 + IT_0445;
    const ccomplex_t IT_0447 = 4*IT_0388;
    const ccomplex_t IT_0448 = 16*IT_0219;
    const ccomplex_t IT_0449 = conj(IT_0145)*IT_0398 + conj(IT_0230)*IT_0420 +
       conj(IT_0224)*IT_0423 + 0.125*conj(IT_0383)*IT_0430 + 0.125*IT_0224
      *IT_0440 + conj(IT_0055)*IT_0446 + 0.125*conj(IT_0388)*IT_0447 + IT_0359*
      (IT_0055 + 2*IT_0235 + 1./8*IT_0448);
    const ccomplex_t IT_0450 = 4*IT_0266;
    const ccomplex_t IT_0451 = 16*IT_0231;
    const ccomplex_t IT_0452 = conj(IT_0180)*IT_0404 + conj(IT_0189)*IT_0415 +
       conj(IT_0214)*IT_0426 + conj(IT_0234)*IT_0429 + 0.125*conj(IT_0253)
      *IT_0435 + 0.125*IT_0234*IT_0442 + 0.125*conj(IT_0266)*IT_0450 + IT_0343*
      (IT_0180 + 2*IT_0226 + 0.125*IT_0451);
    const ccomplex_t IT_0453 = IT_0245 + IT_0389;
    const ccomplex_t IT_0454 = (-2)*IT_0253;
    const ccomplex_t IT_0455 = (-2)*conj(IT_0253);
    const ccomplex_t IT_0456 = (-2)*IT_0266;
    const ccomplex_t IT_0457 = (-2)*conj(IT_0266);
    const ccomplex_t IT_0458 = IT_0238 + IT_0242 + IT_0243;
    const ccomplex_t IT_0459 = 2*IT_0388;
    const ccomplex_t IT_0460 = 2*conj(IT_0388);
    const ccomplex_t IT_0461 = (-2)*IT_0383;
    const ccomplex_t IT_0462 = (-2)*conj(IT_0383);
    const ccomplex_t IT_0463 = (-2)*IT_0388;
    const ccomplex_t IT_0464 = (-2)*conj(IT_0388);
    const ccomplex_t IT_0465 = (-4)*IT_0171;
    const ccomplex_t IT_0466 = -IT_0006;
    const ccomplex_t IT_0467 = s_34 + IT_0466;
    const ccomplex_t IT_0468 = s_12*IT_0467;
    const ccomplex_t IT_0469 = (-8)*conj(IT_0089);
    const ccomplex_t IT_0470 = (-4)*IT_0003;
    const ccomplex_t IT_0471 = s_34 + IT_0006;
    const ccomplex_t IT_0472 = s_12*IT_0471;
    const ccomplex_t IT_0473 = (-8)*IT_0336;
    const ccomplex_t IT_0474 = (-8)*conj(IT_0336);
    const ccomplex_t IT_0475 = -conj(IT_0329);
    const ccomplex_t IT_0476 = conj(IT_0322) + IT_0475;
    const ccomplex_t IT_0477 = -IT_0329;
    const ccomplex_t IT_0478 = IT_0005*IT_0471;
    const ccomplex_t IT_0479 = conj(IT_0329)*(IT_0391 + IT_0461) + IT_0329*
      (IT_0392 + IT_0462) + 8*conj(IT_0336)*(IT_0329 + 0.125*IT_0393 + 0.125
      *IT_0463) + 8*IT_0336*(conj(IT_0329) + 0.125*IT_0394 + 0.125*IT_0464) +
       conj(IT_0322)*(IT_0434 + IT_0454 + IT_0473) + IT_0322*(IT_0437 + IT_0455 
      + IT_0474) + 8*IT_0303*(0.125*IT_0457 + 0.125*IT_0460 + IT_0476) + 8*conj
      (IT_0303)*(IT_0322 + 0.125*IT_0456 + 0.125*IT_0459 + IT_0477);
    const ccomplex_t IT_0480 = IT_0005*IT_0467;
    const ccomplex_t IT_0481 = 0.125*conj(IT_0266);
    const ccomplex_t IT_0482 = 0.5*IT_0259*IT_0266 + 0.5*conj(IT_0253)*IT_0269
       + 0.5*IT_0253*IT_0272 + -IT_0168*IT_0383 + IT_0164*conj(IT_0383) + 4*conj
      (IT_0090)*(IT_0163 + IT_0165 + 0.25*IT_0388) + 4*conj(IT_0089)*(IT_0164 + 
      (-0.25)*IT_0388) + (-4)*(IT_0089 + -IT_0090)*(IT_0168 + 1./4*conj(IT_0388)
      ) + -IT_0163*(conj(IT_0383) + (-0.5)*IT_0469) + 4*IT_0256*IT_0481;
    const ccomplex_t IT_0483 = 0.125*IT_0409;
    const ccomplex_t IT_0484 = IT_0359 + IT_0483;
    const ccomplex_t IT_0485 = 0.125*IT_0363;
    const ccomplex_t IT_0486 = 0.125*IT_0359;
    const ccomplex_t IT_0487 = 0.125*IT_0347;
    const ccomplex_t IT_0488 = 0.125*IT_0343;
    const ccomplex_t IT_0489 = 0.125*conj(IT_0180)*IT_0304 + 0.125*IT_0180
      *IT_0307 + 0.125*conj(IT_0055)*IT_0330 + 0.125*IT_0055*IT_0333 + IT_0351
      *IT_0404 + IT_0355*IT_0407 + IT_0367*IT_0446 + IT_0371*IT_0484 + IT_0411
      *IT_0485 + IT_0410*IT_0486 + IT_0399*IT_0487 + IT_0396*IT_0488;
    const ccomplex_t IT_0490 = s_23*m_N_4*m_tau;
    const ccomplex_t IT_0491 = 0.125*IT_0438;
    const ccomplex_t IT_0492 = conj(IT_0383) + IT_0491;
    const ccomplex_t IT_0493 = 4*conj(IT_0266);
    const ccomplex_t IT_0494 = 0.125*IT_0435;
    const ccomplex_t IT_0495 = 0.125*IT_0266*IT_0326 + 0.125*conj(IT_0145)
      *IT_0431 + 0.125*IT_0145*IT_0433 + conj(IT_0388)*IT_0446 + IT_0323*IT_0481
       + IT_0388*IT_0484 + IT_0450*IT_0486 + IT_0355*IT_0492 + IT_0485*IT_0493 +
       IT_0351*(IT_0383 + IT_0494);
    const ccomplex_t IT_0496 = s_14*m_N_4*m_tau;
    const ccomplex_t IT_0497 = 0.125*conj(IT_0266)*IT_0304 + 0.125*IT_0266
      *IT_0307 + conj(IT_0388)*IT_0398 + IT_0388*IT_0401 + 0.125*conj(IT_0055)
      *IT_0431 + 0.125*IT_0055*IT_0433 + 0.125*IT_0351*IT_0450 + IT_0363*IT_0492
       + 0.125*IT_0355*IT_0493 + IT_0359*(IT_0383 + IT_0494);
    const ccomplex_t IT_0498 = s_13*m_N_4*m_tau;
    const ccomplex_t IT_0499 = 0.125*IT_0432;
    const ccomplex_t IT_0500 = conj(IT_0253) + IT_0499;
    const ccomplex_t IT_0501 = 4*conj(IT_0388);
    const ccomplex_t IT_0502 = 0.125*IT_0430;
    const ccomplex_t IT_0503 = 0.125*IT_0340*IT_0388 + 0.125*IT_0337*conj
      (IT_0388) + conj(IT_0266)*IT_0404 + IT_0266*IT_0407 + 0.125*conj(IT_0189)
      *IT_0436 + 0.125*IT_0189*IT_0439 + IT_0447*IT_0488 + IT_0371*IT_0500 +
       IT_0487*IT_0501 + IT_0367*(IT_0253 + IT_0502);
    const ccomplex_t IT_0504 = s_24*m_N_4*m_tau;
    const ccomplex_t IT_0505 = 0.125*IT_0333*IT_0388 + 0.125*IT_0330*conj
      (IT_0388) + conj(IT_0266)*IT_0415 + IT_0266*IT_0417 + 0.125*conj(IT_0180)
      *IT_0436 + 0.125*IT_0180*IT_0439 + 0.125*IT_0367*IT_0447 + IT_0347*IT_0500
       + 0.125*IT_0371*IT_0501 + IT_0343*(IT_0253 + IT_0502);
    const ccomplex_t IT_0506 = IT_0004*(conj(IT_0055)*IT_0092 + IT_0055
      ...
      *conj(IT_0383) + IT_0272*IT_0388 + IT_0269*conj(IT_0388))*(IT_0242 +
       ...
       conj(IT_0388)*IT_0393 + IT_0388*IT_0394) + 8*IT_0395*IT_0412 + 8*IT_0413
      *IT_0444 + 8*IT_0239*IT_0449 + 8*IT_0240*IT_0452 + IT_0453*(conj(IT_0303)
      *IT_0391 + IT_0303*IT_0392 + conj(IT_0322)*IT_0393 + IT_0322*IT_0394 +
       conj(IT_0336)*IT_0454 + IT_0336*IT_0455 + conj(IT_0329)*IT_0456 + IT_0329
      *IT_0457) + IT_0458*(conj(IT_0303)*IT_0434 + IT_0303*IT_0437 + conj
      (IT_0322)*IT_0459 + IT_0322*IT_0460 + conj(IT_0336)*IT_0461 + IT_0336
      *IT_0462 + conj(IT_0329)*IT_0463 + IT_0329*IT_0464) + (IT_0184*IT_0232 +
       IT_0182*IT_0233 + (conj(IT_0164) + IT_0192)*IT_0236 + IT_0191*IT_0237)
      *IT_0465 + 8*IT_0468*(IT_0089*(conj(IT_0089) + -conj(IT_0090)) + (IT_0163 
      + IT_0165)*IT_0168 + IT_0090*(conj(IT_0090) + 0.125*IT_0469)) + (IT_0094
      *IT_0220 + IT_0092*IT_0221 + (conj(IT_0163) + IT_0167)*IT_0227 + IT_0166
      *IT_0228)*IT_0470 + 8*IT_0472*(IT_0336*conj(IT_0336) + 0.125*conj(IT_0303)
      *IT_0473 + IT_0303*(conj(IT_0303) + 0.125*IT_0474) + IT_0476*(IT_0322 +
       IT_0477)) + IT_0478*IT_0479 + 2*IT_0480*IT_0482 + 8*IT_0238*IT_0489 + 8
      *IT_0490*IT_0495 + 8*IT_0496*IT_0497 + 8*IT_0498*IT_0503 + 8*IT_0504
      *IT_0505;
