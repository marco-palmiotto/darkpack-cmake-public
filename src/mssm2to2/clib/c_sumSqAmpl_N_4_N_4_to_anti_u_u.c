...
ccomplex_return_t c_sumSqAmpl_N_4_N_4_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0336 = m_u*s_13*m_N_4;
    ...
    const ccomplex_t IT_0360 = m_u*s_14*m_N_4;
    ...
    const ccomplex_t IT_0382 = m_u*s_23*m_N_4;
    ...
    const ccomplex_t IT_0412 = m_u*s_24*m_N_4;
