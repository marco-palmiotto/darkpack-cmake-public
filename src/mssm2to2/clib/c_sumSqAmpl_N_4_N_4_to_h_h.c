        ...
        )
{
    ...
    const ccomplex_t IT_0066 = IT_0032*IT_0048;
    const ccomplex_t IT_0067 = cpow(IT_0048, 2);
    const ccomplex_t IT_0068 = m_N_4*IT_0067;
    const ccomplex_t IT_0069 = IT_0050 + IT_0068;
    const ccomplex_t IT_0070 = IT_0036*IT_0069;
    const ccomplex_t IT_0071 = IT_0004*IT_0041;
    const ccomplex_t IT_0072 = IT_0008*IT_0039;
    const ccomplex_t IT_0073 = IT_0013*IT_0045;
    const ccomplex_t IT_0074 = IT_0016*IT_0043;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*(IT_0071 + -IT_0072 + 
      -IT_0073 + IT_0074);
    const ccomplex_t IT_0076 = IT_0063*IT_0075;
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0034 + (0 + _Complex_I*1)
      *m_N_4*Gamma_o4 + reg_prop, -1);
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = IT_0069*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*IT_0080;
    const ccomplex_t IT_0082 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0083 = IT_0004*IT_0082;
    const ccomplex_t IT_0084 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0085 = IT_0008*IT_0084;
    const ccomplex_t IT_0086 = N_B1*N_u4*e_em;
    ...
    const ccomplex_t IT_0091 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0092 = IT_0013*IT_0091;
    const ccomplex_t IT_0093 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0094 = IT_0016*IT_0093;
    const ccomplex_t IT_0095 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0096 = IT_0013*IT_0095;
    const ccomplex_t IT_0097 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0114 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0115 = IT_0013*IT_0114;
    const ccomplex_t IT_0116 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0117 = IT_0016*IT_0116;
    const ccomplex_t IT_0118 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0119 = IT_0013*IT_0118;
    const ccomplex_t IT_0120 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0157 = m_N_2*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0159 = IT_0004*IT_0158;
    const ccomplex_t IT_0160 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0161 = IT_0008*IT_0160;
    const ccomplex_t IT_0162 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0163 = IT_0004*IT_0162;
    const ccomplex_t IT_0164 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0183 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*IT_0183;
    const ccomplex_t IT_0185 = IT_0181*IT_0184;
    const ccomplex_t IT_0186 = cpow((-2)*s_23 + IT_0000 + IT_0034 + -m_N_3*
    ...
    const ccomplex_t IT_0236 = cpow((-2)*s_13 + IT_0000 + IT_0034 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = IT_0234*IT_0237;
    const ccomplex_t IT_0239 = (-0.5)*IT_0066 + 0.5*IT_0070 + (-0.5)*IT_0076 +
       IT_0079 + IT_0129 + IT_0132 + IT_0182 + IT_0185 + IT_0235 + IT_0238;
    const ccomplex_t IT_0240 = 2*IT_0239;
    const ccomplex_t IT_0241 = 0.5*IT_0066 + (-0.5)*IT_0070 + 0.5*IT_0076;
    ...
    const ccomplex_t IT_0247 = IT_0051*IT_0078;
    const ccomplex_t IT_0248 = cpow(IT_0125, 2);
    const ccomplex_t IT_0249 = m_N_1*IT_0248;
    const ccomplex_t IT_0250 = IT_0127 + IT_0249;
    const ccomplex_t IT_0251 = IT_0081*IT_0250;
    const ccomplex_t IT_0252 = IT_0131*IT_0250;
    const ccomplex_t IT_0253 = cpow(IT_0178, 2);
    const ccomplex_t IT_0254 = m_N_2*IT_0253;
    const ccomplex_t IT_0255 = IT_0180 + IT_0254;
    const ccomplex_t IT_0256 = IT_0134*IT_0255;
    const ccomplex_t IT_0257 = IT_0184*IT_0255;
    ...
    const ccomplex_t IT_0263 = (-0.5)*IT_0033 + 0.5*IT_0052 + (-0.5)*IT_0064 +
       IT_0247 + IT_0251 + IT_0252 + IT_0256 + IT_0257 + IT_0261 + IT_0262;
    ...
    const ccomplex_t IT_0273 = IT_0036*IT_0049;
    const ccomplex_t IT_0274 = IT_0081*IT_0126;
    const ccomplex_t IT_0275 = IT_0232*IT_0237;
    const ccomplex_t IT_0276 = IT_0187*IT_0232;
    const ccomplex_t IT_0277 = IT_0049*IT_0078;
    const ccomplex_t IT_0278 = IT_0126*IT_0131;
    const ccomplex_t IT_0279 = IT_0134*IT_0179;
    const ccomplex_t IT_0280 = IT_0179*IT_0184;
    ...
    const ccomplex_t IT_0285 = 2*conj(IT_0263);
    const ccomplex_t IT_0286 = (-2)*conj(IT_0065);
    const ccomplex_t IT_0287 = IT_0272*(IT_0246*IT_0281 + IT_0243*conj(IT_0281
      ) + conj(IT_0281)*(IT_0282 + IT_0283) + (IT_0240 + IT_0242 + IT_0282 +
       IT_0283)*conj(IT_0284) + IT_0281*(IT_0285 + IT_0286) + IT_0284*(IT_0244 +
       IT_0245 + IT_0285 + IT_0286));
    ...
    const ccomplex_t IT_0293 = IT_0288*(IT_0269*IT_0281 + IT_0266*conj(IT_0281
      ) + conj(IT_0281)*(IT_0289 + IT_0290) + conj(IT_0284)*(IT_0264 + IT_0265 +
       IT_0289 + IT_0290) + IT_0281*(IT_0291 + IT_0292) + IT_0284*(IT_0267 +
    ...
    const ccomplex_t IT_0306 = IT_0000*IT_0034;
    const ccomplex_t IT_0307 = IT_0000*(conj(IT_0065)*IT_0243 + IT_0065
