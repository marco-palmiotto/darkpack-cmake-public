        ...
        )
{
    ...
    const ccomplex_t IT_0015 = m_b*conj(N_d4)*e_em*IT_0014*U_sb_11;
    const ccomplex_t IT_0016 = IT_0013*IT_0015;
    const ccomplex_t IT_0017 = 1.4142135623731*IT_0016;
    const ccomplex_t IT_0018 = conj(N_W4)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0023 = conj(N_B4)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0005 + IT_0006 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_10);
    const ccomplex_t IT_0034 = m_b*conj(N_d4)*e_em*IT_0014*U_sb_10;
    const ccomplex_t IT_0035 = IT_0013*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0038 = IT_0012*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0053 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0054 = IT_0022*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = m_b*conj(N_d4)*e_em*IT_0014*conj(U_sb_00);
    ...
    const ccomplex_t IT_0066 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0067 = IT_0022*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = m_b*conj(N_d4)*e_em*IT_0014*conj(U_sb_01);
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_10;
    const ccomplex_t IT_0079 = N_B4*e_em*conj(U_sb_00);
    const ccomplex_t IT_0080 = IT_0022*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_W4*e_em*conj(U_sb_00);
    const ccomplex_t IT_0083 = IT_0012*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = m_b*N_d4*e_em*IT_0014*conj(U_sb_10);
    ...
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_11;
    ...
    const ccomplex_t IT_0113 = m_b*N_d4*e_em*IT_0014*U_sb_00;
    ...
    const ccomplex_t IT_0125 = m_b*N_d4*e_em*IT_0014*U_sb_01;
    ...
    const ccomplex_t IT_0169 = m_sG*s_34*m_N_4;
    const ccomplex_t IT_0170 = 8*IT_0159;
    const ccomplex_t IT_0171 = 8*conj(IT_0159);
    const ccomplex_t IT_0172 = m_b*m_sG*s_14;
    ...
    const ccomplex_t IT_0180 = 16*IT_0166;
    const ccomplex_t IT_0181 = m_b*s_23*m_N_4;
    const ccomplex_t IT_0182 = 16*conj(IT_0166);
    const ccomplex_t IT_0183 = m_sG*m_N_4*IT_0005;
    ...
    const ccomplex_t IT_0188 = 16*IT_0159;
    const ccomplex_t IT_0189 = 16*conj(IT_0159);
    const ccomplex_t IT_0190 = m_b*s_24*m_N_4;
    const ccomplex_t IT_0191 = 16*IT_0143;
    const ccomplex_t IT_0192 = m_b*m_sG*s_13;
    const ccomplex_t IT_0193 = 8*IT_0004*(conj(IT_0049)*IT_0077 + IT_0049*conj
      (IT_0077) + 0.125*conj(IT_0108)*IT_0134 + 0.125*IT_0108*IT_0135) + IT_0136
      *(conj(IT_0143)*IT_0151 + IT_0143*IT_0152 + conj(IT_0159)*IT_0167 +
       IT_0159*IT_0168) + IT_0169*(conj(IT_0143)*IT_0167 + IT_0143*IT_0168 +
       conj(IT_0150)*IT_0170 + IT_0150*IT_0171) + IT_0172*(16*IT_0049*conj
      (IT_0150) + conj(IT_0077)*IT_0151 + IT_0077*IT_0152 + conj(IT_0166)
      *IT_0175 + IT_0166*IT_0178 + conj(IT_0049)*IT_0179) + IT_0000*(16*IT_0049
      *conj(IT_0049) + conj(IT_0133)*IT_0174 + conj(IT_0150)*IT_0179 + conj
      (IT_0166)*IT_0180) + IT_0181*(conj(IT_0077)*IT_0167 + IT_0077*IT_0168 +
       conj(IT_0150)*IT_0175 + IT_0150*IT_0178 + conj(IT_0049)*IT_0180 + IT_0049
      *IT_0182) + IT_0183*(conj(IT_0049)*IT_0175 + IT_0049*IT_0178 + conj
      (IT_0150)*IT_0180 + IT_0150*IT_0182 + conj(IT_0077)*IT_0185 + IT_0077
      *IT_0187 + conj(IT_0143)*IT_0188 + IT_0143*IT_0189) + (conj(IT_0049)
      *IT_0170 + IT_0049*IT_0171 + conj(IT_0143)*IT_0185 + IT_0143*IT_0187 +
       conj(IT_0077)*IT_0188 + IT_0077*IT_0189)*IT_0190 + IT_0001*(16*IT_0077
      *conj(IT_0077) + conj(IT_0108)*IT_0184 + conj(IT_0159)*IT_0188 + conj
      (IT_0143)*IT_0191) + 8*(conj(IT_0049)*IT_0143 + (IT_0049 + 2*IT_0077)*conj
      (IT_0143) + 0.125*conj(IT_0159)*IT_0185 + 0.125*IT_0159*IT_0187 + 0.125
      *conj(IT_0077)*IT_0191)*IT_0192;
