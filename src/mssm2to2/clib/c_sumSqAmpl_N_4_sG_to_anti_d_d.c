...
ccomplex_return_t c_sumSqAmpl_N_4_sG_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0044;
    ...
    const ccomplex_t IT_0083 = m_sG*s_34*m_N_4;
    ...
    const ccomplex_t IT_0089 = m_d*s_24*m_N_4;
    ...
    const ccomplex_t IT_0095 = m_sG*m_N_4*IT_0014;
    ...
    const ccomplex_t IT_0098 = m_d*s_23*m_N_4;
