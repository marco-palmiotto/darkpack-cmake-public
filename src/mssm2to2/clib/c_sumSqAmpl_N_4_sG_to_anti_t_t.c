        ...
        )
{
    ...
    const ccomplex_t IT_0020 = m_t*conj(N_u4)*e_em*IT_0019*U_st_10;
    ...
    const ccomplex_t IT_0038 = m_t*conj(N_u4)*e_em*IT_0019*U_st_11;
    ...
    const ccomplex_t IT_0048 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0049 = IT_0007*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = m_t*conj(N_u4)*e_em*IT_0019*conj(U_st_01);
    ...
    const ccomplex_t IT_0064 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0065 = IT_0007*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = m_t*conj(N_u4)*e_em*IT_0019*conj(U_st_00);
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_00);
    const ccomplex_t IT_0108 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0109 = IT_0007*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = m_t*N_u4*e_em*IT_0019*U_st_00;
    ...
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_01);
    const ccomplex_t IT_0120 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0121 = IT_0007*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = m_t*N_u4*e_em*IT_0019*U_st_01;
    ...
    const ccomplex_t IT_0134 = m_sG*s_34*m_N_4;
    ...
    const ccomplex_t IT_0170 = m_t*s_23*m_N_4;
    ...
    const ccomplex_t IT_0179 = m_sG*m_N_4*IT_0026;
    ...
    const ccomplex_t IT_0186 = m_t*s_24*m_N_4;
