...
ccomplex_return_t c_sumSqAmpl_N_4_sG_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
    ...
    const ccomplex_t IT_0089 = m_u*s_24*m_N_4;
    ...
    const ccomplex_t IT_0098 = m_u*s_23*m_N_4;
