        ...
        )
{
    ...
    const ccomplex_t IT_0004 = N_B4*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*(IT_0006 + 1.5*IT_0015);
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_12 + IT_0018 + -IT_0019 + -IT_0024 
      + -reg_prop, -1);
    const ccomplex_t IT_0026 = (-0.333333333333333)*IT_0000;
    ...
    const ccomplex_t IT_0050 = (-6)*IT_0018;
    const ccomplex_t IT_0051 = 0.333333333333333*IT_0000;
    ...
    const ccomplex_t IT_0057 = m_b*s_14*m_N_4;
    const ccomplex_t IT_0058 = -IT_0029;
    const ccomplex_t IT_0059 = s_34*IT_0019;
    ...
    const ccomplex_t IT_0065 = IT_0019*IT_0055;
    const ccomplex_t IT_0066 = pow(s_13, 2);
    const ccomplex_t IT_0067 = (-6)*IT_0066;
    const ccomplex_t IT_0068 = -IT_0045;
    const ccomplex_t IT_0069 = m_b*m_N_4;
    const ccomplex_t IT_0070 = (-6)*s_14;
    const ccomplex_t IT_0071 = (-6)*s_34;
    const ccomplex_t IT_0072 = (-6)*IT_0019;
    const ccomplex_t IT_0073 = (conj(IT_0030)*IT_0049 + IT_0030*conj(IT_0049))
      *IT_0050 + IT_0055*(conj(IT_0023)*IT_0049 + IT_0023*conj(IT_0049) + conj
      (IT_0030)*IT_0068 + IT_0030*conj(IT_0068)) + (conj(IT_0023)*IT_0054 +
       IT_0023*conj(IT_0054) + conj(IT_0053)*IT_0068 + IT_0053*conj(IT_0068))
      *IT_0070 + (conj(IT_0049)*IT_0053 + IT_0049*conj(IT_0053) + conj(IT_0030)
      *IT_0054 + IT_0030*conj(IT_0054))*IT_0071 + (conj(IT_0023)*IT_0068 +
       IT_0023*conj(IT_0068))*IT_0072;
    const ccomplex_t IT_0074 = m_b*s_34*m_N_4;
    ...
    const ccomplex_t IT_0083 = s_13*(IT_0030*conj(IT_0030) + IT_0049*conj
      ...
      (IT_0049)*IT_0054 + IT_0049*conj(IT_0054))*IT_0056 + (-6)*conj(IT_0023)*
      (IT_0048*IT_0057 + (-0.166666666666667)*IT_0058*IT_0063 + (
      -0.166666666666667)*IT_0053*IT_0064 + (-0.166666666666667)*IT_0023*IT_0065
       + (-0.166666666666667)*IT_0030*IT_0067) + IT_0023*(conj(IT_0053)*IT_0064 
      ...
      *IT_0023*IT_0063 + IT_0057*IT_0068 + (-4)*IT_0058*IT_0078 + IT_0080
      *IT_0081 + IT_0079*IT_0082) + (-6)*conj(IT_0048)*(IT_0023*IT_0057 + (
