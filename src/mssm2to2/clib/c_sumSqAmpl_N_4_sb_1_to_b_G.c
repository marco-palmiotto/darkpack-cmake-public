        ...
        )
{
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_12 + IT_0018 + -IT_0019 + -IT_0024 
      + -reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0000*IT_0017;
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = -IT_0023 + (-2)*IT_0028;
    const ccomplex_t IT_0030 = m_b*conj(N_d4)*e_em*IT_0012*U_sb_10;
    ...
    const ccomplex_t IT_0049 = (-8)*IT_0018;
    ...
    const ccomplex_t IT_0056 = m_b*s_14*m_N_4;
    ...
    const ccomplex_t IT_0068 = m_b*m_N_4;
    ...
    const ccomplex_t IT_0072 = (conj(IT_0029)*IT_0048 + IT_0029*conj(IT_0048))
      *IT_0049 + IT_0054*(conj(IT_0023)*IT_0048 + IT_0023*conj(IT_0048) + conj
      (IT_0029)*IT_0067 + IT_0029*conj(IT_0067)) + (conj(IT_0023)*IT_0053 +
      ...
      *IT_0053 + IT_0029*conj(IT_0053))*IT_0070 + (conj(IT_0023)*IT_0067 +
       IT_0023*conj(IT_0067))*IT_0071;
    const ccomplex_t IT_0073 = m_b*s_34*m_N_4;
    ...
    const ccomplex_t IT_0082 = s_13*(IT_0029*conj(IT_0029) + IT_0048*conj
      ...
      (IT_0048)*IT_0053 + IT_0048*conj(IT_0053))*IT_0055 + (-8)*conj(IT_0023)*
      (IT_0044*IT_0056 + (-0.125)*IT_0057*IT_0062 + (-0.125)*IT_0052*IT_0063 + (
      -0.125)*IT_0023*IT_0064 + (-0.125)*IT_0029*IT_0066) + IT_0023*(conj
      (IT_0052)*IT_0063 + conj(IT_0029)*IT_0066) + (conj(IT_0053)*IT_0063 + conj
      (IT_0048)*IT_0066)*IT_0067 + (-8)*(IT_0056*IT_0057 + (-0.125)*IT_0044
      *IT_0062 + (-0.125)*IT_0053*IT_0063 + (-0.125)*IT_0048*IT_0066 + (-0.125)
      *IT_0064*IT_0067)*conj(IT_0067) + IT_0068*IT_0072 + IT_0057*(IT_0074
      *IT_0075 + IT_0073*IT_0076) + IT_0044*(IT_0073*IT_0074 + IT_0075*IT_0076) 
      + (-8)*conj(IT_0057)*((-0.125)*IT_0023*IT_0062 + IT_0056*IT_0067 + (-4)
      *IT_0057*IT_0077 + IT_0079*IT_0080 + IT_0078*IT_0081) + (-8)*conj(IT_0044)
      *(IT_0023*IT_0056 + (-0.125)*IT_0062*IT_0067 + (-4)*IT_0044*IT_0077 +
