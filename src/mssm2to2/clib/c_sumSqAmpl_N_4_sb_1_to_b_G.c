...
ccomplex_return_t c_sumSqAmpl_N_4_sb_1_to_b_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_B4*e_em*U_sb_10;
    ...
    const ccomplex_t IT_0016 = m_b*N_d4*e_em*IT_0015*U_sb_00;
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_1*
    ...
    const ccomplex_t IT_0030 = m_b*conj(N_d4)*e_em*IT_0015*U_sb_10;
    ...
    const ccomplex_t IT_0036 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0037 = IT_0013*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*(IT_0032 + 0.333333333333333
      *IT_0035 + -IT_0038);
    ...
    const ccomplex_t IT_0054 = IT_0027*IT_0052;
    ...
    const ccomplex_t IT_0074 = (conj(IT_0029)*IT_0050 + IT_0029*conj(IT_0050))
      *IT_0051 + IT_0056*(conj(IT_0028)*IT_0050 + IT_0028*conj(IT_0050) + conj
      (IT_0029)*IT_0069 + IT_0029*conj(IT_0069)) + (conj(IT_0028)*IT_0053 +
       IT_0028*conj(IT_0053) + conj(IT_0055)*IT_0069 + IT_0055*conj(IT_0069))
      *IT_0071 + (conj(IT_0029)*IT_0053 + IT_0029*conj(IT_0053) + conj(IT_0050)
      *IT_0055 + IT_0050*conj(IT_0055))*IT_0072 + (conj(IT_0028)*IT_0069 +
       IT_0028*conj(IT_0069))*IT_0073;
    const ccomplex_t IT_0075 = m_b*s_34*m_N_4;
    const ccomplex_t IT_0076 = (-8)*conj(IT_0029);
    const ccomplex_t IT_0077 = s_14*IT_0000;
    const ccomplex_t IT_0078 = (-8)*conj(IT_0050);
    const ccomplex_t IT_0079 = (-0.125)*IT_0069;
    const ccomplex_t IT_0080 = s_14*s_34;
    const ccomplex_t IT_0081 = (-8)*IT_0050;
    const ccomplex_t IT_0082 = (-0.125)*IT_0077;
    const ccomplex_t IT_0083 = (-8)*IT_0029;
    const ccomplex_t IT_0084 = (-0.125)*IT_0075;
    const ccomplex_t IT_0085 = s_13*(IT_0029*conj(IT_0029) + IT_0050*conj
      (IT_0050))*IT_0051 + (conj(IT_0050)*IT_0053 + IT_0050*conj(IT_0053) + conj
      (IT_0029)*IT_0055 + IT_0029*conj(IT_0055))*IT_0057 + (-8)*conj(IT_0028)*
      (IT_0049*IT_0058 + (-0.125)*IT_0059*IT_0064 + (-0.125)*IT_0055*IT_0065 + (
      -0.125)*IT_0028*IT_0066 + (-0.125)*IT_0029*IT_0068) + IT_0028*(conj
      (IT_0055)*IT_0065 + conj(IT_0029)*IT_0068) + (conj(IT_0053)*IT_0065 + conj
      (IT_0050)*IT_0068)*IT_0069 + IT_0070*IT_0074 + IT_0059*(IT_0076*IT_0077 +
       IT_0075*IT_0078) + IT_0049*(IT_0075*IT_0076 + IT_0077*IT_0078) + (-8)
      *conj(IT_0069)*(IT_0058*IT_0059 + (-0.125)*IT_0049*IT_0064 + (-0.125)
      *IT_0053*IT_0065 + (-0.125)*IT_0050*IT_0068 + IT_0066*IT_0079) + (-8)*conj
      (IT_0059)*((-0.125)*IT_0028*IT_0064 + IT_0058*IT_0069 + (-4)*IT_0059
      *IT_0080 + IT_0082*IT_0083 + IT_0081*IT_0084) + (-8)*conj(IT_0049)*
      (IT_0028*IT_0058 + IT_0064*IT_0079 + (-4)*IT_0049*IT_0080 + IT_0081
