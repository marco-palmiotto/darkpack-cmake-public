        ...
        )
{
    ...
    const ccomplex_t IT_0057 = IT_0004*IT_0020;
    const ccomplex_t IT_0058 = N_B4*N_d4*e_em;
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = IT_0004*IT_0022;
    const ccomplex_t IT_0061 = N_B4*N_u4*e_em;
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = IT_0011*IT_0020;
    const ccomplex_t IT_0064 = N_W4*N_d4*e_em;
    const ccomplex_t IT_0065 = IT_0063*IT_0064;
    const ccomplex_t IT_0066 = IT_0011*IT_0022;
    const ccomplex_t IT_0067 = N_W4*N_u4*e_em;
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*(IT_0059 + -IT_0062 + 
      -IT_0065 + IT_0068);
    const ccomplex_t IT_0070 = m_N_4*IT_0069;
    const ccomplex_t IT_0071 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0072 = IT_0057*IT_0071;
    const ccomplex_t IT_0073 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0074 = IT_0060*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0076 = IT_0063*IT_0075;
    const ccomplex_t IT_0077 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0078 = IT_0066*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*(IT_0072 + -IT_0074 + 
      -IT_0076 + IT_0078);
    const ccomplex_t IT_0080 = m_N_4*IT_0079;
    const ccomplex_t IT_0081 = IT_0070 + IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_23 + IT_0000 + IT_0049 + -m_N_4*
    ...
    const ccomplex_t IT_0086 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0087 = IT_0004*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = m_b*N_d1*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0094 = cpow((-2)*s_23 + IT_0000 + IT_0049 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0095 = IT_0093*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*IT_0095;
    const ccomplex_t IT_0097 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0098 = IT_0057*IT_0097;
    const ccomplex_t IT_0099 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0100 = IT_0066*IT_0099;
    const ccomplex_t IT_0101 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0102 = IT_0057*IT_0101;
    const ccomplex_t IT_0103 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0104 = IT_0066*IT_0103;
    const ccomplex_t IT_0105 = IT_0098 + IT_0100 + IT_0102 + IT_0104;
    const ccomplex_t IT_0106 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0107 = IT_0060*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0109 = IT_0063*IT_0108;
    const ccomplex_t IT_0110 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0111 = IT_0060*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0119 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0120 = IT_0057*IT_0119;
    const ccomplex_t IT_0121 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0122 = IT_0066*IT_0121;
    const ccomplex_t IT_0123 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0124 = IT_0057*IT_0123;
    const ccomplex_t IT_0125 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0126 = IT_0066*IT_0125;
    const ccomplex_t IT_0127 = IT_0120 + IT_0122 + IT_0124 + IT_0126;
    const ccomplex_t IT_0128 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0129 = IT_0060*IT_0128;
    const ccomplex_t IT_0130 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0131 = IT_0063*IT_0130;
    const ccomplex_t IT_0132 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0133 = IT_0060*IT_0132;
    const ccomplex_t IT_0134 = N_W1*N_d4*e_em;
    const ccomplex_t IT_0135 = IT_0063*IT_0134;
    ...
    const ccomplex_t IT_0151 = cpow((-2)*s_23 + IT_0000 + IT_0049 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0152 = IT_0150*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*IT_0152;
    const ccomplex_t IT_0154 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0155 = IT_0057*IT_0154;
    const ccomplex_t IT_0156 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0157 = IT_0066*IT_0156;
    const ccomplex_t IT_0158 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0159 = IT_0057*IT_0158;
    const ccomplex_t IT_0160 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0161 = IT_0066*IT_0160;
    const ccomplex_t IT_0162 = IT_0155 + IT_0157 + IT_0159 + IT_0161;
    const ccomplex_t IT_0163 = N_B4*N_u2*e_em;
    const ccomplex_t IT_0164 = IT_0060*IT_0163;
    const ccomplex_t IT_0165 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0166 = IT_0063*IT_0165;
    const ccomplex_t IT_0167 = N_B2*N_u4*e_em;
    ...
    const ccomplex_t IT_0176 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0177 = IT_0057*IT_0176;
    const ccomplex_t IT_0178 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0179 = IT_0066*IT_0178;
    const ccomplex_t IT_0180 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0181 = IT_0057*IT_0180;
    const ccomplex_t IT_0182 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0186 = IT_0060*IT_0185;
    const ccomplex_t IT_0187 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0188 = IT_0063*IT_0187;
    const ccomplex_t IT_0189 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0190 = IT_0060*IT_0189;
    const ccomplex_t IT_0191 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0234 = IT_0063*IT_0233;
    ...
    const ccomplex_t IT_0238 = IT_0063*IT_0237;
    ...
    const ccomplex_t IT_0253 = cpow((-2)*s_23 + IT_0000 + IT_0049 + -m_N_3*
    ...
    const ccomplex_t IT_0288 = (-2)*U_sb_00*((IT_0000*IT_0009*IT_0011*IT_0013
      *IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))*conj
      (U_sb_00) + -1./2*IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_10)) + U_sb_10
      *(IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_00) + (-2)*(IT_0000*IT_0009
      *IT_0011*IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*conj(U_sb_10
    ...
    const ccomplex_t IT_0306 = (-2)*U_sb_00*((IT_0000*IT_0009*IT_0011*IT_0013
      *IT_0020 + (-0.5)*m_W*IT_0026*(IT_0011 + 1./3*IT_0010*IT_0027))*conj
      (U_sb_01) + -1./2*IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_11)) + U_sb_10
      *(IT_0009*IT_0011*IT_0021*IT_0022*conj(U_sb_01) + (-2)*(IT_0000*IT_0009
      *IT_0011*IT_0013*IT_0020 + -1./3*m_W*IT_0010*IT_0026*IT_0027)*conj(U_sb_11
    ...
    const ccomplex_t IT_0310 = IT_0034*IT_0309;
    const ccomplex_t IT_0311 = (0 + _Complex_I*1)*IT_0310;
    const ccomplex_t IT_0312 = IT_0052*IT_0287;
    const ccomplex_t IT_0313 = IT_0050*IT_0312;
    const ccomplex_t IT_0314 = (0 + _Complex_I*1)*IT_0313;
    const ccomplex_t IT_0315 = m_b*IT_0314;
    const ccomplex_t IT_0316 = IT_0082*IT_0287;
    const ccomplex_t IT_0317 = (0 + _Complex_I*1)*IT_0316;
    const ccomplex_t IT_0318 = IT_0081*IT_0317;
    const ccomplex_t IT_0319 = m_N_1*IT_0117;
    const ccomplex_t IT_0320 = m_N_4*IT_0139;
    const ccomplex_t IT_0321 = IT_0319 + IT_0320;
    const ccomplex_t IT_0322 = m_b*conj(N_d1)*e_em*IT_0013*U_sb_10;
    const ccomplex_t IT_0323 = IT_0012*IT_0322;
    const ccomplex_t IT_0324 = 1.4142135623731*IT_0323;
    const ccomplex_t IT_0325 = conj(N_B1)*e_em*U_sb_00;
    const ccomplex_t IT_0326 = IT_0004*IT_0325;
    const ccomplex_t IT_0327 = 1.4142135623731*IT_0326;
    const ccomplex_t IT_0328 = conj(N_W1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0334 = IT_0094*IT_0333;
    const ccomplex_t IT_0335 = (0 + _Complex_I*1)*IT_0334;
    const ccomplex_t IT_0336 = IT_0321*IT_0335;
    const ccomplex_t IT_0337 = m_N_4*IT_0174;
    const ccomplex_t IT_0338 = m_N_2*IT_0196;
    const ccomplex_t IT_0339 = IT_0337 + IT_0338;
    const ccomplex_t IT_0340 = m_b*conj(N_d2)*e_em*IT_0013*U_sb_10;
    const ccomplex_t IT_0341 = IT_0012*IT_0340;
    const ccomplex_t IT_0342 = 1.4142135623731*IT_0341;
    const ccomplex_t IT_0343 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0344 = IT_0011*IT_0343;
    const ccomplex_t IT_0345 = 1.4142135623731*IT_0344;
    const ccomplex_t IT_0346 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0347 = IT_0004*IT_0346;
    ...
    const ccomplex_t IT_0352 = IT_0151*IT_0351;
    const ccomplex_t IT_0353 = (0 + _Complex_I*1)*IT_0352;
    const ccomplex_t IT_0354 = IT_0339*IT_0353;
    const ccomplex_t IT_0355 = -IT_0275 + -IT_0293 + -IT_0311 + 2*IT_0315 + 
    ...
    const ccomplex_t IT_0359 = IT_0069*IT_0317;
    const ccomplex_t IT_0360 = IT_0174*IT_0353;
    const ccomplex_t IT_0361 = IT_0220*IT_0274;
    const ccomplex_t IT_0362 = IT_0139*IT_0335;
    const ccomplex_t IT_0363 = -IT_0055 + IT_0359 + IT_0360 + IT_0361 + IT_0362;
    const ccomplex_t IT_0364 = m_b*s_14;
    const ccomplex_t IT_0365 = IT_0079*IT_0084;
    const ccomplex_t IT_0366 = IT_0242*IT_0255;
    const ccomplex_t IT_0367 = IT_0096*IT_0117;
    const ccomplex_t IT_0368 = IT_0153*IT_0196;
    const ccomplex_t IT_0369 = IT_0314 + -IT_0365 + -IT_0366 + -IT_0367 + 
      -IT_0368;
