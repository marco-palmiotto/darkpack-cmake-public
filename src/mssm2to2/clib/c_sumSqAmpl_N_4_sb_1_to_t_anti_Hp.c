        ...
        )
{
    ...
    const ccomplex_t IT_0060 = m_t*U_sb_00*(m_t*IT_0025*IT_0058*conj(U_st_00) 
      + mu_h*conj(U_st_10)) + m_b*(m_b*IT_0004*IT_0059*U_sb_00*conj(U_st_00) +
       U_sb_10*(mu_h*conj(U_st_00) + m_t*IT_0025*IT_0059*conj(U_st_10)));
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0004*U_sb_10
      *conj(U_st_00) + (-1.4142135623731)*e_em*IT_0006*((-0.5)*IT_0024*IT_0060 +
       m_W*IT_0004*IT_0058*U_sb_00*conj(U_st_00)) + A_t*IT_0058*U_sb_00*conj
      (U_st_10));
    ...
    const ccomplex_t IT_0075 = m_t*U_sb_00*(m_t*IT_0025*IT_0058*conj(U_st_01) 
      + mu_h*conj(U_st_11)) + m_b*(m_b*IT_0004*IT_0059*U_sb_00*conj(U_st_01) +
       U_sb_10*(mu_h*conj(U_st_01) + m_t*IT_0025*IT_0059*conj(U_st_11)));
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0004*U_sb_10
      *conj(U_st_01) + (-1.4142135623731)*e_em*IT_0006*((-0.5)*IT_0024*IT_0075 +
       m_W*IT_0004*IT_0058*U_sb_00*conj(U_st_01)) + A_t*IT_0058*U_sb_00*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0090 = m_b*N_d4*e_em*IT_0024*U_sb_00;
    ...
    const ccomplex_t IT_0099 = m_b*conj(U_d1)*V_tb*e_em*IT_0024*U_sb_10;
    const ccomplex_t IT_0100 = IT_0089*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    ...
    const ccomplex_t IT_0110 = m_b*conj(U_d2)*V_tb*e_em*IT_0024*U_sb_10;
    const ccomplex_t IT_0111 = IT_0089*IT_0110;
    const ccomplex_t IT_0112 = 1.4142135623731*IT_0111;
    const ccomplex_t IT_0113 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    ...
    const ccomplex_t IT_0135 = IT_0085*IT_0134;
    ...
    const ccomplex_t IT_0139 = IT_0029 + IT_0048 + IT_0066 + IT_0080 + 
      -IT_0098 + -IT_0109 + -IT_0120 + IT_0138;
    const ccomplex_t IT_0140 = conj(N_B4)*e_em*U_st_00;
    const ccomplex_t IT_0141 = IT_0012*IT_0140;
    const ccomplex_t IT_0142 = 1.4142135623731*IT_0141;
    const ccomplex_t IT_0143 = conj(N_W4)*e_em*U_st_00;
    const ccomplex_t IT_0144 = IT_0006*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = m_t*conj(N_u4)*e_em*IT_0024*U_st_10;
    const ccomplex_t IT_0147 = IT_0052*IT_0146;
    ...
    const ccomplex_t IT_0154 = conj(N_B4)*e_em*U_st_01;
    const ccomplex_t IT_0155 = IT_0012*IT_0154;
    const ccomplex_t IT_0156 = 1.4142135623731*IT_0155;
    const ccomplex_t IT_0157 = conj(N_W4)*e_em*U_st_01;
    const ccomplex_t IT_0158 = IT_0006*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = m_t*conj(N_u4)*e_em*IT_0024*U_st_11;
    ...
    const ccomplex_t IT_0168 = IT_0006*IT_0058;
    const ccomplex_t IT_0169 = conj(N_u4)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0170 = IT_0168*IT_0169;
    const ccomplex_t IT_0171 = 2*IT_0170;
    const ccomplex_t IT_0172 = IT_0012*IT_0058;
    const ccomplex_t IT_0173 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0174 = IT_0172*IT_0173;
    const ccomplex_t IT_0175 = 1.4142135623731*IT_0174;
    const ccomplex_t IT_0176 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0187 = IT_0105*IT_0182;
    const ccomplex_t IT_0188 = IT_0000*IT_0003*IT_0187;
    const ccomplex_t IT_0189 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0190 = IT_0172*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0196 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0202 = IT_0116*IT_0201;
    const ccomplex_t IT_0203 = IT_0030*IT_0031*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0004*IT_0006*IT_0024*IT_0059;
    const ccomplex_t IT_0205 = 0.5*IT_0204;
    const ccomplex_t IT_0206 = IT_0134*IT_0205;
    const ccomplex_t IT_0207 = IT_0082*IT_0083*IT_0206;
    const ccomplex_t IT_0208 = IT_0046*IT_0201;
    ...
    const ccomplex_t IT_0212 = IT_0096*IT_0205;
    ...
    const ccomplex_t IT_0216 = -IT_0153 + -IT_0167 + -IT_0186 + IT_0188 +
       IT_0203 + IT_0207 + -IT_0211 + -IT_0215;
    const ccomplex_t IT_0217 = 6*s_13;
    const ccomplex_t IT_0218 = m_t*m_N_4;
    const ccomplex_t IT_0219 = 6*IT_0139;
    const ccomplex_t IT_0220 = IT_0108 + IT_0119 + -IT_0214;
    const ccomplex_t IT_0221 = m_t*s_12;
    const ccomplex_t IT_0222 = IT_0137 + IT_0185 + IT_0210;
    const ccomplex_t IT_0223 = s_23*m_N_4;
    const ccomplex_t IT_0224 = 6*conj(IT_0139);
    const ccomplex_t IT_0225 = 6*conj(IT_0216);
    const ccomplex_t IT_0226 = m_t*m_N_4*IT_0002;
    const ccomplex_t IT_0227 = s_13*IT_0002;
    ...
    const ccomplex_t IT_0232 = 6*IT_0216;
    const ccomplex_t IT_0233 = 0.166666666666667*IT_0221;
    const ccomplex_t IT_0234 = 0.166666666666667*IT_0223;
    const ccomplex_t IT_0235 = (IT_0139*conj(IT_0139) + IT_0216*conj(IT_0216))
      *IT_0217 + conj(IT_0216)*IT_0218*IT_0219 + (IT_0216*IT_0218 + IT_0220
      *IT_0221 + IT_0222*IT_0223)*IT_0224 + (IT_0221*IT_0222 + IT_0220*IT_0223)
      *IT_0225 + 6*conj(IT_0222)*(IT_0220*IT_0226 + 0.166666666666667*IT_0222
      *IT_0231 + IT_0232*IT_0233 + IT_0219*IT_0234) + 6*conj(IT_0220)*(IT_0222
      *IT_0226 + 0.166666666666667*IT_0220*IT_0231 + IT_0219*IT_0233 + IT_0232
      *IT_0234);
