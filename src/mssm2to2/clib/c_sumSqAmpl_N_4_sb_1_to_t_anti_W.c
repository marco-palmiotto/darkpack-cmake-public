        ...
        )
{
    ...
    const ccomplex_t IT_0006 = N_B4*e_em*U_st_10;
    ...
    const ccomplex_t IT_0013 = m_t*N_u4*e_em*IT_0012*U_st_00;
    ...
    const ccomplex_t IT_0029 = m_t*N_u4*e_em*IT_0012*U_st_01;
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0018 + IT_0038 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0040 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0018 + IT_0038 + -m_C_1*
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
      *e_em*IT_0001*IT_0010*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0072 = conj(N_B4)*e_em*U_st_01;
    const ccomplex_t IT_0073 = IT_0005*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W4)*e_em*U_st_01;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = m_t*conj(N_u4)*e_em*IT_0012*U_st_11;
    ...
    const ccomplex_t IT_0092 = m_t*conj(N_u4)*e_em*IT_0012*U_st_10;
    ...
    const ccomplex_t IT_0101 = m_t*m_N_4;
    const ccomplex_t IT_0102 = IT_0070*IT_0101;
    const ccomplex_t IT_0103 = -IT_0051 + -IT_0064;
    ...
    const ccomplex_t IT_0108 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0109 = IT_0001*IT_0108;
    const ccomplex_t IT_0110 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0115 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    ...
    const ccomplex_t IT_0120 = m_b*conj(U_d1)*V_tb*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0121 = IT_0119*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*(IT_0116 + (-0.5)*IT_0122);
    ...
    const ccomplex_t IT_0131 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0132 = IT_0001*IT_0131;
    const ccomplex_t IT_0133 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0138 = m_b*conj(U_d2)*V_tb*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0139 = IT_0119*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0142 = IT_0001*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*(IT_0140 + (-2)*IT_0142);
    ...
    const ccomplex_t IT_0149 = pow(m_W, 2);
    const ccomplex_t IT_0150 = IT_0101*IT_0149;
    const ccomplex_t IT_0151 = (-3)*IT_0150;
    const ccomplex_t IT_0152 = 3*IT_0150;
    const ccomplex_t IT_0153 = pow(m_b, 2);
    const ccomplex_t IT_0154 = cpow((-2)*s_12 + -IT_0019 + -IT_0038 + IT_0153 
      + -reg_prop, -1);
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001;
    const ccomplex_t IT_0156 = 0.5*IT_0155;
    const ccomplex_t IT_0157 = m_b*conj(N_d4)*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0158 = IT_0119*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0161 = IT_0001*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0174 = -IT_0023 + -IT_0037;
    const ccomplex_t IT_0175 = s_14*IT_0018;
    const ccomplex_t IT_0176 = s_13*s_34;
    ...
    const ccomplex_t IT_0184 = s_13*IT_0149;
    const ccomplex_t IT_0185 = (-12)*IT_0184;
    const ccomplex_t IT_0186 = 6*IT_0181 + IT_0183 + IT_0185;
    const ccomplex_t IT_0187 = s_14*IT_0149;
    const ccomplex_t IT_0188 = IT_0066*IT_0187;
    ...
    const ccomplex_t IT_0193 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0194 = IT_0059*IT_0127;
    const ccomplex_t IT_0195 = IT_0052*IT_0193*IT_0194;
    const ccomplex_t IT_0196 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0197 = IT_0046*IT_0144;
    const ccomplex_t IT_0198 = IT_0039*IT_0196*IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*m_b;
    ...
    const ccomplex_t IT_0203 = m_b*N_d4*e_em*IT_0012*U_sb_00;
    const ccomplex_t IT_0204 = IT_0119*IT_0203;
    ...
    const ccomplex_t IT_0210 = IT_0156*IT_0209;
    const ccomplex_t IT_0211 = IT_0154*IT_0199*IT_0210;
    const ccomplex_t IT_0212 = -IT_0195 + -IT_0198 + -IT_0211;
    const ccomplex_t IT_0213 = IT_0130 + IT_0147;
    const ccomplex_t IT_0214 = m_N_4*IT_0213;
    const ccomplex_t IT_0215 = IT_0212 + IT_0214;
    const ccomplex_t IT_0216 = s_34*IT_0149;
    ...
    const ccomplex_t IT_0222 = m_N_4*IT_0064;
    const ccomplex_t IT_0223 = m_N_4*IT_0051;
    const ccomplex_t IT_0224 = m_t*IT_0173;
    const ccomplex_t IT_0225 = -IT_0222 + -IT_0223 + -IT_0224;
    const ccomplex_t IT_0226 = IT_0061*IT_0114;
    const ccomplex_t IT_0227 = IT_0052*IT_0193*IT_0226;
    const ccomplex_t IT_0228 = IT_0048*IT_0137;
    const ccomplex_t IT_0229 = IT_0039*IT_0196*IT_0228;
    const ccomplex_t IT_0230 = IT_0227 + IT_0229;
    const ccomplex_t IT_0231 = IT_0225 + IT_0230;
    const ccomplex_t IT_0232 = 6*conj(IT_0103)*(IT_0065*IT_0107 + -IT_0148
      *IT_0151 + IT_0152*IT_0173 + IT_0174*IT_0178 + 0.166666666666667*IT_0103
      *IT_0186 + IT_0192*IT_0215 + IT_0221*IT_0231);
    const ccomplex_t IT_0233 = (-18)*conj(IT_0212);
    const ccomplex_t IT_0234 = s_14*s_34*IT_0066;
    const ccomplex_t IT_0235 = -IT_0234;
    const ccomplex_t IT_0236 = s_13 + IT_0235;
    const ccomplex_t IT_0237 = s_13*IT_0236;
    const ccomplex_t IT_0238 = 2*IT_0130 + 2*IT_0147;
    const ccomplex_t IT_0239 = IT_0085 + IT_0099 + 2*IT_0173;
    const ccomplex_t IT_0240 = IT_0101*IT_0236;
    const ccomplex_t IT_0241 = m_N_4*IT_0236;
    const ccomplex_t IT_0242 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0243 = 0.5*IT_0217;
    const ccomplex_t IT_0244 = s_34 + IT_0243;
    const ccomplex_t IT_0245 = m_N_4*IT_0244;
    const ccomplex_t IT_0246 = 2*IT_0245;
    const ccomplex_t IT_0247 = (-2)*IT_0182;
    const ccomplex_t IT_0248 = IT_0184 + IT_0247;
    const ccomplex_t IT_0249 = IT_0066*IT_0248;
    const ccomplex_t IT_0250 = (-6)*IT_0249;
    const ccomplex_t IT_0251 = 12*s_13;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_t*IT_0236;
    const ccomplex_t IT_0254 = (-6)*IT_0174;
    const ccomplex_t IT_0255 = pow(s_34, 2);
    const ccomplex_t IT_0256 = IT_0066*IT_0255;
    const ccomplex_t IT_0257 = -IT_0256;
    const ccomplex_t IT_0258 = IT_0018 + IT_0257;
    const ccomplex_t IT_0259 = IT_0101*IT_0258;
    const ccomplex_t IT_0260 = m_N_4*IT_0258;
    const ccomplex_t IT_0261 = (-6)*conj(IT_0174);
    const ccomplex_t IT_0262 = (-6)*IT_0181;
    const ccomplex_t IT_0263 = IT_0183 + IT_0262;
    const ccomplex_t IT_0264 = (-6)*IT_0100;
    const ccomplex_t IT_0265 = 0.166666666666667*IT_0264;
    const ccomplex_t IT_0266 = IT_0238 + IT_0265;
    const ccomplex_t IT_0267 = (-0.25)*IT_0188;
    const ccomplex_t IT_0268 = s_14 + IT_0267;
    const ccomplex_t IT_0269 = m_t*IT_0268;
    const ccomplex_t IT_0270 = (-4)*IT_0269;
    const ccomplex_t IT_0271 = (-6)*IT_0239;
    const ccomplex_t IT_0272 = IT_0148 + IT_0173;
    const ccomplex_t IT_0273 = (-6)*conj(IT_0239);
    const ccomplex_t IT_0274 = (-6)*IT_0212;
    const ccomplex_t IT_0275 = (-6)*conj(IT_0148)*(IT_0103*IT_0151 + (
      -0.166666666666667)*IT_0148*IT_0186 + IT_0192*IT_0231 + (
      -0.166666666666667)*IT_0173*IT_0263 + -IT_0107*IT_0266 + (
      -0.166666666666667)*IT_0178*IT_0271 + IT_0221*(IT_0214 + (
      -0.166666666666667)*IT_0274));
    const ccomplex_t IT_0276 = (-6)*conj(IT_0212);
    const ccomplex_t IT_0277 = (-6)*conj(IT_0238);
    const ccomplex_t IT_0278 = m_t*IT_0070;
    const ccomplex_t IT_0279 = 6*IT_0278;
    const ccomplex_t IT_0280 = (-6)*IT_0065;
    const ccomplex_t IT_0281 = 6*IT_0103;
    const ccomplex_t IT_0282 = (-6)*IT_0238;
    const ccomplex_t IT_0283 = 6*IT_0173;
    const ccomplex_t IT_0284 = (-6)*IT_0148;
    const ccomplex_t IT_0285 = IT_0101*((-18)*IT_0212 + (-18)*IT_0214) +
       IT_0231*IT_0252 + IT_0254*IT_0260 + IT_0253*IT_0271 + IT_0241*IT_0280 +
       IT_0221*IT_0281 + IT_0279*(IT_0100 + 0.166666666666667*IT_0282) + IT_0270
      *IT_0283 + IT_0192*IT_0284;
    const ccomplex_t IT_0286 = IT_0101*((-18)*IT_0225 + (-18)*IT_0230) +
       IT_0215*IT_0252 + IT_0253*IT_0254 + 6*IT_0241*IT_0266 + IT_0260*IT_0271 +
       6*IT_0065*IT_0278 + IT_0192*IT_0281 + IT_0246*IT_0283 + IT_0221*IT_0284;
    const ccomplex_t IT_0287 = 0.166666666666667*IT_0240;
    const ccomplex_t IT_0288 = s_13*IT_0258;
    const ccomplex_t IT_0289 = 0.166666666666667*IT_0288;
    const ccomplex_t IT_0290 = (-6)*conj(IT_0100);
    const ccomplex_t IT_0291 = IT_0107*IT_0272;
    const ccomplex_t IT_0292 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0100
      *IT_0102 + IT_0103*IT_0107) + IT_0232 + IT_0101*IT_0231*IT_0233 + (IT_0174
      *IT_0237 + IT_0102*IT_0238 + IT_0239*IT_0240 + IT_0231*IT_0241)*IT_0242 +
       6*conj(IT_0212)*(IT_0103*IT_0192 + IT_0238*IT_0241 + IT_0173*IT_0246 +
       0.166666666666667*IT_0215*IT_0252 + 0.166666666666667*IT_0253*IT_0254) + 
      (IT_0100*IT_0240 + IT_0215*IT_0253 + IT_0239*IT_0259 + IT_0231*IT_0260)
      *IT_0261 + 6*conj(IT_0173)*(IT_0103*IT_0152 + 0.166666666666667*IT_0173
      *IT_0186 + IT_0215*IT_0246 + 0.166666666666667*IT_0148*IT_0263 + IT_0107
      *IT_0266 + IT_0231*IT_0270 + 0.166666666666667*IT_0178*IT_0271) + (IT_0231
      *IT_0253 + IT_0214*IT_0260 + IT_0178*IT_0272)*IT_0273 + IT_0275 + (IT_0148
      *IT_0221 + IT_0100*IT_0241 + IT_0239*IT_0260)*IT_0276 + (IT_0065*conj
      (IT_0212) + conj(IT_0065)*IT_0215 + IT_0231*(conj(IT_0100) +
       0.166666666666667*IT_0277))*IT_0279 + (conj(IT_0225) + conj(IT_0230))
      *IT_0285 + conj(IT_0214)*IT_0286 + 6*conj(IT_0100)*(IT_0071*IT_0100 +
       IT_0065*IT_0102 + 0.166666666666667*IT_0241*IT_0274 + IT_0254*IT_0287) +
       6*conj(IT_0174)*(IT_0103*IT_0178 + IT_0238*IT_0240 + 0.166666666666667
      *IT_0237*IT_0280 + IT_0254*IT_0289) + 6*conj(IT_0239)*(0.166666666666667
      *IT_0254*IT_0259 + IT_0237*IT_0266 + 0.166666666666667*IT_0260*IT_0274 +
       IT_0280*IT_0287 + IT_0271*IT_0289) + IT_0290*(IT_0071*IT_0238 + IT_0237
      *IT_0239 + IT_0214*IT_0241 + IT_0291) + 6*conj(IT_0238)*(IT_0237*IT_0239 +
       IT_0174*IT_0240 + IT_0215*IT_0241 + IT_0071*IT_0266 + 0.166666666666667
      *IT_0102*IT_0280 + IT_0291);
