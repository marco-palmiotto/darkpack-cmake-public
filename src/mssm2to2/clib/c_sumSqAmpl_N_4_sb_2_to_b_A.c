        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_B4*e_em*U_sb_11;
    ...
    const ccomplex_t IT_0017 = m_b*N_d4*e_em*IT_0016*U_sb_01;
    ...
    const ccomplex_t IT_0031 = m_b*conj(N_d4)*e_em*IT_0016*U_sb_11;
    ...
    const ccomplex_t IT_0037 = conj(N_B4)*e_em*U_sb_01;
