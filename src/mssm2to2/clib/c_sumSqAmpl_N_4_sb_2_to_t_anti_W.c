...
ccomplex_return_t c_sumSqAmpl_N_4_sb_2_to_t_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u2
      *e_em*IT_0004*IT_0012*IT_0014*U_sb_01;
    ...
    const ccomplex_t IT_0043 = m_t*N_u4*e_em*IT_0012*U_st_01;
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0000 + IT_0033 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0047*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = IT_0039*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_C_1*
    ...
    const ccomplex_t IT_0103 = -IT_0019 + -IT_0064;
    const ccomplex_t IT_0104 = s_13*s_14;
    const ccomplex_t IT_0105 = s_34*IT_0033;
    ...
    const ccomplex_t IT_0118 = m_b*conj(U_d1)*V_tb*e_em*IT_0012*U_sb_11;
    const ccomplex_t IT_0119 = IT_0117*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = V_tb*e_em*conj(U_Wm1)*U_sb_01;
    ...
    const ccomplex_t IT_0128 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0129 = IT_0004*IT_0128;
    const ccomplex_t IT_0130 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0135 = m_b*conj(U_d2)*V_tb*e_em*IT_0012*U_sb_11;
    const ccomplex_t IT_0136 = IT_0117*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = V_tb*e_em*conj(U_Wm2)*U_sb_01;
    ...
    const ccomplex_t IT_0169 = -IT_0037 + -IT_0051;
    const ccomplex_t IT_0170 = s_14*IT_0000;
    ...
    const ccomplex_t IT_0189 = IT_0059*IT_0124;
    const ccomplex_t IT_0190 = IT_0052*IT_0188*IT_0189;
    ...
    const ccomplex_t IT_0195 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0196 = IT_0023*IT_0195;
    const ccomplex_t IT_0197 = 1.4142135623731*IT_0196;
    const ccomplex_t IT_0198 = m_b*N_d4*e_em*IT_0012*U_sb_01;
    ...
    const ccomplex_t IT_0206 = IT_0151*IT_0194*IT_0205;
    const ccomplex_t IT_0207 = -IT_0190 + -IT_0193 + -IT_0206;
    const ccomplex_t IT_0208 = IT_0127 + IT_0144;
    const ccomplex_t IT_0209 = m_N_4*IT_0208;
    const ccomplex_t IT_0210 = IT_0207 + IT_0209;
    const ccomplex_t IT_0211 = s_34*IT_0146;
    ...
    const ccomplex_t IT_0217 = m_N_4*IT_0064;
    const ccomplex_t IT_0218 = m_N_4*IT_0019;
    const ccomplex_t IT_0219 = m_t*IT_0168;
    const ccomplex_t IT_0220 = -IT_0217 + -IT_0218 + -IT_0219;
    const ccomplex_t IT_0221 = IT_0016*IT_0134;
    const ccomplex_t IT_0222 = IT_0002*IT_0191*IT_0221;
    const ccomplex_t IT_0223 = IT_0061*IT_0114;
    const ccomplex_t IT_0224 = IT_0052*IT_0188*IT_0223;
    const ccomplex_t IT_0225 = IT_0222 + IT_0224;
    const ccomplex_t IT_0226 = IT_0220 + IT_0225;
    const ccomplex_t IT_0227 = 6*conj(IT_0103)*(IT_0065*IT_0107 + -IT_0145
      *IT_0148 + IT_0149*IT_0168 + IT_0169*IT_0173 + 0.166666666666667*IT_0103
      *IT_0181 + IT_0187*IT_0210 + IT_0216*IT_0226);
    const ccomplex_t IT_0228 = (-18)*conj(IT_0207);
    const ccomplex_t IT_0229 = s_14*s_34*IT_0066;
    const ccomplex_t IT_0230 = -IT_0229;
    const ccomplex_t IT_0231 = s_13 + IT_0230;
    const ccomplex_t IT_0232 = s_13*IT_0231;
    const ccomplex_t IT_0233 = 2*IT_0127 + 2*IT_0144;
    const ccomplex_t IT_0234 = IT_0085 + IT_0099 + 2*IT_0168;
    const ccomplex_t IT_0235 = IT_0101*IT_0231;
    const ccomplex_t IT_0236 = m_N_4*IT_0231;
    const ccomplex_t IT_0237 = (-6)*conj(IT_0065);
    ...
    const ccomplex_t IT_0242 = (-2)*IT_0177;
    const ccomplex_t IT_0243 = IT_0179 + IT_0242;
    ...
    const ccomplex_t IT_0248 = m_t*IT_0231;
    const ccomplex_t IT_0249 = (-6)*IT_0169;
    ...
    const ccomplex_t IT_0255 = m_N_4*IT_0253;
    const ccomplex_t IT_0256 = (-6)*conj(IT_0169);
    const ccomplex_t IT_0257 = (-6)*IT_0176;
    const ccomplex_t IT_0258 = IT_0178 + IT_0257;
    ...
    const ccomplex_t IT_0262 = (-0.25)*IT_0183;
    const ccomplex_t IT_0263 = s_14 + IT_0262;
    const ccomplex_t IT_0264 = m_t*IT_0263;
    const ccomplex_t IT_0265 = (-4)*IT_0264;
    const ccomplex_t IT_0266 = (-6)*IT_0234;
    const ccomplex_t IT_0267 = IT_0145 + IT_0168;
    const ccomplex_t IT_0268 = (-6)*conj(IT_0234);
    const ccomplex_t IT_0269 = (-6)*IT_0207;
    const ccomplex_t IT_0270 = (-6)*conj(IT_0145)*(IT_0103*IT_0148 + (
      -0.166666666666667)*IT_0145*IT_0181 + IT_0187*IT_0226 + (
      -0.166666666666667)*IT_0168*IT_0258 + -IT_0107*IT_0261 + (
      -0.166666666666667)*IT_0173*IT_0266 + IT_0216*(IT_0209 + (
      -0.166666666666667)*IT_0269));
    const ccomplex_t IT_0271 = (-6)*conj(IT_0207);
    const ccomplex_t IT_0272 = (-6)*conj(IT_0233);
    const ccomplex_t IT_0273 = m_t*IT_0070;
    const ccomplex_t IT_0274 = 6*IT_0273;
    const ccomplex_t IT_0275 = (-6)*IT_0065;
    const ccomplex_t IT_0276 = 6*IT_0103;
    const ccomplex_t IT_0277 = (-6)*IT_0233;
    const ccomplex_t IT_0278 = 6*IT_0168;
    const ccomplex_t IT_0279 = (-6)*IT_0145;
    const ccomplex_t IT_0280 = IT_0101*((-18)*IT_0207 + (-18)*IT_0209) +
       IT_0226*IT_0247 + IT_0249*IT_0255 + IT_0248*IT_0266 + IT_0236*IT_0275 +
       IT_0216*IT_0276 + IT_0274*(IT_0100 + 0.166666666666667*IT_0277) + IT_0265
      *IT_0278 + IT_0187*IT_0279;
    const ccomplex_t IT_0281 = IT_0101*((-18)*IT_0220 + (-18)*IT_0225) +
       IT_0210*IT_0247 + IT_0248*IT_0249 + 6*IT_0236*IT_0261 + IT_0255*IT_0266 +
       6*IT_0065*IT_0273 + IT_0187*IT_0276 + IT_0241*IT_0278 + IT_0216*IT_0279;
    const ccomplex_t IT_0282 = 0.166666666666667*IT_0235;
    const ccomplex_t IT_0283 = s_13*IT_0253;
    const ccomplex_t IT_0284 = 0.166666666666667*IT_0283;
    const ccomplex_t IT_0285 = (-6)*conj(IT_0100);
    const ccomplex_t IT_0286 = IT_0107*IT_0267;
    const ccomplex_t IT_0287 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0100
      *IT_0102 + IT_0103*IT_0107) + IT_0227 + IT_0101*IT_0226*IT_0228 + (IT_0169
      *IT_0232 + IT_0102*IT_0233 + IT_0234*IT_0235 + IT_0226*IT_0236)*IT_0237 +
       6*conj(IT_0207)*(IT_0103*IT_0187 + IT_0233*IT_0236 + IT_0168*IT_0241 +
       0.166666666666667*IT_0210*IT_0247 + 0.166666666666667*IT_0248*IT_0249) + 
      (IT_0100*IT_0235 + IT_0210*IT_0248 + IT_0234*IT_0254 + IT_0226*IT_0255)
      *IT_0256 + 6*conj(IT_0168)*(IT_0103*IT_0149 + 0.166666666666667*IT_0168
      *IT_0181 + IT_0210*IT_0241 + 0.166666666666667*IT_0145*IT_0258 + IT_0107
      *IT_0261 + IT_0226*IT_0265 + 0.166666666666667*IT_0173*IT_0266) + (IT_0226
      *IT_0248 + IT_0209*IT_0255 + IT_0173*IT_0267)*IT_0268 + IT_0270 + (IT_0145
      *IT_0216 + IT_0100*IT_0236 + IT_0234*IT_0255)*IT_0271 + (IT_0065*conj
      (IT_0207) + conj(IT_0065)*IT_0210 + IT_0226*(conj(IT_0100) +
       0.166666666666667*IT_0272))*IT_0274 + (conj(IT_0220) + conj(IT_0225))
      *IT_0280 + conj(IT_0209)*IT_0281 + 6*conj(IT_0100)*(IT_0071*IT_0100 +
       IT_0065*IT_0102 + 0.166666666666667*IT_0236*IT_0269 + IT_0249*IT_0282) +
       6*conj(IT_0169)*(IT_0103*IT_0173 + IT_0233*IT_0235 + 0.166666666666667
      *IT_0232*IT_0275 + IT_0249*IT_0284) + 6*conj(IT_0234)*(0.166666666666667
      *IT_0249*IT_0254 + IT_0232*IT_0261 + 0.166666666666667*IT_0255*IT_0269 +
       IT_0275*IT_0282 + IT_0266*IT_0284) + IT_0285*(IT_0071*IT_0233 + IT_0232
      *IT_0234 + IT_0209*IT_0236 + IT_0286) + 6*conj(IT_0233)*(IT_0232*IT_0234 +
       IT_0169*IT_0235 + IT_0210*IT_0236 + IT_0071*IT_0261 + 0.166666666666667
      *IT_0102*IT_0275 + IT_0286);
