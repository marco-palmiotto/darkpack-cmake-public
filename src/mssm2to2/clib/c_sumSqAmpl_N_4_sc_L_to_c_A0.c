...
ccomplex_return_t c_sumSqAmpl_N_4_sc_L_to_c_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0006;
    ...
    const ccomplex_t IT_0121 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0154 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0155 = IT_0024*IT_0154;
    const ccomplex_t IT_0156 = conj(N_B3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0162 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0163 = IT_0024*IT_0162;
    const ccomplex_t IT_0164 = conj(N_B4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0002*IT_0016;
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0010 + IT_0019 + -m_N_3*
    ...
    const ccomplex_t IT_0180 = 6*s_13;
    const ccomplex_t IT_0181 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0019 
      + -reg_prop, -1);
    const ccomplex_t IT_0182 = conj(N_B4)*e_em;
    const ccomplex_t IT_0183 = IT_0006*IT_0182;
    const ccomplex_t IT_0184 = 1.4142135623731*IT_0183;
    const ccomplex_t IT_0185 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0190 = m_c*e_em*IT_0000*IT_0002*IT_0016*IT_0023;
    ...
    const ccomplex_t IT_0217 = IT_0152*IT_0216;
    const ccomplex_t IT_0218 = conj(N_B1)*e_em;
    const ccomplex_t IT_0219 = IT_0006*IT_0218;
    const ccomplex_t IT_0220 = 1.4142135623731*IT_0219;
    const ccomplex_t IT_0221 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0226 = IT_0089*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*IT_0226;
    const ccomplex_t IT_0228 = IT_0066*IT_0227;
    const ccomplex_t IT_0229 = conj(N_B2)*e_em;
    const ccomplex_t IT_0230 = IT_0006*IT_0229;
    const ccomplex_t IT_0231 = 1.4142135623731*IT_0230;
    const ccomplex_t IT_0232 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0239 = IT_0109*IT_0238;
    const ccomplex_t IT_0240 = -IT_0203 + IT_0206 + IT_0217 + IT_0228 + IT_0239;
    const ccomplex_t IT_0241 = s_34*m_N_4;
    const ccomplex_t IT_0242 = m_N_4*IT_0066;
    const ccomplex_t IT_0243 = m_N_1*IT_0084;
    const ccomplex_t IT_0244 = IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = IT_0227*IT_0244;
    const ccomplex_t IT_0246 = m_N_4*IT_0152;
    const ccomplex_t IT_0247 = m_N_3*IT_0170;
    const ccomplex_t IT_0248 = IT_0246 + IT_0247;
    const ccomplex_t IT_0249 = IT_0216*IT_0248;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
    ...
    const ccomplex_t IT_0255 = IT_0048*IT_0205;
    const ccomplex_t IT_0256 = m_N_4*IT_0109;
    const ccomplex_t IT_0257 = m_N_2*IT_0127;
    const ccomplex_t IT_0258 = IT_0256 + IT_0257;
    const ccomplex_t IT_0259 = IT_0238*IT_0258;
    const ccomplex_t IT_0260 = -IT_0245 + -IT_0249 + -IT_0254 + -IT_0255 + 
      -IT_0259;
    const ccomplex_t IT_0261 = 6*conj(IT_0260);
    const ccomplex_t IT_0262 = m_c*m_N_4;
    const ccomplex_t IT_0263 = 6*IT_0179;
    const ccomplex_t IT_0264 = 6*conj(IT_0179);
    const ccomplex_t IT_0265 = pow(m_A0, 2);
    const ccomplex_t IT_0266 = m_c*m_N_4*IT_0265;
    ...
    const ccomplex_t IT_0271 = 6*IT_0260;
    const ccomplex_t IT_0272 = 0.166666666666667*IT_0241;
    const ccomplex_t IT_0273 = IT_0179*conj(IT_0179)*IT_0180 + (IT_0199
      ...
      *IT_0264 + 6*conj(IT_0199)*(IT_0240*IT_0266 + -IT_0199*IT_0270 +
       0.166666666666667*IT_0200*IT_0271 + IT_0263*IT_0272) + 6*conj(IT_0240)*
      (0.166666666666667*IT_0200*IT_0263 + IT_0199*IT_0266 + -IT_0240*IT_0270 +
       IT_0271*IT_0272);
