        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B4*N_u4*e_em;
    const ccomplex_t IT_0018 = IT_0016*IT_0017;
    const ccomplex_t IT_0019 = sin(beta);
    const ccomplex_t IT_0020 = IT_0006*IT_0019;
    const ccomplex_t IT_0021 = N_B4*N_d4*e_em;
    const ccomplex_t IT_0022 = IT_0020*IT_0021;
    const ccomplex_t IT_0023 = IT_0002*IT_0015;
    const ccomplex_t IT_0024 = N_W4*N_u4*e_em;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = IT_0002*IT_0019;
    const ccomplex_t IT_0027 = N_W4*N_d4*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = -IT_0018 + IT_0022 + IT_0025 + -IT_0028;
    const ccomplex_t IT_0030 = m_N_4*IT_0029;
    const ccomplex_t IT_0031 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0032 = IT_0016*IT_0031;
    const ccomplex_t IT_0033 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0034 = IT_0020*IT_0033;
    const ccomplex_t IT_0035 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0036 = IT_0023*IT_0035;
    const ccomplex_t IT_0037 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0038 = IT_0026*IT_0037;
    const ccomplex_t IT_0039 = IT_0032 + -IT_0034 + -IT_0036 + IT_0038;
    const ccomplex_t IT_0040 = m_N_4*IT_0039;
    const ccomplex_t IT_0041 = IT_0030 + IT_0040;
    const ccomplex_t IT_0042 = cpow(IT_0019, -1);
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0000*IT_0002*IT_0042;
    const ccomplex_t IT_0044 = (-0.5)*IT_0043;
    const ccomplex_t IT_0045 = pow(m_sc_L, 2);
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_4*
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_1*
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_2*
    ...
    const ccomplex_t IT_0175 = cpow((-2)*s_23 + IT_0010 + IT_0045 + -m_N_3*
    ...
    const ccomplex_t IT_0209 = IT_0041*IT_0208;
    const ccomplex_t IT_0210 = m_N_4*IT_0109;
    const ccomplex_t IT_0211 = m_N_2*IT_0127;
    const ccomplex_t IT_0212 = IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = conj(N_B2)*e_em;
    const ccomplex_t IT_0214 = IT_0006*IT_0213;
    const ccomplex_t IT_0215 = 1.4142135623731*IT_0214;
    const ccomplex_t IT_0216 = conj(N_W2)*e_em;
    const ccomplex_t IT_0217 = IT_0002*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1)*(IT_0215 + 3*IT_0218);
    ...
    const ccomplex_t IT_0234 = m_N_4*IT_0152;
    const ccomplex_t IT_0235 = m_N_3*IT_0170;
    const ccomplex_t IT_0236 = IT_0234 + IT_0235;
    const ccomplex_t IT_0237 = IT_0233*IT_0236;
    const ccomplex_t IT_0238 = -IT_0184 + -IT_0198 + -IT_0209 + -IT_0223 + 
      -IT_0237;
    const ccomplex_t IT_0239 = 6*s_13;
    const ccomplex_t IT_0240 = m_c*m_N_4;
    const ccomplex_t IT_0241 = 6*IT_0179;
    const ccomplex_t IT_0242 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0045 
      + -reg_prop, -1);
    const ccomplex_t IT_0243 = m_c*e_em*IT_0000*IT_0002*IT_0015*IT_0042;
    ...
    const ccomplex_t IT_0248 = IT_0109*IT_0222;
    const ccomplex_t IT_0249 = IT_0152*IT_0233;
    const ccomplex_t IT_0250 = IT_0029*IT_0208;
    const ccomplex_t IT_0251 = IT_0066*IT_0194;
    const ccomplex_t IT_0252 = -IT_0247 + IT_0248 + IT_0249 + IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = m_c*s_14;
    const ccomplex_t IT_0254 = IT_0039*IT_0048;
    const ccomplex_t IT_0255 = IT_0127*IT_0134;
    const ccomplex_t IT_0256 = IT_0206*IT_0244;
    const ccomplex_t IT_0257 = IT_0242*IT_0256;
    const ccomplex_t IT_0258 = (0 + _Complex_I*1)*IT_0257;
    const ccomplex_t IT_0259 = IT_0170*IT_0177;
    const ccomplex_t IT_0260 = IT_0084*IT_0091;
    const ccomplex_t IT_0261 = -IT_0254 + -IT_0255 + -IT_0258 + -IT_0259 + 
      -IT_0260;
    const ccomplex_t IT_0262 = s_34*m_N_4;
