...
ccomplex_return_t c_sumSqAmpl_N_4_sc_L_to_c_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
    ...
    const ccomplex_t IT_0047 = m_c*s_14*m_N_4;
    ...
    const ccomplex_t IT_0057 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0062 = m_c*s_34*m_N_4;
