        ...
        )
{
    ...
    const ccomplex_t IT_0045 = IT_0004*IT_0033;
    ...
    const ccomplex_t IT_0156 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0157 = IT_0034*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0159 = IT_0045*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0161 = IT_0048*IT_0160;
    const ccomplex_t IT_0162 = conj(N_W4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0169 = (-0.5)*IT_0168;
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0001 + IT_0020 + -m_N_3*
    ...
    const ccomplex_t IT_0219 = IT_0019 + (-2)*IT_0027 + IT_0083 + IT_0134 +
    ...
    const ccomplex_t IT_0234 = IT_0136*IT_0233;
    const ccomplex_t IT_0235 = IT_0140*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*IT_0235;
    const ccomplex_t IT_0237 = m_N_1*IT_0080;
    const ccomplex_t IT_0238 = m_N_4*IT_0058;
    ...
    const ccomplex_t IT_0272 = IT_0033*IT_0271;
    ...
    const ccomplex_t IT_0285 = 2*IT_0231 + -IT_0236 + -IT_0250 + -IT_0264 + 
    ...
    const ccomplex_t IT_0289 = IT_0109*IT_0260;
    const ccomplex_t IT_0290 = IT_0215*IT_0280;
    const ccomplex_t IT_0291 = IT_0058*IT_0249;
    const ccomplex_t IT_0292 = IT_0154*IT_0269;
    const ccomplex_t IT_0293 = -IT_0026 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_c*s_14;
    const ccomplex_t IT_0295 = IT_0172*IT_0193;
    const ccomplex_t IT_0296 = IT_0145*IT_0164;
    const ccomplex_t IT_0297 = IT_0032*IT_0080;
    const ccomplex_t IT_0298 = IT_0088*IT_0131;
