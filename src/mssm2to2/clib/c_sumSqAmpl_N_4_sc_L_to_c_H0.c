...
ccomplex_return_t c_sumSqAmpl_N_4_sc_L_to_c_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0232 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
    ...
    const ccomplex_t IT_0287 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0304 = m_c*m_N_4*IT_0303;
