        ...
        )
{
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0006*IT_0014*IT_0016;
    ...
    const ccomplex_t IT_0228 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0236 = cpow((-2)*s_13 + IT_0019 + IT_0168 + -m_sc_L*
    ...
    const ccomplex_t IT_0244 = IT_0024 + IT_0243;
    const ccomplex_t IT_0245 = 6*IT_0244;
    const ccomplex_t IT_0246 = IT_0027 + 2*IT_0041 + 2*IT_0055 + 2*IT_0069;
    ...
    const ccomplex_t IT_0252 = -IT_0083 + (-2)*IT_0102 + (-2)*IT_0121 + (-2)
      *IT_0140;
    ...
    const ccomplex_t IT_0259 = m_c*IT_0232;
    ...
    const ccomplex_t IT_0270 = (-2)*IT_0181 + -IT_0243;
    const ccomplex_t IT_0271 = 2*IT_0207 + IT_0239;
    ...
    const ccomplex_t IT_0284 = IT_0070 + IT_0282;
    const ccomplex_t IT_0285 = conj(IT_0141) + conj(IT_0207);
    const ccomplex_t IT_0286 = IT_0141 + IT_0207;
    const ccomplex_t IT_0287 = IT_0149*IT_0228;
    const ccomplex_t IT_0288 = 3*IT_0287;
    const ccomplex_t IT_0289 = IT_0146 + IT_0154;
    const ccomplex_t IT_0290 = IT_0148 + IT_0153;
    const ccomplex_t IT_0291 = s_34*IT_0149;
    ...
    const ccomplex_t IT_0297 = 6*IT_0183;
    const ccomplex_t IT_0298 = 6*IT_0199;
    const ccomplex_t IT_0299 = IT_0297 + IT_0298;
    const ccomplex_t IT_0300 = s_14*IT_0149;
    const ccomplex_t IT_0301 = IT_0142*IT_0300;
    const ccomplex_t IT_0302 = (-0.25)*IT_0301;
    const ccomplex_t IT_0303 = s_14 + IT_0302;
    const ccomplex_t IT_0304 = m_c*IT_0303;
    ...
    const ccomplex_t IT_0309 = (-0.25)*IT_0292;
    const ccomplex_t IT_0310 = s_34 + IT_0309;
    const ccomplex_t IT_0311 = m_N_4*IT_0310;
    const ccomplex_t IT_0312 = (-4)*IT_0311;
    const ccomplex_t IT_0313 = 6*conj(IT_0183);
    const ccomplex_t IT_0314 = 6*conj(IT_0199);
    const ccomplex_t IT_0315 = IT_0313 + IT_0314;
    const ccomplex_t IT_0316 = 6*conj(IT_0209);
    const ccomplex_t IT_0317 = 6*conj(IT_0225);
    const ccomplex_t IT_0318 = IT_0316 + IT_0317;
    const ccomplex_t IT_0319 = (-6)*IT_0183;
    const ccomplex_t IT_0320 = (-6)*IT_0199;
    const ccomplex_t IT_0321 = IT_0319 + IT_0320;
    const ccomplex_t IT_0322 = (-6)*conj(IT_0183);
    const ccomplex_t IT_0323 = (-6)*conj(IT_0199);
    const ccomplex_t IT_0324 = IT_0322 + IT_0323;
    const ccomplex_t IT_0325 = (-6)*IT_0209;
    const ccomplex_t IT_0326 = (-6)*IT_0225;
    const ccomplex_t IT_0327 = IT_0325 + IT_0326;
    const ccomplex_t IT_0328 = (-6)*conj(IT_0209);
    const ccomplex_t IT_0329 = (-6)*conj(IT_0225);
    const ccomplex_t IT_0330 = IT_0328 + IT_0329;
    const ccomplex_t IT_0331 = 0.5*IT_0301;
    const ccomplex_t IT_0332 = s_14 + IT_0331;
    const ccomplex_t IT_0333 = m_c*IT_0332;
    const ccomplex_t IT_0334 = 2*IT_0333;
    const ccomplex_t IT_0335 = 6*IT_0282;
    const ccomplex_t IT_0336 = 6*conj(IT_0282);
    const ccomplex_t IT_0337 = (-3)*IT_0287;
    const ccomplex_t IT_0338 = 6*conj(IT_0025);
    const ccomplex_t IT_0339 = (-0.166666666666667)*IT_0338;
    const ccomplex_t IT_0340 = conj(IT_0070) + IT_0339;
    const ccomplex_t IT_0341 = (-6)*IT_0337*((conj(IT_0025) + -conj(IT_0070))
      *IT_0141 + -(IT_0025 + -IT_0070)*(conj(IT_0082) + -conj(IT_0141)) + (
      -0.166666666666667)*conj(IT_0207)*IT_0335 + (-0.166666666666667)*IT_0207
      *IT_0336 + IT_0082*IT_0340);
    const ccomplex_t IT_0342 = (-18)*conj(IT_0183);
    const ccomplex_t IT_0343 = s_13*IT_0232;
    const ccomplex_t IT_0344 = IT_0228*IT_0268;
    const ccomplex_t IT_0345 = 6*IT_0270;
    const ccomplex_t IT_0346 = 6*conj(IT_0270);
    const ccomplex_t IT_0347 = (-6)*IT_0270;
    const ccomplex_t IT_0348 = (-6)*conj(IT_0270);
    ...
    const ccomplex_t IT_0353 = IT_0228*IT_0352;
    const ccomplex_t IT_0354 = s_13*IT_0352;
    const ccomplex_t IT_0355 = (-6)*IT_0271;
    const ccomplex_t IT_0356 = m_c*IT_0268;
    const ccomplex_t IT_0357 = (-6)*conj(IT_0271);
    ...
    const ccomplex_t IT_0362 = conj(IT_0082)*IT_0271 + IT_0082*conj(IT_0271) +
       0.166666666666667*conj(IT_0025)*IT_0345 + 0.166666666666667*IT_0025
      *IT_0346 + 0.166666666666667*IT_0283*IT_0347 + 0.166666666666667*IT_0284
      *IT_0348 + 0.166666666666667*IT_0285*IT_0355 + 0.166666666666667*IT_0286
      *IT_0357;
    const ccomplex_t IT_0363 = m_N_4*IT_0268;
    const ccomplex_t IT_0364 = m_N_4*IT_0352;
    const ccomplex_t IT_0365 = (-0.166666666666667)*IT_0305;
    const ccomplex_t IT_0366 = (-0.166666666666667)*IT_0296;
    const ccomplex_t IT_0367 = (conj(IT_0025)*IT_0070 + IT_0025*conj(IT_0070) 
      ...
      *IT_0262 + IT_0226*IT_0265) + IT_0269*(IT_0258*IT_0270 + IT_0255*conj
      ...
      (IT_0025)*IT_0248 + IT_0025*IT_0251 + conj(IT_0082)*IT_0262 + IT_0082
      *IT_0265 + IT_0255*IT_0283 + IT_0258*IT_0284 + IT_0274*IT_0285 + IT_0277
      *IT_0286) + 6*conj(IT_0207)*((IT_0025 + -IT_0070)*IT_0288 +
       0.166666666666667*IT_0141*IT_0289 + 0.166666666666667*IT_0082*IT_0290 +
       0.166666666666667*IT_0296*IT_0299 + 0.166666666666667*IT_0305*IT_0308) +
       IT_0312*(conj(IT_0082)*IT_0299 + conj(IT_0025)*IT_0308 + IT_0082*IT_0315 
      + IT_0025*IT_0318 + conj(IT_0141)*IT_0321 + IT_0141*IT_0324 + conj(IT_0070
      )*IT_0327 + IT_0070*IT_0330) + (conj(IT_0025)*IT_0299 + conj(IT_0082)
      *IT_0308 + IT_0025*IT_0315 + IT_0082*IT_0318 + conj(IT_0070)*IT_0321 +
       IT_0070*IT_0324 + conj(IT_0141)*IT_0327 + IT_0141*IT_0330)*IT_0334 +
       IT_0288*(conj(IT_0082)*IT_0335 + IT_0082*IT_0336) + IT_0341 + IT_0228*
      (IT_0200*((-18)*conj(IT_0209) + (-18)*conj(IT_0225)) + IT_0226*((-18)*conj
      (IT_0199) + IT_0342)) + (conj(IT_0244)*IT_0245 + conj(IT_0246)*IT_0255 +
       IT_0246*IT_0257 + conj(IT_0240)*IT_0260 + conj(IT_0252)*IT_0274 + IT_0252
      *IT_0276)*IT_0343 + IT_0344*(IT_0258*IT_0271 + IT_0255*conj(IT_0271) +
       conj(IT_0252)*IT_0345 + IT_0252*IT_0346 + conj(IT_0240)*IT_0347 + IT_0240
      *IT_0348) + (conj(IT_0271)*IT_0347 + IT_0271*IT_0348)*IT_0353 + IT_0354*
      (conj(IT_0270)*IT_0347 + conj(IT_0271)*IT_0355) + IT_0356*(IT_0201*IT_0347
       + IT_0200*IT_0348 + IT_0227*IT_0355 + IT_0226*IT_0357) + 6*IT_0361
      *IT_0362 + (IT_0227*IT_0255 + IT_0226*IT_0258 + conj(IT_0199)*IT_0274 +
       IT_0199*IT_0277 + conj(IT_0252)*IT_0297 + IT_0252*IT_0313 + conj(IT_0240)
      *IT_0319 + IT_0240*IT_0322)*IT_0363 + (conj(IT_0271)*IT_0319 + IT_0271
      *IT_0322 + IT_0227*IT_0347 + IT_0226*IT_0348 + conj(IT_0199)*IT_0355 +
       IT_0199*IT_0357)*IT_0364 + (-6)*conj(IT_0282)*((-0.166666666666667)
      *IT_0156*IT_0282 + IT_0141*IT_0288 + (-0.166666666666667)*IT_0070*IT_0289 
      + (-0.166666666666667)*IT_0025*IT_0290 + IT_0299*IT_0365 + IT_0308*IT_0366
      ) + IT_0207*(IT_0156*conj(IT_0207) + conj(IT_0141)*IT_0289 + conj(IT_0082)
      *IT_0290 + (-6)*IT_0288*IT_0340 + (-6)*IT_0318*IT_0365 + (-6)*IT_0315
      *IT_0366) + (-6)*IT_0282*(conj(IT_0141)*IT_0288 + (-0.166666666666667)
      *conj(IT_0070)*IT_0289 + (-0.166666666666667)*conj(IT_0025)*IT_0290 +
       IT_0315*IT_0365 + IT_0318*IT_0366);
