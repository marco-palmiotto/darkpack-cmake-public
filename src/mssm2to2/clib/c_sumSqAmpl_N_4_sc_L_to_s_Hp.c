...
ccomplex_return_t c_sumSqAmpl_N_4_sc_L_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = N_u4*e_em*V_Wp2;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp1)
      *IT_0014;
    const ccomplex_t IT_0047 = N_u4*e_em*V_Wp1;
    const ccomplex_t IT_0048 = IT_0024*IT_0047;
    const ccomplex_t IT_0049 = 2*IT_0048;
    const ccomplex_t IT_0050 = N_B4*V_u1*e_em;
    const ccomplex_t IT_0051 = IT_0030*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = N_W4*V_u1*e_em;
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0000 + IT_0042 + -m_C_1*
    ...
    const ccomplex_t IT_0122 = m_s*m_N_4;
    const ccomplex_t IT_0123 = IT_0087 + IT_0105;
    const ccomplex_t IT_0124 = m_s*IT_0123;
    const ccomplex_t IT_0125 = -IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0127 = IT_0040*IT_0069;
    const ccomplex_t IT_0128 = IT_0043*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0130 = IT_0018*IT_0116;
    const ccomplex_t IT_0131 = IT_0008*IT_0129*IT_0130;
    const ccomplex_t IT_0132 = m_N_4*IT_0119;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0134 = IT_0059*IT_0089;
    const ccomplex_t IT_0135 = IT_0061*IT_0133*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0009*IT_0014;
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0029;
    const ccomplex_t IT_0139 = (-0.333333333333333)*IT_0138;
    const ccomplex_t IT_0140 = IT_0137*IT_0139;
    const ccomplex_t IT_0141 = cpow((-2)*s_13 + IT_0007 + IT_0042 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0142 = IT_0140*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*IT_0142;
    const ccomplex_t IT_0144 = (0 + _Complex_I*(-2.82842712474619))*conj(V_cs)
    ...
    const ccomplex_t IT_0146 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0009*IT_0014*IT_0067;
    const ccomplex_t IT_0147 = (-0.5)*IT_0146;
    const ccomplex_t IT_0148 = IT_0145*IT_0147;
    const ccomplex_t IT_0149 = cpow((-2)*s_13 + IT_0007 + IT_0042 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0150 = IT_0148*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*IT_0150;
    const ccomplex_t IT_0152 = -IT_0128 + -IT_0131 + IT_0132 + -IT_0135 +
       IT_0143 + IT_0151;
    const ccomplex_t IT_0153 = IT_0045 + IT_0063;
    const ccomplex_t IT_0154 = m_s*IT_0153;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*(IT_0109 + (-3)*IT_0112);
    ...
    const ccomplex_t IT_0161 = IT_0023*IT_0084;
    const ccomplex_t IT_0162 = IT_0043*IT_0126*IT_0161;
    const ccomplex_t IT_0163 = IT_0046*IT_0102;
    const ccomplex_t IT_0164 = IT_0061*IT_0133*IT_0163;
    const ccomplex_t IT_0165 = IT_0016*IT_0114;
    const ccomplex_t IT_0166 = IT_0008*IT_0129*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0193 = IT_0005*(IT_0065*IT_0066 + IT_0120*IT_0121) + (
      -6)*IT_0122*(conj(IT_0125)*(IT_0152 + -IT_0155) + IT_0125*(conj(IT_0152) +
      ...
      *IT_0190) + IT_0120*(conj(IT_0064) + 0.166666666666667*IT_0191)) + (conj
      (IT_0152)*IT_0155 + IT_0152*conj(IT_0155) + conj(IT_0125)*IT_0173 +
       IT_0125*conj(IT_0173))*IT_0192;
