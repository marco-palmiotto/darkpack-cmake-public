...
ccomplex_return_t c_sumSqAmpl_N_4_sc_R_to_c_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
    ...
    const ccomplex_t IT_0040 = m_c*s_14*m_N_4;
    ...
    const ccomplex_t IT_0052 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0057 = m_c*s_34*m_N_4;
