...
ccomplex_return_t c_sumSqAmpl_N_4_sc_R_to_c_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0041 = m_c*s_14*m_N_4;
    ...
    const ccomplex_t IT_0051 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0056 = m_c*s_34*m_N_4;
