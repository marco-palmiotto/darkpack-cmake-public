...
ccomplex_return_t c_sumSqAmpl_N_4_sc_R_to_s_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = conj(N_W4)*e_em*V_Wp1;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(N_u4)*V_u1*e_em;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
    ...
    const ccomplex_t IT_0035 = N_W4*e_em*conj(U_Wm1);
    const ccomplex_t IT_0036 = IT_0004*IT_0035;
    const ccomplex_t IT_0037 = N_d4*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0044 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0045 = IT_0004*IT_0044;
    const ccomplex_t IT_0046 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0054 = pow(m_c, 2);
    const ccomplex_t IT_0055 = pow(m_N_4, 2);
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + -IT_0016 + IT_0054 + -IT_0055 
      + -reg_prop, -1);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*m_c;
    ...
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0004;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
    ...
    const ccomplex_t IT_0077 = m_s*IT_0076;
    ...
    const ccomplex_t IT_0104 = m_s*IT_0070;
    ...
    const ccomplex_t IT_0144 = m_s*m_N_4;
