...
ccomplex_return_t c_sumSqAmpl_N_4_sd_L_to_d_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0046 = m_d*s_14*m_N_4;
    ...
    const ccomplex_t IT_0058 = m_d*m_N_4;
    ...
    const ccomplex_t IT_0063 = m_d*s_34*m_N_4;
