        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0014 = (-0.5)*IT_0013;
    const ccomplex_t IT_0015 = IT_0012*IT_0014;
    const ccomplex_t IT_0016 = pow(m_N_4, 2);
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0001 + IT_0016 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0018 = IT_0015*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*m_d*e_em*IT_0000*IT_0003
      *IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_13 + IT_0001 + IT_0016 + -m_sd_R*
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0000*IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0232 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
