...
ccomplex_return_t c_sumSqAmpl_N_4_sd_L_to_d_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0277 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
    ...
    const ccomplex_t IT_0287 = m_d*m_N_4;
    ...
    const ccomplex_t IT_0304 = m_d*m_N_4*IT_0303;
