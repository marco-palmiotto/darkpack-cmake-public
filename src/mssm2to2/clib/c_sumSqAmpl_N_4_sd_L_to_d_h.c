        ...
        )
{
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0006 + m_d*e_em*mu_h*IT_0000*IT_0011*IT_0033*IT_0035);
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0038 + IT_0049 + -m_sd_R*
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*e_em*(IT_0006*IT_0011
      *IT_0033*IT_0035*IT_0038 + (-0.5)*m_W*(IT_0006*IT_0034 + IT_0000*IT_0104)*
      (IT_0011 + 1./3*IT_0010*IT_0105));
    const ccomplex_t IT_0107 = IT_0037*IT_0106;
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0038 + IT_0049 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0109 = IT_0107*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*m_d*e_em*IT_0006*IT_0011
      *IT_0033*IT_0035;
    ...
    const ccomplex_t IT_0278 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
