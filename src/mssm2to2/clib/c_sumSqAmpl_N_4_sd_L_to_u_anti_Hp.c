        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0000*IT_0005*IT_0008;
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_12 + IT_0012 + -IT_0013 + -IT_0014 
      + -reg_prop, -1);
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0017 = IT_0011*IT_0015*IT_0016;
    const ccomplex_t IT_0018 = pow(m_u, 2);
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0005*(IT_0000*IT_0002*IT_0008*IT_0012 + (-2)*IT_0001*(m_W*IT_0002 + (
      -0.5)*IT_0000*IT_0003*IT_0018));
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0013 + IT_0018 + -m_su_L*
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0013 + IT_0018 + -m_su_R*
    ...
    const ccomplex_t IT_0039 = IT_0002*IT_0005;
    const ccomplex_t IT_0040 = N_d4*e_em*U_Wm2;
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = (-2)*IT_0041;
    const ccomplex_t IT_0043 = IT_0002*IT_0030;
    const ccomplex_t IT_0044 = N_B4*U_d2*e_em;
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = N_W4*U_d2*e_em;
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0014 + IT_0018 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0057 = IT_0054*IT_0055*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0014 + IT_0018 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0000*IT_0003*IT_0005;
    const ccomplex_t IT_0061 = 0.5*IT_0060;
    const ccomplex_t IT_0062 = N_d4*e_em*U_Wm1;
    const ccomplex_t IT_0063 = IT_0039*IT_0062;
    const ccomplex_t IT_0064 = (-2)*IT_0063;
    const ccomplex_t IT_0065 = N_B4*U_d1*e_em;
    const ccomplex_t IT_0066 = IT_0043*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = N_W4*U_d1*e_em;
    ...
    const ccomplex_t IT_0076 = IT_0058*IT_0059*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0078 = IT_0074*IT_0077;
    const ccomplex_t IT_0079 = IT_0059*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*IT_0079;
    const ccomplex_t IT_0081 = m_u*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0005;
    const ccomplex_t IT_0083 = IT_0053*IT_0082;
    const ccomplex_t IT_0084 = IT_0056*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*IT_0084;
    const ccomplex_t IT_0086 = m_u*IT_0085;
    ...
    const ccomplex_t IT_0099 = -IT_0017 + IT_0026 + IT_0036 + IT_0057 +
       IT_0076 + -IT_0081 + -IT_0086 + IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0000*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0105 = IT_0001*IT_0005;
    const ccomplex_t IT_0106 = conj(N_u4)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0107 = IT_0105*IT_0106;
    const ccomplex_t IT_0108 = 2*IT_0107;
    const ccomplex_t IT_0109 = IT_0001*IT_0030;
    const ccomplex_t IT_0110 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0111 = IT_0109*IT_0110;
    const ccomplex_t IT_0112 = 1.4142135623731*IT_0111;
    const ccomplex_t IT_0113 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0121 = IT_0058*IT_0059*IT_0120;
    const ccomplex_t IT_0122 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0123 = IT_0109*IT_0122;
    const ccomplex_t IT_0124 = 1.4142135623731*IT_0123;
    const ccomplex_t IT_0125 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0129 = conj(N_u4)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0130 = IT_0105*IT_0129;
    ...
    const ccomplex_t IT_0136 = IT_0055*IT_0056*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*(IT_0089 + 3*IT_0092);
    ...
    const ccomplex_t IT_0142 = IT_0061*IT_0119;
    ...
    const ccomplex_t IT_0146 = IT_0038*IT_0134;
    ...
    const ccomplex_t IT_0156 = IT_0094*IT_0151;
    const ccomplex_t IT_0157 = IT_0015*IT_0016*IT_0156;
    const ccomplex_t IT_0158 = -IT_0104 + IT_0121 + IT_0136 + -IT_0141 + 
      -IT_0145 + -IT_0149 + -IT_0155 + IT_0157;
    const ccomplex_t IT_0159 = 6*s_13;
    const ccomplex_t IT_0160 = m_u*m_N_4;
    const ccomplex_t IT_0161 = 6*IT_0099;
    const ccomplex_t IT_0162 = IT_0080 + IT_0085 + -IT_0154;
    const ccomplex_t IT_0163 = m_u*s_12;
    const ccomplex_t IT_0164 = IT_0097 + IT_0144 + IT_0148;
    const ccomplex_t IT_0165 = s_23*m_N_4;
    const ccomplex_t IT_0166 = 6*conj(IT_0099);
    const ccomplex_t IT_0167 = 6*conj(IT_0158);
    const ccomplex_t IT_0168 = m_u*m_N_4*IT_0014;
    const ccomplex_t IT_0169 = s_13*IT_0014;
