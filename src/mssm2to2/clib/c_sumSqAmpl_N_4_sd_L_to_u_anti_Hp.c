...
ccomplex_return_t c_sumSqAmpl_N_4_sd_L_to_u_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0119 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0120 = IT_0104*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0126 = conj(N_u4)*e_em*conj(V_Wp2);
    const ccomplex_t IT_0127 = IT_0100*IT_0126;
    ...
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0000*IT_0002*IT_0017;
    ...
    const ccomplex_t IT_0160 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0168 = m_u*m_N_4*IT_0025;
