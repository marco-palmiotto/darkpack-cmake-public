        ...
        )
{
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_23 + IT_0009 + IT_0025 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0030 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0031 = IT_0001*IT_0030;
    const ccomplex_t IT_0032 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0063 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_12 + -IT_0010 + -IT_0025 + IT_0070 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0001;
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0001;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
    ...
    const ccomplex_t IT_0135 = IT_0023*IT_0092;
    ...
    const ccomplex_t IT_0139 = m_N_4*IT_0138;
    ...
    const ccomplex_t IT_0149 = m_u*IT_0077;
    ...
    const ccomplex_t IT_0153 = IT_0016*IT_0099;
    const ccomplex_t IT_0154 = IT_0026*IT_0134*IT_0153;
    ...
    const ccomplex_t IT_0173 = m_u*IT_0161;
    ...
    const ccomplex_t IT_0193 = m_u*IT_0192;
