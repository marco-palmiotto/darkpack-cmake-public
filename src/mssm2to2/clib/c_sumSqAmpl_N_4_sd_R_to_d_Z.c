...
ccomplex_return_t c_sumSqAmpl_N_4_sd_R_to_d_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0053 = conj(N_u2)*N_u4*e_em;
    ...
    const ccomplex_t IT_0058 = IT_0003*IT_0056;
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0001;
    const ccomplex_t IT_0065 = (-0.333333333333333)*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_N_2*
    ...
    const ccomplex_t IT_0070 = -IT_0036 + -IT_0050 + (-0.5)*IT_0052 + -IT_0069;
    const ccomplex_t IT_0071 = pow(m_W, -1);
    const ccomplex_t IT_0072 = cos(beta);
    const ccomplex_t IT_0073 = cpow(IT_0072, -1);
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
    ...
    const ccomplex_t IT_0080 = N_d2*conj(N_d4)*e_em;
    const ccomplex_t IT_0081 = IT_0003*IT_0080;
    const ccomplex_t IT_0082 = IT_0007*IT_0080;
    const ccomplex_t IT_0083 = N_u2*conj(N_u4)*e_em;
    const ccomplex_t IT_0084 = IT_0007*IT_0083;
    const ccomplex_t IT_0085 = IT_0003*IT_0083;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0006*IT_0071*IT_0073;
    ...
    const ccomplex_t IT_0094 = IT_0013*IT_0077;
    const ccomplex_t IT_0095 = N_u1*conj(N_u4)*e_em;
    const ccomplex_t IT_0096 = IT_0003*IT_0095;
    const ccomplex_t IT_0097 = IT_0007*IT_0095;
    const ccomplex_t IT_0098 = N_d1*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0108 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0109 = IT_0003*IT_0108;
    const ccomplex_t IT_0110 = IT_0007*IT_0108;
    const ccomplex_t IT_0111 = N_d3*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0006*IT_0071*IT_0073;
    ...
    const ccomplex_t IT_0121 = IT_0093 + 0.5*IT_0094 + IT_0107 + IT_0120;
    ...
    const ccomplex_t IT_0143 = pow(m_N_4, 2);
    const ccomplex_t IT_0144 = cpow((-2)*s_12 + IT_0016 + -IT_0017 + -IT_0143 
      + -reg_prop, -1);
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0002;
    ...
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0152 = e_em*IT_0003;
    const ccomplex_t IT_0153 = e_em*IT_0007;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*(IT_0152 + 3*IT_0153);
    const ccomplex_t IT_0155 = (-0.166666666666667)*IT_0154;
    const ccomplex_t IT_0156 = IT_0015*IT_0155;
    const ccomplex_t IT_0157 = IT_0144*IT_0151*IT_0156;
    const ccomplex_t IT_0158 = m_N_4*IT_0051;
    ...
    const ccomplex_t IT_0163 = IT_0150 + -IT_0157 + (-0.5)*IT_0162;
    const ccomplex_t IT_0164 = m_N_1*IT_0030;
    const ccomplex_t IT_0165 = m_N_4*IT_0102;
    const ccomplex_t IT_0166 = -IT_0165;
    const ccomplex_t IT_0167 = IT_0164 + IT_0166;
    const ccomplex_t IT_0168 = IT_0106*IT_0167;
    const ccomplex_t IT_0169 = m_N_2*IT_0063;
    const ccomplex_t IT_0170 = m_N_4*IT_0088;
    const ccomplex_t IT_0171 = -IT_0170;
    const ccomplex_t IT_0172 = IT_0169 + IT_0171;
    const ccomplex_t IT_0173 = IT_0092*IT_0172;
    const ccomplex_t IT_0174 = m_N_3*IT_0044;
    const ccomplex_t IT_0175 = m_N_4*IT_0115;
    const ccomplex_t IT_0176 = -IT_0175;
    const ccomplex_t IT_0177 = IT_0174 + IT_0176;
    const ccomplex_t IT_0178 = IT_0119*IT_0177;
    const ccomplex_t IT_0179 = (-0.5)*IT_0162 + IT_0168 + IT_0173 + IT_0178;
    const ccomplex_t IT_0180 = IT_0163 + IT_0179;
    const ccomplex_t IT_0181 = conj(IT_0163) + conj(IT_0179);
    const ccomplex_t IT_0182 = IT_0075*IT_0146;
    const ccomplex_t IT_0183 = IT_0144*IT_0151*IT_0182;
    const ccomplex_t IT_0184 = IT_0075*IT_0155;
    const ccomplex_t IT_0185 = IT_0144*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*IT_0185;
    const ccomplex_t IT_0187 = m_d*IT_0186;
    const ccomplex_t IT_0188 = IT_0020*IT_0161;
    const ccomplex_t IT_0189 = IT_0183 + -IT_0187 + (-0.5)*IT_0188;
    const ccomplex_t IT_0190 = m_N_2*IT_0088;
    const ccomplex_t IT_0191 = m_N_4*IT_0063;
    const ccomplex_t IT_0192 = -IT_0191;
    const ccomplex_t IT_0193 = IT_0190 + IT_0192;
    const ccomplex_t IT_0194 = IT_0068*IT_0193;
    const ccomplex_t IT_0195 = m_N_3*IT_0115;
    const ccomplex_t IT_0196 = m_N_4*IT_0044;
    const ccomplex_t IT_0197 = -IT_0196;
    const ccomplex_t IT_0198 = IT_0195 + IT_0197;
    const ccomplex_t IT_0199 = IT_0049*IT_0198;
    const ccomplex_t IT_0200 = m_N_1*IT_0102;
    const ccomplex_t IT_0201 = m_N_4*IT_0030;
    ...
    const ccomplex_t IT_0208 = m_d*m_N_4;
    const ccomplex_t IT_0209 = pow(s_14, 2);
    const ccomplex_t IT_0210 = IT_0122*IT_0209;
    const ccomplex_t IT_0211 = -IT_0143;
    const ccomplex_t IT_0212 = IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = IT_0208*IT_0212;
    const ccomplex_t IT_0214 = (-0.666666666666667)*IT_0145;
    const ccomplex_t IT_0215 = cpow((-2)*s_13 + IT_0016 + IT_0143 + -m_sd_R*
    ...
    const ccomplex_t IT_0225 = 2*IT_0036 + 2*IT_0050 + IT_0052 + 2*IT_0069;
    ...
    const ccomplex_t IT_0231 = (-2)*IT_0093 + -IT_0094 + (-2)*IT_0107 + (-2)
      *IT_0120;
    ...
    const ccomplex_t IT_0238 = m_d*IT_0212;
    ...
    const ccomplex_t IT_0249 = (-2)*IT_0149 + -IT_0222;
    ...
    const ccomplex_t IT_0268 = IT_0126 + IT_0134;
    const ccomplex_t IT_0269 = IT_0128 + IT_0133;
    const ccomplex_t IT_0270 = s_34*IT_0129;
    const ccomplex_t IT_0271 = IT_0122*IT_0270;
    ...
    const ccomplex_t IT_0276 = 6*IT_0163;
    const ccomplex_t IT_0277 = 6*IT_0179;
    const ccomplex_t IT_0278 = IT_0276 + IT_0277;
    const ccomplex_t IT_0279 = s_14*IT_0129;
    const ccomplex_t IT_0280 = IT_0122*IT_0279;
    ...
    const ccomplex_t IT_0285 = 6*IT_0189;
    const ccomplex_t IT_0286 = 6*IT_0205;
    const ccomplex_t IT_0287 = IT_0285 + IT_0286;
    const ccomplex_t IT_0288 = 6*conj(IT_0022);
    const ccomplex_t IT_0289 = conj(IT_0070) + (-0.166666666666667)*IT_0288;
    const ccomplex_t IT_0290 = 6*conj(IT_0163);
    const ccomplex_t IT_0291 = 6*conj(IT_0179);
    const ccomplex_t IT_0292 = IT_0290 + IT_0291;
    const ccomplex_t IT_0293 = 6*conj(IT_0189);
    const ccomplex_t IT_0294 = 6*conj(IT_0205);
    const ccomplex_t IT_0295 = IT_0293 + IT_0294;
    const ccomplex_t IT_0296 = (-0.25)*IT_0271;
    const ccomplex_t IT_0297 = s_34 + IT_0296;
    const ccomplex_t IT_0298 = m_N_4*IT_0297;
    const ccomplex_t IT_0299 = (-4)*IT_0298;
    const ccomplex_t IT_0300 = (-6)*IT_0163;
    const ccomplex_t IT_0301 = (-6)*IT_0179;
    const ccomplex_t IT_0302 = IT_0300 + IT_0301;
    const ccomplex_t IT_0303 = (-6)*conj(IT_0163);
    const ccomplex_t IT_0304 = (-6)*conj(IT_0179);
    const ccomplex_t IT_0305 = IT_0303 + IT_0304;
    const ccomplex_t IT_0306 = (-6)*IT_0189;
    const ccomplex_t IT_0307 = (-6)*IT_0205;
    const ccomplex_t IT_0308 = IT_0306 + IT_0307;
    const ccomplex_t IT_0309 = (-6)*conj(IT_0189);
    const ccomplex_t IT_0310 = (-6)*conj(IT_0205);
    const ccomplex_t IT_0311 = IT_0309 + IT_0310;
    const ccomplex_t IT_0312 = 0.5*IT_0280;
    const ccomplex_t IT_0313 = s_14 + IT_0312;
    const ccomplex_t IT_0314 = m_d*IT_0313;
    const ccomplex_t IT_0315 = 2*IT_0314;
    const ccomplex_t IT_0316 = 6*IT_0261;
    const ccomplex_t IT_0317 = 6*conj(IT_0261);
    const ccomplex_t IT_0318 = (-3)*IT_0266;
    const ccomplex_t IT_0319 = (-6)*((conj(IT_0022) + -conj(IT_0070))*IT_0121 
      + -(IT_0022 + -IT_0070)*(conj(IT_0079) + -conj(IT_0121)) + IT_0079*IT_0289
       + (-0.166666666666667)*conj(IT_0186)*IT_0316 + (-0.166666666666667)
      *IT_0186*IT_0317)*IT_0318;
    const ccomplex_t IT_0320 = (-18)*conj(IT_0163);
    const ccomplex_t IT_0321 = s_13*IT_0212;
    const ccomplex_t IT_0322 = IT_0208*IT_0247;
    const ccomplex_t IT_0323 = 6*IT_0249;
    const ccomplex_t IT_0324 = 6*conj(IT_0249);
    const ccomplex_t IT_0325 = (-6)*IT_0249;
    const ccomplex_t IT_0326 = (-6)*conj(IT_0249);
    const ccomplex_t IT_0327 = pow(s_34, 2);
    const ccomplex_t IT_0328 = IT_0122*IT_0327;
    const ccomplex_t IT_0329 = -IT_0328;
    const ccomplex_t IT_0330 = IT_0016 + IT_0329;
    const ccomplex_t IT_0331 = IT_0208*IT_0330;
    const ccomplex_t IT_0332 = s_13*IT_0330;
    const ccomplex_t IT_0333 = (-6)*IT_0250;
    const ccomplex_t IT_0334 = m_d*IT_0247;
    const ccomplex_t IT_0335 = (-6)*conj(IT_0250);
    ...
    const ccomplex_t IT_0340 = conj(IT_0079)*IT_0250 + IT_0079*conj(IT_0250) +
       0.166666666666667*conj(IT_0022)*IT_0323 + 0.166666666666667*IT_0022
      *IT_0324 + 0.166666666666667*IT_0262*IT_0325 + 0.166666666666667*IT_0263
      *IT_0326 + 0.166666666666667*IT_0264*IT_0333 + 0.166666666666667*IT_0265
      *IT_0335;
    const ccomplex_t IT_0341 = m_N_4*IT_0247;
    const ccomplex_t IT_0342 = m_N_4*IT_0330;
    const ccomplex_t IT_0343 = (conj(IT_0022)*IT_0070 + IT_0022*conj(IT_0070) 
      ...
      *IT_0265) + (-6)*conj(IT_0261)*((-0.166666666666667)*IT_0136*IT_0261 +
       IT_0121*IT_0267 + (-0.166666666666667)*IT_0070*IT_0268 + (
      -0.166666666666667)*IT_0022*IT_0269 + (-0.166666666666667)*IT_0278*IT_0284
       + (-0.166666666666667)*IT_0275*IT_0287) + 6*conj(IT_0186)*((IT_0022 + 
      -IT_0070)*IT_0267 + 0.166666666666667*IT_0121*IT_0268 + 0.166666666666667
      *IT_0079*IT_0269 + 0.166666666666667*IT_0275*IT_0278 + 0.166666666666667
      *IT_0284*IT_0287) + (-6)*IT_0261*(conj(IT_0121)*IT_0267 + (
      -0.166666666666667)*conj(IT_0070)*IT_0268 + (-0.166666666666667)*conj
      (IT_0022)*IT_0269 + (-0.166666666666667)*IT_0284*IT_0292 + (
      -0.166666666666667)*IT_0275*IT_0295) + IT_0186*(IT_0136*conj(IT_0186) +
       conj(IT_0121)*IT_0268 + conj(IT_0079)*IT_0269 + (-6)*IT_0267*IT_0289 +
       IT_0275*IT_0292 + IT_0284*IT_0295) + IT_0299*(conj(IT_0079)*IT_0278 +
       conj(IT_0022)*IT_0287 + IT_0079*IT_0292 + IT_0022*IT_0295 + conj(IT_0121)
      *IT_0302 + IT_0121*IT_0305 + conj(IT_0070)*IT_0308 + IT_0070*IT_0311) + 
      (conj(IT_0022)*IT_0278 + conj(IT_0079)*IT_0287 + IT_0022*IT_0292 + IT_0079
      *IT_0295 + conj(IT_0070)*IT_0302 + IT_0070*IT_0305 + conj(IT_0121)*IT_0308
       + IT_0121*IT_0311)*IT_0315 + IT_0267*(conj(IT_0079)*IT_0316 + IT_0079
      *IT_0317) + IT_0319 + IT_0208*(IT_0180*((-18)*conj(IT_0189) + (-18)*conj
      (IT_0205)) + IT_0206*((-18)*conj(IT_0179) + IT_0320)) + (conj(IT_0223)
      *IT_0224 + conj(IT_0225)*IT_0234 + IT_0225*IT_0236 + conj(IT_0219)*IT_0239
       + conj(IT_0231)*IT_0253 + IT_0231*IT_0255)*IT_0321 + IT_0322*(IT_0237
      *IT_0250 + IT_0234*conj(IT_0250) + conj(IT_0231)*IT_0323 + IT_0231*IT_0324
       + conj(IT_0219)*IT_0325 + IT_0219*IT_0326) + (conj(IT_0250)*IT_0325 +
       IT_0250*IT_0326)*IT_0331 + IT_0332*(conj(IT_0249)*IT_0325 + conj(IT_0250)
      *IT_0333) + IT_0334*(IT_0181*IT_0325 + IT_0180*IT_0326 + IT_0207*IT_0333 +
       IT_0206*IT_0335) + 6*IT_0339*IT_0340 + (IT_0207*IT_0234 + IT_0206*IT_0237
       + conj(IT_0179)*IT_0253 + IT_0179*IT_0256 + conj(IT_0231)*IT_0276 +
       IT_0231*IT_0290 + conj(IT_0219)*IT_0300 + IT_0219*IT_0303)*IT_0341 + 
      (conj(IT_0250)*IT_0300 + IT_0250*IT_0303 + IT_0207*IT_0325 + IT_0206
      *IT_0326 + conj(IT_0179)*IT_0333 + IT_0179*IT_0335)*IT_0342;
    return create_ccomplex_return(IT_0343);
}
