        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_d*e_em*IT_0005*IT_0007
      *IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0005 + m_d*e_em*mu_h*IT_0002*IT_0007*IT_0009*IT_0010);
    ...
    const ccomplex_t IT_0242 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0007*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0253 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0007*IT_0009*IT_0010;
