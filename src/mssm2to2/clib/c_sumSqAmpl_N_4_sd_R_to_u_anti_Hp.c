...
ccomplex_return_t c_sumSqAmpl_N_4_sd_R_to_u_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = N_d4*e_em*U_Wm2;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
    ...
    const ccomplex_t IT_0108 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0109 = IT_0094*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0115 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
