        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0009;
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0014 + IT_0024 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0023*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*IT_0026;
    const ccomplex_t IT_0028 = cpow(IT_0001, -1);
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0000*IT_0003*IT_0005*IT_0028;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = 0.666666666666667*IT_0010;
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = cpow((-2)*s_13 + IT_0014 + IT_0024 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0034 = IT_0032*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0000*IT_0005*IT_0028;
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = IT_0002*IT_0005;
    const ccomplex_t IT_0039 = N_d4*e_em*U_Wm2;
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = (-2)*IT_0040;
    const ccomplex_t IT_0042 = IT_0002*IT_0009;
    const ccomplex_t IT_0043 = N_B4*U_d2*e_em;
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = N_W4*U_d2*e_em;
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0015 + IT_0024 + -m_C_2*
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_23 + IT_0015 + IT_0024 + -m_C_1*
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0000*IT_0005*IT_0028;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0000*IT_0005*IT_0028;
    ...
    const ccomplex_t IT_0084 = -IT_0018 + IT_0027 + IT_0035 + -IT_0057 + 
      -IT_0077 + IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0091 = IT_0001*IT_0009;
    const ccomplex_t IT_0092 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0093 = IT_0091*IT_0092;
    const ccomplex_t IT_0094 = 1.4142135623731*IT_0093;
    const ccomplex_t IT_0095 = IT_0001*IT_0005;
    const ccomplex_t IT_0096 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0100 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0107 = IT_0054*IT_0090*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0000*IT_0002*IT_0005*IT_0028;
    const ccomplex_t IT_0109 = 0.5*IT_0108;
    const ccomplex_t IT_0110 = IT_0079*IT_0109;
    const ccomplex_t IT_0111 = IT_0016*IT_0017*IT_0110;
    const ccomplex_t IT_0112 = IT_0011*IT_0109;
    ...
    const ccomplex_t IT_0131 = IT_0058*IT_0116*IT_0130;
    ...
    const ccomplex_t IT_0147 = IT_0056 + IT_0076 + -IT_0114;
    ...
    const ccomplex_t IT_0152 = m_u*m_N_4*IT_0015;
    ...
    const ccomplex_t IT_0161 = (IT_0084*conj(IT_0084) + IT_0143*conj(IT_0143))
      ...
      *IT_0148 + IT_0082*IT_0149)*IT_0150 + (IT_0082*IT_0148 + IT_0147*IT_0149)
      *IT_0151 + 6*conj(IT_0082)*(IT_0147*IT_0152 + 0.166666666666667*IT_0082
      *IT_0157 + IT_0158*IT_0159 + IT_0146*IT_0160) + 6*conj(IT_0147)*(IT_0082
