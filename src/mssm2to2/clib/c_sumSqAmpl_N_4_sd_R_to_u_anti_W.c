...
ccomplex_return_t c_sumSqAmpl_N_4_sd_R_to_u_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0036 = s_14*s_34*IT_0035;
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = s_13 + IT_0037;
    const ccomplex_t IT_0039 = m_N_4*IT_0038;
    const ccomplex_t IT_0040 = pow(m_d, 2);
    const ccomplex_t IT_0041 = pow(m_N_4, 2);
    const ccomplex_t IT_0042 = cpow((-2)*s_12 + -IT_0001 + IT_0040 + -IT_0041 
      + -reg_prop, -1);
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0004*IT_0012*IT_0014;
    const ccomplex_t IT_0044 = 0.5*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0004;
    ...
    const ccomplex_t IT_0051 = s_13*IT_0038;
    const ccomplex_t IT_0052 = s_13*s_14;
    const ccomplex_t IT_0053 = s_34*IT_0041;
    const ccomplex_t IT_0054 = -IT_0053;
    const ccomplex_t IT_0055 = IT_0052 + IT_0054;
    const ccomplex_t IT_0056 = -IT_0019 + -IT_0032;
    ...
    const ccomplex_t IT_0070 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0071 = IT_0004*IT_0070;
    const ccomplex_t IT_0072 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0078 = IT_0002*IT_0069*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_d;
    ...
    const ccomplex_t IT_0085 = IT_0042*IT_0079*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0087 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0088 = IT_0004*IT_0087;
    const ccomplex_t IT_0089 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0095 = IT_0020*IT_0086*IT_0094;
    const ccomplex_t IT_0096 = -IT_0078 + -IT_0085 + -IT_0095;
    const ccomplex_t IT_0097 = 6*IT_0096;
    const ccomplex_t IT_0098 = pow(s_34, 2);
    ...
    const ccomplex_t IT_0106 = (-0.25)*IT_0105;
    const ccomplex_t IT_0107 = s_34 + IT_0106;
    const ccomplex_t IT_0108 = m_N_4*IT_0107;
    const ccomplex_t IT_0109 = (-4)*IT_0108;
    const ccomplex_t IT_0110 = (-6)*conj(IT_0096);
    const ccomplex_t IT_0111 = s_13*IT_0101;
    const ccomplex_t IT_0112 = (-6)*IT_0050;
    const ccomplex_t IT_0113 = s_14*IT_0103;
    ...
    const ccomplex_t IT_0119 = pow(m_W, 4);
    ...
    const ccomplex_t IT_0125 = s_13*IT_0103;
    const ccomplex_t IT_0126 = (-12)*IT_0125;
    const ccomplex_t IT_0127 = IT_0122 + IT_0124 + IT_0126;
    const ccomplex_t IT_0128 = (-6)*IT_0121;
    const ccomplex_t IT_0129 = IT_0124 + IT_0128;
    const ccomplex_t IT_0130 = 0.5*IT_0105;
    ...
    const ccomplex_t IT_0138 = 0.5*IT_0114;
    const ccomplex_t IT_0139 = s_14 + IT_0138;
    const ccomplex_t IT_0140 = m_u*IT_0139;
    const ccomplex_t IT_0141 = 2*IT_0140;
    const ccomplex_t IT_0142 = IT_0034 + IT_0096;
    const ccomplex_t IT_0143 = m_u*IT_0038;
    const ccomplex_t IT_0144 = (-6)*conj(IT_0050);
    const ccomplex_t IT_0145 = m_u*m_N_4;
    const ccomplex_t IT_0146 = (-2)*IT_0123;
    const ccomplex_t IT_0147 = IT_0125 + IT_0146;
    const ccomplex_t IT_0148 = IT_0035*IT_0147;
    const ccomplex_t IT_0149 = (-6)*IT_0148;
    const ccomplex_t IT_0150 = 12*s_13;
    const ccomplex_t IT_0151 = IT_0149 + IT_0150;
    const ccomplex_t IT_0152 = 6*IT_0049;
    const ccomplex_t IT_0153 = (-6)*IT_0056;
    const ccomplex_t IT_0154 = (-18)*IT_0061*IT_0145;
    const ccomplex_t IT_0155 = IT_0133*IT_0152;
    const ccomplex_t IT_0156 = IT_0142*IT_0151;
    const ccomplex_t IT_0157 = (IT_0034*IT_0039 + IT_0050*IT_0051 + IT_0055
      *IT_0057)*IT_0059 + (-6)*conj(IT_0058)*(IT_0061*IT_0066 + (
      -0.166666666666667)*IT_0067*IT_0068 + (-0.166666666666667)*IT_0039*IT_0097
      ) + (IT_0050*IT_0102 + IT_0056*IT_0109)*IT_0110 + (-6)*conj(IT_0050)*((
      -0.166666666666667)*IT_0051*IT_0068 + IT_0096*IT_0102 + (
      -0.166666666666667)*IT_0111*IT_0112) + 6*conj(IT_0049)*(0.166666666666667
      *IT_0055*IT_0068 + IT_0061*IT_0118 + 0.166666666666667*IT_0049*IT_0127 +
       0.166666666666667*IT_0056*IT_0129 + (IT_0034 + 0.166666666666667*IT_0097)
      *IT_0133 + 0.166666666666667*IT_0112*IT_0137) + (-6)*conj(IT_0056)*((
      -0.166666666666667)*IT_0055*IT_0068 + (-0.166666666666667)*IT_0056*IT_0127
       + (-0.166666666666667)*IT_0049*IT_0129 + (-0.166666666666667)*IT_0112
      *IT_0137 + IT_0061*IT_0141 + IT_0109*IT_0142) + (IT_0034*IT_0102 + IT_0057
      *IT_0137 + IT_0061*IT_0143)*IT_0144 + (-6)*conj(IT_0061)*(IT_0058*IT_0066 
      + -1./6*IT_0112*IT_0143 + -1./6*((-18)*IT_0034 + (-18)*IT_0096)*IT_0145 + 
      -1./6*IT_0061*IT_0151 + -1./6*IT_0118*IT_0152 + -1./6*IT_0141*IT_0153) +
       conj(IT_0034)*(IT_0039*IT_0068 + IT_0102*IT_0112 + IT_0109*IT_0153 +
       IT_0154 + IT_0155 + IT_0156) + 6*conj(IT_0096)*(IT_0039*IT_0058 +
