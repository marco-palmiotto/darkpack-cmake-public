        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0021 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_12 + -IT_0016 + IT_0034 + -IT_0035 
      + -reg_prop, -1);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_d;
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0004;
    ...
    const ccomplex_t IT_0056 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0057 = IT_0004*IT_0056;
    const ccomplex_t IT_0058 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
    ...
    const ccomplex_t IT_0132 = m_u*IT_0070;
