...
ccomplex_return_t c_sumSqAmpl_N_4_se_L_to_e_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = N_B4*N_u4*e_em;
    ...
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0000*IT_0002*IT_0016;
    ...
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
    ...
    const ccomplex_t IT_0240 = m_e*m_N_4;
    ...
    const ccomplex_t IT_0266 = m_e*m_N_4*IT_0265;
