...
ccomplex_return_t c_sumSqAmpl_N_4_se_L_to_e_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_13 + IT_0036 + IT_0047 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    const ccomplex_t IT_0103 = sin(beta);
    const ccomplex_t IT_0104 = cpow(IT_0001, -2);
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0011
      *IT_0031*IT_0033*IT_0036 + (-0.5)*m_W*(IT_0000*IT_0032 + -IT_0006*IT_0103)
      *(IT_0011 + -IT_0010*IT_0104));
    ...
    const ccomplex_t IT_0240 = IT_0053*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*IT_0240;
    const ccomplex_t IT_0242 = m_N_4*IT_0076;
    const ccomplex_t IT_0243 = m_N_2*IT_0098;
    const ccomplex_t IT_0244 = IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = IT_0241*IT_0244;
    const ccomplex_t IT_0246 = IT_0038*IT_0227;
    ...
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*(IT_0251 + IT_0254);
    ...
    const ccomplex_t IT_0259 = m_N_4*IT_0193;
    const ccomplex_t IT_0260 = m_N_3*IT_0215;
    const ccomplex_t IT_0261 = IT_0259 + IT_0260;
    const ccomplex_t IT_0262 = IT_0258*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0011*IT_0031*IT_0033;
    const ccomplex_t IT_0264 = 0.5*IT_0263;
    const ccomplex_t IT_0265 = IT_0043*IT_0264;
    const ccomplex_t IT_0266 = IT_0048*IT_0265;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*IT_0266;
    const ccomplex_t IT_0268 = IT_0106*IT_0227;
    const ccomplex_t IT_0269 = IT_0102*IT_0268;
    ...
    const ccomplex_t IT_0281 = m_N_4*IT_0142;
    const ccomplex_t IT_0282 = m_N_1*IT_0164;
    const ccomplex_t IT_0283 = IT_0281 + IT_0282;
    const ccomplex_t IT_0284 = IT_0280*IT_0283;
    const ccomplex_t IT_0285 = 2*IT_0231 + -IT_0245 + -IT_0248 + -IT_0262 + 
      -IT_0267 + -IT_0270 + -IT_0284;
    const ccomplex_t IT_0286 = 2*s_13;
    const ccomplex_t IT_0287 = m_e*m_N_4;
    const ccomplex_t IT_0288 = 2*IT_0219;
    const ccomplex_t IT_0289 = IT_0193*IT_0258;
    const ccomplex_t IT_0290 = IT_0018*IT_0247;
    const ccomplex_t IT_0291 = IT_0142*IT_0280;
    const ccomplex_t IT_0292 = IT_0076*IT_0241;
    ...
    const ccomplex_t IT_0304 = m_e*m_N_4*IT_0303;
