        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0013 = (-0.5)*IT_0012;
    const ccomplex_t IT_0014 = IT_0011*IT_0013;
    const ccomplex_t IT_0015 = pow(m_N_4, 2);
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0001 + IT_0015 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    const ccomplex_t IT_0017 = IT_0014*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*m_e*e_em*IT_0000*IT_0003
      *IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0026 = m_e*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0000*IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0000
      *IT_0003*IT_0006*IT_0007;
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_13 + IT_0001 + IT_0015 + -m_se_R*
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0000*IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0233 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
    ...
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*(IT_0243 + IT_0246);
