...
ccomplex_return_t c_sumSqAmpl_N_4_se_L_to_nu_e_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0026 = conj(N_u4)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = 2*IT_0027;
    const ccomplex_t IT_0029 = IT_0000*IT_0010;
    const ccomplex_t IT_0030 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
    ...
    const ccomplex_t IT_0113 = s_23*m_N_4;
