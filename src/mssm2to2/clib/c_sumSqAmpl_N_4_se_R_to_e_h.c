        ...
        )
{
    ...
    const ccomplex_t IT_0035 = pow(m_e, 2);
    const ccomplex_t IT_0036 = pow(m_se_R, 2);
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0035 + IT_0049 + -m_se_L*
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_13 + IT_0035 + IT_0049 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0105 = cpow(IT_0001, -2);
    const ccomplex_t IT_0106 = sin(beta);
    const ccomplex_t IT_0107 = (0 + _Complex_I*-1)*e_em*(IT_0006*IT_0011
      *IT_0035*IT_0041*IT_0043 + -m_W*IT_0010*IT_0105*(IT_0006*IT_0042 + IT_0000
      *IT_0106));
    ...
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_e*e_em*IT_0006*IT_0011
      *IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0118 = m_e*IT_0117;
    ...
    const ccomplex_t IT_0228 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0011*IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0232 = m_N_4*IT_0078;
    const ccomplex_t IT_0233 = m_N_2*IT_0100;
    const ccomplex_t IT_0234 = IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = IT_0231*IT_0234;
    const ccomplex_t IT_0236 = IT_0037*IT_0223;
    const ccomplex_t IT_0237 = (0 + _Complex_I*1)*IT_0236;
    const ccomplex_t IT_0238 = IT_0032*IT_0237;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0011*IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0243 = m_N_4*IT_0195;
    const ccomplex_t IT_0244 = m_N_3*IT_0217;
    ...
    const ccomplex_t IT_0256 = IT_0050*IT_0255;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*IT_0256;
    const ccomplex_t IT_0258 = IT_0108*IT_0223;
    const ccomplex_t IT_0259 = IT_0104*IT_0258;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1)*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0011*IT_0041*IT_0043;
    ...
    const ccomplex_t IT_0269 = 2*IT_0227 + -IT_0235 + -IT_0238 + -IT_0246 + 
    ...
    const ccomplex_t IT_0273 = IT_0195*IT_0242;
    const ccomplex_t IT_0274 = IT_0019*IT_0237;
    const ccomplex_t IT_0275 = IT_0144*IT_0264;
    const ccomplex_t IT_0276 = IT_0078*IT_0231;
