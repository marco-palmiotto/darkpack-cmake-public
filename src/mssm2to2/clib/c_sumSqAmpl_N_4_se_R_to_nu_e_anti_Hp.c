        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0000*IT_0002;
    ...
    const ccomplex_t IT_0010 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
      *e_em*IT_0000*IT_0002*IT_0039;
    const ccomplex_t IT_0047 = (-0.5)*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0049 = IT_0028*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_e;
