...
ccomplex_return_t c_sumSqAmpl_N_4_se_R_to_nu_e_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
    ...
    const ccomplex_t IT_0054 = pow(m_e, 2);
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*m_e;
    ...
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0000*IT_0004;
