...
ccomplex_return_t c_sumSqAmpl_N_4_se_R_to_nu_e_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0003;
    ...
    const ccomplex_t IT_0042 = pow(m_e, 2);
    const ccomplex_t IT_0043 = pow(m_N_4, 2);
    const ccomplex_t IT_0044 = cpow((-2)*s_12 + -IT_0000 + IT_0042 + -IT_0043 
      + -reg_prop, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_e;
    ...
    const ccomplex_t IT_0056 = IT_0001*IT_0047*IT_0055;
