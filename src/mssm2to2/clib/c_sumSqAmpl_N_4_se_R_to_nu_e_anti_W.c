        ...
        )
{
    ...
    const ccomplex_t IT_0019 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0020 = IT_0001*IT_0019;
    const ccomplex_t IT_0021 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0036 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0037 = IT_0001*IT_0036;
    const ccomplex_t IT_0038 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0046 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0047 = IT_0001*IT_0046;
    const ccomplex_t IT_0048 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0127 = 0.5*IT_0090*IT_0116;
    const ccomplex_t IT_0128 = 2*(IT_0034 + IT_0067)*IT_0105 + (conj(IT_0089)
      ...
      *IT_0120 + (-2)*conj(IT_0072)*IT_0124 + 4*conj(IT_0099)*IT_0126 + IT_0127)
       + (-2)*IT_0099*(IT_0103*IT_0112 + -conj(IT_0073)*IT_0120 + 2*conj(IT_0099
      )*IT_0124 + (-4)*conj(IT_0072)*IT_0126 + -IT_0127);
