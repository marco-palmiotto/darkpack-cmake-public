...
ccomplex_return_t c_sumSqAmpl_N_4_smu_L_to_mu_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
    ...
    const ccomplex_t IT_0047 = m_mu*s_14*m_N_4;
    ...
    const ccomplex_t IT_0056 = m_mu*m_N_4;
    ...
    const ccomplex_t IT_0061 = m_mu*s_34*m_N_4;
