...
ccomplex_return_t c_sumSqAmpl_N_4_smu_L_to_mu_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = N_B4*N_d1*e_em;
    ...
    const ccomplex_t IT_0022 = N_B1*N_d4*e_em;
    ...
    const ccomplex_t IT_0028 = N_B4*N_u1*e_em;
    ...
    const ccomplex_t IT_0033 = N_B1*N_u4*e_em;
    ...
    const ccomplex_t IT_0042 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0043 = IT_0015*IT_0042;
    const ccomplex_t IT_0044 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0045 = IT_0019*IT_0044;
    const ccomplex_t IT_0046 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0047 = IT_0015*IT_0046;
    const ccomplex_t IT_0048 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0049 = IT_0019*IT_0048;
    const ccomplex_t IT_0050 = IT_0043 + IT_0045 + IT_0047 + IT_0049;
    const ccomplex_t IT_0051 = conj(N_B1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0055 = conj(N_B4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0077 = (-0.5)*IT_0076;
    const ccomplex_t IT_0078 = sin(beta);
    const ccomplex_t IT_0079 = cpow(IT_0013, -2);
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0012 + (-0.5)*m_W*(IT_0001*IT_0012 + -IT_0018*IT_0078)
      *(IT_0004 + -IT_0003*IT_0079));
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0090 = N_B4*N_u4*e_em;
    const ccomplex_t IT_0091 = IT_0027*IT_0090;
    const ccomplex_t IT_0092 = N_W4*N_d4*e_em;
    ...
    const ccomplex_t IT_0098 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0099 = IT_0015*IT_0098;
    const ccomplex_t IT_0100 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0101 = IT_0027*IT_0100;
    const ccomplex_t IT_0102 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0103 = IT_0030*IT_0102;
    const ccomplex_t IT_0104 = conj(N_W4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0126 = N_W4*N_d2*e_em;
    ...
    const ccomplex_t IT_0137 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0162 = (-0.5)*IT_0161;
    const ccomplex_t IT_0163 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0164 = IT_0162*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*IT_0164;
    const ccomplex_t IT_0166 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0167 = IT_0015*IT_0166;
    const ccomplex_t IT_0168 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0169 = IT_0019*IT_0168;
    const ccomplex_t IT_0170 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0171 = IT_0015*IT_0170;
    const ccomplex_t IT_0172 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0178 = IT_0030*IT_0177;
    ...
    const ccomplex_t IT_0188 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0189 = IT_0015*IT_0188;
    const ccomplex_t IT_0190 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0191 = IT_0019*IT_0190;
    const ccomplex_t IT_0192 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0193 = IT_0015*IT_0192;
    const ccomplex_t IT_0194 = conj(N_W4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0199 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0200 = IT_0030*IT_0199;
    const ccomplex_t IT_0201 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0202 = IT_0027*IT_0201;
    const ccomplex_t IT_0203 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0211 = IT_0165*IT_0210;
    ...
    const ccomplex_t IT_0215 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0071 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0230 = m_N_4*IT_0186;
    const ccomplex_t IT_0231 = m_N_3*IT_0208;
    ...
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*(IT_0255 + IT_0258);
    const ccomplex_t IT_0260 = (-0.5)*IT_0259;
    const ccomplex_t IT_0261 = IT_0081*IT_0260;
    const ccomplex_t IT_0262 = IT_0075*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1)*IT_0262;
    const ccomplex_t IT_0264 = IT_0085*IT_0260;
    const ccomplex_t IT_0265 = (0 + _Complex_I*1)*IT_0264;
    const ccomplex_t IT_0266 = IT_0108*IT_0265;
    const ccomplex_t IT_0267 = m_N_4*IT_0040;
    const ccomplex_t IT_0268 = m_N_1*IT_0062;
    const ccomplex_t IT_0269 = IT_0267 + IT_0268;
    const ccomplex_t IT_0270 = conj(N_B1)*e_em;
    const ccomplex_t IT_0271 = IT_0014*IT_0270;
    const ccomplex_t IT_0272 = 1.4142135623731*IT_0271;
    const ccomplex_t IT_0273 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0281 = IT_0213*IT_0260;
    ...
    const ccomplex_t IT_0285 = -IT_0233 + -IT_0247 + -IT_0252 + -IT_0263 + 
      -IT_0266 + -IT_0280 + 2*IT_0284;
    const ccomplex_t IT_0286 = 2*s_13;
    const ccomplex_t IT_0287 = m_mu*m_N_4;
    const ccomplex_t IT_0288 = 2*IT_0219;
    const ccomplex_t IT_0289 = IT_0135*IT_0243;
    const ccomplex_t IT_0290 = IT_0186*IT_0229;
    const ccomplex_t IT_0291 = IT_0040*IT_0279;
    const ccomplex_t IT_0292 = IT_0096*IT_0265;
    const ccomplex_t IT_0293 = -IT_0217 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_mu*s_14;
    const ccomplex_t IT_0295 = IT_0011*IT_0062;
    const ccomplex_t IT_0296 = IT_0114*IT_0157;
    const ccomplex_t IT_0297 = IT_0165*IT_0208;
    const ccomplex_t IT_0298 = IT_0087*IT_0106;
    ...
    const ccomplex_t IT_0304 = m_mu*m_N_4*IT_0303;
