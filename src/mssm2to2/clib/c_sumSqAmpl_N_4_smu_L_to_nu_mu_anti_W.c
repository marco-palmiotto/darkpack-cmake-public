        ...
        )
{
    ...
    const ccomplex_t IT_0074 = m_N_4*IT_0064*IT_0073;
    const ccomplex_t IT_0075 = cos(theta_W);
    ...
    const ccomplex_t IT_0088 = -IT_0040;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*(IT_0079 + -IT_0082);
    const ccomplex_t IT_0090 = (-0.5)*IT_0089;
    const ccomplex_t IT_0091 = cpow(s_13 + (-0.5)*IT_0049 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0095 = 2*IT_0087 + (-0.5)*IT_0094;
    const ccomplex_t IT_0096 = 2*IT_0095;
    const ccomplex_t IT_0097 = (-0.5)*IT_0074*IT_0096;
    ...
    const ccomplex_t IT_0105 = 0.5*IT_0014 + 0.5*IT_0026;
    const ccomplex_t IT_0106 = (-0.25)*IT_0099;
    ...
    const ccomplex_t IT_0111 = (-2)*(IT_0029 + IT_0063)*IT_0072 + IT_0097 +
       IT_0104 + IT_0110;
    const ccomplex_t IT_0112 = s_14*s_34*IT_0064;
    const ccomplex_t IT_0113 = -IT_0112;
    const ccomplex_t IT_0114 = s_13 + IT_0113;
    const ccomplex_t IT_0115 = s_13*IT_0114;
    const ccomplex_t IT_0116 = -IT_0014 + -IT_0026;
    const ccomplex_t IT_0117 = 2*IT_0116;
    const ccomplex_t IT_0118 = 0.5*IT_0094;
    const ccomplex_t IT_0119 = (-2)*IT_0118;
    const ccomplex_t IT_0120 = IT_0117 + IT_0119;
    const ccomplex_t IT_0121 = 2*conj(IT_0116);
    const ccomplex_t IT_0122 = (-2)*conj(IT_0118);
    const ccomplex_t IT_0123 = IT_0121 + IT_0122;
    const ccomplex_t IT_0124 = m_N_4*IT_0114;
    const ccomplex_t IT_0125 = IT_0029 + IT_0063;
    ...
    const ccomplex_t IT_0130 = IT_0087 + IT_0105;
    const ccomplex_t IT_0131 = s_13*IT_0064*IT_0073;
    const ccomplex_t IT_0132 = pow(m_W, 4);
    const ccomplex_t IT_0133 = s_13*IT_0132;
    const ccomplex_t IT_0134 = IT_0064*IT_0133;
    const ccomplex_t IT_0135 = IT_0066 + IT_0068 + (-0.5)*IT_0134;
    const ccomplex_t IT_0136 = (-0.25)*IT_0134;
    const ccomplex_t IT_0137 = IT_0067 + IT_0136;
    const ccomplex_t IT_0138 = s_13*s_34;
    const ccomplex_t IT_0139 = 2*conj(IT_0095);
    const ccomplex_t IT_0140 = pow(s_14, 2);
    const ccomplex_t IT_0141 = IT_0064*IT_0140;
    const ccomplex_t IT_0142 = -IT_0049;
    const ccomplex_t IT_0143 = IT_0141 + IT_0142;
    const ccomplex_t IT_0144 = s_13*IT_0143;
    const ccomplex_t IT_0145 = (-2)*(conj(IT_0029) + conj(IT_0063))*IT_0111 +
       IT_0115*(conj(IT_0095)*IT_0120 + IT_0095*IT_0123) + IT_0124*((conj
      (IT_0029) + conj(IT_0063))*IT_0120 + IT_0123*IT_0125) + IT_0129*((conj
      (IT_0087) + conj(IT_0105))*IT_0120 + IT_0123*IT_0130) + conj(IT_0095)
      *IT_0096*IT_0131 + (-4)*conj(IT_0105)*(0.5*IT_0109*IT_0125 + IT_0105
      *IT_0135 + (-2)*IT_0087*IT_0137 + (-0.25)*IT_0096*IT_0138) + (-4)*conj
      (IT_0087)*((-0.5)*IT_0103*IT_0125 + IT_0087*IT_0135 + (-2)*IT_0105*IT_0137
       + (-0.25)*IT_0096*IT_0138) + (IT_0074*IT_0125 + IT_0130*IT_0138)*IT_0139 
      + (-2)*((-0.5)*conj(IT_0116)*IT_0117 + IT_0116*conj(IT_0118) + IT_0118*
      (conj(IT_0116) + -conj(IT_0118)))*IT_0144;
