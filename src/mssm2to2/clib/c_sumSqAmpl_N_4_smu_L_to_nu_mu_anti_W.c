...
ccomplex_return_t c_sumSqAmpl_N_4_smu_L_to_nu_mu_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0004 = IT_0001*IT_0003;
    const ccomplex_t IT_0005 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0012 = cpow(s_23 + (-0.5)*IT_0011 + 0.5*m_C_1*(m_C_1 +
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0001;
    const ccomplex_t IT_0016 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0017 = IT_0001*IT_0016;
    const ccomplex_t IT_0018 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0024 = cpow(s_23 + (-0.5)*IT_0011 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0028 = m_N_4*IT_0027;
    ...
    const ccomplex_t IT_0039 = IT_0012*IT_0037*IT_0038;
    ...
    const ccomplex_t IT_0049 = IT_0024*IT_0047*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001;
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0001*IT_0052*IT_0054;
    const ccomplex_t IT_0056 = (-0.5)*IT_0055;
    const ccomplex_t IT_0057 = IT_0051*IT_0056;
    const ccomplex_t IT_0058 = pow(m_mu, 2);
    const ccomplex_t IT_0059 = pow(m_N_4, 2);
    const ccomplex_t IT_0060 = cpow((-2)*s_12 + -IT_0011 + IT_0058 + -IT_0059 
      + -reg_prop, -1);
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0062 = IT_0057*IT_0060*IT_0061;
    const ccomplex_t IT_0063 = 0.5*IT_0039 + 0.5*IT_0049 + -IT_0062;
    const ccomplex_t IT_0064 = pow(m_W, -2);
    const ccomplex_t IT_0065 = pow(s_34, 2);
    const ccomplex_t IT_0066 = m_N_4*IT_0064*IT_0065;
    ...
    const ccomplex_t IT_0080 = -IT_0050;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*(IT_0071 + -IT_0074);
    const ccomplex_t IT_0082 = (-0.5)*IT_0081;
    const ccomplex_t IT_0083 = cpow(s_13 + (-0.5)*IT_0059 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0087 = 2*IT_0079 + (-0.5)*IT_0086;
    const ccomplex_t IT_0088 = 2*IT_0087;
    const ccomplex_t IT_0089 = (-0.5)*IT_0066*IT_0088;
    ...
    const ccomplex_t IT_0098 = IT_0029 + IT_0063;
    const ccomplex_t IT_0099 = (-2)*IT_0097*IT_0098;
    const ccomplex_t IT_0100 = s_34*IT_0090;
    ...
    const ccomplex_t IT_0107 = 0.5*IT_0014 + 0.5*IT_0026;
    const ccomplex_t IT_0108 = (-0.25)*IT_0101;
    ...
    const ccomplex_t IT_0113 = IT_0089 + IT_0099 + IT_0106 + IT_0112;
    const ccomplex_t IT_0114 = s_14*s_34*IT_0064;
    const ccomplex_t IT_0115 = -IT_0114;
    const ccomplex_t IT_0116 = s_13 + IT_0115;
    const ccomplex_t IT_0117 = s_13*IT_0116;
    const ccomplex_t IT_0118 = -IT_0014 + -IT_0026;
    const ccomplex_t IT_0119 = 2*IT_0118;
    const ccomplex_t IT_0120 = 0.5*IT_0086;
    const ccomplex_t IT_0121 = (-2)*IT_0120;
    const ccomplex_t IT_0122 = IT_0119 + IT_0121;
    const ccomplex_t IT_0123 = 2*conj(IT_0118);
    const ccomplex_t IT_0124 = (-2)*conj(IT_0120);
    const ccomplex_t IT_0125 = IT_0123 + IT_0124;
    const ccomplex_t IT_0126 = m_N_4*IT_0116;
    const ccomplex_t IT_0127 = s_13*s_14;
    const ccomplex_t IT_0128 = s_34*IT_0059;
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = IT_0127 + IT_0129;
    const ccomplex_t IT_0131 = IT_0079 + IT_0107;
    const ccomplex_t IT_0132 = pow(s_14, 2);
    const ccomplex_t IT_0133 = IT_0064*IT_0132;
    const ccomplex_t IT_0134 = -IT_0059;
    const ccomplex_t IT_0135 = IT_0133 + IT_0134;
    const ccomplex_t IT_0136 = s_13*IT_0135;
    const ccomplex_t IT_0137 = s_13*IT_0064*IT_0065;
    const ccomplex_t IT_0138 = pow(m_W, 4);
    const ccomplex_t IT_0139 = s_13*IT_0138;
    const ccomplex_t IT_0140 = IT_0064*IT_0139;
    const ccomplex_t IT_0141 = IT_0091 + IT_0093 + (-0.5)*IT_0140;
    const ccomplex_t IT_0142 = (-0.25)*IT_0140;
    const ccomplex_t IT_0143 = IT_0092 + IT_0142;
    const ccomplex_t IT_0144 = s_13*s_34;
    const ccomplex_t IT_0145 = 2*conj(IT_0087);
    const ccomplex_t IT_0146 = (-2)*(conj(IT_0029) + conj(IT_0063))*IT_0113 +
       IT_0117*(conj(IT_0087)*IT_0122 + IT_0087*IT_0125) + ((conj(IT_0029) +
       conj(IT_0063))*IT_0122 + IT_0098*IT_0125)*IT_0126 + IT_0130*((conj
      (IT_0079) + conj(IT_0107))*IT_0122 + IT_0125*IT_0131) + (-2)*((-0.5)*conj
      (IT_0118)*IT_0119 + IT_0118*conj(IT_0120) + IT_0120*(conj(IT_0118) + -conj
      (IT_0120)))*IT_0136 + conj(IT_0087)*IT_0088*IT_0137 + (-4)*conj(IT_0107)*
      (0.5*IT_0098*IT_0111 + IT_0107*IT_0141 + (-2)*IT_0079*IT_0143 + (-0.25)
      *IT_0088*IT_0144) + (-4)*conj(IT_0079)*((-0.5)*IT_0098*IT_0105 + IT_0079
      *IT_0141 + (-2)*IT_0107*IT_0143 + (-0.25)*IT_0088*IT_0144) + (IT_0066
      *IT_0098 + IT_0131*IT_0144)*IT_0145;
