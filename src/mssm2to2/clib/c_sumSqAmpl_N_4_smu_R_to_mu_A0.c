        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
    ...
    const ccomplex_t IT_0012 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_smu_L*
    ...
    const ccomplex_t IT_0027 = IT_0002*IT_0020;
    ...
    const ccomplex_t IT_0045 = pow(m_smu_R, 2);
    ...
    const ccomplex_t IT_0183 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0006;
    const ccomplex_t IT_0184 = 0.5*IT_0183;
    const ccomplex_t IT_0185 = IT_0132*IT_0184;
    ...
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0207 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0212 = m_N_4*IT_0152;
    const ccomplex_t IT_0213 = m_N_3*IT_0170;
    const ccomplex_t IT_0214 = IT_0212 + IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0006;
    ...
    const ccomplex_t IT_0222 = m_mu*m_N_4;
    const ccomplex_t IT_0223 = 2*IT_0179;
    const ccomplex_t IT_0224 = e_em*m_mu*IT_0000*IT_0002*IT_0006*IT_0020;
    const ccomplex_t IT_0225 = (-0.5)*IT_0224;
    const ccomplex_t IT_0226 = IT_0044*IT_0225;
    const ccomplex_t IT_0227 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0045 
      + -reg_prop, -1);
    const ccomplex_t IT_0228 = IT_0226*IT_0227;
    const ccomplex_t IT_0229 = (0 + _Complex_I*1)*IT_0228;
    const ccomplex_t IT_0230 = IT_0066*IT_0210;
    const ccomplex_t IT_0231 = IT_0109*IT_0186;
    const ccomplex_t IT_0232 = IT_0152*IT_0218;
    const ccomplex_t IT_0233 = IT_0030*IT_0202;
    const ccomplex_t IT_0234 = -IT_0229 + IT_0230 + IT_0231 + IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = m_mu*s_14;
    const ccomplex_t IT_0236 = IT_0084*IT_0091;
    const ccomplex_t IT_0237 = IT_0200*IT_0225;
