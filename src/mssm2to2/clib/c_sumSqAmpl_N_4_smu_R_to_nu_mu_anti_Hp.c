...
ccomplex_return_t c_sumSqAmpl_N_4_smu_R_to_nu_mu_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = conj(N_u4)*e_em*conj(V_Wp1);
    ...
    const ccomplex_t IT_0014 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0015 = IT_0013*IT_0014;
    const ccomplex_t IT_0016 = 1.4142135623731*IT_0015;
    const ccomplex_t IT_0017 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0026 = pow(m_smu_R, 2);
    const ccomplex_t IT_0027 = cpow(s_23 + (-0.5)*IT_0026 + 0.5*m_C_1*(m_C_1 +
    ...
    const ccomplex_t IT_0040 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0047 = IT_0029*IT_0030*IT_0046;
    const ccomplex_t IT_0048 = sin(beta);
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0000*IT_0002*IT_0004*IT_0048;
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + -IT_0026 + IT_0054 + -IT_0055 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*m_mu;
    const ccomplex_t IT_0064 = IT_0056*IT_0062*IT_0063;
    const ccomplex_t IT_0065 = cpow(s_13 + (-0.5)*IT_0055 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0000*IT_0004;
    ...
    const ccomplex_t IT_0079 = (-0.5)*IT_0028 + (-0.5)*IT_0047 + -IT_0059 +
       IT_0064 + 0.5*IT_0078;
    const ccomplex_t IT_0080 = IT_0004*IT_0048;
    const ccomplex_t IT_0081 = N_d4*e_em*U_Wm2;
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (-2)*IT_0082;
    const ccomplex_t IT_0084 = IT_0012*IT_0048;
    const ccomplex_t IT_0085 = N_B4*U_d2*e_em;
    const ccomplex_t IT_0086 = IT_0084*IT_0085;
    const ccomplex_t IT_0087 = 1.4142135623731*IT_0086;
    const ccomplex_t IT_0088 = N_W4*U_d2*e_em;
    ...
    const ccomplex_t IT_0114 = -IT_0058 + (-0.5)*IT_0097 + (-0.5)*IT_0113;
    const ccomplex_t IT_0115 = s_23*m_N_4;
    const ccomplex_t IT_0116 = s_12*s_23;
    const ccomplex_t IT_0117 = s_13*IT_0026;
