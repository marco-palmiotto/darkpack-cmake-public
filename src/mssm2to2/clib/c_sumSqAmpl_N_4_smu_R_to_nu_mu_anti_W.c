...
ccomplex_return_t c_sumSqAmpl_N_4_smu_R_to_nu_mu_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0035 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0036 = IT_0004*IT_0035;
    const ccomplex_t IT_0037 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0044 = IT_0016*IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0004;
    ...
    const ccomplex_t IT_0053 = pow(m_N_4, 2);
    ...
    const ccomplex_t IT_0058 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0059 = IT_0004*IT_0058;
    const ccomplex_t IT_0060 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0076 = m_N_4*IT_0074*IT_0075;
    ...
    const ccomplex_t IT_0108 = -IT_0053;
    ...
    const ccomplex_t IT_0114 = s_34*IT_0053;
    ...
    const ccomplex_t IT_0128 = conj(IT_0073)*IT_0120;
    const ccomplex_t IT_0129 = 0.5*IT_0090*IT_0116;
    const ccomplex_t IT_0130 = 2*(IT_0034 + IT_0067)*IT_0105 + (conj(IT_0089)
      ...
      *IT_0118 + 2*IT_0073*(0.5*IT_0090*IT_0111 + IT_0076*IT_0112 + conj(IT_0073
      ...
      (IT_0099)*IT_0125 + (-2)*conj(IT_0072)*IT_0127 + (-0.5)*IT_0128 + (-0.5)
      *IT_0129) + (-4)*IT_0072*((-0.5)*IT_0097*IT_0112 + conj(IT_0072)*IT_0125 +
       (-2)*conj(IT_0099)*IT_0127 + (-0.5)*IT_0128 + (-0.5)*IT_0129);
