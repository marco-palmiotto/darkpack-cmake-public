...
ccomplex_return_t c_sumSqAmpl_N_4_snu_e_to_e_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_e*m_N_4*IT_0000;
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_23 + IT_0000 + IT_0024 + -m_C_2*
    ...
    const ccomplex_t IT_0111 = m_e*m_N_4;
    const ccomplex_t IT_0112 = cpow((-2)*s_13 + IT_0024 + IT_0047 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0003*IT_0049;
    ...
    const ccomplex_t IT_0121 = IT_0022*IT_0087;
    const ccomplex_t IT_0122 = IT_0025*IT_0120*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0124 = IT_0042*IT_0067;
    const ccomplex_t IT_0125 = IT_0028*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = cpow((-2)*s_13 + IT_0024 + IT_0047 + -m_se_L*
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0003*IT_0049*IT_0050;
    ...
    const ccomplex_t IT_0134 = m_N_4*IT_0064;
    const ccomplex_t IT_0135 = IT_0119 + -IT_0122 + -IT_0125 + IT_0133 + (-0.5
      )*IT_0134;
    const ccomplex_t IT_0136 = IT_0027 + IT_0045;
    const ccomplex_t IT_0137 = m_e*IT_0136;
    const ccomplex_t IT_0138 = -IT_0137;
    const ccomplex_t IT_0139 = IT_0085 + IT_0103;
    const ccomplex_t IT_0140 = m_e*IT_0139;
    const ccomplex_t IT_0141 = -IT_0140;
    const ccomplex_t IT_0142 = IT_0004*IT_0100;
    const ccomplex_t IT_0143 = IT_0025*IT_0120*IT_0142;
    const ccomplex_t IT_0144 = IT_0029*IT_0082;
    const ccomplex_t IT_0145 = IT_0028*IT_0123*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0003*IT_0049*IT_0050;
    const ccomplex_t IT_0147 = 0.5*IT_0146;
    const ccomplex_t IT_0148 = IT_0114*IT_0147;
    const ccomplex_t IT_0149 = IT_0112*IT_0148;
    ...
    const ccomplex_t IT_0157 = 2*IT_0135;
    const ccomplex_t IT_0158 = (-2)*IT_0138;
    const ccomplex_t IT_0159 = IT_0157 + IT_0158;
    const ccomplex_t IT_0160 = 2*conj(IT_0135);
    const ccomplex_t IT_0161 = (-2)*conj(IT_0138);
    const ccomplex_t IT_0162 = IT_0160 + IT_0161;
    const ccomplex_t IT_0163 = s_23*m_N_4;
    ...
    const ccomplex_t IT_0173 = 2*IT_0001*(conj(IT_0046)*IT_0105 + IT_0046
      ...
      *IT_0111*((conj(IT_0135) + -conj(IT_0138))*IT_0141 + (IT_0135 + -IT_0138)
      ...
      *IT_0166 + IT_0105*IT_0169)*IT_0170 + (IT_0135*conj(IT_0135) + IT_0138
      *conj(IT_0138) + IT_0141*conj(IT_0141) + IT_0156*conj(IT_0156))*IT_0171 + 
      (conj(IT_0135)*IT_0138 + IT_0135*conj(IT_0138) + conj(IT_0141)*IT_0156 +
