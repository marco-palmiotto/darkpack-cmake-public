...
ccomplex_return_t c_sumSqAmpl_N_4_snu_e_to_e_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_e*U_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0015 + IT_0037 + -m_se_L*
    ...
    const ccomplex_t IT_0063 = m_e*m_N_4;
    ...
    const ccomplex_t IT_0070 = cpow(s_12 + 0.5*IT_0016 + 0.5*IT_0037 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0071 = 0.5*IT_0033;
    ...
    const ccomplex_t IT_0127 = IT_0028*IT_0081;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0129 = IT_0030*IT_0127*IT_0128;
    ...
    const ccomplex_t IT_0144 = IT_0006*IT_0099;
    const ccomplex_t IT_0145 = IT_0017*IT_0125*IT_0144;
    const ccomplex_t IT_0146 = IT_0021*IT_0088;
    const ccomplex_t IT_0147 = IT_0030*IT_0128*IT_0146;
