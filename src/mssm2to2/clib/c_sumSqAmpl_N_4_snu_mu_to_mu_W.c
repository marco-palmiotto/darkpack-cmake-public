        ...
        )
{
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0031 = N_W4*e_em*conj(U_Wm1);
    const ccomplex_t IT_0032 = IT_0004*IT_0031;
    const ccomplex_t IT_0033 = N_d4*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0141 = m_N_4*IT_0041;
    const ccomplex_t IT_0142 = m_mu*IT_0076;
    const ccomplex_t IT_0143 = IT_0140 + IT_0141 + 0.5*IT_0142;
    const ccomplex_t IT_0144 = IT_0030*IT_0099;
    const ccomplex_t IT_0145 = IT_0039*IT_0124*IT_0144;
    const ccomplex_t IT_0146 = IT_0006*IT_0088;
    const ccomplex_t IT_0147 = IT_0017*IT_0127*IT_0146;
    ...
    const ccomplex_t IT_0175 = m_N_4*IT_0173;
    const ccomplex_t IT_0176 = (-2)*conj(IT_0105);
    const ccomplex_t IT_0177 = m_mu*IT_0047;
    const ccomplex_t IT_0178 = (-2)*conj(IT_0155);
    ...
    const ccomplex_t IT_0196 = s_13*IT_0173;
    ...
    const ccomplex_t IT_0203 = (-0.166666666666667)*IT_0175;
    const ccomplex_t IT_0204 = IT_0063*IT_0133 + (-0.166666666666667)*IT_0168
      *IT_0188 + (-0.166666666666667)*IT_0158*IT_0195 + (-0.666666666666667)
      *IT_0167*(IT_0148 + 0.25*IT_0198) + (-0.333333333333333)*IT_0177*(IT_0062 
      + 0.5*IT_0199) + IT_0123*IT_0200 + IT_0139*IT_0201 + IT_0187*IT_0202 +
       IT_0169*IT_0203;
    const ccomplex_t IT_0205 = (-3)*IT_0063*IT_0149 + 2*IT_0133*IT_0167 + 0.5
      *IT_0168*IT_0169 + IT_0042*IT_0177 + IT_0158*IT_0183 + (-3)*IT_0139
      *IT_0200 + (-3)*IT_0123*IT_0201 + (-3)*IT_0163*IT_0202 + (-3)*IT_0188
      *IT_0203;
    const ccomplex_t IT_0206 = (-2)*conj(IT_0062);
    const ccomplex_t IT_0207 = IT_0069*IT_0189;
    const ccomplex_t IT_0208 = 2*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      ...
      *IT_0154 + IT_0064*IT_0155 + IT_0156*IT_0157 + IT_0149*IT_0158)*IT_0159 +
       2*conj(IT_0130)*(IT_0065*IT_0123 + IT_0155*IT_0158 + IT_0077*IT_0163 + 2
      *IT_0133*IT_0167 + 0.5*IT_0168*IT_0169) + (IT_0062*IT_0157 + IT_0133
      *IT_0168 + IT_0156*IT_0174 + IT_0149*IT_0175)*IT_0176 + 2*IT_0177*(IT_0042
      *conj(IT_0130) + conj(IT_0042)*IT_0133 + IT_0149*(conj(IT_0062) + 0.5
      *IT_0178)) + 2*conj(IT_0077)*(IT_0065*IT_0080 + (-2)*IT_0077*IT_0117 +
       IT_0133*IT_0163 + 4*IT_0103*IT_0180 + IT_0069*IT_0183 + IT_0149*IT_0187 +
       0.5*IT_0109*IT_0188) + (IT_0149*IT_0168 + IT_0132*IT_0175 + IT_0109
      *IT_0189)*IT_0190 + IT_0192 + (IT_0103*IT_0139 + IT_0062*IT_0158 + IT_0156
      *IT_0175)*IT_0193 + 2*conj(IT_0062)*(IT_0048*IT_0062 + IT_0042*IT_0064 +
       0.5*IT_0158*IT_0191 + IT_0169*IT_0194) + 2*conj(IT_0105)*(IT_0065*IT_0109
       + IT_0155*IT_0157 + 0.5*IT_0154*IT_0195 + IT_0169*IT_0197) + 2*conj
      (IT_0156)*(0.5*IT_0169*IT_0174 + IT_0154*IT_0183 + 0.5*IT_0175*IT_0191 +
       IT_0194*IT_0195 + IT_0188*IT_0197) + (-6)*(conj(IT_0143) + conj(IT_0148))
      *IT_0204 + 2*conj(IT_0132)*IT_0205 + IT_0206*(IT_0048*IT_0155 + IT_0154
      *IT_0156 + IT_0132*IT_0158 + IT_0207) + 2*conj(IT_0155)*(IT_0154*IT_0156 +
       IT_0105*IT_0157 + IT_0133*IT_0158 + IT_0048*IT_0183 + 0.5*IT_0064*IT_0195
       + IT_0207);
