        ...
        )
{
    ...
    const ccomplex_t IT_0032 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0036 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0041 = conj(N_B1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0123 = conj(N_W3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0127 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0128 = IT_0009*IT_0127;
    const ccomplex_t IT_0129 = IT_0122 + IT_0124 + IT_0126 + IT_0128;
    const ccomplex_t IT_0130 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0166 = cpow(s_23 + (-0.5)*IT_0063 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0183 = N_B2*N_u4*e_em;
    ...
    const ccomplex_t IT_0192 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0196 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0201 = conj(N_B2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0205 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0223 = cpow(s_23 + (-0.5)*IT_0063 + 0.5*m_N_2*(m_N_2 +
