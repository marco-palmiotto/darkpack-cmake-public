        ...
        )
{
    ...
    const ccomplex_t IT_0010 = N_B1*N_u4*e_em;
    ...
    const ccomplex_t IT_0018 = N_W4*N_u1*e_em;
    ...
    const ccomplex_t IT_0023 = N_W1*N_u4*e_em;
    ...
    const ccomplex_t IT_0036 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0037 = IT_0003*IT_0036;
    const ccomplex_t IT_0038 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0084 = pow(m_N_4, 2);
    ...
    const ccomplex_t IT_0096 = cpow(s_23 + (-0.5)*IT_0063 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0156 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0157 = IT_0003*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0159 = IT_0007*IT_0158;
    const ccomplex_t IT_0160 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0161 = IT_0017*IT_0160;
    const ccomplex_t IT_0162 = conj(N_W4)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0168 = cpow(s_23 + (-0.5)*IT_0063 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0194 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0195 = IT_0003*IT_0194;
    const ccomplex_t IT_0196 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0197 = IT_0007*IT_0196;
    const ccomplex_t IT_0198 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0199 = IT_0003*IT_0198;
    const ccomplex_t IT_0200 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0201 = IT_0007*IT_0200;
    const ccomplex_t IT_0202 = IT_0195 + IT_0197 + IT_0199 + IT_0201;
    const ccomplex_t IT_0203 = conj(N_W2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0207 = conj(N_W4)*conj(N_u2)*e_em;
