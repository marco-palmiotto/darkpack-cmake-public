...
ccomplex_return_t c_sumSqAmpl_N_4_snu_tau_to_nu_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0033 = IT_0021*IT_0032;
    const ccomplex_t IT_0034 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0035 = IT_0024*IT_0034;
    const ccomplex_t IT_0036 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0050 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0078 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0079 = IT_0017*IT_0078;
    const ccomplex_t IT_0080 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0081 = IT_0021*IT_0080;
    const ccomplex_t IT_0082 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0083 = IT_0024*IT_0082;
    const ccomplex_t IT_0084 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0085 = IT_0027*IT_0084;
    const ccomplex_t IT_0086 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0087 = IT_0017*IT_0086;
    const ccomplex_t IT_0088 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0089 = IT_0021*IT_0088;
    const ccomplex_t IT_0090 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0091 = IT_0024*IT_0090;
    const ccomplex_t IT_0092 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0113 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0114 = IT_0024*IT_0113;
    const ccomplex_t IT_0115 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0116 = IT_0027*IT_0115;
    const ccomplex_t IT_0117 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0118 = IT_0017*IT_0117;
    const ccomplex_t IT_0119 = N_B3*N_d4*e_em;
    ...
    const ccomplex_t IT_0127 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0141 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0154 = cpow(s_23 + (-0.5)*IT_0012 + 0.5*m_N_3*(m_N_3 +
