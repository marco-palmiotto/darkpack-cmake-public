        ...
        )
{
    ...
    const ccomplex_t IT_0027 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0028 = cpow(s_23 + (-0.5)*IT_0027 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0033 = 0.25*IT_0032;
    ...
    const ccomplex_t IT_0042 = cpow(s_23 + (-0.5)*IT_0027 + 0.5*m_N_2*(m_N_2 +
       (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = conj(N_d2)*N_d4*e_em;
    ...
    const ccomplex_t IT_0074 = cpow(s_23 + (-0.5)*IT_0027 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0098 = IT_0016*IT_0030;
    const ccomplex_t IT_0099 = conj(N_B3)*e_em;
    const ccomplex_t IT_0100 = IT_0001*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0107 = cpow(s_23 + (-0.5)*IT_0027 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0119 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0120 = IT_0003*IT_0119;
    const ccomplex_t IT_0121 = IT_0007*IT_0119;
    const ccomplex_t IT_0122 = N_d3*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0131 = (-0.5)*IT_0065 + (-0.5)*IT_0097 + (-0.25)
      *IT_0098 + (-0.5)*IT_0130;
    ...
    const ccomplex_t IT_0141 = conj(IT_0033) + conj(IT_0131);
    ...
    const ccomplex_t IT_0147 = IT_0044*IT_0061;
    const ccomplex_t IT_0148 = IT_0076*IT_0093;
    const ccomplex_t IT_0149 = IT_0109*IT_0126;
    const ccomplex_t IT_0150 = (-0.5)*IT_0147 + (-0.5)*IT_0148 + (-0.5)*IT_0149;
    const ccomplex_t IT_0151 = -IT_0015;
    const ccomplex_t IT_0152 = IT_0013 + IT_0151;
    const ccomplex_t IT_0153 = IT_0030*IT_0152;
    const ccomplex_t IT_0154 = 0.25*IT_0153;
    const ccomplex_t IT_0155 = IT_0150 + -IT_0154;
    const ccomplex_t IT_0156 = -conj(IT_0154);
    const ccomplex_t IT_0157 = conj(IT_0150) + IT_0156;
    const ccomplex_t IT_0158 = e_em*IT_0003;
    const ccomplex_t IT_0159 = e_em*IT_0007;
    ...
    const ccomplex_t IT_0163 = pow(m_N_4, 2);
    const ccomplex_t IT_0164 = cpow(s_12 + 0.5*IT_0027 + 0.5*IT_0163 + 0.5
      *reg_prop, -1);
    ...
    const ccomplex_t IT_0168 = (-0.25)*IT_0144;
    const ccomplex_t IT_0169 = IT_0135 + IT_0168;
    const ccomplex_t IT_0170 = s_34*IT_0133;
    const ccomplex_t IT_0171 = IT_0132*IT_0170;
    const ccomplex_t IT_0172 = 0.5*IT_0171;
    const ccomplex_t IT_0173 = s_34 + IT_0172;
    const ccomplex_t IT_0174 = m_N_4*IT_0173;
    const ccomplex_t IT_0175 = 2*IT_0174;
    const ccomplex_t IT_0176 = 2*conj(IT_0033);
    const ccomplex_t IT_0177 = 2*conj(IT_0131);
    const ccomplex_t IT_0178 = IT_0176 + IT_0177;
    const ccomplex_t IT_0179 = s_14*s_34*IT_0132;
    const ccomplex_t IT_0180 = -IT_0179;
    const ccomplex_t IT_0181 = s_13 + IT_0180;
    const ccomplex_t IT_0182 = s_13*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0006;
    const ccomplex_t IT_0184 = -IT_0183;
    const ccomplex_t IT_0185 = cpow(s_13 + (-0.5)*IT_0163 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0189 = -IT_0166 + (-0.5)*IT_0188;
    const ccomplex_t IT_0190 = IT_0147 + IT_0148 + IT_0149;
    const ccomplex_t IT_0191 = 2*IT_0190;
    const ccomplex_t IT_0192 = IT_0013*IT_0030;
    const ccomplex_t IT_0193 = IT_0015*IT_0030;
    const ccomplex_t IT_0194 = 0.5*IT_0188 + (-0.5)*IT_0192 + 0.5*IT_0193;
    const ccomplex_t IT_0195 = (-2)*IT_0194;
    const ccomplex_t IT_0196 = IT_0191 + IT_0195;
    const ccomplex_t IT_0197 = 2*conj(IT_0190);
    const ccomplex_t IT_0198 = (-2)*conj(IT_0194);
    const ccomplex_t IT_0199 = IT_0197 + IT_0198;
    const ccomplex_t IT_0200 = m_N_4*IT_0181;
    const ccomplex_t IT_0201 = pow(s_34, 2);
    const ccomplex_t IT_0202 = s_13*IT_0132*IT_0201;
    const ccomplex_t IT_0203 = 2*IT_0189;
    const ccomplex_t IT_0204 = m_N_4*IT_0132*IT_0201;
    const ccomplex_t IT_0205 = 2*conj(IT_0189);
    const ccomplex_t IT_0206 = s_13*s_34;
    const ccomplex_t IT_0207 = conj(IT_0150) + conj(IT_0167);
    const ccomplex_t IT_0208 = IT_0150 + IT_0167;
    const ccomplex_t IT_0209 = (-0.25)*IT_0171;
    const ccomplex_t IT_0210 = s_34 + IT_0209;
    const ccomplex_t IT_0211 = m_N_4*IT_0210;
    const ccomplex_t IT_0212 = (-4)*IT_0211;
    const ccomplex_t IT_0213 = 2*IT_0131;
    const ccomplex_t IT_0214 = pow(s_14, 2);
    const ccomplex_t IT_0215 = IT_0132*IT_0214;
    const ccomplex_t IT_0216 = -IT_0163;
    const ccomplex_t IT_0217 = IT_0215 + IT_0216;
    const ccomplex_t IT_0218 = s_13*IT_0217;
    const ccomplex_t IT_0219 = 2*IT_0194;
    const ccomplex_t IT_0220 = (-0.5)*IT_0219;
    const ccomplex_t IT_0221 = IT_0190 + IT_0220;
    const ccomplex_t IT_0222 = (-2)*conj(IT_0190);
    const ccomplex_t IT_0223 = s_13*s_14;
    const ccomplex_t IT_0224 = s_34*IT_0163;
    const ccomplex_t IT_0225 = -IT_0224;
    const ccomplex_t IT_0226 = IT_0223 + IT_0225;
    const ccomplex_t IT_0227 = 4*(IT_0033 + IT_0131)*IT_0140*IT_0141 + (-4)
      *IT_0146*IT_0155*IT_0157 + 8*IT_0167*(IT_0157*IT_0169 + 0.125*IT_0175
      *IT_0178) + IT_0182*(conj(IT_0189)*IT_0196 + IT_0189*IT_0199) + (IT_0141
      *IT_0196 + (IT_0033 + IT_0131)*IT_0199)*IT_0200 + conj(IT_0189)*IT_0202
      *IT_0203 + IT_0204*(IT_0141*IT_0203 + (IT_0033 + IT_0131)*IT_0205) + (-2)
      *IT_0206*(conj(IT_0154)*IT_0189 + IT_0154*conj(IT_0189) + (-0.5)*IT_0203
      *IT_0207 + (-0.5)*IT_0205*IT_0208) + (-2)*IT_0212*(IT_0141*IT_0150 +
       IT_0131*conj(IT_0150) + IT_0033*IT_0157 + (-0.5)*IT_0154*IT_0178 + (-0.5)
      *conj(IT_0154)*IT_0213) + (-4)*conj(IT_0167)*(IT_0146*IT_0167 + (-2)
      *IT_0155*IT_0169 + (-0.5)*IT_0175*(IT_0033 + 0.5*IT_0213)) + (-2)*IT_0218*
      ((-0.5)*conj(IT_0190)*IT_0191 + conj(IT_0194)*IT_0221 + (-0.5)*IT_0194
      *IT_0222) + (IT_0196*IT_0207 + IT_0199*IT_0208 + 2*IT_0156*IT_0221 + 2
      *IT_0154*(conj(IT_0194) + 0.5*IT_0222))*IT_0226;
