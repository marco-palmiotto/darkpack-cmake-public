...
ccomplex_return_t c_sumSqAmpl_N_4_snu_tau_to_nu_tau_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = conj(N_u2)*N_u4*e_em;
    ...
    const ccomplex_t IT_0048 = cpow(s_23 + (-0.5)*IT_0021 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0053 = N_u4*conj(N_u4)*e_em;
    const ccomplex_t IT_0054 = IT_0028*IT_0053;
    const ccomplex_t IT_0055 = IT_0025*IT_0053;
    const ccomplex_t IT_0056 = IT_0025*IT_0051;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*(IT_0052 + -IT_0054 + 
      -IT_0055 + IT_0056);
    ...
    const ccomplex_t IT_0087 = conj(N_d1)*N_d4*e_em;
    const ccomplex_t IT_0088 = IT_0025*IT_0087;
    const ccomplex_t IT_0089 = conj(N_u1)*N_u4*e_em;
    const ccomplex_t IT_0090 = IT_0028*IT_0089;
    const ccomplex_t IT_0091 = IT_0025*IT_0089;
    const ccomplex_t IT_0092 = IT_0028*IT_0087;
    ...
    const ccomplex_t IT_0108 = cpow(s_23 + (-0.5)*IT_0021 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0124 = conj(N_d3)*N_d4*e_em;
    ...
    const ccomplex_t IT_0133 = (-0.5)*IT_0039 + (-0.25)*IT_0063 + (-0.5)
      *IT_0099 + (-0.5)*IT_0132;
    const ccomplex_t IT_0134 = N_u2*conj(N_u4)*e_em;
    const ccomplex_t IT_0135 = IT_0028*IT_0134;
    const ccomplex_t IT_0136 = IT_0025*IT_0134;
    const ccomplex_t IT_0137 = N_d2*conj(N_d4)*e_em;
    const ccomplex_t IT_0138 = IT_0025*IT_0137;
    const ccomplex_t IT_0139 = IT_0028*IT_0137;
    ...
    const ccomplex_t IT_0145 = (-0.5)*IT_0060;
    ...
    const ccomplex_t IT_0150 = IT_0050*IT_0149;
    const ccomplex_t IT_0151 = 0.5*IT_0144 + 0.25*IT_0147 + (-0.25)*IT_0150;
    const ccomplex_t IT_0152 = IT_0133 + IT_0151;
    const ccomplex_t IT_0153 = conj(IT_0133) + conj(IT_0151);
    const ccomplex_t IT_0154 = s_14*s_34*IT_0000;
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = s_13 + IT_0155;
    const ccomplex_t IT_0157 = s_13*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*e_em*IT_0010*IT_0015;
    const ccomplex_t IT_0159 = -IT_0158;
    const ccomplex_t IT_0160 = pow(m_N_4, 2);
    const ccomplex_t IT_0161 = cpow(s_13 + (-0.5)*IT_0160 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0165 = cpow(s_12 + 0.5*IT_0021 + 0.5*IT_0160 + 0.5
      *reg_prop, -1);
    const ccomplex_t IT_0166 = e_em*IT_0025;
    const ccomplex_t IT_0167 = e_em*IT_0028;
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*(IT_0166 + IT_0167);
    ...
    const ccomplex_t IT_0173 = (-0.5)*IT_0164 + -IT_0172;
    const ccomplex_t IT_0174 = (-0.5)*IT_0081;
    const ccomplex_t IT_0175 = IT_0074*IT_0174;
    const ccomplex_t IT_0176 = IT_0110*IT_0118;
    const ccomplex_t IT_0177 = IT_0175 + IT_0176;
    const ccomplex_t IT_0178 = 2*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*(IT_0135 + IT_0136 + 
      -IT_0138 + -IT_0139);
    ...
    const ccomplex_t IT_0184 = IT_0050*IT_0145;
    const ccomplex_t IT_0185 = IT_0050*IT_0061;
    const ccomplex_t IT_0186 = 0.5*IT_0164 + -IT_0183 + (-0.5)*IT_0184 + 0.5
      *IT_0185;
    const ccomplex_t IT_0187 = (-2)*IT_0186;
    const ccomplex_t IT_0188 = IT_0178 + IT_0187;
    const ccomplex_t IT_0189 = 2*conj(IT_0177);
    const ccomplex_t IT_0190 = (-2)*conj(IT_0186);
    const ccomplex_t IT_0191 = IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = m_N_4*IT_0156;
    ...
    const ccomplex_t IT_0199 = IT_0074*IT_0084;
    const ccomplex_t IT_0200 = (-0.5)*IT_0176 + (-0.5)*IT_0199;
    const ccomplex_t IT_0201 = 0.5*IT_0183 + 0.25*IT_0184 + (-0.25)*IT_0185;
    const ccomplex_t IT_0202 = 2*IT_0133;
    const ccomplex_t IT_0203 = 2*IT_0151;
    const ccomplex_t IT_0204 = IT_0202 + IT_0203;
    const ccomplex_t IT_0205 = 2*conj(IT_0133);
    const ccomplex_t IT_0206 = 2*conj(IT_0151);
    const ccomplex_t IT_0207 = IT_0205 + IT_0206;
    const ccomplex_t IT_0208 = pow(s_34, 2);
    const ccomplex_t IT_0209 = s_13*IT_0000*IT_0208;
    const ccomplex_t IT_0210 = 2*IT_0173;
    const ccomplex_t IT_0211 = m_N_4*IT_0000*IT_0208;
    const ccomplex_t IT_0212 = 2*conj(IT_0173);
    const ccomplex_t IT_0213 = s_13*s_34;
    const ccomplex_t IT_0214 = (-0.5)*IT_0172;
    const ccomplex_t IT_0215 = conj(IT_0200) + conj(IT_0214);
    const ccomplex_t IT_0216 = IT_0200 + IT_0214;
    const ccomplex_t IT_0217 = pow(m_Z, 4);
    const ccomplex_t IT_0218 = s_13*IT_0217;
    const ccomplex_t IT_0219 = IT_0000*IT_0218;
    const ccomplex_t IT_0220 = (-0.5)*IT_0219;
    const ccomplex_t IT_0221 = IT_0002 + IT_0004 + IT_0220;
    const ccomplex_t IT_0222 = -conj(IT_0201);
    const ccomplex_t IT_0223 = (-0.25)*IT_0219;
    const ccomplex_t IT_0224 = IT_0003 + IT_0223;
    const ccomplex_t IT_0225 = 0.5*IT_0194;
    ...
    const ccomplex_t IT_0232 = -IT_0160;
    const ccomplex_t IT_0233 = IT_0231 + IT_0232;
    const ccomplex_t IT_0234 = s_13*IT_0233;
    const ccomplex_t IT_0235 = (-2)*conj(IT_0177);
    const ccomplex_t IT_0236 = 2*IT_0186;
    const ccomplex_t IT_0237 = (-0.5)*IT_0236;
    const ccomplex_t IT_0238 = s_13*s_14;
    const ccomplex_t IT_0239 = s_34*IT_0160;
    const ccomplex_t IT_0240 = -IT_0239;
    const ccomplex_t IT_0241 = IT_0238 + IT_0240;
    const ccomplex_t IT_0242 = 4*IT_0008*IT_0152*IT_0153 + IT_0157*(conj
      (IT_0173)*IT_0188 + IT_0173*IT_0191) + (IT_0153*IT_0188 + IT_0152*IT_0191)
      *IT_0192 + (-2)*IT_0198*(IT_0153*IT_0200 + IT_0152*conj(IT_0200) + (-0.5)
      *conj(IT_0201)*IT_0204 + (-0.5)*IT_0201*IT_0207) + conj(IT_0173)*IT_0209
      *IT_0210 + IT_0211*(IT_0153*IT_0210 + IT_0152*IT_0212) + (-2)*IT_0213*
      (conj(IT_0173)*IT_0201 + IT_0173*conj(IT_0201) + (-0.5)*IT_0210*IT_0215 + 
      (-0.5)*IT_0212*IT_0216) + (-4)*IT_0221*(IT_0214*conj(IT_0214) + (IT_0200 +
       -IT_0201)*(conj(IT_0200) + IT_0222)) + 8*conj(IT_0214)*((IT_0200 + 
      -IT_0201)*IT_0224 + IT_0204*IT_0229) + 8*IT_0214*((conj(IT_0200) + IT_0222
      )*IT_0224 + IT_0207*IT_0229) + IT_0234*(conj(IT_0177)*IT_0178 + IT_0186
      *IT_0235 + (-2)*conj(IT_0186)*(IT_0177 + IT_0237)) + (IT_0188*IT_0215 +
       IT_0191*IT_0216 + 2*IT_0201*(conj(IT_0186) + 0.5*IT_0235) + 2*IT_0222*
      (IT_0177 + IT_0237))*IT_0241;
