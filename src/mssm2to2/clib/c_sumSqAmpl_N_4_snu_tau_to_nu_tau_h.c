        ...
        )
{
    ...
    const ccomplex_t IT_0041 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0042 = IT_0026*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0044 = IT_0029*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0046 = IT_0032*IT_0045;
    const ccomplex_t IT_0047 = conj(N_W4)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0054 = cpow(s_23 + (-0.5)*IT_0053 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0168 = cpow(s_23 + (-0.5)*IT_0053 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0176 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0177 = IT_0026*IT_0176;
    const ccomplex_t IT_0178 = N_B1*N_d4*e_em;
    ...
    const ccomplex_t IT_0185 = N_W1*N_u4*e_em;
    ...
    const ccomplex_t IT_0194 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0195 = IT_0026*IT_0194;
    const ccomplex_t IT_0196 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0197 = IT_0029*IT_0196;
    const ccomplex_t IT_0198 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0199 = IT_0026*IT_0198;
    const ccomplex_t IT_0200 = conj(N_B4)*conj(N_d1)*e_em;
