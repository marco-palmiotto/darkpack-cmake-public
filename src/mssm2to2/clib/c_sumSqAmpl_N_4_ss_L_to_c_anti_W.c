...
ccomplex_return_t c_sumSqAmpl_N_4_ss_L_to_c_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0030 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0031 = IT_0004*IT_0030;
    const ccomplex_t IT_0032 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0063 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0082 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0083 = IT_0004*IT_0082;
    const ccomplex_t IT_0084 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0093 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0094 = IT_0004*IT_0093;
    const ccomplex_t IT_0095 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0125 = m_c*IT_0077;
    ...
    const ccomplex_t IT_0130 = IT_0017*IT_0128*IT_0129;
    const ccomplex_t IT_0131 = IT_0038*IT_0099;
    ...
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
    ...
    const ccomplex_t IT_0149 = IT_0013*IT_0081;
    const ccomplex_t IT_0150 = IT_0017*IT_0129*IT_0149;
    const ccomplex_t IT_0151 = IT_0036*IT_0092;
    const ccomplex_t IT_0152 = IT_0029*IT_0132*IT_0151;
    ...
    const ccomplex_t IT_0165 = m_N_4*IT_0160;
    const ccomplex_t IT_0166 = (-6)*conj(IT_0042);
    const ccomplex_t IT_0167 = 0.5*IT_0119;
    ...
    const ccomplex_t IT_0199 = (-6)*conj(IT_0103)*(IT_0065*IT_0104 + (
      ...
      -0.166666666666667)*IT_0077*IT_0187 + -IT_0069*IT_0194 + (
      -0.166666666666667)*IT_0109*IT_0195 + IT_0123*(IT_0155 + (
    ...
    const ccomplex_t IT_0209 = IT_0063*((-18)*IT_0153 + (-18)*IT_0155) +
       IT_0135*IT_0176 + IT_0178*IT_0184 + IT_0177*IT_0195 + IT_0165*IT_0204 +
       IT_0123*IT_0205 + IT_0191*IT_0206 + IT_0203*(IT_0062 + 0.166666666666667
      *IT_0207) + IT_0141*IT_0208;
    const ccomplex_t IT_0210 = IT_0063*((-18)*IT_0127 + (-18)*IT_0134) +
       IT_0156*IT_0176 + IT_0177*IT_0178 + 6*IT_0165*IT_0194 + IT_0184*IT_0195 +
       6*IT_0042*IT_0202 + IT_0141*IT_0205 + IT_0170*IT_0206 + IT_0123*IT_0208;
    ...
    const ccomplex_t IT_0216 = 6*conj(IT_0042)*(IT_0042*IT_0048 + IT_0062
      ...
      *IT_0117 + IT_0123*IT_0135 + IT_0141*IT_0156) + IT_0063*IT_0135*IT_0157 + 
      (IT_0105*IT_0161 + IT_0064*IT_0162 + IT_0163*IT_0164 + IT_0135*IT_0165)
      *IT_0166 + 6*conj(IT_0153)*(IT_0065*IT_0141 + IT_0162*IT_0165 + IT_0077
      *IT_0170 + 0.166666666666667*IT_0156*IT_0176 + 0.166666666666667*IT_0177
      *IT_0178) + (IT_0062*IT_0164 + IT_0156*IT_0177 + IT_0163*IT_0183 + IT_0135
      *IT_0184)*IT_0185 + 6*conj(IT_0077)*(IT_0065*IT_0080 + 0.166666666666667
      *IT_0077*IT_0117 + IT_0156*IT_0170 + 0.166666666666667*IT_0103*IT_0187 +
       IT_0135*IT_0191 + IT_0069*IT_0194 + 0.166666666666667*IT_0109*IT_0195) + 
      (IT_0135*IT_0177 + IT_0155*IT_0184 + IT_0109*IT_0196)*IT_0197 + IT_0199 + 
      (IT_0103*IT_0123 + IT_0062*IT_0165 + IT_0163*IT_0184)*IT_0200 + (IT_0042
      *conj(IT_0153) + conj(IT_0042)*IT_0156 + IT_0135*(conj(IT_0062) +
       0.166666666666667*IT_0201))*IT_0203 + (conj(IT_0127) + conj(IT_0134))
      ...
      *IT_0178*IT_0183 + IT_0161*IT_0194 + 0.166666666666667*IT_0184*IT_0198 +
       IT_0204*IT_0211 + IT_0195*IT_0213) + IT_0214*(IT_0048*IT_0162 + IT_0161
      *IT_0163 + IT_0155*IT_0165 + IT_0215) + 6*conj(IT_0162)*(IT_0161*IT_0163 +
       IT_0105*IT_0164 + IT_0156*IT_0165 + IT_0048*IT_0194 + 0.166666666666667
