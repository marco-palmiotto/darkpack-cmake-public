        ...
        )
{
    ...
    const ccomplex_t IT_0002 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0001;
    ...
    const ccomplex_t IT_0011 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_sc_L*
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0001;
    ...
    const ccomplex_t IT_0061 = pow(m_s, 2);
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0010 + -IT_0025 + IT_0061 
      + -reg_prop, -1);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*m_s;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0001;
    ...
    const ccomplex_t IT_0079 = m_c*IT_0047;
    ...
    const ccomplex_t IT_0094 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0143 = m_c*IT_0135;
    ...
    const ccomplex_t IT_0170 = m_c*IT_0104;
