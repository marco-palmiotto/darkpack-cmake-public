...
ccomplex_return_t c_sumSqAmpl_N_4_ss_L_to_s_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0023 = IT_0015*IT_0022;
    const ccomplex_t IT_0024 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0028 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0029 = IT_0027*IT_0028;
    const ccomplex_t IT_0030 = IT_0004*IT_0012;
    const ccomplex_t IT_0031 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0034 = IT_0027*IT_0033;
    const ccomplex_t IT_0035 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*m_s*e_em*IT_0000*IT_0002
      *IT_0004*IT_0012;
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0071 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_3*
    ...
    const ccomplex_t IT_0161 = cpow(IT_0013, -2);
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0012 + (-0.5)*m_W*(IT_0001*IT_0012 + -IT_0018*IT_0160)
      *(IT_0004 + 1./3*IT_0003*IT_0161));
    const ccomplex_t IT_0163 = -IT_0162;
    const ccomplex_t IT_0164 = IT_0078*IT_0163;
    const ccomplex_t IT_0165 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0166 = IT_0164*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*IT_0166;
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0169 = (-0.5)*IT_0168;
    const ccomplex_t IT_0170 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
    ...
    const ccomplex_t IT_0219 = IT_0065 + IT_0074 + (-2)*IT_0083 + IT_0108 +
    ...
    const ccomplex_t IT_0231 = IT_0076*IT_0227;
    const ccomplex_t IT_0232 = IT_0080*IT_0231;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*IT_0232;
    const ccomplex_t IT_0234 = m_s*IT_0233;
    ...
    const ccomplex_t IT_0278 = m_N_4*IT_0062;
    const ccomplex_t IT_0279 = m_N_2*IT_0040;
    const ccomplex_t IT_0280 = IT_0278 + IT_0279;
    const ccomplex_t IT_0281 = IT_0277*IT_0280;
    const ccomplex_t IT_0282 = IT_0084*IT_0227;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1)*IT_0282;
    const ccomplex_t IT_0284 = IT_0107*IT_0283;
    const ccomplex_t IT_0285 = -IT_0230 + 2*IT_0234 + -IT_0248 + -IT_0262 + 
      -IT_0267 + -IT_0281 + -IT_0284;
    const ccomplex_t IT_0286 = 6*s_13;
    const ccomplex_t IT_0287 = m_s*m_N_4;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0062*IT_0277;
    const ccomplex_t IT_0290 = IT_0134*IT_0258;
    const ccomplex_t IT_0291 = IT_0193*IT_0244;
    const ccomplex_t IT_0292 = IT_0095*IT_0283;
    const ccomplex_t IT_0293 = -IT_0082 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_s*s_14;
    const ccomplex_t IT_0295 = IT_0172*IT_0215;
    const ccomplex_t IT_0296 = IT_0011*IT_0040;
    const ccomplex_t IT_0297 = IT_0113*IT_0156;
    const ccomplex_t IT_0298 = IT_0086*IT_0105;
    ...
    const ccomplex_t IT_0304 = m_s*m_N_4*IT_0303;
