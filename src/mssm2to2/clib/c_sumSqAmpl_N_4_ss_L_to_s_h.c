...
ccomplex_return_t c_sumSqAmpl_N_4_ss_L_to_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
    ...
    const ccomplex_t IT_0016 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = sin(alpha);
    const ccomplex_t IT_0019 = IT_0014*IT_0018;
    const ccomplex_t IT_0020 = N_B4*N_d1*e_em;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0023 = IT_0015*IT_0022;
    const ccomplex_t IT_0024 = N_B1*N_d4*e_em;
    ...
    const ccomplex_t IT_0042 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0043 = IT_0015*IT_0042;
    const ccomplex_t IT_0044 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0045 = IT_0019*IT_0044;
    const ccomplex_t IT_0046 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0047 = IT_0015*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0049 = IT_0019*IT_0048;
    const ccomplex_t IT_0050 = IT_0043 + IT_0045 + IT_0047 + IT_0049;
    const ccomplex_t IT_0051 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0052 = IT_0027*IT_0051;
    const ccomplex_t IT_0053 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0054 = IT_0030*IT_0053;
    const ccomplex_t IT_0055 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0056 = IT_0027*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0063 = m_N_4*IT_0062;
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0004*IT_0007*IT_0018 + (-0.5)*m_W*(IT_0001*IT_0018 + IT_0012*IT_0075)*
      (IT_0004 + 1./3*IT_0003*IT_0076));
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0079 = (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = IT_0077*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*(IT_0099 + IT_0101 + 
      -IT_0103 + -IT_0105);
    ...
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0112 = (-0.5)*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_2*
    ...
    const ccomplex_t IT_0142 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0143 = IT_0015*IT_0142;
    const ccomplex_t IT_0144 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0145 = IT_0019*IT_0144;
    const ccomplex_t IT_0146 = IT_0139 + IT_0141 + IT_0143 + IT_0145;
    const ccomplex_t IT_0147 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0148 = IT_0027*IT_0147;
    const ccomplex_t IT_0149 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0150 = IT_0030*IT_0149;
    const ccomplex_t IT_0151 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0152 = IT_0027*IT_0151;
    const ccomplex_t IT_0153 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0189 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0193 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0200 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0201 = IT_0030*IT_0200;
    const ccomplex_t IT_0202 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0203 = IT_0027*IT_0202;
    const ccomplex_t IT_0204 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*m_s*e_em*IT_0000*IT_0002
      *IT_0004*IT_0018;
    const ccomplex_t IT_0214 = 0.5*IT_0213;
    const ccomplex_t IT_0215 = IT_0079*IT_0214;
    const ccomplex_t IT_0216 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0217 = IT_0215*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*IT_0217;
    const ccomplex_t IT_0219 = m_s*IT_0218;
    const ccomplex_t IT_0220 = IT_0065 + IT_0074 + IT_0083 + IT_0110 + IT_0161
       + IT_0212 + (-2)*IT_0219;
    const ccomplex_t IT_0221 = 6*s_13;
    const ccomplex_t IT_0222 = IT_0086*IT_0107;
    const ccomplex_t IT_0223 = IT_0011*IT_0062;
    const ccomplex_t IT_0224 = IT_0115*IT_0158;
    const ccomplex_t IT_0225 = IT_0166*IT_0209;
    ...
    const ccomplex_t IT_0234 = IT_0214*IT_0233;
    const ccomplex_t IT_0235 = IT_0216*IT_0234;
    const ccomplex_t IT_0236 = (0 + _Complex_I*1)*IT_0235;
    const ccomplex_t IT_0237 = -IT_0222 + -IT_0223 + -IT_0224 + -IT_0225 +
       IT_0236;
    const ccomplex_t IT_0238 = m_s*s_14;
    const ccomplex_t IT_0239 = conj(N_B1)*e_em;
    const ccomplex_t IT_0240 = IT_0014*IT_0239;
    const ccomplex_t IT_0241 = 1.4142135623731*IT_0240;
    const ccomplex_t IT_0242 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0272 = IT_0084*IT_0233;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*IT_0272;
    const ccomplex_t IT_0274 = IT_0096*IT_0273;
    const ccomplex_t IT_0275 = -IT_0218 + IT_0249 + IT_0260 + IT_0271 + IT_0274;
    const ccomplex_t IT_0276 = s_34*m_N_4;
    const ccomplex_t IT_0277 = m_N_4*IT_0136;
    const ccomplex_t IT_0278 = m_N_2*IT_0158;
    const ccomplex_t IT_0279 = IT_0277 + IT_0278;
    const ccomplex_t IT_0280 = IT_0259*IT_0279;
    const ccomplex_t IT_0281 = m_N_4*IT_0187;
    const ccomplex_t IT_0282 = m_N_3*IT_0209;
    const ccomplex_t IT_0283 = IT_0281 + IT_0282;
    const ccomplex_t IT_0284 = IT_0270*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0286 = 0.5*IT_0285;
    const ccomplex_t IT_0287 = IT_0067*IT_0286;
    const ccomplex_t IT_0288 = IT_0072*IT_0287;
    const ccomplex_t IT_0289 = (0 + _Complex_I*1)*IT_0288;
    const ccomplex_t IT_0290 = IT_0077*IT_0233;
    const ccomplex_t IT_0291 = IT_0081*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = IT_0109*IT_0273;
    const ccomplex_t IT_0294 = m_N_4*IT_0040;
    const ccomplex_t IT_0295 = m_N_1*IT_0062;
    const ccomplex_t IT_0296 = IT_0294 + IT_0295;
    const ccomplex_t IT_0297 = IT_0248*IT_0296;
    const ccomplex_t IT_0298 = m_s*IT_0236;
    const ccomplex_t IT_0299 = -IT_0280 + -IT_0284 + -IT_0289 + -IT_0292 + 
      -IT_0293 + -IT_0297 + 2*IT_0298;
    const ccomplex_t IT_0300 = 6*conj(IT_0299);
    const ccomplex_t IT_0301 = m_s*m_N_4;
    const ccomplex_t IT_0302 = 6*IT_0220;
    const ccomplex_t IT_0303 = 6*conj(IT_0220);
    const ccomplex_t IT_0304 = pow(m_h, 2);
    const ccomplex_t IT_0305 = m_s*m_N_4*IT_0304;
    ...
    const ccomplex_t IT_0310 = 6*IT_0299;
    const ccomplex_t IT_0311 = 0.166666666666667*IT_0276;
    const ccomplex_t IT_0312 = IT_0220*conj(IT_0220)*IT_0221 + (IT_0237
      *IT_0238 + IT_0275*IT_0276)*IT_0300 + conj(IT_0299)*(IT_0221*IT_0299 +
       IT_0301*IT_0302) + (IT_0238*IT_0275 + IT_0237*IT_0276 + IT_0299*IT_0301)
      *IT_0303 + 6*conj(IT_0237)*(IT_0275*IT_0305 + -IT_0237*IT_0309 +
       0.166666666666667*IT_0238*IT_0310 + IT_0302*IT_0311) + 6*conj(IT_0275)*
      (0.166666666666667*IT_0238*IT_0302 + IT_0237*IT_0305 + -IT_0275*IT_0309 +
       IT_0310*IT_0311);
