...
ccomplex_return_t c_sumSqAmpl_N_4_ss_R_to_c_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_12 + -IT_0011 + -IT_0027 + IT_0050 
      + -reg_prop, -1);
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0016;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
      *IT_0000*IT_0002*IT_0006*IT_0015;
    ...
    const ccomplex_t IT_0060 = N_d4*e_em*U_Wm1;
    ...
    const ccomplex_t IT_0076 = cpow((-2)*s_23 + IT_0010 + IT_0027 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = m_c*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0081 = (-0.333333333333333)*IT_0021;
    const ccomplex_t IT_0082 = IT_0055*IT_0081;
    const ccomplex_t IT_0083 = IT_0051*IT_0080*IT_0082;
    const ccomplex_t IT_0084 = IT_0014 + IT_0026 + -IT_0049 + IT_0059 + 
      -IT_0079 + -IT_0083;
    const ccomplex_t IT_0085 = 6*s_13;
    const ccomplex_t IT_0086 = m_c*s_12;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *IT_0000*IT_0002*IT_0005*IT_0016;
    ...
    const ccomplex_t IT_0092 = IT_0048 + IT_0078 + -IT_0091;
    const ccomplex_t IT_0093 = s_23*m_N_4;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0095 = IT_0002*IT_0015;
    const ccomplex_t IT_0096 = conj(N_u4)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0097 = IT_0095*IT_0096;
    const ccomplex_t IT_0098 = 2*IT_0097;
    const ccomplex_t IT_0099 = IT_0015*IT_0020;
    const ccomplex_t IT_0100 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0101 = IT_0099*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0111 = IT_0076*IT_0094*IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0113 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0114 = IT_0099*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0120 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0127 = IT_0028*IT_0112*IT_0126;
    const ccomplex_t IT_0128 = m_N_4*IT_0091;
    ...
    const ccomplex_t IT_0145 = IT_0053*IT_0088;
    const ccomplex_t IT_0146 = IT_0051*IT_0080*IT_0145;
    const ccomplex_t IT_0147 = IT_0111 + IT_0127 + -IT_0128 + -IT_0139 + 
      -IT_0144 + IT_0146;
    const ccomplex_t IT_0148 = 6*conj(IT_0147);
    const ccomplex_t IT_0149 = m_c*m_N_4;
    const ccomplex_t IT_0150 = 6*IT_0084;
    const ccomplex_t IT_0151 = 6*conj(IT_0084);
    const ccomplex_t IT_0152 = m_c*m_N_4*IT_0027;
    const ccomplex_t IT_0153 = s_13*IT_0027;
    ...
    const ccomplex_t IT_0158 = 0.166666666666667*IT_0086;
    const ccomplex_t IT_0159 = 6*IT_0147;
    const ccomplex_t IT_0160 = 0.166666666666667*IT_0093;
    const ccomplex_t IT_0161 = IT_0084*conj(IT_0084)*IT_0085 + (IT_0058
      *IT_0086 + IT_0092*IT_0093)*IT_0148 + conj(IT_0147)*(IT_0085*IT_0147 +
       IT_0149*IT_0150) + (IT_0086*IT_0092 + IT_0058*IT_0093 + IT_0147*IT_0149)
      *IT_0151 + 6*conj(IT_0058)*(IT_0092*IT_0152 + 0.166666666666667*IT_0058
      *IT_0157 + IT_0158*IT_0159 + IT_0150*IT_0160) + 6*conj(IT_0092)*(IT_0058
      *IT_0152 + 0.166666666666667*IT_0092*IT_0157 + IT_0150*IT_0158 + IT_0159
      *IT_0160);
