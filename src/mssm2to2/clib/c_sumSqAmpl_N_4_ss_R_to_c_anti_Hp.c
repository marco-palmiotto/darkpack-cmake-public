        ...
        )
{
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
    ...
    const ccomplex_t IT_0109 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0110 = IT_0095*IT_0109;
    const ccomplex_t IT_0111 = 1.4142135623731*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0116 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0145 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0152 = m_c*m_N_4*IT_0002;
