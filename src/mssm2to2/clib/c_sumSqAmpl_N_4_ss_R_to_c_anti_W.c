...
ccomplex_return_t c_sumSqAmpl_N_4_ss_R_to_c_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0006 = IT_0004*IT_0005;
    const ccomplex_t IT_0007 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0022 = conj(N_W4)*e_em*U_Wm2;
    const ccomplex_t IT_0023 = IT_0004*IT_0022;
    const ccomplex_t IT_0024 = conj(N_d4)*U_d2*e_em;
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_12 + -IT_0001 + IT_0034 + -IT_0035 
      + -reg_prop, -1);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0038 = cos(theta_W);
    const ccomplex_t IT_0039 = cpow(IT_0038, -1);
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0039;
    ...
    const ccomplex_t IT_0047 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0048 = IT_0004*IT_0047;
    const ccomplex_t IT_0049 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0055 = IT_0002*IT_0046*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0057 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0058 = IT_0004*IT_0057;
    const ccomplex_t IT_0059 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0065 = IT_0030*IT_0056*IT_0064;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0086 = s_13*IT_0082;
    const ccomplex_t IT_0087 = 2*IT_0076;
    const ccomplex_t IT_0088 = s_13*IT_0070;
    const ccomplex_t IT_0089 = s_13*s_14;
    const ccomplex_t IT_0090 = s_34*IT_0035;
    const ccomplex_t IT_0091 = -IT_0090;
    const ccomplex_t IT_0092 = IT_0089 + IT_0091;
    const ccomplex_t IT_0093 = -IT_0019 + -IT_0032;
    const ccomplex_t IT_0094 = conj(IT_0076) + conj(IT_0093);
    ...
    const ccomplex_t IT_0104 = m_c*IT_0070;
    ...
    const ccomplex_t IT_0109 = (-6)*IT_0087;
    ...
    const ccomplex_t IT_0134 = conj(IT_0066) + conj(IT_0085);
    const ccomplex_t IT_0135 = (-6)*conj(IT_0087);
    ...
    const ccomplex_t IT_0144 = m_c*m_N_4;
    ...
    const ccomplex_t IT_0152 = (-6)*conj(IT_0093);
    ...
    const ccomplex_t IT_0157 = 6*IT_0033*(conj(IT_0066)*IT_0071 + -conj
      (IT_0078)*IT_0083) + (IT_0071*conj(IT_0085) + conj(IT_0033)*IT_0086 + conj
      (IT_0087)*IT_0088 + IT_0092*IT_0094)*IT_0095 + IT_0087*(IT_0088*IT_0096 +
       IT_0101*IT_0102) + (conj(IT_0085)*IT_0101 + conj(IT_0087)*IT_0103 + conj
      (IT_0078)*IT_0104 + IT_0094*IT_0108)*IT_0109 + 6*IT_0076*
      (0.166666666666667*IT_0092*IT_0096 + conj(IT_0078)*IT_0116 +
       0.166666666666667*conj(IT_0076)*IT_0125 + 0.166666666666667*conj(IT_0093)
      *IT_0127 + IT_0133*IT_0134 + 0.166666666666667*IT_0108*IT_0135) + (-6)
      *IT_0093*((-0.166666666666667)*IT_0092*IT_0096 + (-0.166666666666667)*conj
      (IT_0093)*IT_0125 + (-0.166666666666667)*conj(IT_0076)*IT_0127 + (
      -0.166666666666667)*IT_0108*IT_0135 + conj(IT_0078)*IT_0139 + (conj
      (IT_0085) + (-0.166666666666667)*IT_0102)*IT_0143) + (-6)*IT_0078*(conj
      (IT_0033)*IT_0083 + -1./6*IT_0104*IT_0135 + -1./6*((-18)*conj(IT_0066) + (
      -18)*conj(IT_0085))*IT_0144 + -1./6*conj(IT_0078)*IT_0150 + -1./6*IT_0116
      *IT_0151 + -1./6*IT_0139*IT_0152) + IT_0085*(IT_0071*IT_0096 + IT_0101
      *IT_0135 + IT_0153 + IT_0154 + IT_0155 + IT_0156) + 6*IT_0066*(conj
      (IT_0033)*IT_0071 + -conj(IT_0087)*IT_0101 + 0.166666666666667*IT_0153 +
