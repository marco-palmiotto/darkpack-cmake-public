...
ccomplex_return_t c_sumSqAmpl_N_4_ss_R_to_s_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0042 = m_s*s_14*m_N_4;
    ...
    const ccomplex_t IT_0052 = m_s*m_N_4;
    ...
    const ccomplex_t IT_0057 = m_s*s_34*m_N_4;
