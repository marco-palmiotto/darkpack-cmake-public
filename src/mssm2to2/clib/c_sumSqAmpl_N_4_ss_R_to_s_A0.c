...
ccomplex_return_t c_sumSqAmpl_N_4_ss_R_to_s_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
    ...
    const ccomplex_t IT_0206 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0214 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0226 = m_s*m_N_4;
    ...
    const ccomplex_t IT_0252 = m_s*m_N_4*IT_0251;
