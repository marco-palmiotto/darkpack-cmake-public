...
ccomplex_return_t c_sumSqAmpl_N_4_ss_R_to_s_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0041 = m_s*s_14*m_N_4;
    ...
    const ccomplex_t IT_0051 = m_s*m_N_4;
    ...
    const ccomplex_t IT_0056 = m_s*s_34*m_N_4;
