        ...
        )
{
    ...
    const ccomplex_t IT_0226 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0011*IT_0039*IT_0041;
    ...
    const ccomplex_t IT_0234 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0011*IT_0039*IT_0041;
    ...
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0011*IT_0039*IT_0041;
