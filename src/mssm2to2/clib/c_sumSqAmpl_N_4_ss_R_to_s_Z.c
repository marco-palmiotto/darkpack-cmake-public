        ...
        )
{
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0016 + IT_0066 + -m_ss_R*
    ...
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0006*IT_0080*IT_0082;
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0006*IT_0080*IT_0082;
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0080*IT_0082;
    ...
    const ccomplex_t IT_0131 = -IT_0087 + IT_0090 + -IT_0091 + 2*IT_0104 + 2
      *IT_0117 + 2*IT_0130;
    const ccomplex_t IT_0132 = m_s*m_N_4;
    ...
    const ccomplex_t IT_0160 = 0.333333333333333*IT_0064;
    ...
    const ccomplex_t IT_0175 = IT_0084*IT_0160;
    const ccomplex_t IT_0176 = IT_0145*IT_0146*IT_0175;
    const ccomplex_t IT_0177 = IT_0084*IT_0143;
    ...
    const ccomplex_t IT_0181 = m_N_4*IT_0029;
    const ccomplex_t IT_0182 = IT_0034*IT_0181;
    const ccomplex_t IT_0183 = IT_0020*IT_0150;
    const ccomplex_t IT_0184 = IT_0020*IT_0152;
    const ccomplex_t IT_0185 = m_N_4*IT_0043;
    const ccomplex_t IT_0186 = IT_0048*IT_0185;
    const ccomplex_t IT_0187 = m_N_4*IT_0057;
    const ccomplex_t IT_0188 = IT_0062*IT_0187;
    const ccomplex_t IT_0189 = IT_0176 + -IT_0180 + IT_0182 + 0.5*IT_0183 + (
      -0.5)*IT_0184 + IT_0186 + IT_0188;
    const ccomplex_t IT_0190 = IT_0020*IT_0148;
    const ccomplex_t IT_0191 = m_N_1*IT_0099;
    ...
    const ccomplex_t IT_0196 = IT_0062*IT_0195;
    ...
    const ccomplex_t IT_0200 = -IT_0070 + (-2)*IT_0163;
    const ccomplex_t IT_0201 = s_14*s_34*IT_0074;
    const ccomplex_t IT_0202 = -IT_0201;
    const ccomplex_t IT_0203 = s_13 + IT_0202;
    const ccomplex_t IT_0204 = s_13*IT_0203;
    const ccomplex_t IT_0205 = IT_0087 + 2*IT_0179;
    const ccomplex_t IT_0206 = IT_0132*IT_0203;
    const ccomplex_t IT_0207 = -IT_0163;
    const ccomplex_t IT_0208 = m_N_4*IT_0203;
    const ccomplex_t IT_0209 = (-6)*conj(IT_0073);
    const ccomplex_t IT_0210 = (-6)*conj(IT_0131);
    const ccomplex_t IT_0211 = pow(m_Z, 2);
    const ccomplex_t IT_0212 = s_14*IT_0211;
    const ccomplex_t IT_0213 = IT_0074*IT_0212;
    const ccomplex_t IT_0214 = (-0.25)*IT_0213;
    const ccomplex_t IT_0215 = s_14 + IT_0214;
    const ccomplex_t IT_0216 = m_s*IT_0215;
    const ccomplex_t IT_0217 = (-4)*IT_0216;
    const ccomplex_t IT_0218 = 0.5*IT_0213;
    const ccomplex_t IT_0219 = s_14 + IT_0218;
    const ccomplex_t IT_0220 = m_s*IT_0219;
    const ccomplex_t IT_0221 = 2*IT_0220;
    const ccomplex_t IT_0222 = (-0.5)*IT_0090 + 0.5*IT_0091 + -IT_0104 + 
      -IT_0117 + -IT_0130;
    const ccomplex_t IT_0223 = s_34*IT_0211;
    const ccomplex_t IT_0224 = IT_0074*IT_0223;
    ...
    const ccomplex_t IT_0241 = m_s*IT_0203;
    const ccomplex_t IT_0242 = (-6)*IT_0200;
    ...
    const ccomplex_t IT_0248 = s_14*IT_0016;
    const ccomplex_t IT_0249 = s_13*s_34;
    const ccomplex_t IT_0250 = -IT_0249;
    const ccomplex_t IT_0251 = IT_0248 + IT_0250;
    const ccomplex_t IT_0252 = m_N_4*IT_0246;
    const ccomplex_t IT_0253 = (-6)*conj(IT_0200);
    const ccomplex_t IT_0254 = (-6)*conj(IT_0205);
    const ccomplex_t IT_0255 = (-6)*conj(IT_0165);
    const ccomplex_t IT_0256 = (-6)*IT_0073;
    const ccomplex_t IT_0257 = (-6)*IT_0205;
    const ccomplex_t IT_0258 = 6*IT_0207;
    const ccomplex_t IT_0259 = 6*IT_0134;
    const ccomplex_t IT_0260 = 6*IT_0222;
    const ccomplex_t IT_0261 = 6*IT_0179;
    const ccomplex_t IT_0262 = 6*IT_0131*IT_0139 + IT_0132*((-18)*IT_0165 + (
      -18)*IT_0173) + IT_0198*IT_0240 + IT_0242*IT_0252 + IT_0208*IT_0256 +
       IT_0241*IT_0257 + IT_0232*IT_0258 + IT_0228*IT_0259 + IT_0221*IT_0260 +
       IT_0217*IT_0261;
    const ccomplex_t IT_0263 = (-6)*IT_0131;
    const ccomplex_t IT_0264 = 6*IT_0073*IT_0139 + IT_0132*((-18)*IT_0189 + (
      -18)*IT_0197) + IT_0174*IT_0240 + IT_0241*IT_0242 + IT_0252*IT_0257 +
       IT_0217*IT_0258 + IT_0221*IT_0259 + IT_0228*IT_0260 + IT_0232*IT_0261 +
       IT_0208*IT_0263;
    const ccomplex_t IT_0265 = IT_0132*IT_0211;
    ...
    const ccomplex_t IT_0271 = (-24)*IT_0234;
    const ccomplex_t IT_0272 = 6*IT_0270 + IT_0271;
    const ccomplex_t IT_0273 = 0.166666666666667*IT_0207;
    const ccomplex_t IT_0274 = 24*IT_0234;
    const ccomplex_t IT_0275 = (-12)*IT_0233;
    const ccomplex_t IT_0276 = 6*IT_0270 + IT_0274 + IT_0275;
    const ccomplex_t IT_0277 = 0.166666666666667*IT_0134;
    const ccomplex_t IT_0278 = s_13*IT_0246;
    const ccomplex_t IT_0279 = 0.166666666666667*IT_0278;
    const ccomplex_t IT_0280 = 0.166666666666667*IT_0204;
    const ccomplex_t IT_0281 = 0.166666666666667*IT_0222;
    const ccomplex_t IT_0282 = 0.166666666666667*IT_0179;
    const ccomplex_t IT_0283 = (-6)*IT_0165;
    const ccomplex_t IT_0284 = 0.166666666666667*IT_0206;
    const ccomplex_t IT_0285 = 0.166666666666667*IT_0138;
    const ccomplex_t IT_0286 = 0.166666666666667*IT_0251;
    const ccomplex_t IT_0287 = 6*conj(IT_0073)*(IT_0073*IT_0079 + IT_0131
      *IT_0133 + IT_0134*IT_0138 + IT_0139*IT_0174) + IT_0132*IT_0198*IT_0199 + 
      (IT_0200*IT_0204 + IT_0205*IT_0206 + IT_0138*IT_0207 + IT_0198*IT_0208)
      *IT_0209 + (IT_0138*IT_0179 + IT_0204*IT_0205 + IT_0173*IT_0208)*IT_0210 +
       6*conj(IT_0165)*(IT_0073*IT_0139 + IT_0207*IT_0217 + IT_0134*IT_0221 +
       IT_0222*IT_0228 + IT_0179*IT_0232 + 0.166666666666667*IT_0174*IT_0240 +
       0.166666666666667*IT_0241*IT_0242) + (IT_0131*IT_0206 + IT_0174*IT_0241 +
       IT_0205*IT_0247 + IT_0207*IT_0251 + IT_0198*IT_0252)*IT_0253 + (IT_0198
      *IT_0241 + IT_0179*IT_0251 + IT_0173*IT_0252)*IT_0254 + (IT_0131*IT_0208 +
       IT_0205*IT_0252)*IT_0255 + (conj(IT_0189) + conj(IT_0197))*IT_0262 + conj
      (IT_0173)*IT_0264 + 6*conj(IT_0134)*(IT_0073*IT_0138 + IT_0174*IT_0221 +
       IT_0198*IT_0228 + IT_0200*IT_0251 + IT_0222*IT_0266 + IT_0179*IT_0267 +
       IT_0272*IT_0273 + IT_0276*IT_0277) + 6*conj(IT_0200)*(IT_0134*IT_0251 +
       IT_0242*IT_0279 + IT_0256*IT_0280) + 6*conj(IT_0222)*(IT_0131*IT_0138 +
       IT_0198*IT_0221 + IT_0174*IT_0228 + IT_0205*IT_0251 + IT_0134*IT_0266 +
       IT_0207*IT_0267 + IT_0276*IT_0281 + IT_0272*IT_0282) + 6*conj(IT_0131)*
      (IT_0079*IT_0131 + IT_0073*IT_0133 + IT_0139*IT_0198 + IT_0138*IT_0222 +
       0.166666666666667*IT_0208*IT_0283 + IT_0242*IT_0284) + 6*conj(IT_0205)*
      (0.166666666666667*IT_0242*IT_0247 + IT_0222*IT_0251 + IT_0257*IT_0279 +
       IT_0263*IT_0280 + 0.166666666666667*IT_0252*IT_0283 + IT_0256*IT_0284) +
       6*conj(IT_0207)*(IT_0174*IT_0217 + IT_0198*IT_0232 + IT_0179*IT_0266 +
       IT_0222*IT_0267 + IT_0273*IT_0276 + IT_0272*IT_0277 + IT_0256*IT_0285 +
       IT_0242*IT_0286) + 6*conj(IT_0179)*(IT_0198*IT_0217 + IT_0174*IT_0232 +
       IT_0207*IT_0266 + IT_0134*IT_0267 + IT_0272*IT_0281 + IT_0276*IT_0282 +
