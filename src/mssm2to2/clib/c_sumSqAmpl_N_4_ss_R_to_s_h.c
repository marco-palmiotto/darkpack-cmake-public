        ...
        )
{
    ...
    const ccomplex_t IT_0223 = IT_0087*IT_0108;
    const ccomplex_t IT_0224 = IT_0008*IT_0059;
    const ccomplex_t IT_0225 = IT_0116*IT_0159;
    const ccomplex_t IT_0226 = IT_0167*IT_0210;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0023*IT_0063*IT_0065;
    const ccomplex_t IT_0228 = 0.5*IT_0227;
    const ccomplex_t IT_0229 = IT_0215*IT_0228;
    const ccomplex_t IT_0230 = IT_0217*IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1)*IT_0230;
    const ccomplex_t IT_0232 = -IT_0223 + -IT_0224 + -IT_0225 + -IT_0226 +
       IT_0231;
    const ccomplex_t IT_0233 = m_s*s_14;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0023*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0239 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0023*IT_0063*IT_0065;
    const ccomplex_t IT_0240 = 0.5*IT_0239;
    const ccomplex_t IT_0241 = IT_0114*IT_0240;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*IT_0241;
    const ccomplex_t IT_0243 = IT_0137*IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0023*IT_0063*IT_0065;
    const ccomplex_t IT_0245 = 0.5*IT_0244;
    const ccomplex_t IT_0246 = IT_0165*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = IT_0188*IT_0247;
    const ccomplex_t IT_0249 = IT_0085*IT_0228;
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*IT_0249;
    const ccomplex_t IT_0251 = IT_0097*IT_0250;
    const ccomplex_t IT_0252 = -IT_0219 + IT_0238 + IT_0243 + IT_0248 + IT_0251;
    const ccomplex_t IT_0253 = s_34*m_N_4;
    const ccomplex_t IT_0254 = m_N_4*IT_0137;
    const ccomplex_t IT_0255 = m_N_2*IT_0159;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = IT_0242*IT_0256;
    const ccomplex_t IT_0258 = m_N_4*IT_0188;
    const ccomplex_t IT_0259 = m_N_3*IT_0210;
    const ccomplex_t IT_0260 = IT_0258 + IT_0259;
    const ccomplex_t IT_0261 = IT_0247*IT_0260;
    const ccomplex_t IT_0262 = conj(N_B4)*e_em;
    const ccomplex_t IT_0263 = IT_0001*IT_0262;
    const ccomplex_t IT_0264 = 1.4142135623731*IT_0263;
    const ccomplex_t IT_0265 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0271 = IT_0072*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1)*IT_0271;
    const ccomplex_t IT_0273 = IT_0078*IT_0228;
    const ccomplex_t IT_0274 = IT_0082*IT_0273;
    const ccomplex_t IT_0275 = (0 + _Complex_I*1)*IT_0274;
    const ccomplex_t IT_0276 = IT_0110*IT_0250;
    const ccomplex_t IT_0277 = m_N_4*IT_0037;
    const ccomplex_t IT_0278 = m_N_1*IT_0059;
    const ccomplex_t IT_0279 = IT_0277 + IT_0278;
    const ccomplex_t IT_0280 = IT_0237*IT_0279;
    const ccomplex_t IT_0281 = m_s*IT_0231;
    const ccomplex_t IT_0282 = -IT_0257 + -IT_0261 + -IT_0272 + -IT_0275 + 
      -IT_0276 + -IT_0280 + 2*IT_0281;
