...
ccomplex_return_t c_sumSqAmpl_N_4_ss_R_to_s_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0018 = IT_0010*IT_0017;
    const ccomplex_t IT_0019 = N_B2*N_d4*e_em;
    ...
    const ccomplex_t IT_0039 = conj(N_B2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0052 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0053 = IT_0024*IT_0052;
    const ccomplex_t IT_0054 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0013 + m_s*e_em*mu_h*IT_0009*IT_0023*IT_0063*IT_0065);
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*-3)*e_em*(IT_0004*IT_0013
      *IT_0023*IT_0063*IT_0065 + -1./3*m_W*IT_0022*IT_0075*(IT_0013*IT_0064 +
       IT_0009*IT_0076));
    ...
    const ccomplex_t IT_0096 = conj(N_B4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0100 = conj(N_W4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0108 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_4*
    ...
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0001;
    const ccomplex_t IT_0113 = (-0.333333333333333)*IT_0112;
    const ccomplex_t IT_0114 = cpow((-2)*s_23 + IT_0004 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*m_s*e_em*IT_0013*IT_0023
      *IT_0063*IT_0065;
    const ccomplex_t IT_0215 = 0.5*IT_0214;
    const ccomplex_t IT_0216 = IT_0080*IT_0215;
    ...
    const ccomplex_t IT_0240 = IT_0072*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*IT_0240;
    const ccomplex_t IT_0242 = m_N_4*IT_0037;
    const ccomplex_t IT_0243 = m_N_2*IT_0059;
    const ccomplex_t IT_0244 = IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0023*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0249 = IT_0244*IT_0248;
    const ccomplex_t IT_0250 = m_N_4*IT_0188;
    const ccomplex_t IT_0251 = m_N_3*IT_0210;
    ...
    const ccomplex_t IT_0255 = IT_0165*IT_0254;
    const ccomplex_t IT_0256 = (0 + _Complex_I*1)*IT_0255;
    const ccomplex_t IT_0257 = IT_0252*IT_0256;
    const ccomplex_t IT_0258 = IT_0108*IT_0223;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*IT_0258;
    const ccomplex_t IT_0260 = IT_0107*IT_0259;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0023*IT_0063*IT_0065;
    const ccomplex_t IT_0262 = 0.5*IT_0261;
    const ccomplex_t IT_0263 = IT_0114*IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1)*IT_0263;
    const ccomplex_t IT_0265 = m_N_4*IT_0159;
    const ccomplex_t IT_0266 = m_N_1*IT_0137;
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = IT_0264*IT_0267;
    const ccomplex_t IT_0269 = -IT_0226 + 2*IT_0230 + -IT_0241 + -IT_0249 + 
      -IT_0257 + -IT_0260 + -IT_0268;
    const ccomplex_t IT_0270 = 6*s_13;
    const ccomplex_t IT_0271 = m_s*m_N_4;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0094*IT_0259;
    const ccomplex_t IT_0274 = IT_0159*IT_0264;
    const ccomplex_t IT_0275 = IT_0037*IT_0248;
    const ccomplex_t IT_0276 = IT_0188*IT_0256;
    const ccomplex_t IT_0277 = -IT_0219 + IT_0273 + IT_0274 + IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = m_s*s_14;
    const ccomplex_t IT_0279 = IT_0116*IT_0137;
    const ccomplex_t IT_0280 = IT_0008*IT_0059;
    const ccomplex_t IT_0281 = IT_0167*IT_0210;
    const ccomplex_t IT_0282 = IT_0105*IT_0110;
    ...
    const ccomplex_t IT_0288 = m_s*m_N_4*IT_0287;
