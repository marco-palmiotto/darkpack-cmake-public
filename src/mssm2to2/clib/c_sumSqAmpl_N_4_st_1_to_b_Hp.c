        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_b*m_N_4*IT_0000;
    ...
    const ccomplex_t IT_0012 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0013 = IT_0011*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = IT_0005*IT_0007;
    const ccomplex_t IT_0016 = m_t*N_u4*e_em*IT_0002*U_st_00;
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0000 + IT_0050 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0055 = V_tb*e_em*conj(V_Wp2)*U_st_00;
    const ccomplex_t IT_0056 = IT_0007*IT_0055;
    const ccomplex_t IT_0057 = m_t*V_tb*conj(V_u2)*e_em*IT_0002*U_st_10;
    ...
    const ccomplex_t IT_0066 = IT_0031*IT_0065;
    ...
    const ccomplex_t IT_0144 = m_b*m_N_4;
    const ccomplex_t IT_0145 = IT_0048*IT_0113;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0147 = IT_0051*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = IT_0061*IT_0094;
    ...
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0004*conj
      ...
      *IT_0152 + m_W*IT_0003*IT_0004*conj(U_sb_00)*U_st_00) + A_t*IT_0003*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0154 = IT_0007*IT_0095;
    const ccomplex_t IT_0155 = m_b*conj(N_d4)*e_em*IT_0002*U_sb_10;
    const ccomplex_t IT_0156 = IT_0154*IT_0155;
    const ccomplex_t IT_0157 = 1.4142135623731*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0172 = cpow((-2)*s_13 + IT_0022 + IT_0050 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0173 = m_t*conj(U_sb_01)*(m_t*IT_0003*IT_0005*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0004*IT_0095*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0005*IT_0095*U_st_10));
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0004*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0007*((-0.5)*IT_0002
      *IT_0173 + m_W*IT_0003*IT_0004*conj(U_sb_01)*U_st_00) + A_t*IT_0003*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0175 = m_b*conj(N_d4)*e_em*IT_0002*U_sb_11;
    const ccomplex_t IT_0176 = IT_0154*IT_0175;
    const ccomplex_t IT_0177 = 1.4142135623731*IT_0176;
    const ccomplex_t IT_0178 = conj(N_W4)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0191 = IT_0009*IT_0130;
    const ccomplex_t IT_0192 = IT_0023*IT_0190*IT_0191;
    const ccomplex_t IT_0193 = m_N_4*IT_0025;
    const ccomplex_t IT_0194 = IT_0147 + IT_0150 + -IT_0171 + -IT_0189 +
       IT_0192 + -IT_0193;
    const ccomplex_t IT_0195 = IT_0100 + IT_0118;
    const ccomplex_t IT_0196 = m_b*IT_0195;
    const ccomplex_t IT_0197 = -IT_0196;
    const ccomplex_t IT_0198 = IT_0074*IT_0097;
    const ccomplex_t IT_0199 = IT_0054*IT_0149*IT_0198;
    const ccomplex_t IT_0200 = m_N_4*IT_0135;
    const ccomplex_t IT_0201 = IT_0041*IT_0115;
    const ccomplex_t IT_0202 = IT_0051*IT_0146*IT_0201;
    const ccomplex_t IT_0203 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0204 = IT_0011*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = m_b*N_d4*e_em*IT_0002*U_sb_00;
    const ccomplex_t IT_0207 = IT_0154*IT_0206;
    ...
    const ccomplex_t IT_0214 = IT_0151*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*IT_0214;
    const ccomplex_t IT_0216 = IT_0020*IT_0132;
    const ccomplex_t IT_0217 = IT_0023*IT_0190*IT_0216;
    const ccomplex_t IT_0218 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0219 = IT_0011*IT_0218;
    const ccomplex_t IT_0220 = 1.4142135623731*IT_0219;
    const ccomplex_t IT_0221 = m_b*N_d4*e_em*IT_0002*U_sb_01;
    ...
    const ccomplex_t IT_0228 = IT_0174*IT_0227;
    const ccomplex_t IT_0229 = IT_0172*IT_0228;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = -IT_0199 + IT_0200 + -IT_0202 + IT_0215 + 
      -IT_0217 + IT_0230;
    const ccomplex_t IT_0232 = m_b*IT_0078;
    const ccomplex_t IT_0233 = -IT_0232;
    const ccomplex_t IT_0234 = IT_0231 + IT_0233;
    const ccomplex_t IT_0235 = -conj(IT_0232);
    const ccomplex_t IT_0236 = conj(IT_0231) + IT_0235;
    const ccomplex_t IT_0237 = 6*s_13;
    const ccomplex_t IT_0238 = (-6)*s_13;
    const ccomplex_t IT_0239 = s_23*m_N_4;
    const ccomplex_t IT_0240 = (-6)*IT_0197;
    const ccomplex_t IT_0241 = IT_0194 + 0.166666666666667*IT_0240;
    const ccomplex_t IT_0242 = (-6)*conj(IT_0197);
    const ccomplex_t IT_0243 = m_b*s_12;
    const ccomplex_t IT_0244 = 6*IT_0001*(IT_0079*IT_0136 + IT_0137*IT_0138) +
       (IT_0079*IT_0137 + IT_0136*IT_0138)*IT_0143 + 6*IT_0144*((conj(IT_0194) +
       -conj(IT_0197))*IT_0234 + (IT_0194 + -IT_0197)*IT_0236) + (IT_0194*conj
      (IT_0194) + IT_0197*conj(IT_0197) + IT_0231*conj(IT_0231) + IT_0232*conj
      (IT_0232))*IT_0237 + (conj(IT_0194)*IT_0197 + IT_0194*conj(IT_0197) + conj
      (IT_0231)*IT_0232 + IT_0231*conj(IT_0232))*IT_0238 + 6*IT_0239*(IT_0138
      *IT_0234 + IT_0136*IT_0236 + IT_0079*IT_0241 + IT_0137*(conj(IT_0194) +
       0.166666666666667*IT_0242)) + 6*(IT_0079*IT_0234 + IT_0137*IT_0236 +
       IT_0138*IT_0241 + IT_0136*(conj(IT_0194) + 0.166666666666667*IT_0242))
      *IT_0243;
