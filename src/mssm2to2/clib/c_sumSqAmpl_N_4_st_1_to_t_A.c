...
ccomplex_return_t c_sumSqAmpl_N_4_st_1_to_t_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = conj(N_B4)*e_em*U_st_00;
    const ccomplex_t IT_0032 = IT_0003*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W4)*e_em*U_st_00;
    const ccomplex_t IT_0035 = IT_0010*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = m_t*conj(N_u4)*e_em*IT_0012*U_st_10;
