...
ccomplex_return_t c_sumSqAmpl_N_4_st_1_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0033 = IT_0001*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = m_t*N_u4*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0084 = N_B4*N_d1*e_em;
    ...
    const ccomplex_t IT_0093 = N_B4*N_u1*e_em;
    const ccomplex_t IT_0094 = IT_0058*IT_0093;
    const ccomplex_t IT_0095 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0096 = IT_0061*IT_0095;
    const ccomplex_t IT_0097 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0098 = IT_0058*IT_0097;
    const ccomplex_t IT_0099 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0106 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0107 = IT_0055*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0109 = IT_0064*IT_0108;
    const ccomplex_t IT_0110 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0111 = IT_0055*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0117 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0118 = IT_0061*IT_0117;
    const ccomplex_t IT_0119 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0120 = IT_0058*IT_0119;
    const ccomplex_t IT_0121 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0137 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_1*
    ...
    const ccomplex_t IT_0141 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0142 = IT_0055*IT_0141;
    const ccomplex_t IT_0143 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0144 = IT_0064*IT_0143;
    const ccomplex_t IT_0145 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0146 = IT_0055*IT_0145;
    const ccomplex_t IT_0147 = N_W2*N_u4*e_em;
    ...
    const ccomplex_t IT_0151 = IT_0058*IT_0150;
    const ccomplex_t IT_0152 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0153 = IT_0061*IT_0152;
    const ccomplex_t IT_0154 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0155 = IT_0058*IT_0154;
    const ccomplex_t IT_0156 = N_W2*N_d4*e_em;
    const ccomplex_t IT_0157 = IT_0061*IT_0156;
    ...
    const ccomplex_t IT_0162 = m_N_2*IT_0161;
    ...
    const ccomplex_t IT_0167 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0173 = IT_0058*IT_0172;
    const ccomplex_t IT_0174 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0175 = IT_0061*IT_0174;
    const ccomplex_t IT_0176 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0177 = IT_0058*IT_0176;
    const ccomplex_t IT_0178 = conj(N_W4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0179 = IT_0061*IT_0178;
    ...
    const ccomplex_t IT_0186 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0187 = IT_0001*IT_0186;
    const ccomplex_t IT_0188 = 1.4142135623731*IT_0187;
    const ccomplex_t IT_0189 = m_t*N_u2*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0194 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_2*
    ...
    const ccomplex_t IT_0201 = IT_0064*IT_0200;
    const ccomplex_t IT_0202 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0203 = IT_0055*IT_0202;
    const ccomplex_t IT_0204 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0208 = IT_0058*IT_0207;
    const ccomplex_t IT_0209 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0210 = IT_0061*IT_0209;
    const ccomplex_t IT_0211 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0212 = IT_0058*IT_0211;
    const ccomplex_t IT_0213 = N_W3*N_d4*e_em;
    const ccomplex_t IT_0214 = IT_0061*IT_0213;
    ...
    const ccomplex_t IT_0220 = conj(N_B3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0221 = IT_0055*IT_0220;
    const ccomplex_t IT_0222 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0223 = IT_0064*IT_0222;
    const ccomplex_t IT_0224 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0225 = IT_0055*IT_0224;
    ...
    const ccomplex_t IT_0230 = IT_0058*IT_0229;
    const ccomplex_t IT_0231 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0232 = IT_0061*IT_0231;
    const ccomplex_t IT_0233 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0234 = IT_0058*IT_0233;
    const ccomplex_t IT_0235 = conj(N_W4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0236 = IT_0061*IT_0235;
    ...
    const ccomplex_t IT_0242 = IT_0219 + IT_0241;
    const ccomplex_t IT_0243 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0244 = IT_0001*IT_0243;
    const ccomplex_t IT_0245 = 1.4142135623731*IT_0244;
    const ccomplex_t IT_0246 = m_t*N_u3*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0251 = cpow((-2)*s_23 + IT_0023 + IT_0050 + -m_N_3*
    ...
    const ccomplex_t IT_0283 = IT_0079*IT_0282;
    const ccomplex_t IT_0284 = m_N_4*IT_0104;
    const ccomplex_t IT_0285 = m_N_1*IT_0126;
    const ccomplex_t IT_0286 = IT_0284 + IT_0285;
    const ccomplex_t IT_0287 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0288 = IT_0001*IT_0287;
    const ccomplex_t IT_0289 = 1.4142135623731*IT_0288;
    const ccomplex_t IT_0290 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0291 = IT_0008*IT_0290;
    const ccomplex_t IT_0292 = 1.4142135623731*IT_0291;
    const ccomplex_t IT_0293 = m_t*conj(N_u1)*e_em*IT_0010*U_st_10;
    ...
    const ccomplex_t IT_0298 = IT_0137*IT_0297;
    const ccomplex_t IT_0299 = (0 + _Complex_I*1)*IT_0298;
    const ccomplex_t IT_0300 = IT_0286*IT_0299;
    const ccomplex_t IT_0301 = IT_0026*IT_0280;
    const ccomplex_t IT_0302 = IT_0029*IT_0301;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1)*IT_0302;
    const ccomplex_t IT_0304 = IT_0048*IT_0280;
    ...
    const ccomplex_t IT_0308 = m_N_4*IT_0218;
    const ccomplex_t IT_0309 = m_N_3*IT_0240;
    ...
    const ccomplex_t IT_0342 = -IT_0269 + -IT_0283 + -IT_0300 + -IT_0303 + 2
    ...
    const ccomplex_t IT_0346 = IT_0067*IT_0282;
    const ccomplex_t IT_0347 = IT_0104*IT_0299;
    const ccomplex_t IT_0348 = IT_0161*IT_0340;
    const ccomplex_t IT_0349 = IT_0218*IT_0323;
    const ccomplex_t IT_0350 = -IT_0053 + IT_0346 + IT_0347 + IT_0348 + IT_0349;
    const ccomplex_t IT_0351 = m_t*s_14;
    const ccomplex_t IT_0352 = IT_0126*IT_0139;
    const ccomplex_t IT_0353 = IT_0077*IT_0082;
    const ccomplex_t IT_0354 = IT_0183*IT_0196;
    const ccomplex_t IT_0355 = IT_0240*IT_0253;
    const ccomplex_t IT_0356 = IT_0306 + -IT_0352 + -IT_0353 + -IT_0354 + 
      -IT_0355;
