        ...
        )
{
    ...
    const ccomplex_t IT_0040 = m_t*N_u4*e_em*IT_0039*U_st_00;
    const ccomplex_t IT_0041 = IT_0038*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*(IT_0035 + (-0.75)*IT_0042);
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_t*e_em*IT_0000*IT_0011
      *IT_0037*IT_0039;
    const ccomplex_t IT_0052 = (-0.5)*IT_0051;
    const ccomplex_t IT_0053 = IT_0044*IT_0052;
    const ccomplex_t IT_0054 = pow(m_N_4, 2);
    const ccomplex_t IT_0055 = cpow((-2)*s_12 + -IT_0046 + -IT_0054 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0056 = IT_0053*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = m_t*IT_0057;
    const ccomplex_t IT_0059 = m_t*mu_h*IT_0039;
    const ccomplex_t IT_0060 = cos(beta);
    const ccomplex_t IT_0061 = IT_0006*IT_0060;
    const ccomplex_t IT_0062 = IT_0000*IT_0036;
    const ccomplex_t IT_0063 = IT_0061 + IT_0062;
    const ccomplex_t IT_0064 = cpow(IT_0001, -2);
    const ccomplex_t IT_0065 = 2*U_st_00*((IT_0000*IT_0011*IT_0037*IT_0039
      *IT_0045 + (-0.5)*m_W*IT_0063*(IT_0011 + -1./3*IT_0010*IT_0064))*conj
      (U_st_00) + 1./2*IT_0006*IT_0011*IT_0037*IT_0059*conj(U_st_10)) + U_st_10*
      (IT_0006*IT_0011*IT_0037*IT_0059*conj(U_st_00) + (-1.33333333333333)*((
      -1.5)*IT_0000*IT_0011*IT_0037*IT_0039*IT_0045 + m_W*IT_0010*IT_0063
      *IT_0064)*conj(U_st_10));
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(e_em*IT_0065 +
       1.4142135623731*A_t*IT_0000*(conj(U_st_00)*U_st_10 + U_st_00*conj(U_st_10
      )));
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = IT_0044*IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_13 + IT_0045 + IT_0054 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0070 = IT_0068*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0073 = IT_0002*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = m_t*N_u4*e_em*IT_0039*U_st_01;
    ...
    const ccomplex_t IT_0080 = 2*U_st_00*((IT_0000*IT_0011*IT_0037*IT_0039
      *IT_0045 + (-0.5)*m_W*IT_0063*(IT_0011 + -1./3*IT_0010*IT_0064))*conj
      (U_st_01) + 1./2*IT_0006*IT_0011*IT_0037*IT_0059*conj(U_st_11)) + U_st_10*
      (IT_0006*IT_0011*IT_0037*IT_0059*conj(U_st_01) + (-1.33333333333333)*((
      -1.5)*IT_0000*IT_0011*IT_0037*IT_0039*IT_0045 + m_W*IT_0010*IT_0063
      *IT_0064)*conj(U_st_11));
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*(e_em*IT_0080 +
       1.4142135623731*A_t*IT_0000*(conj(U_st_01)*U_st_10 + U_st_00*conj(U_st_11
      )));
    const ccomplex_t IT_0082 = (-0.5)*IT_0081;
    const ccomplex_t IT_0083 = IT_0079*IT_0082;
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0045 + IT_0054 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0085 = IT_0083*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0088 = IT_0002*IT_0087;
    const ccomplex_t IT_0089 = 1.4142135623731*IT_0088;
    const ccomplex_t IT_0090 = m_t*N_u1*e_em*IT_0039*U_st_00;
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_23 + IT_0045 + IT_0046 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0099 = IT_0003*IT_0098;
    const ccomplex_t IT_0100 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0107 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0108 = IT_0012*IT_0107;
    const ccomplex_t IT_0109 = conj(N_W1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0119 = m_N_4*IT_0118;
    ...
    const ccomplex_t IT_0124 = N_B1*N_u4*e_em;
    ...
    const ccomplex_t IT_0129 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0130 = IT_0012*IT_0129;
    const ccomplex_t IT_0131 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0132 = IT_0015*IT_0131;
    const ccomplex_t IT_0133 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0134 = IT_0012*IT_0133;
    const ccomplex_t IT_0135 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0146 = conj(N_B2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0150 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0157 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0170 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0171 = IT_0003*IT_0170;
    const ccomplex_t IT_0172 = N_B2*N_d4*e_em;
    ...
    const ccomplex_t IT_0192 = m_t*N_u2*e_em*IT_0039*U_st_00;
    const ccomplex_t IT_0193 = IT_0038*IT_0192;
    ...
    const ccomplex_t IT_0197 = cpow((-2)*s_23 + IT_0045 + IT_0046 + -m_N_2*
    ...
    const ccomplex_t IT_0201 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0202 = IT_0002*IT_0201;
    const ccomplex_t IT_0203 = 1.4142135623731*IT_0202;
    const ccomplex_t IT_0204 = m_t*N_u3*e_em*IT_0039*U_st_00;
    ...
    const ccomplex_t IT_0209 = cpow((-2)*s_23 + IT_0045 + IT_0046 + -m_N_3*
    ...
    const ccomplex_t IT_0258 = IT_0050 + (-2)*IT_0058 + IT_0071 + IT_0086 +
    ...
    const ccomplex_t IT_0265 = m_t*conj(N_u4)*e_em*IT_0039*U_st_10;
    ...
    const ccomplex_t IT_0270 = IT_0067*IT_0269;
    ...
    const ccomplex_t IT_0279 = m_t*conj(N_u4)*e_em*IT_0039*U_st_11;
    const ccomplex_t IT_0280 = IT_0038*IT_0279;
    ...
    const ccomplex_t IT_0284 = IT_0082*IT_0283;
    const ccomplex_t IT_0285 = IT_0084*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*IT_0285;
    const ccomplex_t IT_0287 = IT_0052*IT_0269;
    ...
    const ccomplex_t IT_0291 = IT_0047*IT_0269;
    ...
    const ccomplex_t IT_0300 = m_t*conj(N_u1)*e_em*IT_0039*U_st_10;
    const ccomplex_t IT_0301 = IT_0038*IT_0300;
    ...
    const ccomplex_t IT_0305 = IT_0095*IT_0304;
    const ccomplex_t IT_0306 = (0 + _Complex_I*1)*IT_0305;
    const ccomplex_t IT_0307 = m_N_1*IT_0118;
    const ccomplex_t IT_0308 = m_N_4*IT_0140;
    const ccomplex_t IT_0309 = IT_0307 + IT_0308;
    const ccomplex_t IT_0310 = IT_0306*IT_0309;
    const ccomplex_t IT_0311 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0312 = IT_0002*IT_0311;
    const ccomplex_t IT_0313 = 1.4142135623731*IT_0312;
    const ccomplex_t IT_0314 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0315 = IT_0011*IT_0314;
    const ccomplex_t IT_0316 = 1.4142135623731*IT_0315;
    const ccomplex_t IT_0317 = m_t*conj(N_u2)*e_em*IT_0039*U_st_10;
    const ccomplex_t IT_0318 = IT_0038*IT_0317;
    ...
    const ccomplex_t IT_0324 = m_N_4*IT_0186;
    ...
    const ccomplex_t IT_0332 = IT_0011*IT_0331;
    const ccomplex_t IT_0333 = 1.4142135623731*IT_0332;
    const ccomplex_t IT_0334 = m_t*conj(N_u3)*e_em*IT_0039*U_st_10;
    const ccomplex_t IT_0335 = IT_0038*IT_0334;
    ...
    const ccomplex_t IT_0341 = m_N_4*IT_0232;
    const ccomplex_t IT_0342 = m_N_3*IT_0254;
    ...
    const ccomplex_t IT_0349 = IT_0019*IT_0292;
    const ccomplex_t IT_0350 = IT_0232*IT_0340;
    const ccomplex_t IT_0351 = IT_0140*IT_0306;
    const ccomplex_t IT_0352 = IT_0186*IT_0323;
    const ccomplex_t IT_0353 = -IT_0057 + IT_0349 + IT_0350 + IT_0351 + IT_0352;
    const ccomplex_t IT_0354 = m_t*s_14;
    const ccomplex_t IT_0355 = IT_0030*IT_0049;
    const ccomplex_t IT_0356 = IT_0097*IT_0118;
    const ccomplex_t IT_0357 = IT_0164*IT_0199;
