        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0003*IT_0021*IT_0023*U_st_01;
    const ccomplex_t IT_0025 = 0.5*IT_0024;
    const ccomplex_t IT_0026 = IT_0020*IT_0025;
    const ccomplex_t IT_0027 = pow(m_b, 2);
    const ccomplex_t IT_0028 = pow(m_st_2, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_23 + IT_0027 + IT_0028 + -m_C_2*
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0027 + IT_0028 + -m_C_1*
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_13 + IT_0027 + IT_0054 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0056 = cpow(IT_0001, -1);
    const ccomplex_t IT_0057 = m_t*conj(U_sb_00)*(m_t*IT_0022*IT_0056*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0001*IT_0023*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0023*IT_0056*U_st_11));
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0021
      *IT_0057 + m_W*IT_0001*IT_0022*conj(U_sb_00)*U_st_01) + A_t*IT_0022*conj
      (U_sb_00)*U_st_11);
    const ccomplex_t IT_0059 = IT_0003*IT_0023;
    const ccomplex_t IT_0060 = m_b*conj(N_d4)*e_em*IT_0021*U_sb_10;
    const ccomplex_t IT_0061 = IT_0059*IT_0060;
    const ccomplex_t IT_0062 = 1.4142135623731*IT_0061;
    const ccomplex_t IT_0063 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0064 = IT_0003*IT_0063;
    const ccomplex_t IT_0065 = 1.4142135623731*IT_0064;
    const ccomplex_t IT_0066 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0027 + IT_0054 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0076 = m_t*conj(U_sb_01)*(m_t*IT_0022*IT_0056*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0001*IT_0023*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0023*IT_0056*U_st_11));
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0021
      *IT_0076 + m_W*IT_0001*IT_0022*conj(U_sb_01)*U_st_01) + A_t*IT_0022*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0078 = m_b*conj(N_d4)*e_em*IT_0021*U_sb_11;
    ...
    const ccomplex_t IT_0091 = IT_0075*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0003*IT_0021*IT_0022*IT_0056;
    ...
    const ccomplex_t IT_0102 = IT_0003*IT_0056;
    const ccomplex_t IT_0103 = m_t*conj(N_u4)*e_em*IT_0021*U_st_11;
    const ccomplex_t IT_0104 = IT_0102*IT_0103;
    const ccomplex_t IT_0105 = 1.4142135623731*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*(IT_0098 + 3*IT_0101 + 3
      *IT_0105);
    const ccomplex_t IT_0107 = 0.166666666666667*IT_0106;
    const ccomplex_t IT_0108 = IT_0095*IT_0107;
    const ccomplex_t IT_0109 = cpow((-2)*s_12 + -IT_0028 + -IT_0054 + 
      -reg_prop + m_t*(m_t + (0 + _Complex_I*-1)*Gamma_top), -1);
    const ccomplex_t IT_0110 = IT_0093*IT_0108*IT_0109;
    const ccomplex_t IT_0111 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0112 = IT_0009*IT_0111;
    const ccomplex_t IT_0113 = 1.4142135623731*IT_0112;
    const ccomplex_t IT_0114 = m_t*N_u4*e_em*IT_0021*U_st_01;
    const ccomplex_t IT_0115 = IT_0102*IT_0114;
    const ccomplex_t IT_0116 = 1.4142135623731*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*(IT_0113 + (-0.75)*IT_0116);
    const ccomplex_t IT_0118 = 0.666666666666667*IT_0117;
    const ccomplex_t IT_0119 = IT_0095*IT_0118;
    ...
    const ccomplex_t IT_0123 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    const ccomplex_t IT_0124 = IT_0003*IT_0123;
    const ccomplex_t IT_0125 = m_t*V_tb*conj(V_u2)*e_em*IT_0021*U_st_11;
    ...
    const ccomplex_t IT_0132 = IT_0029*IT_0130*IT_0131;
    const ccomplex_t IT_0133 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    const ccomplex_t IT_0134 = IT_0003*IT_0133;
    const ccomplex_t IT_0135 = m_t*V_tb*conj(V_u1)*e_em*IT_0021*U_st_11;
    ...
    const ccomplex_t IT_0140 = IT_0044*IT_0139;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0142 = IT_0048*IT_0140*IT_0141;
    const ccomplex_t IT_0143 = -IT_0074 + -IT_0092 + IT_0110 + -IT_0122 +
       IT_0132 + IT_0142;
    const ccomplex_t IT_0144 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0001*IT_0003*IT_0021*IT_0023;
    const ccomplex_t IT_0145 = 0.5*IT_0144;
    const ccomplex_t IT_0146 = IT_0118*IT_0145;
    const ccomplex_t IT_0147 = IT_0093*IT_0109*IT_0146;
    ...
    const ccomplex_t IT_0152 = IT_0003*IT_0022;
    ...
    const ccomplex_t IT_0168 = IT_0048*IT_0141*IT_0167;
    ...
    const ccomplex_t IT_0172 = m_b*N_d4*e_em*IT_0021*U_sb_00;
    ...
    const ccomplex_t IT_0183 = m_b*N_d4*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0217 = -conj(IT_0214);
    const ccomplex_t IT_0218 = conj(IT_0206) + IT_0217;
    const ccomplex_t IT_0219 = m_b*m_N_4*IT_0028;
    const ccomplex_t IT_0220 = -IT_0121;
    const ccomplex_t IT_0221 = conj(IT_0213) + conj(IT_0220);
    const ccomplex_t IT_0222 = -IT_0031 + -IT_0050;
    const ccomplex_t IT_0223 = IT_0150 + IT_0222;
    const ccomplex_t IT_0224 = IT_0213 + IT_0220;
    const ccomplex_t IT_0225 = conj(IT_0150) + conj(IT_0222);
    const ccomplex_t IT_0226 = s_13*IT_0028;
    ...
    const ccomplex_t IT_0233 = s_23*m_N_4;
    const ccomplex_t IT_0234 = (-6)*IT_0053;
    const ccomplex_t IT_0235 = 0.166666666666667*IT_0234;
    const ccomplex_t IT_0236 = IT_0143 + IT_0235;
    const ccomplex_t IT_0237 = (-6)*conj(IT_0053);
    const ccomplex_t IT_0238 = m_b*s_12;
    const ccomplex_t IT_0239 = (-6)*IT_0000*((conj(IT_0053) + -conj(IT_0143))
      *IT_0216 + (IT_0053 + -IT_0143)*IT_0218) + 6*IT_0219*(IT_0221*IT_0223 +
       IT_0224*IT_0225) + (IT_0221*IT_0224 + IT_0223*IT_0225)*IT_0230 + (IT_0053
      *conj(IT_0053) + IT_0143*conj(IT_0143) + IT_0206*conj(IT_0206) + IT_0214
      *conj(IT_0214))*IT_0231 + (conj(IT_0053)*IT_0143 + IT_0053*conj(IT_0143) +
       conj(IT_0206)*IT_0214 + IT_0206*conj(IT_0214))*IT_0232 + 6*IT_0233*
      (IT_0218*IT_0223 + IT_0216*IT_0225 + IT_0221*IT_0236 + IT_0224*(conj
      (IT_0143) + 0.166666666666667*IT_0237)) + 6*(IT_0216*IT_0221 + IT_0218
      *IT_0224 + IT_0225*IT_0236 + IT_0223*(conj(IT_0143) + 0.166666666666667
      *IT_0237))*IT_0238;
