        ...
        )
{
    ...
    const ccomplex_t IT_0020 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0021 = IT_0001*IT_0020;
    const ccomplex_t IT_0022 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0041 = m_b*N_d4*e_em*IT_0009*U_sb_00;
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0015 + IT_0046 + -m_sb_1*
    ...
    const ccomplex_t IT_0053 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0054 = IT_0036*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = m_b*N_d4*e_em*IT_0009*U_sb_01;
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0015 + IT_0046 + -m_sb_2*
    ...
    const ccomplex_t IT_0072 = m_b*conj(N_d4)*e_em*IT_0009*U_sb_11;
    const ccomplex_t IT_0073 = IT_0040*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = conj(N_W4)*e_em*U_sb_01;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = conj(N_B4)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0120 = m_t*conj(N_u4)*e_em*IT_0009*U_st_11;
    const ccomplex_t IT_0121 = IT_0119*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*(IT_0113 + 3*IT_0116 + 3
      *IT_0122);
    const ccomplex_t IT_0124 = 0.166666666666667*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001;
    ...
    const ccomplex_t IT_0131 = IT_0103*IT_0130;
    const ccomplex_t IT_0132 = 3*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W4)*e_em*V_Wp1;
    const ccomplex_t IT_0134 = IT_0001*IT_0133;
    const ccomplex_t IT_0135 = conj(N_u4)*V_u1*e_em;
    ...
    const ccomplex_t IT_0140 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    const ccomplex_t IT_0141 = IT_0001*IT_0140;
    const ccomplex_t IT_0142 = m_t*V_tb*conj(V_u1)*e_em*IT_0009*U_st_11;
    ...
    const ccomplex_t IT_0157 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    const ccomplex_t IT_0158 = IT_0001*IT_0157;
    const ccomplex_t IT_0159 = m_t*V_tb*conj(V_u2)*e_em*IT_0009*U_st_11;
    ...
    const ccomplex_t IT_0169 = -IT_0050 + -IT_0064;
    const ccomplex_t IT_0170 = s_14*IT_0015;
    ...
    const ccomplex_t IT_0182 = s_34*IT_0130;
    ...
    const ccomplex_t IT_0189 = IT_0013*IT_0139;
    const ccomplex_t IT_0190 = IT_0017*IT_0188*IT_0189;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0192 = IT_0028*IT_0156;
    const ccomplex_t IT_0193 = IT_0030*IT_0191*IT_0192;
    const ccomplex_t IT_0194 = -IT_0190 + -IT_0193;
    const ccomplex_t IT_0195 = m_N_4*IT_0019;
    const ccomplex_t IT_0196 = m_N_4*IT_0032;
    const ccomplex_t IT_0197 = m_b*IT_0129;
    const ccomplex_t IT_0198 = IT_0195 + IT_0196 + -IT_0197;
    const ccomplex_t IT_0199 = IT_0194 + IT_0198;
    const ccomplex_t IT_0200 = s_14*IT_0130;
    const ccomplex_t IT_0201 = IT_0066*IT_0200;
    ...
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*m_t;
    const ccomplex_t IT_0207 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0208 = IT_0036*IT_0207;
    const ccomplex_t IT_0209 = 1.4142135623731*IT_0208;
    const ccomplex_t IT_0210 = m_t*N_u4*e_em*IT_0009*U_st_01;
    ...
    const ccomplex_t IT_0216 = IT_0110*IT_0206*IT_0215;
    const ccomplex_t IT_0217 = IT_0008*IT_0146;
    const ccomplex_t IT_0218 = IT_0017*IT_0188*IT_0217;
    const ccomplex_t IT_0219 = IT_0026*IT_0163;
    const ccomplex_t IT_0220 = IT_0030*IT_0191*IT_0219;
    const ccomplex_t IT_0221 = -IT_0216 + -IT_0218 + -IT_0220;
    const ccomplex_t IT_0222 = IT_0149 + IT_0166;
    const ccomplex_t IT_0223 = m_N_4*IT_0222;
    const ccomplex_t IT_0224 = IT_0221 + IT_0223;
    const ccomplex_t IT_0225 = (-18)*conj(IT_0221);
    const ccomplex_t IT_0226 = 2*IT_0149 + 2*IT_0166;
    ...
    const ccomplex_t IT_0231 = 0.5*IT_0183;
    const ccomplex_t IT_0232 = s_34 + IT_0231;
    const ccomplex_t IT_0233 = m_N_4*IT_0232;
    const ccomplex_t IT_0234 = 2*IT_0233;
    const ccomplex_t IT_0235 = (-2)*IT_0177;
    const ccomplex_t IT_0236 = IT_0179 + IT_0235;
    const ccomplex_t IT_0237 = IT_0066*IT_0236;
    const ccomplex_t IT_0238 = (-6)*IT_0237;
    const ccomplex_t IT_0239 = 12*s_13;
    const ccomplex_t IT_0240 = IT_0238 + IT_0239;
    const ccomplex_t IT_0241 = m_b*IT_0229;
    const ccomplex_t IT_0242 = (-6)*IT_0169;
    const ccomplex_t IT_0243 = IT_0103*IT_0229;
    const ccomplex_t IT_0244 = IT_0086 + IT_0101 + 2*IT_0129;
    ...
    const ccomplex_t IT_0249 = IT_0103*IT_0248;
    const ccomplex_t IT_0250 = m_N_4*IT_0248;
    const ccomplex_t IT_0251 = (-6)*conj(IT_0169);
    const ccomplex_t IT_0252 = s_13*IT_0229;
    const ccomplex_t IT_0253 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0254 = (-6)*IT_0176;
    const ccomplex_t IT_0255 = IT_0178 + IT_0254;
    const ccomplex_t IT_0256 = (-0.25)*IT_0201;
    const ccomplex_t IT_0257 = s_14 + IT_0256;
    const ccomplex_t IT_0258 = m_b*IT_0257;
    const ccomplex_t IT_0259 = (-4)*IT_0258;
    const ccomplex_t IT_0260 = (-6)*IT_0102;
    const ccomplex_t IT_0261 = 0.166666666666667*IT_0260;
    const ccomplex_t IT_0262 = IT_0226 + IT_0261;
    const ccomplex_t IT_0263 = (-6)*IT_0244;
    const ccomplex_t IT_0264 = IT_0129 + IT_0167;
    const ccomplex_t IT_0265 = (-6)*conj(IT_0244);
    const ccomplex_t IT_0266 = (-6)*IT_0221;
    const ccomplex_t IT_0267 = (-6)*conj(IT_0167)*(IT_0105*IT_0168 + (
      -0.166666666666667)*IT_0167*IT_0181 + IT_0199*IT_0205 + (
      -0.166666666666667)*IT_0129*IT_0255 + -IT_0109*IT_0262 + (
      -0.166666666666667)*IT_0173*IT_0263 + IT_0187*(IT_0223 + (
      -0.166666666666667)*IT_0266));
    const ccomplex_t IT_0268 = (-6)*conj(IT_0221);
    ...
    const ccomplex_t IT_0274 = 6*IT_0129;
    const ccomplex_t IT_0275 = (-6)*IT_0226;
    const ccomplex_t IT_0276 = (-6)*IT_0167;
    const ccomplex_t IT_0277 = IT_0103*((-18)*IT_0221 + (-18)*IT_0223) +
       IT_0199*IT_0240 + IT_0242*IT_0250 + IT_0241*IT_0263 + IT_0230*IT_0272 +
       IT_0187*IT_0273 + IT_0259*IT_0274 + IT_0271*(IT_0102 + 0.166666666666667
      *IT_0275) + IT_0205*IT_0276;
    const ccomplex_t IT_0278 = IT_0103*((-18)*IT_0194 + (-18)*IT_0198) +
       IT_0224*IT_0240 + IT_0241*IT_0242 + 6*IT_0230*IT_0262 + IT_0250*IT_0263 +
       6*IT_0065*IT_0270 + IT_0205*IT_0273 + IT_0234*IT_0274 + IT_0187*IT_0276;
    const ccomplex_t IT_0279 = 0.166666666666667*IT_0243;
    const ccomplex_t IT_0280 = s_13*IT_0248;
    const ccomplex_t IT_0281 = 0.166666666666667*IT_0280;
    const ccomplex_t IT_0282 = (-6)*conj(IT_0102);
    const ccomplex_t IT_0283 = IT_0109*IT_0264;
    const ccomplex_t IT_0284 = 6*conj(IT_0065)*(IT_0065*IT_0071 + IT_0102
      *IT_0104 + IT_0105*IT_0109) + 6*conj(IT_0105)*(IT_0065*IT_0109 + IT_0129
      *IT_0132 + -IT_0167*IT_0168 + IT_0169*IT_0173 + 0.166666666666667*IT_0105
      *IT_0181 + IT_0187*IT_0199 + IT_0205*IT_0224) + IT_0103*IT_0199*IT_0225 +
       6*conj(IT_0221)*(IT_0105*IT_0205 + IT_0226*IT_0230 + IT_0129*IT_0234 +
       0.166666666666667*IT_0224*IT_0240 + 0.166666666666667*IT_0241*IT_0242) + 
      (IT_0224*IT_0241 + IT_0102*IT_0243 + IT_0244*IT_0249 + IT_0199*IT_0250)
      *IT_0251 + (IT_0104*IT_0226 + IT_0199*IT_0230 + IT_0243*IT_0244 + IT_0169
      *IT_0252)*IT_0253 + 6*conj(IT_0129)*(IT_0105*IT_0132 + 0.166666666666667
      *IT_0129*IT_0181 + IT_0224*IT_0234 + 0.166666666666667*IT_0167*IT_0255 +
       IT_0199*IT_0259 + IT_0109*IT_0262 + 0.166666666666667*IT_0173*IT_0263) + 
      (IT_0199*IT_0241 + IT_0223*IT_0250 + IT_0173*IT_0264)*IT_0265 + IT_0267 + 
      (IT_0167*IT_0187 + IT_0102*IT_0230 + IT_0244*IT_0250)*IT_0268 + (IT_0065
      *conj(IT_0221) + conj(IT_0065)*IT_0224 + IT_0199*(conj(IT_0102) +
       0.166666666666667*IT_0269))*IT_0271 + (conj(IT_0194) + conj(IT_0198))
      *IT_0277 + conj(IT_0223)*IT_0278 + 6*conj(IT_0102)*(IT_0071*IT_0102 +
       IT_0065*IT_0104 + 0.166666666666667*IT_0230*IT_0266 + IT_0242*IT_0279) +
       6*conj(IT_0169)*(IT_0105*IT_0173 + IT_0226*IT_0243 + 0.166666666666667
      *IT_0252*IT_0272 + IT_0242*IT_0281) + 6*conj(IT_0244)*(0.166666666666667
      *IT_0242*IT_0249 + IT_0252*IT_0262 + 0.166666666666667*IT_0250*IT_0266 +
       IT_0272*IT_0279 + IT_0263*IT_0281) + IT_0282*(IT_0071*IT_0226 + IT_0223
      *IT_0230 + IT_0244*IT_0252 + IT_0283) + 6*conj(IT_0226)*(IT_0224*IT_0230 +
       IT_0169*IT_0243 + IT_0244*IT_0252 + IT_0071*IT_0262 + 0.166666666666667
      *IT_0104*IT_0272 + IT_0283);
