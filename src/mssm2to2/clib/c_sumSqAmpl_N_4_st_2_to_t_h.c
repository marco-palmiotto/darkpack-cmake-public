        ...
        )
{
    ...
    const ccomplex_t IT_0033 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0034 = IT_0001*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = m_t*N_u4*e_em*IT_0010*U_st_00;
    ...
    const ccomplex_t IT_0041 = 2*conj(U_st_00)*(((-0.5)*m_W*IT_0022*(IT_0008 +
    ...
    const ccomplex_t IT_0075 = pow(m_st_2, 2);
    ...
    const ccomplex_t IT_0080 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0081 = IT_0001*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = m_t*N_u1*e_em*IT_0010*U_st_01;
    ...
    const ccomplex_t IT_0137 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0138 = IT_0001*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = m_t*N_u2*e_em*IT_0010*U_st_01;
