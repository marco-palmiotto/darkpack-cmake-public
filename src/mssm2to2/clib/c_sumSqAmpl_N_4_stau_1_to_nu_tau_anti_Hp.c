        ...
        )
{
    ...
    const ccomplex_t IT_0038 = conj(U_d2)*e_em*m_tau*IT_0024*U_stau_10;
    ...
    const ccomplex_t IT_0074 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0075 = IT_0008*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*IT_0075;
    const ccomplex_t IT_0077 = N_d4*e_em*m_tau*IT_0024*U_stau_00;
    ...
    const ccomplex_t IT_0094 = conj(N_d4)*e_em*m_tau*IT_0024*U_stau_10;
