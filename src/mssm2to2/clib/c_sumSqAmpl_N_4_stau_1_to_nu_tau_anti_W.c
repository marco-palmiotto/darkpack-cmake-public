        ...
        )
{
    ...
    const ccomplex_t IT_0004 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0005 = IT_0003*IT_0004;
    const ccomplex_t IT_0006 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0011 = e_em*conj(U_Wm1)*U_stau_00;
    ...
    const ccomplex_t IT_0031 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0032 = IT_0003*IT_0031;
    const ccomplex_t IT_0033 = conj(U_d2)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0038 = cpow(s_23 + (-0.5)*IT_0000 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0045 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0046 = IT_0003*IT_0045;
    const ccomplex_t IT_0047 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0053 = IT_0001*IT_0044*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0055 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0056 = IT_0003*IT_0055;
    const ccomplex_t IT_0057 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0083 = IT_0066*IT_0067*IT_0082;
    const ccomplex_t IT_0084 = 0.5*IT_0053 + 0.5*IT_0063 + 0.5*IT_0083;
    const ccomplex_t IT_0085 = pow(m_W, -2);
    const ccomplex_t IT_0086 = pow(s_34, 2);
    const ccomplex_t IT_0087 = m_N_4*IT_0085*IT_0086;
    const ccomplex_t IT_0088 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0089 = IT_0071*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0092 = IT_0003*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = conj(N_d4)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0003
      *U_stau_00;
    ...
    const ccomplex_t IT_0112 = cpow(s_13 + (-0.5)*IT_0064 + (-0.5)*reg_prop +
    ...
    const ccomplex_t IT_0116 = -IT_0101 + (-0.5)*IT_0115;
    const ccomplex_t IT_0117 = 2*IT_0116;
    const ccomplex_t IT_0118 = (-0.5)*IT_0087*IT_0117;
    ...
    const ccomplex_t IT_0127 = IT_0043 + IT_0084;
    const ccomplex_t IT_0128 = (-2)*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = (-0.5)*IT_0101;
    const ccomplex_t IT_0130 = s_34*IT_0119;
    ...
    const ccomplex_t IT_0137 = 0.5*IT_0023 + 0.5*IT_0040;
    const ccomplex_t IT_0138 = (-0.25)*IT_0131;
    ...
    const ccomplex_t IT_0143 = IT_0118 + IT_0128 + IT_0136 + IT_0142;
    const ccomplex_t IT_0144 = s_14*s_34*IT_0085;
    const ccomplex_t IT_0145 = -IT_0144;
    const ccomplex_t IT_0146 = s_13 + IT_0145;
    const ccomplex_t IT_0147 = s_13*IT_0146;
    const ccomplex_t IT_0148 = -IT_0023 + -IT_0040;
    const ccomplex_t IT_0149 = 2*IT_0148;
    const ccomplex_t IT_0150 = 0.5*IT_0115;
    const ccomplex_t IT_0151 = (-2)*IT_0150;
    const ccomplex_t IT_0152 = IT_0149 + IT_0151;
    const ccomplex_t IT_0153 = 2*conj(IT_0148);
    const ccomplex_t IT_0154 = (-2)*conj(IT_0150);
    const ccomplex_t IT_0155 = IT_0153 + IT_0154;
    const ccomplex_t IT_0156 = s_13*s_14;
    const ccomplex_t IT_0157 = s_34*IT_0064;
    const ccomplex_t IT_0158 = -IT_0157;
    const ccomplex_t IT_0159 = IT_0156 + IT_0158;
    const ccomplex_t IT_0160 = IT_0129 + IT_0137;
    const ccomplex_t IT_0161 = m_N_4*IT_0146;
    const ccomplex_t IT_0162 = pow(s_14, 2);
    const ccomplex_t IT_0163 = IT_0085*IT_0162;
    const ccomplex_t IT_0164 = -IT_0064;
    const ccomplex_t IT_0165 = IT_0163 + IT_0164;
    const ccomplex_t IT_0166 = s_13*IT_0165;
    const ccomplex_t IT_0167 = s_13*IT_0085*IT_0086;
    const ccomplex_t IT_0168 = pow(m_W, 4);
    const ccomplex_t IT_0169 = s_13*IT_0168;
    const ccomplex_t IT_0170 = IT_0085*IT_0169;
    const ccomplex_t IT_0171 = IT_0120 + IT_0122 + (-0.5)*IT_0170;
    const ccomplex_t IT_0172 = (-0.25)*IT_0170;
    const ccomplex_t IT_0173 = IT_0121 + IT_0172;
    const ccomplex_t IT_0174 = s_13*s_34;
    const ccomplex_t IT_0175 = 2*conj(IT_0116);
    const ccomplex_t IT_0176 = (-2)*(conj(IT_0043) + conj(IT_0084))*IT_0143 +
       IT_0147*(conj(IT_0116)*IT_0152 + IT_0116*IT_0155) + IT_0159*((conj
      (IT_0129) + conj(IT_0137))*IT_0152 + IT_0155*IT_0160) + ((conj(IT_0043) +
       conj(IT_0084))*IT_0152 + IT_0127*IT_0155)*IT_0161 + (-2)*((-0.5)*conj
      (IT_0148)*IT_0149 + IT_0148*conj(IT_0150) + IT_0150*(conj(IT_0148) + -conj
      (IT_0150)))*IT_0166 + conj(IT_0116)*IT_0117*IT_0167 + (-4)*conj(IT_0137)*
      (0.5*IT_0127*IT_0141 + IT_0137*IT_0171 + (-2)*IT_0129*IT_0173 + (-0.25)
      *IT_0117*IT_0174) + (-4)*conj(IT_0129)*((-0.5)*IT_0127*IT_0135 + IT_0129
      *IT_0171 + (-2)*IT_0137*IT_0173 + (-0.25)*IT_0117*IT_0174) + (IT_0087
      *IT_0127 + IT_0160*IT_0174)*IT_0175;
