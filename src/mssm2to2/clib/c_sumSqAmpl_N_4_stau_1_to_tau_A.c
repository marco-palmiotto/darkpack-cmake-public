        ...
        )
{
    ...
    const ccomplex_t IT_0003 = N_B4*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0012 = N_d4*e_em*m_tau*IT_0011*U_stau_00;
    ...
    const ccomplex_t IT_0039 = conj(N_d4)*e_em*m_tau*IT_0011*U_stau_10;
