        ...
        )
{
    ...
    const ccomplex_t IT_0047 = N_B4*N_u1*e_em;
    ...
    const ccomplex_t IT_0088 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0089 = IT_0016*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = N_d4*e_em*m_tau*IT_0002*U_stau_01;
    ...
    const ccomplex_t IT_0139 = N_d2*e_em*m_tau*IT_0002*U_stau_00;
    ...
    const ccomplex_t IT_0147 = N_B4*N_u2*e_em;
    const ccomplex_t IT_0148 = IT_0046*IT_0147;
    const ccomplex_t IT_0149 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0150 = IT_0049*IT_0149;
    const ccomplex_t IT_0151 = N_W4*N_u2*e_em;
    ...
    const ccomplex_t IT_0165 = conj(N_B2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0171 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0172 = IT_0055*IT_0171;
    const ccomplex_t IT_0173 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0174 = IT_0046*IT_0173;
    const ccomplex_t IT_0175 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0176 = IT_0049*IT_0175;
    const ccomplex_t IT_0177 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0188 = N_d3*e_em*m_tau*IT_0002*U_stau_00;
    ...
    const ccomplex_t IT_0238 = IT_0045*IT_0084;
    const ccomplex_t IT_0239 = cpow(s_12 + 0.5*IT_0029 + (-0.5)*IT_0030 + 0.5
      *IT_0042 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0240 = e_em*m_tau*IT_0001*IT_0002*IT_0007*IT_0021;
    const ccomplex_t IT_0241 = (-0.5)*IT_0240;
    const ccomplex_t IT_0242 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0243 = IT_0016*IT_0242;
    const ccomplex_t IT_0244 = 1.4142135623731*IT_0243;
    const ccomplex_t IT_0245 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0246 = IT_0001*IT_0245;
    const ccomplex_t IT_0247 = 1.4142135623731*IT_0246;
    const ccomplex_t IT_0248 = conj(N_d4)*e_em*m_tau*IT_0002*U_stau_10;
    ...
    const ccomplex_t IT_0256 = IT_0129*IT_0134;
    const ccomplex_t IT_0257 = 0.5*IT_0236 + 0.5*IT_0237 + 0.5*IT_0238 + 0.5
      *IT_0255 + 0.5*IT_0256;
    ...
    const ccomplex_t IT_0265 = conj(N_d2)*e_em*m_tau*IT_0002*U_stau_10;
    ...
    const ccomplex_t IT_0287 = IT_0132*IT_0252;
    ...
    const ccomplex_t IT_0304 = IT_0027*IT_0241;
