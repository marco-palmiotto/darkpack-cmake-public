...
ccomplex_return_t c_sumSqAmpl_N_4_stau_1_to_tau_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0021 = IT_0003*IT_0020;
    const ccomplex_t IT_0022 = conj(N_B4)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0026 = conj(N_W4)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0034 = cpow(IT_0000, -1);
    const ccomplex_t IT_0035 = IT_0011*IT_0034;
    const ccomplex_t IT_0036 = pow(m_W, -1);
    const ccomplex_t IT_0037 = N_d4*e_em*m_tau*IT_0036*U_stau_00;
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*(IT_0033 + 0.5*IT_0039);
    const ccomplex_t IT_0041 = -IT_0040;
    const ccomplex_t IT_0042 = pow(m_tau, 2);
    const ccomplex_t IT_0043 = pow(m_stau_1, 2);
    const ccomplex_t IT_0044 = cpow(s_23 + (-0.5)*IT_0042 + (-0.5)*IT_0043 +
    ...
    const ccomplex_t IT_0048 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0049 = IT_0002*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = N_d1*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0056 = cpow(s_23 + (-0.5)*IT_0042 + (-0.5)*IT_0043 +
    ...
    const ccomplex_t IT_0061 = N_B4*N_d1*e_em;
    ...
    const ccomplex_t IT_0069 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0070 = IT_0007*IT_0069;
    const ccomplex_t IT_0071 = N_W1*N_u4*e_em;
    const ccomplex_t IT_0072 = IT_0012*IT_0071;
    const ccomplex_t IT_0073 = N_W1*N_d4*e_em;
    const ccomplex_t IT_0074 = IT_0015*IT_0073;
    const ccomplex_t IT_0075 = (-0.5)*IT_0060 + 0.5*IT_0062 + 0.5*IT_0064 + (
      -0.5)*IT_0066 + (-0.5)*IT_0068 + 0.5*IT_0070 + 0.5*IT_0072 + (-0.5)*IT_0074;
    const ccomplex_t IT_0076 = m_N_1*IT_0075;
    const ccomplex_t IT_0077 = conj(N_B1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0087 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0088 = IT_0007*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0090 = IT_0012*IT_0089;
    const ccomplex_t IT_0091 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0097 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0098 = IT_0002*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = N_d2*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0105 = cpow(s_23 + (-0.5)*IT_0042 + (-0.5)*IT_0043 +
    ...
    const ccomplex_t IT_0126 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0127 = IT_0003*IT_0126;
    const ccomplex_t IT_0128 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0129 = IT_0007*IT_0128;
    const ccomplex_t IT_0130 = conj(N_W2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0136 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0145 = IT_0107*IT_0144;
    const ccomplex_t IT_0146 = pow(m_N_4, 2);
    const ccomplex_t IT_0147 = cpow(s_13 + (-0.5)*IT_0042 + (-0.5)*IT_0146 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0148 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0149 = IT_0011*IT_0148;
    const ccomplex_t IT_0150 = e_em*mu_h*m_tau*IT_0036*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0151 = IT_0011*IT_0150;
    const ccomplex_t IT_0152 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0153 = IT_0006*IT_0152;
    const ccomplex_t IT_0154 = 1.4142135623731*IT_0153;
    const ccomplex_t IT_0155 = A_tau*U_stau_00*conj(U_stau_10);
    const ccomplex_t IT_0156 = IT_0006*IT_0155;
    const ccomplex_t IT_0157 = 1.4142135623731*IT_0156;
    const ccomplex_t IT_0158 = (-0.5)*IT_0149 + 0.5*IT_0151 + (-0.5)*IT_0154 +
       0.5*IT_0157;
    const ccomplex_t IT_0159 = IT_0041*IT_0158;
    const ccomplex_t IT_0160 = IT_0147*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0163 = IT_0002*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = N_d4*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0170 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0171 = IT_0011*IT_0170;
    const ccomplex_t IT_0172 = e_em*mu_h*m_tau*IT_0036*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0173 = IT_0011*IT_0172;
    const ccomplex_t IT_0174 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0175 = IT_0006*IT_0174;
    const ccomplex_t IT_0176 = 1.4142135623731*IT_0175;
    const ccomplex_t IT_0177 = A_tau*U_stau_00*conj(U_stau_11);
    const ccomplex_t IT_0178 = IT_0006*IT_0177;
    const ccomplex_t IT_0179 = 1.4142135623731*IT_0178;
    const ccomplex_t IT_0180 = (-0.5)*IT_0171 + 0.5*IT_0173 + (-0.5)*IT_0176 +
       0.5*IT_0179;
    const ccomplex_t IT_0181 = IT_0169*IT_0180;
    const ccomplex_t IT_0182 = cpow(s_13 + (-0.5)*IT_0042 + (-0.5)*IT_0146 + (
    ...
    const ccomplex_t IT_0185 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0186 = IT_0002*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = N_d3*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0193 = cpow(s_23 + (-0.5)*IT_0042 + (-0.5)*IT_0043 +
    ...
    const ccomplex_t IT_0198 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0199 = IT_0007*IT_0198;
    const ccomplex_t IT_0200 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0201 = IT_0012*IT_0200;
    const ccomplex_t IT_0202 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0203 = IT_0015*IT_0202;
    const ccomplex_t IT_0204 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0205 = IT_0003*IT_0204;
    const ccomplex_t IT_0206 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0207 = IT_0007*IT_0206;
    const ccomplex_t IT_0208 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0214 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0215 = IT_0003*IT_0214;
    const ccomplex_t IT_0216 = conj(N_B3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0222 = conj(N_B4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0223 = IT_0003*IT_0222;
    const ccomplex_t IT_0224 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0225 = IT_0007*IT_0224;
    const ccomplex_t IT_0226 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0227 = IT_0012*IT_0226;
    const ccomplex_t IT_0228 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0234 = (-0.5)*IT_0047 + (-0.5)*IT_0096 + (-0.5)
      *IT_0145 + (-0.5)*IT_0161 + (-0.5)*IT_0184 + (-0.5)*IT_0233;
    const ccomplex_t IT_0235 = 2*s_13;
    const ccomplex_t IT_0236 = IT_0107*IT_0142;
    const ccomplex_t IT_0237 = IT_0195*IT_0230;
    const ccomplex_t IT_0238 = cpow(s_12 + (-0.5)*IT_0042 + 0.5*IT_0043 + 0.5
      *IT_0146 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0239 = e_em*m_tau*IT_0006*IT_0011*IT_0034*IT_0036;
    const ccomplex_t IT_0240 = (-0.5)*IT_0239;
    const ccomplex_t IT_0241 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0242 = IT_0002*IT_0241;
    const ccomplex_t IT_0243 = 1.4142135623731*IT_0242;
    const ccomplex_t IT_0244 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0245 = IT_0011*IT_0244;
    const ccomplex_t IT_0246 = 1.4142135623731*IT_0245;
    const ccomplex_t IT_0247 = conj(N_d4)*e_em*m_tau*IT_0036*U_stau_10;
    ...
    const ccomplex_t IT_0255 = IT_0058*IT_0093;
    const ccomplex_t IT_0256 = IT_0028*IT_0046;
    ...
    const ccomplex_t IT_0265 = conj(N_d1)*e_em*m_tau*IT_0036*U_stau_10;
    const ccomplex_t IT_0266 = IT_0035*IT_0265;
    ...
    const ccomplex_t IT_0270 = IT_0056*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1)*IT_0270;
    const ccomplex_t IT_0272 = IT_0075*IT_0271;
    const ccomplex_t IT_0273 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0274 = IT_0002*IT_0273;
    const ccomplex_t IT_0275 = 1.4142135623731*IT_0274;
    const ccomplex_t IT_0276 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0277 = IT_0011*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_d2)*e_em*m_tau*IT_0036*U_stau_10;
    const ccomplex_t IT_0280 = IT_0035*IT_0279;
    ...
    const ccomplex_t IT_0307 = (-0.5)*IT_0272 + (-0.5)*IT_0286 + (-0.5)
      *IT_0300 + (-0.5)*IT_0303 + 0.5*IT_0306;
    const ccomplex_t IT_0308 = s_34*m_N_4;
    const ccomplex_t IT_0309 = IT_0158*IT_0251;
    const ccomplex_t IT_0310 = IT_0147*IT_0309;
    const ccomplex_t IT_0311 = (0 + _Complex_I*1)*IT_0310;
    const ccomplex_t IT_0312 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0313 = IT_0002*IT_0312;
    const ccomplex_t IT_0314 = 1.4142135623731*IT_0313;
    const ccomplex_t IT_0315 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0316 = IT_0011*IT_0315;
    const ccomplex_t IT_0317 = 1.4142135623731*IT_0316;
    const ccomplex_t IT_0318 = conj(N_d4)*e_em*m_tau*IT_0036*U_stau_11;
    const ccomplex_t IT_0319 = IT_0035*IT_0318;
    ...
    const ccomplex_t IT_0323 = IT_0180*IT_0322;
    const ccomplex_t IT_0324 = IT_0182*IT_0323;
    const ccomplex_t IT_0325 = (0 + _Complex_I*1)*IT_0324;
    const ccomplex_t IT_0326 = IT_0030*IT_0302;
    const ccomplex_t IT_0327 = m_N_4*IT_0075;
    const ccomplex_t IT_0328 = m_N_1*IT_0093;
    const ccomplex_t IT_0329 = IT_0327 + IT_0328;
    const ccomplex_t IT_0330 = IT_0271*IT_0329;
    const ccomplex_t IT_0331 = m_N_4*IT_0124;
    const ccomplex_t IT_0332 = m_N_2*IT_0142;
    const ccomplex_t IT_0333 = IT_0331 + IT_0332;
    const ccomplex_t IT_0334 = IT_0285*IT_0333;
    const ccomplex_t IT_0335 = m_N_4*IT_0212;
    const ccomplex_t IT_0336 = m_N_3*IT_0230;
    const ccomplex_t IT_0337 = IT_0335 + IT_0336;
    const ccomplex_t IT_0338 = IT_0299*IT_0337;
    const ccomplex_t IT_0339 = 0.5*IT_0311 + 0.5*IT_0325 + 0.5*IT_0326 + 0.5
      *IT_0330 + 0.5*IT_0334 + 0.5*IT_0338;
    const ccomplex_t IT_0340 = 2*conj(IT_0339);
    const ccomplex_t IT_0341 = m_N_4*m_tau;
    const ccomplex_t IT_0342 = 2*IT_0234;
    const ccomplex_t IT_0343 = 2*conj(IT_0234);
    const ccomplex_t IT_0344 = pow(m_A0, 2);
    const ccomplex_t IT_0345 = m_N_4*m_tau*IT_0344;
