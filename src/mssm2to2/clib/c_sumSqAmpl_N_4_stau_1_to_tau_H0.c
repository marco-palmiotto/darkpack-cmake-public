...
ccomplex_return_t c_sumSqAmpl_N_4_stau_1_to_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = N_B4*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0050 = cpow(s_12 + (-0.5)*IT_0043 + 0.5*IT_0044 + 0.5
      *IT_0049 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0011
      *IT_0035*IT_0037;
    ...
    const ccomplex_t IT_0057 = cpow(s_13 + (-0.5)*IT_0043 + (-0.5)*IT_0049 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0058 = mu_h*m_tau*IT_0037;
    const ccomplex_t IT_0059 = sin(beta);
    const ccomplex_t IT_0060 = -IT_0006*IT_0059;
    const ccomplex_t IT_0061 = IT_0000*IT_0034;
    const ccomplex_t IT_0062 = IT_0060 + IT_0061;
    const ccomplex_t IT_0063 = cpow(IT_0001, -2);
    const ccomplex_t IT_0064 = (-2)*U_stau_00*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0062*(IT_0011 + -IT_0010*IT_0063))*conj
      (U_stau_00) + -1./2*IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_10)) +
       U_stau_10*(IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_00) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0062*IT_0063)
      *conj(U_stau_10));
    const ccomplex_t IT_0065 = (0 + _Complex_I*-1)*(e_em*IT_0064 + (
      -1.4142135623731)*A_tau*IT_0000*(conj(U_stau_00)*U_stau_10 + U_stau_00
      *conj(U_stau_10)));
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = IT_0042*IT_0066;
    const ccomplex_t IT_0068 = IT_0057*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0043 + (-0.5)*IT_0049 + (
    ...
    const ccomplex_t IT_0074 = N_d4*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0079 = (-2)*U_stau_00*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0062*(IT_0011 + -IT_0010*IT_0063))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_11)) +
       U_stau_10*(IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0062*IT_0063)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0085 = N_B4*N_d1*e_em;
    ...
    const ccomplex_t IT_0100 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0107 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0108 = IT_0003*IT_0107;
    const ccomplex_t IT_0109 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0110 = IT_0015*IT_0109;
    const ccomplex_t IT_0111 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0112 = IT_0003*IT_0111;
    const ccomplex_t IT_0113 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0114 = IT_0015*IT_0113;
    const ccomplex_t IT_0115 = IT_0108 + IT_0110 + IT_0112 + IT_0114;
    const ccomplex_t IT_0116 = conj(N_B1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0120 = conj(N_B4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0130 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0131 = IT_0002*IT_0130;
    const ccomplex_t IT_0132 = 1.4142135623731*IT_0131;
    const ccomplex_t IT_0133 = N_d1*e_em*m_tau*IT_0037*U_stau_00;
    const ccomplex_t IT_0134 = IT_0036*IT_0133;
    ...
    const ccomplex_t IT_0138 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0170 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0171 = IT_0015*IT_0170;
    const ccomplex_t IT_0172 = IT_0165 + IT_0167 + IT_0169 + IT_0171;
    const ccomplex_t IT_0173 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0174 = IT_0007*IT_0173;
    const ccomplex_t IT_0175 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0176 = IT_0012*IT_0175;
    const ccomplex_t IT_0177 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0178 = IT_0007*IT_0177;
    const ccomplex_t IT_0179 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0186 = IT_0163 + IT_0185;
    const ccomplex_t IT_0187 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0188 = IT_0002*IT_0187;
    const ccomplex_t IT_0189 = 1.4142135623731*IT_0188;
    const ccomplex_t IT_0190 = N_d2*e_em*m_tau*IT_0037*U_stau_00;
    const ccomplex_t IT_0191 = IT_0036*IT_0190;
    ...
    const ccomplex_t IT_0195 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0199 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0200 = IT_0002*IT_0199;
    const ccomplex_t IT_0201 = 1.4142135623731*IT_0200;
    const ccomplex_t IT_0202 = N_d3*e_em*m_tau*IT_0037*U_stau_00;
    ...
    const ccomplex_t IT_0207 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0232 = conj(N_B3)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0236 = conj(N_B4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0241 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0242 = IT_0007*IT_0241;
    const ccomplex_t IT_0243 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0244 = IT_0012*IT_0243;
    const ccomplex_t IT_0245 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0255 = IT_0209*IT_0254;
    const ccomplex_t IT_0256 = (-0.5)*IT_0048 + IT_0056 + (-0.5)*IT_0069 + (
      -0.5)*IT_0084 + (-0.5)*IT_0141 + (-0.5)*IT_0198 + (-0.5)*IT_0255;
    const ccomplex_t IT_0257 = m_N_4*IT_0105;
    const ccomplex_t IT_0258 = m_N_1*IT_0127;
    const ccomplex_t IT_0259 = IT_0257 + IT_0258;
    const ccomplex_t IT_0260 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0261 = IT_0002*IT_0260;
    const ccomplex_t IT_0262 = 1.4142135623731*IT_0261;
    const ccomplex_t IT_0263 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0264 = IT_0011*IT_0263;
    const ccomplex_t IT_0265 = 1.4142135623731*IT_0264;
    const ccomplex_t IT_0266 = conj(N_d1)*e_em*m_tau*IT_0037*U_stau_10;
    const ccomplex_t IT_0267 = IT_0036*IT_0266;
    ...
    const ccomplex_t IT_0273 = IT_0259*IT_0272;
    const ccomplex_t IT_0274 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0275 = IT_0002*IT_0274;
    const ccomplex_t IT_0276 = 1.4142135623731*IT_0275;
    const ccomplex_t IT_0277 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0278 = IT_0011*IT_0277;
    const ccomplex_t IT_0279 = 1.4142135623731*IT_0278;
    const ccomplex_t IT_0280 = conj(N_d2)*e_em*m_tau*IT_0037*U_stau_10;
    ...
    const ccomplex_t IT_0302 = (-2)*U_stau_00*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0062*(IT_0011 + -IT_0010*IT_0063))*conj
      (U_stau_00) + -1./2*IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_10)) +
       U_stau_10*(IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_00) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0062*IT_0063)
    ...
    const ccomplex_t IT_0319 = (-2)*U_stau_00*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0062*(IT_0011 + -IT_0010*IT_0063))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_11)) +
       U_stau_10*(IT_0006*IT_0011*IT_0035*IT_0058*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0062*IT_0063)
      *conj(U_stau_11));
    const ccomplex_t IT_0320 = (0 + _Complex_I*-1)*(e_em*IT_0319 + (
      -1.4142135623731)*A_tau*IT_0000*(conj(U_stau_01)*U_stau_10 + U_stau_00
      *conj(U_stau_11)));
    const ccomplex_t IT_0321 = (-0.5)*IT_0320;
    const ccomplex_t IT_0322 = IT_0318*IT_0321;
    const ccomplex_t IT_0323 = IT_0070*IT_0322;
    const ccomplex_t IT_0324 = (0 + _Complex_I*1)*IT_0323;
    const ccomplex_t IT_0325 = IT_0045*IT_0301;
    const ccomplex_t IT_0326 = (0 + _Complex_I*1)*IT_0325;
    const ccomplex_t IT_0327 = IT_0030*IT_0326;
    const ccomplex_t IT_0328 = m_N_4*IT_0230;
    const ccomplex_t IT_0329 = m_N_3*IT_0252;
    const ccomplex_t IT_0330 = IT_0328 + IT_0329;
    const ccomplex_t IT_0331 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0332 = IT_0002*IT_0331;
    const ccomplex_t IT_0333 = 1.4142135623731*IT_0332;
    const ccomplex_t IT_0334 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0335 = IT_0011*IT_0334;
    const ccomplex_t IT_0336 = 1.4142135623731*IT_0335;
    const ccomplex_t IT_0337 = conj(N_d3)*e_em*m_tau*IT_0037*U_stau_10;
    const ccomplex_t IT_0338 = IT_0036*IT_0337;
    const ccomplex_t IT_0339 = 1.4142135623731*IT_0338;
    const ccomplex_t IT_0340 = (0 + _Complex_I*1)*(IT_0333 + IT_0336 + 
      -IT_0339);
    ...
    const ccomplex_t IT_0345 = IT_0052*IT_0301;
    const ccomplex_t IT_0346 = IT_0050*IT_0345;
    const ccomplex_t IT_0347 = (0 + _Complex_I*1)*IT_0346;
    const ccomplex_t IT_0348 = m_tau*IT_0347;
    const ccomplex_t IT_0349 = 0.5*IT_0273 + 0.5*IT_0290 + 0.5*IT_0307 + 0.5
      *IT_0324 + 0.5*IT_0327 + 0.5*IT_0344 + -IT_0348;
    const ccomplex_t IT_0350 = 2*s_13;
    const ccomplex_t IT_0351 = m_N_4*m_tau;
    const ccomplex_t IT_0352 = 2*IT_0256;
    const ccomplex_t IT_0353 = IT_0018*IT_0326;
    const ccomplex_t IT_0354 = IT_0105*IT_0272;
    const ccomplex_t IT_0355 = IT_0162*IT_0286;
    const ccomplex_t IT_0356 = IT_0230*IT_0343;
    const ccomplex_t IT_0357 = 0.5*IT_0055 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0028*IT_0047;
    const ccomplex_t IT_0360 = IT_0184*IT_0197;
    const ccomplex_t IT_0361 = IT_0209*IT_0252;
    const ccomplex_t IT_0362 = IT_0127*IT_0140;
    const ccomplex_t IT_0363 = (-0.5)*IT_0347 + 0.5*IT_0359 + 0.5*IT_0360 +
       0.5*IT_0361 + 0.5*IT_0362;
    const ccomplex_t IT_0364 = s_34*m_N_4;
    const ccomplex_t IT_0365 = 2*conj(IT_0256);
    const ccomplex_t IT_0366 = 2*conj(IT_0349);
    const ccomplex_t IT_0367 = pow(m_H0, 2);
    const ccomplex_t IT_0368 = m_N_4*m_tau*IT_0367;
