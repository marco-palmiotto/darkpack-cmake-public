        ...
        )
{
    ...
    const ccomplex_t IT_0027 = IT_0003*IT_0009;
    const ccomplex_t IT_0028 = N_B4*N_d3*e_em;
    const ccomplex_t IT_0029 = IT_0027*IT_0028;
    const ccomplex_t IT_0030 = sin(alpha);
    const ccomplex_t IT_0031 = IT_0005*IT_0030;
    const ccomplex_t IT_0032 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0033 = IT_0031*IT_0032;
    const ccomplex_t IT_0034 = N_B3*N_d4*e_em;
    const ccomplex_t IT_0035 = IT_0027*IT_0034;
    const ccomplex_t IT_0036 = N_W3*N_u4*e_em;
    ...
    const ccomplex_t IT_0045 = N_B3*N_u4*e_em;
    ...
    const ccomplex_t IT_0056 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0057 = IT_0031*IT_0056;
    const ccomplex_t IT_0058 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0059 = IT_0027*IT_0058;
    const ccomplex_t IT_0060 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0061 = IT_0031*IT_0060;
    const ccomplex_t IT_0062 = IT_0055 + IT_0057 + IT_0059 + IT_0061;
    const ccomplex_t IT_0063 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0067 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0093 = IT_0001*IT_0003;
    const ccomplex_t IT_0094 = IT_0092 + IT_0093;
    const ccomplex_t IT_0095 = cpow(IT_0008, -2);
    const ccomplex_t IT_0096 = (-2)*U_stau_00*((IT_0000*IT_0002*IT_0003
      *IT_0005*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0005 + -IT_0004*IT_0095))*conj
      (U_stau_00) + -1./2*IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_10)) +
       U_stau_10*(IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_00) + (-2)*
      (IT_0000*IT_0002*IT_0003*IT_0005*IT_0021 + -m_W*IT_0004*IT_0094*IT_0095)
      *conj(U_stau_10));
    ...
    const ccomplex_t IT_0111 = (-2)*U_stau_00*((IT_0000*IT_0002*IT_0003
      *IT_0005*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0005 + -IT_0004*IT_0095))*conj
      (U_stau_01) + -1./2*IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_11)) +
       U_stau_10*(IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0002*IT_0003*IT_0005*IT_0021 + -m_W*IT_0004*IT_0094*IT_0095)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0117 = N_B4*N_d4*e_em;
    const ccomplex_t IT_0118 = IT_0027*IT_0117;
    const ccomplex_t IT_0119 = N_B4*N_u4*e_em;
    const ccomplex_t IT_0120 = IT_0039*IT_0119;
    const ccomplex_t IT_0121 = N_W4*N_d4*e_em;
    const ccomplex_t IT_0122 = IT_0042*IT_0121;
    const ccomplex_t IT_0123 = N_W4*N_u4*e_em;
    ...
    const ccomplex_t IT_0127 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0128 = IT_0027*IT_0127;
    const ccomplex_t IT_0129 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0130 = IT_0039*IT_0129;
    const ccomplex_t IT_0131 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0132 = IT_0042*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0138 = cpow(s_23 + (-0.5)*IT_0021 + (-0.5)*IT_0022 +
    ...
    const ccomplex_t IT_0144 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0145 = IT_0031*IT_0144;
    const ccomplex_t IT_0146 = N_B1*N_d4*e_em;
    const ccomplex_t IT_0147 = IT_0027*IT_0146;
    ...
    const ccomplex_t IT_0151 = N_B4*N_u1*e_em;
    ...
    const ccomplex_t IT_0156 = IT_0039*IT_0155;
    const ccomplex_t IT_0157 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0166 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0167 = IT_0031*IT_0166;
    const ccomplex_t IT_0168 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0169 = IT_0027*IT_0168;
    const ccomplex_t IT_0170 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0171 = IT_0031*IT_0170;
    const ccomplex_t IT_0172 = IT_0165 + IT_0167 + IT_0169 + IT_0171;
    const ccomplex_t IT_0173 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0174 = IT_0039*IT_0173;
    const ccomplex_t IT_0175 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0176 = IT_0042*IT_0175;
    const ccomplex_t IT_0177 = conj(N_B4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0187 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0188 = IT_0009*IT_0187;
    const ccomplex_t IT_0189 = 1.4142135623731*IT_0188;
    const ccomplex_t IT_0190 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0195 = cpow(s_23 + (-0.5)*IT_0021 + (-0.5)*IT_0022 +
    ...
    const ccomplex_t IT_0199 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0200 = IT_0027*IT_0199;
    const ccomplex_t IT_0201 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0202 = IT_0031*IT_0201;
    const ccomplex_t IT_0203 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0204 = IT_0027*IT_0203;
    const ccomplex_t IT_0205 = N_W2*N_u4*e_em;
    ...
    const ccomplex_t IT_0210 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0211 = IT_0042*IT_0210;
    const ccomplex_t IT_0212 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0213 = IT_0039*IT_0212;
    const ccomplex_t IT_0214 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0221 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0222 = IT_0027*IT_0221;
    const ccomplex_t IT_0223 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0224 = IT_0031*IT_0223;
    const ccomplex_t IT_0225 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0226 = IT_0027*IT_0225;
    const ccomplex_t IT_0227 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0228 = IT_0031*IT_0227;
    const ccomplex_t IT_0229 = IT_0222 + IT_0224 + IT_0226 + IT_0228;
    const ccomplex_t IT_0230 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0231 = IT_0039*IT_0230;
    const ccomplex_t IT_0232 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0233 = IT_0042*IT_0232;
    const ccomplex_t IT_0234 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0235 = IT_0039*IT_0234;
    const ccomplex_t IT_0236 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0244 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0245 = IT_0009*IT_0244;
    const ccomplex_t IT_0246 = 1.4142135623731*IT_0245;
    const ccomplex_t IT_0247 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0252 = cpow(s_23 + (-0.5)*IT_0021 + (-0.5)*IT_0022 +
    ...
    const ccomplex_t IT_0256 = IT_0026 + (-0.5)*IT_0088 + (-0.5)*IT_0101 + (
      -0.5)*IT_0116 + (-0.5)*IT_0141 + (-0.5)*IT_0198 + (-0.5)*IT_0255;
    const ccomplex_t IT_0257 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0258 = IT_0009*IT_0257;
    const ccomplex_t IT_0259 = 1.4142135623731*IT_0258;
    const ccomplex_t IT_0260 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0261 = IT_0005*IT_0260;
    const ccomplex_t IT_0262 = 1.4142135623731*IT_0261;
    const ccomplex_t IT_0263 = conj(N_d4)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0283 = (-2)*U_stau_00*((IT_0000*IT_0002*IT_0003
      *IT_0005*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0005 + -IT_0004*IT_0095))*conj
      (U_stau_01) + -1./2*IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_11)) +
       U_stau_10*(IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0002*IT_0003*IT_0005*IT_0021 + -m_W*IT_0004*IT_0094*IT_0095)
      *conj(U_stau_11));
    const ccomplex_t IT_0284 = (0 + _Complex_I*-1)*(e_em*IT_0283 + (
      -1.4142135623731)*A_tau*IT_0003*(conj(U_stau_01)*U_stau_10 + U_stau_00
      *conj(U_stau_11)));
    const ccomplex_t IT_0285 = (-0.5)*IT_0284;
    const ccomplex_t IT_0286 = IT_0282*IT_0285;
    const ccomplex_t IT_0287 = IT_0102*IT_0286;
    const ccomplex_t IT_0288 = (0 + _Complex_I*1)*IT_0287;
    const ccomplex_t IT_0289 = m_N_4*IT_0219;
    const ccomplex_t IT_0290 = m_N_2*IT_0241;
    const ccomplex_t IT_0291 = IT_0289 + IT_0290;
    const ccomplex_t IT_0292 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0293 = IT_0009*IT_0292;
    const ccomplex_t IT_0294 = 1.4142135623731*IT_0293;
    const ccomplex_t IT_0295 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0296 = IT_0005*IT_0295;
    const ccomplex_t IT_0297 = 1.4142135623731*IT_0296;
    const ccomplex_t IT_0298 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0303 = IT_0252*IT_0302;
    const ccomplex_t IT_0304 = (0 + _Complex_I*1)*IT_0303;
    const ccomplex_t IT_0305 = IT_0291*IT_0304;
    const ccomplex_t IT_0306 = (-2)*U_stau_00*((IT_0000*IT_0002*IT_0003
      *IT_0005*IT_0021 + (-0.5)*m_W*IT_0094*(IT_0005 + -IT_0004*IT_0095))*conj
      (U_stau_00) + -1./2*IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_10)) +
       U_stau_10*(IT_0002*IT_0005*IT_0030*IT_0090*conj(U_stau_00) + (-2)*
      (IT_0000*IT_0002*IT_0003*IT_0005*IT_0021 + -m_W*IT_0004*IT_0094*IT_0095)
    ...
    const ccomplex_t IT_0310 = IT_0089*IT_0309;
    const ccomplex_t IT_0311 = (0 + _Complex_I*1)*IT_0310;
    const ccomplex_t IT_0312 = IT_0138*IT_0267;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = IT_0137*IT_0313;
    const ccomplex_t IT_0315 = m_N_4*IT_0162;
    const ccomplex_t IT_0316 = m_N_1*IT_0184;
    const ccomplex_t IT_0317 = IT_0315 + IT_0316;
    const ccomplex_t IT_0318 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0319 = IT_0009*IT_0318;
    const ccomplex_t IT_0320 = 1.4142135623731*IT_0319;
    const ccomplex_t IT_0321 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0322 = IT_0005*IT_0321;
    const ccomplex_t IT_0323 = 1.4142135623731*IT_0322;
    const ccomplex_t IT_0324 = conj(N_d1)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0346 = IT_0085*IT_0345;
    const ccomplex_t IT_0347 = (0 + _Complex_I*1)*IT_0346;
    const ccomplex_t IT_0348 = IT_0334*IT_0347;
    const ccomplex_t IT_0349 = -IT_0271 + 0.5*IT_0288 + 0.5*IT_0305 + 0.5
    ...
    const ccomplex_t IT_0353 = IT_0125*IT_0313;
    const ccomplex_t IT_0354 = IT_0162*IT_0330;
    const ccomplex_t IT_0355 = IT_0219*IT_0304;
    const ccomplex_t IT_0356 = IT_0052*IT_0347;
    const ccomplex_t IT_0357 = 0.5*IT_0025 + (-0.5)*IT_0353 + (-0.5)*IT_0354 +
       (-0.5)*IT_0355 + (-0.5)*IT_0356;
    const ccomplex_t IT_0358 = s_14*m_tau;
    const ccomplex_t IT_0359 = IT_0241*IT_0254;
    const ccomplex_t IT_0360 = IT_0135*IT_0140;
    const ccomplex_t IT_0361 = IT_0184*IT_0197;
    const ccomplex_t IT_0362 = IT_0074*IT_0087;
