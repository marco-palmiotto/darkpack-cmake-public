        ...
        )
{
    ...
    const ccomplex_t IT_0077 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0078 = IT_0001*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = N_d4*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0091 = IT_0005*IT_0025;
    ...
    const ccomplex_t IT_0096 = 2*U_stau_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj(U_stau_00
      ) + 1./2*IT_0006*IT_0008*IT_0021*IT_0090*conj(U_stau_10)) + U_stau_10*
      (IT_0006*IT_0008*IT_0021*IT_0090*conj(U_stau_00) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -m_W*IT_0007*IT_0094*IT_0095)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0106 = N_d4*e_em*m_tau*IT_0010*U_stau_01;
    ...
    const ccomplex_t IT_0111 = 2*U_stau_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj(U_stau_01
      ) + 1./2*IT_0006*IT_0008*IT_0021*IT_0090*conj(U_stau_11)) + U_stau_10*
      (IT_0006*IT_0008*IT_0021*IT_0090*conj(U_stau_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -m_W*IT_0007*IT_0094*IT_0095)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0140 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
       0.5*m_N_4*(m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0141 = IT_0084*IT_0140;
    ...
    const ccomplex_t IT_0154 = IT_0034*IT_0153;
    ...
    const ccomplex_t IT_0192 = N_d1*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0197 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0201 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0202 = IT_0001*IT_0201;
    const ccomplex_t IT_0203 = 1.4142135623731*IT_0202;
    const ccomplex_t IT_0204 = N_d3*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0209 = cpow(s_23 + (-0.5)*IT_0016 + (-0.5)*IT_0017 +
    ...
    const ccomplex_t IT_0213 = IT_0022*IT_0212;
    ...
    const ccomplex_t IT_0222 = IT_0034*IT_0221;
    ...
    const ccomplex_t IT_0237 = IT_0026*IT_0236;
    ...
    const ccomplex_t IT_0258 = (-0.5)*IT_0072 + IT_0088 + (-0.5)*IT_0101 + (
    ...
    const ccomplex_t IT_0265 = conj(N_d4)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0270 = IT_0140*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1)*IT_0270;
    const ccomplex_t IT_0272 = IT_0139*IT_0271;
    const ccomplex_t IT_0273 = IT_0076*IT_0269;
    ...
    const ccomplex_t IT_0277 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0278 = IT_0001*IT_0277;
    const ccomplex_t IT_0279 = 1.4142135623731*IT_0278;
    const ccomplex_t IT_0280 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0281 = IT_0008*IT_0280;
    const ccomplex_t IT_0282 = 1.4142135623731*IT_0281;
    const ccomplex_t IT_0283 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_10;
    const ccomplex_t IT_0284 = IT_0009*IT_0283;
    ...
    const ccomplex_t IT_0298 = IT_0089*IT_0297;
    ...
    const ccomplex_t IT_0306 = conj(N_d4)*e_em*m_tau*IT_0010*U_stau_11;
    ...
    const ccomplex_t IT_0311 = 2*U_stau_00*((IT_0006*IT_0008*IT_0010*IT_0016
      *IT_0025 + (-0.5)*m_W*IT_0094*(IT_0008 + -IT_0007*IT_0095))*conj(U_stau_01
      ) + 1./2*IT_0006*IT_0008*IT_0021*IT_0090*conj(U_stau_11)) + U_stau_10*
      (IT_0006*IT_0008*IT_0021*IT_0090*conj(U_stau_01) + 2*(IT_0006*IT_0008
      *IT_0010*IT_0016*IT_0025 + -m_W*IT_0007*IT_0094*IT_0095)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0315 = IT_0102*IT_0314;
    ...
    const ccomplex_t IT_0326 = conj(N_d1)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0334 = m_N_4*IT_0232;
    const ccomplex_t IT_0335 = m_N_3*IT_0254;
    ...
    const ccomplex_t IT_0343 = conj(N_d3)*e_em*m_tau*IT_0010*U_stau_10;
    const ccomplex_t IT_0344 = IT_0009*IT_0343;
    ...
    const ccomplex_t IT_0348 = IT_0209*IT_0347;
    const ccomplex_t IT_0349 = (0 + _Complex_I*1)*IT_0348;
    const ccomplex_t IT_0350 = IT_0336*IT_0349;
    const ccomplex_t IT_0351 = 0.5*IT_0272 + -IT_0276 + 0.5*IT_0293 + 0.5
    ...
    const ccomplex_t IT_0355 = IT_0164*IT_0332;
    const ccomplex_t IT_0356 = IT_0047*IT_0289;
    const ccomplex_t IT_0357 = IT_0232*IT_0349;
    const ccomplex_t IT_0358 = IT_0126*IT_0271;
    const ccomplex_t IT_0359 = 0.5*IT_0087 + (-0.5)*IT_0355 + (-0.5)*IT_0356 +
       (-0.5)*IT_0357 + (-0.5)*IT_0358;
    const ccomplex_t IT_0360 = s_14*m_tau;
    const ccomplex_t IT_0361 = IT_0137*IT_0142;
    const ccomplex_t IT_0362 = IT_0186*IT_0199;
    const ccomplex_t IT_0363 = IT_0020*IT_0069;
    const ccomplex_t IT_0364 = IT_0211*IT_0254;
