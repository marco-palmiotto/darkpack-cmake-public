        ...
        )
{
    ...
    const ccomplex_t IT_0004 = conj(N_u4)*e_em*conj(V_Wp1);
    ...
    const ccomplex_t IT_0010 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0011 = IT_0009*IT_0010;
    const ccomplex_t IT_0012 = 1.4142135623731*IT_0011;
    const ccomplex_t IT_0013 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0035 = cpow(s_23 + (-0.5)*IT_0031 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0036 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0037 = IT_0002*IT_0036;
    const ccomplex_t IT_0038 = conj(U_d2)*e_em*m_tau*IT_0024*U_stau_11;
    ...
    const ccomplex_t IT_0042 = conj(N_B4)*conj(V_u2)*e_em;
    const ccomplex_t IT_0043 = IT_0009*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = conj(N_W4)*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0049 = conj(N_u4)*e_em*conj(V_Wp2);
    ...
    const ccomplex_t IT_0056 = IT_0034*IT_0035*IT_0055;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(A_tau*IT_0065*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0002*(m_W*IT_0000*IT_0065*U_stau_01 + (-0.5)
      *m_tau*IT_0024*(m_tau*IT_0022*IT_0065*U_stau_01 + mu_h*U_stau_11)));
    ...
    const ccomplex_t IT_0074 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0075 = IT_0008*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*IT_0075;
    const ccomplex_t IT_0077 = N_d4*e_em*m_tau*IT_0024*U_stau_01;
    ...
    const ccomplex_t IT_0087 = m_N_4*IT_0086;
    const ccomplex_t IT_0088 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0089 = IT_0008*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0092 = IT_0002*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = conj(N_d4)*e_em*m_tau*IT_0024*U_stau_11;
