...
ccomplex_return_t c_sumSqAmpl_N_4_stau_2_to_nu_tau_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow(IT_0013, -1);
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*(A_tau*IT_0012*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0006*(m_W*IT_0012*IT_0013*U_stau_01 + (-0.5)
      *m_tau*IT_0014*(m_tau*IT_0012*IT_0015*U_stau_01 + mu_h*U_stau_11)));
    const ccomplex_t IT_0017 = IT_0011*IT_0016;
    const ccomplex_t IT_0018 = pow(m_N_4, 2);
    const ccomplex_t IT_0019 = cpow(s_13 + (-0.5)*IT_0018 + (-0.5)*reg_prop +
       0.5*m_snu_tau*(m_snu_tau + (0 + _Complex_I*-1)*Gamma_nutaul), -1);
    const ccomplex_t IT_0020 = IT_0017*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*IT_0020;
    const ccomplex_t IT_0022 = IT_0006*IT_0013;
    const ccomplex_t IT_0023 = conj(N_u4)*e_em*conj(V_Wp1);
    const ccomplex_t IT_0024 = IT_0022*IT_0023;
    const ccomplex_t IT_0025 = 2*IT_0024;
    const ccomplex_t IT_0026 = IT_0001*IT_0013;
    const ccomplex_t IT_0027 = conj(N_B4)*conj(V_u1)*e_em;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = 1.4142135623731*IT_0028;
    const ccomplex_t IT_0030 = conj(N_W4)*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0037 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0038 = IT_0006*IT_0037;
    const ccomplex_t IT_0039 = IT_0006*IT_0015;
    const ccomplex_t IT_0040 = conj(U_d1)*e_em*m_tau*IT_0014*U_stau_11;
    ...
    const ccomplex_t IT_0050 = cpow(s_12 + 0.5*IT_0018 + 0.5*IT_0046 + (-0.5)
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0006*IT_0012*IT_0014*IT_0015;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0055 = IT_0001*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0058 = IT_0006*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = conj(N_d4)*e_em*m_tau*IT_0014*U_stau_11;
    ...
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0068 = cpow(s_23 + (-0.5)*IT_0046 + 0.5*m_C_2*(m_C_2 +
       (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0069 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0070 = IT_0006*IT_0069;
    const ccomplex_t IT_0071 = conj(U_d2)*e_em*m_tau*IT_0014*U_stau_11;
    const ccomplex_t IT_0072 = IT_0039*IT_0071;
    ...
    const ccomplex_t IT_0090 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0091 = IT_0001*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = N_d4*e_em*m_tau*IT_0014*U_stau_01;
    ...
    const ccomplex_t IT_0102 = 0.5*IT_0021 + (-0.5)*IT_0048 + (-0.5)*IT_0066 +
       (-0.5)*IT_0089 + 0.5*IT_0101;
    const ccomplex_t IT_0103 = IT_0006*IT_0012;
    const ccomplex_t IT_0104 = N_d4*e_em*U_Wm2;
    const ccomplex_t IT_0105 = IT_0103*IT_0104;
    const ccomplex_t IT_0106 = (-2)*IT_0105;
    const ccomplex_t IT_0107 = IT_0001*IT_0012;
    const ccomplex_t IT_0108 = N_B4*U_d2*e_em;
    const ccomplex_t IT_0109 = IT_0107*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = N_W4*U_d2*e_em;
    ...
    const ccomplex_t IT_0118 = IT_0074*IT_0117;
    ...
    const ccomplex_t IT_0138 = s_23*m_N_4;
    const ccomplex_t IT_0139 = s_12*s_23;
    const ccomplex_t IT_0140 = s_13*IT_0046;
