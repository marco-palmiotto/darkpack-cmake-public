        ...
        )
{
    ...
    const ccomplex_t IT_0002 = conj(N_W4)*e_em*U_Wm1;
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = conj(N_d4)*U_d1*e_em;
    ...
    const ccomplex_t IT_0044 = N_W4*e_em*conj(V_Wp2);
    const ccomplex_t IT_0045 = IT_0001*IT_0044;
    const ccomplex_t IT_0046 = N_u4*conj(V_u2)*e_em;
    ...
    const ccomplex_t IT_0054 = N_W4*e_em*conj(V_Wp1);
    const ccomplex_t IT_0055 = IT_0001*IT_0054;
    const ccomplex_t IT_0056 = N_u4*conj(V_u1)*e_em;
    ...
    const ccomplex_t IT_0072 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = N_d4*e_em*m_tau*IT_0014*U_stau_01;
    ...
    const ccomplex_t IT_0085 = m_N_4*IT_0083*IT_0084;
    ...
    const ccomplex_t IT_0106 = conj(N_d4)*e_em*m_tau*IT_0014*U_stau_11;
