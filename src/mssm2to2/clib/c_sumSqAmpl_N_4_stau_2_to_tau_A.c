        ...
        )
{
    ...
    const ccomplex_t IT_0008 = N_B4*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0017 = N_d4*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0039 = conj(N_d4)*e_em*m_tau*IT_0016*U_stau_11;
