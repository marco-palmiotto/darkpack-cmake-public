        ...
        )
{
    ...
    const ccomplex_t IT_0037 = N_d4*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0060 = pow(m_N_4, 2);
    ...
    const ccomplex_t IT_0148 = conj(N_W2)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0154 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0155 = IT_0012*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0162 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0163 = IT_0002*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = N_d4*e_em*m_tau*IT_0036*U_stau_00;
    ...
    const ccomplex_t IT_0185 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0186 = IT_0002*IT_0185;
    const ccomplex_t IT_0187 = 1.4142135623731*IT_0186;
    const ccomplex_t IT_0188 = N_d3*e_em*m_tau*IT_0036*U_stau_01;
    ...
    const ccomplex_t IT_0310 = m_N_4*IT_0212;
    const ccomplex_t IT_0311 = m_N_3*IT_0230;
    ...
    const ccomplex_t IT_0319 = m_N_4*m_tau;
