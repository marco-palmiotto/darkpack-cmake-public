...
ccomplex_return_t c_sumSqAmpl_N_4_stau_2_to_tau_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = N_B4*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0018 = N_d4*e_em*m_tau*IT_0004*U_stau_01;
    ...
    const ccomplex_t IT_0032 = IT_0005*IT_0007;
    const ccomplex_t IT_0033 = IT_0031 + IT_0032;
    const ccomplex_t IT_0034 = cpow(IT_0012, -2);
    const ccomplex_t IT_0035 = (-2)*U_stau_01*((IT_0001*IT_0004*IT_0006
      *IT_0007*IT_0009 + (-0.5)*m_W*IT_0033*(IT_0009 + -IT_0008*IT_0034))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0009*IT_0028*IT_0029*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0009*IT_0028*IT_0029*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0004*IT_0006*IT_0007*IT_0009 + -m_W*IT_0008*IT_0033*IT_0034)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0041 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0042 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0043 = IT_0013*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = N_d4*e_em*m_tau*IT_0004*U_stau_00;
    ...
    const ccomplex_t IT_0052 = (-2)*conj(U_stau_00)*((IT_0001*IT_0004*IT_0006
    ...
    const ccomplex_t IT_0058 = IT_0007*IT_0013;
    const ccomplex_t IT_0059 = N_B4*N_d4*e_em;
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = IT_0013*IT_0029;
    const ccomplex_t IT_0062 = N_B4*N_u4*e_em;
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = IT_0007*IT_0009;
    const ccomplex_t IT_0065 = N_W4*N_d4*e_em;
    ...
    const ccomplex_t IT_0072 = conj(N_B4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0073 = IT_0058*IT_0072;
    const ccomplex_t IT_0074 = conj(N_B4)*conj(N_u4)*e_em;
    const ccomplex_t IT_0075 = IT_0061*IT_0074;
    const ccomplex_t IT_0076 = conj(N_W4)*conj(N_d4)*e_em;
    const ccomplex_t IT_0077 = IT_0064*IT_0076;
    const ccomplex_t IT_0078 = conj(N_W4)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0083 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0002 +
    ...
    const ccomplex_t IT_0103 = IT_0064*IT_0102;
    ...
    const ccomplex_t IT_0111 = conj(N_W1)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0115 = conj(N_W4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0116 = IT_0067*IT_0115;
    const ccomplex_t IT_0117 = IT_0110 + IT_0112 + IT_0114 + IT_0116;
    const ccomplex_t IT_0118 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0119 = IT_0061*IT_0118;
    const ccomplex_t IT_0120 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0121 = IT_0064*IT_0120;
    const ccomplex_t IT_0122 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0123 = IT_0061*IT_0122;
    const ccomplex_t IT_0124 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0132 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0133 = IT_0013*IT_0132;
    const ccomplex_t IT_0134 = 1.4142135623731*IT_0133;
    const ccomplex_t IT_0135 = N_d1*e_em*m_tau*IT_0004*U_stau_01;
    ...
    const ccomplex_t IT_0144 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0145 = IT_0013*IT_0144;
    const ccomplex_t IT_0146 = 1.4142135623731*IT_0145;
    const ccomplex_t IT_0147 = N_d2*e_em*m_tau*IT_0004*U_stau_01;
    ...
    const ccomplex_t IT_0152 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0002 +
    ...
    const ccomplex_t IT_0155 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0156 = IT_0058*IT_0155;
    const ccomplex_t IT_0157 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0158 = IT_0067*IT_0157;
    const ccomplex_t IT_0159 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0160 = IT_0058*IT_0159;
    const ccomplex_t IT_0161 = N_W2*N_u4*e_em;
    ...
    const ccomplex_t IT_0165 = IT_0061*IT_0164;
    const ccomplex_t IT_0166 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0167 = IT_0064*IT_0166;
    const ccomplex_t IT_0168 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0169 = IT_0061*IT_0168;
    const ccomplex_t IT_0170 = N_W2*N_d4*e_em;
    const ccomplex_t IT_0171 = IT_0064*IT_0170;
    ...
    const ccomplex_t IT_0177 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0178 = IT_0058*IT_0177;
    const ccomplex_t IT_0179 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0180 = IT_0067*IT_0179;
    const ccomplex_t IT_0181 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0182 = IT_0058*IT_0181;
    const ccomplex_t IT_0183 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0184 = IT_0067*IT_0183;
    const ccomplex_t IT_0185 = IT_0178 + IT_0180 + IT_0182 + IT_0184;
    const ccomplex_t IT_0186 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0187 = IT_0061*IT_0186;
    const ccomplex_t IT_0188 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0189 = IT_0064*IT_0188;
    const ccomplex_t IT_0190 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0191 = IT_0061*IT_0190;
    const ccomplex_t IT_0192 = conj(N_W4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0193 = IT_0064*IT_0192;
    ...
    const ccomplex_t IT_0201 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0202 = IT_0013*IT_0201;
    const ccomplex_t IT_0203 = 1.4142135623731*IT_0202;
    const ccomplex_t IT_0204 = N_d3*e_em*m_tau*IT_0004*U_stau_01;
    ...
    const ccomplex_t IT_0209 = cpow(s_23 + (-0.5)*IT_0001 + (-0.5)*IT_0002 +
    ...
    const ccomplex_t IT_0213 = IT_0058*IT_0212;
    ...
    const ccomplex_t IT_0241 = IT_0067*IT_0240;
    const ccomplex_t IT_0242 = IT_0235 + IT_0237 + IT_0239 + IT_0241;
    const ccomplex_t IT_0243 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0244 = IT_0061*IT_0243;
    const ccomplex_t IT_0245 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0246 = IT_0064*IT_0245;
    const ccomplex_t IT_0247 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0273 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0274 = IT_0013*IT_0273;
    const ccomplex_t IT_0275 = 1.4142135623731*IT_0274;
    const ccomplex_t IT_0276 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0277 = IT_0009*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_d2)*e_em*m_tau*IT_0004*U_stau_11;
    const ccomplex_t IT_0280 = IT_0017*IT_0279;
    ...
    const ccomplex_t IT_0284 = IT_0152*IT_0283;
    const ccomplex_t IT_0285 = (0 + _Complex_I*1)*IT_0284;
    const ccomplex_t IT_0286 = m_N_4*IT_0175;
    const ccomplex_t IT_0287 = m_N_2*IT_0197;
    const ccomplex_t IT_0288 = IT_0286 + IT_0287;
    const ccomplex_t IT_0289 = IT_0285*IT_0288;
    const ccomplex_t IT_0290 = IT_0011*IT_0269;
    const ccomplex_t IT_0291 = IT_0003*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*IT_0291;
    const ccomplex_t IT_0293 = m_tau*IT_0292;
    const ccomplex_t IT_0294 = (-2)*U_stau_01*((IT_0001*IT_0004*IT_0006
      *IT_0007*IT_0009 + (-0.5)*m_W*IT_0033*(IT_0009 + -IT_0008*IT_0034))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0009*IT_0028*IT_0029*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0009*IT_0028*IT_0029*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0004*IT_0006*IT_0007*IT_0009 + -m_W*IT_0008*IT_0033*IT_0034)
    ...
    const ccomplex_t IT_0297 = IT_0269*IT_0296;
    ...
    const ccomplex_t IT_0306 = conj(N_d4)*e_em*m_tau*IT_0004*U_stau_10;
    const ccomplex_t IT_0307 = IT_0017*IT_0306;
    ...
    const ccomplex_t IT_0311 = (-2)*conj(U_stau_00)*((IT_0001*IT_0004*IT_0006
      *IT_0007*IT_0009 + (-0.5)*m_W*IT_0033*(IT_0009 + -IT_0008*IT_0034))
      *U_stau_01 + -1./2*IT_0006*IT_0009*IT_0028*IT_0029*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0009*IT_0028*IT_0029*U_stau_01 + (-2)*(IT_0001
      *IT_0004*IT_0006*IT_0007*IT_0009 + -m_W*IT_0008*IT_0033*IT_0034)*U_stau_11);
    ...
    const ccomplex_t IT_0328 = IT_0140*IT_0327;
    const ccomplex_t IT_0329 = (0 + _Complex_I*1)*IT_0328;
    const ccomplex_t IT_0330 = m_N_4*IT_0107;
    const ccomplex_t IT_0331 = m_N_1*IT_0129;
    const ccomplex_t IT_0332 = IT_0330 + IT_0331;
    const ccomplex_t IT_0333 = IT_0329*IT_0332;
    const ccomplex_t IT_0334 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0335 = IT_0013*IT_0334;
    const ccomplex_t IT_0336 = 1.4142135623731*IT_0335;
    const ccomplex_t IT_0337 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0338 = IT_0009*IT_0337;
    const ccomplex_t IT_0339 = 1.4142135623731*IT_0338;
    const ccomplex_t IT_0340 = conj(N_d3)*e_em*m_tau*IT_0004*U_stau_11;
    ...
    const ccomplex_t IT_0345 = IT_0209*IT_0344;
    const ccomplex_t IT_0346 = (0 + _Complex_I*1)*IT_0345;
    const ccomplex_t IT_0347 = m_N_4*IT_0232;
    const ccomplex_t IT_0348 = m_N_3*IT_0254;
    const ccomplex_t IT_0349 = IT_0347 + IT_0348;
    const ccomplex_t IT_0350 = IT_0346*IT_0349;
    const ccomplex_t IT_0351 = 0.5*IT_0272 + 0.5*IT_0289 + -IT_0293 + 0.5
    ...
    const ccomplex_t IT_0355 = IT_0070*IT_0271;
    const ccomplex_t IT_0356 = IT_0232*IT_0346;
    const ccomplex_t IT_0357 = IT_0107*IT_0329;
    const ccomplex_t IT_0358 = IT_0175*IT_0285;
    const ccomplex_t IT_0359 = 0.5*IT_0025 + (-0.5)*IT_0355 + (-0.5)*IT_0356 +
       (-0.5)*IT_0357 + (-0.5)*IT_0358;
    const ccomplex_t IT_0360 = s_14*m_tau;
    const ccomplex_t IT_0361 = IT_0211*IT_0254;
    const ccomplex_t IT_0362 = IT_0080*IT_0085;
    const ccomplex_t IT_0363 = IT_0129*IT_0142;
    const ccomplex_t IT_0364 = IT_0154*IT_0197;
    const ccomplex_t IT_0365 = (-0.5)*IT_0292 + 0.5*IT_0361 + 0.5*IT_0362 +
    ...
    const ccomplex_t IT_0369 = pow(m_H0, 2);
