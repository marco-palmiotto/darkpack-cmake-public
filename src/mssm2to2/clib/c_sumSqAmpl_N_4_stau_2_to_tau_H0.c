        ...
        )
{
    ...
    const ccomplex_t IT_0031 = N_B4*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0038 = N_d4*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0050 = cpow(s_13 + (-0.5)*IT_0043 + (-0.5)*IT_0049 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0051 = mu_h*m_tau*IT_0037;
    const ccomplex_t IT_0052 = sin(beta);
    const ccomplex_t IT_0053 = -IT_0006*IT_0052;
    const ccomplex_t IT_0054 = IT_0000*IT_0034;
    const ccomplex_t IT_0055 = IT_0053 + IT_0054;
    const ccomplex_t IT_0056 = cpow(IT_0001, -2);
    const ccomplex_t IT_0057 = (-2)*U_stau_01*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0055*(IT_0011 + -IT_0010*IT_0056))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0011*IT_0035*IT_0051*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0011*IT_0035*IT_0051*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0055*IT_0056)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0063 = cpow(s_13 + (-0.5)*IT_0043 + (-0.5)*IT_0049 + (
    ...
    const ccomplex_t IT_0067 = N_d4*e_em*m_tau*IT_0037*U_stau_00;
    ...
    const ccomplex_t IT_0072 = (-2)*conj(U_stau_00)*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0055*(IT_0011 + -IT_0010*IT_0056))
      *U_stau_01 + -1./2*IT_0006*IT_0011*IT_0035*IT_0051*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0011*IT_0035*IT_0051*U_stau_01 + (-2)*(IT_0000
      *IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0055*IT_0056)*U_stau_11);
    ...
    const ccomplex_t IT_0109 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0110 = IT_0007*IT_0109;
    const ccomplex_t IT_0111 = conj(N_W1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0112 = IT_0012*IT_0111;
    const ccomplex_t IT_0113 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0114 = IT_0007*IT_0113;
    const ccomplex_t IT_0115 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0123 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0124 = IT_0002*IT_0123;
    const ccomplex_t IT_0125 = 1.4142135623731*IT_0124;
    const ccomplex_t IT_0126 = N_d1*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0131 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0135 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0136 = IT_0002*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = N_d2*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0143 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0155 = conj(N_B2)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0159 = conj(N_B4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0191 = IT_0145*IT_0190;
    const ccomplex_t IT_0192 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0193 = IT_0002*IT_0192;
    const ccomplex_t IT_0194 = 1.4142135623731*IT_0193;
    const ccomplex_t IT_0195 = N_d3*e_em*m_tau*IT_0037*U_stau_01;
    ...
    const ccomplex_t IT_0200 = cpow(s_23 + (-0.5)*IT_0043 + (-0.5)*IT_0044 +
    ...
    const ccomplex_t IT_0230 = IT_0003*IT_0229;
    ...
    const ccomplex_t IT_0235 = IT_0007*IT_0234;
    const ccomplex_t IT_0236 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0237 = IT_0012*IT_0236;
    ...
    const ccomplex_t IT_0249 = cpow(s_12 + (-0.5)*IT_0043 + 0.5*IT_0044 + 0.5
      *IT_0049 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0250 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0011
      *IT_0035*IT_0037;
    const ccomplex_t IT_0251 = (-0.5)*IT_0250;
    const ccomplex_t IT_0252 = IT_0042*IT_0251;
    ...
    const ccomplex_t IT_0268 = IT_0045*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0030*IT_0269;
    const ccomplex_t IT_0271 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0272 = IT_0002*IT_0271;
    const ccomplex_t IT_0273 = 1.4142135623731*IT_0272;
    const ccomplex_t IT_0274 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0275 = IT_0011*IT_0274;
    const ccomplex_t IT_0276 = 1.4142135623731*IT_0275;
    const ccomplex_t IT_0277 = conj(N_d1)*e_em*m_tau*IT_0037*U_stau_11;
    const ccomplex_t IT_0278 = IT_0036*IT_0277;
    ...
    const ccomplex_t IT_0284 = m_N_4*IT_0098;
    const ccomplex_t IT_0285 = m_N_1*IT_0120;
    const ccomplex_t IT_0286 = IT_0284 + IT_0285;
    const ccomplex_t IT_0287 = IT_0283*IT_0286;
    const ccomplex_t IT_0288 = (-2)*U_stau_01*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0055*(IT_0011 + -IT_0010*IT_0056))*conj
      (U_stau_01) + -1./2*IT_0006*IT_0011*IT_0035*IT_0051*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0011*IT_0035*IT_0051*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0055*IT_0056)
    ...
    const ccomplex_t IT_0305 = (-2)*conj(U_stau_00)*((IT_0000*IT_0011*IT_0035
      *IT_0037*IT_0043 + (-0.5)*m_W*IT_0055*(IT_0011 + -IT_0010*IT_0056))
      *U_stau_01 + -1./2*IT_0006*IT_0011*IT_0035*IT_0051*U_stau_11) + conj
      (U_stau_10)*(IT_0006*IT_0011*IT_0035*IT_0051*U_stau_01 + (-2)*(IT_0000
      *IT_0011*IT_0035*IT_0037*IT_0043 + -m_W*IT_0010*IT_0055*IT_0056)*U_stau_11);
    ...
    const ccomplex_t IT_0309 = IT_0063*IT_0308;
    const ccomplex_t IT_0310 = (0 + _Complex_I*1)*IT_0309;
    const ccomplex_t IT_0311 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0312 = IT_0002*IT_0311;
    const ccomplex_t IT_0313 = 1.4142135623731*IT_0312;
    const ccomplex_t IT_0314 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0315 = IT_0011*IT_0314;
    const ccomplex_t IT_0316 = 1.4142135623731*IT_0315;
    const ccomplex_t IT_0317 = conj(N_d2)*e_em*m_tau*IT_0037*U_stau_11;
    const ccomplex_t IT_0318 = IT_0036*IT_0317;
    ...
    const ccomplex_t IT_0322 = IT_0143*IT_0321;
    const ccomplex_t IT_0323 = (0 + _Complex_I*1)*IT_0322;
    const ccomplex_t IT_0324 = m_N_4*IT_0188;
    const ccomplex_t IT_0325 = m_N_2*IT_0166;
    const ccomplex_t IT_0326 = IT_0324 + IT_0325;
    const ccomplex_t IT_0327 = IT_0323*IT_0326;
    const ccomplex_t IT_0328 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0329 = IT_0002*IT_0328;
    const ccomplex_t IT_0330 = 1.4142135623731*IT_0329;
    const ccomplex_t IT_0331 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0332 = IT_0011*IT_0331;
    const ccomplex_t IT_0333 = 1.4142135623731*IT_0332;
    const ccomplex_t IT_0334 = conj(N_d3)*e_em*m_tau*IT_0037*U_stau_11;
    const ccomplex_t IT_0335 = IT_0036*IT_0334;
    ...
    const ccomplex_t IT_0341 = m_N_4*IT_0223;
    const ccomplex_t IT_0342 = m_N_3*IT_0245;
    ...
    const ccomplex_t IT_0349 = 0.5*IT_0270 + 0.5*IT_0287 + 0.5*IT_0293 + 0.5
    ...
    const ccomplex_t IT_0353 = IT_0098*IT_0283;
    const ccomplex_t IT_0354 = IT_0223*IT_0340;
    const ccomplex_t IT_0355 = IT_0188*IT_0323;
    const ccomplex_t IT_0356 = IT_0018*IT_0269;
    ...
    const ccomplex_t IT_0360 = IT_0145*IT_0166;
    const ccomplex_t IT_0361 = IT_0202*IT_0245;
    const ccomplex_t IT_0362 = IT_0120*IT_0133;
