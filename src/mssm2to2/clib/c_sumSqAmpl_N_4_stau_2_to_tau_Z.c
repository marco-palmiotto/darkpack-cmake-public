        ...
        )
{
    ...
    const ccomplex_t IT_0021 = N_B4*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0028 = N_d4*e_em*m_tau*IT_0027*U_stau_01;
    ...
    const ccomplex_t IT_0042 = IT_0014*IT_0040;
    ...
    const ccomplex_t IT_0051 = N_d1*e_em*m_tau*IT_0027*U_stau_01;
    ...
    const ccomplex_t IT_0056 = cpow(s_23 + (-0.5)*IT_0033 + (-0.5)*IT_0034 +
    ...
    const ccomplex_t IT_0060 = 0.5*IT_0019;
    ...
    const ccomplex_t IT_0078 = cpow(s_23 + (-0.5)*IT_0033 + (-0.5)*IT_0034 +
    ...
    const ccomplex_t IT_0090 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0091 = IT_0008*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = N_d3*e_em*m_tau*IT_0027*U_stau_01;
    ...
    const ccomplex_t IT_0102 = 0.5*IT_0059 + 0.25*IT_0061 + 0.5*IT_0081 + 0.5
      *IT_0101;
    const ccomplex_t IT_0103 = pow(m_N_4, 2);
    ...
    const ccomplex_t IT_0111 = conj(IT_0039) + IT_0110;
    ...
    const ccomplex_t IT_0138 = IT_0014*IT_0136;
    ...
    const ccomplex_t IT_0150 = conj(N_d1)*e_em*m_tau*IT_0027*U_stau_11;
    ...
    const ccomplex_t IT_0158 = N_u2*conj(N_u4)*e_em;
    const ccomplex_t IT_0159 = IT_0010*IT_0158;
    const ccomplex_t IT_0160 = IT_0014*IT_0158;
    const ccomplex_t IT_0161 = N_d2*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0180 = N_u3*conj(N_u4)*e_em;
    const ccomplex_t IT_0181 = IT_0010*IT_0180;
    const ccomplex_t IT_0182 = IT_0014*IT_0180;
    const ccomplex_t IT_0183 = N_d3*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0199 = IT_0098*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*IT_0199;
    const ccomplex_t IT_0201 = IT_0187*IT_0200;
    const ccomplex_t IT_0202 = (-0.25)*IT_0135 + (-0.5)*IT_0157 + (-0.5)
      *IT_0179 + (-0.5)*IT_0201;
    const ccomplex_t IT_0203 = IT_0134 + -IT_0202;
    const ccomplex_t IT_0204 = conj(IT_0134) + -conj(IT_0202);
    ...
    const ccomplex_t IT_0210 = m_N_4*m_tau;
    ...
    const ccomplex_t IT_0216 = 0.5*IT_0135 + IT_0157 + IT_0179 + IT_0201;
    const ccomplex_t IT_0217 = -IT_0059 + (-0.5)*IT_0061 + -IT_0081 + -IT_0101;
    ...
    const ccomplex_t IT_0227 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0228 = IT_0008*IT_0227;
    const ccomplex_t IT_0229 = 1.4142135623731*IT_0228;
    const ccomplex_t IT_0230 = N_d4*e_em*m_tau*IT_0027*U_stau_00;
    ...
    const ccomplex_t IT_0239 = (-0.5)*IT_0038 + (-0.5)*IT_0224 + (-0.5)*IT_0238;
    ...
    const ccomplex_t IT_0262 = 0.5*IT_0133 + 0.5*IT_0247 + 0.5*IT_0261;
    ...
    const ccomplex_t IT_0281 = m_N_4*IT_0271;
    const ccomplex_t IT_0282 = m_N_4*IT_0020;
    const ccomplex_t IT_0283 = m_N_4*IT_0060;
    const ccomplex_t IT_0284 = -IT_0283;
    const ccomplex_t IT_0285 = IT_0282 + IT_0284;
    const ccomplex_t IT_0286 = IT_0037*IT_0285;
    const ccomplex_t IT_0287 = m_N_1*IT_0143;
    const ccomplex_t IT_0288 = m_N_4*IT_0047;
    const ccomplex_t IT_0289 = -IT_0288;
    const ccomplex_t IT_0290 = IT_0287 + IT_0289;
    const ccomplex_t IT_0291 = IT_0058*IT_0290;
    const ccomplex_t IT_0292 = m_N_3*IT_0187;
    const ccomplex_t IT_0293 = m_N_4*IT_0089;
    const ccomplex_t IT_0294 = -IT_0293;
    const ccomplex_t IT_0295 = IT_0292 + IT_0294;
    const ccomplex_t IT_0296 = IT_0100*IT_0295;
    const ccomplex_t IT_0297 = m_N_2*IT_0165;
    const ccomplex_t IT_0298 = m_N_4*IT_0069;
    const ccomplex_t IT_0299 = -IT_0298;
    const ccomplex_t IT_0300 = IT_0297 + IT_0299;
    const ccomplex_t IT_0301 = IT_0080*IT_0300;
    const ccomplex_t IT_0302 = 0.25*IT_0286 + 0.5*IT_0291 + 0.5*IT_0296 + 0.5
      *IT_0301;
    const ccomplex_t IT_0303 = (0 + _Complex_I*1)*m_tau;
    const ccomplex_t IT_0304 = IT_0105*IT_0126;
    const ccomplex_t IT_0305 = IT_0104*IT_0303*IT_0304;
    const ccomplex_t IT_0306 = m_tau*IT_0129;
    const ccomplex_t IT_0307 = 0.25*IT_0286 + (-0.5)*IT_0305 + 0.5*IT_0306;
    const ccomplex_t IT_0308 = conj(IT_0302) + conj(IT_0307);
    const ccomplex_t IT_0309 = IT_0302 + IT_0307;
    const ccomplex_t IT_0310 = IT_0132*IT_0285;
    const ccomplex_t IT_0311 = m_N_1*IT_0047;
    const ccomplex_t IT_0312 = m_N_4*IT_0143;
    const ccomplex_t IT_0313 = -IT_0312;
    const ccomplex_t IT_0314 = IT_0311 + IT_0313;
    const ccomplex_t IT_0315 = IT_0156*IT_0314;
    const ccomplex_t IT_0316 = m_N_2*IT_0069;
    const ccomplex_t IT_0317 = m_N_4*IT_0165;
    const ccomplex_t IT_0318 = -IT_0317;
    const ccomplex_t IT_0319 = IT_0316 + IT_0318;
    const ccomplex_t IT_0320 = IT_0178*IT_0319;
    const ccomplex_t IT_0321 = m_N_3*IT_0089;
    const ccomplex_t IT_0322 = m_N_4*IT_0187;
    const ccomplex_t IT_0323 = -IT_0322;
    const ccomplex_t IT_0324 = IT_0321 + IT_0323;
    const ccomplex_t IT_0325 = IT_0200*IT_0324;
    const ccomplex_t IT_0326 = 0.25*IT_0310 + (-0.5)*IT_0315 + (-0.5)*IT_0320 
      + (-0.5)*IT_0325;
    const ccomplex_t IT_0327 = IT_0032*IT_0115;
    const ccomplex_t IT_0328 = IT_0104*IT_0303*IT_0327;
    const ccomplex_t IT_0329 = m_tau*IT_0108;
    const ccomplex_t IT_0330 = 0.25*IT_0310 + 0.5*IT_0328 + (-0.5)*IT_0329;
    const ccomplex_t IT_0331 = conj(IT_0326) + conj(IT_0330);
    const ccomplex_t IT_0332 = IT_0326 + IT_0330;
    ...
    const ccomplex_t IT_0339 = conj(IT_0130) + conj(IT_0202);
    const ccomplex_t IT_0340 = IT_0130 + IT_0202;
    ...
    const ccomplex_t IT_0400 = m_N_4*IT_0394;
    ...
    const ccomplex_t IT_0406 = 4*IT_0326;
    const ccomplex_t IT_0407 = (-6)*conj(IT_0302);
    const ccomplex_t IT_0408 = IT_0210*IT_0271;
    const ccomplex_t IT_0409 = (-2)*IT_0273;
    const ccomplex_t IT_0410 = (-2)*conj(IT_0273);
    const ccomplex_t IT_0411 = s_13*IT_0214;
    ...
    const ccomplex_t IT_0430 = (-2)*IT_0202;
    const ccomplex_t IT_0431 = (-2)*conj(IT_0202);
    const ccomplex_t IT_0432 = conj(IT_0102)*IT_0202 + IT_0102*conj(IT_0202) +
       0.5*conj(IT_0134)*IT_0424 + 0.5*IT_0134*IT_0427 + 0.5*conj(IT_0130)
      *IT_0428 + 0.5*IT_0130*IT_0429 + 0.5*conj(IT_0039)*IT_0430 + 0.5*IT_0039
      *IT_0431;
    const ccomplex_t IT_0433 = 3*IT_0420;
    const ccomplex_t IT_0434 = (-8)*IT_0006*((IT_0039 + -IT_0102)*conj(IT_0109
      ) + IT_0109*IT_0111 + conj(IT_0130)*IT_0203 + IT_0130*IT_0204) + (-4)*
      (IT_0109*conj(IT_0109) + (IT_0039 + -IT_0102)*IT_0111 + IT_0130*conj
      ...
      *IT_0280) + IT_0281*(IT_0241*IT_0308 + IT_0244*IT_0309 + IT_0277*IT_0331 +
       IT_0280*IT_0332) + IT_0336*(conj(IT_0039)*IT_0265 + IT_0039*IT_0268 +
       IT_0241*IT_0337 + IT_0244*IT_0338 + IT_0277*IT_0339 + IT_0280*IT_0340 +
       conj(IT_0134)*IT_0343 + IT_0134*IT_0346) + IT_0352*(conj(IT_0130)*IT_0355
       + IT_0130*IT_0358 + conj(IT_0109)*IT_0361 + IT_0109*IT_0364) + (conj
      (IT_0109)*IT_0355 + IT_0109*IT_0358 + conj(IT_0130)*IT_0361 + IT_0130
      *IT_0364)*IT_0370 + IT_0374*(conj(IT_0134)*IT_0355 + IT_0134*IT_0358 +
       conj(IT_0039)*IT_0361 + IT_0039*IT_0364 + conj(IT_0202)*IT_0377 + IT_0202
      *IT_0380 + conj(IT_0102)*IT_0383 + IT_0102*IT_0386) + (conj(IT_0039)
      *IT_0355 + IT_0039*IT_0358 + conj(IT_0134)*IT_0361 + IT_0134*IT_0364 +
       conj(IT_0102)*IT_0377 + IT_0102*IT_0380 + conj(IT_0202)*IT_0383 + IT_0202
      ...
      *IT_0407)) + IT_0408*(IT_0244*IT_0274 + IT_0241*conj(IT_0274) + conj
      (IT_0216)*IT_0396 + IT_0216*IT_0397 + conj(IT_0262)*IT_0409 + IT_0262
      *IT_0410) + (conj(IT_0217)*IT_0218 + conj(IT_0239)*IT_0265 + IT_0239
      *IT_0267 + conj(IT_0216)*IT_0275 + conj(IT_0262)*IT_0343 + IT_0262*IT_0345
       ...
       IT_0340*IT_0401 + conj(IT_0039)*IT_0409 + IT_0039*IT_0410 + conj(IT_0134)
      *IT_0416 + IT_0134*IT_0417) + (IT_0265*IT_0331 + IT_0268*IT_0332 + conj
      (IT_0307)*IT_0343 + IT_0307*IT_0346 + conj(IT_0262)*IT_0353 + IT_0262
      *IT_0356 + conj(IT_0216)*IT_0375 + IT_0216*IT_0378)*IT_0418 + (conj
      (IT_0274)*IT_0375 + IT_0274*IT_0378 + IT_0331*IT_0409 + IT_0332*IT_0410 +
       conj(IT_0307)*IT_0416 + IT_0307*IT_0417)*IT_0419 + 2*IT_0421*IT_0432 + 
      (conj(IT_0130)*IT_0424 + IT_0130*IT_0427 + conj(IT_0134)*IT_0428 + IT_0134
