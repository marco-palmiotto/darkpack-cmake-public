...
ccomplex_return_t c_sumSqAmpl_N_4_stau_2_to_tau_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0033 = N_B4*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0040 = N_d4*e_em*m_tau*IT_0039*U_stau_01;
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*e_em*m_tau*IT_0006*IT_0011
      *IT_0037*IT_0039;
    ...
    const ccomplex_t IT_0061 = IT_0006*IT_0036;
    const ccomplex_t IT_0062 = sin(beta);
    const ccomplex_t IT_0063 = IT_0000*IT_0062;
    const ccomplex_t IT_0064 = IT_0061 + IT_0063;
    const ccomplex_t IT_0065 = cpow(IT_0001, -2);
    const ccomplex_t IT_0066 = 2*U_stau_01*((IT_0006*IT_0011*IT_0037*IT_0039
      *IT_0045 + (-0.5)*m_W*IT_0064*(IT_0011 + -IT_0010*IT_0065))*conj(U_stau_01
      ) + 1./2*IT_0000*IT_0011*IT_0037*IT_0060*conj(U_stau_11)) + U_stau_11*
      (IT_0000*IT_0011*IT_0037*IT_0060*conj(U_stau_01) + 2*(IT_0006*IT_0011
      *IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0064*IT_0065)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0076 = N_d4*e_em*m_tau*IT_0039*U_stau_00;
    ...
    const ccomplex_t IT_0083 = 2*conj(U_stau_00)*((IT_0006*IT_0011*IT_0037
      *IT_0039*IT_0045 + (-0.5)*m_W*IT_0064*(IT_0011 + -IT_0010*IT_0065))
      *U_stau_01 + 1./2*IT_0000*IT_0011*IT_0037*IT_0060*U_stau_11) + conj
      (U_stau_10)*(IT_0000*IT_0011*IT_0037*IT_0060*U_stau_01 + 2*(IT_0006
      *IT_0011*IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0064*IT_0065)*U_stau_11);
    ...
    const ccomplex_t IT_0089 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0090 = IT_0002*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = N_d1*e_em*m_tau*IT_0039*U_stau_01;
    ...
    const ccomplex_t IT_0097 = cpow(s_23 + (-0.5)*IT_0045 + (-0.5)*IT_0046 +
    ...
    const ccomplex_t IT_0122 = conj(N_B1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0123 = IT_0003*IT_0122;
    const ccomplex_t IT_0124 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0125 = IT_0007*IT_0124;
    const ccomplex_t IT_0126 = conj(N_B4)*conj(N_u1)*e_em;
    const ccomplex_t IT_0127 = IT_0003*IT_0126;
    const ccomplex_t IT_0128 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0129 = IT_0007*IT_0128;
    const ccomplex_t IT_0130 = IT_0123 + IT_0125 + IT_0127 + IT_0129;
    const ccomplex_t IT_0131 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0132 = IT_0012*IT_0131;
    const ccomplex_t IT_0133 = conj(N_W1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0146 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0147 = IT_0002*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = N_d2*e_em*m_tau*IT_0039*U_stau_01;
    ...
    const ccomplex_t IT_0154 = cpow(s_23 + (-0.5)*IT_0045 + (-0.5)*IT_0046 +
    ...
    const ccomplex_t IT_0157 = N_B4*N_u2*e_em;
    const ccomplex_t IT_0158 = IT_0003*IT_0157;
    const ccomplex_t IT_0159 = N_B4*N_d2*e_em;
    const ccomplex_t IT_0160 = IT_0007*IT_0159;
    const ccomplex_t IT_0161 = N_B2*N_u4*e_em;
    const ccomplex_t IT_0162 = IT_0003*IT_0161;
    const ccomplex_t IT_0163 = N_B2*N_d4*e_em;
    const ccomplex_t IT_0164 = IT_0007*IT_0163;
    const ccomplex_t IT_0165 = IT_0158 + IT_0160 + IT_0162 + IT_0164;
    const ccomplex_t IT_0166 = N_W4*N_u2*e_em;
    const ccomplex_t IT_0167 = IT_0012*IT_0166;
    const ccomplex_t IT_0168 = N_W4*N_d2*e_em;
    const ccomplex_t IT_0169 = IT_0015*IT_0168;
    const ccomplex_t IT_0170 = N_W2*N_u4*e_em;
    const ccomplex_t IT_0171 = IT_0012*IT_0170;
    const ccomplex_t IT_0172 = N_W2*N_d4*e_em;
    ...
    const ccomplex_t IT_0179 = conj(N_B2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0180 = IT_0003*IT_0179;
    const ccomplex_t IT_0181 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0182 = IT_0007*IT_0181;
    const ccomplex_t IT_0183 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0184 = IT_0003*IT_0183;
    const ccomplex_t IT_0185 = conj(N_B4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0192 = conj(N_W4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0193 = IT_0012*IT_0192;
    const ccomplex_t IT_0194 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0201 = IT_0178 + IT_0200;
    const ccomplex_t IT_0202 = IT_0156*IT_0201;
    const ccomplex_t IT_0203 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0204 = IT_0002*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = N_d3*e_em*m_tau*IT_0039*U_stau_01;
    const ccomplex_t IT_0207 = IT_0038*IT_0206;
    ...
    const ccomplex_t IT_0211 = cpow(s_23 + (-0.5)*IT_0045 + (-0.5)*IT_0046 +
    ...
    const ccomplex_t IT_0218 = N_B3*N_u4*e_em;
    ...
    const ccomplex_t IT_0223 = N_W4*N_u3*e_em;
    const ccomplex_t IT_0224 = IT_0012*IT_0223;
    const ccomplex_t IT_0225 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0226 = IT_0015*IT_0225;
    const ccomplex_t IT_0227 = N_W3*N_u4*e_em;
    const ccomplex_t IT_0228 = IT_0012*IT_0227;
    const ccomplex_t IT_0229 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0236 = conj(N_B3)*conj(N_u4)*e_em;
    ...
    const ccomplex_t IT_0240 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0245 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0246 = IT_0012*IT_0245;
    const ccomplex_t IT_0247 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0248 = IT_0015*IT_0247;
    const ccomplex_t IT_0249 = conj(N_W4)*conj(N_u3)*e_em;
    const ccomplex_t IT_0250 = IT_0012*IT_0249;
    const ccomplex_t IT_0251 = conj(N_W4)*conj(N_d3)*e_em;
    ...
    const ccomplex_t IT_0259 = IT_0213*IT_0258;
    const ccomplex_t IT_0260 = (-0.5)*IT_0050 + IT_0058 + (-0.5)*IT_0071 + (
      -0.5)*IT_0088 + (-0.5)*IT_0145 + (-0.5)*IT_0202 + (-0.5)*IT_0259;
    const ccomplex_t IT_0261 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0262 = IT_0002*IT_0261;
    const ccomplex_t IT_0263 = 1.4142135623731*IT_0262;
    const ccomplex_t IT_0264 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0265 = IT_0011*IT_0264;
    const ccomplex_t IT_0266 = 1.4142135623731*IT_0265;
    const ccomplex_t IT_0267 = conj(N_d4)*e_em*m_tau*IT_0039*U_stau_11;
    ...
    const ccomplex_t IT_0272 = IT_0047*IT_0271;
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*IT_0272;
    const ccomplex_t IT_0274 = IT_0032*IT_0273;
    const ccomplex_t IT_0275 = IT_0054*IT_0271;
    const ccomplex_t IT_0276 = IT_0052*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1)*IT_0276;
    const ccomplex_t IT_0278 = m_tau*IT_0277;
    const ccomplex_t IT_0279 = 2*U_stau_01*((IT_0006*IT_0011*IT_0037*IT_0039
      *IT_0045 + (-0.5)*m_W*IT_0064*(IT_0011 + -IT_0010*IT_0065))*conj(U_stau_01
      ) + 1./2*IT_0000*IT_0011*IT_0037*IT_0060*conj(U_stau_11)) + U_stau_11*
      (IT_0000*IT_0011*IT_0037*IT_0060*conj(U_stau_01) + 2*(IT_0006*IT_0011
      *IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0064*IT_0065)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0296 = 2*conj(U_stau_00)*((IT_0006*IT_0011*IT_0037
      *IT_0039*IT_0045 + (-0.5)*m_W*IT_0064*(IT_0011 + -IT_0010*IT_0065))
      *U_stau_01 + 1./2*IT_0000*IT_0011*IT_0037*IT_0060*U_stau_11) + conj
      (U_stau_10)*(IT_0000*IT_0011*IT_0037*IT_0060*U_stau_01 + 2*(IT_0006
      *IT_0011*IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0064*IT_0065)*U_stau_11);
    const ccomplex_t IT_0297 = (0 + _Complex_I*1)*(e_em*IT_0296 +
       1.4142135623731*A_tau*IT_0006*(U_stau_01*conj(U_stau_10) + conj(U_stau_00
      )*U_stau_11));
    ...
    const ccomplex_t IT_0302 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0303 = IT_0002*IT_0302;
    const ccomplex_t IT_0304 = 1.4142135623731*IT_0303;
    const ccomplex_t IT_0305 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0306 = IT_0011*IT_0305;
    const ccomplex_t IT_0307 = 1.4142135623731*IT_0306;
    const ccomplex_t IT_0308 = conj(N_d1)*e_em*m_tau*IT_0039*U_stau_11;
    const ccomplex_t IT_0309 = IT_0038*IT_0308;
    ...
    const ccomplex_t IT_0313 = IT_0097*IT_0312;
    const ccomplex_t IT_0314 = (0 + _Complex_I*1)*IT_0313;
    const ccomplex_t IT_0315 = m_N_1*IT_0142;
    const ccomplex_t IT_0316 = m_N_4*IT_0120;
    const ccomplex_t IT_0317 = IT_0315 + IT_0316;
    const ccomplex_t IT_0318 = IT_0314*IT_0317;
    const ccomplex_t IT_0319 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0320 = IT_0002*IT_0319;
    const ccomplex_t IT_0321 = 1.4142135623731*IT_0320;
    const ccomplex_t IT_0322 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0323 = IT_0011*IT_0322;
    const ccomplex_t IT_0324 = 1.4142135623731*IT_0323;
    const ccomplex_t IT_0325 = conj(N_d2)*e_em*m_tau*IT_0039*U_stau_11;
    const ccomplex_t IT_0326 = IT_0038*IT_0325;
    ...
    const ccomplex_t IT_0330 = IT_0154*IT_0329;
    const ccomplex_t IT_0331 = (0 + _Complex_I*1)*IT_0330;
    const ccomplex_t IT_0332 = m_N_4*IT_0177;
    const ccomplex_t IT_0333 = m_N_2*IT_0199;
    const ccomplex_t IT_0334 = IT_0332 + IT_0333;
    const ccomplex_t IT_0335 = IT_0331*IT_0334;
    const ccomplex_t IT_0336 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0337 = IT_0002*IT_0336;
    const ccomplex_t IT_0338 = 1.4142135623731*IT_0337;
    const ccomplex_t IT_0339 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0340 = IT_0011*IT_0339;
    const ccomplex_t IT_0341 = 1.4142135623731*IT_0340;
    const ccomplex_t IT_0342 = conj(N_d3)*e_em*m_tau*IT_0039*U_stau_11;
    const ccomplex_t IT_0343 = IT_0038*IT_0342;
    ...
    const ccomplex_t IT_0347 = IT_0211*IT_0346;
    const ccomplex_t IT_0348 = (0 + _Complex_I*1)*IT_0347;
    const ccomplex_t IT_0349 = m_N_4*IT_0234;
    const ccomplex_t IT_0350 = m_N_3*IT_0256;
    const ccomplex_t IT_0351 = IT_0349 + IT_0350;
    const ccomplex_t IT_0352 = IT_0348*IT_0351;
    const ccomplex_t IT_0353 = 0.5*IT_0274 + -IT_0278 + 0.5*IT_0284 + 0.5
      *IT_0301 + 0.5*IT_0318 + 0.5*IT_0335 + 0.5*IT_0352;
    const ccomplex_t IT_0354 = 2*s_13;
    const ccomplex_t IT_0355 = m_N_4*m_tau;
    const ccomplex_t IT_0356 = 2*IT_0260;
    const ccomplex_t IT_0357 = IT_0019*IT_0273;
    const ccomplex_t IT_0358 = IT_0120*IT_0314;
    const ccomplex_t IT_0359 = IT_0177*IT_0331;
    const ccomplex_t IT_0360 = IT_0234*IT_0348;
    const ccomplex_t IT_0361 = 0.5*IT_0057 + (-0.5)*IT_0357 + (-0.5)*IT_0358 +
       (-0.5)*IT_0359 + (-0.5)*IT_0360;
    const ccomplex_t IT_0362 = s_14*m_tau;
    const ccomplex_t IT_0363 = IT_0030*IT_0049;
    const ccomplex_t IT_0364 = IT_0213*IT_0256;
    const ccomplex_t IT_0365 = IT_0099*IT_0142;
    const ccomplex_t IT_0366 = IT_0156*IT_0199;
    const ccomplex_t IT_0367 = (-0.5)*IT_0277 + 0.5*IT_0363 + 0.5*IT_0364 +
       0.5*IT_0365 + 0.5*IT_0366;
    const ccomplex_t IT_0368 = s_34*m_N_4;
    const ccomplex_t IT_0369 = 2*conj(IT_0260);
    const ccomplex_t IT_0370 = 2*conj(IT_0353);
    const ccomplex_t IT_0371 = pow(m_h, 2);
    const ccomplex_t IT_0372 = m_N_4*m_tau*IT_0371;
    ...
    const ccomplex_t IT_0377 = 2*IT_0353;
    const ccomplex_t IT_0378 = 0.5*IT_0368;
    const ccomplex_t IT_0379 = (IT_0260*conj(IT_0260) + IT_0353*conj(IT_0353))
      ...
      *IT_0370 + 2*conj(IT_0367)*(IT_0361*IT_0372 + -IT_0367*IT_0376 + 0.5
      *IT_0362*IT_0377 + IT_0356*IT_0378) + 2*conj(IT_0361)*(0.5*IT_0356*IT_0362
       + IT_0367*IT_0372 + -IT_0361*IT_0376 + IT_0377*IT_0378);
