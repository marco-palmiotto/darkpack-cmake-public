        ...
        )
{
    ...
    const ccomplex_t IT_0052 = cpow(s_13 + (-0.5)*IT_0045 + (-0.5)*IT_0051 + (
      -0.5)*reg_prop + 0.5*m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2),
       -1);
    const ccomplex_t IT_0053 = mu_h*m_tau*IT_0039;
    const ccomplex_t IT_0054 = IT_0006*IT_0036;
    ...
    const ccomplex_t IT_0059 = 2*U_stau_01*((IT_0006*IT_0011*IT_0037*IT_0039
      *IT_0045 + (-0.5)*m_W*IT_0057*(IT_0011 + -IT_0010*IT_0058))*conj(U_stau_01
      ) + 1./2*IT_0000*IT_0011*IT_0037*IT_0053*conj(U_stau_11)) + U_stau_11*
      (IT_0000*IT_0011*IT_0037*IT_0053*conj(U_stau_01) + 2*(IT_0006*IT_0011
      *IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0057*IT_0058)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0065 = cpow(s_13 + (-0.5)*IT_0045 + (-0.5)*IT_0051 + (
      -0.5)*reg_prop + 0.5*m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1),
       -1);
    const ccomplex_t IT_0066 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0067 = IT_0002*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = N_d4*e_em*m_tau*IT_0039*U_stau_00;
    ...
    const ccomplex_t IT_0074 = 2*conj(U_stau_00)*((IT_0006*IT_0011*IT_0037
      *IT_0039*IT_0045 + (-0.5)*m_W*IT_0057*(IT_0011 + -IT_0010*IT_0058))
      *U_stau_01 + 1./2*IT_0000*IT_0011*IT_0037*IT_0053*U_stau_11) + conj
      (U_stau_10)*(IT_0000*IT_0011*IT_0037*IT_0053*U_stau_01 + 2*(IT_0006
      *IT_0011*IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0057*IT_0058)*U_stau_11);
    ...
    const ccomplex_t IT_0104 = conj(N_B1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0108 = conj(N_B4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0113 = conj(N_W1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0117 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0128 = N_d1*e_em*m_tau*IT_0039*U_stau_01;
    const ccomplex_t IT_0129 = IT_0038*IT_0128;
    ...
    const ccomplex_t IT_0133 = cpow(s_23 + (-0.5)*IT_0045 + (-0.5)*IT_0046 +
    ...
    const ccomplex_t IT_0140 = N_d2*e_em*m_tau*IT_0039*U_stau_01;
    const ccomplex_t IT_0141 = IT_0038*IT_0140;
    ...
    const ccomplex_t IT_0145 = cpow(s_23 + (-0.5)*IT_0045 + (-0.5)*IT_0046 +
    ...
    const ccomplex_t IT_0194 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0195 = IT_0002*IT_0194;
    const ccomplex_t IT_0196 = 1.4142135623731*IT_0195;
    const ccomplex_t IT_0197 = N_d3*e_em*m_tau*IT_0039*U_stau_01;
    ...
    const ccomplex_t IT_0202 = cpow(s_23 + (-0.5)*IT_0045 + (-0.5)*IT_0046 +
    ...
    const ccomplex_t IT_0248 = m_N_4*IT_0247;
    const ccomplex_t IT_0249 = IT_0226 + IT_0248;
    const ccomplex_t IT_0250 = IT_0204*IT_0249;
    const ccomplex_t IT_0251 = cpow(s_12 + (-0.5)*IT_0045 + 0.5*IT_0046 + 0.5
      *IT_0051 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*e_em*m_tau*IT_0006*IT_0011
      *IT_0037*IT_0039;
    const ccomplex_t IT_0253 = 0.5*IT_0252;
    const ccomplex_t IT_0254 = IT_0044*IT_0253;
    ...
    const ccomplex_t IT_0258 = (-0.5)*IT_0050 + (-0.5)*IT_0064 + (-0.5)
    ...
    const ccomplex_t IT_0265 = conj(N_d4)*e_em*m_tau*IT_0039*U_stau_11;
    ...
    const ccomplex_t IT_0270 = IT_0047*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1)*IT_0270;
    const ccomplex_t IT_0272 = IT_0032*IT_0271;
    const ccomplex_t IT_0273 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0274 = IT_0002*IT_0273;
    const ccomplex_t IT_0275 = 1.4142135623731*IT_0274;
    const ccomplex_t IT_0276 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0277 = IT_0011*IT_0276;
    const ccomplex_t IT_0278 = 1.4142135623731*IT_0277;
    const ccomplex_t IT_0279 = conj(N_d1)*e_em*m_tau*IT_0039*U_stau_11;
    ...
    const ccomplex_t IT_0286 = m_N_4*IT_0100;
    const ccomplex_t IT_0287 = m_N_1*IT_0122;
    const ccomplex_t IT_0288 = IT_0286 + IT_0287;
    const ccomplex_t IT_0289 = IT_0285*IT_0288;
    const ccomplex_t IT_0290 = 2*U_stau_01*((IT_0006*IT_0011*IT_0037*IT_0039
      *IT_0045 + (-0.5)*m_W*IT_0057*(IT_0011 + -IT_0010*IT_0058))*conj(U_stau_01
      ) + 1./2*IT_0000*IT_0011*IT_0037*IT_0053*conj(U_stau_11)) + U_stau_11*
      (IT_0000*IT_0011*IT_0037*IT_0053*conj(U_stau_01) + 2*(IT_0006*IT_0011
      *IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0057*IT_0058)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0307 = 2*conj(U_stau_00)*((IT_0006*IT_0011*IT_0037
      *IT_0039*IT_0045 + (-0.5)*m_W*IT_0057*(IT_0011 + -IT_0010*IT_0058))
      *U_stau_01 + 1./2*IT_0000*IT_0011*IT_0037*IT_0053*U_stau_11) + conj
      (U_stau_10)*(IT_0000*IT_0011*IT_0037*IT_0053*U_stau_01 + 2*(IT_0006
      *IT_0011*IT_0037*IT_0039*IT_0045 + -m_W*IT_0010*IT_0057*IT_0058)*U_stau_11);
    ...
    const ccomplex_t IT_0313 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0314 = IT_0002*IT_0313;
    const ccomplex_t IT_0315 = 1.4142135623731*IT_0314;
    const ccomplex_t IT_0316 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0317 = IT_0011*IT_0316;
    const ccomplex_t IT_0318 = 1.4142135623731*IT_0317;
    const ccomplex_t IT_0319 = conj(N_d2)*e_em*m_tau*IT_0039*U_stau_11;
    const ccomplex_t IT_0320 = IT_0038*IT_0319;
    ...
    const ccomplex_t IT_0326 = m_N_4*IT_0190;
    const ccomplex_t IT_0327 = m_N_2*IT_0168;
    const ccomplex_t IT_0328 = IT_0326 + IT_0327;
    const ccomplex_t IT_0329 = IT_0325*IT_0328;
    const ccomplex_t IT_0330 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0331 = IT_0002*IT_0330;
    const ccomplex_t IT_0332 = 1.4142135623731*IT_0331;
    const ccomplex_t IT_0333 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0334 = IT_0011*IT_0333;
    const ccomplex_t IT_0335 = 1.4142135623731*IT_0334;
    const ccomplex_t IT_0336 = conj(N_d3)*e_em*m_tau*IT_0039*U_stau_11;
    const ccomplex_t IT_0337 = IT_0038*IT_0336;
    ...
    const ccomplex_t IT_0343 = m_N_4*IT_0225;
    const ccomplex_t IT_0344 = m_N_3*IT_0247;
