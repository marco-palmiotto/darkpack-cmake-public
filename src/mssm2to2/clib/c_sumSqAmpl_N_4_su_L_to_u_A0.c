        ...
        )
{
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0000*IT_0002*IT_0042;
    const ccomplex_t IT_0044 = (-0.5)*IT_0043;
    const ccomplex_t IT_0045 = pow(m_su_L, 2);
    ...
    const ccomplex_t IT_0240 = m_u*m_N_4;
    const ccomplex_t IT_0241 = 6*IT_0179;
    const ccomplex_t IT_0242 = cpow((-2)*s_12 + IT_0010 + -IT_0011 + -IT_0045 
      + -reg_prop, -1);
    const ccomplex_t IT_0243 = m_u*e_em*IT_0000*IT_0002*IT_0015*IT_0042;
