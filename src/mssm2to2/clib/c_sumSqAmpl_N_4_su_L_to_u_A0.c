...
ccomplex_return_t c_sumSqAmpl_N_4_su_L_to_u_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0000*IT_0002*IT_0016;
    ...
    const ccomplex_t IT_0190 = m_u*e_em*IT_0000*IT_0002*IT_0016*IT_0023;
    ...
    const ccomplex_t IT_0199 = -IT_0194 + -IT_0195 + -IT_0196 + -IT_0197 + 
      -IT_0198;
    const ccomplex_t IT_0200 = m_u*s_14;
    ...
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
