...
ccomplex_return_t c_sumSqAmpl_N_4_su_L_to_u_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
    ...
    const ccomplex_t IT_0047 = m_u*s_14*m_N_4;
    ...
    const ccomplex_t IT_0057 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0062 = m_u*s_34*m_N_4;
