        ...
        )
{
    ...
    const ccomplex_t IT_0020 = conj(N_W3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = conj(N_B4)*conj(N_d3)*e_em;
    const ccomplex_t IT_0023 = IT_0015*IT_0022;
    const ccomplex_t IT_0024 = conj(N_W4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0028 = conj(N_B3)*conj(N_u4)*e_em;
    const ccomplex_t IT_0029 = IT_0027*IT_0028;
    const ccomplex_t IT_0030 = IT_0004*IT_0012;
    const ccomplex_t IT_0031 = conj(N_W3)*conj(N_d4)*e_em;
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = conj(N_B4)*conj(N_u3)*e_em;
    ...
    const ccomplex_t IT_0046 = N_B3*N_d4*e_em;
    ...
    const ccomplex_t IT_0051 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0052 = IT_0027*IT_0051;
    const ccomplex_t IT_0053 = N_W4*N_d3*e_em;
    const ccomplex_t IT_0054 = IT_0030*IT_0053;
    const ccomplex_t IT_0055 = N_B3*N_u4*e_em;
    const ccomplex_t IT_0056 = IT_0027*IT_0055;
    const ccomplex_t IT_0057 = N_W3*N_d4*e_em;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_su_R*
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0080 = (-0.5)*IT_0079;
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0007 + IT_0071 + -m_su_L*
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0002
      *IT_0004*IT_0018;
    ...
    const ccomplex_t IT_0091 = m_u*IT_0090;
    ...
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_4*
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0118 = (-0.5)*IT_0117;
    const ccomplex_t IT_0119 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0120 = IT_0118*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*IT_0120;
    const ccomplex_t IT_0122 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0123 = IT_0015*IT_0122;
    const ccomplex_t IT_0124 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0125 = IT_0019*IT_0124;
    const ccomplex_t IT_0126 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0127 = IT_0015*IT_0126;
    const ccomplex_t IT_0128 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0173 = conj(N_B2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0174 = IT_0015*IT_0173;
    const ccomplex_t IT_0175 = conj(N_W2)*conj(N_u4)*e_em;
    const ccomplex_t IT_0176 = IT_0019*IT_0175;
    const ccomplex_t IT_0177 = conj(N_B4)*conj(N_d2)*e_em;
    const ccomplex_t IT_0178 = IT_0015*IT_0177;
    const ccomplex_t IT_0179 = conj(N_W4)*conj(N_u2)*e_em;
    ...
    const ccomplex_t IT_0184 = conj(N_W2)*conj(N_d4)*e_em;
    const ccomplex_t IT_0185 = IT_0030*IT_0184;
    const ccomplex_t IT_0186 = conj(N_B4)*conj(N_u2)*e_em;
    const ccomplex_t IT_0187 = IT_0027*IT_0186;
    const ccomplex_t IT_0188 = conj(N_W4)*conj(N_d2)*e_em;
    ...
    const ccomplex_t IT_0232 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0237 = IT_0078*IT_0227;
    ...
    const ccomplex_t IT_0247 = IT_0004*IT_0246;
    ...
    const ccomplex_t IT_0253 = m_N_4*IT_0164;
    const ccomplex_t IT_0254 = m_N_1*IT_0142;
    ...
    const ccomplex_t IT_0267 = m_N_4*IT_0215;
    const ccomplex_t IT_0268 = m_N_2*IT_0193;
    ...
    const ccomplex_t IT_0281 = m_N_4*IT_0062;
    const ccomplex_t IT_0282 = m_N_3*IT_0040;
    ...
    const ccomplex_t IT_0289 = IT_0062*IT_0280;
    const ccomplex_t IT_0290 = IT_0100*IT_0241;
    const ccomplex_t IT_0291 = IT_0164*IT_0252;
    const ccomplex_t IT_0292 = IT_0215*IT_0266;
    const ccomplex_t IT_0293 = -IT_0090 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_u*s_14;
    const ccomplex_t IT_0295 = IT_0121*IT_0142;
    const ccomplex_t IT_0296 = IT_0172*IT_0193;
    const ccomplex_t IT_0297 = IT_0011*IT_0040;
    const ccomplex_t IT_0298 = IT_0110*IT_0115;
