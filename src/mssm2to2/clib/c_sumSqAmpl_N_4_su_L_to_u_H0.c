...
ccomplex_return_t c_sumSqAmpl_N_4_su_L_to_u_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0004*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0029 = IT_0008*IT_0011;
    ...
    const ccomplex_t IT_0037 = IT_0011*IT_0025;
    const ccomplex_t IT_0038 = N_B4*N_u3*e_em;
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = IT_0008*IT_0023;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0004
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_R*
    ...
    const ccomplex_t IT_0085 = cpow(IT_0024, -2);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0004
      *IT_0006*IT_0008*IT_0011 + (-0.5)*m_W*(IT_0005*IT_0011 + -IT_0023*IT_0084)
      *(IT_0008 + -1./3*IT_0007*IT_0085));
    const ccomplex_t IT_0087 = -IT_0086;
    const ccomplex_t IT_0088 = IT_0010*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
    ...
    const ccomplex_t IT_0128 = N_W4*N_d1*e_em;
    const ccomplex_t IT_0129 = IT_0040*IT_0128;
    const ccomplex_t IT_0130 = N_B1*N_u4*e_em;
    const ccomplex_t IT_0131 = IT_0037*IT_0130;
    const ccomplex_t IT_0132 = N_W1*N_d4*e_em;
    ...
    const ccomplex_t IT_0139 = conj(N_B1)*conj(N_d4)*e_em;
    const ccomplex_t IT_0140 = IT_0026*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W1)*conj(N_u4)*e_em;
    const ccomplex_t IT_0142 = IT_0029*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B4)*conj(N_d1)*e_em;
    const ccomplex_t IT_0144 = IT_0026*IT_0143;
    const ccomplex_t IT_0145 = conj(N_W4)*conj(N_u1)*e_em;
    ...
    const ccomplex_t IT_0150 = conj(N_W1)*conj(N_d4)*e_em;
    ...
    const ccomplex_t IT_0154 = conj(N_W4)*conj(N_d1)*e_em;
    ...
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0163 = (-0.5)*IT_0162;
    const ccomplex_t IT_0164 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0214 = (-0.5)*IT_0213;
    const ccomplex_t IT_0215 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0219 = (-2)*IT_0017 + IT_0075 + IT_0083 + IT_0091 +
    ...
    const ccomplex_t IT_0232 = IT_0087*IT_0227;
    const ccomplex_t IT_0233 = IT_0089*IT_0232;
    ...
    const ccomplex_t IT_0268 = IT_0215*IT_0267;
    const ccomplex_t IT_0269 = (0 + _Complex_I*1)*IT_0268;
    const ccomplex_t IT_0270 = IT_0259*IT_0269;
    const ccomplex_t IT_0271 = m_N_4*IT_0050;
    const ccomplex_t IT_0272 = m_N_3*IT_0072;
    const ccomplex_t IT_0273 = IT_0271 + IT_0272;
    const ccomplex_t IT_0274 = conj(N_B3)*e_em;
    const ccomplex_t IT_0275 = IT_0025*IT_0274;
    const ccomplex_t IT_0276 = 1.4142135623731*IT_0275;
    const ccomplex_t IT_0277 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0285 = 2*IT_0231 + -IT_0234 + -IT_0248 + -IT_0253 + 
      -IT_0256 + -IT_0270 + -IT_0284;
    const ccomplex_t IT_0286 = 6*s_13;
    const ccomplex_t IT_0287 = m_u*m_N_4;
    const ccomplex_t IT_0288 = 6*IT_0219;
    const ccomplex_t IT_0289 = IT_0100*IT_0255;
    const ccomplex_t IT_0290 = IT_0050*IT_0283;
    const ccomplex_t IT_0291 = IT_0137*IT_0244;
    const ccomplex_t IT_0292 = IT_0188*IT_0269;
    const ccomplex_t IT_0293 = -IT_0016 + IT_0289 + IT_0290 + IT_0291 + IT_0292;
    const ccomplex_t IT_0294 = m_u*s_14;
    const ccomplex_t IT_0295 = IT_0159*IT_0166;
    const ccomplex_t IT_0296 = IT_0210*IT_0217;
    const ccomplex_t IT_0297 = IT_0110*IT_0115;
    const ccomplex_t IT_0298 = IT_0022*IT_0072;
    const ccomplex_t IT_0299 = IT_0230 + -IT_0295 + -IT_0296 + -IT_0297 + 
      -IT_0298;
    const ccomplex_t IT_0300 = s_34*m_N_4;
    const ccomplex_t IT_0301 = 6*conj(IT_0219);
    const ccomplex_t IT_0302 = 6*conj(IT_0285);
    const ccomplex_t IT_0303 = pow(m_H0, 2);
    const ccomplex_t IT_0304 = m_u*m_N_4*IT_0303;
