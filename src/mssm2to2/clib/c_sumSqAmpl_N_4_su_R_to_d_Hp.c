        ...
        )
{
    ...
    const ccomplex_t IT_0112 = IT_0048*IT_0110*IT_0111;
    const ccomplex_t IT_0113 = m_N_4*IT_0027;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0005*IT_0007*IT_0009*IT_0013;
    const ccomplex_t IT_0115 = 0.5*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0005*IT_0009*IT_0013;
    const ccomplex_t IT_0117 = 0.5*IT_0116;
    const ccomplex_t IT_0118 = IT_0115*IT_0117;
    const ccomplex_t IT_0119 = cpow((-2)*s_13 + IT_0003 + IT_0047 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0120 = IT_0118*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0123 = IT_0011*IT_0020;
