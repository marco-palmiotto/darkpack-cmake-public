...
ccomplex_return_t c_sumSqAmpl_N_4_su_R_to_d_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0001 = m_d*m_N_4*IT_0000;
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0000 + IT_0047 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_ud*e_em*IT_0005*IT_0007*IT_0009;
    ...
    const ccomplex_t IT_0078 = m_d*m_N_4;
    ...
    const ccomplex_t IT_0087 = IT_0006*IT_0009;
    ...
    const ccomplex_t IT_0091 = IT_0006*IT_0022;
    ...
    const ccomplex_t IT_0104 = IT_0051*IT_0102*IT_0103;
    const ccomplex_t IT_0105 = conj(N_d4)*e_em*conj(U_Wm1);
    const ccomplex_t IT_0106 = IT_0087*IT_0105;
    const ccomplex_t IT_0107 = (-2)*IT_0106;
    const ccomplex_t IT_0108 = conj(N_B4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0109 = IT_0091*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = conj(N_W4)*conj(U_d1)*e_em;
    const ccomplex_t IT_0112 = IT_0087*IT_0111;
    ...
    const ccomplex_t IT_0121 = m_N_4*IT_0027;
    ...
    const ccomplex_t IT_0133 = cpow((-2)*s_13 + IT_0003 + IT_0047 + -m_sd_L*
    ...
    const ccomplex_t IT_0137 = IT_0011*IT_0020;
    const ccomplex_t IT_0138 = IT_0004*IT_0136*IT_0137;
    const ccomplex_t IT_0139 = -IT_0086 + -IT_0104 + -IT_0120 + -IT_0121 + 
      -IT_0135 + IT_0138;
    const ccomplex_t IT_0140 = IT_0015*IT_0024;
    const ccomplex_t IT_0141 = IT_0004*IT_0136*IT_0140;
    const ccomplex_t IT_0142 = m_N_4*IT_0018;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
    ...
    const ccomplex_t IT_0150 = IT_0084*IT_0149;
