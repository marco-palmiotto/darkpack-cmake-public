        ...
        )
{
    ...
    const ccomplex_t IT_0060 = m_d*IT_0050;
    ...
    const ccomplex_t IT_0069 = N_W4*e_em*conj(U_Wm1);
    const ccomplex_t IT_0070 = IT_0004*IT_0069;
    const ccomplex_t IT_0071 = N_d4*conj(U_d1)*e_em;
    ...
    const ccomplex_t IT_0086 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0087 = IT_0004*IT_0086;
    const ccomplex_t IT_0088 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0132 = m_d*IT_0039;
