...
ccomplex_return_t c_sumSqAmpl_N_4_su_R_to_d_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = conj(N_W4)*e_em*V_Wp1;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = conj(N_u4)*V_u1*e_em;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_u;
    ...
    const ccomplex_t IT_0072 = IT_0036*IT_0066*IT_0071;
    const ccomplex_t IT_0073 = N_W4*e_em*conj(U_Wm2);
    const ccomplex_t IT_0074 = IT_0004*IT_0073;
    const ccomplex_t IT_0075 = N_d4*conj(U_d2)*e_em;
    ...
    const ccomplex_t IT_0083 = IT_0065 + -IT_0072 + IT_0082;
    const ccomplex_t IT_0084 = 6*IT_0083;
    const ccomplex_t IT_0085 = s_13*IT_0050;
    const ccomplex_t IT_0086 = 6*IT_0033;
    const ccomplex_t IT_0087 = IT_0019 + IT_0032;
    const ccomplex_t IT_0088 = m_N_4*IT_0087;
    const ccomplex_t IT_0089 = -IT_0088;
    const ccomplex_t IT_0090 = 2*IT_0043;
    const ccomplex_t IT_0091 = s_13*IT_0054;
    const ccomplex_t IT_0092 = s_13*s_14;
    const ccomplex_t IT_0093 = s_34*IT_0035;
    const ccomplex_t IT_0094 = -IT_0093;
    const ccomplex_t IT_0095 = IT_0092 + IT_0094;
    const ccomplex_t IT_0096 = IT_0043 + IT_0087;
    const ccomplex_t IT_0097 = 6*conj(IT_0033);
    ...
    const ccomplex_t IT_0126 = (-6)*IT_0090;
    ...
    const ccomplex_t IT_0132 = m_d*IT_0054;
    const ccomplex_t IT_0133 = (-6)*conj(IT_0090);
    const ccomplex_t IT_0134 = s_13*IT_0130;
    const ccomplex_t IT_0135 = (-6)*IT_0083;
    ...
    const ccomplex_t IT_0144 = (-6)*conj(IT_0083);
    const ccomplex_t IT_0145 = m_d*m_N_4;
    ...
    const ccomplex_t IT_0152 = 6*IT_0043;
    const ccomplex_t IT_0153 = (-6)*IT_0087;
    const ccomplex_t IT_0154 = (-18)*IT_0045*IT_0145;
    const ccomplex_t IT_0155 = IT_0121*IT_0152;
    const ccomplex_t IT_0156 = (IT_0083 + IT_0089)*IT_0151;
    const ccomplex_t IT_0157 = (-6)*conj(IT_0033)*(IT_0045*IT_0051 + (
      -0.166666666666667)*IT_0055*IT_0084 + (-0.166666666666667)*IT_0085*IT_0086
      ) + (IT_0055*IT_0089 + IT_0090*IT_0091 + IT_0095*IT_0096)*IT_0097 + 6*conj
      (IT_0043)*(0.166666666666667*IT_0086*IT_0095 + IT_0045*IT_0104 +
       0.166666666666667*IT_0043*IT_0113 + 0.166666666666667*IT_0087*IT_0115 + 
      (0.166666666666667*IT_0084 + IT_0089)*IT_0121 + 0.166666666666667*IT_0125
      *IT_0126) + (IT_0096*IT_0125 + IT_0089*IT_0131 + IT_0045*IT_0132)*IT_0133 
      + conj(IT_0090)*(IT_0086*IT_0091 + IT_0126*IT_0134 + IT_0131*IT_0135) + (
      -6)*conj(IT_0087)*((-0.166666666666667)*IT_0086*IT_0095 + (
      -0.166666666666667)*IT_0087*IT_0113 + (-0.166666666666667)*IT_0043*IT_0115
       + (-0.166666666666667)*IT_0125*IT_0126 + IT_0045*IT_0139 + (IT_0089 + (
      -0.166666666666667)*IT_0135)*IT_0143) + (IT_0090*IT_0131 + IT_0087*IT_0143
      )*IT_0144 + (-6)*conj(IT_0045)*(IT_0033*IT_0051 + -1./6*IT_0126*IT_0132 + 
      -1./6*((-18)*IT_0083 + (-18)*IT_0089)*IT_0145 + -1./6*IT_0045*IT_0151 + 
      -1./6*IT_0104*IT_0152 + -1./6*IT_0139*IT_0153) + conj(IT_0089)*(IT_0055
      *IT_0086 + IT_0126*IT_0131 + IT_0143*IT_0153 + IT_0154 + IT_0155 + IT_0156
      ) + 6*conj(IT_0083)*(IT_0033*IT_0055 + 0.166666666666667*IT_0154 +
