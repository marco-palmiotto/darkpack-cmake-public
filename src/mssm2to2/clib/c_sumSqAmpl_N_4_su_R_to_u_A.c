...
ccomplex_return_t c_sumSqAmpl_N_4_su_R_to_u_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
    ...
    const ccomplex_t IT_0042 = m_u*s_14*m_N_4;
    ...
    const ccomplex_t IT_0052 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0057 = m_u*s_34*m_N_4;
