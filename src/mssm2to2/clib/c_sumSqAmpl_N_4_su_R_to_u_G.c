...
ccomplex_return_t c_sumSqAmpl_N_4_su_R_to_u_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0041 = m_u*s_14*m_N_4;
    ...
    const ccomplex_t IT_0051 = m_u*m_N_4;
    ...
    const ccomplex_t IT_0056 = m_u*s_34*m_N_4;
