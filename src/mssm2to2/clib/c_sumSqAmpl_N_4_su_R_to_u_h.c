...
ccomplex_return_t c_sumSqAmpl_N_4_su_R_to_u_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = IT_0005*IT_0009;
    ...
    const ccomplex_t IT_0032 = IT_0009*IT_0013;
    const ccomplex_t IT_0033 = N_W4*N_u1*e_em;
    const ccomplex_t IT_0034 = IT_0032*IT_0033;
    const ccomplex_t IT_0035 = IT_0013*IT_0023;
    ...
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0008
      *IT_0009*IT_0011*IT_0013 + m_W*IT_0012*IT_0084*(IT_0009*IT_0010 + IT_0023
      *IT_0085));
    ...
    const ccomplex_t IT_0224 = IT_0087*IT_0223;
    const ccomplex_t IT_0225 = IT_0089*IT_0224;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0231 = m_N_4*IT_0045;
    const ccomplex_t IT_0232 = m_N_1*IT_0067;
    const ccomplex_t IT_0233 = IT_0231 + IT_0232;
    const ccomplex_t IT_0234 = IT_0230*IT_0233;
    const ccomplex_t IT_0235 = IT_0015*IT_0223;
    ...
    const ccomplex_t IT_0250 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0254 = m_N_4*IT_0139;
    const ccomplex_t IT_0255 = m_N_2*IT_0161;
    const ccomplex_t IT_0256 = IT_0254 + IT_0255;
    const ccomplex_t IT_0257 = IT_0253*IT_0256;
    const ccomplex_t IT_0258 = IT_0115*IT_0223;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*IT_0258;
    const ccomplex_t IT_0260 = IT_0114*IT_0259;
    const ccomplex_t IT_0261 = m_N_4*IT_0195;
    const ccomplex_t IT_0262 = m_N_3*IT_0217;
    const ccomplex_t IT_0263 = IT_0261 + IT_0262;
    const ccomplex_t IT_0264 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0008*IT_0011*IT_0013;
    const ccomplex_t IT_0265 = 0.5*IT_0264;
    const ccomplex_t IT_0266 = IT_0172*IT_0265;
    ...
    const ccomplex_t IT_0271 = m_u*m_N_4;
    const ccomplex_t IT_0272 = 6*IT_0221;
    const ccomplex_t IT_0273 = IT_0101*IT_0259;
    const ccomplex_t IT_0274 = IT_0045*IT_0230;
    const ccomplex_t IT_0275 = IT_0139*IT_0253;
    const ccomplex_t IT_0276 = IT_0195*IT_0267;
    ...
    const ccomplex_t IT_0282 = IT_0067*IT_0074;
    ...
    const ccomplex_t IT_0288 = m_u*m_N_4*IT_0287;
