        ...
        )
{
    ...
    const ccomplex_t IT_0020 = cpow(IT_0004, -2);
    const ccomplex_t IT_0021 = cos(beta);
    const ccomplex_t IT_0022 = sin(alpha);
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0008
      *IT_0009*IT_0011*IT_0013 + m_W*IT_0012*IT_0020*(IT_0009*IT_0010 + IT_0021
      *IT_0022));
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0037 = IT_0005*IT_0022;
    ...
    const ccomplex_t IT_0048 = IT_0013*IT_0022;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0008
      *IT_0011*IT_0013*IT_0022;
    const ccomplex_t IT_0085 = (-0.5)*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
    ...
    const ccomplex_t IT_0099 = IT_0048*IT_0098;
    ...
    const ccomplex_t IT_0221 = (-2)*IT_0019 + IT_0028 + IT_0083 + IT_0091 +
    ...
    const ccomplex_t IT_0224 = IT_0024*IT_0223;
    const ccomplex_t IT_0225 = IT_0026*IT_0224;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0243 = IT_0085*IT_0242;
    ...
    const ccomplex_t IT_0261 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0008*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0265 = m_N_4*IT_0058;
    const ccomplex_t IT_0266 = m_N_1*IT_0080;
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = IT_0264*IT_0267;
    const ccomplex_t IT_0269 = -IT_0226 + -IT_0234 + -IT_0245 + -IT_0253 + 2
    ...
    const ccomplex_t IT_0274 = IT_0058*IT_0264;
    const ccomplex_t IT_0275 = IT_0217*IT_0230;
    const ccomplex_t IT_0276 = IT_0144*IT_0249;
    ...
    const ccomplex_t IT_0280 = IT_0033*IT_0080;
    const ccomplex_t IT_0281 = IT_0123*IT_0166;
    const ccomplex_t IT_0282 = IT_0174*IT_0195;
    const ccomplex_t IT_0283 = IT_0256 + -IT_0279 + -IT_0280 + -IT_0281 + 
      -IT_0282;
