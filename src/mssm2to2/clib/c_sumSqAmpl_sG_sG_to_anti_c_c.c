        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow((-2)*s_13 + IT_0003 + IT_0004 + -m_sc_R*
    ...
    const ccomplex_t IT_0012 = cpow((-2)*s_23 + IT_0003 + IT_0004 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0013 = IT_0002*IT_0012;
    const ccomplex_t IT_0014 = s_12*IT_0003;
    const ccomplex_t IT_0015 = cpow((-2)*s_23 + IT_0003 + IT_0004 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
