...
ccomplex_return_t c_sumSqAmpl_sG_sb_1_to_b_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_00;
    const ccomplex_t IT_0003 = pow(m_b, 2);
    const ccomplex_t IT_0004 = pow(m_sG, 2);
    const ccomplex_t IT_0005 = cpow((-2)*s_13 + IT_0003 + IT_0004 + -m_sb_1*
