...
ccomplex_return_t c_sumSqAmpl_sG_sb_1_to_b_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_10;
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0006
      *IT_0007 + 3*IT_0005*IT_0010)*U_sb_00*conj(U_sb_01) + IT_0006*IT_0007
      *U_sb_10*conj(U_sb_11));
    const ccomplex_t IT_0046 = (-0.666666666666667)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_11;
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_2*
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0006
      *IT_0007 + 3*IT_0005*IT_0010)*U_sb_00*conj(U_sb_00) + IT_0006*IT_0007
      *U_sb_10*conj(U_sb_10));
    const ccomplex_t IT_0053 = (-0.666666666666667)*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sb_1*
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_01;
