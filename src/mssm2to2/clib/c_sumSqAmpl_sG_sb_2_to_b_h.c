...
ccomplex_return_t c_sumSqAmpl_sG_sb_2_to_b_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = IT_0001*IT_0003;
    ...
    const ccomplex_t IT_0026 = 2*U_sb_01*((IT_0000*IT_0002*IT_0003*IT_0005
      *IT_0010 + (-0.5)*m_W*IT_0023*(IT_0005 + 1./3*IT_0004*IT_0025))*conj
      (U_sb_01) + 1./2*IT_0002*IT_0005*IT_0018*IT_0019*conj(U_sb_11)) + U_sb_11*
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*(e_em*IT_0026 +
       1.4142135623731*A_b*IT_0003*IT_0017*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = IT_0008*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_10;
    const ccomplex_t IT_0034 = 2*conj(U_sb_00)*((IT_0000*IT_0002*IT_0003
      *IT_0005*IT_0010 + (-0.5)*m_W*IT_0023*(IT_0005 + 1./3*IT_0004*IT_0025))
      *U_sb_01 + 1./2*IT_0002*IT_0005*IT_0018*IT_0019*U_sb_11) + conj(U_sb_10)*
      (IT_0002*IT_0005*IT_0018*IT_0019*U_sb_01 + 2*(IT_0000*IT_0002*IT_0003
      *IT_0005*IT_0010 + -1./3*m_W*IT_0004*IT_0023*IT_0025)*U_sb_11);
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*(e_em*IT_0034 +
       1.4142135623731*A_b*IT_0003*IT_0017*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = IT_0033*IT_0036;
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sb_1*
    ...
    const ccomplex_t IT_0051 = IT_0028*IT_0043;
    ...
    const ccomplex_t IT_0058 = 2*IT_0050 + -IT_0053 + -IT_0057;
