...
ccomplex_return_t c_sumSqAmpl_sG_sb_2_to_t_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = m_t*U_sb_01*(m_t*IT_0001*IT_0003*conj(U_st_01) 
      + mu_h*conj(U_st_11)) + m_b*(m_b*IT_0002*IT_0017*U_sb_01*conj(U_st_01) +
       U_sb_11*(mu_h*conj(U_st_01) + m_t*IT_0003*IT_0017*conj(U_st_11)));
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0002*U_sb_11
      *conj(U_st_01) + (-1.4142135623731)*e_em*IT_0005*((-0.5)*IT_0000*IT_0018 +
       m_W*IT_0001*IT_0002*U_sb_01*conj(U_st_01)) + A_t*IT_0001*U_sb_01*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0031 = m_t*U_sb_01*(m_t*IT_0001*IT_0003*conj(U_st_00) 
      + mu_h*conj(U_st_10)) + m_b*(m_b*IT_0002*IT_0017*U_sb_01*conj(U_st_00) +
       U_sb_11*(mu_h*conj(U_st_00) + m_t*IT_0003*IT_0017*conj(U_st_10)));
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0002*U_sb_11
      *conj(U_st_00) + (-1.4142135623731)*e_em*IT_0005*((-0.5)*IT_0000*IT_0031 +
       m_W*IT_0001*IT_0002*U_sb_01*conj(U_st_00)) + A_t*IT_0001*U_sb_01*conj
      (U_st_10));
