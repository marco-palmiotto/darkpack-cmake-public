...
ccomplex_return_t c_sumSqAmpl_sG_sc_L_to_c_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*m_c*e_em*IT_0005*IT_0007
      *IT_0008*IT_0010;
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0005
      *IT_0007*IT_0010*IT_0016;
    const ccomplex_t IT_0018 = 0.5*IT_0017;
    const ccomplex_t IT_0019 = IT_0004*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_R*
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0005
      *IT_0007*IT_0008*IT_0010 + (-0.5)*m_W*(IT_0006*IT_0008 + -IT_0016*IT_0024)
      *(IT_0010 + -1./3*IT_0009*IT_0026));
    const ccomplex_t IT_0028 = -IT_0027;
    const ccomplex_t IT_0029 = IT_0004*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = m_c*IT_0015;
    ...
    const ccomplex_t IT_0039 = m_c*m_sG;
