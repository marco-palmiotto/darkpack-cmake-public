...
ccomplex_return_t c_sumSqAmpl_sG_sc_R_to_c_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = pow(m_sc_R, 2);
    ...
    const ccomplex_t IT_0011 = (-1.33333333333333)*IT_0001;
    const ccomplex_t IT_0012 = cpow((-2)*s_13 + IT_0004 + IT_0005 + -m_sc_R*
