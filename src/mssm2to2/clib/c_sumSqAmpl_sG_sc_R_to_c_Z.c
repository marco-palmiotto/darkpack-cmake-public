...
ccomplex_return_t c_sumSqAmpl_sG_sc_R_to_c_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_sc_R*
    ...
    const ccomplex_t IT_0039 = m_c*IT_0023;
