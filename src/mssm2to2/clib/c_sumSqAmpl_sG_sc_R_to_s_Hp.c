...
ccomplex_return_t c_sumSqAmpl_sG_sc_R_to_s_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = cpow((-2)*s_12 + -IT_0012 + IT_0016 + -IT_0017 
      + -reg_prop, -1);
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*m_c;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0000*IT_0002*IT_0003*IT_0006;
    const ccomplex_t IT_0021 = 0.5*IT_0020;
    const ccomplex_t IT_0022 = IT_0009*IT_0021;
    const ccomplex_t IT_0023 = IT_0018*IT_0019*IT_0022;
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_ss_L*
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0000*IT_0001*IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0044 = s_13*IT_0017;
    const ccomplex_t IT_0045 = m_s*s_12;
