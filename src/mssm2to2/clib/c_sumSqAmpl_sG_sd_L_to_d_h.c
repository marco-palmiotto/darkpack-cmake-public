...
ccomplex_return_t c_sumSqAmpl_sG_sd_L_to_d_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0003 + m_d*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0016);
    const ccomplex_t IT_0018 = 0.5*IT_0017;
    const ccomplex_t IT_0019 = IT_0008*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sd_R*
