...
ccomplex_return_t c_sumSqAmpl_sG_sd_L_to_u_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0011 + IT_0019 + -m_su_R*
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0005*(IT_0001*(m_W*IT_0002 + (-0.5)*IT_0000*IT_0003*IT_0019) + -1./2
      *IT_0000*IT_0002*IT_0010*IT_0026);
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = IT_0008*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0011 + IT_0019 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0000*IT_0002*IT_0005*IT_0026;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = IT_0008*IT_0035;
    const ccomplex_t IT_0037 = IT_0013*IT_0033*IT_0036;
    const ccomplex_t IT_0038 = -IT_0032 + IT_0037;
    const ccomplex_t IT_0039 = m_u*s_12;
    const ccomplex_t IT_0040 = s_12*s_23;
    const ccomplex_t IT_0041 = s_13*IT_0012;
    const ccomplex_t IT_0042 = m_u*m_sG;
