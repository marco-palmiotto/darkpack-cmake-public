...
ccomplex_return_t c_sumSqAmpl_sG_sd_L_to_u_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_su_L*
    ...
    const ccomplex_t IT_0030 = m_u*IT_0024;
