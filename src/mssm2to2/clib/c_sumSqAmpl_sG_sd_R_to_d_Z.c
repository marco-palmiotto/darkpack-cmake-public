...
ccomplex_return_t c_sumSqAmpl_sG_sd_R_to_d_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_12 + IT_0006 + -IT_0007 + -IT_0018 
      + -reg_prop, -1);
    const ccomplex_t IT_0020 = 0.333333333333333*IT_0003;
    ...
    const ccomplex_t IT_0039 = m_d*IT_0023;
