...
ccomplex_return_t c_sumSqAmpl_sG_sd_R_to_d_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = m_d*IT_0015;
    const ccomplex_t IT_0028 = IT_0026 + (-2)*IT_0027;
    const ccomplex_t IT_0029 = m_d*s_14;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0003 + m_d*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0019);
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = IT_0008*IT_0031;
    const ccomplex_t IT_0033 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_sd_L*
    ...
    const ccomplex_t IT_0041 = m_d*m_sG;
