...
ccomplex_return_t c_sumSqAmpl_sG_sd_R_to_u_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow(IT_0008, -1);
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0005*IT_0007*IT_0010*IT_0017;
    const ccomplex_t IT_0019 = 0.5*IT_0018;
    const ccomplex_t IT_0020 = IT_0004*IT_0019;
    const ccomplex_t IT_0021 = pow(m_u, 2);
    const ccomplex_t IT_0022 = cpow((-2)*s_13 + IT_0001 + IT_0021 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0023 = IT_0020*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0005*IT_0006*IT_0010*IT_0017;
    const ccomplex_t IT_0026 = 0.5*IT_0025;
    const ccomplex_t IT_0027 = IT_0004*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_d;
    const ccomplex_t IT_0029 = IT_0003*IT_0027*IT_0028;
    const ccomplex_t IT_0030 = IT_0024 + -IT_0029;
    const ccomplex_t IT_0031 = m_u*s_12;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0001 + IT_0021 + -m_su_L*
    ...
    const ccomplex_t IT_0043 = m_u*m_sG;
