...
ccomplex_return_t c_sumSqAmpl_sG_ss_L_to_c_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = cpow(IT_0015, -1);
    const ccomplex_t IT_0027 = (0 + _Complex_I*(-2.82842712474619))*V_cs*e_em
      *IT_0002*(IT_0015*(m_W*IT_0016 + (-0.5)*IT_0000*IT_0007*IT_0017) + -1./2
      *IT_0000*IT_0012*IT_0016*IT_0026);
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = IT_0005*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *IT_0000*IT_0002*IT_0016*IT_0026;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = IT_0005*IT_0035;
    const ccomplex_t IT_0037 = IT_0014*IT_0033*IT_0036;
    const ccomplex_t IT_0038 = -IT_0032 + IT_0037;
    const ccomplex_t IT_0039 = m_c*s_12;
    const ccomplex_t IT_0040 = m_c*m_sG;
