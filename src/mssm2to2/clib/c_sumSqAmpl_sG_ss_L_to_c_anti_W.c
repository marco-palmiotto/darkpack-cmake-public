...
ccomplex_return_t c_sumSqAmpl_sG_ss_L_to_c_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = cpow((-2)*s_13 + IT_0005 + IT_0006 + -m_sc_L*
    ...
    const ccomplex_t IT_0030 = m_c*IT_0024;
    const ccomplex_t IT_0031 = -IT_0030;
    const ccomplex_t IT_0032 = m_c*IT_0016;
    ...
    const ccomplex_t IT_0043 = m_c*IT_0028;
