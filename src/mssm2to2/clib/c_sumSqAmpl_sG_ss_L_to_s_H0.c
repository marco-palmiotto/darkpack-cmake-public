...
ccomplex_return_t c_sumSqAmpl_sG_ss_L_to_s_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = m_s*IT_0015;
    ...
    const ccomplex_t IT_0039 = m_s*m_sG;
