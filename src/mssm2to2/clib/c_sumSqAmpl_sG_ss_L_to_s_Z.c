...
ccomplex_return_t c_sumSqAmpl_sG_ss_L_to_s_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*m_s;
    const ccomplex_t IT_0040 = IT_0028*IT_0038*IT_0039;
    const ccomplex_t IT_0041 = m_s*IT_0030;
