...
ccomplex_return_t c_sumSqAmpl_sG_ss_R_to_s_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_ss_R*
    ...
    const ccomplex_t IT_0039 = m_s*IT_0023;
