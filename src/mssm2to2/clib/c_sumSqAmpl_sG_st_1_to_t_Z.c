...
ccomplex_return_t c_sumSqAmpl_sG_st_1_to_t_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_00;
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_10;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0003 
      + (-3)*IT_0001*IT_0006)*U_st_00*conj(U_st_01) + IT_0002*IT_0003*U_st_10
      *conj(U_st_11));
    const ccomplex_t IT_0045 = 1.33333333333333*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_11;
    const ccomplex_t IT_0047 = pow(m_t, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0012 + IT_0047 + -m_st_2*
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0003 
      + (-3)*IT_0001*IT_0006)*U_st_00*conj(U_st_00) + IT_0002*IT_0003*U_st_10
      *conj(U_st_10));
    const ccomplex_t IT_0053 = 1.33333333333333*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0012 + IT_0047 + -m_st_1*
    ...
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_01;
