...
ccomplex_return_t c_sumSqAmpl_sG_st_2_to_t_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (-0.5)*IT_0004 + 0.5*IT_0006 + (-0.5)*IT_0010 +
       0.5*IT_0013;
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_11;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_10;
    const ccomplex_t IT_0023 = m_t*e_em*mu_h*IT_0002*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0024 = IT_0001*IT_0023;
    const ccomplex_t IT_0025 = m_t*e_em*mu_h*IT_0002*conj(U_st_00)*U_st_11;
    const ccomplex_t IT_0026 = IT_0001*IT_0025;
    const ccomplex_t IT_0027 = A_t*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0028 = IT_0007*IT_0027;
    const ccomplex_t IT_0029 = 1.4142135623731*IT_0028;
    const ccomplex_t IT_0030 = A_t*conj(U_st_00)*U_st_11;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = IT_0021 + IT_0037;
    const ccomplex_t IT_0039 = 8*s_13;
    const ccomplex_t IT_0040 = pow(m_st_2, 2);
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_00;
