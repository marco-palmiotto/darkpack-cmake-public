...
ccomplex_return_t c_sumSqAmpl_sG_st_2_to_t_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_11;
    ...
    const ccomplex_t IT_0015 = (-2)*U_st_01*((0.5*m_W*IT_0011*(IT_0008 + -1./3
      *IT_0007*IT_0013) + IT_0001*IT_0002*IT_0006*IT_0008*IT_0014)*conj(U_st_01)
       + -1./2*IT_0003*IT_0004*IT_0006*IT_0008*conj(U_st_11)) + U_st_11*(IT_0003
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0014 + IT_0019 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0018*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_10;
    const ccomplex_t IT_0024 = (-2)*conj(U_st_00)*((0.5*m_W*IT_0011*(IT_0008 +
       -1./3*IT_0007*IT_0013) + IT_0001*IT_0002*IT_0006*IT_0008*IT_0014)*U_st_01
       + -1./2*IT_0003*IT_0004*IT_0006*IT_0008*U_st_11) + conj(U_st_10)*(IT_0003
      *IT_0004*IT_0006*IT_0008*U_st_01 + (-1.33333333333333)*(m_W*IT_0007
      *IT_0011*IT_0013 + 1.5*IT_0001*IT_0002*IT_0006*IT_0008*IT_0014)*U_st_11);
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0014 + IT_0019 + -m_st_1*
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_01;
    const ccomplex_t IT_0041 = IT_0017*IT_0040;
    const ccomplex_t IT_0042 = IT_0020*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_00;
