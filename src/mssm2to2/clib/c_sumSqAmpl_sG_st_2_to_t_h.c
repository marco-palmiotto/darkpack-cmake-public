...
ccomplex_return_t c_sumSqAmpl_sG_st_2_to_t_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = 2*U_st_01*(((-0.5)*m_W*IT_0012*(IT_0008 + -1./3
      *IT_0007*IT_0014) + IT_0001*IT_0002*IT_0005*IT_0008*IT_0015)*conj(U_st_01)
       + 1./2*IT_0003*IT_0005*IT_0006*IT_0008*conj(U_st_11)) + U_st_11*(IT_0003
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_13 + IT_0015 + IT_0020 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0022 = IT_0019*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_10;
    const ccomplex_t IT_0025 = 2*conj(U_st_00)*(((-0.5)*m_W*IT_0012*(IT_0008 +
       -1./3*IT_0007*IT_0014) + IT_0001*IT_0002*IT_0005*IT_0008*IT_0015)*U_st_01
       + 1./2*IT_0003*IT_0005*IT_0006*IT_0008*U_st_11) + conj(U_st_10)*(IT_0003
      *IT_0005*IT_0006*IT_0008*U_st_01 + (-1.33333333333333)*(m_W*IT_0007
      *IT_0012*IT_0014 + (-1.5)*IT_0001*IT_0002*IT_0005*IT_0008*IT_0015)*U_st_11);
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_13 + IT_0015 + IT_0020 + -m_st_1*
