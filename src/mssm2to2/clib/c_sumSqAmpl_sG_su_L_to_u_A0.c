...
ccomplex_return_t c_sumSqAmpl_sG_su_L_to_u_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_12 + IT_0007 + -IT_0008 + -IT_0012 
      + -reg_prop, -1);
    const ccomplex_t IT_0014 = cos(beta);
    const ccomplex_t IT_0015 = sin(beta);
    const ccomplex_t IT_0016 = cpow(IT_0015, -1);
    const ccomplex_t IT_0017 = m_u*e_em*IT_0000*IT_0002*IT_0014*IT_0016;
    ...
    const ccomplex_t IT_0024 = pow(m_A0, 2);
    const ccomplex_t IT_0025 = s_13*IT_0024;
    const ccomplex_t IT_0026 = s_14*s_34;
    const ccomplex_t IT_0027 = m_sG*s_34;
    const ccomplex_t IT_0028 = 8*IT_0022;
    return create_ccomplex_return(8*s_13*IT_0011*conj(IT_0011) + (-8)*IT_0023*
      (IT_0025 + (-2)*IT_0026) + (IT_0011 + conj(IT_0011))*IT_0027*IT_0028);
}
