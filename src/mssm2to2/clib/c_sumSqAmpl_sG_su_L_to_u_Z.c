...
ccomplex_return_t c_sumSqAmpl_sG_su_L_to_u_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*m_u;
    const ccomplex_t IT_0040 = IT_0028*IT_0038*IT_0039;
    const ccomplex_t IT_0041 = m_u*IT_0030;
