...
ccomplex_return_t c_sumSqAmpl_sG_su_R_to_u_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*m_u*e_em*IT_0005*IT_0007
      *IT_0008*IT_0010;
    ...
    const ccomplex_t IT_0017 = m_u*IT_0015;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*e_em*(1.5*IT_0000*IT_0005
      *IT_0007*IT_0008*IT_0010 + -m_W*IT_0009*IT_0019*(IT_0006*IT_0008 + 
      -IT_0020*IT_0021));
    ...
    const ccomplex_t IT_0029 = m_u*s_14;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0005
      *IT_0007*IT_0010*IT_0021;
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = IT_0004*IT_0031;
    const ccomplex_t IT_0033 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_su_L*
    ...
    const ccomplex_t IT_0041 = m_u*m_sG;
