...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_1_to_A_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sb_1
    ...
    const ccomplex_t IT_0014 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sb_1
      *Gamma_b1 + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0041 = IT_0007 + IT_0037;
    const ccomplex_t IT_0042 = -IT_0013 + -IT_0027;
