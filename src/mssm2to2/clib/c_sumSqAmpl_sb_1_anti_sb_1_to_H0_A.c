...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_1_to_H0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = 0.666666666666667*IT_0027;
    ...
    const ccomplex_t IT_0038 = (-0.333333333333333)*conj(IT_0030);
    const ccomplex_t IT_0039 = IT_0030*(conj(IT_0032)*IT_0033 + conj(IT_0035)
      *IT_0036) + (-3)*IT_0032*(s_23*conj(IT_0035) + conj(IT_0032)*IT_0037 +
       IT_0033*IT_0038) + (-3)*IT_0035*(s_23*conj(IT_0032) + IT_0000*conj
