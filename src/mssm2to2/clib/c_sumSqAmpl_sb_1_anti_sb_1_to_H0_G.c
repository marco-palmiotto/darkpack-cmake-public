...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_1_to_H0_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (-2)*IT_0027;
    const ccomplex_t IT_0032 = IT_0026*IT_0031;
    const ccomplex_t IT_0033 = (-4)*s_24;
    const ccomplex_t IT_0034 = IT_0022*IT_0031;
    const ccomplex_t IT_0035 = -IT_0034;
    const ccomplex_t IT_0036 = (-4)*s_34;
    const ccomplex_t IT_0037 = pow(m_sb_1, 2);
    const ccomplex_t IT_0038 = (-0.25)*conj(IT_0030);
    const ccomplex_t IT_0039 = IT_0030*(conj(IT_0032)*IT_0033 + conj(IT_0035)
      *IT_0036) + (-4)*IT_0032*(s_23*conj(IT_0035) + conj(IT_0032)*IT_0037 +
       IT_0033*IT_0038) + (-4)*IT_0035*(s_23*conj(IT_0032) + IT_0000*conj
      (IT_0035) + IT_0036*IT_0038);
