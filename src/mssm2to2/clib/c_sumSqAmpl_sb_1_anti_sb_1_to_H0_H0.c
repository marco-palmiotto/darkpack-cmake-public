        ...
        )
{
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0000 + IT_0026 + -m_ss_L*
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0000 + IT_0026 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0032*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0000 + IT_0026 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0000 + IT_0026 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0047 = IT_0042*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0003*conj(U_sb_00);
    const ccomplex_t IT_0050 = (-0.5)*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_ts)*IT_0003*U_sb_00;
    const ccomplex_t IT_0052 = (-0.5)*IT_0051;
    const ccomplex_t IT_0053 = IT_0050*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0000 + IT_0026 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0053*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0000 + IT_0026 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0062 = IT_0003*IT_0011;
    const ccomplex_t IT_0063 = IT_0061 + IT_0062;
    const ccomplex_t IT_0064 = 2*U_sb_00*((IT_0004*IT_0007*IT_0008*IT_0010
      *IT_0017 + (-0.5)*m_W*(IT_0010 + 1./3*IT_0009*IT_0016)*IT_0063)*conj
      ...
      *IT_0008*IT_0010*IT_0017 + -1./3*m_W*IT_0009*IT_0016*IT_0063)*conj(U_sb_10
      ));
    ...
    const ccomplex_t IT_0067 = IT_0009*IT_0016;
    const ccomplex_t IT_0068 = IT_0010 + IT_0067;
    const ccomplex_t IT_0069 = cpow(IT_0008, 3);
    const ccomplex_t IT_0070 = cpow(IT_0008, 2);
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_W*e_em*IT_0068*(IT_0006
      *IT_0069 + 5*IT_0003*((-1)*IT_0003*(IT_0006*IT_0008 + 1./5*IT_0003*IT_0011
      ) + IT_0011*IT_0070));
    ...
    const ccomplex_t IT_0076 = cpow((-2)*s_12 + (-2)*IT_0026 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0077 = cpow(IT_0003, 2);
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*m_W*e_em*IT_0068*(IT_0011
      *IT_0069 + -IT_0003*(IT_0003*IT_0008*IT_0011 + IT_0006*(IT_0070 + -IT_0077
      )));
    ...
    const ccomplex_t IT_0083 = cpow((-2)*s_23 + IT_0000 + IT_0026 + -m_sd_L*
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_13 + IT_0000 + IT_0026 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0092 = IT_0088*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*IT_0092;
    const ccomplex_t IT_0094 = cpow((-2)*s_13 + IT_0000 + IT_0026 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0095 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0014*
      (IT_0010 + 1./3*IT_0009*IT_0016) + IT_0003*IT_0004*IT_0007*IT_0010*IT_0017
      )*U_sb_01 + -1./2*IT_0005*IT_0007*IT_0008*IT_0010*U_sb_11) + conj(U_sb_10)
      *(IT_0005*IT_0007*IT_0008*IT_0010*U_sb_01 + 0.666666666666667*(m_W*IT_0009
      *IT_0014*IT_0016 + (-3)*IT_0003*IT_0004*IT_0007*IT_0010*IT_0017)*U_sb_11);
    const ccomplex_t IT_0096 = (0 + _Complex_I*-1)*(e_em*IT_0095 + (
      -1.4142135623731)*A_b*IT_0002*IT_0003*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0097 = (-0.5)*IT_0096;
    const ccomplex_t IT_0098 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0014*(IT_0010 + 1.
      /3*IT_0009*IT_0016) + IT_0003*IT_0004*IT_0007*IT_0010*IT_0017)*conj
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_23 + IT_0000 + IT_0026 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0105 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0014*
      (IT_0010 + 1./3*IT_0009*IT_0016) + IT_0003*IT_0004*IT_0007*IT_0010*IT_0017
      )*U_sb_01 + -1./2*IT_0005*IT_0007*IT_0008*IT_0010*U_sb_11) + conj(U_sb_10)
      *(IT_0005*IT_0007*IT_0008*IT_0010*U_sb_01 + 0.666666666666667*(m_W*IT_0009
      *IT_0014*IT_0016 + (-3)*IT_0003*IT_0004*IT_0007*IT_0010*IT_0017)*U_sb_11);
    ...
    const ccomplex_t IT_0108 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0014*(IT_0010 + 1.
      /3*IT_0009*IT_0016) + IT_0003*IT_0004*IT_0007*IT_0010*IT_0017)*conj
      (U_sb_01) + -1./2*IT_0005*IT_0007*IT_0008*IT_0010*conj(U_sb_11)) + U_sb_10
      *(IT_0005*IT_0007*IT_0008*IT_0010*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0009*IT_0014*IT_0016 + (-3)*IT_0003*IT_0004*IT_0007*IT_0010*IT_0017)
    ...
    const ccomplex_t IT_0115 = -IT_0077;
    const ccomplex_t IT_0116 = pow(m_W, -2);
    const ccomplex_t IT_0117 = cpow(IT_0006, -2);
    const ccomplex_t IT_0118 = cpow(IT_0009, -2);
    const ccomplex_t IT_0119 = 0.5*(IT_0070*(IT_0016 + 3*IT_0118) + IT_0115*
      (IT_0016 + 3*(1 + (-2)*IT_0017*IT_0116*IT_0117)*IT_0118))*U_sb_00*conj
      (U_sb_00) + (IT_0016*IT_0070 + IT_0115*(IT_0016 + (-3)*IT_0017*IT_0116
    ...
    const ccomplex_t IT_0122 = IT_0023 + IT_0025 + IT_0034 + IT_0037 + IT_0045
       + IT_0048 + IT_0056 + IT_0059 + -IT_0075 + -IT_0082 + IT_0090 + IT_0093 +
