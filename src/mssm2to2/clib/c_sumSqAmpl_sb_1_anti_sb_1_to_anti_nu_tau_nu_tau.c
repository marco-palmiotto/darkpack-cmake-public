...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_1_to_anti_nu_tau_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = s_13*s_14;
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0004
    ...
    return create_ccomplex_return((12*IT_0000 + (-6)*IT_0002)*IT_0019*conj
      (IT_0019));
}
