...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_1_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_s*e_em*IT_0003*IT_0024
      *IT_0026*IT_0027;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_s*e_em*IT_0003*IT_0024
      *IT_0026*IT_0032;
    ...
    const ccomplex_t IT_0059 = -IT_0023;
    ...
    const ccomplex_t IT_0064 = 18*s_34;
    const ccomplex_t IT_0065 = IT_0063 + IT_0064;
    const ccomplex_t IT_0066 = m_s*e_em*IT_0003*IT_0024*IT_0026*IT_0033;
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = m_b*e_em*mu_h*IT_0024*conj(U_sb_00)*U_sb_10;
    const ccomplex_t IT_0069 = IT_0003*IT_0068;
    const ccomplex_t IT_0070 = m_b*e_em*mu_h*IT_0024*U_sb_00*conj(U_sb_10);
    const ccomplex_t IT_0071 = IT_0003*IT_0070;
    const ccomplex_t IT_0072 = A_b*IT_0030*conj(U_sb_00)*U_sb_10;
    const ccomplex_t IT_0073 = IT_0033*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = A_b*IT_0030*U_sb_00*conj(U_sb_10);
    const ccomplex_t IT_0076 = IT_0033*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = (-0.5)*IT_0069 + 0.5*IT_0071 + (-0.5)*IT_0074 +
       0.5*IT_0077;
    const ccomplex_t IT_0079 = IT_0067*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_12 + (-2)*IT_0009 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_12 + (-2)*IT_0009 + IT_0083 + 
      -reg_prop, -1);
    const ccomplex_t IT_0085 = m_s*e_em*IT_0003*IT_0024;
    const ccomplex_t IT_0086 = 0.5*IT_0085;
    const ccomplex_t IT_0087 = IT_0003*IT_0026*IT_0033;
    const ccomplex_t IT_0088 = IT_0068*IT_0087;
    const ccomplex_t IT_0089 = IT_0070*IT_0087;
    const ccomplex_t IT_0090 = IT_0025*IT_0072;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = IT_0025*IT_0075;
    ...
    const ccomplex_t IT_0100 = (-18)*s_34 + IT_0063;
    ...
    const ccomplex_t IT_0118 = (-18)*IT_0023;
    const ccomplex_t IT_0119 = 0.25*IT_0106;
    const ccomplex_t IT_0120 = (-3)*IT_0113*(conj(IT_0023) + (-2)*IT_0058 + 2
      *conj(IT_0058) + -IT_0061 + 0.0555555555555556*IT_0118) + (IT_0023 + -conj
      (IT_0023) + 2*IT_0058 + (-2)*conj(IT_0058) + IT_0061 + -conj(IT_0061))
      *IT_0119;
    const ccomplex_t IT_0121 = (-18)*conj(IT_0023);
    const ccomplex_t IT_0122 = cpow(IT_0113, 2);
    const ccomplex_t IT_0123 = s_34*IT_0009;
    const ccomplex_t IT_0124 = (-36)*IT_0123;
    const ccomplex_t IT_0125 = IT_0009*IT_0062;
    ...
    const ccomplex_t IT_0154 = (-18)*IT_0142;
    const ccomplex_t IT_0155 = IT_0113*IT_0146;
    const ccomplex_t IT_0156 = IT_0119*IT_0151;
    const ccomplex_t IT_0157 = IT_0058*IT_0117;
    const ccomplex_t IT_0158 = (conj(IT_0023)*IT_0058 + conj(IT_0058)*(IT_0023
       + IT_0061))*IT_0065 + conj(IT_0023)*(IT_0023*IT_0064 + (18*IT_0062 +
       IT_0064)*IT_0098) + IT_0058*conj(IT_0058)*((-36)*IT_0062 + IT_0099) +
       conj(IT_0098)*(IT_0023*(18*IT_0062 + IT_0064) + IT_0098*(36*IT_0062 +
       IT_0099) + IT_0061*IT_0100) + conj(IT_0061)*(IT_0061*IT_0064 + IT_0058
      *IT_0065 + IT_0098*IT_0100 + IT_0113*IT_0117 + IT_0062*IT_0118) + (-6)
      *IT_0116*IT_0120 + IT_0061*IT_0062*IT_0121 + IT_0122*IT_0130 + (-2)
      *IT_0119*(IT_0113*((-12)*IT_0123 + (-12)*IT_0125 + 24*IT_0127) + (-0.5)
      *IT_0119*IT_0130) + IT_0132*(18*conj(IT_0023)*IT_0133 + conj(IT_0132)
      *IT_0136 + conj(IT_0138)*IT_0139 + IT_0140 + conj(IT_0098)*IT_0143 + conj
      (IT_0061)*IT_0145 + IT_0147 + IT_0152) + IT_0138*(IT_0136*conj(IT_0138) +
       conj(IT_0132)*IT_0139 + IT_0140 + IT_0121*IT_0144 + IT_0147 + IT_0152 +
       conj(IT_0061)*IT_0153 + conj(IT_0098)*IT_0154) + conj(IT_0132)*(18
      *IT_0023*IT_0133 + IT_0098*IT_0143 + IT_0061*IT_0145 + IT_0155 + IT_0156 +
       IT_0157) + conj(IT_0138)*(IT_0118*IT_0144 + IT_0061*IT_0153 + IT_0098
