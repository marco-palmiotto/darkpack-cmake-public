...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_1_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*m_tau*IT_0003*IT_0024
      *IT_0026*IT_0027;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*m_tau*IT_0003*IT_0024
      *IT_0026*IT_0032;
    ...
    const ccomplex_t IT_0074 = e_em*m_tau*IT_0003*IT_0024*IT_0026*IT_0033;
    ...
    const ccomplex_t IT_0092 = cpow((-2)*s_12 + (-2)*IT_0009 + IT_0091 + 
      -reg_prop, -1);
    const ccomplex_t IT_0093 = e_em*m_tau*IT_0003*IT_0024;
    ...
    const ccomplex_t IT_0119 = s_13*m_tau;
    const ccomplex_t IT_0120 = conj(IT_0058)*IT_0072;
    const ccomplex_t IT_0121 = s_14*m_tau;
    ...
    const ccomplex_t IT_0131 = IT_0116 + IT_0118;
