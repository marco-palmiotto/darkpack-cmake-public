...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_1_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = 2*conj(U_sb_00)*(((-0.5)*m_W*IT_0015*(IT_0011 +
       1./3*IT_0010*IT_0017) + IT_0004*IT_0005*IT_0008*IT_0011*IT_0018)*U_sb_01 
      + 1./2*IT_0006*IT_0008*IT_0009*IT_0011*U_sb_11) + conj(U_sb_10)*(IT_0006
      *IT_0008*IT_0009*IT_0011*U_sb_01 + (-0.666666666666667)*(m_W*IT_0010
    ...
    const ccomplex_t IT_0029 = 2*U_sb_00*(((-0.5)*m_W*IT_0015*(IT_0011 + 1./3
      *IT_0010*IT_0017) + IT_0004*IT_0005*IT_0008*IT_0011*IT_0018)*conj(U_sb_00)
       + 1./2*IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_10)) + U_sb_10*(IT_0006
      *IT_0008*IT_0009*IT_0011*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0010
    ...
    const ccomplex_t IT_0051 = e_em*IT_0011*(IT_0007*IT_0009 + IT_0004*IT_0013
      )*IT_0024;
    const ccomplex_t IT_0052 = -IT_0051;
    const ccomplex_t IT_0053 = IT_0050*IT_0052;
    const ccomplex_t IT_0054 = pow(m_Z, 2);
    const ccomplex_t IT_0055 = cpow((-2)*s_12 + (-2)*IT_0001 + IT_0054 + 
      -reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0008*IT_0011*IT_0013;
    const ccomplex_t IT_0057 = IT_0038*IT_0056;
    const ccomplex_t IT_0058 = IT_0040*IT_0056;
    const ccomplex_t IT_0059 = IT_0007*IT_0042;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = IT_0007*IT_0045;
    ...
    const ccomplex_t IT_0066 = -e_em*IT_0011*(IT_0004*IT_0007 + -IT_0009
      *IT_0013)*IT_0024;
    const ccomplex_t IT_0067 = -IT_0066;
    const ccomplex_t IT_0068 = IT_0065*IT_0067;
    const ccomplex_t IT_0069 = -IT_0027 + -IT_0036 + IT_0053 + IT_0068;
    ...
    const ccomplex_t IT_0074 = m_W*e_em;
    const ccomplex_t IT_0075 = cpow(IT_0016, -4);
    const ccomplex_t IT_0076 = IT_0009*IT_0010*IT_0013*IT_0075;
    const ccomplex_t IT_0077 = IT_0004*IT_0007*IT_0010*IT_0075;
    const ccomplex_t IT_0078 = cpow(IT_0010, -3);
    const ccomplex_t IT_0079 = IT_0009*IT_0013*IT_0078;
    const ccomplex_t IT_0080 = IT_0004*IT_0007*IT_0078;
    const ccomplex_t IT_0081 = IT_0009*IT_0011*IT_0013*IT_0017;
    const ccomplex_t IT_0082 = IT_0004*IT_0007*IT_0011*IT_0017;
    const ccomplex_t IT_0083 = cpow(IT_0010, -2);
    const ccomplex_t IT_0084 = cpow(IT_0017 + IT_0083, -1);
    const ccomplex_t IT_0085 = (IT_0076 + -IT_0077 + IT_0079 + -IT_0080 + 2
      *IT_0081 + (-2)*IT_0082)*IT_0084;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*e_em*((-1.5)*(IT_0011
    ...
    const ccomplex_t IT_0110 = cpow((-2)*s_13 + IT_0000 + (0 + _Complex_I*1)
      *m_sb_1*Gamma_b1 + reg_prop, -1);
    const ccomplex_t IT_0111 = 2*U_sb_00*(((-0.5)*m_W*IT_0015*(IT_0011 + 1./3
      *IT_0010*IT_0017) + IT_0004*IT_0005*IT_0008*IT_0011*IT_0018)*conj(U_sb_00)
       + 1./2*IT_0006*IT_0008*IT_0009*IT_0011*conj(U_sb_10)) + U_sb_10*(IT_0006
      *IT_0008*IT_0009*IT_0011*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0010
      *IT_0015*IT_0017 + (-3)*IT_0004*IT_0005*IT_0008*IT_0011*IT_0018)*conj
    ...
    const ccomplex_t IT_0117 = -IT_0035;
    const ccomplex_t IT_0118 = IT_0090 + IT_0117;
    const ccomplex_t IT_0119 = IT_0089*IT_0118;
    const ccomplex_t IT_0120 = IT_0027 + IT_0036 + IT_0109 + IT_0116 + -IT_0119;
    const ccomplex_t IT_0121 = (-0.333333333333333)*conj(IT_0120);
    const ccomplex_t IT_0122 = pow(s_14, 2);
    const ccomplex_t IT_0123 = IT_0070*IT_0122;
    const ccomplex_t IT_0124 = s_14*s_24*IT_0070;
    const ccomplex_t IT_0125 = (-3)*s_12 + 3*IT_0124;
    const ccomplex_t IT_0126 = (-0.333333333333333)*conj(IT_0069);
    const ccomplex_t IT_0127 = pow(s_24, 2);
    const ccomplex_t IT_0128 = IT_0070*IT_0127;
    const ccomplex_t IT_0129 = (-3)*IT_0069*(conj(IT_0069)*(IT_0000 + -IT_0072
      ) + (-0.333333333333333)*conj(IT_0092)*IT_0096 + IT_0100*IT_0121) + (-3)
      *IT_0092*(conj(IT_0092)*(IT_0001 + -IT_0123) + IT_0121*IT_0125 + IT_0096
      *IT_0126) + (-3)*IT_0120*((-0.333333333333333)*conj(IT_0092)*IT_0125 +
       IT_0100*IT_0126 + conj(IT_0120)*(IT_0001 + -IT_0128));
