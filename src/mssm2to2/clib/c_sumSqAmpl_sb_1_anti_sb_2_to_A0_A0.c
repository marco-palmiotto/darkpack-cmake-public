        ...
        )
{
    ...
    const ccomplex_t IT_0011 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0000
      *U_sb_00;
    const ccomplex_t IT_0012 = 0.5*IT_0011;
    const ccomplex_t IT_0013 = 1.4142135623731*A_b*V_tb*V_ts*IT_0000*conj
      (U_sb_01);
    const ccomplex_t IT_0014 = (-0.5)*IT_0013;
    const ccomplex_t IT_0015 = IT_0012*IT_0014;
    const ccomplex_t IT_0016 = pow(m_sb_2, 2);
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0006 + IT_0016 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0018 = IT_0015*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0015*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*IT_0021;
    const ccomplex_t IT_0023 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0000
      *U_sb_10;
    const ccomplex_t IT_0024 = (-0.5)*IT_0023;
    const ccomplex_t IT_0025 = 1.4142135623731*A_b*V_tb*V_td*IT_0000*conj
      (U_sb_11);
    const ccomplex_t IT_0026 = 0.5*IT_0025;
    const ccomplex_t IT_0027 = IT_0024*IT_0026;
    const ccomplex_t IT_0028 = cpow((-2)*s_23 + IT_0006 + IT_0016 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0029 = IT_0027*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*IT_0029;
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0048 = (-0.5)*IT_0038 + 0.5*IT_0040 + (-0.5)*IT_0044 +
       0.5*IT_0047;
    const ccomplex_t IT_0049 = m_b*e_em*mu_h*IT_0036*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0050 = IT_0035*IT_0049;
    const ccomplex_t IT_0051 = m_b*e_em*mu_h*IT_0036*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0052 = IT_0035*IT_0051;
    const ccomplex_t IT_0053 = A_b*IT_0041*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0054 = IT_0000*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = A_b*IT_0041*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0006 + IT_0016 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0006 + (0 + _Complex_I*1)
      *m_sb_1*Gamma_b1 + reg_prop, -1);
    const ccomplex_t IT_0065 = IT_0060*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0000
      *U_sb_10;
    const ccomplex_t IT_0068 = (-0.5)*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*A_b*V_tb*V_ts*IT_0000*conj
      (U_sb_11);
    const ccomplex_t IT_0070 = 0.5*IT_0069;
    const ccomplex_t IT_0071 = IT_0068*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = cpow((-2)*s_23 + IT_0006 + IT_0016 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0071*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = m_b*e_em*mu_h*IT_0036*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0079 = IT_0035*IT_0078;
    const ccomplex_t IT_0080 = m_b*e_em*mu_h*IT_0036*U_sb_01*conj(U_sb_11);
    const ccomplex_t IT_0081 = IT_0035*IT_0080;
    const ccomplex_t IT_0082 = A_b*IT_0041*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0083 = IT_0000*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = A_b*IT_0041*U_sb_01*conj(U_sb_11);
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_23 + IT_0006 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    const ccomplex_t IT_0091 = IT_0089*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_sb_2*
    ...
    const ccomplex_t IT_0100 = cos(alpha);
    const ccomplex_t IT_0101 = cpow(IT_0000, 3);
    const ccomplex_t IT_0102 = cos(beta);
    const ccomplex_t IT_0103 = cpow(IT_0000, 2);
    const ccomplex_t IT_0104 = sin(alpha);
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*m_W*e_em*IT_0099*(IT_0100
      *IT_0101 + IT_0102*(IT_0103*IT_0104 + -IT_0102*(IT_0000*IT_0100 + IT_0102
      *IT_0104)));
    const ccomplex_t IT_0106 = 0.5*IT_0105;
    const ccomplex_t IT_0107 = m_b*mu_h*IT_0036;
    const ccomplex_t IT_0108 = cpow(IT_0102, -1);
    const ccomplex_t IT_0109 = IT_0102*IT_0104;
    const ccomplex_t IT_0110 = IT_0000*IT_0100;
    const ccomplex_t IT_0111 = IT_0109 + IT_0110;
    const ccomplex_t IT_0112 = pow(m_b, 2);
    const ccomplex_t IT_0113 = 2*U_sb_00*(((-0.5)*m_W*(IT_0035 + 1./3*IT_0034
      *IT_0097)*IT_0111 + IT_0035*IT_0036*IT_0104*IT_0108*IT_0112)*conj(U_sb_01)
       + 1./2*IT_0035*IT_0100*IT_0107*IT_0108*conj(U_sb_11)) + U_sb_10*(IT_0035
      *IT_0100*IT_0107*IT_0108*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0034
      *IT_0097*IT_0111 + (-3)*IT_0035*IT_0036*IT_0104*IT_0108*IT_0112)*conj
      (U_sb_11));
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*(e_em*IT_0113 +
       1.4142135623731*A_b*IT_0041*IT_0104*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0120 = -IT_0102;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*m_W*e_em*IT_0099*(IT_0101
      *IT_0104 + IT_0120*(IT_0100*IT_0103 + (IT_0100*IT_0102 + -IT_0000*IT_0104)
      *IT_0120));
    const ccomplex_t IT_0122 = 0.5*IT_0121;
    const ccomplex_t IT_0123 = -IT_0000*IT_0104;
    const ccomplex_t IT_0124 = IT_0100*IT_0102;
    const ccomplex_t IT_0125 = IT_0123 + IT_0124;
    const ccomplex_t IT_0126 = (-2)*U_sb_00*((IT_0035*IT_0036*IT_0100*IT_0108
      *IT_0112 + (-0.5)*m_W*(IT_0035 + 1./3*IT_0034*IT_0097)*IT_0125)*conj
      (U_sb_01) + -1./2*IT_0035*IT_0104*IT_0107*IT_0108*conj(U_sb_11)) + U_sb_10
      *(IT_0035*IT_0104*IT_0107*IT_0108*conj(U_sb_01) + (-2)*(IT_0035*IT_0036
      *IT_0100*IT_0108*IT_0112 + -1./3*m_W*IT_0034*IT_0097*IT_0125)*conj(U_sb_11
      ));
    const ccomplex_t IT_0127 = (0 + _Complex_I*-1)*(e_em*IT_0126 + (
      -1.4142135623731)*A_b*IT_0041*IT_0100*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0128 = (-0.5)*IT_0127;
    const ccomplex_t IT_0129 = IT_0122*IT_0128;
    const ccomplex_t IT_0130 = cpow((-2)*s_12 + -IT_0007 + -IT_0016 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0131 = IT_0129*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*IT_0131;
    const ccomplex_t IT_0133 = cpow((-2)*s_23 + IT_0006 + IT_0016 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0137 = -IT_0103;
    const ccomplex_t IT_0138 = cpow(IT_0102, 2);
    const ccomplex_t IT_0139 = pow(m_W, -2);
    const ccomplex_t IT_0140 = cpow(IT_0102, -2);
    const ccomplex_t IT_0141 = cpow(IT_0034, -2);
    const ccomplex_t IT_0142 = 0.5*(IT_0138*(IT_0097 + 3*IT_0141) + IT_0137*
      (IT_0097 + 3*(1 + (-2)*IT_0112*IT_0139*IT_0140)*IT_0141))*U_sb_00*conj
      (U_sb_01) + (IT_0097*(IT_0137 + IT_0138) + 3*IT_0103*IT_0112*IT_0139
    ...
    const ccomplex_t IT_0145 = IT_0010 + IT_0019 + IT_0022 + IT_0030 + IT_0033
       + IT_0063 + IT_0066 + IT_0074 + IT_0077 + IT_0092 + IT_0095 + -IT_0119 + 
      -IT_0132 + IT_0135 + IT_0144;
