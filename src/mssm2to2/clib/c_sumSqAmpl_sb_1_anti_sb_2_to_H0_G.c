...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_2_to_H0_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (-4)*s_23;
    const ccomplex_t IT_0035 = -IT_0000;
    const ccomplex_t IT_0036 = IT_0030*IT_0035;
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = (-4)*s_24;
    const ccomplex_t IT_0039 = (-4)*s_34;
    const ccomplex_t IT_0040 = (-4)*IT_0031*(IT_0022*conj(IT_0031) + (-0.25)
      *conj(IT_0033)*IT_0034 + (-0.25)*conj(IT_0037)*IT_0038) + IT_0037*(conj
      (IT_0031)*IT_0038 + conj(IT_0033)*IT_0039) + (-4)*IT_0033*(IT_0021*conj
      (IT_0033) + (-0.25)*conj(IT_0031)*IT_0034 + (-0.25)*conj(IT_0037)*IT_0039);
