...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_2_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0041 = -IT_0010*IT_0011;
    const ccomplex_t IT_0042 = IT_0006*IT_0007;
    const ccomplex_t IT_0043 = IT_0041 + IT_0042;
    const ccomplex_t IT_0044 = pow(m_b, 2);
    const ccomplex_t IT_0045 = (-2)*U_sb_00*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0043 + IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_11)) + U_sb_10
      *(IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0043 + (-3)*IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)
      *conj(U_sb_11));
    const ccomplex_t IT_0046 = (0 + _Complex_I*-1)*(e_em*IT_0045 + (
      -1.4142135623731)*A_b*IT_0007*IT_0037*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0047 = (-0.5)*IT_0046;
    const ccomplex_t IT_0048 = pow(m_H0, 2);
    ...
    const ccomplex_t IT_0053 = e_em*IT_0001*IT_0003*(IT_0007*IT_0010 + 
      -IT_0006*IT_0011);
    const ccomplex_t IT_0054 = m_b*e_em*mu_h*IT_0038*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0055 = IT_0003*IT_0054;
    const ccomplex_t IT_0056 = m_b*e_em*mu_h*IT_0038*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0057 = IT_0003*IT_0056;
    const ccomplex_t IT_0058 = A_b*IT_0037*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0059 = IT_0010*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = A_b*IT_0037*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0070 = (-2)*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0043 + IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_11)) + U_sb_11
      *(IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0043 + (-3)*IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)
      *conj(U_sb_11));
    const ccomplex_t IT_0071 = (0 + _Complex_I*-1)*(e_em*IT_0070 + (
      -1.4142135623731)*A_b*IT_0007*IT_0037*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    const ccomplex_t IT_0072 = (-0.5)*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0048 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0077 = e_em*IT_0001*IT_0003*(IT_0006*IT_0007 + IT_0010
      *IT_0011);
    const ccomplex_t IT_0078 = -IT_0077;
    const ccomplex_t IT_0079 = IT_0003*IT_0010*IT_0040;
    const ccomplex_t IT_0080 = IT_0054*IT_0079;
    const ccomplex_t IT_0081 = IT_0056*IT_0079;
    const ccomplex_t IT_0082 = IT_0006*IT_0058;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = IT_0006*IT_0061;
    ...
    const ccomplex_t IT_0098 = (-2)*U_sb_00*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0043 + IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_11)) + U_sb_10
      *(IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0043 + (-3)*IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)
    ...
    const ccomplex_t IT_0101 = cpow((-2)*s_13 + IT_0025 + IT_0048 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0102 = IT_0100*IT_0101;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*IT_0102;
    const ccomplex_t IT_0104 = IT_0097*IT_0103;
    const ccomplex_t IT_0105 = (-2)*U_sb_00*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0043 + IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)*conj
      (U_sb_00) + -1./2*IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_10)) + U_sb_10
      *(IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0043 + (-3)*IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)
      *conj(U_sb_10));
    const ccomplex_t IT_0106 = (0 + _Complex_I*-1)*(e_em*IT_0105 + (
      -1.4142135623731)*A_b*IT_0007*IT_0037*(conj(U_sb_00)*U_sb_10 + U_sb_00
      *conj(U_sb_10)));
    const ccomplex_t IT_0107 = (-0.5)*IT_0106;
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0048 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0112 = (-2)*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0043 + IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_11)) + U_sb_11
      *(IT_0003*IT_0011*IT_0039*IT_0040*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0043 + (-3)*IT_0003*IT_0007*IT_0038*IT_0040*IT_0044)
    ...
    const ccomplex_t IT_0115 = IT_0073*IT_0114;
    ...
    const ccomplex_t IT_0121 = IT_0052 + IT_0104 + IT_0111 + IT_0117 + -IT_0120;
    const ccomplex_t IT_0122 = s_14*s_24*IT_0032;
    const ccomplex_t IT_0123 = -IT_0122;
    const ccomplex_t IT_0124 = s_12 + IT_0123;
    const ccomplex_t IT_0125 = (-3)*conj(IT_0031);
    const ccomplex_t IT_0126 = pow(s_34, 2);
    const ccomplex_t IT_0127 = IT_0032*IT_0126;
    const ccomplex_t IT_0128 = s_24*s_34*IT_0032;
    ...
    const ccomplex_t IT_0134 = (-3)*IT_0031*(conj(IT_0031)*(IT_0025 + -IT_0034
      ) + conj(IT_0092)*IT_0095 + conj(IT_0121)*IT_0124) + IT_0121*IT_0124
      *IT_0125 + (-3)*IT_0092*((-0.333333333333333)*IT_0095*IT_0125 + conj
      (IT_0092)*(IT_0048 + -IT_0127) + conj(IT_0121)*IT_0130) + (conj(IT_0092)
      *IT_0130 + conj(IT_0121)*(IT_0026 + -IT_0132))*IT_0133;
