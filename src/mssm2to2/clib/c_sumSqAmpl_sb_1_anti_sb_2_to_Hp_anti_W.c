        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002
      *IT_0005*(m_W*IT_0006*IT_0007*conj(U_sb_01) + (-0.5)*IT_0008*(IT_0006
      *IT_0009*IT_0010*conj(U_sb_01) + m_b*(m_b*IT_0007*IT_0011*conj(U_sb_01) +
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_su_L*
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0002*U_sb_00*conj(U_st_00);
    const ccomplex_t IT_0021 = -IT_0020;
    const ccomplex_t IT_0022 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0010*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0007*IT_0011*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0010*IT_0011*U_st_10));
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0002*((-0.5)*IT_0008
      *IT_0022 + m_W*IT_0006*IT_0007*conj(U_sb_01)*U_st_00) + A_t*IT_0006*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_st_1*
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0002*U_sb_00*conj(U_st_01);
    const ccomplex_t IT_0029 = -IT_0028;
    const ccomplex_t IT_0030 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0010*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0007*IT_0011*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0010*IT_0011*U_st_11));
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0002*((-0.5)*IT_0008
      *IT_0030 + m_W*IT_0006*IT_0007*conj(U_sb_01)*U_st_01) + A_t*IT_0006*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_st_2*
    ...
    const ccomplex_t IT_0036 = e_em*IT_0002;
    const ccomplex_t IT_0037 = m_b*e_em*mu_h*IT_0008*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0038 = IT_0002*IT_0037;
    const ccomplex_t IT_0039 = m_b*e_em*mu_h*IT_0008*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + -IT_0015 + -IT_0049 + m_A0*
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*e_em*IT_0002*(IT_0007
      *IT_0054 + -IT_0006*IT_0055);
    const ccomplex_t IT_0057 = m_b*mu_h*IT_0008;
    const ccomplex_t IT_0058 = -IT_0007*IT_0055;
    const ccomplex_t IT_0059 = IT_0006*IT_0054;
    const ccomplex_t IT_0060 = IT_0058 + IT_0059;
    const ccomplex_t IT_0061 = cos(theta_W);
    const ccomplex_t IT_0062 = cpow(IT_0061, -2);
    const ccomplex_t IT_0063 = pow(m_b, 2);
    const ccomplex_t IT_0064 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0060*(IT_0002 + 1.
      /3*IT_0001*IT_0062) + IT_0002*IT_0008*IT_0011*IT_0054*IT_0063)*conj
      (U_sb_01) + -1./2*IT_0002*IT_0011*IT_0055*IT_0057*conj(U_sb_11)) + U_sb_10
      *(IT_0002*IT_0011*IT_0055*IT_0057*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0001*IT_0060*IT_0062 + (-3)*IT_0002*IT_0008*IT_0011*IT_0054*IT_0063)
      *conj(U_sb_11));
    const ccomplex_t IT_0065 = (0 + _Complex_I*-1)*(e_em*IT_0064 + (
      -1.4142135623731)*A_b*IT_0041*IT_0054*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_12 + -IT_0015 + -IT_0049 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = IT_0056*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*e_em*IT_0002*(IT_0006
      *IT_0054 + IT_0007*IT_0055);
    const ccomplex_t IT_0072 = -IT_0071;
    const ccomplex_t IT_0073 = IT_0006*IT_0055;
    const ccomplex_t IT_0074 = IT_0007*IT_0054;
    const ccomplex_t IT_0075 = IT_0073 + IT_0074;
    const ccomplex_t IT_0076 = 2*U_sb_00*((IT_0002*IT_0008*IT_0011*IT_0055
      *IT_0063 + (-0.5)*m_W*(IT_0002 + 1./3*IT_0001*IT_0062)*IT_0075)*conj
      (U_sb_01) + 1./2*IT_0002*IT_0011*IT_0054*IT_0057*conj(U_sb_11)) + U_sb_10*
      (IT_0002*IT_0011*IT_0054*IT_0057*conj(U_sb_01) + 2*(IT_0002*IT_0008
      *IT_0011*IT_0055*IT_0063 + -1./3*m_W*IT_0001*IT_0062*IT_0075)*conj(U_sb_11
      ));
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*(e_em*IT_0076 +
       1.4142135623731*A_b*IT_0041*IT_0055*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    const ccomplex_t IT_0078 = 0.5*IT_0077;
    const ccomplex_t IT_0079 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0015 + -IT_0049 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0002*(m_W*IT_0006*IT_0007*conj(U_sb_01) + (-0.5)*IT_0008*(IT_0006
      *IT_0010*IT_0085*conj(U_sb_01) + m_b*(m_b*IT_0007*IT_0011*conj(U_sb_01) +
       mu_h*conj(U_sb_11))));
    const ccomplex_t IT_0087 = -IT_0086;
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = IT_0084*IT_0090;
    const ccomplex_t IT_0092 = -IT_0019 + -IT_0027 + -IT_0035 + IT_0053 +
       IT_0070 + IT_0082 + -IT_0091;
    const ccomplex_t IT_0093 = pow(m_W, -2);
    const ccomplex_t IT_0094 = pow(s_34, 2);
    const ccomplex_t IT_0095 = IT_0093*IT_0094;
    const ccomplex_t IT_0096 = IT_0019 + IT_0027 + IT_0035 + IT_0091;
    ...
    return create_ccomplex_return((-3)*IT_0092*(conj(IT_0092)*(IT_0014 + 
      -IT_0095) + conj(IT_0096)*IT_0099) + (-3)*IT_0096*(conj(IT_0092)*IT_0099 +
       conj(IT_0096)*(IT_0015 + -IT_0101)));
}
