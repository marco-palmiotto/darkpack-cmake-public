...
ccomplex_return_t c_sumSqAmpl_sb_1_anti_sb_2_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = e_em*m_mu*IT_0003*IT_0033*IT_0035*IT_0036;
    ...
    const ccomplex_t IT_0055 = e_em*m_mu*IT_0003*IT_0033;
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0033
      *IT_0035*IT_0077;
    ...
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0033
      *IT_0035*IT_0081;
