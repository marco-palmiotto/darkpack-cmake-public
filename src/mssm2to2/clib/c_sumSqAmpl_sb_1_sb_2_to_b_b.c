        ...
        )
{
    ...
    const ccomplex_t IT_0010 = cpow((-2)*s_13 + IT_0000 + -IT_0001 + IT_0009 +
       reg_prop, -1);
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_00;
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_11;
    ...
    const ccomplex_t IT_0018 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0023 = conj(N_W1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0030 = m_b*conj(N_d1)*e_em*IT_0029*U_sb_10;
    ...
    const ccomplex_t IT_0038 = m_b*N_d1*e_em*IT_0029*U_sb_01;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0000 + IT_0009 + -m_N_1*
    ...
    const ccomplex_t IT_0050 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0051 = IT_0022*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = m_b*conj(N_d2)*e_em*IT_0029*U_sb_10;
    ...
    const ccomplex_t IT_0058 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0059 = IT_0017*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = m_b*N_d2*e_em*IT_0029*U_sb_01;
    ...
    const ccomplex_t IT_0081 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0082 = IT_0017*IT_0081;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = m_b*N_d3*e_em*IT_0029*U_sb_01;
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_13 + IT_0000 + IT_0009 + -m_N_3*
    ...
    const ccomplex_t IT_0096 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0097 = IT_0022*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = m_b*conj(N_d4)*e_em*IT_0029*U_sb_10;
    ...
    const ccomplex_t IT_0104 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0105 = IT_0017*IT_0104;
    const ccomplex_t IT_0106 = 1.4142135623731*IT_0105;
    const ccomplex_t IT_0107 = m_b*N_d4*e_em*IT_0029*U_sb_01;
    ...
    const ccomplex_t IT_0113 = cpow((-2)*s_13 + IT_0000 + IT_0009 + -m_N_4*
    ...
    const ccomplex_t IT_0117 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0118 = IT_0017*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = m_b*N_d1*e_em*IT_0029*U_sb_00;
    ...
    const ccomplex_t IT_0131 = m_b*conj(N_d1)*e_em*IT_0029*U_sb_11;
    ...
    const ccomplex_t IT_0194 = conj(N_B2)*e_em*U_sb_01;
    const ccomplex_t IT_0195 = IT_0017*IT_0194;
    const ccomplex_t IT_0196 = 1.4142135623731*IT_0195;
    const ccomplex_t IT_0197 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0198 = IT_0022*IT_0197;
    const ccomplex_t IT_0199 = 1.4142135623731*IT_0198;
    const ccomplex_t IT_0200 = m_b*conj(N_d2)*e_em*IT_0029*U_sb_11;
    ...
    const ccomplex_t IT_0206 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0207 = IT_0205*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*IT_0207;
    const ccomplex_t IT_0209 = (-0.166666666666667)*IT_0008 + (-0.5)*IT_0015 +
       IT_0139 + IT_0162 + IT_0185 + IT_0208;
    const ccomplex_t IT_0210 = IT_0006*IT_0010;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1)*IT_0210;
    const ccomplex_t IT_0212 = IT_0044*IT_0136;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*IT_0212;
    const ccomplex_t IT_0214 = IT_0067*IT_0205;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*IT_0214;
    const ccomplex_t IT_0216 = IT_0090*IT_0159;
    const ccomplex_t IT_0217 = (0 + _Complex_I*1)*IT_0216;
    const ccomplex_t IT_0218 = IT_0113*IT_0182;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1)*IT_0218;
    const ccomplex_t IT_0220 = IT_0003*IT_0013;
    const ccomplex_t IT_0221 = (0 + _Complex_I*1)*IT_0220;
    const ccomplex_t IT_0222 = 0.166666666666667*IT_0211 + -IT_0213 + -IT_0215
       + -IT_0217 + -IT_0219 + 0.5*IT_0221;
    const ccomplex_t IT_0223 = IT_0043*IT_0137;
    const ccomplex_t IT_0224 = (0 + _Complex_I*1)*IT_0223;
    const ccomplex_t IT_0225 = IT_0066*IT_0206;
    const ccomplex_t IT_0226 = (0 + _Complex_I*1)*IT_0225;
    const ccomplex_t IT_0227 = IT_0089*IT_0160;
    const ccomplex_t IT_0228 = (0 + _Complex_I*1)*IT_0227;
    const ccomplex_t IT_0229 = IT_0112*IT_0183;
    const ccomplex_t IT_0230 = (0 + _Complex_I*1)*IT_0229;
    const ccomplex_t IT_0231 = (-0.5)*IT_0211 + (-0.166666666666667)*IT_0221 +
    ...
    const ccomplex_t IT_0241 = IT_0004*IT_0012;
    const ccomplex_t IT_0242 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0243 = IT_0010*IT_0241*IT_0242;
    const ccomplex_t IT_0244 = IT_0003*IT_0241*IT_0242;
    const ccomplex_t IT_0245 = IT_0042*IT_0124;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0247 = IT_0044*IT_0245*IT_0246;
    const ccomplex_t IT_0248 = IT_0065*IT_0193;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0250 = IT_0067*IT_0248*IT_0249;
    const ccomplex_t IT_0251 = IT_0088*IT_0147;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0253 = IT_0090*IT_0251*IT_0252;
    const ccomplex_t IT_0254 = IT_0111*IT_0170;
    const ccomplex_t IT_0255 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0256 = IT_0113*IT_0254*IT_0255;
    const ccomplex_t IT_0257 = m_b*IT_0211;
    const ccomplex_t IT_0258 = m_b*IT_0008;
    const ccomplex_t IT_0259 = m_b*IT_0213;
    const ccomplex_t IT_0260 = m_b*IT_0215;
    const ccomplex_t IT_0261 = m_b*IT_0217;
    const ccomplex_t IT_0262 = m_b*IT_0219;
    const ccomplex_t IT_0263 = (-0.166666666666667)*IT_0243 + 0.5*IT_0244 +
       IT_0247 + IT_0250 + IT_0253 + IT_0256 + 0.166666666666667*IT_0257 + (-0.5
      )*IT_0258 + -IT_0259 + -IT_0260 + -IT_0261 + -IT_0262;
    const ccomplex_t IT_0264 = IT_0005*IT_0011;
    const ccomplex_t IT_0265 = IT_0010*IT_0242*IT_0264;
    const ccomplex_t IT_0266 = IT_0003*IT_0242*IT_0264;
    const ccomplex_t IT_0267 = m_b*IT_0221;
    const ccomplex_t IT_0268 = m_b*IT_0015;
    const ccomplex_t IT_0269 = m_b*IT_0046;
    const ccomplex_t IT_0270 = m_b*IT_0069;
    const ccomplex_t IT_0271 = m_b*IT_0092;
    const ccomplex_t IT_0272 = m_b*IT_0115;
    const ccomplex_t IT_0273 = IT_0034*IT_0135;
    const ccomplex_t IT_0274 = IT_0044*IT_0246*IT_0273;
    const ccomplex_t IT_0275 = IT_0057*IT_0204;
    const ccomplex_t IT_0276 = IT_0067*IT_0249*IT_0275;
    const ccomplex_t IT_0277 = IT_0080*IT_0158;
    const ccomplex_t IT_0278 = IT_0090*IT_0252*IT_0277;
    const ccomplex_t IT_0279 = IT_0103*IT_0181;
    const ccomplex_t IT_0280 = IT_0113*IT_0255*IT_0279;
    const ccomplex_t IT_0281 = (-0.166666666666667)*IT_0265 + 0.5*IT_0266 + (
      -0.5)*IT_0267 + 0.166666666666667*IT_0268 + -IT_0269 + -IT_0270 + -IT_0271
       + -IT_0272 + IT_0274 + IT_0276 + IT_0278 + IT_0280;
    const ccomplex_t IT_0282 = IT_0137*IT_0245*IT_0246;
    const ccomplex_t IT_0283 = IT_0160*IT_0251*IT_0252;
    const ccomplex_t IT_0284 = IT_0183*IT_0254*IT_0255;
    const ccomplex_t IT_0285 = m_b*IT_0139;
    const ccomplex_t IT_0286 = m_b*IT_0162;
    const ccomplex_t IT_0287 = m_b*IT_0185;
    const ccomplex_t IT_0288 = IT_0206*IT_0248*IT_0249;
    const ccomplex_t IT_0289 = m_b*IT_0208;
    const ccomplex_t IT_0290 = 0.5*IT_0243 + (-0.166666666666667)*IT_0244 + (
      -0.5)*IT_0257 + 0.166666666666667*IT_0258 + IT_0282 + IT_0283 + IT_0284 + 
    ...
    const ccomplex_t IT_0294 = IT_0137*IT_0246*IT_0273;
    const ccomplex_t IT_0295 = IT_0206*IT_0249*IT_0275;
    const ccomplex_t IT_0296 = IT_0160*IT_0252*IT_0277;
    const ccomplex_t IT_0297 = IT_0183*IT_0255*IT_0279;
    const ccomplex_t IT_0298 = m_b*IT_0224;
    const ccomplex_t IT_0299 = m_b*IT_0226;
    const ccomplex_t IT_0300 = m_b*IT_0228;
    const ccomplex_t IT_0301 = m_b*IT_0230;
    const ccomplex_t IT_0302 = 0.5*IT_0265 + (-0.166666666666667)*IT_0266 +
       0.166666666666667*IT_0267 + (-0.5)*IT_0268 + IT_0294 + IT_0295 + IT_0296 
