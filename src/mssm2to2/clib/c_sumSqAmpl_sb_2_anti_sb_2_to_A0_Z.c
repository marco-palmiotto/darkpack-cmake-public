...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = -IT_0003*IT_0005;
    const ccomplex_t IT_0014 = IT_0002*IT_0004;
    const ccomplex_t IT_0015 = IT_0013 + IT_0014;
    const ccomplex_t IT_0016 = cpow(IT_0000, -2);
    const ccomplex_t IT_0017 = pow(m_b, 2);
    const ccomplex_t IT_0018 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0015*(IT_0007 + 1.
      /3*IT_0006*IT_0016) + IT_0002*IT_0007*IT_0010*IT_0012*IT_0017)*conj
      (U_sb_01) + -1./2*IT_0005*IT_0007*IT_0011*IT_0012*conj(U_sb_11)) + U_sb_11
      *(IT_0005*IT_0007*IT_0011*IT_0012*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0006*IT_0015*IT_0016 + (-3)*IT_0002*IT_0007*IT_0010*IT_0012*IT_0017)
      *conj(U_sb_11));
    const ccomplex_t IT_0019 = (0 + _Complex_I*-1)*(e_em*IT_0018 + (
      -1.4142135623731)*A_b*IT_0002*IT_0009*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0031 = 2*U_sb_01*((IT_0005*IT_0007*IT_0010*IT_0012
      *IT_0017 + (-0.5)*m_W*(IT_0007 + 1./3*IT_0006*IT_0016)*IT_0030)*conj
      (U_sb_01) + 1./2*IT_0002*IT_0007*IT_0011*IT_0012*conj(U_sb_11)) + U_sb_11*
      (IT_0002*IT_0007*IT_0011*IT_0012*conj(U_sb_01) + 2*(IT_0005*IT_0007
      *IT_0010*IT_0012*IT_0017 + -1./3*m_W*IT_0006*IT_0016*IT_0030)*conj(U_sb_11
      ));
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*(e_em*IT_0031 +
       1.4142135623731*A_b*IT_0005*IT_0009*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0006 + 3*IT_0000*IT_0007)*conj(U_sb_00)*U_sb_01 + IT_0001*IT_0006*conj
      (U_sb_10)*U_sb_11);
    const ccomplex_t IT_0043 = (-0.666666666666667)*IT_0042;
    const ccomplex_t IT_0044 = m_b*e_em*mu_h*IT_0010*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0045 = IT_0007*IT_0044;
    const ccomplex_t IT_0046 = m_b*e_em*mu_h*IT_0010*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0047 = IT_0007*IT_0046;
    const ccomplex_t IT_0048 = A_b*IT_0009*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0049 = IT_0003*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = A_b*IT_0009*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0021 + IT_0055 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0057 = IT_0054*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = IT_0043*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0006 + 3*IT_0000*IT_0007)*U_sb_01*conj(U_sb_01) + IT_0001*IT_0006
      *U_sb_11*conj(U_sb_11));
    const ccomplex_t IT_0061 = (-0.666666666666667)*IT_0060;
    const ccomplex_t IT_0062 = m_b*e_em*mu_h*IT_0010*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0063 = IT_0007*IT_0062;
    const ccomplex_t IT_0064 = m_b*e_em*mu_h*IT_0010*U_sb_01*conj(U_sb_11);
    const ccomplex_t IT_0065 = IT_0007*IT_0064;
    const ccomplex_t IT_0066 = A_b*IT_0009*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0067 = IT_0003*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = A_b*IT_0009*U_sb_01*conj(U_sb_11);
    ...
    const ccomplex_t IT_0072 = (-0.5)*IT_0063 + 0.5*IT_0065 + (-0.5)*IT_0068 +
       0.5*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0055 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0055 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    ...
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0006 + 3*IT_0000*IT_0007)*U_sb_00*conj(U_sb_01) + IT_0001*IT_0006
      *U_sb_10*conj(U_sb_11));
    const ccomplex_t IT_0086 = (-0.666666666666667)*IT_0085;
    const ccomplex_t IT_0087 = m_b*e_em*mu_h*IT_0010*U_sb_01*conj(U_sb_10);
    const ccomplex_t IT_0088 = IT_0007*IT_0087;
    const ccomplex_t IT_0089 = m_b*e_em*mu_h*IT_0010*conj(U_sb_00)*U_sb_11;
    const ccomplex_t IT_0090 = IT_0007*IT_0089;
    const ccomplex_t IT_0091 = A_b*IT_0009*U_sb_01*conj(U_sb_10);
    const ccomplex_t IT_0092 = IT_0003*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = A_b*IT_0009*conj(U_sb_00)*U_sb_11;
    ...
    const ccomplex_t IT_0097 = 0.5*IT_0088 + (-0.5)*IT_0090 + 0.5*IT_0093 + (
      -0.5)*IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0021 + IT_0055 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0102 = -IT_0025 + -IT_0037 + IT_0059 + IT_0076 +
       IT_0084 + IT_0101;
    const ccomplex_t IT_0103 = s_14*s_24*IT_0039;
    const ccomplex_t IT_0104 = -IT_0103;
    const ccomplex_t IT_0105 = s_12 + IT_0104;
    const ccomplex_t IT_0106 = (-3)*conj(IT_0038);
    const ccomplex_t IT_0107 = pow(s_34, 2);
    const ccomplex_t IT_0108 = IT_0039*IT_0107;
    const ccomplex_t IT_0109 = s_24*s_34*IT_0039;
    ...
    const ccomplex_t IT_0114 = (-3)*IT_0102;
    const ccomplex_t IT_0115 = (-3)*IT_0038*(conj(IT_0038)*(IT_0021 + -IT_0041
      ) + conj(IT_0077)*IT_0080 + conj(IT_0102)*IT_0105) + IT_0102*IT_0105
      *IT_0106 + (-3)*IT_0077*((-0.333333333333333)*IT_0080*IT_0106 + conj
      (IT_0077)*(IT_0055 + -IT_0108) + conj(IT_0102)*IT_0111) + (conj(IT_0077)
      *IT_0111 + conj(IT_0102)*(IT_0021 + -IT_0113))*IT_0114;
