...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sb_2
    ...
    const ccomplex_t IT_0018 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sb_2
      *Gamma_b2 + (-0.5)*reg_prop, -1);
