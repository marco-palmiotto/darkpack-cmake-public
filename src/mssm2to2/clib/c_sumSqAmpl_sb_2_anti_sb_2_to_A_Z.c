...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_A_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1)*IT_0000*IT_0002*IT_0003
      *IT_0008*((-0.5)*(IT_0004 + 3*IT_0005)*U_sb_01*conj(U_sb_01) + IT_0004
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
      *IT_0003 + 3*IT_0001*IT_0020)*U_sb_01*conj(U_sb_01) + IT_0002*IT_0003
      *U_sb_11*conj(U_sb_11));
    const ccomplex_t IT_0022 = (-0.333333333333333)*IT_0021;
    const ccomplex_t IT_0023 = IT_0019*IT_0022;
    const ccomplex_t IT_0024 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sb_2
      *Gamma_b2 + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = IT_0023*IT_0025;
    const ccomplex_t IT_0027 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sb_2
      *Gamma_b2 + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0058 = (-0.666666666666667)*IT_0021;
    ...
    const ccomplex_t IT_0078 = -IT_0023 + -IT_0059;
    const ccomplex_t IT_0079 = IT_0030 + IT_0074;
    ...
    const ccomplex_t IT_0089 = (-0.5)*IT_0033 + 0.5*IT_0077;
