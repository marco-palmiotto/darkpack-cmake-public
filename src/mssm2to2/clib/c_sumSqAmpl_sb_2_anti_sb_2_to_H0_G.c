...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_H0_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0014*(IT_0010 + 1.
      /3*IT_0009*IT_0016) + IT_0003*IT_0004*IT_0007*IT_0010*IT_0017)*conj
      (U_sb_01) + -1./2*IT_0005*IT_0007*IT_0008*IT_0010*conj(U_sb_11)) + U_sb_11
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*-1)*(e_em*IT_0018 + (
      -1.4142135623731)*A_b*IT_0002*IT_0003*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
