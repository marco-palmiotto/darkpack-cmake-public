...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = m_b*e_em*mu_h*IT_0035*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0037 = IT_0003*IT_0036;
    const ccomplex_t IT_0038 = m_b*e_em*mu_h*IT_0035*U_sb_01*conj(U_sb_11);
    const ccomplex_t IT_0039 = IT_0003*IT_0038;
    const ccomplex_t IT_0040 = cpow(V_tb, 2);
    const ccomplex_t IT_0041 = A_b*IT_0040*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0042 = IT_0010*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = A_b*IT_0040*U_sb_01*conj(U_sb_11);
    ...
    const ccomplex_t IT_0060 = (-2)*U_sb_00*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0058 + IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_11)) + U_sb_10
      *(IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0058 + (-3)*IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)
      *conj(U_sb_11));
    const ccomplex_t IT_0061 = (0 + _Complex_I*-1)*(e_em*IT_0060 + (
      -1.4142135623731)*A_b*IT_0007*IT_0040*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0062 = (-0.5)*IT_0061;
    const ccomplex_t IT_0063 = pow(m_H0, 2);
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0025 + IT_0063 + -m_sb_1*
    ...
    const ccomplex_t IT_0068 = (-0.666666666666667)*IT_0004;
    const ccomplex_t IT_0069 = (-2)*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0058 + IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_11)) + U_sb_11
      *(IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0058 + (-3)*IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)
      *conj(U_sb_11));
    const ccomplex_t IT_0070 = (0 + _Complex_I*-1)*(e_em*IT_0069 + (
      -1.4142135623731)*A_b*IT_0007*IT_0040*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    const ccomplex_t IT_0071 = (-0.5)*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0063 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = IT_0068*IT_0074;
    const ccomplex_t IT_0076 = e_em*IT_0001*IT_0003*(IT_0006*IT_0007 + IT_0010
      *IT_0011);
    const ccomplex_t IT_0077 = -IT_0076;
    const ccomplex_t IT_0078 = IT_0003*IT_0010*IT_0055;
    const ccomplex_t IT_0079 = IT_0036*IT_0078;
    const ccomplex_t IT_0080 = IT_0038*IT_0078;
    const ccomplex_t IT_0081 = IT_0006*IT_0041;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = IT_0006*IT_0044;
    ...
    const ccomplex_t IT_0095 = (-2)*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0058 + IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_11)) + U_sb_11
      *(IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0058 + (-3)*IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)
    ...
    const ccomplex_t IT_0098 = IT_0072*IT_0097;
    const ccomplex_t IT_0099 = (0 + _Complex_I*1)*IT_0098;
    const ccomplex_t IT_0100 = IT_0068*IT_0099;
    const ccomplex_t IT_0101 = (-2)*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0058 + IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)*conj
      (U_sb_01) + -1./2*IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_11)) + U_sb_11
      *(IT_0003*IT_0011*IT_0054*IT_0055*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0002*IT_0016*IT_0058 + (-3)*IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_13 + IT_0063 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
    ...
    const ccomplex_t IT_0110 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0016)*IT_0058 + IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)
      *U_sb_01 + -1./2*IT_0003*IT_0011*IT_0054*IT_0055*U_sb_11) + conj(U_sb_10)*
      (IT_0003*IT_0011*IT_0054*IT_0055*U_sb_01 + 0.666666666666667*(m_W*IT_0002
      *IT_0016*IT_0058 + (-3)*IT_0003*IT_0007*IT_0035*IT_0055*IT_0059)*U_sb_11);
    const ccomplex_t IT_0111 = (0 + _Complex_I*-1)*(e_em*IT_0110 + (
      -1.4142135623731)*A_b*IT_0007*IT_0040*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0112 = (-0.5)*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_13 + IT_0025 + IT_0063 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0117 = -IT_0068;
    const ccomplex_t IT_0118 = IT_0005 + IT_0117;
    const ccomplex_t IT_0119 = IT_0028*IT_0118;
    const ccomplex_t IT_0120 = IT_0067 + IT_0100 + IT_0107 + IT_0116 + -IT_0119;
    const ccomplex_t IT_0121 = s_14*s_24*IT_0031;
    const ccomplex_t IT_0122 = -IT_0121;
    const ccomplex_t IT_0123 = s_12 + IT_0122;
    const ccomplex_t IT_0124 = (-3)*conj(IT_0030);
    ...
    const ccomplex_t IT_0132 = (-3)*IT_0120;
    const ccomplex_t IT_0133 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0091)*IT_0094 + conj(IT_0120)*IT_0123) + IT_0120*IT_0123
      *IT_0124 + (-3)*IT_0091*((-0.333333333333333)*IT_0094*IT_0124 + conj
      (IT_0091)*(IT_0063 + -IT_0126) + conj(IT_0120)*IT_0129) + (conj(IT_0091)
      *IT_0129 + conj(IT_0120)*(IT_0025 + -IT_0131))*IT_0132;
