...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_h_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0039 = (-3)*IT_0029*(conj(IT_0029)*IT_0030 + (
      -0.333333333333333)*conj(IT_0032)*IT_0033 + (-0.333333333333333)*conj
      (IT_0036)*IT_0037) + IT_0036*(conj(IT_0029)*IT_0037 + conj(IT_0032)
      *IT_0038) + (-3)*IT_0032*(IT_0021*conj(IT_0032) + (-0.333333333333333)
      *conj(IT_0029)*IT_0033 + (-0.333333333333333)*conj(IT_0036)*IT_0038);
