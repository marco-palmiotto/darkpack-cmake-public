...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_h_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = 2*U_sb_01*(((-0.5)*m_W*IT_0014*(IT_0010 + 1./3
      *IT_0009*IT_0016) + IT_0003*IT_0004*IT_0007*IT_0010*IT_0017)*conj(U_sb_01)
       + 1./2*IT_0005*IT_0007*IT_0008*IT_0010*conj(U_sb_11)) + U_sb_11*(IT_0005
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*(e_em*IT_0018 +
       1.4142135623731*A_b*IT_0002*IT_0003*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_23 + IT_0021 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    ...
    const ccomplex_t IT_0031 = IT_0001*IT_0027;
    ...
    const ccomplex_t IT_0037 = (-4)*s_24;
    const ccomplex_t IT_0038 = (-4)*s_34;
    const ccomplex_t IT_0039 = (-4)*IT_0029*(conj(IT_0029)*IT_0030 + (-0.25)
      *conj(IT_0032)*IT_0033 + (-0.25)*conj(IT_0036)*IT_0037) + IT_0036*(conj
      (IT_0029)*IT_0037 + conj(IT_0032)*IT_0038) + (-4)*IT_0032*(IT_0021*conj
      (IT_0032) + (-0.25)*conj(IT_0029)*IT_0033 + (-0.25)*conj(IT_0036)*IT_0038);
