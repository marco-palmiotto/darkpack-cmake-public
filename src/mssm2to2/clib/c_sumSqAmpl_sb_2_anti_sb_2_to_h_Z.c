...
ccomplex_return_t c_sumSqAmpl_sb_2_anti_sb_2_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = m_b*e_em*mu_h*IT_0036*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0038 = IT_0003*IT_0037;
    const ccomplex_t IT_0039 = m_b*e_em*mu_h*IT_0036*U_sb_01*conj(U_sb_11);
    const ccomplex_t IT_0040 = IT_0003*IT_0039;
    const ccomplex_t IT_0041 = cpow(V_tb, 2);
    const ccomplex_t IT_0042 = A_b*IT_0041*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0043 = IT_0009*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = A_b*IT_0041*U_sb_01*conj(U_sb_11);
    ...
    const ccomplex_t IT_0061 = 2*U_sb_00*(((-0.5)*m_W*(IT_0003 + 1./3*IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_sb_11)) + U_sb_10*(IT_0003
      *IT_0007*IT_0055*IT_0056*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0002
      *IT_0017*IT_0059 + (-3)*IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj
      (U_sb_11));
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*(e_em*IT_0061 +
       1.4142135623731*A_b*IT_0012*IT_0041*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    const ccomplex_t IT_0063 = 0.5*IT_0062;
    const ccomplex_t IT_0064 = pow(m_h, 2);
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0025 + IT_0064 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0063*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = IT_0054*IT_0067;
    const ccomplex_t IT_0069 = (-0.666666666666667)*IT_0004;
    const ccomplex_t IT_0070 = 2*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3*IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_sb_11)) + U_sb_11*(IT_0003
      *IT_0007*IT_0055*IT_0056*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0002
      *IT_0017*IT_0059 + (-3)*IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj
      (U_sb_11));
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*(e_em*IT_0070 +
       1.4142135623731*A_b*IT_0012*IT_0041*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    const ccomplex_t IT_0072 = 0.5*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0064 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0079 = IT_0003*IT_0009*IT_0056;
    const ccomplex_t IT_0080 = IT_0037*IT_0079;
    const ccomplex_t IT_0081 = IT_0039*IT_0079;
    const ccomplex_t IT_0082 = IT_0011*IT_0042;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = IT_0011*IT_0045;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = (-0.5)*IT_0080 + 0.5*IT_0081 + 0.5*IT_0083 + (
      -0.5)*IT_0085;
    const ccomplex_t IT_0087 = pow(m_Z, 2);
    const ccomplex_t IT_0088 = cpow((-2)*s_12 + (-2)*IT_0025 + IT_0087 + 
      -reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0086*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = IT_0078*IT_0090;
    const ccomplex_t IT_0092 = IT_0052 + -IT_0068 + -IT_0076 + IT_0091;
    const ccomplex_t IT_0093 = s_14*s_34*IT_0031;
    const ccomplex_t IT_0094 = -IT_0093;
    const ccomplex_t IT_0095 = s_13 + IT_0094;
    const ccomplex_t IT_0096 = 2*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3*IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_sb_11)) + U_sb_11*(IT_0003
      *IT_0007*IT_0055*IT_0056*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0002
      *IT_0017*IT_0059 + (-3)*IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj
    ...
    const ccomplex_t IT_0101 = IT_0069*IT_0100;
    const ccomplex_t IT_0102 = 2*U_sb_01*(((-0.5)*m_W*(IT_0003 + 1./3*IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj(U_sb_01)
       + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_sb_11)) + U_sb_11*(IT_0003
      *IT_0007*IT_0055*IT_0056*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0002
      *IT_0017*IT_0059 + (-3)*IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)*conj
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0064 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = IT_0069*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
    ...
    const ccomplex_t IT_0111 = 2*conj(U_sb_00)*(((-0.5)*m_W*(IT_0003 + 1./3
      *IT_0002*IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)
      *U_sb_01 + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*U_sb_11) + conj(U_sb_10)*
      (IT_0003*IT_0007*IT_0055*IT_0056*U_sb_01 + (-0.666666666666667)*(m_W
      *IT_0002*IT_0017*IT_0059 + (-3)*IT_0003*IT_0012*IT_0036*IT_0056*IT_0060)
      *U_sb_11);
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*(e_em*IT_0111 +
       1.4142135623731*A_b*IT_0012*IT_0041*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    const ccomplex_t IT_0113 = 0.5*IT_0112;
    const ccomplex_t IT_0114 = cpow((-2)*s_13 + IT_0025 + IT_0064 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0134 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0092)*IT_0095 + conj(IT_0121)*IT_0124) + IT_0121*IT_0124
      *IT_0125 + (-3)*IT_0092*((-0.333333333333333)*IT_0095*IT_0125 + conj
      (IT_0092)*(IT_0064 + -IT_0127) + conj(IT_0121)*IT_0130) + (conj(IT_0092)
      *IT_0130 + conj(IT_0121)*(IT_0025 + -IT_0132))*IT_0133;
