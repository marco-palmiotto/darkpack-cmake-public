        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0009 = (-0.5)*IT_0008;
    const ccomplex_t IT_0010 = cos(theta_W);
    const ccomplex_t IT_0011 = cpow(IT_0010, -1);
    const ccomplex_t IT_0012 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0013 = IT_0011*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = cos(beta);
    const ccomplex_t IT_0016 = cpow(IT_0015, -1);
    const ccomplex_t IT_0017 = IT_0007*IT_0016;
    const ccomplex_t IT_0018 = m_b*conj(N_d2)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0029 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0030 = IT_0011*IT_0029;
    const ccomplex_t IT_0031 = 1.4142135623731*IT_0030;
    const ccomplex_t IT_0032 = m_b*conj(N_d3)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0043 = conj(N_B1)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0044 = IT_0011*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = m_b*conj(N_d1)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0057 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0058 = IT_0011*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_b*conj(N_d4)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0007*conj(U_sb_00);
    const ccomplex_t IT_0070 = -IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0007;
    const ccomplex_t IT_0072 = 0.5*IT_0071;
    const ccomplex_t IT_0073 = pow(m_sb_1, 2);
    const ccomplex_t IT_0074 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0001 + -IT_0073 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0078 = pow(m_sG, 2);
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -IT_0078 +
       reg_prop, -1);
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*g_s;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_00);
    ...
    const ccomplex_t IT_0085 = -IT_0077 + (-0.5)*IT_0084;
    ...
    const ccomplex_t IT_0116 = N_B3*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0122 = m_b*N_d3*e_em*IT_0003*conj(U_sb_10);
    ...
    const ccomplex_t IT_0138 = N_W2*e_em*conj(U_sb_00);
    const ccomplex_t IT_0139 = IT_0007*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = m_b*N_d2*e_em*IT_0003*conj(U_sb_10);
    ...
    const ccomplex_t IT_0150 = IT_0137*IT_0149;
    const ccomplex_t IT_0151 = IT_0002*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*IT_0151;
    const ccomplex_t IT_0153 = conj(N_B4)*e_em;
    const ccomplex_t IT_0154 = IT_0011*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0175 = 0.166666666666667*IT_0084 + -IT_0107 + -IT_0129
       + -IT_0152 + -IT_0174;
    const ccomplex_t IT_0176 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0181 = m_b*m_c*IT_0001;
    const ccomplex_t IT_0182 = 3*IT_0175;
    const ccomplex_t IT_0183 = IT_0085 + IT_0182;
    const ccomplex_t IT_0184 = 3*conj(IT_0175);
    const ccomplex_t IT_0185 = conj(IT_0085) + IT_0184;
    const ccomplex_t IT_0186 = m_c*s_14;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_10);
    const ccomplex_t IT_0189 = IT_0080*IT_0188;
    const ccomplex_t IT_0190 = IT_0079*IT_0187*IT_0189;
    const ccomplex_t IT_0191 = pow(m_W, 2);
    const ccomplex_t IT_0192 = cpow((-2)*s_12 + -IT_0001 + -IT_0073 + IT_0191 
      + -reg_prop, -1);
    const ccomplex_t IT_0193 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0003*IT_0007;
    const ccomplex_t IT_0194 = (-0.5)*IT_0193;
    const ccomplex_t IT_0195 = pow(m_b, 2);
    const ccomplex_t IT_0196 = cpow(IT_0015, 2);
    const ccomplex_t IT_0197 = cpow(IT_0004, 2);
    const ccomplex_t IT_0198 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0007*((IT_0003*(IT_0000 + -IT_0195) + m_W*(IT_0196 + -IT_0197))*conj
      (U_sb_00) + m_b*mu_h*IT_0003*IT_0004*IT_0016*conj(U_sb_10));
    ...
    const ccomplex_t IT_0203 = cpow((-2)*s_12 + -IT_0001 + -IT_0073 + m_Hp*
    ...
    const ccomplex_t IT_0206 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0007*(m_W*IT_0004*IT_0015*conj(U_sb_00) + (-0.5)*IT_0003*(IT_0000
      *IT_0005*IT_0015*conj(U_sb_00) + m_b*(m_b*IT_0004*IT_0016*conj(U_sb_00) +
       mu_h*conj(U_sb_10))));
    ...
    const ccomplex_t IT_0211 = (-0.5)*IT_0069;
    const ccomplex_t IT_0212 = m_b*IT_0211;
    const ccomplex_t IT_0213 = m_b*IT_0070;
    const ccomplex_t IT_0214 = -IT_0213;
    const ccomplex_t IT_0215 = IT_0212 + IT_0214;
    const ccomplex_t IT_0216 = IT_0076*IT_0215;
    const ccomplex_t IT_0217 = (-0.5)*IT_0190 + -IT_0202 + -IT_0210 + IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0219 = IT_0050*IT_0093;
    const ccomplex_t IT_0220 = IT_0040*IT_0218*IT_0219;
    const ccomplex_t IT_0221 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0222 = IT_0064*IT_0160;
    const ccomplex_t IT_0223 = IT_0054*IT_0221*IT_0222;
    const ccomplex_t IT_0224 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0225 = IT_0036*IT_0115;
    const ccomplex_t IT_0226 = IT_0026*IT_0224*IT_0225;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0228 = IT_0022*IT_0137;
    const ccomplex_t IT_0229 = IT_0002*IT_0227*IT_0228;
    const ccomplex_t IT_0230 = m_c*IT_0053;
    const ccomplex_t IT_0231 = m_c*IT_0025;
    const ccomplex_t IT_0232 = m_c*IT_0039;
    const ccomplex_t IT_0233 = m_c*IT_0067;
    const ccomplex_t IT_0234 = 0.166666666666667*IT_0190 + -IT_0220 + -IT_0223
       + -IT_0226 + -IT_0229 + IT_0230 + IT_0231 + IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = IT_0042*IT_0104;
    const ccomplex_t IT_0236 = IT_0040*IT_0218*IT_0235;
    const ccomplex_t IT_0237 = m_c*IT_0084;
    const ccomplex_t IT_0238 = IT_0009*IT_0149;
    const ccomplex_t IT_0239 = IT_0002*IT_0227*IT_0238;
    const ccomplex_t IT_0240 = IT_0028*IT_0126;
    const ccomplex_t IT_0241 = IT_0026*IT_0224*IT_0240;
    const ccomplex_t IT_0242 = IT_0056*IT_0171;
    const ccomplex_t IT_0243 = IT_0054*IT_0221*IT_0242;
    const ccomplex_t IT_0244 = m_c*IT_0107;
    const ccomplex_t IT_0245 = m_c*IT_0152;
    const ccomplex_t IT_0246 = m_c*IT_0129;
    const ccomplex_t IT_0247 = m_c*IT_0174;
    const ccomplex_t IT_0248 = -IT_0236 + (-0.166666666666667)*IT_0237 + 
      -IT_0239 + -IT_0241 + -IT_0243 + IT_0244 + IT_0245 + IT_0246 + IT_0247;
    const ccomplex_t IT_0249 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0003*IT_0005*IT_0007*IT_0015;
    const ccomplex_t IT_0250 = 0.5*IT_0249;
    const ccomplex_t IT_0251 = IT_0207*IT_0250;
    const ccomplex_t IT_0252 = IT_0203*IT_0251;
    const ccomplex_t IT_0253 = (0 + _Complex_I*1)*IT_0252;
    const ccomplex_t IT_0254 = m_c*IT_0211;
    const ccomplex_t IT_0255 = m_c*IT_0070;
    const ccomplex_t IT_0256 = -IT_0255;
    const ccomplex_t IT_0257 = IT_0254 + IT_0256;
    const ccomplex_t IT_0258 = IT_0076*IT_0257;
    const ccomplex_t IT_0259 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0003*IT_0007;
    const ccomplex_t IT_0260 = 0.5*IT_0259;
    const ccomplex_t IT_0261 = IT_0199*IT_0260;
    const ccomplex_t IT_0262 = IT_0192*IT_0261;
    const ccomplex_t IT_0263 = (0 + _Complex_I*1)*IT_0262;
    const ccomplex_t IT_0264 = 0.5*IT_0237 + -IT_0253 + -IT_0258 + -IT_0263;
    const ccomplex_t IT_0265 = IT_0085 + 0.333333333333333*IT_0175;
    const ccomplex_t IT_0266 = 0.333333333333333*conj(IT_0175);
    const ccomplex_t IT_0267 = conj(IT_0085) + IT_0266;
    const ccomplex_t IT_0268 = 6*s_34;
    const ccomplex_t IT_0269 = 18*s_34;
    const ccomplex_t IT_0270 = m_b*m_c;
    const ccomplex_t IT_0271 = (-18)*conj(IT_0248);
    const ccomplex_t IT_0272 = (-6)*conj(IT_0264);
    const ccomplex_t IT_0273 = IT_0271 + IT_0272;
    const ccomplex_t IT_0274 = (-18)*IT_0248;
    const ccomplex_t IT_0275 = m_b*s_13;
    const ccomplex_t IT_0276 = 12*IT_0178;
    const ccomplex_t IT_0277 = (-6)*IT_0176;
    const ccomplex_t IT_0278 = (IT_0068*conj(IT_0068) + IT_0085*conj(IT_0085) 
      + IT_0175*conj(IT_0175))*IT_0180 + (-6)*IT_0181*(conj(IT_0068)*IT_0183 +
       IT_0068*IT_0185) + 6*IT_0186*(conj(IT_0068)*(IT_0217 + 3*IT_0234) +
       IT_0068*(conj(IT_0217) + 3*conj(IT_0234)) + IT_0185*IT_0248 + IT_0183
      *conj(IT_0248) + 3*conj(IT_0264)*IT_0265 + 3*IT_0264*IT_0267) + (conj
      (IT_0217)*IT_0234 + IT_0217*conj(IT_0234) + conj(IT_0248)*IT_0264 +
       IT_0248*conj(IT_0264))*IT_0268 + (IT_0217*conj(IT_0217) + IT_0234*conj
      (IT_0234) + IT_0248*conj(IT_0248) + IT_0264*conj(IT_0264))*IT_0269 + (-6)
      *IT_0270*(conj(IT_0217)*IT_0248 + -1./6*((-18)*conj(IT_0217) + (-6)*conj
      (IT_0234))*IT_0264 + IT_0217*(conj(IT_0248) + 3*conj(IT_0264)) + -1./6
      *IT_0234*IT_0273 + -1./6*conj(IT_0234)*IT_0274) + (-6)*(IT_0185*IT_0234 +
       IT_0183*conj(IT_0234) + 3*conj(IT_0217)*IT_0265 + 3*IT_0217*IT_0267 + (
      -0.166666666666667)*IT_0068*IT_0273 + conj(IT_0068)*(IT_0264 + (
      -0.166666666666667)*IT_0274))*IT_0275 + (conj(IT_0085)*IT_0175 + IT_0085
      *conj(IT_0175))*(IT_0276 + IT_0277);
