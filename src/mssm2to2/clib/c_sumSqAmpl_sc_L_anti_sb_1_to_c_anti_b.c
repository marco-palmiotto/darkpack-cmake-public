...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sb_1_to_c_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = N_W1*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_3*
    ...
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0099 = conj(N_B4)*e_em;
    const ccomplex_t IT_0100 = IT_0023*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0119 = IT_0098*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*IT_0119;
    const ccomplex_t IT_0121 = 0.166666666666667*IT_0008 + -IT_0050 + -IT_0074
       + -IT_0097 + -IT_0120;
    const ccomplex_t IT_0122 = sin(beta);
    const ccomplex_t IT_0123 = cpow(IT_0122, -1);
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0010*IT_0038*IT_0123;
    ...
    const ccomplex_t IT_0129 = m_b*conj(N_d1)*e_em*IT_0038*conj(U_sb_00);
    ...
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0010*IT_0038*IT_0123;
    ...
    const ccomplex_t IT_0142 = m_b*conj(N_d4)*e_em*IT_0038*conj(U_sb_00);
    ...
    const ccomplex_t IT_0177 = s_34*IT_0002;
    const ccomplex_t IT_0178 = (-18)*IT_0177;
    const ccomplex_t IT_0179 = s_13*s_14;
    const ccomplex_t IT_0180 = 36*IT_0179;
    const ccomplex_t IT_0181 = IT_0178 + IT_0180;
    const ccomplex_t IT_0182 = m_c*s_14;
    const ccomplex_t IT_0183 = pow(m_W, 2);
    const ccomplex_t IT_0184 = cpow((-2)*s_12 + -IT_0002 + -IT_0015 + IT_0183 
      + -reg_prop, -1);
    const ccomplex_t IT_0185 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0010*IT_0038;
    const ccomplex_t IT_0186 = 0.5*IT_0185;
    const ccomplex_t IT_0187 = pow(m_b, 2);
    const ccomplex_t IT_0188 = cpow(IT_0035, 2);
    const ccomplex_t IT_0189 = cpow(IT_0122, 2);
    const ccomplex_t IT_0190 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0010*((IT_0038*(IT_0000 + -IT_0187) + m_W*(IT_0188 + -IT_0189))*conj
      (U_sb_00) + m_b*mu_h*IT_0036*IT_0038*IT_0122*conj(U_sb_10));
    ...
    const ccomplex_t IT_0195 = cpow((-2)*s_12 + -IT_0002 + -IT_0015 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0196 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0010*IT_0035*IT_0038*IT_0123;
    const ccomplex_t IT_0197 = 0.5*IT_0196;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0010*(m_W*IT_0035*IT_0122*conj(U_sb_00) + (-0.5)*IT_0038*(IT_0000
      *IT_0035*IT_0123*conj(U_sb_00) + m_b*(m_b*IT_0036*IT_0122*conj(U_sb_00) +
       mu_h*conj(U_sb_10))));
    ...
    const ccomplex_t IT_0203 = (-0.5)*IT_0011;
    const ccomplex_t IT_0204 = m_c*IT_0203;
    const ccomplex_t IT_0205 = m_c*IT_0012;
    const ccomplex_t IT_0206 = -IT_0205;
    const ccomplex_t IT_0207 = IT_0204 + IT_0206;
    const ccomplex_t IT_0208 = IT_0018*IT_0207;
    const ccomplex_t IT_0209 = m_c*IT_0008;
    const ccomplex_t IT_0210 = -IT_0194 + -IT_0202 + -IT_0208 + 0.5*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0010*IT_0036*IT_0038*IT_0122;
    const ccomplex_t IT_0212 = 0.5*IT_0211;
    const ccomplex_t IT_0213 = IT_0199*IT_0212;
    const ccomplex_t IT_0214 = IT_0195*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_b*V_cb*e_em
      *IT_0010*IT_0038;
    const ccomplex_t IT_0217 = (-0.5)*IT_0216;
    const ccomplex_t IT_0218 = IT_0191*IT_0217;
    const ccomplex_t IT_0219 = IT_0184*IT_0218;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*IT_0219;
    const ccomplex_t IT_0221 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_10);
    const ccomplex_t IT_0223 = IT_0004*IT_0222;
    const ccomplex_t IT_0224 = IT_0003*IT_0221*IT_0223;
    const ccomplex_t IT_0225 = m_b*IT_0012;
    const ccomplex_t IT_0226 = -IT_0225;
    const ccomplex_t IT_0227 = m_b*IT_0203;
    const ccomplex_t IT_0228 = IT_0226 + IT_0227;
    const ccomplex_t IT_0229 = IT_0018*IT_0228;
    const ccomplex_t IT_0230 = -IT_0215 + -IT_0220 + (-0.5)*IT_0224 + IT_0229;
    const ccomplex_t IT_0231 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0232 = IT_0083*IT_0172;
    const ccomplex_t IT_0233 = IT_0075*IT_0231*IT_0232;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0235 = IT_0059*IT_0159;
    const ccomplex_t IT_0236 = IT_0051*IT_0234*IT_0235;
    const ccomplex_t IT_0237 = m_c*IT_0162;
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0239 = IT_0031*IT_0133;
    const ccomplex_t IT_0240 = IT_0021*IT_0238*IT_0239;
    const ccomplex_t IT_0241 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0242 = IT_0106*IT_0146;
    const ccomplex_t IT_0243 = IT_0098*IT_0241*IT_0242;
    const ccomplex_t IT_0244 = m_c*IT_0136;
    const ccomplex_t IT_0245 = m_c*IT_0175;
    const ccomplex_t IT_0246 = m_c*IT_0149;
    const ccomplex_t IT_0247 = 0.166666666666667*IT_0224 + -IT_0233 + -IT_0236
       + IT_0237 + -IT_0240 + -IT_0243 + IT_0244 + IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = IT_0071*IT_0151;
    const ccomplex_t IT_0249 = IT_0051*IT_0234*IT_0248;
    const ccomplex_t IT_0250 = IT_0117*IT_0138;
    const ccomplex_t IT_0251 = IT_0098*IT_0241*IT_0250;
    const ccomplex_t IT_0252 = m_c*IT_0074;
    const ccomplex_t IT_0253 = m_c*IT_0120;
    const ccomplex_t IT_0254 = IT_0047*IT_0125;
    const ccomplex_t IT_0255 = IT_0021*IT_0238*IT_0254;
    const ccomplex_t IT_0256 = IT_0094*IT_0164;
    const ccomplex_t IT_0257 = IT_0075*IT_0231*IT_0256;
    const ccomplex_t IT_0258 = m_c*IT_0050;
    const ccomplex_t IT_0259 = m_c*IT_0097;
    const ccomplex_t IT_0260 = (-0.166666666666667)*IT_0209 + -IT_0249 + 
      -IT_0251 + IT_0252 + IT_0253 + -IT_0255 + -IT_0257 + IT_0258 + IT_0259;
    const ccomplex_t IT_0261 = 3*IT_0121;
    const ccomplex_t IT_0262 = IT_0020 + IT_0261;
    const ccomplex_t IT_0263 = 3*conj(IT_0121);
    const ccomplex_t IT_0264 = conj(IT_0020) + IT_0263;
    const ccomplex_t IT_0265 = (18*conj(IT_0020) + 6*conj(IT_0121))*IT_0210 + 
      (18*IT_0020 + 6*IT_0121)*conj(IT_0210) + 6*conj(IT_0176)*(IT_0230 + 3
      *IT_0247) + 6*IT_0176*(conj(IT_0230) + 3*conj(IT_0247)) + 6*conj(IT_0260)
      *IT_0262 + 6*IT_0260*IT_0264;
    const ccomplex_t IT_0266 = m_b*m_c*IT_0002;
    const ccomplex_t IT_0267 = 6*s_34;
    const ccomplex_t IT_0268 = 18*s_34;
    const ccomplex_t IT_0269 = 12*IT_0179;
    const ccomplex_t IT_0270 = (-6)*IT_0177;
    const ccomplex_t IT_0271 = m_b*s_13;
    const ccomplex_t IT_0272 = (-18)*conj(IT_0260);
    const ccomplex_t IT_0273 = (-6)*conj(IT_0210);
    const ccomplex_t IT_0274 = IT_0272 + IT_0273;
    const ccomplex_t IT_0275 = (-18)*IT_0260;
    const ccomplex_t IT_0276 = (-6)*conj(IT_0247);
    const ccomplex_t IT_0277 = ((-18)*conj(IT_0020) + (-6)*conj(IT_0121))
      *IT_0230 + ((-18)*IT_0020 + (-6)*IT_0121)*conj(IT_0230) + (-6)*IT_0247
      *IT_0264 + IT_0176*IT_0274 + (-6)*conj(IT_0176)*(IT_0210 + (
      -0.166666666666667)*IT_0275) + IT_0262*IT_0276;
    const ccomplex_t IT_0278 = m_b*m_c;
    const ccomplex_t IT_0279 = (IT_0020*conj(IT_0020) + IT_0121*conj(IT_0121) 
      + IT_0176*conj(IT_0176))*IT_0181 + IT_0182*IT_0265 + (-6)*(conj(IT_0176)
      *IT_0262 + IT_0176*IT_0264)*IT_0266 + (conj(IT_0230)*IT_0247 + IT_0230
      *conj(IT_0247) + conj(IT_0210)*IT_0260 + IT_0210*conj(IT_0260))*IT_0267 + 
      (IT_0210*conj(IT_0210) + IT_0230*conj(IT_0230) + IT_0247*conj(IT_0247) +
       IT_0260*conj(IT_0260))*IT_0268 + (conj(IT_0020)*IT_0121 + IT_0020*conj
      (IT_0121))*(IT_0269 + IT_0270) + IT_0271*IT_0277 + (-6)*(conj(IT_0230)
      *IT_0260 + -1./6*IT_0230*((-18)*conj(IT_0210) + (-6)*conj(IT_0260)) + -1.
      /6*IT_0247*IT_0274 + -1./6*conj(IT_0247)*IT_0275 + -1./6*IT_0210*((-18)
      *conj(IT_0230) + IT_0276))*IT_0278;
