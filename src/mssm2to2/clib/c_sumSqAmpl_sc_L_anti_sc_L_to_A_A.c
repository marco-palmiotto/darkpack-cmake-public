...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sc_L
    ...
    const ccomplex_t IT_0010 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sc_L
      *Gamma_cl + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0056 = pow(m_sc_L, 4);
