...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_A_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sc_L
      *Gamma_cl + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = IT_0023*IT_0025;
    const ccomplex_t IT_0027 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sc_L
      *Gamma_cl + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0055 = s_14*s_34*IT_0013;
    ...
    const ccomplex_t IT_0065 = 0.5*IT_0035;
    const ccomplex_t IT_0066 = IT_0040*IT_0047;
    const ccomplex_t IT_0067 = IT_0034*IT_0037;
    const ccomplex_t IT_0068 = IT_0052 + IT_0053 + IT_0066 + IT_0067;
    const ccomplex_t IT_0069 = conj(IT_0040)*IT_0047;
    const ccomplex_t IT_0070 = conj(IT_0034)*IT_0037;
    const ccomplex_t IT_0071 = conj(IT_0036)*IT_0050;
    const ccomplex_t IT_0072 = IT_0054 + IT_0069 + IT_0070 + IT_0071;
    const ccomplex_t IT_0073 = IT_0019*IT_0058;
    const ccomplex_t IT_0074 = -IT_0073;
    const ccomplex_t IT_0075 = IT_0023 + IT_0074;
    const ccomplex_t IT_0076 = IT_0025*IT_0075;
    const ccomplex_t IT_0077 = (-0.5)*IT_0033 + 0.5*IT_0076;
    const ccomplex_t IT_0078 = s_24*s_34*IT_0013;
    const ccomplex_t IT_0079 = -IT_0078;
    const ccomplex_t IT_0080 = s_23 + IT_0079;
    const ccomplex_t IT_0081 = IT_0028*(IT_0030 + -IT_0059);
    const ccomplex_t IT_0082 = (-0.5)*IT_0081;
    const ccomplex_t IT_0083 = IT_0037*IT_0082;
    const ccomplex_t IT_0084 = 0.5*IT_0060;
    const ccomplex_t IT_0085 = IT_0041*IT_0084;
    const ccomplex_t IT_0086 = IT_0083 + IT_0085;
    const ccomplex_t IT_0087 = IT_0037*conj(IT_0082);
    const ccomplex_t IT_0088 = IT_0041*conj(IT_0084);
    const ccomplex_t IT_0089 = IT_0087 + IT_0088;
    const ccomplex_t IT_0090 = IT_0030 + IT_0073;
    const ccomplex_t IT_0091 = -IT_0023 + -IT_0059;
    const ccomplex_t IT_0092 = IT_0090 + IT_0091;
    const ccomplex_t IT_0093 = IT_0028*IT_0092;
    const ccomplex_t IT_0094 = (-0.5)*IT_0076 + 0.5*IT_0093;
    const ccomplex_t IT_0095 = IT_0050*IT_0082;
    const ccomplex_t IT_0096 = IT_0047*IT_0082;
    const ccomplex_t IT_0097 = IT_0050*IT_0084;
    const ccomplex_t IT_0098 = IT_0047*conj(IT_0082);
    const ccomplex_t IT_0099 = conj(IT_0077)*IT_0086 + IT_0077*IT_0089 +
       IT_0054*IT_0094 + IT_0053*conj(IT_0094) + IT_0065*(IT_0050*conj(IT_0082) 
      + IT_0047*conj(IT_0084) + IT_0037*conj(IT_0094)) + conj(IT_0065)*(IT_0047
      *IT_0084 + IT_0037*IT_0094 + IT_0095) + conj(IT_0061)*(IT_0053 + IT_0041
      *IT_0094 + IT_0096 + IT_0097) + IT_0061*(IT_0054 + IT_0050*conj(IT_0084) +
       IT_0041*conj(IT_0094) + IT_0098);
    const ccomplex_t IT_0100 = s_14*s_24*IT_0013;
    const ccomplex_t IT_0101 = -IT_0100;
    const ccomplex_t IT_0102 = s_12 + IT_0101;
    ...
    const ccomplex_t IT_0109 = (-3)*s_13;
    const ccomplex_t IT_0110 = (-3)*s_23;
    const ccomplex_t IT_0111 = (-3)*IT_0012;
    const ccomplex_t IT_0112 = (-0.333333333333333)*IT_0077;
    const ccomplex_t IT_0113 = IT_0053*IT_0077 + conj(IT_0077)*(IT_0054 +
       IT_0065*IT_0109 + IT_0061*IT_0110) + (-3)*conj(IT_0065)*(s_12*IT_0061 + (
      -0.333333333333333)*IT_0065*IT_0111 + IT_0109*IT_0112) + (-3)*conj(IT_0061
      )*(s_12*IT_0065 + (-0.333333333333333)*IT_0061*IT_0111 + IT_0110*IT_0112);
    const ccomplex_t IT_0114 = (-9)*IT_0011 + IT_0017*(conj(IT_0034)*IT_0043 +
       IT_0034*IT_0046 + IT_0040*IT_0048 + conj(IT_0040)*(IT_0049 + IT_0051) +
       conj(IT_0036)*(IT_0052 + IT_0053) + IT_0036*IT_0054) + IT_0057*(conj
      (IT_0034)*IT_0053 + IT_0034*IT_0054 + (IT_0034*IT_0041 + IT_0049 + IT_0051
      )*conj(IT_0061) + IT_0061*IT_0064 + conj(IT_0065)*IT_0068 + IT_0065
      *IT_0072 + IT_0046*IT_0077 + IT_0043*conj(IT_0077)) + IT_0080*IT_0099 + 
      (conj(IT_0040)*IT_0053 + IT_0040*IT_0054 + IT_0072*IT_0082 + IT_0068*conj
      (IT_0082) + IT_0064*IT_0084 + (IT_0034*IT_0041 + IT_0049 + IT_0051)*conj
      (IT_0084) + IT_0046*IT_0094 + IT_0043*conj(IT_0094))*IT_0102 + (IT_0089
      *IT_0094 + IT_0086*conj(IT_0094) + conj(IT_0082)*IT_0095 + conj(IT_0084)*
      (IT_0053 + IT_0096 + IT_0097) + IT_0084*(IT_0054 + IT_0098))*IT_0106 +
       IT_0108*IT_0113;
