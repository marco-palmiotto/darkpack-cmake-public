...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_H0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sc_R*
    ...
    const ccomplex_t IT_0020 = e_em*IT_0002*IT_0017*(IT_0005*IT_0006 + 
      -IT_0018*IT_0019);
    const ccomplex_t IT_0021 = (0 + _Complex_I*-3)*e_em*(IT_0002*IT_0016 + -1.
      /3*IT_0001*IT_0017);
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
