...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0041 = cpow(IT_0007, 3);
    const ccomplex_t IT_0042 = (0 + _Complex_I*5)*m_W*e_em*IT_0040*(IT_0001*
      (IT_0008*IT_0011 + (-0.2)*IT_0001*(IT_0001*IT_0011 + 5*IT_0007*IT_0027)) +
       1./5*IT_0027*IT_0041);
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*-1)*m_W*e_em*IT_0040*(IT_0001*
      (IT_0001*IT_0007*IT_0011 + -(IT_0002 + -IT_0008)*IT_0027) + -IT_0011
      *IT_0041);
