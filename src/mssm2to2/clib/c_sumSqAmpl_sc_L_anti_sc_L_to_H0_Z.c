...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = pow(m_sc_L, 2);
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*(0.5*m_W*(IT_0006
      *IT_0007 + -IT_0010*IT_0011)*(IT_0003 + -1./3*IT_0002*IT_0016) + IT_0003
      *IT_0011*IT_0035*IT_0036*IT_0037);
