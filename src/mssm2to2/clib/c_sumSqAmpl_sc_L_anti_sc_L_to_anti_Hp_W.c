        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*conj(V_cd)
      *e_em*IT_0005;
    const ccomplex_t IT_0032 = -IT_0031;
    const ccomplex_t IT_0033 = pow(m_d, 2);
    const ccomplex_t IT_0034 = cpow(IT_0000, -1);
    const ccomplex_t IT_0035 = (0 + _Complex_I*(-2.82842712474619))*V_cd*e_em
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*(-2.82842712474619))*V_cs*e_em
      *IT_0005*(IT_0000*(m_W*IT_0002 + (-0.5)*IT_0008*IT_0009*IT_0010) + -1./2
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0005*(m_W*IT_0000*IT_0002*U_sb_00 + (-0.5)*IT_0008*(IT_0000*IT_0009
      *IT_0010*U_sb_00 + m_b*(m_b*IT_0002*IT_0034*U_sb_00 + mu_h*U_sb_10)));
    const ccomplex_t IT_0054 = -IT_0053;
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0015 + IT_0037 + -m_sb_1*
    ...
    const ccomplex_t IT_0084 = (-3)*IT_0027*(conj(IT_0027)*(IT_0015 + -IT_0030
      ...
      *IT_0080 + conj(IT_0071)*(IT_0015 + -IT_0082))*IT_0083;
