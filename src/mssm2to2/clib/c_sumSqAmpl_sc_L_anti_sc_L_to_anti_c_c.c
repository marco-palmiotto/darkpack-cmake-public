...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*m_c*e_em*IT_0000*IT_0003
      *IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*m_c*e_em*IT_0000*IT_0003
      *IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0058 = m_c*IT_0057;
    ...
    const ccomplex_t IT_0064 = IT_0038*IT_0042;
    const ccomplex_t IT_0065 = (-0.5)*IT_0057 + -IT_0064;
    const ccomplex_t IT_0066 = conj(N_B4)*e_em;
    const ccomplex_t IT_0067 = IT_0029*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0083 = cpow((-2)*s_23 + IT_0001 + IT_0016 + -m_N_4*
    ...
    const ccomplex_t IT_0123 = cpow((-2)*s_23 + IT_0001 + IT_0016 + -m_N_2*
    ...
    const ccomplex_t IT_0143 = cpow((-2)*s_23 + IT_0001 + IT_0016 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0144 = IT_0142*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*IT_0144;
    const ccomplex_t IT_0146 = 0.166666666666667*IT_0057 + -IT_0085 + -IT_0105
       + -IT_0125 + -IT_0145;
    const ccomplex_t IT_0147 = IT_0042*IT_0050;
    const ccomplex_t IT_0148 = -IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0150 = (-0.5)*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0156 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0157 = (-0.5)*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0000*IT_0003*IT_0006;
    ...
    const ccomplex_t IT_0163 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0164 = (-0.5)*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0166 = (-0.5)*IT_0165;
    const ccomplex_t IT_0167 = IT_0164*IT_0166;
    const ccomplex_t IT_0168 = IT_0103*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0171 = (-0.5)*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0000*IT_0003*IT_0006;
    const ccomplex_t IT_0173 = (-0.5)*IT_0172;
    const ccomplex_t IT_0174 = IT_0171*IT_0173;
    const ccomplex_t IT_0175 = IT_0123*IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*IT_0175;
    const ccomplex_t IT_0177 = -IT_0155 + -IT_0162 + -IT_0169 + -IT_0176;
    ...
    const ccomplex_t IT_0207 = IT_0093*IT_0164;
    const ccomplex_t IT_0208 = IT_0103*IT_0206*IT_0207;
    const ccomplex_t IT_0209 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0210 = IT_0113*IT_0171;
    const ccomplex_t IT_0211 = IT_0123*IT_0209*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0213 = IT_0133*IT_0150;
    const ccomplex_t IT_0214 = IT_0143*IT_0212*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0216 = IT_0073*IT_0157;
    const ccomplex_t IT_0217 = IT_0083*IT_0215*IT_0216;
    const ccomplex_t IT_0218 = m_c*IT_0169;
    const ccomplex_t IT_0219 = m_c*IT_0176;
    const ccomplex_t IT_0220 = m_c*IT_0155;
    const ccomplex_t IT_0221 = m_c*IT_0162;
    const ccomplex_t IT_0222 = -IT_0208 + -IT_0211 + -IT_0214 + -IT_0217 +
       IT_0218 + IT_0219 + IT_0220 + IT_0221;
    const ccomplex_t IT_0223 = IT_0101*IT_0166;
    const ccomplex_t IT_0224 = IT_0103*IT_0206*IT_0223;
    const ccomplex_t IT_0225 = IT_0121*IT_0173;
    const ccomplex_t IT_0226 = IT_0123*IT_0209*IT_0225;
    const ccomplex_t IT_0227 = IT_0141*IT_0152;
    const ccomplex_t IT_0228 = IT_0143*IT_0212*IT_0227;
    const ccomplex_t IT_0229 = IT_0081*IT_0159;
    const ccomplex_t IT_0230 = IT_0083*IT_0215*IT_0229;
    const ccomplex_t IT_0231 = m_c*IT_0105;
    const ccomplex_t IT_0232 = m_c*IT_0125;
    const ccomplex_t IT_0233 = m_c*IT_0145;
    const ccomplex_t IT_0234 = m_c*IT_0085;
    const ccomplex_t IT_0235 = (-0.166666666666667)*IT_0058 + -IT_0224 + 
      -IT_0226 + -IT_0228 + -IT_0230 + IT_0231 + IT_0232 + IT_0233 + IT_0234;
    const ccomplex_t IT_0236 = (-18)*IT_0235;
    const ccomplex_t IT_0237 = (-6)*IT_0059;
    const ccomplex_t IT_0238 = IT_0236 + IT_0237;
    const ccomplex_t IT_0239 = (-18)*conj(IT_0235);
    const ccomplex_t IT_0240 = (-6)*conj(IT_0059);
    const ccomplex_t IT_0241 = IT_0239 + IT_0240;
    const ccomplex_t IT_0242 = (-18)*IT_0059;
    const ccomplex_t IT_0243 = (-6)*IT_0235;
    const ccomplex_t IT_0244 = IT_0242 + IT_0243;
    const ccomplex_t IT_0245 = (-18)*conj(IT_0059);
    const ccomplex_t IT_0246 = (-6)*conj(IT_0235);
    const ccomplex_t IT_0247 = IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = 6*s_34;
    const ccomplex_t IT_0249 = -IT_0001;
    const ccomplex_t IT_0250 = s_34 + IT_0249;
    const ccomplex_t IT_0251 = 6*IT_0028;
    const ccomplex_t IT_0252 = 6*conj(IT_0028);
    const ccomplex_t IT_0253 = m_c*s_13;
    const ccomplex_t IT_0254 = conj(IT_0065) + 3*conj(IT_0146);
    const ccomplex_t IT_0255 = 6*conj(IT_0222);
    const ccomplex_t IT_0256 = 6*conj(IT_0059);
    const ccomplex_t IT_0257 = 18*conj(IT_0235);
    const ccomplex_t IT_0258 = 6*conj(IT_0235);
    const ccomplex_t IT_0259 = 18*conj(IT_0059);
    const ccomplex_t IT_0260 = 18*conj(IT_0222);
    const ccomplex_t IT_0261 = IT_0059*(conj(IT_0065) + 0.333333333333333*conj
      (IT_0146)) + IT_0060*(conj(IT_0148) + 0.333333333333333*conj(IT_0177)) +
       0.333333333333333*(conj(IT_0148) + 3*conj(IT_0177))*IT_0222 +
       0.333333333333333*IT_0235*IT_0254 + IT_0148*(conj(IT_0060) +
       0.0555555555555556*IT_0255) + 0.0555555555555556*IT_0146*(IT_0256 +
       IT_0257) + 0.0555555555555556*IT_0065*(IT_0258 + IT_0259) +
       0.333333333333333*IT_0177*(conj(IT_0060) + 0.166666666666667*IT_0260);
    const ccomplex_t IT_0262 = -s_14;
    const ccomplex_t IT_0263 = s_13 + IT_0262;
    const ccomplex_t IT_0264 = m_c*IT_0263;
    const ccomplex_t IT_0265 = conj(IT_0146) + conj(IT_0177);
    const ccomplex_t IT_0266 = IT_0146 + IT_0177;
    const ccomplex_t IT_0267 = conj(IT_0065) + conj(IT_0148);
    const ccomplex_t IT_0268 = 18*IT_0028;
    const ccomplex_t IT_0269 = IT_0065 + IT_0148;
    const ccomplex_t IT_0270 = 18*conj(IT_0028);
    const ccomplex_t IT_0271 = (-18)*IT_0222;
    const ccomplex_t IT_0272 = (-6)*IT_0222;
    const ccomplex_t IT_0273 = IT_0251*IT_0265 + IT_0252*IT_0266 + IT_0267
      *IT_0268 + IT_0269*IT_0270 + IT_0205*((-12)*IT_0028 + 12*conj(IT_0028) + (
      -6)*IT_0060 + 6*conj(IT_0060) + IT_0236 + IT_0237 + IT_0256 + IT_0257 +
       IT_0260 + IT_0271) + IT_0198*((-36)*IT_0028 + 36*conj(IT_0028) + (-18)
      *IT_0060 + 18*conj(IT_0060) + IT_0242 + IT_0243 + IT_0255 + IT_0258 +
       IT_0259 + IT_0272);
    const ccomplex_t IT_0274 = (-18)*IT_0201;
    const ccomplex_t IT_0275 = IT_0183 + IT_0184 + IT_0274;
    const ccomplex_t IT_0276 = -IT_0205;
    const ccomplex_t IT_0277 = -IT_0198;
    const ccomplex_t IT_0278 = (-6)*IT_0201;
    const ccomplex_t IT_0279 = IT_0179 + IT_0181 + IT_0278;
    const ccomplex_t IT_0280 = m_c*s_14;
    const ccomplex_t IT_0281 = 3*IT_0146;
    const ccomplex_t IT_0282 = IT_0065 + IT_0281;
    const ccomplex_t IT_0283 = (-18)*IT_0065;
    const ccomplex_t IT_0284 = (-6)*IT_0146;
    const ccomplex_t IT_0285 = IT_0283 + IT_0284;
    const ccomplex_t IT_0286 = (-18)*conj(IT_0065);
    const ccomplex_t IT_0287 = (-6)*conj(IT_0146);
    const ccomplex_t IT_0288 = IT_0286 + IT_0287;
    const ccomplex_t IT_0289 = (-0.166666666666667)*conj(IT_0148);
    const ccomplex_t IT_0290 = (-0.166666666666667)*conj(IT_0177)*IT_0238 + (
      -0.166666666666667)*IT_0177*IT_0241 + (-0.166666666666667)*IT_0148*IT_0247
       + (-0.166666666666667)*conj(IT_0146)*IT_0271 + (-0.166666666666667)*conj
      (IT_0065)*IT_0272 + conj(IT_0222)*IT_0282 + (-0.166666666666667)*conj
      (IT_0060)*IT_0285 + (-0.166666666666667)*IT_0060*IT_0288 + IT_0244*IT_0289;
    const ccomplex_t IT_0291 = (36*s_34 + (-36)*IT_0001)*IT_0028*conj(IT_0028)
       + (conj(IT_0028)*(IT_0059 + IT_0060) + IT_0028*(conj(IT_0059) + conj
      (IT_0060)))*IT_0063 + (conj(IT_0065)*IT_0146 + IT_0065*conj(IT_0146) +
       conj(IT_0148)*IT_0177 + IT_0148*conj(IT_0177))*IT_0182 + (IT_0065*conj
      (IT_0065) + IT_0146*conj(IT_0146) + IT_0148*conj(IT_0148) + IT_0177*conj
      (IT_0177))*IT_0185 + -IT_0199*IT_0204 + (-2)*IT_0205*(IT_0198*((-12)
      *IT_0178 + 24*IT_0180 + (-12)*IT_0201) + 0.5*IT_0204*IT_0205) + IT_0062*
      (IT_0059*conj(IT_0059) + IT_0060*conj(IT_0060) + IT_0222*conj(IT_0222) +
       IT_0235*conj(IT_0235)) + IT_0001*(conj(IT_0222)*IT_0238 + IT_0222*IT_0241
       + conj(IT_0060)*IT_0244 + IT_0060*IT_0247) + (conj(IT_0060)*IT_0222 +
       IT_0060*conj(IT_0222) + conj(IT_0059)*IT_0235 + IT_0059*conj(IT_0235))
      *IT_0248 + IT_0250*((conj(IT_0222) + conj(IT_0235))*IT_0251 + (IT_0222 +
       IT_0235)*IT_0252) + 18*IT_0253*IT_0261 + IT_0264*IT_0273 + IT_0275*
      (IT_0205*IT_0265 + IT_0198*IT_0267 + IT_0266*IT_0276 + IT_0269*IT_0277) + 
      (IT_0198*IT_0265 + IT_0205*IT_0267 + IT_0269*IT_0276 + IT_0266*IT_0277)
      *IT_0279 + (-6)*IT_0201*(IT_0177*IT_0254 + conj(IT_0177)*IT_0282 + (
      -0.166666666666667)*IT_0148*IT_0288 + IT_0285*IT_0289) + (-6)*IT_0280
      *IT_0290;
