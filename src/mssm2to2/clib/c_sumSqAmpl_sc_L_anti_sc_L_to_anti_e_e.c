...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_anti_e_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0054 = m_e*IT_0053;
    const ccomplex_t IT_0055 = m_e*IT_0033;
    ...
    const ccomplex_t IT_0079 = m_e*s_13;
