...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0005*IT_0009;
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*e_em*IT_0004*IT_0031;
    ...
    const ccomplex_t IT_0040 = IT_0004*IT_0031;
    const ccomplex_t IT_0041 = e_em*IT_0040;
    const ccomplex_t IT_0042 = IT_0005*IT_0012;
    const ccomplex_t IT_0043 = e_em*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*(IT_0041 + -IT_0043);
    ...
    const ccomplex_t IT_0054 = m_mu*IT_0053;
    const ccomplex_t IT_0055 = m_mu*IT_0033;
    const ccomplex_t IT_0056 = -(IT_0037 + -IT_0047)*(IT_0054 + -IT_0055);
    ...
    const ccomplex_t IT_0062 = (-1.33333333333333)*IT_0060;
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = cpow(s_12 + IT_0017 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0070 = s_34*IT_0017;
    ...
    const ccomplex_t IT_0075 = (-6)*IT_0057;
    const ccomplex_t IT_0076 = IT_0067*(24*IT_0068 + (-12)*IT_0069 + (-12)
      *IT_0070) + (IT_0039 + -conj(IT_0039) + IT_0049 + -conj(IT_0049))*IT_0074 
      + -IT_0052*((-12)*IT_0029 + 12*conj(IT_0029) + (-6)*IT_0056 + 6*conj
      (IT_0056) + 6*conj(IT_0057) + IT_0075);
    const ccomplex_t IT_0077 = m_mu*s_14;
    const ccomplex_t IT_0078 = (-6)*IT_0049;
    const ccomplex_t IT_0079 = m_mu*s_13;
    const ccomplex_t IT_0080 = IT_0071 + IT_0073;
    const ccomplex_t IT_0081 = conj(IT_0029)*IT_0052;
    const ccomplex_t IT_0082 = (-6)*conj(IT_0049);
    const ccomplex_t IT_0083 = (-6)*conj(IT_0057);
    const ccomplex_t IT_0084 = 0.166666666666667*IT_0077;
    ...
    const ccomplex_t IT_0087 = IT_0029*(conj(IT_0029)*(12*s_34 + (-12)*IT_0030
      ) + 6*(conj(IT_0039) + conj(IT_0049))*IT_0052 + 6*(conj(IT_0056) + conj
      (IT_0057))*IT_0059) + -IT_0067*IT_0076 + conj(IT_0039)*(IT_0075*IT_0077 +
       IT_0069*IT_0078) + conj(IT_0056)*(IT_0030*IT_0075 + IT_0077*IT_0078) + 6
      *IT_0049*(conj(IT_0057)*IT_0079 + 0.166666666666667*conj(IT_0049)*IT_0080 
      + IT_0081) + 6*IT_0039*(conj(IT_0056)*IT_0079 + 0.166666666666667*conj
      (IT_0039)*IT_0080 + IT_0081 + 0.166666666666667*IT_0069*IT_0082 + IT_0083
      *IT_0084) + 6*IT_0056*(conj(IT_0039)*IT_0079 + 0.166666666666667*IT_0030
      *IT_0083 + IT_0082*IT_0084 + 0.166666666666667*conj(IT_0056)*IT_0085 +
       IT_0086) + 6*IT_0057*(conj(IT_0049)*IT_0079 + 0.166666666666667*conj
      (IT_0057)*IT_0085 + IT_0086);
