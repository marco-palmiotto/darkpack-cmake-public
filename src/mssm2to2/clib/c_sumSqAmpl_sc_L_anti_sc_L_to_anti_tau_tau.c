        ...
        )
{
    ...
    const ccomplex_t IT_0069 = s_34*IT_0017;
    const ccomplex_t IT_0070 = IT_0017*IT_0030;
    const ccomplex_t IT_0071 = (-6)*IT_0069;
    const ccomplex_t IT_0072 = 12*IT_0068;
    const ccomplex_t IT_0073 = IT_0071 + IT_0072;
    const ccomplex_t IT_0074 = (-6)*IT_0070;
    const ccomplex_t IT_0075 = IT_0073 + IT_0074;
    const ccomplex_t IT_0076 = (-6)*IT_0057;
    const ccomplex_t IT_0077 = IT_0067*(24*IT_0068 + (-12)*IT_0069 + (-12)
      *IT_0070) + (IT_0039 + -conj(IT_0039) + IT_0049 + -conj(IT_0049))*IT_0075 
      + -IT_0052*((-12)*IT_0029 + 12*conj(IT_0029) + (-6)*IT_0056 + 6*conj
      (IT_0056) + 6*conj(IT_0057) + IT_0076);
    const ccomplex_t IT_0078 = s_14*m_tau;
    ...
    const ccomplex_t IT_0084 = 0.166666666666667*IT_0078;
    ...
    const ccomplex_t IT_0087 = IT_0029*(conj(IT_0029)*(12*s_34 + (-12)*IT_0030
      ...
      (IT_0057))*IT_0059) + -IT_0067*IT_0077 + conj(IT_0039)*(IT_0076*IT_0078 +
       IT_0070*IT_0079) + conj(IT_0056)*(IT_0030*IT_0076 + IT_0078*IT_0079) + 6
      *IT_0049*(0.166666666666667*conj(IT_0049)*IT_0073 + conj(IT_0057)*IT_0080 
      + IT_0081) + 6*IT_0039*(0.166666666666667*conj(IT_0039)*IT_0073 + conj
      (IT_0056)*IT_0080 + IT_0081 + 0.166666666666667*IT_0070*IT_0082 + IT_0083
      *IT_0084) + 6*IT_0056*(conj(IT_0039)*IT_0080 + 0.166666666666667*IT_0030
      *IT_0083 + IT_0082*IT_0084 + 0.166666666666667*conj(IT_0056)*IT_0085 +
       IT_0086) + 6*IT_0057*(conj(IT_0049)*IT_0080 + 0.166666666666667*conj
