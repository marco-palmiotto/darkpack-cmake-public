...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_h_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_sc_R*
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = IT_0015 + (-2)*IT_0040 + IT_0045;
