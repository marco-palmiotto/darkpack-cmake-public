        ...
        )
{
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_13 + IT_0022 + (0 + _Complex_I*1)
      *m_sc_L*Gamma_cl + reg_prop, -1);
    const ccomplex_t IT_0024 = IT_0021*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = IT_0004*IT_0009;
    const ccomplex_t IT_0027 = IT_0015 + IT_0026;
    const ccomplex_t IT_0028 = cpow(IT_0002, 3);
    const ccomplex_t IT_0029 = cpow(IT_0002, 2);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_W*e_em*IT_0027*(IT_0016
      *IT_0028 + 5*IT_0001*((-0.2)*IT_0001*(IT_0001*IT_0007 + 5*IT_0002*IT_0016)
       + IT_0007*IT_0029));
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = IT_0018*IT_0031;
    const ccomplex_t IT_0033 = pow(m_sc_L, 2);
    const ccomplex_t IT_0034 = cpow((-2)*s_12 + (-2)*IT_0033 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0032*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*IT_0035;
    const ccomplex_t IT_0037 = cpow(IT_0001, 2);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_W*e_em*IT_0027*(IT_0007
      *IT_0028 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0007 + 1*IT_0016*(IT_0029 + 
      -1./5*IT_0037)));
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0001
      *IT_0013*IT_0014*IT_0015;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0002
      *IT_0013*IT_0014*IT_0015;
    const ccomplex_t IT_0047 = (-0.5)*IT_0046;
    const ccomplex_t IT_0048 = IT_0045*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0022 + IT_0033 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0022 + IT_0033 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0048*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0022 + (0 + _Complex_I*1)
      *m_sc_L*Gamma_cl + reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0021*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = IT_0012 + IT_0025 + -IT_0036 + -IT_0043 +
