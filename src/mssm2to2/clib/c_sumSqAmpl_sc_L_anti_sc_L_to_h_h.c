...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_L_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0001
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_sc_R*
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*(IT_0007*IT_0010
      ...
      *IT_0017)*(IT_0007*IT_0011 + IT_0001*IT_0027));
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0021*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0010
      *IT_0015*IT_0016*IT_0017 + 0.166666666666667*m_W*(IT_0004*IT_0005 + (-3)
      *IT_0017)*(IT_0001*IT_0011 + -IT_0007*IT_0027));
    const ccomplex_t IT_0038 = -IT_0037;
    const ccomplex_t IT_0039 = IT_0004*IT_0005;
    const ccomplex_t IT_0040 = IT_0017 + IT_0039;
    const ccomplex_t IT_0041 = cpow(IT_0001, 3);
    const ccomplex_t IT_0042 = (0 + _Complex_I*-5)*m_W*e_em*IT_0040*(IT_0007*
      (IT_0001*IT_0007*IT_0011 + 1*(IT_0002 + -1./5*IT_0008)*IT_0027) + -1./5
      *IT_0011*IT_0041);
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = IT_0038*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_12 + (-2)*IT_0023 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0044*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*m_W*e_em*IT_0040*(IT_0007*
      (IT_0002*IT_0011 + -IT_0007*(IT_0007*IT_0011 + IT_0001*IT_0027)) + IT_0027
      *IT_0041);
