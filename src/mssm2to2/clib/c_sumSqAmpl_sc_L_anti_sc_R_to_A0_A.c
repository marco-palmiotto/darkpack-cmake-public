...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_A0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = m_c*e_em*mu_h*IT_0002*IT_0004;
    const ccomplex_t IT_0006 = 0.5*IT_0005;
    const ccomplex_t IT_0007 = pow(m_A0, 2);
    const ccomplex_t IT_0008 = pow(m_sc_R, 2);
    const ccomplex_t IT_0009 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sc_L*
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0007 + IT_0012 + -m_sc_R*
