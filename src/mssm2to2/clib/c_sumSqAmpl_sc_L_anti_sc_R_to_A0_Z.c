...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0002
    ...
    const ccomplex_t IT_0033 = m_c*e_em*mu_h*IT_0007*IT_0009;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = pow(m_A0, 2);
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0014 + IT_0035 + -m_sc_L*
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_13 + IT_0013 + IT_0035 + -m_sc_R*
