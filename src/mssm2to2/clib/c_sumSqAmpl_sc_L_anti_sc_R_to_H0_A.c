...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_H0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0002
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0009 = 0.5*IT_0008;
    const ccomplex_t IT_0010 = pow(m_H0, 2);
    const ccomplex_t IT_0011 = pow(m_sc_R, 2);
    const ccomplex_t IT_0012 = cpow((-2)*s_23 + IT_0010 + IT_0011 + -m_sc_L*
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0010 + IT_0015 + -m_sc_R*
    ...
    const ccomplex_t IT_0023 = (-3)*s_23;
    ...
    const ccomplex_t IT_0027 = (-3)*s_24;
    const ccomplex_t IT_0028 = (-3)*s_34;
    const ccomplex_t IT_0029 = (-3)*IT_0020*(IT_0011*conj(IT_0020) + (
      -0.333333333333333)*conj(IT_0022)*IT_0023 + (-0.333333333333333)*conj
      (IT_0026)*IT_0027) + IT_0026*(conj(IT_0020)*IT_0027 + conj(IT_0022)
      *IT_0028) + (-3)*IT_0022*(IT_0010*conj(IT_0022) + (-0.333333333333333)
      *conj(IT_0020)*IT_0023 + (-0.333333333333333)*conj(IT_0026)*IT_0028);
