        ...
        )
{
    ...
    const ccomplex_t IT_0026 = IT_0004*IT_0012;
    const ccomplex_t IT_0027 = IT_0005 + IT_0026;
    const ccomplex_t IT_0028 = cpow(IT_0009, 3);
    const ccomplex_t IT_0029 = cpow(IT_0001, 2);
    const ccomplex_t IT_0030 = cpow(IT_0009, 2);
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_W*e_em*IT_0027*(IT_0002
      *IT_0028 + -IT_0001*(IT_0001*IT_0002*IT_0009 + -IT_0010*(IT_0029 + 
      -IT_0030)));
    const ccomplex_t IT_0032 = (-1.5)*IT_0031;
    const ccomplex_t IT_0033 = IT_0007*IT_0032;
    const ccomplex_t IT_0034 = pow(m_sc_L, 2);
    const ccomplex_t IT_0035 = pow(m_sc_R, 2);
    const ccomplex_t IT_0036 = cpow((-2)*s_12 + -IT_0034 + -IT_0035 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0033*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0016 + IT_0035 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0015*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0016 + IT_0034 + -m_sc_R*
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0003*IT_0005*IT_0009;
    const ccomplex_t IT_0047 = (-0.5)*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*m_W*e_em*IT_0027*(IT_0010
      *IT_0028 + 5*IT_0001*((-0.2)*IT_0001*(IT_0001*IT_0002 + 5*IT_0009*IT_0010)
       + IT_0002*IT_0030));
    ...
    const ccomplex_t IT_0053 = IT_0019 + IT_0025 + -IT_0038 + IT_0041 +
       IT_0044 + -IT_0052;
