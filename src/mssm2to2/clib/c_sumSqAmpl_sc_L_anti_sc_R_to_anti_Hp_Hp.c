        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*e_em
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0000*IT_0008*(mu_h*U_sb_00 + m_b*IT_0003*IT_0006*U_sb_10);
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0000*IT_0008*(mu_h*U_sb_01 + m_b*IT_0003*IT_0006*U_sb_11);
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = IT_0028*IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sb_2*
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0006*IT_0008*IT_0035;
    ...
    const ccomplex_t IT_0043 = cpow(IT_0004, 3);
    const ccomplex_t IT_0044 = 3*IT_0008 + IT_0040;
    const ccomplex_t IT_0045 = cpow(IT_0004, 2);
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_W*e_em*(IT_0041*IT_0042
      *IT_0043 + -IT_0002*(IT_0002*(IT_0002*IT_0035*IT_0041 + IT_0004*IT_0042
      *IT_0044) + -IT_0035*IT_0044*IT_0045));
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = IT_0037*IT_0047;
    const ccomplex_t IT_0049 = pow(m_sc_L, 2);
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0006*IT_0008*IT_0042;
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = -IT_0008;
    const ccomplex_t IT_0056 = IT_0040 + IT_0055;
    const ccomplex_t IT_0057 = -IT_0002;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*m_W*e_em*(IT_0035*IT_0043
      *IT_0056 + IT_0057*(IT_0042*IT_0044*IT_0045 + -(IT_0004*IT_0035*IT_0044 + 
      -IT_0002*IT_0042*IT_0056)*IT_0057));
    const ccomplex_t IT_0059 = 0.5*IT_0058;
    const ccomplex_t IT_0060 = IT_0054*IT_0059;
    const ccomplex_t IT_0061 = cpow((-2)*s_12 + -IT_0015 + -IT_0049 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*mu_h*IT_0000*IT_0008;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*V_cd
      *e_em*IT_0000*IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = IT_0065*IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0070 = IT_0068*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0000*IT_0008;
    const ccomplex_t IT_0073 = 0.5*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*V_cs
      *e_em*IT_0000*IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0075 = 0.5*IT_0074;
    const ccomplex_t IT_0076 = IT_0073*IT_0075;
    const ccomplex_t IT_0077 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = pow(m_s, 2);
    const ccomplex_t IT_0081 = (0 + _Complex_I*(-2.82842712474619))*conj(V_cs)
      *e_em*IT_0008*(IT_0002*(m_W*IT_0004 + (-0.5)*IT_0000*IT_0005*IT_0006) + 
      -1./2*IT_0000*IT_0003*IT_0004*IT_0080);
    const ccomplex_t IT_0082 = 0.5*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
      *mu_h*IT_0000*IT_0008;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = IT_0082*IT_0084;
    const ccomplex_t IT_0086 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = IT_0018 + IT_0026 + IT_0034 + -IT_0052 + 
      -IT_0063 + IT_0071 + IT_0079 + IT_0088;
