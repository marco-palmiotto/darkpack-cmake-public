...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_anti_b_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = m_b*e_em*IT_0000*IT_0002;
    const ccomplex_t IT_0004 = 0.5*IT_0003;
    const ccomplex_t IT_0005 = cos(beta);
    const ccomplex_t IT_0006 = sin(beta);
    const ccomplex_t IT_0007 = cpow(IT_0006, -1);
    const ccomplex_t IT_0008 = m_c*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0018 = m_b*e_em*IT_0000*IT_0002*IT_0006*IT_0017;
    const ccomplex_t IT_0019 = (-0.5)*IT_0018;
    const ccomplex_t IT_0020 = m_c*e_em*mu_h*IT_0000*IT_0002;
    const ccomplex_t IT_0021 = 0.5*IT_0020;
    const ccomplex_t IT_0022 = IT_0019*IT_0021;
    const ccomplex_t IT_0023 = cpow((-2)*s_12 + -IT_0012 + -IT_0013 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0024 = IT_0022*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = -IT_0016 + -IT_0025;
    const ccomplex_t IT_0027 = pow(m_b, 2);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u1
      *e_em*IT_0000*IT_0002*IT_0007;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*V_cb*e_em*conj(V_Wp1)*IT_0002;
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0013 + IT_0027 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0033 = IT_0031*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0000*IT_0002*IT_0007;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*V_cb*e_em*conj(V_Wp2)*IT_0002;
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0013 + IT_0027 + -m_C_2*
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_cb
      *e_em*IT_0000*IT_0002*IT_0017;
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = IT_0029*IT_0047;
    const ccomplex_t IT_0049 = IT_0032*IT_0045*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_cb
      *e_em*IT_0000*IT_0002*IT_0017;
    ...
    const ccomplex_t IT_0054 = IT_0039*IT_0052*IT_0053;
    const ccomplex_t IT_0055 = m_b*IT_0041;
    const ccomplex_t IT_0056 = m_b*IT_0034;
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*m_b*e_em*IT_0000*IT_0002
      *IT_0017*IT_0059;
    const ccomplex_t IT_0061 = 0.5*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0002*IT_0007*IT_0059;
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0002*IT_0007*IT_0068;
    const ccomplex_t IT_0072 = 0.5*IT_0071;
    const ccomplex_t IT_0073 = IT_0070*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_12 + -IT_0012 + -IT_0013 + m_H0*
    ...
    const ccomplex_t IT_0084 = s_34*IT_0012;
