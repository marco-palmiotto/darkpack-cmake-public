        ...
        )
{
    ...
    const ccomplex_t IT_0118 = IT_0034*IT_0098*IT_0117;
    const ccomplex_t IT_0119 = IT_0044*IT_0067;
    const ccomplex_t IT_0120 = IT_0048*IT_0101*IT_0119;
    const ccomplex_t IT_0121 = IT_0058*IT_0073;
    const ccomplex_t IT_0122 = IT_0062*IT_0104*IT_0121;
    const ccomplex_t IT_0123 = m_c*IT_0071;
    const ccomplex_t IT_0124 = m_c*IT_0077;
    ...
    const ccomplex_t IT_0127 = IT_0020*IT_0095*IT_0126;
    const ccomplex_t IT_0128 = m_c*IT_0083;
    const ccomplex_t IT_0129 = m_c*IT_0089;
    const ccomplex_t IT_0130 = -IT_0127 + IT_0128 + IT_0129;
    const ccomplex_t IT_0131 = -IT_0018;
    const ccomplex_t IT_0132 = s_34 + IT_0131;
    const ccomplex_t IT_0133 = pow(m_sc_L, 2);
    const ccomplex_t IT_0134 = cpow((-2)*s_12 + -IT_0019 + -IT_0133 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0135 = cos(alpha);
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0006
      *IT_0012*IT_0014*IT_0135;
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = sin(alpha);
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*m_c*e_em*IT_0006*IT_0012
      *IT_0014*IT_0138;
    ...
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0006
      *IT_0012*IT_0014*IT_0138;
    const ccomplex_t IT_0145 = (-0.5)*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_c*e_em*IT_0006*IT_0012
      *IT_0014*IT_0135;
    const ccomplex_t IT_0147 = (-0.5)*IT_0146;
    const ccomplex_t IT_0148 = IT_0145*IT_0147;
    const ccomplex_t IT_0149 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0019 + -IT_0133 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0164 = m_c*e_em*IT_0006*IT_0012;
    const ccomplex_t IT_0165 = (-0.5)*IT_0164;
    const ccomplex_t IT_0166 = cos(beta);
    const ccomplex_t IT_0167 = m_c*e_em*mu_h*IT_0006*IT_0012*IT_0014*IT_0166;
    const ccomplex_t IT_0168 = (-0.5)*IT_0167;
    const ccomplex_t IT_0169 = IT_0165*IT_0168;
    const ccomplex_t IT_0170 = pow(m_Z, 2);
    const ccomplex_t IT_0171 = cpow((-2)*s_12 + -IT_0019 + -IT_0133 + IT_0170 
      + -reg_prop, -1);
    const ccomplex_t IT_0172 = IT_0169*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = cpow((-2)*s_12 + -IT_0019 + -IT_0133 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0175 = m_c*e_em*mu_h*IT_0006*IT_0012;
    const ccomplex_t IT_0176 = 0.5*IT_0175;
    const ccomplex_t IT_0177 = m_c*e_em*IT_0006*IT_0012*IT_0014*IT_0166;
    ...
    const ccomplex_t IT_0183 = 18*IT_0018;
    const ccomplex_t IT_0184 = IT_0158 + IT_0183;
    const ccomplex_t IT_0185 = (-18)*IT_0018;
    const ccomplex_t IT_0186 = IT_0158 + IT_0185;
    const ccomplex_t IT_0187 = (-6)*s_34;
    const ccomplex_t IT_0188 = (-6)*conj(IT_0110);
    const ccomplex_t IT_0189 = 0.166666666666667*IT_0188;
    const ccomplex_t IT_0190 = s_34*(conj(IT_0125) + conj(IT_0130) + (-3)
      *IT_0155) + (-0.166666666666667)*(IT_0182 + -conj(IT_0182))*IT_0184 + (
      -0.166666666666667)*(IT_0152 + -conj(IT_0152))*IT_0186 + 0.166666666666667
      *(IT_0125 + IT_0130)*IT_0187 + IT_0018*(IT_0110 + IT_0189);
    const ccomplex_t IT_0191 = s_13 + s_14;
    const ccomplex_t IT_0192 = m_c*IT_0191;
    const ccomplex_t IT_0193 = s_34 + IT_0018;
    const ccomplex_t IT_0194 = s_34*IT_0133;
    const ccomplex_t IT_0195 = (-18)*IT_0194;
    const ccomplex_t IT_0196 = s_13*s_14;
    const ccomplex_t IT_0197 = 36*IT_0196;
    const ccomplex_t IT_0198 = IT_0195 + IT_0197;
    const ccomplex_t IT_0199 = (-18)*conj(IT_0110);
    const ccomplex_t IT_0200 = 6*conj(IT_0182);
    const ccomplex_t IT_0201 = IT_0018*IT_0133;
    const ccomplex_t IT_0202 = (-18)*conj(IT_0065);
    const ccomplex_t IT_0203 = 6*conj(IT_0152);
    const ccomplex_t IT_0204 = IT_0093*IT_0203;
    const ccomplex_t IT_0205 = (-6)*conj(IT_0182);
    const ccomplex_t IT_0206 = IT_0132*IT_0203;
    const ccomplex_t IT_0207 = IT_0160*IT_0202;
    const ccomplex_t IT_0208 = 18*conj(IT_0090)*IT_0154 + IT_0193*IT_0200 +
       IT_0207;
    const ccomplex_t IT_0209 = IT_0018*IT_0199;
    const ccomplex_t IT_0210 = ((conj(IT_0065) + conj(IT_0090))*IT_0093 + 
      ...
      (IT_0152)*((-36)*IT_0018 + IT_0163) + 6*IT_0155*IT_0190 + (-6)*IT_0182*((
      -0.166666666666667)*(36*IT_0018 + IT_0163)*conj(IT_0182) + (conj(IT_0065) 
      + -conj(IT_0090))*IT_0192 + -(IT_0157 + IT_0189)*IT_0193) + IT_0090*
      (IT_0154*(18*conj(IT_0125) + 18*conj(IT_0130) + IT_0162) + conj(IT_0090)
      *IT_0198 + IT_0160*IT_0199 + IT_0192*IT_0200 + IT_0201*IT_0202 + IT_0204) 
      + IT_0065*(18*conj(IT_0110)*IT_0154 + ((-18)*conj(IT_0125) + (-18)*conj
      (IT_0130) + IT_0156)*IT_0160 + conj(IT_0065)*IT_0198 + (-18)*conj(IT_0090)
      *IT_0201 + IT_0204 + IT_0192*IT_0205) + IT_0110*(18*conj(IT_0065)*IT_0154 
      + conj(IT_0110)*IT_0158 + IT_0193*IT_0205 + IT_0206) + IT_0125*(IT_0206 +
       IT_0208 + IT_0209) + IT_0130*(IT_0157*IT_0158 + IT_0206 + IT_0208 +
       IT_0209);
