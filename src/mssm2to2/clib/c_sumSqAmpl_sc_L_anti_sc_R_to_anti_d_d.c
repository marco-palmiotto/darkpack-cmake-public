...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = m_d*e_em*IT_0000*IT_0002*IT_0006*IT_0017;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u1
      *e_em*IT_0000*IT_0002*IT_0007;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*conj(V_cd)*e_em*conj(V_Wp1)
      *IT_0002;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0000*IT_0002*IT_0007;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*conj(V_cd)*e_em*conj(V_Wp2)
      *IT_0002;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*conj
      (V_cd)*e_em*IT_0000*IT_0002*IT_0017;
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*conj
      (V_cd)*e_em*IT_0000*IT_0002*IT_0017;
