...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = e_em*m_mu*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0005*IT_0028;
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0005*IT_0037;
