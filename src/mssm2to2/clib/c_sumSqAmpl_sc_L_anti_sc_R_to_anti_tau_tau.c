...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = e_em*m_tau*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0002
      *IT_0005*IT_0028;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0005*IT_0018*IT_0028;
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0002
      *IT_0005*IT_0037;
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0005*IT_0018*IT_0037;
