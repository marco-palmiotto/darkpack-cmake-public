        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0002 + IT_0010*IT_0011) + (-1.5)*IT_0000*IT_0001*IT_0003
      *IT_0005*IT_0012);
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0016 + (0 + _Complex_I*1)
      *m_sc_R*Gamma_cr + reg_prop, -1);
    const ccomplex_t IT_0018 = IT_0015*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0003*IT_0005*IT_0011;
    const ccomplex_t IT_0021 = (-0.5)*IT_0020;
    const ccomplex_t IT_0022 = IT_0004*IT_0009;
    const ccomplex_t IT_0023 = IT_0005 + IT_0022;
    const ccomplex_t IT_0024 = cpow(IT_0011, 3);
    const ccomplex_t IT_0025 = cpow(IT_0001, 2);
    const ccomplex_t IT_0026 = cpow(IT_0011, 2);
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_W*e_em*IT_0023*(IT_0002
      *IT_0024 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0011 + (-0.2)*IT_0010*(IT_0025
       + (-5)*IT_0026)));
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = IT_0021*IT_0028;
    const ccomplex_t IT_0030 = pow(m_sc_L, 2);
    const ccomplex_t IT_0031 = pow(m_sc_R, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0030 + -IT_0031 + -reg_prop, -1);
    const ccomplex_t IT_0033 = IT_0029*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*e_em*(0.5*m_W*(IT_0005 + -1.
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0016 + IT_0031 + -m_sc_L*
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0016 + IT_0030 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0005 + 
      -1./3*IT_0004*IT_0009)*(IT_0001*IT_0002 + IT_0010*IT_0011) + IT_0000
      *IT_0001*IT_0003*IT_0005*IT_0012);
    const ccomplex_t IT_0048 = -IT_0047;
    const ccomplex_t IT_0049 = IT_0007*IT_0048;
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0016 + (0 + _Complex_I*1)
      *m_sc_L*Gamma_cl + reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_W*e_em*IT_0023*(IT_0010
      *IT_0024 + 5*IT_0001*((-0.2)*IT_0001*(IT_0001*IT_0002 + 5*IT_0010*IT_0011)
       + IT_0002*IT_0026));
    const ccomplex_t IT_0054 = (-0.5)*IT_0053;
    const ccomplex_t IT_0055 = IT_0007*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + -IT_0030 + -IT_0031 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0057 = IT_0055*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = IT_0019 + -IT_0034 + IT_0040 + IT_0046 +
       IT_0052 + -IT_0058;
