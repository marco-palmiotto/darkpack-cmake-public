...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = m_c*e_em*mu_h*IT_0004*IT_0007*IT_0010*IT_0011;
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0005
    ...
    const ccomplex_t IT_0032 = m_c*e_em*mu_h*IT_0007*IT_0010;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0015 + IT_0025 + -m_sc_R*
