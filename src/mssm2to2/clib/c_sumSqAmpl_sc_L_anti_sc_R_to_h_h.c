        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0010 + IT_0003*IT_0011) + (-1.5)*IT_0000*IT_0002*IT_0005
      *IT_0010*IT_0012);
    ...
    const ccomplex_t IT_0026 = cpow(IT_0010, 2);
    const ccomplex_t IT_0027 = cpow(IT_0003, 2);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_W*e_em*IT_0024*(IT_0001
      *IT_0025 + (-5)*IT_0010*(IT_0001*IT_0003*IT_0010 + (-0.2)*IT_0011*(IT_0026
       + (-5)*IT_0027)));
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = IT_0022*IT_0029;
    const ccomplex_t IT_0031 = pow(m_sc_R, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_12 + -IT_0017 + -IT_0031 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0033 = IT_0030*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*m_W*e_em*IT_0024*(IT_0011
      *IT_0025 + -IT_0010*(IT_0010*(IT_0001*IT_0010 + IT_0003*IT_0011) + 
      -IT_0001*IT_0027));
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0017 + -IT_0031 + -reg_prop, -1);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0005 + 
      -1./3*IT_0004*IT_0009)*(IT_0001*IT_0010 + IT_0003*IT_0011) + IT_0000
      *IT_0002*IT_0005*IT_0010*IT_0012);
    const ccomplex_t IT_0042 = -IT_0041;
    const ccomplex_t IT_0043 = IT_0007*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0016 + IT_0031 + -m_sc_L*
    ...
    const ccomplex_t IT_0053 = IT_0020 + -IT_0034 + -IT_0040 + IT_0046 +
       IT_0049 + IT_0052;
