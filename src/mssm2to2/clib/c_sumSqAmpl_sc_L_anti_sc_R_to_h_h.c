...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_sc_R_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0019 = IT_0015*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0002
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0016 + (0 + _Complex_I*1)
      *m_sc_R*Gamma_cr + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0016 + (0 + _Complex_I*1)
      *m_sc_L*Gamma_cl + reg_prop, -1);
    const ccomplex_t IT_0028 = IT_0015*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = pow(m_sc_L, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0016 + IT_0030 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0023*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_12 + -IT_0017 + -IT_0030 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0002*IT_0005*IT_0009;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = IT_0004*IT_0012;
    const ccomplex_t IT_0038 = IT_0005 + IT_0037;
    const ccomplex_t IT_0039 = cpow(IT_0003, 3);
    const ccomplex_t IT_0040 = cpow(IT_0009, 2);
    const ccomplex_t IT_0041 = cpow(IT_0003, 2);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_W*e_em*IT_0038*(IT_0001
      *IT_0039 + (-5)*IT_0009*(IT_0001*IT_0003*IT_0009 + (-0.2)*IT_0010*(IT_0040
       + (-5)*IT_0041)));
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = IT_0036*IT_0043;
    const ccomplex_t IT_0045 = IT_0034*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_W*e_em*IT_0038*(IT_0010
      *IT_0039 + -IT_0009*(IT_0009*(IT_0001*IT_0009 + IT_0003*IT_0010) + 
      -IT_0001*IT_0041));
    ...
    const ccomplex_t IT_0053 = IT_0020 + IT_0026 + IT_0029 + IT_0033 + 
      -IT_0046 + -IT_0052;
