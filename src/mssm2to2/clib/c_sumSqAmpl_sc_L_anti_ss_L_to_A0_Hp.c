        ...
        )
{
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0023 + IT_0024 + -m_sb_1*
    ...
    const ccomplex_t IT_0052 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0001
      *U_sb_11;
    const ccomplex_t IT_0053 = (-0.5)*IT_0052;
    const ccomplex_t IT_0054 = IT_0051*IT_0053;
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0023 + IT_0024 + -m_sb_2*
    ...
    const ccomplex_t IT_0061 = e_em*IT_0013;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = IT_0060*IT_0062;
    const ccomplex_t IT_0064 = 0.5*IT_0024 + 0.5*IT_0036;
    const ccomplex_t IT_0065 = s_12 + IT_0064;
    const ccomplex_t IT_0066 = IT_0063*IT_0065;
    const ccomplex_t IT_0067 = IT_0060*IT_0061;
    const ccomplex_t IT_0068 = (-0.5)*s_13 + (-0.5)*s_23 + 0.5*IT_0024 + 0.5
      *IT_0036;
    const ccomplex_t IT_0069 = s_12 + IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = -IT_0059;
    const ccomplex_t IT_0072 = IT_0061*IT_0071;
    const ccomplex_t IT_0073 = s_12 + IT_0024;
    const ccomplex_t IT_0074 = -s_23;
    const ccomplex_t IT_0075 = IT_0073 + IT_0074;
    const ccomplex_t IT_0076 = IT_0072*IT_0075;
    const ccomplex_t IT_0077 = IT_0062*IT_0071;
    const ccomplex_t IT_0078 = IT_0073*IT_0077;
    const ccomplex_t IT_0079 = -IT_0070 + 0.5*IT_0076 + (-0.5)*IT_0078;
    ...
    const ccomplex_t IT_0083 = m_c*e_em*mu_h*IT_0012*IT_0013;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*mu_h*IT_0012*IT_0013;
    const ccomplex_t IT_0086 = 0.5*IT_0085;
    const ccomplex_t IT_0087 = IT_0084*IT_0086;
    const ccomplex_t IT_0088 = cpow((-2)*s_13 + IT_0023 + IT_0036 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*mu_h*IT_0012*IT_0013;
    const ccomplex_t IT_0092 = 0.5*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0001;
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = IT_0092*IT_0094;
    const ccomplex_t IT_0096 = cpow((-2)*s_23 + IT_0023 + IT_0024 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0097 = IT_0095*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*IT_0097;
    const ccomplex_t IT_0099 = IT_0011 + IT_0027 + -IT_0039 + IT_0049 +
       IT_0057 + (-2)*IT_0082 + IT_0090 + IT_0098;
