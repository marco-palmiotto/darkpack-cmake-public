        ...
        )
{
    ...
    const ccomplex_t IT_0010 = cpow(IT_0008, -1);
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001*(IT_0004*IT_0005*IT_0007*IT_0008 + (-2)*IT_0006*(m_W*IT_0008
       + (-0.5)*IT_0004*IT_0009*IT_0010));
    const ccomplex_t IT_0012 = 0.5*IT_0011;
    const ccomplex_t IT_0013 = pow(m_sc_L, 2);
    const ccomplex_t IT_0014 = pow(m_ss_L, 2);
    const ccomplex_t IT_0015 = cpow((-2)*s_12 + -IT_0013 + -IT_0014 + m_Hp*
    ...
    const ccomplex_t IT_0021 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0008
      *U_sb_10;
    const ccomplex_t IT_0022 = (-0.5)*IT_0021;
    const ccomplex_t IT_0023 = pow(m_A0, 2);
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0014 + IT_0023 + -m_sb_1*
    ...
    const ccomplex_t IT_0030 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0008
      *U_sb_11;
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0014 + IT_0023 + -m_sb_2*
    ...
    const ccomplex_t IT_0036 = IT_0018 + -IT_0027 + -IT_0035;
    const ccomplex_t IT_0037 = pow(m_W, -2);
    const ccomplex_t IT_0038 = pow(s_34, 2);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = IT_0027 + IT_0035;
    const ccomplex_t IT_0041 = s_24*s_34*IT_0037;
    const ccomplex_t IT_0042 = -IT_0041;
    const ccomplex_t IT_0043 = s_23 + IT_0042;
    const ccomplex_t IT_0044 = pow(s_24, 2);
    const ccomplex_t IT_0045 = IT_0037*IT_0044;
    return create_ccomplex_return((-3)*IT_0036*(conj(IT_0036)*(IT_0023 + 
      -IT_0039) + conj(IT_0040)*IT_0043) + (-3)*IT_0040*(conj(IT_0036)*IT_0043 +
       conj(IT_0040)*(IT_0014 + -IT_0045)));
}
