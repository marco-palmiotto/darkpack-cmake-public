        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0001 + -m_s*e_em*mu_h*IT_0007*IT_0014*IT_0015*IT_0018);
    const ccomplex_t IT_0020 = (-0.5)*IT_0019;
    const ccomplex_t IT_0021 = IT_0017*IT_0020;
    const ccomplex_t IT_0022 = pow(m_H0, 2);
    const ccomplex_t IT_0023 = pow(m_ss_L, 2);
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_ss_R*
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0015*(IT_0002*IT_0004*IT_0014*IT_0018 + (-2)*IT_0005*(m_W*IT_0002
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0004
      *IT_0014*IT_0015*IT_0018 + (-0.5)*m_W*(IT_0001*IT_0005 + -IT_0002*IT_0007)
      *(IT_0015 + 1./3*IT_0010*IT_0031));
    const ccomplex_t IT_0033 = -IT_0032;
    const ccomplex_t IT_0034 = IT_0029*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0022 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = -IT_0015;
    const ccomplex_t IT_0039 = IT_0010*IT_0031;
    const ccomplex_t IT_0040 = IT_0038 + IT_0039;
    const ccomplex_t IT_0041 = cpow(IT_0002, 3);
    const ccomplex_t IT_0042 = -IT_0005;
    const ccomplex_t IT_0043 = 3*IT_0015 + IT_0039;
    const ccomplex_t IT_0044 = cpow(IT_0002, 2);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_W*e_em*(IT_0007*IT_0040
      *IT_0041 + IT_0042*(IT_0042*(IT_0001*IT_0005*IT_0040 + -IT_0002*IT_0007
      *IT_0043) + IT_0001*IT_0043*IT_0044));
    const ccomplex_t IT_0046 = 0.5*IT_0045;
    const ccomplex_t IT_0047 = IT_0029*IT_0046;
    const ccomplex_t IT_0048 = pow(m_sc_L, 2);
    const ccomplex_t IT_0049 = cpow((-2)*s_12 + -IT_0023 + -IT_0048 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0047*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0001
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0022 + IT_0048 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*mu_h*IT_0014*IT_0015;
    const ccomplex_t IT_0061 = 0.5*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0001;
    const ccomplex_t IT_0063 = (-0.5)*IT_0062;
    const ccomplex_t IT_0064 = IT_0061*IT_0063;
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_sb_2*
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      ...
      *IT_0008*IT_0027*conj(U_sb_01) + m_b*(m_b*IT_0002*IT_0018*conj(U_sb_01) +
       mu_h*conj(U_sb_11))));
    ...
    const ccomplex_t IT_0076 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0023 + -IT_0048 + -reg_prop, -1);
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0015;
    const ccomplex_t IT_0078 = (-0.5)*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0002 + 
      -IT_0005*IT_0007)*IT_0015;
    const ccomplex_t IT_0080 = 0.5*IT_0079;
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = 0.5*IT_0023 + 0.5*IT_0048;
    const ccomplex_t IT_0083 = s_12 + IT_0082;
    const ccomplex_t IT_0084 = IT_0081*IT_0083;
    const ccomplex_t IT_0085 = IT_0078*IT_0079;
    const ccomplex_t IT_0086 = (-0.5)*s_13 + (-0.5)*s_23 + 0.5*IT_0023 + 0.5
      *IT_0048;
    const ccomplex_t IT_0087 = s_12 + IT_0086;
    const ccomplex_t IT_0088 = IT_0085*IT_0087;
    const ccomplex_t IT_0089 = s_12 + IT_0023;
    const ccomplex_t IT_0090 = -IT_0077;
    const ccomplex_t IT_0091 = IT_0080*IT_0090;
    const ccomplex_t IT_0092 = IT_0089*IT_0091;
    const ccomplex_t IT_0093 = IT_0079*IT_0090;
    const ccomplex_t IT_0094 = -s_23;
    const ccomplex_t IT_0095 = IT_0089 + IT_0094;
    const ccomplex_t IT_0096 = IT_0093*IT_0095;
    const ccomplex_t IT_0097 = -IT_0088 + (-0.5)*IT_0092 + 0.5*IT_0096;
    ...
    const ccomplex_t IT_0101 = cpow(IT_0005, 2);
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0015
      *IT_0041 + (-2)*IT_0005*(IT_0002*(IT_0001*IT_0005 + -IT_0002*IT_0007)*(0.5
      *IT_0015 + IT_0010*IT_0031) + 1./2*IT_0007*IT_0015*IT_0101));
    const ccomplex_t IT_0103 = (-0.5)*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*(-1.4142135623731))*conj(V_cs)
      *e_em*IT_0015*((IT_0004 + -IT_0008)*IT_0014 + m_W*(IT_0044 + -IT_0101));
    const ccomplex_t IT_0105 = 0.5*IT_0104;
    const ccomplex_t IT_0106 = IT_0103*IT_0105;
    const ccomplex_t IT_0107 = pow(m_W, 2);
    const ccomplex_t IT_0108 = cpow((-2)*s_12 + -IT_0023 + -IT_0048 + IT_0107 
      + -reg_prop, -1);
    const ccomplex_t IT_0109 = IT_0106*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*e_em*(IT_0007*IT_0008
    ...
    const ccomplex_t IT_0117 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0015*(m_W*IT_0002*IT_0005*conj(U_sb_00) + (-0.5)*IT_0014*(IT_0005
      *IT_0008*IT_0027*conj(U_sb_00) + m_b*(m_b*IT_0002*IT_0018*conj(U_sb_00) +
       mu_h*conj(U_sb_10))));
    ...
    const ccomplex_t IT_0125 = IT_0013 + IT_0026 + IT_0037 + -IT_0051 +
       IT_0059 + IT_0067 + IT_0075 + (-2)*IT_0100 + -IT_0110 + IT_0116 + IT_0124;
