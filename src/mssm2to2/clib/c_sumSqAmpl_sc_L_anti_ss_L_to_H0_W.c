        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0005
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0010 + IT_0027 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = IT_0033*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0005 + IT_0006*IT_0007);
    const ccomplex_t IT_0041 = -IT_0040;
    const ccomplex_t IT_0042 = pow(m_c, 2);
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*(-1.4142135623731))*conj(V_cs)
      *e_em*IT_0001*(IT_0020*(IT_0021 + -IT_0042) + -m_W*(IT_0043 + -IT_0044));
    const ccomplex_t IT_0046 = 0.5*IT_0045;
    const ccomplex_t IT_0047 = pow(m_W, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + IT_0047 
      + -reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = IT_0041*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0005
      *IT_0006 + -IT_0004*IT_0007);
    const ccomplex_t IT_0053 = cpow(IT_0006, -1);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001*(IT_0006*IT_0020*IT_0021*IT_0022 + (-2)*IT_0004*(m_W*IT_0006
       + (-0.5)*IT_0020*IT_0042*IT_0053));
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0010 + IT_0027 + -m_sb_1*
    ...
    const ccomplex_t IT_0094 = (-3)*IT_0015*(conj(IT_0015)*(IT_0009 + -IT_0018
      ...
      *IT_0085 + (-3)*IT_0068*((-0.333333333333333)*IT_0071*IT_0085 + conj
      (IT_0068)*(IT_0027 + -IT_0087) + conj(IT_0081)*IT_0090) + (conj(IT_0068)
