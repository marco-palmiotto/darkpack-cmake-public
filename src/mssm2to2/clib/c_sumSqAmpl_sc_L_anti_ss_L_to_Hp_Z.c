...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_ss_L_to_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0003*(IT_0005*IT_0006*IT_0008*IT_0009 + (-2)*IT_0007*(m_W*IT_0009
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_23 + IT_0015 + IT_0022 + -m_sc_L*
    ...
    const ccomplex_t IT_0033 = cpow((-2)*s_13 + IT_0014 + IT_0022 + -m_ss_L*
