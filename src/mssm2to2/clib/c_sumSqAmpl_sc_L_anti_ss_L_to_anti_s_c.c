        ...
        )
{
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0006;
    const ccomplex_t IT_0096 = 0.5*IT_0095;
    const ccomplex_t IT_0097 = pow(m_sc_L, 2);
    const ccomplex_t IT_0098 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0022 + -IT_0097 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0102 = (-0.5)*IT_0091 + -IT_0101;
    const ccomplex_t IT_0103 = pow(m_W, -1);
    const ccomplex_t IT_0104 = cos(beta);
    const ccomplex_t IT_0105 = cpow(IT_0104, -1);
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0006*IT_0103*IT_0105;
    const ccomplex_t IT_0107 = (-0.5)*IT_0106;
    const ccomplex_t IT_0108 = sin(beta);
    const ccomplex_t IT_0109 = cpow(IT_0108, -1);
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0006*IT_0103*IT_0109;
    ...
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0006*IT_0103*IT_0105;
    const ccomplex_t IT_0116 = (-0.5)*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0006*IT_0103*IT_0109;
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0103*IT_0105;
    const ccomplex_t IT_0123 = (-0.5)*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0006*IT_0103*IT_0109;
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0103*IT_0105;
    ...
    const ccomplex_t IT_0134 = IT_0083*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*IT_0134;
    const ccomplex_t IT_0136 = -IT_0114 + -IT_0121 + -IT_0128 + -IT_0135;
    const ccomplex_t IT_0137 = s_34*IT_0097;
    ...
    const ccomplex_t IT_0142 = m_c*m_s*IT_0097;
    const ccomplex_t IT_0143 = (-18)*IT_0092 + (-6)*IT_0102;
    const ccomplex_t IT_0144 = (-6)*conj(IT_0102);
    const ccomplex_t IT_0145 = (-18)*conj(IT_0092);
    const ccomplex_t IT_0146 = IT_0144 + IT_0145;
    const ccomplex_t IT_0147 = m_c*s_13;
    const ccomplex_t IT_0148 = IT_0019*IT_0111;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0150 = IT_0023*IT_0148*IT_0149;
    const ccomplex_t IT_0151 = IT_0041*IT_0118;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0153 = IT_0043*IT_0151*IT_0152;
    const ccomplex_t IT_0154 = IT_0061*IT_0125;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0156 = IT_0063*IT_0154*IT_0155;
    const ccomplex_t IT_0157 = IT_0081*IT_0132;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0159 = IT_0083*IT_0157*IT_0158;
    const ccomplex_t IT_0160 = m_c*IT_0025;
    const ccomplex_t IT_0161 = m_c*IT_0045;
    const ccomplex_t IT_0162 = m_c*IT_0065;
    const ccomplex_t IT_0163 = m_c*IT_0085;
    const ccomplex_t IT_0164 = m_c*IT_0091;
    const ccomplex_t IT_0165 = -IT_0150 + -IT_0153 + -IT_0156 + -IT_0159 +
       IT_0160 + IT_0161 + IT_0162 + IT_0163 + (-0.166666666666667)*IT_0164;
    const ccomplex_t IT_0166 = pow(m_c, 2);
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0006*(IT_0021*IT_0103*IT_0105*IT_0108 + (-2)*IT_0104*(m_W*IT_0108
       + (-0.5)*IT_0103*IT_0109*IT_0166));
    const ccomplex_t IT_0168 = 0.5*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
      *IT_0006*IT_0103*IT_0104*IT_0109;
    const ccomplex_t IT_0170 = 0.5*IT_0169;
    const ccomplex_t IT_0171 = IT_0168*IT_0170;
    const ccomplex_t IT_0172 = cpow((-2)*s_12 + -IT_0022 + -IT_0097 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0173 = IT_0171*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*IT_0173;
    const ccomplex_t IT_0175 = (-0.5)*IT_0093;
    const ccomplex_t IT_0176 = m_c*IT_0175;
    const ccomplex_t IT_0177 = m_c*IT_0094;
    const ccomplex_t IT_0178 = -IT_0177;
    const ccomplex_t IT_0179 = IT_0176 + IT_0178;
    const ccomplex_t IT_0180 = IT_0100*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
      *IT_0006*IT_0103;
    const ccomplex_t IT_0182 = 0.5*IT_0181;
    const ccomplex_t IT_0183 = cpow(IT_0104, 2);
    const ccomplex_t IT_0184 = cpow(IT_0108, 2);
    const ccomplex_t IT_0185 = (0 + _Complex_I*(-1.4142135623731))*conj(V_cs)
      *e_em*IT_0006*(IT_0103*(IT_0021 + -IT_0166) + -m_W*(IT_0183 + -IT_0184));
    const ccomplex_t IT_0186 = 0.5*IT_0185;
    const ccomplex_t IT_0187 = IT_0182*IT_0186;
    const ccomplex_t IT_0188 = pow(m_W, 2);
    const ccomplex_t IT_0189 = cpow((-2)*s_12 + -IT_0022 + -IT_0097 + IT_0188 
      + -reg_prop, -1);
    const ccomplex_t IT_0190 = IT_0187*IT_0189;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*IT_0190;
    const ccomplex_t IT_0192 = 0.5*IT_0164 + -IT_0174 + -IT_0180 + -IT_0191;
    const ccomplex_t IT_0193 = IT_0011*IT_0107;
    const ccomplex_t IT_0194 = IT_0023*IT_0149*IT_0193;
    const ccomplex_t IT_0195 = IT_0033*IT_0116;
    const ccomplex_t IT_0196 = IT_0043*IT_0152*IT_0195;
    const ccomplex_t IT_0197 = IT_0053*IT_0123;
    const ccomplex_t IT_0198 = IT_0063*IT_0155*IT_0197;
    const ccomplex_t IT_0199 = IT_0073*IT_0130;
    const ccomplex_t IT_0200 = IT_0083*IT_0158*IT_0199;
    const ccomplex_t IT_0201 = m_c*IT_0114;
    const ccomplex_t IT_0202 = m_c*IT_0121;
    const ccomplex_t IT_0203 = m_c*IT_0128;
    const ccomplex_t IT_0204 = m_c*IT_0135;
    ...
    const ccomplex_t IT_0208 = IT_0186*IT_0207;
    const ccomplex_t IT_0209 = IT_0189*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*IT_0209;
    const ccomplex_t IT_0211 = m_s*IT_0175;
    const ccomplex_t IT_0212 = m_s*IT_0094;
    const ccomplex_t IT_0213 = -IT_0212;
    const ccomplex_t IT_0214 = IT_0211 + IT_0213;
    const ccomplex_t IT_0215 = IT_0100*IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *IT_0006*IT_0103*IT_0105*IT_0108;
    const ccomplex_t IT_0217 = 0.5*IT_0216;
    const ccomplex_t IT_0218 = IT_0168*IT_0217;
    const ccomplex_t IT_0219 = IT_0172*IT_0218;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*IT_0219;
    const ccomplex_t IT_0221 = -IT_0210 + IT_0215 + -IT_0220;
    const ccomplex_t IT_0222 = IT_0165 + 3*IT_0192;
    const ccomplex_t IT_0223 = 3*conj(IT_0192);
    const ccomplex_t IT_0224 = conj(IT_0165) + IT_0223;
    const ccomplex_t IT_0225 = conj(IT_0092)*(18*IT_0165 + 6*IT_0192) +
       IT_0092*(18*conj(IT_0165) + 6*conj(IT_0192)) + conj(IT_0136)*(18*IT_0205 
      + 6*IT_0221) + IT_0136*(18*conj(IT_0205) + 6*conj(IT_0221)) + 6*conj
      (IT_0102)*IT_0222 + 6*IT_0102*IT_0224;
    const ccomplex_t IT_0226 = m_c*m_s;
    const ccomplex_t IT_0227 = (-18)*IT_0165;
    const ccomplex_t IT_0228 = (-6)*IT_0192;
    const ccomplex_t IT_0229 = IT_0227 + IT_0228;
    const ccomplex_t IT_0230 = (-18)*conj(IT_0165);
    const ccomplex_t IT_0231 = (-6)*conj(IT_0192);
    const ccomplex_t IT_0232 = IT_0230 + IT_0231;
    const ccomplex_t IT_0233 = m_s*s_14;
    const ccomplex_t IT_0234 = (-6)*((-0.166666666666667)*IT_0146*IT_0205 + (
      -0.166666666666667)*IT_0143*conj(IT_0205) + (conj(IT_0092) + 3*conj
      (IT_0102))*IT_0221 + (IT_0092 + 3*IT_0102)*conj(IT_0221) + (
      -0.166666666666667)*conj(IT_0136)*IT_0229 + (-0.166666666666667)*IT_0136
      *IT_0232)*IT_0233;
    const ccomplex_t IT_0235 = 6*s_34;
    const ccomplex_t IT_0236 = 18*s_34;
    const ccomplex_t IT_0237 = 12*IT_0139;
    const ccomplex_t IT_0238 = (-6)*IT_0137;
    const ccomplex_t IT_0239 = (IT_0092*conj(IT_0092) + IT_0102*conj(IT_0102) 
      + IT_0136*conj(IT_0136))*IT_0141 + IT_0142*(conj(IT_0136)*IT_0143 +
       IT_0136*IT_0146) + IT_0147*IT_0225 + (-6)*IT_0226*(conj(IT_0221)*IT_0222 
      + IT_0221*IT_0224 + (-0.166666666666667)*conj(IT_0205)*IT_0229 + (
      -0.166666666666667)*IT_0205*IT_0232) + IT_0234 + (conj(IT_0165)*IT_0192 +
       IT_0165*conj(IT_0192) + conj(IT_0205)*IT_0221 + IT_0205*conj(IT_0221))
      *IT_0235 + (IT_0165*conj(IT_0165) + IT_0192*conj(IT_0192) + IT_0205*conj
      (IT_0205) + IT_0221*conj(IT_0221))*IT_0236 + (conj(IT_0092)*IT_0102 +
       IT_0092*conj(IT_0102))*(IT_0237 + IT_0238);
