...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_ss_L_to_h_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0010 + IT_0023 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0022*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = IT_0020*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0010 + IT_0023 + -m_sb_2*
    ...
    const ccomplex_t IT_0042 = cpow(IT_0005, -1);
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001*(IT_0005*IT_0038*IT_0039*IT_0040 + (-2)*IT_0006*(m_W*IT_0005
       + (-0.5)*IT_0038*IT_0041*IT_0042));
    const ccomplex_t IT_0044 = 0.5*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + m_Hp*
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*(-1.4142135623731))*conj(V_cs)
      *e_em*IT_0001*(IT_0038*(IT_0039 + -IT_0041) + -m_W*(IT_0051 + -IT_0052));
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0007
      *IT_0038*IT_0039*IT_0040 + (-0.5)*m_W*(IT_0004*IT_0005 + IT_0006*IT_0007)*
      (IT_0001 + 1./3*IT_0000*IT_0062));
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0023 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0068 = -IT_0027 + -IT_0035 + IT_0048 + IT_0059 + 
      -IT_0067;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0004
      *IT_0038*IT_0041*IT_0042 + (-0.5)*m_W*(IT_0004*IT_0005 + IT_0006*IT_0007)*
      (IT_0001 + -1./3*IT_0000*IT_0062));
    const ccomplex_t IT_0076 = -IT_0075;
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0023 + (0 + _Complex_I*1)
      *m_sc_L*Gamma_cl + reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = IT_0060*IT_0079;
    const ccomplex_t IT_0081 = IT_0027 + IT_0035 + IT_0067 + -IT_0074 + IT_0080;
    ...
    const ccomplex_t IT_0094 = (-3)*IT_0015*(conj(IT_0015)*(IT_0009 + -IT_0018
      ...
      *IT_0085 + (-3)*IT_0068*((-0.333333333333333)*IT_0071*IT_0085 + conj
      (IT_0068)*(IT_0023 + -IT_0087) + conj(IT_0081)*IT_0090) + (conj(IT_0068)
