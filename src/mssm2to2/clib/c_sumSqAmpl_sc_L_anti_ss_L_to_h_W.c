        ...
        )
{
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*(-1.4142135623731))*conj(V_cs)
      *e_em*IT_0001*(IT_0020*(IT_0021 + -IT_0033) + -m_W*(IT_0034 + -IT_0035));
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0010 + IT_0026 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*IT_0048;
    const ccomplex_t IT_0050 = IT_0044*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0006 + IT_0005*IT_0007);
    const ccomplex_t IT_0052 = -IT_0051;
    const ccomplex_t IT_0053 = cpow(IT_0005, -1);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001*(IT_0005*IT_0020*IT_0021*IT_0022 + (-2)*IT_0006*(m_W*IT_0005
       + (-0.5)*IT_0020*IT_0033*IT_0053));
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0010 + IT_0026 + -m_sb_1*
    ...
    const ccomplex_t IT_0068 = -IT_0030 + IT_0042 + -IT_0050 + IT_0059 + 
      -IT_0067;
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0004
      ...
      *IT_0004*IT_0020*IT_0033*IT_0053);
    const ccomplex_t IT_0076 = -IT_0075;
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0026 + (0 + _Complex_I*1)
      *m_sc_L*Gamma_cl + reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = IT_0019*IT_0079;
    const ccomplex_t IT_0081 = IT_0030 + IT_0050 + IT_0067 + -IT_0074 + IT_0080;
    ...
    const ccomplex_t IT_0094 = (-3)*IT_0015*(conj(IT_0015)*(IT_0009 + -IT_0018
      ...
      *IT_0085 + (-3)*IT_0068*((-0.333333333333333)*IT_0071*IT_0085 + conj
      (IT_0068)*(IT_0026 + -IT_0087) + conj(IT_0081)*IT_0090) + (conj(IT_0068)
