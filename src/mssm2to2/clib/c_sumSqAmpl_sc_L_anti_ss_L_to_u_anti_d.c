...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_ss_L_to_u_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001*(IT_0019*(IT_0022 + -IT_0023) + m_W*(IT_0025 + -IT_0027));
    ...
    const ccomplex_t IT_0035 = cpow(IT_0026, -1);
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0001*IT_0019*IT_0024*IT_0035;
    const ccomplex_t IT_0037 = 0.5*IT_0036;
    const ccomplex_t IT_0038 = cpow(IT_0024, -1);
    const ccomplex_t IT_0039 = (0 + _Complex_I*(-2.82842712474619))*conj(V_cs)
      *e_em*IT_0001*(IT_0024*(m_W*IT_0026 + (-0.5)*IT_0019*IT_0022*IT_0035) + 
      -1./2*IT_0019*IT_0023*IT_0026*IT_0038);
    ...
    const ccomplex_t IT_0046 = m_u*s_14;
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0001*IT_0019*IT_0026*IT_0038;
    ...
    const ccomplex_t IT_0057 = m_d*IT_0013;
    const ccomplex_t IT_0058 = m_d*IT_0003;
