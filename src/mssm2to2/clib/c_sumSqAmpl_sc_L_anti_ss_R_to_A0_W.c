        ...
        )
{
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
      *IT_0001*conj(U_sb_00);
    const ccomplex_t IT_0027 = -IT_0026;
    const ccomplex_t IT_0028 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0004
      *U_sb_00;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = IT_0027*IT_0032;
    const ccomplex_t IT_0034 = e_em*IT_0001;
    ...
    const ccomplex_t IT_0045 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0004;
    ...
    const ccomplex_t IT_0051 = -IT_0012 + -IT_0025 + -IT_0033 + IT_0042 + 
      -IT_0050;
    const ccomplex_t IT_0052 = pow(m_W, -2);
    const ccomplex_t IT_0053 = pow(s_34, 2);
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = IT_0012 + IT_0025 + IT_0033 + IT_0050;
