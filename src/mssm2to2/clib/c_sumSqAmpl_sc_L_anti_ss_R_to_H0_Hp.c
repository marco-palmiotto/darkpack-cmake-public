        ...
        )
{
    ...
    const ccomplex_t IT_0046 = -IT_0002;
    const ccomplex_t IT_0047 = 3*IT_0008 + IT_0043;
    const ccomplex_t IT_0048 = cpow(IT_0004, 2);
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*m_W*e_em*(IT_0023*IT_0044
      *IT_0045 + IT_0046*(IT_0046*(IT_0002*IT_0011*IT_0044 + -IT_0004*IT_0023
      *IT_0047) + IT_0011*IT_0047*IT_0048));
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = IT_0039*IT_0050;
    const ccomplex_t IT_0052 = pow(m_sc_L, 2);
    const ccomplex_t IT_0053 = cpow((-2)*s_12 + -IT_0016 + -IT_0052 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0054 = IT_0051*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0006*IT_0008*IT_0011;
    const ccomplex_t IT_0057 = 0.5*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0000*IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0059 = 0.5*IT_0058;
    const ccomplex_t IT_0060 = IT_0057*IT_0059;
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0015 + IT_0052 + -m_sc_R*
      (m_sc_R + (0 + _Complex_I*-1)*Gamma_cr) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0005
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0015 + (0 + _Complex_I*1)
      *m_sc_L*Gamma_cl + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sb_2*
    ...
    const ccomplex_t IT_0078 = cpow(IT_0002, 2);
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_W*e_em*(IT_0008*IT_0011
      *IT_0045 + (-2)*IT_0002*(IT_0004*(IT_0002*IT_0011 + -IT_0004*IT_0023)*(0.5
      *IT_0008 + IT_0007*IT_0042) + 1./2*IT_0008*IT_0023*IT_0078));
    const ccomplex_t IT_0080 = (-0.5)*IT_0079;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_12 + -IT_0016 + -IT_0052 + IT_0084 
      + -reg_prop, -1);
    const ccomplex_t IT_0086 = IT_0083*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*-3)*e_em*(IT_0000*IT_0003
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_23 + IT_0015 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    const ccomplex_t IT_0092 = IT_0090*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*IT_0092;
    const ccomplex_t IT_0094 = IT_0019 + IT_0029 + IT_0037 + -IT_0055 +
       IT_0063 + IT_0069 + IT_0077 + -IT_0087 + IT_0093;
