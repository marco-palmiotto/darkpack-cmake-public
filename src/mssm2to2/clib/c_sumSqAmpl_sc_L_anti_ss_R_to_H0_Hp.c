...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_ss_R_to_H0_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0000*IT_0008;
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = -IT_0008;
    ...
    const ccomplex_t IT_0053 = cpow(IT_0004, 3);
    const ccomplex_t IT_0054 = -IT_0002;
    const ccomplex_t IT_0055 = 3*IT_0008 + IT_0051;
    const ccomplex_t IT_0056 = cpow(IT_0004, 2);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*m_W*e_em*(IT_0023*IT_0052
      *IT_0053 + IT_0054*(IT_0054*(IT_0002*IT_0011*IT_0052 + -IT_0004*IT_0023
      *IT_0055) + IT_0011*IT_0055*IT_0056));
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = IT_0047*IT_0058;
    const ccomplex_t IT_0060 = pow(m_sc_L, 2);
    const ccomplex_t IT_0061 = cpow((-2)*s_12 + -IT_0016 + -IT_0060 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0059*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0006*IT_0008*IT_0011;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0000*IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = IT_0065*IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_13 + IT_0015 + IT_0060 + -m_sc_R*
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_23 + IT_0015 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = cpow(IT_0002, 2);
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*m_W*e_em*(IT_0008*IT_0011
      *IT_0053 + (-2)*IT_0002*(IT_0004*(IT_0002*IT_0011 + -IT_0004*IT_0023)*(0.5
      *IT_0008 + IT_0007*IT_0050) + 1./2*IT_0008*IT_0023*IT_0084));
    const ccomplex_t IT_0086 = (-0.5)*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_12 + -IT_0016 + -IT_0060 + IT_0090 
      + -reg_prop, -1);
    const ccomplex_t IT_0092 = IT_0089*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*IT_0092;
    const ccomplex_t IT_0094 = IT_0019 + IT_0029 + IT_0037 + IT_0045 + 
      -IT_0063 + IT_0071 + IT_0077 + IT_0083 + -IT_0093;
