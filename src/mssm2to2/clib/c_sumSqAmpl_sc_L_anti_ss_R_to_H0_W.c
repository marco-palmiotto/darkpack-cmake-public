        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0001*IT_0017;
    const ccomplex_t IT_0019 = 0.5*IT_0018;
    const ccomplex_t IT_0020 = pow(m_sc_L, 2);
    const ccomplex_t IT_0021 = cpow((-2)*s_12 + -IT_0008 + -IT_0020 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0022 = IT_0019*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*IT_0022;
    const ccomplex_t IT_0024 = IT_0016*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0014 + IT_0013*IT_0015);
    const ccomplex_t IT_0026 = -IT_0025;
    const ccomplex_t IT_0027 = cpow(IT_0014, -1);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0001*IT_0013*IT_0017*IT_0027;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = pow(m_W, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_12 + -IT_0008 + -IT_0020 + IT_0030 
      + -reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0029*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = IT_0026*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001;
    const ccomplex_t IT_0036 = -IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0004 + -m_s*e_em*mu_h*IT_0001*IT_0015*IT_0017*IT_0027);
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = IT_0036*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*conj(V_cd)
      *e_em*IT_0001;
    const ccomplex_t IT_0044 = -IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0004;
    const ccomplex_t IT_0046 = (-0.5)*IT_0045;
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sd_L*
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = IT_0052*IT_0057;
    const ccomplex_t IT_0059 = -IT_0012 + IT_0024 + IT_0034 + -IT_0042 + 
      -IT_0050 + -IT_0058;
    const ccomplex_t IT_0060 = pow(m_W, -2);
    const ccomplex_t IT_0061 = pow(s_34, 2);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = IT_0012 + IT_0042 + IT_0050 + IT_0058;
