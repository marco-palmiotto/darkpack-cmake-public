...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_ss_R_to_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0009 + IT_0016 + -m_sc_L*
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0008 + IT_0016 + -m_ss_R*
