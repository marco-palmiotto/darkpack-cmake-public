        ...
        )
{
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0000*IT_0004;
    const ccomplex_t IT_0103 = 0.5*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
    ...
    const ccomplex_t IT_0165 = m_c*m_s*IT_0098;
    ...
    const ccomplex_t IT_0173 = m_c*m_s;
