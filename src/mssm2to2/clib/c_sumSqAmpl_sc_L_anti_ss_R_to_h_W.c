...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_ss_R_to_h_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
    ...
    const ccomplex_t IT_0022 = cpow((-2)*s_23 + IT_0012 + IT_0021 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0023 = IT_0020*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*IT_0023;
    const ccomplex_t IT_0025 = IT_0018*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*conj(V_cd)
      *e_em*IT_0005;
    const ccomplex_t IT_0027 = -IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0003;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_23 + IT_0012 + IT_0021 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = IT_0027*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*V_cb*e_em
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0012 + IT_0021 + -m_sb_2*
    ...
    const ccomplex_t IT_0044 = cpow(IT_0000, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0002*IT_0005*IT_0008*IT_0044;
    const ccomplex_t IT_0046 = 0.5*IT_0045;
    const ccomplex_t IT_0047 = pow(m_W, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_12 + -IT_0011 + -IT_0012 + IT_0047 
      + -reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = IT_0043*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0005;
    const ccomplex_t IT_0053 = -IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0003 + m_s*e_em*mu_h*IT_0001*IT_0005*IT_0008*IT_0044);
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0012 + IT_0021 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0057 = IT_0055*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = IT_0053*IT_0058;
    const ccomplex_t IT_0060 = IT_0016 + -IT_0025 + -IT_0033 + -IT_0041 +
       IT_0051 + -IT_0059;
    const ccomplex_t IT_0061 = pow(m_W, -2);
    const ccomplex_t IT_0062 = pow(s_34, 2);
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = IT_0025 + IT_0033 + IT_0041 + IT_0059;
    ...
    return create_ccomplex_return((-3)*IT_0060*(conj(IT_0060)*(IT_0021 + 
      -IT_0063) + conj(IT_0064)*IT_0067) + (-3)*IT_0064*(conj(IT_0060)*IT_0067 +
       conj(IT_0064)*(IT_0012 + -IT_0069)));
}
