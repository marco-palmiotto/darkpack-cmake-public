        ...
        )
{
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_12 + -IT_0008 + -IT_0038 + m_Hp*
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_1*
    ...
    return create_ccomplex_return((-3)*IT_0060*(conj(IT_0060)*(IT_0007 + 
      -IT_0063) + conj(IT_0064)*IT_0067) + (-3)*IT_0064*(conj(IT_0060)*IT_0067 +
       conj(IT_0064)*(IT_0008 + -IT_0069)));
}
