...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_st_1_to_s_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_cs)*e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0010 = 0.5*IT_0009;
    const ccomplex_t IT_0011 = sin(beta);
    const ccomplex_t IT_0012 = cpow(IT_0011, -1);
    const ccomplex_t IT_0013 = IT_0008*IT_0012;
    const ccomplex_t IT_0014 = m_t*V_tb*V_u1*e_em*IT_0004*conj(U_st_10);
    ...
    const ccomplex_t IT_0019 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0026 = IT_0000*IT_0003*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0001 + IT_0002 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = m_t*V_tb*V_u2*e_em*IT_0004*conj(U_st_10);
    ...
    const ccomplex_t IT_0036 = V_tb*e_em*V_Wp2*conj(U_st_00);
    ...
    const ccomplex_t IT_0043 = IT_0027*IT_0028*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp2)
      *IT_0008;
    const ccomplex_t IT_0045 = IT_0028*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = m_s*IT_0035;
    const ccomplex_t IT_0048 = m_s*IT_0039;
    ...
    const ccomplex_t IT_0055 = m_s*IT_0018;
    const ccomplex_t IT_0056 = m_s*IT_0022;
    const ccomplex_t IT_0057 = -IT_0056;
    const ccomplex_t IT_0058 = IT_0055 + IT_0057;
    const ccomplex_t IT_0059 = IT_0054*IT_0058;
    const ccomplex_t IT_0060 = -IT_0026 + -IT_0043 + IT_0051 + IT_0059;
    const ccomplex_t IT_0061 = IT_0041*IT_0046;
    const ccomplex_t IT_0062 = IT_0024*IT_0054;
    ...
    const ccomplex_t IT_0078 = m_b*m_s;
    const ccomplex_t IT_0079 = IT_0044*IT_0066;
    const ccomplex_t IT_0080 = IT_0027*IT_0028*IT_0079;
    const ccomplex_t IT_0081 = IT_0052*IT_0071;
    const ccomplex_t IT_0082 = IT_0000*IT_0003*IT_0081;
    const ccomplex_t IT_0083 = m_s*IT_0069;
    const ccomplex_t IT_0084 = m_s*IT_0074;
    const ccomplex_t IT_0085 = IT_0080 + IT_0082 + -IT_0083 + -IT_0084;
    const ccomplex_t IT_0086 = (-18)*conj(IT_0085);
    const ccomplex_t IT_0087 = m_b*m_s*IT_0002;
