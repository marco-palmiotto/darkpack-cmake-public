        ...
        )
{
    ...
    const ccomplex_t IT_0126 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0127 = IT_0012*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = m_t*conj(N_u2)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0142 = m_t*conj(N_u3)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0155 = m_t*conj(N_u4)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0171 = IT_0037*IT_0112;
    const ccomplex_t IT_0172 = IT_0010*IT_0170*IT_0171;
    const ccomplex_t IT_0173 = IT_0083*IT_0138;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0175 = IT_0064*IT_0173*IT_0174;
    const ccomplex_t IT_0176 = IT_0105*IT_0151;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0178 = IT_0107*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = m_c*IT_0008;
    const ccomplex_t IT_0180 = m_c*IT_0040;
    const ccomplex_t IT_0181 = m_c*IT_0063;
    const ccomplex_t IT_0182 = m_c*IT_0109;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0184 = IT_0060*IT_0125;
    const ccomplex_t IT_0185 = IT_0041*IT_0183*IT_0184;
    const ccomplex_t IT_0186 = m_c*IT_0086;
    const ccomplex_t IT_0187 = -IT_0172 + -IT_0175 + -IT_0178 + (
      -0.166666666666667)*IT_0179 + IT_0180 + IT_0181 + IT_0182 + -IT_0185 +
       IT_0186;
    const ccomplex_t IT_0188 = 0.5*IT_0179;
    const ccomplex_t IT_0189 = IT_0094*IT_0159;
    const ccomplex_t IT_0190 = IT_0107*IT_0177*IT_0189;
    const ccomplex_t IT_0191 = IT_0049*IT_0133;
    const ccomplex_t IT_0192 = IT_0041*IT_0183*IT_0191;
    const ccomplex_t IT_0193 = m_c*IT_0123;
    const ccomplex_t IT_0194 = m_c*IT_0136;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_11);
    const ccomplex_t IT_0196 = IT_0000*IT_0195;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0198 = IT_0006*IT_0196*IT_0197;
    const ccomplex_t IT_0199 = IT_0022*IT_0120;
    const ccomplex_t IT_0200 = IT_0010*IT_0170*IT_0199;
    const ccomplex_t IT_0201 = IT_0072*IT_0146;
    const ccomplex_t IT_0202 = IT_0064*IT_0174*IT_0201;
    const ccomplex_t IT_0203 = m_c*IT_0149;
    const ccomplex_t IT_0204 = m_c*IT_0162;
    const ccomplex_t IT_0205 = -IT_0190 + -IT_0192 + IT_0193 + IT_0194 +
       0.166666666666667*IT_0198 + -IT_0200 + -IT_0202 + IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = (-0.5)*IT_0198;
    const ccomplex_t IT_0207 = 6*s_34;
    const ccomplex_t IT_0208 = 18*s_34;
    const ccomplex_t IT_0209 = 12*IT_0167;
    const ccomplex_t IT_0210 = (-6)*IT_0165;
    const ccomplex_t IT_0211 = m_c*m_t;
    const ccomplex_t IT_0212 = (-18)*conj(IT_0187);
    const ccomplex_t IT_0213 = (-6)*conj(IT_0188);
    const ccomplex_t IT_0214 = IT_0212 + IT_0213;
    const ccomplex_t IT_0215 = (-6)*IT_0188;
    const ccomplex_t IT_0216 = 3*conj(IT_0188);
    const ccomplex_t IT_0217 = m_t*s_13;
    const ccomplex_t IT_0218 = 0.333333333333333*IT_0206;
    const ccomplex_t IT_0219 = IT_0205 + IT_0218;
    const ccomplex_t IT_0220 = 3*IT_0219;
    const ccomplex_t IT_0221 = 0.333333333333333*conj(IT_0206);
    const ccomplex_t IT_0222 = conj(IT_0205) + IT_0221;
    const ccomplex_t IT_0223 = 3*IT_0222;
    const ccomplex_t IT_0224 = (-6)*IT_0217*(conj(IT_0009)*(IT_0205 + 3
      *IT_0206) + IT_0009*(conj(IT_0205) + 3*conj(IT_0206)) + (
      -0.166666666666667)*IT_0163*IT_0214 + 3*conj(IT_0163)*(IT_0187 + (
      -0.0555555555555556)*IT_0215) + conj(IT_0110)*IT_0220 + IT_0110*IT_0223);
    const ccomplex_t IT_0225 = m_c*s_14;
    const ccomplex_t IT_0226 = conj(IT_0009)*(IT_0187 + 3*IT_0188) + 3*conj
      (IT_0110)*(IT_0187 + 0.333333333333333*IT_0188) + 3*IT_0110*(conj(IT_0187)
       + 0.333333333333333*conj(IT_0188)) + IT_0009*(conj(IT_0187) + IT_0216) +
       conj(IT_0163)*IT_0220 + IT_0163*IT_0223;
    const ccomplex_t IT_0227 = (-6)*((conj(IT_0009) + 3*conj(IT_0110))*IT_0163
       + (IT_0009 + 3*IT_0110)*conj(IT_0163))*IT_0164 + (IT_0009*conj(IT_0009) +
       IT_0110*conj(IT_0110) + IT_0163*conj(IT_0163))*IT_0169 + (conj(IT_0187)
      *IT_0188 + IT_0187*conj(IT_0188) + conj(IT_0205)*IT_0206 + IT_0205*conj
      (IT_0206))*IT_0207 + (IT_0187*conj(IT_0187) + IT_0188*conj(IT_0188) +
       IT_0205*conj(IT_0205) + IT_0206*conj(IT_0206))*IT_0208 + (conj(IT_0009)
      *IT_0110 + IT_0009*conj(IT_0110))*(IT_0209 + IT_0210) + IT_0211*((-18)
      *IT_0188*conj(IT_0206) + IT_0187*((-18)*conj(IT_0205) + (-6)*conj(IT_0206)
      ) + IT_0205*IT_0214 + conj(IT_0205)*IT_0215 + (-6)*IT_0206*(conj(IT_0187) 
      + IT_0216)) + IT_0224 + 6*IT_0225*IT_0226;
