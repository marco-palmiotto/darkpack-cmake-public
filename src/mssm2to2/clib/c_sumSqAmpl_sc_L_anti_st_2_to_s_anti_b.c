...
ccomplex_return_t c_sumSqAmpl_sc_L_anti_st_2_to_s_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = pow(m_sc_L, 2);
    ...
    const ccomplex_t IT_0041 = m_s*IT_0016;
    const ccomplex_t IT_0042 = m_s*IT_0020;
    ...
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_cs)*e_em*IT_0001*IT_0011*IT_0048;
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = IT_0034*IT_0050;
    const ccomplex_t IT_0052 = IT_0036*IT_0046*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0001*IT_0011*IT_0048;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = IT_0022*IT_0055;
    const ccomplex_t IT_0057 = IT_0005*IT_0053*IT_0056;
    const ccomplex_t IT_0058 = m_s*IT_0028;
    const ccomplex_t IT_0059 = m_s*IT_0032;
    ...
    const ccomplex_t IT_0068 = IT_0036*IT_0046*IT_0067;
    ...
    const ccomplex_t IT_0072 = IT_0005*IT_0053*IT_0071;
    const ccomplex_t IT_0073 = IT_0050*IT_0066;
    ...
    const ccomplex_t IT_0077 = IT_0055*IT_0070;
    ...
    const ccomplex_t IT_0084 = m_b*m_s*IT_0004;
    ...
    const ccomplex_t IT_0091 = m_b*m_s;
    const ccomplex_t IT_0092 = (-18)*conj(IT_0063);
    const ccomplex_t IT_0093 = (-18)*IT_0063;
    const ccomplex_t IT_0094 = (-18)*IT_0040;
    const ccomplex_t IT_0095 = conj(IT_0040)*(18*IT_0063*IT_0064 + (-18)
      *IT_0081*IT_0082 + (-18)*IT_0083*IT_0084 + IT_0040*IT_0089) + conj(IT_0063
      )*(18*IT_0040*IT_0064 + IT_0063*IT_0090) + (IT_0082*IT_0083 + IT_0081
      *IT_0091)*IT_0092 + conj(IT_0081)*(18*IT_0064*IT_0083 + IT_0081*IT_0090 +
       IT_0091*IT_0093 + IT_0082*IT_0094) + conj(IT_0083)*(18*IT_0064*IT_0081 +
       IT_0083*IT_0089 + IT_0082*IT_0093 + IT_0084*IT_0094);
