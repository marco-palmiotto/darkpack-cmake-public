        ...
        )
{
    ...
    const ccomplex_t IT_0003 = cpow((-2)*s_13 + IT_0001 + IT_0002 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0004 = sin(theta_W);
    const ccomplex_t IT_0005 = cpow(IT_0004, -1);
    const ccomplex_t IT_0006 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp2)
      *IT_0005;
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_13 + IT_0001 + IT_0002 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp1)
      *IT_0005;
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0005*IT_0007*IT_0009*conj(U_st_01);
    ...
    const ccomplex_t IT_0026 = m_s*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_cs)*e_em*IT_0005*IT_0007*IT_0009;
    ...
    const ccomplex_t IT_0053 = IT_0000*IT_0003*IT_0052;
    const ccomplex_t IT_0054 = IT_0015*IT_0016;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = m_t*V_tb*V_u1*e_em*IT_0007*conj(U_st_11);
    ...
    const ccomplex_t IT_0062 = V_tb*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0070 = IT_0003*IT_0006;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = m_s*IT_0045;
    const ccomplex_t IT_0073 = m_s*IT_0049;
    const ccomplex_t IT_0074 = -IT_0073;
    const ccomplex_t IT_0075 = IT_0072 + IT_0074;
    const ccomplex_t IT_0076 = IT_0071*IT_0075;
    const ccomplex_t IT_0077 = -IT_0065;
    const ccomplex_t IT_0078 = IT_0060 + IT_0077;
    const ccomplex_t IT_0079 = IT_0028*IT_0078;
    const ccomplex_t IT_0080 = IT_0014*IT_0015*IT_0079;
    const ccomplex_t IT_0081 = -IT_0053 + IT_0069 + IT_0076 + -IT_0080;
    const ccomplex_t IT_0082 = (-18)*conj(IT_0081);
    const ccomplex_t IT_0083 = m_b*s_13;
    const ccomplex_t IT_0084 = IT_0055*IT_0078;
    const ccomplex_t IT_0085 = IT_0051*IT_0071;
    const ccomplex_t IT_0086 = -IT_0084 + -IT_0085;
    const ccomplex_t IT_0087 = (-18)*conj(IT_0086);
    const ccomplex_t IT_0088 = s_34*IT_0002;
    ...
    const ccomplex_t IT_0093 = m_b*m_s*IT_0002;
    const ccomplex_t IT_0094 = (-18)*conj(IT_0034);
    const ccomplex_t IT_0095 = IT_0033*(18*conj(IT_0034)*IT_0035 + conj
      (IT_0033)*IT_0036 + IT_0037*IT_0082 + IT_0083*IT_0087) + IT_0034*(18*conj
      (IT_0033)*IT_0035 + IT_0082*IT_0083 + conj(IT_0034)*IT_0092 + IT_0087
      *IT_0093) + IT_0081*((-18)*conj(IT_0033)*IT_0037 + IT_0036*conj(IT_0081) +
       18*IT_0035*conj(IT_0086) + IT_0083*IT_0094) + IT_0086*(18*IT_0035*conj
      (IT_0081) + (-18)*conj(IT_0033)*IT_0083 + conj(IT_0086)*IT_0092 + IT_0093
      *IT_0094);
