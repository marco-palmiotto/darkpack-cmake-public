        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp2)
      *IT_0007;
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp1)
      *IT_0007;
    ...
    const ccomplex_t IT_0059 = m_s*IT_0020;
    const ccomplex_t IT_0060 = m_s*IT_0033;
    ...
    const ccomplex_t IT_0064 = -IT_0058 + IT_0059 + IT_0060 + -IT_0063;
    const ccomplex_t IT_0065 = IT_0023*IT_0039;
    const ccomplex_t IT_0066 = IT_0021*IT_0061*IT_0065;
    const ccomplex_t IT_0067 = m_s*IT_0042;
    const ccomplex_t IT_0068 = IT_0009*IT_0045;
    const ccomplex_t IT_0069 = IT_0002*IT_0056*IT_0068;
    const ccomplex_t IT_0070 = m_s*IT_0048;
    const ccomplex_t IT_0071 = IT_0067 + -IT_0069 + IT_0070;
    const ccomplex_t IT_0072 = (-18)*IT_0071;
    const ccomplex_t IT_0073 = 18*IT_0066 + IT_0072;
    const ccomplex_t IT_0074 = (-18)*conj(IT_0071);
    const ccomplex_t IT_0075 = 18*conj(IT_0066);
    const ccomplex_t IT_0076 = IT_0074 + IT_0075;
    const ccomplex_t IT_0077 = m_s*s_14;
    const ccomplex_t IT_0078 = 18*s_34;
    const ccomplex_t IT_0079 = (-18)*s_34;
    const ccomplex_t IT_0080 = m_s*m_t*IT_0001;
    const ccomplex_t IT_0081 = (-18)*IT_0034;
    const ccomplex_t IT_0082 = (-18)*conj(IT_0034);
    const ccomplex_t IT_0083 = m_t*s_13;
    const ccomplex_t IT_0084 = (IT_0034*conj(IT_0034) + IT_0049*conj(IT_0049))
      *IT_0054 + IT_0055*(conj(IT_0064)*IT_0073 + IT_0064*IT_0076) + ((-18)*conj
      (IT_0034)*IT_0064 + (-18)*IT_0034*conj(IT_0064) + conj(IT_0049)*IT_0073 +
      ...
      (IT_0071))*IT_0079 + IT_0080*(conj(IT_0049)*IT_0081 + IT_0049*IT_0082) + 
      (18*conj(IT_0049)*IT_0064 + 18*IT_0049*conj(IT_0064) + 18*conj(IT_0034)
      *IT_0071 + 18*IT_0034*conj(IT_0071) + conj(IT_0066)*IT_0081 + IT_0066
      *IT_0082)*IT_0083;
