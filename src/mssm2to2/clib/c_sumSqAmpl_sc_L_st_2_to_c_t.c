        ...
        )
{
    ...
    const ccomplex_t IT_0008 = IT_0003*IT_0006*IT_0007;
    ...
    const ccomplex_t IT_0017 = conj(N_B4)*e_em;
    ...
    const ccomplex_t IT_0022 = conj(N_W4)*e_em;
    const ccomplex_t IT_0023 = IT_0021*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*(IT_0019 + 3*IT_0024);
    const ccomplex_t IT_0026 = 0.166666666666667*IT_0025;
    const ccomplex_t IT_0027 = N_B4*e_em*U_st_11;
    ...
    const ccomplex_t IT_0034 = m_t*N_u4*e_em*IT_0033*U_st_01;
    const ccomplex_t IT_0035 = IT_0032*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*(IT_0029 + (-0.75)*IT_0036);
    const ccomplex_t IT_0038 = 0.666666666666667*IT_0037;
    const ccomplex_t IT_0039 = IT_0026*IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_4*
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0046 = conj(N_B1)*e_em;
    const ccomplex_t IT_0047 = IT_0016*IT_0046;
    const ccomplex_t IT_0048 = 1.4142135623731*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0054 = conj(N_B1)*e_em*U_st_01;
    const ccomplex_t IT_0055 = IT_0016*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = conj(N_W1)*e_em*U_st_01;
    const ccomplex_t IT_0058 = IT_0021*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_t*conj(N_u1)*e_em*IT_0033*U_st_11;
    ...
    const ccomplex_t IT_0066 = IT_0044*IT_0045*IT_0065;
    ...
    const ccomplex_t IT_0089 = IT_0067*IT_0068*IT_0088;
    const ccomplex_t IT_0090 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0091 = IT_0016*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = m_t*N_u3*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0103 = conj(N_B4)*e_em*U_st_01;
    const ccomplex_t IT_0104 = IT_0016*IT_0103;
    const ccomplex_t IT_0105 = 1.4142135623731*IT_0104;
    const ccomplex_t IT_0106 = conj(N_W4)*e_em*U_st_01;
    const ccomplex_t IT_0107 = IT_0021*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = m_t*conj(N_u4)*e_em*IT_0033*U_st_11;
    const ccomplex_t IT_0110 = IT_0032*IT_0109;
    ...
    const ccomplex_t IT_0115 = IT_0040*IT_0102*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0117 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0138 = IT_0116*IT_0117*IT_0137;
    const ccomplex_t IT_0139 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0140 = IT_0016*IT_0139;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = m_t*N_u1*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0151 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0152 = IT_0016*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = m_t*N_u2*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0163 = (-0.166666666666667)*IT_0008 +
       0.166666666666667*IT_0013 + -IT_0043 + IT_0066 + IT_0089 + -IT_0101 +
       IT_0115 + IT_0138 + -IT_0150 + -IT_0162;
    const ccomplex_t IT_0164 = (-0.5)*IT_0012;
    const ccomplex_t IT_0165 = 0.166666666666667*IT_0012 + -IT_0042 + -IT_0100
       + -IT_0149 + -IT_0161;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0021*IT_0031*IT_0033;
    const ccomplex_t IT_0167 = (-0.5)*IT_0166;
    const ccomplex_t IT_0168 = IT_0087*IT_0167;
    const ccomplex_t IT_0169 = IT_0068*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0021*IT_0031*IT_0033;
    const ccomplex_t IT_0172 = (-0.5)*IT_0171;
    const ccomplex_t IT_0173 = IT_0113*IT_0172;
    const ccomplex_t IT_0174 = IT_0040*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
      *IT_0021*IT_0031*IT_0033;
    const ccomplex_t IT_0177 = (-0.5)*IT_0176;
    const ccomplex_t IT_0178 = IT_0064*IT_0177;
    const ccomplex_t IT_0179 = IT_0045*IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0021*IT_0031*IT_0033;
    const ccomplex_t IT_0182 = (-0.5)*IT_0181;
    const ccomplex_t IT_0183 = IT_0136*IT_0182;
    const ccomplex_t IT_0184 = IT_0117*IT_0183;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*IT_0184;
    const ccomplex_t IT_0186 = -IT_0170 + -IT_0175 + -IT_0180 + -IT_0185;
    const ccomplex_t IT_0187 = pow(m_st_2, 2);
    const ccomplex_t IT_0188 = s_34*IT_0187;
    const ccomplex_t IT_0189 = (-18)*IT_0188;
    const ccomplex_t IT_0190 = s_23*s_24;
    const ccomplex_t IT_0191 = 36*IT_0190;
    const ccomplex_t IT_0192 = IT_0189 + IT_0191;
    const ccomplex_t IT_0193 = m_c*s_24;
    const ccomplex_t IT_0194 = IT_0038*IT_0172;
    const ccomplex_t IT_0195 = IT_0040*IT_0102*IT_0194;
    const ccomplex_t IT_0196 = m_t*IT_0185;
    const ccomplex_t IT_0197 = m_t*IT_0170;
    const ccomplex_t IT_0198 = m_t*IT_0175;
    const ccomplex_t IT_0199 = IT_0146*IT_0177;
    const ccomplex_t IT_0200 = IT_0044*IT_0045*IT_0199;
    const ccomplex_t IT_0201 = IT_0158*IT_0182;
    const ccomplex_t IT_0202 = IT_0116*IT_0117*IT_0201;
    const ccomplex_t IT_0203 = IT_0097*IT_0167;
    const ccomplex_t IT_0204 = IT_0067*IT_0068*IT_0203;
    const ccomplex_t IT_0205 = m_t*IT_0180;
    const ccomplex_t IT_0206 = IT_0195 + -IT_0196 + -IT_0197 + -IT_0198 +
       IT_0200 + IT_0202 + IT_0204 + -IT_0205;
    const ccomplex_t IT_0207 = 3*IT_0165;
    const ccomplex_t IT_0208 = IT_0164 + IT_0207;
    const ccomplex_t IT_0209 = 3*conj(IT_0165);
    const ccomplex_t IT_0210 = conj(IT_0164) + IT_0209;
    const ccomplex_t IT_0211 = m_c*m_t*IT_0187;
    const ccomplex_t IT_0212 = 18*s_34;
    const ccomplex_t IT_0213 = m_c*m_t;
    const ccomplex_t IT_0214 = (-18)*IT_0206;
    const ccomplex_t IT_0215 = (-18)*conj(IT_0206);
    const ccomplex_t IT_0216 = m_t*s_23;
    const ccomplex_t IT_0217 = (conj(IT_0014)*((-18)*IT_0164 + (-6)*IT_0165) +
       IT_0014*((-18)*conj(IT_0164) + (-6)*conj(IT_0165)) + (-6)*conj(IT_0163)
      *IT_0208 + (-6)*IT_0163*IT_0210 + conj(IT_0186)*IT_0214 + IT_0186*IT_0215)
      *IT_0216;
    const ccomplex_t IT_0218 = 12*IT_0190;
    const ccomplex_t IT_0219 = (-6)*IT_0188;
    const ccomplex_t IT_0220 = 6*s_34*(conj(IT_0014)*IT_0163 + IT_0014*conj
      (IT_0163)) + (IT_0164*conj(IT_0164) + IT_0165*conj(IT_0165) + IT_0186*conj
      (IT_0186))*IT_0192 + 6*IT_0193*((conj(IT_0014) + 3*conj(IT_0163))*IT_0186 
      + (IT_0014 + 3*IT_0163)*conj(IT_0186) + conj(IT_0206)*IT_0208 + IT_0206
      *IT_0210) + (-6)*(conj(IT_0186)*IT_0208 + IT_0186*IT_0210)*IT_0211 + 
      (IT_0014*conj(IT_0014) + IT_0163*conj(IT_0163) + IT_0206*conj(IT_0206))
      *IT_0212 + (-6)*IT_0213*(conj(IT_0014)*IT_0206 + IT_0014*conj(IT_0206) + (
      -0.166666666666667)*conj(IT_0163)*IT_0214 + (-0.166666666666667)*IT_0163
      *IT_0215) + IT_0217 + (conj(IT_0164)*IT_0165 + IT_0164*conj(IT_0165))*
      (IT_0218 + IT_0219);
