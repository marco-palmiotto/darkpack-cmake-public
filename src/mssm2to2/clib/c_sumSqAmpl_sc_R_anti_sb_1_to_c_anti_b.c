        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B1*e_em*conj(U_sb_00);
    const ccomplex_t IT_0013 = IT_0011*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = N_W1*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0021 = m_b*N_d1*e_em*IT_0003*conj(U_sb_10);
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0049 = 0.5*IT_0048;
    const ccomplex_t IT_0050 = N_B3*e_em*conj(U_sb_00);
    const ccomplex_t IT_0051 = IT_0011*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = N_W3*e_em*conj(U_sb_00);
    const ccomplex_t IT_0054 = IT_0007*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = m_b*N_d3*e_em*IT_0003*conj(U_sb_10);
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = N_B4*e_em*conj(U_sb_00);
    const ccomplex_t IT_0068 = IT_0011*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = N_W4*e_em*conj(U_sb_00);
    const ccomplex_t IT_0071 = IT_0007*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = m_b*N_d4*e_em*IT_0003*conj(U_sb_10);
    ...
    const ccomplex_t IT_0092 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0093 = IT_0011*IT_0092;
    const ccomplex_t IT_0094 = 1.4142135623731*IT_0093;
    const ccomplex_t IT_0095 = m_b*conj(N_d2)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0105 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0106 = IT_0011*IT_0105;
    const ccomplex_t IT_0107 = 1.4142135623731*IT_0106;
    const ccomplex_t IT_0108 = m_b*conj(N_d3)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0118 = conj(N_B1)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0119 = IT_0011*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = m_b*conj(N_d1)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0131 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0132 = IT_0011*IT_0131;
    const ccomplex_t IT_0133 = 1.4142135623731*IT_0132;
    const ccomplex_t IT_0134 = m_b*conj(N_d4)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_00);
    const ccomplex_t IT_0149 = IT_0084*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0151 = IT_0083*IT_0149*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0003*IT_0007;
    const ccomplex_t IT_0153 = 0.5*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *mu_h*IT_0003*IT_0005*IT_0007*IT_0018*conj(U_sb_00);
    const ccomplex_t IT_0155 = (-0.5)*IT_0154;
    const ccomplex_t IT_0156 = IT_0153*IT_0155;
    const ccomplex_t IT_0157 = pow(m_W, 2);
    const ccomplex_t IT_0158 = pow(m_sb_1, 2);
    const ccomplex_t IT_0159 = cpow((-2)*s_12 + -IT_0001 + IT_0157 + -IT_0158 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
      *IT_0003*IT_0007*(mu_h*conj(U_sb_00) + m_b*IT_0005*IT_0019*conj(U_sb_10));
    const ccomplex_t IT_0165 = 0.5*IT_0164;
    const ccomplex_t IT_0166 = IT_0163*IT_0165;
    const ccomplex_t IT_0167 = cpow((-2)*s_12 + -IT_0001 + -IT_0158 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0168 = IT_0166*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*IT_0168;
    const ccomplex_t IT_0170 = (-0.5)*IT_0151 + -IT_0161 + -IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0172 = IT_0025*IT_0117;
    const ccomplex_t IT_0173 = IT_0002*IT_0171*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0175 = IT_0043*IT_0091;
    const ccomplex_t IT_0176 = IT_0029*IT_0174*IT_0175;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0178 = IT_0060*IT_0104;
    const ccomplex_t IT_0179 = IT_0047*IT_0177*IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0181 = IT_0077*IT_0130;
    const ccomplex_t IT_0182 = IT_0064*IT_0180*IT_0181;
    const ccomplex_t IT_0183 = m_c*IT_0028;
    const ccomplex_t IT_0184 = m_c*IT_0046;
    const ccomplex_t IT_0185 = m_c*IT_0063;
    const ccomplex_t IT_0186 = m_c*IT_0080;
    const ccomplex_t IT_0187 = 0.166666666666667*IT_0151 + -IT_0173 + -IT_0176
       + -IT_0179 + -IT_0182 + IT_0183 + IT_0184 + IT_0185 + IT_0186;
    const ccomplex_t IT_0188 = m_c*IT_0088;
    ...
    const ccomplex_t IT_0197 = IT_0167*IT_0196;
    const ccomplex_t IT_0198 = (0 + _Complex_I*1)*IT_0197;
    const ccomplex_t IT_0199 = 0.5*IT_0188 + -IT_0193 + -IT_0198;
    const ccomplex_t IT_0200 = IT_0049*IT_0112;
    const ccomplex_t IT_0201 = IT_0047*IT_0177*IT_0200;
    const ccomplex_t IT_0202 = IT_0066*IT_0138;
    const ccomplex_t IT_0203 = IT_0064*IT_0180*IT_0202;
    const ccomplex_t IT_0204 = IT_0009*IT_0125;
    const ccomplex_t IT_0205 = IT_0002*IT_0171*IT_0204;
    const ccomplex_t IT_0206 = IT_0031*IT_0099;
    const ccomplex_t IT_0207 = IT_0029*IT_0174*IT_0206;
    const ccomplex_t IT_0208 = m_c*IT_0128;
    const ccomplex_t IT_0209 = m_c*IT_0102;
    const ccomplex_t IT_0210 = m_c*IT_0115;
    const ccomplex_t IT_0211 = m_c*IT_0141;
    const ccomplex_t IT_0212 = (-0.166666666666667)*IT_0188 + -IT_0201 + 
      -IT_0203 + -IT_0205 + -IT_0207 + IT_0208 + IT_0209 + IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = 6*s_34;
    const ccomplex_t IT_0214 = 18*s_34;
    const ccomplex_t IT_0215 = m_b*m_c;
    ...
    const ccomplex_t IT_0224 = m_b*s_13;
    const ccomplex_t IT_0225 = 0.333333333333333*conj(IT_0142);
    const ccomplex_t IT_0226 = conj(IT_0089) + IT_0225;
    const ccomplex_t IT_0227 = conj(IT_0081)*(IT_0199 + 3*IT_0212) + IT_0081*
      (conj(IT_0199) + 3*conj(IT_0212)) + (-0.166666666666667)*IT_0089*IT_0218 +
       (-0.166666666666667)*IT_0142*IT_0221 + (-0.166666666666667)*conj(IT_0142)
      *IT_0222 + (-0.166666666666667)*conj(IT_0089)*IT_0223 + 3*IT_0170*IT_0226;
    const ccomplex_t IT_0228 = 12*IT_0145;
    const ccomplex_t IT_0229 = (-6)*IT_0143;
    const ccomplex_t IT_0230 = m_c*s_14;
    const ccomplex_t IT_0231 = 3*IT_0142;
    const ccomplex_t IT_0232 = 3*conj(IT_0142);
    const ccomplex_t IT_0233 = conj(IT_0081)*(IT_0170 + 3*IT_0187) + IT_0081*
      (conj(IT_0170) + 3*conj(IT_0187)) + 3*(IT_0089 + 0.333333333333333*IT_0142
      )*conj(IT_0199) + 3*IT_0199*IT_0226 + conj(IT_0212)*(IT_0089 + IT_0231) +
       IT_0212*(conj(IT_0089) + IT_0232);
    const ccomplex_t IT_0234 = m_b*m_c*IT_0001;
    const ccomplex_t IT_0235 = (IT_0081*conj(IT_0081) + IT_0089*conj(IT_0089) 
      + IT_0142*conj(IT_0142))*IT_0147 + (conj(IT_0170)*IT_0187 + IT_0170*conj
      (IT_0187) + conj(IT_0199)*IT_0212 + IT_0199*conj(IT_0212))*IT_0213 + 
      (IT_0170*conj(IT_0170) + IT_0187*conj(IT_0187) + IT_0199*conj(IT_0199) +
       IT_0212*conj(IT_0212))*IT_0214 + IT_0215*(IT_0170*((-18)*conj(IT_0199) + 
      (-6)*conj(IT_0212)) + IT_0199*IT_0218 + IT_0212*IT_0221 + conj(IT_0212)
      *IT_0222 + conj(IT_0199)*IT_0223) + (-6)*IT_0224*IT_0227 + (conj(IT_0089)
      *IT_0142 + IT_0089*conj(IT_0142))*(IT_0228 + IT_0229) + 6*IT_0230*IT_0233 
      + (-6)*(conj(IT_0081)*(IT_0089 + IT_0231) + IT_0081*(conj(IT_0089) +
       IT_0232))*IT_0234;
