...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_sc_R_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sc_R
      *Gamma_cr + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0040 = (-0.5)*IT_0017 + (-0.5)*IT_0031;
    const ccomplex_t IT_0041 = IT_0012 + IT_0040;
    const ccomplex_t IT_0042 = IT_0014*IT_0041;
    const ccomplex_t IT_0043 = IT_0019*IT_0034;
    const ccomplex_t IT_0044 = IT_0042 + 0.5*IT_0043;
    const ccomplex_t IT_0045 = (-0.5)*IT_0020;
    const ccomplex_t IT_0046 = conj(IT_0044) + conj(IT_0045);
    ...
    const ccomplex_t IT_0064 = pow(m_sc_R, 4);
    ...
    const ccomplex_t IT_0070 = (-0.333333333333333)*conj(IT_0044);
    const ccomplex_t IT_0071 = (-0.333333333333333)*conj(IT_0030);
    const ccomplex_t IT_0072 = (-0.333333333333333)*conj(IT_0045);
    const ccomplex_t IT_0073 = (-0.333333333333333)*conj(IT_0050)*IT_0051;
    const ccomplex_t IT_0074 = (-0.333333333333333)*conj(IT_0036);
    const ccomplex_t IT_0075 = conj(IT_0024)*IT_0063 + (-3)*IT_0067 + (-3)
      *IT_0065*IT_0068 + (-3)*IT_0069 + (-3)*IT_0058*IT_0070 + (-3)*IT_0059
      *IT_0071 + (-3)*IT_0057*IT_0072 + (-3)*IT_0073 + (-3)*IT_0056*IT_0074;
    const ccomplex_t IT_0076 = conj(IT_0024)*IT_0065 + (-3)*IT_0067 + (-3)
      *IT_0063*IT_0068 + (-3)*IT_0069 + (-3)*IT_0057*IT_0070 + (-3)*IT_0056
      *IT_0071 + (-3)*IT_0058*IT_0072 + (-3)*IT_0073 + (-3)*IT_0059*IT_0074;
    ...
    const ccomplex_t IT_0080 = IT_0007*((-12)*IT_0007 + 3*IT_0008*IT_0022) +
      ...
      *IT_0051 + conj(IT_0016)*IT_0053 + conj(IT_0021)*IT_0055) + IT_0036*(conj
      (IT_0045)*IT_0051 + conj(IT_0030)*IT_0053 + conj(IT_0026)*IT_0056 + conj
      (IT_0021)*IT_0057 + conj(IT_0016)*IT_0058 + conj(IT_0024)*IT_0059 +
       IT_0060) + IT_0030*(conj(IT_0044)*IT_0051 + conj(IT_0036)*IT_0053 + conj
      ...
      *IT_0076 + IT_0045*(conj(IT_0036)*IT_0051 + conj(IT_0044)*IT_0055 + conj
      (IT_0026)*IT_0057 + conj(IT_0024)*IT_0058 + IT_0077 + IT_0078 + IT_0079) +
       IT_0044*(conj(IT_0030)*IT_0051 + conj(IT_0045)*IT_0055 + conj(IT_0024)
