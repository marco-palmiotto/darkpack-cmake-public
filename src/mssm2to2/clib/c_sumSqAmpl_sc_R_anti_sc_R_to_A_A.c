        ...
        )
{
    ...
    const ccomplex_t IT_0000 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sc_R
    ...
    const ccomplex_t IT_0010 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sc_R
      *Gamma_cr + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0063 = conj(IT_0013)*(IT_0016*IT_0018 + IT_0020
      ...
      *IT_0035 + IT_0020*IT_0039 + IT_0023*IT_0051) + conj(IT_0020)*(IT_0013
      *IT_0022 + IT_0026*IT_0028 + IT_0016*IT_0027*IT_0037 + IT_0039*IT_0048 +
       IT_0052*IT_0053 + IT_0035*IT_0055 + IT_0020*IT_0057) + conj(IT_0016)*
      (IT_0013*IT_0018 + s_23*IT_0017*IT_0035 + IT_0027*(s_23*IT_0023 + IT_0020
      *IT_0037) + IT_0026*IT_0039 + IT_0028*IT_0048 + IT_0016*IT_0057 + IT_0034
      *IT_0058) + IT_0052*IT_0059 + conj(IT_0035)*(IT_0026*IT_0036 + IT_0024
      *IT_0048 + IT_0020*IT_0055 + IT_0017*IT_0060) + conj(IT_0034)*(IT_0018
      *IT_0026 + IT_0022*IT_0048 + IT_0023*IT_0055 + IT_0016*IT_0058 + IT_0061 +
       IT_0062) + conj(IT_0023)*(IT_0013*IT_0024 + IT_0026*IT_0029 + IT_0048
      *IT_0051 + IT_0034*IT_0055 + IT_0027*IT_0060 + IT_0061 + IT_0062);
