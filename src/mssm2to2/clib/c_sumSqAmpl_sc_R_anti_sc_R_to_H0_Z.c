...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_sc_R_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = pow(m_sc_R, 2);
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*(IT_0005
      *IT_0006 + -IT_0009*IT_0010)*IT_0015 + 1.5*IT_0010*IT_0016*IT_0035*IT_0036
      *IT_0037);
