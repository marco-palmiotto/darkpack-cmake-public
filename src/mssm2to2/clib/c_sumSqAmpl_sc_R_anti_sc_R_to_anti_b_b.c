        ...
        )
{
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u1
      *e_em*IT_0000*IT_0005*IT_0013;
    const ccomplex_t IT_0057 = 0.5*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*conj
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*V_u2
      *e_em*IT_0000*IT_0005*IT_0013;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*conj
      (V_u2)*e_em*IT_0000*IT_0005*IT_0013;
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = IT_0065*IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0017 + IT_0030 + -m_C_2*
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0084 = (-0.333333333333333)*IT_0083;
    const ccomplex_t IT_0085 = (-1.33333333333333)*IT_0083;
    ...
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*g_s;
    const ccomplex_t IT_0091 = (-2)*IT_0090;
    const ccomplex_t IT_0092 = IT_0087*IT_0090;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*IT_0092;
    const ccomplex_t IT_0094 = IT_0091*IT_0093;
    const ccomplex_t IT_0095 = 0.5*IT_0089 + (-0.0833333333333333)*IT_0094;
    const ccomplex_t IT_0096 = cpow(IT_0095, 2);
    const ccomplex_t IT_0097 = (-36)*IT_0073;
    const ccomplex_t IT_0098 = IT_0017*IT_0030;
    const ccomplex_t IT_0099 = (-36)*IT_0098;
    const ccomplex_t IT_0100 = 72*IT_0075;
    const ccomplex_t IT_0101 = IT_0097 + IT_0099 + IT_0100;
    const ccomplex_t IT_0102 = 0.25*IT_0094;
    const ccomplex_t IT_0103 = (-18)*IT_0050;
    const ccomplex_t IT_0104 = m_b*IT_0072;
    ...
    const ccomplex_t IT_0117 = m_b*s_14;
    const ccomplex_t IT_0118 = m_b*s_13;
    const ccomplex_t IT_0119 = 6*conj(IT_0050);
    const ccomplex_t IT_0120 = 18*conj(IT_0105);
    const ccomplex_t IT_0121 = 6*conj(IT_0105);
    const ccomplex_t IT_0122 = 18*conj(IT_0050);
    const ccomplex_t IT_0123 = 3*IT_0050*(conj(IT_0055) + 0.333333333333333
      *conj(IT_0072)) + 3*conj(IT_0049)*IT_0079 + 3*IT_0049*conj(IT_0079) + 
      (conj(IT_0055) + 3*conj(IT_0072))*IT_0105 + 0.166666666666667*IT_0072*
      (IT_0119 + IT_0120) + 0.166666666666667*IT_0055*(IT_0121 + IT_0122);
    const ccomplex_t IT_0124 = -s_14;
    const ccomplex_t IT_0125 = s_13 + IT_0124;
    const ccomplex_t IT_0126 = m_b*IT_0125;
    const ccomplex_t IT_0127 = 6*IT_0029;
    const ccomplex_t IT_0128 = 6*conj(IT_0029);
    const ccomplex_t IT_0129 = conj(IT_0055) + conj(IT_0079);
    const ccomplex_t IT_0130 = 18*IT_0029;
    const ccomplex_t IT_0131 = IT_0055 + IT_0079;
    const ccomplex_t IT_0132 = 18*conj(IT_0029);
    const ccomplex_t IT_0133 = IT_0102*((-12)*IT_0029 + 12*conj(IT_0029) + (-6
      )*IT_0049 + 6*conj(IT_0049) + (-6)*IT_0050 + (-18)*IT_0105 + IT_0119 +
       IT_0120) + IT_0095*((-36)*IT_0029 + 36*conj(IT_0029) + (-18)*IT_0049 + 18
      *conj(IT_0049) + IT_0103 + IT_0106 + IT_0121 + IT_0122) + conj(IT_0072)
      *IT_0127 + IT_0072*IT_0128 + IT_0129*IT_0130 + IT_0131*IT_0132;
    const ccomplex_t IT_0134 = (-6)*IT_0098;
    const ccomplex_t IT_0135 = IT_0074 + IT_0076 + IT_0134;
    const ccomplex_t IT_0136 = -IT_0102;
    const ccomplex_t IT_0137 = -IT_0095;
    const ccomplex_t IT_0138 = (-18)*IT_0098;
    const ccomplex_t IT_0139 = IT_0080 + IT_0081 + IT_0138;
    const ccomplex_t IT_0140 = -IT_0030;
    const ccomplex_t IT_0141 = IT_0029*conj(IT_0029)*(36*s_34 + (-36)*IT_0030)
       + (IT_0049*conj(IT_0049) + IT_0050*conj(IT_0050))*IT_0052 + (conj(IT_0029
      )*(IT_0049 + IT_0050) + IT_0029*(conj(IT_0049) + conj(IT_0050)))*IT_0053 +
       (conj(IT_0055)*IT_0072 + IT_0055*conj(IT_0072))*IT_0077 + (IT_0055*conj
      (IT_0055) + IT_0072*conj(IT_0072) + IT_0079*conj(IT_0079))*IT_0082 + 
      -IT_0096*IT_0101 + (-2)*IT_0102*(IT_0095*((-12)*IT_0073 + 24*IT_0075 + (
      -12)*IT_0098) + 0.5*IT_0101*IT_0102) + IT_0030*(conj(IT_0049)*IT_0107 +
       IT_0049*IT_0110) + IT_0098*(conj(IT_0079)*IT_0113 + IT_0079*IT_0116) + 
      (conj(IT_0079)*IT_0107 + IT_0079*IT_0110 + conj(IT_0049)*IT_0113 + IT_0049
      *IT_0116)*IT_0117 + 6*IT_0118*IT_0123 + IT_0126*IT_0133 + IT_0135*(conj
      (IT_0072)*IT_0095 + IT_0102*IT_0129 + IT_0131*IT_0136 + IT_0072*IT_0137) +
       (conj(IT_0072)*IT_0102 + IT_0095*IT_0129 + IT_0072*IT_0136 + IT_0131
      *IT_0137)*IT_0139 + 6*conj(IT_0105)*(s_34*IT_0050 + 0.166666666666667
      *IT_0052*IT_0105 + 0.166666666666667*IT_0127*(s_34 + IT_0140)) + 6*IT_0105
      *(s_34*conj(IT_0050) + 0.166666666666667*IT_0128*(s_34 + IT_0140));
