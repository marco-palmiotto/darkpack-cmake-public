...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_sc_R_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0039 = IT_0004*IT_0031;
    const ccomplex_t IT_0040 = e_em*IT_0039;
    const ccomplex_t IT_0041 = IT_0005*IT_0008;
    const ccomplex_t IT_0042 = e_em*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*(IT_0040 + -IT_0042);
    ...
    const ccomplex_t IT_0055 = -(IT_0036 + -IT_0046)*(IT_0053 + -IT_0054);
    ...
    const ccomplex_t IT_0068 = IT_0017*IT_0030;
    ...
    const ccomplex_t IT_0086 = IT_0029*(conj(IT_0029)*(12*s_34 + (-12)*IT_0030
      ) + 6*(conj(IT_0038) + conj(IT_0048))*IT_0051 + 6*(conj(IT_0055) + conj
      (IT_0056))*IT_0058) + -IT_0066*IT_0075 + conj(IT_0038)*(IT_0074*IT_0076 +
       IT_0068*IT_0077) + conj(IT_0055)*(IT_0030*IT_0074 + IT_0076*IT_0077) + 6
      *IT_0048*(conj(IT_0056)*IT_0078 + 0.166666666666667*conj(IT_0048)*IT_0079 
      + IT_0080) + 6*IT_0038*(conj(IT_0055)*IT_0078 + 0.166666666666667*conj
      (IT_0038)*IT_0079 + IT_0080 + 0.166666666666667*IT_0068*IT_0081 + IT_0082
      *IT_0083) + 6*IT_0055*(conj(IT_0038)*IT_0078 + 0.166666666666667*IT_0030
      *IT_0082 + IT_0081*IT_0083 + 0.166666666666667*conj(IT_0055)*IT_0084 +
       IT_0085) + 6*IT_0056*(conj(IT_0048)*IT_0078 + 0.166666666666667*conj
