        ...
        )
{
    ...
    const ccomplex_t IT_0060 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0080 = IT_0016*IT_0029;
    ...
    const ccomplex_t IT_0091 = 18*conj(IT_0050);
    ...
    const ccomplex_t IT_0096 = IT_0058 + IT_0086;
    const ccomplex_t IT_0097 = 18*conj(IT_0028);
    const ccomplex_t IT_0098 = (-18)*IT_0050;
    const ccomplex_t IT_0099 = ((-12)*IT_0028 + 12*conj(IT_0028) + (-6)
      *IT_0050 + 6*conj(IT_0050) + (-6)*IT_0053 + 6*conj(IT_0053))*IT_0084 + 
      (conj(IT_0058) + conj(IT_0086))*IT_0095 + IT_0096*IT_0097 + IT_0077*((-36)
      *IT_0028 + 36*conj(IT_0028) + (-18)*IT_0053 + 18*conj(IT_0053) + IT_0091 +
       IT_0098);
    const ccomplex_t IT_0100 = (-18)*IT_0080;
    const ccomplex_t IT_0101 = IT_0061 + IT_0063 + IT_0100;
    const ccomplex_t IT_0102 = (-18)*IT_0058;
    const ccomplex_t IT_0103 = m_t*s_14;
    ...
    const ccomplex_t IT_0108 = conj(IT_0028)*(IT_0028*(36*s_34 + (-36)*IT_0029
      ...
      *IT_0060 + 24*IT_0062 + (-12)*IT_0080) + 0.5*IT_0083*IT_0084 + 0.5*
      (IT_0058 + -conj(IT_0058) + IT_0086 + -conj(IT_0086))*IT_0090) + IT_0058
      *IT_0059*IT_0091 + IT_0094*IT_0099 + conj(IT_0086)*(18*IT_0053*IT_0059 +
       IT_0064*IT_0086 + IT_0077*IT_0101 + IT_0080*IT_0102 + IT_0098*IT_0103) +
       IT_0053*(IT_0103*IT_0104 + IT_0029*IT_0105) + IT_0086*(IT_0080*IT_0104 +
       IT_0103*IT_0105) + IT_0101*(conj(IT_0058)*IT_0077 + IT_0096*IT_0106) +
       conj(IT_0050)*(IT_0050*IT_0055 + IT_0107) + conj(IT_0053)*(IT_0053
      *IT_0055 + 18*IT_0059*IT_0086 + IT_0029*IT_0098 + IT_0102*IT_0103 +
       IT_0107);
