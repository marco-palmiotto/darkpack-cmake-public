        ...
        )
{
    ...
    const ccomplex_t IT_0076 = IT_0066*(24*IT_0067 + (-12)*IT_0068 + (-12)
      *IT_0069) + (IT_0038 + -conj(IT_0038) + IT_0048 + -conj(IT_0048))*IT_0074 
    ...
    const ccomplex_t IT_0086 = IT_0029*(conj(IT_0029)*(12*s_34 + (-12)*IT_0030
      ...
      (IT_0056))*IT_0058) + -IT_0066*IT_0076 + conj(IT_0038)*(IT_0075*IT_0077 +
       IT_0069*IT_0078) + conj(IT_0055)*(IT_0030*IT_0075 + IT_0077*IT_0078) + 6
      *IT_0048*(0.166666666666667*conj(IT_0048)*IT_0072 + conj(IT_0056)*IT_0079 
      + IT_0080) + 6*IT_0038*(0.166666666666667*conj(IT_0038)*IT_0072 + conj
      (IT_0055)*IT_0079 + IT_0080 + 0.166666666666667*IT_0069*IT_0081 + IT_0082
      *IT_0083) + 6*IT_0055*(conj(IT_0038)*IT_0079 + 0.166666666666667*IT_0030
      *IT_0082 + IT_0081*IT_0083 + 0.166666666666667*conj(IT_0055)*IT_0084 +
       IT_0085) + 6*IT_0056*(conj(IT_0048)*IT_0079 + 0.166666666666667*conj
