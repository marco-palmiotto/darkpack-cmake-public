...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_sc_R_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*IT_0000*IT_0001*IT_0002*
      (IT_0004 + (-0.75)*IT_0005*IT_0006*IT_0008*IT_0010);
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*-1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0002*IT_0007 + -IT_0001*IT_0013) + (-1.5)*IT_0002*IT_0006*IT_0014
      *IT_0015*IT_0016);
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_W*e_em*IT_0020*(IT_0013
      *IT_0021 + 5*IT_0001*((-0.2)*IT_0001*(IT_0001*IT_0007 + 5*IT_0002*IT_0013)
       + IT_0007*IT_0022));
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0007 + IT_0002*IT_0013) + (-1.5)*IT_0001*IT_0006*IT_0014
      *IT_0015*IT_0016);
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_W*e_em*IT_0020*(IT_0007
      *IT_0021 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0007 + 1*IT_0013*(IT_0022 + 
      -1./5*IT_0032)));
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0001
      *IT_0014*IT_0015*IT_0016;
    const ccomplex_t IT_0040 = 0.5*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0002
      *IT_0014*IT_0015*IT_0016;
    const ccomplex_t IT_0042 = (-0.5)*IT_0041;
    const ccomplex_t IT_0043 = IT_0040*IT_0042;
    const ccomplex_t IT_0044 = pow(m_h, 2);
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0026 + IT_0044 + -m_sc_L*
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_13 + IT_0026 + IT_0044 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
