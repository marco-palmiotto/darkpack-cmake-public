...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_ss_L_to_A0_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*mu_h*IT_0001*IT_0004;
    const ccomplex_t IT_0006 = 0.5*IT_0005;
    const ccomplex_t IT_0007 = pow(m_sc_R, 2);
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001;
    const ccomplex_t IT_0018 = -IT_0017;
    const ccomplex_t IT_0019 = m_c*e_em*mu_h*IT_0001*IT_0004;
    const ccomplex_t IT_0020 = (-0.5)*IT_0019;
    const ccomplex_t IT_0021 = cpow((-2)*s_13 + IT_0007 + IT_0013 + -m_sc_L*
