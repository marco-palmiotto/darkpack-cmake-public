        ...
        )
{
    ...
    const ccomplex_t IT_0013 = pow(m_H0, 2);
    ...
    const ccomplex_t IT_0025 = cpow(IT_0003, 3);
    const ccomplex_t IT_0026 = sin(alpha);
    const ccomplex_t IT_0027 = -IT_0001;
    const ccomplex_t IT_0028 = 3*IT_0006 + IT_0023;
    const ccomplex_t IT_0029 = cpow(IT_0003, 2);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_W*e_em*(IT_0024*IT_0025
      *IT_0026 + IT_0027*(IT_0027*(IT_0001*IT_0009*IT_0024 + -IT_0003*IT_0026
      *IT_0028) + IT_0009*IT_0028*IT_0029));
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = IT_0019*IT_0031;
    const ccomplex_t IT_0033 = pow(m_sc_R, 2);
    const ccomplex_t IT_0034 = cpow((-2)*s_12 + -IT_0014 + -IT_0033 + m_Hp*
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0006*(IT_0000*IT_0002*IT_0003*IT_0039 + (-2)*IT_0001*(m_W*IT_0003
       + (-0.5)*IT_0000*IT_0004*IT_0040));
    const ccomplex_t IT_0042 = 0.5*IT_0041;
    const ccomplex_t IT_0043 = IT_0038*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0013 + IT_0033 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*(m_W*IT_0005*IT_0022*
      (IT_0001*IT_0009 + -IT_0003*IT_0026) + 1.5*IT_0000*IT_0004*IT_0006*IT_0026
      *IT_0040);
    const ccomplex_t IT_0048 = (-0.666666666666667)*IT_0047;
    const ccomplex_t IT_0049 = IT_0019*IT_0048;
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0013 + (0 + _Complex_I*1)
      *m_sc_R*Gamma_cr + reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*conj
    ...
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0075 = IT_0073*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0006 +
       1./3*IT_0005*IT_0022)*(IT_0001*IT_0009 + -IT_0003*IT_0026) + IT_0000
      *IT_0002*IT_0006*IT_0009*IT_0039);
    const ccomplex_t IT_0078 = -IT_0077;
    const ccomplex_t IT_0079 = IT_0019*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0013 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0079*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = cpow(IT_0001, 2);
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_W*e_em*(IT_0006*IT_0009
      *IT_0025 + (-2)*IT_0001*(IT_0003*(0.5*IT_0006 + IT_0005*IT_0022)*(IT_0001
      *IT_0009 + -IT_0003*IT_0026) + 1./2*IT_0006*IT_0026*IT_0083));
    const ccomplex_t IT_0085 = (-0.5)*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_12 + -IT_0014 + -IT_0033 + IT_0089 
      + -reg_prop, -1);
    const ccomplex_t IT_0091 = IT_0088*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = IT_0017 + -IT_0036 + IT_0046 + IT_0052 +
       IT_0060 + IT_0068 + IT_0076 + IT_0082 + -IT_0092;
