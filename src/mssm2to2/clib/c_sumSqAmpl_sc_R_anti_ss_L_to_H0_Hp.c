...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_ss_L_to_H0_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0009 + -m_s*e_em*mu_h*IT_0000*IT_0002*IT_0006*IT_0010);
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0006*(IT_0000*IT_0002*IT_0003*IT_0029 + (-2)*IT_0001*(m_W*IT_0003
       + (-0.5)*IT_0000*IT_0004*IT_0030));
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = IT_0028*IT_0032;
    const ccomplex_t IT_0034 = pow(m_sc_R, 2);
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0014 + IT_0034 + -m_sc_L*
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*(1.5*IT_0000*IT_0004
      *IT_0006*IT_0010*IT_0030 + m_W*IT_0005*(IT_0001*IT_0009 + -IT_0003*IT_0010
      )*IT_0041);
    const ccomplex_t IT_0043 = (-0.666666666666667)*IT_0042;
    const ccomplex_t IT_0044 = IT_0039*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_13 + IT_0014 + (0 + _Complex_I*1)
      *m_sc_R*Gamma_cr + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0044*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*conj
      (V_cd)*e_em*IT_0000*IT_0002*IT_0004*IT_0006;
    const ccomplex_t IT_0049 = 0.5*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0009;
    const ccomplex_t IT_0051 = (-0.5)*IT_0050;
    const ccomplex_t IT_0052 = IT_0049*IT_0051;
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sb_2*
    ...
    const ccomplex_t IT_0064 = cpow(IT_0003, 3);
    const ccomplex_t IT_0065 = cpow(IT_0001, 2);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_W*e_em*(IT_0006*IT_0009
      *IT_0064 + (-2)*IT_0001*(IT_0003*(IT_0001*IT_0009 + -IT_0003*IT_0010)*(0.5
      *IT_0006 + IT_0005*IT_0041) + 1./2*IT_0006*IT_0010*IT_0065));
    ...
    const ccomplex_t IT_0071 = pow(m_W, 2);
    const ccomplex_t IT_0072 = cpow((-2)*s_12 + -IT_0015 + -IT_0034 + IT_0071 
      + -reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0070*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = cpow((-2)*s_12 + -IT_0015 + -IT_0034 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0076 = -IT_0006;
    const ccomplex_t IT_0077 = IT_0005*IT_0041;
    const ccomplex_t IT_0078 = IT_0076 + IT_0077;
    const ccomplex_t IT_0079 = -IT_0001;
    const ccomplex_t IT_0080 = 3*IT_0006 + IT_0077;
    const ccomplex_t IT_0081 = cpow(IT_0003, 2);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_W*e_em*(IT_0010*IT_0064
      *IT_0078 + IT_0079*(IT_0079*(IT_0001*IT_0009*IT_0078 + -IT_0003*IT_0010
      *IT_0080) + IT_0009*IT_0080*IT_0081));
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0006*IT_0009*IT_0029 + (-0.5)*m_W*(IT_0001*IT_0009 + -IT_0003*IT_0010)
      *(IT_0006 + 1./3*IT_0005*IT_0041));
    const ccomplex_t IT_0088 = -IT_0087;
    const ccomplex_t IT_0089 = IT_0039*IT_0088;
    const ccomplex_t IT_0090 = cpow((-2)*s_23 + IT_0014 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0091 = IT_0089*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = IT_0018 + IT_0026 + IT_0037 + IT_0047 + IT_0055
       + IT_0063 + -IT_0074 + -IT_0086 + IT_0092;
