...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_ss_L_to_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = pow(m_ss_L, 2);
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0009 + IT_0016 + -m_sc_R*
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0008 + IT_0016 + -m_ss_L*
