        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_c*V_cb*e_em
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_sb_1*
    ...
    const ccomplex_t IT_0040 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_sb_2*
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
      *IT_0006*IT_0009*IT_0045 + (-0.5)*m_W*(IT_0001*IT_0009 + IT_0003*IT_0020)*
      (IT_0006 + 1./3*IT_0005*IT_0047));
    const ccomplex_t IT_0049 = IT_0044*IT_0048;
    const ccomplex_t IT_0050 = cpow((-2)*s_23 + IT_0013 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = cpow(IT_0003, 3);
    const ccomplex_t IT_0054 = cpow(IT_0001, 2);
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*m_W*e_em*(IT_0006*IT_0009
      *IT_0053 + (-2)*IT_0001*(IT_0003*(IT_0001*IT_0009 + IT_0003*IT_0020)*(0.5
      *IT_0006 + IT_0005*IT_0047) + -1./2*IT_0006*IT_0020*IT_0054));
    ...
    const ccomplex_t IT_0061 = pow(m_sc_R, 2);
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0014 + IT_0060 + -IT_0061 
      + -reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0059*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = IT_0005*IT_0047;
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_W*e_em*(IT_0020*IT_0053
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_12 + -IT_0014 + -IT_0061 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0000
      *IT_0004*IT_0006*IT_0009;
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = pow(m_c, 2);
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0006*(IT_0000*IT_0002*IT_0003*IT_0045 + (-2)*IT_0001*(m_W*IT_0003
       + (-0.5)*IT_0000*IT_0004*IT_0077));
    const ccomplex_t IT_0079 = 0.5*IT_0078;
    const ccomplex_t IT_0080 = IT_0076*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0013 + IT_0061 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*e_em*(m_W*IT_0005*(IT_0001
      *IT_0009 + IT_0003*IT_0020)*IT_0047 + (-1.5)*IT_0000*IT_0004*IT_0006
      *IT_0020*IT_0077);
    const ccomplex_t IT_0085 = 0.666666666666667*IT_0084;
    const ccomplex_t IT_0086 = IT_0044*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0013 + (0 + _Complex_I*1)
      *m_sc_R*Gamma_cr + reg_prop, -1);
    const ccomplex_t IT_0088 = IT_0086*IT_0087;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*IT_0088;
    const ccomplex_t IT_0090 = IT_0017 + IT_0026 + IT_0034 + IT_0042 + IT_0052
       + -IT_0064 + -IT_0074 + IT_0083 + IT_0089;
