...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_ss_R_to_A0_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0001*IT_0004*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0019 = pow(s_34, 2);
    const ccomplex_t IT_0020 = IT_0018*IT_0019;
    return create_ccomplex_return((-3)*IT_0016*conj(IT_0016)*(IT_0017 + 
      -IT_0020));
}
