        ...
        )
{
    ...
    const ccomplex_t IT_0051 = -IT_0013;
    const ccomplex_t IT_0052 = IT_0008*IT_0027;
    const ccomplex_t IT_0053 = IT_0051 + IT_0052;
    const ccomplex_t IT_0054 = cpow(IT_0003, 3);
    const ccomplex_t IT_0055 = -IT_0005;
    const ccomplex_t IT_0056 = 3*IT_0013 + IT_0052;
    const ccomplex_t IT_0057 = cpow(IT_0003, 2);
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*m_W*e_em*(IT_0007*IT_0053
      *IT_0054 + IT_0055*(IT_0055*(IT_0002*IT_0005*IT_0053 + -IT_0003*IT_0007
      *IT_0056) + IT_0002*IT_0056*IT_0057));
    const ccomplex_t IT_0059 = 0.5*IT_0058;
    const ccomplex_t IT_0060 = IT_0025*IT_0059;
    const ccomplex_t IT_0061 = pow(m_sc_R, 2);
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0020 + -IT_0061 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0060*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0002
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_13 + IT_0019 + IT_0061 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = pow(m_c, 2);
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0002*IT_0005 +
    ...
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0019 + (0 + _Complex_I*1)
      *m_sc_R*Gamma_cr + reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*mu_h*IT_0012*IT_0013;
    const ccomplex_t IT_0081 = 0.5*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0002;
    const ccomplex_t IT_0083 = (-0.5)*IT_0082;
    const ccomplex_t IT_0084 = IT_0081*IT_0083;
    const ccomplex_t IT_0085 = cpow((-2)*s_23 + IT_0019 + IT_0020 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0086 = IT_0084*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*IT_0086;
    const ccomplex_t IT_0088 = IT_0011 + IT_0023 + IT_0034 + IT_0042 + IT_0050
       + -IT_0064 + IT_0072 + IT_0079 + IT_0087;
