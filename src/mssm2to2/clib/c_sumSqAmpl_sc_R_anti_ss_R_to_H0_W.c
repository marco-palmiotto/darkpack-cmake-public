...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_ss_R_to_H0_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0005*IT_0007*IT_0008*IT_0009;
    ...
    return create_ccomplex_return((-3)*IT_0017*conj(IT_0017)*(IT_0018 + 
      -IT_0021));
}
