...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_ss_R_to_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0003*IT_0005*IT_0007*IT_0009;
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_23 + IT_0013 + IT_0020 + -m_sc_R*
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0012 + IT_0020 + -m_ss_R*
