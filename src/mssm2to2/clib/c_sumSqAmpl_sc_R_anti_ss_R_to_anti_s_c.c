        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0073 = pow(m_sc_R, 2);
    const ccomplex_t IT_0074 = m_c*m_s*IT_0073;
    const ccomplex_t IT_0075 = s_34*IT_0073;
    ...
    const ccomplex_t IT_0080 = IT_0020*IT_0061;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0082 = IT_0022*IT_0080*IT_0081;
    const ccomplex_t IT_0083 = IT_0028*IT_0068;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0085 = IT_0030*IT_0083*IT_0084;
    const ccomplex_t IT_0086 = IT_0036*IT_0047;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0088 = IT_0038*IT_0086*IT_0087;
    const ccomplex_t IT_0089 = m_c*IT_0016;
    const ccomplex_t IT_0090 = m_c*IT_0024;
    const ccomplex_t IT_0091 = m_c*IT_0032;
    const ccomplex_t IT_0092 = IT_0010*IT_0054;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0094 = IT_0014*IT_0092*IT_0093;
    const ccomplex_t IT_0095 = m_c*IT_0040;
    const ccomplex_t IT_0096 = -IT_0082 + -IT_0085 + -IT_0088 + IT_0089 +
       IT_0090 + IT_0091 + -IT_0094 + IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0000*IT_0002*IT_0004*IT_0008;
    const ccomplex_t IT_0098 = 0.5*IT_0097;
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*e_em
      *IT_0000*IT_0002*IT_0004*IT_0007;
    const ccomplex_t IT_0100 = 0.5*IT_0099;
    const ccomplex_t IT_0101 = IT_0098*IT_0100;
    const ccomplex_t IT_0102 = cpow((-2)*s_12 + -IT_0013 + -IT_0073 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0103 = IT_0101*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*IT_0103;
    const ccomplex_t IT_0105 = -IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
    ...
    const ccomplex_t IT_0112 = IT_0026*IT_0066;
    const ccomplex_t IT_0113 = IT_0030*IT_0084*IT_0112;
    const ccomplex_t IT_0114 = IT_0034*IT_0045;
    const ccomplex_t IT_0115 = IT_0038*IT_0087*IT_0114;
    const ccomplex_t IT_0116 = pow(m_sG, 2);
    const ccomplex_t IT_0117 = cpow((-2)*s_23 + IT_0012 + IT_0013 + -IT_0116 +
       reg_prop, -1);
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*g_s;
    ...
    const ccomplex_t IT_0124 = m_c*IT_0050;
    const ccomplex_t IT_0125 = IT_0006*IT_0052;
    const ccomplex_t IT_0126 = IT_0014*IT_0093*IT_0125;
    const ccomplex_t IT_0127 = IT_0018*IT_0059;
    const ccomplex_t IT_0128 = IT_0022*IT_0081*IT_0127;
    const ccomplex_t IT_0129 = m_c*IT_0057;
    const ccomplex_t IT_0130 = m_c*IT_0064;
    const ccomplex_t IT_0131 = -IT_0113 + -IT_0115 + (-0.166666666666667)
    ...
    const ccomplex_t IT_0135 = m_c*s_13;
    const ccomplex_t IT_0136 = (-0.5)*IT_0121;
    const ccomplex_t IT_0137 = 0.5*IT_0122;
    const ccomplex_t IT_0138 = 6*IT_0105;
    const ccomplex_t IT_0139 = 18*IT_0096;
    ...
    const ccomplex_t IT_0145 = 0.166666666666667*IT_0121;
    const ccomplex_t IT_0146 = (-18)*IT_0131;
    const ccomplex_t IT_0147 = (-6)*IT_0111;
    const ccomplex_t IT_0148 = IT_0041*(18*conj(IT_0096) + 6*conj(IT_0105)) +
    ...
    const ccomplex_t IT_0150 = (-6)*IT_0075;
    const ccomplex_t IT_0151 = 12*IT_0077;
    ...
    const ccomplex_t IT_0170 = IT_0041*((-18)*conj(IT_0072)*IT_0074 + conj
      (IT_0041)*IT_0079) + (conj(IT_0096)*IT_0105 + IT_0096*conj(IT_0105) + conj
      (IT_0111)*IT_0131 + IT_0111*conj(IT_0131))*IT_0132 + (IT_0096*conj(IT_0096
      ) + IT_0105*conj(IT_0105) + IT_0111*conj(IT_0111) + IT_0131*conj(IT_0131))
      *IT_0133 + IT_0072*(conj(IT_0072)*IT_0079 + IT_0074*IT_0134) + IT_0135
      *IT_0148 + IT_0145*(IT_0074*(18*IT_0041 + IT_0134) + IT_0079*(conj(IT_0072
      ) + -IT_0145 + IT_0149)) + 6*IT_0136*((IT_0041 + -conj(IT_0041))*IT_0074 +
       (-0.333333333333333)*((-0.5)*conj(IT_0072) + IT_0145 + (-0.5)*IT_0149)
      *IT_0152 + IT_0079*IT_0153) + IT_0154*IT_0166 + (-6)*IT_0167*((IT_0096 + 3
