        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0004*IT_0005 +
       IT_0002*IT_0007)*IT_0008*IT_0017 + (-3)*IT_0003*IT_0007*IT_0012*IT_0013
      *IT_0018);
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*m_c*e_em*mu_h*IT_0006
    ...
    const ccomplex_t IT_0069 = IT_0008*IT_0017;
    const ccomplex_t IT_0070 = -IT_0013 + IT_0069;
    const ccomplex_t IT_0071 = cpow(IT_0005, 3);
    const ccomplex_t IT_0072 = 3*IT_0013 + IT_0069;
    const ccomplex_t IT_0073 = cpow(IT_0005, 2);
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*m_W*e_em*(IT_0004*IT_0070
      *IT_0071 + -IT_0002*(IT_0002*(IT_0002*IT_0007*IT_0070 + IT_0004*IT_0005
      *IT_0072) + -IT_0007*IT_0072*IT_0073));
    ...
    const ccomplex_t IT_0079 = pow(m_c, 2);
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0004*IT_0005 +
       IT_0002*IT_0007)*IT_0008*IT_0017 + (-1.5)*IT_0004*IT_0006*IT_0012*IT_0013
      *IT_0079);
    const ccomplex_t IT_0081 = 0.666666666666667*IT_0080;
    const ccomplex_t IT_0082 = IT_0015*IT_0081;
    const ccomplex_t IT_0083 = cpow((-2)*s_13 + IT_0022 + (0 + _Complex_I*1)
      *m_sc_R*Gamma_cr + reg_prop, -1);
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*IT_0084;
    const ccomplex_t IT_0086 = IT_0011 + IT_0025 + IT_0034 + IT_0043 + IT_0051
       + IT_0059 + IT_0067 + -IT_0078 + IT_0085;
