...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_ss_R_to_h_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_c*m_s*conj
      (V_cs)*e_em*IT_0005*IT_0008*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0021 = pow(s_34, 2);
    const ccomplex_t IT_0022 = IT_0020*IT_0021;
    return create_ccomplex_return((-3)*IT_0018*conj(IT_0018)*(IT_0019 + 
      -IT_0022));
}
