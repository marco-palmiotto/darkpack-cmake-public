...
ccomplex_return_t c_sumSqAmpl_sc_R_anti_st_1_to_s_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
    ...
    const ccomplex_t IT_0043 = m_s*IT_0017;
    const ccomplex_t IT_0044 = m_s*IT_0021;
    const ccomplex_t IT_0045 = -IT_0044;
    const ccomplex_t IT_0046 = IT_0043 + IT_0045;
    const ccomplex_t IT_0047 = IT_0011*IT_0046;
    const ccomplex_t IT_0048 = m_s*IT_0029;
    const ccomplex_t IT_0049 = m_s*IT_0033;
