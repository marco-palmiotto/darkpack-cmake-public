        ...
        )
{
    ...
    const ccomplex_t IT_0028 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0029 = IT_0027*IT_0028;
    const ccomplex_t IT_0030 = 1.4142135623731*IT_0029;
    const ccomplex_t IT_0031 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    ...
    const ccomplex_t IT_0038 = m_b*conj(U_d2)*V_tb*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0039 = IT_0027*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
