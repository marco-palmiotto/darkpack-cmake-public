...
ccomplex_return_t c_sumSqAmpl_sc_R_sb_1_to_s_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*V_u1
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_C_2*
    ...
    const ccomplex_t IT_0025 = s_34*IT_0001;
    const ccomplex_t IT_0026 = m_s*m_t;
    ...
    const ccomplex_t IT_0031 = m_b*conj(U_d2)*V_tb*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = V_tb*e_em*conj(U_Wm2)*U_sb_00;
    const ccomplex_t IT_0035 = IT_0007*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*(IT_0033 + (-2)*IT_0035);
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = IT_0017*IT_0037;
    const ccomplex_t IT_0039 = IT_0015*IT_0027*IT_0038;
    const ccomplex_t IT_0040 = -IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0042 = m_b*conj(U_d1)*V_tb*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0043 = IT_0030*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = V_tb*e_em*conj(U_Wm1)*U_sb_00;
    const ccomplex_t IT_0046 = IT_0007*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*(IT_0044 + (-2)*IT_0046);
    const ccomplex_t IT_0048 = (-0.5)*IT_0047;
    const ccomplex_t IT_0049 = IT_0009*IT_0048;
    const ccomplex_t IT_0050 = IT_0002*IT_0041*IT_0049;
    const ccomplex_t IT_0051 = m_s*IT_0023;
    const ccomplex_t IT_0052 = 18*s_34;
    const ccomplex_t IT_0053 = (-18)*s_34;
    const ccomplex_t IT_0054 = m_t*s_13;
    const ccomplex_t IT_0055 = (-18)*IT_0023;
    const ccomplex_t IT_0056 = (-18)*conj(IT_0023);
    const ccomplex_t IT_0057 = m_s*s_14;
    const ccomplex_t IT_0058 = IT_0023*conj(IT_0023)*(36*IT_0024 + (-18)
      *IT_0025) + IT_0026*(((-18)*conj(IT_0040) + 18*conj(IT_0050))*IT_0051 + ((
      -18)*IT_0040 + 18*IT_0050)*conj(IT_0051)) + (IT_0040*conj(IT_0040) +
       IT_0050*conj(IT_0050) + IT_0051*conj(IT_0051))*IT_0052 + (conj(IT_0040)
      *IT_0050 + IT_0040*conj(IT_0050))*IT_0053 + IT_0054*(18*conj(IT_0023)
      *IT_0040 + 18*IT_0023*conj(IT_0040) + conj(IT_0050)*IT_0055 + IT_0050
      *IT_0056) + (conj(IT_0051)*IT_0055 + IT_0051*IT_0056)*IT_0057;
