        ...
        )
{
    ...
    const ccomplex_t IT_0020 = N_B1*e_em*U_st_10;
    ...
    const ccomplex_t IT_0029 = m_t*N_u1*e_em*IT_0028*U_st_00;
    ...
    const ccomplex_t IT_0040 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0041 = IT_0017*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = m_t*N_u2*e_em*IT_0028*U_st_00;
    ...
    const ccomplex_t IT_0056 = m_t*N_u4*e_em*IT_0028*U_st_00;
    ...
    const ccomplex_t IT_0071 = m_t*conj(N_u1)*e_em*IT_0028*U_st_10;
    ...
    const ccomplex_t IT_0086 = m_t*conj(N_u2)*e_em*IT_0028*U_st_10;
    ...
    const ccomplex_t IT_0099 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0100 = IT_0017*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = m_t*N_u3*e_em*IT_0028*U_st_00;
    ...
    const ccomplex_t IT_0115 = m_t*conj(N_u3)*e_em*IT_0028*U_st_10;
    ...
    const ccomplex_t IT_0140 = pow(m_st_1, 2);
    const ccomplex_t IT_0141 = s_34*IT_0140;
    const ccomplex_t IT_0142 = (-6)*IT_0141;
    const ccomplex_t IT_0143 = s_23*s_24;
    const ccomplex_t IT_0144 = 12*IT_0143;
    const ccomplex_t IT_0145 = IT_0142 + IT_0144;
    const ccomplex_t IT_0146 = (-0.5)*IT_0012;
    const ccomplex_t IT_0147 = 0.166666666666667*IT_0012;
    const ccomplex_t IT_0148 = -IT_0078 + -IT_0093 + -IT_0122 + -IT_0137;
    const ccomplex_t IT_0149 = IT_0147 + IT_0148;
    const ccomplex_t IT_0150 = conj(IT_0147) + conj(IT_0148);
    const ccomplex_t IT_0151 = (-18)*IT_0141;
    const ccomplex_t IT_0152 = 36*IT_0143;
    ...
    const ccomplex_t IT_0159 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0024*IT_0026*IT_0028;
    ...
    const ccomplex_t IT_0164 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0024*IT_0026*IT_0028;
    const ccomplex_t IT_0165 = 0.5*IT_0164;
    const ccomplex_t IT_0166 = IT_0106*IT_0165;
    const ccomplex_t IT_0167 = IT_0096*IT_0166;
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0024*IT_0026*IT_0028;
    const ccomplex_t IT_0170 = 0.5*IT_0169;
    const ccomplex_t IT_0171 = IT_0060*IT_0170;
    const ccomplex_t IT_0172 = IT_0063*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = -IT_0158 + -IT_0163 + -IT_0168 + -IT_0173;
    const ccomplex_t IT_0175 = m_c*m_t;
    const ccomplex_t IT_0176 = IT_0075*IT_0160;
    const ccomplex_t IT_0177 = IT_0015*IT_0035*IT_0176;
    const ccomplex_t IT_0178 = IT_0090*IT_0155;
    const ccomplex_t IT_0179 = IT_0037*IT_0049*IT_0178;
    const ccomplex_t IT_0180 = m_t*IT_0163;
    const ccomplex_t IT_0181 = m_t*IT_0168;
    const ccomplex_t IT_0182 = IT_0119*IT_0165;
    const ccomplex_t IT_0183 = IT_0095*IT_0096*IT_0182;
    const ccomplex_t IT_0184 = IT_0134*IT_0170;
    const ccomplex_t IT_0185 = IT_0062*IT_0063*IT_0184;
    const ccomplex_t IT_0186 = m_t*IT_0158;
    const ccomplex_t IT_0187 = m_t*IT_0173;
    const ccomplex_t IT_0188 = IT_0177 + IT_0179 + -IT_0180 + -IT_0181 +
       IT_0183 + IT_0185 + -IT_0186 + -IT_0187;
    const ccomplex_t IT_0189 = (-18)*IT_0139;
    const ccomplex_t IT_0190 = (-6)*IT_0014;
    const ccomplex_t IT_0191 = IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = (-18)*conj(IT_0139);
    const ccomplex_t IT_0193 = (-6)*conj(IT_0014);
    const ccomplex_t IT_0194 = IT_0192 + IT_0193;
    const ccomplex_t IT_0195 = m_t*s_23;
    const ccomplex_t IT_0196 = (((-18)*conj(IT_0014) + (-6)*conj(IT_0139))
      *IT_0146 + ((-18)*IT_0014 + (-6)*IT_0139)*conj(IT_0146) + (-18)*conj
      (IT_0174)*IT_0188 + (-18)*IT_0174*conj(IT_0188) + IT_0150*IT_0191 +
       IT_0149*IT_0194)*IT_0195;
    const ccomplex_t IT_0197 = 18*s_34;
    const ccomplex_t IT_0198 = m_c*s_24;
    const ccomplex_t IT_0199 = 18*IT_0188;
    const ccomplex_t IT_0200 = 18*conj(IT_0188);
    const ccomplex_t IT_0201 = m_c*m_t*IT_0140;
    const ccomplex_t IT_0202 = (-18)*IT_0174;
    const ccomplex_t IT_0203 = (-18)*conj(IT_0174);
    const ccomplex_t IT_0204 = 6*s_34*(conj(IT_0014)*IT_0139 + IT_0014*conj
      (IT_0139)) + IT_0145*(conj(IT_0146)*IT_0149 + IT_0146*IT_0150) + IT_0153*
      (IT_0146*conj(IT_0146) + IT_0149*IT_0150 + IT_0174*conj(IT_0174)) +
       IT_0175*(conj(IT_0188)*IT_0191 + IT_0188*IT_0194) + IT_0196 + (IT_0014
      *conj(IT_0014) + IT_0139*conj(IT_0139) + IT_0188*conj(IT_0188))*IT_0197 +
       6*IT_0198*((conj(IT_0014) + 3*conj(IT_0139))*IT_0174 + (IT_0014 + 3
      *IT_0139)*conj(IT_0174) + conj(IT_0146)*IT_0188 + IT_0146*conj(IT_0188) +
       0.166666666666667*IT_0150*IT_0199 + 0.166666666666667*IT_0149*IT_0200) + 
      (-6)*IT_0201*(conj(IT_0146)*IT_0174 + IT_0146*conj(IT_0174) + (
      -0.166666666666667)*IT_0150*IT_0202 + (-0.166666666666667)*IT_0149*IT_0203);
