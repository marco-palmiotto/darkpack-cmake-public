...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sb_1_to_u_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*conj
      (V_u1)*e_em*IT_0005*IT_0007*IT_0009*conj(U_sb_00);
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*conj
      (V_u2)*e_em*IT_0005*IT_0007*IT_0009*conj(U_sb_00);
    ...
    const ccomplex_t IT_0043 = m_b*U_d1*V_tb*e_em*IT_0007*conj(U_sb_10);
    ...
    const ccomplex_t IT_0051 = m_b*U_d2*V_tb*e_em*IT_0007*conj(U_sb_10);
