        ...
        )
{
    ...
    const ccomplex_t IT_0023 = N_B1*e_em*conj(U_sb_01);
    const ccomplex_t IT_0024 = IT_0012*IT_0023;
    const ccomplex_t IT_0025 = 1.4142135623731*IT_0024;
    const ccomplex_t IT_0026 = N_W1*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0033 = m_b*N_d1*e_em*IT_0032*conj(U_sb_11);
    ...
    const ccomplex_t IT_0050 = N_B3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0051 = IT_0012*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = N_W3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0054 = IT_0017*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = m_b*N_d3*e_em*IT_0032*conj(U_sb_11);
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0065 = conj(N_B4)*e_em;
    const ccomplex_t IT_0066 = IT_0012*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = conj(N_W4)*e_em;
    ...
    const ccomplex_t IT_0079 = m_b*N_d4*e_em*IT_0032*conj(U_sb_11);
    ...
    const ccomplex_t IT_0110 = 0.166666666666667*IT_0008 + -IT_0040 + -IT_0063
       + -IT_0086 + -IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
    ...
    const ccomplex_t IT_0116 = m_b*conj(N_d1)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0017*IT_0030*IT_0032;
    ...
    const ccomplex_t IT_0129 = m_b*conj(N_d2)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0135 = IT_0087*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0138 = (-0.5)*IT_0137;
    const ccomplex_t IT_0139 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0140 = IT_0012*IT_0139;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = m_b*conj(N_d3)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0152 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0153 = IT_0012*IT_0152;
    const ccomplex_t IT_0154 = 1.4142135623731*IT_0153;
    const ccomplex_t IT_0155 = m_b*conj(N_d4)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0161 = IT_0064*IT_0160;
    ...
    const ccomplex_t IT_0169 = m_d*s_14;
    const ccomplex_t IT_0170 = m_d*IT_0008;
    ...
    const ccomplex_t IT_0178 = IT_0022*IT_0120;
    const ccomplex_t IT_0179 = IT_0010*IT_0177*IT_0178;
    const ccomplex_t IT_0180 = m_d*IT_0123;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0182 = IT_0095*IT_0133;
    const ccomplex_t IT_0183 = IT_0087*IT_0181*IT_0182;
    const ccomplex_t IT_0184 = m_d*IT_0136;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0186 = IT_0049*IT_0146;
    const ccomplex_t IT_0187 = IT_0041*IT_0185*IT_0186;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0189 = IT_0072*IT_0159;
    const ccomplex_t IT_0190 = IT_0064*IT_0188*IT_0189;
    const ccomplex_t IT_0191 = m_d*IT_0162;
    const ccomplex_t IT_0192 = m_d*IT_0149;
    const ccomplex_t IT_0193 = 0.166666666666667*IT_0175 + -IT_0179 + IT_0180 
      + -IT_0183 + IT_0184 + -IT_0187 + -IT_0190 + IT_0191 + IT_0192;
    const ccomplex_t IT_0194 = m_d*IT_0086;
    const ccomplex_t IT_0195 = IT_0106*IT_0125;
    const ccomplex_t IT_0196 = IT_0087*IT_0181*IT_0195;
    const ccomplex_t IT_0197 = m_d*IT_0109;
    const ccomplex_t IT_0198 = IT_0083*IT_0151;
    const ccomplex_t IT_0199 = IT_0064*IT_0188*IT_0198;
    const ccomplex_t IT_0200 = m_d*IT_0063;
    const ccomplex_t IT_0201 = IT_0037*IT_0112;
    const ccomplex_t IT_0202 = IT_0010*IT_0177*IT_0201;
    const ccomplex_t IT_0203 = IT_0060*IT_0138;
    const ccomplex_t IT_0204 = IT_0041*IT_0185*IT_0203;
    const ccomplex_t IT_0205 = m_d*IT_0040;
    const ccomplex_t IT_0206 = (-0.166666666666667)*IT_0170 + IT_0194 + 
      -IT_0196 + IT_0197 + -IT_0199 + IT_0200 + -IT_0202 + -IT_0204 + IT_0205;
    ...
    const ccomplex_t IT_0211 = (18*conj(IT_0009) + 6*conj(IT_0110))*IT_0171 + 
      (18*IT_0009 + 6*IT_0110)*conj(IT_0171) + 6*conj(IT_0163)*(IT_0176 + 3
      *IT_0193) + 6*IT_0163*(conj(IT_0176) + 3*conj(IT_0193)) + 6*conj(IT_0206)
      *IT_0208 + 6*IT_0206*IT_0210;
    const ccomplex_t IT_0212 = m_b*m_d*IT_0005;
    ...
    const ccomplex_t IT_0217 = m_b*s_13;
    ...
    const ccomplex_t IT_0222 = (-6)*conj(IT_0193);
    const ccomplex_t IT_0223 = ((-18)*conj(IT_0009) + (-6)*conj(IT_0110))
      *IT_0176 + ((-18)*IT_0009 + (-6)*IT_0110)*conj(IT_0176) + (-6)*IT_0193
      *IT_0210 + IT_0163*IT_0220 + (-6)*conj(IT_0163)*(IT_0171 + (
      -0.166666666666667)*IT_0221) + IT_0208*IT_0222;
    const ccomplex_t IT_0224 = m_b*m_d;
    const ccomplex_t IT_0225 = (-6)*(conj(IT_0176)*IT_0206 + (
      -0.166666666666667)*IT_0176*((-18)*conj(IT_0171) + (-6)*conj(IT_0206)) + (
      -0.166666666666667)*IT_0193*IT_0220 + (-0.166666666666667)*conj(IT_0193)
      *IT_0221 + (-0.166666666666667)*IT_0171*((-18)*conj(IT_0176) + IT_0222))
      *IT_0224;
    const ccomplex_t IT_0226 = (IT_0009*conj(IT_0009) + IT_0110*conj(IT_0110) 
      + IT_0163*conj(IT_0163))*IT_0168 + IT_0169*IT_0211 + (-6)*(conj(IT_0163)
      *IT_0208 + IT_0163*IT_0210)*IT_0212 + (conj(IT_0176)*IT_0193 + IT_0176
      *conj(IT_0193) + conj(IT_0171)*IT_0206 + IT_0171*conj(IT_0206))*IT_0213 + 
      (IT_0171*conj(IT_0171) + IT_0176*conj(IT_0176) + IT_0193*conj(IT_0193) +
       IT_0206*conj(IT_0206))*IT_0214 + (conj(IT_0009)*IT_0110 + IT_0009*conj
      (IT_0110))*(IT_0215 + IT_0216) + IT_0217*IT_0223 + IT_0225;
