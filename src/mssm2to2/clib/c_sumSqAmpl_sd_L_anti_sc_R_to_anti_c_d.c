...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sc_R_to_anti_c_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_N_1*
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_N_2*
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_N_3*
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_N_4*
    ...
    const ccomplex_t IT_0054 = m_d*IT_0053;
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*IT_0000*IT_0004;
    const ccomplex_t IT_0093 = (-0.5)*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*e_em
      *mu_h*IT_0000*IT_0001*IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*e_em
      *mu_h*IT_0000*IT_0004;
    const ccomplex_t IT_0103 = 0.5*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
    ...
    const ccomplex_t IT_0113 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -IT_0112 +
       reg_prop, -1);
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0042;
    const ccomplex_t IT_0119 = 0.666666666666667*IT_0118;
    ...
    const ccomplex_t IT_0134 = IT_0006*IT_0119;
    ...
    const ccomplex_t IT_0138 = IT_0018*IT_0123;
    ...
    const ccomplex_t IT_0142 = IT_0026*IT_0127;
    ...
    const ccomplex_t IT_0156 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
    ...
    const ccomplex_t IT_0163 = m_d*s_13;
    ...
    const ccomplex_t IT_0165 = m_c*m_d*IT_0098;
    const ccomplex_t IT_0166 = s_34*IT_0098;
    ...
    const ccomplex_t IT_0173 = m_c*m_d;
