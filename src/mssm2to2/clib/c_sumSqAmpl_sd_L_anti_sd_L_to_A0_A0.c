        ...
        )
{
    ...
    const ccomplex_t IT_0022 = cpow(IT_0007, 3);
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_W*e_em*IT_0021*(IT_0001*
      (IT_0008*IT_0016 + -IT_0001*(IT_0001*IT_0016 + IT_0007*IT_0018)) + IT_0018
      *IT_0022);
    const ccomplex_t IT_0024 = 0.5*IT_0023;
    const ccomplex_t IT_0025 = IT_0019*IT_0024;
    const ccomplex_t IT_0026 = pow(m_sd_L, 2);
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*e_em*(IT_0010*IT_0014
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_W*e_em*IT_0021*(IT_0016
      *IT_0022 + IT_0032*(IT_0008*IT_0018 + -(IT_0007*IT_0016 + -IT_0001*IT_0018
      )*IT_0032));
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = IT_0031*IT_0034;
    const ccomplex_t IT_0036 = cpow((-2)*s_12 + (-2)*IT_0026 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = m_d*e_em*mu_h*IT_0014;
    const ccomplex_t IT_0040 = IT_0017*IT_0039;
    const ccomplex_t IT_0041 = A_b*V_td*conj(V_td);
    const ccomplex_t IT_0042 = IT_0007*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = 0.5*IT_0040 + 0.5*IT_0043;
    const ccomplex_t IT_0045 = (-0.5)*IT_0040 + (-0.5)*IT_0043;
    const ccomplex_t IT_0046 = IT_0044*IT_0045;
    const ccomplex_t IT_0047 = pow(m_A0, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0026 + IT_0047 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0026 + IT_0047 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0046*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0007;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0007;
    const ccomplex_t IT_0057 = (-0.5)*IT_0056;
    const ccomplex_t IT_0058 = IT_0055*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0026 + IT_0047 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0026 + IT_0047 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0058*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = 1.4142135623731*A_b*V_tb*V_td*IT_0007*conj
      (U_sb_10);
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0007
      *U_sb_10;
    const ccomplex_t IT_0068 = (-0.5)*IT_0067;
    const ccomplex_t IT_0069 = IT_0066*IT_0068;
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0026 + IT_0047 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_13 + IT_0026 + IT_0047 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0074 = IT_0069*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*A_b*V_tb*V_td*IT_0007*conj
      (U_sb_11);
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0007
      *U_sb_11;
    const ccomplex_t IT_0079 = (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = IT_0077*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0026 + IT_0047 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = cpow((-2)*s_23 + IT_0026 + IT_0047 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0085 = IT_0080*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = IT_0013 + -IT_0029 + -IT_0038 + IT_0050 +
       IT_0053 + IT_0061 + IT_0064 + IT_0072 + IT_0075 + IT_0083 + IT_0086;
