...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_L_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sd_L
    ...
    const ccomplex_t IT_0018 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sd_L
      *Gamma_dl + (-0.5)*reg_prop, -1);
