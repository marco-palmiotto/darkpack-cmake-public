        ...
        )
{
    ...
    const ccomplex_t IT_0018 = e_em*IT_0013*(IT_0000*IT_0003 + -IT_0014
      *IT_0015)*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*e_em*(IT_0013*IT_0016 + 3
      *IT_0012*IT_0017);
    const ccomplex_t IT_0020 = 0.166666666666667*IT_0019;
    const ccomplex_t IT_0021 = IT_0018*IT_0020;
    const ccomplex_t IT_0022 = s_13 + s_23;
    const ccomplex_t IT_0023 = IT_0021*IT_0022;
    const ccomplex_t IT_0024 = s_12 + IT_0008;
    const ccomplex_t IT_0025 = 0.5*IT_0018;
    const ccomplex_t IT_0026 = 0.333333333333333*IT_0019;
    const ccomplex_t IT_0027 = IT_0025*IT_0026;
    const ccomplex_t IT_0028 = IT_0024*IT_0027;
    const ccomplex_t IT_0029 = IT_0023 + IT_0028;
    const ccomplex_t IT_0030 = IT_0020*IT_0025;
    const ccomplex_t IT_0031 = IT_0024*IT_0030;
    const ccomplex_t IT_0032 = IT_0018*IT_0026;
    const ccomplex_t IT_0033 = s_23*IT_0032;
    const ccomplex_t IT_0034 = (-2)*IT_0031 + -IT_0033;
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0003;
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_ss_R*
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0062*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0003;
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0000;
    const ccomplex_t IT_0069 = (-0.5)*IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*A_b*V_tb*V_td*IT_0003*conj
      (U_sb_10);
    ...
    const ccomplex_t IT_0098 = IT_0011 + IT_0038 + IT_0052 + IT_0060 + IT_0065
