        ...
        )
{
    ...
    const ccomplex_t IT_0031 = pow(m_sd_L, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0015 + IT_0031 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0033 = IT_0030*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0015 + IT_0031 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0030*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = IT_0004*IT_0005;
    const ccomplex_t IT_0039 = IT_0019 + IT_0038;
    const ccomplex_t IT_0040 = cpow(IT_0001, 3);
    const ccomplex_t IT_0041 = (0 + _Complex_I*-1)*m_W*e_em*IT_0039*(IT_0007*(
      (IT_0002 + -IT_0008)*IT_0011 + IT_0001*IT_0007*IT_0020) + -IT_0020*IT_0040);
    const ccomplex_t IT_0042 = (-1.5)*IT_0041;
    const ccomplex_t IT_0043 = IT_0022*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_12 + (-2)*IT_0031 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0007;
    const ccomplex_t IT_0048 = (-0.5)*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0007;
    const ccomplex_t IT_0050 = (-0.5)*IT_0049;
    const ccomplex_t IT_0051 = IT_0048*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0015 + IT_0031 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0015 + IT_0031 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0015 + IT_0031 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0062*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0015 + IT_0031 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0067 = IT_0062*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0007 + -m_d*e_em*mu_h*IT_0001*IT_0017*IT_0018*IT_0019);
    const ccomplex_t IT_0070 = (-0.5)*IT_0069;
    const ccomplex_t IT_0071 = cpow(IT_0070, 2);
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0015 + IT_0031 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0015 + IT_0031 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0072*IT_0075;
    const ccomplex_t IT_0077 = cpow((-2)*s_23 + IT_0015 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0024*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0010
      *IT_0017*IT_0018*IT_0019 + (-0.166666666666667)*m_W*(IT_0004*IT_0005 + 3
      *IT_0019)*(IT_0001*IT_0011 + IT_0007*IT_0020));
    const ccomplex_t IT_0080 = (0 + _Complex_I*5)*m_W*e_em*IT_0039*(IT_0007*
    ...
    const ccomplex_t IT_0086 = IT_0014 + IT_0025 + IT_0034 + IT_0037 + 
      -IT_0046 + IT_0054 + IT_0057 + IT_0065 + IT_0068 + IT_0074 + IT_0076 +
       IT_0078 + -IT_0085;
