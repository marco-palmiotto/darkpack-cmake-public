        ...
        )
{
    ...
    const ccomplex_t IT_0104 = (-3)*conj(IT_0058);
    const ccomplex_t IT_0105 = -(IT_0039 + -IT_0087)*(s_23 + -IT_0098);
    const ccomplex_t IT_0106 = (IT_0087 + IT_0090)*(IT_0089 + IT_0090);
    const ccomplex_t IT_0107 = 6*IT_0058*(conj(IT_0058)*(1 + 0.5*IT_0061) + (
      -0.5)*conj(IT_0070)*IT_0076 + 0.5*conj(IT_0080)*IT_0085 + (-0.5)*conj
      (IT_0069)*IT_0093) + 3*IT_0080*(conj(IT_0058)*IT_0085 + conj(IT_0080)
      *IT_0097 + conj(IT_0070)*IT_0099 + IT_0100*IT_0101) + 3*IT_0070*(conj
      (IT_0080)*IT_0099 + -conj(IT_0070)*IT_0103 + 0.333333333333333*IT_0076
      *IT_0104 + IT_0101*IT_0105) + (-3)*IT_0069*(conj(IT_0080)*IT_0100 + (
      -0.333333333333333)*IT_0093*IT_0104 + conj(IT_0070)*IT_0105 + IT_0101
      *IT_0106);
