...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_L_to_anti_b_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = m_b*IT_0030;
    const ccomplex_t IT_0032 = 0.333333333333333*IT_0029;
    const ccomplex_t IT_0033 = m_b*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*e_em*IT_0004*IT_0028;
    ...
    const ccomplex_t IT_0039 = IT_0004*IT_0028;
    const ccomplex_t IT_0040 = e_em*IT_0039;
    const ccomplex_t IT_0041 = IT_0005*IT_0011;
    ...
    const ccomplex_t IT_0047 = (IT_0031 + -IT_0033)*(IT_0038 + -IT_0046);
    ...
    const ccomplex_t IT_0054 = -(IT_0031 + -IT_0033)*(IT_0038 + -IT_0046);
    ...
    const ccomplex_t IT_0059 = (-0.333333333333333)*IT_0057;
    ...
    const ccomplex_t IT_0079 = IT_0032*IT_0046;
    const ccomplex_t IT_0080 = -IT_0079;
    const ccomplex_t IT_0081 = IT_0032*IT_0038;
    ...
    const ccomplex_t IT_0087 = m_b*s_13;
    ...
    const ccomplex_t IT_0095 = 18*IT_0027;
    const ccomplex_t IT_0096 = IT_0080 + IT_0082;
    const ccomplex_t IT_0097 = 18*conj(IT_0027);
    const ccomplex_t IT_0098 = (-18)*IT_0049;
    const ccomplex_t IT_0099 = ((-12)*IT_0027 + 12*conj(IT_0027) + (-6)
      *IT_0049 + 6*conj(IT_0049) + (-6)*IT_0056 + 6*conj(IT_0056))*IT_0078 + 
      (conj(IT_0080) + conj(IT_0082))*IT_0095 + IT_0096*IT_0097 + IT_0069*((-36)
      *IT_0027 + 36*conj(IT_0027) + (-18)*IT_0056 + 18*conj(IT_0056) + IT_0091 +
       IT_0098);
    const ccomplex_t IT_0100 = m_b*s_14;
    const ccomplex_t IT_0101 = (-18)*IT_0080;
    ...
    const ccomplex_t IT_0105 = (-18)*conj(IT_0080);
    const ccomplex_t IT_0106 = -IT_0069;
    const ccomplex_t IT_0107 = IT_0027*conj(IT_0049)*IT_0053 + conj(IT_0027)*
      (IT_0027*(36*s_34 + (-36)*IT_0050) + IT_0053*(IT_0049 + IT_0056)) + 
      ...
      *conj(IT_0080)*IT_0087) + IT_0080*(conj(IT_0080)*IT_0090 + IT_0087*IT_0091
      ) + IT_0094*IT_0099 + conj(IT_0056)*(IT_0027*IT_0053 + IT_0052*IT_0056 +
       18*IT_0082*IT_0087 + IT_0050*IT_0098 + IT_0100*IT_0101) + conj(IT_0082)*
      (18*IT_0056*IT_0087 + IT_0082*IT_0090 + IT_0098*IT_0100 + IT_0073*IT_0101 
      + IT_0069*IT_0103) + IT_0082*(IT_0100*IT_0104 + IT_0073*IT_0105) + IT_0056
      *(IT_0050*IT_0104 + IT_0100*IT_0105) + IT_0103*(IT_0069*conj(IT_0080) +
       IT_0096*IT_0106);
