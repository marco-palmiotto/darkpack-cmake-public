        ...
        )
{
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0006;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*conj(V_cd)*e_em*U_Wm2*IT_0006;
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm1)*IT_0006;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*conj(V_cd)*e_em*U_Wm1*IT_0006;
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0000*IT_0006*IT_0013;
    const ccomplex_t IT_0070 = 0.5*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u1
      *e_em*IT_0000*IT_0006*IT_0013;
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
    ...
    const ccomplex_t IT_0127 = m_c*IT_0065;
    const ccomplex_t IT_0128 = m_c*IT_0059;
    ...
    const ccomplex_t IT_0153 = m_c*s_13;
    ...
    const ccomplex_t IT_0166 = m_c*IT_0165;
