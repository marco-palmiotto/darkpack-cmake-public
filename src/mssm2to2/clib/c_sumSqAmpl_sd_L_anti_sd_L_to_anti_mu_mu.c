...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_L_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0062 = cpow(s_12 + IT_0015 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = s_13*s_14;
    const ccomplex_t IT_0067 = IT_0015*IT_0028;
    const ccomplex_t IT_0068 = s_34*IT_0015;
    ...
    const ccomplex_t IT_0075 = m_mu*s_14;
    const ccomplex_t IT_0076 = (-6)*IT_0042;
    const ccomplex_t IT_0077 = m_mu*s_13;
