        ...
        )
{
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0006;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm2*IT_0006;
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0006;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm1*IT_0006;
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
      *e_em*IT_0000*IT_0006*IT_0012;
