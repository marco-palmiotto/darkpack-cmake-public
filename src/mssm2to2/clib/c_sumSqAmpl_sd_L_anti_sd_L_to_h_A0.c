        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*e_em*(IT_0013*IT_0016 + 3
      *IT_0012*IT_0017);
    ...
    const ccomplex_t IT_0029 = 0.333333333333333*IT_0020;
    const ccomplex_t IT_0030 = IT_0019*IT_0029;
    const ccomplex_t IT_0031 = IT_0023*IT_0030;
    const ccomplex_t IT_0032 = IT_0025*IT_0029;
    const ccomplex_t IT_0033 = s_23*IT_0032;
    const ccomplex_t IT_0034 = (-0.5)*IT_0028 + (-0.5)*IT_0031 + 0.5*IT_0033;
    ...
    const ccomplex_t IT_0040 = m_d*e_em*mu_h*IT_0039;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0000 + m_d*e_em*mu_h*IT_0015*IT_0017*IT_0039*IT_0046);
    const ccomplex_t IT_0048 = 0.5*IT_0047;
    const ccomplex_t IT_0049 = IT_0045*IT_0048;
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0003;
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*IT_0059;
    const ccomplex_t IT_0061 = 0.5*IT_0041 + 0.5*IT_0044;
    const ccomplex_t IT_0062 = IT_0048*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0062*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0003;
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0000;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0000*conj(U_sb_10);
    const ccomplex_t IT_0075 = 0.5*IT_0074;
    const ccomplex_t IT_0076 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0003
      *U_sb_10;
    ...
    const ccomplex_t IT_0082 = 1.4142135623731*A_b*V_tb*V_td*IT_0003*conj
      (U_sb_10);
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0091 = 1.4142135623731*A_b*V_tb*V_td*IT_0003*conj
      (U_sb_11);
    ...
    const ccomplex_t IT_0098 = IT_0011 + (-2)*IT_0038 + IT_0052 + IT_0060 +
