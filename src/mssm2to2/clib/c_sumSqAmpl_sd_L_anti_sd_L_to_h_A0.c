...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_L_to_h_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0006 + 3
      *IT_0000*IT_0007);
    ...
    const ccomplex_t IT_0031 = m_d*e_em*mu_h*IT_0030;
    const ccomplex_t IT_0032 = IT_0007*IT_0031;
    const ccomplex_t IT_0033 = A_b*V_td*conj(V_td);
    ...
    const ccomplex_t IT_0037 = cpow(IT_0002, -1);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0005 + m_d*e_em*mu_h*IT_0003*IT_0007*IT_0030*IT_0037);
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = IT_0036*IT_0039;
    const ccomplex_t IT_0041 = pow(m_h, 2);
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0013 + IT_0041 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0040*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0004;
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0013 + IT_0041 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = 0.5*IT_0032 + 0.5*IT_0035;
    const ccomplex_t IT_0054 = IT_0039*IT_0053;
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0013 + IT_0041 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0004;
    const ccomplex_t IT_0059 = 0.5*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0005;
    const ccomplex_t IT_0061 = 0.5*IT_0060;
    const ccomplex_t IT_0062 = IT_0059*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0013 + IT_0041 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0068 = 1.4142135623731*A_b*V_tb*V_td*IT_0004*conj
      (U_sb_10);
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0013 + IT_0041 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0013 + IT_0041 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0075 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0004
      *U_sb_11;
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_23 + IT_0013 + IT_0041 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0085 = 1.4142135623731*A_b*V_tb*V_td*IT_0004*conj
      (U_sb_11);
    const ccomplex_t IT_0086 = 0.5*IT_0085;
    const ccomplex_t IT_0087 = IT_0084*IT_0086;
    const ccomplex_t IT_0088 = IT_0082*IT_0087;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*IT_0088;
    const ccomplex_t IT_0090 = cpow((-2)*s_13 + IT_0013 + IT_0041 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0093 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0004
      *U_sb_10;
    ...
    const ccomplex_t IT_0098 = (-2)*IT_0029 + IT_0044 + IT_0052 + IT_0057 +
       IT_0065 + IT_0073 + IT_0081 + IT_0089 + IT_0097;
