...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_L_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*e_em*(IT_0002*IT_0006
      *IT_0013*IT_0014*IT_0015 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + 3
    ...
    const ccomplex_t IT_0030 = pow(m_sd_L, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0021 + IT_0030 + -m_sb_2*
    ...
    const ccomplex_t IT_0036 = cpow(IT_0002, 3);
    const ccomplex_t IT_0037 = cpow(IT_0002, 2);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_W*e_em*IT_0035*(IT_0007
      *IT_0036 + 5*IT_0001*((-1)*IT_0001*(IT_0002*IT_0007 + 1./5*IT_0001*IT_0016
      ) + IT_0016*IT_0037));
    const ccomplex_t IT_0039 = (-0.5)*IT_0038;
    const ccomplex_t IT_0040 = IT_0018*IT_0039;
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + (-2)*IT_0030 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = cpow(IT_0001, 2);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_W*e_em*IT_0035*(IT_0016
      *IT_0036 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0016 + 1*IT_0007*(IT_0037 + 
      -1./5*IT_0044)));
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0001 + -m_d*e_em*mu_h*IT_0002*IT_0013*IT_0014*IT_0015);
    const ccomplex_t IT_0052 = (-0.5)*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0002 + m_d*e_em*mu_h*IT_0001*IT_0013*IT_0014*IT_0015);
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = IT_0052*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_13 + IT_0021 + IT_0030 + -m_sd_R*
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0002;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = IT_0060*IT_0062;
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0021 + IT_0030 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0065 = IT_0063*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0021 + IT_0030 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0002;
    const ccomplex_t IT_0073 = 0.5*IT_0072;
    const ccomplex_t IT_0074 = IT_0071*IT_0073;
    const ccomplex_t IT_0075 = cpow((-2)*s_23 + IT_0021 + IT_0030 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = cpow((-2)*s_23 + IT_0021 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_td)*IT_0002*U_sb_11;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = IT_0082*IT_0084;
    const ccomplex_t IT_0086 = cpow((-2)*s_23 + IT_0021 + IT_0030 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_13 + IT_0021 + IT_0030 + -m_sb_1*
    ...
    const ccomplex_t IT_0097 = cpow((-2)*s_23 + IT_0021 + IT_0030 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0105 = IT_0012 + IT_0024 + IT_0033 + -IT_0043 + 
      -IT_0050 + IT_0058 + IT_0066 + IT_0069 + IT_0077 + IT_0080 + IT_0088 +
       IT_0096 + IT_0104;
