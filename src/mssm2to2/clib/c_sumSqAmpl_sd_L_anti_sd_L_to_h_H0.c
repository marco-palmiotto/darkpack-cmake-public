        ...
        )
{
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0026 + IT_0035 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0059*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0001;
    const ccomplex_t IT_0075 = (-0.5)*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0002;
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
    ...
    const ccomplex_t IT_0105 = IT_0012 + -IT_0029 + IT_0038 + IT_0046 + 
      -IT_0054 + IT_0062 + IT_0070 + IT_0073 + IT_0081 + IT_0085 + IT_0088 +
       IT_0096 + IT_0104;
