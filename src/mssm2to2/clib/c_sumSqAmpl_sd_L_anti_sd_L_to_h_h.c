        ...
        )
{
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0015 + IT_0030 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0029*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*IT_0035;
    const ccomplex_t IT_0037 = IT_0004*IT_0005;
    const ccomplex_t IT_0038 = IT_0019 + IT_0037;
    const ccomplex_t IT_0039 = cpow(IT_0007, 3);
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_W*e_em*IT_0038*(IT_0001*
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0015 + IT_0030 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0015 + IT_0030 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0015 + IT_0030 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = cpow((-2)*s_13 + IT_0015 + IT_0030 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0015 + IT_0030 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0015 + IT_0030 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0075 = IT_0071*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0015 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0023*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0010
      *IT_0017*IT_0018*IT_0019 + (-0.166666666666667)*m_W*(IT_0004*IT_0005 + 3
      *IT_0019)*(IT_0001*IT_0011 + -IT_0007*IT_0020));
    const ccomplex_t IT_0079 = -IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*-5)*m_W*e_em*IT_0038*(IT_0001*(
    ...
    const ccomplex_t IT_0083 = cpow((-2)*s_12 + (-2)*IT_0030 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0084 = IT_0082*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*IT_0084;
    const ccomplex_t IT_0086 = IT_0014 + IT_0024 + IT_0033 + IT_0036 + 
      -IT_0045 + IT_0053 + IT_0056 + IT_0064 + IT_0067 + IT_0073 + IT_0075 +
       IT_0077 + -IT_0085;
