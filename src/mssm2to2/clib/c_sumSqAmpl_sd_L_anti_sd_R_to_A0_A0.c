...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_R_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0000
      *U_sb_01;
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0011 + -m_d*e_em*mu_h*IT_0012*IT_0014*IT_0015*IT_0017);
    ...
    const ccomplex_t IT_0025 = -IT_0013;
    const ccomplex_t IT_0026 = cpow(IT_0000, 2);
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_W*e_em*IT_0023*(IT_0015
      *IT_0024 + IT_0025*((IT_0011*IT_0013 + -IT_0000*IT_0015)*IT_0025 + IT_0011
      *IT_0026));
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = IT_0019*IT_0028;
    const ccomplex_t IT_0030 = pow(m_sd_L, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_12 + -IT_0007 + -IT_0030 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0029*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*A_b*V_tb*V_td*IT_0000*conj
      (U_sb_10);
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0000
      *U_sb_00;
    const ccomplex_t IT_0037 = 0.5*IT_0036;
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0006 + IT_0030 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0038*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_13 + IT_0006 + IT_0030 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0005*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0015 + m_d*e_em*mu_h*IT_0011*IT_0012*IT_0014*IT_0017);
    const ccomplex_t IT_0049 = 0.5*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*m_W*e_em*IT_0023*(IT_0011
      *IT_0024 + -IT_0013*(IT_0013*(IT_0000*IT_0011 + IT_0013*IT_0015) + 
      -IT_0015*IT_0026));
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0007 + -IT_0030 + -reg_prop, -1);
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = IT_0010 + -IT_0033 + IT_0041 + IT_0044 +
       IT_0047 + -IT_0055;
