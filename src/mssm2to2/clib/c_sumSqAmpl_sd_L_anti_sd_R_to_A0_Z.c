...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_R_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0002 + -m_d*e_em*mu_h*IT_0005*IT_0007*IT_0009*IT_0010);
    ...
    const ccomplex_t IT_0033 = m_d*e_em*mu_h*IT_0009;
    const ccomplex_t IT_0034 = IT_0007*IT_0033;
    const ccomplex_t IT_0035 = A_b*V_td*conj(V_td);
    ...
    const ccomplex_t IT_0040 = cpow((-2)*s_23 + IT_0014 + IT_0039 + -m_sd_L*
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0013 + IT_0039 + -m_sd_R*
