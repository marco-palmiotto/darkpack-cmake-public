        ...
        )
{
    ...
    const ccomplex_t IT_0021 = 1.4142135623731*A_b*V_tb*V_td*IT_0000*conj
      (U_sb_11);
    ...
    const ccomplex_t IT_0031 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0000
      *U_sb_01;
    ...
    const ccomplex_t IT_0049 = IT_0000*IT_0041*IT_0048;
    ...
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*m_W*e_em*IT_0042*(IT_0044
      *IT_0064 + IT_0065*((IT_0003*IT_0043 + -IT_0000*IT_0044)*IT_0065 + IT_0003
      *IT_0066));
    ...
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*e_em*((-0.166666666666667)
      *m_W*(IT_0038*IT_0039 + 3*IT_0041)*(IT_0003*IT_0043 + -IT_0000*IT_0044) +
       IT_0003*IT_0041*IT_0046*IT_0048*IT_0073);
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*e_em*(m_W*IT_0038*IT_0039*
      (IT_0003*IT_0043 + -IT_0000*IT_0044) + (-3)*IT_0003*IT_0041*IT_0046
      *IT_0048*IT_0073);
