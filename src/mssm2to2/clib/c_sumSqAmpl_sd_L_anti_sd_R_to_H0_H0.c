        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_sb_2*
    ...
    const ccomplex_t IT_0012 = cpow((-2)*s_13 + IT_0006 + IT_0011 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0000 + -m_d*e_em*mu_h*IT_0015*IT_0017*IT_0018*IT_0020);
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*e_em*(m_W*IT_0019*IT_0024*
      (IT_0000*IT_0016 + -IT_0018*IT_0025) + (-3)*IT_0000*IT_0015*IT_0017
      *IT_0020*IT_0026);
    const ccomplex_t IT_0028 = 0.333333333333333*IT_0027;
    const ccomplex_t IT_0029 = IT_0022*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0006 + IT_0011 + -m_sd_R*
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_13 + IT_0006 + IT_0011 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0040*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0018 + m_d*e_em*mu_h*IT_0000*IT_0015*IT_0017*IT_0020);
    const ccomplex_t IT_0048 = 0.5*IT_0047;
    const ccomplex_t IT_0049 = IT_0019*IT_0024;
    const ccomplex_t IT_0050 = IT_0020 + IT_0049;
    const ccomplex_t IT_0051 = cpow(IT_0018, 3);
    const ccomplex_t IT_0052 = cpow(IT_0018, 2);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_W*e_em*IT_0050*(IT_0016
      *IT_0051 + 5*IT_0000*((-1)*IT_0000*(IT_0016*IT_0018 + 1./5*IT_0000*IT_0025
      ) + IT_0025*IT_0052));
    ...
    const ccomplex_t IT_0059 = cpow(IT_0000, 2);
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*m_W*e_em*IT_0050*(IT_0025
      *IT_0051 + -IT_0000*(IT_0000*IT_0018*IT_0025 + IT_0016*(IT_0052 + -IT_0059
      )));
    const ccomplex_t IT_0061 = (-1.5)*IT_0060;
    const ccomplex_t IT_0062 = IT_0022*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_12 + -IT_0007 + -IT_0011 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0062*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0020 +
       1./3*IT_0019*IT_0024)*(IT_0000*IT_0016 + -IT_0018*IT_0025) + IT_0000
      *IT_0015*IT_0017*IT_0020*IT_0026);
    const ccomplex_t IT_0067 = -IT_0066;
    const ccomplex_t IT_0068 = IT_0022*IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_13 + IT_0006 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    const ccomplex_t IT_0070 = IT_0068*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0068*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = IT_0010 + IT_0014 + IT_0032 + IT_0035 + IT_0043
       + IT_0046 + -IT_0058 + -IT_0065 + IT_0071 + IT_0074;
