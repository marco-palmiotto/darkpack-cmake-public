...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_R_to_Z_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0008 + m_d*e_em*mu_h*IT_0001*IT_0014*IT_0022*IT_0023);
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0001 + -m_d*e_em*mu_h*IT_0008*IT_0014*IT_0022*IT_0023);
    ...
    return create_ccomplex_return(6*IT_0047*conj(IT_0047)*(1 + 0.5*IT_0050));
}
