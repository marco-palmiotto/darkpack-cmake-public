...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_R_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = m_c*e_em*IT_0001*IT_0002;
    const ccomplex_t IT_0021 = (-0.5)*IT_0020;
    const ccomplex_t IT_0022 = cpow(IT_0010, -1);
    const ccomplex_t IT_0023 = IT_0001*IT_0005*IT_0022;
    const ccomplex_t IT_0024 = IT_0003*IT_0023;
    const ccomplex_t IT_0025 = IT_0006*IT_0010;
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + IT_0029 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm2)*IT_0001;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*conj
      (V_cd)*e_em*IT_0001*IT_0002*IT_0022;
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0016 + IT_0034 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*V_cd*e_em*conj(U_Wm1)*IT_0001;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*conj
      (V_cd)*e_em*IT_0001*IT_0002*IT_0022;
    const ccomplex_t IT_0044 = (-0.5)*IT_0043;
    const ccomplex_t IT_0045 = IT_0042*IT_0044;
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0016 + IT_0034 + -m_C_1*
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u1
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = IT_0044*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0056 = IT_0046*IT_0054*IT_0055;
    const ccomplex_t IT_0057 = m_c*IT_0048;
    const ccomplex_t IT_0058 = m_c*IT_0041;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_c*V_cd*V_u2
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0061 = 0.5*IT_0060;
    const ccomplex_t IT_0062 = IT_0037*IT_0061;
    const ccomplex_t IT_0063 = IT_0039*IT_0059*IT_0062;
    const ccomplex_t IT_0064 = -IT_0056 + IT_0057 + IT_0058 + -IT_0063;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0066 + m_d*e_em*mu_h*IT_0001*IT_0002*IT_0022*IT_0067);
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*-1)*(m_d*e_em*mu_h*IT_0001
      *IT_0002*IT_0022*IT_0066 + (-1.4142135623731)*A_b*V_td*conj(V_td)*IT_0067);
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + m_H0*
