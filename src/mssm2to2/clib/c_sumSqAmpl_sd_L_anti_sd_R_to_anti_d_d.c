        ...
        )
{
    ...
    const ccomplex_t IT_0093 = m_d*IT_0092;
    ...
    const ccomplex_t IT_0106 = m_d*IT_0022;
    const ccomplex_t IT_0107 = m_d*IT_0036;
    const ccomplex_t IT_0108 = m_d*IT_0050;
    const ccomplex_t IT_0109 = m_d*IT_0064;
    ...
    const ccomplex_t IT_0118 = IT_0020*IT_0095*IT_0117;
    ...
    const ccomplex_t IT_0125 = m_d*IT_0071;
    const ccomplex_t IT_0126 = m_d*IT_0077;
    const ccomplex_t IT_0127 = m_d*IT_0083;
    const ccomplex_t IT_0128 = m_d*IT_0089;
    const ccomplex_t IT_0129 = 0.166666666666667*IT_0116 + -IT_0118 + -IT_0120
    ...
    const ccomplex_t IT_0133 = (0 + _Complex_I*1)*m_d*e_em*IT_0006*IT_0012
      *IT_0014*IT_0132;
    const ccomplex_t IT_0134 = 0.5*IT_0133;
    const ccomplex_t IT_0135 = cos(alpha);
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0132 + m_d*e_em*mu_h*IT_0006*IT_0012*IT_0014*IT_0135);
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = IT_0134*IT_0137;
    const ccomplex_t IT_0139 = pow(m_sd_L, 2);
    ...
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*m_d*e_em*IT_0006*IT_0012
      *IT_0014*IT_0135;
    const ccomplex_t IT_0144 = (-0.5)*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*-1)*(m_d*e_em*mu_h*IT_0006
      *IT_0012*IT_0014*IT_0132 + (-1.4142135623731)*A_b*V_td*conj(V_td)*IT_0135);
    ...
    const ccomplex_t IT_0161 = m_d*e_em*IT_0006*IT_0012*IT_0014*IT_0160;
    const ccomplex_t IT_0162 = (-0.5)*IT_0161;
    const ccomplex_t IT_0163 = m_d*e_em*mu_h*IT_0012;
    const ccomplex_t IT_0164 = IT_0006*IT_0163;
    const ccomplex_t IT_0165 = A_b*V_td*conj(V_td);
    ...
    const ccomplex_t IT_0173 = m_d*e_em*IT_0006*IT_0012;
    ...
    const ccomplex_t IT_0193 = (-6)*IT_0155*(s_34*(IT_0129 + -conj(IT_0129) +
       3*IT_0155) + 0.166666666666667*(IT_0185 + -conj(IT_0185))*IT_0188 +
       0.166666666666667*(IT_0151 + -conj(IT_0151))*IT_0190 + -IT_0018*(IT_0110 
      + IT_0192));
    ...
    const ccomplex_t IT_0209 = ((conj(IT_0065) + conj(IT_0090))*IT_0093 + 
      ...
      *IT_0153 + conj(IT_0090)*(IT_0154*IT_0156 + IT_0153*IT_0157) + conj
      ...
      ) + IT_0193 + (-6)*IT_0185*((-0.166666666666667)*(36*IT_0018 + IT_0159)
      *conj(IT_0185) + (conj(IT_0065) + -conj(IT_0090))*IT_0195 + -(conj(IT_0129
      ) + IT_0192)*IT_0196) + IT_0065*(18*conj(IT_0110)*IT_0154 + ((-18)*conj
      (IT_0129) + IT_0156)*IT_0157 + (-18)*conj(IT_0090)*IT_0197 + conj(IT_0065)
      *IT_0202 + IT_0195*IT_0203 + IT_0205) + 6*IT_0090*(0.166666666666667
      *IT_0154*(18*conj(IT_0129) + IT_0158) + conj(IT_0185)*IT_0195 +
       0.166666666666667*conj(IT_0090)*IT_0202 + 0.166666666666667*IT_0205 +
       0.166666666666667*IT_0157*IT_0206 + 0.166666666666667*IT_0197*IT_0207) +
       IT_0110*(18*conj(IT_0065)*IT_0154 + conj(IT_0110)*IT_0187 + IT_0196
      *IT_0203 + IT_0208) + IT_0129*(18*conj(IT_0090)*IT_0154 + conj(IT_0129)
      *IT_0187 + 6*conj(IT_0185)*IT_0196 + IT_0018*IT_0206 + IT_0157*IT_0207 +
       IT_0208);
