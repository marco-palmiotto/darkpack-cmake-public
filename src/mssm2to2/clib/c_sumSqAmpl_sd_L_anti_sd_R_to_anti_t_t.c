...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_R_to_anti_t_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm1)*IT_0002;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*conj
      (V_td)*e_em*IT_0000*IT_0002*IT_0007;
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*V_td*e_em*conj(U_Wm2)*IT_0002;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*conj
      (V_td)*e_em*IT_0000*IT_0002*IT_0007;
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_t*V_td*V_u1
