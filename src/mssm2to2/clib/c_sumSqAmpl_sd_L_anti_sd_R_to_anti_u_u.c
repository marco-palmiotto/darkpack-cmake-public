...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_sd_R_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = m_u*e_em*IT_0000*IT_0002;
    ...
    const ccomplex_t IT_0027 = m_u*e_em*IT_0000*IT_0002*IT_0006*IT_0026;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm1)*IT_0002;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*V_ud*e_em*conj(U_Wm2)*IT_0002;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0000*IT_0002*IT_0007;
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0000*IT_0002*IT_0026;
    ...
    const ccomplex_t IT_0062 = m_u*IT_0041;
    const ccomplex_t IT_0063 = m_u*IT_0048;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0066 + m_d*e_em*mu_h*IT_0000*IT_0002*IT_0007*IT_0067);
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0002
      *IT_0026*IT_0067;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*-1)*(m_d*e_em*mu_h*IT_0000
      *IT_0002*IT_0007*IT_0066 + (-1.4142135623731)*A_b*V_td*conj(V_td)*IT_0067);
    const ccomplex_t IT_0077 = (-0.5)*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0002
      *IT_0026*IT_0066;
    ...
    const ccomplex_t IT_0089 = m_u*s_13;
