        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*IT_0005*IT_0010*
      (IT_0002*IT_0004 + -IT_0000*IT_0011) + (-3)*IT_0001*IT_0003*IT_0004
      *IT_0006*IT_0012);
    ...
    const ccomplex_t IT_0018 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0019 = IT_0015*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0004 + -m_d*e_em*mu_h*IT_0000*IT_0001*IT_0003*IT_0006);
    const ccomplex_t IT_0022 = (-0.5)*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0006 +
       1./3*IT_0005*IT_0010)*(IT_0000*IT_0002 + IT_0004*IT_0011) + IT_0000
      *IT_0001*IT_0003*IT_0006*IT_0012);
    const ccomplex_t IT_0024 = IT_0022*IT_0023;
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0016 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*(m_W*IT_0005*IT_0010*
      (IT_0000*IT_0002 + IT_0004*IT_0011) + (-3)*IT_0000*IT_0001*IT_0003*IT_0006
      *IT_0012);
    const ccomplex_t IT_0029 = (-0.333333333333333)*IT_0028;
    const ccomplex_t IT_0030 = IT_0022*IT_0029;
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0016 + (0 + _Complex_I*1)
      *m_sd_R*Gamma_dr + reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_sb_1*
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_sb_2*
    ...
    const ccomplex_t IT_0052 = cpow(IT_0000, 3);
    const ccomplex_t IT_0053 = cpow(IT_0000, 2);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*m_W*e_em*IT_0051*(IT_0002
      *IT_0052 + 5*IT_0004*((-1)*IT_0004*(IT_0000*IT_0002 + 1./5*IT_0004*IT_0011
      ) + IT_0011*IT_0053));
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = IT_0022*IT_0055;
    const ccomplex_t IT_0057 = pow(m_sd_R, 2);
    const ccomplex_t IT_0058 = cpow((-2)*s_12 + -IT_0017 + -IT_0057 + m_H0*
    ...
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*m_W*e_em*IT_0051*(IT_0011
      *IT_0052 + (-5)*IT_0004*(IT_0000*IT_0004*IT_0011 + 1*IT_0002*(IT_0053 + 
      -1./5*IT_0061)));
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0017 + -IT_0057 + -reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0006 +
       1./3*IT_0005*IT_0010)*(IT_0002*IT_0004 + -IT_0000*IT_0011) + IT_0001
      *IT_0003*IT_0004*IT_0006*IT_0012);
    const ccomplex_t IT_0069 = -IT_0068;
    const ccomplex_t IT_0070 = IT_0008*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0016 + IT_0057 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0016 + IT_0057 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0004*conj(U_sb_10);
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
    ...
    const ccomplex_t IT_0087 = cpow((-2)*s_23 + IT_0016 + IT_0057 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0088 = IT_0086*IT_0087;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*IT_0088;
    const ccomplex_t IT_0090 = IT_0020 + IT_0027 + IT_0033 + IT_0041 + IT_0049
       + -IT_0060 + -IT_0067 + IT_0073 + IT_0081 + IT_0089;
