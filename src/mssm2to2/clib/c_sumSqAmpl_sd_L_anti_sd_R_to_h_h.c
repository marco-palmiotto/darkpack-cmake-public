        ...
        )
{
    ...
    const ccomplex_t IT_0012 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0000 + m_d*e_em*mu_h*IT_0013*IT_0015*IT_0016*IT_0018);
    ...
    const ccomplex_t IT_0025 = cpow(IT_0000, 3);
    const ccomplex_t IT_0026 = sin(beta);
    const ccomplex_t IT_0027 = cpow(IT_0000, 2);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_W*e_em*IT_0024*(IT_0014
      *IT_0025 + -IT_0016*(IT_0016*(IT_0000*IT_0014 + IT_0016*IT_0026) + 
      -IT_0026*IT_0027));
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0018 +
       1./3*IT_0017*IT_0022)*(IT_0000*IT_0014 + IT_0016*IT_0026) + IT_0000
      *IT_0013*IT_0015*IT_0018*IT_0033);
    const ccomplex_t IT_0035 = IT_0020*IT_0034;
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0006 + IT_0011 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0006 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0035*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*(m_W*IT_0017*IT_0022*
      (IT_0000*IT_0014 + IT_0016*IT_0026) + (-3)*IT_0000*IT_0013*IT_0015*IT_0018
      *IT_0033);
    const ccomplex_t IT_0043 = (-0.333333333333333)*IT_0042;
    const ccomplex_t IT_0044 = IT_0020*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0006 + (0 + _Complex_I*1)
      *m_sd_R*Gamma_dr + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0044*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0044*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_sb_1*
    ...
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0006 + IT_0011 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0005*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0007 + -IT_0011 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0016 + -m_d*e_em*mu_h*IT_0000*IT_0013*IT_0015*IT_0018);
    const ccomplex_t IT_0064 = (-0.5)*IT_0063;
    const ccomplex_t IT_0065 = cpow(IT_0016, 2);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_W*e_em*IT_0024*(IT_0025
      *IT_0026 + (-5)*IT_0016*(IT_0000*IT_0016*IT_0026 + 1*IT_0014*(IT_0027 + 
      -1./5*IT_0065)));
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = IT_0064*IT_0067;
    const ccomplex_t IT_0069 = IT_0062*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0006 + IT_0011 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0056*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = IT_0010 + -IT_0032 + IT_0038 + IT_0041 +
       IT_0047 + IT_0050 + IT_0058 + IT_0061 + -IT_0070 + IT_0073;
