...
ccomplex_return_t c_sumSqAmpl_sd_L_anti_st_1_to_d_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = conj(N_B1)*e_em*conj(U_st_10);
    ...
    const ccomplex_t IT_0034 = m_t*conj(N_u1)*e_em*IT_0021*conj(U_st_00);
    ...
    const ccomplex_t IT_0045 = conj(N_B2)*e_em*conj(U_st_10);
    const ccomplex_t IT_0046 = IT_0027*IT_0045;
    const ccomplex_t IT_0047 = 1.4142135623731*IT_0046;
    const ccomplex_t IT_0048 = m_t*conj(N_u2)*e_em*IT_0021*conj(U_st_00);
    ...
    const ccomplex_t IT_0059 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0060 = IT_0027*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = m_t*conj(N_u3)*e_em*IT_0021*conj(U_st_00);
    ...
    const ccomplex_t IT_0073 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0074 = IT_0027*IT_0073;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = m_t*conj(N_u4)*e_em*IT_0021*conj(U_st_00);
    ...
    const ccomplex_t IT_0100 = m_t*N_u1*e_em*IT_0021*conj(U_st_10);
    ...
    const ccomplex_t IT_0138 = N_B3*e_em*conj(U_st_00);
    ...
    const ccomplex_t IT_0144 = m_t*N_u3*e_em*IT_0021*conj(U_st_10);
    ...
    const ccomplex_t IT_0214 = A_t*IT_0031*conj(U_st_10) + (-0.707106781186548
      )*e_em*IT_0001*((IT_0021*(IT_0015 + -IT_0211) + -m_W*(IT_0212 + -IT_0213))
      *conj(U_st_00) + m_t*mu_h*IT_0021*IT_0022*IT_0032*conj(U_st_10));
    ...
    const ccomplex_t IT_0227 = A_t*IT_0022*conj(U_st_10) + (-1.4142135623731)
      *e_em*IT_0001*(m_W*IT_0022*IT_0031*conj(U_st_00) + (-0.5)*IT_0021*(IT_0015
      *IT_0023*IT_0031*conj(U_st_00) + m_t*(m_t*IT_0022*IT_0032*conj(U_st_00) +
       mu_h*conj(U_st_10))));
