        ...
        )
{
    ...
    const ccomplex_t IT_0018 = m_t*conj(N_u1)*e_em*IT_0003*conj(U_st_01);
    const ccomplex_t IT_0019 = IT_0017*IT_0018;
    const ccomplex_t IT_0020 = 1.4142135623731*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*(IT_0014 + (-0.75)*IT_0020);
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0028 = (-0.5)*IT_0027;
    const ccomplex_t IT_0029 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0030 = IT_0011*IT_0029;
    const ccomplex_t IT_0031 = 1.4142135623731*IT_0030;
    const ccomplex_t IT_0032 = m_t*conj(N_u2)*e_em*IT_0003*conj(U_st_01);
    const ccomplex_t IT_0033 = IT_0017*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*(IT_0031 + (-0.75)*IT_0034);
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0042 = (-0.5)*IT_0041;
    const ccomplex_t IT_0043 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0044 = IT_0011*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = m_t*conj(N_u3)*e_em*IT_0003*conj(U_st_01);
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0056 = (-0.5)*IT_0055;
    const ccomplex_t IT_0057 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0058 = IT_0011*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_t*conj(N_u4)*e_em*IT_0003*conj(U_st_01);
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*V_td*e_em
      *IT_0007*conj(U_st_01);
    const ccomplex_t IT_0077 = -IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
      *e_em*IT_0007;
    const ccomplex_t IT_0079 = 0.5*IT_0078;
    const ccomplex_t IT_0080 = pow(m_st_2, 2);
    ...
    const ccomplex_t IT_0100 = m_t*N_u1*e_em*IT_0003*conj(U_st_11);
    ...
    const ccomplex_t IT_0122 = m_t*N_u2*e_em*IT_0003*conj(U_st_11);
    ...
    const ccomplex_t IT_0144 = m_t*N_u3*e_em*IT_0003*conj(U_st_11);
    ...
    const ccomplex_t IT_0166 = m_t*N_u4*e_em*IT_0003*conj(U_st_11);
    ...
    const ccomplex_t IT_0181 = m_d*IT_0107;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0183 = IT_0009*IT_0104;
    const ccomplex_t IT_0184 = IT_0002*IT_0182*IT_0183;
    const ccomplex_t IT_0185 = IT_0056*IT_0170;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0187 = IT_0054*IT_0185*IT_0186;
    const ccomplex_t IT_0188 = m_d*IT_0151;
    const ccomplex_t IT_0189 = m_d*IT_0173;
    const ccomplex_t IT_0190 = m_d*IT_0075;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0192 = IT_0028*IT_0126;
    const ccomplex_t IT_0193 = IT_0026*IT_0191*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0195 = IT_0042*IT_0148;
    const ccomplex_t IT_0196 = IT_0040*IT_0194*IT_0195;
    const ccomplex_t IT_0197 = m_d*IT_0129;
    const ccomplex_t IT_0198 = IT_0181 + -IT_0184 + -IT_0187 + IT_0188 +
       IT_0189 + (-0.166666666666667)*IT_0190 + -IT_0193 + -IT_0196 + IT_0197;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_td)
      *e_em*IT_0003*IT_0007;
    const ccomplex_t IT_0200 = (-0.5)*IT_0199;
    const ccomplex_t IT_0201 = pow(m_t, 2);
    const ccomplex_t IT_0202 = cpow(IT_0004, 2);
    const ccomplex_t IT_0203 = cpow(IT_0015, 2);
    const ccomplex_t IT_0204 = A_t*IT_0015*conj(U_st_11) + (-0.707106781186548
      )*e_em*IT_0007*((IT_0003*(IT_0000 + -IT_0201) + -m_W*(IT_0202 + -IT_0203))
      *conj(U_st_01) + m_t*mu_h*IT_0003*IT_0004*IT_0016*conj(U_st_11));
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*V_td*IT_0204;
    const ccomplex_t IT_0206 = IT_0200*IT_0205;
    const ccomplex_t IT_0207 = pow(m_W, 2);
    const ccomplex_t IT_0208 = cpow((-2)*s_12 + -IT_0001 + -IT_0080 + IT_0207 
      + -reg_prop, -1);
    const ccomplex_t IT_0209 = IT_0206*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*IT_0209;
    const ccomplex_t IT_0211 = A_t*IT_0004*conj(U_st_11) + (-1.4142135623731)
      *e_em*IT_0007*(m_W*IT_0004*IT_0015*conj(U_st_01) + (-0.5)*IT_0003*(IT_0000
      *IT_0005*IT_0015*conj(U_st_01) + m_t*(m_t*IT_0004*IT_0016*conj(U_st_01) +
       mu_h*conj(U_st_11))));
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*V_td*IT_0211;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_td)
      *e_em*IT_0003*IT_0005*IT_0007*IT_0015;
    const ccomplex_t IT_0214 = 0.5*IT_0213;
    const ccomplex_t IT_0215 = IT_0212*IT_0214;
    const ccomplex_t IT_0216 = cpow((-2)*s_12 + -IT_0001 + -IT_0080 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0217 = IT_0215*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*IT_0217;
    const ccomplex_t IT_0219 = (-0.5)*IT_0076;
    const ccomplex_t IT_0220 = m_d*IT_0219;
    const ccomplex_t IT_0221 = m_d*IT_0077;
    const ccomplex_t IT_0222 = -IT_0221;
    const ccomplex_t IT_0223 = IT_0220 + IT_0222;
    const ccomplex_t IT_0224 = IT_0083*IT_0223;
    const ccomplex_t IT_0225 = 0.5*IT_0190 + -IT_0210 + -IT_0218 + -IT_0224;
    const ccomplex_t IT_0226 = IT_0022*IT_0093;
    const ccomplex_t IT_0227 = IT_0002*IT_0182*IT_0226;
    const ccomplex_t IT_0228 = m_d*IT_0025;
    const ccomplex_t IT_0229 = IT_0064*IT_0159;
    const ccomplex_t IT_0230 = IT_0054*IT_0186*IT_0229;
    const ccomplex_t IT_0231 = m_d*IT_0039;
    const ccomplex_t IT_0232 = m_d*IT_0067;
    const ccomplex_t IT_0233 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0234 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_11);
    const ccomplex_t IT_0235 = IT_0071*IT_0234;
    const ccomplex_t IT_0236 = IT_0070*IT_0233*IT_0235;
    const ccomplex_t IT_0237 = IT_0036*IT_0115;
    const ccomplex_t IT_0238 = IT_0026*IT_0191*IT_0237;
    const ccomplex_t IT_0239 = IT_0050*IT_0137;
    const ccomplex_t IT_0240 = IT_0040*IT_0194*IT_0239;
    const ccomplex_t IT_0241 = m_d*IT_0053;
    const ccomplex_t IT_0242 = -IT_0227 + IT_0228 + -IT_0230 + IT_0231 +
       IT_0232 + 0.166666666666667*IT_0236 + -IT_0238 + -IT_0240 + IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
      *e_em*IT_0003*IT_0004*IT_0007*IT_0016;
    const ccomplex_t IT_0244 = 0.5*IT_0243;
    const ccomplex_t IT_0245 = IT_0212*IT_0244;
    const ccomplex_t IT_0246 = IT_0216*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_td)
      *e_em*IT_0003*IT_0007;
    ...
    const ccomplex_t IT_0253 = m_t*IT_0219;
    const ccomplex_t IT_0254 = m_t*IT_0077;
    const ccomplex_t IT_0255 = -IT_0254;
    const ccomplex_t IT_0256 = IT_0253 + IT_0255;
    const ccomplex_t IT_0257 = IT_0083*IT_0256;
    const ccomplex_t IT_0258 = (-0.5)*IT_0236 + -IT_0247 + -IT_0252 + IT_0257;
    const ccomplex_t IT_0259 = 6*s_34;
    const ccomplex_t IT_0260 = 18*s_34;
    const ccomplex_t IT_0261 = m_t*s_13;
    const ccomplex_t IT_0262 = (-6)*conj(IT_0258);
    const ccomplex_t IT_0263 = (-18)*conj(IT_0242);
    const ccomplex_t IT_0264 = IT_0262 + IT_0263;
    const ccomplex_t IT_0265 = (-18)*conj(IT_0198);
    const ccomplex_t IT_0266 = (-6)*conj(IT_0225);
    const ccomplex_t IT_0267 = IT_0265 + IT_0266;
    const ccomplex_t IT_0268 = (-6)*IT_0225;
    const ccomplex_t IT_0269 = conj(IT_0085)*(IT_0242 + 3*IT_0258) + (
      -0.166666666666667)*conj(IT_0174)*((-18)*IT_0242 + (-6)*IT_0258) + IT_0085
      *(conj(IT_0242) + 3*conj(IT_0258)) + (-0.166666666666667)*IT_0174*IT_0264 
      + (-0.166666666666667)*IT_0068*IT_0267 + (-0.166666666666667)*conj(IT_0068
      )*((-18)*IT_0198 + IT_0268);
    const ccomplex_t IT_0270 = 12*IT_0178;
    const ccomplex_t IT_0271 = (-6)*IT_0176;
    const ccomplex_t IT_0272 = m_d*s_14;
    const ccomplex_t IT_0273 = 3*conj(IT_0225);
    const ccomplex_t IT_0274 = conj(IT_0085)*(IT_0198 + 3*IT_0225) + 3*conj
      (IT_0174)*(IT_0198 + 0.333333333333333*IT_0225) + 3*IT_0174*(conj(IT_0198)
       + 0.333333333333333*conj(IT_0225)) + 3*conj(IT_0068)*(IT_0242 +
       0.333333333333333*IT_0258) + 3*IT_0068*(conj(IT_0242) + 0.333333333333333
      *conj(IT_0258)) + IT_0085*(conj(IT_0198) + IT_0273);
    const ccomplex_t IT_0275 = m_d*m_t;
    const ccomplex_t IT_0276 = (-6)*(conj(IT_0068)*(IT_0085 + 3*IT_0174) +
       IT_0068*(conj(IT_0085) + 3*conj(IT_0174)))*IT_0175 + (IT_0068*conj
      (IT_0068) + IT_0085*conj(IT_0085) + IT_0174*conj(IT_0174))*IT_0180 + (conj
      (IT_0198)*IT_0225 + IT_0198*conj(IT_0225) + conj(IT_0242)*IT_0258 +
       IT_0242*conj(IT_0258))*IT_0259 + (IT_0198*conj(IT_0198) + IT_0225*conj
      (IT_0225) + IT_0242*conj(IT_0242) + IT_0258*conj(IT_0258))*IT_0260 + (-6)
      *IT_0261*IT_0269 + (conj(IT_0085)*IT_0174 + IT_0085*conj(IT_0174))*
      (IT_0270 + IT_0271) + 6*IT_0272*IT_0274 + ((-18)*IT_0225*conj(IT_0258) +
       IT_0198*IT_0264 + IT_0242*IT_0267 + conj(IT_0242)*IT_0268 + (-6)*IT_0258*
      (conj(IT_0198) + IT_0273))*IT_0275;
