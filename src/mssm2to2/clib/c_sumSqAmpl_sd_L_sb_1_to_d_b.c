        ...
        )
{
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0000 + IT_0009 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0017 = cos(theta_W);
    const ccomplex_t IT_0018 = cpow(IT_0017, -1);
    const ccomplex_t IT_0019 = conj(N_B1)*e_em;
    ...
    const ccomplex_t IT_0036 = m_b*N_d1*e_em*IT_0035*U_sb_00;
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0000 + IT_0009 + -m_N_3*
    ...
    const ccomplex_t IT_0073 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0074 = IT_0018*IT_0073;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = m_b*N_d3*e_em*IT_0035*U_sb_00;
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0000 + IT_0009 + -m_N_4*
    ...
    const ccomplex_t IT_0093 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0094 = IT_0018*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = m_b*N_d4*e_em*IT_0035*U_sb_00;
    ...
    const ccomplex_t IT_0125 = IT_0084*IT_0124;
    ...
    const ccomplex_t IT_0132 = conj(N_W2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0144 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0023*IT_0033*IT_0035;
    const ccomplex_t IT_0145 = (-0.5)*IT_0144;
    const ccomplex_t IT_0146 = m_b*conj(N_d1)*e_em*IT_0035*U_sb_10;
    const ccomplex_t IT_0147 = IT_0034*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = conj(N_W1)*e_em*U_sb_00;
    const ccomplex_t IT_0150 = IT_0023*IT_0149;
    const ccomplex_t IT_0151 = 1.4142135623731*IT_0150;
    const ccomplex_t IT_0152 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0179 = m_b*m_d;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0181 = IT_0028*IT_0157;
    const ccomplex_t IT_0182 = IT_0016*IT_0180*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0184 = IT_0092*IT_0123;
    const ccomplex_t IT_0185 = IT_0084*IT_0183*IT_0184;
    const ccomplex_t IT_0186 = -IT_0182 + -IT_0185;
    const ccomplex_t IT_0187 = m_d*IT_0013;
    const ccomplex_t IT_0188 = (-0.5)*IT_0187;
    const ccomplex_t IT_0189 = 6*IT_0188;
    const ccomplex_t IT_0190 = IT_0040*IT_0145;
    const ccomplex_t IT_0191 = IT_0016*IT_0180*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0193 = IT_0080*IT_0162;
    const ccomplex_t IT_0194 = IT_0064*IT_0192*IT_0193;
    const ccomplex_t IT_0195 = IT_0100*IT_0111;
    const ccomplex_t IT_0196 = IT_0084*IT_0183*IT_0195;
    const ccomplex_t IT_0197 = m_d*IT_0043;
    const ccomplex_t IT_0198 = m_d*IT_0063;
    const ccomplex_t IT_0199 = m_d*IT_0083;
    const ccomplex_t IT_0200 = m_d*IT_0103;
    const ccomplex_t IT_0201 = 0.166666666666667*IT_0187 + IT_0191 + IT_0194 +
       IT_0196 + -IT_0197 + -IT_0198 + -IT_0199 + -IT_0200;
    const ccomplex_t IT_0202 = 18*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0204 = IT_0060*IT_0128;
    const ccomplex_t IT_0205 = IT_0044*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = -IT_0205;
    const ccomplex_t IT_0207 = (-18)*IT_0206;
    const ccomplex_t IT_0208 = IT_0189 + IT_0202 + IT_0207;
    const ccomplex_t IT_0209 = 6*conj(IT_0188);
    const ccomplex_t IT_0210 = 18*conj(IT_0201);
    const ccomplex_t IT_0211 = (-18)*conj(IT_0206);
    const ccomplex_t IT_0212 = IT_0209 + IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_00;
    ...
    const ccomplex_t IT_0217 = m_sG*IT_0216;
    const ccomplex_t IT_0218 = 0.5*IT_0217;
    const ccomplex_t IT_0219 = 6*IT_0206;
    const ccomplex_t IT_0220 = (-18)*IT_0188;
    const ccomplex_t IT_0221 = (-6)*IT_0201;
    const ccomplex_t IT_0222 = IT_0219 + IT_0220 + IT_0221;
    const ccomplex_t IT_0223 = 6*conj(IT_0206);
    const ccomplex_t IT_0224 = (-18)*conj(IT_0188);
    const ccomplex_t IT_0225 = (-6)*conj(IT_0201);
    const ccomplex_t IT_0226 = IT_0223 + IT_0224 + IT_0225;
    const ccomplex_t IT_0227 = IT_0052*IT_0140;
    const ccomplex_t IT_0228 = IT_0044*IT_0203*IT_0227;
    const ccomplex_t IT_0229 = IT_0072*IT_0174;
    const ccomplex_t IT_0230 = IT_0064*IT_0192*IT_0229;
    const ccomplex_t IT_0231 = m_d*IT_0177;
    const ccomplex_t IT_0232 = m_d*IT_0126;
    const ccomplex_t IT_0233 = (-0.166666666666667)*IT_0217 + IT_0228 +
       IT_0230 + -IT_0231 + -IT_0232;
    const ccomplex_t IT_0234 = IT_0143 + IT_0160;
    const ccomplex_t IT_0235 = m_d*IT_0234;
    const ccomplex_t IT_0236 = -IT_0235;
    const ccomplex_t IT_0237 = conj(IT_0233) + conj(IT_0236);
    const ccomplex_t IT_0238 = 18*IT_0206;
    const ccomplex_t IT_0239 = (-18)*IT_0201;
    const ccomplex_t IT_0240 = (-6)*IT_0188;
    const ccomplex_t IT_0241 = IT_0238 + IT_0239 + IT_0240;
    const ccomplex_t IT_0242 = IT_0233 + IT_0236;
    const ccomplex_t IT_0243 = 18*conj(IT_0206);
    const ccomplex_t IT_0244 = (-18)*conj(IT_0201);
    const ccomplex_t IT_0245 = (-6)*conj(IT_0188);
    ...
    const ccomplex_t IT_0251 = m_b*s_13;
    const ccomplex_t IT_0252 = 6*IT_0218;
    const ccomplex_t IT_0253 = 18*IT_0233;
    const ccomplex_t IT_0254 = 18*IT_0236;
    const ccomplex_t IT_0255 = (-18)*IT_0186;
    const ccomplex_t IT_0256 = 6*conj(IT_0218);
    const ccomplex_t IT_0257 = 18*conj(IT_0233);
    const ccomplex_t IT_0258 = 18*conj(IT_0236);
    const ccomplex_t IT_0259 = (-18)*conj(IT_0186);
    const ccomplex_t IT_0260 = conj(IT_0178)*IT_0208 + IT_0178*IT_0212 + (-6)
      *conj(IT_0014)*(IT_0186 + (-3)*IT_0218 + -IT_0233 + -IT_0236) + (-6)
      *IT_0014*(conj(IT_0186) + (-3)*conj(IT_0218) + -conj(IT_0233) + -conj
      (IT_0236)) + IT_0106*(IT_0252 + IT_0253 + IT_0254 + IT_0255) + IT_0105*
      (IT_0256 + IT_0257 + IT_0258 + IT_0259);
    const ccomplex_t IT_0261 = (-6)*s_34;
    const ccomplex_t IT_0262 = m_d*s_14;
    const ccomplex_t IT_0263 = (-0.166666666666667)*IT_0106;
    const ccomplex_t IT_0264 = (-0.166666666666667)*conj(IT_0014)*IT_0222 + (
      -0.166666666666667)*IT_0014*IT_0226 + (-3)*conj(IT_0178)*(IT_0186 + -1./3
      *IT_0218 + -IT_0233 + -IT_0236) + (-3)*IT_0178*(conj(IT_0186) + -1./3*conj
      (IT_0218) + -conj(IT_0233) + -conj(IT_0236)) + (-0.166666666666667)
      *IT_0105*IT_0246 + IT_0241*IT_0263;
    const ccomplex_t IT_0265 = m_b*m_d*IT_0000;
    const ccomplex_t IT_0266 = (-18)*conj(IT_0178);
    const ccomplex_t IT_0267 = (-18)*IT_0178;
    const ccomplex_t IT_0268 = IT_0005*(conj(IT_0014)*IT_0105 + IT_0014
      *IT_0106) + IT_0109*(IT_0014*conj(IT_0014) + IT_0105*IT_0106 + IT_0178
      *conj(IT_0178)) + IT_0179*(conj(IT_0186)*IT_0208 + IT_0186*IT_0212 + conj
      (IT_0218)*IT_0222 + IT_0218*IT_0226 + IT_0237*IT_0241 + IT_0242*IT_0246) +
       (conj(IT_0188)*IT_0201 + IT_0188*conj(IT_0201) + IT_0218*IT_0237 + conj
      (IT_0218)*IT_0242)*IT_0247 + (IT_0186*conj(IT_0186) + IT_0188*conj(IT_0188
      ) + IT_0201*conj(IT_0201) + IT_0206*conj(IT_0206) + IT_0218*conj(IT_0218) 
      + IT_0236*IT_0237)*IT_0248 + IT_0237*IT_0249 + (conj(IT_0201)*IT_0206 +
       IT_0201*conj(IT_0206) + IT_0186*IT_0237 + conj(IT_0186)*IT_0242)*IT_0250 
      + IT_0251*IT_0260 + (conj(IT_0188)*IT_0206 + IT_0188*conj(IT_0206) + conj
      (IT_0186)*IT_0218 + IT_0186*conj(IT_0218))*IT_0261 + (-6)*IT_0262*IT_0264 
      + (-6)*IT_0265*(conj(IT_0014)*IT_0178 + IT_0014*conj(IT_0178) + (
      -0.166666666666667)*IT_0105*IT_0266 + IT_0263*IT_0267);
