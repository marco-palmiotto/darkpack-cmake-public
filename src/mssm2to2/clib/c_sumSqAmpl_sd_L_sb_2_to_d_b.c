        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0013 = IT_0011*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = conj(N_W3)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0019 = m_b*conj(N_d3)*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_d*N_d1*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0031 = IT_0011*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W1)*e_em*U_sb_01;
    const ccomplex_t IT_0034 = IT_0007*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = m_b*conj(N_d1)*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0046 = (-0.5)*IT_0045;
    const ccomplex_t IT_0047 = m_b*conj(N_d2)*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0053 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0054 = IT_0007*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*(IT_0049 + 0.333333333333333
      *IT_0052 + -IT_0055);
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0068 = conj(N_B4)*e_em*U_sb_01;
    const ccomplex_t IT_0069 = IT_0011*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = conj(N_W4)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0100 = m_b*N_d1*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0125 = IT_0044*IT_0124;
    ...
    const ccomplex_t IT_0165 = 0.166666666666667*IT_0087 + -IT_0107 + -IT_0126
       + -IT_0145 + -IT_0164;
    const ccomplex_t IT_0166 = m_b*m_d*IT_0001;
    ...
    const ccomplex_t IT_0172 = m_b*s_13;
    ...
    const ccomplex_t IT_0180 = IT_0076*IT_0153;
    const ccomplex_t IT_0181 = IT_0062*IT_0179*IT_0180;
    const ccomplex_t IT_0182 = m_d*IT_0026;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0184 = IT_0040*IT_0096;
    const ccomplex_t IT_0185 = IT_0027*IT_0183*IT_0184;
    const ccomplex_t IT_0186 = m_d*IT_0043;
    const ccomplex_t IT_0187 = m_d*IT_0061;
    const ccomplex_t IT_0188 = m_d*IT_0079;
    const ccomplex_t IT_0189 = IT_0181 + -IT_0182 + IT_0185 + -IT_0186 + 
      -IT_0187 + -IT_0188;
    const ccomplex_t IT_0190 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0191 = IT_0023*IT_0134;
    const ccomplex_t IT_0192 = IT_0002*IT_0190*IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0194 = IT_0058*IT_0115;
    const ccomplex_t IT_0195 = IT_0044*IT_0193*IT_0194;
    const ccomplex_t IT_0196 = 0.166666666666667*IT_0177 + -IT_0192 + -IT_0195;
    const ccomplex_t IT_0197 = IT_0178 + (-3)*IT_0189 + 3*IT_0196;
    const ccomplex_t IT_0198 = 3*conj(IT_0196);
    const ccomplex_t IT_0199 = (-3)*conj(IT_0189);
    const ccomplex_t IT_0200 = conj(IT_0178) + IT_0198 + IT_0199;
    const ccomplex_t IT_0201 = m_d*IT_0087;
    const ccomplex_t IT_0202 = (-0.5)*IT_0201;
    const ccomplex_t IT_0203 = 6*IT_0202;
    const ccomplex_t IT_0204 = m_d*IT_0107;
    const ccomplex_t IT_0205 = m_d*IT_0164;
    const ccomplex_t IT_0206 = IT_0046*IT_0123;
    const ccomplex_t IT_0207 = IT_0044*IT_0193*IT_0206;
    const ccomplex_t IT_0208 = m_d*IT_0126;
    const ccomplex_t IT_0209 = m_d*IT_0145;
    const ccomplex_t IT_0210 = 0.166666666666667*IT_0201 + -IT_0204 + -IT_0205
       + IT_0207 + -IT_0208 + -IT_0209;
    const ccomplex_t IT_0211 = 18*IT_0210;
    const ccomplex_t IT_0212 = IT_0064*IT_0161;
    const ccomplex_t IT_0213 = IT_0062*IT_0179*IT_0212;
    const ccomplex_t IT_0214 = IT_0029*IT_0104;
    const ccomplex_t IT_0215 = IT_0027*IT_0183*IT_0214;
    const ccomplex_t IT_0216 = IT_0009*IT_0142;
    const ccomplex_t IT_0217 = IT_0002*IT_0190*IT_0216;
    const ccomplex_t IT_0218 = -IT_0213 + -IT_0215 + -IT_0217;
    const ccomplex_t IT_0219 = (-18)*IT_0218;
    const ccomplex_t IT_0220 = IT_0203 + IT_0211 + IT_0219;
    const ccomplex_t IT_0221 = 6*conj(IT_0202);
    const ccomplex_t IT_0222 = 18*conj(IT_0210);
    const ccomplex_t IT_0223 = (-18)*conj(IT_0218);
    const ccomplex_t IT_0224 = IT_0221 + IT_0222 + IT_0223;
    const ccomplex_t IT_0225 = conj(IT_0088)*((-18)*IT_0178 + 6*IT_0189 + (-6)
      *IT_0196) + IT_0088*((-18)*conj(IT_0178) + 6*conj(IT_0189) + (-6)*conj
      (IT_0196)) + (-6)*conj(IT_0165)*IT_0197 + (-6)*IT_0165*IT_0200 + conj
      (IT_0080)*IT_0220 + IT_0080*IT_0224;
    const ccomplex_t IT_0226 = m_b*m_d;
    const ccomplex_t IT_0227 = 18*IT_0218;
    const ccomplex_t IT_0228 = (-18)*IT_0210;
    const ccomplex_t IT_0229 = (-6)*IT_0202;
    const ccomplex_t IT_0230 = IT_0227 + IT_0228 + IT_0229;
    const ccomplex_t IT_0231 = 18*conj(IT_0218);
    const ccomplex_t IT_0232 = (-18)*conj(IT_0210);
    const ccomplex_t IT_0233 = (-6)*conj(IT_0202);
    const ccomplex_t IT_0234 = IT_0231 + IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = conj(IT_0178)*(18*IT_0202 + 6*IT_0210 + (-6)
      *IT_0218) + IT_0178*(18*conj(IT_0202) + 6*conj(IT_0210) + (-6)*conj
      (IT_0218)) + conj(IT_0196)*IT_0220 + IT_0196*IT_0224 + conj(IT_0189)
      *IT_0230 + IT_0189*IT_0234;
    const ccomplex_t IT_0236 = m_d*s_14;
    const ccomplex_t IT_0237 = 6*conj(IT_0080)*IT_0197 + 6*IT_0080*IT_0200 +
       conj(IT_0088)*((-18)*IT_0202 + (-6)*IT_0210 + 6*IT_0218) + IT_0088*((-18)
      *conj(IT_0202) + (-6)*conj(IT_0210) + 6*conj(IT_0218)) + conj(IT_0165)
      *IT_0230 + IT_0165*IT_0234;
    ...
    const ccomplex_t IT_0242 = 12*IT_0169;
    const ccomplex_t IT_0243 = (-6)*IT_0167;
    const ccomplex_t IT_0244 = (-6)*(conj(IT_0080)*(IT_0088 + 3*IT_0165) +
       IT_0080*(conj(IT_0088) + 3*conj(IT_0165)))*IT_0166 + (IT_0080*conj
      (IT_0080) + IT_0088*conj(IT_0088) + IT_0165*conj(IT_0165))*IT_0171 +
       IT_0172*IT_0225 + IT_0226*IT_0235 + IT_0236*IT_0237 + (conj(IT_0178)
      *IT_0196 + IT_0178*conj(IT_0196) + conj(IT_0202)*IT_0210 + IT_0202*conj
      (IT_0210))*IT_0238 + (IT_0178*conj(IT_0178) + IT_0189*conj(IT_0189) +
       IT_0196*conj(IT_0196) + IT_0202*conj(IT_0202) + IT_0210*conj(IT_0210) +
       IT_0218*conj(IT_0218))*IT_0239 + (conj(IT_0189)*IT_0196 + IT_0189*conj
      (IT_0196) + conj(IT_0210)*IT_0218 + IT_0210*conj(IT_0218))*IT_0240 + (conj
      (IT_0178)*IT_0189 + IT_0178*conj(IT_0189) + conj(IT_0202)*IT_0218 +
       IT_0202*conj(IT_0218))*IT_0241 + (conj(IT_0088)*IT_0165 + IT_0088*conj
      (IT_0165))*(IT_0242 + IT_0243);
