...
ccomplex_return_t c_sumSqAmpl_sd_L_sc_R_to_s_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_23 + IT_0010 + IT_0011 + -m_C_1*
    ...
    return create_ccomplex_return(IT_0033*(18*s_34*conj(IT_0033) + 18*conj
      (IT_0034)*IT_0035) + IT_0034*(18*conj(IT_0033)*IT_0035 + conj(IT_0034)*(36
      *IT_0036 + (-18)*IT_0038)));
}
