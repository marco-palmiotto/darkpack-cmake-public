        ...
        )
{
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0016*IT_0034*IT_0036;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = IT_0033*IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = m_s*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0016*IT_0034*IT_0036;
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0016*IT_0034*IT_0036;
    const ccomplex_t IT_0074 = (-0.5)*IT_0073;
    const ccomplex_t IT_0075 = IT_0072*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = m_s*IT_0078;
    const ccomplex_t IT_0080 = IT_0025 + -IT_0043 + -IT_0058 + -IT_0064 + 
      -IT_0079;
    const ccomplex_t IT_0081 = cpow(IT_0033, 2);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_N_1*IT_0081;
    const ccomplex_t IT_0083 = IT_0040*IT_0082;
    const ccomplex_t IT_0084 = cpow(IT_0051, 2);
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*m_N_2*IT_0084;
    const ccomplex_t IT_0086 = IT_0055*IT_0085;
    const ccomplex_t IT_0087 = cpow(IT_0072, 2);
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*m_N_4*IT_0087;
    const ccomplex_t IT_0089 = IT_0076*IT_0088;
    const ccomplex_t IT_0090 = 0.166666666666667*IT_0008 + -IT_0083 + -IT_0086
       + -IT_0089;
    const ccomplex_t IT_0091 = -IT_0042 + -IT_0057 + -IT_0063 + -IT_0078;
    ...
    const ccomplex_t IT_0120 = IT_0038*IT_0093;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0122 = IT_0040*IT_0120*IT_0121;
    const ccomplex_t IT_0123 = IT_0074*IT_0108;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0125 = IT_0076*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = m_s*IT_0096;
    const ccomplex_t IT_0127 = m_s*IT_0101;
    const ccomplex_t IT_0128 = m_s*IT_0106;
    const ccomplex_t IT_0129 = m_s*IT_0111;
    const ccomplex_t IT_0130 = IT_0122 + IT_0125 + -IT_0126 + -IT_0127 + 
      -IT_0128 + -IT_0129;
    const ccomplex_t IT_0131 = IT_0053*IT_0098;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0133 = IT_0055*IT_0131*IT_0132;
    const ccomplex_t IT_0134 = IT_0060*IT_0103;
    ...
    const ccomplex_t IT_0155 = m_d*s_23;
    const ccomplex_t IT_0156 = 6*IT_0009;
    const ccomplex_t IT_0157 = (-6)*IT_0009;
    const ccomplex_t IT_0158 = m_s*s_24;
    const ccomplex_t IT_0159 = 6*s_34*IT_0009*(IT_0080 + conj(IT_0090)) + conj
      (IT_0091)*((-18)*IT_0112*IT_0113 + IT_0091*IT_0118) + conj(IT_0112)*((-18)
      *IT_0091*IT_0113 + IT_0112*IT_0118) + IT_0150 + (IT_0080*conj(IT_0080) +
       IT_0090*conj(IT_0090) + IT_0130*conj(IT_0130) + IT_0137*conj(IT_0137))
      *IT_0151 + (conj(IT_0080)*IT_0090 + IT_0080*conj(IT_0090) + conj(IT_0130)
      *IT_0137 + IT_0130*conj(IT_0137) + IT_0152)*IT_0153 + (conj(IT_0080) +
       IT_0090)*IT_0154 + IT_0155*(conj(IT_0091)*IT_0140 + IT_0091*IT_0143 +
       IT_0112*(18*conj(IT_0080) + (-18)*conj(IT_0090) + IT_0156) + conj(IT_0112
      )*(18*IT_0080 + (-18)*IT_0090 + IT_0157)) + (conj(IT_0112)*IT_0146 +
       IT_0112*IT_0149 + conj(IT_0091)*((-18)*IT_0080 + 18*IT_0090 + IT_0156) +
       IT_0091*((-18)*conj(IT_0080) + 18*conj(IT_0090) + IT_0157))*IT_0158;
