...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sb_1_to_u_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = V_tb*e_em*U_Wm1*conj(U_sb_00);
    const ccomplex_t IT_0027 = IT_0008*IT_0026;
    const ccomplex_t IT_0028 = IT_0008*IT_0012;
    const ccomplex_t IT_0029 = m_b*U_d1*V_tb*e_em*IT_0004*conj(U_sb_10);
    ...
    const ccomplex_t IT_0036 = V_tb*e_em*U_Wm2*conj(U_sb_00);
    const ccomplex_t IT_0037 = IT_0008*IT_0036;
    const ccomplex_t IT_0038 = m_b*U_d2*V_tb*e_em*IT_0004*conj(U_sb_10);
