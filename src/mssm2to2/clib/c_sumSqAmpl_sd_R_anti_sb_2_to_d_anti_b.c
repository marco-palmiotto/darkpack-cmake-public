        ...
        )
{
    ...
    const ccomplex_t IT_0009 = N_B1*e_em*conj(U_sb_01);
    const ccomplex_t IT_0010 = IT_0008*IT_0009;
    const ccomplex_t IT_0011 = 1.4142135623731*IT_0010;
    const ccomplex_t IT_0012 = N_W1*e_em*conj(U_sb_01);
    const ccomplex_t IT_0013 = IT_0004*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = IT_0002*IT_0004;
    const ccomplex_t IT_0016 = m_b*N_d1*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = N_B2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0030 = IT_0008*IT_0029;
    const ccomplex_t IT_0031 = 1.4142135623731*IT_0030;
    const ccomplex_t IT_0032 = N_W2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0033 = IT_0004*IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*IT_0033;
    const ccomplex_t IT_0035 = m_b*N_d2*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0052 = m_b*N_d3*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = N_B4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0064 = IT_0008*IT_0063;
    const ccomplex_t IT_0065 = 1.4142135623731*IT_0064;
    const ccomplex_t IT_0066 = N_W4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0067 = IT_0004*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = m_b*N_d4*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0089 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0090 = IT_0008*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = m_b*conj(N_d1)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0102 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0103 = IT_0008*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = m_b*conj(N_d2)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0115 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0116 = IT_0008*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = m_b*conj(N_d3)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0124 = IT_0058*IT_0123;
    ...
    const ccomplex_t IT_0128 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0129 = IT_0008*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = m_b*conj(N_d4)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0150 = IT_0020*IT_0088;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0152 = IT_0024*IT_0150*IT_0151;
    const ccomplex_t IT_0153 = IT_0039*IT_0101;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0155 = IT_0041*IT_0153*IT_0154;
    const ccomplex_t IT_0156 = IT_0056*IT_0114;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0158 = IT_0058*IT_0156*IT_0157;
    const ccomplex_t IT_0159 = IT_0073*IT_0127;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0161 = IT_0075*IT_0159*IT_0160;
    const ccomplex_t IT_0162 = m_d*IT_0026;
    const ccomplex_t IT_0163 = m_d*IT_0043;
    const ccomplex_t IT_0164 = m_d*IT_0060;
    const ccomplex_t IT_0165 = m_d*IT_0077;
    const ccomplex_t IT_0166 = 0.166666666666667*IT_0148 + -IT_0152 + -IT_0155
       + -IT_0158 + -IT_0161 + IT_0162 + IT_0163 + IT_0164 + IT_0165;
    const ccomplex_t IT_0167 = m_d*IT_0085;
    const ccomplex_t IT_0168 = 0.5*IT_0167;
    const ccomplex_t IT_0169 = IT_0045*IT_0122;
    const ccomplex_t IT_0170 = IT_0058*IT_0157*IT_0169;
    const ccomplex_t IT_0171 = IT_0006*IT_0096;
    const ccomplex_t IT_0172 = IT_0024*IT_0151*IT_0171;
    const ccomplex_t IT_0173 = IT_0028*IT_0109;
    const ccomplex_t IT_0174 = IT_0041*IT_0154*IT_0173;
    const ccomplex_t IT_0175 = IT_0062*IT_0135;
    const ccomplex_t IT_0176 = IT_0075*IT_0160*IT_0175;
    const ccomplex_t IT_0177 = m_d*IT_0099;
    const ccomplex_t IT_0178 = m_d*IT_0112;
    const ccomplex_t IT_0179 = m_d*IT_0125;
    const ccomplex_t IT_0180 = m_d*IT_0138;
    const ccomplex_t IT_0181 = (-0.166666666666667)*IT_0167 + -IT_0170 + 
      -IT_0172 + -IT_0174 + -IT_0176 + IT_0177 + IT_0178 + IT_0179 + IT_0180;
    const ccomplex_t IT_0182 = 6*s_34;
    const ccomplex_t IT_0183 = 18*s_34;
    const ccomplex_t IT_0184 = m_b*m_d;
    ...
    const ccomplex_t IT_0193 = m_b*s_13;
    ...
    const ccomplex_t IT_0204 = (IT_0078*conj(IT_0078) + IT_0086*conj(IT_0086) 
      ...
      *IT_0139 + IT_0086*conj(IT_0139))*(IT_0197 + IT_0198) + (-6)*IT_0199*(conj
      (IT_0078)*(IT_0086 + IT_0200) + IT_0078*(conj(IT_0086) + IT_0201)) + 6
      *IT_0202*IT_0203;
