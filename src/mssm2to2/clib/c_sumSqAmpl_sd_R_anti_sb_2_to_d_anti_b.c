...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sb_2_to_d_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = m_b*N_d1*e_em*IT_0003*conj(U_sb_11);
    ...
    const ccomplex_t IT_0019 = N_B1*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0029 = m_b*N_d2*e_em*IT_0003*conj(U_sb_11);
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*(IT_0031 + 0.333333333333333
      *IT_0034 + -IT_0037);
    const ccomplex_t IT_0039 = 3*IT_0038;
    const ccomplex_t IT_0040 = 0.166666666666667*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0048 = 0.5*IT_0047;
    const ccomplex_t IT_0049 = m_b*N_d3*e_em*IT_0003*conj(U_sb_11);
    const ccomplex_t IT_0050 = IT_0013*IT_0049;
    const ccomplex_t IT_0051 = 1.4142135623731*IT_0050;
    const ccomplex_t IT_0052 = N_B3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0053 = IT_0018*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*IT_0053;
    const ccomplex_t IT_0055 = N_W3*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = N_W4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0068 = IT_0007*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = m_b*N_d4*e_em*IT_0003*conj(U_sb_11);
    ...
    const ccomplex_t IT_0093 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0094 = IT_0018*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = m_b*conj(N_d2)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0106 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0107 = IT_0018*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = m_b*conj(N_d4)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0115 = IT_0064*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*IT_0115;
    const ccomplex_t IT_0117 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0118 = IT_0018*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = m_b*conj(N_d1)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0018;
    ...
    const ccomplex_t IT_0132 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0133 = IT_0018*IT_0132;
    const ccomplex_t IT_0134 = 1.4142135623731*IT_0133;
    const ccomplex_t IT_0135 = m_b*conj(N_d3)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_01);
    const ccomplex_t IT_0150 = IT_0085*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0152 = IT_0084*IT_0150*IT_0151;
    const ccomplex_t IT_0153 = (-0.5)*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0155 = IT_0024*IT_0126;
    const ccomplex_t IT_0156 = IT_0002*IT_0154*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0158 = IT_0040*IT_0092;
    const ccomplex_t IT_0159 = IT_0028*IT_0157*IT_0158;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0161 = IT_0060*IT_0131;
    const ccomplex_t IT_0162 = IT_0046*IT_0160*IT_0161;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0164 = IT_0078*IT_0105;
    const ccomplex_t IT_0165 = IT_0064*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = m_d*IT_0027;
    const ccomplex_t IT_0167 = m_d*IT_0045;
    const ccomplex_t IT_0168 = m_d*IT_0063;
    const ccomplex_t IT_0169 = m_d*IT_0081;
    const ccomplex_t IT_0170 = 0.166666666666667*IT_0152 + -IT_0156 + -IT_0159
       + -IT_0162 + -IT_0165 + IT_0166 + IT_0167 + IT_0168 + IT_0169;
    const ccomplex_t IT_0171 = m_d*IT_0089;
    const ccomplex_t IT_0172 = 0.5*IT_0171;
    const ccomplex_t IT_0173 = IT_0009*IT_0124;
    const ccomplex_t IT_0174 = IT_0002*IT_0154*IT_0173;
    const ccomplex_t IT_0175 = IT_0048*IT_0139;
    const ccomplex_t IT_0176 = IT_0046*IT_0160*IT_0175;
    const ccomplex_t IT_0177 = IT_0042*IT_0100;
    const ccomplex_t IT_0178 = IT_0028*IT_0157*IT_0177;
    const ccomplex_t IT_0179 = IT_0066*IT_0113;
    const ccomplex_t IT_0180 = IT_0064*IT_0163*IT_0179;
    const ccomplex_t IT_0181 = m_d*IT_0129;
    const ccomplex_t IT_0182 = m_d*IT_0103;
    const ccomplex_t IT_0183 = m_d*IT_0142;
    const ccomplex_t IT_0184 = m_d*IT_0116;
    const ccomplex_t IT_0185 = (-0.166666666666667)*IT_0171 + -IT_0174 + 
      -IT_0176 + -IT_0178 + -IT_0180 + IT_0181 + IT_0182 + IT_0183 + IT_0184;
    const ccomplex_t IT_0186 = 6*s_34;
    const ccomplex_t IT_0187 = 18*s_34;
    const ccomplex_t IT_0188 = m_b*m_d;
    const ccomplex_t IT_0189 = (-18)*conj(IT_0153);
    const ccomplex_t IT_0190 = (-6)*conj(IT_0170);
    const ccomplex_t IT_0191 = IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = (-18)*conj(IT_0170);
    const ccomplex_t IT_0193 = (-6)*conj(IT_0153);
    const ccomplex_t IT_0194 = IT_0192 + IT_0193;
    const ccomplex_t IT_0195 = (-18)*IT_0170;
    const ccomplex_t IT_0196 = (-6)*IT_0170;
    const ccomplex_t IT_0197 = m_b*s_13;
    const ccomplex_t IT_0198 = 0.333333333333333*conj(IT_0143);
    const ccomplex_t IT_0199 = conj(IT_0090) + IT_0198;
    const ccomplex_t IT_0200 = conj(IT_0082)*(IT_0172 + 3*IT_0185) + IT_0082*
      (conj(IT_0172) + 3*conj(IT_0185)) + (-0.166666666666667)*IT_0090*IT_0191 +
       (-0.166666666666667)*IT_0143*IT_0194 + (-0.166666666666667)*conj(IT_0143)
      *IT_0195 + (-0.166666666666667)*conj(IT_0090)*IT_0196 + 3*IT_0153*IT_0199;
    const ccomplex_t IT_0201 = 12*IT_0146;
    const ccomplex_t IT_0202 = (-6)*IT_0144;
    const ccomplex_t IT_0203 = m_d*s_14;
    const ccomplex_t IT_0204 = 3*IT_0143;
    const ccomplex_t IT_0205 = 3*conj(IT_0143);
    const ccomplex_t IT_0206 = conj(IT_0082)*(IT_0153 + 3*IT_0170) + IT_0082*
      (conj(IT_0153) + 3*conj(IT_0170)) + 3*(IT_0090 + 0.333333333333333*IT_0143
      )*conj(IT_0172) + 3*IT_0172*IT_0199 + conj(IT_0185)*(IT_0090 + IT_0204) +
       IT_0185*(conj(IT_0090) + IT_0205);
    const ccomplex_t IT_0207 = m_b*m_d*IT_0001;
    const ccomplex_t IT_0208 = (IT_0082*conj(IT_0082) + IT_0090*conj(IT_0090) 
      + IT_0143*conj(IT_0143))*IT_0148 + (conj(IT_0153)*IT_0170 + IT_0153*conj
      (IT_0170) + conj(IT_0172)*IT_0185 + IT_0172*conj(IT_0185))*IT_0186 + 
      (IT_0153*conj(IT_0153) + IT_0170*conj(IT_0170) + IT_0172*conj(IT_0172) +
       IT_0185*conj(IT_0185))*IT_0187 + IT_0188*(IT_0153*((-18)*conj(IT_0172) + 
      (-6)*conj(IT_0185)) + IT_0172*IT_0191 + IT_0185*IT_0194 + conj(IT_0185)
      *IT_0195 + conj(IT_0172)*IT_0196) + (-6)*IT_0197*IT_0200 + (conj(IT_0090)
      *IT_0143 + IT_0090*conj(IT_0143))*(IT_0201 + IT_0202) + 6*IT_0203*IT_0206 
      + (-6)*(conj(IT_0082)*(IT_0090 + IT_0204) + IT_0082*(conj(IT_0090) +
       IT_0205))*IT_0207;
    return create_ccomplex_return(IT_0208);
}
