...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sb_2_to_u_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*conj
      (V_u1)*e_em*IT_0000*IT_0004*IT_0008*conj(U_sb_01);
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*conj
      (V_u2)*e_em*IT_0000*IT_0004*IT_0008*conj(U_sb_01);
    ...
    const ccomplex_t IT_0026 = V_tb*e_em*U_Wm1*conj(U_sb_01);
    const ccomplex_t IT_0027 = IT_0004*IT_0026;
    const ccomplex_t IT_0028 = IT_0002*IT_0004;
    const ccomplex_t IT_0029 = m_b*U_d1*V_tb*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0036 = V_tb*e_em*U_Wm2*conj(U_sb_01);
    const ccomplex_t IT_0037 = IT_0004*IT_0036;
    const ccomplex_t IT_0038 = m_b*U_d2*V_tb*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0047 = m_t*m_u;
    const ccomplex_t IT_0048 = -IT_0035 + -IT_0044;
    const ccomplex_t IT_0049 = m_t*s_13;
    const ccomplex_t IT_0050 = 18*s_34;
    const ccomplex_t IT_0051 = m_u*s_14;
    const ccomplex_t IT_0052 = (-18)*conj(IT_0025);
    const ccomplex_t IT_0053 = s_13*s_14;
    const ccomplex_t IT_0054 = s_34*IT_0014;
    const ccomplex_t IT_0055 = IT_0025*((-18)*conj(IT_0046)*IT_0047 + (-18)
      *conj(IT_0048)*IT_0049 + conj(IT_0025)*IT_0050) + IT_0046*(conj(IT_0046)
      *IT_0050 + 18*conj(IT_0048)*IT_0051 + IT_0047*IT_0052) + IT_0048*(18*conj
      (IT_0046)*IT_0051 + IT_0049*IT_0052 + conj(IT_0048)*(36*IT_0053 + (-18)
      *IT_0054));
