...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sc_R_to_anti_c_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0049;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0049;
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0049;
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0049;
    ...
    const ccomplex_t IT_0078 = 0.166666666666667*IT_0047 + -IT_0056 + -IT_0063
       + -IT_0070 + -IT_0077;
    const ccomplex_t IT_0079 = pow(m_sd_R, 2);
    const ccomplex_t IT_0080 = m_c*m_d*IT_0079;
    ...
    const ccomplex_t IT_0086 = m_d*s_13;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*V_cd
    ...
    const ccomplex_t IT_0096 = IT_0010*IT_0053;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0098 = IT_0014*IT_0096*IT_0097;
    const ccomplex_t IT_0099 = IT_0020*IT_0060;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0101 = IT_0022*IT_0099*IT_0100;
    const ccomplex_t IT_0102 = IT_0028*IT_0067;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0104 = IT_0030*IT_0102*IT_0103;
    const ccomplex_t IT_0105 = IT_0036*IT_0074;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0107 = IT_0038*IT_0105*IT_0106;
    const ccomplex_t IT_0108 = m_d*IT_0016;
    const ccomplex_t IT_0109 = m_d*IT_0024;
    const ccomplex_t IT_0110 = m_d*IT_0032;
    const ccomplex_t IT_0111 = m_d*IT_0040;
    const ccomplex_t IT_0112 = -IT_0098 + -IT_0101 + -IT_0104 + -IT_0107 +
       IT_0108 + IT_0109 + IT_0110 + IT_0111;
    const ccomplex_t IT_0113 = m_d*IT_0047;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cd)
      *e_em*IT_0000*IT_0001*IT_0004*IT_0008;
    const ccomplex_t IT_0115 = 0.5*IT_0114;
    const ccomplex_t IT_0116 = IT_0088*IT_0115;
    ...
    const ccomplex_t IT_0120 = IT_0006*IT_0051;
    const ccomplex_t IT_0121 = IT_0014*IT_0097*IT_0120;
    const ccomplex_t IT_0122 = IT_0018*IT_0058;
    const ccomplex_t IT_0123 = IT_0022*IT_0100*IT_0122;
    const ccomplex_t IT_0124 = IT_0026*IT_0065;
    const ccomplex_t IT_0125 = IT_0030*IT_0103*IT_0124;
    const ccomplex_t IT_0126 = IT_0034*IT_0072;
    const ccomplex_t IT_0127 = IT_0038*IT_0106*IT_0126;
    const ccomplex_t IT_0128 = m_d*IT_0056;
    const ccomplex_t IT_0129 = m_d*IT_0063;
    const ccomplex_t IT_0130 = m_d*IT_0070;
    const ccomplex_t IT_0131 = m_d*IT_0077;
    const ccomplex_t IT_0132 = (-0.166666666666667)*IT_0113 + -IT_0121 + 
      -IT_0123 + -IT_0125 + -IT_0127 + IT_0128 + IT_0129 + IT_0130 + IT_0131;
    ...
    const ccomplex_t IT_0144 = m_c*m_d;
