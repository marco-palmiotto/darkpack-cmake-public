        ...
        )
{
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0049;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0049;
    ...
    const ccomplex_t IT_0062 = IT_0030*IT_0061;
    ...
    const ccomplex_t IT_0120 = IT_0018*IT_0051;
    const ccomplex_t IT_0121 = IT_0022*IT_0100*IT_0120;
    const ccomplex_t IT_0122 = IT_0026*IT_0058;
    const ccomplex_t IT_0123 = IT_0030*IT_0103*IT_0122;
    const ccomplex_t IT_0124 = IT_0034*IT_0065;
    const ccomplex_t IT_0125 = IT_0038*IT_0106*IT_0124;
    const ccomplex_t IT_0126 = m_d*IT_0056;
    const ccomplex_t IT_0127 = m_d*IT_0063;
    const ccomplex_t IT_0128 = m_d*IT_0070;
    const ccomplex_t IT_0129 = IT_0006*IT_0074;
    const ccomplex_t IT_0130 = IT_0014*IT_0097*IT_0129;
    const ccomplex_t IT_0131 = m_d*IT_0077;
    const ccomplex_t IT_0132 = (-0.166666666666667)*IT_0113 + -IT_0121 + 
      -IT_0123 + -IT_0125 + IT_0126 + IT_0127 + IT_0128 + -IT_0130 + IT_0131;
