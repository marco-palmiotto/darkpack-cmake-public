...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sd_R_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_sd_R
    ...
    const ccomplex_t IT_0010 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sd_R
      *Gamma_dr + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0053 = pow(m_sd_R, 4);
