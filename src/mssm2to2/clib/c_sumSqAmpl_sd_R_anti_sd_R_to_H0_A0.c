        ...
        )
{
    ...
    const ccomplex_t IT_0049 = A_b*V_td*conj(V_td);
    const ccomplex_t IT_0050 = IT_0000*IT_0049;
    const ccomplex_t IT_0051 = 1.4142135623731*IT_0050;
    const ccomplex_t IT_0052 = 0.5*IT_0048 + 0.5*IT_0051;
    const ccomplex_t IT_0053 = cpow(IT_0022, -1);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0003 + -m_d*e_em*mu_h*IT_0023*IT_0025*IT_0046*IT_0053);
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = IT_0052*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0000;
    ...
    const ccomplex_t IT_0068 = (-0.5)*IT_0048 + (-0.5)*IT_0051;
    const ccomplex_t IT_0069 = IT_0055*IT_0068;
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0000;
    ...
    const ccomplex_t IT_0081 = 1.4142135623731*A_b*V_tb*V_td*IT_0000*conj
      (U_sb_00);
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0003*conj(U_sb_00);
    const ccomplex_t IT_0090 = (-0.5)*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*A_b*V_tb*conj(V_td)*IT_0000
      *U_sb_00;
    const ccomplex_t IT_0092 = 0.5*IT_0091;
    const ccomplex_t IT_0093 = IT_0090*IT_0092;
    const ccomplex_t IT_0094 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0095 = IT_0093*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*IT_0095;
    const ccomplex_t IT_0097 = IT_0011 + IT_0019 + -IT_0045 + IT_0059 +
       IT_0067 + IT_0072 + IT_0080 + IT_0088 + IT_0096;
