...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sd_R_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0011*
    ...
    const ccomplex_t IT_0032 = cpow(IT_0003, 3);
    const ccomplex_t IT_0033 = (0 + _Complex_I*5)*m_W*e_em*IT_0031*(IT_0005*
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_12 + (-2)*IT_0026 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0039 = (0 + _Complex_I*-1)*m_W*e_em*IT_0031*(IT_0005*(
      (IT_0004 + -IT_0006)*IT_0009 + IT_0003*IT_0005*IT_0017) + -IT_0017*IT_0032);
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0015 + IT_0026 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0005*conj(U_sb_00);
    const ccomplex_t IT_0053 = (-0.5)*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_td)*IT_0005*U_sb_00;
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = IT_0053*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0015 + IT_0026 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0015 + IT_0026 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0061 = IT_0056*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0015 + IT_0026 + -m_sb_2*
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0015 + IT_0026 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0068*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0005 + -m_d*e_em*mu_h*IT_0003*IT_0018*IT_0019*IT_0020);
    const ccomplex_t IT_0075 = (-0.5)*IT_0074;
    const ccomplex_t IT_0076 = cpow(IT_0075, 2);
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = cpow((-2)*s_23 + IT_0015 + IT_0026 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0079 = IT_0077*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0015 + IT_0026 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0077*IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_23 + IT_0015 + (0 + _Complex_I*1)
      *m_sd_R*Gamma_dr + reg_prop, -1);
    const ccomplex_t IT_0083 = IT_0024*IT_0082;
    const ccomplex_t IT_0084 = cpow((-2)*s_23 + IT_0015 + IT_0026 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0085 = IT_0048*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = IT_0014 + IT_0025 + -IT_0037 + -IT_0043 +
       IT_0051 + IT_0059 + IT_0062 + IT_0070 + IT_0073 + IT_0079 + IT_0081 +
       IT_0083 + IT_0086;
