        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0011*
      (IT_0005*IT_0009 + -IT_0003*IT_0015) + (-3)*IT_0005*IT_0008*IT_0016
      *IT_0017*IT_0018);
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0023 + (0 + _Complex_I*1)
      *m_sd_R*Gamma_dr + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0022*IT_0024;
    const ccomplex_t IT_0026 = cpow((-2)*s_23 + IT_0023 + (0 + _Complex_I*1)
      *m_sd_R*Gamma_dr + reg_prop, -1);
    ...
    const ccomplex_t IT_0033 = pow(m_sd_R, 2);
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0023 + IT_0033 + -m_sb_1*
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0023 + IT_0033 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0023 + IT_0033 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0065 = IT_0060*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0023 + IT_0033 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0011*
      (IT_0003*IT_0009 + IT_0005*IT_0015) + (-3)*IT_0003*IT_0008*IT_0016*IT_0017
      *IT_0018);
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*5)*m_W*e_em*IT_0074*(IT_0005*
      (IT_0004*IT_0015 + (-1)*IT_0005*(IT_0003*IT_0009 + 1./5*IT_0005*IT_0015)) 
      + 1./5*IT_0009*IT_0075);
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*-1)*m_W*e_em*IT_0074*(IT_0005*(
      (IT_0004 + -IT_0006)*IT_0009 + IT_0003*IT_0005*IT_0015) + -IT_0015*IT_0075);
    ...
    const ccomplex_t IT_0087 = IT_0014 + IT_0025 + IT_0027 + IT_0036 + IT_0044
       + IT_0047 + IT_0053 + IT_0055 + IT_0063 + IT_0066 + IT_0069 + -IT_0080 + 
      -IT_0086;
