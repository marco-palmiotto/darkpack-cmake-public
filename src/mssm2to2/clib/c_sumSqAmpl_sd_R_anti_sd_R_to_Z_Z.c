...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sd_R_to_Z_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = pow(m_sd_R, 2);
    ...
    const ccomplex_t IT_0061 = (-0.333333333333333)*IT_0059;
    ...
    const ccomplex_t IT_0076 = s_14*s_23*s_34*IT_0055;
    ...
    const ccomplex_t IT_0084 = -(IT_0035 + -IT_0070)*(s_12 + -IT_0079);
    ...
    const ccomplex_t IT_0091 = cpow(IT_0060, 2);
    const ccomplex_t IT_0092 = IT_0086*(IT_0062 + -IT_0091);
    const ccomplex_t IT_0093 = (s_12 + -IT_0077)*(s_12 + -IT_0079);
    const ccomplex_t IT_0094 = 3*conj(IT_0067);
    const ccomplex_t IT_0095 = s_13*s_24*s_34*IT_0055;
    const ccomplex_t IT_0096 = IT_0081 + IT_0095;
    const ccomplex_t IT_0097 = pow(s_13, 2);
    const ccomplex_t IT_0098 = IT_0068*IT_0097;
    const ccomplex_t IT_0099 = -(s_12 + -IT_0077)*(IT_0035 + -IT_0098);
    const ccomplex_t IT_0100 = IT_0065*(IT_0062 + -IT_0091);
    const ccomplex_t IT_0101 = -IT_0100;
    const ccomplex_t IT_0102 = 3*conj(IT_0087);
    const ccomplex_t IT_0103 = s_23*s_24*s_34*IT_0055;
    const ccomplex_t IT_0104 = pow(s_24, 2);
    const ccomplex_t IT_0105 = IT_0068*IT_0104;
    const ccomplex_t IT_0106 = -IT_0105;
    const ccomplex_t IT_0107 = -IT_0072;
    const ccomplex_t IT_0108 = IT_0035 + IT_0103 + IT_0106 + IT_0107;
    const ccomplex_t IT_0109 = (IT_0035 + -IT_0072)*(s_12 + -IT_0077);
    const ccomplex_t IT_0110 = -IT_0109;
    const ccomplex_t IT_0111 = (-3)*conj(IT_0067);
    const ccomplex_t IT_0112 = (s_12 + -IT_0079)*(IT_0035 + -IT_0105);
    const ccomplex_t IT_0113 = -IT_0112;
    const ccomplex_t IT_0114 = (-3)*conj(IT_0092);
    const ccomplex_t IT_0115 = -IT_0035;
    const ccomplex_t IT_0116 = (IT_0070 + IT_0115)*(IT_0098 + IT_0115);
    const ccomplex_t IT_0117 = 3*IT_0087;
    const ccomplex_t IT_0118 = s_13*s_14*s_34*IT_0055;
    const ccomplex_t IT_0119 = IT_0070 + IT_0098 + IT_0115 + -IT_0118;
    const ccomplex_t IT_0120 = (-3)*IT_0054;
    const ccomplex_t IT_0121 = (-3)*conj(IT_0054);
    const ccomplex_t IT_0122 = s_14*s_34*IT_0068;
    const ccomplex_t IT_0123 = (s_12 + -IT_0079)*(s_13 + -IT_0122);
    const ccomplex_t IT_0124 = (IT_0035 + -IT_0072)*(s_13 + -IT_0122);
    const ccomplex_t IT_0125 = -IT_0124;
    const ccomplex_t IT_0126 = s_34*IT_0068;
    const ccomplex_t IT_0127 = s_23*s_34*IT_0068;
    const ccomplex_t IT_0128 = -IT_0127;
    const ccomplex_t IT_0129 = s_24 + IT_0128;
    const ccomplex_t IT_0130 = IT_0126*IT_0129;
    const ccomplex_t IT_0131 = -IT_0087;
    const ccomplex_t IT_0132 = -(IT_0035 + -IT_0098)*(s_13 + -IT_0122);
    const ccomplex_t IT_0133 = s_24*s_34*IT_0068;
    const ccomplex_t IT_0134 = -(IT_0035 + -IT_0098)*(s_23 + -IT_0133);
    const ccomplex_t IT_0135 = s_13*s_34*IT_0068;
    const ccomplex_t IT_0136 = -IT_0135;
    const ccomplex_t IT_0137 = s_14 + IT_0136;
    const ccomplex_t IT_0138 = IT_0126*IT_0137;
    const ccomplex_t IT_0139 = (s_12 + -IT_0079)*(s_23 + -IT_0133);
    const ccomplex_t IT_0140 = (IT_0035 + -IT_0072)*(IT_0035 + -IT_0105);
    const ccomplex_t IT_0141 = 3*IT_0101;
    const ccomplex_t IT_0142 = (-3)*IT_0067;
    const ccomplex_t IT_0143 = (-3)*IT_0092;
    const ccomplex_t IT_0144 = (IT_0035 + -IT_0072)*(s_23 + -IT_0133);
    const ccomplex_t IT_0145 = -IT_0144;
    const ccomplex_t IT_0146 = (-3)*IT_0100;
    const ccomplex_t IT_0147 = 0.333333333333333*IT_0093;
    const ccomplex_t IT_0148 = 3*conj(IT_0101)*(0.333333333333333*IT_0083
      *IT_0108 + IT_0131*IT_0139 + 0.333333333333333*IT_0140*IT_0141 +
       0.333333333333333*IT_0110*IT_0142 + 0.333333333333333*IT_0113*IT_0143 +
       0.333333333333333*IT_0145*IT_0146 + IT_0117*IT_0147);
    const ccomplex_t IT_0149 = -(IT_0035 + -IT_0098)*(IT_0035 + -IT_0105);
    const ccomplex_t IT_0150 = -IT_0149;
    const ccomplex_t IT_0151 = 3*IT_0092;
    const ccomplex_t IT_0152 = IT_0056*IT_0068;
    const ccomplex_t IT_0153 = (s_12 + -IT_0079)*(IT_0063 + -IT_0152);
    const ccomplex_t IT_0154 = (IT_0035 + -IT_0072)*(IT_0063 + -IT_0152);
    const ccomplex_t IT_0155 = -IT_0154;
    const ccomplex_t IT_0156 = (-0.333333333333333)*IT_0123;
    ...
    const ccomplex_t IT_0159 = 6*IT_0054*conj(IT_0054)*(1 + 0.5*IT_0057) +
       conj(IT_0067)*(IT_0074*IT_0075 + IT_0082*IT_0083 + IT_0084*IT_0088) +
       IT_0067*(IT_0082*IT_0089 + IT_0084*IT_0090) + IT_0092*(IT_0093*IT_0094 +
       IT_0089*IT_0096 + IT_0090*IT_0099) + IT_0101*(IT_0093*IT_0102 + IT_0089
      *IT_0108 + IT_0110*IT_0111 + IT_0113*IT_0114) + conj(IT_0087)*(IT_0116
      *IT_0117 + IT_0119*IT_0120) + IT_0087*IT_0119*IT_0121 + IT_0100*(IT_0102
      *IT_0123 + IT_0111*IT_0125 + IT_0121*IT_0130) + IT_0131*(IT_0094*IT_0123 +
       IT_0090*IT_0132 + IT_0114*IT_0134 + IT_0121*IT_0138) + IT_0148 + 3*conj
      (IT_0092)*(0.333333333333333*IT_0083*IT_0096 + 0.333333333333333*IT_0088
      *IT_0099 + IT_0100*IT_0139 + IT_0075*IT_0147 + 0.333333333333333*IT_0150
      *IT_0151) + (-3)*conj(IT_0100)*((-0.333333333333333)*IT_0120*IT_0130 + (
      -0.333333333333333)*IT_0125*IT_0142 + IT_0101*IT_0145 + -IT_0131*IT_0153 +
       (-0.333333333333333)*IT_0146*IT_0155 + IT_0117*IT_0156 + IT_0151*IT_0157)
       + (-3)*conj(IT_0131)*((-0.333333333333333)*IT_0088*IT_0132 + (
      -0.333333333333333)*IT_0120*IT_0138 + (-0.333333333333333)*IT_0134*IT_0143
       + -IT_0100*IT_0153 + IT_0075*IT_0156 + IT_0141*IT_0157 + IT_0131*IT_0158);
