        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*V_td*(A_b*IT_0005*conj
      (U_st_01) + 0.707106781186548*m_d*e_em*IT_0014*IT_0017*(mu_h*conj(U_st_01)
       + m_t*IT_0015*IT_0016*conj(U_st_11)));
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0005
      *U_st_01 + 0.707106781186548*m_d*e_em*IT_0014*IT_0017*(mu_h*U_st_01 + m_t
      *IT_0015*IT_0016*U_st_11));
    const ccomplex_t IT_0020 = IT_0018*IT_0019;
    const ccomplex_t IT_0021 = pow(m_Hp, 2);
    const ccomplex_t IT_0022 = pow(m_sd_R, 2);
    const ccomplex_t IT_0023 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0024 = IT_0020*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0027 = 0.666666666666667*IT_0026;
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = s_12 + IT_0022;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = 2*IT_0026;
    const ccomplex_t IT_0032 = 0.333333333333333*IT_0026;
    ...
    const ccomplex_t IT_0043 = cpow(s_12 + IT_0022 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
      *Gamma_Z) + (-2)*IT_0022 + -reg_prop, -1);
    const ccomplex_t IT_0047 = cpow(IT_0001, -1);
    const ccomplex_t IT_0048 = (0 + _Complex_I*-1)*e_em*(IT_0001*IT_0017 + 
      -IT_0010*IT_0047);
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*e_em*IT_0010*IT_0047;
    const ccomplex_t IT_0050 = (-0.666666666666667)*IT_0049;
    const ccomplex_t IT_0051 = IT_0048*IT_0050;
    const ccomplex_t IT_0052 = -s_23;
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*-3)*e_em*(IT_0008*IT_0014
      *IT_0015*IT_0017*IT_0070 + -1./3*m_W*IT_0002*IT_0010*(IT_0005*IT_0069 +
       IT_0003*IT_0070));
    const ccomplex_t IT_0072 = (-0.333333333333333)*IT_0071;
    const ccomplex_t IT_0073 = IT_0002*IT_0010;
    const ccomplex_t IT_0074 = -IT_0017 + IT_0073;
    const ccomplex_t IT_0075 = cpow(IT_0005, 3);
    const ccomplex_t IT_0076 = 3*IT_0017 + IT_0073;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*m_W*e_em*(IT_0069*IT_0074
      *IT_0075 + IT_0003*(IT_0006*IT_0070*IT_0076 + -IT_0003*(IT_0003*IT_0070
      *IT_0074 + IT_0005*IT_0069*IT_0076)));
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*-3)*e_em*(IT_0008*IT_0014
      *IT_0015*IT_0017*IT_0069 + -1./3*m_W*IT_0002*IT_0010*(IT_0003*IT_0069 + 
      -IT_0005*IT_0070));
    const ccomplex_t IT_0084 = 0.333333333333333*IT_0083;
    const ccomplex_t IT_0085 = -IT_0017;
    const ccomplex_t IT_0086 = IT_0073 + IT_0085;
    const ccomplex_t IT_0087 = -IT_0003;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*m_W*e_em*(IT_0070*IT_0075
      *IT_0086 + IT_0087*(IT_0006*IT_0069*IT_0076 + -(IT_0005*IT_0070*IT_0076 + 
      -IT_0003*IT_0069*IT_0086)*IT_0087));
    const ccomplex_t IT_0089 = 0.5*IT_0088;
    const ccomplex_t IT_0090 = IT_0084*IT_0089;
    const ccomplex_t IT_0091 = cpow((-2)*s_12 + (-2)*IT_0022 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0092 = IT_0090*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_d*conj(V_cd)
      *e_em*mu_h*IT_0014*IT_0017;
    const ccomplex_t IT_0095 = 0.5*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*m_d*V_cd*e_em
      *mu_h*IT_0014*IT_0017;
    const ccomplex_t IT_0097 = 0.5*IT_0096;
    const ccomplex_t IT_0098 = IT_0095*IT_0097;
    const ccomplex_t IT_0099 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_sc_L*
      (m_sc_L + (0 + _Complex_I*-1)*Gamma_cl) + reg_prop, -1);
    const ccomplex_t IT_0100 = IT_0098*IT_0099;
    const ccomplex_t IT_0101 = (0 + _Complex_I*1)*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0014*IT_0017;
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0107 = IT_0105*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*V_cd
      *e_em*IT_0014*IT_0015*IT_0016*IT_0017;
    const ccomplex_t IT_0109 = 0.5*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_c*m_d*conj
      (V_cd)*e_em*IT_0014*IT_0015*IT_0016*IT_0017;
    const ccomplex_t IT_0111 = 0.5*IT_0110;
    const ccomplex_t IT_0112 = IT_0109*IT_0111;
    const ccomplex_t IT_0113 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_sc_R*
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0014*IT_0015*IT_0016*IT_0017;
    ...
    const ccomplex_t IT_0120 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0121 = IT_0119*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*V_td*(A_b*IT_0005*conj
      (U_st_00) + 0.707106781186548*m_d*e_em*IT_0014*IT_0017*(mu_h*conj(U_st_00)
       + m_t*IT_0015*IT_0016*conj(U_st_10)));
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0005
      *U_st_00 + 0.707106781186548*m_d*e_em*IT_0014*IT_0017*(mu_h*U_st_00 + m_t
      *IT_0015*IT_0016*U_st_10));
    const ccomplex_t IT_0124 = IT_0122*IT_0123;
    const ccomplex_t IT_0125 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0126 = IT_0124*IT_0125;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*IT_0126;
    const ccomplex_t IT_0128 = IT_0013 + IT_0025 + (-0.5)*IT_0045 + -IT_0068 +
       -IT_0082 + -IT_0093 + IT_0101 + IT_0107 + IT_0115 + IT_0121 + IT_0127;
    return create_ccomplex_return(3*IT_0128*conj(IT_0128));
}
