        ...
        )
{
    ...
    const ccomplex_t IT_0019 = cpow(s_12 + IT_0015 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0022 = -IT_0021;
    const ccomplex_t IT_0023 = 0.666666666666667*IT_0021;
    const ccomplex_t IT_0024 = IT_0022*IT_0023;
    const ccomplex_t IT_0025 = s_12 + IT_0015;
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = (-2)*IT_0021;
    const ccomplex_t IT_0028 = 0.333333333333333*IT_0021;
    ...
    const ccomplex_t IT_0033 = IT_0023*IT_0027;
    const ccomplex_t IT_0034 = s_23*IT_0033;
    const ccomplex_t IT_0035 = IT_0022*IT_0028;
    const ccomplex_t IT_0036 = IT_0025*IT_0035;
    const ccomplex_t IT_0037 = -IT_0034 + (-2)*IT_0036;
    const ccomplex_t IT_0038 = IT_0032 + IT_0037;
    const ccomplex_t IT_0039 = IT_0020*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0002 + 
      -IT_0000*IT_0003)*IT_0005;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0001*IT_0002 +
    ...
    const ccomplex_t IT_0125 = (s_12 + -IT_0102)*(s_12 + -IT_0104);
    const ccomplex_t IT_0126 = s_14*s_34*IT_0080;
    const ccomplex_t IT_0127 = (s_12 + -IT_0104)*(s_13 + -IT_0126);
    const ccomplex_t IT_0128 = IT_0021*IT_0028;
    const ccomplex_t IT_0129 = IT_0020*IT_0128;
    const ccomplex_t IT_0130 = IT_0049*IT_0059;
    const ccomplex_t IT_0131 = IT_0048*IT_0130;
    const ccomplex_t IT_0132 = (-0.5)*IT_0129 + IT_0131;
    ...
    const ccomplex_t IT_0142 = -(IT_0015 + -IT_0082)*(s_13 + -IT_0126);
    ...
    const ccomplex_t IT_0150 = -IT_0024 + -IT_0092;
    const ccomplex_t IT_0151 = IT_0073 + IT_0150;
    const ccomplex_t IT_0152 = IT_0020*IT_0151;
    const ccomplex_t IT_0153 = IT_0057 + IT_0096;
    ...
    const ccomplex_t IT_0183 = (s_13 + -IT_0126)*(IT_0015 + -IT_0160);
    ...
    const ccomplex_t IT_0190 = 3*conj(IT_0100);
    const ccomplex_t IT_0191 = 3*conj(IT_0132);
    ...
    const ccomplex_t IT_0193 = (-3)*IT_0177*((-0.333333333333333)*IT_0091
      *IT_0182 + conj(IT_0156)*IT_0186 + conj(IT_0177)*IT_0188 + (
      -0.333333333333333)*IT_0127*IT_0189 + (-0.333333333333333)*IT_0163*IT_0190
       + (-0.333333333333333)*IT_0178*IT_0191 + (-0.333333333333333)*IT_0184
      *IT_0192);
    const ccomplex_t IT_0194 = (IT_0015 + -IT_0110)*(IT_0015 + -IT_0160);
    const ccomplex_t IT_0195 = 0.333333333333333*IT_0125;
    const ccomplex_t IT_0196 = 3*IT_0156*(0.333333333333333*IT_0135*IT_0162 +
       ...
       0.333333333333333*IT_0163*IT_0191 + 0.333333333333333*IT_0167*IT_0192 +
    ...
    const ccomplex_t IT_0199 = 6*IT_0067*conj(IT_0067)*(1 + 0.5*IT_0070) +
      ...
      *IT_0115) + conj(IT_0122)*(IT_0108*IT_0124 + IT_0113*IT_0125 + IT_0127
      *IT_0133 + IT_0115*IT_0134) + IT_0100*(IT_0107*IT_0135 + IT_0114*IT_0136) 
      + conj(IT_0132)*(IT_0090*IT_0141 + IT_0115*IT_0142 + IT_0144*IT_0145) + (
      -3)*IT_0132*((-0.333333333333333)*IT_0091*IT_0141 + (-0.333333333333333)
      *IT_0136*IT_0142 + conj(IT_0132)*IT_0148 + (-0.333333333333333)*IT_0144
      *IT_0149) + conj(IT_0156)*(IT_0087*IT_0125 + IT_0108*IT_0162 + IT_0133
      *IT_0163 + IT_0145*IT_0165 + IT_0167*IT_0168) + conj(IT_0177)*(IT_0087
      *IT_0127 + IT_0113*IT_0163 + IT_0133*IT_0178 + IT_0090*IT_0182 + IT_0168
      *IT_0184) + IT_0193 + IT_0196 + 3*IT_0122*(0.333333333333333*IT_0124
      *IT_0135 + 0.333333333333333*IT_0134*IT_0136 + 0.333333333333333*IT_0127
      *IT_0191 + IT_0190*IT_0195 + conj(IT_0122)*IT_0198);
