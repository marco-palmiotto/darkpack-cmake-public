...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sd_R_to_anti_b_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0085 = m_b*IT_0084;
    ...
    const ccomplex_t IT_0090 = ((-12)*IT_0028 + 12*conj(IT_0028) + (-6)
      ...
      *IT_0028 + 36*conj(IT_0028) + (-18)*IT_0048 + 18*conj(IT_0048) + 18*conj
      (IT_0049) + IT_0089);
    const ccomplex_t IT_0091 = m_b*s_14;
    ...
    const ccomplex_t IT_0098 = m_b*s_13;
