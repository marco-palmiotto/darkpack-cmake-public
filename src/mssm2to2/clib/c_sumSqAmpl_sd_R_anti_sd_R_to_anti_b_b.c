        ...
        )
{
    ...
    const ccomplex_t IT_0095 = ((-12)*IT_0028 + 12*conj(IT_0028) + (-6)
      *IT_0051 + 6*conj(IT_0051) + (-6)*IT_0052 + 6*conj(IT_0052))*IT_0077 + 
      (conj(IT_0079) + conj(IT_0081))*IT_0091 + IT_0092*IT_0093 + IT_0068*((-36)
    ...
    const ccomplex_t IT_0103 = IT_0028*IT_0055;
    const ccomplex_t IT_0104 = (-18)*IT_0081;
    const ccomplex_t IT_0105 = IT_0098 + IT_0100;
    const ccomplex_t IT_0106 = IT_0068*IT_0101;
    const ccomplex_t IT_0107 = conj(IT_0028)*(IT_0028*(36*s_34 + (-36)*IT_0029
      ...
      *IT_0085) + IT_0081*IT_0086*IT_0087 + IT_0090*IT_0095 + (IT_0029*IT_0051 +
       IT_0079*IT_0096)*IT_0097 + IT_0092*IT_0101*IT_0102 + conj(IT_0052)*
      (IT_0052*IT_0054 + IT_0103) + conj(IT_0051)*(IT_0051*IT_0054 + 18*IT_0079
      *IT_0086 + IT_0029*IT_0094 + IT_0103 + IT_0096*IT_0104) + conj(IT_0079)*
      (18*IT_0051*IT_0086 + IT_0094*IT_0096 + IT_0072*IT_0104 + IT_0079*IT_0105 
      + IT_0106) + conj(IT_0081)*((-18)*IT_0072*IT_0079 + 18*IT_0052*IT_0086 + (
      -18)*IT_0051*IT_0096 + IT_0081*IT_0105 + IT_0106);
