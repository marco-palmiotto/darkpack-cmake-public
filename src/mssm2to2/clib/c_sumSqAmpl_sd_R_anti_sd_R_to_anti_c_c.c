...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_sd_R_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*IT_0003*(IT_0004
      *IT_0005 + -IT_0006*IT_0007)*IT_0008 + (-3)*IT_0005*IT_0009*IT_0010
      *IT_0011*IT_0012);
    const ccomplex_t IT_0014 = 0.333333333333333*IT_0013;
    const ccomplex_t IT_0015 = cpow(IT_0006, -1);
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*m_c*e_em*IT_0007*IT_0009
      *IT_0012*IT_0015;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*e_em*(m_W*IT_0003*(IT_0005
      *IT_0006 + IT_0004*IT_0007)*IT_0008 + (-3)*IT_0007*IT_0009*IT_0010*IT_0011
      *IT_0012);
    const ccomplex_t IT_0023 = (-0.333333333333333)*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*m_c*e_em*IT_0005*IT_0009
      *IT_0012*IT_0015;
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_cd*e_em*IT_0009*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0000 + IT_0030 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0000 + IT_0030 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0048 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_cd*e_em*IT_0009*IT_0011*IT_0012;
    const ccomplex_t IT_0049 = (-0.5)*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*conj
      (V_cd)*e_em*IT_0009*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0056 = IT_0008*IT_0031;
    const ccomplex_t IT_0057 = e_em*IT_0056;
    const ccomplex_t IT_0058 = IT_0002*IT_0012;
    const ccomplex_t IT_0059 = e_em*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*(IT_0057 + (-3)*IT_0059);
    ...
    const ccomplex_t IT_0066 = IT_0000*IT_0030;
    const ccomplex_t IT_0067 = m_c*IT_0033;
    const ccomplex_t IT_0068 = (-0.333333333333333)*IT_0032;
    const ccomplex_t IT_0069 = m_c*IT_0068;
    const ccomplex_t IT_0070 = -(IT_0036 + -IT_0063)*(IT_0067 + -IT_0069);
    ...
    const ccomplex_t IT_0085 = cpow(s_12 + IT_0000 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0104 = IT_0046 + IT_0054;
    const ccomplex_t IT_0105 = m_c*IT_0104;
    const ccomplex_t IT_0106 = 3*IT_0070;
    const ccomplex_t IT_0107 = IT_0105 + IT_0106;
    const ccomplex_t IT_0108 = 3*conj(IT_0070);
    const ccomplex_t IT_0109 = conj(IT_0105) + IT_0108;
    const ccomplex_t IT_0110 = 18*conj(IT_0073);
    const ccomplex_t IT_0111 = 18*conj(IT_0038)*IT_0073 + 6*conj(IT_0055)*
      (IT_0070 + 3*IT_0105) + 6*IT_0055*(conj(IT_0070) + 3*conj(IT_0105)) + 6
      *conj(IT_0065)*IT_0107 + 6*IT_0065*IT_0109 + IT_0038*IT_0110;
    const ccomplex_t IT_0112 = (-18)*IT_0073;
    const ccomplex_t IT_0113 = (-18)*conj(IT_0073);
    const ccomplex_t IT_0114 = m_c*s_14;
    const ccomplex_t IT_0115 = (-6)*IT_0073;
    const ccomplex_t IT_0116 = (-6)*conj(IT_0073);
    const ccomplex_t IT_0117 = (-6)*IT_0066;
    const ccomplex_t IT_0118 = IT_0078 + IT_0080 + IT_0117;
    const ccomplex_t IT_0119 = conj(IT_0038) + conj(IT_0065);
    const ccomplex_t IT_0120 = IT_0038 + IT_0065;
    const ccomplex_t IT_0121 = -IT_0102;
    const ccomplex_t IT_0122 = -IT_0096;
    const ccomplex_t IT_0123 = (-18)*IT_0066;
    const ccomplex_t IT_0124 = IT_0082 + IT_0083 + IT_0123;
    const ccomplex_t IT_0125 = 6*conj(IT_0029);
    const ccomplex_t IT_0126 = -IT_0030;
    const ccomplex_t IT_0127 = -s_14;
    const ccomplex_t IT_0128 = s_13 + IT_0127;
    const ccomplex_t IT_0129 = m_c*IT_0128;
    const ccomplex_t IT_0130 = 6*IT_0029;
    const ccomplex_t IT_0131 = 18*IT_0029;
    const ccomplex_t IT_0132 = 18*conj(IT_0029);
    const ccomplex_t IT_0133 = 6*conj(IT_0105);
    const ccomplex_t IT_0134 = (-12)*IT_0102*(IT_0029 + -conj(IT_0029) + 1./2
      *IT_0070 + -1./2*conj(IT_0070) + -1./2*conj(IT_0073) + 3./2*IT_0105 + -3.
      /2*conj(IT_0105) + (-0.0833333333333333)*IT_0115) + IT_0055*IT_0125 + conj
      (IT_0055)*IT_0130 + IT_0119*IT_0131 + IT_0120*IT_0132 + IT_0096*((-36)
      *IT_0029 + 36*conj(IT_0029) + (-18)*IT_0070 + 18*conj(IT_0070) + (-6)
      *IT_0105 + IT_0110 + IT_0112 + IT_0133);
    const ccomplex_t IT_0135 = IT_0029*conj(IT_0029)*(36*s_34 + (-36)*IT_0030)
       + (-6)*(conj(IT_0038)*(IT_0055 + 3*IT_0065) + IT_0038*(conj(IT_0055) + 3
      *conj(IT_0065)))*IT_0066 + (IT_0070*conj(IT_0070) + IT_0073*conj(IT_0073))
      *IT_0075 + (conj(IT_0029)*(IT_0070 + IT_0073) + IT_0029*(conj(IT_0070) +
       conj(IT_0073)))*IT_0076 + (conj(IT_0055)*IT_0065 + IT_0055*conj(IT_0065))
      *IT_0081 + (IT_0038*conj(IT_0038) + IT_0055*conj(IT_0055) + IT_0065*conj
      (IT_0065))*IT_0084 + -IT_0097*IT_0101 + (-2)*IT_0102*(((-12)*IT_0066 + (
      -12)*IT_0077 + 24*IT_0079)*IT_0096 + 0.5*IT_0101*IT_0102) + IT_0103
      *IT_0111 + IT_0030*(conj(IT_0070)*IT_0112 + IT_0070*IT_0113) + (-6)
      *IT_0114*(conj(IT_0038)*IT_0107 + IT_0038*IT_0109 + (-0.166666666666667)
      *conj(IT_0065)*IT_0112 + (-0.166666666666667)*IT_0065*IT_0113 + (
      -0.166666666666667)*conj(IT_0055)*IT_0115 + (-0.166666666666667)*IT_0055
      *IT_0116) + IT_0118*(conj(IT_0055)*IT_0096 + IT_0102*IT_0119 + IT_0120
      *IT_0121 + IT_0055*IT_0122) + (conj(IT_0055)*IT_0102 + IT_0096*IT_0119 +
       IT_0055*IT_0121 + IT_0120*IT_0122)*IT_0124 + 6*IT_0105*(s_34*conj(IT_0070
      ) + 0.166666666666667*IT_0030*IT_0116 + 0.166666666666667*IT_0125*(s_34 +
       IT_0126)) + (s_34*IT_0070 + 0.166666666666667*IT_0075*IT_0105 +
       0.166666666666667*IT_0030*IT_0115 + 0.166666666666667*(s_34 + IT_0126)
      *IT_0130)*IT_0133 + IT_0129*IT_0134;
