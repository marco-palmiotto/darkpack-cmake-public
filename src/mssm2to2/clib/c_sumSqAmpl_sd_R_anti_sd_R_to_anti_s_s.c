        ...
        )
{
    ...
    const ccomplex_t IT_0067 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0090 = ((-12)*IT_0028 + 12*conj(IT_0028) + (-6)
      *IT_0048 + 6*conj(IT_0048) + (-6)*IT_0049 + 6*conj(IT_0049))*IT_0074 + 
      (conj(IT_0076) + conj(IT_0078))*IT_0086 + IT_0087*IT_0088 + IT_0065*((-36)
    ...
    const ccomplex_t IT_0093 = (-18)*IT_0067;
    const ccomplex_t IT_0094 = (-18)*IT_0069;
    const ccomplex_t IT_0095 = 36*IT_0071;
    const ccomplex_t IT_0096 = IT_0093 + IT_0094 + IT_0095;
    const ccomplex_t IT_0097 = -IT_0065;
    const ccomplex_t IT_0098 = m_s*s_13;
    const ccomplex_t IT_0099 = IT_0028*IT_0052;
    const ccomplex_t IT_0100 = (-18)*IT_0078;
    const ccomplex_t IT_0101 = IT_0093 + IT_0095;
    const ccomplex_t IT_0102 = IT_0065*IT_0096;
    const ccomplex_t IT_0103 = conj(IT_0028)*(IT_0028*(36*s_34 + (-36)*IT_0029
      ) + (IT_0048 + IT_0049)*IT_0052) + -IT_0066*IT_0073 + (-2)*IT_0074*
      (IT_0065*((-12)*IT_0067 + (-12)*IT_0069 + 24*IT_0071) + 0.5*IT_0073
      ...
      *IT_0091 + 18*IT_0048*IT_0098 + IT_0069*IT_0100 + IT_0076*IT_0101 +
       IT_0102) + conj(IT_0078)*((-18)*IT_0069*IT_0076 + (-18)*IT_0048*IT_0091 +
