        ...
        )
{
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0001 + -m_d*e_em*mu_h*IT_0002*IT_0014*IT_0015*IT_0016);
    const ccomplex_t IT_0057 = (-0.5)*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0002 + m_d*e_em*mu_h*IT_0001*IT_0014*IT_0015*IT_0016);
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0060*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0001;
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0002;
    ...
    const ccomplex_t IT_0106 = IT_0012 + -IT_0030 + IT_0039 + IT_0047 + 
      -IT_0055 + IT_0063 + IT_0071 + IT_0074 + IT_0082 + IT_0086 + IT_0089 +
       IT_0097 + IT_0105;
