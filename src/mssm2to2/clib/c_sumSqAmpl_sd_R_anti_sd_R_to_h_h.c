        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0011*
      (IT_0005*IT_0009 + IT_0003*IT_0015) + (-3)*IT_0005*IT_0008*IT_0016*IT_0017
      *IT_0018);
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0023 + IT_0033 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0023 + IT_0033 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0023 + IT_0033 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0023 + IT_0033 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0023 + IT_0033 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0023 + IT_0033 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0011*
      (IT_0003*IT_0009 + -IT_0005*IT_0015) + (-3)*IT_0003*IT_0008*IT_0016
      *IT_0017*IT_0018);
    const ccomplex_t IT_0071 = 0.333333333333333*IT_0070;
    const ccomplex_t IT_0072 = IT_0002*IT_0011;
    const ccomplex_t IT_0073 = IT_0018 + IT_0072;
    const ccomplex_t IT_0074 = cpow(IT_0005, 3);
    const ccomplex_t IT_0075 = (0 + _Complex_I*-5)*m_W*e_em*IT_0073*(IT_0003*(
      (-0.2)*(IT_0004 + (-5)*IT_0006)*IT_0009 + IT_0003*IT_0005*IT_0015) + -1./5
      *IT_0015*IT_0074);
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_W*e_em*IT_0073*(IT_0003*
      (IT_0006*IT_0015 + -IT_0003*(IT_0005*IT_0009 + IT_0003*IT_0015)) + IT_0009
      *IT_0074);
