...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_ss_L_to_anti_c_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *conj(V_u1)*e_em*IT_0004*IT_0006*IT_0008;
    const ccomplex_t IT_0010 = 0.5*IT_0009;
    const ccomplex_t IT_0011 = cos(beta);
    const ccomplex_t IT_0012 = cpow(IT_0011, -1);
    const ccomplex_t IT_0013 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0004*IT_0008*IT_0012;
    ...
    const ccomplex_t IT_0036 = m_c*m_u;
    const ccomplex_t IT_0037 = -IT_0029 + -IT_0033;
    const ccomplex_t IT_0038 = m_c*s_14;
    const ccomplex_t IT_0039 = 18*s_34;
    const ccomplex_t IT_0040 = m_u*s_13;
    const ccomplex_t IT_0041 = (-18)*conj(IT_0025);
    const ccomplex_t IT_0042 = s_13*s_14;
    const ccomplex_t IT_0043 = pow(m_sd_R, 2);
    const ccomplex_t IT_0044 = s_34*IT_0043;
    const ccomplex_t IT_0045 = IT_0025*((-18)*conj(IT_0035)*IT_0036 + (-18)
      *conj(IT_0037)*IT_0038 + conj(IT_0025)*IT_0039) + IT_0035*(conj(IT_0035)
      *IT_0039 + 18*conj(IT_0037)*IT_0040 + IT_0036*IT_0041) + IT_0037*(18*conj
      (IT_0035)*IT_0040 + IT_0038*IT_0041 + conj(IT_0037)*(36*IT_0042 + (-18)
      *IT_0044));
