...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_ss_L_to_anti_s_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0086 = IT_0048*IT_0085;
    const ccomplex_t IT_0087 = IT_0053*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = m_d*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0097 = -IT_0076 + -IT_0082 + -IT_0088 + -IT_0094;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0118 = -IT_0102 + -IT_0107 + -IT_0112 + -IT_0117;
    const ccomplex_t IT_0119 = pow(m_sd_R, 2);
    const ccomplex_t IT_0120 = m_d*m_s*IT_0119;
    ...
    const ccomplex_t IT_0126 = m_d*m_s;
    const ccomplex_t IT_0127 = m_d*IT_0102;
    const ccomplex_t IT_0128 = m_d*IT_0107;
    const ccomplex_t IT_0129 = m_d*IT_0112;
    const ccomplex_t IT_0130 = IT_0073*IT_0114;
    const ccomplex_t IT_0131 = IT_0024*IT_0025*IT_0130;
    const ccomplex_t IT_0132 = IT_0079*IT_0099;
    const ccomplex_t IT_0133 = IT_0038*IT_0039*IT_0132;
    const ccomplex_t IT_0134 = IT_0085*IT_0104;
    const ccomplex_t IT_0135 = IT_0052*IT_0053*IT_0134;
    const ccomplex_t IT_0136 = IT_0091*IT_0109;
    const ccomplex_t IT_0137 = IT_0066*IT_0067*IT_0136;
    const ccomplex_t IT_0138 = m_d*IT_0117;
    const ccomplex_t IT_0139 = IT_0127 + IT_0128 + IT_0129 + -IT_0131 + 
      -IT_0133 + -IT_0135 + -IT_0137 + IT_0138;
    ...
    const ccomplex_t IT_0148 = m_d*s_13;
    const ccomplex_t IT_0149 = s_34*IT_0008*((-18)*IT_0008 + (-6)*IT_0096 + 6
      *conj(IT_0096)) + conj(IT_0097)*((-18)*IT_0118*IT_0120 + IT_0097*IT_0125) 
      + conj(IT_0118)*((-18)*IT_0097*IT_0120 + IT_0118*IT_0125) + IT_0126*
      (IT_0139*IT_0142 + conj(IT_0139)*IT_0145) + ((-18)*conj(IT_0097)*IT_0139 +
       (-18)*IT_0097*conj(IT_0139) + IT_0118*IT_0142 + conj(IT_0118)*IT_0145)
      *IT_0146 + (IT_0096*conj(IT_0096) + IT_0139*conj(IT_0139))*IT_0147 + (18
      *conj(IT_0118)*IT_0139 + 18*IT_0118*conj(IT_0139) + conj(IT_0097)*(18
      *IT_0096 + IT_0140) + IT_0097*(18*conj(IT_0096) + IT_0144))*IT_0148;
