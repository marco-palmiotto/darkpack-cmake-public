...
ccomplex_return_t c_sumSqAmpl_sd_R_anti_ss_R_to_anti_c_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
    ...
    const ccomplex_t IT_0025 = -IT_0014 + -IT_0022;
    const ccomplex_t IT_0026 = m_u*s_13;
    const ccomplex_t IT_0027 = s_13*s_14;
    const ccomplex_t IT_0028 = pow(m_sd_R, 2);
    const ccomplex_t IT_0029 = s_34*IT_0028;
    return create_ccomplex_return(IT_0024*(18*s_34*conj(IT_0024) + 18*conj
      (IT_0025)*IT_0026) + IT_0025*(18*conj(IT_0024)*IT_0026 + conj(IT_0025)*(36
      *IT_0027 + (-18)*IT_0029)));
}
