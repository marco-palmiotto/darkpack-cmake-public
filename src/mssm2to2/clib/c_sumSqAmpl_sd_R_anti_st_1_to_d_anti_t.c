        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0024 + IT_0025 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0061 = IT_0059*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = N_B4*e_em*conj(U_st_00);
    const ccomplex_t IT_0066 = IT_0008*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = N_W4*e_em*conj(U_st_00);
    const ccomplex_t IT_0069 = IT_0004*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = m_t*N_u4*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0083 = conj(N_B2)*e_em*conj(U_st_10);
    const ccomplex_t IT_0084 = IT_0008*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = m_t*conj(N_u2)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0008;
    const ccomplex_t IT_0095 = (-0.333333333333333)*IT_0094;
    const ccomplex_t IT_0096 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0097 = IT_0008*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = m_t*conj(N_u3)*e_em*IT_0000*conj(U_st_00);
    const ccomplex_t IT_0100 = IT_0017*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*(IT_0098 + (-0.75)*IT_0101);
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0008;
    const ccomplex_t IT_0108 = (-0.333333333333333)*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0110 = IT_0008*IT_0109;
    const ccomplex_t IT_0111 = 1.4142135623731*IT_0110;
    const ccomplex_t IT_0112 = m_t*conj(N_u4)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0008;
    const ccomplex_t IT_0121 = (-0.333333333333333)*IT_0120;
    const ccomplex_t IT_0122 = conj(N_B1)*e_em*conj(U_st_10);
    const ccomplex_t IT_0123 = IT_0008*IT_0122;
    const ccomplex_t IT_0124 = 1.4142135623731*IT_0123;
    const ccomplex_t IT_0125 = m_t*conj(N_u1)*e_em*IT_0000*conj(U_st_00);
    const ccomplex_t IT_0126 = IT_0017*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1)*(IT_0124 + (-0.75)*IT_0127);
    ...
    const ccomplex_t IT_0133 = pow(m_sG, 2);
    const ccomplex_t IT_0134 = cpow((-2)*s_13 + IT_0024 + IT_0025 + -IT_0133 +
       reg_prop, -1);
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*g_s;
    ...
    const ccomplex_t IT_0140 = -IT_0093 + -IT_0106 + -IT_0119 + -IT_0132 +
       0.166666666666667*IT_0139;
    const ccomplex_t IT_0141 = (-0.5)*IT_0139;
    const ccomplex_t IT_0142 = m_d*m_t*IT_0025;
    const ccomplex_t IT_0143 = s_34*IT_0025;
    ...
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*V_td*(A_b*IT_0001 + (
      -0.707106781186548)*m_d*e_em*mu_h*IT_0000*IT_0002*IT_0004*IT_0015)*conj
      (U_st_00);
    ...
    const ccomplex_t IT_0155 = cpow((-2)*s_12 + -IT_0025 + IT_0153 + -IT_0154 
      + -reg_prop, -1);
    const ccomplex_t IT_0156 = IT_0152*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*V_td*(A_b*IT_0015*conj
      (U_st_00) + 0.707106781186548*m_d*e_em*IT_0000*IT_0004*(mu_h*conj(U_st_00)
       + m_t*IT_0002*IT_0016*conj(U_st_10)));
    ...
    const ccomplex_t IT_0162 = cpow((-2)*s_12 + -IT_0025 + -IT_0154 + m_Hp*
    ...
    const ccomplex_t IT_0165 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_00);
    const ccomplex_t IT_0166 = IT_0135*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0168 = IT_0134*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = -IT_0157 + -IT_0164 + (-0.5)*IT_0168;
    const ccomplex_t IT_0170 = IT_0041*IT_0082;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0172 = IT_0043*IT_0170*IT_0171;
    const ccomplex_t IT_0173 = IT_0058*IT_0095;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0175 = IT_0060*IT_0173*IT_0174;
    const ccomplex_t IT_0176 = IT_0075*IT_0108;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0178 = IT_0077*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = m_d*IT_0028;
    const ccomplex_t IT_0180 = m_d*IT_0045;
    const ccomplex_t IT_0181 = m_d*IT_0062;
    const ccomplex_t IT_0182 = m_d*IT_0079;
    const ccomplex_t IT_0183 = IT_0022*IT_0121;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0185 = IT_0026*IT_0183*IT_0184;
    const ccomplex_t IT_0186 = 0.166666666666667*IT_0168 + -IT_0172 + -IT_0175
       + -IT_0178 + IT_0179 + IT_0180 + IT_0181 + IT_0182 + -IT_0185;
    const ccomplex_t IT_0187 = IT_0006*IT_0129;
    const ccomplex_t IT_0188 = IT_0026*IT_0184*IT_0187;
    const ccomplex_t IT_0189 = IT_0030*IT_0090;
    const ccomplex_t IT_0190 = IT_0043*IT_0171*IT_0189;
    const ccomplex_t IT_0191 = IT_0047*IT_0103;
    const ccomplex_t IT_0192 = IT_0060*IT_0174*IT_0191;
    const ccomplex_t IT_0193 = IT_0064*IT_0116;
    const ccomplex_t IT_0194 = IT_0077*IT_0177*IT_0193;
    const ccomplex_t IT_0195 = m_d*IT_0093;
    const ccomplex_t IT_0196 = m_d*IT_0106;
    const ccomplex_t IT_0197 = m_d*IT_0119;
    const ccomplex_t IT_0198 = m_d*IT_0132;
    const ccomplex_t IT_0199 = m_d*IT_0139;
    ...
    const ccomplex_t IT_0215 = IT_0200 + 0.333333333333333*IT_0211;
    const ccomplex_t IT_0216 = 0.333333333333333*conj(IT_0211);
    const ccomplex_t IT_0217 = conj(IT_0200) + IT_0216;
    const ccomplex_t IT_0218 = (-18)*conj(IT_0169);
    const ccomplex_t IT_0219 = (-6)*conj(IT_0186);
    const ccomplex_t IT_0220 = IT_0218 + IT_0219;
    const ccomplex_t IT_0221 = (-18)*conj(IT_0186);
    const ccomplex_t IT_0222 = (-6)*conj(IT_0169);
    const ccomplex_t IT_0223 = IT_0221 + IT_0222;
    const ccomplex_t IT_0224 = (-18)*IT_0186;
    const ccomplex_t IT_0225 = (-6)*IT_0186;
    const ccomplex_t IT_0226 = (conj(IT_0140) + 3*conj(IT_0141))*IT_0169 + 3
      *conj(IT_0080)*IT_0215 + 3*IT_0080*IT_0217 + (-0.166666666666667)*IT_0141
      *IT_0220 + (-0.166666666666667)*IT_0140*IT_0223 + (-0.166666666666667)
      *conj(IT_0140)*IT_0224 + (-0.166666666666667)*conj(IT_0141)*IT_0225;
    const ccomplex_t IT_0227 = 12*IT_0145;
    const ccomplex_t IT_0228 = (-6)*IT_0143;
    const ccomplex_t IT_0229 = m_d*m_t;
    const ccomplex_t IT_0230 = 3*conj(IT_0211);
    const ccomplex_t IT_0231 = m_d*s_14;
    const ccomplex_t IT_0232 = conj(IT_0080)*(IT_0169 + 3*IT_0186) + IT_0080*
      (conj(IT_0169) + 3*conj(IT_0186)) + conj(IT_0141)*(IT_0200 + 3*IT_0211) +
       3*conj(IT_0140)*IT_0215 + 3*IT_0140*IT_0217 + IT_0141*(conj(IT_0200) +
       IT_0230);
    const ccomplex_t IT_0233 = (conj(IT_0080)*((-18)*IT_0140 + (-6)*IT_0141) +
       IT_0080*((-18)*conj(IT_0140) + (-6)*conj(IT_0141)))*IT_0142 + (IT_0080
      *conj(IT_0080) + IT_0140*conj(IT_0140) + IT_0141*conj(IT_0141))*IT_0147 + 
      (conj(IT_0169)*IT_0186 + IT_0169*conj(IT_0186) + conj(IT_0200)*IT_0211 +
       IT_0200*conj(IT_0211))*IT_0212 + (IT_0169*conj(IT_0169) + IT_0186*conj
      (IT_0186) + IT_0200*conj(IT_0200) + IT_0211*conj(IT_0211))*IT_0213 + (-6)
      *IT_0214*IT_0226 + (conj(IT_0140)*IT_0141 + IT_0140*conj(IT_0141))*
      (IT_0227 + IT_0228) + IT_0229*(IT_0211*IT_0220 + IT_0200*IT_0223 + conj
      (IT_0200)*IT_0224 + conj(IT_0211)*IT_0225 + (-6)*IT_0169*(conj(IT_0200) +
       IT_0230)) + 6*IT_0231*IT_0232;
