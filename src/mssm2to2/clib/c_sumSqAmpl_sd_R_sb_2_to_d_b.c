        ...
        )
{
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_3*
    ...
    const ccomplex_t IT_0061 = m_b*conj(N_d3)*e_em*IT_0012*U_sb_11;
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_4*
    ...
    const ccomplex_t IT_0072 = m_b*conj(N_d4)*e_em*IT_0012*U_sb_11;
    ...
    const ccomplex_t IT_0085 = IT_0069*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = -IT_0027 + -IT_0044 + 0.166666666666667*IT_0051
       + -IT_0068 + -IT_0086;
    const ccomplex_t IT_0088 = (-0.5)*IT_0051;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
    ...
    const ccomplex_t IT_0094 = m_b*N_d1*e_em*IT_0012*U_sb_01;
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0008*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0107 = m_b*N_d2*e_em*IT_0012*U_sb_01;
    ...
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0008*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0120 = m_b*N_d3*e_em*IT_0012*U_sb_01;
    ...
    const ccomplex_t IT_0133 = m_b*N_d4*e_em*IT_0012*U_sb_01;
    ...
    const ccomplex_t IT_0142 = m_b*m_d*IT_0001;
    ...
    const ccomplex_t IT_0148 = m_b*s_13;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0150 = IT_0071*IT_0137;
    const ccomplex_t IT_0151 = IT_0069*IT_0149*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0153 = IT_0054*IT_0124;
    const ccomplex_t IT_0154 = IT_0052*IT_0152*IT_0153;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_11;
    ...
    const ccomplex_t IT_0159 = m_sG*IT_0158;
    const ccomplex_t IT_0160 = m_d*IT_0101;
    const ccomplex_t IT_0161 = m_d*IT_0127;
    const ccomplex_t IT_0162 = m_d*IT_0140;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0164 = IT_0030*IT_0098;
    const ccomplex_t IT_0165 = IT_0028*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = m_d*IT_0114;
    const ccomplex_t IT_0167 = IT_0151 + IT_0154 + (-0.166666666666667)
      *IT_0159 + -IT_0160 + -IT_0161 + -IT_0162 + IT_0165 + -IT_0166;
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0169 = IT_0006*IT_0111;
    const ccomplex_t IT_0170 = IT_0002*IT_0168*IT_0169;
    const ccomplex_t IT_0171 = -IT_0170;
    const ccomplex_t IT_0172 = 0.5*IT_0159;
    const ccomplex_t IT_0173 = -conj(IT_0171);
    const ccomplex_t IT_0174 = conj(IT_0167) + 3*conj(IT_0172) + IT_0173;
    const ccomplex_t IT_0175 = m_d*IT_0051;
    const ccomplex_t IT_0176 = (-0.5)*IT_0175;
    const ccomplex_t IT_0177 = IT_0024*IT_0103;
    const ccomplex_t IT_0178 = IT_0002*IT_0168*IT_0177;
    const ccomplex_t IT_0179 = IT_0065*IT_0116;
    const ccomplex_t IT_0180 = IT_0052*IT_0152*IT_0179;
    const ccomplex_t IT_0181 = m_d*IT_0044;
    const ccomplex_t IT_0182 = m_d*IT_0027;
    const ccomplex_t IT_0183 = m_d*IT_0068;
    const ccomplex_t IT_0184 = m_d*IT_0086;
    const ccomplex_t IT_0185 = 0.166666666666667*IT_0175 + IT_0178 + IT_0180 +
       -IT_0181 + -IT_0182 + -IT_0183 + -IT_0184;
    const ccomplex_t IT_0186 = IT_0083*IT_0129;
    const ccomplex_t IT_0187 = IT_0069*IT_0149*IT_0186;
    const ccomplex_t IT_0188 = IT_0041*IT_0090;
    const ccomplex_t IT_0189 = IT_0028*IT_0163*IT_0188;
    const ccomplex_t IT_0190 = -IT_0187 + -IT_0189;
    const ccomplex_t IT_0191 = -IT_0190;
    const ccomplex_t IT_0192 = IT_0185 + IT_0191;
    const ccomplex_t IT_0193 = -conj(IT_0190);
    const ccomplex_t IT_0194 = conj(IT_0185) + IT_0193;
    const ccomplex_t IT_0195 = 6*IT_0172;
    const ccomplex_t IT_0196 = 18*IT_0167;
    const ccomplex_t IT_0197 = (-18)*IT_0171;
    const ccomplex_t IT_0198 = IT_0195 + IT_0196 + IT_0197;
    const ccomplex_t IT_0199 = 6*conj(IT_0172);
    const ccomplex_t IT_0200 = 18*conj(IT_0167);
    const ccomplex_t IT_0201 = (-18)*conj(IT_0171);
    const ccomplex_t IT_0202 = IT_0199 + IT_0200 + IT_0201;
    const ccomplex_t IT_0203 = conj(IT_0088)*(IT_0167 + -IT_0171 + 3*IT_0172) 
      + IT_0088*IT_0174 + conj(IT_0141)*(IT_0176 + 3*IT_0192) + IT_0141*(conj
      (IT_0176) + 3*IT_0194) + 0.166666666666667*conj(IT_0087)*IT_0198 +
       0.166666666666667*IT_0087*IT_0202;
    const ccomplex_t IT_0204 = m_b*m_d;
    const ccomplex_t IT_0205 = 18*IT_0171;
    const ccomplex_t IT_0206 = (-18)*IT_0167;
    const ccomplex_t IT_0207 = (-6)*IT_0172;
    const ccomplex_t IT_0208 = IT_0205 + IT_0206 + IT_0207;
    const ccomplex_t IT_0209 = 18*conj(IT_0171);
    const ccomplex_t IT_0210 = (-18)*conj(IT_0167);
    const ccomplex_t IT_0211 = (-6)*conj(IT_0172);
    const ccomplex_t IT_0212 = IT_0209 + IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = (-6)*IT_0204*(IT_0174*IT_0176 + (IT_0167 + 
      -IT_0171 + 3*IT_0172)*conj(IT_0176) + (-0.166666666666667)*conj(IT_0190)
      *IT_0198 + (-0.166666666666667)*IT_0190*IT_0202 + (-0.166666666666667)
      *conj(IT_0185)*IT_0208 + (-0.166666666666667)*IT_0185*IT_0212);
    const ccomplex_t IT_0214 = m_d*s_14;
    const ccomplex_t IT_0215 = (-6)*conj(IT_0087)*(IT_0176 + 3*IT_0185 + (-3)
      *IT_0190) + (-6)*IT_0087*(conj(IT_0176) + 3*conj(IT_0185) + (-3)*conj
      (IT_0190)) + (-18)*conj(IT_0088)*(IT_0176 + 0.333333333333333*IT_0192) + (
      -18)*IT_0088*(conj(IT_0176) + 0.333333333333333*IT_0194) + conj(IT_0141)
      *IT_0208 + IT_0141*IT_0212;
    const ccomplex_t IT_0216 = 6*s_34;
    const ccomplex_t IT_0217 = 18*s_34;
    const ccomplex_t IT_0218 = (-18)*s_34;
    const ccomplex_t IT_0219 = (-6)*s_34;
    const ccomplex_t IT_0220 = 12*IT_0145;
    const ccomplex_t IT_0221 = (-6)*IT_0143;
    const ccomplex_t IT_0222 = (((-18)*conj(IT_0087) + (-6)*conj(IT_0088))
      *IT_0141 + ((-18)*IT_0087 + (-6)*IT_0088)*conj(IT_0141))*IT_0142 + 
      (IT_0087*conj(IT_0087) + IT_0088*conj(IT_0088) + IT_0141*conj(IT_0141))
      *IT_0147 + 6*IT_0148*IT_0203 + IT_0213 + IT_0214*IT_0215 + (conj(IT_0167)
      *IT_0172 + IT_0167*conj(IT_0172) + conj(IT_0176)*IT_0185 + IT_0176*conj
      (IT_0185))*IT_0216 + (IT_0167*conj(IT_0167) + IT_0171*conj(IT_0171) +
       IT_0172*conj(IT_0172) + IT_0176*conj(IT_0176) + IT_0185*conj(IT_0185) +
       IT_0190*conj(IT_0190))*IT_0217 + (conj(IT_0167)*IT_0171 + IT_0167*conj
      (IT_0171) + conj(IT_0185)*IT_0190 + IT_0185*conj(IT_0190))*IT_0218 + (conj
      (IT_0171)*IT_0172 + IT_0171*conj(IT_0172) + conj(IT_0176)*IT_0190 +
       IT_0176*conj(IT_0190))*IT_0219 + (conj(IT_0087)*IT_0088 + IT_0087*conj
      (IT_0088))*(IT_0220 + IT_0221);
