        ...
        )
{
    ...
    const ccomplex_t IT_0127 = m_d*s_13;
    const ccomplex_t IT_0128 = m_d*IT_0007;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0130 = IT_0033*IT_0107;
    const ccomplex_t IT_0131 = IT_0037*IT_0129*IT_0130;
    const ccomplex_t IT_0132 = m_d*IT_0025;
    const ccomplex_t IT_0133 = m_d*IT_0039;
    const ccomplex_t IT_0134 = m_d*IT_0053;
    const ccomplex_t IT_0135 = m_d*IT_0067;
    const ccomplex_t IT_0136 = 0.166666666666667*IT_0128 + IT_0131 + -IT_0132 
      + -IT_0133 + -IT_0134 + -IT_0135;
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0138 = IT_0047*IT_0114;
    const ccomplex_t IT_0139 = IT_0051*IT_0137*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0141 = IT_0019*IT_0091;
    const ccomplex_t IT_0142 = IT_0023*IT_0140*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0144 = IT_0061*IT_0100;
    const ccomplex_t IT_0145 = IT_0065*IT_0143*IT_0144;
    const ccomplex_t IT_0146 = -IT_0139 + -IT_0142 + -IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*conj(V_cd)*e_em*conj(V_Wp1)
      *IT_0014;
    const ccomplex_t IT_0149 = IT_0077*IT_0148;
    const ccomplex_t IT_0150 = IT_0070*IT_0147*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*conj(V_cd)*e_em*conj(V_Wp2)
      *IT_0014;
    const ccomplex_t IT_0152 = IT_0082*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0154 = IT_0086*IT_0152*IT_0153;
    const ccomplex_t IT_0155 = (-0.5)*IT_0128 + IT_0150 + IT_0154;
    const ccomplex_t IT_0156 = -IT_0146;
    const ccomplex_t IT_0157 = IT_0136 + IT_0156;
    const ccomplex_t IT_0158 = -conj(IT_0146);
    const ccomplex_t IT_0159 = conj(IT_0136) + IT_0158;
    const ccomplex_t IT_0160 = IT_0049*IT_0116;
    const ccomplex_t IT_0161 = IT_0051*IT_0137*IT_0160;
    const ccomplex_t IT_0162 = -IT_0161;
    const ccomplex_t IT_0163 = 18*IT_0162;
    const ccomplex_t IT_0164 = IT_0021*IT_0095;
    const ccomplex_t IT_0165 = IT_0023*IT_0140*IT_0164;
    const ccomplex_t IT_0166 = IT_0035*IT_0109;
    const ccomplex_t IT_0167 = IT_0037*IT_0129*IT_0166;
    const ccomplex_t IT_0168 = -IT_0165 + -IT_0167;
    const ccomplex_t IT_0169 = 18*IT_0168;
    const ccomplex_t IT_0170 = IT_0063*IT_0102;
    const ccomplex_t IT_0171 = IT_0065*IT_0143*IT_0170;
    const ccomplex_t IT_0172 = m_d*IT_0098;
    const ccomplex_t IT_0173 = m_d*IT_0105;
    const ccomplex_t IT_0174 = m_d*IT_0112;
    const ccomplex_t IT_0175 = m_d*IT_0119;
    const ccomplex_t IT_0176 = IT_0171 + -IT_0172 + -IT_0173 + -IT_0174 + 
      -IT_0175;
    const ccomplex_t IT_0177 = (-18)*IT_0176;
    const ccomplex_t IT_0178 = IT_0080 + IT_0088;
    const ccomplex_t IT_0179 = m_c*IT_0178;
    const ccomplex_t IT_0180 = -IT_0179;
    const ccomplex_t IT_0181 = (-6)*IT_0180;
    const ccomplex_t IT_0182 = IT_0163 + IT_0169 + IT_0177 + IT_0181;
    const ccomplex_t IT_0183 = 18*conj(IT_0162);
    const ccomplex_t IT_0184 = 18*conj(IT_0168);
    const ccomplex_t IT_0185 = (-18)*conj(IT_0176);
    const ccomplex_t IT_0186 = (-6)*conj(IT_0180);
    const ccomplex_t IT_0187 = IT_0183 + IT_0184 + IT_0185 + IT_0186;
    const ccomplex_t IT_0188 = conj(IT_0068)*((-18)*IT_0136 + 18*IT_0146 + (-6
      )*IT_0155) + IT_0068*((-18)*conj(IT_0136) + 18*conj(IT_0146) + (-6)*conj
      (IT_0155)) + (-18)*conj(IT_0089)*(IT_0155 + 0.333333333333333*IT_0157) + (
      -18)*IT_0089*(conj(IT_0155) + 0.333333333333333*IT_0159) + conj(IT_0120)
      *IT_0182 + IT_0120*IT_0187;
    const ccomplex_t IT_0189 = 6*s_34;
    const ccomplex_t IT_0190 = conj(IT_0162) + conj(IT_0168);
    const ccomplex_t IT_0191 = 18*s_34;
    const ccomplex_t IT_0192 = (-18)*s_34;
    const ccomplex_t IT_0193 = IT_0162 + IT_0168;
    const ccomplex_t IT_0194 = conj(IT_0176)*IT_0192;
    const ccomplex_t IT_0195 = (-6)*s_34;
    const ccomplex_t IT_0196 = 12*IT_0124;
    const ccomplex_t IT_0197 = (-6)*IT_0122;
    const ccomplex_t IT_0198 = m_c*m_d;
    const ccomplex_t IT_0199 = -conj(IT_0168);
    const ccomplex_t IT_0200 = -conj(IT_0162);
    const ccomplex_t IT_0201 = conj(IT_0176) + 3*conj(IT_0180) + IT_0199 +
       IT_0200;
    const ccomplex_t IT_0202 = 6*IT_0180;
    const ccomplex_t IT_0203 = 18*IT_0176;
    const ccomplex_t IT_0204 = (-18)*IT_0162;
    const ccomplex_t IT_0205 = (-18)*IT_0168;
    const ccomplex_t IT_0206 = IT_0202 + IT_0203 + IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = 6*conj(IT_0180);
    const ccomplex_t IT_0208 = 18*conj(IT_0176);
    const ccomplex_t IT_0209 = (-18)*conj(IT_0162);
    const ccomplex_t IT_0210 = (-18)*conj(IT_0168);
    const ccomplex_t IT_0211 = IT_0207 + IT_0208 + IT_0209 + IT_0210;
    const ccomplex_t IT_0212 = -IT_0168;
    const ccomplex_t IT_0213 = (-0.166666666666667)*conj(IT_0136)*IT_0182 + (
      -0.166666666666667)*IT_0136*IT_0187 + IT_0155*IT_0201 + (
      -0.166666666666667)*conj(IT_0146)*IT_0206 + (-0.166666666666667)*IT_0146
      *IT_0211 + -conj(IT_0155)*(IT_0162 + -IT_0176 + (-3)*IT_0180 + -IT_0212);
    const ccomplex_t IT_0214 = m_c*s_14;
    const ccomplex_t IT_0215 = conj(IT_0120)*(IT_0155 + 3*IT_0157) + IT_0120*
      (conj(IT_0155) + 3*IT_0159) + IT_0089*IT_0201 + 0.166666666666667*conj
      (IT_0068)*IT_0206 + 0.166666666666667*IT_0068*IT_0211 + -conj(IT_0089)*
      (IT_0162 + -IT_0176 + (-3)*IT_0180 + -IT_0212);
    const ccomplex_t IT_0216 = (((-18)*conj(IT_0068) + (-6)*conj(IT_0089))
      *IT_0120 + ((-18)*IT_0068 + (-6)*IT_0089)*conj(IT_0120))*IT_0121 + 
      (IT_0068*conj(IT_0068) + IT_0089*conj(IT_0089) + IT_0120*conj(IT_0120))
      *IT_0126 + IT_0127*IT_0188 + (conj(IT_0136)*IT_0155 + IT_0136*conj(IT_0155
      ) + conj(IT_0176)*IT_0180 + IT_0176*conj(IT_0180))*IT_0189 + (IT_0136*conj
      (IT_0136) + IT_0146*conj(IT_0146) + IT_0155*conj(IT_0155) + IT_0176*conj
      (IT_0176) + IT_0180*conj(IT_0180) + (IT_0162 + IT_0168)*IT_0190)*IT_0191 +
       (conj(IT_0136)*IT_0146 + IT_0136*conj(IT_0146) + IT_0176*IT_0190)*IT_0192
       + IT_0193*IT_0194 + (conj(IT_0146)*IT_0155 + IT_0146*conj(IT_0155) +
       IT_0180*IT_0190 + conj(IT_0180)*IT_0193)*IT_0195 + (conj(IT_0068)*IT_0089
       + IT_0068*conj(IT_0089))*(IT_0196 + IT_0197) + (-6)*IT_0198*IT_0213 + 6
      *IT_0214*IT_0215;
