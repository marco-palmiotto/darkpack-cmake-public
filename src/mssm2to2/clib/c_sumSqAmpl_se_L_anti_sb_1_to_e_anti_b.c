        ...
        )
{
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0009*IT_0016*IT_0018;
    ...
    const ccomplex_t IT_0117 = m_e*IT_0033;
    const ccomplex_t IT_0118 = m_e*IT_0058;
    const ccomplex_t IT_0119 = m_e*IT_0081;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0009*IT_0016*IT_0018;
    ...
    const ccomplex_t IT_0130 = m_e*IT_0105;
