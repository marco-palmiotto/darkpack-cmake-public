...
ccomplex_return_t c_sumSqAmpl_se_L_anti_sb_1_to_e_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = N_W2*e_em*conj(U_sb_00);
    const ccomplex_t IT_0045 = IT_0009*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = m_b*N_d2*e_em*IT_0018*conj(U_sb_10);
    ...
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_3*
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_4*
    ...
    const ccomplex_t IT_0108 = -IT_0034 + -IT_0058 + -IT_0083 + -IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0009*IT_0016*IT_0018;
    const ccomplex_t IT_0111 = (-0.5)*IT_0110;
    const ccomplex_t IT_0112 = IT_0031*IT_0111;
    const ccomplex_t IT_0113 = IT_0002*IT_0109*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0009*IT_0016*IT_0018;
    const ccomplex_t IT_0116 = (-0.5)*IT_0115;
    const ccomplex_t IT_0117 = IT_0055*IT_0116;
    const ccomplex_t IT_0118 = IT_0035*IT_0114*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0009*IT_0016*IT_0018;
    const ccomplex_t IT_0121 = (-0.5)*IT_0120;
    const ccomplex_t IT_0122 = IT_0080*IT_0121;
    const ccomplex_t IT_0123 = IT_0059*IT_0119*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0009*IT_0016*IT_0018;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = IT_0104*IT_0126;
    const ccomplex_t IT_0128 = IT_0084*IT_0124*IT_0127;
    const ccomplex_t IT_0129 = m_e*IT_0034;
    const ccomplex_t IT_0130 = m_e*IT_0058;
    const ccomplex_t IT_0131 = m_e*IT_0083;
    const ccomplex_t IT_0132 = m_e*IT_0107;
    const ccomplex_t IT_0133 = -IT_0113 + -IT_0118 + -IT_0123 + -IT_0128 +
       IT_0129 + IT_0130 + IT_0131 + IT_0132;
    const ccomplex_t IT_0134 = m_e*s_14;
    const ccomplex_t IT_0135 = m_b*conj(N_d3)*e_em*IT_0018*conj(U_sb_00);
    const ccomplex_t IT_0136 = IT_0017*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = conj(N_B3)*e_em*conj(U_sb_10);
    ...
    const ccomplex_t IT_0145 = IT_0059*IT_0119*IT_0144;
    const ccomplex_t IT_0146 = conj(N_B1)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0147 = IT_0004*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = m_b*conj(N_d1)*e_em*IT_0018*conj(U_sb_00);
    ...
    const ccomplex_t IT_0155 = IT_0002*IT_0109*IT_0154;
    ...
    const ccomplex_t IT_0159 = m_b*conj(N_d2)*e_em*IT_0018*conj(U_sb_00);
    ...
    const ccomplex_t IT_0164 = 1.5*IT_0163;
    const ccomplex_t IT_0165 = (-0.333333333333333)*IT_0164;
    const ccomplex_t IT_0166 = IT_0043*IT_0165;
    const ccomplex_t IT_0167 = IT_0035*IT_0114*IT_0166;
    const ccomplex_t IT_0168 = m_b*conj(N_d4)*e_em*IT_0018*conj(U_sb_00);
    const ccomplex_t IT_0169 = IT_0017*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = conj(N_B4)*e_em*conj(U_sb_10);
    ...
    const ccomplex_t IT_0177 = IT_0092*IT_0176;
    const ccomplex_t IT_0178 = IT_0084*IT_0124*IT_0177;
    const ccomplex_t IT_0179 = IT_0111*IT_0153;
    ...
    const ccomplex_t IT_0183 = IT_0116*IT_0165;
    const ccomplex_t IT_0184 = IT_0035*IT_0183;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*IT_0184;
    const ccomplex_t IT_0186 = m_e*IT_0185;
    const ccomplex_t IT_0187 = IT_0121*IT_0143;
    const ccomplex_t IT_0188 = IT_0059*IT_0187;
    const ccomplex_t IT_0189 = (0 + _Complex_I*1)*IT_0188;
    const ccomplex_t IT_0190 = m_e*IT_0189;
    const ccomplex_t IT_0191 = IT_0126*IT_0176;
    const ccomplex_t IT_0192 = IT_0084*IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1)*IT_0192;
    const ccomplex_t IT_0194 = m_e*IT_0193;
    const ccomplex_t IT_0195 = -IT_0145 + -IT_0155 + -IT_0167 + -IT_0178 +
       IT_0182 + IT_0186 + IT_0190 + IT_0194;
    const ccomplex_t IT_0196 = m_b*s_13;
    const ccomplex_t IT_0197 = -IT_0181 + -IT_0185 + -IT_0189 + -IT_0193;
    const ccomplex_t IT_0198 = m_b*m_e*IT_0001;
    const ccomplex_t IT_0199 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0204 = m_b*m_e;
    const ccomplex_t IT_0205 = 6*s_34;
    const ccomplex_t IT_0206 = -conj(IT_0108);
    const ccomplex_t IT_0207 = (-6)*conj(IT_0133);
    const ccomplex_t IT_0208 = 6*IT_0108*(conj(IT_0133)*IT_0134 + -conj
      (IT_0195)*IT_0196 + -conj(IT_0197)*IT_0198 + 0.166666666666667*conj
      (IT_0108)*IT_0203) + (-6)*IT_0133*(IT_0196*conj(IT_0197) + conj(IT_0195)
      *IT_0204 + (-0.166666666666667)*conj(IT_0133)*IT_0205 + IT_0134*IT_0206) +
       6*IT_0197*(IT_0134*conj(IT_0195) + 0.166666666666667*conj(IT_0197)
      *IT_0203 + IT_0198*IT_0206 + 0.166666666666667*IT_0196*IT_0207) + 6
      *IT_0195*(IT_0134*conj(IT_0197) + 0.166666666666667*conj(IT_0195)*IT_0205 
      + IT_0196*IT_0206 + 0.166666666666667*IT_0204*IT_0207);
