        ...
        )
{
    ...
    const ccomplex_t IT_0028 = pow(m_e, 2);
    ...
    const ccomplex_t IT_0041 = N_B2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0042 = IT_0001*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = N_W2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0045 = IT_0006*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = m_b*N_d2*e_em*IT_0021*conj(U_sb_11);
    ...
    const ccomplex_t IT_0064 = N_B3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_W3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0068 = IT_0006*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = m_b*N_d3*e_em*IT_0021*conj(U_sb_11);
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0006*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0123 = m_e*IT_0032;
    const ccomplex_t IT_0124 = m_e*IT_0055;
    const ccomplex_t IT_0125 = m_e*IT_0078;
    const ccomplex_t IT_0126 = m_e*IT_0101;
    const ccomplex_t IT_0127 = -IT_0107 + -IT_0112 + -IT_0117 + -IT_0122 +
       IT_0123 + IT_0124 + IT_0125 + IT_0126;
    const ccomplex_t IT_0128 = m_e*s_14;
    ...
    const ccomplex_t IT_0132 = m_b*conj(N_d3)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0138 = IT_0076*IT_0116*IT_0137;
    ...
    const ccomplex_t IT_0142 = m_b*conj(N_d1)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0148 = IT_0030*IT_0106*IT_0147;
    const ccomplex_t IT_0149 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0150 = IT_0001*IT_0149;
    const ccomplex_t IT_0151 = 1.4142135623731*IT_0150;
    const ccomplex_t IT_0152 = m_b*conj(N_d2)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0158 = IT_0053*IT_0111*IT_0157;
    const ccomplex_t IT_0159 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0160 = IT_0001*IT_0159;
    const ccomplex_t IT_0161 = 1.4142135623731*IT_0160;
    const ccomplex_t IT_0162 = m_b*conj(N_d4)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0169 = IT_0104*IT_0146;
    const ccomplex_t IT_0170 = IT_0030*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*IT_0170;
    const ccomplex_t IT_0172 = m_e*IT_0171;
    const ccomplex_t IT_0173 = IT_0109*IT_0156;
    ...
    const ccomplex_t IT_0177 = IT_0114*IT_0136;
    ...
    const ccomplex_t IT_0186 = m_b*s_13;
    const ccomplex_t IT_0187 = -IT_0171 + -IT_0175 + -IT_0179 + -IT_0183;
    const ccomplex_t IT_0188 = m_b*m_e*IT_0029;
    const ccomplex_t IT_0189 = s_34*IT_0029;
    ...
    const ccomplex_t IT_0194 = m_b*m_e;
    const ccomplex_t IT_0195 = 6*s_34;
    const ccomplex_t IT_0196 = -conj(IT_0102);
    const ccomplex_t IT_0197 = (-6)*conj(IT_0127);
    const ccomplex_t IT_0198 = 6*IT_0102*(conj(IT_0127)*IT_0128 + -conj
      (IT_0185)*IT_0186 + -conj(IT_0187)*IT_0188 + 0.166666666666667*conj
      (IT_0102)*IT_0193) + (-6)*IT_0127*(IT_0186*conj(IT_0187) + conj(IT_0185)
      *IT_0194 + (-0.166666666666667)*conj(IT_0127)*IT_0195 + IT_0128*IT_0196) +
       6*IT_0187*(IT_0128*conj(IT_0185) + 0.166666666666667*conj(IT_0187)
      *IT_0193 + IT_0188*IT_0196 + 0.166666666666667*IT_0186*IT_0197) + 6
      *IT_0185*(IT_0128*conj(IT_0187) + 0.166666666666667*conj(IT_0185)*IT_0195 
      + IT_0186*IT_0196 + 0.166666666666667*IT_0194*IT_0197);
