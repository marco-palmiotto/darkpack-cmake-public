...
ccomplex_return_t c_sumSqAmpl_se_L_anti_sc_L_to_e_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0099 = IT_0063*IT_0097*IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0104 = IT_0083*IT_0102*IT_0103;
    const ccomplex_t IT_0105 = m_e*IT_0025;
    const ccomplex_t IT_0106 = m_e*IT_0045;
    const ccomplex_t IT_0107 = m_e*IT_0065;
    const ccomplex_t IT_0108 = m_e*IT_0085;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0113 = IT_0023*IT_0111*IT_0112;
    const ccomplex_t IT_0114 = -IT_0094 + -IT_0099 + -IT_0104 + IT_0105 +
       IT_0106 + IT_0107 + IT_0108 + -IT_0113;
    const ccomplex_t IT_0115 = m_e*s_14;
    const ccomplex_t IT_0116 = sin(beta);
    const ccomplex_t IT_0117 = cpow(IT_0116, -1);
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0006*IT_0087*IT_0117;
    ...
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0006*IT_0087*IT_0117;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0006*IT_0087*IT_0117;
    ...
    const ccomplex_t IT_0135 = m_e*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0006*IT_0087*IT_0117;
    const ccomplex_t IT_0137 = (-0.5)*IT_0136;
    const ccomplex_t IT_0138 = IT_0011*IT_0137;
    const ccomplex_t IT_0139 = IT_0023*IT_0112*IT_0138;
    const ccomplex_t IT_0140 = IT_0033*IT_0119;
    const ccomplex_t IT_0141 = IT_0043*IT_0093*IT_0140;
    const ccomplex_t IT_0142 = IT_0053*IT_0125;
    const ccomplex_t IT_0143 = IT_0063*IT_0098*IT_0142;
    const ccomplex_t IT_0144 = IT_0073*IT_0131;
    const ccomplex_t IT_0145 = IT_0083*IT_0103*IT_0144;
    const ccomplex_t IT_0146 = IT_0110*IT_0137;
    const ccomplex_t IT_0147 = IT_0023*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*IT_0147;
    const ccomplex_t IT_0149 = m_e*IT_0148;
    const ccomplex_t IT_0150 = IT_0123 + IT_0129 + IT_0135 + -IT_0139 + 
      -IT_0141 + -IT_0143 + -IT_0145 + IT_0149;
    const ccomplex_t IT_0151 = m_c*s_13;
    const ccomplex_t IT_0152 = -IT_0122 + -IT_0128 + -IT_0134 + -IT_0148;
    const ccomplex_t IT_0153 = m_c*m_e*IT_0022;
    const ccomplex_t IT_0154 = s_34*IT_0022;
    ...
    const ccomplex_t IT_0160 = m_c*m_e;
    const ccomplex_t IT_0161 = (-6)*conj(IT_0114);
    const ccomplex_t IT_0162 = (-6)*IT_0114;
    const ccomplex_t IT_0163 = -IT_0086;
    const ccomplex_t IT_0164 = 6*conj(IT_0086)*(IT_0114*IT_0115 + -IT_0150
      *IT_0151 + -IT_0152*IT_0153 + 0.166666666666667*IT_0086*IT_0158) + 6*conj
      (IT_0114)*(IT_0086*IT_0115 + 0.166666666666667*IT_0114*IT_0159) + (IT_0151
      *IT_0152 + IT_0150*IT_0160)*IT_0161 + 6*conj(IT_0150)*(IT_0115*IT_0152 +
       0.166666666666667*IT_0150*IT_0159 + 0.166666666666667*IT_0160*IT_0162 +
       IT_0151*IT_0163) + 6*conj(IT_0152)*(IT_0115*IT_0150 + 0.166666666666667
      *IT_0152*IT_0158 + 0.166666666666667*IT_0151*IT_0162 + IT_0153*IT_0163);
    return create_ccomplex_return(IT_0164);
}
