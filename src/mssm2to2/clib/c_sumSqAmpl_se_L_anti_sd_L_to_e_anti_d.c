...
ccomplex_return_t c_sumSqAmpl_se_L_anti_sd_L_to_e_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
    ...
    const ccomplex_t IT_0124 = IT_0096*IT_0123;
    const ccomplex_t IT_0125 = IT_0063*IT_0124;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*IT_0125;
    const ccomplex_t IT_0127 = m_e*IT_0126;
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0006*IT_0087*IT_0089;
    const ccomplex_t IT_0129 = (-0.5)*IT_0128;
    const ccomplex_t IT_0130 = IT_0101*IT_0129;
    const ccomplex_t IT_0131 = IT_0083*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*IT_0131;
    const ccomplex_t IT_0133 = m_e*IT_0132;
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0006*IT_0087*IT_0089;
    const ccomplex_t IT_0135 = (-0.5)*IT_0134;
    const ccomplex_t IT_0136 = IT_0011*IT_0135;
    const ccomplex_t IT_0137 = IT_0023*IT_0112*IT_0136;
    const ccomplex_t IT_0138 = IT_0033*IT_0117;
    const ccomplex_t IT_0139 = IT_0043*IT_0093*IT_0138;
    const ccomplex_t IT_0140 = IT_0053*IT_0123;
    const ccomplex_t IT_0141 = IT_0063*IT_0098*IT_0140;
    const ccomplex_t IT_0142 = IT_0073*IT_0129;
    const ccomplex_t IT_0143 = IT_0083*IT_0103*IT_0142;
    const ccomplex_t IT_0144 = IT_0110*IT_0135;
    const ccomplex_t IT_0145 = IT_0023*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*IT_0145;
    const ccomplex_t IT_0147 = m_e*IT_0146;
    const ccomplex_t IT_0148 = IT_0121 + IT_0127 + IT_0133 + -IT_0137 + 
      -IT_0139 + -IT_0141 + -IT_0143 + IT_0147;
    const ccomplex_t IT_0149 = m_d*s_13;
    const ccomplex_t IT_0150 = -IT_0120 + -IT_0126 + -IT_0132 + -IT_0146;
    const ccomplex_t IT_0151 = m_d*m_e*IT_0022;
    ...
    const ccomplex_t IT_0157 = 6*s_34;
    const ccomplex_t IT_0158 = m_d*m_e;
    const ccomplex_t IT_0159 = (-6)*conj(IT_0114);
    const ccomplex_t IT_0160 = (-6)*IT_0114;
    const ccomplex_t IT_0161 = -IT_0086;
    const ccomplex_t IT_0162 = 6*conj(IT_0086)*(IT_0114*IT_0115 + -IT_0148
      *IT_0149 + -IT_0150*IT_0151 + 0.166666666666667*IT_0086*IT_0156) + 6*conj
      (IT_0114)*(IT_0086*IT_0115 + 0.166666666666667*IT_0114*IT_0157) + (IT_0149
      *IT_0150 + IT_0148*IT_0158)*IT_0159 + 6*conj(IT_0148)*(IT_0115*IT_0150 +
       0.166666666666667*IT_0148*IT_0157 + 0.166666666666667*IT_0158*IT_0160 +
       IT_0149*IT_0161) + 6*conj(IT_0150)*(IT_0115*IT_0148 + 0.166666666666667
      *IT_0150*IT_0156 + 0.166666666666667*IT_0149*IT_0160 + IT_0151*IT_0161);
