...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_L_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = -IT_0001;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*m_W*e_em*IT_0022*(IT_0018
      *IT_0023 + IT_0024*(IT_0008*IT_0016 + (IT_0001*IT_0016 + -IT_0007*IT_0018)
      *IT_0024));
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*(IT_0010*IT_0014
      *IT_0015*IT_0017*IT_0018 + 0.5*m_W*(IT_0004*IT_0005 + -IT_0017)*(IT_0007
      *IT_0016 + IT_0001*IT_0018));
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_W*e_em*IT_0022*(IT_0001*
      (IT_0008*IT_0018 + -IT_0001*(IT_0007*IT_0016 + IT_0001*IT_0018)) + IT_0016
      *IT_0023);
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0028 + IT_0036 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0035*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*IT_0048;
    const ccomplex_t IT_0050 = IT_0013 + -IT_0031 + IT_0039 + -IT_0046 +
       IT_0049;
