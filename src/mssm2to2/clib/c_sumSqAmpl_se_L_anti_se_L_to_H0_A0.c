...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_L_to_H0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_se_R*
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
