        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_se_R*
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*5)*m_W*e_em*IT_0038*(IT_0007*
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0021*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*-1)*m_W*e_em*IT_0038*(IT_0007*(
      (IT_0002 + -IT_0008)*IT_0011 + IT_0001*IT_0007*IT_0027) + -IT_0027*IT_0039);
