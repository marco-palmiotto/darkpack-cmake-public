...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_L_to_Z_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = cpow(IT_0017, -1);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*e_em*(0.5*m_W*(IT_0017
      *IT_0018 + -IT_0020*IT_0021)*(IT_0001*IT_0004 + -IT_0026) + IT_0018
      *IT_0026*IT_0034*IT_0035*IT_0036);
    const ccomplex_t IT_0038 = -IT_0037;
    const ccomplex_t IT_0039 = IT_0033*IT_0038;
    const ccomplex_t IT_0040 = pow(m_se_L, 2);
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*e_em*(0.5*m_W*(IT_0018
      *IT_0020 + IT_0017*IT_0021)*(IT_0001*IT_0004 + -IT_0026) + IT_0021*IT_0026
    ...
    const ccomplex_t IT_0058 = IT_0016 + -IT_0043 + -IT_0057;
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*-1)*e_em*(IT_0003*IT_0026 + 
      -IT_0001*IT_0062);
    const ccomplex_t IT_0064 = -IT_0063;
    const ccomplex_t IT_0065 = cpow(IT_0064, 2);
    const ccomplex_t IT_0066 = pow(m_Z, 2);
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0066 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0066 + (0 + _Complex_I*1)
      *m_se_L*Gamma_el + reg_prop, -1);
    ...
    const ccomplex_t IT_0090 = -IT_0040;
    ...
    const ccomplex_t IT_0096 = -(IT_0040 + -IT_0089)*(IT_0040 + -IT_0095);
    ...
    const ccomplex_t IT_0100 = -(s_12 + -IT_0081)*(IT_0040 + -IT_0089);
    const ccomplex_t IT_0101 = -conj(IT_0069);
    const ccomplex_t IT_0102 = IT_0060*IT_0071;
    const ccomplex_t IT_0103 = -(IT_0040 + -IT_0087)*(IT_0066 + -IT_0102);
    const ccomplex_t IT_0104 = -conj(IT_0058);
    const ccomplex_t IT_0105 = -(IT_0040 + -IT_0087)*(s_23 + -IT_0098);
