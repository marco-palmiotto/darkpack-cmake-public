...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_L_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0029
      *IT_0031*IT_0032;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0029
      *IT_0031*IT_0036;
    ...
    const ccomplex_t IT_0084 = m_mu*s_14;
