...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_L_to_h_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_se_R*
    ...
    const ccomplex_t IT_0031 = -IT_0022;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
