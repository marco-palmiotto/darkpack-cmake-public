...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_L_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0026 + IT_0043 + -m_se_R*
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0026 + IT_0043 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
