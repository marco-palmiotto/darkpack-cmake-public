        ...
        )
{
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0022 + (0 + _Complex_I*1)
      *m_se_L*Gamma_el + reg_prop, -1);
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_W*e_em*IT_0036*(IT_0001*
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_12 + (-2)*IT_0023 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0010
      *IT_0015*IT_0016*IT_0017 + 0.5*m_W*(IT_0004*IT_0005 + -IT_0017)*(IT_0001
      *IT_0011 + -IT_0007*IT_0027));
    const ccomplex_t IT_0045 = -IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*-5)*m_W*e_em*IT_0036*(IT_0001*(
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0021*IT_0051;
    const ccomplex_t IT_0053 = IT_0014 + IT_0025 + IT_0031 + IT_0033 + 
      -IT_0042 + -IT_0050 + IT_0052;
