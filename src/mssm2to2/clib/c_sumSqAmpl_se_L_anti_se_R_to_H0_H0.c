        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*m_W*e_em*IT_0011*(IT_0001
      *IT_0013 + 5*IT_0003*((-1)*IT_0003*(IT_0001*IT_0012 + 1./5*IT_0003*IT_0014
      ) + IT_0014*IT_0015));
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0020 + IT_0037 + -m_se_L*
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_23 + IT_0037 + (0 + _Complex_I*1)
      *m_se_R*Gamma_er + reg_prop, -1);
    const ccomplex_t IT_0047 = IT_0045*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0019 + IT_0037 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0045*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = -IT_0023 + -IT_0032 + IT_0040 + IT_0043 +
       IT_0048 + IT_0051;
