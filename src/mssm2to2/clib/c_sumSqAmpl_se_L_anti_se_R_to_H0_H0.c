...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_R_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*-1)*e_em*(IT_0000*IT_0002
      *IT_0005*IT_0008*IT_0009 + -m_W*IT_0004*(IT_0001*IT_0009 + -IT_0003
      *IT_0010)*IT_0012);
    const ccomplex_t IT_0021 = IT_0007*IT_0020;
    const ccomplex_t IT_0022 = cpow((-2)*s_23 + IT_0016 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0016 + IT_0029 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0021*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0000
      *IT_0002*IT_0005*IT_0009;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = IT_0004*IT_0012;
    const ccomplex_t IT_0036 = IT_0005 + IT_0035;
    const ccomplex_t IT_0037 = cpow(IT_0003, 3);
    const ccomplex_t IT_0038 = cpow(IT_0003, 2);
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*m_W*e_em*IT_0036*(IT_0001
      *IT_0037 + 5*IT_0009*((-1)*IT_0009*(IT_0001*IT_0003 + 1./5*IT_0009*IT_0010
      ) + IT_0010*IT_0038));
    ...
    const ccomplex_t IT_0045 = cpow(IT_0009, 2);
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_W*e_em*IT_0036*(IT_0010
      *IT_0037 + -IT_0009*(IT_0003*IT_0009*IT_0010 + IT_0001*(IT_0038 + -IT_0045
      )));
    const ccomplex_t IT_0047 = (-1.5)*IT_0046;
    const ccomplex_t IT_0048 = IT_0007*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_12 + -IT_0025 + -IT_0029 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = IT_0019 + IT_0024 + IT_0028 + IT_0032 + 
      -IT_0044 + -IT_0051;
