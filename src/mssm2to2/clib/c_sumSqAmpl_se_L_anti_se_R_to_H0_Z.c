...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_R_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = m_e*e_em*mu_h*IT_0004*IT_0007*IT_0010*IT_0011;
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0005
    ...
    const ccomplex_t IT_0030 = e_em*IT_0001*(IT_0003*IT_0004 + -IT_0002
      *IT_0005)*IT_0007;
    const ccomplex_t IT_0031 = m_e*e_em*mu_h*IT_0007*IT_0010;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0015 + IT_0025 + -m_se_R*
