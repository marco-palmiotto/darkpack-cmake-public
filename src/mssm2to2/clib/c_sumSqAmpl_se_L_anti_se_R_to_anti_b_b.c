...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_R_to_anti_b_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = m_e*e_em*mu_h*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0018 = m_e*e_em*mu_h*IT_0000*IT_0002*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_b*e_em*IT_0000*IT_0002
      *IT_0005*IT_0027;
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_b*e_em*IT_0000*IT_0002
      *IT_0005*IT_0030;
