        ...
        )
{
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_N_3*
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_N_4*
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0060 = 0.5*IT_0059;
    const ccomplex_t IT_0061 = IT_0058*IT_0060;
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = -IT_0022 + -IT_0036 + -IT_0050 + -IT_0064;
    const ccomplex_t IT_0066 = (-0.5)*IT_0031;
    const ccomplex_t IT_0067 = IT_0032*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0069 = IT_0034*IT_0067*IT_0068;
    const ccomplex_t IT_0070 = (-0.5)*IT_0045;
    const ccomplex_t IT_0071 = IT_0046*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0073 = IT_0048*IT_0071*IT_0072;
    const ccomplex_t IT_0074 = m_e*IT_0022;
    const ccomplex_t IT_0075 = m_e*IT_0036;
    const ccomplex_t IT_0076 = m_e*IT_0050;
    const ccomplex_t IT_0077 = (-0.5)*IT_0059;
    const ccomplex_t IT_0078 = IT_0060*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0080 = IT_0062*IT_0078*IT_0079;
    const ccomplex_t IT_0081 = (-0.5)*IT_0015;
    const ccomplex_t IT_0082 = IT_0016*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0084 = IT_0020*IT_0082*IT_0083;
    const ccomplex_t IT_0085 = m_e*IT_0064;
    const ccomplex_t IT_0086 = -IT_0069 + -IT_0073 + IT_0074 + IT_0075 +
       IT_0076 + -IT_0080 + -IT_0084 + IT_0085;
    const ccomplex_t IT_0087 = m_e*s_13;
    ...
    const ccomplex_t IT_0091 = IT_0020*IT_0083*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0001;
    const ccomplex_t IT_0093 = -IT_0092;
    const ccomplex_t IT_0094 = IT_0030*IT_0093;
    const ccomplex_t IT_0095 = IT_0034*IT_0068*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0001;
    const ccomplex_t IT_0097 = -IT_0096;
    const ccomplex_t IT_0098 = IT_0044*IT_0097;
    const ccomplex_t IT_0099 = IT_0048*IT_0072*IT_0098;
    ...
    const ccomplex_t IT_0104 = IT_0066*IT_0093;
    ...
    const ccomplex_t IT_0108 = IT_0070*IT_0097;
    ...
    const ccomplex_t IT_0115 = IT_0062*IT_0079*IT_0114;
    const ccomplex_t IT_0116 = IT_0077*IT_0113;
    ...
    const ccomplex_t IT_0120 = -IT_0091 + -IT_0095 + -IT_0099 + IT_0103 +
       IT_0107 + IT_0111 + -IT_0115 + IT_0119;
    const ccomplex_t IT_0121 = m_e*s_14;
    const ccomplex_t IT_0122 = sin(beta);
    const ccomplex_t IT_0123 = m_e*e_em*IT_0006*IT_0012*IT_0014*IT_0122;
    const ccomplex_t IT_0124 = (-0.5)*IT_0123;
    const ccomplex_t IT_0125 = m_e*e_em*mu_h*IT_0006*IT_0012;
    const ccomplex_t IT_0126 = 0.5*IT_0125;
    const ccomplex_t IT_0127 = IT_0124*IT_0126;
    const ccomplex_t IT_0128 = pow(m_se_L, 2);
    const ccomplex_t IT_0129 = cpow((-2)*s_12 + -IT_0019 + -IT_0128 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0130 = IT_0127*IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*IT_0130;
    const ccomplex_t IT_0132 = m_e*e_em*IT_0006*IT_0012;
    const ccomplex_t IT_0133 = 0.5*IT_0132;
    const ccomplex_t IT_0134 = m_e*e_em*mu_h*IT_0006*IT_0012*IT_0014*IT_0122;
    const ccomplex_t IT_0135 = 0.5*IT_0134;
    const ccomplex_t IT_0136 = IT_0133*IT_0135;
    const ccomplex_t IT_0137 = pow(m_Z, 2);
    const ccomplex_t IT_0138 = cpow((-2)*s_12 + -IT_0019 + -IT_0128 + IT_0137 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0143 = m_e*IT_0142;
    const ccomplex_t IT_0144 = -IT_0102 + -IT_0106 + -IT_0110 + -IT_0118;
    const ccomplex_t IT_0145 = IT_0018*IT_0128;
    const ccomplex_t IT_0146 = cos(alpha);
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_e*e_em*IT_0006*IT_0012
      *IT_0014*IT_0146;
    const ccomplex_t IT_0148 = (-0.5)*IT_0147;
    const ccomplex_t IT_0149 = sin(alpha);
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0006
      *IT_0012*IT_0014*IT_0149;
    const ccomplex_t IT_0151 = 0.5*IT_0150;
    const ccomplex_t IT_0152 = IT_0148*IT_0151;
    const ccomplex_t IT_0153 = cpow((-2)*s_12 + -IT_0019 + -IT_0128 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0154 = IT_0152*IT_0153;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*m_e*e_em*IT_0006*IT_0012
      *IT_0014*IT_0149;
    const ccomplex_t IT_0157 = 0.5*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0006
      *IT_0012*IT_0014*IT_0146;
    ...
    const ccomplex_t IT_0161 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0019 + -IT_0128 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0169 = s_34*IT_0128;
    const ccomplex_t IT_0170 = (-0.5)*IT_0169;
    const ccomplex_t IT_0171 = IT_0168 + IT_0170;
    const ccomplex_t IT_0172 = (-2)*IT_0086;
    const ccomplex_t IT_0173 = -IT_0065;
    const ccomplex_t IT_0174 = -IT_0018;
    const ccomplex_t IT_0175 = s_34 + IT_0174;
    const ccomplex_t IT_0176 = 0.5*IT_0120;
    const ccomplex_t IT_0177 = s_34 + IT_0018;
    const ccomplex_t IT_0178 = 2*s_34;
    const ccomplex_t IT_0179 = IT_0164*IT_0175;
    const ccomplex_t IT_0180 = (-2)*conj(IT_0086);
    const ccomplex_t IT_0181 = IT_0141*IT_0177;
    const ccomplex_t IT_0182 = 2*conj(IT_0065)*(IT_0086*IT_0087 + -IT_0120
      *IT_0121 + -IT_0141*IT_0143 + -IT_0144*IT_0145 + IT_0164*IT_0167 + 2
      *IT_0065*IT_0171) + 2*conj(IT_0144)*(IT_0087*IT_0120 + IT_0141*IT_0143 +
       IT_0164*IT_0167 + 2*IT_0144*IT_0171 + 0.5*IT_0121*IT_0172 + IT_0145
      *IT_0173) + 2*conj(IT_0164)*((IT_0065 + IT_0144)*IT_0167 + 2*IT_0175*(0.5
      *IT_0086 + IT_0164 + IT_0176)) + 2*conj(IT_0141)*(IT_0143*(IT_0144 +
       IT_0173) + 2*(IT_0141 + 0.25*IT_0172 + IT_0176)*IT_0177) + 2*conj(IT_0086
      )*(IT_0065*IT_0087 + 0.5*IT_0086*IT_0178 + IT_0179) + IT_0180*(IT_0018
      *IT_0120 + IT_0121*IT_0144 + IT_0181) + 2*conj(IT_0120)*(IT_0087*IT_0144 +
       0.5*IT_0018*IT_0172 + IT_0121*IT_0173 + IT_0176*IT_0178 + IT_0179 +
       IT_0181);
