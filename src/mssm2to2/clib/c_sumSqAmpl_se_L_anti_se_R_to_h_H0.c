...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_R_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow(IT_0003, 2);
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*m_W*e_em*IT_0011*(IT_0001
      *IT_0012 + 5*IT_0013*((-1)*IT_0013*(IT_0001*IT_0003 + 1./5*IT_0013*IT_0014
      ) + IT_0014*IT_0015));
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0000
      *IT_0002*IT_0005*IT_0013;
    const ccomplex_t IT_0025 = 0.5*IT_0024;
    const ccomplex_t IT_0026 = cpow(IT_0013, 2);
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_W*e_em*IT_0011*(IT_0012
      *IT_0014 + (-5)*IT_0013*(IT_0003*IT_0013*IT_0014 + 1*IT_0001*(IT_0015 + 
      -1./5*IT_0026)));
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0005 + 
      -IT_0004*IT_0009)*(IT_0001*IT_0013 + -IT_0003*IT_0014) + IT_0000*IT_0002
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0020 + IT_0037 + -m_se_L*
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0005 + 
      -IT_0004*IT_0009)*(IT_0001*IT_0003 + IT_0013*IT_0014) + IT_0000*IT_0002
      *IT_0003*IT_0005*IT_0033);
    const ccomplex_t IT_0042 = IT_0007*IT_0041;
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0037 + (0 + _Complex_I*1)
      *m_se_L*Gamma_el + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0013 + -IT_0003*IT_0014) + -IT_0000*IT_0002*IT_0005*IT_0013
      *IT_0033);
    const ccomplex_t IT_0047 = IT_0025*IT_0046;
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0019 + IT_0037 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0047*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0003 + IT_0013*IT_0014) + -IT_0000*IT_0002*IT_0003*IT_0005
      *IT_0033);
    const ccomplex_t IT_0052 = -IT_0051;
    const ccomplex_t IT_0053 = IT_0007*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0037 + (0 + _Complex_I*1)
      *m_se_R*Gamma_er + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0053*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*IT_0055;
    const ccomplex_t IT_0057 = -IT_0023 + -IT_0032 + IT_0040 + IT_0045 +
       IT_0050 + IT_0056;
