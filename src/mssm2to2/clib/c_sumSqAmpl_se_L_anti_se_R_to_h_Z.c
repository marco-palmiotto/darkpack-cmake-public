...
ccomplex_return_t c_sumSqAmpl_se_L_anti_se_R_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = m_e*e_em*mu_h*IT_0003*IT_0007*IT_0010*IT_0011;
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0002
      *IT_0007*IT_0010*IT_0011;
    const ccomplex_t IT_0024 = 0.5*IT_0023;
    const ccomplex_t IT_0025 = pow(m_h, 2);
    const ccomplex_t IT_0026 = cpow((-2)*s_23 + IT_0016 + IT_0025 + -m_se_L*
    ...
    const ccomplex_t IT_0032 = m_e*e_em*mu_h*IT_0007*IT_0010;
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0015 + IT_0025 + -m_se_R*
