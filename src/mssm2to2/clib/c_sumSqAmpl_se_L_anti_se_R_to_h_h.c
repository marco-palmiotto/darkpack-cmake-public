        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    const ccomplex_t IT_0018 = IT_0014*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0015 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0016 + -IT_0029 + -reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0004*IT_0012;
    const ccomplex_t IT_0032 = IT_0005 + IT_0031;
    const ccomplex_t IT_0033 = cpow(IT_0009, 3);
    const ccomplex_t IT_0034 = cpow(IT_0009, 2);
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*m_W*e_em*IT_0032*(IT_0001
      *IT_0033 + -IT_0003*(IT_0003*(IT_0001*IT_0009 + IT_0003*IT_0010) + 
      -IT_0010*IT_0034));
    ...
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0015 + IT_0029 + -m_se_R*
      (m_se_R + (0 + _Complex_I*-1)*Gamma_er) + reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0025*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0000
      *IT_0002*IT_0005*IT_0009;
    const ccomplex_t IT_0044 = 0.5*IT_0043;
    const ccomplex_t IT_0045 = cpow(IT_0003, 2);
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_W*e_em*IT_0032*(IT_0010
      *IT_0033 + (-5)*IT_0003*(IT_0003*IT_0009*IT_0010 + 1*IT_0001*(IT_0034 + 
      -1./5*IT_0045)));
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = IT_0044*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_12 + -IT_0016 + -IT_0029 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = IT_0019 + IT_0022 + IT_0028 + -IT_0039 +
       IT_0042 + -IT_0051;
