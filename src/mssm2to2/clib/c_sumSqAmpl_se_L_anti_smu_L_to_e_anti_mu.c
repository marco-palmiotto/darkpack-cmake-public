...
ccomplex_return_t c_sumSqAmpl_se_L_anti_smu_L_to_e_anti_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0149 = m_mu*s_13;
    const ccomplex_t IT_0150 = -IT_0120 + -IT_0126 + -IT_0132 + -IT_0146;
    const ccomplex_t IT_0151 = m_e*m_mu*IT_0022;
    const ccomplex_t IT_0152 = s_13*s_14;
    const ccomplex_t IT_0153 = s_34*IT_0022;
    const ccomplex_t IT_0154 = (-0.5)*IT_0153;
    const ccomplex_t IT_0155 = IT_0152 + IT_0154;
    const ccomplex_t IT_0156 = 2*s_34;
    const ccomplex_t IT_0157 = m_e*m_mu;
    const ccomplex_t IT_0158 = (-2)*conj(IT_0114);
    const ccomplex_t IT_0159 = (-2)*IT_0114;
    const ccomplex_t IT_0160 = -IT_0086;
    const ccomplex_t IT_0161 = 2*conj(IT_0086)*(IT_0114*IT_0115 + -IT_0148
      *IT_0149 + -IT_0150*IT_0151 + 2*IT_0086*IT_0155) + 2*conj(IT_0114)*
      (IT_0086*IT_0115 + 0.5*IT_0114*IT_0156) + (IT_0149*IT_0150 + IT_0148
      *IT_0157)*IT_0158 + 2*conj(IT_0148)*(IT_0115*IT_0150 + 0.5*IT_0148*IT_0156
       + 0.5*IT_0157*IT_0159 + IT_0149*IT_0160) + 2*conj(IT_0150)*(IT_0115
      *IT_0148 + 2*IT_0150*IT_0155 + 0.5*IT_0149*IT_0159 + IT_0151*IT_0160);
