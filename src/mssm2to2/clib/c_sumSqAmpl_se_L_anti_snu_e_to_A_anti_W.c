        ...
        )
{
    ...
    const ccomplex_t IT_0072 = (-0.5)*IT_0053 + IT_0071;
    ...
    const ccomplex_t IT_0112 = IT_0033 + IT_0050;
    const ccomplex_t IT_0113 = -IT_0038 + -IT_0058;
    const ccomplex_t IT_0114 = IT_0112 + IT_0113;
    const ccomplex_t IT_0115 = IT_0052*IT_0114;
    const ccomplex_t IT_0116 = -IT_0031 + -IT_0069;
    const ccomplex_t IT_0117 = IT_0027 + IT_0094;
    const ccomplex_t IT_0118 = IT_0116 + IT_0117;
    const ccomplex_t IT_0119 = IT_0022*IT_0118;
    const ccomplex_t IT_0120 = 0.5*IT_0115 + IT_0119;
    const ccomplex_t IT_0121 = s_12*IT_0074;
    const ccomplex_t IT_0122 = s_13*IT_0082;
    const ccomplex_t IT_0123 = s_14*s_34*IT_0046;
    const ccomplex_t IT_0124 = -IT_0123;
    const ccomplex_t IT_0125 = s_13 + IT_0124;
    const ccomplex_t IT_0126 = s_24*s_34*IT_0046;
    const ccomplex_t IT_0127 = -IT_0126;
    const ccomplex_t IT_0128 = s_23 + IT_0127;
    const ccomplex_t IT_0129 = s_13*IT_0101;
    const ccomplex_t IT_0130 = s_23*IT_0107;
    const ccomplex_t IT_0131 = IT_0129 + IT_0130;
    const ccomplex_t IT_0132 = s_13*conj(IT_0101);
    const ccomplex_t IT_0133 = s_23*conj(IT_0107);
    const ccomplex_t IT_0134 = IT_0132 + IT_0133;
    const ccomplex_t IT_0135 = s_12*IT_0101;
    const ccomplex_t IT_0136 = s_12*conj(IT_0101);
    const ccomplex_t IT_0137 = IT_0016*IT_0101;
    const ccomplex_t IT_0138 = conj(IT_0045)*IT_0120 + IT_0045*conj(IT_0120) +
       IT_0057*(IT_0016*conj(IT_0101) + s_12*conj(IT_0107) + s_13*conj(IT_0120))
       + conj(IT_0061)*IT_0131 + IT_0061*IT_0134 + conj(IT_0059)*(IT_0045 +
       IT_0017*IT_0107 + s_23*IT_0120 + IT_0135) + IT_0059*(conj(IT_0045) +
       IT_0017*conj(IT_0107) + s_23*conj(IT_0120) + IT_0136) + conj(IT_0057)*
      (s_12*IT_0107 + s_13*IT_0120 + IT_0137);
    const ccomplex_t IT_0139 = pow(s_24, 2);
    const ccomplex_t IT_0140 = IT_0046*IT_0139;
    const ccomplex_t IT_0141 = -IT_0140;
    const ccomplex_t IT_0142 = IT_0017 + IT_0141;
    const ccomplex_t IT_0143 = 3*IT_0045*conj(IT_0045) + -IT_0048*IT_0063 +
      ...
      + IT_0082*IT_0088 + conj(IT_0074)*IT_0089 + conj(IT_0072)*(IT_0045 +
       IT_0090)) + IT_0093*(conj(IT_0045)*IT_0074 + IT_0045*conj(IT_0074) +
       IT_0101*IT_0105 + conj(IT_0107)*IT_0109 + IT_0107*IT_0111 + IT_0088
      *IT_0120 + IT_0085*conj(IT_0120) + conj(IT_0101)*(IT_0045 + IT_0090 +
       IT_0121 + IT_0122)) + (conj(IT_0045)*IT_0082 + IT_0045*conj(IT_0082) +
       conj(IT_0061)*IT_0085 + IT_0061*IT_0088 + IT_0057*IT_0105 + conj(IT_0059)
      *IT_0109 + IT_0059*IT_0111 + conj(IT_0057)*(IT_0045 + IT_0090 + IT_0121 +
       IT_0122))*IT_0125 + IT_0128*IT_0138 + (conj(IT_0120)*IT_0131 + IT_0120
      *IT_0134 + conj(IT_0107)*(IT_0045 + IT_0135) + IT_0107*(conj(IT_0045) +
       IT_0017*conj(IT_0107) + IT_0136) + conj(IT_0101)*IT_0137)*IT_0142;
