...
ccomplex_return_t c_sumSqAmpl_se_L_anti_snu_e_to_H0_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0007
      *IT_0012*IT_0013*IT_0014;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0012*IT_0014;
    const ccomplex_t IT_0037 = 0.5*IT_0036;
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = pow(m_H0, 2);
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0029 + IT_0039 + -m_se_R*
