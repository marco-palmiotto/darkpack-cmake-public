...
ccomplex_return_t c_sumSqAmpl_se_L_anti_snu_e_to_e_anti_nu_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0000*IT_0002*IT_0019;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0000*IT_0002*IT_0019;
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0000*IT_0002*IT_0019;
    ...
    const ccomplex_t IT_0145 = m_e*IT_0144;
    ...
    const ccomplex_t IT_0148 = -IT_0108 + -IT_0120 + -IT_0132 + -IT_0144 + 
      -IT_0147;
    const ccomplex_t IT_0149 = m_e*s_14;
