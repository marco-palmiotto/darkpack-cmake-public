...
ccomplex_return_t c_sumSqAmpl_se_L_anti_ss_L_to_e_anti_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0151 = m_e*m_s*IT_0022;
    ...
    const ccomplex_t IT_0158 = m_e*m_s;
