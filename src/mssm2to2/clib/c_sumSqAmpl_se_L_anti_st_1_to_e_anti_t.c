...
ccomplex_return_t c_sumSqAmpl_se_L_anti_st_1_to_e_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0151 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0152 = IT_0001*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = m_t*conj(N_u3)*e_em*IT_0021*conj(U_st_00);
    ...
    const ccomplex_t IT_0161 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0162 = IT_0001*IT_0161;
    const ccomplex_t IT_0163 = 1.4142135623731*IT_0162;
    const ccomplex_t IT_0164 = m_t*conj(N_u4)*e_em*IT_0021*conj(U_st_00);
