...
ccomplex_return_t c_sumSqAmpl_se_L_anti_st_2_to_e_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0105 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0006*IT_0021*IT_0104;
    ...
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0006*IT_0021*IT_0104;
    ...
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0006*IT_0021*IT_0104;
    ...
    const ccomplex_t IT_0125 = m_e*IT_0032;
    const ccomplex_t IT_0126 = m_e*IT_0055;
    const ccomplex_t IT_0127 = m_e*IT_0078;
    const ccomplex_t IT_0128 = m_e*IT_0101;
    const ccomplex_t IT_0129 = -IT_0109 + -IT_0114 + -IT_0119 + -IT_0124 +
       IT_0125 + IT_0126 + IT_0127 + IT_0128;
    const ccomplex_t IT_0130 = m_e*s_14;
    const ccomplex_t IT_0131 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0132 = IT_0001*IT_0131;
    const ccomplex_t IT_0133 = 1.4142135623731*IT_0132;
    const ccomplex_t IT_0134 = m_t*conj(N_u1)*e_em*IT_0021*conj(U_st_01);
    ...
    const ccomplex_t IT_0144 = m_t*conj(N_u2)*e_em*IT_0021*conj(U_st_01);
    ...
    const ccomplex_t IT_0151 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0152 = IT_0001*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = m_t*conj(N_u3)*e_em*IT_0021*conj(U_st_01);
    ...
    const ccomplex_t IT_0160 = IT_0076*IT_0118*IT_0159;
    ...
    const ccomplex_t IT_0175 = IT_0111*IT_0148;
    ...
    const ccomplex_t IT_0179 = IT_0116*IT_0158;
    ...
    const ccomplex_t IT_0190 = m_e*m_t*IT_0029;
    ...
    const ccomplex_t IT_0196 = m_e*m_t;
