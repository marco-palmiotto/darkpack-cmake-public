...
ccomplex_return_t c_sumSqAmpl_se_L_anti_su_L_to_e_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0006*IT_0087*IT_0117;
    ...
    const ccomplex_t IT_0151 = m_u*s_13;
    const ccomplex_t IT_0152 = -IT_0122 + -IT_0128 + -IT_0134 + -IT_0148;
    const ccomplex_t IT_0153 = m_e*m_u*IT_0022;
    ...
    const ccomplex_t IT_0160 = m_e*m_u;
