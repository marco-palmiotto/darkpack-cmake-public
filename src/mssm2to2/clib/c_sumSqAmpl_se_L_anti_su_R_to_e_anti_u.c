...
ccomplex_return_t c_sumSqAmpl_se_L_anti_su_R_to_e_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0001;
    const ccomplex_t IT_0095 = 0.666666666666667*IT_0094;
    const ccomplex_t IT_0096 = IT_0030*IT_0095;
    const ccomplex_t IT_0097 = IT_0034*IT_0076*IT_0096;
    ...
    const ccomplex_t IT_0101 = IT_0048*IT_0081*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0001;
    const ccomplex_t IT_0103 = 0.666666666666667*IT_0102;
    const ccomplex_t IT_0104 = IT_0058*IT_0103;
    const ccomplex_t IT_0105 = IT_0062*IT_0086*IT_0104;
    const ccomplex_t IT_0106 = IT_0074*IT_0095;
    const ccomplex_t IT_0107 = IT_0034*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = m_e*IT_0108;
    const ccomplex_t IT_0110 = IT_0079*IT_0099;
    ...
    const ccomplex_t IT_0114 = IT_0084*IT_0103;
    ...
    const ccomplex_t IT_0121 = IT_0020*IT_0071*IT_0120;
    const ccomplex_t IT_0122 = IT_0069*IT_0119;
    ...
    const ccomplex_t IT_0128 = -IT_0108 + -IT_0112 + -IT_0116 + -IT_0124;
    ...
    const ccomplex_t IT_0135 = m_e*m_u;
