        ...
        )
{
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(IT_0056 + IT_0059);
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*(IT_0004 + IT_0009);
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*(IT_0025 + IT_0028);
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*(IT_0039 + IT_0042);
    const ccomplex_t IT_0090 = (-0.5)*IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0006*IT_0012*IT_0069;
    ...
    const ccomplex_t IT_0105 = IT_0011*IT_0076;
    const ccomplex_t IT_0106 = IT_0020*IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0108 = IT_0030*IT_0083;
    const ccomplex_t IT_0109 = IT_0034*IT_0107*IT_0108;
    const ccomplex_t IT_0110 = m_e*IT_0022;
    const ccomplex_t IT_0111 = m_e*IT_0036;
    const ccomplex_t IT_0112 = m_e*IT_0050;
    const ccomplex_t IT_0113 = m_e*IT_0064;
    const ccomplex_t IT_0114 = IT_0106 + IT_0109 + -IT_0110 + -IT_0111 + 
      -IT_0112 + -IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0116 = IT_0044*IT_0090;
    const ccomplex_t IT_0117 = IT_0048*IT_0115*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0119 = IT_0061*IT_0067;
    ...
    const ccomplex_t IT_0125 = IT_0053*IT_0071;
    const ccomplex_t IT_0126 = IT_0051*IT_0118*IT_0125;
    const ccomplex_t IT_0127 = IT_0032*IT_0085;
    const ccomplex_t IT_0128 = IT_0034*IT_0107*IT_0127;
    const ccomplex_t IT_0129 = IT_0046*IT_0092;
    const ccomplex_t IT_0130 = IT_0048*IT_0115*IT_0129;
    const ccomplex_t IT_0131 = m_e*IT_0074;
    const ccomplex_t IT_0132 = m_e*IT_0081;
    const ccomplex_t IT_0133 = m_e*IT_0088;
    const ccomplex_t IT_0134 = m_e*IT_0095;
    const ccomplex_t IT_0135 = IT_0126 + IT_0128 + IT_0130 + -IT_0131 + 
      -IT_0132 + -IT_0133 + -IT_0134;
    const ccomplex_t IT_0136 = 6*IT_0135;
    const ccomplex_t IT_0137 = IT_0016*IT_0078;
    const ccomplex_t IT_0138 = IT_0020*IT_0104*IT_0137;
    const ccomplex_t IT_0139 = -IT_0138;
    const ccomplex_t IT_0140 = (-6)*IT_0139;
    const ccomplex_t IT_0141 = IT_0136 + IT_0140;
    const ccomplex_t IT_0142 = 6*conj(IT_0135);
    ...
    const ccomplex_t IT_0155 = m_e*s_14;
    const ccomplex_t IT_0156 = (-6)*conj(IT_0065)*(IT_0096*IT_0097 + (
      ...
      *conj(IT_0114) + IT_0121*conj(IT_0121) + IT_0135*conj(IT_0135) + IT_0139
      *conj(IT_0139))*IT_0152 + (conj(IT_0114)*IT_0121 + IT_0114*conj(IT_0121) +
       conj(IT_0135)*IT_0139 + IT_0135*conj(IT_0139))*IT_0153 + (-6)*conj
