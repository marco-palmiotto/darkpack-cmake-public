...
ccomplex_return_t c_sumSqAmpl_se_L_sc_L_to_e_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0097 = m_c*m_e*IT_0019;
    ...
    const ccomplex_t IT_0103 = m_e*s_14;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0105 = IT_0011*IT_0067;
    const ccomplex_t IT_0106 = IT_0020*IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0108 = IT_0058*IT_0090;
    const ccomplex_t IT_0109 = IT_0062*IT_0107*IT_0108;
    const ccomplex_t IT_0110 = -IT_0106 + -IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0112 = IT_0030*IT_0076;
    const ccomplex_t IT_0113 = IT_0034*IT_0111*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0115 = IT_0044*IT_0083;
    const ccomplex_t IT_0116 = IT_0048*IT_0114*IT_0115;
    const ccomplex_t IT_0117 = m_e*IT_0074;
    const ccomplex_t IT_0118 = m_e*IT_0081;
    const ccomplex_t IT_0119 = m_e*IT_0088;
    const ccomplex_t IT_0120 = m_e*IT_0095;
    ...
    const ccomplex_t IT_0124 = conj(IT_0110) + IT_0123;
    const ccomplex_t IT_0125 = IT_0032*IT_0078;
    const ccomplex_t IT_0126 = IT_0034*IT_0111*IT_0125;
    const ccomplex_t IT_0127 = -IT_0126;
    const ccomplex_t IT_0128 = 6*IT_0127;
    const ccomplex_t IT_0129 = IT_0016*IT_0071;
    const ccomplex_t IT_0130 = IT_0020*IT_0104*IT_0129;
    const ccomplex_t IT_0131 = IT_0046*IT_0085;
    const ccomplex_t IT_0132 = IT_0048*IT_0114*IT_0131;
    const ccomplex_t IT_0133 = IT_0060*IT_0092;
    const ccomplex_t IT_0134 = IT_0062*IT_0107*IT_0133;
    const ccomplex_t IT_0135 = m_e*IT_0022;
    const ccomplex_t IT_0136 = m_e*IT_0036;
    const ccomplex_t IT_0137 = m_e*IT_0050;
    const ccomplex_t IT_0138 = m_e*IT_0064;
    const ccomplex_t IT_0139 = IT_0130 + IT_0132 + IT_0134 + -IT_0135 + 
      -IT_0136 + -IT_0137 + -IT_0138;
    const ccomplex_t IT_0140 = (-6)*IT_0139;
    const ccomplex_t IT_0141 = IT_0128 + IT_0140;
    const ccomplex_t IT_0142 = 6*conj(IT_0127);
    ...
    const ccomplex_t IT_0155 = m_c*s_13;
    const ccomplex_t IT_0156 = (-6)*conj(IT_0065)*(IT_0096*IT_0097 + (
      -0.166666666666667)*IT_0065*IT_0102) + 6*IT_0103*(conj(IT_0096)*IT_0122 +
       IT_0096*IT_0124 + 0.166666666666667*conj(IT_0065)*IT_0141 +
       0.166666666666667*IT_0065*IT_0144) + IT_0145*(conj(IT_0121)*IT_0141 +
       IT_0121*IT_0144 + conj(IT_0110)*IT_0148 + IT_0110*IT_0151) + (IT_0110
      *conj(IT_0110) + IT_0121*conj(IT_0121) + IT_0127*conj(IT_0127) + IT_0139
      *conj(IT_0139))*IT_0152 + (conj(IT_0110)*IT_0121 + IT_0110*conj(IT_0121) +
       conj(IT_0127)*IT_0139 + IT_0127*conj(IT_0139))*IT_0153 + (-6)*conj
      (IT_0096)*(IT_0065*IT_0097 + IT_0102*IT_0154) + (-6)*(conj(IT_0065)
      *IT_0122 + IT_0065*IT_0124 + (-0.166666666666667)*conj(IT_0096)*IT_0148 +
