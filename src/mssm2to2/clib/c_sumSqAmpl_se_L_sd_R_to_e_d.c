...
ccomplex_return_t c_sumSqAmpl_se_L_sd_R_to_e_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0095 = m_d*m_e*IT_0011;
    const ccomplex_t IT_0096 = s_34*IT_0011;
    ...
    const ccomplex_t IT_0106 = IT_0032*IT_0088;
    const ccomplex_t IT_0107 = IT_0036*IT_0105*IT_0106;
    const ccomplex_t IT_0108 = m_e*IT_0014;
    const ccomplex_t IT_0109 = m_e*IT_0022;
    const ccomplex_t IT_0110 = m_e*IT_0030;
    const ccomplex_t IT_0111 = m_e*IT_0038;
    const ccomplex_t IT_0112 = IT_0104 + IT_0107 + -IT_0108 + -IT_0109 + 
      -IT_0110 + -IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0114 = IT_0016*IT_0062;
    const ccomplex_t IT_0115 = IT_0020*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0117 = IT_0024*IT_0075;
    ...
    const ccomplex_t IT_0122 = conj(IT_0112) + IT_0121;
    const ccomplex_t IT_0123 = IT_0018*IT_0064;
    const ccomplex_t IT_0124 = IT_0020*IT_0113*IT_0123;
    const ccomplex_t IT_0125 = m_e*IT_0054;
    const ccomplex_t IT_0126 = m_e*IT_0080;
    const ccomplex_t IT_0127 = m_e*IT_0093;
    const ccomplex_t IT_0128 = m_e*IT_0067;
    ...
    const ccomplex_t IT_0132 = IT_0012*IT_0102*IT_0131;
    const ccomplex_t IT_0133 = IT_0026*IT_0077;
    const ccomplex_t IT_0134 = IT_0028*IT_0116*IT_0133;
    const ccomplex_t IT_0135 = IT_0034*IT_0090;
    const ccomplex_t IT_0136 = IT_0036*IT_0105*IT_0135;
    ...
    const ccomplex_t IT_0154 = (-6)*conj(IT_0039)*(IT_0094*IT_0095 + (
      -0.166666666666667)*IT_0039*IT_0100) + 6*IT_0101*(conj(IT_0094)*IT_0120 +
       IT_0094*IT_0122 + 0.166666666666667*conj(IT_0039)*IT_0139 +
       0.166666666666667*IT_0039*IT_0142) + IT_0143*(conj(IT_0119)*IT_0139 +
       IT_0119*IT_0142 + conj(IT_0112)*IT_0146 + IT_0112*IT_0149) + (IT_0112
      *conj(IT_0112) + IT_0119*conj(IT_0119) + IT_0129*conj(IT_0129) + IT_0137
      *conj(IT_0137))*IT_0150 + (conj(IT_0112)*IT_0119 + IT_0112*conj(IT_0119) +
       conj(IT_0129)*IT_0137 + IT_0129*conj(IT_0137))*IT_0151 + (-6)*conj
      (IT_0094)*(IT_0039*IT_0095 + IT_0100*IT_0152) + (-6)*(conj(IT_0039)
      *IT_0120 + IT_0039*IT_0122 + (-0.166666666666667)*conj(IT_0094)*IT_0146 +
