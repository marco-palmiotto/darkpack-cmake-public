...
ccomplex_return_t c_sumSqAmpl_se_L_snu_mu_to_nu_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0001;
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0001*IT_0016*IT_0018;
    const ccomplex_t IT_0020 = 0.5*IT_0019;
    const ccomplex_t IT_0021 = IT_0002*IT_0020;
    const ccomplex_t IT_0022 = IT_0007*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0001*IT_0016*IT_0018;
    ...
    const ccomplex_t IT_0030 = m_mu*IT_0029;
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = (-0.5)*IT_0023 + (-0.5)*IT_0028;
    const ccomplex_t IT_0033 = m_mu*s_23;
    const ccomplex_t IT_0034 = s_23*s_24;
    const ccomplex_t IT_0035 = pow(m_snu_mu, 2);
    const ccomplex_t IT_0036 = s_34*IT_0035;
    const ccomplex_t IT_0037 = (-2)*s_34;
    const ccomplex_t IT_0038 = 2*s_34*(IT_0015*conj(IT_0015) + IT_0031*conj
      (IT_0031)) + 2*((conj(IT_0015) + -conj(IT_0031))*IT_0032 + (IT_0015 + 
      -IT_0031)*conj(IT_0032))*IT_0033 + 4*IT_0032*conj(IT_0032)*(IT_0034 + (
      -0.5)*IT_0036) + (conj(IT_0015)*IT_0031 + IT_0015*conj(IT_0031))*IT_0037;
