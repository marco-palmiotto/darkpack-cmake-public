...
ccomplex_return_t c_sumSqAmpl_se_L_snu_tau_to_e_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0006*IT_0064*IT_0066;
    ...
    const ccomplex_t IT_0088 = m_e*s_24;
