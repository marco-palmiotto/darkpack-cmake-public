...
ccomplex_return_t c_sumSqAmpl_se_L_st_1_to_e_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = m_t*N_u1*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0026 = pow(m_se_L, 2);
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0025 + IT_0026 + -m_N_1*
    ...
    const ccomplex_t IT_0058 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0059 = IT_0001*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = m_t*N_u3*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0025 + IT_0026 + -m_N_3*
    ...
    const ccomplex_t IT_0078 = N_B4*e_em*U_st_10;
    const ccomplex_t IT_0079 = IT_0001*IT_0078;
    const ccomplex_t IT_0080 = 1.4142135623731*IT_0079;
    const ccomplex_t IT_0081 = m_t*N_u4*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0025 + IT_0026 + -m_N_4*
    ...
    const ccomplex_t IT_0093 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0006*IT_0018*IT_0092;
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0096 = IT_0001*IT_0095;
    const ccomplex_t IT_0097 = 1.4142135623731*IT_0096;
    const ccomplex_t IT_0098 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0099 = IT_0006*IT_0098;
    const ccomplex_t IT_0100 = 1.4142135623731*IT_0099;
    const ccomplex_t IT_0101 = m_t*conj(N_u1)*e_em*IT_0018*U_st_10;
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0006*IT_0018*IT_0092;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0112 = IT_0001*IT_0111;
    const ccomplex_t IT_0113 = 1.4142135623731*IT_0112;
    const ccomplex_t IT_0114 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0115 = IT_0006*IT_0114;
    const ccomplex_t IT_0116 = 1.4142135623731*IT_0115;
    const ccomplex_t IT_0117 = m_t*conj(N_u2)*e_em*IT_0018*U_st_10;
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0006*IT_0018*IT_0092;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = conj(N_B3)*e_em*U_st_00;
    const ccomplex_t IT_0128 = IT_0001*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0131 = IT_0006*IT_0130;
    const ccomplex_t IT_0132 = 1.4142135623731*IT_0131;
    const ccomplex_t IT_0133 = m_t*conj(N_u3)*e_em*IT_0018*U_st_10;
    ...
    const ccomplex_t IT_0139 = IT_0067*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*IT_0139;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0006*IT_0018*IT_0092;
    const ccomplex_t IT_0142 = (-0.5)*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B4)*e_em*U_st_00;
    const ccomplex_t IT_0144 = IT_0001*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = conj(N_W4)*e_em*U_st_00;
    const ccomplex_t IT_0147 = IT_0006*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = m_t*conj(N_u4)*e_em*IT_0018*U_st_10;
    ...
    const ccomplex_t IT_0155 = IT_0087*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*IT_0155;
    const ccomplex_t IT_0157 = -IT_0108 + -IT_0124 + -IT_0140 + -IT_0156;
    const ccomplex_t IT_0158 = pow(m_st_1, 2);
    const ccomplex_t IT_0159 = m_e*m_t*IT_0158;
    ...
    const ccomplex_t IT_0165 = m_e*s_24;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0167 = IT_0011*IT_0105;
    const ccomplex_t IT_0168 = IT_0027*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0170 = IT_0037*IT_0121;
    const ccomplex_t IT_0171 = IT_0047*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0173 = IT_0077*IT_0153;
    const ccomplex_t IT_0174 = IT_0087*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = m_t*IT_0029;
    const ccomplex_t IT_0176 = m_t*IT_0049;
    const ccomplex_t IT_0177 = m_t*IT_0069;
    const ccomplex_t IT_0178 = m_t*IT_0089;
    const ccomplex_t IT_0179 = IT_0168 + IT_0171 + IT_0174 + -IT_0175 + 
      -IT_0176 + -IT_0177 + -IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0181 = IT_0057*IT_0137;
    const ccomplex_t IT_0182 = IT_0067*IT_0180*IT_0181;
    const ccomplex_t IT_0183 = -IT_0182;
    const ccomplex_t IT_0184 = IT_0179 + -IT_0183;
    const ccomplex_t IT_0185 = -conj(IT_0183);
    const ccomplex_t IT_0186 = conj(IT_0179) + IT_0185;
    const ccomplex_t IT_0187 = IT_0045*IT_0110;
    const ccomplex_t IT_0188 = IT_0047*IT_0169*IT_0187;
    const ccomplex_t IT_0189 = IT_0065*IT_0126;
    const ccomplex_t IT_0190 = IT_0067*IT_0180*IT_0189;
    const ccomplex_t IT_0191 = m_t*IT_0108;
    const ccomplex_t IT_0192 = m_t*IT_0124;
    const ccomplex_t IT_0193 = m_t*IT_0156;
    const ccomplex_t IT_0194 = m_t*IT_0140;
    const ccomplex_t IT_0195 = IT_0188 + IT_0190 + -IT_0191 + -IT_0192 + 
      -IT_0193 + -IT_0194;
    const ccomplex_t IT_0196 = 6*IT_0195;
    const ccomplex_t IT_0197 = IT_0023*IT_0094;
    const ccomplex_t IT_0198 = IT_0027*IT_0166*IT_0197;
    const ccomplex_t IT_0199 = IT_0085*IT_0142;
    const ccomplex_t IT_0200 = IT_0087*IT_0172*IT_0199;
    const ccomplex_t IT_0201 = -IT_0198 + -IT_0200;
    const ccomplex_t IT_0202 = (-6)*IT_0201;
    const ccomplex_t IT_0203 = IT_0196 + IT_0202;
    const ccomplex_t IT_0204 = 6*conj(IT_0195);
    const ccomplex_t IT_0205 = (-6)*conj(IT_0201);
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = m_e*m_t;
    const ccomplex_t IT_0208 = 6*IT_0201;
    const ccomplex_t IT_0209 = (-6)*IT_0195;
    const ccomplex_t IT_0210 = IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = 6*conj(IT_0201);
    const ccomplex_t IT_0212 = (-6)*conj(IT_0195);
    const ccomplex_t IT_0213 = IT_0211 + IT_0212;
    const ccomplex_t IT_0214 = 6*s_34;
    const ccomplex_t IT_0215 = (-6)*s_34;
    const ccomplex_t IT_0216 = (-0.166666666666667)*IT_0157;
    const ccomplex_t IT_0217 = m_t*s_23;
    const ccomplex_t IT_0218 = (-6)*conj(IT_0090)*(IT_0157*IT_0159 + (
      -0.166666666666667)*IT_0090*IT_0164) + 6*IT_0165*(conj(IT_0157)*IT_0184 +
       IT_0157*IT_0186 + 0.166666666666667*conj(IT_0090)*IT_0203 +
       0.166666666666667*IT_0090*IT_0206) + IT_0207*(conj(IT_0183)*IT_0203 +
       IT_0183*IT_0206 + conj(IT_0179)*IT_0210 + IT_0179*IT_0213) + (IT_0179
      *conj(IT_0179) + IT_0183*conj(IT_0183) + IT_0195*conj(IT_0195) + IT_0201
      *conj(IT_0201))*IT_0214 + (conj(IT_0179)*IT_0183 + IT_0179*conj(IT_0183) +
       conj(IT_0195)*IT_0201 + IT_0195*conj(IT_0201))*IT_0215 + (-6)*conj
      (IT_0157)*(IT_0090*IT_0159 + IT_0164*IT_0216) + (-6)*(conj(IT_0090)
      *IT_0184 + IT_0090*IT_0186 + (-0.166666666666667)*conj(IT_0157)*IT_0210 +
       IT_0213*IT_0216)*IT_0217;
