...
ccomplex_return_t c_sumSqAmpl_se_L_st_2_to_e_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0039 = IT_0001*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = m_t*N_u2*e_em*IT_0018*U_st_01;
    ...
    const ccomplex_t IT_0061 = m_t*N_u3*e_em*IT_0018*U_st_01;
    ...
    const ccomplex_t IT_0081 = m_t*N_u4*e_em*IT_0018*U_st_01;
    ...
    const ccomplex_t IT_0158 = pow(m_st_2, 2);
    ...
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0177 = IT_0057*IT_0137;
    const ccomplex_t IT_0178 = IT_0067*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = m_t*IT_0029;
    const ccomplex_t IT_0180 = m_t*IT_0049;
    const ccomplex_t IT_0181 = m_t*IT_0069;
    const ccomplex_t IT_0182 = m_t*IT_0089;
    ...
    const ccomplex_t IT_0187 = IT_0023*IT_0094;
    const ccomplex_t IT_0188 = IT_0027*IT_0166*IT_0187;
    const ccomplex_t IT_0189 = IT_0085*IT_0142;
    const ccomplex_t IT_0190 = IT_0087*IT_0172*IT_0189;
    const ccomplex_t IT_0191 = m_t*IT_0108;
    const ccomplex_t IT_0192 = m_t*IT_0124;
    const ccomplex_t IT_0193 = m_t*IT_0140;
    const ccomplex_t IT_0194 = m_t*IT_0156;
    const ccomplex_t IT_0195 = IT_0188 + IT_0190 + -IT_0191 + -IT_0192 + 
      -IT_0193 + -IT_0194;
    const ccomplex_t IT_0196 = 6*IT_0195;
    const ccomplex_t IT_0197 = IT_0045*IT_0110;
    const ccomplex_t IT_0198 = IT_0047*IT_0169*IT_0197;
    const ccomplex_t IT_0199 = IT_0065*IT_0126;
    const ccomplex_t IT_0200 = IT_0067*IT_0176*IT_0199;
    ...
    const ccomplex_t IT_0214 = m_t*s_23;
    const ccomplex_t IT_0215 = 6*s_34;
    const ccomplex_t IT_0216 = (-6)*s_34;
    const ccomplex_t IT_0217 = (-6)*conj(IT_0090)*(IT_0157*IT_0159 + (
      -0.166666666666667)*IT_0090*IT_0164) + (-6)*conj(IT_0157)*(IT_0090*IT_0159
       + (-0.166666666666667)*IT_0157*IT_0164) + (-6)*IT_0165*(conj(IT_0157)
      *IT_0184 + IT_0157*IT_0186 + (-0.166666666666667)*conj(IT_0090)*IT_0203 + 
      (-0.166666666666667)*IT_0090*IT_0206) + IT_0207*(conj(IT_0175)*IT_0203 +
       IT_0175*IT_0206 + conj(IT_0183)*IT_0210 + IT_0183*IT_0213) + 6*(conj
      (IT_0090)*IT_0184 + IT_0090*IT_0186 + 0.166666666666667*conj(IT_0157)
      *IT_0210 + 0.166666666666667*IT_0157*IT_0213)*IT_0214 + (IT_0175*conj
      (IT_0175) + IT_0183*conj(IT_0183) + IT_0195*conj(IT_0195) + IT_0201*conj
      (IT_0201))*IT_0215 + (conj(IT_0175)*IT_0183 + IT_0175*conj(IT_0183) + conj
      (IT_0195)*IT_0201 + IT_0195*conj(IT_0201))*IT_0216;
