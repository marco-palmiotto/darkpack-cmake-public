...
ccomplex_return_t c_sumSqAmpl_se_L_st_2_to_nu_e_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    const ccomplex_t IT_0021 = IT_0001*IT_0020;
    const ccomplex_t IT_0022 = m_t*V_tb*conj(V_u2)*e_em*IT_0008*U_st_11;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
      *e_em*IT_0001*IT_0008*IT_0032*U_st_01;
    ...
    const ccomplex_t IT_0045 = (-0.5)*IT_0018 + (-0.5)*IT_0030 + (-0.5)
      *IT_0038 + (-0.5)*IT_0044;
    const ccomplex_t IT_0046 = (-0.5)*IT_0037 + (-0.5)*IT_0043;
    const ccomplex_t IT_0047 = m_b*s_23;
    const ccomplex_t IT_0048 = s_23*s_24;
    const ccomplex_t IT_0049 = pow(m_st_2, 2);
    const ccomplex_t IT_0050 = s_34*IT_0049;
    return create_ccomplex_return(6*IT_0045*(s_34*conj(IT_0045) + -conj
      (IT_0046)*IT_0047) + (-6)*IT_0046*(conj(IT_0045)*IT_0047 + (
      -0.166666666666667)*conj(IT_0046)*(12*IT_0048 + (-6)*IT_0050)));
}
