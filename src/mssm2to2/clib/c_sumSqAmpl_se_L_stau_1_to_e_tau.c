...
ccomplex_return_t c_sumSqAmpl_se_L_stau_1_to_e_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
    ...
    const ccomplex_t IT_0039 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0040 = IT_0004*IT_0039;
    const ccomplex_t IT_0041 = 1.4142135623731*IT_0040;
    const ccomplex_t IT_0042 = N_d2*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_3*
    ...
    const ccomplex_t IT_0082 = N_d4*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0099 = conj(N_d1)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0009*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0115 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0009*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0131 = conj(N_d3)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0009*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0147 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0156 = pow(m_stau_1, 2);
    const ccomplex_t IT_0157 = m_e*m_tau*IT_0156;
    ...
    const ccomplex_t IT_0162 = s_23*m_tau;
    const ccomplex_t IT_0163 = IT_0029 + IT_0049 + IT_0069 + IT_0089;
    const ccomplex_t IT_0164 = m_tau*IT_0163;
    const ccomplex_t IT_0165 = -IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0167 = IT_0014*IT_0103;
    const ccomplex_t IT_0168 = IT_0002*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0170 = IT_0038*IT_0119;
    const ccomplex_t IT_0171 = IT_0030*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0173 = IT_0066*IT_0135;
    const ccomplex_t IT_0174 = IT_0050*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0176 = IT_0078*IT_0151;
    const ccomplex_t IT_0177 = IT_0070*IT_0175*IT_0176;
    const ccomplex_t IT_0178 = -IT_0168 + -IT_0171 + -IT_0174 + -IT_0177;
    const ccomplex_t IT_0179 = IT_0165 + -IT_0178;
    const ccomplex_t IT_0180 = -conj(IT_0178);
    const ccomplex_t IT_0181 = conj(IT_0165) + IT_0180;
    const ccomplex_t IT_0182 = IT_0026*IT_0092;
    const ccomplex_t IT_0183 = IT_0002*IT_0166*IT_0182;
    const ccomplex_t IT_0184 = IT_0046*IT_0108;
    const ccomplex_t IT_0185 = IT_0030*IT_0169*IT_0184;
    const ccomplex_t IT_0186 = IT_0086*IT_0140;
    const ccomplex_t IT_0187 = IT_0070*IT_0175*IT_0186;
    const ccomplex_t IT_0188 = IT_0058*IT_0124;
    const ccomplex_t IT_0189 = IT_0050*IT_0172*IT_0188;
    const ccomplex_t IT_0190 = -IT_0183 + -IT_0185 + -IT_0187 + -IT_0189;
    const ccomplex_t IT_0191 = 2*IT_0190;
    const ccomplex_t IT_0192 = IT_0106 + IT_0122 + IT_0138 + IT_0154;
    const ccomplex_t IT_0193 = m_tau*IT_0192;
    ...
    const ccomplex_t IT_0200 = m_e*m_tau;
    const ccomplex_t IT_0201 = 2*IT_0194;
    const ccomplex_t IT_0202 = (-2)*IT_0190;
    const ccomplex_t IT_0203 = IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = 2*conj(IT_0194);
    const ccomplex_t IT_0205 = (-2)*conj(IT_0190);
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = m_e*s_24;
    const ccomplex_t IT_0208 = 2*s_34;
    const ccomplex_t IT_0209 = (-2)*s_34;
    const ccomplex_t IT_0210 = (-2)*conj(IT_0090)*(IT_0155*IT_0157 + (-2)
      *IT_0090*IT_0161) + (-2)*conj(IT_0155)*(IT_0090*IT_0157 + (-2)*IT_0155
      *IT_0161) + (-2)*IT_0162*(conj(IT_0090)*IT_0179 + IT_0090*IT_0181 + (-0.5)
      *conj(IT_0155)*IT_0196 + (-0.5)*IT_0155*IT_0199) + IT_0200*(conj(IT_0165)
      *IT_0196 + IT_0165*IT_0199 + conj(IT_0178)*IT_0203 + IT_0178*IT_0206) + 2*
      (conj(IT_0155)*IT_0179 + IT_0155*IT_0181 + 0.5*conj(IT_0090)*IT_0203 + 0.5
      *IT_0090*IT_0206)*IT_0207 + (IT_0165*conj(IT_0165) + IT_0178*conj(IT_0178)
       + IT_0190*conj(IT_0190) + IT_0194*conj(IT_0194))*IT_0208 + (conj(IT_0165)
      *IT_0178 + IT_0165*conj(IT_0178) + conj(IT_0190)*IT_0194 + IT_0190*conj
      (IT_0194))*IT_0209;
