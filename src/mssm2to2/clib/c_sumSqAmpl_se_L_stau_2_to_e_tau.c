...
ccomplex_return_t c_sumSqAmpl_se_L_stau_2_to_e_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = N_d1*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0041 = N_d2*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0061 = N_d3*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0081 = N_d4*e_em*m_tau*IT_0018*U_stau_01;
