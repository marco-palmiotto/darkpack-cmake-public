        ...
        )
{
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0006*IT_0012*IT_0067;
    const ccomplex_t IT_0074 = (-0.5)*IT_0073;
    const ccomplex_t IT_0075 = IT_0032*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0077 = IT_0034*IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0006*IT_0012*IT_0067;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*(IT_0004 + 3*IT_0009);
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*(IT_0025 + 3*IT_0028);
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*(IT_0053 + 3*IT_0056);
    const ccomplex_t IT_0096 = 0.166666666666667*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
      *IT_0006*IT_0012*IT_0067;
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*(IT_0039 + 3*IT_0042);
    ...
    const ccomplex_t IT_0112 = IT_0072 + IT_0077 + IT_0082 + -IT_0088 + 
      -IT_0094 + -IT_0102 + -IT_0108 + IT_0111;
    const ccomplex_t IT_0113 = m_e*s_24;
    const ccomplex_t IT_0114 = m_u*IT_0022;
    const ccomplex_t IT_0115 = m_u*IT_0036;
    const ccomplex_t IT_0116 = m_u*IT_0050;
    const ccomplex_t IT_0117 = IT_0058*IT_0096;
    const ccomplex_t IT_0118 = IT_0062*IT_0110*IT_0117;
    const ccomplex_t IT_0119 = IT_0011*IT_0084;
    const ccomplex_t IT_0120 = IT_0020*IT_0071*IT_0119;
    const ccomplex_t IT_0121 = IT_0030*IT_0090;
    const ccomplex_t IT_0122 = IT_0034*IT_0076*IT_0121;
    const ccomplex_t IT_0123 = IT_0044*IT_0104;
    const ccomplex_t IT_0124 = IT_0048*IT_0081*IT_0123;
    const ccomplex_t IT_0125 = m_u*IT_0064;
    const ccomplex_t IT_0126 = -IT_0114 + -IT_0115 + -IT_0116 + IT_0118 +
       IT_0120 + IT_0122 + IT_0124 + -IT_0125;
    const ccomplex_t IT_0127 = m_u*s_23;
    const ccomplex_t IT_0128 = -IT_0087 + -IT_0093 + -IT_0101 + -IT_0107;
    const ccomplex_t IT_0129 = pow(m_su_L, 2);
    const ccomplex_t IT_0130 = m_e*m_u*IT_0129;
    const ccomplex_t IT_0131 = s_34*IT_0129;
    ...
    const ccomplex_t IT_0137 = m_e*m_u;
    const ccomplex_t IT_0138 = (-6)*conj(IT_0112);
    const ccomplex_t IT_0139 = (-6)*IT_0112;
    const ccomplex_t IT_0140 = -IT_0065;
    const ccomplex_t IT_0141 = 6*conj(IT_0065)*(IT_0112*IT_0113 + -IT_0126
      *IT_0127 + -IT_0128*IT_0130 + 0.166666666666667*IT_0065*IT_0135) + 6*conj
      (IT_0112)*(IT_0065*IT_0113 + 0.166666666666667*IT_0112*IT_0136) + (IT_0127
      *IT_0128 + IT_0126*IT_0137)*IT_0138 + 6*conj(IT_0126)*(IT_0113*IT_0128 +
       0.166666666666667*IT_0126*IT_0136 + 0.166666666666667*IT_0137*IT_0139 +
       IT_0127*IT_0140) + 6*conj(IT_0128)*(IT_0113*IT_0126 + 0.166666666666667
      *IT_0128*IT_0135 + 0.166666666666667*IT_0127*IT_0139 + IT_0130*IT_0140);
