...
ccomplex_return_t c_sumSqAmpl_se_L_su_R_to_e_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_e*N_d1*e_em
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_e*N_d2*e_em
      *IT_0006*IT_0063*IT_0069;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*m_e*N_d3*e_em
      *IT_0006*IT_0063*IT_0069;
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_e*N_d4*e_em
      *IT_0006*IT_0063*IT_0069;
    ...
    const ccomplex_t IT_0104 = m_e*s_24;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0106 = IT_0041*IT_0083;
    const ccomplex_t IT_0107 = IT_0045*IT_0105*IT_0106;
    const ccomplex_t IT_0108 = m_u*IT_0019;
    const ccomplex_t IT_0109 = m_u*IT_0033;
    const ccomplex_t IT_0110 = m_u*IT_0047;
    const ccomplex_t IT_0111 = m_u*IT_0061;
    const ccomplex_t IT_0112 = IT_0107 + -IT_0108 + -IT_0109 + -IT_0110 + 
      -IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0114 = IT_0027*IT_0076;
    const ccomplex_t IT_0115 = IT_0031*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0117 = IT_0055*IT_0090;
    const ccomplex_t IT_0118 = IT_0059*IT_0116*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0120 = IT_0011*IT_0067;
    const ccomplex_t IT_0121 = IT_0017*IT_0119*IT_0120;
    const ccomplex_t IT_0122 = -IT_0115 + -IT_0118 + -IT_0121;
    const ccomplex_t IT_0123 = IT_0112 + -IT_0122;
    const ccomplex_t IT_0124 = -conj(IT_0122);
    const ccomplex_t IT_0125 = conj(IT_0112) + IT_0124;
    const ccomplex_t IT_0126 = IT_0013*IT_0071;
    const ccomplex_t IT_0127 = IT_0017*IT_0119*IT_0126;
    const ccomplex_t IT_0128 = IT_0057*IT_0092;
    const ccomplex_t IT_0129 = IT_0059*IT_0116*IT_0128;
    const ccomplex_t IT_0130 = m_u*IT_0074;
    const ccomplex_t IT_0131 = m_u*IT_0088;
    const ccomplex_t IT_0132 = m_u*IT_0095;
    const ccomplex_t IT_0133 = m_u*IT_0081;
    const ccomplex_t IT_0134 = IT_0127 + IT_0129 + -IT_0130 + -IT_0131 + 
      -IT_0132 + -IT_0133;
    const ccomplex_t IT_0135 = 6*IT_0134;
    const ccomplex_t IT_0136 = IT_0029*IT_0078;
    const ccomplex_t IT_0137 = IT_0031*IT_0113*IT_0136;
    const ccomplex_t IT_0138 = IT_0043*IT_0085;
    const ccomplex_t IT_0139 = IT_0045*IT_0105*IT_0138;
    const ccomplex_t IT_0140 = -IT_0137 + -IT_0139;
    const ccomplex_t IT_0141 = (-6)*IT_0140;
    const ccomplex_t IT_0142 = IT_0135 + IT_0141;
    const ccomplex_t IT_0143 = 6*conj(IT_0134);
    ...
    const ccomplex_t IT_0148 = (-6)*IT_0134;
    const ccomplex_t IT_0149 = IT_0147 + IT_0148;
    const ccomplex_t IT_0150 = 6*conj(IT_0140);
    const ccomplex_t IT_0151 = (-6)*conj(IT_0134);
    const ccomplex_t IT_0152 = IT_0150 + IT_0151;
    const ccomplex_t IT_0153 = 6*s_34;
    const ccomplex_t IT_0154 = (-6)*s_34;
    const ccomplex_t IT_0155 = (-0.166666666666667)*IT_0096;
    const ccomplex_t IT_0156 = m_u*s_23;
    const ccomplex_t IT_0157 = (-6)*conj(IT_0062)*(IT_0096*IT_0098 + (
      -0.166666666666667)*IT_0062*IT_0103) + 6*IT_0104*(conj(IT_0096)*IT_0123 +
       IT_0096*IT_0125 + 0.166666666666667*conj(IT_0062)*IT_0142 +
       0.166666666666667*IT_0062*IT_0145) + IT_0146*(conj(IT_0122)*IT_0142 +
       IT_0122*IT_0145 + conj(IT_0112)*IT_0149 + IT_0112*IT_0152) + (IT_0112
      *conj(IT_0112) + IT_0122*conj(IT_0122) + IT_0134*conj(IT_0134) + IT_0140
      *conj(IT_0140))*IT_0153 + (conj(IT_0112)*IT_0122 + IT_0112*conj(IT_0122) +
       conj(IT_0134)*IT_0140 + IT_0134*conj(IT_0140))*IT_0154 + (-6)*conj
      (IT_0096)*(IT_0062*IT_0098 + IT_0103*IT_0155) + (-6)*(conj(IT_0062)
      *IT_0123 + IT_0062*IT_0125 + (-0.166666666666667)*conj(IT_0096)*IT_0149 +
       IT_0152*IT_0155)*IT_0156;
