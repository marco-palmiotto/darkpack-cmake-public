        ...
        )
{
    ...
    const ccomplex_t IT_0070 = IT_0017*IT_0068*IT_0069;
    ...
    const ccomplex_t IT_0075 = IT_0031*IT_0073*IT_0074;
    ...
    const ccomplex_t IT_0080 = IT_0045*IT_0078*IT_0079;
    ...
    const ccomplex_t IT_0085 = IT_0059*IT_0083*IT_0084;
    const ccomplex_t IT_0086 = sin(beta);
    const ccomplex_t IT_0087 = cpow(IT_0086, -1);
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0006*IT_0063*IT_0087;
    ...
    const ccomplex_t IT_0099 = m_u*IT_0098;
    ...
    const ccomplex_t IT_0112 = IT_0070 + IT_0075 + IT_0080 + IT_0085 + 
      -IT_0093 + -IT_0099 + -IT_0105 + -IT_0111;
    const ccomplex_t IT_0113 = m_e*s_24;
    const ccomplex_t IT_0114 = IT_0011*IT_0089;
    const ccomplex_t IT_0115 = IT_0017*IT_0069*IT_0114;
    const ccomplex_t IT_0116 = IT_0027*IT_0095;
    const ccomplex_t IT_0117 = IT_0031*IT_0074*IT_0116;
    const ccomplex_t IT_0118 = IT_0041*IT_0101;
    const ccomplex_t IT_0119 = IT_0045*IT_0079*IT_0118;
    const ccomplex_t IT_0120 = IT_0055*IT_0107;
    const ccomplex_t IT_0121 = IT_0059*IT_0084*IT_0120;
    const ccomplex_t IT_0122 = m_u*IT_0019;
    const ccomplex_t IT_0123 = m_u*IT_0033;
    const ccomplex_t IT_0124 = m_u*IT_0047;
    const ccomplex_t IT_0125 = m_u*IT_0061;
    const ccomplex_t IT_0126 = IT_0115 + IT_0117 + IT_0119 + IT_0121 + 
      -IT_0122 + -IT_0123 + -IT_0124 + -IT_0125;
    const ccomplex_t IT_0127 = m_u*s_23;
    const ccomplex_t IT_0128 = -IT_0092 + -IT_0098 + -IT_0104 + -IT_0110;
    const ccomplex_t IT_0129 = pow(m_su_R, 2);
    ...
    const ccomplex_t IT_0136 = m_e*m_u;
    const ccomplex_t IT_0137 = 6*s_34;
    const ccomplex_t IT_0138 = -conj(IT_0062);
    const ccomplex_t IT_0139 = (-6)*conj(IT_0112);
    const ccomplex_t IT_0140 = 6*IT_0062*(conj(IT_0112)*IT_0113 + -conj
      (IT_0126)*IT_0127 + -conj(IT_0128)*IT_0130 + 0.166666666666667*conj
      (IT_0062)*IT_0135) + (-6)*IT_0112*(IT_0127*conj(IT_0128) + conj(IT_0126)
      *IT_0136 + (-0.166666666666667)*conj(IT_0112)*IT_0137 + IT_0113*IT_0138) +
       6*IT_0128*(IT_0113*conj(IT_0126) + 0.166666666666667*conj(IT_0128)
      *IT_0135 + IT_0130*IT_0138 + 0.166666666666667*IT_0127*IT_0139) + 6
      *IT_0126*(IT_0113*conj(IT_0128) + 0.166666666666667*conj(IT_0126)*IT_0137 
      + IT_0127*IT_0138 + 0.166666666666667*IT_0136*IT_0139);
