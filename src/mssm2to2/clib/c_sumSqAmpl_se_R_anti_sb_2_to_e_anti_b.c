        ...
        )
{
    ...
    const ccomplex_t IT_0108 = m_b*conj(N_d3)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0114 = IT_0058*IT_0092*IT_0113;
    const ccomplex_t IT_0115 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0116 = IT_0008*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = m_b*conj(N_d1)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0124 = IT_0024*IT_0082*IT_0123;
    const ccomplex_t IT_0125 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0126 = IT_0008*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = m_b*conj(N_d2)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0134 = IT_0041*IT_0087*IT_0133;
    const ccomplex_t IT_0135 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0136 = IT_0008*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = m_b*conj(N_d4)*e_em*IT_0000*conj(U_sb_01);
    ...
    const ccomplex_t IT_0145 = IT_0080*IT_0122;
    ...
    const ccomplex_t IT_0149 = IT_0085*IT_0132;
    ...
    const ccomplex_t IT_0153 = IT_0090*IT_0112;
    ...
    const ccomplex_t IT_0162 = m_b*s_13;
    const ccomplex_t IT_0163 = -IT_0147 + -IT_0151 + -IT_0155 + -IT_0159;
    const ccomplex_t IT_0164 = m_b*m_e*IT_0023;
    ...
    const ccomplex_t IT_0170 = m_b*m_e;
    const ccomplex_t IT_0171 = 6*s_34;
    const ccomplex_t IT_0172 = -conj(IT_0078);
    const ccomplex_t IT_0173 = (-6)*conj(IT_0103);
    const ccomplex_t IT_0174 = 6*IT_0078*(conj(IT_0103)*IT_0104 + -conj
      (IT_0161)*IT_0162 + -conj(IT_0163)*IT_0164 + 0.166666666666667*conj
      (IT_0078)*IT_0169) + (-6)*IT_0103*(IT_0162*conj(IT_0163) + conj(IT_0161)
      *IT_0170 + (-0.166666666666667)*conj(IT_0103)*IT_0171 + IT_0104*IT_0172) +
       6*IT_0163*(IT_0104*conj(IT_0161) + 0.166666666666667*conj(IT_0163)
      *IT_0169 + IT_0164*IT_0172 + 0.166666666666667*IT_0162*IT_0173) + 6
      *IT_0161*(IT_0104*conj(IT_0163) + 0.166666666666667*conj(IT_0161)*IT_0171 
