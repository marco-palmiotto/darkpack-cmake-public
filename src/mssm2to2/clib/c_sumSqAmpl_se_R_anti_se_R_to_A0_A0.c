...
ccomplex_return_t c_sumSqAmpl_se_R_anti_se_R_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0027 + IT_0035 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
