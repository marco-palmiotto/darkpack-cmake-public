...
ccomplex_return_t c_sumSqAmpl_se_R_anti_se_R_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_se_L*
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
