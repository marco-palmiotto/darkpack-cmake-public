        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*-1)*e_em*(IT_0003*IT_0008
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*5)*m_W*e_em*IT_0038*(IT_0005*
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0021*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*-1)*m_W*e_em*IT_0038*(IT_0005*(
      (IT_0004 + -IT_0006)*IT_0009 + IT_0003*IT_0005*IT_0027) + -IT_0027*IT_0039);
