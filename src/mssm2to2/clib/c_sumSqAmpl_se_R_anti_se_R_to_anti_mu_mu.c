...
ccomplex_return_t c_sumSqAmpl_se_R_anti_se_R_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = m_mu*IT_0004;
    const ccomplex_t IT_0006 = (-2)*IT_0003;
    const ccomplex_t IT_0007 = m_mu*IT_0006;
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*e_em*m_mu*IT_0010*IT_0028
      *IT_0030*IT_0031;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*m_mu*IT_0010*IT_0028
      *IT_0030*IT_0035;
