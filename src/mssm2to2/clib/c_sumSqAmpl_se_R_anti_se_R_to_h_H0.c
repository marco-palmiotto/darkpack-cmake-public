...
ccomplex_return_t c_sumSqAmpl_se_R_anti_se_R_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*IT_0000*IT_0001*IT_0002*
      (IT_0004 + (-0.5)*IT_0005*IT_0006*IT_0008*IT_0010);
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0007 + -IT_0002*IT_0013) + -IT_0001*IT_0006*IT_0014*IT_0015
      *IT_0016);
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*m_W*e_em*IT_0019*(IT_0007
      *IT_0020 + 5*IT_0001*((-1)*IT_0001*(IT_0002*IT_0007 + 1./5*IT_0001*IT_0013
      ) + IT_0013*IT_0021));
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0002*IT_0007 + IT_0001*IT_0013) + -IT_0002*IT_0006*IT_0014*IT_0015
      *IT_0016);
    const ccomplex_t IT_0030 = -IT_0029;
    const ccomplex_t IT_0031 = cpow(IT_0001, 2);
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*m_W*e_em*IT_0019*(IT_0013
      *IT_0020 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0013 + 1*IT_0007*(IT_0021 + 
      -1./5*IT_0031)));
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0002
      *IT_0014*IT_0015*IT_0016;
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0001
      *IT_0014*IT_0015*IT_0016;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = IT_0039*IT_0041;
    const ccomplex_t IT_0043 = pow(m_h, 2);
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0025 + IT_0043 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0042*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = IT_0017*IT_0030;
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0025 + IT_0043 + -m_se_L*
      (m_se_L + (0 + _Complex_I*-1)*Gamma_el) + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0042*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*IT_0055;
    const ccomplex_t IT_0057 = IT_0012 + -IT_0028 + -IT_0037 + IT_0046 +
