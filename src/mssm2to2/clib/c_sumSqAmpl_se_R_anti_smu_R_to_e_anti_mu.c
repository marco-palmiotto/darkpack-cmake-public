...
ccomplex_return_t c_sumSqAmpl_se_R_anti_smu_R_to_e_anti_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0041;
    const ccomplex_t IT_0069 = -IT_0068;
    const ccomplex_t IT_0070 = IT_0016*IT_0069;
    const ccomplex_t IT_0071 = IT_0020*IT_0050*IT_0070;
    ...
    const ccomplex_t IT_0075 = IT_0028*IT_0055*IT_0074;
    ...
    const ccomplex_t IT_0079 = IT_0036*IT_0060*IT_0078;
    const ccomplex_t IT_0080 = IT_0048*IT_0069;
    const ccomplex_t IT_0081 = IT_0020*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = m_e*IT_0082;
    const ccomplex_t IT_0084 = IT_0053*IT_0073;
    ...
    const ccomplex_t IT_0088 = IT_0058*IT_0077;
    ...
    const ccomplex_t IT_0095 = IT_0012*IT_0045*IT_0094;
    const ccomplex_t IT_0096 = IT_0043*IT_0093;
    ...
    const ccomplex_t IT_0101 = m_mu*s_13;
    const ccomplex_t IT_0102 = -IT_0082 + -IT_0086 + -IT_0090 + -IT_0098;
    const ccomplex_t IT_0103 = m_e*m_mu*IT_0011;
    const ccomplex_t IT_0104 = s_13*s_14;
    const ccomplex_t IT_0105 = s_34*IT_0011;
    const ccomplex_t IT_0106 = (-0.5)*IT_0105;
    const ccomplex_t IT_0107 = IT_0104 + IT_0106;
    const ccomplex_t IT_0108 = m_e*m_mu;
    const ccomplex_t IT_0109 = 2*s_34;
    const ccomplex_t IT_0110 = (-2)*conj(IT_0066);
    const ccomplex_t IT_0111 = 2*IT_0039*(conj(IT_0066)*IT_0067 + -conj
      (IT_0100)*IT_0101 + -conj(IT_0102)*IT_0103 + 2*conj(IT_0039)*IT_0107) + 2
      *IT_0066*(conj(IT_0039)*IT_0067 + -IT_0101*conj(IT_0102) + -conj(IT_0100)
      *IT_0108 + 0.5*conj(IT_0066)*IT_0109) + 2*IT_0102*(IT_0067*conj(IT_0100) +
       -conj(IT_0039)*IT_0103 + 2*conj(IT_0102)*IT_0107 + 0.5*IT_0101*IT_0110) +
       (-2)*IT_0100*(conj(IT_0039)*IT_0101 + -IT_0067*conj(IT_0102) + (-0.5)
      *conj(IT_0100)*IT_0109 + (-0.5)*IT_0108*IT_0110);
