...
ccomplex_return_t c_sumSqAmpl_se_R_anti_snu_e_to_H0_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
      *IT_0001*IT_0005*IT_0007*IT_0018;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0003
      *IT_0005*IT_0007*IT_0018;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = pow(m_H0, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0010 + IT_0030 + -m_se_L*
    ...
    const ccomplex_t IT_0035 = -IT_0015 + -IT_0025 + IT_0034;
    const ccomplex_t IT_0036 = pow(m_W, -2);
    const ccomplex_t IT_0037 = pow(s_24, 2);
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = -IT_0015 + -IT_0025;
    ...
    return create_ccomplex_return(-IT_0035*(conj(IT_0035)*(IT_0011 + -IT_0038)
       + conj(IT_0039)*(s_12 + IT_0041)) + -IT_0039*(conj(IT_0035)*(s_12 +
       IT_0041) + conj(IT_0039)*(IT_0010 + -IT_0043)));
}
