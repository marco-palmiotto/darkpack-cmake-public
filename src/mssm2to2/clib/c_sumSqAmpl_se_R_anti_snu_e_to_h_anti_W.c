...
ccomplex_return_t c_sumSqAmpl_se_R_anti_snu_e_to_h_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_e*e_em*mu_h
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*m_e*e_em*mu_h*IT_0001
      *IT_0005*IT_0008*IT_0019;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = pow(m_h, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0011 + IT_0031 + -m_se_L*
