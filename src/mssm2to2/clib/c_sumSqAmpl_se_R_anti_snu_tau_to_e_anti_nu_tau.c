...
ccomplex_return_t c_sumSqAmpl_se_R_anti_snu_tau_to_e_anti_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0070 = m_e*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0008*IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0008*IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0082 = m_e*IT_0081;
