...
ccomplex_return_t c_sumSqAmpl_se_R_anti_st_1_to_e_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0127 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0128 = IT_0008*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_t*conj(N_u3)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0137 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0138 = IT_0008*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = m_t*conj(N_u4)*e_em*IT_0000*conj(U_st_00);
