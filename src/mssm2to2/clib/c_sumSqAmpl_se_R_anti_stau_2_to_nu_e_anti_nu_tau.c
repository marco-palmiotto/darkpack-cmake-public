...
ccomplex_return_t c_sumSqAmpl_se_R_anti_stau_2_to_nu_e_anti_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = e_em*U_Wm2*conj(U_stau_01);
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = IT_0002*IT_0004;
    const ccomplex_t IT_0010 = U_d2*e_em*m_tau*IT_0000*conj(U_stau_11);
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0020 = (-0.5)*IT_0019;
    const ccomplex_t IT_0021 = e_em*U_Wm1*conj(U_stau_01);
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = U_d1*e_em*m_tau*IT_0000*conj(U_stau_11);
