...
ccomplex_return_t c_sumSqAmpl_se_R_sb_1_to_e_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = m_b*conj(N_d4)*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0014 = IT_0011*IT_0013;
    const ccomplex_t IT_0015 = 1.4142135623731*IT_0014;
    const ccomplex_t IT_0016 = conj(N_W4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0004;
    const ccomplex_t IT_0066 = -IT_0065;
    const ccomplex_t IT_0067 = m_b*conj(N_d3)*e_em*IT_0012*U_sb_10;
    ...
    const ccomplex_t IT_0085 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0086 = IT_0004*IT_0085;
    const ccomplex_t IT_0087 = 1.4142135623731*IT_0086;
    const ccomplex_t IT_0088 = m_b*N_d4*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0008*IT_0010*IT_0012;
    const ccomplex_t IT_0097 = 0.5*IT_0096;
    const ccomplex_t IT_0098 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0099 = IT_0004*IT_0098;
    const ccomplex_t IT_0100 = 1.4142135623731*IT_0099;
    const ccomplex_t IT_0101 = m_b*N_d1*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0008*IT_0010*IT_0012;
    const ccomplex_t IT_0110 = 0.5*IT_0109;
    const ccomplex_t IT_0111 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0112 = IT_0004*IT_0111;
    const ccomplex_t IT_0113 = 1.4142135623731*IT_0112;
    const ccomplex_t IT_0114 = m_b*N_d3*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0122 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0123 = IT_0004*IT_0122;
    const ccomplex_t IT_0124 = 1.4142135623731*IT_0123;
    const ccomplex_t IT_0125 = m_b*N_d2*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0008*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0136 = m_b*m_e*IT_0001;
    ...
    const ccomplex_t IT_0144 = IT_0078*IT_0110;
    const ccomplex_t IT_0145 = IT_0064*IT_0143*IT_0144;
    const ccomplex_t IT_0146 = m_e*IT_0045;
    const ccomplex_t IT_0147 = m_e*IT_0063;
    const ccomplex_t IT_0148 = m_e*IT_0081;
    const ccomplex_t IT_0149 = m_e*IT_0027;
    const ccomplex_t IT_0150 = IT_0145 + -IT_0146 + -IT_0147 + -IT_0148 + 
      -IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0152 = IT_0024*IT_0084;
    const ccomplex_t IT_0153 = IT_0002*IT_0151*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0155 = IT_0058*IT_0131;
    const ccomplex_t IT_0156 = IT_0046*IT_0154*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0158 = IT_0042*IT_0097;
    ...
    const ccomplex_t IT_0163 = conj(IT_0150) + IT_0162;
    const ccomplex_t IT_0164 = IT_0030*IT_0105;
    const ccomplex_t IT_0165 = IT_0028*IT_0157*IT_0164;
    const ccomplex_t IT_0166 = IT_0006*IT_0092;
    const ccomplex_t IT_0167 = IT_0002*IT_0151*IT_0166;
    const ccomplex_t IT_0168 = m_e*IT_0134;
    const ccomplex_t IT_0169 = m_e*IT_0108;
    const ccomplex_t IT_0170 = m_e*IT_0121;
    const ccomplex_t IT_0171 = m_e*IT_0095;
    const ccomplex_t IT_0172 = IT_0165 + IT_0167 + -IT_0168 + -IT_0169 + 
      -IT_0170 + -IT_0171;
    const ccomplex_t IT_0173 = 6*IT_0172;
    const ccomplex_t IT_0174 = IT_0060*IT_0129;
    const ccomplex_t IT_0175 = IT_0046*IT_0154*IT_0174;
    const ccomplex_t IT_0176 = IT_0066*IT_0118;
    const ccomplex_t IT_0177 = IT_0064*IT_0143*IT_0176;
    const ccomplex_t IT_0178 = -IT_0175 + -IT_0177;
    const ccomplex_t IT_0179 = (-6)*IT_0178;
    const ccomplex_t IT_0180 = IT_0173 + IT_0179;
    const ccomplex_t IT_0181 = 6*conj(IT_0172);
    const ccomplex_t IT_0182 = (-6)*conj(IT_0178);
    const ccomplex_t IT_0183 = IT_0181 + IT_0182;
    const ccomplex_t IT_0184 = m_b*m_e;
    const ccomplex_t IT_0185 = 6*IT_0178;
    const ccomplex_t IT_0186 = (-6)*IT_0172;
    const ccomplex_t IT_0187 = IT_0185 + IT_0186;
    const ccomplex_t IT_0188 = 6*conj(IT_0178);
    const ccomplex_t IT_0189 = (-6)*conj(IT_0172);
    const ccomplex_t IT_0190 = IT_0188 + IT_0189;
    const ccomplex_t IT_0191 = 6*s_34;
    const ccomplex_t IT_0192 = (-6)*s_34;
    const ccomplex_t IT_0193 = (-0.166666666666667)*IT_0135;
    const ccomplex_t IT_0194 = m_e*s_14;
    const ccomplex_t IT_0195 = (-6)*conj(IT_0082)*(IT_0135*IT_0136 + (
      -0.166666666666667)*IT_0082*IT_0141) + 6*IT_0142*(conj(IT_0135)*IT_0161 +
       IT_0135*IT_0163 + 0.166666666666667*conj(IT_0082)*IT_0180 +
       0.166666666666667*IT_0082*IT_0183) + IT_0184*(conj(IT_0160)*IT_0180 +
       IT_0160*IT_0183 + conj(IT_0150)*IT_0187 + IT_0150*IT_0190) + (IT_0150
      *conj(IT_0150) + IT_0160*conj(IT_0160) + IT_0172*conj(IT_0172) + IT_0178
      *conj(IT_0178))*IT_0191 + (conj(IT_0150)*IT_0160 + IT_0150*conj(IT_0160) +
       conj(IT_0172)*IT_0178 + IT_0172*conj(IT_0178))*IT_0192 + (-6)*conj
      (IT_0135)*(IT_0082*IT_0136 + IT_0141*IT_0193) + (-6)*(conj(IT_0082)
      *IT_0161 + IT_0082*IT_0163 + (-0.166666666666667)*conj(IT_0135)*IT_0187 +
       IT_0190*IT_0193)*IT_0194;
