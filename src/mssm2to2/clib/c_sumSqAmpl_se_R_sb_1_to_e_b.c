        ...
        )
{
    ...
    const ccomplex_t IT_0031 = m_b*conj(N_d4)*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0032 = IT_0011*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0008*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0008*IT_0010*IT_0012;
    const ccomplex_t IT_0123 = 0.5*IT_0122;
    const ccomplex_t IT_0124 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0125 = IT_0004*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = m_b*N_d3*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0133 = IT_0064*IT_0132;
    ...
    const ccomplex_t IT_0144 = IT_0024*IT_0097;
    const ccomplex_t IT_0145 = IT_0002*IT_0143*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0147 = IT_0042*IT_0084;
    const ccomplex_t IT_0148 = IT_0028*IT_0146*IT_0147;
    const ccomplex_t IT_0149 = m_e*IT_0027;
    const ccomplex_t IT_0150 = m_e*IT_0063;
    const ccomplex_t IT_0151 = m_e*IT_0081;
    const ccomplex_t IT_0152 = m_e*IT_0045;
    const ccomplex_t IT_0153 = IT_0145 + IT_0148 + -IT_0149 + -IT_0150 + 
      -IT_0151 + -IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0155 = IT_0060*IT_0110;
    const ccomplex_t IT_0156 = IT_0046*IT_0154*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0158 = IT_0078*IT_0123;
    ...
    const ccomplex_t IT_0163 = conj(IT_0153) + IT_0162;
    const ccomplex_t IT_0164 = IT_0048*IT_0118;
    const ccomplex_t IT_0165 = IT_0046*IT_0154*IT_0164;
    const ccomplex_t IT_0166 = m_e*IT_0134;
    const ccomplex_t IT_0167 = m_e*IT_0095;
    const ccomplex_t IT_0168 = m_e*IT_0108;
    const ccomplex_t IT_0169 = m_e*IT_0121;
    const ccomplex_t IT_0170 = IT_0165 + -IT_0166 + -IT_0167 + -IT_0168 + 
      -IT_0169;
    const ccomplex_t IT_0171 = 6*IT_0170;
    const ccomplex_t IT_0172 = IT_0006*IT_0105;
    const ccomplex_t IT_0173 = IT_0002*IT_0143*IT_0172;
    const ccomplex_t IT_0174 = IT_0066*IT_0131;
    const ccomplex_t IT_0175 = IT_0064*IT_0157*IT_0174;
    const ccomplex_t IT_0176 = IT_0030*IT_0092;
    const ccomplex_t IT_0177 = IT_0028*IT_0146*IT_0176;
    const ccomplex_t IT_0178 = -IT_0173 + -IT_0175 + -IT_0177;
    ...
    const ccomplex_t IT_0195 = (-6)*conj(IT_0082)*(IT_0135*IT_0136 + (
      -0.166666666666667)*IT_0082*IT_0141) + 6*IT_0142*(conj(IT_0135)*IT_0161 +
       ...
       IT_0160*IT_0183 + conj(IT_0153)*IT_0187 + IT_0153*IT_0190) + (IT_0153
      *conj(IT_0153) + IT_0160*conj(IT_0160) + IT_0170*conj(IT_0170) + IT_0178
      *conj(IT_0178))*IT_0191 + (conj(IT_0153)*IT_0160 + IT_0153*conj(IT_0160) +
       conj(IT_0170)*IT_0178 + IT_0170*conj(IT_0178))*IT_0192 + (-6)*conj
