        ...
        )
{
    ...
    const ccomplex_t IT_0005 = conj(N_W2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0012 = m_b*conj(N_d2)*e_em*IT_0011*U_sb_11;
    ...
    const ccomplex_t IT_0031 = m_b*conj(N_d1)*e_em*IT_0011*U_sb_11;
    ...
    const ccomplex_t IT_0049 = m_b*conj(N_d3)*e_em*IT_0011*U_sb_11;
    ...
    const ccomplex_t IT_0073 = m_b*conj(N_d4)*e_em*IT_0011*U_sb_11;
    ...
    const ccomplex_t IT_0098 = m_b*N_d2*e_em*IT_0011*U_sb_01;
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0004*IT_0009*IT_0011;
    ...
    const ccomplex_t IT_0110 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0111 = IT_0016*IT_0110;
    const ccomplex_t IT_0112 = 1.4142135623731*IT_0111;
    const ccomplex_t IT_0113 = m_b*N_d4*e_em*IT_0011*U_sb_01;
    ...
    const ccomplex_t IT_0123 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0124 = IT_0016*IT_0123;
    const ccomplex_t IT_0125 = 1.4142135623731*IT_0124;
    const ccomplex_t IT_0126 = m_b*N_d3*e_em*IT_0011*U_sb_01;
    ...
    const ccomplex_t IT_0134 = -IT_0094 + -IT_0107 + -IT_0120 + -IT_0133;
    const ccomplex_t IT_0135 = m_b*m_e*IT_0001;
    ...
    const ccomplex_t IT_0143 = IT_0022*IT_0104;
    const ccomplex_t IT_0144 = IT_0002*IT_0142*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0146 = IT_0060*IT_0122;
    const ccomplex_t IT_0147 = IT_0046*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = m_e*IT_0045;
    const ccomplex_t IT_0149 = m_e*IT_0027;
    const ccomplex_t IT_0150 = m_e*IT_0063;
    const ccomplex_t IT_0151 = m_e*IT_0080;
    const ccomplex_t IT_0152 = IT_0144 + IT_0147 + -IT_0148 + -IT_0149 + 
      -IT_0150 + -IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0154 = IT_0077*IT_0109;
    const ccomplex_t IT_0155 = IT_0064*IT_0153*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0157 = IT_0042*IT_0083;
    const ccomplex_t IT_0158 = IT_0028*IT_0156*IT_0157;
    const ccomplex_t IT_0159 = -IT_0155 + -IT_0158;
    const ccomplex_t IT_0160 = IT_0152 + -IT_0159;
    const ccomplex_t IT_0161 = -conj(IT_0159);
    const ccomplex_t IT_0162 = conj(IT_0152) + IT_0161;
    const ccomplex_t IT_0163 = IT_0066*IT_0117;
    const ccomplex_t IT_0164 = IT_0064*IT_0153*IT_0163;
    const ccomplex_t IT_0165 = IT_0030*IT_0091;
    const ccomplex_t IT_0166 = IT_0028*IT_0156*IT_0165;
    const ccomplex_t IT_0167 = IT_0048*IT_0130;
    const ccomplex_t IT_0168 = IT_0046*IT_0145*IT_0167;
    const ccomplex_t IT_0169 = m_e*IT_0094;
    const ccomplex_t IT_0170 = m_e*IT_0107;
    const ccomplex_t IT_0171 = m_e*IT_0133;
    const ccomplex_t IT_0172 = m_e*IT_0120;
    const ccomplex_t IT_0173 = IT_0164 + IT_0166 + IT_0168 + -IT_0169 + 
      -IT_0170 + -IT_0171 + -IT_0172;
    const ccomplex_t IT_0174 = 6*IT_0173;
    const ccomplex_t IT_0175 = IT_0024*IT_0102;
    const ccomplex_t IT_0176 = IT_0002*IT_0142*IT_0175;
    const ccomplex_t IT_0177 = -IT_0176;
    const ccomplex_t IT_0178 = (-6)*IT_0177;
    const ccomplex_t IT_0179 = IT_0174 + IT_0178;
    const ccomplex_t IT_0180 = 6*conj(IT_0173);
    const ccomplex_t IT_0181 = (-6)*conj(IT_0177);
    const ccomplex_t IT_0182 = IT_0180 + IT_0181;
    const ccomplex_t IT_0183 = m_b*m_e;
    ...
    const ccomplex_t IT_0188 = (-6)*conj(IT_0173);
    const ccomplex_t IT_0189 = IT_0187 + IT_0188;
    const ccomplex_t IT_0190 = 6*s_34;
    const ccomplex_t IT_0191 = (-6)*s_34;
    const ccomplex_t IT_0192 = (-0.166666666666667)*IT_0134;
    const ccomplex_t IT_0193 = m_e*s_14;
    const ccomplex_t IT_0194 = (-6)*conj(IT_0081)*(IT_0134*IT_0135 + (
      -0.166666666666667)*IT_0081*IT_0140) + 6*IT_0141*(conj(IT_0134)*IT_0160 +
       IT_0134*IT_0162 + 0.166666666666667*conj(IT_0081)*IT_0179 +
       0.166666666666667*IT_0081*IT_0182) + IT_0183*(conj(IT_0159)*IT_0179 +
       IT_0159*IT_0182 + conj(IT_0152)*IT_0186 + IT_0152*IT_0189) + (IT_0152
      *conj(IT_0152) + IT_0159*conj(IT_0159) + IT_0173*conj(IT_0173) + IT_0177
      *conj(IT_0177))*IT_0190 + (conj(IT_0152)*IT_0159 + IT_0152*conj(IT_0159) +
       conj(IT_0173)*IT_0177 + IT_0173*conj(IT_0177))*IT_0191 + (-6)*conj
      (IT_0134)*(IT_0081*IT_0135 + IT_0140*IT_0192) + (-6)*(conj(IT_0081)
      *IT_0160 + IT_0081*IT_0162 + (-0.166666666666667)*conj(IT_0134)*IT_0186 +
       IT_0189*IT_0192)*IT_0193;
