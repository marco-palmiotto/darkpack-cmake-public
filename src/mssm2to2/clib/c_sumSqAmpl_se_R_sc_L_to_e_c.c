...
ccomplex_return_t c_sumSqAmpl_se_R_sc_L_to_e_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0018 = 0.5*IT_0017;
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0026 = 0.5*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0000*IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0012 + IT_0013 + -m_N_2*
    ...
    const ccomplex_t IT_0105 = IT_0034*IT_0051;
    const ccomplex_t IT_0106 = IT_0038*IT_0104*IT_0105;
    ...
    const ccomplex_t IT_0115 = IT_0006*IT_0092;
    const ccomplex_t IT_0116 = IT_0014*IT_0114*IT_0115;
    const ccomplex_t IT_0117 = m_e*IT_0095;
    const ccomplex_t IT_0118 = m_e*IT_0056;
    const ccomplex_t IT_0119 = m_e*IT_0069;
    const ccomplex_t IT_0120 = m_e*IT_0082;
    ...
    const ccomplex_t IT_0125 = IT_0010*IT_0084;
    const ccomplex_t IT_0126 = IT_0014*IT_0114*IT_0125;
    const ccomplex_t IT_0127 = IT_0020*IT_0066;
    const ccomplex_t IT_0128 = IT_0022*IT_0107*IT_0127;
    const ccomplex_t IT_0129 = IT_0028*IT_0079;
    const ccomplex_t IT_0130 = IT_0030*IT_0111*IT_0129;
    const ccomplex_t IT_0131 = -IT_0126 + -IT_0128 + -IT_0130;
    const ccomplex_t IT_0132 = 6*IT_0131;
    const ccomplex_t IT_0133 = IT_0036*IT_0053;
    const ccomplex_t IT_0134 = IT_0038*IT_0104*IT_0133;
    const ccomplex_t IT_0135 = m_e*IT_0024;
    const ccomplex_t IT_0136 = m_e*IT_0032;
    const ccomplex_t IT_0137 = m_e*IT_0016;
    const ccomplex_t IT_0138 = m_e*IT_0040;
    const ccomplex_t IT_0139 = IT_0134 + -IT_0135 + -IT_0136 + -IT_0137 + 
      -IT_0138;
    ...
    const ccomplex_t IT_0156 = (-6)*conj(IT_0041)*(IT_0096*IT_0097 + (
      -0.166666666666667)*IT_0041*IT_0102) + 6*IT_0103*(conj(IT_0096)*IT_0122 +
       IT_0096*IT_0124 + 0.166666666666667*conj(IT_0041)*IT_0141 +
       0.166666666666667*IT_0041*IT_0144) + IT_0145*(conj(IT_0121)*IT_0141 +
       IT_0121*IT_0144 + conj(IT_0110)*IT_0148 + IT_0110*IT_0151) + (IT_0110
      *conj(IT_0110) + IT_0121*conj(IT_0121) + IT_0131*conj(IT_0131) + IT_0139
      *conj(IT_0139))*IT_0152 + (conj(IT_0110)*IT_0121 + IT_0110*conj(IT_0121) +
       conj(IT_0131)*IT_0139 + IT_0131*conj(IT_0139))*IT_0153 + (-6)*conj
      (IT_0096)*(IT_0041*IT_0097 + IT_0102*IT_0154) + (-6)*(conj(IT_0041)
      *IT_0122 + IT_0041*IT_0124 + (-0.166666666666667)*conj(IT_0096)*IT_0148 +
