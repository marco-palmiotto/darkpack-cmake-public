        ...
        )
{
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0015 + IT_0016 + -m_N_3*
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0015 + IT_0016 + -m_N_1*
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0001;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0006*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0103 = IT_0011*IT_0088;
    ...
    const ccomplex_t IT_0110 = IT_0056*IT_0067;
    const ccomplex_t IT_0111 = IT_0048*IT_0109*IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0113 = IT_0041*IT_0081;
    const ccomplex_t IT_0114 = IT_0045*IT_0112*IT_0113;
    const ccomplex_t IT_0115 = m_e*IT_0019;
    const ccomplex_t IT_0116 = m_e*IT_0033;
    const ccomplex_t IT_0117 = m_e*IT_0047;
    const ccomplex_t IT_0118 = m_e*IT_0061;
    const ccomplex_t IT_0119 = IT_0111 + IT_0114 + -IT_0115 + -IT_0116 + 
      -IT_0117 + -IT_0118;
    const ccomplex_t IT_0120 = IT_0108 + -IT_0119;
    const ccomplex_t IT_0121 = -conj(IT_0119);
    const ccomplex_t IT_0122 = conj(IT_0108) + IT_0121;
    const ccomplex_t IT_0123 = IT_0013*IT_0090;
    const ccomplex_t IT_0124 = IT_0017*IT_0102*IT_0123;
    const ccomplex_t IT_0125 = m_e*IT_0079;
    const ccomplex_t IT_0126 = m_e*IT_0086;
    ...
    const ccomplex_t IT_0131 = IT_0058*IT_0069;
    const ccomplex_t IT_0132 = IT_0048*IT_0109*IT_0131;
    const ccomplex_t IT_0133 = IT_0029*IT_0076;
    const ccomplex_t IT_0134 = IT_0031*IT_0105*IT_0133;
    const ccomplex_t IT_0135 = IT_0043*IT_0083;
    const ccomplex_t IT_0136 = IT_0045*IT_0112*IT_0135;
    ...
    const ccomplex_t IT_0145 = (-6)*IT_0129;
    const ccomplex_t IT_0146 = IT_0144 + IT_0145;
    const ccomplex_t IT_0147 = 6*conj(IT_0137);
    const ccomplex_t IT_0148 = (-6)*conj(IT_0129);
    const ccomplex_t IT_0149 = IT_0147 + IT_0148;
    const ccomplex_t IT_0150 = m_e*s_14;
    const ccomplex_t IT_0151 = 6*s_34;
    const ccomplex_t IT_0152 = (-6)*s_34;
    const ccomplex_t IT_0153 = (-6)*conj(IT_0062)*(IT_0094*IT_0095 + (
      -0.166666666666667)*IT_0062*IT_0100) + (-6)*conj(IT_0094)*(IT_0062*IT_0095
       + (-0.166666666666667)*IT_0094*IT_0100) + (-6)*IT_0101*(conj(IT_0094)
      *IT_0120 + IT_0094*IT_0122 + (-0.166666666666667)*conj(IT_0062)*IT_0139 + 
      (-0.166666666666667)*IT_0062*IT_0142) + IT_0143*(conj(IT_0108)*IT_0139 +
       IT_0108*IT_0142 + conj(IT_0119)*IT_0146 + IT_0119*IT_0149) + 6*(conj
      (IT_0062)*IT_0120 + IT_0062*IT_0122 + 0.166666666666667*conj(IT_0094)
      *IT_0146 + 0.166666666666667*IT_0094*IT_0149)*IT_0150 + (IT_0108*conj
      (IT_0108) + IT_0119*conj(IT_0119) + IT_0129*conj(IT_0129) + IT_0137*conj
      (IT_0137))*IT_0151 + (conj(IT_0108)*IT_0119 + IT_0108*conj(IT_0119) + conj
      (IT_0129)*IT_0137 + IT_0129*conj(IT_0137))*IT_0152;
