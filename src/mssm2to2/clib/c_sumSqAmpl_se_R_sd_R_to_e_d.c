...
ccomplex_return_t c_sumSqAmpl_se_R_sd_R_to_e_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0067 = m_d*m_e*IT_0013;
    ...
    const ccomplex_t IT_0078 = IT_0018*IT_0049;
    const ccomplex_t IT_0079 = IT_0022*IT_0077*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0081 = IT_0034*IT_0061;
    const ccomplex_t IT_0082 = IT_0038*IT_0080*IT_0081;
    const ccomplex_t IT_0083 = -IT_0076 + -IT_0079 + -IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0085 = IT_0026*IT_0055;
    const ccomplex_t IT_0086 = IT_0030*IT_0084*IT_0085;
    const ccomplex_t IT_0087 = m_e*IT_0016;
    const ccomplex_t IT_0088 = m_e*IT_0024;
    const ccomplex_t IT_0089 = m_e*IT_0032;
    const ccomplex_t IT_0090 = m_e*IT_0040;
    const ccomplex_t IT_0091 = IT_0086 + -IT_0087 + -IT_0088 + -IT_0089 + 
      -IT_0090;
    const ccomplex_t IT_0092 = IT_0083 + -IT_0091;
    const ccomplex_t IT_0093 = -conj(IT_0091);
    const ccomplex_t IT_0094 = conj(IT_0083) + IT_0093;
    const ccomplex_t IT_0095 = IT_0010*IT_0044;
    const ccomplex_t IT_0096 = IT_0014*IT_0074*IT_0095;
    const ccomplex_t IT_0097 = IT_0036*IT_0062;
    const ccomplex_t IT_0098 = IT_0038*IT_0080*IT_0097;
    const ccomplex_t IT_0099 = m_e*IT_0047;
    const ccomplex_t IT_0100 = m_e*IT_0053;
    const ccomplex_t IT_0101 = m_e*IT_0059;
    const ccomplex_t IT_0102 = m_e*IT_0065;
    const ccomplex_t IT_0103 = IT_0096 + IT_0098 + -IT_0099 + -IT_0100 + 
      -IT_0101 + -IT_0102;
    const ccomplex_t IT_0104 = 6*IT_0103;
    const ccomplex_t IT_0105 = IT_0020*IT_0050;
    const ccomplex_t IT_0106 = IT_0022*IT_0077*IT_0105;
    const ccomplex_t IT_0107 = IT_0028*IT_0056;
    const ccomplex_t IT_0108 = IT_0030*IT_0084*IT_0107;
    const ccomplex_t IT_0109 = -IT_0106 + -IT_0108;
    const ccomplex_t IT_0110 = (-6)*IT_0109;
    const ccomplex_t IT_0111 = IT_0104 + IT_0110;
    const ccomplex_t IT_0112 = 6*conj(IT_0103);
    ...
    const ccomplex_t IT_0117 = (-6)*IT_0103;
    const ccomplex_t IT_0118 = IT_0116 + IT_0117;
    const ccomplex_t IT_0119 = 6*conj(IT_0109);
    const ccomplex_t IT_0120 = (-6)*conj(IT_0103);
    const ccomplex_t IT_0121 = IT_0119 + IT_0120;
    const ccomplex_t IT_0122 = m_d*m_e;
    const ccomplex_t IT_0123 = 6*s_34;
    const ccomplex_t IT_0124 = (-6)*s_34;
    const ccomplex_t IT_0125 = (-6)*conj(IT_0041)*(IT_0066*IT_0067 + (
      -0.166666666666667)*IT_0041*IT_0072) + (-6)*conj(IT_0066)*(IT_0041*IT_0067
       + (-0.166666666666667)*IT_0066*IT_0072) + (-6)*IT_0073*(conj(IT_0066)
      *IT_0092 + IT_0066*IT_0094 + (-0.166666666666667)*conj(IT_0041)*IT_0111 + 
      (-0.166666666666667)*IT_0041*IT_0114) + 6*IT_0115*(conj(IT_0041)*IT_0092 +
       IT_0041*IT_0094 + 0.166666666666667*conj(IT_0066)*IT_0118 +
       0.166666666666667*IT_0066*IT_0121) + (conj(IT_0083)*IT_0111 + IT_0083
      *IT_0114 + conj(IT_0091)*IT_0118 + IT_0091*IT_0121)*IT_0122 + (IT_0083
      *conj(IT_0083) + IT_0091*conj(IT_0091) + IT_0103*conj(IT_0103) + IT_0109
      *conj(IT_0109))*IT_0123 + (conj(IT_0083)*IT_0091 + IT_0083*conj(IT_0091) +
       conj(IT_0103)*IT_0109 + IT_0103*conj(IT_0109))*IT_0124;
