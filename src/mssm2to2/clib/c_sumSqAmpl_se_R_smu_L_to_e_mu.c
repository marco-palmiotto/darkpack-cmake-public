...
ccomplex_return_t c_sumSqAmpl_se_R_smu_L_to_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0095 = pow(m_smu_L, 2);
    ...
    const ccomplex_t IT_0103 = IT_0016*IT_0062;
    const ccomplex_t IT_0104 = IT_0020*IT_0102*IT_0103;
    const ccomplex_t IT_0105 = m_mu*IT_0014;
    const ccomplex_t IT_0106 = m_mu*IT_0022;
    const ccomplex_t IT_0107 = m_mu*IT_0030;
    const ccomplex_t IT_0108 = m_mu*IT_0038;
    const ccomplex_t IT_0109 = IT_0104 + -IT_0105 + -IT_0106 + -IT_0107 + 
      -IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0111 = IT_0032*IT_0075;
    const ccomplex_t IT_0112 = IT_0036*IT_0110*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0114 = IT_0006*IT_0049;
    const ccomplex_t IT_0115 = IT_0012*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0117 = IT_0024*IT_0088;
    const ccomplex_t IT_0118 = IT_0028*IT_0116*IT_0117;
    ...
    const ccomplex_t IT_0123 = IT_0026*IT_0090;
    const ccomplex_t IT_0124 = IT_0028*IT_0116*IT_0123;
    ...
    const ccomplex_t IT_0131 = IT_0008*IT_0051;
    const ccomplex_t IT_0132 = IT_0012*IT_0113*IT_0131;
    const ccomplex_t IT_0133 = IT_0018*IT_0064;
    const ccomplex_t IT_0134 = IT_0020*IT_0102*IT_0133;
    const ccomplex_t IT_0135 = IT_0034*IT_0077;
    const ccomplex_t IT_0136 = IT_0036*IT_0110*IT_0135;
    ...
    const ccomplex_t IT_0153 = (-2)*conj(IT_0039)*(IT_0094*IT_0096 + (-2)
      *IT_0039*IT_0100) + (-2)*conj(IT_0094)*(IT_0039*IT_0096 + (-2)*IT_0094
      *IT_0100) + 2*IT_0101*(conj(IT_0094)*IT_0120 + IT_0094*IT_0122 + 0.5*conj
      (IT_0039)*IT_0139 + 0.5*IT_0039*IT_0142) + IT_0143*(conj(IT_0119)*IT_0139 
      + IT_0119*IT_0142 + conj(IT_0109)*IT_0146 + IT_0109*IT_0149) + (-2)*(conj
      (IT_0039)*IT_0120 + IT_0039*IT_0122 + (-0.5)*conj(IT_0094)*IT_0146 + (-0.5
