        ...
        )
{
    ...
    const ccomplex_t IT_0143 = m_mu*s_23;
    ...
    const ccomplex_t IT_0150 = m_e*m_mu;
    ...
    const ccomplex_t IT_0153 = (-2)*conj(IT_0039)*(IT_0094*IT_0096 + (-2)
      ...
      *IT_0100) + (-2)*IT_0101*(conj(IT_0094)*IT_0120 + IT_0094*IT_0122 + (-0.5)
      *conj(IT_0039)*IT_0139 + (-0.5)*IT_0039*IT_0142) + 2*IT_0143*(conj(IT_0039
      )*IT_0120 + IT_0039*IT_0122 + 0.5*conj(IT_0094)*IT_0146 + 0.5*IT_0094
      *IT_0149) + (conj(IT_0111)*IT_0139 + IT_0111*IT_0142 + conj(IT_0119)
      *IT_0146 + IT_0119*IT_0149)*IT_0150 + (IT_0111*conj(IT_0111) + IT_0119
      *conj(IT_0119) + IT_0131*conj(IT_0131) + IT_0137*conj(IT_0137))*IT_0151 + 
      (conj(IT_0111)*IT_0119 + IT_0111*conj(IT_0119) + conj(IT_0131)*IT_0137 +
       IT_0131*conj(IT_0137))*IT_0152;
