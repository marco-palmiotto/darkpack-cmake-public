        ...
        )
{
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0070 = IT_0006*IT_0043;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0072 = IT_0014*IT_0070*IT_0071;
    const ccomplex_t IT_0073 = IT_0018*IT_0048;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0075 = IT_0022*IT_0073*IT_0074;
    const ccomplex_t IT_0076 = IT_0034*IT_0058;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0078 = IT_0038*IT_0076*IT_0077;
    const ccomplex_t IT_0079 = -IT_0072 + -IT_0075 + -IT_0078;
    const ccomplex_t IT_0080 = IT_0026*IT_0053;
    ...
    const ccomplex_t IT_0084 = m_mu*IT_0024;
    const ccomplex_t IT_0085 = m_mu*IT_0032;
    const ccomplex_t IT_0086 = m_mu*IT_0040;
    const ccomplex_t IT_0087 = IT_0082 + -IT_0083 + -IT_0084 + -IT_0085 + 
      -IT_0086;
    const ccomplex_t IT_0088 = IT_0079 + -IT_0087;
    const ccomplex_t IT_0089 = -conj(IT_0087);
    const ccomplex_t IT_0090 = conj(IT_0079) + IT_0089;
    const ccomplex_t IT_0091 = cpow(IT_0010, 2);
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*m_N_1*IT_0091;
    const ccomplex_t IT_0093 = IT_0014*IT_0092;
    const ccomplex_t IT_0094 = cpow(IT_0036, 2);
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_N_4*IT_0094;
    const ccomplex_t IT_0096 = IT_0038*IT_0095;
    const ccomplex_t IT_0097 = m_mu*IT_0046;
    const ccomplex_t IT_0098 = m_mu*IT_0051;
    const ccomplex_t IT_0099 = m_mu*IT_0056;
    const ccomplex_t IT_0100 = m_mu*IT_0061;
    const ccomplex_t IT_0101 = IT_0093 + IT_0096 + -IT_0097 + -IT_0098 + 
      -IT_0099 + -IT_0100;
    ...
    const ccomplex_t IT_0106 = cpow(IT_0028, 2);
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*m_N_3*IT_0106;
    ...
    const ccomplex_t IT_0125 = (-2)*conj(IT_0041)*(IT_0062*IT_0064 + (-2)
      ...
      *IT_0068) + (-2)*IT_0069*(conj(IT_0062)*IT_0088 + IT_0062*IT_0090 + (-0.5)
      *conj(IT_0041)*IT_0111 + (-0.5)*IT_0041*IT_0114) + 2*IT_0115*(conj(IT_0041
      )*IT_0088 + IT_0041*IT_0090 + 0.5*conj(IT_0062)*IT_0118 + 0.5*IT_0062
      *IT_0121) + (conj(IT_0079)*IT_0111 + IT_0079*IT_0114 + conj(IT_0087)
      *IT_0118 + IT_0087*IT_0121)*IT_0122 + (IT_0079*conj(IT_0079) + IT_0087
      *conj(IT_0087) + IT_0101*conj(IT_0101) + IT_0109*conj(IT_0109))*IT_0123 + 
      (conj(IT_0079)*IT_0087 + IT_0079*conj(IT_0087) + conj(IT_0101)*IT_0109 +
       IT_0101*conj(IT_0109))*IT_0124;
