        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = IT_0045*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0010 + IT_0035 + -m_N_2*
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0010 + IT_0035 + -m_N_3*
    ...
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0078 = cpow((-2)*s_13 + IT_0010 + IT_0035 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0079 = IT_0076*IT_0077*IT_0078;
    const ccomplex_t IT_0080 = IT_0013 + IT_0020 + IT_0037 + IT_0051 + IT_0065
       + IT_0079;
    ...
    const ccomplex_t IT_0114 = IT_0073*IT_0113;
    ...
    const ccomplex_t IT_0119 = conj(IT_0091) + conj(IT_0117);
    const ccomplex_t IT_0120 = m_e*s_24;
    const ccomplex_t IT_0121 = 2*IT_0080;
    const ccomplex_t IT_0122 = 2*conj(IT_0080);
    const ccomplex_t IT_0123 = (-2)*s_34;
    const ccomplex_t IT_0124 = 2*s_34*(IT_0080*conj(IT_0080) + IT_0092*conj
      (IT_0092)) + 4*IT_0096*IT_0118*IT_0119 + (-2)*IT_0120*(IT_0119*(IT_0092 + 
      (-0.5)*IT_0121) + IT_0118*(conj(IT_0092) + (-0.5)*IT_0122)) + (conj
      (IT_0080)*IT_0092 + IT_0080*conj(IT_0092))*IT_0123;
