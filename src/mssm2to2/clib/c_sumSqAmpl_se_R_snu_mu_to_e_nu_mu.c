...
ccomplex_return_t c_sumSqAmpl_se_R_snu_mu_to_e_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    return create_ccomplex_return(2*IT_0065*(s_34*conj(IT_0065) + -conj
      (IT_0086)*IT_0087) + (-2)*IT_0086*(conj(IT_0065)*IT_0087 + (-2)*conj
