...
ccomplex_return_t c_sumSqAmpl_se_R_snu_tau_to_e_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
