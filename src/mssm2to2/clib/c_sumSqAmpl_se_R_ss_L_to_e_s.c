        ...
        )
{
    ...
    const ccomplex_t IT_0104 = IT_0006*IT_0049;
    const ccomplex_t IT_0105 = IT_0012*IT_0103*IT_0104;
    ...
    const ccomplex_t IT_0114 = IT_0024*IT_0075;
    const ccomplex_t IT_0115 = IT_0028*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = m_s*IT_0014;
    const ccomplex_t IT_0117 = m_s*IT_0022;
    const ccomplex_t IT_0118 = m_s*IT_0030;
    ...
    const ccomplex_t IT_0124 = IT_0008*IT_0051;
    const ccomplex_t IT_0125 = IT_0012*IT_0103*IT_0124;
    const ccomplex_t IT_0126 = IT_0034*IT_0090;
    const ccomplex_t IT_0127 = IT_0036*IT_0109*IT_0126;
    const ccomplex_t IT_0128 = m_s*IT_0054;
    const ccomplex_t IT_0129 = m_s*IT_0067;
    const ccomplex_t IT_0130 = m_s*IT_0080;
    const ccomplex_t IT_0131 = m_s*IT_0093;
    const ccomplex_t IT_0132 = IT_0125 + IT_0127 + -IT_0128 + -IT_0129 + 
      -IT_0130 + -IT_0131;
    const ccomplex_t IT_0133 = 6*IT_0132;
    const ccomplex_t IT_0134 = IT_0018*IT_0064;
    const ccomplex_t IT_0135 = IT_0020*IT_0106*IT_0134;
    const ccomplex_t IT_0136 = IT_0026*IT_0077;
    const ccomplex_t IT_0137 = IT_0028*IT_0113*IT_0136;
    ...
    const ccomplex_t IT_0144 = m_s*s_23;
    ...
    const ccomplex_t IT_0151 = m_e*m_s;
    ...
    const ccomplex_t IT_0154 = (-6)*conj(IT_0039)*(IT_0094*IT_0096 + (
      ...
      *IT_0121 + IT_0094*IT_0123 + (-0.166666666666667)*conj(IT_0039)*IT_0140 + 
      (-0.166666666666667)*IT_0039*IT_0143) + 6*IT_0144*(conj(IT_0039)*IT_0121 +
       IT_0039*IT_0123 + 0.166666666666667*conj(IT_0094)*IT_0147 +
       0.166666666666667*IT_0094*IT_0150) + (conj(IT_0112)*IT_0140 + IT_0112
      *IT_0143 + conj(IT_0120)*IT_0147 + IT_0120*IT_0150)*IT_0151 + (IT_0112
      *conj(IT_0112) + IT_0120*conj(IT_0120) + IT_0132*conj(IT_0132) + IT_0138
      *conj(IT_0138))*IT_0152 + (conj(IT_0112)*IT_0120 + IT_0112*conj(IT_0120) +
       conj(IT_0132)*IT_0138 + IT_0132*conj(IT_0138))*IT_0153;
