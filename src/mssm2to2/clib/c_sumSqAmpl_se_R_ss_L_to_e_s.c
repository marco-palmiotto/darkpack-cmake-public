...
ccomplex_return_t c_sumSqAmpl_se_R_ss_L_to_e_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0104 = IT_0024*IT_0062;
    const ccomplex_t IT_0105 = IT_0028*IT_0103*IT_0104;
    const ccomplex_t IT_0106 = m_s*IT_0014;
    const ccomplex_t IT_0107 = m_s*IT_0022;
    const ccomplex_t IT_0108 = m_s*IT_0030;
    const ccomplex_t IT_0109 = m_s*IT_0038;
    const ccomplex_t IT_0110 = IT_0105 + -IT_0106 + -IT_0107 + -IT_0108 + 
      -IT_0109;
    const ccomplex_t IT_0111 = IT_0018*IT_0051;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0113 = IT_0020*IT_0111*IT_0112;
    const ccomplex_t IT_0114 = IT_0026*IT_0064;
    const ccomplex_t IT_0115 = IT_0028*IT_0103*IT_0114;
    const ccomplex_t IT_0116 = -IT_0113 + -IT_0115;
    const ccomplex_t IT_0117 = 6*IT_0116;
    const ccomplex_t IT_0118 = IT_0008*IT_0090;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0120 = IT_0012*IT_0118*IT_0119;
    const ccomplex_t IT_0121 = IT_0034*IT_0077;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0123 = IT_0036*IT_0121*IT_0122;
    const ccomplex_t IT_0124 = m_s*IT_0054;
    const ccomplex_t IT_0125 = m_s*IT_0067;
    const ccomplex_t IT_0126 = m_s*IT_0080;
    const ccomplex_t IT_0127 = m_s*IT_0093;
    const ccomplex_t IT_0128 = IT_0120 + IT_0123 + -IT_0124 + -IT_0125 + 
      -IT_0126 + -IT_0127;
    const ccomplex_t IT_0129 = (-6)*IT_0128;
    const ccomplex_t IT_0130 = IT_0117 + IT_0129;
    const ccomplex_t IT_0131 = 6*conj(IT_0116);
    const ccomplex_t IT_0132 = (-6)*conj(IT_0128);
    const ccomplex_t IT_0133 = IT_0131 + IT_0132;
    const ccomplex_t IT_0134 = IT_0006*IT_0088;
    const ccomplex_t IT_0135 = IT_0012*IT_0119*IT_0134;
    const ccomplex_t IT_0136 = IT_0016*IT_0049;
    const ccomplex_t IT_0137 = IT_0020*IT_0112*IT_0136;
    const ccomplex_t IT_0138 = IT_0032*IT_0075;
    const ccomplex_t IT_0139 = IT_0036*IT_0122*IT_0138;
    const ccomplex_t IT_0140 = -IT_0135 + -IT_0137 + -IT_0139;
    const ccomplex_t IT_0141 = 6*IT_0128;
    const ccomplex_t IT_0142 = (-6)*IT_0116;
    const ccomplex_t IT_0143 = IT_0141 + IT_0142;
    const ccomplex_t IT_0144 = 6*conj(IT_0128);
    const ccomplex_t IT_0145 = (-6)*conj(IT_0116);
    const ccomplex_t IT_0146 = IT_0144 + IT_0145;
    const ccomplex_t IT_0147 = m_e*s_24;
    const ccomplex_t IT_0148 = IT_0110 + -IT_0140;
    const ccomplex_t IT_0149 = -conj(IT_0140);
    const ccomplex_t IT_0150 = conj(IT_0110) + IT_0149;
    ...
    const ccomplex_t IT_0155 = (-6)*conj(IT_0039)*(IT_0094*IT_0096 + (
      -0.166666666666667)*IT_0039*IT_0101) + IT_0102*(conj(IT_0110)*IT_0130 +
       IT_0110*IT_0133 + conj(IT_0140)*IT_0143 + IT_0140*IT_0146) + 6*IT_0147*
      (0.166666666666667*conj(IT_0039)*IT_0143 + 0.166666666666667*IT_0039
      *IT_0146 + conj(IT_0094)*IT_0148 + IT_0094*IT_0150) + (IT_0110*conj
      (IT_0110) + IT_0116*conj(IT_0116) + IT_0128*conj(IT_0128) + IT_0140*conj
      (IT_0140))*IT_0151 + (conj(IT_0116)*IT_0128 + IT_0116*conj(IT_0128) + conj
      (IT_0110)*IT_0140 + IT_0110*conj(IT_0140))*IT_0152 + (-6)*conj(IT_0094)*
      (IT_0039*IT_0096 + IT_0101*IT_0153) + (-6)*((-0.166666666666667)*conj
      (IT_0094)*IT_0130 + conj(IT_0039)*IT_0148 + IT_0039*IT_0150 + IT_0133
      *IT_0153)*IT_0154;
