...
ccomplex_return_t c_sumSqAmpl_se_R_stau_2_to_e_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d1)
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d2)
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*m_e*conj(N_d3)
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0075 = conj(N_d2)*e_em*m_tau*IT_0003*U_stau_11;
    ...
    const ccomplex_t IT_0107 = conj(N_d4)*e_em*m_tau*IT_0003*U_stau_11;
    ...
    const ccomplex_t IT_0140 = IT_0026*IT_0079;
    ...
    const ccomplex_t IT_0160 = m_tau*IT_0114;
    const ccomplex_t IT_0161 = m_tau*IT_0130;
    const ccomplex_t IT_0162 = IT_0048*IT_0116;
    const ccomplex_t IT_0163 = IT_0038*IT_0153*IT_0162;
    const ccomplex_t IT_0164 = m_tau*IT_0098;
    const ccomplex_t IT_0165 = m_tau*IT_0082;
    const ccomplex_t IT_0166 = -IT_0160 + -IT_0161 + IT_0163 + -IT_0164 + 
      -IT_0165;
    const ccomplex_t IT_0167 = 2*IT_0166;
    const ccomplex_t IT_0168 = IT_0034*IT_0068;
    const ccomplex_t IT_0169 = IT_0024*IT_0139*IT_0168;
    const ccomplex_t IT_0170 = IT_0062*IT_0100;
    const ccomplex_t IT_0171 = IT_0052*IT_0147*IT_0170;
    const ccomplex_t IT_0172 = IT_0020*IT_0084;
    const ccomplex_t IT_0173 = IT_0002*IT_0150*IT_0172;
    const ccomplex_t IT_0174 = -IT_0169 + -IT_0171 + -IT_0173;
    const ccomplex_t IT_0175 = (-2)*IT_0174;
    const ccomplex_t IT_0176 = IT_0167 + IT_0175;
    const ccomplex_t IT_0177 = 2*conj(IT_0166);
    ...
    const ccomplex_t IT_0190 = (-2)*conj(IT_0066)*(IT_0131*IT_0133 + (-2)
      ...
      *IT_0137) + 2*IT_0138*(conj(IT_0131)*IT_0157 + IT_0131*IT_0159 + 0.5*conj
      ...
      ) + IT_0166*conj(IT_0166) + IT_0174*conj(IT_0174))*IT_0188 + (conj(IT_0146
      )*IT_0156 + IT_0146*conj(IT_0156) + conj(IT_0166)*IT_0174 + IT_0166*conj
      (IT_0174))*IT_0189;
