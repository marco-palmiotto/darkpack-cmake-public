...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_sb_2_to_mu_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0103 = -IT_0033 + -IT_0056 + -IT_0079 + -IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0106 = (-0.5)*IT_0105;
    const ccomplex_t IT_0107 = IT_0030*IT_0106;
    const ccomplex_t IT_0108 = IT_0002*IT_0104*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = IT_0052*IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0113 = IT_0054*IT_0111*IT_0112;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0118 = IT_0080*IT_0116*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0123 = IT_0077*IT_0121*IT_0122;
    const ccomplex_t IT_0124 = m_mu*IT_0033;
    const ccomplex_t IT_0125 = m_mu*IT_0056;
    const ccomplex_t IT_0126 = m_mu*IT_0079;
    const ccomplex_t IT_0127 = m_mu*IT_0102;
    const ccomplex_t IT_0128 = -IT_0108 + -IT_0113 + -IT_0118 + -IT_0123 +
       IT_0124 + IT_0125 + IT_0126 + IT_0127;
    const ccomplex_t IT_0129 = m_mu*s_14;
    ...
    const ccomplex_t IT_0133 = m_b*conj(N_d1)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0139 = IT_0002*IT_0104*IT_0138;
    const ccomplex_t IT_0140 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0141 = IT_0004*IT_0140;
    const ccomplex_t IT_0142 = 1.4142135623731*IT_0141;
    const ccomplex_t IT_0143 = m_b*conj(N_d2)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0149 = IT_0054*IT_0112*IT_0148;
    ...
    const ccomplex_t IT_0153 = m_b*conj(N_d4)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0159 = IT_0077*IT_0122*IT_0158;
    const ccomplex_t IT_0160 = IT_0106*IT_0137;
    const ccomplex_t IT_0161 = IT_0002*IT_0160;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*IT_0161;
    const ccomplex_t IT_0163 = m_mu*IT_0162;
    const ccomplex_t IT_0164 = IT_0110*IT_0147;
    ...
    const ccomplex_t IT_0180 = IT_0120*IT_0157;
    const ccomplex_t IT_0181 = IT_0077*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*IT_0181;
    const ccomplex_t IT_0183 = m_mu*IT_0182;
    const ccomplex_t IT_0184 = IT_0099*IT_0175;
    const ccomplex_t IT_0185 = IT_0080*IT_0117*IT_0184;
    const ccomplex_t IT_0186 = -IT_0139 + -IT_0149 + -IT_0159 + IT_0163 +
       IT_0167 + IT_0179 + IT_0183 + -IT_0185;
    const ccomplex_t IT_0187 = m_b*s_13;
    const ccomplex_t IT_0188 = -IT_0162 + -IT_0166 + -IT_0178 + -IT_0182;
    const ccomplex_t IT_0189 = m_b*m_mu*IT_0001;
    const ccomplex_t IT_0190 = s_34*IT_0001;
    const ccomplex_t IT_0191 = (-6)*IT_0190;
    const ccomplex_t IT_0192 = s_13*s_14;
    const ccomplex_t IT_0193 = 12*IT_0192;
    const ccomplex_t IT_0194 = IT_0191 + IT_0193;
    const ccomplex_t IT_0195 = m_b*m_mu;
    const ccomplex_t IT_0196 = 6*s_34;
    const ccomplex_t IT_0197 = -conj(IT_0103);
    const ccomplex_t IT_0198 = (-6)*conj(IT_0128);
    const ccomplex_t IT_0199 = 6*IT_0103*(conj(IT_0128)*IT_0129 + -conj
      (IT_0186)*IT_0187 + -conj(IT_0188)*IT_0189 + 0.166666666666667*conj
      (IT_0103)*IT_0194) + (-6)*IT_0128*(IT_0187*conj(IT_0188) + conj(IT_0186)
      *IT_0195 + (-0.166666666666667)*conj(IT_0128)*IT_0196 + IT_0129*IT_0197) +
       6*IT_0188*(IT_0129*conj(IT_0186) + 0.166666666666667*conj(IT_0188)
      *IT_0194 + IT_0189*IT_0197 + 0.166666666666667*IT_0187*IT_0198) + 6
      *IT_0186*(IT_0129*conj(IT_0188) + 0.166666666666667*conj(IT_0186)*IT_0196 
      + IT_0187*IT_0197 + 0.166666666666667*IT_0195*IT_0198);
