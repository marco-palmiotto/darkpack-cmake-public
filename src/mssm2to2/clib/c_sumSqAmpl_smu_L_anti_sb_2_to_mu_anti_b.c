        ...
        )
{
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_3*
    ...
    const ccomplex_t IT_0043 = m_b*N_d3*e_em*IT_0021*conj(U_sb_11);
    const ccomplex_t IT_0044 = IT_0020*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = N_B3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0047 = IT_0004*IT_0046;
    const ccomplex_t IT_0048 = 1.4142135623731*IT_0047;
    const ccomplex_t IT_0049 = N_W3*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0059 = m_b*N_d2*e_em*IT_0021*conj(U_sb_11);
    const ccomplex_t IT_0060 = IT_0020*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = N_W2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0063 = IT_0009*IT_0062;
    const ccomplex_t IT_0064 = 1.4142135623731*IT_0063;
    const ccomplex_t IT_0065 = N_B2*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_4*
    ...
    const ccomplex_t IT_0091 = N_W4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0092 = IT_0009*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = m_b*N_d4*e_em*IT_0021*conj(U_sb_11);
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0109 = (-0.5)*IT_0108;
    const ccomplex_t IT_0110 = IT_0054*IT_0109;
    const ccomplex_t IT_0111 = IT_0034*IT_0107*IT_0110;
    const ccomplex_t IT_0112 = m_mu*IT_0057;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0115 = (-0.5)*IT_0114;
    const ccomplex_t IT_0116 = IT_0070*IT_0115;
    const ccomplex_t IT_0117 = IT_0058*IT_0113*IT_0116;
    const ccomplex_t IT_0118 = m_mu*IT_0033;
    const ccomplex_t IT_0119 = m_mu*IT_0081;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0122 = (-0.5)*IT_0121;
    const ccomplex_t IT_0123 = IT_0030*IT_0122;
    const ccomplex_t IT_0124 = IT_0002*IT_0120*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0127 = (-0.5)*IT_0126;
    const ccomplex_t IT_0128 = IT_0102*IT_0127;
    const ccomplex_t IT_0129 = IT_0082*IT_0125*IT_0128;
    const ccomplex_t IT_0130 = m_mu*IT_0105;
    const ccomplex_t IT_0131 = -IT_0111 + IT_0112 + -IT_0117 + IT_0118 +
       IT_0119 + -IT_0124 + -IT_0129 + IT_0130;
    const ccomplex_t IT_0132 = m_mu*s_14;
    const ccomplex_t IT_0133 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0134 = IT_0004*IT_0133;
    const ccomplex_t IT_0135 = 1.4142135623731*IT_0134;
    const ccomplex_t IT_0136 = m_b*conj(N_d1)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0142 = IT_0002*IT_0120*IT_0141;
    ...
    const ccomplex_t IT_0146 = m_b*conj(N_d2)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0152 = IT_0058*IT_0113*IT_0151;
    const ccomplex_t IT_0153 = IT_0122*IT_0140;
    ...
    const ccomplex_t IT_0157 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0158 = IT_0004*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = m_b*conj(N_d3)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0166 = IT_0034*IT_0107*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0168 = IT_0004*IT_0167;
    const ccomplex_t IT_0169 = 1.4142135623731*IT_0168;
    const ccomplex_t IT_0170 = m_b*conj(N_d4)*e_em*IT_0021*conj(U_sb_01);
    ...
    const ccomplex_t IT_0176 = IT_0082*IT_0125*IT_0175;
    const ccomplex_t IT_0177 = IT_0115*IT_0150;
    ...
    const ccomplex_t IT_0181 = IT_0109*IT_0164;
    ...
    const ccomplex_t IT_0185 = IT_0127*IT_0174;
    const ccomplex_t IT_0186 = IT_0082*IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1)*IT_0186;
    const ccomplex_t IT_0188 = m_mu*IT_0187;
    const ccomplex_t IT_0189 = -IT_0142 + -IT_0152 + IT_0156 + -IT_0166 + 
      -IT_0176 + IT_0180 + IT_0184 + IT_0188;
    const ccomplex_t IT_0190 = m_b*s_13;
    const ccomplex_t IT_0191 = -IT_0155 + -IT_0179 + -IT_0183 + -IT_0187;
    const ccomplex_t IT_0192 = m_b*m_mu*IT_0001;
    ...
    const ccomplex_t IT_0198 = m_b*m_mu;
