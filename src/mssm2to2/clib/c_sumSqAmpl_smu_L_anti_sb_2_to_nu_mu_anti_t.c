...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_sb_2_to_nu_mu_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = V_tb*e_em*U_Wm1*conj(U_sb_01);
    ...
    const ccomplex_t IT_0026 = m_b*U_d1*V_tb*e_em*IT_0003*conj(U_sb_11);
    ...
    const ccomplex_t IT_0033 = V_tb*e_em*U_Wm2*conj(U_sb_01);
    const ccomplex_t IT_0034 = IT_0001*IT_0033;
    const ccomplex_t IT_0035 = m_b*U_d2*V_tb*e_em*IT_0003*conj(U_sb_11);
