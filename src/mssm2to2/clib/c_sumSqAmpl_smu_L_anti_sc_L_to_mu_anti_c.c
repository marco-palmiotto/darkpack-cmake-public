...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_sc_L_to_mu_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0107 = m_mu*IT_0065;
    const ccomplex_t IT_0108 = m_mu*IT_0085;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0006*IT_0087*IT_0089;
    ...
    const ccomplex_t IT_0135 = m_mu*IT_0134;
    ...
    const ccomplex_t IT_0149 = m_mu*IT_0148;
    ...
    const ccomplex_t IT_0153 = m_c*m_mu*IT_0022;
    ...
    const ccomplex_t IT_0160 = m_c*m_mu;
