        ...
        )
{
    ...
    const ccomplex_t IT_0142 = IT_0053*IT_0131;
    const ccomplex_t IT_0143 = IT_0063*IT_0103*IT_0142;
    const ccomplex_t IT_0144 = IT_0110*IT_0137;
    ...
    const ccomplex_t IT_0148 = IT_0082*IT_0125;
    const ccomplex_t IT_0149 = IT_0066*IT_0098*IT_0148;
    const ccomplex_t IT_0150 = IT_0123 + IT_0129 + IT_0135 + -IT_0139 + 
      -IT_0141 + -IT_0143 + IT_0147 + -IT_0149;
    const ccomplex_t IT_0151 = m_c*s_13;
    const ccomplex_t IT_0152 = -IT_0122 + -IT_0128 + -IT_0134 + -IT_0146;
    ...
    const ccomplex_t IT_0159 = m_c*m_mu;
    const ccomplex_t IT_0160 = 6*s_34;
    const ccomplex_t IT_0161 = -conj(IT_0086);
    const ccomplex_t IT_0162 = (-6)*conj(IT_0114);
    const ccomplex_t IT_0163 = 6*IT_0086*(conj(IT_0114)*IT_0115 + -conj
      (IT_0150)*IT_0151 + -conj(IT_0152)*IT_0153 + 0.166666666666667*conj
      (IT_0086)*IT_0158) + (-6)*IT_0114*(IT_0151*conj(IT_0152) + conj(IT_0150)
      *IT_0159 + (-0.166666666666667)*conj(IT_0114)*IT_0160 + IT_0115*IT_0161) +
       6*IT_0152*(IT_0115*conj(IT_0150) + 0.166666666666667*conj(IT_0152)
      *IT_0158 + IT_0153*IT_0161 + 0.166666666666667*IT_0151*IT_0162) + 6
      *IT_0150*(IT_0115*conj(IT_0152) + 0.166666666666667*conj(IT_0150)*IT_0160 
      + IT_0151*IT_0161 + 0.166666666666667*IT_0159*IT_0162);
