...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_sd_L_to_mu_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0147 = m_mu*IT_0146;
    ...
    const ccomplex_t IT_0151 = m_d*m_mu*IT_0022;
    ...
    const ccomplex_t IT_0158 = m_d*m_mu;
