...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_sd_L_to_nu_mu_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1)*e_em*conj(U_Wm2)*IT_0001;
    ...
    const ccomplex_t IT_0019 = IT_0013*IT_0017*IT_0018;
    const ccomplex_t IT_0020 = 0.5*IT_0012 + 0.5*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm1*IT_0001;
    const ccomplex_t IT_0022 = IT_0002*IT_0021;
    const ccomplex_t IT_0023 = IT_0011*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm2*IT_0001;
    const ccomplex_t IT_0026 = IT_0014*IT_0025;
    const ccomplex_t IT_0027 = IT_0018*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = 0.5*IT_0024 + 0.5*IT_0028;
    const ccomplex_t IT_0030 = m_u*s_13;
    const ccomplex_t IT_0031 = s_13*s_14;
    const ccomplex_t IT_0032 = s_34*IT_0010;
    return create_ccomplex_return(6*IT_0020*(s_34*conj(IT_0020) + -conj
      (IT_0029)*IT_0030) + (-6)*IT_0029*(conj(IT_0020)*IT_0030 + (
      -0.166666666666667)*conj(IT_0029)*(12*IT_0031 + (-6)*IT_0032)));
}
