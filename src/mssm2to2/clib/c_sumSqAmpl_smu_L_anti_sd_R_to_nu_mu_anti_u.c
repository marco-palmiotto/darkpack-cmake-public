...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_sd_R_to_nu_mu_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
      *e_em*IT_0001*IT_0003*IT_0005;
    ...
    return create_ccomplex_return(IT_0020*conj(IT_0020)*(12*IT_0021 + (-6)
      *IT_0022));
}
