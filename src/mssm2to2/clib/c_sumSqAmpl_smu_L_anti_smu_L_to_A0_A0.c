...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = e_em*m_mu*mu_h*IT_0014*IT_0015;
    const ccomplex_t IT_0017 = 0.5*IT_0016;
    const ccomplex_t IT_0018 = (-0.5)*IT_0016;
    const ccomplex_t IT_0019 = IT_0017*IT_0018;
    const ccomplex_t IT_0020 = pow(m_A0, 2);
    const ccomplex_t IT_0021 = pow(m_smu_L, 2);
    const ccomplex_t IT_0022 = cpow((-2)*s_13 + IT_0020 + IT_0021 + -m_smu_R*
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*(IT_0010*IT_0014
      *IT_0015*IT_0026*IT_0027 + 0.5*m_W*(IT_0004*IT_0005 + -IT_0015)*(IT_0001
      *IT_0027 + IT_0007*IT_0028));
    const ccomplex_t IT_0030 = IT_0004*IT_0005;
    const ccomplex_t IT_0031 = IT_0015 + IT_0030;
    const ccomplex_t IT_0032 = cpow(IT_0007, 3);
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_W*e_em*IT_0031*(IT_0001*
      (IT_0008*IT_0027 + -IT_0001*(IT_0001*IT_0027 + IT_0007*IT_0028)) + IT_0028
      *IT_0032);
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = IT_0029*IT_0034;
    const ccomplex_t IT_0036 = IT_0025*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0020 + IT_0021 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0039 = IT_0019*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*e_em*(IT_0010*IT_0014
      *IT_0015*IT_0026*IT_0028 + (-0.5)*m_W*(IT_0004*IT_0005 + -IT_0015)*
      (IT_0007*IT_0027 + -IT_0001*IT_0028));
    const ccomplex_t IT_0042 = -IT_0041;
    const ccomplex_t IT_0043 = -IT_0001;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*m_W*e_em*IT_0031*(IT_0027
      *IT_0032 + IT_0043*(IT_0008*IT_0028 + -(IT_0007*IT_0027 + -IT_0001*IT_0028
      )*IT_0043));
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = IT_0042*IT_0045;
    const ccomplex_t IT_0047 = cpow((-2)*s_12 + (-2)*IT_0021 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*IT_0048;
    const ccomplex_t IT_0050 = IT_0013 + IT_0024 + -IT_0037 + IT_0040 + 
      -IT_0049;
