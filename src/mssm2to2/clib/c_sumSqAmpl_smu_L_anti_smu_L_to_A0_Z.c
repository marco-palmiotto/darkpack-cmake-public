...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(IT_0002*IT_0007
      *IT_0009*IT_0010*IT_0011 + (-0.5)*m_W*(IT_0002*IT_0004 + -IT_0003*IT_0005)
      *(IT_0007 + -IT_0006*IT_0012));
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*e_em*(IT_0005*IT_0007
    ...
    return create_ccomplex_return((-2)*IT_0027*conj(IT_0027)*(s_12 + IT_0015 +
