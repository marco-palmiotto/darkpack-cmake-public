...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_H0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0011 + IT_0012 + -m_smu_R*
    ...
    const ccomplex_t IT_0020 = -e_em*IT_0002*IT_0017*(IT_0005*IT_0007 + 
      -IT_0018*IT_0019);
    const ccomplex_t IT_0021 = (0 + _Complex_I*-1)*e_em*(IT_0002*IT_0016 + 
      -IT_0001*IT_0017);
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
