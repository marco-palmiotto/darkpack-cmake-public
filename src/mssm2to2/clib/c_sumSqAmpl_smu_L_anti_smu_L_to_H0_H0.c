...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*IT_0000*(IT_0002*(IT_0004 + 
      -IT_0006) + -IT_0008*(IT_0004 + -IT_0006*(1 + (-2)*IT_0009*IT_0010*IT_0012
      )));
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0001
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0025 = IT_0021*IT_0024;
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0022 + (0 + _Complex_I*1)
      *m_smu_L*Gamma_ml + reg_prop, -1);
    const ccomplex_t IT_0027 = sin(beta);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*(IT_0007*IT_0010
      *IT_0015*IT_0016*IT_0017 + 0.5*m_W*(IT_0004*IT_0005 + -IT_0017)*(IT_0007
      *IT_0011 + -IT_0001*IT_0027));
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0021*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0010
      *IT_0015*IT_0016*IT_0017 + 0.5*m_W*(IT_0004*IT_0005 + -IT_0017)*(IT_0001
      *IT_0011 + IT_0007*IT_0027));
    const ccomplex_t IT_0038 = IT_0004*IT_0005;
    const ccomplex_t IT_0039 = IT_0017 + IT_0038;
    const ccomplex_t IT_0040 = cpow(IT_0001, 3);
    const ccomplex_t IT_0041 = (0 + _Complex_I*5)*m_W*e_em*IT_0039*(IT_0007*
      (IT_0002*IT_0027 + (-1)*IT_0007*(IT_0001*IT_0011 + 1./5*IT_0007*IT_0027)) 
      + 1./5*IT_0011*IT_0040);
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*-1)*m_W*e_em*IT_0039*(IT_0007*(
      (IT_0002 + -IT_0008)*IT_0011 + IT_0001*IT_0007*IT_0027) + -IT_0027*IT_0040);
    const ccomplex_t IT_0048 = (-1.5)*IT_0047;
    const ccomplex_t IT_0049 = IT_0029*IT_0048;
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + (-2)*IT_0023 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = IT_0014 + IT_0025 + IT_0032 + IT_0034 + IT_0036
       + -IT_0046 + -IT_0052;
