...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0006
      *IT_0007 + -IT_0010*IT_0011)*(IT_0003 + -IT_0002*IT_0016) + IT_0003
      *IT_0007*IT_0035*IT_0036*IT_0037);
    ...
    const ccomplex_t IT_0061 = -conj(IT_0030);
    const ccomplex_t IT_0062 = pow(s_34, 2);
    const ccomplex_t IT_0063 = IT_0031*IT_0062;
    const ccomplex_t IT_0064 = s_24*s_34*IT_0031;
    ...
    const ccomplex_t IT_0069 = -IT_0056;
    const ccomplex_t IT_0070 = (conj(IT_0030)*(IT_0025 + -IT_0033) + conj
      (IT_0045)*IT_0048 + conj(IT_0056)*IT_0059)*IT_0060 + IT_0056*IT_0059
      *IT_0061 + IT_0045*(IT_0048*IT_0061 + -conj(IT_0045)*(IT_0040 + -IT_0063) 
      + -conj(IT_0056)*IT_0066) + (conj(IT_0045)*IT_0066 + conj(IT_0056)*
      (IT_0025 + -IT_0068))*IT_0069;
