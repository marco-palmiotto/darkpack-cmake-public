...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_anti_b_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*-1)*e_em*(IT_0005*IT_0011 + 
      -IT_0004*IT_0029);
    ...
    const ccomplex_t IT_0051 = m_b*IT_0050;
    const ccomplex_t IT_0052 = (-0.5)*IT_0030;
    const ccomplex_t IT_0053 = m_b*IT_0052;
    const ccomplex_t IT_0054 = m_b*IT_0031;
    const ccomplex_t IT_0055 = -(IT_0040 + -IT_0046)*(IT_0053 + -IT_0054);
    const ccomplex_t IT_0056 = -IT_0055;
    const ccomplex_t IT_0057 = -IT_0056;
    const ccomplex_t IT_0058 = (IT_0040 + -IT_0046)*(IT_0053 + -IT_0054);
    const ccomplex_t IT_0059 = -IT_0058;
    const ccomplex_t IT_0060 = -IT_0059;
    const ccomplex_t IT_0061 = -IT_0028;
    ...
    const ccomplex_t IT_0072 = IT_0016*IT_0028;
    const ccomplex_t IT_0073 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0079 = IT_0070*(24*IT_0071 + (-12)*IT_0072 + (-12)
      *IT_0073) + (IT_0042 + -conj(IT_0042) + IT_0048 + -conj(IT_0048))*IT_0077 
      + -IT_0051*((-12)*IT_0027 + 12*conj(IT_0027) + 6*conj(IT_0057) + (-6)
      *IT_0060 + 6*conj(IT_0060) + IT_0078);
    const ccomplex_t IT_0080 = m_b*s_14;
    const ccomplex_t IT_0081 = (-6)*IT_0042;
    const ccomplex_t IT_0082 = m_b*s_13;
    const ccomplex_t IT_0083 = IT_0074 + IT_0076;
    const ccomplex_t IT_0084 = conj(IT_0027)*IT_0051;
    const ccomplex_t IT_0085 = (-6)*conj(IT_0042);
    const ccomplex_t IT_0086 = (-6)*conj(IT_0057);
    const ccomplex_t IT_0087 = 0.166666666666667*IT_0080;
    const ccomplex_t IT_0088 = 6*s_34;
    const ccomplex_t IT_0089 = conj(IT_0027)*IT_0062;
    const ccomplex_t IT_0090 = IT_0027*(conj(IT_0027)*(12*s_34 + (-12)*IT_0028
      ) + 6*(conj(IT_0042) + conj(IT_0048))*IT_0051 + 6*(conj(IT_0057) + conj
      (IT_0060))*IT_0062) + -IT_0070*IT_0079 + conj(IT_0048)*(IT_0078*IT_0080 +
       IT_0072*IT_0081) + conj(IT_0060)*(IT_0028*IT_0078 + IT_0080*IT_0081) + 6
      *IT_0042*(conj(IT_0057)*IT_0082 + 0.166666666666667*conj(IT_0042)*IT_0083 
      ...
      *IT_0087) + 6*IT_0057*(conj(IT_0042)*IT_0082 + 0.166666666666667*conj
      (IT_0057)*IT_0088 + IT_0089) + 6*IT_0060*(conj(IT_0048)*IT_0082 +
       0.166666666666667*IT_0028*IT_0086 + IT_0085*IT_0087 + 0.166666666666667
