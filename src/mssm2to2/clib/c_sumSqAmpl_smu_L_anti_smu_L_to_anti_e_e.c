...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_anti_e_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = m_e*s_13;
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_12 + (-2)*IT_0015 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_e*e_em*IT_0003*IT_0029
      *IT_0031*IT_0037;
    const ccomplex_t IT_0046 = 0.5*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*(IT_0003*IT_0029
      *IT_0031*IT_0035*IT_0037 + (-0.5)*m_W*(IT_0032*IT_0036 + IT_0030*IT_0037)*
      (IT_0003 + -IT_0002*IT_0038));
    ...
    const ccomplex_t IT_0063 = IT_0056 + IT_0058 + IT_0062;
