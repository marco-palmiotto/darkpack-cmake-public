...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0054 = m_s*IT_0031;
    ...
    const ccomplex_t IT_0072 = IT_0015*IT_0028;
    ...
    const ccomplex_t IT_0080 = m_s*s_14;
