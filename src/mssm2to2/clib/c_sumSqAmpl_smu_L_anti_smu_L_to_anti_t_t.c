...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_anti_t_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*m_t*e_em*IT_0000*IT_0004
      *IT_0006*IT_0012;
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*-1)*e_em*(IT_0006*IT_0009 + 
      -IT_0005*IT_0030);
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*IT_0005*IT_0030;
    ...
    const ccomplex_t IT_0052 = m_t*IT_0051;
    const ccomplex_t IT_0053 = (-0.5)*IT_0031;
    const ccomplex_t IT_0054 = m_t*IT_0053;
    const ccomplex_t IT_0055 = m_t*IT_0032;
    ...
    const ccomplex_t IT_0068 = cpow(s_12 + IT_0016 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = 0.5*IT_0070;
    const ccomplex_t IT_0072 = s_13*s_14;
    const ccomplex_t IT_0073 = IT_0016*IT_0029;
    const ccomplex_t IT_0074 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0081 = m_t*s_14;
    const ccomplex_t IT_0082 = (-6)*IT_0043;
    const ccomplex_t IT_0083 = m_t*s_13;
