...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0052 = m_u*IT_0051;
    const ccomplex_t IT_0053 = (-0.5)*IT_0031;
    const ccomplex_t IT_0054 = m_u*IT_0053;
    const ccomplex_t IT_0055 = m_u*IT_0032;
    ...
    const ccomplex_t IT_0083 = m_u*s_13;
