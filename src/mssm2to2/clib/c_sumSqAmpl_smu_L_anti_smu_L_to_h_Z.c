...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = -IT_0004;
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0007
      *IT_0009 + IT_0011*IT_0012)*(IT_0003 + -IT_0002*IT_0017) + IT_0003*IT_0012
      *IT_0035*IT_0036*IT_0037);
