...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_L_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0022 + (0 + _Complex_I*1)
      *m_smu_L*Gamma_ml + reg_prop, -1);
    const ccomplex_t IT_0033 = IT_0030*IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0021*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0010
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*-5)*m_W*e_em*IT_0039*(IT_0001*(
      (-0.2)*(IT_0002 + (-5)*IT_0008)*IT_0011 + IT_0001*IT_0007*IT_0027) + -1./5
      *IT_0027*IT_0040);
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_W*e_em*IT_0039*(IT_0001*
      (IT_0008*IT_0027 + -IT_0001*(IT_0007*IT_0011 + IT_0001*IT_0027)) + IT_0011
      *IT_0040);
    ...
    const ccomplex_t IT_0053 = IT_0014 + IT_0025 + IT_0031 + IT_0033 + IT_0035
       + -IT_0046 + -IT_0052;
