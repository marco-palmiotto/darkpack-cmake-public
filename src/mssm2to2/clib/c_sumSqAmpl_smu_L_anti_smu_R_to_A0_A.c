...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_A0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = e_em*m_mu*mu_h*IT_0002*IT_0004;
    const ccomplex_t IT_0006 = 0.5*IT_0005;
    const ccomplex_t IT_0007 = pow(m_A0, 2);
    const ccomplex_t IT_0008 = pow(m_smu_R, 2);
    const ccomplex_t IT_0009 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_smu_L*
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0007 + IT_0012 + -m_smu_R*
    ...
    const ccomplex_t IT_0021 = IT_0000*IT_0016;
    const ccomplex_t IT_0022 = -IT_0021;
    const ccomplex_t IT_0023 = -s_24;
    const ccomplex_t IT_0024 = -s_34;
    const ccomplex_t IT_0025 = -IT_0017*(IT_0008*conj(IT_0017) + -conj(IT_0019
      )*IT_0020 + -conj(IT_0022)*IT_0023) + IT_0022*(conj(IT_0017)*IT_0023 +
       conj(IT_0019)*IT_0024) + -IT_0019*(IT_0007*conj(IT_0019) + -conj(IT_0017)
      *IT_0020 + -conj(IT_0022)*IT_0024);
    return create_ccomplex_return(IT_0025);
}
