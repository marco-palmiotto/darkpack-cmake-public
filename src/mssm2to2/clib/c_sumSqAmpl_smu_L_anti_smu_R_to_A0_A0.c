...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = -IT_0001;
    const ccomplex_t IT_0015 = cos(alpha);
    const ccomplex_t IT_0016 = cpow(IT_0012, 2);
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*m_W*e_em*IT_0011*(IT_0003
      *IT_0013 + -IT_0014*(IT_0014*(IT_0003*IT_0012 + -IT_0001*IT_0015) + 
      -IT_0015*IT_0016));
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0000
      *IT_0002*IT_0005*IT_0015;
    const ccomplex_t IT_0026 = 0.5*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_W*e_em*IT_0011*(IT_0013
      *IT_0015 + -IT_0001*(IT_0001*(IT_0001*IT_0003 + IT_0012*IT_0015) + 
      -IT_0003*IT_0016));
    ...
    return create_ccomplex_return(IT_0033*conj(IT_0033));
}
