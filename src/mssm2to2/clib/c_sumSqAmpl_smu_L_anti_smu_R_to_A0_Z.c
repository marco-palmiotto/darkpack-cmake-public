...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0005
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0002
      *IT_0007*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0033 = e_em*m_mu*mu_h*IT_0007*IT_0009;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = pow(m_A0, 2);
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0014 + IT_0035 + -m_smu_L*
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_13 + IT_0013 + IT_0035 + -m_smu_R*
