...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_H0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0002
      *IT_0004*IT_0005*IT_0007;
    const ccomplex_t IT_0009 = 0.5*IT_0008;
    const ccomplex_t IT_0010 = pow(m_H0, 2);
    const ccomplex_t IT_0011 = pow(m_smu_R, 2);
    const ccomplex_t IT_0012 = cpow((-2)*s_23 + IT_0010 + IT_0011 + -m_smu_L*
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_13 + IT_0010 + IT_0015 + -m_smu_R*
