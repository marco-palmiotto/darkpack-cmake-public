...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = e_em*m_mu*mu_h*IT_0004*IT_0007*IT_0010*IT_0011;
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0005
    ...
    const ccomplex_t IT_0030 = e_em*IT_0001*(IT_0003*IT_0004 + -IT_0002
      *IT_0005)*IT_0007;
    const ccomplex_t IT_0031 = e_em*m_mu*mu_h*IT_0007*IT_0010;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0015 + IT_0025 + -m_smu_R*
    ...
    return create_ccomplex_return(-IT_0037*(conj(IT_0037)*(IT_0025 + -IT_0040)
       + conj(IT_0047)*IT_0050) + -IT_0047*(conj(IT_0037)*IT_0050 + conj(IT_0047
      )*(IT_0016 + -IT_0052)));
}
