...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_Hp_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = e_em*m_mu*mu_h*IT_0001*IT_0003;
    const ccomplex_t IT_0005 = 0.5*IT_0004;
    const ccomplex_t IT_0006 = pow(m_smu_L, 2);
    const ccomplex_t IT_0007 = pow(m_smu_R, 2);
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0001
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0001*IT_0003;
