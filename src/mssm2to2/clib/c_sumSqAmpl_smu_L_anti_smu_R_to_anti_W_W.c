...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_anti_W_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow(IT_0000, -1);
    ...
    return create_ccomplex_return(2*IT_0024*conj(IT_0024)*(1 + 0.5*IT_0027));
}
