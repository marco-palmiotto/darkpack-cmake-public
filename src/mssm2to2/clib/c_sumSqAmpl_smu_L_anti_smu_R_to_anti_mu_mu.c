...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0000
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0000
    ...
    const ccomplex_t IT_0086 = (-0.5)*IT_0036;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0027;
    ...
    const ccomplex_t IT_0115 = IT_0035*IT_0088;
    const ccomplex_t IT_0116 = IT_0040*IT_0114*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0118 = IT_0050*IT_0093;
    const ccomplex_t IT_0119 = IT_0054*IT_0117*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0121 = IT_0064*IT_0099;
    const ccomplex_t IT_0122 = IT_0068*IT_0120*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0124 = IT_0078*IT_0105;
    const ccomplex_t IT_0125 = IT_0082*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = m_mu*IT_0091;
    const ccomplex_t IT_0127 = m_mu*IT_0097;
    const ccomplex_t IT_0128 = m_mu*IT_0103;
    const ccomplex_t IT_0129 = m_mu*IT_0109;
    const ccomplex_t IT_0130 = -IT_0116 + -IT_0119 + -IT_0122 + -IT_0125 +
       IT_0126 + IT_0127 + IT_0128 + IT_0129;
    const ccomplex_t IT_0131 = IT_0052*IT_0094;
    const ccomplex_t IT_0132 = IT_0054*IT_0117*IT_0131;
    const ccomplex_t IT_0133 = IT_0066*IT_0100;
    const ccomplex_t IT_0134 = IT_0068*IT_0120*IT_0133;
    const ccomplex_t IT_0135 = IT_0080*IT_0106;
    const ccomplex_t IT_0136 = IT_0082*IT_0123*IT_0135;
    const ccomplex_t IT_0137 = m_mu*IT_0042;
    const ccomplex_t IT_0138 = m_mu*IT_0056;
    const ccomplex_t IT_0139 = m_mu*IT_0070;
    const ccomplex_t IT_0140 = m_mu*IT_0084;
    const ccomplex_t IT_0141 = IT_0037*IT_0086;
    const ccomplex_t IT_0142 = IT_0040*IT_0114*IT_0141;
    const ccomplex_t IT_0143 = -IT_0132 + -IT_0134 + -IT_0136 + IT_0137 +
       IT_0138 + IT_0139 + IT_0140 + -IT_0142;
    const ccomplex_t IT_0144 = -IT_0039;
    const ccomplex_t IT_0145 = s_34 + IT_0144;
    const ccomplex_t IT_0146 = m_mu*s_13;
    const ccomplex_t IT_0147 = sin(beta);
    const ccomplex_t IT_0148 = e_em*m_mu*IT_0000*IT_0002*IT_0005*IT_0147;
    const ccomplex_t IT_0149 = (-0.5)*IT_0148;
    const ccomplex_t IT_0150 = e_em*m_mu*mu_h*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0156 = e_em*m_mu*IT_0000*IT_0005;
    const ccomplex_t IT_0157 = 0.5*IT_0156;
    const ccomplex_t IT_0158 = e_em*m_mu*mu_h*IT_0000*IT_0002*IT_0005*IT_0147;
    ...
    const ccomplex_t IT_0172 = m_mu*s_14;
    const ccomplex_t IT_0173 = (-2)*IT_0143;
    const ccomplex_t IT_0174 = IT_0012*IT_0039;
    const ccomplex_t IT_0175 = -IT_0085;
    const ccomplex_t IT_0176 = -IT_0110;
    const ccomplex_t IT_0177 = s_34 + IT_0039;
    const ccomplex_t IT_0178 = (-2)*conj(IT_0143);
    const ccomplex_t IT_0179 = IT_0165*IT_0177;
    const ccomplex_t IT_0180 = 2*s_34;
    const ccomplex_t IT_0181 = IT_0025*IT_0145;
    const ccomplex_t IT_0182 = 2*conj(IT_0025)*((IT_0085 + IT_0110)*IT_0113 +
       2*(IT_0025 + 1./2*IT_0130 + 1./2*IT_0143)*IT_0145) + 2*conj(IT_0110)*
      (IT_0025*IT_0113 + IT_0130*IT_0146 + IT_0165*IT_0167 + 2*IT_0110*IT_0171 +
       0.5*IT_0172*IT_0173 + IT_0174*IT_0175) + 2*conj(IT_0085)*(IT_0025*IT_0113
       + IT_0143*IT_0146 + -IT_0165*IT_0167 + 2*IT_0085*IT_0171 + -IT_0130
      *IT_0172 + IT_0174*IT_0176) + (-2)*conj(IT_0165)*(IT_0167*(IT_0085 +
       IT_0176) + -(IT_0130 + 2*IT_0165 + 0.5*IT_0173)*IT_0177) + IT_0178*
      (IT_0039*IT_0130 + IT_0110*IT_0172 + IT_0179) + 2*conj(IT_0130)*(IT_0110
      *IT_0146 + 0.5*IT_0039*IT_0173 + IT_0172*IT_0175 + IT_0179 + 0.5*IT_0130
      *IT_0180 + IT_0181) + 2*conj(IT_0143)*(IT_0085*IT_0146 + 0.5*IT_0143
      *IT_0180 + IT_0181);
