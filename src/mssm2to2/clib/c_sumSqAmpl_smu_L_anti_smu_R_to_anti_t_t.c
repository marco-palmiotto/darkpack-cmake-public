...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_anti_t_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = m_t*e_em*IT_0000*IT_0002*IT_0005*IT_0019;
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_t*e_em*IT_0000*IT_0002
      *IT_0019*IT_0037;
