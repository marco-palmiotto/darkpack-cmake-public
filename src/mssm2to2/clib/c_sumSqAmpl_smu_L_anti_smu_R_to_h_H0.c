...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0000
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0019 + IT_0037 + -m_smu_R*
