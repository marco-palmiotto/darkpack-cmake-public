...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_smu_R_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = e_em*m_mu*mu_h*IT_0003*IT_0007*IT_0010*IT_0011;
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0006 + 
      -IT_0000*IT_0007);
    ...
    const ccomplex_t IT_0026 = cpow((-2)*s_23 + IT_0016 + IT_0025 + -m_smu_L*
    ...
    const ccomplex_t IT_0030 = e_em*IT_0001*(IT_0002*IT_0004 + IT_0003*IT_0005
      )*IT_0007;
    const ccomplex_t IT_0031 = -IT_0030;
    const ccomplex_t IT_0032 = e_em*m_mu*mu_h*IT_0007*IT_0010;
    const ccomplex_t IT_0033 = 0.5*IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0033*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*IT_0035;
    const ccomplex_t IT_0037 = IT_0031*IT_0036;
    const ccomplex_t IT_0038 = IT_0020 + -IT_0029 + IT_0037;
    const ccomplex_t IT_0039 = pow(m_Z, -2);
    const ccomplex_t IT_0040 = pow(s_34, 2);
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0006;
    const ccomplex_t IT_0043 = (-2)*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0015 + IT_0025 + -m_smu_R*
    ...
    const ccomplex_t IT_0049 = s_24*s_34*IT_0039;
    const ccomplex_t IT_0050 = -IT_0049;
    const ccomplex_t IT_0051 = s_23 + IT_0050;
    const ccomplex_t IT_0052 = pow(s_24, 2);
    const ccomplex_t IT_0053 = IT_0039*IT_0052;
    return create_ccomplex_return(-IT_0038*(conj(IT_0038)*(IT_0025 + -IT_0041)
       + conj(IT_0048)*IT_0051) + -IT_0048*(conj(IT_0038)*IT_0051 + conj(IT_0048
      )*(IT_0016 + -IT_0053)));
}
