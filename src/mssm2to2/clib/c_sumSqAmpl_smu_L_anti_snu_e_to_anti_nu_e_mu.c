...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_snu_e_to_anti_nu_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = IT_0029*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0034 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0045 = (-0.5)*IT_0044;
    const ccomplex_t IT_0046 = IT_0043*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0048 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0062 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0112 = 0.5*IT_0021 + 0.5*IT_0035 + 0.5*IT_0049 + 0.5
      *IT_0063 + (-0.5)*IT_0075 + (-0.5)*IT_0087 + (-0.5)*IT_0099 + (-0.5)
      *IT_0111;
    const ccomplex_t IT_0113 = 0.5*IT_0074 + 0.5*IT_0086 + 0.5*IT_0098 + 0.5
      *IT_0110;
    const ccomplex_t IT_0114 = m_mu*s_13;
    const ccomplex_t IT_0115 = s_13*s_14;
    const ccomplex_t IT_0116 = pow(m_smu_L, 2);
    const ccomplex_t IT_0117 = s_34*IT_0116;
    return create_ccomplex_return(2*IT_0112*(s_34*conj(IT_0112) + conj(IT_0113
      )*IT_0114) + 2*IT_0113*(conj(IT_0112)*IT_0114 + 2*conj(IT_0113)*(IT_0115 +
       (-0.5)*IT_0117)));
}
