...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_snu_mu_to_H0_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002*
      (m_W*IT_0005 + (-0.5)*IT_0004*IT_0012*IT_0013)*IT_0014;
    ...
    const ccomplex_t IT_0022 = cpow(IT_0002, 3);
    const ccomplex_t IT_0023 = -IT_0005;
    const ccomplex_t IT_0024 = 3*IT_0014 + IT_0020;
    const ccomplex_t IT_0025 = cpow(IT_0002, 2);
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*m_W*e_em*(IT_0007*IT_0021
      *IT_0022 + IT_0023*(IT_0023*(IT_0001*IT_0005*IT_0021 + -IT_0002*IT_0007
      *IT_0024) + IT_0001*IT_0024*IT_0025));
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_12 + -IT_0029 + -IT_0030 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0028*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0007
      *IT_0012*IT_0013*IT_0014;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0012*IT_0014;
    const ccomplex_t IT_0037 = 0.5*IT_0036;
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = pow(m_H0, 2);
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0029 + IT_0039 + -m_smu_R*
      (m_smu_R + (0 + _Complex_I*-1)*Gamma_mr) + reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0038*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0039 + reg_prop + (0 +
       _Complex_I*1)*m_snu_mu*Gamma_numl, -1);
    const ccomplex_t IT_0044 = IT_0014 + IT_0020;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0005 + 
      -IT_0002*IT_0007)*IT_0044;
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0029 + -IT_0030 + -reg_prop, -1);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0002 + 
      -IT_0005*IT_0007)*IT_0014;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0014;
    const ccomplex_t IT_0053 = (-0.5)*IT_0052;
    const ccomplex_t IT_0054 = IT_0051*IT_0053;
    const ccomplex_t IT_0055 = s_13 + s_23;
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = s_12 + IT_0030;
    const ccomplex_t IT_0058 = -IT_0052;
    const ccomplex_t IT_0059 = 0.5*IT_0051;
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = IT_0057*IT_0060;
    const ccomplex_t IT_0062 = IT_0056 + IT_0061;
    const ccomplex_t IT_0063 = IT_0051*IT_0058;
    const ccomplex_t IT_0064 = s_23*IT_0063;
    const ccomplex_t IT_0065 = IT_0053*IT_0059;
    const ccomplex_t IT_0066 = 0.5*IT_0029 + 0.5*IT_0030;
    ...
    const ccomplex_t IT_0073 = cpow(IT_0005, 2);
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0014
      *IT_0022 + (-2)*IT_0005*(IT_0002*(IT_0001*IT_0005 + -IT_0002*IT_0007)*(0.5
      *IT_0014 + IT_0008*IT_0019) + 1./2*IT_0007*IT_0014*IT_0073));
    const ccomplex_t IT_0075 = (-0.5)*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0014*
      (IT_0004*IT_0012 + m_W*(IT_0025 + -IT_0073));
    const ccomplex_t IT_0077 = (-0.5)*IT_0076;
    const ccomplex_t IT_0078 = IT_0075*IT_0077;
    const ccomplex_t IT_0079 = pow(m_W, 2);
    const ccomplex_t IT_0080 = cpow((-2)*s_12 + -IT_0029 + -IT_0030 + IT_0079 
      + -reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0004
      *IT_0012*IT_0013*IT_0014 + (-0.5)*m_W*(IT_0001*IT_0005 + -IT_0002*IT_0007)
      *(IT_0014 + -IT_0008*IT_0019));
    const ccomplex_t IT_0084 = -IT_0083;
    const ccomplex_t IT_0085 = IT_0016*IT_0084;
    const ccomplex_t IT_0086 = cpow((-2)*s_13 + IT_0039 + (0 + _Complex_I*1)
      *m_smu_L*Gamma_ml + reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = IT_0011 + -IT_0033 + IT_0042 + IT_0049 +
       IT_0072 + -IT_0082 + IT_0088;
