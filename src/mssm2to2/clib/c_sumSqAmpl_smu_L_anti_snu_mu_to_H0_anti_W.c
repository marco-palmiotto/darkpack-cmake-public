...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_snu_mu_to_H0_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = cpow(IT_0000, 2);
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005;
    const ccomplex_t IT_0022 = (-0.5)*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_W*e_em*(IT_0000*IT_0001 +
       IT_0002*IT_0003)*IT_0005;
    const ccomplex_t IT_0024 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0002 + 
      -IT_0000*IT_0003)*IT_0005;
    const ccomplex_t IT_0029 = cpow(IT_0000, -1);
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002
      *IT_0005*(m_W*IT_0000 + (-0.5)*IT_0008*IT_0009*IT_0029);
    const ccomplex_t IT_0031 = -IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + m_Hp*
    ...
    const ccomplex_t IT_0036 = -IT_0020 + -IT_0027 + -IT_0035;
    const ccomplex_t IT_0037 = pow(m_W, -2);
    const ccomplex_t IT_0038 = pow(s_14, 2);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = -IT_0021;
    ...
    const ccomplex_t IT_0056 = -IT_0040;
    const ccomplex_t IT_0057 = IT_0022 + IT_0056;
    const ccomplex_t IT_0058 = IT_0026*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0005
      *IT_0008*IT_0009*IT_0029 + (-0.5)*m_W*(IT_0000*IT_0001 + -IT_0002*IT_0003)
      *(IT_0005 + -IT_0004*IT_0042));
    const ccomplex_t IT_0060 = -IT_0059;
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0047 + (0 + _Complex_I*1)
      *m_smu_L*Gamma_ml + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = IT_0040*IT_0063;
    const ccomplex_t IT_0065 = -IT_0020 + -IT_0035 + IT_0051 + -IT_0058 +
       IT_0064;
    const ccomplex_t IT_0066 = s_14*s_24*IT_0037;
    const ccomplex_t IT_0067 = -IT_0066;
    const ccomplex_t IT_0068 = s_12 + IT_0067;
    const ccomplex_t IT_0069 = -IT_0036;
    const ccomplex_t IT_0070 = -conj(IT_0036);
    const ccomplex_t IT_0071 = pow(s_34, 2);
    const ccomplex_t IT_0072 = IT_0037*IT_0071;
    const ccomplex_t IT_0073 = s_24*s_34*IT_0037;
    ...
    const ccomplex_t IT_0079 = (conj(IT_0036)*(IT_0015 + -IT_0039) + conj
      (IT_0052)*IT_0055 + conj(IT_0065)*IT_0068)*IT_0069 + IT_0065*IT_0068
      *IT_0070 + IT_0052*(IT_0055*IT_0070 + -conj(IT_0052)*(IT_0047 + -IT_0072) 
      + -conj(IT_0065)*IT_0075) + (conj(IT_0052)*IT_0075 + conj(IT_0065)*
