...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_snu_mu_to_mu_anti_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002*
      (IT_0000*IT_0005 + -m_W*(IT_0007 + -IT_0009));
    const ccomplex_t IT_0011 = (-0.5)*IT_0010;
    const ccomplex_t IT_0012 = IT_0004*IT_0011;
    const ccomplex_t IT_0013 = pow(m_W, 2);
    const ccomplex_t IT_0014 = pow(m_smu_L, 2);
    ...
    const ccomplex_t IT_0019 = cpow(IT_0006, -1);
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0000*IT_0002*IT_0008*IT_0019;
    const ccomplex_t IT_0021 = 0.5*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002
      *IT_0008*(m_W*IT_0006 + (-0.5)*IT_0000*IT_0005*IT_0019);
    const ccomplex_t IT_0023 = -IT_0022;
    const ccomplex_t IT_0024 = IT_0021*IT_0023;
    const ccomplex_t IT_0025 = cpow((-2)*s_12 + -IT_0014 + -IT_0015 + m_Hp*
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0000*IT_0002*IT_0019;
    const ccomplex_t IT_0039 = (-0.5)*IT_0038;
    const ccomplex_t IT_0040 = IT_0037*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0005 + IT_0014 + -m_N_1*
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0019;
    const ccomplex_t IT_0053 = (-0.5)*IT_0052;
    const ccomplex_t IT_0054 = IT_0051*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0056 = cpow((-2)*s_13 + IT_0005 + IT_0014 + -m_N_2*
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0000*IT_0002*IT_0019;
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = IT_0065*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0070 = cpow((-2)*s_13 + IT_0005 + IT_0014 + -m_N_3*
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0000*IT_0002*IT_0019;
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0005 + IT_0014 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0085 = IT_0082*IT_0083*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002;
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0014 + -IT_0015 + -reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = (-0.5)*IT_0086;
    const ccomplex_t IT_0092 = m_mu*IT_0091;
    const ccomplex_t IT_0093 = -IT_0086;
    const ccomplex_t IT_0094 = m_mu*IT_0093;
    ...
    const ccomplex_t IT_0143 = IT_0084*IT_0142;
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*IT_0143;
    const ccomplex_t IT_0145 = m_mu*IT_0144;
    const ccomplex_t IT_0146 = -IT_0018 + -IT_0027 + -IT_0043 + -IT_0057 + 
      -IT_0071 + -IT_0085 + -IT_0097 + IT_0109 + IT_0121 + IT_0133 + IT_0145;
    const ccomplex_t IT_0147 = IT_0090*IT_0093;
    const ccomplex_t IT_0148 = -IT_0108 + -IT_0120 + -IT_0132 + -IT_0144 + 
      -IT_0147;
    const ccomplex_t IT_0149 = m_mu*s_14;
    const ccomplex_t IT_0150 = s_13*s_14;
    const ccomplex_t IT_0151 = s_34*IT_0014;
    return create_ccomplex_return(2*IT_0146*(s_34*conj(IT_0146) + conj(IT_0148
      )*IT_0149) + 2*IT_0148*(conj(IT_0146)*IT_0149 + 2*conj(IT_0148)*(IT_0150 +
       (-0.5)*IT_0151)));
}
