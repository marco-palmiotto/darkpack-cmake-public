...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_snu_mu_to_s_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0001*IT_0014*IT_0016*IT_0017;
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0001*IT_0014;
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0001*IT_0013*IT_0014*IT_0050;
    const ccomplex_t IT_0052 = 0.5*IT_0051;
    const ccomplex_t IT_0053 = IT_0019*IT_0052;
    const ccomplex_t IT_0054 = IT_0023*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = m_c*IT_0037;
    const ccomplex_t IT_0057 = m_c*IT_0003;
