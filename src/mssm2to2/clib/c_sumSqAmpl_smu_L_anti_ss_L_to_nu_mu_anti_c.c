...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_ss_L_to_nu_mu_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*conj(V_cs)*e_em*U_Wm1*IT_0001;
    const ccomplex_t IT_0022 = IT_0002*IT_0021;
    const ccomplex_t IT_0023 = IT_0011*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*conj(V_cs)*e_em*U_Wm2*IT_0001;
