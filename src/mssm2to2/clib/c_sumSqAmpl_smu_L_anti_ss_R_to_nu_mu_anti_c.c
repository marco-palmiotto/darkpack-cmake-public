...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_ss_R_to_nu_mu_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_cs)*e_em*IT_0001*IT_0003*IT_0005;
