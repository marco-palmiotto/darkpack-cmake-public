...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_st_2_to_mu_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B1*e_em*conj(U_st_01);
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = N_W1*e_em*conj(U_st_01);
    ...
    const ccomplex_t IT_0022 = m_t*N_u1*e_em*IT_0021*conj(U_st_11);
    ...
    const ccomplex_t IT_0041 = N_B2*e_em*conj(U_st_01);
    const ccomplex_t IT_0042 = IT_0001*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = N_W2*e_em*conj(U_st_01);
    const ccomplex_t IT_0045 = IT_0006*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = m_t*N_u2*e_em*IT_0021*conj(U_st_11);
    ...
    const ccomplex_t IT_0064 = N_B3*e_em*conj(U_st_01);
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_W3*e_em*conj(U_st_01);
    const ccomplex_t IT_0068 = IT_0006*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = m_t*N_u3*e_em*IT_0021*conj(U_st_11);
    ...
    const ccomplex_t IT_0114 = IT_0053*IT_0112*IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0006*IT_0021*IT_0104;
    ...
    const ccomplex_t IT_0119 = IT_0076*IT_0117*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0006*IT_0021*IT_0104;
    const ccomplex_t IT_0121 = (-0.5)*IT_0120;
    const ccomplex_t IT_0122 = IT_0097*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0124 = IT_0099*IT_0122*IT_0123;
    const ccomplex_t IT_0125 = m_mu*IT_0032;
    const ccomplex_t IT_0126 = m_mu*IT_0055;
    const ccomplex_t IT_0127 = m_mu*IT_0078;
    const ccomplex_t IT_0128 = m_mu*IT_0101;
    const ccomplex_t IT_0129 = -IT_0109 + -IT_0114 + -IT_0119 + -IT_0124 +
       IT_0125 + IT_0126 + IT_0127 + IT_0128;
    const ccomplex_t IT_0130 = m_mu*s_14;
    const ccomplex_t IT_0131 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0132 = IT_0001*IT_0131;
    const ccomplex_t IT_0133 = 1.4142135623731*IT_0132;
    const ccomplex_t IT_0134 = m_t*conj(N_u3)*e_em*IT_0021*conj(U_st_01);
    ...
    const ccomplex_t IT_0140 = IT_0076*IT_0118*IT_0139;
    const ccomplex_t IT_0141 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0142 = IT_0001*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = m_t*conj(N_u1)*e_em*IT_0021*conj(U_st_01);
    ...
    const ccomplex_t IT_0150 = IT_0030*IT_0108*IT_0149;
    const ccomplex_t IT_0151 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0152 = IT_0001*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = m_t*conj(N_u2)*e_em*IT_0021*conj(U_st_01);
    const ccomplex_t IT_0155 = IT_0020*IT_0154;
    ...
    const ccomplex_t IT_0160 = IT_0053*IT_0113*IT_0159;
    const ccomplex_t IT_0161 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0162 = IT_0001*IT_0161;
    const ccomplex_t IT_0163 = 1.4142135623731*IT_0162;
    const ccomplex_t IT_0164 = m_t*conj(N_u4)*e_em*IT_0021*conj(U_st_01);
    ...
    const ccomplex_t IT_0169 = IT_0086*IT_0168;
    const ccomplex_t IT_0170 = IT_0099*IT_0123*IT_0169;
    const ccomplex_t IT_0171 = IT_0106*IT_0148;
    ...
    const ccomplex_t IT_0175 = IT_0111*IT_0158;
    const ccomplex_t IT_0176 = IT_0053*IT_0175;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*IT_0176;
    const ccomplex_t IT_0178 = m_mu*IT_0177;
    const ccomplex_t IT_0179 = IT_0116*IT_0138;
    ...
    const ccomplex_t IT_0183 = IT_0121*IT_0168;
    const ccomplex_t IT_0184 = IT_0099*IT_0183;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*IT_0184;
    const ccomplex_t IT_0186 = m_mu*IT_0185;
    const ccomplex_t IT_0187 = -IT_0140 + -IT_0150 + -IT_0160 + -IT_0170 +
       IT_0174 + IT_0178 + IT_0182 + IT_0186;
    const ccomplex_t IT_0188 = m_t*s_13;
    const ccomplex_t IT_0189 = -IT_0173 + -IT_0177 + -IT_0181 + -IT_0185;
    const ccomplex_t IT_0190 = m_t*m_mu*IT_0029;
    ...
    const ccomplex_t IT_0196 = m_t*m_mu;
    const ccomplex_t IT_0197 = 6*s_34;
    const ccomplex_t IT_0198 = -conj(IT_0102);
    const ccomplex_t IT_0199 = (-6)*conj(IT_0129);
    const ccomplex_t IT_0200 = 6*IT_0102*(conj(IT_0129)*IT_0130 + -conj
      (IT_0187)*IT_0188 + -conj(IT_0189)*IT_0190 + 0.166666666666667*conj
      (IT_0102)*IT_0195) + (-6)*IT_0129*(IT_0188*conj(IT_0189) + conj(IT_0187)
      *IT_0196 + (-0.166666666666667)*conj(IT_0129)*IT_0197 + IT_0130*IT_0198) +
       6*IT_0189*(IT_0130*conj(IT_0187) + 0.166666666666667*conj(IT_0189)
      *IT_0195 + IT_0190*IT_0198 + 0.166666666666667*IT_0188*IT_0199) + 6
      *IT_0187*(IT_0130*conj(IT_0189) + 0.166666666666667*conj(IT_0187)*IT_0197 
