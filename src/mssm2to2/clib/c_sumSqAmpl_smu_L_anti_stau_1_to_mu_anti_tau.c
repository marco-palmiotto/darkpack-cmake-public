...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_stau_1_to_mu_anti_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B1*e_em*conj(U_stau_00);
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = N_W1*e_em*conj(U_stau_00);
    ...
    const ccomplex_t IT_0022 = N_d1*e_em*m_tau*IT_0021*conj(U_stau_10);
    ...
    const ccomplex_t IT_0041 = N_B2*e_em*conj(U_stau_00);
    const ccomplex_t IT_0042 = IT_0001*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = N_W2*e_em*conj(U_stau_00);
    const ccomplex_t IT_0045 = IT_0006*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = N_d2*e_em*m_tau*IT_0021*conj(U_stau_10);
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_13 + IT_0028 + IT_0029 + -m_N_2*
    ...
    const ccomplex_t IT_0064 = N_B3*e_em*conj(U_stau_00);
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_W3*e_em*conj(U_stau_00);
    const ccomplex_t IT_0068 = IT_0006*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = N_d3*e_em*m_tau*IT_0021*conj(U_stau_10);
    ...
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0028 + IT_0029 + -m_N_3*
    ...
    const ccomplex_t IT_0099 = cpow((-2)*s_13 + IT_0028 + IT_0029 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0100 = IT_0098*IT_0099;
    const ccomplex_t IT_0101 = (0 + _Complex_I*1)*IT_0100;
    const ccomplex_t IT_0102 = -IT_0032 + -IT_0055 + -IT_0078 + -IT_0101;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0006*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0006*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0112 = IT_0053*IT_0110*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0006*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0117 = IT_0076*IT_0115*IT_0116;
    ...
    const ccomplex_t IT_0122 = IT_0099*IT_0120*IT_0121;
    const ccomplex_t IT_0123 = m_mu*IT_0032;
    const ccomplex_t IT_0124 = m_mu*IT_0055;
    const ccomplex_t IT_0125 = m_mu*IT_0078;
    const ccomplex_t IT_0126 = m_mu*IT_0101;
    const ccomplex_t IT_0127 = -IT_0107 + -IT_0112 + -IT_0117 + -IT_0122 +
       IT_0123 + IT_0124 + IT_0125 + IT_0126;
    const ccomplex_t IT_0128 = m_mu*s_14;
    const ccomplex_t IT_0129 = conj(N_B1)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0130 = IT_0001*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = conj(N_d1)*e_em*m_tau*IT_0021*conj(U_stau_00);
    ...
    const ccomplex_t IT_0138 = IT_0030*IT_0106*IT_0137;
    const ccomplex_t IT_0139 = conj(N_B2)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0140 = IT_0001*IT_0139;
    const ccomplex_t IT_0141 = 1.4142135623731*IT_0140;
    const ccomplex_t IT_0142 = conj(N_d2)*e_em*m_tau*IT_0021*conj(U_stau_00);
    ...
    const ccomplex_t IT_0148 = IT_0053*IT_0111*IT_0147;
    const ccomplex_t IT_0149 = conj(N_B3)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0150 = IT_0001*IT_0149;
    const ccomplex_t IT_0151 = 1.4142135623731*IT_0150;
    const ccomplex_t IT_0152 = conj(N_d3)*e_em*m_tau*IT_0021*conj(U_stau_00);
    ...
    const ccomplex_t IT_0158 = IT_0076*IT_0116*IT_0157;
    const ccomplex_t IT_0159 = conj(N_B4)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0160 = IT_0001*IT_0159;
    const ccomplex_t IT_0161 = 1.4142135623731*IT_0160;
    const ccomplex_t IT_0162 = conj(N_d4)*e_em*m_tau*IT_0021*conj(U_stau_00);
    ...
    const ccomplex_t IT_0167 = IT_0086*IT_0166;
    const ccomplex_t IT_0168 = IT_0099*IT_0121*IT_0167;
    const ccomplex_t IT_0169 = IT_0104*IT_0136;
    const ccomplex_t IT_0170 = IT_0030*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*IT_0170;
    const ccomplex_t IT_0172 = m_mu*IT_0171;
    const ccomplex_t IT_0173 = IT_0109*IT_0146;
    const ccomplex_t IT_0174 = IT_0053*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*IT_0174;
    const ccomplex_t IT_0176 = m_mu*IT_0175;
    const ccomplex_t IT_0177 = IT_0114*IT_0156;
    const ccomplex_t IT_0178 = IT_0076*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*IT_0178;
    const ccomplex_t IT_0180 = m_mu*IT_0179;
    const ccomplex_t IT_0181 = IT_0119*IT_0166;
    ...
    const ccomplex_t IT_0185 = -IT_0138 + -IT_0148 + -IT_0158 + -IT_0168 +
       IT_0172 + IT_0176 + IT_0180 + IT_0184;
    const ccomplex_t IT_0186 = s_13*m_tau;
    const ccomplex_t IT_0187 = -IT_0171 + -IT_0175 + -IT_0179 + -IT_0183;
    const ccomplex_t IT_0188 = m_mu*m_tau*IT_0029;
    const ccomplex_t IT_0189 = s_13*s_14;
    const ccomplex_t IT_0190 = s_34*IT_0029;
    const ccomplex_t IT_0191 = (-0.5)*IT_0190;
    const ccomplex_t IT_0192 = IT_0189 + IT_0191;
    const ccomplex_t IT_0193 = m_mu*m_tau;
    const ccomplex_t IT_0194 = 2*s_34;
    const ccomplex_t IT_0195 = (-2)*conj(IT_0127);
    const ccomplex_t IT_0196 = 2*IT_0102*(conj(IT_0127)*IT_0128 + -conj
      (IT_0185)*IT_0186 + -conj(IT_0187)*IT_0188 + 2*conj(IT_0102)*IT_0192) + 2
      *IT_0127*(conj(IT_0102)*IT_0128 + -IT_0186*conj(IT_0187) + -conj(IT_0185)
      *IT_0193 + 0.5*conj(IT_0127)*IT_0194) + 2*IT_0187*(IT_0128*conj(IT_0185) +
       -conj(IT_0102)*IT_0188 + 2*conj(IT_0187)*IT_0192 + 0.5*IT_0186*IT_0195) +
       (-2)*IT_0185*(conj(IT_0102)*IT_0186 + -IT_0128*conj(IT_0187) + (-0.5)
      *conj(IT_0185)*IT_0194 + (-0.5)*IT_0193*IT_0195);
