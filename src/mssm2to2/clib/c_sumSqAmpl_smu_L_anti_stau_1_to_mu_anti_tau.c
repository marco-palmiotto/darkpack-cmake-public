        ...
        )
{
    ...
    const ccomplex_t IT_0064 = N_B4*e_em*conj(U_stau_00);
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_W4*e_em*conj(U_stau_00);
    const ccomplex_t IT_0068 = IT_0006*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = N_d4*e_em*m_tau*IT_0021*conj(U_stau_10);
    ...
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0028 + IT_0029 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0080 = N_B3*e_em*conj(U_stau_00);
    const ccomplex_t IT_0081 = IT_0001*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = N_W3*e_em*conj(U_stau_00);
    const ccomplex_t IT_0084 = IT_0006*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = N_d3*e_em*m_tau*IT_0021*conj(U_stau_10);
    const ccomplex_t IT_0087 = IT_0020*IT_0086;
    ...
    const ccomplex_t IT_0149 = conj(N_B4)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0150 = IT_0001*IT_0149;
    const ccomplex_t IT_0151 = 1.4142135623731*IT_0150;
    const ccomplex_t IT_0152 = conj(N_d4)*e_em*m_tau*IT_0021*conj(U_stau_00);
    ...
    const ccomplex_t IT_0158 = IT_0076*IT_0121*IT_0157;
    const ccomplex_t IT_0159 = IT_0104*IT_0136;
    const ccomplex_t IT_0160 = IT_0030*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = m_mu*IT_0161;
    const ccomplex_t IT_0163 = IT_0109*IT_0146;
    const ccomplex_t IT_0164 = IT_0053*IT_0163;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*IT_0164;
    const ccomplex_t IT_0166 = m_mu*IT_0165;
    const ccomplex_t IT_0167 = conj(N_B3)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0168 = IT_0001*IT_0167;
    const ccomplex_t IT_0169 = 1.4142135623731*IT_0168;
    const ccomplex_t IT_0170 = conj(N_d3)*e_em*m_tau*IT_0021*conj(U_stau_00);
    ...
    const ccomplex_t IT_0178 = m_mu*IT_0177;
    const ccomplex_t IT_0179 = IT_0119*IT_0156;
    const ccomplex_t IT_0180 = IT_0076*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1)*IT_0180;
    const ccomplex_t IT_0182 = m_mu*IT_0181;
    const ccomplex_t IT_0183 = IT_0098*IT_0174;
    const ccomplex_t IT_0184 = IT_0079*IT_0116*IT_0183;
    const ccomplex_t IT_0185 = -IT_0138 + -IT_0148 + -IT_0158 + IT_0162 +
       IT_0166 + IT_0178 + IT_0182 + -IT_0184;
    const ccomplex_t IT_0186 = s_13*m_tau;
    const ccomplex_t IT_0187 = -IT_0161 + -IT_0165 + -IT_0177 + -IT_0181;
