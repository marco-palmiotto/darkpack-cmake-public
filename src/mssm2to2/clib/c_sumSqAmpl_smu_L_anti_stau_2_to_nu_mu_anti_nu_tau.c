...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_stau_2_to_nu_mu_anti_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = e_em*U_Wm2*conj(U_stau_01);
    ...
    const ccomplex_t IT_0009 = U_d2*e_em*m_tau*IT_0008*conj(U_stau_11);
    ...
    const ccomplex_t IT_0019 = e_em*U_Wm1*conj(U_stau_01);
    const ccomplex_t IT_0020 = IT_0001*IT_0019;
    const ccomplex_t IT_0021 = U_d1*e_em*m_tau*IT_0008*conj(U_stau_11);
