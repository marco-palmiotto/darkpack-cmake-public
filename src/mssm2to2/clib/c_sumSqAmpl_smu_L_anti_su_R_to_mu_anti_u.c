...
ccomplex_return_t c_sumSqAmpl_smu_L_anti_su_R_to_mu_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0072 = IT_0034*IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0006*IT_0012*IT_0067;
    const ccomplex_t IT_0074 = (-0.5)*IT_0073;
    const ccomplex_t IT_0075 = IT_0046*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0077 = IT_0048*IT_0075*IT_0076;
    ...
    const ccomplex_t IT_0082 = IT_0062*IT_0080*IT_0081;
    const ccomplex_t IT_0083 = m_mu*IT_0022;
    const ccomplex_t IT_0084 = m_mu*IT_0036;
    const ccomplex_t IT_0085 = m_mu*IT_0050;
    const ccomplex_t IT_0086 = m_mu*IT_0064;
    ...
    const ccomplex_t IT_0091 = IT_0020*IT_0089*IT_0090;
    const ccomplex_t IT_0092 = -IT_0072 + -IT_0077 + -IT_0082 + IT_0083 +
       IT_0084 + IT_0085 + IT_0086 + -IT_0091;
    const ccomplex_t IT_0093 = m_mu*s_14;
    ...
    const ccomplex_t IT_0097 = IT_0020*IT_0090*IT_0096;
    const ccomplex_t IT_0098 = IT_0088*IT_0095;
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0001;
    ...
    const ccomplex_t IT_0120 = IT_0030*IT_0103;
    const ccomplex_t IT_0121 = IT_0034*IT_0071*IT_0120;
    const ccomplex_t IT_0122 = IT_0044*IT_0109;
    const ccomplex_t IT_0123 = IT_0048*IT_0076*IT_0122;
    const ccomplex_t IT_0124 = IT_0058*IT_0115;
    const ccomplex_t IT_0125 = IT_0062*IT_0081*IT_0124;
    const ccomplex_t IT_0126 = -IT_0097 + IT_0101 + IT_0107 + IT_0113 +
       IT_0119 + -IT_0121 + -IT_0123 + -IT_0125;
    const ccomplex_t IT_0127 = m_u*s_13;
    const ccomplex_t IT_0128 = -IT_0100 + -IT_0106 + -IT_0112 + -IT_0118;
    const ccomplex_t IT_0129 = m_u*m_mu*IT_0019;
    ...
    const ccomplex_t IT_0136 = m_u*m_mu;
    const ccomplex_t IT_0137 = (-6)*conj(IT_0092);
    const ccomplex_t IT_0138 = (-6)*IT_0092;
    const ccomplex_t IT_0139 = -IT_0065;
    const ccomplex_t IT_0140 = 6*conj(IT_0065)*(IT_0092*IT_0093 + -IT_0126
      *IT_0127 + -IT_0128*IT_0129 + 0.166666666666667*IT_0065*IT_0134) + 6*conj
      (IT_0092)*(IT_0065*IT_0093 + 0.166666666666667*IT_0092*IT_0135) + (IT_0127
      *IT_0128 + IT_0126*IT_0136)*IT_0137 + 6*conj(IT_0126)*(IT_0093*IT_0128 +
       0.166666666666667*IT_0126*IT_0135 + 0.166666666666667*IT_0136*IT_0138 +
       IT_0127*IT_0139) + 6*conj(IT_0128)*(IT_0093*IT_0126 + 0.166666666666667
      *IT_0128*IT_0134 + 0.166666666666667*IT_0127*IT_0138 + IT_0129*IT_0139);
