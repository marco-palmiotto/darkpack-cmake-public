        ...
        )
{
    ...
    const ccomplex_t IT_0091 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0092 = IT_0018*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = m_b*N_d3*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0129 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0130 = IT_0018*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = m_b*N_d2*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0148 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0149 = IT_0018*IT_0148;
    const ccomplex_t IT_0150 = 1.4142135623731*IT_0149;
    const ccomplex_t IT_0151 = m_b*N_d1*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0175 = IT_0042*IT_0128;
    const ccomplex_t IT_0176 = IT_0028*IT_0174*IT_0175;
    const ccomplex_t IT_0177 = m_mu*IT_0027;
    const ccomplex_t IT_0178 = m_mu*IT_0045;
    const ccomplex_t IT_0179 = m_mu*IT_0063;
    const ccomplex_t IT_0180 = m_mu*IT_0081;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0182 = IT_0060*IT_0090;
    const ccomplex_t IT_0183 = IT_0046*IT_0181*IT_0182;
    const ccomplex_t IT_0184 = IT_0176 + -IT_0177 + -IT_0178 + -IT_0179 + 
      -IT_0180 + IT_0183;
    const ccomplex_t IT_0185 = -conj(IT_0184);
    const ccomplex_t IT_0186 = conj(IT_0173) + IT_0185;
    const ccomplex_t IT_0187 = IT_0009*IT_0155;
    const ccomplex_t IT_0188 = IT_0002*IT_0167*IT_0187;
    const ccomplex_t IT_0189 = IT_0066*IT_0117;
    const ccomplex_t IT_0190 = IT_0064*IT_0170*IT_0189;
    const ccomplex_t IT_0191 = m_mu*IT_0158;
    const ccomplex_t IT_0192 = m_mu*IT_0101;
    const ccomplex_t IT_0193 = IT_0048*IT_0098;
    const ccomplex_t IT_0194 = IT_0046*IT_0181*IT_0193;
    const ccomplex_t IT_0195 = m_mu*IT_0120;
    const ccomplex_t IT_0196 = m_mu*IT_0139;
    const ccomplex_t IT_0197 = IT_0188 + IT_0190 + -IT_0191 + -IT_0192 +
       IT_0194 + -IT_0195 + -IT_0196;
    const ccomplex_t IT_0198 = 6*IT_0197;
    const ccomplex_t IT_0199 = IT_0030*IT_0136;
    const ccomplex_t IT_0200 = IT_0028*IT_0174*IT_0199;
    ...
    const ccomplex_t IT_0214 = m_mu*s_14;
    const ccomplex_t IT_0215 = 6*s_34;
    const ccomplex_t IT_0216 = (-6)*s_34;
    const ccomplex_t IT_0217 = (-6)*conj(IT_0082)*(IT_0159*IT_0160 + (
      -0.166666666666667)*IT_0082*IT_0165) + (-6)*conj(IT_0159)*(IT_0082*IT_0160
       + (-0.166666666666667)*IT_0159*IT_0165) + (-6)*IT_0166*(conj(IT_0159)*
      (IT_0173 + -IT_0184) + IT_0159*IT_0186 + (-0.166666666666667)*conj(IT_0082
      )*IT_0203 + (-0.166666666666667)*IT_0082*IT_0206) + IT_0207*(conj(IT_0173)
      *IT_0203 + IT_0173*IT_0206 + conj(IT_0184)*IT_0210 + IT_0184*IT_0213) + 6*
      (conj(IT_0082)*(IT_0173 + -IT_0184) + IT_0082*IT_0186 + 0.166666666666667
      *conj(IT_0159)*IT_0210 + 0.166666666666667*IT_0159*IT_0213)*IT_0214 + 
      (IT_0173*conj(IT_0173) + IT_0184*conj(IT_0184) + IT_0197*conj(IT_0197) +
       IT_0201*conj(IT_0201))*IT_0215 + (conj(IT_0173)*IT_0184 + IT_0173*conj
      (IT_0184) + conj(IT_0197)*IT_0201 + IT_0197*conj(IT_0201))*IT_0216;
