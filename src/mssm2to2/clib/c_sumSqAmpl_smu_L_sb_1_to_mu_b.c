...
ccomplex_return_t c_sumSqAmpl_smu_L_sb_1_to_mu_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0034 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0035 = IT_0018*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_W2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0052 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0053 = IT_0007*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*IT_0053;
    const ccomplex_t IT_0055 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0110 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0111 = IT_0018*IT_0110;
    const ccomplex_t IT_0112 = 1.4142135623731*IT_0111;
    const ccomplex_t IT_0113 = m_b*N_d4*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0121 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0122 = IT_0018*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = m_b*N_d3*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0143 = m_b*N_d2*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0160 = m_b*m_mu*IT_0001;
    ...
    const ccomplex_t IT_0168 = IT_0024*IT_0090;
    const ccomplex_t IT_0169 = IT_0002*IT_0167*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0171 = IT_0078*IT_0109;
    const ccomplex_t IT_0172 = IT_0064*IT_0170*IT_0171;
    const ccomplex_t IT_0173 = m_mu*IT_0027;
    const ccomplex_t IT_0174 = m_mu*IT_0045;
    const ccomplex_t IT_0175 = m_mu*IT_0063;
    const ccomplex_t IT_0176 = m_mu*IT_0081;
    const ccomplex_t IT_0177 = IT_0169 + IT_0172 + -IT_0173 + -IT_0174 + 
      -IT_0175 + -IT_0176;
    const ccomplex_t IT_0178 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0179 = IT_0042*IT_0155;
    const ccomplex_t IT_0180 = IT_0028*IT_0178*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0182 = IT_0060*IT_0136;
    const ccomplex_t IT_0183 = IT_0046*IT_0181*IT_0182;
    const ccomplex_t IT_0184 = -IT_0180 + -IT_0183;
    const ccomplex_t IT_0185 = IT_0177 + -IT_0184;
    const ccomplex_t IT_0186 = -conj(IT_0184);
    const ccomplex_t IT_0187 = conj(IT_0177) + IT_0186;
    const ccomplex_t IT_0188 = m_mu*IT_0101;
    const ccomplex_t IT_0189 = m_mu*IT_0158;
    const ccomplex_t IT_0190 = m_mu*IT_0139;
    const ccomplex_t IT_0191 = m_mu*IT_0120;
    const ccomplex_t IT_0192 = IT_0030*IT_0147;
    const ccomplex_t IT_0193 = IT_0028*IT_0178*IT_0192;
    const ccomplex_t IT_0194 = -IT_0188 + -IT_0189 + -IT_0190 + -IT_0191 +
       IT_0193;
    const ccomplex_t IT_0195 = 6*IT_0194;
    const ccomplex_t IT_0196 = IT_0009*IT_0098;
    const ccomplex_t IT_0197 = IT_0002*IT_0167*IT_0196;
    const ccomplex_t IT_0198 = IT_0048*IT_0128;
    const ccomplex_t IT_0199 = IT_0046*IT_0181*IT_0198;
    const ccomplex_t IT_0200 = IT_0066*IT_0117;
    const ccomplex_t IT_0201 = IT_0064*IT_0170*IT_0200;
    const ccomplex_t IT_0202 = -IT_0197 + -IT_0199 + -IT_0201;
    const ccomplex_t IT_0203 = (-6)*IT_0202;
    const ccomplex_t IT_0204 = IT_0195 + IT_0203;
    const ccomplex_t IT_0205 = 6*conj(IT_0194);
    const ccomplex_t IT_0206 = (-6)*conj(IT_0202);
    const ccomplex_t IT_0207 = IT_0205 + IT_0206;
    const ccomplex_t IT_0208 = m_b*m_mu;
    const ccomplex_t IT_0209 = 6*IT_0202;
    const ccomplex_t IT_0210 = (-6)*IT_0194;
    const ccomplex_t IT_0211 = IT_0209 + IT_0210;
    const ccomplex_t IT_0212 = 6*conj(IT_0202);
    const ccomplex_t IT_0213 = (-6)*conj(IT_0194);
    const ccomplex_t IT_0214 = IT_0212 + IT_0213;
    const ccomplex_t IT_0215 = 6*s_34;
    const ccomplex_t IT_0216 = (-6)*s_34;
    const ccomplex_t IT_0217 = (-0.166666666666667)*IT_0159;
    const ccomplex_t IT_0218 = m_mu*s_14;
    const ccomplex_t IT_0219 = (-6)*conj(IT_0082)*(IT_0159*IT_0160 + (
      -0.166666666666667)*IT_0082*IT_0165) + 6*IT_0166*(conj(IT_0159)*IT_0185 +
       IT_0159*IT_0187 + 0.166666666666667*conj(IT_0082)*IT_0204 +
       0.166666666666667*IT_0082*IT_0207) + IT_0208*(conj(IT_0184)*IT_0204 +
       IT_0184*IT_0207 + conj(IT_0177)*IT_0211 + IT_0177*IT_0214) + (IT_0177
      *conj(IT_0177) + IT_0184*conj(IT_0184) + IT_0194*conj(IT_0194) + IT_0202
      *conj(IT_0202))*IT_0215 + (conj(IT_0177)*IT_0184 + IT_0177*conj(IT_0184) +
       conj(IT_0194)*IT_0202 + IT_0194*conj(IT_0202))*IT_0216 + (-6)*conj
      (IT_0159)*(IT_0082*IT_0160 + IT_0165*IT_0217) + (-6)*(conj(IT_0082)
      *IT_0185 + IT_0082*IT_0187 + (-0.166666666666667)*conj(IT_0159)*IT_0211 +
       IT_0214*IT_0217)*IT_0218;
