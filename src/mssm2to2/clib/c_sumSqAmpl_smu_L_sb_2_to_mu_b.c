...
ccomplex_return_t c_sumSqAmpl_smu_L_sb_2_to_mu_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = m_b*conj(N_d2)*e_em*IT_0003*U_sb_11;
    const ccomplex_t IT_0012 = IT_0010*IT_0011;
    const ccomplex_t IT_0013 = 1.4142135623731*IT_0012;
    const ccomplex_t IT_0014 = conj(N_W2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0019 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0031 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0032 = IT_0018*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0035 = IT_0007*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = m_b*conj(N_d3)*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0065 = (-0.5)*IT_0064;
    const ccomplex_t IT_0066 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0067 = IT_0018*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = conj(N_W1)*e_em*U_sb_01;
    const ccomplex_t IT_0070 = IT_0007*IT_0069;
    const ccomplex_t IT_0071 = 1.4142135623731*IT_0070;
    const ccomplex_t IT_0072 = m_b*conj(N_d1)*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0089 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0090 = IT_0018*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = m_b*N_d3*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0108 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0109 = IT_0018*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = m_b*N_d4*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0130 = m_b*N_d1*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0146 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0147 = IT_0018*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = m_b*N_d2*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0158 = m_b*m_mu*IT_0001;
    ...
    const ccomplex_t IT_0164 = m_b*s_13;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0166 = IT_0059*IT_0107;
    const ccomplex_t IT_0167 = IT_0045*IT_0165*IT_0166;
    const ccomplex_t IT_0168 = m_mu*IT_0027;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0170 = IT_0076*IT_0126;
    const ccomplex_t IT_0171 = IT_0063*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = m_mu*IT_0044;
    const ccomplex_t IT_0173 = m_mu*IT_0062;
    const ccomplex_t IT_0174 = m_mu*IT_0079;
    const ccomplex_t IT_0175 = IT_0167 + -IT_0168 + IT_0171 + -IT_0172 + 
      -IT_0173 + -IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0177 = IT_0024*IT_0145;
    const ccomplex_t IT_0178 = IT_0002*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0180 = IT_0041*IT_0088;
    const ccomplex_t IT_0181 = IT_0028*IT_0179*IT_0180;
    ...
    const ccomplex_t IT_0186 = IT_0009*IT_0153;
    const ccomplex_t IT_0187 = IT_0002*IT_0176*IT_0186;
    const ccomplex_t IT_0188 = m_mu*IT_0156;
    const ccomplex_t IT_0189 = m_mu*IT_0099;
    const ccomplex_t IT_0190 = m_mu*IT_0137;
    const ccomplex_t IT_0191 = m_mu*IT_0118;
    const ccomplex_t IT_0192 = IT_0187 + -IT_0188 + -IT_0189 + -IT_0190 + 
      -IT_0191;
    const ccomplex_t IT_0193 = 6*IT_0192;
    const ccomplex_t IT_0194 = IT_0065*IT_0134;
    const ccomplex_t IT_0195 = IT_0063*IT_0169*IT_0194;
    const ccomplex_t IT_0196 = IT_0047*IT_0115;
    const ccomplex_t IT_0197 = IT_0045*IT_0165*IT_0196;
    const ccomplex_t IT_0198 = IT_0030*IT_0096;
    const ccomplex_t IT_0199 = IT_0028*IT_0179*IT_0198;
    const ccomplex_t IT_0200 = -IT_0195 + -IT_0197 + -IT_0199;
    const ccomplex_t IT_0201 = (-6)*IT_0200;
    const ccomplex_t IT_0202 = IT_0193 + IT_0201;
    const ccomplex_t IT_0203 = 6*conj(IT_0192);
    const ccomplex_t IT_0204 = (-6)*conj(IT_0200);
    const ccomplex_t IT_0205 = IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = m_b*m_mu;
    const ccomplex_t IT_0207 = 6*IT_0200;
    const ccomplex_t IT_0208 = (-6)*IT_0192;
    const ccomplex_t IT_0209 = IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = 6*conj(IT_0200);
    const ccomplex_t IT_0211 = (-6)*conj(IT_0192);
    ...
    const ccomplex_t IT_0216 = m_mu*s_14;
    const ccomplex_t IT_0217 = (-6)*conj(IT_0080)*(IT_0157*IT_0158 + (
      -0.166666666666667)*IT_0080*IT_0163) + 6*IT_0164*(conj(IT_0157)*IT_0183 +
       IT_0157*IT_0185 + 0.166666666666667*conj(IT_0080)*IT_0202 +
       0.166666666666667*IT_0080*IT_0205) + IT_0206*(conj(IT_0182)*IT_0202 +
       IT_0182*IT_0205 + conj(IT_0175)*IT_0209 + IT_0175*IT_0212) + (IT_0175
      *conj(IT_0175) + IT_0182*conj(IT_0182) + IT_0192*conj(IT_0192) + IT_0200
      *conj(IT_0200))*IT_0213 + (conj(IT_0175)*IT_0182 + IT_0175*conj(IT_0182) +
       conj(IT_0192)*IT_0200 + IT_0192*conj(IT_0200))*IT_0214 + (-6)*conj
      (IT_0157)*(IT_0080*IT_0158 + IT_0163*IT_0215) + (-6)*(conj(IT_0080)
      *IT_0183 + IT_0080*IT_0185 + (-0.166666666666667)*conj(IT_0157)*IT_0209 +
