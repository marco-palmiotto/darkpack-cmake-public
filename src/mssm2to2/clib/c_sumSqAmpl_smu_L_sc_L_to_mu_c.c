        ...
        )
{
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*(IT_0025 + IT_0028);
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*(IT_0039 + IT_0042);
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*(IT_0053 + IT_0056);
    ...
    const ccomplex_t IT_0097 = m_c*m_mu*IT_0019;
    ...
    const ccomplex_t IT_0105 = IT_0044*IT_0083;
    ...
    const ccomplex_t IT_0121 = -IT_0114 + -IT_0117 + -IT_0120;
    const ccomplex_t IT_0122 = IT_0111 + -IT_0121;
    const ccomplex_t IT_0123 = -conj(IT_0121);
    const ccomplex_t IT_0124 = conj(IT_0111) + IT_0123;
    const ccomplex_t IT_0125 = IT_0016*IT_0071;
    const ccomplex_t IT_0126 = IT_0020*IT_0118*IT_0125;
    const ccomplex_t IT_0127 = IT_0060*IT_0092;
    const ccomplex_t IT_0128 = IT_0062*IT_0115*IT_0127;
    const ccomplex_t IT_0129 = m_mu*IT_0074;
    const ccomplex_t IT_0130 = m_mu*IT_0088;
    const ccomplex_t IT_0131 = m_mu*IT_0095;
    const ccomplex_t IT_0132 = m_mu*IT_0081;
    const ccomplex_t IT_0133 = IT_0126 + IT_0128 + -IT_0129 + -IT_0130 + 
      -IT_0131 + -IT_0132;
    const ccomplex_t IT_0134 = 6*IT_0133;
    const ccomplex_t IT_0135 = IT_0032*IT_0078;
    const ccomplex_t IT_0136 = IT_0034*IT_0112*IT_0135;
    const ccomplex_t IT_0137 = IT_0046*IT_0085;
    const ccomplex_t IT_0138 = IT_0048*IT_0104*IT_0137;
    ...
    const ccomplex_t IT_0156 = (-6)*conj(IT_0065)*(IT_0096*IT_0097 + (
      -0.166666666666667)*IT_0065*IT_0102) + 6*IT_0103*(conj(IT_0096)*IT_0122 +
       ...
       IT_0121*IT_0144 + conj(IT_0111)*IT_0148 + IT_0111*IT_0151) + (IT_0111
      *conj(IT_0111) + IT_0121*conj(IT_0121) + IT_0133*conj(IT_0133) + IT_0139
      *conj(IT_0139))*IT_0152 + (conj(IT_0111)*IT_0121 + IT_0111*conj(IT_0121) +
       conj(IT_0133)*IT_0139 + IT_0133*conj(IT_0139))*IT_0153 + (-6)*conj
