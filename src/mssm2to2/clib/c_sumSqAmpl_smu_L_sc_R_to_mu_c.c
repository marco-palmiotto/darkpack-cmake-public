...
ccomplex_return_t c_sumSqAmpl_smu_L_sc_R_to_mu_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0000*IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0097 = m_c*m_mu*IT_0013;
    ...
    const ccomplex_t IT_0108 = IT_0034*IT_0077;
    const ccomplex_t IT_0109 = IT_0038*IT_0107*IT_0108;
    const ccomplex_t IT_0110 = m_mu*IT_0016;
    const ccomplex_t IT_0111 = m_mu*IT_0024;
    const ccomplex_t IT_0112 = m_mu*IT_0032;
    const ccomplex_t IT_0113 = m_mu*IT_0040;
    const ccomplex_t IT_0114 = IT_0106 + IT_0109 + -IT_0110 + -IT_0111 + 
      -IT_0112 + -IT_0113;
    const ccomplex_t IT_0115 = IT_0010*IT_0053;
    const ccomplex_t IT_0116 = IT_0014*IT_0104*IT_0115;
    const ccomplex_t IT_0117 = IT_0028*IT_0084;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0119 = IT_0030*IT_0117*IT_0118;
    const ccomplex_t IT_0120 = IT_0036*IT_0079;
    const ccomplex_t IT_0121 = IT_0038*IT_0107*IT_0120;
    const ccomplex_t IT_0122 = -IT_0116 + -IT_0119 + -IT_0121;
    const ccomplex_t IT_0123 = 6*IT_0122;
    const ccomplex_t IT_0124 = IT_0020*IT_0066;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0126 = IT_0022*IT_0124*IT_0125;
    const ccomplex_t IT_0127 = m_mu*IT_0056;
    const ccomplex_t IT_0128 = m_mu*IT_0082;
    const ccomplex_t IT_0129 = m_mu*IT_0069;
    ...
    const ccomplex_t IT_0134 = 6*conj(IT_0122);
    const ccomplex_t IT_0135 = (-6)*conj(IT_0131);
    const ccomplex_t IT_0136 = IT_0134 + IT_0135;
    const ccomplex_t IT_0137 = IT_0018*IT_0064;
    const ccomplex_t IT_0138 = IT_0022*IT_0125*IT_0137;
    const ccomplex_t IT_0139 = IT_0026*IT_0092;
    const ccomplex_t IT_0140 = IT_0030*IT_0118*IT_0139;
    const ccomplex_t IT_0141 = -IT_0138 + -IT_0140;
    const ccomplex_t IT_0142 = 6*IT_0131;
    const ccomplex_t IT_0143 = (-6)*IT_0122;
    const ccomplex_t IT_0144 = IT_0142 + IT_0143;
    const ccomplex_t IT_0145 = 6*conj(IT_0131);
    const ccomplex_t IT_0146 = (-6)*conj(IT_0122);
    const ccomplex_t IT_0147 = IT_0145 + IT_0146;
    const ccomplex_t IT_0148 = m_c*s_13;
    const ccomplex_t IT_0149 = IT_0114 + -IT_0141;
    const ccomplex_t IT_0150 = -conj(IT_0141);
    const ccomplex_t IT_0151 = conj(IT_0114) + IT_0150;
    ...
    const ccomplex_t IT_0156 = (-6)*conj(IT_0041)*(IT_0096*IT_0097 + (
      -0.166666666666667)*IT_0041*IT_0102) + IT_0103*(conj(IT_0114)*IT_0133 +
       IT_0114*IT_0136 + conj(IT_0141)*IT_0144 + IT_0141*IT_0147) + 6*IT_0148*
      (0.166666666666667*conj(IT_0041)*IT_0144 + 0.166666666666667*IT_0041
      *IT_0147 + conj(IT_0096)*IT_0149 + IT_0096*IT_0151) + (IT_0114*conj
      (IT_0114) + IT_0122*conj(IT_0122) + IT_0131*conj(IT_0131) + IT_0141*conj
      (IT_0141))*IT_0152 + (conj(IT_0122)*IT_0131 + IT_0122*conj(IT_0131) + conj
      (IT_0114)*IT_0141 + IT_0114*conj(IT_0141))*IT_0153 + (-6)*conj(IT_0096)*
      (IT_0041*IT_0097 + IT_0102*IT_0154) + (-6)*((-0.166666666666667)*conj
      (IT_0096)*IT_0133 + conj(IT_0041)*IT_0149 + IT_0041*IT_0151 + IT_0136
      *IT_0154)*IT_0155;
