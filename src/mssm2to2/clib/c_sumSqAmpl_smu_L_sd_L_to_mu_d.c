...
ccomplex_return_t c_sumSqAmpl_smu_L_sd_L_to_mu_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*(IT_0053 + IT_0056);
    ...
    const ccomplex_t IT_0095 = m_d*m_mu*IT_0019;
    ...
    const ccomplex_t IT_0106 = IT_0058*IT_0088;
    const ccomplex_t IT_0107 = IT_0062*IT_0105*IT_0106;
    const ccomplex_t IT_0108 = m_mu*IT_0022;
    const ccomplex_t IT_0109 = m_mu*IT_0036;
    const ccomplex_t IT_0110 = m_mu*IT_0050;
    const ccomplex_t IT_0111 = m_mu*IT_0064;
    const ccomplex_t IT_0112 = IT_0104 + IT_0107 + -IT_0108 + -IT_0109 + 
      -IT_0110 + -IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0114 = IT_0030*IT_0074;
    const ccomplex_t IT_0115 = IT_0034*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0117 = IT_0044*IT_0081;
    ...
    const ccomplex_t IT_0124 = IT_0034*IT_0113*IT_0123;
    const ccomplex_t IT_0125 = m_mu*IT_0072;
    const ccomplex_t IT_0126 = m_mu*IT_0086;
    const ccomplex_t IT_0127 = m_mu*IT_0093;
    const ccomplex_t IT_0128 = m_mu*IT_0079;
    const ccomplex_t IT_0129 = IT_0124 + -IT_0125 + -IT_0126 + -IT_0127 + 
      -IT_0128;
    const ccomplex_t IT_0130 = 6*IT_0129;
    const ccomplex_t IT_0131 = IT_0016*IT_0069;
    const ccomplex_t IT_0132 = IT_0020*IT_0102*IT_0131;
    const ccomplex_t IT_0133 = IT_0046*IT_0083;
    const ccomplex_t IT_0134 = IT_0048*IT_0116*IT_0133;
    const ccomplex_t IT_0135 = IT_0060*IT_0090;
    const ccomplex_t IT_0136 = IT_0062*IT_0105*IT_0135;
    ...
    const ccomplex_t IT_0143 = m_d*m_mu;
    ...
    const ccomplex_t IT_0154 = (-6)*conj(IT_0065)*(IT_0094*IT_0095 + (
      -0.166666666666667)*IT_0065*IT_0100) + 6*IT_0101*(conj(IT_0094)*IT_0120 +
       IT_0094*IT_0122 + 0.166666666666667*conj(IT_0065)*IT_0139 +
       0.166666666666667*IT_0065*IT_0142) + IT_0143*(conj(IT_0119)*IT_0139 +
      ...
      *conj(IT_0137))*IT_0150 + (conj(IT_0112)*IT_0119 + IT_0112*conj(IT_0119) +
      ...
      (IT_0094)*(IT_0065*IT_0095 + IT_0100*IT_0152) + (-6)*(conj(IT_0065)
      *IT_0120 + IT_0065*IT_0122 + (-0.166666666666667)*conj(IT_0094)*IT_0146 +
