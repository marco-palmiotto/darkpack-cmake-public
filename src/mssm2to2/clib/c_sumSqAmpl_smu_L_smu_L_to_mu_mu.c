        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_23 + IT_0009 + IT_0010 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*m_N_3*IT_0023;
    ...
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0030*IT_0031;
    const ccomplex_t IT_0033 = -IT_0012 + -IT_0018 + -IT_0020 + -IT_0026 + 
      -IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0009 + IT_0010 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0008*IT_0034;
    const ccomplex_t IT_0036 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0024*IT_0036;
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0009 + IT_0010 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    ...
    const ccomplex_t IT_0053 = m_mu*IT_0052;
    const ccomplex_t IT_0054 = IT_0034*IT_0050;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = m_mu*IT_0055;
    ...
    const ccomplex_t IT_0084 = IT_0025*IT_0080;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1)*IT_0084;
    const ccomplex_t IT_0086 = m_mu*IT_0085;
    ...
    const ccomplex_t IT_0099 = IT_0038*IT_0095;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1)*IT_0099;
    const ccomplex_t IT_0101 = m_mu*IT_0100;
    const ccomplex_t IT_0102 = IT_0035 + IT_0037 + IT_0039 + -IT_0053 + 
      -IT_0056 + -IT_0068 + -IT_0071 + -IT_0083 + -IT_0086 + -IT_0098 + -IT_0101;
    const ccomplex_t IT_0103 = cpow(IT_0049, 2);
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*m_N_1*IT_0103;
    const ccomplex_t IT_0105 = IT_0034*IT_0104;
    const ccomplex_t IT_0106 = IT_0011*IT_0104;
    const ccomplex_t IT_0107 = cpow(IT_0064, 2);
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*m_N_2*IT_0107;
    const ccomplex_t IT_0109 = IT_0017*IT_0108;
    const ccomplex_t IT_0110 = cpow(IT_0094, 2);
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*m_N_4*IT_0110;
    const ccomplex_t IT_0112 = IT_0038*IT_0111;
    const ccomplex_t IT_0113 = IT_0031*IT_0111;
    const ccomplex_t IT_0114 = cpow(IT_0079, 2);
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*m_N_3*IT_0114;
    const ccomplex_t IT_0116 = IT_0025*IT_0115;
    const ccomplex_t IT_0117 = -IT_0105 + -IT_0106 + -IT_0109 + -IT_0112 + 
      -IT_0113 + -IT_0116;
    const ccomplex_t IT_0118 = IT_0019*IT_0108;
    const ccomplex_t IT_0119 = IT_0036*IT_0115;
    const ccomplex_t IT_0120 = -IT_0053 + -IT_0056 + -IT_0068 + -IT_0071 + 
      -IT_0083 + -IT_0086 + -IT_0098 + -IT_0101 + IT_0118 + IT_0119;
    const ccomplex_t IT_0121 = 2*s_34;
    const ccomplex_t IT_0122 = (-2)*s_34;
    const ccomplex_t IT_0123 = -IT_0052 + IT_0055 + -IT_0067 + IT_0070 + 
      -IT_0082 + IT_0085 + -IT_0097 + IT_0100;
    const ccomplex_t IT_0124 = m_mu*s_24;
    const ccomplex_t IT_0125 = IT_0117 + -IT_0120;
    const ccomplex_t IT_0126 = 2*IT_0102;
    const ccomplex_t IT_0127 = (-2)*IT_0033;
    const ccomplex_t IT_0128 = m_mu*s_23;
    const ccomplex_t IT_0129 = 2*IT_0033;
    const ccomplex_t IT_0130 = (-2)*IT_0102;
    const ccomplex_t IT_0131 = 2*conj(IT_0102);
    const ccomplex_t IT_0132 = (-2)*conj(IT_0033);
    const ccomplex_t IT_0133 = 2*conj(IT_0033);
    ...
    const ccomplex_t IT_0139 = conj(IT_0117) + IT_0138;
    ...
    const ccomplex_t IT_0141 = (IT_0033*conj(IT_0033) + IT_0102*conj(IT_0102) 
      + IT_0117*conj(IT_0117) + IT_0120*conj(IT_0120))*IT_0121 + (conj(IT_0033)
      *IT_0102 + IT_0033*conj(IT_0102) + conj(IT_0117)*IT_0120 + IT_0117*conj
      (IT_0120))*IT_0122 + (-2)*conj(IT_0123)*(IT_0124*(IT_0125 + (-0.5)*IT_0126
       + (-0.5)*IT_0127) + -IT_0128*(IT_0125 + 0.5*IT_0129 + 0.5*IT_0130)) +
       IT_0009*(conj(IT_0117)*(IT_0126 + IT_0127) + conj(IT_0120)*(IT_0129 +
       IT_0130) + IT_0117*(IT_0131 + IT_0132) + IT_0120*(IT_0133 + IT_0134)) +
       IT_0140;
