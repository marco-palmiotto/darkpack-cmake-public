...
ccomplex_return_t c_sumSqAmpl_smu_L_snu_e_to_nu_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0032 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0046 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0060 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
    ...
    const ccomplex_t IT_0086 = 0.5*IT_0070 + 0.5*IT_0075 + 0.5*IT_0080 + 0.5
      *IT_0085;
    const ccomplex_t IT_0087 = m_mu*s_23;
    const ccomplex_t IT_0088 = s_23*s_24;
    const ccomplex_t IT_0089 = s_34*IT_0016;
    const ccomplex_t IT_0090 = (-2)*s_34;
    const ccomplex_t IT_0091 = 2*s_34*(IT_0019*conj(IT_0019) + IT_0062*conj
      (IT_0062)) + 2*((conj(IT_0019) + -conj(IT_0062))*IT_0086 + (IT_0019 + 
      -IT_0062)*conj(IT_0086))*IT_0087 + 4*IT_0086*conj(IT_0086)*(IT_0088 + (
      -0.5)*IT_0089) + (conj(IT_0019)*IT_0062 + IT_0019*conj(IT_0062))*IT_0090;
