        ...
        )
{
    ...
    const ccomplex_t IT_0031 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0045 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0059 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0006*IT_0062*IT_0064;
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = IT_0013*IT_0066;
    const ccomplex_t IT_0068 = IT_0017*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0006*IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0006*IT_0062*IT_0064;
    ...
    return create_ccomplex_return(2*IT_0061*(s_34*conj(IT_0061) + conj(IT_0085
      )*IT_0086) + 2*IT_0085*(conj(IT_0061)*IT_0086 + 2*conj(IT_0085)*(IT_0087 +
       (-0.5)*IT_0088)));
}
