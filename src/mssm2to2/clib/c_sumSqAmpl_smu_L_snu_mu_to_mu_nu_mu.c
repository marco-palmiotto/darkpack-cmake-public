        ...
        )
{
    ...
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0006 + IT_0030 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0057*IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0062 = cpow((-2)*s_13 + IT_0006 + IT_0030 + -m_N_3*
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*(IT_0065 + IT_0068);
    const ccomplex_t IT_0072 = (-0.5)*IT_0071;
    const ccomplex_t IT_0073 = IT_0070*IT_0072;
    const ccomplex_t IT_0074 = IT_0061*IT_0062*IT_0073;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0001*IT_0076*IT_0078;
    ...
    const ccomplex_t IT_0101 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0001*IT_0076*IT_0078;
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0001*IT_0076*IT_0078;
    const ccomplex_t IT_0107 = (-0.5)*IT_0106;
    const ccomplex_t IT_0108 = IT_0056*IT_0107;
    const ccomplex_t IT_0109 = IT_0059*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*IT_0109;
    const ccomplex_t IT_0111 = -IT_0095 + -IT_0100 + -IT_0105 + -IT_0110;
    const ccomplex_t IT_0112 = s_23*s_24;
    const ccomplex_t IT_0113 = s_34*IT_0007;
    const ccomplex_t IT_0114 = (-0.5)*IT_0113;
    const ccomplex_t IT_0115 = IT_0112 + IT_0114;
    const ccomplex_t IT_0116 = conj(IT_0089) + conj(IT_0111);
    const ccomplex_t IT_0117 = m_mu*s_24;
    const ccomplex_t IT_0118 = 2*IT_0075;
    const ccomplex_t IT_0119 = 2*conj(IT_0075);
    const ccomplex_t IT_0120 = (-2)*s_34;
    const ccomplex_t IT_0121 = 2*s_34*(IT_0075*conj(IT_0075) + IT_0090*conj
      (IT_0090)) + 4*(IT_0089 + IT_0111)*IT_0115*IT_0116 + (-2)*IT_0117*(IT_0116
      *(IT_0090 + (-0.5)*IT_0118) + (IT_0089 + IT_0111)*(conj(IT_0090) + (-0.5)
      *IT_0119)) + (conj(IT_0075)*IT_0090 + IT_0075*conj(IT_0090))*IT_0120;
