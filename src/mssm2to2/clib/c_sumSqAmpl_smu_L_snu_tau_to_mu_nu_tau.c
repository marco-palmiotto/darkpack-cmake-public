...
ccomplex_return_t c_sumSqAmpl_smu_L_snu_tau_to_mu_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*(IT_0022 + -IT_0025);
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_N_4*
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0047 = IT_0044*IT_0045*IT_0046;
    const ccomplex_t IT_0048 = IT_0019 + IT_0033 + IT_0047;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*(IT_0051 + -IT_0054);
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = IT_0056*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_N_2*
    ...
    const ccomplex_t IT_0067 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0006*IT_0064*IT_0066;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0006*IT_0064*IT_0066;
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0006*IT_0064*IT_0066;
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0006*IT_0064*IT_0066;
    ...
    const ccomplex_t IT_0088 = m_mu*s_24;
    const ccomplex_t IT_0089 = s_23*s_24;
    const ccomplex_t IT_0090 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0091 = s_34*IT_0090;
    const ccomplex_t IT_0092 = (-2)*s_34;
    const ccomplex_t IT_0093 = 2*s_34*(IT_0048*conj(IT_0048) + IT_0063*conj
      (IT_0063)) + 2*((conj(IT_0048) + -conj(IT_0063))*IT_0087 + (IT_0048 + 
      -IT_0063)*conj(IT_0087))*IT_0088 + 4*IT_0087*conj(IT_0087)*(IT_0089 + (
      -0.5)*IT_0091) + (conj(IT_0048)*IT_0063 + IT_0048*conj(IT_0063))*IT_0092;
