        ...
        )
{
    ...
    const ccomplex_t IT_0018 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_N_2*
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_N_3*
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_N_4*
    ...
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -m_N_1*
    ...
    const ccomplex_t IT_0087 = m_mu*s_24;
    const ccomplex_t IT_0088 = s_23*s_24;
    const ccomplex_t IT_0089 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0090 = s_34*IT_0089;
    return create_ccomplex_return(2*IT_0062*(s_34*conj(IT_0062) + -conj
      (IT_0086)*IT_0087) + (-2)*IT_0086*(conj(IT_0062)*IT_0087 + (-2)*conj
      (IT_0086)*(IT_0088 + (-0.5)*IT_0090)));
}
