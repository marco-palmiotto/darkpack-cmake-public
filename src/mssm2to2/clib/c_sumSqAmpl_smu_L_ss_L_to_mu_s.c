...
ccomplex_return_t c_sumSqAmpl_smu_L_ss_L_to_mu_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*(IT_0039 + (-3)*IT_0042);
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0114 = IT_0044*IT_0081;
    const ccomplex_t IT_0115 = IT_0048*IT_0113*IT_0114;
    const ccomplex_t IT_0116 = m_s*IT_0022;
    const ccomplex_t IT_0117 = m_s*IT_0036;
    const ccomplex_t IT_0118 = m_s*IT_0050;
    const ccomplex_t IT_0119 = m_s*IT_0064;
    ...
    const ccomplex_t IT_0124 = IT_0032*IT_0076;
    const ccomplex_t IT_0125 = IT_0034*IT_0106*IT_0124;
    const ccomplex_t IT_0126 = IT_0046*IT_0083;
    const ccomplex_t IT_0127 = IT_0048*IT_0113*IT_0126;
    const ccomplex_t IT_0128 = -IT_0125 + -IT_0127;
    const ccomplex_t IT_0129 = 6*IT_0128;
    const ccomplex_t IT_0130 = IT_0016*IT_0069;
    const ccomplex_t IT_0131 = IT_0020*IT_0103*IT_0130;
    const ccomplex_t IT_0132 = IT_0060*IT_0090;
    const ccomplex_t IT_0133 = IT_0062*IT_0109*IT_0132;
    ...
    const ccomplex_t IT_0154 = (-6)*conj(IT_0065)*(IT_0094*IT_0096 + (
      -0.166666666666667)*IT_0065*IT_0101) + (-6)*conj(IT_0094)*(IT_0065*IT_0096
       + (-0.166666666666667)*IT_0094*IT_0101) + 6*IT_0102*(conj(IT_0065)
      *IT_0121 + IT_0065*IT_0123 + 0.166666666666667*conj(IT_0094)*IT_0140 +
      ...
      (IT_0094)*IT_0121 + IT_0094*IT_0123 + (-0.166666666666667)*conj(IT_0065)
      *IT_0147 + (-0.166666666666667)*IT_0065*IT_0150)*IT_0151 + (IT_0112*conj
