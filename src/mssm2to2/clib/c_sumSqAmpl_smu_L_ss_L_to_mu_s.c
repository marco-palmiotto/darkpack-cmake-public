        ...
        )
{
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*(IT_0039 + (-3)*IT_0042);
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*(IT_0053 + (-3)*IT_0056);
    const ccomplex_t IT_0081 = 0.166666666666667*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*(IT_0004 + (-3)*IT_0009);
    ...
    const ccomplex_t IT_0122 = IT_0016*IT_0088;
    const ccomplex_t IT_0123 = IT_0020*IT_0112*IT_0122;
    const ccomplex_t IT_0124 = IT_0032*IT_0069;
    const ccomplex_t IT_0125 = IT_0034*IT_0103*IT_0124;
    const ccomplex_t IT_0126 = IT_0046*IT_0076;
    const ccomplex_t IT_0127 = IT_0048*IT_0106*IT_0126;
    const ccomplex_t IT_0128 = IT_0060*IT_0083;
    const ccomplex_t IT_0129 = IT_0062*IT_0109*IT_0128;
    const ccomplex_t IT_0130 = -IT_0123 + -IT_0125 + -IT_0127 + -IT_0129;
    const ccomplex_t IT_0131 = 6*IT_0130;
    const ccomplex_t IT_0132 = IT_0072 + IT_0079 + IT_0086 + IT_0093;
    ...
    const ccomplex_t IT_0150 = (-6)*conj(IT_0065)*(IT_0094*IT_0096 + (
      ...
      *IT_0119 + IT_0065*IT_0121 + 0.166666666666667*conj(IT_0094)*IT_0136 +
      ...
      (IT_0094)*IT_0119 + IT_0094*IT_0121 + (-0.166666666666667)*conj(IT_0065)
      *IT_0143 + (-0.166666666666667)*IT_0065*IT_0146)*IT_0147 + (IT_0115*conj
