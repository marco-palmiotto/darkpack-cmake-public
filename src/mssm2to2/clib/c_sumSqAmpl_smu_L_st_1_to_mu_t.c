...
ccomplex_return_t c_sumSqAmpl_smu_L_st_1_to_mu_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = conj(N_B1)*e_em*U_st_00;
    ...
    const ccomplex_t IT_0018 = m_t*conj(N_u1)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = conj(N_B3)*e_em*U_st_00;
    const ccomplex_t IT_0032 = IT_0008*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0035 = IT_0004*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = m_t*conj(N_u3)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0024 + IT_0025 + -m_N_3*
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0064 = (-0.5)*IT_0063;
    const ccomplex_t IT_0065 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0066 = IT_0008*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0069 = IT_0004*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = m_t*conj(N_u2)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0024 + IT_0025 + -m_N_2*
    ...
    const ccomplex_t IT_0092 = m_t*N_u4*e_em*IT_0000*U_st_00;
    ...
    const ccomplex_t IT_0108 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0109 = IT_0008*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = m_t*N_u1*e_em*IT_0000*U_st_00;
    ...
    const ccomplex_t IT_0127 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0128 = IT_0008*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_t*N_u2*e_em*IT_0000*U_st_00;
    ...
    const ccomplex_t IT_0138 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0139 = IT_0008*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = m_t*N_u3*e_em*IT_0000*U_st_00;
    ...
    const ccomplex_t IT_0157 = -IT_0099 + -IT_0118 + -IT_0137 + -IT_0156;
    const ccomplex_t IT_0158 = pow(m_st_1, 2);
    const ccomplex_t IT_0159 = m_t*m_mu*IT_0158;
    ...
    const ccomplex_t IT_0165 = m_t*s_23;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0167 = IT_0022*IT_0107;
    const ccomplex_t IT_0168 = IT_0026*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0170 = IT_0058*IT_0088;
    const ccomplex_t IT_0171 = IT_0060*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0173 = IT_0075*IT_0126;
    const ccomplex_t IT_0174 = IT_0077*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = -IT_0168 + -IT_0171 + -IT_0174;
    const ccomplex_t IT_0176 = m_t*IT_0099;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0178 = IT_0041*IT_0153;
    const ccomplex_t IT_0179 = IT_0043*IT_0177*IT_0178;
    const ccomplex_t IT_0180 = m_t*IT_0118;
    const ccomplex_t IT_0181 = m_t*IT_0156;
    const ccomplex_t IT_0182 = m_t*IT_0137;
    const ccomplex_t IT_0183 = -IT_0176 + IT_0179 + -IT_0180 + -IT_0181 + 
      -IT_0182;
    ...
    const ccomplex_t IT_0187 = IT_0064*IT_0134;
    const ccomplex_t IT_0188 = IT_0077*IT_0172*IT_0187;
    const ccomplex_t IT_0189 = IT_0030*IT_0145;
    const ccomplex_t IT_0190 = IT_0043*IT_0177*IT_0189;
    const ccomplex_t IT_0191 = -IT_0188 + -IT_0190;
    const ccomplex_t IT_0192 = 6*IT_0191;
    const ccomplex_t IT_0193 = IT_0006*IT_0115;
    const ccomplex_t IT_0194 = IT_0026*IT_0166*IT_0193;
    const ccomplex_t IT_0195 = IT_0047*IT_0096;
    const ccomplex_t IT_0196 = IT_0060*IT_0169*IT_0195;
    const ccomplex_t IT_0197 = m_t*IT_0028;
    const ccomplex_t IT_0198 = m_t*IT_0045;
    const ccomplex_t IT_0199 = m_t*IT_0062;
    const ccomplex_t IT_0200 = m_t*IT_0079;
    const ccomplex_t IT_0201 = IT_0194 + IT_0196 + -IT_0197 + -IT_0198 + 
      -IT_0199 + -IT_0200;
    ...
    const ccomplex_t IT_0207 = m_t*m_mu;
    ...
    const ccomplex_t IT_0217 = m_mu*s_24;
    const ccomplex_t IT_0218 = (-6)*conj(IT_0080)*(IT_0157*IT_0159 + (
      -0.166666666666667)*IT_0080*IT_0164) + 6*IT_0165*(conj(IT_0157)*IT_0184 +
       IT_0157*IT_0186 + 0.166666666666667*conj(IT_0080)*IT_0203 +
       0.166666666666667*IT_0080*IT_0206) + IT_0207*(conj(IT_0183)*IT_0203 +
       IT_0183*IT_0206 + conj(IT_0175)*IT_0210 + IT_0175*IT_0213) + (IT_0175
      *conj(IT_0175) + IT_0183*conj(IT_0183) + IT_0191*conj(IT_0191) + IT_0201
      *conj(IT_0201))*IT_0214 + (conj(IT_0175)*IT_0183 + IT_0175*conj(IT_0183) +
       conj(IT_0191)*IT_0201 + IT_0191*conj(IT_0201))*IT_0215 + (-6)*conj
      (IT_0157)*(IT_0080*IT_0159 + IT_0164*IT_0216) + (-6)*(conj(IT_0080)
      *IT_0184 + IT_0080*IT_0186 + (-0.166666666666667)*conj(IT_0157)*IT_0210 +
