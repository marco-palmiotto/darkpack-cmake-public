...
ccomplex_return_t c_sumSqAmpl_smu_L_st_2_to_mu_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0041 = m_t*N_u4*e_em*IT_0018*U_st_01;
    ...
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0025 + IT_0026 + -m_N_4*
    ...
    const ccomplex_t IT_0058 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0059 = IT_0001*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = m_t*N_u1*e_em*IT_0018*U_st_01;
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0025 + IT_0026 + -m_N_1*
    ...
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0006*IT_0018*IT_0092;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = conj(N_B3)*e_em*U_st_01;
    const ccomplex_t IT_0112 = IT_0001*IT_0111;
    const ccomplex_t IT_0113 = 1.4142135623731*IT_0112;
    const ccomplex_t IT_0114 = conj(N_W3)*e_em*U_st_01;
    const ccomplex_t IT_0115 = IT_0006*IT_0114;
    const ccomplex_t IT_0116 = 1.4142135623731*IT_0115;
    const ccomplex_t IT_0117 = m_t*conj(N_u3)*e_em*IT_0018*U_st_11;
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*N_d4*e_em*m_mu
      *IT_0006*IT_0018*IT_0092;
    ...
    const ccomplex_t IT_0133 = m_t*conj(N_u4)*e_em*IT_0018*U_st_11;
    ...
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*N_d1*e_em*m_mu
      *IT_0006*IT_0018*IT_0092;
    const ccomplex_t IT_0142 = (-0.5)*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B1)*e_em*U_st_01;
    const ccomplex_t IT_0144 = IT_0001*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = conj(N_W1)*e_em*U_st_01;
    const ccomplex_t IT_0147 = IT_0006*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = m_t*conj(N_u1)*e_em*IT_0018*U_st_11;
    ...
    const ccomplex_t IT_0165 = m_mu*s_24;
    const ccomplex_t IT_0166 = m_t*IT_0029;
    const ccomplex_t IT_0167 = m_t*IT_0049;
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0169 = IT_0057*IT_0153;
    const ccomplex_t IT_0170 = IT_0067*IT_0168*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0172 = IT_0011*IT_0105;
    const ccomplex_t IT_0173 = IT_0027*IT_0171*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0175 = IT_0037*IT_0137;
    const ccomplex_t IT_0176 = IT_0047*IT_0174*IT_0175;
    const ccomplex_t IT_0177 = m_t*IT_0069;
    const ccomplex_t IT_0178 = m_t*IT_0089;
    const ccomplex_t IT_0179 = -IT_0166 + -IT_0167 + IT_0170 + IT_0173 +
       IT_0176 + -IT_0177 + -IT_0178;
    const ccomplex_t IT_0180 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0181 = IT_0086*IT_0121;
    const ccomplex_t IT_0182 = IT_0070*IT_0180*IT_0181;
    const ccomplex_t IT_0183 = -IT_0182;
    const ccomplex_t IT_0184 = -conj(IT_0183);
    const ccomplex_t IT_0185 = conj(IT_0179) + IT_0184;
    const ccomplex_t IT_0186 = IT_0023*IT_0094;
    const ccomplex_t IT_0187 = IT_0027*IT_0171*IT_0186;
    const ccomplex_t IT_0188 = IT_0078*IT_0110;
    const ccomplex_t IT_0189 = IT_0070*IT_0180*IT_0188;
    const ccomplex_t IT_0190 = m_t*IT_0108;
    const ccomplex_t IT_0191 = m_t*IT_0124;
    const ccomplex_t IT_0192 = m_t*IT_0140;
    const ccomplex_t IT_0193 = m_t*IT_0156;
    const ccomplex_t IT_0194 = IT_0187 + IT_0189 + -IT_0190 + -IT_0191 + 
      -IT_0192 + -IT_0193;
    const ccomplex_t IT_0195 = 6*IT_0194;
    const ccomplex_t IT_0196 = IT_0045*IT_0126;
    const ccomplex_t IT_0197 = IT_0047*IT_0174*IT_0196;
    const ccomplex_t IT_0198 = IT_0065*IT_0142;
    const ccomplex_t IT_0199 = IT_0067*IT_0168*IT_0198;
    const ccomplex_t IT_0200 = -IT_0197 + -IT_0199;
    const ccomplex_t IT_0201 = (-6)*IT_0200;
    const ccomplex_t IT_0202 = IT_0195 + IT_0201;
    const ccomplex_t IT_0203 = 6*conj(IT_0194);
    const ccomplex_t IT_0204 = (-6)*conj(IT_0200);
    const ccomplex_t IT_0205 = IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = m_t*m_mu;
    const ccomplex_t IT_0207 = 6*IT_0200;
    const ccomplex_t IT_0208 = (-6)*IT_0194;
    const ccomplex_t IT_0209 = IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = 6*conj(IT_0200);
    const ccomplex_t IT_0211 = (-6)*conj(IT_0194);
    ...
    const ccomplex_t IT_0217 = (-6)*conj(IT_0090)*(IT_0157*IT_0159 + (
      -0.166666666666667)*IT_0090*IT_0164) + 6*IT_0165*(conj(IT_0157)*(IT_0179 +
       -IT_0183) + IT_0157*IT_0185 + 0.166666666666667*conj(IT_0090)*IT_0202 +
       0.166666666666667*IT_0090*IT_0205) + IT_0206*(conj(IT_0183)*IT_0202 +
       IT_0183*IT_0205 + conj(IT_0179)*IT_0209 + IT_0179*IT_0212) + (IT_0179
      *conj(IT_0179) + IT_0183*conj(IT_0183) + IT_0194*conj(IT_0194) + IT_0200
      *conj(IT_0200))*IT_0213 + (conj(IT_0179)*IT_0183 + IT_0179*conj(IT_0183) +
       conj(IT_0194)*IT_0200 + IT_0194*conj(IT_0200))*IT_0214 + (-6)*conj
      (IT_0157)*(IT_0090*IT_0159 + IT_0164*IT_0215) + (-6)*(conj(IT_0090)*
      (IT_0179 + -IT_0183) + IT_0090*IT_0185 + (-0.166666666666667)*conj(IT_0157
      )*IT_0209 + IT_0212*IT_0215)*IT_0216;
