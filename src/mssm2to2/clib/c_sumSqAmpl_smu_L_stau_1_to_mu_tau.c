        ...
        )
{
    ...
    const ccomplex_t IT_0041 = N_d4*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
    ...
    const ccomplex_t IT_0059 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0060 = IT_0004*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = N_d2*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_1*
    ...
    const ccomplex_t IT_0082 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0099 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0115 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0121 = IT_0070*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*N_d2*e_em*m_mu
      *IT_0009*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0131 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*N_d3*e_em*m_mu
      *IT_0009*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0147 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0182 = IT_0106 + IT_0122 + IT_0138 + IT_0154;
    const ccomplex_t IT_0183 = m_tau*IT_0182;
    const ccomplex_t IT_0184 = -IT_0183;
    const ccomplex_t IT_0185 = 2*IT_0184;
    const ccomplex_t IT_0186 = IT_0066*IT_0124;
    const ccomplex_t IT_0187 = IT_0050*IT_0172*IT_0186;
    const ccomplex_t IT_0188 = IT_0045*IT_0092;
    const ccomplex_t IT_0189 = IT_0047*IT_0166*IT_0188;
    const ccomplex_t IT_0190 = IT_0018*IT_0140;
    const ccomplex_t IT_0191 = IT_0002*IT_0175*IT_0190;
    const ccomplex_t IT_0192 = IT_0086*IT_0108;
    const ccomplex_t IT_0193 = IT_0070*IT_0169*IT_0192;
    ...
    const ccomplex_t IT_0210 = (-2)*conj(IT_0090)*(IT_0155*IT_0157 + (-2)
      ...
      *IT_0161) + 2*IT_0162*(conj(IT_0155)*IT_0179 + IT_0155*IT_0181 + 0.5*conj
      (IT_0090)*IT_0196 + 0.5*IT_0090*IT_0199) + IT_0200*(conj(IT_0178)*IT_0196 
      + IT_0178*IT_0199 + conj(IT_0165)*IT_0203 + IT_0165*IT_0206) + (-2)*(conj
      (IT_0090)*IT_0179 + IT_0090*IT_0181 + (-0.5)*conj(IT_0155)*IT_0203 + (-0.5
      )*IT_0155*IT_0206)*IT_0207 + (IT_0165*conj(IT_0165) + IT_0178*conj(IT_0178
      ) + IT_0184*conj(IT_0184) + IT_0194*conj(IT_0194))*IT_0208 + (conj(IT_0165
      )*IT_0178 + IT_0165*conj(IT_0178) + conj(IT_0184)*IT_0194 + IT_0184*conj
      (IT_0194))*IT_0209;
