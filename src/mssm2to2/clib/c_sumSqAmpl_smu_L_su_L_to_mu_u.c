        ...
        )
{
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*(IT_0004 + 3*IT_0009);
    ...
    const ccomplex_t IT_0106 = IT_0011*IT_0071;
    ...
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0115 = IT_0058*IT_0090;
    const ccomplex_t IT_0116 = IT_0062*IT_0114*IT_0115;
    const ccomplex_t IT_0117 = -IT_0107 + -IT_0110 + -IT_0113 + -IT_0116;
    const ccomplex_t IT_0118 = IT_0022 + IT_0036 + IT_0050 + IT_0064;
    const ccomplex_t IT_0119 = m_u*IT_0118;
    const ccomplex_t IT_0120 = -IT_0119;
    const ccomplex_t IT_0121 = IT_0117 + -IT_0120;
    const ccomplex_t IT_0122 = -conj(IT_0120);
    const ccomplex_t IT_0123 = conj(IT_0117) + IT_0122;
    const ccomplex_t IT_0124 = IT_0016*IT_0069;
    const ccomplex_t IT_0125 = IT_0020*IT_0105*IT_0124;
    const ccomplex_t IT_0126 = IT_0032*IT_0078;
    const ccomplex_t IT_0127 = IT_0034*IT_0108*IT_0126;
    const ccomplex_t IT_0128 = IT_0046*IT_0085;
    const ccomplex_t IT_0129 = IT_0048*IT_0111*IT_0128;
    const ccomplex_t IT_0130 = IT_0060*IT_0092;
    const ccomplex_t IT_0131 = IT_0062*IT_0114*IT_0130;
    const ccomplex_t IT_0132 = -IT_0125 + -IT_0127 + -IT_0129 + -IT_0131;
    const ccomplex_t IT_0133 = 6*IT_0132;
    const ccomplex_t IT_0134 = IT_0074 + IT_0081 + IT_0088 + IT_0095;
    ...
    const ccomplex_t IT_0139 = 6*conj(IT_0132);
    const ccomplex_t IT_0140 = (-6)*conj(IT_0136);
    const ccomplex_t IT_0141 = IT_0139 + IT_0140;
    const ccomplex_t IT_0142 = m_u*m_mu;
    const ccomplex_t IT_0143 = 6*IT_0136;
    const ccomplex_t IT_0144 = (-6)*IT_0132;
    const ccomplex_t IT_0145 = IT_0143 + IT_0144;
    const ccomplex_t IT_0146 = 6*conj(IT_0136);
    const ccomplex_t IT_0147 = (-6)*conj(IT_0132);
    const ccomplex_t IT_0148 = IT_0146 + IT_0147;
    const ccomplex_t IT_0149 = m_mu*s_24;
    const ccomplex_t IT_0150 = 6*s_34;
    const ccomplex_t IT_0151 = (-6)*s_34;
    const ccomplex_t IT_0152 = (-6)*conj(IT_0065)*(IT_0096*IT_0098 + (
      -0.166666666666667)*IT_0065*IT_0103) + (-6)*conj(IT_0096)*(IT_0065*IT_0098
       + (-0.166666666666667)*IT_0096*IT_0103) + 6*IT_0104*(conj(IT_0065)
      *IT_0121 + IT_0065*IT_0123 + 0.166666666666667*conj(IT_0096)*IT_0138 +
       0.166666666666667*IT_0096*IT_0141) + IT_0142*(conj(IT_0120)*IT_0138 +
       IT_0120*IT_0141 + conj(IT_0117)*IT_0145 + IT_0117*IT_0148) + (-6)*(conj
      (IT_0096)*IT_0121 + IT_0096*IT_0123 + (-0.166666666666667)*conj(IT_0065)
      *IT_0145 + (-0.166666666666667)*IT_0065*IT_0148)*IT_0149 + (IT_0117*conj
      (IT_0117) + IT_0120*conj(IT_0120) + IT_0132*conj(IT_0132) + IT_0136*conj
      (IT_0136))*IT_0150 + (conj(IT_0117)*IT_0120 + IT_0117*conj(IT_0120) + conj
      (IT_0132)*IT_0136 + IT_0132*conj(IT_0136))*IT_0151;
