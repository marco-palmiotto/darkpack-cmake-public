        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = m_b*N_d3*e_em*IT_0003*conj(U_sb_11);
    const ccomplex_t IT_0032 = IT_0013*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = N_B3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0035 = IT_0018*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = N_W3*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0047 = m_b*N_d2*e_em*IT_0003*conj(U_sb_11);
    ...
    const ccomplex_t IT_0053 = N_B2*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0088 = m_mu*IT_0045;
    ...
    const ccomplex_t IT_0093 = IT_0046*IT_0089*IT_0092;
    const ccomplex_t IT_0094 = m_mu*IT_0027;
    ...
    const ccomplex_t IT_0105 = IT_0064*IT_0101*IT_0104;
    const ccomplex_t IT_0106 = m_mu*IT_0081;
    const ccomplex_t IT_0107 = -IT_0087 + IT_0088 + -IT_0093 + IT_0094 +
    ...
    const ccomplex_t IT_0112 = m_b*conj(N_d1)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0118 = IT_0002*IT_0096*IT_0117;
    const ccomplex_t IT_0119 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0120 = IT_0018*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = m_b*conj(N_d2)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0128 = IT_0046*IT_0089*IT_0127;
    const ccomplex_t IT_0129 = IT_0098*IT_0116;
    const ccomplex_t IT_0130 = IT_0002*IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*IT_0130;
    const ccomplex_t IT_0132 = m_mu*IT_0131;
    ...
    const ccomplex_t IT_0136 = m_b*conj(N_d3)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0142 = IT_0028*IT_0083*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0144 = IT_0018*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = m_b*conj(N_d4)*e_em*IT_0003*conj(U_sb_01);
    ...
    const ccomplex_t IT_0152 = IT_0064*IT_0101*IT_0151;
    const ccomplex_t IT_0153 = IT_0091*IT_0126;
    ...
    const ccomplex_t IT_0157 = IT_0085*IT_0140;
    const ccomplex_t IT_0158 = IT_0028*IT_0157;
    const ccomplex_t IT_0159 = (0 + _Complex_I*1)*IT_0158;
    const ccomplex_t IT_0160 = m_mu*IT_0159;
    const ccomplex_t IT_0161 = IT_0103*IT_0150;
    ...
    const ccomplex_t IT_0165 = -IT_0118 + -IT_0128 + IT_0132 + -IT_0142 + 
      -IT_0152 + IT_0156 + IT_0160 + IT_0164;
    const ccomplex_t IT_0166 = m_b*s_13;
    const ccomplex_t IT_0167 = -IT_0131 + -IT_0155 + -IT_0159 + -IT_0163;
