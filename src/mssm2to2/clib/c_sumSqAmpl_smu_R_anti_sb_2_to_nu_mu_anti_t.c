...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_sb_2_to_nu_mu_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = V_tb*e_em*U_Wm1*conj(U_sb_01);
    const ccomplex_t IT_0026 = IT_0004*IT_0025;
    const ccomplex_t IT_0027 = IT_0002*IT_0004;
    const ccomplex_t IT_0028 = m_b*U_d1*V_tb*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0035 = V_tb*e_em*U_Wm2*conj(U_sb_01);
    const ccomplex_t IT_0036 = IT_0004*IT_0035;
    const ccomplex_t IT_0037 = m_b*U_d2*V_tb*e_em*IT_0000*conj(U_sb_11);
