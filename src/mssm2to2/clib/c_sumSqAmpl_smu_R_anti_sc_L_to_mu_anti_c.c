...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_sc_L_to_mu_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0004*IT_0093;
    ...
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0000*IT_0004*IT_0093;
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0000*IT_0004*IT_0093;
    ...
    const ccomplex_t IT_0115 = IT_0020*IT_0088*IT_0114;
    const ccomplex_t IT_0116 = IT_0024*IT_0095;
    const ccomplex_t IT_0117 = IT_0034*IT_0069*IT_0116;
    const ccomplex_t IT_0118 = IT_0038*IT_0101;
    const ccomplex_t IT_0119 = IT_0048*IT_0074*IT_0118;
    const ccomplex_t IT_0120 = IT_0052*IT_0107;
    const ccomplex_t IT_0121 = IT_0062*IT_0079*IT_0120;
    const ccomplex_t IT_0122 = IT_0086*IT_0113;
    ...
    const ccomplex_t IT_0126 = IT_0099 + IT_0105 + IT_0111 + -IT_0115 + 
      -IT_0117 + -IT_0119 + -IT_0121 + IT_0125;
    const ccomplex_t IT_0127 = m_c*s_13;
    const ccomplex_t IT_0128 = -IT_0098 + -IT_0104 + -IT_0110 + -IT_0124;
    const ccomplex_t IT_0129 = m_c*m_mu*IT_0019;
    ...
    const ccomplex_t IT_0136 = m_c*m_mu;
    const ccomplex_t IT_0137 = (-6)*conj(IT_0090);
    const ccomplex_t IT_0138 = (-6)*IT_0090;
    const ccomplex_t IT_0139 = -IT_0065;
    const ccomplex_t IT_0140 = 6*conj(IT_0065)*(IT_0090*IT_0091 + -IT_0126
      *IT_0127 + -IT_0128*IT_0129 + 0.166666666666667*IT_0065*IT_0134) + 6*conj
      (IT_0090)*(IT_0065*IT_0091 + 0.166666666666667*IT_0090*IT_0135) + (IT_0127
      *IT_0128 + IT_0126*IT_0136)*IT_0137 + 6*conj(IT_0126)*(IT_0091*IT_0128 +
       0.166666666666667*IT_0126*IT_0135 + 0.166666666666667*IT_0136*IT_0138 +
       IT_0127*IT_0139) + 6*conj(IT_0128)*(IT_0091*IT_0126 + 0.166666666666667
