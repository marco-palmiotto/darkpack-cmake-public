        ...
        )
{
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0075 = IT_0051*IT_0073*IT_0074;
    ...
    const ccomplex_t IT_0080 = IT_0048*IT_0078*IT_0079;
    ...
    const ccomplex_t IT_0119 = IT_0048*IT_0079*IT_0118;
    const ccomplex_t IT_0120 = IT_0086*IT_0113;
    ...
    const ccomplex_t IT_0124 = IT_0061*IT_0101;
    const ccomplex_t IT_0125 = IT_0051*IT_0074*IT_0124;
    const ccomplex_t IT_0126 = IT_0099 + IT_0105 + IT_0111 + -IT_0115 + 
      -IT_0117 + -IT_0119 + IT_0123 + -IT_0125;
    const ccomplex_t IT_0127 = m_c*s_13;
    const ccomplex_t IT_0128 = -IT_0098 + -IT_0104 + -IT_0110 + -IT_0122;
    ...
    const ccomplex_t IT_0135 = m_c*m_mu;
    const ccomplex_t IT_0136 = 6*s_34;
    const ccomplex_t IT_0137 = -conj(IT_0065);
    const ccomplex_t IT_0138 = (-6)*conj(IT_0090);
    const ccomplex_t IT_0139 = 6*IT_0065*(conj(IT_0090)*IT_0091 + -conj
      (IT_0126)*IT_0127 + -conj(IT_0128)*IT_0129 + 0.166666666666667*conj
      (IT_0065)*IT_0134) + (-6)*IT_0090*(IT_0127*conj(IT_0128) + conj(IT_0126)
      *IT_0135 + (-0.166666666666667)*conj(IT_0090)*IT_0136 + IT_0091*IT_0137) +
       6*IT_0128*(IT_0091*conj(IT_0126) + 0.166666666666667*conj(IT_0128)
      *IT_0134 + IT_0129*IT_0137 + 0.166666666666667*IT_0127*IT_0138) + 6
      *IT_0126*(IT_0091*conj(IT_0128) + 0.166666666666667*conj(IT_0126)*IT_0136 
