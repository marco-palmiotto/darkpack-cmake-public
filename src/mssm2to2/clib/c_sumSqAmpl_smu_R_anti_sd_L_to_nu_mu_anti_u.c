...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_sd_L_to_nu_mu_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm1*IT_0004;
    const ccomplex_t IT_0026 = IT_0006*IT_0025;
    const ccomplex_t IT_0027 = IT_0014*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*V_ud*e_em*U_Wm2*IT_0004;
    ...
    const ccomplex_t IT_0034 = m_u*s_13;
