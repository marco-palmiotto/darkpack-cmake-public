...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_sd_R_to_nu_mu_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    return create_ccomplex_return(IT_0022*conj(IT_0022)*(12*IT_0023 + (-6)
      *IT_0024));
}
