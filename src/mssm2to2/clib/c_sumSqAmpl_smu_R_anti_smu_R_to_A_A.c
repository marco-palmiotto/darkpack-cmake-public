        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_smu_R
    ...
    const ccomplex_t IT_0018 = cpow(IT_0010, 2);
    const ccomplex_t IT_0019 = (-0.5)*IT_0013 + (-0.5)*IT_0018;
    ...
    const ccomplex_t IT_0027 = (IT_0012 + -IT_0013)*IT_0017;
    ...
    const ccomplex_t IT_0033 = -(IT_0009 + IT_0017)*(IT_0012 + -IT_0018);
    const ccomplex_t IT_0034 = -IT_0033;
    const ccomplex_t IT_0035 = (-0.5)*IT_0034;
    const ccomplex_t IT_0036 = pow(s_13, 2);
    const ccomplex_t IT_0037 = IT_0012*IT_0017;
    ...
    const ccomplex_t IT_0044 = IT_0017*IT_0023;
    ...
    const ccomplex_t IT_0048 = pow(m_smu_R, 2);
    ...
    const ccomplex_t IT_0058 = pow(m_smu_R, 4);
