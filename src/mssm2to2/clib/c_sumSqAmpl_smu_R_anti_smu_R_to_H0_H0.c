...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_smu_L*
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0021*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*-1)*e_em*(IT_0003*IT_0008
      *IT_0015*IT_0016*IT_0017 + -m_W*IT_0002*IT_0011*(IT_0003*IT_0009 + IT_0005
      *IT_0027));
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*5)*m_W*e_em*IT_0039*(IT_0005*
      (IT_0004*IT_0027 + (-1)*IT_0005*(IT_0003*IT_0009 + 1./5*IT_0005*IT_0027)) 
      + 1./5*IT_0009*IT_0040);
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*-1)*m_W*e_em*IT_0039*(IT_0005*(
      (IT_0004 + -IT_0006)*IT_0009 + IT_0003*IT_0005*IT_0027) + -IT_0027*IT_0040);
