...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_Hp_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0001*IT_0002 +
       IT_0000*IT_0003)*IT_0004*IT_0009 + -IT_0003*IT_0005*IT_0010*IT_0011
      *IT_0012);
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0000*IT_0001 +
       -IT_0002*IT_0003)*IT_0004*IT_0009 + -IT_0001*IT_0005*IT_0010*IT_0011
      *IT_0012);
    const ccomplex_t IT_0022 = cpow((-2)*s_12 + (-2)*IT_0015 + m_H0*(m_H0 + (0
    ...
    return create_ccomplex_return(-IT_0026*conj(IT_0026)*(IT_0027 + -IT_0030));
}
