        ...
        )
{
    ...
    const ccomplex_t IT_0119 = (s_12 + -IT_0084)*(s_12 + -IT_0086);
    const ccomplex_t IT_0120 = IT_0047*IT_0055;
    const ccomplex_t IT_0121 = IT_0047*IT_0051;
    const ccomplex_t IT_0122 = -IT_0121;
    const ccomplex_t IT_0123 = IT_0120 + IT_0122;
    const ccomplex_t IT_0124 = IT_0046*IT_0123;
    const ccomplex_t IT_0125 = cpow(IT_0020, 2);
    const ccomplex_t IT_0126 = -IT_0125;
    const ccomplex_t IT_0127 = IT_0070 + IT_0126;
    const ccomplex_t IT_0128 = IT_0019*IT_0127;
    const ccomplex_t IT_0129 = IT_0124 + 0.5*IT_0128;
    const ccomplex_t IT_0130 = s_14*s_34*IT_0083;
    const ccomplex_t IT_0131 = (s_12 + -IT_0086)*(s_13 + -IT_0130);
    const ccomplex_t IT_0132 = pow(s_13, 2);
    const ccomplex_t IT_0133 = IT_0083*IT_0132;
    const ccomplex_t IT_0134 = -IT_0014;
    const ccomplex_t IT_0135 = pow(s_14, 2);
    const ccomplex_t IT_0136 = IT_0083*IT_0135;
    const ccomplex_t IT_0137 = (IT_0133 + IT_0134)*(IT_0134 + IT_0136);
    const ccomplex_t IT_0138 = s_13*s_14*s_34*IT_0067;
    const ccomplex_t IT_0139 = -IT_0138;
    const ccomplex_t IT_0140 = IT_0133 + IT_0134 + IT_0136 + IT_0139;
    const ccomplex_t IT_0141 = -IT_0066;
    const ccomplex_t IT_0142 = IT_0046*IT_0120;
    const ccomplex_t IT_0143 = IT_0019*IT_0125;
    const ccomplex_t IT_0144 = IT_0142 + (-0.5)*IT_0143;
    const ccomplex_t IT_0145 = s_34*IT_0083;
    const ccomplex_t IT_0146 = s_13*s_34*IT_0083;
    const ccomplex_t IT_0147 = -IT_0146;
    const ccomplex_t IT_0148 = s_14 + IT_0147;
    const ccomplex_t IT_0149 = IT_0145*IT_0148;
    const ccomplex_t IT_0150 = s_23*s_34*IT_0083;
    const ccomplex_t IT_0151 = -IT_0150;
    const ccomplex_t IT_0152 = s_24 + IT_0151;
    const ccomplex_t IT_0153 = IT_0145*IT_0152;
    const ccomplex_t IT_0154 = -conj(IT_0066);
    const ccomplex_t IT_0155 = -(IT_0014 + -IT_0113)*(IT_0014 + -IT_0136);
    const ccomplex_t IT_0156 = -IT_0155;
    const ccomplex_t IT_0157 = -(s_12 + -IT_0086)*(IT_0014 + -IT_0136);
    const ccomplex_t IT_0158 = -IT_0118;
    const ccomplex_t IT_0159 = -(s_12 + -IT_0084)*(IT_0014 + -IT_0133);
    const ccomplex_t IT_0160 = -(s_13 + -IT_0130)*(IT_0014 + -IT_0133);
    const ccomplex_t IT_0161 = -conj(IT_0118);
    const ccomplex_t IT_0162 = (s_12 + -IT_0084)*(IT_0014 + -IT_0113);
    const ccomplex_t IT_0163 = -IT_0162;
    const ccomplex_t IT_0164 = (IT_0014 + -IT_0113)*(s_13 + -IT_0130);
    const ccomplex_t IT_0165 = -IT_0164;
    const ccomplex_t IT_0166 = -conj(IT_0081);
    const ccomplex_t IT_0167 = s_24*s_34*IT_0083;
    const ccomplex_t IT_0168 = -(IT_0014 + -IT_0133)*(s_23 + -IT_0167);
    const ccomplex_t IT_0169 = (s_12 + -IT_0086)*(s_23 + -IT_0167);
    const ccomplex_t IT_0170 = pow(m_W, 2);
    const ccomplex_t IT_0171 = IT_0068*IT_0083;
    const ccomplex_t IT_0172 = (s_12 + -IT_0086)*(IT_0170 + -IT_0171);
    const ccomplex_t IT_0173 = -(IT_0014 + -IT_0133)*(IT_0170 + -IT_0171);
    const ccomplex_t IT_0174 = -IT_0144;
    const ccomplex_t IT_0175 = -(IT_0014 + -IT_0110)*(IT_0014 + -IT_0133);
    const ccomplex_t IT_0176 = -IT_0175;
    const ccomplex_t IT_0177 = (s_12 + -IT_0086)*(IT_0014 + -IT_0110);
    const ccomplex_t IT_0178 = -IT_0177;
    const ccomplex_t IT_0179 = -IT_0107;
    const ccomplex_t IT_0180 = (IT_0014 + -IT_0110)*(IT_0014 + -IT_0113);
    const ccomplex_t IT_0181 = -IT_0081;
    const ccomplex_t IT_0182 = (IT_0014 + -IT_0113)*(s_23 + -IT_0167);
    const ccomplex_t IT_0183 = -IT_0182;
    const ccomplex_t IT_0184 = -IT_0129;
    const ccomplex_t IT_0185 = (IT_0014 + -IT_0113)*(IT_0170 + -IT_0171);
    const ccomplex_t IT_0186 = -IT_0185;
    const ccomplex_t IT_0187 = 2*conj(IT_0066)*(IT_0066*(1 + 0.5*IT_0069) +
       0.5*IT_0081*IT_0089 + 0.5*IT_0098*IT_0100 + 0.5*IT_0107*IT_0115) + conj
      (IT_0118)*(IT_0107*IT_0119 + IT_0129*IT_0131 + IT_0118*IT_0137 + IT_0140
      *IT_0141) + (IT_0118*IT_0140 + IT_0144*IT_0149 + IT_0129*IT_0153)*IT_0154 
      + conj(IT_0081)*(IT_0066*IT_0089 + IT_0098*IT_0119 + IT_0131*IT_0144 +
       IT_0081*IT_0156 + IT_0157*IT_0158) + (IT_0081*IT_0157 + IT_0098*IT_0159 +
       IT_0144*IT_0160)*IT_0161 + (IT_0107*IT_0163 + IT_0129*IT_0165)*IT_0166 +
       conj(IT_0144)*(IT_0081*IT_0131 + IT_0141*IT_0149 + IT_0158*IT_0160 + 
      -IT_0098*IT_0168 + IT_0107*IT_0169 + IT_0129*IT_0172 + IT_0173*IT_0174) +
       conj(IT_0098)*(IT_0066*IT_0100 + IT_0081*IT_0119 + IT_0158*IT_0159 +
       IT_0129*IT_0169 + IT_0168*IT_0174 + IT_0098*IT_0176 + IT_0178*IT_0179) +
       conj(IT_0107)*(IT_0066*IT_0115 + IT_0118*IT_0119 + IT_0144*IT_0169 + 
      -IT_0098*IT_0178 + IT_0107*IT_0180 + IT_0163*IT_0181 + IT_0183*IT_0184) +
       conj(IT_0129)*(IT_0118*IT_0131 + IT_0141*IT_0153 + IT_0098*IT_0169 +
       IT_0144*IT_0172 + IT_0165*IT_0181 + IT_0179*IT_0183 + IT_0184*IT_0186);
