...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*m_d*e_em*IT_0000*IT_0002
      *IT_0005*IT_0011;
    ...
    const ccomplex_t IT_0050 = m_d*IT_0049;
    const ccomplex_t IT_0051 = -IT_0030;
    const ccomplex_t IT_0052 = m_d*IT_0051;
    const ccomplex_t IT_0053 = m_d*IT_0031;
    ...
    const ccomplex_t IT_0079 = m_d*s_14;
    const ccomplex_t IT_0080 = (-6)*IT_0042;
    const ccomplex_t IT_0081 = m_d*s_13;
