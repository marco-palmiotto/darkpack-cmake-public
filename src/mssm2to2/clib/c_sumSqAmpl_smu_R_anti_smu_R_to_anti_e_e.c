...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_anti_e_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = m_e*IT_0004;
    const ccomplex_t IT_0006 = (-2)*IT_0003;
    const ccomplex_t IT_0007 = m_e*IT_0006;
    ...
    const ccomplex_t IT_0040 = cpow((-2)*s_12 + (-2)*IT_0015 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*m_e*e_em*IT_0010*IT_0028
      *IT_0030*IT_0036;
    const ccomplex_t IT_0044 = 0.5*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0034*
      (IT_0031*IT_0035 + IT_0029*IT_0036) + -IT_0010*IT_0028*IT_0030*IT_0036
      *IT_0037);
    ...
    const ccomplex_t IT_0062 = IT_0055 + IT_0057 + IT_0061;
    ...
    const ccomplex_t IT_0083 = m_e*s_14;
