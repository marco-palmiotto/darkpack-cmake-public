...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0053 = m_s*IT_0031;
    ...
    const ccomplex_t IT_0071 = IT_0016*IT_0028;
    const ccomplex_t IT_0072 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0079 = m_s*s_14;
    const ccomplex_t IT_0080 = (-6)*IT_0042;
    const ccomplex_t IT_0081 = m_s*s_13;
