...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow(IT_0012, -1);
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*e_em*(m_W*IT_0006*IT_0011*
      (IT_0003*IT_0004 + IT_0012*IT_0013) + -IT_0002*IT_0007*IT_0013*IT_0014
      *IT_0015);
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(m_W*IT_0006*IT_0011*
      (IT_0003*IT_0012 + -IT_0004*IT_0013) + -IT_0002*IT_0003*IT_0007*IT_0014
      *IT_0015);
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*m_u*e_em*IT_0002*IT_0005
      *IT_0007*IT_0013;
    ...
    const ccomplex_t IT_0030 = cpow(IT_0010, -1);
    ...
    const ccomplex_t IT_0035 = IT_0007*IT_0010;
    ...
    const ccomplex_t IT_0054 = m_u*IT_0032;
    ...
    const ccomplex_t IT_0067 = cpow(s_12 + IT_0000 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = 0.5*IT_0069;
    const ccomplex_t IT_0071 = s_13*s_14;
    const ccomplex_t IT_0072 = IT_0000*IT_0029;
    const ccomplex_t IT_0073 = s_34*IT_0000;
    ...
    const ccomplex_t IT_0080 = m_u*s_14;
    const ccomplex_t IT_0081 = (-6)*IT_0043;
    const ccomplex_t IT_0082 = m_u*s_13;
