...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_h_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0000
      *IT_0002*IT_0006*IT_0007;
    ...
    const ccomplex_t IT_0042 = (-0.5)*IT_0003;
    const ccomplex_t IT_0043 = IT_0009*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = IT_0015 + IT_0041 + IT_0046;
    return create_ccomplex_return(IT_0047*conj(IT_0047));
}
