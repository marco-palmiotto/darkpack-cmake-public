...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0025 + IT_0043 + -m_smu_L*
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0025 + IT_0043 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
