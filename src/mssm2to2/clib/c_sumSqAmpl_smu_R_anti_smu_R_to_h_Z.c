...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = cpow(IT_0010, -1);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*(IT_0006
      *IT_0008 + IT_0010*IT_0011)*IT_0016 + -IT_0011*IT_0017*IT_0035*IT_0036
      *IT_0037);
