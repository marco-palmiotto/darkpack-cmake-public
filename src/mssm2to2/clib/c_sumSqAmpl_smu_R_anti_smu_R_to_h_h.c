...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_smu_R_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_smu_L*
      (m_smu_L + (0 + _Complex_I*-1)*Gamma_ml) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0021*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*-1)*e_em*(IT_0003*IT_0008
    ...
    const ccomplex_t IT_0040 = cpow(IT_0005, 3);
    const ccomplex_t IT_0041 = (0 + _Complex_I*-5)*m_W*e_em*IT_0039*(IT_0003*(
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_W*e_em*IT_0039*(IT_0003*
