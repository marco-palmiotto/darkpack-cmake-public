...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_snu_e_to_anti_nu_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0031 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0045 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0059 = cpow(s_23 + (-0.5)*IT_0016 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0008*IT_0061*IT_0063;
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0008*IT_0061*IT_0063;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0008*IT_0061*IT_0063;
    ...
    const ccomplex_t IT_0088 = 0.5*IT_0018 + 0.5*IT_0032 + 0.5*IT_0046 + 0.5
      *IT_0060 + (-0.5)*IT_0069 + (-0.5)*IT_0075 + (-0.5)*IT_0081 + (-0.5)
      *IT_0087;
    const ccomplex_t IT_0089 = 0.5*IT_0068 + 0.5*IT_0074 + 0.5*IT_0080 + 0.5
      *IT_0086;
    const ccomplex_t IT_0090 = m_mu*s_13;
    const ccomplex_t IT_0091 = s_13*s_14;
    const ccomplex_t IT_0092 = pow(m_smu_R, 2);
    const ccomplex_t IT_0093 = s_34*IT_0092;
    return create_ccomplex_return(2*IT_0088*(s_34*conj(IT_0088) + conj(IT_0089
      )*IT_0090) + 2*IT_0089*(conj(IT_0088)*IT_0090 + 2*conj(IT_0089)*(IT_0091 +
       (-0.5)*IT_0093)));
}
