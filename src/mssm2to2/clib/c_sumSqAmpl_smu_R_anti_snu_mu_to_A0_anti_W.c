...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_snu_mu_to_A0_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = e_em*m_mu*mu_h*IT_0001*IT_0004;
    const ccomplex_t IT_0006 = (-0.5)*IT_0005;
    const ccomplex_t IT_0007 = pow(m_A0, 2);
    const ccomplex_t IT_0008 = pow(m_smu_R, 2);
    const ccomplex_t IT_0009 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_smu_L*
