...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_snu_mu_to_H0_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0004*IT_0012;
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0004
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0018 + IT_0043 + -m_smu_L*
