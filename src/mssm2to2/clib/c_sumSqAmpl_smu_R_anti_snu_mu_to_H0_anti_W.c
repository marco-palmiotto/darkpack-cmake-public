...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_snu_mu_to_H0_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0003
      *IT_0005*IT_0007*IT_0018;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = pow(m_H0, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0010 + IT_0030 + -m_smu_L*
