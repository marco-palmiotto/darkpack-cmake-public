...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_snu_mu_to_anti_t_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0000*IT_0002;
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0000*IT_0002*IT_0006*IT_0007;
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0000*IT_0002;
