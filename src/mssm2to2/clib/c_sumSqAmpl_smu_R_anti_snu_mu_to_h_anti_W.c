...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_snu_mu_to_h_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0005*IT_0008;
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu*mu_h
      *IT_0002*IT_0005*IT_0008*IT_0019;
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005;
    const ccomplex_t IT_0028 = -IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*m_mu*mu_h*IT_0001
      *IT_0005*IT_0008*IT_0019;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = pow(m_h, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0011 + IT_0031 + -m_smu_L*
    ...
    const ccomplex_t IT_0036 = -IT_0016 + -IT_0026 + IT_0035;
    const ccomplex_t IT_0037 = pow(m_W, -2);
    const ccomplex_t IT_0038 = pow(s_24, 2);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = -IT_0016 + -IT_0026;
    const ccomplex_t IT_0041 = s_14*s_24*IT_0037;
    const ccomplex_t IT_0042 = -IT_0041;
    const ccomplex_t IT_0043 = pow(s_14, 2);
    const ccomplex_t IT_0044 = IT_0037*IT_0043;
    return create_ccomplex_return(-IT_0036*(conj(IT_0036)*(IT_0012 + -IT_0039)
       + conj(IT_0040)*(s_12 + IT_0042)) + -IT_0040*(conj(IT_0036)*(s_12 +
       IT_0042) + conj(IT_0040)*(IT_0011 + -IT_0044)));
}
