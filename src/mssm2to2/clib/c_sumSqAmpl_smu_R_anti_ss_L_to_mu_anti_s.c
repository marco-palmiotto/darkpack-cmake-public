        ...
        )
{
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0134 = m_s*m_mu;
