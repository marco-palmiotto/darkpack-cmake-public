...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_ss_L_to_mu_anti_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0125 = m_s*s_13;
    const ccomplex_t IT_0126 = -IT_0096 + -IT_0110 + -IT_0116 + -IT_0120;
    const ccomplex_t IT_0127 = m_s*m_mu*IT_0019;
    ...
    const ccomplex_t IT_0133 = m_s*m_mu;
