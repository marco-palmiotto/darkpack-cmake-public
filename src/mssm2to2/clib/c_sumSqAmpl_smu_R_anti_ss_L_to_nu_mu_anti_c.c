...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_ss_L_to_nu_mu_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *conj(V_u1)*e_em*IT_0000*IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0017 = (-0.5)*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *conj(V_u2)*e_em*IT_0000*IT_0004*IT_0008;
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*conj(V_cs)*e_em*U_Wm1*IT_0004;
    const ccomplex_t IT_0026 = IT_0006*IT_0025;
    const ccomplex_t IT_0027 = IT_0014*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*conj(V_cs)*e_em*U_Wm2*IT_0004;
    ...
    const ccomplex_t IT_0034 = m_c*s_13;
    const ccomplex_t IT_0035 = s_13*s_14;
    const ccomplex_t IT_0036 = s_34*IT_0013;
    return create_ccomplex_return(6*IT_0024*(s_34*conj(IT_0024) + -conj
      (IT_0033)*IT_0034) + (-6)*IT_0033*(conj(IT_0024)*IT_0034 + (
      -0.166666666666667)*conj(IT_0033)*(12*IT_0035 + (-6)*IT_0036)));
}
