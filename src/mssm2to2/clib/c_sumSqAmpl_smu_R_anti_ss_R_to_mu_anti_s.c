        ...
        )
{
    ...
    const ccomplex_t IT_0062 = m_mu*IT_0014;
    const ccomplex_t IT_0063 = m_mu*IT_0022;
    const ccomplex_t IT_0064 = m_mu*IT_0030;
    const ccomplex_t IT_0065 = m_mu*IT_0038;
    ...
    const ccomplex_t IT_0109 = m_s*m_mu;
