        ...
        )
{
    ...
    const ccomplex_t IT_0117 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0118 = IT_0008*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = m_t*conj(N_u4)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0126 = IT_0077*IT_0099*IT_0125;
    const ccomplex_t IT_0127 = conj(N_B2)*e_em*conj(U_st_10);
    const ccomplex_t IT_0128 = IT_0008*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_t*conj(N_u2)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0137 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0138 = IT_0008*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = m_t*conj(N_u3)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0146 = IT_0060*IT_0094*IT_0145;
    ...
    const ccomplex_t IT_0155 = IT_0092*IT_0144;
    ...
    const ccomplex_t IT_0159 = IT_0097*IT_0124;
