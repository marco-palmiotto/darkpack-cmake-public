...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_st_2_to_mu_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0107 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0108 = IT_0008*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = m_t*conj(N_u3)*e_em*IT_0000*conj(U_st_01);
    ...
    const ccomplex_t IT_0116 = IT_0060*IT_0094*IT_0115;
    const ccomplex_t IT_0117 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0118 = IT_0008*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = m_t*conj(N_u1)*e_em*IT_0000*conj(U_st_01);
    ...
    const ccomplex_t IT_0126 = IT_0026*IT_0084*IT_0125;
    ...
    const ccomplex_t IT_0130 = m_t*conj(N_u2)*e_em*IT_0000*conj(U_st_01);
    ...
    const ccomplex_t IT_0136 = IT_0043*IT_0089*IT_0135;
    ...
    const ccomplex_t IT_0147 = IT_0082*IT_0124;
    ...
    const ccomplex_t IT_0151 = IT_0087*IT_0134;
    ...
    const ccomplex_t IT_0155 = IT_0092*IT_0114;
