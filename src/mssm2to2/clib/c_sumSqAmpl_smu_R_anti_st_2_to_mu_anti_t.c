        ...
        )
{
    ...
    const ccomplex_t IT_0054 = m_t*N_u4*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0070 = m_t*N_u3*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0107 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0108 = IT_0008*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = m_t*conj(N_u2)*e_em*IT_0000*conj(U_st_01);
    ...
    const ccomplex_t IT_0116 = IT_0043*IT_0089*IT_0115;
    ...
    const ccomplex_t IT_0130 = m_t*conj(N_u4)*e_em*IT_0000*conj(U_st_01);
    ...
    const ccomplex_t IT_0137 = IT_0082*IT_0124;
    ...
    const ccomplex_t IT_0141 = IT_0087*IT_0114;
    ...
    const ccomplex_t IT_0145 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0146 = IT_0008*IT_0145;
    const ccomplex_t IT_0147 = 1.4142135623731*IT_0146;
    const ccomplex_t IT_0148 = m_t*conj(N_u3)*e_em*IT_0000*conj(U_st_01);
