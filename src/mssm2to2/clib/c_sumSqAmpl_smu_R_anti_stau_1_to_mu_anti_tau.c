...
ccomplex_return_t c_sumSqAmpl_smu_R_anti_stau_1_to_mu_anti_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0125 = conj(N_B4)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0126 = IT_0008*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = conj(N_d4)*e_em*m_tau*IT_0000*conj(U_stau_00);
    ...
    const ccomplex_t IT_0143 = conj(N_B3)*e_em*conj(U_stau_10);
    const ccomplex_t IT_0144 = IT_0008*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = conj(N_d3)*e_em*m_tau*IT_0000*conj(U_stau_00);
