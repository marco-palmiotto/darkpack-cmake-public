        ...
        )
{
    ...
    const ccomplex_t IT_0013 = m_b*conj(N_d1)*e_em*IT_0012*U_sb_10;
    ...
    const ccomplex_t IT_0031 = m_b*conj(N_d3)*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0032 = IT_0011*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0035 = IT_0010*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0004;
    const ccomplex_t IT_0048 = -IT_0047;
    const ccomplex_t IT_0049 = m_b*conj(N_d4)*e_em*IT_0012*U_sb_10;
    const ccomplex_t IT_0050 = IT_0011*IT_0049;
    const ccomplex_t IT_0051 = 1.4142135623731*IT_0050;
    const ccomplex_t IT_0052 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0053 = IT_0010*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*IT_0053;
    const ccomplex_t IT_0055 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0008*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0109 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0110 = IT_0004*IT_0109;
    const ccomplex_t IT_0111 = 1.4142135623731*IT_0110;
    const ccomplex_t IT_0112 = m_b*N_d2*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0008*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0008*IT_0010*IT_0012;
    ...
    const ccomplex_t IT_0127 = m_b*N_d4*e_em*IT_0012*U_sb_00;
    ...
    const ccomplex_t IT_0144 = IT_0042*IT_0084;
    const ccomplex_t IT_0145 = IT_0028*IT_0143*IT_0144;
    const ccomplex_t IT_0146 = m_mu*IT_0027;
    const ccomplex_t IT_0147 = m_mu*IT_0045;
    const ccomplex_t IT_0148 = m_mu*IT_0063;
    const ccomplex_t IT_0149 = m_mu*IT_0081;
    const ccomplex_t IT_0150 = IT_0145 + -IT_0146 + -IT_0147 + -IT_0148 + 
      -IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0152 = IT_0060*IT_0123;
    const ccomplex_t IT_0153 = IT_0046*IT_0151*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0155 = IT_0024*IT_0097;
    const ccomplex_t IT_0156 = IT_0002*IT_0154*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0158 = IT_0076*IT_0118;
    const ccomplex_t IT_0159 = IT_0064*IT_0157*IT_0158;
    ...
    const ccomplex_t IT_0164 = IT_0048*IT_0131;
    const ccomplex_t IT_0165 = IT_0046*IT_0151*IT_0164;
    const ccomplex_t IT_0166 = m_mu*IT_0108;
    const ccomplex_t IT_0167 = m_mu*IT_0095;
    const ccomplex_t IT_0168 = IT_0006*IT_0105;
    const ccomplex_t IT_0169 = IT_0002*IT_0154*IT_0168;
    const ccomplex_t IT_0170 = m_mu*IT_0121;
    const ccomplex_t IT_0171 = m_mu*IT_0134;
    const ccomplex_t IT_0172 = IT_0165 + -IT_0166 + -IT_0167 + IT_0169 + 
      -IT_0170 + -IT_0171;
    const ccomplex_t IT_0173 = 6*IT_0172;
    const ccomplex_t IT_0174 = IT_0078*IT_0116;
    const ccomplex_t IT_0175 = IT_0064*IT_0157*IT_0174;
    const ccomplex_t IT_0176 = IT_0030*IT_0092;
    const ccomplex_t IT_0177 = IT_0028*IT_0143*IT_0176;
