        ...
        )
{
    ...
    const ccomplex_t IT_0123 = IT_0006*IT_0069;
    ...
    const ccomplex_t IT_0129 = m_mu*IT_0093;
    const ccomplex_t IT_0130 = m_mu*IT_0079;
