        ...
        )
{
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0008;
    const ccomplex_t IT_0027 = -IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0056 = (-0.333333333333333)*IT_0026;
    ...
    const ccomplex_t IT_0084 = m_mu*IT_0016;
    const ccomplex_t IT_0085 = m_mu*IT_0024;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0087 = IT_0029*IT_0055;
    const ccomplex_t IT_0088 = IT_0025*IT_0086*IT_0087;
    const ccomplex_t IT_0089 = m_mu*IT_0032;
    const ccomplex_t IT_0090 = m_mu*IT_0040;
    const ccomplex_t IT_0091 = -IT_0084 + -IT_0085 + IT_0088 + -IT_0089 + 
      -IT_0090;
    ...
    const ccomplex_t IT_0099 = m_mu*IT_0047;
    const ccomplex_t IT_0100 = m_mu*IT_0053;
    const ccomplex_t IT_0101 = m_mu*IT_0059;
    ...
    const ccomplex_t IT_0107 = IT_0027*IT_0056;
    const ccomplex_t IT_0108 = IT_0025*IT_0086*IT_0107;
    ...
    const ccomplex_t IT_0122 = m_d*m_mu;
