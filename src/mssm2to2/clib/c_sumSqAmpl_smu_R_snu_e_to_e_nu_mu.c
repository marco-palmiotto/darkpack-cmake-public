...
ccomplex_return_t c_sumSqAmpl_smu_R_snu_e_to_e_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = m_e*s_24;
    const ccomplex_t IT_0035 = s_23*s_24;
    const ccomplex_t IT_0036 = s_34*IT_0011;
    const ccomplex_t IT_0037 = (-2)*s_34;
    const ccomplex_t IT_0038 = 2*s_34*(IT_0021*conj(IT_0021) + IT_0033*conj
      (IT_0033)) + 2*(conj(IT_0032)*(IT_0021 + -IT_0033) + IT_0032*(conj(IT_0021
      ) + -conj(IT_0033)))*IT_0034 + 4*IT_0032*conj(IT_0032)*(IT_0035 + (-0.5)
