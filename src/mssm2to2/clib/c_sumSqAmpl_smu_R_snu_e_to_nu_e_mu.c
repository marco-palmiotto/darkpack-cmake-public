        ...
        )
{
    ...
    const ccomplex_t IT_0035 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0049 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0047*IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0052 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0091 = 2*s_34*(IT_0022*conj(IT_0022) + IT_0065*conj
      (IT_0065)) + 2*((conj(IT_0022) + -conj(IT_0065))*IT_0086 + (IT_0022 + 
      -IT_0065)*conj(IT_0086))*IT_0087 + 4*IT_0086*conj(IT_0086)*(IT_0088 + (
      -0.5)*IT_0089) + (conj(IT_0022)*IT_0065 + IT_0022*conj(IT_0065))*IT_0090;
