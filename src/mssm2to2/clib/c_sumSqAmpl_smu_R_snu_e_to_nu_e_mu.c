...
ccomplex_return_t c_sumSqAmpl_smu_R_snu_e_to_nu_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0048 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0062 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_N_1*(m_N_1 +
       (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0060*IT_0061*IT_0062;
    const ccomplex_t IT_0064 = (-0.5)*IT_0021 + (-0.5)*IT_0035 + (-0.5)
      *IT_0049 + (-0.5)*IT_0063;
    ...
    const ccomplex_t IT_0085 = 0.5*IT_0069 + 0.5*IT_0074 + 0.5*IT_0079 + 0.5
      *IT_0084;
    const ccomplex_t IT_0086 = m_mu*s_23;
    const ccomplex_t IT_0087 = s_23*s_24;
    const ccomplex_t IT_0088 = s_34*IT_0019;
    return create_ccomplex_return(2*IT_0064*(s_34*conj(IT_0064) + conj(IT_0085
      )*IT_0086) + 2*IT_0085*(conj(IT_0064)*IT_0086 + 2*conj(IT_0085)*(IT_0087 +
       (-0.5)*IT_0088)));
}
