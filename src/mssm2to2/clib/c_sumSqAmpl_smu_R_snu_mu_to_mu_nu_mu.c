...
ccomplex_return_t c_sumSqAmpl_smu_R_snu_mu_to_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_13 + IT_0010 + IT_0035 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0033*IT_0034*IT_0036;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = IT_0045*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0050 = cpow((-2)*s_13 + IT_0010 + IT_0035 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0048*IT_0049*IT_0050;
    const ccomplex_t IT_0052 = IT_0013 + IT_0020 + IT_0037 + IT_0051;
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = IT_0060*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0065 = cpow((-2)*s_13 + IT_0010 + IT_0035 + -m_N_1*
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0076 = 0.5*IT_0075;
    const ccomplex_t IT_0077 = IT_0074*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0010 + IT_0035 + -m_N_4*
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0093 = -IT_0066 + -IT_0080 + IT_0086 + IT_0092;
    const ccomplex_t IT_0094 = s_23*s_24;
    const ccomplex_t IT_0095 = s_34*IT_0011;
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0022;
    ...
    const ccomplex_t IT_0119 = IT_0085 + IT_0091;
    const ccomplex_t IT_0120 = IT_0118 + IT_0119;
    const ccomplex_t IT_0121 = conj(IT_0118) + conj(IT_0119);
    const ccomplex_t IT_0122 = (-2)*s_34;
    const ccomplex_t IT_0123 = m_mu*s_24;
    const ccomplex_t IT_0124 = 2*IT_0052;
    const ccomplex_t IT_0125 = (-2)*IT_0093;
    const ccomplex_t IT_0126 = 2*conj(IT_0052);
    const ccomplex_t IT_0127 = (-2)*conj(IT_0093);
    const ccomplex_t IT_0128 = 2*s_34*(IT_0052*conj(IT_0052) + IT_0093*conj
      (IT_0093)) + 4*IT_0097*IT_0120*IT_0121 + (conj(IT_0052)*IT_0093 + IT_0052
      *conj(IT_0093))*IT_0122 + IT_0123*(IT_0121*(IT_0124 + IT_0125) + IT_0120*
      (IT_0126 + IT_0127));
