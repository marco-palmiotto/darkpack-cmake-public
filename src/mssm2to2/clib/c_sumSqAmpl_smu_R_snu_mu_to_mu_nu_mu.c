        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0052 = (-0.5)*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = IT_0052*IT_0054;
    const ccomplex_t IT_0056 = pow(m_snu_mu, 2);
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0019 + IT_0056 + -m_C_1*
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = IT_0062*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_23 + IT_0019 + IT_0056 + -m_C_2*
    ...
    const ccomplex_t IT_0070 = -IT_0022 + -IT_0036 + -IT_0050 + IT_0060 +
       IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0006;
    const ccomplex_t IT_0072 = IT_0052*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0074 = IT_0057*IT_0072*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0006;
    const ccomplex_t IT_0076 = IT_0062*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0078 = IT_0066*IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0092 = IT_0079*IT_0080*IT_0091;
    const ccomplex_t IT_0093 = IT_0074 + IT_0078 + IT_0092;
    const ccomplex_t IT_0094 = s_23*s_24;
    const ccomplex_t IT_0095 = s_34*IT_0056;
    const ccomplex_t IT_0096 = (-0.5)*IT_0095;
    const ccomplex_t IT_0097 = IT_0094 + IT_0096;
    const ccomplex_t IT_0098 = IT_0059 + IT_0068;
    ...
    const ccomplex_t IT_0114 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0001;
    const ccomplex_t IT_0115 = -IT_0114;
    const ccomplex_t IT_0116 = IT_0090*IT_0115;
    const ccomplex_t IT_0117 = IT_0080*IT_0116;
    ...
    const ccomplex_t IT_0121 = conj(IT_0098) + conj(IT_0119);
    const ccomplex_t IT_0122 = (-2)*s_34;
    const ccomplex_t IT_0123 = m_mu*s_24;
    const ccomplex_t IT_0124 = 2*IT_0093;
    const ccomplex_t IT_0125 = (-2)*IT_0070;
    const ccomplex_t IT_0126 = 2*conj(IT_0093);
    const ccomplex_t IT_0127 = (-2)*conj(IT_0070);
    const ccomplex_t IT_0128 = 2*s_34*(IT_0070*conj(IT_0070) + IT_0093*conj
      (IT_0093)) + 4*IT_0097*IT_0120*IT_0121 + (conj(IT_0070)*IT_0093 + IT_0070
