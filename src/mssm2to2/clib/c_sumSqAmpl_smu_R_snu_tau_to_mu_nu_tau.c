...
ccomplex_return_t c_sumSqAmpl_smu_R_snu_tau_to_mu_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0051 = -IT_0022 + -IT_0036 + -IT_0050;
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_N_3*
    ...
    const ccomplex_t IT_0092 = 2*s_34*(IT_0051*conj(IT_0051) + IT_0065*conj
      (IT_0065)) + (-2)*((conj(IT_0051) + -conj(IT_0065))*IT_0086 + (IT_0051 + 
      -IT_0065)*conj(IT_0086))*IT_0087 + 4*IT_0086*conj(IT_0086)*(IT_0088 + (
      -0.5)*IT_0090) + (conj(IT_0051)*IT_0065 + IT_0051*conj(IT_0065))*IT_0091;
