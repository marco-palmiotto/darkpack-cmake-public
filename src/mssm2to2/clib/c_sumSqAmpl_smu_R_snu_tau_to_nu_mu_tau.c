        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
      *m_tau*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0040 = 2*s_34*(IT_0020*conj(IT_0020) + IT_0033*conj
      (IT_0033)) + 2*((conj(IT_0020) + -conj(IT_0033))*IT_0034 + (IT_0020 + 
      -IT_0033)*conj(IT_0034))*IT_0035 + 4*IT_0034*conj(IT_0034)*(IT_0036 + (
      -0.5)*IT_0038) + (conj(IT_0020)*IT_0033 + IT_0020*conj(IT_0033))*IT_0039;
