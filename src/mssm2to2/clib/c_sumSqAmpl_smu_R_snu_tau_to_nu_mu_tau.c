...
ccomplex_return_t c_sumSqAmpl_smu_R_snu_tau_to_nu_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
      *m_tau*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0004;
    const ccomplex_t IT_0026 = IT_0006*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0028 = IT_0011*IT_0026*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0004;
    const ccomplex_t IT_0030 = IT_0015*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0032 = IT_0019*IT_0030*IT_0031;
    const ccomplex_t IT_0033 = 0.5*IT_0028 + 0.5*IT_0032;
    const ccomplex_t IT_0034 = 0.5*IT_0013 + 0.5*IT_0021;
    ...
    const ccomplex_t IT_0040 = 2*s_34*(IT_0024*conj(IT_0024) + IT_0033*conj
      (IT_0033)) + (-2)*((conj(IT_0024) + -conj(IT_0033))*IT_0034 + (IT_0024 + 
      -IT_0033)*conj(IT_0034))*IT_0035 + 4*IT_0034*conj(IT_0034)*(IT_0036 + (
      -0.5)*IT_0038) + (conj(IT_0024)*IT_0033 + IT_0024*conj(IT_0033))*IT_0039;
