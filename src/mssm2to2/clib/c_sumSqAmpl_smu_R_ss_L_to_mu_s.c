        ...
        )
{
    ...
    const ccomplex_t IT_0012 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0013 = IT_0009*IT_0012;
    const ccomplex_t IT_0014 = (0 + _Complex_I*1)*IT_0013;
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0016 = 0.5*IT_0015;
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0018 = (-0.5)*IT_0017;
    const ccomplex_t IT_0019 = IT_0016*IT_0018;
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0019*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0024 = 0.5*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0026 = (-0.5)*IT_0025;
    const ccomplex_t IT_0027 = IT_0024*IT_0026;
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_N_4*
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_N_1*
    ...
    const ccomplex_t IT_0102 = m_mu*s_24;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0104 = IT_0032*IT_0088;
    const ccomplex_t IT_0105 = IT_0036*IT_0103*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0107 = IT_0016*IT_0062;
    const ccomplex_t IT_0108 = IT_0020*IT_0106*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0110 = IT_0024*IT_0075;
    const ccomplex_t IT_0111 = IT_0028*IT_0109*IT_0110;
    const ccomplex_t IT_0112 = -IT_0105 + -IT_0108 + -IT_0111;
    const ccomplex_t IT_0113 = m_s*IT_0014;
    const ccomplex_t IT_0114 = m_s*IT_0022;
    const ccomplex_t IT_0115 = m_s*IT_0030;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0117 = IT_0006*IT_0049;
    const ccomplex_t IT_0118 = IT_0012*IT_0116*IT_0117;
    const ccomplex_t IT_0119 = m_s*IT_0038;
    ...
    const ccomplex_t IT_0125 = IT_0020*IT_0106*IT_0124;
    const ccomplex_t IT_0126 = m_s*IT_0054;
    const ccomplex_t IT_0127 = m_s*IT_0067;
    const ccomplex_t IT_0128 = m_s*IT_0093;
    const ccomplex_t IT_0129 = m_s*IT_0080;
    const ccomplex_t IT_0130 = IT_0125 + -IT_0126 + -IT_0127 + -IT_0128 + 
      -IT_0129;
    const ccomplex_t IT_0131 = 6*IT_0130;
    const ccomplex_t IT_0132 = IT_0008*IT_0051;
    const ccomplex_t IT_0133 = IT_0012*IT_0116*IT_0132;
    const ccomplex_t IT_0134 = IT_0026*IT_0077;
    const ccomplex_t IT_0135 = IT_0028*IT_0109*IT_0134;
    const ccomplex_t IT_0136 = IT_0034*IT_0090;
    const ccomplex_t IT_0137 = IT_0036*IT_0103*IT_0136;
    ...
    const ccomplex_t IT_0151 = m_s*s_23;
    const ccomplex_t IT_0152 = 6*s_34;
    const ccomplex_t IT_0153 = (-6)*s_34;
    const ccomplex_t IT_0154 = (-6)*conj(IT_0039)*(IT_0094*IT_0096 + (
      -0.166666666666667)*IT_0039*IT_0101) + (-6)*conj(IT_0094)*(IT_0039*IT_0096
       + (-0.166666666666667)*IT_0094*IT_0101) + (-6)*IT_0102*(conj(IT_0094)
      *IT_0121 + IT_0094*IT_0123 + (-0.166666666666667)*conj(IT_0039)*IT_0140 + 
      (-0.166666666666667)*IT_0039*IT_0143) + IT_0144*(conj(IT_0112)*IT_0140 +
       IT_0112*IT_0143 + conj(IT_0120)*IT_0147 + IT_0120*IT_0150) + 6*(conj
      (IT_0039)*IT_0121 + IT_0039*IT_0123 + 0.166666666666667*conj(IT_0094)
      *IT_0147 + 0.166666666666667*IT_0094*IT_0150)*IT_0151 + (IT_0112*conj
