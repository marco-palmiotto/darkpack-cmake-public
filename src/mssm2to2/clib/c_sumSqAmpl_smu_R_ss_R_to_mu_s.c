...
ccomplex_return_t c_sumSqAmpl_smu_R_ss_R_to_mu_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0068 = m_s*m_mu*IT_0067;
    ...
    const ccomplex_t IT_0074 = m_s*s_23;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0076 = IT_0006*IT_0043;
    const ccomplex_t IT_0077 = IT_0014*IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0079 = IT_0018*IT_0049;
    const ccomplex_t IT_0080 = IT_0022*IT_0078*IT_0079;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0082 = IT_0034*IT_0061;
    const ccomplex_t IT_0083 = IT_0038*IT_0081*IT_0082;
    const ccomplex_t IT_0084 = -IT_0077 + -IT_0080 + -IT_0083;
    const ccomplex_t IT_0085 = m_s*IT_0016;
    const ccomplex_t IT_0086 = m_s*IT_0024;
    const ccomplex_t IT_0087 = m_s*IT_0032;
    const ccomplex_t IT_0088 = m_s*IT_0040;
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0090 = IT_0026*IT_0056;
    const ccomplex_t IT_0091 = IT_0030*IT_0089*IT_0090;
    const ccomplex_t IT_0092 = -IT_0085 + -IT_0086 + -IT_0087 + -IT_0088 +
       IT_0091;
    const ccomplex_t IT_0093 = IT_0084 + -IT_0092;
    const ccomplex_t IT_0094 = -conj(IT_0092);
    const ccomplex_t IT_0095 = conj(IT_0084) + IT_0094;
    const ccomplex_t IT_0096 = IT_0020*IT_0050;
    const ccomplex_t IT_0097 = IT_0022*IT_0078*IT_0096;
    const ccomplex_t IT_0098 = IT_0028*IT_0054;
    const ccomplex_t IT_0099 = IT_0030*IT_0089*IT_0098;
    const ccomplex_t IT_0100 = -IT_0097 + -IT_0099;
    const ccomplex_t IT_0101 = 6*IT_0100;
    const ccomplex_t IT_0102 = IT_0010*IT_0044;
    const ccomplex_t IT_0103 = IT_0014*IT_0075*IT_0102;
    const ccomplex_t IT_0104 = IT_0036*IT_0062;
    const ccomplex_t IT_0105 = IT_0038*IT_0081*IT_0104;
    const ccomplex_t IT_0106 = m_s*IT_0047;
    const ccomplex_t IT_0107 = m_s*IT_0053;
    const ccomplex_t IT_0108 = m_s*IT_0059;
    const ccomplex_t IT_0109 = m_s*IT_0065;
    const ccomplex_t IT_0110 = IT_0103 + IT_0105 + -IT_0106 + -IT_0107 + 
      -IT_0108 + -IT_0109;
    const ccomplex_t IT_0111 = (-6)*IT_0110;
    const ccomplex_t IT_0112 = IT_0101 + IT_0111;
    const ccomplex_t IT_0113 = 6*conj(IT_0100);
    const ccomplex_t IT_0114 = (-6)*conj(IT_0110);
    const ccomplex_t IT_0115 = IT_0113 + IT_0114;
    const ccomplex_t IT_0116 = m_s*m_mu;
    const ccomplex_t IT_0117 = 6*IT_0110;
    const ccomplex_t IT_0118 = (-6)*IT_0100;
    const ccomplex_t IT_0119 = IT_0117 + IT_0118;
    const ccomplex_t IT_0120 = 6*conj(IT_0110);
    const ccomplex_t IT_0121 = (-6)*conj(IT_0100);
    const ccomplex_t IT_0122 = IT_0120 + IT_0121;
    const ccomplex_t IT_0123 = m_mu*s_24;
    const ccomplex_t IT_0124 = 6*s_34;
    const ccomplex_t IT_0125 = (-6)*s_34;
    const ccomplex_t IT_0126 = (-6)*conj(IT_0041)*(IT_0066*IT_0068 + (
      -0.166666666666667)*IT_0041*IT_0073) + (-6)*conj(IT_0066)*(IT_0041*IT_0068
       + (-0.166666666666667)*IT_0066*IT_0073) + 6*IT_0074*(conj(IT_0041)
      *IT_0093 + IT_0041*IT_0095 + 0.166666666666667*conj(IT_0066)*IT_0112 +
       0.166666666666667*IT_0066*IT_0115) + IT_0116*(conj(IT_0092)*IT_0112 +
       IT_0092*IT_0115 + conj(IT_0084)*IT_0119 + IT_0084*IT_0122) + (-6)*(conj
      (IT_0066)*IT_0093 + IT_0066*IT_0095 + (-0.166666666666667)*conj(IT_0041)
      *IT_0119 + (-0.166666666666667)*IT_0041*IT_0122)*IT_0123 + (IT_0084*conj
      (IT_0084) + IT_0092*conj(IT_0092) + IT_0100*conj(IT_0100) + IT_0110*conj
      (IT_0110))*IT_0124 + (conj(IT_0084)*IT_0092 + IT_0084*conj(IT_0092) + conj
      (IT_0100)*IT_0110 + IT_0100*conj(IT_0110))*IT_0125;
