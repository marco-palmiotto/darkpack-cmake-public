        ...
        )
{
    ...
    const ccomplex_t IT_0079 = IT_0026*IT_0055;
    const ccomplex_t IT_0080 = IT_0030*IT_0078*IT_0079;
    ...
    const ccomplex_t IT_0088 = m_s*IT_0016;
    const ccomplex_t IT_0089 = m_s*IT_0024;
    const ccomplex_t IT_0090 = m_s*IT_0032;
    const ccomplex_t IT_0091 = m_s*IT_0040;
    const ccomplex_t IT_0092 = IT_0087 + -IT_0088 + -IT_0089 + -IT_0090 + 
      -IT_0091;
    ...
    const ccomplex_t IT_0096 = IT_0010*IT_0044;
    const ccomplex_t IT_0097 = IT_0014*IT_0075*IT_0096;
    const ccomplex_t IT_0098 = IT_0020*IT_0050;
    const ccomplex_t IT_0099 = IT_0022*IT_0085*IT_0098;
    const ccomplex_t IT_0100 = IT_0036*IT_0062;
    const ccomplex_t IT_0101 = IT_0038*IT_0081*IT_0100;
    const ccomplex_t IT_0102 = -IT_0097 + -IT_0099 + -IT_0101;
    const ccomplex_t IT_0103 = 6*IT_0102;
    const ccomplex_t IT_0104 = IT_0028*IT_0056;
    const ccomplex_t IT_0105 = IT_0030*IT_0078*IT_0104;
    ...
    const ccomplex_t IT_0126 = (-6)*conj(IT_0041)*(IT_0066*IT_0068 + (
      ...
      *IT_0119 + (-0.166666666666667)*IT_0041*IT_0122)*IT_0123 + (IT_0084*conj
      (IT_0084) + IT_0092*conj(IT_0092) + IT_0102*conj(IT_0102) + IT_0110*conj
      (IT_0110))*IT_0124 + (conj(IT_0084)*IT_0092 + IT_0084*conj(IT_0092) + conj
      (IT_0102)*IT_0110 + IT_0102*conj(IT_0110))*IT_0125;
