...
ccomplex_return_t c_sumSqAmpl_smu_R_st_2_to_mu_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = N_B2*e_em*U_st_11;
    ...
    const ccomplex_t IT_0015 = m_t*N_u2*e_em*IT_0000*U_st_01;
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0024 = IT_0020*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0027 = 0.5*IT_0026;
    const ccomplex_t IT_0028 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0029 = IT_0008*IT_0028;
    const ccomplex_t IT_0030 = 1.4142135623731*IT_0029;
    const ccomplex_t IT_0031 = m_t*N_u3*e_em*IT_0000*U_st_01;
    ...
    const ccomplex_t IT_0037 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0043 = IT_0008*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = m_t*N_u4*e_em*IT_0000*U_st_01;
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0059 = m_t*N_u1*e_em*IT_0000*U_st_01;
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_N_1*
    ...
    const ccomplex_t IT_0073 = IT_0023*IT_0071*IT_0072;
    ...
    const ccomplex_t IT_0130 = m_t*IT_0129;
    const ccomplex_t IT_0131 = conj(N_B4)*e_em*U_st_01;
    const ccomplex_t IT_0132 = IT_0008*IT_0131;
    const ccomplex_t IT_0133 = 1.4142135623731*IT_0132;
    const ccomplex_t IT_0134 = conj(N_W4)*e_em*U_st_01;
    const ccomplex_t IT_0135 = IT_0004*IT_0134;
    const ccomplex_t IT_0136 = 1.4142135623731*IT_0135;
    const ccomplex_t IT_0137 = m_t*conj(N_u4)*e_em*IT_0000*U_st_11;
    ...
    const ccomplex_t IT_0145 = m_t*IT_0144;
    const ccomplex_t IT_0146 = IT_0063*IT_0115;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0148 = IT_0065*IT_0146*IT_0147;
    const ccomplex_t IT_0149 = IT_0073 + IT_0078 + IT_0083 + -IT_0098 + 
      -IT_0113 + -IT_0130 + -IT_0145 + IT_0148;
    const ccomplex_t IT_0150 = m_mu*s_24;
    const ccomplex_t IT_0151 = m_t*IT_0025;
    const ccomplex_t IT_0152 = m_t*IT_0039;
    const ccomplex_t IT_0153 = m_t*IT_0053;
    const ccomplex_t IT_0154 = IT_0055*IT_0126;
    const ccomplex_t IT_0155 = IT_0065*IT_0147*IT_0154;
    const ccomplex_t IT_0156 = IT_0006*IT_0094;
    const ccomplex_t IT_0157 = IT_0023*IT_0072*IT_0156;
    const ccomplex_t IT_0158 = IT_0027*IT_0109;
    const ccomplex_t IT_0159 = IT_0037*IT_0077*IT_0158;
    const ccomplex_t IT_0160 = IT_0041*IT_0141;
    const ccomplex_t IT_0161 = IT_0051*IT_0082*IT_0160;
    const ccomplex_t IT_0162 = m_t*IT_0067;
    const ccomplex_t IT_0163 = -IT_0151 + -IT_0152 + -IT_0153 + IT_0155 +
       IT_0157 + IT_0159 + IT_0161 + -IT_0162;
    const ccomplex_t IT_0164 = m_t*s_23;
    const ccomplex_t IT_0165 = -IT_0097 + -IT_0112 + -IT_0129 + -IT_0144;
    const ccomplex_t IT_0166 = pow(m_st_2, 2);
    const ccomplex_t IT_0167 = m_t*m_mu*IT_0166;
    const ccomplex_t IT_0168 = s_34*IT_0166;
    const ccomplex_t IT_0169 = (-6)*IT_0168;
    const ccomplex_t IT_0170 = s_23*s_24;
    const ccomplex_t IT_0171 = 12*IT_0170;
    const ccomplex_t IT_0172 = IT_0169 + IT_0171;
    const ccomplex_t IT_0173 = 6*s_34;
    const ccomplex_t IT_0174 = m_t*m_mu;
    const ccomplex_t IT_0175 = (-6)*conj(IT_0149);
    const ccomplex_t IT_0176 = (-6)*IT_0149;
    const ccomplex_t IT_0177 = -IT_0068;
    const ccomplex_t IT_0178 = 6*conj(IT_0068)*(IT_0149*IT_0150 + -IT_0163
      *IT_0164 + -IT_0165*IT_0167 + 0.166666666666667*IT_0068*IT_0172) + 6*conj
      (IT_0149)*(IT_0068*IT_0150 + 0.166666666666667*IT_0149*IT_0173) + (IT_0164
      *IT_0165 + IT_0163*IT_0174)*IT_0175 + 6*conj(IT_0163)*(IT_0150*IT_0165 +
       0.166666666666667*IT_0163*IT_0173 + 0.166666666666667*IT_0174*IT_0176 +
       IT_0164*IT_0177) + 6*conj(IT_0165)*(IT_0150*IT_0163 + 0.166666666666667
      *IT_0165*IT_0172 + 0.166666666666667*IT_0164*IT_0176 + IT_0167*IT_0177);
