        ...
        )
{
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0021 + IT_0022 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0055 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0056 = IT_0008*IT_0055;
    const ccomplex_t IT_0057 = 1.4142135623731*IT_0056;
    const ccomplex_t IT_0058 = m_t*N_u3*e_em*IT_0000*U_st_01;
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0143 = IT_0006*IT_0081;
    const ccomplex_t IT_0144 = IT_0023*IT_0142*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0146 = IT_0027*IT_0097;
    const ccomplex_t IT_0147 = IT_0037*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0149 = IT_0041*IT_0129;
    const ccomplex_t IT_0150 = IT_0051*IT_0148*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0152 = IT_0064*IT_0113;
    const ccomplex_t IT_0153 = IT_0054*IT_0151*IT_0152;
    const ccomplex_t IT_0154 = -IT_0144 + -IT_0147 + -IT_0150 + -IT_0153;
    const ccomplex_t IT_0155 = IT_0025 + IT_0039 + IT_0053 + IT_0067;
    const ccomplex_t IT_0156 = m_t*IT_0155;
    const ccomplex_t IT_0157 = -IT_0156;
    const ccomplex_t IT_0158 = IT_0154 + -IT_0157;
    const ccomplex_t IT_0159 = -conj(IT_0157);
    const ccomplex_t IT_0160 = conj(IT_0154) + IT_0159;
    const ccomplex_t IT_0161 = IT_0019*IT_0070;
    const ccomplex_t IT_0162 = IT_0023*IT_0142*IT_0161;
    const ccomplex_t IT_0163 = IT_0035*IT_0086;
    const ccomplex_t IT_0164 = IT_0037*IT_0145*IT_0163;
    const ccomplex_t IT_0165 = IT_0062*IT_0102;
    const ccomplex_t IT_0166 = IT_0054*IT_0151*IT_0165;
    const ccomplex_t IT_0167 = IT_0049*IT_0118;
    const ccomplex_t IT_0168 = IT_0051*IT_0148*IT_0167;
    const ccomplex_t IT_0169 = -IT_0162 + -IT_0164 + -IT_0166 + -IT_0168;
    const ccomplex_t IT_0170 = 6*IT_0169;
    const ccomplex_t IT_0171 = IT_0084 + IT_0100 + IT_0116 + IT_0132;
    ...
    const ccomplex_t IT_0176 = 6*conj(IT_0169);
    const ccomplex_t IT_0177 = (-6)*conj(IT_0173);
    const ccomplex_t IT_0178 = IT_0176 + IT_0177;
    const ccomplex_t IT_0179 = m_mu*s_24;
    const ccomplex_t IT_0180 = 6*IT_0173;
    const ccomplex_t IT_0181 = (-6)*IT_0169;
    const ccomplex_t IT_0182 = IT_0180 + IT_0181;
    const ccomplex_t IT_0183 = 6*conj(IT_0173);
    const ccomplex_t IT_0184 = (-6)*conj(IT_0169);
    const ccomplex_t IT_0185 = IT_0183 + IT_0184;
    const ccomplex_t IT_0186 = m_t*m_mu;
    const ccomplex_t IT_0187 = 6*s_34;
    const ccomplex_t IT_0188 = (-6)*s_34;
    const ccomplex_t IT_0189 = (-6)*conj(IT_0068)*(IT_0133*IT_0135 + (
      -0.166666666666667)*IT_0068*IT_0140) + (-6)*conj(IT_0133)*(IT_0068*IT_0135
       + (-0.166666666666667)*IT_0133*IT_0140) + 6*IT_0141*(conj(IT_0068)
      *IT_0158 + IT_0068*IT_0160 + 0.166666666666667*conj(IT_0133)*IT_0175 +
       0.166666666666667*IT_0133*IT_0178) + (-6)*IT_0179*(conj(IT_0133)*IT_0158 
      + IT_0133*IT_0160 + (-0.166666666666667)*conj(IT_0068)*IT_0182 + (
      -0.166666666666667)*IT_0068*IT_0185) + (conj(IT_0157)*IT_0175 + IT_0157
      *IT_0178 + conj(IT_0154)*IT_0182 + IT_0154*IT_0185)*IT_0186 + (IT_0154
      *conj(IT_0154) + IT_0157*conj(IT_0157) + IT_0169*conj(IT_0169) + IT_0173
      *conj(IT_0173))*IT_0187 + (conj(IT_0154)*IT_0157 + IT_0154*conj(IT_0157) +
       conj(IT_0169)*IT_0173 + IT_0169*conj(IT_0173))*IT_0188;
