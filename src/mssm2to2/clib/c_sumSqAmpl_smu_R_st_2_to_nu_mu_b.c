...
ccomplex_return_t c_sumSqAmpl_smu_R_st_2_to_nu_mu_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = m_t*V_tb*conj(V_u2)*e_em*IT_0000*U_st_11;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
      *e_em*IT_0000*IT_0002*IT_0004*U_st_01;
    ...
    const ccomplex_t IT_0047 = (-0.5)*IT_0021 + (-0.5)*IT_0034 + (-0.5)
      *IT_0040 + (-0.5)*IT_0046;
    const ccomplex_t IT_0048 = (-0.5)*IT_0039 + (-0.5)*IT_0045;
    const ccomplex_t IT_0049 = m_b*s_23;
    const ccomplex_t IT_0050 = s_23*s_24;
    const ccomplex_t IT_0051 = pow(m_st_2, 2);
    const ccomplex_t IT_0052 = s_34*IT_0051;
    return create_ccomplex_return(6*IT_0047*(s_34*conj(IT_0047) + -conj
      (IT_0048)*IT_0049) + (-6)*IT_0048*(conj(IT_0047)*IT_0049 + (
      -0.166666666666667)*conj(IT_0048)*(12*IT_0050 + (-6)*IT_0052)));
}
