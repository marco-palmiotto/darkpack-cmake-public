        ...
        )
{
    ...
    const ccomplex_t IT_0013 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0029 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0041 = IT_0008*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*conj(N_d1)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0055 = IT_0008*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_N_1*
    ...
    const ccomplex_t IT_0071 = IT_0021*IT_0069*IT_0070;
    ...
    const ccomplex_t IT_0076 = IT_0035*IT_0074*IT_0075;
    ...
    const ccomplex_t IT_0081 = IT_0049*IT_0079*IT_0080;
    const ccomplex_t IT_0082 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0083 = IT_0008*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0086 = IT_0004*IT_0085;
    const ccomplex_t IT_0087 = 1.4142135623731*IT_0086;
    const ccomplex_t IT_0088 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0096 = m_tau*IT_0095;
    const ccomplex_t IT_0097 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0098 = IT_0008*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0101 = IT_0004*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = conj(N_d3)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0108 = IT_0073*IT_0107;
    ...
    const ccomplex_t IT_0120 = conj(N_d1)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0128 = m_tau*IT_0127;
    ...
    const ccomplex_t IT_0135 = conj(N_d4)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0140 = IT_0078*IT_0139;
    const ccomplex_t IT_0141 = IT_0049*IT_0140;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*IT_0141;
    const ccomplex_t IT_0143 = m_tau*IT_0142;
    const ccomplex_t IT_0144 = IT_0061*IT_0113;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0146 = IT_0063*IT_0144*IT_0145;
    const ccomplex_t IT_0147 = IT_0071 + IT_0076 + IT_0081 + -IT_0096 + 
      -IT_0111 + -IT_0128 + -IT_0143 + IT_0146;
    const ccomplex_t IT_0148 = m_mu*s_24;
    const ccomplex_t IT_0149 = m_tau*IT_0023;
    const ccomplex_t IT_0150 = m_tau*IT_0037;
    const ccomplex_t IT_0151 = m_tau*IT_0051;
    const ccomplex_t IT_0152 = IT_0053*IT_0124;
    const ccomplex_t IT_0153 = IT_0063*IT_0145*IT_0152;
    const ccomplex_t IT_0154 = IT_0006*IT_0092;
    const ccomplex_t IT_0155 = IT_0021*IT_0070*IT_0154;
    const ccomplex_t IT_0156 = IT_0025*IT_0107;
    const ccomplex_t IT_0157 = IT_0035*IT_0075*IT_0156;
    const ccomplex_t IT_0158 = IT_0039*IT_0139;
    const ccomplex_t IT_0159 = IT_0049*IT_0080*IT_0158;
    const ccomplex_t IT_0160 = m_tau*IT_0065;
    const ccomplex_t IT_0161 = -IT_0149 + -IT_0150 + -IT_0151 + IT_0153 +
       IT_0155 + IT_0157 + IT_0159 + -IT_0160;
    const ccomplex_t IT_0162 = s_23*m_tau;
    const ccomplex_t IT_0163 = -IT_0095 + -IT_0110 + -IT_0127 + -IT_0142;
    const ccomplex_t IT_0164 = pow(m_stau_1, 2);
    const ccomplex_t IT_0165 = m_mu*m_tau*IT_0164;
    const ccomplex_t IT_0166 = s_23*s_24;
    const ccomplex_t IT_0167 = s_34*IT_0164;
    const ccomplex_t IT_0168 = (-0.5)*IT_0167;
    const ccomplex_t IT_0169 = IT_0166 + IT_0168;
    const ccomplex_t IT_0170 = 2*s_34;
    const ccomplex_t IT_0171 = m_mu*m_tau;
    const ccomplex_t IT_0172 = (-2)*conj(IT_0147);
    const ccomplex_t IT_0173 = (-2)*IT_0147;
    const ccomplex_t IT_0174 = -IT_0066;
    const ccomplex_t IT_0175 = 2*conj(IT_0066)*(IT_0147*IT_0148 + -IT_0161
      *IT_0162 + -IT_0163*IT_0165 + 2*IT_0066*IT_0169) + 2*conj(IT_0147)*
      (IT_0066*IT_0148 + 0.5*IT_0147*IT_0170) + (IT_0162*IT_0163 + IT_0161
      *IT_0171)*IT_0172 + 2*conj(IT_0161)*(IT_0148*IT_0163 + 0.5*IT_0161*IT_0170
       + 0.5*IT_0171*IT_0173 + IT_0162*IT_0174) + 2*conj(IT_0163)*(IT_0148
      *IT_0161 + 2*IT_0163*IT_0169 + 0.5*IT_0162*IT_0173 + IT_0165*IT_0174);
