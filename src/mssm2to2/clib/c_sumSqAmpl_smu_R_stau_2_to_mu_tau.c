...
ccomplex_return_t c_sumSqAmpl_smu_R_stau_2_to_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*conj(N_d2)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0040 = 0.5*IT_0039;
    const ccomplex_t IT_0041 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0042 = IT_0008*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = N_d2*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0053 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0054 = IT_0008*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = N_d3*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*N_B2*e_em
      *IT_0008;
    const ccomplex_t IT_0116 = -IT_0115;
    const ccomplex_t IT_0117 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0118 = IT_0008*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0121 = IT_0004*IT_0120;
    const ccomplex_t IT_0122 = 1.4142135623731*IT_0121;
    const ccomplex_t IT_0123 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0131 = -IT_0082 + -IT_0098 + -IT_0114 + -IT_0130;
    const ccomplex_t IT_0132 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0138 = m_mu*s_24;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0140 = IT_0062*IT_0079;
    const ccomplex_t IT_0141 = IT_0052*IT_0139*IT_0140;
    const ccomplex_t IT_0142 = m_tau*IT_0037;
    const ccomplex_t IT_0143 = m_tau*IT_0051;
    const ccomplex_t IT_0144 = m_tau*IT_0065;
    const ccomplex_t IT_0145 = m_tau*IT_0023;
    const ccomplex_t IT_0146 = IT_0141 + -IT_0142 + -IT_0143 + -IT_0144 + 
      -IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0148 = IT_0006*IT_0095;
    const ccomplex_t IT_0149 = IT_0021*IT_0147*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0151 = IT_0026*IT_0111;
    const ccomplex_t IT_0152 = IT_0024*IT_0150*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0154 = IT_0040*IT_0127;
    const ccomplex_t IT_0155 = IT_0038*IT_0153*IT_0154;
    const ccomplex_t IT_0156 = -IT_0149 + -IT_0152 + -IT_0155;
    ...
    const ccomplex_t IT_0160 = IT_0034*IT_0100;
    const ccomplex_t IT_0161 = IT_0024*IT_0150*IT_0160;
    const ccomplex_t IT_0162 = IT_0017*IT_0084;
    const ccomplex_t IT_0163 = IT_0021*IT_0147*IT_0162;
    ...
    const ccomplex_t IT_0168 = IT_0161 + IT_0163 + -IT_0164 + -IT_0165 + 
      -IT_0166 + -IT_0167;
    const ccomplex_t IT_0169 = 2*IT_0168;
    const ccomplex_t IT_0170 = IT_0060*IT_0068;
    const ccomplex_t IT_0171 = IT_0052*IT_0139*IT_0170;
    const ccomplex_t IT_0172 = IT_0048*IT_0116;
    const ccomplex_t IT_0173 = IT_0038*IT_0153*IT_0172;
    ...
    const ccomplex_t IT_0182 = (-2)*IT_0168;
    const ccomplex_t IT_0183 = IT_0181 + IT_0182;
    const ccomplex_t IT_0184 = 2*conj(IT_0174);
    const ccomplex_t IT_0185 = (-2)*conj(IT_0168);
    const ccomplex_t IT_0186 = IT_0184 + IT_0185;
    const ccomplex_t IT_0187 = s_23*m_tau;
    const ccomplex_t IT_0188 = 2*s_34;
    const ccomplex_t IT_0189 = (-2)*s_34;
    const ccomplex_t IT_0190 = (-2)*conj(IT_0066)*(IT_0131*IT_0133 + (-2)
      *IT_0066*IT_0137) + (-2)*conj(IT_0131)*(IT_0066*IT_0133 + (-2)*IT_0131
      *IT_0137) + 2*IT_0138*(conj(IT_0131)*IT_0157 + IT_0131*IT_0159 + 0.5*conj
      (IT_0066)*IT_0176 + 0.5*IT_0066*IT_0179) + IT_0180*(conj(IT_0156)*IT_0176 
      + IT_0156*IT_0179 + conj(IT_0146)*IT_0183 + IT_0146*IT_0186) + (-2)*(conj
      (IT_0066)*IT_0157 + IT_0066*IT_0159 + (-0.5)*conj(IT_0131)*IT_0183 + (-0.5
      )*IT_0131*IT_0186)*IT_0187 + (IT_0146*conj(IT_0146) + IT_0156*conj(IT_0156
      ) + IT_0168*conj(IT_0168) + IT_0174*conj(IT_0174))*IT_0188 + (conj(IT_0146
      )*IT_0156 + IT_0146*conj(IT_0156) + conj(IT_0168)*IT_0174 + IT_0168*conj
      (IT_0174))*IT_0189;
