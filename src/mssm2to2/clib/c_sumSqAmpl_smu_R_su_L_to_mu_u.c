        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*conj(N_d3)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*conj(N_d4)
      *e_em*m_mu*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0106 = IT_0006*IT_0053;
    const ccomplex_t IT_0107 = IT_0014*IT_0105*IT_0106;
    ...
    const ccomplex_t IT_0115 = IT_0034*IT_0090;
    const ccomplex_t IT_0116 = IT_0038*IT_0114*IT_0115;
    const ccomplex_t IT_0117 = -IT_0107 + -IT_0110 + -IT_0113 + -IT_0116;
    const ccomplex_t IT_0118 = IT_0016 + IT_0024 + IT_0032 + IT_0040;
    ...
    const ccomplex_t IT_0124 = IT_0010*IT_0045;
    const ccomplex_t IT_0125 = IT_0014*IT_0105*IT_0124;
    const ccomplex_t IT_0126 = IT_0020*IT_0066;
    const ccomplex_t IT_0127 = IT_0022*IT_0108*IT_0126;
    const ccomplex_t IT_0128 = IT_0028*IT_0079;
    const ccomplex_t IT_0129 = IT_0030*IT_0111*IT_0128;
    const ccomplex_t IT_0130 = IT_0036*IT_0092;
    const ccomplex_t IT_0131 = IT_0038*IT_0114*IT_0130;
    const ccomplex_t IT_0132 = -IT_0125 + -IT_0127 + -IT_0129 + -IT_0131;
    const ccomplex_t IT_0133 = 6*IT_0132;
    const ccomplex_t IT_0134 = IT_0056 + IT_0069 + IT_0082 + IT_0095;
    ...
    const ccomplex_t IT_0152 = (-6)*conj(IT_0041)*(IT_0096*IT_0098 + (
      -0.166666666666667)*IT_0041*IT_0103) + (-6)*conj(IT_0096)*(IT_0041*IT_0098
       + (-0.166666666666667)*IT_0096*IT_0103) + 6*IT_0104*(conj(IT_0041)
      *IT_0121 + IT_0041*IT_0123 + 0.166666666666667*conj(IT_0096)*IT_0138 +
      ...
      (IT_0096)*IT_0121 + IT_0096*IT_0123 + (-0.166666666666667)*conj(IT_0041)
      *IT_0145 + (-0.166666666666667)*IT_0041*IT_0148)*IT_0149 + (IT_0117*conj
