...
ccomplex_return_t c_sumSqAmpl_smu_R_su_L_to_nu_mu_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0004;
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0004;
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0034 = (-0.5)*IT_0025 + (-0.5)*IT_0030;
    const ccomplex_t IT_0035 = m_d*s_23;
    ...
    const ccomplex_t IT_0040 = 6*s_34*(IT_0020*conj(IT_0020) + IT_0033*conj
      (IT_0033)) + 6*((conj(IT_0020) + -conj(IT_0033))*IT_0034 + (IT_0020 + 
      -IT_0033)*conj(IT_0034))*IT_0035 + IT_0034*conj(IT_0034)*(12*IT_0036 + (-6
      )*IT_0038) + (conj(IT_0020)*IT_0033 + IT_0020*conj(IT_0033))*IT_0039;
