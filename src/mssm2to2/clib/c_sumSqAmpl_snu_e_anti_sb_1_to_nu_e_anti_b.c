...
ccomplex_return_t c_sumSqAmpl_snu_e_anti_sb_1_to_nu_e_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0015 = conj(N_B1)*e_em*conj(U_sb_10);
    ...
    const ccomplex_t IT_0022 = m_b*conj(N_d1)*e_em*IT_0021*conj(U_sb_00);
    ...
    const ccomplex_t IT_0030 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0039 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0040 = IT_0004*IT_0039;
    const ccomplex_t IT_0041 = 1.4142135623731*IT_0040;
    const ccomplex_t IT_0042 = m_b*conj(N_d2)*e_em*IT_0021*conj(U_sb_00);
    ...
    const ccomplex_t IT_0050 = IT_0029*IT_0030*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0052 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0061 = m_b*conj(N_d4)*e_em*IT_0021*conj(U_sb_00);
    const ccomplex_t IT_0062 = IT_0020*IT_0061;
    const ccomplex_t IT_0063 = 1.4142135623731*IT_0062;
    const ccomplex_t IT_0064 = conj(N_B4)*e_em*conj(U_sb_10);
    ...
    const ccomplex_t IT_0071 = IT_0051*IT_0052*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0073 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0082 = m_b*conj(N_d3)*e_em*IT_0021*conj(U_sb_00);
    const ccomplex_t IT_0083 = IT_0020*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0086 = IT_0004*IT_0085;
    const ccomplex_t IT_0087 = 1.4142135623731*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*(IT_0084 + 0.666666666666667
      *IT_0087);
    const ccomplex_t IT_0089 = 1.5*IT_0088;
    const ccomplex_t IT_0090 = (-0.333333333333333)*IT_0089;
    const ccomplex_t IT_0091 = IT_0081*IT_0090;
    const ccomplex_t IT_0092 = IT_0072*IT_0073*IT_0091;
    const ccomplex_t IT_0093 = 0.5*IT_0028 + 0.5*IT_0050 + 0.5*IT_0071 + 0.5
      *IT_0092;
    const ccomplex_t IT_0094 = m_b*N_d1*e_em*IT_0021*conj(U_sb_10);
    const ccomplex_t IT_0095 = IT_0020*IT_0094;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = N_B1*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*(IT_0096 + 0.333333333333333
      *IT_0099 + -IT_0102);
    ...
    const ccomplex_t IT_0152 = IT_0060*IT_0151;
    const ccomplex_t IT_0153 = IT_0052*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*IT_0153;
    const ccomplex_t IT_0155 = 0.5*IT_0109 + 0.5*IT_0124 + 0.5*IT_0139 + 0.5
      *IT_0154;
    const ccomplex_t IT_0156 = m_b*s_13;
    const ccomplex_t IT_0157 = s_13*s_14;
    const ccomplex_t IT_0158 = s_34*IT_0001;
    return create_ccomplex_return(6*IT_0093*(s_34*conj(IT_0093) + -conj
      (IT_0155)*IT_0156) + (-6)*IT_0155*(conj(IT_0093)*IT_0156 + (
      -0.166666666666667)*conj(IT_0155)*(12*IT_0157 + (-6)*IT_0158)));
}
