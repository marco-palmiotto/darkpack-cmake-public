        ...
        )
{
    ...
    const ccomplex_t IT_0016 = m_e*IT_0015;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d2)
      *e_em*IT_0005*IT_0026*IT_0028;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_e*U_d2*e_em
    ...
    const ccomplex_t IT_0038 = m_e*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*m_e*conj(U_d1)
      *e_em*IT_0005*IT_0026*IT_0028;
    const ccomplex_t IT_0040 = (-0.5)*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*m_e*U_d1*e_em
      *IT_0005*IT_0026*IT_0028;
    ...
    const ccomplex_t IT_0059 = m_e*s_14;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*m_e*e_em*IT_0005*IT_0026
      *IT_0028*IT_0080;
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_12 + (-2)*IT_0010 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0092 = IT_0090*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*m_e*e_em*IT_0005*IT_0026
      *IT_0028*IT_0087;
    const ccomplex_t IT_0095 = 0.5*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*m_W*e_em*IT_0085*(IT_0080
      *IT_0086 + IT_0027*IT_0087);
