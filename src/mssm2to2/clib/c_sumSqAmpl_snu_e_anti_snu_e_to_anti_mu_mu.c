...
ccomplex_return_t c_sumSqAmpl_snu_e_anti_snu_e_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = m_mu*s_13;
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0027
      *IT_0029*IT_0030;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0027
      *IT_0029*IT_0037;
    ...
    const ccomplex_t IT_0055 = m_mu*IT_0054;
    ...
    const ccomplex_t IT_0066 = m_mu*s_14;
