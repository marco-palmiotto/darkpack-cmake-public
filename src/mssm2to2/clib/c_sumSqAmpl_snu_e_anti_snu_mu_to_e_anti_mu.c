...
ccomplex_return_t c_sumSqAmpl_snu_e_anti_snu_mu_to_e_anti_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*e_em*V_Wp1*IT_0004;
    ...
    const ccomplex_t IT_0027 = m_e*IT_0010;
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*conj(U_d2)
      *e_em*m_mu*IT_0004*IT_0020*IT_0022;
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = IT_0012*IT_0037;
    const ccomplex_t IT_0039 = IT_0011*IT_0028*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*conj(U_d1)
      *e_em*m_mu*IT_0004*IT_0020*IT_0022;
    const ccomplex_t IT_0041 = (-0.5)*IT_0040;
    const ccomplex_t IT_0042 = IT_0007*IT_0041;
    const ccomplex_t IT_0043 = IT_0002*IT_0019*IT_0042;
    const ccomplex_t IT_0044 = IT_0024*IT_0041;
    const ccomplex_t IT_0045 = IT_0002*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = m_e*IT_0046;
    const ccomplex_t IT_0048 = IT_0030*IT_0037;
