        ...
        )
{
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_e*U_d1*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0055 = m_e*m_t;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0057 = IT_0030*IT_0035;
    const ccomplex_t IT_0058 = IT_0021*IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0060 = IT_0017*IT_0043;
    const ccomplex_t IT_0061 = IT_0002*IT_0059*IT_0060;
    const ccomplex_t IT_0062 = m_e*IT_0033;
    const ccomplex_t IT_0063 = m_e*IT_0020;
    const ccomplex_t IT_0064 = -IT_0058 + -IT_0061 + IT_0062 + IT_0063;
    const ccomplex_t IT_0065 = IT_0009*IT_0045;
    const ccomplex_t IT_0066 = IT_0002*IT_0059*IT_0065;
    const ccomplex_t IT_0067 = IT_0023*IT_0039;
    const ccomplex_t IT_0068 = IT_0021*IT_0056*IT_0067;
    const ccomplex_t IT_0069 = m_e*IT_0042;
    const ccomplex_t IT_0070 = m_e*IT_0048;
    ...
    const ccomplex_t IT_0082 = (-6)*conj(IT_0034);
    const ccomplex_t IT_0083 = m_t*s_13;
    const ccomplex_t IT_0084 = (IT_0034*conj(IT_0034) + IT_0049*conj(IT_0049))
      *IT_0054 + 6*IT_0055*(conj(IT_0064)*IT_0073 + IT_0064*IT_0076) + (-6)*
      (conj(IT_0034)*IT_0064 + IT_0034*conj(IT_0064) + -conj(IT_0049)*IT_0073 + 
      -IT_0049*IT_0076)*IT_0077 + (IT_0064*conj(IT_0064) + IT_0066*conj(IT_0066)
       + IT_0071*conj(IT_0071))*IT_0078 + (conj(IT_0066)*IT_0071 + IT_0066*conj
      (IT_0071))*IT_0079 + IT_0080*(conj(IT_0049)*IT_0081 + IT_0049*IT_0082) + 6
      *(conj(IT_0049)*IT_0064 + IT_0049*conj(IT_0064) + conj(IT_0034)*IT_0071 +
       IT_0034*conj(IT_0071) + 0.166666666666667*conj(IT_0066)*IT_0081 +
       0.166666666666667*IT_0066*IT_0082)*IT_0083;
