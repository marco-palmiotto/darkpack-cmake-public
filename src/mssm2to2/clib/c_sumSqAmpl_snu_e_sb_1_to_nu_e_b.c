        ...
        )
{
    ...
    const ccomplex_t IT_0043 = m_b*conj(N_d3)*e_em*IT_0018*U_sb_10;
    const ccomplex_t IT_0044 = IT_0017*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = conj(N_W3)*e_em*U_sb_00;
    const ccomplex_t IT_0047 = IT_0009*IT_0046;
    const ccomplex_t IT_0048 = 1.4142135623731*IT_0047;
    const ccomplex_t IT_0049 = conj(N_B3)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0067 = m_b*conj(N_d4)*e_em*IT_0018*U_sb_10;
    ...
    const ccomplex_t IT_0082 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0147 = IT_0066*IT_0146;
