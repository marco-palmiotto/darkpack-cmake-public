        ...
        )
{
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0034 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0043 = m_b*conj(N_d3)*e_em*IT_0021*U_sb_11;
    ...
    const ccomplex_t IT_0067 = m_b*conj(N_d1)*e_em*IT_0021*U_sb_11;
    const ccomplex_t IT_0068 = IT_0020*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0071 = IT_0004*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = conj(N_W1)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0082 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0104 = (-0.5)*IT_0032 + (-0.5)*IT_0056 + (-0.5)
      *IT_0080 + (-0.5)*IT_0103;
    ...
    const ccomplex_t IT_0108 = m_b*N_d1*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0119 = m_b*N_d2*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0130 = m_b*N_d4*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0135 = IT_0090*IT_0134;
    ...
    const ccomplex_t IT_0141 = m_b*N_d3*e_em*IT_0021*U_sb_01;
    ...
    return create_ccomplex_return(6*IT_0104*(s_34*conj(IT_0104) + conj(IT_0149
      )*IT_0150) + 6*IT_0149*(conj(IT_0104)*IT_0150 + 0.166666666666667*conj
      (IT_0149)*(12*IT_0151 + (-6)*IT_0152)));
}
