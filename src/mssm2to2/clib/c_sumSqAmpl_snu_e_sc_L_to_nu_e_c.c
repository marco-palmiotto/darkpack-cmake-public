...
ccomplex_return_t c_sumSqAmpl_snu_e_sc_L_to_nu_e_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*(IT_0024 + 3*IT_0027);
    const ccomplex_t IT_0031 = 0.166666666666667*IT_0030;
    const ccomplex_t IT_0032 = IT_0029*IT_0031;
    const ccomplex_t IT_0033 = IT_0020*IT_0021*IT_0032;
