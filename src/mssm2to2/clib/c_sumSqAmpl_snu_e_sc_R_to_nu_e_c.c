...
ccomplex_return_t c_sumSqAmpl_snu_e_sc_R_to_nu_e_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0006*IT_0012*IT_0014;
