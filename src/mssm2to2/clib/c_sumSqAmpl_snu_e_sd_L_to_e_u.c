        ...
        )
{
    ...
    const ccomplex_t IT_0037 = m_e*m_u*IT_0010;
    ...
    const ccomplex_t IT_0044 = IT_0007*IT_0025;
    const ccomplex_t IT_0045 = IT_0011*IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0047 = IT_0016*IT_0031;
    const ccomplex_t IT_0048 = IT_0018*IT_0046*IT_0047;
    const ccomplex_t IT_0049 = IT_0045 + IT_0048;
    const ccomplex_t IT_0050 = IT_0014*IT_0032;
    const ccomplex_t IT_0051 = IT_0018*IT_0046*IT_0050;
    const ccomplex_t IT_0052 = m_e*IT_0013;
    const ccomplex_t IT_0053 = m_e*IT_0020;
    const ccomplex_t IT_0054 = -IT_0051 + IT_0052 + IT_0053;
    const ccomplex_t IT_0055 = m_e*IT_0036;
    const ccomplex_t IT_0056 = IT_0002*IT_0026;
    const ccomplex_t IT_0057 = IT_0011*IT_0043*IT_0056;
    const ccomplex_t IT_0058 = 6*s_34;
    const ccomplex_t IT_0059 = (-6)*s_34;
    const ccomplex_t IT_0060 = m_e*s_14;
    const ccomplex_t IT_0061 = (-6)*IT_0054;
    const ccomplex_t IT_0062 = 0.166666666666667*IT_0061;
    const ccomplex_t IT_0063 = IT_0057 + IT_0062;
    const ccomplex_t IT_0064 = (-6)*conj(IT_0054);
    const ccomplex_t IT_0065 = 0.166666666666667*IT_0064;
    const ccomplex_t IT_0066 = conj(IT_0057) + IT_0065;
    const ccomplex_t IT_0067 = (-6)*IT_0036;
    const ccomplex_t IT_0068 = (-6)*conj(IT_0036);
    const ccomplex_t IT_0069 = m_e*m_u;
    const ccomplex_t IT_0070 = (-6)*conj(IT_0049);
    const ccomplex_t IT_0071 = 0.166666666666667*IT_0057;
    const ccomplex_t IT_0072 = (-6)*IT_0049;
    const ccomplex_t IT_0073 = 0.166666666666667*conj(IT_0057);
    const ccomplex_t IT_0074 = m_u*s_13;
    const ccomplex_t IT_0075 = (-6)*conj(IT_0021)*(IT_0036*IT_0037 + (
      -0.166666666666667)*IT_0021*IT_0042) + (-6)*conj(IT_0036)*(IT_0021*IT_0037
       + (-0.166666666666667)*IT_0036*IT_0042) + (IT_0049*conj(IT_0049) +
       IT_0054*conj(IT_0054) + IT_0055*conj(IT_0055) + IT_0057*conj(IT_0057))
      *IT_0058 + (conj(IT_0049)*IT_0055 + IT_0049*conj(IT_0055) + conj(IT_0054)
      *IT_0057 + IT_0054*conj(IT_0057))*IT_0059 + 6*IT_0060*(conj(IT_0036)
      *IT_0049 + IT_0036*conj(IT_0049) + conj(IT_0021)*IT_0063 + IT_0021*IT_0066
       + 0.166666666666667*conj(IT_0055)*IT_0067 + 0.166666666666667*IT_0055
      *IT_0068) + 6*IT_0069*(conj(IT_0049)*IT_0054 + IT_0049*conj(IT_0054) +
       conj(IT_0055)*IT_0063 + IT_0055*IT_0066 + IT_0070*IT_0071 + IT_0072
      *IT_0073) + 6*(conj(IT_0036)*IT_0054 + IT_0036*conj(IT_0054) + IT_0021*
      (conj(IT_0055) + 0.166666666666667*IT_0070) + IT_0068*IT_0071 + conj
      (IT_0021)*(IT_0055 + 0.166666666666667*IT_0072) + IT_0067*IT_0073)*IT_0074;
