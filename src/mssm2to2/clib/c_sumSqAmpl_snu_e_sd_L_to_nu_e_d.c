...
ccomplex_return_t c_sumSqAmpl_snu_e_sd_L_to_nu_e_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0046 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0060 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_4*(m_N_4 +
