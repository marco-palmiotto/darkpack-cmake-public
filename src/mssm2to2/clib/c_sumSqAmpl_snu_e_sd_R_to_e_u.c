        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0004;
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0004;
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0017 = (-0.5)*IT_0016;
    const ccomplex_t IT_0018 = IT_0015*IT_0017;
    const ccomplex_t IT_0019 = cpow((-2)*s_13 + IT_0010 + IT_0011 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0020 = IT_0014*IT_0018*IT_0019;
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_e*U_d2*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0033 = m_e*IT_0032;
    const ccomplex_t IT_0034 = m_e*s_14;
    const ccomplex_t IT_0035 = s_13*s_14;
    const ccomplex_t IT_0036 = s_34*IT_0011;
    const ccomplex_t IT_0037 = (-6)*s_34;
    const ccomplex_t IT_0038 = 6*s_34*(IT_0021*conj(IT_0021) + IT_0033*conj
      (IT_0033)) + 6*(conj(IT_0032)*(IT_0021 + -IT_0033) + IT_0032*(conj(IT_0021
      ) + -conj(IT_0033)))*IT_0034 + IT_0032*conj(IT_0032)*(12*IT_0035 + (-6)
      *IT_0036) + (conj(IT_0021)*IT_0033 + IT_0021*conj(IT_0033))*IT_0037;
