...
ccomplex_return_t c_sumSqAmpl_snu_e_snu_e_to_nu_e_nu_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = cpow(s_23 + (-0.5)*IT_0014 + 0.5*m_N_2*(m_N_2 +
       (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = cpow(s_13 + (-0.5)*IT_0014 + 0.5*m_N_2*(m_N_2 +
       (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0059 = cpow(s_13 + (-0.5)*IT_0014 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
