...
ccomplex_return_t c_sumSqAmpl_snu_e_ss_R_to_nu_e_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0075 = m_s*IT_0074;
    ...
    const ccomplex_t IT_0088 = (-0.5)*IT_0021 + (-0.5)*IT_0035 + (-0.5)
      *IT_0049 + (-0.5)*IT_0063 + 0.5*IT_0069 + 0.5*IT_0075 + 0.5*IT_0081 + 0.5
      *IT_0087;
    const ccomplex_t IT_0089 = 0.5*IT_0068 + 0.5*IT_0074 + 0.5*IT_0080 + 0.5
      *IT_0086;
    const ccomplex_t IT_0090 = m_s*s_23;
    const ccomplex_t IT_0091 = s_23*s_24;
    const ccomplex_t IT_0092 = pow(m_ss_R, 2);
