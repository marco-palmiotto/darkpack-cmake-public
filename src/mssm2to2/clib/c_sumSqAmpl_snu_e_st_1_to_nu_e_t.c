...
ccomplex_return_t c_sumSqAmpl_snu_e_st_1_to_nu_e_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = m_t*N_u2*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0060 = m_t*N_u4*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0126 = m_t*conj(N_u4)*e_em*IT_0018*U_st_10;
