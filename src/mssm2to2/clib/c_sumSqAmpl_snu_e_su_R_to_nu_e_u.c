...
ccomplex_return_t c_sumSqAmpl_snu_e_su_R_to_nu_e_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0092 = pow(m_su_R, 2);
