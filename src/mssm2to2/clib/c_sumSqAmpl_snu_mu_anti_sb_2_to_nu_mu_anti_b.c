...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_sb_2_to_nu_mu_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B2)*e_em*conj(U_sb_11);
    ...
    const ccomplex_t IT_0019 = m_b*conj(N_d2)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0037 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = m_b*conj(N_d4)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0047 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0057 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_b*conj(N_d1)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0144 = IT_0086*IT_0143;
