        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0039 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0040 = IT_0001*IT_0039;
    const ccomplex_t IT_0041 = 1.4142135623731*IT_0040;
    const ccomplex_t IT_0042 = m_b*conj(N_d2)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0079 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0080 = IT_0001*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = m_b*conj(N_d4)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0118 = IT_0070*IT_0117;
