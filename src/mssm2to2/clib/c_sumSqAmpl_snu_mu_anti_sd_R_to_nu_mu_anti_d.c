...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_sd_R_to_nu_mu_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0001;
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0001;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0001;
