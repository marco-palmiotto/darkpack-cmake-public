...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_snu_mu_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = IT_0002*IT_0016;
    const ccomplex_t IT_0036 = IT_0003 + IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_W*e_em*(IT_0006*IT_0007 + 
      -IT_0010*IT_0011)*IT_0036;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = pow(m_H0, 2);
    const ccomplex_t IT_0040 = cpow((-2)*s_23 + IT_0039 + reg_prop + (0 +
