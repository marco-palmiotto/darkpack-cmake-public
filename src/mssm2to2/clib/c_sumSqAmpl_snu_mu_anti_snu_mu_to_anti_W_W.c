        ...
        )
{
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009;
    const ccomplex_t IT_0070 = (-0.5)*IT_0069;
    const ccomplex_t IT_0071 = -IT_0069;
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = pow(m_W, 2);
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0018 + IT_0073 + -m_smu_L*
    ...
    const ccomplex_t IT_0102 = -(s_12 + -IT_0063)*(IT_0018 + -IT_0101);
    const ccomplex_t IT_0103 = IT_0031*IT_0035;
    const ccomplex_t IT_0104 = IT_0030*IT_0103;
    const ccomplex_t IT_0105 = s_14*s_34*IT_0062;
    const ccomplex_t IT_0106 = -(IT_0018 + -IT_0101)*(s_13 + -IT_0105);
    const ccomplex_t IT_0107 = pow(s_14, 2);
    const ccomplex_t IT_0108 = IT_0062*IT_0107;
    const ccomplex_t IT_0109 = -(s_12 + -IT_0065)*(IT_0018 + -IT_0108);
    const ccomplex_t IT_0110 = IT_0030*(IT_0047 + IT_0057);
    const ccomplex_t IT_0111 = -IT_0110;
    const ccomplex_t IT_0112 = -IT_0111;
    const ccomplex_t IT_0113 = (s_12 + -IT_0063)*(s_12 + -IT_0065);
    const ccomplex_t IT_0114 = -(IT_0018 + -IT_0094)*(IT_0018 + -IT_0101);
    const ccomplex_t IT_0115 = -IT_0114;
    const ccomplex_t IT_0116 = IT_0031*IT_0041;
    ...
    const ccomplex_t IT_0121 = s_24*s_34*IT_0062;
    const ccomplex_t IT_0122 = (s_12 + -IT_0065)*(s_23 + -IT_0121);
    const ccomplex_t IT_0123 = -conj(IT_0111);
    const ccomplex_t IT_0124 = (s_12 + -IT_0065)*(s_13 + -IT_0105);
    const ccomplex_t IT_0125 = -(IT_0018 + -IT_0097)*(IT_0018 + -IT_0108);
    const ccomplex_t IT_0126 = -IT_0125;
    const ccomplex_t IT_0127 = -(IT_0018 + -IT_0101)*(s_23 + -IT_0121);
    const ccomplex_t IT_0128 = (s_12 + -IT_0065)*(IT_0018 + -IT_0094);
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = -IT_0060;
    const ccomplex_t IT_0131 = s_34*IT_0062;
    const ccomplex_t IT_0132 = s_13*s_34*IT_0062;
    const ccomplex_t IT_0133 = -IT_0132;
    const ccomplex_t IT_0134 = s_14 + IT_0133;
    const ccomplex_t IT_0135 = IT_0131*IT_0134;
    const ccomplex_t IT_0136 = s_23*s_34*IT_0062;
    const ccomplex_t IT_0137 = -IT_0136;
    const ccomplex_t IT_0138 = s_24 + IT_0137;
    const ccomplex_t IT_0139 = IT_0131*IT_0138;
    const ccomplex_t IT_0140 = -IT_0018;
    const ccomplex_t IT_0141 = s_13*s_14*s_34*IT_0053;
    const ccomplex_t IT_0142 = -IT_0141;
    const ccomplex_t IT_0143 = IT_0101 + IT_0108 + IT_0140 + IT_0142;
    const ccomplex_t IT_0144 = -IT_0052;
    const ccomplex_t IT_0145 = IT_0054*IT_0062;
    const ccomplex_t IT_0146 = -(IT_0018 + -IT_0101)*(IT_0073 + -IT_0145);
    const ccomplex_t IT_0147 = (s_12 + -IT_0065)*(IT_0073 + -IT_0145);
    const ccomplex_t IT_0148 = -conj(IT_0060);
    const ccomplex_t IT_0149 = -conj(IT_0052);
    const ccomplex_t IT_0150 = (IT_0101 + IT_0140)*(IT_0108 + IT_0140);
    const ccomplex_t IT_0151 = (s_12 + -IT_0063)*(IT_0018 + -IT_0097);
    const ccomplex_t IT_0152 = -IT_0151;
    const ccomplex_t IT_0153 = (IT_0018 + -IT_0097)*(s_13 + -IT_0105);
    const ccomplex_t IT_0154 = -IT_0153;
    const ccomplex_t IT_0155 = -IT_0081;
    const ccomplex_t IT_0156 = (IT_0018 + -IT_0094)*(IT_0018 + -IT_0097);
    const ccomplex_t IT_0157 = -conj(IT_0081);
    const ccomplex_t IT_0158 = (IT_0018 + -IT_0097)*(s_23 + -IT_0121);
    const ccomplex_t IT_0159 = -IT_0158;
    const ccomplex_t IT_0160 = -conj(IT_0120);
    const ccomplex_t IT_0161 = (IT_0018 + -IT_0097)*(IT_0073 + -IT_0145);
    const ccomplex_t IT_0162 = -IT_0161;
    const ccomplex_t IT_0163 = 2*IT_0052*(conj(IT_0052)*(1 + 0.5*IT_0055) +
       0.5*conj(IT_0060)*IT_0068 + 0.5*conj(IT_0081)*IT_0083 + 0.5*conj(IT_0091)
      *IT_0099) + (conj(IT_0060)*IT_0102 + conj(IT_0104)*IT_0106 + conj(IT_0081)
      *IT_0109)*IT_0112 + IT_0060*(conj(IT_0052)*IT_0068 + conj(IT_0081)*IT_0113
       + conj(IT_0060)*IT_0115 + conj(IT_0120)*IT_0122 + IT_0102*IT_0123) +
       IT_0081*(conj(IT_0052)*IT_0083 + conj(IT_0060)*IT_0113 + IT_0109*IT_0123 
      + conj(IT_0104)*IT_0124 + conj(IT_0081)*IT_0126) + (conj(IT_0104)*IT_0127 
      + conj(IT_0091)*IT_0129)*IT_0130 + (conj(IT_0104)*IT_0135 + conj(IT_0120)
      *IT_0139 + conj(IT_0111)*IT_0143)*IT_0144 + IT_0104*(conj(IT_0091)*IT_0122
       + IT_0106*IT_0123 + conj(IT_0081)*IT_0124 + -conj(IT_0104)*IT_0146 + conj
      (IT_0120)*IT_0147 + IT_0127*IT_0148 + IT_0135*IT_0149) + IT_0111*(conj
      (IT_0091)*IT_0113 + conj(IT_0120)*IT_0124 + IT_0143*IT_0149 + conj(IT_0111
      )*IT_0150) + (conj(IT_0091)*IT_0152 + conj(IT_0120)*IT_0154)*IT_0155 +
       IT_0091*(conj(IT_0052)*IT_0099 + conj(IT_0111)*IT_0113 + conj(IT_0104)
      *IT_0122 + IT_0129*IT_0148 + conj(IT_0091)*IT_0156 + IT_0152*IT_0157 +
       IT_0159*IT_0160) + IT_0120*(conj(IT_0060)*IT_0122 + conj(IT_0111)*IT_0124
       + conj(IT_0104)*IT_0147 + IT_0139*IT_0149 + IT_0154*IT_0157 + -conj
