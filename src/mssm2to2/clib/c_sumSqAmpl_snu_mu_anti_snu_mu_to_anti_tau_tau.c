...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_snu_mu_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = m_tau*IT_0018;
    const ccomplex_t IT_0020 = m_tau*IT_0005;
    ...
    const ccomplex_t IT_0026 = s_13*m_tau;
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*m_tau*IT_0003*IT_0027
      *IT_0029*IT_0030;
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + (-2)*IT_0012 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*m_tau*IT_0003*IT_0027
      *IT_0029*IT_0037;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_W*e_em*IT_0035*(IT_0030
      *IT_0036 + IT_0028*IT_0037);
