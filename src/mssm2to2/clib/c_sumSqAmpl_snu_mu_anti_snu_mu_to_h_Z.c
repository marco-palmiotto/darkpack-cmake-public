...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_snu_mu_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = IT_0002*IT_0017;
    const ccomplex_t IT_0036 = IT_0003 + IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_W*e_em*(IT_0007*IT_0009 +
       IT_0011*IT_0012)*IT_0036;
