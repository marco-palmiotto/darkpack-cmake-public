...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_snu_mu_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_23 + IT_0027 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0032 = cpow((-2)*s_13 + IT_0027 + reg_prop + (0 +
       _Complex_I*1)*m_snu_mu*Gamma_numl, -1);
