...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_snu_tau_to_nu_mu_anti_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0022 = cpow(s_13 + (-0.5)*IT_0021 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0042 = cpow(s_13 + (-0.5)*IT_0021 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0053 = N_B2*e_em;
    const ccomplex_t IT_0054 = IT_0001*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = N_W2*e_em;
    ...
    const ccomplex_t IT_0062 = cpow(s_13 + (-0.5)*IT_0021 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0082 = cpow(s_13 + (-0.5)*IT_0021 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0085 = 0.5*IT_0024 + 0.5*IT_0044 + 0.5*IT_0064 + 0.5
      *IT_0084;
    const ccomplex_t IT_0086 = s_13*s_14;
    const ccomplex_t IT_0087 = s_34*IT_0021;
    return create_ccomplex_return(4*IT_0085*conj(IT_0085)*(IT_0086 + (-0.5)
      *IT_0087));
}
