...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_st_1_to_nu_mu_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0057 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_t*conj(N_u4)*e_em*IT_0018*conj(U_st_00);
    ...
    const ccomplex_t IT_0077 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0078 = IT_0001*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = m_t*conj(N_u3)*e_em*IT_0018*conj(U_st_00);
