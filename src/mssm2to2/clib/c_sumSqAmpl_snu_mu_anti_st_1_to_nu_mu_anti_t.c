        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B4)*e_em*conj(U_st_10);
    ...
    const ccomplex_t IT_0019 = m_t*conj(N_u4)*e_em*IT_0018*conj(U_st_00);
    ...
    const ccomplex_t IT_0057 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_t*conj(N_u3)*e_em*IT_0018*conj(U_st_00);
    ...
    const ccomplex_t IT_0067 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0077 = conj(N_B1)*e_em*conj(U_st_10);
    const ccomplex_t IT_0078 = IT_0001*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = m_t*conj(N_u1)*e_em*IT_0018*conj(U_st_00);
    ...
    const ccomplex_t IT_0143 = IT_0076*IT_0142;
