        ...
        )
{
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0003*IT_0005*IT_0043;
    ...
    const ccomplex_t IT_0058 = m_mu*IT_0010;
    const ccomplex_t IT_0059 = m_mu*IT_0014;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0003*IT_0005*IT_0043*conj(U_st_01);
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = IT_0035*IT_0066;
    const ccomplex_t IT_0068 = IT_0036*IT_0048*IT_0067;
    ...
    const ccomplex_t IT_0084 = m_b*m_mu*IT_0019;
    ...
    const ccomplex_t IT_0091 = m_b*m_mu;
    const ccomplex_t IT_0092 = (-6)*IT_0063;
    const ccomplex_t IT_0093 = (-6)*conj(IT_0063);
    const ccomplex_t IT_0094 = -conj(IT_0040);
    const ccomplex_t IT_0095 = 6*IT_0040*(conj(IT_0063)*IT_0064 + -conj
      (IT_0081)*IT_0082 + -conj(IT_0083)*IT_0084 + 0.166666666666667*conj
      (IT_0040)*IT_0089) + 6*IT_0063*(conj(IT_0040)*IT_0064 + 0.166666666666667
      *conj(IT_0063)*IT_0090) + (IT_0082*conj(IT_0083) + conj(IT_0081)*IT_0091)
      *IT_0092 + 6*IT_0081*(IT_0064*conj(IT_0083) + 0.166666666666667*conj
      (IT_0081)*IT_0090 + 0.166666666666667*IT_0091*IT_0093 + IT_0082*IT_0094) +
       6*IT_0083*(IT_0064*conj(IT_0081) + 0.166666666666667*conj(IT_0083)
      *IT_0089 + 0.166666666666667*IT_0082*IT_0093 + IT_0084*IT_0094);
