...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_st_2_to_nu_mu_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0047 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0060 = m_t*conj(N_u4)*e_em*IT_0018*conj(U_st_01);
    ...
    const ccomplex_t IT_0067 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0077 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0078 = IT_0001*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = m_t*conj(N_u3)*e_em*IT_0018*conj(U_st_01);
    ...
    const ccomplex_t IT_0087 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_3*(m_N_3 +
