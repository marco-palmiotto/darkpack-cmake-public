...
ccomplex_return_t c_sumSqAmpl_snu_mu_anti_su_L_to_mu_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp2*IT_0001;
    ...
    const ccomplex_t IT_0032 = m_mu*IT_0010;
    ...
    const ccomplex_t IT_0055 = m_d*m_mu*IT_0007;
    ...
    const ccomplex_t IT_0061 = m_d*m_mu;
