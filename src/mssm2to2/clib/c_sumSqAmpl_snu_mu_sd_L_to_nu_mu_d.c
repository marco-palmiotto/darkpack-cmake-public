...
ccomplex_return_t c_sumSqAmpl_snu_mu_sd_L_to_nu_mu_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0016 = pow(m_snu_mu, 2);
    const ccomplex_t IT_0017 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0032 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0035 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*(IT_0038 + -IT_0041);
    const ccomplex_t IT_0045 = (-0.5)*IT_0044;
    const ccomplex_t IT_0046 = IT_0043*IT_0045;
    const ccomplex_t IT_0047 = IT_0034*IT_0035*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0049 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*(IT_0052 + (-3)*IT_0055);
    const ccomplex_t IT_0059 = 0.166666666666667*IT_0058;
    const ccomplex_t IT_0060 = IT_0057*IT_0059;
    const ccomplex_t IT_0061 = IT_0048*IT_0049*IT_0060;
    const ccomplex_t IT_0062 = 0.5*IT_0033 + 0.5*IT_0047 + 0.5*IT_0061;
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0006*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0006*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0006*IT_0063*IT_0065;
    ...
    const ccomplex_t IT_0086 = 0.5*IT_0070 + 0.5*IT_0075 + 0.5*IT_0080 + 0.5
      *IT_0085;
    const ccomplex_t IT_0087 = m_d*s_13;
    const ccomplex_t IT_0088 = s_13*s_14;
    const ccomplex_t IT_0089 = s_34*IT_0016;
    const ccomplex_t IT_0090 = (-6)*s_34;
    const ccomplex_t IT_0091 = 6*s_34*(IT_0019*conj(IT_0019) + IT_0062*conj
      (IT_0062)) + 6*((conj(IT_0019) + -conj(IT_0062))*IT_0086 + (IT_0019 + 
      -IT_0062)*conj(IT_0086))*IT_0087 + IT_0086*conj(IT_0086)*(12*IT_0088 + (-6
      )*IT_0089) + (conj(IT_0019)*IT_0062 + IT_0019*conj(IT_0062))*IT_0090;
