        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0002;
    const ccomplex_t IT_0004 = pow(m_W, -1);
    const ccomplex_t IT_0005 = cos(beta);
    const ccomplex_t IT_0006 = cpow(IT_0005, -1);
    const ccomplex_t IT_0007 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0002*IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0002;
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0002*IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0002*IT_0004*IT_0006;
    const ccomplex_t IT_0028 = 0.5*IT_0027;
    const ccomplex_t IT_0029 = IT_0015*IT_0028;
    const ccomplex_t IT_0030 = IT_0019*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*IT_0030;
    const ccomplex_t IT_0032 = m_mu*IT_0031;
    ...
    return create_ccomplex_return(6*IT_0033*(s_34*conj(IT_0033) + -conj
      (IT_0034)*IT_0035) + (-6)*IT_0034*(conj(IT_0033)*IT_0035 + (
      -0.166666666666667)*conj(IT_0034)*(12*IT_0036 + (-6)*IT_0037)));
}
