        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0049 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0052 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0006*IT_0012*IT_0014;
