...
ccomplex_return_t c_sumSqAmpl_snu_mu_sd_R_to_nu_mu_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    return create_ccomplex_return(6*IT_0064*(s_34*conj(IT_0064) + conj(IT_0085
      )*IT_0086) + 6*IT_0085*(conj(IT_0064)*IT_0086 + 0.166666666666667*conj
      (IT_0085)*(12*IT_0087 + (-6)*IT_0088)));
}
