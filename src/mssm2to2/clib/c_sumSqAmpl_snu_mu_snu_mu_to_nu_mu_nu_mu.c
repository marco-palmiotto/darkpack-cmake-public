...
ccomplex_return_t c_sumSqAmpl_snu_mu_snu_mu_to_nu_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow(s_23 + (-0.5)*IT_0014 + 0.5*m_N_1*(m_N_1 +
       (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0016 = IT_0013*IT_0015;
    const ccomplex_t IT_0017 = cpow(s_13 + (-0.5)*IT_0014 + 0.5*m_N_1*(m_N_1 +
       (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0031 = cpow(s_23 + (-0.5)*IT_0014 + 0.5*m_N_2*(m_N_2 +
       (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_N_3*IT_0041;
    const ccomplex_t IT_0043 = cpow(s_23 + (-0.5)*IT_0014 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = cpow(s_13 + (-0.5)*IT_0014 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*m_N_4*IT_0055;
    const ccomplex_t IT_0057 = cpow(s_13 + (-0.5)*IT_0014 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = cpow(s_23 + (-0.5)*IT_0014 + 0.5*m_N_4*(m_N_4 +
       (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0056*IT_0059;
    const ccomplex_t IT_0061 = 0.5*IT_0016 + 0.5*IT_0018 + 0.5*IT_0030 + 0.5
      *IT_0032 + 0.5*IT_0044 + 0.5*IT_0046 + 0.5*IT_0058 + 0.5*IT_0060;
