...
ccomplex_return_t c_sumSqAmpl_snu_mu_ss_L_to_nu_mu_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0045 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0048 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*(IT_0051 + (-3)*IT_0054);
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0006*IT_0062*IT_0064;
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = IT_0030*IT_0076;
    const ccomplex_t IT_0078 = IT_0020*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0006*IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0091 = pow(m_ss_L, 2);
