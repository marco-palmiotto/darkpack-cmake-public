...
ccomplex_return_t c_sumSqAmpl_snu_mu_ss_R_to_nu_mu_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = IT_0029*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0034 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0049 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0062 = m_s*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0064 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0076 = IT_0063*IT_0064*IT_0075;
    ...
    const ccomplex_t IT_0089 = (-0.5)*IT_0050 + 0.5*IT_0056 + 0.5*IT_0062 + (
      -0.5)*IT_0076 + 0.5*IT_0082 + 0.5*IT_0088;
    const ccomplex_t IT_0090 = 0.5*IT_0055 + 0.5*IT_0061 + 0.5*IT_0081 + 0.5
      *IT_0087;
    const ccomplex_t IT_0091 = m_s*s_23;
    const ccomplex_t IT_0092 = s_23*s_24;
    const ccomplex_t IT_0093 = pow(m_ss_R, 2);
    const ccomplex_t IT_0094 = s_34*IT_0093;
    const ccomplex_t IT_0095 = (-6)*s_34;
    const ccomplex_t IT_0096 = 6*s_34*(IT_0036*conj(IT_0036) + IT_0089*conj
      (IT_0089)) + 6*((conj(IT_0036) + -conj(IT_0089))*IT_0090 + (IT_0036 + 
      -IT_0089)*conj(IT_0090))*IT_0091 + IT_0090*conj(IT_0090)*(12*IT_0092 + (-6
      )*IT_0094) + (conj(IT_0036)*IT_0089 + IT_0036*conj(IT_0089))*IT_0095;
