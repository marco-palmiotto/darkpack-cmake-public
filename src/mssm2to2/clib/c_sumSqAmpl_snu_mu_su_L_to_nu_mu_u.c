...
ccomplex_return_t c_sumSqAmpl_snu_mu_su_L_to_nu_mu_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*(IT_0007 + 3*IT_0012);
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*(IT_0021 + -IT_0024);
    const ccomplex_t IT_0028 = (-0.5)*IT_0027;
    const ccomplex_t IT_0029 = IT_0026*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0031 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0045 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0009*IT_0062*IT_0064;
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = IT_0014*IT_0066;
    const ccomplex_t IT_0068 = IT_0002*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0009*IT_0062*IT_0064;
    const ccomplex_t IT_0071 = (-0.5)*IT_0070;
    const ccomplex_t IT_0072 = IT_0028*IT_0071;
    const ccomplex_t IT_0073 = IT_0031*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0009*IT_0062*IT_0064;
    const ccomplex_t IT_0076 = (-0.5)*IT_0075;
    const ccomplex_t IT_0077 = IT_0042*IT_0076;
    const ccomplex_t IT_0078 = IT_0045*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0009*IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0085 = IT_0069 + IT_0074 + IT_0079 + IT_0084;
    const ccomplex_t IT_0086 = m_u*IT_0085;
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = 0.5*IT_0069 + 0.5*IT_0074 + 0.5*IT_0079 + 0.5
      *IT_0084;
    const ccomplex_t IT_0089 = m_u*s_23;
    const ccomplex_t IT_0090 = s_23*s_24;
    const ccomplex_t IT_0091 = pow(m_su_L, 2);
    const ccomplex_t IT_0092 = s_34*IT_0091;
    const ccomplex_t IT_0093 = (-6)*s_34;
    const ccomplex_t IT_0094 = 6*s_34*(IT_0061*conj(IT_0061) + IT_0087*conj
      (IT_0087)) + 6*((conj(IT_0061) + -conj(IT_0087))*IT_0088 + (IT_0061 + 
      -IT_0087)*conj(IT_0088))*IT_0089 + IT_0088*conj(IT_0088)*(12*IT_0090 + (-6
      )*IT_0092) + (conj(IT_0061)*IT_0087 + IT_0061*conj(IT_0087))*IT_0093;
