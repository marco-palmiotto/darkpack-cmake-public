        ...
        )
{
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0006*IT_0061*IT_0063;
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0006*IT_0061*IT_0063;
    ...
    const ccomplex_t IT_0088 = (-0.5)*IT_0018 + (-0.5)*IT_0032 + (-0.5)
      *IT_0046 + (-0.5)*IT_0060 + 0.5*IT_0069 + 0.5*IT_0075 + 0.5*IT_0081 + 0.5
      *IT_0087;
    const ccomplex_t IT_0089 = 0.5*IT_0068 + 0.5*IT_0074 + 0.5*IT_0080 + 0.5
      *IT_0086;
    const ccomplex_t IT_0090 = m_u*s_23;
    const ccomplex_t IT_0091 = s_23*s_24;
    const ccomplex_t IT_0092 = pow(m_su_L, 2);
    const ccomplex_t IT_0093 = s_34*IT_0092;
    return create_ccomplex_return(6*IT_0088*(s_34*conj(IT_0088) + -conj
      (IT_0089)*IT_0090) + (-6)*IT_0089*(conj(IT_0088)*IT_0090 + (
      -0.166666666666667)*conj(IT_0089)*(12*IT_0091 + (-6)*IT_0093)));
}
