        ...
        )
{
    ...
    const ccomplex_t IT_0050 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0059 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0060 = IT_0004*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = m_b*conj(N_d4)*e_em*IT_0021*conj(U_sb_00);
    ...
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0074 = m_b*conj(N_d3)*e_em*IT_0021*conj(U_sb_00);
