...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_sb_1_to_nu_tau_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0022 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0023 = IT_0004*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*(IT_0021 + 0.666666666666667
      *IT_0024);
    ...
    const ccomplex_t IT_0029 = IT_0000*IT_0002*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0031 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0040 = conj(N_B1)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0041 = IT_0004*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = m_b*conj(N_d1)*e_em*IT_0018*conj(U_sb_00);
    ...
    const ccomplex_t IT_0049 = IT_0030*IT_0031*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0051 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0060 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0061 = IT_0004*IT_0060;
    const ccomplex_t IT_0062 = 1.4142135623731*IT_0061;
    const ccomplex_t IT_0063 = m_b*conj(N_d2)*e_em*IT_0018*conj(U_sb_00);
    ...
    const ccomplex_t IT_0071 = IT_0050*IT_0051*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0073 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0082 = m_b*conj(N_d4)*e_em*IT_0018*conj(U_sb_00);
    const ccomplex_t IT_0083 = IT_0017*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = conj(N_B4)*e_em*conj(U_sb_10);
    ...
    const ccomplex_t IT_0093 = 0.5*IT_0029 + 0.5*IT_0049 + 0.5*IT_0071 + 0.5
      *IT_0092;
    const ccomplex_t IT_0094 = m_b*N_d1*e_em*IT_0018*conj(U_sb_10);
    ...
    const ccomplex_t IT_0113 = m_b*N_d2*e_em*IT_0018*conj(U_sb_10);
    ...
    const ccomplex_t IT_0128 = m_b*N_d3*e_em*IT_0018*conj(U_sb_10);
    ...
    const ccomplex_t IT_0143 = m_b*N_d4*e_em*IT_0018*conj(U_sb_10);
