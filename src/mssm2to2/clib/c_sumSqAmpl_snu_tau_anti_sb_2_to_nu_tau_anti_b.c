...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_sb_2_to_nu_tau_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B4)*e_em*conj(U_sb_11);
    ...
    const ccomplex_t IT_0037 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = m_b*conj(N_d1)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0047 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_1*(m_N_1 +
       (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0045*IT_0046*IT_0047;
    const ccomplex_t IT_0049 = conj(N_B2)*e_em;
    const ccomplex_t IT_0050 = IT_0001*IT_0049;
    const ccomplex_t IT_0051 = 1.4142135623731*IT_0050;
    const ccomplex_t IT_0052 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0057 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_b*conj(N_d2)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0067 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0071 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0072 = IT_0001*IT_0071;
    const ccomplex_t IT_0073 = 1.4142135623731*IT_0072;
    const ccomplex_t IT_0074 = m_b*conj(N_d3)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0144 = IT_0056*IT_0143;
    const ccomplex_t IT_0145 = IT_0067*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*IT_0145;
    const ccomplex_t IT_0147 = 0.5*IT_0104 + 0.5*IT_0118 + 0.5*IT_0132 + 0.5
      *IT_0146;
    const ccomplex_t IT_0148 = m_b*s_13;
    const ccomplex_t IT_0149 = s_13*s_14;
    const ccomplex_t IT_0150 = s_34*IT_0026;
    return create_ccomplex_return(6*IT_0089*(s_34*conj(IT_0089) + -conj
      (IT_0147)*IT_0148) + (-6)*IT_0147*(conj(IT_0089)*IT_0148 + (
      -0.166666666666667)*conj(IT_0147)*(12*IT_0149 + (-6)*IT_0150)));
}
