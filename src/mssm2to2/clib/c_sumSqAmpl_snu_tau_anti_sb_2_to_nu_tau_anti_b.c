        ...
        )
{
    ...
    const ccomplex_t IT_0019 = m_b*conj(N_d1)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0027 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0030 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0039 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0040 = IT_0001*IT_0039;
    const ccomplex_t IT_0041 = 1.4142135623731*IT_0040;
    const ccomplex_t IT_0042 = m_b*conj(N_d4)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0050 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0059 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0060 = IT_0001*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = m_b*conj(N_d3)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0026 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0079 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0080 = IT_0001*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = m_b*conj(N_d2)*e_em*IT_0018*conj(U_sb_01);
    ...
    const ccomplex_t IT_0108 = m_b*N_d4*e_em*IT_0018*conj(U_sb_11);
    const ccomplex_t IT_0109 = IT_0017*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = N_B4*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0148 = IT_0050*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*IT_0148;
    const ccomplex_t IT_0150 = 0.5*IT_0104 + 0.5*IT_0119 + 0.5*IT_0134 + 0.5
      *IT_0149;
    const ccomplex_t IT_0151 = m_b*s_13;
    const ccomplex_t IT_0152 = s_13*s_14;
    const ccomplex_t IT_0153 = s_34*IT_0026;
