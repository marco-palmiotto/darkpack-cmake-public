...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1)*m_W*e_em*(IT_0002*IT_0004 + 
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_W*e_em*(IT_0002*IT_0003 +
       IT_0004*IT_0005)*IT_0011;
