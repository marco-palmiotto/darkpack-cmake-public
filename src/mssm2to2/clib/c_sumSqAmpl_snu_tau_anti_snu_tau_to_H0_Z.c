...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow(IT_0000, -4);
    const ccomplex_t IT_0025 = IT_0002*IT_0009*IT_0010*IT_0024;
    const ccomplex_t IT_0026 = IT_0002*IT_0011*IT_0012*IT_0024;
    const ccomplex_t IT_0027 = cpow(IT_0002, -3);
    const ccomplex_t IT_0028 = IT_0009*IT_0010*IT_0027;
    const ccomplex_t IT_0029 = IT_0011*IT_0012*IT_0027;
    const ccomplex_t IT_0030 = IT_0003*IT_0006*IT_0009*IT_0010;
    const ccomplex_t IT_0031 = IT_0003*IT_0006*IT_0011*IT_0012;
    const ccomplex_t IT_0032 = cpow(IT_0002, -2);
    const ccomplex_t IT_0033 = cpow(IT_0006 + IT_0032, -1);
    const ccomplex_t IT_0034 = (IT_0025 + IT_0026 + IT_0028 + IT_0029 + 2
      *IT_0030 + 2*IT_0031)*IT_0033;
