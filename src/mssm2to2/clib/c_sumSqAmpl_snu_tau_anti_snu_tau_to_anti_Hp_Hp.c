        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*(A_tau*IT_0007*conj
      (U_stau_10) + (-1.4142135623731)*e_em*IT_0014*(m_W*IT_0001*IT_0007*conj
      (U_stau_00) + (-0.5)*m_tau*IT_0033*(m_tau*IT_0007*IT_0034*conj(U_stau_00) 
      + mu_h*conj(U_stau_10))));
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*(A_tau*IT_0007*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0014*(m_W*IT_0001*IT_0007*U_stau_00 + (-0.5)
      *m_tau*IT_0033*(m_tau*IT_0007*IT_0034*U_stau_00 + mu_h*U_stau_10)));
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = pow(m_Hp, 2);
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0029 + IT_0038 + reg_prop +
       -m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1), -1);
    const ccomplex_t IT_0040 = IT_0037*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*(A_tau*IT_0007*conj
      (U_stau_11) + (-1.4142135623731)*e_em*IT_0014*(m_W*IT_0001*IT_0007*conj
      (U_stau_01) + (-0.5)*m_tau*IT_0033*(m_tau*IT_0007*IT_0034*conj(U_stau_01) 
      + mu_h*conj(U_stau_11))));
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*(A_tau*IT_0007*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0014*(m_W*IT_0001*IT_0007*U_stau_01 + (-0.5)
      *m_tau*IT_0033*(m_tau*IT_0007*IT_0034*U_stau_01 + mu_h*U_stau_11)));
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0029 + IT_0038 + reg_prop +
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0019 +
       IT_0007*IT_0022)*IT_0025;
    const ccomplex_t IT_0072 = 0.5*IT_0071;
    const ccomplex_t IT_0073 = -IT_0014 + IT_0016;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*m_W*e_em*(IT_0018*IT_0022
      *IT_0073 + IT_0001*(IT_0008*IT_0019*IT_0021 + -IT_0001*(IT_0007*IT_0021
      *IT_0022 + IT_0001*IT_0019*IT_0073)));
