...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_c*e_em*IT_0000*IT_0002
      *IT_0005*IT_0013;
    ...
    const ccomplex_t IT_0053 = m_c*IT_0052;
    const ccomplex_t IT_0054 = (-0.5)*IT_0032;
    const ccomplex_t IT_0055 = m_c*IT_0054;
    const ccomplex_t IT_0056 = m_c*IT_0033;
    ...
    const ccomplex_t IT_0063 = m_c*s_14;
    const ccomplex_t IT_0064 = (-6)*IT_0044;
    const ccomplex_t IT_0065 = m_c*s_13;
