...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0055 = m_d*IT_0054;
    const ccomplex_t IT_0056 = m_d*IT_0033;
    ...
    const ccomplex_t IT_0063 = m_d*s_14;
    const ccomplex_t IT_0064 = (-6)*IT_0044;
    const ccomplex_t IT_0065 = m_d*s_13;
