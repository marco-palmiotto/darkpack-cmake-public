...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = m_mu*s_13;
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0028
      *IT_0030*IT_0031;
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*m_W*e_em*IT_0036*(IT_0029
      *IT_0031 + IT_0037*IT_0038);
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0028
      *IT_0030*IT_0037;
    const ccomplex_t IT_0046 = (-0.5)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_W*e_em*IT_0036*(IT_0029
      *IT_0037 + -IT_0031*IT_0038);
    const ccomplex_t IT_0048 = (-0.5)*IT_0047;
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + (-2)*IT_0012 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0058 = s_34*IT_0012;
    const ccomplex_t IT_0059 = (-0.5)*IT_0058;
    const ccomplex_t IT_0060 = IT_0057 + IT_0059;
    const ccomplex_t IT_0061 = (IT_0019 + -IT_0020)*(IT_0015 + -IT_0023);
    const ccomplex_t IT_0062 = pow(m_mu, 2);
    const ccomplex_t IT_0063 = IT_0005*IT_0023;
    const ccomplex_t IT_0064 = -IT_0063;
    const ccomplex_t IT_0065 = -IT_0062;
    const ccomplex_t IT_0066 = s_34 + IT_0065;
    const ccomplex_t IT_0067 = 2*s_34;
    const ccomplex_t IT_0068 = m_mu*s_14;
    const ccomplex_t IT_0069 = (-2)*IT_0017;
    const ccomplex_t IT_0070 = IT_0012*IT_0062;
    const ccomplex_t IT_0071 = (-2)*conj(IT_0026);
    const ccomplex_t IT_0072 = (-2)*conj(IT_0017);
    const ccomplex_t IT_0073 = 0.5*IT_0026;
    const ccomplex_t IT_0074 = 2*conj(IT_0017)*(IT_0026*IT_0027 + IT_0053
      *IT_0056 + 2*IT_0017*IT_0060) + (-2)*conj(IT_0061)*(IT_0026*IT_0062 + 
      -IT_0027*IT_0064 + -IT_0053*IT_0066 + (-0.5)*IT_0061*IT_0067 + (-0.5)
      *IT_0068*IT_0069) + 2*conj(IT_0064)*(IT_0053*IT_0056 + IT_0027*IT_0061 + 2
      *IT_0060*IT_0064 + -IT_0026*IT_0068 + 0.5*IT_0069*IT_0070) + IT_0061*
      (IT_0062*IT_0071 + IT_0068*IT_0072) + IT_0064*(IT_0068*IT_0071 + IT_0070
      *IT_0072) + 2*conj(IT_0053)*(IT_0056*(IT_0017 + IT_0064) + 2*IT_0066*
      (IT_0053 + 0.5*IT_0061 + IT_0073)) + 2*conj(IT_0026)*(IT_0017*IT_0027 +
       IT_0053*IT_0066 + IT_0067*IT_0073);
