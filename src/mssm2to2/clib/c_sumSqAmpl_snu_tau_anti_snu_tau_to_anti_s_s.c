...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0053 = m_s*IT_0052;
    const ccomplex_t IT_0054 = (-0.5)*IT_0032;
    const ccomplex_t IT_0055 = m_s*IT_0054;
    const ccomplex_t IT_0056 = m_s*IT_0033;
    ...
    const ccomplex_t IT_0063 = m_s*s_14;
    const ccomplex_t IT_0064 = (-6)*IT_0044;
    const ccomplex_t IT_0065 = m_s*s_13;
