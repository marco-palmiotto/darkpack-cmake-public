...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0001
      *IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_u*e_em*IT_0000*IT_0003
      *IT_0005*IT_0013;
    ...
    const ccomplex_t IT_0056 = m_u*IT_0033;
    ...
    const ccomplex_t IT_0063 = m_u*s_14;
    const ccomplex_t IT_0064 = (-6)*IT_0044;
    const ccomplex_t IT_0065 = m_u*s_13;
