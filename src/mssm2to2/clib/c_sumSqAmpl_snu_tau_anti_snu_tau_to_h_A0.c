...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_snu_tau_to_h_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0007;
    ...
    const ccomplex_t IT_0017 = (-0.5)*IT_0008;
    const ccomplex_t IT_0018 = -IT_0010;
    const ccomplex_t IT_0019 = IT_0017*IT_0018;
    const ccomplex_t IT_0020 = IT_0016*IT_0019;
    const ccomplex_t IT_0021 = IT_0014 + IT_0020;
    const ccomplex_t IT_0022 = IT_0009*IT_0018;
    const ccomplex_t IT_0023 = s_23*IT_0022;
    const ccomplex_t IT_0024 = IT_0011*IT_0017;
    ...
    return create_ccomplex_return(IT_0030*conj(IT_0030));
}
