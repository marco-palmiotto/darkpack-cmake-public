        ...
        )
{
    ...
    const ccomplex_t IT_0037 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = m_t*conj(N_u4)*e_em*IT_0018*conj(U_st_00);
