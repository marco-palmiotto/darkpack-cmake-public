        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B2)*e_em*conj(U_st_11);
    ...
    const ccomplex_t IT_0019 = m_t*conj(N_u2)*e_em*IT_0018*conj(U_st_01);
    ...
    const ccomplex_t IT_0057 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_t*conj(N_u1)*e_em*IT_0018*conj(U_st_01);
