        ...
        )
{
    ...
    const ccomplex_t IT_0004 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0005 = cpow(s_13 + (-0.5)*IT_0003 + (-0.5)*IT_0004 +
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0001;
    const ccomplex_t IT_0025 = cpow(s_13 + (-0.5)*IT_0003 + (-0.5)*IT_0004 +
       0.5*m_C_1*(m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*IT_0026;
    const ccomplex_t IT_0028 = m_t*V_tb*V_u1*e_em*IT_0011*conj(U_st_11);
    const ccomplex_t IT_0029 = IT_0010*IT_0028;
    const ccomplex_t IT_0030 = 1.4142135623731*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*IT_0030;
    const ccomplex_t IT_0032 = (-0.5)*IT_0031;
    const ccomplex_t IT_0033 = V_tb*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em
      *m_tau*IT_0001*IT_0011*IT_0043;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = IT_0038*IT_0045;
    const ccomplex_t IT_0047 = IT_0025*IT_0041*IT_0046;
    ...
    const ccomplex_t IT_0052 = IT_0005*IT_0048*IT_0051;
    const ccomplex_t IT_0053 = m_tau*IT_0016;
    const ccomplex_t IT_0054 = m_tau*IT_0020;
    const ccomplex_t IT_0055 = -IT_0054;
    const ccomplex_t IT_0056 = IT_0053 + IT_0055;
    const ccomplex_t IT_0057 = IT_0007*IT_0056;
    const ccomplex_t IT_0058 = m_tau*IT_0032;
    const ccomplex_t IT_0059 = m_tau*IT_0036;
    const ccomplex_t IT_0060 = -IT_0059;
    const ccomplex_t IT_0061 = IT_0058 + IT_0060;
    const ccomplex_t IT_0062 = IT_0027*IT_0061;
    const ccomplex_t IT_0063 = 0.5*IT_0047 + 0.5*IT_0052 + (-0.5)*IT_0057 + (
      -0.5)*IT_0062;
    const ccomplex_t IT_0064 = s_14*m_tau;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0001*IT_0011*IT_0043*conj(U_st_01);
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = IT_0024*IT_0066;
    const ccomplex_t IT_0068 = IT_0025*IT_0041*IT_0067;
    const ccomplex_t IT_0069 = IT_0045*IT_0066;
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0001*IT_0011*IT_0043*conj(U_st_01);
    const ccomplex_t IT_0074 = (-0.5)*IT_0073;
    const ccomplex_t IT_0075 = IT_0002*IT_0074;
    const ccomplex_t IT_0076 = IT_0005*IT_0048*IT_0075;
    const ccomplex_t IT_0077 = IT_0050*IT_0074;
    ...
    const ccomplex_t IT_0083 = (-0.5)*IT_0071 + (-0.5)*IT_0079;
    const ccomplex_t IT_0084 = m_b*m_tau*IT_0004;
    ...
    const ccomplex_t IT_0090 = m_b*m_tau;
