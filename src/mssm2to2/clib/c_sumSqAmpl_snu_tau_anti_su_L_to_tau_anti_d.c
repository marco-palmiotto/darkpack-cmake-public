...
ccomplex_return_t c_sumSqAmpl_snu_tau_anti_su_L_to_tau_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp2*IT_0001;
    const ccomplex_t IT_0003 = -IT_0002;
    const ccomplex_t IT_0004 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0001;
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*V_ud*e_em*V_Wp1*IT_0001;
    const ccomplex_t IT_0012 = -IT_0011;
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0001;
    ...
    const ccomplex_t IT_0027 = m_tau*IT_0017;
    const ccomplex_t IT_0028 = m_tau*IT_0010;
    ...
    const ccomplex_t IT_0033 = IT_0015*IT_0029*IT_0032;
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d1)
      *V_ud*e_em*IT_0001*IT_0020*IT_0022;
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = IT_0013*IT_0037;
    const ccomplex_t IT_0039 = IT_0015*IT_0029*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*m_d*conj(U_d2)
      *V_ud*e_em*IT_0001*IT_0020*IT_0022;
    const ccomplex_t IT_0041 = (-0.5)*IT_0040;
    const ccomplex_t IT_0042 = IT_0004*IT_0041;
    const ccomplex_t IT_0043 = IT_0008*IT_0019*IT_0042;
    ...
    const ccomplex_t IT_0052 = (-0.5)*IT_0039 + (-0.5)*IT_0043 + 0.5*IT_0047 +
       0.5*IT_0051;
    const ccomplex_t IT_0053 = m_d*s_13;
    const ccomplex_t IT_0054 = (-0.5)*IT_0046 + (-0.5)*IT_0050;
    const ccomplex_t IT_0055 = m_d*m_tau*IT_0007;
    ...
    const ccomplex_t IT_0062 = m_d*m_tau;
    const ccomplex_t IT_0063 = (-6)*IT_0034;
    const ccomplex_t IT_0064 = (-6)*conj(IT_0034);
    const ccomplex_t IT_0065 = -conj(IT_0018);
    const ccomplex_t IT_0066 = 6*IT_0018*(conj(IT_0034)*IT_0035 + -conj
      (IT_0052)*IT_0053 + -conj(IT_0054)*IT_0055 + 0.166666666666667*conj
      (IT_0018)*IT_0060) + 6*IT_0034*(conj(IT_0018)*IT_0035 + 0.166666666666667
      *conj(IT_0034)*IT_0061) + (IT_0053*conj(IT_0054) + conj(IT_0052)*IT_0062)
      *IT_0063 + 6*IT_0052*(IT_0035*conj(IT_0054) + 0.166666666666667*conj
      (IT_0052)*IT_0061 + 0.166666666666667*IT_0062*IT_0064 + IT_0053*IT_0065) +
       6*IT_0054*(IT_0035*conj(IT_0052) + 0.166666666666667*conj(IT_0054)
      *IT_0060 + 0.166666666666667*IT_0053*IT_0064 + IT_0055*IT_0065);
