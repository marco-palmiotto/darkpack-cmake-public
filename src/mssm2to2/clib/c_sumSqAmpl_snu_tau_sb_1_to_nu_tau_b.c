...
ccomplex_return_t c_sumSqAmpl_snu_tau_sb_1_to_nu_tau_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0022 = conj(N_B2)*e_em*U_sb_00;
    const ccomplex_t IT_0023 = IT_0004*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = conj(N_W2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0035 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_1*(m_N_1 +
       (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0036 = conj(N_B1)*e_em;
    const ccomplex_t IT_0037 = IT_0004*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = conj(N_W1)*e_em;
    ...
    const ccomplex_t IT_0044 = m_b*conj(N_d1)*e_em*IT_0018*U_sb_10;
    const ccomplex_t IT_0045 = IT_0017*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = conj(N_W1)*e_em*U_sb_00;
    const ccomplex_t IT_0048 = IT_0009*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0057 = IT_0034*IT_0035*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0059 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0081 = IT_0058*IT_0059*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0083 = cpow(s_13 + (-0.5)*IT_0001 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0105 = IT_0082*IT_0083*IT_0104;
    const ccomplex_t IT_0106 = 0.5*IT_0057 + 0.5*IT_0081 + 0.5*IT_0105;
    const ccomplex_t IT_0107 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0108 = IT_0004*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = m_b*N_d1*e_em*IT_0018*U_sb_00;
    ...
    const ccomplex_t IT_0118 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0119 = IT_0004*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = m_b*N_d2*e_em*IT_0018*U_sb_00;
    ...
    const ccomplex_t IT_0132 = m_b*N_d3*e_em*IT_0018*U_sb_00;
    ...
    const ccomplex_t IT_0143 = m_b*N_d4*e_em*IT_0018*U_sb_00;
    ...
    const ccomplex_t IT_0151 = 0.5*IT_0117 + 0.5*IT_0128 + 0.5*IT_0139 + 0.5
      *IT_0150;
    const ccomplex_t IT_0152 = m_b*s_13;
    const ccomplex_t IT_0153 = s_13*s_14;
    const ccomplex_t IT_0154 = s_34*IT_0001;
    const ccomplex_t IT_0155 = (-6)*s_34;
    const ccomplex_t IT_0156 = 6*s_34*(IT_0033*conj(IT_0033) + IT_0106*conj
      (IT_0106)) + 6*((conj(IT_0033) + -conj(IT_0106))*IT_0151 + (IT_0033 + 
      -IT_0106)*conj(IT_0151))*IT_0152 + IT_0151*conj(IT_0151)*(12*IT_0153 + (-6
      )*IT_0154) + (conj(IT_0033)*IT_0106 + IT_0033*conj(IT_0106))*IT_0155;
