        ...
        )
{
    ...
    const ccomplex_t IT_0015 = conj(N_W2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0022 = m_b*conj(N_d2)*e_em*IT_0021*U_sb_11;
    ...
    const ccomplex_t IT_0104 = IT_0082*IT_0083*IT_0103;
    const ccomplex_t IT_0105 = 0.5*IT_0057 + 0.5*IT_0081 + 0.5*IT_0104;
    const ccomplex_t IT_0106 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0107 = IT_0004*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = m_b*N_d1*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0120 = m_b*N_d2*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0131 = m_b*N_d4*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0137 = IT_0083*IT_0136;
    ...
    const ccomplex_t IT_0142 = m_b*N_d3*e_em*IT_0021*U_sb_01;
    ...
    const ccomplex_t IT_0155 = 6*s_34*(IT_0033*conj(IT_0033) + IT_0105*conj
      (IT_0105)) + 6*((conj(IT_0033) + -conj(IT_0105))*IT_0150 + (IT_0033 + 
      -IT_0105)*conj(IT_0150))*IT_0151 + IT_0150*conj(IT_0150)*(12*IT_0152 + (-6
      )*IT_0153) + (conj(IT_0033)*IT_0105 + IT_0033*conj(IT_0105))*IT_0154;
