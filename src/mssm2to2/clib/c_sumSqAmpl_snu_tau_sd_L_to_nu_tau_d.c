...
ccomplex_return_t c_sumSqAmpl_snu_tau_sd_L_to_nu_tau_d(
        ...
        )
{
    ...
    return create_ccomplex_return(6*IT_0061*(s_34*conj(IT_0061) + conj(IT_0085
      )*IT_0086) + 6*IT_0085*(conj(IT_0061)*IT_0086 + 0.166666666666667*conj
