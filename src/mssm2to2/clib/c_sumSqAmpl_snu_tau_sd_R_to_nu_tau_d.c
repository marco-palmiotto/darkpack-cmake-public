...
ccomplex_return_t c_sumSqAmpl_snu_tau_sd_R_to_nu_tau_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
