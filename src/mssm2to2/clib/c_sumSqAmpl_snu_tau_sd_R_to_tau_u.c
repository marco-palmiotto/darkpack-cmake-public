...
ccomplex_return_t c_sumSqAmpl_snu_tau_sd_R_to_tau_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow(s_13 + (-0.5)*IT_0010 + (-0.5)*IT_0011 +
       0.5*m_C_1*(m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em
      *m_tau*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0034 = (-0.5)*IT_0029 + (-0.5)*IT_0033;
    const ccomplex_t IT_0035 = (-0.5)*IT_0014 + (-0.5)*IT_0022;
    const ccomplex_t IT_0036 = s_14*m_tau;
    const ccomplex_t IT_0037 = s_13*s_14;
    const ccomplex_t IT_0038 = s_34*IT_0011;
    const ccomplex_t IT_0039 = (-6)*s_34;
    const ccomplex_t IT_0040 = 6*s_34*(IT_0025*conj(IT_0025) + IT_0034*conj
      (IT_0034)) + (-6)*((conj(IT_0025) + -conj(IT_0034))*IT_0035 + (IT_0025 + 
      -IT_0034)*conj(IT_0035))*IT_0036 + IT_0035*conj(IT_0035)*(12*IT_0037 + (-6
      )*IT_0038) + (conj(IT_0025)*IT_0034 + IT_0025*conj(IT_0034))*IT_0039;
