...
ccomplex_return_t c_sumSqAmpl_snu_tau_ss_L_to_nu_tau_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1)*(IT_0004 + -IT_0009);
    const ccomplex_t IT_0013 = (-0.5)*IT_0012;
    const ccomplex_t IT_0014 = IT_0011*IT_0013;
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0016 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0017 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0020 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*(IT_0023 + -IT_0026);
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = IT_0028*IT_0030;
    const ccomplex_t IT_0032 = IT_0019*IT_0020*IT_0031;
    const ccomplex_t IT_0033 = 0.5*IT_0018 + 0.5*IT_0032;
    ...
    const ccomplex_t IT_0046 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0068 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0006*IT_0048*IT_0050;
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*(IT_0059 + (-3)*IT_0062);
    ...
    const ccomplex_t IT_0088 = m_s*IT_0087;
    const ccomplex_t IT_0089 = (-0.5)*IT_0047 + 0.5*IT_0056 + 0.5*IT_0071 +
       0.5*IT_0077 + (-0.5)*IT_0082 + 0.5*IT_0088;
    const ccomplex_t IT_0090 = 0.5*IT_0055 + 0.5*IT_0070 + 0.5*IT_0076 + 0.5
      *IT_0087;
    const ccomplex_t IT_0091 = m_s*s_23;
    const ccomplex_t IT_0092 = s_23*s_24;
    const ccomplex_t IT_0093 = pow(m_ss_L, 2);
    const ccomplex_t IT_0094 = s_34*IT_0093;
    const ccomplex_t IT_0095 = (-6)*s_34;
    const ccomplex_t IT_0096 = 6*s_34*(IT_0033*conj(IT_0033) + IT_0089*conj
      (IT_0089)) + 6*((conj(IT_0033) + -conj(IT_0089))*IT_0090 + (IT_0033 + 
      -IT_0089)*conj(IT_0090))*IT_0091 + IT_0090*conj(IT_0090)*(12*IT_0092 + (-6
      )*IT_0094) + (conj(IT_0033)*IT_0089 + IT_0033*conj(IT_0089))*IT_0095;
