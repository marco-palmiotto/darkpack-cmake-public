        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow(s_13 + (-0.5)*IT_0013 + (-0.5)*IT_0014 +
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em
      *m_tau*IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0023 = cpow(s_13 + (-0.5)*IT_0013 + (-0.5)*IT_0014 +
       0.5*m_C_2*(m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0024 = IT_0017*IT_0022*IT_0023;
    const ccomplex_t IT_0025 = 0.5*IT_0016 + 0.5*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0005;
    const ccomplex_t IT_0027 = IT_0007*IT_0026;
    const ccomplex_t IT_0028 = IT_0015*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0005;
    ...
    const ccomplex_t IT_0037 = (-0.5)*IT_0029 + (-0.5)*IT_0033;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*conj(V_Wp2)*IT_0005;
    const ccomplex_t IT_0039 = IT_0030*IT_0038;
    const ccomplex_t IT_0040 = IT_0017*IT_0023*IT_0039;
    const ccomplex_t IT_0041 = IT_0021*IT_0038;
    const ccomplex_t IT_0042 = IT_0023*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = m_c*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*e_em*conj(V_Wp1)*IT_0005;
    const ccomplex_t IT_0046 = IT_0026*IT_0045;
    const ccomplex_t IT_0047 = IT_0000*IT_0015*IT_0046;
    const ccomplex_t IT_0048 = IT_0011*IT_0045;
    const ccomplex_t IT_0049 = IT_0015*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = m_c*IT_0050;
    const ccomplex_t IT_0052 = (-0.5)*IT_0040 + 0.5*IT_0044 + (-0.5)*IT_0047 +
       0.5*IT_0051;
    const ccomplex_t IT_0053 = (-0.5)*IT_0043 + (-0.5)*IT_0050;
    const ccomplex_t IT_0054 = m_c*s_23;
    const ccomplex_t IT_0055 = pow(m_ss_L, 2);
    const ccomplex_t IT_0056 = m_c*m_tau*IT_0055;
    ...
    const ccomplex_t IT_0062 = m_c*m_tau;
    const ccomplex_t IT_0063 = 6*IT_0025;
    const ccomplex_t IT_0064 = (-6)*IT_0036;
    const ccomplex_t IT_0065 = IT_0063 + IT_0064;
    const ccomplex_t IT_0066 = 6*conj(IT_0025);
    const ccomplex_t IT_0067 = (-6)*conj(IT_0036);
    ...
    const ccomplex_t IT_0072 = s_24*m_tau;
    const ccomplex_t IT_0073 = (-6)*((conj(IT_0025) + -conj(IT_0036))*IT_0037 
      + (IT_0025 + -IT_0036)*conj(IT_0037) + -conj(IT_0052)*IT_0053 + -IT_0052
      *conj(IT_0053))*IT_0054 + (-6)*conj(IT_0037)*(IT_0053*IT_0056 + (
      -0.166666666666667)*IT_0037*IT_0061) + IT_0062*(conj(IT_0052)*IT_0065 +
       IT_0052*IT_0068) + (IT_0025*conj(IT_0025) + IT_0036*conj(IT_0036) +
       IT_0052*conj(IT_0052))*IT_0069 + (conj(IT_0025)*IT_0036 + IT_0025*conj
