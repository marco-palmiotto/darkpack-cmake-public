        ...
        )
{
    ...
    const ccomplex_t IT_0034 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = IT_0043*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0048 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0006*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0062 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0088 = 0.5*IT_0069 + 0.5*IT_0074 + 0.5*IT_0079 + 0.5
      *IT_0084;
    const ccomplex_t IT_0089 = m_s*s_23;
    const ccomplex_t IT_0090 = s_23*s_24;
    const ccomplex_t IT_0091 = pow(m_ss_R, 2);
    const ccomplex_t IT_0092 = s_34*IT_0091;
    const ccomplex_t IT_0093 = (-6)*s_34;
    const ccomplex_t IT_0094 = 6*s_34*(IT_0064*conj(IT_0064) + IT_0087*conj
      (IT_0087)) + 6*((conj(IT_0064) + -conj(IT_0087))*IT_0088 + (IT_0064 + 
      -IT_0087)*conj(IT_0088))*IT_0089 + IT_0088*conj(IT_0088)*(12*IT_0090 + (-6
      )*IT_0092) + (conj(IT_0064)*IT_0087 + IT_0064*conj(IT_0087))*IT_0093;
