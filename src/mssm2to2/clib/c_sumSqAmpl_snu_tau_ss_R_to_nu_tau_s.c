...
ccomplex_return_t c_sumSqAmpl_snu_tau_ss_R_to_nu_tau_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0016 = 0.5*IT_0015;
    const ccomplex_t IT_0017 = IT_0011*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0019 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0020 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0006*IT_0012*IT_0014;
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = IT_0029*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0034 = cpow(s_13 + (-0.5)*IT_0019 + 0.5*m_N_1*(m_N_1 +
