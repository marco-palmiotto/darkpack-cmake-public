        ...
        )
{
    ...
    const ccomplex_t IT_0026 = cpow(s_13 + (-0.5)*IT_0025 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0040 = m_t*N_u4*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0046 = cpow(s_13 + (-0.5)*IT_0025 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0057 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_t*N_u1*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0066 = cpow(s_13 + (-0.5)*IT_0025 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0070 = N_B3*e_em*U_st_10;
    const ccomplex_t IT_0071 = IT_0001*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = m_t*N_u3*e_em*IT_0018*U_st_00;
    ...
    const ccomplex_t IT_0133 = IT_0069*IT_0120*IT_0132;
    const ccomplex_t IT_0134 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0135 = IT_0001*IT_0134;
    const ccomplex_t IT_0136 = 1.4142135623731*IT_0135;
    const ccomplex_t IT_0137 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0138 = IT_0006*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = m_t*conj(N_u1)*e_em*IT_0018*U_st_10;
    ...
    const ccomplex_t IT_0147 = IT_0066*IT_0145*IT_0146;
