...
ccomplex_return_t c_sumSqAmpl_snu_tau_st_1_to_nu_tau_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = conj(N_W2)*e_em*U_st_00;
    ...
    const ccomplex_t IT_0022 = m_t*conj(N_u2)*e_em*IT_0021*U_st_10;
    ...
    const ccomplex_t IT_0030 = cpow(s_13 + (-0.5)*IT_0029 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0040 = conj(N_B3)*e_em*U_st_00;
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = conj(N_W3)*e_em*U_st_00;
    const ccomplex_t IT_0044 = IT_0006*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = m_t*conj(N_u3)*e_em*IT_0021*U_st_10;
    ...
    const ccomplex_t IT_0053 = cpow(s_13 + (-0.5)*IT_0029 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0063 = conj(N_B4)*e_em*U_st_00;
    ...
    const ccomplex_t IT_0069 = m_t*conj(N_u4)*e_em*IT_0021*U_st_10;
    ...
    const ccomplex_t IT_0076 = cpow(s_13 + (-0.5)*IT_0029 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0081 = m_t*N_u2*e_em*IT_0021*U_st_00;
    ...
    const ccomplex_t IT_0089 = m_t*IT_0088;
    ...
    const ccomplex_t IT_0093 = m_t*N_u3*e_em*IT_0021*U_st_00;
    ...
    const ccomplex_t IT_0105 = m_t*N_u4*e_em*IT_0021*U_st_00;
    ...
    const ccomplex_t IT_0111 = IT_0076*IT_0110;
    ...
    const ccomplex_t IT_0122 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0123 = IT_0001*IT_0122;
    const ccomplex_t IT_0124 = 1.4142135623731*IT_0123;
    const ccomplex_t IT_0125 = m_t*N_u1*e_em*IT_0021*U_st_00;
    ...
    const ccomplex_t IT_0131 = cpow(s_13 + (-0.5)*IT_0029 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0134 = m_t*IT_0133;
    const ccomplex_t IT_0135 = conj(N_B1)*e_em*U_st_00;
    const ccomplex_t IT_0136 = IT_0001*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0139 = IT_0006*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = m_t*conj(N_u1)*e_em*IT_0021*U_st_10;
    ...
    const ccomplex_t IT_0146 = IT_0121*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0148 = IT_0131*IT_0146*IT_0147;
    const ccomplex_t IT_0149 = (-0.5)*IT_0031 + (-0.5)*IT_0054 + (-0.5)
      *IT_0077 + 0.5*IT_0089 + 0.5*IT_0101 + 0.5*IT_0113 + 0.5*IT_0134 + (-0.5)
      *IT_0148;
    const ccomplex_t IT_0150 = 0.5*IT_0088 + 0.5*IT_0100 + 0.5*IT_0112 + 0.5
      *IT_0133;
    const ccomplex_t IT_0151 = m_t*s_23;
    const ccomplex_t IT_0152 = s_23*s_24;
    const ccomplex_t IT_0153 = pow(m_st_1, 2);
    const ccomplex_t IT_0154 = s_34*IT_0153;
    return create_ccomplex_return(6*IT_0149*(s_34*conj(IT_0149) + -conj
      (IT_0150)*IT_0151) + (-6)*IT_0150*(conj(IT_0149)*IT_0151 + (
      -0.166666666666667)*conj(IT_0150)*(12*IT_0152 + (-6)*IT_0154)));
}
