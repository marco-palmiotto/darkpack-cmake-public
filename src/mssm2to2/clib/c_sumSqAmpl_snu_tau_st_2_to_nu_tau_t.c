...
ccomplex_return_t c_sumSqAmpl_snu_tau_st_2_to_nu_tau_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B2)*e_em*U_st_01;
    ...
    const ccomplex_t IT_0040 = conj(N_B3)*e_em*U_st_01;
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = conj(N_W3)*e_em*U_st_01;
    const ccomplex_t IT_0044 = IT_0006*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = m_t*conj(N_u3)*e_em*IT_0021*U_st_11;
    ...
    const ccomplex_t IT_0092 = m_t*conj(N_u1)*e_em*IT_0021*U_st_11;
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0099 = cpow(s_13 + (-0.5)*IT_0029 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0101 = 0.5*IT_0031 + 0.5*IT_0054 + 0.5*IT_0077 + 0.5
      *IT_0100;
    const ccomplex_t IT_0102 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0103 = IT_0001*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = m_t*N_u2*e_em*IT_0021*U_st_01;
    ...
    const ccomplex_t IT_0113 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0114 = IT_0001*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = m_t*N_u3*e_em*IT_0021*U_st_01;
    ...
    const ccomplex_t IT_0124 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0125 = IT_0001*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = m_t*N_u4*e_em*IT_0021*U_st_01;
    ...
    const ccomplex_t IT_0135 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0136 = IT_0001*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = m_t*N_u1*e_em*IT_0021*U_st_01;
