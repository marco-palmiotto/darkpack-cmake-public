        ...
        )
{
    ...
    const ccomplex_t IT_0040 = m_t*N_u4*e_em*IT_0018*U_st_01;
    ...
    const ccomplex_t IT_0057 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = m_t*N_u1*e_em*IT_0018*U_st_01;
