...
ccomplex_return_t c_sumSqAmpl_snu_tau_su_L_to_nu_tau_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*(IT_0023 + 3*IT_0026);
    ...
    const ccomplex_t IT_0060 = cpow(s_13 + (-0.5)*IT_0016 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0006*IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0006*IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0089 = (-0.5)*IT_0047 + (-0.5)*IT_0061 + 0.5*IT_0070 +
       0.5*IT_0076 + 0.5*IT_0082 + 0.5*IT_0088;
    const ccomplex_t IT_0090 = 0.5*IT_0069 + 0.5*IT_0075 + 0.5*IT_0081 + 0.5
      *IT_0087;
    const ccomplex_t IT_0091 = m_u*s_23;
    const ccomplex_t IT_0092 = s_23*s_24;
    const ccomplex_t IT_0093 = pow(m_su_L, 2);
