        ...
        )
{
    ...
    const ccomplex_t IT_0015 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0016 = cpow(s_13 + (-0.5)*IT_0015 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0030 = cpow(s_13 + (-0.5)*IT_0015 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0044 = cpow(s_13 + (-0.5)*IT_0015 + 0.5*m_N_1*(m_N_1 +
    ...
    const ccomplex_t IT_0067 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0006*IT_0064*IT_0066;
    const ccomplex_t IT_0079 = 0.5*IT_0078;
    const ccomplex_t IT_0080 = IT_0057*IT_0079;
    const ccomplex_t IT_0081 = IT_0047*IT_0077*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0006*IT_0064*IT_0066;
