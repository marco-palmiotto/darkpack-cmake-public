        ...
        )
{
    ...
    const ccomplex_t IT_0026 = m_c*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0001*IT_0003*IT_0005;
    ...
    const ccomplex_t IT_0035 = m_c*s_14;
    const ccomplex_t IT_0036 = 18*s_34;
    const ccomplex_t IT_0037 = m_c*m_t;
    const ccomplex_t IT_0038 = V_tb*e_em*U_Wm1*conj(U_sb_00);
    ...
    const ccomplex_t IT_0043 = m_b*U_d1*V_tb*e_em*IT_0003*conj(U_sb_10);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*(IT_0039 + (-0.5)*IT_0045);
    const ccomplex_t IT_0047 = IT_0022*IT_0046;
    const ccomplex_t IT_0048 = IT_0009*IT_0012*IT_0047;
    const ccomplex_t IT_0049 = V_tb*e_em*U_Wm2*conj(U_sb_00);
    const ccomplex_t IT_0050 = IT_0001*IT_0049;
    const ccomplex_t IT_0051 = m_b*U_d2*V_tb*e_em*IT_0003*conj(U_sb_10);
    ...
    const ccomplex_t IT_0056 = IT_0018*IT_0019*IT_0055;
    const ccomplex_t IT_0057 = IT_0002*IT_0046;
    const ccomplex_t IT_0058 = IT_0012*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = m_c*IT_0059;
    const ccomplex_t IT_0061 = IT_0014*IT_0054;
    const ccomplex_t IT_0062 = IT_0019*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = m_c*IT_0063;
    ...
    const ccomplex_t IT_0075 = m_c*m_t*IT_0011;
