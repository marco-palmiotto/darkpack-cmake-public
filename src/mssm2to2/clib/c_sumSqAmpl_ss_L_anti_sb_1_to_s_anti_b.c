...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_sb_1_to_s_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_4*
    ...
    const ccomplex_t IT_0068 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0077 = m_b*N_d2*e_em*IT_0026*conj(U_sb_10);
    ...
    const ccomplex_t IT_0083 = N_W2*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_3*
    ...
    const ccomplex_t IT_0102 = m_b*N_d3*e_em*IT_0026*conj(U_sb_10);
    ...
    const ccomplex_t IT_0108 = N_W3*e_em*conj(U_sb_00);
    const ccomplex_t IT_0109 = IT_0017*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*(IT_0104 + 0.333333333333333
      *IT_0107 + -IT_0110);
    ...
    const ccomplex_t IT_0118 = 0.166666666666667*IT_0008 + -IT_0042 + -IT_0067
       + -IT_0092 + -IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0017*IT_0024*IT_0026;
    const ccomplex_t IT_0120 = (-0.5)*IT_0119;
    const ccomplex_t IT_0121 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0122 = IT_0012*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = m_b*conj(N_d3)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0129 = 1.5*IT_0128;
    ...
    const ccomplex_t IT_0134 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0017*IT_0024*IT_0026;
    ...
    const ccomplex_t IT_0139 = m_b*conj(N_d1)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0145 = IT_0043*IT_0144;
    const ccomplex_t IT_0146 = (0 + _Complex_I*1)*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0017*IT_0024*IT_0026;
    const ccomplex_t IT_0148 = (-0.5)*IT_0147;
    const ccomplex_t IT_0149 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0150 = IT_0012*IT_0149;
    const ccomplex_t IT_0151 = 1.4142135623731*IT_0150;
    const ccomplex_t IT_0152 = m_b*conj(N_d2)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0017*IT_0024*IT_0026;
    const ccomplex_t IT_0169 = (-0.5)*IT_0168;
    const ccomplex_t IT_0170 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0171 = IT_0012*IT_0170;
    const ccomplex_t IT_0172 = 1.4142135623731*IT_0171;
    const ccomplex_t IT_0173 = m_b*conj(N_d4)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0183 = -IT_0133 + -IT_0146 + -IT_0167 + -IT_0182;
    const ccomplex_t IT_0184 = s_34*IT_0002;
    const ccomplex_t IT_0185 = (-18)*IT_0184;
    const ccomplex_t IT_0186 = s_13*s_14;
    const ccomplex_t IT_0187 = 36*IT_0186;
    const ccomplex_t IT_0188 = IT_0185 + IT_0187;
    const ccomplex_t IT_0189 = m_s*s_14;
    const ccomplex_t IT_0190 = m_s*IT_0008;
    const ccomplex_t IT_0191 = 0.5*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_10);
    const ccomplex_t IT_0193 = IT_0004*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0195 = IT_0003*IT_0193*IT_0194;
    const ccomplex_t IT_0196 = (-0.5)*IT_0195;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0198 = IT_0022*IT_0179;
    const ccomplex_t IT_0199 = IT_0010*IT_0197*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0201 = IT_0101*IT_0130;
    const ccomplex_t IT_0202 = IT_0093*IT_0200*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0204 = IT_0051*IT_0143;
    const ccomplex_t IT_0205 = IT_0043*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0207 = IT_0076*IT_0164;
    const ccomplex_t IT_0208 = IT_0068*IT_0206*IT_0207;
    const ccomplex_t IT_0209 = m_s*IT_0146;
    const ccomplex_t IT_0210 = m_s*IT_0167;
    const ccomplex_t IT_0211 = m_s*IT_0133;
    const ccomplex_t IT_0212 = m_s*IT_0182;
    const ccomplex_t IT_0213 = 0.166666666666667*IT_0195 + -IT_0199 + -IT_0202
       + -IT_0205 + -IT_0208 + IT_0209 + IT_0210 + IT_0211 + IT_0212;
    const ccomplex_t IT_0214 = IT_0064*IT_0135;
    const ccomplex_t IT_0215 = IT_0043*IT_0203*IT_0214;
    const ccomplex_t IT_0216 = IT_0089*IT_0148;
    const ccomplex_t IT_0217 = IT_0068*IT_0206*IT_0216;
    const ccomplex_t IT_0218 = IT_0114*IT_0120;
    const ccomplex_t IT_0219 = IT_0093*IT_0200*IT_0218;
    const ccomplex_t IT_0220 = IT_0039*IT_0169;
    const ccomplex_t IT_0221 = IT_0010*IT_0197*IT_0220;
    const ccomplex_t IT_0222 = m_s*IT_0067;
    const ccomplex_t IT_0223 = m_s*IT_0092;
    const ccomplex_t IT_0224 = m_s*IT_0117;
    const ccomplex_t IT_0225 = m_s*IT_0042;
    const ccomplex_t IT_0226 = (-0.166666666666667)*IT_0190 + -IT_0215 + 
      -IT_0217 + -IT_0219 + -IT_0221 + IT_0222 + IT_0223 + IT_0224 + IT_0225;
    const ccomplex_t IT_0227 = 3*IT_0118;
    const ccomplex_t IT_0228 = IT_0009 + IT_0227;
    const ccomplex_t IT_0229 = 3*conj(IT_0118);
    const ccomplex_t IT_0230 = conj(IT_0009) + IT_0229;
    const ccomplex_t IT_0231 = (18*conj(IT_0009) + 6*conj(IT_0118))*IT_0191 + 
      (18*IT_0009 + 6*IT_0118)*conj(IT_0191) + 6*conj(IT_0183)*(IT_0196 + 3
      *IT_0213) + 6*IT_0183*(conj(IT_0196) + 3*conj(IT_0213)) + 6*conj(IT_0226)
      *IT_0228 + 6*IT_0226*IT_0230;
    const ccomplex_t IT_0232 = m_b*m_s*IT_0002;
    const ccomplex_t IT_0233 = 6*s_34;
    const ccomplex_t IT_0234 = 18*s_34;
    const ccomplex_t IT_0235 = 12*IT_0186;
    const ccomplex_t IT_0236 = (-6)*IT_0184;
    const ccomplex_t IT_0237 = m_b*s_13;
    const ccomplex_t IT_0238 = (-18)*conj(IT_0226);
    const ccomplex_t IT_0239 = (-6)*conj(IT_0191);
    const ccomplex_t IT_0240 = IT_0238 + IT_0239;
    const ccomplex_t IT_0241 = (-18)*IT_0226;
    const ccomplex_t IT_0242 = (-6)*conj(IT_0213);
    const ccomplex_t IT_0243 = ((-18)*conj(IT_0009) + (-6)*conj(IT_0118))
      *IT_0196 + ((-18)*IT_0009 + (-6)*IT_0118)*conj(IT_0196) + (-6)*IT_0213
      *IT_0230 + IT_0183*IT_0240 + (-6)*conj(IT_0183)*(IT_0191 + (
      -0.166666666666667)*IT_0241) + IT_0228*IT_0242;
    const ccomplex_t IT_0244 = m_b*m_s;
    const ccomplex_t IT_0245 = (IT_0009*conj(IT_0009) + IT_0118*conj(IT_0118) 
      + IT_0183*conj(IT_0183))*IT_0188 + IT_0189*IT_0231 + (-6)*(conj(IT_0183)
      *IT_0228 + IT_0183*IT_0230)*IT_0232 + (conj(IT_0196)*IT_0213 + IT_0196
      *conj(IT_0213) + conj(IT_0191)*IT_0226 + IT_0191*conj(IT_0226))*IT_0233 + 
      (IT_0191*conj(IT_0191) + IT_0196*conj(IT_0196) + IT_0213*conj(IT_0213) +
       IT_0226*conj(IT_0226))*IT_0234 + (conj(IT_0009)*IT_0118 + IT_0009*conj
      (IT_0118))*(IT_0235 + IT_0236) + IT_0237*IT_0243 + (-6)*(conj(IT_0196)
      *IT_0226 + -1./6*IT_0196*((-18)*conj(IT_0191) + (-6)*conj(IT_0226)) + -1.
      /6*IT_0213*IT_0240 + -1./6*conj(IT_0213)*IT_0241 + -1./6*IT_0191*((-18)
      *conj(IT_0196) + IT_0242))*IT_0244;
