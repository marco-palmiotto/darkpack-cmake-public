        ...
        )
{
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_3*
    ...
    const ccomplex_t IT_0076 = m_b*N_d3*e_em*IT_0026*conj(U_sb_10);
    ...
    const ccomplex_t IT_0114 = 0.166666666666667*IT_0008 + -IT_0041 + -IT_0066
       + -IT_0090 + -IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0017*IT_0024*IT_0026;
    const ccomplex_t IT_0116 = (-0.5)*IT_0115;
    const ccomplex_t IT_0117 = conj(N_B1)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0118 = IT_0012*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = m_b*conj(N_d1)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0130 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0131 = IT_0012*IT_0130;
    const ccomplex_t IT_0132 = 1.4142135623731*IT_0131;
    const ccomplex_t IT_0133 = m_b*conj(N_d3)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0017*IT_0024*IT_0026;
    const ccomplex_t IT_0142 = (-0.5)*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0144 = IT_0012*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = m_b*conj(N_d4)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0154 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0017*IT_0024*IT_0026;
    const ccomplex_t IT_0155 = (-0.5)*IT_0154;
    const ccomplex_t IT_0156 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0157 = IT_0012*IT_0156;
    const ccomplex_t IT_0158 = 1.4142135623731*IT_0157;
    const ccomplex_t IT_0159 = m_b*conj(N_d2)*e_em*IT_0026*conj(U_sb_00);
    ...
    const ccomplex_t IT_0174 = m_s*IT_0008;
    ...
    const ccomplex_t IT_0182 = IT_0050*IT_0163;
    const ccomplex_t IT_0183 = IT_0042*IT_0181*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0185 = IT_0075*IT_0137;
    const ccomplex_t IT_0186 = IT_0067*IT_0184*IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0188 = IT_0022*IT_0124;
    const ccomplex_t IT_0189 = IT_0010*IT_0187*IT_0188;
    const ccomplex_t IT_0190 = m_s*IT_0127;
    const ccomplex_t IT_0191 = m_s*IT_0140;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0193 = IT_0099*IT_0150;
    const ccomplex_t IT_0194 = IT_0091*IT_0192*IT_0193;
    const ccomplex_t IT_0195 = m_s*IT_0166;
    const ccomplex_t IT_0196 = m_s*IT_0153;
    const ccomplex_t IT_0197 = 0.166666666666667*IT_0179 + -IT_0183 + -IT_0186
       + -IT_0189 + IT_0190 + IT_0191 + -IT_0194 + IT_0195 + IT_0196;
    const ccomplex_t IT_0198 = IT_0038*IT_0116;
    const ccomplex_t IT_0199 = IT_0010*IT_0187*IT_0198;
    const ccomplex_t IT_0200 = IT_0063*IT_0155;
    const ccomplex_t IT_0201 = IT_0042*IT_0181*IT_0200;
    const ccomplex_t IT_0202 = IT_0087*IT_0129;
    const ccomplex_t IT_0203 = IT_0067*IT_0184*IT_0202;
    const ccomplex_t IT_0204 = IT_0110*IT_0142;
    const ccomplex_t IT_0205 = IT_0091*IT_0192*IT_0204;
    const ccomplex_t IT_0206 = m_s*IT_0041;
    const ccomplex_t IT_0207 = m_s*IT_0066;
    const ccomplex_t IT_0208 = m_s*IT_0090;
    const ccomplex_t IT_0209 = m_s*IT_0113;
    const ccomplex_t IT_0210 = (-0.166666666666667)*IT_0174 + -IT_0199 + 
      -IT_0201 + -IT_0203 + -IT_0205 + IT_0206 + IT_0207 + IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = 3*IT_0114;
    const ccomplex_t IT_0212 = IT_0009 + IT_0211;
    const ccomplex_t IT_0213 = 3*conj(IT_0114);
    const ccomplex_t IT_0214 = conj(IT_0009) + IT_0213;
    const ccomplex_t IT_0215 = (18*conj(IT_0009) + 6*conj(IT_0114))*IT_0175 + 
      (18*IT_0009 + 6*IT_0114)*conj(IT_0175) + 6*conj(IT_0167)*(IT_0180 + 3
      *IT_0197) + 6*IT_0167*(conj(IT_0180) + 3*conj(IT_0197)) + 6*conj(IT_0210)
      *IT_0212 + 6*IT_0210*IT_0214;
    const ccomplex_t IT_0216 = m_b*m_s*IT_0005;
    const ccomplex_t IT_0217 = 6*s_34;
    const ccomplex_t IT_0218 = 18*s_34;
    const ccomplex_t IT_0219 = 12*IT_0170;
    const ccomplex_t IT_0220 = (-6)*IT_0168;
    const ccomplex_t IT_0221 = m_b*s_13;
    const ccomplex_t IT_0222 = (-18)*conj(IT_0210);
    const ccomplex_t IT_0223 = (-6)*conj(IT_0175);
    const ccomplex_t IT_0224 = IT_0222 + IT_0223;
    const ccomplex_t IT_0225 = (-18)*IT_0210;
    const ccomplex_t IT_0226 = (-6)*conj(IT_0197);
    const ccomplex_t IT_0227 = ((-18)*conj(IT_0009) + (-6)*conj(IT_0114))
      *IT_0180 + ((-18)*IT_0009 + (-6)*IT_0114)*conj(IT_0180) + (-6)*IT_0197
      *IT_0214 + IT_0167*IT_0224 + (-6)*conj(IT_0167)*(IT_0175 + (
      -0.166666666666667)*IT_0225) + IT_0212*IT_0226;
    const ccomplex_t IT_0228 = m_b*m_s;
    const ccomplex_t IT_0229 = (IT_0009*conj(IT_0009) + IT_0114*conj(IT_0114) 
      + IT_0167*conj(IT_0167))*IT_0172 + IT_0173*IT_0215 + (-6)*(conj(IT_0167)
      *IT_0212 + IT_0167*IT_0214)*IT_0216 + (conj(IT_0180)*IT_0197 + IT_0180
      *conj(IT_0197) + conj(IT_0175)*IT_0210 + IT_0175*conj(IT_0210))*IT_0217 + 
      (IT_0175*conj(IT_0175) + IT_0180*conj(IT_0180) + IT_0197*conj(IT_0197) +
       IT_0210*conj(IT_0210))*IT_0218 + (conj(IT_0009)*IT_0114 + IT_0009*conj
      (IT_0114))*(IT_0219 + IT_0220) + IT_0221*IT_0227 + (-6)*(conj(IT_0180)
      *IT_0210 + -1./6*IT_0180*((-18)*conj(IT_0175) + (-6)*conj(IT_0210)) + -1.
      /6*IT_0197*IT_0224 + -1./6*conj(IT_0197)*IT_0225 + -1./6*IT_0175*((-18)
      *conj(IT_0180) + IT_0226))*IT_0228;
