        ...
        )
{
    ...
    const ccomplex_t IT_0051 = N_B2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0052 = IT_0012*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = N_W2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0055 = IT_0017*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = m_b*N_d2*e_em*IT_0029*conj(U_sb_11);
    ...
    const ccomplex_t IT_0074 = N_B3*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0080 = m_b*N_d3*e_em*IT_0029*conj(U_sb_11);
    ...
    const ccomplex_t IT_0111 = 0.166666666666667*IT_0008 + -IT_0041 + -IT_0064
       + -IT_0087 + -IT_0110;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0017*IT_0027*IT_0029;
    const ccomplex_t IT_0113 = (-0.5)*IT_0112;
    const ccomplex_t IT_0114 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0115 = IT_0012*IT_0114;
    const ccomplex_t IT_0116 = 1.4142135623731*IT_0115;
    const ccomplex_t IT_0117 = m_b*conj(N_d2)*e_em*IT_0029*conj(U_sb_01);
    const ccomplex_t IT_0118 = IT_0028*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*(IT_0116 + 1.5*IT_0119);
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0017*IT_0027*IT_0029;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0128 = IT_0012*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_b*conj(N_d3)*e_em*IT_0029*conj(U_sb_01);
    ...
    const ccomplex_t IT_0140 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0141 = IT_0012*IT_0140;
    const ccomplex_t IT_0142 = 1.4142135623731*IT_0141;
    const ccomplex_t IT_0143 = m_b*conj(N_d1)*e_em*IT_0029*conj(U_sb_01);
    ...
    const ccomplex_t IT_0156 = m_b*conj(N_d4)*e_em*IT_0029*conj(U_sb_01);
    ...
    const ccomplex_t IT_0164 = -IT_0124 + -IT_0137 + -IT_0150 + -IT_0163;
    ...
    const ccomplex_t IT_0170 = m_b*m_s*IT_0005;
    const ccomplex_t IT_0171 = 3*conj(IT_0111);
    const ccomplex_t IT_0172 = conj(IT_0009) + IT_0171;
    const ccomplex_t IT_0173 = m_s*s_14;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0175 = IT_0038*IT_0139;
    const ccomplex_t IT_0176 = IT_0010*IT_0174*IT_0175;
    const ccomplex_t IT_0177 = m_s*IT_0008;
    const ccomplex_t IT_0178 = m_s*IT_0041;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0180 = IT_0061*IT_0113;
    const ccomplex_t IT_0181 = IT_0042*IT_0179*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0183 = IT_0084*IT_0126;
    const ccomplex_t IT_0184 = IT_0065*IT_0182*IT_0183;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0186 = IT_0107*IT_0152;
    const ccomplex_t IT_0187 = IT_0088*IT_0185*IT_0186;
    const ccomplex_t IT_0188 = m_s*IT_0064;
    const ccomplex_t IT_0189 = m_s*IT_0087;
    const ccomplex_t IT_0190 = m_s*IT_0110;
    const ccomplex_t IT_0191 = -IT_0176 + (-0.166666666666667)*IT_0177 +
       IT_0178 + -IT_0181 + -IT_0184 + -IT_0187 + IT_0188 + IT_0189 + IT_0190;
    const ccomplex_t IT_0192 = 0.5*IT_0177;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_11);
    const ccomplex_t IT_0194 = IT_0000*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0196 = IT_0006*IT_0194*IT_0195;
    const ccomplex_t IT_0197 = (-0.5)*IT_0196;
    const ccomplex_t IT_0198 = IT_0022*IT_0147;
    const ccomplex_t IT_0199 = IT_0010*IT_0174*IT_0198;
    const ccomplex_t IT_0200 = IT_0073*IT_0134;
    const ccomplex_t IT_0201 = IT_0065*IT_0182*IT_0200;
    const ccomplex_t IT_0202 = IT_0050*IT_0121;
    const ccomplex_t IT_0203 = IT_0042*IT_0179*IT_0202;
    const ccomplex_t IT_0204 = IT_0096*IT_0160;
    const ccomplex_t IT_0205 = IT_0088*IT_0185*IT_0204;
    const ccomplex_t IT_0206 = m_s*IT_0150;
    const ccomplex_t IT_0207 = m_s*IT_0124;
    const ccomplex_t IT_0208 = m_s*IT_0137;
    const ccomplex_t IT_0209 = m_s*IT_0163;
    const ccomplex_t IT_0210 = 0.166666666666667*IT_0196 + -IT_0199 + -IT_0201
       + -IT_0203 + -IT_0205 + IT_0206 + IT_0207 + IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = IT_0197 + 3*IT_0210;
    const ccomplex_t IT_0212 = 3*conj(IT_0210);
    const ccomplex_t IT_0213 = conj(IT_0197) + IT_0212;
    const ccomplex_t IT_0214 = IT_0172*IT_0191 + (IT_0009 + 3*IT_0111)*conj
      (IT_0191) + 0.166666666666667*(18*conj(IT_0009) + 6*conj(IT_0111))*IT_0192
       + 0.166666666666667*(18*IT_0009 + 6*IT_0111)*conj(IT_0192) + conj(IT_0164
      )*IT_0211 + IT_0164*IT_0213;
    const ccomplex_t IT_0215 = 6*s_34;
    const ccomplex_t IT_0216 = 18*s_34;
    const ccomplex_t IT_0217 = m_b*m_s;
    const ccomplex_t IT_0218 = (-6)*conj(IT_0210);
    const ccomplex_t IT_0219 = (-18)*conj(IT_0197);
    const ccomplex_t IT_0220 = IT_0218 + IT_0219;
    const ccomplex_t IT_0221 = (-18)*conj(IT_0191);
    const ccomplex_t IT_0222 = (-6)*conj(IT_0192);
    const ccomplex_t IT_0223 = IT_0221 + IT_0222;
    const ccomplex_t IT_0224 = (-18)*IT_0191;
    const ccomplex_t IT_0225 = m_b*s_13;
    const ccomplex_t IT_0226 = (conj(IT_0009)*((-18)*IT_0197 + (-6)*IT_0210) +
       (-6)*conj(IT_0111)*IT_0211 + (-6)*IT_0111*IT_0213 + IT_0009*IT_0220 +
       IT_0164*IT_0223 + (-6)*conj(IT_0164)*(IT_0192 + (-0.166666666666667)
      *IT_0224))*IT_0225;
    const ccomplex_t IT_0227 = 12*IT_0167;
    const ccomplex_t IT_0228 = (-6)*IT_0165;
    const ccomplex_t IT_0229 = (IT_0009*conj(IT_0009) + IT_0111*conj(IT_0111) 
      + IT_0164*conj(IT_0164))*IT_0169 + (-6)*IT_0170*((IT_0009 + 3*IT_0111)
      *conj(IT_0164) + IT_0164*IT_0172) + 6*IT_0173*IT_0214 + (conj(IT_0191)
      *IT_0192 + IT_0191*conj(IT_0192) + conj(IT_0197)*IT_0210 + IT_0197*conj
      (IT_0210))*IT_0215 + (IT_0191*conj(IT_0191) + IT_0192*conj(IT_0192) +
       IT_0197*conj(IT_0197) + IT_0210*conj(IT_0210))*IT_0216 + (-6)*IT_0217*(
      (conj(IT_0191) + 3*conj(IT_0192))*IT_0197 + IT_0191*conj(IT_0197) + -1./6
      *IT_0192*IT_0220 + -1./6*IT_0210*IT_0223 + -1./6*conj(IT_0210)*IT_0224) +
       IT_0226 + (conj(IT_0009)*IT_0111 + IT_0009*conj(IT_0111))*(IT_0227 +
       IT_0228);
