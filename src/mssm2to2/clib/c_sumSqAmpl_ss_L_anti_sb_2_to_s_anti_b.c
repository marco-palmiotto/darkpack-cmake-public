...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_sb_2_to_s_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = conj(N_B2)*e_em;
    ...
    const ccomplex_t IT_0018 = conj(N_W2)*e_em;
    ...
    const ccomplex_t IT_0023 = N_W2*e_em*conj(U_sb_01);
    const ccomplex_t IT_0024 = IT_0017*IT_0023;
    const ccomplex_t IT_0025 = 1.4142135623731*IT_0024;
    const ccomplex_t IT_0026 = N_B2*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0033 = m_b*N_d2*e_em*IT_0032*conj(U_sb_11);
    const ccomplex_t IT_0034 = IT_0031*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*(IT_0025 + (
      -0.333333333333333)*IT_0028 + -IT_0035);
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0068 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0069 = conj(N_B3)*e_em;
    const ccomplex_t IT_0070 = IT_0012*IT_0069;
    const ccomplex_t IT_0071 = 1.4142135623731*IT_0070;
    const ccomplex_t IT_0072 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0077 = N_W3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0078 = IT_0017*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = N_B3*e_em*conj(U_sb_01);
    const ccomplex_t IT_0081 = IT_0012*IT_0080;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = m_b*N_d3*e_em*IT_0032*conj(U_sb_11);
    const ccomplex_t IT_0084 = IT_0031*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*(IT_0079 + (
      -0.333333333333333)*IT_0082 + -IT_0085);
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_4*
    ...
    const ccomplex_t IT_0102 = N_B4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0103 = IT_0012*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = N_W4*e_em*conj(U_sb_01);
    const ccomplex_t IT_0106 = IT_0017*IT_0105;
    const ccomplex_t IT_0107 = 1.4142135623731*IT_0106;
    const ccomplex_t IT_0108 = m_b*N_d4*e_em*IT_0032*conj(U_sb_11);
    const ccomplex_t IT_0109 = IT_0031*IT_0108;
    ...
    const ccomplex_t IT_0118 = 0.166666666666667*IT_0008 + -IT_0042 + -IT_0067
       + -IT_0092 + -IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0120 = (-0.5)*IT_0119;
    const ccomplex_t IT_0121 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0122 = IT_0012*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = m_b*conj(N_d1)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0132 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0133 = (-0.5)*IT_0132;
    const ccomplex_t IT_0134 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0135 = IT_0012*IT_0134;
    const ccomplex_t IT_0136 = 1.4142135623731*IT_0135;
    const ccomplex_t IT_0137 = m_b*conj(N_d2)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0147 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0148 = IT_0012*IT_0147;
    const ccomplex_t IT_0149 = 1.4142135623731*IT_0148;
    const ccomplex_t IT_0150 = m_b*conj(N_d3)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0154 = (-0.333333333333333)*IT_0153;
    ...
    const ccomplex_t IT_0158 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0159 = (-0.5)*IT_0158;
    const ccomplex_t IT_0160 = m_b*conj(N_d4)*e_em*IT_0032*conj(U_sb_01);
    ...
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*(IT_0162 + 0.666666666666667
      *IT_0165);
    ...
    const ccomplex_t IT_0170 = IT_0093*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*IT_0170;
    const ccomplex_t IT_0172 = -IT_0131 + -IT_0144 + -IT_0157 + -IT_0171;
    const ccomplex_t IT_0173 = s_34*IT_0002;
    const ccomplex_t IT_0174 = (-18)*IT_0173;
    const ccomplex_t IT_0175 = s_13*s_14;
    const ccomplex_t IT_0176 = 36*IT_0175;
    const ccomplex_t IT_0177 = IT_0174 + IT_0176;
    const ccomplex_t IT_0178 = m_s*s_14;
    const ccomplex_t IT_0179 = m_s*IT_0008;
    const ccomplex_t IT_0180 = 0.5*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_sb_11);
    const ccomplex_t IT_0182 = IT_0004*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0184 = IT_0003*IT_0182*IT_0183;
    const ccomplex_t IT_0185 = (-0.5)*IT_0184;
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0187 = IT_0101*IT_0168;
    const ccomplex_t IT_0188 = IT_0093*IT_0186*IT_0187;
    const ccomplex_t IT_0189 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0190 = IT_0076*IT_0154;
    const ccomplex_t IT_0191 = IT_0068*IT_0189*IT_0190;
    const ccomplex_t IT_0192 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0193 = IT_0051*IT_0128;
    const ccomplex_t IT_0194 = IT_0043*IT_0192*IT_0193;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0196 = IT_0022*IT_0141;
    const ccomplex_t IT_0197 = IT_0010*IT_0195*IT_0196;
    const ccomplex_t IT_0198 = m_s*IT_0131;
    const ccomplex_t IT_0199 = m_s*IT_0144;
    const ccomplex_t IT_0200 = m_s*IT_0157;
    const ccomplex_t IT_0201 = m_s*IT_0171;
    const ccomplex_t IT_0202 = 0.166666666666667*IT_0184 + -IT_0188 + -IT_0191
       + -IT_0194 + -IT_0197 + IT_0198 + IT_0199 + IT_0200 + IT_0201;
    const ccomplex_t IT_0203 = IT_0064*IT_0120;
    const ccomplex_t IT_0204 = IT_0043*IT_0192*IT_0203;
    const ccomplex_t IT_0205 = IT_0039*IT_0133;
    const ccomplex_t IT_0206 = IT_0010*IT_0195*IT_0205;
    const ccomplex_t IT_0207 = IT_0089*IT_0146;
    const ccomplex_t IT_0208 = IT_0068*IT_0189*IT_0207;
    const ccomplex_t IT_0209 = IT_0114*IT_0159;
    const ccomplex_t IT_0210 = IT_0093*IT_0186*IT_0209;
    const ccomplex_t IT_0211 = m_s*IT_0067;
    const ccomplex_t IT_0212 = m_s*IT_0042;
    const ccomplex_t IT_0213 = m_s*IT_0092;
    const ccomplex_t IT_0214 = m_s*IT_0117;
    const ccomplex_t IT_0215 = (-0.166666666666667)*IT_0179 + -IT_0204 + 
      -IT_0206 + -IT_0208 + -IT_0210 + IT_0211 + IT_0212 + IT_0213 + IT_0214;
    const ccomplex_t IT_0216 = 3*IT_0118;
    const ccomplex_t IT_0217 = IT_0009 + IT_0216;
    const ccomplex_t IT_0218 = 3*conj(IT_0118);
    const ccomplex_t IT_0219 = conj(IT_0009) + IT_0218;
    const ccomplex_t IT_0220 = (18*conj(IT_0009) + 6*conj(IT_0118))*IT_0180 + 
      (18*IT_0009 + 6*IT_0118)*conj(IT_0180) + 6*conj(IT_0172)*(IT_0185 + 3
      *IT_0202) + 6*IT_0172*(conj(IT_0185) + 3*conj(IT_0202)) + 6*conj(IT_0215)
      *IT_0217 + 6*IT_0215*IT_0219;
    const ccomplex_t IT_0221 = m_b*m_s*IT_0002;
    const ccomplex_t IT_0222 = 6*s_34;
    const ccomplex_t IT_0223 = 18*s_34;
    const ccomplex_t IT_0224 = 12*IT_0175;
    const ccomplex_t IT_0225 = (-6)*IT_0173;
    const ccomplex_t IT_0226 = m_b*s_13;
    const ccomplex_t IT_0227 = (-18)*conj(IT_0215);
    const ccomplex_t IT_0228 = (-6)*conj(IT_0180);
    const ccomplex_t IT_0229 = IT_0227 + IT_0228;
    const ccomplex_t IT_0230 = (-18)*IT_0215;
    const ccomplex_t IT_0231 = (-6)*conj(IT_0202);
    const ccomplex_t IT_0232 = ((-18)*conj(IT_0009) + (-6)*conj(IT_0118))
      *IT_0185 + ((-18)*IT_0009 + (-6)*IT_0118)*conj(IT_0185) + (-6)*IT_0202
      *IT_0219 + IT_0172*IT_0229 + (-6)*conj(IT_0172)*(IT_0180 + (
      -0.166666666666667)*IT_0230) + IT_0217*IT_0231;
    const ccomplex_t IT_0233 = m_b*m_s;
    const ccomplex_t IT_0234 = (IT_0009*conj(IT_0009) + IT_0118*conj(IT_0118) 
      + IT_0172*conj(IT_0172))*IT_0177 + IT_0178*IT_0220 + (-6)*(conj(IT_0172)
      *IT_0217 + IT_0172*IT_0219)*IT_0221 + (conj(IT_0185)*IT_0202 + IT_0185
      *conj(IT_0202) + conj(IT_0180)*IT_0215 + IT_0180*conj(IT_0215))*IT_0222 + 
      (IT_0180*conj(IT_0180) + IT_0185*conj(IT_0185) + IT_0202*conj(IT_0202) +
       IT_0215*conj(IT_0215))*IT_0223 + (conj(IT_0009)*IT_0118 + IT_0009*conj
      (IT_0118))*(IT_0224 + IT_0225) + IT_0226*IT_0232 + (-6)*(conj(IT_0185)
      *IT_0215 + -1./6*IT_0185*((-18)*conj(IT_0180) + (-6)*conj(IT_0215)) + -1.
      /6*IT_0202*IT_0229 + -1./6*conj(IT_0202)*IT_0230 + -1./6*IT_0180*((-18)
      *conj(IT_0185) + IT_0231))*IT_0233;
