        ...
        )
{
    ...
    const ccomplex_t IT_0000 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_ss_L
    ...
    const ccomplex_t IT_0010 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_ss_L
      *Gamma_sl + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0053 = pow(m_ss_L, 4);
