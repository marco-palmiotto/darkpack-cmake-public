...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_L_to_A_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_ss_L
    ...
    const ccomplex_t IT_0014 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_ss_L
      *Gamma_sl + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0064 = pow(m_ss_L, 4);
