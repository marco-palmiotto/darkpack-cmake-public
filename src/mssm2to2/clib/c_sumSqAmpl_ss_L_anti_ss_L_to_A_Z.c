...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_L_to_A_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = 0.111111111111111*IT_0009;
    ...
    const ccomplex_t IT_0024 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_ss_L
      *Gamma_sl + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = IT_0023*IT_0025;
    const ccomplex_t IT_0027 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_ss_L
      *Gamma_sl + (-0.5)*reg_prop, -1);
