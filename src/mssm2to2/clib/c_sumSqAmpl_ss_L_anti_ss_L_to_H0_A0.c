...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_L_to_H0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0039 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0003;
    const ccomplex_t IT_0040 = 0.5*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0000;
    const ccomplex_t IT_0042 = (-0.5)*IT_0041;
    const ccomplex_t IT_0043 = IT_0040*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sd_R*
    ...
    const ccomplex_t IT_0050 = A_b*V_ts*conj(V_ts);
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0000 + -m_s*e_em*mu_h*IT_0015*IT_0017*IT_0047*IT_0054);
    ...
    const ccomplex_t IT_0061 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0003;
    ...
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0075 = 1.4142135623731*A_b*V_tb*V_ts*IT_0003*conj
      (U_sb_10);
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = IT_0011 + IT_0038 + IT_0046 + IT_0060 + IT_0068
