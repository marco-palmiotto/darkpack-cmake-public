        ...
        )
{
    ...
    const ccomplex_t IT_0047 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0000;
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sd_R*
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0003 + -m_s*e_em*mu_h*IT_0023*IT_0025*IT_0055*IT_0062);
    ...
    const ccomplex_t IT_0069 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0000;
    ...
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0003*conj(U_sb_10);
    const ccomplex_t IT_0083 = (-0.5)*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0000
      *U_sb_10;
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0091 = 1.4142135623731*A_b*V_tb*V_ts*IT_0000*conj
      (U_sb_10);
    ...
    const ccomplex_t IT_0098 = IT_0011 + IT_0019 + IT_0046 + IT_0054 + IT_0068
       + IT_0076 + IT_0081 + IT_0089 + IT_0097;
