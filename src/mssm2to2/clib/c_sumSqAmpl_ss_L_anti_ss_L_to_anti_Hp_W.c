...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_L_to_anti_Hp_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
      *IT_0005;
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
    ...
    const ccomplex_t IT_0047 = A_t*IT_0002*conj(U_st_11) + (-1.4142135623731)
      ...
      *IT_0008*IT_0009*conj(U_st_01) + m_t*(m_t*IT_0002*IT_0029*conj(U_st_01) +
       mu_h*conj(U_st_11))));
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*V_ts*IT_0047;
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0005*(IT_0001*IT_0007*IT_0008*IT_0009 + (-2)*IT_0002*(m_W*IT_0001 + (
