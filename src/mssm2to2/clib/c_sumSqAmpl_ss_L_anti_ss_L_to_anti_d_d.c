        ...
        )
{
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_d*e_em*IT_0003*IT_0025
      *IT_0027*IT_0033;
    ...
    const ccomplex_t IT_0049 = pow(m_d, 2);
    ...
    const ccomplex_t IT_0083 = m_d*s_13;
    ...
    const ccomplex_t IT_0096 = m_d*s_14;
