        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*3)*e_em*(IT_0005*IT_0011 + 1./3
      *IT_0004*IT_0028);
    const ccomplex_t IT_0030 = 0.166666666666667*IT_0029;
    const ccomplex_t IT_0031 = m_s*IT_0030;
    const ccomplex_t IT_0032 = 0.333333333333333*IT_0029;
    const ccomplex_t IT_0033 = m_s*IT_0032;
    const ccomplex_t IT_0034 = -IT_0033;
    const ccomplex_t IT_0035 = IT_0031 + IT_0034;
    const ccomplex_t IT_0036 = IT_0004*IT_0028;
    const ccomplex_t IT_0037 = e_em*IT_0036;
    const ccomplex_t IT_0038 = IT_0005*IT_0011;
    ...
    const ccomplex_t IT_0059 = (IT_0031 + -IT_0033)*(IT_0044 + -IT_0049);
    const ccomplex_t IT_0060 = (-18)*IT_0008;
    const ccomplex_t IT_0061 = 18*s_34;
    const ccomplex_t IT_0062 = IT_0060 + IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0008 + IT_0015 + -m_N_1*
    ...
    const ccomplex_t IT_0083 = cpow((-2)*s_23 + IT_0008 + IT_0015 + -m_N_2*
    ...
    const ccomplex_t IT_0101 = IT_0083*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*IT_0101;
    const ccomplex_t IT_0103 = cpow((-2)*s_23 + IT_0008 + IT_0015 + -m_N_3*
    ...
    const ccomplex_t IT_0121 = IT_0103*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*IT_0121;
    const ccomplex_t IT_0123 = cpow((-2)*s_23 + IT_0008 + IT_0015 + -m_N_4*
    ...
    const ccomplex_t IT_0143 = 0.166666666666667*IT_0056 + -IT_0082 + -IT_0102
       + -IT_0122 + -IT_0142;
    const ccomplex_t IT_0144 = IT_0032*IT_0044;
    const ccomplex_t IT_0145 = (-0.5)*IT_0056 + -IT_0144;
    const ccomplex_t IT_0146 = IT_0032*IT_0049;
    const ccomplex_t IT_0147 = -IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0149 = (-0.5)*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
    ...
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0156 = (-0.5)*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0158 = (-0.5)*IT_0157;
    const ccomplex_t IT_0159 = IT_0156*IT_0158;
    const ccomplex_t IT_0160 = IT_0103*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0163 = (-0.5)*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0165 = (-0.5)*IT_0164;
    const ccomplex_t IT_0166 = IT_0163*IT_0165;
    const ccomplex_t IT_0167 = IT_0123*IT_0166;
    ...
    const ccomplex_t IT_0171 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0185 = cpow(s_12 + IT_0015 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0186 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0187 = 0.666666666666667*IT_0186;
    const ccomplex_t IT_0188 = (-0.333333333333333)*IT_0186;
    ...
    const ccomplex_t IT_0194 = IT_0185*IT_0192;
    ...
    const ccomplex_t IT_0200 = IT_0008*IT_0015;
    ...
    const ccomplex_t IT_0206 = IT_0091*IT_0149;
    const ccomplex_t IT_0207 = IT_0083*IT_0205*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0209 = IT_0111*IT_0156;
    const ccomplex_t IT_0210 = IT_0103*IT_0208*IT_0209;
    const ccomplex_t IT_0211 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0212 = IT_0131*IT_0163;
    const ccomplex_t IT_0213 = IT_0123*IT_0211*IT_0212;
    const ccomplex_t IT_0214 = m_s*IT_0154;
    const ccomplex_t IT_0215 = m_s*IT_0161;
    const ccomplex_t IT_0216 = m_s*IT_0168;
    const ccomplex_t IT_0217 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0218 = IT_0079*IT_0172;
    const ccomplex_t IT_0219 = IT_0063*IT_0217*IT_0218;
    const ccomplex_t IT_0220 = m_s*IT_0175;
    const ccomplex_t IT_0221 = -IT_0207 + -IT_0210 + -IT_0213 + IT_0214 +
       IT_0215 + IT_0216 + -IT_0219 + IT_0220;
    const ccomplex_t IT_0222 = IT_0099*IT_0151;
    const ccomplex_t IT_0223 = IT_0083*IT_0205*IT_0222;
    const ccomplex_t IT_0224 = IT_0119*IT_0158;
    const ccomplex_t IT_0225 = IT_0103*IT_0208*IT_0224;
    const ccomplex_t IT_0226 = IT_0139*IT_0165;
    const ccomplex_t IT_0227 = IT_0123*IT_0211*IT_0226;
    const ccomplex_t IT_0228 = m_s*IT_0102;
    const ccomplex_t IT_0229 = m_s*IT_0122;
    const ccomplex_t IT_0230 = m_s*IT_0142;
    const ccomplex_t IT_0231 = IT_0071*IT_0170;
    const ccomplex_t IT_0232 = IT_0063*IT_0217*IT_0231;
    const ccomplex_t IT_0233 = m_s*IT_0082;
    const ccomplex_t IT_0234 = (-0.166666666666667)*IT_0057 + -IT_0223 + 
      -IT_0225 + -IT_0227 + IT_0228 + IT_0229 + IT_0230 + -IT_0232 + IT_0233;
    ...
    const ccomplex_t IT_0259 = m_s*s_13;
    const ccomplex_t IT_0260 = 6*conj(IT_0221);
    const ccomplex_t IT_0261 = 6*conj(IT_0058);
    const ccomplex_t IT_0262 = 18*conj(IT_0234);
    const ccomplex_t IT_0263 = 6*conj(IT_0234);
    const ccomplex_t IT_0264 = 18*conj(IT_0058);
    const ccomplex_t IT_0265 = 18*conj(IT_0221);
    const ccomplex_t IT_0266 = IT_0058*(conj(IT_0143) + 3*conj(IT_0145)) + 3
      *conj(IT_0176)*(0.333333333333333*IT_0059 + IT_0221) + 3*conj(IT_0147)*
      (IT_0059 + 1./3*IT_0221) + 3*(conj(IT_0143) + 0.333333333333333*conj
      (IT_0145))*IT_0234 + 3*IT_0147*(conj(IT_0059) + 0.0555555555555556*IT_0260
      ) + 0.166666666666667*IT_0143*(IT_0261 + IT_0262) + 0.166666666666667
      *IT_0145*(IT_0263 + IT_0264) + IT_0176*(conj(IT_0059) + 0.166666666666667
      *IT_0265);
    const ccomplex_t IT_0267 = -s_14;
    const ccomplex_t IT_0268 = s_13 + IT_0267;
    const ccomplex_t IT_0269 = m_s*IT_0268;
    const ccomplex_t IT_0270 = conj(IT_0143) + conj(IT_0176);
    const ccomplex_t IT_0271 = IT_0143 + IT_0176;
    const ccomplex_t IT_0272 = conj(IT_0145) + conj(IT_0147);
    const ccomplex_t IT_0273 = 18*IT_0027;
    const ccomplex_t IT_0274 = IT_0145 + IT_0147;
    const ccomplex_t IT_0275 = 18*conj(IT_0027);
    const ccomplex_t IT_0276 = (-18)*IT_0221;
    const ccomplex_t IT_0277 = (-6)*IT_0221;
    const ccomplex_t IT_0278 = IT_0257*IT_0270 + IT_0258*IT_0271 + IT_0272
      *IT_0273 + IT_0274*IT_0275 + IT_0204*((-12)*IT_0027 + 12*conj(IT_0027) + (
      -6)*IT_0059 + 6*conj(IT_0059) + IT_0235 + IT_0236 + IT_0261 + IT_0262 +
       IT_0265 + IT_0276) + IT_0197*((-36)*IT_0027 + 36*conj(IT_0027) + (-18)
      *IT_0059 + 18*conj(IT_0059) + IT_0241 + IT_0242 + IT_0260 + IT_0263 +
       IT_0264 + IT_0277);
    const ccomplex_t IT_0279 = m_s*s_14;
    const ccomplex_t IT_0280 = (-18)*IT_0200;
    const ccomplex_t IT_0281 = IT_0182 + IT_0183 + IT_0280;
    const ccomplex_t IT_0282 = -IT_0204;
    const ccomplex_t IT_0283 = -IT_0197;
    const ccomplex_t IT_0284 = (-6)*IT_0200;
    const ccomplex_t IT_0285 = IT_0178 + IT_0180 + IT_0284;
    const ccomplex_t IT_0286 = (36*s_34 + (-36)*IT_0008)*IT_0027*conj(IT_0027)
       + (conj(IT_0027)*(IT_0058 + IT_0059) + IT_0027*(conj(IT_0058) + conj
      (IT_0059)))*IT_0062 + (conj(IT_0143)*IT_0145 + IT_0143*conj(IT_0145) +
       conj(IT_0147)*IT_0176 + IT_0147*conj(IT_0176))*IT_0181 + (IT_0143*conj
      (IT_0143) + IT_0145*conj(IT_0145) + IT_0147*conj(IT_0147) + IT_0176*conj
      ...
      *IT_0177 + 24*IT_0179 + (-12)*IT_0200) + 0.5*IT_0203*IT_0204) + IT_0061*
      ...
      ) + (-6)*conj(IT_0145))*IT_0176 + conj(IT_0176)*IT_0247 + conj(IT_0147)
      *IT_0250 + IT_0147*IT_0253) + (conj(IT_0059)*IT_0221 + IT_0059*conj
      (IT_0221) + conj(IT_0058)*IT_0234 + IT_0058*conj(IT_0234))*IT_0254 +
       IT_0256*((conj(IT_0221) + conj(IT_0234))*IT_0257 + (IT_0221 + IT_0234)
      *IT_0258) + 6*IT_0259*IT_0266 + IT_0269*IT_0278 + (conj(IT_0176)*IT_0237 +
       IT_0176*IT_0240 + conj(IT_0147)*IT_0243 + IT_0147*IT_0246 + conj(IT_0221)
      *IT_0247 + conj(IT_0059)*IT_0250 + IT_0059*IT_0253 + conj(IT_0143)*IT_0276
       + conj(IT_0145)*IT_0277)*IT_0279 + IT_0281*(IT_0204*IT_0270 + IT_0197
      *IT_0272 + IT_0271*IT_0282 + IT_0274*IT_0283) + (IT_0197*IT_0270 + IT_0204
      *IT_0272 + IT_0274*IT_0282 + IT_0271*IT_0283)*IT_0285;
