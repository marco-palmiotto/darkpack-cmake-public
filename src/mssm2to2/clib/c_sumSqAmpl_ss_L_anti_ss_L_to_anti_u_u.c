...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_L_to_anti_u_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm2)*IT_0006;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*V_us*e_em*U_Wm2*IT_0006;
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm1)*IT_0006;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*V_us*e_em*U_Wm1*IT_0006;
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0016 + IT_0029 + -m_C_1*
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_us
      *e_em*IT_0000*IT_0006*IT_0012;
    const ccomplex_t IT_0070 = 0.5*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_us*e_em*IT_0000*IT_0006*IT_0012;
    const ccomplex_t IT_0072 = 0.5*IT_0071;
    const ccomplex_t IT_0073 = IT_0070*IT_0072;
    const ccomplex_t IT_0074 = IT_0057*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_us
      *e_em*IT_0000*IT_0006*IT_0012;
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
      *V_us*e_em*IT_0000*IT_0006*IT_0012;
    ...
    const ccomplex_t IT_0084 = IT_0034*IT_0048;
    const ccomplex_t IT_0085 = -IT_0084;
    const ccomplex_t IT_0086 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0094 = cpow(s_12 + IT_0016 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0108 = IT_0016*IT_0029;
    ...
    const ccomplex_t IT_0113 = (-18)*IT_0066 + (-6)*IT_0068;
    const ccomplex_t IT_0114 = (-18)*IT_0068;
    const ccomplex_t IT_0115 = (-6)*IT_0066;
    const ccomplex_t IT_0116 = IT_0114 + IT_0115;
    const ccomplex_t IT_0117 = (-18)*conj(IT_0068);
    const ccomplex_t IT_0118 = (-6)*conj(IT_0066);
    const ccomplex_t IT_0119 = IT_0117 + IT_0118;
    const ccomplex_t IT_0120 = (-18)*IT_0050;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0122 = IT_0055*IT_0070;
    const ccomplex_t IT_0123 = IT_0057*IT_0121*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0125 = IT_0061*IT_0077;
    const ccomplex_t IT_0126 = IT_0063*IT_0124*IT_0125;
    const ccomplex_t IT_0127 = m_u*IT_0065;
    const ccomplex_t IT_0128 = m_u*IT_0059;
    const ccomplex_t IT_0129 = -IT_0123 + -IT_0126 + IT_0127 + IT_0128;
    const ccomplex_t IT_0130 = (-6)*IT_0129;
    const ccomplex_t IT_0131 = IT_0120 + IT_0130;
    const ccomplex_t IT_0132 = (-18)*conj(IT_0050);
    const ccomplex_t IT_0133 = (-6)*conj(IT_0129);
    const ccomplex_t IT_0134 = IT_0132 + IT_0133;
    const ccomplex_t IT_0135 = IT_0054*IT_0072;
    const ccomplex_t IT_0136 = IT_0057*IT_0121*IT_0135;
    const ccomplex_t IT_0137 = m_u*IT_0075;
    const ccomplex_t IT_0138 = IT_0060*IT_0079;
    const ccomplex_t IT_0139 = IT_0063*IT_0124*IT_0138;
    const ccomplex_t IT_0140 = m_u*IT_0082;
    const ccomplex_t IT_0141 = -IT_0136 + IT_0137 + -IT_0139 + IT_0140;
    const ccomplex_t IT_0142 = (-18)*IT_0129;
    const ccomplex_t IT_0143 = (-6)*IT_0050;
    const ccomplex_t IT_0144 = IT_0142 + IT_0143;
    const ccomplex_t IT_0145 = (-18)*conj(IT_0129);
    const ccomplex_t IT_0146 = (-6)*conj(IT_0050);
    ...
    const ccomplex_t IT_0153 = m_u*s_13;
    const ccomplex_t IT_0154 = 6*conj(IT_0141);
    const ccomplex_t IT_0155 = 6*conj(IT_0129);
    const ccomplex_t IT_0156 = 18*conj(IT_0050);
    const ccomplex_t IT_0157 = 18*conj(IT_0141);
    const ccomplex_t IT_0158 = 6*conj(IT_0050);
    const ccomplex_t IT_0159 = 18*conj(IT_0129);
    const ccomplex_t IT_0160 = IT_0050*(conj(IT_0066) + 3*conj(IT_0068)) +
       IT_0049*(conj(IT_0083) + 3*conj(IT_0085)) + 3*(conj(IT_0066) +
       0.333333333333333*conj(IT_0068))*IT_0129 + 3*(conj(IT_0083) +
       0.333333333333333*conj(IT_0085))*IT_0141 + 3*IT_0085*(conj(IT_0049) +
       0.0555555555555556*IT_0154) + 0.166666666666667*IT_0068*(IT_0155 +
       IT_0156) + IT_0083*(conj(IT_0049) + 0.166666666666667*IT_0157) +
       0.166666666666667*IT_0066*(IT_0158 + IT_0159);
    const ccomplex_t IT_0161 = m_u*s_14;
    const ccomplex_t IT_0162 = (-18)*IT_0141;
    const ccomplex_t IT_0163 = (-6)*IT_0141;
    const ccomplex_t IT_0164 = -s_14;
    const ccomplex_t IT_0165 = s_13 + IT_0164;
    const ccomplex_t IT_0166 = m_u*IT_0165;
    const ccomplex_t IT_0167 = conj(IT_0066) + conj(IT_0083);
    const ccomplex_t IT_0168 = IT_0066 + IT_0083;
    const ccomplex_t IT_0169 = conj(IT_0068) + conj(IT_0085);
    const ccomplex_t IT_0170 = 18*IT_0028;
    const ccomplex_t IT_0171 = IT_0068 + IT_0085;
    const ccomplex_t IT_0172 = 18*conj(IT_0028);
    const ccomplex_t IT_0173 = IT_0112*((-12)*IT_0028 + 12*conj(IT_0028) + (-6
      )*IT_0049 + 6*conj(IT_0049) + IT_0142 + IT_0143 + IT_0157 + IT_0158 +
       IT_0159 + IT_0162) + IT_0105*((-36)*IT_0028 + 36*conj(IT_0028) + (-18)
      *IT_0049 + 18*conj(IT_0049) + IT_0120 + IT_0130 + IT_0154 + IT_0155 +
       IT_0156 + IT_0163) + IT_0151*IT_0167 + IT_0152*IT_0168 + IT_0169*IT_0170 
      + IT_0171*IT_0172;
    const ccomplex_t IT_0174 = (-6)*IT_0108;
    const ccomplex_t IT_0175 = IT_0087 + IT_0089 + IT_0174;
    const ccomplex_t IT_0176 = -IT_0112;
    const ccomplex_t IT_0177 = -IT_0105;
    const ccomplex_t IT_0178 = (-18)*IT_0108;
    const ccomplex_t IT_0179 = IT_0091 + IT_0092 + IT_0178;
    const ccomplex_t IT_0180 = IT_0028*conj(IT_0028)*(36*s_34 + (-36)*IT_0029)
       + (conj(IT_0028)*(IT_0049 + IT_0050) + IT_0028*(conj(IT_0049) + conj
      (IT_0050)))*IT_0053 + (conj(IT_0066)*IT_0068 + IT_0066*conj(IT_0068) +
       conj(IT_0083)*IT_0085 + IT_0083*conj(IT_0085))*IT_0090 + (IT_0066*conj
      (IT_0066) + IT_0068*conj(IT_0068) + IT_0083*conj(IT_0083) + IT_0085*conj
      (IT_0085))*IT_0093 + -IT_0106*IT_0111 + (-2)*IT_0112*(IT_0105*((-12)
      *IT_0086 + 24*IT_0088 + (-12)*IT_0108) + 0.5*IT_0111*IT_0112) + IT_0108*((
      (-18)*conj(IT_0066) + (-6)*conj(IT_0068))*IT_0083 + conj(IT_0083)*IT_0113 
      + conj(IT_0085)*IT_0116 + IT_0085*IT_0119) + IT_0052*(IT_0049*conj(IT_0049
      ) + IT_0050*conj(IT_0050) + IT_0129*conj(IT_0129) + IT_0141*conj(IT_0141))
       + IT_0029*(conj(IT_0049)*IT_0131 + IT_0049*IT_0134 + conj(IT_0141)
      *IT_0144 + IT_0141*IT_0147) + (conj(IT_0050)*IT_0129 + IT_0050*conj
      (IT_0129) + conj(IT_0049)*IT_0141 + IT_0049*conj(IT_0141))*IT_0148 +
       IT_0150*((conj(IT_0129) + conj(IT_0141))*IT_0151 + (IT_0129 + IT_0141)
      *IT_0152) + 6*IT_0153*IT_0160 + IT_0161*(conj(IT_0049)*IT_0116 + IT_0049
      *IT_0119 + conj(IT_0085)*IT_0131 + IT_0085*IT_0134 + IT_0113*conj(IT_0141)
       + conj(IT_0083)*IT_0144 + IT_0083*IT_0147 + conj(IT_0066)*IT_0162 + conj
      (IT_0068)*IT_0163) + IT_0166*IT_0173 + IT_0175*(IT_0105*IT_0167 + IT_0112
      *IT_0169 + IT_0171*IT_0176 + IT_0168*IT_0177) + (IT_0112*IT_0167 + IT_0105
      *IT_0169 + IT_0168*IT_0176 + IT_0171*IT_0177)*IT_0179;
    return create_ccomplex_return(IT_0180);
}
