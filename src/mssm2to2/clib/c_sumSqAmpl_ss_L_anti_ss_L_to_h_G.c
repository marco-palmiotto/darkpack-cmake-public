...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_L_to_h_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0032 = (-4)*IT_0022*(conj(IT_0022)*IT_0023 + (-0.25)
      *conj(IT_0025)*IT_0026 + (-0.25)*conj(IT_0029)*IT_0030) + IT_0029*(conj
      (IT_0022)*IT_0030 + conj(IT_0025)*IT_0031) + (-4)*IT_0025*(IT_0014*conj
      (IT_0025) + (-0.25)*conj(IT_0022)*IT_0026 + (-0.25)*conj(IT_0029)*IT_0031);
