        ...
        )
{
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0026 + IT_0035 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0034*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0006
      *IT_0013*IT_0014*IT_0015 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + 3
      *IT_0015)*(IT_0001*IT_0007 + -IT_0002*IT_0016));
    const ccomplex_t IT_0040 = -IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_W*e_em*IT_0019*(IT_0007
      *IT_0020 + 5*IT_0001*((-1)*IT_0001*(IT_0002*IT_0007 + 1./5*IT_0001*IT_0016
      ) + IT_0016*IT_0022));
    const ccomplex_t IT_0042 = (-0.5)*IT_0041;
    const ccomplex_t IT_0043 = IT_0040*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_12 + (-2)*IT_0026 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0026 + IT_0035 + -m_sd_R*
    ...
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0026 + IT_0035 + -m_ss_R*
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0002;
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = IT_0064*IT_0066;
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0026 + IT_0035 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0026 + IT_0035 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0059*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = IT_0017*IT_0040;
    const ccomplex_t IT_0075 = cpow((-2)*s_23 + IT_0035 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = cpow((-2)*s_13 + IT_0035 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    ...
    const ccomplex_t IT_0086 = cpow((-2)*s_13 + IT_0026 + IT_0035 + -m_sb_1*
    ...
    const ccomplex_t IT_0094 = cpow((-2)*s_23 + IT_0026 + IT_0035 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0095 = IT_0093*IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*IT_0095;
    const ccomplex_t IT_0097 = cpow((-2)*s_13 + IT_0026 + IT_0035 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0105 = IT_0012 + -IT_0029 + IT_0038 + -IT_0046 +
       IT_0054 + IT_0062 + IT_0070 + IT_0073 + IT_0077 + IT_0080 + IT_0088 +
       IT_0096 + IT_0104;
