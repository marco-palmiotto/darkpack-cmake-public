...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_L_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0007
      *IT_0009 + IT_0011*IT_0012)*(IT_0003 + 1./3*IT_0002*IT_0017) + IT_0003
      *IT_0012*IT_0035*IT_0036*IT_0037);
    ...
    const ccomplex_t IT_0059 = (-3)*conj(IT_0030);
    const ccomplex_t IT_0060 = pow(s_34, 2);
    const ccomplex_t IT_0061 = IT_0031*IT_0060;
    const ccomplex_t IT_0062 = s_24*s_34*IT_0031;
    const ccomplex_t IT_0063 = -IT_0062;
    const ccomplex_t IT_0064 = s_23 + IT_0063;
    const ccomplex_t IT_0065 = pow(s_24, 2);
    const ccomplex_t IT_0066 = IT_0031*IT_0065;
    const ccomplex_t IT_0067 = (-3)*IT_0055;
    const ccomplex_t IT_0068 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0044)*IT_0047 + conj(IT_0055)*IT_0058) + IT_0055*IT_0058
      *IT_0059 + (-3)*IT_0044*((-0.333333333333333)*IT_0047*IT_0059 + conj
      (IT_0044)*(IT_0039 + -IT_0061) + conj(IT_0055)*IT_0064) + (conj(IT_0044)
      *IT_0064 + conj(IT_0055)*(IT_0025 + -IT_0066))*IT_0067;
