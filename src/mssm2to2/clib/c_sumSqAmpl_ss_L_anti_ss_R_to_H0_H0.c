...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_R_to_H0_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = pow(m_ss_R, 2);
    ...
    const ccomplex_t IT_0016 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*IT_0017;
    const ccomplex_t IT_0019 = pow(m_ss_L, 2);
    const ccomplex_t IT_0020 = cpow((-2)*s_13 + IT_0006 + IT_0019 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0023 + m_s*e_em*mu_h*IT_0000*IT_0024*IT_0026*IT_0028);
    ...
    const ccomplex_t IT_0035 = cpow(IT_0023, 3);
    const ccomplex_t IT_0036 = sin(beta);
    const ccomplex_t IT_0037 = cpow(IT_0023, 2);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_W*e_em*IT_0034*(IT_0025
      *IT_0035 + 5*IT_0000*((-1)*IT_0000*(IT_0023*IT_0025 + 1./5*IT_0000*IT_0036
      ) + IT_0036*IT_0037));
    const ccomplex_t IT_0039 = (-0.5)*IT_0038;
    const ccomplex_t IT_0040 = IT_0030*IT_0039;
    const ccomplex_t IT_0041 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0007 + -IT_0019 + -reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0000 + -m_s*e_em*mu_h*IT_0023*IT_0024*IT_0026*IT_0028);
    const ccomplex_t IT_0045 = (-0.5)*IT_0044;
    const ccomplex_t IT_0046 = cpow(IT_0000, 2);
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_W*e_em*IT_0034*(IT_0035
      *IT_0036 + -IT_0000*(IT_0000*IT_0023*IT_0036 + IT_0025*(IT_0037 + -IT_0046
      )));
    const ccomplex_t IT_0048 = (-1.5)*IT_0047;
    const ccomplex_t IT_0049 = IT_0045*IT_0048;
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + -IT_0007 + -IT_0019 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = pow(m_s, 2);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0028 +
       1./3*IT_0027*IT_0032)*(IT_0000*IT_0025 + -IT_0023*IT_0036) + IT_0000
      *IT_0024*IT_0026*IT_0028*IT_0053);
    const ccomplex_t IT_0055 = -IT_0054;
    const ccomplex_t IT_0056 = IT_0045*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0006 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0061 = IT_0056*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*e_em*(m_W*IT_0027*IT_0032*
      (IT_0000*IT_0025 + -IT_0023*IT_0036) + (-3)*IT_0000*IT_0024*IT_0026
      *IT_0028*IT_0053);
    const ccomplex_t IT_0064 = 0.333333333333333*IT_0063;
    const ccomplex_t IT_0065 = IT_0045*IT_0064;
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0006 + IT_0019 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0067 = IT_0065*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*IT_0067;
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0006 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    const ccomplex_t IT_0070 = IT_0065*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0006 + IT_0019 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0005*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = IT_0010 + IT_0018 + IT_0022 + -IT_0043 + 
      -IT_0052 + IT_0059 + IT_0062 + IT_0068 + IT_0071 + IT_0074;
