        ...
        )
{
    ...
    const ccomplex_t IT_0012 = cpow((-2)*s_23 + IT_0006 + IT_0011 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0000 + -m_s*e_em*mu_h*IT_0015*IT_0017*IT_0018*IT_0020);
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0015
      *IT_0017*IT_0020*IT_0023 + (-0.5)*m_W*(IT_0000*IT_0016 + -IT_0018*IT_0024)
      *(IT_0020 + 1./3*IT_0019*IT_0026));
    const ccomplex_t IT_0028 = -IT_0027;
    const ccomplex_t IT_0029 = IT_0022*IT_0028;
    const ccomplex_t IT_0030 = cpow((-2)*s_13 + IT_0006 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0031 = IT_0029*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = cpow((-2)*s_23 + IT_0006 + IT_0011 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0034 = IT_0029*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*-3)*e_em*(IT_0000*IT_0015
      *IT_0017*IT_0020*IT_0023 + -1./3*m_W*IT_0019*(IT_0000*IT_0016 + -IT_0018
      *IT_0024)*IT_0026);
    const ccomplex_t IT_0037 = 0.333333333333333*IT_0036;
    const ccomplex_t IT_0038 = IT_0022*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0006 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0006 + IT_0007 + -m_ss_R*
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0006 + IT_0011 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0018 + m_s*e_em*mu_h*IT_0000*IT_0015*IT_0017*IT_0020);
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = IT_0019*IT_0026;
    const ccomplex_t IT_0060 = IT_0020 + IT_0059;
    const ccomplex_t IT_0061 = cpow(IT_0018, 3);
    const ccomplex_t IT_0062 = cpow(IT_0018, 2);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*m_W*e_em*IT_0060*(IT_0016
      *IT_0061 + 5*IT_0000*((-1)*IT_0000*(IT_0016*IT_0018 + 1./5*IT_0000*IT_0024
      ) + IT_0024*IT_0062));
    const ccomplex_t IT_0064 = (-0.5)*IT_0063;
    const ccomplex_t IT_0065 = IT_0058*IT_0064;
    const ccomplex_t IT_0066 = IT_0056*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = cpow(IT_0000, 2);
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_W*e_em*IT_0060*(IT_0024
      *IT_0061 + -IT_0000*(IT_0000*IT_0018*IT_0024 + IT_0016*(IT_0062 + -IT_0068
      )));
    const ccomplex_t IT_0070 = (-1.5)*IT_0069;
    const ccomplex_t IT_0071 = IT_0022*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_12 + -IT_0007 + -IT_0011 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = IT_0010 + IT_0014 + IT_0032 + IT_0035 + IT_0041
       + IT_0044 + IT_0052 + IT_0055 + -IT_0067 + -IT_0074;
