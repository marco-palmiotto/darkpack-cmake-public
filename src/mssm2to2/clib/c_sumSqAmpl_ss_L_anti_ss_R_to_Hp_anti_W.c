        ...
        )
{
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*V_cs*e_em
      *IT_0001;
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0006
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*V_ts*e_em
      *IT_0001*conj(U_st_00);
    const ccomplex_t IT_0062 = -IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0006
