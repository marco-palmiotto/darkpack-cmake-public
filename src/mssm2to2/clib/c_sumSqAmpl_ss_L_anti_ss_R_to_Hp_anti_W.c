...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_R_to_Hp_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = m_s*e_em*mu_h*IT_0003;
    const ccomplex_t IT_0005 = IT_0001*IT_0004;
    const ccomplex_t IT_0006 = sin(beta);
    const ccomplex_t IT_0007 = A_b*V_ts*conj(V_ts);
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0017 + -m_s*e_em*mu_h*IT_0001*IT_0003*IT_0019*IT_0021);
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0019 + m_s*e_em*mu_h*IT_0001*IT_0003*IT_0017*IT_0021);
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*V_ts*e_em
      *IT_0001*conj(U_st_00);
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = cpow(IT_0006, -1);
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0006
      *U_st_00 + 0.707106781186548*m_s*e_em*IT_0001*IT_0003*(mu_h*U_st_00 + m_t
      *IT_0021*IT_0038*U_st_10));
    const ccomplex_t IT_0040 = pow(m_Hp, 2);
    const ccomplex_t IT_0041 = cpow((-2)*s_23 + IT_0012 + IT_0040 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0039*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = IT_0037*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*V_ts*e_em
      *IT_0001*conj(U_st_01);
    const ccomplex_t IT_0046 = -IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0006
      *U_st_01 + 0.707106781186548*m_s*e_em*IT_0001*IT_0003*(mu_h*U_st_01 + m_t
      *IT_0021*IT_0038*U_st_11));
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0012 + IT_0040 + -m_st_2*
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*mu_h*IT_0001*IT_0003;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0012 + IT_0040 + -m_sc_L*
    ...
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *mu_h*IT_0001*IT_0003;
    const ccomplex_t IT_0063 = 0.5*IT_0062;
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0012 + IT_0040 + -m_su_L*
