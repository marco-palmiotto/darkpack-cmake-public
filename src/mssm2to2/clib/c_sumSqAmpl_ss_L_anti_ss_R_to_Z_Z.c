...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_R_to_Z_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0008 + m_s*e_em*mu_h*IT_0001*IT_0014*IT_0022*IT_0023);
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0001 + -m_s*e_em*mu_h*IT_0008*IT_0014*IT_0022*IT_0023);
