...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_R_to_anti_W_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0001 + -m_s*e_em*mu_h*IT_0003*IT_0005*IT_0007*IT_0008);
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0003 + m_s*e_em*mu_h*IT_0001*IT_0005*IT_0007*IT_0008);
