        ...
        )
{
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0001*IT_0002*IT_0022;
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0001;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_cs)*e_em*IT_0001*IT_0002*IT_0022;
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0001*IT_0002*IT_0011;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0066 + m_s*e_em*mu_h*IT_0001*IT_0002*IT_0022*IT_0067);
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*-1)*(m_s*e_em*mu_h*IT_0001
      *IT_0002*IT_0022*IT_0066 + (-1.4142135623731)*A_b*V_ts*conj(V_ts)*IT_0067);
