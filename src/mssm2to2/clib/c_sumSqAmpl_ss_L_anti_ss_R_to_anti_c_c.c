...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_R_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = m_c*e_em*IT_0001*IT_0002*IT_0010*IT_0011;
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + IT_0020 
      + -reg_prop, -1);
    const ccomplex_t IT_0022 = m_c*e_em*IT_0001*IT_0002;
    const ccomplex_t IT_0023 = (-0.5)*IT_0022;
    const ccomplex_t IT_0024 = cpow(IT_0010, -1);
    const ccomplex_t IT_0025 = IT_0001*IT_0005*IT_0024;
    const ccomplex_t IT_0026 = IT_0003*IT_0025;
    const ccomplex_t IT_0027 = IT_0006*IT_0010;
    const ccomplex_t IT_0028 = 1.4142135623731*IT_0027;
    const ccomplex_t IT_0029 = 0.5*IT_0026 + (-0.5)*IT_0028;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0016 + IT_0034 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0001;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_cs)*e_em*IT_0001*IT_0002*IT_0024;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = IT_0036*IT_0038;
    const ccomplex_t IT_0040 = IT_0035*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = cpow((-2)*s_23 + IT_0016 + IT_0034 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0001;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0001*IT_0002*IT_0024;
    ...
    const ccomplex_t IT_0052 = m_c*IT_0041;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u1
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = IT_0038*IT_0055;
    const ccomplex_t IT_0057 = IT_0035*IT_0053*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*m_c*V_cs*V_u2
      *e_em*IT_0001*IT_0002*IT_0011;
    const ccomplex_t IT_0060 = 0.5*IT_0059;
    const ccomplex_t IT_0061 = IT_0045*IT_0060;
    const ccomplex_t IT_0062 = IT_0042*IT_0058*IT_0061;
    const ccomplex_t IT_0063 = m_c*IT_0048;
    const ccomplex_t IT_0064 = IT_0052 + -IT_0057 + -IT_0062 + IT_0063;
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0066 + -m_s*e_em*mu_h*IT_0001*IT_0002*IT_0024*IT_0067);
    const ccomplex_t IT_0069 = (-0.5)*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*m_c*e_em*IT_0001*IT_0002
      *IT_0011*IT_0067;
    const ccomplex_t IT_0071 = (-0.5)*IT_0070;
    const ccomplex_t IT_0072 = IT_0069*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*(m_s*e_em*mu_h*IT_0001
      *IT_0002*IT_0024*IT_0066 + 1.4142135623731*A_b*V_ts*conj(V_ts)*IT_0067);
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*m_c*e_em*IT_0001*IT_0002
      *IT_0011*IT_0066;
    ...
    const ccomplex_t IT_0087 = m_c*IT_0086;
    const ccomplex_t IT_0088 = -IT_0034;
    const ccomplex_t IT_0089 = m_c*s_13;
    const ccomplex_t IT_0090 = s_13*s_14;
    const ccomplex_t IT_0091 = s_34*IT_0015;
