...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_R_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = e_em*m_mu*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0005*IT_0034;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0005*IT_0037;
