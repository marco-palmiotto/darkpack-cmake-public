        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm1)*IT_0004;
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_ts)*e_em*IT_0004*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*V_ts*e_em*conj(U_Wm2)*IT_0004;
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_ts)*e_em*IT_0004*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0029 = m_t*IT_0013;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*m_t*V_ts*V_u2
      *e_em*IT_0004*IT_0006*IT_0024;
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = IT_0017*IT_0032;
    const ccomplex_t IT_0034 = IT_0014*IT_0030*IT_0033;
    const ccomplex_t IT_0035 = m_t*IT_0020;
    const ccomplex_t IT_0036 = -IT_0028 + IT_0029 + -IT_0034 + IT_0035;
    const ccomplex_t IT_0037 = m_t*s_13;
    const ccomplex_t IT_0038 = m_t*e_em*IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0057 = m_t*e_em*IT_0004*IT_0006*IT_0007*IT_0024;
    ...
    const ccomplex_t IT_0065 = m_t*IT_0064;
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*m_t*e_em*IT_0004*IT_0006
      *IT_0024*IT_0069;
    ...
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*m_t*e_em*IT_0004*IT_0006
      *IT_0024*IT_0068;
