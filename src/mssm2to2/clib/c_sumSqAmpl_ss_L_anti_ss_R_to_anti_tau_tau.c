...
ccomplex_return_t c_sumSqAmpl_ss_L_anti_ss_R_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = m_s*e_em*mu_h*IT_0000;
    const ccomplex_t IT_0009 = IT_0005*IT_0008;
    const ccomplex_t IT_0010 = A_b*V_ts*conj(V_ts);
    ...
    const ccomplex_t IT_0020 = e_em*m_tau*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0002
      *IT_0005*IT_0034;
    const ccomplex_t IT_0036 = (-0.5)*IT_0035;
    const ccomplex_t IT_0037 = sin(alpha);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0034 + -m_s*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0037);
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0002
      *IT_0005*IT_0037;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*(m_s*e_em*mu_h*IT_0000
      *IT_0002*IT_0005*IT_0034 + 1.4142135623731*A_b*V_ts*conj(V_ts)*IT_0037);
    ...
    return create_ccomplex_return(IT_0032*conj(IT_0032)*(12*s_34 + 12*IT_0033)
       + (12*s_34 + (-12)*IT_0033)*IT_0052*conj(IT_0052));
}
