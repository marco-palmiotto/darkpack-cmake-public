        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm1)*IT_0002;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*V_us
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*V_us*e_em*conj(U_Wm2)*IT_0002;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*V_us
      *e_em*IT_0000*IT_0002*IT_0007;
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_us
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_us
      *e_em*IT_0000*IT_0002*IT_0026;
