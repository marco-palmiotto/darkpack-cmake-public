        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0003 + m_s*e_em*mu_h*IT_0000*IT_0020*IT_0022*IT_0024);
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*(m_W*IT_0023*IT_0028*
      (IT_0000*IT_0021 + -IT_0003*IT_0029) + (-3)*IT_0000*IT_0020*IT_0022
      *IT_0024*IT_0030);
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0007 + IT_0034 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0033*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0000 + -m_s*e_em*mu_h*IT_0003*IT_0020*IT_0022*IT_0024);
    const ccomplex_t IT_0039 = (-0.5)*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0024 +
       1./3*IT_0023*IT_0028)*(IT_0003*IT_0021 + IT_0000*IT_0029) + IT_0003
      *IT_0020*IT_0022*IT_0024*IT_0030);
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0007 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*e_em*(m_W*IT_0023*IT_0028*
      (IT_0003*IT_0021 + IT_0000*IT_0029) + (-3)*IT_0003*IT_0020*IT_0022*IT_0024
      *IT_0030);
    const ccomplex_t IT_0046 = (-0.333333333333333)*IT_0045;
    const ccomplex_t IT_0047 = IT_0039*IT_0046;
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0007 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_13 + IT_0007 + IT_0034 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0057 = IT_0055*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0007 + IT_0034 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
    ...
    const ccomplex_t IT_0067 = IT_0023*IT_0028;
    const ccomplex_t IT_0068 = IT_0024 + IT_0067;
    const ccomplex_t IT_0069 = cpow(IT_0003, 3);
    const ccomplex_t IT_0070 = cpow(IT_0003, 2);
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*m_W*e_em*IT_0068*(IT_0021
      *IT_0069 + 5*IT_0000*((-1)*IT_0000*(IT_0003*IT_0021 + 1./5*IT_0000*IT_0029
      ) + IT_0029*IT_0070));
    const ccomplex_t IT_0072 = (-0.5)*IT_0071;
    const ccomplex_t IT_0073 = IT_0039*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_12 + -IT_0008 + -IT_0034 + m_H0*
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*m_W*e_em*IT_0068*(IT_0029
      *IT_0069 + (-5)*IT_0000*(IT_0000*IT_0003*IT_0029 + 1*IT_0021*(IT_0070 + 
      -1./5*IT_0077)));
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0008 + -IT_0034 + -reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0024 +
       1./3*IT_0023*IT_0028)*(IT_0000*IT_0021 + -IT_0003*IT_0029) + IT_0000
      *IT_0020*IT_0022*IT_0024*IT_0030);
    ...
    const ccomplex_t IT_0090 = IT_0011 + IT_0019 + IT_0037 + IT_0044 + IT_0050
