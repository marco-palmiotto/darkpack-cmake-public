        ...
        )
{
    ...
    const ccomplex_t IT_0029 = cpow((-2)*s_13 + IT_0006 + (0 + _Complex_I*1)
      *m_ss_L*Gamma_sl + reg_prop, -1);
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0033 = IT_0028*IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*-3)*e_em*(IT_0000*IT_0015
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_13 + IT_0006 + IT_0011 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0042 = IT_0037*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0006 + IT_0011 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0006 + IT_0007 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0057 = IT_0019*IT_0026;
    const ccomplex_t IT_0058 = IT_0020 + IT_0057;
    const ccomplex_t IT_0059 = cpow(IT_0000, 3);
    const ccomplex_t IT_0060 = cpow(IT_0018, 2);
    const ccomplex_t IT_0061 = cpow(IT_0000, 2);
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*m_W*e_em*IT_0058*(IT_0024
      *IT_0059 + (-5)*IT_0018*(IT_0000*IT_0018*IT_0024 + (-0.2)*IT_0016*(IT_0060
       + (-5)*IT_0061)));
    const ccomplex_t IT_0063 = 0.5*IT_0062;
    const ccomplex_t IT_0064 = IT_0056*IT_0063;
    const ccomplex_t IT_0065 = cpow((-2)*s_12 + -IT_0007 + -IT_0011 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*m_W*e_em*IT_0058*(IT_0016
      *IT_0059 + -IT_0018*(IT_0018*(IT_0000*IT_0016 + IT_0018*IT_0024) + 
      -IT_0024*IT_0061));
    ...
    const ccomplex_t IT_0074 = IT_0010 + IT_0014 + IT_0031 + IT_0034 + IT_0040
       + IT_0043 + IT_0051 + IT_0054 + -IT_0067 + -IT_0073;
