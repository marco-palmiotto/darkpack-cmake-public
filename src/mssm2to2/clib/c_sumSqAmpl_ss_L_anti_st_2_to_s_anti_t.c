        ...
        )
{
    ...
    const ccomplex_t IT_0009 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_3*
    ...
    const ccomplex_t IT_0017 = conj(N_W3)*e_em;
    ...
    const ccomplex_t IT_0022 = N_B3*e_em*conj(U_st_01);
    const ccomplex_t IT_0023 = IT_0011*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = N_W3*e_em*conj(U_st_01);
    ...
    const ccomplex_t IT_0032 = m_t*N_u3*e_em*IT_0031*conj(U_st_11);
    ...
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_4*
    ...
    const ccomplex_t IT_0083 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_2*
    ...
    const ccomplex_t IT_0115 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0005 + -IT_0114 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0119 = (-0.5)*IT_0008 + -IT_0118;
    const ccomplex_t IT_0120 = cos(beta);
    const ccomplex_t IT_0121 = cpow(IT_0120, -1);
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0016*IT_0031*IT_0121;
    const ccomplex_t IT_0123 = (-0.5)*IT_0122;
    const ccomplex_t IT_0124 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0125 = IT_0011*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = m_t*conj(N_u4)*e_em*IT_0031*conj(U_st_01);
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0016*IT_0031*IT_0121;
    const ccomplex_t IT_0136 = (-0.5)*IT_0135;
    const ccomplex_t IT_0137 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0138 = IT_0011*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = m_t*conj(N_u2)*e_em*IT_0031*conj(U_st_01);
    const ccomplex_t IT_0141 = IT_0030*IT_0140;
    ...
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0016*IT_0031*IT_0121;
    const ccomplex_t IT_0149 = (-0.5)*IT_0148;
    const ccomplex_t IT_0150 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0151 = IT_0011*IT_0150;
    const ccomplex_t IT_0152 = 1.4142135623731*IT_0151;
    const ccomplex_t IT_0153 = m_t*conj(N_u1)*e_em*IT_0031*conj(U_st_01);
    ...
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0016*IT_0031*IT_0121;
    const ccomplex_t IT_0162 = (-0.5)*IT_0161;
    const ccomplex_t IT_0163 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0164 = IT_0011*IT_0163;
    const ccomplex_t IT_0165 = 1.4142135623731*IT_0164;
    const ccomplex_t IT_0166 = m_t*conj(N_u3)*e_em*IT_0031*conj(U_st_01);
    const ccomplex_t IT_0167 = IT_0030*IT_0166;
    const ccomplex_t IT_0168 = 1.4142135623731*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*(IT_0165 + (-0.75)*IT_0168);
    ...
    const ccomplex_t IT_0175 = s_34*IT_0005;
    ...
    const ccomplex_t IT_0180 = m_s*s_14;
    const ccomplex_t IT_0181 = IT_0036*IT_0162;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0183 = IT_0009*IT_0181*IT_0182;
    const ccomplex_t IT_0184 = IT_0058*IT_0123;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0186 = IT_0060*IT_0184*IT_0185;
    const ccomplex_t IT_0187 = IT_0081*IT_0149;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0189 = IT_0083*IT_0187*IT_0188;
    const ccomplex_t IT_0190 = IT_0104*IT_0136;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0192 = IT_0106*IT_0190*IT_0191;
    const ccomplex_t IT_0193 = m_s*IT_0008;
    const ccomplex_t IT_0194 = m_s*IT_0085;
    const ccomplex_t IT_0195 = m_s*IT_0108;
    const ccomplex_t IT_0196 = m_s*IT_0039;
    const ccomplex_t IT_0197 = m_s*IT_0062;
    const ccomplex_t IT_0198 = -IT_0183 + -IT_0186 + -IT_0189 + -IT_0192 + (
      -0.166666666666667)*IT_0193 + IT_0194 + IT_0195 + IT_0196 + IT_0197;
    const ccomplex_t IT_0199 = IT_0047*IT_0131;
    const ccomplex_t IT_0200 = IT_0060*IT_0185*IT_0199;
    const ccomplex_t IT_0201 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_11);
    const ccomplex_t IT_0202 = IT_0000*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0204 = IT_0006*IT_0202*IT_0203;
    const ccomplex_t IT_0205 = m_s*IT_0160;
    const ccomplex_t IT_0206 = m_s*IT_0173;
    const ccomplex_t IT_0207 = m_s*IT_0134;
    const ccomplex_t IT_0208 = IT_0070*IT_0157;
    const ccomplex_t IT_0209 = IT_0083*IT_0188*IT_0208;
    const ccomplex_t IT_0210 = IT_0093*IT_0144;
    const ccomplex_t IT_0211 = IT_0106*IT_0191*IT_0210;
    const ccomplex_t IT_0212 = IT_0021*IT_0170;
    const ccomplex_t IT_0213 = IT_0009*IT_0182*IT_0212;
    const ccomplex_t IT_0214 = m_s*IT_0147;
    const ccomplex_t IT_0215 = -IT_0200 + 0.166666666666667*IT_0204 + IT_0205 
      + IT_0206 + IT_0207 + -IT_0209 + -IT_0211 + -IT_0213 + IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_ts)
      *e_em*IT_0016*IT_0029*IT_0031*IT_0120;
    const ccomplex_t IT_0217 = 0.5*IT_0216;
    const ccomplex_t IT_0218 = A_t*IT_0120*conj(U_st_11) + (-1.4142135623731)
      *e_em*IT_0016*(m_W*IT_0028*IT_0120*conj(U_st_01) + (-0.5)*IT_0031*(IT_0003
      *IT_0028*IT_0121*conj(U_st_01) + m_t*(m_t*IT_0029*IT_0120*conj(U_st_01) +
       mu_h*conj(U_st_11))));
    const ccomplex_t IT_0219 = (0 + _Complex_I*1)*V_ts*IT_0218;
    const ccomplex_t IT_0220 = IT_0217*IT_0219;
    const ccomplex_t IT_0221 = cpow((-2)*s_12 + -IT_0005 + -IT_0114 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0222 = IT_0220*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = (-0.5)*IT_0110;
    const ccomplex_t IT_0225 = m_t*IT_0224;
    const ccomplex_t IT_0226 = m_t*IT_0111;
    ...
    const ccomplex_t IT_0231 = cpow((-2)*s_12 + -IT_0005 + -IT_0114 + IT_0230 
      + -reg_prop, -1);
    const ccomplex_t IT_0232 = (0 + _Complex_I*1.4142135623731)*m_t*conj(V_ts)
      *e_em*IT_0016*IT_0031;
    const ccomplex_t IT_0233 = 0.5*IT_0232;
    const ccomplex_t IT_0234 = pow(m_t, 2);
    const ccomplex_t IT_0235 = cpow(IT_0120, 2);
    const ccomplex_t IT_0236 = cpow(IT_0028, 2);
    const ccomplex_t IT_0237 = A_t*IT_0028*conj(U_st_11) + (-0.707106781186548
      )*e_em*IT_0016*((IT_0031*(IT_0003 + -IT_0234) + -m_W*(IT_0235 + -IT_0236))
      *conj(U_st_01) + m_t*mu_h*IT_0029*IT_0031*IT_0120*conj(U_st_11));
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*V_ts*IT_0237;
    ...
    const ccomplex_t IT_0242 = (-0.5)*IT_0204 + -IT_0223 + IT_0229 + -IT_0241;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_ts)
      *e_em*IT_0016*IT_0031;
    const ccomplex_t IT_0244 = (-0.5)*IT_0243;
    const ccomplex_t IT_0245 = IT_0238*IT_0244;
    const ccomplex_t IT_0246 = IT_0231*IT_0245;
    const ccomplex_t IT_0247 = (0 + _Complex_I*1)*IT_0246;
    const ccomplex_t IT_0248 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_ts)
      *e_em*IT_0016*IT_0028*IT_0031*IT_0121;
    const ccomplex_t IT_0249 = 0.5*IT_0248;
    const ccomplex_t IT_0250 = IT_0219*IT_0249;
    const ccomplex_t IT_0251 = IT_0221*IT_0250;
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*IT_0251;
    const ccomplex_t IT_0253 = m_s*IT_0224;
    const ccomplex_t IT_0254 = m_s*IT_0111;
    const ccomplex_t IT_0255 = -IT_0254;
    const ccomplex_t IT_0256 = IT_0253 + IT_0255;
    const ccomplex_t IT_0257 = IT_0117*IT_0256;
    const ccomplex_t IT_0258 = 0.5*IT_0193 + -IT_0247 + -IT_0252 + -IT_0257;
    const ccomplex_t IT_0259 = IT_0109 + 3*IT_0119;
    const ccomplex_t IT_0260 = 3*conj(IT_0119);
    const ccomplex_t IT_0261 = conj(IT_0109) + IT_0260;
    const ccomplex_t IT_0262 = (18*conj(IT_0109) + 6*conj(IT_0119))*IT_0198 + 
      (18*IT_0109 + 6*IT_0119)*conj(IT_0198) + conj(IT_0174)*(18*IT_0215 + 6
      *IT_0242) + IT_0174*(18*conj(IT_0215) + 6*conj(IT_0242)) + 6*conj(IT_0258)
      *IT_0259 + 6*IT_0258*IT_0261;
    const ccomplex_t IT_0263 = m_s*m_t*IT_0005;
    const ccomplex_t IT_0264 = (-6)*IT_0119;
    const ccomplex_t IT_0265 = (-18)*IT_0109;
    const ccomplex_t IT_0266 = IT_0264 + IT_0265;
    const ccomplex_t IT_0267 = (-6)*conj(IT_0119);
    const ccomplex_t IT_0268 = (-18)*conj(IT_0109);
    const ccomplex_t IT_0269 = IT_0267 + IT_0268;
    const ccomplex_t IT_0270 = 6*s_34;
    const ccomplex_t IT_0271 = 18*s_34;
    const ccomplex_t IT_0272 = 12*IT_0177;
    const ccomplex_t IT_0273 = (-6)*IT_0175;
    const ccomplex_t IT_0274 = m_t*s_13;
    const ccomplex_t IT_0275 = (-18)*conj(IT_0198);
    const ccomplex_t IT_0276 = (-6)*conj(IT_0258);
    const ccomplex_t IT_0277 = IT_0275 + IT_0276;
    const ccomplex_t IT_0278 = (-6)*IT_0258;
    const ccomplex_t IT_0279 = (-6)*conj(IT_0242);
    const ccomplex_t IT_0280 = m_s*m_t;
    const ccomplex_t IT_0281 = (IT_0109*conj(IT_0109) + IT_0119*conj(IT_0119) 
      + IT_0174*conj(IT_0174))*IT_0179 + IT_0180*IT_0262 + IT_0263*(conj(IT_0174
      )*IT_0266 + IT_0174*IT_0269) + (conj(IT_0215)*IT_0242 + IT_0215*conj
      (IT_0242) + conj(IT_0198)*IT_0258 + IT_0198*conj(IT_0258))*IT_0270 + 
      (IT_0198*conj(IT_0198) + IT_0215*conj(IT_0215) + IT_0242*conj(IT_0242) +
       IT_0258*conj(IT_0258))*IT_0271 + (conj(IT_0109)*IT_0119 + IT_0109*conj
      (IT_0119))*(IT_0272 + IT_0273) + (-6)*IT_0274*(IT_0242*IT_0261 + -1./6
      *conj(IT_0215)*IT_0266 + -1./6*IT_0215*IT_0269 + -1./6*IT_0174*IT_0277 + 
      -1./6*conj(IT_0174)*((-18)*IT_0198 + IT_0278) + -1./6*IT_0259*IT_0279) + (
      -18)*(conj(IT_0242)*IT_0258 + 1./3*IT_0242*(conj(IT_0198) + 3*conj(IT_0258
      )) + (-0.0555555555555555)*IT_0215*IT_0277 + (-0.0555555555555555)*conj
      (IT_0215)*IT_0278 + (-0.0555555555555555)*IT_0198*((-18)*conj(IT_0215) +
       IT_0279))*IT_0280;
