        ...
        )
{
    ...
    const ccomplex_t IT_0016 = conj(N_B1)*e_em*U_sb_00;
    const ccomplex_t IT_0017 = IT_0015*IT_0016;
    const ccomplex_t IT_0018 = 1.4142135623731*IT_0017;
    const ccomplex_t IT_0019 = conj(N_W1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = m_b*conj(N_d2)*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0032 = IT_0010*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W2)*e_em*U_sb_00;
    const ccomplex_t IT_0035 = IT_0007*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = m_b*conj(N_d4)*e_em*IT_0003*U_sb_10;
    const ccomplex_t IT_0068 = IT_0010*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0071 = IT_0007*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_10;
    const ccomplex_t IT_0085 = IT_0083*IT_0084;
    const ccomplex_t IT_0086 = pow(m_sG, 2);
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -IT_0086 +
       reg_prop, -1);
    ...
    const ccomplex_t IT_0099 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0100 = IT_0015*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = m_b*N_d2*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0121 = m_b*N_d1*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0137 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0138 = IT_0015*IT_0137;
    const ccomplex_t IT_0139 = 1.4142135623731*IT_0138;
    const ccomplex_t IT_0140 = m_b*N_d3*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0156 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0157 = IT_0015*IT_0156;
    const ccomplex_t IT_0158 = 1.4142135623731*IT_0157;
    const ccomplex_t IT_0159 = m_b*N_d4*e_em*IT_0003*U_sb_00;
    ...
    const ccomplex_t IT_0167 = 0.166666666666667*IT_0089 + -IT_0109 + -IT_0128
       + -IT_0147 + -IT_0166;
    const ccomplex_t IT_0168 = m_b*m_s*IT_0001;
    const ccomplex_t IT_0169 = s_34*IT_0001;
    const ccomplex_t IT_0170 = (-18)*IT_0169;
    const ccomplex_t IT_0171 = s_13*s_14;
    const ccomplex_t IT_0172 = 36*IT_0171;
    const ccomplex_t IT_0173 = IT_0170 + IT_0172;
    const ccomplex_t IT_0174 = m_b*s_13;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_00;
    const ccomplex_t IT_0176 = IT_0083*IT_0175;
    const ccomplex_t IT_0177 = IT_0087*IT_0176;
    const ccomplex_t IT_0178 = (0 + _Complex_I*1)*IT_0177;
    const ccomplex_t IT_0179 = m_sG*IT_0178;
    const ccomplex_t IT_0180 = (-0.5)*IT_0179;
    const ccomplex_t IT_0181 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0182 = IT_0024*IT_0117;
    const ccomplex_t IT_0183 = IT_0002*IT_0181*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0185 = IT_0042*IT_0098;
    const ccomplex_t IT_0186 = IT_0028*IT_0184*IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0188 = IT_0078*IT_0155;
    const ccomplex_t IT_0189 = IT_0064*IT_0187*IT_0188;
    const ccomplex_t IT_0190 = 0.166666666666667*IT_0179 + -IT_0183 + -IT_0186
       + -IT_0189;
    const ccomplex_t IT_0191 = m_s*IT_0027;
    const ccomplex_t IT_0192 = m_s*IT_0045;
    const ccomplex_t IT_0193 = m_s*IT_0063;
    const ccomplex_t IT_0194 = m_s*IT_0081;
    const ccomplex_t IT_0195 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0196 = IT_0060*IT_0136;
    const ccomplex_t IT_0197 = IT_0046*IT_0195*IT_0196;
    const ccomplex_t IT_0198 = -IT_0191 + -IT_0192 + -IT_0193 + -IT_0194 +
       IT_0197;
    const ccomplex_t IT_0199 = (-3)*IT_0198;
    const ccomplex_t IT_0200 = IT_0180 + 3*IT_0190 + IT_0199;
    const ccomplex_t IT_0201 = (-3)*conj(IT_0198);
    const ccomplex_t IT_0202 = 3*conj(IT_0190);
    const ccomplex_t IT_0203 = conj(IT_0180) + IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = m_s*IT_0089;
    const ccomplex_t IT_0205 = (-0.5)*IT_0204;
    const ccomplex_t IT_0206 = 6*IT_0205;
    const ccomplex_t IT_0207 = IT_0009*IT_0125;
    const ccomplex_t IT_0208 = IT_0002*IT_0181*IT_0207;
    const ccomplex_t IT_0209 = IT_0066*IT_0163;
    const ccomplex_t IT_0210 = IT_0064*IT_0187*IT_0209;
    const ccomplex_t IT_0211 = m_s*IT_0128;
    const ccomplex_t IT_0212 = m_s*IT_0109;
    const ccomplex_t IT_0213 = m_s*IT_0147;
    const ccomplex_t IT_0214 = m_s*IT_0166;
    const ccomplex_t IT_0215 = 0.166666666666667*IT_0204 + IT_0208 + IT_0210 +
       -IT_0211 + -IT_0212 + -IT_0213 + -IT_0214;
    const ccomplex_t IT_0216 = 18*IT_0215;
    const ccomplex_t IT_0217 = IT_0030*IT_0106;
    const ccomplex_t IT_0218 = IT_0028*IT_0184*IT_0217;
    const ccomplex_t IT_0219 = IT_0048*IT_0144;
    const ccomplex_t IT_0220 = IT_0046*IT_0195*IT_0219;
    const ccomplex_t IT_0221 = -IT_0218 + -IT_0220;
    const ccomplex_t IT_0222 = (-18)*IT_0221;
    const ccomplex_t IT_0223 = IT_0206 + IT_0216 + IT_0222;
    const ccomplex_t IT_0224 = 6*conj(IT_0205);
    const ccomplex_t IT_0225 = 18*conj(IT_0215);
    const ccomplex_t IT_0226 = (-18)*conj(IT_0221);
    const ccomplex_t IT_0227 = IT_0224 + IT_0225 + IT_0226;
    const ccomplex_t IT_0228 = conj(IT_0090)*((-18)*IT_0180 + (-6)*IT_0190 + 6
      *IT_0198) + IT_0090*((-18)*conj(IT_0180) + (-6)*conj(IT_0190) + 6*conj
      (IT_0198)) + (-6)*conj(IT_0167)*IT_0200 + (-6)*IT_0167*IT_0203 + conj
      (IT_0082)*IT_0223 + IT_0082*IT_0227;
    const ccomplex_t IT_0229 = m_b*m_s;
    const ccomplex_t IT_0230 = -conj(IT_0215);
    const ccomplex_t IT_0231 = (-3)*conj(IT_0205);
    const ccomplex_t IT_0232 = conj(IT_0221) + IT_0230 + IT_0231;
    const ccomplex_t IT_0233 = 18*IT_0221;
    const ccomplex_t IT_0234 = (-18)*IT_0215;
    const ccomplex_t IT_0235 = (-6)*IT_0205;
    const ccomplex_t IT_0236 = IT_0233 + IT_0234 + IT_0235;
    const ccomplex_t IT_0237 = 18*conj(IT_0221);
    const ccomplex_t IT_0238 = (-18)*conj(IT_0215);
    const ccomplex_t IT_0239 = (-6)*conj(IT_0205);
    const ccomplex_t IT_0240 = IT_0237 + IT_0238 + IT_0239;
    const ccomplex_t IT_0241 = 18*IT_0229*(conj(IT_0180)*(IT_0205 + 1./3
      *IT_0215 + -1./3*IT_0221) + 0.0555555555555555*conj(IT_0190)*IT_0223 +
       0.0555555555555555*IT_0190*IT_0227 + -1./3*IT_0180*IT_0232 +
       0.0555555555555555*conj(IT_0198)*IT_0236 + 0.0555555555555555*IT_0198
      *IT_0240);
    const ccomplex_t IT_0242 = m_s*s_14;
    const ccomplex_t IT_0243 = 6*s_34;
    const ccomplex_t IT_0244 = 18*s_34;
    const ccomplex_t IT_0245 = (-18)*s_34;
    const ccomplex_t IT_0246 = (-6)*s_34;
    const ccomplex_t IT_0247 = 12*IT_0171;
    const ccomplex_t IT_0248 = (-6)*IT_0169;
    const ccomplex_t IT_0249 = (-6)*(conj(IT_0082)*(IT_0090 + 3*IT_0167) +
       IT_0082*(conj(IT_0090) + 3*conj(IT_0167)))*IT_0168 + (IT_0082*conj
      (IT_0082) + IT_0090*conj(IT_0090) + IT_0167*conj(IT_0167))*IT_0173 +
       IT_0174*IT_0228 + IT_0241 + 6*(conj(IT_0082)*IT_0200 + IT_0082*IT_0203 + 
      (-3)*conj(IT_0090)*(IT_0205 + 1./3*IT_0215 + -1./3*IT_0221) + IT_0090
      *IT_0232 + 0.166666666666667*conj(IT_0167)*IT_0236 + 0.166666666666667
      *IT_0167*IT_0240)*IT_0242 + (conj(IT_0180)*IT_0190 + IT_0180*conj(IT_0190)
       + conj(IT_0205)*IT_0215 + IT_0205*conj(IT_0215))*IT_0243 + (IT_0180*conj
      (IT_0180) + IT_0190*conj(IT_0190) + IT_0198*conj(IT_0198) + IT_0205*conj
      (IT_0205) + IT_0215*conj(IT_0215) + IT_0221*conj(IT_0221))*IT_0244 + (conj
      (IT_0190)*IT_0198 + IT_0190*conj(IT_0198) + conj(IT_0215)*IT_0221 +
       IT_0215*conj(IT_0221))*IT_0245 + (conj(IT_0180)*IT_0198 + IT_0180*conj
      (IT_0198) + conj(IT_0205)*IT_0221 + IT_0205*conj(IT_0221))*IT_0246 + (conj
      (IT_0090)*IT_0167 + IT_0090*conj(IT_0167))*(IT_0247 + IT_0248);
