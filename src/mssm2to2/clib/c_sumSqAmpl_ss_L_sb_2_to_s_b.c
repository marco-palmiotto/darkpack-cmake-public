        ...
        )
{
    ...
    const ccomplex_t IT_0018 = IT_0005*IT_0007;
    const ccomplex_t IT_0019 = m_b*conj(N_d1)*e_em*IT_0003*U_sb_11;
    const ccomplex_t IT_0020 = IT_0018*IT_0019;
    const ccomplex_t IT_0021 = 1.4142135623731*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*(IT_0014 + (-3)*IT_0017 + 3
      *IT_0021);
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = m_b*conj(N_d2)*e_em*IT_0003*U_sb_11;
    const ccomplex_t IT_0031 = IT_0018*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = conj(N_W2)*e_em*U_sb_01;
    const ccomplex_t IT_0034 = IT_0007*IT_0033;
    const ccomplex_t IT_0035 = 1.4142135623731*IT_0034;
    const ccomplex_t IT_0036 = conj(N_B2)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0047 = (-0.5)*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0049 = IT_0011*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W3)*e_em*U_sb_01;
    const ccomplex_t IT_0052 = IT_0007*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = m_b*conj(N_d3)*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0064 = (-0.5)*IT_0063;
    const ccomplex_t IT_0065 = m_b*conj(N_d4)*e_em*IT_0003*U_sb_11;
    ...
    const ccomplex_t IT_0080 = -IT_0026 + -IT_0044 + -IT_0061 + -IT_0079;
    ...
    const ccomplex_t IT_0097 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0098 = IT_0011*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = m_b*N_d3*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0116 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0117 = IT_0011*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = m_b*N_d1*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0135 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0136 = IT_0011*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = m_b*N_d2*e_em*IT_0003*U_sb_01;
    ...
    const ccomplex_t IT_0165 = 0.166666666666667*IT_0087 + -IT_0107 + -IT_0126
       + -IT_0145 + -IT_0164;
    const ccomplex_t IT_0166 = m_b*m_s*IT_0001;
    ...
    const ccomplex_t IT_0172 = m_b*m_s;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_01;
    const ccomplex_t IT_0174 = IT_0081*IT_0173;
    const ccomplex_t IT_0175 = IT_0085*IT_0174;
    ...
    const ccomplex_t IT_0180 = IT_0009*IT_0123;
    const ccomplex_t IT_0181 = IT_0002*IT_0179*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0183 = IT_0064*IT_0161;
    const ccomplex_t IT_0184 = IT_0062*IT_0182*IT_0183;
    const ccomplex_t IT_0185 = m_s*IT_0087;
    const ccomplex_t IT_0186 = m_s*IT_0164;
    const ccomplex_t IT_0187 = m_s*IT_0126;
    const ccomplex_t IT_0188 = m_s*IT_0145;
    const ccomplex_t IT_0189 = m_s*IT_0107;
    const ccomplex_t IT_0190 = IT_0181 + IT_0184 + 0.166666666666667*IT_0185 +
       -IT_0186 + -IT_0187 + -IT_0188 + -IT_0189;
    const ccomplex_t IT_0191 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0192 = IT_0029*IT_0142;
    const ccomplex_t IT_0193 = IT_0027*IT_0191*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0195 = IT_0047*IT_0104;
    const ccomplex_t IT_0196 = IT_0045*IT_0194*IT_0195;
    const ccomplex_t IT_0197 = -IT_0193 + -IT_0196;
    const ccomplex_t IT_0198 = (-0.5)*IT_0185;
    const ccomplex_t IT_0199 = IT_0190 + -IT_0197 + 3*IT_0198;
    const ccomplex_t IT_0200 = 3*conj(IT_0198);
    const ccomplex_t IT_0201 = -conj(IT_0197);
    const ccomplex_t IT_0202 = conj(IT_0190) + IT_0200 + IT_0201;
    const ccomplex_t IT_0203 = IT_0023*IT_0115;
    const ccomplex_t IT_0204 = IT_0002*IT_0179*IT_0203;
    const ccomplex_t IT_0205 = IT_0041*IT_0134;
    const ccomplex_t IT_0206 = IT_0027*IT_0191*IT_0205;
    const ccomplex_t IT_0207 = IT_0076*IT_0153;
    const ccomplex_t IT_0208 = IT_0062*IT_0182*IT_0207;
    const ccomplex_t IT_0209 = 0.166666666666667*IT_0177 + -IT_0204 + -IT_0206
       + -IT_0208;
    const ccomplex_t IT_0210 = 6*IT_0198;
    const ccomplex_t IT_0211 = 18*IT_0190;
    const ccomplex_t IT_0212 = (-18)*IT_0197;
    const ccomplex_t IT_0213 = IT_0210 + IT_0211 + IT_0212;
    const ccomplex_t IT_0214 = 6*conj(IT_0198);
    const ccomplex_t IT_0215 = 18*conj(IT_0190);
    const ccomplex_t IT_0216 = (-18)*conj(IT_0197);
    const ccomplex_t IT_0217 = IT_0214 + IT_0215 + IT_0216;
    const ccomplex_t IT_0218 = IT_0058*IT_0096;
    const ccomplex_t IT_0219 = IT_0045*IT_0194*IT_0218;
    const ccomplex_t IT_0220 = m_s*IT_0026;
    const ccomplex_t IT_0221 = m_s*IT_0044;
    const ccomplex_t IT_0222 = m_s*IT_0061;
    const ccomplex_t IT_0223 = m_s*IT_0079;
    const ccomplex_t IT_0224 = IT_0219 + -IT_0220 + -IT_0221 + -IT_0222 + 
      -IT_0223;
    const ccomplex_t IT_0225 = 18*IT_0197;
    const ccomplex_t IT_0226 = (-18)*IT_0190;
    ...
    const ccomplex_t IT_0230 = (-18)*conj(IT_0190);
    const ccomplex_t IT_0231 = (-6)*conj(IT_0198);
    const ccomplex_t IT_0232 = IT_0229 + IT_0230 + IT_0231;
    const ccomplex_t IT_0233 = 6*s_34;
    const ccomplex_t IT_0234 = 18*s_34;
    const ccomplex_t IT_0235 = (-18)*s_34;
    const ccomplex_t IT_0236 = (-6)*s_34;
    const ccomplex_t IT_0237 = 12*IT_0169;
    const ccomplex_t IT_0238 = (-6)*IT_0167;
    const ccomplex_t IT_0239 = m_s*s_14;
    const ccomplex_t IT_0240 = -IT_0209;
    const ccomplex_t IT_0241 = (-0.333333333333333)*IT_0178 + IT_0224 + IT_0240;
    const ccomplex_t IT_0242 = 3*IT_0241;
    const ccomplex_t IT_0243 = -conj(IT_0209);
    const ccomplex_t IT_0244 = (-0.333333333333333)*conj(IT_0178);
    const ccomplex_t IT_0245 = conj(IT_0224) + IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = 3*IT_0245;
    const ccomplex_t IT_0247 = m_b*s_13;
    const ccomplex_t IT_0248 = conj(IT_0080)*IT_0213 + IT_0080*IT_0217 + (-18)
      *conj(IT_0088)*(IT_0178 + -1./3*IT_0224 + -1./3*IT_0240) + 6*conj(IT_0165)
      *IT_0242 + (-18)*IT_0088*(conj(IT_0178) + -1./3*conj(IT_0224) + -1./3
      *IT_0243) + 6*IT_0165*IT_0246;
    const ccomplex_t IT_0249 = (-6)*(conj(IT_0080)*(IT_0088 + 3*IT_0165) +
       IT_0080*(conj(IT_0088) + 3*conj(IT_0165)))*IT_0166 + (IT_0080*conj
      (IT_0080) + IT_0088*conj(IT_0088) + IT_0165*conj(IT_0165))*IT_0171 + 6
      *IT_0172*(conj(IT_0178)*IT_0199 + IT_0178*IT_0202 + 0.166666666666667*conj
      (IT_0209)*IT_0213 + 0.166666666666667*IT_0209*IT_0217 + 0.166666666666667
      *conj(IT_0224)*IT_0228 + 0.166666666666667*IT_0224*IT_0232) + (conj
      (IT_0190)*IT_0198 + IT_0190*conj(IT_0198) + conj(IT_0178)*IT_0209 +
       IT_0178*conj(IT_0209))*IT_0233 + (IT_0178*conj(IT_0178) + IT_0190*conj
      (IT_0190) + IT_0197*conj(IT_0197) + IT_0198*conj(IT_0198) + IT_0209*conj
      (IT_0209) + IT_0224*conj(IT_0224))*IT_0234 + (conj(IT_0190)*IT_0197 +
       IT_0190*conj(IT_0197) + conj(IT_0209)*IT_0224 + IT_0209*conj(IT_0224))
      *IT_0235 + (conj(IT_0197)*IT_0198 + IT_0197*conj(IT_0198) + conj(IT_0178)
      *IT_0224 + IT_0178*conj(IT_0224))*IT_0236 + (conj(IT_0088)*IT_0165 +
       IT_0088*conj(IT_0165))*(IT_0237 + IT_0238) + (-6)*IT_0239*(conj(IT_0088)
      *IT_0199 + IT_0088*IT_0202 + (-0.166666666666667)*conj(IT_0165)*IT_0228 + 
      (-0.166666666666667)*IT_0165*IT_0232 + conj(IT_0080)*IT_0242 + IT_0080
