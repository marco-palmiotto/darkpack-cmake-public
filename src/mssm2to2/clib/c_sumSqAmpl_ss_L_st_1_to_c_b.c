...
ccomplex_return_t c_sumSqAmpl_ss_L_st_1_to_c_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm1)*IT_0001;
    ...
    const ccomplex_t IT_0056 = m_b*m_c;
    const ccomplex_t IT_0057 = m_b*IT_0021;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0059 = IT_0016*IT_0025;
    const ccomplex_t IT_0060 = IT_0018*IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0062 = IT_0007*IT_0038;
    const ccomplex_t IT_0063 = IT_0011*IT_0061*IT_0062;
    const ccomplex_t IT_0064 = IT_0060 + IT_0063;
    const ccomplex_t IT_0065 = 18*IT_0064;
    const ccomplex_t IT_0066 = IT_0036 + IT_0048;
    const ccomplex_t IT_0067 = m_b*IT_0066;
    const ccomplex_t IT_0068 = -IT_0067;
    const ccomplex_t IT_0069 = (-18)*IT_0068;
    const ccomplex_t IT_0070 = IT_0065 + IT_0069;
    const ccomplex_t IT_0071 = 18*conj(IT_0064);
    const ccomplex_t IT_0072 = (-18)*conj(IT_0068);
    const ccomplex_t IT_0073 = IT_0071 + IT_0072;
    const ccomplex_t IT_0074 = IT_0014*IT_0033;
    const ccomplex_t IT_0075 = IT_0018*IT_0058*IT_0074;
    const ccomplex_t IT_0076 = IT_0002*IT_0045;
    const ccomplex_t IT_0077 = IT_0011*IT_0061*IT_0076;
    const ccomplex_t IT_0078 = -IT_0075 + -IT_0077;
    const ccomplex_t IT_0079 = 18*IT_0068;
    const ccomplex_t IT_0080 = (-18)*IT_0064;
    const ccomplex_t IT_0081 = IT_0079 + IT_0080;
    const ccomplex_t IT_0082 = 18*conj(IT_0068);
    const ccomplex_t IT_0083 = (-18)*conj(IT_0064);
    const ccomplex_t IT_0084 = IT_0082 + IT_0083;
    const ccomplex_t IT_0085 = m_c*s_24;
    const ccomplex_t IT_0086 = 18*s_34;
    const ccomplex_t IT_0087 = (-18)*s_34;
    const ccomplex_t IT_0088 = m_b*m_c*IT_0050;
    const ccomplex_t IT_0089 = (-18)*IT_0021;
    const ccomplex_t IT_0090 = (-18)*conj(IT_0021);
    const ccomplex_t IT_0091 = m_b*s_23;
    const ccomplex_t IT_0092 = (IT_0021*conj(IT_0021) + IT_0049*conj(IT_0049))
      *IT_0055 + IT_0056*(conj(IT_0057)*IT_0070 + IT_0057*IT_0073 + conj(IT_0078
      )*IT_0081 + IT_0078*IT_0084) + (conj(IT_0049)*(18*IT_0057 + (-18)*IT_0078)
       + IT_0049*(18*conj(IT_0057) + (-18)*conj(IT_0078)) + conj(IT_0021)
      *IT_0081 + IT_0021*IT_0084)*IT_0085 + (IT_0057*conj(IT_0057) + IT_0064
      *conj(IT_0064) + IT_0068*conj(IT_0068) + IT_0078*conj(IT_0078))*IT_0086 + 
      (conj(IT_0064)*IT_0068 + IT_0064*conj(IT_0068) + conj(IT_0057)*IT_0078 +
       IT_0057*conj(IT_0078))*IT_0087 + IT_0088*(conj(IT_0049)*IT_0089 + IT_0049
      *IT_0090) + (conj(IT_0049)*IT_0070 + IT_0049*IT_0073 + 18*conj(IT_0021)
      *IT_0078 + 18*IT_0021*conj(IT_0078) + conj(IT_0057)*IT_0089 + IT_0057
      *IT_0090)*IT_0091;
