        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0030 = m_b*N_d2*e_em*IT_0003*conj(U_sb_10);
    const ccomplex_t IT_0031 = IT_0018*IT_0030;
    const ccomplex_t IT_0032 = 1.4142135623731*IT_0031;
    const ccomplex_t IT_0033 = N_W2*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = m_b*N_d1*e_em*IT_0003*conj(U_sb_10);
    const ccomplex_t IT_0068 = IT_0018*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = N_W1*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0082 = -IT_0026 + -IT_0045 + -IT_0063 + -IT_0081;
    ...
    const ccomplex_t IT_0119 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0120 = IT_0011*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = m_b*conj(N_d3)*e_em*IT_0003*conj(U_sb_00);
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0011;
    const ccomplex_t IT_0131 = (-0.333333333333333)*IT_0130;
    const ccomplex_t IT_0132 = conj(N_B4)*e_em*conj(U_sb_10);
    ...
    const ccomplex_t IT_0155 = IT_0078*IT_0092;
    const ccomplex_t IT_0156 = IT_0064*IT_0154*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0158 = IT_0042*IT_0105;
    const ccomplex_t IT_0159 = IT_0027*IT_0157*IT_0158;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0161 = IT_0060*IT_0118;
    const ccomplex_t IT_0162 = IT_0046*IT_0160*IT_0161;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0164 = IT_0023*IT_0131;
    const ccomplex_t IT_0165 = IT_0002*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = m_s*IT_0063;
    const ccomplex_t IT_0167 = m_s*IT_0026;
    const ccomplex_t IT_0168 = m_s*IT_0081;
    const ccomplex_t IT_0169 = m_s*IT_0045;
    const ccomplex_t IT_0170 = 0.166666666666667*IT_0152 + -IT_0156 + -IT_0159
       + -IT_0162 + -IT_0165 + IT_0166 + IT_0167 + IT_0168 + IT_0169;
    const ccomplex_t IT_0171 = m_s*IT_0089;
    const ccomplex_t IT_0172 = 0.5*IT_0171;
    const ccomplex_t IT_0173 = IT_0066*IT_0100;
    const ccomplex_t IT_0174 = IT_0064*IT_0154*IT_0173;
    const ccomplex_t IT_0175 = IT_0029*IT_0113;
    const ccomplex_t IT_0176 = IT_0027*IT_0157*IT_0175;
    const ccomplex_t IT_0177 = IT_0009*IT_0139;
    const ccomplex_t IT_0178 = IT_0002*IT_0163*IT_0177;
    const ccomplex_t IT_0179 = m_s*IT_0103;
    const ccomplex_t IT_0180 = m_s*IT_0116;
    const ccomplex_t IT_0181 = m_s*IT_0129;
    const ccomplex_t IT_0182 = m_s*IT_0142;
    const ccomplex_t IT_0183 = IT_0048*IT_0126;
    const ccomplex_t IT_0184 = IT_0046*IT_0160*IT_0183;
    const ccomplex_t IT_0185 = (-0.166666666666667)*IT_0171 + -IT_0174 + 
      -IT_0176 + -IT_0178 + IT_0179 + IT_0180 + IT_0181 + IT_0182 + -IT_0184;
    const ccomplex_t IT_0186 = 6*s_34;
    const ccomplex_t IT_0187 = 18*s_34;
    const ccomplex_t IT_0188 = m_b*m_s;
    ...
    const ccomplex_t IT_0203 = m_s*s_14;
