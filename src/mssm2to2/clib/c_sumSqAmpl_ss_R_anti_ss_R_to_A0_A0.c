...
ccomplex_return_t c_sumSqAmpl_ss_R_anti_ss_R_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*m_W*e_em*IT_0022*(IT_0003*
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0010*
    ...
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*m_W*e_em*IT_0022*(IT_0015
      *IT_0023 + IT_0033*(IT_0006*IT_0014 + (IT_0003*IT_0014 + -IT_0005*IT_0015)
      *IT_0033));
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = IT_0032*IT_0035;
    const ccomplex_t IT_0037 = cpow((-2)*s_12 + (-2)*IT_0027 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0005;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0005;
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = IT_0041*IT_0043;
    const ccomplex_t IT_0045 = pow(m_A0, 2);
    const ccomplex_t IT_0046 = cpow((-2)*s_13 + IT_0027 + IT_0045 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0047 = IT_0044*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0027 + IT_0045 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0044*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = m_s*e_em*mu_h*IT_0016;
    const ccomplex_t IT_0053 = IT_0018*IT_0052;
    const ccomplex_t IT_0054 = A_b*V_ts*conj(V_ts);
    const ccomplex_t IT_0055 = IT_0005*IT_0054;
    const ccomplex_t IT_0056 = 1.4142135623731*IT_0055;
    const ccomplex_t IT_0057 = 0.5*IT_0053 + 0.5*IT_0056;
    const ccomplex_t IT_0058 = (-0.5)*IT_0053 + (-0.5)*IT_0056;
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0027 + IT_0045 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0061 = IT_0059*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0027 + IT_0045 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0059*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*A_b*V_tb*V_ts*IT_0005*conj
      (U_sb_00);
    const ccomplex_t IT_0067 = (-0.5)*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0005
      *U_sb_00;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_13 + IT_0027 + IT_0045 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0027 + IT_0045 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0075 = IT_0070*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*A_b*V_tb*V_ts*IT_0005*conj
      (U_sb_01);
    const ccomplex_t IT_0078 = (-0.5)*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0005
      *U_sb_01;
    const ccomplex_t IT_0080 = 0.5*IT_0079;
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0027 + IT_0045 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0083 = IT_0081*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*IT_0083;
    const ccomplex_t IT_0085 = cpow((-2)*s_23 + IT_0027 + IT_0045 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0086 = IT_0081*IT_0085;
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*IT_0086;
    const ccomplex_t IT_0088 = IT_0013 + -IT_0030 + -IT_0039 + IT_0048 +
       IT_0051 + IT_0062 + IT_0065 + IT_0073 + IT_0076 + IT_0084 + IT_0087;
