...
ccomplex_return_t c_sumSqAmpl_ss_R_anti_ss_R_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_ss_R
    ...
    const ccomplex_t IT_0004 = 0.333333333333333*IT_0002;
    const ccomplex_t IT_0005 = IT_0003*IT_0004;
    const ccomplex_t IT_0006 = cpow(IT_0004, 2);
    const ccomplex_t IT_0007 = -IT_0006;
    const ccomplex_t IT_0008 = IT_0005 + IT_0007;
    const ccomplex_t IT_0009 = IT_0001*IT_0008;
    const ccomplex_t IT_0010 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_ss_R
      *Gamma_sr + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0014 = cpow(IT_0003, 2);
    ...
    const ccomplex_t IT_0037 = pow(m_ss_R, 2);
    ...
    const ccomplex_t IT_0047 = 0.222222222222222*IT_0046;
    ...
    const ccomplex_t IT_0053 = pow(m_ss_R, 4);
