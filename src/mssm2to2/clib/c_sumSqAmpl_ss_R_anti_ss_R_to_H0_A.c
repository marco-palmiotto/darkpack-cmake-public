...
ccomplex_return_t c_sumSqAmpl_ss_R_anti_ss_R_to_H0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0027 = (-3)*s_23;
    const ccomplex_t IT_0028 = 0.333333333333333*IT_0000;
    const ccomplex_t IT_0029 = IT_0022*IT_0028;
    const ccomplex_t IT_0030 = -IT_0029;
    const ccomplex_t IT_0031 = (-3)*s_24;
    const ccomplex_t IT_0032 = (-3)*s_34;
    const ccomplex_t IT_0033 = (-3)*IT_0023*(conj(IT_0023)*IT_0024 + (
      -0.333333333333333)*conj(IT_0026)*IT_0027 + (-0.333333333333333)*conj
      (IT_0030)*IT_0031) + IT_0030*(conj(IT_0023)*IT_0031 + conj(IT_0026)
      *IT_0032) + (-3)*IT_0026*(IT_0015*conj(IT_0026) + (-0.333333333333333)
      *conj(IT_0023)*IT_0027 + (-0.333333333333333)*conj(IT_0030)*IT_0032);
