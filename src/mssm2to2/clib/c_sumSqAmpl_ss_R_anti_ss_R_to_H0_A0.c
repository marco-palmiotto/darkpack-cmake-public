        ...
        )
{
    ...
    const ccomplex_t IT_0004 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0003;
    ...
    const ccomplex_t IT_0015 = m_s*e_em*mu_h*IT_0014;
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0003 + -m_s*e_em*mu_h*IT_0013*IT_0014*IT_0022*IT_0023);
    const ccomplex_t IT_0025 = (-0.5)*IT_0024;
    const ccomplex_t IT_0026 = IT_0020*IT_0025;
    const ccomplex_t IT_0027 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_ss_L*
    ...
    const ccomplex_t IT_0032 = 1.4142135623731*A_b*V_tb*V_ts*IT_0000*conj
      (U_sb_00);
    const ccomplex_t IT_0033 = (-0.5)*IT_0032;
    const ccomplex_t IT_0034 = IT_0031*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_1*
    ...
    const ccomplex_t IT_0040 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0000
      *U_sb_01;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = IT_0039*IT_0041;
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sb_2*
    ...
    const ccomplex_t IT_0054 = 0.5*IT_0016 + 0.5*IT_0019;
    const ccomplex_t IT_0055 = IT_0025*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0060 = s_12 + IT_0008;
    const ccomplex_t IT_0061 = cos(theta_W);
    const ccomplex_t IT_0062 = cpow(IT_0061, -1);
    const ccomplex_t IT_0063 = e_em*IT_0013*(IT_0000*IT_0003 + -IT_0021
      *IT_0023)*IT_0062;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*e_em*IT_0012*IT_0062;
    ...
    const ccomplex_t IT_0069 = s_13 + s_23;
    const ccomplex_t IT_0070 = (-0.333333333333333)*IT_0065;
    const ccomplex_t IT_0071 = IT_0063*IT_0070;
    const ccomplex_t IT_0072 = IT_0069*IT_0071;
    const ccomplex_t IT_0073 = IT_0064*IT_0070;
    const ccomplex_t IT_0074 = IT_0060*IT_0073;
    const ccomplex_t IT_0075 = -IT_0068 + -IT_0072 + 2*IT_0074;
    const ccomplex_t IT_0076 = IT_0063*IT_0066;
    ...
    const ccomplex_t IT_0081 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0000
      *U_sb_00;
    ...
    const ccomplex_t IT_0089 = 1.4142135623731*A_b*V_tb*V_ts*IT_0000*conj
      (U_sb_01);
    ...
    const ccomplex_t IT_0097 = IT_0011 + IT_0029 + IT_0037 + IT_0045 + IT_0053
       + IT_0058 + -IT_0080 + IT_0088 + IT_0096;
