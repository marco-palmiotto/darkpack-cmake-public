        ...
        )
{
    ...
    const ccomplex_t IT_0076 = IT_0032*IT_0047;
    const ccomplex_t IT_0077 = -IT_0076;
    const ccomplex_t IT_0078 = IT_0032*IT_0039;
    ...
    const ccomplex_t IT_0085 = 18*conj(IT_0050);
    const ccomplex_t IT_0086 = -s_14;
    const ccomplex_t IT_0087 = s_13 + IT_0086;
    const ccomplex_t IT_0088 = m_b*IT_0087;
    const ccomplex_t IT_0089 = 18*IT_0028;
    const ccomplex_t IT_0090 = IT_0077 + IT_0079;
    const ccomplex_t IT_0091 = 18*conj(IT_0028);
    const ccomplex_t IT_0092 = (-18)*IT_0050;
    const ccomplex_t IT_0093 = ((-12)*IT_0028 + 12*conj(IT_0028) + (-6)
      *IT_0049 + 6*conj(IT_0049) + (-6)*IT_0050 + 6*conj(IT_0050))*IT_0060 + 
      (conj(IT_0077) + conj(IT_0079))*IT_0089 + IT_0090*IT_0091 + IT_0075*((-36)
      *IT_0028 + 36*conj(IT_0028) + (-18)*IT_0049 + 18*conj(IT_0049) + IT_0085 +
       IT_0092);
    const ccomplex_t IT_0094 = m_b*s_14;
    const ccomplex_t IT_0095 = (-18)*conj(IT_0050);
    const ccomplex_t IT_0096 = (-6)*IT_0062;
    const ccomplex_t IT_0097 = (-6)*IT_0064;
    const ccomplex_t IT_0098 = 12*IT_0066;
    const ccomplex_t IT_0099 = IT_0096 + IT_0097 + IT_0098;
    const ccomplex_t IT_0100 = -IT_0060;
    const ccomplex_t IT_0101 = IT_0028*IT_0053;
    const ccomplex_t IT_0102 = (-18)*IT_0079;
    const ccomplex_t IT_0103 = IT_0080 + IT_0082;
    const ccomplex_t IT_0104 = IT_0060*IT_0099;
    const ccomplex_t IT_0105 = conj(IT_0028)*(IT_0028*(36*s_34 + (-36)*IT_0029
      ...
      *IT_0083) + IT_0079*IT_0084*IT_0085 + IT_0088*IT_0093 + (IT_0029*IT_0049 +
       IT_0077*IT_0094)*IT_0095 + IT_0090*IT_0099*IT_0100 + conj(IT_0050)*
      (IT_0050*IT_0052 + IT_0101) + conj(IT_0049)*(IT_0049*IT_0052 + 18*IT_0077
      *IT_0084 + IT_0029*IT_0092 + IT_0101 + IT_0094*IT_0102) + conj(IT_0077)*
      (18*IT_0049*IT_0084 + IT_0092*IT_0094 + IT_0064*IT_0102 + IT_0077*IT_0103 
      + IT_0104) + conj(IT_0079)*((-18)*IT_0064*IT_0077 + 18*IT_0050*IT_0084 + (
      -18)*IT_0049*IT_0094 + IT_0079*IT_0103 + IT_0104);
