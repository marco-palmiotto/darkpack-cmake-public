        ...
        )
{
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
      (V_cs)*e_em*IT_0007*IT_0009*IT_0010;
    const ccomplex_t IT_0046 = (-0.5)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0007*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d2)
      *V_cs*e_em*IT_0007*IT_0009*IT_0010;
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0007*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0121 = m_c*s_13;
    const ccomplex_t IT_0122 = 18*conj(IT_0072);
    const ccomplex_t IT_0123 = 6*conj(IT_0104);
    const ccomplex_t IT_0124 = 18*conj(IT_0073);
    const ccomplex_t IT_0125 = 18*conj(IT_0065)*IT_0072 + 6*conj(IT_0061)*
      (IT_0073 + 3*IT_0104) + 6*IT_0061*(conj(IT_0073) + 3*conj(IT_0104)) + conj
      (IT_0044)*(18*IT_0073 + IT_0120) + IT_0065*IT_0122 + IT_0044*(IT_0123 +
       IT_0124);
    const ccomplex_t IT_0126 = m_c*s_14;
    const ccomplex_t IT_0127 = (-18)*IT_0073;
    const ccomplex_t IT_0128 = (-6)*IT_0104;
    ...
    const ccomplex_t IT_0134 = IT_0091*((-12)*IT_0029 + 12*conj(IT_0029) + 6
      *conj(IT_0072) + (-6)*IT_0073 + 6*conj(IT_0073) + (-18)*IT_0104 + 18*conj
      (IT_0104) + IT_0107) + conj(IT_0061)*IT_0116 + IT_0061*IT_0119 + IT_0102*(
      (-36)*IT_0029 + 36*conj(IT_0029) + IT_0106 + IT_0122 + IT_0123 + IT_0124 +
       IT_0127 + IT_0128) + IT_0110*IT_0132 + IT_0111*IT_0133;
    const ccomplex_t IT_0135 = IT_0029*conj(IT_0029)*(36*s_34 + (-36)*IT_0030)
      ...
      *IT_0075*conj(IT_0104) + 0.166666666666667*IT_0030*IT_0118 +
       0.166666666666667*(s_34 + IT_0117)*IT_0119)*IT_0120 + IT_0121*IT_0125 +
       IT_0126*(IT_0065*((-18)*conj(IT_0073) + (-6)*conj(IT_0104)) + IT_0044
      *IT_0105 + conj(IT_0044)*IT_0106 + conj(IT_0061)*IT_0107 + IT_0061*IT_0118
       + conj(IT_0065)*(IT_0127 + IT_0128)) + IT_0131*IT_0134;
