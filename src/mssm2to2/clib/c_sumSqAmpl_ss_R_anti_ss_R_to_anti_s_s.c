        ...
        )
{
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0084 = 0.5*IT_0083;
    const ccomplex_t IT_0085 = IT_0082*IT_0084;
    const ccomplex_t IT_0086 = cpow((-2)*s_23 + IT_0012 + IT_0016 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0012 + IT_0016 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0000*IT_0002*IT_0005;
    const ccomplex_t IT_0091 = 0.5*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0005;
    ...
    const ccomplex_t IT_0098 = IT_0047*IT_0056;
    const ccomplex_t IT_0099 = (-0.5)*IT_0034 + -IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0036;
    const ccomplex_t IT_0101 = (-0.333333333333333)*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*N_B1*e_em
      *IT_0036;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0036;
    ...
    const ccomplex_t IT_0112 = IT_0078*IT_0111;
    ...
    const ccomplex_t IT_0119 = IT_0089*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*IT_0119;
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0036;
    ...
    const ccomplex_t IT_0128 = 0.166666666666667*IT_0034 + -IT_0106 + -IT_0113
       + -IT_0120 + -IT_0127;
    ...
    const ccomplex_t IT_0159 = m_s*IT_0096;
    const ccomplex_t IT_0160 = IT_0068*IT_0103;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0162 = IT_0070*IT_0160*IT_0161;
    const ccomplex_t IT_0163 = IT_0076*IT_0110;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0165 = IT_0078*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = IT_0093*IT_0117;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0168 = IT_0089*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = IT_0084*IT_0124;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0171 = IT_0086*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = m_s*IT_0072;
    const ccomplex_t IT_0173 = m_s*IT_0080;
    const ccomplex_t IT_0174 = m_s*IT_0088;
    const ccomplex_t IT_0175 = IT_0159 + -IT_0162 + -IT_0165 + -IT_0168 + 
      -IT_0171 + IT_0172 + IT_0173 + IT_0174;
    const ccomplex_t IT_0176 = IT_0074*IT_0108;
    const ccomplex_t IT_0177 = IT_0078*IT_0164*IT_0176;
    const ccomplex_t IT_0178 = IT_0082*IT_0122;
    const ccomplex_t IT_0179 = IT_0086*IT_0170*IT_0178;
    const ccomplex_t IT_0180 = m_s*IT_0127;
    const ccomplex_t IT_0181 = IT_0066*IT_0101;
    const ccomplex_t IT_0182 = IT_0070*IT_0161*IT_0181;
    const ccomplex_t IT_0183 = IT_0091*IT_0115;
    const ccomplex_t IT_0184 = IT_0089*IT_0167*IT_0183;
    const ccomplex_t IT_0185 = m_s*IT_0106;
    const ccomplex_t IT_0186 = m_s*IT_0113;
    const ccomplex_t IT_0187 = m_s*IT_0120;
    const ccomplex_t IT_0188 = (-0.166666666666667)*IT_0035 + -IT_0177 + 
      -IT_0179 + IT_0180 + -IT_0182 + -IT_0184 + IT_0185 + IT_0186 + IT_0187;
    ...
    const ccomplex_t IT_0194 = m_s*s_13;
    ...
    const ccomplex_t IT_0201 = IT_0058*(conj(IT_0099) + 0.333333333333333*conj
      (IT_0128)) + conj(IT_0097)*(0.333333333333333*IT_0059 + IT_0175) + 1*conj
      (IT_0064)*(IT_0059 + 1./3*IT_0175) + 0.333333333333333*IT_0158*IT_0188 +
       IT_0064*(conj(IT_0059) + 0.0555555555555556*IT_0195) + 0.333333333333333
      *IT_0097*(conj(IT_0059) + 0.166666666666667*IT_0196) + 0.0555555555555556
      *IT_0099*(IT_0197 + IT_0198) + 0.0555555555555556*IT_0128*(IT_0199 +
       IT_0200);
    ...
    const ccomplex_t IT_0212 = m_s*s_14;
    ...
    const ccomplex_t IT_0232 = (36*s_34 + (-36)*IT_0012)*IT_0028*conj(IT_0028)
      ...
      *IT_0146*(conj(IT_0097)*(IT_0099 + 3*IT_0128) + (-0.166666666666667)*conj
      ...
      (IT_0175) + conj(IT_0188))*IT_0192 + (IT_0175 + IT_0188)*IT_0193) + 18
