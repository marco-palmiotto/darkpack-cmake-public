...
ccomplex_return_t c_sumSqAmpl_ss_R_anti_ss_R_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*e_em*m_tau*IT_0000*IT_0002
      *IT_0005*IT_0010;
    ...
    const ccomplex_t IT_0051 = m_tau*IT_0032;
    ...
    const ccomplex_t IT_0058 = s_13*m_tau;
