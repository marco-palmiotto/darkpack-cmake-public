        ...
        )
{
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*e_em*IT_0021*IT_0024;
    ...
    const ccomplex_t IT_0034 = (-0.333333333333333)*IT_0028;
    ...
    const ccomplex_t IT_0041 = IT_0027*IT_0034;
    ...
    const ccomplex_t IT_0048 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0003;
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = pow(m_W, -1);
    const ccomplex_t IT_0057 = m_s*e_em*mu_h*IT_0056;
    const ccomplex_t IT_0058 = IT_0025*IT_0057;
    const ccomplex_t IT_0059 = A_b*V_ts*conj(V_ts);
    const ccomplex_t IT_0060 = IT_0003*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = (-0.5)*IT_0058 + (-0.5)*IT_0061;
    const ccomplex_t IT_0063 = cpow(IT_0022, -1);
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0000 + m_s*e_em*mu_h*IT_0023*IT_0025*IT_0056*IT_0063);
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = IT_0062*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0003;
    ...
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = 0.5*IT_0058 + 0.5*IT_0061;
    const ccomplex_t IT_0079 = IT_0065*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0085 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0003
      *U_sb_00;
    const ccomplex_t IT_0086 = 0.5*IT_0085;
    const ccomplex_t IT_0087 = IT_0084*IT_0086;
    const ccomplex_t IT_0088 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0092 = 1.4142135623731*A_b*V_tb*V_ts*IT_0003*conj
      (U_sb_00);
    ...
    const ccomplex_t IT_0099 = IT_0011 + IT_0019 + IT_0047 + IT_0055 + IT_0069
       + IT_0077 + IT_0082 + IT_0090 + IT_0098;
