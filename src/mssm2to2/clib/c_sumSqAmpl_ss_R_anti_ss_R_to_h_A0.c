...
ccomplex_return_t c_sumSqAmpl_ss_R_anti_ss_R_to_h_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0010 + m_s*e_em*mu_h*IT_0001*IT_0002*IT_0012*IT_0013);
    ...
    const ccomplex_t IT_0022 = 1.4142135623731*A_b*V_td*conj(V_ts)*IT_0005;
    ...
    const ccomplex_t IT_0027 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0005
      *U_sb_00;
    const ccomplex_t IT_0031 = 0.5*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0010*conj(U_sb_00);
    const ccomplex_t IT_0033 = 0.5*IT_0032;
    const ccomplex_t IT_0034 = IT_0031*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_sb_1*
    ...
    const ccomplex_t IT_0040 = 1.4142135623731*A_b*V_tb*conj(V_ts)*IT_0005
      *U_sb_01;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = IT_0039*IT_0041;
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0017 + IT_0018 + -m_sb_2*
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_ts)*IT_0010*U_sb_01;
    const ccomplex_t IT_0049 = 0.5*IT_0048;
    const ccomplex_t IT_0050 = IT_0047*IT_0049;
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0017 + IT_0018 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = 1.4142135623731*A_b*conj(V_td)*V_ts*IT_0005;
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0010;
    const ccomplex_t IT_0057 = 0.5*IT_0056;
    const ccomplex_t IT_0058 = IT_0055*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0017 + IT_0018 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0063 = s_13 + s_23;
    const ccomplex_t IT_0064 = cos(theta_W);
    const ccomplex_t IT_0065 = cpow(IT_0064, -1);
    const ccomplex_t IT_0066 = e_em*IT_0001*(IT_0005*IT_0010 + IT_0011*IT_0013
      )*IT_0065;
    const ccomplex_t IT_0067 = -IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*e_em*IT_0000*IT_0065;
    ...
    const ccomplex_t IT_0093 = 1.4142135623731*A_b*V_tb*V_ts*IT_0005*conj
      (U_sb_00);
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = IT_0092*IT_0094;
    const ccomplex_t IT_0096 = cpow((-2)*s_23 + IT_0017 + IT_0018 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0097 = IT_0095*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*IT_0097;
    const ccomplex_t IT_0099 = IT_0021 + IT_0029 + IT_0037 + IT_0045 + IT_0053
       + IT_0061 + IT_0085 + IT_0090 + IT_0098;
