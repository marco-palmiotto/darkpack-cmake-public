        ...
        )
{
    ...
    const ccomplex_t IT_0037 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_sb_2*
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0044*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0007 + -IT_0002*IT_0013) + (-3)*IT_0001*IT_0006*IT_0014
      *IT_0015*IT_0016);
    const ccomplex_t IT_0049 = 0.333333333333333*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*m_W*e_em*IT_0020*(IT_0007
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_12 + (-2)*IT_0027 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0070 = IT_0068*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0001;
    const ccomplex_t IT_0073 = (-0.5)*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0002;
    const ccomplex_t IT_0075 = 0.5*IT_0074;
    const ccomplex_t IT_0076 = IT_0073*IT_0075;
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0076*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0068*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = IT_0018*IT_0049;
    const ccomplex_t IT_0084 = cpow((-2)*s_23 + IT_0036 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    const ccomplex_t IT_0085 = IT_0083*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0036 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_sb_1*
    ...
    const ccomplex_t IT_0103 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0106 = IT_0012 + -IT_0030 + IT_0039 + IT_0047 + 
      -IT_0055 + IT_0063 + IT_0071 + IT_0079 + IT_0082 + IT_0086 + IT_0089 +
       IT_0097 + IT_0105;
