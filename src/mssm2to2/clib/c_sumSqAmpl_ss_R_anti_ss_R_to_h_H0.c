...
ccomplex_return_t c_sumSqAmpl_ss_R_anti_ss_R_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0002*IT_0007 + IT_0001*IT_0013) + (-3)*IT_0002*IT_0006*IT_0014*IT_0015
      *IT_0016);
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*m_W*e_em*IT_0020*(IT_0013
      *IT_0021 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0013 + (-0.2)*IT_0007*(IT_0022
       + (-5)*IT_0023)));
    ...
    const ccomplex_t IT_0037 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*(m_W*IT_0004*IT_0009*
      (IT_0001*IT_0007 + -IT_0002*IT_0013) + (-3)*IT_0001*IT_0006*IT_0014
      *IT_0015*IT_0016);
    const ccomplex_t IT_0041 = 0.333333333333333*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_W*e_em*IT_0020*(IT_0007
      *IT_0021 + 5*IT_0001*((-1)*IT_0001*(IT_0002*IT_0007 + 1./5*IT_0001*IT_0013
      ) + IT_0013*IT_0023));
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = IT_0041*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_12 + (-2)*IT_0027 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0054 = IT_0052*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0001 + -m_s*e_em*mu_h*IT_0002*IT_0014*IT_0015*IT_0016);
    const ccomplex_t IT_0057 = (-0.5)*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_ts
      *conj(V_ts)*IT_0002 + m_s*e_em*mu_h*IT_0001*IT_0014*IT_0015*IT_0016);
    const ccomplex_t IT_0059 = 0.5*IT_0058;
    const ccomplex_t IT_0060 = IT_0057*IT_0059;
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*A_b*V_td*conj
      (V_ts)*IT_0001;
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0070 = IT_0068*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0060*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = IT_0018*IT_0041;
    const ccomplex_t IT_0076 = cpow((-2)*s_23 + IT_0036 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0036 + (0 + _Complex_I*1)
      *m_ss_R*Gamma_sr + reg_prop, -1);
    const ccomplex_t IT_0080 = IT_0075*IT_0079;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_sb_1*
    ...
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_23 + IT_0027 + IT_0036 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
    ...
    const ccomplex_t IT_0103 = cpow((-2)*s_13 + IT_0027 + IT_0036 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0106 = IT_0012 + -IT_0030 + IT_0039 + -IT_0047 +
       IT_0055 + IT_0063 + IT_0071 + IT_0074 + IT_0078 + IT_0081 + IT_0089 +
       IT_0097 + IT_0105;
