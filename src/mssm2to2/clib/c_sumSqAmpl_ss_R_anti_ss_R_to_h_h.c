...
ccomplex_return_t c_sumSqAmpl_ss_R_anti_ss_R_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0011*
      (IT_0005*IT_0009 + IT_0003*IT_0017) + (-3)*IT_0005*IT_0008*IT_0018*IT_0019
      *IT_0020);
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0015 + IT_0033 + -m_sb_1*
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*e_em*(m_W*IT_0002*IT_0011*
      (IT_0003*IT_0009 + -IT_0005*IT_0017) + (-3)*IT_0003*IT_0008*IT_0018
      *IT_0019*IT_0020);
    ...
    const ccomplex_t IT_0052 = cpow(IT_0005, 3);
    const ccomplex_t IT_0053 = (0 + _Complex_I*-5)*m_W*e_em*IT_0051*(IT_0003*(
      (-0.2)*(IT_0004 + (-5)*IT_0006)*IT_0009 + IT_0003*IT_0005*IT_0017) + -1./5
      *IT_0017*IT_0052);
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = IT_0049*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + (-2)*IT_0033 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0057 = IT_0055*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_W*e_em*IT_0051*(IT_0003*
      (IT_0006*IT_0017 + -IT_0003*(IT_0005*IT_0009 + IT_0003*IT_0017)) + IT_0009
      *IT_0052);
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_13 + IT_0015 + IT_0033 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0015 + IT_0033 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0015 + IT_0033 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0079*IT_0080;
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0015 + IT_0033 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0083 = IT_0079*IT_0082;
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0015 + IT_0033 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
