        ...
        )
{
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0015*IT_0017*IT_0019;
    const ccomplex_t IT_0092 = 0.5*IT_0091;
    const ccomplex_t IT_0093 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0094 = IT_0011*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = m_b*N_d2*e_em*IT_0019*U_sb_00;
    ...
    const ccomplex_t IT_0106 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0107 = IT_0011*IT_0106;
    const ccomplex_t IT_0108 = 1.4142135623731*IT_0107;
    const ccomplex_t IT_0109 = m_b*N_d4*e_em*IT_0019*U_sb_00;
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0015*IT_0017*IT_0019;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0015*IT_0017*IT_0019;
    const ccomplex_t IT_0131 = 0.5*IT_0130;
    const ccomplex_t IT_0132 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0133 = IT_0011*IT_0132;
    const ccomplex_t IT_0134 = 1.4142135623731*IT_0133;
    const ccomplex_t IT_0135 = m_b*N_d1*e_em*IT_0019*U_sb_00;
    ...
    const ccomplex_t IT_0144 = m_b*m_s*IT_0002;
    ...
    const ccomplex_t IT_0150 = m_s*s_14;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0152 = IT_0067*IT_0118;
    const ccomplex_t IT_0153 = IT_0053*IT_0151*IT_0152;
    const ccomplex_t IT_0154 = m_s*IT_0008;
    const ccomplex_t IT_0155 = m_s*IT_0034;
    const ccomplex_t IT_0156 = m_s*IT_0052;
    const ccomplex_t IT_0157 = m_s*IT_0070;
    const ccomplex_t IT_0158 = m_s*IT_0088;
    const ccomplex_t IT_0159 = IT_0153 + 0.166666666666667*IT_0154 + -IT_0155 
      + -IT_0156 + -IT_0157 + -IT_0158;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0161 = IT_0031*IT_0131;
    const ccomplex_t IT_0162 = IT_0009*IT_0160*IT_0161;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0164 = IT_0049*IT_0092;
    const ccomplex_t IT_0165 = IT_0035*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0167 = IT_0085*IT_0105;
    const ccomplex_t IT_0168 = IT_0071*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = -IT_0162 + -IT_0165 + -IT_0168;
    const ccomplex_t IT_0170 = (-0.5)*IT_0154;
    const ccomplex_t IT_0171 = IT_0159 + -IT_0169;
    const ccomplex_t IT_0172 = -conj(IT_0169);
    const ccomplex_t IT_0173 = conj(IT_0159) + IT_0172;
    const ccomplex_t IT_0174 = IT_0037*IT_0100;
    const ccomplex_t IT_0175 = IT_0035*IT_0163*IT_0174;
    const ccomplex_t IT_0176 = IT_0055*IT_0126;
    const ccomplex_t IT_0177 = IT_0053*IT_0151*IT_0176;
    const ccomplex_t IT_0178 = -IT_0175 + -IT_0177;
    const ccomplex_t IT_0179 = 18*IT_0178;
    const ccomplex_t IT_0180 = IT_0013*IT_0139;
    const ccomplex_t IT_0181 = IT_0009*IT_0160*IT_0180;
    const ccomplex_t IT_0182 = IT_0073*IT_0113;
    const ccomplex_t IT_0183 = IT_0071*IT_0166*IT_0182;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_10;
    ...
    const ccomplex_t IT_0189 = m_s*IT_0116;
    const ccomplex_t IT_0190 = m_s*IT_0142;
    const ccomplex_t IT_0191 = m_s*IT_0103;
    const ccomplex_t IT_0192 = m_s*IT_0129;
    const ccomplex_t IT_0193 = IT_0181 + IT_0183 + (-0.166666666666667)
      *IT_0188 + -IT_0189 + -IT_0190 + -IT_0191 + -IT_0192;
    const ccomplex_t IT_0194 = (-18)*IT_0193;
    const ccomplex_t IT_0195 = 0.5*IT_0188;
    const ccomplex_t IT_0196 = (-6)*IT_0195;
    const ccomplex_t IT_0197 = IT_0179 + IT_0194 + IT_0196;
    const ccomplex_t IT_0198 = 18*conj(IT_0178);
    const ccomplex_t IT_0199 = (-18)*conj(IT_0193);
    const ccomplex_t IT_0200 = (-6)*conj(IT_0195);
    const ccomplex_t IT_0201 = IT_0198 + IT_0199 + IT_0200;
    const ccomplex_t IT_0202 = conj(IT_0089)*((-18)*IT_0159 + 18*IT_0169 + (-6
      )*IT_0170) + IT_0089*((-18)*conj(IT_0159) + 18*conj(IT_0169) + (-6)*conj
      (IT_0170)) + (-18)*conj(IT_0090)*(IT_0170 + 0.333333333333333*IT_0171) + (
      -18)*IT_0090*(conj(IT_0170) + 0.333333333333333*IT_0173) + conj(IT_0143)
      *IT_0197 + IT_0143*IT_0201;
    const ccomplex_t IT_0203 = 6*s_34;
    const ccomplex_t IT_0204 = 18*s_34;
    const ccomplex_t IT_0205 = (-18)*s_34;
    const ccomplex_t IT_0206 = (-6)*s_34;
    const ccomplex_t IT_0207 = 12*IT_0147;
    const ccomplex_t IT_0208 = (-6)*IT_0145;
    const ccomplex_t IT_0209 = m_b*m_s;
    const ccomplex_t IT_0210 = -conj(IT_0193);
    const ccomplex_t IT_0211 = (-3)*conj(IT_0195);
    const ccomplex_t IT_0212 = conj(IT_0178) + IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = 6*IT_0195;
    const ccomplex_t IT_0214 = 18*IT_0193;
    const ccomplex_t IT_0215 = (-18)*IT_0178;
    const ccomplex_t IT_0216 = IT_0213 + IT_0214 + IT_0215;
    const ccomplex_t IT_0217 = 6*conj(IT_0195);
    const ccomplex_t IT_0218 = 18*conj(IT_0193);
    const ccomplex_t IT_0219 = (-18)*conj(IT_0178);
    const ccomplex_t IT_0220 = IT_0217 + IT_0218 + IT_0219;
    const ccomplex_t IT_0221 = -IT_0193;
    const ccomplex_t IT_0222 = 6*IT_0209*(0.166666666666667*conj(IT_0159)
      *IT_0197 + 0.166666666666667*IT_0159*IT_0201 + IT_0170*IT_0212 +
       0.166666666666667*conj(IT_0169)*IT_0216 + 0.166666666666667*IT_0169
      *IT_0220 + conj(IT_0170)*(IT_0178 + (-3)*IT_0195 + IT_0221));
    const ccomplex_t IT_0223 = m_b*s_13;
    const ccomplex_t IT_0224 = -conj(IT_0143)*(IT_0170 + 3*IT_0171) + -IT_0143
      *(conj(IT_0170) + 3*IT_0173) + IT_0090*IT_0212 + (-0.166666666666667)*conj
      (IT_0089)*IT_0216 + (-0.166666666666667)*IT_0089*IT_0220 + conj(IT_0090)*
      (IT_0178 + (-3)*IT_0195 + IT_0221);
    const ccomplex_t IT_0225 = (((-18)*conj(IT_0089) + (-6)*conj(IT_0090))
      *IT_0143 + ((-18)*IT_0089 + (-6)*IT_0090)*conj(IT_0143))*IT_0144 + 
      (IT_0089*conj(IT_0089) + IT_0090*conj(IT_0090) + IT_0143*conj(IT_0143))
      *IT_0149 + IT_0150*IT_0202 + (conj(IT_0159)*IT_0170 + IT_0159*conj(IT_0170
      ) + conj(IT_0193)*IT_0195 + IT_0193*conj(IT_0195))*IT_0203 + (IT_0159*conj
      (IT_0159) + IT_0169*conj(IT_0169) + IT_0170*conj(IT_0170) + IT_0178*conj
      (IT_0178) + IT_0193*conj(IT_0193) + IT_0195*conj(IT_0195))*IT_0204 + (conj
      (IT_0159)*IT_0169 + IT_0159*conj(IT_0169) + conj(IT_0178)*IT_0193 +
       IT_0178*conj(IT_0193))*IT_0205 + (conj(IT_0169)*IT_0170 + IT_0169*conj
      (IT_0170) + conj(IT_0178)*IT_0195 + IT_0178*conj(IT_0195))*IT_0206 + (conj
      (IT_0089)*IT_0090 + IT_0089*conj(IT_0090))*(IT_0207 + IT_0208) + IT_0222 +
       (-6)*IT_0223*IT_0224;
