        ...
        )
{
    ...
    const ccomplex_t IT_0016 = m_b*conj(N_d1)*e_em*IT_0015*U_sb_11;
    ...
    const ccomplex_t IT_0024 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*(IT_0018 + -IT_0021 +
    ...
    const ccomplex_t IT_0055 = m_b*conj(N_d3)*e_em*IT_0015*U_sb_11;
    const ccomplex_t IT_0056 = IT_0014*IT_0055;
    const ccomplex_t IT_0057 = 1.4142135623731*IT_0056;
    const ccomplex_t IT_0058 = conj(N_B3)*e_em*U_sb_01;
    const ccomplex_t IT_0059 = IT_0023*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = conj(N_W3)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0075 = m_b*conj(N_d4)*e_em*IT_0015*U_sb_11;
    ...
    const ccomplex_t IT_0090 = 0.166666666666667*IT_0008 + -IT_0034 + -IT_0053
       + -IT_0071 + -IT_0089;
    const ccomplex_t IT_0091 = (-0.5)*IT_0008;
    const ccomplex_t IT_0092 = N_B1*e_em*U_sb_11;
    const ccomplex_t IT_0093 = IT_0023*IT_0092;
    const ccomplex_t IT_0094 = 1.4142135623731*IT_0093;
    const ccomplex_t IT_0095 = m_b*N_d1*e_em*IT_0015*U_sb_01;
    ...
    const ccomplex_t IT_0107 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0108 = IT_0023*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = m_b*N_d4*e_em*IT_0015*U_sb_01;
    ...
    const ccomplex_t IT_0118 = IT_0072*IT_0117;
    ...
    const ccomplex_t IT_0122 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0123 = IT_0023*IT_0122;
    const ccomplex_t IT_0124 = 1.4142135623731*IT_0123;
    const ccomplex_t IT_0125 = m_b*N_d2*e_em*IT_0015*U_sb_01;
    ...
    const ccomplex_t IT_0130 = 1.5*IT_0129;
    ...
    const ccomplex_t IT_0138 = m_b*N_d3*e_em*IT_0015*U_sb_01;
    ...
    const ccomplex_t IT_0143 = 1.5*IT_0142;
    ...
    const ccomplex_t IT_0149 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0011*IT_0013*IT_0015;
    ...
    const ccomplex_t IT_0154 = -IT_0104 + -IT_0119 + -IT_0134 + -IT_0153;
    const ccomplex_t IT_0155 = m_b*m_s*IT_0002;
    const ccomplex_t IT_0156 = s_34*IT_0002;
    const ccomplex_t IT_0157 = (-18)*IT_0156;
    const ccomplex_t IT_0158 = s_13*s_14;
    const ccomplex_t IT_0159 = 36*IT_0158;
    const ccomplex_t IT_0160 = IT_0157 + IT_0159;
    const ccomplex_t IT_0161 = m_b*m_s;
    const ccomplex_t IT_0162 = m_s*IT_0008;
    const ccomplex_t IT_0163 = (-0.5)*IT_0162;
    const ccomplex_t IT_0164 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0165 = IT_0031*IT_0099;
    const ccomplex_t IT_0166 = IT_0009*IT_0164*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0168 = IT_0068*IT_0148;
    const ccomplex_t IT_0169 = IT_0054*IT_0167*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0171 = IT_0074*IT_0116;
    const ccomplex_t IT_0172 = IT_0072*IT_0170*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*g_s*U_sb_11;
    ...
    const ccomplex_t IT_0177 = m_sG*IT_0176;
    const ccomplex_t IT_0178 = m_s*IT_0104;
    const ccomplex_t IT_0179 = m_s*IT_0134;
    const ccomplex_t IT_0180 = m_s*IT_0153;
    const ccomplex_t IT_0181 = m_s*IT_0119;
    const ccomplex_t IT_0182 = IT_0166 + IT_0169 + IT_0172 + (
      -0.166666666666667)*IT_0177 + -IT_0178 + -IT_0179 + -IT_0180 + -IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0184 = IT_0050*IT_0131;
    const ccomplex_t IT_0185 = IT_0035*IT_0183*IT_0184;
    const ccomplex_t IT_0186 = -IT_0185;
    const ccomplex_t IT_0187 = 0.5*IT_0177;
    const ccomplex_t IT_0188 = IT_0182 + -IT_0186 + 3*IT_0187;
    const ccomplex_t IT_0189 = -conj(IT_0186);
    const ccomplex_t IT_0190 = conj(IT_0182) + 3*conj(IT_0187) + IT_0189;
    const ccomplex_t IT_0191 = IT_0029*IT_0101;
    const ccomplex_t IT_0192 = IT_0009*IT_0164*IT_0191;
    const ccomplex_t IT_0193 = IT_0086*IT_0106;
    const ccomplex_t IT_0194 = IT_0072*IT_0170*IT_0193;
    const ccomplex_t IT_0195 = -IT_0192 + -IT_0194;
    const ccomplex_t IT_0196 = 6*IT_0187;
    const ccomplex_t IT_0197 = 18*IT_0182;
    const ccomplex_t IT_0198 = (-18)*IT_0186;
    const ccomplex_t IT_0199 = IT_0196 + IT_0197 + IT_0198;
    const ccomplex_t IT_0200 = 6*conj(IT_0187);
    const ccomplex_t IT_0201 = 18*conj(IT_0182);
    const ccomplex_t IT_0202 = (-18)*conj(IT_0186);
    const ccomplex_t IT_0203 = IT_0200 + IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = IT_0048*IT_0121;
    const ccomplex_t IT_0205 = IT_0035*IT_0183*IT_0204;
    const ccomplex_t IT_0206 = IT_0066*IT_0150;
    const ccomplex_t IT_0207 = IT_0054*IT_0167*IT_0206;
    const ccomplex_t IT_0208 = m_s*IT_0034;
    const ccomplex_t IT_0209 = m_s*IT_0053;
    const ccomplex_t IT_0210 = m_s*IT_0071;
    const ccomplex_t IT_0211 = m_s*IT_0089;
    const ccomplex_t IT_0212 = 0.166666666666667*IT_0162 + IT_0205 + IT_0207 +
       -IT_0208 + -IT_0209 + -IT_0210 + -IT_0211;
    const ccomplex_t IT_0213 = 18*IT_0186;
    const ccomplex_t IT_0214 = (-18)*IT_0182;
    const ccomplex_t IT_0215 = (-6)*IT_0187;
    const ccomplex_t IT_0216 = IT_0213 + IT_0214 + IT_0215;
    const ccomplex_t IT_0217 = 18*conj(IT_0186);
    const ccomplex_t IT_0218 = (-18)*conj(IT_0182);
    const ccomplex_t IT_0219 = (-6)*conj(IT_0187);
    ...
    const ccomplex_t IT_0225 = 12*IT_0158;
    const ccomplex_t IT_0226 = (-6)*IT_0156;
    const ccomplex_t IT_0227 = m_s*s_14;
    const ccomplex_t IT_0228 = (-3)*conj(IT_0195);
    const ccomplex_t IT_0229 = 3*conj(IT_0212);
    const ccomplex_t IT_0230 = conj(IT_0163) + IT_0228 + IT_0229;
    const ccomplex_t IT_0231 = 3*IT_0212;
    const ccomplex_t IT_0232 = conj(IT_0091)*(IT_0163 + (-0.333333333333333)
      *IT_0195 + 0.333333333333333*IT_0212) + IT_0091*(conj(IT_0163) + (
      -0.333333333333333)*conj(IT_0195) + 0.333333333333333*conj(IT_0212)) + (
      -0.0555555555555556)*conj(IT_0154)*IT_0216 + (-0.0555555555555556)*IT_0154
      *IT_0220 + 0.333333333333333*IT_0090*IT_0230 + 0.333333333333333*conj
      (IT_0090)*(IT_0163 + (-3)*IT_0195 + IT_0231);
    const ccomplex_t IT_0233 = m_b*s_13;
    const ccomplex_t IT_0234 = (((-18)*conj(IT_0090) + (-6)*conj(IT_0091))
      *IT_0154 + ((-18)*IT_0090 + (-6)*IT_0091)*conj(IT_0154))*IT_0155 + 
      (IT_0090*conj(IT_0090) + IT_0091*conj(IT_0091) + IT_0154*conj(IT_0154))
      *IT_0160 + (-6)*IT_0161*(conj(IT_0163)*IT_0188 + IT_0163*IT_0190 + (
      -0.166666666666667)*conj(IT_0195)*IT_0199 + (-0.166666666666667)*IT_0195
      *IT_0203 + (-0.166666666666667)*conj(IT_0212)*IT_0216 + (
      -0.166666666666667)*IT_0212*IT_0220) + (conj(IT_0182)*IT_0187 + IT_0182
      *conj(IT_0187) + conj(IT_0163)*IT_0212 + IT_0163*conj(IT_0212))*IT_0221 + 
      (IT_0163*conj(IT_0163) + IT_0182*conj(IT_0182) + IT_0186*conj(IT_0186) +
       IT_0187*conj(IT_0187) + IT_0195*conj(IT_0195) + IT_0212*conj(IT_0212))
      *IT_0222 + (conj(IT_0182)*IT_0186 + IT_0182*conj(IT_0186) + conj(IT_0195)
      *IT_0212 + IT_0195*conj(IT_0212))*IT_0223 + (conj(IT_0186)*IT_0187 +
       IT_0186*conj(IT_0187) + conj(IT_0163)*IT_0195 + IT_0163*conj(IT_0195))
      *IT_0224 + (conj(IT_0090)*IT_0091 + IT_0090*conj(IT_0091))*(IT_0225 +
       IT_0226) + (-18)*IT_0227*IT_0232 + 6*(conj(IT_0091)*IT_0188 + IT_0091
      *IT_0190 + 0.166666666666667*conj(IT_0090)*IT_0199 + 0.166666666666667
      *IT_0090*IT_0203 + IT_0154*IT_0230 + conj(IT_0154)*(IT_0163 + (-3)*IT_0195
       + IT_0231))*IT_0233;
