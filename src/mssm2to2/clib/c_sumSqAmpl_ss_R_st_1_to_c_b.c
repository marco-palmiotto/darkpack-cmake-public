        ...
        )
{
    ...
    const ccomplex_t IT_0026 = V_tb*e_em*conj(V_Wp2)*U_st_00;
    const ccomplex_t IT_0027 = IT_0002*IT_0026;
    const ccomplex_t IT_0028 = m_t*V_tb*conj(V_u2)*e_em*IT_0008*U_st_10;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_C_2*
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
      *e_em*IT_0002*IT_0008*IT_0015*U_st_00;
    ...
    const ccomplex_t IT_0049 = IT_0036 + IT_0042 + IT_0048;
    const ccomplex_t IT_0050 = IT_0041 + IT_0047;
    const ccomplex_t IT_0051 = m_b*s_23;
    const ccomplex_t IT_0052 = s_23*s_24;
    const ccomplex_t IT_0053 = pow(m_st_1, 2);
