        ...
        )
{
    ...
    const ccomplex_t IT_0024 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    const ccomplex_t IT_0025 = IT_0004*IT_0024;
    const ccomplex_t IT_0026 = m_t*V_tb*conj(V_u1)*e_em*IT_0000*U_st_11;
