...
ccomplex_return_t c_sumSqAmpl_ss_R_st_2_to_c_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0002*IT_0008*IT_0015;
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
    ...
    const ccomplex_t IT_0029 = m_b*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0031 = cpow((-2)*s_13 + IT_0019 + IT_0020 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0032 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    const ccomplex_t IT_0033 = IT_0002*IT_0032;
    const ccomplex_t IT_0034 = m_t*V_tb*conj(V_u2)*e_em*IT_0008*U_st_11;
    ...
    const ccomplex_t IT_0042 = IT_0030*IT_0031*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0002*IT_0008*IT_0015*U_st_01;
    ...
    const ccomplex_t IT_0049 = IT_0029 + IT_0042 + IT_0048;
    const ccomplex_t IT_0050 = IT_0028 + IT_0047;
    const ccomplex_t IT_0051 = m_b*s_23;
    const ccomplex_t IT_0052 = s_23*s_24;
    const ccomplex_t IT_0053 = pow(m_st_2, 2);
    const ccomplex_t IT_0054 = s_34*IT_0053;
    const ccomplex_t IT_0055 = (-18)*s_34;
    const ccomplex_t IT_0056 = s_34*(18*IT_0023*conj(IT_0023) + 18*IT_0049
      *conj(IT_0049)) + ((18*conj(IT_0023) + (-18)*conj(IT_0049))*IT_0050 + (18
      *IT_0023 + (-18)*IT_0049)*conj(IT_0050))*IT_0051 + IT_0050*conj(IT_0050)*
      (36*IT_0052 + (-18)*IT_0054) + (conj(IT_0023)*IT_0049 + IT_0023*conj
      (IT_0049))*IT_0055;
