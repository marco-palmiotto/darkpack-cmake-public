        ...
        )
{
    ...
    const ccomplex_t IT_0035 = (-0.5)*IT_0026 + 0.5*IT_0028 + (-0.5)*IT_0031 +
       0.5*IT_0034;
    const ccomplex_t IT_0036 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0014*U_st_01 
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0036 + m_W*IT_0001*IT_0004*conj(U_sb_00)*U_st_01) + A_t*IT_0004*conj
      (U_sb_00)*U_st_11);
    ...
    const ccomplex_t IT_0068 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0014*U_st_00 
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0068 + m_W*IT_0001*IT_0004*conj(U_sb_01)*U_st_00) + A_t*IT_0004*conj
      (U_sb_01)*U_st_10);
    ...
    const ccomplex_t IT_0090 = m_b*mu_h*IT_0001*IT_0012*IT_0013*conj(U_sb_10)
      *U_st_00 + -conj(U_sb_00)*(((IT_0003 + -IT_0006)*IT_0012 + -m_W*(IT_0088 +
       -IT_0089))*U_st_00 + m_t*mu_h*IT_0004*IT_0012*IT_0014*U_st_10);
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0015*IT_0090 + A_b*IT_0004*conj(U_sb_10)*U_st_00 + -A_t*IT_0001
    ...
    const ccomplex_t IT_0133 = (-0.5)*IT_0124 + 0.5*IT_0126 + (-0.5)*IT_0129 +
       0.5*IT_0132;
    const ccomplex_t IT_0134 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0014*U_st_00 
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0134 + m_W*IT_0001*IT_0004*conj(U_sb_00)*U_st_00) + A_t*IT_0004*conj
      (U_sb_00)*U_st_10);
