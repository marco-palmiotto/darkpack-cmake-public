...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_1_to_A_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (s_12 + IT_0005)*(s_12 + 0.5*IT_0005 + 0.5
      *IT_0006);
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0002*conj(U_sb_00)*U_st_00;
    const ccomplex_t IT_0013 = -IT_0012;
    const ccomplex_t IT_0014 = IT_0011*IT_0013;
    const ccomplex_t IT_0015 = IT_0009*IT_0010*IT_0014;
    const ccomplex_t IT_0016 = (s_13 + s_23)*(s_12 + 0.5*IT_0005 + 0.5*IT_0006);
    const ccomplex_t IT_0017 = 2*IT_0011;
    const ccomplex_t IT_0018 = (-0.5)*IT_0012;
    const ccomplex_t IT_0019 = IT_0017*IT_0018;
    const ccomplex_t IT_0020 = IT_0009*IT_0016*IT_0019;
    const ccomplex_t IT_0021 = 0.5*IT_0005 + 0.5*IT_0006;
    const ccomplex_t IT_0022 = s_12 + IT_0021;
    const ccomplex_t IT_0023 = IT_0011*IT_0018;
    const ccomplex_t IT_0024 = IT_0022*IT_0023;
    const ccomplex_t IT_0025 = IT_0015 + IT_0020 + IT_0024;
    const ccomplex_t IT_0026 = cpow(s_12 + 0.5*IT_0005 + 0.5*IT_0006, 2);
    const ccomplex_t IT_0027 = IT_0009*IT_0023*IT_0026;
    const ccomplex_t IT_0028 = s_12 + IT_0005;
    const ccomplex_t IT_0029 = IT_0014*IT_0028;
    const ccomplex_t IT_0030 = s_13 + s_23;
    const ccomplex_t IT_0031 = IT_0019*IT_0030;
    const ccomplex_t IT_0032 = IT_0013*IT_0017;
    const ccomplex_t IT_0033 = s_23*IT_0032;
    const ccomplex_t IT_0034 = (s_13 + s_23)*(s_12 + IT_0005);
    const ccomplex_t IT_0035 = IT_0009*IT_0032*IT_0034;
    const ccomplex_t IT_0036 = (-2)*IT_0027 + (-0.5)*IT_0029 + (-0.5)*IT_0031 
      + 0.5*IT_0033 + (-0.5)*IT_0035;
    ...
    const ccomplex_t IT_0044 = -IT_0011;
    const ccomplex_t IT_0045 = IT_0018*IT_0044;
    const ccomplex_t IT_0046 = IT_0013*IT_0044;
    const ccomplex_t IT_0047 = IT_0009*IT_0028*IT_0046;
    const ccomplex_t IT_0048 = IT_0045 + IT_0047;
    const ccomplex_t IT_0049 = IT_0009*IT_0022*IT_0045;
    ...
    const ccomplex_t IT_0053 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_st_1
      *Gamma_t1 + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = (-1.33333333333333)*IT_0011;
    const ccomplex_t IT_0056 = IT_0018*IT_0055;
    const ccomplex_t IT_0057 = (-0.666666666666667)*IT_0011;
    const ccomplex_t IT_0058 = IT_0013*IT_0057;
    const ccomplex_t IT_0059 = IT_0056 + IT_0058;
    const ccomplex_t IT_0060 = IT_0013*IT_0055;
    const ccomplex_t IT_0061 = IT_0018*IT_0057;
    const ccomplex_t IT_0062 = -IT_0060 + -IT_0061;
    const ccomplex_t IT_0063 = IT_0059 + IT_0062;
    const ccomplex_t IT_0064 = IT_0054*IT_0063;
    const ccomplex_t IT_0065 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sb_1
      *Gamma_b1 + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*IT_0065;
    const ccomplex_t IT_0067 = 0.333333333333333*IT_0011;
    const ccomplex_t IT_0068 = IT_0018*IT_0067;
    const ccomplex_t IT_0069 = IT_0013*IT_0067;
    const ccomplex_t IT_0070 = -IT_0069;
    const ccomplex_t IT_0071 = IT_0068 + IT_0070;
    const ccomplex_t IT_0072 = IT_0066*IT_0071;
    const ccomplex_t IT_0073 = IT_0052 + 0.5*IT_0064 + (-0.5)*IT_0072;
    const ccomplex_t IT_0074 = (-2)*IT_0011;
    const ccomplex_t IT_0075 = IT_0018*IT_0074;
    const ccomplex_t IT_0076 = IT_0009*IT_0014*IT_0028;
    const ccomplex_t IT_0077 = IT_0013*IT_0074;
    const ccomplex_t IT_0078 = IT_0009*IT_0028*IT_0077;
    const ccomplex_t IT_0079 = IT_0023 + IT_0075 + IT_0076 + IT_0078;
    const ccomplex_t IT_0080 = IT_0009*IT_0022*IT_0023;
    const ccomplex_t IT_0081 = IT_0009*IT_0022*IT_0075;
    const ccomplex_t IT_0082 = -IT_0077 + (-2)*IT_0080 + (-2)*IT_0081;
    const ccomplex_t IT_0083 = IT_0079 + IT_0082;
    const ccomplex_t IT_0084 = IT_0008*IT_0083;
    const ccomplex_t IT_0085 = -IT_0060;
    const ccomplex_t IT_0086 = IT_0056 + IT_0085;
    const ccomplex_t IT_0087 = IT_0054*IT_0086;
    const ccomplex_t IT_0088 = -IT_0084 + (-0.5)*IT_0087;
    const ccomplex_t IT_0089 = 3*s_13;
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = -IT_0014 + -IT_0077 + (-2)*IT_0080 + (-2)
      *IT_0081;
    const ccomplex_t IT_0092 = IT_0079 + IT_0091;
    const ccomplex_t IT_0093 = IT_0008*IT_0092;
    const ccomplex_t IT_0094 = 0.666666666666667*IT_0011;
    const ccomplex_t IT_0095 = IT_0018*IT_0094;
    const ccomplex_t IT_0096 = IT_0013*IT_0094;
    const ccomplex_t IT_0097 = -IT_0096;
    const ccomplex_t IT_0098 = IT_0095 + IT_0097;
    const ccomplex_t IT_0099 = IT_0066*IT_0098;
    const ccomplex_t IT_0100 = -IT_0093 + 0.5*IT_0099;
    ...
    const ccomplex_t IT_0116 = IT_0054*IT_0056;
    const ccomplex_t IT_0117 = (-2)*IT_0080 + (-2)*IT_0081;
    const ccomplex_t IT_0118 = IT_0079 + IT_0117;
    const ccomplex_t IT_0119 = IT_0008*IT_0118;
    const ccomplex_t IT_0120 = (-0.5)*IT_0116 + -IT_0119;
    ...
    const ccomplex_t IT_0126 = -IT_0061;
    const ccomplex_t IT_0127 = IT_0056 + IT_0126;
    const ccomplex_t IT_0128 = IT_0054*IT_0127;
    const ccomplex_t IT_0129 = 0.5*IT_0072 + (-0.5)*IT_0128;
    const ccomplex_t IT_0130 = (-2)*IT_0049;
    const ccomplex_t IT_0131 = IT_0048 + IT_0130;
    const ccomplex_t IT_0132 = IT_0008*IT_0131;
    const ccomplex_t IT_0133 = 0.5*IT_0116 + IT_0132;
    const ccomplex_t IT_0134 = IT_0052 + (-0.5)*IT_0099;
