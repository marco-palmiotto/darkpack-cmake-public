        ...
        )
{
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0005 + IT_0006*IT_0007);
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = pow(m_W, -1);
    const ccomplex_t IT_0039 = cpow(IT_0004, -1);
    const ccomplex_t IT_0040 = cpow(IT_0006, -1);
    const ccomplex_t IT_0041 = pow(m_b, 2);
    const ccomplex_t IT_0042 = pow(m_t, 2);
    const ccomplex_t IT_0043 = cpow(IT_0004, 2);
    const ccomplex_t IT_0044 = cpow(IT_0006, 2);
    const ccomplex_t IT_0045 = m_b*mu_h*IT_0006*IT_0038*IT_0039*conj(U_sb_10)
      *U_st_00 + -conj(U_sb_00)*((IT_0038*(IT_0041 + -IT_0042) + -m_W*(IT_0043 +
       -IT_0044))*U_st_00 + m_t*mu_h*IT_0004*IT_0038*IT_0040*U_st_10);
    ...
    const ccomplex_t IT_0054 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0040*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0006*IT_0039*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0039*IT_0040*U_st_10));
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0006*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0038
    ...
    const ccomplex_t IT_0062 = m_b*mu_h*IT_0038;
    ...
    const ccomplex_t IT_0068 = (-2)*U_sb_00*((IT_0001*IT_0005*IT_0038*IT_0039
      *IT_0041 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))*conj
      (U_sb_00) + -1./2*IT_0001*IT_0007*IT_0039*IT_0062*conj(U_sb_10)) + U_sb_10
      *(IT_0001*IT_0007*IT_0039*IT_0062*conj(U_sb_00) + (-2)*(IT_0001*IT_0005
      *IT_0038*IT_0039*IT_0041 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*conj(U_sb_10
      ));
    const ccomplex_t IT_0069 = (0 + _Complex_I*-1)*(e_em*IT_0068 + (
      -1.4142135623731)*A_b*IT_0005*IT_0061*(conj(U_sb_00)*U_sb_10 + U_sb_00
      *conj(U_sb_10)));
    const ccomplex_t IT_0070 = (-0.5)*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0023 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0077 = (-2)*conj(U_sb_00)*((IT_0001*IT_0005*IT_0038
      *IT_0039*IT_0041 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))
      *U_sb_01 + -1./2*IT_0001*IT_0007*IT_0039*IT_0062*U_sb_11) + conj(U_sb_10)*
      (IT_0001*IT_0007*IT_0039*IT_0062*U_sb_01 + (-2)*(IT_0001*IT_0005*IT_0038
      *IT_0039*IT_0041 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*U_sb_11);
    const ccomplex_t IT_0078 = (0 + _Complex_I*-1)*(e_em*IT_0077 + (
      -1.4142135623731)*A_b*IT_0005*IT_0061*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0079 = (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0009 + IT_0023 + -m_sb_2*
    ...
    const ccomplex_t IT_0084 = -IT_0027 + -IT_0035 + IT_0052 + IT_0059 + 
      -IT_0074 + -IT_0083;
    const ccomplex_t IT_0085 = s_14*s_34*IT_0016;
    const ccomplex_t IT_0086 = -IT_0085;
    const ccomplex_t IT_0087 = s_13 + IT_0086;
    const ccomplex_t IT_0088 = (-2)*U_sb_00*((IT_0001*IT_0005*IT_0038*IT_0039
      *IT_0041 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))*conj
      (U_sb_00) + -1./2*IT_0001*IT_0007*IT_0039*IT_0062*conj(U_sb_10)) + U_sb_10
      *(IT_0001*IT_0007*IT_0039*IT_0062*conj(U_sb_00) + (-2)*(IT_0001*IT_0005
      *IT_0038*IT_0039*IT_0041 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*conj(U_sb_10
    ...
    const ccomplex_t IT_0094 = -IT_0060;
    const ccomplex_t IT_0095 = IT_0003 + IT_0094;
    const ccomplex_t IT_0096 = IT_0013*IT_0095;
    const ccomplex_t IT_0097 = m_t*mu_h*IT_0038;
    const ccomplex_t IT_0098 = -IT_0006*IT_0007 + IT_0064;
    const ccomplex_t IT_0099 = (-2)*U_st_00*((IT_0001*IT_0007*IT_0038*IT_0040
      *IT_0042 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0067)*IT_0098)*conj(U_st_00
      ) + -1./2*IT_0001*IT_0005*IT_0040*IT_0097*conj(U_st_10)) + U_st_10*
      (IT_0001*IT_0005*IT_0040*IT_0097*conj(U_st_00) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0038*IT_0040*IT_0042 + m_W*IT_0000*IT_0067*IT_0098)
      *conj(U_st_10));
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_13 + IT_0023 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0108 = (-2)*U_st_00*((IT_0001*IT_0007*IT_0038*IT_0040
      *IT_0042 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0067)*IT_0098)*conj(U_st_01
      ) + -1./2*IT_0001*IT_0005*IT_0040*IT_0097*conj(U_st_11)) + U_st_10*
      (IT_0001*IT_0005*IT_0040*IT_0097*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0038*IT_0040*IT_0042 + m_W*IT_0000*IT_0067*IT_0098)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0010 + IT_0023 + -m_st_2*
    ...
    const ccomplex_t IT_0115 = (-2)*conj(U_sb_00)*((IT_0001*IT_0005*IT_0038
      *IT_0039*IT_0041 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))
      *U_sb_01 + -1./2*IT_0001*IT_0007*IT_0039*IT_0062*U_sb_11) + conj(U_sb_10)*
      (IT_0001*IT_0007*IT_0039*IT_0062*U_sb_01 + (-2)*(IT_0001*IT_0005*IT_0038
      *IT_0039*IT_0041 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*U_sb_11);
    ...
    const ccomplex_t IT_0118 = IT_0080*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*IT_0118;
    const ccomplex_t IT_0120 = IT_0076*IT_0119;
    const ccomplex_t IT_0121 = IT_0027 + IT_0035 + IT_0093 + -IT_0096 +
    ...
    const ccomplex_t IT_0134 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ...
      *IT_0125 + (-3)*IT_0084*((-0.333333333333333)*IT_0087*IT_0125 + conj
      (IT_0084)*(IT_0023 + -IT_0127) + conj(IT_0121)*IT_0130) + (conj(IT_0084)
