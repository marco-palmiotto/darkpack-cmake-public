...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_1_to_Hp_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = m_t*conj(U_sb_00)*(m_t*IT_0002*IT_0005*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0003*IT_0006*conj(U_sb_00)*U_st_00 + conj
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0003*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0009*((-0.5)*IT_0004
      *IT_0007 + m_W*IT_0002*IT_0003*conj(U_sb_00)*U_st_00) + A_t*IT_0002*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0011 = pow(m_Hp, 2);
    const ccomplex_t IT_0012 = pow(m_sb_1, 2);
    const ccomplex_t IT_0013 = cpow((-2)*s_23 + IT_0011 + IT_0012 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0014 = IT_0010*IT_0013;
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*IT_0014;
    const ccomplex_t IT_0016 = pow(m_st_1, 2);
    const ccomplex_t IT_0017 = cpow((-2)*s_13 + IT_0011 + IT_0016 + -m_sb_1*
