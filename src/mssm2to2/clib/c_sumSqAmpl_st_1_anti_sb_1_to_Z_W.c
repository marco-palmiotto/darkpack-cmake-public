...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_1_to_Z_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = m_b*mu_h*IT_0006*IT_0007*IT_0008*conj(U_sb_10)
      *U_st_00 + -conj(U_sb_00)*((IT_0007*(IT_0010 + -IT_0011) + -m_W*(IT_0012 +
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0014*IT_0016 + A_b*IT_0005*conj(U_sb_10)*U_st_00 + -A_t*IT_0006
    ...
    const ccomplex_t IT_0065 = IT_0024 + -IT_0060 + IT_0061 + IT_0064;
    const ccomplex_t IT_0066 = 3*conj(IT_0050);
    const ccomplex_t IT_0067 = 3*IT_0050;
    const ccomplex_t IT_0068 = (IT_0024 + -IT_0060)*(IT_0024 + -IT_0063);
    const ccomplex_t IT_0069 = 3*IT_0058;
    const ccomplex_t IT_0070 = IT_0033 + IT_0056;
    const ccomplex_t IT_0071 = IT_0037*IT_0055;
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0015 
      + (-3)*IT_0001*IT_0016)*U_st_00*conj(U_st_01) + IT_0002*IT_0015*U_st_10
      *conj(U_st_11));
    const ccomplex_t IT_0078 = 1.33333333333333*IT_0077;
    const ccomplex_t IT_0079 = IT_0076*IT_0078;
    const ccomplex_t IT_0080 = pow(m_Z, 2);
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0024 + IT_0080 + -m_st_2*
    ...
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0080 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = IT_0086*IT_0088;
    const ccomplex_t IT_0090 = -IT_0074 + -IT_0083 + -IT_0089;
    ...
    const ccomplex_t IT_0109 = s_14*s_34*IT_0051;
    const ccomplex_t IT_0110 = (s_12 + -IT_0094)*(s_13 + -IT_0109);
    const ccomplex_t IT_0111 = -IT_0032;
    ...
    const ccomplex_t IT_0116 = (IT_0024 + -IT_0063)*(s_12 + -IT_0094);
    ...
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
      *IT_0015 + 3*IT_0001*IT_0016)*U_sb_00*conj(U_sb_00) + IT_0002*IT_0015
      *U_sb_10*conj(U_sb_10));
    const ccomplex_t IT_0120 = (-0.666666666666667)*IT_0119;
    const ccomplex_t IT_0121 = IT_0037*IT_0120;
    const ccomplex_t IT_0122 = cpow((-2)*s_23 + IT_0080 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
      *IT_0015 + 3*IT_0001*IT_0016)*conj(U_sb_00)*U_sb_01 + IT_0002*IT_0015*conj
      (U_sb_10)*U_sb_11);
    const ccomplex_t IT_0128 = (-0.666666666666667)*IT_0127;
    const ccomplex_t IT_0129 = IT_0126*IT_0128;
    const ccomplex_t IT_0130 = cpow((-2)*s_23 + IT_0023 + IT_0080 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*IT_0130;
    const ccomplex_t IT_0132 = IT_0129*IT_0131;
    const ccomplex_t IT_0133 = -IT_0038 + -IT_0071;
    const ccomplex_t IT_0134 = IT_0070 + IT_0133;
    const ccomplex_t IT_0135 = IT_0029*IT_0134;
    const ccomplex_t IT_0136 = IT_0124 + IT_0132 + -IT_0135;
    ...
    const ccomplex_t IT_0142 = IT_0023 + IT_0137 + IT_0138 + IT_0141;
    const ccomplex_t IT_0143 = s_24*s_34*IT_0051;
    const ccomplex_t IT_0144 = (s_12 + -IT_0094)*(s_23 + -IT_0143);
    const ccomplex_t IT_0145 = (s_12 + -IT_0092)*(IT_0023 + -IT_0140);
    ...
    const ccomplex_t IT_0151 = (IT_0023 + -IT_0099)*(IT_0023 + -IT_0140);
    const ccomplex_t IT_0152 = IT_0037*IT_0111;
    const ccomplex_t IT_0153 = -IT_0152;
    const ccomplex_t IT_0154 = IT_0112 + IT_0153;
    const ccomplex_t IT_0155 = IT_0029*IT_0154;
    const ccomplex_t IT_0156 = -IT_0124 + -IT_0132 + IT_0155;
    const ccomplex_t IT_0157 = (IT_0023 + -IT_0140)*(s_23 + -IT_0143);
    const ccomplex_t IT_0158 = -IT_0157;
    const ccomplex_t IT_0159 = 3*conj(IT_0113);
    ...
    const ccomplex_t IT_0165 = (IT_0024 + -IT_0063)*(IT_0023 + -IT_0140);
    ...
    const ccomplex_t IT_0172 = (IT_0024 + -IT_0060)*(s_13 + -IT_0109);
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = (IT_0024 + -IT_0060)*(s_23 + -IT_0143);
    ...
    const ccomplex_t IT_0178 = (IT_0024 + -IT_0060)*(IT_0080 + -IT_0177);
    ...
    const ccomplex_t IT_0186 = (s_12 + -IT_0094)*(IT_0080 + -IT_0177);
    const ccomplex_t IT_0187 = (-0.333333333333333)*IT_0186;
    const ccomplex_t IT_0188 = (s_13 + -IT_0109)*(IT_0023 + -IT_0140);
    const ccomplex_t IT_0189 = -IT_0188;
    const ccomplex_t IT_0190 = (-0.333333333333333)*IT_0189;
    const ccomplex_t IT_0191 = (IT_0023 + -IT_0140)*(IT_0080 + -IT_0177);
    ...
    const ccomplex_t IT_0193 = 6*IT_0050*conj(IT_0050)*(1 + 0.5*IT_0054) +
      ...
      *IT_0104) + conj(IT_0106)*(IT_0067*IT_0108 + IT_0110*IT_0114 + IT_0101
      *IT_0115 + IT_0104*IT_0117) + IT_0090*(IT_0066*IT_0097 + IT_0103*IT_0118) 
      + conj(IT_0136)*(IT_0069*IT_0115 + IT_0067*IT_0142 + IT_0114*IT_0144 +
       IT_0146*IT_0147 + IT_0149*IT_0150) + IT_0164 + 3*IT_0106*
      (0.333333333333333*IT_0066*IT_0108 + 0.333333333333333*IT_0117*IT_0118 +
       0.333333333333333*IT_0110*IT_0159 + conj(IT_0106)*IT_0165 + IT_0163
      *IT_0166) + (-3)*conj(IT_0113)*(IT_0050*IT_0171 + (-0.333333333333333)
      *IT_0104*IT_0173 + IT_0150*IT_0176) + (-3)*IT_0113*((-0.333333333333333)
      *IT_0118*IT_0173 + IT_0161*IT_0176 + conj(IT_0113)*IT_0179 + (
      -0.333333333333333)*IT_0171*IT_0180) + (-3)*conj(IT_0156)*((
      -0.333333333333333)*IT_0069*IT_0110 + IT_0050*IT_0184 + IT_0101*IT_0185 +
       IT_0114*IT_0187 + IT_0147*IT_0190) + (-3)*IT_0156*(conj(IT_0136)*IT_0158 
      + (-0.333333333333333)*IT_0110*IT_0162 + (-0.333333333333333)*IT_0180
