        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow(IT_0005, 3);
    const ccomplex_t IT_0031 = cpow(IT_0001, 2);
    const ccomplex_t IT_0032 = cos(theta_W);
    const ccomplex_t IT_0033 = cpow(IT_0032, -2);
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*m_W*e_em*(IT_0009*IT_0019
      *IT_0030 + IT_0001*(IT_0002*IT_0019*IT_0031 + (-2)*IT_0005*(IT_0002
      *IT_0005 + IT_0001*IT_0009)*(0.5*IT_0019 + IT_0013*IT_0033)));
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = cpow(IT_0005, 2);
    const ccomplex_t IT_0037 = m_b*mu_h*IT_0005*IT_0010*IT_0017*conj(U_sb_10)
      *U_st_00 + conj(U_sb_00)*(((IT_0004 + -IT_0007)*IT_0017 + m_W*(IT_0031 + 
      -IT_0036))*U_st_00 + -m_t*mu_h*IT_0001*IT_0011*IT_0017*U_st_10);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0019*IT_0037 + A_b*IT_0001*conj(U_sb_10)*U_st_00 + -A_t*IT_0005
    ...
    const ccomplex_t IT_0042 = pow(m_st_1, 2);
    const ccomplex_t IT_0043 = cpow((-2)*s_12 + -IT_0026 + IT_0041 + -IT_0042 
      + -reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0040*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = cpow((-2)*s_13 + IT_0025 + IT_0042 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0047 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0011*U_st_01 
    ...
    const ccomplex_t IT_0048 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      ...
      *IT_0047 + m_W*IT_0001*IT_0005*conj(U_sb_00)*U_st_01) + A_t*IT_0001*conj
      (U_sb_00)*U_st_11);
    const ccomplex_t IT_0049 = m_t*mu_h*IT_0017;
    const ccomplex_t IT_0050 = IT_0001*IT_0009;
    const ccomplex_t IT_0051 = IT_0002*IT_0005;
    const ccomplex_t IT_0052 = IT_0050 + IT_0051;
    const ccomplex_t IT_0053 = 2*U_st_00*((IT_0002*IT_0004*IT_0011*IT_0017
      *IT_0019 + (-0.5)*m_W*(IT_0019 + -1./3*IT_0013*IT_0033)*IT_0052)*conj
      (U_st_01) + 1./2*IT_0009*IT_0011*IT_0019*IT_0049*conj(U_st_11)) + U_st_10*
      (IT_0009*IT_0011*IT_0019*IT_0049*conj(U_st_01) + (-1.33333333333333)*((
      -1.5)*IT_0002*IT_0004*IT_0011*IT_0017*IT_0019 + m_W*IT_0013*IT_0033
      *IT_0052)*conj(U_st_11));
    ...
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0005
    ...
    const ccomplex_t IT_0063 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0062*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*IT_0064;
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0005
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0074 = m_t*conj(U_sb_01)*(m_t*IT_0001*IT_0011*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0005*IT_0010*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0010*IT_0011*U_st_10));
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0019*((-0.5)*IT_0017
      *IT_0074 + m_W*IT_0001*IT_0005*conj(U_sb_01)*U_st_00) + A_t*IT_0001*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0076 = cpow(V_tb, 2);
    const ccomplex_t IT_0077 = m_b*mu_h*IT_0017;
    const ccomplex_t IT_0078 = conj(U_sb_10)*(IT_0002*IT_0010*IT_0019*IT_0077
      *U_sb_01 + 2*(IT_0007*IT_0009*IT_0010*IT_0017*IT_0019 + -1./3*m_W*IT_0013
      *IT_0033*IT_0052)*U_sb_11) + 2*conj(U_sb_00)*((IT_0007*IT_0009*IT_0010
      *IT_0017*IT_0019 + (-0.5)*m_W*(IT_0019 + 1./3*IT_0013*IT_0033)*IT_0052)
      *U_sb_01 + 1./2*IT_0002*IT_0010*IT_0019*IT_0077*U_sb_11);
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*(e_em*IT_0078 +
       1.4142135623731*A_b*IT_0009*IT_0076*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_12 + -IT_0026 + -IT_0042 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0085 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0011*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0005*IT_0010*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0010*IT_0011*U_st_10));
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0019*((-0.5)*IT_0017
      *IT_0085 + m_W*IT_0001*IT_0005*conj(U_sb_00)*U_st_00) + A_t*IT_0001*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0087 = IT_0013*IT_0033;
    const ccomplex_t IT_0088 = -IT_0019 + IT_0087;
    const ccomplex_t IT_0089 = 3*IT_0019 + IT_0087;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*m_W*e_em*(IT_0002*IT_0030
      *IT_0088 + IT_0001*(IT_0009*IT_0036*IT_0089 + -IT_0001*(IT_0001*IT_0009
      *IT_0088 + IT_0002*IT_0005*IT_0089)));
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_13 + IT_0025 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    const ccomplex_t IT_0096 = 2*U_st_00*((IT_0002*IT_0004*IT_0011*IT_0017
      *IT_0019 + (-0.5)*m_W*(IT_0019 + -1./3*IT_0013*IT_0033)*IT_0052)*conj
      (U_st_00) + 1./2*IT_0009*IT_0011*IT_0019*IT_0049*conj(U_st_10)) + U_st_10*
      (IT_0009*IT_0011*IT_0019*IT_0049*conj(U_st_00) + (-1.33333333333333)*((
      -1.5)*IT_0002*IT_0004*IT_0011*IT_0017*IT_0019 + m_W*IT_0013*IT_0033
      *IT_0052)*conj(U_st_10));
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_23 + IT_0025 + (0 + _Complex_I*1)
      *m_sb_1*Gamma_b1 + reg_prop, -1);
    const ccomplex_t IT_0103 = U_sb_10*(IT_0002*IT_0010*IT_0019*IT_0077*conj
      (U_sb_00) + 2*(IT_0007*IT_0009*IT_0010*IT_0017*IT_0019 + -1./3*m_W*IT_0013
      *IT_0033*IT_0052)*conj(U_sb_10)) + 2*U_sb_00*((IT_0007*IT_0009*IT_0010
      *IT_0017*IT_0019 + (-0.5)*m_W*(IT_0019 + 1./3*IT_0013*IT_0033)*IT_0052)
      *conj(U_sb_00) + 1./2*IT_0002*IT_0010*IT_0019*IT_0077*conj(U_sb_10));
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*(e_em*IT_0103 +
       1.4142135623731*A_b*IT_0009*IT_0076*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    ...
    const ccomplex_t IT_0136 = A_t*IT_0001*U_st_10 + (-1.4142135623731)*e_em
      *IT_0019*(m_W*IT_0001*IT_0005*U_st_00 + (-0.5)*IT_0017*(IT_0005*IT_0010
      *IT_0135*U_st_00 + m_t*(m_t*IT_0001*IT_0011*U_st_00 + mu_h*U_st_10)));
    const ccomplex_t IT_0137 = (0 + _Complex_I*1)*conj(V_td)*IT_0136;
    ...
    const ccomplex_t IT_0141 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0142 = IT_0140*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*IT_0142;
    const ccomplex_t IT_0144 = IT_0016 + IT_0029 + -IT_0045 + IT_0058 +
       IT_0065 + IT_0072 + IT_0083 + -IT_0094 + IT_0101 + IT_0108 + (-2)*IT_0134
       + IT_0143;
