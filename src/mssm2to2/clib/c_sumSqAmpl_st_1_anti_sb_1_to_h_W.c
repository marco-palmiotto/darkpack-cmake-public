        ...
        )
{
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0007*conj(U_sb_10);
    const ccomplex_t IT_0051 = 0.5*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0009 + IT_0043 + -m_sd_L*
    ...
    const ccomplex_t IT_0070 = 2*U_sb_00*(((-0.5)*m_W*IT_0036*(IT_0001 + 1./3
    ...
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0043 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0090 = U_st_10*(IT_0001*IT_0007*IT_0022*IT_0089*conj
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0043 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0097 = -IT_0069;
    ...
    const ccomplex_t IT_0102 = U_st_10*(IT_0001*IT_0007*IT_0022*IT_0089*conj
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0010 + IT_0043 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = IT_0101*IT_0107;
    const ccomplex_t IT_0109 = IT_0047 + IT_0055 + IT_0076 + IT_0084 + IT_0096
       + -IT_0099 + IT_0108;
    ...
    const ccomplex_t IT_0122 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ...
      *IT_0113 + (-3)*IT_0085*((-0.333333333333333)*IT_0088*IT_0113 + conj
      (IT_0085)*(IT_0043 + -IT_0115) + conj(IT_0109)*IT_0118) + (conj(IT_0085)
