...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_1_to_nu_tau_anti_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
      *IT_0001*IT_0019;
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*e_em*m_tau
