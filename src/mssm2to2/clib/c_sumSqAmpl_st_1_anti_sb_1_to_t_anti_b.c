        ...
        )
{
    ...
    const ccomplex_t IT_0034 = m_t*conj(N_u4)*e_em*IT_0033*U_st_10;
    ...
    const ccomplex_t IT_0059 = conj(N_W1)*e_em*U_st_00;
    const ccomplex_t IT_0060 = IT_0010*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = m_t*conj(N_u1)*e_em*IT_0033*U_st_10;
    ...
    const ccomplex_t IT_0085 = IT_0058*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0088 = conj(N_B2)*e_em*U_st_00;
    const ccomplex_t IT_0089 = IT_0023*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = conj(N_W2)*e_em*U_st_00;
    const ccomplex_t IT_0092 = IT_0010*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = m_t*conj(N_u2)*e_em*IT_0033*U_st_10;
    ...
    const ccomplex_t IT_0115 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0116 = m_b*N_d3*e_em*IT_0033*conj(U_sb_10);
    const ccomplex_t IT_0117 = IT_0041*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = N_W3*e_em*conj(U_sb_00);
    const ccomplex_t IT_0120 = IT_0010*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = N_B3*e_em*conj(U_sb_00);
    ...
    const ccomplex_t IT_0141 = IT_0115*IT_0140;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*IT_0141;
    const ccomplex_t IT_0143 = 0.166666666666667*IT_0008 + -IT_0057 + -IT_0086
       + -IT_0114 + -IT_0142;
    const ccomplex_t IT_0144 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_10;
    ...
    const ccomplex_t IT_0157 = N_B1*e_em*U_st_10;
    const ccomplex_t IT_0158 = IT_0023*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = m_t*N_u1*e_em*IT_0033*U_st_00;
    ...
    const ccomplex_t IT_0168 = N_B2*e_em*U_st_10;
    const ccomplex_t IT_0169 = IT_0023*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = m_t*N_u2*e_em*IT_0033*U_st_00;
    ...
    const ccomplex_t IT_0193 = IT_0087*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*IT_0193;
    const ccomplex_t IT_0195 = m_t*N_u3*e_em*IT_0033*U_st_00;
    const ccomplex_t IT_0196 = IT_0032*IT_0195;
    ...
    const ccomplex_t IT_0201 = (0 + _Complex_I*1)*(IT_0197 + (
      -1.33333333333333)*IT_0200);
    ...
    const ccomplex_t IT_0206 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0207 = IT_0023*IT_0206;
    const ccomplex_t IT_0208 = 1.4142135623731*IT_0207;
    const ccomplex_t IT_0209 = m_b*conj(N_d3)*e_em*IT_0033*conj(U_sb_00);
    ...
    const ccomplex_t IT_0241 = 0.166666666666667*IT_0148 + -IT_0167 + -IT_0194
       + -IT_0218 + -IT_0240;
    const ccomplex_t IT_0242 = (-0.5)*IT_0148;
    const ccomplex_t IT_0243 = s_34*IT_0002;
    const ccomplex_t IT_0244 = (-6)*IT_0243;
    const ccomplex_t IT_0245 = s_13*s_14;
    const ccomplex_t IT_0246 = 12*IT_0245;
    const ccomplex_t IT_0247 = IT_0244 + IT_0246;
    const ccomplex_t IT_0248 = (-18)*IT_0243;
    const ccomplex_t IT_0249 = 36*IT_0245;
    const ccomplex_t IT_0250 = IT_0248 + IT_0249;
    const ccomplex_t IT_0251 = m_t*s_14;
    const ccomplex_t IT_0252 = pow(m_W, 2);
    const ccomplex_t IT_0253 = cpow((-2)*s_12 + -IT_0002 + -IT_0015 + IT_0252 
      + -reg_prop, -1);
    const ccomplex_t IT_0254 = pow(m_b, 2);
    const ccomplex_t IT_0255 = cpow(IT_0039, 2);
    const ccomplex_t IT_0256 = cpow(IT_0030, 2);
    const ccomplex_t IT_0257 = m_b*mu_h*IT_0030*IT_0033*IT_0040*conj(U_sb_10)
      *U_st_00 + conj(U_sb_00)*((IT_0033*(IT_0000 + -IT_0254) + m_W*(IT_0255 + 
      -IT_0256))*U_st_00 + -m_t*mu_h*IT_0031*IT_0033*IT_0039*U_st_10);
    const ccomplex_t IT_0258 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0010*IT_0257 + A_b*IT_0039*conj(U_sb_10)*U_st_00 + -A_t*IT_0030
      *conj(U_sb_00)*U_st_10);
    const ccomplex_t IT_0259 = -IT_0258;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0010*IT_0033;
    ...
    const ccomplex_t IT_0266 = m_t*conj(U_sb_00)*(m_t*IT_0031*IT_0039*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0030*IT_0040*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0031*IT_0040*U_st_10));
    const ccomplex_t IT_0267 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0030*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0010*((-0.5)*IT_0033
      *IT_0266 + m_W*IT_0030*IT_0039*conj(U_sb_00)*U_st_00) + A_t*IT_0039*conj
      (U_sb_00)*U_st_10);
    ...
    const ccomplex_t IT_0273 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0274 = IT_0004*IT_0145;
    const ccomplex_t IT_0275 = IT_0003*IT_0273*IT_0274;
    const ccomplex_t IT_0276 = (-0.5)*IT_0011;
    const ccomplex_t IT_0277 = m_b*IT_0276;
    const ccomplex_t IT_0278 = m_b*IT_0012;
    const ccomplex_t IT_0279 = -IT_0278;
    const ccomplex_t IT_0280 = IT_0277 + IT_0279;
    const ccomplex_t IT_0281 = IT_0018*IT_0280;
    const ccomplex_t IT_0282 = m_t*IT_0148;
    const ccomplex_t IT_0283 = -IT_0264 + -IT_0272 + (-0.5)*IT_0275 + IT_0281 
      + 0.5*IT_0282;
    const ccomplex_t IT_0284 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0285 = IT_0070*IT_0156;
    const ccomplex_t IT_0286 = IT_0058*IT_0284*IT_0285;
    const ccomplex_t IT_0287 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0288 = IT_0139*IT_0215;
    const ccomplex_t IT_0289 = IT_0115*IT_0287*IT_0288;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0291 = IT_0098*IT_0191;
    const ccomplex_t IT_0292 = IT_0087*IT_0290*IT_0291;
    const ccomplex_t IT_0293 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0294 = IT_0038*IT_0237;
    const ccomplex_t IT_0295 = IT_0021*IT_0293*IT_0294;
    const ccomplex_t IT_0296 = m_t*IT_0167;
    const ccomplex_t IT_0297 = m_t*IT_0194;
    const ccomplex_t IT_0298 = m_t*IT_0218;
    const ccomplex_t IT_0299 = m_t*IT_0240;
    const ccomplex_t IT_0300 = 0.166666666666667*IT_0275 + (-0.166666666666667
      )*IT_0282 + -IT_0286 + -IT_0289 + -IT_0292 + -IT_0295 + IT_0296 + IT_0297 
      + IT_0298 + IT_0299;
    const ccomplex_t IT_0301 = IT_0128*IT_0205;
    const ccomplex_t IT_0302 = IT_0115*IT_0287*IT_0301;
    const ccomplex_t IT_0303 = IT_0005*IT_0144;
    const ccomplex_t IT_0304 = IT_0003*IT_0273*IT_0303;
    const ccomplex_t IT_0305 = IT_0083*IT_0164;
    const ccomplex_t IT_0306 = IT_0058*IT_0284*IT_0305;
    const ccomplex_t IT_0307 = IT_0111*IT_0175;
    const ccomplex_t IT_0308 = IT_0087*IT_0290*IT_0307;
    const ccomplex_t IT_0309 = IT_0054*IT_0227;
    const ccomplex_t IT_0310 = IT_0021*IT_0293*IT_0309;
    const ccomplex_t IT_0311 = m_t*IT_0008;
    const ccomplex_t IT_0312 = m_t*IT_0086;
    const ccomplex_t IT_0313 = m_t*IT_0114;
    const ccomplex_t IT_0314 = m_t*IT_0142;
    const ccomplex_t IT_0315 = m_t*IT_0057;
    const ccomplex_t IT_0316 = -IT_0302 + 0.166666666666667*IT_0304 + -IT_0306
       + -IT_0308 + -IT_0310 + (-0.166666666666667)*IT_0311 + IT_0312 + IT_0313 
      + IT_0314 + IT_0315;
    const ccomplex_t IT_0317 = 3*IT_0143;
    const ccomplex_t IT_0318 = IT_0020 + IT_0317;
    const ccomplex_t IT_0319 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0010*IT_0033;
    const ccomplex_t IT_0320 = 0.5*IT_0319;
    const ccomplex_t IT_0321 = IT_0259*IT_0320;
    const ccomplex_t IT_0322 = IT_0253*IT_0321;
    const ccomplex_t IT_0323 = (0 + _Complex_I*1)*IT_0322;
    const ccomplex_t IT_0324 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0010*IT_0031*IT_0033*IT_0039;
    const ccomplex_t IT_0325 = 0.5*IT_0324;
    const ccomplex_t IT_0326 = IT_0267*IT_0325;
    const ccomplex_t IT_0327 = IT_0265*IT_0326;
    const ccomplex_t IT_0328 = (0 + _Complex_I*1)*IT_0327;
    const ccomplex_t IT_0329 = m_t*IT_0276;
    const ccomplex_t IT_0330 = m_t*IT_0012;
    const ccomplex_t IT_0331 = -IT_0330;
    const ccomplex_t IT_0332 = IT_0329 + IT_0331;
    const ccomplex_t IT_0333 = IT_0018*IT_0332;
    const ccomplex_t IT_0334 = (-0.5)*IT_0304 + 0.5*IT_0311 + -IT_0323 + 
      -IT_0328 + -IT_0333;
    const ccomplex_t IT_0335 = 0.333333333333333*IT_0143;
    const ccomplex_t IT_0336 = IT_0020 + IT_0335;
    const ccomplex_t IT_0337 = 3*conj(IT_0143);
    const ccomplex_t IT_0338 = conj(IT_0020) + IT_0337;
    const ccomplex_t IT_0339 = 0.333333333333333*conj(IT_0143);
    const ccomplex_t IT_0340 = conj(IT_0020) + IT_0339;
    const ccomplex_t IT_0341 = conj(IT_0241)*(IT_0283 + 3*IT_0300) + 3*conj
      (IT_0242)*(IT_0283 + 0.333333333333333*IT_0300) + IT_0241*(conj(IT_0283) +
       3*conj(IT_0300)) + 3*IT_0242*(conj(IT_0283) + 0.333333333333333*conj
      (IT_0300)) + conj(IT_0316)*IT_0318 + 3*conj(IT_0334)*IT_0336 + IT_0316
      *IT_0338 + 3*IT_0334*IT_0340;
    const ccomplex_t IT_0342 = m_b*m_t*IT_0002;
    const ccomplex_t IT_0343 = 6*s_34;
    const ccomplex_t IT_0344 = 18*s_34;
    const ccomplex_t IT_0345 = m_b*m_t;
    const ccomplex_t IT_0346 = (-18)*conj(IT_0334);
    const ccomplex_t IT_0347 = (-6)*conj(IT_0316);
    const ccomplex_t IT_0348 = IT_0346 + IT_0347;
    const ccomplex_t IT_0349 = (-18)*conj(IT_0316);
    const ccomplex_t IT_0350 = (-6)*conj(IT_0334);
    const ccomplex_t IT_0351 = IT_0349 + IT_0350;
    const ccomplex_t IT_0352 = (-18)*IT_0316;
    const ccomplex_t IT_0353 = (-6)*IT_0316;
    const ccomplex_t IT_0354 = m_b*s_13;
    const ccomplex_t IT_0355 = conj(IT_0300)*IT_0318 + 3*conj(IT_0283)*IT_0336
       + IT_0300*IT_0338 + 3*IT_0283*IT_0340 + (-0.166666666666667)*IT_0242
      *IT_0348 + (-0.166666666666667)*IT_0241*IT_0351 + conj(IT_0241)*(IT_0334 +
       (-0.166666666666667)*IT_0352) + 3*conj(IT_0242)*(IT_0334 + (
      -0.0555555555555556)*IT_0353);
    const ccomplex_t IT_0356 = (conj(IT_0020)*IT_0143 + IT_0020*conj(IT_0143) 
      + conj(IT_0241)*IT_0242 + IT_0241*conj(IT_0242))*IT_0247 + (IT_0020*conj
      (IT_0020) + IT_0143*conj(IT_0143) + IT_0241*conj(IT_0241) + IT_0242*conj
      (IT_0242))*IT_0250 + 6*IT_0251*IT_0341 + (-6)*(conj(IT_0241)*IT_0318 + 3
      *conj(IT_0242)*IT_0336 + IT_0241*IT_0338 + 3*IT_0242*IT_0340)*IT_0342 + 
      (conj(IT_0283)*IT_0300 + IT_0283*conj(IT_0300) + conj(IT_0316)*IT_0334 +
       IT_0316*conj(IT_0334))*IT_0343 + (IT_0283*conj(IT_0283) + IT_0300*conj
      (IT_0300) + IT_0316*conj(IT_0316) + IT_0334*conj(IT_0334))*IT_0344 +
       IT_0345*(((-18)*conj(IT_0283) + (-6)*conj(IT_0300))*IT_0334 + IT_0283
      *IT_0348 + IT_0300*IT_0351 + conj(IT_0300)*IT_0352 + conj(IT_0283)*IT_0353
      ) + (-6)*IT_0354*IT_0355;
