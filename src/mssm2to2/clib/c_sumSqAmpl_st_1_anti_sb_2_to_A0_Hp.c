        ...
        )
{
    ...
    const ccomplex_t IT_0017 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0015*U_st_00 
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0017 + m_W*IT_0001*IT_0004*conj(U_sb_01)*U_st_00) + A_t*IT_0004*conj
      (U_sb_01)*U_st_10);
    ...
    const ccomplex_t IT_0035 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0015*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0001*IT_0016*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0015*IT_0016*U_st_10));
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0018*((-0.5)*IT_0014
      *IT_0035 + m_W*IT_0001*IT_0004*conj(U_sb_00)*U_st_00) + A_t*IT_0004*conj
      (U_sb_00)*U_st_10);
    ...
    const ccomplex_t IT_0053 = m_t*e_em*mu_h*IT_0014*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0054 = IT_0018*IT_0053;
    const ccomplex_t IT_0055 = m_t*e_em*mu_h*IT_0014*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0056 = IT_0018*IT_0055;
    const ccomplex_t IT_0057 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0058 = IT_0004*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0072 = m_b*mu_h*IT_0001*IT_0014*IT_0016*conj(U_sb_11)
      *U_st_00 + -conj(U_sb_01)*(((IT_0003 + -IT_0006)*IT_0014 + -m_W*(IT_0070 +
       -IT_0071))*U_st_00 + m_t*mu_h*IT_0004*IT_0014*IT_0015*U_st_10);
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0018*IT_0072 + A_b*IT_0004*conj(U_sb_11)*U_st_00 + -A_t*IT_0001
    ...
    const ccomplex_t IT_0077 = pow(m_st_1, 2);
    ...
    const ccomplex_t IT_0106 = m_t*e_em*mu_h*IT_0014*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0107 = IT_0018*IT_0106;
    const ccomplex_t IT_0108 = m_t*e_em*mu_h*IT_0014*U_st_00*conj(U_st_11);
    const ccomplex_t IT_0109 = IT_0018*IT_0108;
    const ccomplex_t IT_0110 = A_t*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0111 = IT_0004*IT_0110;
    const ccomplex_t IT_0112 = 1.4142135623731*IT_0111;
    const ccomplex_t IT_0113 = A_t*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0116 = (-0.5)*IT_0107 + 0.5*IT_0109 + (-0.5)*IT_0112 +
       0.5*IT_0115;
    const ccomplex_t IT_0117 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0015*U_st_01 
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0117 + m_W*IT_0001*IT_0004*conj(U_sb_01)*U_st_01) + A_t*IT_0004*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0119 = IT_0116*IT_0118;
    const ccomplex_t IT_0120 = cpow((-2)*s_13 + IT_0012 + IT_0077 + -m_st_2*
    ...
    const ccomplex_t IT_0124 = A_t*IT_0004*U_st_10 + (-1.4142135623731)*e_em
      *IT_0018*(m_W*IT_0001*IT_0004*U_st_00 + (-0.5)*IT_0014*(IT_0001*IT_0016
      *IT_0123*U_st_00 + m_t*(m_t*IT_0004*IT_0015*U_st_00 + mu_h*U_st_10)));
    ...
    const ccomplex_t IT_0133 = A_t*IT_0004*U_st_10 + (-1.4142135623731)*e_em
      *IT_0018*(m_W*IT_0001*IT_0004*U_st_00 + (-0.5)*IT_0014*(IT_0001*IT_0016
      *IT_0132*U_st_00 + m_t*(m_t*IT_0004*IT_0015*U_st_00 + mu_h*U_st_10)));
    ...
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0001
      *U_st_00 + 0.707106781186548*m_d*e_em*IT_0014*IT_0018*(mu_h*U_st_00 + m_t
    ...
    const ccomplex_t IT_0148 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0001
      *U_st_00 + 0.707106781186548*m_s*e_em*IT_0014*IT_0018*(mu_h*U_st_00 + m_t
      *IT_0015*IT_0016*U_st_10));
