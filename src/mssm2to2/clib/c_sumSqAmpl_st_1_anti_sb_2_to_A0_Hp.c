...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_2_to_A0_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = 1.4142135623731*V_tb*IT_0000*(IT_0001*(IT_0001 
      ...
      *IT_0006*IT_0007))*IT_0009*conj(U_sb_01)*U_st_00;
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0001
      *U_st_00 + 0.707106781186548*m_s*e_em*IT_0012*IT_0015*(mu_h*U_st_00 + m_t
    ...
    const ccomplex_t IT_0025 = m_t*e_em*mu_h*IT_0012*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0026 = IT_0015*IT_0025;
    const ccomplex_t IT_0027 = m_t*e_em*mu_h*IT_0012*U_st_00*conj(U_st_11);
    const ccomplex_t IT_0028 = IT_0015*IT_0027;
    const ccomplex_t IT_0029 = A_t*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0030 = IT_0004*IT_0029;
    const ccomplex_t IT_0031 = 1.4142135623731*IT_0030;
    const ccomplex_t IT_0032 = A_t*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0035 = (-0.5)*IT_0026 + 0.5*IT_0028 + (-0.5)*IT_0031 +
       0.5*IT_0034;
    const ccomplex_t IT_0036 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0014*U_st_01 
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0036 + m_W*IT_0001*IT_0004*conj(U_sb_01)*U_st_01) + A_t*IT_0004*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0038 = IT_0035*IT_0037;
    const ccomplex_t IT_0039 = pow(m_st_1, 2);
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0020 + IT_0039 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0038*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = pow(m_d, 2);
    const ccomplex_t IT_0044 = A_t*IT_0004*U_st_10 + (-1.4142135623731)*e_em
      *IT_0015*(m_W*IT_0001*IT_0004*U_st_00 + (-0.5)*IT_0012*(IT_0001*IT_0013
      *IT_0043*U_st_00 + m_t*(m_t*IT_0004*IT_0014*U_st_00 + mu_h*U_st_10)));
    ...
    const ccomplex_t IT_0053 = A_t*IT_0004*U_st_10 + (-1.4142135623731)*e_em
      *IT_0015*(m_W*IT_0001*IT_0004*U_st_00 + (-0.5)*IT_0012*(IT_0001*IT_0013
      *IT_0052*U_st_00 + m_t*(m_t*IT_0004*IT_0014*U_st_00 + mu_h*U_st_10)));
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0001
      *U_st_00 + 0.707106781186548*m_d*e_em*IT_0012*IT_0015*(mu_h*U_st_00 + m_t
      *IT_0013*IT_0014*U_st_10));
    ...
    const ccomplex_t IT_0068 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0014*U_st_00 
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0068 + m_W*IT_0001*IT_0004*conj(U_sb_00)*U_st_00) + A_t*IT_0004*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0070 = m_b*e_em*mu_h*IT_0012*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0071 = IT_0015*IT_0070;
    const ccomplex_t IT_0072 = m_b*e_em*mu_h*IT_0012*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0073 = IT_0015*IT_0072;
    const ccomplex_t IT_0074 = cpow(V_tb, 2);
    const ccomplex_t IT_0075 = A_b*IT_0074*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = A_b*IT_0074*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0083 = cpow((-2)*s_23 + IT_0020 + IT_0021 + -m_sb_1*
    ...
    const ccomplex_t IT_0090 = m_b*mu_h*IT_0001*IT_0012*IT_0013*conj(U_sb_11)
      *U_st_00 + -conj(U_sb_01)*(((IT_0003 + -IT_0006)*IT_0012 + -m_W*(IT_0088 +
       -IT_0089))*U_st_00 + m_t*mu_h*IT_0004*IT_0012*IT_0014*U_st_10);
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0015*IT_0090 + A_b*IT_0004*conj(U_sb_11)*U_st_00 + -A_t*IT_0001
    ...
    const ccomplex_t IT_0123 = m_t*e_em*mu_h*IT_0012*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0124 = IT_0015*IT_0123;
    const ccomplex_t IT_0125 = m_t*e_em*mu_h*IT_0012*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0126 = IT_0015*IT_0125;
    const ccomplex_t IT_0127 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0128 = IT_0004*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0133 = (-0.5)*IT_0124 + 0.5*IT_0126 + (-0.5)*IT_0129 +
       0.5*IT_0132;
    const ccomplex_t IT_0134 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0014*U_st_00 
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      ...
      *IT_0134 + m_W*IT_0001*IT_0004*conj(U_sb_01)*U_st_00) + A_t*IT_0004*conj
      (U_sb_01)*U_st_10);
    ...
    const ccomplex_t IT_0144 = A_b*IT_0074*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0145 = IT_0001*IT_0144;
    const ccomplex_t IT_0146 = 1.4142135623731*IT_0145;
    const ccomplex_t IT_0147 = A_b*IT_0074*U_sb_01*conj(U_sb_11);
