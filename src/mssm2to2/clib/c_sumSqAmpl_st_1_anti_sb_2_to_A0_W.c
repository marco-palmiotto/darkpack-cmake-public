        ...
        )
{
    ...
    const ccomplex_t IT_0009 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0007*U_st_00 
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      ...
      *IT_0009 + m_W*IT_0004*IT_0005*conj(U_sb_01)*U_st_00) + A_t*IT_0004*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0011 = pow(m_sb_2, 2);
    ...
    const ccomplex_t IT_0028 = m_b*e_em*mu_h*IT_0006*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0029 = IT_0001*IT_0028;
    const ccomplex_t IT_0030 = m_b*e_em*mu_h*IT_0006*U_sb_01*conj(U_sb_11);
    ...
    const ccomplex_t IT_0054 = m_b*e_em*mu_h*IT_0006*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0055 = IT_0001*IT_0054;
    const ccomplex_t IT_0056 = m_b*e_em*mu_h*IT_0006*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0057 = IT_0001*IT_0056;
    const ccomplex_t IT_0058 = A_b*IT_0032*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0059 = IT_0005*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = A_b*IT_0032*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0064 = (-0.5)*IT_0055 + 0.5*IT_0057 + (-0.5)*IT_0060 +
       0.5*IT_0063;
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0011 + IT_0021 + -m_sb_1*
    ...
    const ccomplex_t IT_0073 = m_t*e_em*mu_h*IT_0006*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0074 = IT_0001*IT_0073;
    const ccomplex_t IT_0075 = m_t*e_em*mu_h*IT_0006*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0083 = (-0.5)*IT_0074 + 0.5*IT_0076 + (-0.5)*IT_0079 +
       0.5*IT_0082;
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0021 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0090 = m_t*e_em*mu_h*IT_0006*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0091 = IT_0001*IT_0090;
    const ccomplex_t IT_0092 = m_t*e_em*mu_h*IT_0006*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0100 = (-0.5)*IT_0091 + 0.5*IT_0093 + (-0.5)*IT_0096 +
       0.5*IT_0099;
    const ccomplex_t IT_0101 = cpow((-2)*s_13 + IT_0012 + IT_0021 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0102 = IT_0100*IT_0101;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*IT_0102;
    const ccomplex_t IT_0104 = IT_0089*IT_0103;
    const ccomplex_t IT_0105 = IT_0025 + IT_0043 + IT_0051 + IT_0068 + IT_0087
       + IT_0104;
