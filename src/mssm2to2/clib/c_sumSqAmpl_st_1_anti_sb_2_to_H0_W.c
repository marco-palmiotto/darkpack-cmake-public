...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_2_to_H0_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0021*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0006*IT_0022*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0021*IT_0022*U_st_10));
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0006*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0020
      *IT_0023 + m_W*IT_0004*IT_0006*conj(U_sb_01)*U_st_00) + A_t*IT_0004*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0025 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*IT_0026;
    const ccomplex_t IT_0028 = IT_0019*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0005 + IT_0006*IT_0007);
    const ccomplex_t IT_0030 = -IT_0029;
    const ccomplex_t IT_0031 = pow(m_b, 2);
    const ccomplex_t IT_0032 = pow(m_t, 2);
    const ccomplex_t IT_0033 = cpow(IT_0004, 2);
    const ccomplex_t IT_0034 = cpow(IT_0006, 2);
    const ccomplex_t IT_0035 = m_b*mu_h*IT_0006*IT_0020*IT_0022*conj(U_sb_11)
      *U_st_00 + -conj(U_sb_01)*((IT_0020*(IT_0031 + -IT_0032) + -m_W*(IT_0033 +
       -IT_0034))*U_st_00 + m_t*mu_h*IT_0004*IT_0020*IT_0021*U_st_10);
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0001*IT_0035 + A_b*IT_0004*conj(U_sb_11)*U_st_00 + -A_t*IT_0006
    ...
    const ccomplex_t IT_0043 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
    ...
    const ccomplex_t IT_0062 = m_b*mu_h*IT_0020;
    const ccomplex_t IT_0063 = -IT_0006*IT_0007;
    ...
    const ccomplex_t IT_0068 = (-2)*U_sb_01*((IT_0001*IT_0005*IT_0020*IT_0022
      *IT_0031 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_11)) + U_sb_11
      *(IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_01) + (-2)*(IT_0001*IT_0005
      *IT_0020*IT_0022*IT_0031 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*conj(U_sb_11
      ));
    const ccomplex_t IT_0069 = (0 + _Complex_I*-1)*(e_em*IT_0068 + (
      -1.4142135623731)*A_b*IT_0005*IT_0061*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    const ccomplex_t IT_0070 = (-0.5)*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0047 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0077 = (-2)*U_sb_00*((IT_0001*IT_0005*IT_0020*IT_0022
      *IT_0031 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_11)) + U_sb_10
      *(IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_01) + (-2)*(IT_0001*IT_0005
      *IT_0020*IT_0022*IT_0031 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*conj(U_sb_11
      ));
    const ccomplex_t IT_0078 = (0 + _Complex_I*-1)*(e_em*IT_0077 + (
      -1.4142135623731)*A_b*IT_0005*IT_0061*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0079 = (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0009 + IT_0047 + -m_sb_1*
    ...
    const ccomplex_t IT_0084 = IT_0028 + IT_0042 + -IT_0051 + -IT_0059 + 
      -IT_0074 + -IT_0083;
    const ccomplex_t IT_0085 = s_14*s_34*IT_0016;
    const ccomplex_t IT_0086 = -IT_0085;
    const ccomplex_t IT_0087 = s_13 + IT_0086;
    const ccomplex_t IT_0088 = (-2)*U_sb_00*((IT_0001*IT_0005*IT_0020*IT_0022
      *IT_0031 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_11)) + U_sb_10
      *(IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_01) + (-2)*(IT_0001*IT_0005
      *IT_0020*IT_0022*IT_0031 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*conj(U_sb_11
    ...
    const ccomplex_t IT_0096 = m_t*mu_h*IT_0020;
    const ccomplex_t IT_0097 = -IT_0006*IT_0007 + IT_0064;
    const ccomplex_t IT_0098 = (-2)*U_st_00*((IT_0001*IT_0007*IT_0020*IT_0021
      *IT_0032 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0067)*IT_0097)*conj(U_st_01
      ) + -1./2*IT_0001*IT_0005*IT_0021*IT_0096*conj(U_st_11)) + U_st_10*
      (IT_0001*IT_0005*IT_0021*IT_0096*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0020*IT_0021*IT_0032 + m_W*IT_0000*IT_0067*IT_0097)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0101 = cpow((-2)*s_13 + IT_0010 + IT_0047 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0102 = IT_0100*IT_0101;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*IT_0102;
    const ccomplex_t IT_0104 = IT_0095*IT_0103;
    const ccomplex_t IT_0105 = (-2)*U_st_00*((IT_0001*IT_0007*IT_0020*IT_0021
      *IT_0032 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0067)*IT_0097)*conj(U_st_00
      ) + -1./2*IT_0001*IT_0005*IT_0021*IT_0096*conj(U_st_10)) + U_st_10*
      (IT_0001*IT_0005*IT_0021*IT_0096*conj(U_st_00) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0020*IT_0021*IT_0032 + m_W*IT_0000*IT_0067*IT_0097)
      *conj(U_st_10));
    ...
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0047 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0112 = -IT_0060;
    const ccomplex_t IT_0113 = IT_0003 + IT_0112;
    const ccomplex_t IT_0114 = IT_0013*IT_0113;
    const ccomplex_t IT_0115 = (-2)*U_sb_01*((IT_0001*IT_0005*IT_0020*IT_0022
      *IT_0031 + (-0.5)*m_W*IT_0065*(IT_0001 + 1./3*IT_0000*IT_0067))*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_11)) + U_sb_11
      *(IT_0001*IT_0007*IT_0022*IT_0062*conj(U_sb_01) + (-2)*(IT_0001*IT_0005
      *IT_0020*IT_0022*IT_0031 + -1./3*m_W*IT_0000*IT_0065*IT_0067)*conj(U_sb_11
    ...
    const ccomplex_t IT_0118 = IT_0071*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*IT_0118;
    const ccomplex_t IT_0120 = IT_0060*IT_0119;
    const ccomplex_t IT_0121 = IT_0051 + IT_0059 + IT_0093 + IT_0104 + IT_0111
       + -IT_0114 + IT_0120;
    ...
    const ccomplex_t IT_0134 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ) + conj(IT_0084)*IT_0087 + conj(IT_0121)*IT_0124) + IT_0121*IT_0124
      *IT_0125 + (-3)*IT_0084*((-0.333333333333333)*IT_0087*IT_0125 + conj
      (IT_0084)*(IT_0047 + -IT_0127) + conj(IT_0121)*IT_0130) + (conj(IT_0084)
