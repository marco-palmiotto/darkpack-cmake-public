        ...
        )
{
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
      *e_em*IT_0001*U_st_00;
    const ccomplex_t IT_0030 = -IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0005*conj(U_sb_11);
    const ccomplex_t IT_0032 = (-0.5)*IT_0031;
    const ccomplex_t IT_0033 = pow(m_H0, 2);
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0009 + IT_0033 + -m_ss_L*
    ...
    const ccomplex_t IT_0041 = m_b*mu_h*IT_0020;
    ...
    const ccomplex_t IT_0048 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0044*(IT_0001 + 1.
      /3*IT_0000*IT_0046) + IT_0001*IT_0005*IT_0020*IT_0022*IT_0047)*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0041*conj(U_sb_11)) + U_sb_10
      *(IT_0001*IT_0007*IT_0022*IT_0041*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0000*IT_0044*IT_0046 + (-3)*IT_0001*IT_0005*IT_0020*IT_0022*IT_0047)
      *conj(U_sb_11));
    const ccomplex_t IT_0049 = (0 + _Complex_I*-1)*(e_em*IT_0048 + (
      -1.4142135623731)*A_b*IT_0005*IT_0040*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0050 = (-0.5)*IT_0049;
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0009 + IT_0033 + -m_sb_1*
    ...
    const ccomplex_t IT_0056 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0044*(IT_0001 + 1.
      /3*IT_0000*IT_0046) + IT_0001*IT_0005*IT_0020*IT_0022*IT_0047)*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0041*conj(U_sb_11)) + U_sb_11
      *(IT_0001*IT_0007*IT_0022*IT_0041*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0000*IT_0044*IT_0046 + (-3)*IT_0001*IT_0005*IT_0020*IT_0022*IT_0047)
      *conj(U_sb_11));
    const ccomplex_t IT_0057 = (0 + _Complex_I*-1)*(e_em*IT_0056 + (
      -1.4142135623731)*A_b*IT_0005*IT_0040*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0033 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = IT_0055*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
      *e_em*IT_0001*U_st_00;
    const ccomplex_t IT_0064 = -IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0005*conj(U_sb_11);
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0009 + IT_0033 + -m_sd_L*
    ...
    const ccomplex_t IT_0076 = m_b*mu_h*IT_0006*IT_0020*IT_0022*conj(U_sb_11)
      *U_st_00 + -conj(U_sb_01)*((IT_0020*(IT_0047 + -IT_0073) + -m_W*(IT_0074 +
       -IT_0075))*U_st_00 + m_t*mu_h*IT_0004*IT_0020*IT_0021*U_st_10);
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0001*IT_0076 + A_b*IT_0004*conj(U_sb_11)*U_st_00 + -A_t*IT_0006
    ...
    const ccomplex_t IT_0084 = IT_0028 + -IT_0037 + -IT_0054 + -IT_0062 + 
      -IT_0070 + IT_0083;
    const ccomplex_t IT_0085 = s_14*s_34*IT_0016;
    const ccomplex_t IT_0086 = -IT_0085;
    const ccomplex_t IT_0087 = s_13 + IT_0086;
    const ccomplex_t IT_0088 = m_t*mu_h*IT_0020;
    const ccomplex_t IT_0089 = -IT_0006*IT_0007 + IT_0043;
    const ccomplex_t IT_0090 = (-2)*U_st_00*((IT_0001*IT_0007*IT_0020*IT_0021
      *IT_0073 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0046)*IT_0089)*conj(U_st_00
      ) + -1./2*IT_0001*IT_0005*IT_0021*IT_0088*conj(U_st_10)) + U_st_10*
      (IT_0001*IT_0005*IT_0021*IT_0088*conj(U_st_00) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0020*IT_0021*IT_0073 + m_W*IT_0000*IT_0046*IT_0089)
      *conj(U_st_10));
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0033 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001*conj(U_sb_01)*U_st_01;
    const ccomplex_t IT_0098 = -IT_0097;
    const ccomplex_t IT_0099 = (-2)*U_st_00*((IT_0001*IT_0007*IT_0020*IT_0021
      *IT_0073 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0046)*IT_0089)*conj(U_st_01
      ) + -1./2*IT_0001*IT_0005*IT_0021*IT_0088*conj(U_st_11)) + U_st_10*
      (IT_0001*IT_0005*IT_0021*IT_0088*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0020*IT_0021*IT_0073 + m_W*IT_0000*IT_0046*IT_0089)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0122 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ...
      *IT_0113 + (-3)*IT_0084*((-0.333333333333333)*IT_0087*IT_0113 + conj
      (IT_0084)*(IT_0033 + -IT_0115) + conj(IT_0109)*IT_0118) + (conj(IT_0084)
