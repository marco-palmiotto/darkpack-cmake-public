...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_2_to_Hp_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = m_t*conj(U_sb_01)*(m_t*IT_0002*IT_0005*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0003*IT_0006*conj(U_sb_01)*U_st_00 + conj
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0003*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0009*((-0.5)*IT_0004
      *IT_0007 + m_W*IT_0002*IT_0003*conj(U_sb_01)*U_st_00) + A_t*IT_0002*conj
      (U_sb_01)*U_st_10);
