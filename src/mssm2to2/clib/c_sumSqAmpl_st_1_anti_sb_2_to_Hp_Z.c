...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_2_to_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0009*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0007*IT_0010*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0009*IT_0010*U_st_10));
    const ccomplex_t IT_0012 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0003*((-0.5)*IT_0008
      *IT_0011 + m_W*IT_0006*IT_0007*conj(U_sb_01)*U_st_00) + A_t*IT_0006*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0013 = pow(m_Hp, 2);
    const ccomplex_t IT_0014 = pow(m_sb_2, 2);
    const ccomplex_t IT_0015 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_st_1*
    ...
    const ccomplex_t IT_0021 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0009*U_st_01 
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      ...
      *IT_0021 + m_W*IT_0006*IT_0007*conj(U_sb_01)*U_st_01) + A_t*IT_0006*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0023 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_st_2*
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0013 + IT_0028 + -m_sb_2*
    ...
    const ccomplex_t IT_0045 = m_t*conj(U_sb_00)*(m_t*IT_0006*IT_0009*U_st_00 
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      ...
      *IT_0045 + m_W*IT_0006*IT_0007*conj(U_sb_00)*U_st_00) + A_t*IT_0006*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0047 = cpow((-2)*s_13 + IT_0013 + IT_0028 + -m_sb_1*
