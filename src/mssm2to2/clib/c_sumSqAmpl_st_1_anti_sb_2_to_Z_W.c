        ...
        )
{
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0015 
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0024 + IT_0070 + -m_st_2*
    ...
    const ccomplex_t IT_0119 = cpow((-2)*s_23 + IT_0023 + IT_0070 + -m_sb_1*
    ...
    const ccomplex_t IT_0127 = -IT_0041 + -IT_0078;
    ...
    const ccomplex_t IT_0133 = cpow((-2)*s_23 + IT_0070 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0164 = 3*IT_0136*(0.333333333333333*IT_0066*IT_0144 +
    ...
    const ccomplex_t IT_0165 = (IT_0024 + -IT_0063)*(IT_0023 + -IT_0142);
    ...
    const ccomplex_t IT_0178 = (IT_0024 + -IT_0060)*(IT_0070 + -IT_0177);
    ...
    const ccomplex_t IT_0191 = (IT_0023 + -IT_0142)*(IT_0070 + -IT_0177);
    ...
    const ccomplex_t IT_0193 = 6*IT_0050*conj(IT_0050)*(1 + 0.5*IT_0054) +
      ...
      *IT_0104) + conj(IT_0106)*(IT_0108*IT_0112 + IT_0067*IT_0114 + IT_0101
      *IT_0115 + IT_0104*IT_0117) + IT_0090*(IT_0066*IT_0097 + IT_0103*IT_0118) 
      + conj(IT_0136)*(IT_0069*IT_0115 + IT_0112*IT_0138 + IT_0067*IT_0144 +
       IT_0146*IT_0147 + IT_0149*IT_0150) + IT_0164 + 3*IT_0106*
      (0.333333333333333*IT_0066*IT_0114 + 0.333333333333333*IT_0117*IT_0118 +
      ...
      *IT_0118*IT_0173 + IT_0161*IT_0176 + conj(IT_0111)*IT_0179 + (
      ...
      -0.333333333333333)*IT_0069*IT_0108 + IT_0050*IT_0184 + IT_0101*IT_0185 +
