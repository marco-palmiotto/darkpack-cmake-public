...
ccomplex_return_t c_sumSqAmpl_st_1_anti_sb_2_to_anti_s_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = m_t*conj(U_sb_01)*(m_t*IT_0022*IT_0025*U_st_00 
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0023*conj
      ...
      *IT_0038 + m_W*IT_0022*IT_0023*conj(U_sb_01)*U_st_00) + A_t*IT_0022*conj
      (U_sb_01)*U_st_10);
