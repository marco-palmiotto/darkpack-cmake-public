...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (-2)*U_st_00*((0.5*m_W*IT_0013*(IT_0007 + -1./3
      *IT_0006*IT_0014) + IT_0005*IT_0007*IT_0009*IT_0011*IT_0015)*conj(U_st_00)
       + -1./2*IT_0002*IT_0007*IT_0010*IT_0011*conj(U_st_10)) + U_st_10*(IT_0002
      *IT_0007*IT_0010*IT_0011*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0006
    ...
    const ccomplex_t IT_0029 = 2*U_st_00*((IT_0002*IT_0007*IT_0009*IT_0011
      *IT_0015 + (-0.5)*m_W*(IT_0007 + -1./3*IT_0006*IT_0014)*IT_0028)*conj
      (U_st_00) + 1./2*IT_0005*IT_0007*IT_0010*IT_0011*conj(U_st_10)) + U_st_10*
      (IT_0005*IT_0007*IT_0010*IT_0011*conj(U_st_00) + (-1.33333333333333)*((
    ...
    const ccomplex_t IT_0042 = m_t*e_em*mu_h*IT_0009*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0043 = IT_0007*IT_0042;
    const ccomplex_t IT_0044 = m_t*e_em*mu_h*IT_0009*conj(U_st_00)*U_st_11;
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0019 + IT_0053 + -m_st_2*
    ...
    const ccomplex_t IT_0060 = m_t*e_em*mu_h*IT_0009*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0061 = IT_0007*IT_0060;
    const ccomplex_t IT_0062 = m_t*e_em*mu_h*IT_0009*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0063 = IT_0007*IT_0062;
    const ccomplex_t IT_0064 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0065 = IT_0004*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0081 = m_t*e_em*mu_h*IT_0009*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0082 = IT_0007*IT_0081;
    const ccomplex_t IT_0083 = m_t*e_em*mu_h*IT_0009*U_st_00*conj(U_st_11);
    const ccomplex_t IT_0084 = IT_0007*IT_0083;
    const ccomplex_t IT_0085 = A_t*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0086 = IT_0004*IT_0085;
    const ccomplex_t IT_0087 = 1.4142135623731*IT_0086;
    const ccomplex_t IT_0088 = A_t*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0091 = (-0.5)*IT_0082 + 0.5*IT_0084 + (-0.5)*IT_0087 +
       0.5*IT_0090;
    const ccomplex_t IT_0092 = cpow((-2)*s_13 + IT_0019 + IT_0053 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
