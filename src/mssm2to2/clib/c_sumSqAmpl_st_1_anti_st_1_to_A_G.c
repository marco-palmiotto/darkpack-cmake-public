...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_A_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_st_1
    ...
    const ccomplex_t IT_0014 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_st_1
      *Gamma_t1 + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0064 = pow(m_st_1, 4);
