        ...
        )
{
    ...
    const ccomplex_t IT_0036 = m_t*e_em*mu_h*IT_0004*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0037 = IT_0003*IT_0036;
    const ccomplex_t IT_0038 = m_t*e_em*mu_h*IT_0004*conj(U_st_00)*U_st_11;
    ...
    const ccomplex_t IT_0046 = 0.5*IT_0037 + (-0.5)*IT_0039 + 0.5*IT_0042 + (
      -0.5)*IT_0045;
    const ccomplex_t IT_0047 = (-2)*U_st_00*((0.5*m_W*IT_0023*(IT_0003 + -1./3
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0000 + IT_0051 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0050*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = m_t*e_em*mu_h*IT_0004*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0056 = IT_0003*IT_0055;
    const ccomplex_t IT_0057 = m_t*e_em*mu_h*IT_0004*U_st_00*conj(U_st_11);
    const ccomplex_t IT_0058 = IT_0003*IT_0057;
    const ccomplex_t IT_0059 = A_t*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0060 = IT_0009*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = A_t*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0065 = (-0.5)*IT_0056 + 0.5*IT_0058 + (-0.5)*IT_0061 +
       0.5*IT_0064;
    const ccomplex_t IT_0066 = (-2)*conj(U_st_00)*((0.5*m_W*IT_0023*(IT_0003 +
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0000 + IT_0051 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = cpow(IT_0024, -1);
    const ccomplex_t IT_0074 = -e_em*IT_0003*(IT_0009*IT_0017 + -IT_0019
      *IT_0020)*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*e_em*((-0.75)*(IT_0003
      *IT_0024 + -1./3*IT_0002*IT_0073)*U_st_00*conj(U_st_00) + IT_0002*IT_0073
    ...
    const ccomplex_t IT_0080 = s_12 + IT_0051;
    const ccomplex_t IT_0081 = 0.5*IT_0074;
    const ccomplex_t IT_0082 = 1.33333333333333*IT_0075;
    const ccomplex_t IT_0083 = IT_0081*IT_0082;
    const ccomplex_t IT_0084 = IT_0080*IT_0083;
    const ccomplex_t IT_0085 = IT_0079 + IT_0084;
    const ccomplex_t IT_0086 = IT_0076*IT_0081;
    const ccomplex_t IT_0087 = IT_0080*IT_0086;
    const ccomplex_t IT_0088 = IT_0074*IT_0082;
    const ccomplex_t IT_0089 = s_23*IT_0088;
    const ccomplex_t IT_0090 = (-2)*IT_0087 + -IT_0089;
    const ccomplex_t IT_0091 = IT_0085 + IT_0090;
    const ccomplex_t IT_0092 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
      *Gamma_Z) + (-2)*IT_0051 + -reg_prop, -1);
    const ccomplex_t IT_0093 = IT_0091*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*IT_0093;
    const ccomplex_t IT_0095 = IT_0002*IT_0025;
    const ccomplex_t IT_0096 = IT_0003 + IT_0095;
    const ccomplex_t IT_0097 = cpow(IT_0020, 3);
    const ccomplex_t IT_0098 = -IT_0009;
    const ccomplex_t IT_0099 = cpow(IT_0020, 2);
    const ccomplex_t IT_0100 = (0 + _Complex_I*1)*m_W*e_em*IT_0096*(IT_0017
      *IT_0097 + IT_0098*((IT_0009*IT_0019 + -IT_0017*IT_0020)*IT_0098 + IT_0019
      *IT_0099));
    const ccomplex_t IT_0101 = 0.5*IT_0100;
    const ccomplex_t IT_0102 = IT_0016*IT_0101;
    const ccomplex_t IT_0103 = cpow((-2)*s_12 + (-2)*IT_0051 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*m_W*e_em*IT_0009*IT_0020*
      (IT_0009*IT_0019 + -IT_0017*IT_0020)*IT_0096;
    ...
    const ccomplex_t IT_0120 = IT_0032 + IT_0035 + IT_0054 + IT_0072 + IT_0094
       + -IT_0105 + -IT_0119;
