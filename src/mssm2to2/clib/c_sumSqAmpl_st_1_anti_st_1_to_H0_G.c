...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_H0_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = (-4)*s_23;
    const ccomplex_t IT_0032 = -IT_0000;
    const ccomplex_t IT_0033 = IT_0026*IT_0032;
    const ccomplex_t IT_0034 = -IT_0033;
    const ccomplex_t IT_0035 = (-4)*s_24;
    const ccomplex_t IT_0036 = (-4)*s_34;
    const ccomplex_t IT_0037 = (-4)*IT_0027*(conj(IT_0027)*IT_0028 + (-0.25)
      *conj(IT_0030)*IT_0031 + (-0.25)*conj(IT_0034)*IT_0035) + IT_0034*(conj
      (IT_0027)*IT_0035 + conj(IT_0030)*IT_0036) + (-4)*IT_0030*(IT_0019*conj
      (IT_0030) + (-0.25)*conj(IT_0027)*IT_0031 + (-0.25)*conj(IT_0034)*IT_0036);
