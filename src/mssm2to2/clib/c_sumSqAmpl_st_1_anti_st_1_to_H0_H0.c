        ...
        )
{
    ...
    const ccomplex_t IT_0026 = (-2)*U_st_00*((IT_0001*IT_0009*IT_0019*IT_0021
      *IT_0022 + (-0.166666666666667)*m_W*(IT_0007*IT_0012 + (-3)*IT_0022)
      *IT_0025)*conj(U_st_00) + -1./2*IT_0004*IT_0020*IT_0021*IT_0022*conj
      (U_st_10)) + U_st_10*(IT_0004*IT_0020*IT_0021*IT_0022*conj(U_st_00) + (
      -1.33333333333333)*(1.5*IT_0001*IT_0009*IT_0019*IT_0021*IT_0022 + m_W
      *IT_0007*IT_0012*IT_0025)*conj(U_st_10));
    ...
    const ccomplex_t IT_0042 = 2*U_st_00*((IT_0004*IT_0009*IT_0019*IT_0021
      *IT_0022 + 0.166666666666667*m_W*(IT_0007*IT_0012 + (-3)*IT_0022)*IT_0041)
      *conj(U_st_00) + 1./2*IT_0001*IT_0020*IT_0021*IT_0022*conj(U_st_10)) +
       U_st_10*(IT_0001*IT_0020*IT_0021*IT_0022*conj(U_st_00) + (
      -1.33333333333333)*((-1.5)*IT_0004*IT_0009*IT_0019*IT_0021*IT_0022 + m_W
      *IT_0007*IT_0012*IT_0041)*conj(U_st_10));
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0017 + IT_0046 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = cpow((-2)*s_23 + IT_0017 + IT_0046 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
