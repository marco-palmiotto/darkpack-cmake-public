        ...
        )
{
    ...
    const ccomplex_t IT_0053 = m_t*mu_h*IT_0035;
    const ccomplex_t IT_0054 = cpow(IT_0010, -1);
    const ccomplex_t IT_0055 = IT_0006*IT_0007;
    const ccomplex_t IT_0056 = -IT_0010*IT_0011 + IT_0055;
    const ccomplex_t IT_0057 = pow(m_t, 2);
    const ccomplex_t IT_0058 = (-2)*conj(U_st_00)*((0.5*m_W*(IT_0003 + -1./3
      *IT_0002*IT_0016)*IT_0056 + IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)
      *U_st_01 + -1./2*IT_0003*IT_0007*IT_0053*IT_0054*U_st_11) + conj(U_st_10)*
      (IT_0003*IT_0007*IT_0053*IT_0054*U_st_01 + (-1.33333333333333)*(m_W
      *IT_0002*IT_0016*IT_0056 + 1.5*IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)
      *U_st_11);
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0025 + IT_0061 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0060*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = IT_0052*IT_0064;
    const ccomplex_t IT_0066 = e_em*IT_0001*IT_0003*(IT_0006*IT_0007 + IT_0010
      *IT_0011);
    const ccomplex_t IT_0067 = -IT_0066;
    const ccomplex_t IT_0068 = IT_0003*IT_0006*IT_0054;
    const ccomplex_t IT_0069 = IT_0036*IT_0068;
    const ccomplex_t IT_0070 = IT_0038*IT_0068;
    const ccomplex_t IT_0071 = IT_0010*IT_0040;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = IT_0010*IT_0043;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = 0.5*IT_0069 + (-0.5)*IT_0070 + (-0.5)*IT_0072 +
       0.5*IT_0074;
    const ccomplex_t IT_0076 = pow(m_Z, 2);
    const ccomplex_t IT_0077 = cpow((-2)*s_12 + (-2)*IT_0025 + IT_0076 + 
      -reg_prop, -1);
    const ccomplex_t IT_0078 = IT_0075*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*IT_0078;
    const ccomplex_t IT_0080 = IT_0067*IT_0079;
    const ccomplex_t IT_0081 = 1.33333333333333*IT_0004;
    const ccomplex_t IT_0082 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0056 + IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)*conj(U_st_00)
       + -1./2*IT_0003*IT_0007*IT_0053*IT_0054*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0007*IT_0053*IT_0054*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0056 + 1.5*IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)*conj
      (U_st_10));
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_23 + IT_0061 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0089 = IT_0050 + -IT_0065 + IT_0080 + -IT_0088;
    const ccomplex_t IT_0090 = s_14*s_34*IT_0031;
    const ccomplex_t IT_0091 = -IT_0090;
    const ccomplex_t IT_0092 = s_13 + IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*conj(U_st_00)*U_st_01 + IT_0001*IT_0002*conj
      (U_st_10)*U_st_11);
    const ccomplex_t IT_0094 = 1.33333333333333*IT_0093;
    const ccomplex_t IT_0095 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0056 + IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)*conj(U_st_01)
       + -1./2*IT_0003*IT_0007*IT_0053*IT_0054*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0007*IT_0053*IT_0054*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0056 + 1.5*IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0025 + IT_0061 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0108 = (-2)*conj(U_st_00)*((0.5*m_W*(IT_0003 + -1./3
      *IT_0002*IT_0016)*IT_0056 + IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)
      *U_st_01 + -1./2*IT_0003*IT_0007*IT_0053*IT_0054*U_st_11) + conj(U_st_10)*
      (IT_0003*IT_0007*IT_0053*IT_0054*U_st_01 + (-1.33333333333333)*(m_W
      *IT_0002*IT_0016*IT_0056 + 1.5*IT_0003*IT_0011*IT_0035*IT_0054*IT_0057)
    ...
    const ccomplex_t IT_0117 = cpow((-2)*s_13 + IT_0061 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    ...
    const ccomplex_t IT_0121 = IT_0101 + IT_0107 + IT_0113 + -IT_0116 + IT_0120;
    ...
    const ccomplex_t IT_0134 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0089)*IT_0092 + conj(IT_0121)*IT_0124) + IT_0121*IT_0124
      *IT_0125 + (-3)*IT_0089*((-0.333333333333333)*IT_0092*IT_0125 + conj
      (IT_0089)*(IT_0061 + -IT_0127) + conj(IT_0121)*IT_0130) + (conj(IT_0089)
