...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = m_t*e_em*mu_h*IT_0035*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0037 = IT_0003*IT_0036;
    const ccomplex_t IT_0038 = m_t*e_em*mu_h*IT_0035*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0039 = IT_0003*IT_0038;
    const ccomplex_t IT_0040 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0041 = IT_0006*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0057 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0055 + IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)*conj(U_st_00)
       + -1./2*IT_0003*IT_0007*IT_0052*IT_0053*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0007*IT_0052*IT_0053*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
    ...
    const ccomplex_t IT_0067 = (-2)*conj(U_st_00)*((0.5*m_W*(IT_0003 + -1./3
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0025 + IT_0060 + -m_st_2*
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0025 + IT_0060 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = IT_0101*IT_0107;
    const ccomplex_t IT_0109 = IT_0064 + IT_0073 + -IT_0095 + IT_0099 + IT_0108;
    const ccomplex_t IT_0110 = s_14*s_24*IT_0031;
    const ccomplex_t IT_0111 = -IT_0110;
    const ccomplex_t IT_0112 = s_12 + IT_0111;
    const ccomplex_t IT_0113 = (-3)*conj(IT_0030);
    const ccomplex_t IT_0114 = pow(s_34, 2);
    const ccomplex_t IT_0115 = IT_0031*IT_0114;
    const ccomplex_t IT_0116 = s_24*s_34*IT_0031;
    ...
    const ccomplex_t IT_0122 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0089)*IT_0092 + conj(IT_0109)*IT_0112) + IT_0109*IT_0112
      *IT_0113 + (-3)*IT_0089*((-0.333333333333333)*IT_0092*IT_0113 + conj
      (IT_0089)*(IT_0060 + -IT_0115) + conj(IT_0109)*IT_0118) + (conj(IT_0089)
      *IT_0118 + conj(IT_0109)*(IT_0025 + -IT_0120))*IT_0121;
