...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_Z_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_st_2*
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0005*IT_0006 
      + (-3)*IT_0004*IT_0007)*U_st_00*conj(U_st_01) + IT_0005*IT_0006*U_st_10
      *conj(U_st_11));
    const ccomplex_t IT_0009 = 1.33333333333333*IT_0008;
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0005*IT_0006 
      + (-3)*IT_0004*IT_0007)*conj(U_st_00)*U_st_01 + IT_0005*IT_0006*conj
      (U_st_10)*U_st_11);
    const ccomplex_t IT_0011 = 1.33333333333333*IT_0010;
    const ccomplex_t IT_0012 = IT_0009*IT_0011;
    const ccomplex_t IT_0013 = IT_0003*IT_0012;
    const ccomplex_t IT_0014 = cpow((-2)*s_13 + IT_0000 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*IT_0014;
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0005*IT_0006 
      + (-3)*IT_0004*IT_0007)*U_st_00*conj(U_st_00) + IT_0005*IT_0006*U_st_10
      *conj(U_st_10));
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0032 = -(s_12 + -IT_0029)*(IT_0001 + -IT_0031);
    const ccomplex_t IT_0033 = pow(e_em, 2);
    const ccomplex_t IT_0034 = cpow(IT_0004, -2);
    const ccomplex_t IT_0035 = U_st_00*conj(U_st_00);
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = cpow(IT_0004, -4);
    const ccomplex_t IT_0038 = cpow(IT_0006, 2);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = IT_0035*IT_0039;
    const ccomplex_t IT_0041 = U_st_10*conj(U_st_10);
    ...
    const ccomplex_t IT_0055 = IT_0006*IT_0037*IT_0053*IT_0054;
    const ccomplex_t IT_0056 = cos(beta);
    const ccomplex_t IT_0057 = sin(alpha);
    const ccomplex_t IT_0058 = IT_0006*IT_0037*IT_0056*IT_0057;
    const ccomplex_t IT_0059 = cpow(IT_0006, -3);
    const ccomplex_t IT_0060 = IT_0053*IT_0054*IT_0059;
    const ccomplex_t IT_0061 = IT_0056*IT_0057*IT_0059;
    const ccomplex_t IT_0062 = IT_0007*IT_0034*IT_0053*IT_0054;
    const ccomplex_t IT_0063 = IT_0007*IT_0034*IT_0056*IT_0057;
    ...
    const ccomplex_t IT_0075 = 2*U_st_00*(((-0.5)*m_W*(IT_0007 + -1./3*IT_0006
      *IT_0034)*IT_0073 + IT_0007*IT_0053*IT_0068*IT_0070*IT_0074)*conj(U_st_00)
       + 1./2*IT_0007*IT_0057*IT_0069*IT_0070*conj(U_st_10)) + U_st_10*(IT_0007
      *IT_0057*IT_0069*IT_0070*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0006
      *IT_0034*IT_0073 + (-1.5)*IT_0007*IT_0053*IT_0068*IT_0070*IT_0074)*conj
      (U_st_10));
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*(e_em*IT_0075 +
       1.4142135623731*A_t*IT_0053*(conj(U_st_00)*U_st_10 + U_st_00*conj(U_st_10
      )));
    ...
    const ccomplex_t IT_0082 = IT_0006*IT_0037*IT_0053*IT_0056;
    const ccomplex_t IT_0083 = IT_0006*IT_0037*IT_0054*IT_0057;
    const ccomplex_t IT_0084 = IT_0053*IT_0056*IT_0059;
    const ccomplex_t IT_0085 = IT_0054*IT_0057*IT_0059;
    const ccomplex_t IT_0086 = IT_0007*IT_0034*IT_0053*IT_0056;
    const ccomplex_t IT_0087 = IT_0007*IT_0034*IT_0054*IT_0057;
    ...
    const ccomplex_t IT_0093 = (-2)*U_st_00*((IT_0007*IT_0057*IT_0068*IT_0070
      *IT_0074 + 0.5*m_W*(IT_0007 + -1./3*IT_0006*IT_0034)*IT_0092)*conj(U_st_00
      ) + -1./2*IT_0007*IT_0053*IT_0069*IT_0070*conj(U_st_10)) + U_st_10*
      (IT_0007*IT_0053*IT_0069*IT_0070*conj(U_st_00) + (-1.33333333333333)*(1.5
      *IT_0007*IT_0057*IT_0068*IT_0070*IT_0074 + m_W*IT_0006*IT_0034*IT_0092)
      *conj(U_st_10));
    const ccomplex_t IT_0094 = (0 + _Complex_I*-1)*(e_em*IT_0093 + (
      -1.4142135623731)*A_t*IT_0057*(conj(U_st_00)*U_st_10 + U_st_00*conj
      (U_st_10)));
    const ccomplex_t IT_0095 = (-0.5)*IT_0094;
    const ccomplex_t IT_0096 = IT_0090*IT_0095;
    const ccomplex_t IT_0097 = cpow((-2)*s_12 + (-2)*IT_0001 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0116 = -IT_0001;
    ...
    const ccomplex_t IT_0122 = -(IT_0001 + -IT_0031)*(IT_0001 + -IT_0121);
    ...
    const ccomplex_t IT_0128 = -(IT_0001 + -IT_0115)*(IT_0000 + -IT_0127);
    const ccomplex_t IT_0129 = (-3)*conj(IT_0100);
    const ccomplex_t IT_0130 = -(IT_0001 + -IT_0115)*(s_23 + -IT_0124);
