        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
    ...
    const ccomplex_t IT_0011 = cpow((-2)*s_13 + IT_0009 + IT_0010 + -m_st_2*
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_23 + IT_0009 + IT_0010 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0074 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0034)*IT_0072 + IT_0003*IT_0056*IT_0068*IT_0070*IT_0073)*conj(U_st_00)
       + -1./2*IT_0003*IT_0053*IT_0069*IT_0070*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0053*IT_0069*IT_0070*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
    ...
    const ccomplex_t IT_0078 = cpow((-2)*s_12 + (-2)*IT_0010 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0093 = 2*U_st_00*((IT_0003*IT_0053*IT_0068*IT_0070
      *IT_0073 + (-0.5)*m_W*(IT_0003 + -1./3*IT_0002*IT_0034)*IT_0092)*conj
      (U_st_00) + 1./2*IT_0003*IT_0056*IT_0069*IT_0070*conj(U_st_10)) + U_st_10*
      (IT_0003*IT_0056*IT_0069*IT_0070*conj(U_st_00) + (-1.33333333333333)*((
    ...
    const ccomplex_t IT_0116 = -IT_0010;
    ...
    const ccomplex_t IT_0122 = -(IT_0010 + -IT_0031)*(IT_0010 + -IT_0121);
    ...
    const ccomplex_t IT_0128 = -(IT_0010 + -IT_0115)*(IT_0009 + -IT_0127);
    const ccomplex_t IT_0129 = (-3)*conj(IT_0100);
    const ccomplex_t IT_0130 = -(IT_0010 + -IT_0115)*(s_23 + -IT_0124);
