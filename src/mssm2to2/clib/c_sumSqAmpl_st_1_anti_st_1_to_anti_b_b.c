        ...
        )
{
    ...
    const ccomplex_t IT_0031 = 2*U_st_00*((IT_0000*IT_0003*IT_0005*IT_0011
      *IT_0016 + (-0.5)*m_W*(IT_0005 + -1./3*IT_0004*IT_0015)*IT_0030)*conj
    ...
    const ccomplex_t IT_0065 = V_tb*e_em*conj(V_Wp2)*U_st_00;
    const ccomplex_t IT_0066 = IT_0005*IT_0065;
    const ccomplex_t IT_0067 = IT_0005*IT_0011;
    const ccomplex_t IT_0068 = m_t*V_tb*conj(V_u2)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0021 + IT_0038 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*IT_0074;
    const ccomplex_t IT_0076 = m_t*V_tb*V_u2*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0088 = m_t*V_tb*V_u1*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0093 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0099 = V_tb*e_em*conj(V_Wp1)*U_st_00;
    const ccomplex_t IT_0100 = IT_0005*IT_0099;
    const ccomplex_t IT_0101 = m_t*V_tb*conj(V_u1)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_23 + IT_0021 + IT_0038 + -m_C_1*
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0000*IT_0002*IT_0005*conj(U_st_00);
    const ccomplex_t IT_0114 = (-0.5)*IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
      *e_em*IT_0000*IT_0002*IT_0005*U_st_00;
    ...
    const ccomplex_t IT_0145 = IT_0021*IT_0038;
    ...
    const ccomplex_t IT_0160 = m_b*IT_0080;
    const ccomplex_t IT_0161 = m_b*IT_0084;
    const ccomplex_t IT_0162 = -IT_0161;
    const ccomplex_t IT_0163 = IT_0160 + IT_0162;
    const ccomplex_t IT_0164 = IT_0075*IT_0163;
    const ccomplex_t IT_0165 = m_b*IT_0092;
    const ccomplex_t IT_0166 = m_b*IT_0096;
    ...
    const ccomplex_t IT_0196 = m_b*e_em*IT_0000*IT_0002*IT_0005*IT_0010;
    ...
    const ccomplex_t IT_0210 = cpow((-2)*s_12 + (-2)*IT_0021 + m_A0*(m_A0 + (0
       + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0211 = IT_0209*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*IT_0211;
    const ccomplex_t IT_0213 = m_b*e_em*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0230 = m_b*IT_0229;
    ...
    const ccomplex_t IT_0249 = m_b*s_13;
    ...
    const ccomplex_t IT_0265 = IT_0194*IT_0240 + IT_0195*IT_0241 + IT_0239
      ...
      *IT_0058 + IT_0156 + IT_0174 + IT_0235 + IT_0251 + IT_0252 + IT_0256 +
       IT_0264);
    const ccomplex_t IT_0266 = m_b*s_14;
