...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_anti_b_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0065 = V_tb*e_em*conj(V_Wp1)*U_st_00;
    const ccomplex_t IT_0066 = IT_0005*IT_0065;
    const ccomplex_t IT_0067 = IT_0005*IT_0011;
    const ccomplex_t IT_0068 = m_t*V_tb*conj(V_u1)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0021 + IT_0060 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*IT_0074;
    const ccomplex_t IT_0076 = m_t*V_tb*V_u1*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0081 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0088 = m_t*V_tb*V_u2*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0093 = V_tb*e_em*V_Wp2*conj(U_st_00);
    ...
    const ccomplex_t IT_0099 = V_tb*e_em*conj(V_Wp2)*U_st_00;
    const ccomplex_t IT_0100 = IT_0005*IT_0099;
    const ccomplex_t IT_0101 = m_t*V_tb*conj(V_u2)*e_em*IT_0000*U_st_10;
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0000*IT_0002*IT_0005*conj(U_st_00);
    const ccomplex_t IT_0114 = (-0.5)*IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
    ...
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0000*IT_0002*IT_0005*conj(U_st_00);
    const ccomplex_t IT_0121 = (-0.5)*IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0000*IT_0002*IT_0005*U_st_00;
    ...
    const ccomplex_t IT_0138 = cpow(s_12 + IT_0021 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0145 = IT_0021*IT_0060;
    ...
    const ccomplex_t IT_0163 = m_b*IT_0092;
    const ccomplex_t IT_0164 = m_b*IT_0096;
    const ccomplex_t IT_0165 = -IT_0164;
    const ccomplex_t IT_0166 = IT_0163 + IT_0165;
    const ccomplex_t IT_0167 = IT_0108*IT_0166;
    const ccomplex_t IT_0168 = m_b*IT_0080;
    const ccomplex_t IT_0169 = m_b*IT_0084;
    const ccomplex_t IT_0170 = -IT_0169;
    const ccomplex_t IT_0171 = IT_0168 + IT_0170;
    const ccomplex_t IT_0172 = IT_0075*IT_0171;
    ...
    const ccomplex_t IT_0179 = IT_0072*IT_0114;
    const ccomplex_t IT_0180 = IT_0073*IT_0157*IT_0179;
    const ccomplex_t IT_0181 = IT_0105*IT_0121;
    const ccomplex_t IT_0182 = IT_0106*IT_0160*IT_0181;
    const ccomplex_t IT_0183 = m_b*IT_0119;
    const ccomplex_t IT_0184 = m_b*IT_0126;
    ...
    const ccomplex_t IT_0196 = (-6)*IT_0145;
    const ccomplex_t IT_0197 = IT_0129 + IT_0131 + IT_0196;
    ...
    const ccomplex_t IT_0203 = -IT_0142;
    const ccomplex_t IT_0204 = (-18)*IT_0145;
    const ccomplex_t IT_0205 = IT_0133 + IT_0134 + IT_0204;
    const ccomplex_t IT_0206 = 36*s_34;
    const ccomplex_t IT_0207 = m_b*e_em*IT_0000*IT_0002*IT_0005*IT_0010;
    ...
    const ccomplex_t IT_0224 = m_b*e_em*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0250 = m_b*s_13;
    ...
    const ccomplex_t IT_0265 = IT_0194*IT_0199 + IT_0195*IT_0200 + IT_0198
      *IT_0261 + IT_0202*IT_0262 + IT_0142*((-12)*IT_0037 + 12*conj(IT_0037) + (
    ...
    const ccomplex_t IT_0274 = m_b*s_14;
    ...
    const ccomplex_t IT_0276 = (conj(IT_0037)*(IT_0057 + IT_0058) + IT_0037*
      ...
      *IT_0132 + (IT_0064*conj(IT_0064) + IT_0110*conj(IT_0110) + IT_0112*conj
      (IT_0112) + IT_0127*conj(IT_0127))*IT_0135 + -IT_0143*IT_0148 + (-2)
      *IT_0155*(IT_0142*((-12)*IT_0128 + 24*IT_0130 + (-12)*IT_0145) + 0.5
      *IT_0148*IT_0155) + IT_0059*(IT_0057*conj(IT_0057) + IT_0058*conj(IT_0058)
      ...
      *IT_0175 + IT_0057*IT_0178 + conj(IT_0185)*IT_0188 + IT_0185*IT_0191) + 
      ...
      (IT_0185))*IT_0194 + (IT_0173 + IT_0185)*IT_0195) + IT_0197*(IT_0142
      *IT_0198 + IT_0155*IT_0199 + IT_0200*IT_0201 + IT_0202*IT_0203) + (IT_0155
      *IT_0198 + IT_0142*IT_0199 + IT_0201*IT_0202 + IT_0200*IT_0203)*IT_0205 +
      ...
      *IT_0257 + IT_0260*IT_0265 + (-6)*IT_0145*((conj(IT_0064) + 3*conj(IT_0110
