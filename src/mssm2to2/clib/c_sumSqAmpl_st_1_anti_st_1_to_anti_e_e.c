        ...
        )
{
    ...
    const ccomplex_t IT_0024 = m_e*s_14;
    const ccomplex_t IT_0025 = IT_0007*IT_0013;
    const ccomplex_t IT_0026 = -IT_0025;
    const ccomplex_t IT_0027 = pow(m_e, 2);
    const ccomplex_t IT_0028 = IT_0010*IT_0027;
    const ccomplex_t IT_0029 = IT_0007*IT_0021;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*m_e*e_em*IT_0003*IT_0032
      *IT_0034*IT_0038;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = IT_0033*IT_0038;
    const ccomplex_t IT_0057 = IT_0035*IT_0040;
    const ccomplex_t IT_0058 = IT_0056 + IT_0057;
    const ccomplex_t IT_0059 = 2*U_st_00*((IT_0003*IT_0032*IT_0035*IT_0041
    ...
    const ccomplex_t IT_0069 = -IT_0023;
    const ccomplex_t IT_0070 = -IT_0027;
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_12 + (-2)*IT_0010 + IT_0088 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_12 + (-2)*IT_0010 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0108 = s_34 + IT_0027;
    ...
    const ccomplex_t IT_0115 = cpow(s_12 + IT_0010 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0120 = s_34*IT_0010;
    ...
    const ccomplex_t IT_0125 = 6*IT_0068*(IT_0023 + -conj(IT_0023) + 2*IT_0065
       + (-2)*conj(IT_0065) + -conj(IT_0069) + -IT_0110) + IT_0118*((-12)
      *IT_0028 + 24*IT_0119 + (-12)*IT_0120) + (IT_0026 + -conj(IT_0026) +
       IT_0030 + -conj(IT_0030))*IT_0124;
    ...
    const ccomplex_t IT_0131 = (-6)*IT_0030;
    const ccomplex_t IT_0132 = 0.166666666666667*IT_0024;
    const ccomplex_t IT_0133 = 6*s_34;
    const ccomplex_t IT_0134 = IT_0065*IT_0071;
    const ccomplex_t IT_0135 = (IT_0023*IT_0024 + IT_0026*IT_0028)*IT_0031 + 6
      *conj(IT_0065)*((IT_0026 + IT_0030)*IT_0068 + (IT_0023 + IT_0069)*IT_0071 
      + 0.166666666666667*IT_0065*((-12)*IT_0027 + IT_0072)) + (-6)*conj(IT_0105
      )*((-0.166666666666667)*(12*IT_0027 + IT_0072)*IT_0105 + -(IT_0026 + 
      -IT_0030)*IT_0107 + -IT_0108*(IT_0023 + IT_0110)) + -IT_0118*IT_0125 +
       IT_0126*(IT_0024*IT_0026 + IT_0023*IT_0027 + IT_0127) + (-6)*conj(IT_0030
      )*(IT_0105*IT_0107 + -IT_0069*IT_0128 + (-0.166666666666667)*IT_0030
      *IT_0129 + -IT_0130) + 6*conj(IT_0026)*(IT_0105*IT_0107 + IT_0023*IT_0128 
      + 0.166666666666667*IT_0026*IT_0129 + IT_0130 + 0.166666666666667*IT_0028
      *IT_0131 + IT_0109*IT_0132) + 6*conj(IT_0023)*(0.166666666666667*IT_0027
      *IT_0109 + IT_0127 + IT_0026*IT_0128 + IT_0131*IT_0132 + 0.166666666666667
      *IT_0023*IT_0133 + IT_0134) + 6*conj(IT_0069)*(IT_0030*IT_0128 +
