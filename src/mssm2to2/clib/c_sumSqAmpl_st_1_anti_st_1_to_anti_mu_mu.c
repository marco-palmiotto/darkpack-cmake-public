...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = 0.666666666666667*IT_0004;
    const ccomplex_t IT_0025 = m_mu*IT_0024;
    const ccomplex_t IT_0026 = m_mu*IT_0005;
    const ccomplex_t IT_0027 = -(IT_0010 + -IT_0023)*(IT_0025 + -IT_0026);
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0033
      *IT_0035*IT_0036;
    const ccomplex_t IT_0038 = 0.5*IT_0037;
    const ccomplex_t IT_0039 = cos(alpha);
    const ccomplex_t IT_0040 = m_t*mu_h*IT_0033;
    ...
    const ccomplex_t IT_0048 = 2*U_st_00*(((-0.5)*m_W*IT_0045*(IT_0003 + -1./3
      *IT_0002*IT_0046) + IT_0003*IT_0033*IT_0039*IT_0042*IT_0047)*conj(U_st_00)
       + 1./2*IT_0003*IT_0036*IT_0040*IT_0042*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0036*IT_0040*IT_0042*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0045*IT_0046 + (-1.5)*IT_0003*IT_0033*IT_0039*IT_0042*IT_0047)*conj
      (U_st_10));
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*(e_em*IT_0048 +
       1.4142135623731*A_t*IT_0039*(conj(U_st_00)*U_st_10 + U_st_00*conj(U_st_10
      )));
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0033
      *IT_0035*IT_0039;
    const ccomplex_t IT_0056 = (-0.5)*IT_0055;
    const ccomplex_t IT_0057 = IT_0034*IT_0039;
    const ccomplex_t IT_0058 = -IT_0036*IT_0041 + IT_0057;
    const ccomplex_t IT_0059 = (-2)*U_st_00*((IT_0003*IT_0033*IT_0036*IT_0042
      *IT_0047 + 0.5*m_W*(IT_0003 + -1./3*IT_0002*IT_0046)*IT_0058)*conj(U_st_00
      ) + -1./2*IT_0003*IT_0039*IT_0040*IT_0042*conj(U_st_10)) + U_st_10*
      (IT_0003*IT_0039*IT_0040*IT_0042*conj(U_st_00) + (-1.33333333333333)*(1.5
      *IT_0003*IT_0033*IT_0036*IT_0042*IT_0047 + m_W*IT_0002*IT_0046*IT_0058)
      *conj(U_st_10));
    const ccomplex_t IT_0060 = (0 + _Complex_I*-1)*(e_em*IT_0059 + (
      -1.4142135623731)*A_t*IT_0036*(conj(U_st_00)*U_st_10 + U_st_00*conj
      (U_st_10)));
    const ccomplex_t IT_0061 = (-0.5)*IT_0060;
    const ccomplex_t IT_0062 = IT_0056*IT_0061;
    const ccomplex_t IT_0063 = cpow((-2)*s_12 + (-2)*IT_0007 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0069 = m_mu*IT_0068;
    const ccomplex_t IT_0070 = -IT_0013;
    const ccomplex_t IT_0071 = s_34 + IT_0070;
    const ccomplex_t IT_0072 = 12*s_34;
    const ccomplex_t IT_0073 = e_em*m_mu*IT_0003*IT_0033*IT_0035*IT_0041;
    const ccomplex_t IT_0074 = (-0.5)*IT_0073;
    const ccomplex_t IT_0075 = m_t*e_em*mu_h*IT_0033*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0076 = IT_0003*IT_0075;
    const ccomplex_t IT_0077 = m_t*e_em*mu_h*IT_0033*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0078 = IT_0003*IT_0077;
    const ccomplex_t IT_0079 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0080 = IT_0034*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0090 = e_em*m_mu*IT_0003*IT_0033;
    const ccomplex_t IT_0091 = 0.5*IT_0090;
    const ccomplex_t IT_0092 = IT_0003*IT_0034*IT_0042;
    const ccomplex_t IT_0093 = IT_0075*IT_0092;
    const ccomplex_t IT_0094 = IT_0077*IT_0092;
    const ccomplex_t IT_0095 = IT_0041*IT_0079;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = IT_0041*IT_0082;
    ...
    const ccomplex_t IT_0102 = cpow((-2)*s_12 + (-2)*IT_0007 + IT_0101 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0107 = (-6)*conj(IT_0028);
    ...
    const ccomplex_t IT_0126 = IT_0118*((-12)*IT_0014 + 24*IT_0119 + (-12)
      *IT_0120) + (-6)*IT_0069*(conj(IT_0028) + -IT_0029 + conj(IT_0029) + (-2)
      *IT_0066 + 2*conj(IT_0066) + 0.166666666666667*IT_0121) + (IT_0012 +
       IT_0031 + -conj(IT_0031) + IT_0110)*IT_0125;
    const ccomplex_t IT_0127 = conj(IT_0105)*IT_0106;
    const ccomplex_t IT_0128 = m_mu*s_13;
    const ccomplex_t IT_0129 = IT_0122 + IT_0124;
    const ccomplex_t IT_0130 = conj(IT_0066)*IT_0069;
    const ccomplex_t IT_0131 = (-6)*conj(IT_0031);
    const ccomplex_t IT_0132 = 0.166666666666667*IT_0015;
    const ccomplex_t IT_0133 = 6*s_34;
    const ccomplex_t IT_0134 = conj(IT_0066)*IT_0071;
    const ccomplex_t IT_0135 = (conj(IT_0012)*IT_0014 + IT_0015*conj(IT_0029))
      *IT_0032 + 6*IT_0066*((conj(IT_0012) + conj(IT_0031))*IT_0069 + (conj
      (IT_0028) + conj(IT_0029))*IT_0071 + 0.166666666666667*conj(IT_0066)*((-12
      )*IT_0013 + IT_0072)) + 6*IT_0105*(0.166666666666667*(12*IT_0013 + IT_0072
      )*conj(IT_0105) + IT_0106*(conj(IT_0029) + 0.166666666666667*IT_0107) + 
      -IT_0109*(conj(IT_0031) + IT_0110)) + -IT_0118*IT_0126 + IT_0121*(conj
      (IT_0012)*IT_0015 + IT_0013*conj(IT_0029) + IT_0127) + (-6)*IT_0031*(conj
      (IT_0105)*IT_0109 + -conj(IT_0028)*IT_0128 + (-0.166666666666667)*conj
      (IT_0031)*IT_0129 + -IT_0130) + 6*IT_0012*(conj(IT_0105)*IT_0109 + conj
      (IT_0029)*IT_0128 + 0.166666666666667*conj(IT_0012)*IT_0129 + IT_0130 +
       0.166666666666667*IT_0014*IT_0131 + IT_0107*IT_0132) + 6*IT_0028*(conj
      (IT_0031)*IT_0128 + 0.166666666666667*conj(IT_0028)*IT_0133 + IT_0134) + 6
      *IT_0029*(0.166666666666667*IT_0013*IT_0107 + IT_0127 + conj(IT_0012)
      *IT_0128 + IT_0131*IT_0132 + 0.166666666666667*conj(IT_0029)*IT_0133 +
       IT_0134);
