        ...
        )
{
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*e_em*m_mu*IT_0000*IT_0002
      *IT_0005*IT_0008;
    ...
    const ccomplex_t IT_0070 = e_em*m_mu*IT_0000*IT_0002*IT_0005*IT_0010;
    ...
    const ccomplex_t IT_0087 = e_em*m_mu*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0121 = (-6)*IT_0107;
    const ccomplex_t IT_0122 = 12*IT_0118;
    const ccomplex_t IT_0123 = IT_0120 + IT_0121 + IT_0122;
    const ccomplex_t IT_0124 = 6*conj(IT_0067);
    const ccomplex_t IT_0125 = IT_0117*((-12)*IT_0107 + 24*IT_0118 + (-12)
      *IT_0119) + (IT_0052 + -conj(IT_0052) + IT_0057 + -conj(IT_0057))*IT_0123 
    ...
    const ccomplex_t IT_0135 = conj(IT_0037)*(IT_0037*(12*s_34 + (-12)*IT_0038
      ...
      *IT_0107 + IT_0067*IT_0108)*IT_0109 + -IT_0117*IT_0125 + (-6)*conj(IT_0052
      )*(IT_0102*IT_0104 + -IT_0065*IT_0126 + (-0.166666666666667)*IT_0052
      *IT_0127 + -IT_0128) + 6*conj(IT_0057)*(IT_0102*IT_0104 + IT_0067*IT_0126 
      + 0.166666666666667*IT_0057*IT_0127 + IT_0128 + 0.166666666666667*IT_0107
      *IT_0129 + IT_0106*IT_0130) + 6*conj(IT_0065)*(IT_0052*IT_0126 +
       0.166666666666667*IT_0065*IT_0131 + IT_0132) + IT_0133*(IT_0038*IT_0067 +
       IT_0057*IT_0108 + IT_0134) + IT_0124*(0.166666666666667*IT_0038*IT_0106 +
       IT_0057*IT_0126 + IT_0129*IT_0130 + 0.166666666666667*IT_0067*IT_0131 +
       IT_0132 + IT_0134);
