...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_h_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = (-3)*IT_0028*(conj(IT_0028)*IT_0029 + (
      -0.333333333333333)*conj(IT_0031)*IT_0032 + (-0.333333333333333)*conj
      (IT_0035)*IT_0036) + IT_0035*(conj(IT_0028)*IT_0036 + conj(IT_0031)
      *IT_0037) + (-3)*IT_0031*(IT_0020*conj(IT_0031) + (-0.333333333333333)
      *conj(IT_0028)*IT_0032 + (-0.333333333333333)*conj(IT_0035)*IT_0037);
