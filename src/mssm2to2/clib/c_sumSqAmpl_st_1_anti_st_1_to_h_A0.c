        ...
        )
{
    ...
    const ccomplex_t IT_0013 = m_t*e_em*mu_h*IT_0012*conj(U_st_00)*U_st_10;
    ...
    const ccomplex_t IT_0017 = m_t*e_em*mu_h*IT_0012*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0018 = IT_0015*IT_0017;
    const ccomplex_t IT_0019 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0020 = IT_0007*IT_0019;
    const ccomplex_t IT_0021 = 1.4142135623731*IT_0020;
    const ccomplex_t IT_0022 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*e_em*((-0.75)*(IT_0000
      *IT_0004 + -1./3*IT_0002*IT_0032)*U_st_00*conj(U_st_00) + IT_0002*IT_0032
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_12 + (-2)*IT_0028 + m_A0*(m_A0 + (0
       + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0004*IT_0013;
    const ccomplex_t IT_0056 = IT_0004*IT_0017;
    const ccomplex_t IT_0057 = IT_0006*IT_0019;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = IT_0006*IT_0022;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = (-0.5)*IT_0055 + 0.5*IT_0056 + (-0.5)*IT_0058 +
       0.5*IT_0060;
    const ccomplex_t IT_0062 = cpow(IT_0007, 3);
    const ccomplex_t IT_0063 = cpow(IT_0007, 2);
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*m_W*e_em*IT_0005*(IT_0008
      *IT_0062 + -IT_0006*(IT_0006*(IT_0007*IT_0008 + IT_0006*IT_0009) + 
      -IT_0009*IT_0063));
    ...
    const ccomplex_t IT_0069 = pow(m_h, 2);
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0069 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    const ccomplex_t IT_0071 = m_t*mu_h*IT_0012;
    const ccomplex_t IT_0072 = IT_0006*IT_0009;
    const ccomplex_t IT_0073 = IT_0007*IT_0008;
    const ccomplex_t IT_0074 = IT_0072 + IT_0073;
    const ccomplex_t IT_0075 = pow(m_t, 2);
    const ccomplex_t IT_0076 = 2*U_st_00*((0.166666666666667*m_W*(IT_0001
      *IT_0002 + (-3)*IT_0004)*IT_0074 + IT_0004*IT_0008*IT_0012*IT_0014*IT_0075
      )*conj(U_st_00) + 1./2*IT_0004*IT_0009*IT_0014*IT_0071*conj(U_st_10)) +
       U_st_10*(IT_0004*IT_0009*IT_0014*IT_0071*conj(U_st_00) + (
      -1.33333333333333)*(m_W*IT_0001*IT_0002*IT_0074 + (-1.5)*IT_0004*IT_0008
      *IT_0012*IT_0014*IT_0075)*conj(U_st_10));
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0069 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    const ccomplex_t IT_0083 = IT_0079*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*IT_0083;
    const ccomplex_t IT_0085 = m_t*e_em*mu_h*IT_0012*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0086 = IT_0004*IT_0085;
    const ccomplex_t IT_0087 = m_t*e_em*mu_h*IT_0012*U_st_00*conj(U_st_11);
    const ccomplex_t IT_0088 = IT_0004*IT_0087;
    const ccomplex_t IT_0089 = A_t*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0090 = IT_0006*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = A_t*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0095 = (-0.5)*IT_0086 + 0.5*IT_0088 + (-0.5)*IT_0091 +
       0.5*IT_0094;
    const ccomplex_t IT_0096 = 2*conj(U_st_00)*((0.166666666666667*m_W*
      (IT_0001*IT_0002 + (-3)*IT_0004)*IT_0074 + IT_0004*IT_0008*IT_0012*IT_0014
      *IT_0075)*U_st_01 + 1./2*IT_0004*IT_0009*IT_0014*IT_0071*U_st_11) + conj
      (U_st_10)*(IT_0004*IT_0009*IT_0014*IT_0071*U_st_01 + (-1.33333333333333)*
      (m_W*IT_0001*IT_0002*IT_0074 + (-1.5)*IT_0004*IT_0008*IT_0012*IT_0014
      *IT_0075)*U_st_11);
    ...
    const ccomplex_t IT_0100 = cpow((-2)*s_23 + IT_0028 + IT_0069 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0101 = IT_0099*IT_0100;
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*IT_0101;
    const ccomplex_t IT_0103 = m_t*e_em*mu_h*IT_0012*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0104 = IT_0004*IT_0103;
    const ccomplex_t IT_0105 = m_t*e_em*mu_h*IT_0012*conj(U_st_00)*U_st_11;
    const ccomplex_t IT_0106 = IT_0004*IT_0105;
    const ccomplex_t IT_0107 = A_t*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0108 = IT_0006*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = A_t*conj(U_st_00)*U_st_11;
    const ccomplex_t IT_0111 = IT_0006*IT_0110;
    const ccomplex_t IT_0112 = 1.4142135623731*IT_0111;
    const ccomplex_t IT_0113 = 0.5*IT_0104 + (-0.5)*IT_0106 + 0.5*IT_0109 + (
      -0.5)*IT_0112;
    const ccomplex_t IT_0114 = 2*U_st_00*((0.166666666666667*m_W*(IT_0001
      *IT_0002 + (-3)*IT_0004)*IT_0074 + IT_0004*IT_0008*IT_0012*IT_0014*IT_0075
      )*conj(U_st_01) + 1./2*IT_0004*IT_0009*IT_0014*IT_0071*conj(U_st_11)) +
       U_st_10*(IT_0004*IT_0009*IT_0014*IT_0071*conj(U_st_01) + (
      -1.33333333333333)*(m_W*IT_0001*IT_0002*IT_0074 + (-1.5)*IT_0004*IT_0008
      *IT_0012*IT_0014*IT_0075)*conj(U_st_11));
    ...
    const ccomplex_t IT_0118 = cpow((-2)*s_13 + IT_0028 + IT_0069 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0119 = IT_0117*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*IT_0119;
    const ccomplex_t IT_0121 = -IT_0031 + (-2)*IT_0053 + -IT_0068 + IT_0081 +
