...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_h_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = 2*U_st_00*(((-0.5)*m_W*IT_0013*(IT_0009 + -1./3
      *IT_0008*IT_0015) + IT_0002*IT_0003*IT_0006*IT_0009*IT_0016)*conj(U_st_00)
       + 1./2*IT_0004*IT_0006*IT_0007*IT_0009*conj(U_st_10)) + U_st_10*(IT_0004
      *IT_0006*IT_0007*IT_0009*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0008
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_23 + IT_0020 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    const ccomplex_t IT_0022 = IT_0019*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*IT_0022;
    const ccomplex_t IT_0024 = cpow((-2)*s_13 + IT_0020 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    ...
    const ccomplex_t IT_0032 = (-4)*s_23;
    const ccomplex_t IT_0033 = -IT_0000;
    const ccomplex_t IT_0034 = IT_0027*IT_0033;
    const ccomplex_t IT_0035 = -IT_0034;
    const ccomplex_t IT_0036 = (-4)*s_24;
    const ccomplex_t IT_0037 = (-4)*s_34;
    const ccomplex_t IT_0038 = (-4)*IT_0028*(conj(IT_0028)*IT_0029 + (-0.25)
      *conj(IT_0031)*IT_0032 + (-0.25)*conj(IT_0035)*IT_0036) + IT_0035*(conj
      (IT_0028)*IT_0036 + conj(IT_0031)*IT_0037) + (-4)*IT_0031*(IT_0020*conj
      (IT_0031) + (-0.25)*conj(IT_0028)*IT_0032 + (-0.25)*conj(IT_0035)*IT_0037);
