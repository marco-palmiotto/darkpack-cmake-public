        ...
        )
{
    ...
    const ccomplex_t IT_0037 = m_t*e_em*mu_h*IT_0036*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0038 = IT_0003*IT_0037;
    const ccomplex_t IT_0039 = m_t*e_em*mu_h*IT_0036*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0040 = IT_0003*IT_0039;
    const ccomplex_t IT_0041 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0042 = IT_0011*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0059 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0057 + IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj(U_st_00)
       + 1./2*IT_0003*IT_0012*IT_0053*IT_0054*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0012*IT_0053*IT_0054*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
    ...
    const ccomplex_t IT_0069 = 2*conj(U_st_00)*(((-0.5)*m_W*(IT_0003 + -1./3
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0025 + IT_0062 + -m_st_2*
    ...
    const ccomplex_t IT_0104 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
    ...
    const ccomplex_t IT_0123 = (-3)*IT_0111;
    const ccomplex_t IT_0124 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0091)*IT_0094 + conj(IT_0111)*IT_0114) + IT_0111*IT_0114
      *IT_0115 + (-3)*IT_0091*((-0.333333333333333)*IT_0094*IT_0115 + conj
      (IT_0091)*(IT_0062 + -IT_0117) + conj(IT_0111)*IT_0120) + (conj(IT_0091)
      *IT_0120 + conj(IT_0111)*(IT_0025 + -IT_0122))*IT_0123;
