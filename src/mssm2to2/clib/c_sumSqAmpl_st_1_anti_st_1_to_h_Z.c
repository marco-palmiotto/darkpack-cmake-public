...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_1_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0034 = 1.33333333333333*IT_0004;
    const ccomplex_t IT_0035 = pow(m_W, -1);
    const ccomplex_t IT_0036 = m_t*mu_h*IT_0035;
    const ccomplex_t IT_0037 = cpow(IT_0009, -1);
    const ccomplex_t IT_0038 = IT_0011*IT_0012;
    const ccomplex_t IT_0039 = IT_0007*IT_0009;
    const ccomplex_t IT_0040 = IT_0038 + IT_0039;
    const ccomplex_t IT_0041 = pow(m_t, 2);
    const ccomplex_t IT_0042 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0040 + IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)*conj(U_st_00)
       + 1./2*IT_0003*IT_0012*IT_0036*IT_0037*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0012*IT_0036*IT_0037*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0040 + (-1.5)*IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)*conj
      (U_st_10));
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*U_st_00*conj(U_st_01) + IT_0001*IT_0002*U_st_10
      *conj(U_st_11));
    const ccomplex_t IT_0051 = 1.33333333333333*IT_0050;
    const ccomplex_t IT_0052 = 2*conj(U_st_00)*(((-0.5)*m_W*(IT_0003 + -1./3
      *IT_0002*IT_0017)*IT_0040 + IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)
      *U_st_01 + 1./2*IT_0003*IT_0012*IT_0036*IT_0037*U_st_11) + conj(U_st_10)*
      (IT_0003*IT_0012*IT_0036*IT_0037*U_st_01 + (-1.33333333333333)*(m_W
      *IT_0002*IT_0017*IT_0040 + (-1.5)*IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)
      *U_st_11);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*(e_em*IT_0052 +
       1.4142135623731*A_t*IT_0007*(U_st_01*conj(U_st_10) + conj(U_st_00)
      *U_st_11));
    const ccomplex_t IT_0054 = (-0.5)*IT_0053;
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0025 + IT_0045 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0056 = IT_0054*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = IT_0051*IT_0057;
    const ccomplex_t IT_0059 = e_em*IT_0001*IT_0003*(IT_0007*IT_0011 + IT_0009
      *IT_0012);
    const ccomplex_t IT_0060 = -IT_0059;
    const ccomplex_t IT_0061 = m_t*e_em*mu_h*IT_0035*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0062 = IT_0003*IT_0061;
    const ccomplex_t IT_0063 = m_t*e_em*mu_h*IT_0035*U_st_00*conj(U_st_10);
    const ccomplex_t IT_0064 = IT_0003*IT_0063;
    const ccomplex_t IT_0065 = A_t*conj(U_st_00)*U_st_10;
    const ccomplex_t IT_0066 = IT_0011*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = A_t*U_st_00*conj(U_st_10);
    ...
    const ccomplex_t IT_0071 = (-0.5)*IT_0062 + 0.5*IT_0064 + (-0.5)*IT_0067 +
       0.5*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_12 + (-2)*IT_0025 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0078 = IT_0003*IT_0011*IT_0037;
    const ccomplex_t IT_0079 = IT_0061*IT_0078;
    const ccomplex_t IT_0080 = IT_0063*IT_0078;
    const ccomplex_t IT_0081 = IT_0009*IT_0065;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = IT_0009*IT_0068;
    ...
    const ccomplex_t IT_0091 = -IT_0049 + -IT_0058 + IT_0075 + IT_0090;
    const ccomplex_t IT_0092 = s_14*s_34*IT_0031;
    const ccomplex_t IT_0093 = -IT_0092;
    const ccomplex_t IT_0094 = s_13 + IT_0093;
    const ccomplex_t IT_0095 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0040 + IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)*conj(U_st_00)
       + 1./2*IT_0003*IT_0012*IT_0036*IT_0037*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0012*IT_0036*IT_0037*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0040 + (-1.5)*IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)*conj
    ...
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0045 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    ...
    const ccomplex_t IT_0102 = IT_0046*IT_0097;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*IT_0102;
    const ccomplex_t IT_0104 = IT_0034*IT_0103;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*conj(U_st_00)*U_st_01 + IT_0001*IT_0002*conj
      (U_st_10)*U_st_11);
    const ccomplex_t IT_0106 = 1.33333333333333*IT_0105;
    const ccomplex_t IT_0107 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0040 + IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)*conj(U_st_01)
       + 1./2*IT_0003*IT_0012*IT_0036*IT_0037*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0012*IT_0036*IT_0037*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0040 + (-1.5)*IT_0003*IT_0007*IT_0035*IT_0037*IT_0041)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0110 = cpow((-2)*s_13 + IT_0025 + IT_0045 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    ...
    const ccomplex_t IT_0114 = -IT_0034;
    const ccomplex_t IT_0115 = IT_0005 + IT_0114;
    const ccomplex_t IT_0116 = IT_0028*IT_0115;
    const ccomplex_t IT_0117 = IT_0058 + IT_0101 + IT_0104 + IT_0113 + -IT_0116;
    const ccomplex_t IT_0118 = s_14*s_24*IT_0031;
    const ccomplex_t IT_0119 = -IT_0118;
    const ccomplex_t IT_0120 = s_12 + IT_0119;
    const ccomplex_t IT_0121 = (-3)*conj(IT_0030);
    const ccomplex_t IT_0122 = pow(s_34, 2);
    const ccomplex_t IT_0123 = IT_0031*IT_0122;
    const ccomplex_t IT_0124 = s_24*s_34*IT_0031;
    const ccomplex_t IT_0125 = -IT_0124;
    const ccomplex_t IT_0126 = s_23 + IT_0125;
    const ccomplex_t IT_0127 = pow(s_24, 2);
    const ccomplex_t IT_0128 = IT_0031*IT_0127;
    const ccomplex_t IT_0129 = (-3)*IT_0117;
    const ccomplex_t IT_0130 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0091)*IT_0094 + conj(IT_0117)*IT_0120) + IT_0117*IT_0120
      *IT_0121 + (-3)*IT_0091*((-0.333333333333333)*IT_0094*IT_0121 + conj
      (IT_0091)*(IT_0045 + -IT_0123) + conj(IT_0117)*IT_0126) + (conj(IT_0091)
      *IT_0126 + conj(IT_0117)*(IT_0025 + -IT_0128))*IT_0129;
