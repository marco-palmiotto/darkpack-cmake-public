        ...
        )
{
    ...
    const ccomplex_t IT_0027 = 2*U_st_00*((IT_0005*IT_0009*IT_0019*IT_0021
      *IT_0022 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0022)*IT_0026)
      *conj(U_st_00) + 1./2*IT_0003*IT_0020*IT_0021*IT_0022*conj(U_st_10)) +
       U_st_10*(IT_0003*IT_0020*IT_0021*IT_0022*conj(U_st_00) + (
      -1.33333333333333)*((-1.5)*IT_0005*IT_0009*IT_0019*IT_0021*IT_0022 + m_W
      *IT_0002*IT_0012*IT_0026)*conj(U_st_10));
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0017 + IT_0035 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0037 = 2*U_st_00*((IT_0005*IT_0009*IT_0019*IT_0021
      *IT_0022 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0022)*IT_0026)
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*(e_em*IT_0037 +
       1.4142135623731*A_t*IT_0005*(conj(U_st_01)*U_st_10 + U_st_00*conj(U_st_11
      )));
    const ccomplex_t IT_0039 = (-0.5)*IT_0038;
    const ccomplex_t IT_0040 = 2*conj(U_st_00)*((IT_0005*IT_0009*IT_0019
    ...
    const ccomplex_t IT_0047 = IT_0002*IT_0012;
    const ccomplex_t IT_0048 = IT_0022 + IT_0047;
    const ccomplex_t IT_0049 = cpow(IT_0003, 3);
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*m_W*e_em*IT_0048*(IT_0005*
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_12 + (-2)*IT_0035 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0056 = (0 + _Complex_I*-5)*m_W*e_em*IT_0048*(IT_0005*
      (IT_0003*IT_0005*IT_0010 + 1*(IT_0004 + -1./5*IT_0006)*IT_0023) + -1./5
      *IT_0010*IT_0049);
    const ccomplex_t IT_0057 = 0.5*IT_0056;
    const ccomplex_t IT_0058 = IT_0005*IT_0023;
    const ccomplex_t IT_0059 = -IT_0003*IT_0010 + IT_0058;
    const ccomplex_t IT_0060 = (-2)*U_st_00*((IT_0003*IT_0009*IT_0019*IT_0021
      *IT_0022 + (-0.166666666666667)*m_W*(IT_0002*IT_0012 + (-3)*IT_0022)
      *IT_0059)*conj(U_st_00) + -1./2*IT_0005*IT_0020*IT_0021*IT_0022*conj
      (U_st_10)) + U_st_10*(IT_0005*IT_0020*IT_0021*IT_0022*conj(U_st_00) + (
      -1.33333333333333)*(1.5*IT_0003*IT_0009*IT_0019*IT_0021*IT_0022 + m_W
      *IT_0002*IT_0012*IT_0059)*conj(U_st_10));
    ...
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0017 + IT_0035 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0067 = 2*conj(U_st_00)*((IT_0005*IT_0009*IT_0019
      *IT_0021*IT_0022 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0022)
      *IT_0026)*U_st_01 + 1./2*IT_0003*IT_0020*IT_0021*IT_0022*U_st_11) + conj
      (U_st_10)*(IT_0003*IT_0020*IT_0021*IT_0022*U_st_01 + (-1.33333333333333)*(
      (-1.5)*IT_0005*IT_0009*IT_0019*IT_0021*IT_0022 + m_W*IT_0002*IT_0012
    ...
    const ccomplex_t IT_0070 = IT_0039*IT_0069;
    const ccomplex_t IT_0071 = IT_0066*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = IT_0016 + IT_0032 + IT_0034 + IT_0045 + 
      -IT_0054 + -IT_0065 + IT_0072;
