...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_2_to_A0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (-3)*s_23;
    const ccomplex_t IT_0031 = (-0.666666666666667)*IT_0000;
    const ccomplex_t IT_0032 = IT_0026*IT_0031;
    const ccomplex_t IT_0033 = -IT_0032;
    const ccomplex_t IT_0034 = (-3)*s_24;
    const ccomplex_t IT_0035 = (-3)*s_34;
    const ccomplex_t IT_0036 = (-3)*IT_0027*(IT_0018*conj(IT_0027) + (
      -0.333333333333333)*conj(IT_0029)*IT_0030 + (-0.333333333333333)*conj
      (IT_0033)*IT_0034) + IT_0033*(conj(IT_0027)*IT_0034 + conj(IT_0029)
      *IT_0035) + (-3)*IT_0029*(IT_0017*conj(IT_0029) + (-0.333333333333333)
      *conj(IT_0027)*IT_0030 + (-0.333333333333333)*conj(IT_0033)*IT_0035);
