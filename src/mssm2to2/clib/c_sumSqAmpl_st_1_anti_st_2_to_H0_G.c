...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_2_to_H0_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0038 = (-4)*IT_0029*(IT_0020*conj(IT_0029) + (-0.25)
      *conj(IT_0031)*IT_0032 + (-0.25)*conj(IT_0035)*IT_0036) + IT_0035*(conj
      (IT_0029)*IT_0036 + conj(IT_0031)*IT_0037) + (-4)*IT_0031*(IT_0019*conj
      (IT_0031) + (-0.25)*conj(IT_0029)*IT_0032 + (-0.25)*conj(IT_0035)*IT_0037);
