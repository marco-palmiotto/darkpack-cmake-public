        ...
        )
{
    ...
    const ccomplex_t IT_0021 = cpow(IT_0001, 3);
    const ccomplex_t IT_0022 = (0 + _Complex_I*5)*m_W*e_em*IT_0019*(IT_0004*
      (IT_0002*IT_0010 + (-0.2)*IT_0004*(IT_0004*IT_0010 + 5*IT_0001*IT_0020)) +
       1./5*IT_0020*IT_0021);
    ...
    const ccomplex_t IT_0028 = IT_0004*IT_0010;
    const ccomplex_t IT_0029 = IT_0027 + IT_0028;
    const ccomplex_t IT_0030 = 2*U_st_00*((IT_0004*IT_0009*IT_0018*IT_0024
      *IT_0026 + 0.166666666666667*m_W*(IT_0007*IT_0012 + (-3)*IT_0018)*IT_0029)
      ...
      *IT_0007*IT_0012*IT_0029)*conj(U_st_11));
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_12 + -IT_0034 + -IT_0035 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0040 = (0 + _Complex_I*-1)*m_W*e_em*IT_0019*(IT_0004*
      (IT_0001*IT_0004*IT_0010 + (IT_0002 + -IT_0005)*IT_0020) + -IT_0010
      *IT_0021);
    const ccomplex_t IT_0041 = (-1.5)*IT_0040;
    const ccomplex_t IT_0042 = IT_0004*IT_0020;
    const ccomplex_t IT_0043 = -IT_0001*IT_0010 + IT_0042;
    const ccomplex_t IT_0044 = (-2)*U_st_00*((IT_0001*IT_0009*IT_0018*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0007*IT_0012 + (-3)*IT_0018)
      *IT_0043)*conj(U_st_01) + -1./2*IT_0004*IT_0018*IT_0025*IT_0026*conj
      ...
      *IT_0007*IT_0012*IT_0043)*conj(U_st_11));
    ...
    const ccomplex_t IT_0052 = (-2)*U_st_00*((IT_0001*IT_0009*IT_0018*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0007*IT_0012 + (-3)*IT_0018)
      *IT_0043)*conj(U_st_00) + -1./2*IT_0004*IT_0018*IT_0025*IT_0026*conj
      (U_st_10)) + U_st_10*(IT_0004*IT_0018*IT_0025*IT_0026*conj(U_st_00) + (
      -1.33333333333333)*(1.5*IT_0001*IT_0009*IT_0018*IT_0024*IT_0026 + m_W
      *IT_0007*IT_0012*IT_0043)*conj(U_st_10));
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_23 + IT_0035 + IT_0050 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0059 = IT_0055*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*IT_0059;
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0050 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0062 = (-2)*U_st_01*((IT_0001*IT_0009*IT_0018*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0007*IT_0012 + (-3)*IT_0018)
      *IT_0043)*conj(U_st_01) + -1./2*IT_0004*IT_0018*IT_0025*IT_0026*conj
    ...
    const ccomplex_t IT_0065 = (-2)*U_st_00*((IT_0001*IT_0009*IT_0018*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0007*IT_0012 + (-3)*IT_0018)
      *IT_0043)*conj(U_st_01) + -1./2*IT_0004*IT_0018*IT_0025*IT_0026*conj
      (U_st_11)) + U_st_10*(IT_0004*IT_0018*IT_0025*IT_0026*conj(U_st_01) + (
      -1.33333333333333)*(1.5*IT_0001*IT_0009*IT_0018*IT_0024*IT_0026 + m_W
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_13 + IT_0034 + IT_0050 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0068*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = IT_0016 + -IT_0038 + -IT_0049 + IT_0057 +
