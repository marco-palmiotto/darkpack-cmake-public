        ...
        )
{
    ...
    const ccomplex_t IT_0038 = cpow(IT_0010, -1);
    const ccomplex_t IT_0039 = IT_0006*IT_0007;
    const ccomplex_t IT_0040 = -IT_0010*IT_0011 + IT_0039;
    const ccomplex_t IT_0041 = pow(m_t, 2);
    const ccomplex_t IT_0042 = (-2)*U_st_01*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0040 + IT_0003*IT_0011*IT_0036*IT_0038*IT_0041)*conj(U_st_01)
       + -1./2*IT_0003*IT_0007*IT_0037*IT_0038*conj(U_st_11)) + U_st_11*(IT_0003
      *IT_0007*IT_0037*IT_0038*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0040 + 1.5*IT_0003*IT_0011*IT_0036*IT_0038*IT_0041)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0052 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0040 + IT_0003*IT_0011*IT_0036*IT_0038*IT_0041)*conj(U_st_01)
       + -1./2*IT_0003*IT_0007*IT_0037*IT_0038*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0007*IT_0037*IT_0038*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0040 + 1.5*IT_0003*IT_0011*IT_0036*IT_0038*IT_0041)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0026 + IT_0045 + -m_st_1*
    ...
    const ccomplex_t IT_0059 = e_em*IT_0001*IT_0003*(IT_0007*IT_0010 + 
      -IT_0006*IT_0011);
    const ccomplex_t IT_0060 = m_t*e_em*mu_h*IT_0036*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0061 = IT_0003*IT_0060;
    const ccomplex_t IT_0062 = m_t*e_em*mu_h*IT_0036*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0070 = (-0.5)*IT_0061 + 0.5*IT_0063 + (-0.5)*IT_0066 +
       0.5*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_12 + -IT_0025 + -IT_0026 + m_A0*
    ...
    const ccomplex_t IT_0077 = IT_0003*IT_0006*IT_0038;
    const ccomplex_t IT_0078 = IT_0060*IT_0077;
    const ccomplex_t IT_0079 = IT_0062*IT_0077;
    const ccomplex_t IT_0080 = IT_0010*IT_0064;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = IT_0010*IT_0067;
    ...
    const ccomplex_t IT_0086 = cpow((-2)*s_12 + -IT_0025 + -IT_0026 + IT_0085 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0094 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0040 + IT_0003*IT_0011*IT_0036*IT_0038*IT_0041)*conj(U_st_00)
       + -1./2*IT_0003*IT_0007*IT_0037*IT_0038*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0007*IT_0037*IT_0038*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0040 + 1.5*IT_0003*IT_0011*IT_0036*IT_0038*IT_0041)*conj
      (U_st_10));
    ...
    const ccomplex_t IT_0097 = cpow((-2)*s_13 + IT_0045 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0103 = cpow((-2)*s_13 + IT_0025 + IT_0045 + -m_st_2*
    ...
    const ccomplex_t IT_0107 = -IT_0035;
    const ccomplex_t IT_0108 = IT_0005 + IT_0107;
    const ccomplex_t IT_0109 = IT_0029*IT_0108;
    const ccomplex_t IT_0110 = IT_0049 + IT_0058 + IT_0100 + IT_0106 + -IT_0109;
    const ccomplex_t IT_0111 = s_14*s_24*IT_0032;
    const ccomplex_t IT_0112 = -IT_0111;
    const ccomplex_t IT_0113 = s_12 + IT_0112;
    const ccomplex_t IT_0114 = (-3)*conj(IT_0031);
    const ccomplex_t IT_0115 = pow(s_34, 2);
    const ccomplex_t IT_0116 = IT_0032*IT_0115;
    const ccomplex_t IT_0117 = s_24*s_34*IT_0032;
    ...
    const ccomplex_t IT_0122 = (-3)*IT_0110;
    const ccomplex_t IT_0123 = (-3)*IT_0031*(conj(IT_0031)*(IT_0025 + -IT_0034
      ) + conj(IT_0090)*IT_0093 + conj(IT_0110)*IT_0113) + IT_0110*IT_0113
      *IT_0114 + (-3)*IT_0090*((-0.333333333333333)*IT_0093*IT_0114 + conj
      (IT_0090)*(IT_0045 + -IT_0116) + conj(IT_0110)*IT_0119) + (conj(IT_0090)
      *IT_0119 + conj(IT_0110)*(IT_0026 + -IT_0121))*IT_0122;
