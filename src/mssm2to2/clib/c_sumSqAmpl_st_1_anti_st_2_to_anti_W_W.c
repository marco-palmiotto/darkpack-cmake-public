        ...
        )
{
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*IT_0012*IT_0020;
    const ccomplex_t IT_0043 = (-2)*IT_0042;
    const ccomplex_t IT_0044 = cpow(IT_0020, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*e_em*((-0.75)*(IT_0012
      *IT_0020 + -1./3*IT_0001*IT_0044)*U_st_00*conj(U_st_01) + IT_0001*IT_0044
    ...
    const ccomplex_t IT_0049 = s_12 + IT_0006;
    const ccomplex_t IT_0050 = -IT_0042;
    const ccomplex_t IT_0051 = 1.33333333333333*IT_0045;
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = IT_0049*IT_0052;
    const ccomplex_t IT_0054 = IT_0048 + IT_0053;
    const ccomplex_t IT_0055 = 0.5*IT_0005 + 0.5*IT_0006;
    const ccomplex_t IT_0056 = s_12 + IT_0055;
    const ccomplex_t IT_0057 = IT_0046*IT_0050;
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = IT_0043*IT_0051;
    const ccomplex_t IT_0060 = s_23*IT_0059;
    const ccomplex_t IT_0061 = (-2)*IT_0058 + -IT_0060;
    ...
    const ccomplex_t IT_0068 = 2*IT_0042;
    const ccomplex_t IT_0069 = IT_0046*IT_0068;
    const ccomplex_t IT_0070 = IT_0040*(IT_0057 + IT_0069);
    ...
    const ccomplex_t IT_0083 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
      *e_em*IT_0012*U_st_00;
    const ccomplex_t IT_0084 = (-0.5)*IT_0083;
    const ccomplex_t IT_0085 = (0 + _Complex_I*1.4142135623731)*V_ts*e_em
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_23 + IT_0006 + IT_0088 + -m_ss_L*
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
    ...
    const ccomplex_t IT_0120 = -IT_0091 + -IT_0099 + -IT_0103 + -IT_0111 + 
      -IT_0119;
    ...
    const ccomplex_t IT_0129 = IT_0040*(IT_0057 + IT_0069 + -IT_0128);
    const ccomplex_t IT_0130 = -IT_0129;
    const ccomplex_t IT_0131 = s_13*s_24*s_34*IT_0065;
    const ccomplex_t IT_0132 = IT_0126 + IT_0131;
    const ccomplex_t IT_0133 = 3*conj(IT_0064);
    const ccomplex_t IT_0134 = pow(s_23, 2);
    const ccomplex_t IT_0135 = IT_0072*IT_0134;
    const ccomplex_t IT_0136 = (IT_0005 + -IT_0076)*(IT_0006 + -IT_0135);
    const ccomplex_t IT_0137 = 3*IT_0120;
    const ccomplex_t IT_0138 = (IT_0005 + -IT_0076)*(s_12 + -IT_0124);
    const ccomplex_t IT_0139 = -IT_0138;
    const ccomplex_t IT_0140 = (-3)*IT_0071;
    const ccomplex_t IT_0141 = (-3)*conj(IT_0071);
    const ccomplex_t IT_0142 = (s_12 + -IT_0122)*(s_12 + -IT_0124);
    const ccomplex_t IT_0143 = 3*conj(IT_0120);
    const ccomplex_t IT_0144 = (IT_0005 + -IT_0074)*(s_12 + -IT_0122);
    const ccomplex_t IT_0145 = -IT_0144;
    const ccomplex_t IT_0146 = IT_0042*IT_0046;
    const ccomplex_t IT_0147 = IT_0040*IT_0146;
    const ccomplex_t IT_0148 = s_14*s_34*IT_0072;
    const ccomplex_t IT_0149 = (s_12 + -IT_0124)*(s_13 + -IT_0148);
    const ccomplex_t IT_0150 = (IT_0005 + -IT_0074)*(s_13 + -IT_0148);
    const ccomplex_t IT_0151 = -IT_0150;
    const ccomplex_t IT_0152 = s_24*s_34*IT_0072;
    const ccomplex_t IT_0153 = (IT_0005 + -IT_0074)*(s_23 + -IT_0152);
    const ccomplex_t IT_0154 = -IT_0153;
    const ccomplex_t IT_0155 = (-3)*conj(IT_0130);
    const ccomplex_t IT_0156 = s_34*IT_0072;
    const ccomplex_t IT_0157 = s_13*s_34*IT_0072;
    const ccomplex_t IT_0158 = -IT_0157;
    const ccomplex_t IT_0159 = s_14 + IT_0158;
    const ccomplex_t IT_0160 = IT_0156*IT_0159;
    const ccomplex_t IT_0161 = (-3)*conj(IT_0064);
    const ccomplex_t IT_0162 = -IT_0104;
    const ccomplex_t IT_0163 = IT_0107*IT_0162;
    const ccomplex_t IT_0164 = -IT_0163;
    const ccomplex_t IT_0165 = IT_0108 + IT_0164;
    const ccomplex_t IT_0166 = IT_0110*IT_0165;
    const ccomplex_t IT_0167 = -IT_0083;
    const ccomplex_t IT_0168 = IT_0086*IT_0167;
    const ccomplex_t IT_0169 = -IT_0168;
    const ccomplex_t IT_0170 = IT_0087 + IT_0169;
    const ccomplex_t IT_0171 = IT_0090*IT_0170;
    const ccomplex_t IT_0172 = -IT_0092;
    ...
    const ccomplex_t IT_0177 = -IT_0114;
    const ccomplex_t IT_0178 = IT_0117*IT_0177;
    const ccomplex_t IT_0179 = -IT_0178;
    const ccomplex_t IT_0180 = IT_0118 + IT_0179;
    const ccomplex_t IT_0181 = IT_0113*IT_0180;
    const ccomplex_t IT_0182 = -IT_0052 + -IT_0128;
    const ccomplex_t IT_0183 = IT_0100 + IT_0182;
    const ccomplex_t IT_0184 = IT_0040*IT_0183;
    const ccomplex_t IT_0185 = -IT_0166 + -IT_0171 + -IT_0176 + -IT_0181 + 
      -IT_0184;
    const ccomplex_t IT_0186 = 3*conj(IT_0071);
    const ccomplex_t IT_0187 = s_23*s_24*s_34*IT_0065;
    const ccomplex_t IT_0188 = pow(s_24, 2);
    const ccomplex_t IT_0189 = IT_0072*IT_0188;
    const ccomplex_t IT_0190 = -IT_0189;
    const ccomplex_t IT_0191 = -IT_0135;
    const ccomplex_t IT_0192 = IT_0006 + IT_0187 + IT_0190 + IT_0191;
    const ccomplex_t IT_0193 = (s_12 + -IT_0124)*(IT_0006 + -IT_0189);
    const ccomplex_t IT_0194 = -IT_0193;
    const ccomplex_t IT_0195 = (s_12 + -IT_0122)*(IT_0006 + -IT_0135);
    const ccomplex_t IT_0196 = -IT_0195;
    const ccomplex_t IT_0197 = (-3)*conj(IT_0120);
    const ccomplex_t IT_0198 = IT_0042*IT_0051;
    const ccomplex_t IT_0199 = -IT_0198;
    const ccomplex_t IT_0200 = IT_0146 + IT_0199;
    const ccomplex_t IT_0201 = IT_0040*IT_0200;
    const ccomplex_t IT_0202 = IT_0166 + IT_0171 + IT_0176 + IT_0181 + IT_0201;
    const ccomplex_t IT_0203 = s_23*s_34*IT_0072;
    const ccomplex_t IT_0204 = -IT_0203;
    const ccomplex_t IT_0205 = s_24 + IT_0204;
    const ccomplex_t IT_0206 = IT_0156*IT_0205;
    const ccomplex_t IT_0207 = (IT_0006 + -IT_0135)*(s_13 + -IT_0148);
    const ccomplex_t IT_0208 = -IT_0207;
    const ccomplex_t IT_0209 = (s_12 + -IT_0124)*(s_23 + -IT_0152);
    const ccomplex_t IT_0210 = (IT_0006 + -IT_0135)*(IT_0006 + -IT_0189);
    const ccomplex_t IT_0211 = 3*IT_0185;
    const ccomplex_t IT_0212 = (-3)*IT_0130;
    const ccomplex_t IT_0213 = (-3)*IT_0120;
    const ccomplex_t IT_0214 = (IT_0006 + -IT_0135)*(s_23 + -IT_0152);
    const ccomplex_t IT_0215 = -IT_0214;
    const ccomplex_t IT_0216 = -IT_0202;
    const ccomplex_t IT_0217 = 0.333333333333333*IT_0142;
    const ccomplex_t IT_0218 = (IT_0005 + -IT_0074)*(IT_0006 + -IT_0189);
    const ccomplex_t IT_0219 = 3*IT_0130;
    const ccomplex_t IT_0220 = IT_0066*IT_0072;
    const ccomplex_t IT_0221 = (s_12 + -IT_0124)*(IT_0088 + -IT_0220);
    const ccomplex_t IT_0222 = (IT_0006 + -IT_0135)*(IT_0088 + -IT_0220);
    const ccomplex_t IT_0223 = -IT_0222;
    const ccomplex_t IT_0224 = (-0.333333333333333)*IT_0149;
    const ccomplex_t IT_0225 = (-0.333333333333333)*IT_0209;
    const ccomplex_t IT_0226 = (IT_0005 + -IT_0074)*(IT_0088 + -IT_0220);
    ...
    const ccomplex_t IT_0228 = 6*IT_0064*conj(IT_0064)*(1 + 0.5*IT_0067) +
       ...
       IT_0120*IT_0127 + IT_0130*IT_0132)*IT_0133 + conj(IT_0120)*(IT_0082
      *IT_0127 + IT_0136*IT_0137 + IT_0139*IT_0140) + IT_0120*IT_0139*IT_0141 +
       IT_0130*(IT_0142*IT_0143 + IT_0141*IT_0145) + IT_0147*(IT_0143*IT_0149 +
       IT_0141*IT_0151 + IT_0154*IT_0155 + IT_0160*IT_0161) + IT_0185*(IT_0142
      *IT_0186 + IT_0133*IT_0192 + IT_0155*IT_0194 + IT_0196*IT_0197) + IT_0202*
      (IT_0149*IT_0186 + IT_0161*IT_0206 + IT_0197*IT_0208) + 3*conj(IT_0185)*
      (0.333333333333333*IT_0082*IT_0192 + IT_0147*IT_0209 + 0.333333333333333
      *IT_0210*IT_0211 + 0.333333333333333*IT_0194*IT_0212 + 0.333333333333333
      *IT_0196*IT_0213 + IT_0215*IT_0216 + IT_0078*IT_0217) + 3*conj(IT_0130)*
      (0.333333333333333*IT_0082*IT_0132 + 0.333333333333333*IT_0140*IT_0145 +
       IT_0202*IT_0209 + IT_0137*IT_0217 + 0.333333333333333*IT_0218*IT_0219) + 
      (-3)*conj(IT_0202)*(IT_0064*IT_0206 + (-0.333333333333333)*IT_0208*IT_0213
       + IT_0185*IT_0215 + -IT_0147*IT_0221 + IT_0202*IT_0223 + IT_0078*IT_0224 
      + IT_0219*IT_0225) + (-3)*conj(IT_0147)*((-0.333333333333333)*IT_0140
      *IT_0151 + IT_0064*IT_0160 + (-0.333333333333333)*IT_0154*IT_0212 +
       IT_0216*IT_0221 + IT_0137*IT_0224 + IT_0211*IT_0225 + IT_0147*IT_0227);
