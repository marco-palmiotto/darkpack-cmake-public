...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_2_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + IT_0051 
      + -reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0050*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = cpow(IT_0036, -1);
    const ccomplex_t IT_0056 = e_em*m_mu*IT_0003*IT_0032*IT_0037*IT_0055;
    ...
    const ccomplex_t IT_0066 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + m_A0*
    ...
    const ccomplex_t IT_0072 = s_34 + IT_0027;
    const ccomplex_t IT_0073 = -IT_0023;
    const ccomplex_t IT_0074 = (-6)*IT_0073;
    const ccomplex_t IT_0075 = 12*s_34;
    const ccomplex_t IT_0076 = sin(alpha);
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0032
      *IT_0055*IT_0076;
    ...
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*e_em*m_mu*IT_0003*IT_0032
      *IT_0055*IT_0079;
    const ccomplex_t IT_0094 = (-0.5)*IT_0093;
    const ccomplex_t IT_0095 = IT_0036*IT_0079;
    const ccomplex_t IT_0096 = -IT_0037*IT_0076 + IT_0095;
    const ccomplex_t IT_0097 = (-2)*U_st_00*((IT_0003*IT_0032*IT_0038*IT_0076
      *IT_0085 + 0.5*m_W*(IT_0003 + -1./3*IT_0002*IT_0084)*IT_0096)*conj(U_st_01
      ...
      *IT_0003*IT_0032*IT_0038*IT_0076*IT_0085 + m_W*IT_0002*IT_0084*IT_0096)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0101 = cpow((-2)*s_12 + -IT_0015 + -IT_0016 + m_H0*
    ...
    const ccomplex_t IT_0108 = -IT_0027;
    const ccomplex_t IT_0109 = s_34 + IT_0108;
    const ccomplex_t IT_0110 = m_mu*s_13;
    const ccomplex_t IT_0111 = s_34*IT_0015;
    ...
    const ccomplex_t IT_0116 = IT_0104*IT_0107;
    const ccomplex_t IT_0117 = (-6)*IT_0030;
    const ccomplex_t IT_0118 = 0.166666666666667*IT_0024;
    const ccomplex_t IT_0119 = 6*s_34;
    const ccomplex_t IT_0120 = IT_0104*IT_0109;
    const ccomplex_t IT_0121 = (-6)*conj(IT_0073);
    const ccomplex_t IT_0122 = IT_0069*IT_0072;
    const ccomplex_t IT_0123 = (IT_0023*IT_0024 + IT_0026*IT_0028)*IT_0031 + 6
      *conj(IT_0069)*((IT_0026 + -IT_0030)*IT_0071 + IT_0072*(IT_0023 +
       0.166666666666667*IT_0074) + 0.166666666666667*IT_0069*(12*IT_0027 +
       IT_0075)) + 6*conj(IT_0104)*(0.166666666666667*((-12)*IT_0027 + IT_0075)
      *IT_0104 + (IT_0026 + IT_0030)*IT_0107 + (IT_0023 + IT_0073)*IT_0109) + (
      -6)*conj(IT_0030)*(IT_0069*IT_0071 + -IT_0073*IT_0110 + (
      -0.166666666666667)*IT_0030*IT_0115 + -IT_0116) + 6*conj(IT_0026)*(IT_0069
      *IT_0071 + IT_0023*IT_0110 + 0.166666666666667*IT_0026*IT_0115 + IT_0116 +
       0.166666666666667*IT_0028*IT_0117 + IT_0074*IT_0118) + 6*conj(IT_0073)*
      (IT_0030*IT_0110 + 0.166666666666667*IT_0073*IT_0119 + IT_0120) + IT_0121*
      (IT_0024*IT_0026 + IT_0023*IT_0027 + IT_0122) + 6*conj(IT_0023)*
      (0.166666666666667*IT_0027*IT_0074 + IT_0026*IT_0110 + IT_0117*IT_0118 +
       0.166666666666667*IT_0023*IT_0119 + IT_0120 + IT_0122);
