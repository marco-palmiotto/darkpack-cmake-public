...
ccomplex_return_t c_sumSqAmpl_st_1_anti_st_2_to_h_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0039 = (-4)*IT_0030*(IT_0021*conj(IT_0030) + (-0.25)
      *conj(IT_0032)*IT_0033 + (-0.25)*conj(IT_0036)*IT_0037) + IT_0036*(conj
      (IT_0030)*IT_0037 + conj(IT_0032)*IT_0038) + (-4)*IT_0032*(IT_0020*conj
      (IT_0032) + (-0.25)*conj(IT_0030)*IT_0033 + (-0.25)*conj(IT_0036)*IT_0038);
