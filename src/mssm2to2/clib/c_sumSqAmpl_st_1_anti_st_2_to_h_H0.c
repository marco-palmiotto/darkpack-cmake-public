        ...
        )
{
    ...
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_W*e_em*IT_0018*(IT_0007
      *IT_0020 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0007 + 1*IT_0019*(IT_0021 + 
      -1./5*IT_0036)));
    const ccomplex_t IT_0038 = 0.5*IT_0037;
    const ccomplex_t IT_0039 = IT_0002*IT_0019;
    const ccomplex_t IT_0040 = IT_0001*IT_0007;
    const ccomplex_t IT_0041 = IT_0039 + IT_0040;
    const ccomplex_t IT_0042 = 2*U_st_00*((IT_0001*IT_0006*IT_0017*IT_0024
      *IT_0026 + 0.166666666666667*m_W*(IT_0004*IT_0009 + (-3)*IT_0017)*IT_0041)
      ...
      *IT_0004*IT_0009*IT_0041)*conj(U_st_11));
    ...
    const ccomplex_t IT_0050 = 2*U_st_00*((IT_0001*IT_0006*IT_0017*IT_0024
      ...
      *conj(U_st_00) + 1./2*IT_0002*IT_0017*IT_0025*IT_0026*conj(U_st_10)) +
      ...
      -1.33333333333333)*((-1.5)*IT_0001*IT_0006*IT_0017*IT_0024*IT_0026 + m_W
      *IT_0004*IT_0009*IT_0041)*conj(U_st_10));
    ...
    const ccomplex_t IT_0053 = (-2)*U_st_00*((IT_0002*IT_0006*IT_0017*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + (-3)*IT_0017)
      *IT_0028)*conj(U_st_01) + -1./2*IT_0001*IT_0017*IT_0025*IT_0026*conj
      (U_st_11)) + U_st_10*(IT_0001*IT_0017*IT_0025*IT_0026*conj(U_st_01) + (
      -1.33333333333333)*(1.5*IT_0002*IT_0006*IT_0017*IT_0024*IT_0026 + m_W
    ...
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0048 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0060 = 2*U_st_01*((IT_0001*IT_0006*IT_0017*IT_0024
      *IT_0026 + 0.166666666666667*m_W*(IT_0004*IT_0009 + (-3)*IT_0017)*IT_0041)
      *conj(U_st_01) + 1./2*IT_0002*IT_0017*IT_0025*IT_0026*conj(U_st_11)) +
    ...
    const ccomplex_t IT_0063 = (-2)*U_st_00*((IT_0002*IT_0006*IT_0017*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + (-3)*IT_0017)
      *IT_0028)*conj(U_st_01) + -1./2*IT_0001*IT_0017*IT_0025*IT_0026*conj
      (U_st_11)) + U_st_10*(IT_0001*IT_0017*IT_0025*IT_0026*conj(U_st_01) + (
      -1.33333333333333)*(1.5*IT_0002*IT_0006*IT_0017*IT_0024*IT_0026 + m_W
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0014 + IT_0048 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0070 = 2*U_st_00*((IT_0001*IT_0006*IT_0017*IT_0024
      *IT_0026 + 0.166666666666667*m_W*(IT_0004*IT_0009 + (-3)*IT_0017)*IT_0041)
      *conj(U_st_01) + 1./2*IT_0002*IT_0017*IT_0025*IT_0026*conj(U_st_11)) +
       U_st_10*(IT_0002*IT_0017*IT_0025*IT_0026*conj(U_st_01) + (
      -1.33333333333333)*((-1.5)*IT_0001*IT_0006*IT_0017*IT_0024*IT_0026 + m_W
    ...
    const ccomplex_t IT_0073 = (-2)*U_st_00*((IT_0002*IT_0006*IT_0017*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + (-3)*IT_0017)
    ...
    const ccomplex_t IT_0079 = cpow((-2)*s_13 + IT_0013 + IT_0048 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0080 = (-2)*U_st_01*((IT_0002*IT_0006*IT_0017*IT_0024
      *IT_0026 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + (-3)*IT_0017)
      *IT_0028)*conj(U_st_01) + -1./2*IT_0001*IT_0017*IT_0025*IT_0026*conj
    ...
    const ccomplex_t IT_0086 = IT_0012 + -IT_0034 + -IT_0047 + IT_0058 +
       IT_0068 + IT_0078 + IT_0085;
