        ...
        )
{
    ...
    const ccomplex_t IT_0039 = cpow(IT_0009, -1);
    const ccomplex_t IT_0040 = IT_0011*IT_0012;
    const ccomplex_t IT_0041 = IT_0007*IT_0009;
    const ccomplex_t IT_0042 = IT_0040 + IT_0041;
    const ccomplex_t IT_0043 = pow(m_t, 2);
    const ccomplex_t IT_0044 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0042 + IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj(U_st_01)
       + 1./2*IT_0003*IT_0012*IT_0038*IT_0039*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0012*IT_0038*IT_0039*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0042 + (-1.5)*IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0026 + IT_0047 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = IT_0036*IT_0050;
    const ccomplex_t IT_0052 = e_em*IT_0001*IT_0003*(IT_0007*IT_0011 + IT_0009
      *IT_0012);
    const ccomplex_t IT_0053 = -IT_0052;
    const ccomplex_t IT_0054 = m_t*e_em*mu_h*IT_0037*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0055 = IT_0003*IT_0054;
    const ccomplex_t IT_0056 = m_t*e_em*mu_h*IT_0037*U_st_00*conj(U_st_11);
    const ccomplex_t IT_0057 = IT_0003*IT_0056;
    const ccomplex_t IT_0058 = A_t*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0059 = IT_0011*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = A_t*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0064 = (-0.5)*IT_0055 + 0.5*IT_0057 + (-0.5)*IT_0060 +
       0.5*IT_0063;
    const ccomplex_t IT_0065 = cpow((-2)*s_12 + -IT_0025 + -IT_0026 + m_A0*
    ...
    const ccomplex_t IT_0071 = IT_0003*IT_0011*IT_0039;
    const ccomplex_t IT_0072 = IT_0054*IT_0071;
    const ccomplex_t IT_0073 = IT_0056*IT_0071;
    const ccomplex_t IT_0074 = IT_0009*IT_0058;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = IT_0009*IT_0061;
    ...
    const ccomplex_t IT_0084 = 1.33333333333333*IT_0004;
    const ccomplex_t IT_0085 = 2*U_st_01*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0042 + IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj(U_st_01)
       + 1./2*IT_0003*IT_0012*IT_0038*IT_0039*conj(U_st_11)) + U_st_11*(IT_0003
      *IT_0012*IT_0038*IT_0039*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0042 + (-1.5)*IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0047 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0087*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = IT_0084*IT_0090;
    const ccomplex_t IT_0092 = -IT_0051 + IT_0068 + IT_0083 + -IT_0091;
    const ccomplex_t IT_0093 = s_14*s_34*IT_0032;
    const ccomplex_t IT_0094 = -IT_0093;
    const ccomplex_t IT_0095 = s_13 + IT_0094;
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*U_st_01*conj(U_st_01) + IT_0001*IT_0002*U_st_11
      *conj(U_st_11));
    const ccomplex_t IT_0097 = 1.33333333333333*IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0025 + IT_0047 + -m_st_2*
    ...
    const ccomplex_t IT_0102 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0042 + IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj(U_st_00)
       + 1./2*IT_0003*IT_0012*IT_0038*IT_0039*conj(U_st_10)) + U_st_10*(IT_0003
      *IT_0012*IT_0038*IT_0039*conj(U_st_00) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0042 + (-1.5)*IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj
      (U_st_10));
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0047 + (0 + _Complex_I*1)
      *m_st_1*Gamma_t1 + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = IT_0084*IT_0107;
    const ccomplex_t IT_0109 = 2*U_st_01*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0042 + IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj(U_st_01)
       + 1./2*IT_0003*IT_0012*IT_0038*IT_0039*conj(U_st_11)) + U_st_11*(IT_0003
      *IT_0012*IT_0038*IT_0039*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0042 + (-1.5)*IT_0003*IT_0007*IT_0037*IT_0039*IT_0043)*conj
    ...
    const ccomplex_t IT_0115 = -IT_0084;
    const ccomplex_t IT_0116 = IT_0005 + IT_0115;
    const ccomplex_t IT_0117 = IT_0029*IT_0116;
    const ccomplex_t IT_0118 = IT_0051 + IT_0101 + IT_0108 + IT_0114 + -IT_0117;
    const ccomplex_t IT_0119 = s_14*s_24*IT_0032;
    const ccomplex_t IT_0120 = -IT_0119;
    const ccomplex_t IT_0121 = s_12 + IT_0120;
    const ccomplex_t IT_0122 = (-3)*conj(IT_0031);
    const ccomplex_t IT_0123 = pow(s_34, 2);
    const ccomplex_t IT_0124 = IT_0032*IT_0123;
    const ccomplex_t IT_0125 = s_24*s_34*IT_0032;
    const ccomplex_t IT_0126 = -IT_0125;
    const ccomplex_t IT_0127 = s_23 + IT_0126;
    const ccomplex_t IT_0128 = pow(s_24, 2);
    const ccomplex_t IT_0129 = IT_0032*IT_0128;
    const ccomplex_t IT_0130 = (-3)*IT_0118;
    const ccomplex_t IT_0131 = (-3)*IT_0031*(conj(IT_0031)*(IT_0025 + -IT_0034
      ) + conj(IT_0092)*IT_0095 + conj(IT_0118)*IT_0121) + IT_0118*IT_0121
      *IT_0122 + (-3)*IT_0092*((-0.333333333333333)*IT_0095*IT_0122 + conj
      (IT_0092)*(IT_0047 + -IT_0124) + conj(IT_0118)*IT_0127) + (conj(IT_0092)
      *IT_0127 + conj(IT_0118)*(IT_0026 + -IT_0129))*IT_0130;
