        ...
        )
{
    ...
    const ccomplex_t IT_0030 = 2*U_st_00*((IT_0005*IT_0009*IT_0019*IT_0021
      *IT_0022 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0022)*IT_0026)
    ...
    const ccomplex_t IT_0037 = cpow((-2)*s_23 + IT_0017 + IT_0036 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0038 = IT_0033*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = pow(m_st_1, 2);
    const ccomplex_t IT_0041 = cpow((-2)*s_13 + IT_0017 + IT_0040 + -m_st_2*
      (m_st_2 + (0 + _Complex_I*-1)*Gamma_t2) + reg_prop, -1);
    const ccomplex_t IT_0042 = 2*U_st_01*((IT_0005*IT_0009*IT_0019*IT_0021
      *IT_0022 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0022)*IT_0026)
      *conj(U_st_01) + 1./2*IT_0003*IT_0020*IT_0021*IT_0022*conj(U_st_11)) +
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0017 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0045*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = cpow((-2)*s_12 + -IT_0036 + -IT_0040 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0002*IT_0012;
    const ccomplex_t IT_0053 = IT_0022 + IT_0052;
    const ccomplex_t IT_0054 = cpow(IT_0003, 3);
    const ccomplex_t IT_0055 = (0 + _Complex_I*-5)*m_W*e_em*IT_0053*(IT_0005*
      (IT_0003*IT_0005*IT_0010 + 1*(IT_0004 + -1./5*IT_0006)*IT_0023) + -1./5
      *IT_0010*IT_0054);
    const ccomplex_t IT_0056 = 0.5*IT_0055;
    const ccomplex_t IT_0057 = IT_0005*IT_0023;
    const ccomplex_t IT_0058 = -IT_0003*IT_0010 + IT_0057;
    const ccomplex_t IT_0059 = (-2)*U_st_00*((IT_0003*IT_0009*IT_0019*IT_0021
      *IT_0022 + (-0.166666666666667)*m_W*(IT_0002*IT_0012 + (-3)*IT_0022)
      *IT_0058)*conj(U_st_01) + -1./2*IT_0005*IT_0020*IT_0021*IT_0022*conj
      (U_st_11)) + U_st_10*(IT_0005*IT_0020*IT_0021*IT_0022*conj(U_st_01) + (
      -1.33333333333333)*(1.5*IT_0003*IT_0009*IT_0019*IT_0021*IT_0022 + m_W
      *IT_0002*IT_0012*IT_0058)*conj(U_st_11));
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0036 + -IT_0040 + -reg_prop, -1);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_W*e_em*IT_0053*(IT_0005*
    ...
    const ccomplex_t IT_0071 = IT_0016 + IT_0035 + IT_0039 + IT_0047 + IT_0050
       + -IT_0064 + -IT_0070;
    return create_ccomplex_return(3*IT_0071*conj(IT_0071));
}
