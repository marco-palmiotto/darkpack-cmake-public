...
ccomplex_return_t c_sumSqAmpl_st_2_anti_sb_1_to_H0_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0021*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0006*IT_0022*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0021*IT_0022*U_st_11));
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0006*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0020
      *IT_0023 + m_W*IT_0004*IT_0006*conj(U_sb_00)*U_st_01) + A_t*IT_0004*conj
      (U_sb_00)*U_st_11);
    ...
    const ccomplex_t IT_0031 = m_b*mu_h*IT_0020;
    const ccomplex_t IT_0032 = -IT_0006*IT_0007;
    const ccomplex_t IT_0033 = IT_0004*IT_0005;
    ...
    const ccomplex_t IT_0038 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0034*(IT_0001 + 1.
      /3*IT_0000*IT_0036) + IT_0001*IT_0005*IT_0020*IT_0022*IT_0037)*conj
      (U_sb_00) + -1./2*IT_0001*IT_0007*IT_0022*IT_0031*conj(U_sb_10)) + U_sb_10
      *(IT_0001*IT_0007*IT_0022*IT_0031*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0000*IT_0034*IT_0036 + (-3)*IT_0001*IT_0005*IT_0020*IT_0022*IT_0037)
      *conj(U_sb_10));
    const ccomplex_t IT_0039 = (0 + _Complex_I*-1)*(e_em*IT_0038 + (
      -1.4142135623731)*A_b*IT_0005*IT_0030*(conj(U_sb_00)*U_sb_10 + U_sb_00
      *conj(U_sb_10)));
    ...
    const ccomplex_t IT_0048 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0034*
      (IT_0001 + 1./3*IT_0000*IT_0036) + IT_0001*IT_0005*IT_0020*IT_0022*IT_0037
      )*U_sb_01 + -1./2*IT_0001*IT_0007*IT_0022*IT_0031*U_sb_11) + conj(U_sb_10)
      *(IT_0001*IT_0007*IT_0022*IT_0031*U_sb_01 + 0.666666666666667*(m_W*IT_0000
      *IT_0034*IT_0036 + (-3)*IT_0001*IT_0005*IT_0020*IT_0022*IT_0037)*U_sb_11);
    const ccomplex_t IT_0049 = (0 + _Complex_I*-1)*(e_em*IT_0048 + (
      -1.4142135623731)*A_b*IT_0005*IT_0030*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0050 = (-0.5)*IT_0049;
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0009 + IT_0041 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = IT_0047*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0005 + IT_0006*IT_0007);
    const ccomplex_t IT_0056 = -IT_0055;
    const ccomplex_t IT_0057 = pow(m_t, 2);
    const ccomplex_t IT_0058 = cpow(IT_0004, 2);
    const ccomplex_t IT_0059 = cpow(IT_0006, 2);
    const ccomplex_t IT_0060 = m_b*mu_h*IT_0006*IT_0020*IT_0022*conj(U_sb_10)
      *U_st_01 + -conj(U_sb_00)*((IT_0020*(IT_0037 + -IT_0057) + -m_W*(IT_0058 +
       -IT_0059))*U_st_01 + m_t*mu_h*IT_0004*IT_0020*IT_0021*U_st_11);
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0001*IT_0060 + A_b*IT_0004*conj(U_sb_10)*U_st_01 + -A_t*IT_0006
      *conj(U_sb_00)*U_st_11);
    const ccomplex_t IT_0062 = -IT_0061;
    const ccomplex_t IT_0063 = pow(m_W, 2);
    const ccomplex_t IT_0064 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + IT_0063 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0009 + IT_0041 + -m_sd_L*
    ...
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0009 + IT_0041 + -m_ss_L*
    ...
    const ccomplex_t IT_0084 = IT_0028 + -IT_0045 + -IT_0054 + IT_0067 + 
      -IT_0075 + -IT_0083;
    ...
    const ccomplex_t IT_0091 = -IT_0006*IT_0007 + IT_0033;
    const ccomplex_t IT_0092 = (-2)*conj(U_st_00)*((IT_0001*IT_0007*IT_0020
      *IT_0021*IT_0057 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0036)*IT_0091)
      *U_st_01 + -1./2*IT_0001*IT_0005*IT_0021*IT_0090*U_st_11) + conj(U_st_10)*
      (IT_0001*IT_0005*IT_0021*IT_0090*U_st_01 + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0020*IT_0021*IT_0057 + m_W*IT_0000*IT_0036*IT_0091)
      *U_st_11);
    ...
    const ccomplex_t IT_0095 = cpow((-2)*s_13 + IT_0010 + IT_0041 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = IT_0089*IT_0097;
    const ccomplex_t IT_0099 = (-2)*U_st_01*((IT_0001*IT_0007*IT_0020*IT_0021
      *IT_0057 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0036)*IT_0091)*conj(U_st_01
      ) + -1./2*IT_0001*IT_0005*IT_0021*IT_0090*conj(U_st_11)) + U_st_11*
      (IT_0001*IT_0005*IT_0021*IT_0090*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0020*IT_0021*IT_0057 + m_W*IT_0000*IT_0036*IT_0091)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0122 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ...
      *IT_0113 + (-3)*IT_0084*((-0.333333333333333)*IT_0087*IT_0113 + conj
      (IT_0084)*(IT_0041 + -IT_0115) + conj(IT_0109)*IT_0118) + (conj(IT_0084)
