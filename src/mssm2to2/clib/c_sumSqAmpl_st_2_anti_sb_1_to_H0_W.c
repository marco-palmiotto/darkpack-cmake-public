        ...
        )
{
    ...
    const ccomplex_t IT_0032 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0030*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0006*IT_0031*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0030*IT_0031*U_st_11));
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0006*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0029
      *IT_0032 + m_W*IT_0004*IT_0006*conj(U_sb_00)*U_st_01) + A_t*IT_0004*conj
      (U_sb_00)*U_st_11);
    ...
    const ccomplex_t IT_0056 = (-2)*conj(U_sb_00)*(((-0.5)*m_W*IT_0052*
      (IT_0001 + 1./3*IT_0000*IT_0054) + IT_0001*IT_0005*IT_0029*IT_0031*IT_0055
      )*U_sb_01 + -1./2*IT_0001*IT_0007*IT_0031*IT_0049*U_sb_11) + conj(U_sb_10)
      *(IT_0001*IT_0007*IT_0031*IT_0049*U_sb_01 + 0.666666666666667*(m_W*IT_0000
      *IT_0052*IT_0054 + (-3)*IT_0001*IT_0005*IT_0029*IT_0031*IT_0055)*U_sb_11);
    const ccomplex_t IT_0057 = (0 + _Complex_I*-1)*(e_em*IT_0056 + (
      -1.4142135623731)*A_b*IT_0005*IT_0048*(U_sb_01*conj(U_sb_10) + conj
      (U_sb_00)*U_sb_11));
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0009 + IT_0023 + -m_sb_2*
    ...
    const ccomplex_t IT_0064 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0052*(IT_0001 + 1.
      /3*IT_0000*IT_0054) + IT_0001*IT_0005*IT_0029*IT_0031*IT_0055)*conj
      (U_sb_00) + -1./2*IT_0001*IT_0007*IT_0031*IT_0049*conj(U_sb_10)) + U_sb_10
      *(IT_0001*IT_0007*IT_0031*IT_0049*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0000*IT_0052*IT_0054 + (-3)*IT_0001*IT_0005*IT_0029*IT_0031*IT_0055)
      *conj(U_sb_10));
    const ccomplex_t IT_0065 = (0 + _Complex_I*-1)*(e_em*IT_0064 + (
      -1.4142135623731)*A_b*IT_0005*IT_0048*(conj(U_sb_00)*U_sb_10 + U_sb_00
      *conj(U_sb_10)));
    ...
    const ccomplex_t IT_0076 = m_b*mu_h*IT_0006*IT_0029*IT_0031*conj(U_sb_10)
      *U_st_01 + -conj(U_sb_00)*((IT_0029*(IT_0055 + -IT_0073) + -m_W*(IT_0074 +
       -IT_0075))*U_st_01 + m_t*mu_h*IT_0004*IT_0029*IT_0030*U_st_11);
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0001*IT_0076 + A_b*IT_0004*conj(U_sb_10)*U_st_01 + -A_t*IT_0006
    ...
    const ccomplex_t IT_0091 = m_t*mu_h*IT_0029;
    const ccomplex_t IT_0092 = -IT_0006*IT_0007 + IT_0051;
    const ccomplex_t IT_0093 = (-2)*U_st_01*((IT_0001*IT_0007*IT_0029*IT_0030
      *IT_0073 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0054)*IT_0092)*conj(U_st_01
      ) + -1./2*IT_0001*IT_0005*IT_0030*IT_0091*conj(U_st_11)) + U_st_11*
      (IT_0001*IT_0005*IT_0030*IT_0091*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0029*IT_0030*IT_0073 + m_W*IT_0000*IT_0054*IT_0092)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0023 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0102 = (-2)*conj(U_st_00)*((IT_0001*IT_0007*IT_0029
      *IT_0030*IT_0073 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0054)*IT_0092)
      *U_st_01 + -1./2*IT_0001*IT_0005*IT_0030*IT_0091*U_st_11) + conj(U_st_10)*
      (IT_0001*IT_0005*IT_0030*IT_0091*U_st_01 + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0029*IT_0030*IT_0073 + m_W*IT_0000*IT_0054*IT_0092)
      *U_st_11);
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0010 + IT_0023 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = IT_0101*IT_0107;
    const ccomplex_t IT_0109 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0052*(IT_0001 + 1.
      /3*IT_0000*IT_0054) + IT_0001*IT_0005*IT_0029*IT_0031*IT_0055)*conj
      (U_sb_00) + -1./2*IT_0001*IT_0007*IT_0031*IT_0049*conj(U_sb_10)) + U_sb_10
      *(IT_0001*IT_0007*IT_0031*IT_0049*conj(U_sb_00) + 0.666666666666667*(m_W
      *IT_0000*IT_0052*IT_0054 + (-3)*IT_0001*IT_0005*IT_0029*IT_0031*IT_0055)
    ...
    const ccomplex_t IT_0115 = IT_0027 + IT_0045 + IT_0062 + -IT_0090 +
       IT_0099 + IT_0108 + IT_0114;
    ...
    const ccomplex_t IT_0128 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ) + conj(IT_0084)*IT_0087 + conj(IT_0115)*IT_0118) + IT_0115*IT_0118
      *IT_0119 + (-3)*IT_0084*((-0.333333333333333)*IT_0087*IT_0119 + conj
      (IT_0084)*(IT_0023 + -IT_0121) + conj(IT_0115)*IT_0124) + (conj(IT_0084)
