        ...
        )
{
    ...
    const ccomplex_t IT_0018 = -IT_0011;
    const ccomplex_t IT_0019 = IT_0013*IT_0018;
    const ccomplex_t IT_0020 = s_12 + IT_0005;
    ...
    const ccomplex_t IT_0026 = IT_0018*IT_0022;
    const ccomplex_t IT_0027 = s_23*IT_0026;
    const ccomplex_t IT_0028 = (-0.5)*IT_0021 + (-0.5)*IT_0025 + 0.5*IT_0027;
    ...
    const ccomplex_t IT_0034 = cpow(IT_0031, -1);
    const ccomplex_t IT_0035 = cpow(IT_0032, -1);
    const ccomplex_t IT_0036 = pow(m_b, 2);
    const ccomplex_t IT_0037 = pow(m_t, 2);
    const ccomplex_t IT_0038 = cpow(IT_0031, 2);
    const ccomplex_t IT_0039 = cpow(IT_0032, 2);
    const ccomplex_t IT_0040 = m_b*mu_h*IT_0032*IT_0033*IT_0034*conj(U_sb_10)
      *U_st_01 + -conj(U_sb_00)*((IT_0033*(IT_0036 + -IT_0037) + -m_W*(IT_0038 +
       -IT_0039))*U_st_01 + m_t*mu_h*IT_0031*IT_0033*IT_0035*U_st_11);
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0010*IT_0040 + A_b*IT_0031*conj(U_sb_10)*U_st_01 + -A_t*IT_0032
      *conj(U_sb_00)*U_st_11);
    const ccomplex_t IT_0042 = -IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*m_W*e_em*IT_0002*IT_0009;
    const ccomplex_t IT_0044 = -IT_0043;
    const ccomplex_t IT_0045 = IT_0042*IT_0044;
    const ccomplex_t IT_0046 = pow(m_W, 2);
    const ccomplex_t IT_0047 = cpow((-2)*s_12 + -IT_0005 + -IT_0006 + IT_0046 
      + -reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0045*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*IT_0048;
    const ccomplex_t IT_0050 = IT_0004 + (-2)*IT_0030 + -IT_0049;
    ...
    const ccomplex_t IT_0055 = (-2)*IT_0013;
    const ccomplex_t IT_0056 = IT_0012*IT_0055;
    const ccomplex_t IT_0057 = IT_0008*(IT_0014 + IT_0056);
    ...
    const ccomplex_t IT_0063 = (IT_0006 + -IT_0060)*(IT_0006 + -IT_0062);
    ...
    const ccomplex_t IT_0067 = IT_0006 + -IT_0060 + IT_0065 + IT_0066;
    const ccomplex_t IT_0068 = 3*IT_0050;
    const ccomplex_t IT_0069 = 3*conj(IT_0050);
    const ccomplex_t IT_0070 = IT_0014 + IT_0056;
    const ccomplex_t IT_0071 = IT_0018*IT_0055;
    ...
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0009 
      + (-3)*IT_0001*IT_0010)*conj(U_st_00)*U_st_01 + IT_0002*IT_0009*conj
      (U_st_10)*U_st_11);
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0006 + IT_0080 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = IT_0079*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0009 
      + (-3)*IT_0001*IT_0010)*U_st_01*conj(U_st_01) + IT_0002*IT_0009*U_st_11
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0100 = (IT_0006 + -IT_0060)*(IT_0005 + -IT_0099);
    const ccomplex_t IT_0101 = 3*IT_0090;
    const ccomplex_t IT_0102 = (IT_0006 + -IT_0060)*(s_12 + -IT_0092);
    const ccomplex_t IT_0103 = -IT_0102;
    const ccomplex_t IT_0104 = (-3)*IT_0058;
    const ccomplex_t IT_0105 = IT_0008*(IT_0014 + -IT_0019 + IT_0056);
    ...
    const ccomplex_t IT_0109 = -IT_0013;
    ...
    const ccomplex_t IT_0116 = (IT_0006 + -IT_0062)*(s_12 + -IT_0094);
    const ccomplex_t IT_0117 = -IT_0116;
    const ccomplex_t IT_0118 = (-3)*conj(IT_0058);
    const ccomplex_t IT_0119 = -IT_0019 + -IT_0071;
    const ccomplex_t IT_0120 = IT_0070 + IT_0119;
    ...
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
      *IT_0009 + 3*IT_0001*IT_0010)*conj(U_sb_00)*U_sb_01 + IT_0002*IT_0009*conj
      (U_sb_10)*U_sb_11);
    const ccomplex_t IT_0125 = (-0.666666666666667)*IT_0124;
    const ccomplex_t IT_0126 = IT_0123*IT_0125;
    const ccomplex_t IT_0127 = cpow((-2)*s_23 + IT_0005 + IT_0080 + -m_sb_2*
    ...
    const ccomplex_t IT_0144 = IT_0005 + IT_0139 + IT_0140 + IT_0143;
    const ccomplex_t IT_0145 = (s_12 + -IT_0092)*(IT_0005 + -IT_0142);
    const ccomplex_t IT_0146 = -IT_0145;
    const ccomplex_t IT_0147 = (-3)*IT_0106;
    const ccomplex_t IT_0148 = (s_12 + -IT_0094)*(IT_0005 + -IT_0099);
    const ccomplex_t IT_0149 = -IT_0148;
    const ccomplex_t IT_0150 = (-3)*IT_0090;
    const ccomplex_t IT_0151 = (IT_0005 + -IT_0099)*(IT_0005 + -IT_0142);
    const ccomplex_t IT_0152 = IT_0018*IT_0109;
    const ccomplex_t IT_0153 = -IT_0152;
    const ccomplex_t IT_0154 = IT_0110 + IT_0153;
    const ccomplex_t IT_0155 = IT_0008*IT_0154;
    const ccomplex_t IT_0156 = -IT_0129 + -IT_0135 + IT_0155;
    const ccomplex_t IT_0157 = (s_23 + -IT_0137)*(IT_0005 + -IT_0142);
    ...
    const ccomplex_t IT_0165 = (IT_0006 + -IT_0062)*(IT_0005 + -IT_0142);
    ...
    const ccomplex_t IT_0172 = (IT_0006 + -IT_0060)*(s_13 + -IT_0107);
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = (IT_0006 + -IT_0060)*(s_23 + -IT_0137);
    ...
    const ccomplex_t IT_0178 = (IT_0006 + -IT_0060)*(IT_0080 + -IT_0177);
    ...
    const ccomplex_t IT_0188 = (s_13 + -IT_0107)*(IT_0005 + -IT_0142);
    const ccomplex_t IT_0189 = -IT_0188;
    const ccomplex_t IT_0190 = (-0.333333333333333)*IT_0189;
    const ccomplex_t IT_0191 = (IT_0005 + -IT_0142)*(IT_0080 + -IT_0177);
