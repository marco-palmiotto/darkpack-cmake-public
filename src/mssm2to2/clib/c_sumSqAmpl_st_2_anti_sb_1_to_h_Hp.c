        ...
        )
{
    ...
    const ccomplex_t IT_0031 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0011*U_st_01 
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      ...
      *IT_0031 + m_W*IT_0001*IT_0005*conj(U_sb_00)*U_st_01) + A_t*IT_0001*conj
      (U_sb_00)*U_st_11);
    ...
    const ccomplex_t IT_0040 = 2*U_sb_00*((IT_0007*IT_0009*IT_0010*IT_0017
      *IT_0019 + (-0.5)*m_W*IT_0037*(IT_0019 + 1./3*IT_0013*IT_0039))*conj
      (U_sb_00) + 1./2*IT_0002*IT_0010*IT_0019*IT_0034*conj(U_sb_10)) + U_sb_10*
      (IT_0002*IT_0010*IT_0019*IT_0034*conj(U_sb_00) + 2*(IT_0007*IT_0009
      *IT_0010*IT_0017*IT_0019 + -1./3*m_W*IT_0013*IT_0037*IT_0039)*conj(U_sb_10
      ));
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*(e_em*IT_0040 +
       1.4142135623731*A_b*IT_0009*IT_0033*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    const ccomplex_t IT_0042 = 0.5*IT_0041;
    const ccomplex_t IT_0043 = IT_0032*IT_0042;
    const ccomplex_t IT_0044 = IT_0030*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = m_t*conj(U_sb_01)*(m_t*IT_0001*IT_0011*U_st_01 
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      ...
      *IT_0046 + m_W*IT_0001*IT_0005*conj(U_sb_01)*U_st_01) + A_t*IT_0001*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0048 = 2*conj(U_sb_00)*((IT_0007*IT_0009*IT_0010
      *IT_0017*IT_0019 + (-0.5)*m_W*IT_0037*(IT_0019 + 1./3*IT_0013*IT_0039))
      *U_sb_01 + 1./2*IT_0002*IT_0010*IT_0019*IT_0034*U_sb_11) + conj(U_sb_10)*
      (IT_0002*IT_0010*IT_0019*IT_0034*U_sb_01 + 2*(IT_0007*IT_0009*IT_0010
      *IT_0017*IT_0019 + -1./3*m_W*IT_0013*IT_0037*IT_0039)*U_sb_11);
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*(e_em*IT_0048 +
       1.4142135623731*A_b*IT_0009*IT_0033*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = IT_0047*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sb_2*
    ...
    const ccomplex_t IT_0060 = m_b*mu_h*IT_0005*IT_0010*IT_0017*conj(U_sb_10)
      *U_st_01 + conj(U_sb_00)*(((IT_0004 + -IT_0007)*IT_0017 + m_W*(IT_0056 + 
      -IT_0059))*U_st_01 + -m_t*mu_h*IT_0001*IT_0011*IT_0017*U_st_11);
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0019*IT_0060 + A_b*IT_0001*conj(U_sb_10)*U_st_01 + -A_t*IT_0005
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0005
    ...
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0074 = IT_0072*IT_0073;
    const ccomplex_t IT_0075 = (0 + _Complex_I*1)*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*conj(V_ts)*(A_b*IT_0005
      *U_st_01 + 0.707106781186548*m_s*e_em*IT_0017*IT_0019*(mu_h*U_st_01 + m_t
      *IT_0010*IT_0011*U_st_11));
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0009*conj(U_sb_00);
    const ccomplex_t IT_0078 = 0.5*IT_0077;
    const ccomplex_t IT_0079 = IT_0076*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0079*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = IT_0013*IT_0039;
    const ccomplex_t IT_0084 = -IT_0019 + IT_0083;
    const ccomplex_t IT_0085 = 3*IT_0019 + IT_0083;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_W*e_em*(IT_0002*IT_0055
      *IT_0084 + IT_0001*(IT_0009*IT_0059*IT_0085 + -IT_0001*(IT_0001*IT_0009
      *IT_0084 + IT_0002*IT_0005*IT_0085)));
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = IT_0032*IT_0087;
    const ccomplex_t IT_0089 = cpow((-2)*s_12 + -IT_0026 + -IT_0065 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1)*IT_0090;
    const ccomplex_t IT_0092 = cpow((-2)*s_13 + IT_0025 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0093 = m_t*mu_h*IT_0017;
    const ccomplex_t IT_0094 = U_st_11*(IT_0009*IT_0011*IT_0019*IT_0093*conj
    ...
    const ccomplex_t IT_0126 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0011*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0005*IT_0010*conj(U_sb_00)*U_st_00 + conj
      (U_sb_10)*(mu_h*U_st_00 + m_t*IT_0010*IT_0011*U_st_10));
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_10)*U_st_00 + (-1.4142135623731)*e_em*IT_0019*((-0.5)*IT_0017
      *IT_0126 + m_W*IT_0001*IT_0005*conj(U_sb_00)*U_st_00) + A_t*IT_0001*conj
      (U_sb_00)*U_st_10);
    const ccomplex_t IT_0128 = conj(U_st_10)*(IT_0009*IT_0011*IT_0019*IT_0093
      *U_st_01 + (-1.33333333333333)*((-1.5)*IT_0002*IT_0004*IT_0011*IT_0017
      *IT_0019 + m_W*IT_0013*IT_0037*IT_0039)*U_st_11) + 2*conj(U_st_00)*(
      (IT_0002*IT_0004*IT_0011*IT_0017*IT_0019 + (-0.5)*m_W*IT_0037*(IT_0019 + 
      -1./3*IT_0013*IT_0039))*U_st_01 + 1./2*IT_0009*IT_0011*IT_0019*IT_0093
      *U_st_11);
    ...
    const ccomplex_t IT_0132 = cpow((-2)*s_13 + IT_0025 + IT_0065 + -m_st_1*
    ...
    const ccomplex_t IT_0136 = A_t*IT_0001*U_st_11 + (-1.4142135623731)*e_em
      *IT_0019*(m_W*IT_0001*IT_0005*U_st_01 + (-0.5)*IT_0017*(IT_0005*IT_0010
      *IT_0135*U_st_01 + m_t*(m_t*IT_0001*IT_0011*U_st_01 + mu_h*U_st_11)));
    ...
    const ccomplex_t IT_0144 = IT_0016 + IT_0029 + IT_0045 + IT_0054 + 
      -IT_0068 + IT_0075 + IT_0082 + -IT_0091 + IT_0099 + (-2)*IT_0125 + IT_0134
       + IT_0143;
