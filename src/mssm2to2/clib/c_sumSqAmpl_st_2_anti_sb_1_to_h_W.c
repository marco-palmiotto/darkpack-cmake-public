        ...
        )
{
    ...
    const ccomplex_t IT_0024 = m_t*conj(U_sb_00)*(m_t*IT_0006*IT_0022*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0005*IT_0023*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0022*IT_0023*U_st_11));
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0021
      *IT_0024 + m_W*IT_0005*IT_0006*conj(U_sb_00)*U_st_01) + A_t*IT_0006*conj
      (U_sb_00)*U_st_11);
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0009 + IT_0034 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0033*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = IT_0031*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0040 = -IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0007*conj(U_sb_10);
    const ccomplex_t IT_0042 = 0.5*IT_0041;
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0009 + IT_0034 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = IT_0040*IT_0045;
    const ccomplex_t IT_0047 = -IT_0002;
    const ccomplex_t IT_0048 = cpow(V_tb, 2);
    const ccomplex_t IT_0049 = m_b*mu_h*IT_0021;
    ...
    const ccomplex_t IT_0056 = 2*U_sb_00*(((-0.5)*m_W*IT_0052*(IT_0001 + 1./3
      *IT_0000*IT_0054) + IT_0001*IT_0007*IT_0021*IT_0023*IT_0055)*conj(U_sb_00)
       + 1./2*IT_0001*IT_0004*IT_0023*IT_0049*conj(U_sb_10)) + U_sb_10*(IT_0001
      *IT_0004*IT_0023*IT_0049*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0000
      *IT_0052*IT_0054 + (-3)*IT_0001*IT_0007*IT_0021*IT_0023*IT_0055)*conj
      (U_sb_10));
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*(e_em*IT_0056 +
       1.4142135623731*A_b*IT_0007*IT_0048*(conj(U_sb_00)*U_sb_10 + U_sb_00*conj
      (U_sb_10)));
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0034 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0065 = 2*conj(U_sb_00)*(((-0.5)*m_W*IT_0052*(IT_0001 +
       1./3*IT_0000*IT_0054) + IT_0001*IT_0007*IT_0021*IT_0023*IT_0055)*U_sb_01 
      + 1./2*IT_0001*IT_0004*IT_0023*IT_0049*U_sb_11) + conj(U_sb_10)*(IT_0001
      *IT_0004*IT_0023*IT_0049*U_sb_01 + (-0.666666666666667)*(m_W*IT_0000
      *IT_0052*IT_0054 + (-3)*IT_0001*IT_0007*IT_0021*IT_0023*IT_0055)*U_sb_11);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*(e_em*IT_0065 +
       1.4142135623731*A_b*IT_0007*IT_0048*(U_sb_01*conj(U_sb_10) + conj(U_sb_00
      )*U_sb_11));
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0009 + IT_0034 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = IT_0064*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0005 + -IT_0006*IT_0007);
    const ccomplex_t IT_0073 = -IT_0072;
    const ccomplex_t IT_0074 = pow(m_t, 2);
    const ccomplex_t IT_0075 = cpow(IT_0006, 2);
    const ccomplex_t IT_0076 = cpow(IT_0005, 2);
    const ccomplex_t IT_0077 = m_b*mu_h*IT_0005*IT_0021*IT_0023*conj(U_sb_10)
      *U_st_01 + -conj(U_sb_00)*((IT_0021*(IT_0055 + -IT_0074) + -m_W*(IT_0075 +
       -IT_0076))*U_st_01 + m_t*mu_h*IT_0006*IT_0021*IT_0022*U_st_11);
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0001*IT_0077 + A_b*IT_0006*conj(U_sb_10)*U_st_01 + -A_t*IT_0005
      *conj(U_sb_00)*U_st_11);
    const ccomplex_t IT_0079 = -IT_0078;
    const ccomplex_t IT_0080 = pow(m_W, 2);
    const ccomplex_t IT_0081 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + IT_0080 
      + -reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0079*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = IT_0073*IT_0083;
    const ccomplex_t IT_0085 = IT_0029 + -IT_0038 + -IT_0046 + -IT_0062 + 
      -IT_0071 + IT_0084;
    const ccomplex_t IT_0086 = s_14*s_34*IT_0016;
    const ccomplex_t IT_0087 = -IT_0086;
    const ccomplex_t IT_0088 = s_13 + IT_0087;
    const ccomplex_t IT_0089 = m_t*mu_h*IT_0021;
    const ccomplex_t IT_0090 = U_st_11*(IT_0001*IT_0007*IT_0022*IT_0089*conj
      (U_st_01) + (-1.33333333333333)*(m_W*IT_0000*IT_0052*IT_0054 + (-1.5)
      *IT_0001*IT_0004*IT_0021*IT_0022*IT_0074)*conj(U_st_11)) + 2*U_st_01*(((
      -0.5)*m_W*IT_0052*(IT_0001 + -1./3*IT_0000*IT_0054) + IT_0001*IT_0004
      *IT_0021*IT_0022*IT_0074)*conj(U_st_01) + 1./2*IT_0001*IT_0007*IT_0022
      *IT_0089*conj(U_st_11));
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0034 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0097 = 2*U_sb_00*(((-0.5)*m_W*IT_0052*(IT_0001 + 1./3
      *IT_0000*IT_0054) + IT_0001*IT_0007*IT_0021*IT_0023*IT_0055)*conj(U_sb_00)
       + 1./2*IT_0001*IT_0004*IT_0023*IT_0049*conj(U_sb_10)) + U_sb_10*(IT_0001
      *IT_0004*IT_0023*IT_0049*conj(U_sb_00) + (-0.666666666666667)*(m_W*IT_0000
      *IT_0052*IT_0054 + (-3)*IT_0001*IT_0007*IT_0021*IT_0023*IT_0055)*conj
    ...
    const ccomplex_t IT_0108 = conj(U_st_10)*(IT_0001*IT_0007*IT_0022*IT_0089
      *U_st_01 + (-1.33333333333333)*(m_W*IT_0000*IT_0052*IT_0054 + (-1.5)
      *IT_0001*IT_0004*IT_0021*IT_0022*IT_0074)*U_st_11) + 2*conj(U_st_00)*(((
      -0.5)*m_W*IT_0052*(IT_0001 + -1./3*IT_0000*IT_0054) + IT_0001*IT_0004
      *IT_0021*IT_0022*IT_0074)*U_st_01 + 1./2*IT_0001*IT_0007*IT_0022*IT_0089
      *U_st_11);
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0010 + IT_0034 + -m_st_1*
    ...
    const ccomplex_t IT_0115 = IT_0038 + IT_0046 + IT_0071 + IT_0096 + IT_0102
       + -IT_0105 + IT_0114;
    const ccomplex_t IT_0116 = s_14*s_24*IT_0016;
    const ccomplex_t IT_0117 = -IT_0116;
    const ccomplex_t IT_0118 = s_12 + IT_0117;
    const ccomplex_t IT_0119 = (-3)*conj(IT_0015);
    const ccomplex_t IT_0120 = pow(s_34, 2);
    const ccomplex_t IT_0121 = IT_0016*IT_0120;
    const ccomplex_t IT_0122 = s_24*s_34*IT_0016;
    ...
    const ccomplex_t IT_0127 = (-3)*IT_0115;
    const ccomplex_t IT_0128 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ) + conj(IT_0085)*IT_0088 + conj(IT_0115)*IT_0118) + IT_0115*IT_0118
      *IT_0119 + (-3)*IT_0085*((-0.333333333333333)*IT_0088*IT_0119 + conj
      (IT_0085)*(IT_0034 + -IT_0121) + conj(IT_0115)*IT_0124) + (conj(IT_0085)
      *IT_0124 + conj(IT_0115)*(IT_0009 + -IT_0126))*IT_0127;
