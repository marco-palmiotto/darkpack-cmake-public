...
ccomplex_return_t c_sumSqAmpl_st_2_anti_sb_1_to_nu_tau_anti_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0008*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0002*IT_0003*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0002*IT_0008*U_st_11));
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0003*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0005*((-0.5)*IT_0000
      *IT_0009 + m_W*IT_0001*IT_0003*conj(U_sb_00)*U_st_01) + A_t*IT_0001*conj
      (U_sb_00)*U_st_11);
    ...
    const ccomplex_t IT_0036 = m_b*mu_h*IT_0000*IT_0002*IT_0003*conj(U_sb_10)
      *U_st_01 + -conj(U_sb_00)*((IT_0000*(IT_0032 + -IT_0033) + -m_W*(IT_0034 +
       -IT_0035))*U_st_01 + m_t*mu_h*IT_0000*IT_0001*IT_0008*U_st_11);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0005*IT_0036 + A_b*IT_0001*conj(U_sb_10)*U_st_01 + -A_t*IT_0003
