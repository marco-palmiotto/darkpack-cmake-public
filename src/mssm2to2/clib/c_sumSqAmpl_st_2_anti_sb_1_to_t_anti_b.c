        ...
        )
{
    ...
    const ccomplex_t IT_0024 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0025 = IT_0023*IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*IT_0025;
    const ccomplex_t IT_0027 = conj(N_W2)*e_em*U_st_01;
    ...
    const ccomplex_t IT_0034 = m_t*conj(N_u2)*e_em*IT_0033*U_st_11;
    ...
    const ccomplex_t IT_0065 = m_t*conj(N_u3)*e_em*IT_0033*U_st_11;
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_4*
    ...
    const ccomplex_t IT_0092 = m_t*conj(N_u4)*e_em*IT_0033*U_st_11;
    ...
    const ccomplex_t IT_0097 = N_B4*e_em*conj(U_sb_00);
    const ccomplex_t IT_0098 = IT_0023*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = N_W4*e_em*conj(U_sb_00);
    const ccomplex_t IT_0101 = IT_0010*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = m_b*N_d4*e_em*IT_0033*conj(U_sb_10);
    const ccomplex_t IT_0104 = IT_0041*IT_0103;
    ...
    const ccomplex_t IT_0109 = IT_0085*IT_0108;
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*IT_0109;
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0112 = conj(N_B1)*e_em*U_st_01;
    const ccomplex_t IT_0113 = IT_0023*IT_0112;
    const ccomplex_t IT_0114 = 1.4142135623731*IT_0113;
    const ccomplex_t IT_0115 = conj(N_W1)*e_em*U_st_01;
    const ccomplex_t IT_0116 = IT_0010*IT_0115;
    const ccomplex_t IT_0117 = 1.4142135623731*IT_0116;
    const ccomplex_t IT_0118 = m_t*conj(N_u1)*e_em*IT_0033*U_st_11;
    ...
    const ccomplex_t IT_0123 = m_b*N_d1*e_em*IT_0033*conj(U_sb_10);
    ...
    const ccomplex_t IT_0129 = N_B1*e_em*conj(U_sb_00);
    const ccomplex_t IT_0130 = IT_0023*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = (0 + _Complex_I*1)*(IT_0125 + -IT_0128 +
       0.333333333333333*IT_0131);
    ...
    const ccomplex_t IT_0145 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0146 = IT_0023*IT_0145;
    const ccomplex_t IT_0147 = 1.4142135623731*IT_0146;
    const ccomplex_t IT_0148 = m_t*N_u2*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0153 = conj(N_B2)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0154 = IT_0023*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = m_b*conj(N_d2)*e_em*IT_0033*conj(U_sb_00);
    ...
    const ccomplex_t IT_0164 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0165 = IT_0023*IT_0164;
    const ccomplex_t IT_0166 = 1.4142135623731*IT_0165;
    const ccomplex_t IT_0167 = m_t*N_u1*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0172 = conj(N_B1)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0173 = IT_0023*IT_0172;
    const ccomplex_t IT_0174 = 1.4142135623731*IT_0173;
    const ccomplex_t IT_0175 = m_b*conj(N_d1)*e_em*IT_0033*conj(U_sb_00);
    ...
    const ccomplex_t IT_0183 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0184 = IT_0023*IT_0183;
    const ccomplex_t IT_0185 = 1.4142135623731*IT_0184;
    const ccomplex_t IT_0186 = m_t*N_u3*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0191 = m_b*conj(N_d3)*e_em*IT_0033*conj(U_sb_00);
    const ccomplex_t IT_0192 = IT_0041*IT_0191;
    const ccomplex_t IT_0193 = 1.4142135623731*IT_0192;
    const ccomplex_t IT_0194 = conj(N_B3)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0195 = IT_0023*IT_0194;
    ...
    const ccomplex_t IT_0201 = IT_0058*IT_0200;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*IT_0201;
    const ccomplex_t IT_0203 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0204 = IT_0023*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = m_t*N_u4*e_em*IT_0033*U_st_01;
    const ccomplex_t IT_0207 = IT_0032*IT_0206;
    const ccomplex_t IT_0208 = 1.4142135623731*IT_0207;
    const ccomplex_t IT_0209 = (0 + _Complex_I*1)*(IT_0205 + (-0.75)*IT_0208);
    const ccomplex_t IT_0210 = 0.666666666666667*IT_0209;
    const ccomplex_t IT_0211 = conj(N_B4)*e_em*conj(U_sb_10);
    const ccomplex_t IT_0212 = IT_0023*IT_0211;
    const ccomplex_t IT_0213 = 1.4142135623731*IT_0212;
    const ccomplex_t IT_0214 = m_b*conj(N_d4)*e_em*IT_0033*conj(U_sb_00);
    const ccomplex_t IT_0215 = IT_0041*IT_0214;
    ...
    const ccomplex_t IT_0220 = IT_0085*IT_0219;
    const ccomplex_t IT_0221 = (0 + _Complex_I*1)*IT_0220;
    const ccomplex_t IT_0222 = 0.166666666666667*IT_0143 + -IT_0163 + -IT_0182
       + -IT_0202 + -IT_0221;
    const ccomplex_t IT_0223 = s_34*IT_0002;
    ...
    const ccomplex_t IT_0228 = (-18)*IT_0223;
    const ccomplex_t IT_0229 = 36*IT_0225;
    const ccomplex_t IT_0230 = IT_0228 + IT_0229;
    const ccomplex_t IT_0231 = m_t*s_14;
    const ccomplex_t IT_0232 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0010*IT_0033;
    const ccomplex_t IT_0233 = 0.5*IT_0232;
    const ccomplex_t IT_0234 = pow(m_b, 2);
    const ccomplex_t IT_0235 = cpow(IT_0039, 2);
    const ccomplex_t IT_0236 = cpow(IT_0030, 2);
    const ccomplex_t IT_0237 = m_b*mu_h*IT_0030*IT_0033*IT_0040*conj(U_sb_10)
      *U_st_01 + conj(U_sb_00)*((IT_0033*(IT_0000 + -IT_0234) + m_W*(IT_0235 + 
      -IT_0236))*U_st_01 + -m_t*mu_h*IT_0031*IT_0033*IT_0039*U_st_11);
    const ccomplex_t IT_0238 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0010*IT_0237 + A_b*IT_0039*conj(U_sb_10)*U_st_01 + -A_t*IT_0030
      *conj(U_sb_00)*U_st_11);
    const ccomplex_t IT_0239 = -IT_0238;
    const ccomplex_t IT_0240 = IT_0233*IT_0239;
    const ccomplex_t IT_0241 = pow(m_W, 2);
    const ccomplex_t IT_0242 = cpow((-2)*s_12 + -IT_0002 + -IT_0015 + IT_0241 
      + -reg_prop, -1);
    const ccomplex_t IT_0243 = IT_0240*IT_0242;
    const ccomplex_t IT_0244 = (0 + _Complex_I*1)*IT_0243;
    const ccomplex_t IT_0245 = (-0.5)*IT_0011;
    const ccomplex_t IT_0246 = m_t*IT_0245;
    const ccomplex_t IT_0247 = m_t*IT_0012;
    const ccomplex_t IT_0248 = -IT_0247;
    const ccomplex_t IT_0249 = IT_0246 + IT_0248;
    const ccomplex_t IT_0250 = IT_0018*IT_0249;
    const ccomplex_t IT_0251 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0010*IT_0031*IT_0033*IT_0039;
    const ccomplex_t IT_0252 = 0.5*IT_0251;
    const ccomplex_t IT_0253 = m_t*conj(U_sb_00)*(m_t*IT_0031*IT_0039*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0030*IT_0040*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0031*IT_0040*U_st_11));
    const ccomplex_t IT_0254 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0030*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0010*((-0.5)*IT_0033
      *IT_0253 + m_W*IT_0030*IT_0039*conj(U_sb_00)*U_st_01) + A_t*IT_0039*conj
      (U_sb_00)*U_st_11);
    const ccomplex_t IT_0255 = IT_0252*IT_0254;
    const ccomplex_t IT_0256 = cpow((-2)*s_12 + -IT_0002 + -IT_0015 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0257 = IT_0255*IT_0256;
    const ccomplex_t IT_0258 = (0 + _Complex_I*1)*IT_0257;
    const ccomplex_t IT_0259 = IT_0005*IT_0139;
    const ccomplex_t IT_0260 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0261 = IT_0003*IT_0259*IT_0260;
    const ccomplex_t IT_0262 = m_t*IT_0008;
    const ccomplex_t IT_0263 = -IT_0244 + -IT_0250 + -IT_0258 + (-0.5)*IT_0261
       + 0.5*IT_0262;
    const ccomplex_t IT_0264 = m_t*IT_0143;
    const ccomplex_t IT_0265 = IT_0004*IT_0140;
    const ccomplex_t IT_0266 = IT_0003*IT_0260*IT_0265;
    const ccomplex_t IT_0267 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0010*IT_0033;
    const ccomplex_t IT_0268 = (-0.5)*IT_0267;
    const ccomplex_t IT_0269 = IT_0239*IT_0268;
    const ccomplex_t IT_0270 = IT_0242*IT_0269;
    const ccomplex_t IT_0271 = (0 + _Complex_I*1)*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0010*IT_0030*IT_0033*IT_0040;
    const ccomplex_t IT_0273 = 0.5*IT_0272;
    const ccomplex_t IT_0274 = IT_0254*IT_0273;
    const ccomplex_t IT_0275 = IT_0256*IT_0274;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1)*IT_0275;
    const ccomplex_t IT_0277 = m_b*IT_0012;
    const ccomplex_t IT_0278 = -IT_0277;
    const ccomplex_t IT_0279 = m_b*IT_0245;
    const ccomplex_t IT_0280 = IT_0278 + IT_0279;
    const ccomplex_t IT_0281 = IT_0018*IT_0280;
    const ccomplex_t IT_0282 = 0.5*IT_0264 + (-0.5)*IT_0266 + -IT_0271 + 
      -IT_0276 + IT_0281;
    const ccomplex_t IT_0283 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0284 = IT_0081*IT_0190;
    const ccomplex_t IT_0285 = IT_0058*IT_0283*IT_0284;
    const ccomplex_t IT_0286 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0287 = IT_0134*IT_0171;
    const ccomplex_t IT_0288 = IT_0111*IT_0286*IT_0287;
    const ccomplex_t IT_0289 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0290 = IT_0054*IT_0152;
    const ccomplex_t IT_0291 = IT_0021*IT_0289*IT_0290;
    const ccomplex_t IT_0292 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0293 = IT_0107*IT_0210;
    const ccomplex_t IT_0294 = IT_0085*IT_0292*IT_0293;
    const ccomplex_t IT_0295 = m_t*IT_0137;
    const ccomplex_t IT_0296 = m_t*IT_0057;
    const ccomplex_t IT_0297 = m_t*IT_0084;
    const ccomplex_t IT_0298 = m_t*IT_0110;
    const ccomplex_t IT_0299 = 0.166666666666667*IT_0261 + (-0.166666666666667
      )*IT_0262 + -IT_0285 + -IT_0288 + -IT_0291 + -IT_0294 + IT_0295 + IT_0296 
      + IT_0297 + IT_0298;
    const ccomplex_t IT_0300 = IT_0020 + 3*IT_0138;
    const ccomplex_t IT_0301 = 3*conj(IT_0138);
    const ccomplex_t IT_0302 = conj(IT_0020) + IT_0301;
    const ccomplex_t IT_0303 = IT_0096*IT_0218;
    const ccomplex_t IT_0304 = IT_0085*IT_0292*IT_0303;
    const ccomplex_t IT_0305 = m_t*IT_0163;
    const ccomplex_t IT_0306 = IT_0069*IT_0199;
    const ccomplex_t IT_0307 = IT_0058*IT_0283*IT_0306;
    const ccomplex_t IT_0308 = IT_0122*IT_0179;
    const ccomplex_t IT_0309 = IT_0111*IT_0286*IT_0308;
    const ccomplex_t IT_0310 = IT_0038*IT_0160;
    const ccomplex_t IT_0311 = IT_0021*IT_0289*IT_0310;
    const ccomplex_t IT_0312 = m_t*IT_0182;
    const ccomplex_t IT_0313 = m_t*IT_0202;
    const ccomplex_t IT_0314 = m_t*IT_0221;
    const ccomplex_t IT_0315 = (-0.166666666666667)*IT_0264 +
       0.166666666666667*IT_0266 + -IT_0304 + IT_0305 + -IT_0307 + -IT_0309 + 
      -IT_0311 + IT_0312 + IT_0313 + IT_0314;
    const ccomplex_t IT_0316 = 3*IT_0222;
    const ccomplex_t IT_0317 = IT_0144 + IT_0316;
    const ccomplex_t IT_0318 = 3*conj(IT_0222);
    const ccomplex_t IT_0319 = conj(IT_0144) + IT_0318;
    const ccomplex_t IT_0320 = (18*conj(IT_0020) + 6*conj(IT_0138))*IT_0263 + 
      (18*IT_0020 + 6*IT_0138)*conj(IT_0263) + (18*conj(IT_0144) + 6*conj
      (IT_0222))*IT_0282 + (18*IT_0144 + 6*IT_0222)*conj(IT_0282) + 6*conj
      (IT_0299)*IT_0300 + 6*IT_0299*IT_0302 + 6*conj(IT_0315)*IT_0317 + 6
      *IT_0315*IT_0319;
    const ccomplex_t IT_0321 = 6*s_34;
    const ccomplex_t IT_0322 = 18*s_34;
    const ccomplex_t IT_0323 = m_b*m_t;
    const ccomplex_t IT_0324 = (-18)*conj(IT_0263);
    const ccomplex_t IT_0325 = (-6)*conj(IT_0299);
    const ccomplex_t IT_0326 = IT_0324 + IT_0325;
    const ccomplex_t IT_0327 = (-18)*conj(IT_0299);
    const ccomplex_t IT_0328 = (-6)*conj(IT_0263);
    const ccomplex_t IT_0329 = IT_0327 + IT_0328;
    const ccomplex_t IT_0330 = (-18)*IT_0299;
    const ccomplex_t IT_0331 = (-6)*IT_0299;
    const ccomplex_t IT_0332 = m_b*m_t*IT_0002;
    const ccomplex_t IT_0333 = (-6)*conj(IT_0222);
    const ccomplex_t IT_0334 = (-18)*conj(IT_0144);
    const ccomplex_t IT_0335 = IT_0333 + IT_0334;
    const ccomplex_t IT_0336 = (-6)*IT_0138;
    const ccomplex_t IT_0337 = (-6)*conj(IT_0138);
    const ccomplex_t IT_0338 = m_b*s_13;
    const ccomplex_t IT_0339 = IT_0302*IT_0315 + IT_0300*conj(IT_0315) + (
      -0.166666666666667)*IT_0144*IT_0326 + (-0.166666666666667)*IT_0222*IT_0329
       + (-0.166666666666667)*conj(IT_0222)*IT_0330 + (-0.166666666666667)*conj
      (IT_0144)*IT_0331 + (-0.166666666666667)*IT_0263*IT_0335 + (
      -0.166666666666667)*conj(IT_0282)*((-18)*IT_0020 + IT_0336) + (
      -0.166666666666667)*IT_0282*((-18)*conj(IT_0020) + IT_0337);
    const ccomplex_t IT_0340 = (conj(IT_0020)*IT_0138 + IT_0020*conj(IT_0138) 
      + conj(IT_0144)*IT_0222 + IT_0144*conj(IT_0222))*IT_0227 + (IT_0020*conj
      (IT_0020) + IT_0138*conj(IT_0138) + IT_0144*conj(IT_0144) + IT_0222*conj
      (IT_0222))*IT_0230 + IT_0231*IT_0320 + (conj(IT_0263)*IT_0299 + IT_0263
      *conj(IT_0299) + conj(IT_0282)*IT_0315 + IT_0282*conj(IT_0315))*IT_0321 + 
      (IT_0263*conj(IT_0263) + IT_0282*conj(IT_0282) + IT_0299*conj(IT_0299) +
       IT_0315*conj(IT_0315))*IT_0322 + IT_0323*(IT_0263*((-18)*conj(IT_0282) + 
      (-6)*conj(IT_0315)) + IT_0282*IT_0326 + IT_0315*IT_0329 + conj(IT_0315)
      *IT_0330 + conj(IT_0282)*IT_0331) + IT_0332*(conj(IT_0020)*((-18)*IT_0144 
      + (-6)*IT_0222) + IT_0020*IT_0335 + IT_0319*IT_0336 + IT_0317*IT_0337) + (
      -6)*IT_0338*IT_0339;
