        ...
        )
{
    ...
    const ccomplex_t IT_0035 = 0.5*IT_0026 + (-0.5)*IT_0028 + 0.5*IT_0031 + (
      -0.5)*IT_0034;
    const ccomplex_t IT_0036 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0014*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0001*IT_0013*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0013*IT_0014*U_st_10));
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0015*((-0.5)*IT_0012
      *IT_0036 + m_W*IT_0001*IT_0004*conj(U_sb_01)*U_st_00) + A_t*IT_0004*conj
      (U_sb_01)*U_st_10);
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0020 + IT_0021 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0044 = pow(m_d, 2);
    const ccomplex_t IT_0045 = A_t*IT_0004*U_st_11 + (-1.4142135623731)*e_em
      *IT_0015*(m_W*IT_0001*IT_0004*U_st_01 + (-0.5)*IT_0012*(IT_0001*IT_0013
      *IT_0044*U_st_01 + m_t*(m_t*IT_0004*IT_0014*U_st_01 + mu_h*U_st_11)));
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*conj(V_td)*IT_0045;
    const ccomplex_t IT_0047 = 1.4142135623731*A_b*V_tb*V_td*IT_0001*conj
      (U_sb_11);
    const ccomplex_t IT_0048 = 0.5*IT_0047;
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = IT_0043*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_23 + IT_0020 + IT_0021 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*conj(V_td)*(A_b*IT_0001
      *U_st_01 + 0.707106781186548*m_d*e_em*IT_0012*IT_0015*(mu_h*U_st_01 + m_t
      *IT_0013*IT_0014*U_st_11));
    const ccomplex_t IT_0054 = 1.4142135623731*A_b*V_tb*V_td*IT_0001*conj
      (U_sb_01);
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = IT_0053*IT_0055;
    const ccomplex_t IT_0057 = IT_0052*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = m_t*conj(U_sb_00)*(m_t*IT_0004*IT_0014*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0001*IT_0013*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0013*IT_0014*U_st_11));
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0001*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0015*((-0.5)*IT_0012
      *IT_0059 + m_W*IT_0001*IT_0004*conj(U_sb_00)*U_st_01) + A_t*IT_0004*conj
      (U_sb_00)*U_st_11);
    const ccomplex_t IT_0061 = m_b*e_em*mu_h*IT_0012*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0062 = IT_0015*IT_0061;
    const ccomplex_t IT_0063 = m_b*e_em*mu_h*IT_0012*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0064 = IT_0015*IT_0063;
    const ccomplex_t IT_0065 = cpow(V_tb, 2);
    const ccomplex_t IT_0066 = A_b*IT_0065*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0067 = IT_0001*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = A_b*IT_0065*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0070 = IT_0001*IT_0069;
    const ccomplex_t IT_0071 = 1.4142135623731*IT_0070;
    const ccomplex_t IT_0072 = (-0.5)*IT_0062 + 0.5*IT_0064 + (-0.5)*IT_0068 +
       0.5*IT_0071;
    const ccomplex_t IT_0073 = IT_0060*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0020 + IT_0021 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0075 = IT_0073*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*IT_0075;
    const ccomplex_t IT_0077 = m_W*e_em*IT_0015;
    const ccomplex_t IT_0078 = (-0.5)*IT_0077;
    const ccomplex_t IT_0079 = cpow(IT_0004, 2);
    const ccomplex_t IT_0080 = cpow(IT_0001, 2);
    const ccomplex_t IT_0081 = m_b*mu_h*IT_0001*IT_0012*IT_0013*conj(U_sb_11)
      *U_st_01 + -conj(U_sb_01)*(((IT_0003 + -IT_0006)*IT_0012 + -m_W*(IT_0079 +
       -IT_0080))*U_st_01 + m_t*mu_h*IT_0004*IT_0012*IT_0014*U_st_11);
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0015*IT_0081 + A_b*IT_0004*conj(U_sb_11)*U_st_01 + -A_t*IT_0001
    ...
    const ccomplex_t IT_0086 = cpow((-2)*s_12 + -IT_0021 + -IT_0039 + IT_0085 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0090 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0015*conj(U_sb_01)*U_st_01;
    const ccomplex_t IT_0091 = (-0.5)*IT_0090;
    const ccomplex_t IT_0092 = e_em*IT_0015;
    const ccomplex_t IT_0093 = 0.5*IT_0092;
    const ccomplex_t IT_0094 = IT_0091*IT_0093;
    const ccomplex_t IT_0095 = 0.5*IT_0021 + 0.5*IT_0039;
    const ccomplex_t IT_0096 = s_12 + IT_0095;
    const ccomplex_t IT_0097 = IT_0094*IT_0096;
    const ccomplex_t IT_0098 = IT_0091*IT_0092;
    const ccomplex_t IT_0099 = (-0.5)*s_13 + (-0.5)*s_23 + 0.5*IT_0021 + 0.5
      *IT_0039;
    const ccomplex_t IT_0100 = s_12 + IT_0099;
    const ccomplex_t IT_0101 = IT_0098*IT_0100;
    const ccomplex_t IT_0102 = s_12 + IT_0021;
    const ccomplex_t IT_0103 = -IT_0090;
    const ccomplex_t IT_0104 = IT_0093*IT_0103;
    const ccomplex_t IT_0105 = IT_0102*IT_0104;
    const ccomplex_t IT_0106 = IT_0092*IT_0103;
    const ccomplex_t IT_0107 = -s_23;
    const ccomplex_t IT_0108 = IT_0102 + IT_0107;
    const ccomplex_t IT_0109 = IT_0106*IT_0108;
    const ccomplex_t IT_0110 = -IT_0101 + (-0.5)*IT_0105 + 0.5*IT_0109;
    ...
    const ccomplex_t IT_0114 = m_t*e_em*mu_h*IT_0012*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0115 = IT_0015*IT_0114;
    const ccomplex_t IT_0116 = m_t*e_em*mu_h*IT_0012*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0117 = IT_0015*IT_0116;
    const ccomplex_t IT_0118 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0119 = IT_0004*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0140 = m_b*e_em*mu_h*IT_0012*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0141 = IT_0015*IT_0140;
    const ccomplex_t IT_0142 = m_b*e_em*mu_h*IT_0012*U_sb_01*conj(U_sb_11);
    const ccomplex_t IT_0143 = IT_0015*IT_0142;
    const ccomplex_t IT_0144 = A_b*IT_0065*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0145 = IT_0001*IT_0144;
    const ccomplex_t IT_0146 = 1.4142135623731*IT_0145;
    const ccomplex_t IT_0147 = A_b*IT_0065*U_sb_01*conj(U_sb_11);
    ...
    const ccomplex_t IT_0155 = IT_0011 + IT_0024 + IT_0042 + IT_0051 + IT_0058
       + IT_0076 + -IT_0088 + (-2)*IT_0113 + IT_0130 + IT_0139 + IT_0154;
