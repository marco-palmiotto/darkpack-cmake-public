...
ccomplex_return_t c_sumSqAmpl_st_2_anti_sb_2_to_A0_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = m_b*e_em*mu_h*IT_0004*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0006 = IT_0001*IT_0005;
    const ccomplex_t IT_0007 = m_b*e_em*mu_h*IT_0004*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0008 = IT_0001*IT_0007;
    const ccomplex_t IT_0009 = sin(beta);
    const ccomplex_t IT_0010 = cpow(V_tb, 2);
    const ccomplex_t IT_0011 = A_b*IT_0010*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0012 = IT_0009*IT_0011;
    const ccomplex_t IT_0013 = 1.4142135623731*IT_0012;
    const ccomplex_t IT_0014 = A_b*IT_0010*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0020 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0021 = IT_0017*IT_0020;
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*IT_0021;
    const ccomplex_t IT_0023 = IT_0003*IT_0022;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0025 = -IT_0024;
    const ccomplex_t IT_0026 = 1.4142135623731*A_b*V_tb*V_td*IT_0009*conj
      (U_sb_11);
    const ccomplex_t IT_0027 = 0.5*IT_0026;
    const ccomplex_t IT_0028 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0029 = IT_0027*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*IT_0029;
    const ccomplex_t IT_0031 = IT_0025*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0033 = -IT_0032;
    const ccomplex_t IT_0034 = 1.4142135623731*A_b*V_tb*V_ts*IT_0009*conj
      (U_sb_11);
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_ss_L*
    ...
    const ccomplex_t IT_0043 = cpow(IT_0009, -1);
    const ccomplex_t IT_0044 = cpow(IT_0042, -1);
    const ccomplex_t IT_0045 = m_t*conj(U_sb_01)*(m_t*IT_0042*IT_0043*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0009*IT_0044*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0043*IT_0044*U_st_11));
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0009*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0004
      *IT_0045 + m_W*IT_0009*IT_0042*conj(U_sb_01)*U_st_01) + A_t*IT_0042*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0047 = pow(m_st_2, 2);
    const ccomplex_t IT_0048 = cpow((-2)*s_12 + -IT_0019 + -IT_0047 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = IT_0041*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001*conj(U_sb_01)*U_st_01;
    const ccomplex_t IT_0053 = -IT_0052;
    const ccomplex_t IT_0054 = m_b*e_em*mu_h*IT_0004*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0055 = IT_0001*IT_0054;
    const ccomplex_t IT_0056 = m_b*e_em*mu_h*IT_0004*U_sb_01*conj(U_sb_11);
    const ccomplex_t IT_0057 = IT_0001*IT_0056;
    const ccomplex_t IT_0058 = A_b*IT_0010*conj(U_sb_01)*U_sb_11;
    const ccomplex_t IT_0059 = IT_0009*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = A_b*IT_0010*U_sb_01*conj(U_sb_11);
    ...
    const ccomplex_t IT_0064 = (-0.5)*IT_0055 + 0.5*IT_0057 + (-0.5)*IT_0060 +
       0.5*IT_0063;
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0018 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = IT_0053*IT_0067;
    const ccomplex_t IT_0069 = -IT_0023 + -IT_0031 + -IT_0039 + IT_0051 + 
      -IT_0068;
    ...
    const ccomplex_t IT_0075 = m_t*e_em*mu_h*IT_0004*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0076 = IT_0001*IT_0075;
    const ccomplex_t IT_0077 = m_t*e_em*mu_h*IT_0004*conj(U_st_00)*U_st_11;
    const ccomplex_t IT_0078 = IT_0001*IT_0077;
    const ccomplex_t IT_0079 = A_t*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0080 = IT_0042*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = A_t*conj(U_st_00)*U_st_11;
    ...
    const ccomplex_t IT_0085 = 0.5*IT_0076 + (-0.5)*IT_0078 + 0.5*IT_0081 + (
      -0.5)*IT_0084;
    const ccomplex_t IT_0086 = cpow((-2)*s_13 + IT_0018 + IT_0047 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = IT_0074*IT_0088;
    const ccomplex_t IT_0090 = m_t*e_em*mu_h*IT_0004*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0091 = IT_0001*IT_0090;
    const ccomplex_t IT_0092 = m_t*e_em*mu_h*IT_0004*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0093 = IT_0001*IT_0092;
    const ccomplex_t IT_0094 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0095 = IT_0042*IT_0094;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0100 = (-0.5)*IT_0091 + 0.5*IT_0093 + (-0.5)*IT_0096 +
       0.5*IT_0099;
    const ccomplex_t IT_0101 = cpow((-2)*s_13 + IT_0018 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0102 = IT_0100*IT_0101;
    const ccomplex_t IT_0103 = (0 + _Complex_I*1)*IT_0102;
    const ccomplex_t IT_0104 = IT_0053*IT_0103;
    const ccomplex_t IT_0105 = IT_0023 + IT_0031 + IT_0039 + IT_0068 + IT_0089
       + IT_0104;
    ...
    return create_ccomplex_return((-3)*IT_0069*(conj(IT_0069)*(IT_0018 + 
      -IT_0072) + conj(IT_0105)*IT_0108) + (-3)*IT_0105*(conj(IT_0069)*IT_0108 +
       conj(IT_0105)*(IT_0019 + -IT_0110)));
}
