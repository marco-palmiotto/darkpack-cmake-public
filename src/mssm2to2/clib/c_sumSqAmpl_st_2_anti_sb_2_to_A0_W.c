        ...
        )
{
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_23 + IT_0018 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    const ccomplex_t IT_0020 = IT_0017*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*IT_0020;
    const ccomplex_t IT_0022 = IT_0003*IT_0021;
    const ccomplex_t IT_0023 = e_em*IT_0001;
    const ccomplex_t IT_0024 = -IT_0023;
    const ccomplex_t IT_0025 = cos(beta);
    const ccomplex_t IT_0026 = cpow(IT_0009, -1);
    const ccomplex_t IT_0027 = cpow(IT_0025, -1);
    const ccomplex_t IT_0028 = m_t*conj(U_sb_01)*(m_t*IT_0025*IT_0026*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0009*IT_0027*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0026*IT_0027*U_st_11));
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0009*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0004
      *IT_0028 + m_W*IT_0009*IT_0025*conj(U_sb_01)*U_st_01) + A_t*IT_0025*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0030 = pow(m_sb_2, 2);
    const ccomplex_t IT_0031 = pow(m_st_2, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_12 + -IT_0030 + -IT_0031 + m_Hp*
    ...
    const ccomplex_t IT_0038 = m_b*e_em*mu_h*IT_0004*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0039 = IT_0001*IT_0038;
    const ccomplex_t IT_0040 = m_b*e_em*mu_h*IT_0004*U_sb_00*conj(U_sb_11);
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = A_b*IT_0010*conj(U_sb_01)*U_sb_10;
    const ccomplex_t IT_0043 = IT_0009*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = A_b*IT_0010*U_sb_00*conj(U_sb_11);
    ...
    const ccomplex_t IT_0048 = (-0.5)*IT_0039 + 0.5*IT_0041 + (-0.5)*IT_0044 +
       0.5*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0018 + IT_0030 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = IT_0037*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0054 = -IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*A_b*V_tb*V_td*IT_0009*conj
      (U_sb_11);
    const ccomplex_t IT_0056 = 0.5*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0018 + IT_0030 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = IT_0054*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0062 = -IT_0061;
    const ccomplex_t IT_0063 = 1.4142135623731*A_b*V_tb*V_ts*IT_0009*conj
      (U_sb_11);
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0018 + IT_0030 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = IT_0062*IT_0067;
    const ccomplex_t IT_0069 = -IT_0022 + IT_0035 + -IT_0052 + -IT_0060 + 
      -IT_0068;
    ...
    const ccomplex_t IT_0085 = 0.5*IT_0076 + (-0.5)*IT_0078 + 0.5*IT_0081 + (
      -0.5)*IT_0084;
    const ccomplex_t IT_0086 = cpow((-2)*s_13 + IT_0018 + IT_0031 + -m_st_1*
    ...
    const ccomplex_t IT_0105 = IT_0022 + IT_0052 + IT_0060 + IT_0068 + IT_0089
       + IT_0104;
