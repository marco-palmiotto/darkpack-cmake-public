...
ccomplex_return_t c_sumSqAmpl_st_2_anti_sb_2_to_A_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_sb_2
      *Gamma_b2 + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = 0.333333333333333*IT_0011;
    const ccomplex_t IT_0047 = IT_0018*IT_0046;
    const ccomplex_t IT_0048 = IT_0013*IT_0046;
    const ccomplex_t IT_0049 = -IT_0048;
    const ccomplex_t IT_0050 = IT_0047 + IT_0049;
    const ccomplex_t IT_0051 = IT_0045*IT_0050;
    const ccomplex_t IT_0052 = -IT_0011;
    const ccomplex_t IT_0053 = IT_0013*IT_0052;
    const ccomplex_t IT_0054 = IT_0018*IT_0052;
    const ccomplex_t IT_0055 = IT_0009*IT_0022*IT_0054;
    const ccomplex_t IT_0056 = -IT_0053 + (-2)*IT_0055;
    const ccomplex_t IT_0057 = IT_0009*IT_0028*IT_0053;
    const ccomplex_t IT_0058 = IT_0054 + IT_0057;
    const ccomplex_t IT_0059 = IT_0056 + IT_0058;
    const ccomplex_t IT_0060 = IT_0008*IT_0059;
    const ccomplex_t IT_0061 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_st_2
      *Gamma_t2 + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*IT_0061;
    const ccomplex_t IT_0063 = (-1.33333333333333)*IT_0011;
    const ccomplex_t IT_0064 = IT_0018*IT_0063;
    const ccomplex_t IT_0065 = (-0.666666666666667)*IT_0011;
    const ccomplex_t IT_0066 = IT_0013*IT_0065;
    const ccomplex_t IT_0067 = IT_0064 + IT_0066;
    const ccomplex_t IT_0068 = IT_0013*IT_0063;
    const ccomplex_t IT_0069 = IT_0018*IT_0065;
    const ccomplex_t IT_0070 = -IT_0068 + -IT_0069;
    const ccomplex_t IT_0071 = IT_0067 + IT_0070;
    const ccomplex_t IT_0072 = IT_0062*IT_0071;
    const ccomplex_t IT_0073 = (-0.5)*IT_0051 + IT_0060 + 0.5*IT_0072;
    const ccomplex_t IT_0074 = IT_0009*IT_0014*IT_0028;
    const ccomplex_t IT_0075 = (-2)*IT_0011;
    const ccomplex_t IT_0076 = IT_0013*IT_0075;
    const ccomplex_t IT_0077 = IT_0009*IT_0028*IT_0076;
    const ccomplex_t IT_0078 = IT_0018*IT_0075;
    const ccomplex_t IT_0079 = IT_0023 + IT_0074 + IT_0077 + IT_0078;
    const ccomplex_t IT_0080 = IT_0009*IT_0022*IT_0023;
    const ccomplex_t IT_0081 = IT_0009*IT_0022*IT_0078;
    const ccomplex_t IT_0082 = -IT_0076 + (-2)*IT_0080 + (-2)*IT_0081;
    const ccomplex_t IT_0083 = IT_0079 + IT_0082;
    const ccomplex_t IT_0084 = IT_0008*IT_0083;
    const ccomplex_t IT_0085 = -IT_0068;
    ...
    const ccomplex_t IT_0116 = IT_0062*IT_0064;
    ...
    const ccomplex_t IT_0126 = -IT_0069;
    const ccomplex_t IT_0127 = IT_0064 + IT_0126;
    const ccomplex_t IT_0128 = IT_0062*IT_0127;
    const ccomplex_t IT_0129 = 0.5*IT_0051 + (-0.5)*IT_0128;
    ...
    const ccomplex_t IT_0134 = IT_0060 + (-0.5)*IT_0096;
    ...
    const ccomplex_t IT_0141 = IT_0039*conj(IT_0129) + IT_0129*(conj(IT_0039) 
      ...
      (IT_0134)*IT_0139) + IT_0133*(IT_0006*conj(IT_0133) + s_12*conj(IT_0134) +
       ...
       IT_0139*IT_0140);
    const ccomplex_t IT_0142 = IT_0045*IT_0047;
    const ccomplex_t IT_0143 = 0.5*IT_0128 + IT_0132 + (-0.5)*IT_0142;
    const ccomplex_t IT_0144 = IT_0089*IT_0120;
    const ccomplex_t IT_0145 = IT_0045*IT_0092;
    const ccomplex_t IT_0146 = -IT_0014 + (-2)*IT_0080 + (-2)*IT_0081;
