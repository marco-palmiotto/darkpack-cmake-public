        ...
        )
{
    ...
    const ccomplex_t IT_0023 = cpow(IT_0004, -1);
    ...
    const ccomplex_t IT_0030 = (-2)*U_sb_01*(((-0.5)*m_W*IT_0026*(IT_0001 + 1.
      /3*IT_0000*IT_0028) + IT_0001*IT_0005*IT_0021*IT_0023*IT_0029)*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_11
      *(IT_0001*IT_0007*IT_0022*IT_0023*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0000*IT_0026*IT_0028 + (-3)*IT_0001*IT_0005*IT_0021*IT_0023*IT_0029)
      *conj(U_sb_11));
    const ccomplex_t IT_0031 = (0 + _Complex_I*-1)*(e_em*IT_0030 + (
      -1.4142135623731)*A_b*IT_0005*IT_0020*(conj(U_sb_01)*U_sb_11 + U_sb_01
      *conj(U_sb_11)));
    ...
    const ccomplex_t IT_0040 = (-2)*U_sb_00*(((-0.5)*m_W*IT_0026*(IT_0001 + 1.
      /3*IT_0000*IT_0028) + IT_0001*IT_0005*IT_0021*IT_0023*IT_0029)*conj
      (U_sb_01) + -1./2*IT_0001*IT_0007*IT_0022*IT_0023*conj(U_sb_11)) + U_sb_10
      *(IT_0001*IT_0007*IT_0022*IT_0023*conj(U_sb_01) + 0.666666666666667*(m_W
      *IT_0000*IT_0026*IT_0028 + (-3)*IT_0001*IT_0005*IT_0021*IT_0023*IT_0029)
      *conj(U_sb_11));
    const ccomplex_t IT_0041 = (0 + _Complex_I*-1)*(e_em*IT_0040 + (
      -1.4142135623731)*A_b*IT_0005*IT_0020*(conj(U_sb_01)*U_sb_10 + U_sb_00
      *conj(U_sb_11)));
    const ccomplex_t IT_0042 = (-0.5)*IT_0041;
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0009 + IT_0033 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*IT_0044;
    const ccomplex_t IT_0046 = IT_0039*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0005
      *IT_0006 + -IT_0004*IT_0007);
    const ccomplex_t IT_0048 = cpow(IT_0006, -1);
    const ccomplex_t IT_0049 = m_t*conj(U_sb_01)*(m_t*IT_0004*IT_0048*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0006*IT_0023*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0023*IT_0048*U_st_11));
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0006*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0021
      *IT_0049 + m_W*IT_0004*IT_0006*conj(U_sb_01)*U_st_01) + A_t*IT_0004*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0051 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = IT_0047*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0056 = -IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_td
      *IT_0005*conj(U_sb_11);
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_23 + IT_0009 + IT_0033 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = IT_0056*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0064 = -IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0005*conj(U_sb_11);
    const ccomplex_t IT_0066 = (-0.5)*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0009 + IT_0033 + -m_ss_L*
    ...
    const ccomplex_t IT_0076 = m_b*mu_h*IT_0006*IT_0021*IT_0023*conj(U_sb_11)
      *U_st_01 + -conj(U_sb_01)*((IT_0021*(IT_0029 + -IT_0073) + -m_W*(IT_0074 +
       -IT_0075))*U_st_01 + m_t*mu_h*IT_0004*IT_0021*IT_0048*U_st_11);
    ...
    const ccomplex_t IT_0084 = -IT_0037 + -IT_0046 + IT_0054 + -IT_0062 + 
      -IT_0070 + IT_0083;
    const ccomplex_t IT_0085 = s_14*s_34*IT_0016;
    const ccomplex_t IT_0086 = -IT_0085;
    const ccomplex_t IT_0087 = s_13 + IT_0086;
    const ccomplex_t IT_0088 = -IT_0019;
    const ccomplex_t IT_0089 = IT_0003 + IT_0088;
    const ccomplex_t IT_0090 = IT_0013*IT_0089;
    const ccomplex_t IT_0091 = m_t*mu_h*IT_0021;
    const ccomplex_t IT_0092 = -IT_0006*IT_0007 + IT_0025;
    const ccomplex_t IT_0093 = (-2)*U_st_01*((IT_0001*IT_0007*IT_0021*IT_0048
      *IT_0073 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0028)*IT_0092)*conj(U_st_01
      ) + -1./2*IT_0001*IT_0005*IT_0048*IT_0091*conj(U_st_11)) + U_st_11*
      (IT_0001*IT_0005*IT_0048*IT_0091*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0021*IT_0048*IT_0073 + m_W*IT_0000*IT_0028*IT_0092)
      *conj(U_st_11));
    ...
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0033 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0102 = (-2)*conj(U_st_00)*((IT_0001*IT_0007*IT_0021
      *IT_0048*IT_0073 + 0.5*m_W*(IT_0001 + -1./3*IT_0000*IT_0028)*IT_0092)
      *U_st_01 + -1./2*IT_0001*IT_0005*IT_0048*IT_0091*U_st_11) + conj(U_st_10)*
      (IT_0001*IT_0005*IT_0048*IT_0091*U_st_01 + (-1.33333333333333)*(1.5
      *IT_0001*IT_0007*IT_0021*IT_0048*IT_0073 + m_W*IT_0000*IT_0028*IT_0092)
      *U_st_11);
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0010 + IT_0033 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = IT_0101*IT_0107;
    const ccomplex_t IT_0109 = IT_0037 + IT_0046 + IT_0062 + IT_0070 + 
      -IT_0090 + IT_0099 + IT_0108;
