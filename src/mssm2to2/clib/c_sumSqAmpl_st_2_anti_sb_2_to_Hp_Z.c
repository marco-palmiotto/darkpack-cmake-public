...
ccomplex_return_t c_sumSqAmpl_st_2_anti_sb_2_to_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0009*U_st_01 
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      ...
      *IT_0011 + m_W*IT_0006*IT_0007*conj(U_sb_01)*U_st_01) + A_t*IT_0006*conj
      (U_sb_01)*U_st_11);
    ...
    const ccomplex_t IT_0021 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0009*U_st_00 
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      ...
      *IT_0021 + m_W*IT_0006*IT_0007*conj(U_sb_01)*U_st_00) + A_t*IT_0006*conj
      (U_sb_01)*U_st_10);
    ...
    const ccomplex_t IT_0045 = m_t*conj(U_sb_00)*(m_t*IT_0006*IT_0009*U_st_01 
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0007*conj
      ...
      *IT_0045 + m_W*IT_0006*IT_0007*conj(U_sb_00)*U_st_01) + A_t*IT_0006*conj
      (U_sb_00)*U_st_11);
