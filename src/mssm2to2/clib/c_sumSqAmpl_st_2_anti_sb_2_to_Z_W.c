        ...
        )
{
    ...
    const ccomplex_t IT_0018 = m_b*mu_h*IT_0010*IT_0011*IT_0012*conj(U_sb_11)
      *U_st_01 + -conj(U_sb_01)*((IT_0011*(IT_0014 + -IT_0015) + -m_W*(IT_0016 +
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0018*IT_0020 + A_b*IT_0009*conj(U_sb_11)*U_st_01 + -A_t*IT_0010
    ...
    const ccomplex_t IT_0030 = 0.5*IT_0006 + 0.5*IT_0007;
    ...
    const ccomplex_t IT_0041 = s_12 + IT_0006;
    const ccomplex_t IT_0042 = -IT_0033;
    const ccomplex_t IT_0043 = IT_0032*IT_0042;
    const ccomplex_t IT_0044 = IT_0041*IT_0043;
    const ccomplex_t IT_0045 = IT_0037*IT_0042;
    ...
    const ccomplex_t IT_0057 = IT_0029*(IT_0035 + IT_0056);
    ...
    const ccomplex_t IT_0063 = (IT_0007 + -IT_0060)*(IT_0007 + -IT_0062);
    ...
    const ccomplex_t IT_0067 = IT_0007 + -IT_0060 + IT_0065 + IT_0066;
    const ccomplex_t IT_0068 = 3*IT_0050;
    const ccomplex_t IT_0069 = 3*conj(IT_0050);
    const ccomplex_t IT_0070 = pow(m_Z, 2);
    const ccomplex_t IT_0071 = cpow((-2)*s_13 + IT_0007 + IT_0070 + -m_st_1*
    ...
    const ccomplex_t IT_0105 = IT_0029*(IT_0035 + -IT_0043 + IT_0056);
    ...
    const ccomplex_t IT_0116 = (IT_0007 + -IT_0062)*(s_12 + -IT_0094);
    const ccomplex_t IT_0117 = -IT_0116;
    const ccomplex_t IT_0118 = (-3)*conj(IT_0058);
    const ccomplex_t IT_0119 = cpow((-2)*s_23 + IT_0070 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0121 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
      *IT_0019 + 3*IT_0001*IT_0020)*U_sb_01*conj(U_sb_01) + IT_0002*IT_0019
    ...
    const ccomplex_t IT_0125 = cpow((-2)*s_23 + IT_0006 + IT_0070 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*IT_0125;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
      *IT_0019 + 3*IT_0001*IT_0020)*U_sb_00*conj(U_sb_01) + IT_0002*IT_0019
    ...
    const ccomplex_t IT_0133 = -IT_0043 + -IT_0080;
    ...
    const ccomplex_t IT_0144 = IT_0006 + IT_0139 + IT_0140 + IT_0143;
    const ccomplex_t IT_0145 = (s_12 + -IT_0092)*(IT_0006 + -IT_0142);
    ...
    const ccomplex_t IT_0151 = (IT_0006 + -IT_0099)*(IT_0006 + -IT_0142);
    const ccomplex_t IT_0152 = IT_0042*IT_0109;
    ...
    const ccomplex_t IT_0157 = (s_23 + -IT_0137)*(IT_0006 + -IT_0142);
    ...
    const ccomplex_t IT_0165 = (IT_0007 + -IT_0062)*(IT_0006 + -IT_0142);
    ...
    const ccomplex_t IT_0172 = (IT_0007 + -IT_0060)*(s_13 + -IT_0107);
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = (IT_0007 + -IT_0060)*(s_23 + -IT_0137);
    ...
    const ccomplex_t IT_0188 = (s_13 + -IT_0107)*(IT_0006 + -IT_0142);
    const ccomplex_t IT_0189 = -IT_0188;
    const ccomplex_t IT_0190 = (-0.333333333333333)*IT_0189;
    const ccomplex_t IT_0191 = (IT_0006 + -IT_0142)*(IT_0070 + -IT_0177);
