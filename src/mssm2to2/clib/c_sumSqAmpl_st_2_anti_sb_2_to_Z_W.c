...
ccomplex_return_t c_sumSqAmpl_st_2_anti_sb_2_to_Z_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = m_b*mu_h*IT_0006*IT_0007*IT_0008*conj(U_sb_11)
      *U_st_01 + -conj(U_sb_01)*((IT_0007*(IT_0010 + -IT_0011) + -m_W*(IT_0012 +
       -IT_0013))*U_st_01 + m_t*mu_h*IT_0005*IT_0007*IT_0009*U_st_11);
    const ccomplex_t IT_0015 = sin(theta_W);
    const ccomplex_t IT_0016 = cpow(IT_0015, -1);
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0014*IT_0016 + A_b*IT_0005*conj(U_sb_11)*U_st_01 + -A_t*IT_0006
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0016*conj(U_sb_01)*U_st_00;
    const ccomplex_t IT_0071 = -IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0015 
      + (-3)*IT_0001*IT_0016)*conj(U_st_00)*U_st_01 + IT_0002*IT_0015*conj
      (U_st_10)*U_st_11);
    ...
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0024 + IT_0075 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0077 = (0 + _Complex_I*1)*IT_0076;
    const ccomplex_t IT_0078 = IT_0074*IT_0077;
    const ccomplex_t IT_0079 = IT_0033 + IT_0056;
    const ccomplex_t IT_0080 = IT_0037*IT_0055;
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0015 
      + (-3)*IT_0001*IT_0016)*U_st_01*conj(U_st_01) + IT_0002*IT_0015*U_st_11
      *conj(U_st_11));
    const ccomplex_t IT_0085 = 1.33333333333333*IT_0084;
    const ccomplex_t IT_0086 = IT_0037*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0075 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = IT_0086*IT_0088;
    const ccomplex_t IT_0090 = -IT_0078 + -IT_0083 + -IT_0089;
    ...
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0016*conj(U_sb_00)*U_st_01;
    const ccomplex_t IT_0130 = -IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0002
    ...
    const ccomplex_t IT_0134 = cpow((-2)*s_23 + IT_0023 + IT_0075 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*IT_0134;
    const ccomplex_t IT_0136 = IT_0133*IT_0135;
    const ccomplex_t IT_0137 = -IT_0124 + IT_0128 + -IT_0136;
    const ccomplex_t IT_0138 = s_34*IT_0051;
    const ccomplex_t IT_0139 = s_23*s_34*IT_0052;
    const ccomplex_t IT_0140 = -IT_0139;
    const ccomplex_t IT_0141 = s_24 + IT_0140;
    const ccomplex_t IT_0142 = IT_0138*IT_0141;
    const ccomplex_t IT_0143 = -IT_0038 + -IT_0080;
    const ccomplex_t IT_0144 = IT_0079 + IT_0143;
    const ccomplex_t IT_0145 = IT_0029*IT_0144;
    const ccomplex_t IT_0146 = IT_0124 + IT_0136 + -IT_0145;
    const ccomplex_t IT_0147 = pow(s_23, 2);
    const ccomplex_t IT_0148 = IT_0052*IT_0147;
    const ccomplex_t IT_0149 = s_24*s_34*IT_0051;
    const ccomplex_t IT_0150 = (IT_0023 + -IT_0148)*(s_23 + -IT_0149);
    const ccomplex_t IT_0151 = -IT_0150;
    const ccomplex_t IT_0152 = IT_0051*IT_0053;
    const ccomplex_t IT_0153 = (IT_0023 + -IT_0148)*(IT_0075 + -IT_0152);
    const ccomplex_t IT_0154 = -IT_0153;
    const ccomplex_t IT_0155 = (s_12 + -IT_0094)*(s_23 + -IT_0149);
    const ccomplex_t IT_0156 = (s_12 + -IT_0094)*(IT_0075 + -IT_0152);
    const ccomplex_t IT_0157 = (s_13 + -IT_0110)*(IT_0023 + -IT_0148);
    const ccomplex_t IT_0158 = -IT_0157;
    const ccomplex_t IT_0159 = (-3)*IT_0106;
    const ccomplex_t IT_0160 = 3*conj(IT_0058);
    const ccomplex_t IT_0161 = 3*conj(IT_0090);
    const ccomplex_t IT_0162 = 3*conj(IT_0114);
    const ccomplex_t IT_0163 = (-3)*conj(IT_0106);
    const ccomplex_t IT_0164 = (-3)*conj(IT_0050);
    const ccomplex_t IT_0165 = s_23*s_24*s_34*IT_0051*IT_0052;
    const ccomplex_t IT_0166 = -IT_0099;
    const ccomplex_t IT_0167 = -IT_0148;
    const ccomplex_t IT_0168 = IT_0023 + IT_0165 + IT_0166 + IT_0167;
    const ccomplex_t IT_0169 = (s_12 + -IT_0092)*(IT_0023 + -IT_0148);
    const ccomplex_t IT_0170 = -IT_0169;
    const ccomplex_t IT_0171 = (s_12 + -IT_0094)*(IT_0023 + -IT_0099);
    const ccomplex_t IT_0172 = -IT_0171;
    const ccomplex_t IT_0173 = (-3)*conj(IT_0090);
    const ccomplex_t IT_0174 = (IT_0023 + -IT_0099)*(IT_0023 + -IT_0148);
    const ccomplex_t IT_0175 = (-3)*IT_0090;
    const ccomplex_t IT_0176 = 0.333333333333333*IT_0109;
    const ccomplex_t IT_0177 = (-3)*conj(IT_0146)*(IT_0137*IT_0151 + (
      -0.333333333333333)*IT_0115*IT_0155 + (-0.333333333333333)*IT_0068*IT_0168
       + (-0.333333333333333)*IT_0159*IT_0170 + -IT_0146*IT_0174 + (
      -0.333333333333333)*IT_0172*IT_0175 + -IT_0064*IT_0176);
    const ccomplex_t IT_0178 = (IT_0024 + -IT_0062)*(IT_0023 + -IT_0148);
    const ccomplex_t IT_0179 = s_13*s_34*IT_0052;
    const ccomplex_t IT_0180 = -IT_0179;
    const ccomplex_t IT_0181 = s_14 + IT_0180;
    const ccomplex_t IT_0182 = IT_0138*IT_0181;
    const ccomplex_t IT_0183 = (IT_0024 + -IT_0060)*(s_23 + -IT_0149);
    const ccomplex_t IT_0184 = -IT_0183;
    const ccomplex_t IT_0185 = (-0.333333333333333)*IT_0184;
    const ccomplex_t IT_0186 = (IT_0024 + -IT_0060)*(s_13 + -IT_0110);
    const ccomplex_t IT_0187 = -IT_0186;
    const ccomplex_t IT_0188 = (-0.333333333333333)*IT_0187;
    const ccomplex_t IT_0189 = (IT_0024 + -IT_0060)*(IT_0075 + -IT_0152);
    const ccomplex_t IT_0190 = -IT_0189;
    const ccomplex_t IT_0191 = 6*IT_0050*conj(IT_0050)*(1 + 0.5*IT_0054) +
       conj(IT_0058)*(IT_0063*IT_0064 + IT_0067*IT_0068) + IT_0058*IT_0067
      *IT_0069 + conj(IT_0090)*(IT_0068*IT_0097 + IT_0100*IT_0101 + IT_0103
      *IT_0104) + conj(IT_0106)*(IT_0068*IT_0108 + IT_0101*IT_0109 + IT_0111
      *IT_0115 + IT_0104*IT_0117) + IT_0090*(IT_0069*IT_0097 + IT_0103*IT_0118) 
      + (-3)*conj(IT_0137)*((-0.333333333333333)*IT_0064*IT_0111 + IT_0050
      *IT_0142 + IT_0146*IT_0151 + IT_0137*IT_0154 + (-0.333333333333333)
      *IT_0101*IT_0155 + (-0.333333333333333)*IT_0115*IT_0156 + (
      -0.333333333333333)*IT_0158*IT_0159) + IT_0137*(IT_0111*IT_0160 + IT_0155
      *IT_0161 + IT_0156*IT_0162 + IT_0158*IT_0163 + IT_0142*IT_0164) + IT_0146*
      (IT_0109*IT_0160 + IT_0155*IT_0162 + IT_0069*IT_0168 + IT_0163*IT_0170 +
       IT_0172*IT_0173) + IT_0177 + 3*IT_0106*(0.333333333333333*IT_0069*IT_0108
       + 0.333333333333333*IT_0117*IT_0118 + 0.333333333333333*IT_0111*IT_0162 +
       IT_0161*IT_0176 + conj(IT_0106)*IT_0178) + (-3)*conj(IT_0114)*(IT_0050
      *IT_0182 + IT_0175*IT_0185 + IT_0104*IT_0188) + (-3)*IT_0114*((
      -0.333333333333333)*IT_0164*IT_0182 + IT_0173*IT_0185 + IT_0118*IT_0188 +
       conj(IT_0114)*IT_0190);
