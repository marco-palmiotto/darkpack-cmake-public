        ...
        )
{
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0025 + (0 + _Complex_I*1)
      *m_sb_2*Gamma_b2 + reg_prop, -1);
    const ccomplex_t IT_0058 = m_t*conj(U_sb_01)*(m_t*IT_0001*IT_0011*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0005*IT_0010*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0010*IT_0011*U_st_11));
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0019*((-0.5)*IT_0017
      *IT_0058 + m_W*IT_0001*IT_0005*conj(U_sb_01)*U_st_01) + A_t*IT_0001*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0060 = cpow(V_tb, 2);
    const ccomplex_t IT_0061 = m_b*mu_h*IT_0017;
    const ccomplex_t IT_0062 = IT_0001*IT_0009;
    const ccomplex_t IT_0063 = IT_0002*IT_0005;
    const ccomplex_t IT_0064 = IT_0062 + IT_0063;
    const ccomplex_t IT_0065 = cos(theta_W);
    const ccomplex_t IT_0066 = cpow(IT_0065, -2);
    const ccomplex_t IT_0067 = 2*U_sb_01*((IT_0007*IT_0009*IT_0010*IT_0017
      *IT_0019 + (-0.5)*m_W*IT_0064*(IT_0019 + 1./3*IT_0013*IT_0066))*conj
      (U_sb_01) + 1./2*IT_0002*IT_0010*IT_0019*IT_0061*conj(U_sb_11)) + U_sb_11*
      (IT_0002*IT_0010*IT_0019*IT_0061*conj(U_sb_01) + 2*(IT_0007*IT_0009
      *IT_0010*IT_0017*IT_0019 + -1./3*m_W*IT_0013*IT_0064*IT_0066)*conj(U_sb_11
      ));
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*(e_em*IT_0067 +
       1.4142135623731*A_b*IT_0009*IT_0060*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0059*IT_0069;
    const ccomplex_t IT_0071 = IT_0057*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_13 + IT_0025 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0074 = m_t*mu_h*IT_0017;
    const ccomplex_t IT_0075 = U_st_11*(IT_0009*IT_0011*IT_0019*IT_0074*conj
      (U_st_01) + (-1.33333333333333)*((-1.5)*IT_0002*IT_0004*IT_0011*IT_0017
      *IT_0019 + m_W*IT_0013*IT_0064*IT_0066)*conj(U_st_11)) + 2*U_st_01*(
      (IT_0002*IT_0004*IT_0011*IT_0017*IT_0019 + (-0.5)*m_W*IT_0064*(IT_0019 + 
      -1./3*IT_0013*IT_0066))*conj(U_st_01) + 1./2*IT_0009*IT_0011*IT_0019
      *IT_0074*conj(U_st_11));
    ...
    const ccomplex_t IT_0081 = cpow((-2)*s_12 + -IT_0026 + -IT_0030 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0013*IT_0066;
    const ccomplex_t IT_0083 = -IT_0019 + IT_0082;
    const ccomplex_t IT_0084 = cpow(IT_0005, 3);
    const ccomplex_t IT_0085 = 3*IT_0019 + IT_0082;
    const ccomplex_t IT_0086 = cpow(IT_0005, 2);
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*m_W*e_em*(IT_0002*IT_0083
      *IT_0084 + -IT_0001*(IT_0001*(IT_0001*IT_0009*IT_0083 + IT_0002*IT_0005
      *IT_0085) + -IT_0009*IT_0085*IT_0086));
    ...
    const ccomplex_t IT_0092 = m_t*conj(U_sb_00)*(m_t*IT_0001*IT_0011*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0005*IT_0010*conj(U_sb_00)*U_st_01 + conj
      (U_sb_10)*(mu_h*U_st_01 + m_t*IT_0010*IT_0011*U_st_11));
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_10)*U_st_01 + (-1.4142135623731)*e_em*IT_0019*((-0.5)*IT_0017
      *IT_0092 + m_W*IT_0001*IT_0005*conj(U_sb_00)*U_st_01) + A_t*IT_0001*conj
      (U_sb_00)*U_st_11);
    const ccomplex_t IT_0094 = 2*U_sb_00*((IT_0007*IT_0009*IT_0010*IT_0017
      *IT_0019 + (-0.5)*m_W*IT_0064*(IT_0019 + 1./3*IT_0013*IT_0066))*conj
      (U_sb_01) + 1./2*IT_0002*IT_0010*IT_0019*IT_0061*conj(U_sb_11)) + U_sb_10*
      (IT_0002*IT_0010*IT_0019*IT_0061*conj(U_sb_01) + 2*(IT_0007*IT_0009
      *IT_0010*IT_0017*IT_0019 + -1./3*m_W*IT_0013*IT_0064*IT_0066)*conj(U_sb_11
      ));
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*(e_em*IT_0094 +
       1.4142135623731*A_b*IT_0009*IT_0060*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    const ccomplex_t IT_0096 = 0.5*IT_0095;
    const ccomplex_t IT_0097 = IT_0093*IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0099 = IT_0097*IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1)*IT_0099;
    const ccomplex_t IT_0101 = cpow(IT_0001, 2);
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*m_W*e_em*(IT_0009*IT_0019
      *IT_0084 + (-2)*IT_0001*(IT_0005*(IT_0002*IT_0005 + IT_0001*IT_0009)*(0.5
      *IT_0019 + IT_0013*IT_0066) + -1./2*IT_0002*IT_0019*IT_0101));
    const ccomplex_t IT_0103 = 0.5*IT_0102;
    const ccomplex_t IT_0104 = m_b*mu_h*IT_0005*IT_0010*IT_0017*conj(U_sb_11)
      *U_st_01 + conj(U_sb_01)*(((IT_0004 + -IT_0007)*IT_0017 + -m_W*(IT_0086 + 
      -IT_0101))*U_st_01 + -m_t*mu_h*IT_0001*IT_0011*IT_0017*U_st_11);
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0019*IT_0104 + A_b*IT_0001*conj(U_sb_11)*U_st_01 + -A_t*IT_0005
    ...
    const ccomplex_t IT_0109 = cpow((-2)*s_12 + -IT_0026 + -IT_0030 + IT_0108 
      + -reg_prop, -1);
    const ccomplex_t IT_0110 = IT_0107*IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*IT_0110;
    const ccomplex_t IT_0112 = cpow((-2)*s_13 + IT_0025 + IT_0030 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0113 = m_t*conj(U_sb_01)*(m_t*IT_0001*IT_0011*U_st_00 
      + mu_h*U_st_10) + m_b*(m_b*IT_0005*IT_0010*conj(U_sb_01)*U_st_00 + conj
      (U_sb_11)*(mu_h*U_st_00 + m_t*IT_0010*IT_0011*U_st_10));
    const ccomplex_t IT_0114 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_11)*U_st_00 + (-1.4142135623731)*e_em*IT_0019*((-0.5)*IT_0017
      *IT_0113 + m_W*IT_0001*IT_0005*conj(U_sb_01)*U_st_00) + A_t*IT_0001*conj
      (U_sb_01)*U_st_10);
    const ccomplex_t IT_0115 = conj(U_st_10)*(IT_0009*IT_0011*IT_0019*IT_0074
      *U_st_01 + (-1.33333333333333)*((-1.5)*IT_0002*IT_0004*IT_0011*IT_0017
      *IT_0019 + m_W*IT_0013*IT_0064*IT_0066)*U_st_11) + 2*conj(U_st_00)*(
      (IT_0002*IT_0004*IT_0011*IT_0017*IT_0019 + (-0.5)*m_W*IT_0064*(IT_0019 + 
      -1./3*IT_0013*IT_0066))*U_st_01 + 1./2*IT_0009*IT_0011*IT_0019*IT_0074
      *U_st_11);
    ...
    const ccomplex_t IT_0122 = A_t*IT_0001*U_st_11 + (-1.4142135623731)*e_em
      *IT_0019*(m_W*IT_0001*IT_0005*U_st_01 + (-0.5)*IT_0017*(IT_0005*IT_0010
      *IT_0121*U_st_01 + m_t*(m_t*IT_0001*IT_0011*U_st_01 + mu_h*U_st_11)));
    ...
    const ccomplex_t IT_0127 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sd_L*
    ...
    const ccomplex_t IT_0134 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_sd_R*
    ...
    const ccomplex_t IT_0141 = cpow((-2)*s_23 + IT_0025 + IT_0026 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0142 = IT_0140*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*IT_0142;
    const ccomplex_t IT_0144 = IT_0016 + IT_0029 + (-2)*IT_0056 + IT_0072 +
       IT_0080 + -IT_0091 + IT_0100 + -IT_0111 + IT_0120 + IT_0129 + IT_0136 +
       IT_0143;
