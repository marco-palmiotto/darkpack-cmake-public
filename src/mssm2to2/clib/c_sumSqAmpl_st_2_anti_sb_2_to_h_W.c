...
ccomplex_return_t c_sumSqAmpl_st_2_anti_sb_2_to_h_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0022*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0005*IT_0023*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0022*IT_0023*U_st_11));
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0021
      *IT_0024 + m_W*IT_0005*IT_0006*conj(U_sb_01)*U_st_01) + A_t*IT_0006*conj
      (U_sb_01)*U_st_11);
    ...
    const ccomplex_t IT_0030 = -IT_0002;
    const ccomplex_t IT_0031 = cpow(V_tb, 2);
    const ccomplex_t IT_0032 = m_b*mu_h*IT_0021;
    const ccomplex_t IT_0033 = IT_0006*IT_0007;
    ...
    const ccomplex_t IT_0039 = 2*U_sb_01*(((-0.5)*m_W*IT_0035*(IT_0001 + 1./3
      *IT_0000*IT_0037) + IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj(U_sb_01)
       + 1./2*IT_0001*IT_0004*IT_0023*IT_0032*conj(U_sb_11)) + U_sb_11*(IT_0001
      *IT_0004*IT_0023*IT_0032*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0000
      *IT_0035*IT_0037 + (-3)*IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj
      (U_sb_11));
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*(e_em*IT_0039 +
       1.4142135623731*A_b*IT_0007*IT_0031*(conj(U_sb_01)*U_sb_11 + U_sb_01*conj
      (U_sb_11)));
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = pow(m_h, 2);
    const ccomplex_t IT_0043 = cpow((-2)*s_23 + IT_0042 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0052 = m_b*mu_h*IT_0005*IT_0021*IT_0023*conj(U_sb_11)
      *U_st_01 + -conj(U_sb_01)*((IT_0021*(IT_0038 + -IT_0049) + -m_W*(IT_0050 +
       -IT_0051))*U_st_01 + m_t*mu_h*IT_0006*IT_0021*IT_0022*U_st_11);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0001*IT_0052 + A_b*IT_0006*conj(U_sb_11)*U_st_01 + -A_t*IT_0005
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_23 + IT_0009 + IT_0042 + -m_sd_L*
    ...
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
      *e_em*IT_0001*U_st_01;
    const ccomplex_t IT_0069 = -IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*V_ts
      *IT_0007*conj(U_sb_11);
    const ccomplex_t IT_0071 = 0.5*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0009 + IT_0042 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0073 = IT_0071*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1)*IT_0073;
    const ccomplex_t IT_0075 = IT_0069*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1.4142135623731)*V_tb*e_em
      *IT_0001*conj(U_sb_00)*U_st_01;
    const ccomplex_t IT_0077 = -IT_0076;
    const ccomplex_t IT_0078 = 2*U_sb_00*(((-0.5)*m_W*IT_0035*(IT_0001 + 1./3
      *IT_0000*IT_0037) + IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj(U_sb_01)
       + 1./2*IT_0001*IT_0004*IT_0023*IT_0032*conj(U_sb_11)) + U_sb_10*(IT_0001
      *IT_0004*IT_0023*IT_0032*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0000
      *IT_0035*IT_0037 + (-3)*IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj
      (U_sb_11));
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*(e_em*IT_0078 +
       1.4142135623731*A_b*IT_0007*IT_0031*(conj(U_sb_01)*U_sb_10 + U_sb_00*conj
      (U_sb_11)));
    const ccomplex_t IT_0080 = 0.5*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_23 + IT_0009 + IT_0042 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = IT_0077*IT_0083;
    const ccomplex_t IT_0085 = IT_0029 + -IT_0046 + IT_0059 + -IT_0067 + 
      -IT_0075 + -IT_0084;
    ...
    const ccomplex_t IT_0090 = U_st_11*(IT_0001*IT_0007*IT_0022*IT_0089*conj
      (U_st_01) + (-1.33333333333333)*(m_W*IT_0000*IT_0035*IT_0037 + (-1.5)
      *IT_0001*IT_0004*IT_0021*IT_0022*IT_0049)*conj(U_st_11)) + 2*U_st_01*(((
      -0.5)*m_W*IT_0035*(IT_0001 + -1./3*IT_0000*IT_0037) + IT_0001*IT_0004
      *IT_0021*IT_0022*IT_0049)*conj(U_st_01) + 1./2*IT_0001*IT_0007*IT_0022
    ...
    const ccomplex_t IT_0093 = cpow((-2)*s_13 + IT_0042 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0097 = -IT_0030;
    const ccomplex_t IT_0098 = IT_0003 + IT_0097;
    const ccomplex_t IT_0099 = IT_0013*IT_0098;
    const ccomplex_t IT_0100 = 2*U_sb_00*(((-0.5)*m_W*IT_0035*(IT_0001 + 1./3
      *IT_0000*IT_0037) + IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj(U_sb_01)
       + 1./2*IT_0001*IT_0004*IT_0023*IT_0032*conj(U_sb_11)) + U_sb_10*(IT_0001
      *IT_0004*IT_0023*IT_0032*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0000
      *IT_0035*IT_0037 + (-3)*IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj
    ...
    const ccomplex_t IT_0108 = conj(U_st_10)*(IT_0001*IT_0007*IT_0022*IT_0089
      *U_st_01 + (-1.33333333333333)*(m_W*IT_0000*IT_0035*IT_0037 + (-1.5)
      *IT_0001*IT_0004*IT_0021*IT_0022*IT_0049)*U_st_11) + 2*conj(U_st_00)*(((
      -0.5)*m_W*IT_0035*(IT_0001 + -1./3*IT_0000*IT_0037) + IT_0001*IT_0004
      *IT_0021*IT_0022*IT_0049)*U_st_01 + 1./2*IT_0001*IT_0007*IT_0022*IT_0089
      *U_st_11);
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_13 + IT_0010 + IT_0042 + -m_st_1*
    ...
    const ccomplex_t IT_0115 = 2*U_sb_01*(((-0.5)*m_W*IT_0035*(IT_0001 + 1./3
      *IT_0000*IT_0037) + IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj(U_sb_01)
       + 1./2*IT_0001*IT_0004*IT_0023*IT_0032*conj(U_sb_11)) + U_sb_11*(IT_0001
      *IT_0004*IT_0023*IT_0032*conj(U_sb_01) + (-0.666666666666667)*(m_W*IT_0000
      *IT_0035*IT_0037 + (-3)*IT_0001*IT_0007*IT_0021*IT_0023*IT_0038)*conj
    ...
    const ccomplex_t IT_0121 = IT_0067 + IT_0075 + IT_0096 + -IT_0099 +
    ...
    const ccomplex_t IT_0134 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ...
      *IT_0125 + (-3)*IT_0085*((-0.333333333333333)*IT_0088*IT_0125 + conj
      (IT_0085)*(IT_0042 + -IT_0127) + conj(IT_0121)*IT_0130) + (conj(IT_0085)
