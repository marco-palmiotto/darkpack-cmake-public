        ...
        )
{
    ...
    const ccomplex_t IT_0041 = cpow(IT_0005, -1);
    const ccomplex_t IT_0042 = pow(m_t, 2);
    const ccomplex_t IT_0043 = cpow(IT_0006, 2);
    const ccomplex_t IT_0044 = cpow(IT_0005, 2);
    const ccomplex_t IT_0045 = m_b*mu_h*IT_0005*IT_0022*IT_0024*conj(U_sb_11)
      *U_st_01 + -conj(U_sb_01)*((IT_0022*(IT_0030 + -IT_0042) + -m_W*(IT_0043 +
       -IT_0044))*U_st_01 + m_t*mu_h*IT_0006*IT_0022*IT_0041*U_st_11);
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0001*IT_0045 + A_b*IT_0006*conj(U_sb_11)*U_st_01 + -A_t*IT_0005
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0006 + IT_0005*IT_0007);
    const ccomplex_t IT_0054 = -IT_0053;
    const ccomplex_t IT_0055 = m_t*conj(U_sb_01)*(m_t*IT_0006*IT_0041*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0005*IT_0024*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0024*IT_0041*U_st_11));
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0005*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0001*((-0.5)*IT_0022
      *IT_0055 + m_W*IT_0005*IT_0006*conj(U_sb_01)*U_st_01) + A_t*IT_0006*conj
      (U_sb_01)*U_st_11);
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0009 + IT_0034 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = IT_0062*IT_0067;
    const ccomplex_t IT_0069 = -IT_0002;
    const ccomplex_t IT_0070 = 2*U_sb_01*(((-0.5)*m_W*IT_0027*(IT_0001 + 1./3
      *IT_0000*IT_0029) + IT_0001*IT_0007*IT_0022*IT_0024*IT_0030)*conj(U_sb_01)
    ...
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0034 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0094 = m_t*mu_h*IT_0022;
    const ccomplex_t IT_0095 = conj(U_st_10)*(IT_0001*IT_0007*IT_0041*IT_0094
      *U_st_01 + (-1.33333333333333)*(m_W*IT_0000*IT_0027*IT_0029 + (-1.5)
      *IT_0001*IT_0004*IT_0022*IT_0041*IT_0042)*U_st_11) + 2*conj(U_st_00)*(((
      -0.5)*m_W*IT_0027*(IT_0001 + -1./3*IT_0000*IT_0029) + IT_0001*IT_0004
      *IT_0022*IT_0041*IT_0042)*U_st_01 + 1./2*IT_0001*IT_0007*IT_0041*IT_0094
      *U_st_11);
    ...
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0010 + IT_0034 + -m_st_1*
    ...
    const ccomplex_t IT_0102 = U_st_11*(IT_0001*IT_0007*IT_0041*IT_0094*conj
      (U_st_01) + (-1.33333333333333)*(m_W*IT_0000*IT_0027*IT_0029 + (-1.5)
      *IT_0001*IT_0004*IT_0022*IT_0041*IT_0042)*conj(U_st_11)) + 2*U_st_01*(((
      -0.5)*m_W*IT_0027*(IT_0001 + -1./3*IT_0000*IT_0029) + IT_0001*IT_0004
      *IT_0022*IT_0041*IT_0042)*conj(U_st_01) + 1./2*IT_0001*IT_0007*IT_0041
    ...
    const ccomplex_t IT_0109 = IT_0038 + IT_0068 + IT_0076 + IT_0084 + 
