        ...
        )
{
    ...
    const ccomplex_t IT_0042 = m_b*N_d1*e_em*IT_0033*conj(U_sb_11);
    const ccomplex_t IT_0043 = IT_0041*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = N_B1*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0059 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0060 = IT_0023*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = conj(N_W2)*e_em*U_st_01;
    const ccomplex_t IT_0063 = IT_0010*IT_0062;
    const ccomplex_t IT_0064 = 1.4142135623731*IT_0063;
    const ccomplex_t IT_0065 = m_t*conj(N_u2)*e_em*IT_0033*U_st_11;
    ...
    const ccomplex_t IT_0104 = N_B3*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0149 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0150 = IT_0023*IT_0149;
    const ccomplex_t IT_0151 = 1.4142135623731*IT_0150;
    const ccomplex_t IT_0152 = m_t*N_u2*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0157 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0158 = IT_0023*IT_0157;
    const ccomplex_t IT_0159 = 1.4142135623731*IT_0158;
    const ccomplex_t IT_0160 = m_b*conj(N_d2)*e_em*IT_0033*conj(U_sb_01);
    const ccomplex_t IT_0161 = IT_0041*IT_0160;
    ...
    const ccomplex_t IT_0168 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0169 = IT_0023*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = m_t*N_u1*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0176 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0177 = IT_0023*IT_0176;
    const ccomplex_t IT_0178 = 1.4142135623731*IT_0177;
    const ccomplex_t IT_0179 = m_b*conj(N_d1)*e_em*IT_0033*conj(U_sb_01);
    ...
    const ccomplex_t IT_0190 = m_t*N_u3*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0195 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0196 = IT_0023*IT_0195;
    const ccomplex_t IT_0197 = 1.4142135623731*IT_0196;
    const ccomplex_t IT_0198 = m_b*conj(N_d3)*e_em*IT_0033*conj(U_sb_01);
    ...
    const ccomplex_t IT_0204 = IT_0086*IT_0203;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*IT_0204;
    const ccomplex_t IT_0206 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0207 = IT_0023*IT_0206;
    const ccomplex_t IT_0208 = 1.4142135623731*IT_0207;
    const ccomplex_t IT_0209 = m_t*N_u4*e_em*IT_0033*U_st_01;
    ...
    const ccomplex_t IT_0213 = (-1.33333333333333)*IT_0212;
    const ccomplex_t IT_0214 = (-0.75)*IT_0213;
    const ccomplex_t IT_0215 = 0.666666666666667*IT_0214;
    const ccomplex_t IT_0216 = m_b*conj(N_d4)*e_em*IT_0033*conj(U_sb_01);
    const ccomplex_t IT_0217 = IT_0041*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = conj(N_B4)*e_em*conj(U_sb_11);
    ...
    const ccomplex_t IT_0228 = 0.166666666666667*IT_0147 + -IT_0167 + -IT_0186
       + -IT_0205 + -IT_0227;
    const ccomplex_t IT_0229 = s_34*IT_0002;
    ...
    const ccomplex_t IT_0234 = (-18)*IT_0229;
    const ccomplex_t IT_0235 = 36*IT_0231;
    const ccomplex_t IT_0236 = IT_0234 + IT_0235;
    const ccomplex_t IT_0237 = m_t*s_14;
    const ccomplex_t IT_0238 = cpow((-2)*s_12 + -IT_0002 + -IT_0015 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0239 = m_t*conj(U_sb_01)*(m_t*IT_0031*IT_0039*U_st_01 
      + mu_h*U_st_11) + m_b*(m_b*IT_0030*IT_0040*conj(U_sb_01)*U_st_01 + conj
      (U_sb_11)*(mu_h*U_st_01 + m_t*IT_0031*IT_0040*U_st_11));
    const ccomplex_t IT_0240 = (0 + _Complex_I*1)*V_tb*(A_b*IT_0030*conj
      (U_sb_11)*U_st_01 + (-1.4142135623731)*e_em*IT_0010*((-0.5)*IT_0033
      *IT_0239 + m_W*IT_0030*IT_0039*conj(U_sb_01)*U_st_01) + A_t*IT_0039*conj
      (U_sb_01)*U_st_11);
    const ccomplex_t IT_0241 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
    ...
    const ccomplex_t IT_0247 = cpow((-2)*s_12 + -IT_0002 + -IT_0015 + IT_0246 
      + -reg_prop, -1);
    const ccomplex_t IT_0248 = pow(m_b, 2);
    const ccomplex_t IT_0249 = cpow(IT_0039, 2);
    const ccomplex_t IT_0250 = cpow(IT_0030, 2);
    const ccomplex_t IT_0251 = m_b*mu_h*IT_0030*IT_0033*IT_0040*conj(U_sb_11)
      *U_st_01 + conj(U_sb_01)*((IT_0033*(IT_0000 + -IT_0248) + m_W*(IT_0249 + 
      -IT_0250))*U_st_01 + -m_t*mu_h*IT_0031*IT_0033*IT_0039*U_st_11);
    const ccomplex_t IT_0252 = (0 + _Complex_I*1)*V_tb*((-0.707106781186548)
      *e_em*IT_0010*IT_0251 + A_b*IT_0039*conj(U_sb_11)*U_st_01 + -A_t*IT_0030
    ...
    const ccomplex_t IT_0259 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0260 = IT_0005*IT_0143;
    const ccomplex_t IT_0261 = IT_0003*IT_0259*IT_0260;
    const ccomplex_t IT_0262 = (-0.5)*IT_0011;
    const ccomplex_t IT_0263 = m_t*IT_0262;
    const ccomplex_t IT_0264 = m_t*IT_0012;
    const ccomplex_t IT_0265 = -IT_0264;
    const ccomplex_t IT_0266 = IT_0263 + IT_0265;
    const ccomplex_t IT_0267 = IT_0018*IT_0266;
    const ccomplex_t IT_0268 = m_t*IT_0008;
    const ccomplex_t IT_0269 = -IT_0245 + -IT_0258 + (-0.5)*IT_0261 + -IT_0267
       + 0.5*IT_0268;
    const ccomplex_t IT_0270 = IT_0004*IT_0144;
    const ccomplex_t IT_0271 = IT_0003*IT_0259*IT_0270;
    const ccomplex_t IT_0272 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0010*IT_0033;
    const ccomplex_t IT_0273 = (-0.5)*IT_0272;
    const ccomplex_t IT_0274 = IT_0253*IT_0273;
    const ccomplex_t IT_0275 = IT_0247*IT_0274;
    const ccomplex_t IT_0276 = (0 + _Complex_I*1)*IT_0275;
    const ccomplex_t IT_0277 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0010*IT_0030*IT_0033*IT_0040;
    const ccomplex_t IT_0278 = 0.5*IT_0277;
    const ccomplex_t IT_0279 = IT_0240*IT_0278;
    const ccomplex_t IT_0280 = IT_0238*IT_0279;
    const ccomplex_t IT_0281 = (0 + _Complex_I*1)*IT_0280;
    const ccomplex_t IT_0282 = m_b*IT_0262;
    const ccomplex_t IT_0283 = m_b*IT_0012;
    const ccomplex_t IT_0284 = -IT_0283;
    const ccomplex_t IT_0285 = IT_0282 + IT_0284;
    const ccomplex_t IT_0286 = IT_0018*IT_0285;
    const ccomplex_t IT_0287 = m_t*IT_0147;
    const ccomplex_t IT_0288 = (-0.5)*IT_0271 + -IT_0276 + -IT_0281 + IT_0286 
      + 0.5*IT_0287;
    const ccomplex_t IT_0289 = m_t*IT_0113;
    const ccomplex_t IT_0290 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0291 = IT_0054*IT_0175;
    const ccomplex_t IT_0292 = IT_0021*IT_0290*IT_0291;
    const ccomplex_t IT_0293 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0294 = IT_0082*IT_0156;
    const ccomplex_t IT_0295 = IT_0058*IT_0293*IT_0294;
    const ccomplex_t IT_0296 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0297 = IT_0110*IT_0194;
    const ccomplex_t IT_0298 = IT_0086*IT_0296*IT_0297;
    const ccomplex_t IT_0299 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0300 = IT_0138*IT_0215;
    const ccomplex_t IT_0301 = IT_0114*IT_0299*IT_0300;
    const ccomplex_t IT_0302 = m_t*IT_0057;
    const ccomplex_t IT_0303 = m_t*IT_0085;
    const ccomplex_t IT_0304 = m_t*IT_0141;
    const ccomplex_t IT_0305 = 0.166666666666667*IT_0261 + (-0.166666666666667
      )*IT_0268 + IT_0289 + -IT_0292 + -IT_0295 + -IT_0298 + -IT_0301 + IT_0302 
      + IT_0303 + IT_0304;
    const ccomplex_t IT_0306 = IT_0020 + 3*IT_0142;
    const ccomplex_t IT_0307 = 3*conj(IT_0142);
    const ccomplex_t IT_0308 = conj(IT_0020) + IT_0307;
    const ccomplex_t IT_0309 = IT_0097*IT_0202;
    const ccomplex_t IT_0310 = IT_0086*IT_0296*IT_0309;
    const ccomplex_t IT_0311 = IT_0038*IT_0183;
    const ccomplex_t IT_0312 = IT_0021*IT_0290*IT_0311;
    const ccomplex_t IT_0313 = IT_0069*IT_0164;
    const ccomplex_t IT_0314 = IT_0058*IT_0293*IT_0313;
    const ccomplex_t IT_0315 = IT_0125*IT_0224;
    const ccomplex_t IT_0316 = IT_0114*IT_0299*IT_0315;
    const ccomplex_t IT_0317 = m_t*IT_0186;
    const ccomplex_t IT_0318 = m_t*IT_0167;
    const ccomplex_t IT_0319 = m_t*IT_0205;
    const ccomplex_t IT_0320 = m_t*IT_0227;
    const ccomplex_t IT_0321 = 0.166666666666667*IT_0271 + (-0.166666666666667
      )*IT_0287 + -IT_0310 + -IT_0312 + -IT_0314 + -IT_0316 + IT_0317 + IT_0318 
      + IT_0319 + IT_0320;
    const ccomplex_t IT_0322 = 3*IT_0228;
    const ccomplex_t IT_0323 = IT_0148 + IT_0322;
    const ccomplex_t IT_0324 = 3*conj(IT_0228);
    const ccomplex_t IT_0325 = conj(IT_0148) + IT_0324;
    const ccomplex_t IT_0326 = (18*conj(IT_0020) + 6*conj(IT_0142))*IT_0269 + 
      (18*IT_0020 + 6*IT_0142)*conj(IT_0269) + (18*conj(IT_0148) + 6*conj
      (IT_0228))*IT_0288 + (18*IT_0148 + 6*IT_0228)*conj(IT_0288) + 6*conj
      (IT_0305)*IT_0306 + 6*IT_0305*IT_0308 + 6*conj(IT_0321)*IT_0323 + 6
      *IT_0321*IT_0325;
    const ccomplex_t IT_0327 = m_b*m_t;
    const ccomplex_t IT_0328 = (-18)*IT_0269;
    const ccomplex_t IT_0329 = (-6)*IT_0305;
    const ccomplex_t IT_0330 = IT_0328 + IT_0329;
    const ccomplex_t IT_0331 = (-18)*conj(IT_0269);
    const ccomplex_t IT_0332 = (-6)*conj(IT_0305);
    const ccomplex_t IT_0333 = IT_0331 + IT_0332;
    const ccomplex_t IT_0334 = (-18)*IT_0305;
    const ccomplex_t IT_0335 = (-6)*IT_0269;
    const ccomplex_t IT_0336 = IT_0334 + IT_0335;
    const ccomplex_t IT_0337 = (-18)*conj(IT_0305);
    const ccomplex_t IT_0338 = (-6)*conj(IT_0269);
    const ccomplex_t IT_0339 = IT_0337 + IT_0338;
    const ccomplex_t IT_0340 = 6*s_34;
    const ccomplex_t IT_0341 = 18*s_34;
    const ccomplex_t IT_0342 = m_b*m_t*IT_0002;
    const ccomplex_t IT_0343 = (-6)*IT_0142;
    const ccomplex_t IT_0344 = (-6)*conj(IT_0142);
    const ccomplex_t IT_0345 = m_b*s_13;
    const ccomplex_t IT_0346 = IT_0308*IT_0321 + IT_0306*conj(IT_0321) + (
      -0.166666666666667)*conj(IT_0148)*IT_0330 + (-0.166666666666667)*IT_0148
      *IT_0333 + (-0.166666666666667)*conj(IT_0228)*IT_0336 + (
      -0.166666666666667)*IT_0228*IT_0339 + (-0.166666666666667)*conj(IT_0288)*(
      (-18)*IT_0020 + IT_0343) + (-0.166666666666667)*IT_0288*((-18)*conj
      (IT_0020) + IT_0344);
    const ccomplex_t IT_0347 = (conj(IT_0020)*IT_0142 + IT_0020*conj(IT_0142) 
      + conj(IT_0148)*IT_0228 + IT_0148*conj(IT_0228))*IT_0233 + (IT_0020*conj
      (IT_0020) + IT_0142*conj(IT_0142) + IT_0148*conj(IT_0148) + IT_0228*conj
      (IT_0228))*IT_0236 + IT_0237*IT_0326 + IT_0327*(conj(IT_0288)*IT_0330 +
       IT_0288*IT_0333 + conj(IT_0321)*IT_0336 + IT_0321*IT_0339) + (conj
      (IT_0269)*IT_0305 + IT_0269*conj(IT_0305) + conj(IT_0288)*IT_0321 +
       IT_0288*conj(IT_0321))*IT_0340 + (IT_0269*conj(IT_0269) + IT_0288*conj
      (IT_0288) + IT_0305*conj(IT_0305) + IT_0321*conj(IT_0321))*IT_0341 +
       IT_0342*(conj(IT_0020)*((-18)*IT_0148 + (-6)*IT_0228) + IT_0020*((-18)
      *conj(IT_0148) + (-6)*conj(IT_0228)) + IT_0325*IT_0343 + IT_0323*IT_0344) 
      + (-6)*IT_0345*IT_0346;
