        ...
        )
{
    ...
    const ccomplex_t IT_0011 = m_t*mu_h*IT_0010;
    ...
    const ccomplex_t IT_0018 = 2*U_st_01*(((-0.5)*m_W*IT_0015*(IT_0007 + -1./3
      *IT_0006*IT_0016) + IT_0003*IT_0007*IT_0010*IT_0012*IT_0017)*conj(U_st_01)
       + 1./2*IT_0005*IT_0007*IT_0011*IT_0012*conj(U_st_11)) + U_st_11*(IT_0005
      *IT_0007*IT_0011*IT_0012*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0006
      *IT_0015*IT_0016 + (-1.5)*IT_0003*IT_0007*IT_0010*IT_0012*IT_0017)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0028 = -IT_0004*IT_0005 + IT_0027;
    const ccomplex_t IT_0029 = (-2)*U_st_01*((IT_0005*IT_0007*IT_0010*IT_0012
      *IT_0017 + 0.5*m_W*(IT_0007 + -1./3*IT_0006*IT_0016)*IT_0028)*conj(U_st_01
      ) + -1./2*IT_0003*IT_0007*IT_0011*IT_0012*conj(U_st_11)) + U_st_11*
      (IT_0003*IT_0007*IT_0011*IT_0012*conj(U_st_01) + (-1.33333333333333)*(1.5
      *IT_0005*IT_0007*IT_0010*IT_0012*IT_0017 + m_W*IT_0006*IT_0016*IT_0028)
      *conj(U_st_11));
    const ccomplex_t IT_0030 = (0 + _Complex_I*-1)*(e_em*IT_0029 + (
      -1.4142135623731)*A_t*IT_0005*(conj(U_st_01)*U_st_11 + U_st_01*conj
      (U_st_11)));
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = cpow((-2)*s_12 + (-2)*IT_0021 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0042 = m_t*e_em*mu_h*IT_0010*conj(U_st_01)*U_st_10;
    const ccomplex_t IT_0043 = IT_0007*IT_0042;
    const ccomplex_t IT_0044 = m_t*e_em*mu_h*IT_0010*U_st_00*conj(U_st_11);
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0021 + IT_0053 + -m_st_1*
    ...
    const ccomplex_t IT_0060 = m_t*e_em*mu_h*IT_0010*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0061 = IT_0007*IT_0060;
    const ccomplex_t IT_0062 = m_t*e_em*mu_h*IT_0010*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0081 = m_t*e_em*mu_h*IT_0010*U_st_01*conj(U_st_10);
    const ccomplex_t IT_0082 = IT_0007*IT_0081;
    const ccomplex_t IT_0083 = m_t*e_em*mu_h*IT_0010*conj(U_st_00)*U_st_11;
    ...
    const ccomplex_t IT_0091 = 0.5*IT_0082 + (-0.5)*IT_0084 + 0.5*IT_0087 + (
      -0.5)*IT_0090;
    const ccomplex_t IT_0092 = cpow((-2)*s_13 + IT_0021 + IT_0053 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0100 = -IT_0025 + -IT_0035 + IT_0057 + IT_0074 +
       IT_0095 + IT_0099;
    ...
    const ccomplex_t IT_0113 = (-3)*IT_0036*(conj(IT_0036)*(IT_0021 + -IT_0039
      ...
      *IT_0109 + conj(IT_0100)*(IT_0021 + -IT_0111))*IT_0112;
