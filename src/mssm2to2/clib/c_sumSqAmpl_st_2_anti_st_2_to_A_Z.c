...
ccomplex_return_t c_sumSqAmpl_st_2_anti_st_2_to_A_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1)*IT_0000*IT_0002*IT_0003
      *IT_0008*(0.25*(IT_0004 + (-3)*IT_0005)*U_st_01*conj(U_st_01) + IT_0004
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0002*IT_0003 
      + (-3)*IT_0001*IT_0020)*U_st_01*conj(U_st_01) + IT_0002*IT_0003*U_st_11
      *conj(U_st_11));
    const ccomplex_t IT_0022 = 0.666666666666667*IT_0021;
    const ccomplex_t IT_0023 = IT_0019*IT_0022;
    const ccomplex_t IT_0024 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_st_2
      *Gamma_t2 + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = IT_0023*IT_0025;
    const ccomplex_t IT_0027 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_st_2
      *Gamma_t2 + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0058 = 1.33333333333333*IT_0021;
    ...
    const ccomplex_t IT_0074 = IT_0019*IT_0058;
    const ccomplex_t IT_0075 = -IT_0074;
    const ccomplex_t IT_0076 = IT_0023 + IT_0075;
    const ccomplex_t IT_0077 = IT_0025*IT_0076;
    const ccomplex_t IT_0078 = IT_0030 + IT_0074;
    const ccomplex_t IT_0079 = -IT_0023 + -IT_0059;
    ...
    const ccomplex_t IT_0090 = (-0.5)*IT_0033 + 0.5*IT_0077;
