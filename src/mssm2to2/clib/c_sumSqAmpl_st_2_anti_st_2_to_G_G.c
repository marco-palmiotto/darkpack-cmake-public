        ...
        )
{
    ...
    const ccomplex_t IT_0003 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_st_2
    ...
    const ccomplex_t IT_0074 = pow(g_s, 2);
    ...
    const ccomplex_t IT_0122 = IT_0075 + 0.5*IT_0087;
    ...
    const ccomplex_t IT_0220 = pow(m_st_2, 4);
