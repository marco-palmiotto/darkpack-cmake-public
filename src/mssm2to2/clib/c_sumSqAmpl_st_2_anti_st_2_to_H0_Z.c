...
ccomplex_return_t c_sumSqAmpl_st_2_anti_st_2_to_H0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0036 = m_t*e_em*mu_h*IT_0035*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0037 = IT_0003*IT_0036;
    const ccomplex_t IT_0038 = m_t*e_em*mu_h*IT_0035*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0039 = IT_0003*IT_0038;
    const ccomplex_t IT_0040 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0041 = IT_0006*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0051 = 1.33333333333333*IT_0004;
    const ccomplex_t IT_0052 = m_t*mu_h*IT_0035;
    const ccomplex_t IT_0053 = cpow(IT_0010, -1);
    const ccomplex_t IT_0054 = IT_0006*IT_0007;
    const ccomplex_t IT_0055 = -IT_0010*IT_0011 + IT_0054;
    const ccomplex_t IT_0056 = pow(m_t, 2);
    const ccomplex_t IT_0057 = (-2)*U_st_01*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0055 + IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)*conj(U_st_01)
       + -1./2*IT_0003*IT_0007*IT_0052*IT_0053*conj(U_st_11)) + U_st_11*(IT_0003
      *IT_0007*IT_0052*IT_0053*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0055 + 1.5*IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0060 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0059*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1)*IT_0062;
    const ccomplex_t IT_0064 = IT_0051*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*conj(U_st_00)*U_st_01 + IT_0001*IT_0002*conj
      (U_st_10)*U_st_11);
    const ccomplex_t IT_0066 = 1.33333333333333*IT_0065;
    const ccomplex_t IT_0067 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0055 + IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)*conj(U_st_01)
       + -1./2*IT_0003*IT_0007*IT_0052*IT_0053*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0007*IT_0052*IT_0053*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0055 + 1.5*IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0025 + IT_0060 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = IT_0066*IT_0072;
    const ccomplex_t IT_0074 = e_em*IT_0001*IT_0003*(IT_0006*IT_0007 + IT_0010
      *IT_0011);
    const ccomplex_t IT_0075 = -IT_0074;
    const ccomplex_t IT_0076 = IT_0003*IT_0006*IT_0053;
    const ccomplex_t IT_0077 = IT_0036*IT_0076;
    const ccomplex_t IT_0078 = IT_0038*IT_0076;
    const ccomplex_t IT_0079 = IT_0010*IT_0040;
    const ccomplex_t IT_0080 = 1.4142135623731*IT_0079;
    const ccomplex_t IT_0081 = IT_0010*IT_0043;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = 0.5*IT_0077 + (-0.5)*IT_0078 + (-0.5)*IT_0080 +
       0.5*IT_0082;
    const ccomplex_t IT_0084 = pow(m_Z, 2);
    const ccomplex_t IT_0085 = cpow((-2)*s_12 + (-2)*IT_0025 + IT_0084 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0089 = IT_0050 + -IT_0064 + -IT_0073 + IT_0088;
    const ccomplex_t IT_0090 = s_14*s_34*IT_0031;
    const ccomplex_t IT_0091 = -IT_0090;
    const ccomplex_t IT_0092 = s_13 + IT_0091;
    const ccomplex_t IT_0093 = -IT_0051;
    const ccomplex_t IT_0094 = IT_0005 + IT_0093;
    const ccomplex_t IT_0095 = IT_0028*IT_0094;
    const ccomplex_t IT_0096 = cpow((-2)*s_13 + IT_0060 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    ...
    const ccomplex_t IT_0100 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*U_st_00*conj(U_st_01) + IT_0001*IT_0002*U_st_10
      *conj(U_st_11));
    const ccomplex_t IT_0101 = 1.33333333333333*IT_0100;
    const ccomplex_t IT_0102 = (-2)*conj(U_st_00)*((0.5*m_W*(IT_0003 + -1./3
      *IT_0002*IT_0016)*IT_0055 + IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)
      *U_st_01 + -1./2*IT_0003*IT_0007*IT_0052*IT_0053*U_st_11) + conj(U_st_10)*
      (IT_0003*IT_0007*IT_0052*IT_0053*U_st_01 + (-1.33333333333333)*(m_W
      *IT_0002*IT_0016*IT_0055 + 1.5*IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)
      *U_st_11);
    ...
    const ccomplex_t IT_0105 = cpow((-2)*s_13 + IT_0025 + IT_0060 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0106 = IT_0104*IT_0105;
    const ccomplex_t IT_0107 = (0 + _Complex_I*1)*IT_0106;
    const ccomplex_t IT_0108 = IT_0101*IT_0107;
    const ccomplex_t IT_0109 = (-2)*U_st_00*((0.5*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0016)*IT_0055 + IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)*conj(U_st_01)
       + -1./2*IT_0003*IT_0007*IT_0052*IT_0053*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0007*IT_0052*IT_0053*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0016*IT_0055 + 1.5*IT_0003*IT_0011*IT_0035*IT_0053*IT_0056)*conj
    ...
    const ccomplex_t IT_0115 = IT_0064 + -IT_0095 + IT_0099 + IT_0108 + IT_0114;
    const ccomplex_t IT_0116 = s_14*s_24*IT_0031;
    const ccomplex_t IT_0117 = -IT_0116;
    const ccomplex_t IT_0118 = s_12 + IT_0117;
    const ccomplex_t IT_0119 = (-3)*conj(IT_0030);
    const ccomplex_t IT_0120 = pow(s_34, 2);
    const ccomplex_t IT_0121 = IT_0031*IT_0120;
    const ccomplex_t IT_0122 = s_24*s_34*IT_0031;
    ...
    const ccomplex_t IT_0128 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ) + conj(IT_0089)*IT_0092 + conj(IT_0115)*IT_0118) + IT_0115*IT_0118
      *IT_0119 + (-3)*IT_0089*((-0.333333333333333)*IT_0092*IT_0119 + conj
      (IT_0089)*(IT_0060 + -IT_0121) + conj(IT_0115)*IT_0124) + (conj(IT_0089)
      *IT_0124 + conj(IT_0115)*(IT_0025 + -IT_0126))*IT_0127;
