        ...
        )
{
    ...
    const ccomplex_t IT_0040 = s_12 + IT_0024;
    ...
    const ccomplex_t IT_0107 = -IT_0069;
    const ccomplex_t IT_0108 = IT_0089 + IT_0107;
    const ccomplex_t IT_0109 = IT_0059*IT_0108;
    const ccomplex_t IT_0110 = 0.5*IT_0106 + -IT_0109;
    const ccomplex_t IT_0111 = s_14*s_23*s_34*IT_0080;
    const ccomplex_t IT_0112 = s_14*s_24*IT_0092;
    const ccomplex_t IT_0113 = -IT_0112;
    const ccomplex_t IT_0114 = s_13*s_23*IT_0092;
    const ccomplex_t IT_0115 = -IT_0114;
    const ccomplex_t IT_0116 = s_12 + IT_0113 + IT_0115;
    const ccomplex_t IT_0117 = IT_0111 + IT_0116;
    const ccomplex_t IT_0118 = 3*IT_0079;
    const ccomplex_t IT_0119 = pow(s_23, 2);
    const ccomplex_t IT_0120 = IT_0092*IT_0119;
    const ccomplex_t IT_0121 = -(IT_0024 + -IT_0097)*(IT_0024 + -IT_0120);
    const ccomplex_t IT_0122 = -IT_0121;
    const ccomplex_t IT_0123 = 3*IT_0110;
    const ccomplex_t IT_0124 = -(IT_0024 + -IT_0097)*(s_12 + -IT_0114);
    const ccomplex_t IT_0125 = (-3)*IT_0091;
    const ccomplex_t IT_0126 = 3*conj(IT_0079);
    const ccomplex_t IT_0127 = (-3)*conj(IT_0091);
    const ccomplex_t IT_0128 = IT_0050*IT_0083;
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = IT_0085 + IT_0129;
    const ccomplex_t IT_0131 = IT_0039*IT_0130;
    const ccomplex_t IT_0132 = IT_0068*IT_0087;
    const ccomplex_t IT_0133 = -IT_0132;
    const ccomplex_t IT_0134 = IT_0089 + IT_0133;
    const ccomplex_t IT_0135 = IT_0059*IT_0134;
    const ccomplex_t IT_0136 = 0.5*IT_0131 + -IT_0135;
    const ccomplex_t IT_0137 = s_13*s_24*s_34*IT_0080;
    const ccomplex_t IT_0138 = IT_0116 + IT_0137;
    const ccomplex_t IT_0139 = (s_12 + -IT_0112)*(s_12 + -IT_0114);
    const ccomplex_t IT_0140 = 3*conj(IT_0110);
    const ccomplex_t IT_0141 = -(IT_0024 + -IT_0094)*(s_12 + -IT_0112);
    const ccomplex_t IT_0142 = pow(m_W, 2);
    const ccomplex_t IT_0143 = cpow((-2)*s_23 + IT_0024 + IT_0142 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*V_ts*e_em
      *IT_0009*conj(U_st_01);
    const ccomplex_t IT_0146 = -IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*conj(V_ts)
    ...
    const ccomplex_t IT_0151 = cpow((-2)*s_23 + IT_0024 + IT_0142 + -m_sb_1*
    ...
    const ccomplex_t IT_0159 = cpow((-2)*s_23 + IT_0024 + IT_0142 + -m_sb_2*
    ...
    const ccomplex_t IT_0167 = cpow((-2)*s_23 + IT_0024 + IT_0142 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0168 = (0 + _Complex_I*1)*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*V_td*e_em
      *IT_0009*conj(U_st_01);
    const ccomplex_t IT_0170 = -IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1.4142135623731)*conj(V_td)
      *e_em*IT_0009*U_st_01;
    const ccomplex_t IT_0172 = -IT_0171;
    const ccomplex_t IT_0173 = IT_0170*IT_0172;
    const ccomplex_t IT_0174 = IT_0168*IT_0173;
    const ccomplex_t IT_0175 = IT_0041*IT_0043;
    const ccomplex_t IT_0176 = IT_0041*IT_0050;
    const ccomplex_t IT_0177 = -IT_0176;
    const ccomplex_t IT_0178 = IT_0175 + IT_0177;
    const ccomplex_t IT_0179 = IT_0039*IT_0178;
    const ccomplex_t IT_0180 = IT_0060*IT_0064;
    const ccomplex_t IT_0181 = IT_0060*IT_0068;
    const ccomplex_t IT_0182 = -IT_0181;
    const ccomplex_t IT_0183 = IT_0180 + IT_0182;
    const ccomplex_t IT_0184 = IT_0059*IT_0183;
    const ccomplex_t IT_0185 = -IT_0150 + -IT_0158 + -IT_0166 + -IT_0174 + (
      -0.5)*IT_0179 + IT_0184;
    const ccomplex_t IT_0186 = s_14*s_34*IT_0092;
    const ccomplex_t IT_0187 = (s_12 + -IT_0114)*(s_13 + -IT_0186);
    const ccomplex_t IT_0188 = 3*conj(IT_0091);
    const ccomplex_t IT_0189 = s_34*IT_0092;
    const ccomplex_t IT_0190 = s_23*s_34*IT_0092;
    const ccomplex_t IT_0191 = -IT_0190;
    const ccomplex_t IT_0192 = s_24 + IT_0191;
    const ccomplex_t IT_0193 = IT_0189*IT_0192;
    const ccomplex_t IT_0194 = (IT_0024 + -IT_0120)*(s_13 + -IT_0186);
    const ccomplex_t IT_0195 = -IT_0194;
    const ccomplex_t IT_0196 = (-3)*conj(IT_0110);
    const ccomplex_t IT_0197 = -IT_0051 + -IT_0128;
    const ccomplex_t IT_0198 = IT_0085 + IT_0197;
    const ccomplex_t IT_0199 = IT_0039*IT_0198;
    const ccomplex_t IT_0200 = -IT_0069 + -IT_0132;
    const ccomplex_t IT_0201 = IT_0089 + IT_0200;
    const ccomplex_t IT_0202 = IT_0059*IT_0201;
    const ccomplex_t IT_0203 = IT_0150 + IT_0158 + IT_0166 + IT_0174 + 0.5
      *IT_0199 + -IT_0202;
    const ccomplex_t IT_0204 = s_23*s_24*s_34*IT_0080;
    const ccomplex_t IT_0205 = pow(s_24, 2);
    const ccomplex_t IT_0206 = IT_0092*IT_0205;
    const ccomplex_t IT_0207 = -IT_0206;
    const ccomplex_t IT_0208 = -IT_0120;
    const ccomplex_t IT_0209 = IT_0024 + IT_0204 + IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = (s_12 + -IT_0112)*(IT_0024 + -IT_0120);
    const ccomplex_t IT_0211 = -IT_0210;
    const ccomplex_t IT_0212 = (s_12 + -IT_0114)*(IT_0024 + -IT_0206);
    const ccomplex_t IT_0213 = -IT_0212;
    const ccomplex_t IT_0214 = (-3)*conj(IT_0136);
    const ccomplex_t IT_0215 = IT_0039*IT_0175;
    const ccomplex_t IT_0216 = IT_0059*IT_0180;
    const ccomplex_t IT_0217 = (-0.5)*IT_0215 + IT_0216;
    const ccomplex_t IT_0218 = s_13*s_34*IT_0092;
    const ccomplex_t IT_0219 = -IT_0218;
    const ccomplex_t IT_0220 = s_14 + IT_0219;
    const ccomplex_t IT_0221 = IT_0189*IT_0220;
    const ccomplex_t IT_0222 = -(IT_0024 + -IT_0094)*(s_13 + -IT_0186);
    const ccomplex_t IT_0223 = s_24*s_34*IT_0092;
    const ccomplex_t IT_0224 = -(IT_0024 + -IT_0094)*(s_23 + -IT_0223);
    const ccomplex_t IT_0225 = (s_12 + -IT_0114)*(s_23 + -IT_0223);
    const ccomplex_t IT_0226 = (IT_0024 + -IT_0120)*(IT_0024 + -IT_0206);
    const ccomplex_t IT_0227 = 3*IT_0203;
    const ccomplex_t IT_0228 = (-3)*IT_0110;
    const ccomplex_t IT_0229 = (-3)*IT_0136;
    const ccomplex_t IT_0230 = (IT_0024 + -IT_0120)*(s_23 + -IT_0223);
    const ccomplex_t IT_0231 = -IT_0230;
    const ccomplex_t IT_0232 = -IT_0185;
    const ccomplex_t IT_0233 = 0.333333333333333*IT_0139;
    const ccomplex_t IT_0234 = -(IT_0024 + -IT_0094)*(IT_0024 + -IT_0206);
    const ccomplex_t IT_0235 = -IT_0234;
    const ccomplex_t IT_0236 = 3*IT_0136;
    const ccomplex_t IT_0237 = IT_0081*IT_0092;
    const ccomplex_t IT_0238 = (s_12 + -IT_0114)*(IT_0142 + -IT_0237);
    const ccomplex_t IT_0239 = (IT_0024 + -IT_0120)*(IT_0142 + -IT_0237);
    const ccomplex_t IT_0240 = -IT_0239;
    const ccomplex_t IT_0241 = (-0.333333333333333)*IT_0225;
    const ccomplex_t IT_0242 = -(IT_0024 + -IT_0094)*(IT_0142 + -IT_0237);
    const ccomplex_t IT_0243 = 6*IT_0079*conj(IT_0079)*(1 + 0.5*IT_0082) +
       conj(IT_0091)*(IT_0098*IT_0099 + IT_0101*IT_0102) + IT_0091*IT_0101
      *IT_0103 + conj(IT_0110)*(IT_0117*IT_0118 + IT_0122*IT_0123 + IT_0124
      *IT_0125) + IT_0110*(IT_0117*IT_0126 + IT_0124*IT_0127) + IT_0136*(IT_0126
      *IT_0138 + IT_0139*IT_0140 + IT_0127*IT_0141) + IT_0185*(IT_0187*IT_0188 +
       IT_0103*IT_0193 + IT_0195*IT_0196) + IT_0203*(IT_0139*IT_0188 + IT_0126
      *IT_0209 + IT_0196*IT_0211 + IT_0213*IT_0214) + IT_0217*(IT_0140*IT_0187 +
       IT_0103*IT_0221 + IT_0127*IT_0222 + IT_0214*IT_0224) + 3*conj(IT_0203)*
      (0.333333333333333*IT_0118*IT_0209 + IT_0217*IT_0225 + 0.333333333333333
      *IT_0226*IT_0227 + 0.333333333333333*IT_0211*IT_0228 + 0.333333333333333
      *IT_0213*IT_0229 + IT_0231*IT_0232 + IT_0099*IT_0233) + 3*conj(IT_0136)*
      (0.333333333333333*IT_0118*IT_0138 + 0.333333333333333*IT_0125*IT_0141 +
       IT_0185*IT_0225 + IT_0123*IT_0233 + 0.333333333333333*IT_0235*IT_0236) + 
      (-3)*conj(IT_0185)*((-0.333333333333333)*IT_0099*IT_0187 + (
      -0.333333333333333)*IT_0102*IT_0193 + (-0.333333333333333)*IT_0195*IT_0228
       + IT_0203*IT_0231 + -IT_0217*IT_0238 + IT_0185*IT_0240 + IT_0236*IT_0241)
       + (-3)*conj(IT_0217)*((-0.333333333333333)*IT_0123*IT_0187 + (
      -0.333333333333333)*IT_0102*IT_0221 + (-0.333333333333333)*IT_0125*IT_0222
       + (-0.333333333333333)*IT_0224*IT_0229 + IT_0232*IT_0238 + IT_0227
      *IT_0241 + IT_0217*IT_0242);
