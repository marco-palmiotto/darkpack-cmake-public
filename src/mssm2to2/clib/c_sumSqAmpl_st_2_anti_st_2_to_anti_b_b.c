        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (-2)*U_st_01*((IT_0000*IT_0003*IT_0005*IT_0011
      *IT_0017 + 0.5*m_W*(IT_0005 + -1./3*IT_0004*IT_0016)*IT_0029)*conj(U_st_01
    ...
    const ccomplex_t IT_0046 = IT_0005*IT_0015;
    ...
    const ccomplex_t IT_0059 = -(IT_0041 + -IT_0043)*(IT_0052 + -IT_0056);
    ...
    const ccomplex_t IT_0065 = IT_0042*IT_0052;
    const ccomplex_t IT_0066 = -IT_0065;
    const ccomplex_t IT_0067 = IT_0005*IT_0011;
    const ccomplex_t IT_0068 = m_t*V_tb*V_u2*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0073 = V_tb*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0079 = V_tb*e_em*conj(V_Wp2)*U_st_01;
    const ccomplex_t IT_0080 = IT_0005*IT_0079;
    const ccomplex_t IT_0081 = m_t*V_tb*conj(V_u2)*e_em*IT_0000*U_st_11;
    ...
    const ccomplex_t IT_0086 = cpow((-2)*s_23 + IT_0022 + IT_0062 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = IT_0078*IT_0088;
    const ccomplex_t IT_0090 = m_t*V_tb*V_u1*e_em*IT_0000*conj(U_st_11);
    ...
    const ccomplex_t IT_0095 = V_tb*e_em*V_Wp1*conj(U_st_01);
    ...
    const ccomplex_t IT_0101 = V_tb*e_em*conj(V_Wp1)*U_st_01;
    const ccomplex_t IT_0102 = IT_0005*IT_0101;
    const ccomplex_t IT_0103 = m_t*V_tb*conj(V_u1)*e_em*IT_0000*U_st_11;
    ...
    const ccomplex_t IT_0108 = cpow((-2)*s_23 + IT_0022 + IT_0062 + -m_C_1*
    ...
    const ccomplex_t IT_0113 = IT_0042*IT_0056;
    const ccomplex_t IT_0114 = -IT_0113;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0000*IT_0002*IT_0005*conj(U_st_01);
    const ccomplex_t IT_0116 = (-0.5)*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0000*IT_0002*IT_0005*conj(U_st_01);
    const ccomplex_t IT_0123 = (-0.5)*IT_0122;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_b*U_d2*V_tb
      *e_em*IT_0000*IT_0002*IT_0005*U_st_01;
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0140 = (-0.333333333333333)*IT_0139;
    const ccomplex_t IT_0141 = (-1.33333333333333)*IT_0139;
    ...
    const ccomplex_t IT_0147 = IT_0138*IT_0145;
    ...
    const ccomplex_t IT_0159 = IT_0107*IT_0116;
    const ccomplex_t IT_0160 = IT_0108*IT_0158*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0162 = IT_0085*IT_0123;
    const ccomplex_t IT_0163 = IT_0086*IT_0161*IT_0162;
    const ccomplex_t IT_0164 = m_b*IT_0121;
    const ccomplex_t IT_0165 = m_b*IT_0128;
    const ccomplex_t IT_0166 = -IT_0160 + -IT_0163 + -IT_0164 + -IT_0165;
    const ccomplex_t IT_0167 = IT_0100*IT_0118;
    const ccomplex_t IT_0168 = IT_0108*IT_0158*IT_0167;
    const ccomplex_t IT_0169 = IT_0078*IT_0125;
    const ccomplex_t IT_0170 = IT_0086*IT_0161*IT_0169;
    const ccomplex_t IT_0171 = m_b*IT_0094;
    const ccomplex_t IT_0172 = m_b*IT_0098;
    const ccomplex_t IT_0173 = -IT_0172;
    const ccomplex_t IT_0174 = IT_0171 + IT_0173;
    const ccomplex_t IT_0175 = IT_0110*IT_0174;
    const ccomplex_t IT_0176 = m_b*IT_0072;
    const ccomplex_t IT_0177 = m_b*IT_0076;
    const ccomplex_t IT_0178 = -IT_0177;
    const ccomplex_t IT_0179 = IT_0176 + IT_0178;
    const ccomplex_t IT_0180 = IT_0088*IT_0179;
    const ccomplex_t IT_0181 = -IT_0168 + -IT_0170 + -IT_0175 + -IT_0180;
    const ccomplex_t IT_0182 = (-18)*IT_0181;
    const ccomplex_t IT_0183 = (-6)*IT_0058;
    const ccomplex_t IT_0184 = IT_0182 + IT_0183;
    const ccomplex_t IT_0185 = (-18)*conj(IT_0181);
    const ccomplex_t IT_0186 = (-6)*conj(IT_0058);
    const ccomplex_t IT_0187 = IT_0185 + IT_0186;
    const ccomplex_t IT_0188 = (-18)*IT_0058;
    const ccomplex_t IT_0189 = (-6)*IT_0181;
    const ccomplex_t IT_0190 = IT_0188 + IT_0189;
    const ccomplex_t IT_0191 = (-18)*conj(IT_0058);
    ...
    const ccomplex_t IT_0208 = cpow((-2)*s_12 + (-2)*IT_0022 + IT_0207 + 
      -reg_prop, -1);
    const ccomplex_t IT_0209 = m_b*e_em*IT_0000*IT_0005;
    const ccomplex_t IT_0210 = 0.5*IT_0209;
    const ccomplex_t IT_0211 = m_t*e_em*mu_h*IT_0000*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0212 = IT_0001*IT_0005*IT_0011;
    const ccomplex_t IT_0213 = IT_0211*IT_0212;
    const ccomplex_t IT_0214 = m_t*e_em*mu_h*IT_0000*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0215 = IT_0212*IT_0214;
    const ccomplex_t IT_0216 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0217 = IT_0010*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = A_t*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0220 = IT_0010*IT_0219;
    const ccomplex_t IT_0221 = 1.4142135623731*IT_0220;
    const ccomplex_t IT_0222 = 0.5*IT_0213 + (-0.5)*IT_0215 + (-0.5)*IT_0218 +
       0.5*IT_0221;
    ...
    const ccomplex_t IT_0226 = cpow((-2)*s_12 + (-2)*IT_0022 + m_A0*(m_A0 + (0
       + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0227 = m_b*e_em*IT_0000*IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0228 = (-0.5)*IT_0227;
    const ccomplex_t IT_0229 = IT_0005*IT_0211;
    const ccomplex_t IT_0230 = IT_0005*IT_0214;
    const ccomplex_t IT_0231 = IT_0001*IT_0216;
    const ccomplex_t IT_0232 = 1.4142135623731*IT_0231;
    const ccomplex_t IT_0233 = IT_0001*IT_0219;
    ...
    const ccomplex_t IT_0239 = -IT_0225 + -IT_0238;
    ...
    const ccomplex_t IT_0265 = IT_0239*(((-18)*conj(IT_0066) + (-6)*conj
      ...
      *IT_0243 + conj(IT_0058)*IT_0244 + (IT_0192 + IT_0200)*IT_0245 + conj
    ...
    const ccomplex_t IT_0275 = m_b*s_14;
    ...
    const ccomplex_t IT_0277 = (conj(IT_0037)*(IT_0058 + IT_0060) + IT_0037*
      (conj(IT_0058) + conj(IT_0060)))*IT_0064 + (conj(IT_0066)*IT_0112 +
      ...
      *IT_0156*IT_0157) + IT_0061*(IT_0058*conj(IT_0058) + IT_0060*conj(IT_0060)
      ...
      *IT_0184 + IT_0166*IT_0187 + conj(IT_0060)*IT_0190 + IT_0060*IT_0193) + 
      (conj(IT_0060)*IT_0166 + IT_0060*conj(IT_0166) + conj(IT_0058)*IT_0181 +
       IT_0058*conj(IT_0181))*IT_0194 + (s_34 + IT_0195)*((conj(IT_0166) + conj
      (IT_0181))*IT_0196 + (IT_0166 + IT_0181)*IT_0197) + 6*IT_0198*IT_0206 +
       conj(IT_0239)*(((-18)*IT_0066 + (-6)*IT_0112 + 18*IT_0114 + 6*IT_0129)
      *IT_0241 + IT_0060*IT_0243 + IT_0058*IT_0244 + (IT_0189 + IT_0199)*IT_0245
