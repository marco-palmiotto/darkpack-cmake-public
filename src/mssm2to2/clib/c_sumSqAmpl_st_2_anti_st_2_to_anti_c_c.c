        ...
        )
{
    ...
    const ccomplex_t IT_0022 = 0.666666666666667*IT_0004;
    const ccomplex_t IT_0023 = m_c*IT_0022;
    const ccomplex_t IT_0024 = m_c*IT_0005;
    const ccomplex_t IT_0025 = (IT_0015 + -IT_0021)*(IT_0023 + -IT_0024);
    const ccomplex_t IT_0026 = -IT_0025;
    const ccomplex_t IT_0027 = m_c*s_13;
    ...
    const ccomplex_t IT_0043 = m_c*e_em*IT_0003*IT_0028*IT_0033*IT_0042;
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_12 + (-2)*IT_0012 + IT_0049 + 
      -reg_prop, -1);
    const ccomplex_t IT_0051 = m_c*e_em*IT_0003*IT_0028;
    const ccomplex_t IT_0052 = (-0.5)*IT_0051;
    const ccomplex_t IT_0053 = IT_0003*IT_0033*IT_0042;
    const ccomplex_t IT_0054 = IT_0029*IT_0053;
    const ccomplex_t IT_0055 = IT_0031*IT_0053;
    const ccomplex_t IT_0056 = IT_0034*IT_0041;
    const ccomplex_t IT_0057 = 1.4142135623731*IT_0056;
    const ccomplex_t IT_0058 = IT_0037*IT_0041;
    ...
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*m_c*e_em*IT_0003*IT_0028
      *IT_0042*IT_0072;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*1)*m_c*e_em*IT_0003*IT_0028
      *IT_0042*IT_0076;
    ...
    const ccomplex_t IT_0101 = pow(m_c, 2);
    const ccomplex_t IT_0102 = -IT_0026;
    const ccomplex_t IT_0103 = 18*s_34;
    const ccomplex_t IT_0104 = (-18)*IT_0101;
    const ccomplex_t IT_0105 = IT_0103 + IT_0104;
    const ccomplex_t IT_0106 = IT_0005*IT_0021;
    const ccomplex_t IT_0107 = -IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*g_s;
    const ccomplex_t IT_0109 = (-2)*IT_0108;
    const ccomplex_t IT_0110 = cpow(s_12 + IT_0012 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0115 = (-6)*IT_0067;
    const ccomplex_t IT_0116 = IT_0012*IT_0101;
    const ccomplex_t IT_0117 = (-6)*IT_0116;
    const ccomplex_t IT_0118 = 12*IT_0069;
    const ccomplex_t IT_0119 = IT_0115 + IT_0117 + IT_0118;
    const ccomplex_t IT_0120 = (-18)*IT_0017;
    const ccomplex_t IT_0121 = m_c*s_14;
    const ccomplex_t IT_0122 = (-18)*IT_0026;
    const ccomplex_t IT_0123 = (-18)*conj(IT_0017);
    const ccomplex_t IT_0124 = (-18)*conj(IT_0026);
    const ccomplex_t IT_0125 = (-36)*IT_0067;
    const ccomplex_t IT_0126 = (-36)*IT_0116;
    const ccomplex_t IT_0127 = 72*IT_0069;
    const ccomplex_t IT_0128 = IT_0125 + IT_0126 + IT_0127;
    const ccomplex_t IT_0129 = (-0.0833333333333333)*IT_0113;
    const ccomplex_t IT_0130 = cpow(IT_0129, 2);
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0132 = 0.666666666666667*IT_0131;
    const ccomplex_t IT_0133 = (-1.33333333333333)*IT_0131;
    ...
    const ccomplex_t IT_0138 = (-2)*IT_0129;
    const ccomplex_t IT_0139 = (-12)*IT_0067;
    const ccomplex_t IT_0140 = (-12)*IT_0116;
    const ccomplex_t IT_0141 = 24*IT_0069;
    const ccomplex_t IT_0142 = IT_0139 + IT_0140 + IT_0141;
    const ccomplex_t IT_0143 = -IT_0114;
    const ccomplex_t IT_0144 = (-18)*IT_0116;
    const ccomplex_t IT_0145 = IT_0068 + IT_0070 + IT_0144;
    const ccomplex_t IT_0146 = -IT_0137;
    const ccomplex_t IT_0147 = -s_14;
    const ccomplex_t IT_0148 = s_13 + IT_0147;
    const ccomplex_t IT_0149 = m_c*IT_0148;
    const ccomplex_t IT_0150 = 36*conj(IT_0100);
    const ccomplex_t IT_0151 = 18*IT_0107;
    const ccomplex_t IT_0152 = IT_0100*(18*conj(IT_0017) + 18*conj(IT_0107)) +
       (-6)*(IT_0026 + -conj(IT_0026) + 2*IT_0100 + (-2)*conj(IT_0100) + IT_0102
       + -conj(IT_0102))*IT_0114 + (IT_0129 + IT_0137)*(18*conj(IT_0026) + (-36)
      *IT_0100 + (-18)*IT_0102 + 18*conj(IT_0102) + IT_0122 + IT_0150) + conj
      (IT_0100)*(18*IT_0017 + IT_0151);
    const ccomplex_t IT_0153 = 18*IT_0101 + IT_0103;
    const ccomplex_t IT_0154 = (-18)*s_34 + IT_0104;
    const ccomplex_t IT_0155 = IT_0100*IT_0105;
    const ccomplex_t IT_0156 = conj(IT_0017)*(18*IT_0026*IT_0027 + (-18)
      *IT_0064*IT_0066 + IT_0017*IT_0071) + conj(IT_0100)*(IT_0100*(36*s_34 + (
      -36)*IT_0101) + (IT_0026 + IT_0102)*IT_0105) + conj(IT_0107)*(18*IT_0064
      *IT_0066 + 18*IT_0027*IT_0102 + IT_0071*IT_0107 + IT_0114*IT_0119 +
       IT_0116*IT_0120 + IT_0121*IT_0122) + IT_0102*(IT_0121*IT_0123 + IT_0101
      *IT_0124) + -IT_0128*(IT_0130 + IT_0137*(IT_0137 + -IT_0138)) + IT_0114*
      (conj(IT_0017)*IT_0119 + -IT_0114*IT_0128 + (-2)*(IT_0137 + (-0.5)*IT_0138
      )*IT_0142) + IT_0017*IT_0119*IT_0143 + IT_0107*(IT_0116*IT_0123 + IT_0121
      *IT_0124 + IT_0119*IT_0143) + -IT_0145*((IT_0017 + -conj(IT_0017) +
       IT_0107 + -conj(IT_0107))*IT_0129 + -(conj(IT_0017) + conj(IT_0107))
      *IT_0137 + -(IT_0017 + IT_0107)*IT_0146) + IT_0149*IT_0152 + conj(IT_0064)
      *(IT_0064*(36*s_34 + 36*IT_0101) + IT_0066*((-18)*IT_0017 + IT_0151) +
       IT_0102*IT_0153 + IT_0026*IT_0154) + conj(IT_0102)*(IT_0102*IT_0103 +
       IT_0120*IT_0121 + IT_0101*IT_0122 + IT_0027*IT_0151 + IT_0064*IT_0153 +
       IT_0155) + conj(IT_0026)*(18*IT_0017*IT_0027 + IT_0026*IT_0103 + IT_0064
      *IT_0154 + IT_0155);
