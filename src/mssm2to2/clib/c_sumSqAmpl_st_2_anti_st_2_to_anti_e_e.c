        ...
        )
{
    ...
    const ccomplex_t IT_0069 = IT_0021*IT_0038;
    const ccomplex_t IT_0070 = m_e*s_14;
    const ccomplex_t IT_0071 = (-6)*conj(IT_0052);
    const ccomplex_t IT_0072 = m_e*e_em*IT_0000*IT_0005;
    const ccomplex_t IT_0073 = 0.5*IT_0072;
    const ccomplex_t IT_0074 = m_t*e_em*mu_h*IT_0000*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0075 = IT_0001*IT_0005*IT_0011;
    const ccomplex_t IT_0076 = IT_0074*IT_0075;
    const ccomplex_t IT_0077 = m_t*e_em*mu_h*IT_0000*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0078 = IT_0075*IT_0077;
    const ccomplex_t IT_0079 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0080 = IT_0010*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_12 + (-2)*IT_0021 + IT_0087 + 
      -reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0086*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = m_e*e_em*IT_0000*IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0092 = (-0.5)*IT_0091;
    const ccomplex_t IT_0093 = IT_0005*IT_0074;
    const ccomplex_t IT_0094 = IT_0005*IT_0077;
    ...
    const ccomplex_t IT_0101 = cpow((-2)*s_12 + (-2)*IT_0021 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0106 = m_e*IT_0105;
    const ccomplex_t IT_0107 = s_34 + IT_0038;
    const ccomplex_t IT_0108 = (-6)*IT_0066;
    ...
    const ccomplex_t IT_0120 = (-6)*IT_0069;
    const ccomplex_t IT_0121 = 12*IT_0117;
    const ccomplex_t IT_0122 = IT_0119 + IT_0120 + IT_0121;
    const ccomplex_t IT_0123 = 6*conj(IT_0066);
    const ccomplex_t IT_0124 = 6*conj(IT_0065);
    const ccomplex_t IT_0125 = IT_0116*((-12)*IT_0069 + 24*IT_0117 + (-12)
      *IT_0118) + (IT_0052 + -conj(IT_0052) + IT_0057 + -conj(IT_0057))*IT_0122 
      + -IT_0060*((-12)*IT_0037 + 12*conj(IT_0037) + (-6)*IT_0065 + IT_0108 +
       IT_0123 + IT_0124);
    const ccomplex_t IT_0126 = m_e*s_13;
    const ccomplex_t IT_0127 = IT_0119 + IT_0121;
    ...
    const ccomplex_t IT_0132 = IT_0037*IT_0068;
    const ccomplex_t IT_0133 = (-6)*conj(IT_0066);
    const ccomplex_t IT_0134 = IT_0104*IT_0107;
    const ccomplex_t IT_0135 = conj(IT_0037)*(IT_0037*(12*s_34 + (-12)*IT_0038
      ) + 6*(IT_0052 + IT_0057)*IT_0060 + 6*(IT_0065 + IT_0066)*IT_0068) + 
      (IT_0057*IT_0069 + IT_0065*IT_0070)*IT_0071 + conj(IT_0104)*((12*s_34 + 12
      *IT_0038)*IT_0104 + (-6)*(IT_0052 + -IT_0057)*IT_0106 + 6*IT_0107*(IT_0065
       + 0.166666666666667*IT_0108)) + -IT_0116*IT_0125 + (-6)*conj(IT_0052)*
      (IT_0104*IT_0106 + -IT_0066*IT_0126 + (-0.166666666666667)*IT_0052*IT_0127
       + -IT_0128) + 6*conj(IT_0057)*(IT_0104*IT_0106 + IT_0065*IT_0126 +
       0.166666666666667*IT_0057*IT_0127 + IT_0128 + 0.166666666666667*IT_0069
      *IT_0129 + IT_0108*IT_0130) + IT_0123*(IT_0052*IT_0126 + 0.166666666666667
      *IT_0066*IT_0131 + IT_0132) + IT_0133*(IT_0038*IT_0065 + IT_0057*IT_0070 +
       IT_0134) + IT_0124*(0.166666666666667*IT_0038*IT_0108 + IT_0057*IT_0126 +
       IT_0129*IT_0130 + 0.166666666666667*IT_0065*IT_0131 + IT_0132 + IT_0134);
