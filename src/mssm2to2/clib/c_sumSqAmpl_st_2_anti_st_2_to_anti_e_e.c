...
ccomplex_return_t c_sumSqAmpl_st_2_anti_st_2_to_anti_e_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*m_e*e_em*IT_0000*IT_0002
      *IT_0005*IT_0008;
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*((-0.75)*(IT_0005
      *IT_0014 + -1./3*IT_0004*IT_0039)*U_st_01*conj(U_st_01) + IT_0004*IT_0039
    ...
    const ccomplex_t IT_0062 = m_e*IT_0061;
    const ccomplex_t IT_0063 = m_e*IT_0041;
    const ccomplex_t IT_0064 = (IT_0050 + -IT_0055)*(IT_0062 + -IT_0063);
    const ccomplex_t IT_0065 = -IT_0064;
    const ccomplex_t IT_0066 = -IT_0038;
    const ccomplex_t IT_0067 = s_34 + IT_0066;
    const ccomplex_t IT_0068 = IT_0021*IT_0038;
    const ccomplex_t IT_0069 = m_e*s_14;
    const ccomplex_t IT_0070 = (-6)*IT_0052;
    const ccomplex_t IT_0071 = m_e*e_em*IT_0000*IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0072 = (-0.5)*IT_0071;
    const ccomplex_t IT_0073 = m_t*e_em*mu_h*IT_0000*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0074 = IT_0005*IT_0073;
    const ccomplex_t IT_0075 = m_t*e_em*mu_h*IT_0000*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0076 = IT_0005*IT_0075;
    const ccomplex_t IT_0077 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0078 = IT_0001*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_12 + (-2)*IT_0021 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0089 = cpow((-2)*s_12 + (-2)*IT_0021 + IT_0088 + 
      -reg_prop, -1);
    const ccomplex_t IT_0090 = m_e*e_em*IT_0000*IT_0005;
    const ccomplex_t IT_0091 = 0.5*IT_0090;
    const ccomplex_t IT_0092 = IT_0001*IT_0005*IT_0011;
    const ccomplex_t IT_0093 = IT_0073*IT_0092;
    const ccomplex_t IT_0094 = IT_0075*IT_0092;
    const ccomplex_t IT_0095 = IT_0010*IT_0077;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = IT_0010*IT_0080;
    ...
    const ccomplex_t IT_0104 = s_34 + IT_0038;
    const ccomplex_t IT_0105 = (-6)*conj(IT_0065);
    const ccomplex_t IT_0106 = s_13 + s_14;
    const ccomplex_t IT_0107 = m_e*IT_0106;
    const ccomplex_t IT_0108 = -conj(IT_0057);
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0110 = -IT_0109;
    const ccomplex_t IT_0111 = (-1.33333333333333)*IT_0109;
    const ccomplex_t IT_0112 = IT_0110*IT_0111;
    const ccomplex_t IT_0113 = cpow(s_12 + IT_0021 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0118 = s_34*IT_0021;
    const ccomplex_t IT_0119 = (-6)*IT_0065;
    const ccomplex_t IT_0120 = (-6)*IT_0118;
    const ccomplex_t IT_0121 = (-6)*IT_0068;
    const ccomplex_t IT_0122 = 12*IT_0117;
    const ccomplex_t IT_0123 = IT_0120 + IT_0121 + IT_0122;
    const ccomplex_t IT_0124 = IT_0116*((-12)*IT_0068 + 24*IT_0117 + (-12)
      *IT_0118) + -IT_0060*((-12)*IT_0037 + 12*conj(IT_0037) + (-6)*IT_0064 + 6
      *conj(IT_0064) + 6*conj(IT_0065) + IT_0119) + (IT_0052 + -conj(IT_0052) +
       IT_0057 + IT_0108)*IT_0123;
    const ccomplex_t IT_0125 = m_e*s_13;
    const ccomplex_t IT_0126 = IT_0120 + IT_0122;
    const ccomplex_t IT_0127 = conj(IT_0037)*IT_0060;
    const ccomplex_t IT_0128 = (-6)*conj(IT_0052);
    const ccomplex_t IT_0129 = 0.166666666666667*IT_0069;
    const ccomplex_t IT_0130 = 6*s_34;
    const ccomplex_t IT_0131 = conj(IT_0037)*IT_0067;
    const ccomplex_t IT_0132 = conj(IT_0103)*IT_0104;
    const ccomplex_t IT_0133 = IT_0037*(conj(IT_0037)*(12*s_34 + (-12)*IT_0038
      ) + 6*(conj(IT_0052) + conj(IT_0057))*IT_0060 + 6*(conj(IT_0064) + conj
      (IT_0065))*IT_0067) + (conj(IT_0057)*IT_0068 + conj(IT_0064)*IT_0069)
      *IT_0070 + IT_0103*((12*s_34 + 12*IT_0038)*conj(IT_0103) + 6*IT_0104*(conj
      (IT_0064) + 0.166666666666667*IT_0105) + (-6)*IT_0107*(conj(IT_0052) +
       IT_0108)) + -IT_0116*IT_0124 + (-6)*IT_0052*(conj(IT_0103)*IT_0107 + 
      -conj(IT_0065)*IT_0125 + (-0.166666666666667)*conj(IT_0052)*IT_0126 + 
      -IT_0127) + 6*IT_0057*(conj(IT_0103)*IT_0107 + conj(IT_0064)*IT_0125 +
       0.166666666666667*conj(IT_0057)*IT_0126 + IT_0127 + 0.166666666666667
      *IT_0068*IT_0128 + IT_0105*IT_0129) + 6*IT_0065*(conj(IT_0052)*IT_0125 +
       0.166666666666667*conj(IT_0065)*IT_0130 + IT_0131) + IT_0119*(IT_0038
      *conj(IT_0064) + conj(IT_0057)*IT_0069 + IT_0132) + 6*IT_0064*
      (0.166666666666667*IT_0038*IT_0105 + conj(IT_0057)*IT_0125 + IT_0128
      *IT_0129 + 0.166666666666667*conj(IT_0064)*IT_0130 + IT_0131 + IT_0132);
