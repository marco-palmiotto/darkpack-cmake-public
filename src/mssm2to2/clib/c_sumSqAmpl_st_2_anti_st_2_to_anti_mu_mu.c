        ...
        )
{
    ...
    const ccomplex_t IT_0067 = -IT_0038;
    const ccomplex_t IT_0068 = s_34 + IT_0067;
    const ccomplex_t IT_0069 = IT_0022*IT_0038;
    const ccomplex_t IT_0070 = m_mu*s_14;
    const ccomplex_t IT_0071 = (-6)*IT_0052;
    const ccomplex_t IT_0072 = e_em*m_mu*IT_0000*IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0073 = (-0.5)*IT_0072;
    const ccomplex_t IT_0074 = m_t*e_em*mu_h*IT_0000*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0075 = IT_0005*IT_0074;
    const ccomplex_t IT_0076 = m_t*e_em*mu_h*IT_0000*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0077 = IT_0005*IT_0076;
    const ccomplex_t IT_0078 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0079 = IT_0001*IT_0078;
    const ccomplex_t IT_0080 = 1.4142135623731*IT_0079;
    const ccomplex_t IT_0081 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0086 = cpow((-2)*s_12 + (-2)*IT_0022 + m_A0*(m_A0 + (0
       + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0087 = IT_0085*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1)*IT_0087;
    const ccomplex_t IT_0089 = pow(m_Z, 2);
    const ccomplex_t IT_0090 = cpow((-2)*s_12 + (-2)*IT_0022 + IT_0089 + 
      -reg_prop, -1);
    const ccomplex_t IT_0091 = e_em*m_mu*IT_0000*IT_0005;
    const ccomplex_t IT_0092 = 0.5*IT_0091;
    const ccomplex_t IT_0093 = IT_0001*IT_0005*IT_0011;
    const ccomplex_t IT_0094 = IT_0074*IT_0093;
    const ccomplex_t IT_0095 = IT_0076*IT_0093;
    const ccomplex_t IT_0096 = IT_0010*IT_0078;
    const ccomplex_t IT_0097 = 1.4142135623731*IT_0096;
    const ccomplex_t IT_0098 = IT_0010*IT_0081;
    ...
    const ccomplex_t IT_0106 = (-6)*conj(IT_0066);
    const ccomplex_t IT_0107 = s_13 + s_14;
    const ccomplex_t IT_0108 = m_mu*IT_0107;
    const ccomplex_t IT_0109 = -conj(IT_0057);
    ...
    const ccomplex_t IT_0120 = (-6)*IT_0066;
    const ccomplex_t IT_0121 = (-6)*IT_0119;
    const ccomplex_t IT_0122 = (-6)*IT_0069;
    const ccomplex_t IT_0123 = 12*IT_0118;
    const ccomplex_t IT_0124 = IT_0121 + IT_0122 + IT_0123;
    const ccomplex_t IT_0125 = IT_0117*((-12)*IT_0069 + 24*IT_0118 + (-12)
      *IT_0119) + -IT_0060*((-12)*IT_0037 + 12*conj(IT_0037) + (-6)*IT_0065 + 6
      *conj(IT_0065) + 6*conj(IT_0066) + IT_0120) + (IT_0052 + -conj(IT_0052) +
       IT_0057 + IT_0109)*IT_0124;
    const ccomplex_t IT_0126 = m_mu*s_13;
    const ccomplex_t IT_0127 = IT_0121 + IT_0123;
    const ccomplex_t IT_0128 = conj(IT_0037)*IT_0060;
    const ccomplex_t IT_0129 = (-6)*conj(IT_0052);
    const ccomplex_t IT_0130 = 0.166666666666667*IT_0070;
    const ccomplex_t IT_0131 = 6*s_34;
    const ccomplex_t IT_0132 = conj(IT_0037)*IT_0068;
    const ccomplex_t IT_0133 = conj(IT_0104)*IT_0105;
    const ccomplex_t IT_0134 = IT_0037*(conj(IT_0037)*(12*s_34 + (-12)*IT_0038
      ) + 6*(conj(IT_0052) + conj(IT_0057))*IT_0060 + 6*(conj(IT_0065) + conj
      (IT_0066))*IT_0068) + (conj(IT_0057)*IT_0069 + conj(IT_0065)*IT_0070)
      *IT_0071 + IT_0104*((12*s_34 + 12*IT_0038)*conj(IT_0104) + 6*IT_0105*(conj
      (IT_0065) + 0.166666666666667*IT_0106) + (-6)*IT_0108*(conj(IT_0052) +
       IT_0109)) + -IT_0117*IT_0125 + (-6)*IT_0052*(conj(IT_0104)*IT_0108 + 
      -conj(IT_0066)*IT_0126 + (-0.166666666666667)*conj(IT_0052)*IT_0127 + 
      -IT_0128) + 6*IT_0057*(conj(IT_0104)*IT_0108 + conj(IT_0065)*IT_0126 +
       0.166666666666667*conj(IT_0057)*IT_0127 + IT_0128 + 0.166666666666667
      *IT_0069*IT_0129 + IT_0106*IT_0130) + 6*IT_0066*(conj(IT_0052)*IT_0126 +
       0.166666666666667*conj(IT_0066)*IT_0131 + IT_0132) + IT_0120*(IT_0038
      *conj(IT_0065) + conj(IT_0057)*IT_0070 + IT_0133) + 6*IT_0065*
      (0.166666666666667*IT_0038*IT_0106 + conj(IT_0057)*IT_0126 + IT_0129
      *IT_0130 + 0.166666666666667*conj(IT_0065)*IT_0131 + IT_0132 + IT_0133);
