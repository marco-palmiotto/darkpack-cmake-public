...
ccomplex_return_t c_sumSqAmpl_st_2_anti_st_2_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*((-0.75)*(IT_0005
      *IT_0015 + -1./3*IT_0004*IT_0039)*U_st_01*conj(U_st_01) + IT_0004*IT_0039
    ...
    const ccomplex_t IT_0067 = (IT_0050 + -IT_0055)*(IT_0062 + -IT_0063);
    const ccomplex_t IT_0068 = -IT_0067;
    const ccomplex_t IT_0069 = -IT_0068;
    const ccomplex_t IT_0070 = -IT_0038;
    const ccomplex_t IT_0071 = s_34 + IT_0070;
    const ccomplex_t IT_0072 = IT_0022*IT_0038;
    const ccomplex_t IT_0073 = m_mu*s_14;
    const ccomplex_t IT_0074 = (-6)*conj(IT_0052);
    const ccomplex_t IT_0075 = e_em*m_mu*IT_0000*IT_0005;
    const ccomplex_t IT_0076 = 0.5*IT_0075;
    const ccomplex_t IT_0077 = m_t*e_em*mu_h*IT_0000*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0078 = IT_0001*IT_0005*IT_0011;
    const ccomplex_t IT_0079 = IT_0077*IT_0078;
    const ccomplex_t IT_0080 = m_t*e_em*mu_h*IT_0000*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0081 = IT_0078*IT_0080;
    const ccomplex_t IT_0082 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0083 = IT_0010*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_12 + (-2)*IT_0022 + IT_0090 + 
      -reg_prop, -1);
    const ccomplex_t IT_0092 = IT_0089*IT_0091;
    const ccomplex_t IT_0093 = (0 + _Complex_I*1)*IT_0092;
    const ccomplex_t IT_0094 = e_em*m_mu*IT_0000*IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0095 = (-0.5)*IT_0094;
    const ccomplex_t IT_0096 = IT_0005*IT_0077;
    const ccomplex_t IT_0097 = IT_0005*IT_0080;
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_12 + (-2)*IT_0022 + m_A0*(m_A0 + (0
    ...
    const ccomplex_t IT_0110 = s_34 + IT_0038;
    const ccomplex_t IT_0111 = (-6)*IT_0066;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0113 = -IT_0112;
    const ccomplex_t IT_0114 = (-1.33333333333333)*IT_0112;
    const ccomplex_t IT_0115 = IT_0113*IT_0114;
    const ccomplex_t IT_0116 = cpow(s_12 + IT_0022 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0121 = s_34*IT_0022;
    const ccomplex_t IT_0122 = (-6)*IT_0121;
    const ccomplex_t IT_0123 = (-6)*IT_0072;
    const ccomplex_t IT_0124 = 12*IT_0120;
    const ccomplex_t IT_0125 = IT_0122 + IT_0123 + IT_0124;
    const ccomplex_t IT_0126 = 6*conj(IT_0066);
    const ccomplex_t IT_0127 = 6*conj(IT_0069);
    const ccomplex_t IT_0128 = IT_0119*((-12)*IT_0072 + 24*IT_0120 + (-12)
      *IT_0121) + (IT_0052 + -conj(IT_0052) + IT_0057 + -conj(IT_0057))*IT_0125 
      + -IT_0060*((-12)*IT_0037 + 12*conj(IT_0037) + (-6)*IT_0069 + IT_0111 +
       IT_0126 + IT_0127);
    const ccomplex_t IT_0129 = m_mu*s_13;
    const ccomplex_t IT_0130 = IT_0122 + IT_0124;
    const ccomplex_t IT_0131 = IT_0037*IT_0060;
    const ccomplex_t IT_0132 = (-6)*IT_0052;
    const ccomplex_t IT_0133 = 0.166666666666667*IT_0073;
    const ccomplex_t IT_0134 = 6*s_34;
    const ccomplex_t IT_0135 = IT_0037*IT_0071;
    const ccomplex_t IT_0136 = (-6)*conj(IT_0066);
    const ccomplex_t IT_0137 = IT_0107*IT_0110;
    const ccomplex_t IT_0138 = conj(IT_0037)*(IT_0037*(12*s_34 + (-12)*IT_0038
      ) + 6*(IT_0052 + IT_0057)*IT_0060 + 6*(IT_0066 + IT_0069)*IT_0071) + 
      (IT_0057*IT_0072 + IT_0069*IT_0073)*IT_0074 + conj(IT_0107)*((12*s_34 + 12
      *IT_0038)*IT_0107 + (-6)*(IT_0052 + -IT_0057)*IT_0109 + 6*IT_0110*(IT_0069
       + 0.166666666666667*IT_0111)) + -IT_0119*IT_0128 + (-6)*conj(IT_0052)*
      (IT_0107*IT_0109 + -IT_0066*IT_0129 + (-0.166666666666667)*IT_0052*IT_0130
       + -IT_0131) + 6*conj(IT_0057)*(IT_0107*IT_0109 + IT_0069*IT_0129 +
       0.166666666666667*IT_0057*IT_0130 + IT_0131 + 0.166666666666667*IT_0072
      *IT_0132 + IT_0111*IT_0133) + IT_0126*(IT_0052*IT_0129 + 0.166666666666667
      *IT_0066*IT_0134 + IT_0135) + IT_0136*(IT_0038*IT_0069 + IT_0057*IT_0073 +
       IT_0137) + IT_0127*(0.166666666666667*IT_0038*IT_0111 + IT_0057*IT_0129 +
       IT_0132*IT_0133 + 0.166666666666667*IT_0069*IT_0134 + IT_0135 + IT_0137);
