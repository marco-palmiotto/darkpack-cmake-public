        ...
        )
{
    ...
    const ccomplex_t IT_0070 = s_14*m_tau;
    const ccomplex_t IT_0071 = (-6)*IT_0052;
    const ccomplex_t IT_0072 = e_em*m_tau*IT_0000*IT_0002*IT_0005*IT_0010;
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_12 + (-2)*IT_0022 + IT_0089 + 
      -reg_prop, -1);
    const ccomplex_t IT_0091 = e_em*m_tau*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0108 = m_tau*IT_0107;
    ...
    const ccomplex_t IT_0134 = IT_0037*(conj(IT_0037)*(12*s_34 + (-12)*IT_0038
      ...
      *IT_0071 + IT_0104*((12*s_34 + 12*IT_0038)*conj(IT_0104) + 6*IT_0105*(conj
      (IT_0065) + 0.166666666666667*IT_0106) + (-6)*IT_0108*(conj(IT_0052) +
       IT_0109)) + -IT_0117*IT_0126 + (-6)*IT_0052*(conj(IT_0104)*IT_0108 + (
      -0.166666666666667)*conj(IT_0052)*IT_0123 + -conj(IT_0066)*IT_0127 + 
      -IT_0128) + 6*IT_0057*(conj(IT_0104)*IT_0108 + 0.166666666666667*conj
      (IT_0057)*IT_0123 + conj(IT_0065)*IT_0127 + IT_0128 + 0.166666666666667
      *IT_0069*IT_0129 + IT_0106*IT_0130) + 6*IT_0066*(conj(IT_0052)*IT_0127 +
       0.166666666666667*conj(IT_0066)*IT_0131 + IT_0132) + IT_0120*(IT_0038
      *conj(IT_0065) + conj(IT_0057)*IT_0070 + IT_0133) + 6*IT_0065*
      (0.166666666666667*IT_0038*IT_0106 + conj(IT_0057)*IT_0127 + IT_0129
