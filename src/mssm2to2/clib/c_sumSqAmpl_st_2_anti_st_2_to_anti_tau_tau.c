...
ccomplex_return_t c_sumSqAmpl_st_2_anti_st_2_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0073 = s_14*m_tau;
    const ccomplex_t IT_0074 = (-6)*conj(IT_0052);
    const ccomplex_t IT_0075 = e_em*m_tau*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0094 = e_em*m_tau*IT_0000*IT_0002*IT_0005*IT_0010;
    ...
    const ccomplex_t IT_0123 = 12*IT_0120;
    const ccomplex_t IT_0124 = IT_0122 + IT_0123;
    const ccomplex_t IT_0125 = (-6)*IT_0072;
    const ccomplex_t IT_0126 = IT_0124 + IT_0125;
    const ccomplex_t IT_0127 = 6*conj(IT_0066);
    const ccomplex_t IT_0128 = 6*conj(IT_0069);
    const ccomplex_t IT_0129 = IT_0119*((-12)*IT_0072 + 24*IT_0120 + (-12)
      *IT_0121) + (IT_0052 + -conj(IT_0052) + IT_0057 + -conj(IT_0057))*IT_0126 
      + -IT_0060*((-12)*IT_0037 + 12*conj(IT_0037) + (-6)*IT_0069 + IT_0111 +
       IT_0127 + IT_0128);
    const ccomplex_t IT_0130 = s_13*m_tau;
    ...
    const ccomplex_t IT_0138 = conj(IT_0037)*(IT_0037*(12*s_34 + (-12)*IT_0038
      ...
      *IT_0038)*IT_0107 + (-6)*(IT_0052 + -IT_0057)*IT_0109 + 6*IT_0110*(IT_0069
       + 0.166666666666667*IT_0111)) + -IT_0119*IT_0129 + (-6)*conj(IT_0052)*
      (IT_0107*IT_0109 + (-0.166666666666667)*IT_0052*IT_0124 + -IT_0066*IT_0130
       + -IT_0131) + 6*conj(IT_0057)*(IT_0107*IT_0109 + 0.166666666666667
      *IT_0057*IT_0124 + IT_0069*IT_0130 + IT_0131 + 0.166666666666667*IT_0072
      *IT_0132 + IT_0111*IT_0133) + IT_0127*(IT_0052*IT_0130 + 0.166666666666667
      *IT_0066*IT_0134 + IT_0135) + IT_0136*(IT_0038*IT_0069 + IT_0057*IT_0073 +
       IT_0137) + IT_0128*(0.166666666666667*IT_0038*IT_0111 + IT_0057*IT_0130 +
