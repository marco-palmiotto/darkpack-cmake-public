...
ccomplex_return_t c_sumSqAmpl_st_2_anti_st_2_to_h_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = 2*U_st_01*(((-0.5)*m_W*IT_0013*(IT_0009 + -1./3
      *IT_0008*IT_0015) + IT_0002*IT_0003*IT_0006*IT_0009*IT_0016)*conj(U_st_01)
       + 1./2*IT_0004*IT_0006*IT_0007*IT_0009*conj(U_st_11)) + U_st_11*(IT_0004
    ...
    const ccomplex_t IT_0029 = pow(m_st_2, 2);
