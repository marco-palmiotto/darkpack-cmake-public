        ...
        )
{
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*m_W*e_em*IT_0015*(IT_0007
      *IT_0016 + (-5)*IT_0001*(IT_0001*IT_0002*IT_0007 + (-0.2)*IT_0017*(IT_0018
       + (-5)*IT_0019)));
    const ccomplex_t IT_0021 = 0.5*IT_0020;
    const ccomplex_t IT_0022 = pow(m_W, -1);
    const ccomplex_t IT_0023 = m_t*mu_h*IT_0022;
    ...
    const ccomplex_t IT_0028 = 2*U_st_01*((IT_0001*IT_0006*IT_0014*IT_0022
      *IT_0024 + 0.166666666666667*m_W*(IT_0004*IT_0009 + (-3)*IT_0014)*IT_0027)
      *conj(U_st_01) + 1./2*IT_0002*IT_0014*IT_0023*IT_0024*conj(U_st_11)) +
       U_st_11*(IT_0002*IT_0014*IT_0023*IT_0024*conj(U_st_01) + (
      -1.33333333333333)*((-1.5)*IT_0001*IT_0006*IT_0014*IT_0022*IT_0024 + m_W
      *IT_0004*IT_0009*IT_0027)*conj(U_st_11));
    ...
    const ccomplex_t IT_0032 = pow(m_st_2, 2);
    ...
    const ccomplex_t IT_0038 = IT_0001*IT_0017;
    const ccomplex_t IT_0039 = -IT_0002*IT_0007 + IT_0038;
    const ccomplex_t IT_0040 = (-2)*U_st_01*((IT_0002*IT_0006*IT_0014*IT_0022
      *IT_0024 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + (-3)*IT_0014)
      *IT_0039)*conj(U_st_01) + -1./2*IT_0001*IT_0014*IT_0023*IT_0024*conj
      (U_st_11)) + U_st_11*(IT_0001*IT_0014*IT_0023*IT_0024*conj(U_st_01) + (
      -1.33333333333333)*(1.5*IT_0002*IT_0006*IT_0014*IT_0022*IT_0024 + m_W
    ...
    const ccomplex_t IT_0043 = 2*U_st_01*((IT_0001*IT_0006*IT_0014*IT_0022
      *IT_0024 + 0.166666666666667*m_W*(IT_0004*IT_0009 + (-3)*IT_0014)*IT_0027)
      *conj(U_st_01) + 1./2*IT_0002*IT_0014*IT_0023*IT_0024*conj(U_st_11)) +
       U_st_11*(IT_0002*IT_0014*IT_0023*IT_0024*conj(U_st_01) + (
      -1.33333333333333)*((-1.5)*IT_0001*IT_0006*IT_0014*IT_0022*IT_0024 + m_W
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0036 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0030*IT_0042;
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = cpow((-2)*s_12 + (-2)*IT_0032 + m_H0*(m_H0 + (0
       + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*m_W*e_em*IT_0015*(IT_0016
      *IT_0017 + 5*IT_0001*((-0.2)*IT_0001*(IT_0001*IT_0007 + 5*IT_0002*IT_0017)
       + IT_0007*IT_0019));
    const ccomplex_t IT_0055 = (-0.5)*IT_0054;
    const ccomplex_t IT_0056 = IT_0042*IT_0055;
    const ccomplex_t IT_0057 = IT_0053*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*IT_0057;
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0032 + IT_0036 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0060 = (-2)*U_st_00*((IT_0002*IT_0006*IT_0014*IT_0022
      *IT_0024 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + (-3)*IT_0014)
      *IT_0039)*conj(U_st_01) + -1./2*IT_0001*IT_0014*IT_0023*IT_0024*conj
      (U_st_11)) + U_st_10*(IT_0001*IT_0014*IT_0023*IT_0024*conj(U_st_01) + (
      -1.33333333333333)*(1.5*IT_0002*IT_0006*IT_0014*IT_0022*IT_0024 + m_W
      *IT_0004*IT_0009*IT_0039)*conj(U_st_11));
    ...
    const ccomplex_t IT_0063 = 2*conj(U_st_00)*((IT_0001*IT_0006*IT_0014
      *IT_0022*IT_0024 + 0.166666666666667*m_W*(IT_0004*IT_0009 + (-3)*IT_0014)
      *IT_0027)*U_st_01 + 1./2*IT_0002*IT_0014*IT_0023*IT_0024*U_st_11) + conj
      (U_st_10)*(IT_0002*IT_0014*IT_0023*IT_0024*U_st_01 + (-1.33333333333333)*(
      (-1.5)*IT_0001*IT_0006*IT_0014*IT_0022*IT_0024 + m_W*IT_0004*IT_0009
      *IT_0027)*U_st_11);
    ...
    const ccomplex_t IT_0069 = cpow((-2)*s_23 + IT_0032 + IT_0036 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0070 = 2*U_st_00*((IT_0001*IT_0006*IT_0014*IT_0022
      *IT_0024 + 0.166666666666667*m_W*(IT_0004*IT_0009 + (-3)*IT_0014)*IT_0027)
      *conj(U_st_01) + 1./2*IT_0002*IT_0014*IT_0023*IT_0024*conj(U_st_11)) +
       U_st_10*(IT_0002*IT_0014*IT_0023*IT_0024*conj(U_st_01) + (
      -1.33333333333333)*((-1.5)*IT_0001*IT_0006*IT_0014*IT_0022*IT_0024 + m_W
      *IT_0004*IT_0009*IT_0027)*conj(U_st_11));
    ...
    const ccomplex_t IT_0073 = (-2)*conj(U_st_00)*((IT_0002*IT_0006*IT_0014
      *IT_0022*IT_0024 + (-0.166666666666667)*m_W*(IT_0004*IT_0009 + (-3)
      *IT_0014)*IT_0039)*U_st_01 + -1./2*IT_0001*IT_0014*IT_0023*IT_0024*U_st_11
      ) + conj(U_st_10)*(IT_0001*IT_0014*IT_0023*IT_0024*U_st_01 + (
      -1.33333333333333)*(1.5*IT_0002*IT_0006*IT_0014*IT_0022*IT_0024 + m_W
      *IT_0004*IT_0009*IT_0039)*U_st_11);
    ...
    const ccomplex_t IT_0079 = IT_0012 + -IT_0035 + IT_0048 + IT_0052 + 
      -IT_0058 + IT_0068 + IT_0078;
