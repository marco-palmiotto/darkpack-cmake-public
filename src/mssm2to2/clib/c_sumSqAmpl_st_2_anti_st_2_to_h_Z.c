        ...
        )
{
    ...
    const ccomplex_t IT_0069 = IT_0003*IT_0011*IT_0054;
    const ccomplex_t IT_0070 = IT_0037*IT_0069;
    const ccomplex_t IT_0071 = IT_0039*IT_0069;
    const ccomplex_t IT_0072 = IT_0009*IT_0041;
    const ccomplex_t IT_0073 = 1.4142135623731*IT_0072;
    const ccomplex_t IT_0074 = IT_0009*IT_0044;
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*conj(U_st_00)*U_st_01 + IT_0001*IT_0002*conj
      (U_st_10)*U_st_11);
    const ccomplex_t IT_0083 = 1.33333333333333*IT_0082;
    const ccomplex_t IT_0084 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0057 + IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj(U_st_01)
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_13 + IT_0025 + IT_0062 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    ...
    const ccomplex_t IT_0108 = -IT_0052;
    const ccomplex_t IT_0109 = IT_0005 + IT_0108;
    const ccomplex_t IT_0110 = IT_0028*IT_0109;
    const ccomplex_t IT_0111 = IT_0066 + IT_0090 + IT_0098 + IT_0107 + -IT_0110;
