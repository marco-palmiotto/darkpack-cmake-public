...
ccomplex_return_t c_sumSqAmpl_st_2_anti_st_2_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = m_t*e_em*mu_h*IT_0036*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0038 = IT_0003*IT_0037;
    const ccomplex_t IT_0039 = m_t*e_em*mu_h*IT_0036*U_st_01*conj(U_st_11);
    const ccomplex_t IT_0040 = IT_0003*IT_0039;
    const ccomplex_t IT_0041 = A_t*conj(U_st_01)*U_st_11;
    const ccomplex_t IT_0042 = IT_0011*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = A_t*U_st_01*conj(U_st_11);
    ...
    const ccomplex_t IT_0052 = 1.33333333333333*IT_0004;
    const ccomplex_t IT_0053 = m_t*mu_h*IT_0036;
    const ccomplex_t IT_0054 = cpow(IT_0009, -1);
    const ccomplex_t IT_0055 = IT_0011*IT_0012;
    const ccomplex_t IT_0056 = IT_0007*IT_0009;
    const ccomplex_t IT_0057 = IT_0055 + IT_0056;
    const ccomplex_t IT_0058 = pow(m_t, 2);
    const ccomplex_t IT_0059 = 2*U_st_01*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0057 + IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj(U_st_01)
       + 1./2*IT_0003*IT_0012*IT_0053*IT_0054*conj(U_st_11)) + U_st_11*(IT_0003
      *IT_0012*IT_0053*IT_0054*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0057 + (-1.5)*IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0069 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0057 + IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj(U_st_01)
       + 1./2*IT_0003*IT_0012*IT_0053*IT_0054*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0012*IT_0053*IT_0054*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0057 + (-1.5)*IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj
      (U_st_11));
    ...
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0025 + IT_0062 + -m_st_1*
    ...
    const ccomplex_t IT_0078 = IT_0003*IT_0011*IT_0054;
    const ccomplex_t IT_0079 = IT_0037*IT_0078;
    const ccomplex_t IT_0080 = IT_0039*IT_0078;
    const ccomplex_t IT_0081 = IT_0009*IT_0041;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = IT_0009*IT_0044;
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1)*e_em*(0.25*(IT_0001*IT_0002 
      + (-3)*IT_0000*IT_0003)*U_st_00*conj(U_st_01) + IT_0001*IT_0002*U_st_10
      *conj(U_st_11));
    const ccomplex_t IT_0103 = 1.33333333333333*IT_0102;
    const ccomplex_t IT_0104 = 2*conj(U_st_00)*(((-0.5)*m_W*(IT_0003 + -1./3
      *IT_0002*IT_0017)*IT_0057 + IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)
      *U_st_01 + 1./2*IT_0003*IT_0012*IT_0053*IT_0054*U_st_11) + conj(U_st_10)*
      (IT_0003*IT_0012*IT_0053*IT_0054*U_st_01 + (-1.33333333333333)*(m_W
      *IT_0002*IT_0017*IT_0057 + (-1.5)*IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)
      *U_st_11);
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*(e_em*IT_0104 +
       1.4142135623731*A_t*IT_0007*(U_st_01*conj(U_st_10) + conj(U_st_00)
      *U_st_11));
    const ccomplex_t IT_0106 = (-0.5)*IT_0105;
    const ccomplex_t IT_0107 = cpow((-2)*s_13 + IT_0025 + IT_0062 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0108 = IT_0106*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*IT_0108;
    const ccomplex_t IT_0110 = IT_0103*IT_0109;
    const ccomplex_t IT_0111 = 2*U_st_00*(((-0.5)*m_W*(IT_0003 + -1./3*IT_0002
      *IT_0017)*IT_0057 + IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj(U_st_01)
       + 1./2*IT_0003*IT_0012*IT_0053*IT_0054*conj(U_st_11)) + U_st_10*(IT_0003
      *IT_0012*IT_0053*IT_0054*conj(U_st_01) + (-1.33333333333333)*(m_W*IT_0002
      *IT_0017*IT_0057 + (-1.5)*IT_0003*IT_0007*IT_0036*IT_0054*IT_0058)*conj
    ...
    const ccomplex_t IT_0116 = IT_0068*IT_0115;
    const ccomplex_t IT_0117 = IT_0066 + -IT_0097 + IT_0101 + IT_0110 + IT_0116;
    ...
    const ccomplex_t IT_0130 = (-3)*IT_0030*(conj(IT_0030)*(IT_0025 + -IT_0033
      ...
      *IT_0121 + (-3)*IT_0091*((-0.333333333333333)*IT_0094*IT_0121 + conj
      (IT_0091)*(IT_0062 + -IT_0123) + conj(IT_0117)*IT_0126) + (conj(IT_0091)
