        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*m_W*e_em*IT_0021*(IT_0010
      *IT_0022 + (-5)*IT_0005*(IT_0003*IT_0005*IT_0010 + 1*(IT_0004 + -1./5
      *IT_0006)*IT_0023));
    ...
    const ccomplex_t IT_0029 = IT_0005*IT_0023;
    const ccomplex_t IT_0030 = -IT_0003*IT_0010 + IT_0029;
    const ccomplex_t IT_0031 = (-2)*U_st_01*((IT_0003*IT_0009*IT_0020*IT_0026
      *IT_0028 + (-0.166666666666667)*m_W*(IT_0002*IT_0012 + (-3)*IT_0020)
      *IT_0030)*conj(U_st_01) + -1./2*IT_0005*IT_0020*IT_0027*IT_0028*conj
      (U_st_11)) + U_st_11*(IT_0005*IT_0020*IT_0027*IT_0028*conj(U_st_01) + (
      -1.33333333333333)*(1.5*IT_0003*IT_0009*IT_0020*IT_0026*IT_0028 + m_W
      *IT_0002*IT_0012*IT_0030)*conj(U_st_11));
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_W*e_em*IT_0021*(IT_0022
      *IT_0023 + IT_0005*(IT_0004*IT_0010 + -IT_0005*(IT_0005*IT_0010 + IT_0003
      *IT_0023)));
    ...
    const ccomplex_t IT_0043 = 2*U_st_01*((IT_0005*IT_0009*IT_0020*IT_0026
      *IT_0028 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0020)*IT_0042)
      *conj(U_st_01) + 1./2*IT_0003*IT_0020*IT_0027*IT_0028*conj(U_st_11)) +
       U_st_11*(IT_0003*IT_0020*IT_0027*IT_0028*conj(U_st_01) + (
      -1.33333333333333)*((-1.5)*IT_0005*IT_0009*IT_0020*IT_0026*IT_0028 + m_W
    ...
    const ccomplex_t IT_0050 = cpow((-2)*s_23 + IT_0049 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0051 = cpow(IT_0045, 2);
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = IT_0050*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0049 + (0 + _Complex_I*1)
      *m_st_2*Gamma_t2 + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0052*IT_0054;
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0017 + IT_0049 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0057 = 2*conj(U_st_00)*((IT_0005*IT_0009*IT_0020
      *IT_0026*IT_0028 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0020)
      *IT_0042)*U_st_01 + 1./2*IT_0003*IT_0020*IT_0027*IT_0028*U_st_11) + conj
      (U_st_10)*(IT_0003*IT_0020*IT_0027*IT_0028*U_st_01 + (-1.33333333333333)*(
      (-1.5)*IT_0005*IT_0009*IT_0020*IT_0026*IT_0028 + m_W*IT_0002*IT_0012
      *IT_0042)*U_st_11);
    ...
    const ccomplex_t IT_0060 = 2*U_st_00*((IT_0005*IT_0009*IT_0020*IT_0026
      *IT_0028 + 0.166666666666667*m_W*(IT_0002*IT_0012 + (-3)*IT_0020)*IT_0042)
      *conj(U_st_01) + 1./2*IT_0003*IT_0020*IT_0027*IT_0028*conj(U_st_11)) +
       U_st_10*(IT_0003*IT_0020*IT_0027*IT_0028*conj(U_st_01) + (
      -1.33333333333333)*((-1.5)*IT_0005*IT_0009*IT_0020*IT_0026*IT_0028 + m_W
      *IT_0002*IT_0012*IT_0042)*conj(U_st_11));
    ...
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0017 + IT_0049 + -m_st_1*
      (m_st_1 + (0 + _Complex_I*-1)*Gamma_t1) + reg_prop, -1);
    const ccomplex_t IT_0067 = IT_0063*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*IT_0067;
    const ccomplex_t IT_0069 = IT_0016 + -IT_0036 + -IT_0048 + IT_0053 +
