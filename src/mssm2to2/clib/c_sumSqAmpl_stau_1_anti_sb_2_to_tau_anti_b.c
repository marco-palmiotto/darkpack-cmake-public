        ...
        )
{
    ...
    const ccomplex_t IT_0098 = conj(N_d4)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0123 = N_d1*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0130 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0131 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0132 = IT_0004*IT_0131;
    const ccomplex_t IT_0133 = 1.4142135623731*IT_0132;
    const ccomplex_t IT_0134 = N_d2*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0140 = IT_0037*IT_0130*IT_0139;
    ...
    const ccomplex_t IT_0145 = N_d3*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0151 = IT_0064*IT_0141*IT_0150;
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0153 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0154 = IT_0004*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = N_d4*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0161 = IT_0114*IT_0160;
    const ccomplex_t IT_0162 = IT_0091*IT_0152*IT_0161;
    const ccomplex_t IT_0163 = m_tau*IT_0036;
    const ccomplex_t IT_0164 = m_tau*IT_0063;
    ...
    const ccomplex_t IT_0167 = 0.5*IT_0129 + 0.5*IT_0140 + 0.5*IT_0151 + 0.5
      *IT_0162 + (-0.5)*IT_0163 + (-0.5)*IT_0164 + (-0.5)*IT_0165 + (-0.5)
      *IT_0166;
    const ccomplex_t IT_0168 = s_14*m_tau;
    const ccomplex_t IT_0169 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0170 = IT_0004*IT_0169;
    const ccomplex_t IT_0171 = 1.4142135623731*IT_0170;
    const ccomplex_t IT_0172 = m_b*conj(N_d1)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0177 = IT_0127*IT_0176;
    ...
    const ccomplex_t IT_0192 = m_tau*IT_0191;
    const ccomplex_t IT_0193 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0194 = IT_0004*IT_0193;
    const ccomplex_t IT_0195 = 1.4142135623731*IT_0194;
    const ccomplex_t IT_0196 = m_b*conj(N_d3)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0201 = IT_0149*IT_0200;
    const ccomplex_t IT_0202 = IT_0064*IT_0201;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*IT_0202;
    const ccomplex_t IT_0204 = m_tau*IT_0203;
    const ccomplex_t IT_0205 = IT_0075*IT_0200;
    const ccomplex_t IT_0206 = IT_0064*IT_0141*IT_0205;
    const ccomplex_t IT_0207 = IT_0021*IT_0176;
    const ccomplex_t IT_0208 = IT_0002*IT_0119*IT_0207;
    const ccomplex_t IT_0209 = IT_0048*IT_0188;
    const ccomplex_t IT_0210 = IT_0037*IT_0130*IT_0209;
    const ccomplex_t IT_0211 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0212 = IT_0004*IT_0211;
    const ccomplex_t IT_0213 = 1.4142135623731*IT_0212;
    const ccomplex_t IT_0214 = m_b*conj(N_d4)*e_em*IT_0016*conj(U_sb_01);
    const ccomplex_t IT_0215 = IT_0015*IT_0214;
    ...
    const ccomplex_t IT_0220 = IT_0091*IT_0152*IT_0219;
    const ccomplex_t IT_0221 = IT_0160*IT_0218;
    const ccomplex_t IT_0222 = IT_0091*IT_0221;
    const ccomplex_t IT_0223 = (0 + _Complex_I*1)*IT_0222;
    const ccomplex_t IT_0224 = m_tau*IT_0223;
    const ccomplex_t IT_0225 = (-0.5)*IT_0180 + (-0.5)*IT_0192 + (-0.5)
      *IT_0204 + 0.5*IT_0206 + 0.5*IT_0208 + 0.5*IT_0210 + 0.5*IT_0220 + (-0.5)
      *IT_0224;
    const ccomplex_t IT_0226 = m_b*s_13;
    const ccomplex_t IT_0227 = 0.5*IT_0179 + 0.5*IT_0191 + 0.5*IT_0203 + 0.5
      *IT_0223;
