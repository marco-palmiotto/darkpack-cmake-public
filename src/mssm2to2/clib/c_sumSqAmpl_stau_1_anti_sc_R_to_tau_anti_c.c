...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_sc_R_to_tau_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_c*N_u1*e_em
    ...
    const ccomplex_t IT_0018 = conj(N_d1)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0066 = IT_0008*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0069 = IT_0004*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = conj(N_d4)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0080 = 0.5*IT_0028 + 0.5*IT_0045 + 0.5*IT_0062 + 0.5
      *IT_0079;
    const ccomplex_t IT_0081 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0082 = IT_0008*IT_0081;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0095 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0106 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0118 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0119 = IT_0008*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0134 = IT_0026*IT_0127*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0008;
    const ccomplex_t IT_0136 = 0.666666666666667*IT_0135;
    const ccomplex_t IT_0137 = IT_0041*IT_0136;
    const ccomplex_t IT_0138 = IT_0043*IT_0090*IT_0137;
    const ccomplex_t IT_0139 = IT_0125*IT_0132;
    ...
    const ccomplex_t IT_0149 = IT_0099*IT_0148;
    ...
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0008;
    const ccomplex_t IT_0154 = 0.666666666666667*IT_0153;
    const ccomplex_t IT_0155 = IT_0110*IT_0154;
    const ccomplex_t IT_0156 = IT_0077*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*IT_0156;
    const ccomplex_t IT_0158 = m_tau*IT_0157;
    const ccomplex_t IT_0159 = IT_0058*IT_0148;
    const ccomplex_t IT_0160 = IT_0060*IT_0101*IT_0159;
    const ccomplex_t IT_0161 = IT_0075*IT_0154;
    const ccomplex_t IT_0162 = IT_0077*IT_0112*IT_0161;
    const ccomplex_t IT_0163 = 0.5*IT_0134 + 0.5*IT_0138 + (-0.5)*IT_0142 + (
      -0.5)*IT_0146 + (-0.5)*IT_0152 + (-0.5)*IT_0158 + 0.5*IT_0160 + 0.5*IT_0162;
    const ccomplex_t IT_0164 = m_c*s_13;
    const ccomplex_t IT_0165 = 0.5*IT_0141 + 0.5*IT_0145 + 0.5*IT_0151 + 0.5
      *IT_0157;
    const ccomplex_t IT_0166 = m_c*m_tau*IT_0025;
    ...
    const ccomplex_t IT_0173 = m_c*m_tau;
