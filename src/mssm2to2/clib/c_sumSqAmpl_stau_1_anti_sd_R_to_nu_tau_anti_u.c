...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_sd_R_to_nu_tau_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = conj(U_d2)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0021 = e_em*conj(U_Wm1)*U_stau_00;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(U_d1)*e_em*m_tau*IT_0000*U_stau_10;
