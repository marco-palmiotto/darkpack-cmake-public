...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_e_to_anti_nu_e_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = N_d2*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0057 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = N_d3*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0067 = cpow(s_23 + (-0.5)*IT_0026 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0080 = N_d4*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0087 = cpow(s_23 + (-0.5)*IT_0026 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0095 = conj(N_d1)*e_em*m_tau*IT_0018*U_stau_10;
    ...
    const ccomplex_t IT_0149 = 0.5*IT_0028 + 0.5*IT_0048 + 0.5*IT_0068 + 0.5
      *IT_0088 + (-0.5)*IT_0103 + (-0.5)*IT_0118 + (-0.5)*IT_0133 + (-0.5)
      *IT_0148;
    const ccomplex_t IT_0150 = 0.5*IT_0102 + 0.5*IT_0117 + 0.5*IT_0132 + 0.5
      *IT_0147;
