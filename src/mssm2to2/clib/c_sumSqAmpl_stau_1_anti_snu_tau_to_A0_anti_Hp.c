        ...
        )
{
    ...
    const ccomplex_t IT_0026 = IT_0014*IT_0022;
    const ccomplex_t IT_0027 = pow(m_stau_1, 2);
    const ccomplex_t IT_0028 = 0.5*IT_0019 + 0.5*IT_0027;
    const ccomplex_t IT_0029 = s_12 + IT_0028;
    const ccomplex_t IT_0030 = IT_0026*IT_0029;
    const ccomplex_t IT_0031 = IT_0016*IT_0021;
    const ccomplex_t IT_0032 = s_23*IT_0031;
    const ccomplex_t IT_0033 = (-2)*IT_0030 + -IT_0032;
    const ccomplex_t IT_0034 = IT_0025 + IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0019 + -IT_0027 + -reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = pow(m_W, -1);
    const ccomplex_t IT_0039 = cpow(IT_0001, -1);
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*(A_tau*IT_0003*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0012*(m_W*IT_0001*IT_0003*U_stau_01 + (-0.5)
      *m_tau*IT_0038*(m_tau*IT_0003*IT_0039*U_stau_01 + mu_h*U_stau_11)));
    const ccomplex_t IT_0041 = e_em*mu_h*m_tau*IT_0038*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0042 = IT_0012*IT_0041;
    const ccomplex_t IT_0043 = e_em*mu_h*m_tau*IT_0038*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0044 = IT_0012*IT_0043;
    const ccomplex_t IT_0045 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0046 = IT_0003*IT_0045;
    const ccomplex_t IT_0047 = 1.4142135623731*IT_0046;
    const ccomplex_t IT_0048 = A_tau*U_stau_00*conj(U_stau_11);
    const ccomplex_t IT_0049 = IT_0003*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = (-0.5)*IT_0042 + 0.5*IT_0044 + (-0.5)*IT_0047 +
       0.5*IT_0050;
    const ccomplex_t IT_0052 = IT_0040*IT_0051;
    const ccomplex_t IT_0053 = pow(m_A0, 2);
    const ccomplex_t IT_0054 = cpow((-2)*s_13 + IT_0027 + IT_0053 + reg_prop +
    ...
    const ccomplex_t IT_0057 = m_W*e_em*IT_0012;
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = cpow(IT_0003, 2);
    const ccomplex_t IT_0060 = A_tau*IT_0001*U_stau_10 + 0.707106781186548
      *e_em*IT_0012*((IT_0005*IT_0038 + -m_W*(IT_0002 + -IT_0059))*U_stau_00 + 
      -mu_h*m_tau*IT_0003*IT_0038*IT_0039*U_stau_10);
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = -IT_0061;
    const ccomplex_t IT_0063 = IT_0058*IT_0062;
    const ccomplex_t IT_0064 = pow(m_W, 2);
    const ccomplex_t IT_0065 = cpow((-2)*s_12 + -IT_0019 + -IT_0027 + IT_0064 
      + -reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0063*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = e_em*mu_h*m_tau*IT_0038*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0069 = IT_0012*IT_0068;
    const ccomplex_t IT_0070 = e_em*mu_h*m_tau*IT_0038*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0071 = IT_0012*IT_0070;
    const ccomplex_t IT_0072 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0073 = IT_0003*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = A_tau*U_stau_00*conj(U_stau_10);
    const ccomplex_t IT_0076 = IT_0003*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = (-0.5)*IT_0069 + 0.5*IT_0071 + (-0.5)*IT_0074 +
       0.5*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*(A_tau*IT_0003*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0012*(m_W*IT_0001*IT_0003*U_stau_00 + (-0.5)
      *m_tau*IT_0038*(m_tau*IT_0003*IT_0039*U_stau_00 + mu_h*U_stau_10)));
    const ccomplex_t IT_0080 = IT_0078*IT_0079;
    const ccomplex_t IT_0081 = cpow((-2)*s_13 + IT_0053 + reg_prop + (0 +
       _Complex_I*1)*m_stau_1*Gamma_tau1, -1);
    const ccomplex_t IT_0082 = IT_0080*IT_0081;
    const ccomplex_t IT_0083 = (0 + _Complex_I*1)*IT_0082;
    const ccomplex_t IT_0084 = IT_0010 + IT_0037 + IT_0056 + -IT_0067 + IT_0083;
