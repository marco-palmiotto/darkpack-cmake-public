...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_A0_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_13 + IT_0017 + IT_0018 + reg_prop +
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_12 + -IT_0018 + -IT_0027 + m_Hp*
    ...
    const ccomplex_t IT_0034 = e_em*mu_h*m_tau*IT_0004*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0035 = IT_0001*IT_0034;
    const ccomplex_t IT_0036 = e_em*mu_h*m_tau*IT_0004*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0037 = IT_0001*IT_0036;
    const ccomplex_t IT_0038 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0039 = IT_0009*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0044 = (-0.5)*IT_0035 + 0.5*IT_0037 + (-0.5)*IT_0040 +
       0.5*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_13 + IT_0017 + reg_prop + (0 +
    ...
    return create_ccomplex_return(-IT_0049*(conj(IT_0049)*(IT_0027 + -IT_0052)
       + conj(IT_0053)*(s_12 + IT_0055)) + -IT_0053*(conj(IT_0049)*(s_12 +
       IT_0055) + conj(IT_0053)*(IT_0018 + -IT_0057)));
}
