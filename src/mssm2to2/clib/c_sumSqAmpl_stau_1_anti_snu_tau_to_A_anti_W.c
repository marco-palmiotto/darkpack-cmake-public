        ...
        )
{
    ...
    const ccomplex_t IT_0014 = s_13 + s_23;
    const ccomplex_t IT_0015 = IT_0013*IT_0014;
    const ccomplex_t IT_0016 = -IT_0009;
    const ccomplex_t IT_0017 = IT_0012*IT_0016;
    const ccomplex_t IT_0018 = s_23*IT_0017;
    const ccomplex_t IT_0019 = IT_0011*IT_0016;
    const ccomplex_t IT_0020 = -s_23;
    const ccomplex_t IT_0021 = s_12 + IT_0006;
    const ccomplex_t IT_0022 = IT_0020 + IT_0021;
    const ccomplex_t IT_0023 = IT_0019*IT_0022;
    const ccomplex_t IT_0024 = IT_0010*IT_0011;
    const ccomplex_t IT_0025 = (-0.5)*s_13 + (-0.5)*s_23 + 0.5*IT_0005 + 0.5
      *IT_0006;
    ...
    const ccomplex_t IT_0038 = A_tau*IT_0031*U_stau_10 + 0.707106781186548
      *e_em*IT_0002*((IT_0032*IT_0035 + -m_W*(IT_0036 + -IT_0037))*U_stau_00 + 
      -mu_h*m_tau*IT_0032*IT_0033*IT_0034*U_stau_10);
    ...
    const ccomplex_t IT_0057 = 2*IT_0011;
    const ccomplex_t IT_0058 = IT_0010*IT_0057;
    const ccomplex_t IT_0059 = IT_0019 + IT_0058;
    const ccomplex_t IT_0060 = IT_0016*IT_0057;
    const ccomplex_t IT_0061 = -IT_0024 + -IT_0060;
    ...
    const ccomplex_t IT_0081 = IT_0056*(IT_0024 + -IT_0058);
    const ccomplex_t IT_0082 = 0.5*IT_0081;
    const ccomplex_t IT_0083 = conj(IT_0047)*(IT_0064 + IT_0066) + IT_0047*
      (conj(IT_0064) + conj(IT_0066)) + IT_0006*(conj(IT_0066)*IT_0067 + IT_0066
      *conj(IT_0067)) + s_12*(conj(IT_0067)*IT_0072 + IT_0067*conj(IT_0072) +
       conj(IT_0066)*IT_0080 + IT_0066*conj(IT_0080)) + IT_0005*(conj(IT_0072)
      *IT_0080 + IT_0072*conj(IT_0080)) + s_23*(conj(IT_0064)*IT_0066 + IT_0064
      *conj(IT_0066) + conj(IT_0067)*IT_0082 + IT_0067*conj(IT_0082)) + s_13*
    ...
    const ccomplex_t IT_0098 = -IT_0008*(IT_0019 + -IT_0024 + -IT_0051);
    ...
    const ccomplex_t IT_0121 = IT_0064*(IT_0020*conj(IT_0067) + conj(IT_0080)
      *IT_0118) + -IT_0067*(IT_0006*conj(IT_0067) + -conj(IT_0080)*IT_0119 +
       IT_0020*IT_0120) + -IT_0080*(IT_0005*conj(IT_0080) + -conj(IT_0067)
    ...
    const ccomplex_t IT_0125 = -conj(IT_0066);
    const ccomplex_t IT_0126 = conj(IT_0082)*(IT_0047 + -IT_0020*IT_0066 + 
      -IT_0072*IT_0118) + IT_0066*(IT_0006*conj(IT_0066) + IT_0119*IT_0124) +
       IT_0082*(conj(IT_0047) + IT_0118*IT_0124 + IT_0020*IT_0125) + IT_0072*
    ...
    const ccomplex_t IT_0130 = s_12*IT_0100;
    const ccomplex_t IT_0131 = s_13*IT_0108;
    const ccomplex_t IT_0132 = IT_0005*IT_0089;
    const ccomplex_t IT_0133 = IT_0047 + IT_0130 + IT_0131 + IT_0132;
    const ccomplex_t IT_0134 = s_23*IT_0108;
    const ccomplex_t IT_0135 = IT_0006*IT_0100 + IT_0115 + IT_0134;
    const ccomplex_t IT_0136 = s_23*conj(IT_0108);
    const ccomplex_t IT_0137 = IT_0103 + IT_0136;
    const ccomplex_t IT_0138 = s_12*conj(IT_0100);
    const ccomplex_t IT_0139 = s_13*conj(IT_0108);
    const ccomplex_t IT_0140 = IT_0005*conj(IT_0089);
    const ccomplex_t IT_0141 = s_14*s_34*IT_0084;
    const ccomplex_t IT_0142 = -IT_0141;
    const ccomplex_t IT_0143 = s_13 + IT_0142;
    const ccomplex_t IT_0144 = IT_0083*IT_0087 + conj(IT_0047)*(IT_0089
      ...
      *IT_0111 + IT_0108*IT_0114 + conj(IT_0100)*IT_0115) + IT_0117*IT_0121 + 
      -IT_0123*IT_0126 + IT_0129*(conj(IT_0047)*IT_0100 + IT_0047*conj(IT_0100) 
      + conj(IT_0064)*IT_0111 + IT_0064*IT_0114 + conj(IT_0080)*IT_0133 + conj
      (IT_0067)*IT_0135 + IT_0067*IT_0137 + IT_0080*(conj(IT_0047) + IT_0138 +
       IT_0139 + IT_0140)) + (conj(IT_0047)*IT_0108 + IT_0047*conj(IT_0108) +
       conj(IT_0082)*IT_0111 + IT_0082*IT_0114 + conj(IT_0072)*IT_0133 + conj
      (IT_0066)*IT_0135 + IT_0066*IT_0137 + IT_0072*(conj(IT_0047) + IT_0138 +
       IT_0139 + IT_0140))*IT_0143;
