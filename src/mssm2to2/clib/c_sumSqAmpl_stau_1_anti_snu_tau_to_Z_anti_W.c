...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_Z_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0004 + -IT_0000*IT_0005)*U_stau_00*conj(U_stau_00) + IT_0000*IT_0005
    ...
    const ccomplex_t IT_0010 = cpow((-2)*s_13 + IT_0009 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001
      *U_stau_01;
    const ccomplex_t IT_0014 = -IT_0013;
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0004 + -IT_0000*IT_0005)*U_stau_00*conj(U_stau_01) + IT_0000*IT_0005
      *U_stau_10*conj(U_stau_11));
    const ccomplex_t IT_0016 = (-2)*IT_0015;
    const ccomplex_t IT_0017 = IT_0014*IT_0016;
    const ccomplex_t IT_0018 = pow(m_stau_1, 2);
    const ccomplex_t IT_0019 = cpow((-2)*s_13 + IT_0009 + IT_0018 + reg_prop +
    ...
    const ccomplex_t IT_0030 = -(IT_0025 + -IT_0026)*(IT_0018 + -IT_0029);
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0005;
    const ccomplex_t IT_0032 = -IT_0031;
    const ccomplex_t IT_0033 = IT_0003*IT_0032;
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0009 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0004;
    const ccomplex_t IT_0039 = 2*IT_0038;
    const ccomplex_t IT_0040 = IT_0037*IT_0039;
    const ccomplex_t IT_0041 = IT_0003*IT_0039;
    const ccomplex_t IT_0042 = -IT_0041;
    const ccomplex_t IT_0043 = IT_0040 + IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0018 + -IT_0026 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0051 = (-2)*IT_0038;
    ...
    const ccomplex_t IT_0067 = A_tau*IT_0060*U_stau_10 + 0.707106781186548
      *e_em*IT_0001*((IT_0061*IT_0064 + -m_W*(IT_0065 + -IT_0066))*U_stau_00 + 
      -mu_h*m_tau*IT_0061*IT_0062*IT_0063*U_stau_10);
    ...
    const ccomplex_t IT_0098 = IT_0040*IT_0045;
    ...
    const ccomplex_t IT_0107 = (IT_0073 + -IT_0104)*(IT_0018 + -IT_0106);
    const ccomplex_t IT_0108 = -IT_0107;
    const ccomplex_t IT_0109 = IT_0003*IT_0051;
    const ccomplex_t IT_0110 = IT_0045*(IT_0052 + -IT_0109);
    ...
    const ccomplex_t IT_0135 = (s_12 + -IT_0048)*(IT_0009 + -IT_0134);
    const ccomplex_t IT_0136 = -(IT_0026 + -IT_0128)*(IT_0009 + -IT_0134);
    const ccomplex_t IT_0137 = (s_23 + -IT_0049)*(s_24 + -IT_0101);
    const ccomplex_t IT_0138 = -(s_23 + -IT_0049)*(IT_0026 + -IT_0128);
    const ccomplex_t IT_0139 = -IT_0036;
    const ccomplex_t IT_0140 = (IT_0025 + -IT_0026)*(s_24 + -IT_0101);
    const ccomplex_t IT_0141 = -conj(IT_0036);
    const ccomplex_t IT_0142 = -(IT_0018 + -IT_0029)*(IT_0009 + -IT_0134);
    const ccomplex_t IT_0143 = (s_23 + -IT_0049)*(s_14 + -IT_0055);
    const ccomplex_t IT_0144 = -(IT_0018 + -IT_0029)*(s_23 + -IT_0049);
    const ccomplex_t IT_0145 = -IT_0022;
    const ccomplex_t IT_0146 = (IT_0025 + IT_0129)*(IT_0128 + IT_0129);
    const ccomplex_t IT_0147 = (IT_0025 + -IT_0026)*(s_12 + -IT_0048);
    const ccomplex_t IT_0148 = (IT_0025 + -IT_0026)*(IT_0073 + -IT_0104);
    const ccomplex_t IT_0149 = (IT_0025 + -IT_0026)*(s_14 + -IT_0055);
    const ccomplex_t IT_0150 = -conj(IT_0022);
    const ccomplex_t IT_0151 = conj(IT_0022)*(IT_0022*IT_0030 + IT_0047
      ...
      *IT_0056 + IT_0098*IT_0100 + IT_0036*IT_0102 + IT_0047*IT_0103 + -IT_0053
      *IT_0108 + IT_0110*IT_0111 + IT_0115*IT_0116) + (IT_0053*IT_0115 + IT_0098
      *IT_0120 + IT_0047*IT_0123 + IT_0110*IT_0126 + IT_0036*IT_0132)*IT_0133 +
       conj(IT_0047)*(IT_0022*IT_0050 + IT_0053*IT_0103 + IT_0116*IT_0123 +
       IT_0098*IT_0135 + -IT_0047*IT_0136 + IT_0110*IT_0137 + IT_0138*IT_0139) +
       (IT_0047*IT_0138 + IT_0110*IT_0140)*IT_0141 + conj(IT_0098)*(IT_0036
      *IT_0050 + IT_0053*IT_0100 + IT_0116*IT_0120 + IT_0047*IT_0135 + -IT_0098
      *IT_0142 + IT_0110*IT_0143 + IT_0144*IT_0145) + conj(IT_0036)*(IT_0050
      *IT_0098 + IT_0053*IT_0102 + IT_0116*IT_0132 + IT_0036*IT_0146 + IT_0145
      *IT_0147) + conj(IT_0110)*(IT_0053*IT_0111 + IT_0116*IT_0126 + IT_0047
      *IT_0137 + IT_0139*IT_0140 + IT_0098*IT_0143 + -IT_0110*IT_0148 + IT_0145
      *IT_0149) + (IT_0098*IT_0144 + IT_0036*IT_0147 + IT_0110*IT_0149)*IT_0150;
