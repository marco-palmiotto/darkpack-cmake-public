...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_anti_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1)*(A_tau*IT_0005*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0003*(m_W*IT_0005*IT_0006*U_stau_00 + (-0.5)
      *m_tau*IT_0007*(m_tau*IT_0005*IT_0008*U_stau_00 + mu_h*U_stau_10)));
    const ccomplex_t IT_0010 = pow(m_stau_1, 2);
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_23 + IT_0011 + IT_0022 + reg_prop +
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
       -IT_0000*IT_0003)*U_stau_00*conj(U_stau_01) + IT_0001*IT_0002*U_stau_10
      *conj(U_stau_11));
    const ccomplex_t IT_0028 = (-2)*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*(A_tau*IT_0005*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0003*(m_W*IT_0005*IT_0006*U_stau_01 + (-0.5)
      *m_tau*IT_0007*(m_tau*IT_0005*IT_0008*U_stau_01 + mu_h*U_stau_11)));
    const ccomplex_t IT_0030 = cpow((-2)*s_23 + IT_0011 + IT_0022 + reg_prop +
    ...
    const ccomplex_t IT_0035 = s_14*s_34*IT_0017;
    const ccomplex_t IT_0036 = -IT_0035;
    const ccomplex_t IT_0037 = s_13 + IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0003;
    const ccomplex_t IT_0039 = -IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_13 + IT_0010 + IT_0022 + reg_prop +
    ...
    const ccomplex_t IT_0044 = -IT_0015 + IT_0026 + IT_0033 + IT_0043;
    const ccomplex_t IT_0045 = s_14*s_24*IT_0017;
    const ccomplex_t IT_0046 = -IT_0045;
    const ccomplex_t IT_0047 = s_12 + IT_0046;
    const ccomplex_t IT_0048 = -IT_0016;
    const ccomplex_t IT_0049 = pow(s_34, 2);
    const ccomplex_t IT_0050 = IT_0017*IT_0049;
    const ccomplex_t IT_0051 = s_24*s_34*IT_0017;
    const ccomplex_t IT_0052 = -IT_0051;
    const ccomplex_t IT_0053 = s_23 + IT_0052;
    const ccomplex_t IT_0054 = -conj(IT_0016);
    const ccomplex_t IT_0055 = pow(s_24, 2);
    const ccomplex_t IT_0056 = IT_0017*IT_0055;
    const ccomplex_t IT_0057 = (conj(IT_0016)*(IT_0010 + -IT_0019) + conj
      (IT_0034)*IT_0037 + conj(IT_0044)*IT_0047)*IT_0048 + -IT_0034*(conj
      (IT_0034)*(IT_0022 + -IT_0050) + conj(IT_0044)*IT_0053 + -IT_0037*IT_0054)
       + -IT_0044*(conj(IT_0034)*IT_0053 + -IT_0047*IT_0054 + conj(IT_0044)*
      (IT_0011 + -IT_0056));
