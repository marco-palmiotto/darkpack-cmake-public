        ...
        )
{
    ...
    const ccomplex_t IT_0038 = N_B1*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0042 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0062 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0079 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0080 = IT_0029*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0099 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0100 = IT_0029*IT_0099;
    const ccomplex_t IT_0101 = 1.4142135623731*IT_0100;
    const ccomplex_t IT_0102 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0116 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0002
      *U_stau_00;
    const ccomplex_t IT_0117 = (-0.5)*IT_0116;
    const ccomplex_t IT_0118 = m_tau*IT_0117;
    const ccomplex_t IT_0119 = -IT_0116;
    ...
    const ccomplex_t IT_0181 = IT_0109*IT_0180;
    ...
    const ccomplex_t IT_0184 = -IT_0020 + -IT_0027 + 0.5*IT_0050 + 0.5*IT_0070
       + 0.5*IT_0090 + 0.5*IT_0110 + -IT_0123 + (-0.5)*IT_0138 + (-0.5)*IT_0153 
      + (-0.5)*IT_0168 + (-0.5)*IT_0183;
    const ccomplex_t IT_0185 = IT_0115*IT_0119;
