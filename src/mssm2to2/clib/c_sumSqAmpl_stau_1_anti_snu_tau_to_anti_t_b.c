...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_anti_t_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0001*IT_0015;
    ...
    const ccomplex_t IT_0024 = A_tau*IT_0018*U_stau_10 + 0.707106781186548
      *e_em*IT_0001*((IT_0015*IT_0021 + -m_W*(IT_0022 + -IT_0023))*U_stau_00 + 
      -mu_h*m_tau*IT_0015*IT_0019*IT_0020*U_stau_10);
    ...
    const ccomplex_t IT_0032 = m_b*IT_0003;
    const ccomplex_t IT_0033 = -IT_0032;
    const ccomplex_t IT_0034 = IT_0031 + IT_0033;
    const ccomplex_t IT_0035 = IT_0010*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*(A_tau*IT_0020*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0001*(m_W*IT_0018*IT_0020*U_stau_00 + (-0.5)
      *m_tau*IT_0015*(m_tau*IT_0019*IT_0020*U_stau_00 + mu_h*U_stau_10)));
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
    ...
    const ccomplex_t IT_0045 = cpow(IT_0020, -1);
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*e_em
      *IT_0001*IT_0015*IT_0018*IT_0045;
    ...
    const ccomplex_t IT_0056 = m_t*IT_0030;
    ...
    const ccomplex_t IT_0061 = -IT_0050 + -IT_0055 + IT_0060;
