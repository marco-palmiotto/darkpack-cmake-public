        ...
        )
{
    ...
    const ccomplex_t IT_0025 = m_b*IT_0024;
    const ccomplex_t IT_0026 = m_b*IT_0003;
    const ccomplex_t IT_0027 = -IT_0026;
    const ccomplex_t IT_0028 = IT_0025 + IT_0027;
    const ccomplex_t IT_0029 = IT_0010*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0001*IT_0015;
    ...
    const ccomplex_t IT_0050 = m_t*IT_0024;
    const ccomplex_t IT_0051 = m_t*IT_0003;
