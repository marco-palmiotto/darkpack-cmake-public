...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_anti_u_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0001*IT_0013*IT_0015*IT_0016;
    ...
    const ccomplex_t IT_0025 = m_d*IT_0024;
    const ccomplex_t IT_0026 = m_d*IT_0003;
    ...
    const ccomplex_t IT_0044 = m_d*s_13;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0001*IT_0015;
    ...
    const ccomplex_t IT_0050 = m_u*IT_0024;
    const ccomplex_t IT_0051 = m_u*IT_0003;
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0001*IT_0014*IT_0015*IT_0055;
