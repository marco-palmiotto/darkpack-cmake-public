...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_h_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = cpow(IT_0002, 2);
    const ccomplex_t IT_0012 = cpow(IT_0001, 2);
    const ccomplex_t IT_0013 = A_tau*IT_0002*U_stau_10 + 0.707106781186548
      *e_em*IT_0005*((IT_0008*IT_0010 + -m_W*(IT_0011 + -IT_0012))*U_stau_00 + 
      -mu_h*m_tau*IT_0001*IT_0008*IT_0009*U_stau_10);
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005
      *U_stau_00;
    const ccomplex_t IT_0024 = (-0.5)*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*m_W*e_em*(IT_0000*IT_0001 + 
      -IT_0002*IT_0003)*IT_0005;
    const ccomplex_t IT_0026 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0017 + -IT_0018 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0060 = IT_0002*IT_0003;
    const ccomplex_t IT_0061 = IT_0000*IT_0001;
    const ccomplex_t IT_0062 = IT_0060 + IT_0061;
    const ccomplex_t IT_0063 = 2*U_stau_00*((IT_0003*IT_0005*IT_0008*IT_0009
      *IT_0010 + (-0.5)*m_W*(IT_0005 + -IT_0004*IT_0043)*IT_0062)*conj(U_stau_01
      ) + 1./2*IT_0000*IT_0005*IT_0009*IT_0059*conj(U_stau_11)) + U_stau_10*
      (IT_0000*IT_0005*IT_0009*IT_0059*conj(U_stau_01) + 2*(IT_0003*IT_0005
      *IT_0008*IT_0009*IT_0010 + -m_W*IT_0004*IT_0043*IT_0062)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0066 = cpow((-2)*s_13 + IT_0017 + IT_0048 + reg_prop +
    ...
    const ccomplex_t IT_0070 = -IT_0041;
    const ccomplex_t IT_0071 = IT_0024 + IT_0070;
    const ccomplex_t IT_0072 = IT_0028*IT_0071;
    const ccomplex_t IT_0073 = 2*U_stau_00*((IT_0003*IT_0005*IT_0008*IT_0009
      *IT_0010 + (-0.5)*m_W*(IT_0005 + -IT_0004*IT_0043)*IT_0062)*conj(U_stau_00
      ) + 1./2*IT_0000*IT_0005*IT_0009*IT_0059*conj(U_stau_10)) + U_stau_10*
      (IT_0000*IT_0005*IT_0009*IT_0059*conj(U_stau_00) + 2*(IT_0003*IT_0005
      *IT_0008*IT_0009*IT_0010 + -m_W*IT_0004*IT_0043*IT_0062)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0048 + reg_prop + (0 +
       _Complex_I*1)*m_stau_1*Gamma_tau1, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = IT_0041*IT_0078;
    const ccomplex_t IT_0080 = -IT_0022 + -IT_0036 + IT_0052 + IT_0069 + 
      -IT_0072 + IT_0079;
    ...
    const ccomplex_t IT_0093 = (conj(IT_0037)*(IT_0017 + -IT_0040) + conj
