        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0005 + -IT_0006*IT_0007);
    ...
    const ccomplex_t IT_0021 = cpow(IT_0005, 2);
    const ccomplex_t IT_0022 = A_tau*IT_0006*U_stau_10 + 0.707106781186548
      *e_em*IT_0001*((IT_0017*IT_0019 + -m_W*(IT_0020 + -IT_0021))*U_stau_00 + 
      -mu_h*m_tau*IT_0005*IT_0017*IT_0018*U_stau_10);
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*IT_0022;
    const ccomplex_t IT_0024 = -IT_0023;
    const ccomplex_t IT_0025 = pow(m_W, 2);
    const ccomplex_t IT_0026 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + IT_0025 
      + -reg_prop, -1);
    const ccomplex_t IT_0027 = IT_0024*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = IT_0016*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*e_em*IT_0001*(IT_0004
      *IT_0006 + IT_0005*IT_0007);
    const ccomplex_t IT_0031 = -IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*(A_tau*IT_0005*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0001*(m_W*IT_0005*IT_0006*U_stau_00 + (-0.5)
      *m_tau*IT_0017*(m_tau*IT_0005*IT_0018*U_stau_00 + mu_h*U_stau_10)));
    const ccomplex_t IT_0033 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + m_Hp*
    ...
    const ccomplex_t IT_0041 = -IT_0002;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*m_W*e_em*(IT_0004*IT_0005 +
       IT_0006*IT_0007)*IT_0045;
    ...
    const ccomplex_t IT_0057 = mu_h*m_tau*IT_0017;
    const ccomplex_t IT_0058 = IT_0006*IT_0007;
    const ccomplex_t IT_0059 = IT_0004*IT_0005;
    const ccomplex_t IT_0060 = IT_0058 + IT_0059;
    const ccomplex_t IT_0061 = 2*U_stau_00*((IT_0001*IT_0007*IT_0017*IT_0018
      *IT_0019 + (-0.5)*m_W*(IT_0001 + -IT_0000*IT_0043)*IT_0060)*conj(U_stau_00
      ) + 1./2*IT_0001*IT_0004*IT_0018*IT_0057*conj(U_stau_10)) + U_stau_10*
      (IT_0001*IT_0004*IT_0018*IT_0057*conj(U_stau_00) + 2*(IT_0001*IT_0007
      *IT_0017*IT_0018*IT_0019 + -m_W*IT_0000*IT_0043*IT_0060)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0048 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0070 = 2*U_stau_00*((IT_0001*IT_0007*IT_0017*IT_0018
      *IT_0019 + (-0.5)*m_W*(IT_0001 + -IT_0000*IT_0043)*IT_0060)*conj(U_stau_01
      ) + 1./2*IT_0001*IT_0004*IT_0018*IT_0057*conj(U_stau_11)) + U_stau_10*
      (IT_0001*IT_0004*IT_0018*IT_0057*conj(U_stau_01) + 2*(IT_0001*IT_0007
      *IT_0017*IT_0018*IT_0019 + -m_W*IT_0000*IT_0043*IT_0060)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0073 = cpow((-2)*s_13 + IT_0009 + IT_0048 + reg_prop +
    ...
    const ccomplex_t IT_0080 = -IT_0029 + -IT_0036 + IT_0052 + IT_0067 +
       IT_0076 + -IT_0079;
    ...
    const ccomplex_t IT_0093 = (conj(IT_0037)*(IT_0009 + -IT_0040) + conj
