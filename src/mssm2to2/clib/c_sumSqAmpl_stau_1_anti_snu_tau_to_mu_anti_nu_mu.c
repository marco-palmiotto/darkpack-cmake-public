...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_mu_anti_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*(A_tau*IT_0003*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0005*(m_W*IT_0001*IT_0003*U_stau_00 + (-0.5)
      *m_tau*IT_0000*(m_tau*IT_0002*IT_0003*U_stau_00 + mu_h*U_stau_10)));
    ...
    const ccomplex_t IT_0022 = m_mu*IT_0021;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*e_em*m_mu
      *IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0033 = A_tau*IT_0001*U_stau_10 + 0.707106781186548
      *e_em*IT_0005*((IT_0000*IT_0030 + -m_W*(IT_0031 + -IT_0032))*U_stau_00 + 
      -mu_h*m_tau*IT_0000*IT_0002*IT_0003*U_stau_10);
    ...
    const ccomplex_t IT_0044 = m_mu*s_14;
