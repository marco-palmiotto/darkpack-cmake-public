        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
    ...
    const ccomplex_t IT_0038 = m_s*IT_0037;
    const ccomplex_t IT_0039 = m_s*IT_0003;
    ...
    const ccomplex_t IT_0050 = m_c*IT_0037;
