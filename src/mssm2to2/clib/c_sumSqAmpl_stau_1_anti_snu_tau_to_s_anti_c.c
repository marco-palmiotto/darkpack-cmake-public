...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_snu_tau_to_s_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = pow(m_stau_1, 2);
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*(A_tau*IT_0013*U_stau_10 + (
      -1.4142135623731)*e_em*IT_0001*(m_W*IT_0013*IT_0014*U_stau_00 + (-0.5)
      *m_tau*IT_0015*(m_tau*IT_0013*IT_0016*U_stau_00 + mu_h*U_stau_10)));
    ...
    const ccomplex_t IT_0035 = A_tau*IT_0014*U_stau_10 + 0.707106781186548
      *e_em*IT_0001*((IT_0015*IT_0032 + -m_W*(IT_0033 + -IT_0034))*U_stau_00 + 
      -mu_h*m_tau*IT_0013*IT_0015*IT_0016*U_stau_10);
