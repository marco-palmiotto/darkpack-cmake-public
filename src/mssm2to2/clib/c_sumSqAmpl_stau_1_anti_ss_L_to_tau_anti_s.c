...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_ss_L_to_tau_anti_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = conj(N_W4)*e_em*U_stau_00;
    ...
    const ccomplex_t IT_0022 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0033 = cpow(s_13 + (-0.5)*IT_0028 + (-0.5)*IT_0029 +
    ...
    const ccomplex_t IT_0094 = conj(N_d1)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0106 = N_d3*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0117 = N_d4*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0124 = IT_0030*IT_0122*IT_0123;
    ...
    const ccomplex_t IT_0129 = N_d2*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0135 = IT_0033*IT_0125*IT_0134;
    ...
    const ccomplex_t IT_0150 = m_tau*IT_0032;
    ...
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
    ...
    const ccomplex_t IT_0159 = IT_0026*IT_0154;
    const ccomplex_t IT_0160 = IT_0030*IT_0123*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0006*IT_0019*IT_0021;
    const ccomplex_t IT_0162 = (-0.5)*IT_0161;
    const ccomplex_t IT_0163 = IT_0133*IT_0162;
    ...
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0006*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0006*IT_0019*IT_0021;
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = IT_0098*IT_0174;
    const ccomplex_t IT_0176 = IT_0079*IT_0139*IT_0175;
    const ccomplex_t IT_0177 = IT_0052*IT_0162;
    const ccomplex_t IT_0178 = IT_0033*IT_0125*IT_0177;
    const ccomplex_t IT_0179 = IT_0074*IT_0168;
    const ccomplex_t IT_0180 = IT_0076*IT_0112*IT_0179;
    const ccomplex_t IT_0181 = IT_0147*IT_0174;
    const ccomplex_t IT_0182 = IT_0079*IT_0181;
    const ccomplex_t IT_0183 = (0 + _Complex_I*1)*IT_0182;
    const ccomplex_t IT_0184 = m_tau*IT_0183;
    const ccomplex_t IT_0185 = (-0.5)*IT_0158 + 0.5*IT_0160 + (-0.5)*IT_0166 +
       (-0.5)*IT_0172 + 0.5*IT_0176 + 0.5*IT_0178 + 0.5*IT_0180 + (-0.5)*IT_0184;
    const ccomplex_t IT_0186 = m_s*s_13;
    const ccomplex_t IT_0187 = 0.5*IT_0157 + 0.5*IT_0165 + 0.5*IT_0171 + 0.5
      *IT_0183;
