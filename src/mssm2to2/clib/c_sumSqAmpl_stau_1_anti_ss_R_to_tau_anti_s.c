...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_ss_R_to_tau_anti_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0010 = IT_0008*IT_0009;
    const ccomplex_t IT_0011 = 1.4142135623731*IT_0010;
    const ccomplex_t IT_0012 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0013 = IT_0004*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = IT_0002*IT_0004;
    const ccomplex_t IT_0016 = conj(N_d4)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0035 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0052 = conj(N_d3)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0064 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0065 = IT_0008*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0068 = IT_0004*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = conj(N_d1)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0078 = 0.5*IT_0026 + 0.5*IT_0043 + 0.5*IT_0060 + 0.5
      *IT_0077;
    const ccomplex_t IT_0079 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0080 = IT_0008*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0089 = IT_0061*IT_0087*IT_0088;
    const ccomplex_t IT_0090 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0091 = IT_0008*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0100 = IT_0041*IT_0098*IT_0099;
    const ccomplex_t IT_0101 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0102 = IT_0008*IT_0101;
    const ccomplex_t IT_0103 = 1.4142135623731*IT_0102;
    const ccomplex_t IT_0104 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0110 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0111 = IT_0058*IT_0109*IT_0110;
    const ccomplex_t IT_0112 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0113 = IT_0008*IT_0112;
    const ccomplex_t IT_0114 = 1.4142135623731*IT_0113;
    const ccomplex_t IT_0115 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0122 = IT_0024*IT_0120*IT_0121;
    const ccomplex_t IT_0123 = m_tau*IT_0077;
    const ccomplex_t IT_0124 = m_tau*IT_0043;
    const ccomplex_t IT_0125 = m_tau*IT_0060;
    const ccomplex_t IT_0126 = m_tau*IT_0026;
    const ccomplex_t IT_0127 = 0.5*IT_0089 + 0.5*IT_0100 + 0.5*IT_0111 + 0.5
      *IT_0122 + (-0.5)*IT_0123 + (-0.5)*IT_0124 + (-0.5)*IT_0125 + (-0.5)
      *IT_0126;
    const ccomplex_t IT_0128 = s_14*m_tau;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0008;
    const ccomplex_t IT_0130 = (-0.333333333333333)*IT_0129;
    const ccomplex_t IT_0131 = IT_0020*IT_0130;
    const ccomplex_t IT_0132 = IT_0024*IT_0121*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0008;
    const ccomplex_t IT_0134 = (-0.333333333333333)*IT_0133;
    const ccomplex_t IT_0135 = IT_0074*IT_0134;
    const ccomplex_t IT_0136 = IT_0061*IT_0088*IT_0135;
    ...
    const ccomplex_t IT_0140 = IT_0041*IT_0099*IT_0139;
    ...
    const ccomplex_t IT_0145 = IT_0097*IT_0138;
    ...
    const ccomplex_t IT_0155 = IT_0119*IT_0130;
    ...
    const ccomplex_t IT_0159 = IT_0056*IT_0150;
    const ccomplex_t IT_0160 = IT_0058*IT_0110*IT_0159;
    const ccomplex_t IT_0161 = 0.5*IT_0132 + 0.5*IT_0136 + 0.5*IT_0140 + (-0.5
      )*IT_0144 + (-0.5)*IT_0148 + (-0.5)*IT_0154 + (-0.5)*IT_0158 + 0.5*IT_0160;
    const ccomplex_t IT_0162 = m_s*s_13;
    const ccomplex_t IT_0163 = 0.5*IT_0143 + 0.5*IT_0147 + 0.5*IT_0153 + 0.5
      *IT_0157;
    ...
    const ccomplex_t IT_0170 = m_s*m_tau;
    const ccomplex_t IT_0171 = 6*s_34;
    const ccomplex_t IT_0172 = -conj(IT_0078);
    const ccomplex_t IT_0173 = (-6)*conj(IT_0127);
    const ccomplex_t IT_0174 = 6*IT_0078*(conj(IT_0127)*IT_0128 + -conj
      (IT_0161)*IT_0162 + -conj(IT_0163)*IT_0164 + 0.166666666666667*conj
      (IT_0078)*IT_0169) + (-6)*IT_0127*(IT_0162*conj(IT_0163) + conj(IT_0161)
      *IT_0170 + (-0.166666666666667)*conj(IT_0127)*IT_0171 + IT_0128*IT_0172) +
       6*IT_0163*(IT_0128*conj(IT_0161) + 0.166666666666667*conj(IT_0163)
      *IT_0169 + IT_0164*IT_0172 + 0.166666666666667*IT_0162*IT_0173) + 6
      *IT_0161*(IT_0128*conj(IT_0163) + 0.166666666666667*conj(IT_0161)*IT_0171 
      + IT_0162*IT_0172 + 0.166666666666667*IT_0170*IT_0173);
