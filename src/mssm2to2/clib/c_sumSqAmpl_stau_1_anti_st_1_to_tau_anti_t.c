...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_st_1_to_tau_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0031 = conj(N_d1)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0050 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0051 = IT_0004*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0054 = IT_0009*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = conj(N_d4)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0114 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0117 = 0.5*IT_0038 + 0.5*IT_0064 + 0.5*IT_0090 + 0.5
      *IT_0116;
    const ccomplex_t IT_0118 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0119 = IT_0004*IT_0118;
    const ccomplex_t IT_0120 = 1.4142135623731*IT_0119;
    const ccomplex_t IT_0121 = N_d3*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0127 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0128 = IT_0114*IT_0126*IT_0127;
    const ccomplex_t IT_0129 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0130 = IT_0004*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = N_d4*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0139 = IT_0062*IT_0137*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0141 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0142 = IT_0004*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = N_d2*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0150 = IT_0088*IT_0140*IT_0149;
    const ccomplex_t IT_0151 = m_tau*IT_0038;
    const ccomplex_t IT_0152 = m_tau*IT_0090;
    const ccomplex_t IT_0153 = m_tau*IT_0116;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0155 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0156 = IT_0004*IT_0155;
    const ccomplex_t IT_0157 = 1.4142135623731*IT_0156;
    const ccomplex_t IT_0158 = N_d1*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0164 = IT_0002*IT_0154*IT_0163;
    const ccomplex_t IT_0165 = m_tau*IT_0064;
    const ccomplex_t IT_0166 = 0.5*IT_0128 + 0.5*IT_0139 + 0.5*IT_0150 + (-0.5
      )*IT_0151 + (-0.5)*IT_0152 + (-0.5)*IT_0153 + 0.5*IT_0164 + (-0.5)*IT_0165;
    const ccomplex_t IT_0167 = s_14*m_tau;
    const ccomplex_t IT_0168 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0169 = IT_0004*IT_0168;
    const ccomplex_t IT_0170 = 1.4142135623731*IT_0169;
    const ccomplex_t IT_0171 = m_t*conj(N_u4)*e_em*IT_0016*conj(U_st_00);
    ...
    const ccomplex_t IT_0180 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0181 = IT_0004*IT_0180;
    const ccomplex_t IT_0182 = 1.4142135623731*IT_0181;
    const ccomplex_t IT_0183 = m_t*conj(N_u3)*e_em*IT_0016*conj(U_st_00);
    ...
    const ccomplex_t IT_0189 = IT_0114*IT_0127*IT_0188;
    const ccomplex_t IT_0190 = conj(N_B2)*e_em*conj(U_st_10);
    const ccomplex_t IT_0191 = IT_0004*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = m_t*conj(N_u2)*e_em*IT_0016*conj(U_st_00);
    ...
    const ccomplex_t IT_0198 = IT_0086*IT_0197;
    const ccomplex_t IT_0199 = IT_0088*IT_0140*IT_0198;
    const ccomplex_t IT_0200 = IT_0060*IT_0175;
    const ccomplex_t IT_0201 = IT_0062*IT_0138*IT_0200;
    const ccomplex_t IT_0202 = IT_0148*IT_0197;
    const ccomplex_t IT_0203 = IT_0088*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*IT_0203;
    const ccomplex_t IT_0205 = m_tau*IT_0204;
    const ccomplex_t IT_0206 = IT_0125*IT_0187;
    const ccomplex_t IT_0207 = IT_0114*IT_0206;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*IT_0207;
    const ccomplex_t IT_0209 = m_tau*IT_0208;
    const ccomplex_t IT_0210 = conj(N_B1)*e_em*conj(U_st_10);
    const ccomplex_t IT_0211 = IT_0004*IT_0210;
    const ccomplex_t IT_0212 = 1.4142135623731*IT_0211;
    const ccomplex_t IT_0213 = m_t*conj(N_u1)*e_em*IT_0016*conj(U_st_00);
    ...
    const ccomplex_t IT_0218 = IT_0035*IT_0217;
    const ccomplex_t IT_0219 = IT_0002*IT_0154*IT_0218;
    const ccomplex_t IT_0220 = IT_0162*IT_0217;
    ...
    const ccomplex_t IT_0224 = (-0.5)*IT_0179 + 0.5*IT_0189 + 0.5*IT_0199 +
       0.5*IT_0201 + (-0.5)*IT_0205 + (-0.5)*IT_0209 + 0.5*IT_0219 + (-0.5)
      *IT_0223;
    const ccomplex_t IT_0225 = m_t*s_13;
    const ccomplex_t IT_0226 = 0.5*IT_0178 + 0.5*IT_0204 + 0.5*IT_0208 + 0.5
      *IT_0222;
    const ccomplex_t IT_0227 = m_t*m_tau*IT_0001;
    const ccomplex_t IT_0228 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0233 = m_t*m_tau;
    const ccomplex_t IT_0234 = 6*s_34;
    const ccomplex_t IT_0235 = -conj(IT_0117);
    const ccomplex_t IT_0236 = (-6)*conj(IT_0166);
    const ccomplex_t IT_0237 = 6*IT_0117*(conj(IT_0166)*IT_0167 + -conj
      (IT_0224)*IT_0225 + -conj(IT_0226)*IT_0227 + 0.166666666666667*conj
      (IT_0117)*IT_0232) + (-6)*IT_0166*(IT_0225*conj(IT_0226) + conj(IT_0224)
      *IT_0233 + (-0.166666666666667)*conj(IT_0166)*IT_0234 + IT_0167*IT_0235) +
       6*IT_0226*(IT_0167*conj(IT_0224) + 0.166666666666667*conj(IT_0226)
      *IT_0232 + IT_0227*IT_0235 + 0.166666666666667*IT_0225*IT_0236) + 6
      *IT_0224*(IT_0167*conj(IT_0226) + 0.166666666666667*conj(IT_0224)*IT_0234 
      + IT_0225*IT_0235 + 0.166666666666667*IT_0233*IT_0236);
