        ...
        )
{
    ...
    const ccomplex_t IT_0043 = e_em*mu_h*m_tau*IT_0009*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0044 = IT_0007*IT_0043;
    const ccomplex_t IT_0045 = e_em*mu_h*m_tau*IT_0009*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0046 = IT_0007*IT_0045;
    const ccomplex_t IT_0047 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0048 = IT_0003*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0061 = e_em*mu_h*m_tau*IT_0009*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0062 = IT_0007*IT_0061;
    const ccomplex_t IT_0063 = e_em*mu_h*m_tau*IT_0009*conj(U_stau_00)
      *U_stau_11;
    ...
    const ccomplex_t IT_0080 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0014*(IT_0007 + 
      -IT_0006*IT_0015) + IT_0002*IT_0007*IT_0009*IT_0011*IT_0016)*conj
      (U_stau_00) + -1./2*IT_0005*IT_0007*IT_0010*IT_0011*conj(U_stau_10)) +
       U_stau_10*(IT_0005*IT_0007*IT_0010*IT_0011*conj(U_stau_00) + 2*(m_W
      *IT_0006*IT_0014*IT_0015 + -IT_0002*IT_0007*IT_0009*IT_0011*IT_0016)*conj
    ...
    const ccomplex_t IT_0086 = 2*U_stau_00*((IT_0005*IT_0007*IT_0009*IT_0011
      *IT_0016 + (-0.5)*m_W*(IT_0007 + -IT_0006*IT_0015)*IT_0029)*conj(U_stau_00
      ) + 1./2*IT_0002*IT_0007*IT_0010*IT_0011*conj(U_stau_10)) + U_stau_10*
      (IT_0002*IT_0007*IT_0010*IT_0011*conj(U_stau_00) + 2*(IT_0005*IT_0007
      *IT_0009*IT_0011*IT_0016 + -m_W*IT_0006*IT_0015*IT_0029)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0092 = cpow((-2)*s_13 + IT_0054 + reg_prop + (0 +
       _Complex_I*1)*m_stau_1*Gamma_tau1, -1);
    ...
    const ccomplex_t IT_0098 = e_em*mu_h*m_tau*IT_0009*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0099 = IT_0007*IT_0098;
    const ccomplex_t IT_0100 = e_em*mu_h*m_tau*IT_0009*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0101 = IT_0007*IT_0100;
    const ccomplex_t IT_0102 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0103 = IT_0003*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = A_tau*U_stau_00*conj(U_stau_11);
    ...
    const ccomplex_t IT_0108 = (-0.5)*IT_0099 + 0.5*IT_0101 + (-0.5)*IT_0104 +
       0.5*IT_0107;
    const ccomplex_t IT_0109 = cpow((-2)*s_13 + IT_0020 + IT_0054 + reg_prop +
       -m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2), -1);
    ...
    const ccomplex_t IT_0113 = IT_0058 + IT_0075 + -IT_0085 + -IT_0091 +
       IT_0095 + IT_0112;
