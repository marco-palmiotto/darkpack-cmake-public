        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow(s_13 + (-0.5)*reg_prop + (0 + _Complex_I*(
    ...
    const ccomplex_t IT_0025 = (-0.5)*IT_0015;
    const ccomplex_t IT_0026 = (IT_0012 + -IT_0017)*(IT_0014 + IT_0022);
    const ccomplex_t IT_0027 = (-0.5)*IT_0026;
    const ccomplex_t IT_0028 = pow(s_23, 2);
    const ccomplex_t IT_0029 = cpow(IT_0011, 2);
    const ccomplex_t IT_0030 = IT_0022*(IT_0012 + -IT_0029);
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = IT_0019*IT_0022;
    const ccomplex_t IT_0033 = (-0.5)*IT_0017 + (-0.5)*IT_0029;
    const ccomplex_t IT_0034 = IT_0012 + IT_0033;
    const ccomplex_t IT_0035 = IT_0014*IT_0034;
    const ccomplex_t IT_0036 = 0.5*IT_0032 + IT_0035;
    const ccomplex_t IT_0037 = 0.5*IT_0030;
    const ccomplex_t IT_0038 = IT_0016 + IT_0024;
    const ccomplex_t IT_0039 = -s_13*IT_0007;
    const ccomplex_t IT_0040 = IT_0012*IT_0022;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = IT_0014*(IT_0012 + -IT_0029);
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = conj(IT_0031) + conj(IT_0036);
    const ccomplex_t IT_0045 = s_12*s_13;
    const ccomplex_t IT_0046 = IT_0031 + IT_0036;
    const ccomplex_t IT_0047 = -s_23*IT_0007;
    const ccomplex_t IT_0048 = conj(IT_0025)*IT_0045;
    const ccomplex_t IT_0049 = conj(IT_0016) + conj(IT_0024);
    ...
    const ccomplex_t IT_0058 = pow(m_stau_1, 2);
    ...
    const ccomplex_t IT_0067 = conj(IT_0025)*(IT_0007 + IT_0025*IT_0058) +
       ...
       IT_0037)*IT_0059 + IT_0041*(s_23*conj(IT_0024) + s_13*conj(IT_0031) +
       IT_0060) + IT_0043*(s_23*conj(IT_0016) + s_13*conj(IT_0036) + IT_0060) +
       IT_0049*IT_0061 + IT_0038*IT_0062 + IT_0044*IT_0063 + IT_0046*IT_0064 +
       conj(IT_0041)*(s_23*IT_0024 + s_13*IT_0031 + IT_0041*IT_0058 + IT_0065 +
       IT_0066) + conj(IT_0043)*(s_23*IT_0016 + s_13*IT_0036 + IT_0043*IT_0058 +
       IT_0065 + IT_0066);
    const ccomplex_t IT_0068 = (-4)*IT_0008 + IT_0009*(conj(IT_0016)*IT_0024 +
       IT_0016*conj(IT_0024) + conj(IT_0025)*IT_0027 + IT_0025*conj(IT_0027)) +
       IT_0028*(conj(IT_0031)*IT_0036 + IT_0031*conj(IT_0036) + conj(IT_0027)
      *IT_0037 + IT_0027*conj(IT_0037)) + IT_0038*IT_0039 + (conj(IT_0016)
      *IT_0041 + IT_0016*conj(IT_0041) + conj(IT_0024)*IT_0043 + IT_0024*conj
      ...
      (IT_0031)*IT_0043 + IT_0031*conj(IT_0043) + IT_0037*IT_0049)*IT_0050 +
       IT_0051*IT_0052 + (conj(IT_0024)*IT_0031 + IT_0024*conj(IT_0031) + conj
      (IT_0016)*IT_0036 + IT_0016*conj(IT_0036) + IT_0027*IT_0051 + conj(IT_0027
