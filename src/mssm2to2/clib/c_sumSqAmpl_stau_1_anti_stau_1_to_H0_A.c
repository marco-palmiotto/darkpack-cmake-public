...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_1_to_H0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0013*(IT_0009 + 
      ...
      (U_stau_00) + -1./2*IT_0004*IT_0006*IT_0007*IT_0009*conj(U_stau_10)) +
       U_stau_10*(IT_0004*IT_0006*IT_0007*IT_0009*conj(U_stau_00) + 2*(m_W
