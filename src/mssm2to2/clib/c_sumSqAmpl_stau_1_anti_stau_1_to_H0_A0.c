        ...
        )
{
    ...
    const ccomplex_t IT_0054 = (-2)*U_stau_00*(((-0.5)*m_W*(IT_0001 + -IT_0000
      *IT_0016)*IT_0052 + IT_0001*IT_0002*IT_0023*IT_0033*IT_0053)*conj
      (U_stau_00) + -1./2*IT_0001*IT_0020*IT_0033*IT_0049*conj(U_stau_10)) +
       U_stau_10*(IT_0001*IT_0020*IT_0033*IT_0049*conj(U_stau_00) + 2*(m_W
    ...
    const ccomplex_t IT_0060 = cpow((-2)*s_13 + IT_0028 + IT_0047 + reg_prop +
    ...
    const ccomplex_t IT_0078 = cpow((-2)*s_23 + IT_0028 + IT_0047 + reg_prop +
       -m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2), -1);
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0015 + -IT_0000*IT_0096)*U_stau_00*conj(U_stau_00) + IT_0000*IT_0096
