...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_1_to_H0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = (-2)*U_stau_00*(((-0.5)*m_W*(IT_0001 + -IT_0000
      *IT_0016)*IT_0038 + IT_0001*IT_0002*IT_0023*IT_0035*IT_0039)*conj
      (U_stau_00) + -1./2*IT_0001*IT_0020*IT_0034*IT_0035*conj(U_stau_10)) +
       U_stau_10*(IT_0001*IT_0020*IT_0034*IT_0035*conj(U_stau_00) + 2*(m_W
    ...
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0015 + -IT_0000*IT_0060)*U_stau_00*conj(U_stau_00) + IT_0000*IT_0060
    ...
    const ccomplex_t IT_0085 = cpow((-2)*s_13 + IT_0028 + IT_0032 + reg_prop +
    ...
    const ccomplex_t IT_0103 = cpow((-2)*s_23 + IT_0028 + IT_0032 + reg_prop +
       -m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2), -1);
