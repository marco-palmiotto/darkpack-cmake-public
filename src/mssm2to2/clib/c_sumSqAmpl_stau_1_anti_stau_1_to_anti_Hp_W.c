        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0012*(IT_0005 + 
      ...
      (U_stau_00) + -1./2*IT_0003*IT_0005*IT_0008*IT_0009*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0005*IT_0008*IT_0009*conj(U_stau_00) + 2*(m_W
    ...
    const ccomplex_t IT_0029 = 2*U_stau_00*((IT_0003*IT_0005*IT_0007*IT_0009
      *IT_0015 + (-0.5)*m_W*(IT_0005 + -IT_0004*IT_0014)*IT_0028)*conj(U_stau_00
      ) + 1./2*IT_0000*IT_0005*IT_0008*IT_0009*conj(U_stau_10)) + U_stau_10*
      (IT_0000*IT_0005*IT_0008*IT_0009*conj(U_stau_00) + 2*(IT_0003*IT_0005
      *IT_0007*IT_0009*IT_0015 + -m_W*IT_0004*IT_0014*IT_0028)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0038 = e_em*mu_h*m_tau*IT_0007*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0039 = IT_0005*IT_0038;
    const ccomplex_t IT_0040 = e_em*mu_h*m_tau*IT_0007*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0041 = IT_0005*IT_0040;
    const ccomplex_t IT_0042 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0043 = IT_0001*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*(A_tau*IT_0001*U_stau_10 + (
