        ...
        )
{
    ...
    const ccomplex_t IT_0016 = m_b*s_14;
    const ccomplex_t IT_0017 = -IT_0004;
    const ccomplex_t IT_0018 = m_b*IT_0017;
    const ccomplex_t IT_0019 = m_b*IT_0005;
    ...
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_b*e_em*IT_0003*IT_0034
      *IT_0036*IT_0037;
    ...
    const ccomplex_t IT_0048 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0045*(IT_0003 + 
      ...
      (U_stau_00) + -1./2*IT_0003*IT_0036*IT_0040*IT_0041*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0036*IT_0040*IT_0041*conj(U_stau_00) + 2*(m_W
      *IT_0002*IT_0045*IT_0046 + -IT_0003*IT_0034*IT_0036*IT_0037*IT_0047)*conj
      (U_stau_10));
    const ccomplex_t IT_0049 = (0 + _Complex_I*-1)*(e_em*IT_0048 + (
      -1.4142135623731)*A_tau*IT_0037*(conj(U_stau_00)*U_stau_10 + U_stau_00
      *conj(U_stau_10)));
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*m_b*e_em*IT_0003*IT_0034
      *IT_0036*IT_0041;
    ...
    const ccomplex_t IT_0060 = 2*U_stau_00*((IT_0003*IT_0034*IT_0036*IT_0041
      *IT_0047 + (-0.5)*m_W*(IT_0003 + -IT_0002*IT_0046)*IT_0059)*conj(U_stau_00
      ) + 1./2*IT_0003*IT_0036*IT_0037*IT_0040*conj(U_stau_10)) + U_stau_10*
      (IT_0003*IT_0036*IT_0037*IT_0040*conj(U_stau_00) + 2*(IT_0003*IT_0034
      *IT_0036*IT_0041*IT_0047 + -m_W*IT_0002*IT_0046*IT_0059)*conj(U_stau_10));
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*(e_em*IT_0060 +
       1.4142135623731*A_tau*IT_0041*(conj(U_stau_00)*U_stau_10 + U_stau_00*conj
      (U_stau_10)));
    ...
    const ccomplex_t IT_0069 = m_b*IT_0068;
    ...
    const ccomplex_t IT_0077 = m_b*e_em*IT_0003*IT_0034*IT_0036*IT_0042;
    ...
    const ccomplex_t IT_0094 = m_b*e_em*IT_0003*IT_0034;
    ...
    const ccomplex_t IT_0132 = m_b*s_13;
