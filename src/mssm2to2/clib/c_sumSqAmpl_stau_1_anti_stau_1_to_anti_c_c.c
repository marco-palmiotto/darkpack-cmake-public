        ...
        )
{
    ...
    const ccomplex_t IT_0050 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0047*(IT_0003 + 
      -IT_0002*IT_0048) + IT_0003*IT_0035*IT_0041*IT_0044*IT_0049)*conj
      (U_stau_00) + -1./2*IT_0003*IT_0038*IT_0042*IT_0044*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0038*IT_0042*IT_0044*conj(U_stau_00) + 2*(m_W
    ...
    const ccomplex_t IT_0062 = 2*U_stau_00*((IT_0003*IT_0035*IT_0038*IT_0044
      *IT_0049 + (-0.5)*m_W*(IT_0003 + -IT_0002*IT_0048)*IT_0061)*conj(U_stau_00
      ) + 1./2*IT_0003*IT_0041*IT_0042*IT_0044*conj(U_stau_10)) + U_stau_10*
      (IT_0003*IT_0041*IT_0042*IT_0044*conj(U_stau_00) + 2*(IT_0003*IT_0035
      *IT_0038*IT_0044*IT_0049 + -m_W*IT_0002*IT_0048*IT_0061)*conj(U_stau_10));
    ...
    const ccomplex_t IT_0078 = e_em*mu_h*m_tau*IT_0035*conj(U_stau_00)
      *U_stau_10;
