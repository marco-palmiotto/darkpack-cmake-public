...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_1_to_anti_nu_tau_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = e_em*U_Wm2*conj(U_stau_00);
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = cos(beta);
    const ccomplex_t IT_0005 = cpow(IT_0004, -1);
    const ccomplex_t IT_0006 = IT_0001*IT_0005;
    const ccomplex_t IT_0007 = pow(m_W, -1);
    const ccomplex_t IT_0008 = U_d2*e_em*m_tau*IT_0007*conj(U_stau_10);
    ...
    const ccomplex_t IT_0012 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = conj(U_d2)*e_em*m_tau*IT_0007*U_stau_10;
    ...
    const ccomplex_t IT_0020 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_C_2*(m_C_2 +
    ...
    const ccomplex_t IT_0027 = IT_0001*IT_0023;
    const ccomplex_t IT_0028 = e_em*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*(IT_0026 + IT_0028);
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0023 + -IT_0000*IT_0024)*U_stau_00*conj(U_stau_00) + IT_0000*IT_0024
    ...
    const ccomplex_t IT_0037 = e_em*U_Wm1*conj(U_stau_00);
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = U_d1*e_em*m_tau*IT_0007*conj(U_stau_10);
    ...
    const ccomplex_t IT_0043 = e_em*conj(U_Wm1)*U_stau_00;
    const ccomplex_t IT_0044 = IT_0001*IT_0043;
    const ccomplex_t IT_0045 = conj(U_d1)*e_em*m_tau*IT_0007*U_stau_10;
    ...
    const ccomplex_t IT_0050 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0051 = IT_0049*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*IT_0051;
    const ccomplex_t IT_0053 = 0.5*IT_0022 + -IT_0036 + 0.5*IT_0052;
    const ccomplex_t IT_0054 = s_13*s_14;
    const ccomplex_t IT_0055 = s_34*IT_0019;
    return create_ccomplex_return(4*IT_0053*conj(IT_0053)*(IT_0054 + (-0.5)
      *IT_0055));
}
