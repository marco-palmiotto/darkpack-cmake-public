        ...
        )
{
    ...
    const ccomplex_t IT_0046 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0043*(IT_0003 + 
      -IT_0002*IT_0044) + IT_0003*IT_0032*IT_0034*IT_0035*IT_0045)*conj
      (U_stau_00) + -1./2*IT_0003*IT_0034*IT_0038*IT_0039*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0034*IT_0038*IT_0039*conj(U_stau_00) + 2*(m_W
      *IT_0002*IT_0043*IT_0044 + -IT_0003*IT_0032*IT_0034*IT_0035*IT_0045)*conj
      (U_stau_10));
    const ccomplex_t IT_0047 = (0 + _Complex_I*-1)*(e_em*IT_0046 + (
      -1.4142135623731)*A_tau*IT_0035*(conj(U_stau_00)*U_stau_10 + U_stau_00
      *conj(U_stau_10)));
    ...
    const ccomplex_t IT_0058 = 2*U_stau_00*((IT_0003*IT_0032*IT_0034*IT_0039
      *IT_0045 + (-0.5)*m_W*(IT_0003 + -IT_0002*IT_0044)*IT_0057)*conj(U_stau_00
      ) + 1./2*IT_0003*IT_0034*IT_0035*IT_0038*conj(U_stau_10)) + U_stau_10*
      (IT_0003*IT_0034*IT_0035*IT_0038*conj(U_stau_00) + 2*(IT_0003*IT_0032
      *IT_0034*IT_0039*IT_0045 + -m_W*IT_0002*IT_0044*IT_0057)*conj(U_stau_10));
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*(e_em*IT_0058 +
       1.4142135623731*A_tau*IT_0039*(conj(U_stau_00)*U_stau_10 + U_stau_00*conj
      (U_stau_10)));
    ...
    const ccomplex_t IT_0077 = e_em*mu_h*m_tau*IT_0032*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0078 = IT_0003*IT_0034*IT_0040;
    const ccomplex_t IT_0079 = IT_0077*IT_0078;
    const ccomplex_t IT_0080 = e_em*mu_h*m_tau*IT_0032*U_stau_00*conj
      (U_stau_10);
