        ...
        )
{
    ...
    const ccomplex_t IT_0017 = e_em*mu_h*m_tau*IT_0012*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0018 = IT_0015*IT_0017;
    const ccomplex_t IT_0019 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0020 = IT_0006*IT_0019;
    const ccomplex_t IT_0021 = 1.4142135623731*IT_0020;
    const ccomplex_t IT_0022 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0000
      *IT_0004 + -IT_0002*IT_0047)*U_stau_00*conj(U_stau_00) + IT_0002*IT_0047
    ...
    const ccomplex_t IT_0077 = 2*U_stau_00*((0.5*m_W*(IT_0001*IT_0002 + 
      -IT_0004)*IT_0075 + IT_0004*IT_0009*IT_0012*IT_0014*IT_0076)*conj
      (U_stau_00) + 1./2*IT_0004*IT_0008*IT_0014*IT_0072*conj(U_stau_10)) +
       U_stau_10*(IT_0004*IT_0008*IT_0014*IT_0072*conj(U_stau_00) + (-2)*(m_W
    ...
    const ccomplex_t IT_0086 = cpow((-2)*s_23 + IT_0028 + IT_0070 + reg_prop +
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_13 + IT_0028 + IT_0070 + reg_prop +
       -m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2), -1);
