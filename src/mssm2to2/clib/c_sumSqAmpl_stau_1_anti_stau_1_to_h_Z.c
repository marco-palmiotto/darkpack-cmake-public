...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_1_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0042 = 2*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0040 + IT_0003*IT_0012*IT_0035*IT_0037*IT_0041)*conj
      (U_stau_00) + 1./2*IT_0003*IT_0007*IT_0036*IT_0037*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0007*IT_0036*IT_0037*conj(U_stau_00) + (-2)*(m_W
    ...
    const ccomplex_t IT_0061 = e_em*mu_h*m_tau*IT_0035*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0062 = IT_0003*IT_0061;
    const ccomplex_t IT_0063 = e_em*mu_h*m_tau*IT_0035*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0064 = IT_0003*IT_0063;
    const ccomplex_t IT_0065 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0066 = IT_0009*IT_0065;
    ...
    const ccomplex_t IT_0078 = IT_0003*IT_0009*IT_0037;
    const ccomplex_t IT_0079 = IT_0061*IT_0078;
    const ccomplex_t IT_0080 = IT_0063*IT_0078;
    const ccomplex_t IT_0081 = IT_0011*IT_0065;
    const ccomplex_t IT_0082 = 1.4142135623731*IT_0081;
    const ccomplex_t IT_0083 = IT_0011*IT_0068;
    ...
    const ccomplex_t IT_0114 = IT_0049 + IT_0058 + -IT_0097 + IT_0104 + IT_0113;
    const ccomplex_t IT_0115 = s_14*s_24*IT_0031;
    const ccomplex_t IT_0116 = -IT_0115;
    const ccomplex_t IT_0117 = s_12 + IT_0116;
    const ccomplex_t IT_0118 = -IT_0030;
    const ccomplex_t IT_0119 = pow(s_34, 2);
    const ccomplex_t IT_0120 = IT_0031*IT_0119;
    const ccomplex_t IT_0121 = s_24*s_34*IT_0031;
    ...
    const ccomplex_t IT_0127 = (conj(IT_0030)*(IT_0025 + -IT_0033) + conj
      (IT_0091)*IT_0094 + conj(IT_0114)*IT_0117)*IT_0118 + -IT_0091*(conj
      (IT_0091)*(IT_0045 + -IT_0120) + conj(IT_0114)*IT_0123 + -IT_0094*IT_0124)
       + -IT_0114*(conj(IT_0091)*IT_0123 + -IT_0117*IT_0124 + conj(IT_0114)*
      (IT_0025 + -IT_0126));
