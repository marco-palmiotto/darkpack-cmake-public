        ...
        )
{
    ...
    const ccomplex_t IT_0037 = e_em*mu_h*m_tau*IT_0036*conj(U_stau_00)
      *U_stau_10;
    ...
    const ccomplex_t IT_0041 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0042 = IT_0009*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0060 = 2*conj(U_stau_00)*(((-0.5)*m_W*(IT_0003 + 
    ...
    const ccomplex_t IT_0068 = e_em*IT_0001*IT_0003*(IT_0007*IT_0009 + 
      -IT_0011*IT_0012);
    const ccomplex_t IT_0069 = -IT_0068;
    const ccomplex_t IT_0070 = IT_0003*IT_0009*IT_0055;
    const ccomplex_t IT_0071 = IT_0037*IT_0070;
    const ccomplex_t IT_0072 = IT_0039*IT_0070;
    const ccomplex_t IT_0073 = IT_0011*IT_0041;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = IT_0011*IT_0044;
    ...
    const ccomplex_t IT_0079 = cpow((-2)*s_12 + (-2)*IT_0025 + IT_0078 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0084 = 2*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0058 + IT_0003*IT_0012*IT_0036*IT_0055*IT_0059)*conj
      (U_stau_00) + 1./2*IT_0003*IT_0007*IT_0054*IT_0055*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0007*IT_0054*IT_0055*conj(U_stau_00) + (-2)*(m_W
    ...
    const ccomplex_t IT_0095 = 2*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0058 + IT_0003*IT_0012*IT_0036*IT_0055*IT_0059)*conj
      (U_stau_00) + 1./2*IT_0003*IT_0007*IT_0054*IT_0055*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0007*IT_0054*IT_0055*conj(U_stau_00) + (-2)*(m_W
      *IT_0002*IT_0017*IT_0058 + -IT_0003*IT_0012*IT_0036*IT_0055*IT_0059)*conj
    ...
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0063 + reg_prop + (0 +
       _Complex_I*1)*m_stau_1*Gamma_tau1, -1);
    ...
    const ccomplex_t IT_0102 = 2*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0058 + IT_0003*IT_0012*IT_0036*IT_0055*IT_0059)*conj
      (U_stau_00) + 1./2*IT_0003*IT_0007*IT_0054*IT_0055*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0007*IT_0054*IT_0055*conj(U_stau_00) + (-2)*(m_W
      *IT_0002*IT_0017*IT_0058 + -IT_0003*IT_0012*IT_0036*IT_0055*IT_0059)*conj
    ...
    const ccomplex_t IT_0108 = -IT_0083;
    const ccomplex_t IT_0109 = IT_0005 + IT_0108;
    const ccomplex_t IT_0110 = IT_0028*IT_0109;
    const ccomplex_t IT_0111 = 2*conj(U_stau_00)*(((-0.5)*m_W*(IT_0003 + 
      -IT_0002*IT_0017)*IT_0058 + IT_0003*IT_0012*IT_0036*IT_0055*IT_0059)
      *U_stau_01 + 1./2*IT_0003*IT_0007*IT_0054*IT_0055*U_stau_11) + conj
      (U_stau_10)*(IT_0003*IT_0007*IT_0054*IT_0055*U_stau_01 + (-2)*(m_W*IT_0002
      *IT_0017*IT_0058 + -IT_0003*IT_0012*IT_0036*IT_0055*IT_0059)*U_stau_11);
    ...
    const ccomplex_t IT_0117 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
    ...
    const ccomplex_t IT_0122 = cpow((-2)*s_13 + IT_0025 + IT_0063 + reg_prop +
       -m_stau_2*(m_stau_2 + (0 + _Complex_I*-1)*Gamma_tau2), -1);
    ...
    const ccomplex_t IT_0126 = IT_0101 + IT_0107 + -IT_0110 + IT_0116 + IT_0125;
    const ccomplex_t IT_0127 = s_14*s_24*IT_0031;
    const ccomplex_t IT_0128 = -IT_0127;
    const ccomplex_t IT_0129 = s_12 + IT_0128;
    const ccomplex_t IT_0130 = -IT_0030;
    const ccomplex_t IT_0131 = -conj(IT_0030);
    const ccomplex_t IT_0132 = pow(s_34, 2);
    const ccomplex_t IT_0133 = IT_0031*IT_0132;
    const ccomplex_t IT_0134 = s_24*s_34*IT_0031;
    ...
    const ccomplex_t IT_0140 = (conj(IT_0030)*(IT_0025 + -IT_0033) + conj
