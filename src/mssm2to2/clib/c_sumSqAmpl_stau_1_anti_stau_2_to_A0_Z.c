        ...
        )
{
    ...
    const ccomplex_t IT_0046 = e_em*mu_h*m_tau*IT_0009*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0047 = IT_0007*IT_0046;
    const ccomplex_t IT_0048 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0049 = IT_0003*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = A_tau*U_stau_01*conj(U_stau_11);
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_23 + IT_0055 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0064 = e_em*mu_h*m_tau*IT_0009*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0065 = IT_0007*IT_0064;
    const ccomplex_t IT_0066 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0067 = IT_0003*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = A_tau*U_stau_00*conj(U_stau_11);
    ...
    const ccomplex_t IT_0072 = (-0.5)*IT_0063 + 0.5*IT_0065 + (-0.5)*IT_0068 +
       0.5*IT_0071;
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0021 + IT_0055 + reg_prop +
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0006 +
       -IT_0000*IT_0007)*U_stau_01*conj(U_stau_01) + IT_0001*IT_0006*U_stau_11
      *conj(U_stau_11));
    const ccomplex_t IT_0082 = (-2)*IT_0081;
    const ccomplex_t IT_0083 = cpow((-2)*s_13 + IT_0020 + IT_0055 + reg_prop +
    ...
    const ccomplex_t IT_0087 = e_em*mu_h*m_tau*IT_0009*conj(U_stau_00)
      *U_stau_10;
    const ccomplex_t IT_0088 = IT_0007*IT_0087;
    const ccomplex_t IT_0089 = e_em*mu_h*m_tau*IT_0009*U_stau_00*conj
      (U_stau_10);
    const ccomplex_t IT_0090 = IT_0007*IT_0089;
    const ccomplex_t IT_0091 = A_tau*conj(U_stau_00)*U_stau_10;
    const ccomplex_t IT_0092 = IT_0003*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = A_tau*U_stau_00*conj(U_stau_10);
    ...
    const ccomplex_t IT_0097 = (-0.5)*IT_0088 + 0.5*IT_0090 + (-0.5)*IT_0093 +
       0.5*IT_0096;
    const ccomplex_t IT_0098 = cpow((-2)*s_13 + IT_0055 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0106 = -IT_0038;
    const ccomplex_t IT_0107 = -conj(IT_0038);
    const ccomplex_t IT_0108 = pow(s_34, 2);
    const ccomplex_t IT_0109 = IT_0039*IT_0108;
    const ccomplex_t IT_0110 = s_24*s_34*IT_0039;
    ...
    const ccomplex_t IT_0115 = -IT_0102;
    const ccomplex_t IT_0116 = (conj(IT_0038)*(IT_0020 + -IT_0041) + conj
      (IT_0077)*IT_0080 + conj(IT_0102)*IT_0105)*IT_0106 + IT_0102*IT_0105
      *IT_0107 + IT_0077*(IT_0080*IT_0107 + -conj(IT_0077)*(IT_0055 + -IT_0109) 
      + -conj(IT_0102)*IT_0112) + (conj(IT_0077)*IT_0112 + conj(IT_0102)*
      (IT_0021 + -IT_0114))*IT_0115;
