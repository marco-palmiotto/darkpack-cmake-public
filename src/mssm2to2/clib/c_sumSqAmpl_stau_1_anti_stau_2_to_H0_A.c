...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_2_to_H0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (-2)*U_stau_00*(((-0.5)*m_W*IT_0013*(IT_0009 + 
      -IT_0008*IT_0015) + IT_0002*IT_0003*IT_0006*IT_0009*IT_0016)*conj
      (U_stau_01) + -1./2*IT_0004*IT_0006*IT_0007*IT_0009*conj(U_stau_11)) +
       U_stau_10*(IT_0004*IT_0006*IT_0007*IT_0009*conj(U_stau_01) + 2*(m_W
    ...
    const ccomplex_t IT_0026 = cpow((-2)*s_13 + IT_0020 + IT_0025 + reg_prop +
    ...
    const ccomplex_t IT_0033 = -s_23;
    const ccomplex_t IT_0034 = IT_0000*IT_0029;
    const ccomplex_t IT_0035 = -IT_0034;
    const ccomplex_t IT_0036 = -s_24;
    const ccomplex_t IT_0037 = -s_34;
    const ccomplex_t IT_0038 = -IT_0030*(IT_0021*conj(IT_0030) + -conj(IT_0032
      )*IT_0033 + -conj(IT_0035)*IT_0036) + IT_0035*(conj(IT_0030)*IT_0036 +
       conj(IT_0032)*IT_0037) + -IT_0032*(IT_0020*conj(IT_0032) + -conj(IT_0030)
      *IT_0033 + -conj(IT_0035)*IT_0037);
