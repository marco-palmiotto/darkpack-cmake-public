...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_2_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = m_c*s_14;
    const ccomplex_t IT_0018 = -IT_0004;
    const ccomplex_t IT_0019 = m_c*IT_0018;
    const ccomplex_t IT_0020 = m_c*IT_0005;
    ...
    const ccomplex_t IT_0034 = m_c*e_em*IT_0003*IT_0033;
    ...
    const ccomplex_t IT_0056 = cpow((-2)*s_12 + -IT_0008 + -IT_0009 + m_A0*
    ...
    const ccomplex_t IT_0065 = m_c*e_em*IT_0003*IT_0033*IT_0037*IT_0064;
    ...
    const ccomplex_t IT_0072 = m_c*IT_0071;
    const ccomplex_t IT_0073 = s_34 + IT_0015;
    const ccomplex_t IT_0074 = -IT_0029;
    const ccomplex_t IT_0075 = (-6)*conj(IT_0074);
    const ccomplex_t IT_0076 = 12*s_34;
    const ccomplex_t IT_0077 = cpow((-2)*s_12 + -IT_0008 + -IT_0009 + m_H0*
      (m_H0 + (0 + _Complex_I*-1)*Gamma_H0) + -reg_prop, -1);
    const ccomplex_t IT_0078 = sin(alpha);
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_c*e_em*IT_0003*IT_0033
      *IT_0064*IT_0078;
    const ccomplex_t IT_0080 = (-0.5)*IT_0079;
    const ccomplex_t IT_0081 = cos(alpha);
    const ccomplex_t IT_0082 = mu_h*m_tau*IT_0033;
    const ccomplex_t IT_0083 = -IT_0039*IT_0078;
    const ccomplex_t IT_0084 = IT_0037*IT_0081;
    ...
    const ccomplex_t IT_0089 = (0 + _Complex_I*-1)*(e_em*IT_0088 + (
      -1.4142135623731)*A_tau*IT_0081*(conj(U_stau_01)*U_stau_10 + U_stau_00
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_c*e_em*IT_0003*IT_0033
      *IT_0064*IT_0081;
    const ccomplex_t IT_0096 = (-0.5)*IT_0095;
    const ccomplex_t IT_0097 = IT_0037*IT_0078;
    const ccomplex_t IT_0098 = IT_0039*IT_0081;
    const ccomplex_t IT_0099 = IT_0097 + IT_0098;
    const ccomplex_t IT_0100 = 2*U_stau_00*((IT_0003*IT_0033*IT_0038*IT_0078
      *IT_0087 + (-0.5)*m_W*(IT_0003 + -IT_0002*IT_0086)*IT_0099)*conj(U_stau_01
      ) + 1./2*IT_0003*IT_0038*IT_0081*IT_0082*conj(U_stau_11)) + U_stau_10*
      (IT_0003*IT_0038*IT_0081*IT_0082*conj(U_stau_01) + 2*(IT_0003*IT_0033
      *IT_0038*IT_0078*IT_0087 + -m_W*IT_0002*IT_0086*IT_0099)*conj(U_stau_11));
    const ccomplex_t IT_0101 = (0 + _Complex_I*1)*(e_em*IT_0100 +
       1.4142135623731*A_tau*IT_0078*(conj(U_stau_01)*U_stau_10 + U_stau_00*conj
      (U_stau_11)));
    ...
    const ccomplex_t IT_0110 = -IT_0015;
    const ccomplex_t IT_0111 = s_34 + IT_0110;
    const ccomplex_t IT_0112 = m_c*s_13;
    const ccomplex_t IT_0113 = s_34*IT_0008;
    ...
    const ccomplex_t IT_0118 = conj(IT_0106)*IT_0109;
    const ccomplex_t IT_0119 = (-6)*conj(IT_0031);
    const ccomplex_t IT_0120 = 0.166666666666667*IT_0017;
    const ccomplex_t IT_0121 = 6*s_34;
    const ccomplex_t IT_0122 = conj(IT_0106)*IT_0111;
    const ccomplex_t IT_0123 = (-6)*IT_0074;
    const ccomplex_t IT_0124 = conj(IT_0070)*IT_0073;
    const ccomplex_t IT_0125 = (conj(IT_0014)*IT_0016 + IT_0017*conj(IT_0029))
      *IT_0032 + 6*IT_0070*((conj(IT_0014) + -conj(IT_0031))*IT_0072 + IT_0073*
      (conj(IT_0029) + 0.166666666666667*IT_0075) + 0.166666666666667*conj
      (IT_0070)*(12*IT_0015 + IT_0076)) + 6*IT_0106*(0.166666666666667*((-12)
      *IT_0015 + IT_0076)*conj(IT_0106) + (conj(IT_0014) + conj(IT_0031))
      *IT_0109 + (conj(IT_0029) + conj(IT_0074))*IT_0111) + (-6)*IT_0031*(conj
      (IT_0070)*IT_0072 + -conj(IT_0074)*IT_0112 + (-0.166666666666667)*conj
      (IT_0031)*IT_0117 + -IT_0118) + 6*IT_0014*(conj(IT_0070)*IT_0072 + conj
      (IT_0029)*IT_0112 + 0.166666666666667*conj(IT_0014)*IT_0117 + IT_0118 +
       0.166666666666667*IT_0016*IT_0119 + IT_0075*IT_0120) + 6*IT_0074*(conj
      (IT_0031)*IT_0112 + 0.166666666666667*conj(IT_0074)*IT_0121 + IT_0122) +
       IT_0123*(conj(IT_0014)*IT_0017 + IT_0015*conj(IT_0029) + IT_0124) + 6
      *IT_0029*(0.166666666666667*IT_0015*IT_0075 + conj(IT_0014)*IT_0112 +
       IT_0119*IT_0120 + 0.166666666666667*conj(IT_0029)*IT_0121 + IT_0122 +
       IT_0124);
