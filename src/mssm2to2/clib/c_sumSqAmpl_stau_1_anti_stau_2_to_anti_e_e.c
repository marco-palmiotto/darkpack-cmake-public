...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_2_to_anti_e_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0028 = -IT_0003*IT_0011;
    const ccomplex_t IT_0029 = IT_0001*IT_0009;
    const ccomplex_t IT_0030 = IT_0028 + IT_0029;
    const ccomplex_t IT_0031 = (-2)*U_stau_00*((IT_0000*IT_0002*IT_0005
      *IT_0009*IT_0016 + (-0.5)*m_W*(IT_0005 + -IT_0004*IT_0015)*IT_0030)*conj
      (U_stau_01) + -1./2*IT_0002*IT_0003*IT_0005*IT_0008*conj(U_stau_11)) +
       U_stau_10*(IT_0002*IT_0003*IT_0005*IT_0008*conj(U_stau_01) + (-2)*
      (IT_0000*IT_0002*IT_0005*IT_0009*IT_0016 + -m_W*IT_0004*IT_0015*IT_0030)
      *conj(U_stau_11));
    const ccomplex_t IT_0032 = (0 + _Complex_I*-1)*(e_em*IT_0031 + (
      -1.4142135623731)*A_tau*IT_0009*(conj(U_stau_01)*U_stau_10 + U_stau_00
      *conj(U_stau_11)));
    const ccomplex_t IT_0033 = (-0.5)*IT_0032;
    const ccomplex_t IT_0034 = IT_0027*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_12 + -IT_0021 + -IT_0022 + m_H0*
    ...
    const ccomplex_t IT_0070 = m_e*s_13;
    const ccomplex_t IT_0071 = m_e*e_em*IT_0000*IT_0002*IT_0005*IT_0011;
    ...
    const ccomplex_t IT_0088 = m_e*e_em*IT_0000*IT_0005;
    const ccomplex_t IT_0089 = 0.5*IT_0088;
    const ccomplex_t IT_0090 = IT_0002*IT_0005*IT_0011;
    ...
    const ccomplex_t IT_0111 = m_e*s_14;
