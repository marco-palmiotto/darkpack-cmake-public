...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_2_to_anti_nu_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
       -IT_0000*IT_0005)*U_stau_00*conj(U_stau_01) + IT_0001*IT_0002*U_stau_10
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
      *Gamma_Z) + -IT_0013 + -IT_0014 + -reg_prop, -1);
    ...
    const ccomplex_t IT_0020 = s_34*IT_0013;
    return create_ccomplex_return(4*IT_0018*conj(IT_0018)*(IT_0019 + (-0.5)
      *IT_0020));
}
