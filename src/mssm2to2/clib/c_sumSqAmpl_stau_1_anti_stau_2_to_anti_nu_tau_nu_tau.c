...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_2_to_anti_nu_tau_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = e_em*U_Wm2*conj(U_stau_01);
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = U_d2*e_em*m_tau*IT_0007*conj(U_stau_11);
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0023 + -IT_0000*IT_0024)*U_stau_00*conj(U_stau_01) + IT_0000*IT_0024
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_12 + m_Z*(m_Z + (0 + _Complex_I*-1)
      *Gamma_Z) + -IT_0019 + -IT_0034 + -reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0033*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = e_em*conj(U_Wm1)*U_stau_00;
    const ccomplex_t IT_0039 = IT_0001*IT_0038;
    const ccomplex_t IT_0040 = conj(U_d1)*e_em*m_tau*IT_0007*U_stau_10;
    const ccomplex_t IT_0041 = IT_0006*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*(IT_0039 + (-0.5)*IT_0042);
    const ccomplex_t IT_0044 = e_em*U_Wm1*conj(U_stau_01);
    const ccomplex_t IT_0045 = IT_0001*IT_0044;
    const ccomplex_t IT_0046 = U_d1*e_em*m_tau*IT_0007*conj(U_stau_11);
    ...
    const ccomplex_t IT_0051 = cpow(s_23 + (-0.5)*IT_0019 + 0.5*m_C_1*(m_C_1 +
       (0 + _Complex_I*-1)*Gamma_c1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = 0.5*IT_0022 + -IT_0037 + 0.5*IT_0053;
    const ccomplex_t IT_0055 = s_13*s_14;
    const ccomplex_t IT_0056 = s_34*IT_0034;
    return create_ccomplex_return(4*IT_0054*conj(IT_0054)*(IT_0055 + (-0.5)
      *IT_0056));
}
