        ...
        )
{
    ...
    const ccomplex_t IT_0017 = m_s*s_14;
    const ccomplex_t IT_0018 = -IT_0004;
    const ccomplex_t IT_0019 = m_s*IT_0018;
    const ccomplex_t IT_0020 = m_s*IT_0005;
    ...
    const ccomplex_t IT_0037 = m_s*e_em*IT_0003*IT_0033*IT_0035*IT_0036;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = e_em*mu_h*m_tau*IT_0033*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0040 = IT_0003*IT_0039;
    const ccomplex_t IT_0041 = e_em*mu_h*m_tau*IT_0033*U_stau_00*conj
      (U_stau_11);
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_12 + -IT_0008 + -IT_0009 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = m_s*e_em*IT_0003*IT_0033;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = IT_0003*IT_0035*IT_0036;
    const ccomplex_t IT_0057 = IT_0039*IT_0056;
    const ccomplex_t IT_0058 = IT_0041*IT_0056;
    const ccomplex_t IT_0059 = IT_0034*IT_0043;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = IT_0034*IT_0046;
    ...
    const ccomplex_t IT_0066 = cpow((-2)*s_12 + -IT_0008 + -IT_0009 + IT_0065 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_s*e_em*IT_0003*IT_0033
      *IT_0035*IT_0078;
    const ccomplex_t IT_0080 = 0.5*IT_0079;
    const ccomplex_t IT_0081 = mu_h*m_tau*IT_0033;
    const ccomplex_t IT_0082 = cos(alpha);
    const ccomplex_t IT_0083 = IT_0034*IT_0078;
    const ccomplex_t IT_0084 = IT_0036*IT_0082;
    ...
    const ccomplex_t IT_0088 = 2*U_stau_00*(((-0.5)*m_W*IT_0085*(IT_0003 + 
      -IT_0002*IT_0086) + IT_0003*IT_0033*IT_0035*IT_0078*IT_0087)*conj
      (U_stau_01) + 1./2*IT_0003*IT_0035*IT_0081*IT_0082*conj(U_stau_11)) +
       U_stau_10*(IT_0003*IT_0035*IT_0081*IT_0082*conj(U_stau_01) + (-2)*(m_W
      *IT_0002*IT_0085*IT_0086 + -IT_0003*IT_0033*IT_0035*IT_0078*IT_0087)*conj
      (U_stau_11));
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*m_s*e_em*IT_0003*IT_0033
      *IT_0035*IT_0082;
    const ccomplex_t IT_0096 = (-0.5)*IT_0095;
    const ccomplex_t IT_0097 = -IT_0036*IT_0078;
    const ccomplex_t IT_0098 = IT_0034*IT_0082;
    const ccomplex_t IT_0099 = IT_0097 + IT_0098;
    const ccomplex_t IT_0100 = (-2)*U_stau_00*((IT_0003*IT_0033*IT_0035
      *IT_0082*IT_0087 + (-0.5)*m_W*(IT_0003 + -IT_0002*IT_0086)*IT_0099)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0035*IT_0078*IT_0081*conj(U_stau_11)) +
       U_stau_10*(IT_0003*IT_0035*IT_0078*IT_0081*conj(U_stau_01) + (-2)*
      (IT_0003*IT_0033*IT_0035*IT_0082*IT_0087 + -m_W*IT_0002*IT_0086*IT_0099)
      *conj(U_stau_11));
    const ccomplex_t IT_0101 = (0 + _Complex_I*-1)*(e_em*IT_0100 + (
      -1.4142135623731)*A_tau*IT_0082*(conj(U_stau_01)*U_stau_10 + U_stau_00
      *conj(U_stau_11)));
    const ccomplex_t IT_0102 = (-0.5)*IT_0101;
    const ccomplex_t IT_0103 = IT_0096*IT_0102;
    const ccomplex_t IT_0104 = cpow((-2)*s_12 + -IT_0008 + -IT_0009 + m_H0*
