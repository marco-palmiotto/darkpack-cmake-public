...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_2_to_anti_t_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = m_t*s_14;
    const ccomplex_t IT_0018 = -IT_0004;
    const ccomplex_t IT_0019 = m_t*IT_0018;
    const ccomplex_t IT_0020 = m_t*IT_0005;
    ...
    const ccomplex_t IT_0050 = m_t*e_em*IT_0003*IT_0035*IT_0048*IT_0049;
    ...
    const ccomplex_t IT_0055 = m_t*e_em*IT_0003*IT_0035;
    ...
    const ccomplex_t IT_0073 = m_t*IT_0072;
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0035
      *IT_0049*IT_0080;
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*m_t*e_em*IT_0003*IT_0035
      *IT_0049*IT_0083;
    ...
    const ccomplex_t IT_0116 = m_t*s_13;
