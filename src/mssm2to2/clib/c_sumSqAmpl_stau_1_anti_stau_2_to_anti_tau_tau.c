        ...
        )
{
    ...
    const ccomplex_t IT_0157 = -IT_0051 + 0.5*IT_0078 + 0.5*IT_0104 + 0.5
      *IT_0130 + 0.5*IT_0156;
    const ccomplex_t IT_0158 = conj(N_B1)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0159 = IT_0039*IT_0158;
    const ccomplex_t IT_0160 = 1.4142135623731*IT_0159;
    const ccomplex_t IT_0161 = conj(N_d1)*e_em*m_tau*IT_0000*conj(U_stau_01);
    ...
    const ccomplex_t IT_0169 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0175 = IT_0052*IT_0174;
    ...
    const ccomplex_t IT_0181 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0182 = IT_0039*IT_0181;
    const ccomplex_t IT_0183 = 1.4142135623731*IT_0182;
    const ccomplex_t IT_0184 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0189 = conj(N_B3)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0190 = IT_0039*IT_0189;
    const ccomplex_t IT_0191 = 1.4142135623731*IT_0190;
    const ccomplex_t IT_0192 = conj(N_d3)*e_em*m_tau*IT_0000*conj(U_stau_01);
    ...
    const ccomplex_t IT_0200 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0201 = IT_0039*IT_0200;
    const ccomplex_t IT_0202 = 1.4142135623731*IT_0201;
    const ccomplex_t IT_0203 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0208 = conj(N_B4)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0209 = IT_0039*IT_0208;
    const ccomplex_t IT_0210 = 1.4142135623731*IT_0209;
    const ccomplex_t IT_0211 = conj(N_d4)*e_em*m_tau*IT_0000*conj(U_stau_01);
    ...
    const ccomplex_t IT_0217 = IT_0154*IT_0216;
    const ccomplex_t IT_0218 = (0 + _Complex_I*1)*IT_0217;
    const ccomplex_t IT_0219 = conj(N_B2)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0220 = IT_0039*IT_0219;
    const ccomplex_t IT_0221 = 1.4142135623731*IT_0220;
    const ccomplex_t IT_0222 = conj(N_d2)*e_em*m_tau*IT_0000*conj(U_stau_01);
    ...
    const ccomplex_t IT_0230 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0236 = IT_0079*IT_0235;
    ...
    const ccomplex_t IT_0242 = IT_0116*IT_0188;
    const ccomplex_t IT_0243 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0244 = IT_0105*IT_0242*IT_0243;
    const ccomplex_t IT_0245 = IT_0152*IT_0207;
    const ccomplex_t IT_0246 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0247 = IT_0154*IT_0245*IT_0246;
    const ccomplex_t IT_0248 = -IT_0040;
    const ccomplex_t IT_0249 = m_tau*IT_0248;
    const ccomplex_t IT_0250 = m_tau*IT_0041;
    const ccomplex_t IT_0251 = -IT_0250;
    const ccomplex_t IT_0252 = IT_0249 + IT_0251;
    const ccomplex_t IT_0253 = IT_0050*IT_0252;
    const ccomplex_t IT_0254 = IT_0179*IT_0252;
    const ccomplex_t IT_0255 = m_tau*IT_0130;
    const ccomplex_t IT_0256 = m_tau*IT_0156;
    const ccomplex_t IT_0257 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0258 = IT_0064*IT_0173;
    const ccomplex_t IT_0259 = IT_0052*IT_0257*IT_0258;
    const ccomplex_t IT_0260 = m_tau*IT_0078;
    const ccomplex_t IT_0261 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0262 = IT_0090*IT_0234;
    const ccomplex_t IT_0263 = IT_0079*IT_0261*IT_0262;
    const ccomplex_t IT_0264 = m_tau*IT_0104;
    const ccomplex_t IT_0265 = 0.5*IT_0244 + 0.5*IT_0247 + -IT_0253 + IT_0254 
      + (-0.5)*IT_0255 + (-0.5)*IT_0256 + 0.5*IT_0259 + (-0.5)*IT_0260 + 0.5
      *IT_0263 + (-0.5)*IT_0264;
    const ccomplex_t IT_0266 = IT_0127*IT_0196;
    const ccomplex_t IT_0267 = IT_0105*IT_0243*IT_0266;
    const ccomplex_t IT_0268 = IT_0141*IT_0215;
    const ccomplex_t IT_0269 = IT_0154*IT_0246*IT_0268;
    const ccomplex_t IT_0270 = IT_0075*IT_0165;
    const ccomplex_t IT_0271 = IT_0052*IT_0257*IT_0270;
    const ccomplex_t IT_0272 = m_tau*IT_0176;
    const ccomplex_t IT_0273 = m_tau*IT_0237;
    const ccomplex_t IT_0274 = IT_0101*IT_0226;
    const ccomplex_t IT_0275 = IT_0079*IT_0261*IT_0274;
    const ccomplex_t IT_0276 = m_tau*IT_0199;
    const ccomplex_t IT_0277 = m_tau*IT_0218;
    const ccomplex_t IT_0278 = IT_0253 + -IT_0254 + 0.5*IT_0267 + 0.5*IT_0269 
      + 0.5*IT_0271 + (-0.5)*IT_0272 + (-0.5)*IT_0273 + 0.5*IT_0275 + (-0.5)
      *IT_0276 + (-0.5)*IT_0277;
    const ccomplex_t IT_0279 = -IT_0016;
    const ccomplex_t IT_0280 = s_34 + IT_0279;
    const ccomplex_t IT_0281 = s_13*m_tau;
    const ccomplex_t IT_0282 = e_em*m_tau*IT_0000*IT_0005;
    const ccomplex_t IT_0283 = 0.5*IT_0282;
    const ccomplex_t IT_0284 = e_em*mu_h*m_tau*IT_0000*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0285 = IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0286 = IT_0284*IT_0285;
    const ccomplex_t IT_0287 = e_em*mu_h*m_tau*IT_0000*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0288 = IT_0285*IT_0287;
    const ccomplex_t IT_0289 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0290 = IT_0001*IT_0289;
    const ccomplex_t IT_0291 = 1.4142135623731*IT_0290;
    const ccomplex_t IT_0292 = A_tau*U_stau_00*conj(U_stau_11);
    const ccomplex_t IT_0293 = IT_0001*IT_0292;
    const ccomplex_t IT_0294 = 1.4142135623731*IT_0293;
    const ccomplex_t IT_0295 = (-0.5)*IT_0286 + 0.5*IT_0288 + 0.5*IT_0291 + (
      -0.5)*IT_0294;
    const ccomplex_t IT_0296 = IT_0283*IT_0295;
    const ccomplex_t IT_0297 = pow(m_Z, 2);
    const ccomplex_t IT_0298 = cpow((-2)*s_12 + -IT_0021 + -IT_0022 + IT_0297 
      + -reg_prop, -1);
    const ccomplex_t IT_0299 = IT_0296*IT_0298;
    const ccomplex_t IT_0300 = (0 + _Complex_I*1)*IT_0299;
    const ccomplex_t IT_0301 = e_em*m_tau*IT_0000*IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0302 = (-0.5)*IT_0301;
    const ccomplex_t IT_0303 = IT_0005*IT_0284;
    const ccomplex_t IT_0304 = IT_0005*IT_0287;
    const ccomplex_t IT_0305 = IT_0010*IT_0289;
    const ccomplex_t IT_0306 = 1.4142135623731*IT_0305;
    const ccomplex_t IT_0307 = IT_0010*IT_0292;
    const ccomplex_t IT_0308 = 1.4142135623731*IT_0307;
    const ccomplex_t IT_0309 = (-0.5)*IT_0303 + 0.5*IT_0304 + (-0.5)*IT_0306 +
       0.5*IT_0308;
    const ccomplex_t IT_0310 = IT_0302*IT_0309;
    const ccomplex_t IT_0311 = cpow((-2)*s_12 + -IT_0021 + -IT_0022 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0312 = IT_0310*IT_0311;
    const ccomplex_t IT_0313 = (0 + _Complex_I*1)*IT_0312;
    const ccomplex_t IT_0314 = -IT_0300 + -IT_0313;
    ...
    const ccomplex_t IT_0327 = 2*s_34;
    const ccomplex_t IT_0328 = conj(IT_0038)*IT_0280;
    const ccomplex_t IT_0329 = (-2)*IT_0265;
    const ccomplex_t IT_0330 = conj(IT_0314)*IT_0326;
    const ccomplex_t IT_0331 = 2*IT_0038*((conj(IT_0157) + conj(IT_0238))
      *IT_0241 + 2*(conj(IT_0038) + 0.5*conj(IT_0265) + 0.5*conj(IT_0278))
      ...
      *IT_0281 + -conj(IT_0314)*IT_0316 + 2*conj(IT_0157)*IT_0320 + -conj
      (IT_0278)*IT_0321 + IT_0323*IT_0325) + (-2)*IT_0314*(IT_0316*(conj(IT_0157
       ...
       2*IT_0265*(conj(IT_0157)*IT_0281 + 0.5*conj(IT_0265)*IT_0327 + IT_0328) +
       IT_0329*(IT_0016*conj(IT_0278) + conj(IT_0238)*IT_0321 + IT_0330) + 2
      *IT_0278*(conj(IT_0238)*IT_0281 + 0.5*IT_0016*IT_0322 + IT_0321*IT_0324 +
       0.5*conj(IT_0278)*IT_0327 + IT_0328 + IT_0330);
