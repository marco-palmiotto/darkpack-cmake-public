...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_stau_2_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = e_em*IT_0001*IT_0003*(IT_0007*IT_0011 + IT_0009
      *IT_0012);
    const ccomplex_t IT_0036 = -IT_0035;
    const ccomplex_t IT_0037 = pow(m_W, -1);
    const ccomplex_t IT_0038 = e_em*mu_h*m_tau*IT_0037*conj(U_stau_01)
      *U_stau_10;
    const ccomplex_t IT_0039 = IT_0003*IT_0038;
    const ccomplex_t IT_0040 = e_em*mu_h*m_tau*IT_0037*U_stau_00*conj
      (U_stau_11);
    const ccomplex_t IT_0041 = IT_0003*IT_0040;
    const ccomplex_t IT_0042 = A_tau*conj(U_stau_01)*U_stau_10;
    const ccomplex_t IT_0043 = IT_0009*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = A_tau*U_stau_00*conj(U_stau_11);
    ...
    const ccomplex_t IT_0048 = (-0.5)*IT_0039 + 0.5*IT_0041 + (-0.5)*IT_0044 +
       0.5*IT_0047;
    const ccomplex_t IT_0049 = cpow((-2)*s_12 + -IT_0025 + -IT_0026 + m_A0*
      (m_A0 + (0 + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0048*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = IT_0036*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
       -IT_0000*IT_0003)*U_stau_00*conj(U_stau_00) + IT_0001*IT_0002*U_stau_10
      *conj(U_stau_10));
    const ccomplex_t IT_0054 = (-2)*IT_0053;
    const ccomplex_t IT_0055 = mu_h*m_tau*IT_0037;
    const ccomplex_t IT_0056 = cpow(IT_0011, -1);
    const ccomplex_t IT_0057 = IT_0011*IT_0012;
    const ccomplex_t IT_0058 = IT_0007*IT_0009;
    const ccomplex_t IT_0059 = IT_0057 + IT_0058;
    const ccomplex_t IT_0060 = pow(m_tau, 2);
    const ccomplex_t IT_0061 = 2*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_01) + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_11)) +
       U_stau_10*(IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_01) + (-2)*(m_W
      *IT_0002*IT_0017*IT_0059 + -IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_11));
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0026 + IT_0064 + reg_prop +
    ...
    const ccomplex_t IT_0069 = e_em*IT_0001*IT_0003*(IT_0007*IT_0009 + 
      -IT_0011*IT_0012);
    const ccomplex_t IT_0070 = -IT_0069;
    const ccomplex_t IT_0071 = IT_0003*IT_0009*IT_0056;
    const ccomplex_t IT_0072 = IT_0038*IT_0071;
    const ccomplex_t IT_0073 = IT_0040*IT_0071;
    const ccomplex_t IT_0074 = IT_0011*IT_0042;
    const ccomplex_t IT_0075 = 1.4142135623731*IT_0074;
    const ccomplex_t IT_0076 = IT_0011*IT_0045;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = (-0.5)*IT_0072 + 0.5*IT_0073 + 0.5*IT_0075 + (
      -0.5)*IT_0077;
    const ccomplex_t IT_0079 = pow(m_Z, 2);
    const ccomplex_t IT_0080 = cpow((-2)*s_12 + -IT_0025 + -IT_0026 + IT_0079 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0084 = (-2)*IT_0004;
    const ccomplex_t IT_0085 = 2*U_stau_01*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_01) + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_11)) +
       U_stau_11*(IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_01) + (-2)*(m_W
      *IT_0002*IT_0017*IT_0059 + -IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_11));
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_23 + IT_0064 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0105 = 2*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_00) + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_10)) +
       U_stau_10*(IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_00) + (-2)*(m_W
      *IT_0002*IT_0017*IT_0059 + -IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_10));
    const ccomplex_t IT_0106 = (0 + _Complex_I*1)*(e_em*IT_0105 +
       1.4142135623731*A_tau*IT_0012*(conj(U_stau_00)*U_stau_10 + U_stau_00*conj
      (U_stau_10)));
    const ccomplex_t IT_0107 = 0.5*IT_0106;
    const ccomplex_t IT_0108 = cpow((-2)*s_13 + IT_0064 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0002 +
       -IT_0000*IT_0003)*U_stau_01*conj(U_stau_01) + IT_0001*IT_0002*U_stau_11
      *conj(U_stau_11));
    const ccomplex_t IT_0113 = (-2)*IT_0112;
    const ccomplex_t IT_0114 = 2*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_01) + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_11)) +
       U_stau_10*(IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_01) + (-2)*(m_W
      *IT_0002*IT_0017*IT_0059 + -IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
    ...
    const ccomplex_t IT_0117 = cpow((-2)*s_13 + IT_0025 + IT_0064 + reg_prop +
    ...
    const ccomplex_t IT_0121 = 2*U_stau_01*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0017)*IT_0059 + IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
      (U_stau_01) + 1./2*IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_11)) +
       U_stau_11*(IT_0003*IT_0007*IT_0055*IT_0056*conj(U_stau_01) + (-2)*(m_W
      *IT_0002*IT_0017*IT_0059 + -IT_0003*IT_0012*IT_0037*IT_0056*IT_0060)*conj
    ...
    const ccomplex_t IT_0124 = IT_0088*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*IT_0124;
    const ccomplex_t IT_0126 = IT_0084*IT_0125;
    const ccomplex_t IT_0127 = -IT_0098 + IT_0104 + IT_0111 + IT_0120 + IT_0126;
    const ccomplex_t IT_0128 = s_14*s_24*IT_0032;
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = s_12 + IT_0129;
    const ccomplex_t IT_0131 = -IT_0031;
    const ccomplex_t IT_0132 = -conj(IT_0031);
    const ccomplex_t IT_0133 = pow(s_34, 2);
    const ccomplex_t IT_0134 = IT_0032*IT_0133;
    const ccomplex_t IT_0135 = s_24*s_34*IT_0032;
    ...
    const ccomplex_t IT_0140 = -IT_0127;
    const ccomplex_t IT_0141 = (conj(IT_0031)*(IT_0025 + -IT_0034) + conj
      (IT_0092)*IT_0095 + conj(IT_0127)*IT_0130)*IT_0131 + IT_0127*IT_0130
      *IT_0132 + IT_0092*(IT_0095*IT_0132 + -conj(IT_0092)*(IT_0064 + -IT_0134) 
      + -conj(IT_0127)*IT_0137) + (conj(IT_0092)*IT_0137 + conj(IT_0127)*
      (IT_0026 + -IT_0139))*IT_0140;
