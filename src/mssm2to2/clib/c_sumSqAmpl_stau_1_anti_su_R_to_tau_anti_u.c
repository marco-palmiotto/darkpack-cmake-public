...
ccomplex_return_t c_sumSqAmpl_stau_1_anti_su_R_to_tau_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = conj(N_d4)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0031 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0032 = IT_0008*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0035 = IT_0004*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0080 = 0.5*IT_0028 + 0.5*IT_0045 + 0.5*IT_0062 + 0.5
      *IT_0079;
    const ccomplex_t IT_0081 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0082 = IT_0008*IT_0081;
    const ccomplex_t IT_0083 = 1.4142135623731*IT_0082;
    const ccomplex_t IT_0084 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0091 = IT_0063*IT_0089*IT_0090;
    const ccomplex_t IT_0092 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0093 = IT_0008*IT_0092;
    const ccomplex_t IT_0094 = 1.4142135623731*IT_0093;
    const ccomplex_t IT_0095 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0106 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0117 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0124 = IT_0026*IT_0122*IT_0123;
    const ccomplex_t IT_0125 = m_tau*IT_0079;
    const ccomplex_t IT_0126 = m_tau*IT_0045;
    const ccomplex_t IT_0127 = m_tau*IT_0062;
    const ccomplex_t IT_0128 = m_tau*IT_0028;
    const ccomplex_t IT_0129 = 0.5*IT_0091 + 0.5*IT_0102 + 0.5*IT_0113 + 0.5
      *IT_0124 + (-0.5)*IT_0125 + (-0.5)*IT_0126 + (-0.5)*IT_0127 + (-0.5)
      *IT_0128;
    const ccomplex_t IT_0130 = s_14*m_tau;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0008;
    const ccomplex_t IT_0132 = 0.666666666666667*IT_0131;
    const ccomplex_t IT_0133 = IT_0022*IT_0132;
    const ccomplex_t IT_0134 = IT_0026*IT_0123*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0008;
    const ccomplex_t IT_0136 = 0.666666666666667*IT_0135;
    const ccomplex_t IT_0137 = IT_0076*IT_0136;
    const ccomplex_t IT_0138 = IT_0063*IT_0090*IT_0137;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0008;
    const ccomplex_t IT_0140 = 0.666666666666667*IT_0139;
    const ccomplex_t IT_0141 = IT_0041*IT_0140;
    const ccomplex_t IT_0142 = IT_0043*IT_0101*IT_0141;
    const ccomplex_t IT_0143 = IT_0088*IT_0136;
    ...
    const ccomplex_t IT_0147 = IT_0099*IT_0140;
    ...
    const ccomplex_t IT_0151 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0008;
    ...
    const ccomplex_t IT_0157 = IT_0121*IT_0132;
    ...
    const ccomplex_t IT_0161 = IT_0058*IT_0152;
    const ccomplex_t IT_0162 = IT_0060*IT_0112*IT_0161;
    const ccomplex_t IT_0163 = 0.5*IT_0134 + 0.5*IT_0138 + 0.5*IT_0142 + (-0.5
      )*IT_0146 + (-0.5)*IT_0150 + (-0.5)*IT_0156 + (-0.5)*IT_0160 + 0.5*IT_0162;
    const ccomplex_t IT_0164 = m_u*s_13;
    const ccomplex_t IT_0165 = 0.5*IT_0145 + 0.5*IT_0149 + 0.5*IT_0155 + 0.5
      *IT_0159;
    ...
    const ccomplex_t IT_0172 = m_u*m_tau;
    const ccomplex_t IT_0173 = 6*s_34;
    const ccomplex_t IT_0174 = -conj(IT_0080);
    const ccomplex_t IT_0175 = (-6)*conj(IT_0129);
    const ccomplex_t IT_0176 = 6*IT_0080*(conj(IT_0129)*IT_0130 + -conj
      (IT_0163)*IT_0164 + -conj(IT_0165)*IT_0166 + 0.166666666666667*conj
      (IT_0080)*IT_0171) + (-6)*IT_0129*(IT_0164*conj(IT_0165) + conj(IT_0163)
      *IT_0172 + (-0.166666666666667)*conj(IT_0129)*IT_0173 + IT_0130*IT_0174) +
       6*IT_0165*(IT_0130*conj(IT_0163) + 0.166666666666667*conj(IT_0165)
      *IT_0171 + IT_0166*IT_0174 + 0.166666666666667*IT_0164*IT_0175) + 6
      *IT_0163*(IT_0130*conj(IT_0165) + 0.166666666666667*conj(IT_0163)*IT_0173 
