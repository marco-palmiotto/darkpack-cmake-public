        ...
        )
{
    ...
    const ccomplex_t IT_0140 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0141 = IT_0004*IT_0140;
    const ccomplex_t IT_0142 = 1.4142135623731*IT_0141;
    const ccomplex_t IT_0143 = m_b*N_d4*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0149 = IT_0082*IT_0148;
    ...
    const ccomplex_t IT_0157 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0162 = N_B3*e_em*U_sb_10;
    const ccomplex_t IT_0163 = IT_0004*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = m_b*N_d3*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0184 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0185 = IT_0004*IT_0184;
    const ccomplex_t IT_0186 = 1.4142135623731*IT_0185;
    const ccomplex_t IT_0187 = m_b*N_d2*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0193 = IT_0034*IT_0192;
    ...
    const ccomplex_t IT_0204 = IT_0030*IT_0117;
    const ccomplex_t IT_0205 = IT_0002*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0207 = IT_0102*IT_0139;
    const ccomplex_t IT_0208 = IT_0082*IT_0206*IT_0207;
    const ccomplex_t IT_0209 = 0.5*IT_0205 + 0.5*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0211 = IT_0078*IT_0161;
    const ccomplex_t IT_0212 = IT_0058*IT_0210*IT_0211;
    const ccomplex_t IT_0213 = m_tau*IT_0033;
    const ccomplex_t IT_0214 = m_tau*IT_0057;
    const ccomplex_t IT_0215 = m_tau*IT_0081;
    const ccomplex_t IT_0216 = m_tau*IT_0105;
    const ccomplex_t IT_0217 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0218 = IT_0054*IT_0183;
    const ccomplex_t IT_0219 = IT_0034*IT_0217*IT_0218;
    const ccomplex_t IT_0220 = (-0.5)*IT_0212 + 0.5*IT_0213 + 0.5*IT_0214 +
       0.5*IT_0215 + 0.5*IT_0216 + (-0.5)*IT_0219;
    const ccomplex_t IT_0221 = -conj(IT_0220);
    const ccomplex_t IT_0222 = conj(IT_0209) + IT_0221;
    const ccomplex_t IT_0223 = IT_0090*IT_0147;
    const ccomplex_t IT_0224 = IT_0082*IT_0206*IT_0223;
    const ccomplex_t IT_0225 = m_tau*IT_0128;
    const ccomplex_t IT_0226 = m_tau*IT_0194;
    const ccomplex_t IT_0227 = m_tau*IT_0150;
    const ccomplex_t IT_0228 = IT_0018*IT_0125;
    const ccomplex_t IT_0229 = IT_0002*IT_0203*IT_0228;
    const ccomplex_t IT_0230 = IT_0066*IT_0169;
    const ccomplex_t IT_0231 = IT_0058*IT_0210*IT_0230;
    const ccomplex_t IT_0232 = m_tau*IT_0172;
    const ccomplex_t IT_0233 = (-0.5)*IT_0224 + 0.5*IT_0225 + 0.5*IT_0226 +
       0.5*IT_0227 + (-0.5)*IT_0229 + (-0.5)*IT_0231 + 0.5*IT_0232;
    const ccomplex_t IT_0234 = 6*IT_0233;
    const ccomplex_t IT_0235 = IT_0042*IT_0191;
    const ccomplex_t IT_0236 = IT_0034*IT_0217*IT_0235;
    const ccomplex_t IT_0237 = 0.5*IT_0236;
    const ccomplex_t IT_0238 = (-6)*IT_0237;
    const ccomplex_t IT_0239 = IT_0234 + IT_0238;
    const ccomplex_t IT_0240 = 6*conj(IT_0233);
    const ccomplex_t IT_0241 = (-6)*conj(IT_0237);
    const ccomplex_t IT_0242 = IT_0240 + IT_0241;
    const ccomplex_t IT_0243 = m_b*m_tau;
    const ccomplex_t IT_0244 = 6*IT_0237;
    const ccomplex_t IT_0245 = (-6)*IT_0233;
    const ccomplex_t IT_0246 = IT_0244 + IT_0245;
    const ccomplex_t IT_0247 = 6*conj(IT_0237);
    const ccomplex_t IT_0248 = (-6)*conj(IT_0233);
    const ccomplex_t IT_0249 = IT_0247 + IT_0248;
    const ccomplex_t IT_0250 = s_14*m_tau;
    const ccomplex_t IT_0251 = 6*s_34;
    const ccomplex_t IT_0252 = (-6)*s_34;
    const ccomplex_t IT_0253 = (-6)*conj(IT_0106)*(IT_0195*IT_0196 + (
      -0.166666666666667)*IT_0106*IT_0201) + (-6)*conj(IT_0195)*(IT_0106*IT_0196
       + (-0.166666666666667)*IT_0195*IT_0201) + (-6)*IT_0202*(conj(IT_0195)*
      (IT_0209 + -IT_0220) + IT_0195*IT_0222 + (-0.166666666666667)*conj(IT_0106
      )*IT_0239 + (-0.166666666666667)*IT_0106*IT_0242) + IT_0243*(conj(IT_0209)
      *IT_0239 + IT_0209*IT_0242 + conj(IT_0220)*IT_0246 + IT_0220*IT_0249) + 6*
      (conj(IT_0106)*(IT_0209 + -IT_0220) + IT_0106*IT_0222 + 0.166666666666667
      *conj(IT_0195)*IT_0246 + 0.166666666666667*IT_0195*IT_0249)*IT_0250 + 
      (IT_0209*conj(IT_0209) + IT_0220*conj(IT_0220) + IT_0233*conj(IT_0233) +
       IT_0237*conj(IT_0237))*IT_0251 + (conj(IT_0209)*IT_0220 + IT_0209*conj
      (IT_0220) + conj(IT_0233)*IT_0237 + IT_0233*conj(IT_0237))*IT_0252;
