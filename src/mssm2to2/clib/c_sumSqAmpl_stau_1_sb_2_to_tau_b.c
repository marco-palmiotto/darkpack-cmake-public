...
ccomplex_return_t c_sumSqAmpl_stau_1_sb_2_to_tau_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0035 = m_b*conj(N_d4)*e_em*IT_0008*U_sb_11;
    ...
    const ccomplex_t IT_0041 = conj(N_B4)*e_em*U_sb_01;
    ...
    const ccomplex_t IT_0050 = N_d4*e_em*m_tau*IT_0008*U_stau_00;
    ...
    const ccomplex_t IT_0062 = N_d1*e_em*m_tau*IT_0008*U_stau_00;
    ...
    const ccomplex_t IT_0067 = conj(N_B1)*e_em*U_sb_01;
    const ccomplex_t IT_0068 = IT_0016*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = conj(N_W1)*e_em*U_sb_01;
    const ccomplex_t IT_0071 = IT_0006*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = m_b*conj(N_d1)*e_em*IT_0008*U_sb_11;
    ...
    const ccomplex_t IT_0082 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0083 = IT_0016*IT_0082;
    const ccomplex_t IT_0084 = 1.4142135623731*IT_0083;
    const ccomplex_t IT_0085 = N_d3*e_em*m_tau*IT_0008*U_stau_00;
    ...
    const ccomplex_t IT_0104 = 0.5*IT_0033 + 0.5*IT_0057 + 0.5*IT_0080 + 0.5
      *IT_0103;
    ...
    const ccomplex_t IT_0108 = m_b*N_d1*e_em*IT_0008*U_sb_01;
    ...
    const ccomplex_t IT_0127 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0128 = IT_0016*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_b*N_d4*e_em*IT_0008*U_sb_01;
    ...
    const ccomplex_t IT_0160 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0161 = IT_0016*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = m_b*N_d2*e_em*IT_0008*U_sb_01;
    ...
    const ccomplex_t IT_0182 = N_B3*e_em*U_sb_11;
    const ccomplex_t IT_0183 = IT_0016*IT_0182;
    const ccomplex_t IT_0184 = 1.4142135623731*IT_0183;
    const ccomplex_t IT_0185 = m_b*N_d3*e_em*IT_0008*U_sb_01;
    ...
    const ccomplex_t IT_0193 = 0.5*IT_0126 + 0.5*IT_0148 + 0.5*IT_0170 + 0.5
      *IT_0192;
    const ccomplex_t IT_0194 = m_b*m_tau*IT_0001;
    const ccomplex_t IT_0195 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0200 = m_b*s_13;
    const ccomplex_t IT_0201 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0202 = IT_0022*IT_0159;
    const ccomplex_t IT_0203 = IT_0002*IT_0201*IT_0202;
    const ccomplex_t IT_0204 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0205 = IT_0100*IT_0181;
    const ccomplex_t IT_0206 = IT_0081*IT_0204*IT_0205;
    const ccomplex_t IT_0207 = m_tau*IT_0080;
    const ccomplex_t IT_0208 = m_tau*IT_0033;
    const ccomplex_t IT_0209 = m_tau*IT_0103;
    const ccomplex_t IT_0210 = m_tau*IT_0057;
    const ccomplex_t IT_0211 = (-0.5)*IT_0203 + (-0.5)*IT_0206 + 0.5*IT_0207 +
       0.5*IT_0208 + 0.5*IT_0209 + 0.5*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0213 = IT_0077*IT_0123;
    const ccomplex_t IT_0214 = IT_0058*IT_0212*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0216 = IT_0046*IT_0145;
    const ccomplex_t IT_0217 = IT_0034*IT_0215*IT_0216;
    const ccomplex_t IT_0218 = 0.5*IT_0214 + 0.5*IT_0217;
    const ccomplex_t IT_0219 = IT_0211 + -IT_0218;
    const ccomplex_t IT_0220 = -conj(IT_0218);
    const ccomplex_t IT_0221 = conj(IT_0211) + IT_0220;
    const ccomplex_t IT_0222 = IT_0066*IT_0112;
    const ccomplex_t IT_0223 = IT_0058*IT_0212*IT_0222;
    const ccomplex_t IT_0224 = IT_0089*IT_0189;
    const ccomplex_t IT_0225 = IT_0081*IT_0204*IT_0224;
    const ccomplex_t IT_0226 = IT_0054*IT_0134;
    const ccomplex_t IT_0227 = IT_0034*IT_0215*IT_0226;
    const ccomplex_t IT_0228 = m_tau*IT_0126;
    const ccomplex_t IT_0229 = m_tau*IT_0170;
    const ccomplex_t IT_0230 = m_tau*IT_0192;
    const ccomplex_t IT_0231 = m_tau*IT_0148;
    const ccomplex_t IT_0232 = (-0.5)*IT_0223 + (-0.5)*IT_0225 + (-0.5)
      *IT_0227 + 0.5*IT_0228 + 0.5*IT_0229 + 0.5*IT_0230 + 0.5*IT_0231;
    const ccomplex_t IT_0233 = 6*IT_0232;
    const ccomplex_t IT_0234 = IT_0030*IT_0167;
    const ccomplex_t IT_0235 = IT_0002*IT_0201*IT_0234;
    const ccomplex_t IT_0236 = 0.5*IT_0235;
    const ccomplex_t IT_0237 = (-6)*IT_0236;
    const ccomplex_t IT_0238 = IT_0233 + IT_0237;
    const ccomplex_t IT_0239 = 6*conj(IT_0232);
    ...
    const ccomplex_t IT_0244 = (-6)*IT_0232;
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = 6*conj(IT_0236);
    const ccomplex_t IT_0247 = (-6)*conj(IT_0232);
    const ccomplex_t IT_0248 = IT_0246 + IT_0247;
    const ccomplex_t IT_0249 = 6*s_34;
    const ccomplex_t IT_0250 = (-6)*s_34;
    const ccomplex_t IT_0251 = (-0.166666666666667)*IT_0193;
    const ccomplex_t IT_0252 = s_14*m_tau;
    const ccomplex_t IT_0253 = (-6)*conj(IT_0104)*(IT_0193*IT_0194 + (
      -0.166666666666667)*IT_0104*IT_0199) + 6*IT_0200*(conj(IT_0193)*IT_0219 +
       IT_0193*IT_0221 + 0.166666666666667*conj(IT_0104)*IT_0238 +
       0.166666666666667*IT_0104*IT_0241) + IT_0242*(conj(IT_0218)*IT_0238 +
       IT_0218*IT_0241 + conj(IT_0211)*IT_0245 + IT_0211*IT_0248) + (IT_0211
      *conj(IT_0211) + IT_0218*conj(IT_0218) + IT_0232*conj(IT_0232) + IT_0236
      *conj(IT_0236))*IT_0249 + (conj(IT_0211)*IT_0218 + IT_0211*conj(IT_0218) +
       conj(IT_0232)*IT_0236 + IT_0232*conj(IT_0236))*IT_0250 + (-6)*conj
      (IT_0193)*(IT_0104*IT_0194 + IT_0199*IT_0251) + (-6)*(conj(IT_0104)
      *IT_0219 + IT_0104*IT_0221 + (-0.166666666666667)*conj(IT_0193)*IT_0245 +
       IT_0248*IT_0251)*IT_0252;
