...
ccomplex_return_t c_sumSqAmpl_stau_1_sc_R_to_tau_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = N_B2*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0015 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    const ccomplex_t IT_0016 = IT_0014*IT_0015;
    const ccomplex_t IT_0017 = 1.4142135623731*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*(IT_0011 + 0.5*IT_0017);
    ...
    const ccomplex_t IT_0023 = cpow(s_13 + (-0.5)*IT_0021 + (-0.5)*IT_0022 +
       0.5*m_N_2*(m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0024 = IT_0020*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*IT_0024;
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0027 = 0.5*IT_0026;
    const ccomplex_t IT_0028 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0029 = IT_0008*IT_0028;
    const ccomplex_t IT_0030 = 1.4142135623731*IT_0029;
    const ccomplex_t IT_0031 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0037 = cpow(s_13 + (-0.5)*IT_0021 + (-0.5)*IT_0022 +
       0.5*m_N_3*(m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0038 = IT_0036*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0045 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0051 = cpow(s_13 + (-0.5)*IT_0021 + (-0.5)*IT_0022 +
       0.5*m_N_4*(m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0050*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0059 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0133 = 0.5*IT_0084 + 0.5*IT_0100 + 0.5*IT_0116 + 0.5
      *IT_0132;
    const ccomplex_t IT_0134 = m_c*m_tau*IT_0022;
    const ccomplex_t IT_0135 = s_34*IT_0022;
    ...
    const ccomplex_t IT_0140 = m_c*m_tau;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0142 = IT_0006*IT_0081;
    const ccomplex_t IT_0143 = IT_0023*IT_0141*IT_0142;
    const ccomplex_t IT_0144 = m_tau*IT_0025;
    const ccomplex_t IT_0145 = m_tau*IT_0039;
    const ccomplex_t IT_0146 = m_tau*IT_0053;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0148 = IT_0027*IT_0097;
    const ccomplex_t IT_0149 = IT_0037*IT_0147*IT_0148;
    const ccomplex_t IT_0150 = m_tau*IT_0067;
    const ccomplex_t IT_0151 = (-0.5)*IT_0143 + 0.5*IT_0144 + 0.5*IT_0145 +
       0.5*IT_0146 + (-0.5)*IT_0149 + 0.5*IT_0150;
    const ccomplex_t IT_0152 = IT_0019*IT_0070;
    const ccomplex_t IT_0153 = IT_0023*IT_0141*IT_0152;
    const ccomplex_t IT_0154 = 0.5*IT_0153;
    const ccomplex_t IT_0155 = 6*IT_0154;
    const ccomplex_t IT_0156 = IT_0035*IT_0086;
    const ccomplex_t IT_0157 = IT_0037*IT_0147*IT_0156;
    const ccomplex_t IT_0158 = IT_0049*IT_0102;
    const ccomplex_t IT_0159 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0160 = IT_0051*IT_0158*IT_0159;
    const ccomplex_t IT_0161 = m_tau*IT_0084;
    const ccomplex_t IT_0162 = m_tau*IT_0100;
    const ccomplex_t IT_0163 = m_tau*IT_0132;
    const ccomplex_t IT_0164 = m_tau*IT_0116;
    const ccomplex_t IT_0165 = IT_0063*IT_0118;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0167 = IT_0065*IT_0165*IT_0166;
    const ccomplex_t IT_0168 = (-0.5)*IT_0157 + (-0.5)*IT_0160 + 0.5*IT_0161 +
       0.5*IT_0162 + 0.5*IT_0163 + 0.5*IT_0164 + (-0.5)*IT_0167;
    const ccomplex_t IT_0169 = (-6)*IT_0168;
    const ccomplex_t IT_0170 = IT_0155 + IT_0169;
    const ccomplex_t IT_0171 = 6*conj(IT_0154);
    const ccomplex_t IT_0172 = (-6)*conj(IT_0168);
    const ccomplex_t IT_0173 = IT_0171 + IT_0172;
    const ccomplex_t IT_0174 = IT_0055*IT_0129;
    const ccomplex_t IT_0175 = IT_0065*IT_0166*IT_0174;
    const ccomplex_t IT_0176 = IT_0041*IT_0113;
    const ccomplex_t IT_0177 = IT_0051*IT_0159*IT_0176;
    const ccomplex_t IT_0178 = 0.5*IT_0175 + 0.5*IT_0177;
    const ccomplex_t IT_0179 = 6*IT_0168;
    const ccomplex_t IT_0180 = (-6)*IT_0154;
    const ccomplex_t IT_0181 = IT_0179 + IT_0180;
    const ccomplex_t IT_0182 = 6*conj(IT_0168);
    const ccomplex_t IT_0183 = (-6)*conj(IT_0154);
    const ccomplex_t IT_0184 = IT_0182 + IT_0183;
    const ccomplex_t IT_0185 = m_c*s_13;
    const ccomplex_t IT_0186 = IT_0151 + -IT_0178;
    const ccomplex_t IT_0187 = -conj(IT_0178);
    const ccomplex_t IT_0188 = conj(IT_0151) + IT_0187;
    const ccomplex_t IT_0189 = 6*s_34;
    const ccomplex_t IT_0190 = (-6)*s_34;
    const ccomplex_t IT_0191 = (-0.166666666666667)*IT_0133;
    const ccomplex_t IT_0192 = s_14*m_tau;
    const ccomplex_t IT_0193 = (-6)*conj(IT_0068)*(IT_0133*IT_0134 + (
      -0.166666666666667)*IT_0068*IT_0139) + IT_0140*(conj(IT_0151)*IT_0170 +
       IT_0151*IT_0173 + conj(IT_0178)*IT_0181 + IT_0178*IT_0184) + 6*IT_0185*
      (0.166666666666667*conj(IT_0068)*IT_0181 + 0.166666666666667*IT_0068
      *IT_0184 + conj(IT_0133)*IT_0186 + IT_0133*IT_0188) + (IT_0151*conj
      (IT_0151) + IT_0154*conj(IT_0154) + IT_0168*conj(IT_0168) + IT_0178*conj
      (IT_0178))*IT_0189 + (conj(IT_0154)*IT_0168 + IT_0154*conj(IT_0168) + conj
      (IT_0151)*IT_0178 + IT_0151*conj(IT_0178))*IT_0190 + (-6)*conj(IT_0133)*
      (IT_0068*IT_0134 + IT_0139*IT_0191) + (-6)*((-0.166666666666667)*conj
      (IT_0133)*IT_0170 + conj(IT_0068)*IT_0186 + IT_0068*IT_0188 + IT_0173
      *IT_0191)*IT_0192;
