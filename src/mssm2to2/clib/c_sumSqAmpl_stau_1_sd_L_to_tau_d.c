...
ccomplex_return_t c_sumSqAmpl_stau_1_sd_L_to_tau_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B1*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0019 = N_d1*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0026 = pow(m_stau_1, 2);
    const ccomplex_t IT_0027 = cpow(s_13 + (-0.5)*IT_0025 + (-0.5)*IT_0026 +
    ...
    const ccomplex_t IT_0038 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0039 = IT_0001*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = N_d2*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0047 = cpow(s_13 + (-0.5)*IT_0025 + (-0.5)*IT_0026 +
    ...
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*(IT_0052 + (-3)*IT_0055);
    const ccomplex_t IT_0057 = 0.166666666666667*IT_0056;
    const ccomplex_t IT_0058 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0059 = IT_0001*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = N_d3*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0067 = cpow(s_13 + (-0.5)*IT_0025 + (-0.5)*IT_0026 +
    ...
    const ccomplex_t IT_0081 = N_d4*e_em*m_tau*IT_0018*U_stau_00;
    ...
    const ccomplex_t IT_0087 = cpow(s_13 + (-0.5)*IT_0025 + (-0.5)*IT_0026 +
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_d*N_d2*e_em
      *IT_0006*IT_0016*IT_0018;
    const ccomplex_t IT_0108 = (-0.5)*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0110 = IT_0001*IT_0109;
    const ccomplex_t IT_0111 = 1.4142135623731*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0113 = IT_0006*IT_0112;
    const ccomplex_t IT_0114 = 1.4142135623731*IT_0113;
    const ccomplex_t IT_0115 = conj(N_d2)*e_em*m_tau*IT_0018*U_stau_10;
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0006*IT_0016*IT_0018;
    const ccomplex_t IT_0124 = (-0.5)*IT_0123;
    const ccomplex_t IT_0125 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0126 = IT_0001*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0129 = IT_0006*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = conj(N_d3)*e_em*m_tau*IT_0018*U_stau_10;
    ...
    const ccomplex_t IT_0153 = IT_0087*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*IT_0153;
    const ccomplex_t IT_0155 = 0.5*IT_0106 + 0.5*IT_0122 + 0.5*IT_0138 + 0.5
      *IT_0154;
    const ccomplex_t IT_0156 = m_d*m_tau*IT_0026;
    const ccomplex_t IT_0157 = s_34*IT_0026;
    ...
    const ccomplex_t IT_0162 = m_d*s_13;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0164 = IT_0011*IT_0103;
    const ccomplex_t IT_0165 = IT_0027*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0167 = IT_0037*IT_0119;
    const ccomplex_t IT_0168 = IT_0047*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0170 = IT_0077*IT_0151;
    const ccomplex_t IT_0171 = IT_0087*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = 0.5*IT_0165 + 0.5*IT_0168 + 0.5*IT_0171;
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0174 = IT_0057*IT_0135;
    const ccomplex_t IT_0175 = IT_0067*IT_0173*IT_0174;
    const ccomplex_t IT_0176 = m_tau*IT_0029;
    const ccomplex_t IT_0177 = m_tau*IT_0049;
    const ccomplex_t IT_0178 = m_tau*IT_0069;
    const ccomplex_t IT_0179 = m_tau*IT_0089;
    const ccomplex_t IT_0180 = (-0.5)*IT_0175 + 0.5*IT_0176 + 0.5*IT_0177 +
       0.5*IT_0178 + 0.5*IT_0179;
    const ccomplex_t IT_0181 = IT_0172 + -IT_0180;
    const ccomplex_t IT_0182 = -conj(IT_0180);
    const ccomplex_t IT_0183 = conj(IT_0172) + IT_0182;
    const ccomplex_t IT_0184 = IT_0023*IT_0092;
    const ccomplex_t IT_0185 = IT_0027*IT_0163*IT_0184;
    const ccomplex_t IT_0186 = IT_0085*IT_0140;
    const ccomplex_t IT_0187 = IT_0087*IT_0169*IT_0186;
    ...
    const ccomplex_t IT_0192 = (-0.5)*IT_0185 + (-0.5)*IT_0187 + 0.5*IT_0188 +
       0.5*IT_0189 + 0.5*IT_0190 + 0.5*IT_0191;
    const ccomplex_t IT_0193 = 6*IT_0192;
    const ccomplex_t IT_0194 = IT_0045*IT_0108;
    const ccomplex_t IT_0195 = IT_0047*IT_0166*IT_0194;
    const ccomplex_t IT_0196 = IT_0065*IT_0124;
    const ccomplex_t IT_0197 = IT_0067*IT_0173*IT_0196;
    const ccomplex_t IT_0198 = 0.5*IT_0195 + 0.5*IT_0197;
    const ccomplex_t IT_0199 = (-6)*IT_0198;
    const ccomplex_t IT_0200 = IT_0193 + IT_0199;
    const ccomplex_t IT_0201 = 6*conj(IT_0192);
    const ccomplex_t IT_0202 = (-6)*conj(IT_0198);
    const ccomplex_t IT_0203 = IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = s_14*m_tau;
    const ccomplex_t IT_0205 = 6*IT_0198;
    const ccomplex_t IT_0206 = (-6)*IT_0192;
    const ccomplex_t IT_0207 = IT_0205 + IT_0206;
    const ccomplex_t IT_0208 = 6*conj(IT_0198);
    const ccomplex_t IT_0209 = (-6)*conj(IT_0192);
    const ccomplex_t IT_0210 = IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = m_d*m_tau;
    const ccomplex_t IT_0212 = 6*s_34;
    const ccomplex_t IT_0213 = (-6)*s_34;
    const ccomplex_t IT_0214 = (-6)*conj(IT_0090)*(IT_0155*IT_0156 + (
      -0.166666666666667)*IT_0090*IT_0161) + (-6)*conj(IT_0155)*(IT_0090*IT_0156
       + (-0.166666666666667)*IT_0155*IT_0161) + (-6)*IT_0162*(conj(IT_0155)
      *IT_0181 + IT_0155*IT_0183 + (-0.166666666666667)*conj(IT_0090)*IT_0200 + 
      (-0.166666666666667)*IT_0090*IT_0203) + 6*IT_0204*(conj(IT_0090)*IT_0181 +
       IT_0090*IT_0183 + 0.166666666666667*conj(IT_0155)*IT_0207 +
       0.166666666666667*IT_0155*IT_0210) + (conj(IT_0172)*IT_0200 + IT_0172
      *IT_0203 + conj(IT_0180)*IT_0207 + IT_0180*IT_0210)*IT_0211 + (IT_0172
      *conj(IT_0172) + IT_0180*conj(IT_0180) + IT_0192*conj(IT_0192) + IT_0198
      *conj(IT_0198))*IT_0212 + (conj(IT_0172)*IT_0180 + IT_0172*conj(IT_0180) +
       conj(IT_0192)*IT_0198 + IT_0192*conj(IT_0198))*IT_0213;
