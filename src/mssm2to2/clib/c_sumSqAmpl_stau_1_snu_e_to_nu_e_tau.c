...
ccomplex_return_t c_sumSqAmpl_stau_1_snu_e_to_nu_e_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0044 = IT_0006*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0069 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0076 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0079 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0086 = conj(N_d3)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0101 = 0.5*IT_0031 + 0.5*IT_0054 + 0.5*IT_0077 + 0.5
      *IT_0100;
    const ccomplex_t IT_0102 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0103 = IT_0001*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = N_d4*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0113 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0114 = IT_0001*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = N_d2*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0127 = N_d3*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0135 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0136 = IT_0001*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = N_d1*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0144 = IT_0030*IT_0143;
    ...
    const ccomplex_t IT_0152 = pow(m_stau_1, 2);
