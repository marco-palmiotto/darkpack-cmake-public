...
ccomplex_return_t c_sumSqAmpl_stau_1_snu_mu_to_mu_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0021 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0022 = IT_0001*IT_0021;
    const ccomplex_t IT_0023 = conj(U_d2)*e_em*m_tau*IT_0008*U_stau_10;
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*U_d1*e_em*m_mu
      *IT_0001*IT_0006*IT_0008;
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = IT_0012*IT_0032;
    const ccomplex_t IT_0034 = IT_0017*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1)*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*U_d2*e_em*m_mu
      *IT_0001*IT_0006*IT_0008;
    ...
    const ccomplex_t IT_0042 = m_mu*s_14;
