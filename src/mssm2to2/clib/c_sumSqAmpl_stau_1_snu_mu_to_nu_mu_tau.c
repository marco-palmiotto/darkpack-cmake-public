...
ccomplex_return_t c_sumSqAmpl_stau_1_snu_mu_to_nu_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0070 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0092 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0093 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0094 = IT_0001*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0097 = IT_0006*IT_0096;
    const ccomplex_t IT_0098 = 1.4142135623731*IT_0097;
    const ccomplex_t IT_0099 = conj(N_d3)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0113 = IT_0091*IT_0092*IT_0112;
    ...
    const ccomplex_t IT_0126 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0127 = IT_0001*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = N_d1*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0138 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0139 = IT_0001*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = N_d3*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0150 = (-0.5)*IT_0078 + 0.5*IT_0090 + (-0.5)*IT_0113 +
       0.5*IT_0125 + 0.5*IT_0137 + 0.5*IT_0149;
    const ccomplex_t IT_0151 = 0.5*IT_0089 + 0.5*IT_0124 + 0.5*IT_0136 + 0.5
      *IT_0148;
    const ccomplex_t IT_0152 = s_13*m_tau;
    const ccomplex_t IT_0153 = s_13*s_14;
    const ccomplex_t IT_0154 = pow(m_stau_1, 2);
