...
ccomplex_return_t c_sumSqAmpl_stau_1_ss_L_to_tau_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = N_B1*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0022 = N_d1*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0038 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0039 = IT_0004*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = N_d4*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0047 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0054 = N_d3*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0079 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0080 = IT_0004*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_d2*e_em*m_tau*IT_0021*U_stau_00;
    ...
    const ccomplex_t IT_0090 = 0.5*IT_0029 + 0.5*IT_0049 + 0.5*IT_0069 + 0.5
      *IT_0089;
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0009*IT_0019*IT_0021;
    ...
    const ccomplex_t IT_0099 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0108 = (-0.5)*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0110 = IT_0004*IT_0109;
    const ccomplex_t IT_0111 = 1.4142135623731*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0113 = IT_0009*IT_0112;
    const ccomplex_t IT_0114 = 1.4142135623731*IT_0113;
    const ccomplex_t IT_0115 = conj(N_d1)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0009*IT_0019*IT_0021;
    const ccomplex_t IT_0124 = (-0.5)*IT_0123;
    const ccomplex_t IT_0125 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0126 = IT_0004*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0129 = IT_0009*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_10;
    ...
    const ccomplex_t IT_0155 = 0.5*IT_0106 + 0.5*IT_0122 + 0.5*IT_0138 + 0.5
      *IT_0154;
    const ccomplex_t IT_0156 = m_s*m_tau*IT_0001;
    const ccomplex_t IT_0157 = s_34*IT_0001;
    const ccomplex_t IT_0158 = (-6)*IT_0157;
    const ccomplex_t IT_0159 = s_13*s_14;
    const ccomplex_t IT_0160 = 12*IT_0159;
    const ccomplex_t IT_0161 = IT_0158 + IT_0160;
    const ccomplex_t IT_0162 = m_s*m_tau;
    const ccomplex_t IT_0163 = m_tau*IT_0029;
    const ccomplex_t IT_0164 = m_tau*IT_0089;
    const ccomplex_t IT_0165 = m_tau*IT_0049;
    const ccomplex_t IT_0166 = m_tau*IT_0069;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0168 = IT_0066*IT_0151;
    const ccomplex_t IT_0169 = IT_0050*IT_0167*IT_0168;
    const ccomplex_t IT_0170 = 0.5*IT_0163 + 0.5*IT_0164 + 0.5*IT_0165 + 0.5
      *IT_0166 + (-0.5)*IT_0169;
    const ccomplex_t IT_0171 = IT_0086*IT_0124;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0173 = IT_0070*IT_0171*IT_0172;
    const ccomplex_t IT_0174 = IT_0058*IT_0140;
    const ccomplex_t IT_0175 = IT_0050*IT_0167*IT_0174;
    const ccomplex_t IT_0176 = 0.5*IT_0173 + 0.5*IT_0175;
    const ccomplex_t IT_0177 = 6*IT_0176;
    const ccomplex_t IT_0178 = IT_0045*IT_0092;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0180 = IT_0047*IT_0178*IT_0179;
    const ccomplex_t IT_0181 = m_tau*IT_0138;
    const ccomplex_t IT_0182 = m_tau*IT_0154;
    const ccomplex_t IT_0183 = m_tau*IT_0106;
    const ccomplex_t IT_0184 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0185 = IT_0026*IT_0108;
    const ccomplex_t IT_0186 = IT_0002*IT_0184*IT_0185;
    const ccomplex_t IT_0187 = m_tau*IT_0122;
    const ccomplex_t IT_0188 = (-0.5)*IT_0180 + 0.5*IT_0181 + 0.5*IT_0182 +
       0.5*IT_0183 + (-0.5)*IT_0186 + 0.5*IT_0187;
    const ccomplex_t IT_0189 = (-6)*IT_0188;
    const ccomplex_t IT_0190 = IT_0177 + IT_0189;
    const ccomplex_t IT_0191 = 6*conj(IT_0176);
    const ccomplex_t IT_0192 = (-6)*conj(IT_0188);
    const ccomplex_t IT_0193 = IT_0191 + IT_0192;
    const ccomplex_t IT_0194 = IT_0037*IT_0103;
    const ccomplex_t IT_0195 = IT_0047*IT_0179*IT_0194;
    const ccomplex_t IT_0196 = IT_0014*IT_0119;
    const ccomplex_t IT_0197 = IT_0002*IT_0184*IT_0196;
    const ccomplex_t IT_0198 = IT_0078*IT_0135;
    const ccomplex_t IT_0199 = IT_0070*IT_0172*IT_0198;
    const ccomplex_t IT_0200 = 0.5*IT_0195 + 0.5*IT_0197 + 0.5*IT_0199;
    const ccomplex_t IT_0201 = 6*IT_0188;
    const ccomplex_t IT_0202 = (-6)*IT_0176;
    const ccomplex_t IT_0203 = IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = 6*conj(IT_0188);
    const ccomplex_t IT_0205 = (-6)*conj(IT_0176);
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = m_s*s_13;
    const ccomplex_t IT_0208 = IT_0170 + -IT_0200;
    const ccomplex_t IT_0209 = -conj(IT_0200);
    const ccomplex_t IT_0210 = conj(IT_0170) + IT_0209;
    const ccomplex_t IT_0211 = 6*s_34;
    const ccomplex_t IT_0212 = (-6)*s_34;
    const ccomplex_t IT_0213 = (-0.166666666666667)*IT_0155;
    const ccomplex_t IT_0214 = s_14*m_tau;
    const ccomplex_t IT_0215 = (-6)*conj(IT_0090)*(IT_0155*IT_0156 + (
      -0.166666666666667)*IT_0090*IT_0161) + IT_0162*(conj(IT_0170)*IT_0190 +
       IT_0170*IT_0193 + conj(IT_0200)*IT_0203 + IT_0200*IT_0206) + 6*IT_0207*
      (0.166666666666667*conj(IT_0090)*IT_0203 + 0.166666666666667*IT_0090
      *IT_0206 + conj(IT_0155)*IT_0208 + IT_0155*IT_0210) + (IT_0170*conj
      (IT_0170) + IT_0176*conj(IT_0176) + IT_0188*conj(IT_0188) + IT_0200*conj
      (IT_0200))*IT_0211 + (conj(IT_0176)*IT_0188 + IT_0176*conj(IT_0188) + conj
      (IT_0170)*IT_0200 + IT_0170*conj(IT_0200))*IT_0212 + (-6)*conj(IT_0155)*
      (IT_0090*IT_0156 + IT_0161*IT_0213) + (-6)*((-0.166666666666667)*conj
      (IT_0155)*IT_0190 + conj(IT_0090)*IT_0208 + IT_0090*IT_0210 + IT_0193
      *IT_0213)*IT_0214;
