        ...
        )
{
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0006*IT_0016*IT_0018;
    const ccomplex_t IT_0108 = (-0.5)*IT_0107;
    const ccomplex_t IT_0109 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0110 = IT_0001*IT_0109;
    const ccomplex_t IT_0111 = 1.4142135623731*IT_0110;
    const ccomplex_t IT_0112 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0113 = IT_0006*IT_0112;
    const ccomplex_t IT_0114 = 1.4142135623731*IT_0113;
    const ccomplex_t IT_0115 = conj(N_d3)*e_em*m_tau*IT_0018*U_stau_10;
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0006*IT_0016*IT_0018;
    const ccomplex_t IT_0124 = (-0.5)*IT_0123;
    const ccomplex_t IT_0125 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0126 = IT_0001*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0129 = IT_0006*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = conj(N_d4)*e_em*m_tau*IT_0018*U_stau_10;
    ...
    const ccomplex_t IT_0139 = (0 + _Complex_I*1.4142135623731)*m_s*N_d1*e_em
      *IT_0006*IT_0016*IT_0018;
    const ccomplex_t IT_0140 = (-0.5)*IT_0139;
    const ccomplex_t IT_0141 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0142 = IT_0001*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0145 = IT_0006*IT_0144;
    const ccomplex_t IT_0146 = 1.4142135623731*IT_0145;
    const ccomplex_t IT_0147 = conj(N_d1)*e_em*m_tau*IT_0018*U_stau_10;
    ...
    const ccomplex_t IT_0155 = 0.5*IT_0106 + 0.5*IT_0122 + 0.5*IT_0138 + 0.5
      *IT_0154;
    const ccomplex_t IT_0156 = m_s*m_tau*IT_0026;
    ...
    const ccomplex_t IT_0170 = IT_0037*IT_0119;
    const ccomplex_t IT_0171 = IT_0047*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = m_tau*IT_0089;
    const ccomplex_t IT_0173 = (-0.5)*IT_0165 + 0.5*IT_0166 + 0.5*IT_0167 +
       0.5*IT_0168 + (-0.5)*IT_0171 + 0.5*IT_0172;
    const ccomplex_t IT_0174 = IT_0023*IT_0092;
    const ccomplex_t IT_0175 = IT_0027*IT_0163*IT_0174;
    const ccomplex_t IT_0176 = 0.5*IT_0175;
    const ccomplex_t IT_0177 = 6*IT_0176;
    const ccomplex_t IT_0178 = IT_0045*IT_0108;
    const ccomplex_t IT_0179 = IT_0047*IT_0169*IT_0178;
    const ccomplex_t IT_0180 = IT_0065*IT_0124;
    ...
    const ccomplex_t IT_0184 = m_tau*IT_0122;
    const ccomplex_t IT_0185 = m_tau*IT_0154;
    const ccomplex_t IT_0186 = m_tau*IT_0138;
    const ccomplex_t IT_0187 = IT_0085*IT_0140;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0189 = IT_0087*IT_0187*IT_0188;
    const ccomplex_t IT_0190 = (-0.5)*IT_0179 + (-0.5)*IT_0182 + 0.5*IT_0183 +
       0.5*IT_0184 + 0.5*IT_0185 + 0.5*IT_0186 + (-0.5)*IT_0189;
    const ccomplex_t IT_0191 = (-6)*IT_0190;
    const ccomplex_t IT_0192 = IT_0177 + IT_0191;
    const ccomplex_t IT_0193 = 6*conj(IT_0176);
    const ccomplex_t IT_0194 = (-6)*conj(IT_0190);
    const ccomplex_t IT_0195 = IT_0193 + IT_0194;
    const ccomplex_t IT_0196 = IT_0077*IT_0151;
    const ccomplex_t IT_0197 = IT_0087*IT_0188*IT_0196;
    const ccomplex_t IT_0198 = IT_0057*IT_0135;
    const ccomplex_t IT_0199 = IT_0067*IT_0181*IT_0198;
    ...
    const ccomplex_t IT_0215 = (-6)*conj(IT_0090)*(IT_0155*IT_0156 + (
      ...
      *IT_0206 + conj(IT_0155)*IT_0208 + IT_0155*IT_0210) + (IT_0173*conj
      (IT_0173) + IT_0176*conj(IT_0176) + IT_0190*conj(IT_0190) + IT_0200*conj
      (IT_0200))*IT_0211 + (conj(IT_0176)*IT_0190 + IT_0176*conj(IT_0190) + conj
