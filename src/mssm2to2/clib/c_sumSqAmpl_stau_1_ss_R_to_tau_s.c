        ...
        )
{
    ...
    const ccomplex_t IT_0005 = N_B3*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0014 = N_d3*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0009*IT_0011*IT_0013;
    ...
    const ccomplex_t IT_0030 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
      *e_em*IT_0009*IT_0011*IT_0013;
    const ccomplex_t IT_0040 = 0.5*IT_0039;
    const ccomplex_t IT_0041 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0042 = IT_0004*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = N_d2*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0057 = N_d4*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0075 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0107 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0123 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0138 = m_s*m_tau;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0140 = IT_0040*IT_0127;
    const ccomplex_t IT_0141 = IT_0038*IT_0139*IT_0140;
    const ccomplex_t IT_0142 = m_tau*IT_0023;
    const ccomplex_t IT_0143 = m_tau*IT_0065;
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0145 = IT_0020*IT_0095;
    const ccomplex_t IT_0146 = IT_0002*IT_0144*IT_0145;
    const ccomplex_t IT_0147 = m_tau*IT_0037;
    const ccomplex_t IT_0148 = m_tau*IT_0051;
    const ccomplex_t IT_0149 = (-0.5)*IT_0141 + 0.5*IT_0142 + 0.5*IT_0143 + (
      -0.5)*IT_0146 + 0.5*IT_0147 + 0.5*IT_0148;
    const ccomplex_t IT_0150 = IT_0048*IT_0116;
    const ccomplex_t IT_0151 = IT_0038*IT_0139*IT_0150;
    const ccomplex_t IT_0152 = 0.5*IT_0151;
    const ccomplex_t IT_0153 = 6*IT_0152;
    const ccomplex_t IT_0154 = IT_0018*IT_0084;
    const ccomplex_t IT_0155 = IT_0002*IT_0144*IT_0154;
    const ccomplex_t IT_0156 = IT_0061*IT_0100;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0158 = IT_0063*IT_0156*IT_0157;
    const ccomplex_t IT_0159 = m_tau*IT_0082;
    const ccomplex_t IT_0160 = m_tau*IT_0130;
    const ccomplex_t IT_0161 = m_tau*IT_0098;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0163 = IT_0034*IT_0068;
    const ccomplex_t IT_0164 = IT_0024*IT_0162*IT_0163;
    const ccomplex_t IT_0165 = m_tau*IT_0114;
    const ccomplex_t IT_0166 = (-0.5)*IT_0155 + (-0.5)*IT_0158 + 0.5*IT_0159 +
       0.5*IT_0160 + 0.5*IT_0161 + (-0.5)*IT_0164 + 0.5*IT_0165;
    const ccomplex_t IT_0167 = (-6)*IT_0166;
    const ccomplex_t IT_0168 = IT_0153 + IT_0167;
    const ccomplex_t IT_0169 = 6*conj(IT_0152);
    const ccomplex_t IT_0170 = (-6)*conj(IT_0166);
    const ccomplex_t IT_0171 = IT_0169 + IT_0170;
    const ccomplex_t IT_0172 = IT_0026*IT_0079;
    const ccomplex_t IT_0173 = IT_0024*IT_0162*IT_0172;
    const ccomplex_t IT_0174 = IT_0053*IT_0111;
    const ccomplex_t IT_0175 = IT_0063*IT_0157*IT_0174;
    const ccomplex_t IT_0176 = 0.5*IT_0173 + 0.5*IT_0175;
    const ccomplex_t IT_0177 = 6*IT_0166;
    const ccomplex_t IT_0178 = (-6)*IT_0152;
    const ccomplex_t IT_0179 = IT_0177 + IT_0178;
    const ccomplex_t IT_0180 = 6*conj(IT_0166);
    const ccomplex_t IT_0181 = (-6)*conj(IT_0152);
    const ccomplex_t IT_0182 = IT_0180 + IT_0181;
    const ccomplex_t IT_0183 = m_s*s_13;
    const ccomplex_t IT_0184 = IT_0149 + -IT_0176;
    const ccomplex_t IT_0185 = -conj(IT_0176);
    const ccomplex_t IT_0186 = conj(IT_0149) + IT_0185;
    ...
    const ccomplex_t IT_0191 = (-6)*conj(IT_0066)*(IT_0131*IT_0132 + (
      -0.166666666666667)*IT_0066*IT_0137) + IT_0138*(conj(IT_0149)*IT_0168 +
       IT_0149*IT_0171 + conj(IT_0176)*IT_0179 + IT_0176*IT_0182) + 6*IT_0183*
      (0.166666666666667*conj(IT_0066)*IT_0179 + 0.166666666666667*IT_0066
      *IT_0182 + conj(IT_0131)*IT_0184 + IT_0131*IT_0186) + (IT_0149*conj
      (IT_0149) + IT_0152*conj(IT_0152) + IT_0166*conj(IT_0166) + IT_0176*conj
      (IT_0176))*IT_0187 + (conj(IT_0152)*IT_0166 + IT_0152*conj(IT_0166) + conj
      (IT_0149)*IT_0176 + IT_0149*conj(IT_0176))*IT_0188 + (-6)*conj(IT_0131)*
      (IT_0066*IT_0132 + IT_0137*IT_0189) + (-6)*((-0.166666666666667)*conj
      (IT_0131)*IT_0168 + conj(IT_0066)*IT_0184 + IT_0066*IT_0186 + IT_0171
      *IT_0189)*IT_0190;
