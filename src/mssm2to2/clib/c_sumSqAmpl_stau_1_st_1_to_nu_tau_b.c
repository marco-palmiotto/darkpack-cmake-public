...
ccomplex_return_t c_sumSqAmpl_stau_1_st_1_to_nu_tau_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = V_tb*e_em*conj(V_Wp1)*U_st_00;
    ...
    const ccomplex_t IT_0008 = m_t*V_tb*conj(V_u1)*e_em*IT_0007*U_st_10;
    ...
    const ccomplex_t IT_0027 = V_tb*e_em*conj(V_Wp2)*U_st_00;
    const ccomplex_t IT_0028 = IT_0001*IT_0027;
    const ccomplex_t IT_0029 = m_t*V_tb*conj(V_u2)*e_em*IT_0007*U_st_10;
    ...
    const ccomplex_t IT_0034 = e_em*conj(U_Wm2)*U_stau_00;
    const ccomplex_t IT_0035 = IT_0001*IT_0034;
    const ccomplex_t IT_0036 = conj(U_d2)*e_em*m_tau*IT_0007*U_stau_10;
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_b*U_d1*V_tb
      *e_em*IT_0001*IT_0007*IT_0016*U_st_00;
    ...
    return create_ccomplex_return(6*IT_0044*(s_34*conj(IT_0044) + -conj
      (IT_0055)*IT_0056) + (-6)*IT_0055*(conj(IT_0044)*IT_0056 + (
      -0.166666666666667)*conj(IT_0055)*(12*IT_0057 + (-6)*IT_0058)));
}
