        ...
        )
{
    ...
    const ccomplex_t IT_0002 = conj(N_B3)*e_em*U_st_01;
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = 1.4142135623731*IT_0003;
    const ccomplex_t IT_0005 = sin(theta_W);
    const ccomplex_t IT_0006 = cpow(IT_0005, -1);
    const ccomplex_t IT_0007 = conj(N_W3)*e_em*U_st_01;
    ...
    const ccomplex_t IT_0014 = m_t*conj(N_u3)*e_em*IT_0013*U_st_11;
    ...
    const ccomplex_t IT_0019 = N_B3*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0025 = N_d3*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0042 = m_t*conj(N_u4)*e_em*IT_0013*U_st_11;
    ...
    const ccomplex_t IT_0047 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0048 = IT_0001*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = N_d4*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0071 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0072 = IT_0001*IT_0071;
    const ccomplex_t IT_0073 = 1.4142135623731*IT_0072;
    const ccomplex_t IT_0074 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0082 = cpow(s_13 + (-0.5)*IT_0031 + (-0.5)*IT_0032 +
       0.5*m_N_2*(m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0083 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0084 = IT_0001*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = conj(N_W2)*e_em*U_st_01;
    const ccomplex_t IT_0087 = IT_0006*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = m_t*conj(N_u2)*e_em*IT_0013*U_st_11;
    ...
    const ccomplex_t IT_0094 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0095 = IT_0001*IT_0094;
    const ccomplex_t IT_0096 = 1.4142135623731*IT_0095;
    const ccomplex_t IT_0097 = N_d2*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0109 = m_t*N_u4*e_em*IT_0013*U_st_01;
    ...
    const ccomplex_t IT_0128 = N_B1*e_em*U_st_11;
    const ccomplex_t IT_0129 = IT_0001*IT_0128;
    const ccomplex_t IT_0130 = 1.4142135623731*IT_0129;
    const ccomplex_t IT_0131 = m_t*N_u1*e_em*IT_0013*U_st_01;
    ...
    const ccomplex_t IT_0148 = IT_0059*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*IT_0148;
    const ccomplex_t IT_0150 = N_B2*e_em*U_st_11;
    const ccomplex_t IT_0151 = IT_0001*IT_0150;
    const ccomplex_t IT_0152 = 1.4142135623731*IT_0151;
    const ccomplex_t IT_0153 = m_t*N_u2*e_em*IT_0013*U_st_01;
    ...
    const ccomplex_t IT_0170 = IT_0082*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*IT_0170;
    const ccomplex_t IT_0172 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0173 = IT_0001*IT_0172;
    const ccomplex_t IT_0174 = 1.4142135623731*IT_0173;
    const ccomplex_t IT_0175 = m_t*N_u3*e_em*IT_0013*U_st_01;
    ...
    const ccomplex_t IT_0201 = m_t*s_13;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0203 = IT_0018*IT_0190;
    ...
    const ccomplex_t IT_0207 = m_tau*IT_0104;
    const ccomplex_t IT_0208 = m_tau*IT_0081;
    const ccomplex_t IT_0209 = (-0.5)*IT_0204 + 0.5*IT_0205 + 0.5*IT_0206 +
       0.5*IT_0207 + 0.5*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0211 = IT_0046*IT_0124;
    const ccomplex_t IT_0212 = IT_0056*IT_0210*IT_0211;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0214 = IT_0070*IT_0146;
    const ccomplex_t IT_0215 = IT_0059*IT_0213*IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0217 = IT_0093*IT_0168;
    const ccomplex_t IT_0218 = IT_0082*IT_0216*IT_0217;
    const ccomplex_t IT_0219 = 0.5*IT_0212 + 0.5*IT_0215 + 0.5*IT_0218;
    const ccomplex_t IT_0220 = IT_0209 + -IT_0219;
    const ccomplex_t IT_0221 = -conj(IT_0219);
    const ccomplex_t IT_0222 = conj(IT_0209) + IT_0221;
    const ccomplex_t IT_0223 = IT_0054*IT_0113;
    const ccomplex_t IT_0224 = IT_0056*IT_0210*IT_0223;
    const ccomplex_t IT_0225 = m_tau*IT_0127;
    const ccomplex_t IT_0226 = IT_0078*IT_0135;
    const ccomplex_t IT_0227 = IT_0059*IT_0213*IT_0226;
    const ccomplex_t IT_0228 = m_tau*IT_0149;
    const ccomplex_t IT_0229 = m_tau*IT_0171;
    const ccomplex_t IT_0230 = m_tau*IT_0193;
    const ccomplex_t IT_0231 = (-0.5)*IT_0224 + 0.5*IT_0225 + (-0.5)*IT_0227 +
       0.5*IT_0228 + 0.5*IT_0229 + 0.5*IT_0230;
    const ccomplex_t IT_0232 = 6*IT_0231;
    const ccomplex_t IT_0233 = IT_0101*IT_0157;
    const ccomplex_t IT_0234 = IT_0082*IT_0216*IT_0233;
    const ccomplex_t IT_0235 = IT_0029*IT_0179;
    const ccomplex_t IT_0236 = IT_0033*IT_0202*IT_0235;
    const ccomplex_t IT_0237 = 0.5*IT_0234 + 0.5*IT_0236;
    const ccomplex_t IT_0238 = (-6)*IT_0237;
    const ccomplex_t IT_0239 = IT_0232 + IT_0238;
    const ccomplex_t IT_0240 = 6*conj(IT_0231);
    const ccomplex_t IT_0241 = (-6)*conj(IT_0237);
    const ccomplex_t IT_0242 = IT_0240 + IT_0241;
    const ccomplex_t IT_0243 = m_t*m_tau;
    const ccomplex_t IT_0244 = 6*IT_0237;
    const ccomplex_t IT_0245 = (-6)*IT_0231;
    const ccomplex_t IT_0246 = IT_0244 + IT_0245;
    const ccomplex_t IT_0247 = 6*conj(IT_0237);
    const ccomplex_t IT_0248 = (-6)*conj(IT_0231);
    ...
    const ccomplex_t IT_0254 = (-6)*conj(IT_0105)*(IT_0194*IT_0195 + (
      -0.166666666666667)*IT_0105*IT_0200) + 6*IT_0201*(conj(IT_0194)*IT_0220 +
       IT_0194*IT_0222 + 0.166666666666667*conj(IT_0105)*IT_0239 +
       0.166666666666667*IT_0105*IT_0242) + IT_0243*(conj(IT_0219)*IT_0239 +
       IT_0219*IT_0242 + conj(IT_0209)*IT_0246 + IT_0209*IT_0249) + (IT_0209
      *conj(IT_0209) + IT_0219*conj(IT_0219) + IT_0231*conj(IT_0231) + IT_0237
      *conj(IT_0237))*IT_0250 + (conj(IT_0209)*IT_0219 + IT_0209*conj(IT_0219) +
       conj(IT_0231)*IT_0237 + IT_0231*conj(IT_0237))*IT_0251 + (-6)*conj
      (IT_0194)*(IT_0105*IT_0195 + IT_0200*IT_0252) + (-6)*(conj(IT_0105)
      *IT_0220 + IT_0105*IT_0222 + (-0.166666666666667)*conj(IT_0194)*IT_0246 +
       IT_0249*IT_0252)*IT_0253;
