...
ccomplex_return_t c_sumSqAmpl_stau_1_st_2_to_tau_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = conj(N_B2)*e_em*U_st_01;
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = 1.4142135623731*IT_0003;
    const ccomplex_t IT_0005 = sin(theta_W);
    const ccomplex_t IT_0006 = cpow(IT_0005, -1);
    const ccomplex_t IT_0007 = conj(N_W2)*e_em*U_st_01;
    ...
    const ccomplex_t IT_0014 = m_t*conj(N_u2)*e_em*IT_0013*U_st_11;
    ...
    const ccomplex_t IT_0025 = N_d2*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0031 = pow(m_tau, 2);
    ...
    const ccomplex_t IT_0047 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0048 = IT_0001*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = N_d3*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0070 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0071 = IT_0001*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = N_d4*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0093 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0094 = IT_0001*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = N_d1*e_em*m_tau*IT_0013*U_stau_00;
    ...
    const ccomplex_t IT_0102 = cpow(s_13 + (-0.5)*IT_0031 + (-0.5)*IT_0032 +
       0.5*m_N_1*(m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0103 = IT_0101*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1)*IT_0103;
    const ccomplex_t IT_0105 = 0.5*IT_0035 + 0.5*IT_0058 + 0.5*IT_0081 + 0.5
      *IT_0104;
    ...
    const ccomplex_t IT_0109 = m_t*N_u2*e_em*IT_0013*U_st_01;
    ...
    const ccomplex_t IT_0131 = m_t*N_u3*e_em*IT_0013*U_st_01;
    ...
    const ccomplex_t IT_0150 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0151 = IT_0001*IT_0150;
    const ccomplex_t IT_0152 = 1.4142135623731*IT_0151;
    const ccomplex_t IT_0153 = m_t*N_u4*e_em*IT_0013*U_st_01;
    ...
    const ccomplex_t IT_0186 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_10;
    ...
    const ccomplex_t IT_0194 = 0.5*IT_0127 + 0.5*IT_0149 + 0.5*IT_0171 + 0.5
      *IT_0193;
    const ccomplex_t IT_0195 = m_t*m_tau*IT_0032;
    const ccomplex_t IT_0196 = s_34*IT_0032;
    ...
    const ccomplex_t IT_0201 = m_t*m_tau;
    const ccomplex_t IT_0202 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0203 = IT_0018*IT_0124;
    const ccomplex_t IT_0204 = IT_0033*IT_0202*IT_0203;
    const ccomplex_t IT_0205 = m_tau*IT_0035;
    const ccomplex_t IT_0206 = m_tau*IT_0058;
    const ccomplex_t IT_0207 = m_tau*IT_0081;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0209 = IT_0046*IT_0146;
    const ccomplex_t IT_0210 = IT_0056*IT_0208*IT_0209;
    const ccomplex_t IT_0211 = m_tau*IT_0104;
    const ccomplex_t IT_0212 = (-0.5)*IT_0204 + 0.5*IT_0205 + 0.5*IT_0206 +
       0.5*IT_0207 + (-0.5)*IT_0210 + 0.5*IT_0211;
    const ccomplex_t IT_0213 = IT_0029*IT_0113;
    const ccomplex_t IT_0214 = IT_0033*IT_0202*IT_0213;
    const ccomplex_t IT_0215 = 0.5*IT_0214;
    const ccomplex_t IT_0216 = 6*IT_0215;
    const ccomplex_t IT_0217 = IT_0054*IT_0135;
    const ccomplex_t IT_0218 = IT_0056*IT_0208*IT_0217;
    const ccomplex_t IT_0219 = IT_0077*IT_0157;
    const ccomplex_t IT_0220 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0221 = IT_0079*IT_0219*IT_0220;
    const ccomplex_t IT_0222 = m_tau*IT_0127;
    const ccomplex_t IT_0223 = m_tau*IT_0149;
    const ccomplex_t IT_0224 = m_tau*IT_0193;
    const ccomplex_t IT_0225 = m_tau*IT_0171;
    const ccomplex_t IT_0226 = IT_0100*IT_0179;
    const ccomplex_t IT_0227 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0228 = IT_0102*IT_0226*IT_0227;
    const ccomplex_t IT_0229 = (-0.5)*IT_0218 + (-0.5)*IT_0221 + 0.5*IT_0222 +
       0.5*IT_0223 + 0.5*IT_0224 + 0.5*IT_0225 + (-0.5)*IT_0228;
    const ccomplex_t IT_0230 = (-6)*IT_0229;
    const ccomplex_t IT_0231 = IT_0216 + IT_0230;
    const ccomplex_t IT_0232 = 6*conj(IT_0215);
    const ccomplex_t IT_0233 = (-6)*conj(IT_0229);
    const ccomplex_t IT_0234 = IT_0232 + IT_0233;
    const ccomplex_t IT_0235 = IT_0092*IT_0190;
    const ccomplex_t IT_0236 = IT_0102*IT_0227*IT_0235;
    const ccomplex_t IT_0237 = IT_0069*IT_0168;
    const ccomplex_t IT_0238 = IT_0079*IT_0220*IT_0237;
    const ccomplex_t IT_0239 = 0.5*IT_0236 + 0.5*IT_0238;
    const ccomplex_t IT_0240 = 6*IT_0229;
    const ccomplex_t IT_0241 = (-6)*IT_0215;
    const ccomplex_t IT_0242 = IT_0240 + IT_0241;
    const ccomplex_t IT_0243 = 6*conj(IT_0229);
    const ccomplex_t IT_0244 = (-6)*conj(IT_0215);
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = m_t*s_13;
    const ccomplex_t IT_0247 = IT_0212 + -IT_0239;
    const ccomplex_t IT_0248 = -conj(IT_0239);
    const ccomplex_t IT_0249 = conj(IT_0212) + IT_0248;
    const ccomplex_t IT_0250 = 6*s_34;
    const ccomplex_t IT_0251 = (-6)*s_34;
    const ccomplex_t IT_0252 = (-0.166666666666667)*IT_0194;
    const ccomplex_t IT_0253 = s_14*m_tau;
    const ccomplex_t IT_0254 = (-6)*conj(IT_0105)*(IT_0194*IT_0195 + (
      -0.166666666666667)*IT_0105*IT_0200) + IT_0201*(conj(IT_0212)*IT_0231 +
       IT_0212*IT_0234 + conj(IT_0239)*IT_0242 + IT_0239*IT_0245) + 6*IT_0246*
      (0.166666666666667*conj(IT_0105)*IT_0242 + 0.166666666666667*IT_0105
      *IT_0245 + conj(IT_0194)*IT_0247 + IT_0194*IT_0249) + (IT_0212*conj
      (IT_0212) + IT_0215*conj(IT_0215) + IT_0229*conj(IT_0229) + IT_0239*conj
      (IT_0239))*IT_0250 + (conj(IT_0215)*IT_0229 + IT_0215*conj(IT_0229) + conj
      (IT_0212)*IT_0239 + IT_0212*conj(IT_0239))*IT_0251 + (-6)*conj(IT_0194)*
      (IT_0105*IT_0195 + IT_0200*IT_0252) + (-6)*((-0.166666666666667)*conj
      (IT_0194)*IT_0231 + conj(IT_0105)*IT_0247 + IT_0105*IT_0249 + IT_0234
      *IT_0252)*IT_0253;
