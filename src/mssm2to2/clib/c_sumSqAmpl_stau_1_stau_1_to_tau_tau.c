        ...
        )
{
    ...
    const ccomplex_t IT_0002 = N_B1*e_em*U_stau_10;
    ...
    const ccomplex_t IT_0011 = N_d1*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0022 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0023 = IT_0001*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = N_d2*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0034 = cpow(s_23 + (-0.5)*IT_0018 + (-0.5)*IT_0019 +
       0.5*m_N_2*(m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0035 = IT_0031*IT_0034;
    const ccomplex_t IT_0036 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0037 = IT_0001*IT_0036;
    const ccomplex_t IT_0038 = 1.4142135623731*IT_0037;
    const ccomplex_t IT_0039 = N_d3*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_N_3*IT_0044;
    ...
    const ccomplex_t IT_0048 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0049 = IT_0001*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = N_d4*e_em*m_tau*IT_0010*U_stau_00;
    ...
    const ccomplex_t IT_0058 = cpow(s_13 + (-0.5)*IT_0018 + (-0.5)*IT_0019 +
       0.5*m_N_4*(m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = 0.5*IT_0021 + 0.5*IT_0033 + 0.5*IT_0035 + 0.5
      *IT_0047 + 0.5*IT_0059;
    const ccomplex_t IT_0061 = cpow(s_23 + (-0.5)*IT_0018 + (-0.5)*IT_0019 +
       0.5*m_N_1*(m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0017*IT_0061;
    const ccomplex_t IT_0063 = cpow(s_13 + (-0.5)*IT_0018 + (-0.5)*IT_0019 +
       0.5*m_N_3*(m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0064 = IT_0045*IT_0063;
    const ccomplex_t IT_0065 = cpow(s_23 + (-0.5)*IT_0018 + (-0.5)*IT_0019 +
       0.5*m_N_4*(m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0057*IT_0065;
    const ccomplex_t IT_0067 = conj(N_B1)*e_em*U_stau_00;
    const ccomplex_t IT_0068 = IT_0001*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = conj(N_W1)*e_em*U_stau_00;
    const ccomplex_t IT_0071 = IT_0008*IT_0070;
    const ccomplex_t IT_0072 = 1.4142135623731*IT_0071;
    const ccomplex_t IT_0073 = conj(N_d1)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0082 = IT_0061*IT_0078;
    ...
    const ccomplex_t IT_0091 = conj(N_d2)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0100 = IT_0034*IT_0096;
    ...
    const ccomplex_t IT_0109 = conj(N_d3)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0114 = IT_0043*IT_0113;
    ...
    const ccomplex_t IT_0127 = conj(N_d4)*e_em*m_tau*IT_0010*U_stau_10;
    ...
    const ccomplex_t IT_0136 = IT_0065*IT_0132;
    ...
    const ccomplex_t IT_0142 = IT_0061*IT_0141;
    const ccomplex_t IT_0143 = IT_0020*IT_0141;
    const ccomplex_t IT_0144 = cpow(IT_0095, 2);
    const ccomplex_t IT_0145 = (0 + _Complex_I*1)*m_N_2*IT_0144;
    const ccomplex_t IT_0146 = IT_0032*IT_0145;
    const ccomplex_t IT_0147 = cpow(IT_0113, 2);
    ...
    const ccomplex_t IT_0152 = IT_0065*IT_0151;
    const ccomplex_t IT_0153 = IT_0058*IT_0151;
    const ccomplex_t IT_0154 = 0.5*IT_0142 + 0.5*IT_0143 + 0.5*IT_0146 + 0.5
      *IT_0149 + 0.5*IT_0152 + 0.5*IT_0153;
    const ccomplex_t IT_0155 = IT_0034*IT_0145;
    const ccomplex_t IT_0156 = IT_0046*IT_0148;
    ...
    const ccomplex_t IT_0162 = IT_0154 + -IT_0157;
    ...
    const ccomplex_t IT_0176 = conj(IT_0154) + IT_0175;
    ...
    const ccomplex_t IT_0178 = (IT_0060*conj(IT_0060) + IT_0139*conj(IT_0139) 
      + IT_0154*conj(IT_0154) + IT_0157*conj(IT_0157))*IT_0158 + (conj(IT_0060)
      *IT_0139 + IT_0060*conj(IT_0139) + conj(IT_0154)*IT_0157 + IT_0154*conj
      (IT_0157))*IT_0159 + (-2)*conj(IT_0160)*(IT_0161*(IT_0162 + (-0.5)*IT_0163
       + (-0.5)*IT_0164) + -IT_0165*(IT_0162 + 0.5*IT_0166 + 0.5*IT_0167)) +
       IT_0018*(conj(IT_0154)*(IT_0163 + IT_0164) + conj(IT_0157)*(IT_0166 +
       IT_0167) + IT_0154*(IT_0168 + IT_0169) + IT_0157*(IT_0170 + IT_0171)) +
       IT_0177;
