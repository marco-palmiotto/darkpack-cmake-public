        ...
        )
{
    ...
    const ccomplex_t IT_0022 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0023 = IT_0004*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = N_d1*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0034 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0035 = IT_0004*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_W2)*e_em*U_stau_00;
    const ccomplex_t IT_0038 = IT_0009*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = conj(N_d2)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0045 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0046 = IT_0004*IT_0045;
    const ccomplex_t IT_0047 = 1.4142135623731*IT_0046;
    const ccomplex_t IT_0048 = N_d2*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0068 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0069 = IT_0004*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = N_d3*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0079 = pow(m_stau_2, 2);
    const ccomplex_t IT_0080 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0079 +
       0.5*m_N_1*(m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0087 = conj(N_d1)*e_em*m_tau*IT_0016*U_stau_11;
    ...
    const ccomplex_t IT_0095 = N_d1*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0103 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0079 +
       0.5*m_N_2*(m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0104 = N_B2*e_em*U_stau_10;
    const ccomplex_t IT_0105 = IT_0004*IT_0104;
    const ccomplex_t IT_0106 = 1.4142135623731*IT_0105;
    const ccomplex_t IT_0107 = N_d2*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0126 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0079 +
       0.5*m_N_3*(m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0127 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0128 = IT_0004*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = N_d3*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0149 = cpow(s_23 + (-0.5)*IT_0000 + (-0.5)*IT_0079 +
       0.5*m_N_4*(m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0150 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0151 = IT_0004*IT_0150;
    const ccomplex_t IT_0152 = 1.4142135623731*IT_0151;
    const ccomplex_t IT_0153 = N_d4*e_em*m_tau*IT_0016*U_stau_00;
    ...
    const ccomplex_t IT_0172 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
       0.5*m_N_4*(m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0173 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0174 = IT_0004*IT_0173;
    const ccomplex_t IT_0175 = 1.4142135623731*IT_0174;
    const ccomplex_t IT_0176 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0177 = IT_0009*IT_0176;
    const ccomplex_t IT_0178 = 1.4142135623731*IT_0177;
    const ccomplex_t IT_0179 = conj(N_d4)*e_em*m_tau*IT_0016*U_stau_10;
    ...
    const ccomplex_t IT_0184 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0185 = IT_0004*IT_0184;
    const ccomplex_t IT_0186 = 1.4142135623731*IT_0185;
    const ccomplex_t IT_0187 = N_d4*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0192 = IT_0183*IT_0191;
    const ccomplex_t IT_0193 = IT_0172*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*IT_0193;
    const ccomplex_t IT_0195 = 0.5*IT_0032 + 0.5*IT_0055 + 0.5*IT_0078 + (-0.5
      )*IT_0102 + (-0.5)*IT_0125 + (-0.5)*IT_0148 + (-0.5)*IT_0171 + 0.5*IT_0194;
    const ccomplex_t IT_0196 = IT_0169*IT_0172;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*IT_0196;
    const ccomplex_t IT_0198 = IT_0002*IT_0100;
    const ccomplex_t IT_0199 = (0 + _Complex_I*1)*IT_0198;
    const ccomplex_t IT_0200 = IT_0033*IT_0123;
    const ccomplex_t IT_0201 = (0 + _Complex_I*1)*IT_0200;
    const ccomplex_t IT_0202 = IT_0056*IT_0146;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*IT_0202;
    const ccomplex_t IT_0204 = IT_0030*IT_0080;
    const ccomplex_t IT_0205 = (0 + _Complex_I*1)*IT_0204;
    const ccomplex_t IT_0206 = IT_0076*IT_0126;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*IT_0206;
    const ccomplex_t IT_0208 = IT_0149*IT_0192;
    const ccomplex_t IT_0209 = (0 + _Complex_I*1)*IT_0208;
    const ccomplex_t IT_0210 = IT_0053*IT_0103;
    ...
    const ccomplex_t IT_0212 = 0.5*IT_0197 + 0.5*IT_0199 + 0.5*IT_0201 + 0.5
      ...
      *IT_0211;
    const ccomplex_t IT_0213 = IT_0000*IT_0079;
    const ccomplex_t IT_0214 = s_23*s_24;
    const ccomplex_t IT_0215 = s_34*IT_0079;
    const ccomplex_t IT_0216 = (-0.5)*IT_0215;
    const ccomplex_t IT_0217 = IT_0214 + IT_0216;
    const ccomplex_t IT_0218 = s_24*m_tau;
    const ccomplex_t IT_0219 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0220 = IT_0168*IT_0183;
    const ccomplex_t IT_0221 = IT_0149*IT_0219*IT_0220;
    const ccomplex_t IT_0222 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0223 = IT_0021*IT_0091;
    const ccomplex_t IT_0224 = IT_0080*IT_0222*IT_0223;
    const ccomplex_t IT_0225 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0226 = IT_0044*IT_0122;
    const ccomplex_t IT_0227 = IT_0033*IT_0225*IT_0226;
    const ccomplex_t IT_0228 = m_tau*IT_0205;
    const ccomplex_t IT_0229 = m_tau*IT_0032;
    const ccomplex_t IT_0230 = m_tau*IT_0055;
    const ccomplex_t IT_0231 = m_tau*IT_0207;
    const ccomplex_t IT_0232 = m_tau*IT_0078;
    const ccomplex_t IT_0233 = m_tau*IT_0209;
    const ccomplex_t IT_0234 = m_tau*IT_0194;
    const ccomplex_t IT_0235 = m_tau*IT_0211;
    const ccomplex_t IT_0236 = (-0.5)*IT_0221 + (-0.5)*IT_0224 + (-0.5)
      *IT_0227 + 0.5*IT_0228 + 0.5*IT_0229 + 0.5*IT_0230 + 0.5*IT_0231 + 0.5
      *IT_0232 + 0.5*IT_0233 + 0.5*IT_0234 + 0.5*IT_0235;
    const ccomplex_t IT_0237 = IT_0002*IT_0222*IT_0223;
    const ccomplex_t IT_0238 = IT_0103*IT_0225*IT_0226;
    const ccomplex_t IT_0239 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0240 = IT_0067*IT_0145;
    const ccomplex_t IT_0241 = IT_0056*IT_0239*IT_0240;
    const ccomplex_t IT_0242 = IT_0126*IT_0239*IT_0240;
    const ccomplex_t IT_0243 = IT_0172*IT_0219*IT_0220;
    const ccomplex_t IT_0244 = 0.5*IT_0237 + 0.5*IT_0238 + 0.5*IT_0241 + 0.5
      *IT_0242 + 0.5*IT_0243;
    ...
    const ccomplex_t IT_0248 = IT_0157*IT_0191;
    const ccomplex_t IT_0249 = IT_0172*IT_0219*IT_0248;
    const ccomplex_t IT_0250 = m_tau*IT_0201;
    const ccomplex_t IT_0251 = m_tau*IT_0125;
    const ccomplex_t IT_0252 = m_tau*IT_0203;
    const ccomplex_t IT_0253 = m_tau*IT_0148;
    const ccomplex_t IT_0254 = m_tau*IT_0197;
    const ccomplex_t IT_0255 = m_tau*IT_0171;
    const ccomplex_t IT_0256 = IT_0029*IT_0099;
    const ccomplex_t IT_0257 = IT_0002*IT_0222*IT_0256;
    const ccomplex_t IT_0258 = IT_0052*IT_0111;
    const ccomplex_t IT_0259 = IT_0103*IT_0225*IT_0258;
    const ccomplex_t IT_0260 = m_tau*IT_0199;
    const ccomplex_t IT_0261 = m_tau*IT_0102;
    const ccomplex_t IT_0262 = (-0.5)*IT_0249 + 0.5*IT_0250 + 0.5*IT_0251 +
       0.5*IT_0252 + 0.5*IT_0253 + 0.5*IT_0254 + 0.5*IT_0255 + (-0.5)*IT_0257 + 
      (-0.5)*IT_0259 + 0.5*IT_0260 + 0.5*IT_0261;
    const ccomplex_t IT_0263 = 2*IT_0262;
    const ccomplex_t IT_0264 = IT_0075*IT_0134;
    const ccomplex_t IT_0265 = IT_0056*IT_0239*IT_0264;
    const ccomplex_t IT_0266 = IT_0126*IT_0239*IT_0264;
    const ccomplex_t IT_0267 = IT_0149*IT_0219*IT_0248;
    const ccomplex_t IT_0268 = IT_0080*IT_0222*IT_0256;
    const ccomplex_t IT_0269 = IT_0033*IT_0225*IT_0258;
    const ccomplex_t IT_0270 = 0.5*IT_0265 + 0.5*IT_0266 + 0.5*IT_0267 + 0.5
      *IT_0268 + 0.5*IT_0269;
    const ccomplex_t IT_0271 = (-2)*IT_0270;
    const ccomplex_t IT_0272 = IT_0263 + IT_0271;
    const ccomplex_t IT_0273 = 2*conj(IT_0262);
    const ccomplex_t IT_0274 = (-2)*conj(IT_0270);
    const ccomplex_t IT_0275 = IT_0273 + IT_0274;
    const ccomplex_t IT_0276 = 2*IT_0270;
    const ccomplex_t IT_0277 = (-2)*IT_0262;
    const ccomplex_t IT_0278 = IT_0276 + IT_0277;
    const ccomplex_t IT_0279 = 2*conj(IT_0270);
    const ccomplex_t IT_0280 = (-2)*conj(IT_0262);
    const ccomplex_t IT_0281 = IT_0279 + IT_0280;
    const ccomplex_t IT_0282 = s_23*m_tau;
    ...
    const ccomplex_t IT_0285 = (-2)*conj(IT_0195)*(IT_0212*IT_0213 + (-2)
      ...
      *IT_0217) + 2*IT_0218*(conj(IT_0212)*IT_0245 + IT_0212*IT_0247 + 0.5*conj
      (IT_0195)*IT_0272 + 0.5*IT_0195*IT_0275) + IT_0000*(conj(IT_0244)*IT_0272 
      + IT_0244*IT_0275 + conj(IT_0236)*IT_0278 + IT_0236*IT_0281) + (-2)*(conj
      (IT_0195)*IT_0245 + IT_0195*IT_0247 + (-0.5)*conj(IT_0212)*IT_0278 + (-0.5
      )*IT_0212*IT_0281)*IT_0282 + (IT_0236*conj(IT_0236) + IT_0244*conj(IT_0244
      ) + IT_0262*conj(IT_0262) + IT_0270*conj(IT_0270))*IT_0283 + (conj(IT_0236
      )*IT_0244 + IT_0236*conj(IT_0244) + conj(IT_0262)*IT_0270 + IT_0262*conj
      (IT_0270))*IT_0284;
