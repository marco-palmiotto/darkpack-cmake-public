...
ccomplex_return_t c_sumSqAmpl_stau_1_su_L_to_tau_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0006 = (-0.5)*IT_0005;
    const ccomplex_t IT_0007 = cos(theta_W);
    const ccomplex_t IT_0008 = cpow(IT_0007, -1);
    const ccomplex_t IT_0009 = conj(N_B2)*e_em*U_stau_00;
    const ccomplex_t IT_0010 = IT_0008*IT_0009;
    const ccomplex_t IT_0011 = 1.4142135623731*IT_0010;
    const ccomplex_t IT_0012 = conj(N_W2)*e_em*U_stau_00;
    ...
    const ccomplex_t IT_0018 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = conj(N_B3)*e_em*U_stau_00;
    const ccomplex_t IT_0032 = IT_0008*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W3)*e_em*U_stau_00;
    const ccomplex_t IT_0035 = IT_0004*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_d3)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0047 = (-0.5)*IT_0046;
    const ccomplex_t IT_0048 = conj(N_B4)*e_em*U_stau_00;
    const ccomplex_t IT_0049 = IT_0008*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W4)*e_em*U_stau_00;
    const ccomplex_t IT_0052 = IT_0004*IT_0051;
    const ccomplex_t IT_0053 = 1.4142135623731*IT_0052;
    const ccomplex_t IT_0054 = conj(N_d4)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0063 = cpow(s_13 + (-0.5)*IT_0024 + (-0.5)*IT_0025 +
       0.5*m_N_1*(m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0072 = conj(N_d1)*e_em*m_tau*IT_0000*U_stau_10;
    ...
    const ccomplex_t IT_0092 = N_d2*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0100 = N_B3*e_em*U_stau_10;
    const ccomplex_t IT_0101 = IT_0008*IT_0100;
    const ccomplex_t IT_0102 = 1.4142135623731*IT_0101;
    const ccomplex_t IT_0103 = N_d3*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0127 = N_B4*e_em*U_stau_10;
    const ccomplex_t IT_0128 = IT_0008*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = N_d4*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0146 = N_B1*e_em*U_stau_10;
    const ccomplex_t IT_0147 = IT_0008*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = N_d1*e_em*m_tau*IT_0000*U_stau_00;
    ...
    const ccomplex_t IT_0155 = IT_0063*IT_0154;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*IT_0155;
    const ccomplex_t IT_0157 = 0.5*IT_0099 + 0.5*IT_0118 + 0.5*IT_0137 + 0.5
      *IT_0156;
    const ccomplex_t IT_0158 = pow(m_su_L, 2);
    const ccomplex_t IT_0159 = m_u*m_tau*IT_0158;
    const ccomplex_t IT_0160 = s_34*IT_0158;
    const ccomplex_t IT_0161 = (-6)*IT_0160;
    const ccomplex_t IT_0162 = s_23*s_24;
    const ccomplex_t IT_0163 = 12*IT_0162;
    const ccomplex_t IT_0164 = IT_0161 + IT_0163;
    const ccomplex_t IT_0165 = m_u*s_23;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0167 = IT_0076*IT_0145;
    const ccomplex_t IT_0168 = IT_0063*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0170 = IT_0022*IT_0088;
    const ccomplex_t IT_0171 = IT_0026*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0173 = IT_0058*IT_0126;
    const ccomplex_t IT_0174 = IT_0060*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = 0.5*IT_0168 + 0.5*IT_0171 + 0.5*IT_0174;
    const ccomplex_t IT_0176 = m_u*IT_0028;
    const ccomplex_t IT_0177 = m_u*IT_0045;
    const ccomplex_t IT_0178 = m_u*IT_0062;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0180 = IT_0041*IT_0115;
    const ccomplex_t IT_0181 = IT_0043*IT_0179*IT_0180;
    const ccomplex_t IT_0182 = m_u*IT_0079;
    const ccomplex_t IT_0183 = 0.5*IT_0176 + 0.5*IT_0177 + 0.5*IT_0178 + (-0.5
      )*IT_0181 + 0.5*IT_0182;
    const ccomplex_t IT_0184 = IT_0175 + -IT_0183;
    const ccomplex_t IT_0185 = -conj(IT_0183);
    const ccomplex_t IT_0186 = conj(IT_0175) + IT_0185;
    const ccomplex_t IT_0187 = IT_0006*IT_0096;
    const ccomplex_t IT_0188 = IT_0026*IT_0169*IT_0187;
    const ccomplex_t IT_0189 = IT_0030*IT_0107;
    const ccomplex_t IT_0190 = IT_0043*IT_0179*IT_0189;
    const ccomplex_t IT_0191 = 0.5*IT_0188 + 0.5*IT_0190;
    const ccomplex_t IT_0192 = 6*IT_0191;
    const ccomplex_t IT_0193 = IT_0047*IT_0134;
    const ccomplex_t IT_0194 = IT_0060*IT_0172*IT_0193;
    const ccomplex_t IT_0195 = m_u*IT_0099;
    const ccomplex_t IT_0196 = m_u*IT_0118;
    const ccomplex_t IT_0197 = m_u*IT_0137;
    const ccomplex_t IT_0198 = IT_0065*IT_0153;
    const ccomplex_t IT_0199 = IT_0063*IT_0166*IT_0198;
    const ccomplex_t IT_0200 = m_u*IT_0156;
    const ccomplex_t IT_0201 = (-0.5)*IT_0194 + 0.5*IT_0195 + 0.5*IT_0196 +
       0.5*IT_0197 + (-0.5)*IT_0199 + 0.5*IT_0200;
    const ccomplex_t IT_0202 = (-6)*IT_0201;
    const ccomplex_t IT_0203 = IT_0192 + IT_0202;
    const ccomplex_t IT_0204 = 6*conj(IT_0191);
    const ccomplex_t IT_0205 = (-6)*conj(IT_0201);
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = m_u*m_tau;
    const ccomplex_t IT_0208 = 6*IT_0201;
    const ccomplex_t IT_0209 = (-6)*IT_0191;
    const ccomplex_t IT_0210 = IT_0208 + IT_0209;
    const ccomplex_t IT_0211 = 6*conj(IT_0201);
    const ccomplex_t IT_0212 = (-6)*conj(IT_0191);
    const ccomplex_t IT_0213 = IT_0211 + IT_0212;
    const ccomplex_t IT_0214 = s_24*m_tau;
    const ccomplex_t IT_0215 = 6*s_34;
    const ccomplex_t IT_0216 = (-6)*s_34;
    const ccomplex_t IT_0217 = (-6)*conj(IT_0080)*(IT_0157*IT_0159 + (
      -0.166666666666667)*IT_0080*IT_0164) + (-6)*conj(IT_0157)*(IT_0080*IT_0159
       + (-0.166666666666667)*IT_0157*IT_0164) + 6*IT_0165*(conj(IT_0080)
      *IT_0184 + IT_0080*IT_0186 + 0.166666666666667*conj(IT_0157)*IT_0203 +
       0.166666666666667*IT_0157*IT_0206) + IT_0207*(conj(IT_0183)*IT_0203 +
       IT_0183*IT_0206 + conj(IT_0175)*IT_0210 + IT_0175*IT_0213) + (-6)*(conj
      (IT_0157)*IT_0184 + IT_0157*IT_0186 + (-0.166666666666667)*conj(IT_0080)
      *IT_0210 + (-0.166666666666667)*IT_0080*IT_0213)*IT_0214 + (IT_0175*conj
      (IT_0175) + IT_0183*conj(IT_0183) + IT_0191*conj(IT_0191) + IT_0201*conj
      (IT_0201))*IT_0215 + (conj(IT_0175)*IT_0183 + IT_0175*conj(IT_0183) + conj
      (IT_0191)*IT_0201 + IT_0191*conj(IT_0201))*IT_0216;
