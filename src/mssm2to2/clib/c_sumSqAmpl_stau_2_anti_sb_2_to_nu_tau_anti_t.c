...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_sb_2_to_nu_tau_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*conj
      (V_u1)*e_em*IT_0000*IT_0002*IT_0004*conj(U_sb_01);
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1.4142135623731)*m_t*V_tb*conj
      (V_u2)*e_em*IT_0000*IT_0002*IT_0004*conj(U_sb_01);
    ...
    const ccomplex_t IT_0034 = V_tb*e_em*U_Wm1*conj(U_sb_01);
    const ccomplex_t IT_0035 = IT_0004*IT_0034;
    const ccomplex_t IT_0036 = m_b*U_d1*V_tb*e_em*IT_0000*conj(U_sb_11);
    ...
    const ccomplex_t IT_0043 = V_tb*e_em*U_Wm2*conj(U_sb_01);
    const ccomplex_t IT_0044 = IT_0004*IT_0043;
    const ccomplex_t IT_0045 = m_b*U_d2*V_tb*e_em*IT_0000*conj(U_sb_11);
