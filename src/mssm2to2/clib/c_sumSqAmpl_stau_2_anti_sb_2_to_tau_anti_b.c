...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_sb_2_to_tau_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0043 = m_b*N_d2*e_em*IT_0016*conj(U_sb_11);
    ...
    const ccomplex_t IT_0060 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0069 = m_b*N_d3*e_em*IT_0016*conj(U_sb_11);
    ...
    const ccomplex_t IT_0112 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0115 = 0.5*IT_0036 + 0.5*IT_0062 + 0.5*IT_0088 + 0.5
      *IT_0114;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0117 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0118 = IT_0004*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = N_d1*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0126 = IT_0002*IT_0116*IT_0125;
    ...
    const ccomplex_t IT_0130 = N_d2*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0137 = IT_0060*IT_0135*IT_0136;
    const ccomplex_t IT_0138 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0139 = IT_0004*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = N_d3*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0148 = IT_0086*IT_0146*IT_0147;
    ...
    const ccomplex_t IT_0152 = N_d4*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0159 = IT_0112*IT_0157*IT_0158;
    const ccomplex_t IT_0160 = m_tau*IT_0036;
    const ccomplex_t IT_0161 = m_tau*IT_0062;
    const ccomplex_t IT_0162 = m_tau*IT_0088;
    const ccomplex_t IT_0163 = m_tau*IT_0114;
    const ccomplex_t IT_0164 = 0.5*IT_0126 + 0.5*IT_0137 + 0.5*IT_0148 + 0.5
      *IT_0159 + (-0.5)*IT_0160 + (-0.5)*IT_0161 + (-0.5)*IT_0162 + (-0.5)
      *IT_0163;
    const ccomplex_t IT_0165 = s_14*m_tau;
    const ccomplex_t IT_0166 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0167 = IT_0004*IT_0166;
    const ccomplex_t IT_0168 = 1.4142135623731*IT_0167;
    const ccomplex_t IT_0169 = m_b*conj(N_d2)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0177 = m_tau*IT_0176;
    const ccomplex_t IT_0178 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0179 = IT_0004*IT_0178;
    const ccomplex_t IT_0180 = 1.4142135623731*IT_0179;
    const ccomplex_t IT_0181 = m_b*conj(N_d3)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0189 = m_tau*IT_0188;
    const ccomplex_t IT_0190 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0191 = IT_0004*IT_0190;
    const ccomplex_t IT_0192 = 1.4142135623731*IT_0191;
    const ccomplex_t IT_0193 = m_b*conj(N_d4)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0198 = IT_0156*IT_0197;
    const ccomplex_t IT_0199 = IT_0112*IT_0198;
    const ccomplex_t IT_0200 = (0 + _Complex_I*1)*IT_0199;
    const ccomplex_t IT_0201 = m_tau*IT_0200;
    const ccomplex_t IT_0202 = IT_0084*IT_0185;
    const ccomplex_t IT_0203 = IT_0086*IT_0147*IT_0202;
    const ccomplex_t IT_0204 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0205 = IT_0004*IT_0204;
    const ccomplex_t IT_0206 = 1.4142135623731*IT_0205;
    const ccomplex_t IT_0207 = m_b*conj(N_d1)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0213 = IT_0002*IT_0116*IT_0212;
    const ccomplex_t IT_0214 = IT_0058*IT_0173;
    const ccomplex_t IT_0215 = IT_0060*IT_0136*IT_0214;
    const ccomplex_t IT_0216 = IT_0110*IT_0197;
    const ccomplex_t IT_0217 = IT_0112*IT_0158*IT_0216;
    const ccomplex_t IT_0218 = IT_0124*IT_0211;
    ...
    const ccomplex_t IT_0222 = (-0.5)*IT_0177 + (-0.5)*IT_0189 + (-0.5)
      *IT_0201 + 0.5*IT_0203 + 0.5*IT_0213 + 0.5*IT_0215 + 0.5*IT_0217 + (-0.5)
      *IT_0221;
    const ccomplex_t IT_0223 = m_b*s_13;
    const ccomplex_t IT_0224 = 0.5*IT_0176 + 0.5*IT_0188 + 0.5*IT_0200 + 0.5
      *IT_0220;
