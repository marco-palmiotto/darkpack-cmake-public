        ...
        )
{
    ...
    const ccomplex_t IT_0076 = m_b*N_d2*e_em*IT_0016*conj(U_sb_11);
    const ccomplex_t IT_0077 = IT_0015*IT_0076;
    const ccomplex_t IT_0078 = 1.4142135623731*IT_0077;
    const ccomplex_t IT_0079 = N_W2*e_em*conj(U_sb_01);
    ...
    const ccomplex_t IT_0092 = m_b*N_d3*e_em*IT_0016*conj(U_sb_11);
    ...
    const ccomplex_t IT_0118 = 0.5*IT_0036 + 0.5*IT_0063 + 0.5*IT_0090 + 0.5
      *IT_0117;
    const ccomplex_t IT_0119 = m_tau*IT_0090;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0121 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0122 = IT_0004*IT_0121;
    const ccomplex_t IT_0123 = 1.4142135623731*IT_0122;
    const ccomplex_t IT_0124 = N_d1*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0130 = IT_0002*IT_0120*IT_0129;
    const ccomplex_t IT_0131 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0132 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0133 = IT_0004*IT_0132;
    const ccomplex_t IT_0134 = 1.4142135623731*IT_0133;
    const ccomplex_t IT_0135 = N_d2*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0141 = IT_0064*IT_0131*IT_0140;
    const ccomplex_t IT_0142 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0143 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0144 = IT_0004*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = N_d3*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0152 = IT_0091*IT_0142*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0154 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0155 = IT_0004*IT_0154;
    const ccomplex_t IT_0156 = 1.4142135623731*IT_0155;
    const ccomplex_t IT_0157 = N_d4*e_em*m_tau*IT_0016*U_stau_01;
    ...
    const ccomplex_t IT_0163 = IT_0037*IT_0153*IT_0162;
    const ccomplex_t IT_0164 = m_tau*IT_0036;
    const ccomplex_t IT_0165 = m_tau*IT_0117;
    const ccomplex_t IT_0166 = m_tau*IT_0063;
    const ccomplex_t IT_0167 = (-0.5)*IT_0119 + 0.5*IT_0130 + 0.5*IT_0141 +
       0.5*IT_0152 + 0.5*IT_0163 + (-0.5)*IT_0164 + (-0.5)*IT_0165 + (-0.5)
      *IT_0166;
    const ccomplex_t IT_0168 = s_14*m_tau;
    const ccomplex_t IT_0169 = conj(N_B3)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0170 = IT_0004*IT_0169;
    const ccomplex_t IT_0171 = 1.4142135623731*IT_0170;
    const ccomplex_t IT_0172 = m_b*conj(N_d3)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0177 = IT_0150*IT_0176;
    ...
    const ccomplex_t IT_0181 = IT_0114*IT_0176;
    const ccomplex_t IT_0182 = IT_0091*IT_0142*IT_0181;
    const ccomplex_t IT_0183 = conj(N_B1)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0184 = IT_0004*IT_0183;
    const ccomplex_t IT_0185 = 1.4142135623731*IT_0184;
    const ccomplex_t IT_0186 = m_b*conj(N_d1)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0192 = IT_0002*IT_0120*IT_0191;
    const ccomplex_t IT_0193 = conj(N_B2)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0194 = IT_0004*IT_0193;
    const ccomplex_t IT_0195 = 1.4142135623731*IT_0194;
    const ccomplex_t IT_0196 = m_b*conj(N_d2)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0202 = IT_0064*IT_0131*IT_0201;
    const ccomplex_t IT_0203 = conj(N_B4)*e_em*conj(U_sb_11);
    const ccomplex_t IT_0204 = IT_0004*IT_0203;
    const ccomplex_t IT_0205 = 1.4142135623731*IT_0204;
    const ccomplex_t IT_0206 = m_b*conj(N_d4)*e_em*IT_0016*conj(U_sb_01);
    ...
    const ccomplex_t IT_0212 = IT_0037*IT_0153*IT_0211;
    const ccomplex_t IT_0213 = IT_0128*IT_0190;
    const ccomplex_t IT_0214 = IT_0002*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*IT_0214;
    const ccomplex_t IT_0216 = m_tau*IT_0215;
    const ccomplex_t IT_0217 = IT_0139*IT_0200;
    ...
    const ccomplex_t IT_0221 = IT_0161*IT_0210;
    ...
    const ccomplex_t IT_0225 = (-0.5)*IT_0180 + 0.5*IT_0182 + 0.5*IT_0192 +
       0.5*IT_0202 + 0.5*IT_0212 + (-0.5)*IT_0216 + (-0.5)*IT_0220 + (-0.5)
      *IT_0224;
    const ccomplex_t IT_0226 = m_b*s_13;
    const ccomplex_t IT_0227 = 0.5*IT_0179 + 0.5*IT_0215 + 0.5*IT_0219 + 0.5
      *IT_0223;
