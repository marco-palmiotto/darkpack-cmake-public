...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_sc_L_to_tau_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = 1.4142135623731*IT_0013;
    const ccomplex_t IT_0015 = conj(N_W1)*e_em*U_stau_01;
    ...
    const ccomplex_t IT_0022 = conj(N_d1)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0041 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0042 = IT_0001*IT_0041;
    const ccomplex_t IT_0043 = 1.4142135623731*IT_0042;
    const ccomplex_t IT_0044 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0045 = IT_0006*IT_0044;
    const ccomplex_t IT_0046 = 1.4142135623731*IT_0045;
    const ccomplex_t IT_0047 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0053 = cpow(s_13 + (-0.5)*IT_0028 + (-0.5)*IT_0029 +
    ...
    const ccomplex_t IT_0064 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0068 = IT_0006*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = conj(N_d3)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0093 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0099 = cpow(s_13 + (-0.5)*IT_0028 + (-0.5)*IT_0029 +
    ...
    const ccomplex_t IT_0102 = 0.5*IT_0032 + 0.5*IT_0055 + 0.5*IT_0078 + 0.5
      *IT_0101;
    const ccomplex_t IT_0103 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0104 = IT_0001*IT_0103;
    const ccomplex_t IT_0105 = 1.4142135623731*IT_0104;
    const ccomplex_t IT_0106 = N_d2*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0113 = IT_0053*IT_0111*IT_0112;
    const ccomplex_t IT_0114 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0115 = IT_0001*IT_0114;
    const ccomplex_t IT_0116 = 1.4142135623731*IT_0115;
    const ccomplex_t IT_0117 = N_d3*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0125 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0126 = IT_0001*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = N_d4*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0135 = IT_0099*IT_0133*IT_0134;
    const ccomplex_t IT_0136 = m_tau*IT_0032;
    const ccomplex_t IT_0137 = m_tau*IT_0055;
    const ccomplex_t IT_0138 = m_tau*IT_0078;
    const ccomplex_t IT_0139 = m_tau*IT_0101;
    ...
    const ccomplex_t IT_0143 = N_d1*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0150 = IT_0030*IT_0148*IT_0149;
    const ccomplex_t IT_0151 = 0.5*IT_0113 + 0.5*IT_0124 + 0.5*IT_0135 + (-0.5
      )*IT_0136 + (-0.5)*IT_0137 + (-0.5)*IT_0138 + (-0.5)*IT_0139 + 0.5*IT_0150;
    const ccomplex_t IT_0152 = s_14*m_tau;
    const ccomplex_t IT_0153 = sin(beta);
    const ccomplex_t IT_0154 = cpow(IT_0153, -1);
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0006*IT_0021*IT_0154;
    ...
    const ccomplex_t IT_0166 = m_tau*IT_0165;
    const ccomplex_t IT_0167 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0006*IT_0021*IT_0154;
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u1)
      *e_em*IT_0006*IT_0021*IT_0154;
    const ccomplex_t IT_0174 = (-0.5)*IT_0173;
    const ccomplex_t IT_0175 = IT_0026*IT_0174;
    const ccomplex_t IT_0176 = IT_0030*IT_0149*IT_0175;
    const ccomplex_t IT_0177 = IT_0051*IT_0156;
    const ccomplex_t IT_0178 = IT_0053*IT_0112*IT_0177;
    const ccomplex_t IT_0179 = IT_0074*IT_0162;
    const ccomplex_t IT_0180 = IT_0076*IT_0123*IT_0179;
    const ccomplex_t IT_0181 = IT_0097*IT_0168;
    const ccomplex_t IT_0182 = IT_0099*IT_0134*IT_0181;
    const ccomplex_t IT_0183 = IT_0147*IT_0174;
    ...
    const ccomplex_t IT_0187 = (-0.5)*IT_0160 + (-0.5)*IT_0166 + (-0.5)
      *IT_0172 + 0.5*IT_0176 + 0.5*IT_0178 + 0.5*IT_0180 + 0.5*IT_0182 + (-0.5)
      *IT_0186;
    const ccomplex_t IT_0188 = m_c*s_13;
    const ccomplex_t IT_0189 = 0.5*IT_0159 + 0.5*IT_0165 + 0.5*IT_0171 + 0.5
      *IT_0185;
    const ccomplex_t IT_0190 = m_c*m_tau*IT_0029;
    const ccomplex_t IT_0191 = s_34*IT_0029;
    ...
    const ccomplex_t IT_0197 = m_c*m_tau;
    const ccomplex_t IT_0198 = (-6)*conj(IT_0151);
    const ccomplex_t IT_0199 = (-6)*IT_0151;
    const ccomplex_t IT_0200 = -IT_0102;
    const ccomplex_t IT_0201 = 6*conj(IT_0102)*(IT_0151*IT_0152 + -IT_0187
      *IT_0188 + -IT_0189*IT_0190 + 0.166666666666667*IT_0102*IT_0195) + 6*conj
      (IT_0151)*(IT_0102*IT_0152 + 0.166666666666667*IT_0151*IT_0196) + (IT_0188
      *IT_0189 + IT_0187*IT_0197)*IT_0198 + 6*conj(IT_0187)*(IT_0152*IT_0189 +
       0.166666666666667*IT_0187*IT_0196 + 0.166666666666667*IT_0197*IT_0199 +
       IT_0188*IT_0200) + 6*conj(IT_0189)*(IT_0152*IT_0187 + 0.166666666666667
      *IT_0189*IT_0195 + 0.166666666666667*IT_0188*IT_0199 + IT_0190*IT_0200);
