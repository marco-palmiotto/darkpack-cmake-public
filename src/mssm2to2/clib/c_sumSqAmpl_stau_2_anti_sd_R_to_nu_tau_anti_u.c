...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_sd_R_to_nu_tau_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0006 = (-0.5)*IT_0005;
    const ccomplex_t IT_0007 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0008 = IT_0004*IT_0007;
    const ccomplex_t IT_0009 = IT_0002*IT_0004;
    const ccomplex_t IT_0010 = conj(U_d2)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0021 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0022 = IT_0004*IT_0021;
    const ccomplex_t IT_0023 = conj(U_d1)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    return create_ccomplex_return(IT_0031*conj(IT_0031)*(12*IT_0032 + (-6)
      *IT_0033));
}
