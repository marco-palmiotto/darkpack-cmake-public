...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_sd_R_to_tau_anti_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_d*N_d3*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*m_d*N_d4*e_em
      *IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0163 = 0.5*IT_0139 + 0.5*IT_0143 + 0.5*IT_0149 + 0.5
      *IT_0155;
    const ccomplex_t IT_0164 = m_d*m_tau*IT_0023;
    ...
    const ccomplex_t IT_0171 = m_d*m_tau;
