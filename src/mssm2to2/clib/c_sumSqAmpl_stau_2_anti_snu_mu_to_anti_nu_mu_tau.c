...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_snu_mu_to_anti_nu_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0037 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = 1.4142135623731*IT_0038;
    const ccomplex_t IT_0040 = N_d2*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0057 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0058 = IT_0001*IT_0057;
    const ccomplex_t IT_0059 = 1.4142135623731*IT_0058;
    const ccomplex_t IT_0060 = N_d3*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0077 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0078 = IT_0001*IT_0077;
    const ccomplex_t IT_0079 = 1.4142135623731*IT_0078;
    const ccomplex_t IT_0080 = N_d4*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0095 = conj(N_d1)*e_em*m_tau*IT_0018*U_stau_11;
    ...
    const ccomplex_t IT_0110 = conj(N_d2)*e_em*m_tau*IT_0018*U_stau_11;
    ...
    const ccomplex_t IT_0125 = conj(N_d3)*e_em*m_tau*IT_0018*U_stau_11;
