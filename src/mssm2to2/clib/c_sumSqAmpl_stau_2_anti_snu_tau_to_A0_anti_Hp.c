        ...
        )
{
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*(A_tau*IT_0003*U_stau_10 + (
    ...
    const ccomplex_t IT_0041 = e_em*mu_h*m_tau*IT_0038*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0042 = IT_0012*IT_0041;
    const ccomplex_t IT_0043 = e_em*mu_h*m_tau*IT_0038*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0044 = IT_0012*IT_0043;
    const ccomplex_t IT_0045 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0046 = IT_0003*IT_0045;
    const ccomplex_t IT_0047 = 1.4142135623731*IT_0046;
    const ccomplex_t IT_0048 = A_tau*conj(U_stau_00)*U_stau_11;
    ...
    const ccomplex_t IT_0060 = A_tau*IT_0001*U_stau_11 + 0.707106781186548
      *e_em*IT_0012*((IT_0005*IT_0038 + -m_W*(IT_0002 + -IT_0059))*U_stau_01 + 
      -mu_h*m_tau*IT_0003*IT_0038*IT_0039*U_stau_11);
    ...
    const ccomplex_t IT_0068 = e_em*mu_h*m_tau*IT_0038*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0069 = IT_0012*IT_0068;
    const ccomplex_t IT_0070 = e_em*mu_h*m_tau*IT_0038*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0071 = IT_0012*IT_0070;
    const ccomplex_t IT_0072 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0073 = IT_0003*IT_0072;
    const ccomplex_t IT_0074 = 1.4142135623731*IT_0073;
    const ccomplex_t IT_0075 = A_tau*U_stau_01*conj(U_stau_11);
    const ccomplex_t IT_0076 = IT_0003*IT_0075;
    const ccomplex_t IT_0077 = 1.4142135623731*IT_0076;
    const ccomplex_t IT_0078 = (-0.5)*IT_0069 + 0.5*IT_0071 + (-0.5)*IT_0074 +
       0.5*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*(A_tau*IT_0003*U_stau_11 + (
