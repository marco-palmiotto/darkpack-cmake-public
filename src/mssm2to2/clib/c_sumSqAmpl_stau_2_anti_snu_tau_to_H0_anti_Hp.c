...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_snu_tau_to_H0_anti_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*(A_tau*IT_0002*U_stau_11 + (
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*(A_tau*IT_0002*U_stau_10 + (
    ...
    const ccomplex_t IT_0029 = -IT_0002*IT_0007;
    const ccomplex_t IT_0030 = IT_0001*IT_0005;
    const ccomplex_t IT_0031 = IT_0029 + IT_0030;
    const ccomplex_t IT_0032 = (-2)*conj(U_stau_00)*((IT_0001*IT_0004*IT_0014
      *IT_0015*IT_0016 + (-0.5)*m_W*(IT_0016 + -IT_0008*IT_0019)*IT_0031)
      *U_stau_01 + -1./2*IT_0007*IT_0015*IT_0016*IT_0028*U_stau_11) + conj
      (U_stau_10)*(IT_0007*IT_0015*IT_0016*IT_0028*U_stau_01 + (-2)*(IT_0001
      *IT_0004*IT_0014*IT_0015*IT_0016 + -m_W*IT_0008*IT_0019*IT_0031)*U_stau_11);
    ...
    const ccomplex_t IT_0040 = cpow(IT_0002, 3);
    const ccomplex_t IT_0041 = cpow(IT_0005, 2);
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0016
      *IT_0040 + (-2)*IT_0005*(IT_0002*(IT_0001*IT_0005 + -IT_0002*IT_0007)*(0.5
      *IT_0016 + IT_0008*IT_0019) + 1./2*IT_0007*IT_0016*IT_0041));
    const ccomplex_t IT_0043 = (-0.5)*IT_0042;
    const ccomplex_t IT_0044 = cpow(IT_0002, 2);
    const ccomplex_t IT_0045 = A_tau*IT_0005*U_stau_11 + 0.707106781186548
      *e_em*IT_0016*((IT_0004*IT_0014 + -m_W*(IT_0041 + -IT_0044))*U_stau_01 + 
      -mu_h*m_tau*IT_0002*IT_0014*IT_0015*U_stau_11);
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = -IT_0046;
    const ccomplex_t IT_0048 = IT_0043*IT_0047;
    const ccomplex_t IT_0049 = pow(m_W, 2);
    const ccomplex_t IT_0050 = pow(m_snu_tau, 2);
    const ccomplex_t IT_0051 = cpow((-2)*s_12 + -IT_0036 + IT_0049 + -IT_0050 
      + -reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0048*IT_0051;
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_12 + -IT_0036 + -IT_0050 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0055 = -IT_0016;
    const ccomplex_t IT_0056 = IT_0020 + IT_0055;
    const ccomplex_t IT_0057 = -IT_0005;
    const ccomplex_t IT_0058 = 3*IT_0016 + IT_0020;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_W*e_em*(IT_0007*IT_0040
      *IT_0056 + IT_0057*(IT_0001*IT_0044*IT_0058 + IT_0057*(IT_0001*IT_0005
      *IT_0056 + -IT_0002*IT_0007*IT_0058)));
    ...
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0012 + reg_prop + (0 +
       _Complex_I*1)*m_stau_2*Gamma_tau2, -1);
    const ccomplex_t IT_0088 = (-2)*U_stau_01*((IT_0001*IT_0004*IT_0014
      *IT_0015*IT_0016 + (-0.5)*m_W*(IT_0016 + -IT_0008*IT_0019)*IT_0031)*conj
      (U_stau_01) + -1./2*IT_0007*IT_0015*IT_0016*IT_0028*conj(U_stau_11)) +
       U_stau_11*(IT_0007*IT_0015*IT_0016*IT_0028*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0004*IT_0014*IT_0015*IT_0016 + -m_W*IT_0008*IT_0019*IT_0031)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0094 = IT_0011 + IT_0026 + IT_0039 + -IT_0053 + 
      -IT_0063 + IT_0086 + IT_0093;
