        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*(A_tau*IT_0002*U_stau_11 + (
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_13 + IT_0033 + reg_prop + (0 +
       _Complex_I*1)*m_stau_2*Gamma_tau2, -1);
    const ccomplex_t IT_0042 = mu_h*m_tau*IT_0012;
    const ccomplex_t IT_0043 = -IT_0002*IT_0007;
    const ccomplex_t IT_0044 = IT_0001*IT_0005;
    const ccomplex_t IT_0045 = IT_0043 + IT_0044;
    const ccomplex_t IT_0046 = (-2)*U_stau_01*((IT_0001*IT_0004*IT_0012
      *IT_0013*IT_0014 + (-0.5)*m_W*(IT_0014 + -IT_0008*IT_0018)*IT_0045)*conj
      (U_stau_01) + -1./2*IT_0007*IT_0013*IT_0014*IT_0042*conj(U_stau_11)) +
       U_stau_11*(IT_0007*IT_0013*IT_0014*IT_0042*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0004*IT_0012*IT_0013*IT_0014 + -m_W*IT_0008*IT_0018*IT_0045)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*(A_tau*IT_0002*U_stau_10 + (
    ...
    const ccomplex_t IT_0053 = (-2)*conj(U_stau_00)*((IT_0001*IT_0004*IT_0012
      *IT_0013*IT_0014 + (-0.5)*m_W*(IT_0014 + -IT_0008*IT_0018)*IT_0045)
      *U_stau_01 + -1./2*IT_0007*IT_0013*IT_0014*IT_0042*U_stau_11) + conj
      (U_stau_10)*(IT_0007*IT_0013*IT_0014*IT_0042*U_stau_01 + (-2)*(IT_0001
      *IT_0004*IT_0012*IT_0013*IT_0014 + -m_W*IT_0008*IT_0018*IT_0045)*U_stau_11);
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0028 + IT_0033 + reg_prop +
    ...
    const ccomplex_t IT_0061 = s_13 + s_23;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0002 + 
    ...
    const ccomplex_t IT_0067 = s_12 + IT_0029;
    const ccomplex_t IT_0068 = 0.5*IT_0062;
    const ccomplex_t IT_0069 = -IT_0063;
    ...
    const ccomplex_t IT_0075 = 0.5*IT_0028 + 0.5*IT_0029;
    const ccomplex_t IT_0076 = s_12 + IT_0075;
    const ccomplex_t IT_0077 = IT_0064*IT_0068;
    const ccomplex_t IT_0078 = IT_0076*IT_0077;
    const ccomplex_t IT_0079 = -IT_0074 + (-2)*IT_0078;
    ...
    const ccomplex_t IT_0083 = cpow(IT_0005, 2);
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0014
      *IT_0021 + (-2)*IT_0005*(IT_0002*(IT_0001*IT_0005 + -IT_0002*IT_0007)*(0.5
      *IT_0014 + IT_0008*IT_0018) + 1./2*IT_0007*IT_0014*IT_0083));
    const ccomplex_t IT_0085 = (-0.5)*IT_0084;
    const ccomplex_t IT_0086 = A_tau*IT_0005*U_stau_11 + 0.707106781186548
      *e_em*IT_0014*((IT_0004*IT_0012 + m_W*(IT_0024 + -IT_0083))*U_stau_01 + 
      -mu_h*m_tau*IT_0002*IT_0012*IT_0013*U_stau_11);
    ...
    const ccomplex_t IT_0091 = cpow((-2)*s_12 + -IT_0028 + -IT_0029 + IT_0090 
      + -reg_prop, -1);
