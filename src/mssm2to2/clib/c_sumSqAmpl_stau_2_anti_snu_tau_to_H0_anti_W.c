        ...
        )
{
    ...
    const ccomplex_t IT_0011 = cpow(IT_0000, 2);
    const ccomplex_t IT_0012 = cpow(IT_0002, 2);
    const ccomplex_t IT_0013 = A_tau*IT_0000*U_stau_11 + 0.707106781186548
      *e_em*IT_0005*((IT_0008*IT_0010 + -m_W*(IT_0011 + -IT_0012))*U_stau_01 + 
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0002 + 
      -IT_0000*IT_0003)*IT_0005;
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*(A_tau*IT_0002*U_stau_11 + (
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_12 + -IT_0017 + -IT_0018 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0026 = IT_0024*IT_0025;
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*IT_0026;
    const ccomplex_t IT_0028 = IT_0023*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005
      *U_stau_01;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*m_W*e_em*(IT_0000*IT_0001 +
       IT_0002*IT_0003)*IT_0005;
    ...
    const ccomplex_t IT_0036 = -IT_0022 + -IT_0028 + -IT_0035;
    const ccomplex_t IT_0037 = pow(m_W, -2);
    const ccomplex_t IT_0038 = pow(s_14, 2);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = -IT_0029;
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_W*e_em*(IT_0000*IT_0001 + 
      -IT_0002*IT_0003)*IT_0044;
    ...
    const ccomplex_t IT_0056 = mu_h*m_tau*IT_0008;
    const ccomplex_t IT_0057 = -IT_0002*IT_0003;
    const ccomplex_t IT_0058 = IT_0000*IT_0001;
    const ccomplex_t IT_0059 = IT_0057 + IT_0058;
    const ccomplex_t IT_0060 = (-2)*U_stau_01*((IT_0001*IT_0005*IT_0008
      *IT_0009*IT_0010 + (-0.5)*m_W*(IT_0005 + -IT_0004*IT_0042)*IT_0059)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0005*IT_0009*IT_0056*conj(U_stau_11)) +
       U_stau_11*(IT_0003*IT_0005*IT_0009*IT_0056*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0005*IT_0008*IT_0009*IT_0010 + -m_W*IT_0004*IT_0042*IT_0059)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0067 = -IT_0040;
    const ccomplex_t IT_0068 = IT_0030 + IT_0067;
    const ccomplex_t IT_0069 = IT_0034*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005
      *U_stau_00;
    const ccomplex_t IT_0071 = -IT_0070;
    const ccomplex_t IT_0072 = (-2)*conj(U_stau_00)*((IT_0001*IT_0005*IT_0008
      *IT_0009*IT_0010 + (-0.5)*m_W*(IT_0005 + -IT_0004*IT_0042)*IT_0059)
      *U_stau_01 + -1./2*IT_0003*IT_0005*IT_0009*IT_0056*U_stau_11) + conj
      (U_stau_10)*(IT_0003*IT_0005*IT_0009*IT_0056*U_stau_01 + (-2)*(IT_0001
      *IT_0005*IT_0008*IT_0009*IT_0010 + -m_W*IT_0004*IT_0042*IT_0059)*U_stau_11);
    const ccomplex_t IT_0073 = (0 + _Complex_I*-1)*(e_em*IT_0072 + (
      -1.4142135623731)*A_tau*IT_0001*(U_stau_01*conj(U_stau_10) + conj
      (U_stau_00)*U_stau_11));
    const ccomplex_t IT_0074 = (-0.5)*IT_0073;
    const ccomplex_t IT_0075 = cpow((-2)*s_13 + IT_0017 + IT_0047 + reg_prop +
    ...
    const ccomplex_t IT_0079 = -IT_0022 + -IT_0028 + IT_0051 + IT_0066 + 
      -IT_0069 + IT_0078;
    ...
    const ccomplex_t IT_0092 = (conj(IT_0036)*(IT_0017 + -IT_0039) + conj
