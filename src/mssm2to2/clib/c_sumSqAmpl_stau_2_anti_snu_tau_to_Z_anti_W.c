        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0005*IT_0006 +
       -IT_0004*IT_0007)*conj(U_stau_00)*U_stau_01 + IT_0005*IT_0006*conj
      (U_stau_10)*U_stau_11);
    const ccomplex_t IT_0009 = (-2)*IT_0008;
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007
      *U_stau_00;
    const ccomplex_t IT_0011 = -IT_0010;
    const ccomplex_t IT_0012 = IT_0009*IT_0011;
    const ccomplex_t IT_0013 = IT_0003*IT_0012;
    const ccomplex_t IT_0014 = cpow((-2)*s_13 + IT_0000 + reg_prop + (0 +
       _Complex_I*1)*m_stau_2*Gamma_tau2, -1);
    const ccomplex_t IT_0015 = (0 + _Complex_I*1)*IT_0014;
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0005*IT_0006 +
       -IT_0004*IT_0007)*U_stau_01*conj(U_stau_01) + IT_0005*IT_0006*U_stau_11
      *conj(U_stau_11));
    const ccomplex_t IT_0017 = (-2)*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0007
      *U_stau_01;
    ...
    const ccomplex_t IT_0030 = -(IT_0025 + -IT_0026)*(IT_0001 + -IT_0029);
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0000 + reg_prop + (0 +
       _Complex_I*1)*m_snu_tau*Gamma_nutaul, -1);
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*e_em*IT_0005*IT_0007;
    const ccomplex_t IT_0034 = -IT_0033;
    const ccomplex_t IT_0035 = IT_0019*IT_0034;
    const ccomplex_t IT_0036 = IT_0032*IT_0035;
    const ccomplex_t IT_0037 = cpow((-2)*s_12 + m_W*(m_W + (0 + _Complex_I*-1)
      *Gamma_W) + -IT_0001 + -IT_0026 + -reg_prop, -1);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*e_em*IT_0004*IT_0007;
    const ccomplex_t IT_0040 = 2*IT_0039;
    const ccomplex_t IT_0041 = (-0.5)*IT_0018;
    const ccomplex_t IT_0042 = IT_0040*IT_0041;
    const ccomplex_t IT_0043 = IT_0019*IT_0040;
    ...
    const ccomplex_t IT_0051 = (-2)*IT_0039;
    ...
    const ccomplex_t IT_0067 = A_tau*IT_0060*U_stau_11 + 0.707106781186548
      *e_em*IT_0007*((IT_0061*IT_0064 + -m_W*(IT_0065 + -IT_0066))*U_stau_01 + 
    ...
    const ccomplex_t IT_0098 = IT_0038*IT_0042;
    ...
    const ccomplex_t IT_0107 = (IT_0073 + -IT_0104)*(IT_0001 + -IT_0106);
    const ccomplex_t IT_0108 = -IT_0107;
    const ccomplex_t IT_0109 = IT_0019*IT_0051;
    const ccomplex_t IT_0110 = IT_0038*(IT_0052 + -IT_0109);
    ...
    const ccomplex_t IT_0135 = -(IT_0001 + -IT_0029)*(IT_0000 + -IT_0134);
    const ccomplex_t IT_0136 = (s_12 + -IT_0048)*(IT_0000 + -IT_0134);
    const ccomplex_t IT_0137 = (s_23 + -IT_0049)*(s_14 + -IT_0055);
    const ccomplex_t IT_0138 = -(IT_0001 + -IT_0029)*(s_23 + -IT_0049);
    ...
    const ccomplex_t IT_0151 = conj(IT_0022)*(IT_0022*IT_0030 + IT_0047
      ...
      *IT_0120 + IT_0047*IT_0123 + IT_0110*IT_0126 + IT_0036*IT_0132)*IT_0133 +
       conj(IT_0098)*(IT_0036*IT_0050 + IT_0053*IT_0100 + IT_0116*IT_0120 + 
      -IT_0098*IT_0135 + IT_0047*IT_0136 + IT_0110*IT_0137 + IT_0138*IT_0139) +
       conj(IT_0036)*(IT_0050*IT_0098 + IT_0053*IT_0102 + IT_0116*IT_0132 +
       IT_0036*IT_0140 + IT_0139*IT_0141) + (IT_0098*IT_0138 + IT_0036*IT_0141 +
