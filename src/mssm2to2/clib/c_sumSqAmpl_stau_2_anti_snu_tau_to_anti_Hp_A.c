...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_snu_tau_to_anti_Hp_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = (0 + _Complex_I*1)*(A_tau*IT_0001*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0006*(m_W*IT_0001*IT_0002*U_stau_01 + (-0.5)
      *m_tau*IT_0003*(m_tau*IT_0001*IT_0004*U_stau_01 + mu_h*U_stau_11)));
