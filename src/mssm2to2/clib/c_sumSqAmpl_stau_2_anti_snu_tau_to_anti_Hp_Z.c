...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_snu_tau_to_anti_Hp_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1)*(A_tau*IT_0005*U_stau_11 + (
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*(A_tau*IT_0005*U_stau_10 + (
