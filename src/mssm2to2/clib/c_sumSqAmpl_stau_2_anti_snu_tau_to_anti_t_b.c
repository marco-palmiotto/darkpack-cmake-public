        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_b*V_tb*e_em
      *IT_0001*IT_0015;
    ...
    const ccomplex_t IT_0029 = A_tau*IT_0014*U_stau_11 + 0.707106781186548
      *e_em*IT_0001*((IT_0015*IT_0026 + -m_W*(IT_0027 + -IT_0028))*U_stau_01 + 
    ...
    const ccomplex_t IT_0050 = m_t*IT_0037;
