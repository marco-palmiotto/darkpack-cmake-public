        ...
        )
{
    ...
    const ccomplex_t IT_0014 = cpow((-2)*s_12 + -IT_0006 + -IT_0007 + IT_0013 
      + -reg_prop, -1);
    ...
    const ccomplex_t IT_0022 = cpow(IT_0018, 2);
    const ccomplex_t IT_0023 = cpow(IT_0020, 2);
    const ccomplex_t IT_0024 = A_tau*IT_0018*U_stau_11 + 0.707106781186548
      *e_em*IT_0001*((IT_0015*IT_0021 + -m_W*(IT_0022 + -IT_0023))*U_stau_01 + 
      -mu_h*m_tau*IT_0015*IT_0019*IT_0020*U_stau_11);
    ...
    const ccomplex_t IT_0030 = (-0.5)*IT_0002;
    const ccomplex_t IT_0031 = m_d*IT_0030;
    const ccomplex_t IT_0032 = m_d*IT_0003;
    const ccomplex_t IT_0033 = -IT_0032;
    const ccomplex_t IT_0034 = IT_0031 + IT_0033;
    const ccomplex_t IT_0035 = IT_0010*IT_0034;
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*(A_tau*IT_0020*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0001*(m_W*IT_0018*IT_0020*U_stau_01 + (-0.5)
      *m_tau*IT_0015*(m_tau*IT_0019*IT_0020*U_stau_01 + mu_h*U_stau_11)));
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *IT_0001*IT_0015*IT_0019*IT_0020;
    ...
    const ccomplex_t IT_0043 = -IT_0029 + -IT_0035 + -IT_0042;
    ...
    const ccomplex_t IT_0050 = cpow(IT_0020, -1);
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0001*IT_0015*IT_0018*IT_0050;
    const ccomplex_t IT_0052 = 0.5*IT_0051;
    const ccomplex_t IT_0053 = IT_0036*IT_0052;
    const ccomplex_t IT_0054 = IT_0040*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*IT_0054;
    const ccomplex_t IT_0056 = m_u*IT_0030;
    const ccomplex_t IT_0057 = m_u*IT_0003;
