        ...
        )
{
    ...
    const ccomplex_t IT_0014 = m_s*IT_0013;
    const ccomplex_t IT_0015 = m_s*IT_0003;
    ...
    const ccomplex_t IT_0022 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
    ...
    const ccomplex_t IT_0028 = cpow(IT_0024, 2);
    const ccomplex_t IT_0029 = cpow(IT_0026, 2);
    const ccomplex_t IT_0030 = A_tau*IT_0024*U_stau_11 + 0.707106781186548
      *e_em*IT_0001*((IT_0021*IT_0027 + -m_W*(IT_0028 + -IT_0029))*U_stau_01 + 
      -mu_h*m_tau*IT_0021*IT_0025*IT_0026*U_stau_11);
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*(A_tau*IT_0026*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0001*(m_W*IT_0024*IT_0026*U_stau_01 + (-0.5)
      *m_tau*IT_0021*(m_tau*IT_0025*IT_0026*U_stau_01 + mu_h*U_stau_11)));
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0001*IT_0021*IT_0025*IT_0026;
    const ccomplex_t IT_0038 = 0.5*IT_0037;
    const ccomplex_t IT_0039 = IT_0036*IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_12 + -IT_0006 + -IT_0007 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = -IT_0018 + -IT_0035 + -IT_0042;
    const ccomplex_t IT_0044 = m_s*s_14;
    const ccomplex_t IT_0045 = m_c*IT_0013;
    const ccomplex_t IT_0046 = m_c*IT_0003;
    ...
    const ccomplex_t IT_0055 = cpow(IT_0026, -1);
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0001*IT_0021*IT_0024*IT_0055;
