...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_snu_tau_to_s_anti_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = (0 + _Complex_I*1.4142135623731)*conj(V_cs)
      *e_em*IT_0001;
    const ccomplex_t IT_0005 = 0.5*IT_0004;
    const ccomplex_t IT_0006 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0016 = cpow(IT_0014, -1);
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*(A_tau*IT_0013*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0001*(m_W*IT_0013*IT_0014*U_stau_01 + (-0.5)
      *m_tau*IT_0015*(m_tau*IT_0013*IT_0016*U_stau_01 + mu_h*U_stau_11)));
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0001*IT_0013*IT_0015*IT_0016;
    const ccomplex_t IT_0019 = 0.5*IT_0018;
    const ccomplex_t IT_0020 = IT_0017*IT_0019;
    const ccomplex_t IT_0021 = cpow((-2)*s_12 + -IT_0006 + -IT_0007 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0022 = IT_0020*IT_0021;
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*IT_0022;
    const ccomplex_t IT_0024 = (-0.5)*IT_0002;
    const ccomplex_t IT_0025 = m_s*IT_0024;
    const ccomplex_t IT_0026 = m_s*IT_0003;
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_s*conj(V_cs)
      *e_em*IT_0001*IT_0015;
    const ccomplex_t IT_0031 = (-0.5)*IT_0030;
    const ccomplex_t IT_0032 = pow(m_tau, 2);
    const ccomplex_t IT_0033 = cpow(IT_0014, 2);
    const ccomplex_t IT_0034 = cpow(IT_0013, 2);
    const ccomplex_t IT_0035 = A_tau*IT_0014*U_stau_11 + 0.707106781186548
      *e_em*IT_0001*((IT_0015*IT_0032 + -m_W*(IT_0033 + -IT_0034))*U_stau_01 + 
      -mu_h*m_tau*IT_0013*IT_0015*IT_0016*U_stau_11);
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*IT_0035;
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = IT_0031*IT_0037;
    const ccomplex_t IT_0039 = pow(m_W, 2);
    const ccomplex_t IT_0040 = cpow((-2)*s_12 + -IT_0006 + -IT_0007 + IT_0039 
      + -reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0038*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = -IT_0023 + -IT_0029 + -IT_0042;
    const ccomplex_t IT_0044 = m_s*s_14;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0001*IT_0015;
    ...
    const ccomplex_t IT_0050 = m_c*IT_0024;
    const ccomplex_t IT_0051 = m_c*IT_0003;
    const ccomplex_t IT_0052 = -IT_0051;
    const ccomplex_t IT_0053 = IT_0050 + IT_0052;
    const ccomplex_t IT_0054 = IT_0010*IT_0053;
    const ccomplex_t IT_0055 = cpow(IT_0013, -1);
    const ccomplex_t IT_0056 = (0 + _Complex_I*1.4142135623731)*m_c*conj(V_cs)
      *e_em*IT_0001*IT_0014*IT_0015*IT_0055;
    ...
    const ccomplex_t IT_0061 = -IT_0049 + IT_0054 + -IT_0060;
    const ccomplex_t IT_0062 = m_c*s_13;
    const ccomplex_t IT_0063 = s_13*s_14;
    const ccomplex_t IT_0064 = s_34*IT_0006;
    const ccomplex_t IT_0065 = m_c*m_s;
