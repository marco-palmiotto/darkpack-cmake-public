...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_ss_R_to_tau_anti_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0016 = conj(N_d1)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0047 = IT_0008*IT_0046;
    const ccomplex_t IT_0048 = 1.4142135623731*IT_0047;
    const ccomplex_t IT_0049 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0050 = IT_0004*IT_0049;
    const ccomplex_t IT_0051 = 1.4142135623731*IT_0050;
    const ccomplex_t IT_0052 = conj(N_d3)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*m_s*N_d4*e_em
      *IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0064 = IT_0008*IT_0063;
    const ccomplex_t IT_0065 = 1.4142135623731*IT_0064;
    const ccomplex_t IT_0066 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0067 = IT_0004*IT_0066;
    const ccomplex_t IT_0068 = 1.4142135623731*IT_0067;
    const ccomplex_t IT_0069 = conj(N_d4)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0078 = 0.5*IT_0026 + 0.5*IT_0043 + 0.5*IT_0060 + 0.5
      *IT_0077;
    const ccomplex_t IT_0079 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0080 = IT_0008*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_d2*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0089 = IT_0041*IT_0087*IT_0088;
    ...
    const ccomplex_t IT_0093 = N_d3*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0100 = IT_0058*IT_0098*IT_0099;
    const ccomplex_t IT_0101 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0102 = IT_0008*IT_0101;
    const ccomplex_t IT_0103 = 1.4142135623731*IT_0102;
    const ccomplex_t IT_0104 = N_d4*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0111 = IT_0075*IT_0109*IT_0110;
    const ccomplex_t IT_0112 = m_tau*IT_0026;
    const ccomplex_t IT_0113 = m_tau*IT_0043;
    const ccomplex_t IT_0114 = m_tau*IT_0060;
    const ccomplex_t IT_0115 = m_tau*IT_0077;
    const ccomplex_t IT_0116 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0117 = IT_0008*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = N_d1*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0126 = IT_0024*IT_0124*IT_0125;
    const ccomplex_t IT_0127 = 0.5*IT_0089 + 0.5*IT_0100 + 0.5*IT_0111 + (-0.5
      )*IT_0112 + (-0.5)*IT_0113 + (-0.5)*IT_0114 + (-0.5)*IT_0115 + 0.5*IT_0126;
    const ccomplex_t IT_0128 = s_14*m_tau;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0008;
    const ccomplex_t IT_0130 = (-0.333333333333333)*IT_0129;
    const ccomplex_t IT_0131 = IT_0020*IT_0130;
    const ccomplex_t IT_0132 = IT_0024*IT_0125*IT_0131;
    const ccomplex_t IT_0133 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0008;
    const ccomplex_t IT_0134 = (-0.333333333333333)*IT_0133;
    const ccomplex_t IT_0135 = IT_0039*IT_0134;
    const ccomplex_t IT_0136 = IT_0041*IT_0088*IT_0135;
    const ccomplex_t IT_0137 = IT_0123*IT_0130;
    ...
    const ccomplex_t IT_0141 = IT_0086*IT_0134;
    ...
    const ccomplex_t IT_0157 = IT_0056*IT_0146;
    const ccomplex_t IT_0158 = IT_0058*IT_0099*IT_0157;
    const ccomplex_t IT_0159 = IT_0073*IT_0152;
    const ccomplex_t IT_0160 = IT_0075*IT_0110*IT_0159;
    const ccomplex_t IT_0161 = 0.5*IT_0132 + 0.5*IT_0136 + (-0.5)*IT_0140 + (
      -0.5)*IT_0144 + (-0.5)*IT_0150 + (-0.5)*IT_0156 + 0.5*IT_0158 + 0.5*IT_0160;
    const ccomplex_t IT_0162 = m_s*s_13;
    const ccomplex_t IT_0163 = 0.5*IT_0139 + 0.5*IT_0143 + 0.5*IT_0149 + 0.5
      *IT_0155;
    const ccomplex_t IT_0164 = m_s*m_tau*IT_0023;
    ...
    const ccomplex_t IT_0171 = m_s*m_tau;
    const ccomplex_t IT_0172 = (-6)*conj(IT_0127);
    const ccomplex_t IT_0173 = (-6)*IT_0127;
    const ccomplex_t IT_0174 = -IT_0078;
    const ccomplex_t IT_0175 = 6*conj(IT_0078)*(IT_0127*IT_0128 + -IT_0161
      *IT_0162 + -IT_0163*IT_0164 + 0.166666666666667*IT_0078*IT_0169) + 6*conj
      (IT_0127)*(IT_0078*IT_0128 + 0.166666666666667*IT_0127*IT_0170) + (IT_0162
      *IT_0163 + IT_0161*IT_0171)*IT_0172 + 6*conj(IT_0161)*(IT_0128*IT_0163 +
       0.166666666666667*IT_0161*IT_0170 + 0.166666666666667*IT_0171*IT_0173 +
       IT_0162*IT_0174) + 6*conj(IT_0163)*(IT_0128*IT_0161 + 0.166666666666667
      *IT_0163*IT_0169 + 0.166666666666667*IT_0162*IT_0173 + IT_0164*IT_0174);
