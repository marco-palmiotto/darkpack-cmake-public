        ...
        )
{
    ...
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0008;
    ...
    const ccomplex_t IT_0134 = m_tau*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0008;
    ...
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0008;
    ...
    const ccomplex_t IT_0146 = m_tau*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0008;
    const ccomplex_t IT_0148 = (-0.333333333333333)*IT_0147;
    const ccomplex_t IT_0149 = IT_0020*IT_0148;
    const ccomplex_t IT_0150 = IT_0024*IT_0125*IT_0149;
    const ccomplex_t IT_0151 = IT_0039*IT_0130;
    const ccomplex_t IT_0152 = IT_0041*IT_0088*IT_0151;
    const ccomplex_t IT_0153 = IT_0056*IT_0136;
    const ccomplex_t IT_0154 = IT_0058*IT_0099*IT_0153;
    const ccomplex_t IT_0155 = IT_0073*IT_0142;
    const ccomplex_t IT_0156 = IT_0075*IT_0110*IT_0155;
    const ccomplex_t IT_0157 = IT_0123*IT_0148;
    ...
    const ccomplex_t IT_0161 = (-0.5)*IT_0134 + (-0.5)*IT_0140 + (-0.5)
      *IT_0146 + 0.5*IT_0150 + 0.5*IT_0152 + 0.5*IT_0154 + 0.5*IT_0156 + (-0.5)
      *IT_0160;
    const ccomplex_t IT_0162 = m_s*s_13;
    const ccomplex_t IT_0163 = 0.5*IT_0133 + 0.5*IT_0139 + 0.5*IT_0145 + 0.5
      *IT_0159;
