        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (-2)*U_stau_01*(((-0.5)*m_W*IT_0014*(IT_0007 + 
      -IT_0006*IT_0015) + IT_0002*IT_0007*IT_0009*IT_0011*IT_0016)*conj
      (U_stau_01) + -1./2*IT_0005*IT_0007*IT_0010*IT_0011*conj(U_stau_11)) +
       U_stau_11*(IT_0005*IT_0007*IT_0010*IT_0011*conj(U_stau_01) + 2*(m_W
    ...
    const ccomplex_t IT_0030 = 2*U_stau_01*((IT_0005*IT_0007*IT_0009*IT_0011
      *IT_0016 + (-0.5)*m_W*(IT_0007 + -IT_0006*IT_0015)*IT_0029)*conj(U_stau_01
      ) + 1./2*IT_0002*IT_0007*IT_0010*IT_0011*conj(U_stau_11)) + U_stau_11*
      (IT_0002*IT_0007*IT_0010*IT_0011*conj(U_stau_01) + 2*(IT_0005*IT_0007
      *IT_0009*IT_0011*IT_0016 + -m_W*IT_0006*IT_0015*IT_0029)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0043 = e_em*mu_h*m_tau*IT_0009*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0044 = IT_0007*IT_0043;
    const ccomplex_t IT_0045 = e_em*mu_h*m_tau*IT_0009*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0046 = IT_0007*IT_0045;
    const ccomplex_t IT_0047 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0048 = IT_0003*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = A_tau*U_stau_01*conj(U_stau_11);
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0054 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0061 = e_em*mu_h*m_tau*IT_0009*conj(U_stau_01)
      *U_stau_10;
    ...
    const ccomplex_t IT_0071 = (-0.5)*IT_0062 + 0.5*IT_0064 + (-0.5)*IT_0067 +
       0.5*IT_0070;
    const ccomplex_t IT_0072 = cpow((-2)*s_23 + IT_0020 + IT_0054 + reg_prop +
    ...
    const ccomplex_t IT_0082 = e_em*mu_h*m_tau*IT_0009*U_stau_01*conj
      (U_stau_10);
    const ccomplex_t IT_0083 = IT_0007*IT_0082;
    const ccomplex_t IT_0084 = e_em*mu_h*m_tau*IT_0009*conj(U_stau_00)
      *U_stau_11;
    const ccomplex_t IT_0085 = IT_0007*IT_0084;
    const ccomplex_t IT_0086 = A_tau*U_stau_01*conj(U_stau_10);
    const ccomplex_t IT_0087 = IT_0003*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = A_tau*conj(U_stau_00)*U_stau_11;
    ...
    const ccomplex_t IT_0101 = 2*U_stau_01*((IT_0005*IT_0007*IT_0009*IT_0011
      *IT_0016 + (-0.5)*m_W*(IT_0007 + -IT_0006*IT_0015)*IT_0029)*conj(U_stau_01
      ) + 1./2*IT_0002*IT_0007*IT_0010*IT_0011*conj(U_stau_11)) + U_stau_11*
      (IT_0002*IT_0007*IT_0010*IT_0011*conj(U_stau_01) + 2*(IT_0005*IT_0007
      *IT_0009*IT_0011*IT_0016 + -m_W*IT_0006*IT_0015*IT_0029)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0107 = (-2)*U_stau_01*(((-0.5)*m_W*IT_0014*(IT_0007 + 
      -IT_0006*IT_0015) + IT_0002*IT_0007*IT_0009*IT_0011*IT_0016)*conj
      (U_stau_01) + -1./2*IT_0005*IT_0007*IT_0010*IT_0011*conj(U_stau_11)) +
       U_stau_11*(IT_0005*IT_0007*IT_0010*IT_0011*conj(U_stau_01) + 2*(m_W
      *IT_0006*IT_0014*IT_0015 + -IT_0002*IT_0007*IT_0009*IT_0011*IT_0016)*conj
    ...
    const ccomplex_t IT_0113 = IT_0058 + IT_0075 + IT_0096 + IT_0100 + 
      -IT_0106 + -IT_0112;
    const ccomplex_t IT_0114 = s_14*s_24*IT_0038;
    const ccomplex_t IT_0115 = -IT_0114;
    const ccomplex_t IT_0116 = s_12 + IT_0115;
    const ccomplex_t IT_0117 = -IT_0037;
    const ccomplex_t IT_0118 = -conj(IT_0037);
    const ccomplex_t IT_0119 = pow(s_34, 2);
    const ccomplex_t IT_0120 = IT_0038*IT_0119;
    const ccomplex_t IT_0121 = s_24*s_34*IT_0038;
    const ccomplex_t IT_0122 = -IT_0121;
    const ccomplex_t IT_0123 = s_23 + IT_0122;
    const ccomplex_t IT_0124 = pow(s_24, 2);
    const ccomplex_t IT_0125 = IT_0038*IT_0124;
    const ccomplex_t IT_0126 = -IT_0113;
    const ccomplex_t IT_0127 = (conj(IT_0037)*(IT_0020 + -IT_0040) + conj
      (IT_0076)*IT_0079 + conj(IT_0113)*IT_0116)*IT_0117 + IT_0113*IT_0116
      *IT_0118 + IT_0076*(IT_0079*IT_0118 + -conj(IT_0076)*(IT_0054 + -IT_0120) 
      + -conj(IT_0113)*IT_0123) + (conj(IT_0076)*IT_0123 + conj(IT_0113)*
      (IT_0020 + -IT_0125))*IT_0126;
