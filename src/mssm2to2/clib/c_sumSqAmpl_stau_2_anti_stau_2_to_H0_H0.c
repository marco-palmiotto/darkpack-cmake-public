        ...
        )
{
    ...
    const ccomplex_t IT_0042 = (-2)*U_stau_01*((IT_0005*IT_0008*IT_0016
      *IT_0018*IT_0019 + 0.5*m_W*(IT_0002*IT_0011 + -IT_0019)*IT_0023)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0017*IT_0018*IT_0019*conj(U_stau_11)) +
       U_stau_11*(IT_0003*IT_0017*IT_0018*IT_0019*conj(U_stau_01) + (-2)*
      (IT_0005*IT_0008*IT_0016*IT_0018*IT_0019 + -m_W*IT_0002*IT_0011*IT_0023)
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0031 + reg_prop + (0 +
       _Complex_I*1)*m_stau_2*Gamma_tau2, -1);
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*5)*m_W*e_em*IT_0038*(IT_0005*
      (IT_0004*IT_0020 + (-1)*IT_0005*(IT_0003*IT_0009 + 1./5*IT_0005*IT_0020)) 
      + 1./5*IT_0009*IT_0039);
    const ccomplex_t IT_0056 = (-0.5)*IT_0055;
    const ccomplex_t IT_0057 = IT_0003*IT_0009;
    const ccomplex_t IT_0058 = IT_0005*IT_0020;
    const ccomplex_t IT_0059 = IT_0057 + IT_0058;
    const ccomplex_t IT_0060 = 2*U_stau_01*((IT_0003*IT_0008*IT_0016*IT_0018
      *IT_0019 + 0.5*m_W*(IT_0002*IT_0011 + -IT_0019)*IT_0059)*conj(U_stau_01) +
       1./2*IT_0005*IT_0017*IT_0018*IT_0019*conj(U_stau_11)) + U_stau_11*
      (IT_0005*IT_0017*IT_0018*IT_0019*conj(U_stau_01) + 2*(IT_0003*IT_0008
      *IT_0016*IT_0018*IT_0019 + -m_W*IT_0002*IT_0011*IT_0059)*conj(U_stau_11));
