        ...
        )
{
    ...
    const ccomplex_t IT_0038 = e_em*mu_h*m_tau*IT_0035*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0039 = IT_0003*IT_0038;
    const ccomplex_t IT_0040 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0041 = IT_0010*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = A_tau*U_stau_01*conj(U_stau_11);
    ...
    const ccomplex_t IT_0059 = (-2)*U_stau_00*(((-0.5)*m_W*(IT_0003 + -IT_0002
    ...
    const ccomplex_t IT_0067 = (-2)*IT_0004;
    const ccomplex_t IT_0068 = (-2)*U_stau_01*(((-0.5)*m_W*(IT_0003 + -IT_0002
      *IT_0016)*IT_0057 + IT_0003*IT_0007*IT_0035*IT_0054*IT_0058)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0011*IT_0053*IT_0054*conj(U_stau_11)) +
       U_stau_11*(IT_0003*IT_0011*IT_0053*IT_0054*conj(U_stau_01) + 2*(m_W
      *IT_0002*IT_0016*IT_0057 + -IT_0003*IT_0007*IT_0035*IT_0054*IT_0058)*conj
      (U_stau_11));
    ...
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0062 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0077 = IT_0003*IT_0010*IT_0054;
    const ccomplex_t IT_0078 = IT_0036*IT_0077;
    const ccomplex_t IT_0079 = IT_0038*IT_0077;
    const ccomplex_t IT_0080 = IT_0006*IT_0040;
    ...
    const ccomplex_t IT_0090 = IT_0050 + -IT_0066 + -IT_0074 + IT_0089;
    const ccomplex_t IT_0091 = s_14*s_34*IT_0031;
    const ccomplex_t IT_0092 = -IT_0091;
    const ccomplex_t IT_0093 = s_13 + IT_0092;
    const ccomplex_t IT_0094 = cpow((-2)*s_13 + IT_0062 + reg_prop + (0 +
       _Complex_I*1)*m_stau_2*Gamma_tau2, -1);
    ...
    const ccomplex_t IT_0098 = -IT_0067;
    ...
    const ccomplex_t IT_0103 = (-2)*conj(U_stau_00)*(((-0.5)*m_W*(IT_0003 + 
    ...
    const ccomplex_t IT_0106 = cpow((-2)*s_13 + IT_0025 + IT_0062 + reg_prop +
       -m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1), -1);
    const ccomplex_t IT_0107 = IT_0105*IT_0106;
    const ccomplex_t IT_0108 = (0 + _Complex_I*1)*IT_0107;
    const ccomplex_t IT_0109 = IT_0102*IT_0108;
    const ccomplex_t IT_0110 = IT_0066 + IT_0074 + IT_0097 + -IT_0100 + IT_0109;
    const ccomplex_t IT_0111 = s_14*s_24*IT_0031;
    const ccomplex_t IT_0112 = -IT_0111;
    const ccomplex_t IT_0113 = s_12 + IT_0112;
    const ccomplex_t IT_0114 = -IT_0030;
    const ccomplex_t IT_0115 = -conj(IT_0030);
    ...
    const ccomplex_t IT_0123 = -IT_0110;
    const ccomplex_t IT_0124 = (conj(IT_0030)*(IT_0025 + -IT_0033) + conj
      (IT_0090)*IT_0093 + conj(IT_0110)*IT_0113)*IT_0114 + IT_0110*IT_0113
      *IT_0115 + IT_0090*(IT_0093*IT_0115 + -conj(IT_0090)*(IT_0062 + -IT_0117) 
      + -conj(IT_0110)*IT_0120) + (conj(IT_0090)*IT_0120 + conj(IT_0110)*
      (IT_0025 + -IT_0122))*IT_0123;
