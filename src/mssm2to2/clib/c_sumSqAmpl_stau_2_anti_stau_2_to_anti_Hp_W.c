        ...
        )
{
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*(A_tau*IT_0009*U_stau_11 + (
      -1.4142135623731)*e_em*IT_0001*(m_W*IT_0009*IT_0024*U_stau_01 + (-0.5)
      *m_tau*IT_0004*(m_tau*IT_0009*IT_0025*U_stau_01 + mu_h*U_stau_11)));
    ...
    const ccomplex_t IT_0043 = 2*U_stau_01*(((-0.5)*m_W*IT_0039*(IT_0001 + 
      -IT_0000*IT_0041) + IT_0001*IT_0004*IT_0025*IT_0033*IT_0042)*conj
      (U_stau_01) + 1./2*IT_0001*IT_0025*IT_0032*IT_0036*conj(U_stau_11)) +
       U_stau_11*(IT_0001*IT_0025*IT_0032*IT_0036*conj(U_stau_01) + (-2)*(m_W
      *IT_0000*IT_0039*IT_0041 + -IT_0001*IT_0004*IT_0025*IT_0033*IT_0042)*conj
      (U_stau_11));
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*(e_em*IT_0043 +
       1.4142135623731*A_tau*IT_0033*(conj(U_stau_01)*U_stau_11 + U_stau_01*conj
      (U_stau_11)));
    ...
    const ccomplex_t IT_0054 = (-2)*U_stau_01*((IT_0001*IT_0004*IT_0025
      *IT_0032*IT_0042 + (-0.5)*m_W*(IT_0001 + -IT_0000*IT_0041)*IT_0053)*conj
      (U_stau_01) + -1./2*IT_0001*IT_0025*IT_0033*IT_0036*conj(U_stau_11)) +
       U_stau_11*(IT_0001*IT_0025*IT_0033*IT_0036*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0004*IT_0025*IT_0032*IT_0042 + -m_W*IT_0000*IT_0041*IT_0053)
      *conj(U_stau_11));
    const ccomplex_t IT_0055 = (0 + _Complex_I*-1)*(e_em*IT_0054 + (
      -1.4142135623731)*A_tau*IT_0032*(conj(U_stau_01)*U_stau_11 + U_stau_01
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0065 = (-2)*U_stau_01*((IT_0001*IT_0004*IT_0025
      *IT_0032*IT_0042 + (-0.5)*m_W*(IT_0001 + -IT_0000*IT_0041)*IT_0053)*conj
      (U_stau_01) + -1./2*IT_0001*IT_0025*IT_0033*IT_0036*conj(U_stau_11)) +
       U_stau_11*(IT_0001*IT_0025*IT_0033*IT_0036*conj(U_stau_01) + (-2)*
      (IT_0001*IT_0004*IT_0025*IT_0032*IT_0042 + -m_W*IT_0000*IT_0041*IT_0053)
    ...
    const ccomplex_t IT_0071 = 2*U_stau_01*(((-0.5)*m_W*IT_0039*(IT_0001 + 
      -IT_0000*IT_0041) + IT_0001*IT_0004*IT_0025*IT_0033*IT_0042)*conj
      (U_stau_01) + 1./2*IT_0001*IT_0025*IT_0032*IT_0036*conj(U_stau_11)) +
       U_stau_11*(IT_0001*IT_0025*IT_0032*IT_0036*conj(U_stau_01) + (-2)*(m_W
      *IT_0000*IT_0039*IT_0041 + -IT_0001*IT_0004*IT_0025*IT_0033*IT_0042)*conj
