        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (-2)*U_stau_01*(((-0.5)*m_W*IT_0013*(IT_0005 + 
      -IT_0004*IT_0015) + IT_0000*IT_0002*IT_0003*IT_0005*IT_0016)*conj
      (U_stau_01) + -1./2*IT_0002*IT_0005*IT_0008*IT_0009*conj(U_stau_11)) +
       U_stau_11*(IT_0002*IT_0005*IT_0008*IT_0009*conj(U_stau_01) + 2*(m_W
    ...
    const ccomplex_t IT_0030 = 2*U_stau_01*((IT_0000*IT_0002*IT_0005*IT_0009
      *IT_0016 + (-0.5)*m_W*(IT_0005 + -IT_0004*IT_0015)*IT_0029)*conj(U_stau_01
      ) + 1./2*IT_0002*IT_0003*IT_0005*IT_0008*conj(U_stau_11)) + U_stau_11*
      (IT_0002*IT_0003*IT_0005*IT_0008*conj(U_stau_01) + 2*(IT_0000*IT_0002
      *IT_0005*IT_0009*IT_0016 + -m_W*IT_0004*IT_0015*IT_0029)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0005
      *IT_0014 + -IT_0004*IT_0039)*U_stau_01*conj(U_stau_01) + IT_0004*IT_0039
    ...
    const ccomplex_t IT_0063 = m_d*IT_0062;
    const ccomplex_t IT_0064 = m_d*IT_0041;
    ...
    const ccomplex_t IT_0074 = m_d*s_14;
    const ccomplex_t IT_0075 = (-6)*IT_0052;
    const ccomplex_t IT_0076 = m_d*e_em*IT_0000*IT_0002*IT_0005*IT_0010;
    const ccomplex_t IT_0077 = (-0.5)*IT_0076;
    const ccomplex_t IT_0078 = e_em*mu_h*m_tau*IT_0000*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0079 = IT_0005*IT_0078;
    const ccomplex_t IT_0080 = e_em*mu_h*m_tau*IT_0000*U_stau_01*conj
      (U_stau_11);
    ...
    const ccomplex_t IT_0093 = m_d*e_em*IT_0000*IT_0005;
    ...
    const ccomplex_t IT_0130 = m_d*s_13;
