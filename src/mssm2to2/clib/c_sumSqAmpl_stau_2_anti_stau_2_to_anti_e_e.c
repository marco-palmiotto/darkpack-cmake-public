        ...
        )
{
    ...
    const ccomplex_t IT_0107 = (-2)*U_stau_01*(((-0.5)*m_W*IT_0104*(IT_0003 + 
      -IT_0002*IT_0105) + IT_0003*IT_0028*IT_0033*IT_0097*IT_0106)*conj
      (U_stau_01) + -1./2*IT_0003*IT_0033*IT_0100*IT_0101*conj(U_stau_11)) +
       U_stau_11*(IT_0003*IT_0033*IT_0100*IT_0101*conj(U_stau_01) + 2*(m_W
      *IT_0002*IT_0104*IT_0105 + -IT_0003*IT_0028*IT_0033*IT_0097*IT_0106)*conj
      (U_stau_11));
    const ccomplex_t IT_0108 = (0 + _Complex_I*-1)*(e_em*IT_0107 + (
      -1.4142135623731)*A_tau*IT_0097*(conj(U_stau_01)*U_stau_11 + U_stau_01
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0119 = 2*U_stau_01*((IT_0003*IT_0028*IT_0033*IT_0101
      *IT_0106 + (-0.5)*m_W*(IT_0003 + -IT_0002*IT_0105)*IT_0118)*conj(U_stau_01
      ) + 1./2*IT_0003*IT_0033*IT_0097*IT_0100*conj(U_stau_11)) + U_stau_11*
      (IT_0003*IT_0033*IT_0097*IT_0100*conj(U_stau_01) + 2*(IT_0003*IT_0028
      *IT_0033*IT_0101*IT_0106 + -m_W*IT_0002*IT_0105*IT_0118)*conj(U_stau_11));
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*(e_em*IT_0119 +
       1.4142135623731*A_tau*IT_0101*(conj(U_stau_01)*U_stau_11 + U_stau_01*conj
      (U_stau_11)));
