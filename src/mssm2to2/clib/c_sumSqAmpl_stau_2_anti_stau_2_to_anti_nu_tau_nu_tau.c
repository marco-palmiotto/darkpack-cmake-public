...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_stau_2_to_anti_nu_tau_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = e_em*U_Wm2*conj(U_stau_01);
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = cos(beta);
    const ccomplex_t IT_0005 = cpow(IT_0004, -1);
    const ccomplex_t IT_0006 = IT_0001*IT_0005;
    const ccomplex_t IT_0007 = pow(m_W, -1);
    const ccomplex_t IT_0008 = U_d2*e_em*m_tau*IT_0007*conj(U_stau_11);
    ...
    const ccomplex_t IT_0012 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0013 = IT_0001*IT_0012;
    const ccomplex_t IT_0014 = conj(U_d2)*e_em*m_tau*IT_0007*U_stau_11;
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0023 + -IT_0000*IT_0024)*U_stau_01*conj(U_stau_01) + IT_0000*IT_0024
    ...
    const ccomplex_t IT_0037 = e_em*U_Wm1*conj(U_stau_01);
    const ccomplex_t IT_0038 = IT_0001*IT_0037;
    const ccomplex_t IT_0039 = U_d1*e_em*m_tau*IT_0007*conj(U_stau_11);
    ...
    const ccomplex_t IT_0043 = e_em*conj(U_Wm1)*U_stau_01;
    const ccomplex_t IT_0044 = IT_0001*IT_0043;
    const ccomplex_t IT_0045 = conj(U_d1)*e_em*m_tau*IT_0007*U_stau_11;
