        ...
        )
{
    ...
    const ccomplex_t IT_0004 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0014*IT_0015 +
       -IT_0013*IT_0016)*U_stau_01*conj(U_stau_01) + IT_0014*IT_0015*U_stau_11
      *conj(U_stau_11));
    ...
    const ccomplex_t IT_0063 = (-2)*U_stau_01*(((-0.5)*m_W*IT_0060*(IT_0016 + 
      -IT_0015*IT_0061) + IT_0016*IT_0049*IT_0051*IT_0052*IT_0062)*conj
      (U_stau_01) + -1./2*IT_0016*IT_0051*IT_0055*IT_0056*conj(U_stau_11)) +
       U_stau_11*(IT_0016*IT_0051*IT_0055*IT_0056*conj(U_stau_01) + 2*(m_W
      *IT_0015*IT_0060*IT_0061 + -IT_0016*IT_0049*IT_0051*IT_0052*IT_0062)*conj
      (U_stau_11));
    const ccomplex_t IT_0064 = (0 + _Complex_I*-1)*(e_em*IT_0063 + (
      -1.4142135623731)*A_tau*IT_0052*(conj(U_stau_01)*U_stau_11 + U_stau_01
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0075 = 2*U_stau_01*((IT_0016*IT_0049*IT_0051*IT_0056
      *IT_0062 + (-0.5)*m_W*(IT_0016 + -IT_0015*IT_0061)*IT_0074)*conj(U_stau_01
      ) + 1./2*IT_0016*IT_0051*IT_0052*IT_0055*conj(U_stau_11)) + U_stau_11*
      (IT_0016*IT_0051*IT_0052*IT_0055*conj(U_stau_01) + 2*(IT_0016*IT_0049
      *IT_0051*IT_0056*IT_0062 + -m_W*IT_0015*IT_0061*IT_0074)*conj(U_stau_11));
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*(e_em*IT_0075 +
       1.4142135623731*A_tau*IT_0056*(conj(U_stau_01)*U_stau_11 + U_stau_01*conj
      (U_stau_11)));
    ...
    const ccomplex_t IT_0088 = e_em*mu_h*m_tau*IT_0049*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0089 = IT_0016*IT_0051*IT_0057;
    const ccomplex_t IT_0090 = IT_0088*IT_0089;
    const ccomplex_t IT_0091 = e_em*mu_h*m_tau*IT_0049*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0092 = IT_0089*IT_0091;
    const ccomplex_t IT_0093 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0094 = IT_0050*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = A_tau*U_stau_01*conj(U_stau_11);
