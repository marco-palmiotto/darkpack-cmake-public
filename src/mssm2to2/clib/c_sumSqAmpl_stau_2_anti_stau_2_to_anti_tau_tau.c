        ...
        )
{
    ...
    const ccomplex_t IT_0002 = N_B4*e_em*conj(U_stau_01);
    const ccomplex_t IT_0003 = IT_0001*IT_0002;
    const ccomplex_t IT_0004 = 1.4142135623731*IT_0003;
    const ccomplex_t IT_0005 = sin(theta_W);
    const ccomplex_t IT_0006 = cpow(IT_0005, -1);
    const ccomplex_t IT_0007 = N_W4*e_em*conj(U_stau_01);
    ...
    const ccomplex_t IT_0014 = N_d4*e_em*m_tau*IT_0013*conj(U_stau_11);
    ...
    const ccomplex_t IT_0019 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0020 = IT_0001*IT_0019;
    const ccomplex_t IT_0021 = 1.4142135623731*IT_0020;
    const ccomplex_t IT_0022 = N_d4*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0029 = pow(m_tau, 2);
    const ccomplex_t IT_0030 = pow(m_stau_2, 2);
    ...
    const ccomplex_t IT_0033 = IT_0001*IT_0005;
    const ccomplex_t IT_0034 = e_em*IT_0033;
    const ccomplex_t IT_0035 = IT_0000*IT_0006;
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*(0.5*(IT_0001*IT_0005 +
       -IT_0000*IT_0006)*U_stau_01*conj(U_stau_01) + IT_0001*IT_0005*U_stau_11
      *conj(U_stau_11));
    const ccomplex_t IT_0043 = -IT_0042;
    const ccomplex_t IT_0044 = m_tau*IT_0043;
    const ccomplex_t IT_0045 = (-2)*IT_0042;
    const ccomplex_t IT_0046 = m_tau*IT_0045;
    const ccomplex_t IT_0047 = -IT_0046;
    const ccomplex_t IT_0048 = IT_0044 + IT_0047;
    const ccomplex_t IT_0049 = IT_0041*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*e_em*IT_0001*IT_0005;
    ...
    const ccomplex_t IT_0055 = cpow(s_23 + (-0.5)*IT_0029 + (-0.5)*IT_0030 +
       0.5*m_N_1*(m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0056 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0057 = IT_0001*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = N_d1*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0064 = N_B1*e_em*conj(U_stau_01);
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = N_W1*e_em*conj(U_stau_01);
    const ccomplex_t IT_0068 = IT_0006*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = N_d1*e_em*m_tau*IT_0013*conj(U_stau_11);
    ...
    const ccomplex_t IT_0090 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0091 = IT_0001*IT_0090;
    const ccomplex_t IT_0092 = 1.4142135623731*IT_0091;
    const ccomplex_t IT_0093 = N_d2*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0113 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0114 = IT_0001*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = N_d3*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0122 = IT_0100*IT_0101*IT_0121;
    const ccomplex_t IT_0123 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0124 = IT_0001*IT_0123;
    const ccomplex_t IT_0125 = 1.4142135623731*IT_0124;
    const ccomplex_t IT_0126 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0127 = IT_0006*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0137 = m_tau*IT_0136;
    const ccomplex_t IT_0138 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0139 = IT_0001*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0142 = IT_0006*IT_0141;
    const ccomplex_t IT_0143 = 1.4142135623731*IT_0142;
    const ccomplex_t IT_0144 = conj(N_d2)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0164 = IT_0112*IT_0163;
    ...
    const ccomplex_t IT_0183 = 0.5*IT_0032 + -IT_0049 + IT_0053 + 0.5*IT_0076 
      + 0.5*IT_0099 + 0.5*IT_0122 + (-0.5)*IT_0137 + (-0.5)*IT_0152 + (-0.5)
      *IT_0167 + (-0.5)*IT_0182;
    const ccomplex_t IT_0184 = IT_0041*IT_0045;
    const ccomplex_t IT_0185 = 0.5*IT_0136 + 0.5*IT_0151 + 0.5*IT_0166 + 0.5
      *IT_0181 + -IT_0184;
    ...
    const ccomplex_t IT_0204 = IT_0045*IT_0052;
    const ccomplex_t IT_0205 = conj(N_B3)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0206 = IT_0001*IT_0205;
    const ccomplex_t IT_0207 = 1.4142135623731*IT_0206;
    const ccomplex_t IT_0208 = conj(N_d3)*e_em*m_tau*IT_0013*conj(U_stau_01);
    ...
    const ccomplex_t IT_0216 = conj(N_B4)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0217 = IT_0001*IT_0216;
    const ccomplex_t IT_0218 = 1.4142135623731*IT_0217;
    const ccomplex_t IT_0219 = conj(N_d4)*e_em*m_tau*IT_0013*conj(U_stau_01);
    ...
    const ccomplex_t IT_0227 = conj(N_B1)*e_em*conj(U_stau_11);
    const ccomplex_t IT_0228 = IT_0001*IT_0227;
    const ccomplex_t IT_0229 = 1.4142135623731*IT_0228;
    const ccomplex_t IT_0230 = conj(N_d1)*e_em*m_tau*IT_0013*conj(U_stau_01);
    ...
    const ccomplex_t IT_0249 = -IT_0204 + 0.5*IT_0215 + 0.5*IT_0226 + 0.5
      *IT_0237 + 0.5*IT_0248;
    const ccomplex_t IT_0250 = 4*IT_0202;
    const ccomplex_t IT_0251 = s_14*m_tau;
    const ccomplex_t IT_0252 = IT_0178*IT_0223;
    const ccomplex_t IT_0253 = IT_0028*IT_0031*IT_0252;
    const ccomplex_t IT_0254 = IT_0133*IT_0234;
    const ccomplex_t IT_0255 = IT_0054*IT_0055*IT_0254;
    const ccomplex_t IT_0256 = IT_0148*IT_0245;
    const ccomplex_t IT_0257 = IT_0077*IT_0078*IT_0256;
    const ccomplex_t IT_0258 = IT_0163*IT_0212;
    const ccomplex_t IT_0259 = IT_0100*IT_0101*IT_0258;
    const ccomplex_t IT_0260 = m_tau*IT_0237;
    const ccomplex_t IT_0261 = m_tau*IT_0248;
    const ccomplex_t IT_0262 = m_tau*IT_0215;
    const ccomplex_t IT_0263 = m_tau*IT_0226;
    const ccomplex_t IT_0264 = IT_0049 + -IT_0053 + 0.5*IT_0253 + 0.5*IT_0255 
      + 0.5*IT_0257 + 0.5*IT_0259 + (-0.5)*IT_0260 + (-0.5)*IT_0261 + (-0.5)
      *IT_0262 + (-0.5)*IT_0263;
    ...
    const ccomplex_t IT_0279 = 2*U_stau_01*((IT_0006*IT_0011*IT_0013*IT_0029
      *IT_0269 + (-0.5)*m_W*IT_0277*(IT_0006 + -IT_0005*IT_0278))*conj(U_stau_01
      ) + 1./2*IT_0006*IT_0011*IT_0272*IT_0273*conj(U_stau_11)) + U_stau_11*
      (IT_0006*IT_0011*IT_0272*IT_0273*conj(U_stau_01) + 2*(IT_0006*IT_0011
      *IT_0013*IT_0029*IT_0269 + -m_W*IT_0005*IT_0277*IT_0278)*conj(U_stau_11));
    const ccomplex_t IT_0280 = (0 + _Complex_I*1)*(e_em*IT_0279 +
       1.4142135623731*A_tau*IT_0269*(conj(U_stau_01)*U_stau_11 + U_stau_01*conj
      (U_stau_11)));
    ...
    const ccomplex_t IT_0291 = (-2)*U_stau_01*((IT_0006*IT_0011*IT_0013
      *IT_0029*IT_0273 + (-0.5)*m_W*(IT_0006 + -IT_0005*IT_0278)*IT_0290)*conj
      (U_stau_01) + -1./2*IT_0006*IT_0011*IT_0269*IT_0272*conj(U_stau_11)) +
       U_stau_11*(IT_0006*IT_0011*IT_0269*IT_0272*conj(U_stau_01) + (-2)*
      (IT_0006*IT_0011*IT_0013*IT_0029*IT_0273 + -m_W*IT_0005*IT_0278*IT_0290)
      *conj(U_stau_11));
    const ccomplex_t IT_0292 = (0 + _Complex_I*-1)*(e_em*IT_0291 + (
      -1.4142135623731)*A_tau*IT_0273*(conj(U_stau_01)*U_stau_11 + U_stau_01
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0301 = -IT_0029;
    const ccomplex_t IT_0302 = s_34 + IT_0301;
    const ccomplex_t IT_0303 = 0.5*conj(IT_0264);
    const ccomplex_t IT_0304 = e_em*m_tau*IT_0006*IT_0011*IT_0013*IT_0275;
    const ccomplex_t IT_0305 = (-0.5)*IT_0304;
    const ccomplex_t IT_0306 = e_em*mu_h*m_tau*IT_0013*conj(U_stau_01)
      *U_stau_11;
    const ccomplex_t IT_0307 = IT_0006*IT_0306;
    const ccomplex_t IT_0308 = e_em*mu_h*m_tau*IT_0013*U_stau_01*conj
      (U_stau_11);
    const ccomplex_t IT_0309 = IT_0006*IT_0308;
    const ccomplex_t IT_0310 = A_tau*conj(U_stau_01)*U_stau_11;
    const ccomplex_t IT_0311 = IT_0275*IT_0310;
    const ccomplex_t IT_0312 = 1.4142135623731*IT_0311;
    const ccomplex_t IT_0313 = A_tau*U_stau_01*conj(U_stau_11);
    const ccomplex_t IT_0314 = IT_0275*IT_0313;
    const ccomplex_t IT_0315 = 1.4142135623731*IT_0314;
    const ccomplex_t IT_0316 = (-0.5)*IT_0307 + 0.5*IT_0309 + (-0.5)*IT_0312 +
       0.5*IT_0315;
    const ccomplex_t IT_0317 = IT_0305*IT_0316;
    const ccomplex_t IT_0318 = cpow((-2)*s_12 + (-2)*IT_0030 + m_A0*(m_A0 + (0
       + _Complex_I*-1)*Gamma_A0) + -reg_prop, -1);
    const ccomplex_t IT_0319 = IT_0317*IT_0318;
    const ccomplex_t IT_0320 = (0 + _Complex_I*1)*IT_0319;
    const ccomplex_t IT_0321 = e_em*m_tau*IT_0006*IT_0013;
    const ccomplex_t IT_0322 = 0.5*IT_0321;
    const ccomplex_t IT_0323 = IT_0006*IT_0011*IT_0275;
    const ccomplex_t IT_0324 = IT_0306*IT_0323;
    const ccomplex_t IT_0325 = IT_0308*IT_0323;
    const ccomplex_t IT_0326 = IT_0010*IT_0310;
    const ccomplex_t IT_0327 = 1.4142135623731*IT_0326;
    const ccomplex_t IT_0328 = IT_0010*IT_0313;
    const ccomplex_t IT_0329 = 1.4142135623731*IT_0328;
    const ccomplex_t IT_0330 = (-0.5)*IT_0324 + 0.5*IT_0325 + 0.5*IT_0327 + (
      -0.5)*IT_0329;
    const ccomplex_t IT_0331 = IT_0322*IT_0330;
    const ccomplex_t IT_0332 = pow(m_Z, 2);
    const ccomplex_t IT_0333 = cpow((-2)*s_12 + (-2)*IT_0030 + IT_0332 + 
      -reg_prop, -1);
    ...
    const ccomplex_t IT_0338 = m_tau*IT_0337;
    const ccomplex_t IT_0339 = -conj(IT_0249);
    const ccomplex_t IT_0340 = s_34 + IT_0029;
    const ccomplex_t IT_0341 = (-2)*conj(IT_0183);
    const ccomplex_t IT_0342 = (-4)*IT_0202;
    const ccomplex_t IT_0343 = 0.5*IT_0194*IT_0342;
    const ccomplex_t IT_0344 = conj(IT_0336)*IT_0340;
    const ccomplex_t IT_0345 = 2*IT_0183*(conj(IT_0185)*IT_0186 + 0.5*conj
      ...
      *IT_0302*((IT_0183 + IT_0264)*conj(IT_0298) + 2*IT_0298*(0.5*conj(IT_0183)
       + conj(IT_0298) + IT_0303)) + (-2)*IT_0336*(IT_0338*(conj(IT_0185) +
       IT_0339) + (-2)*IT_0340*(IT_0303 + conj(IT_0336) + 0.25*IT_0341)) + 2
      *IT_0185*(conj(IT_0183)*IT_0186 + 2*conj(IT_0185)*IT_0191 + -IT_0251*conj
      (IT_0264) + -conj(IT_0336)*IT_0338 + IT_0192*IT_0339 + IT_0343) + (-2)
      *IT_0249*(conj(IT_0185)*IT_0192 + (-2)*IT_0191*conj(IT_0249) + -IT_0186
      *conj(IT_0264) + -conj(IT_0336)*IT_0338 + (-0.5)*IT_0251*IT_0341 + 
      -IT_0343) + IT_0299*(conj(IT_0249)*IT_0251 + IT_0029*conj(IT_0264) +
       IT_0344) + 2*IT_0264*(IT_0186*conj(IT_0249) + IT_0187*IT_0303 + 0.5
      *IT_0029*IT_0341 + IT_0344);
