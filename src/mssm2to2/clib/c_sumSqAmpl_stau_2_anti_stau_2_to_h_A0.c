        ...
        )
{
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*e_em*((-0.5)*(IT_0001
      *IT_0015 + -IT_0000*IT_0081)*U_stau_01*conj(U_stau_01) + IT_0000*IT_0081
    ...
    const ccomplex_t IT_0104 = cpow((-2)*s_23 + IT_0027 + IT_0047 + reg_prop +
       -m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1), -1);
