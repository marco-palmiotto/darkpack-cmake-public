...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_stau_2_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0014 = (-0.5)*(IT_0005*(IT_0007 + -IT_0013) + IT_0003*
      (IT_0007 + -(1 + (-2)*IT_0008*IT_0009*IT_0011)*IT_0013))*U_stau_01*conj
      (U_stau_01) + ((IT_0003 + IT_0005)*IT_0007 + IT_0002*IT_0008*IT_0009
      *IT_0011*IT_0013)*U_stau_11*conj(U_stau_11);
    ...
    const ccomplex_t IT_0034 = cpow((-2)*s_23 + IT_0032 + IT_0033 + reg_prop +
    ...
    const ccomplex_t IT_0043 = 2*U_stau_01*((IT_0001*IT_0009*IT_0017*IT_0019
      *IT_0020 + 0.5*m_W*(IT_0007*IT_0012 + -IT_0020)*IT_0024)*conj(U_stau_01) +
       1./2*IT_0004*IT_0018*IT_0019*IT_0020*conj(U_stau_11)) + U_stau_11*
      (IT_0004*IT_0018*IT_0019*IT_0020*conj(U_stau_01) + 2*(IT_0001*IT_0009
      *IT_0017*IT_0019*IT_0020 + -m_W*IT_0007*IT_0012*IT_0024)*conj(U_stau_11));
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0032 + reg_prop + (0 +
    ...
    const ccomplex_t IT_0053 = cpow((-2)*s_13 + IT_0032 + reg_prop + (0 +
       _Complex_I*1)*m_stau_2*Gamma_tau2, -1);
    ...
    const ccomplex_t IT_0061 = (-2)*U_stau_01*((IT_0004*IT_0009*IT_0017
      *IT_0019*IT_0020 + 0.5*m_W*(IT_0007*IT_0012 + -IT_0020)*IT_0060)*conj
      (U_stau_01) + -1./2*IT_0001*IT_0018*IT_0019*IT_0020*conj(U_stau_11)) +
       U_stau_11*(IT_0001*IT_0018*IT_0019*IT_0020*conj(U_stau_01) + (-2)*
      (IT_0004*IT_0009*IT_0017*IT_0019*IT_0020 + -m_W*IT_0007*IT_0012*IT_0060)
      *conj(U_stau_11));
    const ccomplex_t IT_0062 = (0 + _Complex_I*-1)*(e_em*IT_0061 + (
      -1.4142135623731)*A_tau*IT_0004*(conj(U_stau_01)*U_stau_11 + U_stau_01
      *conj(U_stau_11)));
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0032 + IT_0033 + reg_prop +
       -m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1), -1);
