        ...
        )
{
    ...
    const ccomplex_t IT_0027 = 2*U_stau_01*((IT_0001*IT_0009*IT_0019*IT_0021
      *IT_0022 + 0.5*m_W*(IT_0007*IT_0012 + -IT_0022)*IT_0026)*conj(U_stau_01) +
       1./2*IT_0004*IT_0020*IT_0021*IT_0022*conj(U_stau_11)) + U_stau_11*
    ...
    const ccomplex_t IT_0033 = cpow((-2)*s_23 + IT_0017 + reg_prop + (0 +
       _Complex_I*1)*m_stau_2*Gamma_tau2, -1);
    ...
    const ccomplex_t IT_0043 = cpow((-2)*s_13 + IT_0017 + IT_0042 + reg_prop +
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_23 + IT_0017 + IT_0042 + reg_prop +
       -m_stau_1*(m_stau_1 + (0 + _Complex_I*-1)*Gamma_tau1), -1);
    ...
    const ccomplex_t IT_0064 = (-2)*U_stau_01*((IT_0004*IT_0009*IT_0019
      *IT_0021*IT_0022 + 0.5*m_W*(IT_0007*IT_0012 + -IT_0022)*IT_0063)*conj
      (U_stau_01) + -1./2*IT_0001*IT_0020*IT_0021*IT_0022*conj(U_stau_11)) +
       U_stau_11*(IT_0001*IT_0020*IT_0021*IT_0022*conj(U_stau_01) + (-2)*
