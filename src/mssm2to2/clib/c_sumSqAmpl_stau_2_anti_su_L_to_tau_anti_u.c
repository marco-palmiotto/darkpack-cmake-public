        ...
        )
{
    ...
    const ccomplex_t IT_0173 = IT_0026*IT_0156;
    const ccomplex_t IT_0174 = IT_0030*IT_0112*IT_0173;
    const ccomplex_t IT_0175 = IT_0051*IT_0162;
    const ccomplex_t IT_0176 = IT_0053*IT_0123*IT_0175;
    const ccomplex_t IT_0177 = IT_0074*IT_0168;
    const ccomplex_t IT_0178 = IT_0076*IT_0134*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0006*IT_0021*IT_0154;
    const ccomplex_t IT_0180 = (-0.5)*IT_0179;
    const ccomplex_t IT_0181 = IT_0147*IT_0180;
    ...
    const ccomplex_t IT_0185 = IT_0098*IT_0180;
    const ccomplex_t IT_0186 = IT_0079*IT_0149*IT_0185;
    const ccomplex_t IT_0187 = (-0.5)*IT_0160 + (-0.5)*IT_0166 + (-0.5)
      *IT_0172 + 0.5*IT_0174 + 0.5*IT_0176 + 0.5*IT_0178 + (-0.5)*IT_0184 + 0.5
      *IT_0186;
