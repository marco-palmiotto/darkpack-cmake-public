...
ccomplex_return_t c_sumSqAmpl_stau_2_anti_su_L_to_tau_anti_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0161 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0006*IT_0021*IT_0154;
    ...
    const ccomplex_t IT_0173 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0006*IT_0021*IT_0154;
    ...
    const ccomplex_t IT_0189 = 0.5*IT_0159 + 0.5*IT_0165 + 0.5*IT_0171 + 0.5
      *IT_0185;
    const ccomplex_t IT_0190 = m_u*m_tau*IT_0029;
