        ...
        )
{
    ...
    const ccomplex_t IT_0019 = m_b*conj(N_d1)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0025 = conj(N_B1)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0035 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0036 = IT_0004*IT_0035;
    const ccomplex_t IT_0037 = 1.4142135623731*IT_0036;
    const ccomplex_t IT_0038 = N_d2*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0043 = m_b*conj(N_d2)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0049 = conj(N_B2)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0059 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0060 = IT_0004*IT_0059;
    const ccomplex_t IT_0061 = 1.4142135623731*IT_0060;
    const ccomplex_t IT_0062 = N_d3*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0067 = m_b*conj(N_d3)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0083 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0084 = IT_0004*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = N_d4*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0091 = m_b*conj(N_d4)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0097 = conj(N_W4)*e_em*U_sb_00;
    const ccomplex_t IT_0098 = IT_0011*IT_0097;
    const ccomplex_t IT_0099 = 1.4142135623731*IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1)*(IT_0093 + 0.333333333333333
      *IT_0096 + -IT_0099);
    ...
    const ccomplex_t IT_0143 = m_b*N_d2*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0162 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0163 = IT_0004*IT_0162;
    const ccomplex_t IT_0164 = 1.4142135623731*IT_0163;
    const ccomplex_t IT_0165 = m_b*N_d4*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0204 = IT_0054*IT_0139;
    const ccomplex_t IT_0205 = IT_0034*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0207 = IT_0078*IT_0183;
    const ccomplex_t IT_0208 = IT_0058*IT_0206*IT_0207;
    const ccomplex_t IT_0209 = m_tau*IT_0033;
    const ccomplex_t IT_0210 = m_tau*IT_0057;
    const ccomplex_t IT_0211 = m_tau*IT_0081;
    const ccomplex_t IT_0212 = m_tau*IT_0105;
    const ccomplex_t IT_0213 = (-0.5)*IT_0205 + (-0.5)*IT_0208 + 0.5*IT_0209 +
       0.5*IT_0210 + 0.5*IT_0211 + 0.5*IT_0212;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0215 = IT_0030*IT_0117;
    const ccomplex_t IT_0216 = IT_0002*IT_0214*IT_0215;
    const ccomplex_t IT_0217 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0218 = IT_0102*IT_0161;
    const ccomplex_t IT_0219 = IT_0082*IT_0217*IT_0218;
    ...
    const ccomplex_t IT_0224 = IT_0090*IT_0169;
    const ccomplex_t IT_0225 = IT_0082*IT_0217*IT_0224;
    const ccomplex_t IT_0226 = m_tau*IT_0128;
    const ccomplex_t IT_0227 = m_tau*IT_0150;
    const ccomplex_t IT_0228 = m_tau*IT_0172;
    const ccomplex_t IT_0229 = IT_0018*IT_0125;
    const ccomplex_t IT_0230 = IT_0002*IT_0214*IT_0229;
    const ccomplex_t IT_0231 = IT_0066*IT_0191;
    const ccomplex_t IT_0232 = IT_0058*IT_0206*IT_0231;
    const ccomplex_t IT_0233 = m_tau*IT_0194;
    const ccomplex_t IT_0234 = (-0.5)*IT_0225 + 0.5*IT_0226 + 0.5*IT_0227 +
       0.5*IT_0228 + (-0.5)*IT_0230 + (-0.5)*IT_0232 + 0.5*IT_0233;
    const ccomplex_t IT_0235 = 6*IT_0234;
    const ccomplex_t IT_0236 = IT_0042*IT_0147;
    const ccomplex_t IT_0237 = IT_0034*IT_0203*IT_0236;
