...
ccomplex_return_t c_sumSqAmpl_stau_2_sb_1_to_tau_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = N_B4*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0014 = N_d4*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0019 = m_b*conj(N_d4)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0025 = conj(N_B4)*e_em*U_sb_00;
    ...
    const ccomplex_t IT_0047 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0048 = IT_0004*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = N_d1*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0082 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
       0.5*m_N_3*(m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0083 = m_b*conj(N_d3)*e_em*IT_0013*U_sb_10;
    ...
    const ccomplex_t IT_0106 = 0.5*IT_0033 + 0.5*IT_0057 + 0.5*IT_0081 + 0.5
      *IT_0105;
    const ccomplex_t IT_0107 = N_B2*e_em*U_sb_10;
    const ccomplex_t IT_0108 = IT_0004*IT_0107;
    const ccomplex_t IT_0109 = 1.4142135623731*IT_0108;
    const ccomplex_t IT_0110 = m_b*N_d2*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0129 = N_B4*e_em*U_sb_10;
    const ccomplex_t IT_0130 = IT_0004*IT_0129;
    const ccomplex_t IT_0131 = 1.4142135623731*IT_0130;
    const ccomplex_t IT_0132 = m_b*N_d4*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0151 = N_B1*e_em*U_sb_10;
    const ccomplex_t IT_0152 = IT_0004*IT_0151;
    const ccomplex_t IT_0153 = 1.4142135623731*IT_0152;
    const ccomplex_t IT_0154 = m_b*N_d1*e_em*IT_0013*U_sb_00;
    ...
    const ccomplex_t IT_0165 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0187 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0193 = IT_0082*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*IT_0193;
    const ccomplex_t IT_0195 = 0.5*IT_0128 + 0.5*IT_0150 + 0.5*IT_0172 + 0.5
      *IT_0194;
    const ccomplex_t IT_0196 = m_b*m_tau*IT_0001;
    const ccomplex_t IT_0197 = s_34*IT_0001;
    const ccomplex_t IT_0198 = (-6)*IT_0197;
    const ccomplex_t IT_0199 = s_13*s_14;
    const ccomplex_t IT_0200 = 12*IT_0199;
    const ccomplex_t IT_0201 = IT_0198 + IT_0200;
    const ccomplex_t IT_0202 = m_b*s_13;
    const ccomplex_t IT_0203 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0204 = IT_0094*IT_0191;
    const ccomplex_t IT_0205 = IT_0082*IT_0203*IT_0204;
    const ccomplex_t IT_0206 = m_tau*IT_0057;
    const ccomplex_t IT_0207 = m_tau*IT_0081;
    const ccomplex_t IT_0208 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0209 = IT_0070*IT_0125;
    const ccomplex_t IT_0210 = IT_0058*IT_0208*IT_0209;
    const ccomplex_t IT_0211 = m_tau*IT_0105;
    const ccomplex_t IT_0212 = m_tau*IT_0033;
    const ccomplex_t IT_0213 = (-0.5)*IT_0205 + 0.5*IT_0206 + 0.5*IT_0207 + (
      -0.5)*IT_0210 + 0.5*IT_0211 + 0.5*IT_0212;
    const ccomplex_t IT_0214 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0215 = IT_0030*IT_0147;
    const ccomplex_t IT_0216 = IT_0002*IT_0214*IT_0215;
    const ccomplex_t IT_0217 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0218 = IT_0046*IT_0169;
    const ccomplex_t IT_0219 = IT_0034*IT_0217*IT_0218;
    const ccomplex_t IT_0220 = 0.5*IT_0216 + 0.5*IT_0219;
    const ccomplex_t IT_0221 = IT_0213 + -IT_0220;
    const ccomplex_t IT_0222 = -conj(IT_0220);
    const ccomplex_t IT_0223 = conj(IT_0213) + IT_0222;
    const ccomplex_t IT_0224 = IT_0102*IT_0180;
    const ccomplex_t IT_0225 = IT_0082*IT_0203*IT_0224;
    const ccomplex_t IT_0226 = IT_0018*IT_0136;
    const ccomplex_t IT_0227 = IT_0002*IT_0214*IT_0226;
    const ccomplex_t IT_0228 = IT_0054*IT_0158;
    const ccomplex_t IT_0229 = IT_0034*IT_0217*IT_0228;
    const ccomplex_t IT_0230 = m_tau*IT_0172;
    const ccomplex_t IT_0231 = m_tau*IT_0128;
    const ccomplex_t IT_0232 = m_tau*IT_0194;
    const ccomplex_t IT_0233 = m_tau*IT_0150;
    const ccomplex_t IT_0234 = (-0.5)*IT_0225 + (-0.5)*IT_0227 + (-0.5)
      *IT_0229 + 0.5*IT_0230 + 0.5*IT_0231 + 0.5*IT_0232 + 0.5*IT_0233;
    const ccomplex_t IT_0235 = 6*IT_0234;
    const ccomplex_t IT_0236 = IT_0078*IT_0114;
    const ccomplex_t IT_0237 = IT_0058*IT_0208*IT_0236;
    const ccomplex_t IT_0238 = 0.5*IT_0237;
    const ccomplex_t IT_0239 = (-6)*IT_0238;
    const ccomplex_t IT_0240 = IT_0235 + IT_0239;
    const ccomplex_t IT_0241 = 6*conj(IT_0234);
    const ccomplex_t IT_0242 = (-6)*conj(IT_0238);
    const ccomplex_t IT_0243 = IT_0241 + IT_0242;
    const ccomplex_t IT_0244 = m_b*m_tau;
    const ccomplex_t IT_0245 = 6*IT_0238;
    const ccomplex_t IT_0246 = (-6)*IT_0234;
    const ccomplex_t IT_0247 = IT_0245 + IT_0246;
    const ccomplex_t IT_0248 = 6*conj(IT_0238);
    const ccomplex_t IT_0249 = (-6)*conj(IT_0234);
    const ccomplex_t IT_0250 = IT_0248 + IT_0249;
    const ccomplex_t IT_0251 = 6*s_34;
    const ccomplex_t IT_0252 = (-6)*s_34;
    const ccomplex_t IT_0253 = (-0.166666666666667)*IT_0195;
    const ccomplex_t IT_0254 = s_14*m_tau;
    const ccomplex_t IT_0255 = (-6)*conj(IT_0106)*(IT_0195*IT_0196 + (
      -0.166666666666667)*IT_0106*IT_0201) + 6*IT_0202*(conj(IT_0195)*IT_0221 +
       IT_0195*IT_0223 + 0.166666666666667*conj(IT_0106)*IT_0240 +
       0.166666666666667*IT_0106*IT_0243) + IT_0244*(conj(IT_0220)*IT_0240 +
       IT_0220*IT_0243 + conj(IT_0213)*IT_0247 + IT_0213*IT_0250) + (IT_0213
      *conj(IT_0213) + IT_0220*conj(IT_0220) + IT_0234*conj(IT_0234) + IT_0238
      *conj(IT_0238))*IT_0251 + (conj(IT_0213)*IT_0220 + IT_0213*conj(IT_0220) +
       conj(IT_0234)*IT_0238 + IT_0234*conj(IT_0238))*IT_0252 + (-6)*conj
      (IT_0195)*(IT_0106*IT_0196 + IT_0201*IT_0253) + (-6)*(conj(IT_0106)
      *IT_0221 + IT_0106*IT_0223 + (-0.166666666666667)*conj(IT_0195)*IT_0247 +
       IT_0250*IT_0253)*IT_0254;
