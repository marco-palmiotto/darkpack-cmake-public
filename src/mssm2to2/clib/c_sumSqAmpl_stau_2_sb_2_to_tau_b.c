        ...
        )
{
    ...
    const ccomplex_t IT_0042 = m_b*conj(N_d2)*e_em*IT_0013*U_sb_11;
    ...
    const ccomplex_t IT_0058 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0059 = IT_0004*IT_0058;
    const ccomplex_t IT_0060 = 1.4142135623731*IT_0059;
    const ccomplex_t IT_0061 = N_d4*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0066 = m_b*conj(N_d4)*e_em*IT_0013*U_sb_11;
    ...
    const ccomplex_t IT_0088 = m_b*conj(N_d3)*e_em*IT_0013*U_sb_11;
    ...
    const ccomplex_t IT_0093 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0094 = IT_0004*IT_0093;
    const ccomplex_t IT_0095 = 1.4142135623731*IT_0094;
    const ccomplex_t IT_0096 = N_d3*e_em*m_tau*IT_0013*U_stau_01;
    ...
    const ccomplex_t IT_0104 = 0.5*IT_0032 + 0.5*IT_0056 + 0.5*IT_0080 + 0.5
      *IT_0103;
    const ccomplex_t IT_0105 = conj(N_B1)*e_em*U_stau_01;
    const ccomplex_t IT_0106 = IT_0004*IT_0105;
    const ccomplex_t IT_0107 = 1.4142135623731*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W1)*e_em*U_stau_01;
    const ccomplex_t IT_0109 = IT_0011*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = conj(N_d1)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0119 = m_b*N_d1*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0130 = m_b*N_d3*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0141 = conj(N_d3)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0147 = IT_0081*IT_0146;
    ...
    const ccomplex_t IT_0155 = conj(N_d4)*e_em*m_tau*IT_0013*U_stau_11;
    ...
    const ccomplex_t IT_0160 = N_B4*e_em*U_sb_11;
    const ccomplex_t IT_0161 = IT_0004*IT_0160;
    const ccomplex_t IT_0162 = 1.4142135623731*IT_0161;
    const ccomplex_t IT_0163 = m_b*N_d4*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0182 = N_B2*e_em*U_sb_11;
    const ccomplex_t IT_0183 = IT_0004*IT_0182;
    const ccomplex_t IT_0184 = 1.4142135623731*IT_0183;
    const ccomplex_t IT_0185 = m_b*N_d2*e_em*IT_0013*U_sb_01;
    ...
    const ccomplex_t IT_0202 = IT_0092*IT_0145;
    const ccomplex_t IT_0203 = IT_0081*IT_0201*IT_0202;
    const ccomplex_t IT_0204 = m_tau*IT_0032;
    const ccomplex_t IT_0205 = m_tau*IT_0056;
    const ccomplex_t IT_0206 = m_tau*IT_0103;
    const ccomplex_t IT_0207 = m_tau*IT_0080;
    const ccomplex_t IT_0208 = (-0.5)*IT_0203 + 0.5*IT_0204 + 0.5*IT_0205 +
       0.5*IT_0206 + 0.5*IT_0207;
    const ccomplex_t IT_0209 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0210 = IT_0077*IT_0159;
    const ccomplex_t IT_0211 = IT_0057*IT_0209*IT_0210;
    const ccomplex_t IT_0212 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0213 = IT_0053*IT_0181;
    const ccomplex_t IT_0214 = IT_0033*IT_0212*IT_0213;
    const ccomplex_t IT_0215 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0216 = IT_0029*IT_0115;
    const ccomplex_t IT_0217 = IT_0002*IT_0215*IT_0216;
    const ccomplex_t IT_0218 = 0.5*IT_0211 + 0.5*IT_0214 + 0.5*IT_0217;
    const ccomplex_t IT_0219 = IT_0208 + -IT_0218;
    const ccomplex_t IT_0220 = -conj(IT_0218);
    const ccomplex_t IT_0221 = conj(IT_0208) + IT_0220;
    const ccomplex_t IT_0222 = IT_0065*IT_0167;
    const ccomplex_t IT_0223 = IT_0057*IT_0209*IT_0222;
    const ccomplex_t IT_0224 = m_tau*IT_0126;
    const ccomplex_t IT_0225 = m_tau*IT_0170;
    const ccomplex_t IT_0226 = IT_0018*IT_0123;
    const ccomplex_t IT_0227 = IT_0002*IT_0215*IT_0226;
    const ccomplex_t IT_0228 = m_tau*IT_0192;
    const ccomplex_t IT_0229 = m_tau*IT_0148;
    const ccomplex_t IT_0230 = (-0.5)*IT_0223 + 0.5*IT_0224 + 0.5*IT_0225 + (
      -0.5)*IT_0227 + 0.5*IT_0228 + 0.5*IT_0229;
    const ccomplex_t IT_0231 = 6*IT_0230;
    const ccomplex_t IT_0232 = IT_0041*IT_0189;
    const ccomplex_t IT_0233 = IT_0033*IT_0212*IT_0232;
    const ccomplex_t IT_0234 = IT_0100*IT_0134;
    const ccomplex_t IT_0235 = IT_0081*IT_0201*IT_0234;
    const ccomplex_t IT_0236 = 0.5*IT_0233 + 0.5*IT_0235;
    const ccomplex_t IT_0237 = (-6)*IT_0236;
    const ccomplex_t IT_0238 = IT_0231 + IT_0237;
    const ccomplex_t IT_0239 = 6*conj(IT_0230);
    ...
    const ccomplex_t IT_0253 = (-6)*conj(IT_0104)*(IT_0193*IT_0194 + (
      -0.166666666666667)*IT_0104*IT_0199) + 6*IT_0200*(conj(IT_0193)*IT_0219 +
       ...
       IT_0218*IT_0241 + conj(IT_0208)*IT_0245 + IT_0208*IT_0248) + (IT_0208
      *conj(IT_0208) + IT_0218*conj(IT_0218) + IT_0230*conj(IT_0230) + IT_0236
      *conj(IT_0236))*IT_0249 + (conj(IT_0208)*IT_0218 + IT_0208*conj(IT_0218) +
       conj(IT_0230)*IT_0236 + IT_0230*conj(IT_0236))*IT_0250 + (-6)*conj
