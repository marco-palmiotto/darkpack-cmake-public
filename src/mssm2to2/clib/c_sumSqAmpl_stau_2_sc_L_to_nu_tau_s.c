...
ccomplex_return_t c_sumSqAmpl_stau_2_sc_L_to_nu_tau_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0002 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp1)
      *IT_0001;
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*conj(V_cs)*e_em*conj(V_Wp2)
      *IT_0001;
    const ccomplex_t IT_0019 = e_em*conj(U_Wm2)*U_stau_01;
    const ccomplex_t IT_0020 = IT_0001*IT_0019;
    const ccomplex_t IT_0021 = conj(U_d2)*e_em*m_tau*IT_0008*U_stau_11;
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*conj
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*conj
      (V_cs)*e_em*IT_0001*IT_0006*IT_0008;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = IT_0024*IT_0036;
    const ccomplex_t IT_0038 = IT_0027*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*IT_0038;
    const ccomplex_t IT_0040 = (-0.5)*IT_0034 + (-0.5)*IT_0039;
    const ccomplex_t IT_0041 = m_s*s_13;
    const ccomplex_t IT_0042 = s_13*s_14;
    const ccomplex_t IT_0043 = s_34*IT_0015;
    return create_ccomplex_return(6*IT_0029*(s_34*conj(IT_0029) + conj(IT_0040
      )*IT_0041) + 6*IT_0040*(conj(IT_0029)*IT_0041 + 0.166666666666667*conj
      (IT_0040)*(12*IT_0042 + (-6)*IT_0043)));
}
