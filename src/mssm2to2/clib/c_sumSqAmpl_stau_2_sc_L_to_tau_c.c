...
ccomplex_return_t c_sumSqAmpl_stau_2_sc_L_to_tau_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0022 = N_d1*e_em*m_tau*IT_0021*U_stau_01;
    const ccomplex_t IT_0023 = IT_0020*IT_0022;
    const ccomplex_t IT_0024 = 1.4142135623731*IT_0023;
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*(IT_0017 + 0.5*IT_0024);
    ...
    const ccomplex_t IT_0030 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0039 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0040 = IT_0004*IT_0039;
    const ccomplex_t IT_0041 = 1.4142135623731*IT_0040;
    const ccomplex_t IT_0042 = N_d2*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0050 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0062 = N_d3*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*IT_0001 +
    ...
    const ccomplex_t IT_0082 = N_d4*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0090 = 0.5*IT_0029 + 0.5*IT_0049 + 0.5*IT_0069 + 0.5
      *IT_0089;
    ...
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0009*IT_0021*IT_0092;
    ...
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0009*IT_0021*IT_0092;
    const ccomplex_t IT_0142 = (-0.5)*IT_0141;
    const ccomplex_t IT_0143 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0144 = IT_0004*IT_0143;
    const ccomplex_t IT_0145 = 1.4142135623731*IT_0144;
    const ccomplex_t IT_0146 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0147 = IT_0009*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = conj(N_d3)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0157 = 0.5*IT_0108 + 0.5*IT_0124 + 0.5*IT_0140 + 0.5
      *IT_0156;
    const ccomplex_t IT_0158 = m_c*m_tau*IT_0001;
    const ccomplex_t IT_0159 = s_34*IT_0001;
    ...
    const ccomplex_t IT_0164 = m_c*s_13;
    const ccomplex_t IT_0165 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0166 = IT_0038*IT_0135;
    const ccomplex_t IT_0167 = IT_0030*IT_0165*IT_0166;
    const ccomplex_t IT_0168 = m_tau*IT_0049;
    const ccomplex_t IT_0169 = m_tau*IT_0069;
    const ccomplex_t IT_0170 = m_tau*IT_0089;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0172 = IT_0058*IT_0153;
    const ccomplex_t IT_0173 = IT_0050*IT_0171*IT_0172;
    const ccomplex_t IT_0174 = m_tau*IT_0029;
    const ccomplex_t IT_0175 = (-0.5)*IT_0167 + 0.5*IT_0168 + 0.5*IT_0169 +
       0.5*IT_0170 + (-0.5)*IT_0173 + 0.5*IT_0174;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0177 = IT_0014*IT_0105;
    const ccomplex_t IT_0178 = IT_0002*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0180 = IT_0078*IT_0121;
    const ccomplex_t IT_0181 = IT_0070*IT_0179*IT_0180;
    const ccomplex_t IT_0182 = 0.5*IT_0178 + 0.5*IT_0181;
    const ccomplex_t IT_0183 = IT_0175 + -IT_0182;
    const ccomplex_t IT_0184 = -conj(IT_0182);
    const ccomplex_t IT_0185 = conj(IT_0175) + IT_0184;
    const ccomplex_t IT_0186 = IT_0086*IT_0110;
    const ccomplex_t IT_0187 = IT_0070*IT_0179*IT_0186;
    const ccomplex_t IT_0188 = IT_0066*IT_0142;
    const ccomplex_t IT_0189 = IT_0050*IT_0171*IT_0188;
    const ccomplex_t IT_0190 = m_tau*IT_0140;
    const ccomplex_t IT_0191 = m_tau*IT_0156;
    const ccomplex_t IT_0192 = IT_0026*IT_0094;
    const ccomplex_t IT_0193 = IT_0002*IT_0176*IT_0192;
    const ccomplex_t IT_0194 = m_tau*IT_0108;
    const ccomplex_t IT_0195 = m_tau*IT_0124;
    const ccomplex_t IT_0196 = (-0.5)*IT_0187 + (-0.5)*IT_0189 + 0.5*IT_0190 +
       0.5*IT_0191 + (-0.5)*IT_0193 + 0.5*IT_0194 + 0.5*IT_0195;
    const ccomplex_t IT_0197 = 6*IT_0196;
    const ccomplex_t IT_0198 = IT_0046*IT_0137;
    const ccomplex_t IT_0199 = IT_0030*IT_0165*IT_0198;
    const ccomplex_t IT_0200 = 0.5*IT_0199;
    const ccomplex_t IT_0201 = (-6)*IT_0200;
    const ccomplex_t IT_0202 = IT_0197 + IT_0201;
    const ccomplex_t IT_0203 = 6*conj(IT_0196);
    const ccomplex_t IT_0204 = (-6)*conj(IT_0200);
    const ccomplex_t IT_0205 = IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = m_c*m_tau;
    const ccomplex_t IT_0207 = 6*IT_0200;
    const ccomplex_t IT_0208 = (-6)*IT_0196;
    const ccomplex_t IT_0209 = IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = 6*conj(IT_0200);
    const ccomplex_t IT_0211 = (-6)*conj(IT_0196);
    const ccomplex_t IT_0212 = IT_0210 + IT_0211;
    const ccomplex_t IT_0213 = 6*s_34;
    const ccomplex_t IT_0214 = (-6)*s_34;
    const ccomplex_t IT_0215 = (-0.166666666666667)*IT_0157;
    const ccomplex_t IT_0216 = s_14*m_tau;
    const ccomplex_t IT_0217 = (-6)*conj(IT_0090)*(IT_0157*IT_0158 + (
      -0.166666666666667)*IT_0090*IT_0163) + 6*IT_0164*(conj(IT_0157)*IT_0183 +
       IT_0157*IT_0185 + 0.166666666666667*conj(IT_0090)*IT_0202 +
       0.166666666666667*IT_0090*IT_0205) + IT_0206*(conj(IT_0182)*IT_0202 +
       IT_0182*IT_0205 + conj(IT_0175)*IT_0209 + IT_0175*IT_0212) + (IT_0175
      *conj(IT_0175) + IT_0182*conj(IT_0182) + IT_0196*conj(IT_0196) + IT_0200
      *conj(IT_0200))*IT_0213 + (conj(IT_0175)*IT_0182 + IT_0175*conj(IT_0182) +
       conj(IT_0196)*IT_0200 + IT_0196*conj(IT_0200))*IT_0214 + (-6)*conj
      (IT_0157)*(IT_0090*IT_0158 + IT_0163*IT_0215) + (-6)*(conj(IT_0090)
      *IT_0183 + IT_0090*IT_0185 + (-0.166666666666667)*conj(IT_0157)*IT_0209 +
       IT_0212*IT_0215)*IT_0216;
