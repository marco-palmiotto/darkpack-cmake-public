...
ccomplex_return_t c_sumSqAmpl_stau_2_sc_R_to_tau_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = N_B1*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0015 = N_d1*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0027 = 0.5*IT_0026;
    const ccomplex_t IT_0028 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0029 = IT_0008*IT_0028;
    const ccomplex_t IT_0030 = 1.4142135623731*IT_0029;
    const ccomplex_t IT_0031 = N_d2*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0040 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0043 = IT_0008*IT_0042;
    const ccomplex_t IT_0044 = 1.4142135623731*IT_0043;
    const ccomplex_t IT_0045 = N_d3*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0054 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0055 = 0.5*IT_0054;
    const ccomplex_t IT_0056 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0057 = IT_0008*IT_0056;
    const ccomplex_t IT_0058 = 1.4142135623731*IT_0057;
    const ccomplex_t IT_0059 = N_d4*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0093 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0109 = conj(N_d3)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0140 = m_c*s_13;
    ...
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0145 = IT_0027*IT_0097;
    const ccomplex_t IT_0146 = IT_0037*IT_0144*IT_0145;
    const ccomplex_t IT_0147 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0148 = IT_0055*IT_0129;
    const ccomplex_t IT_0149 = IT_0065*IT_0147*IT_0148;
    const ccomplex_t IT_0150 = 0.5*IT_0143 + 0.5*IT_0146 + 0.5*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0152 = IT_0041*IT_0113;
    const ccomplex_t IT_0153 = IT_0051*IT_0151*IT_0152;
    const ccomplex_t IT_0154 = m_tau*IT_0025;
    const ccomplex_t IT_0155 = m_tau*IT_0039;
    const ccomplex_t IT_0156 = m_tau*IT_0053;
    const ccomplex_t IT_0157 = m_tau*IT_0067;
    const ccomplex_t IT_0158 = (-0.5)*IT_0153 + 0.5*IT_0154 + 0.5*IT_0155 +
       0.5*IT_0156 + 0.5*IT_0157;
    const ccomplex_t IT_0159 = IT_0150 + -IT_0158;
    const ccomplex_t IT_0160 = -conj(IT_0158);
    const ccomplex_t IT_0161 = conj(IT_0150) + IT_0160;
    const ccomplex_t IT_0162 = IT_0019*IT_0070;
    const ccomplex_t IT_0163 = IT_0023*IT_0141*IT_0162;
    const ccomplex_t IT_0164 = IT_0063*IT_0118;
    const ccomplex_t IT_0165 = IT_0065*IT_0147*IT_0164;
    const ccomplex_t IT_0166 = m_tau*IT_0084;
    const ccomplex_t IT_0167 = m_tau*IT_0100;
    const ccomplex_t IT_0168 = m_tau*IT_0116;
    const ccomplex_t IT_0169 = m_tau*IT_0132;
    const ccomplex_t IT_0170 = (-0.5)*IT_0163 + (-0.5)*IT_0165 + 0.5*IT_0166 +
       0.5*IT_0167 + 0.5*IT_0168 + 0.5*IT_0169;
    const ccomplex_t IT_0171 = 6*IT_0170;
    const ccomplex_t IT_0172 = IT_0035*IT_0086;
    const ccomplex_t IT_0173 = IT_0037*IT_0144*IT_0172;
    const ccomplex_t IT_0174 = IT_0049*IT_0102;
    const ccomplex_t IT_0175 = IT_0051*IT_0151*IT_0174;
    ...
    const ccomplex_t IT_0182 = s_14*m_tau;
    ...
    const ccomplex_t IT_0189 = m_c*m_tau;
    const ccomplex_t IT_0190 = 6*s_34;
    const ccomplex_t IT_0191 = (-6)*s_34;
    const ccomplex_t IT_0192 = (-6)*conj(IT_0068)*(IT_0133*IT_0134 + (
      -0.166666666666667)*IT_0068*IT_0139) + (-6)*conj(IT_0133)*(IT_0068*IT_0134
       + (-0.166666666666667)*IT_0133*IT_0139) + (-6)*IT_0140*(conj(IT_0133)
      *IT_0159 + IT_0133*IT_0161 + (-0.166666666666667)*conj(IT_0068)*IT_0178 + 
      (-0.166666666666667)*IT_0068*IT_0181) + 6*IT_0182*(conj(IT_0068)*IT_0159 +
       IT_0068*IT_0161 + 0.166666666666667*conj(IT_0133)*IT_0185 +
       0.166666666666667*IT_0133*IT_0188) + (conj(IT_0150)*IT_0178 + IT_0150
      *IT_0181 + conj(IT_0158)*IT_0185 + IT_0158*IT_0188)*IT_0189 + (IT_0150
      *conj(IT_0150) + IT_0158*conj(IT_0158) + IT_0170*conj(IT_0170) + IT_0176
      *conj(IT_0176))*IT_0190 + (conj(IT_0150)*IT_0158 + IT_0150*conj(IT_0158) +
       conj(IT_0170)*IT_0176 + IT_0170*conj(IT_0176))*IT_0191;
