...
ccomplex_return_t c_sumSqAmpl_stau_2_sd_L_to_tau_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = N_B2*e_em*U_stau_11;
    ...
    const ccomplex_t IT_0019 = N_d2*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0038 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0039 = IT_0001*IT_0038;
    const ccomplex_t IT_0040 = 1.4142135623731*IT_0039;
    const ccomplex_t IT_0041 = N_d3*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0061 = N_d4*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0070 = cpow(s_13 + (-0.5)*IT_0025 + (-0.5)*IT_0026 +
    ...
    const ccomplex_t IT_0074 = N_d1*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0147 = conj(N_d4)*e_em*m_tau*IT_0018*U_stau_11;
    ...
    const ccomplex_t IT_0162 = m_d*m_tau;
    ...
    const ccomplex_t IT_0167 = IT_0057*IT_0151;
    const ccomplex_t IT_0168 = IT_0067*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = m_tau*IT_0029;
    const ccomplex_t IT_0170 = m_tau*IT_0049;
    const ccomplex_t IT_0171 = m_tau*IT_0069;
    const ccomplex_t IT_0172 = m_tau*IT_0089;
    const ccomplex_t IT_0173 = (-0.5)*IT_0165 + (-0.5)*IT_0168 + 0.5*IT_0169 +
       0.5*IT_0170 + 0.5*IT_0171 + 0.5*IT_0172;
    const ccomplex_t IT_0174 = IT_0078*IT_0092;
    const ccomplex_t IT_0175 = IT_0070*IT_0163*IT_0174;
    const ccomplex_t IT_0176 = IT_0045*IT_0124;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0178 = IT_0047*IT_0176*IT_0177;
    const ccomplex_t IT_0179 = IT_0065*IT_0140;
    const ccomplex_t IT_0180 = IT_0067*IT_0166*IT_0179;
    const ccomplex_t IT_0181 = 0.5*IT_0175 + 0.5*IT_0178 + 0.5*IT_0180;
    const ccomplex_t IT_0182 = 6*IT_0181;
    const ccomplex_t IT_0183 = m_tau*IT_0106;
    const ccomplex_t IT_0184 = m_tau*IT_0138;
    const ccomplex_t IT_0185 = m_tau*IT_0154;
    const ccomplex_t IT_0186 = m_tau*IT_0122;
    const ccomplex_t IT_0187 = IT_0023*IT_0108;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0189 = IT_0027*IT_0187*IT_0188;
    const ccomplex_t IT_0190 = 0.5*IT_0183 + 0.5*IT_0184 + 0.5*IT_0185 + 0.5
      *IT_0186 + (-0.5)*IT_0189;
    const ccomplex_t IT_0191 = (-6)*IT_0190;
    const ccomplex_t IT_0192 = IT_0182 + IT_0191;
    const ccomplex_t IT_0193 = 6*conj(IT_0181);
    const ccomplex_t IT_0194 = (-6)*conj(IT_0190);
    const ccomplex_t IT_0195 = IT_0193 + IT_0194;
    const ccomplex_t IT_0196 = IT_0011*IT_0119;
    const ccomplex_t IT_0197 = IT_0027*IT_0188*IT_0196;
    const ccomplex_t IT_0198 = IT_0037*IT_0135;
    const ccomplex_t IT_0199 = IT_0047*IT_0177*IT_0198;
    const ccomplex_t IT_0200 = 0.5*IT_0197 + 0.5*IT_0199;
    const ccomplex_t IT_0201 = 6*IT_0190;
    const ccomplex_t IT_0202 = (-6)*IT_0181;
    const ccomplex_t IT_0203 = IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = 6*conj(IT_0190);
    const ccomplex_t IT_0205 = (-6)*conj(IT_0181);
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = m_d*s_13;
    const ccomplex_t IT_0208 = IT_0173 + -IT_0200;
    const ccomplex_t IT_0209 = -conj(IT_0200);
    const ccomplex_t IT_0210 = conj(IT_0173) + IT_0209;
    ...
    const ccomplex_t IT_0215 = (-6)*conj(IT_0090)*(IT_0155*IT_0156 + (
      -0.166666666666667)*IT_0090*IT_0161) + IT_0162*(conj(IT_0173)*IT_0192 +
       IT_0173*IT_0195 + conj(IT_0200)*IT_0203 + IT_0200*IT_0206) + 6*IT_0207*
      (0.166666666666667*conj(IT_0090)*IT_0203 + 0.166666666666667*IT_0090
      *IT_0206 + conj(IT_0155)*IT_0208 + IT_0155*IT_0210) + (IT_0173*conj
      (IT_0173) + IT_0181*conj(IT_0181) + IT_0190*conj(IT_0190) + IT_0200*conj
      (IT_0200))*IT_0211 + (conj(IT_0181)*IT_0190 + IT_0181*conj(IT_0190) + conj
      (IT_0173)*IT_0200 + IT_0173*conj(IT_0200))*IT_0212 + (-6)*conj(IT_0155)*
      (IT_0090*IT_0156 + IT_0161*IT_0213) + (-6)*((-0.166666666666667)*conj
      (IT_0155)*IT_0192 + conj(IT_0090)*IT_0208 + IT_0090*IT_0210 + IT_0195
      *IT_0213)*IT_0214;
