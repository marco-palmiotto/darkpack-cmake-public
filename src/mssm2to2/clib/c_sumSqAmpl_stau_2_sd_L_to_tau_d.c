        ...
        )
{
    ...
    const ccomplex_t IT_0099 = conj(N_d1)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0115 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0131 = conj(N_d3)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0137 = IT_0050*IT_0136;
    ...
    const ccomplex_t IT_0147 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0155 = 0.5*IT_0106 + 0.5*IT_0122 + 0.5*IT_0138 + 0.5
      *IT_0154;
    const ccomplex_t IT_0156 = m_d*m_tau*IT_0001;
    ...
    const ccomplex_t IT_0164 = IT_0058*IT_0135;
    const ccomplex_t IT_0165 = IT_0050*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = m_tau*IT_0029;
    const ccomplex_t IT_0167 = m_tau*IT_0049;
    const ccomplex_t IT_0168 = m_tau*IT_0069;
    const ccomplex_t IT_0169 = m_tau*IT_0089;
    const ccomplex_t IT_0170 = (-0.5)*IT_0165 + 0.5*IT_0166 + 0.5*IT_0167 +
       0.5*IT_0168 + 0.5*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0172 = IT_0078*IT_0151;
    const ccomplex_t IT_0173 = IT_0070*IT_0171*IT_0172;
    const ccomplex_t IT_0174 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0175 = IT_0014*IT_0103;
    const ccomplex_t IT_0176 = IT_0002*IT_0174*IT_0175;
    const ccomplex_t IT_0177 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0178 = IT_0038*IT_0119;
    const ccomplex_t IT_0179 = IT_0030*IT_0177*IT_0178;
    const ccomplex_t IT_0180 = 0.5*IT_0173 + 0.5*IT_0176 + 0.5*IT_0179;
    ...
    const ccomplex_t IT_0184 = IT_0086*IT_0140;
    const ccomplex_t IT_0185 = IT_0070*IT_0171*IT_0184;
    const ccomplex_t IT_0186 = m_tau*IT_0154;
    const ccomplex_t IT_0187 = IT_0026*IT_0092;
    const ccomplex_t IT_0188 = IT_0002*IT_0174*IT_0187;
    const ccomplex_t IT_0189 = m_tau*IT_0106;
    const ccomplex_t IT_0190 = m_tau*IT_0122;
    const ccomplex_t IT_0191 = m_tau*IT_0138;
    const ccomplex_t IT_0192 = (-0.5)*IT_0185 + 0.5*IT_0186 + (-0.5)*IT_0188 +
       0.5*IT_0189 + 0.5*IT_0190 + 0.5*IT_0191;
    const ccomplex_t IT_0193 = 6*IT_0192;
    const ccomplex_t IT_0194 = IT_0046*IT_0108;
    const ccomplex_t IT_0195 = IT_0030*IT_0177*IT_0194;
    const ccomplex_t IT_0196 = IT_0066*IT_0124;
    const ccomplex_t IT_0197 = IT_0050*IT_0163*IT_0196;
    ...
    const ccomplex_t IT_0204 = m_d*m_tau;
    ...
    const ccomplex_t IT_0215 = (-6)*conj(IT_0090)*(IT_0155*IT_0156 + (
      -0.166666666666667)*IT_0090*IT_0161) + 6*IT_0162*(conj(IT_0155)*IT_0181 +
       IT_0155*IT_0183 + 0.166666666666667*conj(IT_0090)*IT_0200 +
       0.166666666666667*IT_0090*IT_0203) + IT_0204*(conj(IT_0180)*IT_0200 +
       IT_0180*IT_0203 + conj(IT_0170)*IT_0207 + IT_0170*IT_0210) + (IT_0170
      *conj(IT_0170) + IT_0180*conj(IT_0180) + IT_0192*conj(IT_0192) + IT_0198
      *conj(IT_0198))*IT_0211 + (conj(IT_0170)*IT_0180 + IT_0170*conj(IT_0180) +
       conj(IT_0192)*IT_0198 + IT_0192*conj(IT_0198))*IT_0212 + (-6)*conj
      (IT_0155)*(IT_0090*IT_0156 + IT_0161*IT_0213) + (-6)*(conj(IT_0090)
      *IT_0181 + IT_0090*IT_0183 + (-0.166666666666667)*conj(IT_0155)*IT_0207 +
       IT_0210*IT_0213)*IT_0214;
