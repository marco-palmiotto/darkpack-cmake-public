        ...
        )
{
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0091 = conj(N_d4)*e_em*m_tau*IT_0003*U_stau_11;
    ...
    const ccomplex_t IT_0131 = 0.5*IT_0082 + 0.5*IT_0098 + 0.5*IT_0114 + 0.5
      *IT_0130;
    const ccomplex_t IT_0132 = m_d*m_tau*IT_0001;
    ...
    const ccomplex_t IT_0138 = m_d*s_13;
    const ccomplex_t IT_0139 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0140 = IT_0026*IT_0109;
    ...
    const ccomplex_t IT_0146 = IT_0040*IT_0127;
    const ccomplex_t IT_0147 = IT_0038*IT_0145*IT_0146;
    const ccomplex_t IT_0148 = m_tau*IT_0023;
    const ccomplex_t IT_0149 = (-0.5)*IT_0141 + 0.5*IT_0142 + 0.5*IT_0143 +
       0.5*IT_0144 + (-0.5)*IT_0147 + 0.5*IT_0148;
    ...
    const ccomplex_t IT_0163 = IT_0038*IT_0145*IT_0162;
    const ccomplex_t IT_0164 = m_tau*IT_0114;
    const ccomplex_t IT_0165 = m_tau*IT_0130;
    const ccomplex_t IT_0166 = IT_0020*IT_0068;
    const ccomplex_t IT_0167 = IT_0002*IT_0150*IT_0166;
    const ccomplex_t IT_0168 = m_tau*IT_0082;
    const ccomplex_t IT_0169 = m_tau*IT_0098;
    const ccomplex_t IT_0170 = (-0.5)*IT_0161 + (-0.5)*IT_0163 + 0.5*IT_0164 +
       0.5*IT_0165 + (-0.5)*IT_0167 + 0.5*IT_0168 + 0.5*IT_0169;
    const ccomplex_t IT_0171 = 6*IT_0170;
    const ccomplex_t IT_0172 = IT_0034*IT_0111;
    const ccomplex_t IT_0173 = IT_0024*IT_0139*IT_0172;
    const ccomplex_t IT_0174 = 0.5*IT_0173;
    const ccomplex_t IT_0175 = (-6)*IT_0174;
    const ccomplex_t IT_0176 = IT_0171 + IT_0175;
    const ccomplex_t IT_0177 = 6*conj(IT_0170);
    ...
    const ccomplex_t IT_0191 = (-6)*conj(IT_0066)*(IT_0131*IT_0132 + (
      -0.166666666666667)*IT_0066*IT_0137) + 6*IT_0138*(conj(IT_0131)*IT_0157 +
       ...
       IT_0156*IT_0179 + conj(IT_0149)*IT_0183 + IT_0149*IT_0186) + (IT_0149
      *conj(IT_0149) + IT_0156*conj(IT_0156) + IT_0170*conj(IT_0170) + IT_0174
      *conj(IT_0174))*IT_0187 + (conj(IT_0149)*IT_0156 + IT_0149*conj(IT_0156) +
       conj(IT_0170)*IT_0174 + IT_0170*conj(IT_0174))*IT_0188 + (-6)*conj
