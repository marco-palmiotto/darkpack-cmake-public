        ...
        )
{
    ...
    const ccomplex_t IT_0046 = cpow(s_23 + (-0.5)*IT_0025 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0060 = N_d4*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0066 = cpow(s_23 + (-0.5)*IT_0025 + 0.5*m_N_4*(m_N_4 +
    ...
    const ccomplex_t IT_0069 = cpow(s_23 + (-0.5)*IT_0025 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0073 = N_d3*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0098 = conj(N_d1)*e_em*m_tau*IT_0018*U_stau_11;
    ...
    const ccomplex_t IT_0141 = conj(N_d3)*e_em*m_tau*IT_0018*U_stau_11;
    ...
    const ccomplex_t IT_0155 = 2*s_34*(IT_0091*conj(IT_0091) + IT_0148*conj
      (IT_0148)) + (-2)*((conj(IT_0091) + -conj(IT_0148))*IT_0149 + (IT_0091 + 
      -IT_0148)*conj(IT_0149))*IT_0150 + 4*IT_0149*conj(IT_0149)*(IT_0151 + (
      -0.5)*IT_0153) + (conj(IT_0091)*IT_0148 + IT_0091*conj(IT_0148))*IT_0154;
