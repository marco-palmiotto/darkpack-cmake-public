...
ccomplex_return_t c_sumSqAmpl_stau_2_snu_e_to_nu_e_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0044 = IT_0006*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0053 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0076 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_3*(m_N_3 +
    ...
    const ccomplex_t IT_0086 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0087 = IT_0001*IT_0086;
    const ccomplex_t IT_0088 = 1.4142135623731*IT_0087;
    const ccomplex_t IT_0089 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0090 = IT_0006*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0112 = m_tau*IT_0111;
    ...
    const ccomplex_t IT_0116 = N_d2*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0125 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0126 = IT_0001*IT_0125;
    const ccomplex_t IT_0127 = 1.4142135623731*IT_0126;
    const ccomplex_t IT_0128 = N_d3*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0140 = N_d4*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0145 = IT_0085*IT_0144;
    ...
    const ccomplex_t IT_0149 = (-0.5)*IT_0031 + (-0.5)*IT_0054 + (-0.5)
      *IT_0077 + (-0.5)*IT_0100 + 0.5*IT_0112 + 0.5*IT_0124 + 0.5*IT_0136 + 0.5
      *IT_0148;
    const ccomplex_t IT_0150 = 0.5*IT_0111 + 0.5*IT_0123 + 0.5*IT_0135 + 0.5
      *IT_0147;
    const ccomplex_t IT_0151 = s_13*m_tau;
    const ccomplex_t IT_0152 = s_13*s_14;
    const ccomplex_t IT_0153 = pow(m_stau_2, 2);
    const ccomplex_t IT_0154 = s_34*IT_0153;
    return create_ccomplex_return(2*IT_0149*(s_34*conj(IT_0149) + -conj
      (IT_0150)*IT_0151) + (-2)*IT_0150*(conj(IT_0149)*IT_0151 + (-2)*conj
      (IT_0150)*(IT_0152 + (-0.5)*IT_0154)));
}
