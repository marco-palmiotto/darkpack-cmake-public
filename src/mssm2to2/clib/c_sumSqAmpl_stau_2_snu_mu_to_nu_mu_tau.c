...
ccomplex_return_t c_sumSqAmpl_stau_2_snu_mu_to_nu_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0040 = conj(N_B4)*e_em*U_stau_01;
    const ccomplex_t IT_0041 = IT_0001*IT_0040;
    const ccomplex_t IT_0042 = 1.4142135623731*IT_0041;
    const ccomplex_t IT_0043 = conj(N_W4)*e_em*U_stau_01;
    const ccomplex_t IT_0044 = IT_0006*IT_0043;
    const ccomplex_t IT_0045 = 1.4142135623731*IT_0044;
    const ccomplex_t IT_0046 = conj(N_d4)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0055 = 0.5*IT_0031 + 0.5*IT_0054;
    ...
    const ccomplex_t IT_0064 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0065 = IT_0001*IT_0064;
    const ccomplex_t IT_0066 = 1.4142135623731*IT_0065;
    const ccomplex_t IT_0067 = conj(N_W2)*e_em*U_stau_01;
    const ccomplex_t IT_0068 = IT_0006*IT_0067;
    const ccomplex_t IT_0069 = 1.4142135623731*IT_0068;
    const ccomplex_t IT_0070 = conj(N_d2)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0077 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_2*(m_N_2 +
    ...
    const ccomplex_t IT_0082 = N_d1*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0091 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0092 = IT_0001*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = N_d2*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0104 = cpow(s_23 + (-0.5)*IT_0029 + 0.5*m_N_3*(m_N_3 +
       (0 + _Complex_I*-1)*Gamma_o3) + (-0.5)*reg_prop, -1);
    const ccomplex_t IT_0105 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0106 = IT_0001*IT_0105;
    const ccomplex_t IT_0107 = 1.4142135623731*IT_0106;
    const ccomplex_t IT_0108 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0109 = IT_0006*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = conj(N_d3)*e_em*m_tau*IT_0021*U_stau_11;
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*(IT_0118 + -IT_0121);
    const ccomplex_t IT_0123 = (-0.5)*IT_0122;
    const ccomplex_t IT_0124 = IT_0115*IT_0123;
    const ccomplex_t IT_0125 = IT_0103*IT_0104*IT_0124;
    const ccomplex_t IT_0126 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0127 = IT_0001*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = N_d3*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0149 = m_tau*IT_0148;
    const ccomplex_t IT_0150 = (-0.5)*IT_0078 + 0.5*IT_0090 + 0.5*IT_0102 + (
      -0.5)*IT_0125 + 0.5*IT_0137 + 0.5*IT_0149;
    const ccomplex_t IT_0151 = 0.5*IT_0089 + 0.5*IT_0101 + 0.5*IT_0136 + 0.5
      *IT_0148;
    const ccomplex_t IT_0152 = s_13*m_tau;
    const ccomplex_t IT_0153 = s_13*s_14;
    const ccomplex_t IT_0154 = pow(m_stau_2, 2);
    const ccomplex_t IT_0155 = s_34*IT_0154;
    const ccomplex_t IT_0156 = (-2)*s_34;
    const ccomplex_t IT_0157 = 2*s_34*(IT_0055*conj(IT_0055) + IT_0150*conj
      (IT_0150)) + 2*((conj(IT_0055) + -conj(IT_0150))*IT_0151 + (IT_0055 + 
      -IT_0150)*conj(IT_0151))*IT_0152 + 4*IT_0151*conj(IT_0151)*(IT_0153 + (
      -0.5)*IT_0155) + (conj(IT_0055)*IT_0150 + IT_0055*conj(IT_0150))*IT_0156;
