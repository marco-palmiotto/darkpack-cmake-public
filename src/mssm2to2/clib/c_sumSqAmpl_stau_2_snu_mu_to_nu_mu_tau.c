        ...
        )
{
    ...
    const ccomplex_t IT_0101 = 0.5*IT_0031 + 0.5*IT_0054 + 0.5*IT_0077 + 0.5
      *IT_0100;
    const ccomplex_t IT_0102 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0103 = IT_0001*IT_0102;
    const ccomplex_t IT_0104 = 1.4142135623731*IT_0103;
    const ccomplex_t IT_0105 = N_d1*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0124 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0125 = IT_0001*IT_0124;
    const ccomplex_t IT_0126 = 1.4142135623731*IT_0125;
    const ccomplex_t IT_0127 = N_d3*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0135 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0136 = IT_0001*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = N_d4*e_em*m_tau*IT_0021*U_stau_01;
    ...
    const ccomplex_t IT_0147 = m_tau*IT_0146;
    const ccomplex_t IT_0148 = 0.5*IT_0147;
    const ccomplex_t IT_0149 = 0.5*IT_0112 + 0.5*IT_0123 + 0.5*IT_0134 + 0.5
      *IT_0145;
    const ccomplex_t IT_0150 = s_13*m_tau;
    const ccomplex_t IT_0151 = s_13*s_14;
    const ccomplex_t IT_0152 = pow(m_stau_2, 2);
    const ccomplex_t IT_0153 = s_34*IT_0152;
    const ccomplex_t IT_0154 = (-2)*s_34;
    const ccomplex_t IT_0155 = 2*s_34*(IT_0101*conj(IT_0101) + IT_0148*conj
      (IT_0148)) + 2*((conj(IT_0101) + -conj(IT_0148))*IT_0149 + (IT_0101 + 
      -IT_0148)*conj(IT_0149))*IT_0150 + 4*IT_0149*conj(IT_0149)*(IT_0151 + (
      -0.5)*IT_0153) + (conj(IT_0101)*IT_0148 + IT_0101*conj(IT_0148))*IT_0154;
