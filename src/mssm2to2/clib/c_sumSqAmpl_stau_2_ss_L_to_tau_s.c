...
ccomplex_return_t c_sumSqAmpl_stau_2_ss_L_to_tau_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow(s_13 + (-0.5)*IT_0025 + (-0.5)*IT_0026 +
    ...
    const ccomplex_t IT_0034 = N_d3*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0079 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0080 = IT_0001*IT_0079;
    const ccomplex_t IT_0081 = 1.4142135623731*IT_0080;
    const ccomplex_t IT_0082 = N_d1*e_em*m_tau*IT_0018*U_stau_01;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_s*N_d2*e_em
      *IT_0006*IT_0016*IT_0018;
    ...
    const ccomplex_t IT_0123 = (0 + _Complex_I*1.4142135623731)*m_s*N_d3*e_em
      *IT_0006*IT_0016*IT_0018;
    ...
    const ccomplex_t IT_0162 = m_s*s_13;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0164 = IT_0057*IT_0151;
    const ccomplex_t IT_0165 = IT_0067*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0167 = IT_0078*IT_0103;
    ...
    const ccomplex_t IT_0190 = 0.5*IT_0184 + 0.5*IT_0185 + (-0.5)*IT_0187 +
       0.5*IT_0188 + 0.5*IT_0189;
    const ccomplex_t IT_0191 = 6*IT_0190;
    const ccomplex_t IT_0192 = IT_0065*IT_0140;
    const ccomplex_t IT_0193 = IT_0067*IT_0163*IT_0192;
    const ccomplex_t IT_0194 = IT_0086*IT_0092;
    const ccomplex_t IT_0195 = IT_0070*IT_0166*IT_0194;
    const ccomplex_t IT_0196 = IT_0038*IT_0124;
    const ccomplex_t IT_0197 = IT_0030*IT_0177*IT_0196;
    const ccomplex_t IT_0198 = 0.5*IT_0193 + 0.5*IT_0195 + 0.5*IT_0197;
    const ccomplex_t IT_0199 = (-6)*IT_0198;
    const ccomplex_t IT_0200 = IT_0191 + IT_0199;
    const ccomplex_t IT_0201 = 6*conj(IT_0190);
    const ccomplex_t IT_0202 = (-6)*conj(IT_0198);
    const ccomplex_t IT_0203 = IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = m_s*m_tau;
    const ccomplex_t IT_0205 = 6*IT_0198;
    const ccomplex_t IT_0206 = (-6)*IT_0190;
    const ccomplex_t IT_0207 = IT_0205 + IT_0206;
    const ccomplex_t IT_0208 = 6*conj(IT_0198);
    const ccomplex_t IT_0209 = (-6)*conj(IT_0190);
    ...
    const ccomplex_t IT_0215 = (-6)*conj(IT_0090)*(IT_0155*IT_0156 + (
      -0.166666666666667)*IT_0090*IT_0161) + 6*IT_0162*(conj(IT_0155)*IT_0181 +
       ...
       IT_0180*IT_0203 + conj(IT_0173)*IT_0207 + IT_0173*IT_0210) + (IT_0173
      *conj(IT_0173) + IT_0180*conj(IT_0180) + IT_0190*conj(IT_0190) + IT_0198
      *conj(IT_0198))*IT_0211 + (conj(IT_0173)*IT_0180 + IT_0173*conj(IT_0180) +
       conj(IT_0190)*IT_0198 + IT_0190*conj(IT_0198))*IT_0212 + (-6)*conj
