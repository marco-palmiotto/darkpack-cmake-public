        ...
        )
{
    ...
    const ccomplex_t IT_0009 = conj(N_B2)*e_em*U_stau_01;
    const ccomplex_t IT_0010 = IT_0008*IT_0009;
    const ccomplex_t IT_0011 = 1.4142135623731*IT_0010;
    const ccomplex_t IT_0012 = conj(N_W2)*e_em*U_stau_01;
    ...
    const ccomplex_t IT_0018 = conj(N_d2)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0031 = conj(N_B3)*e_em*U_stau_01;
    const ccomplex_t IT_0032 = IT_0008*IT_0031;
    const ccomplex_t IT_0033 = 1.4142135623731*IT_0032;
    const ccomplex_t IT_0034 = conj(N_W3)*e_em*U_stau_01;
    const ccomplex_t IT_0035 = IT_0004*IT_0034;
    const ccomplex_t IT_0036 = 1.4142135623731*IT_0035;
    const ccomplex_t IT_0037 = conj(N_d3)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0072 = conj(N_d1)*e_em*m_tau*IT_0000*U_stau_11;
    ...
    const ccomplex_t IT_0089 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0090 = IT_0008*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = N_d2*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0108 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0109 = IT_0008*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = N_d4*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0119 = N_B3*e_em*U_stau_11;
    const ccomplex_t IT_0120 = IT_0008*IT_0119;
    const ccomplex_t IT_0121 = 1.4142135623731*IT_0120;
    const ccomplex_t IT_0122 = N_d3*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0146 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0147 = IT_0008*IT_0146;
    const ccomplex_t IT_0148 = 1.4142135623731*IT_0147;
    const ccomplex_t IT_0149 = N_d1*e_em*m_tau*IT_0000*U_stau_01;
    ...
    const ccomplex_t IT_0167 = IT_0022*IT_0088;
    const ccomplex_t IT_0168 = IT_0026*IT_0166*IT_0167;
    const ccomplex_t IT_0169 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0170 = IT_0041*IT_0134;
    const ccomplex_t IT_0171 = IT_0043*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0173 = IT_0058*IT_0107;
    const ccomplex_t IT_0174 = IT_0060*IT_0172*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0176 = IT_0076*IT_0145;
    const ccomplex_t IT_0177 = IT_0063*IT_0175*IT_0176;
    const ccomplex_t IT_0178 = 0.5*IT_0168 + 0.5*IT_0171 + 0.5*IT_0174 + 0.5
      *IT_0177;
    const ccomplex_t IT_0179 = IT_0028 + IT_0045 + IT_0062 + IT_0079;
    const ccomplex_t IT_0180 = m_u*IT_0179;
    const ccomplex_t IT_0181 = 0.5*IT_0180;
    const ccomplex_t IT_0182 = IT_0178 + -IT_0181;
    const ccomplex_t IT_0183 = -conj(IT_0181);
    const ccomplex_t IT_0184 = conj(IT_0178) + IT_0183;
    const ccomplex_t IT_0185 = IT_0065*IT_0153;
    const ccomplex_t IT_0186 = IT_0063*IT_0175*IT_0185;
    const ccomplex_t IT_0187 = IT_0006*IT_0096;
    const ccomplex_t IT_0188 = IT_0026*IT_0166*IT_0187;
    const ccomplex_t IT_0189 = IT_0030*IT_0126;
    const ccomplex_t IT_0190 = IT_0043*IT_0169*IT_0189;
    const ccomplex_t IT_0191 = IT_0047*IT_0115;
    const ccomplex_t IT_0192 = IT_0060*IT_0172*IT_0191;
    const ccomplex_t IT_0193 = 0.5*IT_0186 + 0.5*IT_0188 + 0.5*IT_0190 + 0.5
      *IT_0192;
    const ccomplex_t IT_0194 = 6*IT_0193;
    const ccomplex_t IT_0195 = IT_0099 + IT_0118 + IT_0137 + IT_0156;
    const ccomplex_t IT_0196 = m_u*IT_0195;
    const ccomplex_t IT_0197 = 0.5*IT_0196;
    const ccomplex_t IT_0198 = (-6)*IT_0197;
    const ccomplex_t IT_0199 = IT_0194 + IT_0198;
    const ccomplex_t IT_0200 = 6*conj(IT_0193);
    const ccomplex_t IT_0201 = (-6)*conj(IT_0197);
    const ccomplex_t IT_0202 = IT_0200 + IT_0201;
    const ccomplex_t IT_0203 = m_u*m_tau;
    const ccomplex_t IT_0204 = 6*IT_0197;
    const ccomplex_t IT_0205 = (-6)*IT_0193;
    const ccomplex_t IT_0206 = IT_0204 + IT_0205;
    const ccomplex_t IT_0207 = 6*conj(IT_0197);
    const ccomplex_t IT_0208 = (-6)*conj(IT_0193);
    const ccomplex_t IT_0209 = IT_0207 + IT_0208;
    const ccomplex_t IT_0210 = s_24*m_tau;
    const ccomplex_t IT_0211 = 6*s_34;
    const ccomplex_t IT_0212 = (-6)*s_34;
    const ccomplex_t IT_0213 = (-6)*conj(IT_0080)*(IT_0157*IT_0159 + (
      -0.166666666666667)*IT_0080*IT_0164) + (-6)*conj(IT_0157)*(IT_0080*IT_0159
       + (-0.166666666666667)*IT_0157*IT_0164) + 6*IT_0165*(conj(IT_0080)
      *IT_0182 + IT_0080*IT_0184 + 0.166666666666667*conj(IT_0157)*IT_0199 +
       0.166666666666667*IT_0157*IT_0202) + IT_0203*(conj(IT_0181)*IT_0199 +
       IT_0181*IT_0202 + conj(IT_0178)*IT_0206 + IT_0178*IT_0209) + (-6)*(conj
      (IT_0157)*IT_0182 + IT_0157*IT_0184 + (-0.166666666666667)*conj(IT_0080)
      *IT_0206 + (-0.166666666666667)*IT_0080*IT_0209)*IT_0210 + (IT_0178*conj
      (IT_0178) + IT_0181*conj(IT_0181) + IT_0193*conj(IT_0193) + IT_0197*conj
      (IT_0197))*IT_0211 + (conj(IT_0178)*IT_0181 + IT_0178*conj(IT_0181) + conj
      (IT_0193)*IT_0197 + IT_0193*conj(IT_0197))*IT_0212;
