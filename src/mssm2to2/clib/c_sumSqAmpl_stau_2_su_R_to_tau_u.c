...
ccomplex_return_t c_sumSqAmpl_stau_2_su_R_to_tau_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0081 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0008*IT_0015*IT_0080;
    const ccomplex_t IT_0082 = 0.5*IT_0081;
    const ccomplex_t IT_0083 = N_B2*e_em*U_stau_11;
    const ccomplex_t IT_0084 = IT_0001*IT_0083;
    const ccomplex_t IT_0085 = 1.4142135623731*IT_0084;
    const ccomplex_t IT_0086 = N_d2*e_em*m_tau*IT_0015*U_stau_01;
    ...
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0008*IT_0015*IT_0080;
    ...
    const ccomplex_t IT_0099 = N_d3*e_em*m_tau*IT_0015*U_stau_01;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0008*IT_0015*IT_0080;
    const ccomplex_t IT_0108 = 0.5*IT_0107;
    const ccomplex_t IT_0109 = N_B4*e_em*U_stau_11;
    const ccomplex_t IT_0110 = IT_0001*IT_0109;
    const ccomplex_t IT_0111 = 1.4142135623731*IT_0110;
    const ccomplex_t IT_0112 = N_d4*e_em*m_tau*IT_0015*U_stau_01;
    ...
    const ccomplex_t IT_0120 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0008*IT_0015*IT_0080;
    const ccomplex_t IT_0121 = 0.5*IT_0120;
    const ccomplex_t IT_0122 = N_B1*e_em*U_stau_11;
    const ccomplex_t IT_0123 = IT_0001*IT_0122;
    const ccomplex_t IT_0124 = 1.4142135623731*IT_0123;
    const ccomplex_t IT_0125 = N_d1*e_em*m_tau*IT_0015*U_stau_01;
    ...
    const ccomplex_t IT_0143 = IT_0039*IT_0095;
    ...
    const ccomplex_t IT_0147 = IT_0020*IT_0082;
    const ccomplex_t IT_0148 = IT_0024*IT_0146*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0150 = IT_0056*IT_0108;
    const ccomplex_t IT_0151 = IT_0058*IT_0149*IT_0150;
    const ccomplex_t IT_0152 = m_u*IT_0026;
    const ccomplex_t IT_0153 = m_u*IT_0043;
    const ccomplex_t IT_0154 = m_u*IT_0060;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0156 = IT_0074*IT_0121;
    const ccomplex_t IT_0157 = IT_0061*IT_0155*IT_0156;
    const ccomplex_t IT_0158 = m_u*IT_0077;
    const ccomplex_t IT_0159 = (-0.5)*IT_0148 + (-0.5)*IT_0151 + 0.5*IT_0152 +
       0.5*IT_0153 + 0.5*IT_0154 + (-0.5)*IT_0157 + 0.5*IT_0158;
    const ccomplex_t IT_0160 = IT_0145 + -IT_0159;
    const ccomplex_t IT_0161 = -conj(IT_0159);
    const ccomplex_t IT_0162 = conj(IT_0145) + IT_0161;
    const ccomplex_t IT_0163 = IT_0063*IT_0129;
    const ccomplex_t IT_0164 = IT_0061*IT_0155*IT_0163;
    const ccomplex_t IT_0165 = IT_0045*IT_0116;
    const ccomplex_t IT_0166 = IT_0058*IT_0149*IT_0165;
    ...
    const ccomplex_t IT_0170 = IT_0024*IT_0146*IT_0169;
    const ccomplex_t IT_0171 = IT_0028*IT_0103;
    const ccomplex_t IT_0172 = IT_0041*IT_0142*IT_0171;
    const ccomplex_t IT_0173 = m_u*IT_0132;
    const ccomplex_t IT_0174 = m_u*IT_0093;
    const ccomplex_t IT_0175 = m_u*IT_0106;
    const ccomplex_t IT_0176 = m_u*IT_0119;
    ...
    const ccomplex_t IT_0193 = (-6)*conj(IT_0078)*(IT_0133*IT_0135 + (
      ...
      *IT_0160 + IT_0078*IT_0162 + 0.166666666666667*conj(IT_0133)*IT_0179 +
       ...
       IT_0159*IT_0182 + conj(IT_0145)*IT_0186 + IT_0145*IT_0189) + (-6)*(conj
      (IT_0133)*IT_0160 + IT_0133*IT_0162 + (-0.166666666666667)*conj(IT_0078)
      *IT_0186 + (-0.166666666666667)*IT_0078*IT_0189)*IT_0190 + (IT_0145*conj
      (IT_0145) + IT_0159*conj(IT_0159) + IT_0167*conj(IT_0167) + IT_0177*conj
      (IT_0177))*IT_0191 + (conj(IT_0145)*IT_0159 + IT_0145*conj(IT_0159) + conj
