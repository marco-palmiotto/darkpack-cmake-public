...
ccomplex_return_t c_sumSqAmpl_su_L_anti_sc_L_to_anti_c_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0096 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0014*IT_0093*IT_0095;
    const ccomplex_t IT_0097 = (-0.5)*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
    ...
    const ccomplex_t IT_0105 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0014*IT_0093*IT_0095;
    ...
    const ccomplex_t IT_0112 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0014*IT_0093*IT_0095;
    ...
    const ccomplex_t IT_0119 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0014*IT_0093*IT_0095;
    ...
    const ccomplex_t IT_0125 = pow(m_su_L, 2);
    const ccomplex_t IT_0126 = m_c*m_u*IT_0125;
    ...
    const ccomplex_t IT_0132 = m_c*m_u;
    const ccomplex_t IT_0133 = m_u*IT_0102;
    const ccomplex_t IT_0134 = m_u*IT_0109;
    const ccomplex_t IT_0135 = m_u*IT_0116;
    ...
    const ccomplex_t IT_0161 = m_u*IT_0031;
    const ccomplex_t IT_0162 = m_u*IT_0051;
    const ccomplex_t IT_0163 = m_u*IT_0071;
    const ccomplex_t IT_0164 = m_u*IT_0091;
    ...
    const ccomplex_t IT_0171 = m_c*s_14;
    const ccomplex_t IT_0172 = 18*s_34;
    const ccomplex_t IT_0173 = m_u*s_13;
