...
ccomplex_return_t c_sumSqAmpl_su_L_anti_sc_R_to_anti_s_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0004;
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0004;
