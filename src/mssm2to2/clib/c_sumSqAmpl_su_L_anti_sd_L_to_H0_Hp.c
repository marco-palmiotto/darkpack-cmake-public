        ...
        )
{
    ...
    const ccomplex_t IT_0048 = pow(m_su_L, 2);
    const ccomplex_t IT_0049 = cpow((-2)*s_12 + -IT_0022 + -IT_0048 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0050 = IT_0047*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0001
    ...
    const ccomplex_t IT_0057 = cpow((-2)*s_13 + IT_0021 + IT_0048 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0058 = IT_0056*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0014*IT_0015;
    const ccomplex_t IT_0061 = 0.5*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0021 + IT_0022 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0015
      *IT_0068*(m_W*IT_0002*IT_0005*conj(U_sb_00) + (-0.5)*IT_0014*(IT_0005
    ...
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0021 + IT_0022 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0075 = IT_0073*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0015
      *IT_0068*(m_W*IT_0002*IT_0005*conj(U_sb_01) + (-0.5)*IT_0014*(IT_0005
    ...
    const ccomplex_t IT_0111 = (0 + _Complex_I*1)*m_W*e_em*(IT_0001*IT_0015
      *IT_0041 + (-2)*IT_0005*(IT_0002*(IT_0001*IT_0005 + -IT_0002*IT_0007)*(0.5
      *IT_0015 + IT_0010*IT_0031) + 1./2*IT_0007*IT_0015*IT_0110));
    const ccomplex_t IT_0112 = (-0.5)*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0015*((IT_0004 + -IT_0008)*IT_0014 + m_W*(IT_0044 + -IT_0110));
    const ccomplex_t IT_0114 = (-0.5)*IT_0113;
    const ccomplex_t IT_0115 = IT_0112*IT_0114;
    const ccomplex_t IT_0116 = pow(m_W, 2);
    const ccomplex_t IT_0117 = cpow((-2)*s_12 + -IT_0022 + -IT_0048 + IT_0116 
      + -reg_prop, -1);
    const ccomplex_t IT_0118 = IT_0115*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*IT_0118;
    const ccomplex_t IT_0120 = (0 + _Complex_I*1)*e_em*(IT_0007*IT_0008
    ...
    const ccomplex_t IT_0123 = cpow((-2)*s_13 + IT_0021 + (0 + _Complex_I*1)
      *m_su_L*Gamma_ul + reg_prop, -1);
    const ccomplex_t IT_0124 = IT_0122*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1)*IT_0124;
    const ccomplex_t IT_0126 = IT_0013 + IT_0025 + IT_0037 + -IT_0051 +
       IT_0059 + IT_0067 + IT_0076 + IT_0084 + (-2)*IT_0109 + -IT_0119 + IT_0125;
