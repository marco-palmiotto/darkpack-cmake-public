        ...
        )
{
    ...
    const ccomplex_t IT_0024 = cpow(IT_0004, 2);
    const ccomplex_t IT_0025 = cpow(IT_0006, 2);
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0001*(IT_0021*(IT_0022 + -IT_0023) + -m_W*(IT_0024 + -IT_0025));
    const ccomplex_t IT_0027 = (-0.5)*IT_0026;
    const ccomplex_t IT_0028 = pow(m_W, 2);
    const ccomplex_t IT_0029 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + IT_0028 
      + -reg_prop, -1);
    const ccomplex_t IT_0030 = IT_0027*IT_0029;
    const ccomplex_t IT_0031 = (0 + _Complex_I*1)*IT_0030;
    const ccomplex_t IT_0032 = IT_0020*IT_0031;
    const ccomplex_t IT_0033 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0034 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0001
      *IT_0033*conj(U_sb_01)*V_ub_mod;
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0009 + IT_0038 + -m_sb_2*
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0001*(IT_0006*IT_0021*IT_0022*IT_0044 + (-2)*IT_0004*(m_W*IT_0006 + (
      -0.5)*IT_0021*IT_0023*IT_0045));
    const ccomplex_t IT_0047 = 0.5*IT_0046;
    const ccomplex_t IT_0048 = cpow((-2)*s_12 + -IT_0009 + -IT_0010 + m_Hp*
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0005
      *IT_0021*IT_0022*IT_0044 + (-0.5)*m_W*(IT_0004*IT_0005 + -IT_0006*IT_0007)
      *(IT_0001 + 1./3*IT_0000*IT_0054));
    const ccomplex_t IT_0056 = -IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_23 + IT_0038 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_23 + IT_0009 + IT_0038 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0066 = IT_0064*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1)*IT_0066;
    const ccomplex_t IT_0068 = IT_0062*IT_0067;
    const ccomplex_t IT_0069 = IT_0032 + -IT_0042 + IT_0051 + -IT_0060 + 
      -IT_0068;
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0007
      *IT_0021*IT_0023*IT_0045 + 0.5*m_W*(IT_0004*IT_0005 + -IT_0006*IT_0007)*
      (IT_0001 + -1./3*IT_0000*IT_0054));
    const ccomplex_t IT_0077 = -IT_0076;
    const ccomplex_t IT_0078 = cpow((-2)*s_13 + IT_0038 + (0 + _Complex_I*1)
      *m_su_L*Gamma_ul + reg_prop, -1);
    const ccomplex_t IT_0079 = IT_0077*IT_0078;
    const ccomplex_t IT_0080 = (0 + _Complex_I*1)*IT_0079;
    const ccomplex_t IT_0081 = IT_0052*IT_0080;
    const ccomplex_t IT_0082 = IT_0042 + IT_0060 + IT_0068 + -IT_0075 + IT_0081;
    ...
    const ccomplex_t IT_0095 = (-3)*IT_0015*(conj(IT_0015)*(IT_0010 + -IT_0018
      ...
      *IT_0086 + (-3)*IT_0069*((-0.333333333333333)*IT_0072*IT_0086 + conj
      (IT_0069)*(IT_0038 + -IT_0088) + conj(IT_0082)*IT_0091) + (conj(IT_0069)
