...
ccomplex_return_t c_sumSqAmpl_su_L_anti_sd_L_to_Hp_G(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_su_L*
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_13 + IT_0013 + IT_0018 + -m_sd_L*
