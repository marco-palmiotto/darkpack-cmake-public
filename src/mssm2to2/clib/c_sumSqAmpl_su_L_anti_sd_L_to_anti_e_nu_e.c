        ...
        )
{
    ...
    const ccomplex_t IT_0011 = m_e*IT_0010;
    const ccomplex_t IT_0012 = -IT_0009;
    const ccomplex_t IT_0013 = m_e*IT_0012;
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
      *IT_0001*IT_0017;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_e*e_em
