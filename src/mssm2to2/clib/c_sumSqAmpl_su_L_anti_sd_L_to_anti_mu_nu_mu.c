...
ccomplex_return_t c_sumSqAmpl_su_L_anti_sd_L_to_anti_mu_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0005*(IT_0000*IT_0002*IT_0003*IT_0008 + (-2)*IT_0001*(m_W*IT_0003 + (
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0005;
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0005*(IT_0000*(IT_0008 + -IT_0009) + -m_W*(IT_0034 + -IT_0035));
