...
ccomplex_return_t c_sumSqAmpl_su_L_anti_sd_L_to_anti_s_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0046 = m_c*s_13;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
      *IT_0001*IT_0019;
    const ccomplex_t IT_0048 = (-0.5)*IT_0047;
    const ccomplex_t IT_0049 = IT_0029*IT_0048;
    const ccomplex_t IT_0050 = IT_0032*IT_0049;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
    ...
    const ccomplex_t IT_0057 = m_s*IT_0013;
    const ccomplex_t IT_0058 = m_s*IT_0003;
    ...
    const ccomplex_t IT_0066 = m_c*m_s;
