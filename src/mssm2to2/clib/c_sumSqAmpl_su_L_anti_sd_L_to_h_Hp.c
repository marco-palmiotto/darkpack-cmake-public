        ...
        )
{
    ...
    const ccomplex_t IT_0015 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0014;
    ...
    const ccomplex_t IT_0030 = s_12 + IT_0020;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0014*(IT_0005*IT_0007*IT_0043*IT_0044 + (-2)*IT_0001*(m_W*IT_0005 + (
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0014
      *IT_0062*(m_W*IT_0001*IT_0005*conj(U_sb_00) + (-0.5)*IT_0043*(IT_0001
    ...
    const ccomplex_t IT_0068 = cpow((-2)*s_23 + IT_0020 + IT_0053 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0069 = IT_0067*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = IT_0010*IT_0049;
    const ccomplex_t IT_0072 = -IT_0014 + IT_0071;
    const ccomplex_t IT_0073 = cpow(IT_0005, 3);
    const ccomplex_t IT_0074 = 3*IT_0014 + IT_0071;
    const ccomplex_t IT_0075 = cpow(IT_0005, 2);
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*m_W*e_em*(IT_0002*IT_0072
      *IT_0073 + -IT_0001*(IT_0001*(IT_0001*IT_0009*IT_0072 + IT_0002*IT_0005
      *IT_0074) + -IT_0009*IT_0074*IT_0075));
    const ccomplex_t IT_0077 = 0.5*IT_0076;
    const ccomplex_t IT_0078 = IT_0047*IT_0077;
    const ccomplex_t IT_0079 = cpow((-2)*s_12 + -IT_0020 + -IT_0021 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0080 = IT_0078*IT_0079;
    const ccomplex_t IT_0081 = (0 + _Complex_I*1)*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0009
    ...
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0014*IT_0043;
    const ccomplex_t IT_0085 = 0.5*IT_0084;
    const ccomplex_t IT_0086 = IT_0083*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0021 + IT_0053 + -m_su_R*
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0009 + m_d*e_em*mu_h*IT_0002*IT_0014*IT_0043*IT_0044);
    const ccomplex_t IT_0093 = 0.5*IT_0092;
    const ccomplex_t IT_0094 = IT_0091*IT_0093;
    const ccomplex_t IT_0095 = cpow((-2)*s_23 + IT_0020 + IT_0053 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0096 = IT_0094*IT_0095;
    const ccomplex_t IT_0097 = (0 + _Complex_I*1)*IT_0096;
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *mu_h*IT_0014*IT_0043;
    const ccomplex_t IT_0099 = 0.5*IT_0098;
    const ccomplex_t IT_0100 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0009;
    const ccomplex_t IT_0101 = 0.5*IT_0100;
    const ccomplex_t IT_0102 = IT_0099*IT_0101;
    const ccomplex_t IT_0103 = cpow((-2)*s_23 + IT_0020 + IT_0053 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0104 = IT_0102*IT_0103;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*IT_0104;
    const ccomplex_t IT_0106 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0014
      *IT_0062*(m_W*IT_0001*IT_0005*conj(U_sb_01) + (-0.5)*IT_0043*(IT_0001
    ...
    const ccomplex_t IT_0111 = cpow((-2)*s_23 + IT_0020 + IT_0053 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0112 = IT_0110*IT_0111;
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*IT_0112;
    const ccomplex_t IT_0114 = cpow(IT_0001, 2);
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*m_W*e_em*(IT_0009*IT_0014
      *IT_0073 + (-2)*IT_0001*(IT_0005*(IT_0002*IT_0005 + IT_0001*IT_0009)*(0.5
      *IT_0014 + IT_0010*IT_0049) + -1./2*IT_0002*IT_0014*IT_0114));
    const ccomplex_t IT_0116 = 0.5*IT_0115;
    const ccomplex_t IT_0117 = (0 + _Complex_I*(-1.4142135623731))*V_ud*e_em
      *IT_0014*((IT_0004 + -IT_0007)*IT_0043 + -m_W*(IT_0075 + -IT_0114));
    const ccomplex_t IT_0118 = (-0.5)*IT_0117;
    const ccomplex_t IT_0119 = IT_0116*IT_0118;
    const ccomplex_t IT_0120 = pow(m_W, 2);
    const ccomplex_t IT_0121 = cpow((-2)*s_12 + -IT_0020 + -IT_0021 + IT_0120 
      + -reg_prop, -1);
    const ccomplex_t IT_0122 = IT_0119*IT_0121;
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*IT_0122;
    const ccomplex_t IT_0124 = IT_0013 + (-2)*IT_0042 + IT_0056 + IT_0061 +
       IT_0070 + -IT_0081 + IT_0089 + IT_0097 + IT_0105 + IT_0113 + -IT_0123;
