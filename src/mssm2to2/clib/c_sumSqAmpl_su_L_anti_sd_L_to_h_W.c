        ...
        )
{
    ...
    const ccomplex_t IT_0025 = cpow(IT_0005, 2);
    ...
    const ccomplex_t IT_0033 = -IT_0002;
    const ccomplex_t IT_0034 = cpow(IT_0006, -1);
    const ccomplex_t IT_0035 = cos(theta_W);
    const ccomplex_t IT_0036 = cpow(IT_0035, -2);
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0007
      *IT_0021*IT_0022*IT_0034 + (-0.5)*m_W*(IT_0004*IT_0005 + IT_0006*IT_0007)*
      (IT_0001 + 1./3*IT_0000*IT_0036));
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0009 + IT_0038 + -m_sb_2*
    ...
    const ccomplex_t IT_0055 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0001*(IT_0005*IT_0021*IT_0022*IT_0034 + (-2)*IT_0006*(m_W*IT_0005 + (
      -0.5)*IT_0021*IT_0023*IT_0054));
    ...
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0004
      *IT_0005 + IT_0006*IT_0007)*(IT_0001 + -1./3*IT_0000*IT_0036) + IT_0001
      *IT_0004*IT_0021*IT_0023*IT_0054);
    ...
    const ccomplex_t IT_0082 = IT_0042 + IT_0051 + IT_0068 + -IT_0075 + IT_0081;
