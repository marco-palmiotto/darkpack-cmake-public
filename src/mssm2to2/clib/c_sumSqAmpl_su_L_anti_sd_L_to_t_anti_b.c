        ...
        )
{
    ...
    const ccomplex_t IT_0039 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0001*(IT_0024*(m_W*IT_0026 + (-0.5)*IT_0019*IT_0023*IT_0035) + -1./2
      *IT_0019*IT_0022*IT_0026*IT_0038);
