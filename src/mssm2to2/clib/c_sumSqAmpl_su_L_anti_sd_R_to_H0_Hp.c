        ...
        )
{
    ...
    const ccomplex_t IT_0049 = -IT_0008;
    ...
    const ccomplex_t IT_0054 = cpow(IT_0004, 3);
    const ccomplex_t IT_0055 = -IT_0002;
    const ccomplex_t IT_0056 = 3*IT_0008 + IT_0052;
    const ccomplex_t IT_0057 = cpow(IT_0004, 2);
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*m_W*e_em*(IT_0012*IT_0053
      *IT_0054 + IT_0055*(IT_0055*(IT_0002*IT_0011*IT_0053 + -IT_0004*IT_0012
      *IT_0056) + IT_0011*IT_0056*IT_0057));
    const ccomplex_t IT_0059 = 0.5*IT_0058;
    const ccomplex_t IT_0060 = IT_0048*IT_0059;
    const ccomplex_t IT_0061 = pow(m_su_L, 2);
    const ccomplex_t IT_0062 = cpow((-2)*s_12 + -IT_0017 + -IT_0061 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0060*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
      *IT_0006*IT_0008*IT_0011;
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0000*IT_0003*IT_0006*IT_0008;
    const ccomplex_t IT_0068 = 0.5*IT_0067;
    const ccomplex_t IT_0069 = IT_0066*IT_0068;
    const ccomplex_t IT_0070 = cpow((-2)*s_13 + IT_0016 + IT_0061 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0069*IT_0070;
    const ccomplex_t IT_0072 = (0 + _Complex_I*1)*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0005
      *IT_0006*IT_0008*IT_0012 + 0.5*m_W*(IT_0002*IT_0011 + -IT_0004*IT_0012)*
      (IT_0008 + -1./3*IT_0007*IT_0051));
    const ccomplex_t IT_0074 = -IT_0073;
    const ccomplex_t IT_0075 = IT_0048*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_13 + IT_0016 + (0 + _Complex_I*1)
      *m_su_L*Gamma_ul + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*-3)*e_em*(IT_0000*IT_0001
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_23 + IT_0016 + (0 + _Complex_I*1)
      *m_sd_R*Gamma_dr + reg_prop, -1);
    const ccomplex_t IT_0083 = IT_0081*IT_0082;
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*IT_0083;
    const ccomplex_t IT_0085 = cpow(IT_0002, 2);
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*m_W*e_em*(IT_0008*IT_0011
      *IT_0054 + (-2)*IT_0002*(IT_0004*(IT_0002*IT_0011 + -IT_0004*IT_0012)*(0.5
      *IT_0008 + IT_0007*IT_0051) + 1./2*IT_0008*IT_0012*IT_0085));
    ...
    const ccomplex_t IT_0092 = cpow((-2)*s_12 + -IT_0017 + -IT_0061 + IT_0091 
      + -reg_prop, -1);
    const ccomplex_t IT_0093 = IT_0090*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1)*IT_0093;
    const ccomplex_t IT_0095 = IT_0020 + IT_0029 + IT_0038 + IT_0046 + 
      -IT_0064 + IT_0072 + IT_0078 + IT_0084 + -IT_0094;
