        ...
        )
{
    ...
    const ccomplex_t IT_0018 = cpow(IT_0002, -1);
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0001*IT_0005*IT_0007*IT_0018;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0000 + -m_d*e_em*mu_h*IT_0003*IT_0005*IT_0007*IT_0018);
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = pow(m_H0, 2);
    const ccomplex_t IT_0031 = cpow((-2)*s_23 + IT_0010 + IT_0030 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0032 = IT_0029*IT_0031;
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*IT_0032;
    const ccomplex_t IT_0034 = IT_0027*IT_0033;
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
      *IT_0005;
    const ccomplex_t IT_0036 = -IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0000;
    const ccomplex_t IT_0038 = (-0.5)*IT_0037;
    const ccomplex_t IT_0039 = cpow((-2)*s_23 + IT_0010 + IT_0030 + -m_ss_L*
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0010 + IT_0030 + -m_sb_2*
    ...
    return create_ccomplex_return((-3)*IT_0060*(conj(IT_0060)*(IT_0030 + 
      -IT_0063) + conj(IT_0064)*IT_0067) + (-3)*IT_0064*(conj(IT_0060)*IT_0067 +
       conj(IT_0064)*(IT_0010 + -IT_0069)));
}
