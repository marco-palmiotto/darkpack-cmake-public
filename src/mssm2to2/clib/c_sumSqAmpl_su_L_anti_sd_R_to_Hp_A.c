...
ccomplex_return_t c_sumSqAmpl_su_L_anti_sd_R_to_Hp_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
    ...
    const ccomplex_t IT_0019 = cpow((-2)*s_23 + IT_0007 + IT_0013 + -m_su_L*
