        ...
        )
{
    ...
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0037 = IT_0035*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*IT_0037;
    const ccomplex_t IT_0039 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0008
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0016 + IT_0017 + -m_sb_2*
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*-3)*e_em*(IT_0000*IT_0001
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0016 + (0 + _Complex_I*1)
      *m_sd_R*Gamma_dr + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0053*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*IT_0055;
    const ccomplex_t IT_0057 = cpow(IT_0004, 3);
    const ccomplex_t IT_0058 = cpow(IT_0002, 2);
    const ccomplex_t IT_0059 = (0 + _Complex_I*1)*m_W*e_em*(IT_0008*IT_0011
      *IT_0057 + (-2)*IT_0002*(IT_0004*(IT_0002*IT_0011 + IT_0004*IT_0012)*(0.5
      *IT_0008 + IT_0007*IT_0050) + -1./2*IT_0008*IT_0012*IT_0058));
    const ccomplex_t IT_0060 = 0.5*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0000*IT_0003*IT_0004*IT_0008;
    const ccomplex_t IT_0062 = 0.5*IT_0061;
    const ccomplex_t IT_0063 = IT_0060*IT_0062;
    const ccomplex_t IT_0064 = pow(m_W, 2);
    const ccomplex_t IT_0065 = pow(m_su_L, 2);
    const ccomplex_t IT_0066 = cpow((-2)*s_12 + -IT_0017 + IT_0064 + -IT_0065 
      + -reg_prop, -1);
    const ccomplex_t IT_0067 = IT_0063*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1)*IT_0067;
    const ccomplex_t IT_0069 = IT_0007*IT_0050;
    const ccomplex_t IT_0070 = -IT_0008 + IT_0069;
    const ccomplex_t IT_0071 = 3*IT_0008 + IT_0069;
    const ccomplex_t IT_0072 = cpow(IT_0004, 2);
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*m_W*e_em*(IT_0012*IT_0057
      *IT_0070 + -IT_0002*(IT_0002*(IT_0002*IT_0011*IT_0070 + IT_0004*IT_0012
      *IT_0071) + -IT_0011*IT_0071*IT_0072));
    const ccomplex_t IT_0074 = 0.5*IT_0073;
    const ccomplex_t IT_0075 = IT_0048*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_12 + -IT_0017 + -IT_0065 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0084 = cpow((-2)*s_13 + IT_0016 + IT_0065 + -m_su_R*
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0005
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_13 + IT_0016 + (0 + _Complex_I*1)
      *m_su_L*Gamma_ul + reg_prop, -1);
    const ccomplex_t IT_0091 = IT_0089*IT_0090;
    const ccomplex_t IT_0092 = (0 + _Complex_I*1)*IT_0091;
    const ccomplex_t IT_0093 = IT_0020 + IT_0029 + IT_0038 + IT_0046 + IT_0056
       + -IT_0068 + -IT_0078 + IT_0086 + IT_0092;
