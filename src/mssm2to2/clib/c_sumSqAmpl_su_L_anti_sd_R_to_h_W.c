        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
    ...
    const ccomplex_t IT_0019 = cpow(IT_0000, -1);
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_d*V_ud*e_em
      *mu_h*IT_0002*IT_0005*IT_0008*IT_0019;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0003 + m_d*e_em*mu_h*IT_0001*IT_0005*IT_0008*IT_0019);
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = pow(m_h, 2);
    const ccomplex_t IT_0032 = cpow((-2)*s_23 + IT_0011 + IT_0031 + -m_sd_L*
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
      *IT_0005;
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1.4142135623731)*A_b*conj(V_td)
      *V_ts*IT_0003;
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_23 + IT_0011 + IT_0031 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0041 = IT_0039*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*IT_0041;
    const ccomplex_t IT_0043 = IT_0037*IT_0042;
    const ccomplex_t IT_0044 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0005
      *IT_0044*conj(U_sb_01)*V_ub_mod;
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_23 + IT_0011 + IT_0031 + -m_sb_2*
    ...
    return create_ccomplex_return((-3)*IT_0061*(conj(IT_0061)*(IT_0031 + 
      -IT_0064) + conj(IT_0065)*IT_0068) + (-3)*IT_0065*(conj(IT_0061)*IT_0068 +
       conj(IT_0065)*(IT_0011 + -IT_0070)));
}
