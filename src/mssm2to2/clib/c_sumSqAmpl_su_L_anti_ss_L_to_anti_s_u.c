        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
      *IT_0009;
    const ccomplex_t IT_0011 = -IT_0010;
    const ccomplex_t IT_0012 = 0.5*IT_0010;
    const ccomplex_t IT_0013 = pow(m_su_L, 2);
    ...
    const ccomplex_t IT_0038 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0078 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_3*
    ...
    const ccomplex_t IT_0098 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_4*
    ...
    const ccomplex_t IT_0121 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0009*IT_0102*IT_0104;
    ...
    const ccomplex_t IT_0128 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0009*IT_0102*IT_0104;
    ...
    const ccomplex_t IT_0136 = s_34*IT_0013;
    ...
    const ccomplex_t IT_0141 = m_s*m_u*IT_0013;
    ...
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0009*IT_0102;
    const ccomplex_t IT_0149 = 0.5*IT_0148;
    const ccomplex_t IT_0150 = pow(m_u, 2);
    const ccomplex_t IT_0151 = cpow(IT_0103, 2);
    const ccomplex_t IT_0152 = cpow(IT_0107, 2);
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
    ...
    const ccomplex_t IT_0160 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
      *IT_0009*(IT_0000*IT_0102*IT_0104*IT_0107 + (-2)*IT_0103*(m_W*IT_0107 + (
      -0.5)*IT_0102*IT_0108*IT_0150));
    const ccomplex_t IT_0161 = 0.5*IT_0160;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
    ...
    const ccomplex_t IT_0175 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *IT_0009*IT_0102;
    ...
    const ccomplex_t IT_0180 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
    ...
    const ccomplex_t IT_0185 = m_s*IT_0168;
    const ccomplex_t IT_0186 = m_s*IT_0011;
    ...
    const ccomplex_t IT_0226 = m_s*s_14;
    ...
    const ccomplex_t IT_0233 = m_s*m_u;
