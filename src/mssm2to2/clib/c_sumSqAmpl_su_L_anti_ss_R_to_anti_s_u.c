...
ccomplex_return_t c_sumSqAmpl_su_L_anti_ss_R_to_anti_s_u(
        ...
        )
{
    ...
    const ccomplex_t IT_0092 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0000*IT_0004;
    const ccomplex_t IT_0093 = 0.5*IT_0092;
    const ccomplex_t IT_0094 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
    ...
    const ccomplex_t IT_0098 = pow(m_su_L, 2);
    ...
    const ccomplex_t IT_0102 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0000*IT_0001*IT_0004*IT_0008;
    const ccomplex_t IT_0103 = 0.5*IT_0102;
    const ccomplex_t IT_0104 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
    ...
    const ccomplex_t IT_0165 = m_s*m_u*IT_0098;
