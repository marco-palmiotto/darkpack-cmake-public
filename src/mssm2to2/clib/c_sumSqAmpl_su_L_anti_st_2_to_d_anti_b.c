        ...
        )
{
    ...
    const ccomplex_t IT_0028 = cpow((-2)*s_13 + IT_0023 + IT_0024 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0001*IT_0003*IT_0005;
    const ccomplex_t IT_0030 = 0.5*IT_0029;
    const ccomplex_t IT_0031 = m_t*V_tb*V_u2*e_em*IT_0001*conj(U_st_11);
    ...
    const ccomplex_t IT_0036 = V_tb*e_em*V_Wp2*conj(U_st_01);
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0005;
    const ccomplex_t IT_0045 = IT_0028*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = m_d*IT_0035;
    const ccomplex_t IT_0048 = m_d*IT_0039;
    const ccomplex_t IT_0049 = -IT_0048;
    const ccomplex_t IT_0050 = IT_0047 + IT_0049;
    const ccomplex_t IT_0051 = IT_0046*IT_0050;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0005;
    const ccomplex_t IT_0053 = IT_0025*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = m_d*IT_0015;
    const ccomplex_t IT_0056 = m_d*IT_0019;
    ...
    const ccomplex_t IT_0062 = IT_0021*IT_0054;
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0001*IT_0003*IT_0005*conj(U_st_01);
