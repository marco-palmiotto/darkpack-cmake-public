        ...
        )
{
    ...
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_4*
    ...
    const ccomplex_t IT_0113 = m_t*conj(N_u3)*e_em*IT_0032*conj(U_st_01);
    const ccomplex_t IT_0114 = IT_0031*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0117 = IT_0012*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*(IT_0115 + (
      -1.33333333333333)*IT_0118);
    const ccomplex_t IT_0120 = (-0.75)*IT_0119;
    ...
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0128 = IT_0012*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_t*conj(N_u1)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0140 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0141 = IT_0012*IT_0140;
    const ccomplex_t IT_0142 = 1.4142135623731*IT_0141;
    const ccomplex_t IT_0143 = m_t*conj(N_u2)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0151 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0152 = (-0.5)*IT_0151;
    const ccomplex_t IT_0153 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0154 = IT_0012*IT_0153;
    const ccomplex_t IT_0155 = 1.4142135623731*IT_0154;
    const ccomplex_t IT_0156 = m_t*conj(N_u4)*e_em*IT_0032*conj(U_st_01);
    const ccomplex_t IT_0157 = IT_0031*IT_0156;
    ...
    const ccomplex_t IT_0178 = m_u*IT_0163;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0180 = IT_0072*IT_0121;
    const ccomplex_t IT_0181 = IT_0064*IT_0179*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0183 = IT_0022*IT_0134;
    const ccomplex_t IT_0184 = IT_0010*IT_0182*IT_0183;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0186 = IT_0095*IT_0160;
    const ccomplex_t IT_0187 = IT_0087*IT_0185*IT_0186;
    const ccomplex_t IT_0188 = m_u*IT_0137;
    const ccomplex_t IT_0189 = m_u*IT_0124;
    const ccomplex_t IT_0190 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0191 = IT_0049*IT_0147;
    const ccomplex_t IT_0192 = IT_0041*IT_0190*IT_0191;
    const ccomplex_t IT_0193 = m_u*IT_0150;
    const ccomplex_t IT_0194 = 0.166666666666667*IT_0176 + IT_0178 + -IT_0181 
      + -IT_0184 + -IT_0187 + IT_0188 + IT_0189 + -IT_0192 + IT_0193;
    const ccomplex_t IT_0195 = IT_0037*IT_0126;
    const ccomplex_t IT_0196 = IT_0010*IT_0182*IT_0195;
    const ccomplex_t IT_0197 = IT_0060*IT_0139;
    const ccomplex_t IT_0198 = IT_0041*IT_0190*IT_0197;
    const ccomplex_t IT_0199 = m_u*IT_0040;
    const ccomplex_t IT_0200 = m_u*IT_0063;
    const ccomplex_t IT_0201 = IT_0083*IT_0112;
    const ccomplex_t IT_0202 = IT_0064*IT_0179*IT_0201;
    const ccomplex_t IT_0203 = IT_0106*IT_0152;
    const ccomplex_t IT_0204 = IT_0087*IT_0185*IT_0203;
    ...
    const ccomplex_t IT_0207 = (-0.166666666666667)*IT_0171 + -IT_0196 + 
      -IT_0198 + IT_0199 + IT_0200 + -IT_0202 + -IT_0204 + IT_0205 + IT_0206;
