...
ccomplex_return_t c_sumSqAmpl_su_L_anti_st_2_to_u_anti_t(
        ...
        )
{
    ...
    const ccomplex_t IT_0023 = N_B4*e_em*conj(U_st_01);
    const ccomplex_t IT_0024 = IT_0012*IT_0023;
    const ccomplex_t IT_0025 = 1.4142135623731*IT_0024;
    const ccomplex_t IT_0026 = N_W4*e_em*conj(U_st_01);
    ...
    const ccomplex_t IT_0033 = m_t*N_u4*e_em*IT_0032*conj(U_st_11);
    ...
    const ccomplex_t IT_0041 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_3*
    ...
    const ccomplex_t IT_0050 = N_B3*e_em*conj(U_st_01);
    const ccomplex_t IT_0051 = IT_0012*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = N_W3*e_em*conj(U_st_01);
    const ccomplex_t IT_0054 = IT_0017*IT_0053;
    const ccomplex_t IT_0055 = 1.4142135623731*IT_0054;
    const ccomplex_t IT_0056 = m_t*N_u3*e_em*IT_0032*conj(U_st_11);
    ...
    const ccomplex_t IT_0064 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_1*
    ...
    const ccomplex_t IT_0085 = IT_0064*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1)*IT_0085;
    const ccomplex_t IT_0087 = cpow((-2)*s_13 + IT_0003 + IT_0005 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0088 = N_B2*e_em*conj(U_st_01);
    const ccomplex_t IT_0089 = IT_0012*IT_0088;
    const ccomplex_t IT_0090 = 1.4142135623731*IT_0089;
    const ccomplex_t IT_0091 = N_W2*e_em*conj(U_st_01);
    const ccomplex_t IT_0092 = IT_0017*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = m_t*N_u2*e_em*IT_0032*conj(U_st_11);
    ...
    const ccomplex_t IT_0108 = IT_0087*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1)*IT_0108;
    const ccomplex_t IT_0110 = 0.166666666666667*IT_0008 + -IT_0040 + -IT_0063
       + -IT_0086 + -IT_0109;
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0112 = (-0.5)*IT_0111;
    const ccomplex_t IT_0113 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0114 = IT_0012*IT_0113;
    const ccomplex_t IT_0115 = 1.4142135623731*IT_0114;
    const ccomplex_t IT_0116 = m_t*conj(N_u4)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0124 = (0 + _Complex_I*1.4142135623731)*m_u*N_u3*e_em
      *IT_0017*IT_0030*IT_0032;
    const ccomplex_t IT_0125 = (-0.5)*IT_0124;
    const ccomplex_t IT_0126 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0127 = IT_0012*IT_0126;
    const ccomplex_t IT_0128 = 1.4142135623731*IT_0127;
    const ccomplex_t IT_0129 = m_t*conj(N_u3)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0140 = m_t*conj(N_u2)*e_em*IT_0032*conj(U_st_01);
    ...
    const ccomplex_t IT_0152 = m_t*conj(N_u1)*e_em*IT_0032*conj(U_st_01);
    const ccomplex_t IT_0153 = IT_0031*IT_0152;
    const ccomplex_t IT_0154 = 1.4142135623731*IT_0153;
    const ccomplex_t IT_0155 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0156 = IT_0012*IT_0155;
    const ccomplex_t IT_0157 = 1.4142135623731*IT_0156;
    const ccomplex_t IT_0158 = (0 + _Complex_I*1)*(IT_0154 + (
      -1.33333333333333)*IT_0157);
    const ccomplex_t IT_0159 = (-0.75)*IT_0158;
    ...
    const ccomplex_t IT_0164 = -IT_0123 + -IT_0136 + -IT_0149 + -IT_0163;
    ...
    const ccomplex_t IT_0170 = m_u*s_14;
    const ccomplex_t IT_0171 = m_u*IT_0008;
    ...
    const ccomplex_t IT_0176 = IT_0006*IT_0174*IT_0175;
    const ccomplex_t IT_0177 = (-0.5)*IT_0176;
    const ccomplex_t IT_0178 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0179 = IT_0072*IT_0160;
    const ccomplex_t IT_0180 = IT_0064*IT_0178*IT_0179;
    const ccomplex_t IT_0181 = m_u*IT_0123;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0183 = IT_0106*IT_0144;
    const ccomplex_t IT_0184 = IT_0087*IT_0182*IT_0183;
    const ccomplex_t IT_0185 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0186 = IT_0049*IT_0133;
    const ccomplex_t IT_0187 = IT_0041*IT_0185*IT_0186;
    const ccomplex_t IT_0188 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0189 = IT_0022*IT_0120;
    const ccomplex_t IT_0190 = IT_0010*IT_0188*IT_0189;
    const ccomplex_t IT_0191 = m_u*IT_0163;
    const ccomplex_t IT_0192 = m_u*IT_0149;
    const ccomplex_t IT_0193 = m_u*IT_0136;
    const ccomplex_t IT_0194 = 0.166666666666667*IT_0176 + -IT_0180 + IT_0181 
      + -IT_0184 + -IT_0187 + -IT_0190 + IT_0191 + IT_0192 + IT_0193;
    const ccomplex_t IT_0195 = IT_0083*IT_0151;
    const ccomplex_t IT_0196 = IT_0064*IT_0178*IT_0195;
    const ccomplex_t IT_0197 = m_u*IT_0063;
    const ccomplex_t IT_0198 = m_u*IT_0040;
    const ccomplex_t IT_0199 = IT_0098*IT_0146;
    const ccomplex_t IT_0200 = IT_0087*IT_0182*IT_0199;
    const ccomplex_t IT_0201 = IT_0060*IT_0125;
    const ccomplex_t IT_0202 = IT_0041*IT_0185*IT_0201;
    const ccomplex_t IT_0203 = IT_0037*IT_0112;
    const ccomplex_t IT_0204 = IT_0010*IT_0188*IT_0203;
    const ccomplex_t IT_0205 = m_u*IT_0086;
    const ccomplex_t IT_0206 = m_u*IT_0109;
    const ccomplex_t IT_0207 = (-0.166666666666667)*IT_0171 + -IT_0196 +
       IT_0197 + IT_0198 + -IT_0200 + -IT_0202 + -IT_0204 + IT_0205 + IT_0206;
    const ccomplex_t IT_0208 = 3*IT_0110;
    const ccomplex_t IT_0209 = IT_0009 + IT_0208;
    const ccomplex_t IT_0210 = 3*conj(IT_0110);
    const ccomplex_t IT_0211 = conj(IT_0009) + IT_0210;
    const ccomplex_t IT_0212 = (18*conj(IT_0009) + 6*conj(IT_0110))*IT_0172 + 
      (18*IT_0009 + 6*IT_0110)*conj(IT_0172) + 6*conj(IT_0164)*(IT_0177 + 3
      *IT_0194) + 6*IT_0164*(conj(IT_0177) + 3*conj(IT_0194)) + 6*conj(IT_0207)
      *IT_0209 + 6*IT_0207*IT_0211;
    const ccomplex_t IT_0213 = m_t*m_u*IT_0005;
    const ccomplex_t IT_0214 = m_t*m_u;
    const ccomplex_t IT_0215 = (-18)*IT_0207;
    const ccomplex_t IT_0216 = (-6)*IT_0172;
    const ccomplex_t IT_0217 = IT_0215 + IT_0216;
    const ccomplex_t IT_0218 = (-18)*conj(IT_0207);
    const ccomplex_t IT_0219 = (-6)*conj(IT_0172);
    const ccomplex_t IT_0220 = IT_0218 + IT_0219;
    const ccomplex_t IT_0221 = m_t*s_13;
    const ccomplex_t IT_0222 = (((-18)*conj(IT_0009) + (-6)*conj(IT_0110))
      *IT_0177 + ((-18)*IT_0009 + (-6)*IT_0110)*conj(IT_0177) + (-6)*conj
      (IT_0194)*IT_0209 + (-6)*IT_0194*IT_0211 + conj(IT_0164)*IT_0217 + IT_0164
      *IT_0220)*IT_0221;
    const ccomplex_t IT_0223 = 6*s_34;
    const ccomplex_t IT_0224 = 18*s_34;
    const ccomplex_t IT_0225 = 12*IT_0167;
    const ccomplex_t IT_0226 = (-6)*IT_0165;
    const ccomplex_t IT_0227 = (IT_0009*conj(IT_0009) + IT_0110*conj(IT_0110) 
      + IT_0164*conj(IT_0164))*IT_0169 + IT_0170*IT_0212 + (-6)*(conj(IT_0164)
      *IT_0209 + IT_0164*IT_0211)*IT_0213 + IT_0214*(conj(IT_0177)*((-18)
      *IT_0172 + (-6)*IT_0207) + IT_0177*((-18)*conj(IT_0172) + (-6)*conj
      (IT_0207)) + conj(IT_0194)*IT_0217 + IT_0194*IT_0220) + IT_0222 + (conj
      (IT_0177)*IT_0194 + IT_0177*conj(IT_0194) + conj(IT_0172)*IT_0207 +
       IT_0172*conj(IT_0207))*IT_0223 + (IT_0172*conj(IT_0172) + IT_0177*conj
      (IT_0177) + IT_0194*conj(IT_0194) + IT_0207*conj(IT_0207))*IT_0224 + (conj
      (IT_0009)*IT_0110 + IT_0009*conj(IT_0110))*(IT_0225 + IT_0226);
