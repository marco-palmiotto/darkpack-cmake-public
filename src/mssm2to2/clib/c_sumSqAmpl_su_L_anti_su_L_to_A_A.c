...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_L_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0000 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_su_L
    ...
    const ccomplex_t IT_0010 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_su_L
      *Gamma_ul + (-0.5)*reg_prop, -1);
    ...
    const ccomplex_t IT_0053 = pow(m_su_L, 4);
