        ...
        )
{
    ...
    const ccomplex_t IT_0005 = (0 + _Complex_I*1)*g_s;
    ...
    const ccomplex_t IT_0012 = (-2)*IT_0005;
    ...
    const ccomplex_t IT_0026 = (-0.666666666666667)*IT_0003;
    ...
    const ccomplex_t IT_0031 = IT_0015*IT_0027;
    const ccomplex_t IT_0032 = 0.5*IT_0030 + (-0.5)*IT_0031;
    ...
    const ccomplex_t IT_0038 = IT_0012*IT_0026;
    ...
    const ccomplex_t IT_0043 = -IT_0013 + -IT_0027;
    ...
    const ccomplex_t IT_0050 = (-0.5)*IT_0030 + 0.5*IT_0041;
    ...
    const ccomplex_t IT_0071 = (-0.25)*conj(IT_0033);
    const ccomplex_t IT_0072 = (-0.25)*conj(IT_0037);
    const ccomplex_t IT_0073 = (-0.25)*conj(IT_0050)*IT_0051;
    const ccomplex_t IT_0074 = (-0.25)*conj(IT_0046);
    const ccomplex_t IT_0075 = conj(IT_0020)*IT_0065 + (-4)*IT_0067 + (-4)
      *IT_0059*IT_0068 + (-4)*IT_0063*IT_0069 + (-4)*IT_0070 + (-4)*IT_0056
      *IT_0071 + (-4)*IT_0058*IT_0072 + (-4)*IT_0073 + (-4)*IT_0057*IT_0074;
    const ccomplex_t IT_0076 = conj(IT_0020)*IT_0063 + (-4)*IT_0067 + (-4)
      *IT_0056*IT_0068 + (-4)*IT_0065*IT_0069 + (-4)*IT_0070 + (-4)*IT_0059
      *IT_0071 + (-4)*IT_0057*IT_0072 + (-4)*IT_0073 + (-4)*IT_0058*IT_0074;
