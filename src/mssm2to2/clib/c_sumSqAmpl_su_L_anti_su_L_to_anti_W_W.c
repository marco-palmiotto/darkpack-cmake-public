...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_L_to_anti_W_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*e_em*(IT_0006*IT_0009
    ...
    const ccomplex_t IT_0075 = 2*IT_0033;
    ...
    const ccomplex_t IT_0107 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009
      *IT_0096*conj(U_sb_01)*V_ub_mod;
    const ccomplex_t IT_0108 = (-0.5)*IT_0107;
    const ccomplex_t IT_0109 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009
      *IT_0099*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0110 = -IT_0109;
    const ccomplex_t IT_0111 = IT_0108*IT_0110;
    const ccomplex_t IT_0112 = cpow((-2)*s_23 + IT_0019 + IT_0103 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*IT_0112;
    const ccomplex_t IT_0114 = IT_0111*IT_0113;
    const ccomplex_t IT_0115 = -IT_0043;
    const ccomplex_t IT_0116 = IT_0077 + IT_0115;
    const ccomplex_t IT_0117 = IT_0031*IT_0116;
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0009;
    const ccomplex_t IT_0119 = (-0.5)*IT_0118;
    const ccomplex_t IT_0120 = -IT_0118;
    const ccomplex_t IT_0121 = IT_0119*IT_0120;
    const ccomplex_t IT_0122 = cpow((-2)*s_23 + IT_0019 + IT_0103 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0123 = (0 + _Complex_I*1)*IT_0122;
    const ccomplex_t IT_0124 = IT_0121*IT_0123;
    const ccomplex_t IT_0125 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
      *IT_0009;
    const ccomplex_t IT_0126 = (-0.5)*IT_0125;
    const ccomplex_t IT_0127 = -IT_0125;
    const ccomplex_t IT_0128 = IT_0126*IT_0127;
    const ccomplex_t IT_0129 = cpow((-2)*s_23 + IT_0019 + IT_0103 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0130 = (0 + _Complex_I*1)*IT_0129;
    const ccomplex_t IT_0131 = IT_0128*IT_0130;
    const ccomplex_t IT_0132 = -IT_0061;
    const ccomplex_t IT_0133 = IT_0081 + IT_0132;
    const ccomplex_t IT_0134 = IT_0051*IT_0133;
    const ccomplex_t IT_0135 = -IT_0106 + -IT_0114 + 0.5*IT_0117 + -IT_0124 + 
      -IT_0131 + -IT_0134;
    const ccomplex_t IT_0136 = s_14*s_23*s_34*IT_0072;
    const ccomplex_t IT_0137 = s_14*s_24*IT_0084;
    const ccomplex_t IT_0138 = -IT_0137;
    const ccomplex_t IT_0139 = s_13*s_23*IT_0084;
    const ccomplex_t IT_0140 = -IT_0139;
    const ccomplex_t IT_0141 = s_12 + IT_0138 + IT_0140;
    const ccomplex_t IT_0142 = IT_0136 + IT_0141;
    const ccomplex_t IT_0143 = 3*IT_0071;
    const ccomplex_t IT_0144 = pow(s_23, 2);
    const ccomplex_t IT_0145 = IT_0084*IT_0144;
    const ccomplex_t IT_0146 = -(IT_0019 + -IT_0089)*(IT_0019 + -IT_0145);
    const ccomplex_t IT_0147 = -IT_0146;
    const ccomplex_t IT_0148 = 3*IT_0135;
    const ccomplex_t IT_0149 = -(IT_0019 + -IT_0089)*(s_12 + -IT_0139);
    const ccomplex_t IT_0150 = (-3)*IT_0083;
    const ccomplex_t IT_0151 = IT_0042*IT_0075;
    const ccomplex_t IT_0152 = -IT_0151;
    const ccomplex_t IT_0153 = IT_0077 + IT_0152;
    const ccomplex_t IT_0154 = IT_0031*IT_0153;
    const ccomplex_t IT_0155 = IT_0060*IT_0079;
    const ccomplex_t IT_0156 = -IT_0155;
    const ccomplex_t IT_0157 = IT_0081 + IT_0156;
    const ccomplex_t IT_0158 = IT_0051*IT_0157;
    const ccomplex_t IT_0159 = 0.5*IT_0154 + -IT_0158;
    const ccomplex_t IT_0160 = s_13*s_24*s_34*IT_0072;
    const ccomplex_t IT_0161 = IT_0141 + IT_0160;
    const ccomplex_t IT_0162 = 3*conj(IT_0071);
    const ccomplex_t IT_0163 = (s_12 + -IT_0137)*(s_12 + -IT_0139);
    const ccomplex_t IT_0164 = 3*conj(IT_0135);
    const ccomplex_t IT_0165 = -(IT_0019 + -IT_0086)*(s_12 + -IT_0137);
    const ccomplex_t IT_0166 = (-3)*conj(IT_0083);
    const ccomplex_t IT_0167 = -IT_0097;
    const ccomplex_t IT_0168 = IT_0101*IT_0167;
    const ccomplex_t IT_0169 = -IT_0168;
    const ccomplex_t IT_0170 = IT_0102 + IT_0169;
    const ccomplex_t IT_0171 = IT_0105*IT_0170;
    const ccomplex_t IT_0172 = IT_0033*IT_0035;
    const ccomplex_t IT_0173 = IT_0033*IT_0042;
    const ccomplex_t IT_0174 = -IT_0173;
    const ccomplex_t IT_0175 = IT_0172 + IT_0174;
    const ccomplex_t IT_0176 = IT_0031*IT_0175;
    const ccomplex_t IT_0177 = cpow(IT_0120, 2);
    const ccomplex_t IT_0178 = -IT_0177;
    const ccomplex_t IT_0179 = IT_0121 + IT_0178;
    const ccomplex_t IT_0180 = IT_0123*IT_0179;
    const ccomplex_t IT_0181 = cpow(IT_0127, 2);
    const ccomplex_t IT_0182 = -IT_0181;
    const ccomplex_t IT_0183 = IT_0128 + IT_0182;
    const ccomplex_t IT_0184 = IT_0130*IT_0183;
    const ccomplex_t IT_0185 = -IT_0107;
    const ccomplex_t IT_0186 = IT_0110*IT_0185;
    ...
    const ccomplex_t IT_0195 = IT_0171 + (-0.5)*IT_0176 + IT_0180 + IT_0184 +
       IT_0189 + IT_0194;
    const ccomplex_t IT_0196 = s_14*s_34*IT_0084;
    const ccomplex_t IT_0197 = (s_12 + -IT_0139)*(s_13 + -IT_0196);
    const ccomplex_t IT_0198 = 3*conj(IT_0083);
    const ccomplex_t IT_0199 = s_34*IT_0084;
    ...
    const ccomplex_t IT_0204 = (IT_0019 + -IT_0145)*(s_13 + -IT_0196);
    const ccomplex_t IT_0205 = -IT_0204;
    const ccomplex_t IT_0206 = (-3)*conj(IT_0135);
    const ccomplex_t IT_0207 = -IT_0043 + -IT_0151;
    const ccomplex_t IT_0208 = IT_0077 + IT_0207;
    const ccomplex_t IT_0209 = IT_0031*IT_0208;
    const ccomplex_t IT_0210 = -IT_0061 + -IT_0155;
    const ccomplex_t IT_0211 = IT_0081 + IT_0210;
    const ccomplex_t IT_0212 = IT_0051*IT_0211;
    const ccomplex_t IT_0213 = -IT_0171 + -IT_0180 + -IT_0184 + -IT_0189 + 0.5
      *IT_0209 + -IT_0212;
    const ccomplex_t IT_0214 = s_23*s_24*s_34*IT_0072;
    const ccomplex_t IT_0215 = pow(s_24, 2);
    const ccomplex_t IT_0216 = IT_0084*IT_0215;
    const ccomplex_t IT_0217 = -IT_0216;
    const ccomplex_t IT_0218 = -IT_0145;
    const ccomplex_t IT_0219 = IT_0019 + IT_0214 + IT_0217 + IT_0218;
    const ccomplex_t IT_0220 = (s_12 + -IT_0137)*(IT_0019 + -IT_0145);
    const ccomplex_t IT_0221 = -IT_0220;
    const ccomplex_t IT_0222 = (s_12 + -IT_0139)*(IT_0019 + -IT_0216);
    const ccomplex_t IT_0223 = -IT_0222;
    const ccomplex_t IT_0224 = (-3)*conj(IT_0159);
    const ccomplex_t IT_0225 = IT_0031*IT_0172;
    const ccomplex_t IT_0226 = IT_0051*IT_0190;
    const ccomplex_t IT_0227 = (-0.5)*IT_0225 + IT_0226;
    const ccomplex_t IT_0228 = s_13*s_34*IT_0084;
    const ccomplex_t IT_0229 = -IT_0228;
    const ccomplex_t IT_0230 = s_14 + IT_0229;
    const ccomplex_t IT_0231 = IT_0199*IT_0230;
    const ccomplex_t IT_0232 = -(IT_0019 + -IT_0086)*(s_13 + -IT_0196);
    const ccomplex_t IT_0233 = s_24*s_34*IT_0084;
    const ccomplex_t IT_0234 = -(IT_0019 + -IT_0086)*(s_23 + -IT_0233);
    const ccomplex_t IT_0235 = (s_12 + -IT_0139)*(s_23 + -IT_0233);
    const ccomplex_t IT_0236 = (IT_0019 + -IT_0145)*(IT_0019 + -IT_0216);
    const ccomplex_t IT_0237 = 3*IT_0213;
    const ccomplex_t IT_0238 = (-3)*IT_0135;
    const ccomplex_t IT_0239 = (-3)*IT_0159;
    const ccomplex_t IT_0240 = (IT_0019 + -IT_0145)*(s_23 + -IT_0233);
    const ccomplex_t IT_0241 = -IT_0240;
    const ccomplex_t IT_0242 = -IT_0195;
    const ccomplex_t IT_0243 = 0.333333333333333*IT_0163;
    const ccomplex_t IT_0244 = -(IT_0019 + -IT_0086)*(IT_0019 + -IT_0216);
    const ccomplex_t IT_0245 = -IT_0244;
    const ccomplex_t IT_0246 = 3*IT_0159;
    const ccomplex_t IT_0247 = IT_0073*IT_0084;
    const ccomplex_t IT_0248 = (s_12 + -IT_0139)*(IT_0103 + -IT_0247);
    const ccomplex_t IT_0249 = (IT_0019 + -IT_0145)*(IT_0103 + -IT_0247);
    const ccomplex_t IT_0250 = -IT_0249;
    const ccomplex_t IT_0251 = (-0.333333333333333)*IT_0235;
    const ccomplex_t IT_0252 = -(IT_0019 + -IT_0086)*(IT_0103 + -IT_0247);
    const ccomplex_t IT_0253 = 6*IT_0071*conj(IT_0071)*(1 + 0.5*IT_0074) +
      ...
      *IT_0095 + conj(IT_0135)*(IT_0142*IT_0143 + IT_0147*IT_0148 + IT_0149
      *IT_0150) + IT_0135*(IT_0142*IT_0162 + IT_0149*IT_0166) + IT_0159*(IT_0161
      *IT_0162 + IT_0163*IT_0164 + IT_0165*IT_0166) + IT_0195*(IT_0197*IT_0198 +
       IT_0095*IT_0203 + IT_0205*IT_0206) + IT_0213*(IT_0163*IT_0198 + IT_0162
      *IT_0219 + IT_0206*IT_0221 + IT_0223*IT_0224) + IT_0227*(IT_0164*IT_0197 +
       IT_0095*IT_0231 + IT_0166*IT_0232 + IT_0224*IT_0234) + 3*conj(IT_0213)*
      (0.333333333333333*IT_0143*IT_0219 + IT_0227*IT_0235 + 0.333333333333333
      *IT_0236*IT_0237 + 0.333333333333333*IT_0221*IT_0238 + 0.333333333333333
      *IT_0223*IT_0239 + IT_0241*IT_0242 + IT_0091*IT_0243) + 3*conj(IT_0159)*
      (0.333333333333333*IT_0143*IT_0161 + 0.333333333333333*IT_0150*IT_0165 +
       IT_0195*IT_0235 + IT_0148*IT_0243 + 0.333333333333333*IT_0245*IT_0246) + 
      (-3)*conj(IT_0195)*((-0.333333333333333)*IT_0091*IT_0197 + (
      -0.333333333333333)*IT_0094*IT_0203 + (-0.333333333333333)*IT_0205*IT_0238
       + IT_0213*IT_0241 + -IT_0227*IT_0248 + IT_0195*IT_0250 + IT_0246*IT_0251)
       + (-3)*conj(IT_0227)*((-0.333333333333333)*IT_0148*IT_0197 + (
      -0.333333333333333)*IT_0094*IT_0231 + (-0.333333333333333)*IT_0150*IT_0232
