        ...
        )
{
    ...
    const ccomplex_t IT_0038 = (-2)*IT_0033;
    const ccomplex_t IT_0039 = (-1.33333333333333)*IT_0033;
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = s_23*IT_0040;
    const ccomplex_t IT_0042 = s_13 + s_23;
    const ccomplex_t IT_0043 = IT_0035*IT_0038;
    const ccomplex_t IT_0044 = IT_0042*IT_0043;
    const ccomplex_t IT_0045 = IT_0034*IT_0039;
    ...
    const ccomplex_t IT_0096 = -IT_0045;
    const ccomplex_t IT_0097 = IT_0077 + IT_0096;
    const ccomplex_t IT_0098 = IT_0031*IT_0097;
    const ccomplex_t IT_0099 = -IT_0061;
    const ccomplex_t IT_0100 = IT_0081 + IT_0099;
    const ccomplex_t IT_0101 = IT_0051*IT_0100;
    const ccomplex_t IT_0102 = 0.5*IT_0098 + -IT_0101;
    ...
    const ccomplex_t IT_0113 = -(IT_0019 + -IT_0089)*(IT_0019 + -IT_0112);
    const ccomplex_t IT_0114 = -IT_0113;
    const ccomplex_t IT_0115 = 3*IT_0102;
    const ccomplex_t IT_0116 = -(IT_0019 + -IT_0089)*(s_12 + -IT_0106);
    const ccomplex_t IT_0117 = (-3)*IT_0083;
    const ccomplex_t IT_0118 = 3*conj(IT_0071);
    const ccomplex_t IT_0119 = (-3)*conj(IT_0083);
    const ccomplex_t IT_0120 = IT_0039*IT_0075;
    const ccomplex_t IT_0121 = -IT_0120;
    const ccomplex_t IT_0122 = IT_0077 + IT_0121;
    const ccomplex_t IT_0123 = IT_0031*IT_0122;
    const ccomplex_t IT_0124 = IT_0060*IT_0079;
    const ccomplex_t IT_0125 = -IT_0124;
    const ccomplex_t IT_0126 = IT_0081 + IT_0125;
    const ccomplex_t IT_0127 = IT_0051*IT_0126;
    const ccomplex_t IT_0128 = 0.5*IT_0123 + -IT_0127;
    const ccomplex_t IT_0129 = s_13*s_24*s_34*IT_0072;
    const ccomplex_t IT_0130 = IT_0108 + IT_0129;
    const ccomplex_t IT_0131 = (s_12 + -IT_0104)*(s_12 + -IT_0106);
    const ccomplex_t IT_0132 = 3*conj(IT_0102);
    const ccomplex_t IT_0133 = -(IT_0019 + -IT_0086)*(s_12 + -IT_0104);
    const ccomplex_t IT_0134 = pow(m_W, 2);
    const ccomplex_t IT_0135 = cpow((-2)*s_23 + IT_0019 + IT_0134 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0136 = (0 + _Complex_I*1)*IT_0135;
    const ccomplex_t IT_0137 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009
      *IT_0137*U_sb_01*V_ub_mod;
    const ccomplex_t IT_0139 = -IT_0138;
    const ccomplex_t IT_0140 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0141 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009
      *IT_0140*conj(U_sb_01)*V_ub_mod;
    const ccomplex_t IT_0142 = -IT_0141;
    const ccomplex_t IT_0143 = IT_0139*IT_0142;
    const ccomplex_t IT_0144 = IT_0136*IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*V_us*e_em
      *IT_0009;
    const ccomplex_t IT_0146 = -IT_0145;
    const ccomplex_t IT_0147 = cpow(IT_0146, 2);
    const ccomplex_t IT_0148 = cpow((-2)*s_23 + IT_0019 + IT_0134 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*IT_0148;
    const ccomplex_t IT_0150 = IT_0147*IT_0149;
    const ccomplex_t IT_0151 = cpow((-2)*s_23 + IT_0019 + IT_0134 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0152 = (0 + _Complex_I*1)*IT_0151;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009
      *IT_0140*conj(U_sb_00)*V_ub_mod;
    const ccomplex_t IT_0154 = -IT_0153;
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0009
      *IT_0137*U_sb_00*V_ub_mod;
    const ccomplex_t IT_0156 = -IT_0155;
    const ccomplex_t IT_0157 = IT_0154*IT_0156;
    const ccomplex_t IT_0158 = IT_0152*IT_0157;
    const ccomplex_t IT_0159 = IT_0033*IT_0039;
    const ccomplex_t IT_0160 = -IT_0159;
    const ccomplex_t IT_0161 = IT_0033*IT_0035;
    const ccomplex_t IT_0162 = IT_0160 + IT_0161;
    const ccomplex_t IT_0163 = IT_0031*IT_0162;
    const ccomplex_t IT_0164 = IT_0052*IT_0056;
    const ccomplex_t IT_0165 = IT_0052*IT_0060;
    ...
    const ccomplex_t IT_0171 = cpow(IT_0170, 2);
    const ccomplex_t IT_0172 = cpow((-2)*s_23 + IT_0019 + IT_0134 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0173 = (0 + _Complex_I*1)*IT_0172;
    const ccomplex_t IT_0174 = IT_0171*IT_0173;
    const ccomplex_t IT_0175 = -IT_0144 + -IT_0150 + -IT_0158 + (-0.5)*IT_0163
       + IT_0168 + -IT_0174;
    const ccomplex_t IT_0176 = s_14*s_34*IT_0084;
    const ccomplex_t IT_0177 = (s_12 + -IT_0106)*(s_13 + -IT_0176);
    const ccomplex_t IT_0178 = 3*conj(IT_0083);
    const ccomplex_t IT_0179 = s_34*IT_0084;
    const ccomplex_t IT_0180 = s_23*s_34*IT_0084;
    const ccomplex_t IT_0181 = -IT_0180;
    const ccomplex_t IT_0182 = s_24 + IT_0181;
    const ccomplex_t IT_0183 = IT_0179*IT_0182;
    const ccomplex_t IT_0184 = (IT_0019 + -IT_0112)*(s_13 + -IT_0176);
    const ccomplex_t IT_0185 = -IT_0184;
    const ccomplex_t IT_0186 = (-3)*conj(IT_0102);
    const ccomplex_t IT_0187 = -IT_0045 + -IT_0120;
    const ccomplex_t IT_0188 = IT_0077 + IT_0187;
    const ccomplex_t IT_0189 = IT_0031*IT_0188;
    const ccomplex_t IT_0190 = -IT_0061 + -IT_0124;
    const ccomplex_t IT_0191 = IT_0081 + IT_0190;
    const ccomplex_t IT_0192 = IT_0051*IT_0191;
    const ccomplex_t IT_0193 = IT_0144 + IT_0150 + IT_0158 + IT_0174 + 0.5
      *IT_0189 + -IT_0192;
    const ccomplex_t IT_0194 = s_23*s_24*s_34*IT_0072;
    const ccomplex_t IT_0195 = pow(s_24, 2);
    const ccomplex_t IT_0196 = IT_0084*IT_0195;
    const ccomplex_t IT_0197 = -IT_0196;
    const ccomplex_t IT_0198 = -IT_0112;
    const ccomplex_t IT_0199 = IT_0019 + IT_0194 + IT_0197 + IT_0198;
    const ccomplex_t IT_0200 = (s_12 + -IT_0104)*(IT_0019 + -IT_0112);
    ...
    const ccomplex_t IT_0205 = IT_0051*IT_0164;
    const ccomplex_t IT_0206 = IT_0031*IT_0161;
    const ccomplex_t IT_0207 = IT_0205 + (-0.5)*IT_0206;
    const ccomplex_t IT_0208 = s_13*s_34*IT_0084;
    const ccomplex_t IT_0209 = -IT_0208;
    const ccomplex_t IT_0210 = s_14 + IT_0209;
    const ccomplex_t IT_0211 = IT_0179*IT_0210;
    const ccomplex_t IT_0212 = -(IT_0019 + -IT_0086)*(s_13 + -IT_0176);
    const ccomplex_t IT_0213 = s_24*s_34*IT_0084;
    const ccomplex_t IT_0214 = -(IT_0019 + -IT_0086)*(s_23 + -IT_0213);
    const ccomplex_t IT_0215 = (s_12 + -IT_0106)*(s_23 + -IT_0213);
    const ccomplex_t IT_0216 = (IT_0019 + -IT_0112)*(IT_0019 + -IT_0196);
    const ccomplex_t IT_0217 = 3*IT_0193;
    const ccomplex_t IT_0218 = (-3)*IT_0102;
    const ccomplex_t IT_0219 = (-3)*IT_0128;
    const ccomplex_t IT_0220 = (IT_0019 + -IT_0112)*(s_23 + -IT_0213);
    const ccomplex_t IT_0221 = -IT_0220;
    const ccomplex_t IT_0222 = -IT_0175;
    const ccomplex_t IT_0223 = 0.333333333333333*IT_0131;
    const ccomplex_t IT_0224 = -(IT_0019 + -IT_0086)*(IT_0019 + -IT_0196);
    const ccomplex_t IT_0225 = -IT_0224;
    const ccomplex_t IT_0226 = 3*IT_0128;
    const ccomplex_t IT_0227 = IT_0073*IT_0084;
    const ccomplex_t IT_0228 = (s_12 + -IT_0106)*(IT_0134 + -IT_0227);
    const ccomplex_t IT_0229 = (IT_0019 + -IT_0112)*(IT_0134 + -IT_0227);
    const ccomplex_t IT_0230 = -IT_0229;
    const ccomplex_t IT_0231 = (-0.333333333333333)*IT_0215;
    const ccomplex_t IT_0232 = -(IT_0019 + -IT_0086)*(IT_0134 + -IT_0227);
    const ccomplex_t IT_0233 = 6*IT_0071*conj(IT_0071)*(1 + 0.5*IT_0074) +
      ...
      *IT_0117) + IT_0102*(IT_0109*IT_0118 + IT_0116*IT_0119) + IT_0128*(IT_0118
      *IT_0130 + IT_0131*IT_0132 + IT_0119*IT_0133) + IT_0175*(IT_0177*IT_0178 +
       IT_0095*IT_0183 + IT_0185*IT_0186) + IT_0193*(IT_0131*IT_0178 + IT_0118
      *IT_0199 + IT_0186*IT_0201 + IT_0203*IT_0204) + IT_0207*(IT_0132*IT_0177 +
       IT_0095*IT_0211 + IT_0119*IT_0212 + IT_0204*IT_0214) + 3*conj(IT_0193)*
      (0.333333333333333*IT_0110*IT_0199 + IT_0207*IT_0215 + 0.333333333333333
      *IT_0216*IT_0217 + 0.333333333333333*IT_0201*IT_0218 + 0.333333333333333
      *IT_0203*IT_0219 + IT_0221*IT_0222 + IT_0091*IT_0223) + 3*conj(IT_0128)*
      (0.333333333333333*IT_0110*IT_0130 + 0.333333333333333*IT_0117*IT_0133 +
       IT_0175*IT_0215 + IT_0115*IT_0223 + 0.333333333333333*IT_0225*IT_0226) + 
      (-3)*conj(IT_0175)*((-0.333333333333333)*IT_0091*IT_0177 + (
      -0.333333333333333)*IT_0094*IT_0183 + (-0.333333333333333)*IT_0185*IT_0218
       + IT_0193*IT_0221 + -IT_0207*IT_0228 + IT_0175*IT_0230 + IT_0226*IT_0231)
       + (-3)*conj(IT_0207)*((-0.333333333333333)*IT_0115*IT_0177 + (
      -0.333333333333333)*IT_0094*IT_0211 + (-0.333333333333333)*IT_0117*IT_0212
       + (-0.333333333333333)*IT_0214*IT_0219 + IT_0222*IT_0228 + IT_0217
      *IT_0231 + IT_0207*IT_0232);
