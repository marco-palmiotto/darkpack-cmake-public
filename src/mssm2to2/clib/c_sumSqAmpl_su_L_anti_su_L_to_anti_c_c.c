        ...
        )
{
    ...
    const ccomplex_t IT_0085 = m_c*s_14;
    ...
    const ccomplex_t IT_0109 = m_c*s_13;
    const ccomplex_t IT_0110 = conj(IT_0028)*IT_0054;
    const ccomplex_t IT_0111 = (-18)*conj(IT_0066);
    const ccomplex_t IT_0112 = (-18)*conj(IT_0051);
    ...
    const ccomplex_t IT_0116 = IT_0028*(conj(IT_0028)*(36*s_34 + (-36)*IT_0029
      ...
      *IT_0085 + IT_0086*IT_0087) + -IT_0093*(IT_0094 + IT_0080*(IT_0080 + 
      ...
      (conj(IT_0050)*IT_0053 + 18*conj(IT_0068)*IT_0109 + IT_0110 + IT_0085
      *IT_0111 + IT_0029*IT_0112) + IT_0066*(IT_0081*IT_0109 + conj(IT_0066)
      *IT_0113 + IT_0115) + IT_0068*(18*conj(IT_0050)*IT_0109 + IT_0087*IT_0111 
      + IT_0085*IT_0112 + conj(IT_0068)*IT_0113 + IT_0115);
