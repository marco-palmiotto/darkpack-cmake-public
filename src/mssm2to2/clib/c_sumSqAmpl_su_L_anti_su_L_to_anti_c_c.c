...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_L_to_anti_c_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0072 = IT_0034*IT_0044;
    ...
    const ccomplex_t IT_0092 = 18*IT_0028;
    const ccomplex_t IT_0093 = 18*conj(IT_0028);
    const ccomplex_t IT_0094 = 18*conj(IT_0050);
    const ccomplex_t IT_0095 = (-18)*IT_0050;
    const ccomplex_t IT_0096 = ((-12)*IT_0028 + 12*conj(IT_0028) + (-6)
      *IT_0050 + 6*conj(IT_0050) + (-6)*IT_0051 + 6*conj(IT_0051))*IT_0061 +
       IT_0088*IT_0092 + (IT_0073 + IT_0075)*IT_0093 + IT_0068*((-36)*IT_0028 +
       36*conj(IT_0028) + (-18)*IT_0051 + 18*conj(IT_0051) + IT_0094 + IT_0095);
    const ccomplex_t IT_0097 = m_c*s_14;
    const ccomplex_t IT_0098 = m_c*s_13;
    const ccomplex_t IT_0099 = conj(IT_0028)*IT_0054;
    const ccomplex_t IT_0100 = (-18)*conj(IT_0073);
    const ccomplex_t IT_0101 = (-18)*conj(IT_0050);
    ...
    const ccomplex_t IT_0105 = IT_0028*(conj(IT_0028)*(36*s_34 + (-36)*IT_0029
      ...
      *IT_0069 + (-12)*IT_0070 + (-12)*IT_0071) + 0.5*(IT_0073 + -conj(IT_0073) 
      ...
      (IT_0068*IT_0083 + -IT_0087*IT_0088) + IT_0091*IT_0096 + IT_0095*(IT_0029
      *conj(IT_0051) + conj(IT_0075)*IT_0097) + IT_0050*(conj(IT_0050)*IT_0053 +
       18*conj(IT_0073)*IT_0098 + IT_0099) + IT_0051*(conj(IT_0051)*IT_0053 + 18
      *conj(IT_0075)*IT_0098 + IT_0099 + IT_0097*IT_0100 + IT_0029*IT_0101) +
       IT_0073*((-18)*IT_0070*conj(IT_0075) + (-18)*conj(IT_0051)*IT_0097 +
       IT_0094*IT_0098 + conj(IT_0073)*IT_0102 + IT_0104) + IT_0075*(18*conj
      (IT_0051)*IT_0098 + IT_0070*IT_0100 + IT_0097*IT_0101 + conj(IT_0075)
      *IT_0102 + IT_0104);
