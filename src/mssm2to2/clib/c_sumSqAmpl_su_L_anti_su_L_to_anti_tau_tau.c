...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_L_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0087 = IT_0029*(conj(IT_0029)*(12*s_34 + (-12)*IT_0030
      ...
      (IT_0057))*IT_0059) + -IT_0067*IT_0077 + conj(IT_0049)*(IT_0076*IT_0078 +
       IT_0070*IT_0079) + conj(IT_0056)*(IT_0030*IT_0076 + IT_0078*IT_0079) + 6
      *IT_0044*(0.166666666666667*conj(IT_0044)*IT_0073 + conj(IT_0057)*IT_0080 
      + IT_0081) + 6*IT_0049*(0.166666666666667*conj(IT_0049)*IT_0073 + conj
      (IT_0056)*IT_0080 + IT_0081 + 0.166666666666667*IT_0070*IT_0082 + IT_0083
      *IT_0084) + 6*IT_0056*(conj(IT_0049)*IT_0080 + 0.166666666666667*IT_0030
      *IT_0083 + IT_0082*IT_0084 + 0.166666666666667*conj(IT_0056)*IT_0085 +
       IT_0086) + 6*IT_0057*(conj(IT_0044)*IT_0080 + 0.166666666666667*conj
