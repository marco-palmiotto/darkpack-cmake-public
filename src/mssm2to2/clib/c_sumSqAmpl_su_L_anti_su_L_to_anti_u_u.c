        ...
        )
{
    ...
    const ccomplex_t IT_0030 = cpow((-2)*s_23 + IT_0001 + IT_0016 + -IT_0029 +
       reg_prop, -1);
    ...
    const ccomplex_t IT_0036 = cpow(IT_0009, -1);
    const ccomplex_t IT_0037 = IT_0005*IT_0036;
    const ccomplex_t IT_0038 = e_em*IT_0037;
    const ccomplex_t IT_0039 = IT_0006*IT_0009;
    ...
    const ccomplex_t IT_0046 = (0 + _Complex_I*-3)*e_em*(IT_0006*IT_0009 + -1.
      /3*IT_0005*IT_0036);
    const ccomplex_t IT_0047 = 0.333333333333333*IT_0046;
    const ccomplex_t IT_0048 = m_u*IT_0047;
    const ccomplex_t IT_0049 = -IT_0048;
    const ccomplex_t IT_0050 = 0.166666666666667*IT_0046;
    const ccomplex_t IT_0051 = m_u*IT_0050;
    const ccomplex_t IT_0052 = IT_0049 + IT_0051;
    const ccomplex_t IT_0053 = IT_0045*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*e_em*IT_0005*IT_0036;
    ...
    const ccomplex_t IT_0059 = 0.5*IT_0035 + -IT_0053 + IT_0058;
    const ccomplex_t IT_0060 = (IT_0048 + -IT_0051)*(IT_0045 + -IT_0057);
    const ccomplex_t IT_0061 = -IT_0060;
    const ccomplex_t IT_0062 = (-18)*IT_0001;
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_23 + IT_0001 + IT_0016 + -m_N_1*
    ...
    const ccomplex_t IT_0122 = cpow((-2)*s_23 + IT_0001 + IT_0016 + -m_N_3*
    ...
    const ccomplex_t IT_0142 = cpow((-2)*s_23 + IT_0001 + IT_0016 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0143 = IT_0141*IT_0142;
    const ccomplex_t IT_0144 = (0 + _Complex_I*1)*IT_0143;
    const ccomplex_t IT_0145 = 0.166666666666667*IT_0034 + -IT_0084 + -IT_0104
       + -IT_0124 + -IT_0144;
    const ccomplex_t IT_0146 = IT_0045*IT_0047;
    const ccomplex_t IT_0147 = (-0.5)*IT_0034 + -IT_0146;
    const ccomplex_t IT_0148 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u1)
      *e_em*IT_0000*IT_0004*IT_0006;
    const ccomplex_t IT_0149 = (-0.5)*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
    ...
    const ccomplex_t IT_0155 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0000*IT_0004*IT_0006;
    const ccomplex_t IT_0156 = (-0.5)*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0000*IT_0004*IT_0006;
    const ccomplex_t IT_0158 = (-0.5)*IT_0157;
    const ccomplex_t IT_0159 = IT_0156*IT_0158;
    const ccomplex_t IT_0160 = IT_0102*IT_0159;
    const ccomplex_t IT_0161 = (0 + _Complex_I*1)*IT_0160;
    const ccomplex_t IT_0162 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0000*IT_0004*IT_0006;
    ...
    const ccomplex_t IT_0169 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0000*IT_0004*IT_0006;
    const ccomplex_t IT_0170 = (-0.5)*IT_0169;
    const ccomplex_t IT_0171 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0000*IT_0004*IT_0006;
    const ccomplex_t IT_0172 = (-0.5)*IT_0171;
    const ccomplex_t IT_0173 = IT_0170*IT_0172;
    const ccomplex_t IT_0174 = IT_0142*IT_0173;
    const ccomplex_t IT_0175 = (0 + _Complex_I*1)*IT_0174;
    const ccomplex_t IT_0176 = -IT_0154 + -IT_0161 + -IT_0168 + -IT_0175;
    const ccomplex_t IT_0177 = IT_0047*IT_0057;
    const ccomplex_t IT_0178 = -IT_0177;
    const ccomplex_t IT_0179 = s_34*IT_0016;
    ...
    const ccomplex_t IT_0184 = (-18)*IT_0179;
    const ccomplex_t IT_0185 = 36*IT_0181;
    const ccomplex_t IT_0186 = IT_0184 + IT_0185;
    const ccomplex_t IT_0187 = (0 + _Complex_I*1)*e_em;
    const ccomplex_t IT_0188 = 0.666666666666667*IT_0187;
    const ccomplex_t IT_0189 = (-1.33333333333333)*IT_0187;
    const ccomplex_t IT_0190 = IT_0188*IT_0189;
    const ccomplex_t IT_0191 = cpow(s_12 + IT_0016 + 0.5*reg_prop, -1);
    const ccomplex_t IT_0192 = IT_0190*IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1)*IT_0192;
    const ccomplex_t IT_0194 = (0 + _Complex_I*1)*g_s;
    const ccomplex_t IT_0195 = (-2)*IT_0194;
    const ccomplex_t IT_0196 = IT_0191*IT_0194;
    const ccomplex_t IT_0197 = (0 + _Complex_I*1)*IT_0196;
    const ccomplex_t IT_0198 = IT_0195*IT_0197;
    const ccomplex_t IT_0199 = 0.5*IT_0193 + (-0.0833333333333333)*IT_0198;
    const ccomplex_t IT_0200 = cpow(IT_0199, 2);
    const ccomplex_t IT_0201 = (-36)*IT_0179;
    const ccomplex_t IT_0202 = IT_0001*IT_0016;
    const ccomplex_t IT_0203 = (-36)*IT_0202;
    const ccomplex_t IT_0204 = 72*IT_0181;
    const ccomplex_t IT_0205 = IT_0201 + IT_0203 + IT_0204;
    const ccomplex_t IT_0206 = 0.25*IT_0198;
    const ccomplex_t IT_0207 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0208 = IT_0072*IT_0149;
    const ccomplex_t IT_0209 = IT_0082*IT_0207*IT_0208;
    const ccomplex_t IT_0210 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0211 = IT_0092*IT_0156;
    const ccomplex_t IT_0212 = IT_0102*IT_0210*IT_0211;
    const ccomplex_t IT_0213 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0214 = IT_0112*IT_0163;
    const ccomplex_t IT_0215 = IT_0122*IT_0213*IT_0214;
    const ccomplex_t IT_0216 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0217 = IT_0132*IT_0170;
    const ccomplex_t IT_0218 = IT_0142*IT_0216*IT_0217;
    const ccomplex_t IT_0219 = m_u*IT_0154;
    const ccomplex_t IT_0220 = m_u*IT_0161;
    const ccomplex_t IT_0221 = m_u*IT_0175;
    const ccomplex_t IT_0222 = m_u*IT_0168;
    const ccomplex_t IT_0223 = -IT_0209 + -IT_0212 + -IT_0215 + -IT_0218 +
       IT_0219 + IT_0220 + IT_0221 + IT_0222;
    const ccomplex_t IT_0224 = IT_0080*IT_0151;
    const ccomplex_t IT_0225 = IT_0082*IT_0207*IT_0224;
    const ccomplex_t IT_0226 = IT_0100*IT_0158;
    const ccomplex_t IT_0227 = IT_0102*IT_0210*IT_0226;
    const ccomplex_t IT_0228 = IT_0120*IT_0165;
    const ccomplex_t IT_0229 = IT_0122*IT_0213*IT_0228;
    const ccomplex_t IT_0230 = IT_0140*IT_0172;
    const ccomplex_t IT_0231 = IT_0142*IT_0216*IT_0230;
    const ccomplex_t IT_0232 = m_u*IT_0084;
    const ccomplex_t IT_0233 = m_u*IT_0104;
    const ccomplex_t IT_0234 = m_u*IT_0124;
    const ccomplex_t IT_0235 = m_u*IT_0144;
    const ccomplex_t IT_0236 = (-0.166666666666667)*IT_0035 + -IT_0225 + 
      -IT_0227 + -IT_0229 + -IT_0231 + IT_0232 + IT_0233 + IT_0234 + IT_0235;
    const ccomplex_t IT_0237 = (-18)*IT_0236;
    const ccomplex_t IT_0238 = (-6)*IT_0059;
    const ccomplex_t IT_0239 = IT_0237 + IT_0238;
    const ccomplex_t IT_0240 = (-18)*conj(IT_0236);
    const ccomplex_t IT_0241 = (-6)*conj(IT_0059);
    const ccomplex_t IT_0242 = IT_0240 + IT_0241;
    const ccomplex_t IT_0243 = (-18)*IT_0059;
    const ccomplex_t IT_0244 = (-6)*IT_0236;
    const ccomplex_t IT_0245 = IT_0243 + IT_0244;
    const ccomplex_t IT_0246 = (-18)*conj(IT_0059);
    const ccomplex_t IT_0247 = (-6)*conj(IT_0236);
    const ccomplex_t IT_0248 = IT_0246 + IT_0247;
    const ccomplex_t IT_0249 = (-18)*IT_0145 + (-6)*IT_0147;
    const ccomplex_t IT_0250 = (-18)*IT_0147;
    const ccomplex_t IT_0251 = (-6)*IT_0145;
    const ccomplex_t IT_0252 = IT_0250 + IT_0251;
    const ccomplex_t IT_0253 = (-18)*conj(IT_0147);
    const ccomplex_t IT_0254 = (-6)*conj(IT_0145);
    const ccomplex_t IT_0255 = IT_0253 + IT_0254;
    const ccomplex_t IT_0256 = 6*s_34;
    const ccomplex_t IT_0257 = -IT_0001;
    const ccomplex_t IT_0258 = s_34 + IT_0257;
    const ccomplex_t IT_0259 = 6*IT_0028;
    const ccomplex_t IT_0260 = 6*conj(IT_0028);
    const ccomplex_t IT_0261 = m_u*s_14;
    const ccomplex_t IT_0262 = (-18)*IT_0223;
    const ccomplex_t IT_0263 = (-6)*IT_0223;
    const ccomplex_t IT_0264 = (-6)*IT_0202;
    const ccomplex_t IT_0265 = IT_0180 + IT_0182 + IT_0264;
    const ccomplex_t IT_0266 = conj(IT_0145) + conj(IT_0176);
    const ccomplex_t IT_0267 = conj(IT_0147) + conj(IT_0178);
    const ccomplex_t IT_0268 = IT_0147 + IT_0178;
    const ccomplex_t IT_0269 = -IT_0206;
    const ccomplex_t IT_0270 = IT_0145 + IT_0176;
    const ccomplex_t IT_0271 = -IT_0199;
    const ccomplex_t IT_0272 = (-18)*IT_0202;
    const ccomplex_t IT_0273 = IT_0184 + IT_0185 + IT_0272;
    const ccomplex_t IT_0274 = m_u*s_13;
    const ccomplex_t IT_0275 = 6*conj(IT_0059);
    const ccomplex_t IT_0276 = 18*conj(IT_0236);
    const ccomplex_t IT_0277 = 6*conj(IT_0236);
    const ccomplex_t IT_0278 = 18*conj(IT_0059);
    const ccomplex_t IT_0279 = 18*conj(IT_0223);
    const ccomplex_t IT_0280 = 6*conj(IT_0223);
    const ccomplex_t IT_0281 = 18*conj(IT_0061);
    const ccomplex_t IT_0282 = IT_0059*(conj(IT_0145) + 3*conj(IT_0147)) + 1
      *conj(IT_0176)*(IT_0061 + 3*IT_0223) + 3*conj(IT_0178)*(IT_0061 + 1./3
      *IT_0223) + 0.166666666666667*(18*conj(IT_0145) + 6*conj(IT_0147))*IT_0236
       + 0.166666666666667*IT_0145*(IT_0275 + IT_0276) + 0.166666666666667
      *IT_0147*(IT_0277 + IT_0278) + IT_0176*(conj(IT_0061) + 0.166666666666667
      *IT_0279) + 0.166666666666667*IT_0178*(IT_0280 + IT_0281);
    const ccomplex_t IT_0283 = -s_14;
    const ccomplex_t IT_0284 = s_13 + IT_0283;
    const ccomplex_t IT_0285 = m_u*IT_0284;
    const ccomplex_t IT_0286 = 18*IT_0028;
    const ccomplex_t IT_0287 = 18*conj(IT_0028);
    const ccomplex_t IT_0288 = IT_0259*IT_0266 + IT_0260*IT_0270 + IT_0206*((
      -12)*IT_0028 + 12*conj(IT_0028) + (-6)*IT_0061 + 6*conj(IT_0061) + IT_0237
       + IT_0238 + IT_0262 + IT_0275 + IT_0276 + IT_0279) + IT_0199*((-36)
      *IT_0028 + 36*conj(IT_0028) + (-18)*IT_0061 + IT_0243 + IT_0244 + IT_0263 
      + IT_0277 + IT_0278 + IT_0280 + IT_0281) + IT_0267*IT_0286 + IT_0268
      *IT_0287;
    const ccomplex_t IT_0289 = (36*s_34 + (-36)*IT_0001)*IT_0028*conj(IT_0028)
       + (conj(IT_0028)*(IT_0059 + IT_0061) + IT_0028*(conj(IT_0059) + conj
      (IT_0061)))*IT_0064 + (conj(IT_0145)*IT_0147 + IT_0145*conj(IT_0147) +
       conj(IT_0176)*IT_0178 + IT_0176*conj(IT_0178))*IT_0183 + (IT_0145*conj
      (IT_0145) + IT_0147*conj(IT_0147) + IT_0176*conj(IT_0176) + IT_0178*conj
      (IT_0178))*IT_0186 + -IT_0200*IT_0205 + (-2)*IT_0206*(IT_0199*((-12)
      *IT_0179 + 24*IT_0181 + (-12)*IT_0202) + 0.5*IT_0205*IT_0206) + IT_0063*
      (IT_0059*conj(IT_0059) + IT_0061*conj(IT_0061) + IT_0223*conj(IT_0223) +
       IT_0236*conj(IT_0236)) + IT_0001*(conj(IT_0223)*IT_0239 + IT_0223*IT_0242
       + conj(IT_0061)*IT_0245 + IT_0061*IT_0248) + IT_0202*(((-18)*conj(IT_0145
      ) + (-6)*conj(IT_0147))*IT_0176 + conj(IT_0176)*IT_0249 + conj(IT_0178)
      *IT_0252 + IT_0178*IT_0255) + (conj(IT_0061)*IT_0223 + IT_0061*conj
      (IT_0223) + conj(IT_0059)*IT_0236 + IT_0059*conj(IT_0236))*IT_0256 +
       IT_0258*((conj(IT_0223) + conj(IT_0236))*IT_0259 + (IT_0223 + IT_0236)
      *IT_0260) + IT_0261*(conj(IT_0176)*IT_0239 + IT_0176*IT_0242 + conj
      (IT_0178)*IT_0245 + IT_0178*IT_0248 + conj(IT_0223)*IT_0249 + conj(IT_0061
      )*IT_0252 + IT_0061*IT_0255 + conj(IT_0145)*IT_0262 + conj(IT_0147)
      *IT_0263) + IT_0265*(IT_0199*IT_0266 + IT_0206*IT_0267 + IT_0268*IT_0269 +
       IT_0270*IT_0271) + (IT_0206*IT_0266 + IT_0199*IT_0267 + IT_0269*IT_0270 +
       IT_0268*IT_0271)*IT_0273 + 6*IT_0274*IT_0282 + IT_0285*IT_0288;
