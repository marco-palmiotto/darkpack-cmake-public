...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_L_to_h_h(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0001
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0022 + IT_0023 + -m_su_R*
      (m_su_R + (0 + _Complex_I*-1)*Gamma_ur) + reg_prop, -1);
