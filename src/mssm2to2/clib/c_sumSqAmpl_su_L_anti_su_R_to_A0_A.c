...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_R_to_A0_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = m_u*e_em*mu_h*IT_0002*IT_0004;
    const ccomplex_t IT_0006 = 0.5*IT_0005;
    const ccomplex_t IT_0007 = pow(m_A0, 2);
    const ccomplex_t IT_0008 = pow(m_su_R, 2);
    const ccomplex_t IT_0009 = cpow((-2)*s_23 + IT_0007 + IT_0008 + -m_su_L*
    ...
    const ccomplex_t IT_0013 = cpow((-2)*s_13 + IT_0007 + IT_0012 + -m_su_R*
    ...
    const ccomplex_t IT_0020 = (-3)*s_23;
    ...
    const ccomplex_t IT_0024 = (-3)*s_24;
    const ccomplex_t IT_0025 = (-3)*s_34;
    const ccomplex_t IT_0026 = (-3)*IT_0017*(IT_0008*conj(IT_0017) + (
      -0.333333333333333)*conj(IT_0019)*IT_0020 + (-0.333333333333333)*conj
      (IT_0023)*IT_0024) + IT_0023*(conj(IT_0017)*IT_0024 + conj(IT_0019)
      *IT_0025) + (-3)*IT_0019*(IT_0007*conj(IT_0019) + (-0.333333333333333)
      *conj(IT_0017)*IT_0020 + (-0.333333333333333)*conj(IT_0023)*IT_0025);
