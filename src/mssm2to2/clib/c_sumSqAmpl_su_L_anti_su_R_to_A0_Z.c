...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_R_to_A0_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0002
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0005
      *IT_0007*IT_0009*IT_0010;
    ...
    const ccomplex_t IT_0033 = m_u*e_em*mu_h*IT_0007*IT_0009;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = pow(m_A0, 2);
    const ccomplex_t IT_0036 = cpow((-2)*s_23 + IT_0014 + IT_0035 + -m_su_L*
    ...
    const ccomplex_t IT_0046 = cpow((-2)*s_13 + IT_0013 + IT_0035 + -m_su_R*
    ...
    const ccomplex_t IT_0054 = (-3)*conj(IT_0027);
    const ccomplex_t IT_0055 = pow(s_34, 2);
    const ccomplex_t IT_0056 = IT_0028*IT_0055;
    const ccomplex_t IT_0057 = s_24*s_34*IT_0028;
    ...
    const ccomplex_t IT_0062 = (-3)*IT_0050;
    const ccomplex_t IT_0063 = (-3)*IT_0027*(conj(IT_0027)*(IT_0013 + -IT_0030
      ) + conj(IT_0040)*IT_0043 + conj(IT_0050)*IT_0053) + IT_0050*IT_0053
      *IT_0054 + (-3)*IT_0040*((-0.333333333333333)*IT_0043*IT_0054 + conj
      (IT_0040)*(IT_0035 + -IT_0056) + conj(IT_0050)*IT_0059) + (conj(IT_0040)
      *IT_0059 + conj(IT_0050)*(IT_0014 + -IT_0061))*IT_0062;
