...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_R_to_Z_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0008
    ...
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0001
      *IT_0014*IT_0022*IT_0023;
