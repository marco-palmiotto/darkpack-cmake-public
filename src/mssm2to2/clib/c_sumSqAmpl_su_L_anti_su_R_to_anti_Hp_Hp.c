        ...
        )
{
    ...
    const ccomplex_t IT_0012 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0003*IT_0008*IT_0011*(mu_h*U_sb_01 + m_b*IT_0005*IT_0006*U_sb_11)
      *V_ub_mod;
    const ccomplex_t IT_0013 = 0.5*IT_0012;
    const ccomplex_t IT_0014 = IT_0010*IT_0013;
    const ccomplex_t IT_0015 = pow(m_Hp, 2);
    const ccomplex_t IT_0016 = pow(m_su_R, 2);
    const ccomplex_t IT_0017 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sb_2*
    ...
    const ccomplex_t IT_0021 = cpow((-2)*s_12 + m_h*(m_h + (0 + _Complex_I*-1)
      *Gamma_h) + -IT_0016 + -IT_0020 + -reg_prop, -1);
    const ccomplex_t IT_0022 = sin(alpha);
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0003
      *IT_0005*IT_0008*IT_0022;
    ...
    const ccomplex_t IT_0030 = cpow(IT_0002, 3);
    const ccomplex_t IT_0031 = 3*IT_0008 + IT_0027;
    const ccomplex_t IT_0032 = cpow(IT_0002, 2);
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_W*e_em*(IT_0028*IT_0029
      *IT_0030 + -IT_0001*(IT_0001*(IT_0001*IT_0022*IT_0028 + IT_0002*IT_0029
      *IT_0031) + -IT_0022*IT_0031*IT_0032));
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = IT_0024*IT_0034;
    const ccomplex_t IT_0036 = IT_0021*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0003
      *IT_0005*IT_0008*IT_0029;
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = -IT_0008;
    const ccomplex_t IT_0041 = IT_0027 + IT_0040;
    const ccomplex_t IT_0042 = -IT_0001;
    const ccomplex_t IT_0043 = (0 + _Complex_I*1)*m_W*e_em*(IT_0022*IT_0030
      *IT_0041 + IT_0042*(IT_0029*IT_0031*IT_0032 + -(IT_0002*IT_0022*IT_0031 + 
      -IT_0001*IT_0029*IT_0041)*IT_0042));
    const ccomplex_t IT_0044 = 0.5*IT_0043;
    const ccomplex_t IT_0045 = IT_0039*IT_0044;
    const ccomplex_t IT_0046 = cpow((-2)*s_12 + -IT_0016 + -IT_0020 + m_H0*
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0003*IT_0005*IT_0006*IT_0008;
    const ccomplex_t IT_0052 = 0.5*IT_0051;
    const ccomplex_t IT_0053 = IT_0050*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0053*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *mu_h*IT_0003*IT_0008;
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = (0 + _Complex_I*1.4142135623731)*m_s*m_u*V_us
      *e_em*IT_0003*IT_0005*IT_0006*IT_0008;
    const ccomplex_t IT_0060 = 0.5*IT_0059;
    const ccomplex_t IT_0061 = IT_0058*IT_0060;
    const ccomplex_t IT_0062 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0063 = IT_0061*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*IT_0063;
    const ccomplex_t IT_0065 = pow(m_d, 2);
    const ccomplex_t IT_0066 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0008*(IT_0001*(m_W*IT_0002 + (-0.5)*IT_0003*IT_0004*IT_0005) + -1./2
      *IT_0002*IT_0003*IT_0006*IT_0065);
    const ccomplex_t IT_0067 = 0.5*IT_0066;
    const ccomplex_t IT_0068 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0003*IT_0008;
    const ccomplex_t IT_0069 = 0.5*IT_0068;
    const ccomplex_t IT_0070 = IT_0067*IT_0069;
    const ccomplex_t IT_0071 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0072 = IT_0070*IT_0071;
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*IT_0072;
    const ccomplex_t IT_0074 = pow(m_s, 2);
    const ccomplex_t IT_0075 = (0 + _Complex_I*(-2.82842712474619))*V_us*e_em
      *IT_0008*(IT_0001*(m_W*IT_0002 + (-0.5)*IT_0003*IT_0004*IT_0005) + -1./2
      *IT_0002*IT_0003*IT_0006*IT_0074);
    const ccomplex_t IT_0076 = 0.5*IT_0075;
    const ccomplex_t IT_0077 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *mu_h*IT_0003*IT_0008;
    const ccomplex_t IT_0078 = 0.5*IT_0077;
    const ccomplex_t IT_0079 = IT_0076*IT_0078;
    const ccomplex_t IT_0080 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0081 = IT_0079*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*IT_0081;
    const ccomplex_t IT_0083 = cpow((-2)*s_23 + IT_0015 + IT_0016 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0084 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0003*IT_0008*IT_0011*(mu_h*U_sb_00 + m_b*IT_0005*IT_0006*U_sb_10)
      *V_ub_mod;
    const ccomplex_t IT_0085 = 0.5*IT_0084;
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*e_em*IT_0000
    ...
    const ccomplex_t IT_0091 = IT_0019 + -IT_0037 + -IT_0048 + IT_0056 +
       IT_0064 + IT_0073 + IT_0082 + IT_0090;
