        ...
        )
{
    ...
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0002;
    ...
    const ccomplex_t IT_0035 = cpow((-2)*s_23 + IT_0013 + IT_0027 + -m_C_2*
      (m_C_2 + (0 + _Complex_I*-1)*Gamma_c2) + reg_prop, -1);
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0002;
    ...
    const ccomplex_t IT_0050 = m_d*IT_0034;
    const ccomplex_t IT_0051 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0052 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0000*IT_0002*IT_0017;
    const ccomplex_t IT_0053 = 0.5*IT_0052;
    const ccomplex_t IT_0054 = IT_0038*IT_0053;
    const ccomplex_t IT_0055 = IT_0035*IT_0051*IT_0054;
    const ccomplex_t IT_0056 = m_d*IT_0041;
    ...
    const ccomplex_t IT_0065 = cpow((-2)*s_12 + -IT_0012 + -IT_0013 + m_H0*
