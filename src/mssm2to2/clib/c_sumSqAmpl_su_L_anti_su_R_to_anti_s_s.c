...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_R_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = m_u*e_em*mu_h*IT_0000*IT_0002*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0020 = m_u*e_em*mu_h*IT_0000*IT_0002;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_us
      *e_em*IT_0000*IT_0002*IT_0007;
    const ccomplex_t IT_0029 = 0.5*IT_0028;
    const ccomplex_t IT_0030 = (0 + _Complex_I*1)*V_us*e_em*conj(V_Wp1)*IT_0002;
    ...
    const ccomplex_t IT_0035 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_us
      *e_em*IT_0000*IT_0002*IT_0007;
    const ccomplex_t IT_0036 = 0.5*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*V_us*e_em*conj(V_Wp2)*IT_0002;
    ...
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_s*U_d1*V_us
    ...
    const ccomplex_t IT_0049 = IT_0032*IT_0047*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*m_s*U_d2*V_us
      *e_em*IT_0000*IT_0002*IT_0017;
