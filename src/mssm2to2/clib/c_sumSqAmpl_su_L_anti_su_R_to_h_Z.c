...
ccomplex_return_t c_sumSqAmpl_su_L_anti_su_R_to_h_Z(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = m_u*e_em*mu_h*IT_0004*IT_0007*IT_0010*IT_0011;
    ...
    const ccomplex_t IT_0023 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0005
      *IT_0007*IT_0010*IT_0011;
    const ccomplex_t IT_0024 = (-0.5)*IT_0023;
    const ccomplex_t IT_0025 = pow(m_h, 2);
    const ccomplex_t IT_0026 = cpow((-2)*s_23 + IT_0016 + IT_0025 + -m_su_L*
    ...
    const ccomplex_t IT_0032 = m_u*e_em*mu_h*IT_0007*IT_0010;
    ...
    const ccomplex_t IT_0043 = 1.33333333333333*IT_0042;
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0015 + IT_0025 + -m_su_R*
    ...
    return create_ccomplex_return((-3)*IT_0038*(conj(IT_0038)*(IT_0025 + 
      -IT_0041) + conj(IT_0048)*IT_0051) + (-3)*IT_0048*(conj(IT_0038)*IT_0051 +
       conj(IT_0048)*(IT_0016 + -IT_0053)));
}
