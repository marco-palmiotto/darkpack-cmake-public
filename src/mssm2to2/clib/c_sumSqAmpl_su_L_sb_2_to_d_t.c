        ...
        )
{
    ...
    const ccomplex_t IT_0055 = m_d*IT_0042;
    const ccomplex_t IT_0056 = m_d*IT_0048;
    ...
    const ccomplex_t IT_0069 = m_d*IT_0034;
    const ccomplex_t IT_0070 = 18*s_34;
    const ccomplex_t IT_0071 = (-18)*s_34;
    const ccomplex_t IT_0072 = m_d*m_t;
    const ccomplex_t IT_0073 = (-18)*IT_0066;
    const ccomplex_t IT_0074 = 18*IT_0069;
    const ccomplex_t IT_0075 = IT_0073 + IT_0074;
    const ccomplex_t IT_0076 = (-18)*conj(IT_0066);
    const ccomplex_t IT_0077 = 18*conj(IT_0069);
    const ccomplex_t IT_0078 = IT_0076 + IT_0077;
    const ccomplex_t IT_0079 = (-18)*IT_0060;
    const ccomplex_t IT_0080 = (-18)*conj(IT_0060);
    const ccomplex_t IT_0081 = m_d*m_t*IT_0001;
    const ccomplex_t IT_0082 = (-18)*IT_0034;
    const ccomplex_t IT_0083 = (-18)*conj(IT_0034);
    const ccomplex_t IT_0084 = m_t*s_13;
    const ccomplex_t IT_0085 = m_d*s_14;
    const ccomplex_t IT_0086 = (IT_0034*conj(IT_0034) + IT_0049*conj(IT_0049))
      ...
      *IT_0071 + IT_0072*(18*conj(IT_0060)*IT_0066 + 18*IT_0060*conj(IT_0066) +
       conj(IT_0068)*IT_0075 + IT_0068*IT_0078 + conj(IT_0069)*IT_0079 + IT_0069
      *IT_0080) + IT_0081*(conj(IT_0049)*IT_0082 + IT_0049*IT_0083) + (18*conj
      (IT_0034)*IT_0060 + 18*IT_0034*conj(IT_0060) + conj(IT_0049)*IT_0075 +
       IT_0049*IT_0078 + conj(IT_0068)*IT_0082 + IT_0068*IT_0083)*IT_0084 + (18
      *conj(IT_0034)*IT_0066 + 18*IT_0034*conj(IT_0066) + conj(IT_0049)*(18
      *IT_0068 + IT_0079) + IT_0049*(18*conj(IT_0068) + IT_0080) + conj(IT_0069)
      *IT_0082 + IT_0069*IT_0083)*IT_0085;
