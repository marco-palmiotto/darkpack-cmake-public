        ...
        )
{
    ...
    const ccomplex_t IT_0003 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp1)*IT_0001;
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*V_cs*e_em*conj(U_Wm2)*IT_0001;
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*V_ud*e_em*conj(V_Wp2)*IT_0001;
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_d*U_d1*V_ud
    ...
    const ccomplex_t IT_0025 = (0 + _Complex_I*1.4142135623731)*m_d*U_d2*V_ud
      *e_em*IT_0001*IT_0016*IT_0018;
    const ccomplex_t IT_0026 = 0.5*IT_0025;
    const ccomplex_t IT_0027 = IT_0010*IT_0026;
    const ccomplex_t IT_0028 = IT_0014*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*IT_0028;
    const ccomplex_t IT_0030 = m_d*IT_0029;
    ...
    const ccomplex_t IT_0045 = m_c*s_14;
    const ccomplex_t IT_0046 = 18*s_34;
    const ccomplex_t IT_0047 = m_c*m_d;
    const ccomplex_t IT_0048 = IT_0020*IT_0035;
    const ccomplex_t IT_0049 = IT_0005*IT_0008*IT_0048;
    const ccomplex_t IT_0050 = IT_0026*IT_0040;
    const ccomplex_t IT_0051 = IT_0013*IT_0014*IT_0050;
    const ccomplex_t IT_0052 = m_d*IT_0038;
    const ccomplex_t IT_0053 = m_d*IT_0043;
    const ccomplex_t IT_0054 = IT_0049 + IT_0051 + -IT_0052 + -IT_0053;
    const ccomplex_t IT_0055 = (-18)*conj(IT_0054);
    const ccomplex_t IT_0056 = m_d*s_13;
    const ccomplex_t IT_0057 = -IT_0023 + -IT_0029;
    ...
    const ccomplex_t IT_0065 = m_c*m_d*IT_0059;
    const ccomplex_t IT_0066 = (-18)*conj(IT_0044);
    const ccomplex_t IT_0067 = IT_0031*(18*conj(IT_0044)*IT_0045 + conj
      (IT_0031)*IT_0046 + IT_0047*IT_0055 + IT_0056*IT_0058) + IT_0044*(18*conj
      (IT_0031)*IT_0045 + IT_0055*IT_0056 + conj(IT_0044)*IT_0064 + IT_0058
      *IT_0065) + IT_0054*((-18)*conj(IT_0031)*IT_0047 + IT_0046*conj(IT_0054) +
       18*IT_0045*conj(IT_0057) + IT_0056*IT_0066) + IT_0057*(18*IT_0045*conj
