        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_23 + IT_0001 + IT_0002 + -m_C_2*
    ...
    const ccomplex_t IT_0035 = -IT_0026 + -IT_0031;
    const ccomplex_t IT_0036 = m_d*s_13;
    ...
    const ccomplex_t IT_0041 = s_34*(18*IT_0021*conj(IT_0021) + 18*IT_0034
      *conj(IT_0034)) + ((18*conj(IT_0021) + (-18)*conj(IT_0034))*IT_0035 + (18
      *IT_0021 + (-18)*IT_0034)*conj(IT_0035))*IT_0036 + IT_0035*conj(IT_0035)*
      (36*IT_0037 + (-18)*IT_0039) + (conj(IT_0021)*IT_0034 + IT_0021*conj
      (IT_0034))*IT_0040;
