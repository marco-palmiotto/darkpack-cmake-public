        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_u*N_u4*e_em
      *IT_0003*IT_0005*IT_0007;
    const ccomplex_t IT_0009 = (-0.5)*IT_0008;
    const ccomplex_t IT_0010 = conj(N_W4)*e_em*U_st_01;
    ...
    const ccomplex_t IT_0014 = m_t*conj(N_u4)*e_em*IT_0003*U_st_11;
    ...
    const ccomplex_t IT_0019 = conj(N_B4)*e_em*U_st_01;
    ...
    const ccomplex_t IT_0028 = (0 + _Complex_I*1.4142135623731)*m_u*N_u2*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0036 = m_t*conj(N_u2)*e_em*IT_0003*U_st_11;
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
    ...
    const ccomplex_t IT_0048 = m_t*conj(N_u3)*e_em*IT_0003*U_st_11;
    const ccomplex_t IT_0049 = IT_0013*IT_0048;
    const ccomplex_t IT_0050 = 1.4142135623731*IT_0049;
    const ccomplex_t IT_0051 = conj(N_W3)*e_em*U_st_01;
    ...
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_u*N_u1*e_em
      *IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0071 = m_t*conj(N_u1)*e_em*IT_0003*U_st_11;
    ...
    const ccomplex_t IT_0077 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_1*
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_11;
    const ccomplex_t IT_0083 = IT_0081*IT_0082;
    const ccomplex_t IT_0084 = pow(m_sG, 2);
    const ccomplex_t IT_0085 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -IT_0084 +
       reg_prop, -1);
    ...
    const ccomplex_t IT_0100 = m_t*N_u2*e_em*IT_0003*U_st_01;
    ...
    const ccomplex_t IT_0108 = N_B3*e_em*U_st_11;
    const ccomplex_t IT_0109 = IT_0018*IT_0108;
    const ccomplex_t IT_0110 = 1.4142135623731*IT_0109;
    const ccomplex_t IT_0111 = m_t*N_u3*e_em*IT_0003*U_st_01;
    ...
    const ccomplex_t IT_0135 = m_t*N_u4*e_em*IT_0003*U_st_01;
    const ccomplex_t IT_0136 = IT_0013*IT_0135;
    const ccomplex_t IT_0137 = 1.4142135623731*IT_0136;
    const ccomplex_t IT_0138 = N_B4*e_em*U_st_11;
    const ccomplex_t IT_0139 = IT_0018*IT_0138;
    const ccomplex_t IT_0140 = 1.4142135623731*IT_0139;
    const ccomplex_t IT_0141 = (0 + _Complex_I*1)*(IT_0137 + (
      -1.33333333333333)*IT_0140);
    const ccomplex_t IT_0142 = (-0.75)*IT_0141;
    const ccomplex_t IT_0143 = (-1.33333333333333)*IT_0142;
    const ccomplex_t IT_0144 = (-0.75)*IT_0143;
    ...
    const ccomplex_t IT_0160 = m_t*N_u1*e_em*IT_0003*U_st_01;
    ...
    const ccomplex_t IT_0168 = 0.166666666666667*IT_0087 + -IT_0107 + -IT_0126
       + -IT_0148 + -IT_0167;
    const ccomplex_t IT_0169 = m_t*m_u*IT_0001;
    const ccomplex_t IT_0170 = s_34*IT_0001;
    const ccomplex_t IT_0171 = (-18)*IT_0170;
    const ccomplex_t IT_0172 = s_13*s_14;
    const ccomplex_t IT_0173 = 36*IT_0172;
    const ccomplex_t IT_0174 = IT_0171 + IT_0173;
    const ccomplex_t IT_0175 = m_t*s_13;
    const ccomplex_t IT_0176 = (0 + _Complex_I*1.4142135623731)*g_s*U_st_01;
    const ccomplex_t IT_0177 = IT_0081*IT_0176;
    const ccomplex_t IT_0178 = IT_0085*IT_0177;
    const ccomplex_t IT_0179 = (0 + _Complex_I*1)*IT_0178;
    const ccomplex_t IT_0180 = m_sG*IT_0179;
    const ccomplex_t IT_0181 = (-0.5)*IT_0180;
    const ccomplex_t IT_0182 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0183 = IT_0059*IT_0123;
    const ccomplex_t IT_0184 = IT_0045*IT_0182*IT_0183;
    const ccomplex_t IT_0185 = m_u*IT_0062;
    const ccomplex_t IT_0186 = m_u*IT_0027;
    const ccomplex_t IT_0187 = m_u*IT_0079;
    const ccomplex_t IT_0188 = m_u*IT_0044;
    const ccomplex_t IT_0189 = IT_0184 + -IT_0185 + -IT_0186 + -IT_0187 + 
      -IT_0188;
    const ccomplex_t IT_0190 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0191 = IT_0075*IT_0156;
    const ccomplex_t IT_0192 = IT_0077*IT_0190*IT_0191;
    const ccomplex_t IT_0193 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0194 = IT_0040*IT_0096;
    const ccomplex_t IT_0195 = IT_0042*IT_0193*IT_0194;
    const ccomplex_t IT_0196 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0197 = IT_0024*IT_0134;
    const ccomplex_t IT_0198 = IT_0002*IT_0196*IT_0197;
    const ccomplex_t IT_0199 = 0.166666666666667*IT_0180 + -IT_0192 + -IT_0195
       + -IT_0198;
    const ccomplex_t IT_0200 = IT_0181 + (-3)*IT_0189 + 3*IT_0199;
    const ccomplex_t IT_0201 = 3*conj(IT_0199);
    const ccomplex_t IT_0202 = (-3)*conj(IT_0189);
    const ccomplex_t IT_0203 = conj(IT_0181) + IT_0201 + IT_0202;
    const ccomplex_t IT_0204 = m_u*IT_0087;
    const ccomplex_t IT_0205 = (-0.5)*IT_0204;
    const ccomplex_t IT_0206 = 6*IT_0205;
    const ccomplex_t IT_0207 = IT_0064*IT_0164;
    const ccomplex_t IT_0208 = IT_0077*IT_0190*IT_0207;
    const ccomplex_t IT_0209 = IT_0009*IT_0145;
    const ccomplex_t IT_0210 = IT_0002*IT_0196*IT_0209;
    const ccomplex_t IT_0211 = m_u*IT_0167;
    const ccomplex_t IT_0212 = m_u*IT_0107;
    const ccomplex_t IT_0213 = m_u*IT_0126;
    const ccomplex_t IT_0214 = m_u*IT_0148;
    ...
    const ccomplex_t IT_0217 = IT_0029*IT_0104;
    const ccomplex_t IT_0218 = IT_0042*IT_0193*IT_0217;
    const ccomplex_t IT_0219 = IT_0047*IT_0115;
    const ccomplex_t IT_0220 = IT_0045*IT_0182*IT_0219;
    ...
    const ccomplex_t IT_0228 = conj(IT_0088)*((-18)*IT_0181 + 6*IT_0189 + (-6)
      *IT_0199) + IT_0088*((-18)*conj(IT_0181) + 6*conj(IT_0189) + (-6)*conj
      (IT_0199)) + (-6)*conj(IT_0168)*IT_0200 + (-6)*IT_0168*IT_0203 + conj
      (IT_0080)*IT_0223 + IT_0080*IT_0227;
    const ccomplex_t IT_0229 = m_t*m_u;
    const ccomplex_t IT_0230 = 18*IT_0221;
    const ccomplex_t IT_0231 = (-18)*IT_0215;
    const ccomplex_t IT_0232 = (-6)*IT_0205;
    const ccomplex_t IT_0233 = IT_0230 + IT_0231 + IT_0232;
    const ccomplex_t IT_0234 = 18*conj(IT_0221);
    const ccomplex_t IT_0235 = (-18)*conj(IT_0215);
    const ccomplex_t IT_0236 = (-6)*conj(IT_0205);
    const ccomplex_t IT_0237 = IT_0234 + IT_0235 + IT_0236;
    const ccomplex_t IT_0238 = conj(IT_0181)*(18*IT_0205 + 6*IT_0215 + (-6)
      *IT_0221) + IT_0181*(18*conj(IT_0205) + 6*conj(IT_0215) + (-6)*conj
      (IT_0221)) + conj(IT_0199)*IT_0223 + IT_0199*IT_0227 + conj(IT_0189)
      *IT_0233 + IT_0189*IT_0237;
    const ccomplex_t IT_0239 = m_u*s_14;
    const ccomplex_t IT_0240 = 6*conj(IT_0080)*IT_0200 + 6*IT_0080*IT_0203 +
       conj(IT_0088)*((-18)*IT_0205 + (-6)*IT_0215 + 6*IT_0221) + IT_0088*((-18)
      *conj(IT_0205) + (-6)*conj(IT_0215) + 6*conj(IT_0221)) + conj(IT_0168)
      *IT_0233 + IT_0168*IT_0237;
    const ccomplex_t IT_0241 = 6*s_34;
    const ccomplex_t IT_0242 = 18*s_34;
    const ccomplex_t IT_0243 = (-18)*s_34;
    const ccomplex_t IT_0244 = (-6)*s_34;
    const ccomplex_t IT_0245 = 12*IT_0172;
    const ccomplex_t IT_0246 = (-6)*IT_0170;
    const ccomplex_t IT_0247 = (-6)*(conj(IT_0080)*(IT_0088 + 3*IT_0168) +
       IT_0080*(conj(IT_0088) + 3*conj(IT_0168)))*IT_0169 + (IT_0080*conj
      (IT_0080) + IT_0088*conj(IT_0088) + IT_0168*conj(IT_0168))*IT_0174 +
       IT_0175*IT_0228 + IT_0229*IT_0238 + IT_0239*IT_0240 + (conj(IT_0181)
      *IT_0199 + IT_0181*conj(IT_0199) + conj(IT_0205)*IT_0215 + IT_0205*conj
      (IT_0215))*IT_0241 + (IT_0181*conj(IT_0181) + IT_0189*conj(IT_0189) +
       IT_0199*conj(IT_0199) + IT_0205*conj(IT_0205) + IT_0215*conj(IT_0215) +
       IT_0221*conj(IT_0221))*IT_0242 + (conj(IT_0189)*IT_0199 + IT_0189*conj
      (IT_0199) + conj(IT_0215)*IT_0221 + IT_0215*conj(IT_0221))*IT_0243 + (conj
      (IT_0181)*IT_0189 + IT_0181*conj(IT_0189) + conj(IT_0205)*IT_0221 +
       IT_0205*conj(IT_0221))*IT_0244 + (conj(IT_0088)*IT_0168 + IT_0088*conj
      (IT_0168))*(IT_0245 + IT_0246);
