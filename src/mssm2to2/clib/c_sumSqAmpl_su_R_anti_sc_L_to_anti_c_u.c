        ...
        )
{
    ...
    const ccomplex_t IT_0078 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0098 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u2)
      *e_em*IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0103 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u3)
      *e_em*IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0108 = (0 + _Complex_I*1.4142135623731)*m_c*conj(N_u4)
      *e_em*IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0127 = m_u*IT_0102;
    const ccomplex_t IT_0128 = m_u*IT_0107;
    const ccomplex_t IT_0129 = m_u*IT_0112;
    ...
    const ccomplex_t IT_0138 = m_u*IT_0117;
    ...
    const ccomplex_t IT_0149 = (-18)*s_34*IT_0008*(IT_0008 + 1./3*IT_0096 + 
      -1./3*conj(IT_0096)) + conj(IT_0097)*((-18)*IT_0118*IT_0120 + IT_0097
      *IT_0125) + conj(IT_0118)*((-18)*IT_0097*IT_0120 + IT_0118*IT_0125) +
       IT_0126*(IT_0139*IT_0142 + conj(IT_0139)*IT_0145) + ((-18)*conj(IT_0097)
      *IT_0139 + (-18)*IT_0097*conj(IT_0139) + IT_0118*IT_0142 + conj(IT_0118)
      *IT_0145)*IT_0146 + (IT_0096*conj(IT_0096) + IT_0139*conj(IT_0139))
      *IT_0147 + (18*conj(IT_0118)*IT_0139 + 18*IT_0118*conj(IT_0139) + conj
      (IT_0097)*(18*IT_0096 + IT_0140) + IT_0097*(18*conj(IT_0096) + IT_0144))
      *IT_0148;
