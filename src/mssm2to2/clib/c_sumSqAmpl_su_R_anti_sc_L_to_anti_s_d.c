...
ccomplex_return_t c_sumSqAmpl_su_R_anti_sc_L_to_anti_s_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1)*V_cs*e_em*V_Wp2*IT_0004;
    ...
    const ccomplex_t IT_0029 = (0 + _Complex_I*1.4142135623731)*m_s*conj(U_d1)
      *V_cs*e_em*IT_0000*IT_0004*IT_0028;
    const ccomplex_t IT_0030 = (-0.5)*IT_0029;
    const ccomplex_t IT_0031 = IT_0006*IT_0030;
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*m_C_1;
    const ccomplex_t IT_0033 = IT_0012*IT_0031*IT_0032;
    ...
    const ccomplex_t IT_0038 = IT_0020*IT_0036*IT_0037;
    const ccomplex_t IT_0039 = IT_0033 + IT_0038;
    const ccomplex_t IT_0040 = m_s*s_14;
    const ccomplex_t IT_0041 = s_13*s_14;
    const ccomplex_t IT_0042 = pow(m_su_R, 2);
    const ccomplex_t IT_0043 = s_34*IT_0042;
    const ccomplex_t IT_0044 = m_d*m_s;
    const ccomplex_t IT_0045 = 18*s_34;
    const ccomplex_t IT_0046 = conj(IT_0023)*(18*IT_0025*IT_0026 + (-18)
      *IT_0039*IT_0040 + IT_0023*(36*IT_0041 + (-18)*IT_0043)) + conj(IT_0025)*
      (18*IT_0023*IT_0026 + (-18)*IT_0039*IT_0044 + IT_0025*IT_0045) + conj
      (IT_0039)*((-18)*IT_0023*IT_0040 + (-18)*IT_0025*IT_0044 + IT_0039*IT_0045);
