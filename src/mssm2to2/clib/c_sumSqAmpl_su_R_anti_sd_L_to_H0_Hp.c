...
ccomplex_return_t c_sumSqAmpl_su_R_anti_sd_L_to_H0_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0029 = -IT_0006;
    ...
    const ccomplex_t IT_0034 = cpow(IT_0003, 3);
    const ccomplex_t IT_0035 = -IT_0001;
    const ccomplex_t IT_0036 = 3*IT_0006 + IT_0032;
    const ccomplex_t IT_0037 = cpow(IT_0003, 2);
    const ccomplex_t IT_0038 = (0 + _Complex_I*1)*m_W*e_em*(IT_0010*IT_0033
      *IT_0034 + IT_0035*(IT_0035*(IT_0001*IT_0009*IT_0033 + -IT_0003*IT_0010
      *IT_0036) + IT_0009*IT_0036*IT_0037));
    const ccomplex_t IT_0039 = 0.5*IT_0038;
    const ccomplex_t IT_0040 = IT_0028*IT_0039;
    const ccomplex_t IT_0041 = pow(m_su_R, 2);
    const ccomplex_t IT_0042 = cpow((-2)*s_12 + -IT_0015 + -IT_0041 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0040*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
      *IT_0004*IT_0006*IT_0009;
    const ccomplex_t IT_0046 = 0.5*IT_0045;
    const ccomplex_t IT_0047 = pow(m_d, 2);
    const ccomplex_t IT_0048 = pow(m_u, 2);
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0006*(IT_0000*IT_0002*IT_0003*IT_0047 + (-2)*IT_0001*(m_W*IT_0003 + (
      -0.5)*IT_0000*IT_0004*IT_0048));
    const ccomplex_t IT_0050 = 0.5*IT_0049;
    const ccomplex_t IT_0051 = IT_0046*IT_0050;
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0014 + IT_0041 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = (0 + _Complex_I*1)*e_em*(m_W*IT_0005*(IT_0001
      *IT_0009 + -IT_0003*IT_0010)*IT_0031 + 1.5*IT_0000*IT_0004*IT_0006*IT_0010
      *IT_0048);
    const ccomplex_t IT_0056 = (-0.666666666666667)*IT_0055;
    const ccomplex_t IT_0057 = IT_0028*IT_0056;
    const ccomplex_t IT_0058 = cpow((-2)*s_13 + IT_0014 + (0 + _Complex_I*1)
      *m_su_R*Gamma_ur + reg_prop, -1);
    const ccomplex_t IT_0059 = IT_0057*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*IT_0059;
    const ccomplex_t IT_0061 = cpow(IT_0001, 2);
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*m_W*e_em*(IT_0006*IT_0009
      *IT_0034 + (-2)*IT_0001*(IT_0003*(IT_0001*IT_0009 + -IT_0003*IT_0010)*(0.5
      *IT_0006 + IT_0005*IT_0031) + 1./2*IT_0006*IT_0010*IT_0061));
    const ccomplex_t IT_0063 = (-0.5)*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0000*IT_0001*IT_0004*IT_0006;
    const ccomplex_t IT_0065 = (-0.5)*IT_0064;
    const ccomplex_t IT_0066 = IT_0063*IT_0065;
    const ccomplex_t IT_0067 = pow(m_W, 2);
    const ccomplex_t IT_0068 = cpow((-2)*s_12 + -IT_0015 + -IT_0041 + IT_0067 
      + -reg_prop, -1);
    const ccomplex_t IT_0069 = IT_0066*IT_0068;
    const ccomplex_t IT_0070 = (0 + _Complex_I*1)*IT_0069;
    const ccomplex_t IT_0071 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0001
      *IT_0009 + -IT_0003*IT_0010)*(IT_0006 + 1./3*IT_0005*IT_0031) + IT_0000
      *IT_0002*IT_0006*IT_0009*IT_0047);
    const ccomplex_t IT_0072 = -IT_0071;
    const ccomplex_t IT_0073 = IT_0028*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_23 + IT_0014 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    const ccomplex_t IT_0075 = IT_0073*IT_0074;
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*IT_0075;
    const ccomplex_t IT_0077 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0078 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0079 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0000*IT_0006*IT_0078*(mu_h*conj(U_sb_00) + m_b*IT_0002*IT_0004*conj
      (U_sb_10))*V_ub_mod;
    ...
    const ccomplex_t IT_0086 = cpow((-2)*s_23 + IT_0014 + IT_0015 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0000*IT_0006*IT_0078*(mu_h*conj(U_sb_01) + m_b*IT_0002*IT_0004*conj
      (U_sb_11))*V_ub_mod;
    ...
    const ccomplex_t IT_0094 = IT_0018 + IT_0026 + -IT_0044 + IT_0054 +
       IT_0060 + -IT_0070 + IT_0076 + IT_0085 + IT_0093;
    return create_ccomplex_return(3*IT_0094*conj(IT_0094));
}
