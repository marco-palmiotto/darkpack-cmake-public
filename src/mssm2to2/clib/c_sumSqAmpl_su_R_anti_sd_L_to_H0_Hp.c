        ...
        )
{
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1)*e_em*(m_W*IT_0005*(IT_0001
      *IT_0009 + -IT_0003*IT_0010)*IT_0030 + 1.5*IT_0000*IT_0004*IT_0006*IT_0010
      *IT_0031);
    const ccomplex_t IT_0033 = (-0.666666666666667)*IT_0032;
    const ccomplex_t IT_0034 = IT_0028*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0014 + (0 + _Complex_I*1)
      *m_su_R*Gamma_ur + reg_prop, -1);
    const ccomplex_t IT_0036 = IT_0034*IT_0035;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*IT_0036;
    const ccomplex_t IT_0038 = pow(m_d, 2);
    const ccomplex_t IT_0039 = (0 + _Complex_I*1)*e_em*((-0.5)*m_W*(IT_0001
      *IT_0009 + -IT_0003*IT_0010)*(IT_0006 + 1./3*IT_0005*IT_0030) + IT_0000
      *IT_0002*IT_0006*IT_0009*IT_0038);
    const ccomplex_t IT_0040 = -IT_0039;
    const ccomplex_t IT_0041 = IT_0028*IT_0040;
    const ccomplex_t IT_0042 = cpow((-2)*s_23 + IT_0014 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_W*e_em*(IT_0006*IT_0009
      *IT_0045 + (-2)*IT_0001*(IT_0003*(IT_0001*IT_0009 + -IT_0003*IT_0010)*(0.5
      *IT_0006 + IT_0005*IT_0030) + 1./2*IT_0006*IT_0010*IT_0046));
    const ccomplex_t IT_0048 = (-0.5)*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0000*IT_0001*IT_0004*IT_0006;
    const ccomplex_t IT_0050 = (-0.5)*IT_0049;
    const ccomplex_t IT_0051 = IT_0048*IT_0050;
    const ccomplex_t IT_0052 = pow(m_W, 2);
    const ccomplex_t IT_0053 = pow(m_su_R, 2);
    const ccomplex_t IT_0054 = cpow((-2)*s_12 + -IT_0015 + IT_0052 + -IT_0053 
      + -reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0051*IT_0054;
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*IT_0055;
    const ccomplex_t IT_0057 = cpow((-2)*s_12 + -IT_0015 + -IT_0053 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0058 = -IT_0006;
    const ccomplex_t IT_0059 = IT_0005*IT_0030;
    const ccomplex_t IT_0060 = IT_0058 + IT_0059;
    const ccomplex_t IT_0061 = -IT_0001;
    const ccomplex_t IT_0062 = 3*IT_0006 + IT_0059;
    const ccomplex_t IT_0063 = cpow(IT_0003, 2);
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*m_W*e_em*(IT_0010*IT_0045
      *IT_0060 + IT_0061*(IT_0061*(IT_0001*IT_0009*IT_0060 + -IT_0003*IT_0010
      *IT_0062) + IT_0009*IT_0062*IT_0063));
    ...
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0071 = (0 + _Complex_I*(-2.82842712474619))*V_ud*e_em
      *IT_0006*(IT_0001*(m_W*IT_0003 + (-0.5)*IT_0000*IT_0004*IT_0031) + -1./2
      *IT_0000*IT_0002*IT_0003*IT_0038);
    const ccomplex_t IT_0072 = 0.5*IT_0071;
    const ccomplex_t IT_0073 = IT_0070*IT_0072;
    const ccomplex_t IT_0074 = cpow((-2)*s_13 + IT_0014 + IT_0053 + -m_su_L*
    ...
    const ccomplex_t IT_0094 = IT_0018 + IT_0026 + IT_0037 + IT_0044 + 
      -IT_0056 + -IT_0068 + IT_0076 + IT_0085 + IT_0093;
