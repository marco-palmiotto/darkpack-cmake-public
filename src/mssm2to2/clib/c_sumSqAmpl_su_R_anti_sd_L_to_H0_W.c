...
ccomplex_return_t c_sumSqAmpl_su_R_anti_sd_L_to_H0_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0019 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0002*IT_0005*IT_0007*IT_0018;
    ...
    const ccomplex_t IT_0033 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
      *IT_0005*IT_0007*IT_0018;
    const ccomplex_t IT_0034 = 0.5*IT_0033;
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0011 + IT_0027 + -m_su_L*
