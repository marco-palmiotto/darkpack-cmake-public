        ...
        )
{
    ...
    const ccomplex_t IT_0027 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0000
    ...
    const ccomplex_t IT_0031 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0006*(IT_0000*IT_0002*IT_0003*IT_0029 + (-2)*IT_0001*(m_W*IT_0003 + (
      -0.5)*IT_0000*IT_0004*IT_0030));
    const ccomplex_t IT_0032 = 0.5*IT_0031;
    const ccomplex_t IT_0033 = IT_0028*IT_0032;
    const ccomplex_t IT_0034 = pow(m_su_R, 2);
    const ccomplex_t IT_0035 = cpow((-2)*s_13 + IT_0014 + IT_0034 + -m_su_L*
    ...
    const ccomplex_t IT_0042 = (0 + _Complex_I*1)*e_em*(IT_0000*IT_0002
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_23 + IT_0014 + (0 + _Complex_I*1)
      *m_sd_L*Gamma_dl + reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0043*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = cpow((-2)*s_12 + -IT_0015 + -IT_0034 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0005*IT_0041;
    const ccomplex_t IT_0049 = -IT_0006 + IT_0048;
    const ccomplex_t IT_0050 = cpow(IT_0003, 3);
    const ccomplex_t IT_0051 = 3*IT_0006 + IT_0048;
    const ccomplex_t IT_0052 = cpow(IT_0003, 2);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*m_W*e_em*(IT_0010*IT_0049
      *IT_0050 + -IT_0001*(IT_0001*(IT_0001*IT_0009*IT_0049 + IT_0003*IT_0010
      *IT_0051) + -IT_0009*IT_0051*IT_0052));
    const ccomplex_t IT_0054 = 0.5*IT_0053;
    const ccomplex_t IT_0055 = IT_0039*IT_0054;
    const ccomplex_t IT_0056 = IT_0047*IT_0055;
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*IT_0056;
    const ccomplex_t IT_0058 = (0 + _Complex_I*1)*e_em*((-1.5)*IT_0000*IT_0004
    ...
    const ccomplex_t IT_0061 = cpow((-2)*s_13 + IT_0014 + (0 + _Complex_I*1)
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1)*m_W*e_em*(IT_0006*IT_0009
      *IT_0050 + (-2)*IT_0001*(IT_0003*(IT_0001*IT_0009 + IT_0003*IT_0010)*(0.5
      *IT_0006 + IT_0005*IT_0041) + -1./2*IT_0006*IT_0010*IT_0081));
    ...
    const ccomplex_t IT_0088 = cpow((-2)*s_12 + -IT_0015 + -IT_0034 + IT_0087 
      + -reg_prop, -1);
    const ccomplex_t IT_0089 = IT_0086*IT_0088;
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*IT_0089;
    const ccomplex_t IT_0091 = IT_0018 + IT_0026 + IT_0037 + IT_0046 + 
      -IT_0057 + IT_0063 + IT_0072 + IT_0080 + -IT_0090;
