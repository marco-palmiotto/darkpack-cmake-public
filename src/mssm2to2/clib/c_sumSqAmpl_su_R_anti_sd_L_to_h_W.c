...
ccomplex_return_t c_sumSqAmpl_su_R_anti_sd_L_to_h_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0009 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
    ...
    const ccomplex_t IT_0020 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0000*IT_0005*IT_0008*IT_0019;
    ...
    const ccomplex_t IT_0032 = (0 + _Complex_I*1.4142135623731)*V_ud*e_em
      *IT_0005;
    const ccomplex_t IT_0033 = -IT_0032;
    const ccomplex_t IT_0034 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0003
      *IT_0005*IT_0008*IT_0019;
    const ccomplex_t IT_0035 = (-0.5)*IT_0034;
    const ccomplex_t IT_0036 = cpow((-2)*s_13 + IT_0012 + IT_0028 + -m_su_L*
