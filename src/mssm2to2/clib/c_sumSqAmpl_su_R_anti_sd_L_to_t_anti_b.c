...
ccomplex_return_t c_sumSqAmpl_su_R_anti_sd_L_to_t_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0000*IT_0001*IT_0003*IT_0005;
