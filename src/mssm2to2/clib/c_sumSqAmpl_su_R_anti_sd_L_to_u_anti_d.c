        ...
        )
{
    ...
    const ccomplex_t IT_0090 = cpow((-2)*s_13 + IT_0016 + IT_0017 + -IT_0089 +
       reg_prop, -1);
    ...
    const ccomplex_t IT_0097 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *IT_0008*IT_0062*IT_0064*IT_0096;
    const ccomplex_t IT_0098 = 0.5*IT_0097;
    const ccomplex_t IT_0099 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0008*IT_0062;
    const ccomplex_t IT_0100 = 0.5*IT_0099;
    const ccomplex_t IT_0101 = IT_0098*IT_0100;
    const ccomplex_t IT_0102 = pow(m_sd_L, 2);
    ...
    const ccomplex_t IT_0110 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
    ...
    const ccomplex_t IT_0118 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d2)
    ...
    const ccomplex_t IT_0122 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d3)
      *e_em*IT_0008*IT_0062*IT_0117;
    ...
    const ccomplex_t IT_0126 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d4)
      *e_em*IT_0008*IT_0062*IT_0117;
    ...
    const ccomplex_t IT_0142 = (0 + _Complex_I*1.4142135623731)*m_d*conj(N_d1)
      *e_em*IT_0008*IT_0062*IT_0117;
    ...
    const ccomplex_t IT_0165 = m_d*m_u*IT_0017;
    const ccomplex_t IT_0166 = s_34*IT_0017;
