        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
    ...
    const ccomplex_t IT_0015 = cpow((-2)*s_23 + IT_0013 + IT_0014 + -m_su_R*
    ...
    const ccomplex_t IT_0019 = (-0.666666666666667)*IT_0003;
    const ccomplex_t IT_0020 = pow(m_su_R, 2);
    const ccomplex_t IT_0021 = cpow((-2)*s_13 + IT_0013 + IT_0020 + -m_sd_R*
    ...
    const ccomplex_t IT_0027 = pow(s_24, 2);
    const ccomplex_t IT_0028 = IT_0026*IT_0027;
    const ccomplex_t IT_0029 = (0 + _Complex_I*1)*e_em*(IT_0001*IT_0002 + 
      -IT_0000*IT_0010);
    const ccomplex_t IT_0030 = cpow((-2)*s_12 + -IT_0014 + -IT_0020 + m_Hp*
    ...
    return create_ccomplex_return((-3)*IT_0025*(conj(IT_0025)*(IT_0014 + 
      -IT_0028) + conj(IT_0034)*IT_0037) + (-3)*IT_0034*(conj(IT_0025)*IT_0037 +
       conj(IT_0034)*(IT_0013 + -IT_0039)));
}
