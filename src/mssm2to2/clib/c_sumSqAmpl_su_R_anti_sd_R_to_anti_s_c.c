...
ccomplex_return_t c_sumSqAmpl_su_R_anti_sd_R_to_anti_s_c(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = (0 + _Complex_I*1.4142135623731)*m_s*V_cs*e_em
    ...
    const ccomplex_t IT_0024 = m_c*m_s;
