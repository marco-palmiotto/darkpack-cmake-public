...
ccomplex_return_t c_sumSqAmpl_su_R_anti_sd_R_to_h_Hp(
        ...
        )
{
    ...
    const ccomplex_t IT_0010 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *IT_0000*IT_0001*(IT_0003*IT_0004 + -IT_0006*IT_0007)*IT_0009;
    ...
    const ccomplex_t IT_0024 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0003*IT_0006*IT_0012*IT_0013;
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0004*IT_0005 +
    ...
    const ccomplex_t IT_0039 = cpow((-2)*s_13 + IT_0019 + (0 + _Complex_I*1)
      *m_su_R*Gamma_ur + reg_prop, -1);
    const ccomplex_t IT_0040 = IT_0038*IT_0039;
    const ccomplex_t IT_0041 = (0 + _Complex_I*1)*IT_0040;
    const ccomplex_t IT_0042 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0012*IT_0013;
    const ccomplex_t IT_0043 = 0.5*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0007 + m_d*e_em*mu_h*IT_0003*IT_0004*IT_0012*IT_0013);
    const ccomplex_t IT_0045 = 0.5*IT_0044;
    const ccomplex_t IT_0046 = IT_0043*IT_0045;
    const ccomplex_t IT_0047 = cpow((-2)*s_23 + IT_0019 + IT_0020 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0048 = IT_0046*IT_0047;
    const ccomplex_t IT_0049 = (0 + _Complex_I*1)*IT_0048;
    const ccomplex_t IT_0050 = pow(m_su_R, 2);
    const ccomplex_t IT_0051 = cpow((-2)*s_12 + -IT_0020 + -IT_0050 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0052 = IT_0008*IT_0027;
    const ccomplex_t IT_0053 = -IT_0013 + IT_0052;
    const ccomplex_t IT_0054 = cpow(IT_0005, 3);
    const ccomplex_t IT_0055 = 3*IT_0013 + IT_0052;
    const ccomplex_t IT_0056 = cpow(IT_0005, 2);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1)*m_W*e_em*(IT_0004*IT_0053
      *IT_0054 + -IT_0002*(IT_0002*(IT_0002*IT_0007*IT_0053 + IT_0004*IT_0005
      *IT_0055) + -IT_0007*IT_0055*IT_0056));
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = IT_0025*IT_0058;
    const ccomplex_t IT_0060 = IT_0051*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0006
    ...
    const ccomplex_t IT_0067 = cpow((-2)*s_13 + IT_0019 + IT_0050 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1)*IT_0068;
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0019 + IT_0020 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0071 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0012*IT_0013*IT_0071*(mu_h*conj(U_sb_00) + m_b*IT_0003*IT_0006*conj
      (U_sb_10))*V_ub_mod;
    const ccomplex_t IT_0073 = 0.5*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*A_b*V_tb*conj
      (V_td)*IT_0007*U_sb_00;
    ...
    const ccomplex_t IT_0087 = IT_0011 + IT_0023 + IT_0034 + IT_0041 + IT_0049
       + -IT_0061 + IT_0069 + IT_0078 + IT_0086;
