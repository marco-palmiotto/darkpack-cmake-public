        ...
        )
{
    ...
    const ccomplex_t IT_0035 = IT_0008*IT_0027;
    const ccomplex_t IT_0036 = -IT_0013 + IT_0035;
    const ccomplex_t IT_0037 = cpow(IT_0005, 3);
    const ccomplex_t IT_0038 = 3*IT_0013 + IT_0035;
    const ccomplex_t IT_0039 = cpow(IT_0005, 2);
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*m_W*e_em*(IT_0004*IT_0036
      *IT_0037 + -IT_0002*(IT_0002*(IT_0002*IT_0007*IT_0036 + IT_0004*IT_0005
      *IT_0038) + -IT_0007*IT_0038*IT_0039));
    const ccomplex_t IT_0041 = 0.5*IT_0040;
    const ccomplex_t IT_0042 = IT_0025*IT_0041;
    const ccomplex_t IT_0043 = pow(m_su_R, 2);
    const ccomplex_t IT_0044 = cpow((-2)*s_12 + -IT_0020 + -IT_0043 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0045 = IT_0042*IT_0044;
    const ccomplex_t IT_0046 = (0 + _Complex_I*1)*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*m_u*e_em*mu_h*IT_0006
    ...
    const ccomplex_t IT_0052 = cpow((-2)*s_13 + IT_0019 + IT_0043 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
    const ccomplex_t IT_0053 = IT_0051*IT_0052;
    const ccomplex_t IT_0054 = (0 + _Complex_I*1)*IT_0053;
    const ccomplex_t IT_0055 = pow(m_u, 2);
    const ccomplex_t IT_0056 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0004*IT_0005 +
    ...
    const ccomplex_t IT_0059 = cpow((-2)*s_13 + IT_0019 + (0 + _Complex_I*1)
      *m_su_R*Gamma_ur + reg_prop, -1);
    const ccomplex_t IT_0060 = IT_0058*IT_0059;
    const ccomplex_t IT_0061 = (0 + _Complex_I*1)*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*m_u*V_ud*e_em
      *mu_h*IT_0012*IT_0013;
    const ccomplex_t IT_0063 = 0.5*IT_0062;
    const ccomplex_t IT_0064 = (0 + _Complex_I*1)*(1.4142135623731*A_b*V_td
      *conj(V_td)*IT_0007 + m_d*e_em*mu_h*IT_0003*IT_0004*IT_0012*IT_0013);
    const ccomplex_t IT_0065 = 0.5*IT_0064;
    const ccomplex_t IT_0066 = IT_0063*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0019 + IT_0020 + -m_sd_L*
    ...
    const ccomplex_t IT_0087 = IT_0011 + IT_0023 + IT_0034 + -IT_0046 +
       IT_0054 + IT_0061 + IT_0069 + IT_0078 + IT_0086;
