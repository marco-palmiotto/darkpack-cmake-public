        ...
        )
{
    ...
    const ccomplex_t IT_0023 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_N_2*
    ...
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -m_N_3*
    ...
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d2)
    ...
    const ccomplex_t IT_0075 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d4)
      *e_em*IT_0000*IT_0004*IT_0069;
    ...
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d3)
      *e_em*IT_0000*IT_0004*IT_0069;
    ...
    const ccomplex_t IT_0091 = (0 + _Complex_I*1.4142135623731)*m_s*conj(N_d1)
      *e_em*IT_0000*IT_0004*IT_0069;
    ...
    const ccomplex_t IT_0098 = m_s*m_u*IT_0097;
    ...
    const ccomplex_t IT_0104 = IT_0046*IT_0078;
    const ccomplex_t IT_0105 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0106 = IT_0048*IT_0104*IT_0105;
    const ccomplex_t IT_0107 = m_u*IT_0022;
    const ccomplex_t IT_0108 = m_u*IT_0050;
    const ccomplex_t IT_0109 = pow(m_sG, 2);
    const ccomplex_t IT_0110 = cpow((-2)*s_23 + IT_0018 + IT_0019 + -IT_0109 +
       reg_prop, -1);
    const ccomplex_t IT_0111 = (0 + _Complex_I*1.4142135623731)*g_s;
    const ccomplex_t IT_0112 = cpow(IT_0111, 2);
    const ccomplex_t IT_0113 = (0 + _Complex_I*1)*m_sG*IT_0112;
    const ccomplex_t IT_0114 = IT_0110*IT_0113;
    const ccomplex_t IT_0115 = m_u*IT_0064;
    const ccomplex_t IT_0116 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0117 = IT_0031*IT_0067;
    const ccomplex_t IT_0118 = IT_0023*IT_0116*IT_0117;
    const ccomplex_t IT_0119 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0120 = IT_0061*IT_0085;
    const ccomplex_t IT_0121 = IT_0051*IT_0119*IT_0120;
    const ccomplex_t IT_0122 = m_u*IT_0036;
    const ccomplex_t IT_0123 = IT_0016*IT_0090;
    const ccomplex_t IT_0124 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0125 = IT_0020*IT_0123*IT_0124;
    const ccomplex_t IT_0126 = -IT_0106 + IT_0107 + IT_0108 +
       0.166666666666667*IT_0114 + IT_0115 + -IT_0118 + -IT_0121 + IT_0122 + 
      -IT_0125;
    const ccomplex_t IT_0127 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0000*IT_0004;
    const ccomplex_t IT_0128 = 0.5*IT_0127;
    const ccomplex_t IT_0129 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
    ...
    const ccomplex_t IT_0133 = cpow((-2)*s_12 + -IT_0019 + -IT_0097 + IT_0132 
      + -reg_prop, -1);
    const ccomplex_t IT_0134 = IT_0131*IT_0133;
    const ccomplex_t IT_0135 = (0 + _Complex_I*1)*IT_0134;
    const ccomplex_t IT_0136 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *IT_0000*IT_0002*IT_0004*IT_0068;
    const ccomplex_t IT_0137 = 0.5*IT_0136;
    const ccomplex_t IT_0138 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *mu_h*IT_0000*IT_0004;
    const ccomplex_t IT_0139 = 0.5*IT_0138;
    const ccomplex_t IT_0140 = IT_0137*IT_0139;
    const ccomplex_t IT_0141 = cpow((-2)*s_12 + -IT_0019 + -IT_0097 + m_Hp*
      (m_Hp + (0 + _Complex_I*-1)*Gamma_Hp) + -reg_prop, -1);
    const ccomplex_t IT_0142 = IT_0140*IT_0141;
    const ccomplex_t IT_0143 = (0 + _Complex_I*1)*IT_0142;
    const ccomplex_t IT_0144 = (-0.5)*IT_0114 + -IT_0135 + -IT_0143;
    const ccomplex_t IT_0145 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
      *IT_0000*IT_0004;
    const ccomplex_t IT_0146 = (-0.5)*IT_0145;
    const ccomplex_t IT_0147 = IT_0130*IT_0146;
    const ccomplex_t IT_0148 = IT_0133*IT_0147;
    const ccomplex_t IT_0149 = (0 + _Complex_I*1)*IT_0148;
    const ccomplex_t IT_0150 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
    ...
    const ccomplex_t IT_0157 = IT_0020*IT_0124*IT_0156;
    const ccomplex_t IT_0158 = IT_0038*IT_0076;
    const ccomplex_t IT_0159 = IT_0048*IT_0105*IT_0158;
    ...
    const ccomplex_t IT_0164 = IT_0051*IT_0119*IT_0163;
    const ccomplex_t IT_0165 = IT_0033*IT_0071;
    const ccomplex_t IT_0166 = IT_0023*IT_0116*IT_0165;
    ...
    const ccomplex_t IT_0171 = m_s*m_u;
    const ccomplex_t IT_0172 = (-18)*conj(IT_0126);
    ...
    const ccomplex_t IT_0179 = m_s*s_14;
    const ccomplex_t IT_0180 = conj(IT_0155) + IT_0178;
    const ccomplex_t IT_0181 = 3*IT_0168;
    const ccomplex_t IT_0182 = m_u*s_13;
    const ccomplex_t IT_0183 = conj(IT_0065)*((-18)*IT_0096*IT_0098 + IT_0065
      *IT_0103) + conj(IT_0096)*((-18)*IT_0065*IT_0098 + IT_0096*IT_0103) + 
      (conj(IT_0126)*IT_0144 + IT_0126*conj(IT_0144) + conj(IT_0155)*IT_0168 +
       IT_0155*conj(IT_0168))*IT_0169 + (IT_0126*conj(IT_0126) + IT_0144*conj
      (IT_0144) + IT_0155*conj(IT_0155) + IT_0168*conj(IT_0168))*IT_0170 + (-6)
      *IT_0171*((conj(IT_0126) + 3*conj(IT_0144))*IT_0155 + (IT_0126 + 3*IT_0144
      ...
      *IT_0177 + IT_0065*IT_0180 + conj(IT_0065)*(IT_0155 + IT_0181)) + (conj
      (IT_0065)*(18*IT_0126 + 6*IT_0144) + IT_0065*(18*conj(IT_0126) + 6*conj
