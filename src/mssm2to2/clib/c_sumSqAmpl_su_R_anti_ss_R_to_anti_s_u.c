        ...
        )
{
    ...
    const ccomplex_t IT_0044 = (0 + _Complex_I*1.4142135623731)*conj(N_B1)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0051 = (0 + _Complex_I*1.4142135623731)*conj(N_B2)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*conj(N_B3)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0065 = (0 + _Complex_I*1.4142135623731)*conj(N_B4)
      *e_em*IT_0043;
    ...
    const ccomplex_t IT_0072 = pow(m_sG, 2);
    const ccomplex_t IT_0073 = cpow((-2)*s_23 + IT_0012 + IT_0013 + -IT_0072 +
       reg_prop, -1);
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*g_s;
    ...
    const ccomplex_t IT_0078 = -IT_0050 + -IT_0057 + -IT_0064 + -IT_0071 +
       0.166666666666667*IT_0077;
    ...
    const ccomplex_t IT_0113 = (0 + _Complex_I*1.4142135623731)*m_s*V_us*e_em
    ...
    const ccomplex_t IT_0118 = m_u*IT_0077;
    const ccomplex_t IT_0119 = -IT_0117 + 0.5*IT_0118;
    const ccomplex_t IT_0120 = IT_0006*IT_0045;
    const ccomplex_t IT_0121 = IT_0014*IT_0097*IT_0120;
    const ccomplex_t IT_0122 = IT_0018*IT_0052;
    const ccomplex_t IT_0123 = IT_0022*IT_0100*IT_0122;
    const ccomplex_t IT_0124 = IT_0026*IT_0059;
    const ccomplex_t IT_0125 = IT_0030*IT_0103*IT_0124;
    const ccomplex_t IT_0126 = IT_0034*IT_0066;
    const ccomplex_t IT_0127 = IT_0038*IT_0106*IT_0126;
    const ccomplex_t IT_0128 = m_u*IT_0050;
    const ccomplex_t IT_0129 = m_u*IT_0057;
    const ccomplex_t IT_0130 = m_u*IT_0064;
    const ccomplex_t IT_0131 = m_u*IT_0071;
    const ccomplex_t IT_0132 = (-0.166666666666667)*IT_0118 + -IT_0121 + 
    ...
    const ccomplex_t IT_0147 = (-0.5)*IT_0077;
