        ...
        )
{
    ...
    const ccomplex_t IT_0043 = m_d*IT_0029;
    const ccomplex_t IT_0044 = m_d*IT_0033;
    const ccomplex_t IT_0045 = -IT_0044;
    const ccomplex_t IT_0046 = IT_0043 + IT_0045;
    const ccomplex_t IT_0047 = IT_0040*IT_0046;
    const ccomplex_t IT_0048 = m_d*IT_0017;
    const ccomplex_t IT_0049 = m_d*IT_0021;
    ...
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
    ...
    const ccomplex_t IT_0061 = IT_0038*IT_0059*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0000*IT_0004*IT_0056*conj(U_st_00);
