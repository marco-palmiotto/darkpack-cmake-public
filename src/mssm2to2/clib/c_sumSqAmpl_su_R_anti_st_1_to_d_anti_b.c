...
ccomplex_return_t c_sumSqAmpl_su_R_anti_st_1_to_d_anti_b(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = m_t*V_tb*V_u2*e_em*IT_0000*conj(U_st_10);
    ...
    const ccomplex_t IT_0025 = m_t*V_tb*V_u1*e_em*IT_0000*conj(U_st_10);
    const ccomplex_t IT_0026 = IT_0012*IT_0025;
    const ccomplex_t IT_0027 = 1.4142135623731*IT_0026;
    const ccomplex_t IT_0028 = (0 + _Complex_I*1)*IT_0027;
    const ccomplex_t IT_0029 = (-0.5)*IT_0028;
    const ccomplex_t IT_0030 = V_tb*e_em*V_Wp1*conj(U_st_00);
    ...
    const ccomplex_t IT_0036 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
      *V_ud*e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0037 = (-0.5)*IT_0036;
    const ccomplex_t IT_0038 = cpow((-2)*s_13 + IT_0007 + IT_0008 + -m_C_1*
      (m_C_1 + (0 + _Complex_I*-1)*Gamma_c1) + reg_prop, -1);
    const ccomplex_t IT_0039 = IT_0037*IT_0038;
    const ccomplex_t IT_0040 = (0 + _Complex_I*1)*IT_0039;
    const ccomplex_t IT_0041 = IT_0035*IT_0040;
    const ccomplex_t IT_0042 = -IT_0024 + -IT_0041;
    const ccomplex_t IT_0043 = m_d*IT_0017;
    const ccomplex_t IT_0044 = m_d*IT_0021;
    const ccomplex_t IT_0045 = -IT_0044;
    const ccomplex_t IT_0046 = IT_0043 + IT_0045;
    const ccomplex_t IT_0047 = IT_0011*IT_0046;
    const ccomplex_t IT_0048 = m_d*IT_0029;
    const ccomplex_t IT_0049 = m_d*IT_0033;
    ...
    const ccomplex_t IT_0054 = m_d*s_14;
    const ccomplex_t IT_0055 = cos(beta);
    const ccomplex_t IT_0056 = cpow(IT_0055, -1);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d2)
      *V_tb*e_em*IT_0000*IT_0004*IT_0056*conj(U_st_00);
    const ccomplex_t IT_0058 = (-0.5)*IT_0057;
    const ccomplex_t IT_0059 = IT_0006*IT_0058;
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*m_C_2;
    const ccomplex_t IT_0061 = IT_0009*IT_0059*IT_0060;
    const ccomplex_t IT_0062 = (0 + _Complex_I*1.4142135623731)*m_b*conj(U_d1)
      *V_tb*e_em*IT_0000*IT_0004*IT_0056*conj(U_st_00);
    ...
    const ccomplex_t IT_0066 = IT_0038*IT_0064*IT_0065;
    ...
    const ccomplex_t IT_0071 = m_b*m_d;
