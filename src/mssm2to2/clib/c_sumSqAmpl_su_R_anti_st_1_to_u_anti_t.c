        ...
        )
{
    ...
    const ccomplex_t IT_0044 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    const ccomplex_t IT_0045 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0046 = 0.5*IT_0045;
    const ccomplex_t IT_0047 = N_W3*e_em*conj(U_st_00);
    const ccomplex_t IT_0048 = IT_0004*IT_0047;
    const ccomplex_t IT_0049 = 1.4142135623731*IT_0048;
    const ccomplex_t IT_0050 = m_t*N_u3*e_em*IT_0000*conj(U_st_10);
    const ccomplex_t IT_0051 = IT_0015*IT_0050;
    const ccomplex_t IT_0052 = 1.4142135623731*IT_0051;
    const ccomplex_t IT_0053 = N_B3*e_em*conj(U_st_00);
    ...
    const ccomplex_t IT_0062 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0000*IT_0002*IT_0004;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = N_W4*e_em*conj(U_st_00);
    const ccomplex_t IT_0066 = IT_0004*IT_0065;
    const ccomplex_t IT_0067 = 1.4142135623731*IT_0066;
    const ccomplex_t IT_0068 = m_t*N_u4*e_em*IT_0000*conj(U_st_10);
    const ccomplex_t IT_0069 = IT_0015*IT_0068;
    const ccomplex_t IT_0070 = 1.4142135623731*IT_0069;
    const ccomplex_t IT_0071 = N_B4*e_em*conj(U_st_00);
    ...
    const ccomplex_t IT_0082 = cpow((-2)*s_13 + IT_0022 + IT_0023 + -IT_0081 +
       reg_prop, -1);
    ...
    const ccomplex_t IT_0091 = conj(N_B1)*e_em*conj(U_st_10);
    const ccomplex_t IT_0092 = IT_0008*IT_0091;
    const ccomplex_t IT_0093 = 1.4142135623731*IT_0092;
    const ccomplex_t IT_0094 = m_t*conj(N_u1)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0104 = conj(N_B4)*e_em*conj(U_st_10);
    const ccomplex_t IT_0105 = IT_0008*IT_0104;
    const ccomplex_t IT_0106 = 1.4142135623731*IT_0105;
    const ccomplex_t IT_0107 = m_t*conj(N_u4)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0117 = conj(N_B3)*e_em*conj(U_st_10);
    const ccomplex_t IT_0118 = IT_0008*IT_0117;
    const ccomplex_t IT_0119 = 1.4142135623731*IT_0118;
    const ccomplex_t IT_0120 = m_t*conj(N_u3)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0126 = IT_0044*IT_0125;
    ...
    const ccomplex_t IT_0130 = conj(N_B2)*e_em*conj(U_st_10);
    const ccomplex_t IT_0131 = IT_0008*IT_0130;
    const ccomplex_t IT_0132 = 1.4142135623731*IT_0131;
    const ccomplex_t IT_0133 = m_t*conj(N_u2)*e_em*IT_0000*conj(U_st_00);
    ...
    const ccomplex_t IT_0139 = IT_0041*IT_0138;
    const ccomplex_t IT_0140 = (0 + _Complex_I*1)*IT_0139;
    const ccomplex_t IT_0141 = 0.166666666666667*IT_0087 + -IT_0101 + -IT_0114
       + -IT_0127 + -IT_0140;
    const ccomplex_t IT_0142 = m_t*m_u*IT_0023;
    const ccomplex_t IT_0143 = s_34*IT_0023;
    ...
    const ccomplex_t IT_0148 = m_u*s_14;
    const ccomplex_t IT_0149 = m_u*IT_0087;
    const ccomplex_t IT_0150 = 0.5*IT_0149;
    const ccomplex_t IT_0151 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0152 = IT_0064*IT_0111;
    const ccomplex_t IT_0153 = IT_0062*IT_0151*IT_0152;
    const ccomplex_t IT_0154 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0155 = IT_0028*IT_0137;
    const ccomplex_t IT_0156 = IT_0041*IT_0154*IT_0155;
    const ccomplex_t IT_0157 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0158 = IT_0046*IT_0124;
    const ccomplex_t IT_0159 = IT_0044*IT_0157*IT_0158;
    const ccomplex_t IT_0160 = m_u*IT_0101;
    const ccomplex_t IT_0161 = m_u*IT_0140;
    const ccomplex_t IT_0162 = m_u*IT_0114;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0164 = IT_0006*IT_0098;
    const ccomplex_t IT_0165 = IT_0024*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = m_u*IT_0127;
    const ccomplex_t IT_0167 = (-0.166666666666667)*IT_0149 + -IT_0153 + 
      -IT_0156 + -IT_0159 + IT_0160 + IT_0161 + IT_0162 + -IT_0165 + IT_0166;
    const ccomplex_t IT_0168 = (0 + _Complex_I*1.4142135623731)*g_s*conj
      (U_st_00);
    const ccomplex_t IT_0169 = IT_0083*IT_0168;
    const ccomplex_t IT_0170 = (0 + _Complex_I*1)*m_sG;
    const ccomplex_t IT_0171 = IT_0082*IT_0169*IT_0170;
    const ccomplex_t IT_0172 = (-0.5)*IT_0171;
    const ccomplex_t IT_0173 = IT_0020*IT_0090;
    const ccomplex_t IT_0174 = IT_0024*IT_0163*IT_0173;
    const ccomplex_t IT_0175 = IT_0039*IT_0129;
    const ccomplex_t IT_0176 = IT_0041*IT_0154*IT_0175;
    const ccomplex_t IT_0177 = m_u*IT_0026;
    const ccomplex_t IT_0178 = m_u*IT_0043;
    const ccomplex_t IT_0179 = m_u*IT_0079;
    const ccomplex_t IT_0180 = IT_0058*IT_0116;
    const ccomplex_t IT_0181 = IT_0044*IT_0157*IT_0180;
    const ccomplex_t IT_0182 = IT_0076*IT_0103;
    const ccomplex_t IT_0183 = IT_0062*IT_0151*IT_0182;
    const ccomplex_t IT_0184 = m_u*IT_0061;
    const ccomplex_t IT_0185 = 0.166666666666667*IT_0171 + -IT_0174 + -IT_0176
       + IT_0177 + IT_0178 + IT_0179 + -IT_0181 + -IT_0183 + IT_0184;
    const ccomplex_t IT_0186 = 3*IT_0167;
    const ccomplex_t IT_0187 = IT_0150 + IT_0186;
    const ccomplex_t IT_0188 = 3*conj(IT_0167);
    const ccomplex_t IT_0189 = conj(IT_0150) + IT_0188;
    const ccomplex_t IT_0190 = conj(IT_0088)*(18*IT_0150 + 6*IT_0167) +
       IT_0088*(18*conj(IT_0150) + 6*conj(IT_0167)) + 6*conj(IT_0080)*(IT_0172 +
       3*IT_0185) + 6*IT_0080*(conj(IT_0172) + 3*conj(IT_0185)) + 6*conj(IT_0141
      )*IT_0187 + 6*IT_0141*IT_0189;
    ...
    const ccomplex_t IT_0195 = (-6)*conj(IT_0185);
    const ccomplex_t IT_0196 = IT_0194 + IT_0195;
    const ccomplex_t IT_0197 = (-18)*conj(IT_0185);
    const ccomplex_t IT_0198 = (-6)*conj(IT_0172);
    const ccomplex_t IT_0199 = IT_0197 + IT_0198;
    const ccomplex_t IT_0200 = (-18)*IT_0185;
    const ccomplex_t IT_0201 = (-6)*IT_0185;
    const ccomplex_t IT_0202 = m_t*m_u;
    const ccomplex_t IT_0203 = 12*IT_0145;
    const ccomplex_t IT_0204 = (-6)*IT_0143;
    const ccomplex_t IT_0205 = (-6)*(conj(IT_0080)*(IT_0088 + 3*IT_0141) +
       IT_0080*(conj(IT_0088) + 3*conj(IT_0141)))*IT_0142 + (IT_0080*conj
      (IT_0080) + IT_0088*conj(IT_0088) + IT_0141*conj(IT_0141))*IT_0147 +
       IT_0148*IT_0190 + (conj(IT_0150)*IT_0167 + IT_0150*conj(IT_0167) + conj
      (IT_0172)*IT_0185 + IT_0172*conj(IT_0185))*IT_0191 + (IT_0150*conj(IT_0150
      ) + IT_0167*conj(IT_0167) + IT_0172*conj(IT_0172) + IT_0185*conj(IT_0185))
      *IT_0192 + IT_0193*(((-18)*conj(IT_0088) + (-6)*conj(IT_0141))*IT_0172 + (
      -6)*conj(IT_0080)*IT_0187 + (-6)*IT_0080*IT_0189 + IT_0088*IT_0196 +
       IT_0141*IT_0199 + conj(IT_0141)*IT_0200 + conj(IT_0088)*IT_0201) + (((-18
      )*conj(IT_0150) + (-6)*conj(IT_0167))*IT_0172 + IT_0150*IT_0196 + IT_0167
      *IT_0199 + conj(IT_0167)*IT_0200 + conj(IT_0150)*IT_0201)*IT_0202 + (conj
      (IT_0088)*IT_0141 + IT_0088*conj(IT_0141))*(IT_0203 + IT_0204);
