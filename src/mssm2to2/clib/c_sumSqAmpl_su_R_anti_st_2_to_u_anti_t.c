        ...
        )
{
    ...
    const ccomplex_t IT_0049 = cpow((-2)*s_13 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0053 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u3)
      *e_em*IT_0010*IT_0012*IT_0014;
    ...
    const ccomplex_t IT_0061 = m_t*N_u3*e_em*IT_0010*conj(U_st_11);
    ...
    const ccomplex_t IT_0078 = m_t*N_u4*e_em*IT_0010*conj(U_st_11);
    ...
    const ccomplex_t IT_0087 = (0 + _Complex_I*1.4142135623731)*N_B3*e_em
      *IT_0018;
    const ccomplex_t IT_0088 = 0.666666666666667*IT_0087;
    const ccomplex_t IT_0089 = m_t*conj(N_u3)*e_em*IT_0010*conj(U_st_01);
    const ccomplex_t IT_0090 = IT_0025*IT_0089;
    const ccomplex_t IT_0091 = 1.4142135623731*IT_0090;
    const ccomplex_t IT_0092 = conj(N_B3)*e_em*conj(U_st_11);
    const ccomplex_t IT_0093 = IT_0018*IT_0092;
    const ccomplex_t IT_0094 = 1.4142135623731*IT_0093;
    const ccomplex_t IT_0095 = (0 + _Complex_I*1)*(IT_0091 + (
      -1.33333333333333)*IT_0094);
    const ccomplex_t IT_0096 = (-0.75)*IT_0095;
    ...
    const ccomplex_t IT_0103 = conj(N_B1)*e_em*conj(U_st_11);
    const ccomplex_t IT_0104 = IT_0018*IT_0103;
    const ccomplex_t IT_0105 = 1.4142135623731*IT_0104;
    const ccomplex_t IT_0106 = m_t*conj(N_u1)*e_em*IT_0010*conj(U_st_01);
    ...
    const ccomplex_t IT_0116 = conj(N_B2)*e_em*conj(U_st_11);
    const ccomplex_t IT_0117 = IT_0018*IT_0116;
    const ccomplex_t IT_0118 = 1.4142135623731*IT_0117;
    const ccomplex_t IT_0119 = m_t*conj(N_u2)*e_em*IT_0010*conj(U_st_01);
    ...
    const ccomplex_t IT_0127 = conj(N_B4)*e_em*conj(U_st_11);
    const ccomplex_t IT_0128 = IT_0018*IT_0127;
    const ccomplex_t IT_0129 = 1.4142135623731*IT_0128;
    const ccomplex_t IT_0130 = m_t*conj(N_u4)*e_em*IT_0010*conj(U_st_01);
    ...
    const ccomplex_t IT_0135 = (0 + _Complex_I*1.4142135623731)*N_B4*e_em
      *IT_0018;
    const ccomplex_t IT_0136 = 0.666666666666667*IT_0135;
    const ccomplex_t IT_0137 = IT_0134*IT_0136;
    const ccomplex_t IT_0138 = IT_0069*IT_0137;
    ...
    const ccomplex_t IT_0152 = IT_0030*IT_0102;
    const ccomplex_t IT_0153 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0154 = IT_0032*IT_0152*IT_0153;
    const ccomplex_t IT_0155 = IT_0047*IT_0115;
    const ccomplex_t IT_0156 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0157 = IT_0049*IT_0155*IT_0156;
    const ccomplex_t IT_0158 = m_u*IT_0034;
    const ccomplex_t IT_0159 = m_u*IT_0051;
    const ccomplex_t IT_0160 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0161 = IT_0065*IT_0088;
    const ccomplex_t IT_0162 = IT_0052*IT_0160*IT_0161;
    const ccomplex_t IT_0163 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0164 = IT_0082*IT_0136;
    const ccomplex_t IT_0165 = IT_0069*IT_0163*IT_0164;
    const ccomplex_t IT_0166 = m_u*IT_0085;
    const ccomplex_t IT_0167 = m_u*IT_0068;
    const ccomplex_t IT_0168 = 0.166666666666667*IT_0150 + -IT_0154 + -IT_0157
       + IT_0158 + IT_0159 + -IT_0162 + -IT_0165 + IT_0166 + IT_0167;
    const ccomplex_t IT_0169 = m_u*IT_0008;
    const ccomplex_t IT_0170 = 0.5*IT_0169;
    const ccomplex_t IT_0171 = IT_0036*IT_0123;
    const ccomplex_t IT_0172 = IT_0049*IT_0156*IT_0171;
    const ccomplex_t IT_0173 = m_u*IT_0139;
    const ccomplex_t IT_0174 = IT_0054*IT_0097;
    const ccomplex_t IT_0175 = IT_0052*IT_0160*IT_0174;
    const ccomplex_t IT_0176 = IT_0016*IT_0110;
    const ccomplex_t IT_0177 = IT_0032*IT_0153*IT_0176;
    const ccomplex_t IT_0178 = IT_0071*IT_0134;
    const ccomplex_t IT_0179 = IT_0069*IT_0163*IT_0178;
    const ccomplex_t IT_0180 = m_u*IT_0113;
    const ccomplex_t IT_0181 = m_u*IT_0126;
    const ccomplex_t IT_0182 = m_u*IT_0100;
    const ccomplex_t IT_0183 = (-0.166666666666667)*IT_0169 + -IT_0172 +
       IT_0173 + -IT_0175 + -IT_0177 + -IT_0179 + IT_0180 + IT_0181 + IT_0182;
    ...
    const ccomplex_t IT_0188 = conj(IT_0086)*(IT_0151 + 3*IT_0168) + IT_0086*
    ...
    const ccomplex_t IT_0189 = m_t*m_u*IT_0002;
    const ccomplex_t IT_0190 = 6*s_34;
    const ccomplex_t IT_0191 = 18*s_34;
    const ccomplex_t IT_0192 = m_t*m_u;
    ...
    const ccomplex_t IT_0202 = (-0.166666666666667)*((-18)*conj(IT_0009) + (-6
      )*conj(IT_0140))*IT_0151 + conj(IT_0086)*(IT_0170 + 3*IT_0183) + IT_0086*
    ...
    const ccomplex_t IT_0205 = (IT_0009*conj(IT_0009) + IT_0086*conj(IT_0086) 
      + IT_0140*conj(IT_0140))*IT_0145 + 6*IT_0146*IT_0188 + (-6)*(conj(IT_0086)
      *IT_0185 + IT_0086*IT_0187)*IT_0189 + (conj(IT_0151)*IT_0168 + IT_0151
