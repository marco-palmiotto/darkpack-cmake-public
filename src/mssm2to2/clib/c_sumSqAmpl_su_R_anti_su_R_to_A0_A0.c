...
ccomplex_return_t c_sumSqAmpl_su_R_anti_su_R_to_A0_A0(
        ...
        )
{
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_13 + IT_0028 + IT_0036 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
