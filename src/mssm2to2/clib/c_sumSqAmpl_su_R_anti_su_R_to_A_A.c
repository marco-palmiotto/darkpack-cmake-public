...
ccomplex_return_t c_sumSqAmpl_su_R_anti_su_R_to_A_A(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = cpow(s_13 + (0 + _Complex_I*(-0.5))*m_su_R
    ...
    const ccomplex_t IT_0018 = cpow(s_23 + (0 + _Complex_I*(-0.5))*m_su_R
      *Gamma_ur + (-0.5)*reg_prop, -1);
