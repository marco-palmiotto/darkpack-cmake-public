...
ccomplex_return_t c_sumSqAmpl_su_R_anti_su_R_to_Hp_anti_W(
        ...
        )
{
    ...
    const ccomplex_t IT_0013 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0001*IT_0002 +
       IT_0000*IT_0003)*IT_0004*IT_0009 + (-1.5)*IT_0001*IT_0005*IT_0010*IT_0011
      *IT_0012);
    ...
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*e_em*(m_W*(IT_0000*IT_0001 +
       -IT_0002*IT_0003)*IT_0004*IT_0009 + 1.5*IT_0003*IT_0005*IT_0010*IT_0011
      *IT_0012);
