        ...
        )
{
    ...
    const ccomplex_t IT_0034 = -IT_0018;
    const ccomplex_t IT_0035 = IT_0021 + IT_0034;
    const ccomplex_t IT_0036 = -IT_0005;
    const ccomplex_t IT_0037 = (0 + _Complex_I*1)*m_W*e_em*(IT_0015*IT_0023
      *IT_0035 + IT_0036*(IT_0004*IT_0014*IT_0024 + -(IT_0003*IT_0015*IT_0024 + 
      -IT_0005*IT_0014*IT_0035)*IT_0036));
    const ccomplex_t IT_0038 = 0.5*IT_0037;
    const ccomplex_t IT_0039 = IT_0033*IT_0038;
    const ccomplex_t IT_0040 = cpow((-2)*s_12 + (-2)*IT_0028 + m_H0*(m_H0 + (0
    ...
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0028 + IT_0047 + -m_sd_L*
      (m_sd_L + (0 + _Complex_I*-1)*Gamma_dl) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0046*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1.4142135623731)*m_u*V_us*e_em
      *mu_h*IT_0016*IT_0018;
    const ccomplex_t IT_0051 = 0.5*IT_0050;
    const ccomplex_t IT_0052 = cpow(IT_0051, 2);
    const ccomplex_t IT_0053 = (0 + _Complex_I*1)*IT_0052;
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0028 + IT_0047 + -m_ss_L*
      (m_ss_L + (0 + _Complex_I*-1)*Gamma_sl) + reg_prop, -1);
    const ccomplex_t IT_0055 = IT_0053*IT_0054;
    const ccomplex_t IT_0056 = cpow(IT_0005, -1);
    const ccomplex_t IT_0057 = (0 + _Complex_I*1.4142135623731)*m_d*m_u*V_ud
      *e_em*IT_0016*IT_0017*IT_0018*IT_0056;
    const ccomplex_t IT_0058 = 0.5*IT_0057;
    const ccomplex_t IT_0059 = cpow(IT_0058, 2);
    const ccomplex_t IT_0060 = (0 + _Complex_I*1)*IT_0059;
    const ccomplex_t IT_0061 = cpow((-2)*s_23 + IT_0028 + IT_0047 + -m_sd_R*
      (m_sd_R + (0 + _Complex_I*-1)*Gamma_dr) + reg_prop, -1);
    const ccomplex_t IT_0062 = IT_0060*IT_0061;
    const ccomplex_t IT_0063 = (0 + _Complex_I*1.4142135623731)*m_s*m_u*V_us
      *e_em*IT_0016*IT_0017*IT_0018*IT_0056;
    const ccomplex_t IT_0064 = 0.5*IT_0063;
    const ccomplex_t IT_0065 = cpow(IT_0064, 2);
    const ccomplex_t IT_0066 = (0 + _Complex_I*1)*IT_0065;
    const ccomplex_t IT_0067 = cpow((-2)*s_23 + IT_0028 + IT_0047 + -m_ss_R*
      (m_ss_R + (0 + _Complex_I*-1)*Gamma_sr) + reg_prop, -1);
    const ccomplex_t IT_0068 = IT_0066*IT_0067;
    const ccomplex_t IT_0069 = cexp((0 + _Complex_I*1)*delta_wolf);
    const ccomplex_t IT_0070 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0016*IT_0018*IT_0069*(mu_h*conj(U_sb_01) + m_b*IT_0017*IT_0056*conj
      (U_sb_11))*V_ub_mod;
    const ccomplex_t IT_0071 = 0.5*IT_0070;
    const ccomplex_t IT_0072 = cexp((0 + _Complex_I*-1)*delta_wolf);
    const ccomplex_t IT_0073 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0016*IT_0018*IT_0072*(mu_h*U_sb_01 + m_b*IT_0017*IT_0056*U_sb_11)
      *V_ub_mod;
    const ccomplex_t IT_0074 = 0.5*IT_0073;
    const ccomplex_t IT_0075 = IT_0071*IT_0074;
    const ccomplex_t IT_0076 = cpow((-2)*s_23 + IT_0028 + IT_0047 + -m_sb_2*
      (m_sb_2 + (0 + _Complex_I*-1)*Gamma_b2) + reg_prop, -1);
    const ccomplex_t IT_0077 = IT_0075*IT_0076;
    const ccomplex_t IT_0078 = (0 + _Complex_I*1)*IT_0077;
    const ccomplex_t IT_0079 = cpow((-2)*s_23 + IT_0028 + IT_0047 + -m_sb_1*
      (m_sb_1 + (0 + _Complex_I*-1)*Gamma_b1) + reg_prop, -1);
    const ccomplex_t IT_0080 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0016*IT_0018*IT_0069*(mu_h*conj(U_sb_00) + m_b*IT_0017*IT_0056*conj
      (U_sb_10))*V_ub_mod;
    const ccomplex_t IT_0081 = 0.5*IT_0080;
    const ccomplex_t IT_0082 = (0 + _Complex_I*1.4142135623731)*m_u*e_em
      *IT_0016*IT_0018*IT_0072*(mu_h*U_sb_00 + m_b*IT_0017*IT_0056*U_sb_10)
      *V_ub_mod;
    ...
    const ccomplex_t IT_0129 = IT_0013 + -IT_0031 + -IT_0042 + IT_0049 +
       IT_0055 + IT_0062 + IT_0068 + IT_0078 + IT_0086 + IT_0105 + 2*IT_0128;
