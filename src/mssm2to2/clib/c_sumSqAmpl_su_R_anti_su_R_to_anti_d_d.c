...
ccomplex_return_t c_sumSqAmpl_su_R_anti_su_R_to_anti_d_d(
        ...
        )
{
    ...
    const ccomplex_t IT_0058 = (0 + _Complex_I*1.4142135623731)*m_u*V_u1*V_ud
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
      *V_ud*e_em*IT_0000*IT_0005*IT_0013;
    ...
    const ccomplex_t IT_0066 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0000*IT_0005*IT_0013;
    ...
    const ccomplex_t IT_0105 = (-6)*IT_0074;
    const ccomplex_t IT_0106 = (-18)*IT_0057 + IT_0105;
    const ccomplex_t IT_0107 = (-18)*conj(IT_0057);
    const ccomplex_t IT_0108 = (-6)*conj(IT_0074);
    const ccomplex_t IT_0109 = IT_0107 + IT_0108;
    const ccomplex_t IT_0110 = m_d*s_14;
    const ccomplex_t IT_0111 = (-18)*IT_0051;
    const ccomplex_t IT_0112 = m_d*IT_0074;
    const ccomplex_t IT_0113 = -IT_0112;
    const ccomplex_t IT_0114 = (-6)*IT_0113;
    const ccomplex_t IT_0115 = IT_0111 + IT_0114;
    const ccomplex_t IT_0116 = (-18)*conj(IT_0051);
    const ccomplex_t IT_0117 = (-6)*conj(IT_0113);
    const ccomplex_t IT_0118 = IT_0116 + IT_0117;
    const ccomplex_t IT_0119 = m_d*s_13;
    const ccomplex_t IT_0120 = 6*conj(IT_0113);
    const ccomplex_t IT_0121 = 18*conj(IT_0051);
    const ccomplex_t IT_0122 = 6*conj(IT_0051);
    const ccomplex_t IT_0123 = 18*conj(IT_0113);
    const ccomplex_t IT_0124 = 18*conj(IT_0052)*IT_0081 + 18*IT_0052*conj
      (IT_0081) + 6*conj(IT_0074)*(IT_0051 + 3*IT_0113) + conj(IT_0057)*(18
      *IT_0051 + 6*IT_0113) + IT_0057*(IT_0120 + IT_0121) + IT_0074*(IT_0122 +
       IT_0123);
    const ccomplex_t IT_0125 = -s_14;
    const ccomplex_t IT_0126 = s_13 + IT_0125;
    const ccomplex_t IT_0127 = m_d*IT_0126;
    const ccomplex_t IT_0128 = 6*IT_0029;
    const ccomplex_t IT_0129 = 6*conj(IT_0029);
    const ccomplex_t IT_0130 = conj(IT_0057) + conj(IT_0081);
    const ccomplex_t IT_0131 = 18*IT_0029;
    const ccomplex_t IT_0132 = IT_0057 + IT_0081;
    const ccomplex_t IT_0133 = 18*conj(IT_0029);
    const ccomplex_t IT_0134 = IT_0104*((-36)*IT_0029 + 36*conj(IT_0029) + (
      -18)*IT_0052 + 18*conj(IT_0052) + IT_0111 + IT_0114 + IT_0120 + IT_0121) +
       (-12)*IT_0091*(IT_0029 + -conj(IT_0029) + 1./2*IT_0051 + 1./2*IT_0052 + 
      -1./2*conj(IT_0052) + 3./2*IT_0113 + (-0.0833333333333333)*IT_0122 + (
      -0.0833333333333333)*IT_0123) + conj(IT_0074)*IT_0128 + IT_0074*IT_0129 +
       IT_0130*IT_0131 + IT_0132*IT_0133;
    const ccomplex_t IT_0135 = (-18)*IT_0094;
    const ccomplex_t IT_0136 = IT_0082 + IT_0083 + IT_0135;
    const ccomplex_t IT_0137 = -IT_0104;
    const ccomplex_t IT_0138 = -IT_0091;
    const ccomplex_t IT_0139 = (-6)*IT_0094;
    const ccomplex_t IT_0140 = IT_0076 + IT_0078 + IT_0139;
    const ccomplex_t IT_0141 = -IT_0030;
    const ccomplex_t IT_0142 = IT_0029*conj(IT_0029)*(36*s_34 + (-36)*IT_0030)
      ...
      *IT_0097*IT_0104) + IT_0094*(conj(IT_0081)*IT_0106 + IT_0081*IT_0109) + 6
      *IT_0051*(0.166666666666667*conj(IT_0051)*IT_0054 + s_34*conj(IT_0113)) +
       IT_0030*(conj(IT_0052)*IT_0115 + IT_0052*IT_0118) + IT_0110*(conj(IT_0052
      )*IT_0106 + IT_0052*IT_0109 + conj(IT_0081)*IT_0115 + IT_0081*IT_0118) +
       IT_0119*IT_0124 + IT_0127*IT_0134 + IT_0136*(conj(IT_0074)*IT_0091 +
       IT_0104*IT_0130 + IT_0132*IT_0137 + IT_0074*IT_0138) + (conj(IT_0074)
      *IT_0104 + IT_0091*IT_0130 + IT_0074*IT_0137 + IT_0132*IT_0138)*IT_0140 +
       conj(IT_0113)*IT_0128*(s_34 + IT_0141) + 6*IT_0113*(s_34*conj(IT_0051) +
       0.166666666666667*IT_0054*conj(IT_0113) + 0.166666666666667*IT_0129*(s_34
       + IT_0141));
