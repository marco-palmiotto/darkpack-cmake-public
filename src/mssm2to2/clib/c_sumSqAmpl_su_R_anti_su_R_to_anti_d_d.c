        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*m_d*e_em*IT_0005*IT_0009
      *IT_0012*IT_0015;
    const ccomplex_t IT_0017 = (-0.5)*IT_0016;
    const ccomplex_t IT_0018 = IT_0014*IT_0017;
    const ccomplex_t IT_0019 = IT_0001*IT_0018;
    const ccomplex_t IT_0020 = (0 + _Complex_I*1)*IT_0019;
    const ccomplex_t IT_0021 = (0 + _Complex_I*1)*m_d*e_em*IT_0007*IT_0009
      *IT_0012*IT_0015;
    ...
    const ccomplex_t IT_0060 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
      *V_ud*e_em*IT_0009*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0067 = (0 + _Complex_I*1.4142135623731)*m_u*V_u2*V_ud
      *e_em*IT_0009*IT_0011*IT_0012;
    const ccomplex_t IT_0068 = 0.5*IT_0067;
    const ccomplex_t IT_0069 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u2)
      *V_ud*e_em*IT_0009*IT_0011*IT_0012;
    ...
    const ccomplex_t IT_0080 = IT_0033*IT_0040;
    ...
    const ccomplex_t IT_0087 = cpow(s_12 + IT_0000 + 0.5*reg_prop, -1);
    ...
    const ccomplex_t IT_0094 = IT_0000*IT_0030;
    ...
    const ccomplex_t IT_0105 = (-18)*IT_0052;
    const ccomplex_t IT_0106 = m_d*IT_0074;
    const ccomplex_t IT_0107 = -IT_0106;
    const ccomplex_t IT_0108 = (-6)*IT_0107;
    const ccomplex_t IT_0109 = IT_0105 + IT_0108;
    const ccomplex_t IT_0110 = (-18)*conj(IT_0052);
    ...
    const ccomplex_t IT_0119 = m_d*s_14;
    ...
    const ccomplex_t IT_0125 = 6*conj(IT_0052);
    ...
    const ccomplex_t IT_0132 = 18*conj(IT_0052);
    const ccomplex_t IT_0133 = conj(IT_0074)*IT_0123 + IT_0074*IT_0124 + (-12)
      *IT_0091*(IT_0029 + -conj(IT_0029) + 1./2*IT_0051 + -1./2*conj(IT_0051) +
       1./2*IT_0052 + 3./2*IT_0107 + (-0.0833333333333333)*IT_0125 + (
      -0.0833333333333333)*IT_0126) + IT_0127*IT_0128 + IT_0129*IT_0130 +
       IT_0104*((-36)*IT_0029 + 36*conj(IT_0029) + (-18)*IT_0051 + 18*conj
      (IT_0051) + IT_0105 + IT_0108 + IT_0131 + IT_0132);
    ...
    const ccomplex_t IT_0142 = m_d*s_13;
    const ccomplex_t IT_0143 = IT_0052*(18*conj(IT_0057) + 6*conj(IT_0074)) +
       18*conj(IT_0051)*IT_0081 + 18*IT_0051*conj(IT_0081) + IT_0074*(IT_0125 +
    ...
    const ccomplex_t IT_0144 = IT_0029*conj(IT_0029)*(36*s_34 + (-36)*IT_0030)
      ...
      *IT_0097*IT_0104) + 6*IT_0052*(0.166666666666667*conj(IT_0052)*IT_0054 +
       s_34*conj(IT_0107)) + IT_0030*(conj(IT_0051)*IT_0109 + IT_0051*IT_0112) +
       IT_0094*(conj(IT_0081)*IT_0115 + IT_0081*IT_0118) + (conj(IT_0081)
      *IT_0109 + IT_0081*IT_0112 + conj(IT_0051)*IT_0115 + IT_0051*IT_0118)
      ...
      *IT_0127 + IT_0129*IT_0136 + IT_0074*IT_0137) + (conj(IT_0074)*IT_0104 +
      ...
      (IT_0107)*IT_0123*(s_34 + IT_0140) + (s_34*conj(IT_0052) +
