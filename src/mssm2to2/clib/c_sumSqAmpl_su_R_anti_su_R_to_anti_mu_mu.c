...
ccomplex_return_t c_sumSqAmpl_su_R_anti_su_R_to_anti_mu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0054 = m_mu*IT_0033;
    ...
    const ccomplex_t IT_0061 = (-6)*IT_0056;
    ...
    const ccomplex_t IT_0071 = IT_0017*IT_0030;
    const ccomplex_t IT_0072 = s_34*IT_0017;
    ...
    const ccomplex_t IT_0077 = -conj(IT_0048);
    const ccomplex_t IT_0078 = 12*IT_0051*(IT_0029 + -conj(IT_0029) + -1./2
      *conj(IT_0056) + 1./2*IT_0057 + -1./2*conj(IT_0057) + (-0.0833333333333333
      )*IT_0061) + IT_0069*(24*IT_0070 + (-12)*IT_0071 + (-12)*IT_0072) +
       IT_0076*(IT_0044 + -conj(IT_0044) + IT_0048 + IT_0077);
    const ccomplex_t IT_0079 = m_mu*s_13;
    const ccomplex_t IT_0080 = IT_0073 + IT_0075;
    const ccomplex_t IT_0081 = conj(IT_0029)*IT_0051;
    const ccomplex_t IT_0082 = (-6)*conj(IT_0044);
    const ccomplex_t IT_0083 = (-6)*conj(IT_0056);
    ...
    const ccomplex_t IT_0087 = IT_0029*(conj(IT_0029)*(12*s_34 + (-12)*IT_0030
      ) + 6*(conj(IT_0044) + conj(IT_0048))*IT_0051 + 6*(conj(IT_0056) + conj
      (IT_0057))*IT_0059) + (IT_0030*conj(IT_0057) + conj(IT_0048)*IT_0060)
      *IT_0061 + -IT_0069*IT_0078 + (-6)*IT_0044*(conj(IT_0057)*IT_0060 + 
      -IT_0071*IT_0077 + -conj(IT_0056)*IT_0079 + (-0.166666666666667)*conj
      (IT_0044)*IT_0080 + -IT_0081) + 6*IT_0048*(conj(IT_0057)*IT_0079 +
       0.166666666666667*conj(IT_0048)*IT_0080 + IT_0081 + 0.166666666666667
      *IT_0071*IT_0082 + IT_0083*IT_0084) + 6*IT_0056*(conj(IT_0044)*IT_0079 +
       0.166666666666667*conj(IT_0056)*IT_0085 + IT_0086) + 6*IT_0057*(conj
      (IT_0048)*IT_0079 + 0.166666666666667*IT_0030*IT_0083 + IT_0082*IT_0084 +
