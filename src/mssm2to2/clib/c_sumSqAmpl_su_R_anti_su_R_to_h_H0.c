...
ccomplex_return_t c_sumSqAmpl_su_R_anti_su_R_to_h_H0(
        ...
        )
{
    ...
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0026 + IT_0044 + -m_su_L*
    ...
    const ccomplex_t IT_0055 = cpow((-2)*s_13 + IT_0026 + IT_0044 + -m_su_L*
      (m_su_L + (0 + _Complex_I*-1)*Gamma_ul) + reg_prop, -1);
