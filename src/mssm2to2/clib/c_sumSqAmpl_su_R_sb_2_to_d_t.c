        ...
        )
{
    ...
    const ccomplex_t IT_0016 = (0 + _Complex_I*1.4142135623731)*m_u*conj(V_u1)
      *V_ud*e_em*IT_0000*IT_0002*IT_0004;
    ...
    const ccomplex_t IT_0028 = m_b*conj(U_d1)*V_tb*e_em*IT_0000*U_sb_11;
    ...
    const ccomplex_t IT_0038 = m_b*conj(U_d2)*V_tb*e_em*IT_0000*U_sb_11;
    ...
    const ccomplex_t IT_0046 = IT_0012*IT_0037*IT_0045;
    const ccomplex_t IT_0047 = -IT_0036 + -IT_0046;
    const ccomplex_t IT_0048 = m_t*s_13;
    const ccomplex_t IT_0049 = s_13*s_14;
    const ccomplex_t IT_0050 = s_34*IT_0011;
    const ccomplex_t IT_0051 = m_d*s_14;
    const ccomplex_t IT_0052 = m_d*IT_0023;
    const ccomplex_t IT_0053 = m_d*m_t;
    const ccomplex_t IT_0054 = 18*s_34;
    const ccomplex_t IT_0055 = conj(IT_0023)*(18*IT_0047*IT_0048 + IT_0023*(36
      *IT_0049 + (-18)*IT_0050) + (-18)*IT_0051*IT_0052) + conj(IT_0047)*(18
      *IT_0023*IT_0048 + (-18)*IT_0052*IT_0053 + IT_0047*IT_0054) + conj(IT_0052
      )*((-18)*IT_0023*IT_0051 + (-18)*IT_0047*IT_0053 + IT_0052*IT_0054);
