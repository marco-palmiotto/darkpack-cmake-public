        ...
        )
{
    ...
    const ccomplex_t IT_0008 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_1*
    ...
    const ccomplex_t IT_0054 = cpow((-2)*s_23 + IT_0000 + IT_0002 + -m_N_2*
    ...
    const ccomplex_t IT_0072 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0015*IT_0069*IT_0071;
    const ccomplex_t IT_0073 = 0.5*IT_0072;
    const ccomplex_t IT_0074 = (0 + _Complex_I*1.4142135623731)*m_c*N_u4*e_em
      *IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0086 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0015*IT_0069*IT_0071;
    const ccomplex_t IT_0087 = 0.5*IT_0086;
    const ccomplex_t IT_0088 = (0 + _Complex_I*1.4142135623731)*m_c*N_u2*e_em
      *IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0095 = (0 + _Complex_I*1.4142135623731)*m_c*N_u3*e_em
      *IT_0015*IT_0069*IT_0071;
    ...
    const ccomplex_t IT_0108 = m_c*m_u;
    const ccomplex_t IT_0109 = m_u*IT_0007;
    const ccomplex_t IT_0110 = (-0.5)*IT_0109;
    const ccomplex_t IT_0111 = IT_0022*IT_0080;
    const ccomplex_t IT_0112 = (0 + _Complex_I*1)*m_N_1;
    const ccomplex_t IT_0113 = IT_0008*IT_0111*IT_0112;
    const ccomplex_t IT_0114 = IT_0049*IT_0075;
    const ccomplex_t IT_0115 = (0 + _Complex_I*1)*m_N_4;
    const ccomplex_t IT_0116 = IT_0051*IT_0114*IT_0115;
    const ccomplex_t IT_0117 = m_u*IT_0085;
    const ccomplex_t IT_0118 = m_u*IT_0099;
    const ccomplex_t IT_0119 = m_u*IT_0078;
    const ccomplex_t IT_0120 = m_u*IT_0092;
    const ccomplex_t IT_0121 = IT_0113 + IT_0116 + -IT_0117 + -IT_0118 + 
      -IT_0119 + -IT_0120;
    const ccomplex_t IT_0122 = (0 + _Complex_I*1)*m_N_2;
    const ccomplex_t IT_0123 = IT_0056*IT_0089;
    const ccomplex_t IT_0124 = IT_0054*IT_0122*IT_0123;
    const ccomplex_t IT_0125 = IT_0035*IT_0096;
    const ccomplex_t IT_0126 = (0 + _Complex_I*1)*m_N_3;
    const ccomplex_t IT_0127 = IT_0037*IT_0125*IT_0126;
    const ccomplex_t IT_0128 = -IT_0124 + -IT_0127;
    const ccomplex_t IT_0129 = -IT_0128;
    const ccomplex_t IT_0130 = IT_0121 + -conj(IT_0121) + conj(IT_0128) +
       IT_0129;
    const ccomplex_t IT_0131 = IT_0047*IT_0073;
    const ccomplex_t IT_0132 = IT_0051*IT_0115*IT_0131;
    const ccomplex_t IT_0133 = IT_0020*IT_0082;
    const ccomplex_t IT_0134 = IT_0008*IT_0112*IT_0133;
    const ccomplex_t IT_0135 = IT_0064*IT_0087;
    const ccomplex_t IT_0136 = IT_0054*IT_0122*IT_0135;
    const ccomplex_t IT_0137 = -IT_0132 + -IT_0134 + -IT_0136;
    const ccomplex_t IT_0138 = 18*IT_0121;
    const ccomplex_t IT_0139 = (-18)*IT_0128;
    const ccomplex_t IT_0140 = IT_0138 + IT_0139;
    const ccomplex_t IT_0141 = 18*conj(IT_0121);
    const ccomplex_t IT_0142 = (-18)*conj(IT_0128);
    const ccomplex_t IT_0143 = IT_0141 + IT_0142;
    const ccomplex_t IT_0144 = m_u*IT_0039;
    const ccomplex_t IT_0145 = m_u*IT_0053;
    const ccomplex_t IT_0146 = m_u*IT_0067;
    const ccomplex_t IT_0147 = m_u*IT_0025;
    const ccomplex_t IT_0148 = IT_0033*IT_0094;
    const ccomplex_t IT_0149 = IT_0037*IT_0126*IT_0148;
    const ccomplex_t IT_0150 = 0.166666666666667*IT_0109 + -IT_0144 + -IT_0145
       + -IT_0146 + -IT_0147 + IT_0149;
    const ccomplex_t IT_0151 = 18*IT_0128;
    const ccomplex_t IT_0152 = (-18)*IT_0121;
    const ccomplex_t IT_0153 = IT_0151 + IT_0152;
    const ccomplex_t IT_0154 = 18*conj(IT_0128);
    const ccomplex_t IT_0155 = (-18)*conj(IT_0121);
    ...
    const ccomplex_t IT_0160 = m_u*s_13;
    const ccomplex_t IT_0161 = (-0.5)*IT_0007;
    const ccomplex_t IT_0162 = 6*IT_0110;
    const ccomplex_t IT_0163 = (-6)*IT_0110;
    const ccomplex_t IT_0164 = conj(IT_0100)*IT_0153 + IT_0100*IT_0156 + (36
      *IT_0110 + (-6)*IT_0137 + 6*conj(IT_0137) + 6*IT_0150 + (-6)*conj(IT_0150)
      )*IT_0161 + IT_0068*(18*conj(IT_0137) + (-18)*conj(IT_0150) + IT_0162) +
       conj(IT_0068)*(18*IT_0137 + (-18)*IT_0150 + IT_0163);
    const ccomplex_t IT_0165 = m_c*s_14;
    const ccomplex_t IT_0166 = (-0.166666666666667)*conj(IT_0068)*IT_0140 + (
      -0.166666666666667)*IT_0068*IT_0143 + IT_0130*IT_0161 + 3*conj(IT_0100)*
      (IT_0137 + -IT_0150 + (-0.0555555555555556)*IT_0162) + 3*IT_0100*(conj
      (IT_0137) + -conj(IT_0150) + (-0.0555555555555556)*IT_0163);
    const ccomplex_t IT_0167 = 12*IT_0105;
    const ccomplex_t IT_0168 = (-6)*IT_0103;
    const ccomplex_t IT_0169 = conj(IT_0068)*((-18)*IT_0100*IT_0102 + IT_0068
      *IT_0107) + conj(IT_0100)*((-18)*IT_0068*IT_0102 + IT_0100*IT_0107) + 6
      *IT_0108*(IT_0110*IT_0130 + 0.166666666666667*conj(IT_0137)*IT_0140 +
       0.166666666666667*IT_0137*IT_0143 + 0.166666666666667*conj(IT_0150)
      *IT_0153 + 0.166666666666667*IT_0150*IT_0156) + (IT_0121*conj(IT_0121) +
       IT_0128*conj(IT_0128) + IT_0137*conj(IT_0137) + IT_0150*conj(IT_0150))
      *IT_0157 + (conj(IT_0121)*IT_0128 + IT_0121*conj(IT_0128) + conj(IT_0137)
      *IT_0150 + IT_0137*conj(IT_0150))*IT_0158 + 6*IT_0110*(s_34*(IT_0137 +
       conj(IT_0150)) + 0.166666666666667*IT_0110*IT_0158 + 0.166666666666667*
      (conj(IT_0137) + IT_0150)*IT_0159) + IT_0160*IT_0164 + (-6)*IT_0165
      *IT_0166 + 6*IT_0161*((IT_0100 + -conj(IT_0100))*IT_0102 + (
      -0.166666666666667)*IT_0107*IT_0161 + (-0.166666666666667)*(IT_0068 + 
      -conj(IT_0068))*(IT_0167 + IT_0168));
