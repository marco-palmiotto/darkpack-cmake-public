        ...
        )
{
    ...
    const ccomplex_t IT_0017 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u4)
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0025 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*m_u*conj(N_u2)
      *e_em*IT_0003*IT_0005*IT_0007;
    ...
    const ccomplex_t IT_0042 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_4*
      (m_N_4 + (0 + _Complex_I*-1)*Gamma_o4) + reg_prop, -1);
    const ccomplex_t IT_0043 = IT_0021*IT_0042;
    const ccomplex_t IT_0044 = (0 + _Complex_I*1)*IT_0043;
    const ccomplex_t IT_0045 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_1*
      (m_N_1 + (0 + _Complex_I*-1)*Gamma_o1) + reg_prop, -1);
    const ccomplex_t IT_0046 = IT_0014*IT_0045;
    const ccomplex_t IT_0047 = (0 + _Complex_I*1)*IT_0046;
    const ccomplex_t IT_0048 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_2*
      (m_N_2 + (0 + _Complex_I*-1)*Gamma_o2) + reg_prop, -1);
    const ccomplex_t IT_0049 = IT_0030*IT_0048;
    const ccomplex_t IT_0050 = (0 + _Complex_I*1)*IT_0049;
    const ccomplex_t IT_0051 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -m_N_3*
      (m_N_3 + (0 + _Complex_I*-1)*Gamma_o3) + reg_prop, -1);
    ...
    const ccomplex_t IT_0063 = m_u*s_24;
    const ccomplex_t IT_0064 = pow(m_sG, 2);
    const ccomplex_t IT_0065 = cpow((-2)*s_13 + IT_0000 + IT_0001 + -IT_0064 +
       reg_prop, -1);
    ...
    const ccomplex_t IT_0070 = cpow((-2)*s_23 + IT_0000 + IT_0001 + -IT_0064 +
       reg_prop, -1);
    const ccomplex_t IT_0071 = IT_0068*IT_0070;
    const ccomplex_t IT_0072 = cpow(IT_0013, 2);
    const ccomplex_t IT_0073 = (0 + _Complex_I*1)*m_N_1*IT_0072;
    const ccomplex_t IT_0074 = IT_0002*IT_0073;
    const ccomplex_t IT_0075 = cpow(IT_0036, 2);
    const ccomplex_t IT_0076 = (0 + _Complex_I*1)*m_N_3*IT_0075;
    const ccomplex_t IT_0077 = IT_0038*IT_0076;
    const ccomplex_t IT_0078 = cpow(IT_0020, 2);
    const ccomplex_t IT_0079 = (0 + _Complex_I*1)*m_N_4*IT_0078;
    const ccomplex_t IT_0080 = IT_0022*IT_0079;
    const ccomplex_t IT_0081 = m_u*IT_0016;
    const ccomplex_t IT_0082 = m_u*IT_0024;
    const ccomplex_t IT_0083 = cpow(IT_0029, 2);
    const ccomplex_t IT_0084 = (0 + _Complex_I*1)*m_N_2*IT_0083;
    const ccomplex_t IT_0085 = IT_0025*IT_0084;
    const ccomplex_t IT_0086 = m_u*IT_0032;
    const ccomplex_t IT_0087 = m_u*IT_0040;
    const ccomplex_t IT_0088 = (-0.166666666666667)*IT_0069 + 0.5*IT_0071 +
       IT_0074 + IT_0077 + IT_0080 + -IT_0081 + -IT_0082 + IT_0085 + -IT_0086 + 
      -IT_0087;
    const ccomplex_t IT_0089 = cpow(IT_0034, 2);
    const ccomplex_t IT_0090 = (0 + _Complex_I*1)*m_N_3*IT_0089;
    ...
    const ccomplex_t IT_0095 = cpow(IT_0009, 2);
    const ccomplex_t IT_0096 = (0 + _Complex_I*1)*m_N_1*IT_0095;
    const ccomplex_t IT_0097 = IT_0002*IT_0096;
    const ccomplex_t IT_0098 = cpow(IT_0027, 2);
    const ccomplex_t IT_0099 = (0 + _Complex_I*1)*m_N_2*IT_0098;
    const ccomplex_t IT_0100 = IT_0025*IT_0099;
    const ccomplex_t IT_0101 = -IT_0081 + -IT_0082 + -IT_0086 + -IT_0087 +
       IT_0091 + IT_0094 + IT_0097 + IT_0100;
    const ccomplex_t IT_0102 = IT_0045*IT_0073;
    const ccomplex_t IT_0103 = IT_0048*IT_0084;
    const ccomplex_t IT_0104 = IT_0051*IT_0076;
    const ccomplex_t IT_0105 = IT_0042*IT_0079;
    const ccomplex_t IT_0106 = m_u*IT_0047;
    const ccomplex_t IT_0107 = m_u*IT_0050;
    const ccomplex_t IT_0108 = m_u*IT_0053;
    const ccomplex_t IT_0109 = m_u*IT_0044;
    const ccomplex_t IT_0110 = 0.5*IT_0069 + (-0.166666666666667)*IT_0071 +
    ...
    const ccomplex_t IT_0114 = IT_0045*IT_0096;
    const ccomplex_t IT_0115 = IT_0051*IT_0090;
    const ccomplex_t IT_0116 = IT_0042*IT_0093;
    const ccomplex_t IT_0117 = IT_0048*IT_0099;
    const ccomplex_t IT_0118 = -IT_0106 + -IT_0107 + -IT_0108 + -IT_0109 +
    ...
    const ccomplex_t IT_0132 = IT_0000*IT_0001;
    ...
    const ccomplex_t IT_0137 = m_u*s_23;
    ...
    const ccomplex_t IT_0139 = 2*(conj(IT_0041)*IT_0054 + IT_0041*conj(IT_0054
      ...
      *IT_0123 + IT_0000*(IT_0088*((-18)*conj(IT_0101) + (-6)*conj(IT_0118)) +
