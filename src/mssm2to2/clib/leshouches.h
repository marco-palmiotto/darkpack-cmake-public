...
#include <string.h>
#include <strings.h>
#include <stdbool.h> //IMPORTANT: add this library for full bool support in C99 (required for C++ compilation)
...
/*--------------------------------------------------------------------*/
typedef double _Complex Complex_C_t; //IMPORTANT: use this alias for full complex support from C to C++
...
/* structure containing all the scanned parameters from the SLHA file */
{
	...
	/* CKM matrix */
	Complex_C_t Vud,Vus,Vub,Vcd,Vcs,Vcb,Vtd,Vts,Vtb;
	...
	Complex_C_t BtoKstarlow_ALperp_err_noq2,BtoKstarlow_ARperp_err_noq2,BtoKstarlow_ALpar_err_noq2,BtoKstarlow_ARpar_err_noq2,BtoKstarlow_AL0_err_noq2,BtoKstarlow_AR0_err_noq2,BtoKstarlow_At_err_noq2,BtoKstarlow_AS_err_noq2;
	Complex_C_t BtoKstarlow_ALperp_err_q2,BtoKstarlow_ARperp_err_q2,BtoKstarlow_ALpar_err_q2,BtoKstarlow_ARpar_err_q2,BtoKstarlow_AL0_err_q2,BtoKstarlow_AR0_err_q2,BtoKstarlow_At_err_q2,BtoKstarlow_AS_err_q2;
	Complex_C_t BtoKstarhigh_ALperp_err,BtoKstarhigh_ARperp_err,BtoKstarhigh_ALpar_err,BtoKstarhigh_ARpar_err,BtoKstarhigh_AL0_err,BtoKstarhigh_AR0_err,BtoKstarhigh_At_err,BtoKstarhigh_AS_err;

	/* B -> K hadronic uncertainties */
	double hadrerrBK;
	Complex_C_t BtoKlow_FV_err_noq2,BtoKlow_FA_err_noq2,BtoKlow_FS_err_noq2,BtoKlow_FP_err_noq2;
	Complex_C_t BtoKlow_FV_err_q2,BtoKlow_FA_err_q2,BtoKlow_FS_err_q2,BtoKlow_FP_err_q2;
	Complex_C_t BtoKhigh_FV_err,BtoKhigh_FA_err,BtoKhigh_FS_err,BtoKhigh_FP_err;	

	/* Bs -> phi hadronic uncertainties */
	double hadrerrBsphi;
	Complex_C_t Bstophilow_ALperp_err_noq2,Bstophilow_ARperp_err_noq2,Bstophilow_ALpar_err_noq2,Bstophilow_ARpar_err_noq2,Bstophilow_AL0_err_noq2,Bstophilow_AR0_err_noq2,Bstophilow_At_err_noq2,Bstophilow_AS_err_noq2;
	Complex_C_t Bstophilow_ALperp_err_q2,Bstophilow_ARperp_err_q2,Bstophilow_ALpar_err_q2,Bstophilow_ARpar_err_q2,Bstophilow_AL0_err_q2,Bstophilow_AR0_err_q2,Bstophilow_At_err_q2,Bstophilow_AS_err_q2;
	Complex_C_t Bstophihigh_ALperp_err,Bstophihigh_ARperp_err,Bstophihigh_ALpar_err,Bstophihigh_ARpar_err,Bstophihigh_AL0_err,Bstophihigh_AR0_err,Bstophihigh_At_err,Bstophihigh_AS_err;

	/* B -> K* power correction implementation */
	int BKstar_implementation;
	
	Complex_C_t hplus0,hminus0,hplus1,hminus1,hplus2,hminus2,hzero0,hzero1,hzero2; /* hadronic parameters (nonfactorisable power corrections) */
	...
	Complex_C_t deltaC[31],deltaCp[31],deltaCQ[7],deltaCQp[7];
	...
	double mu_W_mass_W,mu_b_mass_b,mu_spec_lambda_h_mass_b;
	double bsgamma_rand;
