...
#include <math.h>
#include "stdbool.h"
#include "c_sumSqAmpl_anti_chi_chi_to_anti_s_s.h"
#include "ccommon.h"

#include "cparams.h"

ccomplex_return_t c_sumSqAmpl_anti_chi_chi_to_anti_s_s(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1)*g_d*m_s*e_em*IT_0008*IT_0010;
    ...
    return create_ccomplex_return(((-48)*IT_0001 + 48*IT_0002 + 48*IT_0004 + (
      -48)*IT_0005)*IT_0017*conj(IT_0017));
}
