...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_1_chi_dm_1_to_anti_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = sin(theta_23_L);
    const ccomplex_t IT_0005 = cos(theta_12_L);
    const ccomplex_t IT_0006 = cos(theta_13_L);
    const ccomplex_t IT_0007 = sin(theta_12_L);
    const ccomplex_t IT_0008 = (0 + _Complex_I*1)*g_f*IT_0002*(IT_0003*IT_0004
       + IT_0005*(IT_0003*IT_0004*IT_0005 + -IT_0006*IT_0007));
    const ccomplex_t IT_0009 = 0.5*IT_0008;
    const ccomplex_t IT_0010 = IT_0001*IT_0009;
    const ccomplex_t IT_0011 = pow(m_chi_dm_1, 2);
    const ccomplex_t IT_0012 = cpow((-2)*s_12 + (-2)*IT_0011 + -reg_prop + m_V
    ...
    const ccomplex_t IT_0016 = cos(theta_23_R);
    const ccomplex_t IT_0017 = sin(theta_13_R);
    const ccomplex_t IT_0018 = sin(theta_23_R);
    const ccomplex_t IT_0019 = cos(theta_12_R);
    const ccomplex_t IT_0020 = cos(theta_13_R);
    const ccomplex_t IT_0021 = sin(theta_12_R);
    const ccomplex_t IT_0022 = (0 + _Complex_I*1)*g_f*IT_0016*(IT_0017*IT_0018
       + IT_0019*(IT_0017*IT_0018*IT_0019 + -IT_0020*IT_0021));
    ...
    const ccomplex_t IT_0028 = (-16)*s_12 + (-32)*IT_0011;
    const ccomplex_t IT_0029 = m_e*m_mu;
    const ccomplex_t IT_0030 = IT_0028*IT_0029;
    const ccomplex_t IT_0031 = -IT_0030;
    const ccomplex_t IT_0032 = s_14*s_23;
    const ccomplex_t IT_0033 = s_13*s_24;
    const ccomplex_t IT_0034 = s_34*IT_0011;
    const ccomplex_t IT_0035 = 16*IT_0032 + 16*IT_0033 + 16*IT_0034;
    return create_ccomplex_return(conj(IT_0015)*(IT_0027*IT_0031 + IT_0015
      *IT_0035) + conj(IT_0027)*(IT_0015*IT_0031 + IT_0027*IT_0035));
}
