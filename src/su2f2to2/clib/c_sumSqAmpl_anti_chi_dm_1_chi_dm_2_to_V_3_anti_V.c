...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_1_chi_dm_2_to_V_3_anti_V(
        ...
        )
{
    ...
    const ccomplex_t IT_0117 = s_14*s_23*IT_0000;
    const ccomplex_t IT_0118 = s_13*s_24*IT_0000;
    const ccomplex_t IT_0119 = IT_0117 + IT_0118;
    const ccomplex_t IT_0120 = s_12*s_34*IT_0000;
    ...
    const ccomplex_t IT_0125 = s_14*s_23*s_34;
    const ccomplex_t IT_0126 = s_13*s_24*s_34;
    const ccomplex_t IT_0127 = s_12*IT_0056;
    const ccomplex_t IT_0128 = (-2)*IT_0112 + 2*IT_0125 + 2*IT_0126 + (-2)
      *IT_0127;
    ...
    const ccomplex_t IT_0134 = IT_0110 + IT_0116 + IT_0124 + IT_0131 + IT_0133;
    ...
    const ccomplex_t IT_0158 = IT_0111 + IT_0125 + IT_0126;
    const ccomplex_t IT_0159 = (-2)*IT_0112 + -IT_0127;
    ...
    const ccomplex_t IT_0299 = 2*IT_0269;
    const ccomplex_t IT_0300 = IT_0287*m_chi_dm_2;
    ...
    const ccomplex_t IT_0305 = 0.125*IT_0109*IT_0173 + 0.125*IT_0041*IT_0174 +
      ...
      *conj(IT_0075)*IT_0291 + 0.125*conj(IT_0064)*IT_0298 + 0.125*IT_0181*
      (IT_0299 + IT_0301) + 0.125*IT_0018*(IT_0303 + IT_0304);
    ...
    const ccomplex_t IT_0320 = (-2)*IT_0112 + 4*IT_0126 + (-2)*IT_0319;
    ...
    const ccomplex_t IT_0370 = (-2)*IT_0112 + 4*IT_0125 + (-2)*IT_0319;
    ...
    const ccomplex_t IT_0458 = conj(IT_0051)*IT_0303;
    const ccomplex_t IT_0459 = 0.5*IT_0458;
    const ccomplex_t IT_0460 = IT_0276 + IT_0396;
    const ccomplex_t IT_0461 = IT_0052*IT_0460;
    const ccomplex_t IT_0462 = 6*IT_0461;
    const ccomplex_t IT_0463 = 0.5*conj(IT_0017);
    const ccomplex_t IT_0464 = -IT_0271;
    const ccomplex_t IT_0465 = s_12 + IT_0464;
    const ccomplex_t IT_0466 = IT_0052*IT_0465;
    const ccomplex_t IT_0467 = (-6)*IT_0466;
    const ccomplex_t IT_0468 = 0.5*conj(IT_0180);
    const ccomplex_t IT_0469 = s_14*s_24;
    const ccomplex_t IT_0470 = (-2)*IT_0469;
    const ccomplex_t IT_0471 = IT_0110 + IT_0470;
    const ccomplex_t IT_0472 = IT_0020*IT_0471;
    const ccomplex_t IT_0473 = -(IT_0011 + -IT_0276)*(s_12 + (-0.5)*IT_0472);
    const ccomplex_t IT_0474 = (-2)*IT_0473;
    const ccomplex_t IT_0475 = (-2)*IT_0474;
    const ccomplex_t IT_0476 = (s_12 + -IT_0271)*(s_12 + (-0.5)*IT_0472);
    ...
    const ccomplex_t IT_0498 = 2*IT_0017*(IT_0459 + IT_0462*IT_0463 + IT_0467
      *IT_0468 + IT_0463*IT_0475 + IT_0468*IT_0478 + IT_0480 + IT_0482 + IT_0484
       + IT_0486 + IT_0488 + IT_0490 + IT_0492 + IT_0494 + IT_0496 + IT_0497);
    const ccomplex_t IT_0499 = -(IT_0012 + -IT_0263)*(s_12 + (-0.5)*IT_0472);
    ...
    const ccomplex_t IT_0511 = conj(IT_0051)*IT_0299;
    const ccomplex_t IT_0512 = 0.5*IT_0511;
    const ccomplex_t IT_0513 = conj(IT_0051)*IT_0301;
    const ccomplex_t IT_0514 = 0.5*IT_0513;
    const ccomplex_t IT_0515 = conj(IT_0064)*IT_0186;
    const ccomplex_t IT_0516 = 0.5*IT_0515;
    const ccomplex_t IT_0517 = conj(IT_0019)*IT_0186;
    const ccomplex_t IT_0518 = 0.5*IT_0517;
    const ccomplex_t IT_0519 = conj(IT_0075)*IT_0454;
    const ccomplex_t IT_0520 = 0.5*IT_0519;
    const ccomplex_t IT_0521 = IT_0109*IT_0197;
    const ccomplex_t IT_0522 = 0.5*IT_0521;
    const ccomplex_t IT_0523 = conj(IT_0075)*IT_0456;
    const ccomplex_t IT_0524 = 0.5*IT_0523;
    const ccomplex_t IT_0525 = conj(IT_0064)*IT_0389;
    const ccomplex_t IT_0526 = 2*IT_0180*(IT_0463*IT_0467 + IT_0463*IT_0478 +
       IT_0468*IT_0501 + IT_0468*IT_0504 + IT_0506 + IT_0508 + IT_0510 + IT_0512
       + IT_0514 + IT_0516 + IT_0518 + IT_0520 + IT_0522 + IT_0524 + IT_0525);
    const ccomplex_t IT_0527 = IT_0018*IT_0027 + (IT_0041*conj(IT_0051) +
