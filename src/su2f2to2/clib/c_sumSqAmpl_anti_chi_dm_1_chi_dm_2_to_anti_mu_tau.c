...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_1_chi_dm_2_to_anti_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0007 = cos(theta_23_R);
    ...
    const ccomplex_t IT_0015 = s_14*s_23;
    ...
    const ccomplex_t IT_0019 = cos(theta_13_L);
    ...
    const ccomplex_t IT_0028 = m_mu*s_12*m_tau;
    const ccomplex_t IT_0029 = m_mu*m_tau*m_chi_dm_1*m_chi_dm_2;
