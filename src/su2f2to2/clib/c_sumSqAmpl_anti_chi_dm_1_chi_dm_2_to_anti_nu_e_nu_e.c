...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_1_chi_dm_2_to_anti_nu_e_nu_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = cos(theta_23_L);
    const ccomplex_t IT_0006 = sin(theta_13_L);
    const ccomplex_t IT_0007 = cos(theta_13_L);
    const ccomplex_t IT_0008 = sin(theta_12_L);
    const ccomplex_t IT_0009 = cos(theta_12_L);
    ...
    const ccomplex_t IT_0014 = pow(m_chi_dm_1, 2);
    const ccomplex_t IT_0015 = pow(m_chi_dm_2, 2);
    const ccomplex_t IT_0016 = cpow((-2)*s_12 + m_V*(m_V + (0 + _Complex_I*-1)
      *Gamma_V) + -IT_0014 + -IT_0015 + -reg_prop, -1);
    const ccomplex_t IT_0017 = IT_0013*IT_0016;
    const ccomplex_t IT_0018 = (0 + _Complex_I*1)*IT_0017;
    const ccomplex_t IT_0019 = -IT_0018;
    return create_ccomplex_return(16*(IT_0000 + IT_0001 + IT_0002)*IT_0019
      *conj(IT_0019));
}
