...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_1_chi_dm_2_to_anti_tau_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*g_f*IT_0005
      *IT_0006*(IT_0007*IT_0008 + IT_0005*IT_0009*IT_0010);
    ...
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*g_f*IT_0020
      *IT_0021*(IT_0022*IT_0023 + IT_0020*IT_0024*IT_0025);
