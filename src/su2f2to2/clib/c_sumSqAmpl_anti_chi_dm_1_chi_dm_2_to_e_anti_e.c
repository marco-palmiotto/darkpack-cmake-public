...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_1_chi_dm_2_to_e_anti_e(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = sin(theta_13_R);
    const ccomplex_t IT_0007 = cos(theta_13_R);
    ...
    const ccomplex_t IT_0011 = (0 + _Complex_I*1.4142135623731)*g_f*IT_0005
      *IT_0006*(IT_0007*IT_0008 + -IT_0006*IT_0009*IT_0010);
    ...
    const ccomplex_t IT_0022 = cos(theta_13_L);
    const ccomplex_t IT_0023 = sin(theta_12_L);
    const ccomplex_t IT_0024 = cos(theta_12_L);
    const ccomplex_t IT_0025 = sin(theta_23_L);
    const ccomplex_t IT_0026 = (0 + _Complex_I*1.4142135623731)*g_f*IT_0020
      *IT_0021*(IT_0022*IT_0023 + -IT_0021*IT_0024*IT_0025);
    ...
    const ccomplex_t IT_0032 = pow(m_e, 2);
    const ccomplex_t IT_0033 = s_12*IT_0032;
    const ccomplex_t IT_0034 = IT_0032*m_chi_dm_1*m_chi_dm_2;
    const ccomplex_t IT_0035 = 32*IT_0034;
    const ccomplex_t IT_0036 = 16*IT_0033 + IT_0035;
    return create_ccomplex_return(IT_0031*((16*IT_0017 + 16*IT_0018 + 16
      *IT_0019)*conj(IT_0031) + conj(IT_0016)*IT_0036) + IT_0016*(conj(IT_0016)*
      (16*IT_0017 + 16*IT_0018 + 16*IT_0019) + conj(IT_0031)*IT_0036));
}
