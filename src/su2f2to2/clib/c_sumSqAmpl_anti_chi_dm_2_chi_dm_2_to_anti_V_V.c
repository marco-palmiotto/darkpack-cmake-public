        ...
        )
{
    ...
    const ccomplex_t IT_0017 = -IT_0002;
    const ccomplex_t IT_0018 = IT_0016 + IT_0017;
    const ccomplex_t IT_0019 = s_12*IT_0000;
    const ccomplex_t IT_0020 = s_13*s_23;
    const ccomplex_t IT_0021 = s_14*s_23*s_34*IT_0013;
    const ccomplex_t IT_0022 = s_14*s_24;
    const ccomplex_t IT_0023 = (-2)*IT_0020 + 2*IT_0021 + -IT_0022;
    const ccomplex_t IT_0024 = IT_0019 + IT_0023;
    const ccomplex_t IT_0025 = IT_0013*IT_0024;
    const ccomplex_t IT_0026 = IT_0000*IT_0002;
    const ccomplex_t IT_0027 = -IT_0026;
    const ccomplex_t IT_0028 = IT_0015 + IT_0027;
    const ccomplex_t IT_0029 = IT_0013*IT_0028;
    const ccomplex_t IT_0030 = -IT_0014 + (-2)*IT_0018 + (-0.5)*IT_0025 + 0.5
      *IT_0029;
    ...
    const ccomplex_t IT_0036 = (-0.5)*IT_0026 + 0.5*IT_0034 + -IT_0035;
    ...
    const ccomplex_t IT_0042 = -IT_0022;
    ...
    const ccomplex_t IT_0060 = -IT_0020;
    ...
    const ccomplex_t IT_0064 = 2*IT_0015 + -IT_0026 + (-2)*IT_0063;
    ...
    const ccomplex_t IT_0076 = -IT_0020 + 2*IT_0021 + (-2)*IT_0022;
    const ccomplex_t IT_0077 = IT_0019 + IT_0076;
    const ccomplex_t IT_0078 = IT_0013*IT_0077;
    const ccomplex_t IT_0079 = IT_0027 + IT_0037;
    ...
    const ccomplex_t IT_0114 = s_23*IT_0096;
    ...
    const ccomplex_t IT_0120 = s_13*IT_0096;
    ...
    const ccomplex_t IT_0173 = (IT_0033 + IT_0050)*(IT_0057 + -conj(IT_0057)) 
      + -(IT_0073 + IT_0084)*(IT_0087 + -conj(IT_0087)) + 0.25*IT_0012*((-16)
    ...
    const ccomplex_t IT_0181 = 9*IT_0026;
    ...
    const ccomplex_t IT_0204 = (-2)*IT_0098 + 2*IT_0099 + 2*IT_0202 + (-2)
      *IT_0203;
    const ccomplex_t IT_0205 = IT_0097 + IT_0204;
    const ccomplex_t IT_0206 = IT_0013*IT_0205;
    const ccomplex_t IT_0207 = (-0.5)*IT_0206;
    const ccomplex_t IT_0208 = 1.5*IT_0026;
    const ccomplex_t IT_0209 = IT_0019 + (-2)*IT_0020 + 0.5*IT_0188 + IT_0193 
    ...
    const ccomplex_t IT_0222 = IT_0097 + IT_0099 + IT_0202;
    const ccomplex_t IT_0223 = (-2)*IT_0098 + -IT_0203;
    const ccomplex_t IT_0224 = IT_0222 + IT_0223;
    const ccomplex_t IT_0225 = IT_0013*IT_0224;
    const ccomplex_t IT_0226 = (-0.5)*IT_0225;
    const ccomplex_t IT_0227 = -IT_0021;
    const ccomplex_t IT_0228 = IT_0019 + IT_0210 + IT_0215 + IT_0217 + IT_0221
       + IT_0226 + IT_0227;
    const ccomplex_t IT_0229 = s_12*s_13;
    const ccomplex_t IT_0230 = s_23*IT_0015;
    ...
    const ccomplex_t IT_0256 = s_23*IT_0013*IT_0015;
    ...
    const ccomplex_t IT_0292 = 8*IT_0134*(IT_0134*(IT_0019 + (-4)*IT_0020 +
       0.5*IT_0179 + -IT_0180 + 0.5*IT_0181) + -IT_0151*IT_0209 + IT_0172
      *IT_0228 + -conj(IT_0087)*IT_0255 + conj(IT_0057)*IT_0291);
    const ccomplex_t IT_0293 = (IT_0002 + -IT_0074)*(s_12 + (-0.5)*IT_0094);
    ...
    const ccomplex_t IT_0299 = IT_0015*IT_0037*IT_0095;
    const ccomplex_t IT_0300 = s_13*s_14*s_23*s_24*IT_0095;
    const ccomplex_t IT_0301 = pow(m_chi_dm_2, 4);
    const ccomplex_t IT_0302 = s_14*s_23*s_34*IT_0095;
    ...
    const ccomplex_t IT_0309 = IT_0002*IT_0013*IT_0015;
    const ccomplex_t IT_0310 = -IT_0309;
    const ccomplex_t IT_0311 = s_12*s_14*s_23*s_34*IT_0095;
    ...
    const ccomplex_t IT_0319 = s_13*s_23*s_24*s_34*IT_0095;
    const ccomplex_t IT_0320 = s_14*s_34*IT_0037*IT_0095;
    const ccomplex_t IT_0321 = s_23*IT_0095*IT_0158;
    ...
    const ccomplex_t IT_0328 = s_12*s_23*IT_0095*IT_0158;
    ...
    const ccomplex_t IT_0337 = s_14*s_24*IT_0037*IT_0095;
    const ccomplex_t IT_0338 = s_13*s_23*IT_0034*IT_0095;
    const ccomplex_t IT_0339 = s_23*s_24*s_34*IT_0095;
    ...
    const ccomplex_t IT_0349 = s_12*s_23*s_24*s_34*IT_0095;
    ...
    const ccomplex_t IT_0354 = (-4)*IT_0134*IT_0254 + IT_0111*(IT_0294 + (-3)
    ...
    const ccomplex_t IT_0355 = (IT_0002 + -IT_0016)*(s_12 + 1.5*IT_0002 + (
      -0.5)*IT_0091);
    ...
    const ccomplex_t IT_0360 = (s_12 + 1.5*IT_0002 + (-0.5)*IT_0091)*(s_13 + 
      -IT_0163);
    const ccomplex_t IT_0361 = (-8)*IT_0360;
    const ccomplex_t IT_0362 = (s_12 + 1.5*IT_0002 + (-0.5)*IT_0091)*(s_23 + 
      -IT_0152);
    const ccomplex_t IT_0363 = (-8)*IT_0362;
    const ccomplex_t IT_0364 = IT_0361 + IT_0363;
    const ccomplex_t IT_0365 = IT_0034*IT_0058*IT_0095;
    const ccomplex_t IT_0366 = s_13*s_24*s_34*IT_0095;
    ...
    const ccomplex_t IT_0374 = s_12*s_13*s_24*s_34*IT_0095;
    const ccomplex_t IT_0375 = -IT_0374;
    const ccomplex_t IT_0376 = IT_0300 + IT_0301 + IT_0365 + IT_0369 + IT_0371
       + IT_0373 + IT_0375;
    const ccomplex_t IT_0377 = s_13*s_23*IT_0015*IT_0095;
    const ccomplex_t IT_0378 = s_14*s_24*IT_0058*IT_0095;
    const ccomplex_t IT_0379 = s_13*s_14*s_34*IT_0095;
    const ccomplex_t IT_0380 = IT_0002 + IT_0379;
    const ccomplex_t IT_0381 = -IT_0016 + -IT_0059;
    const ccomplex_t IT_0382 = IT_0380 + IT_0381;
    const ccomplex_t IT_0383 = IT_0002*IT_0382;
    const ccomplex_t IT_0384 = -IT_0383;
    const ccomplex_t IT_0385 = s_12*s_13*s_14*s_34*IT_0095;
    ...
    const ccomplex_t IT_0391 = s_13*s_14*s_23*s_34*IT_0095;
    ...
    const ccomplex_t IT_0400 = -IT_0134*IT_0291 + (-0.5)*IT_0111*(IT_0313 +
    ...
    const ccomplex_t IT_0404 = s_24*s_34*IT_0058*IT_0095;
    const ccomplex_t IT_0405 = s_13*IT_0095*IT_0158;
    ...
    const ccomplex_t IT_0411 = s_12*s_13*IT_0095*IT_0158;
    const ccomplex_t IT_0412 = -IT_0411;
    const ccomplex_t IT_0413 = IT_0134*IT_0255 + (-0.5)*IT_0111*IT_0318 +
    ...
    const ccomplex_t IT_0414 = (s_12 + 1.5*IT_0002 + (-0.5)*IT_0091)*(IT_0000 
      + -IT_0211);
    const ccomplex_t IT_0415 = s_13*s_23*IT_0095*IT_0158;
    const ccomplex_t IT_0416 = (-2)*IT_0415;
    const ccomplex_t IT_0417 = IT_0021 + IT_0210 + IT_0416;
    const ccomplex_t IT_0418 = (-4)*IT_0417;
    const ccomplex_t IT_0419 = (-0.5)*conj(IT_0087);
    const ccomplex_t IT_0420 = IT_0095*IT_0158;
    const ccomplex_t IT_0421 = (IT_0019 + (-2)*IT_0020 + IT_0026)*(1 + 0.5
      *IT_0420);
    const ccomplex_t IT_0422 = (-0.5)*conj(IT_0057)*IT_0398 + (-0.125)*conj
      ...
      *IT_0421;
    const ccomplex_t IT_0423 = 4*IT_0012*IT_0173 + IT_0292 + 4*IT_0111*IT_0354
