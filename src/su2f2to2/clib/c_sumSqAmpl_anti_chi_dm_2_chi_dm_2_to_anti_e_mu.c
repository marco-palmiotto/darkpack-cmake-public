...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_2_chi_dm_2_to_anti_e_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0004 = cos(theta_23_R);
    const ccomplex_t IT_0005 = sin(theta_13_R);
    const ccomplex_t IT_0006 = sin(theta_23_R);
    const ccomplex_t IT_0007 = cos(theta_12_R);
    const ccomplex_t IT_0008 = cos(theta_13_R);
    const ccomplex_t IT_0009 = sin(theta_12_R);
    const ccomplex_t IT_0010 = (0 + _Complex_I*1)*g_f*IT_0004*(IT_0005*IT_0006
       + IT_0007*(IT_0005*IT_0006*IT_0007 + -IT_0008*IT_0009));
    ...
    const ccomplex_t IT_0018 = s_34*IT_0000;
    const ccomplex_t IT_0019 = 16*IT_0016 + 16*IT_0017 + 16*IT_0018;
    const ccomplex_t IT_0020 = cos(theta_23_L);
    const ccomplex_t IT_0021 = sin(theta_13_L);
    const ccomplex_t IT_0022 = sin(theta_23_L);
    const ccomplex_t IT_0023 = cos(theta_12_L);
    const ccomplex_t IT_0024 = cos(theta_13_L);
    const ccomplex_t IT_0025 = sin(theta_12_L);
    const ccomplex_t IT_0026 = (0 + _Complex_I*1)*g_f*IT_0020*(IT_0021*IT_0022
       + IT_0023*(IT_0021*IT_0022*IT_0023 + -IT_0024*IT_0025));
    ...
    const ccomplex_t IT_0032 = (-16)*s_12 + (-32)*IT_0000;
    const ccomplex_t IT_0033 = m_e*m_mu;
    const ccomplex_t IT_0034 = IT_0032*IT_0033;
    const ccomplex_t IT_0035 = -IT_0034;
    return create_ccomplex_return(IT_0031*(IT_0019*conj(IT_0031) + conj
      (IT_0015)*IT_0035) + IT_0015*(conj(IT_0015)*IT_0019 + conj(IT_0031)
      *IT_0035));
}
