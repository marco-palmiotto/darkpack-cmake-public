...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_2_chi_dm_2_to_anti_nu_mu_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0018 = s_34*IT_0011;
    return create_ccomplex_return(IT_0015*conj(IT_0015)*(16*IT_0016 + 16
      *IT_0017 + 16*IT_0018));
}
