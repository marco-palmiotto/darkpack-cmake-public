...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_2_chi_dm_2_to_mu_anti_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = sin(theta_12_R);
    const ccomplex_t IT_0021 = sin(theta_13_R);
    ...
    const ccomplex_t IT_0029 = m_mu*m_tau;
    ...
    return create_ccomplex_return(-conj(IT_0015)*(IT_0027*IT_0030 + -IT_0015
      *IT_0034) + -conj(IT_0027)*(IT_0015*IT_0030 + -IT_0027*IT_0034));
}
