...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_2_chi_dm_2_to_nu_tau_anti_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0020 = s_13*s_24;
    const ccomplex_t IT_0021 = s_34*IT_0014;
    return create_ccomplex_return(IT_0018*conj(IT_0018)*(16*IT_0019 + 16
      *IT_0020 + 16*IT_0021));
}
