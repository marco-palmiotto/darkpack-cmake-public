        ...
        )
{
    ...
    const ccomplex_t IT_0027 = s_24*IT_0000*IT_0011;
    const ccomplex_t IT_0028 = s_13*s_14*s_23;
    const ccomplex_t IT_0029 = s_23*s_34*IT_0011;
    const ccomplex_t IT_0030 = -IT_0027 + (-2)*IT_0028 + 2*IT_0029;
    const ccomplex_t IT_0031 = IT_0026 + IT_0030;
    const ccomplex_t IT_0032 = IT_0008*IT_0031;
    const ccomplex_t IT_0033 = -IT_0006;
    const ccomplex_t IT_0034 = pow(s_24, 2);
    const ccomplex_t IT_0035 = IT_0008*IT_0034;
    const ccomplex_t IT_0036 = (s_12 + 1.5*IT_0011 + (-0.5)*IT_0016)*(IT_0011 
      + -IT_0035);
    const ccomplex_t IT_0037 = -IT_0036;
    const ccomplex_t IT_0038 = s_12*s_24*IT_0000;
    const ccomplex_t IT_0039 = s_14*IT_0000*IT_0011;
    const ccomplex_t IT_0040 = pow(s_23, 2);
    const ccomplex_t IT_0041 = s_14*IT_0040;
    const ccomplex_t IT_0042 = s_12*s_23*s_34;
    const ccomplex_t IT_0043 = -IT_0039 + 2*IT_0041 + (-2)*IT_0042;
    ...
    const ccomplex_t IT_0048 = s_14*IT_0011;
    const ccomplex_t IT_0049 = -IT_0048;
    const ccomplex_t IT_0050 = IT_0047 + IT_0049;
    const ccomplex_t IT_0051 = cpow(IT_0033, 2);
    const ccomplex_t IT_0052 = pow(m_V, 4);
    const ccomplex_t IT_0053 = s_12*IT_0052;
    const ccomplex_t IT_0054 = s_13*s_23*IT_0000;
    const ccomplex_t IT_0055 = s_14*s_24*IT_0000;
    const ccomplex_t IT_0056 = s_14*s_23*s_34;
    const ccomplex_t IT_0057 = (-2)*IT_0054 + (-2)*IT_0055 + 4*IT_0056;
    const ccomplex_t IT_0058 = IT_0053 + IT_0057;
    const ccomplex_t IT_0059 = IT_0008*IT_0058;
    const ccomplex_t IT_0060 = s_14*s_24;
    const ccomplex_t IT_0061 = IT_0012 + (-4)*IT_0060;
    const ccomplex_t IT_0062 = pow(m_V, -4);
    const ccomplex_t IT_0063 = pow(m_V, 6);
    const ccomplex_t IT_0064 = s_12*IT_0063;
    const ccomplex_t IT_0065 = s_13*s_23*IT_0052;
    ...
    const ccomplex_t IT_0070 = IT_0000*IT_0011;
    const ccomplex_t IT_0071 = 4.5*IT_0070;
    const ccomplex_t IT_0072 = pow(s_13, 2);
    const ccomplex_t IT_0073 = s_24*IT_0072;
    const ccomplex_t IT_0074 = s_12*s_13*s_34;
    const ccomplex_t IT_0075 = -IT_0027 + 2*IT_0073 + (-2)*IT_0074;
    const ccomplex_t IT_0076 = IT_0026 + IT_0075;
    const ccomplex_t IT_0077 = IT_0008*IT_0076;
    const ccomplex_t IT_0078 = pow(s_34, 2);
    const ccomplex_t IT_0079 = IT_0008*IT_0011*IT_0078;
    const ccomplex_t IT_0080 = s_13*s_23*s_24;
    const ccomplex_t IT_0081 = s_13*s_34*IT_0011;
    const ccomplex_t IT_0082 = -IT_0039 + (-2)*IT_0080 + 2*IT_0081;
    const ccomplex_t IT_0083 = IT_0038 + IT_0082;
    const ccomplex_t IT_0084 = IT_0008*IT_0083;
    const ccomplex_t IT_0085 = s_13*s_24*s_34;
    const ccomplex_t IT_0086 = (-2)*IT_0054 + (-2)*IT_0055 + 4*IT_0085;
    const ccomplex_t IT_0087 = IT_0053 + IT_0086;
    const ccomplex_t IT_0088 = IT_0008*IT_0087;
    const ccomplex_t IT_0089 = 16*IT_0007*(IT_0025 + (-0.5)*IT_0077) + (-2)
      *IT_0033*((-16)*IT_0012 + (-4)*IT_0068 + (-4)*IT_0070 + 16*IT_0079) + (-16
      )*IT_0022*(IT_0050 + -1./2*IT_0084) + 8*IT_0021*(IT_0061 + IT_0069 +
       IT_0071 + -IT_0088);
    const ccomplex_t IT_0090 = (-8)*IT_0007*(IT_0007*IT_0017 + (-2)*IT_0019
      *IT_0022 + 2*(IT_0025 + (-0.5)*IT_0032)*IT_0033) + (-8)*IT_0022*(IT_0022
      *IT_0037 + 2*IT_0033*(IT_0046 + -IT_0050)) + (-8)*IT_0051*(IT_0059 + 
      -IT_0061 + -IT_0069 + -IT_0071) + IT_0021*IT_0089;
