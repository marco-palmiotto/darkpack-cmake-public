        ...
        )
{
    ...
    const ccomplex_t IT_0026 = s_24*IT_0025;
    const ccomplex_t IT_0027 = s_12*s_13*s_34;
    const ccomplex_t IT_0028 = -IT_0024 + 2*IT_0026 + (-2)*IT_0027;
    const ccomplex_t IT_0029 = IT_0023 + IT_0028;
    const ccomplex_t IT_0030 = IT_0008*IT_0029;
    const ccomplex_t IT_0031 = s_12*s_14;
    const ccomplex_t IT_0032 = s_24*IT_0011;
    const ccomplex_t IT_0033 = IT_0031 + -IT_0032;
    const ccomplex_t IT_0034 = -IT_0006;
    const ccomplex_t IT_0035 = s_13*s_14*s_23;
    const ccomplex_t IT_0036 = s_23*s_34*IT_0011;
    ...
    const ccomplex_t IT_0075 = s_13*s_24*s_34;
    ...
    const ccomplex_t IT_0083 = cpow(IT_0034, 2);
    const ccomplex_t IT_0084 = s_14*s_23*s_34;
    ...
    const ccomplex_t IT_0088 = (-8)*IT_0007*(IT_0007*IT_0017 + (-2)*IT_0019
      *IT_0022 + IT_0021*(IT_0030 + (-2)*IT_0033) + 2*IT_0034*(IT_0033 + -1./2
      *IT_0039)) + (-8)*IT_0022*(IT_0022*IT_0043 + -IT_0021*(IT_0050 + (-2)
      *IT_0054) + (-2)*IT_0034*(IT_0054 + -IT_0060)) + (-2)*IT_0021*(IT_0034*((
      -16)*IT_0012 + (-4)*IT_0061 + 16*IT_0063 + (-4)*IT_0071) + (-4)*IT_0021*
