...
ccomplex_return_t c_sumSqAmpl_chi_dm_1_anti_chi_dm_1_to_anti_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0024 = sin(theta_12_L);
    const ccomplex_t IT_0025 = sin(theta_13_L);
    ...
    const ccomplex_t IT_0033 = m_mu*m_tau;
