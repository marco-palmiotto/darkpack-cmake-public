...
ccomplex_return_t c_sumSqAmpl_chi_dm_1_anti_chi_dm_2_to_V_3_V(
        ...
        )
{
    ...
    const ccomplex_t IT_0120 = s_14*s_23*IT_0001;
    const ccomplex_t IT_0121 = s_13*s_24*IT_0001;
    const ccomplex_t IT_0122 = IT_0120 + IT_0121;
    const ccomplex_t IT_0123 = s_12*s_34*IT_0001;
    ...
    const ccomplex_t IT_0128 = s_14*s_23*s_34;
    const ccomplex_t IT_0129 = s_13*s_24*s_34;
    const ccomplex_t IT_0130 = s_12*IT_0086;
    const ccomplex_t IT_0131 = (-2)*IT_0115 + 2*IT_0128 + 2*IT_0129 + (-2)
      *IT_0130;
    ...
    const ccomplex_t IT_0137 = IT_0113 + IT_0119 + IT_0127 + IT_0134 + IT_0136;
    ...
    const ccomplex_t IT_0306 = IT_0114 + IT_0128 + IT_0129;
    const ccomplex_t IT_0307 = (-2)*IT_0115 + -IT_0130;
    ...
    const ccomplex_t IT_0427 = (-2)*IT_0115 + 4*IT_0128 + (-2)*IT_0426;
    ...
    const ccomplex_t IT_0478 = (-2)*IT_0115 + 4*IT_0129 + (-2)*IT_0426;
