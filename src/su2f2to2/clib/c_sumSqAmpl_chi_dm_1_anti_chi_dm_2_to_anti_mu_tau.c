...
ccomplex_return_t c_sumSqAmpl_chi_dm_1_anti_chi_dm_2_to_anti_mu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0006 = sin(theta_12_R);
    const ccomplex_t IT_0007 = sin(theta_13_R);
    const ccomplex_t IT_0008 = cos(theta_12_R);
    const ccomplex_t IT_0009 = cos(theta_13_R);
    ...
    const ccomplex_t IT_0030 = m_mu*s_12*m_tau;
    const ccomplex_t IT_0031 = m_mu*m_tau*m_chi_dm_1*m_chi_dm_2;
