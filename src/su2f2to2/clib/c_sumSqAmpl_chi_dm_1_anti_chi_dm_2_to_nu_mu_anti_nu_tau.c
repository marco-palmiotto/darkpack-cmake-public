...
ccomplex_return_t c_sumSqAmpl_chi_dm_1_anti_chi_dm_2_to_nu_mu_anti_nu_tau(
        ...
        )
{
    ...
    const ccomplex_t IT_0012 = pow(m_chi_dm_1, 2);
    const ccomplex_t IT_0013 = pow(m_chi_dm_2, 2);
    const ccomplex_t IT_0014 = cpow((-2)*s_12 + m_V*(m_V + (0 + _Complex_I*-1)
      *Gamma_V) + -IT_0012 + -IT_0013 + -reg_prop, -1);
    const ccomplex_t IT_0015 = IT_0011*IT_0014;
    const ccomplex_t IT_0016 = (0 + _Complex_I*1)*IT_0015;
    const ccomplex_t IT_0017 = -IT_0016;
    return create_ccomplex_return(16*(IT_0000 + IT_0001 + IT_0002)*IT_0017
      *conj(IT_0017));
}
