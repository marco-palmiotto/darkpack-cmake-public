        ...
        )
{
    ...
    const ccomplex_t IT_0026 = s_12*s_13*s_34;
    const ccomplex_t IT_0027 = s_24*IT_0000*IT_0011;
    const ccomplex_t IT_0028 = 2*IT_0025 + (-2)*IT_0026 + -IT_0027;
    ...
    const ccomplex_t IT_0037 = -IT_0027 + (-2)*IT_0035 + 2*IT_0036;
    ...
    const ccomplex_t IT_0076 = s_13*s_24*s_34;
    ...
    const ccomplex_t IT_0084 = cpow(IT_0034, 2);
    ...
    const ccomplex_t IT_0089 = (-8)*IT_0007*(IT_0007*IT_0017 + (-2)*IT_0019
      ...
      *IT_0054) + (-2)*IT_0034*(IT_0054 + -IT_0061)) + (-2)*IT_0021*(IT_0034*((
      -16)*IT_0012 + (-4)*IT_0062 + 16*IT_0064 + (-4)*IT_0072) + (-4)*IT_0021*
