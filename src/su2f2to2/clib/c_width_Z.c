        ...
        )
{
    ...
    const ccomplex_t IT_0048 = IT_0003*IT_0025;
    const ccomplex_t IT_0049 = IT_0003*IT_0048;
    const ccomplex_t IT_0050 = IT_0001*IT_0003;
    ...
    const ccomplex_t IT_0055 = -IT_0028 + -IT_0036;
    const ccomplex_t IT_0056 = IT_0001*IT_0025;
    ...
    const ccomplex_t IT_0063 = IT_0027*IT_0035;
    const ccomplex_t IT_0064 = (1 + 0.5*IT_0036)*(IT_0023 + -IT_0063);
    const ccomplex_t IT_0065 = (1 + 0.5*IT_0036)*(IT_0003 + -IT_0044);
    ...
    const ccomplex_t IT_0076 = 0.666666666666667*IT_0029*IT_0033 +
      ...
      (IT_0034*(IT_0054 + -IT_0062) + IT_0047*(IT_0038 + IT_0064 + 2*IT_0065) + 
