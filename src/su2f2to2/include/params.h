...
struct param_t {
    ...
    csl::InitSanitizer<real_t> Gamma_V { "Gamma_V" };
    ...
    csl::InitSanitizer<real_t> m_V { "m_V" };
    ...
    void reset()
    {
        using real_params = std::array<csl::InitSanitizer<real_t>*, 41>;
        ...
        for (auto &par : real_params{
                ...
                &s_24, &s_34, &m_cdm, &Gamma_V, &theta_W, &reg_prop, 
                &Gamma_V_3, &theta_12_L, &theta_12_R, &theta_13_L, &theta_13_R, &theta_23_L, 
                &theta_23_R, &g_s, &m_V, &m_W, &m_Z, &m_b, 
                &m_c, &m_d, &m_e, &m_h, &m_s, &m_t, 
                &m_u, &m_mu, &m_phi, &m_tau, &m_chi_dm_1, &m_chi_dm_2, })
        {
            par->reset();
        }
    ...
    {
        using real_params = std::array<csl::InitSanitizer<real_t> const*, 41>;
