...
ccomplex_return_t c_sumSqAmpl_anti_chi_dm_1_chi_dm_1_to_anti_V_3_anti_V_3(
        ...
        )
{
    ...
    const ccomplex_t IT_0051 = -IT_0023;
    const ccomplex_t IT_0052 = s_13*s_14*s_23;
    const ccomplex_t IT_0053 = s_12*s_14*IT_0004;
    const ccomplex_t IT_0054 = s_23*s_34*IT_0009;
    const ccomplex_t IT_0055 = s_24*IT_0004*IT_0009;
    const ccomplex_t IT_0056 = (-0.5)*IT_0053 + -IT_0054 + 0.5*IT_0055;
    const ccomplex_t IT_0057 = IT_0052 + IT_0056;
    const ccomplex_t IT_0058 = IT_0012*IT_0057;
    const ccomplex_t IT_0059 = s_12*s_14;
    const ccomplex_t IT_0060 = s_24*IT_0009;
    const ccomplex_t IT_0061 = IT_0059 + -IT_0060;
    const ccomplex_t IT_0062 = pow(s_13, 2);
    const ccomplex_t IT_0063 = s_24*IT_0062;
    const ccomplex_t IT_0064 = s_12*s_13*s_34;
    const ccomplex_t IT_0065 = -IT_0055 + 2*IT_0063 + (-2)*IT_0064;
    const ccomplex_t IT_0066 = IT_0053 + IT_0065;
    const ccomplex_t IT_0067 = IT_0012*IT_0066;
    const ccomplex_t IT_0068 = 0.5*IT_0067;
    const ccomplex_t IT_0069 = 2*IT_0024;
    ...
    const ccomplex_t IT_0092 = (-2)*IT_0007*(((-16)*IT_0008 + (-4)*IT_0010 +
      ...
      (-4)*IT_0032 + IT_0033 + IT_0034)) + 8*IT_0035*(IT_0008 + (-4)*IT_0025 +
       IT_0033 + IT_0034 + (-4)*IT_0041) + (-8)*IT_0006*(IT_0006*IT_0048 + (-2)
      *IT_0050*IT_0051 + 2*IT_0007*(IT_0058 + IT_0061) + -(IT_0061 + -IT_0068)
      *IT_0069) + (-8)*IT_0051*(IT_0051*IT_0073 + 2*IT_0007*(IT_0081 + -IT_0085)
       + IT_0069*(IT_0085 + IT_0091));
