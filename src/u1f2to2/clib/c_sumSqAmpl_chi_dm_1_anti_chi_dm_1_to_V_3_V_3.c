        ...
        )
{
    ...
    const ccomplex_t IT_0013 = s_12*IT_0004;
    ...
    const ccomplex_t IT_0021 = s_13*s_14*s_23;
    const ccomplex_t IT_0022 = s_12*s_14*IT_0004;
    const ccomplex_t IT_0023 = s_23*s_34*IT_0011;
    const ccomplex_t IT_0024 = s_24*IT_0004*IT_0011;
    const ccomplex_t IT_0025 = (-0.5)*IT_0022 + -IT_0023 + 0.5*IT_0024;
    const ccomplex_t IT_0026 = IT_0021 + IT_0025;
    const ccomplex_t IT_0027 = IT_0009*IT_0026;
    const ccomplex_t IT_0028 = 0.5*IT_0006;
    const ccomplex_t IT_0029 = pow(s_13, 2);
    const ccomplex_t IT_0030 = s_24*IT_0029;
    const ccomplex_t IT_0031 = s_12*s_13*s_34;
    const ccomplex_t IT_0032 = -IT_0024 + 2*IT_0030 + (-2)*IT_0031;
    const ccomplex_t IT_0033 = IT_0022 + IT_0032;
    const ccomplex_t IT_0034 = IT_0009*IT_0033;
    const ccomplex_t IT_0035 = 0.5*IT_0034;
    const ccomplex_t IT_0036 = cpow(s_13 + (-0.5)*IT_0004 + (-0.5)*reg_prop, 
      -1);
    ...
    const ccomplex_t IT_0045 = s_12*s_24*IT_0004;
    const ccomplex_t IT_0046 = s_14*IT_0004*IT_0011;
    const ccomplex_t IT_0047 = s_13*s_23*s_24;
    const ccomplex_t IT_0048 = s_13*s_34*IT_0011;
    const ccomplex_t IT_0049 = -IT_0046 + (-2)*IT_0047 + 2*IT_0048;
    const ccomplex_t IT_0050 = IT_0045 + IT_0049;
    const ccomplex_t IT_0051 = IT_0009*IT_0050;
    const ccomplex_t IT_0052 = (-0.5)*IT_0051;
    const ccomplex_t IT_0053 = s_12*s_24;
    const ccomplex_t IT_0054 = s_14*IT_0011;
    ...
    const ccomplex_t IT_0088 = s_14*s_23*s_34;
    ...
    const ccomplex_t IT_0092 = (-8)*IT_0007*(IT_0007*IT_0017 + 2*(IT_0020 +
       IT_0027)*IT_0028 + (-2)*(IT_0020 + -IT_0035)*IT_0038) + (-8)*IT_0037*
      (IT_0037*IT_0042 + (-2)*IT_0007*IT_0044 + 2*IT_0038*(IT_0052 + IT_0056) + 
      (-2)*IT_0028*(IT_0056 + -IT_0062)) + (-32)*IT_0063*(IT_0073 + (-0.25)
      *IT_0075 + (-0.25)*IT_0083 + (-0.25)*IT_0085) + (-2)*IT_0028*(IT_0038*((
      -16)*IT_0013 + 8*IT_0082 + (-4)*IT_0084 + 16*IT_0087) + 16*IT_0028*((-0.25
