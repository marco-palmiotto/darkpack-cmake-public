        ...
        )
{
    ...
    const ccomplex_t IT_0042 = -IT_0023;
    ...
    const ccomplex_t IT_0049 = -(IT_0009 + -IT_0044)*(s_12 + 1.5*IT_0009 +
       IT_0048);
    const ccomplex_t IT_0050 = s_12*s_14*IT_0004;
    const ccomplex_t IT_0051 = s_24*IT_0004*IT_0009;
    const ccomplex_t IT_0052 = s_13*s_14*s_23;
    const ccomplex_t IT_0053 = s_23*s_34*IT_0009;
    const ccomplex_t IT_0054 = -IT_0051 + (-2)*IT_0052 + 2*IT_0053;
    const ccomplex_t IT_0055 = IT_0050 + IT_0054;
    const ccomplex_t IT_0056 = IT_0012*IT_0055;
    const ccomplex_t IT_0057 = (-0.5)*IT_0056;
    const ccomplex_t IT_0058 = s_12*s_14;
    const ccomplex_t IT_0059 = s_24*IT_0009;
    const ccomplex_t IT_0060 = IT_0058 + -IT_0059;
    const ccomplex_t IT_0061 = pow(s_13, 2);
    const ccomplex_t IT_0062 = s_24*IT_0061;
    const ccomplex_t IT_0063 = s_12*s_13*s_34;
    const ccomplex_t IT_0064 = 0.5*IT_0050 + (-0.5)*IT_0051 + -IT_0063;
    const ccomplex_t IT_0065 = IT_0062 + IT_0064;
    const ccomplex_t IT_0066 = IT_0012*IT_0065;
    const ccomplex_t IT_0067 = 2*IT_0007;
    ...
    const ccomplex_t IT_0092 = (-2)*IT_0007*(((-16)*IT_0008 + (-4)*IT_0010 +
      ...
      *IT_0024*(IT_0057 + IT_0060) + -(IT_0060 + -IT_0066)*IT_0067) + (-8)
      *IT_0006*(IT_0006*IT_0071 + (-2)*IT_0042*IT_0073 + 2*IT_0024*(IT_0082 + 
      -IT_0086) + IT_0067*(IT_0086 + IT_0091));
