...
ccomplex_return_t c_sumSqAmpl_chi_dm_1_anti_chi_dm_1_to_anti_V_3_anti_V_3(
        ...
        )
{
    ...
    const ccomplex_t IT_0005 = cpow(s_23 + (-0.5)*IT_0004 + (-0.5)*reg_prop, 
      -1);
    const ccomplex_t IT_0006 = IT_0003*IT_0005;
    const ccomplex_t IT_0007 = 0.5*IT_0006;
    const ccomplex_t IT_0008 = s_12*IT_0004;
    const ccomplex_t IT_0009 = pow(m_chi_dm_1, 2);
    ...
    const ccomplex_t IT_0022 = cpow(s_13 + (-0.5)*IT_0004 + (-0.5)*reg_prop, 
      -1);
    ...
    const ccomplex_t IT_0051 = s_12*s_14*IT_0004;
    ...
    const ccomplex_t IT_0077 = s_12*s_24*IT_0004;
    const ccomplex_t IT_0078 = s_14*IT_0004*IT_0009;
