...
#include <math.h>
#include "stdbool.h"
#include "c_sumSqAmpl_chi_dm_1_anti_chi_dm_1_to_nu_tau_anti_nu_mu.h"
#include "ccommon.h"

#include "cparams.h"

ccomplex_return_t c_sumSqAmpl_chi_dm_1_anti_chi_dm_1_to_nu_tau_anti_nu_mu(
        ...
        )
{
    ...
    const ccomplex_t IT_0015 = cpow(s_12 + IT_0002 + 0.5*reg_prop + (-0.5)
