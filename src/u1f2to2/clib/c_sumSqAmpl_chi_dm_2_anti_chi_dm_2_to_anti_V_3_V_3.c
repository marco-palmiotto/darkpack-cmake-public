...
ccomplex_return_t c_sumSqAmpl_chi_dm_2_anti_chi_dm_2_to_anti_V_3_V_3(
        ...
        )
{
    ...
    const ccomplex_t IT_0008 = s_12*IT_0000;
    ...
    const ccomplex_t IT_0022 = cpow(s_13 + (-0.5)*IT_0000 + (-0.5)*reg_prop, 
      -1);
    const ccomplex_t IT_0023 = IT_0005*IT_0022;
    const ccomplex_t IT_0024 = (-0.5)*IT_0023;
    const ccomplex_t IT_0025 = s_14*s_24;
    const ccomplex_t IT_0026 = s_14*s_23*s_34;
    const ccomplex_t IT_0027 = s_13*s_23*IT_0000;
    const ccomplex_t IT_0028 = s_14*s_24*IT_0000;
    ...
    const ccomplex_t IT_0037 = s_13*s_24*s_34;
    ...
    const ccomplex_t IT_0046 = (-0.5)*IT_0008;
    const ccomplex_t IT_0047 = IT_0045 + IT_0046;
    const ccomplex_t IT_0048 = IT_0012*IT_0047;
    const ccomplex_t IT_0049 = -(IT_0009 + -IT_0044)*(s_12 + 1.5*IT_0009 +
       IT_0048);
    const ccomplex_t IT_0050 = s_13*s_14*s_23;
    const ccomplex_t IT_0051 = s_12*s_14*IT_0000;
    const ccomplex_t IT_0052 = s_23*s_34*IT_0009;
    const ccomplex_t IT_0053 = s_24*IT_0000*IT_0009;
    const ccomplex_t IT_0054 = (-0.5)*IT_0051 + -IT_0052 + 0.5*IT_0053;
    const ccomplex_t IT_0055 = IT_0050 + IT_0054;
    const ccomplex_t IT_0056 = IT_0012*IT_0055;
    const ccomplex_t IT_0057 = s_12*s_14;
    const ccomplex_t IT_0058 = s_24*IT_0009;
    const ccomplex_t IT_0059 = IT_0057 + -IT_0058;
    const ccomplex_t IT_0060 = pow(s_13, 2);
    const ccomplex_t IT_0061 = s_24*IT_0060;
    const ccomplex_t IT_0062 = s_12*s_13*s_34;
    const ccomplex_t IT_0063 = -IT_0053 + 2*IT_0061 + (-2)*IT_0062;
    const ccomplex_t IT_0064 = IT_0051 + IT_0063;
    const ccomplex_t IT_0065 = IT_0012*IT_0064;
    const ccomplex_t IT_0066 = 0.5*IT_0065;
    const ccomplex_t IT_0067 = 2*IT_0024;
    const ccomplex_t IT_0068 = pow(s_24, 2);
    const ccomplex_t IT_0069 = IT_0012*IT_0068;
    const ccomplex_t IT_0070 = (s_12 + 1.5*IT_0009 + IT_0048)*(IT_0009 + 
      -IT_0069);
    const ccomplex_t IT_0071 = -IT_0070;
    const ccomplex_t IT_0072 = s_14*s_24*IT_0012;
    const ccomplex_t IT_0073 = (s_12 + 1.5*IT_0009 + IT_0048)*(s_12 + -IT_0072);
    const ccomplex_t IT_0074 = pow(s_23, 2);
    const ccomplex_t IT_0075 = s_14*IT_0074;
    const ccomplex_t IT_0076 = s_12*s_23*s_34;
    const ccomplex_t IT_0077 = s_12*s_24*IT_0000;
    const ccomplex_t IT_0078 = s_14*IT_0000*IT_0009;
    const ccomplex_t IT_0079 = -IT_0076 + 0.5*IT_0077 + (-0.5)*IT_0078;
    const ccomplex_t IT_0080 = IT_0075 + IT_0079;
    const ccomplex_t IT_0081 = IT_0012*IT_0080;
    const ccomplex_t IT_0082 = s_12*s_24;
    const ccomplex_t IT_0083 = s_14*IT_0009;
    const ccomplex_t IT_0084 = -IT_0083;
    const ccomplex_t IT_0085 = IT_0082 + IT_0084;
    const ccomplex_t IT_0086 = s_13*s_23*s_24;
    const ccomplex_t IT_0087 = s_13*s_34*IT_0009;
    const ccomplex_t IT_0088 = -IT_0078 + (-2)*IT_0086 + 2*IT_0087;
    ...
    const ccomplex_t IT_0092 = (-2)*IT_0007*(((-16)*IT_0008 + (-4)*IT_0010 +
      ...
      (-4)*IT_0032 + IT_0033 + IT_0034)) + 8*IT_0035*(IT_0008 + (-4)*IT_0025 +
       IT_0033 + IT_0034 + (-4)*IT_0041) + (-8)*IT_0042*(IT_0042*IT_0049 + 2
      *IT_0007*(IT_0056 + IT_0059) + -(IT_0059 + -IT_0066)*IT_0067) + (-8)
      *IT_0023*(IT_0023*IT_0071 + (-2)*IT_0042*IT_0073 + 2*IT_0007*(IT_0081 + 
      -IT_0085) + IT_0067*(IT_0085 + IT_0091));
