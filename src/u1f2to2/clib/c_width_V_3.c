        ...
        )
{
    ...
    return create_ccomplex_return(IT_0023 + 2*IT_0027 + 2*IT_0031 + IT_0037 +
       2*IT_0041 + IT_0047 + IT_0070 + IT_0086 + 2*IT_0104 + IT_0116 + IT_0132 +
       2*IT_0150 + 2*IT_0168 + IT_0180);
}
