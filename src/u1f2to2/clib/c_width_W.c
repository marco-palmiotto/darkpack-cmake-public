        ...
        )
{
    ...
    const ccomplex_t IT_0010 = 0.5*IT_0003;
    const ccomplex_t IT_0011 = cpow(IT_0010, 2);
    const ccomplex_t IT_0012 = IT_0001*IT_0009*IT_0011;
    const ccomplex_t IT_0013 = IT_0005*IT_0012;
    const ccomplex_t IT_0014 = cpow(IT_0005, 2);
    const ccomplex_t IT_0015 = IT_0001*IT_0014;
    const ccomplex_t IT_0016 = (1 + 0.5*IT_0012)*(IT_0002 + -IT_0015);
    ...
    const ccomplex_t IT_0020 = IT_0001*IT_0009*IT_0019;
    const ccomplex_t IT_0021 = (IT_0002 + -IT_0015)*(1 + 0.5*IT_0020);
    const ccomplex_t IT_0022 = IT_0005*IT_0020;
    const ccomplex_t IT_0023 = IT_0009*IT_0018;
    const ccomplex_t IT_0024 = IT_0010*IT_0023;
    const ccomplex_t IT_0025 = IT_0006*IT_0009*IT_0014;
    ...
    const ccomplex_t IT_0035 = IT_0006*IT_0014;
    const ccomplex_t IT_0036 = IT_0009*IT_0011;
    ...
    const ccomplex_t IT_0043 = -IT_0012 + -IT_0035;
    const ccomplex_t IT_0044 = IT_0006*IT_0009;
    ...
    const ccomplex_t IT_0049 = 1 + IT_0048;
    ...
    const ccomplex_t IT_0054 = IT_0001*IT_0018;
    ...
    const ccomplex_t IT_0059 = IT_0010*IT_0051;
    const ccomplex_t IT_0060 = IT_0005*IT_0059;
    const ccomplex_t IT_0061 = IT_0001*IT_0010;
    ...
    const ccomplex_t IT_0066 = -IT_0020 + -IT_0035;
    ...
    const ccomplex_t IT_0070 = (-0.666666666666667)*(IT_0005 + -IT_0008 + 
      -IT_0013 + -IT_0016 + -IT_0021 + -IT_0022 + IT_0024 + IT_0027)*IT_0034 +
       0.666666666666667*IT_0032*(IT_0032*(IT_0037 + IT_0039 + 2*IT_0042) + 
      -IT_0033*(IT_0050 + -IT_0058 + -IT_0065 + IT_0069));
